...
rule Rogue_Win32_FakeSpypro{
	...
	strings :
		$a_02_0 = {96 58 b9 e7 bf 35 02 01 ca 81 e9 03 bb 35 02 81 c6 21 bd 38 00 81 c6 df ea 0d 00 89 f2 fc 89 f7 52 e9 77 ff ff ff 2d 90 01 04 41 49 e8 72 ff ff ff 83 e9 0a 83 c1 09 85 c9 75 e5 c3 90 00 } //1
	condition:
		((#a_02_0  & 1)*1) >=1
...
rule Rogue_Win32_FakeSpypro_3{
	...
	strings :
		...
		$a_03_2 = {85 d2 75 3c 8b c6 6b c0 0c 8b 88 90 01 04 8b 90 90 90 01 04 8b 80 90 01 04 89 44 90 00 } //2
...
rule Rogue_Win32_FakeSpypro_4{
	...
	strings :
		...
		$a_03_2 = {85 d2 75 3c 8b c6 6b c0 0c 8b 88 90 01 04 8b 90 90 90 01 04 8b 80 90 01 04 89 44 90 00 } //2
		$a_03_3 = {74 39 50 57 e8 90 01 04 59 59 85 c0 74 36 83 c6 0c 90 00 } //1
		$a_01_4 = {37 61 1d 02 a4 00 } //1
	condition:
...
rule Rogue_Win32_FakeSpypro_5{
	...
	strings :
		$a_03_0 = {fe ff ce fe 8d 44 24 0c 50 ff 74 08 07 e8 90 09 18 02 55 50 58 30 00 00 00 00 00 90 04 01 02 a0 b0 02 00 00 10 00 00 00 00 00 00 00 04 00 00 00 00 00 00 00 00 00 00 00 00 00 00 80 00 00 e0 55 50 58 31 00 00 00 00 00 30 03 00 00 90 04 01 02 b0 c0 02 00 00 90 01 01 03 00 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Rogue_Win32_FakeSpypro_6{
	...
	strings :
		$a_03_0 = {fe ff ce fe 8d 44 24 0c 50 ff 74 08 07 e8 90 09 20 02 55 50 58 30 00 00 00 00 00 90 03 02 01 90 90 a0 02 00 00 10 00 00 00 00 00 00 00 04 00 00 00 00 00 00 00 00 00 00 00 00 00 00 80 00 00 e0 55 50 58 31 00 00 00 00 00 30 03 00 00 90 03 01 01 a0 b0 02 00 00 90 01 01 03 00 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Rogue_Win32_FakeSpypro_10{
	...
	strings :
		$a_03_0 = {6a 02 6a 00 6a 80 8b 4d fc 51 ff 15 90 01 04 6a 00 8d 55 f4 52 68 80 00 00 00 90 00 } //2
		$a_03_1 = {d8 f9 ff ff 90 01 01 8b 90 01 01 08 8b 90 01 01 08 8b 90 01 01 08 8b 90 01 01 08 8b 90 01 02 8b 90 01 01 2c ff 90 00 } //1
		$a_03_2 = {81 7d 0c fa 00 00 00 0f 85 90 01 02 00 00 8b 90 01 01 08 83 90 01 01 08 00 75 0a b8 05 40 00 80 e9 90 01 02 00 00 8b 90 01 01 1c 8b 90 01 01 8b 90 01 01 58 90 00 } //1
...
rule Rogue_Win32_FakeSpypro_11{
	...
	strings :
		$a_03_0 = {6a 02 6a 00 68 00 ff ff ff 8b 4d fc 51 ff 15 90 01 04 6a 00 8d 55 f4 52 68 00 01 00 00 90 00 } //2
		$a_03_1 = {f9 ff ff 51 8b 90 01 01 08 8b 90 01 01 08 8b 90 01 01 08 8b 90 01 01 08 8b 90 01 02 8b 90 01 01 2c ff 90 00 } //1
		$a_03_2 = {81 7d 0c fa 00 00 00 0f 85 90 01 02 00 00 8b 90 01 01 08 83 90 01 01 08 00 75 0a b8 05 40 00 80 e9 90 01 02 00 00 8b 90 01 01 1c 8b 90 01 01 8b 90 01 01 58 90 00 } //1
		$a_01_3 = {53 00 6f 00 66 00 74 00 77 00 61 00 72 00 65 00 5c 00 41 00 76 00 53 00 63 00 61 00 6e 00 } //2 Software\AvScan
	condition:
		((#a_03_0  & 1)*2+(#a_03_1  & 1)*1+(#a_03_2  & 1)*1+(#a_01_3  & 1)*2) >=4
...
rule Rogue_Win32_FakeSpypro_13{
	...
	strings :
		...
		$a_03_4 = {53 6f 66 74 77 61 72 65 5c 61 76 73 90 03 03 04 6f 66 74 75 69 74 65 00 90 00 } //1
...
rule Rogue_Win32_FakeSpypro_16{
	...
	strings :
		...
		$a_02_3 = {53 65 53 68 75 74 64 6f 77 6e 50 72 69 76 69 6c 65 67 65 00 44 6f 20 79 6f 75 20 77 61 6e 74 20 90 03 00 03 74 6f 20 72 65 62 6f 6f 74 20 6e 6f 77 3f 90 05 04 01 00 90 03 00 07 52 65 62 6f 6f 74 20 71 75 65 73 74 69 6f 6e 00 90 00 } //2
...
rule Rogue_Win32_FakeSpypro_17{
	...
	strings :
		$a_03_0 = {0f 85 f9 00 00 00 e8 90 01 02 00 00 3d 90 01 02 00 00 0f 8d e9 00 00 00 c7 45 f8 06 02 00 00 90 00 } //1
		$a_03_1 = {85 c0 75 10 e8 90 01 04 3d 90 01 02 00 00 0f 8d 90 01 02 00 00 c7 45 f8 06 02 00 00 90 00 } //1
...
rule Rogue_Win32_FakeSpypro_19{
	...
	strings :
		...
		$a_02_8 = {4b 69 6c 6c 42 79 50 72 6f 63 90 02 02 22 25 5c 5b 30 2d 39 5d 5b 30 2d 39 5d 5b 30 2d 39 5d 5b 30 2d 39 5d 25 2e 65 78 65 22 2c 20 22 46 61 6b 65 2e 53 65 63 75 72 69 74 79 20 54 6f 6f 6c 22 90 00 } //1
		...
		$a_03_21 = {33 d2 b9 e8 03 00 00 f7 f1 89 44 24 90 01 01 3b c7 72 90 01 01 83 ff 78 7d 90 01 01 3b 3d 90 01 04 73 90 01 01 6a 78 58 2b c7 69 c0 e8 03 00 00 50 ff d6 90 00 } //2
