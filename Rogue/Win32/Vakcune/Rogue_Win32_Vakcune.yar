...
rule Rogue_Win32_Vakcune{
	...
	strings :
		$a_00_0 = {00 50 6f 77 65 72 53 63 61 6e } //01 00 
		$a_01_1 = {00 51 75 61 72 61 6e 74 69 6e 65 50 6f 77 } //01 00 
		$a_00_2 = {5c 44 65 6c 55 53 2e 62 61 74 } //02 00 
		...
		$a_01_6 = {45 00 62 00 69 00 7a 00 20 00 4e 00 65 00 74 00 77 00 6f 00 72 00 6b 00 } //00 00 
	condition:
		any of ($a_*)
