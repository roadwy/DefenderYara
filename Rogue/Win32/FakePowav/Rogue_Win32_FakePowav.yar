...
rule Rogue_Win32_FakePowav{
	...
	strings :
		...
		$a_00_1 = {48 6f 77 54 6f 42 75 79 2e 74 78 74 } //00 00 
	condition:
		any of ($a_*)
...
rule Rogue_Win32_FakePowav_2{
	...
	strings :
		...
		$a_01_2 = {73 6f 66 74 77 61 72 65 73 20 72 65 71 75 69 72 65 64 20 66 6f 72 20 76 69 72 75 73 } //00 00 
	condition:
		any of ($a_*)
...
rule Rogue_Win32_FakePowav_3{
	...
	strings :
		...
		$a_01_1 = {74 6f 20 64 65 6c 65 74 65 20 61 20 76 69 72 75 73 } //01 00 
...
rule Rogue_Win32_FakePowav_5{
	...
	strings :
		$a_01_0 = {53 70 79 20 50 72 6f 74 65 63 74 6f 72 00 } //01 00 
...
rule Rogue_Win32_FakePowav_6{
	...
	strings :
		...
		$a_00_5 = {49 6e 73 74 61 6c 6c 69 6e 67 20 53 79 73 74 65 6d 20 50 72 6f 74 65 63 74 6f 72 2e 2e 2e } //00 00 
	condition:
		any of ($a_*)
...
rule Rogue_Win32_FakePowav_7{
	...
	strings :
		$a_00_0 = {53 79 73 74 65 6d 20 77 69 6c 6c 20 62 65 20 72 65 73 74 6f 72 65 64 20 69 6e 20 25 64 20 73 65 63 6f 6e 64 73 2e } //01 00 
		$a_00_1 = {2a 2a 2a 20 53 54 4f 50 3a 20 30 78 30 30 30 30 30 30 31 39 20 28 30 78 30 30 30 30 30 30 30 30 2c 30 78 63 30 30 45 30 46 46 30 2c 30 78 46 46 46 46 45 46 44 34 2c 30 78 43 30 30 30 30 30 30 30 29 } //02 00 
		$a_01_2 = {42 41 44 5f 46 4f 4f 4c 5f 48 45 41 44 45 52 00 } //02 00 
		$a_01_3 = {44 6c 6c 20 42 61 73 65 20 44 41 74 65 53 74 6d 70 20 2d 20 4e 61 6d 65 } //04 00 
...
rule Rogue_Win32_FakePowav_8{
	...
	strings :
		...
		$a_01_2 = {2f 6f 72 64 65 72 2e 70 68 70 3f 6c 61 6e 67 3d 65 6e 26 61 69 64 3d } //01 00 
...
rule Rogue_Win32_FakePowav_9{
	...
	strings :
		$a_00_0 = {53 70 79 20 50 72 6f 74 65 63 74 6f 72 } //01 00 
		$a_00_1 = {53 79 73 74 65 6d 20 50 72 6f 74 65 63 74 6f 72 } //02 00 
...
rule Rogue_Win32_FakePowav_10{
	...
	strings :
		$a_00_0 = {53 70 79 20 50 72 6f 74 65 63 74 6f 72 } //01 00 
		$a_00_1 = {53 79 73 74 65 6d 20 50 72 6f 74 65 63 74 6f 72 } //04 00 
...
rule Rogue_Win32_FakePowav_11{
	...
	strings :
		...
		$a_00_1 = {57 49 4e 58 44 45 46 45 4e 44 45 52 5f 42 41 53 45 } //02 00 
		$a_01_2 = {2f 6f 72 64 65 72 2e 70 68 70 3f 6c 61 6e 67 3d 65 6e 26 61 69 64 3d } //01 00 
		$a_00_3 = {44 65 73 63 72 69 70 74 69 6f 6e 3a 20 57 33 32 2e 53 70 79 62 6f 74 2e 41 51 47 46 20 69 73 20 61 20 77 6f 72 6d 20 74 68 61 74 20 73 70 72 65 61 64 73 20 74 68 72 6f 75 67 68 20 6d 49 52 43 20 61 6e 64 20 74 6f 20 6e 65 74 77 6f 72 6b } //01 00 
		$a_00_4 = {44 65 73 63 72 69 70 74 69 6f 6e 3a 20 54 72 6f 6a 61 6e 2e 47 6f 6c 64 75 6e 2e 47 20 69 73 20 61 20 54 72 6f 6a 61 6e 20 68 6f 72 73 65 20 70 72 6f 67 72 61 6d 20 74 68 61 74 20 73 74 65 61 6c 73 20 70 61 73 73 77 6f 72 64 73 } //02 00 
		$a_00_5 = {53 65 63 75 72 69 74 79 20 43 65 6e 74 65 72 5f 41 70 70 4d 61 6e 61 67 65 72 5f 73 65 72 76 65 72 5f 6d 75 74 65 78 00 } //02 00 
		$a_00_6 = {53 65 63 75 72 69 74 79 20 43 65 6e 74 65 72 5f 41 70 70 4d 61 6e 61 67 65 72 5f 73 65 6e 64 5f 65 76 65 6e 74 00 } //01 00 
...
rule Rogue_Win32_FakePowav_13{
	...
	strings :
		$a_01_0 = {59 47 48 65 6c 70 65 72 2e 44 4c 4c 00 44 6c 6c 43 61 6e 55 6e 6c 6f 61 64 4e 6f 77 } //01 00 
		$a_01_1 = {59 47 48 65 6c 70 65 72 2e 53 65 61 72 63 68 48 65 6c 70 65 72 } //01 00 
		$a_01_2 = {31 46 32 44 39 43 34 37 2d 36 41 43 39 2d 34 38 37 32 2d 41 41 43 43 2d 45 31 43 44 34 39 34 46 30 34 30 43 } //00 00 
	condition:
		any of ($a_*)
...
rule Rogue_Win32_FakePowav_14{
	...
	strings :
		$a_01_0 = {67 6f 6f 67 6c 69 6e 61 2e 44 4c 4c 00 44 6c 6c 43 61 6e 55 6e 6c 6f 61 64 4e 6f 77 00 44 6c 6c 47 65 74 43 6c 61 73 73 4f 62 6a 65 63 74 00 44 6c 6c 52 65 67 69 73 74 65 72 53 65 72 76 65 72 00 44 6c 6c 55 6e 72 65 67 69 73 74 65 72 53 65 72 76 65 72 } //01 00 
		$a_01_1 = {34 34 64 36 38 39 37 62 2d 36 36 66 62 2d 34 64 31 39 2d 38 66 35 61 2d 35 63 61 66 33 36 36 35 63 31 33 66 } //01 00 
		$a_01_2 = {62 36 36 38 31 63 34 39 2d 63 38 38 32 2d 34 34 38 34 2d 62 35 39 65 2d 33 32 39 66 36 66 63 35 61 33 62 37 } //00 00 
	condition:
		any of ($a_*)
...
rule Rogue_Win32_FakePowav_15{
	...
	strings :
		$a_01_0 = {72 61 70 69 64 61 6e 74 69 76 69 72 75 73 2e 63 6f 6d } //01 00 
		$a_01_1 = {5b 53 70 79 77 61 72 65 2e 43 79 62 65 72 41 6c 65 72 74 32 3b } //01 00 
		$a_01_2 = {50 72 6f 63 65 73 73 65 73 54 6f 4b 69 6c 6c 3d 31 } //01 00 
		$a_01_3 = {52 65 67 4b 65 79 73 56 61 6c 75 65 54 6f 44 65 6c 65 74 65 3d 31 } //01 00 
		$a_01_4 = {44 65 73 63 72 69 70 74 69 6f 6e 3a } //01 00 
		$a_01_5 = {41 64 76 69 63 65 3a } //01 00 
		$a_01_6 = {41 6c 65 72 74 20 6c 65 76 65 6c 3a } //01 00 
		$a_01_7 = {57 69 6e 64 6f 77 73 5c 43 75 72 72 65 6e 74 56 65 72 73 69 6f 6e 5c 52 75 6e 5c 22 44 65 66 61 75 6c 74 22 } //01 00 
		$a_01_8 = {73 75 70 70 6f 72 74 40 65 75 72 65 6b 61 6c 6f 67 2e 63 6f 6d } //00 00 
	condition:
		any of ($a_*)
...
rule Rogue_Win32_FakePowav_16{
	...
	strings :
		...
		$a_01_1 = {48 6f 77 54 6f 42 75 79 2e 74 78 74 } //0a 00 
		$a_01_2 = {43 3a 5c 44 6f 63 75 6d 65 6e 74 73 20 61 6e 64 20 53 65 74 74 69 6e 67 73 5c 4a 6f 68 6e 44 6f 65 5c 44 65 73 6b 74 6f } //0a 00 
		$a_01_3 = {41 72 65 20 79 6f 75 20 73 75 72 65 20 79 6f 75 20 77 61 6e 74 20 74 6f 20 75 6e 69 6e 73 74 61 6c 6c } //01 00 
		$a_01_4 = {5c 52 61 70 69 64 20 41 6e 74 69 76 69 72 75 73 } //01 00 
		$a_01_5 = {57 69 6e 58 20 53 65 63 75 72 69 74 79 20 43 65 6e 74 65 72 00 } //01 00 
		$a_01_6 = {5c 57 69 6e 20 41 6e 74 69 76 69 72 20 32 30 30 38 } //01 00 
		$a_01_7 = {57 69 6e 58 44 65 66 65 6e 64 65 72 } //01 00 
		$a_01_8 = {57 69 6e 58 50 72 6f 74 65 63 74 6f 72 } //01 00 
		$a_01_9 = {50 6f 77 65 72 2d 41 6e 74 69 76 69 72 75 73 2d 32 30 30 39 } //00 00 
	condition:
		any of ($a_*)
