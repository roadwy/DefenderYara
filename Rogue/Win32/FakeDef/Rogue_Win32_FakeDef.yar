...
rule Rogue_Win32_FakeDef{
	...
	strings :
		...
		$a_03_1 = {ff 50 04 89 45 fc 83 7d fc 00 0f 84 90 01 02 00 00 8b 45 90 01 01 83 c0 14 90 00 } //1
	condition:
...
rule Rogue_Win32_FakeDef_2{
	...
	strings :
		...
		$a_03_3 = {bf 19 00 02 00 57 33 db 53 68 90 01 04 68 02 00 00 80 ff d6 85 c0 0f 90 01 05 8d 90 01 02 50 57 53 68 90 00 } //1
	condition:
