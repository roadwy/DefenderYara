...
rule Rogue_Win32_InternetAntivirus_5{
	...
	strings :
		$a_03_0 = {78 6f 6f 6d 65 72 2e 61 6c 69 63 65 2e 69 74 [0-20] 55 8b ec 33 c0 55 68 ?? ?? 40 00 64 ff 30 64 89 20 } //1
...
rule Rogue_Win32_InternetAntivirus_6{
	...
	strings :
		...
		$a_03_1 = {50 6a 00 6a 2a e8 ?? ?? ?? ?? 8b f0 85 f6 74 ?? 6a 00 e8 } //1
		$a_03_2 = {8b 03 50 8d 85 ?? ?? ff ff 50 e8 ?? ?? ?? ?? 85 c0 75 14 ba ?? ?? ?? ?? 8b 85 ?? ?? ff ff e8 } //1
		...
		$a_03_5 = {50 6a 00 6a 02 e8 ?? ?? ?? ?? 8b f0 85 f6 74 ?? 56 e8 ?? ?? ?? ?? 56 e8 } //1
	condition:
...
rule Rogue_Win32_InternetAntivirus_8{
	...
	strings :
		$a_02_0 = {2f 76 65 72 79 73 69 6c 65 6e 74 20 2f 6e 6f 72 65 73 74 61 72 74 20 2f 4e 4f 43 41 4e 43 45 4c 20 2f 44 49 52 3d 22 [0-20] 5c 49 6e 74 65 72 6e 65 74 20 41 6e 74 69 76 69 72 75 73 20 50 72 6f 22 20 2f 70 61 73 73 77 6f 72 64 3d 61 76 69 72 00 } //1
		$a_02_1 = {2f 64 6f 77 6e 6c 6f 61 64 2f 49 70 61 63 6b [0-08] 2e 6a 70 67 00 } //1
		$a_00_2 = {2f 64 6f 77 6e 6c 6f 61 64 2f 66 69 6c 65 2e 6a 70 67 00 } //1
		$a_02_3 = {2f 76 65 72 79 73 69 6c 65 6e 74 20 2f 6e 6f 72 65 73 74 61 72 74 20 2f 4e 4f 43 41 4e 43 45 4c 20 2f 44 49 52 3d 22 [0-20] 5c 47 65 6e 65 72 61 6c 20 41 6e 74 69 76 69 72 75 73 22 20 2f 70 61 73 73 77 6f 72 64 3d 67 65 6e } //1
	condition:
...
rule Rogue_Win32_InternetAntivirus_9{
	...
	strings :
		$a_03_0 = {6a 04 51 52 6a 00 ff 15 ?? ?? ?? ?? 83 f8 07 75 16 8d 4c 24 ?? c6 84 24 ?? ?? 00 00 00 e8 ?? ?? ?? ?? e9 ?? ?? 00 00 68 ?? ?? ?? ?? b9 ?? ?? ?? ?? e8 ?? ?? ?? ?? 8d 4c 24 ?? c6 84 24 ?? ?? 00 00 00 e8 } //1
...
rule Rogue_Win32_InternetAntivirus_10{
	...
	strings :
		$a_03_0 = {41 6a 30 8d 4d ?? 33 d2 b8 ?? ?? ?? ?? e8 ?? ?? ?? ?? 8b 45 ?? e8 ?? ?? ?? ?? 50 8d 4d ?? 33 d2 b8 ?? ?? ?? ?? e8 ?? ?? ?? ?? 8b 45 ?? e8 ?? ?? ?? ?? 50 6a 00 e8 90 09 03 00 3c 06 (74|75) } //10
...
rule Rogue_Win32_InternetAntivirus_11{
	...
	strings :
		...
		$a_02_2 = {25 00 73 00 5c 00 25 00 73 00 5f 00 25 00 [0-06] 64 5f 00 25 00 [0-06] 64 2e 00 65 00 78 00 65 00 } //1
...
rule Rogue_Win32_InternetAntivirus_12{
	...
	strings :
		$a_03_0 = {53 68 2e 70 6e 67 00 90 09 02 00 69 } //10
...
rule Rogue_Win32_InternetAntivirus_13{
	...
	strings :
		$a_02_0 = {46 00 69 00 6c 00 65 00 44 00 65 00 73 00 63 00 72 00 69 00 70 00 74 00 69 00 6f 00 6e 00 [0-06] 49 00 6e 00 74 00 65 00 72 00 6e 00 65 00 74 00 [0-04] 41 00 6e 00 74 00 69 00 76 00 69 00 72 00 75 00 73 00 [0-10] 46 00 69 00 6c 00 65 00 56 00 65 00 72 00 73 00 69 00 6f 00 6e 00 [0-30] 49 00 6e 00 74 00 65 00 72 00 6e 00 61 00 6c 00 4e 00 61 00 6d 00 65 00 [0-04] 49 00 6e 00 74 00 65 00 72 00 6e 00 65 00 74 00 [0-04] 41 00 6e 00 74 00 69 00 76 00 69 00 72 00 75 00 73 00 } //1
		$a_02_1 = {50 00 72 00 6f 00 64 00 75 00 63 00 74 00 4e 00 61 00 6d 00 65 00 [0-08] 49 00 6e 00 74 00 65 00 72 00 6e 00 65 00 74 00 20 00 41 00 6e 00 74 00 69 00 76 00 69 00 72 00 75 00 73 00 } //1
		...
		$a_02_3 = {49 00 6e 00 74 00 65 00 72 00 6e 00 61 00 6c 00 4e 00 61 00 6d 00 65 00 [0-08] 55 00 70 00 64 00 61 00 74 00 65 00 20 00 49 00 6e 00 74 00 65 00 72 00 6e 00 65 00 74 00 20 00 41 00 6e 00 74 00 69 00 76 00 69 00 72 00 75 00 73 00 } //1
	condition:
...
rule Rogue_Win32_InternetAntivirus_14{
	...
	strings :
		...
		$a_03_1 = {53 68 2e 70 6e 67 00 90 09 02 00 69 } //100
