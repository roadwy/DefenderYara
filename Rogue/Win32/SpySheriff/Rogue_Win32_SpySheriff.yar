...
rule Rogue_Win32_SpySheriff_2{
	...
	strings :
		...
		$a_02_3 = {36 39 2e 35 30 2e 31 90 02 05 00 00 00 00 47 45 54 20 2f 90 00 } //1
	condition:
...
rule Rogue_Win32_SpySheriff_4{
	...
	strings :
		...
		$a_02_3 = {47 45 54 20 2f 74 72 69 61 6c 90 02 02 2e 70 68 70 3f 72 65 73 74 3d 25 75 26 76 65 72 3d 25 75 26 61 3d 30 30 30 30 30 30 30 30 20 48 54 54 50 2f 31 2e 30 90 00 } //1
...
rule Rogue_Win32_SpySheriff_5{
	...
	strings :
		...
		$a_02_3 = {47 45 54 20 2f 74 72 69 61 6c 90 02 02 2e 70 68 70 3f 72 65 73 74 3d 25 75 26 76 65 72 3d 25 75 26 61 3d 30 30 30 30 30 30 90 02 02 20 48 54 54 50 2f 31 2e 30 90 00 } //1
...
rule Rogue_Win32_SpySheriff_6{
	...
	strings :
		...
		$a_02_3 = {41 64 77 61 72 65 52 65 6d 6f 76 65 72 90 02 04 20 45 6e 64 20 55 73 65 72 20 4c 69 63 65 6e 73 65 20 41 67 72 65 65 6d 65 6e 74 90 00 } //1
		$a_02_4 = {41 64 77 61 72 65 52 65 6d 6f 76 65 72 90 02 07 20 53 65 74 75 70 90 00 } //1
		$a_00_5 = {41 72 65 20 79 6f 75 20 73 75 72 65 20 79 6f 75 20 77 69 73 68 20 74 6f 20 63 61 6e 63 65 6c 20 73 65 74 75 70 3f } //1 Are you sure you wish to cancel setup?
...
rule Rogue_Win32_SpySheriff_8{
	...
	strings :
		...
		$a_02_4 = {47 45 54 20 2f 74 72 69 61 6c 90 02 02 2e 70 68 70 3f 72 65 73 74 3d 25 75 26 76 65 72 3d 25 75 26 61 3d 30 30 30 30 30 30 30 30 20 48 54 54 50 2f 31 2e 30 90 00 } //1
...
rule Rogue_Win32_SpySheriff_9{
	...
	strings :
		$a_02_0 = {53 6f 66 74 77 61 72 65 5c 4d 69 63 72 6f 73 6f 66 74 5c 57 69 6e 64 6f 77 73 5c 43 75 72 72 65 6e 74 56 65 72 73 69 6f 6e 5c 52 75 6e 00 49 45 44 65 66 65 6e 64 65 72 90 02 05 49 45 20 44 65 66 65 6e 64 65 72 90 00 } //1
...
rule Rogue_Win32_SpySheriff_11{
	...
	strings :
		...
		$a_03_4 = {47 45 54 20 2f 64 6c 70 2e 70 68 70 3f 26 26 6d 3d 30 26 79 64 66 3d 34 32 33 30 39 39 32 26 65 3d 30 30 30 30 30 30 30 30 26 77 3d 5f 5f 5f 5f 5f 5f 90 01 02 26 74 3d 30 26 61 70 7a 78 3d 31 26 61 70 7a 3d 6d 79 61 70 70 2e 65 78 65 20 48 54 54 50 2f 31 2e 30 90 00 } //1
...
rule Rogue_Win32_SpySheriff_12{
	...
	strings :
		$a_02_0 = {5a 69 6e 61 70 73 20 41 6e 74 69 2d 53 70 79 77 61 72 65 20 32 30 30 90 01 01 2e 6c 6e 6b 90 00 } //1
		$a_02_1 = {5a 69 6e 61 70 73 32 30 30 90 01 01 5c 5a 69 6e 61 70 73 2e 65 78 65 90 00 } //1
