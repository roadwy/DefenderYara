...
rule Rogue_Win32_FakeSecSen_2{
	...
	strings :
		$a_02_0 = {50 6c 61 73 6d 61 5c 41 6e 74 69 76 69 72 75 73 2e 65 78 65 [0-20] 61 76 70 6c [0-20] 53 6f 66 74 77 61 72 65 5c 41 6e 74 69 76 69 72 75 73 [0-02] 50 6c 61 73 6d 61 [0-30] 41 75 74 6f 72 75 6e } //4
...
rule Rogue_Win32_FakeSecSen_3{
	...
	strings :
		...
		$a_03_1 = {aa 8d 41 ff 83 f8 07 0f 87 ?? ?? 00 00 ff 24 85 ?? (12|13) 00 10 be 01 00 00 00 e9 ?? ?? 00 00 } //3
		$a_03_2 = {a8 0e 00 00 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? a8 08 00 00 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? 68 05 00 00 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? a8 25 00 00 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? a8 10 00 00 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? 68 04 00 00 } //1
...
rule Rogue_Win32_FakeSecSen_4{
	...
	strings :
		$a_03_0 = {87 04 00 00 00 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? 55 00 00 00 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? 1f 01 00 00 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? 05 00 4c 00 2e 00 47 00 49 00 46 00 } //1
		$a_03_1 = {07 04 00 00 00 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? 4f 00 00 00 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? b6 01 00 00 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? c5 07 00 00 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? 05 00 4c 00 2e 00 47 00 49 00 46 00 } //1
		$a_03_2 = {d3 04 00 00 00 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? 4f 00 00 00 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? e0 00 00 00 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? (05 00 4c 00|06 00 4c 00 31 00) 2e 00 47 00 49 00 46 00 } //1
		$a_03_3 = {07 04 00 00 00 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? eb 00 00 00 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? 4f 00 00 00 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ea 00 00 00 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? 06 00 4c 00 31 00 2e 00 47 00 49 00 46 00 } //1
	condition:
...
rule Rogue_Win32_FakeSecSen_5{
	...
	strings :
		...
		$a_02_4 = {74 61 73 6b [0-04] 6b 69 6c 6c 20 2f 46 20 2f 49 4d } //3
		$a_03_5 = {83 f8 06 0f 85 ?? ?? 00 00 56 6a 00 68 ?? ?? ?? ?? ff 15 ?? ?? ?? ?? 68 e8 03 00 00 ff 15 ?? ?? ?? ?? 8b 35 ?? ?? ?? ?? 68 ?? ?? ?? ?? ff d6 } //5
		$a_03_6 = {6a 00 52 6a 00 6a 02 6a 00 68 ?? ?? ?? ?? 6a 00 50 68 01 00 00 80 ff 15 ?? ?? ?? ?? 68 ?? ?? ?? ?? 8b 4c 24 ?? 51 ff 15 } //4
		$a_03_7 = {83 f8 06 0f 85 ?? ?? 00 00 90 09 14 00 6a 04 68 ?? ?? ?? ?? 68 ?? ?? ?? ?? 6a 00 ff 15 } //4
	condition:
...
rule Rogue_Win32_FakeSecSen_7{
	...
	strings :
		$a_00_0 = {4c 65 6f 73 74 72 65 61 6d 43 6f 6e 6e 65 63 74 } //-100 LeostreamConnect
		...
		$a_02_9 = {53 4f 46 54 57 41 52 45 5c 4d 69 63 72 6f 73 6f 66 74 5c 57 69 6e 64 6f 77 73 5c 43 75 72 72 65 6e 74 56 65 72 73 69 6f 6e 5c 52 75 6e [0-04] 41 4e 54 49 56 49 52 55 53 00 } //1
		...
		$a_03_24 = {84 c0 0f 85 ?? ?? 00 00 e8 ?? ?? ?? ?? 84 c0 0f 85 ?? ?? 00 00 6a 00 e8 ?? ?? ?? ?? 83 c4 04 8b ce e8 ?? ?? ?? ?? 68 ?? ?? ?? ?? 6a 00 6a 01 6a 00 ?? ?? ?? ?? ?? ?? 85 c0 74 ?? ?? ?? ?? ?? ?? ?? 3d b7 00 00 00 } //10
		$a_03_25 = {6a 00 6a 01 6a 00 ?? ?? ?? ?? ?? ?? 85 c0 74 15 ?? ?? ?? ?? ?? ?? 3d b7 00 00 00 75 08 6a 00 ?? ?? ?? ?? ?? ?? 6a 00 8d 4c 24 ?? e8 ?? ?? ?? ?? 8d 44 24 ?? 8d 4c 24 ?? c7 84 24 ?? ?? 00 00 00 00 00 00 89 46 1c e8 } //10
		$a_03_26 = {33 d2 b9 03 00 00 00 ?? f7 f1 ?? c6 47 10 01 bd ?? ?? ?? ?? 83 ea 00 74 1a 4a 74 0d 4a 75 18 c7 44 24 ?? ?? ?? ?? ?? eb 0e c7 44 24 ?? ?? ?? ?? ?? eb } //8
		$a_03_27 = {33 d2 b9 03 00 00 00 c6 ?? 10 01 f7 f1 83 ea 00 74 20 4a 74 10 4a 75 25 8d 94 24 ?? ?? 00 00 89 54 24 ?? eb 18 8d 84 24 ?? ?? 00 00 89 44 24 ?? eb } //8
