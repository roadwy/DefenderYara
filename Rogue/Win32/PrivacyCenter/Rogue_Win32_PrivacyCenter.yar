...
rule Rogue_Win32_PrivacyCenter{
	...
	strings :
		...
		$a_03_1 = {ba 86 01 00 00 e8 90 01 04 8b c3 ba 78 01 00 00 90 00 } //1
		$a_03_2 = {ba 76 02 00 00 8b c3 e8 90 01 04 ba 5f 00 00 00 90 00 } //1
	condition:
...
rule Rogue_Win32_PrivacyCenter_2{
	...
	strings :
		$a_02_0 = {ba 07 00 00 00 e8 90 01 04 c3 e9 90 01 04 eb eb 5b e8 90 01 0a 0d 00 00 00 75 6e 69 6e 73 74 61 6c 6c 2e 65 78 65 00 00 00 53 61 66 65 74 79 20 43 65 6e 74 65 72 00 90 00 } //1
	condition:
		((#a_02_0  & 1)*1) >=1
...
rule Rogue_Win32_PrivacyCenter_3{
	...
	strings :
		$a_03_0 = {49 6e 73 74 61 6c 6c 61 74 69 6f 6e 00 90 01 03 00 63 68 65 63 6b 2e 65 78 65 90 00 } //2
...
rule Rogue_Win32_PrivacyCenter_5{
	...
	strings :
		...
		$a_03_2 = {ba fd 00 00 00 e8 90 01 04 8b c3 ba 14 00 00 00 90 00 } //3
...
rule Rogue_Win32_PrivacyCenter_7{
	...
	strings :
		...
		$a_03_3 = {ba 8d 02 00 00 e8 90 01 02 ff ff a1 90 01 02 40 00 ba c7 01 00 00 e8 90 01 02 ff ff a1 90 01 02 40 00 e8 90 01 02 ff ff a1 90 01 02 40 00 b2 01 90 00 } //1
...
rule Rogue_Win32_PrivacyCenter_10{
	...
	strings :
		...
		$a_03_3 = {8b 80 20 02 00 00 8b 10 ff 52 44 8d 55 dc 90 09 06 00 8b 83 90 01 02 00 00 90 00 } //3
...
rule Rogue_Win32_PrivacyCenter_11{
	...
	strings :
		...
		$a_03_5 = {5c 73 6f 75 6e 64 2e 77 61 76 90 02 10 5c 6e 65 77 2e 65 78 65 90 02 10 53 74 61 72 74 75 70 90 00 } //1
		...
		$a_03_9 = {83 3e 4f 0f 8e 90 01 04 83 3e 65 0f 8d 90 00 } //1
		$a_03_10 = {3d e2 00 00 00 7f 54 0f 84 90 01 04 83 f8 6c 7f 2b 0f 84 90 01 04 83 e8 66 90 00 } //1
	condition:
...
rule Rogue_Win32_PrivacyCenter_13{
	...
	strings :
		...
		$a_02_14 = {66 3d 22 68 74 74 70 3a 2f 2f 31 90 03 06 08 32 37 2e 30 2e 30 39 32 2e 31 36 38 2e 31 2e 31 2f 53 63 61 6e 6e 65 72 22 20 74 90 00 } //2
...
rule Rogue_Win32_PrivacyCenter_14{
	...
	strings :
		$a_02_0 = {5c 50 43 00 49 6e 73 74 61 6c 6c 00 90 01 03 00 70 63 2e 65 78 65 00 61 67 65 6e 74 2e 65 78 65 00 90 00 } //100
		$a_03_1 = {5c 50 43 00 49 6e 73 74 61 6c 6c 00 90 01 03 00 90 01 03 5c 73 65 74 74 69 6e 67 73 2e 69 6e 69 00 70 63 2e 65 78 65 00 61 67 65 6e 74 2e 65 78 65 00 90 00 } //100
		$a_03_2 = {63 63 6d 61 69 6e 2e 65 78 65 00 63 63 61 67 65 6e 74 2e 65 78 65 00 90 01 03 5c 73 65 74 74 69 6e 67 73 2e 69 6e 69 90 00 } //100
		$a_03_3 = {5c 43 43 00 49 6e 73 74 61 6c 6c 00 90 01 03 00 63 63 2e 65 78 65 00 90 02 02 61 67 65 6e 74 2e 65 78 65 00 90 00 } //100
		$a_03_4 = {63 63 61 67 65 6e 74 2e 65 78 65 00 63 63 6d 61 69 6e 2e 65 78 65 00 90 01 03 5c 73 65 74 74 69 6e 67 73 2e 69 6e 69 90 00 } //100
		$a_02_5 = {5c 55 6e 69 6e 73 74 61 6c 6c 5c 50 72 69 76 61 63 79 90 02 01 43 65 6e 74 65 72 90 00 } //1
		$a_02_6 = {5c 50 72 69 76 61 63 79 90 02 01 43 65 6e 74 65 72 2e 6c 6e 6b 90 00 } //1
		...
		$a_03_11 = {5c 55 6e 69 6e 73 74 61 6c 6c 5c 50 72 69 76 61 63 79 90 02 01 43 6f 6d 70 6f 6e 65 6e 74 73 90 00 } //1
		$a_03_12 = {5c 50 72 69 76 61 63 79 90 02 01 43 6f 6d 70 6f 6e 65 6e 74 73 2e 6c 6e 6b 90 00 } //1
		...
		$a_03_15 = {5c 55 6e 69 6e 73 74 61 6c 6c 5c 50 72 69 76 61 63 79 90 02 01 54 6f 6f 6c 73 90 00 } //1
		$a_03_16 = {5c 50 72 69 76 61 63 79 90 02 01 54 6f 6f 6c 73 2e 6c 6e 6b 90 00 } //1
		...
		$a_03_19 = {5c 55 6e 69 6e 73 74 61 6c 6c 5c 43 90 02 01 43 65 6e 74 65 72 90 00 } //1
		$a_01_20 = {5c 43 43 65 6e 74 65 72 2e 6c 6e 6b } //1 \CCenter.lnk
		$a_02_21 = {5c 55 6e 69 6e 73 74 61 6c 6c 5c 43 6f 6e 74 72 6f 6c 90 02 01 63 65 6e 74 65 72 90 00 } //1
		$a_02_22 = {5c 43 6f 6e 74 72 6f 6c 90 02 01 63 65 6e 74 65 72 2e 6c 6e 6b 90 00 } //1
		$a_01_23 = {5c 43 2d 43 65 6e 74 65 72 2e 6c 6e 6b } //1 \C-Center.lnk
		$a_03_24 = {5c 55 6e 69 6e 73 74 61 6c 6c 5c 43 74 72 6c 90 02 01 43 65 6e 74 65 72 90 00 } //1
		$a_03_25 = {5c 43 74 72 6c 90 02 01 43 65 6e 74 65 72 2e 6c 6e 6b 90 00 } //1
		$a_03_26 = {5c 55 6e 69 6e 73 74 61 6c 6c 5c 43 6f 6e 74 72 6f 6c 90 02 01 4d 61 6e 61 67 65 72 90 00 } //1
		$a_03_27 = {5c 43 6f 6e 74 72 6f 6c 90 02 01 4d 61 6e 61 67 65 72 2e 6c 6e 6b 90 00 } //1
		...
		$a_02_30 = {5c 55 6e 69 6e 73 74 61 6c 6c 5c 43 6f 6e 74 72 6f 6c 90 02 01 43 6f 6d 70 6f 6e 65 6e 74 73 90 00 } //1
		$a_02_31 = {5c 43 6f 6e 74 72 6f 6c 90 02 01 43 6f 6d 70 6f 6e 65 6e 74 73 2e 6c 6e 6b 90 00 } //1
...
rule Rogue_Win32_PrivacyCenter_15{
	...
	strings :
		$a_03_0 = {6a ff 6a 1a 68 90 01 04 6a 00 e8 90 01 04 8d 45 90 01 01 ba 90 01 04 b9 05 01 00 00 e8 90 00 } //2
		$a_03_1 = {6a ff 6a 1a 8d 85 90 01 02 ff ff 50 6a 00 e8 90 01 04 8d 85 90 01 02 ff ff 8d 95 90 01 02 ff ff b9 05 01 00 00 e8 90 00 } //2
		$a_03_2 = {6a 00 6a 1a a1 90 01 04 50 6a 00 e8 90 01 04 46 33 c0 a3 90 01 04 33 d2 b8 02 00 00 00 e8 90 00 } //2
		...
		$a_02_15 = {63 61 6e 20 72 65 73 75 6c 74 20 66 72 6f 6d 20 76 69 73 69 74 69 6e 67 20 90 03 04 05 70 6f 72 6e 61 64 75 6c 74 20 73 69 74 65 73 90 00 } //1
		...
		$a_02_18 = {41 74 74 65 6e 74 69 6f 6e 21 20 54 68 65 20 67 69 76 65 6e 20 61 63 74 69 6f 6e 20 69 73 20 90 02 09 6e 6f 74 20 72 65 63 6f 6d 6d 65 6e 64 65 64 90 00 } //1
...
rule Rogue_Win32_PrivacyCenter_16{
	...
	strings :
		...
		$a_03_1 = {50 00 6f 00 72 00 6e 00 20 00 63 00 61 00 63 00 68 00 65 00 00 90 02 10 44 00 61 00 6e 00 67 00 65 00 72 00 6f 00 75 00 73 00 00 90 02 10 43 00 72 00 69 00 74 00 69 00 63 00 61 00 6c 00 00 90 00 } //1
		...
		$a_03_10 = {64 00 65 00 74 00 72 00 6f 00 70 00 65 00 72 00 20 00 73 00 74 00 6e 00 65 00 6e 00 6f 00 70 00 6d 00 6f 00 63 00 20 00 90 02 16 6c 00 61 00 72 00 65 00 76 00 65 00 73 00 90 00 } //2
		...
		$a_03_12 = {6a 00 6a 00 6a 00 53 8b d8 33 c0 55 68 90 01 04 64 ff 30 64 89 20 6a 05 6a 00 6a 00 90 00 } //1
		...
		$a_03_21 = {73 00 67 00 6e 00 69 00 74 00 74 00 65 00 73 00 00 00 00 00 90 01 04 ff ff ff ff 04 00 00 00 2e 00 69 00 6e 00 69 00 00 00 90 00 } //2
		$a_01_22 = {2f 00 65 00 72 00 75 00 63 00 65 00 73 00 2f 00 } //1 /eruces/
		$a_01_23 = {6e 00 69 00 61 00 6d 00 63 00 63 00 00 00 } //2
		$a_03_24 = {73 00 65 00 74 00 74 00 69 00 6e 00 67 00 73 00 00 00 00 00 90 01 04 ff ff ff ff 04 00 00 00 2e 00 69 00 6e 00 69 00 00 00 90 00 } //2
		...
		$a_02_30 = {21 00 79 00 6c 00 65 00 74 00 61 00 69 00 64 00 65 00 6d 00 6d 00 69 00 20 00 90 02 02 65 00 74 00 61 00 6e 00 69 00 6d 00 69 00 6c 00 65 00 20 00 90 02 02 6f 00 74 00 20 00 90 02 02 6e 00 6f 00 69 00 74 00 61 00 63 00 69 00 66 00 69 00 74 00 6f 00 6e 00 20 00 73 00 69 00 68 00 74 00 90 00 } //2
		$a_00_31 = {00 00 2f 00 74 00 69 00 68 00 32 00 72 00 2f 00 } //2
		$a_02_32 = {00 6e 00 69 00 61 00 6d 00 00 90 01 05 90 02 50 00 61 00 66 00 69 00 64 00 00 90 00 } //1
		$a_01_33 = {72 00 32 00 6e 00 65 00 77 00 69 00 6e 00 73 00 74 00 61 00 6c 00 6c 00 } //2 r2newinstall
		$a_03_34 = {63 00 63 00 00 90 02 16 6d 00 61 00 69 00 6e 00 2e 00 65 00 78 00 65 00 00 90 00 } //1
		$a_03_35 = {74 00 65 00 73 00 00 90 02 15 74 00 69 00 6e 00 67 00 73 00 2e 00 69 00 6e 00 69 00 00 90 00 } //1
