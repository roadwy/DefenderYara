...
rule Rogue_Win32_FakeYak{
	...
	strings :
		...
		$a_03_1 = {69 64 3d 25 73 26 68 61 73 68 3d 00 50 4f 53 54 90 02 05 2f 90 02 05 2e 65 78 65 90 00 } //1
	condition:
...
rule Rogue_Win32_FakeYak_2{
	...
	strings :
		...
		$a_03_1 = {33 c9 0f b6 81 90 01 04 8b d0 c1 ea 04 8a 92 90 01 04 83 e0 0f 90 00 } //1
...
rule Rogue_Win32_FakeYak_5{
	...
	strings :
		...
		$a_03_3 = {6d 65 73 73 61 67 65 3d 90 02 0a 74 69 70 3d 90 00 } //1
		$a_02_4 = {53 00 65 00 63 00 75 00 72 00 69 00 74 00 79 00 43 00 65 00 6e 00 74 00 65 00 72 00 90 02 20 41 00 63 00 74 00 69 00 76 00 61 00 74 00 65 00 6e 00 6f 00 77 00 90 02 20 41 00 66 00 74 00 65 00 72 00 53 00 63 00 61 00 6e 00 90 00 } //1
		$a_03_5 = {56 69 72 74 c7 85 90 01 04 75 61 6c 50 c7 85 90 01 04 72 6f 74 65 66 c7 90 01 04 ff 63 74 88 9d 90 01 04 ff d6 90 00 } //2
	condition:
