...
rule Rogue_Win32_FakeXPA_27{
	...
	strings :
		...
		$a_80_7 = {58 65 6e 41 6e 74 69 53 70 79 77 61 72 65 5f 72 75 6e 6e 69 6e 67 } //XenAntiSpyware_running  65516
	condition:
		((#a_01_0  & 1)*10+(#a_01_1  & 1)*10+(#a_00_2  & 1)*5+(#a_00_3  & 1)*5+(#a_01_4  & 1)*5+(#a_01_5  & 1)*1+(#a_01_6  & 1)*1+(#a_80_7  & 1)*65516) >=11
