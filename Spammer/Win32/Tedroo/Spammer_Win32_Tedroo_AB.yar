...
rule Spammer_Win32_Tedroo_AB{
	...
	strings :
		...
		$a_03_12 = {33 c0 8a c8 80 c1 90 01 01 30 88 90 01 04 40 83 f8 90 01 01 72 ef 90 00 } //2
		$a_03_13 = {33 c9 8b d0 2b 91 90 01 04 81 fa 60 ea 00 00 76 0a c7 81 90 01 04 02 00 00 00 83 c1 04 83 f9 14 7c de 90 09 06 00 ff 15 90 00 } //2
	condition:
