...
rule Spammer_Win32_EmailBomb_H{
	...
	strings :
		$a_02_0 = {68 74 74 70 3a 2f 2f 70 72 6f 74 65 63 74 79 6f 75 72 70 63 2d 31 ?? 2e 63 6f 6d 2f 69 65 } //1
		...
		$a_02_3 = {68 74 74 70 3a 2f 2f 70 72 6f 74 65 63 74 79 6f 75 72 70 63 2d 31 ?? 2e 63 6f 6d 2f 6f 75 74 32 2f 6d 73 6e 5f 69 6d 61 69 6c 65 72 5f 76 [0-02] 2e 74 78 74 } //1
	condition:
