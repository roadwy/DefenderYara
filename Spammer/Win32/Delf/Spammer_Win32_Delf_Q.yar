...
rule Spammer_Win32_Delf_Q{
	...
	strings :
		$a_03_0 = {4b 85 db 7c ?? 8b ?? ?? c1 e0 06 03 d8 89 ?? ?? 83 c7 06 83 ff 08 7c ?? 83 ef 08 8b cf 8b ?? ?? d3 eb 8b cf b8 01 00 00 00 d3 e0 50 8b ?? ?? 5a 8b ca 99 f7 f9 89 ?? ?? 81 e3 ff 00 00 80 79 08 4b 81 cb 00 ff ff ff 43 } //3
