...
rule Spammer_Win32_Mapegost_A{
	...
	strings :
		...
		$a_03_3 = {6d 6f 64 65 3d 67 65 74 90 02 08 26 75 69 64 3d 25 73 26 6f 73 3d 25 73 26 70 69 64 3d 25 73 26 66 6c 61 67 73 3d 25 73 26 73 65 6e 74 3d 25 69 26 61 63 63 90 00 } //1
	condition:
