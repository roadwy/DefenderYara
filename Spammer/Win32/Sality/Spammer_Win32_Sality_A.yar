...
rule Spammer_Win32_Sality_A{
	...
	strings :
		...
		$a_01_3 = {5b 56 41 52 25 64 } //01 00 
		$a_01_4 = {53 50 4d 5f 49 44 3d 25 64 } //01 00 
		$a_01_5 = {24 66 72 6f 6d 5f 6d 61 69 6c 24 } //01 00 
		$a_01_6 = {24 47 45 4e 5f 50 45 52 5f 4d 41 49 4c 24 3d } //01 00 
		$a_01_7 = {25 73 3f 66 75 63 6b 3d 70 6f 72 74 26 6d 78 5f 3d 25 64 26 73 6d 74 70 5f 3d 25 64 } //01 00 
		$a_01_8 = {26 73 5f 69 64 3d 25 64 26 76 65 72 3d 25 64 26 72 3d 25 64 } //00 00 
	condition:
		any of ($a_*)
