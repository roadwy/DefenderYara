...
rule Adware_Win64_OffersWizardInstaller{
	...
	strings :
		...
		$a_01_1 = {6e 65 74 68 74 73 72 76 2e 65 78 65 22 20 2d 6e 66 64 69 20 2f 72 76 6d } //01 00  nethtsrv.exe" -nfdi /rvm
		$a_01_2 = {02 25 25 5c 64 72 69 76 65 72 73 00 6e 65 74 68 66 64 72 76 2e 73 79 73 } //00 00  │尥牤癩牥s敮桴摦癲献獹
	condition:
		any of ($a_*)
