...
rule Adware_Win32_Hotbar_4{
	...
	strings :
		$a_03_0 = {0f be 14 37 8a 92 90 01 04 88 16 46 3b f1 76 ef 90 00 } //1
...
rule Adware_Win32_Hotbar_7{
	...
	strings :
		$a_02_0 = {56 8b 74 24 08 8b 0e 8b 01 8b 50 10 57 ff d2 83 7e 0c 00 8d 4e 0c 7c 90 01 01 3b 06 75 90 01 01 8b fe b8 01 00 00 00 f0 0f c1 01 90 00 } //1
...
rule Adware_Win32_Hotbar_8{
	...
	strings :
		...
		$a_03_3 = {50 61 72 74 6e 65 72 90 01 05 43 72 61 7a 79 4c 6f 61 64 65 72 20 31 2e 33 90 00 } //1
	condition:
...
rule Adware_Win32_Hotbar_9{
	...
	strings :
		...
		$a_03_2 = {03 c1 8b 4d 0c 8d 4c 08 ff 80 39 00 74 90 01 01 8b 7d 10 8b f0 2b f8 0f be 14 37 8a 92 90 01 04 88 16 46 3b f1 76 ef 90 00 } //1
	condition:
...
rule Adware_Win32_Hotbar_13{
	...
	strings :
		$a_03_0 = {74 17 57 8b fa 2b f8 0f be 14 37 8a 92 90 01 04 88 16 46 3b f1 76 ef 5f 90 00 } //3
...
rule Adware_Win32_Hotbar_18{
	...
	strings :
		$a_02_0 = {54 65 73 74 69 6e 67 20 66 6f 72 90 02 08 54 6f 6f 6c 62 61 72 90 00 } //1
...
rule Adware_Win32_Hotbar_20{
	...
	strings :
		$a_03_0 = {54 65 73 74 69 6e 67 20 66 6f 72 20 48 42 90 02 04 4c 69 74 65 00 90 00 } //1
...
rule Adware_Win32_Hotbar_21{
	...
	strings :
		...
		$a_02_1 = {48 4f 4f 4b 5f 44 4c 4c 3a 20 48 69 64 65 20 41 90 02 08 77 69 6e 64 6f 77 20 28 30 78 25 78 29 90 00 } //1
...
rule Adware_Win32_Hotbar_22{
	...
	strings :
		$a_02_0 = {6e 70 63 6c 6e 74 61 78 5f 48 42 90 02 05 53 41 2e 64 6c 6c 90 00 } //1
		$a_02_1 = {48 00 42 00 4c 00 69 00 74 00 65 00 90 02 02 41 00 58 00 2e 00 49 00 6e 00 90 02 02 66 00 6f 00 90 00 } //1
...
rule Adware_Win32_Hotbar_23{
	...
	strings :
		...
		$a_02_3 = {42 69 6c 6c 79 42 6f 62 90 02 08 20 77 69 6e 64 6f 77 20 63 6c 61 73 73 20 72 65 67 69 73 74 65 72 20 65 72 72 6f 72 3a 20 25 64 2e 90 00 } //1
...
rule Adware_Win32_Hotbar_26{
	...
	strings :
		$a_02_0 = {68 57 00 07 80 e8 90 01 04 8b 03 57 ff 75 0c 8b 78 f4 2b f0 e8 90 01 04 3b f7 5f ff 75 0c 77 90 01 01 8d 0c 30 51 ff 75 0c 50 e8 90 00 } //1
...
rule Adware_Win32_Hotbar_28{
	...
	strings :
		...
		$a_03_2 = {6d 61 6e 69 66 65 73 74 90 02 01 72 65 61 64 66 61 69 6c 65 64 90 00 } //1
		$a_00_3 = {76 69 63 70 61 72 61 6d 65 74 65 72 73 } //1 vicparameters
		$a_03_4 = {69 63 73 6d 90 02 01 61 6e 69 66 65 73 74 00 90 00 } //1
		$a_03_5 = {53 65 74 74 69 6e 67 90 02 02 4b 65 79 90 02 08 44 65 62 75 67 90 00 } //1
		$a_03_6 = {5f 6b 65 79 90 02 02 6f 66 90 02 02 64 65 62 75 67 90 02 02 73 65 74 74 69 6e 67 73 90 00 } //1
		$a_03_7 = {5f 72 65 67 90 02 02 76 61 6c 75 65 90 02 02 6e 61 6d 65 90 02 02 6c 6f 67 90 02 02 65 6e 61 62 6c 65 90 00 } //1
	condition:
...
rule Adware_Win32_Hotbar_29{
	...
	strings :
		$a_03_0 = {74 18 8b 7d 10 8b f0 2b f8 0f be 14 37 8a 92 90 01 04 88 16 46 3b f1 76 ef 90 00 } //100
		$a_02_1 = {76 61 6c 75 65 61 64 64 2f 50 69 6e 67 2f 90 02 05 2e 68 74 6d 90 00 } //10
		$a_00_2 = {49 00 6e 00 73 00 61 00 74 00 6c 00 6c 00 53 00 74 00 61 00 72 00 74 00 65 00 64 00 } //10 InsatllStarted
		$a_02_3 = {64 6f 77 6e 6c 6f 61 64 73 90 02 03 2e 70 6c 61 74 72 69 75 6d 2e 63 6f 6d 90 00 } //1
		$a_02_4 = {64 6f 77 6e 6c 6f 61 64 73 90 02 03 2e 70 69 6e 62 61 6c 6c 63 6f 72 70 2e 63 6f 6d 90 00 } //1
...
rule Adware_Win32_Hotbar_37{
	...
	strings :
		$a_02_0 = {54 68 69 73 20 90 02 04 61 64 90 02 04 69 73 20 66 72 6f 6d 20 48 6f 74 62 61 72 90 00 } //10
...
rule Adware_Win32_Hotbar_39{
	...
	strings :
		...
		$a_03_1 = {65 6e 61 62 6c 65 90 02 02 74 73 90 02 02 6c 6f 67 90 00 } //5
...
rule Adware_Win32_Hotbar_40{
	...
	strings :
		...
		$a_03_24 = {65 6e 61 62 6c 65 90 02 02 74 73 90 02 02 6c 6f 67 90 00 } //1
...
rule Adware_Win32_Hotbar_42{
	...
	strings :
		...
		$a_03_2 = {80 39 00 74 18 8b 7d 90 01 01 8b f0 2b f8 0f be 14 37 8a 92 90 01 04 88 16 46 3b f1 76 ef 90 00 } //2
		$a_01_3 = {8b c1 32 c9 88 88 00 01 00 00 88 88 01 01 00 00 88 88 02 01 00 00 c3 } //1
		$a_03_4 = {0f be 14 37 8a 92 90 01 04 88 16 46 3b f1 76 ef 90 00 } //2
		...
		$a_03_13 = {65 6e 61 62 6c 65 90 02 02 74 73 90 02 02 6c 6f 67 90 00 } //1
		$a_03_14 = {65 6e 61 62 6c 65 90 02 02 74 68 65 90 02 02 74 73 90 02 02 6c 6f 67 90 00 } //1
		$a_03_15 = {65 6e 61 62 6c 65 90 02 02 6c 6f 67 67 69 6e 67 90 02 02 72 65 67 76 61 6c 75 65 6e 61 6d 65 90 00 } //1
		$a_01_16 = {65 6e 61 62 6c 65 5f 6c 6f 67 5f 74 68 65 5f 72 65 67 5f 76 61 6c 75 65 5f 6e 61 6d 65 00 } //1 湥扡敬江杯瑟敨牟来癟污敵湟浡e
		$a_03_17 = {64 65 62 75 67 90 02 02 73 65 74 74 69 6e 67 73 90 02 02 72 65 67 6b 65 79 6e 61 6d 65 90 00 } //1
		$a_03_18 = {72 65 67 5f 6b 65 79 90 02 01 6e 61 6d 65 5f 66 6f 72 90 02 05 64 65 62 75 67 90 02 02 73 65 74 74 69 6e 67 73 90 00 } //1
		$a_01_19 = {74 68 65 5f 72 65 67 6b 65 79 5f 6f 66 5f 64 65 62 75 67 5f 73 65 74 74 69 6e 67 73 00 } //1
		$a_03_20 = {6c 6f 67 5f 65 6e 61 62 6c 65 5f 90 02 04 72 65 67 5f 76 61 6c 75 65 90 02 02 6e 61 6d 65 90 00 } //1
		$a_03_21 = {6c 6f 67 67 69 6e 67 90 02 02 65 6e 61 62 6c 65 90 02 02 72 65 67 90 02 02 76 61 6c 75 65 90 02 02 6e 61 6d 65 90 00 } //1
		$a_03_22 = {74 68 65 5f 64 65 62 75 67 90 02 02 73 65 74 74 69 6e 67 73 5f 72 65 67 5f 6b 65 79 6e 61 6d 65 90 00 } //1
		...
		$a_03_40 = {70 70 6e 5f 76 69 63 90 02 01 73 6b 69 70 90 00 } //1
		...
		$a_02_64 = {26 62 6e 61 6d 65 3d 26 65 69 64 3d 90 01 04 26 62 76 65 72 3d 26 76 65 72 3d 26 6d 74 3d 30 30 4e 90 00 } //1
		$a_02_65 = {26 62 6e 61 6d 65 3d 26 65 69 64 3d 90 01 04 26 62 76 65 72 3d 26 74 69 6d 65 3d 2d 30 30 31 2f 2d 31 2f 2d 31 25 32 30 2d 31 3a 2d 31 3a 2d 31 90 00 } //1
		$a_02_66 = {26 62 6e 61 6d 65 3d 26 65 69 64 3d 90 01 04 26 75 70 67 3d 6e 26 62 76 65 72 3d 26 74 69 6d 65 3d 2d 30 30 31 2f 2d 31 2f 2d 31 25 32 30 2d 31 3a 2d 31 3a 2d 31 90 00 } //1
		$a_02_67 = {26 62 6e 61 6d 65 3d 26 65 69 64 3d 90 01 04 26 68 64 69 64 3d 30 30 2d 30 30 2d 30 30 2d 30 30 2d 30 30 2d 30 30 26 75 70 67 3d 6e 26 62 76 65 72 3d 90 00 } //1
		$a_03_68 = {7c 63 73 63 69 64 7c 90 02 10 68 64 69 64 7c 6d 74 90 00 } //1
		...
		$a_03_85 = {6d 61 6e 69 66 65 73 74 90 02 01 72 65 61 64 66 61 69 6c 65 64 90 00 } //1
		$a_01_86 = {62 00 73 00 61 00 69 00 74 00 65 00 73 00 74 00 } //1 bsaitest
		$a_03_87 = {25 30 34 64 25 30 32 64 25 30 32 64 25 30 32 64 25 30 32 64 25 30 32 64 2e 25 30 33 90 02 01 75 2e 25 90 02 03 75 00 90 00 } //1
...
rule Adware_Win32_Hotbar_43{
	...
	strings :
		...
		$a_03_65 = {25 00 64 00 2f 00 25 00 64 00 2f 00 25 00 30 00 34 00 64 00 20 00 25 00 64 00 3a 00 25 00 30 00 32 00 64 00 3a 00 25 00 30 00 32 00 64 00 20 00 25 00 90 02 02 73 00 90 00 } //1
		$a_03_66 = {25 00 30 00 34 00 64 00 25 00 30 00 32 00 64 00 25 00 30 00 32 00 64 00 25 00 30 00 32 00 64 00 25 00 30 00 32 00 64 00 25 00 30 00 32 00 64 00 2e 00 25 00 30 00 33 00 75 00 2e 00 25 00 90 02 02 75 00 90 00 } //1
		...
		$a_02_68 = {74 00 65 00 2e 00 61 00 73 00 70 00 78 00 3f 00 72 00 6e 00 64 00 3d 00 90 02 06 26 00 76 00 65 00 72 00 3d 00 90 00 } //1
		$a_02_69 = {74 00 65 00 2e 00 61 00 73 00 70 00 78 00 3f 00 61 00 78 00 30 00 3d 00 90 01 0d 26 00 72 00 6e 00 64 00 3d 00 90 01 06 26 00 76 00 65 00 72 00 3d 00 90 00 } //1
