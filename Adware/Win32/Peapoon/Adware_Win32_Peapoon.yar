...
rule Adware_Win32_Peapoon_2{
	...
	strings :
		$a_03_0 = {6a 02 6a 00 6a 01 6a 00 6a 04 8d 8d 90 01 02 ff ff 56 c7 85 90 01 02 ff ff 90 01 04 89 8d 90 01 02 ff ff ff d7 56 ff 15 90 01 04 8d b5 90 01 02 ff ff e8 90 00 } //1
