...
rule Adware_Win32_PennyBeeLinkury{
	...
	strings :
		...
		$a_03_1 = {5c 4d 6f 6e 65 74 69 7a 61 74 69 6f 6e 5c 53 6d 61 72 74 62 61 72 2e 4d 6f 6e 65 74 69 7a 61 74 69 6f 6e 2e 49 6e 6a 65 63 74 41 70 70 5c 6f 62 6a 90 02 04 5c 52 65 6c 65 61 73 65 5c 73 6d 69 61 2e 70 64 62 90 00 } //1
