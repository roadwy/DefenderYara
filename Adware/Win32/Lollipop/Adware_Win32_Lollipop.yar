...
rule Adware_Win32_Lollipop_2{
	...
	strings :
		$a_03_0 = {40 33 db 3b c2 0f 9c c3 f6 c3 90 01 01 75 90 00 } //10
...
rule Adware_Win32_Lollipop_3{
	...
	strings :
		$a_03_0 = {41 33 db 3b ca 0f 9c c3 f6 c3 90 01 01 75 90 00 } //10
		$a_01_1 = {3f 41 56 44 6f 67 40 40 } //1 ?AVDog@@
		$a_01_2 = {3f 41 56 4d 61 6d 6d 61 6c 40 40 } //1 ?AVMammal@@
		$a_01_3 = {3f 41 56 41 6e 69 6d 61 6c 40 40 } //1 ?AVAnimal@@
		$a_01_4 = {3f 41 56 43 61 74 40 40 } //1 ?AVCat@@
...
rule Adware_Win32_Lollipop_4{
	...
	strings :
		$a_03_0 = {46 33 db 3b f2 0f 9c c3 f6 c3 90 01 01 75 90 00 } //10
		$a_01_1 = {3f 41 56 44 6f 67 40 40 } //1 ?AVDog@@
		$a_01_2 = {3f 41 56 4d 61 6d 6d 61 6c 40 40 } //1 ?AVMammal@@
		$a_01_3 = {3f 41 56 41 6e 69 6d 61 6c 40 40 } //1 ?AVAnimal@@
		$a_01_4 = {3f 41 56 43 61 74 40 40 } //1 ?AVCat@@
...
rule Adware_Win32_Lollipop_5{
	...
	strings :
		$a_03_0 = {c7 41 18 07 00 00 00 89 90 01 01 14 68 90 09 06 00 6a 05 33 90 01 01 33 90 00 } //1
...
rule Adware_Win32_Lollipop_6{
	...
	strings :
		$a_03_0 = {03 c6 33 db 3b c2 0f 9c c3 f6 c3 90 01 01 75 90 00 } //10
		$a_01_1 = {3f 41 56 44 6f 67 40 40 } //1 ?AVDog@@
		$a_01_2 = {3f 41 56 4d 61 6d 6d 61 6c 40 40 } //1 ?AVMammal@@
		$a_01_3 = {3f 41 56 41 6e 69 6d 61 6c 40 40 } //1 ?AVAnimal@@
		$a_01_4 = {3f 41 56 43 61 74 40 40 } //1 ?AVCat@@
...
rule Adware_Win32_Lollipop_7{
	...
	strings :
		$a_03_0 = {03 c7 33 d2 3b c1 0f 9c c2 f6 c2 90 01 01 75 90 00 } //10
		$a_01_1 = {3f 41 56 44 6f 67 40 40 } //1 ?AVDog@@
		$a_01_2 = {3f 41 56 4d 61 6d 6d 61 6c 40 40 } //1 ?AVMammal@@
		$a_01_3 = {3f 41 56 41 6e 69 6d 61 6c 40 40 } //1 ?AVAnimal@@
		$a_01_4 = {3f 41 56 43 61 74 40 40 } //1 ?AVCat@@
...
rule Adware_Win32_Lollipop_13{
	...
	strings :
		...
		$a_03_6 = {68 e8 03 00 00 ff 15 90 01 04 ff 74 24 0c ff 74 24 08 e8 cf ff ff ff 90 00 } //1
	condition:
...
rule Adware_Win32_Lollipop_14{
	...
	strings :
		$a_02_0 = {53 31 33 5f 00 90 02 0f 00 73 90 01 01 6f 90 01 01 66 90 01 01 74 90 01 01 77 90 01 01 61 90 01 01 72 90 01 01 65 90 01 01 5c 90 01 01 6c 90 01 01 6f 90 01 01 6c 90 01 01 6c 90 01 01 69 90 01 01 70 90 01 01 6f 90 01 01 70 90 00 } //5
...
rule Adware_Win32_Lollipop_15{
	...
	strings :
		...
		$a_03_2 = {50 75 62 6c 69 73 68 65 72 20 49 44 20 69 73 90 0a ff 00 73 90 01 01 6f 90 01 01 66 90 01 01 74 90 01 01 77 90 01 01 61 90 01 01 72 90 01 01 65 90 01 01 5c 90 01 01 6c 90 01 01 6f 90 01 01 6c 90 01 01 6c 90 01 01 69 90 01 01 70 90 01 01 6f 90 01 01 70 90 00 } //2
...
rule Adware_Win32_Lollipop_16{
	...
	strings :
		$a_03_0 = {ff d6 89 5d f0 80 7d 90 01 01 4f 75 06 80 7d 90 01 01 4b 74 1c 90 00 } //2
...
rule Adware_Win32_Lollipop_19{
	...
	strings :
		$a_01_0 = {38 37 34 39 34 61 30 62 61 38 66 38 66 39 34 65 66 64 37 64 65 62 63 61 66 39 31 38 } //1 87494a0ba8f8f94efd7debcaf918
		$a_03_1 = {46 31 5f 00 53 31 5f 00 38 90 02 05 37 90 02 05 34 90 02 05 39 90 02 05 34 90 02 05 61 90 00 } //1
		...
		$a_03_7 = {76 00 30 00 76 00 30 00 76 00 90 02 10 73 90 01 01 6f 90 01 01 66 90 01 0d 6c 90 01 01 6f 90 01 01 6c 90 01 01 6c 90 01 01 69 90 00 } //1
		...
		$a_03_10 = {26 6f 73 69 32 3d 90 02 05 26 6f 73 69 31 3d 90 02 05 26 61 73 3d 90 02 05 26 66 77 3d 90 02 05 26 61 76 3d 90 00 } //1
		$a_03_11 = {26 6f 73 69 39 3d 90 02 05 26 61 64 6d 69 6e 3d 90 02 05 26 6c 61 73 74 65 72 72 6f 72 3d 90 02 05 26 61 76 65 72 72 6f 72 3d 90 00 } //1
