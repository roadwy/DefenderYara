...
rule Adware_Win32_Eorezo_4{
	...
	strings :
		$a_03_0 = {8a 04 31 bf 00 01 00 00 2c 90 01 01 0f be c0 99 f7 ff 88 14 31 41 3b 4d 08 7c 90 01 01 56 e8 90 01 04 59 50 56 8d 4d e0 ff 15 90 00 } //1
...
rule Adware_Win32_Eorezo_5{
	...
	strings :
		$a_03_0 = {51 c7 04 24 90 01 01 00 00 00 e8 90 01 04 85 c0 74 09 8b 04 24 83 c0 90 01 01 89 04 24 8b 0c 24 ff 14 8d 90 01 04 33 c0 59 c3 90 00 } //1
		$a_03_1 = {8a 10 33 c9 83 c0 02 84 d2 0f 84 90 01 01 00 00 00 8d 9b 00 00 00 00 0f b6 d2 03 ca 8b d1 c1 ea 90 01 01 c1 e1 90 01 01 0b d1 81 f2 90 01 04 8b ca 8a 10 83 c0 02 84 d2 75 e0 81 f9 90 01 04 74 90 00 } //1
	condition:
...
rule Adware_Win32_Eorezo_6{
	...
	strings :
		...
		$a_03_4 = {41 67 65 6e 63 65 90 02 0c 2e 63 70 70 90 00 } //1
	condition:
...
rule Adware_Win32_Eorezo_7{
	...
	strings :
		$a_03_0 = {39 5d 08 c6 45 fc 02 89 5d f0 7e 90 01 01 8b 7d 0c 8b 37 56 e8 90 01 04 59 50 56 ff 75 c8 8d 4d c0 53 ff 15 90 00 } //1
		$a_03_1 = {8a 04 31 bf 00 01 00 00 2c 0a 0f be c0 99 f7 ff 88 14 31 41 3b 4d 08 7c 90 01 01 56 e8 90 01 04 59 50 56 8d 4d e0 ff 15 90 01 04 56 e8 90 00 } //1
...
rule Adware_Win32_Eorezo_8{
	...
	strings :
		$a_03_0 = {c0 e8 04 8a 55 90 01 01 24 03 c0 e1 02 02 c1 80 e2 0f 88 45 90 01 01 8a 45 90 01 01 8a c8 24 03 c0 e9 02 c0 e0 06 02 45 90 01 01 80 e1 0f c0 e2 04 02 ca 90 00 } //1
		$a_03_1 = {8b 45 e0 59 3b c3 59 75 90 01 01 b8 90 01 04 6a 05 53 68 90 01 04 50 68 90 01 04 53 ff 15 90 01 04 53 90 00 } //1
...
rule Adware_Win32_Eorezo_10{
	...
	strings :
		$a_03_0 = {68 00 30 40 00 ff 35 90 01 04 ff 15 90 01 04 81 3d 90 01 06 00 00 74 00 83 3d 90 01 04 ff 74 0c ff 35 90 01 04 ff 15 90 01 04 6a 01 68 90 01 04 68 90 01 04 68 90 01 04 e8 05 00 00 00 6f 70 65 6e 00 6a 00 ff 15 90 00 } //1
		$a_03_1 = {c7 45 00 3c 00 00 00 c7 45 04 40 01 00 00 8b 44 24 68 89 45 1c b8 90 01 04 89 45 0c 8b 04 24 89 45 10 8b 44 24 08 89 45 14 8b 44 24 04 89 45 18 8d 44 24 0c 50 e8 90 00 } //1
...
rule Adware_Win32_Eorezo_11{
	...
	strings :
		$a_02_0 = {5c 72 65 6c 65 61 73 65 5f 65 6f 72 65 7a 6f 5c 45 6f 52 65 7a 6f 90 02 08 2e 70 64 62 90 00 } //10
...
rule Adware_Win32_Eorezo_13{
	...
	strings :
		...
		$a_03_1 = {5c 52 65 6c 65 61 73 65 5c 74 75 74 6f 34 70 63 5f 90 02 06 2e 70 64 62 90 00 } //10
		$a_01_2 = {63 00 6f 00 6e 00 66 00 2e 00 63 00 79 00 6c 00 } //1 conf.cyl
