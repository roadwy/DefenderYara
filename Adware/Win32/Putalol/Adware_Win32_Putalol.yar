...
rule Adware_Win32_Putalol{
	...
	strings :
		$a_03_0 = {8a 04 30 8b 4d ?? 32 04 0f 8d 4d ?? 0f b6 c0 50 6a 01 e8 } //2
		$a_01_1 = {49 00 6e 00 73 00 74 00 61 00 6c 00 6c 00 5f 00 44 00 69 00 72 00 00 00 } //1
		$a_03_2 = {8a 04 08 8d 4d ?? 32 04 1e 0f b6 c0 50 6a 01 e8 90 09 05 00 8b c7 8b 4d } //2
...
rule Adware_Win32_Putalol_2{
	...
	strings :
		$a_03_0 = {49 83 fb 10 48 0f 43 c3 42 0f b6 14 10 4c 8d 45 ?? 4c 0f 43 c3 ?? 0f b6 ce 41 f6 d1 0f b6 ca f6 d1 ?? 22 ce 41 0f b6 c1 22 c2 0a c8 43 88 0c 10 } //2
		$a_03_1 = {49 83 f9 10 49 0f 43 c3 41 0f b6 14 02 4c 8d 45 ?? 4d 0f 43 c3 0f b6 ca f6 d1 41 22 ce 41 0f b6 c6 f6 d0 22 c2 0a c8 43 88 0c 10 } //2
		$a_03_2 = {44 8d 40 39 48 8d 15 ?? ?? ?? ?? 48 8d 4c 24 ?? e8 ?? ?? ?? ?? 48 8b d8 90 09 03 00 41 b1 } //1
		$a_03_3 = {48 8b d8 41 b1 ?? 41 b8 ?? 00 00 00 48 8d 15 ?? ?? ?? ?? 48 8d 4d ?? e8 90 09 19 00 41 b1 ?? 41 b8 ?? 00 00 00 48 8d 15 ?? ?? ?? ?? 48 8d 4d ?? e8 } //1
	condition:
...
rule Adware_Win32_Putalol_3{
	...
	strings :
		...
		$a_03_6 = {8b 75 08 85 c9 75 ?? 68 ?? 00 00 00 6a 0c 8d 45 ?? 68 ?? ?? ?? ?? 50 e8 ?? ?? ?? ?? 83 c4 10 83 65 ?? 00 83 78 14 10 72 02 8b 00 50 e8 } //2
		...
		$a_03_11 = {8a 04 50 32 c3 0f b6 c0 66 89 04 51 8d 45 ?? 8b 75 ?? 83 fe 08 8b 7d ?? 0f 43 c7 32 1c 50 42 3b 55 ?? 72 cd } //2
