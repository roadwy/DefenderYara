...
rule Adware_Win32_Bayads{
	...
	strings :
		...
		$a_03_2 = {8d 50 d8 80 fa 56 77 1a 0f be c0 83 e8 28 78 90 01 01 8b 15 90 01 04 8b 12 3b 42 f4 7f 90 01 01 8a 04 02 eb 09 3c 25 75 05 a0 90 01 04 88 01 43 41 3b de 72 90 00 } //1
	condition:
