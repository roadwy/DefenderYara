...
rule Adware_Win32_ClickPotato{
	...
	strings :
		$a_03_0 = {03 c1 8b 4d 0c 8d 4c 08 ff 80 39 00 74 90 01 01 8b 7d 10 8b f0 2b f8 0f be 14 37 8a 92 90 01 04 88 16 46 3b f1 76 ef 90 00 } //1
...
rule Adware_Win32_ClickPotato_3{
	...
	strings :
		$a_02_0 = {43 6c 69 63 6b 50 6f 74 61 74 6f 90 02 05 53 41 48 6f 6f 6b 2e 64 6c 6c 90 00 } //5
...
rule Adware_Win32_ClickPotato_4{
	...
	strings :
		$a_02_0 = {6e 70 63 6c 6e 74 61 78 5f 43 6c 69 63 6b 50 6f 74 61 74 6f 90 02 05 53 41 2e 64 6c 6c 90 00 } //1
...
rule Adware_Win32_ClickPotato_5{
	...
	strings :
		...
		$a_03_1 = {8d 34 01 3b f7 7e 90 14 8b 4d 08 a1 90 01 04 03 c1 8b 4d 0c 8d 4c 08 ff 80 39 00 74 18 8b 7d 10 8b f0 2b f8 0f be 14 37 8a 92 90 01 04 88 16 46 3b f1 76 ef 90 00 } //1
		$a_03_2 = {63 61 6c 44 72 69 76 65 00 00 00 00 50 68 79 73 69 00 00 90 01 0d 53 43 53 49 44 49 53 4b 00 00 00 00 90 00 } //1
	condition:
...
rule Adware_Win32_ClickPotato_9{
	...
	strings :
		$a_02_0 = {54 68 69 73 20 41 64 90 02 04 69 73 20 66 72 6f 6d 20 43 6c 69 63 6b 50 6f 74 61 74 6f 90 00 } //5
...
rule Adware_Win32_ClickPotato_11{
	...
	strings :
		$a_03_0 = {03 c1 8b 4d 0c 8d 4c 08 ff 80 39 00 74 90 01 01 8b 7d 10 8b f0 2b f8 0f be 14 37 8a 92 90 01 04 88 16 46 3b f1 76 ef 90 00 } //10
		...
		$a_02_4 = {64 6f 77 6e 6c 6f 61 64 73 90 02 03 2e 70 6c 61 74 72 69 75 6d 2e 63 6f 6d 90 00 } //1
...
rule Adware_Win32_ClickPotato_12{
	...
	strings :
		...
		$a_03_3 = {0f b6 56 05 88 57 05 0f b6 4e 06 88 4f 06 0f b6 56 07 50 57 8b cb 88 57 07 e8 90 01 04 83 c6 08 83 c7 08 83 ed 01 75 9d 90 00 } //1
		$a_03_4 = {8d 44 24 1c 50 8d 4c 24 24 51 8b cf e8 90 01 04 8b 57 04 8b 44 24 20 89 04 16 8b 4f 04 8b 54 24 1c 89 54 0e 04 83 c6 08 83 eb 01 75 d2 81 fe 00 10 00 00 7c c5 90 00 } //1
	condition:
...
rule Adware_Win32_ClickPotato_13{
	...
	strings :
		...
		$a_02_1 = {67 00 65 00 74 00 72 00 90 02 02 73 00 73 00 2e 00 63 00 6c 00 90 02 02 69 00 63 00 6b 00 70 00 6f 00 74 00 61 00 90 02 02 74 00 6f 00 2e 00 63 00 6f 00 6d 00 2f 00 90 00 } //1
		$a_80_2 = {48 54 4d 4c 50 6f 70 75 70 4d 65 6e 75 5f 43 6c 61 73 73 } //HTMLPopupMenu_Class  1
		$a_02_3 = {43 6c 69 63 6b 50 6f 74 61 74 6f 90 02 05 53 41 42 48 4f 2e 44 4c 4c 90 00 } //5
...
rule Adware_Win32_ClickPotato_14{
	...
	strings :
		$a_03_0 = {33 c0 c3 ff 35 90 01 04 e8 90 01 04 59 c3 6a 20 68 90 01 04 e8 90 00 } //1
		$a_03_1 = {56 8b 74 24 08 8b 0e 8b 01 8b 50 10 57 ff d2 83 7e 0c 00 8d 4e 0c 7c 90 01 01 3b 06 75 90 01 01 8b fe b8 01 00 00 00 f0 0f c1 01 90 00 } //1
		$a_02_2 = {43 6c 69 63 6b 50 6f 74 61 74 6f 90 02 05 53 41 42 48 4f 2e 44 4c 4c 90 00 } //1
		...
		$a_02_4 = {73 00 73 00 2e 00 63 00 6c 00 69 00 90 02 02 63 00 6b 00 70 00 90 02 06 74 00 61 00 74 00 90 00 } //1
		$a_02_5 = {70 00 6f 00 74 00 61 00 74 00 6f 00 90 02 06 72 00 73 00 73 00 2e 00 63 00 6c 00 69 00 63 00 6b 00 90 00 } //1
...
rule Adware_Win32_ClickPotato_15{
	...
	strings :
		...
		$a_02_3 = {48 4f 4f 4b 5f 44 4c 4c 3a 20 48 69 64 65 20 41 90 02 08 77 69 6e 64 6f 77 20 28 30 78 25 78 29 90 00 } //1
		...
		$a_02_8 = {42 69 6c 6c 79 42 6f 62 90 02 08 20 77 69 6e 64 6f 77 20 63 6c 61 73 73 20 72 65 67 69 73 74 65 72 20 65 72 72 6f 72 3a 20 25 64 2e 90 00 } //1
