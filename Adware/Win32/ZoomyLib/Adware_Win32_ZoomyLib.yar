...
rule Adware_Win32_ZoomyLib_2{
	...
	strings :
		...
		$a_03_3 = {53 6f 66 74 77 61 72 65 5c 31 90 04 02 03 30 2d 39 5f 33 31 90 00 } //10
...
rule Adware_Win32_ZoomyLib_4{
	...
	strings :
		...
		$a_03_2 = {55 8b ec 51 c7 45 fc 65 03 00 c0 e8 90 01 04 0f b6 c0 85 c0 74 34 e8 90 01 04 0f b6 c0 85 c0 74 90 00 } //1
	condition:
...
rule Adware_Win32_ZoomyLib_5{
	...
	strings :
		$a_03_0 = {48 8b f8 ff 15 90 01 04 8b d8 85 c0 74 10 ba 20 4e 00 00 48 8b cf ff 15 90 01 04 eb 05 e8 90 01 04 85 db 75 db 33 c9 e8 90 01 04 cc 48 8b c4 55 48 8d a8 98 fc ff ff 48 81 ec 60 04 00 00 90 00 } //1
		$a_03_1 = {48 8b 5c 24 20 48 8b cb ff 15 90 01 04 48 85 c0 74 18 48 8d 15 90 01 04 48 8b c8 ff 15 90 01 04 48 85 c0 74 03 ff d0 90 00 } //1
...
rule Adware_Win32_ZoomyLib_6{
	...
	strings :
		$a_03_0 = {8b 40 30 0f b6 40 02 89 45 fc 39 7d fc 74 0e 68 20 4e 00 00 56 ff 15 90 01 04 eb 05 e8 0c 00 00 00 39 7d fc 75 d3 57 e8 90 01 04 cc 55 81 ec 10 04 00 00 8d 6c 24 fc a1 90 01 04 33 c5 89 85 10 04 00 00 6a 04 90 00 } //1
		$a_03_1 = {8b 75 f0 56 ff 15 90 01 04 85 c0 74 12 68 90 01 04 50 ff 15 90 01 04 85 c0 74 02 ff d0 90 00 } //1
...
rule Adware_Win32_ZoomyLib_9{
	...
	strings :
		...
		$a_03_6 = {74 61 6d 6d 67 31 90 04 02 03 30 2d 39 00 90 00 } //64
	condition:
...
rule Adware_Win32_ZoomyLib_11{
	...
	strings :
		...
		$a_03_5 = {83 4d fc ff 59 a1 90 01 04 83 78 f4 00 75 1d 6a 02 59 e8 90 01 04 68 90 01 04 ff 30 68 90 01 04 56 e8 90 01 04 83 c4 10 8b c6 e8 90 01 04 c3 90 00 } //1
	condition:
...
rule Adware_Win32_ZoomyLib_14{
	...
	strings :
		...
		$a_03_3 = {83 4d fc ff 59 a1 90 01 04 83 78 f4 00 75 1d 6a 02 59 e8 90 01 04 68 90 01 04 ff 30 68 90 01 04 56 e8 90 01 04 83 c4 10 8b c6 e8 90 01 04 c3 90 00 } //10
		$a_03_4 = {8d 44 24 10 50 57 57 68 90 01 04 57 57 e8 90 01 04 83 c4 18 b1 01 6a 02 5a e8 90 01 04 68 90 01 04 6a 01 57 ff 15 90 01 04 8b d8 85 db 0f 84 b8 00 00 00 ff 15 90 01 04 3d b7 00 00 00 90 00 } //10
	condition:
...
rule Adware_Win32_ZoomyLib_16{
	...
	strings :
		$a_03_0 = {31 00 30 00 30 00 38 00 30 00 30 00 90 04 01 03 30 2d 39 00 90 04 01 03 30 2d 39 00 00 00 00 00 31 00 31 00 39 00 00 00 31 00 30 00 30 00 38 00 90 00 } //4
...
rule Adware_Win32_ZoomyLib_18{
	...
	strings :
		...
		$a_03_9 = {74 61 6d 6d 67 52 31 31 90 04 01 03 30 2d 39 00 90 00 } //10
	condition:
...
rule Adware_Win32_ZoomyLib_19{
	...
	strings :
		...
		$a_03_2 = {31 00 30 00 30 00 38 00 30 00 30 00 90 04 01 03 30 2d 39 00 90 04 01 03 30 2d 39 00 00 00 00 00 31 00 31 00 39 00 00 00 31 00 30 00 30 00 38 00 90 00 } //1
