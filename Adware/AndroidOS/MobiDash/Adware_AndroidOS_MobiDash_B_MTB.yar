...
rule Adware_AndroidOS_MobiDash_B_MTB{
	...
	strings :
		$a_03_0 = {70 10 bb d6 01 00 12 00 5b 10 ?? ?? 12 00 5c 10 ?? ?? 0e 00 06 00 02 00 04 00 03 00 ?? ?? 4a 00 46 00 00 00 22 00 ?? ?? 12 01 70 30 } //1
		$a_03_1 = {63 6f 6d 2f 6d 63 73 6b 69 6e 32 31 2f 44 72 65 61 6d 2f [0-20] 6f 6e 43 72 65 61 74 65 } //1
