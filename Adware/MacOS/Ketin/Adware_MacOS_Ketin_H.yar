...
rule Adware_MacOS_Ketin_H{
	...
	strings :
		$a_02_0 = {02 00 80 74 08 90 01 01 c8 48 ff c8 48 83 f8 90 01 01 77 f2 90 00 } //2
		...
		$a_02_3 = {48 8d 4d c8 48 89 4c 24 28 31 c9 48 89 4c 24 10 48 89 4c 24 08 48 89 04 24 c7 44 24 20 02 00 00 00 c7 44 24 18 00 00 00 00 bf 01 00 00 00 be 04 00 00 00 31 d2 b9 01 00 00 00 4d 89 90 01 01 49 89 d9 e8 90 00 } //2
	condition:
