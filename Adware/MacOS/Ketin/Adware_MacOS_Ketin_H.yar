...
rule Adware_MacOS_Ketin_H{
	...
	strings :
		...
		$a_00_1 = {55 52 4c 46 6f 72 41 70 70 6c 69 63 61 74 69 6f 6e 54 6f 4f 70 65 6e 55 52 4c } //01 00 
		$a_00_2 = {77 69 6c 6c 50 65 72 66 6f 72 6d 48 54 54 50 52 65 64 69 72 65 63 74 69 6f 6e } //02 00 
