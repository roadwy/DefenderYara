...
rule Misleading_MacOS_BlueBlood_E_xp{
	...
	strings :
		$a_00_0 = {42 72 6f 77 73 65 72 49 6e 6a 65 63 74 6f 72 45 78 74 } //01 00 
		$a_00_1 = {46 6c 65 78 69 53 50 59 } //01 00 
		$a_00_2 = {4d 65 73 73 61 67 65 50 6f 72 74 49 50 43 53 65 6e 64 65 72 2e 68 } //01 00 
