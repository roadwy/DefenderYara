...
rule Misleading_AndroidOS_SmsReg_D_xp{
	...
	strings :
		...
		$a_02_3 = {78 71 32 2e 31 32 37 37 35 32 37 2e 63 6f 6d 2f 30 39 30 31 3f 90 01 04 3a 2f 2f 31 31 31 2e 31 33 2e 34 37 2e 37 36 3a 38 31 2f 6f 70 65 6e 5f 67 61 74 65 2f 77 65 62 5f 67 61 6d 65 5f 66 65 65 2e 70 68 70 90 00 } //1
