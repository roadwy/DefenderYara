...
rule Misleading_Win32_Winfixer{
	...
	strings :
		...
		$a_02_7 = {68 84 00 00 00 50 8d 4c 24 20 e8 ?? ?? ?? ff 57 68 85 00 00 00 e8 ?? ?? ?? ff 83 c4 08 3b c7 74 0f 68 85 00 00 00 50 8d 4c 24 2c e8 ?? ?? ?? ff 57 68 82 00 00 00 e8 ?? ?? ?? ff 83 c4 08 3b c7 74 0f 68 82 00 00 00 50 8d 4c 24 14 e8 } //1
	condition:
