...
rule Misleading_Win32_Sistakasti{
	...
	strings :
		...
		$a_03_2 = {43 72 65 61 74 65 73 20 61 20 73 68 6f 72 74 63 75 74 20 74 6f 20 53 79 73 74 65 6d 20 43 6c 65 61 6e 65 72 20 90 02 03 20 6f 6e 20 79 6f 75 72 20 51 75 69 63 6b 20 4c 61 75 6e 63 68 20 66 6f 6c 64 65 72 90 00 } //1
		$a_03_3 = {5c 53 79 73 74 65 6d 20 43 6c 65 61 6e 65 72 20 90 02 03 5c 55 74 69 6c 69 74 69 65 73 5c 50 6f 69 6e 74 73 74 6f 6e 65 20 44 69 73 6b 20 44 65 66 72 61 67 2e 6c 6e 6b 90 00 } //1
	condition:
