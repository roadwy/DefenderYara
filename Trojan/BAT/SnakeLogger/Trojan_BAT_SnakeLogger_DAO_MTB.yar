...
rule Trojan_BAT_SnakeLogger_DAO_MTB{
	...
	strings :
		...
		$a_01_1 = {44 6f 6f 64 6c 65 4a 75 6d 70 2e 50 72 6f 70 65 72 74 69 65 73 2e 52 65 73 6f 75 72 63 65 73 2e 72 65 73 6f 75 72 63 65 73 } //01 00  DoodleJump.Properties.Resources.resources
