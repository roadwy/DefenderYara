...
rule Trojan_BAT_SnakeLogger_DAN_MTB{
	...
	strings :
		...
		$a_01_1 = {57 69 6e 64 6f 77 73 46 6f 72 6d 73 41 70 70 6c 69 63 61 74 69 6f 6e 31 2e 43 68 6f 69 63 65 50 72 6f 66 69 6c 65 2e 72 65 73 6f 75 72 63 65 73 } //00 00  WindowsFormsApplication1.ChoiceProfile.resources
	condition:
		any of ($a_*)
