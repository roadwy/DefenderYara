...
rule Trojan_BAT_CoinMiner_ABJA_MTB{
	...
	strings :
		$a_03_0 = {08 03 2d 18 07 06 28 90 01 03 0a 72 90 01 03 70 6f 90 01 03 0a 6f 90 01 03 0a 2b 16 07 06 28 90 01 03 0a 72 90 01 03 70 6f 90 01 03 0a 6f 90 01 03 0a 17 73 90 01 03 0a 0d 09 02 16 02 8e 69 6f 90 01 03 0a 09 6f 90 01 03 0a de 0a 09 2c 06 09 6f 90 01 03 0a dc 90 00 } //2
