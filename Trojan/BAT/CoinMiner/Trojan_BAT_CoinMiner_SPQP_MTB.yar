...
rule Trojan_BAT_CoinMiner_SPQP_MTB_2{
	...
	strings :
		...
		$a_81_1 = {70 68 6e 69 70 68 70 63 73 69 76 6a 74 79 79 63 67 63 6c 6a 66 70 68 61 } //02 00 
		$a_01_2 = {65 00 76 00 62 00 61 00 70 00 7a 00 68 00 6f 00 6e 00 75 00 77 00 75 00 68 00 69 00 65 00 75 00 } //00 00 
	condition:
		any of ($a_*)
