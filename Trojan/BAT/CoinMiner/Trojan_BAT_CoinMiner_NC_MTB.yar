...
rule Trojan_BAT_CoinMiner_NC_MTB_2{
	...
	strings :
		$a_03_0 = {6f 5e 00 00 0a 17 73 90 01 03 0a 0c 08 02 16 02 8e 69 6f 56 00 00 0a 90 00 } //01 00 
		$a_01_1 = {68 00 74 00 74 00 70 00 3a 00 2f 00 2f 00 31 00 38 00 35 00 2e 00 31 00 37 00 32 00 2e 00 31 00 32 00 38 00 2e 00 31 00 31 00 2f 00 } //00 00  http://185.172.128.11/
	condition:
		any of ($a_*)
