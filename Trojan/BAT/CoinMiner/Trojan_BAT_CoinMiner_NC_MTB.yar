...
rule Trojan_BAT_CoinMiner_NC_MTB{
	...
	strings :
		$a_03_0 = {72 96 04 00 70 80 90 01 03 04 20 01 00 00 00 16 39 90 01 03 ff 26 38 78 ff ff ff 72 90 01 03 70 80 01 00 00 04 38 d6 ff ff ff 90 00 } //5
...
rule Trojan_BAT_CoinMiner_NC_MTB_2{
	...
	strings :
		$a_03_0 = {6f 5e 00 00 0a 17 73 90 01 03 0a 0c 08 02 16 02 8e 69 6f 56 00 00 0a 90 00 } //5
...
rule Trojan_BAT_CoinMiner_NC_MTB_3{
	...
	strings :
		$a_03_0 = {6f 28 00 00 0a 6f 90 01 02 00 0a 13 04 73 90 01 02 00 0a 13 05 11 05 11 04 28 90 01 02 00 06 73 90 01 02 00 0a 13 06 00 11 06 02 28 90 01 02 00 06 02 8e 69 6f 90 01 02 00 0a 00 11 06 6f 90 01 02 00 0a 00 11 05 6f 90 01 02 00 0a 13 07 de 4e 90 00 } //5
		$a_03_1 = {28 1b 00 00 0a 0a 73 90 01 01 00 00 0a 0b 06 02 6f 90 01 01 00 00 0a 0c 08 14 fe 01 13 05 11 05 2d 11 90 00 } //5
	condition:
...
rule Trojan_BAT_CoinMiner_NC_MTB_4{
	...
	strings :
		$a_03_0 = {7e 11 00 00 04 28 90 01 03 0a 0a 25 06 6f 90 01 03 0a 6a 6f 90 01 03 0a 25 28 90 01 03 06 6f 90 01 03 0a 25 6f 90 01 03 0a 28 90 01 03 0a 73 90 01 03 0a 25 06 6f 90 01 03 0a 6f 90 01 03 0a 6f 90 01 03 0a 74 90 01 03 01 6f 90 01 03 0a 90 00 } //5
