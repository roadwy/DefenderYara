...
rule Trojan_BAT_CoinMiner_AV_MSR{
	...
	strings :
		...
		$a_03_2 = {68 00 74 00 74 00 70 00 3a 00 2f 00 2f 00 6d 00 72 00 62 00 66 00 69 00 6c 00 65 00 2e 00 78 00 79 00 7a 00 2f 00 90 02 0f 2e 00 64 00 6c 00 6c 00 90 00 } //1
