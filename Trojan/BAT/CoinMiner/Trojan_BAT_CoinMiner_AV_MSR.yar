...
rule Trojan_BAT_CoinMiner_AV_MSR{
	...
	strings :
		$a_81_0 = {51 6b 6b 62 61 6c } //01 00 
		$a_01_1 = {76 00 69 00 68 00 61 00 6e 00 73 00 6f 00 66 00 74 00 2e 00 69 00 72 00 } //01 00 
		...
		$a_01_3 = {2e 00 74 00 65 00 6d 00 70 00 } //00 00 
	condition:
		any of ($a_*)
