...
rule Trojan_BAT_CoinMiner_NHC_MTB{
	...
	strings :
		$a_03_0 = {fe 0c 46 00 20 0c 00 00 00 fe 90 01 02 00 9c 20 90 01 03 00 38 90 01 03 ff 11 72 11 61 11 14 58 11 28 11 3b 5f 11 71 1f 1f 5f 64 d2 9c 20 90 01 03 00 38 90 01 03 ff 90 00 } //5
