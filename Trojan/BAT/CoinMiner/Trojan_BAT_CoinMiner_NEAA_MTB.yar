...
rule Trojan_BAT_CoinMiner_NEAA_MTB{
	...
	strings :
		...
		$a_01_1 = {61 00 63 00 74 00 69 00 76 00 61 00 74 00 69 00 6f 00 6e 00 2e 00 70 00 68 00 70 00 3f 00 63 00 6f 00 64 00 65 00 3d 00 } //02 00 
		...
		$a_01_4 = {42 61 6e 6e 65 64 } //00 00 
	condition:
		any of ($a_*)
