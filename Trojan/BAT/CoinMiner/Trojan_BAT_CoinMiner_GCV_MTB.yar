...
rule Trojan_BAT_CoinMiner_GCV_MTB{
	...
	strings :
		$a_03_0 = {11 14 11 15 9a 13 0e 11 0c 11 0e 16 9a 6f ?? ?? ?? 0a 2d 70 11 0e 17 9a 72 ?? ?? ?? ?? 28 ?? ?? ?? 06 28 ?? ?? ?? 0a 2d 19 11 0e 17 9a 72 ?? ?? ?? ?? 28 ?? ?? ?? 06 28 ?? ?? ?? 0a 2c 46 11 0b 2c 42 11 0e 17 9a 72 ?? ?? ?? ?? 28 ?? ?? ?? 06 28 ?? ?? ?? 0a 2d 04 11 0a 2b 02 } //10
