...
rule Trojan_BAT_CoinMiner_ME_MTB{
	...
	strings :
		$a_03_0 = {0a 16 0b 16 0c 2b 27 02 08 8f 90 01 03 01 25 71 90 01 03 01 06 07 25 17 58 0b 91 61 d2 81 90 01 03 01 07 06 8e 69 33 02 16 0b 08 17 58 0c 08 02 8e 69 32 d3 02 2a 90 00 } //10
