...
rule Trojan_BAT_CoinMiner_MA_MTB{
	...
	strings :
		...
		$a_01_1 = {4d 69 6e 65 73 77 65 65 70 65 72 5f 57 69 6e 64 6f 77 73 46 6f 72 6d 73 41 70 70 } //01 00 
		$a_01_2 = {67 65 74 5f 44 61 72 6b 52 65 64 } //01 00 
		$a_01_3 = {67 65 74 5f 49 73 48 69 64 64 65 6e } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_BAT_CoinMiner_MA_MTB_2{
	...
	strings :
		...
		$a_01_4 = {73 65 74 5f 4b 65 79 53 69 7a 65 } //01 00 
		...
		$a_01_8 = {52 69 6a 6e 64 61 65 6c 4d 61 6e 61 67 65 64 } //00 00 
	condition:
		any of ($a_*)
