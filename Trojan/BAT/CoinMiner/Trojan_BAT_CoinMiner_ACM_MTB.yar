...
rule Trojan_BAT_CoinMiner_ACM_MTB{
	...
	strings :
		$a_03_0 = {0a 02 7b 5b 01 00 04 6a 58 06 20 ?? ?? ?? 00 64 0a e0 06 20 ?? ?? ?? 2f 5c 0a 47 02 02 7b 5b 01 00 04 06 } //2
...
rule Trojan_BAT_CoinMiner_ACM_MTB_2{
	...
	strings :
		$a_03_0 = {16 13 06 2b 27 11 05 11 06 9a 13 07 00 11 07 73 17 00 00 0a 13 08 11 08 6f ?? ?? ?? 0a 13 09 11 09 2c 02 16 0a 00 11 06 17 58 13 06 11 06 11 05 8e 69 32 d1 } //2
...
rule Trojan_BAT_CoinMiner_ACM_MTB_3{
	...
	strings :
		$a_03_0 = {2b 2b 2b 30 1b 2c f9 1e 2c f6 2b 2b 2b 30 2b 31 2b 36 75 01 00 00 1b 2b 36 19 2c 0f 16 2d e1 2b 31 16 2b 31 8e 69 28 ?? ?? ?? 0a 07 2a 28 ?? ?? ?? 06 2b ce 0a 2b cd 28 ?? ?? ?? 0a 2b ce 06 2b cd 6f ?? ?? ?? 0a 2b c8 28 ?? ?? ?? 06 2b c3 0b 2b c7 07 2b cc } //1
	condition:
		((#a_03_0  & 1)*1) >=1
