...
rule Trojan_BAT_CoinMiner_NHI_MTB{
	...
	strings :
		$a_03_0 = {28 17 00 00 0a 0b 72 90 01 02 00 70 0c 73 90 01 02 00 0a 0d 09 07 72 90 01 02 00 70 08 28 90 01 02 00 0a 6f 90 01 02 00 0a 00 09 28 1b 00 00 0a 90 00 } //5
