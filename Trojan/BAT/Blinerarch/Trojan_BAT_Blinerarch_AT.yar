...
rule Trojan_BAT_Blinerarch_AT{
	...
	strings :
		...
		$a_01_2 = {35 00 35 00 31 00 32 00 32 00 } //01 00 
		$a_01_3 = {7a 00 61 00 5f 00 6e 00 75 00 6d 00 62 00 65 00 72 00 } //01 00 
		$a_01_4 = {37 00 37 00 2e 00 32 00 32 00 31 00 2e 00 31 00 34 00 39 00 2e 00 32 00 31 00 39 00 } //00 00 
	condition:
		any of ($a_*)
