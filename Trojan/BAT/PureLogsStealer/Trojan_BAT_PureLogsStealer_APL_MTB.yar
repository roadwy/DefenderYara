...
rule Trojan_BAT_PureLogsStealer_APL_MTB{
	...
	strings :
		$a_03_0 = {0a 25 17 6f 90 01 01 00 00 0a 00 25 16 6f 90 01 01 00 00 0a 00 0c 08 6f 90 01 01 00 00 0a 72 90 01 01 05 00 70 6f 90 01 01 00 00 0a 26 08 6f 90 00 } //2
