...
rule Trojan_BAT_Amadey_NA_MTB{
	...
	strings :
		$a_03_0 = {28 13 00 00 0a 28 90 01 01 00 00 0a 72 90 01 01 00 00 70 28 90 01 01 00 00 0a 28 90 01 01 00 00 0a 25 28 90 01 01 00 00 06 28 90 01 01 00 00 0a 28 18 00 00 0a 90 00 } //5
