...
rule Trojan_BAT_Gozi_NG_MTB{
	...
	strings :
		$a_03_0 = {19 8d 6d 00 00 01 0a 06 16 02 a2 06 17 03 8c 90 01 02 00 01 a2 06 18 04 a2 28 90 01 02 00 06 28 90 01 02 00 06 72 90 01 02 00 70 06 28 90 01 02 00 06 2a 90 00 } //5
