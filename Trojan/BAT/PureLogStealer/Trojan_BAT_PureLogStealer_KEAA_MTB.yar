...
rule Trojan_BAT_PureLogStealer_KEAA_MTB{
	...
	strings :
		$a_03_0 = {14 0a 02 16 3e 19 00 00 00 02 18 5d 3a 11 00 00 00 28 90 01 01 00 00 06 0a 28 90 01 01 00 00 0a 06 28 90 01 01 00 00 0a 28 90 01 01 00 00 0a 06 6f 90 00 } //5
