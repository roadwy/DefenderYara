...
rule Trojan_BAT_WhiteSnake_MA_MTB{
	...
	strings :
		...
		$a_01_2 = {38 32 32 37 34 32 31 30 2d 36 33 66 62 2d 34 34 34 34 2d 39 38 33 39 2d 39 32 37 35 61 34 66 62 39 34 38 34 } //01 00  82274210-63fb-4444-9839-9275a4fb9484
		$a_01_3 = {5f 62 76 54 33 75 63 6b 68 4c 78 31 30 73 2e 50 72 6f 70 65 72 74 69 65 73 2e 52 65 73 6f 75 72 63 65 73 } //00 00  _bvT3uckhLx10s.Properties.Resources
	condition:
		any of ($a_*)
