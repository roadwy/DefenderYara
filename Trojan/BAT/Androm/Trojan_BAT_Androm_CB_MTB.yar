...
rule Trojan_BAT_Androm_CB_MTB{
	...
	strings :
		...
		$a_01_1 = {50 6f 6e 74 6f 6f 6e 2e 52 65 73 6f 75 72 63 65 73 } //01 00 
		$a_01_2 = {41 66 66 69 63 68 65 72 49 6e 67 72 65 64 69 65 6e 74 73 } //01 00 
		$a_01_3 = {50 6f 6e 74 6f 6f 6e 2e 50 69 7a 7a 61 32 } //00 00 
	condition:
		any of ($a_*)
