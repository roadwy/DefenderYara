...
rule Trojan_BAT_Androm_AAUF_MTB{
	...
	strings :
		$a_03_0 = {72 2b 00 00 70 0a 06 20 f7 07 00 00 0c 12 02 28 90 01 01 00 00 0a 1f 54 0c 12 02 28 90 01 01 00 00 0a 6f 90 01 01 00 00 0a 28 90 01 01 00 00 0a 0b 28 90 01 01 00 00 0a 07 90 00 } //3
