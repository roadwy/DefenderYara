...
rule Trojan_BAT_Androm_MBGN_MTB{
	...
	strings :
		$a_03_0 = {2b 3a 16 13 07 2b 2a 09 11 04 11 06 58 11 05 11 07 58 6f ?? 00 00 0a 13 08 12 08 28 ?? 00 00 0a 13 09 08 07 11 09 9c 07 17 58 0b 11 07 17 58 13 07 11 07 17 32 d1 } //1
