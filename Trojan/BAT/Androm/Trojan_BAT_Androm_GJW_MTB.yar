...
rule Trojan_BAT_Androm_GJW_MTB{
	...
	strings :
		$a_03_0 = {2b 18 06 08 2b 09 06 18 6f 90 01 03 0a 2b 07 6f 90 01 03 0a 2b f0 02 0d 2b 03 0c 2b e5 06 6f 90 01 03 0a 09 16 09 8e 69 6f 90 01 03 0a 13 04 de 14 90 00 } //10
