...
rule Trojan_BAT_FileCoder_ARA_MTB_3{
	...
	strings :
		$a_03_0 = {06 07 9a 0c 00 08 28 90 01 03 06 00 08 28 90 01 03 06 00 00 07 17 58 0b 07 06 8e 69 32 e2 90 00 } //2
