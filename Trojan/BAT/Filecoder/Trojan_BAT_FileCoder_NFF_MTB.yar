...
rule Trojan_BAT_FileCoder_NFF_MTB{
	...
	strings :
		$a_03_0 = {28 1a 00 00 0a 03 6f 90 01 01 00 00 0a 0a 28 90 01 01 00 00 0a 04 6f 90 01 01 00 00 0a 0b 28 90 01 01 00 00 0a 07 6f 90 01 01 00 00 0a 0b 02 06 07 28 90 01 01 00 00 06 28 90 01 01 00 00 0a 90 00 } //5
