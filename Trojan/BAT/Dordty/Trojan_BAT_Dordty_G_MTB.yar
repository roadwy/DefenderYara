...
rule Trojan_BAT_Dordty_G_MTB{
	...
	strings :
		...
		$a_01_4 = {64 00 69 00 73 00 63 00 6f 00 72 00 64 00 40 00 67 00 6d 00 61 00 69 00 6c 00 } //01 00  discord@gmail
		$a_01_5 = {44 00 69 00 73 00 63 00 6f 00 72 00 64 00 20 00 4c 00 6f 00 67 00 69 00 6e 00 20 00 44 00 65 00 74 00 61 00 69 00 6c 00 73 00 } //01 00  Discord Login Details
		$a_01_6 = {68 00 74 00 74 00 70 00 73 00 5f 00 64 00 69 00 73 00 63 00 6f 00 72 00 64 00 61 00 70 00 70 00 2e 00 63 00 6f 00 6d 00 } //01 00  https_discordapp.com
