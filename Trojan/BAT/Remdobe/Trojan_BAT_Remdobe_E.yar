...
rule Trojan_BAT_Remdobe_E{
	...
	strings :
		$a_01_0 = {67 00 6f 00 62 00 6c 00 6d 00 61 00 68 00 33 00 37 00 31 00 7a 00 } //01 00 
		$a_01_1 = {2d 00 2d 00 6e 00 6f 00 2d 00 73 00 75 00 62 00 6d 00 69 00 74 00 2d 00 73 00 74 00 61 00 6c 00 65 00 } //01 00 
