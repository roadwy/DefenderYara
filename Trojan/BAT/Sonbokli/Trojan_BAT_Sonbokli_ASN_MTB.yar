...
rule Trojan_BAT_Sonbokli_ASN_MTB{
	...
	strings :
		...
		$a_03_1 = {0a 00 00 06 02 6f 90 01 01 00 00 0a 6f 90 01 01 00 00 0a 0c de 21 0b 00 72 90 01 01 00 00 70 28 90 01 01 00 00 0a 00 14 0c de 10 06 14 fe 01 0d 09 2d 07 06 90 00 } //1
	condition:
