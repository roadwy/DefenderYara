...
rule Trojan_BAT_AveMaria_NT_MTB{
	...
	strings :
		$a_03_0 = {72 75 00 00 70 0a 06 28 90 01 01 00 00 0a 25 26 0b 28 90 01 01 00 00 0a 07 16 07 8e 69 6f 90 01 01 00 00 0a 0a 28 90 01 01 00 00 0a 25 26 06 6f 90 01 01 00 00 0a 90 00 } //5
