...
rule Trojan_BAT_AveMaria_NEDC_MTB{
	...
	strings :
		...
		$a_01_1 = {50 6f 77 65 72 65 64 20 62 79 20 53 6d 61 72 74 41 73 73 65 6d 62 6c 79 20 38 2e 31 2e 30 2e 34 38 39 32 } //00 00  Powered by SmartAssembly 8.1.0.4892
	condition:
		any of ($a_*)
