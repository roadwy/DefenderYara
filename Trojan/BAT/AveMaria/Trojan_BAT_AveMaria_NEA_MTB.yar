...
rule Trojan_BAT_AveMaria_NEA_MTB{
	...
	strings :
		$a_03_0 = {7e 0d 00 00 04 11 04 7e 90 01 03 04 11 04 91 20 90 01 03 00 59 d2 9c 00 11 04 17 58 13 04 11 04 7e 90 01 03 04 8e 69 fe 04 90 00 } //5
...
rule Trojan_BAT_AveMaria_NEA_MTB_3{
	...
	strings :
		$a_03_0 = {02 28 ca 01 00 06 00 11 08 20 90 01 03 75 5a 20 90 01 03 73 61 38 90 01 03 ff 00 11 08 20 90 01 03 b3 5a 20 90 01 03 6a 61 38 90 01 03 ff 02 28 90 01 03 06 09 28 90 01 03 06 00 11 08 20 90 01 03 59 5a 20 90 01 03 87 61 38 90 01 03 ff 11 05 28 90 01 03 06 20 90 01 03 8a 28 90 01 03 2b 90 00 } //5
