...
rule Trojan_BAT_AveMaria_NEA_MTB{
	...
	strings :
		...
		$a_01_1 = {49 51 6e 75 69 6e } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_BAT_AveMaria_NEA_MTB_2{
	...
	strings :
		...
		$a_01_1 = {35 00 58 00 54 00 4f 00 44 00 35 00 47 00 34 00 51 00 35 00 34 00 47 00 5a 00 38 00 35 00 37 00 42 00 53 00 43 00 38 00 37 00 34 00 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_BAT_AveMaria_NEA_MTB_3{
	...
	strings :
		...
		$a_01_1 = {4d 61 54 61 63 47 69 61 } //00 00 
	condition:
		any of ($a_*)
