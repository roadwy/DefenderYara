...
rule Trojan_BAT_AveMaria_NLM_MTB{
	...
	strings :
		$a_03_0 = {28 6a 00 00 0a 13 05 1a 8d 90 01 03 01 25 16 72 90 01 03 70 a2 25 17 72 90 01 03 70 a2 25 18 72 90 01 03 70 a2 25 19 72 90 01 03 70 a2 13 06 72 90 01 03 70 28 90 01 03 0a 90 00 } //5
...
rule Trojan_BAT_AveMaria_NLM_MTB_2{
	...
	strings :
		$a_03_0 = {8d 7c 00 00 01 25 16 03 9d 6f 90 01 02 00 0a 7e 90 01 02 00 04 25 2d 17 26 7e 90 01 02 00 04 fe 90 01 04 06 73 90 01 02 00 0a 25 80 90 01 02 00 04 28 90 01 02 00 2b 90 00 } //5
