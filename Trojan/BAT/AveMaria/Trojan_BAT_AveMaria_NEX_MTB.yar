...
rule Trojan_BAT_AveMaria_NEX_MTB{
	...
	strings :
		...
		$a_01_1 = {35 00 37 00 48 00 33 00 46 00 4e 00 50 00 43 00 35 00 34 00 4a 00 48 00 58 00 46 00 46 00 46 00 38 00 44 00 43 00 33 00 34 00 37 00 } //00 00  57H3FNPC54JHXFFF8DC347
	condition:
		any of ($a_*)
