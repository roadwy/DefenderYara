...
rule Trojan_BAT_AveMaria_NEEU_MTB{
	...
	strings :
		...
		$a_01_2 = {53 79 73 74 65 6d 2e 52 65 66 6c 65 63 74 69 6f 6e } //01 00  System.Reflection
		$a_01_3 = {53 79 73 74 65 6d 2e 4e 65 74 2e 48 74 74 70 } //01 00  System.Net.Http
