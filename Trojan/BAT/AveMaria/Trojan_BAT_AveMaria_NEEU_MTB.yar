...
rule Trojan_BAT_AveMaria_NEEU_MTB{
	...
	strings :
		$a_03_0 = {0a 16 0b 2b 22 00 06 6f 90 01 01 00 00 0a 07 9a 6f 90 01 01 00 00 0a 14 14 6f 90 01 01 00 00 0a 2c 02 de 0e de 03 26 de 00 07 17 58 0b 07 90 00 } //10
