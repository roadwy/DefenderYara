...
rule Trojan_BAT_AveMaria_NA_MTB{
	...
	strings :
		$a_03_0 = {28 08 00 00 0a 6f 90 01 01 00 00 0a 14 17 8d 90 01 01 00 00 01 25 16 07 a2 6f 90 01 01 00 00 0a 75 90 01 01 00 00 1b 08 28 90 01 01 00 00 0a 28 90 01 01 00 00 2b 28 90 01 01 00 00 2b 2a 90 00 } //5
