...
rule Trojan_BAT_AveMaria_NAA_MTB{
	...
	strings :
		...
		$a_01_1 = {41 69 72 70 6f 72 74 42 61 67 67 61 67 65 2e 50 72 6f 70 65 72 74 69 65 73 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_BAT_AveMaria_NAA_MTB_2{
	...
	strings :
		...
		$a_01_1 = {6b 43 73 4b 2e 67 2e 72 65 73 6f 75 72 63 65 73 } //01 00 
		$a_01_2 = {45 78 69 74 45 78 61 6d 41 70 70 2e 50 72 6f 70 65 72 74 69 65 73 2e 52 65 73 6f 75 72 63 65 73 2e 72 65 73 6f 75 72 63 65 73 } //00 00 
	condition:
		any of ($a_*)
