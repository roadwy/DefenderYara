...
rule Trojan_BAT_AveMaria_MB_MTB{
	...
	strings :
		$a_03_0 = {06 08 2b 09 06 18 6f 90 01 03 0a 2b 07 6f 90 01 03 0a 2b f0 20 90 01 04 8d 90 01 03 01 25 d0 90 01 03 04 28 90 01 03 0a 0d 2b 03 0c 2b d1 06 6f 90 01 03 0a 09 16 09 8e 69 6f 90 01 03 0a 13 04 de 14 90 00 } //10
