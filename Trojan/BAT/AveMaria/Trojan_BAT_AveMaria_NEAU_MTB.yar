...
rule Trojan_BAT_AveMaria_NEAU_MTB{
	...
	strings :
		$a_03_0 = {11 05 08 6f 90 01 01 00 00 0a 09 20 00 01 00 00 14 14 11 06 74 02 00 00 1b 6f 90 01 01 00 00 0a 90 00 } //5
		$a_03_1 = {1a 8d 15 00 00 01 25 16 11 04 a2 25 17 7e 90 01 01 00 00 0a a2 25 18 07 a2 25 19 17 8c 04 00 00 01 a2 13 06 90 00 } //5
