...
rule Trojan_BAT_Avemaria_ABIX_MTB{
	...
	strings :
		$a_03_0 = {0a 00 02 6f 90 01 03 06 6f 90 01 03 0a 00 02 6f 90 01 03 06 6f 90 01 03 0a 00 2a 90 0a 35 00 72 90 01 03 70 0a 28 90 01 03 06 6f 90 01 03 0a 72 90 01 03 70 06 6f 90 00 } //1
