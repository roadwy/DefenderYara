...
rule Trojan_BAT_AveMaria_NEEZ_MTB{
	...
	strings :
		$a_03_0 = {02 72 01 00 00 70 28 90 01 01 00 00 06 0a 28 90 01 01 00 00 0a 06 6f 90 01 01 00 00 0a 28 90 01 01 00 00 0a 0b 02 07 28 90 01 01 00 00 06 0c dd 06 00 00 00 26 90 00 } //10
