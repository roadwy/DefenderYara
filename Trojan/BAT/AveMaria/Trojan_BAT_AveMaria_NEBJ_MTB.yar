...
rule Trojan_BAT_AveMaria_NEBJ_MTB{
	...
	strings :
		...
		$a_01_2 = {4d 4a 43 4b 56 4b 4c 55 49 4f 52 } //04 00 
		$a_01_3 = {63 30 62 32 32 34 37 30 32 33 62 31 39 34 39 37 34 35 34 32 35 64 64 64 39 62 62 64 63 36 63 34 65 } //01 00 
