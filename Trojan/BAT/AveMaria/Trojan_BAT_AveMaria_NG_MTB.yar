...
rule Trojan_BAT_AveMaria_NG_MTB{
	...
	strings :
		$a_03_0 = {28 0b 00 00 06 0a 28 90 01 01 00 00 0a 06 6f 90 01 01 00 00 0a 28 90 01 01 00 00 06 75 90 01 01 00 00 1b 0b 07 16 07 8e 69 28 90 01 01 00 00 0a 07 2a 90 00 } //5
