...
rule Trojan_BAT_AveMaria_NG_MTB{
	...
	strings :
		...
		$a_01_1 = {57 69 6e 64 6f 77 73 46 6f 72 6d 73 41 70 70 33 39 2e 50 72 6f 70 65 72 74 69 65 73 2e 52 65 73 6f 75 72 63 65 73 2e 72 65 73 6f 75 72 63 65 73 } //01 00  WindowsFormsApp39.Properties.Resources.resources
		$a_01_2 = {42 61 7a 73 69 65 78 } //00 00  Bazsiex
	condition:
		any of ($a_*)
