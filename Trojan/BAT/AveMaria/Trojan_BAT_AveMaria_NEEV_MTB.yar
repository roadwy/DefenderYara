...
rule Trojan_BAT_AveMaria_NEEV_MTB{
	...
	strings :
		$a_03_0 = {2b 14 2b 19 2b 1e 17 2d 06 26 16 2d 04 de 22 2b 1a 19 2c ec 2b f4 28 90 01 01 00 00 06 2b e5 28 90 01 01 00 00 2b 2b e0 28 90 01 01 00 00 2b 2b db 0a 2b e3 90 00 } //10
