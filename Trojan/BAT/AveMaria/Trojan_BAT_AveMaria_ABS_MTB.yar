...
rule Trojan_BAT_AveMaria_ABS_MTB{
	...
	strings :
		$a_03_0 = {04 06 91 20 90 01 03 00 59 d2 9c 00 06 17 58 0a 06 7e 03 90 01 02 04 8e 69 fe 04 0b 07 2d d7 7e 03 90 01 02 04 0c 2b 00 08 2a 90 0a 32 00 7e 03 90 01 02 04 06 7e 03 90 00 } //1
...
rule Trojan_BAT_AveMaria_ABS_MTB_2{
	...
	strings :
		$a_03_0 = {2d 17 26 7e 57 90 01 02 04 fe 06 90 01 03 06 73 4f 90 01 02 0a 25 80 58 90 01 02 04 28 04 90 01 02 2b 28 05 90 01 02 2b 02 fe 06 90 01 03 06 73 52 90 01 02 0a 28 06 90 01 02 2b 28 07 90 01 02 2b 0a 20 87 90 01 02 4e 2b 8d 07 20 86 90 01 02 2d 5a 20 82 90 01 02 70 61 38 7b 90 01 02 ff 90 0a 64 00 02 7b 52 90 01 02 04 6f 4e 90 01 02 0a 7e 58 90 01 01 00 04 25 90 00 } //2
		$a_03_1 = {11 04 20 05 90 01 02 53 5a 20 cf 90 01 02 12 61 2b c6 90 0a 18 00 28 9c 90 01 02 06 0a 16 0b 90 00 } //2
