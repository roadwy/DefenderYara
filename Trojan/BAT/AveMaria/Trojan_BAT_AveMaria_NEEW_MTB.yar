...
rule Trojan_BAT_AveMaria_NEEW_MTB{
	...
	strings :
		...
		$a_01_1 = {44 65 62 75 67 67 65 72 4e 6f 6e 55 73 65 72 43 6f 64 65 41 74 74 72 69 62 75 74 65 } //02 00  DebuggerNonUserCodeAttribute
		$a_01_2 = {44 79 6e 61 6d 69 63 49 6e 76 6f 6b 65 } //02 00  DynamicInvoke
