...
rule Trojan_BAT_AveMaria_NEEW_MTB{
	...
	strings :
		$a_03_0 = {00 28 0e 00 00 06 0a 28 90 01 01 00 00 0a 06 6f 90 01 01 00 00 0a 28 90 01 01 00 00 0a 28 90 01 01 00 00 2b 28 90 01 01 00 00 2b 0b de 03 26 de d9 07 2a 90 00 } //10
