...
rule Trojan_BAT_AveMaria_FAT_MTB{
	...
	strings :
		$a_03_0 = {16 2c 66 26 11 05 11 04 6f ?? 00 00 0a 11 05 18 6f ?? 00 00 0a 11 05 18 6f ?? 00 00 0a 11 05 6f ?? 00 00 0a 13 06 11 06 07 16 07 8e 69 6f ?? 00 00 0a 13 07 28 ?? 00 00 0a 11 07 6f ?? 00 00 0a 13 08 11 08 6f ?? 00 00 0a 13 0a de 2d } //3
