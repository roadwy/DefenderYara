...
rule Trojan_BAT_AveMaria_NEFD_MTB{
	...
	strings :
		$a_03_0 = {13 04 11 04 16 09 16 1e 28 90 01 01 00 00 0a 00 07 09 6f 90 01 01 00 00 0a 00 07 18 6f 90 01 01 00 00 0a 00 07 6f 90 01 01 00 00 0a 03 16 03 8e 69 6f 90 01 01 00 00 0a 13 05 11 05 0a 2b 00 06 2a 90 00 } //10
