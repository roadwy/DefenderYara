...
rule Trojan_BAT_AveMaria_NEFD_MTB{
	...
	strings :
		...
		$a_01_1 = {43 6f 6e 66 75 73 65 72 2e 43 6f 72 65 20 31 2e 36 } //02 00  Confuser.Core 1.6
		$a_01_2 = {73 65 74 5f 57 69 6e 64 6f 77 53 74 79 6c 65 } //00 00  set_WindowStyle
	condition:
		any of ($a_*)
