...
rule Trojan_BAT_AveMaria_NECK_MTB{
	...
	strings :
		$a_03_0 = {18 16 2c 4b 26 2b 32 06 07 9a 16 2c 45 26 08 6f 90 01 01 00 00 0a 6f 90 01 01 00 00 0a 6f 90 01 01 00 00 0a 28 03 00 00 0a 33 0a 17 25 90 00 } //10
