...
rule Trojan_BAT_AveMaria_AARV_MTB{
	...
	strings :
		$a_03_0 = {16 13 06 2b 3d 7e 90 01 01 00 00 04 11 06 7e 90 01 01 00 00 04 11 06 91 7e 90 01 01 00 00 04 61 7e 90 01 01 00 00 04 09 91 61 28 90 01 01 00 00 06 9c 09 7e 90 01 01 00 00 04 8e 69 17 59 33 04 16 0d 2b 04 09 17 58 0d 11 06 17 58 13 06 11 06 7e 90 01 01 00 00 04 8e 69 17 59 31 b6 90 00 } //4
