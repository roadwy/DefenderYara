...
rule Trojan_BAT_AveMaria_ABT_MTB{
	...
	strings :
		$a_03_0 = {04 07 91 20 90 01 03 00 59 d2 9c 00 07 17 58 0b 07 7e 90 01 03 04 8e 69 fe 04 0c 08 2d d7 7e 90 01 03 04 0d de 0b 90 0a 30 00 7e 90 01 03 04 07 7e 01 90 00 } //1
