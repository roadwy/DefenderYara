...
rule Trojan_BAT_AveMaria_MBGG_MTB{
	...
	strings :
		...
		$a_01_1 = {62 2d 38 36 65 31 2d 36 38 33 39 37 34 66 63 63 62 36 31 } //01 00 
		$a_01_2 = {54 7a 68 61 63 2e 50 72 6f 70 65 72 74 69 65 73 2e 52 65 73 6f 75 72 63 65 73 2e 72 65 73 6f 75 72 63 65 } //01 00 
		$a_01_3 = {4f 00 75 00 76 00 78 00 32 00 4d 00 42 00 75 00 77 00 } //00 00 
	condition:
		any of ($a_*)
