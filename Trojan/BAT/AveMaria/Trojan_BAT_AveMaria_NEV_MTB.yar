...
rule Trojan_BAT_AveMaria_NEV_MTB{
	...
	strings :
		...
		$a_01_1 = {35 00 34 00 35 00 42 00 47 00 47 00 50 00 37 00 39 00 54 00 50 00 35 00 4e 00 44 00 38 00 37 00 47 00 35 00 58 00 51 00 38 00 38 00 } //01 00  545BGGP79TP5ND87G5XQ88
		$a_01_2 = {41 00 69 00 6e 00 74 00 61 00 63 00 } //00 00  Aintac
	condition:
		any of ($a_*)
