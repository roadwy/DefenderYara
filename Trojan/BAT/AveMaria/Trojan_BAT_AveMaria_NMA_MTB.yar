...
rule Trojan_BAT_AveMaria_NMA_MTB{
	...
	strings :
		$a_03_0 = {11 18 20 a2 e7 3f 61 5a 20 90 01 03 a8 61 38 90 01 03 ff 7e 90 01 03 04 7e 90 01 03 04 28 90 01 03 06 20 90 01 03 09 38 90 01 03 ff 11 17 17 58 13 17 20 90 01 03 7e 90 00 } //5
...
rule Trojan_BAT_AveMaria_NMA_MTB_2{
	...
	strings :
		$a_03_0 = {0c 16 0d 11 06 20 90 01 03 cd 5a 20 90 01 03 34 61 38 90 01 03 ff 02 7b 90 01 03 04 20 90 01 03 18 28 90 01 03 2b 28 90 01 03 06 90 00 } //5
...
rule Trojan_BAT_AveMaria_NMA_MTB_3{
	...
	strings :
		$a_03_0 = {28 04 00 00 0a 6f 90 01 03 0a 20 90 01 03 00 7e 90 01 03 04 7b 90 01 03 04 3a 90 01 03 ff 26 20 90 01 03 00 38 90 01 03 ff 73 90 01 03 0a 13 0b 20 90 01 03 00 fe 90 01 02 00 38 90 01 03 ff 00 11 0b 11 01 17 73 90 01 03 0a 90 00 } //5
