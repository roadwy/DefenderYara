...
rule Trojan_BAT_AveMaria_NEEA_MTB{
	...
	strings :
		$a_03_0 = {2b 2a 16 2c 2e 26 2b 2e 2b 2f 2b 34 16 2d f7 2b 32 16 08 8e 69 28 90 01 01 00 00 0a 08 0d de 52 28 90 01 01 00 00 0a 2b c9 28 90 01 01 00 00 0a 2b d4 6f 90 01 01 00 00 0a 2b cf 0b 2b d0 07 2b cf 28 90 01 01 00 00 0a 2b ca 0c 2b c9 08 2b cb 90 00 } //10
