...
rule Trojan_BAT_AveMaria_NE_MTB{
	...
	strings :
		$a_03_0 = {28 72 00 00 0a 6f 90 01 01 00 00 0a 07 1f 10 8d 90 01 01 00 00 01 25 d0 90 01 01 00 00 04 28 90 01 01 00 00 0a 6f 90 01 01 00 00 0a 06 07 6f 90 01 01 00 00 0a 90 00 } //5
...
rule Trojan_BAT_AveMaria_NE_MTB_2{
	...
	strings :
		$a_03_0 = {00 72 01 00 00 70 28 90 01 03 06 0a 06 73 90 01 03 0a 0b 00 73 04 00 00 0a 0c 00 07 16 73 05 00 00 0a 73 06 00 00 0a 0d 90 00 } //1
