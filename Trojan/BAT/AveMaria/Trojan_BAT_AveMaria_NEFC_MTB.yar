...
rule Trojan_BAT_AveMaria_NEFC_MTB{
	...
	strings :
		$a_03_0 = {09 11 05 9a 13 09 11 04 11 09 1f 10 28 ?? 00 00 0a b4 6f ?? 00 00 0a 00 11 05 17 d6 13 05 00 11 05 09 8e 69 fe 04 13 0a 11 0a 2d d4 28 ?? 00 00 0a 11 04 6f ?? 00 00 0a 6f ?? 00 00 0a 13 06 11 06 6f ?? 00 00 0a 16 9a 13 07 11 07 } //10
