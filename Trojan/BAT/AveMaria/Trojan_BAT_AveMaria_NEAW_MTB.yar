...
rule Trojan_BAT_AveMaria_NEAW_MTB{
	...
	strings :
		$a_03_0 = {13 13 16 13 15 11 13 28 90 01 02 00 06 11 15 18 d6 5d 6f 90 01 01 00 00 0a 11 15 17 d6 13 15 11 15 1f 0a 31 e3 90 00 } //5
		$a_03_1 = {11 13 1b 11 13 1b 6f 90 01 01 00 00 0a 1f 19 d8 1f 19 d8 6f 90 00 } //5
