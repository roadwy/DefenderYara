...
rule Trojan_BAT_AveMaria_NEES_MTB{
	...
	strings :
		$a_03_0 = {25 16 1f 2d 9d 6f 90 01 01 00 00 0a 0b 07 8e 69 8d 90 01 01 00 00 01 0c 16 13 05 2b 18 00 08 11 05 07 11 05 9a 1f 10 28 90 01 01 00 00 0a d2 9c 00 11 05 17 58 13 05 11 05 07 8e 69 fe 04 13 06 11 06 2d db 02 90 00 } //10
