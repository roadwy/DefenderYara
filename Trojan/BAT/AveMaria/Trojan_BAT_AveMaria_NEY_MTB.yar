...
rule Trojan_BAT_AveMaria_NEY_MTB{
	...
	strings :
		...
		$a_01_1 = {54 00 65 00 78 00 70 00 66 00 72 00 61 00 73 00 6c 00 70 00 70 00 65 00 6d 00 7a 00 62 00 69 00 62 00 79 00 6e 00 67 00 78 00 } //00 00  Texpfraslppemzbibyngx
	condition:
		any of ($a_*)
