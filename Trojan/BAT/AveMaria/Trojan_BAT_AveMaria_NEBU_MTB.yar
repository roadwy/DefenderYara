...
rule Trojan_BAT_AveMaria_NEBU_MTB{
	...
	strings :
		...
		$a_01_1 = {5a 57 4d 32 4d 7a 4a 6d 5a 44 6b 74 4d 54 59 35 4e 43 30 30 5a 6a 52 68 4c 54 6c 69 5a 6d 59 74 5a 6a 49 77 4e 6a 41 77 5a 54 4d 33 4f 54 67 78 } //03 00  ZWM2MzJmZDktMTY5NC00ZjRhLTliZmYtZjIwNjAwZTM3OTgx
		$a_01_2 = {4c 6f 67 69 63 4e 50 20 53 6f 66 74 77 61 72 65 20 32 30 30 39 } //01 00  LogicNP Software 2009
