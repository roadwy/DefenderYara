...
rule Trojan_BAT_AveMaria_NEBX_MTB{
	...
	strings :
		$a_03_0 = {25 26 25 1f 1c 28 90 01 01 00 00 06 20 82 00 00 00 28 90 01 01 00 00 06 90 00 } //5
		$a_03_1 = {a2 25 1f 24 28 90 01 01 00 00 06 28 90 01 01 00 00 0a 25 26 a2 25 1f 28 90 00 } //5
