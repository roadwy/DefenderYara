...
rule Trojan_BAT_Falsesign_RPW_MTB{
	...
	strings :
		$a_03_0 = {32 00 34 00 68 00 72 00 73 00 74 00 72 00 61 00 63 00 6b 00 2e 00 63 00 6f 00 6d 00 2f 00 6c 00 6f 00 61 00 64 00 65 00 72 00 2f 00 75 00 70 00 6c 00 6f 00 61 00 64 00 73 00 2f 00 [0-30] 2e 00 62 00 6d 00 70 00 } //1
