...
rule Trojan_BAT_APosT_MA_MTB{
	...
	strings :
		$a_01_0 = {61 6a 77 66 64 61 69 64 77 61 } //01 00  ajwfdaidwa
		...
		$a_01_5 = {6b 00 6a 00 67 00 73 00 64 00 6f 00 67 00 66 00 65 00 77 00 6f 00 66 00 } //00 00  kjgsdogfewof
	condition:
		any of ($a_*)
