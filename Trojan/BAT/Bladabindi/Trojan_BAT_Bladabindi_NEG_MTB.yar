...
rule Trojan_BAT_Bladabindi_NEG_MTB{
	...
	strings :
		...
		$a_01_1 = {68 00 65 00 61 00 6c 00 74 00 68 00 70 00 79 00 73 00 65 00 72 00 76 00 69 00 63 00 65 00 73 00 2e 00 63 00 6f 00 6d 00 } //01 00 
		$a_01_2 = {52 00 65 00 67 00 41 00 73 00 6d 00 2e 00 65 00 78 00 65 00 } //00 00 
	condition:
		any of ($a_*)
