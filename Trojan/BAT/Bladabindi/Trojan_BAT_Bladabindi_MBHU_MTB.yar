...
rule Trojan_BAT_Bladabindi_MBHU_MTB{
	...
	strings :
		...
		$a_01_1 = {61 32 37 30 2d 35 35 64 33 62 30 62 38 63 65 30 66 } //01 00 
		$a_01_2 = {43 4d 5f 4c 69 6e 6b 73 2e 50 72 6f 70 65 72 74 69 65 73 2e 52 65 73 6f 75 72 63 65 73 2e 72 65 73 6f 75 72 63 65 } //00 00 
	condition:
		any of ($a_*)
