...
rule Trojan_BAT_Bladabindi_SBR_MSR{
	...
	strings :
		$a_03_0 = {72 cf 00 00 70 7e 08 00 00 04 6f 90 01 01 00 00 0a 72 13 01 00 70 28 90 01 01 00 00 0a 16 16 15 28 90 01 01 00 00 0a 26 de 03 90 00 } //1
		$a_03_1 = {11 05 12 06 28 90 01 01 00 00 06 13 07 11 07 28 90 01 01 00 00 06 28 90 01 01 00 00 0a 13 08 02 09 07 06 1b 16 11 08 28 90 01 01 00 00 06 26 06 6f 90 01 01 00 00 0a 0c 08 13 09 de 10 90 00 } //1
