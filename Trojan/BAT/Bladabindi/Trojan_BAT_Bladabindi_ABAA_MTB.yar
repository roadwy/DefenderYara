...
rule Trojan_BAT_Bladabindi_ABAA_MTB{
	...
	strings :
		$a_03_0 = {fe 0c 01 00 fe 0c 02 00 8f 90 01 01 00 00 01 25 47 fe 0c 01 00 fe 0c 07 00 91 fe 0c 00 00 20 90 01 01 00 00 00 58 4a 61 d2 61 d2 52 20 90 01 01 00 00 00 fe 0e 0a 00 90 00 } //1
