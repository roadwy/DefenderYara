...
rule Trojan_BAT_Bladabindi_DQ_MTB{
	...
	strings :
		$a_02_0 = {0a 03 07 03 6f ?? ?? ?? 0a 5d 17 58 28 ?? ?? ?? 0a 28 ?? ?? ?? 0a 59 0c 06 08 28 ?? ?? ?? 0a 0d 12 03 28 ?? ?? ?? 0a 28 ?? ?? ?? 0a 0a 00 07 17 58 0b 07 02 6f ?? ?? ?? 0a fe 02 16 fe 01 13 04 11 04 2d b0 } //10
