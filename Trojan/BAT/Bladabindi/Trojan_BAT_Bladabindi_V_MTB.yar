...
rule Trojan_BAT_Bladabindi_V_MTB{
	...
	strings :
		...
		$a_03_2 = {50 68 6f 65 6e 69 78 5c 73 6f 75 72 63 65 5c 72 65 70 6f 73 5c 4f 6e 65 44 72 69 76 65 5c 4f 6e 65 44 72 69 76 65 5c 6f 62 6a 5c [0-08] 5c 4f 6e 65 44 72 69 76 65 2e 70 64 62 } //1
