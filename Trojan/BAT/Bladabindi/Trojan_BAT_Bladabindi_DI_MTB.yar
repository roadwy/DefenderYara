...
rule Trojan_BAT_Bladabindi_DI_MTB{
	...
	strings :
		$a_03_0 = {08 11 04 07 11 04 1e d8 1e 6f 90 01 03 0a 18 28 90 01 03 0a 9c 11 04 17 d6 13 04 11 04 09 31 e0 90 00 } //20
		$a_03_1 = {08 09 07 09 9a 1f 10 28 90 01 03 0a 9c 09 17 58 0d 09 07 8e 69 3f e6 ff ff ff 90 00 } //20
