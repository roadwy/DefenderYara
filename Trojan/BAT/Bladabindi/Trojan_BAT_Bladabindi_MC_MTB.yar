...
rule Trojan_BAT_Bladabindi_MC_MTB{
	...
	strings :
		$a_03_0 = {13 06 11 06 16 72 ?? ?? ?? 70 a2 11 06 0c 07 08 16 6f ?? ?? ?? 0a 0d 17 13 04 2b 3f 00 02 09 11 04 9a 28 ?? ?? ?? 0a 28 ?? ?? ?? 06 13 05 06 09 11 04 17 58 9a 28 ?? ?? ?? 0a 11 05 28 ?? ?? ?? 0a 00 06 09 11 04 17 58 9a 28 ?? ?? ?? 0a 28 ?? ?? ?? 0a 26 00 11 04 18 58 13 04 11 04 09 28 ?? ?? ?? 2b 17 59 fe 04 13 07 11 07 } //1
		...
		$a_01_5 = {55 6e 73 65 63 75 72 65 } //1 Unsecure
