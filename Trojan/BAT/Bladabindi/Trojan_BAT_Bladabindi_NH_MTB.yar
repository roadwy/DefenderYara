...
rule Trojan_BAT_Bladabindi_NH_MTB{
	...
	strings :
		...
		$a_81_4 = {72 6f 6f 74 5c 53 65 63 75 72 69 74 79 43 65 6e 74 65 72 } //1 root\SecurityCenter
		$a_81_5 = {53 45 4c 45 43 54 20 2a 20 46 52 4f 4d 20 46 69 72 65 77 61 6c 6c 50 72 6f 64 75 63 74 } //1 SELECT * FROM FirewallProduct
	condition:
