...
rule Trojan_BAT_Bladabindi_DL_MTB{
	...
	strings :
		$a_03_0 = {2b 19 2b 1a 18 2d 1a 26 26 2b 1d 6f ?? ?? ?? 0a 28 ?? ?? ?? 0a 0d 1d 2c f0 de 2a 07 2b e4 08 2b e3 6f ?? ?? ?? 0a 2b e1 08 2b e0 16 2d 0c 19 2c 09 08 2c 06 08 6f ?? ?? ?? 0a dc } //10
