...
rule Trojan_BAT_Bladabindi_ABTR_MTB{
	...
	strings :
		$a_03_0 = {0f 00 08 20 00 04 00 00 58 28 90 01 01 00 00 2b 07 02 08 20 00 04 00 00 20 19 03 00 00 20 01 03 00 00 28 90 01 01 00 00 06 0d 1f 0c 13 0d 90 00 } //3
