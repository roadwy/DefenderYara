...
rule Trojan_BAT_Bladabindi_MBCL_MTB{
	...
	strings :
		...
		$a_01_1 = {39 63 61 64 65 34 32 65 2d 35 63 63 35 2d 34 34 65 61 2d 39 38 39 32 2d 64 61 31 36 34 64 30 32 38 61 30 65 } //00 00  9cade42e-5cc5-44ea-9892-da164d028a0e
	condition:
		any of ($a_*)
