...
rule Trojan_BAT_Bladabindi_AG_MTB{
	...
	strings :
		$a_02_0 = {11 05 02 11 05 91 90 02 10 91 61 b4 9c 90 02 10 00 00 04 6f 90 02 10 0a 17 da fe 01 13 07 11 07 2c 04 16 90 02 15 00 11 05 17 d6 13 05 11 05 11 06 13 08 11 08 31 c1 90 00 } //1
