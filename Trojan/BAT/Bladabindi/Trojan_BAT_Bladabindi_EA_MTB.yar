...
rule Trojan_BAT_Bladabindi_EA_MTB{
	meta:
		description = "Trojan:BAT/Bladabindi.EA!MTB,SIGNATURE_TYPE_PEHSTR_EXT,18 00 18 00 0e 00 00 14 00 "
		
	strings :
		$a_00_0 = {24 63 31 35 65 65 38 65 32 2d 65 32 35 33 2d 38 32 37 35 2d 34 33 63 36 2d 36 39 34 66 38 38 31 35 35 62 34 61 } //14 00  $c15ee8e2-e253-8275-43c6-694f88155b4a
		$a_00_1 = {24 38 31 61 65 31 35 63 62 2d 63 36 66 32 2d 37 39 36 62 2d 39 38 62 34 2d 63 65 61 35 62 35 34 35 37 34 34 36 } //14 00  $81ae15cb-c6f2-796b-98b4-cea5b5457446
		$a_00_2 = {24 62 61 36 65 64 31 38 36 2d 34 36 31 36 2d 61 33 35 65 2d 30 66 62 36 2d 63 38 64 65 35 37 64 64 61 65 31 65 } //14 00  $ba6ed186-4616-a35e-0fb6-c8de57ddae1e
		$a_00_3 = {24 31 34 66 39 66 34 39 38 2d 39 62 38 34 2d 63 37 36 34 2d 66 39 65 63 2d 33 37 63 37 37 35 64 65 65 64 33 34 } //01 00  $14f9f498-9b84-c764-f9ec-37c775deed34
