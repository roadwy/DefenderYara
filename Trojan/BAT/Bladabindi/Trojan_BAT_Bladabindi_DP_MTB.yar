...
rule Trojan_BAT_Bladabindi_DP_MTB{
	...
	strings :
		$a_02_0 = {70 0a 17 03 6f 90 01 03 0a 13 04 0c 2b 2f 03 08 28 90 01 03 0a 04 08 04 6f 90 01 03 0a 5d 17 d6 28 90 01 03 0a da 0d 06 09 28 90 01 03 0a 28 90 01 03 0a 28 90 01 03 0a 0a 08 17 d6 0c 08 11 04 31 cc 90 00 } //10
