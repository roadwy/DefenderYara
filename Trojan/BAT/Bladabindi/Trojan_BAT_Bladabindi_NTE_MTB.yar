...
rule Trojan_BAT_Bladabindi_NTE_MTB{
	...
	strings :
		$a_03_0 = {73 13 00 00 0a 0a 06 72 90 01 01 00 00 70 6f 90 01 01 00 00 0a 0b 28 90 01 01 00 00 0a 72 90 01 01 00 00 70 28 90 01 01 00 00 0a 0c 08 07 28 90 01 01 00 00 0a 00 73 90 01 01 00 00 0a 0d 90 00 } //5
