...
rule Trojan_BAT_Bladabindi_NEC_MTB{
	...
	strings :
		...
		$a_01_1 = {70 00 79 00 76 00 65 00 6c 00 72 00 55 00 2b 00 53 00 42 00 50 00 4d 00 2f 00 32 00 4d 00 57 00 45 00 66 00 74 00 69 00 65 00 41 00 3d 00 3d 00 } //00 00  pyvelrU+SBPM/2MWEftieA==
	condition:
		any of ($a_*)
