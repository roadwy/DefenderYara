...
rule Trojan_BAT_Bladabindi_NYL_MTB{
	...
	strings :
		$a_01_0 = {24 65 37 63 62 61 31 61 30 2d 64 37 33 34 2d 34 32 36 38 2d 62 61 31 30 2d 34 61 65 38 62 34 39 64 37 32 30 30 } //01 00 
		...
		$a_01_3 = {41 6e 6f 6e 5f 53 45 2e 52 65 73 6f 75 72 63 65 73 2e 72 65 73 6f 75 72 63 65 } //01 00 
