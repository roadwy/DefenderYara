...
rule Trojan_BAT_Bladabindi_NEAB_MTB{
	...
	strings :
		...
		$a_01_1 = {42 61 73 65 64 41 6e 74 69 56 54 2e 65 78 65 } //02 00 
		$a_01_2 = {6d 5f 66 35 66 35 36 39 38 62 31 64 66 30 34 66 62 32 61 35 39 62 32 66 65 62 32 30 38 36 65 33 63 37 } //00 00 
	condition:
		any of ($a_*)
