...
rule Trojan_BAT_Arkei_NE_MTB{
	...
	strings :
		...
		$a_01_1 = {2f 00 43 00 73 00 74 00 61 00 72 00 74 00 20 00 43 00 3a 00 5c 00 57 00 69 00 6e 00 64 00 6f 00 77 00 73 00 5c 00 54 00 65 00 6d 00 70 00 5c 00 } //01 00 
		$a_01_2 = {63 00 6d 00 64 00 2e 00 65 00 78 00 65 00 } //00 00 
	condition:
		any of ($a_*)
