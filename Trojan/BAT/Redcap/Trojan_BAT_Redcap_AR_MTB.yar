...
rule Trojan_BAT_Redcap_AR_MTB{
	...
	strings :
		$a_03_0 = {25 16 1f 7c 9d 6f 90 01 03 0a 16 9a 13 06 11 06 17 8d 90 01 01 00 00 01 25 16 1f 20 9d 6f 90 01 03 0a 16 9a 6f 90 01 03 0a 13 18 11 06 11 18 90 00 } //2
