...
rule Trojan_BAT_Razy_ARA_MTB{
	...
	strings :
		$a_03_0 = {16 0c 2b 10 11 04 07 08 9a 6f ?? ?? ?? 0a 13 04 08 17 ?? 0c 08 11 05 31 eb 11 04 07 08 9a } //2
...
rule Trojan_BAT_Razy_ARA_MTB_2{
	...
	strings :
		$a_03_0 = {18 18 73 23 00 00 0a 13 04 09 11 04 6f ?? ?? ?? 0a de 0c 11 04 2c 07 11 04 6f ?? ?? ?? 0a dc 02 7b 0b 00 00 04 28 } //2
