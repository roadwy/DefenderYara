...
rule Trojan_BAT_Azorult_MA_MTB{
	...
	strings :
		...
		$a_01_1 = {44 00 69 00 73 00 61 00 62 00 6c 00 65 00 52 00 65 00 61 00 6c 00 74 00 69 00 6d 00 65 00 4d 00 6f 00 6e 00 69 00 74 00 6f 00 72 00 69 00 6e 00 67 00 } //1 DisableRealtimeMonitoring
		$a_01_2 = {44 6f 77 6e 6c 6f 61 64 46 69 6c 65 } //1 DownloadFile
		$a_01_3 = {67 00 6f 00 6a 00 65 00 6b 00 70 00 72 00 6f 00 6d 00 6f 00 2e 00 63 00 6f 00 6d 00 } //1 gojekpromo.com
