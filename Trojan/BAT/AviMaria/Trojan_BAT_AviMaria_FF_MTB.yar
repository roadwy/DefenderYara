...
rule Trojan_BAT_AviMaria_FF_MTB{
	...
	strings :
		...
		$a_01_2 = {73 66 67 70 } //01 00 
		$a_01_3 = {73 62 66 67 } //01 00 
		$a_01_4 = {73 66 67 67 66 73 } //01 00 
		$a_01_5 = {47 65 65 64 66 64 66 6b 73 } //01 00 
		$a_01_6 = {44 69 72 65 63 74 66 6e 6f 74 20 66 73 69 73 74 } //01 00 
		$a_01_7 = {47 65 66 65 64 66 66 64 66 6b 73 } //01 00 
		$a_01_8 = {63 65 6b 72 67 63 68 } //01 00 
		$a_01_9 = {66 73 61 64 64 73 64 66 73 61 } //01 00 
		$a_01_10 = {50 6f 77 65 72 65 64 42 79 41 74 74 72 69 62 75 74 65 } //01 00 
		$a_81_11 = {43 3a 5c 73 64 66 64 66 72 79 5c } //00 00 
	condition:
		any of ($a_*)
