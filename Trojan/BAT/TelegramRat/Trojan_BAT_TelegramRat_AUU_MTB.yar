...
rule Trojan_BAT_TelegramRat_AUU_MTB{
	...
	strings :
		$a_03_0 = {13 09 11 09 8e 2c 0f 11 09 28 90 01 03 2b 6f 90 01 03 0a 17 58 0c 07 6f 90 01 03 0a 11 09 28 90 01 03 06 26 7e 27 00 00 04 28 90 01 03 0a 90 00 } //2
