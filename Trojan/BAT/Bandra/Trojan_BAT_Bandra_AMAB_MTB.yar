...
rule Trojan_BAT_Bandra_AMAB_MTB{
	...
	strings :
		$a_03_0 = {00 06 07 02 07 6f ?? 00 00 0a d2 9c 00 07 17 58 0b 07 06 8e 69 fe 04 0c 08 2d e5 } //1
		...
		$a_03_2 = {00 06 02 07 91 0c 12 02 28 ?? 00 00 0a 28 ?? 00 00 0a 0a 00 07 17 58 0b 07 02 8e 69 fe 04 0d 09 2d de } //1
	condition:
