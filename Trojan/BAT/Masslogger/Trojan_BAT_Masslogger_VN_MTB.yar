...
rule Trojan_BAT_Masslogger_VN_MTB{
	...
	strings :
		$a_03_0 = {01 25 16 7e ?? ?? ?? 04 a2 25 17 7e ?? ?? ?? 04 a2 25 18 72 ?? ?? ?? 70 a2 73 ?? ?? ?? 06 0a 02 28 ?? ?? ?? 06 00 2a } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_BAT_Masslogger_VN_MTB_2{
	...
	strings :
		$a_03_0 = {70 0c 19 8d ?? ?? ?? 01 25 16 06 a2 25 17 07 a2 25 18 08 a2 73 ?? ?? ?? 06 0d 2a 90 09 10 00 7e ?? ?? ?? 04 0a 7e ?? ?? ?? 04 0b 72 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_BAT_Masslogger_VN_MTB_3{
	...
	strings :
		$a_03_0 = {91 61 d2 9c 90 09 1e 00 fe ?? ?? 00 fe ?? ?? 00 fe ?? ?? 00 fe ?? ?? 00 91 fe ?? ?? 00 61 fe ?? ?? 00 fe ?? ?? 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_BAT_Masslogger_VN_MTB_4{
	...
	strings :
		$a_02_0 = {04 0b 19 8d ?? ?? ?? 01 25 16 06 a2 25 17 07 a2 25 18 20 ?? ?? ?? ?? 28 ?? ?? ?? 06 a2 73 ?? ?? ?? 06 26 2a 90 09 0a 00 7e ?? ?? ?? 04 0a 7e } //1
		$a_03_1 = {0b 14 0c 19 8d ?? ?? ?? 01 25 16 06 a2 25 17 07 a2 25 18 72 ?? ?? ?? 70 a2 73 ?? ?? ?? 06 0d 2a 90 09 0b 00 7e ?? ?? ?? 04 0a 7e ?? ?? ?? 04 } //1
	condition:
...
rule Trojan_BAT_Masslogger_VN_MTB_5{
	...
	strings :
		...
		$a_03_1 = {43 00 3a 00 5c 00 57 00 69 00 6e 00 64 00 6f 00 77 00 73 00 5c 00 4d 00 69 00 63 00 72 00 6f 00 73 00 6f 00 66 00 74 00 2e 00 4e 00 45 00 54 00 5c 00 46 00 72 00 61 00 6d 00 65 00 77 00 6f 00 72 00 6b 00 5c 00 76 00 [0-1e] 5c 00 52 00 65 00 67 00 41 00 73 00 6d 00 2e 00 65 00 78 00 65 00 } //1
		$a_03_2 = {43 3a 5c 57 69 6e 64 6f 77 73 5c 4d 69 63 72 6f 73 6f 66 74 2e 4e 45 54 5c 46 72 61 6d 65 77 6f 72 6b 5c 76 [0-1e] 5c 52 65 67 41 73 6d 2e 65 78 65 } //1
