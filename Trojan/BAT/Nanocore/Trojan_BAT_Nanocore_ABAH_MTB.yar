...
rule Trojan_BAT_Nanocore_ABAH_MTB{
	...
	strings :
		...
		$a_01_1 = {49 00 6e 00 73 00 74 00 61 00 67 00 72 00 61 00 6d 00 5f 00 54 00 61 00 6b 00 65 00 6f 00 75 00 74 00 5f 00 50 00 61 00 72 00 73 00 65 00 72 00 2e 00 52 00 65 00 73 00 6f 00 75 00 72 00 63 00 65 00 73 00 } //01 00 
		$a_01_2 = {64 00 6f 00 77 00 6e 00 6c 00 6f 00 61 00 64 00 } //01 00 
		$a_01_3 = {72 00 65 00 64 00 5f 00 6c 00 6f 00 76 00 65 00 } //00 00 
	condition:
		any of ($a_*)
