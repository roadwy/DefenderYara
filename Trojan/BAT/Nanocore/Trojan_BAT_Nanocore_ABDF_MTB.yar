...
rule Trojan_BAT_Nanocore_ABDF_MTB{
	...
	strings :
		...
		$a_01_2 = {45 00 62 00 6f 00 6f 00 6b 00 73 00 4d 00 61 00 6e 00 61 00 67 00 65 00 72 00 2e 00 52 00 65 00 73 00 6f 00 75 00 72 00 63 00 65 00 73 00 } //00 00  EbooksManager.Resources
	condition:
		any of ($a_*)
