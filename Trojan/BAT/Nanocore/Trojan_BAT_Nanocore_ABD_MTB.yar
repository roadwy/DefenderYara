...
rule Trojan_BAT_Nanocore_ABD_MTB{
	...
	strings :
		$a_03_0 = {2b 07 02 08 20 90 01 03 00 6f 90 01 03 0a 0d 08 09 58 0c 09 20 90 01 03 00 2f d8 0f 00 08 28 90 01 03 2b 07 6f 90 01 03 0a dd 90 01 03 00 07 39 90 01 03 00 07 6f 90 01 03 0a dc 90 0a 48 00 0f 00 08 20 90 01 03 00 58 28 01 90 00 } //2
