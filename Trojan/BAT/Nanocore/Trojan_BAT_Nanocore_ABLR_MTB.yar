...
rule Trojan_BAT_Nanocore_ABLR_MTB{
	...
	strings :
		$a_03_0 = {0d 08 16 73 90 01 01 00 00 0a 73 90 01 01 00 00 0a 13 04 11 04 09 6f 90 01 01 00 00 0a de 0c 11 04 2c 07 11 04 6f 90 01 01 00 00 0a dc 09 6f 90 01 01 00 00 0a 13 05 de 25 09 2c 06 09 6f 90 01 01 00 00 0a dc 90 00 } //4
