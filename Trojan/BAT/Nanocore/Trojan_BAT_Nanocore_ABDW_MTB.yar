...
rule Trojan_BAT_Nanocore_ABDW_MTB{
	...
	strings :
		$a_03_0 = {0a 0a 2b 00 06 2a 90 0a 10 00 02 28 90 01 03 0a 28 90 00 } //2
		$a_03_1 = {01 25 16 08 a2 25 0d 14 14 17 8d 90 01 03 01 25 16 17 9c 25 13 04 90 0a 33 00 0b 07 28 90 01 03 06 28 90 01 03 0a 0c 28 90 01 03 0a 14 72 90 01 03 70 17 8d 90 00 } //2
