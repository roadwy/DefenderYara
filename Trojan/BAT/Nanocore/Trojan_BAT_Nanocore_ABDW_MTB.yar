...
rule Trojan_BAT_Nanocore_ABDW_MTB{
	...
	strings :
		...
		$a_01_2 = {53 00 79 00 73 00 74 00 65 00 6d 00 4d 00 61 00 6e 00 61 00 67 00 65 00 72 00 2e 00 52 00 65 00 73 00 6f 00 75 00 72 00 63 00 65 00 73 00 } //00 00  SystemManager.Resources
	condition:
		any of ($a_*)
