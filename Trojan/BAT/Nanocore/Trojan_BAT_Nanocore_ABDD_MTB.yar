...
rule Trojan_BAT_Nanocore_ABDD_MTB{
	...
	strings :
		...
		$a_01_1 = {54 00 72 00 61 00 66 00 66 00 69 00 63 00 53 00 69 00 6d 00 75 00 6c 00 61 00 74 00 69 00 6f 00 6e 00 2e 00 50 00 72 00 6f 00 70 00 65 00 72 00 74 00 69 00 65 00 73 00 2e 00 52 00 65 00 73 00 6f 00 75 00 72 00 63 00 65 00 73 00 } //00 00  TrafficSimulation.Properties.Resources
	condition:
		any of ($a_*)
