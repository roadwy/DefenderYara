...
rule Trojan_BAT_Nanocore_RDB_MTB{
	...
	strings :
		$a_01_0 = {66 65 66 39 61 62 66 66 2d 66 30 34 62 2d 34 64 30 61 2d 39 62 65 39 2d 30 33 39 61 65 62 64 31 31 32 64 35 } //01 00 
		...
		$a_01_3 = {48 48 48 67 56 50 4c } //00 00 
	condition:
		any of ($a_*)
