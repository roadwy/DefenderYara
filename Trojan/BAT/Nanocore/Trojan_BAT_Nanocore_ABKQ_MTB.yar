...
rule Trojan_BAT_Nanocore_ABKQ_MTB{
	...
	strings :
		$a_03_0 = {0a 06 16 73 90 01 01 00 00 0a 0b 73 90 01 01 00 00 0a 0c 07 08 6f 90 01 01 00 00 0a 08 6f 90 01 01 00 00 0a 0d 09 13 04 de 1e 08 2c 06 08 6f 90 01 01 00 00 0a dc 90 00 } //3
