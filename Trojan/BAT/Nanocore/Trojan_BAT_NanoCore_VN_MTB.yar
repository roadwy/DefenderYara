...
rule Trojan_BAT_NanoCore_VN_MTB_2{
	...
	strings :
		$a_01_0 = {56 00 4d 00 2e 00 4d 00 61 00 69 00 6e 00 } //02 00 
		$a_01_1 = {50 00 45 00 2e 00 4d 00 61 00 69 00 6e 00 } //02 00 
...
rule Trojan_BAT_NanoCore_VN_MTB_9{
	...
	strings :
		$a_81_0 = {4f 4a 49 41 55 48 44 4f 55 48 44 55 4f 41 44 47 } //01 00 
		$a_81_1 = {70 61 73 73 77 6f 72 64 } //01 00 
		$a_81_2 = {42 6c 6f 63 6b 43 6f 70 79 } //01 00 
		$a_81_3 = {24 32 32 66 65 36 34 38 66 2d 32 65 36 62 2d 34 62 38 61 2d 62 62 35 62 2d 30 32 30 66 34 65 33 38 32 38 61 34 } //01 00 
		$a_81_4 = {53 6e 61 6b 65 54 72 6f 6f 70 73 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_BAT_NanoCore_VN_MTB_11{
	...
	strings :
		$a_81_0 = {4f 4a 49 41 55 48 44 4f 55 48 44 55 4f 41 44 47 } //01 00 
		$a_81_1 = {70 61 73 73 77 6f 72 64 } //01 00 
		$a_81_2 = {75 68 66 73 69 68 66 6e 66 } //01 00 
		$a_81_3 = {42 6c 6f 63 6b 43 6f 70 79 } //01 00 
		$a_81_4 = {24 65 66 64 38 32 32 39 36 2d 32 34 37 65 2d 34 36 64 63 2d 62 63 62 61 2d 62 38 37 61 31 31 66 34 62 39 32 30 } //01 00 
		$a_01_5 = {53 00 6e 00 61 00 6b 00 65 00 49 00 64 00 41 00 70 00 70 00 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_BAT_NanoCore_VN_MTB_12{
	...
	strings :
		...
		$a_81_1 = {44 65 62 75 67 67 65 72 } //01 00 
		$a_81_2 = {61 73 64 61 64 73 61 64 73 61 64 73 61 64 61 } //01 00 
		$a_81_3 = {52 65 61 64 42 79 74 65 } //01 00 
		$a_81_4 = {42 6c 6f 63 6b 43 6f 70 79 } //01 00 
		$a_81_5 = {57 72 69 74 65 4c 69 6e 65 } //01 00 
		$a_81_6 = {24 35 34 36 63 66 62 39 34 2d 31 35 39 35 2d 34 33 37 31 2d 62 32 65 37 2d 33 36 37 61 38 64 36 66 36 31 30 30 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_BAT_NanoCore_VN_MTB_14{
	...
	strings :
		$a_81_0 = {49 73 44 65 62 75 67 67 65 72 50 72 65 73 65 6e 74 } //01 00 
		$a_81_1 = {43 68 65 63 6b 52 65 6d 6f 74 65 44 65 62 75 67 67 65 72 50 72 65 73 65 6e 74 } //01 00 
		$a_81_2 = {73 64 61 64 73 61 64 61 64 61 73 64 } //01 00 
		$a_81_3 = {52 65 61 64 42 79 74 65 } //01 00 
		$a_81_4 = {42 6c 6f 63 6b 43 6f 70 79 } //01 00 
		$a_81_5 = {57 72 69 74 65 } //01 00 
		$a_81_6 = {24 38 36 35 35 61 63 36 37 2d 39 65 62 63 2d 34 38 39 36 2d 62 35 65 39 2d 61 35 36 37 30 62 62 65 39 63 61 38 } //00 00 
	condition:
		any of ($a_*)
