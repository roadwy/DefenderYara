...
rule Trojan_BAT_Nanocore_ABDG_MTB{
	...
	strings :
		$a_03_0 = {02 07 02 8e 69 5d 91 06 07 06 8e 69 5d 91 61 28 90 01 03 0a 02 07 17 58 02 8e 69 5d 91 28 90 01 03 0a 59 20 90 01 03 00 58 20 90 01 03 00 5d d2 9c 00 07 15 58 0b 90 00 } //4
