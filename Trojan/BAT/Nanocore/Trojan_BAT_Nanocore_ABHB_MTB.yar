...
rule Trojan_BAT_Nanocore_ABHB_MTB{
	...
	strings :
		...
		$a_01_1 = {41 00 70 00 70 00 2e 00 41 00 70 00 6c 00 69 00 63 00 61 00 74 00 74 00 69 00 6f 00 6e 00 2e 00 52 00 65 00 43 00 53 00 } //00 00  App.Aplicattion.ReCS
	condition:
		any of ($a_*)
