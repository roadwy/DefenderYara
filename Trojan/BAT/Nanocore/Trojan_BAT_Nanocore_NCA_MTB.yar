...
rule Trojan_BAT_Nanocore_NCA_MTB{
	...
	strings :
		$a_03_0 = {18 72 ad 33 00 70 14 d0 90 01 03 02 28 90 01 03 0a 18 8d 90 01 03 01 25 16 17 14 28 90 01 03 0a a2 25 17 16 14 28 90 01 03 0a a2 28 90 01 03 0a 90 00 } //5
