...
rule Trojan_BAT_Nanocore_ABH_MTB{
	...
	strings :
		$a_03_0 = {a2 09 17 7e ?? ?? ?? 0a a2 09 18 06 72 ?? ?? ?? 70 6f ?? ?? ?? 0a a2 09 13 04 08 } //2
...
rule Trojan_BAT_Nanocore_ABH_MTB_2{
	...
	strings :
		$a_03_0 = {26 2a d0 2b ?? ?? 06 26 2a 90 0a 30 00 28 0f ?? ?? 06 6f 3f ?? ?? 0a 07 75 24 ?? ?? 01 08 75 03 ?? ?? 1b 16 6f 40 ?? ?? 0a 07 75 24 ?? ?? 01 28 41 ?? 00 0a } //5
