...
rule Trojan_BAT_NanoCore_MA_MTB{
	meta:
		description = "Trojan:BAT/NanoCore.MA!MTB,SIGNATURE_TYPE_PEHSTR_EXT,0c 00 0c 00 0c 00 00 01 00 "
		
	strings :
		$a_01_0 = {48 00 79 00 54 00 33 00 4e 00 47 00 6e 00 42 00 54 00 59 00 48 00 58 00 63 00 4a 00 77 00 46 00 59 00 76 00 } //01 00  HyT3NGnBTYHXcJwFYv
		$a_01_1 = {76 00 68 00 4f 00 78 00 52 00 44 00 32 00 6a 00 35 00 52 00 70 00 78 00 71 00 33 00 4c 00 53 00 41 00 43 00 } //01 00  vhOxRD2j5Rpxq3LSAC
		...
		$a_01_11 = {4e 61 6e 6f 43 6f 72 65 2e 53 65 72 76 65 72 50 6c 75 67 69 6e 48 6f 73 74 } //00 00  NanoCore.ServerPluginHost
	condition:
		any of ($a_*)
