...
rule Trojan_BAT_Nanocore_ABOV_MTB{
	meta:
		description = "Trojan:BAT/Nanocore.ABOV!MTB,SIGNATURE_TYPE_PEHSTR_EXT,06 00 06 00 04 00 00 03 00 "
		
	strings :
		$a_03_0 = {0a 0d 1c 2c a1 09 02 16 02 8e 69 6f 90 01 03 0a 2a 0a 38 90 01 03 ff 0b 38 90 01 03 ff 0c 2b aa 28 90 01 03 0a 2b b4 28 90 01 03 0a 2b bc 90 0a 33 00 06 6f 90 00 } //01 00 
