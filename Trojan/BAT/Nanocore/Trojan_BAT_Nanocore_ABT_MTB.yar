...
rule Trojan_BAT_Nanocore_ABT_MTB{
	meta:
		description = "Trojan:BAT/Nanocore.ABT!MTB,SIGNATURE_TYPE_PEHSTR_EXT,06 00 06 00 05 00 00 02 00 "
		
	strings :
		$a_03_0 = {91 61 d2 6f 90 01 03 0a 07 1d 2c 04 17 58 0b 07 02 8e 69 32 db 06 6f 90 01 03 0a 25 2d 02 26 14 2a 90 00 } //01 00 
...
rule Trojan_BAT_Nanocore_ABT_MTB_2{
	meta:
		description = "Trojan:BAT/Nanocore.ABT!MTB,SIGNATURE_TYPE_PEHSTR_EXT,07 00 07 00 04 00 00 04 00 "
	...
	strings :
		...
		$a_01_3 = {48 00 69 00 65 00 72 00 61 00 72 00 63 00 68 00 79 00 2e 00 50 00 72 00 6f 00 70 00 65 00 72 00 74 00 69 00 65 00 73 00 2e 00 52 00 65 00 73 00 6f 00 75 00 72 00 63 00 65 00 73 00 } //00 00  Hierarchy.Properties.Resources
	condition:
		any of ($a_*)
