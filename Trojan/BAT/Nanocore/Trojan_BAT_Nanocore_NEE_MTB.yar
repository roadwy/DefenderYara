...
rule Trojan_BAT_Nanocore_NEE_MTB{
	...
	strings :
		...
		$a_01_1 = {52 00 65 00 6c 00 69 00 67 00 69 00 6f 00 6e 00 5f 00 4a 00 65 00 6f 00 70 00 61 00 72 00 64 00 79 00 } //05 00  Religion_Jeopardy
		$a_01_2 = {6e 00 63 00 76 00 69 00 65 00 77 00 65 00 72 00 2e 00 65 00 78 00 65 00 } //00 00  ncviewer.exe
	condition:
		any of ($a_*)
