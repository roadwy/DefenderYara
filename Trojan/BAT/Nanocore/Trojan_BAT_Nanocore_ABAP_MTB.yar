...
rule Trojan_BAT_Nanocore_ABAP_MTB{
	...
	strings :
		$a_03_0 = {0a 11 0b 09 18 6f 90 01 03 0a 11 0b 09 18 6f 90 01 03 0a 8e 69 5d 91 09 17 6f 90 01 03 0a 11 0b 91 61 9c 11 0b 17 d6 13 0b 11 0b 11 0a 31 cb 90 00 } //1
