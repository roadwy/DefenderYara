...
rule Trojan_BAT_Nanocore_SA_MSR{
	...
	strings :
		...
		$a_00_1 = {43 00 53 00 50 00 41 00 52 00 4d 00 50 00 72 00 69 00 63 00 69 00 6e 00 67 00 43 00 61 00 6c 00 4f 00 70 00 73 00 2e 00 50 00 72 00 6f 00 70 00 65 00 72 00 74 00 69 00 65 00 73 00 2e 00 52 00 65 00 73 00 6f 00 75 00 72 00 63 00 65 00 73 00 } //01 00 
		$a_01_2 = {30 2e 34 2e 37 2e 32 } //00 00 
	condition:
		any of ($a_*)
