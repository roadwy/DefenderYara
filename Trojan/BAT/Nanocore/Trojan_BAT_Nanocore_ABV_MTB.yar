...
rule Trojan_BAT_Nanocore_ABV_MTB{
	...
	strings :
		$a_03_0 = {07 d8 b4 6f b0 90 01 02 0a 00 2b 00 00 07 17 d6 0b 07 1f 0f 31 cc 02 74 0b 90 01 02 1b 06 6f b1 90 01 02 0a 20 ff 90 01 02 00 28 a5 90 01 02 06 00 2a 90 0a 45 00 06 16 6f b0 90 01 02 0a 00 2b 19 00 06 07 19 32 07 20 ff 90 01 02 00 2b 03 03 90 00 } //6
