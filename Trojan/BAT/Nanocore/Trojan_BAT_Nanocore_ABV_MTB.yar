...
rule Trojan_BAT_Nanocore_ABV_MTB{
	...
	strings :
		...
		$a_01_1 = {4f 6c 65 44 62 43 6f 6d 6d 61 6e 64 } //01 00 
		$a_01_2 = {47 65 74 52 65 73 6f 75 72 63 65 53 74 72 69 6e 67 } //01 00 
		$a_01_3 = {44 61 74 65 54 69 6d 65 50 69 63 6b 65 72 } //01 00 
		$a_01_4 = {52 65 61 64 42 79 74 65 73 } //00 00 
	condition:
		any of ($a_*)
