...
rule Trojan_BAT_Nanocore_ABJW_MTB{
	...
	strings :
		...
		$a_01_1 = {57 00 46 00 41 00 5f 00 59 00 61 00 63 00 68 00 74 00 5f 00 44 00 69 00 63 00 65 00 2e 00 44 00 53 00 53 00 44 00 57 00 45 00 } //00 00  WFA_Yacht_Dice.DSSDWE
	condition:
		any of ($a_*)
