...
rule Trojan_BAT_Tzeebot_C{
	...
	strings :
		...
		$a_03_7 = {06 17 58 0a 90 0a 40 00 07 7e 90 01 02 00 04 7e 90 01 02 00 04 90 02 02 6f 90 01 02 00 0a 6f 90 01 02 00 0a 8c 90 01 01 00 00 01 28 90 01 01 00 00 0a 0b 90 00 } //5
