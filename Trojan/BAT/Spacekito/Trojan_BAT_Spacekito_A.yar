...
rule Trojan_BAT_Spacekito_A{
	...
	strings :
		...
		$a_03_4 = {2e 00 7a 00 69 00 70 00 90 01 02 5f 00 6f 00 6c 00 64 00 90 00 } //1
		...
		$a_03_7 = {4f 00 4b 00 69 00 74 00 53 00 70 00 61 00 63 00 65 00 90 01 02 70 00 61 00 70 00 61 00 72 00 72 00 75 00 63 00 68 00 61 00 73 00 90 00 } //1
		...
		$a_03_12 = {22 00 6e 00 61 00 6d 00 65 00 22 00 3a 00 90 02 02 22 00 4f 00 4b 00 69 00 74 00 53 00 70 00 61 00 63 00 65 00 22 00 2c 00 90 00 } //1
