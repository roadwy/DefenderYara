...
rule Trojan_BAT_Dapato_DA_MTB{
	...
	strings :
		$a_03_0 = {06 0b 02 6f 90 01 03 0a 0c 2b 32 02 07 6f 90 01 03 0a 28 90 01 03 0a 28 90 01 03 0a 28 90 01 03 06 da 0d 06 09 28 90 01 03 0a 28 90 01 03 0a 28 90 01 03 0a 0a 07 28 90 01 03 06 d6 0b 07 08 32 ca 90 00 } //1
