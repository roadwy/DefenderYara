...
rule Trojan_BAT_Dapato_AD_MTB{
	...
	strings :
		$a_03_0 = {0a 2c 13 07 2c 04 16 0b 2b 0c 72 f5 02 00 70 28 90 01 03 0a 16 2a 09 17 58 0d 09 08 8e 69 32 d3 72 1d 03 00 70 90 00 } //2
...
rule Trojan_BAT_Dapato_AD_MTB_2{
	...
	strings :
		$a_03_0 = {13 04 11 04 2c 16 00 06 28 90 01 01 00 00 0a 00 72 90 01 01 00 00 70 28 90 01 01 00 00 0a 00 00 2b 0d 00 72 90 01 01 00 00 70 28 90 01 01 00 00 0a 00 00 00 de 05 90 00 } //2
