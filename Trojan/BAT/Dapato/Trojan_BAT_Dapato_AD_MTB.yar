...
rule Trojan_BAT_Dapato_AD_MTB{
	...
	strings :
		...
		$a_01_1 = {43 00 61 00 6c 00 6c 00 43 00 6f 00 72 00 65 00 49 00 6e 00 73 00 74 00 61 00 6c 00 6c 00 2e 00 65 00 78 00 65 00 } //01 00 
		$a_01_2 = {61 00 6c 00 73 00 6f 00 70 00 77 00 6e 00 72 00 75 00 6e 00 } //00 00 
	condition:
		any of ($a_*)
