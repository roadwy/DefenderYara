...
rule Trojan_BAT_Disco_DB_MTB{
	...
	strings :
		$a_81_0 = {55 48 4a 6c 62 57 6c 31 62 53 42 54 63 44 41 77 5a 6d 56 79 4b 67 3d 3d } //1 UHJlbWl1bSBTcDAwZmVyKg==
		$a_81_1 = {5f 45 6e 63 72 79 70 74 65 64 24 } //1 _Encrypted$
		$a_81_2 = {43 72 79 70 74 6f 4f 62 66 75 73 63 61 74 6f 72 } //1 CryptoObfuscator
