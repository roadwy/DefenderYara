...
rule Trojan_BAT_Disco_DAC_MTB{
	...
	strings :
		$a_03_0 = {11 04 18 6f 90 01 01 00 00 0a 11 04 0c 28 90 01 01 00 00 0a 08 6f 90 01 01 00 00 0a 07 16 07 8e 69 6f 90 01 01 00 00 0a 6f 90 01 01 00 00 0a 28 90 01 01 00 00 0a 0a de 22 7e 90 01 01 00 00 04 18 9a 80 90 01 01 00 00 04 2b a1 90 00 } //3
