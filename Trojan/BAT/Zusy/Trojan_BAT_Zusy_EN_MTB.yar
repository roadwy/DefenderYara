...
rule Trojan_BAT_Zusy_EN_MTB{
	...
	strings :
		...
		$a_01_1 = {50 72 6f 6a 65 63 74 2e 52 75 6d 6d 61 67 65 2e 65 78 65 } //01 00 
		$a_01_2 = {47 65 74 53 75 62 4b 65 79 4e 61 6d 65 73 } //01 00 
		$a_01_3 = {42 69 74 43 6f 6e 76 65 72 74 65 72 } //01 00 
		$a_01_4 = {57 65 62 52 65 71 75 65 73 74 } //01 00 
		$a_01_5 = {50 72 6f 78 79 55 73 65 } //00 00 
	condition:
		any of ($a_*)
