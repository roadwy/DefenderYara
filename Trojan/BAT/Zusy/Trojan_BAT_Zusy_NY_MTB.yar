...
rule Trojan_BAT_Zusy_NY_MTB{
	...
	strings :
		$a_03_0 = {07 20 31 57 57 35 5a 20 90 01 03 13 61 2b c9 00 20 90 01 03 ec 2b c1 7e 90 01 03 04 28 90 01 03 06 0a 07 20 90 01 03 b2 5a 20 90 01 03 9f 61 2b a7 07 20 90 01 03 e4 5a 20 90 01 03 fa 61 2b 98 90 00 } //5
