...
rule Trojan_BAT_Ramcos_RDA_MTB{
	...
	strings :
		...
		$a_03_1 = {06 6f 2d 00 00 0a 0b 07 d2 13 07 12 07 72 90 01 04 28 2e 00 00 0a 13 04 11 06 07 11 04 a2 08 11 04 07 d2 6f 2f 00 00 0a 08 11 04 6f 30 00 00 0a 07 d2 6f 2f 00 00 0a 06 6f 31 00 00 0a 90 00 } //2
	condition:
