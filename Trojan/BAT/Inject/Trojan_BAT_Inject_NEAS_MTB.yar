...
rule Trojan_BAT_Inject_NEAS_MTB{
	...
	strings :
		$a_03_0 = {00 00 0a 06 8e 69 20 00 30 00 00 1f 40 28 90 01 01 00 00 06 13 04 09 11 04 06 06 8e 69 12 01 28 90 01 01 00 00 06 13 05 11 05 13 07 11 07 2c 2d 00 20 fb 03 00 00 16 08 90 00 } //10
