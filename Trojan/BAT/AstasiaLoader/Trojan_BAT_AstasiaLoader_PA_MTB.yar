...
rule Trojan_BAT_AstasiaLoader_PA_MTB{
	...
	strings :
		...
		$a_03_2 = {07 1f 1c 28 90 01 01 00 00 0a 72 90 01 04 28 90 01 01 00 00 0a 6f 90 01 01 00 00 0a 20 d0 07 00 00 28 90 01 01 00 00 0a 1f 1c 28 90 01 01 00 00 0a 72 90 01 04 28 90 00 } //3
	condition:
