...
rule Trojan_BAT_AstasiaLoader_PA_MTB{
	...
	strings :
		$a_01_0 = {5c 00 69 00 6e 00 66 00 65 00 63 00 74 00 65 00 64 00 2e 00 65 00 78 00 65 00 } //01 00 
		$a_01_1 = {41 00 73 00 74 00 61 00 73 00 69 00 61 00 4c 00 6f 00 61 00 64 00 65 00 72 00 } //03 00 
