...
rule Trojan_BAT_WshRat_AWS_MTB{
	...
	strings :
		$a_03_0 = {0a 2b 52 06 6f 90 01 01 00 00 0a 74 90 01 01 00 00 01 0b 7e 90 01 01 00 00 04 07 6f 90 01 01 01 00 0a 6f 90 01 01 01 00 0a 0c 08 2c 19 7e 90 01 01 00 00 04 07 6f 90 00 } //2
