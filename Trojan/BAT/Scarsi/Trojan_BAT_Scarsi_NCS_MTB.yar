...
rule Trojan_BAT_Scarsi_NCS_MTB{
	...
	strings :
		$a_03_0 = {28 30 00 00 0a 6f 90 01 02 00 0a 07 1f 10 8d 90 01 02 00 01 25 d0 90 01 02 00 04 28 90 01 02 00 0a 6f 90 01 02 00 0a 06 07 6f 90 01 02 00 0a 17 73 90 01 02 00 0a 25 02 16 02 8e 69 6f 90 01 02 00 0a 6f 90 01 02 00 0a 06 28 90 01 02 00 06 28 90 01 02 00 06 2a 90 00 } //5
