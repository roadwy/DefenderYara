...
rule Trojan_BAT_Scarsi_ABIO_MTB{
	...
	strings :
		$a_03_0 = {16 0a 2b 6a 00 28 90 01 03 06 73 90 01 03 0a 0b 73 90 01 03 0a 0c 07 16 73 90 01 03 0a 73 90 01 03 0a 0d 09 08 6f 90 01 03 0a de 0a 09 2c 06 09 6f 90 01 03 0a dc 08 6f 90 01 03 0a 13 04 de 34 90 00 } //2
