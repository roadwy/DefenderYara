...
rule Trojan_BAT_Keylogger_NKL_MTB{
	...
	strings :
		...
		$a_01_1 = {46 78 34 62 65 74 61 } //00 00  Fx4beta
	condition:
		any of ($a_*)
...
rule Trojan_BAT_Keylogger_NKL_MTB_2{
	...
	strings :
		...
		$a_01_1 = {53 65 63 75 72 65 48 6f 72 69 7a 6f 6e 73 2e 67 2e 72 65 73 6f 75 72 63 65 73 } //00 00  SecureHorizons.g.resources
	condition:
		any of ($a_*)
...
rule Trojan_BAT_Keylogger_NKL_MTB_3{
	...
	strings :
		...
		$a_01_1 = {41 6e 61 72 63 68 79 2e 67 2e 72 65 73 6f 75 72 63 65 73 } //00 00  Anarchy.g.resources
	condition:
		any of ($a_*)
...
rule Trojan_BAT_Keylogger_NKL_MTB_4{
	...
	strings :
		...
		$a_01_2 = {6e 30 6c 43 34 35 65 6f 57 67 6a 4f 6c 72 5f } //00 00  n0lC45eoWgjOlr_
	condition:
		any of ($a_*)
