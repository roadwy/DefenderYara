...
rule Trojan_BAT_Keylogger_ABS_MTB{
	...
	strings :
		...
		$a_01_2 = {67 65 74 5f 57 6f 72 6b 69 6e 67 44 69 72 65 63 74 6f 72 79 } //01 00 
		$a_01_3 = {47 65 74 46 6f 6c 64 65 72 50 61 74 68 } //01 00 
		$a_01_4 = {47 65 74 46 69 6c 65 44 72 6f 70 4c 69 73 74 } //01 00 
		$a_01_5 = {43 72 65 61 74 65 49 6e 73 74 61 6e 63 65 } //01 00 
		$a_01_6 = {67 65 74 5f 4b 65 79 62 6f 61 72 64 44 65 76 69 63 65 } //00 00 
	condition:
		any of ($a_*)
