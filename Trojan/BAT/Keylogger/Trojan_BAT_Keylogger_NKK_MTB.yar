...
rule Trojan_BAT_Keylogger_NKK_MTB{
	...
	strings :
		$a_03_0 = {72 fb 01 00 70 28 90 01 01 00 00 0a 74 90 01 01 00 00 01 0b 07 6f 90 01 01 00 00 0a 74 90 01 01 00 00 01 0c 08 6f 90 01 01 00 00 0a 0d 09 73 90 01 01 00 00 0a 13 04 00 00 11 04 6f 90 01 01 00 00 0a 90 00 } //5
