...
rule Trojan_BAT_KeyLogger_SPAT_MTB{
	...
	strings :
		...
		$a_01_1 = {62 00 65 00 6a 00 6e 00 36 00 36 00 36 00 53 00 74 00 75 00 62 00 } //01 00 
		$a_01_2 = {40 44 6d 43 44 39 35 66 64 77 79 73 45 65 63 56 78 4a 62 52 41 40 } //00 00 
	condition:
		any of ($a_*)
