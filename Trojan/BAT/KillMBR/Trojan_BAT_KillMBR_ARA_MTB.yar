...
rule Trojan_BAT_KillMBR_ARA_MTB{
	...
	strings :
		...
		$a_01_1 = {50 6c 61 79 53 79 6e 63 } //02 00 
...
rule Trojan_BAT_KillMBR_ARA_MTB_4{
	...
	strings :
		$a_01_0 = {67 65 74 5f 50 72 69 6d 61 72 79 53 63 72 65 65 6e } //01 00 
		$a_01_1 = {63 6c 65 61 72 5f 73 63 72 65 65 6e } //01 00 
		$a_01_2 = {47 44 49 5f 70 61 79 6c 6f 61 64 73 } //01 00 
		$a_01_3 = {72 65 67 5f 64 65 73 74 72 6f 79 } //01 00 
		$a_01_4 = {6d 62 72 5f 64 65 73 74 72 6f 79 } //02 00 
		$a_01_5 = {64 65 73 74 72 75 63 74 69 76 65 5f 74 72 6f 6a 61 6e } //02 00 
