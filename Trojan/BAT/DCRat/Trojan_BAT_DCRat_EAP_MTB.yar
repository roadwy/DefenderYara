...
rule Trojan_BAT_DCRat_EAP_MTB{
	...
	strings :
		...
		$a_01_1 = {57 00 51 00 4a 00 7a 00 6a 00 77 00 2e 00 50 00 72 00 6f 00 70 00 65 00 72 00 74 00 69 00 65 00 73 00 2e 00 52 00 65 00 73 00 6f 00 75 00 72 00 63 00 65 00 73 00 } //00 00  WQJzjw.Properties.Resources
	condition:
		any of ($a_*)
