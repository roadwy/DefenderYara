...
rule Trojan_BAT_DCRat_MAAB_MTB{
	...
	strings :
		$a_01_0 = {24 64 31 63 63 32 62 61 64 2d 64 36 66 37 2d 34 37 62 38 2d 61 66 61 38 2d 33 61 39 64 34 34 33 30 64 63 63 31 } //0a 00  $d1cc2bad-d6f7-47b8-afa8-3a9d4430dcc1
		...
		$a_01_5 = {41 65 73 4d 61 6e 61 67 65 64 } //01 00  AesManaged
		$a_01_6 = {43 00 6f 00 63 00 6b 00 6f 00 73 00 20 00 49 00 6e 00 63 00 6f 00 72 00 70 00 6f 00 72 00 61 00 74 00 65 00 64 00 } //00 00  Cockos Incorporated
	condition:
		any of ($a_*)
