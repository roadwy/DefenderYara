...
rule Trojan_BAT_DCRat_ADR_MTB{
	...
	strings :
		$a_01_0 = {14 fe 01 0a 06 2c 41 00 7e 59 00 00 0a 0b 00 28 cc 00 00 0a 6f cd 00 00 0a 6f ce 00 00 0a 0b 00 de 05 26 00 00 de 00 07 28 0c 00 00 0a 0c 08 2c 08 } //00 00 
	condition:
		any of ($a_*)
