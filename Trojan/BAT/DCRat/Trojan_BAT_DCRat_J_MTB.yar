...
rule Trojan_BAT_DCRat_J_MTB{
	meta:
		description = "Trojan:BAT/DCRat.J!MTB,SIGNATURE_TYPE_PEHSTR_EXT,06 00 06 00 04 00 00 02 00 "
		
	strings :
		$a_01_0 = {08 09 20 ff 00 00 00 9c 09 17 58 0d 09 08 8e 69 32 } //02 00 
		$a_01_1 = {25 17 58 13 0a 91 08 61 d2 9c 09 17 5f 17 } //01 00 
