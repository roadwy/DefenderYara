...
rule Trojan_BAT_DcRat_NEAA_MTB{
	...
	strings :
		...
		$a_01_1 = {72 38 6c 39 73 4a 4c 70 73 4b 78 4b 62 47 31 32 31 5a 65 } //05 00  r8l9sJLpsKxKbG121Ze
		$a_01_2 = {70 44 41 64 42 33 6c 33 77 41 33 58 75 67 57 46 4e 64 71 } //00 00  pDAdB3l3wA3XugWFNdq
	condition:
		any of ($a_*)
