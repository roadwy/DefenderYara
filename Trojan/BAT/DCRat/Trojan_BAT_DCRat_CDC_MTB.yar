...
rule Trojan_BAT_DCRat_CDC_MTB{
	...
	strings :
		$a_03_0 = {28 07 00 00 0a 11 00 28 90 01 03 06 13 06 20 90 01 03 00 7e 90 01 03 04 7b 90 01 03 04 39 90 01 03 ff 26 20 90 01 03 00 38 90 01 03 ff 73 90 01 03 0a 13 02 20 90 01 03 00 90 00 } //5
