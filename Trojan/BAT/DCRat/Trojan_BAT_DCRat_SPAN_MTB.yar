...
rule Trojan_BAT_DCRat_SPAN_MTB{
	...
	strings :
		...
		$a_01_1 = {37 00 77 00 6b 00 48 00 6a 00 75 00 65 00 51 00 4a 00 6b 00 46 00 78 00 4e 00 76 00 45 00 55 00 57 00 50 00 4f 00 48 00 45 00 41 00 3d 00 3d 00 } //00 00  7wkHjueQJkFxNvEUWPOHEA==
	condition:
		any of ($a_*)
