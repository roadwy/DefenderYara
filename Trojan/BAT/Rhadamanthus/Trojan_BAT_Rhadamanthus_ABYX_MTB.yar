...
rule Trojan_BAT_Rhadamanthus_ABYX_MTB{
	...
	strings :
		$a_03_0 = {72 0d 00 00 70 28 90 01 01 00 00 06 0a 28 90 01 01 00 00 0a 06 6f 90 01 01 00 00 0a 28 90 01 01 00 00 0a 28 90 01 01 00 00 06 0b dd 90 01 01 00 00 00 26 de d6 07 2a 90 00 } //2
