...
rule Trojan_BAT_RemcosRAT_NSA_MTB{
	...
	strings :
		$a_03_0 = {38 58 00 00 00 11 01 28 90 01 01 00 00 0a 13 02 38 90 01 01 00 00 00 11 02 13 03 38 90 01 01 00 00 00 11 02 16 11 02 8e 69 28 11 00 00 0a 90 00 } //5
