...
rule Trojan_BAT_RemcosRAT_NRC_MTB{
	...
	strings :
		$a_03_0 = {28 e5 00 00 0a 80 90 01 03 04 11 04 20 90 01 03 76 5a 20 90 01 03 a0 61 38 90 01 03 ff 00 11 04 20 90 01 03 6f 5a 20 90 01 03 9e 61 38 90 01 03 ff 11 04 20 90 01 03 88 5a 20 90 01 03 4d 61 90 00 } //5
