...
rule Trojan_BAT_RemcosRAT_NRA_MTB{
	...
	strings :
		$a_03_0 = {11 04 73 02 00 00 0a 0c 2b 0b 28 90 01 01 00 00 0a 2b eb 13 04 2b eb 73 90 01 01 00 00 0a 0b 08 16 73 90 01 01 00 00 0a 73 90 01 01 00 00 0a 0d 09 07 6f 90 01 01 00 00 0a de 07 90 00 } //5
...
rule Trojan_BAT_RemcosRAT_NRA_MTB_2{
	...
	strings :
		$a_03_0 = {6f 0c 00 00 0a 13 20 11 1a 73 90 01 02 00 0a 13 21 11 21 11 20 16 73 90 01 02 00 0a 13 22 11 22 28 90 01 02 00 0a 73 90 01 02 00 0a 13 23 11 14 6f 90 01 02 00 0a 28 90 01 02 00 0a 28 90 01 02 00 0a 13 24 11 23 6f 90 01 02 00 0a 28 90 01 02 00 0a 90 00 } //5
