...
rule Trojan_BAT_RemcosRAT_NRR_MTB{
	...
	strings :
		$a_03_0 = {7e 17 00 00 04 02 17 58 91 1f 10 62 60 0a 06 7e ?? 00 00 04 02 18 58 91 1e 62 60 0a 06 7e ?? 00 00 04 02 19 58 91 60 0a 02 1a 58 fe ?? ?? 00 06 17 2f 06 7e ?? 00 00 0a 2a } //5
