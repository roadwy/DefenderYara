...
rule Trojan_BAT_RemcosRAT_AH_MTB{
	...
	strings :
		$a_03_0 = {11 00 74 02 90 01 02 1b 1e 3a 39 90 01 02 00 26 38 20 90 01 02 00 28 17 90 01 02 06 72 99 90 01 02 70 7e 08 90 01 02 04 6f 16 90 01 02 0a 18 3a 0d 90 01 02 00 26 38 cd 90 01 02 ff 11 01 90 00 } //1
		$a_03_1 = {8e 69 1e 3a 18 90 01 02 00 26 26 26 38 0b 90 01 02 00 2a 38 fa 90 01 02 ff 38 f5 90 01 02 ff 38 f0 90 01 02 ff 28 01 90 01 02 0a 38 e7 90 01 02 ff 90 0a 2d 00 02 16 02 90 00 } //1
