...
rule Trojan_BAT_ElysiumStealer_DZ_MTB{
	meta:
		description = "Trojan:BAT/ElysiumStealer.DZ!MTB,SIGNATURE_TYPE_PEHSTR_EXT,1b 00 1b 00 09 00 00 14 00 "
		
	strings :
		$a_81_0 = {4e 65 77 42 72 6f 77 73 65 72 53 6f 66 74 } //01 00  NewBrowserSoft
