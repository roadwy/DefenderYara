...
rule Trojan_BAT_ElysiumStealer_ED_MTB{
	meta:
		description = "Trojan:BAT/ElysiumStealer.ED!MTB,SIGNATURE_TYPE_PEHSTR_EXT,1b 00 1b 00 09 00 00 14 00 "
		
	strings :
		$a_81_0 = {66 67 64 66 64 66 64 73 67 66 } //01 00  fgdfdfdsgf
