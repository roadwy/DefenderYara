...
rule Trojan_BAT_ElysiumStealer_DU_MTB{
	meta:
		description = "Trojan:BAT/ElysiumStealer.DU!MTB,SIGNATURE_TYPE_PEHSTR_EXT,1b 00 1b 00 09 00 00 14 00 "
		
	strings :
		$a_81_0 = {73 67 66 64 73 67 66 64 67 6a 70 } //01 00  sgfdsgfdgjp
