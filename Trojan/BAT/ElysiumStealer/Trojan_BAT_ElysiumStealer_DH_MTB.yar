...
rule Trojan_BAT_ElysiumStealer_DH_MTB{
	meta:
		description = "Trojan:BAT/ElysiumStealer.DH!MTB,SIGNATURE_TYPE_PEHSTR_EXT,1b 00 1b 00 0a 00 00 14 00 "
		
	strings :
		$a_81_0 = {66 67 68 66 67 68 66 } //14 00  fghfghf
		$a_81_1 = {64 66 68 64 66 67 64 66 } //14 00  dfhdfgdf
		$a_81_2 = {46 49 4c 45 4d 59 20 43 6f 6d 70 61 6e 79 } //01 00  FILEMY Company
