...
rule Trojan_BAT_ElysiumStealer_DP_MTB{
	...
	strings :
		$a_81_0 = {73 64 67 73 64 66 65 33 31 77 } //01 00 
		...
		$a_81_4 = {44 65 63 72 79 70 74 } //01 00 
		$a_81_5 = {52 65 76 65 72 73 65 44 65 63 6f 64 65 } //01 00 
		$a_81_6 = {52 65 73 6f 6c 76 65 } //00 00 
	condition:
		any of ($a_*)
