...
rule Trojan_BAT_ElysiumStealer_EC_MTB{
	meta:
		description = "Trojan:BAT/ElysiumStealer.EC!MTB,SIGNATURE_TYPE_PEHSTR_EXT,1b 00 1b 00 0a 00 00 14 00 "
		
	strings :
		$a_81_0 = {64 66 67 68 64 66 67 66 64 } //14 00  dfghdfgfd
		$a_81_1 = {6f 69 70 6f 6f 69 70 } //01 00  oipooip
