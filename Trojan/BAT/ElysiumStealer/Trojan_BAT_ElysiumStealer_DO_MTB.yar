...
rule Trojan_BAT_ElysiumStealer_DO_MTB{
	meta:
		description = "Trojan:BAT/ElysiumStealer.DO!MTB,SIGNATURE_TYPE_PEHSTR_EXT,1b 00 1b 00 0a 00 00 14 00 "
		
	strings :
		$a_81_0 = {70 6c 69 63 61 74 69 6f 6e 20 72 65 73 65 72 76 65 64 } //14 00  plication reserved
		$a_81_1 = {68 66 64 64 66 76 66 73 64 63 65 32 32 32 } //01 00  hfddfvfsdce222
