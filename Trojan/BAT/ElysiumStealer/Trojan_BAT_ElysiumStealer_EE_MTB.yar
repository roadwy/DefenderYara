...
rule Trojan_BAT_ElysiumStealer_EE_MTB{
	meta:
		description = "Trojan:BAT/ElysiumStealer.EE!MTB,SIGNATURE_TYPE_PEHSTR_EXT,1b 00 1b 00 09 00 00 14 00 "
		
	strings :
		$a_81_0 = {66 67 66 67 68 67 66 67 66 68 67 68 66 } //01 00  fgfghgfgfhghf
