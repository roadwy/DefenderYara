...
rule Trojan_BAT_ElysiumStealer_DL_MTB{
	...
	strings :
		$a_81_0 = {39 33 31 38 37 34 32 } //14 00 
		$a_81_1 = {61 35 33 32 32 32 32 32 } //01 00 
		$a_81_2 = {5f 46 49 4c 45 54 59 50 45 5f 46 49 4c 45 5f 49 43 4f 4e 5f 31 38 37 37 } //01 00 
