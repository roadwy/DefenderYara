...
rule Trojan_BAT_ElysiumStealer_DL_MTB{
	meta:
		description = "Trojan:BAT/ElysiumStealer.DL!MTB,SIGNATURE_TYPE_PEHSTR_EXT,1b 00 1b 00 0a 00 00 14 00 "
		
	strings :
		$a_81_0 = {39 33 31 38 37 34 32 } //14 00  9318742
		$a_81_1 = {61 35 33 32 32 32 32 32 } //01 00  a5322222
		$a_81_2 = {5f 46 49 4c 45 54 59 50 45 5f 46 49 4c 45 5f 49 43 4f 4e 5f 31 38 37 37 } //01 00  _FILETYPE_FILE_ICON_1877
