...
rule Trojan_BAT_ElysiumStealer_EJ_MTB{
	...
	strings :
		$a_81_0 = {64 66 67 68 64 66 67 67 64 66 67 64 66 } //14 00  dfghdfggdfgdf
		$a_81_1 = {66 61 66 61 73 64 73 61 64 } //01 00  fafasdsad
		$a_81_2 = {64 64 64 64 64 64 61 73 } //01 00  ddddddas
		$a_81_3 = {61 73 64 61 73 64 61 } //01 00  asdasda
		...
		$a_81_10 = {49 6e 76 6f 6b 65 } //00 00  Invoke
	condition:
		any of ($a_*)
