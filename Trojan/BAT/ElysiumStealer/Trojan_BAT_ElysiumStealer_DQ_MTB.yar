...
rule Trojan_BAT_ElysiumStealer_DQ_MTB{
	meta:
		description = "Trojan:BAT/ElysiumStealer.DQ!MTB,SIGNATURE_TYPE_PEHSTR_EXT,1b 00 1b 00 09 00 00 14 00 "
		
	strings :
		$a_81_0 = {67 64 66 67 64 66 32 32 31 73 } //01 00  gdfgdf221s
