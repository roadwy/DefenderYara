...
rule Trojan_BAT_ElysiumStealer_EB_MTB{
	meta:
		description = "Trojan:BAT/ElysiumStealer.EB!MTB,SIGNATURE_TYPE_PEHSTR_EXT,1b 00 1b 00 09 00 00 14 00 "
		
	strings :
		$a_81_0 = {64 77 73 67 73 64 66 66 73 64 } //01 00  dwsgsdffsd
