...
rule Trojan_BAT_AysncRat_RE_MTB{
	...
	strings :
		...
		$a_01_1 = {24 38 35 64 61 39 36 39 39 2d 65 66 66 66 2d 34 34 36 32 2d 39 35 36 37 2d 30 38 63 36 34 36 39 64 61 38 30 36 } //00 00  $85da9699-efff-4462-9567-08c6469da806
	condition:
		any of ($a_*)
