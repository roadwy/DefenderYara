...
rule Trojan_BAT_InfoStealer_ARA_MTB_2{
	...
	strings :
		$a_01_0 = {41 00 70 00 70 00 44 00 61 00 74 00 61 00 47 00 72 00 61 00 62 00 62 00 65 00 72 00 } //2 AppDataGrabber
		$a_01_1 = {43 00 72 00 65 00 64 00 69 00 74 00 43 00 61 00 72 00 64 00 47 00 72 00 61 00 62 00 62 00 65 00 72 00 } //2 CreditCardGrabber
		$a_01_2 = {50 00 61 00 73 00 73 00 77 00 6f 00 72 00 64 00 47 00 72 00 61 00 62 00 62 00 65 00 72 00 } //2 PasswordGrabber
		$a_01_3 = {48 00 69 00 73 00 74 00 6f 00 72 00 79 00 47 00 72 00 61 00 62 00 62 00 65 00 72 00 } //2 HistoryGrabber
		$a_01_4 = {57 00 61 00 6c 00 6c 00 65 00 74 00 47 00 72 00 61 00 62 00 62 00 65 00 72 00 } //2 WalletGrabber
	condition:
