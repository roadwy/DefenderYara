...
rule Trojan_BAT_Moloterae_E{
	...
	strings :
		$a_01_0 = {68 00 74 00 74 00 70 00 3a 00 2f 00 2f 00 77 00 77 00 77 00 2e 00 6e 00 61 00 74 00 74 00 6c 00 79 00 2e 00 63 00 6f 00 6d 00 2f 00 66 00 61 00 76 00 69 00 63 00 6f 00 6e 00 2e 00 69 00 63 00 6f 00 } //01 00  http://www.nattly.com/favicon.ico
