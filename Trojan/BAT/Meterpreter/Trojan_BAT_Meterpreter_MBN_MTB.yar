...
rule Trojan_BAT_Meterpreter_MBN_MTB{
	...
	strings :
		...
		$a_01_1 = {24 32 30 35 39 61 36 38 36 2d 33 66 35 30 2d 34 30 39 66 2d 39 39 31 63 2d 63 66 30 35 31 34 34 64 37 64 36 37 } //00 00  $2059a686-3f50-409f-991c-cf05144d7d67
	condition:
		any of ($a_*)
