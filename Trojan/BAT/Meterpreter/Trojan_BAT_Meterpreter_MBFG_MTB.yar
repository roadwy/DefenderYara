...
rule Trojan_BAT_Meterpreter_MBFG_MTB{
	...
	strings :
		$a_03_0 = {13 15 11 15 11 0e 11 12 7e 90 01 01 00 00 0a 6f 90 01 01 00 00 06 26 72 90 01 03 70 17 8d 90 01 01 00 00 01 25 16 12 09 7c 90 01 01 00 00 04 72 90 01 01 02 00 70 28 90 01 01 00 00 0a a2 13 1b 11 1b 90 00 } //1
