...
rule Trojan_BAT_Lazy_NL_MTB{
	...
	strings :
		$a_03_0 = {28 7b 00 00 0a 02 6f 90 01 01 00 00 0a 28 90 01 01 00 00 0a 03 6f 90 01 01 00 00 0a 0a 73 90 01 01 00 00 0a 06 6f 90 01 01 00 00 0a 28 28 00 00 06 90 00 } //5
...
rule Trojan_BAT_Lazy_NL_MTB_2{
	...
	strings :
		$a_03_0 = {72 95 01 00 70 06 73 90 01 03 0a 0b 07 6f 90 01 03 0a 0c 08 6f 90 01 03 0a 90 00 } //5
