...
rule Trojan_BAT_Lazy_ABLN_MTB{
	...
	strings :
		$a_03_0 = {06 0b 07 07 6f 90 01 01 00 00 0a 07 6f 90 01 01 00 00 0a 6f 90 01 01 00 00 0a 25 06 16 06 8e 69 6f 90 01 01 00 00 0a 0c 6f 90 01 01 00 00 0a 28 90 01 01 00 00 0a 08 6f 90 01 01 00 00 0a 2a 90 0a 3c 00 02 28 90 01 01 00 00 0a 0a 28 90 00 } //3
