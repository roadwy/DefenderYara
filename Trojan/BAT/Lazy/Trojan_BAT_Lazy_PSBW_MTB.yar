...
rule Trojan_BAT_Lazy_PSBW_MTB{
	...
	strings :
		$a_03_0 = {00 00 72 3d 08 00 70 28 41 ?? ?? ?? 0a 06 6f 42 ?? ?? ?? 0b 07 6f 43 ?? ?? ?? 0c 73 44 ?? ?? ?? 0d 08 09 28 15 00 00 06 00 09 6f 45 ?? ?? ?? 80 5e 00 00 04 28 17 00 00 06 00 7e 5e 00 00 04 13 04 2b 00 11 04 2a } //5
