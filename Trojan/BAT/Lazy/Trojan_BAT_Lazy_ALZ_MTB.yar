...
rule Trojan_BAT_Lazy_ALZ_MTB{
	...
	strings :
		$a_03_0 = {0a 06 0b 72 ?? 01 00 70 0c 06 28 ?? 00 00 0a 16 fe 01 0d 09 2c 09 00 06 28 ?? 00 00 0a 26 00 73 ?? 00 00 0a 08 07 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_BAT_Lazy_ALZ_MTB_2{
	...
	strings :
		$a_03_0 = {26 03 1f 10 28 ?? 00 00 2b 1f 20 28 ?? 00 00 2b 28 ?? 00 00 2b 0c 20 00 00 00 00 38 58 00 00 00 00 38 64 01 00 00 00 73 02 01 00 0a 25 11 04 28 ?? 03 00 06 00 25 17 28 ?? 03 00 06 00 25 18 28 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_BAT_Lazy_ALZ_MTB_3{
	...
	strings :
		$a_03_0 = {0c 06 07 28 ?? 00 00 0a 28 ?? 00 00 0a 2d 0d 06 07 28 ?? 00 00 0a 08 28 ?? 00 00 0a de 14 26 72 ?? 01 00 70 02 28 } //1
...
rule Trojan_BAT_Lazy_ALZ_MTB_4{
	...
	strings :
		$a_03_0 = {0d 2b 28 09 6f ?? 00 00 0a 74 ?? 00 00 01 13 04 00 11 04 72 ?? 00 00 70 6f ?? 00 00 0a 14 fe 01 13 05 11 05 2c 04 00 17 0a 00 00 09 6f } //1
		$a_03_1 = {11 07 17 6f ?? 00 00 0a 00 11 07 17 6f ?? 00 00 0a 00 11 07 16 6f ?? 00 00 0a 00 11 07 17 6f ?? 00 00 0a 00 73 19 00 00 0a 13 08 11 08 11 07 6f } //1
	condition:
...
rule Trojan_BAT_Lazy_ALZ_MTB_6{
	...
	strings :
		$a_03_0 = {0c 16 0d 2b 1d 08 09 9a 03 28 ?? 00 00 06 13 04 11 04 28 ?? 00 00 0a 2d 05 11 04 0b de 2b 09 17 58 0d 09 08 8e 69 } //2
