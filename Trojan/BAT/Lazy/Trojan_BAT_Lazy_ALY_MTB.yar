...
rule Trojan_BAT_Lazy_ALY_MTB_2{
	...
	strings :
		$a_03_0 = {0d 08 13 04 16 13 05 2b 24 11 04 11 05 6f ?? ?? ?? 0a 13 06 09 12 06 28 ?? ?? ?? 0a 72 9a 12 00 70 28 ?? ?? ?? 0a 0d 11 05 17 58 13 05 11 05 11 04 6f ?? ?? ?? 0a 32 d1 09 09 6f ?? ?? ?? 0a 17 59 17 } //2
