...
rule Trojan_BAT_Lazy_AMBE_MTB{
	...
	strings :
		$a_03_0 = {05 11 09 8f 90 01 01 00 00 01 25 71 90 01 01 00 00 01 06 11 0e 91 61 d2 81 90 00 } //2
...
rule Trojan_BAT_Lazy_AMBE_MTB_2{
	...
	strings :
		$a_03_0 = {0a 0c 08 28 90 01 01 00 00 0a 72 90 01 01 00 00 70 6f 90 01 01 00 00 0a 6f 90 01 01 00 00 0a 08 28 90 01 01 00 00 0a 72 90 01 01 00 00 70 6f 90 01 01 00 00 0a 6f 90 01 01 00 00 0a 08 6f 90 01 01 00 00 0a 07 16 07 8e 69 6f 90 01 01 00 00 0a 0d de 0a 90 00 } //2
