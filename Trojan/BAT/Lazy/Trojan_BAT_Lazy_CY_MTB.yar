...
rule Trojan_BAT_Lazy_CY_MTB{
	...
	strings :
		...
		$a_01_1 = {73 68 69 70 69 6e 66 6f 2e 50 72 6f 70 65 72 74 69 65 73 2e 52 65 73 6f 75 72 63 65 73 } //01 00  shipinfo.Properties.Resources
		$a_01_2 = {77 72 69 74 65 66 69 6c 65 } //00 00  writefile
	condition:
		any of ($a_*)
