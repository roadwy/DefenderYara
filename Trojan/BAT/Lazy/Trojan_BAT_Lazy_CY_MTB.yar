...
rule Trojan_BAT_Lazy_CY_MTB{
	...
	strings :
		$a_03_0 = {07 6f 3a 00 00 0a 0c 08 28 90 01 02 00 0a 72 90 01 02 00 70 6f 90 01 02 00 0a 0c 08 17 8d 90 01 02 00 01 25 16 1f 0d 9d 6f 90 01 02 00 0a 0c 02 08 17 8d 90 01 02 00 01 25 16 1f 0d 9d 6f 90 01 02 00 0a 7d 90 01 02 00 04 02 7b 90 01 02 00 04 0d 16 13 04 2b 18 90 00 } //5
