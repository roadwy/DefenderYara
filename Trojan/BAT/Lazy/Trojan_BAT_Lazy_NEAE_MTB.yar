...
rule Trojan_BAT_Lazy_NEAE_MTB{
	...
	strings :
		...
		$a_01_1 = {47 00 74 00 4c 00 41 00 4f 00 55 00 37 00 72 00 61 00 6b 00 59 00 42 00 42 00 47 00 65 00 42 00 39 00 77 00 4e 00 4b 00 69 00 51 00 3d 00 3d 00 } //00 00  GtLAOU7rakYBBGeB9wNKiQ==
	condition:
		any of ($a_*)
