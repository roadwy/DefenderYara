...
rule Trojan_BAT_Lazy_AMAB_MTB{
	...
	strings :
		$a_03_0 = {1f 27 0d 11 04 13 06 12 06 03 28 90 01 01 00 00 06 11 06 74 90 01 01 00 00 01 13 04 1f 28 0d 11 04 6f 90 01 01 00 00 0a 13 05 1f 29 0d 11 05 02 16 02 8e 69 6f 90 01 01 00 00 0a 0a 90 00 } //4
