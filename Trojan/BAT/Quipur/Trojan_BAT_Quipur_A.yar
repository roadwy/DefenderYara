...
rule Trojan_BAT_Quipur_A{
	...
	strings :
		$a_03_0 = {2f 00 43 00 6f 00 6f 00 70 00 65 00 72 00 2f 00 90 02 10 2e 00 74 00 78 00 74 00 90 00 } //1
		$a_03_1 = {43 00 3a 00 5c 00 5c 00 4d 00 69 00 63 00 72 00 6f 00 73 00 6f 00 66 00 74 00 90 02 10 2e 00 65 00 78 00 65 00 90 00 } //1
		$a_03_2 = {67 65 74 5f 6c 69 6e 6b 90 02 10 73 65 74 5f 6c 69 6e 6b 90 00 } //1
