...
rule Trojan_BAT_PowDow_NEAB_MTB{
	...
	strings :
		...
		$a_01_1 = {69 00 73 00 20 00 74 00 61 00 6d 00 70 00 65 00 72 00 65 00 64 00 } //02 00  is tampered
		$a_01_2 = {73 65 74 5f 43 72 65 61 74 65 4e 6f 57 69 6e 64 6f 77 } //00 00  set_CreateNoWindow
	condition:
		any of ($a_*)
