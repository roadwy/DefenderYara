...
rule Trojan_BAT_Agentdoc_J_ibt{
	...
	strings :
		$a_01_0 = {4c 00 69 00 6e 00 6b 00 5a 00 69 00 70 00 2e 00 64 00 6c 00 6c 00 } //01 00 
		$a_01_1 = {62 00 64 00 2e 00 68 00 74 00 61 00 } //01 00 
		$a_01_2 = {6d 00 73 00 68 00 74 00 61 00 2e 00 65 00 78 00 65 00 } //01 00 
