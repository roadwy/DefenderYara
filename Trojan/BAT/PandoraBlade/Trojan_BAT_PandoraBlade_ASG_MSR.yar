...
rule Trojan_BAT_PandoraBlade_ASG_MSR{
	...
	strings :
		...
		$a_02_1 = {62 00 69 00 6e 00 5c 00 44 00 65 00 62 00 75 00 67 00 5c 00 53 00 4c 00 4e 00 90 02 30 6f 00 62 00 6a 00 5c 00 44 00 65 00 62 00 75 00 67 00 90 02 30 2e 00 70 00 64 00 62 00 90 00 } //2
		$a_02_2 = {62 69 6e 5c 44 65 62 75 67 5c 53 4c 4e 90 02 30 6f 62 6a 5c 44 65 62 75 67 90 02 30 2e 70 64 62 90 00 } //2
