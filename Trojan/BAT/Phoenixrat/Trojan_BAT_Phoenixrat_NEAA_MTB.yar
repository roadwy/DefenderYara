...
rule Trojan_BAT_Phoenixrat_NEAA_MTB{
	...
	strings :
		...
		$a_01_1 = {55 73 65 72 73 5c 4c 4f 54 54 45 5c 73 6f 75 72 63 65 } //01 00  Users\LOTTE\source
		$a_01_2 = {43 72 79 70 74 6f 4f 62 66 75 73 63 61 74 6f 72 5f 4f 75 74 70 75 74 } //00 00  CryptoObfuscator_Output
	condition:
		any of ($a_*)
