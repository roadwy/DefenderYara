...
rule Trojan_BAT_CryptInject_MI_MTB{
	...
	strings :
		...
		$a_01_2 = {4b 69 6c 6c 50 72 6f 63 65 73 73 41 6e 64 43 68 69 6c 64 72 65 6e } //01 00  KillProcessAndChildren
		$a_01_3 = {72 65 6d 6f 74 65 50 6f 72 74 } //01 00  remotePort
		$a_01_4 = {44 65 73 74 72 6f 79 70 75 62 6c 69 63 44 61 74 61 } //01 00  DestroypublicData
		$a_01_5 = {50 6f 73 74 4d 65 73 73 61 67 65 } //00 00  PostMessage
	condition:
		any of ($a_*)
