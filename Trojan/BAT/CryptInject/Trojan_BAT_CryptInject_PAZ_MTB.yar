...
rule Trojan_BAT_CryptInject_PAZ_MTB{
	...
	strings :
		...
		$a_03_1 = {72 01 00 00 70 7e 0e 00 00 0a 7e 0e 00 00 0a 16 1a 7e 0e 00 00 0a 14 12 05 12 06 28 90 01 03 06 13 08 16 13 09 11 06 7b 18 00 00 04 13 0a 11 0a 16 12 07 28 90 01 03 0a 1c 5a 12 09 28 90 01 03 06 90 00 } //1
	condition:
