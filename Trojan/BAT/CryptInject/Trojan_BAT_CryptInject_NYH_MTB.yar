...
rule Trojan_BAT_CryptInject_NYH_MTB{
	meta:
		description = "Trojan:BAT/CryptInject.NYH!MTB,SIGNATURE_TYPE_PEHSTR_EXT,08 00 08 00 08 00 00 01 00 "
		
	strings :
		$a_01_0 = {57 95 02 28 09 0f 00 00 00 00 00 00 00 00 00 00 01 00 00 00 37 00 00 00 1f 00 00 00 5e 00 00 00 92 00 00 00 31 00 00 00 47 00 00 00 05 00 00 00 09 } //01 00 
		...
		$a_01_2 = {50 6c 61 74 65 73 2e 64 6c 6c } //01 00  Plates.dll
		$a_01_3 = {47 65 74 50 69 78 65 6c } //01 00  GetPixel
		$a_01_4 = {54 6f 41 72 67 62 } //01 00  ToArgb
