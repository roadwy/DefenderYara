...
rule Trojan_BAT_CryptInject_MBIQ_MTB{
	...
	strings :
		$a_01_0 = {48 00 79 00 00 2d 45 00 38 00 46 00 37 00 44 00 42 00 4a 00 37 00 59 00 42 00 47 00 35 00 47 00 38 00 37 00 46 00 56 00 38 00 31 00 49 00 54 00 5a 00 } //01 00  HyⴀE8F7DBJ7YBG5G87FV81ITZ
