...
rule Trojan_BAT_CryptInject_Z{
	...
	strings :
		$a_01_0 = {57 69 7a 7a 42 79 50 61 73 73 2e 70 64 62 } //01 00 
		$a_01_1 = {57 69 7a 7a 42 79 50 61 73 73 2e 65 78 65 } //01 00 
		...
		$a_01_4 = {43 69 64 65 72 4d 65 64 64 65 62 2e 54 65 6b 72 69 2e 43 34 } //00 00 
	condition:
		any of ($a_*)
