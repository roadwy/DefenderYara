...
rule Trojan_BAT_CryptInject_SF_MTB{
	...
	strings :
		$a_03_0 = {02 8e b7 17 da 17 d6 8d ?? 00 00 01 0a 16 02 8e b7 17 da 0d 0c 38 ?? 00 00 00 20 ?? ?? ?? ?? 20 ?? ?? ?? ?? 61 25 fe 0e 04 00 20 ?? 00 00 00 5e 45 ?? 00 00 00 ?? 00 00 00 ?? 00 00 00 ?? 00 00 00 ?? ff ff ff [0-0a] 00 00 00 [0-10] 06 08 02 08 91 03 08 03 8e b7 5d 91 61 9c [0-10] 08 17 d6 0c } //1
