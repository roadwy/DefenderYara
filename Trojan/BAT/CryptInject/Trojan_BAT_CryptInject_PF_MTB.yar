...
rule Trojan_BAT_CryptInject_PF_MTB{
	...
	strings :
		$a_03_0 = {08 11 04 8f 90 01 04 25 71 90 01 04 07 11 04 91 61 d2 81 90 01 04 02 7b 90 00 } //4
		$a_03_1 = {11 04 17 6f 90 02 06 11 04 8f 90 01 04 25 71 90 01 04 08 11 04 91 61 d2 81 90 01 04 11 04 17 58 13 04 11 04 07 8e 69 32 b2 90 00 } //1
		$a_03_2 = {08 11 04 7e 90 01 04 6f 90 02 06 11 04 8f 90 01 04 25 71 90 01 04 08 11 04 91 61 d2 81 90 01 04 11 04 7e 90 01 04 58 13 04 11 04 07 8e 69 32 90 00 } //1
	condition:
