...
rule Trojan_BAT_CryptInject_MBAI_MTB{
	...
	strings :
		$a_03_0 = {07 11 04 11 05 9a 28 90 01 01 00 00 0a 28 90 01 01 00 00 0a 28 90 01 01 00 00 0a 28 90 01 01 00 00 0a 0b 00 11 05 17 d6 13 05 11 05 11 07 13 08 11 08 31 d4 90 00 } //1
