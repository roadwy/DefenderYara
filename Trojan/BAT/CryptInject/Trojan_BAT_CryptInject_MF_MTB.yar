...
rule Trojan_BAT_CryptInject_MF_MTB{
	...
	strings :
		$a_03_0 = {0a 06 16 73 90 01 03 0a 0b 1a 8d 90 01 03 01 0c 06 06 6f 90 01 03 0a 1b 6a da 6f 90 01 03 0a 06 08 16 1a 6f 90 01 03 0a 26 08 16 28 90 01 03 0a 0d 06 16 6a 6f 90 01 03 0a 09 17 da 17 d6 8d 90 01 03 01 13 04 07 11 04 16 09 6f 90 01 03 0a 26 07 6f 90 01 03 0a 06 6f 90 01 03 0a 11 04 90 00 } //1
		$a_03_1 = {0c 08 02 16 02 8e 69 6f 90 01 03 0a 08 6f 90 01 03 0a 06 6f 90 01 03 0a 0d 09 90 00 } //1
