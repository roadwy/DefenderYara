...
rule Trojan_BAT_RevengeRAT_DB_MTB{
	...
	strings :
		$a_02_0 = {0a 13 04 17 13 05 2b 41 08 07 33 02 17 0c 03 08 17 28 90 01 03 0a 28 90 01 03 0a 0a 09 02 11 05 17 28 90 01 03 0a 28 90 01 03 0a 06 07 d8 da 28 90 01 03 0a 28 90 01 03 0a 28 90 01 03 0a 0d 08 17 d6 0c 11 05 17 d6 13 05 11 05 11 04 31 b9 90 00 } //10
