...
rule Trojan_BAT_RevengeRAT_DC_MTB{
	...
	strings :
		$a_02_0 = {0a 1e 5b 8d 2a 00 00 01 0b 16 0d 2b 19 00 07 09 06 09 1e 5a 1e 6f ?? ?? ?? 0a 18 28 ?? ?? ?? 0a 9c 00 09 17 58 0d 09 07 8e 69 17 59 fe 02 16 fe 01 13 04 11 04 2d d6 } //10
