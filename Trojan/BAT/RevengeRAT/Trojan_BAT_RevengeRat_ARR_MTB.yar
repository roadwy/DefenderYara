...
rule Trojan_BAT_RevengeRat_ARR_MTB{
	...
	strings :
		$a_03_0 = {01 0c 08 16 02 7b 90 01 01 00 00 04 28 90 01 01 00 00 0a a2 08 14 14 14 28 90 01 01 00 00 0a 28 90 01 01 00 00 0a 0a 06 28 90 01 01 00 00 0a 72 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_BAT_RevengeRat_ARR_MTB_3{
	...
	strings :
		$a_03_0 = {0a 17 12 00 15 6a 16 28 90 01 01 00 00 0a 17 8d 90 01 01 00 00 01 25 16 17 9e 28 90 01 01 00 00 0a 02 06 02 7b 90 01 01 00 00 04 28 90 01 01 00 00 0a 15 16 28 90 00 } //2
