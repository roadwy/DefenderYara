...
rule Trojan_BAT_RevengeRat_AREV_MTB{
	meta:
		description = "Trojan:BAT/RevengeRat.AREV!MTB,SIGNATURE_TYPE_PEHSTR_EXT,04 00 04 00 03 00 00 02 00 "
		
	strings :
		$a_03_0 = {0a 2d 16 06 28 90 01 01 00 00 06 17 28 90 01 01 00 00 0a 20 90 01 01 07 00 00 28 90 01 01 00 00 0a 72 90 01 01 01 00 70 72 90 01 01 01 00 70 28 90 00 } //01 00 
