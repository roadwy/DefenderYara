...
rule Trojan_BAT_TurtleLoader_NT_MTB{
	...
	strings :
		$a_03_0 = {28 10 00 00 0a 0c 06 08 07 6f ?? 00 00 06 0d 7e ?? 00 00 0a 09 8e 69 7e ?? 00 00 04 7e ?? 00 00 04 28 ?? 00 00 06 13 04 09 16 11 04 09 8e 69 28 ?? 00 00 0a 1f 18 16 28 ?? 00 00 06 28 ?? 00 00 06 13 05 11 04 11 05 7e ?? 00 00 0a 28 ?? 00 00 06 } //5
