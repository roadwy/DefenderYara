...
rule Trojan_BAT_ClipBanker_GF_MTB_3{
	...
	strings :
		$a_01_0 = {4b 71 36 79 4b 53 50 70 6e 71 4d 7a 79 34 7a 32 43 5a 51 } //01 00  Kq6yKSPpnqMzy4z2CZQ
		$a_01_1 = {44 6f 77 6e 6c 6f 61 64 53 74 72 69 6e 67 } //01 00  DownloadString
		$a_01_2 = {48 42 57 61 51 46 54 67 50 4d 6b 68 4e 67 54 54 67 62 66 } //01 00  HBWaQFTgPMkhNgTTgbf
		$a_01_3 = {61 35 50 72 52 43 67 48 44 49 38 42 63 4b 47 64 38 53 69 } //01 00  a5PrRCgHDI8BcKGd8Si
		...
		$a_81_9 = {68 74 74 70 73 3a 2f 2f 61 70 69 2e 74 65 6c 65 67 72 61 6d 2e 6f 72 67 2f 62 6f 74 } //01 00  https://api.telegram.org/bot
		$a_81_10 = {68 74 74 70 73 3a 2f 2f 69 70 76 34 62 6f 74 2e 77 68 61 74 69 73 6d 79 69 70 61 64 64 72 65 73 73 2e 63 6f 6d 2f } //00 00  https://ipv4bot.whatismyipaddress.com/
	condition:
		any of ($a_*)
