...
rule Trojan_BAT_ClipBanker_KA_MTB{
	...
	strings :
		$a_03_0 = {2b 46 12 04 28 90 01 01 00 00 0a 13 05 11 05 06 28 90 01 01 00 00 06 13 06 11 06 08 32 2e 11 06 08 33 0b 07 11 05 6f 90 01 01 00 00 0a 26 2b 1e 11 06 08 31 19 90 00 } //5
