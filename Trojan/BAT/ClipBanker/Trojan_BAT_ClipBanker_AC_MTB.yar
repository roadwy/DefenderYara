...
rule Trojan_BAT_ClipBanker_AC_MTB{
	...
	strings :
		$a_03_0 = {13 04 1f 23 28 90 01 03 0a 72 35 00 00 70 28 90 01 03 0a 13 05 11 05 18 18 73 08 00 00 0a 13 06 11 06 11 04 16 11 04 8e 69 6f 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_BAT_ClipBanker_AC_MTB_2{
	...
	strings :
		$a_03_0 = {0a 16 0b 2b 27 06 02 07 6f 90 01 03 0a 7e 3a 00 00 04 07 7e 3a 00 00 04 8e 69 5d 91 61 28 90 01 03 0a 6f 90 01 03 0a 26 07 17 58 0b 07 02 90 00 } //2
