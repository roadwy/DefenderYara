...
rule Trojan_BAT_ClipBanker_MB_MTB{
	...
	strings :
		$a_03_0 = {09 69 8d 2b 00 00 01 25 17 28 90 01 03 06 13 04 06 28 90 01 03 06 1f 0d 6a 59 13 05 07 06 11 04 11 05 09 6f 90 01 03 2b 2a 90 00 } //1
		...
		$a_01_6 = {43 6f 6e 66 75 73 65 64 42 79 41 74 74 72 69 62 75 74 65 } //1 ConfusedByAttribute
		...
		$a_01_9 = {49 73 4c 6f 67 67 69 6e 67 } //1 IsLogging
	condition:
