...
rule Trojan_BAT_Clipbanker_AMAB_MTB{
	...
	strings :
		...
		$a_01_11 = {5e 00 34 00 31 00 30 00 30 00 31 00 5b 00 30 00 2d 00 39 00 5d 00 3f 00 5b 00 5c 00 64 00 5c 00 2d 00 20 00 5d 00 7b 00 37 00 2c 00 31 00 31 00 7d 00 24 00 } //00 00 
	condition:
		any of ($a_*)
