...
rule Trojan_BAT_Clipbanker_NCB_MTB{
	...
	strings :
		...
		$a_01_1 = {52 00 6f 00 6f 00 62 00 65 00 74 00 43 00 72 00 61 00 73 00 68 00 } //00 00  RoobetCrash
	condition:
		any of ($a_*)
...
rule Trojan_BAT_Clipbanker_NCB_MTB_2{
	...
	strings :
		...
		$a_01_1 = {73 73 73 63 2e 67 2e 72 65 73 6f 75 72 63 65 73 } //00 00  sssc.g.resources
	condition:
		any of ($a_*)
