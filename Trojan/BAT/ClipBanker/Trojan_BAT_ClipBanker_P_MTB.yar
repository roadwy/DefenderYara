...
rule Trojan_BAT_ClipBanker_P_MTB{
	...
	strings :
		...
		$a_01_1 = {5b 00 61 00 2d 00 7a 00 41 00 2d 00 5a 00 31 00 2d 00 39 00 5d 00 7b 00 32 00 37 00 2c 00 33 00 35 00 7d 00 24 00 } //01 00  [a-zA-Z1-9]{27,35}$
		$a_01_2 = {5b 00 61 00 2d 00 7a 00 41 00 2d 00 5a 00 31 00 2d 00 39 00 5d 00 7b 00 34 00 32 00 7d 00 24 00 } //00 00  [a-zA-Z1-9]{42}$
	condition:
		any of ($a_*)
