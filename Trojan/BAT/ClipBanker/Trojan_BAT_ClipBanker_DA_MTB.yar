...
rule Trojan_BAT_ClipBanker_DA_MTB{
	...
	strings :
		$a_03_0 = {7e 01 00 00 04 28 90 01 03 0a 6f 90 01 03 0a 16 8c 14 00 00 01 14 6f 90 01 03 0a 28 90 01 03 0a 2a 90 00 } //5
		$a_03_1 = {72 b6 fa 01 70 72 ba fa 01 70 6f 90 01 03 0a 72 be fa 01 70 72 c2 fa 01 70 6f 90 01 03 0a 28 90 01 03 0a 80 01 00 00 04 2a 90 00 } //5
