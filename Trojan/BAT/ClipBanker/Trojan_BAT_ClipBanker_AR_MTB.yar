...
rule Trojan_BAT_ClipBanker_AR_MTB{
	...
	strings :
		$a_03_0 = {06 02 07 6f 90 01 01 00 00 0a 7e 90 01 01 00 00 04 07 7e 90 01 01 00 00 04 8e 69 5d 91 61 28 90 01 01 00 00 0a 6f 90 01 01 00 00 0a 26 07 17 58 0b 07 02 6f 90 00 } //2
