...
rule Trojan_BAT_Cobalt_MA_MTB{
	...
	strings :
		...
		$a_01_3 = {50 72 6f 63 65 73 73 43 6d 64 4b 65 79 } //01 00 
		$a_01_4 = {46 6c 75 73 68 46 69 6e 61 6c 42 6c 6f 63 6b } //01 00 
		...
		$a_01_10 = {73 65 74 5f 55 73 65 4d 61 63 68 69 6e 65 4b 65 79 53 74 6f 72 65 } //01 00 
		$a_01_11 = {47 65 74 42 79 74 65 73 } //01 00 
		$a_01_12 = {43 72 65 61 74 65 45 6e 63 72 79 70 74 6f 72 } //00 00 
	condition:
		any of ($a_*)
