...
rule Trojan_BAT_Spynoon_ASCO_MTB{
	...
	strings :
		...
		$a_81_1 = {51 75 61 6e 5f 4c 79 5f 54 68 75 5f 56 69 65 6e 2e 50 72 6f 70 65 72 74 69 65 73 2e 52 65 73 6f 75 72 63 65 73 } //00 00  Quan_Ly_Thu_Vien.Properties.Resources
	condition:
		any of ($a_*)
