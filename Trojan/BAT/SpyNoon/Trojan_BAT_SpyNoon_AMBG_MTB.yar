...
rule Trojan_BAT_SpyNoon_AMBG_MTB_2{
	...
	strings :
		$a_03_0 = {0a 0a 02 18 5d 3a 90 01 01 00 00 00 72 90 01 01 00 00 70 28 90 01 01 00 00 0a 38 90 01 01 00 00 00 72 90 01 01 00 00 70 28 90 01 01 00 00 0a 06 28 90 01 01 00 00 0a 38 90 00 } //1
		$a_03_1 = {0a 0b 02 28 90 01 01 00 00 0a 0c 08 17 3b 90 00 } //1
	condition:
