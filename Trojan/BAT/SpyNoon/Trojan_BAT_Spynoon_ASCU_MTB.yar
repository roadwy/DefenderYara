...
rule Trojan_BAT_Spynoon_ASCU_MTB{
	...
	strings :
		$a_03_0 = {11 05 8e 69 17 da 13 0e 16 13 0f 2b 1b 11 06 11 05 11 0f 9a 1f 10 28 90 01 01 00 00 0a b4 6f 90 01 01 00 00 0a 00 11 0f 17 d6 13 0f 11 0f 11 0e 31 90 00 } //1
