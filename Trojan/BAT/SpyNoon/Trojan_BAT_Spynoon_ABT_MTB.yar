...
rule Trojan_BAT_Spynoon_ABT_MTB{
	...
	strings :
		$a_03_0 = {2b 2c 17 8d 09 00 00 01 25 16 72 d3 01 00 70 28 90 01 01 00 00 06 72 90 01 01 02 00 70 28 90 01 01 00 00 06 28 90 01 01 00 00 0a 28 90 01 01 00 00 0a 28 90 01 01 00 00 06 a2 90 00 } //5
