...
rule Trojan_BAT_SpyNoon_MC_MTB{
	...
	strings :
		$a_03_0 = {0b 07 8e 69 17 da 17 d6 8d 90 01 03 01 0c 07 8e 69 17 da 13 06 16 13 07 2b 30 08 11 07 07 11 07 91 7e 90 01 03 04 11 07 7e 90 01 03 04 6f 90 01 03 0a 5d 6f 90 01 03 0a 28 90 01 03 0a 28 90 01 03 0a 61 9c 11 07 17 d6 13 07 11 07 11 06 31 90 00 } //1
