...
rule Trojan_BAT_SpyNoon_MC_MTB{
	...
	strings :
		...
		$a_01_1 = {53 74 61 72 74 54 65 73 74 52 75 6e } //01 00 
		$a_01_2 = {43 6c 65 61 72 45 78 74 65 6e 73 69 6f 6e 73 } //01 00 
		$a_01_3 = {70 72 6f 78 79 44 69 73 63 6f 76 65 72 79 4d 61 6e 61 67 65 72 } //01 00 
		$a_01_4 = {43 72 65 61 74 65 49 6e 73 74 61 6e 63 65 } //01 00 
		$a_01_5 = {47 65 74 4c 6f 67 67 65 72 4d 61 6e 61 67 65 72 } //00 00 
	condition:
		any of ($a_*)
