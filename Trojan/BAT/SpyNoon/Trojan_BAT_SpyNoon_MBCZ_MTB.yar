...
rule Trojan_BAT_SpyNoon_MBCZ_MTB{
	...
	strings :
		$a_03_0 = {2b 20 00 07 09 18 6f 90 01 01 00 00 0a 1f 10 28 90 01 01 01 00 0a 13 05 08 11 05 6f 90 01 01 01 00 0a 00 09 18 58 0d 00 09 07 6f 90 01 01 01 00 0a fe 04 13 06 11 06 2d d1 90 00 } //1
