...
rule Trojan_BAT_Spynoon_AABO_MTB{
	...
	strings :
		...
		$a_01_1 = {34 37 36 61 32 37 34 66 2d 66 64 62 65 2d 34 30 34 32 2d 39 62 34 62 2d 61 31 38 35 32 65 37 34 39 30 39 63 } //00 00  476a274f-fdbe-4042-9b4b-a1852e74909c
	condition:
		any of ($a_*)
