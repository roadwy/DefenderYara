...
rule Trojan_BAT_Spynoon_ABYA_MTB{
	...
	strings :
		$a_03_0 = {72 41 00 00 70 28 90 01 01 00 00 06 0a 28 90 01 01 00 00 0a 06 6f 90 01 01 00 00 0a 28 90 01 01 00 00 06 74 90 01 01 00 00 1b 28 90 01 01 00 00 06 0b dd 90 01 01 00 00 00 26 de d1 90 00 } //3
