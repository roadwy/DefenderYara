...
rule Trojan_BAT_Spynoon_AAPM_MTB{
	...
	strings :
		$a_03_0 = {0d 09 08 1f 10 6f 90 01 01 00 00 0a 6f 90 01 01 00 00 0a 09 08 1f 10 6f 90 01 01 00 00 0a 6f 90 01 01 00 00 0a 09 6f 90 01 01 00 00 0a 07 16 07 8e 69 6f 90 01 01 00 00 0a 28 90 01 01 00 00 2b 13 04 11 04 90 00 } //5
