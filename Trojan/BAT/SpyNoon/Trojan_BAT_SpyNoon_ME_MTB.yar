...
rule Trojan_BAT_SpyNoon_ME_MTB{
	...
	strings :
		$a_03_0 = {0a 03 8e 69 0b 2b 0a 06 07 03 07 91 6f 90 01 03 0a 07 25 17 59 0b 16 fe 02 2d ec 06 6f 90 01 03 0a 28 90 01 03 2b 0c 08 2a 90 00 } //1
		$a_01_1 = {44 6f 77 6e 6c 6f 61 64 44 61 74 61 } //1 DownloadData
		$a_03_2 = {3a 00 2f 00 2f 00 76 00 69 00 74 00 72 00 69 00 66 00 72 00 69 00 67 00 30 00 2e 00 63 00 6f 00 6d 00 2f 00 90 02 60 2e 00 6a 00 70 00 67 00 90 00 } //1
