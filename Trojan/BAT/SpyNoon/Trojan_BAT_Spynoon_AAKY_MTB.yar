...
rule Trojan_BAT_Spynoon_AAKY_MTB{
	...
	strings :
		$a_03_0 = {11 08 11 08 28 90 01 01 00 00 06 11 08 28 90 01 01 00 00 06 28 90 01 01 00 00 06 13 0b 20 00 00 00 00 7e 90 01 01 01 00 04 7b 90 01 01 01 00 04 3a 90 01 01 ff ff ff 26 90 00 } //3
