...
rule Trojan_BAT_Spynoon_ABSW_MTB{
	meta:
		description = "Trojan:BAT/Spynoon.ABSW!MTB,SIGNATURE_TYPE_PEHSTR_EXT,06 00 06 00 04 00 00 02 00 "
		
	strings :
		$a_03_0 = {2b 04 2b 09 de 0d 28 90 01 01 00 00 06 2b f5 0a 2b f4 26 de ec 90 00 } //02 00 
