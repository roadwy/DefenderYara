...
rule Trojan_BAT_SpyNoon_ABAA_MTB{
	...
	strings :
		...
		$a_80_7 = {63 61 72 74 65 6c 6c 61 74 6f 72 2e 46 6f 72 6d 31 2e 72 65 73 6f 75 72 63 65 73 } //cartellator.Form1.resources  00 00 
	condition:
		any of ($a_*)
