...
rule Trojan_BAT_AsyncRAT_NH_MTB{
	...
	strings :
		$a_03_0 = {2b 00 16 2d f8 16 2d d0 2a 28 90 01 03 0a 2b cf 03 2b ce 28 90 01 03 0a 2b ce 6f 90 01 03 0a 2b cf 28 90 01 03 0a 2b ca 28 90 01 03 0a 2b ce 90 00 } //10
