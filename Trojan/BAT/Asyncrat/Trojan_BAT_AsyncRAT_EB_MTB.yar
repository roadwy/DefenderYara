...
rule Trojan_BAT_AsyncRAT_EB_MTB{
	...
	strings :
		...
		$a_01_2 = {33 38 36 64 30 35 64 62 2d 36 62 30 63 2d 34 34 39 39 2d 38 35 31 35 2d 32 66 62 35 33 62 35 38 65 35 30 37 } //01 00 
		$a_01_3 = {43 6f 6e 66 75 73 65 72 45 78 20 76 31 2e 30 2e 30 } //01 00 
		$a_01_4 = {43 00 6c 00 69 00 65 00 6e 00 74 00 2e 00 65 00 78 00 65 00 } //00 00 
	condition:
		any of ($a_*)
