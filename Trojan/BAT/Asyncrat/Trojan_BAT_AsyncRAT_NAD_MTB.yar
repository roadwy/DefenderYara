...
rule Trojan_BAT_AsyncRAT_NAD_MTB{
	...
	strings :
		...
		$a_01_2 = {6d 5f 4d 79 57 65 62 53 65 72 76 69 63 65 73 4f 62 6a 65 63 74 50 72 6f 76 69 64 65 72 } //01 00  m_MyWebServicesObjectProvider
		$a_01_3 = {6d 5f 55 73 65 72 4f 62 6a 65 63 74 50 72 6f 76 69 64 65 72 } //01 00  m_UserObjectProvider
