...
rule Trojan_BAT_AsyncRAT_MBDI_MTB{
	...
	strings :
		$a_03_0 = {70 0d 00 07 08 7e ?? 00 00 04 28 ?? 00 00 06 6f ?? 01 00 0a 6f ?? 01 00 0a 00 07 18 6f ?? 01 00 0a 00 07 6f ?? 01 00 0a 13 04 02 13 05 11 04 11 05 16 11 05 8e 69 6f ?? 01 00 0a 0a de 28 } //1
