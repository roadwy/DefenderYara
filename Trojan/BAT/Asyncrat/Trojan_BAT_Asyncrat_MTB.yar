...
rule Trojan_BAT_Asyncrat_MTB{
	...
	strings :
		$a_03_0 = {26 38 a8 ff 90 01 01 ff 7e 13 00 90 01 01 04 14 28 63 00 90 01 01 06 3a b8 ff 90 01 01 ff 20 01 00 90 01 01 00 28 65 00 90 01 01 06 3a 8d 90 01 01 ff ff 90 00 } //1
