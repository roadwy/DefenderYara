...
rule Trojan_BAT_AsyncRAT_RDK_MTB{
	...
	strings :
		$a_01_0 = {38 64 62 62 37 30 38 62 2d 61 38 38 63 2d 34 36 31 30 2d 39 63 66 36 2d 37 33 32 39 36 63 64 61 33 62 64 34 } //02 00  8dbb708b-a88c-4610-9cf6-73296cda3bd4
