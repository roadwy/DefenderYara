...
rule Trojan_BAT_AsyncRAT_NSY_MTB{
	...
	strings :
		...
		$a_01_1 = {41 64 76 61 6e 63 65 64 5f 43 61 6c 63 75 6c 61 74 6f 72 2e 50 72 6f 70 65 72 74 69 65 73 2e 52 65 73 6f 75 72 63 65 73 2e 72 65 73 6f 75 72 63 65 73 } //00 00  Advanced_Calculator.Properties.Resources.resources
	condition:
		any of ($a_*)
...
rule Trojan_BAT_AsyncRAT_NSY_MTB_2{
	...
	strings :
		...
		$a_01_1 = {6b 62 61 6b 63 2e 65 78 65 } //00 00  kbakc.exe
	condition:
		any of ($a_*)
