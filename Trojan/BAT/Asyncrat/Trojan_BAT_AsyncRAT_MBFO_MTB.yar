...
rule Trojan_BAT_AsyncRAT_MBFO_MTB{
	...
	strings :
		$a_03_0 = {13 06 06 6f 90 01 01 01 00 0a 25 26 1f 10 6a 59 17 6a 58 d4 8d 19 00 00 01 13 07 11 06 11 07 16 11 07 8e 69 90 00 } //1
		$a_03_1 = {de 00 20 88 13 00 00 28 90 01 01 00 00 0a 2b d3 90 00 } //1
