...
rule Trojan_BAT_AsyncRAT_ABQ_MTB{
	...
	strings :
		$a_03_0 = {08 2c 07 08 6f 19 90 01 02 0a 00 dc 2a 90 0a 55 00 00 28 3a 90 01 02 0a 7e 1c 90 01 02 04 6f 3b 90 01 02 0a 72 cd 90 01 02 70 28 3c 90 01 02 0a 28 3d 90 01 02 0a 6f 3e 90 01 02 0a 0a 06 6f 3f 90 01 02 0a 0b 73 40 90 01 02 0a 0c 00 07 08 6f 41 90 01 02 0a 00 08 6f 42 90 01 02 0a 80 1b 90 01 02 04 00 de 0b 90 00 } //5
