...
rule Trojan_BAT_AsyncRAT_NAS_MTB{
	...
	strings :
		...
		$a_01_1 = {50 79 4c 69 62 48 6f 73 74 69 6e 67 } //00 00  PyLibHosting
	condition:
		any of ($a_*)
...
rule Trojan_BAT_AsyncRAT_NAS_MTB_2{
	...
	strings :
		...
		$a_01_1 = {64 75 75 6b 75 6b 66 64 63 79 65 66 66 64 74 6d 2e 52 65 73 6f 75 72 63 65 73 } //00 00  duukukfdcyeffdtm.Resources
	condition:
		any of ($a_*)
