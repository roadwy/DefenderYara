...
rule Trojan_BAT_AsyncRat_NEAO_MTB{
	...
	strings :
		$a_01_0 = {31 00 39 00 35 00 2e 00 32 00 2e 00 37 00 39 00 2e 00 32 00 33 00 33 00 } //05 00 
		$a_01_1 = {53 79 73 74 65 6d 2e 57 69 6e 64 6f 77 73 2e 46 6f 72 6d 73 } //01 00 
