...
rule Trojan_BAT_AsyncRat_NEAY_MTB{
	...
	strings :
		...
		$a_01_1 = {73 65 74 55 54 43 4d 69 6e 75 74 65 73 54 55 20 4a 75 72 61 73 73 69 63 2e 4c 69 62 72 61 72 79 2e 4a 53 46 75 6e 63 74 69 6f 6e 46 6c 61 67 73 } //00 00 
	condition:
		any of ($a_*)
