...
rule Trojan_BAT_AsyncRAT_MBCX_MTB{
	...
	strings :
		...
		$a_01_1 = {62 63 64 33 35 64 66 66 2d 63 39 31 64 2d 34 35 30 38 2d 38 37 65 30 2d 66 37 66 39 32 31 31 38 37 30 31 64 } //01 00  bcd35dff-c91d-4508-87e0-f7f92118701d
