...
rule Trojan_BAT_AsyncRAT_NC_MTB{
	...
	strings :
		...
		$a_01_1 = {54 69 66 66 79 2e 54 64 39 6e 79 2e 72 65 73 6f 75 72 63 65 73 } //01 00  Tiffy.Td9ny.resources
		$a_01_2 = {45 63 6f 6e 6f 63 37 69 63 73 } //00 00  Econoc7ics
	condition:
		any of ($a_*)
