...
rule Trojan_BAT_AsyncRat_ABJU_MTB{
	...
	strings :
		$a_03_0 = {0a 06 18 6f 90 01 03 0a 06 6f 90 01 03 0a 13 04 02 0d 11 04 09 16 09 8e b7 6f 90 01 03 0a 0b de 11 de 0f 90 0a 3d 00 06 08 28 90 01 03 0a 7e 90 01 03 04 6f 90 01 03 0a 6f 90 01 03 0a 6f 90 00 } //3
