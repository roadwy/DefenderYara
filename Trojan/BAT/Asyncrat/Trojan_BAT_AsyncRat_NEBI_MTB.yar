...
rule Trojan_BAT_AsyncRat_NEBI_MTB{
	...
	strings :
		$a_03_0 = {13 04 11 04 06 6f 90 01 01 00 00 0a 00 11 04 05 6f 90 01 01 00 00 0a 00 11 04 0e 04 6f 90 01 01 00 00 0a 00 11 04 6f 90 01 01 00 00 0a 03 16 03 8e b7 6f 90 01 01 00 00 0a 0b 11 04 6f 90 01 01 00 00 0a 00 07 0c 2b 00 08 2a 90 00 } //10
