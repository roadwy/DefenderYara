...
rule Trojan_BAT_AsyncRat_NEAI_MTB{
	...
	strings :
		...
		$a_01_1 = {57 00 53 00 63 00 72 00 69 00 70 00 74 00 2e 00 53 00 68 00 65 00 6c 00 6c 00 } //02 00 
		$a_01_2 = {63 00 6d 00 73 00 74 00 70 00 2e 00 65 00 78 00 65 00 } //02 00 
