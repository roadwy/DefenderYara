...
rule Trojan_BAT_AsyncRat_NEAZ_MTB{
	...
	strings :
		...
		$a_01_1 = {63 61 6c 63 5f 70 72 6f 2e 46 6f 72 6d 31 2e 72 65 73 6f 75 72 63 65 73 } //01 00  calc_pro.Form1.resources
		$a_01_2 = {53 74 61 79 41 77 61 79 5f } //00 00  StayAway_
	condition:
		any of ($a_*)
