...
rule Trojan_BAT_AsyncRAT_AMMB_MTB{
	...
	strings :
		$a_03_0 = {59 17 59 91 07 08 07 8e 69 5d 1f 90 01 01 58 1b 58 1f 39 59 17 59 91 61 03 08 20 90 01 04 58 20 90 01 04 59 03 8e 69 5d 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_BAT_AsyncRAT_AMMB_MTB_2{
	...
	strings :
		$a_03_0 = {08 09 02 7b 90 01 01 01 00 04 09 02 7b 90 01 01 01 00 04 8e 69 5d 91 9e 09 17 58 0d 09 20 00 01 00 00 32 e0 90 00 } //5
