...
rule Trojan_BAT_AsyncRAT_V_MTB{
	...
	strings :
		$a_01_0 = {30 30 37 53 74 75 62 2e 67 2e 72 65 73 6f 75 72 63 65 73 } //02 00  007Stub.g.resources
		$a_01_1 = {30 30 37 53 74 75 62 2e 50 72 6f 70 65 72 74 69 65 73 2e 52 65 73 6f 75 72 63 65 73 } //01 00  007Stub.Properties.Resources
