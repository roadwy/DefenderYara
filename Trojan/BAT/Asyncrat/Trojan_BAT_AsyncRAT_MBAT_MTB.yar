...
rule Trojan_BAT_AsyncRAT_MBAT_MTB{
	...
	strings :
		...
		$a_01_1 = {78 34 34 54 51 32 44 72 43 65 77 52 48 76 32 } //01 00 
		$a_01_2 = {6e 6f 6c 61 6e 65 2e 52 65 73 6f 75 72 63 65 73 2e 72 65 73 6f 75 72 63 65 73 } //01 00 
		$a_01_3 = {31 30 31 62 36 62 32 35 31 35 } //00 00 
	condition:
		any of ($a_*)
