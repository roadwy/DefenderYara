...
rule Trojan_BAT_AsyncRAT_MBAZ_MTB{
	...
	strings :
		$a_03_0 = {01 13 07 09 28 90 01 01 00 00 0a 08 6f 90 01 01 00 00 0a 6f 90 01 01 00 00 0a 13 08 11 08 16 11 07 16 1f 10 28 90 01 01 00 00 0a 11 08 16 11 07 1f 0f 1f 10 28 83 00 00 0a 06 11 07 90 00 } //1
