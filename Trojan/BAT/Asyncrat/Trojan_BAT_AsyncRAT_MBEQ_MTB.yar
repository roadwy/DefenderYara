...
rule Trojan_BAT_AsyncRAT_MBEQ_MTB{
	...
	strings :
		$a_03_0 = {0a 2c 5d 06 06 72 3f 08 00 70 6f ?? 00 00 0a 72 3f 08 00 70 28 ?? 00 00 0a 58 6f ?? 00 00 0a 28 ?? 00 00 0a 13 08 11 07 11 08 16 11 08 8e 69 6f ?? 00 00 0a 11 07 } //1
