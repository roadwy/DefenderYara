...
rule Trojan_BAT_AsyncRat_MF_MTB{
	...
	strings :
		...
		$a_81_1 = {53 6c 79 79 6a 75 6e 70 65 64 6d 66 66 72 75 65 61 62 72 6e 77 62 7a 6d } //01 00  Slyyjunpedmffrueabrnwbzm
		$a_81_2 = {53 79 6d 6d 65 74 72 69 63 41 6c 67 6f 72 69 74 68 6d } //01 00  SymmetricAlgorithm
		$a_81_3 = {43 72 79 70 74 6f 67 72 61 70 68 79 } //01 00  Cryptography
