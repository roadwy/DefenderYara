...
rule Trojan_BAT_AsyncRat_NEAS_MTB{
	...
	strings :
		$a_03_0 = {02 80 0a 00 00 04 28 ?? 00 00 0a 80 07 00 00 04 28 0d 00 00 06 7e 09 00 00 04 6f ?? 00 00 0a 7e 08 00 00 04 6f ?? 00 00 0a 0a 7e 08 00 00 04 6f ?? 00 00 0a 06 2a } //10
