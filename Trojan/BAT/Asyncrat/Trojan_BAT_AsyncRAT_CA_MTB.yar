...
rule Trojan_BAT_AsyncRAT_CA_MTB{
	...
	strings :
		...
		$a_81_1 = {63 75 63 6b 6f 6f 6d 6f 6e 2e 64 6c 6c } //01 00 
		$a_81_2 = {53 78 49 6e 2e 64 6c 6c } //01 00 
		$a_81_3 = {63 6d 64 76 72 74 33 32 2e 64 6c 6c } //01 00 
		$a_81_4 = {53 62 69 65 44 6c 6c 2e 64 6c 6c } //00 00 
	condition:
		any of ($a_*)
