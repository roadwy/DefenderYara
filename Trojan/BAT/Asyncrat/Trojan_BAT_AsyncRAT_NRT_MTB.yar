...
rule Trojan_BAT_AsyncRAT_NRT_MTB{
	...
	strings :
		$a_03_0 = {28 09 00 00 06 28 90 01 03 0a 72 90 01 03 70 6f 90 01 03 0a 28 90 01 03 06 0a 72 90 01 03 70 06 28 90 01 03 0a 72 90 01 03 70 28 90 01 03 0a 26 2a 90 00 } //5
