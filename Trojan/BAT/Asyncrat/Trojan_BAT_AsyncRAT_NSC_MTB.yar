...
rule Trojan_BAT_AsyncRAT_NSC_MTB{
	...
	strings :
		...
		$a_01_1 = {6b 75 72 64 69 73 68 62 75 69 6c 64 } //01 00  kurdishbuild
		$a_01_2 = {68 78 63 61 2e 65 78 65 } //00 00  hxca.exe
	condition:
		any of ($a_*)
...
rule Trojan_BAT_AsyncRAT_NSC_MTB_2{
	...
	strings :
		...
		$a_01_1 = {4e 61 73 68 77 69 6c 6c 65 } //01 00  Nashwille
		$a_01_2 = {4e 65 74 2e 65 78 65 } //00 00  Net.exe
	condition:
		any of ($a_*)
