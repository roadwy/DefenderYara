...
rule Trojan_BAT_AsyncRAT_ABBK_MTB{
	...
	strings :
		$a_03_0 = {70 13 05 28 90 01 03 0a 6f 90 01 03 0a 6f 90 01 03 0a 13 06 72 90 01 03 70 28 90 01 03 06 28 90 01 03 0a 00 00 de 0d 11 04 2c 08 11 04 6f 90 01 03 0a 00 dc 90 00 } //2
