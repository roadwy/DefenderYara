...
rule Trojan_BAT_AsyncRat_AMMH_MTB_2{
	...
	strings :
		$a_03_0 = {fe 0c 02 00 fe 0c 01 00 6f 90 01 01 00 00 0a 20 01 00 00 00 73 90 01 01 00 00 0a 25 fe 0c 00 00 20 90 01 01 00 00 00 fe 0c 00 00 8e 69 6f 90 01 01 00 00 0a 25 6f 90 01 01 00 00 0a fe 0c 02 00 6f 90 01 01 00 00 0a fe 0e 00 00 fe 0c 02 00 6f 90 01 01 00 00 0a 6f 90 01 01 00 00 0a 20 90 01 01 ff ff ff 28 90 01 01 00 00 0a fe 0e 03 00 90 00 } //2
