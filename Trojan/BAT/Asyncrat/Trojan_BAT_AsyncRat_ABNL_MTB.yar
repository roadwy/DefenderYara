...
rule Trojan_BAT_AsyncRat_ABNL_MTB{
	...
	strings :
		$a_03_0 = {04 07 09 16 6f 90 01 03 0a 13 04 12 04 28 90 01 03 0a 6f 90 01 03 0a 00 09 17 d6 0d 09 08 31 dc 7e 90 01 03 04 6f 90 01 03 0a 28 90 01 03 06 26 de 10 90 00 } //4
