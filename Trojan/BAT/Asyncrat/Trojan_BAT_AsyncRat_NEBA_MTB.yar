...
rule Trojan_BAT_AsyncRat_NEBA_MTB{
	...
	strings :
		...
		$a_01_1 = {70 61 79 6c 6f 61 64 2e 65 78 65 } //02 00 
		$a_01_2 = {61 00 6d 00 73 00 69 00 2e 00 64 00 6c 00 6c 00 } //02 00 
		$a_01_3 = {56 00 69 00 72 00 74 00 75 00 61 00 6c 00 50 00 72 00 6f 00 74 00 65 00 63 00 74 00 } //00 00 
	condition:
		any of ($a_*)
