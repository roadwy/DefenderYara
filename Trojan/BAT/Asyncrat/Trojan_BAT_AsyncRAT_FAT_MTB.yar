...
rule Trojan_BAT_AsyncRAT_FAT_MTB{
	...
	strings :
		$a_03_0 = {0a 06 02 7d 90 01 01 00 00 04 06 03 7d 90 01 01 00 00 04 17 80 90 01 01 00 00 04 06 fe 90 01 02 00 00 06 73 90 01 01 00 00 0a 73 90 01 01 00 00 0a 25 16 6f 90 01 01 00 00 0a 6f 90 01 01 00 00 0a de 03 26 de 90 00 } //3
