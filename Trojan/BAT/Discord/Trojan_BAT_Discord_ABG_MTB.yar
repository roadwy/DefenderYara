...
rule Trojan_BAT_Discord_ABG_MTB{
	...
	strings :
		$a_03_0 = {16 0a 05 2d 08 06 7e 63 90 01 02 04 60 0a 05 6e 20 00 90 01 02 80 6e 5f 2c 08 06 7e 64 90 01 02 04 60 0a 02 04 61 03 04 61 5f 6e 20 00 90 01 02 80 6e 5f 2c 08 90 00 } //2
