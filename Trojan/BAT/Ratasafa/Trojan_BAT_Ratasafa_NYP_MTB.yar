...
rule Trojan_BAT_Ratasafa_NYP_MTB{
	...
	strings :
		...
		$a_81_2 = {2f 42 6c 61 63 6b 4e 6f 74 65 70 61 64 3b 63 6f 6d 70 6f 6e 65 6e 74 2f 61 70 70 2e 78 61 6d 6c } //01 00  /BlackNotepad;component/app.xaml
		$a_81_3 = {42 6c 61 63 6b 4e 6f 74 65 70 61 64 2e 65 78 65 } //01 00  BlackNotepad.exe
		$a_01_4 = {53 61 76 61 67 65 64 2e 42 6c 61 63 6b 4e 6f 74 65 70 61 64 2e 50 72 } //00 00  Savaged.BlackNotepad.Pr
	condition:
		any of ($a_*)
