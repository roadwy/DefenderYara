...
rule Trojan_BAT_Raccoon_NRC_MTB{
	...
	strings :
		$a_03_0 = {28 c7 00 00 06 06 28 90 01 01 00 00 06 6f 90 01 01 00 00 0a 6f 90 01 01 00 00 0a 0b 73 90 01 01 00 00 0a 0c 7e 90 01 01 00 00 04 08 07 16 73 90 01 01 00 00 0a 90 00 } //5
