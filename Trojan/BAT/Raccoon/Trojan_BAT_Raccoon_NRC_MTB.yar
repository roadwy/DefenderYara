...
rule Trojan_BAT_Raccoon_NRC_MTB{
	...
	strings :
		...
		$a_01_1 = {69 6e 74 65 72 6e 61 6c 2e 61 6e 6e 6f 74 61 74 69 6f 6e 73 2e 47 75 61 72 64 65 64 42 79 2e 6d 6f 64 75 6c 65 32 33 } //00 00  internal.annotations.GuardedBy.module23
	condition:
		any of ($a_*)
