...
rule Trojan_BAT_Cassiopeia_MBJ_MTB{
	...
	strings :
		$a_03_0 = {73 31 00 00 0a 0c 06 08 28 32 00 00 0a 72 ?? ?? ?? 70 6f 33 00 00 0a 6f 34 00 00 0a 6f 35 00 00 0a 06 18 6f 36 00 00 0a 06 6f 37 00 00 0a 13 04 02 0d 11 04 09 16 09 8e b7 } //5
