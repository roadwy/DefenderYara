...
rule Trojan_BAT_Fsysna_NLF_MTB{
	...
	strings :
		$a_03_0 = {73 31 00 00 0a 80 90 01 03 04 20 90 01 03 00 38 90 01 03 ff 20 90 01 03 06 20 90 01 03 86 58 20 90 01 03 fb 61 7e 90 01 03 04 7b 90 01 03 04 61 7e 90 01 03 04 28 90 01 03 06 90 00 } //5
