...
rule Trojan_BAT_Fsysna_AFS_MTB{
	...
	strings :
		$a_03_0 = {7e 13 00 00 0a 0a 73 14 00 00 0a 0b 07 72 1f 00 00 70 6f 90 01 01 00 00 0a 0a de 0a 07 2c 06 07 6f 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_BAT_Fsysna_AFS_MTB_3{
	...
	strings :
		$a_03_0 = {0b 2b 4d 12 01 28 90 01 01 00 00 0a 0c 08 73 21 00 00 0a 28 90 01 01 00 00 0a 28 90 01 01 00 00 0a 0d 28 90 01 01 00 00 0a 09 28 90 00 } //2
