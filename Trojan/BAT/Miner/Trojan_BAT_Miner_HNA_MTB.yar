...
rule Trojan_BAT_Miner_HNA_MTB{
	...
	strings :
		$a_03_0 = {25 57 00 61 00 74 00 63 00 68 00 64 00 6f 00 67 00 20 00 52 00 75 00 6e 00 6e 00 69 00 6e 00 67 00 3a 00 20 00 00 90 01 01 47 00 6c 00 6f 00 62 00 61 00 6c 00 90 00 } //25
