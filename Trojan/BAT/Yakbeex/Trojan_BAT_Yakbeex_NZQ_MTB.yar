...
rule Trojan_BAT_Yakbeex_NZQ_MTB{
	...
	strings :
		...
		$a_01_1 = {35 30 31 65 33 66 64 63 2d 35 37 35 64 2d 34 39 32 65 2d 39 30 62 63 2d 37 30 33 66 62 36 32 38 30 65 65 32 } //01 00 
		$a_81_2 = {44 69 73 61 62 6c 65 41 6e 74 69 53 70 79 77 61 72 65 } //00 00 
	condition:
		any of ($a_*)
