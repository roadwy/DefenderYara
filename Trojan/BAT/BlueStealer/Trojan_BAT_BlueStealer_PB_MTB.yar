...
rule Trojan_BAT_BlueStealer_PB_MTB{
	...
	strings :
		$a_03_0 = {07 72 2a 05 00 70 72 2e 05 00 70 6f 90 01 02 00 0a 0b 73 c3 00 00 0a 0c 16 0d 2b 23 00 07 09 18 6f 90 01 02 00 0a 20 03 02 00 00 28 90 01 02 00 0a 13 05 08 90 00 } //1
