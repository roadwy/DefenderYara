...
rule Trojan_BAT_Rozena_AE_MTB{
	meta:
		description = "Trojan:BAT/Rozena.AE!MTB,SIGNATURE_TYPE_PEHSTR_EXT,06 00 06 00 05 00 00 02 00 "
		
	strings :
		$a_01_0 = {41 00 56 00 20 00 45 00 76 00 61 00 73 00 69 00 6f 00 6e 00 32 00 20 00 2b 00 68 00 65 00 75 00 72 00 69 00 73 00 74 00 69 00 63 00 } //01 00  AV Evasion2 +heuristic
