...
rule Trojan_BAT_Rozena_MBFN_MTB{
	...
	strings :
		$a_03_0 = {06 08 9a 16 18 6f 90 01 01 00 00 0a 25 20 03 02 00 00 28 90 01 01 00 00 0a 1f 10 5d 0d 20 03 02 00 00 28 90 01 01 00 00 0a 1f 10 5b 13 04 09 1f 10 5a 11 04 58 13 05 06 08 90 00 } //1
