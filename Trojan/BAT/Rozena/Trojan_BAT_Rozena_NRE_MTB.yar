...
rule Trojan_BAT_Rozena_NRE_MTB{
	...
	strings :
		$a_03_0 = {20 00 30 00 00 1f 40 28 90 01 02 00 06 0c 07 16 08 07 8e 69 28 90 01 02 00 0a 00 7e 90 01 02 00 0a 16 08 7e 90 01 02 00 0a 16 7e 90 01 02 00 0a 28 90 01 02 00 06 90 00 } //5
