...
rule Trojan_BAT_Rozena_NR_MTB{
	...
	strings :
		...
		$a_01_1 = {4f 66 66 65 6e 73 69 76 65 53 68 61 72 70 } //00 00  OffensiveSharp
	condition:
		any of ($a_*)
...
rule Trojan_BAT_Rozena_NR_MTB_2{
	...
	strings :
		...
		$a_01_1 = {43 53 68 61 72 70 4c 6f 61 64 65 72 41 45 53 6b 65 79 } //00 00  CSharpLoaderAESkey
	condition:
		any of ($a_*)
...
rule Trojan_BAT_Rozena_NR_MTB_3{
	...
	strings :
		...
		$a_01_1 = {68 00 61 00 73 00 6e 00 61 00 69 00 6e 00 77 00 69 00 6e 00 73 00 } //00 00  hasnainwins
	condition:
		any of ($a_*)
