...
rule Trojan_BAT_Rozena_ARZ_MTB_6{
	...
	strings :
		...
		$a_01_1 = {6e 00 69 00 65 00 74 00 76 00 35 00 36 00 37 00 } //01 00  nietv567
		$a_01_2 = {48 00 4b 00 45 00 59 00 5f 00 43 00 55 00 52 00 52 00 45 00 4e 00 54 00 5f 00 55 00 53 00 45 00 52 00 5c 00 53 00 6f 00 66 00 74 00 77 00 61 00 72 00 65 00 5c 00 4c 00 6f 00 79 00 65 00 69 00 6e 00 44 00 42 00 53 00 65 00 72 00 76 00 69 00 63 00 65 00 41 00 50 00 49 00 } //00 00  HKEY_CURRENT_USER\Software\LoyeinDBServiceAPI
	condition:
		any of ($a_*)
