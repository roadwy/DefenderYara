...
rule Trojan_BAT_Rozena_ARZ_MTB_4{
	...
	strings :
		$a_03_0 = {0c 06 16 08 07 28 90 01 03 0a 7e 02 00 00 0a 16 08 7e 02 00 00 0a 16 7e 02 00 00 0a 28 90 01 03 06 0d 09 15 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_BAT_Rozena_ARZ_MTB_5{
	...
	strings :
		$a_03_0 = {0c 07 16 08 6e 28 90 01 03 0a 07 8e 69 28 90 01 03 0a 00 7e 0c 00 00 0a 0d 16 13 04 7e 0c 00 00 0a 13 05 16 16 08 11 05 16 12 04 28 90 01 03 06 0d 09 15 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_BAT_Rozena_ARZ_MTB_6{
	...
	strings :
		$a_03_0 = {0c 16 08 8e 69 7e 90 01 01 00 00 04 7e 90 01 01 00 00 04 28 90 01 01 00 00 06 0d 08 16 09 6e 28 90 01 01 00 00 0a 08 8e 69 28 90 01 01 00 00 0a 16 16 09 07 16 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_BAT_Rozena_ARZ_MTB_7{
	...
	strings :
		$a_03_0 = {16 13 07 2b 14 07 11 07 8f 90 01 01 00 00 01 25 47 08 61 d2 52 11 07 17 58 13 07 11 07 07 8e 69 32 e5 90 00 } //2
...
rule Trojan_BAT_Rozena_ARZ_MTB_8{
	...
	strings :
		$a_03_0 = {0a 06 8e 69 8d 15 00 00 01 0b 16 0c 2b 0f 07 08 06 08 93 28 90 01 03 0a 9c 08 17 58 0c 08 07 8e 69 32 eb 90 00 } //2
