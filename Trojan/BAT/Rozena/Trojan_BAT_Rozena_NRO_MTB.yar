...
rule Trojan_BAT_Rozena_NRO_MTB{
	...
	strings :
		$a_03_0 = {0c 72 86 12 00 70 28 90 01 01 00 00 06 0d 73 90 01 01 00 00 0a 13 04 06 28 90 01 01 00 00 0a 73 90 01 01 00 00 0a 13 05 11 05 11 04 08 09 6f 90 01 01 00 00 0a 16 73 90 01 01 00 00 0a 13 06 11 06 73 90 01 01 00 00 0a 13 07 11 07 90 00 } //01 00 
		$a_01_1 = {43 61 6c 69 73 74 69 72 6d 61 46 6f 6e 6b 73 69 79 6f 6e 75 } //00 00  CalistirmaFonksiyonu
	condition:
		any of ($a_*)
...
rule Trojan_BAT_Rozena_NRO_MTB_2{
	...
	strings :
		...
		$a_01_1 = {4d 61 69 6c 53 6c 6f 74 57 69 74 68 54 65 73 74 } //00 00  MailSlotWithTest
	condition:
		any of ($a_*)
