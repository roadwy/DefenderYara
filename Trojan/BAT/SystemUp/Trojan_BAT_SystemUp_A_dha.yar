...
rule Trojan_BAT_SystemUp_A_dha{
	...
	strings :
		...
		$a_00_3 = {42 45 41 53 44 5a 58 58 58 4d 45 4c } //01 00 
		$a_00_4 = {59 45 50 54 52 55 50 54 41 53 4b 41 4d 45 4c 41 4e 41 5a } //01 00 
		$a_00_5 = {53 74 61 72 53 68 65 6c 6c } //01 00 
		$a_00_6 = {53 68 65 6c 6c 57 72 69 74 65 4c 69 6e 65 } //01 00 
		$a_00_7 = {50 72 6f 63 65 73 73 53 68 65 6c 6c } //01 00 
