...
rule Trojan_BAT_Disstl_ADI_MTB{
	...
	strings :
		$a_03_0 = {a2 25 17 28 90 01 03 0a a2 25 18 72 50 01 00 70 a2 25 19 02 7b 05 00 00 04 a2 25 1a 72 54 01 00 70 a2 28 90 01 03 0a 0c 07 06 90 00 } //2
...
rule Trojan_BAT_Disstl_ADI_MTB_3{
	...
	strings :
		...
		$a_03_1 = {08 1f 53 58 0c 00 73 90 01 01 00 00 0a 7e 90 01 01 00 00 0a 8e 20 91 d2 00 00 58 7e 90 01 01 00 00 0a 8e 20 aa d5 00 00 58 fe 1c 10 00 00 01 1f 41 58 28 90 00 } //2
