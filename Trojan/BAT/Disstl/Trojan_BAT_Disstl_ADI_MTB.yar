...
rule Trojan_BAT_Disstl_ADI_MTB{
	...
	strings :
		...
		$a_01_1 = {5c 64 65 62 75 67 5c 73 6f 75 72 63 65 5c 72 65 70 6f 73 5c 50 63 43 6c 65 61 6e 65 72 5c 50 63 43 6c 65 61 6e 65 72 5c 6f 62 6a 5c 44 65 62 75 67 5c 50 63 43 6c 65 61 6e 65 72 2e 70 64 62 } //00 00  \debug\source\repos\PcCleaner\PcCleaner\obj\Debug\PcCleaner.pdb
	condition:
		any of ($a_*)
...
rule Trojan_BAT_Disstl_ADI_MTB_2{
	...
	strings :
		...
		$a_01_1 = {46 00 75 00 63 00 6b 00 65 00 64 00 2e 00 65 00 78 00 65 00 } //00 00  Fucked.exe
	condition:
		any of ($a_*)
