...
rule Trojan_BAT_Disstl_AT_MTB{
	...
	strings :
		$a_02_0 = {0b 2b 3e 07 6f 90 01 03 0a 28 90 01 03 0a 74 90 01 03 01 6f 90 01 03 0a 16 6f 90 01 03 0a 6f 90 01 03 0a 0c 08 6f 90 01 03 0a 1f 3b 2e 0c 08 6f 90 01 03 0a 1f 58 fe 01 2b 01 17 2c 04 08 0a de 24 07 90 00 } //10
