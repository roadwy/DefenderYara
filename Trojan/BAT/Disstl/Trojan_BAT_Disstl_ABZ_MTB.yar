...
rule Trojan_BAT_Disstl_ABZ_MTB{
	...
	strings :
		$a_03_0 = {0a 0d 09 72 90 01 03 70 6f 90 01 03 0a 2c 2b 06 72 90 01 03 70 09 17 8d 90 01 03 01 13 04 11 04 16 1f 22 9d 11 04 6f 90 01 03 0a 1d 9a 90 0a 44 00 07 72 90 01 03 70 02 6f 90 01 03 0a 0c 28 90 01 03 0a 08 6f 3b 90 00 } //4
