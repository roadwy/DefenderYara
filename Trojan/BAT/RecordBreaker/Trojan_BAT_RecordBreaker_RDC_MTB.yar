...
rule Trojan_BAT_RecordBreaker_RDC_MTB{
	...
	strings :
		$a_01_0 = {30 37 31 39 33 64 34 36 2d 32 62 63 30 2d 34 34 31 33 2d 61 34 32 62 2d 30 37 33 39 64 30 30 35 66 36 33 61 } //02 00  07193d46-2bc0-4413-a42b-0739d005f63a
