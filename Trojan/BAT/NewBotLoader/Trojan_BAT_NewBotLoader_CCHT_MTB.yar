...
rule Trojan_BAT_NewBotLoader_CCHT_MTB{
	...
	strings :
		$a_03_0 = {0a a2 25 20 02 00 00 00 20 ?? 00 00 00 28 2a 00 00 0a a2 25 20 03 00 00 00 20 ?? 00 00 00 28 2a 00 00 0a a2 25 20 04 00 00 00 20 ?? 00 00 00 28 2a 00 00 0a a2 25 20 05 00 00 00 20 ?? 00 00 00 28 2a 00 00 0a a2 25 20 06 00 00 00 20 ?? 00 00 00 28 2a 00 00 0a a2 25 20 07 00 00 00 20 ?? 00 00 00 28 2a 00 00 0a a2 25 20 08 00 00 00 20 ?? 00 00 00 28 2a 00 00 0a a2 25 20 09 00 00 00 20 ?? 00 00 00 28 2a 00 00 0a a2 25 } //1
