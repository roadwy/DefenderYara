...
rule Trojan_BAT_DarkKomet_MBDB_MTB{
	...
	strings :
		$a_03_0 = {0a 03 50 6f ?? 00 00 0a 6f ?? 00 00 0a 0b 73 0c 00 00 0a 0c 08 07 6f ?? 00 00 0a 08 18 6f ?? 00 00 0a 08 6f ?? 00 00 0a 02 50 16 02 50 8e 69 6f ?? 00 00 0a 2a } //10
