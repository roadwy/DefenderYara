...
rule Trojan_BAT_SoldierAudio_A_dha{
	...
	strings :
		$a_01_0 = {4d 00 69 00 63 00 72 00 6f 00 73 00 6f 00 66 00 74 00 2e 00 4e 00 56 00 49 00 44 00 49 00 41 00 43 00 6f 00 72 00 70 00 2e 00 65 00 78 00 65 00 } //01 00  Microsoft.NVIDIACorp.exe
