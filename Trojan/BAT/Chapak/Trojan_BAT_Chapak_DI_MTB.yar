...
rule Trojan_BAT_Chapak_DI_MTB{
	meta:
		description = "Trojan:BAT/Chapak.DI!MTB,SIGNATURE_TYPE_PEHSTR_EXT,07 00 07 00 07 00 00 01 00 "
		
	strings :
		$a_81_0 = {61 64 66 61 73 64 61 73 } //01 00  adfasdas
		$a_01_1 = {53 00 48 00 4f 00 50 00 50 00 49 00 4e 00 47 00 5f 00 57 00 4f 00 52 00 4c 00 44 00 5f 00 4f 00 4e 00 4c 00 49 00 4e 00 45 00 5f 00 45 00 43 00 4f 00 4d 00 4d 00 45 00 52 00 43 00 45 00 5f 00 49 00 43 00 4f 00 4e 00 5f 00 31 00 39 00 32 00 34 00 34 00 30 00 } //01 00  SHOPPING_WORLD_ONLINE_ECOMMERCE_ICON_192440
		$a_81_2 = {47 65 74 4d 61 6e 69 66 65 73 74 52 65 73 6f 75 72 63 65 53 74 72 65 61 6d } //01 00  GetManifestResourceStream
		...
		$a_81_5 = {52 65 73 6f 6c 76 65 53 69 67 6e 61 74 75 72 65 } //01 00  ResolveSignature
