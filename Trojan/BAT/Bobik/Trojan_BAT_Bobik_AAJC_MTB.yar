...
rule Trojan_BAT_Bobik_AAJC_MTB{
	...
	strings :
		...
		$a_01_2 = {57 00 46 00 5f 00 44 00 6f 00 63 00 2e 00 50 00 72 00 6f 00 70 00 65 00 72 00 74 00 69 00 65 00 73 00 2e 00 52 00 65 00 73 00 6f 00 75 00 72 00 63 00 65 00 73 00 } //00 00 
	condition:
		any of ($a_*)
