...
rule Trojan_BAT_Bobik_NBK_MTB{
	...
	strings :
		...
		$a_01_1 = {4e 20 53 70 6f 6f 66 65 72 } //01 00  N Spoofer
		$a_01_2 = {4e 65 6f 78 20 53 70 6f 6f 66 65 72 } //00 00  Neox Spoofer
	condition:
		any of ($a_*)
...
rule Trojan_BAT_Bobik_NBK_MTB_2{
	...
	strings :
		...
		$a_01_1 = {77 77 63 64 2e 65 78 65 } //01 00  wwcd.exe
		$a_01_2 = {57 00 69 00 6e 00 64 00 6f 00 77 00 73 00 5c 00 57 00 69 00 6e 00 2e 00 70 00 6e 00 67 00 } //00 00  Windows\Win.png
	condition:
		any of ($a_*)
