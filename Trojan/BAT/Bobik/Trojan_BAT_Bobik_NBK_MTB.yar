...
rule Trojan_BAT_Bobik_NBK_MTB{
	...
	strings :
		$a_03_0 = {28 e8 01 00 0a 58 28 90 01 02 00 0a 61 69 61 69 fe 90 01 02 00 61 5e 90 00 } //5
...
rule Trojan_BAT_Bobik_NBK_MTB_2{
	...
	strings :
		$a_03_0 = {72 01 00 00 70 0a 7e 90 01 01 00 00 04 28 90 01 01 00 00 06 00 28 90 01 01 00 00 0a 14 fe 90 01 04 06 73 90 01 01 00 00 0a 6f 90 01 01 00 00 0a 00 06 7e 90 01 01 00 00 04 28 90 01 01 00 00 06 00 28 90 01 01 00 00 0a 6f 90 01 01 00 00 0a 26 90 00 } //5
