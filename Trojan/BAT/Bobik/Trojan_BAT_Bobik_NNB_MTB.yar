...
rule Trojan_BAT_Bobik_NNB_MTB{
	...
	strings :
		$a_03_0 = {6f 4c 00 00 0a 6f 90 01 01 00 00 0a 13 04 12 04 28 90 01 01 00 00 0a 1f 28 da 73 90 01 01 00 00 0a 16 16 73 90 01 01 00 00 0a 11 06 6f 90 01 01 00 00 0a 90 00 } //5
		$a_01_1 = {54 61 73 6b 62 61 72 20 44 65 73 74 72 6f 79 65 72 2e 65 78 65 } //1 Taskbar Destroyer.exe
