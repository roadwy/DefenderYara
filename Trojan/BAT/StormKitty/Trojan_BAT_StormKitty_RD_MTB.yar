...
rule Trojan_BAT_StormKitty_RD_MTB{
	...
	strings :
		$a_01_0 = {2f 00 2f 00 31 00 39 00 35 00 2e 00 31 00 37 00 38 00 2e 00 31 00 32 00 30 00 2e 00 32 00 33 00 30 00 2f 00 66 00 69 00 6c 00 65 00 2f 00 } //01 00 
