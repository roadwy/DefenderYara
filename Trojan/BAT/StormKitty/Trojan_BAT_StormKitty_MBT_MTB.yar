...
rule Trojan_BAT_StormKitty_MBT_MTB{
	...
	strings :
		$a_03_0 = {0a 08 08 6f 90 01 01 00 00 0a 08 6f 90 01 01 00 00 0a 6f 90 01 01 00 00 0a 0d 73 90 01 01 00 00 0a 13 04 11 04 09 17 73 90 01 01 00 00 0a 13 05 06 90 00 } //1
