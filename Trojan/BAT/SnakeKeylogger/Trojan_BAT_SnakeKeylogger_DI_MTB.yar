...
rule Trojan_BAT_SnakeKeylogger_DI_MTB{
	...
	strings :
		$a_81_0 = {41 5a 5a 5a 5a 5a 5a 5a 5a 5a 5a 5a 5a 5a 5a 5a 5a 32 33 } //32 00 
		$a_81_1 = {69 6d 69 6d 69 6d 69 6d 69 6d } //14 00 
		$a_81_2 = {58 44 41 53 58 41 58 41 58 } //14 00 
		$a_81_3 = {00 78 78 78 78 78 78 78 78 78 78 78 78 78 78 78 78 78 78 00 } //01 00 
