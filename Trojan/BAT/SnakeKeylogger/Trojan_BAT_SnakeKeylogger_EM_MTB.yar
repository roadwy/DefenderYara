...
rule Trojan_BAT_SnakeKeylogger_EM_MTB{
	meta:
		description = "Trojan:BAT/SnakeKeylogger.EM!MTB,SIGNATURE_TYPE_PEHSTR_EXT,18 00 18 00 0b 00 00 14 00 "
		
	strings :
		$a_00_0 = {24 33 65 31 66 30 34 38 36 2d 61 34 61 38 2d 34 35 64 34 2d 62 30 33 36 2d 66 30 61 63 64 38 62 63 62 64 66 37 } //01 00  $3e1f0486-a4a8-45d4-b036-f0acd8bcbdf7
