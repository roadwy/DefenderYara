...
rule Trojan_BAT_SnakeKeylogger_MB_MTB{
	...
	strings :
		...
		$a_01_1 = {46 6f 72 74 75 64 65 53 65 63 6f 6e 64 2e 50 72 6f 70 65 72 74 69 65 73 } //02 00 
		$a_01_2 = {4a 61 6d 62 6f } //02 00 
		$a_01_3 = {74 78 74 51 74 79 5f 4b 65 79 50 72 65 73 73 } //01 00 
