...
rule Trojan_BAT_SnakeKeylogger_MV_MTB{
	...
	strings :
		...
		$a_01_1 = {30 35 64 35 39 34 63 35 2d 32 66 61 64 2d 34 66 37 61 2d 38 34 65 31 2d 61 30 61 63 66 64 37 36 37 66 30 36 } //02 00 
		$a_01_2 = {43 6f 6e 77 61 79 5f 73 5f 47 61 6d 65 2e 50 72 6f 70 65 72 74 69 65 73 } //00 00 
	condition:
		any of ($a_*)
