...
rule Trojan_BAT_Snakekeylogger_AFSQ_MTB{
	...
	strings :
		...
		$a_01_4 = {52 43 32 43 72 79 70 74 6f 53 65 72 76 69 63 65 50 72 6f 76 69 64 65 72 } //1 RC2CryptoServiceProvider
		$a_01_5 = {4d 44 35 43 72 79 70 74 6f 53 65 72 76 69 63 65 50 72 6f 76 69 64 65 72 } //1 MD5CryptoServiceProvider
		$a_01_6 = {62 00 61 00 63 00 6b 00 67 00 72 00 6f 00 75 00 6e 00 64 00 5f 00 6d 00 61 00 70 00 5f 00 65 00 61 00 73 00 74 00 31 00 5f 00 73 00 74 00 61 00 72 00 74 00 5f 00 31 00 2e 00 70 00 6e 00 67 00 } //1 background_map_east1_start_1.png
	condition:
