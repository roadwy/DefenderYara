...
rule Trojan_BAT_SnakeKeylogger_NVB_MTB{
	...
	strings :
		$a_03_0 = {06 11 04 17 da 6f 90 01 03 0a 28 90 01 03 06 07 11 04 07 6f 90 01 03 0a 5d 6f 90 01 03 0a 28 90 01 03 06 da 13 05 08 11 05 28 90 01 03 0a 28 90 01 03 0a 28 90 01 03 0a 0c 11 04 17 d6 13 04 11 04 09 31 bc 90 00 } //1
