...
rule Trojan_BAT_SnakeKeylogger_NVB_MTB{
	...
	strings :
		...
		$a_01_1 = {42 00 75 00 6e 00 69 00 66 00 75 00 5f 00 54 00 65 00 78 00 74 00 42 00 6f 00 78 00 } //01 00 
		$a_01_2 = {49 00 6e 00 76 00 69 00 73 00 63 00 65 00 } //00 00 
	condition:
		any of ($a_*)
