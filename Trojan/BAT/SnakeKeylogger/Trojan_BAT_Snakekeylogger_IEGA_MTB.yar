...
rule Trojan_BAT_Snakekeylogger_IEGA_MTB{
	...
	strings :
		...
		$a_01_1 = {35 00 38 00 35 00 47 00 35 00 34 00 53 00 34 00 43 00 35 00 48 00 42 00 43 00 35 00 53 00 59 00 44 00 35 00 34 00 35 00 34 00 32 00 } //01 00 
		$a_01_2 = {53 00 6e 00 61 00 6b 00 65 00 49 00 } //00 00 
	condition:
		any of ($a_*)
