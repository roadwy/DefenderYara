...
rule Trojan_BAT_SnakeKeylogger_NY_MTB{
	...
	strings :
		...
		$a_01_1 = {6f 00 6e 00 65 00 6c 00 69 00 6e 00 65 00 72 00 73 00 2e 00 65 00 78 00 65 00 } //01 00  oneliners.exe
		$a_01_2 = {47 65 74 4d 65 74 68 6f 64 } //01 00  GetMethod
		$a_01_3 = {43 72 65 61 74 65 44 65 6c 65 67 61 74 65 } //01 00  CreateDelegate
		$a_01_4 = {44 79 6e 61 6d 69 63 49 6e 76 6f 6b 65 } //01 00  DynamicInvoke
