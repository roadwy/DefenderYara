...
rule Trojan_BAT_SnakeKeyLogger_RDC_MTB{
	...
	strings :
		$a_01_0 = {64 30 35 63 61 65 65 61 2d 31 39 62 65 2d 34 61 34 61 2d 38 37 30 35 2d 33 39 35 62 35 32 64 37 64 34 34 36 } //01 00  d05caeea-19be-4a4a-8705-395b52d7d446
		...
		$a_01_4 = {45 62 6f 6f 6b 5f 4f 72 64 65 72 69 6e 67 } //01 00  Ebook_Ordering
		$a_01_5 = {4f 4b 4d 4c 50 4f 4b 4d } //00 00  OKMLPOKM
	condition:
		any of ($a_*)
