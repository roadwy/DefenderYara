...
rule Trojan_BAT_SnakeKeylogger_EL_MTB{
	...
	strings :
		$a_81_0 = {54 61 6e 6b 39 30 } //01 00 
		$a_81_1 = {74 61 6e 6b 5f 67 61 6d 65 5f 6f 76 65 72 2e 70 6e 67 } //01 00 
		...
		$a_81_7 = {67 65 74 5f 59 } //01 00 
		$a_81_8 = {67 65 74 5f 58 } //00 00 
	condition:
		any of ($a_*)
