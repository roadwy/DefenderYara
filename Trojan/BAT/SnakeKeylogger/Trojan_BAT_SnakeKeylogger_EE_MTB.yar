...
rule Trojan_BAT_SnakeKeylogger_EE_MTB{
	...
	strings :
		...
		$a_81_1 = {24 63 38 34 30 61 36 61 35 2d 36 33 31 30 2d 34 36 38 62 2d 38 63 63 63 2d 38 39 34 66 65 34 64 31 30 37 61 36 } //01 00 
		$a_81_2 = {57 5f 5f 5f 5f 5f 5f 5f 5f 5f 5f 57 } //01 00 
		$a_81_3 = {58 5f 5f 5f 5f 5f 5f 5f 5f 5f 5f 58 } //00 00 
	condition:
		any of ($a_*)
