...
rule Trojan_BAT_SnakeKeylogger_MG_MTB{
	...
	strings :
		$a_03_0 = {13 08 12 08 28 90 01 03 0a 26 11 06 72 8d a4 10 70 72 9f a4 10 70 28 90 01 03 06 13 09 11 09 28 90 01 03 0a 28 90 01 03 0a 72 b1 a4 10 70 6f 0e 00 00 0a 72 cd a4 10 70 20 00 01 00 00 14 14 11 05 90 00 } //5
