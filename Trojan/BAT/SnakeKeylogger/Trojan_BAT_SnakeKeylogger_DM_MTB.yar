...
rule Trojan_BAT_SnakeKeylogger_DM_MTB{
	...
	strings :
		$a_03_0 = {0a 03 08 03 6f 90 01 03 0a 5d 17 d6 28 90 01 03 0a 28 90 01 03 0a da 0d 06 09 b6 28 90 01 03 0a 28 90 01 03 0a 0a 08 17 d6 0c 00 08 07 fe 02 16 fe 01 13 04 11 04 2d bc 90 00 } //10
