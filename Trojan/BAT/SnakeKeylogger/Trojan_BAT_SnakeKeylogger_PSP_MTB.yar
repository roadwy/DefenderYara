...
rule Trojan_BAT_SnakeKeylogger_PSP_MTB{
	...
	strings :
		$a_03_0 = {16 11 0c 09 59 28 90 01 03 0a 13 0d 11 0c 09 58 17 58 04 6f 90 01 03 0a 28 90 01 03 0a 13 0e 11 0d 13 0f 2b 42 00 07 11 0f 91 13 10 11 10 2c 02 90 00 } //1
