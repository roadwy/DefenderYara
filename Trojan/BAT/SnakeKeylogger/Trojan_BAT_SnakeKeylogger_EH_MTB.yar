...
rule Trojan_BAT_SnakeKeylogger_EH_MTB{
	...
	strings :
		$a_81_0 = {24 65 30 36 66 32 62 34 36 2d 37 30 32 38 2d 34 35 38 37 2d 38 63 38 63 2d 61 34 63 65 39 37 38 33 62 63 62 38 } //01 00  $e06f2b46-7028-4587-8c8c-a4ce9783bcb8
		$a_81_1 = {00 58 58 58 58 58 58 58 00 } //01 00 
		$a_81_2 = {4d 64 35 44 65 63 72 79 70 74 } //01 00  Md5Decrypt
		$a_81_3 = {47 61 6e 67 42 61 6e 67 } //01 00  GangBang
