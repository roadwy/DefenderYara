...
rule Trojan_BAT_SnakeKeylogger_MS_MTB{
	...
	strings :
		...
		$a_01_1 = {45 00 72 00 62 00 6e 00 4b 00 68 00 4f 00 42 00 69 00 57 00 54 00 53 00 52 00 4b 00 45 00 } //03 00 
		$a_01_2 = {68 00 57 00 51 00 48 00 6c 00 53 00 4f 00 78 00 48 00 51 00 4b 00 61 00 4e 00 44 00 76 00 } //01 00 
