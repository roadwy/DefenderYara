...
rule Trojan_BAT_SnakeKeylogger_SPRN_MTB{
	...
	strings :
		...
		$a_01_1 = {6d 00 61 00 65 00 73 00 4d 00 61 00 69 00 6e 00 2e 00 43 00 72 00 65 00 61 00 74 00 65 00 44 00 65 00 63 00 72 00 79 00 70 00 74 00 6f 00 72 00 } //00 00  maesMain.CreateDecryptor
	condition:
		any of ($a_*)
