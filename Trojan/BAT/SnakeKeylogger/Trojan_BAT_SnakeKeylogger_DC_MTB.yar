...
rule Trojan_BAT_SnakeKeylogger_DC_MTB{
	...
	strings :
		$a_81_0 = {47 61 6d 65 42 6f 78 2e 4c 6f 67 6f 2e 72 65 73 6f 75 72 63 65 73 } //01 00  GameBox.Logo.resources
		$a_81_1 = {47 61 6d 65 42 6f 78 2e 50 72 6f 70 65 72 74 69 65 73 } //01 00  GameBox.Properties
		...
		$a_81_4 = {6f 70 65 6e 4b 65 79 62 6f 61 72 64 } //01 00  openKeyboard
		$a_81_5 = {52 65 70 6c 61 63 65 } //01 00  Replace
		$a_81_6 = {67 65 74 5f 4b 65 79 } //01 00  get_Key
