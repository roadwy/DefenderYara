...
rule Trojan_BAT_SnakeKeylogger_RPI_MTB{
	...
	strings :
		...
		$a_01_3 = {41 73 73 65 6d 62 6c 79 } //01 00 
		$a_01_4 = {57 61 69 74 4f 6e 65 } //01 00 
		$a_01_5 = {57 65 62 43 6c 69 65 6e 74 } //01 00 
		$a_01_6 = {44 6f 77 6e 6c 6f 61 64 44 61 74 61 } //01 00 
		$a_01_7 = {57 72 69 74 65 41 64 61 70 74 65 72 } //01 00 
		$a_01_8 = {43 68 65 63 6b 41 64 61 70 74 65 72 } //01 00 
		$a_01_9 = {43 61 6c 6c 41 64 61 70 74 65 72 } //01 00 
		$a_01_10 = {54 65 73 74 41 64 61 70 74 65 72 } //01 00 
		$a_01_11 = {43 6f 6c 6c 65 63 74 41 64 61 70 74 65 72 } //01 00 
		$a_01_12 = {53 6b 79 70 65 20 54 65 63 68 6e 6f 6c 6f 67 69 65 73 20 53 2e 41 2e } //00 00 
	condition:
		any of ($a_*)
