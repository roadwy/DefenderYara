...
rule Trojan_BAT_SnakeKeylogger_MP_MTB{
	...
	strings :
		$a_03_0 = {0d 08 73 3e 00 00 0a 13 04 11 04 09 06 07 6f 90 01 03 0a 16 73 40 00 00 0a 13 05 11 05 73 41 00 00 0a 13 06 11 06 6f 90 01 03 0a 2a 11 07 2a 90 00 } //5
