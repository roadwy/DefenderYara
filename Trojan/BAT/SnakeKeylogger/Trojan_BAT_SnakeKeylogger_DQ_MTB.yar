...
rule Trojan_BAT_SnakeKeylogger_DQ_MTB{
	meta:
		description = "Trojan:BAT/SnakeKeylogger.DQ!MTB,SIGNATURE_TYPE_PEHSTR_EXT,18 00 18 00 0e 00 00 14 00 "
		
	strings :
		$a_00_0 = {24 30 38 39 33 36 65 66 31 2d 38 66 36 63 2d 34 37 31 63 2d 39 64 31 31 2d 37 62 34 35 32 38 34 63 61 34 61 36 } //14 00  $08936ef1-8f6c-471c-9d11-7b45284ca4a6
		$a_00_1 = {24 31 32 65 34 34 37 33 62 2d 30 31 31 32 2d 34 65 32 62 2d 39 30 31 39 2d 33 64 66 63 30 30 66 32 61 36 30 38 } //14 00  $12e4473b-0112-4e2b-9019-3dfc00f2a608
		$a_00_2 = {24 36 66 34 64 35 30 34 36 2d 37 61 61 38 2d 34 38 64 65 2d 62 33 32 32 2d 39 35 35 66 65 35 64 31 32 31 63 38 } //14 00  $6f4d5046-7aa8-48de-b322-955fe5d121c8
		$a_00_3 = {24 33 37 38 36 63 36 65 38 2d 33 37 63 30 2d 34 35 61 61 2d 61 35 61 31 2d 35 66 64 63 36 39 36 35 31 31 64 38 } //01 00  $3786c6e8-37c0-45aa-a5a1-5fdc696511d8
