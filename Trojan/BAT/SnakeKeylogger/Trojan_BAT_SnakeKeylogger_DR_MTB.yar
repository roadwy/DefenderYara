...
rule Trojan_BAT_SnakeKeylogger_DR_MTB{
	meta:
		description = "Trojan:BAT/SnakeKeylogger.DR!MTB,SIGNATURE_TYPE_PEHSTR_EXT,18 00 18 00 0d 00 00 "
		
	strings :
		$a_00_0 = {24 32 61 36 35 36 30 35 62 2d 36 63 34 66 2d 34 34 37 66 2d 39 30 39 39 2d 36 65 38 61 38 32 32 30 62 36 32 62 } //20 $2a65605b-6c4f-447f-9099-6e8a8220b62b
		$a_00_1 = {24 30 37 66 37 31 31 32 35 2d 37 31 39 61 2d 34 33 39 39 2d 39 32 30 39 2d 39 39 38 63 39 32 38 32 34 35 64 33 } //20 $07f71125-719a-4399-9209-998c928245d3
		$a_00_2 = {24 34 31 34 38 38 31 37 31 2d 35 30 31 37 2d 34 31 65 32 2d 39 64 34 38 2d 64 62 36 36 37 36 34 63 30 63 63 62 } //20 $41488171-5017-41e2-9d48-db66764c0ccb
