...
rule Trojan_BAT_SnakeKeylogger_SPD_MTB{
	...
	strings :
		$a_03_0 = {0a 20 00 80 01 00 8d 71 00 00 01 0b 06 72 d5 05 00 70 6f ?? ?? ?? 0a 74 08 00 00 1b 16 07 16 20 00 c0 00 00 28 ?? ?? ?? 0a 00 06 72 db 05 00 70 6f ?? ?? ?? 0a 74 08 00 00 1b 16 } //3
