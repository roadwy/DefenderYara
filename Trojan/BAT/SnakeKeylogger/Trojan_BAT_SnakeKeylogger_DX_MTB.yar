...
rule Trojan_BAT_SnakeKeylogger_DX_MTB{
	...
	strings :
		$a_81_0 = {46 44 44 44 44 44 44 46 } //01 00 
		$a_81_1 = {49 49 49 49 49 75 61 73 49 49 49 49 49 49 } //01 00 
		$a_81_2 = {54 72 69 70 6c 65 44 45 53 } //01 00 
		$a_81_3 = {52 75 6e 50 6f 77 65 72 53 68 65 6c 6c } //01 00 
