...
rule Trojan_BAT_SnakeKeylogger_EO_MTB{
	meta:
		description = "Trojan:BAT/SnakeKeylogger.EO!MTB,SIGNATURE_TYPE_PEHSTR_EXT,18 00 18 00 0b 00 00 14 00 "
		
	strings :
		$a_00_0 = {24 34 36 32 39 64 38 62 32 2d 62 31 36 32 2d 34 34 61 39 2d 61 32 30 37 2d 66 32 62 30 62 34 32 32 33 34 63 35 } //01 00  $4629d8b2-b162-44a9-a207-f2b0b42234c5
