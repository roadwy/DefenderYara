...
rule Trojan_BAT_SnakeKeylogger_DY_MTB{
	...
	strings :
		$a_81_0 = {4d 69 6c 6c 69 6f 6e 61 72 65 2e 50 72 6f 70 65 72 74 69 65 73 2e 52 65 73 6f 75 72 63 65 73 } //01 00  Millionare.Properties.Resources
		$a_81_1 = {47 5a 69 70 53 74 72 65 61 6d } //01 00  GZipStream
		$a_81_2 = {44 6f 6e 74 4c 65 74 55 73 65 72 4c 6f 67 69 6e } //01 00  DontLetUserLogin
