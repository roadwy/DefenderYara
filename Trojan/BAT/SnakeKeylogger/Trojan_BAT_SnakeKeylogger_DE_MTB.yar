...
rule Trojan_BAT_SnakeKeylogger_DE_MTB{
	...
	strings :
		$a_81_0 = {24 64 30 64 32 63 66 62 62 2d 63 30 36 63 2d 34 64 62 65 2d 61 66 38 61 2d 61 65 30 66 62 62 36 61 32 64 62 30 } //20 $d0d2cfbb-c06c-4dbe-af8a-ae0fbb6a2db0
