...
rule Trojan_BAT_SnakeKeylogger_NEAB_MTB{
	...
	strings :
		$a_03_0 = {a2 14 14 14 28 90 01 01 00 00 0a 14 72 90 01 01 46 02 70 18 8d 90 01 01 00 00 01 25 16 72 90 01 01 46 02 70 a2 25 17 72 90 01 01 46 02 70 a2 14 14 14 28 90 01 01 00 00 0a 28 90 01 01 00 00 0a 0b 07 0a 2b 00 06 2a 90 00 } //10
