...
rule Trojan_BAT_SnakeKeylogger_DA_MTB{
	meta:
		description = "Trojan:BAT/SnakeKeylogger.DA!MTB,SIGNATURE_TYPE_PEHSTR_EXT,1b 00 1b 00 09 00 00 14 00 "
		
	strings :
		$a_81_0 = {24 34 37 38 63 38 63 62 30 2d 31 34 35 62 2d 34 63 32 33 2d 61 37 31 61 2d 34 33 32 61 37 38 63 61 61 34 64 62 } //01 00  $478c8cb0-145b-4c23-a71a-432a78caa4db
		...
		$a_81_2 = {43 61 6c 63 75 6c 61 74 6f 72 5f 32 2e 50 72 6f 70 65 72 74 69 65 73 2e 52 65 73 6f 75 72 63 65 73 } //01 00  Calculator_2.Properties.Resources
		...
		$a_81_7 = {67 65 74 5f 49 6e 73 74 61 6e 63 65 } //01 00  get_Instance
