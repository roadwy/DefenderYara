...
rule Trojan_BAT_SnakeKeylogger_DT_MTB{
	meta:
		description = "Trojan:BAT/SnakeKeylogger.DT!MTB,SIGNATURE_TYPE_PEHSTR_EXT,18 00 18 00 0d 00 00 14 00 "
		
	strings :
		$a_00_0 = {24 33 65 36 37 64 63 64 35 2d 33 65 64 62 2d 34 65 32 34 2d 39 65 62 38 2d 39 33 66 36 36 66 39 66 31 35 38 39 } //14 00  $3e67dcd5-3edb-4e24-9eb8-93f66f9f1589
		$a_00_1 = {24 39 35 34 64 65 37 39 63 2d 36 33 63 34 2d 34 30 31 35 2d 38 34 31 37 2d 64 34 36 35 38 38 66 37 63 62 30 66 } //14 00  $954de79c-63c4-4015-8417-d46588f7cb0f
		$a_00_2 = {24 31 66 36 63 37 39 61 38 2d 35 32 36 61 2d 34 32 38 62 2d 62 33 38 66 2d 39 34 31 34 31 63 36 63 65 38 31 31 } //01 00  $1f6c79a8-526a-428b-b38f-94141c6ce811
