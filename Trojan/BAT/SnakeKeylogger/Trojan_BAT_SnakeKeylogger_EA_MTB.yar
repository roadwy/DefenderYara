...
rule Trojan_BAT_SnakeKeylogger_EA_MTB{
	...
	strings :
		$a_00_0 = {24 36 64 35 33 64 38 34 36 2d 37 34 33 37 2d 34 63 61 30 2d 62 65 65 30 2d 61 61 32 39 32 65 65 63 64 35 31 61 } //01 00  $6d53d846-7437-4ca0-bee0-aa292eecd51a
		$a_81_1 = {44 69 61 6c 6f 67 73 4c 69 62 } //01 00  DialogsLib
		$a_81_2 = {00 58 58 58 58 58 58 00 } //01 00  堀塘塘X
		$a_81_3 = {72 65 2e 74 78 74 } //01 00  re.txt
