...
rule Trojan_BAT_SnakeKeylogger_SSU_MTB{
	...
	strings :
		...
		$a_81_1 = {4c 49 4e 4b 53 5f 49 4e 5f 48 45 52 45 } //01 00  LINKS_IN_HERE
		...
		$a_81_7 = {67 65 74 5f 41 73 73 65 6d 62 6c 79 } //01 00  get_Assembly
		$a_81_8 = {67 65 74 5f 52 65 73 6f 75 72 63 65 4d 61 6e 61 67 65 72 } //01 00  get_ResourceManager
		$a_00_9 = {24 36 65 35 62 39 36 39 32 2d 66 39 34 64 2d 34 62 64 30 2d 62 39 65 37 2d 32 38 35 32 33 37 30 64 65 64 64 34 } //00 00  $6e5b9692-f94d-4bd0-b9e7-2852370dedd4
	condition:
		any of ($a_*)
