...
rule Trojan_BAT_SnakeKeylogger_DD_MTB{
	...
	strings :
		$a_81_0 = {24 62 36 38 36 33 32 39 35 2d 32 38 37 38 2d 34 64 34 61 2d 39 65 62 62 2d 62 30 62 64 35 34 32 31 36 30 30 33 } //20 $b6863295-2878-4d4a-9ebb-b0bd54216003
		$a_81_1 = {41 6c 61 72 6d 43 6c 6f 63 6b 2e 52 65 73 6f 75 72 63 65 73 2e 72 65 73 6f 75 72 63 65 73 } //1 AlarmClock.Resources.resources
