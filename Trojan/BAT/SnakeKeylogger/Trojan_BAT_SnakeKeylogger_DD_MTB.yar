...
rule Trojan_BAT_SnakeKeylogger_DD_MTB{
	meta:
		description = "Trojan:BAT/SnakeKeylogger.DD!MTB,SIGNATURE_TYPE_PEHSTR_EXT,18 00 18 00 0b 00 00 14 00 "
		
	strings :
		$a_81_0 = {24 62 36 38 36 33 32 39 35 2d 32 38 37 38 2d 34 64 34 61 2d 39 65 62 62 2d 62 30 62 64 35 34 32 31 36 30 30 33 } //01 00  $b6863295-2878-4d4a-9ebb-b0bd54216003
