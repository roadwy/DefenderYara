...
rule Trojan_BAT_SnakeKeyLogger_RDM_MTB{
	...
	strings :
		$a_01_0 = {48 42 20 37 36 36 } //01 00  HB 766
		...
		$a_01_3 = {62 35 39 64 31 30 61 30 2d 33 66 34 39 2d 34 33 34 38 2d 62 66 64 65 2d 32 37 32 63 39 32 61 32 31 32 66 36 } //00 00  b59d10a0-3f49-4348-bfde-272c92a212f6
	condition:
		any of ($a_*)
