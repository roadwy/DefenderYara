...
rule Trojan_BAT_DiscordStealer_XO_MTB{
	...
	strings :
		$a_01_0 = {4c 69 6d 65 72 42 6f 79 2f 53 74 6f 72 6d 4b 69 74 74 79 } //01 00 
		...
		$a_01_3 = {46 75 63 6b 2e 54 68 61 74 2e 42 69 74 63 68 2e 4b 61 72 65 6e 2e 49 2e 54 61 6b 65 2e 48 65 72 2e 54 6f 2e 43 6f 75 72 74 } //01 00 
		$a_01_4 = {49 6e 76 6f 6b 65 } //01 00 
		$a_01_5 = {44 65 63 72 79 70 74 44 69 73 63 6f 72 64 54 6f 6b 65 6e } //01 00 
