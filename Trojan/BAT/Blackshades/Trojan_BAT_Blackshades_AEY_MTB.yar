...
rule Trojan_BAT_Blackshades_AEY_MTB{
	...
	strings :
		...
		$a_01_1 = {67 65 74 53 74 72 65 61 6d 42 79 74 65 73 58 } //01 00  getStreamBytesX
		$a_01_2 = {67 00 61 00 67 00 61 00 65 00 68 00 67 00 68 00 66 00 78 00 68 00 66 00 78 00 } //01 00  gagaehghfxhfx
		$a_01_3 = {46 72 6f 6d 42 61 73 65 36 34 53 74 72 69 6e 67 } //01 00  FromBase64String
		$a_01_4 = {61 00 6e 00 61 00 67 00 61 00 } //00 00  anaga
	condition:
		any of ($a_*)
