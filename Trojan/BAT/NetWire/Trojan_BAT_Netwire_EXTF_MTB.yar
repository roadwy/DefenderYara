...
rule Trojan_BAT_Netwire_EXTF_MTB{
	...
	strings :
		...
		$a_01_1 = {5a 00 45 00 72 00 6f 00 4b 00 61 00 52 00 75 00 6e 00 } //01 00  ZEroKaRun
		$a_01_2 = {49 00 69 00 61 00 6d 00 73 00 4c 00 61 00 61 00 4f 00 } //01 00  IiamsLaaO
