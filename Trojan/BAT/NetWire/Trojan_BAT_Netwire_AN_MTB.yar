...
rule Trojan_BAT_Netwire_AN_MTB{
	...
	strings :
		$a_03_0 = {13 09 11 0a 6f 90 01 01 00 00 0a 13 0b 2b 19 11 0a 11 09 6f 90 01 01 00 00 0a 0d 08 09 28 90 01 01 00 00 0a d6 0c 11 09 17 d6 13 09 11 09 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_BAT_Netwire_AN_MTB_2{
	...
	strings :
		$a_03_0 = {70 18 8d 17 00 00 01 25 16 72 90 01 03 70 a2 25 17 72 90 01 03 70 a2 14 14 14 28 90 00 } //2
