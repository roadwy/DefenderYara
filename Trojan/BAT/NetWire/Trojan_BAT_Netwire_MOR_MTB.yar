...
rule Trojan_BAT_Netwire_MOR_MTB{
	...
	strings :
		...
		$a_03_3 = {17 8d 59 00 00 01 25 16 1f 20 9d 28 90 01 03 0a 20 00 01 00 00 14 14 17 8d 10 00 00 01 25 16 02 a2 6f 90 01 03 0a 74 30 00 00 01 0a 2b 00 06 2a 90 00 } //7
	condition:
