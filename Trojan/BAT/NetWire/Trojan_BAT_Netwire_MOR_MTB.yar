...
rule Trojan_BAT_Netwire_MOR_MTB{
	...
	strings :
		$a_81_0 = {47 65 74 54 79 70 65 } //01 00 
		$a_81_1 = {47 65 74 45 78 70 6f 72 74 65 64 54 79 70 65 73 } //01 00 
		$a_81_2 = {46 72 6f 6d 42 61 73 65 36 34 53 74 72 69 6e 67 } //07 00 
