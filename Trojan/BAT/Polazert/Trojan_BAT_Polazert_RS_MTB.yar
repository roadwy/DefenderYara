...
rule Trojan_BAT_Polazert_RS_MTB{
	...
	strings :
		$a_01_0 = {7a 00 6b 00 61 00 62 00 73 00 72 00 } //01 00  zkabsr
		...
		$a_01_4 = {4b 65 79 56 61 6c 75 65 50 61 69 72 } //01 00  KeyValuePair
		$a_01_5 = {46 72 6f 6d 42 61 73 65 36 34 53 74 72 69 6e 67 } //01 00  FromBase64String
		$a_01_6 = {67 65 74 5f 4d 61 63 68 69 6e 65 4e 61 6d 65 } //00 00  get_MachineName
	condition:
		any of ($a_*)
