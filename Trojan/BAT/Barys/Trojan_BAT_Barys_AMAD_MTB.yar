...
rule Trojan_BAT_Barys_AMAD_MTB{
	...
	strings :
		$a_03_0 = {0a 06 06 6f 90 01 01 00 00 0a 06 6f 90 01 01 00 00 0a 6f 90 01 01 00 00 0a 13 04 73 90 01 01 00 00 0a 0b 07 11 04 17 73 90 01 01 00 00 0a 0c 28 90 01 02 00 06 16 9a 75 90 01 01 00 00 1b 0d 08 09 16 09 8e 69 6f 90 01 01 00 00 0a 07 6f 90 01 01 00 00 0a 13 05 de 18 90 00 } //1
