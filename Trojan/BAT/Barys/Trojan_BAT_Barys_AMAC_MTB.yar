...
rule Trojan_BAT_Barys_AMAC_MTB{
	...
	strings :
		$a_03_0 = {06 20 00 01 00 00 6f 90 01 01 00 00 0a 06 72 90 01 04 28 90 01 01 00 00 0a 6f 90 01 01 00 00 0a 06 72 90 01 04 28 90 01 01 00 00 0a 6f 90 01 01 00 00 0a 06 06 6f 90 01 01 00 00 0a 06 6f 90 01 01 00 00 0a 6f 90 01 01 00 00 0a 0b 73 90 01 01 00 00 0a 0c 90 00 } //1
