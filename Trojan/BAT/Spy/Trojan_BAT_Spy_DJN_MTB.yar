...
rule Trojan_BAT_Spy_DJN_MTB{
	...
	strings :
		...
		$a_81_11 = {67 65 74 5f 53 63 61 6e 57 61 6c 6c 65 74 73 } //1 get_ScanWallets
		$a_81_12 = {53 63 61 6e 44 69 73 63 6f 72 64 } //1 ScanDiscord
		$a_81_13 = {53 63 61 6e 56 50 4e } //1 ScanVPN
	condition:
