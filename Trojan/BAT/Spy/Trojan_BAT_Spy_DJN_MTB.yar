...
rule Trojan_BAT_Spy_DJN_MTB{
	meta:
		description = "Trojan:BAT/Spy.DJN!MTB,SIGNATURE_TYPE_PEHSTR_EXT,0e 00 0e 00 0e 00 00 01 00 "
	...
	strings :
		...
		$a_81_10 = {53 63 61 6e 6e 65 64 43 6f 6f 6b 69 65 } //01 00  ScannedCookie
		$a_81_11 = {67 65 74 5f 53 63 61 6e 57 61 6c 6c 65 74 73 } //01 00  get_ScanWallets
		$a_81_12 = {53 63 61 6e 44 69 73 63 6f 72 64 } //01 00  ScanDiscord
		$a_81_13 = {53 63 61 6e 56 50 4e } //00 00  ScanVPN
	condition:
		any of ($a_*)
