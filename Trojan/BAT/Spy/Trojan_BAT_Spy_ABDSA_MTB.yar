...
rule Trojan_BAT_Spy_ABDSA_MTB{
	...
	strings :
		...
		$a_01_1 = {49 43 6f 72 65 } //01 00  ICore
		$a_01_2 = {50 61 72 61 6c 6c 65 6c 4c 6f 6f 70 52 65 73 75 6c 74 } //01 00  ParallelLoopResult
		$a_01_3 = {44 69 73 70 6f 73 65 } //01 00  Dispose
		$a_01_4 = {44 69 73 70 6f 73 69 74 69 6f 6e } //00 00  Disposition
	condition:
		any of ($a_*)
