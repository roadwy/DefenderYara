...
rule Trojan_BAT_Spy_Keylogger_OQ{
	...
	strings :
		$a_02_0 = {02 1f 43 fe 01 5f 2c 19 7e 90 01 03 04 72 90 01 03 70 28 90 01 03 0a 80 90 01 03 04 38 fc 35 00 00 28 90 01 03 06 6f 90 01 03 0a 6f 90 01 03 0a 02 1f 56 fe 01 5f 2c 19 7e 90 01 03 04 72 90 01 03 70 90 00 } //10
		...
		$a_02_4 = {5c 54 6d 70 90 01 04 2e 65 78 65 90 00 } //4
