...
rule Trojan_BAT_LokiBot_FK_MTB{
	...
	strings :
		$a_01_0 = {57 b5 a2 3d 09 07 00 00 00 00 00 00 00 00 00 00 01 00 00 00 79 00 00 00 40 00 00 00 5c 00 00 00 36 01 00 00 56 } //10
		$a_01_1 = {24 66 32 36 62 34 35 34 66 2d 39 37 34 35 2d 34 64 35 39 2d 39 30 64 34 2d 33 38 64 30 34 64 39 66 30 39 65 37 } //1 $f26b454f-9745-4d59-90d4-38d04d9f09e7
		...
		$a_01_8 = {41 63 74 69 76 61 74 6f 72 } //1 Activator
	condition:
