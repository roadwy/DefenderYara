...
rule Trojan_BAT_Lokibot_AL_MTB{
	...
	strings :
		$a_03_0 = {09 16 02 7b 90 01 01 00 00 04 a2 09 17 02 7b 90 01 01 00 00 04 a2 09 18 72 90 01 01 72 02 70 a2 11 04 6f 90 01 01 00 00 0a 1a 9a 13 05 11 05 09 13 06 11 06 90 00 } //01 00 
		$a_01_1 = {47 00 69 00 61 00 6f 00 44 00 69 00 65 00 6e 00 } //00 00  GiaoDien
	condition:
		any of ($a_*)
