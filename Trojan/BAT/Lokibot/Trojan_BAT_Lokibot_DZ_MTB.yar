...
rule Trojan_BAT_Lokibot_DZ_MTB{
	meta:
		description = "Trojan:BAT/Lokibot.DZ!MTB,SIGNATURE_TYPE_PEHSTR_EXT,18 00 18 00 0e 00 00 14 00 "
		
	strings :
		$a_00_0 = {24 65 63 31 36 39 38 66 65 2d 35 65 61 37 2d 34 33 65 66 2d 61 65 61 39 2d 62 66 65 30 62 30 35 33 35 63 37 39 } //14 00  $ec1698fe-5ea7-43ef-aea9-bfe0b0535c79
		$a_00_1 = {24 61 35 35 38 61 61 63 33 2d 37 39 34 30 2d 34 39 63 32 2d 62 33 36 34 2d 37 64 39 36 37 65 32 34 31 39 62 35 } //14 00  $a558aac3-7940-49c2-b364-7d967e2419b5
		$a_00_2 = {24 64 61 34 33 66 65 30 64 2d 62 34 61 31 2d 34 66 34 38 2d 61 64 31 35 2d 31 62 39 65 65 33 66 61 62 66 39 34 } //14 00  $da43fe0d-b4a1-4f48-ad15-1b9ee3fabf94
		$a_00_3 = {24 35 65 65 34 39 62 33 32 2d 35 63 35 33 2d 34 64 37 36 2d 38 31 65 33 2d 62 62 32 66 36 30 64 62 36 63 63 63 } //01 00  $5ee49b32-5c53-4d76-81e3-bb2f60db6ccc
