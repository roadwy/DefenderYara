...
rule Trojan_BAT_LokiBot_RPF_MTB{
	...
	strings :
		...
		$a_01_1 = {4d 00 59 00 20 00 44 00 41 00 44 00 20 00 49 00 53 00 20 00 43 00 4f 00 4f 00 4c 00 } //01 00  MY DAD IS COOL
		$a_01_2 = {4e 00 75 00 6d 00 62 00 20 00 49 00 6e 00 20 00 54 00 68 00 65 00 20 00 45 00 6e 00 64 00 } //00 00  Numb In The End
	condition:
		any of ($a_*)
