...
rule Trojan_BAT_Lokibot_EK_MTB{
	...
	strings :
		$a_81_0 = {42 77 6e 76 71 72 6c 2e 64 6c 6c } //01 00 
		$a_81_1 = {56 63 63 73 70 71 6d 6f 66 75 63 65 6c } //01 00 
		$a_81_2 = {49 78 73 6e 62 6f 74 73 66 } //01 00 
		...
		$a_81_6 = {43 6f 6e 76 65 72 74 } //00 00 
	condition:
		any of ($a_*)
