...
rule Trojan_BAT_Lokibot_EG_MTB{
	...
	strings :
		$a_00_0 = {24 61 66 36 65 61 37 32 64 2d 62 34 30 37 2d 34 31 65 64 2d 38 32 64 34 2d 61 33 64 32 62 64 35 65 36 62 34 38 } //20 $af6ea72d-b407-41ed-82d4-a3d2bd5e6b48
