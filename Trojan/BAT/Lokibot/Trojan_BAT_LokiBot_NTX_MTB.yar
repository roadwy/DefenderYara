...
rule Trojan_BAT_LokiBot_NTX_MTB{
	...
	strings :
		...
		$a_81_2 = {55 42 59 48 4e 59 47 56 54 42 46 56 54 52 } //01 00 
		...
		$a_81_6 = {44 65 62 75 67 67 65 72 4e 6f 6e 55 73 65 72 43 6f 64 65 41 74 74 72 69 62 75 74 65 } //00 00 
	condition:
		any of ($a_*)
