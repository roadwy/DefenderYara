...
rule Trojan_BAT_LokiBot_NUX_MTB{
	...
	strings :
		...
		$a_01_1 = {24 39 65 37 31 39 30 63 32 2d 31 66 35 65 2d 34 61 66 61 2d 62 61 30 39 2d 38 61 63 39 39 36 65 61 36 64 37 62 } //01 00 
		$a_01_2 = {54 79 70 69 6e 67 47 61 6d 65 2e 46 6f 72 6d 31 } //00 00 
	condition:
		any of ($a_*)
