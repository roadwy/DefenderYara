...
rule Trojan_BAT_Lokibot_DV_MTB{
	meta:
		description = "Trojan:BAT/Lokibot.DV!MTB,SIGNATURE_TYPE_PEHSTR_EXT,18 00 18 00 0b 00 00 14 00 "
		
	strings :
		$a_00_0 = {24 64 30 33 37 65 36 63 62 2d 62 38 32 32 2d 34 30 31 34 2d 61 34 38 64 2d 63 36 37 32 63 63 31 64 35 33 30 31 } //01 00  $d037e6cb-b822-4014-a48d-c672cc1d5301
