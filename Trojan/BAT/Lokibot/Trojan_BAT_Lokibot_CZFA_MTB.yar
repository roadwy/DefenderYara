...
rule Trojan_BAT_Lokibot_CZFA_MTB{
	...
	strings :
		$a_03_0 = {0b 07 1f 16 8d 90 01 03 01 25 d0 90 01 03 04 28 90 01 03 0a 6f 90 01 03 0a 0c 73 90 01 03 0a 0d 09 08 6f 90 01 03 0a 00 09 18 6f 90 01 03 0a 00 09 6f 90 01 03 0a 06 16 06 8e 69 90 00 } //2
