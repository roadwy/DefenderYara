...
rule Trojan_BAT_LokiBot_FN_MTB{
	...
	strings :
		...
		$a_01_2 = {24 34 39 66 65 32 34 38 35 2d 31 63 33 63 2d 34 32 66 65 2d 62 61 66 64 2d 39 35 61 61 30 38 31 34 63 33 31 66 } //01 00 
		$a_81_3 = {53 74 61 72 5f 57 61 72 73 5f 54 68 65 5f 45 6d 70 69 72 65 5f 53 74 72 69 6b 65 73 5f 42 61 63 6b 5f 69 63 6f 6e } //01 00 
		$a_01_4 = {58 43 43 56 56 } //01 00 
