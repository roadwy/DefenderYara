...
rule Trojan_BAT_Lokibot_DS_MTB{
	...
	strings :
		$a_00_0 = {24 64 30 64 35 61 66 36 37 2d 66 39 30 66 2d 34 64 37 33 2d 38 65 65 30 2d 39 64 37 65 66 35 36 32 32 30 66 37 } //20 $d0d5af67-f90f-4d73-8ee0-9d7ef56220f7
		...
		$a_01_2 = {44 65 62 75 67 67 65 72 42 72 6f 77 73 61 62 6c 65 41 74 74 72 69 62 75 74 65 } //1 DebuggerBrowsableAttribute
		...
		$a_01_10 = {41 63 74 69 76 61 74 6f 72 } //1 Activator
	condition:
