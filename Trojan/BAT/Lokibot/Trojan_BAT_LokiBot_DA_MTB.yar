...
rule Trojan_BAT_LokiBot_DA_MTB{
	...
	strings :
		...
		$a_81_1 = {53 68 6f 70 5f 4d 61 6e 61 67 65 72 } //01 00 
...
rule Trojan_BAT_LokiBot_DA_MTB_2{
	...
	strings :
		$a_81_0 = {24 35 64 33 66 36 64 61 34 2d 62 66 62 38 2d 34 30 31 61 2d 39 65 65 38 2d 62 66 34 64 33 66 64 61 30 62 32 34 } //14 00 
		$a_81_1 = {24 61 65 63 33 31 37 32 61 2d 30 38 32 30 2d 34 62 38 37 2d 62 66 36 31 2d 38 38 61 61 65 64 33 37 34 63 33 36 } //01 00 
		$a_81_2 = {53 63 68 6f 6f 6c 42 6f 6f 6b 4d 61 6e 61 67 65 72 2e 52 65 73 6f 75 72 63 65 73 2e 72 65 73 6f 75 72 63 65 73 } //01 00 
		$a_81_3 = {57 69 6e 4d 61 69 6e 2e 4d 79 2e 52 65 73 6f 75 72 63 65 73 } //01 00 
		...
		$a_81_11 = {43 72 65 61 74 65 49 6e 73 74 61 6e 63 65 } //01 00 
