...
rule Trojan_BAT_Lokibot_MBDE_MTB{
	...
	strings :
		...
		$a_01_1 = {62 34 62 38 32 61 32 66 2d 64 63 33 34 2d 34 61 61 39 2d 62 32 33 37 2d 64 33 30 31 37 65 63 38 62 65 65 65 } //00 00  b4b82a2f-dc34-4aa9-b237-d3017ec8beee
	condition:
		any of ($a_*)
