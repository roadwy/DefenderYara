...
rule Trojan_BAT_Lokibot_MBDE_MTB{
	...
	strings :
		$a_03_0 = {38 d5 01 00 00 06 07 02 7b 90 01 01 00 00 04 08 6f 90 01 01 00 00 0a 6f 90 01 01 00 00 06 28 90 01 01 00 00 06 5a 02 7b 90 01 01 00 00 04 08 6f 90 01 01 00 00 0a 6f 90 01 01 00 00 06 90 00 } //1
