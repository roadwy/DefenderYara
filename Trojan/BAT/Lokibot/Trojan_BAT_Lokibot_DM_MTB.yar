...
rule Trojan_BAT_Lokibot_DM_MTB{
	...
	strings :
		$a_00_0 = {24 62 36 66 62 31 36 37 64 2d 34 63 62 30 2d 34 65 61 63 2d 39 65 66 33 2d 38 33 61 32 61 63 66 39 39 62 65 32 } //20 $b6fb167d-4cb0-4eac-9ef3-83a2acf99be2
