...
rule Trojan_BAT_Lokibot_EJ_MTB{
	...
	strings :
		...
		$a_81_1 = {45 65 67 72 44 6f 77 45 65 67 72 6e 6c 45 65 67 72 6f 61 64 44 45 65 67 72 61 74 61 45 65 67 72 } //01 00  EegrDowEegrnlEegroadDEegrataEegr
		...
		$a_81_6 = {42 75 6c 6b 20 45 6d 61 69 6c 20 53 6f 66 74 77 61 72 65 } //00 00  Bulk Email Software
	condition:
		any of ($a_*)
