...
rule Trojan_BAT_LokiBot_XNFA_MTB{
	...
	strings :
		$a_03_0 = {20 00 01 00 00 6f ?? ?? ?? 0a 09 08 6f ?? ?? ?? 0a 09 18 6f ?? ?? ?? 0a 09 6f ?? ?? ?? 0a 06 16 06 8e 69 6f ?? ?? ?? 0a 13 04 11 04 28 ?? ?? ?? 06 74 6b 00 00 01 6f ?? ?? ?? 0a 17 9a 80 48 00 00 04 23 e2 e6 54 32 00 00 46 40 } //1
