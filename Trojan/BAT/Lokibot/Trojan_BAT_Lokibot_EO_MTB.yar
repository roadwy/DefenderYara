...
rule Trojan_BAT_Lokibot_EO_MTB{
	meta:
		description = "Trojan:BAT/Lokibot.EO!MTB,SIGNATURE_TYPE_PEHSTR_EXT,18 00 18 00 0a 00 00 14 00 "
		
	strings :
		$a_81_0 = {24 62 30 64 37 37 32 34 64 2d 64 39 38 38 2d 34 34 36 32 2d 39 31 64 65 2d 31 33 36 39 36 62 62 65 63 32 39 37 } //01 00  $b0d7724d-d988-4462-91de-13696bbec297
