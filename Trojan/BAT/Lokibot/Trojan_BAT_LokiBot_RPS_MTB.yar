...
rule Trojan_BAT_LokiBot_RPS_MTB_2{
	...
	strings :
		$a_01_0 = {37 00 36 00 34 00 38 00 48 00 32 00 38 00 } //01 00 
		$a_01_1 = {46 00 35 00 45 00 4a 00 34 00 38 00 46 00 46 00 47 00 48 00 55 00 35 00 35 00 54 00 36 00 } //01 00 
		$a_01_2 = {38 00 33 00 37 00 34 00 37 00 } //01 00 
		$a_01_3 = {4c 6f 6f 70 53 74 61 74 65 33 32 } //01 00 
		$a_01_4 = {47 00 61 00 6d 00 65 00 46 00 6f 00 72 00 53 00 65 00 6d 00 65 00 73 00 74 00 72 00 } //00 00 
	condition:
		any of ($a_*)
