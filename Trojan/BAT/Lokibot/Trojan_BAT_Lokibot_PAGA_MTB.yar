...
rule Trojan_BAT_Lokibot_PAGA_MTB{
	...
	strings :
		$a_03_0 = {0d 09 08 6f 90 01 03 0a 00 09 18 6f 90 01 03 0a 00 09 6f 90 01 03 0a 06 16 06 8e 69 6f 90 01 03 0a 13 04 11 04 03 28 90 01 03 06 28 90 01 03 06 90 00 } //2
