...
rule Trojan_BAT_LokiBot_CXJK_MTB_2{
	...
	strings :
		...
		$a_01_2 = {7c 00 7c 00 30 00 41 00 36 00 46 00 31 00 7c 00 7c 00 7c 00 41 00 37 00 } //01 00 
		$a_01_3 = {30 00 42 00 32 00 42 00 7c 00 31 00 31 00 30 00 42 00 32 00 41 00 7c 00 } //00 00 
	condition:
		any of ($a_*)
