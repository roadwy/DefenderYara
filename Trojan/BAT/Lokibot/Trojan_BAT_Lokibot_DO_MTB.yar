...
rule Trojan_BAT_Lokibot_DO_MTB{
	meta:
		description = "Trojan:BAT/Lokibot.DO!MTB,SIGNATURE_TYPE_PEHSTR_EXT,18 00 18 00 0d 00 00 "
		
	strings :
		$a_00_0 = {24 34 64 34 62 63 65 38 33 2d 35 32 64 34 2d 34 62 35 39 2d 38 34 36 35 2d 31 30 62 38 39 30 33 33 34 38 63 62 } //20 $4d4bce83-52d4-4b59-8465-10b8903348cb
		$a_00_1 = {24 39 34 38 34 61 35 62 39 2d 38 35 31 32 2d 34 34 33 64 2d 62 32 39 62 2d 37 32 66 34 64 31 32 65 62 63 37 37 } //20 $9484a5b9-8512-443d-b29b-72f4d12ebc77
		$a_00_2 = {24 39 33 33 31 66 36 65 30 2d 65 39 63 39 2d 34 37 62 35 2d 61 37 35 63 2d 37 34 36 63 35 38 37 62 30 66 66 38 } //20 $9331f6e0-e9c9-47b5-a75c-746c587b0ff8
