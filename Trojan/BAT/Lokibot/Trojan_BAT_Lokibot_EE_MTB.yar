...
rule Trojan_BAT_Lokibot_EE_MTB{
	meta:
		description = "Trojan:BAT/Lokibot.EE!MTB,SIGNATURE_TYPE_PEHSTR_EXT,18 00 18 00 0c 00 00 "
		
	strings :
		$a_00_0 = {24 31 66 61 35 38 65 64 37 2d 66 61 34 62 2d 34 66 33 32 2d 61 66 32 38 2d 32 39 32 66 63 33 36 61 33 65 31 35 } //20 $1fa58ed7-fa4b-4f32-af28-292fc36a3e15
		$a_00_1 = {24 66 35 34 32 64 62 39 36 2d 36 38 64 32 2d 34 33 37 63 2d 61 33 62 32 2d 30 30 62 62 63 65 63 65 38 35 61 65 } //20 $f542db96-68d2-437c-a3b2-00bbcece85ae
