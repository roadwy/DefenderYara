...
rule Trojan_BAT_Lokibot_AGJD_MTB{
	...
	strings :
		...
		$a_01_1 = {4d 00 69 00 63 00 72 00 6f 00 73 00 6f 00 66 00 74 00 2e 00 54 00 65 00 72 00 6d 00 69 00 6e 00 61 00 6c 00 2e 00 57 00 70 00 66 00 2e 00 64 00 6c 00 6c 00 } //00 00 
	condition:
		any of ($a_*)
