...
rule Trojan_BAT_Lokibot_ABVF_MTB{
	...
	strings :
		$a_03_0 = {72 01 00 00 70 28 ?? 00 00 0a 08 28 ?? 00 00 0a 6f ?? 00 00 0a 14 17 8d ?? 00 00 01 25 16 07 a2 6f ?? 00 00 0a 75 ?? 00 00 1b 08 28 ?? 00 00 0a 28 ?? 00 00 2b 28 ?? 00 00 2b 2a } //4
