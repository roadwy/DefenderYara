...
rule Trojan_BAT_Lokibot_DY_MTB{
	meta:
		description = "Trojan:BAT/Lokibot.DY!MTB,SIGNATURE_TYPE_PEHSTR_EXT,18 00 18 00 0b 00 00 14 00 "
		
	strings :
		$a_00_0 = {24 64 35 35 66 63 36 65 32 2d 64 39 35 61 2d 34 66 37 36 2d 39 31 65 63 2d 63 62 38 38 34 65 65 38 30 39 35 38 } //01 00  $d55fc6e2-d95a-4f76-91ec-cb884ee80958
