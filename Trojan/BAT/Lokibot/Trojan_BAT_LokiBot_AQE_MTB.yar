...
rule Trojan_BAT_LokiBot_AQE_MTB{
	...
	strings :
		$a_03_0 = {16 9a 14 19 8d 90 01 03 01 25 16 28 90 01 03 06 a2 25 17 28 90 01 03 06 a2 25 18 90 01 05 28 90 01 03 06 a2 14 6f 90 01 03 0a 20 00 08 00 00 2a 90 00 } //10
