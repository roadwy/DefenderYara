...
rule Trojan_BAT_Lokibot_DR_MTB{
	meta:
		description = "Trojan:BAT/Lokibot.DR!MTB,SIGNATURE_TYPE_PEHSTR_EXT,18 00 18 00 0c 00 00 "
		
	strings :
		$a_00_0 = {24 38 63 65 37 33 65 34 66 2d 36 38 35 34 2d 34 38 39 35 2d 38 35 66 37 2d 37 32 65 66 63 32 64 66 30 34 63 66 } //20 $8ce73e4f-6854-4895-85f7-72efc2df04cf
		$a_00_1 = {24 61 31 38 39 35 30 64 33 2d 33 33 35 66 2d 34 38 33 66 2d 38 38 31 61 2d 31 30 61 33 63 35 37 31 65 36 61 64 } //20 $a18950d3-335f-483f-881a-10a3c571e6ad
