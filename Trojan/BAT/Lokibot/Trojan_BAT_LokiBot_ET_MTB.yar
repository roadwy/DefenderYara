...
rule Trojan_BAT_LokiBot_ET_MTB{
	...
	strings :
		$a_03_0 = {33 00 2e 00 37 00 30 00 2e 00 32 00 34 00 37 00 2e 00 32 00 32 00 39 00 2f 00 63 00 6c 00 61 00 73 00 73 00 2f 00 6c 00 6f 00 61 00 64 00 65 00 72 00 2f 00 75 00 70 00 6c 00 6f 00 61 00 64 00 73 00 2f 00 90 02 50 2e 00 70 00 6e 00 67 00 90 00 } //10
		$a_03_1 = {33 00 2e 00 37 00 30 00 2e 00 32 00 34 00 37 00 2e 00 32 00 32 00 39 00 2f 00 63 00 6c 00 61 00 73 00 73 00 2f 00 6c 00 6f 00 61 00 64 00 65 00 72 00 2f 00 75 00 70 00 6c 00 6f 00 61 00 64 00 73 00 2f 00 90 02 50 2e 00 6a 00 70 00 67 00 90 00 } //10
