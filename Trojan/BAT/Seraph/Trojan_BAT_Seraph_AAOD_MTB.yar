...
rule Trojan_BAT_Seraph_AAOD_MTB{
	...
	strings :
		...
		$a_01_1 = {58 00 45 00 48 00 34 00 4b 00 4a 00 32 00 53 00 4e 00 4f 00 4a 00 63 00 56 00 48 00 69 00 31 00 71 00 6f 00 6d 00 49 00 6b 00 41 00 3d 00 3d 00 } //01 00  XEH4KJ2SNOJcVHi1qomIkA==
