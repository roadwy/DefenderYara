...
rule Trojan_BAT_Seraph_NFS_MTB{
	...
	strings :
		$a_03_0 = {28 0e 00 00 0a 20 90 01 03 00 8d 90 01 03 01 25 d0 90 01 03 04 15 2d 20 26 26 6f 90 01 03 0a 1c 2d 1d 26 07 28 90 01 03 0a 0c 08 16 08 8e 69 28 90 01 03 0a 08 0d 90 00 } //5
