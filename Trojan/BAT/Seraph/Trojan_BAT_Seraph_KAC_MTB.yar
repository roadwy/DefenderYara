...
rule Trojan_BAT_Seraph_KAC_MTB{
	...
	strings :
		$a_03_0 = {11 00 11 02 02 11 02 91 72 90 01 01 00 00 70 28 90 01 01 00 00 0a 59 d2 9c 90 00 } //5
	condition:
		((#a_03_0  & 1)*5) >=5
...
rule Trojan_BAT_Seraph_KAC_MTB_2{
	...
	strings :
		$a_03_0 = {09 11 05 16 6f 90 01 01 00 00 0a 13 06 12 06 28 90 01 01 00 00 0a 13 07 11 04 11 07 6f 90 01 01 00 00 0a 11 05 17 58 13 05 11 05 09 6f 90 01 01 00 00 0a 32 d3 90 00 } //5
