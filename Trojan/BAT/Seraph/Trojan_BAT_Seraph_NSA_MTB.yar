...
rule Trojan_BAT_Seraph_NSA_MTB{
	...
	strings :
		...
		$a_01_1 = {59 7a 70 79 73 7a 72 62 2e 50 72 6f 70 65 72 74 69 65 73 2e 52 65 73 6f 75 72 63 65 73 2e 72 65 73 6f 75 72 63 65 73 } //01 00 
		$a_01_2 = {70 70 62 75 72 61 74 70 } //00 00 
	condition:
		any of ($a_*)
