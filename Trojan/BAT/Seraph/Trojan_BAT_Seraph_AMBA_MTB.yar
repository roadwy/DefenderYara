...
rule Trojan_BAT_Seraph_AMBA_MTB{
	...
	strings :
		$a_03_0 = {11 0a 11 07 11 05 11 07 28 90 01 01 00 00 06 20 90 01 02 00 00 61 d1 9d 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_BAT_Seraph_AMBA_MTB_2{
	...
	strings :
		$a_03_0 = {11 06 11 03 11 01 11 03 91 11 00 59 d2 9c 20 90 01 01 00 00 00 38 90 01 01 ff ff ff 00 90 00 } //5
	condition:
		((#a_03_0  & 1)*5) >=5
