...
rule Trojan_BAT_Seraph_NS_MTB{
	...
	strings :
		...
		$a_01_1 = {44 65 7a 78 67 62 6a } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_BAT_Seraph_NS_MTB_2{
	...
	strings :
		...
		$a_01_1 = {43 75 75 6f 6b 73 62 64 64 2e 50 72 6f 70 65 72 74 69 65 73 2e 52 65 73 6f 75 72 63 65 73 2e 72 65 73 6f 75 72 63 65 73 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_BAT_Seraph_NS_MTB_3{
	...
	strings :
		...
		$a_01_1 = {56 70 77 62 68 6c 75 72 65 75 2e 50 72 6f 70 65 72 74 69 65 73 2e 52 65 73 6f 75 72 63 65 73 2e 72 65 73 6f 75 72 63 65 73 } //00 00 
	condition:
		any of ($a_*)
