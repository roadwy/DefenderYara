...
rule Trojan_BAT_Seraph_ABYE_MTB{
	...
	strings :
		$a_03_0 = {14 16 2c 03 26 2b 2c 0a 2b fb 00 28 ?? 00 00 06 28 ?? 00 00 06 28 ?? 00 00 06 1a 2d 09 26 12 00 1e 2d 06 26 de 0d 0a 2b f5 28 ?? 00 00 06 2b f4 26 de 00 06 2c d4 } //4
