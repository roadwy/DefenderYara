...
rule Trojan_BAT_Seraph_F_MTB{
	...
	strings :
		...
		$a_03_1 = {20 00 01 00 00 5d 0c 07 09 94 13 04 07 09 07 08 94 9e 07 08 11 04 9e 07 07 09 94 07 08 94 58 20 00 01 00 00 5d 94 13 08 11 06 06 90 01 01 06 91 11 08 61 d2 9c 06 17 58 0a 90 00 } //10
	condition:
