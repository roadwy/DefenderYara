...
rule Trojan_BAT_SpyQuasar_MA_MTB{
	...
	strings :
		$a_03_0 = {06 17 6f 2b 90 01 02 0a 06 17 6f 2c 90 01 02 0a 90 0a 4f 00 73 24 00 00 0a 0a 06 72 90 01 01 06 00 70 72 90 01 01 07 00 70 7e 25 00 00 0a 6f 90 01 03 0a 28 90 01 03 0a 6f 90 01 03 0a 8c 24 00 00 01 28 90 01 03 06 28 90 01 03 0a 6f 90 01 03 0a 90 00 } //1
