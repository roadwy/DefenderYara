...
rule Trojan_BAT_CeeInject_AC_bit{
	...
	strings :
		...
		$a_03_1 = {49 6e 76 6f 6b 65 [0-10] 41 70 70 44 6f 6d 61 69 6e 00 67 65 74 5f 43 75 72 72 65 6e 74 44 6f 6d 61 69 6e 00 4c 6f 61 64 00 67 65 74 5f 45 6e 74 72 79 50 6f 69 6e 74 } //1
