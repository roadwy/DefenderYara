...
rule Trojan_BAT_SpySnake_MH_MTB{
	...
	strings :
		$a_03_0 = {08 11 09 07 11 09 9a 1f 10 28 90 01 03 0a 9c 11 09 17 58 13 09 11 09 07 8e 69 fe 04 13 0a 11 0a 2d de 90 00 } //5
	condition:
		((#a_03_0  & 1)*5) >=5
...
rule Trojan_BAT_SpySnake_MH_MTB_2{
	...
	strings :
		$a_03_0 = {0a 06 18 5b 8d 31 00 00 01 0b 16 0c 2b 18 07 08 18 5b 02 08 18 6f 90 01 03 0a 1f 10 28 90 01 03 0a 9c 08 18 58 0c 08 06 32 e4 90 00 } //5
...
rule Trojan_BAT_SpySnake_MH_MTB_3{
	...
	strings :
		...
		$a_03_6 = {19 8d 0a 00 00 01 25 16 72 17 00 00 70 a2 25 17 72 5d 00 00 70 a2 25 18 07 06 28 90 01 03 06 a2 0c 20 05 00 00 00 38 90 00 } //1
	condition:
