...
rule Trojan_BAT_SpySnake_MB_MTB{
	...
	strings :
		...
		$a_01_1 = {39 63 35 35 30 66 30 32 2d 37 65 66 61 2d 34 65 63 39 2d 38 33 37 35 2d 31 35 34 33 36 37 62 39 61 36 30 36 } //01 00 
		$a_01_2 = {44 65 62 75 67 67 61 62 6c 65 41 74 74 72 69 62 75 74 65 } //01 00 
		$a_01_3 = {49 6e 76 6f 6b 65 } //01 00 
		$a_01_4 = {6d 77 4d 42 33 74 34 37 6f 64 59 77 56 51 62 45 54 4f } //01 00 
		$a_01_5 = {53 00 74 00 61 00 74 00 5f 00 57 00 61 00 72 00 6e 00 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_BAT_SpySnake_MB_MTB_2{
	...
	strings :
		...
		$a_01_1 = {37 34 38 30 32 64 39 65 2d 36 33 35 65 2d 34 62 35 38 2d 62 61 30 39 2d 62 35 66 35 36 38 61 65 38 34 36 65 } //05 00 
		$a_01_2 = {47 61 6d 65 49 6e 74 65 72 66 61 63 65 2e 50 72 6f 70 65 72 74 69 65 73 } //05 00 
		$a_01_3 = {45 78 30 35 2e 47 61 6d 65 49 6e 74 65 72 66 61 63 65 } //01 00 
		$a_01_4 = {54 69 63 54 61 63 54 6f 65 42 75 74 74 6f 6e } //01 00 
		$a_01_5 = {43 68 65 63 6b 52 69 67 68 74 4c 65 66 74 44 69 61 67 6f 6e 61 6c 53 74 61 74 65 } //01 00 
		$a_01_6 = {4f 4b 49 4a 55 48 59 47 54 46 } //00 00 
	condition:
		any of ($a_*)
