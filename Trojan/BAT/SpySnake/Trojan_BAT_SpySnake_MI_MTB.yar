...
rule Trojan_BAT_SpySnake_MI_MTB{
	...
	strings :
		...
		$a_01_1 = {53 38 61 62 69 6c 69 38 79 } //01 00 
		$a_01_2 = {67 65 74 5f 47 65 74 50 61 74 63 68 } //01 00 
		$a_01_3 = {52 35 63 6f 6d 6d 35 6e 64 } //01 00 
		$a_01_4 = {58 00 6f 00 78 00 6f 00 54 00 6f 00 72 00 2e 00 65 00 78 00 65 00 } //00 00 
	condition:
		any of ($a_*)
