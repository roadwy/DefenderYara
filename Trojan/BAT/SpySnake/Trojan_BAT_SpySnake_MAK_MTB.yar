...
rule Trojan_BAT_SpySnake_MAK_MTB{
	...
	strings :
		$a_03_0 = {06 07 2b 03 00 2b 07 6f ?? ?? ?? 0a 2b f6 07 6f ?? ?? ?? 0a 0c de 11 07 2b 08 07 6f ?? ?? ?? 0a 2b 04 2c 03 2b f4 00 dc 08 2a } //1
		...
		$a_03_5 = {63 00 64 00 6e 00 2e 00 64 00 69 00 73 00 63 00 6f 00 72 00 64 00 61 00 70 00 70 00 2e 00 63 00 6f 00 6d 00 2f 00 61 00 74 00 74 00 61 00 63 00 68 00 6d 00 65 00 6e 00 74 00 73 00 2f 00 39 00 38 00 31 00 31 00 30 00 36 00 30 00 38 00 33 00 34 00 35 00 34 00 31 00 32 00 34 00 30 00 37 00 35 00 [0-80] 2e 00 6a 00 70 00 67 00 } //1
