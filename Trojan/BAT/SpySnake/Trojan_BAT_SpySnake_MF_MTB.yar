...
rule Trojan_BAT_SpySnake_MF_MTB{
	...
	strings :
		...
		$a_01_1 = {52 61 63 65 5f 54 72 61 63 6b 2e 50 72 6f 70 65 72 74 69 65 73 } //03 00 
		$a_01_2 = {34 66 66 64 37 38 31 35 2d 35 39 61 37 2d 34 64 36 65 2d 61 38 31 31 2d 36 66 31 61 32 37 63 33 63 65 38 38 } //03 00 
		$a_01_3 = {59 66 65 66 66 65 65 66 66 65 66 65 61 } //03 00 
		$a_01_4 = {43 6f 6e 74 72 6f 6c 43 6f 6c 6c 65 63 74 69 6f 6e } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_BAT_SpySnake_MF_MTB_2{
	...
	strings :
		...
		$a_01_1 = {4e 52 5f 44 4b 51 4f 44 4b 57 51 4f 52 } //01 00 
		$a_01_2 = {4e 52 5f 44 35 36 36 35 } //01 00 
		$a_01_3 = {4e 52 5f 4b 6f 6c 61 73 69 6e } //01 00 
		$a_01_4 = {4e 52 5f 44 65 74 72 6f 69 74 53 61 74 61 72 } //01 00 
		$a_01_5 = {53 55 50 45 52 5f 4c 4f 4b 45 52 } //01 00 
		$a_01_6 = {52 65 70 6c 61 63 65 } //01 00 
		$a_01_7 = {44 65 62 75 67 67 61 62 6c 65 41 74 74 72 69 62 75 74 65 } //01 00 
		$a_01_8 = {67 65 74 5f 56 61 6c 75 65 } //01 00 
		$a_01_9 = {44 6f 77 6e 6c 6f 61 64 53 74 72 69 6e 67 } //00 00 
	condition:
		any of ($a_*)
