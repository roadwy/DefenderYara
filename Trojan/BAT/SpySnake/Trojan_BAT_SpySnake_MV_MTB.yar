...
rule Trojan_BAT_SpySnake_MV_MTB{
	meta:
		description = "Trojan:BAT/SpySnake.MV!MTB,SIGNATURE_TYPE_PEHSTR_EXT,18 00 18 00 05 00 00 0a 00 "
		
	strings :
		$a_01_0 = {0a 02 8e 69 18 5a 06 8e 69 58 0b 2b 3b 02 07 02 8e 69 5d 02 07 02 8e 69 5d 91 06 07 06 8e 69 5d 91 61 } //05 00 
		$a_01_1 = {57 17 a2 0b 09 07 00 00 00 fa 01 33 00 16 00 00 01 00 00 00 68 00 00 00 21 00 00 00 45 00 00 00 74 } //05 00 
		$a_01_2 = {47 61 6d 65 5f 77 69 6e 66 6f 72 6d 2e 50 72 6f 70 65 72 74 69 65 73 } //02 00  Game_winform.Properties
		$a_01_3 = {43 6f 6e 74 72 6f 6c 43 6f 6c 6c 65 63 74 69 6f 6e } //02 00  ControlCollection
...
rule Trojan_BAT_SpySnake_MV_MTB_2{
	meta:
		description = "Trojan:BAT/SpySnake.MV!MTB,SIGNATURE_TYPE_PEHSTR_EXT,0c 00 0c 00 03 00 00 05 00 "
	...
	strings :
		...
		$a_03_2 = {13 0d 11 0d 72 f7 03 0c 70 28 90 01 03 0a 13 0d 11 0d 72 e7 03 0c 70 28 90 01 03 0a 13 0d 11 0d 72 cb 04 0c 70 28 90 01 03 0a 13 0d 11 0d 72 ff 03 0c 70 28 90 01 03 0a 13 0d 11 0d 72 cb 04 0c 70 28 90 01 03 0a 13 0d 11 0d 72 cf 04 0c 70 90 00 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_BAT_SpySnake_MV_MTB_3{
	meta:
		description = "Trojan:BAT/SpySnake.MV!MTB,SIGNATURE_TYPE_PEHSTR_EXT,09 00 09 00 09 00 00 01 00 "
	...
	strings :
		...
		$a_01_6 = {4b 69 6e 67 73 74 6f 6e } //01 00  Kingston
