...
rule Trojan_BAT_SpySnake_MV_MTB_2{
	...
	strings :
		...
		$a_03_2 = {13 0d 11 0d 72 f7 03 0c 70 28 ?? ?? ?? 0a 13 0d 11 0d 72 e7 03 0c 70 28 ?? ?? ?? 0a 13 0d 11 0d 72 cb 04 0c 70 28 ?? ?? ?? 0a 13 0d 11 0d 72 ff 03 0c 70 28 ?? ?? ?? 0a 13 0d 11 0d 72 cb 04 0c 70 28 ?? ?? ?? 0a 13 0d 11 0d 72 cf 04 0c 70 } //2
	condition:
