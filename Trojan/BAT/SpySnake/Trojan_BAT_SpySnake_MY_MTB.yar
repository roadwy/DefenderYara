...
rule Trojan_BAT_SpySnake_MY_MTB{
	...
	strings :
		$a_03_0 = {07 11 06 06 11 06 9a 1f 10 28 90 01 03 0a 9c 11 06 17 58 13 06 11 06 06 8e 69 fe 04 13 07 11 07 2d de 90 00 } //2
...
rule Trojan_BAT_SpySnake_MY_MTB_2{
	...
	strings :
		$a_03_0 = {17 9a a2 25 18 72 90 01 03 70 a2 0c 02 14 72 90 01 03 70 18 8d 90 01 03 01 25 16 16 8c 90 01 03 01 a2 25 17 08 a2 25 13 05 14 14 18 8d 90 01 03 01 25 17 17 9c 25 13 06 17 90 00 } //10
