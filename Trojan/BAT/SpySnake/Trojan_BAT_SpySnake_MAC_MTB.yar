...
rule Trojan_BAT_SpySnake_MAC_MTB{
	...
	strings :
		$a_01_0 = {45 6e 71 75 65 75 65 } //01 00 
		$a_01_1 = {44 65 71 75 65 75 65 } //01 00 
		$a_01_2 = {52 00 73 00 6a 00 68 00 72 00 6b 00 62 00 67 00 74 00 6c 00 71 00 6c 00 75 00 61 00 6f 00 62 00 74 00 6f 00 71 00 61 00 68 00 69 00 72 00 } //01 00 
