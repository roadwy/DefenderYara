...
rule Trojan_BAT_SpySnake_MP_MTB{
	...
	strings :
		...
		$a_01_1 = {53 61 6c 75 74 65 46 6f 72 6d 5f 4d 6f 75 73 65 44 6f 77 6e } //05 00  SaluteForm_MouseDown
		$a_01_2 = {53 74 72 69 6e 67 46 6f 72 6d 61 74 45 78 2e 50 72 6f 70 65 72 74 69 65 73 } //00 00  StringFormatEx.Properties
	condition:
		any of ($a_*)
...
rule Trojan_BAT_SpySnake_MP_MTB_2{
	...
	strings :
		...
		$a_01_1 = {31 30 37 37 37 66 64 34 2d 63 34 30 61 2d 34 64 33 65 2d 39 63 65 36 2d 62 64 38 65 38 31 33 39 65 32 35 34 } //01 00  10777fd4-c40a-4d3e-9ce6-bd8e8139e254
		$a_01_2 = {43 68 65 61 74 4d 65 6e 75 2e 50 72 6f 70 65 72 74 69 65 73 } //01 00  CheatMenu.Properties
		$a_01_3 = {41 6c 6f 72 5f 32 32 } //01 00  Alor_22
		$a_01_4 = {41 6c 6f 72 5f 32 38 } //00 00  Alor_28
	condition:
		any of ($a_*)
