...
rule Trojan_BAT_SpySnake_MU_MTB{
	...
	strings :
		...
		$a_01_1 = {4b 6c 69 65 6e 74 20 64 6f 20 62 6c 69 70 61 } //05 00 
		$a_01_2 = {42 6c 69 70 46 61 63 65 2e 50 72 6f 70 65 72 74 69 65 73 } //01 00 
		$a_01_3 = {68 6f 74 6b 65 79 5f 48 6f 74 6b 65 79 50 72 65 73 73 65 64 } //00 00 
	condition:
		any of ($a_*)
