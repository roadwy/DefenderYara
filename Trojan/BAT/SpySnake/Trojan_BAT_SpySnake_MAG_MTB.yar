...
rule Trojan_BAT_SpySnake_MAG_MTB{
	...
	strings :
		...
		$a_01_4 = {59 00 6b 00 6e 00 62 00 68 00 70 00 73 00 6a 00 6b 00 78 00 69 00 71 00 72 00 7a 00 76 00 79 00 7a 00 61 00 6f 00 76 00 62 00 } //00 00  Yknbhpsjkxiqrzvyzaovb
	condition:
		any of ($a_*)
