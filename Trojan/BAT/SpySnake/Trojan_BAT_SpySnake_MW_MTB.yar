...
rule Trojan_BAT_SpySnake_MW_MTB{
	...
	strings :
		$a_03_0 = {02 07 02 8e 69 5d 02 07 02 8e 69 5d 91 06 07 06 8e 69 5d 91 61 90 01 05 6e 02 07 17 58 02 8e 69 5d 91 90 00 } //10
...
rule Trojan_BAT_SpySnake_MW_MTB_2{
	...
	strings :
		...
		$a_03_2 = {13 0e 11 0e 72 d5 04 0c 70 28 90 01 03 0a 13 0e 11 0e 72 c5 04 0c 70 28 90 01 03 0a 13 0e 11 0e 72 2d 05 0c 70 28 90 01 03 0a 13 0e 11 0e 72 dd 04 0c 70 28 90 01 03 0a 13 0e 11 0e 72 2d 05 0c 70 28 90 01 03 0a 13 0e 11 0e 72 31 05 0c 70 90 00 } //2
	condition:
