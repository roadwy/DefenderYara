...
rule Trojan_BAT_SpySnake_MAQ_MTB{
	...
	strings :
		...
		$a_01_1 = {48 61 6e 64 6c 65 49 6e 63 6f 6d 69 6e 67 43 6f 6e 6e 65 63 74 69 6f 6e 73 } //01 00 
		$a_01_2 = {73 00 68 00 75 00 74 00 64 00 6f 00 77 00 6e 00 20 00 74 00 68 00 65 00 20 00 73 00 65 00 72 00 76 00 65 00 72 00 } //01 00 
		$a_01_3 = {49 41 73 79 6e 63 4c 6f 63 61 6c } //01 00 
