...
rule Trojan_BAT_SpySnake_MAU_MTB{
	...
	strings :
		...
		$a_01_2 = {46 6f 72 6d 53 74 61 72 74 50 6f 73 69 74 69 6f 6e } //01 00 
		$a_01_3 = {4d 61 69 6c 4d 65 73 73 61 67 65 } //01 00 
		$a_01_4 = {4e 65 74 77 6f 72 6b 43 72 65 64 65 6e 74 69 61 6c } //01 00 
		$a_01_5 = {61 64 64 5f 4d 6f 75 73 65 44 6f 77 6e } //00 00 
	condition:
		any of ($a_*)
