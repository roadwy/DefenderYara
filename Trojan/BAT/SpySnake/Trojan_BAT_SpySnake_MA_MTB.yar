...
rule Trojan_BAT_SpySnake_MA_MTB{
	...
	strings :
		...
		$a_01_1 = {66 69 72 73 74 43 6c 69 63 6b 65 64 } //01 00  firstClicked
		$a_01_2 = {43 72 65 61 74 65 49 6e 73 74 61 6e 63 65 } //01 00  CreateInstance
		$a_01_3 = {54 69 6d 65 72 31 5f 54 69 63 6b } //01 00  Timer1_Tick
		$a_01_4 = {4d 6f 76 65 6d 65 6e 74 54 6f 44 6f 77 6e } //00 00  MovementToDown
	condition:
		any of ($a_*)
...
rule Trojan_BAT_SpySnake_MA_MTB_3{
	...
	strings :
		...
		$a_01_1 = {47 61 6d 65 5f 6f 66 5f 50 69 67 2e 50 72 6f 70 65 72 74 69 65 73 } //05 00  Game_of_Pig.Properties
		$a_01_2 = {46 49 55 53 48 55 49 46 } //05 00  FIUSHUIF
		$a_01_3 = {34 65 37 66 62 62 34 33 2d 64 32 61 65 2d 34 35 36 61 2d 61 64 37 37 2d 34 66 36 38 61 62 61 31 30 31 30 37 } //01 00  4e7fbb43-d2ae-456a-ad77-4f68aba10107
		$a_01_4 = {72 6f 6c 6c 42 75 74 74 6f 6e 5f 43 6c 69 63 6b } //01 00  rollButton_Click
		$a_01_5 = {45 6e 74 65 72 5f 44 65 74 61 69 6c 73 } //00 00  Enter_Details
	condition:
		any of ($a_*)
