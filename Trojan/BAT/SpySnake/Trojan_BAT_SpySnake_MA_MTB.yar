...
rule Trojan_BAT_SpySnake_MA_MTB_2{
	...
	strings :
		...
		$a_03_6 = {0d 09 07 6f 90 01 03 0a 17 90 0a 1a 00 6f 90 01 03 0a 6f 90 01 03 0a 73 28 00 00 0a 90 02 0d 73 2a 00 00 0a 13 04 11 04 06 16 06 8e 69 6f 90 01 03 0a 11 04 6f 90 01 03 0a de 0c 90 00 } //10
	condition:
