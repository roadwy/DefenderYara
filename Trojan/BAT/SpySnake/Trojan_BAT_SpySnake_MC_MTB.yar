...
rule Trojan_BAT_SpySnake_MC_MTB{
	...
	strings :
		$a_03_0 = {06 09 17 59 11 04 a2 00 09 17 58 0d 09 03 6f ?? ?? ?? 06 fe 02 16 fe 01 13 06 11 06 3a 51 ff ff ff } //10
...
rule Trojan_BAT_SpySnake_MC_MTB_2{
	...
	strings :
		$a_03_0 = {07 06 11 08 9a 1f 10 28 ?? ?? ?? 0a 6f ?? ?? ?? 0a 00 11 08 17 58 13 08 20 ?? ?? ?? 9e 38 ?? ?? ?? ff } //10
