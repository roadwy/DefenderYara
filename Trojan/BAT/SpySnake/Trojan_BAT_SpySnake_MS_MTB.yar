...
rule Trojan_BAT_SpySnake_MS_MTB{
	...
	strings :
		...
		$a_01_2 = {34 32 38 31 62 32 30 38 2d 33 39 61 35 2d 34 63 63 34 2d 62 35 32 34 2d 36 65 39 61 66 36 32 36 66 36 32 31 } //0a 00 
		$a_01_3 = {4d 61 6c 61 67 61 5f 67 61 6d 65 2e 50 72 6f 70 65 72 74 69 65 73 } //05 00 
		$a_01_4 = {53 65 6c 66 20 69 6e 73 74 61 6c 6c 61 74 69 6f 6e } //00 00 
	condition:
		any of ($a_*)
