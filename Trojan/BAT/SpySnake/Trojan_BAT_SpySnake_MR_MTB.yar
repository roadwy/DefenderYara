...
rule Trojan_BAT_SpySnake_MR_MTB{
	...
	strings :
		$a_03_0 = {25 16 07 06 9a a2 25 17 1f 10 8c 4a 00 00 01 a2 6f 90 01 03 0a a5 06 00 00 01 9c 06 17 58 0a 06 07 8e 69 fe 04 13 08 11 08 2d ad 90 00 } //10
		$a_01_1 = {63 38 39 65 63 30 31 33 2d 31 34 66 64 2d 34 32 38 31 2d 61 61 33 62 2d 64 64 34 36 30 35 64 33 32 37 35 66 } //5 c89ec013-14fd-4281-aa3b-dd4605d3275f
...
rule Trojan_BAT_SpySnake_MR_MTB_2{
	...
	strings :
		$a_01_0 = {0d 00 2b 1f 09 20 e5 8e fb 0e fe 01 13 1a 11 1a 2c 09 20 1c 8f fb 0e 0d 00 2b 08 00 20 01 8f fb 0e 0d 00 } //10
		$a_03_1 = {50 45 00 00 4c 01 03 00 90 01 04 00 00 00 00 00 00 00 00 e0 00 02 01 0b 01 50 90 00 } //2
		$a_01_2 = {53 74 72 52 65 76 65 72 73 65 } //2 StrReverse
		$a_01_3 = {43 72 65 61 74 65 5f 5f 49 6e 73 74 61 6e 63 65 5f 5f } //2 Create__Instance__
	condition:
...
rule Trojan_BAT_SpySnake_MR_MTB_3{
	...
	strings :
		...
		$a_01_1 = {48 61 73 68 50 61 73 73 77 6f 72 64 46 6f 72 53 74 6f 72 69 6e 67 49 6e 43 6f 6e 66 69 67 46 69 6c 65 } //1 HashPasswordForStoringInConfigFile
		$a_01_2 = {43 72 65 61 74 65 49 6e 73 74 61 6e 63 65 } //1 CreateInstance
		$a_01_3 = {43 72 65 61 74 65 44 65 63 72 79 70 74 6f 72 } //1 CreateDecryptor
		$a_01_4 = {43 61 6c 7a 6f 6e 65 } //1 Calzone
