...
rule Trojan_BAT_SpySnake_MR_MTB{
	...
	strings :
		...
		$a_01_1 = {63 38 39 65 63 30 31 33 2d 31 34 66 64 2d 34 32 38 31 2d 61 61 33 62 2d 64 64 34 36 30 35 64 33 32 37 35 66 } //01 00 
...
rule Trojan_BAT_SpySnake_MR_MTB_2{
	...
	strings :
		...
		$a_01_2 = {53 74 72 52 65 76 65 72 73 65 } //02 00 
		$a_01_3 = {43 72 65 61 74 65 5f 5f 49 6e 73 74 61 6e 63 65 5f 5f } //00 00 
	condition:
		any of ($a_*)
