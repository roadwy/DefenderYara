...
rule Trojan_BAT_SpySnake_MR_MTB{
	...
	strings :
		$a_03_0 = {25 16 07 06 9a a2 25 17 1f 10 8c 4a 00 00 01 a2 6f ?? ?? ?? 0a a5 06 00 00 01 9c 06 17 58 0a 06 07 8e 69 fe 04 13 08 11 08 2d ad } //10
...
rule Trojan_BAT_SpySnake_MR_MTB_2{
	...
	strings :
		...
		$a_03_1 = {50 45 00 00 4c 01 03 00 ?? ?? ?? ?? 00 00 00 00 00 00 00 00 e0 00 02 01 0b 01 50 } //2
