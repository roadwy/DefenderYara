...
rule Trojan_BAT_SpySnake_MAD_MTB{
	...
	strings :
		...
		$a_01_2 = {44 6f 77 6e 6c 6f 61 64 51 75 65 75 65 } //01 00  DownloadQueue
		$a_01_3 = {53 6c 65 65 70 } //01 00  Sleep
		$a_01_4 = {52 65 70 6c 61 63 65 } //01 00  Replace
		$a_01_5 = {55 72 6c 44 65 63 6f 64 65 } //01 00  UrlDecode
		...
		$a_01_9 = {50 00 72 00 6f 00 78 00 79 00 2d 00 43 00 6f 00 6e 00 6e 00 65 00 63 00 74 00 69 00 6f 00 6e 00 } //00 00  Proxy-Connection
	condition:
		any of ($a_*)
