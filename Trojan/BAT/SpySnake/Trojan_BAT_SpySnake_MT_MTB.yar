...
rule Trojan_BAT_SpySnake_MT_MTB_2{
	...
	strings :
		...
		$a_01_1 = {47 61 6d 65 46 6f 72 6d 5f 4b 65 79 44 6f 77 6e } //01 00 
		$a_01_2 = {65 30 37 63 64 61 37 32 2d 37 31 62 33 2d 34 32 39 35 2d 38 36 35 37 2d 64 37 61 61 31 62 33 62 35 62 31 33 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_BAT_SpySnake_MT_MTB_3{
	...
	strings :
		...
		$a_01_1 = {43 00 75 00 72 00 72 00 65 00 6e 00 74 00 44 00 6f 00 6d 00 61 00 69 00 6e 00 } //01 00 
		$a_01_2 = {51 75 65 75 65 55 73 65 72 57 6f 72 6b 49 74 65 6d } //01 00 
		$a_01_3 = {2f 00 63 00 20 00 70 00 69 00 6e 00 67 00 20 00 62 00 69 00 6e 00 67 00 2e 00 63 00 6f 00 6d 00 } //01 00 
		$a_01_4 = {46 72 6f 6d 53 65 63 6f 6e 64 73 } //01 00 
		$a_01_5 = {53 6c 65 65 70 } //01 00 
		$a_01_6 = {52 00 65 00 76 00 65 00 72 00 73 00 65 00 } //01 00 
