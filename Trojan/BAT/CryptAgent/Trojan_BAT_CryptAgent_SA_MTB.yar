...
rule Trojan_BAT_CryptAgent_SA_MTB{
	...
	strings :
		$a_81_0 = {43 3a 5c 6d 79 61 70 70 2e 65 78 65 } //01 00  C:\myapp.exe
		...
		$a_81_4 = {5c 4d 79 41 70 70 2e 6c 6f 67 } //01 00  \MyApp.log
		$a_81_5 = {54 69 6d 65 4c 6f 67 67 65 72 28 } //00 00  TimeLogger(
	condition:
		any of ($a_*)
