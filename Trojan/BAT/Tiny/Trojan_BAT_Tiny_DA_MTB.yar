...
rule Trojan_BAT_Tiny_DA_MTB{
	...
	strings :
		$a_03_0 = {07 16 11 04 6f 90 01 03 0a 6f 90 01 03 0a 13 06 11 04 11 06 6f 90 01 03 0a 13 07 09 11 07 6f 90 01 03 0a 26 00 11 05 17 d6 13 05 11 05 1e 31 d0 90 00 } //1
