...
rule Trojan_BAT_SapphireStealer_ASH_MTB{
	...
	strings :
		$a_03_0 = {0a 2d 01 2a 72 90 01 01 01 00 70 73 90 01 01 00 00 0a 25 72 90 01 01 01 00 70 06 72 90 01 01 01 00 70 28 90 01 01 00 00 0a 6f 90 01 01 00 00 0a 25 16 90 00 } //00 00 
	condition:
		any of ($a_*)
