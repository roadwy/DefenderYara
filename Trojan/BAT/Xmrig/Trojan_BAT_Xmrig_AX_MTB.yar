...
rule Trojan_BAT_Xmrig_AX_MTB{
	...
	strings :
		$a_03_0 = {0a 14 0b 14 0c 14 0d 28 90 01 03 0a 1a 33 0e 72 32 0f 00 70 0c 72 7c 0f 00 70 0d 2b 0c 72 98 0f 00 70 0c 72 e2 0f 00 70 0d 06 08 6f 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_BAT_Xmrig_AX_MTB_2{
	...
	strings :
		$a_03_0 = {2b 2c 1b 2d 1e 26 2b 2d 2b 32 2b 33 72 b5 00 00 70 7e 4c 00 00 0a 2b 2e 2b 33 18 2d 0d 26 dd 56 00 00 00 2b 2f 15 2c f6 2b dc 2b 2b 2b f0 28 90 01 03 06 2b cd 28 90 01 03 0a 2b cc 07 2b cb 90 00 } //2
