...
rule Trojan_BAT_Xmrig_NEAG_MTB{
	...
	strings :
		...
		$a_01_1 = {4c 00 57 00 69 00 6e 00 64 00 6f 00 77 00 73 00 46 00 6f 00 72 00 6d 00 73 00 41 00 70 00 70 00 37 00 36 00 6f 00 61 00 64 00 } //00 00  LWindowsFormsApp76oad
	condition:
		any of ($a_*)
