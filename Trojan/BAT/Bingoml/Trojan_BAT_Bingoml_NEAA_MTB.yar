...
rule Trojan_BAT_Bingoml_NEAA_MTB{
	...
	strings :
		...
		$a_01_1 = {54 00 6b 00 31 00 44 00 57 00 45 00 4e 00 59 00 53 00 6b 00 64 00 4c 00 53 00 6b 00 64 00 4c 00 52 00 45 00 5a 00 4c 00 4a 00 41 00 3d 00 3d 00 } //00 00 
	condition:
		any of ($a_*)
