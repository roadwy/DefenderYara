...
rule Trojan_BAT_CrimsonRAT_B_MTB{
	...
	strings :
		$a_02_0 = {62 64 73 73 90 02 20 6f 6e 6c 69 6e 65 6e 74 3d 51 90 02 20 62 64 61 67 65 6e 74 90 02 20 6d 73 73 65 63 65 73 3d 4d 90 02 20 66 73 73 6d 90 00 } //1
