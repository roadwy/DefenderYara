...
rule Trojan_BAT_PsDownload_ENAA_MTB{
	...
	strings :
		$a_03_0 = {26 14 0b 73 ?? 00 00 0a 0c 28 ?? 00 00 06 0b dd ?? 00 00 00 08 39 ?? 00 00 00 08 6f ?? 00 00 0a dc 07 28 ?? 00 00 2b 28 ?? 00 00 2b 28 ?? 00 00 0a 6f ?? 00 00 0a 28 ?? 00 00 2b 0d } //4
