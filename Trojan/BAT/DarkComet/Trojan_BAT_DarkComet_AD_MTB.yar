...
rule Trojan_BAT_DarkComet_AD_MTB_3{
	...
	strings :
		...
		$a_01_1 = {51 75 69 63 6b 4c 5a } //01 00 
		$a_01_2 = {53 77 61 67 67 65 72 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_BAT_DarkComet_AD_MTB_4{
	...
	strings :
		...
		$a_01_1 = {53 00 68 00 61 00 72 00 70 00 69 00 65 00 63 00 6c 00 61 00 73 00 73 00 } //01 00 
		$a_01_2 = {69 00 6e 00 76 00 6f 00 6b 00 65 00 73 00 68 00 69 00 74 00 74 00 79 00 66 00 75 00 6e 00 63 00 74 00 69 00 6f 00 6e 00 } //00 00 
	condition:
		any of ($a_*)
