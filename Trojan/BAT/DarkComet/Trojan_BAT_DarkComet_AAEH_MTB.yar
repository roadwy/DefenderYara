...
rule Trojan_BAT_DarkComet_AAEH_MTB{
	...
	strings :
		...
		$a_01_1 = {4b 00 4b 00 4b 00 4b 00 4b 00 4b 00 4b 00 4b 00 4b 00 4c 00 4c 00 4c 00 4c 00 4c 00 4c 00 4c 00 4d 00 4d 00 4d 00 4d 00 50 00 50 00 50 00 50 00 4f 00 4f 00 4f 00 4f 00 } //00 00  KKKKKKKKKLLLLLLLMMMMPPPPOOOO
	condition:
		any of ($a_*)
