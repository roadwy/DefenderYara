...
rule Trojan_BAT_FormBook_ALS_MTB{
	...
	strings :
		...
		$a_01_1 = {43 00 65 00 6c 00 6c 00 75 00 6c 00 61 00 72 00 20 00 41 00 75 00 74 00 6f 00 6d 00 61 00 74 00 6f 00 6e 00 20 00 53 00 69 00 6d 00 75 00 6c 00 61 00 74 00 69 00 6f 00 6e 00 } //00 00 
	condition:
		any of ($a_*)
