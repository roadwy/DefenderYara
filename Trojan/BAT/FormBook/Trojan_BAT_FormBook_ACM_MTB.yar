...
rule Trojan_BAT_FormBook_ACM_MTB{
	...
	strings :
		$a_03_0 = {0d 16 13 04 2b 1e 08 11 04 9a 13 08 09 11 08 1f 10 28 90 01 03 0a b4 6f 90 01 03 0a 00 11 04 17 d6 13 04 00 11 04 08 8e 69 fe 04 13 09 11 09 90 00 } //2
...
rule Trojan_BAT_FormBook_ACM_MTB_2{
	...
	strings :
		$a_03_0 = {07 11 08 06 11 08 9a 1f 10 28 90 01 03 0a 9c 11 08 17 58 13 08 11 08 06 8e 69 fe 04 13 09 11 09 2d de 90 00 } //2
