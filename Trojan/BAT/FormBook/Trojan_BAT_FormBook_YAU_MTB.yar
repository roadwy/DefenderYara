...
rule Trojan_BAT_FormBook_YAU_MTB{
	...
	strings :
		...
		$a_01_4 = {54 00 52 00 4d 00 53 00 2e 00 43 00 61 00 72 00 6f 00 75 00 73 00 65 00 6c 00 4d 00 6f 00 6e 00 69 00 74 00 6f 00 72 00 43 00 6f 00 6e 00 74 00 72 00 6f 00 6c 00 } //01 00  TRMS.CarouselMonitorControl
