...
rule Trojan_BAT_FormBook_ACKD_MTB{
	...
	strings :
		...
		$a_01_1 = {54 00 72 00 75 00 6d 00 70 00 5f 00 61 00 6e 00 64 00 5f 00 6a 00 6f 00 65 00 5f 00 62 00 69 00 64 00 65 00 6e 00 5f 00 70 00 6e 00 67 00 } //00 00  Trump_and_joe_biden_png
	condition:
		any of ($a_*)
