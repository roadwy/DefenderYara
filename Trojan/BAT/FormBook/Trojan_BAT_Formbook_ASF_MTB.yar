...
rule Trojan_BAT_Formbook_ASF_MTB{
	...
	strings :
		$a_03_0 = {16 0b 2b 2a 08 6f 90 01 03 0a 07 18 6f 90 01 03 0a 1f 10 28 90 01 03 0a 28 90 01 03 0a 16 91 13 09 11 04 11 09 6f 90 01 03 0a 07 18 58 0b 07 08 6f 90 01 03 0a 6f 90 01 03 0a fe 04 13 0a 11 0a 2d c2 90 00 } //2
