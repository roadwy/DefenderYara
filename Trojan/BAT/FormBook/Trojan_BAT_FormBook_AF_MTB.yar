...
rule Trojan_BAT_FormBook_AF_MTB_4{
	...
	strings :
		$a_03_0 = {11 00 11 02 02 11 02 91 72 90 01 01 00 00 70 28 90 01 01 00 00 06 59 d2 9c 20 00 00 00 00 7e 90 01 01 01 00 04 7b 90 00 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_BAT_FormBook_AF_MTB_6{
	...
	strings :
		$a_03_0 = {0b 07 13 07 16 13 06 2b 2f 11 07 11 06 9a 0c 08 6f 90 01 01 00 00 0a 28 90 01 01 00 00 06 26 7e 0e 00 00 04 2c 02 de 1c 90 00 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_BAT_FormBook_AF_MTB_8{
	...
	strings :
		...
		$a_01_1 = {48 00 56 00 70 00 4f 00 4c 00 2e 00 65 00 78 00 65 00 } //00 00  HVpOL.exe
	condition:
		any of ($a_*)
...
rule Trojan_BAT_FormBook_AF_MTB_9{
	...
	strings :
		...
		$a_01_1 = {50 00 61 00 72 00 73 00 65 00 72 00 41 00 72 00 } //00 00  ParserAr
	condition:
		any of ($a_*)
...
rule Trojan_BAT_FormBook_AF_MTB_10{
	...
	strings :
		...
		$a_01_1 = {50 00 6f 00 72 00 61 00 6c 00 50 00 65 00 72 00 69 00 6c 00 5f 00 53 00 74 00 65 00 66 00 61 00 6e 00 54 00 69 00 63 00 75 00 } //00 00  PoralPeril_StefanTicu
	condition:
		any of ($a_*)
...
rule Trojan_BAT_FormBook_AF_MTB_11{
	...
	strings :
		...
		$a_01_1 = {54 00 65 00 73 00 74 00 46 00 69 00 72 00 73 00 74 00 57 00 46 00 61 00 70 00 70 00 } //00 00  TestFirstWFapp
	condition:
		any of ($a_*)
...
rule Trojan_BAT_FormBook_AF_MTB_13{
	...
	strings :
		...
		$a_01_1 = {46 00 6f 00 6c 00 64 00 65 00 72 00 54 00 6f 00 54 00 65 00 78 00 74 00 } //00 00  FolderToText
	condition:
		any of ($a_*)
...
rule Trojan_BAT_FormBook_AF_MTB_14{
	...
	strings :
		...
		$a_01_1 = {5f 00 32 00 30 00 34 00 38 00 57 00 69 00 6e 00 64 00 6f 00 77 00 73 00 46 00 6f 00 72 00 6d 00 73 00 41 00 70 00 70 00 } //00 00  _2048WindowsFormsApp
	condition:
		any of ($a_*)
...
rule Trojan_BAT_FormBook_AF_MTB_15{
	meta:
		description = "Trojan:BAT/FormBook.AF!MTB,SIGNATURE_TYPE_PEHSTR_EXT,02 00 02 00 02 00 00 01 00 "
		
	strings :
		$a_01_0 = {16 13 04 2b 1f 00 02 11 04 09 6f 09 00 00 0a 13 05 08 11 04 09 11 05 6f 10 00 00 0a 00 00 11 04 17 58 13 04 11 04 06 fe 04 13 06 11 06 2d d6 } //01 00 
		$a_01_1 = {13 06 11 06 16 fe 02 13 07 11 07 2c 0f 00 11 05 11 04 16 11 06 6f 17 00 00 0a 00 00 00 11 06 16 fe 02 13 08 11 08 2d c9 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_BAT_FormBook_AF_MTB_16{
	...
	strings :
		...
		$a_01_1 = {46 00 6f 00 72 00 6d 00 51 00 75 00 61 00 6e 00 4c 00 79 00 42 00 61 00 6e 00 48 00 61 00 6e 00 67 00 } //00 00  FormQuanLyBanHang
	condition:
		any of ($a_*)
...
rule Trojan_BAT_FormBook_AF_MTB_18{
	...
	strings :
		...
		$a_01_1 = {4e 00 65 00 74 00 77 00 6f 00 72 00 6b 00 20 00 53 00 69 00 6d 00 75 00 6c 00 61 00 74 00 69 00 6f 00 6e 00 20 00 54 00 6f 00 6f 00 6c 00 73 00 } //00 00  Network Simulation Tools
	condition:
		any of ($a_*)
...
rule Trojan_BAT_FormBook_AF_MTB_19{
	...
	strings :
		...
		$a_01_1 = {65 00 76 00 6f 00 6c 00 75 00 74 00 69 00 6f 00 6e 00 53 00 6f 00 63 00 63 00 65 00 72 00 } //00 00  evolutionSoccer
	condition:
		any of ($a_*)
...
rule Trojan_BAT_FormBook_AF_MTB_20{
	...
	strings :
		...
		$a_01_1 = {54 00 6f 00 77 00 65 00 72 00 20 00 44 00 65 00 66 00 65 00 6e 00 73 00 65 00 } //00 00  Tower Defense
	condition:
		any of ($a_*)
...
rule Trojan_BAT_FormBook_AF_MTB_22{
	...
	strings :
		...
		$a_01_1 = {43 3a 5c 55 73 65 72 73 5c 41 64 6d 69 6e 69 73 74 72 61 74 6f 72 5c 44 6f 63 75 6d 65 6e 74 73 5c 43 72 79 70 74 6f 4f 62 66 75 73 63 61 74 6f 72 5f 4f 75 74 70 75 74 5c 48 56 70 4f 4c 2e 70 64 62 } //01 00  C:\Users\Administrator\Documents\CryptoObfuscator_Output\HVpOL.pdb
		$a_01_2 = {48 00 56 00 70 00 4f 00 4c 00 2e 00 65 00 78 00 65 00 } //00 00  HVpOL.exe
	condition:
		any of ($a_*)
...
rule Trojan_BAT_FormBook_AF_MTB_23{
	...
	strings :
		...
		$a_01_2 = {52 00 65 00 73 00 75 00 6d 00 65 00 46 00 6f 00 72 00 6d 00 61 00 74 00 44 00 65 00 74 00 65 00 63 00 74 00 6f 00 72 00 2e 00 65 00 78 00 65 00 } //00 00  ResumeFormatDetector.exe
	condition:
		any of ($a_*)
...
rule Trojan_BAT_FormBook_AF_MTB_24{
	...
	strings :
		...
		$a_01_1 = {41 00 6e 00 20 00 65 00 78 00 70 00 65 00 72 00 69 00 6d 00 65 00 6e 00 74 00 61 00 6c 00 20 00 77 00 65 00 62 00 20 00 62 00 72 00 6f 00 77 00 73 00 65 00 72 00 20 00 74 00 68 00 61 00 74 00 20 00 75 00 73 00 65 00 73 00 20 00 69 00 6e 00 6e 00 6f 00 76 00 61 00 74 00 69 00 76 00 65 00 20 00 74 00 65 00 63 00 68 00 6e 00 6f 00 6c 00 6f 00 67 00 79 00 } //01 00  An experimental web browser that uses innovative technology
