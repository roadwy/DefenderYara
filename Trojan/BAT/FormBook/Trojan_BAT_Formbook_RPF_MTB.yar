...
rule Trojan_BAT_Formbook_RPF_MTB{
	...
	strings :
		...
		$a_01_1 = {41 00 6f 00 79 00 6b 00 6a 00 5f 00 34 00 32 00 31 00 38 00 30 00 5f 00 2e 00 62 00 6d 00 70 00 } //1 Aoykj_42180_.bmp
		$a_01_2 = {4d 00 74 00 76 00 6e 00 67 00 77 00 79 00 75 00 } //1 Mtvngwyu
