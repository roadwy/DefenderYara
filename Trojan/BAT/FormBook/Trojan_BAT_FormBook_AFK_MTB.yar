...
rule Trojan_BAT_FormBook_AFK_MTB_2{
	...
	strings :
		$a_03_0 = {08 11 07 07 11 07 9a 1f 10 28 90 01 03 0a 9c 11 07 17 58 13 07 90 00 } //2
...
rule Trojan_BAT_FormBook_AFK_MTB_3{
	...
	strings :
		$a_03_0 = {07 8e 69 6a 5d d4 07 11 07 07 8e 69 6a 5d d4 91 08 11 07 08 8e 69 6a 5d d4 91 61 28 90 01 01 00 00 06 d2 07 11 07 17 6a 58 07 8e 69 6a 5d d4 91 28 90 01 01 00 00 06 d2 59 20 00 01 00 00 58 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_BAT_FormBook_AFK_MTB_4{
	...
	strings :
		$a_03_0 = {0b 07 13 04 16 13 05 2b 3c 11 04 11 05 9a 0c 08 6f 90 01 01 00 00 0a 04 28 90 01 01 00 00 0a 2c 22 72 90 01 01 00 00 70 08 72 90 01 01 00 00 70 18 8d 90 01 01 00 00 01 13 06 11 06 16 03 a2 11 06 28 90 01 01 00 00 06 0d de 10 11 05 17 58 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_BAT_FormBook_AFK_MTB_5{
	...
	strings :
		$a_03_0 = {16 13 06 2b 2e 11 05 11 06 9a 13 07 00 11 04 6f 90 01 01 01 00 0a 11 07 28 90 01 01 00 00 0a 13 08 11 08 2c 0b 00 06 07 11 04 a2 07 17 58 90 00 } //1
		$a_03_1 = {0d 2b 48 00 06 09 06 8e 69 5d 06 09 06 8e 69 5d 91 07 09 07 6f 90 01 01 01 00 0a 5d 6f 90 01 01 02 00 0a 61 28 90 01 01 00 00 0a 06 09 17 58 06 8e 69 5d 91 28 90 01 01 02 00 0a 59 20 00 01 00 00 58 20 00 01 00 00 5d 28 90 01 01 02 00 0a 9c 00 09 15 58 90 00 } //1
	condition:
...
rule Trojan_BAT_FormBook_AFK_MTB_6{
	...
	strings :
		$a_03_0 = {20 16 ac 01 00 13 04 2b 19 00 06 11 04 06 8e 69 5d 02 06 11 04 28 90 01 03 06 9c 00 11 04 15 58 13 04 11 04 16 fe 04 16 fe 01 13 05 11 05 2d d9 90 00 } //2
