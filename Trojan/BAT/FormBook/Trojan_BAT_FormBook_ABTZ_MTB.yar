...
rule Trojan_BAT_FormBook_ABTZ_MTB{
	...
	strings :
		...
		$a_01_1 = {47 00 61 00 73 00 74 00 72 00 6f 00 65 00 6e 00 74 00 65 00 72 00 6f 00 6c 00 6f 00 67 00 79 00 2e 00 50 00 72 00 6f 00 70 00 65 00 72 00 74 00 69 00 65 00 73 00 2e 00 52 00 65 00 73 00 6f 00 75 00 72 00 63 00 65 00 73 00 } //00 00 
	condition:
		any of ($a_*)
