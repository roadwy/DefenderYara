...
rule Trojan_BAT_FormBook_FK_MTB{
	...
	strings :
		$a_03_0 = {08 13 09 11 07 13 0a 11 09 11 0a 3d 32 00 00 00 02 08 17 28 90 01 03 0a 28 90 01 03 0a 09 20 b3 15 00 00 5d 59 13 0b 11 08 11 0b 28 90 01 03 0a 28 90 01 03 0a 28 90 01 03 0a 13 08 08 17 58 0c 2b be 90 00 } //2
