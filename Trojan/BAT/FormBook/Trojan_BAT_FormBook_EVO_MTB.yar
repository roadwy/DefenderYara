...
rule Trojan_BAT_FormBook_EVO_MTB_2{
	...
	strings :
		...
		$a_01_1 = {00 53 41 53 53 53 53 53 53 53 53 53 53 53 53 53 53 53 53 53 53 53 53 53 53 00 } //01 00 
		$a_01_2 = {00 54 48 41 49 30 30 00 } //01 00 
		$a_01_3 = {00 54 48 41 49 30 32 00 } //01 00 
		$a_01_4 = {00 5f 5f 5f 5f 5f 5f 5f 5f 5f 5f 5f 5f 00 } //01 00 
		$a_01_5 = {00 43 72 65 61 74 65 49 6e 73 74 61 6e 63 65 00 } //01 00 
