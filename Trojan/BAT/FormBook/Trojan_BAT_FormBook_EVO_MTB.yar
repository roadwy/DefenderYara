...
rule Trojan_BAT_FormBook_EVO_MTB{
	...
	strings :
		$a_03_0 = {06 07 03 07 03 6f 90 01 03 0a 5d 6f 90 01 03 0a 06 07 91 61 d2 9c 00 07 17 58 0b 07 06 8e 69 fe 04 0c 08 2d da 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_BAT_FormBook_EVO_MTB_2{
	...
	strings :
		$a_03_0 = {02 03 17 58 90 01 05 5d 91 0a 16 0b 02 90 00 } //1
