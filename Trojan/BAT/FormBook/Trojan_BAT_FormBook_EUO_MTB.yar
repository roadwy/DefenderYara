...
rule Trojan_BAT_FormBook_EUO_MTB_2{
	...
	strings :
		$a_01_0 = {35 00 37 00 4e 00 34 00 38 00 59 00 4a 00 5a 00 48 00 32 00 56 00 48 00 41 00 38 00 47 00 34 00 47 00 43 00 46 00 32 00 38 00 47 00 } //01 00  57N48YJZH2VHA8G4GCF28G
		$a_01_1 = {6f 00 61 00 2b 00 2b 00 64 00 } //01 00  oa++d
		$a_01_2 = {52 00 61 00 72 00 61 00 33 00 } //01 00  Rara3
