...
rule Trojan_BAT_Formbook_RPI_MTB_2{
	...
	strings :
		$a_03_0 = {64 00 69 00 76 00 65 00 72 00 67 00 65 00 6e 00 74 00 69 00 2e 00 74 00 65 00 63 00 68 00 2f 00 64 00 65 00 76 00 2f 00 90 02 10 2e 00 74 00 78 00 74 00 90 00 } //1
