...
rule Trojan_BAT_Formbook_RPI_MTB{
	...
	strings :
		$a_01_0 = {72 00 61 00 70 00 68 00 61 00 65 00 6c 00 6c 00 61 00 73 00 69 00 61 00 2e 00 63 00 6f 00 6d 00 } //01 00 
		$a_01_1 = {4b 00 76 00 65 00 75 00 6a 00 61 00 6d 00 72 00 2e 00 62 00 6d 00 70 00 } //01 00 
		$a_01_2 = {4e 00 72 00 76 00 62 00 70 00 71 00 76 00 78 00 } //01 00 
		$a_01_3 = {67 65 74 5f 41 73 73 65 6d 62 6c 79 } //01 00 
		$a_01_4 = {53 74 6f 70 77 61 74 63 68 } //01 00 
...
rule Trojan_BAT_Formbook_RPI_MTB_2{
	...
	strings :
		...
		$a_01_2 = {57 72 69 74 65 } //01 00 
		$a_01_3 = {52 65 76 65 72 73 65 } //01 00 
		$a_01_4 = {52 65 61 64 42 79 74 65 } //01 00 
		$a_01_5 = {43 6f 6e 63 61 74 } //01 00 
		...
		$a_01_9 = {47 65 74 52 65 73 70 6f 6e 73 65 53 74 72 65 61 6d } //01 00 
		$a_01_10 = {45 6e 63 6f 64 69 6e 67 } //01 00 
		$a_01_11 = {57 65 62 52 65 71 75 65 73 74 } //00 00 
	condition:
		any of ($a_*)
