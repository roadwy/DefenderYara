...
rule Trojan_BAT_Formbook_ND_MTB{
	...
	strings :
		...
		$a_01_1 = {61 34 35 39 2d 31 33 63 33 30 64 33 30 61 61 30 37 } //01 00 
		$a_01_2 = {53 51 4c 41 70 70 4c 6f 67 69 6e 2e 52 65 73 6f 75 72 63 65 73 2e 72 65 73 6f 75 72 63 65 } //01 00 
