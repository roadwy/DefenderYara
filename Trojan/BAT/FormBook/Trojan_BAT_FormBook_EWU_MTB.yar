...
rule Trojan_BAT_FormBook_EWU_MTB{
	...
	strings :
		$a_01_0 = {24 35 61 39 65 35 33 66 35 2d 64 66 63 65 2d 34 32 30 64 2d 39 65 65 62 2d 31 37 64 61 64 38 39 32 38 33 65 30 } //01 00 
		...
		$a_01_4 = {4d 44 35 43 72 79 70 74 6f 53 65 72 76 69 63 65 50 72 6f 76 69 64 65 72 } //00 00 
	condition:
		any of ($a_*)
