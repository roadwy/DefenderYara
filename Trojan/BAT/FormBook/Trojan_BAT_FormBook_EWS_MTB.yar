...
rule Trojan_BAT_FormBook_EWS_MTB{
	...
	strings :
		...
		$a_81_1 = {4b 34 44 4f 4d 34 44 4e 47 48 53 4f 45 30 39 } //01 00  K4DOM4DNGHSOE09
		$a_01_2 = {46 72 6f 6d 42 61 73 65 36 34 } //01 00  FromBase64
		$a_01_3 = {41 65 74 50 61 6c 65 73 74 69 6e 69 61 6e } //01 00  AetPalestinian
		$a_01_4 = {52 67 72 63 68 61 72 74 } //00 00  Rgrchart
	condition:
		any of ($a_*)
