...
rule Trojan_BAT_FormBook_GHGA_MTB{
	...
	strings :
		$a_03_0 = {72 7f 02 00 70 6f 90 01 03 0a 74 01 00 00 1b 0a 73 42 00 00 0a 0b 73 43 00 00 0a 0c 14 0d 1e 8d 42 00 00 01 13 04 08 1b 8d 42 00 00 01 25 d0 b2 00 00 04 90 00 } //2
