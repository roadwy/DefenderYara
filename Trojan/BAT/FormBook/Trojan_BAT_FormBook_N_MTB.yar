...
rule Trojan_BAT_FormBook_N_MTB{
	...
	strings :
		$a_01_0 = {24 61 32 35 36 30 65 66 38 2d 62 37 64 66 2d 34 37 61 65 2d 61 66 39 37 2d 34 39 35 34 37 35 31 66 64 32 33 32 } //01 00 
...
rule Trojan_BAT_FormBook_N_MTB_2{
	...
	strings :
		...
		$a_01_1 = {43 6f 6c 6c 69 73 69 6f 6e 53 69 6d 75 6c 61 74 69 6f 6e 2e 50 72 6f 70 65 72 74 69 65 73 2e 52 65 73 6f 75 72 63 65 73 2e 72 65 73 6f 75 72 63 65 73 } //00 00 
	condition:
		any of ($a_*)
