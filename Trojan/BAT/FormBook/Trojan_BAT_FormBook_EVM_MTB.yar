...
rule Trojan_BAT_FormBook_EVM_MTB{
	...
	strings :
		$a_01_0 = {00 41 5f 5f 5f 5f 5f 5f 5f 5f 5f 5f 5f 00 } //01 00 
		...
		$a_01_3 = {00 45 5f 5f 5f 5f 5f 5f 5f 5f 5f 5f 5f 5f 5f 5f 5f 5f 5f 00 } //01 00 
		$a_01_4 = {00 43 72 65 61 74 65 49 6e 73 74 61 6e 63 65 00 } //01 00 
		$a_01_5 = {00 47 65 74 54 79 70 65 00 } //01 00 
		$a_01_6 = {00 43 6f 6e 73 74 72 75 63 74 69 6f 6e 43 61 6c 6c 00 } //00 00 
	condition:
		any of ($a_*)
