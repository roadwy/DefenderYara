...
rule Trojan_BAT_FormBook_YAT_MTB{
	meta:
		description = "Trojan:BAT/FormBook.YAT!MTB,SIGNATURE_TYPE_PEHSTR_EXT,0f 00 0f 00 06 00 00 0a 00 "
	...
	strings :
		...
		$a_01_4 = {53 00 77 00 69 00 74 00 63 00 68 00 56 00 73 00 56 00 65 00 72 00 73 00 69 00 6f 00 6e 00 } //01 00  SwitchVsVersion
		$a_01_5 = {31 00 32 00 44 00 59 00 34 00 35 00 46 00 46 00 35 00 34 00 53 00 45 00 59 00 38 00 51 00 4b 00 59 00 47 00 42 00 41 00 35 00 52 00 } //00 00  12DY45FF54SEY8QKYGBA5R
	condition:
		any of ($a_*)
