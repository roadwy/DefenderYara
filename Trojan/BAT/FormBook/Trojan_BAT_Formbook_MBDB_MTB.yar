...
rule Trojan_BAT_Formbook_MBDB_MTB{
	...
	strings :
		$a_03_0 = {17 59 13 05 2b 17 00 08 07 11 05 6f 90 01 01 00 00 0a 6f 90 01 01 00 00 0a 26 00 11 05 17 59 13 05 11 05 16 fe 04 16 fe 01 13 06 11 06 2d db 90 00 } //1
