...
rule Trojan_BAT_Formbook_ED_MTB{
	meta:
		description = "Trojan:BAT/Formbook.ED!MTB,SIGNATURE_TYPE_PEHSTR_EXT,10 00 10 00 08 00 00 0a 00 "
		
	strings :
		$a_81_0 = {24 34 34 36 63 63 34 64 34 2d 32 61 39 33 2d 34 63 39 30 2d 62 66 34 35 2d 32 38 64 37 65 64 31 62 66 32 64 61 } //01 00  $446cc4d4-2a93-4c90-bf45-28d7ed1bf2da
		$a_81_1 = {50 72 6f 70 65 72 74 79 41 63 63 65 73 73 6f 72 2e 52 65 73 6f 75 72 63 65 73 } //01 00  PropertyAccessor.Resources
...
rule Trojan_BAT_Formbook_ED_MTB_2{
	meta:
		description = "Trojan:BAT/Formbook.ED!MTB,SIGNATURE_TYPE_PEHSTR_EXT,0f 00 0f 00 08 00 00 0a 00 "
		
	strings :
		$a_81_0 = {24 31 45 39 46 34 36 30 44 2d 32 38 45 46 2d 34 37 36 31 2d 41 36 39 44 2d 35 38 30 32 31 32 39 33 44 35 43 38 } //0a 00  $1E9F460D-28EF-4761-A69D-58021293D5C8
		$a_81_1 = {24 61 38 61 31 39 32 34 39 2d 34 66 65 30 2d 34 37 38 62 2d 62 61 63 66 2d 32 62 32 62 35 35 61 34 39 61 63 33 } //01 00  $a8a19249-4fe0-478b-bacf-2b2b55a49ac3
		$a_81_2 = {46 6f 72 6d 61 74 74 65 72 53 69 6e 6b } //01 00  FormatterSink
		$a_81_3 = {50 61 69 6e 74 65 72 2e 46 6f 72 6d 31 2e 72 65 73 6f 75 72 63 65 73 } //01 00  Painter.Form1.resources
