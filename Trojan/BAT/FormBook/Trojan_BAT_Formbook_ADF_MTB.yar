...
rule Trojan_BAT_Formbook_ADF_MTB{
	...
	strings :
		$a_03_0 = {16 13 04 2b 34 16 13 05 2b 1f 07 11 04 11 05 6f 90 01 03 0a 13 06 08 12 06 28 90 01 03 0a 6f 90 01 03 0a 11 05 17 58 13 05 11 05 07 6f 90 01 03 0a 32 d7 11 04 17 58 13 04 11 04 07 90 00 } //2
