...
rule Trojan_BAT_Formbook_NE_MTB{
	meta:
		description = "Trojan:BAT/Formbook.NE!MTB,SIGNATURE_TYPE_PEHSTR_EXT,05 00 05 00 01 00 00 05 00 "
		
	strings :
		$a_01_0 = {08 8e 69 5d 91 9c 00 11 04 17 58 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_BAT_Formbook_NE_MTB_2{
	...
	strings :
		...
		$a_01_1 = {53 00 30 00 78 00 4b 00 52 00 45 00 74 00 4b 00 54 00 45 00 52 00 54 00 53 00 6b 00 70 00 54 00 52 00 43 00 51 00 3d 00 } //00 00  S0xKREtKTERTSkpTRCQ=
	condition:
		any of ($a_*)
