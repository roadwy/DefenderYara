...
rule Trojan_BAT_Formbook_AWM_MTB{
	...
	strings :
		...
		$a_01_1 = {54 00 75 00 72 00 69 00 6e 00 67 00 4d 00 61 00 63 00 68 00 69 00 6e 00 65 00 53 00 69 00 6d 00 75 00 6c 00 61 00 74 00 69 00 6f 00 6e 00 } //00 00  TuringMachineSimulation
	condition:
		any of ($a_*)
