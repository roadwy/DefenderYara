...
rule Trojan_BAT_FormBook_NO_MTB{
	...
	strings :
		$a_03_0 = {11 00 0f 00 28 90 01 01 00 00 06 25 26 0f 01 28 90 01 01 00 00 06 25 26 d0 01 00 00 1b 28 90 01 01 00 00 0a 25 26 28 17 00 00 0a 25 26 a5 01 00 00 1b 0a 38 00 00 00 00 06 2a 90 00 } //1
