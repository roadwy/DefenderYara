...
rule Trojan_BAT_Formbook_MP_MTB{
	...
	strings :
		$a_03_0 = {06 0b 16 0c 2b 16 07 08 91 0d 90 02 02 7e 90 01 03 04 09 6f 90 01 03 0a 90 02 03 08 17 58 0c 08 07 8e 69 32 e4 7e 90 01 03 04 6f 90 01 03 0a 90 02 02 2a 90 00 } //1
