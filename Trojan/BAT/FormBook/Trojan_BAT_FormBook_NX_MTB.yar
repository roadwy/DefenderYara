...
rule Trojan_BAT_FormBook_NX_MTB{
	...
	strings :
		$a_01_0 = {24 36 62 66 66 37 33 33 32 2d 31 31 62 34 2d 34 37 65 61 2d 39 63 63 36 2d 32 36 64 32 39 65 65 34 33 32 34 36 } //01 00 
		$a_01_1 = {54 68 65 51 75 65 73 74 2e 50 72 6f 70 65 72 74 69 65 73 2e 52 65 73 6f 75 72 63 65 73 2e 72 65 73 6f 75 72 63 65 73 } //01 00 
