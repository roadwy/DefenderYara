...
rule Trojan_BAT_FormBook_AHAH_MTB{
	...
	strings :
		...
		$a_01_2 = {41 00 65 00 65 00 65 00 65 00 } //01 00 
		$a_01_3 = {57 00 69 00 6c 00 6c 00 69 00 73 00 52 00 75 00 62 00 69 00 63 00 73 00 43 00 75 00 62 00 65 00 } //00 00 
	condition:
		any of ($a_*)
