...
rule Trojan_BAT_Formbook_MBFR_MTB{
	...
	strings :
		...
		$a_01_1 = {37 39 66 61 34 64 62 61 2d 37 31 66 61 2d 34 37 38 30 2d 61 32 34 63 2d 62 35 34 39 33 64 32 64 36 31 61 30 } //00 00  79fa4dba-71fa-4780-a24c-b5493d2d61a0
	condition:
		any of ($a_*)
