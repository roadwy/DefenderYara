...
rule Trojan_BAT_FormBook_NYP_MTB{
	...
	strings :
		...
		$a_01_1 = {66 00 69 00 6c 00 74 00 68 00 79 00 2d 00 72 00 65 00 67 00 72 00 65 00 74 00 2e 00 64 00 76 00 72 00 6c 00 69 00 73 00 74 00 73 00 2e 00 63 00 } //00 00  filthy-regret.dvrlists.c
	condition:
		any of ($a_*)
