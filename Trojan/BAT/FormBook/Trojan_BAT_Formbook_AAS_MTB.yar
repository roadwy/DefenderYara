...
rule Trojan_BAT_Formbook_AAS_MTB{
	...
	strings :
		$a_03_0 = {72 5d 01 00 70 28 90 01 03 0a 0b 06 07 6f 90 01 03 0a 0c 02 8e 69 8d 90 01 03 01 0d 08 02 16 02 8e 69 09 16 6f 90 01 03 0a 13 04 09 11 04 90 00 } //2
