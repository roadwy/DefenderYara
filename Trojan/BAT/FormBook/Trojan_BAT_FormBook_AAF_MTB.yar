...
rule Trojan_BAT_FormBook_AAF_MTB_2{
	...
	strings :
		$a_03_0 = {13 06 11 06 08 6f 90 01 03 0a 00 08 6f 90 01 03 0a 03 6a da 17 6a da 13 07 16 6a 13 08 2b 0f 07 1b 6f 90 01 03 0a 00 11 08 17 6a d6 13 08 11 08 11 07 31 eb 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_BAT_FormBook_AAF_MTB_4{
	...
	strings :
		$a_03_0 = {7b 35 00 00 04 8e 69 17 59 8d 58 00 00 01 0b 02 7b 35 00 00 04 07 02 7b 35 00 00 04 8e 69 17 59 28 90 01 03 0a 11 04 16 8c 39 00 00 01 07 13 05 11 05 6f 90 00 } //2
...
rule Trojan_BAT_FormBook_AAF_MTB_5{
	...
	strings :
		$a_03_0 = {16 13 20 2b 25 11 1e 11 20 18 28 90 01 03 06 20 03 02 00 00 28 90 01 03 0a 13 22 11 1f 11 22 6f 90 01 03 0a 11 20 18 58 13 20 11 20 11 1e 90 00 } //2
...
rule Trojan_BAT_FormBook_AAF_MTB_6{
	...
	strings :
		$a_03_0 = {72 8f 11 00 70 28 90 01 03 0a 0b 06 07 6f 90 01 03 0a 0c 02 8e 69 8d 90 01 03 01 0d 08 02 16 02 8e 69 09 16 6f 90 01 03 0a 13 04 09 11 04 90 00 } //2
