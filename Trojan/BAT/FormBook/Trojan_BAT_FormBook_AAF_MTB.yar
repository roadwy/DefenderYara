...
rule Trojan_BAT_FormBook_AAF_MTB_2{
	...
	strings :
		...
		$a_01_1 = {47 00 72 00 6f 00 75 00 70 00 50 00 72 00 6f 00 6a 00 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_BAT_FormBook_AAF_MTB_3{
	...
	strings :
		...
		$a_01_1 = {51 00 4c 00 42 00 61 00 6e 00 48 00 61 00 6e 00 67 00 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_BAT_FormBook_AAF_MTB_4{
	...
	strings :
		...
		$a_01_1 = {47 00 61 00 73 00 74 00 72 00 6f 00 65 00 6e 00 74 00 65 00 72 00 6f 00 6c 00 6f 00 67 00 79 00 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_BAT_FormBook_AAF_MTB_5{
	...
	strings :
		...
		$a_01_1 = {57 00 65 00 62 00 5f 00 42 00 72 00 6f 00 77 00 73 00 65 00 72 00 5f 00 5f 00 48 00 57 00 5f 00 52 00 47 00 4d 00 5f 00 32 00 30 00 31 00 32 00 } //00 00 
	condition:
		any of ($a_*)
