...
rule Trojan_BAT_Formbook_MJ_MTB{
	...
	strings :
		$a_03_0 = {02 8e 69 8d 90 01 03 01 0a 16 0b 2b 1c 00 06 07 02 07 91 03 07 03 6f 90 01 03 0a 5d 6f 90 01 03 0a 61 d2 9c 00 07 17 58 0b 07 02 8e 69 fe 04 0c 08 2d 90 00 } //5
