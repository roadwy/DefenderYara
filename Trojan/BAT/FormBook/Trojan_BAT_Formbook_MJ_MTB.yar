...
rule Trojan_BAT_Formbook_MJ_MTB{
	...
	strings :
		...
		$a_01_1 = {44 65 62 75 67 67 65 72 42 72 6f 77 73 61 62 6c 65 41 74 74 72 69 62 75 74 65 } //01 00 
		$a_01_2 = {49 6e 76 6f 6b 65 } //01 00 
		$a_01_3 = {4d 65 6d 6f 72 79 53 74 72 65 61 6d } //01 00 
		$a_01_4 = {4f 62 66 75 73 63 61 74 69 6f 6e 41 74 74 72 69 62 75 74 65 } //01 00 
		$a_01_5 = {2e 00 63 00 6f 00 6d 00 70 00 72 00 65 00 73 00 73 00 65 00 64 00 } //00 00 
	condition:
		any of ($a_*)
