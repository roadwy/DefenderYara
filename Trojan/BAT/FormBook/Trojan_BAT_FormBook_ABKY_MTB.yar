...
rule Trojan_BAT_FormBook_ABKY_MTB{
	...
	strings :
		...
		$a_01_1 = {53 00 79 00 73 00 74 00 65 00 6d 00 4d 00 61 00 6e 00 61 00 67 00 65 00 72 00 2e 00 49 00 4a 00 53 00 46 00 49 00 48 00 42 00 } //00 00  SystemManager.IJSFIHB
	condition:
		any of ($a_*)
