...
rule Trojan_BAT_Formbook_RPZ_MTB{
	...
	strings :
		$a_01_0 = {06 09 5d 13 05 06 11 04 8e 69 5d 13 08 07 11 05 91 11 04 11 08 91 61 d2 13 09 11 09 07 06 17 58 09 5d 91 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_BAT_Formbook_RPZ_MTB_3{
	...
	strings :
		...
		$a_01_1 = {34 00 44 00 35 00 41 00 39 00 } //01 00  4D5A9
		$a_01_2 = {53 00 79 00 73 00 74 00 65 00 6d 00 2e 00 41 00 63 00 74 00 69 00 76 00 61 00 74 00 6f 00 72 00 } //01 00  System.Activator
		$a_01_3 = {43 00 72 00 65 00 61 00 74 00 65 00 49 00 6e 00 73 00 74 00 61 00 6e 00 63 00 65 00 } //00 00  CreateInstance
	condition:
		any of ($a_*)
