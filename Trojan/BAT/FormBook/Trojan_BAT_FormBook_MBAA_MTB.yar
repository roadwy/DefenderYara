...
rule Trojan_BAT_FormBook_MBAA_MTB{
	...
	strings :
		$a_03_0 = {0a 11 05 16 11 05 8e 69 6f 90 01 01 00 00 0a 13 06 de 59 09 2b cc 07 2b cb 6f 90 01 01 00 00 0a 2b c6 13 04 2b c4 08 2b c3 11 04 2b c1 6f 90 01 01 00 00 0a 2b bc 08 2b bb 90 00 } //1
