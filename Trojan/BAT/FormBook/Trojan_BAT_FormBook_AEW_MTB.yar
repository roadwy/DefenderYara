...
rule Trojan_BAT_FormBook_AEW_MTB{
	...
	strings :
		...
		$a_01_1 = {57 00 69 00 6e 00 64 00 6f 00 77 00 73 00 46 00 6f 00 72 00 6d 00 73 00 41 00 70 00 70 00 6c 00 69 00 63 00 61 00 74 00 69 00 6f 00 6e 00 36 00 } //00 00  WindowsFormsApplication6
	condition:
		any of ($a_*)
