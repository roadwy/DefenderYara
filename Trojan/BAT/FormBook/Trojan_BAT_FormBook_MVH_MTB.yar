...
rule Trojan_BAT_FormBook_MVH_MTB{
	...
	strings :
		$a_03_0 = {7e 14 00 00 04 73 40 00 00 0a 72 90 01 03 70 6f 90 01 03 0a 74 90 01 03 1b 0a 73 42 00 00 0a 0b 07 72 90 01 03 70 28 90 01 03 06 74 90 01 03 1b 6f 90 01 03 0a 0c 73 44 00 00 0a 0d 09 08 6f 90 01 03 0a 00 09 18 6f 90 01 03 0a 00 09 6f 90 01 03 0a 06 16 06 8e 69 6f 90 01 03 0a 90 00 } //2
