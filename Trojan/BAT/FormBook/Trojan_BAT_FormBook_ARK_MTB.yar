...
rule Trojan_BAT_FormBook_ARK_MTB{
	...
	strings :
		$a_03_0 = {14 14 17 8d 16 00 00 01 25 16 07 a2 6f 90 01 03 0a 75 1d 00 00 01 0c 08 6f 90 01 03 0a 16 9a 6f 90 01 03 0a 18 9a 0d 09 16 8c 58 00 00 01 02 7b 0e 00 00 04 13 04 11 04 6f 90 00 } //2
