...
rule Trojan_BAT_FormBook_ABET_MTB{
	...
	strings :
		...
		$a_01_1 = {51 00 51 00 57 00 45 00 53 00 53 00 53 00 53 00 } //01 00  QQWESSSS
		$a_01_2 = {49 00 6e 00 76 00 6f 00 6b 00 65 00 4d 00 65 00 6d 00 62 00 65 00 72 00 } //00 00  InvokeMember
	condition:
		any of ($a_*)
