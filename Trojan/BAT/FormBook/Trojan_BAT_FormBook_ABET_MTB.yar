...
rule Trojan_BAT_FormBook_ABET_MTB{
	...
	strings :
		$a_03_0 = {03 04 1c d6 5d 8c 90 01 03 01 02 28 90 01 03 06 28 90 01 03 0a 0a 06 14 72 90 01 03 70 16 8d 90 01 03 01 14 14 14 28 90 01 03 0a 74 90 01 03 1b 0b 73 90 01 03 0a 0c 08 07 03 1f 0b da 90 00 } //3
