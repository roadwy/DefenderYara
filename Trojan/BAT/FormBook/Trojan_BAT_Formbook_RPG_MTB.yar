...
rule Trojan_BAT_Formbook_RPG_MTB_2{
	...
	strings :
		...
		$a_01_1 = {4a 00 73 00 67 00 69 00 76 00 7a 00 63 00 65 00 2e 00 70 00 6e 00 67 00 } //01 00 
		$a_01_2 = {70 00 6f 00 77 00 65 00 72 00 73 00 68 00 65 00 6c 00 6c 00 } //01 00 
		$a_01_3 = {65 00 6e 00 63 00 20 00 59 00 77 00 42 00 74 00 41 00 47 00 51 00 41 00 49 00 41 00 41 00 76 00 41 00 47 00 4d 00 41 00 49 00 41 00 42 00 30 00 41 00 47 00 6b 00 41 00 62 00 51 00 42 00 6c 00 41 00 47 00 38 00 41 00 64 00 51 00 42 00 30 00 41 00 43 00 41 00 41 00 4d 00 51 00 41 00 31 00 41 00 41 00 } //01 00 
		$a_01_4 = {45 00 6d 00 61 00 69 00 6c 00 20 00 43 00 68 00 65 00 63 00 6b 00 65 00 72 00 20 00 50 00 72 00 6f 00 } //01 00 
		$a_01_5 = {51 00 67 00 6b 00 6b 00 74 00 65 00 64 00 65 00 7a 00 76 00 6e 00 79 00 7a 00 66 00 6d 00 78 00 6d 00 66 00 64 00 6a 00 78 00 61 00 } //00 00 
	condition:
		any of ($a_*)
