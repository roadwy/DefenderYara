...
rule Trojan_BAT_Formbook_RPG_MTB{
	...
	strings :
		$a_01_0 = {08 09 07 09 07 8e 69 5d 91 06 09 91 61 d2 9c 09 13 04 11 04 17 58 0d 09 06 8e 69 32 e3 } //1
	condition:
		((#a_01_0  & 1)*1) >=1
...
rule Trojan_BAT_Formbook_RPG_MTB_2{
	meta:
		description = "Trojan:BAT/Formbook.RPG!MTB,SIGNATURE_TYPE_PEHSTR_EXT,06 00 06 00 06 00 00 "
	...
	strings :
		...
		$a_01_5 = {51 00 67 00 6b 00 6b 00 74 00 65 00 64 00 65 00 7a 00 76 00 6e 00 79 00 7a 00 66 00 6d 00 78 00 6d 00 66 00 64 00 6a 00 78 00 61 00 } //1 Qgkktedezvnyzfmxmfdjxa
	condition:
