...
rule Trojan_BAT_Formbook_RPH_MTB_2{
	...
	strings :
		$a_03_0 = {6d 00 79 00 70 00 75 00 72 00 65 00 2e 00 30 00 30 00 30 00 77 00 65 00 62 00 68 00 6f 00 73 00 74 00 61 00 70 00 70 00 2e 00 63 00 6f 00 6d 00 2f 00 70 00 75 00 72 00 65 00 [0-40] 2e 00 6a 00 70 00 67 00 } //1
