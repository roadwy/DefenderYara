...
rule Trojan_BAT_FormBook_AH_MTB{
	...
	strings :
		$a_02_0 = {57 9d a2 29 09 1f 90 01 0a 02 90 01 03 bf 90 01 03 3a 90 01 03 b2 90 00 } //10
...
rule Trojan_BAT_FormBook_AH_MTB_2{
	...
	strings :
		$a_03_0 = {07 11 08 72 35 00 00 70 28 90 01 03 0a 72 53 00 00 70 20 00 01 00 00 14 14 18 8d 12 00 00 01 25 16 06 11 08 9a a2 25 17 1f 10 8c 7f 00 00 01 a2 90 00 } //2
