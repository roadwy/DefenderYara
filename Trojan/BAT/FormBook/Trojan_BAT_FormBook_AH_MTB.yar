...
rule Trojan_BAT_FormBook_AH_MTB_2{
	...
	strings :
		...
		$a_01_1 = {41 00 43 00 5f 00 43 00 6f 00 6e 00 74 00 72 00 6f 00 6c 00 } //01 00 
		$a_01_2 = {50 00 23 00 65 00 73 00 2e 00 57 00 68 00 23 00 74 00 65 00 } //01 00 
		$a_01_3 = {52 65 70 6c 61 63 65 } //01 00 
		$a_01_4 = {53 00 79 00 73 00 74 00 65 00 6d 00 2e 00 43 00 6f 00 6e 00 76 00 65 00 72 00 74 00 } //00 00 
	condition:
		any of ($a_*)
