...
rule Trojan_BAT_FormBook_EWV_MTB{
	meta:
		description = "Trojan:BAT/FormBook.EWV!MTB,SIGNATURE_TYPE_PEHSTR_EXT,05 00 05 00 05 00 00 01 00 "
		
	strings :
		$a_81_0 = {35 58 54 4f 44 35 47 34 51 35 34 47 5a 38 35 37 42 53 43 38 37 34 } //01 00  5XTOD5G4Q54GZ857BSC874
