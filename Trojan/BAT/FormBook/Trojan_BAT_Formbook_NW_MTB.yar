...
rule Trojan_BAT_Formbook_NW_MTB{
	...
	strings :
		...
		$a_01_1 = {50 61 63 4d 61 6e 2e 50 72 6f 70 65 72 74 69 65 73 2e 52 65 73 6f 75 72 63 65 73 2e 72 65 73 6f 75 72 63 65 } //01 00  PacMan.Properties.Resources.resource
