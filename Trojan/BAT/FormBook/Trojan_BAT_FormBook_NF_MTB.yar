...
rule Trojan_BAT_FormBook_NF_MTB_3{
	...
	strings :
		...
		$a_01_1 = {4a 55 59 54 47 46 48 4a 4e 4b } //00 00  JUYTGFHJNK
	condition:
		any of ($a_*)
...
rule Trojan_BAT_FormBook_NF_MTB_4{
	...
	strings :
		...
		$a_01_1 = {41 00 33 00 68 00 4c 00 6f 00 51 00 } //01 00  A3hLoQ
		$a_01_2 = {57 69 6e 64 6f 77 73 41 70 70 33 2e 52 65 73 6f 75 72 63 65 73 2e 72 65 73 6f 75 72 63 65 73 } //00 00  WindowsApp3.Resources.resources
	condition:
		any of ($a_*)
