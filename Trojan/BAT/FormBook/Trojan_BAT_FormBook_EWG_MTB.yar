...
rule Trojan_BAT_FormBook_EWG_MTB{
	meta:
		description = "Trojan:BAT/FormBook.EWG!MTB,SIGNATURE_TYPE_PEHSTR_EXT,05 00 05 00 05 00 00 01 00 "
		
	strings :
		$a_81_0 = {41 46 44 59 43 35 34 51 48 47 46 52 52 34 46 38 37 47 45 35 46 58 } //01 00  AFDYC54QHGFRR4F87GE5FX
