...
rule Trojan_BAT_FormBook_CXI_MTB{
	...
	strings :
		$a_01_0 = {54 00 65 00 73 00 74 00 2d 00 4e 00 65 00 74 00 43 00 6f 00 6e 00 6e 00 65 00 63 00 74 00 69 00 6f 00 6e 00 } //01 00 
		...
		$a_01_5 = {47 65 74 53 74 72 69 6e 67 } //01 00 
		$a_01_6 = {44 65 62 75 67 67 61 62 6c 65 41 74 74 72 69 62 75 74 65 } //01 00 
		$a_01_7 = {44 65 62 75 67 67 69 6e 67 4d 6f 64 65 73 } //01 00 
		$a_01_8 = {47 65 74 4d 65 74 68 6f 64 } //01 00 
		$a_01_9 = {47 65 74 45 78 70 6f 72 74 65 64 54 79 70 65 73 } //00 00 
	condition:
		any of ($a_*)
