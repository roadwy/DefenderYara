...
rule Trojan_BAT_FormBook_HA_MTB{
	...
	strings :
		$a_81_0 = {4e 69 6d 69 74 7a 44 45 56 } //01 00 
		...
		$a_81_4 = {72 65 67 4b 65 79 50 61 74 68 } //01 00 
		$a_81_5 = {44 6f 77 6e 6c 6f 61 64 4c 69 73 74 } //01 00 
		...
		$a_81_11 = {73 65 74 50 72 6f 78 79 } //00 00 
	condition:
		any of ($a_*)
