...
rule Trojan_BAT_FormBook_ABFY_MTB{
	...
	strings :
		$a_03_0 = {09 11 05 09 6f 90 01 03 0a 1e 5b 6f 90 01 03 0a 6f 90 01 03 0a 00 09 17 6f 90 01 03 0a 00 08 09 6f 90 01 03 0a 17 73 90 01 03 0a 13 06 00 11 06 02 16 02 8e 69 6f 90 01 03 0a 00 11 06 6f 90 01 03 0a 00 00 de 0d 11 06 2c 08 11 06 6f 90 01 03 0a 00 dc 08 6f 90 01 03 0a 0a 00 de 0b 90 00 } //2
