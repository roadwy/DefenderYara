...
rule Trojan_BAT_FormBook_ABE_MTB{
	...
	strings :
		$a_01_0 = {57 bd 02 3e 09 0f 00 00 00 fa 25 33 00 16 00 00 01 00 00 00 48 00 00 00 2f 00 00 00 5e 00 00 00 12 01 00 00 34 01 00 00 } //5
		...
		$a_01_5 = {70 62 44 65 62 75 67 67 65 72 50 72 65 73 65 6e 74 } //1 pbDebuggerPresent
		$a_01_6 = {47 65 74 52 75 6e 74 69 6d 65 44 69 72 65 63 74 6f 72 79 } //1 GetRuntimeDirectory
