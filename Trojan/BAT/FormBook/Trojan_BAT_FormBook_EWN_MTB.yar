...
rule Trojan_BAT_FormBook_EWN_MTB{
	meta:
		description = "Trojan:BAT/FormBook.EWN!MTB,SIGNATURE_TYPE_PEHSTR_EXT,05 00 05 00 05 00 00 01 00 "
		
	strings :
		$a_81_0 = {37 35 37 38 38 35 35 35 5a 5a 5a 43 55 30 34 42 5a 44 43 35 38 34 } //01 00 
