...
rule Trojan_BAT_Formbook_NWF_MTB{
	...
	strings :
		...
		$a_81_1 = {72 65 77 6a 6e 67 66 67 72 66 71 65 } //01 00 
		$a_81_2 = {47 65 74 50 69 78 65 6c } //01 00 
		$a_81_3 = {57 32 33 35 32 35 33 35 33 34 35 } //01 00 
		$a_81_4 = {43 6f 6c 6f 72 54 72 61 6e 73 6c 61 74 6f 72 } //00 00 
	condition:
		any of ($a_*)
