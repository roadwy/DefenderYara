...
rule Trojan_BAT_FormBook_ASA_MTB{
	...
	strings :
		...
		$a_01_1 = {4c 00 54 00 54 00 51 00 5f 00 53 00 55 00 44 00 4f 00 4b 00 55 00 5f 00 47 00 41 00 4d 00 45 00 } //00 00  LTTQ_SUDOKU_GAME
	condition:
		any of ($a_*)
...
rule Trojan_BAT_FormBook_ASA_MTB_2{
	...
	strings :
		...
		$a_01_1 = {61 00 44 00 61 00 79 00 41 00 74 00 54 00 68 00 65 00 52 00 61 00 63 00 65 00 73 00 } //00 00  aDayAtTheRaces
	condition:
		any of ($a_*)
