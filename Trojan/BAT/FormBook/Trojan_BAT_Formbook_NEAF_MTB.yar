...
rule Trojan_BAT_Formbook_NEAF_MTB{
	...
	strings :
		...
		$a_01_1 = {62 2e 52 2e 72 65 73 6f 75 72 63 65 73 } //02 00  b.R.resources
		$a_01_2 = {31 35 34 61 31 65 32 34 66 32 33 34 66 36 2e 52 65 73 6f 75 72 63 65 73 2e 72 65 73 6f 75 72 63 65 73 } //00 00  154a1e24f234f6.Resources.resources
	condition:
		any of ($a_*)
