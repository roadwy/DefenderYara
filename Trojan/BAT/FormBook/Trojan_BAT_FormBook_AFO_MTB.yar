...
rule Trojan_BAT_FormBook_AFO_MTB_2{
	...
	strings :
		$a_03_0 = {0c 16 0d 2b 1a 07 09 06 09 91 08 09 08 6f 90 01 01 01 00 0a 5d 6f 90 01 01 01 00 0a 61 d2 9c 09 17 58 0d 09 06 8e 69 32 e0 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_BAT_FormBook_AFO_MTB_3{
	...
	strings :
		$a_03_0 = {17 59 9a 0c 08 28 90 01 01 00 00 0a 16 fe 01 13 06 11 06 2d 03 00 2b 2f 00 06 09 6f 90 01 01 00 00 0a 08 6f 90 01 01 00 00 0a 00 08 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_BAT_FormBook_AFO_MTB_4{
	...
	strings :
		$a_03_0 = {0a 16 91 13 05 08 17 8d 90 01 03 01 25 16 11 05 9c 6f 90 01 03 0a 09 18 58 0d 09 07 6f 90 01 03 0a fe 04 13 06 11 06 2d c4 90 00 } //2
...
rule Trojan_BAT_FormBook_AFO_MTB_5{
	...
	strings :
		$a_03_0 = {16 0d 2b 31 00 07 08 09 28 90 01 03 06 28 90 01 03 06 00 28 90 01 03 06 28 90 01 03 06 90 00 } //2
...
rule Trojan_BAT_FormBook_AFO_MTB_6{
	...
	strings :
		$a_03_0 = {17 58 08 5d 13 0d 02 07 11 0a 91 11 0c 61 07 11 0d 91 59 28 90 01 03 06 13 0e 07 11 0a 11 0e 28 90 01 03 0a d2 9c 00 11 0a 17 58 90 00 } //2
...
rule Trojan_BAT_FormBook_AFO_MTB_9{
	...
	strings :
		$a_03_0 = {06 13 04 16 13 05 2b 19 11 04 11 05 a3 90 01 01 00 00 01 13 06 09 11 06 6f 90 01 01 00 00 0a 11 05 17 58 13 05 11 05 11 04 8e 69 32 df 90 00 } //1
		$a_03_1 = {0a 16 0b 38 90 01 01 00 00 00 06 07 17 5b 7e 90 01 01 00 00 0a a4 90 01 01 00 00 01 07 17 58 0b 07 02 8e 69 32 e8 90 00 } //1
	condition:
...
rule Trojan_BAT_FormBook_AFO_MTB_10{
	...
	strings :
		$a_03_0 = {0b 16 0c 2b 14 07 08 02 7b 90 01 03 04 08 91 28 90 01 03 0a 9d 08 17 58 0c 08 06 fe 04 0d 09 2d e4 90 00 } //1
		$a_03_1 = {26 2b 1c 00 02 7b 90 01 01 00 00 04 07 6f 90 01 01 00 00 0a 6f 90 01 01 00 00 06 26 1f 64 28 90 01 01 00 00 0a 00 00 07 6f 90 01 01 00 00 0a 16 fe 01 0c 08 2d d7 90 00 } //1
	condition:
		((#a_03_0  & 1)*1+(#a_03_1  & 1)*1) >=2
...
rule Trojan_BAT_FormBook_AFO_MTB_11{
	...
	strings :
		$a_03_0 = {13 04 2b 4e 00 08 11 04 08 8e 69 5d 02 08 11 04 08 8e 69 5d 91 09 11 04 09 6f 90 01 01 00 00 0a 5d 6f 90 01 01 00 00 0a 61 28 90 01 01 00 00 0a 08 11 04 17 58 08 8e 69 5d 91 90 00 } //2
