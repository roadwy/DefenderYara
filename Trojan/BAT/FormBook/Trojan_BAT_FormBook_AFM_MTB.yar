...
rule Trojan_BAT_FormBook_AFM_MTB{
	...
	strings :
		$a_03_0 = {11 0a 17 58 08 5d 13 0d 02 07 11 0a 91 11 0c 61 07 11 0d 91 59 28 90 01 01 00 00 06 13 0e 11 10 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_BAT_FormBook_AFM_MTB_4{
	...
	strings :
		$a_03_0 = {16 13 05 2b 21 00 02 7b 90 01 01 00 00 04 11 05 02 7b 90 01 01 00 00 04 11 05 91 20 e5 05 00 00 59 d2 9c 00 11 05 17 58 13 05 11 05 02 7b 90 01 01 00 00 04 8e 69 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_BAT_FormBook_AFM_MTB_5{
	...
	strings :
		$a_03_0 = {16 0d 2b 1d 07 09 18 6f 90 01 03 0a 1f 10 28 90 01 03 0a 13 05 08 11 05 6f 90 01 03 0a 09 18 58 0d 09 07 6f 90 01 03 0a fe 04 13 06 11 06 2d d4 90 00 } //2
...
rule Trojan_BAT_FormBook_AFM_MTB_7{
	...
	strings :
		$a_03_0 = {13 05 17 8d 08 00 00 01 25 16 7e 4b 00 00 04 a2 13 06 72 f2 16 00 70 72 bf 18 00 70 72 01 00 00 70 28 90 01 01 00 00 0a 28 90 01 01 00 00 0a 13 07 11 07 09 11 05 14 14 11 06 90 00 } //2
...
rule Trojan_BAT_FormBook_AFM_MTB_8{
	...
	strings :
		$a_03_0 = {16 9a 0c 08 19 8d 90 01 03 01 25 16 7e 2b 00 00 04 16 9a a2 25 17 7e 2b 00 00 04 17 9a a2 25 18 90 00 } //2
		$a_03_1 = {16 0b 2b 1a 00 06 07 02 07 18 5a 18 6f 90 01 03 0a 1f 10 28 90 01 03 0a 9c 00 07 17 58 0b 07 06 8e 69 90 00 } //2
...
rule Trojan_BAT_FormBook_AFM_MTB_9{
	...
	strings :
		$a_03_0 = {07 08 09 28 90 01 03 06 28 90 01 03 06 00 28 90 01 03 06 28 90 01 03 06 28 90 01 03 06 00 28 90 01 03 06 d2 06 28 90 01 03 06 00 00 09 1b 59 1c 58 90 00 } //2
...
rule Trojan_BAT_FormBook_AFM_MTB_10{
	...
	strings :
		$a_03_0 = {25 16 1f 3d 9d 6f 90 01 01 00 00 0a 0c 08 16 9a 6f 90 01 01 00 00 0a 13 06 11 06 72 90 01 01 09 00 70 28 90 01 01 00 00 0a 2d 02 2b 21 08 17 9a 6f 90 00 } //2
