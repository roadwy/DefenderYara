...
rule Trojan_BAT_FormBook_EYF_MTB{
	...
	strings :
		$a_01_0 = {42 00 38 00 44 00 32 00 35 00 54 00 } //1 B8D25T
		$a_01_1 = {50 00 61 00 72 00 65 00 74 00 68 00 65 00 72 00 66 00 6c 00 65 00 6e 00 2e 00 54 00 75 00 63 00 73 00 6f 00 6e 00 } //1 Paretherflen.Tucson
