...
rule Trojan_BAT_FormBook_EXB_MTB{
	...
	strings :
		$a_01_0 = {24 31 33 65 62 37 65 66 36 2d 64 62 31 30 2d 34 35 32 65 2d 38 34 37 31 2d 36 39 65 37 63 61 32 65 65 65 31 35 } //01 00 
		$a_01_1 = {00 75 67 7a 31 00 75 67 7a 33 00 70 72 6f 6a 6e 61 6d 65 00 } //01 00 
