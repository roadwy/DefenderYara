...
rule Trojan_BAT_Formbook_EO_MTB{
	...
	strings :
		$a_81_0 = {24 39 37 65 63 31 34 63 64 2d 38 33 37 38 2d 34 66 38 65 2d 39 31 61 61 2d 34 37 34 65 32 62 64 30 31 35 62 37 } //01 00  $97ec14cd-8378-4f8e-91aa-474e2bd015b7
