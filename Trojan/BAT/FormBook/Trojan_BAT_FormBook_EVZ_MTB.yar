...
rule Trojan_BAT_FormBook_EVZ_MTB_2{
	...
	strings :
		...
		$a_01_1 = {00 53 74 72 69 6e 67 54 79 70 65 49 6e 66 6f 00 } //01 00  匀牴湩呧灹䥥普o
		$a_01_2 = {00 49 6e 70 75 74 42 6c 6f 63 6b 53 69 7a 65 00 } //01 00  䤀灮瑵求捯卫穩e
		...
		$a_01_5 = {00 4c 6f 77 65 73 74 42 72 65 61 6b 49 74 65 72 61 74 69 6f 6e 00 } //01 00  䰀睯獥䉴敲歡瑉牥瑡潩n
		$a_01_6 = {00 43 6c 6f 6e 65 48 65 6c 70 65 72 2e 64 6c 6c 00 } //01 00 
		$a_01_7 = {00 44 61 74 61 4d 69 73 61 6c 69 67 6e 65 64 00 } //01 00  䐀瑡䵡獩污杩敮d
