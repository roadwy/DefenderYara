...
rule Trojan_BAT_FormBook_EXI_MTB{
	...
	strings :
		$a_81_0 = {43 41 34 45 55 34 4a 37 54 47 34 59 37 42 35 34 34 48 34 38 37 4f } //0a 00  CA4EU4J7TG4Y7B544H487O
		$a_81_1 = {49 4b 4d 4e 4a 55 48 42 56 47 59 54 46 43 58 44 52 45 53 5a 41 57 51 } //01 00  IKMNJUHBVGYTFCXDRESZAWQ
