...
rule Trojan_BAT_FormBook_ABT_MTB{
	...
	strings :
		...
		$a_01_3 = {59 00 35 00 74 00 46 00 76 00 55 00 38 00 45 00 59 00 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_BAT_FormBook_ABT_MTB_2{
	...
	strings :
		...
		$a_01_3 = {4d 4e 56 4a 44 46 48 4a 44 46 2e 50 72 6f 70 65 72 74 69 65 73 2e 52 65 73 6f 75 72 63 65 73 2e 72 65 73 6f 75 72 63 65 73 } //01 00 
		$a_01_4 = {24 61 36 38 39 62 66 30 63 2d 63 65 62 36 2d 34 38 39 35 2d 38 37 32 30 2d 65 65 62 33 34 36 35 35 33 36 65 66 } //01 00 
		$a_01_5 = {43 6f 6e 66 75 73 65 72 } //00 00 
	condition:
		any of ($a_*)
