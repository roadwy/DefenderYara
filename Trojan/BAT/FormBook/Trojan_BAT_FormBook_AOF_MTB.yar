...
rule Trojan_BAT_FormBook_AOF_MTB_2{
	...
	strings :
		...
		$a_01_1 = {50 00 72 00 6f 00 76 00 61 00 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_BAT_FormBook_AOF_MTB_3{
	...
	strings :
		...
		$a_01_1 = {46 00 72 00 6f 00 6d 00 42 00 61 00 73 00 65 00 36 00 34 00 53 00 74 00 72 00 69 00 6e 00 67 00 } //00 00 
	condition:
		any of ($a_*)
