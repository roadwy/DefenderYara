...
rule Trojan_BAT_FormBook_AOF_MTB_2{
	...
	strings :
		$a_03_0 = {7b 2a 00 00 04 72 92 07 00 70 6f 90 01 03 0a 00 02 7b 2a 00 00 04 16 6f 90 01 03 0a 00 73 7f 00 00 0a 0b 06 72 bc 07 00 70 6f 90 01 03 0a 74 02 00 00 1b 0c 08 90 00 } //2
...
rule Trojan_BAT_FormBook_AOF_MTB_3{
	...
	strings :
		$a_03_0 = {0d 16 25 2d 1f 0a 2b 1b 13 04 1d 2c a9 2b c1 09 06 91 13 05 08 11 05 6f 90 01 03 0a 06 17 58 16 2d f0 0a 06 09 8e 69 32 e6 08 90 00 } //2
