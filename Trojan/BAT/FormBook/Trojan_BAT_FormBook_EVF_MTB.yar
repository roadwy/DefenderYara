...
rule Trojan_BAT_FormBook_EVF_MTB{
	...
	strings :
		$a_01_0 = {42 00 43 00 48 00 47 00 50 00 41 00 38 00 45 00 41 00 46 00 38 00 53 00 41 00 42 00 43 00 38 00 58 00 5a 00 54 00 4e 00 4b 00 34 00 } //01 00  BCHGPA8EAF8SABC8XZTNK4
