...
rule Trojan_BAT_FormBook_ATN_MTB{
	meta:
		description = "Trojan:BAT/FormBook.ATN!MTB,SIGNATURE_TYPE_PEHSTR_EXT,04 00 04 00 03 00 00 02 00 "
	...
	strings :
		...
		$a_01_2 = {48 00 65 00 61 00 6c 00 74 00 68 00 53 00 74 00 6f 00 70 00 43 00 6c 00 69 00 65 00 6e 00 74 00 } //00 00  HealthStopClient
	condition:
		any of ($a_*)
