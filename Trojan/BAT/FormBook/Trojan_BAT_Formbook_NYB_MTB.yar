...
rule Trojan_BAT_Formbook_NYB_MTB{
	...
	strings :
		$a_03_0 = {5a 1e 58 6a 58 6f 90 01 03 0a 05 6f 90 01 03 0a 0b 05 6f 90 01 03 0a 0c 05 6f 90 01 03 0a 26 05 6f 90 01 03 0a 0d 08 02 42 90 01 03 00 02 08 07 58 90 00 } //1
