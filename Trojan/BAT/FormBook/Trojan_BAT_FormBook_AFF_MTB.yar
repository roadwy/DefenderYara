...
rule Trojan_BAT_FormBook_AFF_MTB{
	...
	strings :
		...
		$a_01_1 = {51 00 75 00 61 00 6e 00 4c 00 79 00 42 00 61 00 6e 00 56 00 65 00 4d 00 61 00 79 00 42 00 61 00 79 00 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_BAT_FormBook_AFF_MTB_2{
	...
	strings :
		...
		$a_01_1 = {54 00 65 00 63 00 68 00 6e 00 69 00 74 00 65 00 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_BAT_FormBook_AFF_MTB_3{
	...
	strings :
		...
		$a_01_1 = {51 00 75 00 61 00 6e 00 4c 00 79 00 4e 00 68 00 61 00 6e 00 53 00 75 00 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_BAT_FormBook_AFF_MTB_4{
	...
	strings :
		...
		$a_01_1 = {53 00 75 00 64 00 6f 00 6b 00 75 00 47 00 61 00 6d 00 65 00 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_BAT_FormBook_AFF_MTB_5{
	...
	strings :
		...
		$a_01_1 = {51 00 4c 00 5f 00 4b 00 41 00 52 00 41 00 4f 00 4b 00 45 00 } //00 00 
	condition:
		any of ($a_*)
