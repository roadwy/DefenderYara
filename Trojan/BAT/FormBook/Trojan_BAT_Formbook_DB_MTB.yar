...
rule Trojan_BAT_Formbook_DB_MTB{
	...
	strings :
		$a_81_0 = {24 41 33 41 43 39 44 44 46 2d 32 30 35 42 2d 34 41 43 30 2d 42 31 42 35 2d 41 42 30 32 32 33 43 33 45 39 39 32 } //01 00  $A3AC9DDF-205B-4AC0-B1B5-AB0223C3E992
		$a_81_1 = {67 65 74 5f 53 65 61 47 72 65 65 6e } //01 00  get_SeaGreen
		$a_81_2 = {53 74 61 66 66 5f 53 61 6c 61 72 79 } //01 00  Staff_Salary
		$a_81_3 = {43 6f 6c 6c 6f 71 75 69 75 6d } //01 00  Colloquium
		$a_81_4 = {67 65 74 46 65 65 73 } //01 00  getFees
		$a_81_5 = {54 6f 79 6f 74 61 } //01 00  Toyota
		$a_81_6 = {43 61 6d 72 79 } //00 00  Camry
	condition:
		any of ($a_*)
