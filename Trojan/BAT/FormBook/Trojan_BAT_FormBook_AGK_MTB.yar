...
rule Trojan_BAT_FormBook_AGK_MTB{
	...
	strings :
		$a_03_0 = {16 0d 2b 3f 00 16 13 04 2b 24 00 08 09 11 04 6f 90 01 03 0a 13 0b 07 11 05 12 0b 28 90 01 03 0a 9c 11 05 17 58 13 05 00 11 04 17 58 13 04 11 04 08 6f 90 01 03 0a fe 04 13 0c 11 0c 2d cc 90 00 } //2
