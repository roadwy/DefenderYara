...
rule Trojan_BAT_Formbook_DT_MTB{
	meta:
		description = "Trojan:BAT/Formbook.DT!MTB,SIGNATURE_TYPE_PEHSTR_EXT,09 00 09 00 09 00 00 01 00 "
		
	strings :
		$a_81_0 = {53 63 72 65 65 6e 43 61 70 74 75 72 65 72 2e 50 72 6f 70 65 72 74 69 65 73 2e 52 65 73 6f 75 72 63 65 73 } //01 00  ScreenCapturer.Properties.Resources
		$a_81_1 = {53 63 72 65 65 6e 43 61 70 74 75 72 65 72 2e 65 78 65 } //01 00  ScreenCapturer.exe
		$a_81_2 = {43 6f 6d 70 69 6c 61 74 69 6f 6e 52 65 6c 61 78 61 74 69 6f 6e 73 41 74 74 72 69 62 75 74 65 } //01 00  CompilationRelaxationsAttribute
		...
		$a_81_8 = {47 65 74 44 6f 6d 61 69 6e } //00 00  GetDomain
	condition:
		any of ($a_*)
