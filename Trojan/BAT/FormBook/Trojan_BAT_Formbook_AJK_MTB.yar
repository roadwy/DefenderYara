...
rule Trojan_BAT_Formbook_AJK_MTB{
	...
	strings :
		...
		$a_01_1 = {43 00 75 00 61 00 48 00 61 00 6e 00 67 00 44 00 54 00 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_BAT_Formbook_AJK_MTB_2{
	...
	strings :
		...
		$a_01_1 = {6f 00 62 00 73 00 74 00 61 00 63 00 6c 00 65 00 5f 00 61 00 76 00 6f 00 69 00 64 00 61 00 6e 00 63 00 65 00 31 00 } //00 00 
	condition:
		any of ($a_*)
