...
rule Trojan_BAT_Vahodon_D{
	...
	strings :
		...
		$a_00_1 = {73 00 65 00 6e 00 64 00 66 00 69 00 6c 00 65 00 } //01 00 
		$a_01_2 = {64 00 6f 00 77 00 6e 00 6c 00 6f 00 61 00 64 00 66 00 69 00 6c 00 65 00 7c 00 7c 00 } //01 00 
