...
rule Trojan_BAT_Darkcloud_AAZA_MTB{
	...
	strings :
		...
		$a_03_1 = {06 13 04 1a 2b b9 28 90 01 01 00 00 06 28 90 01 01 00 00 0a 0c 2b e8 26 1c 17 2d a7 26 11 04 0d 1e 16 2c 9f 90 00 } //2
		$a_03_2 = {06 25 26 20 00 01 00 00 14 14 09 28 90 01 01 00 00 06 6f 90 01 01 00 00 0a 25 26 26 90 00 } //2
