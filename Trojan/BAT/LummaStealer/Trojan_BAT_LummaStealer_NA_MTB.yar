...
rule Trojan_BAT_LummaStealer_NA_MTB{
	...
	strings :
		$a_03_0 = {72 93 00 00 70 1b 28 90 01 01 00 00 06 72 93 00 00 70 28 90 01 01 00 00 0a 13 06 11 06 28 90 01 01 00 00 0a 16 90 00 } //5
...
rule Trojan_BAT_LummaStealer_NA_MTB_2{
	...
	strings :
		$a_03_0 = {28 61 38 00 06 0c 28 90 01 02 00 0a 03 6f 90 01 02 00 0a 28 90 01 02 00 06 0d 73 90 01 02 00 0a 13 04 28 90 01 02 00 06 13 05 11 05 08 6f 90 01 02 00 0a 11 05 09 6f 90 01 02 00 0a 11 04 11 05 90 00 } //5
