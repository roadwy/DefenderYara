...
rule Trojan_BAT_LummaStealer_MB_MTB{
	...
	strings :
		$a_03_0 = {a2 25 17 72 90 01 03 70 a2 25 18 11 02 a2 a2 a2 38 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_BAT_LummaStealer_MB_MTB_2{
	...
	strings :
		$a_03_0 = {0b 07 17 1f 0b 6f 90 01 03 0a 0c 08 02 8e 69 3c 90 01 04 08 02 8e 69 3d 90 01 04 73 90 01 03 06 26 2a 90 00 } //1
