...
rule Trojan_BAT_Strab_ISAA_MTB{
	...
	strings :
		$a_03_0 = {03 11 11 8f 90 01 01 00 00 01 25 71 90 01 01 00 00 01 11 90 01 01 11 13 7e 90 01 01 00 00 04 28 90 01 01 01 00 06 a5 90 01 01 00 00 01 61 d2 90 00 } //5
