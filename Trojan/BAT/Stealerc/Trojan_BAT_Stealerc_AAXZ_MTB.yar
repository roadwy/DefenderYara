...
rule Trojan_BAT_Stealerc_AAXZ_MTB{
	...
	strings :
		$a_03_0 = {05 1f 10 28 90 01 01 00 00 2b 1f 20 28 90 01 01 00 00 2b 28 90 01 01 00 00 2b 0c 20 05 00 00 00 38 90 01 02 00 00 11 08 28 90 01 02 00 06 13 09 90 00 } //2
		$a_03_1 = {11 09 09 16 09 8e 69 6f 90 01 01 00 00 0a 13 06 90 00 } //2
