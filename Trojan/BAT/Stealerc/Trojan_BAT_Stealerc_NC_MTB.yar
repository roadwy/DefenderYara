...
rule Trojan_BAT_Stealerc_NC_MTB{
	...
	strings :
		$a_03_0 = {61 d2 52 07 08 8f 90 01 01 00 00 01 25 47 07 11 05 91 06 1a 58 4a 61 d2 61 d2 52 07 11 05 8f 07 00 00 01 25 47 07 08 91 61 d2 52 11 05 17 58 90 00 } //5
