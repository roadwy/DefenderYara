...
rule Trojan_BAT_Injectgen_MA_MTB{
	...
	strings :
		...
		$a_01_8 = {56 69 72 74 75 61 6c 41 6c 6c 6f 63 45 78 } //01 00 
		$a_01_9 = {52 65 73 75 6d 65 54 68 72 65 61 64 } //01 00 
		$a_01_10 = {57 72 69 74 65 50 72 6f 63 65 73 73 4d 65 6d 6f 72 79 } //00 00 
	condition:
		any of ($a_*)
