...
rule Trojan_BAT_Injectgen_MA_MTB{
	...
	strings :
		$a_03_0 = {13 05 11 05 20 00 01 00 00 6f 90 01 03 0a 11 05 17 6f 90 01 03 0a 11 05 0b 03 2d 1f 07 06 1f 10 6f 90 01 03 0a 28 90 01 03 0a 72 90 01 03 70 6f 90 01 03 0a 6f 90 01 03 0a 2b 1d 07 06 1f 10 6f 90 01 03 0a 28 90 01 03 0a 72 90 01 03 70 6f 90 01 03 0a 6f 90 01 03 0a 0c 73 90 01 03 0a 0d 09 08 17 73 90 01 03 0a 13 04 11 04 02 16 02 8e 69 6f 90 01 03 0a 11 04 6f 90 01 03 0a de 90 00 } //1
