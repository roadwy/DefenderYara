...
rule Trojan_BAT_Diztakun_ADT_MTB{
	...
	strings :
		$a_03_0 = {09 06 07 6f 90 01 03 0a 00 00 de 0b 09 2c 07 09 6f 90 01 03 0a 00 dc 07 28 90 01 03 0a 0c 08 6f 90 01 03 0a 00 07 28 90 01 03 0a 13 04 11 04 2c 09 00 07 28 90 00 } //2
