...
rule Trojan_BAT_SpyAgent_MA_MTB{
	...
	strings :
		$a_03_0 = {06 02 07 6f 90 01 03 0a 03 07 03 6f 90 01 03 0a 5d 6f 90 01 03 0a 61 d1 6f 90 01 03 0a 26 07 17 58 0b 07 02 6f 90 01 03 0a 32 d5 06 6f 90 01 03 0a 2a 90 00 } //1
