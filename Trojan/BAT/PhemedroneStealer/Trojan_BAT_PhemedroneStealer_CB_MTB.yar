...
rule Trojan_BAT_PhemedroneStealer_CB_MTB{
	...
	strings :
		$a_03_0 = {fe 0c 00 00 fe 0c 02 00 91 fe 0e 03 00 7e 90 01 04 fe 0c 02 00 7e 90 01 04 6f 6e 00 00 0a 5d 6f 1a 01 00 0a fe 0e 04 00 fe 0c 03 00 fe 0c 04 00 61 d1 fe 0e 90 00 } //1
