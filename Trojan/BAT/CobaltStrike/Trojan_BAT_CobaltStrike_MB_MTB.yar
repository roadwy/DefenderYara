...
rule Trojan_BAT_CobaltStrike_MB_MTB{
	...
	strings :
		$a_03_0 = {11 05 11 04 11 0a 9a 1f 10 28 90 01 03 0a 86 6f 90 01 03 0a 00 11 0a 17 d6 13 0a 11 0a 11 09 31 df 90 00 } //2
		$a_03_1 = {da 04 d6 1f 1a 5d 13 07 07 11 06 28 90 01 03 0a 11 07 d6 90 00 } //2
