...
rule Trojan_BAT_CobaltStrike_AAMI_MTB{
	...
	strings :
		$a_03_0 = {0a 00 25 17 6f ?? 00 00 0a 00 25 18 6f ?? 00 00 0a 00 0d 09 6f ?? 00 00 0a 13 04 11 04 08 16 08 8e 69 6f ?? 00 00 0a 13 05 28 ?? 00 00 0a 11 05 6f ?? 00 00 0a 13 0a de 0b } //4
