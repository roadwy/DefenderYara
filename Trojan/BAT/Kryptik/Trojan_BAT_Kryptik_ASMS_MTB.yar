...
rule Trojan_BAT_Kryptik_ASMS_MTB{
	meta:
		description = "Trojan:BAT/Kryptik.ASMS!MTB,SIGNATURE_TYPE_PEHSTR_EXT,14 00 14 00 0b 00 00 "
	...
	strings :
		...
		$a_01_7 = {75 70 64 61 74 65 42 6f 61 72 64 } //1 updateBoard
		$a_01_8 = {54 65 74 72 69 73 47 61 6d 65 5f 4b 65 79 44 6f 77 6e } //1 TetrisGame_KeyDown
		$a_01_9 = {54 65 74 72 69 73 47 61 6d 65 5f 4b 65 79 50 72 65 73 73 } //1 TetrisGame_KeyPress
		$a_01_10 = {54 65 74 72 69 73 47 61 6d 65 5f 4b 65 79 55 70 } //1 TetrisGame_KeyUp
	condition:
