...
rule Trojan_BAT_Kryptik_KI_MTB{
	...
	strings :
		$a_03_0 = {09 11 04 9a 13 05 11 05 28 90 02 04 23 00 00 00 00 00 80 73 40 59 28 90 02 04 b7 13 06 07 11 06 28 90 02 04 6f 90 02 04 26 00 11 04 17 d6 13 04 11 04 09 8e 69 fe 04 13 07 11 07 2d bf 90 00 } //10
