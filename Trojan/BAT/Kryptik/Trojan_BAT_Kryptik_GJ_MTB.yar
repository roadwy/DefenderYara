...
rule Trojan_BAT_Kryptik_GJ_MTB{
	...
	strings :
		$a_03_0 = {13 05 11 05 28 90 02 04 13 06 11 06 72 90 02 15 13 07 11 07 14 18 8d 90 02 04 13 08 11 08 16 28 90 02 09 16 9a 28 90 02 04 a2 11 08 17 11 04 a2 11 08 6f 90 00 } //10
