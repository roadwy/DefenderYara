...
rule Trojan_BAT_Kryptik_SL_MTB{
	...
	strings :
		$a_03_0 = {0b 07 14 72 90 02 04 18 8d 90 02 04 25 16 1e 8d 90 02 04 25 d0 90 02 04 28 90 02 04 a2 25 17 1e 90 00 } //10
		$a_03_1 = {a2 14 14 28 90 02 09 0c 08 14 72 90 02 04 19 8d 90 02 04 25 16 02 a2 25 17 16 8c 90 02 04 a2 25 18 20 90 02 09 a2 14 14 28 90 02 09 0a 2b 00 06 2a 90 00 } //10
