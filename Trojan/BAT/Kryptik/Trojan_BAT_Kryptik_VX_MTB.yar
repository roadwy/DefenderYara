...
rule Trojan_BAT_Kryptik_VX_MTB{
	...
	strings :
		$a_03_0 = {06 02 07 28 90 02 04 25 26 03 07 03 28 90 02 04 25 26 5d 28 90 02 04 25 26 61 d1 28 90 02 04 25 26 26 07 17 58 0b 07 02 28 90 02 04 25 26 90 00 } //10
