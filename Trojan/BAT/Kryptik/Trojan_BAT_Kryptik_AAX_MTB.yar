...
rule Trojan_BAT_Kryptik_AAX_MTB{
	...
	strings :
		$a_03_0 = {9a 0c 08 19 8d 90 02 04 25 16 7e 90 02 04 a2 25 17 7e 90 02 04 a2 25 18 72 90 02 04 a2 28 90 02 04 26 20 00 08 00 00 0a 2b 00 06 2a 90 00 } //10
...
rule Trojan_BAT_Kryptik_AAX_MTB_2{
	...
	strings :
		$a_03_0 = {0b 07 1f 21 8c 90 02 04 16 28 90 02 04 07 1f 7e 8c 90 02 04 16 28 90 02 0f 13 06 11 06 2c 3d 06 1f 21 8c 90 02 04 07 1f 0e 8c 90 02 09 1f 5e 8c 90 01 22 0a 2b 17 06 07 28 90 00 } //10
