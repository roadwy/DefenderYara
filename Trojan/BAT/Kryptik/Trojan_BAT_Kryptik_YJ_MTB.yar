...
rule Trojan_BAT_Kryptik_YJ_MTB{
	...
	strings :
		$a_03_0 = {04 08 04 6f ?? ?? ?? ?? 5d 17 d6 28 ?? ?? ?? ?? da 0d 06 09 28 [0-0f] 0a 00 08 17 d6 0c 08 11 04 13 05 11 05 31 c7 } //10
		$a_03_1 = {04 08 04 6f ?? ?? ?? ?? 5d 17 d6 28 ?? ?? ?? ?? da 0d 18 2b be 06 09 28 [0-0f] 0a 19 2b a9 08 17 d6 0c 08 11 04 13 05 11 05 31 c2 } //10
