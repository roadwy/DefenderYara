...
rule Trojan_BAT_Kryptik_WF_MTB{
	...
	strings :
		$a_03_0 = {2b 31 03 09 28 [0-04] 04 09 04 6f [0-04] 5d 17 d6 28 [0-04] da 13 04 07 11 04 28 [0-04] 28 [0-04] 28 [0-04] 0b 09 17 d6 0d 09 08 31 cb } //10
		$a_03_1 = {0a 0c 08 28 [0-04] 03 6f [0-04] 6f [0-04] 0d 07 09 6f [0-05] 07 18 6f [0-05] 07 6f [0-04] 04 16 04 8e 69 6f [0-04] 13 04 11 04 0a 2b 00 06 2a } //10
