...
rule Trojan_BAT_Kryptik_VC_MTB{
	...
	strings :
		$a_03_0 = {0b 07 19 8d 90 01 04 25 16 7e 90 01 04 a2 25 17 7e 90 01 04 a2 25 18 72 90 01 04 a2 28 90 01 04 26 20 90 01 04 0a 2b 00 06 2a 90 00 } //10
		$a_03_1 = {0d 07 09 6f 90 01 05 07 18 6f 90 01 05 07 6f 90 01 04 03 16 03 8e 69 6f 90 01 04 13 04 11 04 0a 2b 00 06 2a 90 00 } //10
