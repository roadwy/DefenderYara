...
rule Trojan_BAT_zgRat_NZA_MTB{
	...
	strings :
		$a_03_0 = {28 0f 00 00 0a 28 90 01 03 06 6f 90 01 03 0a 28 90 01 03 0a 28 90 01 03 06 0a dd 90 01 03 00 90 00 } //5
...
rule Trojan_BAT_zgRat_NZA_MTB_2{
	...
	strings :
		$a_03_0 = {28 0c 00 00 06 0a 28 90 01 01 00 00 0a 06 6f 90 01 01 00 00 0a 28 90 01 01 00 00 06 75 90 01 01 00 00 1b 0b 07 16 07 8e 69 28 10 00 00 0a 07 90 00 } //5
