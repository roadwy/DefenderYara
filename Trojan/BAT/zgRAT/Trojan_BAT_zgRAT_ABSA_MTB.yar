...
rule Trojan_BAT_zgRAT_ABSA_MTB{
	...
	strings :
		$a_03_0 = {0c 08 07 6f 90 01 01 00 00 0a 16 73 90 01 01 00 00 0a 0d 06 8e 69 8d 90 01 01 00 00 01 13 04 09 11 04 16 11 04 8e 69 6f 90 01 01 00 00 0a 26 11 04 28 90 01 01 00 00 06 26 73 90 01 01 00 00 06 17 6f 90 01 01 00 00 06 7e 90 01 01 00 00 04 6f 90 01 01 00 00 06 de 14 09 2c 06 09 6f 90 01 01 00 00 0a dc 90 00 } //5
