...
rule Trojan_BAT_Racealer_MT_MTB{
	...
	strings :
		$a_02_0 = {2c 0b 06 6f 90 02 04 28 90 02 04 2a 90 09 32 00 02 28 90 02 04 73 90 02 04 0a 28 90 02 04 14 fe 90 02 05 73 90 02 04 6f 90 02 04 06 6f 90 02 04 7e 90 02 04 28 90 00 } //1
