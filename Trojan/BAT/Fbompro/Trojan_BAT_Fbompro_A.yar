...
rule Trojan_BAT_Fbompro_A{
	...
	strings :
		$a_03_0 = {0a 02 7b 13 00 00 04 72 90 01 02 00 70 28 66 00 00 0a 28 9e 00 00 0a 2c 1a 02 7b 13 00 00 04 72 90 01 02 00 70 28 66 00 00 0a 28 9e 00 00 0a 16 fe 01 90 00 } //1
