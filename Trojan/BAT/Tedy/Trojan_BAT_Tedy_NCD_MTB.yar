...
rule Trojan_BAT_Tedy_NCD_MTB{
	...
	strings :
		...
		$a_01_1 = {4c 6f 67 69 6e 20 50 61 67 65 20 44 65 73 69 67 6e 20 55 49 } //01 00 
		$a_01_2 = {31 00 33 00 2e 00 32 00 32 00 38 00 2e 00 37 00 37 00 2e 00 37 00 39 00 } //00 00 
	condition:
		any of ($a_*)
