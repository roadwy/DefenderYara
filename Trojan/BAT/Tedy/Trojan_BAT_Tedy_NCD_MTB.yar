...
rule Trojan_BAT_Tedy_NCD_MTB{
	...
	strings :
		$a_03_0 = {07 08 6f 32 00 00 0a 0d 06 09 28 90 01 02 00 0a 13 04 12 04 72 90 01 02 00 70 28 90 01 02 00 0a 6f 90 01 02 00 0a 26 08 17 58 0c 08 07 6f 90 01 02 00 0a 32 d0 90 00 } //5
