...
rule Trojan_BAT_Tedy_NEAC_MTB{
	...
	strings :
		...
		$a_01_1 = {61 00 48 00 52 00 30 00 63 00 48 00 4d 00 36 00 4c 00 79 00 39 00 30 00 4c 00 6d 00 31 00 6c 00 4c 00 31 00 4a 00 6c 00 63 00 6e 00 56 00 73 00 62 00 47 00 38 00 3d 00 } //00 00 
	condition:
		any of ($a_*)
