...
rule Trojan_BAT_Tedy_NBA_MTB{
	...
	strings :
		$a_03_0 = {6f 26 00 00 0a 6f 90 01 01 00 00 0a 0a 28 90 01 01 00 00 0a 04 28 90 01 01 00 00 06 16 1f 10 6f 90 01 01 00 00 0a 6f 90 01 01 00 00 0a 0b 02 06 07 28 90 01 01 00 00 06 90 00 } //5
