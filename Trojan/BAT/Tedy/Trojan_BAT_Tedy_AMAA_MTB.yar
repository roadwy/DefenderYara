...
rule Trojan_BAT_Tedy_AMAA_MTB{
	...
	strings :
		$a_03_0 = {06 26 06 72 90 01 01 04 00 70 28 90 01 01 00 00 06 26 06 72 90 01 01 04 00 70 28 90 01 01 00 00 0a 6f 90 01 01 00 00 0a 00 06 6f 90 01 01 00 00 0a 02 16 02 8e 69 6f 90 01 01 00 00 0a 0b 2b 00 07 2a 90 00 } //4
