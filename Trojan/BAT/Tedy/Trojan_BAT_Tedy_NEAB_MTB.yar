...
rule Trojan_BAT_Tedy_NEAB_MTB{
	...
	strings :
		...
		$a_01_1 = {73 00 6f 00 6d 00 65 00 72 00 61 00 6e 00 64 00 6f 00 6d 00 66 00 69 00 6c 00 65 00 } //02 00  somerandomfile
		$a_01_2 = {64 00 66 00 61 00 67 00 6e 00 6d 00 62 00 68 00 62 00 53 00 62 00 6d 00 61 00 } //00 00  dfagnmbhbSbma
	condition:
		any of ($a_*)
