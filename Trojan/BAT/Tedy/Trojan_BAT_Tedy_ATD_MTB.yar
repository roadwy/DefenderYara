...
rule Trojan_BAT_Tedy_ATD_MTB{
	...
	strings :
		$a_03_0 = {06 07 11 04 28 90 01 01 00 00 0a 28 90 01 01 00 00 0a 28 90 01 01 00 00 0a 0c 1f 0c 13 07 72 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_BAT_Tedy_ATD_MTB_5{
	...
	strings :
		$a_03_0 = {72 61 00 00 70 28 90 01 03 06 0a 28 90 01 03 0a 06 6f 90 01 03 0a 28 90 01 03 0a 28 90 01 03 06 0b dd 03 00 00 00 26 de d6 90 00 } //1
...
rule Trojan_BAT_Tedy_ATD_MTB_6{
	...
	strings :
		$a_03_0 = {2b 28 00 06 28 90 01 03 06 0b 07 20 01 80 00 00 fe 01 0c 08 2c 0f 00 7e 90 01 03 04 06 d1 6f 90 01 03 0a 26 00 00 06 17 58 90 00 } //2
