...
rule Trojan_BAT_Tedy_GNC_MTB{
	...
	strings :
		...
		$a_01_1 = {35 30 35 5c 35 30 35 5c 6f 62 6a 5c 52 65 6c 65 61 73 65 5c 66 75 63 6b 79 6f 75 77 61 72 65 2e 70 64 62 } //01 00 
		$a_01_2 = {66 75 63 6b 79 6f 75 77 61 72 65 2e 65 78 65 } //01 00 
