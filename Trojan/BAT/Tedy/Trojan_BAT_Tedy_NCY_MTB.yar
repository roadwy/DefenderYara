...
rule Trojan_BAT_Tedy_NCY_MTB{
	...
	strings :
		$a_03_0 = {73 15 00 00 0a 0d 08 19 18 73 90 01 03 0a 0a 09 07 16 07 8e 69 6f 90 01 03 0a 00 06 09 6f 90 01 03 0a 16 09 6f 90 01 03 0a 8e 69 6f 90 01 03 0a 90 00 } //5
