...
rule Trojan_BAT_Tedy_ATE_MTB{
	...
	strings :
		$a_03_0 = {72 6b 00 00 70 28 90 01 03 06 0a 28 90 01 03 0a 06 6f 90 01 03 0a 28 90 01 03 0a 28 90 01 03 06 0b dd 03 00 00 00 26 de d6 90 00 } //1
...
rule Trojan_BAT_Tedy_ATE_MTB_2{
	...
	strings :
		$a_03_0 = {13 04 12 04 28 90 01 03 0a 0d 1e 8d 90 01 03 01 25 16 72 90 01 03 70 a2 25 17 09 a2 25 18 72 90 01 03 70 a2 25 19 07 a2 25 1a 72 90 01 03 70 a2 25 1b 08 a2 25 1c 72 90 01 03 70 a2 25 1d 06 a2 90 00 } //2
