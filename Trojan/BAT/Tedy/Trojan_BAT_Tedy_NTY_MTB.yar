...
rule Trojan_BAT_Tedy_NTY_MTB{
	...
	strings :
		...
		$a_01_1 = {4e 6f 76 61 6c 69 6e 65 20 49 6e 73 74 61 6c 6c 65 72 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_BAT_Tedy_NTY_MTB_2{
	...
	strings :
		...
		$a_01_1 = {62 69 67 62 61 6c 6c 73 76 69 72 75 73 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_BAT_Tedy_NTY_MTB_3{
	...
	strings :
		...
		$a_01_1 = {63 72 75 7a 7a 61 32 38 47 76 66 69 78 } //00 00 
	condition:
		any of ($a_*)
