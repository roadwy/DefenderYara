...
rule Trojan_BAT_Small_GB_MTB{
	...
	strings :
		...
		$a_81_1 = {42 69 74 63 6f 69 6e 5f 47 72 61 62 62 65 72 } //01 00 
		$a_81_2 = {6f 35 78 30 52 36 75 46 66 5a 51 68 72 45 32 39 4d 63 } //01 00 
		$a_81_3 = {52 77 33 6e 36 45 5a 49 57 33 58 58 53 77 52 4c 4e 4e } //00 00 
	condition:
		any of ($a_*)
