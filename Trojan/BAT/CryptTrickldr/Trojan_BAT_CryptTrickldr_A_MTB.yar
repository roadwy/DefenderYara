...
rule Trojan_BAT_CryptTrickldr_A_MTB{
	...
	strings :
		...
		$a_81_2 = {24 53 5b 24 5f 5d 2c 24 53 5b 24 4a 5d 3d 24 53 5b 24 4a 5d 2c 24 53 5b 24 5f 5d 7d 3b 24 44 7c 25 7b 24 49 3d 28 24 49 2b 31 29 25 32 35 36 3b 24 48 3d 28 24 48 2b 24 53 5b 24 49 5d 29 25 32 35 36 3b 24 53 5b 24 49 5d 2c } //01 00  $S[$_],$S[$J]=$S[$J],$S[$_]};$D|%{$I=($I+1)%256;$H=($H+$S[$I])%256;$S[$I],
		$a_81_3 = {24 53 5b 24 48 5d 3d 24 53 5b 24 48 5d 2c 24 53 5b 24 49 5d 3b 24 5f 2d 62 78 4f 72 24 53 5b 28 24 53 5b 24 49 5d 2b 24 53 5b 24 48 5d 29 25 32 35 36 5d 7d 7d 3b } //01 00  $S[$H]=$S[$H],$S[$I];$_-bxOr$S[($S[$I]+$S[$H])%256]}};
