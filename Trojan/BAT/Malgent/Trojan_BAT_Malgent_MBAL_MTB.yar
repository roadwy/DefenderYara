...
rule Trojan_BAT_Malgent_MBAL_MTB{
	...
	strings :
		$a_03_0 = {01 25 16 11 04 8c 90 01 01 00 00 01 a2 25 17 07 20 ef 04 00 00 6f 90 01 01 00 00 0a 17 8d 90 01 01 00 00 01 25 16 11 04 8c 90 01 01 00 00 01 07 20 ef 04 00 00 6f 90 00 } //1
