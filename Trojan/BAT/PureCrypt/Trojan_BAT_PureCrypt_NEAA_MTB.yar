...
rule Trojan_BAT_PureCrypt_NEAA_MTB{
	...
	strings :
		$a_03_0 = {11 04 11 00 18 5b 11 02 11 00 18 28 ?? 00 00 06 1f 10 28 ?? 00 00 0a 9c 20 04 00 00 00 38 ?? ff ff ff 11 00 11 07 3c ?? ff ff ff 38 ?? ff ff ff 11 07 18 5b } //10
