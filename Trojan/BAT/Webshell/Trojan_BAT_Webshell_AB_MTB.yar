...
rule Trojan_BAT_Webshell_AB_MTB{
	...
	strings :
		...
		$a_03_1 = {28 10 00 00 0a 28 10 00 00 0a 28 10 00 00 0a 72 90 01 04 28 11 00 00 0a 6f 12 00 00 0a 28 11 00 00 0a 6f 12 00 00 0a 28 11 00 00 0a 6f 12 00 00 0a 0a 72 90 01 04 0b 73 13 00 00 0a 90 00 } //5
	condition:
