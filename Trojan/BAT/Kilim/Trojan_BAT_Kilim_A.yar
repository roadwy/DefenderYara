...
rule Trojan_BAT_Kilim_A{
	...
	strings :
		...
		$a_03_7 = {01 00 70 28 90 01 01 00 00 0a 0a 7e 90 01 01 00 00 0a 72 90 01 02 00 70 6f 90 01 01 00 00 0a 72 90 01 02 00 70 72 90 01 02 00 70 6f 90 01 01 00 00 0a 90 00 } //2
		$a_03_8 = {70 18 16 15 28 90 01 01 00 00 0a 26 06 72 90 01 02 00 70 28 90 01 01 00 00 0a 28 90 01 01 00 00 0a 90 00 } //2
	condition:
