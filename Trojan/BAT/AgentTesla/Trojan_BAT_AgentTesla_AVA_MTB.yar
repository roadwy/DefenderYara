...
rule Trojan_BAT_AgentTesla_AVA_MTB{
	...
	strings :
		$a_02_0 = {2b 35 2b 3a 2b 3f 00 2b 0b 2b 0c 90 01 05 00 00 de 14 08 2b f2 07 2b f1 08 2c 0a 16 2d 06 08 90 01 05 00 dc 07 90 01 05 0d 16 2d cb de 30 06 2b c8 90 01 05 2b c4 90 01 05 2b bf 0c 2b be 90 00 } //10
