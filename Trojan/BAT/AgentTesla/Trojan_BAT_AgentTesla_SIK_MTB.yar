...
rule Trojan_BAT_AgentTesla_SIK_MTB{
	...
	strings :
		...
		$a_01_3 = {48 00 65 00 61 00 76 00 79 00 44 00 75 00 63 00 6b 00 } //01 00 
		$a_01_4 = {37 00 39 00 35 00 48 00 43 00 38 00 43 00 4a 00 31 00 51 00 46 00 31 00 42 00 54 00 32 00 34 00 48 00 47 00 57 00 48 00 35 00 35 00 } //00 00 
	condition:
		any of ($a_*)
