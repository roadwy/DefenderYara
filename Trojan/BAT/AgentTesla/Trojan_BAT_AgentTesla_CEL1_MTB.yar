...
rule Trojan_BAT_AgentTesla_CEL1_MTB{
	...
	strings :
		$a_02_0 = {16 09 8e 69 6f 90 01 03 0a 26 28 90 01 03 0a 09 6f 90 01 03 0a 20 90 01 04 28 90 01 03 06 7e 90 01 03 0a 6f 90 01 03 0a 28 90 01 03 0a 0a de 0a 90 09 0f 00 08 6f 90 01 03 0a d4 8d 90 01 03 01 0d 08 09 90 00 } //1
