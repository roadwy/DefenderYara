...
rule Trojan_BAT_AgentTesla_BML_MTB{
	...
	strings :
		$a_02_0 = {0a 0c 1e 8d 90 01 03 01 0d 08 28 90 01 03 0a 72 90 01 03 70 6f 90 01 03 0a 6f 90 01 03 0a 13 04 11 04 16 09 16 1e 28 90 01 03 0a 00 07 09 6f 90 01 03 0a 00 07 18 6f 90 01 03 0a 00 07 6f 90 01 03 0a 03 16 03 8e 69 6f 90 00 } //1
