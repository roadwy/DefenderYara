...
rule Trojan_BAT_AgentTesla_NSM_MTB{
	meta:
		description = "Trojan:BAT/AgentTesla.NSM!MTB,SIGNATURE_TYPE_PEHSTR_EXT,02 00 02 00 02 00 00 01 00 "
	...
	strings :
		...
		$a_01_1 = {50 45 44 4f 49 57 44 45 4a 55 49 4a 44 } //00 00  PEDOIWDEJUIJD
	condition:
		any of ($a_*)
