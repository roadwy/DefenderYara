...
rule Trojan_BAT_AgentTesla_MBIZ_MTB{
	...
	strings :
		...
		$a_01_1 = {71 75 65 73 74 69 6f 6e 73 47 65 6e 65 72 61 74 6f 72 2e 50 72 6f 70 65 72 74 69 65 73 2e 52 65 73 6f 75 72 63 65 73 2e 72 65 73 6f 75 72 63 65 } //00 00 
	condition:
		any of ($a_*)
