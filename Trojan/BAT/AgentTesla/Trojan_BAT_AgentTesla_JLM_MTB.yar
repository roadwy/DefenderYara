...
rule Trojan_BAT_AgentTesla_JLM_MTB{
	...
	strings :
		...
		$a_81_2 = {4c 61 74 65 47 65 74 } //01 00 
		$a_81_3 = {54 6f 42 79 74 65 } //01 00 
		$a_81_4 = {53 75 62 73 74 72 69 6e 67 } //01 00 
		$a_81_5 = {52 6f 75 6e 64 } //01 00 
		$a_81_6 = {52 65 70 6c 61 63 65 } //01 00 
		$a_81_7 = {67 65 74 5f 50 61 72 61 6d 41 72 72 61 79 30 } //01 00 
		$a_81_8 = {49 6e 76 6f 6b 65 4d 65 6d 62 65 72 } //01 00 
		$a_81_9 = {43 72 65 61 74 65 49 6e 73 74 61 6e 63 65 } //00 00 
	condition:
		any of ($a_*)
