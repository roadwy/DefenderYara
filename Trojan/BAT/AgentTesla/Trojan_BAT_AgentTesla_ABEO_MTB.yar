...
rule Trojan_BAT_AgentTesla_ABEO_MTB{
	...
	strings :
		...
		$a_01_2 = {45 78 63 65 72 65 73 74 69 6e 74 2e 52 65 73 6f 75 72 63 65 73 2e 72 65 73 6f 75 72 63 65 73 } //01 00 
		$a_01_3 = {45 00 78 00 63 00 65 00 72 00 65 00 73 00 74 00 69 00 6e 00 74 00 } //00 00 
	condition:
		any of ($a_*)
