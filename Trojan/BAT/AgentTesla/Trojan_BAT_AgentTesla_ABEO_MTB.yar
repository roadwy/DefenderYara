...
rule Trojan_BAT_AgentTesla_ABEO_MTB{
	...
	strings :
		$a_03_0 = {02 28 7f 00 00 0a 28 90 01 03 0a 2a 90 00 } //2
		$a_03_1 = {01 25 16 20 90 01 03 aa 28 90 01 03 06 a2 25 17 20 90 01 03 aa 28 90 01 03 06 a2 14 14 14 28 90 01 03 0a 28 90 01 03 0a 28 90 01 03 06 28 90 01 03 0a 0b 14 90 00 } //2
