...
rule Trojan_BAT_AgentTesla_BGO_MTB{
	...
	strings :
		$a_02_0 = {70 03 11 04 18 6f 90 01 03 0a 28 90 01 03 0a 28 90 01 03 0a 04 07 6f 90 01 03 0a 28 90 01 03 0a 6a 61 b7 28 90 01 03 0a 28 90 01 03 0a 13 05 00 1f fb 13 06 2b 7b 90 00 } //10
