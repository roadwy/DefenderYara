...
rule Trojan_BAT_AgentTesla_GS_MTB{
	...
	strings :
		$a_03_0 = {70 02 08 18 6f 90 01 03 0a 28 90 01 03 0a 28 90 01 03 0a 03 07 6f 90 01 03 0a 28 90 01 03 0a 6a 61 d1 28 90 01 03 0a 13 04 06 11 04 6f 90 01 03 0a 26 07 03 6f 90 01 03 0a 17 59 fe 01 13 05 11 05 90 00 } //10
