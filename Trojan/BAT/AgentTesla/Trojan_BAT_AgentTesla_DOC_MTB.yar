...
rule Trojan_BAT_AgentTesla_DOC_MTB{
	...
	strings :
		$a_03_0 = {16 13 04 2b 1e 02 08 09 11 04 28 90 01 03 06 13 05 07 06 02 11 05 28 90 01 03 06 d2 9c 11 04 17 58 13 04 11 04 17 32 dd 06 17 58 0a 09 17 58 0d 90 00 } //1
