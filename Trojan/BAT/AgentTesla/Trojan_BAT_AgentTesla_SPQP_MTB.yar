...
rule Trojan_BAT_AgentTesla_SPQP_MTB{
	...
	strings :
		...
		$a_01_1 = {42 00 74 00 6a 00 65 00 73 00 2e 00 70 00 6e 00 67 00 } //01 00 
		$a_81_2 = {70 75 62 6c 69 63 2e 63 6c 61 73 73 2e 4d 61 69 6e 2e 48 65 6c 6c 6f 57 6f 72 6c 64 2e 6d 6f 64 75 6c 65 32 } //00 00 
	condition:
		any of ($a_*)
