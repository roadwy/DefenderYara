...
rule Trojan_BAT_AgentTesla_A_MTB{
	...
	strings :
		$a_00_0 = {43 6f 6d 70 75 74 65 4d 61 74 72 69 78 } //01 00 
		$a_00_1 = {4d 61 74 72 69 78 44 61 74 61 } //01 00 
		$a_00_2 = {4d 61 74 72 69 78 53 65 70 61 72 61 74 69 6f 6e } //01 00 
		$a_00_3 = {72 65 70 6c 61 63 65 58 } //01 00 
		$a_00_4 = {47 65 74 44 65 63 6f 64 65 64 } //01 00 
		$a_00_5 = {42 61 73 65 36 34 44 65 63 6f 64 65 72 } //01 00 
		$a_00_6 = {41 48 55 48 44 } //03 00 
