...
rule Trojan_BAT_AgentTesla_CMS_MTB{
	...
	strings :
		...
		$a_01_1 = {54 6f 55 49 6e 74 33 32 } //01 00  ToUInt32
		$a_01_2 = {52 00 65 00 73 00 6f 00 75 00 72 00 63 00 65 00 5f 00 4d 00 65 00 74 00 65 00 72 00 } //01 00  Resource_Meter
