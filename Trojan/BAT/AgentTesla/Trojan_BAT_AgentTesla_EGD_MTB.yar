...
rule Trojan_BAT_AgentTesla_EGD_MTB{
	...
	strings :
		$a_03_0 = {06 02 08 23 00 00 00 00 00 00 10 40 28 90 01 03 0a b7 6f 90 01 03 0a 23 00 00 00 00 00 00 70 40 28 90 01 03 0a b7 28 90 01 03 0a 84 28 90 01 03 0a 6f 90 01 03 0a 26 00 08 18 d6 0c 90 00 } //1
...
rule Trojan_BAT_AgentTesla_EGD_MTB_2{
	...
	strings :
		$a_03_0 = {20 73 3a 2f 2f 90 01 07 20 64 69 76 6f 90 01 07 20 72 63 65 72 90 01 07 20 68 74 74 70 90 01 07 20 2e 63 6f 6d 90 01 07 20 61 64 69 6f 90 00 } //1
