...
rule Trojan_BAT_AgentTesla_BFI_MTB{
	...
	strings :
		...
		$a_81_2 = {5a 42 4a 55 43 45 35 37 5a 45 37 41 46 34 4a 5a } //01 00 
		...
		$a_81_6 = {66 6c 6f 72 61 } //01 00 
		$a_81_7 = {53 6d 61 72 74 45 78 74 65 6e 73 69 6f 6e 73 } //01 00 
...
rule Trojan_BAT_AgentTesla_BFI_MTB_2{
	...
	strings :
		$a_81_0 = {5a 42 4a 55 43 45 35 37 5a 45 37 41 46 34 4a 5a } //01 00 
