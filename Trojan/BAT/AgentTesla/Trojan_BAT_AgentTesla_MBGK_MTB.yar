...
rule Trojan_BAT_AgentTesla_MBGK_MTB{
	...
	strings :
		...
		$a_01_1 = {36 62 32 31 62 35 37 35 2d 36 65 34 33 2d 34 39 39 65 2d 38 31 66 38 2d 34 38 64 33 39 31 33 39 35 30 61 65 } //01 00  6b21b575-6e43-499e-81f8-48d3913950ae
		$a_01_2 = {4a 4a 6a 55 68 38 37 37 } //00 00  JJjUh877
	condition:
		any of ($a_*)
