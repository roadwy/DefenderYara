...
rule Trojan_BAT_AgentTesla_CXS_MTB{
	...
	strings :
		$a_03_0 = {06 02 08 18 28 90 01 03 06 1f 10 28 90 01 03 06 84 28 90 01 03 0a 6f 90 01 03 0a 26 90 00 } //1
...
rule Trojan_BAT_AgentTesla_CXS_MTB_2{
	...
	strings :
		$a_03_0 = {08 11 04 9a 13 08 09 11 08 1f 10 28 90 01 04 b4 6f 90 01 04 00 11 04 17 d6 13 04 00 11 04 08 8e 69 fe 04 13 09 11 09 2d 90 00 } //5
