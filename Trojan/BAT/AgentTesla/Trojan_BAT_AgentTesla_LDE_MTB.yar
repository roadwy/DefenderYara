...
rule Trojan_BAT_AgentTesla_LDE_MTB{
	meta:
		description = "Trojan:BAT/AgentTesla.LDE!MTB,SIGNATURE_TYPE_PEHSTR_EXT,07 00 07 00 07 00 00 01 00 "
		
	strings :
		$a_01_0 = {24 62 31 62 66 61 63 65 35 2d 31 62 61 61 2d 34 61 32 61 2d 62 34 64 32 2d 62 62 33 65 39 30 31 39 66 37 62 38 } //01 00  $b1bface5-1baa-4a2a-b4d2-bb3e9019f7b8
