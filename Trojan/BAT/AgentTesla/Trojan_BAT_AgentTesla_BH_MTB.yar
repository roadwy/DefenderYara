...
rule Trojan_BAT_AgentTesla_BH_MTB{
	...
	strings :
		...
		$a_01_1 = {74 00 61 00 73 00 6b 00 6b 00 69 00 6c 00 6c 00 20 00 2f 00 66 00 20 00 2f 00 49 00 4d 00 20 00 73 00 79 00 73 00 6b 00 65 00 79 00 2e 00 65 00 78 00 65 00 20 00 3e 00 6e 00 75 00 6c 00 } //01 00 
		$a_01_2 = {73 76 63 68 6f 73 74 2e 46 6f 72 6d 31 2e 72 65 73 6f 75 72 63 65 73 } //01 00 
