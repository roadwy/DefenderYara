...
rule Trojan_BAT_AgentTesla_SPPE_MTB{
	...
	strings :
		$a_03_0 = {07 11 06 18 6f 90 01 03 0a 13 07 08 11 06 18 5b 11 07 1f 10 28 90 01 03 0a d2 9c 00 11 06 18 58 13 06 11 06 07 6f 90 01 03 0a fe 04 13 08 11 08 2d cd 90 00 } //4
