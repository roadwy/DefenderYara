...
rule Trojan_BAT_AgentTesla_AVI_MTB{
	...
	strings :
		$a_02_0 = {25 16 03 a2 25 0d 14 14 17 8d 90 01 03 01 25 16 17 9c 25 13 90 01 01 28 90 01 03 0a 11 90 01 01 16 91 2d 90 01 01 2b 90 01 01 09 16 9a 90 00 } //10
