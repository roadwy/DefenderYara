...
rule Trojan_BAT_AgentTesla_ASDK_MTB{
	...
	strings :
		...
		$a_01_1 = {51 75 61 6e 4c 79 51 75 61 6e 43 61 66 65 2e 50 72 6f 70 65 72 74 69 65 73 2e 52 65 73 6f 75 72 63 65 73 } //00 00  QuanLyQuanCafe.Properties.Resources
	condition:
		any of ($a_*)
