...
rule Trojan_BAT_AgentTesla_AMG_MTB{
	...
	strings :
		$a_03_0 = {17 da 13 06 16 0b 2b 1e 09 06 07 6f 90 01 03 0a 13 07 11 07 28 90 01 03 0a 13 08 11 04 08 11 08 b4 9c 07 17 d6 0b 07 11 06 31 dd 08 17 d6 0c 06 17 d6 0a 06 11 05 31 c2 90 00 } //10
