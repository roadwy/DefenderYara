...
rule Trojan_BAT_AgentTesla_LCA_MTB{
	...
	strings :
		$a_03_0 = {09 11 04 11 05 6f 90 01 03 0a 26 09 11 04 11 05 6f 90 01 03 0a 28 90 01 03 0a 13 08 08 07 11 08 d2 9c 11 05 17 58 13 05 11 05 09 6f 90 01 03 0a 32 90 00 } //1
