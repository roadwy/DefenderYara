...
rule Trojan_BAT_AgentTesla_BHB_MTB{
	...
	strings :
		$a_81_0 = {58 58 58 58 58 58 58 58 58 58 58 58 58 58 58 58 58 58 58 58 58 00 41 41 41 41 41 41 41 41 41 41 41 41 41 41 41 41 41 41 41 41 } //0a 00 
		$a_81_1 = {52 65 76 65 72 73 65 00 74 65 78 74 } //0a 00 
		...
		$a_81_7 = {43 72 65 61 74 65 44 65 63 72 79 70 74 6f 72 } //01 00 
		$a_81_8 = {4d 44 35 43 72 79 70 74 6f 53 65 72 76 69 63 65 50 72 6f 76 69 64 65 72 } //01 00 
		$a_81_9 = {54 6f 43 68 61 72 41 72 72 61 79 } //01 00 
		$a_81_10 = {49 6e 76 6f 6b 65 4d 65 74 68 6f 64 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_BAT_AgentTesla_BHB_MTB_2{
	...
	strings :
		...
		$a_81_6 = {44 65 66 6c 61 74 65 53 74 72 65 61 6d } //01 00 
		...
		$a_81_10 = {43 6f 6d 70 72 65 73 73 69 6f 6e 4d 6f 64 65 } //00 00 
	condition:
		any of ($a_*)
