...
rule Trojan_BAT_AgentTesla_DLQ_MTB_2{
	...
	strings :
		$a_01_0 = {24 34 43 30 38 36 32 39 39 2d 38 43 31 31 2d 34 46 45 31 2d 39 34 46 45 2d 36 34 37 46 33 36 34 46 46 31 35 35 } //01 00  $4C086299-8C11-4FE1-94FE-647F364FF155
		...
		$a_01_2 = {55 38 33 34 32 35 32 33 35 33 34 } //01 00  U8342523534
		...
		$a_01_7 = {00 52 65 70 6c 61 63 65 00 54 6f 42 79 74 65 00 } //01 00  刀灥慬散吀䉯瑹e
