...
rule Trojan_BAT_AgentTesla_NYQ_MTB{
	...
	strings :
		...
		$a_01_2 = {24 32 34 37 37 33 65 63 39 2d 34 32 30 35 2d 34 33 37 61 2d 38 34 37 38 2d 63 37 63 31 61 35 33 62 31 64 34 65 } //01 00 
		$a_01_3 = {57 4c 50 58 5f 48 41 43 4b 5f 50 52 4f 2e 52 65 73 6f 75 72 63 65 73 2e 72 65 73 6f 75 72 63 65 73 } //00 00 
	condition:
		any of ($a_*)
