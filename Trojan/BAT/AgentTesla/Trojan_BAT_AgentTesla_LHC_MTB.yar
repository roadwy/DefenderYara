...
rule Trojan_BAT_AgentTesla_LHC_MTB{
	...
	strings :
		$a_03_0 = {09 11 04 11 05 6f 90 01 03 0a 26 09 11 04 11 05 6f 90 01 03 0a 13 06 16 13 07 02 11 06 28 90 01 03 06 13 07 08 07 11 07 d2 9c 11 05 17 58 13 05 11 05 17 32 cb 90 00 } //1
