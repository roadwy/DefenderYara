...
rule Trojan_BAT_AgentTesla_ABFM_MTB{
	...
	strings :
		$a_03_0 = {0d 09 07 6f 90 01 03 0a 00 09 18 6f 90 01 03 0a 00 09 6f 90 01 03 0a 13 04 11 04 03 16 03 8e 69 6f 90 01 03 0a 13 05 09 6f 90 01 03 0a 00 11 05 0a 2b 00 06 2a 90 00 } //1
