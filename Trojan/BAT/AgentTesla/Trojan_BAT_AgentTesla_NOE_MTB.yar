...
rule Trojan_BAT_AgentTesla_NOE_MTB{
	...
	strings :
		...
		$a_01_2 = {23 00 47 00 65 00 74 00 23 00 4d 00 65 00 74 00 23 00 68 00 6f 00 64 00 } //01 00 
		$a_01_3 = {24 61 61 30 63 34 35 62 38 2d 63 63 35 38 2d 34 66 64 37 2d 39 32 62 37 2d 64 66 31 39 34 33 64 35 33 64 66 } //01 00 
