...
rule Trojan_BAT_AgentTesla_KAAI_MTB{
	...
	strings :
		$a_03_0 = {2b 40 02 7b 90 01 01 00 00 04 6f 90 01 01 00 00 0a 06 08 9a 6f 90 01 01 00 00 0a 25 07 08 8f 90 01 01 00 00 01 28 90 01 01 00 00 0a 6f 90 01 01 00 00 0a 6f 90 01 01 00 00 0a 17 8d 90 01 01 00 00 01 25 16 07 08 99 a1 6f 90 01 01 00 00 0a 26 08 17 58 0c 08 06 8e 69 32 ba 90 00 } //10
