...
rule Trojan_BAT_AgentTesla_LNP_MTB{
	...
	strings :
		$a_01_0 = {53 6d 61 72 74 41 73 73 65 6d 62 6c 79 2e 53 6d 61 72 74 45 78 63 65 70 74 69 6f 6e 73 43 6f 72 65 2e 52 65 73 6f 75 72 63 65 73 2e 63 75 72 72 65 6e 74 2e 70 6e 67 } //01 00  SmartAssembly.SmartExceptionsCore.Resources.current.png
		$a_01_1 = {41 77 65 69 69 77 69 2e 65 78 65 } //01 00  Aweiiwi.exe
