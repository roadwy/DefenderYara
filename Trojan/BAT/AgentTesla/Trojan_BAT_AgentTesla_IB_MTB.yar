...
rule Trojan_BAT_AgentTesla_IB_MTB{
	meta:
		description = "Trojan:BAT/AgentTesla.IB!MTB,SIGNATURE_TYPE_PEHSTR_EXT,18 00 18 00 0a 00 00 14 00 "
		
	strings :
		$a_81_0 = {24 31 35 62 61 32 38 31 65 2d 33 61 39 39 2d 34 38 32 64 2d 39 62 30 34 2d 37 30 33 61 36 36 32 65 35 64 35 62 } //01 00  $15ba281e-3a99-482d-9b04-703a662e5d5b
...
rule Trojan_BAT_AgentTesla_IB_MTB_2{
	meta:
		description = "Trojan:BAT/AgentTesla.IB!MTB,SIGNATURE_TYPE_PEHSTR_EXT,0e 00 0e 00 0e 00 00 0b 00 "
		
	strings :
		$a_81_0 = {34 34 33 63 65 32 32 32 2d 65 30 37 66 2d 34 62 63 35 2d 39 62 33 34 2d 39 39 30 38 64 30 36 63 61 34 39 35 } //01 00  443ce222-e07f-4bc5-9b34-9908d06ca495
		$a_81_1 = {42 69 63 65 72 61 5f 50 72 6f 6a 65 63 74 5f 46 69 6e 61 6c 73 } //01 00  Bicera_Project_Finals
		...
		$a_81_12 = {47 65 74 42 79 74 65 73 } //01 00  GetBytes
		$a_81_13 = {54 6f 43 68 61 72 41 72 72 61 79 } //00 00  ToCharArray
	condition:
		any of ($a_*)
