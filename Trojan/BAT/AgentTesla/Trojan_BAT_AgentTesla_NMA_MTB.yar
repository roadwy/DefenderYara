...
rule Trojan_BAT_AgentTesla_NMA_MTB{
	...
	strings :
		$a_03_0 = {28 31 00 00 0a 2b d5 28 ?? 00 00 06 2b d5 6f ?? 00 00 0a 2b d0 28 ?? 00 00 0a 2b cb 0b 2b ca 07 2b c9 07 2b c9 28 ?? 00 00 0a } //5
...
rule Trojan_BAT_AgentTesla_NMA_MTB_2{
	...
	strings :
		$a_03_0 = {68 00 74 00 74 00 70 00 73 00 3a 00 23 00 24 00 40 00 40 00 23 00 24 00 40 00 40 00 74 00 72 00 61 00 6e 00 73 00 66 00 65 00 72 00 2e 00 73 00 68 00 2f 00 67 00 65 00 74 00 2f ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? 2e 00 74 00 78 00 74 } //1
