...
rule Trojan_BAT_AgentTesla_CXK_MTB{
	...
	strings :
		$a_03_0 = {07 08 9a 28 90 01 03 0a 23 00 00 00 00 00 80 73 40 59 28 90 01 03 0a b7 0d 06 09 28 90 01 03 0a 28 90 01 03 0a 28 90 01 03 0a 0a 08 17 d6 0c 90 00 } //1
