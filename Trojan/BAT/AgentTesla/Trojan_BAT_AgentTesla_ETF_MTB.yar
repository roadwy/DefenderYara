...
rule Trojan_BAT_AgentTesla_ETF_MTB{
	...
	strings :
		$a_03_0 = {17 da 17 d6 02 11 06 91 08 1f 0a d6 1f 0a da 61 07 90 01 05 11 07 91 61 b4 9c 90 00 } //1
...
rule Trojan_BAT_AgentTesla_ETF_MTB_2{
	...
	strings :
		$a_03_0 = {17 da 17 d6 02 11 06 91 08 1f 0a d6 1f 0a da 61 07 74 90 01 03 1b 11 07 91 61 b4 9c 1d 90 00 } //1
