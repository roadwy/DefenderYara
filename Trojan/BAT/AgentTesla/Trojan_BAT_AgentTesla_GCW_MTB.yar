...
rule Trojan_BAT_AgentTesla_GCW_MTB{
	...
	strings :
		$a_03_0 = {25 16 1f 2d 9d 6f ?? ?? ?? 0a 0a 06 8e 69 8d ?? ?? ?? ?? 0b 16 13 06 2b 15 07 11 06 06 11 06 9a 1f 10 28 ?? ?? ?? 0a 9c 11 06 17 58 13 06 11 06 06 8e 69 fe 04 13 07 11 07 2d de } //10
