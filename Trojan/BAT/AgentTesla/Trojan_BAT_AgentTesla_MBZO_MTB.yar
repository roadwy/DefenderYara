...
rule Trojan_BAT_AgentTesla_MBZO_MTB{
	...
	strings :
		$a_03_0 = {07 08 06 08 91 20 00 01 00 00 59 03 08 03 6f 90 01 01 00 00 0a 5d 6f 90 01 01 00 00 0a 58 20 00 01 00 00 5d d2 9c 00 08 17 58 0c 08 06 8e 69 90 00 } //1
