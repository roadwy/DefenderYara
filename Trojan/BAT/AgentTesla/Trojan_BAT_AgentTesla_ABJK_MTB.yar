...
rule Trojan_BAT_AgentTesla_ABJK_MTB{
	...
	strings :
		$a_03_0 = {01 25 16 72 90 01 03 70 a2 25 17 72 90 01 03 70 a2 14 14 14 28 90 01 03 0a 28 90 01 03 0a 0b 07 28 90 01 03 06 28 90 01 03 0a 0c 90 0a 3b 00 7e 90 01 03 04 14 72 90 01 03 70 18 8d 90 00 } //2
		$a_03_1 = {0a 0a 2b 00 06 2a 90 0a 10 00 02 28 90 01 03 0a 28 90 00 } //2
