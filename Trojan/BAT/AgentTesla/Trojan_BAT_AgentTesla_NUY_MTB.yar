...
rule Trojan_BAT_AgentTesla_NUY_MTB{
	...
	strings :
		$a_03_0 = {04 5d 91 0a 06 7e ?? ?? ?? 04 03 1f 16 5d 6f ?? ?? ?? 0a 61 0b 2b 00 07 } //1
		$a_03_1 = {02 03 17 58 7e ?? ?? ?? 04 5d 91 0a 16 0b 17 0c 00 02 03 28 ?? ?? ?? 06 0d 06 04 58 13 04 09 11 04 59 04 5d 0b 00 02 03 7e ?? ?? ?? 04 5d 07 d2 9c 02 13 05 2b 00 } //1
