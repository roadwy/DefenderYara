...
rule Trojan_BAT_AgentTesla_NUR_MTB{
	...
	strings :
		...
		$a_01_1 = {54 46 6c 6f 77 2e 50 72 6f 70 65 72 74 69 65 73 2e 52 65 73 6f 75 72 63 65 73 2e 72 65 73 6f 75 72 63 65 73 } //01 00 
		$a_01_2 = {56 00 55 00 57 00 55 00 65 00 64 00 66 00 64 00 6b 00 6a 00 6c 00 6a 00 6d 00 6a 00 6e 00 6a 00 } //00 00 
	condition:
		any of ($a_*)
