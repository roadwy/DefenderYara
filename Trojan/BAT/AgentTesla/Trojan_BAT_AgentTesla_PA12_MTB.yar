...
rule Trojan_BAT_AgentTesla_PA12_MTB{
	...
	strings :
		...
		$a_01_1 = {24 62 31 61 31 66 63 30 38 2d 66 61 31 63 2d 34 37 66 38 2d 61 66 33 64 2d 31 38 32 33 31 36 36 30 39 31 61 35 } //01 00 
		$a_80_2 = {56 69 62 69 69 71 7a 75 6b 6b 6c 6d 67 6d } //Vibiiqzukklmgm  01 00 
		$a_01_3 = {42 69 6e 61 72 79 52 65 61 64 65 72 } //01 00 
