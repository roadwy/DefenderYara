...
rule Trojan_BAT_AgentTesla_JLG_MTB{
	...
	strings :
		$a_01_0 = {42 5f 5f 5f 5f 5f 5f 5f 5f 5f 5f 5f 5f 5f 5f 5f 5f 5f 5f 5f 5f 5f 5f 5f 5f 42 } //01 00  B________________________B
		$a_01_1 = {53 5f 5f 5f 5f 5f 5f 5f 5f 5f 5f 5f 5f 5f 5f 5f 5f 5f 5f 5f 5f 5f 5f 5f 5f 5f 5f 5f 5f 53 } //01 00  S____________________________S
		...
		$a_81_4 = {4f 64 64 73 4d 69 73 73 69 6f 6e 43 6f 6e 74 72 6f 6c } //01 00  OddsMissionControl
		$a_81_5 = {43 72 65 61 74 65 49 6e 73 74 61 6e 63 65 } //01 00  CreateInstance
		$a_81_6 = {53 75 62 73 74 72 69 6e 67 } //01 00  Substring
		$a_81_7 = {4c 61 74 65 47 65 74 } //01 00  LateGet
		$a_81_8 = {47 65 74 4f 62 6a 65 63 74 56 61 6c 75 65 } //00 00  GetObjectValue
	condition:
		any of ($a_*)
