...
rule Trojan_BAT_AgentTesla_ABLY_MTB{
	...
	strings :
		$a_03_0 = {01 25 16 06 17 8d 90 01 03 01 25 16 08 8c 90 01 03 01 a2 14 28 90 01 03 0a 28 90 01 03 0a 1f 10 28 90 01 03 0a 9c 6f 90 01 03 0a 08 17 d6 0c 08 20 90 01 03 00 32 c3 90 0a 3d 00 07 17 8d 90 00 } //5
