...
rule Trojan_BAT_AgentTesla_SA_MTB{
	...
	strings :
		$a_02_0 = {8e 69 17 da 0b 16 0c 2b 32 06 02 02 7b 90 01 03 04 08 9a 28 90 01 03 06 28 90 01 03 0a 0a 08 02 7b 90 01 03 04 8e 69 17 da 2e 0c 06 72 90 01 03 70 28 90 01 03 0a 0a 08 17 d6 0c 08 07 31 ca 90 00 } //10
...
rule Trojan_BAT_AgentTesla_SA_MTB_2{
	...
	strings :
		$a_03_0 = {25 26 13 07 20 90 01 04 28 90 01 03 06 13 08 2b 39 11 07 11 08 9a 13 09 06 11 09 6f 90 01 03 06 25 26 2c 17 90 00 } //10
