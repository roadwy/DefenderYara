...
rule Trojan_BAT_AgentTesla_FAT_MTB{
	...
	strings :
		...
		$a_01_1 = {53 00 75 00 64 00 6f 00 6b 00 75 00 43 00 57 00 4c 00 2e 00 50 00 72 00 6f 00 70 00 65 00 72 00 74 00 69 00 65 00 73 00 2e 00 52 00 65 00 73 00 6f 00 75 00 72 00 63 00 65 00 73 00 } //00 00  SudokuCWL.Properties.Resources
	condition:
		any of ($a_*)
