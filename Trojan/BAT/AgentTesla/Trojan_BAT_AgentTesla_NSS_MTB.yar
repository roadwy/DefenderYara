...
rule Trojan_BAT_AgentTesla_NSS_MTB{
	...
	strings :
		$a_03_0 = {28 1b 00 00 06 0a 28 ?? 00 00 0a 06 6f ?? 00 00 0a 28 ?? 00 00 0a 28 ?? 00 00 06 0b dd 03 } //5
...
rule Trojan_BAT_AgentTesla_NSS_MTB_2{
	...
	strings :
		$a_03_0 = {00 08 11 05 07 11 05 18 5a 18 28 ?? ?? ?? 06 1f 10 28 ?? ?? ?? 06 9c 00 11 05 17 58 13 05 11 05 08 8e 69 fe 04 13 06 11 06 2d d5 } //1
