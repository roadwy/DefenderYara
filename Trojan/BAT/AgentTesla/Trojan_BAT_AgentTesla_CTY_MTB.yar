...
rule Trojan_BAT_AgentTesla_CTY_MTB{
	...
	strings :
		$a_03_0 = {0c 07 08 20 e8 03 00 00 73 90 01 03 0a 0d 06 09 06 6f 90 01 03 0a 1e 5b 6f 90 01 03 0a 6f 90 01 03 0a 06 09 06 6f 90 01 03 0a 1e 5b 6f 90 01 03 0a 6f 90 01 03 0a 06 17 6f 90 01 03 0a 02 06 6f 90 01 03 0a 17 73 90 01 03 0a 13 90 00 } //1
