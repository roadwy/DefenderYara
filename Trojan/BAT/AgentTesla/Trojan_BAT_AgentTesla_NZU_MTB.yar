...
rule Trojan_BAT_AgentTesla_NZU_MTB{
	...
	strings :
		...
		$a_81_1 = {43 38 41 45 44 48 41 55 56 48 37 35 49 34 37 52 52 37 52 44 35 48 } //01 00  C8AEDHAUVH75I47RR7RD5H
		$a_81_2 = {4a 45 50 34 35 57 4a 38 45 39 5a 37 48 37 37 35 34 38 37 4a 51 38 } //00 00  JEP45WJ8E9Z7H775487JQ8
	condition:
		any of ($a_*)
