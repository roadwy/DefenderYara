...
rule Trojan_BAT_AgentTesla_NZU_MTB{
	...
	strings :
		$a_03_0 = {08 06 8e 69 5d 06 08 06 8e 69 5d 91 07 08 1f 16 5d 91 61 28 90 01 03 0a 06 08 17 58 06 8e 69 5d 91 28 90 01 03 0a 59 20 00 01 00 00 58 20 00 01 00 00 5d d2 90 00 } //10
