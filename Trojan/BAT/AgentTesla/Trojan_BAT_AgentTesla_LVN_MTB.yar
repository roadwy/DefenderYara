...
rule Trojan_BAT_AgentTesla_LVN_MTB{
	...
	strings :
		$a_03_0 = {0a 0a 02 8e 69 8d 90 01 04 0b 16 0c 2b 17 00 08 06 8e 69 5d 0d 07 08 02 08 91 06 09 91 61 d2 9c 00 08 17 58 0c 08 02 8e 69 fe 04 13 05 11 05 2d dd 90 00 } //1
