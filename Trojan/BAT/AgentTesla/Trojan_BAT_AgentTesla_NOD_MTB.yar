...
rule Trojan_BAT_AgentTesla_NOD_MTB{
	...
	strings :
		$a_01_0 = {24 35 66 38 66 31 33 38 34 2d 33 33 63 64 2d 34 62 37 30 2d 61 39 63 31 2d 31 63 61 34 62 64 65 62 63 32 31 66 } //01 00  $5f8f1384-33cd-4b70-a9c1-1ca4bdebc21f
		$a_01_1 = {48 43 56 51 75 65 73 74 69 6f 6e 6e 61 69 72 65 2e 50 72 6f 70 65 72 74 69 65 73 2e 52 65 73 6f 75 72 63 65 73 2e 72 65 73 6f 75 72 63 65 73 } //01 00  HCVQuestionnaire.Properties.Resources.resources
