...
rule Trojan_BAT_AgentTesla_EOU_MTB_2{
	...
	strings :
		...
		$a_01_1 = {73 00 73 00 73 00 73 00 73 00 72 00 72 00 72 00 72 00 72 00 72 00 72 00 72 00 72 00 73 00 64 00 61 00 73 00 2e 00 65 00 78 00 65 00 } //00 00  sssssrrrrrrrrrsdas.exe
	condition:
		any of ($a_*)
