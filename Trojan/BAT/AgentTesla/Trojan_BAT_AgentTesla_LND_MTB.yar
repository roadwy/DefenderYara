...
rule Trojan_BAT_AgentTesla_LND_MTB{
	...
	strings :
		$a_03_0 = {0a 13 04 11 04 6c 23 90 01 07 3f 5b 28 90 01 03 0a b7 28 90 01 03 0a 13 06 12 06 28 90 01 03 0a 13 05 07 11 05 6f 90 01 03 0a 26 00 09 17 d6 0d 09 08 6f 90 01 03 0a fe 04 13 07 11 07 2d b7 90 00 } //1
