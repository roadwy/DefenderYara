...
rule Trojan_BAT_AgentTesla_DAE_MTB{
	...
	strings :
		$a_03_0 = {0a 0b 03 8e 69 17 59 17 58 0c 03 04 08 5d 91 07 04 1f 16 5d 91 61 28 90 01 01 00 00 0a 03 04 17 58 08 5d 91 28 90 01 01 00 00 0a 59 06 58 06 5d d2 0d 2b 00 09 2a 90 00 } //4
...
rule Trojan_BAT_AgentTesla_DAE_MTB_2{
	...
	strings :
		$a_03_0 = {13 04 06 11 04 28 90 01 03 06 07 da 28 90 01 03 06 28 90 01 03 06 28 90 01 03 06 0a 00 09 17 d6 0d 09 08 28 90 01 03 06 fe 04 13 05 11 05 2d c8 90 00 } //1
