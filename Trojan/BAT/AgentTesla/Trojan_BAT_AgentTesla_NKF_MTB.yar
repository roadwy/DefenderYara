...
rule Trojan_BAT_AgentTesla_NKF_MTB{
	...
	strings :
		$a_01_0 = {24 38 31 38 61 33 33 61 30 2d 33 63 32 61 2d 34 33 66 33 2d 39 65 30 61 2d 61 38 33 39 35 33 34 34 63 65 30 61 } //01 00 
		...
		$a_81_3 = {74 72 65 76 6e 6f 43 2e 6d 65 74 73 79 53 } //01 00 
		$a_81_4 = {67 6e 69 72 74 53 34 36 65 73 61 42 6d 6f 72 46 } //01 00 
		$a_81_5 = {72 65 62 6d 65 4d 65 6b 6f 76 6e 49 } //00 00 
	condition:
		any of ($a_*)
