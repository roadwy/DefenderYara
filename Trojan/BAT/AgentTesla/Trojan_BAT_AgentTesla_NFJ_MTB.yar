...
rule Trojan_BAT_AgentTesla_NFJ_MTB_2{
	...
	strings :
		$a_81_0 = {57 32 33 35 32 35 33 35 33 34 35 } //01 00  W2352535345
		$a_81_1 = {57 32 35 33 33 35 33 } //01 00  W253353
		$a_81_2 = {57 33 34 32 34 32 36 35 } //01 00  W3424265
		$a_81_3 = {47 65 74 50 69 78 65 6c } //01 00  GetPixel
		$a_81_4 = {54 6f 57 69 6e 33 32 } //01 00  ToWin32
		$a_81_5 = {43 6f 6c 6f 72 54 72 61 6e 73 6c 61 74 6f 72 } //00 00  ColorTranslator
	condition:
		any of ($a_*)
