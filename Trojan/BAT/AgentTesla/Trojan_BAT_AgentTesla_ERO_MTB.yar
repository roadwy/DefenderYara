...
rule Trojan_BAT_AgentTesla_ERO_MTB{
	meta:
		description = "Trojan:BAT/AgentTesla.ERO!MTB,SIGNATURE_TYPE_PEHSTR_EXT,08 00 08 00 08 00 00 01 00 "
		
	strings :
		$a_01_0 = {24 31 35 64 36 31 30 37 37 2d 38 31 36 65 2d 34 61 36 34 2d 62 34 38 35 2d 35 36 61 31 66 64 30 37 62 65 35 64 } //01 00  $15d61077-816e-4a64-b485-56a1fd07be5d
