...
rule Trojan_BAT_AgentTesla_CSP_MTB{
	...
	strings :
		$a_03_0 = {08 11 04 07 11 04 18 5a 18 6f 90 01 03 0a 1f 10 28 90 01 03 0a 8c 90 01 03 01 6f 90 01 03 0a 00 00 11 04 17 58 13 04 11 04 07 6f 90 01 03 0a 18 5b 90 00 } //1
