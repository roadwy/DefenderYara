...
rule Trojan_BAT_AgentTesla_AQC_MTB{
	...
	strings :
		$a_03_0 = {16 0b 11 04 06 07 90 01 05 13 05 11 05 90 01 05 13 06 09 08 11 06 b4 9c 07 17 d6 0b 07 16 31 de 08 17 d6 0c 06 17 d6 0a 06 90 00 } //10
		$a_02_1 = {25 16 09 a2 25 17 90 01 05 a2 25 13 04 14 14 18 90 01 05 25 16 17 9c 25 13 05 17 90 01 05 26 11 05 16 91 2d 02 90 00 } //10
	condition:
...
rule Trojan_BAT_AgentTesla_AQC_MTB_2{
	...
	strings :
		$a_03_0 = {06 03 08 03 90 01 05 5d 17 d6 90 01 05 da 0d 06 09 90 01 05 13 04 12 04 90 01 05 28 90 01 03 06 0a 00 08 17 d6 0c 08 07 fe 02 16 fe 01 13 05 11 05 2d be 06 13 06 2b 00 11 06 2a 90 00 } //10
