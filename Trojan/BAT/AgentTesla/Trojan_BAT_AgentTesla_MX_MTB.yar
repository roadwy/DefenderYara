...
rule Trojan_BAT_AgentTesla_MX_MTB{
	...
	strings :
		$a_02_0 = {16 9a 0a 06 6f 90 01 04 19 9a 0b 07 72 90 01 02 00 70 17 18 8d 90 01 04 25 17 19 8d 90 01 04 25 16 7e 90 01 01 00 00 04 a2 25 17 7e 90 01 01 00 00 04 a2 25 18 72 90 01 02 00 70 a2 a2 28 90 01 04 26 2a 90 00 } //1
	condition:
		((#a_02_0  & 1)*1) >=1
