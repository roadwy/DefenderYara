...
rule Trojan_BAT_AgentTesla_JLO_MTB{
	...
	strings :
		$a_03_0 = {20 00 01 00 00 14 14 18 8d 90 01 03 01 25 16 08 06 18 d8 18 6f 90 01 03 0a a2 25 17 1f 10 8c 90 01 03 01 a2 6f 90 01 03 0a 28 90 01 03 0a 9c 06 17 d6 0a 06 11 04 31 90 00 } //1
