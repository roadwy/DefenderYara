...
rule Trojan_BAT_AgentTesla_AQI_MTB{
	...
	strings :
		$a_02_0 = {11 01 11 03 16 11 04 6f 90 01 03 0a 90 01 05 11 01 6f 90 01 03 0a 13 05 90 01 05 11 02 11 03 16 11 03 8e 69 90 01 05 13 04 90 01 05 11 04 11 03 8e 69 90 00 } //1
