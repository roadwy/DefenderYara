...
rule Trojan_BAT_AgentTesla_LQL_MTB{
	...
	strings :
		$a_03_0 = {16 13 04 2b 21 02 08 09 11 04 28 90 01 03 06 28 90 01 03 0a 13 05 07 06 11 05 28 90 01 03 0a 9c 11 04 17 58 13 04 11 04 17 32 da 90 00 } //1
...
rule Trojan_BAT_AgentTesla_LQL_MTB_2{
	...
	strings :
		$a_03_0 = {0a 1f 20 06 6f 90 01 03 0a 8e 69 1f 20 59 6f 90 01 03 0a 13 04 06 16 6a 6f 90 01 03 0a 06 11 04 16 11 04 8e 69 6f 90 00 } //1
		$a_03_1 = {0a 1f 10 6a 59 17 6a 58 d4 8d 90 01 03 01 13 07 11 06 11 07 16 11 07 8e 69 6f 90 01 03 0a 8d 90 01 03 01 13 08 11 07 16 11 08 16 11 08 8e 69 28 90 01 03 0a 11 08 13 09 90 00 } //1
