...
rule Trojan_BAT_AgentTesla_DEC_MTB{
	...
	strings :
		$a_03_0 = {08 09 11 04 6f ?? ?? ?? 0a 13 07 08 09 11 04 6f ?? ?? ?? 0a 13 08 11 08 28 ?? ?? ?? 0a 13 09 07 06 11 09 d2 9c 00 11 04 17 58 13 04 11 04 08 6f ?? ?? ?? 0a fe 04 13 0a 11 0a 2d c3 } //1
