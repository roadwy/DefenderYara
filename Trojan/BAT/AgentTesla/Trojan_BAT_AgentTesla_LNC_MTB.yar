...
rule Trojan_BAT_AgentTesla_LNC_MTB{
	meta:
		description = "Trojan:BAT/AgentTesla.LNC!MTB,SIGNATURE_TYPE_PEHSTR_EXT,08 00 08 00 08 00 00 01 00 "
		
	strings :
		$a_01_0 = {61 65 30 63 39 37 39 31 2d 62 65 33 36 2d 34 30 38 66 2d 39 39 64 62 2d 34 34 35 38 35 33 39 36 61 30 62 31 } //01 00  ae0c9791-be36-408f-99db-44585396a0b1
		...
		$a_01_7 = {54 72 69 6e 69 74 79 } //00 00  Trinity
	condition:
		any of ($a_*)
...
rule Trojan_BAT_AgentTesla_LNC_MTB_2{
	meta:
		description = "Trojan:BAT/AgentTesla.LNC!MTB,SIGNATURE_TYPE_PEHSTR_EXT,1b 00 1b 00 09 00 00 14 00 "
		
	strings :
		$a_01_0 = {24 36 61 34 65 61 32 61 65 2d 36 38 65 61 2d 34 33 36 39 2d 62 62 61 31 2d 62 33 34 62 39 33 37 64 65 62 37 36 } //14 00  $6a4ea2ae-68ea-4369-bba1-b34b937deb76
		$a_01_1 = {24 35 36 31 32 65 30 61 32 2d 62 66 35 62 2d 34 38 65 61 2d 61 61 61 38 2d 34 37 65 64 37 62 64 39 32 34 31 33 } //01 00  $5612e0a2-bf5b-48ea-aaa8-47ed7bd92413
		$a_01_2 = {52 43 32 43 72 79 70 74 6f 53 65 72 76 69 63 65 50 72 6f 76 69 64 65 72 } //01 00  RC2CryptoServiceProvider
