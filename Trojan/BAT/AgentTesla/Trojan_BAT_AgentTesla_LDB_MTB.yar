...
rule Trojan_BAT_AgentTesla_LDB_MTB{
	meta:
		description = "Trojan:BAT/AgentTesla.LDB!MTB,SIGNATURE_TYPE_PEHSTR_EXT,0f 00 0f 00 07 00 00 01 00 "
		
	strings :
		$a_03_0 = {00 26 06 08 6f 90 01 03 0a 06 18 6f 90 01 03 0a 02 0d 06 6f 90 01 03 0a 09 16 09 8e 69 6f 90 01 03 0a 13 04 dd 90 00 } //0a 00 
