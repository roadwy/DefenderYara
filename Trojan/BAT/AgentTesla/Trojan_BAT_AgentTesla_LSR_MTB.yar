...
rule Trojan_BAT_AgentTesla_LSR_MTB{
	...
	strings :
		...
		$a_01_1 = {00 5f 4a 4a 30 00 } //01 00  开䩊0
		$a_01_2 = {00 5f 4a 4a 31 00 } //01 00  开䩊1
		$a_01_3 = {00 5f 4a 4a 34 00 } //01 00  开䩊4
		$a_01_4 = {00 5f 4a 4a 35 00 } //01 00  开䩊5
		$a_01_5 = {00 5f 4a 4a 36 00 } //01 00  开䩊6
		$a_01_6 = {46 72 6f 6d 42 61 73 65 36 34 } //01 00  FromBase64
		$a_81_7 = {42 75 6e 69 66 75 5f 54 } //01 00  Bunifu_T
