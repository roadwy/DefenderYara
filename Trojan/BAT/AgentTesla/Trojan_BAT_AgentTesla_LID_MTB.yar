...
rule Trojan_BAT_AgentTesla_LID_MTB{
	...
	strings :
		...
		$a_01_1 = {61 62 33 34 37 66 62 36 2d 32 37 65 36 2d 34 34 36 65 2d 62 61 65 62 2d 63 33 66 31 } //01 00  ab347fb6-27e6-446e-baeb-c3f1
		$a_01_2 = {45 6e 63 6f 64 65 72 } //01 00  Encoder
		...
		$a_01_5 = {47 65 74 45 78 70 6f 72 74 65 64 54 79 70 65 73 } //00 00  GetExportedTypes
	condition:
		any of ($a_*)
