...
rule Trojan_BAT_AgentTesla_LCN_MTB{
	...
	strings :
		$a_01_0 = {34 39 65 32 39 30 37 61 2d 36 64 32 61 2d 34 61 34 62 2d 62 34 64 38 2d 33 35 61 65 35 39 34 36 38 66 63 36 } //01 00 
		$a_01_1 = {43 72 65 61 74 65 49 6e 73 74 61 6e 63 65 } //01 00 
		$a_01_2 = {54 6f 57 69 6e 33 32 } //01 00 
		$a_01_3 = {46 53 46 53 46 53 46 46 } //01 00 
		$a_01_4 = {52 6f 67 75 65 6c 69 6b 65 } //01 00 
