...
rule Trojan_BAT_AgentTesla_ABZ_MTB{
	...
	strings :
		$a_03_0 = {25 16 03 a2 6f 90 02 09 0b 07 6f 90 02 04 1f 09 9a 0c 08 72 90 02 09 14 14 19 8d 90 01 04 25 16 7e 90 01 04 a2 25 17 7e 90 01 04 a2 25 18 72 90 01 04 a2 6f 90 01 04 26 90 00 } //10
...
rule Trojan_BAT_AgentTesla_ABZ_MTB_2{
	...
	strings :
		$a_03_0 = {26 20 02 00 00 00 38 90 02 04 11 00 11 02 11 00 28 90 02 03 06 1e 5b 6f 90 02 03 0a 6f 90 02 03 0a 20 06 00 00 00 38 90 02 04 11 08 11 05 20 e8 03 00 00 73 90 02 03 0a 13 02 38 90 02 04 11 09 90 00 } //2
