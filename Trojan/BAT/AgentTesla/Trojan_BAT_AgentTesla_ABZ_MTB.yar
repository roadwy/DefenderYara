...
rule Trojan_BAT_AgentTesla_ABZ_MTB_2{
	...
	strings :
		...
		$a_01_1 = {38 00 30 00 2e 00 36 00 36 00 2e 00 37 00 35 00 2e 00 32 00 37 00 2f 00 61 00 72 00 78 00 31 00 2d 00 4e 00 63 00 70 00 76 00 66 00 75 00 69 00 6a 00 6a 00 2e 00 62 00 6d 00 70 00 } //01 00  80.66.75.27/arx1-Ncpvfuijj.bmp
		$a_01_2 = {4c 00 74 00 71 00 6a 00 78 00 63 00 71 00 75 00 } //00 00  Ltqjxcqu
	condition:
		any of ($a_*)
