...
rule Trojan_BAT_AgentTesla_LPH_MTB{
	...
	strings :
		$a_01_0 = {24 32 39 37 33 39 38 37 61 2d 35 32 62 66 2d 34 61 64 66 2d 62 32 64 66 2d 65 62 63 62 62 66 63 39 30 35 66 39 } //1 $2973987a-52bf-4adf-b2df-ebcbbfc905f9
