...
rule Trojan_BAT_AgentTesla_LPH_MTB{
	...
	strings :
		$a_01_0 = {24 32 39 37 33 39 38 37 61 2d 35 32 62 66 2d 34 61 64 66 2d 62 32 64 66 2d 65 62 63 62 62 66 63 39 30 35 66 39 } //01 00 
		...
		$a_01_5 = {44 65 62 75 67 67 65 72 53 74 65 70 54 68 72 6f 75 67 68 41 74 74 72 69 62 75 74 65 } //01 00 
