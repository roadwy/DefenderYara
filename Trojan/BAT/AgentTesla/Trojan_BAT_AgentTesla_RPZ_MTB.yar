...
rule Trojan_BAT_AgentTesla_RPZ_MTB{
	...
	strings :
		$a_01_0 = {11 06 11 04 5d 13 07 11 06 11 05 5d 13 08 11 06 17 58 11 04 5d 13 09 07 11 07 91 08 11 08 91 61 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_BAT_AgentTesla_RPZ_MTB_2{
	...
	strings :
		$a_01_0 = {0a 06 18 5b 8d 6d 00 00 01 0b 16 0c 2b 1a 00 07 08 18 5b 02 08 18 6f a2 00 00 0a 1f 10 28 a3 00 00 0a 9c 00 08 18 58 0c 08 06 fe 04 0d 09 2d } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_BAT_AgentTesla_RPZ_MTB_5{
	...
	strings :
		...
		$a_01_1 = {44 69 63 74 69 6f 6e 61 72 79 } //01 00  Dictionary
		$a_01_2 = {43 6f 6e 63 61 74 } //01 00  Concat
		$a_01_3 = {54 72 79 47 65 74 56 61 6c 75 65 } //00 00  TryGetValue
	condition:
		any of ($a_*)
...
rule Trojan_BAT_AgentTesla_RPZ_MTB_7{
	...
	strings :
		$a_01_0 = {38 00 30 00 2e 00 36 00 36 00 2e 00 37 00 35 00 2e 00 33 00 37 00 } //01 00  80.66.75.37
		$a_01_1 = {61 00 2d 00 42 00 64 00 6d 00 6b 00 77 00 7a 00 71 00 65 00 63 00 2e 00 62 00 6d 00 70 00 } //01 00  a-Bdmkwzqec.bmp
		$a_01_2 = {52 00 65 00 70 00 6c 00 61 00 63 00 65 00 } //01 00  Replace
		$a_01_3 = {54 00 6f 00 41 00 72 00 72 00 61 00 79 00 } //01 00  ToArray
		$a_01_4 = {52 00 65 00 61 00 64 00 43 00 68 00 61 00 72 00 } //01 00  ReadChar
		...
		$a_01_8 = {48 74 74 70 57 65 62 52 65 71 75 65 73 74 } //00 00  HttpWebRequest
	condition:
		any of ($a_*)
