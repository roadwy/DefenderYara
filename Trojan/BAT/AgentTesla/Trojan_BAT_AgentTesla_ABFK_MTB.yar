...
rule Trojan_BAT_AgentTesla_ABFK_MTB{
	...
	strings :
		...
		$a_01_1 = {50 00 72 00 61 00 63 00 74 00 69 00 63 00 61 00 31 00 2e 00 52 00 65 00 73 00 6f 00 75 00 72 00 63 00 65 00 73 00 } //01 00 
		$a_01_2 = {50 00 72 00 61 00 63 00 74 00 69 00 63 00 61 00 31 00 2e 00 52 00 65 00 73 00 32 00 31 00 } //00 00 
	condition:
		any of ($a_*)
