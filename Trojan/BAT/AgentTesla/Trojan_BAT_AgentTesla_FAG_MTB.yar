...
rule Trojan_BAT_AgentTesla_FAG_MTB{
	...
	strings :
		$a_03_0 = {11 01 11 00 11 04 18 6f 90 01 01 00 00 0a 1f 10 28 90 01 01 00 00 0a b4 6f 90 01 01 00 00 0a 20 90 01 01 00 00 00 28 90 01 01 00 00 06 3a 90 01 02 ff ff 26 20 16 00 00 00 38 90 01 02 ff ff 02 6f 90 01 01 00 00 06 28 90 01 01 01 00 06 02 6f 90 01 01 00 00 06 6f 90 01 01 00 00 0a 38 90 01 01 13 00 00 02 6f 90 01 01 00 00 06 72 90 00 } //3
