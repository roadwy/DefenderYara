...
rule Trojan_BAT_AgentTesla_OV_MTB{
	...
	strings :
		$a_02_0 = {03 11 04 18 6f 90 02 04 28 90 02 04 28 90 02 04 04 07 6f 90 02 04 28 90 02 04 6a 61 b7 28 90 02 08 28 90 02 09 6f 90 02 04 26 07 04 6f 90 02 04 17 90 00 } //1
