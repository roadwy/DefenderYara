...
rule Trojan_BAT_AgentTesla_ABMZ_MTB{
	...
	strings :
		...
		$a_01_1 = {4e 00 74 00 68 00 2e 00 45 00 69 00 6e 00 64 00 68 00 6f 00 76 00 65 00 6e 00 2e 00 46 00 6f 00 6e 00 74 00 79 00 73 00 2e 00 7a 00 65 00 } //00 00 
	condition:
		any of ($a_*)
