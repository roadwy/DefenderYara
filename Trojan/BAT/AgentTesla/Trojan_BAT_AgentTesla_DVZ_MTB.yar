...
rule Trojan_BAT_AgentTesla_DVZ_MTB{
	...
	strings :
		$a_01_0 = {79 00 65 00 73 00 2e 00 79 00 65 00 73 00 } //01 00 
		$a_01_1 = {46 00 55 00 55 00 4e 00 59 00 41 00 4e 00 44 00 48 00 41 00 52 00 44 00 } //01 00 
		...
		$a_01_8 = {70 00 6f 00 77 00 65 00 72 00 } //00 00 
	condition:
		any of ($a_*)
