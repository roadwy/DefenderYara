...
rule Trojan_BAT_AgentTesla_DCJ_MTB_2{
	...
	strings :
		$a_01_0 = {24 34 34 39 42 42 35 37 45 2d 46 33 37 44 2d 34 32 30 37 2d 39 39 43 34 2d 35 43 43 44 41 45 44 30 42 39 35 45 } //01 00 
		...
		$a_01_5 = {00 47 65 74 45 6e 74 72 79 41 73 73 65 6d 62 6c 79 00 } //01 00 
