...
rule Trojan_BAT_AgentTesla_ETR_MTB{
	...
	strings :
		$a_01_0 = {31 36 61 39 34 63 37 34 2d 31 63 37 31 2d 34 65 62 65 2d 39 36 66 31 2d 61 38 63 66 33 36 38 33 34 36 66 33 } //01 00  16a94c74-1c71-4ebe-96f1-a8cf368346f3
		$a_01_1 = {00 47 65 74 54 79 70 65 46 72 6f 6d 48 61 6e 64 6c 65 00 } //01 00 
		$a_01_2 = {00 47 65 74 4d 65 74 68 6f 64 00 } //01 00 
		$a_01_3 = {00 49 6e 76 6f 6b 65 4d 65 6d 62 65 72 00 } //01 00  䤀癮歯䵥浥敢r
...
rule Trojan_BAT_AgentTesla_ETR_MTB_2{
	...
	strings :
		...
		$a_01_2 = {00 43 6f 72 65 56 69 65 77 00 } //01 00  䌀牯噥敩w
		...
		$a_01_6 = {00 43 6f 6e 74 65 78 74 4d 61 6e 61 67 65 72 00 } //01 00  䌀湯整瑸慍慮敧r
