...
rule Trojan_BAT_AgentTesla_EFF_MTB{
	...
	strings :
		...
		$a_01_1 = {42 00 75 00 7e 00 7e 00 6e 00 7e 00 7e 00 69 00 66 00 7e 00 7e 00 75 00 5f 00 7e 00 7e 00 54 00 65 00 7e 00 7e 00 78 00 74 00 7e 00 7e 00 42 00 6f 00 7e 00 7e 00 78 00 } //01 00  Bu~~n~~if~~u_~~Te~~xt~~Bo~~x
		$a_01_2 = {78 00 6f 00 42 00 74 00 78 00 65 00 54 00 5f 00 75 00 66 00 69 00 6e 00 75 00 42 00 } //00 00  xoBtxeT_ufinuB
	condition:
		any of ($a_*)
