...
rule Trojan_BAT_AgentTesla_EFF_MTB{
	...
	strings :
		$a_03_0 = {13 04 11 04 28 90 01 03 0a 20 9e 02 00 00 da 13 05 11 05 28 90 01 03 0a 28 90 01 03 0a 13 06 07 11 06 28 90 01 03 0a 0b 00 09 17 d6 0d 90 09 0c 00 08 09 6f 90 01 03 0a 28 90 01 03 0a 90 00 } //10
