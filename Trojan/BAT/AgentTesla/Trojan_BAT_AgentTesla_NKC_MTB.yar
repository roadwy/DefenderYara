...
rule Trojan_BAT_AgentTesla_NKC_MTB{
	...
	strings :
		...
		$a_03_1 = {06 07 08 1b 5b 93 28 ?? ?? ?? 0a 1f 0a 62 0d 08 1b 5b 17 58 07 8e 69 fe 04 13 04 11 04 2c 1b 09 20 ?? ?? ?? ?? 28 2c 00 00 06 07 08 1b 5b 17 58 93 28 ?? ?? ?? 0a 1b 62 60 0d 08 1b 5b 18 58 07 8e 69 fe 04 13 05 11 05 2c 19 } //1
