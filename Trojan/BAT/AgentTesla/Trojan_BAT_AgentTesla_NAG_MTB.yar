...
rule Trojan_BAT_AgentTesla_NAG_MTB{
	...
	strings :
		...
		$a_01_1 = {68 6a 6b 6a 2e 65 78 65 } //00 00  hjkj.exe
	condition:
		any of ($a_*)
...
rule Trojan_BAT_AgentTesla_NAG_MTB_2{
	...
	strings :
		...
		$a_01_1 = {47 50 54 34 5f 56 32 2e 50 72 6f 70 65 72 74 69 65 73 2e 52 65 73 6f 75 72 63 65 73 } //00 00  GPT4_V2.Properties.Resources
	condition:
		any of ($a_*)
...
rule Trojan_BAT_AgentTesla_NAG_MTB_3{
	...
	strings :
		...
		$a_01_1 = {49 5f 5f 5f 5f 5f 5f 5f 49 } //00 00  I_______I
	condition:
		any of ($a_*)
