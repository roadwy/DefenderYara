...
rule Trojan_BAT_AgentTesla_NAG_MTB{
	...
	strings :
		$a_03_0 = {28 0f 00 00 0a 72 90 01 01 00 00 70 28 90 01 01 00 00 06 6f 90 01 01 00 00 0a 28 90 01 01 00 00 0a 28 90 01 01 00 00 2b 28 90 01 01 00 00 2b 13 01 90 00 } //5
...
rule Trojan_BAT_AgentTesla_NAG_MTB_2{
	...
	strings :
		$a_03_0 = {02 72 23 00 00 70 6f 90 01 03 0a 00 02 02 fe 90 01 04 06 73 90 01 03 0a 28 90 01 03 0a 00 02 16 28 90 01 03 0a 00 2a 90 00 } //5
