...
rule Trojan_BAT_AgentTesla_MG_MTB_2{
	...
	strings :
		$a_03_0 = {16 0a 2b 27 7e 13 00 00 04 06 7e 13 00 00 04 06 9a 19 28 90 01 03 0a 72 cf 00 00 70 72 d3 00 00 70 6f 90 01 03 0a a2 06 17 58 0a 06 7e 13 00 00 04 8e 69 32 cf 90 00 } //10
