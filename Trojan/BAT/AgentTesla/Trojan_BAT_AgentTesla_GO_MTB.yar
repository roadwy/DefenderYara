...
rule Trojan_BAT_AgentTesla_GO_MTB{
	meta:
		description = "Trojan:BAT/AgentTesla.GO!MTB,SIGNATURE_TYPE_PEHSTR_EXT,17 00 17 00 0d 00 00 14 00 "
		
	strings :
		$a_81_0 = {24 61 34 34 65 31 30 61 61 2d 65 35 33 66 2d 34 66 66 31 2d 39 61 38 35 2d 38 32 34 35 35 63 62 35 31 37 36 64 } //14 00  $a44e10aa-e53f-4ff1-9a85-82455cb5176d
		$a_81_1 = {24 61 64 34 61 39 66 35 39 2d 38 64 36 38 2d 34 66 38 33 2d 61 39 64 66 2d 31 66 63 38 64 36 34 34 65 64 63 64 } //14 00  $ad4a9f59-8d68-4f83-a9df-1fc8d644edcd
		$a_81_2 = {24 34 35 35 65 66 64 36 39 2d 31 61 34 39 2d 34 31 66 30 2d 38 35 64 64 2d 36 34 36 35 65 62 39 66 30 35 61 31 } //14 00  $455efd69-1a49-41f0-85dd-6465eb9f05a1
		$a_81_3 = {24 62 63 35 31 37 36 31 65 2d 64 33 62 63 2d 34 66 37 62 2d 39 34 30 37 2d 35 36 62 33 64 39 64 61 65 36 38 65 } //01 00  $bc51761e-d3bc-4f7b-9407-56b3d9dae68e
