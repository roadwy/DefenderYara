...
rule Trojan_BAT_AgentTesla_RPY_MTB_3{
	...
	strings :
		...
		$a_01_1 = {53 74 6f 70 77 61 74 63 68 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_BAT_AgentTesla_RPY_MTB_4{
	...
	strings :
		...
		$a_01_4 = {43 6f 6e 76 65 72 74 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_BAT_AgentTesla_RPY_MTB_5{
	...
	strings :
		$a_01_0 = {31 00 30 00 37 00 2e 00 31 00 37 00 32 00 2e 00 32 00 30 00 36 00 2e 00 31 00 32 00 30 00 2f 00 30 00 30 00 30 00 2f 00 } //01 00 
		$a_01_1 = {4a 00 79 00 65 00 67 00 75 00 76 00 7a 00 78 00 61 00 2e 00 70 00 6e 00 67 00 } //01 00 
		$a_01_2 = {47 00 65 00 74 00 45 00 78 00 70 00 6f 00 72 00 74 00 65 00 64 00 54 00 79 00 70 00 65 00 73 00 } //01 00 
		$a_01_3 = {48 74 74 70 43 6c 69 65 6e 74 } //01 00 
		$a_01_4 = {54 6f 41 72 72 61 79 } //01 00 
		$a_01_5 = {46 69 6c 65 53 74 72 65 61 6d } //01 00 
		$a_01_6 = {54 6f 53 74 72 69 6e 67 } //01 00 
		$a_01_7 = {45 6e 63 6f 64 69 6e 67 } //01 00 
		$a_01_8 = {52 65 76 65 72 73 65 } //00 00 
	condition:
		any of ($a_*)
