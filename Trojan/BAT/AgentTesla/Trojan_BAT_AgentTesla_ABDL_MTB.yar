...
rule Trojan_BAT_AgentTesla_ABDL_MTB{
	...
	strings :
		$a_03_0 = {02 28 19 01 90 01 01 0a 28 90 01 03 0a 0a 2b 00 06 2a 90 00 } //2
		$a_03_1 = {11 04 16 91 2d 02 2b 09 09 16 9a 28 90 01 03 0a 0c 74 90 01 03 01 28 90 01 03 06 00 06 2a 90 00 } //2
