...
rule Trojan_BAT_AgentTesla_CMX_MTB{
	...
	strings :
		$a_03_0 = {07 11 04 06 11 04 18 d8 18 6f 90 01 03 0a 1f 10 28 90 01 03 0a b4 9c 07 11 04 72 90 01 03 70 28 90 01 03 0a 72 90 01 03 70 20 00 01 00 00 14 14 18 8d 90 01 03 01 25 16 06 11 04 18 d8 18 6f 90 01 03 0a a2 25 17 1f 10 8c 90 01 03 01 a2 6f 90 01 03 0a 28 90 00 } //1
