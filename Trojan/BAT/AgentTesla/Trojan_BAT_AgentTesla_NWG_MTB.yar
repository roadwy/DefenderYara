...
rule Trojan_BAT_AgentTesla_NWG_MTB{
	...
	strings :
		$a_01_0 = {57 d5 02 20 09 02 00 00 00 da a4 20 00 16 00 00 01 00 00 00 2c 00 00 00 05 00 00 00 01 00 00 00 0a 00 00 00 01 00 00 00 2a 00 00 00 0f 00 00 00 01 } //10
