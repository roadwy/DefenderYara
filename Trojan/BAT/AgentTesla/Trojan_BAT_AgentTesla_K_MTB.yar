...
rule Trojan_BAT_AgentTesla_K_MTB_2{
	...
	strings :
		$a_01_0 = {42 00 6c 00 65 00 6e 00 64 00 43 00 6f 00 72 00 65 00 2e 00 52 00 65 00 73 00 6f 00 75 00 72 00 63 00 65 00 73 00 } //01 00 
		$a_01_1 = {52 00 61 00 74 00 52 00 75 00 6e 00 50 00 63 00 74 00 } //01 00 
		$a_01_2 = {52 00 61 00 74 00 50 00 63 00 74 00 } //01 00 
		$a_01_3 = {52 00 61 00 74 00 52 00 75 00 6e 00 } //01 00 
		$a_01_4 = {52 00 61 00 74 00 52 00 75 00 6e 00 35 00 } //01 00 
		$a_01_5 = {42 00 61 00 63 00 6b 00 52 00 61 00 74 00 } //00 00 
