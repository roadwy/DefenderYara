...
rule Trojan_BAT_AgentTesla_EVR_MTB{
	...
	strings :
		$a_01_0 = {00 44 69 63 74 69 6f 6e 61 72 79 45 6e 75 6d 65 72 61 74 6f 72 00 } //01 00  䐀捩楴湯牡䕹畮敭慲潴r
		...
		$a_01_5 = {00 4f 70 63 6f 64 65 00 } //01 00  伀捰摯e
		$a_01_6 = {00 53 65 61 72 63 68 52 65 73 75 6c 74 00 } //01 00  匀慥捲剨獥汵t
