...
rule Trojan_BAT_AgentTesla_DRR_MTB{
	...
	strings :
		$a_03_0 = {06 02 08 18 28 90 01 03 06 1f 10 28 90 01 03 06 84 28 90 01 03 06 6f 90 01 03 0a 26 08 18 d6 0c 90 00 } //1
		$a_03_1 = {08 11 04 02 11 04 91 07 61 06 09 91 61 28 90 01 03 0a 9c 09 03 6f 90 01 03 0a 17 59 90 00 } //1
	condition:
...
rule Trojan_BAT_AgentTesla_DRR_MTB_2{
	...
	strings :
		$a_03_0 = {08 09 11 04 28 90 01 03 06 13 07 11 07 28 90 01 03 0a 13 08 07 06 11 08 d2 9c 00 11 04 17 58 13 04 90 00 } //1
