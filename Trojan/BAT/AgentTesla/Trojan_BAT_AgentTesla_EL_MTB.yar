...
rule Trojan_BAT_AgentTesla_EL_MTB_2{
	...
	strings :
		$a_03_0 = {70 03 11 04 18 6f 90 01 03 0a 28 90 01 03 0a 28 90 01 03 0a 04 07 6f 90 01 03 0a 28 90 01 03 0a 6a 61 b7 28 90 01 03 0a 13 07 12 07 28 90 01 03 0a 13 05 08 11 05 6f 90 01 03 0a 26 07 04 6f 90 01 03 0a 17 da 33 03 90 00 } //10
		$a_03_1 = {70 03 11 04 18 6f 90 01 03 0a 28 90 01 03 0a 28 90 01 03 0a 04 07 6f 90 01 03 0a 28 90 01 03 0a 6a 61 b7 28 90 01 03 0a 13 06 12 06 28 90 01 03 0a 13 05 08 11 05 6f 90 01 03 0a 26 07 04 6f 90 01 03 0a 17 da 33 03 90 00 } //10
