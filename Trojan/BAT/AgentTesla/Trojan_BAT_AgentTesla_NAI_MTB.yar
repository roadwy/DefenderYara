...
rule Trojan_BAT_AgentTesla_NAI_MTB{
	meta:
		description = "Trojan:BAT/AgentTesla.NAI!MTB,SIGNATURE_TYPE_PEHSTR_EXT,08 00 08 00 08 00 00 01 00 "
		
	strings :
		$a_01_0 = {24 66 39 30 30 35 30 62 39 2d 63 37 32 31 2d 34 61 31 32 2d 62 37 64 64 2d 37 30 63 35 35 66 64 66 30 63 64 31 } //01 00  $f90050b9-c721-4a12-b7dd-70c55fdf0cd1
