...
rule Trojan_BAT_AgentTesla_NEX_MTB{
	meta:
		description = "Trojan:BAT/AgentTesla.NEX!MTB,SIGNATURE_TYPE_PEHSTR_EXT,19 00 19 00 09 00 00 0a 00 "
		
	strings :
		$a_01_0 = {44 33 33 33 42 41 41 43 2d 30 37 34 33 2d 34 46 36 31 2d 39 43 39 43 2d 33 36 38 43 34 32 36 34 42 44 37 35 } //0a 00  D333BAAC-0743-4F61-9C9C-368C4264BD75
		$a_01_1 = {53 70 61 6e 20 54 61 67 20 52 65 6d 6f 76 65 72 } //01 00  Span Tag Remover
