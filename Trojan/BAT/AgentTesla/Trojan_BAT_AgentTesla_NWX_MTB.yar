...
rule Trojan_BAT_AgentTesla_NWX_MTB{
	...
	strings :
		...
		$a_01_1 = {24 61 61 61 63 31 36 37 39 2d 31 65 36 63 2d 34 37 65 62 2d 61 33 32 36 2d 33 39 39 30 35 66 63 37 35 62 33 33 } //01 00 
		$a_01_2 = {24 31 65 32 65 33 38 62 37 2d 33 33 63 62 2d 34 33 38 34 2d 38 38 35 63 2d 31 65 31 31 63 63 62 64 32 31 34 34 } //00 00 
	condition:
		any of ($a_*)
