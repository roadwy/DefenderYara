...
rule Trojan_BAT_AgentTesla_NAT_MTB{
	...
	strings :
		...
		$a_01_1 = {43 75 74 73 6f 67 67 77 67 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_BAT_AgentTesla_NAT_MTB_2{
	...
	strings :
		...
		$a_01_1 = {32 61 62 39 39 63 66 2d 38 65 33 35 2d 34 35 33 65 2d 38 38 64 36 2d 34 33 64 31 36 30 30 31 65 64 35 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_BAT_AgentTesla_NAT_MTB_3{
	...
	strings :
		...
		$a_01_1 = {4a 00 49 00 54 00 53 00 74 00 61 00 72 00 74 00 65 00 72 00 } //00 00 
	condition:
		any of ($a_*)
