...
rule Trojan_BAT_AgentTesla_MBGS_MTB{
	...
	strings :
		$a_03_0 = {25 20 10 27 00 00 13 00 12 00 6f 90 01 01 00 00 06 1c 13 00 12 00 1d 13 01 12 01 90 00 } //1
...
rule Trojan_BAT_AgentTesla_MBGS_MTB_2{
	...
	strings :
		$a_03_0 = {16 0d 2b 31 11 08 06 08 58 17 58 17 59 07 09 58 17 58 17 59 6f 90 01 01 00 00 0a 13 11 12 11 28 90 01 01 00 00 0a 13 0b 11 05 11 04 11 0b 9c 11 04 17 58 13 04 09 17 58 0d 09 17 fe 04 13 0c 11 0c 2d c5 90 00 } //1
