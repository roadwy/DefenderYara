...
rule Trojan_BAT_AgentTesla_ENT_MTB_2{
	...
	strings :
		$a_01_0 = {49 00 76 00 61 00 6b 00 6b 00 77 00 70 00 61 00 } //01 00 
		...
		$a_01_3 = {00 57 65 62 52 65 71 75 65 73 74 00 } //01 00 
		$a_01_4 = {00 47 65 74 54 79 70 65 00 } //01 00 
		$a_01_5 = {00 47 65 74 4d 65 74 68 6f 64 00 } //01 00 
		$a_01_6 = {00 54 72 69 70 6c 65 44 45 53 43 72 79 70 74 6f 53 65 72 76 69 63 65 50 72 6f 76 69 64 65 72 00 } //01 00 
		$a_01_7 = {00 53 79 6d 6d 65 74 72 69 63 41 6c 67 6f 72 69 74 68 6d 00 } //00 00 
	condition:
		any of ($a_*)
