...
rule Trojan_BAT_AgentTesla_EBG_MTB{
	...
	strings :
		$a_01_0 = {00 4c 65 76 65 6c 00 70 6f 00 4f 30 4f 30 4f 00 } //1 䰀癥汥瀀oくくO
		...
		$a_01_5 = {00 47 65 74 54 79 70 65 73 } //1
		$a_01_6 = {00 44 69 73 70 6c 61 79 4e 61 6d 65 00 4f 30 4f 30 00 4f 30 4f 30 4f 30 00 } //1
