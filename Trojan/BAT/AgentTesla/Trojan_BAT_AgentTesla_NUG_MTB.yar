...
rule Trojan_BAT_AgentTesla_NUG_MTB{
	...
	strings :
		$a_03_0 = {8d 17 00 00 01 25 16 11 07 17 da 8c 90 01 03 01 a2 14 28 90 01 03 0a 28 90 01 03 0a 28 90 01 03 06 11 04 11 07 11 04 6f 90 01 03 0a 5d 6f 90 01 03 0a 28 90 01 03 06 da 13 08 11 05 11 08 28 90 01 03 0a 28 90 01 03 0a 28 90 01 03 0a 13 05 11 07 17 d6 13 07 90 00 } //1
