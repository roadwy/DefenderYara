...
rule Trojan_BAT_AgentTesla_PSDW_MTB{
	...
	strings :
		$a_03_0 = {73 cb 00 00 0a 13 04 11 04 17 6f cc 90 01 03 11 04 17 6f cd 90 01 03 11 04 0b 07 03 06 6f ce 90 01 03 0c 28 2a 90 01 03 08 02 16 02 8e 69 6f cf 90 01 03 6f 2b 90 01 03 0d 09 1f 10 6f d0 90 01 03 13 05 de 06 90 00 } //5
