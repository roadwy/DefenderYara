...
rule Trojan_BAT_AgentTesla_STMK_MTB{
	...
	strings :
		$a_02_0 = {0b 07 06 72 65 00 00 70 6f [0-02] 00 00 0a 74 02 00 00 1b 6f [0-02] 00 00 0a 07 06 72 6d 00 00 70 6f [0-02] 00 00 0a 74 02 00 00 1b 6f [0-02] 00 00 0a 07 06 72 75 00 00 70 6f [0-02] 00 00 0a 74 02 00 00 1b 6f [0-02] 00 00 0a 02 } //1
