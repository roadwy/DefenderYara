...
rule Trojan_BAT_AgentTesla_NBA_MTB{
	meta:
		description = "Trojan:BAT/AgentTesla.NBA!MTB,SIGNATURE_TYPE_PEHSTR_EXT,08 00 08 00 08 00 00 01 00 "
		
	strings :
		$a_01_0 = {24 38 34 37 39 33 32 61 33 2d 33 35 33 30 2d 34 34 35 61 2d 61 36 36 33 2d 66 62 30 34 63 36 32 30 61 37 64 39 } //01 00  $847932a3-3530-445a-a663-fb04c620a7d9
