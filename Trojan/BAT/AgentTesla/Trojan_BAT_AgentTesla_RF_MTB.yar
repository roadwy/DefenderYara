...
rule Trojan_BAT_AgentTesla_RF_MTB_3{
	...
	strings :
		$a_01_0 = {63 00 68 00 72 00 69 00 73 00 74 00 69 00 61 00 6e 00 62 00 65 00 6c 00 74 00 72 00 61 00 6e 00 2e 00 63 00 6f 00 2f 00 77 00 70 00 2d 00 61 00 64 00 6d 00 69 00 6e 00 2f 00 69 00 6d 00 61 00 67 00 65 00 73 00 2f 00 63 00 73 00 73 00 2f 00 67 00 72 00 6f 00 75 00 6e 00 64 00 2f 00 62 00 6f 00 } //01 00 
		$a_01_1 = {53 6c 65 65 70 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_BAT_AgentTesla_RF_MTB_4{
	...
	strings :
		...
		$a_81_3 = {50 72 69 6d 65 72 } //01 00 
		$a_81_4 = {44 45 53 5f 44 65 63 72 79 70 74 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_BAT_AgentTesla_RF_MTB_5{
	...
	strings :
		...
		$a_01_1 = {68 00 6b 00 6b 00 7a 00 75 00 77 00 6c 00 31 00 30 00 45 00 54 00 6a 00 2b 00 53 00 7a 00 78 00 6d 00 54 00 4c 00 6c 00 79 00 77 00 3d 00 3d 00 } //01 00 
		$a_01_2 = {4d 00 61 00 74 00 72 00 69 00 78 00 47 00 72 00 61 00 70 00 68 00 69 00 63 00 73 00 47 00 65 00 6e 00 65 00 72 00 61 00 74 00 6f 00 72 00 2e 00 65 00 78 00 65 00 } //00 00 
	condition:
		any of ($a_*)
