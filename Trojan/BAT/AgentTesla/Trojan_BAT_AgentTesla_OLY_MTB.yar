...
rule Trojan_BAT_AgentTesla_OLY_MTB{
	...
	strings :
		...
		$a_02_8 = {68 00 74 00 74 00 70 00 3a 00 2f 00 2f 00 74 00 65 00 6d 00 70 00 75 00 72 00 69 00 2e 00 6f 00 72 00 67 00 2f 00 90 02 25 2e 00 78 00 73 00 64 00 90 00 } //2
	condition:
