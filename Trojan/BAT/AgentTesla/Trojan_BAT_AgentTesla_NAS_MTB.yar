...
rule Trojan_BAT_AgentTesla_NAS_MTB{
	...
	strings :
		$a_03_0 = {02 06 72 87 03 00 70 28 ?? ?? 00 06 28 ?? ?? 00 0a 28 ?? ?? 00 06 25 28 ?? ?? 00 06 0b 07 6f ?? ?? 00 0a 6f ?? ?? 00 0a 28 ?? ?? 00 0a 0c 07 08 28 ?? ?? 00 0a } //5
		$a_01_1 = {69 6e 63 75 72 61 62 6c 65 2e 65 78 65 } //1 incurable.exe
