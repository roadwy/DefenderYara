...
rule Trojan_BAT_AgentTesla_NVA_MTB{
	...
	strings :
		$a_01_0 = {24 32 39 31 35 34 39 62 35 2d 64 30 39 62 2d 34 32 35 62 2d 38 65 35 32 2d 34 31 38 37 66 33 33 66 36 64 30 32 } //01 00  $291549b5-d09b-425b-8e52-4187f33f6d02
