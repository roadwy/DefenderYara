...
rule Trojan_BAT_AgentTesla_CQN_MTB{
	...
	strings :
		$a_03_0 = {2d 03 26 2b 03 0b 2b 00 06 16 73 90 01 03 0a 73 90 01 03 0a 90 01 01 2d 03 26 2b 03 0c 2b 00 08 07 6f 90 01 03 0a de 07 08 6f 90 01 03 0a dc 07 6f 90 01 03 0a 0d de 0e 07 6f 90 01 03 0a dc 90 00 } //1
