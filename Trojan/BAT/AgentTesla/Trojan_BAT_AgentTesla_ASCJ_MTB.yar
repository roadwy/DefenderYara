...
rule Trojan_BAT_AgentTesla_ASCJ_MTB{
	...
	strings :
		$a_03_0 = {11 05 8e 69 17 da 13 1e 16 13 1f 2b 1d 11 06 11 1f 11 05 11 1f 9a 1f 10 28 90 01 01 00 00 0a 86 6f 90 01 01 00 00 0a 00 11 1f 17 d6 13 1f 11 1f 11 1e 31 dd 90 00 } //4
