...
rule Trojan_BAT_AgentTesla_CLP_MTB{
	...
	strings :
		$a_03_0 = {07 11 04 72 ?? ?? ?? 70 28 ?? ?? ?? 0a 72 ?? ?? ?? 70 20 00 01 00 00 14 14 18 8d ?? ?? ?? 01 25 16 06 11 04 18 d8 18 6f ?? ?? ?? 0a a2 25 17 1f 10 8c ?? ?? ?? 01 a2 6f ?? ?? ?? 0a 28 ?? ?? ?? 0a 9c 11 04 17 d6 13 04 } //1
