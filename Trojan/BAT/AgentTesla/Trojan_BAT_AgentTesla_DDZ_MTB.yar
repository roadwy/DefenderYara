...
rule Trojan_BAT_AgentTesla_DDZ_MTB{
	...
	strings :
		$a_03_0 = {08 09 9a 13 04 11 04 28 90 01 03 0a 23 00 00 00 00 00 80 73 40 59 28 90 01 03 0a b7 13 05 07 11 05 28 90 01 03 0a 8c 90 01 03 01 28 90 01 03 0a 0b 00 09 17 d6 0d 09 08 8e 69 90 00 } //1
