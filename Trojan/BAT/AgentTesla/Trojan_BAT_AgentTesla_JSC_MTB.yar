...
rule Trojan_BAT_AgentTesla_JSC_MTB{
	...
	strings :
		...
		$a_01_1 = {24 34 30 64 34 31 64 62 65 2d 35 34 65 36 2d 34 38 62 31 2d 61 63 64 39 2d 61 38 63 33 31 34 36 66 35 65 39 36 } //01 00 
		$a_01_2 = {5f 58 5f 58 30 46 54 5f 46 54 32 } //00 00 
	condition:
		any of ($a_*)
