...
rule Trojan_BAT_AgentTesla_IM_MTB{
	...
	strings :
		$a_02_0 = {00 01 25 16 02 03 74 ?? ?? ?? 1b 0b 12 01 28 b2 00 00 06 0c 07 10 01 08 a2 14 14 14 28 ?? ?? ?? 0a 74 ?? ?? ?? 01 0a 02 06 72 } //10
...
rule Trojan_BAT_AgentTesla_IM_MTB_2{
	...
	strings :
		$a_03_0 = {20 00 10 00 00 8d ?? ?? ?? 01 13 04 2b 0b 08 11 04 16 11 05 6f ?? ?? ?? 0a 09 11 04 16 11 04 8e 69 6f ?? ?? ?? 0a 25 13 05 16 30 e2 } //10
