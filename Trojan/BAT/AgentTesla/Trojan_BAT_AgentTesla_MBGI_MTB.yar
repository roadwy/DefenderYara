...
rule Trojan_BAT_AgentTesla_MBGI_MTB{
	...
	strings :
		$a_03_0 = {06 20 00 01 00 00 6f ?? 00 00 0a 06 20 bd 97 00 00 28 ?? 00 00 06 28 ?? 00 00 0a 6f ?? 00 00 0a 06 20 76 94 00 00 28 ?? 00 00 06 28 ?? 00 00 0a 6f ?? 00 00 0a 06 06 6f ?? 00 00 0a 06 6f ?? 00 00 0a 6f ?? 00 00 0a 0b 14 } //1
