...
rule Trojan_BAT_AgentTesla_NIN_MTB{
	...
	strings :
		...
		$a_81_5 = {46 72 6f 6d 42 61 73 65 36 34 43 68 61 72 41 72 72 61 79 } //01 00 
		$a_81_6 = {49 5f 5f 5f 5f 5f 5f 5f 5f 5f 5f 5f 5f 5f 5f 5f 5f 5f 5f 35 } //01 00 
		$a_81_7 = {47 65 74 45 78 70 6f 72 74 65 64 54 79 70 65 73 } //01 00 
		$a_81_8 = {54 6f 43 68 61 72 41 72 72 61 79 } //01 00 
		$a_81_9 = {54 6f 53 74 72 69 6e 67 } //00 00 
	condition:
		any of ($a_*)
