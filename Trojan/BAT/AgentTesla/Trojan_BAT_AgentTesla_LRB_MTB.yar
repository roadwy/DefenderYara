...
rule Trojan_BAT_AgentTesla_LRB_MTB{
	...
	strings :
		...
		$a_01_2 = {00 43 46 33 34 32 34 32 33 35 36 36 35 00 } //1 䌀㍆㈴㈴㔳㘶5
		$a_01_3 = {00 4c 65 76 65 6c 00 } //1
		$a_01_4 = {00 43 46 30 30 31 32 33 31 00 } //1
		...
		$a_01_7 = {00 43 46 32 33 34 30 35 32 00 } //1 䌀㉆㐳㔰2
		$a_01_8 = {00 43 46 33 32 31 34 38 31 32 33 00 } //1 䌀㍆ㄲ㠴㈱3
		$a_01_9 = {47 65 74 54 79 70 65 46 72 6f 6d 48 61 6e 64 6c 65 } //1 GetTypeFromHandle
	condition:
