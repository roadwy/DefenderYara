...
rule Trojan_BAT_AgentTesla_MM_MTB_2{
	...
	strings :
		$a_01_0 = {4d 65 6d 6f 72 79 53 74 72 65 61 6d } //01 00  MemoryStream
		...
		$a_01_5 = {54 00 55 00 46 00 48 00 6b 00 74 00 49 00 31 00 78 00 46 00 32 00 38 00 44 00 71 00 72 00 75 00 53 00 73 00 68 00 } //01 00  TUFHktI1xF28DqruSsh
		$a_01_6 = {78 00 54 00 43 00 49 00 49 00 79 00 67 00 62 00 76 00 4c 00 } //00 00  xTCIIygbvL
	condition:
		any of ($a_*)
