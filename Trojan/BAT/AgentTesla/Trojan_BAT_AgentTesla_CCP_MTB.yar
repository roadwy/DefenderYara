...
rule Trojan_BAT_AgentTesla_CCP_MTB_2{
	...
	strings :
		$a_81_0 = {42 46 35 34 41 36 38 34 2d 39 33 41 44 2d 34 35 42 34 2d 42 46 31 39 2d 38 37 42 31 30 43 39 42 36 30 32 46 } //01 00 
		$a_81_1 = {49 45 78 70 61 6e 64 6f } //01 00 
		$a_81_2 = {47 65 74 50 69 78 65 6c } //01 00 
