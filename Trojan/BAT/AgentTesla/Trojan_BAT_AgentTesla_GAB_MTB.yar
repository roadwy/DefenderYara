...
rule Trojan_BAT_AgentTesla_GAB_MTB_2{
	...
	strings :
		$a_01_0 = {46 00 6c 00 75 00 65 00 6e 00 63 00 65 00 2e 00 46 00 6c 00 75 00 65 00 6e 00 63 00 65 00 } //01 00  Fluence.Fluence
		$a_01_1 = {46 00 6c 00 75 00 65 00 6e 00 63 00 65 00 73 00 } //01 00  Fluences
		$a_01_2 = {42 00 49 00 47 00 42 00 4f 00 53 00 53 00 } //01 00  BIGBOSS
		...
		$a_81_10 = {52 65 76 65 72 73 65 } //01 00  Reverse
		$a_81_11 = {44 6f 77 6e 6c 6f 61 64 44 61 74 61 } //00 00  DownloadData
	condition:
		any of ($a_*)
