...
rule Trojan_BAT_AgentTesla_IR_MTB{
	...
	strings :
		...
		$a_81_2 = {69 6d 69 6d 69 6d 69 6d 69 6d } //01 00  imimimimim
		$a_81_3 = {4f 62 73 41 74 74 72 69 62 75 74 65 } //01 00  ObsAttribute
		$a_81_4 = {00 78 78 78 78 78 78 78 78 78 78 78 78 78 78 78 78 78 78 00 61 7a 78 00 } //00 00  砀硸硸硸硸硸硸硸硸x穡x
	condition:
		any of ($a_*)
