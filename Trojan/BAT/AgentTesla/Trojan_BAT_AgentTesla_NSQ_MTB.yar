...
rule Trojan_BAT_AgentTesla_NSQ_MTB{
	...
	strings :
		$a_01_0 = {24 31 35 30 62 65 37 35 61 2d 34 65 35 36 2d 34 64 30 32 2d 62 38 33 36 2d 66 35 33 39 33 38 64 30 34 62 64 36 } //01 00 
		$a_01_1 = {54 69 6d 65 62 6f 78 2e 50 72 6f 70 65 72 74 69 65 73 2e 52 65 73 6f 75 72 63 65 73 2e 72 65 73 6f 75 72 63 65 73 } //01 00 
