...
rule Trojan_BAT_AgentTesla_NX_MTB{
	...
	strings :
		...
		$a_01_1 = {24 33 33 66 65 35 63 33 32 2d 64 62 36 61 2d 34 64 37 61 2d 61 64 64 63 2d 65 31 64 30 64 38 35 38 38 66 61 39 } //01 00 
		$a_01_2 = {47 65 74 54 79 70 65 } //01 00 
		$a_01_3 = {54 77 65 65 6e 45 6e 67 69 6e 65 41 50 49 2e 64 6c 6c } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_BAT_AgentTesla_NX_MTB_2{
	...
	strings :
		...
		$a_81_1 = {46 6f 75 72 41 72 } //01 00 
		$a_81_2 = {46 61 6c 6c 62 61 63 6b 42 75 66 66 65 72 } //01 00 
		$a_81_3 = {57 53 54 52 42 75 66 66 65 72 4d 61 72 73 68 61 6c 65 72 } //01 00 
		$a_81_4 = {53 74 72 52 65 76 65 72 73 65 } //01 00 
		$a_81_5 = {49 73 4e 6f 74 50 75 62 6c 69 63 } //01 00 
		$a_81_6 = {46 72 6f 6d 42 61 73 65 36 34 53 74 72 69 6e 67 } //01 00 
		$a_81_7 = {46 6f 72 6d 61 74 74 65 72 54 79 70 65 53 74 79 6c 65 } //01 00 
		$a_81_8 = {54 69 6d 65 72 31 } //00 00 
	condition:
		any of ($a_*)
