...
rule Trojan_BAT_AgentTesla_NLV_MTB{
	meta:
		description = "Trojan:BAT/AgentTesla.NLV!MTB,SIGNATURE_TYPE_PEHSTR_EXT,0a 00 0a 00 0a 00 00 01 00 "
		
	strings :
		$a_01_0 = {07 08 06 08 18 5a 18 6f 30 00 00 0a 1f 10 28 b0 00 00 0a 9c 08 17 58 0c 08 20 00 58 00 00 fe 04 2d de } //01 00 
		$a_01_1 = {2f 00 61 00 70 00 70 00 2e 00 78 00 61 00 6d 00 6c } //01 00 
		$a_01_2 = {59 00 75 00 41 00 6f 00 20 00 32 00 30 00 31 00 32 } //01 00 
