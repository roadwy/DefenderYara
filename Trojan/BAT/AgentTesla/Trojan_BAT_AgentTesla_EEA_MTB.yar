...
rule Trojan_BAT_AgentTesla_EEA_MTB{
	...
	strings :
		$a_01_0 = {24 35 38 38 43 46 38 42 31 2d 36 31 35 37 2d 34 43 43 45 2d 39 42 32 36 2d 45 42 34 31 31 38 35 39 31 38 45 32 } //01 00  $588CF8B1-6157-4CCE-9B26-EB41185918E2
		...
		$a_01_5 = {00 49 6e 76 6f 6b 65 00 } //01 00  䤀癮歯e
