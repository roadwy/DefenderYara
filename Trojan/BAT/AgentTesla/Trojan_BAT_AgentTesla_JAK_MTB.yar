...
rule Trojan_BAT_AgentTesla_JAK_MTB{
	...
	strings :
		$a_02_0 = {20 00 10 00 00 8d ?? ?? ?? 01 0b 73 ?? ?? ?? 0a 0c [0-02] 06 07 16 20 00 10 00 00 6f ?? ?? ?? 0a 0d 09 16 fe 02 13 04 11 04 2c 0c 00 08 07 16 09 6f ?? ?? ?? 0a [0-03] 09 16 fe 02 13 05 11 05 2d d0 08 6f } //10
...
rule Trojan_BAT_AgentTesla_JAK_MTB_2{
	...
	strings :
		$a_02_0 = {08 11 04 02 28 ?? ?? ?? ?? 13 05 11 05 16 16 16 16 28 ?? ?? ?? 0a 28 ?? ?? ?? 0a 13 06 11 06 2c 33 00 06 06 6f ?? ?? ?? 0a 19 8d ?? ?? ?? ?? 25 16 12 05 28 } //1
		$a_02_1 = {0a 0c 06 16 73 ?? ?? ?? 0a 0d 00 08 8d ?? ?? ?? 01 13 04 09 11 04 16 08 6f ?? ?? ?? 0a 26 11 04 13 05 de 16 } //1
		$a_02_2 = {09 11 05 02 11 05 91 08 61 06 11 04 91 61 d2 9c 11 04 03 6f ?? ?? ?? 0a 17 59 fe 01 16 fe 01 13 06 11 06 2c 0a } //1
