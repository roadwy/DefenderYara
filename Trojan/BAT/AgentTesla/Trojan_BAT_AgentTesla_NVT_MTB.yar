...
rule Trojan_BAT_AgentTesla_NVT_MTB{
	...
	strings :
		$a_01_0 = {24 64 31 33 33 36 38 30 35 2d 36 30 33 61 2d 34 34 38 63 2d 61 35 32 31 2d 38 66 34 63 34 39 31 61 62 34 34 39 } //01 00  $d1336805-603a-448c-a521-8f4c491ab449
