...
rule Trojan_BAT_AgentTesla_CO_MTB{
	...
	strings :
		...
		$a_81_1 = {55 47 78 31 5a 32 6c 75 4c 6b 78 68 64 57 35 6a 61 41 3d 3d } //01 00 
		$a_81_2 = {54 57 46 70 62 67 3d 3d } //01 00 
		$a_81_3 = {53 79 73 74 65 6d 2e 54 65 78 74 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_BAT_AgentTesla_CO_MTB_2{
	...
	strings :
		...
		$a_81_1 = {47 65 74 46 69 6c 65 4e 61 6d 65 42 79 55 52 4c } //01 00 
		...
		$a_81_9 = {69 6d 69 6d 69 6d 69 6d 69 6d } //01 00 
		$a_81_10 = {00 78 78 78 78 78 78 78 78 78 78 78 78 78 78 78 78 78 78 00 } //00 00 
	condition:
		any of ($a_*)
