...
rule Trojan_BAT_AgentTesla_EKC_MTB{
	...
	strings :
		$a_03_0 = {07 16 fe 01 0c 08 2c 0c 06 07 b4 6f 90 01 03 0a 00 00 2b 18 00 06 07 18 32 07 20 ff 00 00 00 2b 03 03 07 d8 b4 6f 90 01 03 0a 00 00 07 17 d6 0b 00 07 1f 10 fe 04 0d 09 90 00 } //1
