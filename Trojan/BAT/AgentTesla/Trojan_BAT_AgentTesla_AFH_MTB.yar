...
rule Trojan_BAT_AgentTesla_AFH_MTB{
	...
	strings :
		$a_03_0 = {09 11 04 9a 13 05 11 05 28 90 01 03 0a 23 00 00 00 00 00 80 73 40 59 28 90 01 03 0a b7 90 00 } //10
		$a_03_1 = {11 04 08 9a 13 07 11 07 28 90 01 03 0a 23 00 00 00 00 00 80 73 40 59 28 90 01 03 0a b7 90 00 } //10
