...
rule Trojan_BAT_AgentTesla_NGQ_MTB{
	...
	strings :
		...
		$a_81_2 = {43 30 41 55 77 42 73 41 47 55 41 5a 51 42 77 41 43 41 41 4c 51 42 7a 41 43 41 41 4d 51 41 31 41 41 3d 3d } //01 00 
		$a_81_3 = {2d 65 6e 63 20 55 77 42 30 41 47 45 41 63 67 42 30 41 } //01 00 
		$a_81_4 = {70 6f 77 65 72 73 68 65 6c 6c } //01 00 
		$a_01_5 = {47 7a 69 70 53 74 72 65 61 6d } //00 00 
	condition:
		any of ($a_*)
