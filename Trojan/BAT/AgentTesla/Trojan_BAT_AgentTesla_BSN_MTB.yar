...
rule Trojan_BAT_AgentTesla_BSN_MTB{
	meta:
		description = "Trojan:BAT/AgentTesla.BSN!MTB,SIGNATURE_TYPE_PEHSTR_EXT,12 00 12 00 09 00 00 0a 00 "
		
	strings :
		$a_81_0 = {35 62 32 34 62 39 62 38 2d 62 37 36 36 2d 34 61 31 61 2d 62 30 39 39 2d 32 35 39 30 66 38 65 64 36 31 30 38 } //01 00  5b24b9b8-b766-4a1a-b099-2590f8ed6108
