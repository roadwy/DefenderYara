...
rule Trojan_BAT_AgentTesla_BNP_MTB{
	...
	strings :
		$a_02_0 = {02 09 18 28 90 01 03 06 1f 10 28 90 01 03 06 84 28 90 01 03 06 28 90 01 03 06 26 90 00 } //1
		$a_02_1 = {09 02 8e 69 18 da 17 d6 17 da 17 d6 8d 90 01 03 01 28 90 01 03 06 74 90 01 03 1b 0a 90 00 } //1
