...
rule Trojan_BAT_AgentTesla_AGS_MTB{
	...
	strings :
		$a_81_0 = {43 6f 75 72 73 65 77 6f 72 6b 2e 41 62 6f 75 74 5f 50 72 6f 67 72 61 6d 2e 72 65 73 6f 75 72 63 65 73 } //01 00  Coursework.About_Program.resources
		$a_81_1 = {43 6f 75 72 73 65 77 6f 72 6b 2e 66 72 6d 47 69 72 69 73 2e 72 65 73 6f 75 72 63 65 73 } //01 00  Coursework.frmGiris.resources
		...
		$a_81_5 = {47 65 74 41 73 73 65 6d 62 6c 69 65 73 } //01 00  GetAssemblies
