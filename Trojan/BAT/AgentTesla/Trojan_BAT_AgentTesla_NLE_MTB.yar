...
rule Trojan_BAT_AgentTesla_NLE_MTB{
	meta:
		description = "Trojan:BAT/AgentTesla.NLE!MTB,SIGNATURE_TYPE_PEHSTR_EXT,08 00 08 00 08 00 00 01 00 "
		
	strings :
		$a_01_0 = {50 6c 61 79 6c 69 73 74 50 61 6e 64 61 2e 50 72 6f 70 65 72 74 69 65 73 2e 52 65 73 6f 75 72 63 65 73 2e 72 65 73 6f 75 72 63 65 73 } //01 00  PlaylistPanda.Properties.Resources.resources
		$a_01_1 = {24 63 32 63 64 30 30 66 38 2d 30 38 37 64 2d 34 64 39 35 2d 61 63 62 32 2d 38 31 31 61 32 37 39 38 39 61 31 35 } //01 00  $c2cd00f8-087d-4d95-acb2-811a27989a15
