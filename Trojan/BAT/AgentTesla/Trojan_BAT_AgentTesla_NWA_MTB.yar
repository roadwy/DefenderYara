...
rule Trojan_BAT_AgentTesla_NWA_MTB{
	meta:
		description = "Trojan:BAT/AgentTesla.NWA!MTB,SIGNATURE_TYPE_PEHSTR_EXT,05 00 05 00 05 00 00 01 00 "
		
	strings :
		$a_01_0 = {24 66 33 34 36 65 35 35 66 2d 34 36 64 33 2d 34 33 61 38 2d 39 31 65 39 2d 35 30 66 38 37 65 30 63 64 35 63 62 } //01 00  $f346e55f-46d3-43a8-91e9-50f87e0cd5cb
