...
rule Trojan_BAT_AgentTesla_CB_MTB{
	...
	strings :
		$a_02_0 = {0a 00 07 28 90 01 04 03 6f 90 01 04 6f 90 01 04 13 06 08 11 06 6f 90 01 04 00 08 18 6f 90 01 04 00 08 6f 90 01 04 13 05 02 28 90 01 04 13 04 28 90 01 04 11 05 11 04 16 11 04 8e b7 6f 90 01 04 6f 90 01 04 0a 06 0d de 13 de 10 90 00 } //12
	condition:
		((#a_02_0  & 1)*12) >=12
...
rule Trojan_BAT_AgentTesla_CB_MTB_2{
	...
	strings :
		$a_03_0 = {72 01 00 00 70 d0 90 01 03 02 28 90 01 03 0a 6f 90 01 03 0a 73 1c 00 00 90 00 } //5
