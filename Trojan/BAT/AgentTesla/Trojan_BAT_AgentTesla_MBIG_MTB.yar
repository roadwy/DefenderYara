...
rule Trojan_BAT_AgentTesla_MBIG_MTB{
	...
	strings :
		$a_03_0 = {0a 06 07 6f 90 01 01 00 00 0a 17 73 7a 00 00 0a 0c 08 02 16 02 8e 69 6f cc 00 00 0a 08 6f 90 01 01 00 00 0a 06 28 90 01 01 00 00 06 0d 09 2a 90 00 } //1
