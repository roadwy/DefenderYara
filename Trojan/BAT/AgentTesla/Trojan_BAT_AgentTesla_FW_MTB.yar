...
rule Trojan_BAT_AgentTesla_FW_MTB{
	...
	strings :
		$a_03_0 = {43 6f 6e 73 6f 6c 65 41 70 70 90 02 0f 2e 67 2e 72 65 73 6f 75 72 63 65 73 90 00 } //20
		$a_03_1 = {74 61 72 20 90 02 0f 2e 67 2e 72 65 73 6f 75 72 63 65 73 90 00 } //20
		$a_03_2 = {50 61 79 6d 65 6e 74 90 02 0f 2e 67 2e 72 65 73 6f 75 72 63 65 73 90 00 } //20
		$a_03_3 = {52 65 71 75 69 72 65 6d 65 6e 74 90 02 0f 2e 67 2e 72 65 73 6f 75 72 63 65 73 90 00 } //20
