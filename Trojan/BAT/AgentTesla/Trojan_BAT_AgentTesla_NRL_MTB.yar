...
rule Trojan_BAT_AgentTesla_NRL_MTB{
	...
	strings :
		$a_03_0 = {07 11 07 11 09 6f 90 01 03 0a 13 0a 11 0a 16 16 16 16 28 90 01 03 0a 28 90 01 03 0a 13 0b 11 0b 2c 2c 00 08 12 0a 28 90 01 03 0a 6f 90 01 03 0a 00 08 12 0a 28 90 01 03 0a 6f 90 01 03 0a 00 08 12 0a 28 90 01 03 0a 6f 90 01 03 0a 00 00 00 11 09 90 00 } //1
