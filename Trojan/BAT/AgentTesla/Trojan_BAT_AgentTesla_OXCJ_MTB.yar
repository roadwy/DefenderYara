...
rule Trojan_BAT_AgentTesla_OXCJ_MTB{
	...
	strings :
		$a_02_0 = {04 14 0d de 4c 08 28 90 01 04 0b de 0a 08 2c 06 08 6f 90 01 04 dc 03 06 28 90 01 04 13 04 11 04 2c 17 18 2c 12 11 04 28 90 01 04 13 05 07 11 05 28 90 01 04 0d de 15 de 0c 11 04 2c 07 11 04 6f 90 01 04 dc 07 28 90 01 04 2a 90 00 } //10
