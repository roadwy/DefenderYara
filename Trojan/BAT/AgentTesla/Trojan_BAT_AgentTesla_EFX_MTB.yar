...
rule Trojan_BAT_AgentTesla_EFX_MTB{
	...
	strings :
		...
		$a_01_1 = {53 00 79 00 73 00 74 00 65 00 6d 00 2e 00 } //01 00 
		$a_01_2 = {47 00 65 00 74 00 4d 00 65 00 74 00 68 00 6f 00 64 00 73 00 } //01 00 
		$a_01_3 = {47 00 65 00 74 00 54 00 79 00 70 00 65 00 73 00 } //00 00 
	condition:
		any of ($a_*)
