...
rule Trojan_BAT_AgentTesla_AMCB_MTB{
	...
	strings :
		$a_03_0 = {0a 72 01 00 00 70 6f 90 01 01 00 00 0a 6f 90 01 01 00 00 0a 06 28 90 01 01 00 00 0a 72 01 00 00 70 6f 90 01 01 00 00 0a 6f 90 01 01 00 00 0a 06 6f 90 01 01 00 00 0a 02 16 02 8e 69 6f 90 01 01 00 00 0a 0b de 0a 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
