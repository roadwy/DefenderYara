...
rule Trojan_BAT_AgentTesla_SF_MTB_2{
	...
	strings :
		$a_02_0 = {11 04 18 6f 90 01 03 0a 90 01 05 28 90 01 03 0a 04 07 6f 90 01 03 0a 90 01 05 6a 61 b7 28 90 01 03 0a 28 90 01 03 0a 13 05 08 11 05 6f 90 01 03 0a 26 07 04 90 01 05 17 da 33 90 00 } //10
