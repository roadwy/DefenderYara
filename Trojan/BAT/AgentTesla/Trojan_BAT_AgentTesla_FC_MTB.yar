...
rule Trojan_BAT_AgentTesla_FC_MTB{
	...
	strings :
		$a_03_0 = {03 03 50 02 04 28 90 01 03 06 04 28 10 00 00 0a 17 15 16 28 11 00 00 0a 90 00 } //1
		$a_01_1 = {51 00 de 08 26 00 05 17 52 00 de 00 2a } //1
		...
		$a_81_6 = {47 65 74 54 79 } //1 GetTy
		$a_81_7 = {45 6e 74 72 79 50 } //1 EntryP
	condition:
...
rule Trojan_BAT_AgentTesla_FC_MTB_2{
	meta:
		description = "Trojan:BAT/AgentTesla.FC!MTB,SIGNATURE_TYPE_PEHSTR_EXT,17 00 17 00 0d 00 00 "
		
	strings :
		$a_81_0 = {24 66 38 37 38 37 62 61 31 2d 63 30 35 30 2d 34 62 34 37 2d 61 64 65 30 2d 33 34 39 62 39 34 31 31 37 63 64 64 } //20 $f8787ba1-c050-4b47-ade0-349b94117cdd
		$a_81_1 = {24 66 31 63 62 36 36 34 61 2d 61 64 37 31 2d 34 62 31 35 2d 61 64 63 33 2d 30 64 30 66 66 34 32 30 66 38 34 30 } //20 $f1cb664a-ad71-4b15-adc3-0d0ff420f840
		$a_81_2 = {24 39 61 64 38 39 61 66 39 2d 39 66 35 39 2d 34 39 30 32 2d 38 62 65 31 2d 30 61 36 32 61 66 30 62 62 37 33 35 } //20 $9ad89af9-9f59-4902-8be1-0a62af0bb735
		$a_81_3 = {24 34 38 36 34 38 61 65 37 2d 38 39 32 33 2d 34 31 35 38 2d 61 62 34 34 2d 38 30 66 33 30 34 31 62 30 33 37 32 } //20 $48648ae7-8923-4158-ab44-80f3041b0372
