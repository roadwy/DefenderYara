...
rule Trojan_BAT_AgentTesla_ABVV_MTB{
	...
	strings :
		...
		$a_01_1 = {4b 00 6f 00 6e 00 61 00 53 00 57 00 44 00 43 00 61 00 72 00 6d 00 } //01 00  KonaSWDCarm
		$a_01_2 = {44 00 65 00 6c 00 65 00 74 00 65 00 4d 00 43 00 } //00 00  DeleteMC
	condition:
		any of ($a_*)
