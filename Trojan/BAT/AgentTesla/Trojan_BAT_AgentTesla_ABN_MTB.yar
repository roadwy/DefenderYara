...
rule Trojan_BAT_AgentTesla_ABN_MTB_2{
	meta:
		description = "Trojan:BAT/AgentTesla.ABN!MTB,SIGNATURE_TYPE_PEHSTR_EXT,0a 00 0a 00 06 00 00 05 00 "
		
	strings :
		$a_03_0 = {0a 06 1f 10 8d 90 01 03 01 6f 90 01 03 0a 06 06 6f 90 01 03 0a 06 6f 90 01 03 0a 6f 90 01 03 0a 0b 02 28 90 01 03 06 73 90 01 03 0a 0c 90 0a 3c 00 06 72 01 90 01 02 70 28 05 90 01 02 06 6f 05 90 00 } //01 00 
		$a_01_1 = {44 6f 77 6e 6c 6f 61 64 44 61 74 61 } //01 00  DownloadData
		$a_01_2 = {55 70 6c 6f 61 64 44 61 74 61 } //01 00  UploadData
