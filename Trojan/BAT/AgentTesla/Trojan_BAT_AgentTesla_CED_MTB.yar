...
rule Trojan_BAT_AgentTesla_CED_MTB{
	...
	strings :
		$a_03_0 = {20 df 8e fb 0e 0b 07 20 e7 8e fb 0e fe 01 0c 08 2c 09 20 1f 8f fb 0e 0b 00 2b 34 07 20 f1 8e fb 0e fe 01 0d 09 2c 09 20 18 8f fb 0e 0b 00 2b 1f 00 20 07 8f fb 0e 0b 17 13 04 02 28 90 01 03 2b 16 02 6f 90 01 03 0a 28 90 01 03 0a 0a 2b 00 06 2a 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_BAT_AgentTesla_CED_MTB_2{
	...
	strings :
		$a_02_0 = {0b 07 16 73 90 01 03 0a 0c 20 00 00 10 00 8d 90 01 03 01 0d 38 90 01 04 06 09 16 11 04 6f 90 01 03 0a 08 09 16 09 8e 69 6f 90 01 03 0a 25 13 04 16 3d 90 01 04 06 6f 90 00 } //1
...
rule Trojan_BAT_AgentTesla_CED_MTB_3{
	...
	strings :
		$a_02_0 = {43 00 6c 00 61 00 73 00 73 00 4c 00 69 00 62 00 72 00 61 00 72 00 79 00 90 02 25 44 00 61 00 74 00 61 00 90 00 } //1
		$a_02_1 = {43 6c 61 73 73 4c 69 62 72 61 72 79 90 02 25 44 61 74 61 90 00 } //1
