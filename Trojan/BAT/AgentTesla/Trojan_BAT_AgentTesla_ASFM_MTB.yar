...
rule Trojan_BAT_AgentTesla_ASFM_MTB{
	...
	strings :
		$a_03_0 = {07 8e 69 6a 5d d4 91 08 11 90 01 01 08 8e 69 6a 5d d4 91 61 07 11 90 01 01 17 6a 58 07 8e 69 6a 5d d4 91 59 20 00 01 00 00 58 13 90 02 04 07 8e 69 6a 5d d4 11 90 01 01 20 00 01 00 00 5d d2 9c 90 00 } //1
