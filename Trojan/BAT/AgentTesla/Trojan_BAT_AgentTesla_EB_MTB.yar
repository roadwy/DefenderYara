...
rule Trojan_BAT_AgentTesla_EB_MTB{
	...
	strings :
		$a_03_0 = {20 d1 c4 d1 c2 20 04 00 00 00 63 20 04 00 00 00 62 20 f6 55 15 f3 61 7d 90 01 04 38 38 02 00 00 7e 90 01 04 20 3a c0 42 be 20 98 89 53 36 58 20 49 5c a0 21 59 20 89 ed f5 d2 61 90 00 } //7
	condition:
		((#a_03_0  & 1)*7) >=7
...
rule Trojan_BAT_AgentTesla_EB_MTB_3{
	...
	strings :
		$a_03_0 = {03 04 03 8e 69 5d 91 11 01 04 05 5d 91 61 7e 1a 01 00 04 28 90 01 04 03 04 17 58 03 8e 69 5d 91 7e 1b 01 00 04 28 90 01 04 59 11 00 90 00 } //5
