...
rule Trojan_BAT_AgentTesla_NU_MTB{
	...
	strings :
		...
		$a_01_1 = {35 00 50 00 48 00 34 00 37 00 35 00 4e 00 47 00 42 00 38 00 59 00 45 00 46 00 39 00 34 00 34 00 5a 00 46 00 43 00 49 00 35 00 41 00 } //00 00  5PH475NGB8YEF944ZFCI5A
	condition:
		any of ($a_*)
...
rule Trojan_BAT_AgentTesla_NU_MTB_3{
	...
	strings :
		...
		$a_01_1 = {53 70 66 53 65 74 4b 65 79 } //01 00  SpfSetKey
		$a_01_2 = {53 00 70 00 6f 00 6f 00 66 00 65 00 72 00 2e 00 50 00 72 00 6f 00 70 00 65 00 72 00 74 00 69 00 65 00 73 00 2e 00 52 00 65 00 73 00 6f 00 75 00 72 00 63 00 65 00 73 00 } //01 00  Spoofer.Properties.Resources
		$a_01_3 = {48 77 69 64 45 64 69 74 49 74 65 6d } //00 00  HwidEditItem
	condition:
		any of ($a_*)
