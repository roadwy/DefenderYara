...
rule Trojan_BAT_AgentTesla_ABNE_MTB{
	...
	strings :
		...
		$a_01_1 = {42 00 6c 00 61 00 63 00 6b 00 6a 00 61 00 63 00 6b 00 5f 00 74 00 68 00 72 00 65 00 61 00 64 00 69 00 6e 00 67 00 2e 00 52 00 65 00 73 00 6f 00 75 00 72 00 63 00 65 00 43 00 53 00 } //00 00  Blackjack_threading.ResourceCS
	condition:
		any of ($a_*)
