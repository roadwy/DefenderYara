...
rule Trojan_BAT_AgentTesla_GEA_MTB{
	...
	strings :
		$a_01_0 = {61 73 70 77 65 72 59 65 76 65 6e 74 73 } //01 00 
		$a_01_1 = {72 63 69 6d 6c 6d 5a 72 75 6b 67 4d 67 72 } //01 00 
		$a_01_2 = {73 66 6d 73 79 73 74 65 6d 59 53 67 34 30 30 } //01 00 
