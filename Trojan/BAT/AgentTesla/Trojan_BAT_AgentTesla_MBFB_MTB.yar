...
rule Trojan_BAT_AgentTesla_MBFB_MTB{
	...
	strings :
		$a_03_0 = {5d 91 61 07 11 90 01 01 91 59 20 00 01 00 00 58 20 00 01 00 00 5d 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_BAT_AgentTesla_MBFB_MTB_2{
	...
	strings :
		$a_03_0 = {04 03 18 6f 90 01 01 00 00 0a 1f 10 28 90 01 01 00 00 0a d2 2a 90 00 } //1
...
rule Trojan_BAT_AgentTesla_MBFB_MTB_3{
	...
	strings :
		$a_03_0 = {5d 91 61 11 90 02 07 91 59 20 00 01 00 00 58 20 00 01 00 00 5d 90 00 } //10
