...
rule Trojan_BAT_AgentTesla_NDD_MTB{
	...
	strings :
		$a_03_0 = {16 13 05 2b 2a 00 09 11 04 11 05 6f 90 01 03 0a 13 07 11 07 28 90 01 03 0a 13 08 17 13 09 08 11 08 d2 6f 90 01 03 0a 00 00 11 05 17 58 13 05 11 05 17 fe 04 13 0a 11 0a 2d cb 07 17 58 0b 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_BAT_AgentTesla_NDD_MTB_2{
	...
	strings :
		$a_03_0 = {7e 01 00 00 04 6f 90 01 03 0a 17 33 2f 7e 90 01 03 04 7e 90 01 03 04 16 6f 90 01 03 0a 74 90 01 03 01 72 90 01 03 70 6f 90 01 03 0a 6f 90 01 03 0a 7e 90 01 03 04 16 6f 90 01 03 0a 28 90 01 03 06 90 00 } //5
		$a_03_1 = {06 03 07 18 6f 90 01 03 0a 1f 10 28 90 01 03 0a 6f 90 01 03 0a 07 18 58 0b 07 03 6f 90 01 03 0a 32 de 90 00 } //5
