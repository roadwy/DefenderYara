...
rule Trojan_BAT_AgentTesla_NDD_MTB_2{
	...
	strings :
		...
		$a_01_2 = {53 74 61 67 65 49 6e 73 74 72 75 63 74 69 6f 6e 5f 73 } //01 00  StageInstruction_s
		$a_01_3 = {51 00 72 00 6b 00 79 00 63 00 74 00 61 00 63 00 71 00 71 00 6f 00 66 00 6e 00 69 00 6f 00 6d 00 72 00 75 00 6b 00 72 00 6b 00 70 00 78 00 } //00 00  Qrkyctacqqofniomrukrkpx
	condition:
		any of ($a_*)
