...
rule Trojan_BAT_AgentTesla_NMR_MTB{
	...
	strings :
		...
		$a_01_10 = {4d 65 6d 6f 72 79 53 74 72 65 61 6d } //01 00 
		$a_01_11 = {44 65 71 75 65 75 65 } //01 00 
		$a_01_12 = {45 6e 71 75 65 75 65 } //01 00 
		$a_01_13 = {46 72 6f 6d 42 61 73 65 36 34 53 74 72 69 6e 67 } //00 00 
	condition:
		any of ($a_*)
