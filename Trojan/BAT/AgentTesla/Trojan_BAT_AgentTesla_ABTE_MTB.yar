...
rule Trojan_BAT_AgentTesla_ABTE_MTB{
	...
	strings :
		$a_03_0 = {11 08 11 01 11 07 18 6f 90 01 02 00 0a 1f 10 28 90 01 03 0a b4 6f 90 01 02 00 0a 38 90 01 02 00 00 28 90 01 03 0a 11 08 28 90 01 03 06 6f 90 01 02 00 0a 13 03 90 00 } //4
