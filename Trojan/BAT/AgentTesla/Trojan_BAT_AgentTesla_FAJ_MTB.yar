...
rule Trojan_BAT_AgentTesla_FAJ_MTB{
	...
	strings :
		$a_03_0 = {13 04 11 04 28 ?? 00 00 0a 25 11 04 6f ?? 00 00 0a 25 09 72 ?? 01 00 70 6f ?? 00 00 0a 74 0d 00 00 1b 6f ?? 00 00 0a 25 09 72 ?? 01 00 70 6f ?? 00 00 0a 74 0d 00 00 1b 6f } //3
