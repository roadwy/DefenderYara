...
rule Trojan_BAT_AgentTesla_RD_MTB_2{
	...
	strings :
		...
		$a_01_1 = {54 00 79 00 78 00 69 00 66 00 2e 00 65 00 78 00 65 00 } //01 00  Tyxif.exe
		$a_01_2 = {53 68 61 72 70 44 65 76 65 6c 6f 70 20 50 72 6f 6a 65 63 74 73 5c 54 79 78 69 66 5c 54 79 78 69 66 5c 6f 62 6a 5c 44 65 62 75 67 5c 54 79 78 69 66 2e 70 64 62 } //00 00  SharpDevelop Projects\Tyxif\Tyxif\obj\Debug\Tyxif.pdb
	condition:
		any of ($a_*)
