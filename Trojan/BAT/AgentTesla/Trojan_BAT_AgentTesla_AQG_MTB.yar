...
rule Trojan_BAT_AgentTesla_AQG_MTB{
	...
	strings :
		$a_03_0 = {0a 17 2d 03 26 2b 03 0c 2b 00 73 90 01 03 0a 0d 08 09 28 90 01 03 06 09 16 6a 6f 90 01 03 0a 09 13 04 de 19 08 6f 90 01 03 0a dc 90 00 } //10
	condition:
		((#a_03_0  & 1)*10) >=10
...
rule Trojan_BAT_AgentTesla_AQG_MTB_2{
	...
	strings :
		$a_02_0 = {25 16 09 a2 25 17 90 01 05 a2 25 13 04 14 14 18 90 01 05 25 16 17 9c 25 13 05 17 90 01 05 26 90 00 } //10
