...
rule Trojan_BAT_AgentTesla_HZ_MTB{
	meta:
		description = "Trojan:BAT/AgentTesla.HZ!MTB,SIGNATURE_TYPE_PEHSTR_EXT,18 00 18 00 0d 00 00 "
		
	strings :
		$a_00_0 = {24 31 39 39 37 63 30 33 66 2d 61 65 66 61 2d 34 65 33 31 2d 39 38 39 31 2d 38 63 34 34 30 36 36 31 66 31 36 38 } //20 $1997c03f-aefa-4e31-9891-8c440661f168
		$a_00_1 = {24 30 62 66 39 32 65 31 66 2d 66 64 61 61 2d 34 33 39 61 2d 38 34 35 35 2d 64 61 35 39 63 61 37 61 33 33 33 62 } //20 $0bf92e1f-fdaa-439a-8455-da59ca7a333b
		$a_00_2 = {24 62 31 31 38 38 30 38 63 2d 63 65 39 64 2d 34 62 31 37 2d 62 32 38 66 2d 64 63 36 38 61 36 39 61 61 36 37 31 } //20 $b118808c-ce9d-4b17-b28f-dc68a69aa671
