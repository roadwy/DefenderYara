...
rule Trojan_BAT_AgentTesla_JAI_MTB{
	...
	strings :
		...
		$a_81_1 = {00 73 74 72 69 6e 67 4b 65 79 00 47 65 74 45 78 65 63 75 74 69 6e 67 41 73 73 65 6d 62 6c 79 00 } //01 00  猀牴湩䭧祥䜀瑥硅捥瑵湩䅧獳浥汢y
		$a_81_2 = {4c 6f 61 64 4c 69 62 72 61 72 79 } //01 00  LoadLibrary
		$a_81_3 = {53 79 73 74 65 6d 53 65 72 76 69 63 65 4d 6f 64 65 6c 43 68 61 6e 6e 65 6c 73 } //01 00  SystemServiceModelChannels
