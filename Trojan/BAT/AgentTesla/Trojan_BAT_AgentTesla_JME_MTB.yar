...
rule Trojan_BAT_AgentTesla_JME_MTB{
	...
	strings :
		$a_81_0 = {31 62 37 35 61 65 32 36 2d 63 64 63 65 2d 34 34 30 34 2d 39 39 33 33 2d 36 64 31 62 61 38 37 32 31 34 39 63 } //01 00  1b75ae26-cdce-4404-9933-6d1ba872149c
		$a_81_1 = {54 6f 42 79 74 65 } //01 00  ToByte
		...
		$a_81_9 = {50 61 72 61 6d 58 41 72 72 61 79 } //01 00  ParamXArray
		$a_81_10 = {52 65 76 65 72 73 65 } //00 00  Reverse
	condition:
		any of ($a_*)
