...
rule Trojan_BAT_AgentTesla_ASBO_MTB{
	...
	strings :
		$a_03_0 = {13 04 09 8e 69 17 da 13 1d 16 13 1e 2b 1a 11 04 09 11 1e 9a 1f 10 28 90 01 01 01 00 0a b4 6f 90 01 01 01 00 0a 00 11 1e 17 d6 13 1e 11 1e 11 1d 31 e0 90 00 } //4
