...
rule Trojan_BAT_AgentTesla_EK_MTB{
	...
	strings :
		$a_03_0 = {13 07 11 05 11 07 1b 8d 01 00 00 01 13 0a 11 0a 16 72 90 01 03 70 28 07 00 00 06 a2 11 0a 17 1f 40 8c 07 00 00 01 a2 11 0a 18 11 07 17 90 00 } //1
		$a_03_1 = {11 07 6f 1c 00 00 0a 18 59 6f 1b 00 00 0a 28 06 00 00 06 a2 11 0a 19 1f 40 8c 07 00 00 01 a2 11 0a 1a 72 90 01 03 70 28 07 00 00 06 a2 11 0a 28 1d 00 00 0a 6f 1e 00 00 0a 13 05 11 05 1f 22 28 01 00 00 2b 3a 64 ff ff ff 90 00 } //1
	condition:
...
rule Trojan_BAT_AgentTesla_EK_MTB_2{
	...
	strings :
		...
		$a_03_1 = {70 03 11 04 18 6f 90 01 03 0a 28 90 01 03 0a 28 90 01 03 0a 04 07 6f 90 01 03 0a 28 90 01 03 0a 6a 61 b7 28 90 01 03 0a 28 90 01 03 0a 13 05 08 11 05 6f 90 01 03 0a 26 07 04 6f 90 01 03 0a 17 da 33 03 90 00 } //10
