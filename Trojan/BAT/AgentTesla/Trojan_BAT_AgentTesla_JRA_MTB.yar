...
rule Trojan_BAT_AgentTesla_JRA_MTB{
	...
	strings :
		$a_81_0 = {36 34 42 31 36 36 45 45 2d 44 37 32 31 2d 34 41 32 46 2d 39 43 37 31 2d 35 31 43 34 39 35 44 33 31 45 43 42 } //1 64B166EE-D721-4A2F-9C71-51C495D31ECB
		$a_81_1 = {43 68 65 63 6b 52 65 6d 6f 74 65 44 65 62 75 67 67 65 72 50 72 65 73 65 6e 74 } //1 CheckRemoteDebuggerPresent
		$a_81_2 = {46 61 63 74 6f 72 79 20 52 65 73 65 74 } //1 Factory Reset
