...
rule Trojan_BAT_AgentTesla_NRP_MTB{
	...
	strings :
		...
		$a_01_4 = {63 62 52 65 73 65 72 76 65 64 32 } //01 00 
		$a_01_5 = {53 79 73 74 65 6d 2e 54 65 78 74 } //01 00 
		$a_01_6 = {6c 70 44 65 73 6b 74 6f 70 } //01 00 
		$a_01_7 = {43 72 65 61 74 65 44 65 63 72 79 70 74 6f 72 } //01 00 
		$a_01_8 = {62 61 73 65 36 34 45 6e 63 6f 64 65 64 44 61 74 61 } //00 00 
	condition:
		any of ($a_*)
