...
rule Trojan_BAT_AgentTesla_NRI_MTB{
	...
	strings :
		$a_01_0 = {24 37 31 64 32 64 35 38 38 2d 30 61 35 34 2d 34 30 33 65 2d 62 65 32 35 2d 38 31 34 62 38 34 63 63 65 62 32 32 } //01 00 
		$a_01_1 = {4c 49 4c 49 54 48 41 47 55 45 53 54 48 4f 55 53 45 2e 52 65 73 6f 75 72 63 65 73 2e 72 65 73 6f 75 72 63 65 73 } //01 00 
