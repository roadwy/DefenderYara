...
rule Trojan_BAT_AgentTesla_EGX_MTB{
	meta:
		description = "Trojan:BAT/AgentTesla.EGX!MTB,SIGNATURE_TYPE_PEHSTR_EXT,02 00 02 00 02 00 00 01 00 "
	...
	strings :
		...
		$a_01_1 = {67 00 6e 00 69 00 72 00 74 00 53 00 34 00 36 00 65 00 73 00 61 00 42 00 6d 00 6f 00 72 00 46 00 } //00 00 
	condition:
		any of ($a_*)
