...
rule Trojan_BAT_AgentTesla_ERF_MTB{
	...
	strings :
		...
		$a_01_1 = {41 63 63 6f 75 6e 74 44 6f 6d 61 69 6e 53 69 64 } //01 00  AccountDomainSid
		$a_01_2 = {46 72 6f 6d 42 61 73 65 36 34 } //01 00  FromBase64
		$a_01_3 = {59 41 53 55 53 55 41 48 42 4e 5f 39 32 35 } //01 00  YASUSUAHBN_925
		$a_01_4 = {59 41 53 55 53 55 41 48 42 4e 5f 39 32 37 } //00 00  YASUSUAHBN_927
	condition:
		any of ($a_*)
