...
rule Trojan_BAT_AgentTesla_NCA_MTB{
	...
	strings :
		$a_03_0 = {06 02 07 94 d1 0c 12 02 28 90 01 03 0a 28 90 01 03 0a 0a 07 17 58 0b 07 02 8e 69 32 90 00 } //1
		$a_03_1 = {06 07 02 07 28 90 01 03 06 07 20 90 01 03 00 5d d1 61 d1 9d 07 17 58 0b 07 02 6f 90 01 03 0a 32 90 00 } //1
