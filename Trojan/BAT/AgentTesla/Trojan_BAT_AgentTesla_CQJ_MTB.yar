...
rule Trojan_BAT_AgentTesla_CQJ_MTB{
	...
	strings :
		$a_01_0 = {39 66 62 38 32 30 36 65 2d 34 30 30 66 2d 34 33 36 30 2d 39 35 37 39 2d 30 39 36 31 31 61 37 62 66 61 36 35 } //01 00  9fb8206e-400f-4360-9579-09611a7bfa65
		$a_01_1 = {47 5a 69 70 53 74 72 65 61 6d } //01 00  GZipStream
		$a_01_2 = {42 69 74 6d 61 70 } //01 00  Bitmap
