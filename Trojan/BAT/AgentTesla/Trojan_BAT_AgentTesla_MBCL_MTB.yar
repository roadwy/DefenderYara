...
rule Trojan_BAT_AgentTesla_MBCL_MTB_2{
	...
	strings :
		...
		$a_01_1 = {33 2d 35 35 64 64 34 62 62 63 64 32 36 39 } //01 00  3-55dd4bbcd269
		$a_01_2 = {45 00 67 00 2e 00 43 00 70 00 } //01 00  Eg.Cp
		$a_01_3 = {4d 30 4d 30 4d 30 4d 30 4d 30 4d 30 4d 30 4d 30 4d 30 4d 30 4d 30 4d 30 4d 30 4d 30 4d } //01 00  M0M0M0M0M0M0M0M0M0M0M0M0M0M0M
		$a_01_4 = {55 6d 64 50 61 72 73 65 72 2e 50 72 6f } //00 00  UmdParser.Pro
	condition:
		any of ($a_*)
