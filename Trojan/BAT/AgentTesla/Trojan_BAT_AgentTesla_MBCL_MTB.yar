...
rule Trojan_BAT_AgentTesla_MBCL_MTB{
	...
	strings :
		$a_03_0 = {a2 11 09 17 7e 90 01 01 00 00 0a a2 11 09 18 11 06 72 de 07 00 70 6f 90 01 01 00 00 0a a2 11 09 13 0a 11 0a 13 0b 1f 1a 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_BAT_AgentTesla_MBCL_MTB_2{
	...
	strings :
		$a_03_0 = {02 06 72 0f 01 00 70 6f 90 01 01 00 00 0a 74 90 01 01 00 00 01 28 90 01 01 00 00 06 28 90 01 01 00 00 06 17 8d 90 01 01 00 00 01 25 16 1f 3d 9d 6f 90 01 01 00 00 0a 0b 20 00 2c 01 00 8d 90 01 01 00 00 01 0c 16 13 04 2b 17 00 08 11 04 07 11 04 9a 90 00 } //1
