...
rule Trojan_BAT_AgentTesla_AB_MTB_2{
	...
	strings :
		...
		$a_81_3 = {57 65 62 52 65 71 75 65 73 74 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_BAT_AgentTesla_AB_MTB_3{
	...
	strings :
		$a_01_0 = {41 70 70 65 6e 64 41 6c 6c 54 65 78 74 } //01 00 
		$a_01_1 = {57 72 69 74 65 41 6c 6c 54 65 78 74 } //01 00 
		$a_01_2 = {54 72 69 6d 45 6e 64 } //01 00 
		$a_01_3 = {54 72 61 6e 73 61 63 74 69 6f 6e } //01 00 
		$a_01_4 = {67 65 74 5f 43 75 72 72 65 6e 74 } //01 00 
		$a_01_5 = {67 65 74 5f 54 72 61 6e 73 61 63 74 69 6f 6e 49 6e 66 6f 72 6d 61 74 69 6f 6e } //01 00 
		$a_01_6 = {42 69 74 43 6f 6e 76 65 72 74 65 72 } //01 00 
		$a_01_7 = {47 65 74 50 69 78 65 6c } //01 00 
		$a_01_8 = {54 72 61 6e 73 61 63 74 69 6f 6e 61 6c 46 69 6c 65 4d 61 6e 61 67 65 72 2e 64 6c 6c } //00 00 
	condition:
		any of ($a_*)
