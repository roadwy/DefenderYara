...
rule Trojan_BAT_AgentTesla_LHD_MTB{
	...
	strings :
		...
		$a_01_1 = {00 58 58 58 58 58 58 58 58 58 31 32 33 00 } //01 00 
		$a_01_2 = {46 48 4a 34 33 32 34 32 34 32 } //01 00 
		...
		$a_01_6 = {43 68 61 72 54 6f 56 61 6c 75 65 } //01 00 
		$a_01_7 = {4e 53 65 72 76 65 72 34 } //00 00 
	condition:
		any of ($a_*)
