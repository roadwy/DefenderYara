...
rule Trojan_BAT_AgentTesla_LAX_MTB{
	meta:
		description = "Trojan:BAT/AgentTesla.LAX!MTB,SIGNATURE_TYPE_PEHSTR_EXT,09 00 09 00 09 00 00 01 00 "
		
	strings :
		$a_01_0 = {24 61 64 31 37 64 39 31 38 2d 65 66 65 62 2d 34 61 31 32 2d 62 37 65 63 2d 65 30 30 35 62 38 64 35 35 64 37 37 } //01 00  $ad17d918-efeb-4a12-b7ec-e005b8d55d77
		$a_01_1 = {57 69 6e 20 55 73 62 49 6e 69 74 } //01 00  Win UsbInit
		...
		$a_01_8 = {53 75 73 70 65 6e 64 4c 61 79 6f 75 74 } //00 00  SuspendLayout
	condition:
		any of ($a_*)
