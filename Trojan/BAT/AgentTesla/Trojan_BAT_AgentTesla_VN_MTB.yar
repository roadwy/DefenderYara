...
rule Trojan_BAT_AgentTesla_VN_MTB_26{
	...
	strings :
		$a_81_0 = {44 6f 6f 64 6c 65 45 61 74 } //01 00 
		$a_81_1 = {44 6f 6f 64 6c 65 47 68 6f 73 74 } //01 00 
		$a_81_2 = {52 65 61 64 42 79 74 65 } //01 00 
		$a_81_3 = {42 6c 6f 63 6b 43 6f 70 79 } //01 00 
		$a_81_4 = {57 72 69 74 65 } //01 00 
		$a_81_5 = {24 30 32 30 38 46 32 45 31 2d 43 32 33 41 2d 34 35 34 42 2d 41 44 39 36 2d 37 30 39 42 33 34 35 38 38 36 33 38 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_BAT_AgentTesla_VN_MTB_28{
	...
	strings :
		$a_81_0 = {47 65 74 46 75 6c 6c 50 61 74 68 } //01 00 
		$a_81_1 = {47 65 74 54 65 6d 70 50 61 74 68 } //01 00 
		$a_81_2 = {57 72 69 74 65 41 6c 6c 42 79 74 65 73 } //01 00 
		$a_81_3 = {57 72 69 74 65 } //01 00 
		$a_81_4 = {42 6c 6f 63 6b 43 6f 70 79 } //01 00 
		$a_81_5 = {24 64 35 30 36 39 37 31 37 2d 32 37 31 37 2d 34 63 63 35 2d 38 34 64 32 2d 64 38 37 35 38 32 34 30 30 66 65 34 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_BAT_AgentTesla_VN_MTB_29{
	...
	strings :
		$a_81_0 = {4d 69 6e 69 5f 47 61 6d 65 5f 43 65 6e 74 65 72 2e 4d 79 } //01 00 
		$a_81_1 = {73 6e 61 6b 65 47 61 6d 65 4f 76 65 72 } //01 00 
		$a_81_2 = {4d 69 6e 69 5f 47 61 6d 65 5f 43 65 6e 74 65 72 2e 73 6e 61 6b 65 2e 72 65 73 6f 75 72 63 65 73 } //01 00 
		$a_81_3 = {24 37 31 38 30 62 38 61 34 2d 62 31 64 65 2d 34 37 35 39 2d 62 33 39 64 2d 33 32 64 35 65 65 32 37 36 34 30 38 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_BAT_AgentTesla_VN_MTB_32{
	...
	strings :
		$a_81_0 = {4d 61 74 68 44 72 69 6c 6c 5f 30 31 2e 4d 79 } //01 00 
		$a_81_1 = {73 74 61 72 74 47 61 6d 65 } //01 00 
		$a_81_2 = {67 61 6d 65 4f 76 65 72 } //01 00 
		$a_01_3 = {4d 00 61 00 74 00 68 00 44 00 72 00 69 00 6c 00 6c 00 5f 00 30 00 31 00 2e 00 52 00 65 00 73 00 6f 00 75 00 72 00 63 00 65 00 73 00 } //01 00 
		$a_81_4 = {24 34 45 34 38 46 30 41 41 2d 38 44 38 46 2d 34 36 44 36 2d 41 44 31 36 2d 37 37 33 42 46 33 43 39 42 36 31 39 } //00 00 
	condition:
		any of ($a_*)
