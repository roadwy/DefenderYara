...
rule Trojan_BAT_AgentTesla_AC_MTB_2{
	...
	strings :
		$a_81_0 = {43 75 72 72 65 6e 74 56 65 72 73 69 6f 6e 5c 45 78 70 6c 6f 72 65 72 5c 53 68 65 6c 6c 20 46 6f 6c 64 65 72 73 } //03 00 
		$a_81_1 = {5c 41 75 64 69 6f 41 70 70 } //03 00 
		$a_81_2 = {2f 43 20 72 75 6e 64 } //03 00 
		$a_81_3 = {5c 44 6f 77 6e 6c 6f 61 64 73 5c } //03 00 
		$a_81_4 = {44 6f 77 6e 6c 6f 61 64 46 69 6c 65 54 61 73 6b 41 73 79 6e 63 } //03 00 
		$a_81_5 = {4a 61 63 6b 2b 4d 79 41 64 64 49 6e 2b 3c 44 6f 77 6e 6c 6f 61 64 3e } //03 00 
		$a_81_6 = {6a 61 7a 6b 2e 64 6c 6c } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_BAT_AgentTesla_AC_MTB_3{
	...
	strings :
		...
		$a_81_1 = {44 6f 63 6b 53 74 79 6c 65 } //03 00 
		$a_81_2 = {40 70 6b 52 65 6d 69 6e 64 65 72 } //03 00 
		$a_81_3 = {45 78 65 63 75 74 65 4e 6f 6e 51 75 65 72 79 } //03 00 
		$a_81_4 = {5b 70 6f 6c 64 61 74 61 35 5d 2e 5b 44 65 6c 65 74 65 45 78 69 73 74 69 6e 67 52 65 6d 69 6e 64 65 72 5d } //03 00 
		$a_81_5 = {40 44 61 74 75 6d } //03 00 
		$a_81_6 = {70 6f 6c 64 61 74 61 35 2e 55 70 64 61 74 65 53 6e 6f 6f 7a 65 } //00 00 
	condition:
		any of ($a_*)
