...
rule Trojan_BAT_AgentTesla_LR_MTB{
	...
	strings :
		...
		$a_01_4 = {53 00 54 00 44 00 53 00 50 00 61 00 63 00 6b 00 61 00 67 00 65 00 42 00 72 00 6f 00 77 00 73 00 65 00 72 00 } //01 00 
		$a_01_5 = {45 00 35 00 5a 00 38 00 34 00 35 00 53 00 35 00 41 00 48 00 44 00 41 00 45 00 35 00 48 00 47 00 47 00 4f 00 34 00 48 00 35 00 31 00 } //00 00 
	condition:
		any of ($a_*)
