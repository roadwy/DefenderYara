...
rule Trojan_BAT_AgentTesla_NEAU_MTB{
	...
	strings :
		$a_03_0 = {28 20 00 00 0a 0a 00 06 7e 0e 00 00 04 28 21 00 00 0a 6f 90 01 01 00 00 0a 00 06 18 6f 90 01 01 00 00 0a 00 06 18 6f 90 01 01 00 00 0a 00 73 65 00 00 06 0b 07 06 6f 90 01 01 00 00 0a 90 00 } //10
