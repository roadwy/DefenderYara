...
rule Trojan_BAT_AgentTesla_EQS_MTB{
	...
	strings :
		$a_01_0 = {38 00 38 00 59 00 43 00 51 00 4f 00 39 00 47 00 48 00 48 00 50 00 47 00 44 00 59 00 48 00 34 00 5a 00 47 00 48 00 42 00 51 00 38 00 } //05 00  88YCQO9GHHPGDYH4ZGHBQ8
		$a_01_1 = {46 00 69 00 72 00 65 00 4c 00 61 00 6d 00 70 00 } //01 00  FireLamp
