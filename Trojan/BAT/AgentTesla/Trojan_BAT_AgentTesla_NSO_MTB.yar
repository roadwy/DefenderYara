...
rule Trojan_BAT_AgentTesla_NSO_MTB{
	...
	strings :
		$a_03_0 = {20 00 aa 02 00 8d 90 01 03 01 6f 90 01 03 0a 00 11 04 14 72 90 01 03 70 1b 8d 90 01 03 01 25 16 02 25 13 09 19 6f 90 01 03 0a a2 25 17 16 90 00 } //1
