...
rule Trojan_BAT_AgentTesla_NAA_MTB_4{
	...
	strings :
		$a_01_0 = {61 6a 77 66 64 61 69 64 77 61 00 41 73 73 65 6d 62 6c 79 54 72 61 64 65 6d 61 72 6b 41 74 74 72 69 62 75 74 65 } //1
		$a_01_1 = {6b 6f 69 00 61 6a 77 66 64 61 69 64 77 61 2e 65 78 65 00 6d 73 63 6f 72 6c 69 62 00 53 75 70 70 72 65 73 73 49 6c 64 61 73 6d 41 74 74 72 69 62 75 74 65 } //1
		$a_01_2 = {47 65 74 54 79 70 65 73 } //1 GetTypes
		$a_81_3 = {6a 73 66 65 69 66 65 6f 66 65 77 6f 6c 66 2e 65 78 65 } //1 jsfeifeofewolf.exe
