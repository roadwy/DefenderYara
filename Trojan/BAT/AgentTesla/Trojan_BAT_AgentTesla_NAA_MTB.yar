...
rule Trojan_BAT_AgentTesla_NAA_MTB{
	...
	strings :
		...
		$a_01_1 = {43 34 50 52 4f 4c 61 75 6e 63 68 65 72 } //00 00  C4PROLauncher
	condition:
		any of ($a_*)
...
rule Trojan_BAT_AgentTesla_NAA_MTB_2{
	...
	strings :
		...
		$a_01_1 = {47 61 6d 65 4d 6f 6e 50 52 4f 4b 49 4c 4c } //00 00  GameMonPROKILL
	condition:
		any of ($a_*)
...
rule Trojan_BAT_AgentTesla_NAA_MTB_3{
	...
	strings :
		...
		$a_01_1 = {31 64 32 61 61 30 61 36 2d 32 63 34 62 2d 34 33 36 39 2d 61 66 31 39 2d 65 66 30 33 65 34 33 63 62 64 37 38 } //00 00  1d2aa0a6-2c4b-4369-af19-ef03e43cbd78
	condition:
		any of ($a_*)
...
rule Trojan_BAT_AgentTesla_NAA_MTB_4{
	...
	strings :
		...
		$a_81_3 = {6a 73 66 65 69 66 65 6f 66 65 77 6f 6c 66 2e 65 78 65 } //01 00  jsfeifeofewolf.exe
