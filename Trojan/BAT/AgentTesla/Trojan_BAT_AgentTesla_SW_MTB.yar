...
rule Trojan_BAT_AgentTesla_SW_MTB_2{
	...
	strings :
		$a_03_0 = {07 09 20 00 5c 00 00 5d 07 09 20 00 5c 00 00 5d 91 08 09 1f 16 5d 6f ?? ?? ?? 0a 61 07 09 17 58 20 00 5c 00 00 5d 91 59 20 00 01 00 00 58 20 00 01 00 00 5d 28 ?? ?? ?? 0a 9c 00 09 15 58 0d 09 16 fe 04 16 fe 01 13 04 11 04 2d b3 } //1
