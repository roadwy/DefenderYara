...
rule Trojan_BAT_AgentTesla_SW_MTB{
	...
	strings :
		...
		$a_01_4 = {4c 00 75 00 63 00 69 00 64 00 69 00 74 00 79 00 2e 00 57 00 69 00 6e 00 46 00 6f 00 72 00 6d 00 73 00 } //01 00 
		$a_01_5 = {37 00 4b 00 38 00 47 00 38 00 45 00 48 00 35 00 34 00 4e 00 35 00 35 00 37 00 38 00 55 00 5a 00 32 00 39 00 5a 00 37 00 35 00 34 00 } //00 00 
	condition:
		any of ($a_*)
