...
rule Trojan_BAT_AgentTesla_LPI_MTB{
	...
	strings :
		$a_03_0 = {11 07 11 06 16 73 90 01 03 0a 13 08 00 90 00 } //1
		$a_03_1 = {03 8e 69 17 59 17 58 17 59 17 58 8d 90 01 03 01 13 09 11 08 11 09 16 03 8e 69 6f 90 01 03 0a 13 0a 11 09 11 0a 28 90 01 03 2b 28 90 01 03 2b 0c 00 de 0d 90 00 } //1
