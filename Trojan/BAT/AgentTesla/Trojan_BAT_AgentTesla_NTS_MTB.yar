...
rule Trojan_BAT_AgentTesla_NTS_MTB{
	...
	strings :
		...
		$a_01_1 = {41 62 61 64 64 6f 6e 44 72 6f 70 70 65 72 2d 6d 61 69 6e } //01 00 
		$a_01_2 = {4b 72 73 74 6f } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_BAT_AgentTesla_NTS_MTB_2{
	...
	strings :
		$a_01_0 = {24 37 39 31 37 32 42 31 33 2d 45 44 42 41 2d 34 30 39 36 2d 42 37 32 35 2d 38 45 39 32 42 37 33 30 42 32 42 41 } //01 00 
		$a_01_1 = {43 6c 61 73 73 4c 69 62 72 61 72 79 33 2e 52 65 73 6f 75 72 63 65 73 2e 72 65 73 6f 75 72 63 65 73 } //01 00 
