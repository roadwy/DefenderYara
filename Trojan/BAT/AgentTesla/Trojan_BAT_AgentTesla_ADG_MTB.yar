...
rule Trojan_BAT_AgentTesla_ADG_MTB{
	...
	strings :
		$a_03_0 = {02 02 8e 69 17 da 91 1f 70 61 0c 02 8e 69 17 d6 17 da 17 d6 8d 90 01 03 01 0d 02 8e 69 17 da 13 04 11 04 13 05 16 13 06 38 90 01 04 09 11 06 02 11 06 91 08 61 07 11 07 91 61 b4 9c 90 00 } //10
