...
rule Trojan_BAT_AgentTesla_AQF_MTB{
	...
	strings :
		$a_03_0 = {16 13 04 07 09 11 04 90 01 05 13 05 11 05 90 01 05 13 06 08 06 11 06 b4 9c 11 04 17 d6 13 04 11 04 16 31 db 06 17 d6 0a 09 17 d6 0d 09 90 00 } //10
