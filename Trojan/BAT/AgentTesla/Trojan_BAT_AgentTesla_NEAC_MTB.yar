...
rule Trojan_BAT_AgentTesla_NEAC_MTB{
	...
	strings :
		...
		$a_01_1 = {2d 00 65 00 78 00 74 00 64 00 75 00 6d 00 6d 00 74 00 } //02 00 
		$a_01_2 = {2d 00 77 00 68 00 61 00 74 00 74 00 } //02 00 
		$a_01_3 = {2d 00 64 00 65 00 62 00 75 00 67 00 } //02 00 
		$a_01_4 = {67 00 67 00 2e 00 65 00 78 00 65 00 } //00 00 
	condition:
		any of ($a_*)
