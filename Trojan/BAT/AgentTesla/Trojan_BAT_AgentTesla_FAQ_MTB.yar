...
rule Trojan_BAT_AgentTesla_FAQ_MTB{
	...
	strings :
		$a_03_0 = {16 2c 21 26 28 90 01 01 00 00 0a 06 6f 90 01 01 00 00 0a 28 90 01 01 01 00 06 74 90 01 01 00 00 1b 28 90 01 01 01 00 06 17 2d 06 26 de 09 0a 2b dd 0b 2b f8 26 de c8 90 00 } //3
