...
rule Trojan_BAT_AgentTesla_FAQ_MTB{
	...
	strings :
		...
		$a_01_1 = {73 00 70 00 62 00 2d 00 67 00 61 00 6e 00 2e 00 72 00 75 00 2f 00 70 00 61 00 6e 00 65 00 6c 00 2f 00 75 00 70 00 6c 00 6f 00 61 00 64 00 73 00 2f 00 44 00 65 00 63 00 6a 00 75 00 2e 00 62 00 6d 00 70 00 } //00 00 
	condition:
		any of ($a_*)
