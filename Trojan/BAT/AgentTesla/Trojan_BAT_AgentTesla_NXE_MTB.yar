...
rule Trojan_BAT_AgentTesla_NXE_MTB{
	...
	strings :
		$a_01_0 = {24 36 63 30 64 61 34 39 63 2d 66 66 65 37 2d 34 63 64 36 2d 62 30 32 65 2d 38 37 34 63 35 61 39 62 38 65 65 38 } //01 00 
		$a_01_1 = {47 61 6d 65 73 70 79 4d 61 73 74 65 72 53 65 72 76 65 72 2e 52 65 73 6f 75 72 63 65 73 } //01 00 
