...
rule Trojan_BAT_AgentTesla_KGO_MTB{
	...
	strings :
		$a_01_0 = {00 58 30 46 54 5f 46 54 32 00 } //01 00 
		$a_01_1 = {00 58 30 46 54 5f 46 54 31 00 } //01 00 
		$a_01_2 = {00 54 44 65 73 44 65 63 72 79 70 74 00 } //01 00 
		$a_01_3 = {50 00 61 00 6e 00 61 00 6d 00 65 00 72 00 61 00 2e 00 50 00 6f 00 72 00 73 00 63 00 68 00 65 00 } //01 00 
		$a_01_4 = {46 72 6f 6d 42 61 73 65 36 34 53 74 72 69 6e 67 } //01 00 
		$a_01_5 = {43 72 65 61 74 65 44 65 63 72 79 70 74 6f 72 } //01 00 
		$a_01_6 = {43 00 72 00 65 00 61 00 74 00 65 00 49 00 6e 00 73 00 74 00 61 00 6e 00 63 00 65 00 } //01 00 
...
rule Trojan_BAT_AgentTesla_KGO_MTB_2{
	...
	strings :
		...
		$a_01_3 = {43 00 72 00 65 00 61 00 74 00 65 00 49 00 6e 00 73 00 74 00 61 00 6e 00 63 00 65 00 } //01 00 
