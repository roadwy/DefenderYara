...
rule Trojan_BAT_AgentTesla_JLN_MTB{
	...
	strings :
		...
		$a_81_5 = {78 70 78 78 78 78 } //01 00 
		$a_81_6 = {4c 43 4d 61 70 53 74 72 69 6e 67 45 78 } //01 00 
		$a_81_7 = {4c 6f 63 61 6c 65 4e 61 6d 65 54 6f 4c 43 49 44 } //01 00 
		$a_81_8 = {56 69 72 74 75 61 6c 50 72 6f 74 65 63 74 } //01 00 
		$a_81_9 = {5c 63 6f 6d 6d 61 6e 64 5c 73 74 61 72 74 2e 65 78 65 } //00 00 
	condition:
		any of ($a_*)
