...
rule Trojan_BAT_AgentTesla_FT_MTB_2{
	...
	strings :
		$a_01_0 = {24 30 37 39 46 39 45 36 31 2d 31 35 34 46 2d 34 30 42 41 2d 41 44 41 41 2d 35 33 35 37 34 35 46 43 35 44 43 30 } //14 00 
		$a_81_1 = {24 39 35 37 62 62 37 64 32 2d 31 35 38 35 2d 34 31 61 30 2d 38 30 61 32 2d 65 65 33 63 62 62 65 36 33 34 31 35 } //14 00 
		$a_81_2 = {24 36 35 33 31 31 39 65 65 2d 66 30 39 34 2d 34 34 39 63 2d 39 36 63 30 2d 39 63 35 64 38 30 38 32 64 63 37 35 } //14 00 
		$a_81_3 = {24 39 35 66 34 36 32 31 63 2d 62 33 34 31 2d 34 63 66 66 2d 62 63 34 64 2d 34 65 32 30 36 31 30 36 66 30 33 37 } //14 00 
		$a_81_4 = {24 66 34 31 37 33 66 61 65 2d 64 39 62 38 2d 34 61 63 32 2d 62 31 63 61 2d 34 33 36 36 65 37 61 63 39 34 30 38 } //01 00 
