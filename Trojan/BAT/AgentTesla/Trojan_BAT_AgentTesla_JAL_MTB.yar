...
rule Trojan_BAT_AgentTesla_JAL_MTB{
	meta:
		description = "Trojan:BAT/AgentTesla.JAL!MTB,SIGNATURE_TYPE_PEHSTR_EXT,0d 00 0d 00 0d 00 00 01 00 "
		
	strings :
		$a_81_0 = {39 66 33 39 32 37 32 37 2d 31 65 30 30 2d 34 65 62 30 2d 61 36 32 39 2d 64 64 65 32 30 63 62 31 63 65 64 37 } //01 00  9f392727-1e00-4eb0-a629-dde20cb1ced7
		...
		$a_81_4 = {50 6f 72 74 61 6c 71 75 69 7a } //01 00  Portalquiz
		$a_81_5 = {44 65 62 75 67 67 69 6e 67 4d 6f 64 65 73 } //01 00  DebuggingModes
		$a_81_6 = {54 69 6d 65 72 5f 74 69 63 6b } //01 00  Timer_tick
		$a_81_7 = {53 70 6c 69 74 } //01 00  Split
		$a_81_8 = {44 65 62 75 67 67 65 72 42 72 6f 77 73 61 62 6c 65 53 74 61 74 65 } //01 00  DebuggerBrowsableState
		$a_81_9 = {46 75 6e 63 74 69 6f 6e 49 6e 69 74 } //01 00  FunctionInit
		...
		$a_81_12 = {47 65 74 54 79 70 65 } //00 00  GetType
	condition:
		any of ($a_*)
