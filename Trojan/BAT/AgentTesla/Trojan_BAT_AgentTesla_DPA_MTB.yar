...
rule Trojan_BAT_AgentTesla_DPA_MTB{
	...
	strings :
		...
		$a_01_1 = {00 43 46 32 33 34 30 35 32 00 } //01 00  䌀㉆㐳㔰2
		$a_01_2 = {00 43 46 33 32 31 34 38 31 32 33 00 } //01 00  䌀㍆ㄲ㠴㈱3
		$a_01_3 = {00 43 46 33 34 32 34 32 33 35 36 36 35 00 } //01 00  䌀㍆㈴㈴㔳㘶5
		...
		$a_01_8 = {54 00 78 00 46 00 69 00 6c 00 65 00 4d 00 61 00 6e 00 61 00 67 00 65 00 72 00 } //01 00  TxFileManager
