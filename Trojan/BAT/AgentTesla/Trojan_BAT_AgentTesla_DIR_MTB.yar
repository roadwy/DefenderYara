...
rule Trojan_BAT_AgentTesla_DIR_MTB{
	...
	strings :
		$a_03_0 = {0c 07 08 6f 90 01 03 0a 07 18 6f 90 01 03 0a 07 6f 90 01 03 0a 02 16 02 8e 69 6f 90 01 03 0a 0d de 15 07 2c 06 07 6f 90 01 03 0a dc 90 09 11 00 73 90 01 03 0a 0b 73 90 01 03 0a 06 6f 90 01 03 0a 90 00 } //1
