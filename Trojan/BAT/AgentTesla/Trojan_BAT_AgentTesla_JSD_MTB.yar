...
rule Trojan_BAT_AgentTesla_JSD_MTB{
	meta:
		description = "Trojan:BAT/AgentTesla.JSD!MTB,SIGNATURE_TYPE_PEHSTR_EXT,08 00 08 00 08 00 00 01 00 "
	...
	strings :
		...
		$a_01_2 = {57 69 6e 41 70 69 } //01 00  WinApi
		$a_01_3 = {44 79 6e 61 6d 69 63 49 6e 76 6f 6b 65 } //01 00  DynamicInvoke
		$a_01_4 = {50 68 6f 6e 65 } //01 00  Phone
