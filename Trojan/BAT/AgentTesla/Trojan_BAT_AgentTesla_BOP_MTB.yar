...
rule Trojan_BAT_AgentTesla_BOP_MTB{
	...
	strings :
		$a_02_0 = {26 20 00 00 00 00 38 90 01 04 11 00 6f 90 01 03 0a 72 90 01 03 70 20 00 01 00 00 14 11 00 17 8d 90 01 03 01 25 16 02 7e 90 01 03 04 28 90 01 03 06 a2 6f 90 01 03 0a 74 90 01 03 01 28 90 01 03 06 13 01 38 90 01 04 28 90 01 03 0a 13 00 38 90 00 } //1
