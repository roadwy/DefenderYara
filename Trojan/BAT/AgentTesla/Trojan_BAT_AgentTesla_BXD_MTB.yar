...
rule Trojan_BAT_AgentTesla_BXD_MTB{
	...
	strings :
		$a_02_0 = {0a 0b 06 16 73 90 01 03 0a 73 90 01 03 0a 0c 08 07 6f 90 01 03 0a 17 8d 90 01 03 01 25 16 07 6f 90 01 03 0a a2 0d de 1e 08 2c 06 08 6f 90 01 03 0a dc 07 2c 06 07 6f 90 01 03 0a dc 90 00 } //1
