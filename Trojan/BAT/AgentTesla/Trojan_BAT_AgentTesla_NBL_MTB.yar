...
rule Trojan_BAT_AgentTesla_NBL_MTB{
	...
	strings :
		$a_03_0 = {02 6c 23 ff b9 f4 ee 2a 81 f7 3f 5b 28 90 01 03 0a b7 28 90 01 03 0a 28 90 01 03 0a 0b 07 0a 2b 00 06 2a 90 00 } //5
...
rule Trojan_BAT_AgentTesla_NBL_MTB_2{
	...
	strings :
		...
		$a_03_1 = {04 20 ab 52 e3 48 61 02 61 0a 7e b0 90 01 03 0c 08 74 44 90 01 03 25 06 93 0b 06 18 58 93 07 61 0b 18 13 0e 38 7c ff ff ff 90 00 } //1
	condition:
