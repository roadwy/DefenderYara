...
rule Trojan_BAT_AgentTesla_CDN_MTB{
	...
	strings :
		...
		$a_81_2 = {00 48 75 6e 74 65 72 00 } //01 00  䠀湵整r
		$a_81_3 = {47 65 74 54 79 70 65 } //01 00  GetType
		$a_81_4 = {43 72 65 61 74 65 49 6e 73 74 61 6e 63 65 } //01 00  CreateInstance
		$a_81_5 = {41 72 72 61 79 41 74 74 72 69 62 75 74 65 } //01 00  ArrayAttribute
		...
		$a_81_8 = {47 65 74 43 68 61 72 } //01 00  GetChar
