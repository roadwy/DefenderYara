...
rule Trojan_BAT_AgentTesla_AAWH_MTB{
	...
	strings :
		$a_03_0 = {06 0a 12 00 28 90 01 01 00 00 06 06 72 43 00 00 70 28 90 01 01 00 00 0a 6f 90 01 01 00 00 0a 06 28 90 01 01 00 00 06 28 90 01 01 00 00 06 2a 90 00 } //4
