...
rule Trojan_BAT_AgentTesla_EEG_MTB{
	...
	strings :
		$a_03_0 = {08 07 16 73 90 01 03 0a 0d 03 8e 69 8d 90 01 03 01 13 04 09 11 04 16 03 8e 69 6f 90 01 03 0a 13 05 11 04 11 05 28 90 01 03 2b 28 90 01 03 2b 13 06 de 28 90 00 } //1
		$a_01_1 = {00 46 72 6f 6d 42 61 73 65 36 34 53 74 72 69 6e 67 00 } //1 䘀潲䉭獡㙥匴牴湩g
		$a_01_2 = {00 43 72 65 61 74 65 44 65 63 72 79 70 74 6f 72 00 } //1
	condition:
