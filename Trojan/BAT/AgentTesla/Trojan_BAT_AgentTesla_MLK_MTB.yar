...
rule Trojan_BAT_AgentTesla_MLK_MTB{
	...
	strings :
		$a_02_0 = {25 16 07 a2 25 17 19 8d 90 01 02 00 01 25 16 7e 90 01 02 00 04 a2 25 17 7e 90 01 02 00 04 a2 25 18 72 90 01 02 00 70 a2 a2 6f 90 01 02 00 0a 26 90 00 } //1
