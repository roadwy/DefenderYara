...
rule Trojan_BAT_AgentTesla_EP_MTB_2{
	...
	strings :
		$a_81_0 = {50 4f 53 5f 53 61 6c 65 73 5f 61 6e 64 5f 49 6e 76 65 6e 74 6f 72 79 2e 4d 79 2e 52 65 73 6f 75 72 63 65 73 } //01 00 
		$a_81_1 = {50 4f 53 5f 53 61 6c 65 73 5f 61 6e 64 5f 49 6e 76 65 6e 74 6f 72 79 2e 49 53 4f 2e 72 65 73 6f 75 72 63 65 73 } //01 00 
		$a_81_2 = {53 61 6d 70 6c 65 20 50 4f 53 20 40 64 65 61 73 70 6f 5f 73 74 75 64 69 6f 73 } //01 00 
		$a_81_3 = {43 75 72 72 65 6e 74 43 6c 6f 63 6b 53 70 65 65 64 } //01 00 
		$a_81_4 = {4d 6f 74 68 65 72 62 6f 61 72 64 20 4e 61 6d 65 } //01 00 
		$a_81_5 = {43 72 65 61 74 65 49 6e 73 74 61 6e 63 65 } //01 00 
		$a_81_6 = {41 63 74 69 76 61 74 6f 72 } //01 00 
		$a_81_7 = {74 65 6d 70 2e 74 78 74 } //00 00 
	condition:
		any of ($a_*)
