...
rule Trojan_BAT_AgentTesla_NDH_MTB{
	meta:
		description = "Trojan:BAT/AgentTesla.NDH!MTB,SIGNATURE_TYPE_PEHSTR_EXT,0a 00 0a 00 0a 00 00 01 00 "
		
	strings :
		$a_01_0 = {24 61 31 32 30 39 33 62 65 2d 36 66 64 61 2d 34 38 63 31 2d 39 62 31 64 2d 30 31 64 34 34 39 61 37 30 37 66 65 } //01 00  $a12093be-6fda-48c1-9b1d-01d449a707fe
		$a_01_1 = {53 79 73 74 65 6d 2e 57 69 6e 64 6f 77 73 2e 46 6f 72 6d 73 2e 46 6f 72 6d } //01 00  System.Windows.Forms.Form
		...
		$a_01_9 = {53 74 72 52 65 76 65 72 73 65 } //00 00  StrReverse
	condition:
		any of ($a_*)
