...
rule Trojan_BAT_AgentTesla_NYE_MTB{
	...
	strings :
		...
		$a_01_1 = {24 38 65 32 31 66 37 36 66 2d 64 32 61 30 2d 34 38 32 66 2d 39 32 66 32 2d 35 66 34 36 38 34 64 31 36 39 65 33 } //00 00  $8e21f76f-d2a0-482f-92f2-5f4684d169e3
	condition:
		any of ($a_*)
