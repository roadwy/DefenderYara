...
rule Trojan_BAT_AgentTesla_NA_MTB{
	...
	strings :
		$a_03_0 = {25 47 11 0b 11 0f 11 0b 8e 69 5d 91 61 d2 52 00 90 01 02 17 58 13 0f 11 0f 11 0a 8e 69 90 00 } //5
	condition:
		((#a_03_0  & 1)*5) >=5
...
rule Trojan_BAT_AgentTesla_NA_MTB_2{
	...
	strings :
		$a_03_0 = {72 7c 3b 02 70 17 8d 90 01 03 01 25 16 11 01 a2 25 13 02 90 00 } //5
...
rule Trojan_BAT_AgentTesla_NA_MTB_3{
	...
	strings :
		$a_03_0 = {06 07 6f 2c 00 00 0a 0c 20 90 01 03 ff 28 90 01 03 0a fe 90 01 02 00 38 90 01 03 00 90 00 } //5
...
rule Trojan_BAT_AgentTesla_NA_MTB_4{
	...
	strings :
		$a_03_0 = {11 07 25 1a 58 13 07 4b 11 07 25 1a 58 13 07 4b 5a 13 11 11 11 20 90 01 03 dc 33 2d 08 07 2d 07 90 00 } //5
...
rule Trojan_BAT_AgentTesla_NA_MTB_5{
	...
	strings :
		$a_03_0 = {8f 0b 00 00 01 25 71 90 01 01 00 00 01 fe 90 01 02 00 fe 90 01 02 00 20 90 01 01 00 00 00 5d 91 61 d2 81 90 01 01 00 00 01 20 90 01 01 00 00 00 fe 90 01 02 00 00 fe 90 01 02 00 20 90 01 01 00 00 00 fe 01 39 90 01 01 00 00 00 90 00 } //5
