...
rule Trojan_BAT_AgentTesla_CAF_MTB{
	...
	strings :
		...
		$a_02_1 = {07 02 09 18 6f ?? ?? ?? 0a 1f 10 28 ?? ?? ?? 0a 84 28 ?? ?? ?? 06 28 ?? ?? ?? 06 26 } //1
	condition:
...
rule Trojan_BAT_AgentTesla_CAF_MTB_2{
	...
	strings :
		$a_03_0 = {2b 1d 12 03 2b 1c 2b 21 07 02 07 18 6f ?? 00 00 0a 1f 10 28 ?? 00 00 0a 6f ?? 00 00 0a de 20 08 2b e0 28 ?? 00 00 0a 2b dd 06 2b dc } //4
...
rule Trojan_BAT_AgentTesla_CAF_MTB_3{
	...
	strings :
		$a_02_0 = {06 11 04 1f 10 28 ?? ?? ?? 06 d1 28 ?? ?? ?? 06 26 } //1
