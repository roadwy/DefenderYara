...
rule Trojan_BAT_AgentTesla_BMH_MTB{
	meta:
		description = "Trojan:BAT/AgentTesla.BMH!MTB,SIGNATURE_TYPE_PEHSTR_EXT,0e 00 0e 00 0e 00 00 01 00 "
		
	strings :
		$a_81_0 = {67 65 74 5f 4f 66 66 73 65 74 4d 61 72 73 68 61 6c 65 72 } //01 00  get_OffsetMarshaler
		$a_81_1 = {67 65 74 5f 52 65 74 75 72 6e 4d 65 73 73 61 67 65 } //01 00  get_ReturnMessage
		...
		$a_81_9 = {54 72 61 6e 73 66 6f 72 6d 46 69 6e 61 6c 42 6c 6f 63 6b } //01 00  TransformFinalBlock
		$a_81_10 = {47 65 74 54 79 70 65 } //01 00  GetType
		$a_81_11 = {49 6e 76 6f 6b 65 4d 65 6d 62 65 72 } //01 00  InvokeMember
		$a_81_12 = {47 65 74 41 73 73 65 6d 62 6c 69 65 73 } //01 00  GetAssemblies
		$a_81_13 = {52 65 70 6c 61 63 65 } //00 00  Replace
	condition:
		any of ($a_*)
