...
rule Trojan_BAT_AgentTesla_MY_MTB_2{
	...
	strings :
		...
		$a_00_9 = {4d 65 6d 6f 72 79 53 74 72 65 61 6d } //01 00  MemoryStream
		$a_00_10 = {52 65 61 64 42 79 74 65 } //01 00  ReadByte
		$a_00_11 = {67 65 74 5f 4c 65 6e 67 74 68 } //01 00  get_Length
