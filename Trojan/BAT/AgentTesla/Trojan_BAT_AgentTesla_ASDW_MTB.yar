...
rule Trojan_BAT_AgentTesla_ASDW_MTB{
	...
	strings :
		$a_03_0 = {ff ff 00 11 11 72 ?? 00 00 70 28 ?? 00 00 0a 72 ?? 00 00 70 28 ?? 00 00 0a 6f ?? 00 00 0a 13 0f 20 06 00 00 00 7e ?? 02 00 04 7b ?? 02 00 04 39 ?? 00 00 00 26 20 07 00 00 00 38 } //1
