...
rule Trojan_BAT_AgentTesla_NO_MTB{
	...
	strings :
		$a_81_0 = {73 65 74 5f 53 65 6c 65 63 74 43 6f 6d 6d 61 6e 64 } //01 00 
		$a_81_1 = {4d 48 4d 53 2e 46 6f 72 6d 31 2e 72 65 73 6f 75 72 63 65 73 } //01 00 
		$a_81_2 = {4d 48 4d 53 2e 66 72 6d 53 79 73 74 65 6d 49 6e 66 6f 2e 72 65 73 6f 75 72 63 65 73 } //01 00 
		$a_81_3 = {24 32 34 30 62 66 30 32 31 2d 31 38 33 66 2d 34 36 66 36 2d 39 37 63 30 2d 63 64 34 39 31 38 61 33 34 38 65 39 } //01 00 
