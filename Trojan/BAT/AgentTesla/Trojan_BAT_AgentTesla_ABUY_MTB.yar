...
rule Trojan_BAT_AgentTesla_ABUY_MTB{
	...
	strings :
		...
		$a_01_1 = {50 00 72 00 6f 00 6a 00 65 00 63 00 74 00 65 00 64 00 5f 00 53 00 61 00 6c 00 65 00 73 00 5f 00 50 00 72 00 6f 00 6a 00 65 00 63 00 74 00 2e 00 52 00 65 00 73 00 6f 00 75 00 72 00 63 00 65 00 73 00 } //00 00 
	condition:
		any of ($a_*)
