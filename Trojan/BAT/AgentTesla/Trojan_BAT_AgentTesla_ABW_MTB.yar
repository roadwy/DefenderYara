...
rule Trojan_BAT_AgentTesla_ABW_MTB_2{
	...
	strings :
		$a_03_0 = {1f 28 28 38 90 01 02 0a 0c 08 72 7d 90 01 02 70 28 90 01 03 0a 0d 09 28 90 01 03 0a 16 fe 01 13 09 11 09 3a 90 01 03 00 00 09 28 90 01 03 0a 16 9a 0d 09 09 90 00 } //4
...
rule Trojan_BAT_AgentTesla_ABW_MTB_3{
	...
	strings :
		$a_03_0 = {16 0d 2b 31 00 07 08 09 28 90 01 03 06 28 90 01 03 06 00 28 90 01 03 06 28 90 01 03 06 28 90 01 03 06 00 7e 90 01 03 04 06 28 90 01 03 06 d2 9c 00 09 17 58 0d 09 17 fe 04 13 04 11 04 2d c5 90 00 } //5
...
rule Trojan_BAT_AgentTesla_ABW_MTB_4{
	...
	strings :
		$a_03_0 = {06 07 16 20 00 90 01 02 00 6f 8c 90 01 02 0a 0d 09 16 fe 02 13 04 11 04 2c 0c 00 08 07 16 09 6f 8d 90 01 02 0a 00 00 00 09 16 fe 02 13 05 11 05 2d d0 08 6f 8e 90 01 02 0a 13 06 de 16 90 00 } //3
