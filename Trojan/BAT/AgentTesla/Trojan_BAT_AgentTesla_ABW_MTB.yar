...
rule Trojan_BAT_AgentTesla_ABW_MTB_2{
	...
	strings :
		...
		$a_01_1 = {47 65 74 44 69 72 65 63 74 6f 72 69 65 73 } //01 00 
		$a_01_2 = {53 6d 74 70 43 6c 69 65 6e 74 } //01 00 
		$a_01_3 = {4e 65 74 77 6f 72 6b 43 72 65 64 65 6e 74 69 61 6c } //01 00 
		$a_01_4 = {46 00 69 00 72 00 65 00 46 00 69 00 78 00 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_BAT_AgentTesla_ABW_MTB_3{
	...
	strings :
		...
		$a_01_3 = {4e 00 65 00 74 00 77 00 6f 00 72 00 6b 00 41 00 72 00 69 00 74 00 68 00 6d 00 65 00 74 00 69 00 63 00 47 00 61 00 6d 00 65 00 2e 00 50 00 72 00 6f 00 70 00 65 00 72 00 74 00 69 00 65 00 73 00 2e 00 52 00 65 00 73 00 6f 00 75 00 72 00 63 00 65 00 73 00 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_BAT_AgentTesla_ABW_MTB_4{
	...
	strings :
		...
		$a_01_3 = {44 65 63 6f 6d 70 72 65 73 73 47 5a 69 70 } //01 00 
		$a_01_4 = {49 6e 76 6f 6b 65 4d 65 6d 62 65 72 } //01 00 
		$a_01_5 = {47 65 74 45 6e 75 6d 65 72 61 74 6f 72 } //01 00 
		$a_01_6 = {44 65 62 75 67 67 69 6e 67 4d 6f 64 65 73 } //01 00 
		$a_01_7 = {62 79 74 65 73 54 6f 44 65 63 6f 6d 70 72 65 73 73 } //00 00 
	condition:
		any of ($a_*)
