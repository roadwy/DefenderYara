...
rule Trojan_BAT_AgentTesla_DMA_MTB{
	...
	strings :
		$a_01_0 = {20 00 54 00 20 00 20 00 6f 00 20 00 57 00 20 00 69 00 20 00 6e 00 20 00 33 00 20 00 32 00 20 00 } //01 00 
		...
		$a_01_7 = {00 49 6e 76 6f 6b 65 4d 65 6d 62 65 72 00 } //00 00 
	condition:
		any of ($a_*)
