...
rule Trojan_BAT_AgentTesla_EPX_MTB{
	...
	strings :
		$a_03_0 = {06 11 04 17 da 6f 90 01 03 0a 07 11 04 07 6f 90 01 03 0a 5d 6f 90 01 03 0a da 13 05 08 11 05 28 90 01 03 0a 28 90 01 03 0a 28 90 01 03 0a 0c 11 04 17 d6 13 04 90 00 } //1
