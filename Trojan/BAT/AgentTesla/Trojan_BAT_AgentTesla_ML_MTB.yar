...
rule Trojan_BAT_AgentTesla_ML_MTB{
	...
	strings :
		$a_02_0 = {13 04 11 04 14 17 8d 90 01 02 00 01 25 16 19 8d 90 01 02 00 01 25 16 7e 90 01 02 00 04 a2 25 17 7e 90 01 02 00 04 a2 25 18 72 90 01 02 00 70 a2 a2 6f 90 01 02 00 0a 26 1f 17 8c 90 01 02 00 01 0a 2b 00 06 2a 90 00 } //1
	condition:
		((#a_02_0  & 1)*1) >=1
...
rule Trojan_BAT_AgentTesla_ML_MTB_2{
	...
	strings :
		$a_03_0 = {06 16 73 23 00 00 0a 73 24 00 00 0a 0c 00 08 90 0a 25 00 28 90 01 03 06 73 21 00 00 0a 0a 00 73 22 00 00 0a 0b 90 02 13 07 6f 25 00 00 0a 00 07 6f 26 00 00 0a 0d de 90 01 01 08 2c 07 08 6f 90 01 03 0a 00 dc 07 2c 07 07 6f 90 01 03 0a 00 dc 06 2c 07 06 6f 90 01 03 0a 00 dc 09 2a 90 00 } //1
