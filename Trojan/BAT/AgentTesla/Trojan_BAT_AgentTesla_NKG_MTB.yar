...
rule Trojan_BAT_AgentTesla_NKG_MTB{
	...
	strings :
		$a_03_0 = {00 00 06 0c 08 20 90 01 04 28 90 01 03 0a fe 04 0d 09 2c 15 06 20 90 01 04 d6 0a 07 16 06 17 d6 8d 90 01 03 01 a2 2b d6 90 00 } //10
		$a_03_1 = {00 07 16 fe 02 16 fe 01 0c 08 2c 1c 07 17 d6 0b 06 72 0e 05 00 70 28 90 01 03 0a 8c 90 01 03 01 6f 90 01 03 0a 00 2b d8 90 00 } //10
