...
rule Trojan_BAT_AgentTesla_MBCR_MTB{
	...
	strings :
		$a_03_0 = {72 cb 02 00 70 20 00 01 00 00 14 14 17 8d 90 01 01 00 00 01 25 16 11 05 6f 90 01 01 00 00 0a a2 6f 90 01 01 00 00 0a 74 90 01 01 00 00 01 13 07 11 07 6f 90 01 01 00 00 0a 16 9a 7e 90 01 01 00 00 04 13 09 11 09 90 00 } //1
