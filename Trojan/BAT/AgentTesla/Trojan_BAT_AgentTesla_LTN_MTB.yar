...
rule Trojan_BAT_AgentTesla_LTN_MTB{
	...
	strings :
		...
		$a_81_1 = {47 65 74 50 69 78 65 6c } //00 00  GetPixel
	condition:
		any of ($a_*)
...
rule Trojan_BAT_AgentTesla_LTN_MTB_2{
	...
	strings :
		$a_01_0 = {24 63 32 38 30 38 63 63 62 2d 35 61 65 38 2d 34 38 65 38 2d 61 64 64 36 2d 31 35 37 30 66 33 35 33 61 39 64 30 } //01 00  $c2808ccb-5ae8-48e8-add6-1570f353a9d0
		...
		$a_01_5 = {00 44 65 62 75 67 67 65 72 4e 6f 6e 55 73 65 72 43 6f 64 65 41 74 74 72 69 62 75 74 65 00 } //00 00  䐀扥杵敧乲湯獕牥潃敤瑁牴扩瑵e
	condition:
		any of ($a_*)
