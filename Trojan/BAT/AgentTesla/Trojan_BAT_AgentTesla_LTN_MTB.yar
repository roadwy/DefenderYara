...
rule Trojan_BAT_AgentTesla_LTN_MTB{
	...
	strings :
		$a_03_0 = {13 05 2b 29 00 09 11 04 11 05 28 90 01 03 06 13 09 11 09 28 90 01 03 0a 13 0a 08 11 04 11 0a d2 6f 90 01 03 0a 00 00 11 05 17 58 13 05 11 05 17 fe 04 13 0b 11 0b 2d cc 90 00 } //1
