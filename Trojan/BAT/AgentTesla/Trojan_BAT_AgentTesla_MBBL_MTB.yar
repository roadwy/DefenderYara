...
rule Trojan_BAT_AgentTesla_MBBL_MTB{
	...
	strings :
		$a_03_0 = {05 03 05 8e 69 5d 91 04 03 1f 16 5d 91 61 28 90 01 03 0a 05 03 17 58 05 8e 69 5d 91 28 90 01 03 0a 59 20 00 01 00 00 58 20 00 01 00 00 5d 90 00 } //1
