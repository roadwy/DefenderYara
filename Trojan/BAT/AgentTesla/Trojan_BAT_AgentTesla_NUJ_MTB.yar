...
rule Trojan_BAT_AgentTesla_NUJ_MTB{
	...
	strings :
		$a_01_0 = {24 31 63 65 62 34 32 36 34 2d 36 33 33 35 2d 34 63 65 31 2d 38 65 62 37 2d 39 39 61 64 38 61 31 65 62 65 64 38 } //01 00  $1ceb4264-6335-4ce1-8eb7-99ad8a1ebed8
		$a_01_1 = {62 6f 73 74 6f 6e 62 65 61 6e 63 61 66 65 2e 52 65 73 6f 75 72 63 65 73 2e 72 65 73 6f 75 72 63 65 73 } //01 00  bostonbeancafe.Resources.resources
