...
rule Trojan_BAT_AgentTesla_ERR_MTB{
	...
	strings :
		$a_01_0 = {54 00 5a 00 51 00 56 00 4f 00 35 00 35 00 37 00 47 00 43 00 42 00 41 00 5a 00 48 00 50 00 54 00 42 00 34 00 47 00 5a 00 47 00 35 00 } //05 00 
		$a_01_1 = {41 00 74 00 68 00 6c 00 65 00 74 00 65 00 } //01 00 
