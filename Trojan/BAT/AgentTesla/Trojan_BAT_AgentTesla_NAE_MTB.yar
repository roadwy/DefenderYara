...
rule Trojan_BAT_AgentTesla_NAE_MTB{
	...
	strings :
		...
		$a_01_1 = {50 75 61 66 6f 77 72 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_BAT_AgentTesla_NAE_MTB_2{
	...
	strings :
		...
		$a_01_1 = {75 6e 70 61 63 6b 6d 65 65 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_BAT_AgentTesla_NAE_MTB_3{
	...
	strings :
		$a_81_0 = {47 65 74 50 69 78 65 6c } //01 00 
		...
		$a_01_4 = {00 49 5f 5f 5f 5f 5f 5f 5f 5f 49 00 } //01 00 
		$a_01_5 = {00 49 5f 5f 5f 5f 5f 5f 5f 5f 5f 49 00 } //01 00 
		$a_01_6 = {00 49 5f 5f 5f 5f 5f 5f 5f 5f 5f 5f 49 00 } //01 00 
		$a_01_7 = {00 49 5f 5f 5f 5f 5f 5f 5f 5f 5f 5f 5f 49 00 } //01 00 
		$a_01_8 = {47 65 74 45 78 70 6f 72 74 65 64 54 79 70 65 73 } //00 00 
	condition:
		any of ($a_*)
