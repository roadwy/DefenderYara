...
rule Trojan_BAT_AgentTesla_DAD_MTB{
	...
	strings :
		$a_03_0 = {13 04 16 13 07 2b 18 00 11 04 11 07 09 11 07 9a 1f 10 28 90 01 01 00 00 0a 9c 00 11 07 17 58 13 07 11 07 09 8e 69 fe 04 13 08 11 08 2d db 90 00 } //3
