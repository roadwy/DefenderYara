...
rule Trojan_BAT_AgentTesla_NUL_MTB{
	...
	strings :
		$a_01_0 = {24 33 39 33 34 64 33 61 39 2d 65 32 64 39 2d 34 35 30 64 2d 61 64 34 63 2d 63 32 35 66 36 34 37 62 62 37 37 30 } //01 00 
		$a_01_1 = {41 50 43 44 2e 50 65 6f 70 6c 65 4c 69 62 72 61 72 79 2e 52 65 73 6f 75 72 63 65 73 2e 72 65 73 6f 75 72 63 65 73 } //01 00 
