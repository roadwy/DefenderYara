...
rule Trojan_BAT_AgentTesla_PREX_MTB_2{
	...
	strings :
		...
		$a_03_7 = {3a 00 2f 00 2f 00 72 00 65 00 6d 00 69 00 73 00 61 00 74 00 2e 00 63 00 6f 00 6d 00 2e 00 75 00 79 00 2f 00 6e 00 6f 00 6e 00 2f 00 90 02 14 2e 00 70 00 64 00 66 00 90 00 } //1
		$a_03_8 = {3a 2f 2f 72 65 6d 69 73 61 74 2e 63 6f 6d 2e 75 79 2f 6e 6f 6e 2f 90 02 14 2e 70 64 66 90 00 } //1
	condition:
