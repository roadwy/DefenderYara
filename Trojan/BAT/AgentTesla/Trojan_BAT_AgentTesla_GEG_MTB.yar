...
rule Trojan_BAT_AgentTesla_GEG_MTB{
	...
	strings :
		...
		$a_01_1 = {49 6e 76 6f 6b 65 } //03 00 
		$a_01_2 = {68 47 64 38 52 34 52 54 62 73 72 34 53 35 50 79 6e 53 } //03 00 
		$a_01_3 = {48 6f 51 4d 50 47 4a 4d 38 63 6f 70 39 66 65 59 54 36 } //00 00 
	condition:
		any of ($a_*)
