...
rule Trojan_BAT_AgentTesla_ID_MTB{
	meta:
		description = "Trojan:BAT/AgentTesla.ID!MTB,SIGNATURE_TYPE_PEHSTR_EXT,0c 00 0c 00 0c 00 00 01 00 "
...
rule Trojan_BAT_AgentTesla_ID_MTB_2{
	meta:
		description = "Trojan:BAT/AgentTesla.ID!MTB,SIGNATURE_TYPE_PEHSTR_EXT,18 00 18 00 0a 00 00 14 00 "
		
	strings :
		$a_81_0 = {24 35 37 35 30 35 32 31 66 2d 37 66 33 37 2d 34 65 36 61 2d 38 38 61 32 2d 63 35 31 35 32 32 39 39 32 37 30 35 } //01 00  $5750521f-7f37-4e6a-88a2-c51522992705
...
rule Trojan_BAT_AgentTesla_ID_MTB_3{
	meta:
		description = "Trojan:BAT/AgentTesla.ID!MTB,SIGNATURE_TYPE_PEHSTR,02 00 02 00 02 00 00 01 00 "
		
	strings :
		$a_01_0 = {28 05 00 00 06 72 63 04 00 70 72 67 04 00 70 6f 7c 00 00 0a 17 8d 57 00 00 01 25 16 1f 2d 9d 6f 7d 00 00 0a 0b 07 8e 69 8d 58 00 00 01 0c 16 13 07 2b 15 } //01 00 
		$a_01_1 = {08 11 07 07 11 07 9a 1f 10 28 7e 00 00 0a 9c 11 07 17 58 13 07 11 07 07 8e 69 fe 04 13 08 11 08 2d de } //00 00 
	condition:
		any of ($a_*)
