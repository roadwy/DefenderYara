...
rule Trojan_BAT_AgentTesla_NSD_MTB{
	...
	strings :
		$a_01_0 = {24 37 62 30 64 31 35 66 66 2d 35 39 63 30 2d 34 30 30 37 2d 38 32 61 61 2d 65 37 34 31 31 38 36 35 33 31 63 62 } //01 00 
		$a_01_1 = {56 69 73 75 61 6c 5f 4e 5f 51 75 65 65 6e 73 5f 53 6f 6c 76 65 72 2e 50 72 6f 70 65 72 74 69 65 73 2e 52 65 73 6f 75 72 63 65 73 2e 72 65 73 6f 75 72 63 65 73 } //01 00 
