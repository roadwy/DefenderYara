...
rule Trojan_BAT_AgentTesla_SIL_MTB{
	...
	strings :
		...
		$a_81_5 = {49 5f 5f 5f 5f 5f 5f 5f 5f 5f 5f 5f 5f 5f 5f 5f 5f 5f 5f 5f 5f 5f 5f 32 } //01 00 
		$a_01_6 = {44 00 65 00 74 00 65 00 63 00 74 00 43 00 50 00 55 00 } //01 00 
		$a_81_7 = {54 6f 43 68 61 72 41 72 72 61 79 } //01 00 
		$a_81_8 = {49 6e 76 6f 6b 65 4d 65 6d 62 65 72 } //00 00 
	condition:
		any of ($a_*)
