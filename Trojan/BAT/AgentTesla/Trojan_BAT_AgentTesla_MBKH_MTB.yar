...
rule Trojan_BAT_AgentTesla_MBKH_MTB{
	...
	strings :
		$a_03_0 = {8e 69 5d 91 08 09 08 6f 90 01 01 00 00 0a 5d 6f 90 01 01 00 00 0a 61 28 90 01 01 00 00 0a 07 09 17 58 07 8e 69 5d 91 28 90 01 01 00 00 0a 59 20 00 01 00 00 58 90 00 } //1
