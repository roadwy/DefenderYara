...
rule Trojan_BAT_AgentTesla_ES_MTB{
	...
	strings :
		$a_02_0 = {0a 18 5b 0a 73 90 01 03 0a 0b 16 0c 2b 1e 00 07 02 08 18 5a 18 6f 90 01 03 0a 1f 10 28 90 01 03 0a 6f 90 01 03 0a 00 00 08 17 58 0c 08 06 fe 04 0d 09 2d da 07 6f 90 01 03 0a 13 04 2b 00 11 04 2a 90 00 } //10
