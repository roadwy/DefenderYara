...
rule Trojan_BAT_AgentTesla_ESO_MTB{
	...
	strings :
		$a_01_0 = {24 45 44 42 34 34 33 35 31 2d 43 37 36 46 2d 34 45 36 31 2d 41 39 31 43 2d 33 31 34 43 46 30 42 34 39 45 35 } //01 00  $EDB44351-C76F-4E61-A91C-314CF0B49E5
