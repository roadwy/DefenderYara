...
rule Trojan_BAT_AgentTesla_JNE_MTB{
	...
	strings :
		...
		$a_01_1 = {39 30 61 63 63 38 65 64 2d 66 31 32 65 2d 34 32 32 32 2d 38 30 32 66 2d 63 32 62 30 35 61 36 35 33 35 63 61 } //01 00  90acc8ed-f12e-4222-802f-c2b05a6535ca
		$a_01_2 = {4f 70 65 6e 43 43 20 47 55 49 } //00 00  OpenCC GUI
	condition:
		any of ($a_*)
