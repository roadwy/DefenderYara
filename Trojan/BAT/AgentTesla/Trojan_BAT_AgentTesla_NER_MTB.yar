...
rule Trojan_BAT_AgentTesla_NER_MTB{
	...
	strings :
		...
		$a_01_2 = {4e 00 66 00 68 00 73 00 7a 00 6d 00 63 00 73 00 64 00 6b 00 } //01 00 
		$a_01_3 = {4b 00 44 00 45 00 20 00 53 00 6f 00 66 00 74 00 77 00 61 00 72 00 65 00 73 00 } //00 00 
	condition:
		any of ($a_*)
