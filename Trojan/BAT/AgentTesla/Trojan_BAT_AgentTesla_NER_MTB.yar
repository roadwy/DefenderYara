...
rule Trojan_BAT_AgentTesla_NER_MTB{
	...
	strings :
		$a_03_0 = {02 06 72 01 00 00 70 6f 90 01 01 00 00 0a 28 90 01 01 00 00 0a 6f 90 01 01 00 00 0a de 07 90 00 } //5
		$a_03_1 = {07 08 18 5b 02 08 18 6f 90 01 01 00 00 0a 1f 10 28 90 01 01 00 00 0a 9c 08 18 58 0c 08 06 32 e4 90 00 } //5
