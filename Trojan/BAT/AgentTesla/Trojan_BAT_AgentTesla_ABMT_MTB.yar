...
rule Trojan_BAT_AgentTesla_ABMT_MTB{
	...
	strings :
		$a_03_0 = {0a 0b de 03 26 de d4 90 0a 2b 00 28 90 01 03 06 0a 28 90 01 03 0a 06 6f 90 01 03 0a 72 90 01 03 70 7e 90 01 03 0a 6f 90 01 03 0a 28 90 01 03 0a 0b de 03 26 de d4 90 00 } //5
