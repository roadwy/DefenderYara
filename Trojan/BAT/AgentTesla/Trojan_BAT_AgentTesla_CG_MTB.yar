...
rule Trojan_BAT_AgentTesla_CG_MTB{
	meta:
		description = "Trojan:BAT/AgentTesla.CG!MTB,SIGNATURE_TYPE_PEHSTR_EXT,04 00 04 00 04 00 00 01 00 "
		
	strings :
		$a_01_0 = {03 07 03 07 91 02 04 07 04 8e b7 5d 91 04 04 07 04 8e b7 5d 91 04 8e b7 5d 91 6f } //01 00 
		$a_01_1 = {61 04 07 07 1d 5d d6 04 8e b7 5d 04 8e b7 5d 91 61 9c 07 17 d6 0b 07 08 31 } //01 00 
		$a_01_2 = {45 00 6e 00 63 00 72 00 79 00 70 00 74 00 69 00 6f 00 6e 00 4b 00 45 00 59 00 } //01 00  EncryptionKEY
		$a_01_3 = {58 6f 72 43 72 79 70 74 } //00 00  XorCrypt
	condition:
		any of ($a_*)
...
rule Trojan_BAT_AgentTesla_CG_MTB_2{
	meta:
		description = "Trojan:BAT/AgentTesla.CG!MTB,SIGNATURE_TYPE_PEHSTR_EXT,0c 00 0c 00 0c 00 00 01 00 "
		
	strings :
		$a_81_0 = {47 61 6d 65 42 61 63 6b 75 70 4d 61 6e 61 67 65 72 } //01 00  GameBackupManager
		...
		$a_81_7 = {47 65 74 44 6f 6d 61 69 6e } //01 00  GetDomain
