...
rule Trojan_BAT_AgentTesla_ABCV_MTB{
	...
	strings :
		$a_03_0 = {0a 13 04 11 04 09 16 09 8e 69 6f 90 01 03 0a de 0b 15 2c 07 11 04 6f 90 01 03 0a dc 07 6f 90 01 03 0a 13 07 de 38 90 0a 32 00 07 06 6f 90 01 03 0a 17 73 90 00 } //2
