...
rule Trojan_BAT_AgentTesla_GH_MTB_2{
	...
	strings :
		...
		$a_81_2 = {46 6f 72 6d 31 2e 72 65 73 6f 75 72 63 65 73 } //01 00 
		$a_81_3 = {46 6f 72 6d 32 2e 72 65 73 6f 75 72 63 65 73 } //01 00 
		$a_81_4 = {46 6f 72 6d 33 2e 72 65 73 6f 75 72 63 65 73 } //01 00 
		$a_03_5 = {46 6f 72 6d 90 01 01 5f 4c 6f 61 64 90 00 } //01 00 
		$a_81_6 = {67 65 74 5f 41 73 73 65 6d 62 6c 79 } //01 00 
		$a_81_7 = {67 65 74 5f 4c 65 6e 67 74 68 } //01 00 
		$a_81_8 = {52 65 70 6c 61 63 65 } //01 00 
		$a_81_9 = {43 6f 6e 76 65 72 74 } //00 00 
	condition:
		any of ($a_*)
