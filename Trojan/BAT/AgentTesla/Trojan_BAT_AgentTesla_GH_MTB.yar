...
rule Trojan_BAT_AgentTesla_GH_MTB{
	...
	strings :
		$a_02_0 = {ff 1f 6e 7e 90 01 03 04 1f 76 7e 90 01 03 04 1f 76 91 7e 90 01 03 04 1f 1c 91 61 1b 5f 9c 2a 90 00 } //1
		$a_02_1 = {ff 1f 4d 7e 90 01 03 04 1f 3b 7e 90 01 03 04 1f 3b 94 7e 90 01 03 04 20 90 01 03 00 94 5a 20 90 01 03 00 5f 9e 2a 90 00 } //1
	condition:
...
rule Trojan_BAT_AgentTesla_GH_MTB_2{
	...
	strings :
		$a_03_0 = {72 6f 7a 65 6e 62 61 79 6e 2e 46 6f 72 6d 90 01 01 2e 72 65 73 6f 75 72 63 65 73 90 00 } //1
		$a_03_1 = {70 72 6f 6a 65 74 6f 72 2e 46 6f 72 6d 90 01 01 2e 72 65 73 6f 75 72 63 65 73 90 00 } //1
		...
		$a_03_5 = {46 6f 72 6d 90 01 01 5f 4c 6f 61 64 90 00 } //1
