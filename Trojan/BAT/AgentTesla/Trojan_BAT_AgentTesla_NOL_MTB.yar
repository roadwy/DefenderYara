...
rule Trojan_BAT_AgentTesla_NOL_MTB{
	...
	strings :
		$a_01_0 = {24 66 65 63 38 65 66 62 33 2d 64 35 35 64 2d 34 31 30 34 2d 62 39 66 30 2d 30 61 65 62 62 66 33 34 31 33 33 61 } //01 00  $fec8efb3-d55d-4104-b9f0-0aebbf34133a
		$a_01_1 = {50 79 72 69 74 65 2e 50 72 6f 70 65 72 74 69 65 73 2e 52 65 73 6f 75 72 63 65 73 2e 72 65 73 6f 75 72 63 65 73 } //01 00  Pyrite.Properties.Resources.resources
