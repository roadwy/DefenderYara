...
rule Trojan_BAT_AgentTesla_NGE_MTB{
	...
	strings :
		$a_03_0 = {1f 10 8d 5b 00 00 01 13 14 11 09 28 90 01 02 00 0a 16 11 14 16 1a 28 90 01 02 00 0a 11 0a 28 90 01 02 00 0a 16 11 14 1a 1a 28 90 01 02 00 0a 11 0b 28 90 01 02 00 0a 16 11 14 1e 1a 28 90 01 02 00 0a 90 00 } //5
...
rule Trojan_BAT_AgentTesla_NGE_MTB_2{
	...
	strings :
		$a_03_0 = {73 95 00 00 0a 26 73 90 01 01 00 00 0a 26 08 28 90 01 01 00 00 0a 02 6f 90 01 01 00 00 0a 6f 90 01 01 00 00 0a 73 90 01 01 00 00 0a 26 73 90 01 01 00 00 0a 26 08 06 6f 90 01 01 00 00 0a 08 08 6f 90 01 01 00 00 0a 08 6f 90 01 01 00 00 0a 6f 90 01 01 00 00 0a 0d 73 90 01 01 00 00 0a 26 73 90 01 01 00 00 0a 26 73 90 01 01 00 00 0a 26 73 90 01 01 00 00 0a 26 07 73 90 01 01 00 00 0a 90 00 } //5
