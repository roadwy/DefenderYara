...
rule Trojan_BAT_AgentTesla_BHS_MTB{
	...
	strings :
		$a_02_0 = {11 06 02 11 06 91 08 61 07 11 07 91 61 b4 9c 11 07 03 28 90 01 03 06 17 da 90 00 } //10
		$a_02_1 = {02 02 8e 69 17 da 91 1f 70 61 0c 02 8e 69 17 d6 17 da 17 d6 8d 90 01 03 01 0d 02 8e 69 17 da 90 00 } //10
