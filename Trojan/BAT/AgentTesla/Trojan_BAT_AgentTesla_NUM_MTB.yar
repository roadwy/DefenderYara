...
rule Trojan_BAT_AgentTesla_NUM_MTB{
	...
	strings :
		...
		$a_01_1 = {52 00 75 00 65 00 75 00 61 00 75 00 72 00 73 00 6c 00 65 00 6e 00 66 00 7a 00 71 00 75 00 2e 00 42 00 70 00 6f 00 72 00 68 00 73 00 6a 00 62 00 6f 00 67 00 6e 00 67 00 72 00 71 00 } //00 00  Rueuaurslenfzqu.Bporhsjbogngrq
	condition:
		any of ($a_*)
