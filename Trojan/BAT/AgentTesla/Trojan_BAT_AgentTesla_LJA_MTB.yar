...
rule Trojan_BAT_AgentTesla_LJA_MTB_2{
	...
	strings :
		$a_01_0 = {23 66 73 64 66 73 64 2e 64 6c 6c 23 } //01 00 
		$a_01_1 = {23 68 64 66 66 66 77 74 77 66 66 66 66 66 66 66 67 73 73 73 73 73 64 66 2e 64 6c 6c 23 } //01 00 
		$a_01_2 = {23 67 74 74 74 74 74 74 77 64 73 23 } //01 00 
		$a_01_3 = {23 77 77 77 77 77 77 77 77 77 23 } //01 00 
		$a_01_4 = {23 66 66 66 73 77 74 66 2e 64 6c 6c 23 } //01 00 
...
rule Trojan_BAT_AgentTesla_LJA_MTB_3{
	...
	strings :
		...
		$a_81_1 = {3f 0e 30 00 30 00 33 00 36 00 30 00 30 00 33 00 32 00 30 00 30 00 33 00 38 00 30 00 30 00 33 00 32 00 30 00 30 00 33 00 37 00 30 00 30 00 33 00 30 00 30 00 30 00 33 00 34 00 30 00 30 00 33 00 34 00 30 00 30 00 33 00 } //01 00 
