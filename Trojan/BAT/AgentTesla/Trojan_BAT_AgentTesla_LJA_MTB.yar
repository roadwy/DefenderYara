...
rule Trojan_BAT_AgentTesla_LJA_MTB{
	...
	strings :
		$a_03_0 = {2b 2a 00 08 09 11 04 6f 90 01 03 0a 13 05 08 09 11 04 6f 90 01 03 0a 13 06 07 06 02 11 06 28 90 01 03 06 d2 9c 00 11 04 17 58 13 04 11 04 17 fe 04 13 07 11 07 2d cb 90 00 } //1
...
rule Trojan_BAT_AgentTesla_LJA_MTB_3{
	...
	strings :
		$a_03_0 = {06 07 02 07 18 5a 18 6f 90 01 03 0a 1f 10 28 90 01 03 0a 9c 00 07 17 58 0b 07 06 8e 69 fe 04 0d 09 2d dc 90 00 } //1
