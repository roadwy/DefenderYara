...
rule Trojan_BAT_AgentTesla_ENO_MTB{
	...
	strings :
		$a_03_0 = {08 11 07 06 11 07 91 7e 90 01 03 04 11 07 7e 90 01 03 04 6f 90 01 03 0a 5d 6f 90 01 03 0a 28 90 01 03 0a 28 90 01 03 0a 61 9c 11 07 17 d6 13 07 90 00 } //1
