...
rule Trojan_BAT_AgentTesla_PSBM_MTB{
	...
	strings :
		$a_03_0 = {7e be 00 00 04 14 fe 03 0d 09 2c 37 7e be 00 00 04 d0 08 00 00 1b 28 24 90 01 03 6f f3 90 01 03 13 04 11 04 2c 1b 20 cd b3 7d fb 28 d0 01 00 06 16 8d 7b 00 00 01 28 f4 90 01 03 73 f5 90 01 03 7a 2b 0a 73 f6 90 01 03 80 be 00 00 04 7e be 00 00 04 d0 08 00 00 1b 28 24 90 01 03 14 6f f7 90 01 03 28 01 00 00 2b 0b de 70 90 00 } //5
