...
rule Trojan_BAT_AgentTesla_LCC_MTB{
	...
	strings :
		$a_01_0 = {24 62 66 64 33 30 63 32 35 2d 66 66 63 33 2d 34 32 62 39 2d 38 63 65 38 2d 37 38 35 33 65 33 30 35 63 35 38 35 } //10 $bfd30c25-ffc3-42b9-8ce8-7853e305c585
		$a_01_1 = {24 64 36 35 65 38 34 33 62 2d 62 65 30 66 2d 34 65 33 64 2d 39 38 31 34 2d 66 66 36 61 30 30 61 32 30 31 30 30 } //10 $d65e843b-be0f-4e3d-9814-ff6a00a20100
