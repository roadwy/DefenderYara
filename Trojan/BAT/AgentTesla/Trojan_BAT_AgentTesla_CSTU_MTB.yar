...
rule Trojan_BAT_AgentTesla_CSTU_MTB{
	...
	strings :
		...
		$a_01_1 = {51 00 45 00 73 00 73 00 44 00 4a 00 5a 00 68 00 51 00 6e 00 4c 00 79 00 77 00 44 00 6e 00 4a 00 47 00 70 00 42 00 45 00 72 00 } //00 00  QEssDJZhQnLywDnJGpBEr
	condition:
		any of ($a_*)
