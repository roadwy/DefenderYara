...
rule Trojan_BAT_AgentTesla_NDE_MTB{
	...
	strings :
		$a_03_0 = {16 0b 2b 22 11 06 06 07 6f 90 01 03 0a 13 07 11 07 28 90 01 03 0a 13 08 11 04 11 08 d2 6f 90 01 03 0a 07 17 58 0b 07 17 fe 04 13 09 11 09 2d d4 09 90 00 } //1
