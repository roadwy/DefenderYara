...
rule Trojan_BAT_AgentTesla_EOX_MTB{
	...
	strings :
		$a_03_0 = {02 09 17 da 6f 90 01 03 0a 03 09 03 6f 90 01 03 0a 5d 6f 90 01 03 0a da 13 04 07 11 04 28 90 01 03 0a 28 90 01 03 0a 28 90 01 03 0a 0b 09 17 d6 0d 90 00 } //1
