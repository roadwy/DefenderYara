...
rule Trojan_BAT_AgentTesla_BK_MTB{
	...
	strings :
		$a_02_0 = {0a 0b 1e 8d 90 01 04 0c 07 28 90 01 04 72 90 01 04 6f 90 01 04 6f 90 01 04 16 08 16 1e 28 90 01 04 06 08 6f 90 01 04 06 18 6f 90 01 04 06 6f 90 01 04 03 16 03 8e 69 6f 90 00 } //10
