...
rule Trojan_BAT_AgentTesla_JED_MTB{
	...
	strings :
		$a_02_0 = {73 22 00 00 0a 0a 16 0b 2b 24 00 06 02 07 6f 90 01 03 0a 03 07 03 6f 90 01 03 0a 5d 6f 90 01 03 0a 61 d1 6f 90 01 03 0a 26 00 07 17 58 0b 07 02 6f 90 01 03 0a fe 04 0c 08 2d cf 06 6f 90 01 03 0a 0d 2b 00 09 2a 90 00 } //10
