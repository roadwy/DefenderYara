...
rule Trojan_BAT_AgentTesla_NZA_MTB_2{
	...
	strings :
		$a_01_0 = {24 62 36 35 34 65 65 62 33 2d 31 62 66 32 2d 34 30 62 38 2d 39 33 66 66 2d 35 32 36 36 65 37 63 34 32 36 30 30 } //0a 00  $b654eeb3-1bf2-40b8-93ff-5266e7c42600
		$a_01_1 = {24 61 30 30 63 32 66 64 61 2d 62 34 62 39 2d 34 34 62 31 2d 61 63 36 31 2d 35 62 62 39 63 39 38 34 37 61 65 30 } //01 00  $a00c2fda-b4b9-44b1-ac61-5bb9c9847ae0
		...
		$a_01_6 = {54 72 61 6e 73 66 6f 72 6d 42 6c 6f 63 6b } //00 00  TransformBlock
	condition:
		any of ($a_*)
