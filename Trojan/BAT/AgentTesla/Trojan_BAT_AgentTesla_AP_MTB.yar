...
rule Trojan_BAT_AgentTesla_AP_MTB_3{
	...
	strings :
		...
		$a_01_1 = {5c 00 4d 00 69 00 63 00 72 00 6f 00 73 00 6f 00 66 00 74 00 5c 00 45 00 64 00 67 00 65 00 46 00 73 00 73 00 5c 00 46 00 69 00 6c 00 65 00 53 00 79 00 6e 00 63 00 53 00 68 00 65 00 6c 00 6c 00 36 00 34 00 2e 00 64 00 61 00 74 00 } //01 00  \Microsoft\EdgeFss\FileSyncShell64.dat
