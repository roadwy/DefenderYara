...
rule Trojan_BAT_AgentTesla_CIN_MTB{
	meta:
		description = "Trojan:BAT/AgentTesla.CIN!MTB,SIGNATURE_TYPE_PEHSTR_EXT,07 00 07 00 07 00 00 01 00 "
		
	strings :
		$a_01_0 = {00 57 53 53 00 54 00 58 58 58 58 58 58 00 } //01 00  圀卓吀堀塘塘X
