...
rule Trojan_BAT_AgentTesla_MBGP_MTB{
	...
	strings :
		$a_03_0 = {01 25 16 1f 2c 9d 6f 90 01 01 01 00 0a 16 9a 73 90 01 01 01 00 0a 2a 90 00 } //1
...
rule Trojan_BAT_AgentTesla_MBGP_MTB_3{
	...
	strings :
		$a_03_0 = {11 07 11 06 11 21 9a 1f 10 28 90 01 01 00 00 0a b4 6f 90 01 01 00 00 0a 00 11 21 17 d6 13 21 11 21 11 20 31 df 90 00 } //1
