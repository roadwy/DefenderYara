...
rule Trojan_BAT_AgentTesla_CBD_MTB{
	...
	strings :
		$a_02_0 = {09 11 04 6f 90 01 03 0a 13 05 07 11 05 08 da 28 90 01 03 0a 28 90 01 03 0a 28 90 01 03 0a 0b 00 11 04 17 d6 13 04 11 04 09 6f 90 01 03 0a fe 04 13 06 11 06 2d ca 90 00 } //1
