...
rule Trojan_BAT_AgentTesla_LTL_MTB{
	...
	strings :
		$a_81_0 = {72 31 63 33 72 73 74 72 69 6d 2f 77 61 72 2f 74 65 6e 2e 6e 69 62 74 78 65 74 2f 2f 3a 73 70 74 74 68 } //01 00  r1c3rstrim/war/ten.nibtxet//:sptth
		...
		$a_81_5 = {47 65 74 4d 65 74 68 6f 64 73 } //00 00  GetMethods
	condition:
		any of ($a_*)
