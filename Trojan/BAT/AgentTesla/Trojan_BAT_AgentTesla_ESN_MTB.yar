...
rule Trojan_BAT_AgentTesla_ESN_MTB{
	...
	strings :
		...
		$a_03_1 = {2b 6e 02 09 28 90 01 03 06 1f 10 28 90 01 03 0a 28 90 01 03 0a 6f 90 01 03 0a 26 90 00 } //1
	condition:
...
rule Trojan_BAT_AgentTesla_ESN_MTB_2{
	...
	strings :
		$a_03_0 = {11 00 03 05 1f 16 5d 7e 90 01 03 04 28 90 01 03 06 61 13 01 90 00 } //1
		$a_03_1 = {03 02 20 00 22 00 00 04 7e 90 01 03 04 28 90 01 03 06 03 04 17 58 20 00 22 00 00 5d 90 00 } //1
