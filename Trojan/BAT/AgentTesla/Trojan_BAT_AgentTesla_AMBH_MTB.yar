...
rule Trojan_BAT_AgentTesla_AMBH_MTB{
	...
	strings :
		$a_03_0 = {0a 00 06 18 6f 90 01 01 00 00 0a 00 06 03 28 90 01 01 00 00 0a 6f 90 01 01 00 00 0a 00 06 6f 90 01 01 00 00 0a 0b 07 02 16 02 8e 69 6f 90 01 01 00 00 0a 0c 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
