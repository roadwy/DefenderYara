...
rule Trojan_BAT_AgentTesla_NME_MTB{
	...
	strings :
		$a_01_0 = {24 35 64 36 36 33 61 64 32 2d 64 36 65 32 2d 34 33 62 66 2d 61 34 62 61 2d 33 39 33 38 33 33 33 38 33 36 34 62 } //1 $5d663ad2-d6e2-43bf-a4ba-39383338364b
		$a_01_1 = {6f 0a 00 00 0a 0d 09 6f 37 00 00 0a 17 8d 09 00 00 01 25 16 1f 26 9d 6f 38 00 00 0a } //1
		$a_01_2 = {43 6c 6f 63 6b 74 6f 77 65 72 73 43 75 72 73 65 2e 50 72 6f 70 65 72 74 69 65 73 2e 52 65 73 6f 75 72 63 65 73 2e 72 65 73 6f 75 72 63 65 73 } //1 ClocktowersCurse.Properties.Resources.resources
