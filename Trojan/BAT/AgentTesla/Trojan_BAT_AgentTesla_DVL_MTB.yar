...
rule Trojan_BAT_AgentTesla_DVL_MTB{
	...
	strings :
		$a_03_0 = {06 02 08 18 6f 90 01 03 0a 1f 10 28 90 01 03 06 84 28 90 01 03 0a 28 90 01 03 06 26 90 00 } //1
		$a_03_1 = {08 11 04 02 11 04 91 07 61 06 09 91 61 28 90 01 03 06 9c 09 03 6f 90 01 03 0a 17 59 90 00 } //1
	condition:
