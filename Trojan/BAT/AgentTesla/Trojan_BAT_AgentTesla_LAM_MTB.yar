...
rule Trojan_BAT_AgentTesla_LAM_MTB{
	...
	strings :
		$a_03_0 = {08 09 9a 13 04 11 04 28 90 01 03 0a 23 90 01 07 40 59 28 90 01 03 0a b7 13 05 07 11 05 28 90 01 03 0a 28 90 01 03 0a 28 90 01 03 0a 0b 00 09 17 d6 0d 09 08 8e 69 fe 04 13 06 11 06 2d 90 00 } //1
