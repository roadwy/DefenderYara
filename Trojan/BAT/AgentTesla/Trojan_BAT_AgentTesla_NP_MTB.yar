...
rule Trojan_BAT_AgentTesla_NP_MTB{
	...
	strings :
		$a_03_0 = {11 00 0f 00 28 90 01 01 00 00 06 25 26 0f 01 28 90 01 01 00 00 06 25 26 d0 01 00 00 1b 28 90 01 01 00 00 0a 25 26 28 90 01 01 00 00 0a 25 26 a5 01 00 00 1b 0a 38 00 00 00 00 06 2a 90 00 } //1
...
rule Trojan_BAT_AgentTesla_NP_MTB_2{
	...
	strings :
		$a_03_0 = {70 0a 06 28 90 01 03 0a 25 26 0b 28 90 01 03 0a 25 26 07 16 07 8e 69 6f 90 01 03 0a 25 26 0a 09 20 90 01 03 5d 5a 20 90 01 03 3e 61 2b ad 90 00 } //10
