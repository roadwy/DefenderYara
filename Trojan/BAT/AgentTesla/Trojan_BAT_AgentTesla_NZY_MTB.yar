...
rule Trojan_BAT_AgentTesla_NZY_MTB{
	...
	strings :
		$a_01_0 = {54 56 71 51 24 24 24 24 4d 24 24 24 24 24 24 24 24 45 24 24 24 24 24 24 24 24 2f 2f 38 24 24 24 24 4c 67 24 24 24 24 24 24 24 24 24 24 24 24 24 24 24 24 24 24 51 24 24 24 } //00 00  TVqQ$$$$M$$$$$$$$E$$$$$$$$//8$$$$Lg$$$$$$$$$$$$$$$$$$Q$$$
	condition:
		any of ($a_*)
...
rule Trojan_BAT_AgentTesla_NZY_MTB_2{
	...
	strings :
		...
		$a_81_2 = {5c 54 65 6d 70 5c 79 33 69 68 6f 34 30 6d 2e 76 62 66 } //00 00  \Temp\y3iho40m.vbf
	condition:
		any of ($a_*)
