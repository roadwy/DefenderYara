...
rule Trojan_BAT_AgentTesla_LNO_MTB{
	...
	strings :
		...
		$a_01_1 = {24 37 36 33 65 34 33 34 37 2d 34 39 31 64 2d 34 37 66 34 2d 38 30 61 37 2d 34 33 65 31 37 64 63 65 36 63 65 65 } //01 00 
		$a_01_2 = {53 65 6c 66 20 43 61 6d } //01 00 
