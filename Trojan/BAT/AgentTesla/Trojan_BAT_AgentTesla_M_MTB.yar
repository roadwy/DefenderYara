...
rule Trojan_BAT_AgentTesla_M_MTB_3{
	...
	strings :
		...
		$a_81_1 = {5a 6c 61 66 6d } //03 00  Zlafm
		$a_81_2 = {67 65 74 5f 43 75 72 72 65 6e 74 44 6f 6d 61 69 6e } //03 00  get_CurrentDomain
		$a_81_3 = {67 65 74 5f 46 75 6c 6c 4e 61 6d 65 } //03 00  get_FullName
		$a_81_4 = {47 65 74 44 6f 6d 61 69 6e } //00 00  GetDomain
	condition:
		any of ($a_*)
...
rule Trojan_BAT_AgentTesla_M_MTB_4{
	...
	strings :
		...
		$a_81_1 = {41 70 70 6c 69 63 61 74 69 6f 6e 53 65 74 74 69 6e 67 73 42 61 73 65 } //03 00  ApplicationSettingsBase
		$a_81_2 = {53 6d 61 72 74 41 73 73 65 6d 62 6c 79 2e 41 74 74 72 69 62 75 74 65 73 } //03 00  SmartAssembly.Attributes
		...
		$a_81_4 = {73 65 74 5f 53 65 63 75 72 69 74 79 50 72 6f 74 6f 63 6f 6c } //03 00  set_SecurityProtocol
		$a_81_5 = {53 65 63 75 72 69 74 79 50 72 6f 74 6f 63 6f 6c 54 79 70 65 } //03 00  SecurityProtocolType
		$a_81_6 = {53 74 6f 70 77 61 74 63 68 } //03 00  Stopwatch
		$a_81_7 = {57 65 62 52 65 71 75 65 73 74 } //00 00  WebRequest
	condition:
		any of ($a_*)
