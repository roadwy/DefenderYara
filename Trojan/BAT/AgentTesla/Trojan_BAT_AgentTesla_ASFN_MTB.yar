...
rule Trojan_BAT_AgentTesla_ASFN_MTB{
	...
	strings :
		$a_03_0 = {0a 00 0a 02 73 90 01 01 00 00 0a 7d 90 01 01 00 00 04 06 28 90 01 01 00 00 0a 00 72 90 01 01 00 00 70 28 90 01 01 00 00 0a 00 28 90 01 01 00 00 0a 0b 07 2c 15 90 00 } //1
