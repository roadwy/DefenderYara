...
rule Trojan_BAT_AgentTesla_BDT_MTB{
	...
	strings :
		$a_02_0 = {01 25 16 02 28 90 01 03 06 a2 28 90 01 03 06 74 90 01 03 01 13 90 01 01 16 7e 90 01 03 04 90 01 05 26 1b 90 01 05 09 6f 90 01 03 0a 08 20 00 01 00 00 14 09 90 00 } //10
