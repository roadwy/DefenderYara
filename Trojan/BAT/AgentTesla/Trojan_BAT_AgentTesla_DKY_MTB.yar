...
rule Trojan_BAT_AgentTesla_DKY_MTB{
	...
	strings :
		$a_03_0 = {16 13 05 2b 2c 00 09 11 04 11 05 6f ?? ?? ?? 0a 13 06 09 11 04 11 05 6f ?? ?? ?? 0a 13 07 08 07 02 11 07 28 ?? ?? ?? 06 d2 9c 00 11 05 17 58 13 05 11 05 17 fe 04 13 08 11 08 2d c9 07 17 58 0b } //1
