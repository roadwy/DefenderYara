...
rule Trojan_BAT_AgentTesla_NRM_MTB{
	...
	strings :
		$a_01_0 = {30 38 62 32 35 63 36 32 2d 34 30 38 61 2d 34 64 65 34 2d 38 65 63 36 2d 37 34 31 39 65 30 38 33 65 64 39 33 } //01 00 
		$a_01_1 = {76 62 53 74 72 69 70 65 2e 52 65 73 6f 75 72 63 65 73 2e 72 65 73 6f 75 72 63 65 73 } //01 00 
