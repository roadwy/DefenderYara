...
rule Trojan_BAT_AgentTesla_PSBO_MTB{
	meta:
		description = "Trojan:BAT/AgentTesla.PSBO!MTB,SIGNATURE_TYPE_PEHSTR_EXT,09 00 09 00 05 00 00 05 00 "
		
	strings :
		$a_01_0 = {02 6f 1c 01 00 0a 13 09 38 05 01 00 00 12 09 28 1d 01 00 0a 13 05 11 04 2c 25 08 7e 43 00 00 04 28 bb 02 00 06 6f 77 00 00 0a 16 7e 43 00 00 04 28 bb 02 00 06 6f 1e 01 00 0a 6f 96 00 00 0a 17 13 04 12 05 28 1f 01 00 0a } //01 00 
