...
rule Trojan_BAT_AgentTesla_AMAM_MTB{
	...
	strings :
		$a_03_0 = {09 1b 62 11 09 60 0d 11 04 1b d6 13 04 11 04 1e fe 04 16 fe 01 13 0c 11 0c 2c 1f 11 05 09 11 04 1e da 1f 1f 5f 63 20 90 01 01 00 00 00 5f b4 6f 90 01 01 00 00 0a 00 11 04 1e da 13 04 00 00 00 11 07 17 d6 13 07 11 07 11 06 6f 90 01 01 00 00 0a fe 04 13 0d 11 0d 3a 90 00 } //4
