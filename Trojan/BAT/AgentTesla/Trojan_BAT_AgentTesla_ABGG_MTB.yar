...
rule Trojan_BAT_AgentTesla_ABGG_MTB{
	...
	strings :
		$a_03_0 = {07 11 06 72 90 01 03 70 28 90 01 03 0a 72 90 01 03 70 20 90 01 03 00 14 14 18 8d 90 01 03 01 25 16 06 11 06 9a a2 25 17 1f 10 8c 90 01 03 01 a2 6f 90 01 03 0a a5 90 01 03 01 9c 11 06 17 58 13 06 11 06 06 8e 69 fe 04 13 07 11 07 2d b2 90 00 } //3
