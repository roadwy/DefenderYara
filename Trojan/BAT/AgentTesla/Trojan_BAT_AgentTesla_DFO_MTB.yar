...
rule Trojan_BAT_AgentTesla_DFO_MTB{
	...
	strings :
		$a_01_0 = {24 66 66 62 66 35 30 65 30 2d 66 36 61 63 2d 34 37 61 30 2d 38 32 63 37 2d 32 61 35 37 63 35 36 65 30 34 39 37 } //01 00 
		...
		$a_01_5 = {47 65 74 43 61 6c 6c 69 6e 67 41 73 73 65 6d 62 6c 79 } //01 00 
