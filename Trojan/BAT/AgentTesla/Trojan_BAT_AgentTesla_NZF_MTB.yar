...
rule Trojan_BAT_AgentTesla_NZF_MTB{
	...
	strings :
		...
		$a_81_1 = {31 38 35 2e 32 34 36 2e 32 32 30 2e 36 35 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_BAT_AgentTesla_NZF_MTB_3{
	...
	strings :
		...
		$a_01_1 = {43 72 79 70 74 6f 53 74 72 65 61 6d } //01 00 
		$a_01_2 = {43 72 65 61 74 65 44 65 63 72 79 70 74 6f 72 } //01 00 
		$a_01_3 = {4e 74 57 72 69 74 65 56 69 72 74 75 61 6c 4d 65 6d 6f 72 79 } //01 00 
