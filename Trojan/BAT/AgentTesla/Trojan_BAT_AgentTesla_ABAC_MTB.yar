...
rule Trojan_BAT_AgentTesla_ABAC_MTB{
	...
	strings :
		$a_03_0 = {07 02 8e 69 6f 90 01 03 0a 8d 90 01 03 01 0d 07 02 16 02 8e 69 09 16 6f 90 01 03 0a 13 04 07 09 11 04 6f 90 01 03 0a 26 28 90 01 03 0a 09 6f 90 01 03 0a 72 90 01 03 70 28 90 01 03 0a 6f 90 01 03 0a 13 05 de 0b 90 00 } //1
