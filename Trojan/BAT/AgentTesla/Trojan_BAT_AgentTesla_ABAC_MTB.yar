...
rule Trojan_BAT_AgentTesla_ABAC_MTB{
	...
	strings :
		...
		$a_01_1 = {47 63 6d 42 6c 6f 63 6b 43 69 70 68 65 72 } //01 00 
		$a_01_2 = {4d 00 41 00 58 00 43 00 41 00 52 00 45 00 2e 00 50 00 72 00 6f 00 70 00 65 00 72 00 74 00 69 00 65 00 73 00 2e 00 52 00 65 00 73 00 6f 00 75 00 72 00 63 00 65 00 73 00 } //00 00 
	condition:
		any of ($a_*)
