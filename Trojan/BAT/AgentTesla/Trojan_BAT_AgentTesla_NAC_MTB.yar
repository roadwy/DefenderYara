...
rule Trojan_BAT_AgentTesla_NAC_MTB{
	...
	strings :
		$a_03_0 = {0a 0c 07 08 6f 90 01 03 0a 07 18 6f 90 01 03 0a 07 6f 90 01 03 0a 02 16 02 8e 69 6f 90 01 03 0a 0d dd 90 00 } //1
...
rule Trojan_BAT_AgentTesla_NAC_MTB_2{
	...
	strings :
		$a_03_0 = {6f 17 00 00 0a 25 17 6f 90 01 01 00 00 0a 13 06 73 90 01 01 00 00 0a 25 11 06 6f 90 01 01 00 00 0a 25 6f 90 01 01 00 00 0a 26 25 90 00 } //5
