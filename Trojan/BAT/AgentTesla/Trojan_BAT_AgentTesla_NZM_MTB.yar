...
rule Trojan_BAT_AgentTesla_NZM_MTB{
	...
	strings :
		...
		$a_01_1 = {39 63 38 64 37 63 66 65 65 65 64 61 } //00 00  9c8d7cfeeeda
	condition:
		any of ($a_*)
...
rule Trojan_BAT_AgentTesla_NZM_MTB_2{
	...
	strings :
		$a_01_0 = {50 00 69 00 65 00 73 00 2e 00 57 00 68 00 69 00 74 00 65 00 } //01 00  Pies.White
...
rule Trojan_BAT_AgentTesla_NZM_MTB_3{
	...
	strings :
		$a_01_0 = {24 64 39 63 32 30 66 38 30 2d 38 31 38 61 2d 34 61 30 35 2d 62 63 62 36 2d 63 37 39 36 61 62 32 38 36 34 30 39 } //01 00  $d9c20f80-818a-4a05-bcb6-c796ab286409
