...
rule Trojan_BAT_AgentTesla_BKB_MTB{
	...
	strings :
		...
		$a_02_1 = {02 02 8e 69 17 da 91 1f 70 61 0c 02 8e 69 17 d6 17 da 17 d6 8d 90 01 03 01 0d 16 28 90 00 } //1
		$a_02_2 = {07 02 09 18 6f 90 01 03 0a 1f 10 28 90 01 03 06 84 28 90 01 03 0a 28 90 01 03 06 26 90 00 } //1
	condition:
