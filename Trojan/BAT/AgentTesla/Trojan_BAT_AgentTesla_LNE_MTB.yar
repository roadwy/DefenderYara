...
rule Trojan_BAT_AgentTesla_LNE_MTB{
	...
	strings :
		...
		$a_01_3 = {54 72 69 70 6c 65 44 45 53 43 72 79 70 74 6f 53 65 72 76 69 63 65 50 72 6f 76 69 64 65 72 } //01 00  TripleDESCryptoServiceProvider
		$a_81_4 = {78 61 6d 70 6c 65 } //01 00  xample
		...
		$a_01_8 = {47 65 74 4d 65 74 68 6f 64 73 } //01 00  GetMethods
