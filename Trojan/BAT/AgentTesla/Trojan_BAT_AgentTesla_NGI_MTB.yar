...
rule Trojan_BAT_AgentTesla_NGI_MTB{
	...
	strings :
		$a_81_0 = {69 6e 74 65 67 72 61 6c 62 64 2e 63 6f 6d 2f 69 6e 71 75 69 72 79 2d 63 69 6d 2e 6a 70 67 } //01 00  integralbd.com/inquiry-cim.jpg
		$a_81_1 = {5a 74 6d 62 44 6f 77 5a 74 6d 62 6e 6c 5a 74 6d 62 6f 61 64 44 5a 74 6d 62 61 74 61 5a 74 6d 62 } //01 00  ZtmbDowZtmbnlZtmboadDZtmbataZtmb
