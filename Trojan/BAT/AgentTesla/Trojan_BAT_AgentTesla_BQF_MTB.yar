...
rule Trojan_BAT_AgentTesla_BQF_MTB{
	...
	strings :
		$a_02_0 = {06 20 00 01 00 00 6f 90 01 03 0a 00 06 20 80 00 00 00 6f 90 01 03 0a 00 7e 90 01 03 04 7e 90 01 03 04 20 e8 03 00 00 73 90 01 03 0a 0b 06 07 06 6f 90 01 03 0a 1e 5b 6f 90 01 03 0a 6f 90 01 03 0a 00 06 07 06 6f 90 01 03 0a 1e 5b 6f 90 01 03 0a 6f 90 01 03 0a 00 06 17 6f 90 00 } //10
