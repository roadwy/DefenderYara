...
rule Trojan_BAT_AgentTesla_NVE_MTB_2{
	...
	strings :
		$a_03_0 = {6f 38 00 00 0a 25 26 26 11 0a 11 0d 16 06 6f 90 01 03 0a 25 26 11 0e 6a 59 69 6f 90 01 03 0a 25 26 13 10 7e 90 01 03 04 11 10 16 11 10 28 90 01 03 06 25 26 69 6f 90 01 03 0a 90 00 } //5
