...
rule Trojan_BAT_AgentTesla_NHP_MTB{
	...
	strings :
		$a_01_0 = {24 61 35 34 63 61 61 36 65 2d 39 32 65 34 2d 34 30 65 64 2d 38 31 35 61 2d 33 32 30 37 34 31 30 39 32 33 36 65 } //32 00  $a54caa6e-92e4-40ed-815a-32074109236e
		$a_01_1 = {24 43 34 41 37 32 36 30 37 2d 46 45 46 36 2d 34 39 45 37 2d 42 32 36 37 2d 30 45 44 45 38 36 39 39 43 43 45 46 } //14 00  $C4A72607-FEF6-49E7-B267-0EDE8699CCEF
		$a_01_2 = {46 72 65 73 68 46 6f 6f 64 45 78 70 72 65 73 73 2e 52 65 73 6f 75 72 63 65 73 } //14 00  FreshFoodExpress.Resources
		...
		$a_01_9 = {44 65 62 75 67 67 65 72 42 72 6f 77 73 61 62 6c 65 53 74 61 74 65 } //00 00  DebuggerBrowsableState
	condition:
		any of ($a_*)
