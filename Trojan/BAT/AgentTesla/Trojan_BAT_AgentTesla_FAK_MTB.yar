...
rule Trojan_BAT_AgentTesla_FAK_MTB{
	...
	strings :
		$a_03_0 = {da 13 08 16 13 09 2b 1f 11 04 09 11 09 18 6f 90 01 01 00 00 0a 1f 10 28 90 01 01 00 00 0a b4 6f 90 01 01 00 00 0a 00 11 09 18 d6 13 09 11 09 11 08 31 db 90 00 } //3
