...
rule Trojan_BAT_AgentTesla_ABPX_MTB{
	...
	strings :
		$a_03_0 = {0a 0b 02 8e 69 17 da 0c 16 0d 2b 37 09 1c 5d 16 fe 01 13 04 11 04 2c 16 07 02 09 9a 28 ?? ?? ?? 0a 1c 6a 61 b4 6f ?? ?? ?? 0a 00 00 2b 11 00 07 02 09 9a 28 ?? ?? ?? 0a 6f ?? ?? ?? 0a 00 00 09 17 d6 0d 09 08 31 c5 07 6f ?? ?? ?? 0a 0a 2b 00 06 2a } //4
