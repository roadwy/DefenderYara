...
rule Trojan_BAT_AgentTesla_DY_MTB{
	meta:
		description = "Trojan:BAT/AgentTesla.DY!MTB,SIGNATURE_TYPE_PEHSTR_EXT,17 00 17 00 0d 00 00 14 00 "
		
	strings :
		$a_81_0 = {24 32 62 31 63 39 37 37 36 2d 30 38 61 62 2d 34 39 64 65 2d 39 37 33 65 2d 32 38 33 64 65 63 61 39 34 61 31 64 } //14 00  $2b1c9776-08ab-49de-973e-283deca94a1d
		$a_81_1 = {24 30 65 32 33 66 30 62 37 2d 61 65 65 31 2d 34 36 30 31 2d 61 64 31 38 2d 31 36 30 38 32 62 38 37 31 61 32 35 } //01 00  $0e23f0b7-aee1-4601-ad18-16082b871a25
		$a_81_2 = {6a 6f 62 2e 50 72 6f 70 65 72 74 69 65 73 2e 52 65 73 6f 75 72 63 65 73 } //01 00  job.Properties.Resources
		$a_81_3 = {52 6f 63 6b 65 74 5f 4d 69 73 73 69 6f 6e 2e 50 72 6f 70 65 72 74 69 65 73 2e 52 65 73 6f 75 72 63 65 73 } //01 00  Rocket_Mission.Properties.Resources
		$a_81_4 = {4d 6f 64 75 6c 65 52 65 73 6f 6c 76 65 45 76 65 6e 74 48 61 6e 64 6c 65 72 } //01 00  ModuleResolveEventHandler
