...
rule Trojan_BAT_AgentTesla_CWA_MTB{
	...
	strings :
		$a_03_0 = {03 08 03 8e 69 5d 03 08 03 8e 69 5d 91 07 08 07 8e 69 5d 91 61 28 90 01 03 0a 03 08 17 58 03 8e 69 5d 91 59 20 00 01 00 00 58 20 00 01 00 00 5d d2 9c 08 17 58 16 90 00 } //1
