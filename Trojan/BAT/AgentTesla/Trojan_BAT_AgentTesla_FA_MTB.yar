...
rule Trojan_BAT_AgentTesla_FA_MTB{
	...
	strings :
		...
		$a_81_3 = {41 45 53 5f 44 65 63 72 79 70 74 } //00 00  AES_Decrypt
	condition:
		any of ($a_*)
...
rule Trojan_BAT_AgentTesla_FA_MTB_2{
	...
	strings :
		$a_81_0 = {24 30 30 34 35 32 61 39 34 2d 35 39 37 61 2d 34 38 38 62 2d 39 31 36 36 2d 35 66 64 63 64 63 30 64 61 61 66 63 } //14 00  $00452a94-597a-488b-9166-5fdcdc0daafc
		$a_81_1 = {24 39 38 37 62 34 35 61 36 2d 61 65 64 35 2d 34 66 38 66 2d 62 37 38 34 2d 36 62 30 61 64 38 35 62 65 62 62 63 } //01 00  $987b45a6-aed5-4f8f-b784-6b0ad85bebbc
		...
		$a_81_3 = {4c 69 67 68 74 57 61 74 63 68 2e 4d 79 2e 52 65 73 6f 75 72 63 65 73 } //01 00  LightWatch.My.Resources
		$a_81_4 = {44 65 62 75 67 67 65 72 42 72 6f 77 73 61 62 6c 65 41 74 74 72 69 62 75 74 65 } //01 00  DebuggerBrowsableAttribute
		$a_81_5 = {46 6f 72 67 65 2e 54 65 6d 70 6c 61 74 69 6e 67 2e 4d 79 2e 52 65 73 6f 75 72 63 65 73 } //01 00  Forge.Templating.My.Resources
