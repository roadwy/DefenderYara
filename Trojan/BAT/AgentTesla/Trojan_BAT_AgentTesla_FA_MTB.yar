...
rule Trojan_BAT_AgentTesla_FA_MTB{
	...
	strings :
		$a_02_0 = {06 07 16 20 00 10 00 00 6f 90 01 03 0a 0d 09 16 fe 02 13 04 11 04 2c 0c 00 08 07 16 09 6f 90 01 03 0a 90 01 03 09 16 fe 02 13 05 11 05 2d d0 08 6f 90 01 03 0a 13 06 de 16 08 2c 07 08 6f 90 01 03 0a 00 dc 90 00 } //10
