...
rule Trojan_BAT_AgentTesla_MBCH_MTB{
	...
	strings :
		$a_03_0 = {09 11 05 08 11 05 9a 1f 10 28 ?? ?? ?? 0a 9c 00 11 05 17 58 13 05 11 05 08 8e 69 fe 04 13 06 11 06 2d dc } //1
		$a_03_1 = {72 66 11 00 70 72 6a 11 00 70 6f ?? ?? ?? 0a 0b 07 72 6e 11 00 70 72 72 11 00 70 } //1
	condition:
...
rule Trojan_BAT_AgentTesla_MBCH_MTB_2{
	...
	strings :
		$a_03_0 = {08 11 04 9a 13 08 09 11 08 1f 10 28 ?? ?? ?? 0a b4 6f ?? ?? ?? 0a 00 11 04 17 d6 13 04 00 11 04 08 8e 69 fe 04 13 09 } //1
