...
rule Trojan_BAT_AgentTesla_AA_MTB{
	meta:
		description = "Trojan:BAT/AgentTesla.AA!MTB,SIGNATURE_TYPE_PEHSTR_EXT,01 00 01 00 01 00 00 01 00 "
		
	strings :
		$a_02_0 = {01 25 16 7e 90 01 03 04 a2 25 17 28 90 01 03 06 a2 25 18 72 90 01 03 70 a2 0a 08 20 90 01 04 5a 20 90 00 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_BAT_AgentTesla_AA_MTB_2{
	meta:
		description = "Trojan:BAT/AgentTesla.AA!MTB,SIGNATURE_TYPE_PEHSTR_EXT,02 00 02 00 01 00 00 02 00 "
		
	strings :
		$a_01_0 = {73 10 00 00 06 0a 06 03 7d 0a 00 00 04 00 02 06 fe 06 11 00 00 06 73 19 00 00 0a 28 06 00 00 2b 28 07 00 00 2b 0b 2b 00 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_BAT_AgentTesla_AA_MTB_3{
	meta:
		description = "Trojan:BAT/AgentTesla.AA!MTB,SIGNATURE_TYPE_PEHSTR_EXT,03 00 03 00 02 00 00 02 00 "
