...
rule Trojan_BAT_AgentTesla_NJS_MTB{
	...
	strings :
		...
		$a_01_1 = {24 65 36 34 35 65 35 37 34 2d 38 36 37 32 2d 34 36 66 30 2d 62 64 38 34 2d 39 37 38 32 62 31 65 39 32 64 33 38 } //01 00  $e645e574-8672-46f0-bd84-9782b1e92d38
		...
		$a_81_3 = {53 46 56 51 53 30 39 4e 54 6b 78 43 57 53 55 3d } //01 00  SFVQS09NTkxCWSU=
