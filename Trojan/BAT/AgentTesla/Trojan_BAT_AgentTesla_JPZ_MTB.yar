...
rule Trojan_BAT_AgentTesla_JPZ_MTB{
	...
	strings :
		...
		$a_01_1 = {24 38 35 36 63 36 37 36 38 2d 34 61 33 38 2d 34 38 34 36 2d 38 66 62 34 2d 39 34 65 31 62 65 63 65 65 31 64 38 } //01 00 
		$a_81_2 = {43 6f 6e 73 6f 6c 65 47 61 6d 65 43 6f 6c 6c 65 63 74 69 6f 6e } //01 00 
