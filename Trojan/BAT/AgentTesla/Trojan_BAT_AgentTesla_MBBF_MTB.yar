...
rule Trojan_BAT_AgentTesla_MBBF_MTB{
	...
	strings :
		$a_01_0 = {24 61 62 62 31 36 65 31 35 2d 66 39 64 66 2d 34 34 37 30 2d 62 38 64 62 2d 32 35 63 33 62 34 30 36 39 35 38 33 } //01 00 
		$a_81_1 = {44 6f 64 67 65 } //01 00 
		$a_81_2 = {47 65 74 4d 65 74 68 6f 64 } //01 00 
		$a_81_3 = {53 70 6c 69 74 } //01 00 
