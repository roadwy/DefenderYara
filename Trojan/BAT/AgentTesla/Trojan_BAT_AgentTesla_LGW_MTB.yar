...
rule Trojan_BAT_AgentTesla_LGW_MTB{
	...
	strings :
		$a_01_0 = {24 64 62 36 39 35 32 34 63 2d 63 34 64 66 2d 34 34 66 31 2d 39 33 31 38 2d 33 65 30 32 32 61 34 36 32 66 34 32 } //01 00 
		...
		$a_01_6 = {43 6f 6c 6f 72 54 72 61 6e 73 6c 61 74 6f 72 } //00 00 
	condition:
		any of ($a_*)
