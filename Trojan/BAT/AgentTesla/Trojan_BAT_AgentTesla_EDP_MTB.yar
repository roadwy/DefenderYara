...
rule Trojan_BAT_AgentTesla_EDP_MTB{
	...
	strings :
		$a_02_0 = {2b 1f 0a 2b fb 20 e7 03 00 00 90 01 01 2d 0a 26 06 17 59 90 01 01 2d 0a 26 2b 0a 28 17 00 00 0a 2b f0 0a 2b 00 06 16 fe 03 0c 08 2d dc 90 00 } //10
