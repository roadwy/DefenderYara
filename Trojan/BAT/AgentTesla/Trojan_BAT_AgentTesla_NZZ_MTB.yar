...
rule Trojan_BAT_AgentTesla_NZZ_MTB_2{
	...
	strings :
		$a_03_0 = {11 00 0f 00 28 02 00 00 06 90 02 09 d0 01 00 00 1b 28 14 00 00 0a 25 26 28 15 00 00 0a 25 26 a5 01 00 00 1b 0a 2b 00 06 2a 90 00 } //1
		$a_03_1 = {11 00 0f 00 28 90 02 13 d0 01 00 00 1b 28 90 01 01 00 00 0a 28 90 01 01 00 00 0a 25 26 a5 01 00 00 1b 0a 2b 00 06 2a 90 00 } //1
