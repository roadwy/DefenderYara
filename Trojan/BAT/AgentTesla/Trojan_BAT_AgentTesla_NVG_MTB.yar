...
rule Trojan_BAT_AgentTesla_NVG_MTB{
	...
	strings :
		$a_01_0 = {24 62 63 35 38 35 30 64 63 2d 38 64 30 35 2d 34 66 64 38 2d 39 32 66 66 2d 36 32 64 65 30 64 66 62 38 34 36 36 } //10 $bc5850dc-8d05-4fd8-92ff-62de0dfb8466
		$a_01_1 = {24 31 30 37 37 37 66 64 34 2d 63 34 30 61 2d 34 64 33 65 2d 39 63 65 36 2d 62 64 38 65 38 31 33 39 65 32 35 34 } //10 $10777fd4-c40a-4d3e-9ce6-bd8e8139e254
