...
rule Trojan_BAT_AgentTesla_JNX_MTB{
	...
	strings :
		...
		$a_01_1 = {24 37 36 39 62 37 35 33 63 2d 34 33 36 65 2d 34 35 38 38 2d 61 36 61 38 2d 38 39 65 61 36 61 63 30 34 61 36 65 } //00 00  $769b753c-436e-4588-a6a8-89ea6ac04a6e
	condition:
		any of ($a_*)
