...
rule Trojan_BAT_AgentTesla_DZD_MTB{
	...
	strings :
		$a_81_0 = {24 35 30 39 66 62 65 38 33 2d 37 65 64 35 2d 34 39 30 36 2d 38 36 39 34 2d 37 66 35 65 39 39 38 32 34 39 36 38 } //01 00  $509fbe83-7ed5-4906-8694-7f5e99824968
