...
rule Trojan_BAT_AgentTesla_CEI_MTB{
	...
	strings :
		$a_00_0 = {c1 00 c3 00 de 00 be 00 ae 00 ae 00 ba 00 ae 00 ae 00 ae 00 ae 00 b2 00 ae 00 ae 00 ae 00 ae 00 } //1
		$a_00_1 = {e2 00 d4 00 a1 00 ae 00 e1 00 ae 00 db 00 bb 00 b6 00 cf 00 d4 00 af 00 c1 00 ba 00 9d 00 d5 00 c3 00 b4 00 d5 00 dd 00 d0 00 e6 00 af 00 e4 00 d0 00 da 00 a6 00 db } //1
