...
rule Trojan_BAT_AgentTesla_EXQ_MTB{
	meta:
		description = "Trojan:BAT/AgentTesla.EXQ!MTB,SIGNATURE_TYPE_PEHSTR_EXT,0e 00 0e 00 05 00 00 0a 00 "
		
	strings :
		$a_81_0 = {48 38 43 38 51 35 38 35 34 43 52 47 48 48 35 34 34 35 47 51 38 47 } //01 00 
