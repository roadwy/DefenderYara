...
rule Trojan_BAT_AgentTesla_ASCM_MTB{
	...
	strings :
		...
		$a_03_1 = {20 e8 03 00 00 5a 28 90 01 01 00 00 0a 7e 90 01 01 00 00 04 08 28 90 01 01 00 00 06 0b 06 17 58 0a 07 17 8d 90 01 01 00 00 01 25 16 1f 20 9d 6f 90 01 01 00 00 0a 0d 7e 90 00 } //1
	condition:
