...
rule Trojan_BAT_AgentTesla_BAM_MTB_2{
	...
	strings :
		$a_81_0 = {2e 72 65 73 6f 75 72 63 65 73 } //01 00  .resources
		$a_81_1 = {47 65 74 4d 65 74 68 6f 64 00 49 6e 76 6f 6b 65 } //01 00  敇䵴瑥潨d湉潶敫
		...
		$a_81_9 = {4d 44 35 43 72 79 70 74 6f 53 65 72 76 69 63 65 50 72 6f 76 69 64 65 72 } //00 00  MD5CryptoServiceProvider
	condition:
		any of ($a_*)
