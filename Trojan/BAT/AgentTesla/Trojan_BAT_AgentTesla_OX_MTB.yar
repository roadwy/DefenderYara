...
rule Trojan_BAT_AgentTesla_OX_MTB{
	...
	strings :
		$a_02_0 = {11 05 16 9a 28 90 02 04 d0 90 02 04 28 90 02 04 28 90 02 04 74 90 02 07 28 90 02 07 72 90 02 04 17 8d 90 02 07 8c 90 02 04 a2 14 14 28 90 02 04 09 17 da 17 d6 8d 90 02 04 13 04 07 14 72 90 02 04 19 90 00 } //1
	condition:
		((#a_02_0  & 1)*1) >=1
...
rule Trojan_BAT_AgentTesla_OX_MTB_2{
	...
	strings :
		...
		$a_02_7 = {68 00 74 00 74 00 70 00 3a 00 2f 00 2f 00 74 00 65 00 6d 00 70 00 75 00 72 00 69 00 2e 00 6f 00 72 00 67 00 2f 00 90 02 25 2e 00 78 00 73 00 64 00 90 00 } //2
	condition:
