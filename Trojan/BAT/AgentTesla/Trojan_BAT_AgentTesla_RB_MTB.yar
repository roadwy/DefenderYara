...
rule Trojan_BAT_AgentTesla_RB_MTB_2{
	...
	strings :
		$a_03_0 = {11 05 17 da 06 1e d8 b4 9c 1e 13 0a 38 90 01 04 11 05 1e fe 02 13 07 11 07 2c 08 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_BAT_AgentTesla_RB_MTB_3{
	...
	strings :
		$a_03_0 = {03 08 03 8e 69 5d 03 08 03 8e 69 5d 91 07 08 07 8e 69 5d 91 61 28 90 01 01 00 00 0a 03 08 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_BAT_AgentTesla_RB_MTB_4{
	...
	strings :
		$a_03_0 = {02 08 02 8e 69 5d 02 08 02 8e 69 5d 91 07 08 07 8e 69 5d 91 61 28 90 01 03 0a 02 08 1e 58 1d 59 02 8e 69 5d 91 59 20 90 01 03 00 58 18 58 20 90 01 03 00 5d d2 9c 08 16 2d 02 17 58 90 00 } //5
