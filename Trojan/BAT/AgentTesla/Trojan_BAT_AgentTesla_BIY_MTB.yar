...
rule Trojan_BAT_AgentTesla_BIY_MTB{
	...
	strings :
		$a_81_0 = {36 62 34 35 35 39 31 34 2d 62 36 62 33 2d 34 32 35 65 2d 62 32 32 30 2d 37 37 33 66 61 30 34 36 39 32 62 38 } //0a 00  6b455914-b6b3-425e-b220-773fa04692b8
		$a_81_1 = {37 66 39 64 37 63 33 38 2d 34 65 30 39 2d 34 33 61 33 2d 38 34 35 35 2d 61 37 39 66 31 39 66 38 64 38 31 30 } //0a 00  7f9d7c38-4e09-43a3-8455-a79f19f8d810
		$a_81_2 = {38 32 30 62 64 61 66 31 2d 63 35 38 63 2d 34 34 65 36 2d 38 30 64 33 2d 33 37 61 34 37 65 35 31 64 39 32 39 } //01 00  820bdaf1-c58c-44e6-80d3-37a47e51d929
