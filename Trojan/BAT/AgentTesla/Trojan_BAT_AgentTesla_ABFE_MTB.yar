...
rule Trojan_BAT_AgentTesla_ABFE_MTB{
	...
	strings :
		$a_03_0 = {13 04 11 04 08 6f 90 01 03 0a 17 73 90 01 03 0a 13 05 11 05 02 28 90 01 03 06 00 11 04 6f 90 01 03 0a 10 00 02 13 06 de 0d 11 05 2c 08 11 05 6f 90 01 03 0a 00 dc 11 06 2a 90 00 } //4
