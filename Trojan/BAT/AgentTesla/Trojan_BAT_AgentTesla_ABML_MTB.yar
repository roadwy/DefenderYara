...
rule Trojan_BAT_AgentTesla_ABML_MTB{
	...
	strings :
		$a_03_0 = {2b 34 16 2b 34 2b 39 2b 3e 2b 06 2b 07 2b 08 de 1a 09 2b f7 08 2b f6 6f 90 01 01 00 00 0a 2b f1 16 2d 06 09 6f 90 01 01 00 00 0a 1b 2c f4 dc 2b 1d 6f 90 01 01 00 00 0a 13 04 de 42 90 00 } //3
