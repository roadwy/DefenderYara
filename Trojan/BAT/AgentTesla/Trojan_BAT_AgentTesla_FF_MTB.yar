...
rule Trojan_BAT_AgentTesla_FF_MTB{
	...
	strings :
		$a_02_0 = {03 50 8e 69 6a 5d b7 03 50 90 01 01 03 50 8e 69 6a 5d b7 91 90 01 03 8e 69 6a 5d b7 91 61 03 50 90 01 01 17 6a d6 03 50 8e 69 6a 5d b7 91 da 20 00 01 00 00 d6 20 00 01 00 00 5d b4 90 00 } //10
