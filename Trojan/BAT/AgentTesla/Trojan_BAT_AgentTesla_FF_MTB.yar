...
rule Trojan_BAT_AgentTesla_FF_MTB{
	meta:
		description = "Trojan:BAT/AgentTesla.FF!MTB,SIGNATURE_TYPE_PEHSTR_EXT,0c 00 0c 00 03 00 00 0a 00 "
		
	strings :
		$a_02_0 = {03 50 8e 69 6a 5d b7 03 50 90 01 01 03 50 8e 69 6a 5d b7 91 90 01 03 8e 69 6a 5d b7 91 61 03 50 90 01 01 17 6a d6 03 50 8e 69 6a 5d b7 91 da 20 00 01 00 00 d6 20 00 01 00 00 5d b4 90 00 } //01 00 
...
rule Trojan_BAT_AgentTesla_FF_MTB_2{
	meta:
		description = "Trojan:BAT/AgentTesla.FF!MTB,SIGNATURE_TYPE_PEHSTR_EXT,18 00 18 00 0d 00 00 14 00 "
		
	strings :
		$a_81_0 = {24 31 38 35 31 30 33 65 37 2d 63 30 32 66 2d 34 36 30 33 2d 38 36 34 34 2d 39 36 31 38 65 66 33 65 33 62 64 61 } //14 00  $185103e7-c02f-4603-8644-9618ef3e3bda
		$a_81_1 = {24 31 61 36 39 30 32 38 65 2d 34 63 39 61 2d 34 34 32 65 2d 38 38 33 36 2d 64 64 37 33 63 63 63 31 39 31 32 63 } //01 00  $1a69028e-4c9a-442e-8836-dd73ccc1912c
		...
		$a_81_3 = {4f 77 6c 2e 43 6f 72 65 2e 4d 79 2e 52 65 73 6f 75 72 63 65 73 } //01 00  Owl.Core.My.Resources
		$a_81_4 = {44 65 62 75 67 67 65 72 42 72 6f 77 73 61 62 6c 65 41 74 74 72 69 62 75 74 65 } //01 00  DebuggerBrowsableAttribute
		$a_81_5 = {41 53 4d 61 6e 61 67 65 72 32 30 31 37 2e 4d 79 2e 52 65 73 6f 75 72 63 65 73 } //01 00  ASManager2017.My.Resources
