...
rule Trojan_BAT_AgentTesla_BOO_MTB{
	...
	strings :
		$a_02_0 = {0a 0d 09 06 20 e8 03 00 00 73 90 01 03 0a 13 04 08 11 04 08 6f 90 01 03 0a 1e 5b 6f 90 01 03 0a 6f 90 01 03 0a 00 17 2c b8 08 11 04 08 6f 90 01 03 0a 1e 5b 6f 90 01 03 0a 6f 90 01 03 0a 00 08 17 6f 90 01 03 0a 00 1b 2c b8 07 08 6f 90 00 } //10
