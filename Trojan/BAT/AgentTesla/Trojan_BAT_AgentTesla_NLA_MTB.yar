...
rule Trojan_BAT_AgentTesla_NLA_MTB{
	...
	strings :
		$a_03_0 = {2b 17 11 09 28 89 00 00 06 11 0d 20 90 01 03 4f 5a 20 13 20 04 f7 61 2b cb 90 00 } //5
...
rule Trojan_BAT_AgentTesla_NLA_MTB_2{
	...
	strings :
		$a_03_0 = {12 02 22 00 00 61 43 11 00 58 6c 28 90 01 03 0a b7 28 90 01 03 0a 38 90 01 03 ff 02 6f 90 01 03 06 02 7b 90 01 03 04 6c 02 7b 90 01 03 04 6c 5b 28 90 01 03 0a 90 00 } //5
...
rule Trojan_BAT_AgentTesla_NLA_MTB_3{
	...
	strings :
		$a_03_0 = {0a 13 04 11 04 28 90 01 03 0a 20 90 01 03 00 da 13 05 11 05 28 90 01 03 0a 28 90 01 03 0a 13 06 07 11 06 28 90 01 03 0a 0b 09 17 d6 0d 09 08 6f 90 01 03 0a fe 04 13 07 11 07 2d b9 07 0a 06 2a 90 00 } //1
