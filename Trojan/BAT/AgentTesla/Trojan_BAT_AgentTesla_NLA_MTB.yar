...
rule Trojan_BAT_AgentTesla_NLA_MTB{
	...
	strings :
		...
		$a_01_1 = {50 72 6f 67 72 61 6d 49 6e 73 74 61 6c 6c 65 72 2e 49 6e 74 65 72 66 61 63 65 2e 72 65 73 6f 75 72 63 65 73 } //00 00  ProgramInstaller.Interface.resources
	condition:
		any of ($a_*)
...
rule Trojan_BAT_AgentTesla_NLA_MTB_2{
	...
	strings :
		...
		$a_01_1 = {41 75 6e 65 2e 52 65 73 6f 75 72 63 65 73 } //00 00  Aune.Resources
	condition:
		any of ($a_*)
...
rule Trojan_BAT_AgentTesla_NLA_MTB_3{
	...
	strings :
		...
		$a_01_1 = {24 64 64 63 31 62 39 30 30 2d 34 31 32 38 2d 34 34 63 30 2d 39 39 34 36 2d 36 37 30 33 66 34 66 64 39 33 64 } //01 00  $ddc1b900-4128-44c0-9946-6703f4fd93d
