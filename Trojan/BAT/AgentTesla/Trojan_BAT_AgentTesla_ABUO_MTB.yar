...
rule Trojan_BAT_AgentTesla_ABUO_MTB{
	...
	strings :
		$a_03_0 = {16 13 07 2b 1e 08 07 11 07 18 6f 90 01 01 00 00 0a 1f 10 28 90 01 01 00 00 0a b4 6f 90 01 01 00 00 0a 00 11 07 18 d6 13 07 11 07 11 06 31 dc 90 00 } //3
