...
rule Trojan_BAT_AgentTesla_OZN_MTB{
	...
	strings :
		$a_02_0 = {08 11 07 6f 90 01 03 0a 08 18 6f 90 01 03 0a 08 6f 90 01 03 0a 13 05 02 28 90 01 03 0a 13 04 28 90 01 03 0a 11 05 11 04 16 11 04 8e b7 6f 90 01 03 0a 6f 90 01 03 0a 0a 06 0b dd 90 00 } //10
