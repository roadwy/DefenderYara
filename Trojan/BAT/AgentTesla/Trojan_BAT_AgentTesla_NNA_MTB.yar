...
rule Trojan_BAT_AgentTesla_NNA_MTB{
	...
	strings :
		$a_01_0 = {68 00 74 00 74 00 70 00 3a 00 2f 00 2f 00 31 00 38 00 35 00 2e 00 32 00 32 00 32 00 2e 00 35 00 38 00 2e 00 35 00 36 00 2f 00 } //01 00  http://185.222.58.56/
