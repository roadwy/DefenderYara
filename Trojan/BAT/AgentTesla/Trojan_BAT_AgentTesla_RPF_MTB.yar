...
rule Trojan_BAT_AgentTesla_RPF_MTB_2{
	...
	strings :
		$a_01_0 = {4f 00 66 00 6a 00 68 00 47 00 65 00 74 00 42 00 79 00 4f 00 66 00 6a 00 68 00 74 00 65 00 41 00 72 00 72 00 4f 00 66 00 6a 00 68 00 61 00 79 00 41 00 73 00 79 00 4f 00 66 00 6a 00 68 00 6e 00 63 00 } //01 00  OfjhGetByOfjhteArrOfjhayAsyOfjhnc
		$a_01_1 = {31 00 38 00 35 00 2e 00 32 00 32 00 32 00 2e 00 35 00 38 00 2e 00 35 00 36 00 } //01 00  185.222.58.56
		$a_01_2 = {42 00 75 00 66 00 67 00 6a 00 2e 00 70 00 6e 00 67 00 } //01 00  Bufgj.png
		$a_01_3 = {53 00 6c 00 65 00 65 00 70 00 } //01 00  Sleep
		$a_01_4 = {47 00 79 00 65 00 63 00 73 00 63 00 6e 00 68 00 6b 00 62 00 79 00 76 00 6a 00 62 00 67 00 76 00 72 00 66 00 } //00 00  Gyecscnhkbyvjbgvrf
	condition:
		any of ($a_*)
