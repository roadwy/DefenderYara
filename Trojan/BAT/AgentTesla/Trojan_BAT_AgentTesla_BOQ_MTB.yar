...
rule Trojan_BAT_AgentTesla_BOQ_MTB{
	...
	strings :
		...
		$a_81_4 = {46 72 6f 6d 42 61 73 65 36 34 43 68 61 72 41 72 72 61 79 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_BAT_AgentTesla_BOQ_MTB_2{
	...
	strings :
		$a_81_0 = {53 6d 61 72 74 45 78 74 65 6e 73 69 6f 6e 73 } //0a 00 
		$a_81_1 = {5a 4a 34 46 41 37 45 5a 37 35 45 43 55 4a 42 5a } //01 00 
