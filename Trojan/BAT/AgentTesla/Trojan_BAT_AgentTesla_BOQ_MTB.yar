...
rule Trojan_BAT_AgentTesla_BOQ_MTB{
	...
	strings :
		$a_02_0 = {70 0c 07 28 90 01 04 72 90 01 04 28 90 01 04 6f 90 01 04 6f 90 01 04 0d 06 09 6f 90 01 03 0a 00 06 18 6f 90 01 03 0a 00 02 6f 90 01 03 0a 16 02 6f 90 01 03 0a 28 90 01 03 0a 13 04 20 90 01 04 28 90 01 03 0a 06 6f 90 01 03 0a 11 04 16 11 04 8e 69 6f 90 00 } //1
