...
rule Trojan_BAT_AgentTesla_RTA_MTB{
	...
	strings :
		...
		$a_03_2 = {08 07 93 28 90 01 03 0a 1f 21 32 11 08 07 93 28 90 01 03 0a 1f 7e fe 02 16 fe 01 2b 01 16 0d 09 2c 14 08 07 1f 21 08 07 93 1f 0e 58 1f 5e 5d 58 28 90 01 03 0a 9d 07 17 58 0b 07 06 6f 90 01 03 0a fe 04 13 04 11 04 2d b7 90 00 } //1
	condition:
