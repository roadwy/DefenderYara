...
rule Trojan_BAT_AgentTesla_GU_MTB{
	meta:
		description = "Trojan:BAT/AgentTesla.GU!MTB,SIGNATURE_TYPE_PEHSTR_EXT,17 00 17 00 0d 00 00 14 00 "
		
	strings :
		$a_81_0 = {24 31 62 62 30 39 66 33 35 2d 34 38 33 39 2d 34 63 31 37 2d 61 38 63 30 2d 37 65 32 38 37 63 39 65 36 63 39 64 } //14 00  $1bb09f35-4839-4c17-a8c0-7e287c9e6c9d
		$a_81_1 = {24 36 31 38 34 39 32 35 38 2d 37 32 62 39 2d 34 61 30 61 2d 62 33 31 64 2d 65 32 35 65 34 61 36 62 61 35 35 39 } //14 00  $61849258-72b9-4a0a-b31d-e25e4a6ba559
		$a_81_2 = {24 38 39 31 36 61 39 32 39 2d 37 38 39 64 2d 34 38 33 31 2d 61 37 65 61 2d 64 63 65 31 66 39 39 65 31 34 32 38 } //14 00  $8916a929-789d-4831-a7ea-dce1f99e1428
		$a_81_3 = {24 32 34 32 33 62 35 31 32 2d 35 65 30 63 2d 34 39 62 31 2d 38 30 31 62 2d 63 39 62 37 63 32 33 62 32 34 30 38 } //01 00  $2423b512-5e0c-49b1-801b-c9b7c23b2408
