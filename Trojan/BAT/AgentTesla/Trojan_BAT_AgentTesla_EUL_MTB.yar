...
rule Trojan_BAT_AgentTesla_EUL_MTB_2{
	...
	strings :
		...
		$a_01_2 = {42 00 75 00 6e 00 69 00 66 00 75 00 5f 00 54 00 65 00 78 00 74 00 42 00 6f 00 78 00 } //01 00  Bunifu_TextBox
		...
		$a_01_5 = {00 44 65 62 75 67 67 69 6e 67 4d 6f 64 65 73 00 } //00 00  䐀扥杵楧杮潍敤s
	condition:
		any of ($a_*)
