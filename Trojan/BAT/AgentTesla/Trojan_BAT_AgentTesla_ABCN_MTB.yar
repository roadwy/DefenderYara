...
rule Trojan_BAT_AgentTesla_ABCN_MTB{
	...
	strings :
		$a_03_0 = {02 07 02 8e 69 5d 91 06 07 06 8e 69 5d 91 61 28 90 01 03 0a 6e 02 07 17 58 02 8e 69 5d 91 28 90 01 03 0a 6a 59 20 90 01 03 00 6a 58 20 90 01 03 00 6a 5d d2 9c 07 15 58 0b 90 00 } //5
