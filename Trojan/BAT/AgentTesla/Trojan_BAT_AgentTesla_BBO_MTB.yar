...
rule Trojan_BAT_AgentTesla_BBO_MTB{
	...
	strings :
		$a_02_0 = {0a 08 18 2c 90 02 01 17 58 0c 08 07 8e 69 32 90 02 01 06 6f 90 01 03 0a 28 90 01 03 0a 2a 73 90 01 03 0a 90 01 05 0a 90 01 05 6f 90 01 03 0a 2b 90 00 } //10
