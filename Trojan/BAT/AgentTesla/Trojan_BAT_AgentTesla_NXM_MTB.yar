...
rule Trojan_BAT_AgentTesla_NXM_MTB{
	...
	strings :
		$a_01_0 = {24 65 33 35 34 37 63 35 39 2d 34 37 65 66 2d 34 33 37 64 2d 38 62 66 31 2d 35 64 38 30 31 34 36 65 63 65 31 66 } //01 00 
		$a_01_1 = {4b 59 4f 49 4b 55 2e 52 65 73 6f 75 72 63 65 73 2e 72 65 73 6f 75 72 63 65 73 } //01 00 
