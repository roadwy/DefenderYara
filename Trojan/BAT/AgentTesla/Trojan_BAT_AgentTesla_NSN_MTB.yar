...
rule Trojan_BAT_AgentTesla_NSN_MTB{
	...
	strings :
		...
		$a_01_1 = {41 4d 41 5a 49 4e 47 4e 45 57 57 4f 52 4c 44 5f 4c 41 55 4e 43 48 45 52 } //01 00 
		$a_01_2 = {24 36 64 34 35 33 30 35 61 2d 38 30 31 66 2d 34 63 36 36 2d 38 37 62 37 2d 38 30 66 35 32 33 31 35 38 63 34 61 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_BAT_AgentTesla_NSN_MTB_2{
	...
	strings :
		$a_01_0 = {24 62 64 31 62 31 32 65 65 2d 35 31 33 64 2d 34 35 65 34 2d 38 62 31 62 2d 39 66 62 33 61 62 36 62 61 34 35 36 } //01 00 
		$a_01_1 = {49 4e 46 53 33 31 36 30 46 69 6e 61 6c 2e 52 65 73 6f 75 72 63 65 73 2e 72 65 73 6f 75 72 63 65 73 } //01 00 
