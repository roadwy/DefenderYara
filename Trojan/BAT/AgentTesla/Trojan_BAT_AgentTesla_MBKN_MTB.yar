...
rule Trojan_BAT_AgentTesla_MBKN_MTB{
	...
	strings :
		$a_03_0 = {6a 5d d4 91 08 11 07 08 8e 69 6a 5d d4 91 61 28 90 01 01 00 00 0a 07 11 07 17 6a 58 07 8e 69 6a 5d d4 91 28 90 01 01 00 00 0a 59 20 00 01 00 00 58 20 00 01 00 00 5d 90 00 } //1
