...
rule Trojan_BAT_AgentTesla_XB_MTB{
	...
	strings :
		$a_03_0 = {0a 02 17 8d 90 01 03 01 25 16 1f 2d 9d 6f 90 01 03 0a 0b 00 07 0c 16 0d 2b 1c 08 09 9a 13 04 00 06 11 04 1f 10 28 90 01 03 0a d1 6f 90 01 03 0a 26 00 09 17 58 0d 90 00 } //1
...
rule Trojan_BAT_AgentTesla_XB_MTB_2{
	...
	strings :
		$a_03_0 = {18 0c 12 02 28 90 01 03 0a 16 28 90 01 03 0a 16 fe 01 0b 07 2c 0c 72 90 01 04 28 90 01 03 0a 00 00 00 02 28 90 01 03 0a 28 90 01 03 0a 0a 2b 00 06 2a 90 00 } //10
