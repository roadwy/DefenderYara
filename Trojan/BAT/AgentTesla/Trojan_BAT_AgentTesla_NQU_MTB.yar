...
rule Trojan_BAT_AgentTesla_NQU_MTB{
	...
	strings :
		$a_81_0 = {45 76 65 72 63 72 61 66 74 5f 6d 6f 64 65 6c 2e 43 68 61 72 61 63 74 65 72 } //01 00 
		$a_81_1 = {53 79 73 33 32 5f 32 34 33 34 34 } //01 00 
		$a_81_2 = {53 79 73 33 32 5f 32 34 33 38 34 } //01 00 
