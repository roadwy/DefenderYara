...
rule Trojan_BAT_AgentTesla_HC_MTB{
	...
	strings :
		$a_02_0 = {08 84 95 9e 11 05 08 84 11 06 9e 09 06 28 ?? ?? ?? ?? 03 06 28 ?? ?? ?? ?? 91 11 05 11 05 07 84 95 11 05 08 84 95 d7 6e 20 ?? ?? ?? ?? 6a 5f b7 95 61 86 9c 06 11 09 12 00 28 ?? ?? ?? ?? 2d 94 } //10
