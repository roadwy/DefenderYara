...
rule Trojan_BAT_AgentTesla_EPN_MTB{
	...
	strings :
		$a_01_0 = {45 00 35 00 5a 00 38 00 34 00 35 00 53 00 35 00 41 00 48 00 44 00 41 00 45 00 35 00 48 00 47 00 47 00 4f 00 34 00 48 00 35 00 31 00 } //01 00 
		$a_01_1 = {43 00 61 00 72 00 6e 00 69 00 6c 00 61 00 } //01 00 
