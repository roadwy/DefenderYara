...
rule Trojan_BAT_AgentTesla_FAI_MTB{
	...
	strings :
		$a_03_0 = {0c 16 0b 2b 19 08 06 07 18 6f 90 01 01 00 00 0a 1f 10 28 90 01 01 00 00 0a 6f 90 01 01 00 00 0a 07 18 58 0b 07 06 6f 90 01 01 00 00 0a 32 de 90 00 } //3
