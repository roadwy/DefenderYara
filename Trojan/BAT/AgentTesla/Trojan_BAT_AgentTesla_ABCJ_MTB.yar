...
rule Trojan_BAT_AgentTesla_ABCJ_MTB{
	...
	strings :
		$a_03_0 = {13 04 06 11 04 6f 90 01 03 0a 06 18 6f 90 01 03 0a 28 90 01 03 06 0c 06 6f 90 01 03 0a 08 16 08 8e 69 6f 90 01 03 0a 13 05 de 0e 07 6f 90 01 03 0a dc 90 00 } //3
