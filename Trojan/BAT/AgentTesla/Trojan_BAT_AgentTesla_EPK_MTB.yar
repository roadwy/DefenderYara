...
rule Trojan_BAT_AgentTesla_EPK_MTB{
	...
	strings :
		$a_01_0 = {4f 00 35 00 36 00 57 00 48 00 38 00 35 00 5a 00 37 00 36 00 48 00 35 00 48 00 47 00 35 00 46 00 38 00 34 00 37 00 38 00 48 00 35 00 } //01 00 
		$a_01_1 = {53 00 6b 00 65 00 74 00 63 00 68 00 } //01 00 
