...
rule Trojan_BAT_AgentTesla_EUN_MTB{
	...
	strings :
		$a_01_0 = {24 31 31 32 63 66 36 65 31 2d 38 31 34 65 2d 34 33 34 34 2d 61 31 38 33 2d 61 64 61 37 37 65 62 35 38 32 62 65 } //01 00  $112cf6e1-814e-4344-a183-ada77eb582be
		$a_01_1 = {00 47 65 74 45 78 70 6f 72 74 65 64 54 79 70 65 73 00 } //01 00  䜀瑥硅潰瑲摥祔数s
