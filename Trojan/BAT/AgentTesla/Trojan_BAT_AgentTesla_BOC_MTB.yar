...
rule Trojan_BAT_AgentTesla_BOC_MTB{
	meta:
		description = "Trojan:BAT/AgentTesla.BOC!MTB,SIGNATURE_TYPE_PEHSTR_EXT,1d 00 1d 00 0b 00 00 0a 00 "
		
	strings :
		$a_81_0 = {50 65 78 65 73 6f 43 6f 72 65 00 43 6f 72 65 } //0a 00 
		$a_81_1 = {50 65 78 65 73 6f 43 6c 61 73 73 } //01 00  PexesoClass
		...
		$a_81_5 = {55 6e 61 72 79 4f 70 65 72 61 74 69 6f 6e } //01 00  UnaryOperation
		$a_81_6 = {42 69 6e 61 72 79 4f 70 65 72 61 74 69 6f 6e } //01 00  BinaryOperation
