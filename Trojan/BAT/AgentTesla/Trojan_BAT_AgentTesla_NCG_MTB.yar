...
rule Trojan_BAT_AgentTesla_NCG_MTB{
	...
	strings :
		$a_01_0 = {24 30 66 32 34 30 39 63 33 2d 38 38 66 30 2d 34 38 38 31 2d 61 61 34 64 2d 34 39 61 34 31 63 30 31 63 39 38 35 } //01 00 
		...
		$a_01_6 = {52 69 6a 6e 64 61 65 6c 4d 61 6e 61 67 65 64 } //01 00 
