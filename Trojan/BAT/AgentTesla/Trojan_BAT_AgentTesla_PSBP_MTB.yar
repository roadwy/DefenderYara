...
rule Trojan_BAT_AgentTesla_PSBP_MTB{
	...
	strings :
		$a_03_0 = {00 73 5c 00 00 0a 0a 73 5d 90 01 03 0b 07 04 6f 5e 90 01 03 0c 06 08 6f 5f 90 01 03 0d 07 09 6f 60 90 01 03 10 02 72 54 a9 06 70 13 04 11 04 02 7b 18 00 00 04 73 4e 90 01 03 13 05 11 05 6f 4f 90 01 03 72 1b aa 06 70 90 00 } //5
