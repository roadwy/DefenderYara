...
rule Trojan_BAT_AgentTesla_DLM_MTB{
	...
	strings :
		...
		$a_01_7 = {24 30 42 46 43 41 44 37 34 2d 31 32 32 36 2d 34 45 45 41 2d 38 38 42 30 2d 39 46 38 31 30 46 46 39 34 30 46 35 } //1 $0BFCAD74-1226-4EEA-88B0-9F810FF940F5
	condition:
