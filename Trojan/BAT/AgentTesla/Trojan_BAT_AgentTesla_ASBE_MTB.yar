...
rule Trojan_BAT_AgentTesla_ASBE_MTB{
	...
	strings :
		$a_03_0 = {13 04 09 8e 69 17 da 13 11 16 13 12 2b 1b 11 04 11 12 09 11 12 9a 1f 10 28 90 01 01 00 00 0a 6f 90 01 01 00 00 0a 00 11 12 17 d6 13 12 11 12 11 11 31 df 90 00 } //4
