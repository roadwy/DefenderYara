...
rule Trojan_BAT_AgentTesla_GAM_MTB{
	...
	strings :
		$a_03_0 = {0b 07 06 72 90 01 01 00 00 70 6f 90 01 01 00 00 0a 74 02 00 00 1b 6f 90 01 01 00 00 0a 07 06 72 90 01 01 00 00 70 6f 90 01 01 00 00 0a 74 02 00 00 1b 6f 90 01 01 00 00 0a 07 06 72 90 01 01 00 00 70 6f 90 01 01 00 00 0a 74 02 00 00 1b 6f 90 01 01 00 00 0a 02 73 90 00 } //3
