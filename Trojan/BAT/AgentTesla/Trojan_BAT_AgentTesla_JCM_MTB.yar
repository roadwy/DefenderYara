...
rule Trojan_BAT_AgentTesla_JCM_MTB{
	meta:
		description = "Trojan:BAT/AgentTesla.JCM!MTB,SIGNATURE_TYPE_PEHSTR_EXT,0a 00 0a 00 0a 00 00 01 00 "
		
	strings :
		$a_81_0 = {24 36 62 36 66 33 37 65 33 2d 35 35 37 33 2d 34 66 61 62 2d 39 32 32 66 2d 31 39 62 31 34 65 63 65 33 61 65 36 } //01 00  $6b6f37e3-5573-4fab-922f-19b14ece3ae6
		$a_00_1 = {44 6f 75 67 6c 61 73 20 48 65 72 69 6f 74 } //01 00  Douglas Heriot
		...
		$a_81_7 = {46 72 6f 6d 42 61 73 65 36 34 43 68 61 72 41 72 72 61 79 } //01 00  FromBase64CharArray
