...
rule Trojan_BAT_AgentTesla_ABK_MTB{
	...
	strings :
		...
		$a_01_1 = {73 6f 63 6b 65 74 70 72 6f 67 72 61 6d 69 6e 67 2e 52 65 73 6f 75 72 63 65 31 } //01 00 
		$a_01_2 = {63 33 34 38 33 33 39 64 2d 31 34 32 34 2d 34 34 35 66 2d 61 66 33 35 2d 39 31 62 61 33 61 30 33 34 63 38 65 } //00 00 
	condition:
		any of ($a_*)
