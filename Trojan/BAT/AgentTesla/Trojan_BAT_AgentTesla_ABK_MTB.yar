...
rule Trojan_BAT_AgentTesla_ABK_MTB_2{
	...
	strings :
		$a_03_0 = {73 28 00 00 0a 0a 06 03 16 03 8e 69 6f 90 01 01 00 00 0a 00 06 6f 2a 00 00 0a 00 00 de 05 90 00 } //2
...
rule Trojan_BAT_AgentTesla_ABK_MTB_3{
	...
	strings :
		$a_03_0 = {2b 08 2a 28 0a 90 01 02 06 2b f6 28 05 90 01 02 06 2b f1 90 0a 18 00 72 13 90 01 02 70 2b 03 90 00 } //1
