...
rule Trojan_BAT_AgentTesla_AABC_MTB{
	...
	strings :
		$a_03_0 = {06 07 8e 69 08 16 08 8e 69 28 ?? 00 00 0a 03 07 28 ?? 00 00 06 0d 09 6f ?? 00 00 0a 13 04 11 04 08 16 08 8e 69 6f ?? 00 00 0a 13 05 28 ?? 00 00 0a 11 05 6f ?? 00 00 0a 13 06 dd ?? 00 00 00 11 04 39 ?? 00 00 00 11 04 6f ?? 00 00 0a dc } //4
