...
rule Trojan_BAT_AgentTesla_LCD_MTB{
	...
	strings :
		$a_03_0 = {09 11 04 11 05 6f 90 01 03 0a 13 08 09 11 04 11 05 6f 90 01 03 0a 13 09 11 09 28 90 01 03 0a 13 0a 08 07 11 0a d2 9c 00 11 05 17 58 13 05 90 00 } //1
