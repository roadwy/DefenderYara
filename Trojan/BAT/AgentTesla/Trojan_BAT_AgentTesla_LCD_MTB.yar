...
rule Trojan_BAT_AgentTesla_LCD_MTB{
	...
	strings :
		...
		$a_01_1 = {24 66 66 62 66 35 30 65 30 2d 66 36 61 63 2d 34 37 61 30 2d 38 32 63 37 2d 32 61 35 37 63 35 36 65 30 34 39 37 } //01 00 
		$a_01_2 = {43 72 65 61 74 65 49 6e 73 74 61 6e 63 65 } //01 00 
		$a_01_3 = {7a 68 77 6c 57 69 6e 46 6f 72 6d 54 } //01 00 
