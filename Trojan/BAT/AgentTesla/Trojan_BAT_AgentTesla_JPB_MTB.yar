...
rule Trojan_BAT_AgentTesla_JPB_MTB{
	...
	strings :
		$a_03_0 = {07 06 09 18 5a 18 6f 90 01 03 0a 1f 10 28 90 01 03 0a d2 6f 90 01 03 0a 00 00 09 17 58 0d 09 06 6f 90 01 03 0a 18 5b fe 04 13 04 11 04 90 00 } //10
