...
rule Trojan_BAT_AgentTesla_RPK_MTB_3{
	...
	strings :
		...
		$a_01_1 = {4d 00 65 00 6c 00 76 00 69 00 6e 00 2e 00 57 00 68 00 69 00 74 00 65 00 } //01 00  Melvin.White
		$a_01_2 = {41 00 6d 00 69 00 72 00 43 00 61 00 6c 00 65 00 6e 00 64 00 61 00 72 00 } //00 00  AmirCalendar
	condition:
		any of ($a_*)
...
rule Trojan_BAT_AgentTesla_RPK_MTB_4{
	...
	strings :
		...
		$a_01_5 = {42 69 6e 61 72 79 52 65 61 64 65 72 } //01 00  BinaryReader
...
rule Trojan_BAT_AgentTesla_RPK_MTB_5{
	...
	strings :
		...
		$a_01_3 = {42 00 61 00 6e 00 6b 00 5f 00 52 00 65 00 70 00 6f 00 72 00 74 00 5f 00 30 00 30 00 30 00 32 00 32 00 35 00 2e 00 6a 00 70 00 67 00 } //01 00  Bank_Report_000225.jpg
		$a_01_4 = {50 00 71 00 73 00 6b 00 6a 00 67 00 62 00 70 00 61 00 67 00 72 00 } //00 00  Pqskjgbpagr
	condition:
		any of ($a_*)
