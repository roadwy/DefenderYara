...
rule Trojan_BAT_AgentTesla_MTB{
	...
	strings :
		$a_03_0 = {16 2d 43 00 38 a2 90 01 02 00 72 7d 90 01 02 70 38 9e 90 01 02 00 38 a3 90 01 02 00 38 a4 90 01 02 00 72 e3 90 01 02 70 38 a4 90 01 02 00 38 a9 90 01 02 00 38 aa 90 01 02 00 8e 69 15 90 00 } //2
