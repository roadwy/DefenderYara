...
rule Trojan_BAT_AgentTesla_AEIS_MTB{
	...
	strings :
		...
		$a_01_1 = {42 00 6f 00 6f 00 6b 00 6d 00 61 00 6b 00 65 00 72 00 46 00 65 00 65 00 64 00 50 00 61 00 72 00 73 00 65 00 53 00 65 00 72 00 76 00 69 00 63 00 65 00 } //01 00  BookmakerFeedParseService
