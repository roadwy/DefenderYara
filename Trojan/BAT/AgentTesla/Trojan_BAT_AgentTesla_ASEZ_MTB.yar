...
rule Trojan_BAT_AgentTesla_ASEZ_MTB{
	...
	strings :
		$a_03_0 = {11 00 11 01 02 11 01 91 72 90 01 01 00 00 70 28 90 01 01 00 00 06 59 d2 9c 20 02 00 00 00 38 90 01 01 ff ff ff 11 01 17 58 13 01 20 06 00 00 00 38 90 00 } //1
