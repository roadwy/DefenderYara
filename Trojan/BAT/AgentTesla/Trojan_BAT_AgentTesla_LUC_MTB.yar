...
rule Trojan_BAT_AgentTesla_LUC_MTB{
	...
	strings :
		$a_03_0 = {02 6c 23 ff 90 01 06 3f 5b 28 90 01 03 0a b7 28 90 01 03 0a 28 90 01 03 0a 2a 90 00 } //1
		$a_01_1 = {0a 0d 06 09 28 8b 00 00 0a 0a 08 17 d6 0c 08 07 6f 8c 00 00 0a 32 d9 } //1
		$a_03_2 = {0a 0d 06 09 28 90 01 03 0a 0a 08 17 d6 0c 08 07 6f 90 01 03 0a 32 d9 90 00 } //1
