...
rule Trojan_BAT_AgentTesla_NB_MTB_2{
	...
	strings :
		$a_03_0 = {20 42 11 f3 ff 5a 09 61 2b af 28 90 01 03 06 20 90 01 03 15 2b 00 28 90 01 03 2b 12 00 28 90 01 03 0a 20 90 01 03 c4 2b 00 28 90 01 03 2b 28 90 01 03 0a 25 28 90 01 03 06 28 90 01 03 0a 73 90 01 03 0a 28 90 01 03 0a 90 00 } //5
...
rule Trojan_BAT_AgentTesla_NB_MTB_3{
	...
	strings :
		$a_03_0 = {64 fe 0c 23 00 1f 19 62 60 fe 90 01 02 00 20 90 01 03 00 fe 90 01 02 00 20 90 01 03 00 5f 5a 90 00 } //5
