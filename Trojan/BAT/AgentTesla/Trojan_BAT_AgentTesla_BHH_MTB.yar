...
rule Trojan_BAT_AgentTesla_BHH_MTB_2{
	...
	strings :
		$a_02_0 = {0a 16 9a 11 01 17 8d 90 01 03 01 25 16 28 90 01 03 06 a2 6f 90 01 03 0a 28 90 01 03 0a 38 90 01 04 28 90 01 03 0a 02 28 90 01 03 06 6f 90 01 03 0a 25 72 90 01 03 70 6f 90 01 03 0a 13 00 11 00 6f 90 01 03 0a 28 90 01 03 06 13 01 38 90 00 } //10
		$a_02_1 = {0a 0a 08 16 73 90 01 03 0a 73 90 01 03 0a 0b 16 7e 90 01 03 04 2d 03 26 11 04 45 01 90 01 07 2b 09 06 6f 90 01 03 0a 0d 2b 14 00 07 06 6f 90 01 03 0a de ed 07 2c 06 07 6f 90 01 03 0a dc dd 90 00 } //10
