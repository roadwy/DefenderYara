...
rule Trojan_BAT_AgentTesla_NAN_MTB{
	...
	strings :
		$a_03_0 = {06 07 02 07 6f ?? ?? ?? 0a 7e ?? ?? ?? 04 07 1f 10 5d 91 61 07 20 ?? ?? ?? 00 5d d1 61 d1 9d 07 17 58 0b 07 02 6f ?? ?? ?? 0a 32 d4 } //1
...
rule Trojan_BAT_AgentTesla_NAN_MTB_2{
	...
	strings :
		$a_03_0 = {07 d0 31 00 00 01 28 ?? 00 00 0a 06 17 8d ?? 00 00 01 25 16 d0 ?? 00 00 1b 28 ?? 00 00 0a a2 28 ?? 00 00 0a 14 17 8d ?? 00 00 01 25 16 28 ?? 00 00 06 a2 6f ?? 00 00 0a } //5
