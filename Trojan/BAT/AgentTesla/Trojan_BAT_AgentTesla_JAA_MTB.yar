...
rule Trojan_BAT_AgentTesla_JAA_MTB{
	...
	strings :
		$a_02_0 = {0a 13 06 06 11 06 28 90 01 03 0a 11 05 da 28 90 01 03 0a 28 90 01 03 0a 28 90 01 03 0a 0a 07 17 d6 0b 07 08 6f 90 01 03 0a fe 04 13 07 11 07 2d c9 90 00 } //10
