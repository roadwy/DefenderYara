...
rule Trojan_BAT_AgentTesla_CBZ_MTB{
	meta:
		description = "Trojan:BAT/AgentTesla.CBZ!MTB,SIGNATURE_TYPE_PEHSTR_EXT,0c 00 0c 00 0c 00 00 01 00 "
		
	strings :
		$a_81_0 = {00 70 72 6f 74 00 6b 69 63 6b 00 } //01 00 
		$a_81_1 = {00 43 5f 44 00 70 32 00 69 32 00 } //01 00 
		$a_81_2 = {00 48 75 6e 74 65 72 00 53 00 } //01 00  䠀湵整rS
		$a_81_3 = {00 52 65 74 75 72 6e 45 72 72 6f 72 00 4d 65 73 73 61 67 65 00 } //01 00 
