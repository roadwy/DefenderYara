...
rule Trojan_BAT_AgentTesla_JPD_MTB{
	...
	strings :
		$a_81_0 = {65 30 39 32 62 36 38 37 2d 36 38 33 35 2d 34 39 32 37 2d 62 61 65 34 2d 35 34 32 32 62 31 33 66 36 35 33 36 } //01 00  e092b687-6835-4927-bae4-5422b13f6536
		$a_81_1 = {4f 75 74 72 61 67 65 20 45 6e 67 69 6e 65 } //01 00  Outrage Engine
