...
rule Trojan_BAT_AgentTesla_CEF_MTB{
	meta:
		description = "Trojan:BAT/AgentTesla.CEF!MTB,SIGNATURE_TYPE_PEHSTR_EXT,08 00 08 00 08 00 00 01 00 "
		
	strings :
		$a_00_0 = {b0 00 d5 00 b2 00 b3 00 cf 00 e6 00 dc 00 af 00 ae 00 ae 00 dd 00 e3 00 b9 00 d4 00 b2 00 ae 00 b0 00 d4 00 d4 00 dc 00 e1 00 be 00 ae 00 ae 00 b0 00 d5 00 b6 00 b6 00 } //01 00 
		...
		$a_81_7 = {54 68 72 65 61 64 50 6f 6f 6c 2e 4c 69 67 68 74 } //00 00  ThreadPool.Light
	condition:
		any of ($a_*)
