...
rule Trojan_BAT_AgentTesla_CLW_MTB{
	...
	strings :
		$a_03_0 = {70 0c 07 28 90 01 03 0a 08 6f 90 01 03 0a 6f 90 01 03 0a 0d 06 09 6f 90 01 03 0a 06 18 6f 90 01 03 0a 03 13 04 06 6f 90 01 03 0a 11 04 16 11 04 8e 69 6f 90 01 03 0a 13 05 de 1b 90 00 } //1
