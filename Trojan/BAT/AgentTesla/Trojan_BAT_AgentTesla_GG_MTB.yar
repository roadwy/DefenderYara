...
rule Trojan_BAT_AgentTesla_GG_MTB{
	...
	strings :
		...
		$a_81_1 = {46 6c 6f 72 61 } //01 00  Flora
		$a_81_2 = {42 69 74 6d 61 70 } //01 00  Bitmap
		$a_81_3 = {46 69 7a 7a 42 75 7a 7a } //01 00  FizzBuzz
		$a_81_4 = {63 6f 6e 76 65 72 74 } //01 00  convert
		$a_81_5 = {44 65 62 75 67 67 65 72 } //01 00  Debugger
		$a_81_6 = {49 73 4c 6f 67 67 69 6e 67 } //00 00  IsLogging
	condition:
		any of ($a_*)
