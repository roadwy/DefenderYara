...
rule Trojan_BAT_AgentTesla_ABUV_MTB{
	...
	strings :
		$a_03_0 = {a2 13 04 d0 90 01 01 00 00 01 28 90 01 02 00 0a 11 04 28 90 01 02 00 0a 20 00 01 00 00 14 14 17 8d 90 01 01 00 00 01 25 16 07 6f 90 01 02 00 0a a2 28 90 01 02 00 0a 74 90 01 01 00 00 01 13 05 11 05 6f 90 01 01 01 00 0a 17 9a 7e 90 01 01 00 00 04 13 06 11 06 90 00 } //4
