...
rule Trojan_BAT_AgentTesla_NAR_MTB{
	...
	strings :
		$a_01_0 = {54 56 64 47 47 75 7a 71 49 4b 4c 57 6b 68 62 61 7a 6f 68 75 70 73 59 47 54 51 4a } //1 TVdGGuzqIKLWkhbazohupsYGTQJ
		$a_01_1 = {69 73 66 64 30 73 64 2e 65 78 65 } //1 isfd0sd.exe
		...
		$a_01_8 = {53 79 73 74 65 6d 2e 54 65 78 74 } //1 System.Text
		$a_01_9 = {43 72 65 61 74 65 49 6e 73 74 61 6e 63 65 } //1 CreateInstance
		$a_01_10 = {48 74 74 70 57 65 62 52 65 71 75 65 73 74 } //1 HttpWebRequest
		$a_01_11 = {44 65 62 75 67 67 61 62 6c 65 41 74 74 72 69 62 75 74 65 } //1 DebuggableAttribute
	condition:
