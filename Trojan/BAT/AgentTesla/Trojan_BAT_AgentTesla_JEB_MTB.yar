...
rule Trojan_BAT_AgentTesla_JEB_MTB{
	...
	strings :
		...
		$a_81_1 = {24 34 63 32 61 35 62 30 62 2d 38 37 66 63 2d 34 63 63 64 2d 62 66 34 38 2d 38 36 39 30 34 39 35 34 32 32 31 66 } //01 00  $4c2a5b0b-87fc-4ccd-bf48-86904954221f
		$a_00_2 = {00 73 65 78 78 00 } //00 00  猀硥x
	condition:
		any of ($a_*)
