...
rule Trojan_BAT_AgentTesla_AM_MTB{
	...
	strings :
		$a_03_0 = {02 72 35 01 90 01 01 70 28 1a 90 01 02 06 0b 73 49 90 01 02 0a 0c 07 8e 69 13 06 2b 13 00 16 2d 0a 08 07 11 06 91 90 00 } //6
...
rule Trojan_BAT_AgentTesla_AM_MTB_2{
	...
	strings :
		$a_03_0 = {07 11 04 11 05 6f 90 01 03 0a 26 07 11 04 11 05 6f 90 01 03 0a 28 90 01 03 0a 13 06 09 08 72 90 01 03 70 28 90 01 03 0a 72 90 01 03 70 20 90 01 03 00 14 14 17 8d 90 01 03 01 25 16 11 06 8c 90 01 03 01 a2 6f 90 01 03 0a a5 90 01 03 01 9c 11 05 17 58 13 05 11 05 07 6f 90 01 03 0a 32 a1 90 00 } //10
	condition:
		((#a_03_0  & 1)*10) >=10
