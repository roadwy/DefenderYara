...
rule Trojan_BAT_AgentTesla_MD_MTB{
	...
	strings :
		$a_03_0 = {16 0d 2b 26 06 09 08 09 08 8e 69 5d 91 07 09 91 61 d2 6f ?? ?? ?? 0a 09 13 04 2b 03 0c 2b e1 11 04 17 58 0d 2b 04 2c 0f 2b c5 09 07 8e 69 32 02 2b 05 } //10
