...
rule Trojan_BAT_AgentTesla_CUL_MTB{
	...
	strings :
		$a_03_0 = {11 00 20 80 00 00 00 6f 90 01 03 0a 38 90 01 03 00 11 00 11 03 11 00 6f 90 01 03 0a 1e 5b 6f 90 01 03 0a 6f 90 01 03 0a 20 01 00 00 00 7e 90 01 03 04 3a 90 00 } //1
