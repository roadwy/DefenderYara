...
rule Trojan_BAT_AgentTesla_AQE_MTB{
	...
	strings :
		$a_03_0 = {0a 0a 02 16 28 90 01 03 0a 0b 06 02 1a 02 8e 69 1a 59 6f 90 01 03 0a 07 90 01 05 0c 06 16 6a 6f 90 01 03 0a 06 16 90 01 05 08 16 08 8e 69 6f 90 01 03 0a 26 08 2a 90 00 } //10
