...
rule Trojan_BAT_AgentTesla_NIC_MTB{
	...
	strings :
		$a_03_0 = {70 0d 08 28 90 01 03 0a 72 6a 09 00 70 6f 90 01 03 0a 6f 90 01 03 0a 13 04 07 11 04 6f 90 01 03 0a 00 07 18 6f 90 01 03 0a 00 28 90 01 03 06 28 90 01 03 0a 13 05 28 90 01 03 0a 07 6f 90 01 03 0a 11 05 16 11 05 8e 69 6f 90 00 } //1
