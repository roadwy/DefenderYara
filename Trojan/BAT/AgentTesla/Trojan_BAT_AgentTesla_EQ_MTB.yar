...
rule Trojan_BAT_AgentTesla_EQ_MTB{
	...
	strings :
		$a_02_0 = {16 0d 04 17 da 13 04 16 0b 2b 0a 09 03 07 94 d6 0d 07 17 d6 0b 07 11 04 31 f1 09 6c 04 6c 5b 0c 02 02 7b ?? ?? ?? 04 6f ?? ?? ?? 0a 1f 0a 9a 7d ?? ?? ?? 04 08 0a 2b 00 06 2a } //10
