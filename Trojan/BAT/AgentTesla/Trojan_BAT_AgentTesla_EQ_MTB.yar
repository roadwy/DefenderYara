...
rule Trojan_BAT_AgentTesla_EQ_MTB_2{
	...
	strings :
		$a_81_0 = {24 65 65 64 37 35 36 32 38 2d 32 65 61 30 2d 34 34 35 31 2d 38 63 61 34 2d 62 62 36 35 31 61 31 33 63 64 64 62 } //05 00 
		$a_81_1 = {43 72 65 61 74 65 49 6e 73 74 61 6e 63 65 } //05 00 
		...
		$a_81_4 = {57 69 6e 43 6f 6e 74 72 6f 6c 73 2e 4c 69 73 74 56 69 65 77 2e 52 65 73 6f 75 72 63 65 73 2e 72 65 73 6f 75 72 63 65 73 } //01 00 
