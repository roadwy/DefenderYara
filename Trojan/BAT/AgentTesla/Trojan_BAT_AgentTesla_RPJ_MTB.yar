...
rule Trojan_BAT_AgentTesla_RPJ_MTB{
	...
	strings :
		$a_03_0 = {7e 01 00 00 04 18 9a 20 d4 01 00 00 95 80 0a 00 00 04 7e 01 00 00 04 19 90 01 02 9a 1f 2c 8f 05 00 00 01 25 71 05 00 00 01 90 01 02 7e 01 00 00 04 18 9a 20 9b 02 00 00 95 61 81 05 00 00 01 2a 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_BAT_AgentTesla_RPJ_MTB_2{
	meta:
		description = "Trojan:BAT/AgentTesla.RPJ!MTB,SIGNATURE_TYPE_PEHSTR_EXT,05 00 05 00 05 00 00 "
	...
	strings :
		...
		$a_01_1 = {64 00 65 00 72 00 61 00 5f 00 63 00 72 00 79 00 70 00 74 00 65 00 64 00 2e 00 6a 00 70 00 67 00 } //1 dera_crypted.jpg
		$a_01_2 = {46 00 7a 00 71 00 71 00 65 00 71 00 74 00 6e 00 6f 00 73 00 72 00 63 00 61 00 73 00 62 00 70 00 6b 00 72 00 } //1 Fzqqeqtnosrcasbpkr
...
rule Trojan_BAT_AgentTesla_RPJ_MTB_3{
	...
	strings :
		$a_01_0 = {00 23 00 00 00 00 00 88 d3 40 73 1f 00 00 0a 0a 06 02 fe 06 06 00 00 06 73 20 00 00 0a 6f 21 00 00 0a 00 06 17 6f 22 00 00 0a 00 06 16 6f 23 00 00 0a 00 2a } //1
	condition:
		((#a_01_0  & 1)*1) >=1
