...
rule Trojan_BAT_AgentTesla_RPJ_MTB_2{
	...
	strings :
		...
		$a_01_1 = {64 00 65 00 72 00 61 00 5f 00 63 00 72 00 79 00 70 00 74 00 65 00 64 00 2e 00 6a 00 70 00 67 00 } //01 00 
		$a_01_2 = {46 00 7a 00 71 00 71 00 65 00 71 00 74 00 6e 00 6f 00 73 00 72 00 63 00 61 00 73 00 62 00 70 00 6b 00 72 00 } //01 00 
		...
		$a_01_4 = {70 00 6f 00 77 00 65 00 72 00 73 00 68 00 65 00 6c 00 6c 00 } //00 00 
	condition:
		any of ($a_*)
