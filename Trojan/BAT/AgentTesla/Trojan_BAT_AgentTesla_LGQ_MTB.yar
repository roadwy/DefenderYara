...
rule Trojan_BAT_AgentTesla_LGQ_MTB{
	...
	strings :
		$a_81_0 = {30 30 30 77 65 62 68 6f 73 74 61 70 70 2e 63 6f 6d } //01 00  000webhostapp.com
		...
		$a_81_4 = {46 6f 72 6d 31 41 53 46 46 44 53 53 46 53 46 } //01 00  Form1ASFFDSSFSF
		$a_01_5 = {46 72 6f 6d 41 72 67 62 } //00 00  FromArgb
	condition:
		any of ($a_*)
