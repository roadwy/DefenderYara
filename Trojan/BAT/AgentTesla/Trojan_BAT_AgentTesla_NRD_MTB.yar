...
rule Trojan_BAT_AgentTesla_NRD_MTB{
	...
	strings :
		$a_03_0 = {68 00 74 00 74 00 70 90 02 98 00 74 00 72 00 61 00 6e 00 73 00 66 00 65 00 72 00 2e 00 73 00 68 00 2f 00 67 00 65 00 74 00 2f 00 90 02 30 2e 00 74 00 78 00 74 90 00 } //1
