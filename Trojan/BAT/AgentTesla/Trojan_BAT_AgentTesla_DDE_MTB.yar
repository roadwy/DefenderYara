...
rule Trojan_BAT_AgentTesla_DDE_MTB{
	...
	strings :
		$a_01_0 = {24 33 66 62 36 62 62 37 36 2d 30 66 30 36 2d 34 31 32 66 2d 38 66 64 66 2d 64 37 33 35 36 34 64 35 37 31 33 64 } //01 00 
		$a_01_1 = {57 69 6e 4d 69 78 65 72 2e 50 72 6f 70 65 72 74 69 65 73 2e 52 65 73 6f 75 72 63 65 73 } //01 00 
