...
rule Trojan_BAT_AgentTesla_DQ_MTB{
	meta:
		description = "Trojan:BAT/AgentTesla.DQ!MTB,SIGNATURE_TYPE_PEHSTR_EXT,19 00 19 00 0d 00 00 "
		
	strings :
		$a_81_0 = {24 34 37 35 64 63 37 36 36 2d 37 30 35 37 2d 34 33 32 30 2d 61 66 30 63 2d 61 64 63 36 35 37 65 36 39 64 30 62 } //20 $475dc766-7057-4320-af0c-adc657e69d0b
		$a_81_1 = {24 33 62 38 64 34 36 63 30 2d 34 36 63 33 2d 34 36 66 34 2d 39 38 63 35 2d 38 61 64 39 64 66 30 65 34 31 61 36 } //20 $3b8d46c0-46c3-46f4-98c5-8ad9df0e41a6
		$a_81_2 = {46 6f 72 6d 73 43 6c 61 73 73 65 73 2e 50 72 6f 70 65 72 74 69 65 73 2e 52 65 73 6f 75 72 63 65 73 } //1 FormsClasses.Properties.Resources
		$a_81_3 = {44 73 6b 45 78 70 6c 6f 72 65 72 2e 4d 79 2e 52 65 73 6f 75 72 63 65 73 } //1 DskExplorer.My.Resources
