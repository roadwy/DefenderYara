...
rule Trojan_BAT_AgentTesla_ASBT_MTB{
	...
	strings :
		$a_03_0 = {13 07 11 06 8e 69 17 da 13 20 16 13 21 38 90 01 01 00 00 00 11 07 11 06 11 21 9a 1f 10 7e 90 01 01 02 00 04 28 90 01 01 03 00 06 b4 6f 90 01 01 00 00 0a 00 11 21 17 d6 13 21 11 21 11 20 3e 90 00 } //4
