...
rule Trojan_BAT_AgentTesla_AJY_MTB{
	...
	strings :
		$a_03_0 = {25 16 11 04 11 0c 18 5a 18 6f 90 01 03 0a a2 25 17 1f 10 8c 90 01 03 01 a2 6f 90 01 03 0a 6f 90 01 03 0a 26 00 11 0c 17 58 13 0c 11 0c 11 05 fe 04 13 0d 11 0d 2d aa 11 06 72 90 01 03 70 28 90 00 } //10
