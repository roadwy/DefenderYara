...
rule Trojan_BAT_AgentTesla_EAO_MTB{
	...
	strings :
		$a_03_0 = {20 00 01 00 00 14 14 17 8d 17 00 00 01 25 16 07 6f 90 01 01 00 00 0a a2 28 90 01 01 00 00 0a 74 20 00 00 01 0c 08 6f 90 01 01 00 00 0a 17 9a 6f 90 01 01 00 00 0a 17 9a 0d 09 16 8c 59 00 00 01 7e 90 01 01 00 00 04 13 04 11 04 6f 90 01 01 00 00 0a 26 02 7b 33 00 00 04 72 43 06 00 70 6f 90 00 } //3
