...
rule Trojan_BAT_AgentTesla_AGT_MTB{
	...
	strings :
		$a_03_0 = {16 0b 2b 4d 16 0c 2b 3b 16 0d 2b 29 11 07 06 08 58 07 09 58 6f 90 01 03 0a 13 0f 12 0f 28 90 01 03 0a 13 09 11 05 11 04 11 09 9c 11 04 17 58 13 04 09 17 58 0d 09 17 fe 04 13 0a 11 0a 2d cd 90 00 } //2
...
rule Trojan_BAT_AgentTesla_AGT_MTB_2{
	...
	strings :
		$a_03_0 = {04 09 11 05 6f 90 01 03 0a 13 06 04 09 11 05 6f 90 01 03 0a 13 07 11 07 28 90 01 03 0a 13 08 07 06 11 08 28 90 01 03 0a 9c 11 05 17 d6 13 05 11 05 11 04 31 cb 90 00 } //10
