...
rule Trojan_BAT_AgentTesla_FAX_MTB{
	...
	strings :
		$a_03_0 = {0d 16 13 04 2b 23 00 08 11 04 18 6f 90 01 01 00 00 0a 1f 10 28 90 01 01 00 00 0a 13 06 09 11 06 6f 90 01 01 00 00 0a 00 11 04 18 58 13 04 00 11 04 08 6f 90 01 01 00 00 0a fe 04 13 07 11 07 2d cd 90 00 } //3
