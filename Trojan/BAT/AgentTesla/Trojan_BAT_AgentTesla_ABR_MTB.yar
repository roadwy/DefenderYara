...
rule Trojan_BAT_AgentTesla_ABR_MTB_2{
	...
	strings :
		...
		$a_01_4 = {4a 00 69 00 73 00 77 00 6d 00 75 00 68 00 6b 00 6e 00 66 00 68 00 } //00 00  Jiswmuhknfh
	condition:
		any of ($a_*)
...
rule Trojan_BAT_AgentTesla_ABR_MTB_3{
	...
	strings :
		...
		$a_01_2 = {54 72 61 6e 73 66 6f 72 6d 42 6c 6f 63 6b } //01 00  TransformBlock
