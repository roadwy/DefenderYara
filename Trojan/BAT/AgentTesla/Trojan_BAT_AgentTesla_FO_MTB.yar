...
rule Trojan_BAT_AgentTesla_FO_MTB_2{
	...
	strings :
		$a_03_0 = {70 12 01 28 90 01 03 0a 2c 10 07 16 31 0c 07 20 e8 03 00 00 5a 28 90 01 03 0a de 03 90 09 06 00 16 0b 72 90 00 } //5
		$a_03_1 = {26 de 00 72 90 01 03 70 28 90 01 03 0a 73 90 01 03 0a 72 90 01 03 70 6f 90 01 03 0a 74 01 00 00 1b 28 90 01 03 06 28 90 01 03 0a 72 90 01 03 70 6f 90 01 03 0a 6f 90 01 03 0a 72 90 01 03 70 6f 90 01 03 0a 14 16 8d 01 00 00 01 6f 90 01 03 0a 26 de 03 26 de 00 2a 90 00 } //5
