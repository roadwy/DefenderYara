...
rule Trojan_BAT_AgentTesla_MAI_MTB{
	...
	strings :
		$a_03_0 = {08 06 07 06 9a 1f 10 28 ?? ?? ?? 0a 6f ?? ?? ?? 0a 06 17 58 0a 06 07 8e 69 fe 04 13 09 11 09 2d df } //5
		$a_03_1 = {08 06 07 06 9a 1f 10 28 ?? ?? ?? 0a d2 6f ?? ?? ?? 0a 06 17 58 0a 06 07 8e 69 fe 04 13 08 11 08 2d de } //5
