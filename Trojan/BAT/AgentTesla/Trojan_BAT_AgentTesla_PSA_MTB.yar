...
rule Trojan_BAT_AgentTesla_PSA_MTB{
	...
	strings :
		...
		$a_01_4 = {41 54 4d 4d 61 6e 61 67 65 72 2e 55 70 64 61 74 65 2e 72 65 73 6f 75 72 63 65 73 } //01 00  ATMManager.Update.resources
		$a_01_5 = {67 65 74 5f 43 61 72 64 4e 75 6d } //00 00  get_CardNum
	condition:
		any of ($a_*)
