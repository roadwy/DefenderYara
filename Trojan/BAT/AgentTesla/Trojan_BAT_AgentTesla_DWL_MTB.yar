...
rule Trojan_BAT_AgentTesla_DWL_MTB{
	...
	strings :
		$a_81_0 = {24 66 30 31 61 32 34 39 38 2d 65 37 37 36 2d 34 65 37 62 2d 38 66 65 64 2d 30 66 66 39 64 66 35 61 31 62 63 36 } //10 $f01a2498-e776-4e7b-8fed-0ff9df5a1bc6
