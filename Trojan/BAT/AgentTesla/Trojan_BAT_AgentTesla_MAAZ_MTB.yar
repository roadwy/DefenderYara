...
rule Trojan_BAT_AgentTesla_MAAZ_MTB{
	...
	strings :
		$a_03_0 = {2b 1f 12 0a 28 ?? 00 00 0a 13 0b 2b 14 12 0a 28 ?? 00 00 0a 13 0b 2b 09 12 0a 28 ?? 00 00 0a 13 0b 07 11 0b 6f ?? 00 00 0a 11 09 17 58 13 09 11 09 09 32 aa } //1
