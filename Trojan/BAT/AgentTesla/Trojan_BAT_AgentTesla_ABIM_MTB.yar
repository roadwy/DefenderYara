...
rule Trojan_BAT_AgentTesla_ABIM_MTB{
	...
	strings :
		$a_03_0 = {06 07 16 20 90 01 03 00 6f 90 01 03 0a 0d 09 16 fe 02 13 04 11 04 2c 0c 90 0a 3b 00 02 73 90 01 03 0a 16 73 90 01 03 0a 0a 00 20 90 01 03 00 8d 90 01 03 01 0b 00 00 73 90 01 03 0a 0c 90 00 } //4
