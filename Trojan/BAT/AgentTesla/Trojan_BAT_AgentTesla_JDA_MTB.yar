...
rule Trojan_BAT_AgentTesla_JDA_MTB{
	meta:
		description = "Trojan:BAT/AgentTesla.JDA!MTB,SIGNATURE_TYPE_PEHSTR_EXT,1b 00 1b 00 0b 00 00 "
		
	strings :
		$a_81_0 = {36 36 61 66 30 32 33 39 2d 37 38 32 30 2d 34 65 66 63 2d 61 31 32 30 2d 32 65 30 34 65 32 36 32 30 36 31 61 } //20 66af0239-7820-4efc-a120-2e04e262061a
		$a_81_1 = {24 37 36 61 66 31 66 63 37 2d 65 65 36 32 2d 34 66 38 36 2d 61 31 39 32 2d 65 34 62 64 62 61 36 31 62 33 66 38 } //20 $76af1fc7-ee62-4f86-a192-e4bdba61b3f8
		$a_00_2 = {44 69 62 61 6b 61 72 20 4d 61 6e 64 61 6c } //10 Dibakar Mandal
		$a_00_3 = {51 4d 61 6e 61 67 65 72 } //10 QManager
	...
	condition:
		((#a_81_0  & 1)*20+(#a_81_1  & 1)*20+(#a_00_2  & 1)*10+(#a_00_3  & 1)*10+(#a_81_4  & 1)*1+(#a_81_5  & 1)*1+(#a_81_6  & 1)*1+(#a_81_7  & 1)*1+(#a_81_8  & 1)*1+(#a_81_9  & 1)*1+(#a_81_10  & 1)*1) >=27
