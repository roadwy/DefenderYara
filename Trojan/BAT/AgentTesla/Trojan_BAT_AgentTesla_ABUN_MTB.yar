...
rule Trojan_BAT_AgentTesla_ABUN_MTB{
	...
	strings :
		$a_03_0 = {16 0d 2b 1d 07 09 18 6f 90 01 01 00 00 0a 1f 10 28 90 01 01 00 00 0a 13 05 08 11 05 6f 90 01 01 00 00 0a 09 18 58 0d 09 07 6f 90 01 01 00 00 0a 32 da 90 00 } //4
