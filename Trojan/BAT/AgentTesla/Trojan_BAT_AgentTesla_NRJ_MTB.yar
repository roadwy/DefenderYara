...
rule Trojan_BAT_AgentTesla_NRJ_MTB{
	...
	strings :
		$a_01_0 = {24 65 37 65 62 61 33 33 32 2d 37 34 35 65 2d 34 31 33 39 2d 39 39 35 66 2d 63 61 31 35 36 36 36 65 63 31 61 33 } //01 00  $e7eba332-745e-4139-995f-ca15666ec1a3
		$a_01_1 = {44 61 69 6c 79 4e 6f 74 65 73 2e 52 65 73 6f 75 72 63 65 73 2e 72 65 73 6f 75 72 63 65 73 } //01 00  DailyNotes.Resources.resources
