...
rule Trojan_BAT_AgentTesla_NDG_MTB{
	...
	strings :
		...
		$a_01_5 = {49 5f 30 30 30 30 30 30 33 } //01 00 
		$a_01_6 = {49 5f 30 30 30 30 30 30 38 } //01 00 
		$a_01_7 = {49 5f 30 32 30 33 } //01 00 
		$a_01_8 = {49 5f 30 39 33 31 32 33 31 32 33 } //01 00 
		$a_81_9 = {42 75 2d 6e 69 2d 2d 66 75 5f 54 2d 2d 65 78 2d 2d 74 42 6f 2d 2d 2d 78 } //00 00 
	condition:
		any of ($a_*)
