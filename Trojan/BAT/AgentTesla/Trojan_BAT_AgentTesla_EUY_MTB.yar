...
rule Trojan_BAT_AgentTesla_EUY_MTB{
	...
	strings :
		$a_01_0 = {35 00 44 00 38 00 46 00 48 00 45 00 47 00 47 00 42 00 34 00 47 00 47 00 48 00 46 00 35 00 35 00 48 00 41 00 37 00 34 00 56 00 43 00 } //01 00 
		$a_01_1 = {43 00 6f 00 66 00 66 00 65 00 65 00 } //01 00 
