...
rule Trojan_BAT_AgentTesla_L_MTB{
	...
	strings :
		$a_00_0 = {47 65 74 52 75 6e 6e 69 6e 67 44 6f 63 75 6d 65 6e 74 73 45 6e 75 6d } //01 00 
		$a_00_1 = {53 79 73 74 65 6d 2e 49 4f 2e 43 6f 6d 70 72 65 73 73 69 6f 6e } //01 00 
		$a_00_2 = {49 45 6e 75 6d 52 75 6e 6e 69 6e 67 44 6f 63 75 6d 65 6e 74 73 } //01 00 
		$a_00_3 = {49 50 41 64 64 72 65 73 73 } //01 00 
