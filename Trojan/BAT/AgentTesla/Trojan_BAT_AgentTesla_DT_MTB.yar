...
rule Trojan_BAT_AgentTesla_DT_MTB{
	meta:
		description = "Trojan:BAT/AgentTesla.DT!MTB,SIGNATURE_TYPE_PEHSTR_EXT,19 00 19 00 0d 00 00 14 00 "
		
	strings :
		$a_81_0 = {24 33 64 61 61 38 39 38 30 2d 39 63 65 36 2d 34 37 36 61 2d 39 62 66 30 2d 63 66 38 66 37 35 66 30 35 62 66 33 } //14 00  $3daa8980-9ce6-476a-9bf0-cf8f75f05bf3
		$a_81_1 = {24 65 36 31 33 66 63 66 30 2d 34 35 63 62 2d 34 31 31 30 2d 39 63 61 37 2d 61 64 36 32 64 30 38 34 30 66 65 63 } //01 00  $e613fcf0-45cb-4110-9ca7-ad62d0840fec
		$a_81_2 = {6e 54 61 72 6c 61 73 69 2e 46 6f 72 6d 31 2e 72 65 73 6f 75 72 63 65 73 } //01 00  nTarlasi.Form1.resources
		$a_81_3 = {43 6c 6f 63 6b 4c 6f 67 69 63 2e 4d 61 69 6e 2e 72 65 73 6f 75 72 63 65 73 } //01 00  ClockLogic.Main.resources
