...
rule Trojan_BAT_AgentTesla_NWB_MTB{
	...
	strings :
		$a_01_0 = {1f 61 95 2e 03 17 2b 01 16 7e 19 00 00 04 7e 21 00 00 04 19 9a 20 4f 09 00 00 95 e0 95 7e 21 00 00 04 19 9a 20 9f 08 00 00 95 61 7e 21 00 00 04 19 9a 20 40 10 00 00 95 2e 09 } //1
