...
rule Trojan_BAT_AgentTesla_LTS_MTB{
	meta:
		description = "Trojan:BAT/AgentTesla.LTS!MTB,SIGNATURE_TYPE_PEHSTR_EXT,09 00 09 00 09 00 00 "
		
	strings :
		$a_01_0 = {64 00 5f 00 ac 00 5f 00 5f 00 71 00 5f 00 4c 00 62 00 5f 00 b3 00 5f 00 97 00 70 00 5f 00 65 00 64 00 5f 00 5f } //1
		$a_01_1 = {68 00 5f 00 a5 00 61 00 af 00 91 00 5f 00 6b 00 6a 00 5f 00 9f 00 61 00 97 00 7e 00 5f 00 5f 00 62 00 5f 00 4e } //1
		$a_01_2 = {24 32 32 30 30 66 36 39 65 2d 37 36 35 35 2d 34 64 39 62 2d 61 30 64 63 2d 38 38 39 35 39 63 36 62 64 66 36 34 } //1 $2200f69e-7655-4d9b-a0dc-88959c6bdf64
