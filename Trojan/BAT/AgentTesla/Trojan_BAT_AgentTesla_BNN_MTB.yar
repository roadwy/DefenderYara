...
rule Trojan_BAT_AgentTesla_BNN_MTB{
	meta:
		description = "Trojan:BAT/AgentTesla.BNN!MTB,SIGNATURE_TYPE_PEHSTR_EXT,0f 00 0f 00 0f 00 00 01 00 "
	...
	strings :
		...
		$a_81_13 = {47 65 74 44 6f 6d 61 69 6e } //01 00  GetDomain
		$a_81_14 = {62 79 74 65 73 54 6f 44 65 63 6f 6d 70 72 65 73 73 } //00 00  bytesToDecompress
	condition:
		any of ($a_*)
