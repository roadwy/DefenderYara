...
rule Trojan_BAT_AgentTesla_NTX_MTB{
	...
	strings :
		...
		$a_01_1 = {66 33 36 64 39 33 31 37 64 61 30 65 } //01 00  f36d9317da0e
		$a_01_2 = {34 65 36 36 33 66 61 65 2d 39 31 64 65 } //01 00  4e663fae-91de
		$a_01_3 = {4f 76 65 72 73 69 6b 74 2e 50 72 6f 70 65 72 74 69 65 } //01 00  Oversikt.Propertie
