...
rule Trojan_BAT_AgentTesla_BRM_MTB{
	...
	strings :
		$a_81_0 = {66 6c 6f 72 61 } //01 00  flora
		...
		$a_81_10 = {46 6f 72 6d 44 65 6c 65 67 61 74 65 73 } //01 00  FormDelegates
		$a_81_11 = {4f 66 66 73 65 74 4d 61 72 73 68 61 6c 65 72 } //01 00  OffsetMarshaler
		$a_81_12 = {52 65 74 75 72 6e 4d 65 73 73 61 67 65 } //01 00  ReturnMessage
		$a_81_13 = {49 6e 76 6f 6b 65 } //00 00  Invoke
	condition:
		any of ($a_*)
