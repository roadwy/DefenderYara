...
rule Trojan_BAT_AgentTesla_MB_MTB_2{
	...
	strings :
		$a_81_0 = {45 6d 61 69 6c 20 43 68 65 63 6b 65 72 20 50 72 6f } //03 00  Email Checker Pro
		$a_81_1 = {55 4c 45 73 65 } //03 00  ULEse
		$a_81_2 = {64 69 73 63 6f 72 64 61 70 70 2e 63 6f 6d 2f 61 74 74 61 63 68 6d 65 6e 74 73 } //03 00  discordapp.com/attachments
		$a_81_3 = {33 74 67 5f 78 73 67 } //03 00  3tg_xsg
		$a_81_4 = {71 66 61 2f 74 69 5f 30 74 69 5f } //00 00  qfa/ti_0ti_
	condition:
		any of ($a_*)
...
rule Trojan_BAT_AgentTesla_MB_MTB_3{
	...
	strings :
		...
		$a_01_5 = {67 65 74 5f 50 72 6f 63 65 73 73 6f 72 43 6f 75 6e 74 } //00 00  get_ProcessorCount
	condition:
		any of ($a_*)
...
rule Trojan_BAT_AgentTesla_MB_MTB_4{
	...
	strings :
		...
		$a_01_7 = {67 65 74 5f 4d 6f 75 73 65 4f 76 65 72 42 61 63 6b 67 72 6f 75 6e 64 } //01 00  get_MouseOverBackground
		$a_01_8 = {53 65 74 53 74 61 74 65 4d 61 63 68 69 6e 65 } //01 00  SetStateMachine
		$a_01_9 = {67 65 74 5f 4b 65 79 } //01 00  get_Key
		$a_01_10 = {44 65 62 75 67 } //01 00  Debug
		$a_01_11 = {67 65 74 5f 43 61 70 73 4c 6f 63 6b } //00 00  get_CapsLock
	condition:
		any of ($a_*)
