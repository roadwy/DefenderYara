...
rule Trojan_BAT_AgentTesla_MBCT_MTB{
	...
	strings :
		$a_03_0 = {0a 0d 00 08 09 28 90 01 01 00 00 0a 02 28 90 01 01 00 00 06 6f 90 02 10 6f 46 00 00 0a 00 08 18 6f 90 01 01 00 00 0a 00 08 6f 90 01 01 00 00 0a 13 04 07 13 05 11 04 11 05 16 11 05 8e 69 6f 49 00 00 0a 0a de 11 90 00 } //1
...
rule Trojan_BAT_AgentTesla_MBCT_MTB_2{
	...
	strings :
		$a_03_0 = {08 07 11 07 18 6f 90 01 01 00 00 0a 1f 10 28 90 01 01 00 00 0a 6f 90 01 01 00 00 0a 00 11 07 18 d6 13 07 11 07 11 06 31 dd 90 00 } //1
