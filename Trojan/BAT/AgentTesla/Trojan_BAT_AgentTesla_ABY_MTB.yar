...
rule Trojan_BAT_AgentTesla_ABY_MTB_2{
	...
	strings :
		...
		$a_01_1 = {49 5a 48 73 2e 67 2e 72 65 73 6f 75 72 63 65 73 } //01 00 
		...
		$a_01_3 = {59 00 35 00 74 00 46 00 76 00 55 00 38 00 45 00 59 00 } //01 00 
		$a_01_4 = {44 00 61 00 76 00 69 00 73 00 31 00 31 00 2e 00 50 00 72 00 6f 00 70 00 65 00 72 00 74 00 69 00 65 00 73 00 2e 00 52 00 65 00 73 00 6f 00 75 00 72 00 63 00 65 00 73 00 } //00 00 
	condition:
		any of ($a_*)
