...
rule Trojan_BAT_AgentTesla_BQI_MTB{
	meta:
		description = "Trojan:BAT/AgentTesla.BQI!MTB,SIGNATURE_TYPE_PEHSTR_EXT,0f 00 0f 00 10 00 00 01 00 "
	...
	strings :
		...
		$a_02_14 = {44 00 53 00 44 00 53 00 90 02 04 53 00 53 00 53 00 53 00 53 00 53 00 53 00 53 00 53 00 53 00 53 00 53 00 53 00 53 00 53 00 53 00 53 00 53 00 53 00 53 00 53 00 53 00 53 00 53 00 53 00 53 00 53 00 53 00 53 00 53 00 90 00 } //01 00 
		$a_02_15 = {44 53 44 53 90 02 04 53 53 53 53 53 53 53 53 53 53 53 53 53 53 53 53 53 53 53 53 53 53 53 53 53 53 53 53 53 53 90 00 } //00 00 
	condition:
		any of ($a_*)
