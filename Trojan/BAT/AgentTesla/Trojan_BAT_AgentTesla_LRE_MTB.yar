...
rule Trojan_BAT_AgentTesla_LRE_MTB{
	...
	strings :
		$a_03_0 = {0a 0c 06 03 07 6f 90 01 03 0a 0d 12 03 28 90 01 03 0a 08 6f 90 01 03 0a 0a 07 17 58 0b 00 17 13 04 2b d7 90 00 } //1
		$a_03_1 = {0a 06 61 20 90 01 03 01 5a 0a 07 17 58 0b 07 02 6f 90 00 } //1
