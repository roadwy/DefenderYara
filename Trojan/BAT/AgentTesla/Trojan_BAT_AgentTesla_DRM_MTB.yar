...
rule Trojan_BAT_AgentTesla_DRM_MTB{
	...
	strings :
		...
		$a_01_4 = {00 47 65 74 54 79 70 65 73 00 } //01 00  䜀瑥祔数s
		$a_01_5 = {00 43 72 65 61 74 65 49 6e 73 74 61 6e 63 65 00 } //01 00  䌀敲瑡䥥獮慴据e
		$a_01_6 = {24 63 32 37 61 32 61 65 33 2d 31 63 66 33 2d 34 37 33 62 2d 38 66 37 34 2d 37 64 38 34 66 64 65 63 65 64 31 37 } //01 00  $c27a2ae3-1cf3-473b-8f74-7d84fdeced17
		$a_01_7 = {00 47 65 74 54 79 70 65 46 72 6f 6d 48 61 6e 64 6c 65 00 } //01 00 
		$a_01_8 = {00 44 65 62 75 67 67 65 72 42 72 6f 77 73 61 62 6c 65 53 74 61 74 65 00 } //01 00  䐀扥杵敧䉲潲獷扡敬瑓瑡e
