...
rule Trojan_BAT_AgentTesla_NZ_MTB{
	...
	strings :
		...
		$a_01_1 = {34 39 63 37 61 33 62 66 39 37 33 37 } //00 00  49c7a3bf9737
	condition:
		any of ($a_*)
...
rule Trojan_BAT_AgentTesla_NZ_MTB_2{
	...
	strings :
		$a_81_0 = {48 52 48 41 35 34 34 37 45 38 35 4e 56 34 35 35 51 37 37 4f 54 41 78 } //01 00  HRHA5447E85NV455Q77OTAx
		$a_01_1 = {44 65 62 75 67 67 61 62 6c 65 41 74 74 72 69 62 75 74 65 } //01 00  DebuggableAttribute
		$a_01_2 = {44 65 62 75 67 67 69 6e 67 4d 6f 64 65 73 } //00 00  DebuggingModes
	condition:
		any of ($a_*)
...
rule Trojan_BAT_AgentTesla_NZ_MTB_3{
	...
	strings :
		...
		$a_01_1 = {57 65 61 74 68 65 72 4f 62 73 65 72 76 65 72 2e 50 72 6f 70 65 72 74 69 65 73 2e 52 65 73 6f 75 72 63 65 73 2e 72 65 73 6f 75 72 63 65 } //01 00  WeatherObserver.Properties.Resources.resource
		$a_01_2 = {34 64 33 37 62 38 37 62 64 63 66 39 } //00 00  4d37b87bdcf9
	condition:
		any of ($a_*)
