...
rule Trojan_BAT_AgentTesla_NZ_MTB{
	...
	strings :
		$a_03_0 = {0a 18 13 06 2b 96 06 1f 11 d8 0b 1f 10 8d 90 01 03 01 0c 17 0d 1a 90 00 } //1
...
rule Trojan_BAT_AgentTesla_NZ_MTB_3{
	...
	strings :
		$a_03_0 = {02 03 17 58 90 01 05 5d 91 13 00 90 00 } //1
...
rule Trojan_BAT_AgentTesla_NZ_MTB_4{
	...
	strings :
		$a_02_0 = {9a 0c 08 19 8d 90 02 04 25 16 7e 90 02 04 a2 25 17 7e 90 02 04 a2 25 18 72 90 02 04 a2 28 90 02 04 26 20 90 02 04 0a 2b 90 09 0e 00 28 90 02 04 0b 07 6f 90 02 04 1f 90 00 } //1
		$a_02_1 = {10 04 02 0e 04 28 90 02 04 28 90 02 04 26 2a 90 09 13 00 28 90 02 05 02 0e 90 01 01 28 90 02 04 28 90 00 } //1
	condition:
