...
rule Trojan_BAT_AgentTesla_LUL_MTB{
	...
	strings :
		$a_01_0 = {24 33 32 36 33 35 38 33 61 2d 33 65 39 36 2d 34 63 63 65 2d 38 63 39 62 2d 65 37 61 39 61 33 38 61 64 66 61 30 } //01 00  $3263583a-3e96-4cce-8c9b-e7a9a38adfa0
