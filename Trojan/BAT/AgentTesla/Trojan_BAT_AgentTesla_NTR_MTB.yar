...
rule Trojan_BAT_AgentTesla_NTR_MTB{
	...
	strings :
		$a_03_0 = {20 00 01 00 00 0a 03 04 20 00 04 01 00 5d 03 02 20 00 04 01 00 04 28 ?? ?? ?? 06 03 04 17 58 20 00 04 01 00 5d 91 28 ?? ?? ?? 06 59 06 58 06 5d 28 ?? ?? ?? 06 9c 03 0b 2b 00 } //1
		$a_03_1 = {02 05 04 5d 91 03 05 1f 16 5d 6f ?? ?? ?? 0a 61 28 ?? ?? ?? 06 0a 2b 00 06 2a } //1
	condition:
