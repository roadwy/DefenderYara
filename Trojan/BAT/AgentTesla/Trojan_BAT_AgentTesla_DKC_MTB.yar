...
rule Trojan_BAT_AgentTesla_DKC_MTB{
	meta:
		description = "Trojan:BAT/AgentTesla.DKC!MTB,SIGNATURE_TYPE_PEHSTR_EXT,0a 00 0a 00 0a 00 00 01 00 "
	...
	strings :
		...
		$a_01_2 = {00 41 63 63 6f 75 6e 74 44 6f 6d 61 69 6e 53 69 64 00 } //01 00  䄀捣畯瑮潄慭湩楓d
		...
		$a_01_6 = {54 6f 4c 6f 77 65 72 } //01 00  ToLower
		$a_01_7 = {00 47 65 74 54 79 70 65 46 72 6f 6d 48 61 6e 64 6c 65 00 } //01 00 
		$a_01_8 = {47 00 2d 00 65 00 2d 00 74 00 2d 00 4d 00 2d 00 65 00 2d 00 74 00 2d 00 68 00 2d 00 6f 00 2d 00 64 00 } //01 00  G-e-t-M-e-t-h-o-d
		$a_01_9 = {00 58 58 58 58 58 58 58 58 58 58 58 58 58 58 58 58 30 39 38 37 36 35 34 33 32 31 00 } //00 00  堀塘塘塘塘塘塘塘じ㠹㘷㐵㈳1
	condition:
		any of ($a_*)
