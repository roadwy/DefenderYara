...
rule Trojan_BAT_AgentTesla_NYZ_MTB{
	...
	strings :
		$a_01_0 = {24 65 63 38 65 30 63 32 39 2d 34 39 36 63 2d 34 66 38 61 2d 62 34 66 65 2d 61 39 35 36 66 30 36 63 32 35 34 66 } //01 00  $ec8e0c29-496c-4f8a-b4fe-a956f06c254f
