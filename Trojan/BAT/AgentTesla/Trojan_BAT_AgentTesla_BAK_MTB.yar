...
rule Trojan_BAT_AgentTesla_BAK_MTB{
	...
	strings :
		$a_03_0 = {0c 16 13 07 2b 1a 08 11 07 07 11 07 9a 1f 10 28 90 01 01 00 00 0a 6f 90 01 01 00 00 0a 00 11 07 17 58 13 07 11 07 07 8e 69 fe 04 13 08 11 08 2d d9 90 00 } //1
