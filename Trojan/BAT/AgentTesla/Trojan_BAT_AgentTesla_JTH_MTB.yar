...
rule Trojan_BAT_AgentTesla_JTH_MTB{
	...
	strings :
		$a_81_0 = {68 74 74 70 73 3a 2f 2f 67 68 67 68 67 68 66 68 66 68 66 68 2e 30 30 30 77 65 62 68 6f 73 74 61 70 70 2e 63 6f 6d 2f 52 75 6e 50 45 2e 64 6c 6c } //01 00  https://ghghghfhfhfh.000webhostapp.com/RunPE.dll
