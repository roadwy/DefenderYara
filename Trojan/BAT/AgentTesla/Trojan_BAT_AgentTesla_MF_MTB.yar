...
rule Trojan_BAT_AgentTesla_MF_MTB{
	...
	strings :
		...
		$a_03_1 = {0d 08 09 28 ?? ?? ?? 06 09 16 6a 6f ?? ?? ?? 0a 09 13 04 dd 2d 01 00 00 20 00 00 af 0d fe 0e 06 00 00 fe 0d 06 00 48 68 d3 13 05 2b 0a } //1
...
rule Trojan_BAT_AgentTesla_MF_MTB_2{
	...
	strings :
		$a_03_0 = {0b 2b f3 72 ?? 00 00 70 28 ?? ?? ?? 0a 13 07 11 07 14 fe 03 13 08 11 08 2c 57 11 07 6f ?? ?? ?? 0a 0a 06 14 fe 03 13 09 11 09 2c 45 06 6f ?? ?? ?? 0a 0b 73 ?? 00 00 0a 0c 20 00 04 00 00 8d 03 00 00 01 13 04 07 11 04 16 11 04 8e 69 6f ?? ?? ?? 0a 13 05 08 11 04 16 11 05 6f ?? ?? ?? 0a 11 06 11 05 58 13 06 11 05 16 fe 02 13 0a 11 0a 2d d4 } //1
