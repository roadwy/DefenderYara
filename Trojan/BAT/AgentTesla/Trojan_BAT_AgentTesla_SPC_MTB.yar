...
rule Trojan_BAT_AgentTesla_SPC_MTB{
	...
	strings :
		...
		$a_01_1 = {50 00 64 00 49 00 41 00 65 00 44 00 67 00 64 00 55 00 70 00 49 00 36 00 66 00 75 00 58 00 50 00 79 00 71 00 6d 00 72 00 32 00 30 00 65 00 6d 00 4a 00 61 00 47 00 5a 00 50 00 35 00 74 00 69 00 } //00 00 
	condition:
		any of ($a_*)
