...
rule Trojan_BAT_AgentTesla_DNV_MTB{
	meta:
		description = "Trojan:BAT/AgentTesla.DNV!MTB,SIGNATURE_TYPE_PEHSTR_EXT,08 00 08 00 08 00 00 01 00 "
		
	strings :
		$a_01_0 = {54 00 30 00 6f 00 30 00 57 00 69 00 30 00 6e 00 30 00 33 00 30 00 32 00 } //01 00  T0o0Wi0n0302
