...
rule Trojan_BAT_AgentTesla_NRT_MTB{
	...
	strings :
		...
		$a_01_1 = {53 79 73 74 65 6d 2e 43 6f 64 65 44 6f 6d 2e 43 6f 6d 70 69 6c 65 72 } //01 00  System.CodeDom.Compiler
		...
		$a_01_3 = {53 79 73 74 65 6d 2e 52 65 66 6c 65 63 74 69 6f 6e } //00 00  System.Reflection
	condition:
		any of ($a_*)
