...
rule Trojan_BAT_AgentTesla_BSO_MTB{
	...
	strings :
		...
		$a_02_1 = {02 03 05 03 8e 69 5d 91 05 04 03 8e 69 5d d6 04 5f 61 b4 7e 90 01 04 20 90 01 04 7e 90 01 04 20 90 01 04 93 05 60 1f 37 5f 9d 61 fe 0b 00 00 19 0c 90 00 } //10
