...
rule Trojan_BAT_AgentTesla_NKE_MTB{
	...
	strings :
		$a_01_0 = {24 65 36 66 37 35 33 38 31 2d 38 64 33 38 2d 34 64 64 64 2d 38 65 30 33 2d 64 37 35 61 30 66 36 65 37 37 34 30 } //01 00 
		...
		$a_01_7 = {44 65 62 75 67 67 65 72 53 74 65 70 54 68 72 6f 75 67 68 41 74 74 72 69 62 75 74 65 } //00 00 
	condition:
		any of ($a_*)
