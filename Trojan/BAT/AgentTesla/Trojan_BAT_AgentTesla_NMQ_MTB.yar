...
rule Trojan_BAT_AgentTesla_NMQ_MTB{
	...
	strings :
		$a_01_0 = {56 73 72 72 70 2e 50 72 6f 70 65 72 74 69 65 73 2e 52 65 73 6f 75 72 63 65 73 2e 72 65 73 6f 75 72 63 65 73 } //0a 00  Vsrrp.Properties.Resources.resources
