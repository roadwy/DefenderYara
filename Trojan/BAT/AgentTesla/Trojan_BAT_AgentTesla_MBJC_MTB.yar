...
rule Trojan_BAT_AgentTesla_MBJC_MTB{
	...
	strings :
		$a_01_0 = {4a 00 56 00 4e 00 4a 00 2a 00 41 00 44 00 2a 00 2a 00 41 00 5f 00 2a 00 2a 00 41 00 50 00 37 00 37 00 59 00 2a 00 43 00 34 00 2a 00 2a 00 2a 00 2a 00 2a 00 41 00 43 00 2a 00 2a 00 } //01 00  JVNJ*AD**A_**AP77Y*C4*****AC**
