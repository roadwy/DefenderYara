...
rule Trojan_BAT_AgentTesla_LNA_MTB{
	...
	strings :
		$a_03_0 = {13 05 2b 31 00 09 11 04 11 05 6f 90 01 03 0a 13 06 09 11 04 11 05 6f 90 01 03 0a 13 07 17 13 08 00 08 07 02 11 07 28 90 01 03 06 d2 9c 00 00 11 05 17 58 13 05 11 05 17 fe 04 13 09 11 09 2d c4 90 00 } //1
...
rule Trojan_BAT_AgentTesla_LNA_MTB_2{
	...
	strings :
		$a_03_0 = {0a 0c 07 08 6f 90 01 03 0a 07 18 6f 90 01 03 0a 07 6f 90 01 03 0a 02 16 02 8e 69 6f 90 01 03 0a 0d de 15 90 00 } //1
