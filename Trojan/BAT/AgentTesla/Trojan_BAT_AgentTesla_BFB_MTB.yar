...
rule Trojan_BAT_AgentTesla_BFB_MTB_2{
	...
	strings :
		$a_81_0 = {47 61 72 72 69 78 2e 45 78 70 6c 6f 72 65 72 31 } //0a 00 
		$a_81_1 = {53 55 50 45 52 4d 45 } //01 00 
		...
		$a_81_6 = {41 70 70 65 6e 64 } //01 00 
		$a_81_7 = {53 75 62 73 74 72 69 6e 67 } //01 00 
		$a_81_8 = {54 6f 53 74 72 69 6e 67 } //01 00 
		$a_81_9 = {53 79 73 74 65 6d 2e 43 6f 6e 76 65 72 74 } //00 00 
	condition:
		any of ($a_*)
