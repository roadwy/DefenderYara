...
rule Trojan_BAT_AgentTesla_EAV_MTB{
	...
	strings :
		$a_03_0 = {0b 16 0c 2b 1f 00 07 08 02 08 91 6e 08 06 5d 28 ?? 00 00 06 6a 59 20 ff 00 00 00 6a 5f d2 9c 00 08 17 58 0c 08 02 8e 69 fe 04 13 04 11 04 2d d5 } //5
	condition:
		((#a_03_0  & 1)*5) >=5
...
rule Trojan_BAT_AgentTesla_EAV_MTB_2{
	...
	strings :
		$a_03_0 = {16 0b 2b 21 11 04 06 07 6f ?? ?? ?? 0a 13 05 11 05 28 ?? ?? ?? 0a 13 06 09 11 06 d2 6f ?? ?? ?? 0a 07 17 58 0b 07 17 fe 04 13 07 11 07 2d d5 08 17 58 0c 06 17 58 0a } //1
