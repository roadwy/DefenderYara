...
rule Trojan_BAT_AgentTesla_NOB_MTB{
	...
	strings :
		$a_01_0 = {24 39 37 34 38 64 64 65 64 2d 65 37 36 61 2d 34 64 63 36 2d 39 30 36 31 2d 63 35 36 39 33 35 63 32 34 66 62 36 } //1 $9748dded-e76a-4dc6-9061-c56935c24fb6
		$a_01_1 = {56 65 6e 64 69 6e 67 4d 61 63 68 69 6e 65 4d 6b 32 2e 50 72 6f 70 65 72 74 69 65 73 2e 52 65 73 6f 75 72 63 65 73 2e 72 65 73 6f 75 72 63 65 } //1 VendingMachineMk2.Properties.Resources.resource
