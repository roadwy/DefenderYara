...
rule Trojan_BAT_AgentTesla_GAK_MTB{
	...
	strings :
		$a_03_0 = {13 04 16 0b 16 0a 2b 2d 16 0a 2b 1c 09 07 06 6f 90 01 01 00 00 0a 13 07 11 04 12 07 28 90 01 01 00 00 0a 6f 90 01 01 00 00 0a 06 17 58 0a 06 09 6f 90 01 01 00 00 0a 32 db 90 00 } //4
