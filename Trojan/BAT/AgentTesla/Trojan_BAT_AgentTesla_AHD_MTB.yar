...
rule Trojan_BAT_AgentTesla_AHD_MTB{
	...
	strings :
		$a_03_0 = {07 02 08 18 5a 18 6f 90 01 03 0a 1f 10 28 90 01 03 0a 6f 90 01 03 0a 00 00 08 17 58 0c 08 06 fe 04 0d 09 2d da 90 00 } //10
		$a_03_1 = {16 9a 13 05 11 05 14 72 90 01 03 70 17 8d 90 01 03 01 25 16 72 90 01 03 70 a2 14 14 28 90 01 03 0a 13 06 11 06 14 72 90 01 03 70 18 8d 90 01 03 01 25 16 16 8c 90 01 03 01 a2 25 17 06 a2 14 14 90 00 } //10
