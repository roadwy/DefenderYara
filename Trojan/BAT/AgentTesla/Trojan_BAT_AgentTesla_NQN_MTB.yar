...
rule Trojan_BAT_AgentTesla_NQN_MTB{
	meta:
		description = "Trojan:BAT/AgentTesla.NQN!MTB,SIGNATURE_TYPE_PEHSTR_EXT,07 00 07 00 07 00 00 01 00 "
		
	strings :
		$a_01_0 = {24 61 62 61 38 32 30 33 36 2d 65 31 33 39 2d 34 30 63 35 2d 62 37 34 65 2d 65 32 61 30 61 61 65 37 37 66 39 66 } //01 00  $aba82036-e139-40c5-b74e-e2a0aae77f9f
		$a_01_1 = {4b 6f 61 68 6f 68 2e 50 72 6f 70 65 72 74 69 65 73 2e 52 65 73 6f 75 72 63 65 73 2e 72 65 73 6f 75 72 63 65 73 } //01 00  Koahoh.Properties.Resources.resources
