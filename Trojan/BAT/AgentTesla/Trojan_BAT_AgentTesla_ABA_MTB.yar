...
rule Trojan_BAT_AgentTesla_ABA_MTB{
	...
	strings :
		$a_03_0 = {2b 1d 09 6f 90 02 03 0a 13 07 08 11 07 07 02 11 07 18 5a 18 6f 90 02 03 0a 6f 90 02 03 0a 9c 09 6f 90 00 } //2
