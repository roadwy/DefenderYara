...
rule Trojan_BAT_AgentTesla_ASAQ_MTB{
	...
	strings :
		...
		$a_01_1 = {35 00 38 00 39 00 38 00 43 00 32 00 59 00 45 00 35 00 53 00 34 00 42 00 34 00 50 00 42 00 42 00 38 00 45 00 34 00 43 00 34 00 35 00 } //00 00  5898C2YE5S4B4PBB8E4C45
	condition:
		any of ($a_*)
