...
rule Trojan_BAT_AgentTesla_DCZ_MTB{
	...
	strings :
		$a_03_0 = {09 11 04 11 05 6f 90 01 03 0a 13 07 09 11 04 11 05 6f 90 01 03 0a 13 08 11 08 28 90 01 03 0a 13 09 08 07 11 09 28 90 01 03 0a 9c 00 11 05 17 58 13 05 11 05 09 6f 90 01 03 0a fe 04 13 0a 11 0a 2d bd 90 00 } //1
