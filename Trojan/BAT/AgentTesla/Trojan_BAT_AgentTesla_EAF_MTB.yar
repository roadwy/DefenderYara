...
rule Trojan_BAT_AgentTesla_EAF_MTB{
	...
	strings :
		$a_03_0 = {0c 16 0d 2b 10 07 08 09 93 66 d1 6f 90 01 01 00 00 0a 26 09 17 58 0d 09 08 8e 69 fe 04 13 04 11 04 2d e4 90 00 } //1
		$a_03_1 = {16 fe 01 2b 01 16 0b 07 2c 10 02 17 9a 28 90 01 01 00 00 0a 28 90 01 01 00 00 06 0a 2b 03 1f 28 0a 06 0c 08 2a 90 00 } //1
