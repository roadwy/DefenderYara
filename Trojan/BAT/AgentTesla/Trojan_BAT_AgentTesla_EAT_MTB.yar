...
rule Trojan_BAT_AgentTesla_EAT_MTB{
	...
	strings :
		$a_03_0 = {0b 06 16 73 ?? 00 00 0a 73 ?? 00 00 0a 0c 08 07 6f ?? 00 00 0a 07 6f ?? 00 00 0a 28 ?? 00 00 2b 28 ?? 00 00 2b 0d de 1e 08 2c 06 08 6f ?? 00 00 0a dc 07 2c 06 07 6f ?? 00 00 0a dc 06 2c 06 06 6f ?? 00 00 0a dc 09 2a } //3
