...
rule Trojan_BAT_AgentTesla_OA_MTB{
	...
	strings :
		$a_01_0 = {50 61 72 61 6d 70 61 61 } //01 00  Parampaa
		...
		$a_01_3 = {41 72 72 61 79 00 43 6f 70 79 } //01 00  牁慲y潃祰
		$a_01_4 = {47 00 4f 00 44 00 6f 00 66 00 42 00 65 00 61 00 75 00 74 00 79 00 } //00 00  GODofBeauty
	condition:
		any of ($a_*)
