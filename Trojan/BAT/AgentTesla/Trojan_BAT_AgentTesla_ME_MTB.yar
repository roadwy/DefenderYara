...
rule Trojan_BAT_AgentTesla_ME_MTB{
	...
	strings :
		$a_03_0 = {06 07 03 07 91 02 7b [0-04] 16 9a 6f [0-04] d2 02 7b [0-04] 17 9a 6f [0-04] d2 61 d2 61 d2 9c } //10
...
rule Trojan_BAT_AgentTesla_ME_MTB_3{
	...
	strings :
		$a_03_0 = {0d 09 08 6f 67 00 00 0a 00 09 18 6f 68 00 00 0a 00 09 6f 69 00 00 0a 06 16 06 8e 69 6f 6a 00 00 0a 13 04 11 04 03 28 19 00 00 06 28 18 00 00 06 72 ?? ?? ?? 70 6f 6b 00 00 0a 80 0b 00 00 04 02 03 73 54 00 00 0a 13 05 2b 00 11 05 2a } //1
