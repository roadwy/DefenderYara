...
rule Trojan_BAT_AgentTesla_MZ_MTB_2{
	...
	strings :
		$a_81_0 = {24 37 34 63 64 62 65 30 37 2d 61 39 35 62 2d 34 38 31 61 2d 39 64 38 35 2d 35 35 34 36 65 64 36 31 35 34 64 38 } //01 00 
		$a_81_1 = {52 65 63 6f 72 64 42 67 79 53 79 73 74 65 6d 2e 4d 79 2e 52 65 73 6f 75 72 63 65 73 } //01 00 
		$a_81_2 = {67 65 74 5f 5f 41 6e 79 5f 62 6c 6f 74 74 65 72 5f 72 65 63 6f 72 64 5f } //01 00 
		$a_81_3 = {66 72 6d 52 62 69 5f 4c 6f 61 64 } //01 00 
		$a_81_4 = {67 65 74 5f 6c 62 6c 54 6f 74 61 6c 43 65 72 66 } //01 00 
		$a_81_5 = {43 65 72 66 44 69 61 6c 6f 67 64 65 6c 65 74 65 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_BAT_AgentTesla_MZ_MTB_3{
	...
	strings :
		...
		$a_01_1 = {66 73 61 66 73 61 66 73 61 66 61 } //01 00 
		$a_01_2 = {47 65 74 42 79 74 65 73 } //01 00 
		$a_01_3 = {43 72 65 61 74 65 44 65 63 72 79 70 74 6f 72 } //01 00 
		$a_01_4 = {63 6d 69 6e 75 74 65 5f 4c 6f 61 64 } //01 00 
		$a_01_5 = {44 6f 77 6e 6c 6f 61 64 44 61 74 61 } //01 00 
		$a_01_6 = {61 00 66 00 61 00 73 00 66 00 73 00 61 00 66 00 73 00 61 00 66 00 73 00 61 00 66 00 73 00 61 00 66 00 61 00 73 00 41 00 46 00 53 00 41 00 46 00 } //00 00 
	condition:
		any of ($a_*)
