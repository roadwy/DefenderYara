...
rule Trojan_BAT_AgentTesla_BFV_MTB{
	...
	strings :
		$a_02_0 = {06 16 9a 18 3a 90 01 04 26 38 90 01 04 11 01 02 28 90 01 03 06 6f 90 01 03 0a 11 00 11 01 6f 90 01 03 0a 6f 90 01 03 0a 1e 3a 90 01 04 26 11 02 17 8d 90 01 03 01 25 16 02 28 90 01 03 06 a2 6f 90 01 03 0a 74 90 00 } //10
