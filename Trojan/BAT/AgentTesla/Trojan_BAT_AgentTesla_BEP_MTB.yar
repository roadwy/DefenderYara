...
rule Trojan_BAT_AgentTesla_BEP_MTB{
	...
	strings :
		$a_02_0 = {07 09 16 11 04 6f 90 01 03 0a 2b 00 11 04 09 8e 69 2e 02 2b 0f 08 09 16 09 8e 69 6f 90 01 03 0a 13 04 2b 0a 07 28 90 01 03 06 13 05 2b 06 11 04 2c da 2b 90 00 } //10
