...
rule Trojan_BAT_AgentTesla_LVG_MTB{
	...
	strings :
		$a_03_0 = {02 6c 23 ff ?? ?? ?? ?? ?? ?? 3f 5b 28 ?? ?? ?? 0a b7 28 ?? ?? ?? 0a 28 ?? ?? ?? 0a 0b 07 0a 2b 00 06 2a } //1
		...
		$a_03_2 = {0a 13 04 11 04 28 ?? ?? ?? 06 28 ?? ?? ?? 0a 13 05 07 11 05 28 ?? ?? ?? 0a 0b 00 09 17 d6 0d 09 08 6f ?? ?? ?? 0a fe 04 13 06 11 06 2d cc } //1
