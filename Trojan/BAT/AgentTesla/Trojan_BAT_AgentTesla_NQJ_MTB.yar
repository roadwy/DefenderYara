...
rule Trojan_BAT_AgentTesla_NQJ_MTB_2{
	...
	strings :
		$a_81_0 = {31 38 2e 31 37 39 2e 31 31 31 2e 32 34 30 2f 31 62 31 2f 6c 6f 61 64 65 72 2f 75 70 6c 6f 61 64 73 2f } //01 00  18.179.111.240/1b1/loader/uploads/
		...
		$a_01_4 = {47 65 74 52 65 73 70 6f 6e 73 65 } //00 00  GetResponse
	condition:
		any of ($a_*)
