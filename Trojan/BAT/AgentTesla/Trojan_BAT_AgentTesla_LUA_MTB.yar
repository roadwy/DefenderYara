...
rule Trojan_BAT_AgentTesla_LUA_MTB{
	...
	strings :
		$a_03_0 = {0b 2b 23 11 06 06 07 28 90 01 03 06 13 08 11 08 28 90 01 03 0a 13 09 11 04 06 11 09 d2 6f 90 01 03 0a 07 17 58 0b 07 17 fe 04 13 0a 11 0a 2d d3 90 00 } //1
