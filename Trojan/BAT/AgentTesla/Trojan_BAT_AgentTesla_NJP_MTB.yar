...
rule Trojan_BAT_AgentTesla_NJP_MTB{
	...
	strings :
		$a_03_0 = {7e 2a 00 00 04 90 01 01 0a 16 9a 1f 44 95 7e 2a 00 00 04 17 9a 20 a0 0d 00 00 95 61 09 0a 7e 2a 00 00 04 17 9a 20 be 0a 00 00 95 2e 03 16 2b 01 17 7e 2a 00 00 04 17 9a 20 bb 02 00 00 20 90 00 } //1
