...
rule Trojan_BAT_AgentTesla_LSQ_MTB{
	...
	strings :
		$a_01_0 = {0a 0b 07 0a 2b 00 06 2a } //01 00 
		...
		$a_01_2 = {00 5a 5a 5a 5a 5a 5a 5a 5a 5a 5a 5a 5a 5a 5a 5a 5a 5a 5a 5a 5a 5a 5a 5a 5a 5a 5a 5a 5a 5a 5a 5a 5a 5a 5a 5a 5a 5a 5a 5a 5a 00 } //01 00 
