...
rule Trojan_BAT_AgentTesla_AME_MTB{
	...
	strings :
		$a_03_0 = {13 05 12 05 28 ?? ?? ?? 0a 17 da 13 06 16 13 07 2b 21 07 11 04 11 07 6f ?? ?? ?? 0a 13 08 11 08 28 ?? ?? ?? 0a 13 09 08 06 11 09 b4 9c 11 07 17 d6 13 07 11 07 11 06 31 d9 } //10
