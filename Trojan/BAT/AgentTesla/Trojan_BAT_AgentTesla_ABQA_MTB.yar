...
rule Trojan_BAT_AgentTesla_ABQA_MTB{
	...
	strings :
		$a_03_0 = {11 08 11 0a 9a 13 0e 11 09 11 0e 1f 10 28 90 01 03 0a b4 6f 90 01 03 0a 00 11 0a 17 d6 13 0a 00 11 0a 11 08 8e 69 fe 04 13 0f 11 0f 2d d2 90 00 } //5
