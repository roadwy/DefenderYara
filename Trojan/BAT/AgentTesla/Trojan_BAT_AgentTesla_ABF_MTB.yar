...
rule Trojan_BAT_AgentTesla_ABF_MTB_2{
	...
	strings :
		$a_03_0 = {08 09 16 20 90 01 03 00 6f 90 01 03 0a 0b 07 16 fe 02 13 06 11 06 2c 09 06 09 16 07 6f 90 01 03 0a 07 16 fe 02 13 07 11 07 2d d5 06 6f 90 01 03 0a 13 05 de 0a 90 00 } //5
...
rule Trojan_BAT_AgentTesla_ABF_MTB_3{
	...
	strings :
		$a_02_0 = {17 da 13 04 16 13 05 11 05 16 fe 01 13 08 11 08 2c 05 38 c8 00 00 00 00 00 72 90 01 04 03 11 05 18 6f 90 01 04 28 90 01 04 28 90 01 04 07 08 6f 90 01 04 28 90 01 04 6a 61 b7 28 90 01 04 28 90 01 04 13 06 90 00 } //10
...
rule Trojan_BAT_AgentTesla_ABF_MTB_4{
	...
	strings :
		$a_03_0 = {12 17 28 4d 90 01 02 0a 73 4e 90 01 02 0a 0b d0 0e 90 01 02 02 28 19 90 01 02 0a 6f 31 90 01 02 0a 72 52 90 01 02 70 6f 4f 90 01 02 0a 73 50 90 01 02 0a 0c 08 6f 4a 90 01 02 0a 16 6a 6f 4b 90 01 02 0a 08 08 90 0a 43 00 7e 27 90 01 02 04 25 13 26 90 00 } //5
		$a_03_1 = {11 07 11 08 61 13 11 11 06 11 0b 11 11 20 ff 90 01 02 00 5f d2 9c 11 06 11 0b 17 58 11 11 20 00 90 01 02 00 5f 1e 64 d2 9c 11 06 90 00 } //5
