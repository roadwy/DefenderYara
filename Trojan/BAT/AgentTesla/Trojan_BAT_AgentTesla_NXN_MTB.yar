...
rule Trojan_BAT_AgentTesla_NXN_MTB{
	...
	strings :
		$a_81_0 = {48 5a 56 30 42 47 35 43 48 35 47 52 44 45 47 38 47 35 35 42 37 38 } //01 00  HZV0BG5CH5GRDEG8G55B78
		$a_81_1 = {4f 45 2e 50 53 } //01 00  OE.PS
		$a_81_2 = {54 72 61 6e 73 66 6f 72 6d 46 69 6e 61 6c 42 6c 6f 63 6b } //01 00  TransformFinalBlock
