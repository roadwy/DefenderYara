...
rule Trojan_BAT_AgentTesla_AKI_MTB{
	...
	strings :
		$a_03_0 = {70 14 14 28 ?? ?? ?? 0a 6f ?? ?? ?? 0a 16 9a 14 72 ?? ?? ?? 70 17 8d ?? ?? ?? 01 25 16 03 a2 25 13 1c 14 14 17 8d ?? ?? ?? 01 25 16 17 9c 25 13 1d 28 ?? ?? ?? 0a 11 1d 16 91 2d 02 2b 0b 11 1c 16 9a } //10
