...
rule Trojan_BAT_AgentTesla_NTA_MTB{
	...
	strings :
		...
		$a_01_1 = {53 70 6c 61 73 68 54 65 73 74 2e 50 72 6f 70 65 72 74 69 65 73 2e 52 65 73 6f 75 72 63 65 73 } //00 00  SplashTest.Properties.Resources
	condition:
		any of ($a_*)
...
rule Trojan_BAT_AgentTesla_NTA_MTB_2{
	...
	strings :
		...
		$a_81_2 = {40 4c 6f 61 64 40 } //01 00  @Load@
		$a_81_3 = {4d 65 74 68 6f 64 30 } //01 00  Method0
		$a_81_4 = {54 6f 49 6e 74 65 67 65 72 } //01 00  ToInteger
