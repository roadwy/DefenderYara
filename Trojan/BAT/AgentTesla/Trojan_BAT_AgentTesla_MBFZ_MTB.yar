...
rule Trojan_BAT_AgentTesla_MBFZ_MTB{
	meta:
		description = "Trojan:BAT/AgentTesla.MBFZ!MTB,SIGNATURE_TYPE_PEHSTR_EXT,0d 00 0d 00 04 00 00 0a 00 "
		
	strings :
		$a_01_0 = {24 39 62 32 34 34 36 64 61 2d 63 37 39 64 2d 34 33 30 61 2d 62 31 62 30 2d 64 30 31 63 30 32 61 35 38 65 63 31 } //01 00  $9b2446da-c79d-430a-b1b0-d01c02a58ec1
