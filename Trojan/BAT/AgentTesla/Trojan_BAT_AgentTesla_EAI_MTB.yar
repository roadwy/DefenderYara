...
rule Trojan_BAT_AgentTesla_EAI_MTB{
	...
	strings :
		$a_03_0 = {25 16 1f 25 9d 6f 90 01 01 00 00 0a 0b 07 8e 69 8d 90 01 01 00 00 01 0c 16 0d 2b 11 08 09 07 09 9a 1f 10 28 90 01 01 00 00 0a 9c 09 17 58 0d 09 07 8e 69 32 e9 90 00 } //3
...
rule Trojan_BAT_AgentTesla_EAI_MTB_2{
	...
	strings :
		$a_03_0 = {13 04 11 04 28 90 01 03 0a 20 9e 02 00 00 da 13 05 11 05 28 90 01 03 0a 28 90 01 03 0a 13 06 07 11 06 28 90 01 03 0a 28 90 01 03 0a 0b 00 09 17 d6 0d 09 08 6f 90 01 03 0a fe 04 13 07 11 07 2d b3 90 09 0c 00 08 09 6f 90 01 03 0a 28 90 01 03 0a 90 00 } //1
