...
rule Trojan_BAT_AgentTesla_LGI_MTB{
	...
	strings :
		$a_01_0 = {46 48 4a 34 33 32 34 32 34 32 } //01 00 
		$a_01_1 = {47 65 74 4f 62 6a 65 63 74 56 61 6c 75 65 } //01 00 
		$a_01_2 = {00 58 58 58 58 58 58 58 58 58 31 32 33 00 } //01 00 
		...
		$a_01_5 = {43 68 61 72 54 6f 56 61 6c 75 65 } //01 00 
		$a_81_6 = {49 2e 6e 2e 76 2e 6f 2e 6b 2e 65 } //01 00 
