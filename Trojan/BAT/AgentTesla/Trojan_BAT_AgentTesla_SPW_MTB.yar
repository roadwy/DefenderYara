...
rule Trojan_BAT_AgentTesla_SPW_MTB_2{
	...
	strings :
		...
		$a_01_1 = {59 00 55 00 43 00 67 00 31 00 66 00 42 00 7a 00 33 00 6b 00 35 00 4e 00 31 00 45 00 6b 00 64 00 50 00 75 00 37 00 4a 00 6a 00 55 00 38 00 79 00 33 00 64 00 6f 00 77 00 56 00 51 00 36 00 7a 00 } //00 00  YUCg1fBz3k5N1EkdPu7JjU8y3dowVQ6z
	condition:
		any of ($a_*)
