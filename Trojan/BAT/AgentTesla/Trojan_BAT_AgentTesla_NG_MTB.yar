...
rule Trojan_BAT_AgentTesla_NG_MTB{
	...
	strings :
		$a_03_0 = {07 11 08 91 11 90 01 01 61 13 0b 07 11 90 01 01 07 8e 69 5d 91 90 00 } //5
	condition:
		((#a_03_0  & 1)*5) >=5
...
rule Trojan_BAT_AgentTesla_NG_MTB_2{
	...
	strings :
		$a_03_0 = {25 26 0c 1f 61 6a 08 28 90 01 03 2b 25 26 80 90 01 03 04 09 20 90 01 03 25 5a 20 90 01 03 4b 61 2b 84 06 28 90 01 03 0a 0b 09 20 90 01 03 4a 5a 20 84 90 01 03 61 38 90 00 } //10
...
rule Trojan_BAT_AgentTesla_NG_MTB_5{
	...
	strings :
		$a_03_0 = {2b 54 38 55 00 00 00 38 90 01 03 00 38 90 01 03 00 38 90 01 03 00 16 2c 03 90 00 } //5
