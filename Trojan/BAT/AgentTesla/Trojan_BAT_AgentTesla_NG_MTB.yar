...
rule Trojan_BAT_AgentTesla_NG_MTB_2{
	...
	strings :
		...
		$a_01_1 = {41 73 74 72 6f 46 4e 4c 61 75 6e 63 68 65 72 } //01 00 
		$a_01_2 = {64 00 65 00 6c 00 20 00 54 00 72 00 69 00 6e 00 69 00 74 00 79 00 2e 00 62 00 61 00 74 00 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_BAT_AgentTesla_NG_MTB_3{
	...
	strings :
		$a_81_0 = {49 54 79 70 65 43 6f 6d 70 } //01 00 
		$a_81_1 = {41 74 68 6c 65 74 69 63 43 6c 75 62 4d 61 6e 61 67 65 6d 65 6e 74 53 79 73 74 65 6d 2e 53 70 6c 61 73 68 53 63 72 65 65 6e 31 2e 72 65 73 6f 75 72 63 65 73 } //01 00 
		$a_81_2 = {41 74 68 6c 65 74 69 63 43 6c 75 62 4d 61 6e 61 67 65 6d 65 6e 74 53 79 73 74 65 6d 2e 52 65 73 6f 75 72 63 65 73 } //01 00 
		$a_81_3 = {50 6f 6f 6c 41 77 61 69 74 61 62 6c 65 } //01 00 
		$a_81_4 = {74 78 74 41 6d 6f 75 6e 74 50 61 69 64 } //01 00 
		$a_81_5 = {41 74 68 6c 65 74 69 63 43 6c 75 62 44 42 } //01 00 
		$a_81_6 = {24 32 34 38 62 35 63 35 39 2d 61 32 66 38 2d 34 38 64 35 2d 38 36 37 32 2d 34 38 63 64 61 39 31 30 38 34 35 38 } //00 00 
	condition:
		any of ($a_*)
