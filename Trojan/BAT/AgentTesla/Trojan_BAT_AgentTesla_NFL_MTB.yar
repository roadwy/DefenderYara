...
rule Trojan_BAT_AgentTesla_NFL_MTB{
	meta:
		description = "Trojan:BAT/AgentTesla.NFL!MTB,SIGNATURE_TYPE_PEHSTR_EXT,18 00 18 00 06 00 00 0a 00 "
		
	strings :
		$a_01_0 = {2b 01 17 17 59 7e 1c 00 00 04 18 9a 20 6b 0a 00 00 95 5f 7e 1c 00 00 04 18 9a 20 c6 10 00 00 95 61 61 81 05 00 00 01 7e 2a 00 00 04 1f 46 95 7e 1c 00 00 04 18 9a 20 bd 00 00 00 95 33 25 7e 2a 00 00 04 1f 46 } //0a 00 
