...
rule Trojan_BAT_AgentTesla_NW_MTB{
	...
	strings :
		...
		$a_01_1 = {45 69 68 6f 72 67 77 } //00 00  Eihorgw
	condition:
		any of ($a_*)
...
rule Trojan_BAT_AgentTesla_NW_MTB_3{
	...
	strings :
		$a_81_0 = {46 6f 75 72 41 72 } //01 00  FourAr
		$a_81_1 = {46 61 6c 6c 62 61 63 6b 42 75 66 66 65 72 } //01 00  FallbackBuffer
		$a_81_2 = {57 53 54 52 42 75 66 66 65 72 4d 61 72 73 68 61 6c 65 72 } //01 00  WSTRBufferMarshaler
		$a_81_3 = {49 56 65 63 74 6f 72 5f 52 61 77 } //01 00  IVector_Raw
		$a_81_4 = {4b 65 79 43 6f 6c 6c 65 63 74 69 6f 6e } //01 00  KeyCollection
		...
		$a_81_8 = {4c 6f 67 69 6e 49 6e 66 6f } //00 00  LoginInfo
	condition:
		any of ($a_*)
