...
rule Trojan_BAT_AgentTesla_NW_MTB{
	...
	strings :
		$a_03_0 = {28 15 00 00 0a 02 72 90 01 01 00 00 70 28 90 01 01 00 00 06 6f 90 01 01 00 00 0a 28 90 01 01 00 00 0a 28 90 01 01 00 00 06 0a dd 06 00 00 00 90 00 } //5
...
rule Trojan_BAT_AgentTesla_NW_MTB_2{
	...
	strings :
		$a_03_0 = {01 25 16 11 0e 17 da 8c 90 01 03 01 a2 14 28 90 01 03 0a 28 90 01 03 0a 28 90 01 03 06 09 11 0e 09 6f 90 01 03 0a 5d 6f 90 01 03 0a 28 90 01 03 06 da 13 0f 11 04 11 0f 28 90 01 03 06 28 90 01 03 0a 28 90 01 03 0a 13 04 11 0e 17 d6 13 0e 11 0e 11 0d 31 a5 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
