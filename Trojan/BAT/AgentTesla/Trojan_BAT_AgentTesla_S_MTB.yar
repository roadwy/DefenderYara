...
rule Trojan_BAT_AgentTesla_S_MTB{
	...
	strings :
		$a_02_0 = {13 07 19 8d 90 01 03 01 80 90 01 03 04 7e 90 01 03 04 16 7e 90 01 03 04 a2 7e 90 01 03 04 17 7e 90 01 03 04 a2 7e 90 01 03 04 18 72 90 01 04 a2 02 90 00 } //1
	condition:
		((#a_02_0  & 1)*1) >=1
