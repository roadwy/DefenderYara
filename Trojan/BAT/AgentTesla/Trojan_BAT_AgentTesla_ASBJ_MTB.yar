...
rule Trojan_BAT_AgentTesla_ASBJ_MTB{
	...
	strings :
		$a_03_0 = {13 05 11 04 8e 69 17 da 13 0c 16 13 0d 2b 1c 11 05 11 0d 11 04 11 0d 9a 1f 10 28 90 01 01 00 00 0a 6f 90 01 01 00 00 0a 00 11 0d 17 d6 13 0d 11 0d 11 0c 31 de 90 00 } //4
