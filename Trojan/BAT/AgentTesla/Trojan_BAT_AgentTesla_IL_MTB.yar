...
rule Trojan_BAT_AgentTesla_IL_MTB{
	...
	strings :
		...
		$a_01_1 = {24 61 34 37 66 61 31 35 65 2d 65 39 39 37 2d 34 65 39 36 2d 39 33 32 39 2d 38 62 63 65 61 34 38 65 63 33 37 38 } //01 00  $a47fa15e-e997-4e96-9329-8bcea48ec378
...
rule Trojan_BAT_AgentTesla_IL_MTB_2{
	...
	strings :
		...
		$a_81_1 = {49 45 78 70 61 6e 64 6f 2e 50 6c 75 67 } //01 00  IExpando.Plug
