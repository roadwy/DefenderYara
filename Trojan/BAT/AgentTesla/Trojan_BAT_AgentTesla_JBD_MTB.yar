...
rule Trojan_BAT_AgentTesla_JBD_MTB{
	meta:
		description = "Trojan:BAT/AgentTesla.JBD!MTB,SIGNATURE_TYPE_PEHSTR_EXT,0b 00 0b 00 0b 00 00 01 00 "
		
	strings :
		$a_81_0 = {00 05 5c 00 37 00 00 } //01 00 
		$a_81_1 = {49 6e 76 6f 6b 65 4d 65 6d 62 65 72 } //01 00  InvokeMember
		$a_81_2 = {53 65 74 43 6f 6d 70 61 74 69 62 6c 65 54 65 78 74 52 65 6e 64 65 72 69 6e 67 44 65 66 61 75 6c 74 } //01 00  SetCompatibleTextRenderingDefault
		...
		$a_81_8 = {43 6c 61 73 73 4c 69 62 72 61 72 79 } //01 00  ClassLibrary
		...
		$a_81_10 = {47 65 74 54 79 70 65 46 72 6f 6d 48 61 6e 64 6c 65 } //00 00  GetTypeFromHandle
	condition:
		any of ($a_*)
