...
rule Trojan_BAT_AgentTesla_JAO_MTB{
	...
	strings :
		$a_02_0 = {0a 0a de 1c 26 03 72 90 01 03 70 7e 90 01 03 0a 6f 90 01 03 0a 10 01 03 28 90 01 03 0a 0a de 00 90 00 } //10
		$a_02_1 = {0a 26 06 28 90 01 03 06 28 90 01 03 06 06 2e 17 72 90 01 03 70 06 28 90 01 03 06 06 8c 90 01 03 01 28 90 01 03 0a 2a 06 17 58 0a 06 1f 64 32 c7 90 00 } //10
