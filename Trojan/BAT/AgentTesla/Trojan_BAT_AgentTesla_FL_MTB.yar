...
rule Trojan_BAT_AgentTesla_FL_MTB{
	...
	strings :
		$a_02_0 = {0a 0c 1e 8d 90 01 03 01 0d 08 28 90 01 03 0a 72 90 01 03 70 6f 90 01 03 0a 6f 90 01 03 0a 13 04 11 04 16 09 16 1e 28 90 01 03 0a 00 07 09 6f 90 01 03 0a 00 07 18 6f 90 01 03 0a 00 07 6f 90 01 03 0a 03 16 03 8e 69 6f 90 01 03 0a 90 00 } //10
...
rule Trojan_BAT_AgentTesla_FL_MTB_2{
	...
	strings :
		$a_03_0 = {28 09 00 00 06 72 01 00 00 70 72 05 00 00 70 6f 90 01 03 0a 28 90 01 03 0a 72 0b 00 00 70 28 90 01 03 06 28 90 01 03 0a 0a 06 6f 90 01 03 0a 0b 90 00 } //5
