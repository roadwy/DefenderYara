...
rule Trojan_BAT_AgentTesla_CRX_MTB{
	...
	strings :
		...
		$a_01_4 = {4c 00 69 00 74 00 74 00 6c 00 65 00 47 00 61 00 6d 00 65 00 42 00 6f 00 78 00 } //01 00 
		$a_01_5 = {35 00 38 00 34 00 48 00 35 00 34 00 38 00 43 00 52 00 38 00 48 00 53 00 47 00 45 00 4a 00 53 00 34 00 37 00 43 00 34 00 34 00 48 00 } //00 00 
	condition:
		any of ($a_*)
