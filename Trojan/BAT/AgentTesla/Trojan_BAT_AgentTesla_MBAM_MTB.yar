...
rule Trojan_BAT_AgentTesla_MBAM_MTB{
	...
	strings :
		$a_03_0 = {03 04 03 8e 69 5d 91 06 04 1f 16 5d 91 61 28 90 01 03 0a 03 04 17 58 03 8e 69 5d 91 28 90 01 01 00 00 0a 59 20 00 01 00 00 58 20 00 01 00 00 5d 90 00 } //1
