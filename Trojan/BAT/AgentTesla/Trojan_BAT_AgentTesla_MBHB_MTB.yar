...
rule Trojan_BAT_AgentTesla_MBHB_MTB{
	...
	strings :
		$a_03_0 = {09 11 07 09 8e 69 5d 09 11 07 09 8e 69 5d 91 11 04 11 07 1f 16 5d 6f 90 01 01 00 00 0a 61 28 90 01 01 00 00 0a 09 11 07 17 58 09 8e 69 5d 91 28 90 01 01 00 00 0a 59 20 00 01 00 00 58 20 00 01 00 00 5d 28 90 01 01 00 00 0a 9c 00 90 00 } //1
