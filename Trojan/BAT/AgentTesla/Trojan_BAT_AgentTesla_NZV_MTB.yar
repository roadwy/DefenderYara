...
rule Trojan_BAT_AgentTesla_NZV_MTB{
	...
	strings :
		...
		$a_81_1 = {47 34 44 35 34 43 37 44 34 38 41 35 37 45 34 37 59 38 37 48 42 34 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_BAT_AgentTesla_NZV_MTB_2{
	...
	strings :
		$a_81_0 = {56 4f 4f 4f 4f 30 31 } //01 00 
		$a_81_1 = {56 4f 4f 4f 4f 30 33 } //01 00 
		...
		$a_81_4 = {53 79 73 74 65 6d 2e 52 65 66 6c 65 63 74 69 6f 6e 2e 41 73 73 65 6d 62 6c 79 } //01 00 
		$a_81_5 = {53 74 72 52 65 76 65 72 73 65 } //00 00 
	condition:
		any of ($a_*)
