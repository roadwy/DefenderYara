...
rule Trojan_BAT_AgentTesla_AEH_MTB{
	...
	strings :
		$a_03_0 = {07 02 08 18 5a 18 6f 90 01 03 0a 1f 10 28 90 01 03 0a d2 6f 90 01 03 0a 00 00 08 17 58 0c 08 06 fe 04 0d 09 2d d9 90 00 } //10
		$a_03_1 = {25 16 02 08 18 5a 18 6f 90 01 03 0a 1f 10 28 90 01 03 0a d2 9c 6f 90 01 03 0a 00 00 08 17 58 0c 08 06 fe 04 0d 09 2d d0 90 00 } //10
