...
rule Trojan_BAT_AgentTesla_LMC_MTB{
	...
	strings :
		...
		$a_81_5 = {47 2d 65 2d 74 2d 4d 2d 65 2d 74 2d 68 2d 6f 2d 64 } //01 00 
		$a_81_6 = {2d 2d 49 2d 2d 6e 2d 2d 76 2d 2d 6f 2d 2d 6b 2d 2d 65 2d 2d } //01 00 
		$a_01_7 = {47 65 74 4f 62 6a 65 63 74 56 61 6c 75 65 } //01 00 
		$a_01_8 = {4c 61 74 65 47 65 74 } //00 00 
	condition:
		any of ($a_*)
