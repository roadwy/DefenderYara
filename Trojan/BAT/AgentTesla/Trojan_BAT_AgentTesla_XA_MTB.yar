...
rule Trojan_BAT_AgentTesla_XA_MTB{
	...
	strings :
		...
		$a_01_1 = {43 72 65 61 74 65 49 6d 61 67 65 46 72 6f 6d 42 61 73 65 36 34 } //01 00  CreateImageFromBase64
		$a_01_2 = {42 61 73 65 36 34 44 61 74 61 } //01 00  Base64Data
