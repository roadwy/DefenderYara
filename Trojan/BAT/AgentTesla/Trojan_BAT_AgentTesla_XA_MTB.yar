...
rule Trojan_BAT_AgentTesla_XA_MTB{
	...
	strings :
		$a_03_0 = {11 07 11 08 6f 90 01 03 0a 13 09 11 04 11 09 28 90 01 03 0a 11 05 da 28 90 01 03 0a 28 90 01 03 0a 28 90 01 03 0a 13 04 00 11 08 17 d6 13 08 11 08 11 07 6f 90 01 03 0a fe 04 13 0a 11 0a 2d c0 90 00 } //1
