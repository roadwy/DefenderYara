...
rule Trojan_BAT_AgentTesla_HD_MTB{
	...
	strings :
		$a_02_0 = {0a 08 16 17 73 90 01 03 0a 0b 73 90 01 03 0a 0d 1f 40 8d 90 01 03 01 0a 15 13 04 07 06 16 06 8e b7 6f 90 01 03 0a 13 04 38 90 01 03 00 09 06 16 11 04 6f 90 01 03 0a 07 06 16 06 8e b7 6f 90 01 03 0a 13 04 11 04 90 00 } //10
