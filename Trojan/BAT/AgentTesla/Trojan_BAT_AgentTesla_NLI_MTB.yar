...
rule Trojan_BAT_AgentTesla_NLI_MTB{
	...
	strings :
		...
		$a_01_1 = {24 33 62 31 65 63 37 36 33 2d 65 36 62 61 2d 34 61 36 66 2d 62 33 63 31 2d 65 63 30 35 34 63 38 62 36 32 37 31 } //01 00 
		$a_01_2 = {68 61 75 68 61 75 77 65 } //01 00 
		$a_81_3 = {25 49 6e 4a 25 65 63 74 6f 72 25 } //00 00 
	condition:
		any of ($a_*)
