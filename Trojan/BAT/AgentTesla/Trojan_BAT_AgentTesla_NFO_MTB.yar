...
rule Trojan_BAT_AgentTesla_NFO_MTB_2{
	...
	strings :
		...
		$a_03_1 = {20 ec 04 00 00 95 e0 95 7e 1a 00 00 04 1b 9a 20 6d 12 00 00 95 61 7e 1a 00 00 04 1b 9a 20 0f 03 00 00 95 2e 03 17 2b 01 16 58 11 04 90 01 01 7e 1a 00 00 04 19 9a 17 95 7e 1a 00 00 04 1b 9a 20 f7 0d 00 00 90 00 } //1
