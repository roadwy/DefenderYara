...
rule Trojan_BAT_AgentTesla_NUS_MTB{
	...
	strings :
		$a_03_0 = {09 11 0c 17 da 6f 90 01 03 0a 28 90 01 03 06 11 04 11 0c 11 04 6f 90 01 03 0a 5d 6f 90 01 03 0a 28 90 01 03 06 da 13 0d 11 05 11 0d 28 90 01 03 0a 28 90 01 03 0a 28 90 01 03 0a 13 05 11 0c 17 d6 13 0c 11 0c 11 0b 31 b7 90 00 } //1
