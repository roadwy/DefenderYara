...
rule Trojan_BAT_AgentTesla_NBB_MTB_2{
	...
	strings :
		...
		$a_01_1 = {74 61 73 6b 73 68 6f 73 74 77 } //01 00  taskshostw
		$a_01_2 = {58 00 30 00 4b 00 4d 00 44 00 67 00 64 00 37 00 44 00 57 00 6e 00 48 00 54 00 56 00 30 00 41 00 71 00 } //00 00  X0KMDgd7DWnHTV0Aq
	condition:
		any of ($a_*)
