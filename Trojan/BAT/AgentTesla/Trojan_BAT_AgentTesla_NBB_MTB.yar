...
rule Trojan_BAT_AgentTesla_NBB_MTB{
	...
	strings :
		$a_03_0 = {02 6c 23 ff b9 f4 ee 2a 81 f7 3f 5b 28 90 01 03 0a b7 28 90 01 03 0a 28 90 01 03 0a 2a 90 00 } //1
		$a_03_1 = {2b 1e 07 08 6f 90 01 03 0a 28 90 01 03 06 28 90 01 03 0a 0d 06 09 28 90 01 03 0a 0a 08 17 d6 0c 08 07 6f 90 01 03 0a 32 d9 90 00 } //1
	condition:
...
rule Trojan_BAT_AgentTesla_NBB_MTB_2{
	...
	strings :
		$a_03_0 = {6f 53 00 00 0a 6f 90 01 01 00 00 0a 6f 90 01 01 00 00 0a 06 18 6f 90 01 01 00 00 0a 06 6f 90 01 01 00 00 0a 0c 02 0d 08 09 16 09 8e b7 6f 90 01 01 00 00 0a 90 00 } //5
