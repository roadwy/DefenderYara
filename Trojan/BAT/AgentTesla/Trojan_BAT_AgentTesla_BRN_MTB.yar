...
rule Trojan_BAT_AgentTesla_BRN_MTB{
	...
	strings :
		$a_02_0 = {0a 0b 07 74 90 01 03 01 16 73 90 01 03 0a 0c 1a 8d 90 01 03 01 0d 07 14 72 90 01 03 70 17 8d 90 01 03 01 25 16 07 14 72 90 01 03 70 16 8d 90 01 03 01 14 14 14 28 90 01 03 0a 1b 8c 90 01 03 01 28 90 01 03 0a a2 14 14 28 f0 00 00 0a 00 07 28 90 00 } //10
