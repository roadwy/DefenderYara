...
rule Trojan_BAT_AgentTesla_BAE_MTB{
	...
	strings :
		$a_03_0 = {13 11 20 e8 03 00 00 13 12 20 e8 03 00 00 8d ?? ?? ?? 01 13 14 2b 19 11 13 11 12 2f 13 2b 26 7e ?? ?? ?? 04 11 14 16 11 13 6f ?? ?? ?? 0a 2b e7 11 11 11 14 16 11 12 6f ?? ?? ?? 0a 13 13 11 13 16 31 d4 2b da } //2
