...
rule Trojan_BAT_AgentTesla_OS_MTB{
	...
	strings :
		$a_02_0 = {08 8e 69 6f 90 02 04 6f 90 09 35 00 28 90 02 04 03 6f 90 02 04 6f 90 02 09 6f 90 02 04 06 18 6f 90 02 04 02 28 90 02 04 0c 28 90 02 04 06 6f 90 00 } //1
