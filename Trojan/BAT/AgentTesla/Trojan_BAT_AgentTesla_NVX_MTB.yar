...
rule Trojan_BAT_AgentTesla_NVX_MTB{
	...
	strings :
		...
		$a_01_2 = {24 30 38 38 65 31 35 66 65 2d 61 66 64 62 2d 34 37 31 63 2d 38 61 38 30 2d 37 65 38 34 62 33 39 30 34 30 31 63 } //00 00  $088e15fe-afdb-471c-8a80-7e84b390401c
	condition:
		any of ($a_*)
