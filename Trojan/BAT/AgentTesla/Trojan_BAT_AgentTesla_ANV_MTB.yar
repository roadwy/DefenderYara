...
rule Trojan_BAT_AgentTesla_ANV_MTB{
	...
	strings :
		$a_03_0 = {d4 91 11 04 11 04 07 95 11 04 08 95 58 20 ff 00 00 00 5f 95 61 90 01 05 9c 00 11 08 17 6a 58 13 08 11 08 11 05 8e 69 17 59 6a fe 02 16 fe 01 13 09 11 09 2d 97 90 00 } //10
