...
rule Trojan_BAT_AgentTesla_PA_MTB{
	...
	strings :
		...
		$a_02_1 = {11 04 1f 41 32 0b 11 04 1f 5a fe 02 16 fe 01 2b 01 16 13 08 11 08 2c 24 00 11 04 1f 0d 58 13 09 11 09 1f 5a fe 02 13 0a 11 0a 2c 07 11 09 1f 1a 59 13 09 06 09 11 09 d1 9d 00 2b 07 00 06 09 11 04 9d 00 00 09 17 58 0d 09 02 6f 90 01 01 00 00 0a fe 04 13 0b 11 0b 3a 90 00 } //1
	condition:
