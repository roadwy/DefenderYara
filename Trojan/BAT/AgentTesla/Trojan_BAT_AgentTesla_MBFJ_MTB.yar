...
rule Trojan_BAT_AgentTesla_MBFJ_MTB_2{
	...
	strings :
		$a_03_0 = {11 04 18 6f 90 01 01 00 00 0a 13 05 07 11 04 18 5b 11 05 1f 10 28 90 01 01 00 00 0a 9c 00 11 04 18 58 13 04 11 04 06 6f 90 01 01 00 00 0a fe 04 13 06 11 06 2d ce 90 00 } //1
