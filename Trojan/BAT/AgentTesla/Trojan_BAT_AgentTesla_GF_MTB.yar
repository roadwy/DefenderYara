...
rule Trojan_BAT_AgentTesla_GF_MTB{
	...
	strings :
		...
		$a_81_1 = {41 5a 58 43 43 43 43 43 43 43 43 43 43 43 43 43 43 43 43 43 43 43 } //05 00  AZXCCCCCCCCCCCCCCCCCCC
		$a_81_2 = {42 6f 6f 6b 73 74 6f 72 65 4d 61 6e 61 67 65 6d 65 6e 74 2e 47 55 49 2e 4d 79 2e 52 65 73 6f 75 72 63 65 73 } //01 00  BookstoreManagement.GUI.My.Resources
