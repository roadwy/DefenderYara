...
rule Trojan_BAT_AgentTesla_DDV_MTB{
	...
	strings :
		$a_01_0 = {73 00 52 00 61 00 6b 00 45 00 31 00 36 00 68 00 41 00 36 00 56 00 } //01 00  sRakE16hA6V
		$a_01_1 = {2b 00 34 00 50 00 39 00 4e 00 63 00 78 00 4b 00 35 00 32 00 4d 00 } //01 00  +4P9NcxK52M
		$a_01_2 = {2b 00 66 00 75 00 75 00 44 00 72 00 58 00 73 00 70 00 52 00 38 00 } //01 00  +fuuDrXspR8
		$a_01_3 = {68 00 72 00 71 00 41 00 41 00 39 00 48 00 56 00 31 00 41 00 71 00 } //01 00  hrqAA9HV1Aq
		$a_01_4 = {2b 00 6a 00 46 00 31 00 47 00 6c 00 6d 00 55 00 39 00 59 00 51 00 } //01 00  +jF1GlmU9YQ
