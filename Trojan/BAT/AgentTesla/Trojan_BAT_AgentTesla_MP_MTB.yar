...
rule Trojan_BAT_AgentTesla_MP_MTB_2{
	...
	strings :
		$a_01_0 = {48 56 4e 6b 70 6b 5a 33 34 4b 6d 65 63 69 56 56 4a 66 69 } //01 00  HVNkpkZ34KmeciVVJfi
		$a_01_1 = {63 64 61 57 39 4f 76 4d 55 39 } //01 00  cdaW9OvMU9
		$a_01_2 = {4f 52 71 46 65 51 4d 41 4d 54 76 38 6d 52 78 76 77 53 72 } //01 00  ORqFeQMAMTv8mRxvwSr
		$a_01_3 = {75 67 6c 64 71 35 4d 57 57 31 52 6e 31 78 73 44 62 58 71 } //01 00  ugldq5MWW1Rn1xsDbXq
		$a_01_4 = {79 6b 56 6c 48 48 4d 62 55 67 44 69 73 78 54 37 53 78 53 } //01 00  ykVlHHMbUgDisxT7SxS
		$a_01_5 = {6b 4c 6a 77 34 69 49 73 43 4c 73 5a 74 78 63 34 6c 6b 73 4e 30 6a } //01 00  kLjw4iIsCLsZtxc4lksN0j
		...
		$a_01_10 = {52 65 76 65 72 73 65 } //00 00  Reverse
	condition:
		any of ($a_*)
