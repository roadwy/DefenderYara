...
rule Trojan_BAT_AgentTesla_BZA_MTB{
	...
	strings :
		$a_02_0 = {04 94 9e 7e ?? ?? ?? 04 7e ?? ?? ?? 04 7e ?? ?? ?? 04 9e 7e ?? ?? ?? 04 7e ?? ?? ?? 04 7e ?? ?? ?? 04 94 7e ?? ?? ?? 04 7e ?? ?? ?? 04 94 58 20 00 01 00 00 5d 94 80 ?? ?? ?? 04 7e ?? ?? ?? 04 7e ?? ?? ?? 04 02 50 7e ?? ?? ?? 04 91 7e ?? ?? ?? 04 61 d2 9c 7e ?? ?? ?? 04 17 58 80 ?? ?? ?? 04 7e ?? ?? ?? 04 02 50 8e 69 } //1
