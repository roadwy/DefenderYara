...
rule Trojan_BAT_AgentTesla_NOA_MTB{
	...
	strings :
		$a_03_0 = {0a 13 04 11 04 28 43 00 00 06 20 90 01 03 00 da 13 05 11 05 28 90 01 03 0a 28 90 01 03 0a 13 06 07 11 06 28 90 01 03 0a 0b 00 09 17 d6 0d 09 08 6f 90 01 03 0a fe 04 13 07 11 07 2d b8 90 00 } //1
