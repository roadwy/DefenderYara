...
rule Trojan_BAT_AgentTesla_CHH_MTB{
	...
	strings :
		$a_03_0 = {20 00 01 00 00 5d 0c 11 06 06 94 13 04 11 06 06 11 06 08 94 9e 11 06 08 11 04 9e 11 06 11 06 06 94 11 06 08 94 58 20 00 01 00 00 5d 94 0d 11 07 07 ?? 07 91 09 61 d2 9c 07 17 58 0b } //1
...
rule Trojan_BAT_AgentTesla_CHH_MTB_2{
	...
	strings :
		$a_03_0 = {0c 08 20 00 01 00 00 6f ?? ?? ?? 0a 08 17 6f ?? ?? ?? 0a 08 72 ?? ?? ?? 70 28 ?? ?? ?? 0a 72 ?? ?? ?? 70 6f ?? ?? ?? 0a 1f 64 73 ?? ?? ?? 0a 1f 10 6f ?? ?? ?? 0a 28 ?? ?? ?? 0a 72 ?? ?? ?? 70 6f ?? ?? ?? 0a 6f ?? ?? ?? 0a 17 73 ?? ?? ?? 0a 0b 07 02 16 02 8e 69 } //1
