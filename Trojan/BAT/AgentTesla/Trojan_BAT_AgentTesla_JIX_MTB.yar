...
rule Trojan_BAT_AgentTesla_JIX_MTB{
	...
	strings :
		$a_03_0 = {0a 0a 00 20 00 10 00 00 8d 90 01 03 01 0b 73 90 01 03 0a 0c 00 00 06 07 16 20 00 10 00 00 6f 90 01 03 0a 0d 09 16 fe 02 13 04 11 04 2c 0c 00 08 07 16 09 6f 90 01 03 0a 00 00 00 09 16 fe 02 13 05 11 05 2d d0 90 00 } //10
