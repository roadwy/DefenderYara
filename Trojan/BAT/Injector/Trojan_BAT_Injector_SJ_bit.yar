...
rule Trojan_BAT_Injector_SJ_bit{
	...
	strings :
		...
		$a_03_1 = {4c 00 6f 00 73 00 74 00 [0-10] 50 00 6c 00 61 00 79 00 [0-10] 57 00 69 00 6e 00 } //1
		$a_03_2 = {06 11 04 06 11 04 91 ?? 11 04 07 5d 91 61 9c 11 04 17 d6 13 04 } //1
