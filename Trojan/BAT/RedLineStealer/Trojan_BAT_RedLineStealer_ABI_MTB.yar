...
rule Trojan_BAT_RedLineStealer_ABI_MTB{
	...
	strings :
		$a_03_0 = {06 02 6f 97 90 01 02 0a 0b 28 98 90 01 02 0a 72 43 90 01 02 70 28 46 90 01 02 0a 0c 08 07 28 99 90 01 02 0a 00 08 28 5c 90 01 02 0a 26 00 de 14 90 00 } //3
		$a_03_1 = {0a 02 7b 82 90 01 02 04 02 7b 83 90 01 02 04 17 6f 91 90 01 02 0a 00 28 08 90 01 02 06 6f 92 90 01 02 0a 72 e8 90 01 02 70 72 68 90 01 02 70 02 7b 83 90 01 02 04 72 9a 90 01 02 70 28 46 90 01 02 0a 6f 93 90 01 02 0a 00 de 0f 90 00 } //3
