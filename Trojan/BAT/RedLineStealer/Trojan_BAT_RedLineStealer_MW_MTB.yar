...
rule Trojan_BAT_RedLineStealer_MW_MTB{
	...
	strings :
		...
		$a_81_2 = {43 3a 5c 57 69 6e 64 6f 77 73 5c 53 79 73 57 4f 57 36 34 5c 73 76 63 68 6f 73 74 2e 65 78 65 } //01 00 
		$a_81_3 = {43 3a 5c 57 69 6e 64 6f 77 73 5c 53 79 73 57 4f 57 36 34 5c 72 75 6e 64 6c 6c 33 32 2e 65 78 65 } //01 00 
		$a_81_4 = {44 6f 77 6e 6c 6f 61 64 53 74 72 69 6e 67 } //01 00 
		$a_81_5 = {44 6f 77 6e 6c 6f 61 64 46 69 6c 65 } //01 00 
		$a_81_6 = {53 6c 65 65 70 } //01 00 
		$a_81_7 = {44 65 62 75 67 67 61 62 6c 65 41 74 74 72 69 62 75 74 65 } //01 00 
		$a_81_8 = {54 6f 53 74 72 69 6e 67 } //01 00 
		$a_81_9 = {67 65 74 5f 4b 65 79 } //00 00 
	condition:
		any of ($a_*)
