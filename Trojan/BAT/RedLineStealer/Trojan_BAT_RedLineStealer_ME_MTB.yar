...
rule Trojan_BAT_RedLineStealer_ME_MTB{
	...
	strings :
		$a_03_0 = {13 0d 17 11 0d 11 0c 28 90 01 03 06 13 0e 11 0e 02 1a 02 8e 69 1a 59 6f 90 01 03 0a 28 90 01 03 06 13 04 de 90 00 } //1
		$a_03_1 = {13 0d 11 0d 28 90 01 03 0a 26 11 0d 07 7b 90 01 03 04 72 90 01 03 70 28 90 01 03 0a 13 0e 11 0e 28 90 01 03 0a 2d 2d 11 0e 28 90 01 03 0a 25 11 0b 16 11 0b 8e 69 6f 90 01 03 0a 6f 90 01 03 0a 11 0e 14 1a 90 00 } //1
