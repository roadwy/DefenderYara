...
rule Trojan_BAT_RedLineStealer_AW_MTB{
	...
	strings :
		$a_03_0 = {33 28 07 6f 60 90 01 02 0a 28 d3 90 01 02 06 2d 1b 07 6f 60 90 01 02 0a 28 62 90 01 02 0a 2d 0e 07 6f 60 90 01 02 0a 6f d2 90 01 02 0a 0c de 31 06 6f 03 90 01 02 0a 2d bb 90 0a 45 00 06 6f 5f 90 01 02 0a 0b 07 6f 60 90 01 02 0a 6f 61 90 01 02 0a 18 90 00 } //1
