...
rule Trojan_BAT_RedLineStealer_MX_MTB{
	...
	strings :
		...
		$a_81_3 = {63 69 70 68 65 72 } //01 00 
		$a_81_4 = {67 65 74 5f 45 6d 61 69 6c } //01 00 
		$a_81_5 = {67 65 74 5f 55 73 65 72 54 79 70 65 } //01 00 
		$a_81_6 = {44 65 62 75 67 67 65 72 42 72 6f 77 73 61 62 6c 65 41 74 74 72 69 62 75 74 65 } //01 00 
		$a_81_7 = {67 65 74 5f 4b 65 79 } //01 00 
