...
rule Trojan_BAT_RedLineStealer_MAG_MTB{
	...
	strings :
		$a_03_0 = {02 8e 69 1f 0f 59 8d 90 01 01 00 00 01 0b 02 1f 0f 07 16 02 8e 69 1f 0f 59 28 90 01 03 0a 1f 10 8d 90 01 01 00 00 01 0c 07 8e 69 08 8e 69 59 8d 90 01 01 00 00 01 0d 07 07 8e 69 1f 10 59 08 16 1f 10 28 90 01 03 0a 07 16 09 16 07 8e 69 08 8e 69 59 28 90 01 03 0a 73 90 01 01 00 00 06 03 06 14 09 08 6f 90 01 03 06 13 04 de 90 00 } //1
