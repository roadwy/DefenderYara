...
rule Trojan_BAT_RedLineStealer_MRA_MTB{
	...
	strings :
		$a_01_0 = {66 00 74 00 70 00 3a 00 2f 00 2f 00 34 00 39 00 2e 00 31 00 32 00 2e 00 32 00 31 00 37 00 2e 00 31 00 30 00 36 00 2f 00 2f 00 66 00 6c 00 65 00 78 00 2e 00 7a 00 69 00 70 00 } //01 00 
		$a_01_1 = {5c 00 54 00 65 00 6d 00 70 00 5c 00 6b 00 6a 00 61 00 73 00 66 00 32 00 33 00 31 00 } //01 00 
		...
		$a_01_5 = {73 65 74 5f 43 72 65 64 65 6e 74 69 61 6c 73 } //01 00 
