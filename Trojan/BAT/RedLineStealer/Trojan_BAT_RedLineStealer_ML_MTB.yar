...
rule Trojan_BAT_RedLineStealer_ML_MTB{
	...
	strings :
		$a_03_0 = {de 0b 08 2c 07 08 6f 90 01 03 0a 00 dc 07 6f 90 01 03 0a 0d de 16 07 2c 07 07 6f 90 01 03 0a 00 dc 90 00 } //1
...
rule Trojan_BAT_RedLineStealer_ML_MTB_2{
	...
	strings :
		$a_03_0 = {0a fe 0e 02 00 fe 0c 02 00 20 00 01 00 00 6f 90 01 03 0a fe 0c 02 00 20 80 00 00 00 6f 90 01 03 0a 28 90 01 03 0a 72 90 01 03 70 6f 90 01 03 0a 28 90 01 03 0a 72 90 01 03 70 6f 90 01 03 0a 20 e8 03 00 00 73 23 00 00 0a fe 90 01 03 fe 90 01 03 fe 90 01 03 fe 90 01 03 6f 90 01 03 0a 20 08 00 00 00 5b 6f 90 01 03 0a 6f 90 01 03 0a fe 90 01 03 fe 90 01 03 fe 90 01 03 6f 90 01 03 0a 20 08 00 00 00 5b 6f 90 01 03 0a 6f 90 01 03 0a fe 90 01 03 20 01 00 00 00 6f 90 01 03 0a fe 90 01 03 fe 90 01 03 6f 90 01 03 0a 20 01 00 00 00 73 2b 00 00 0a fe 90 01 03 fe 90 01 03 fe 90 01 03 20 00 00 00 00 fe 90 01 03 8e 69 6f 90 01 03 0a fe 90 01 03 6f 90 01 03 0a dd 13 00 00 00 fe 90 01 03 39 09 00 00 00 fe 90 01 03 6f 90 01 03 0a dc fe 0c 01 00 6f 90 01 03 0a fe 90 00 } //1
