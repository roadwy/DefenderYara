...
rule Trojan_BAT_RedLineStealer_MA_MTB{
	...
	strings :
		$a_03_0 = {11 07 11 0a 16 11 0a 8e 69 6f 90 01 03 0a 26 38 90 01 03 ff dd 90 01 04 11 07 3a 90 01 01 00 00 00 38 90 01 01 00 00 00 fe 90 01 03 45 90 02 0a 38 90 01 01 00 00 00 38 90 01 01 00 00 00 20 00 00 00 00 7e 90 01 03 04 3a 90 01 03 ff 26 20 00 00 00 00 38 90 01 03 ff 11 07 6f 90 01 03 0a 38 00 00 00 00 dc 90 00 } //1
