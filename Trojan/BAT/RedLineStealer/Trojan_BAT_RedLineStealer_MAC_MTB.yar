...
rule Trojan_BAT_RedLineStealer_MAC_MTB{
	...
	strings :
		...
		$a_81_1 = {53 63 61 6e 50 61 73 73 77 6f 72 64 73 } //01 00 
		$a_81_2 = {53 63 61 6e 43 6f 6f 6b } //01 00 
		$a_81_3 = {44 65 63 72 79 70 74 42 6c 6f 62 } //01 00 
		$a_81_4 = {43 68 72 5f 30 5f 4d 5f 65 } //01 00 
		$a_81_5 = {67 65 74 5f 50 6f 73 74 61 6c 43 6f 64 65 } //01 00 
		...
		$a_81_10 = {67 65 74 5f 6f 73 5f 63 72 79 70 74 } //01 00 
		$a_81_11 = {67 65 74 5f 4b 65 79 } //01 00 
		$a_81_12 = {6d 6f 7a 5f 63 6f 6f 6b 69 65 73 } //01 00 
		$a_81_13 = {44 65 63 72 79 70 74 43 68 72 6f 6d 69 75 6d } //00 00 
	condition:
		any of ($a_*)
