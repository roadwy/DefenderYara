...
rule Trojan_BAT_RedLineStealer_MAW_MTB{
	...
	strings :
		...
		$a_01_5 = {52 65 64 75 63 65 43 6f 6e 66 69 67 } //01 00 
		$a_01_6 = {52 65 64 75 63 65 44 61 74 61 62 61 73 65 } //01 00 
		$a_01_7 = {52 75 6e 50 45 } //01 00 
		$a_01_8 = {4d 65 6d 6f 72 79 45 76 65 6e 74 } //01 00 
		$a_01_9 = {52 65 76 65 72 73 65 } //01 00 
		$a_01_10 = {73 65 74 5f 49 56 } //01 00 
		$a_01_11 = {73 65 74 5f 4b 65 79 } //00 00 
	condition:
		any of ($a_*)
