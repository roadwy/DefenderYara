...
rule Trojan_BAT_RedLineStealer_MF_MTB{
	...
	strings :
		...
		$a_01_1 = {6b 65 79 5f 72 65 67 69 73 74 65 72 } //01 00 
		$a_01_2 = {72 65 76 73 74 72 69 6e 67 } //01 00 
		...
		$a_01_6 = {70 72 6f 66 65 73 73 6f 72 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_BAT_RedLineStealer_MF_MTB_2{
	...
	strings :
		$a_81_0 = {36 35 2e 32 31 2e 31 39 39 2e 31 34 } //01 00 
		$a_81_1 = {46 72 6f 6d 42 61 73 65 36 34 53 74 72 69 6e 67 } //01 00 
		$a_81_2 = {53 74 72 69 6e 67 44 65 63 72 79 70 74 } //01 00 
		$a_81_3 = {43 72 65 61 74 65 53 68 61 64 6f 77 43 6f 70 79 } //01 00 
		$a_81_4 = {67 65 74 5f 49 50 } //01 00 
		$a_81_5 = {67 65 74 5f 50 61 73 73 77 6f 72 64 } //01 00 
		$a_81_6 = {67 65 74 5f 4e 61 6d 65 4f 66 42 72 6f 77 73 65 72 } //01 00 
		$a_81_7 = {67 65 74 5f 43 6f 6f 6b 69 65 73 } //01 00 
		$a_81_8 = {67 65 74 5f 43 72 65 64 65 6e 74 69 61 6c 73 } //00 00 
	condition:
		any of ($a_*)
