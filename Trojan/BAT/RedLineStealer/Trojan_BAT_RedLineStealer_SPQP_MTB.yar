...
rule Trojan_BAT_RedLineStealer_SPQP_MTB{
	...
	strings :
		...
		$a_01_1 = {5a 00 75 00 65 00 6d 00 69 00 6c 00 68 00 71 00 68 00 79 00 6d 00 2e 00 50 00 72 00 6f 00 70 00 65 00 72 00 74 00 69 00 65 00 73 00 2e 00 52 00 65 00 73 00 6f 00 75 00 72 00 63 00 65 00 73 00 } //01 00 
		$a_81_2 = {52 70 68 6b 6b 67 6d 78 63 74 69 66 6e 65 71 79 75 65 63 } //00 00 
	condition:
		any of ($a_*)
