...
rule Trojan_BAT_RedLineStealer_ABY_MTB{
	...
	strings :
		$a_03_0 = {02 2c 27 20 c5 90 01 02 81 0a 16 0b 2b 14 02 07 6f de 90 01 02 0a 06 61 20 93 90 01 02 01 5a 0a 07 17 58 0b 07 02 6f 5d 90 01 02 0a 32 e3 06 2a 90 00 } //5
