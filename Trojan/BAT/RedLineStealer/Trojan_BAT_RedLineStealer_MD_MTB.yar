...
rule Trojan_BAT_RedLineStealer_MD_MTB_2{
	...
	strings :
		...
		$a_81_1 = {47 65 74 42 79 74 65 73 } //01 00 
		...
		$a_81_6 = {43 6f 6e 74 61 69 6e 73 4b 65 79 } //01 00 
		$a_81_7 = {47 65 74 54 65 6d 70 50 61 74 68 } //01 00 
		$a_81_8 = {4c 6f 61 64 46 69 6c 65 } //00 00 
	condition:
		any of ($a_*)
