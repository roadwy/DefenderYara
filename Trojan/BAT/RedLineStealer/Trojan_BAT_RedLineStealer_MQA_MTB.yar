...
rule Trojan_BAT_RedLineStealer_MQA_MTB{
	...
	strings :
		$a_03_0 = {11 08 13 05 14 13 08 11 05 8e 69 1e 5b 13 0c 11 05 73 ?? 00 00 0a 73 ?? 00 00 06 13 0d 16 13 16 38 23 00 00 00 11 0d 6f ?? ?? ?? 06 13 17 11 0d 6f ?? ?? ?? 06 13 18 11 04 11 17 11 18 6f ?? ?? ?? 0a 11 16 17 58 13 16 11 16 11 0c 3f d4 ff ff ff 11 0d 6f ?? ?? ?? 06 11 04 80 ?? 00 00 04 dd } //1
