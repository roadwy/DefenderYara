...
rule Trojan_BAT_RedLineStealer_MAN_MTB{
	...
	strings :
		$a_02_0 = {68 00 74 00 74 00 70 00 73 00 3a 00 2f 00 2f 00 63 00 64 00 6e 00 2e 00 64 00 69 00 73 00 63 00 6f 00 72 00 64 00 61 00 70 00 70 00 2e 00 63 00 6f 00 6d 00 2f 00 61 00 74 00 74 00 61 00 63 00 68 00 6d 00 65 00 6e 00 74 00 73 00 2f 00 90 02 60 2f 00 6d 00 69 00 63 00 72 00 69 00 66 00 69 00 65 00 73 00 2e 00 6a 00 70 00 67 00 90 00 } //1
		$a_02_1 = {68 74 74 70 73 3a 2f 2f 63 64 6e 2e 64 69 73 63 6f 72 64 61 70 70 2e 63 6f 6d 2f 61 74 74 61 63 68 6d 65 6e 74 73 2f 90 02 60 2f 6d 69 63 72 69 66 69 65 73 2e 6a 70 67 90 00 } //1
