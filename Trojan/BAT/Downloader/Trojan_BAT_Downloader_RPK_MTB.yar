...
rule Trojan_BAT_Downloader_RPK_MTB{
	...
	strings :
		$a_03_0 = {6d 00 65 00 64 00 69 00 61 00 66 00 69 00 72 00 65 00 2e 00 63 00 6f 00 6d 00 90 02 50 73 00 76 00 63 00 68 00 6f 00 73 00 74 00 2e 00 6a 00 70 00 67 00 90 00 } //1
