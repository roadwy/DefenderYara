...
rule Trojan_BAT_Downloader_HMV_MTB{
	...
	strings :
		$a_01_0 = {46 72 6f 6d 42 61 73 65 36 34 53 74 72 69 6e 67 } //0a 00  FromBase64String
		$a_01_1 = {47 65 74 54 79 70 65 } //0a 00  GetType
		$a_01_2 = {49 6e 76 6f 6b 65 4d 65 6d 62 65 72 } //0a 00  InvokeMember
		$a_01_3 = {52 65 70 6c 61 63 65 } //0a 00  Replace
