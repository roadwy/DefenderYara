...
rule Trojan_BAT_Injuke_NIJ_MTB{
	...
	strings :
		...
		$a_01_1 = {49 00 79 00 6c 00 68 00 71 00 62 00 68 00 6c 00 76 00 61 00 66 00 73 00 76 00 66 00 } //01 00  Iylhqbhlvafsvf
		$a_01_2 = {43 6f 6d 70 75 74 65 72 20 53 65 6e 74 69 6e 65 6c } //00 00  Computer Sentinel
	condition:
		any of ($a_*)
