...
rule Trojan_BAT_Injuke_AADI_MTB{
	...
	strings :
		...
		$a_01_2 = {64 00 65 00 6c 00 6f 00 62 00 69 00 7a 00 6e 00 65 00 73 00 61 00 2e 00 6f 00 6e 00 6c 00 69 00 6e 00 65 00 2f 00 70 00 61 00 6e 00 65 00 6c 00 2f 00 75 00 70 00 6c 00 6f 00 61 00 64 00 73 00 2f 00 50 00 6f 00 63 00 70 00 7a 00 6b 00 6f 00 68 00 72 00 6a 00 6c 00 2e 00 64 00 6c 00 6c 00 } //00 00 
	condition:
		any of ($a_*)
