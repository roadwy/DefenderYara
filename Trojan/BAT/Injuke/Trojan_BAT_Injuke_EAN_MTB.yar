...
rule Trojan_BAT_Injuke_EAN_MTB{
	...
	strings :
		$a_03_0 = {1a 2d 24 26 28 90 01 01 00 00 0a 06 6f 90 01 01 00 00 0a 28 90 01 01 00 00 0a 1c 2d 13 26 07 16 07 8e 69 1d 2d 0d 26 26 26 07 0c de 10 0a 2b da 0b 2b eb 28 90 01 01 00 00 0a 2b ef 26 de be 90 00 } //3
