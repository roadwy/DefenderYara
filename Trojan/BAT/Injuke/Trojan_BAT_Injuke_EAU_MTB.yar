...
rule Trojan_BAT_Injuke_EAU_MTB{
	...
	strings :
		$a_03_0 = {06 0a 28 02 00 00 0a 06 6f 90 01 01 00 00 0a 28 90 01 01 00 00 0a 0b 02 07 28 90 01 01 00 00 06 0c dd 90 01 01 00 00 00 26 dd 90 01 01 ff ff ff 08 2a 90 00 } //3
