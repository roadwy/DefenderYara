...
rule Trojan_BAT_Injuke_ABRZ_MTB{
	...
	strings :
		$a_01_0 = {53 6f 6d 65 62 6f 34 79 2e 39 69 6e 65 2e 72 65 73 6f 75 72 63 65 73 } //03 00 
		...
		$a_01_2 = {4c 00 61 00 67 00 72 00 61 00 6e 00 67 00 65 00 50 00 6f 00 6c 00 79 00 6e 00 6f 00 6d 00 69 00 61 00 6c 00 } //00 00 
	condition:
		any of ($a_*)
