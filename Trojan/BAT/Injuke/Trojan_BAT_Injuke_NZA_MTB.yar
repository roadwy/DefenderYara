...
rule Trojan_BAT_Injuke_NZA_MTB{
	...
	strings :
		...
		$a_01_1 = {21 52 00 76 00 67 00 6e 00 77 00 61 00 6c 00 6e 00 64 00 74 00 79 00 70 00 65 00 63 00 69 00 61 } //01 00  刡瘀最渀眀愀氀渀搀琀礀瀀攀挀椀愀
		$a_01_2 = {39 39 36 62 2d 31 66 30 61 30 36 37 61 61 39 34 37 } //00 00  996b-1f0a067aa947
	condition:
		any of ($a_*)
