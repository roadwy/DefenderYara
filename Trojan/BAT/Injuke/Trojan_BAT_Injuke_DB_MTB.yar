...
rule Trojan_BAT_Injuke_DB_MTB{
	...
	strings :
		$a_03_0 = {11 01 11 00 11 02 11 00 8e 69 5d 91 7e ?? 00 00 04 11 02 91 61 d2 6f ?? 00 00 0a 38 [0-04] 11 01 6f ?? 00 00 0a 2a 73 ?? 00 00 0a 13 01 38 [0-04] 16 13 02 38 } //3
