...
rule Trojan_BAT_Injuke_ASCS_MTB{
	...
	strings :
		...
		$a_01_1 = {44 00 4b 00 4a 00 41 00 59 00 48 00 47 00 44 00 4b 00 49 00 55 00 48 00 20 00 4b 00 48 00 4a 00 47 00 44 00 41 00 47 00 44 00 4a 00 4b 00 41 00 48 00 } //00 00  DKJAYHGDKIUH KHJGDAGDJKAH
	condition:
		any of ($a_*)
