...
rule Trojan_BAT_Heracles_NHM_MTB{
	...
	strings :
		...
		$a_01_1 = {50 00 61 00 73 00 73 00 77 00 6f 00 72 00 64 00 53 00 74 00 65 00 61 00 6c 00 65 00 72 00 2e 00 53 00 74 00 65 00 61 00 6c 00 65 00 72 00 } //00 00  PasswordStealer.Stealer
	condition:
		any of ($a_*)
