...
rule Trojan_BAT_Heracles_GMZ_MTB{
	...
	strings :
		$a_03_0 = {06 07 08 28 ?? ?? ?? 06 8c 2c 00 00 01 28 ?? ?? ?? 0a 28 ?? ?? ?? 0a 0a 08 7e 3f 00 00 04 8e 69 17 59 2e 0c 06 72 2d 03 00 70 28 ?? ?? ?? 0a 0a 08 17 58 0c 08 7e 3f 00 00 04 8e 69 32 c2 } //10
