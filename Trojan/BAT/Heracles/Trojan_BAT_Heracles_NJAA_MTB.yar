...
rule Trojan_BAT_Heracles_NJAA_MTB{
	...
	strings :
		$a_03_0 = {16 0d 38 19 00 00 00 08 07 09 18 28 90 01 01 0e 00 06 1f 10 28 90 01 01 0e 00 06 28 90 01 01 0e 00 06 09 18 58 0d 09 07 28 90 01 01 0e 00 06 32 de 90 00 } //4
