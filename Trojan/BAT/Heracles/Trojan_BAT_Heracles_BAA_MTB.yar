...
rule Trojan_BAT_Heracles_BAA_MTB{
	...
	strings :
		$a_03_0 = {72 c1 00 00 70 28 90 01 01 00 00 0a 72 ed 00 00 70 28 90 01 01 00 00 0a 26 20 f4 01 00 00 28 90 01 01 00 00 0a 28 90 01 01 00 00 0a 6f 90 01 01 00 00 0a 2a 90 00 } //2
