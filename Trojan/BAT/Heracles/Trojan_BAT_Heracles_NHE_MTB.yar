...
rule Trojan_BAT_Heracles_NHE_MTB_2{
	...
	strings :
		$a_03_0 = {38 00 00 00 00 00 11 04 11 0c 28 90 01 01 00 00 06 20 90 01 01 00 00 00 7e 90 01 01 00 00 04 7b 90 01 01 00 00 04 3a 90 01 01 00 00 00 26 20 90 01 01 00 00 00 38 90 01 01 00 00 00 fe 90 01 02 00 90 00 } //5
...
rule Trojan_BAT_Heracles_NHE_MTB_3{
	...
	strings :
		$a_03_0 = {2b fa 02 06 74 90 01 01 00 00 1b 18 9a 06 74 90 01 01 00 00 1b 1a 9a 28 90 01 01 00 00 06 90 00 } //5
