...
rule Trojan_BAT_Heracles_NHH_MTB{
	...
	strings :
		$a_03_0 = {11 12 17 58 13 12 11 1a 20 90 01 03 d4 5a 20 90 01 03 9f 61 38 90 01 03 ff 20 90 01 03 d5 13 0d 11 1a 20 90 01 03 80 5a 20 90 01 03 ec 61 38 90 01 03 ff 11 0e 11 05 32 08 20 90 01 03 e3 25 90 00 } //5
