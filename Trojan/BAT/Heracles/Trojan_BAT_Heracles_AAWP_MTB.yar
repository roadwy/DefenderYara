...
rule Trojan_BAT_Heracles_AAWP_MTB{
	...
	strings :
		$a_03_0 = {0a 0a 06 7e 01 00 00 04 6f 90 01 01 00 00 0a 06 7e 90 01 01 00 00 04 6f 90 01 01 00 00 0a 06 06 6f 90 01 01 00 00 0a 06 6f 90 01 01 00 00 0a 6f 90 01 01 00 00 0a 0b 02 28 90 01 01 00 00 0a 73 90 01 01 00 00 0a 0c 08 07 16 73 90 01 01 00 00 0a 0d 09 73 90 01 01 00 00 0a 13 04 11 04 6f 90 01 01 00 00 0a 13 05 de 2a 11 04 2c 07 11 04 6f 90 01 01 00 00 0a dc 90 00 } //5
