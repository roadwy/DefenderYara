...
rule Trojan_BAT_Heracles_AANU_MTB{
	...
	strings :
		...
		$a_01_1 = {36 00 7a 00 37 00 73 00 73 00 63 00 5a 00 46 00 4b 00 6f 00 76 00 4b 00 33 00 2f 00 31 00 75 00 5a 00 50 00 71 00 65 00 65 00 67 00 3d 00 3d 00 } //01 00 
