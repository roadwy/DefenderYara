...
rule Trojan_BAT_Heracles_NHS_MTB{
	...
	strings :
		...
		$a_01_1 = {52 00 61 00 6e 00 63 00 68 00 72 00 6f 00 73 00 65 00 32 00 32 00 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_BAT_Heracles_NHS_MTB_2{
	...
	strings :
		...
		$a_01_1 = {57 6f 74 75 63 53 6f 66 74 57 61 72 65 2e 50 72 6f 70 65 72 74 69 65 73 2e 52 65 73 6f 75 72 63 65 73 2e 72 65 73 6f 75 72 63 65 73 } //00 00 
	condition:
		any of ($a_*)
