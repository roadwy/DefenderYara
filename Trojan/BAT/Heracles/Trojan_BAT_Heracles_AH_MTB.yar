...
rule Trojan_BAT_Heracles_AH_MTB{
	...
	strings :
		$a_03_0 = {11 03 11 00 11 02 11 00 8e 69 5d 91 7e 90 01 03 04 11 02 91 61 d2 6f 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_BAT_Heracles_AH_MTB_4{
	...
	strings :
		$a_03_0 = {03 8e 2d 0a 12 01 fe 15 02 00 00 1b 07 2a 7e 90 01 03 0a 0a 02 7b 90 01 03 04 0a 03 16 06 03 8e 69 28 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_BAT_Heracles_AH_MTB_6{
	...
	strings :
		$a_03_0 = {0c 16 13 0d 2b 14 08 11 0d 8f 90 01 03 01 25 47 1e 61 d2 52 11 0d 17 58 13 0d 11 0d 08 8e 69 32 e5 90 00 } //2
