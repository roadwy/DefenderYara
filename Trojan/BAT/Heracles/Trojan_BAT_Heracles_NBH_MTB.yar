...
rule Trojan_BAT_Heracles_NBH_MTB{
	...
	strings :
		$a_03_0 = {12 02 fe 16 13 00 00 02 6f 90 01 03 0a 7e 90 01 03 04 28 90 01 03 06 73 90 01 03 0a 7a 11 01 1a 9a a5 90 01 03 01 13 00 38 90 01 03 ff 11 07 1f 13 58 90 00 } //5
