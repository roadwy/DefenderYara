...
rule Trojan_BAT_Heracles_NH_MTB{
	...
	strings :
		...
		$a_01_1 = {4e 6a 72 67 61 6f 73 68 78 78 6f 6f 69 6b 73 72 67 78 74 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_BAT_Heracles_NH_MTB_2{
	...
	strings :
		...
		$a_01_1 = {47 48 4c 2e 65 78 65 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_BAT_Heracles_NH_MTB_3{
	...
	strings :
		...
		$a_01_2 = {76 00 53 00 53 00 31 00 34 00 6c 00 70 00 57 00 4e 00 6b 00 44 00 43 00 59 00 4c 00 33 00 65 00 45 00 46 00 4f 00 47 00 77 00 45 00 3d 00 } //01 00 
		$a_01_3 = {4c 00 36 00 6a 00 30 00 47 00 4d 00 49 00 78 00 4f 00 36 00 43 00 53 00 58 00 4c 00 48 00 73 00 66 00 30 00 37 00 30 00 62 00 } //00 00 
	condition:
		any of ($a_*)
