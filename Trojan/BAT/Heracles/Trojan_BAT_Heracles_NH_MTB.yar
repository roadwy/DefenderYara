...
rule Trojan_BAT_Heracles_NH_MTB{
	...
	strings :
		$a_03_0 = {08 06 08 06 93 02 7b 90 01 01 01 00 04 07 91 04 60 61 d1 9d 2b 03 0b 2b e0 06 17 59 25 0a 90 00 } //10
	condition:
		((#a_03_0  & 1)*10) >=10
...
rule Trojan_BAT_Heracles_NH_MTB_2{
	...
	strings :
		$a_03_0 = {2b 03 0c 2b f5 2a 06 6f 90 01 02 00 06 28 90 01 02 00 0a 28 90 01 02 00 0a 2a 90 00 } //5
...
rule Trojan_BAT_Heracles_NH_MTB_4{
	...
	strings :
		$a_03_0 = {73 0f 04 00 06 06 20 90 01 03 35 60 0a 6f 90 01 03 0a 20 90 01 03 4e 06 44 90 01 03 ff 02 20 90 01 03 3b 06 60 90 01 03 00 00 04 06 20 90 01 03 3f 61 20 90 01 03 4d 06 5f 0a 02 fe 90 01 04 06 06 20 90 01 03 00 62 0a 73 90 01 03 06 20 90 01 03 18 06 60 0a 6f 90 01 03 0a 02 7b 90 01 03 04 06 20 90 01 03 18 61 20 90 01 03 3e 06 5e 0a 02 20 90 01 03 45 06 20 90 01 03 00 5f 62 0a 90 00 } //5
...
rule Trojan_BAT_Heracles_NH_MTB_5{
	...
	strings :
		$a_03_0 = {11 06 04 11 07 6f 90 01 02 00 0a 11 05 6f 90 01 02 00 0a 13 08 12 08 28 90 01 02 00 0a 72 90 01 02 00 70 28 90 01 02 00 0a 13 06 11 07 17 58 13 07 11 07 04 6f 90 01 02 00 0a fe 04 13 09 11 09 2d c4 90 00 } //5
		$a_03_1 = {28 aa 01 00 0a 0a 06 18 8d 90 01 03 01 25 16 72 90 01 03 70 a2 25 17 72 90 01 03 70 a2 28 90 01 03 06 6f 90 01 03 0a 00 06 18 6f 90 01 03 0a 00 06 18 6f 90 01 03 0a 00 06 6f 90 01 03 0a 0b 90 00 } //5
