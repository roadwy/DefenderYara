...
rule Trojan_BAT_Heracles_MBAR_MTB{
	...
	strings :
		$a_03_0 = {0a 0b 06 02 6f 90 01 01 00 00 0a 0c 08 07 6f 90 01 01 00 00 0a 08 6f 90 01 01 00 00 0a 07 6f 90 01 01 00 00 0a 0d 07 6f 90 01 01 00 00 0a 09 2a 90 00 } //1
