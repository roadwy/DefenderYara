...
rule Trojan_BAT_Perseus_GNP_MTB{
	...
	strings :
		$a_03_0 = {0a 1f 0b 28 90 01 03 06 0b 1f 38 28 90 01 03 06 0c 02 1c 8d 90 01 04 25 16 72 90 01 04 a2 25 17 06 a2 25 18 72 90 01 04 a2 25 19 07 a2 25 1a 72 90 01 04 a2 25 1b 08 a2 90 00 } //10
