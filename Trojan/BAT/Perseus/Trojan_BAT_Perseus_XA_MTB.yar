...
rule Trojan_BAT_Perseus_XA_MTB{
	...
	strings :
		...
		$a_03_3 = {63 6f 73 74 75 72 61 2e 90 02 08 2e 64 6c 6c 2e 64 6c 6c 2e 7a 69 70 90 00 } //20
		$a_03_4 = {63 6f 73 74 75 72 61 2e 90 02 08 2e 64 6c 6c 2e 70 64 62 2e 7a 69 70 90 00 } //20
