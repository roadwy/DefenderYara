...
rule Trojan_BAT_Dothetuk_ADH_MTB{
	...
	strings :
		$a_03_0 = {16 13 0e 2b 30 00 00 08 11 0c 11 0e 8f 14 00 00 02 7c 2c 00 00 04 7b 22 00 00 04 28 ?? ?? ?? 0a 6f ?? ?? ?? 0a 00 00 de 05 26 00 00 de 00 00 11 0e 17 58 13 0e 11 0e 6a 11 07 6e fe 04 13 0f 11 0f 2d c2 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_BAT_Dothetuk_ADH_MTB_2{
	...
	strings :
		$a_03_0 = {0c 03 07 05 0e 04 73 09 00 00 0a 0d 09 0e 06 1e 5b 6f ?? ?? ?? 0a 13 04 28 ?? ?? ?? 0a 13 05 11 05 17 6f ?? ?? ?? 0a 08 8e 69 8d 0a 00 00 01 13 06 16 13 07 11 05 11 04 06 6f ?? ?? ?? 0a 13 08 08 } //2
