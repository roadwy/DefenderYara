...
rule Trojan_BAT_BitRAT_ABGY_MTB{
	...
	strings :
		$a_03_0 = {11 02 11 0b 11 02 6f 90 01 03 0a 1e 5b 28 90 01 03 06 6f 90 01 03 0a 38 90 01 03 00 28 90 01 03 0a 72 90 01 03 70 28 90 01 03 06 13 03 38 90 01 03 ff 11 01 11 02 6f 90 01 03 0a 17 73 90 01 03 0a 13 09 90 00 } //2
