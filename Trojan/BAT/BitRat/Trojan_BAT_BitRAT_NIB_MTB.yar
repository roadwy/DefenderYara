...
rule Trojan_BAT_BitRAT_NIB_MTB{
	...
	strings :
		$a_03_0 = {0a 06 72 9b 04 00 70 6f ?? ?? 00 0a 80 ?? ?? 00 04 16 0b 2b 1b 00 7e ?? ?? 00 04 07 7e ?? ?? 00 04 07 91 20 ?? ?? 00 00 59 d2 9c 00 07 17 58 0b 07 7e ?? ?? 00 04 8e 69 fe 04 0c 08 2d d7 } //5
