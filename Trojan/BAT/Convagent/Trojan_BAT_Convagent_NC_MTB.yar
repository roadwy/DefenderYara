...
rule Trojan_BAT_Convagent_NC_MTB{
	...
	strings :
		$a_03_0 = {8d 86 00 00 01 25 16 17 9c 25 17 17 9c 25 13 07 17 28 90 01 01 00 00 0a 26 11 07 16 91 2d 02 2b 20 11 0f 11 06 16 9a 28 90 01 01 00 00 0a d0 90 01 01 00 00 01 28 90 01 01 00 00 0a 28 90 01 01 00 00 0a 74 90 01 01 00 00 01 51 90 00 } //5
