...
rule Trojan_BAT_Convagent_NHD_MTB{
	...
	strings :
		$a_03_0 = {02 14 7d 01 00 00 04 02 28 90 01 01 00 00 0a 00 00 02 28 90 01 01 00 00 06 00 72 90 01 01 00 00 70 0a 06 73 90 01 01 00 00 0a 0b 07 6f 90 01 01 00 00 0a 00 72 90 01 01 00 00 70 0c 08 07 73 90 01 01 00 00 0a 0d 09 6f 90 01 01 00 00 0a 6f 90 01 01 00 00 0a 13 04 02 7b 90 01 01 00 00 04 11 04 6f 90 01 01 00 00 0a 00 07 6f 90 01 01 00 00 0a 90 00 } //5
