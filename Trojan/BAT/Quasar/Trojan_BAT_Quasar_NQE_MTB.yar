...
rule Trojan_BAT_Quasar_NQE_MTB{
	...
	strings :
		$a_03_0 = {28 0b 00 00 0a 0c 73 ?? 00 00 0a 0d 73 ?? 00 00 0a 13 04 11 04 09 06 07 6f ?? 00 00 0a 17 73 ?? 00 00 0a 13 05 11 05 08 16 08 8e 69 6f ?? 00 00 0a 11 05 } //5
		$a_03_1 = {72 19 24 29 70 a2 11 07 17 11 04 28 ?? ?? ?? 0a a2 11 07 13 08 11 06 28 ?? ?? ?? 0a 28 ?? ?? ?? 0a 72 ?? ?? ?? 70 6f ?? ?? ?? 0a 72 ?? ?? ?? 70 20 ?? ?? ?? 00 } //5
