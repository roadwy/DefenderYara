...
rule Trojan_BAT_Quasar_NAS_MTB{
	...
	strings :
		...
		$a_01_1 = {67 69 74 68 75 62 2e 63 6f 6d 2f 33 46 2f 43 6f 6e 61 72 69 } //01 00 
		$a_01_2 = {52 00 78 00 4c 00 48 00 58 00 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_BAT_Quasar_NAS_MTB_2{
	...
	strings :
		...
		$a_01_1 = {71 00 61 00 7a 00 77 00 73 00 78 00 } //01 00 
