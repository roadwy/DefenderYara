...
rule Trojan_BAT_Quasar_NAS_MTB{
	...
	strings :
		$a_03_0 = {95 11 0d 1d 95 5a 9e 11 17 20 90 01 03 44 5a 20 90 01 03 4c 61 38 90 01 03 ff 11 0c 1e 11 0c 1e 95 11 0d 1e 95 90 00 } //5
...
rule Trojan_BAT_Quasar_NAS_MTB_2{
	...
	strings :
		$a_03_0 = {28 10 00 00 0a 72 90 01 01 00 00 70 02 73 90 01 01 00 00 0a 28 90 01 01 00 00 0a 28 90 01 01 00 00 0a 28 90 01 01 00 00 0a 06 02 6f 90 01 01 00 00 0a 0b 25 07 28 90 01 01 00 00 0a 28 17 00 00 0a 90 00 } //5
