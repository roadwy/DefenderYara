...
rule Trojan_BAT_Quasar_NQW_MTB{
	...
	strings :
		$a_03_0 = {28 26 00 00 0a 0a 73 90 01 03 0a 0b 06 02 6f 90 01 03 0a 0c 08 07 6f 90 01 03 0a 08 6f 90 01 03 0a 07 6f 90 01 03 0a 0d 07 6f 90 01 03 0a 09 90 00 } //5
