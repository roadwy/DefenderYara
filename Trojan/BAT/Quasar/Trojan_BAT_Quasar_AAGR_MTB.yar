...
rule Trojan_BAT_Quasar_AAGR_MTB{
	...
	strings :
		...
		$a_01_1 = {4b 00 4d 00 45 00 56 00 74 00 52 00 7a 00 78 00 47 00 30 00 6f 00 57 00 6c 00 2f 00 76 00 4f 00 34 00 74 00 6c 00 38 00 38 00 76 00 34 00 68 00 4a 00 63 00 42 00 4e 00 49 00 7a 00 73 00 6f 00 6f 00 38 00 67 00 48 00 54 00 4b 00 4d 00 50 00 6d 00 6f 00 55 00 3d 00 } //01 00 
