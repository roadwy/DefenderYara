...
rule Trojan_BAT_Quasar_NAQ_MTB{
	...
	strings :
		$a_03_0 = {28 10 00 00 0a 72 90 01 02 00 70 02 73 90 01 02 00 0a 28 90 01 02 00 0a 28 90 01 02 00 0a 28 90 01 02 00 0a 06 02 6f 90 01 02 00 0a 0b 25 07 28 90 01 02 00 0a 28 90 01 02 00 0a 26 90 00 } //5
