...
rule Trojan_BAT_Quasar_MBCW_MTB{
	...
	strings :
		$a_03_0 = {72 01 00 00 70 0a 06 28 90 01 01 00 00 0a 0b 28 90 01 01 00 00 0a 07 16 07 8e 69 6f 90 01 01 00 00 0a 0a 28 90 01 01 00 00 0a 06 6f 90 01 01 00 00 0a 0c 21 61 00 00 00 00 00 00 00 90 00 } //1
