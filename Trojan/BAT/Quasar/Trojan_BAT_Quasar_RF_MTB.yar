...
rule Trojan_BAT_Quasar_RF_MTB{
	...
	strings :
		...
		$a_01_1 = {24 35 66 30 64 63 63 63 38 2d 64 36 39 61 2d 34 39 66 38 2d 39 65 36 34 2d 36 31 61 65 37 37 62 66 66 34 38 66 } //01 00 
		$a_01_2 = {47 00 72 00 61 00 73 00 79 00 61 00 79 00 2e 00 65 00 78 00 65 00 } //00 00 
	condition:
		any of ($a_*)
