...
rule Trojan_BAT_Quasar_NQ_MTB{
	...
	strings :
		$a_03_0 = {06 07 6f 65 00 00 0a 17 73 90 01 01 00 00 0a 0c 08 02 16 02 8e 69 6f 90 01 01 00 00 0a 08 6f 90 01 01 00 00 0a 06 28 90 01 01 00 00 06 0d 28 90 01 01 00 00 06 09 90 00 } //5
...
rule Trojan_BAT_Quasar_NQ_MTB_2{
	...
	strings :
		$a_03_0 = {17 8d 01 00 00 01 25 16 d0 90 01 01 00 00 01 28 90 01 01 00 00 0a 72 90 01 01 00 00 70 28 90 01 01 00 00 0a 28 90 01 01 00 00 06 75 90 01 01 00 00 01 14 6f 90 01 01 00 00 0a 75 90 01 01 00 00 1b 90 00 } //5
...
rule Trojan_BAT_Quasar_NQ_MTB_3{
	...
	strings :
		$a_03_0 = {1a 8d 39 00 00 01 0b 06 07 16 1a 6f 90 01 01 00 00 0a 26 07 16 28 90 01 01 00 00 0a 0c 06 16 73 90 01 01 00 00 0a 0d 08 8d 90 01 01 00 00 01 13 04 09 11 04 16 08 6f 90 01 01 00 00 0a 26 90 00 } //5
...
rule Trojan_BAT_Quasar_NQ_MTB_4{
	...
	strings :
		$a_03_0 = {6f 2b 00 00 0a 72 90 01 03 70 6f 90 01 03 0a 7e 90 01 03 04 6f 90 01 03 0a 72 90 01 03 70 6f 90 01 03 0a 7e 90 01 03 04 6f 90 01 03 0a 72 90 01 03 70 6f 90 01 03 0a 7e 90 01 03 04 6f 90 01 03 0a 90 00 } //5
...
rule Trojan_BAT_Quasar_NQ_MTB_5{
	...
	strings :
		$a_03_0 = {8d 29 00 00 01 25 d0 90 01 01 00 00 04 28 90 01 01 00 00 0a 0a 1f 10 8d 90 01 01 00 00 01 25 d0 90 01 01 00 00 04 28 90 01 01 00 00 0a 0b 02 28 90 01 01 00 00 06 06 07 28 90 01 01 00 00 06 90 00 } //5
