...
rule Trojan_BAT_Quasar_NQQ_MTB_2{
	...
	strings :
		$a_03_0 = {8c 31 00 00 01 a2 11 07 18 08 28 90 01 01 00 00 0a a2 11 07 13 06 11 06 14 14 19 8d 90 01 01 00 00 01 13 08 11 08 16 17 9c 11 08 17 16 9c 11 08 18 17 9c 11 08 17 28 90 01 01 00 00 0a 90 00 } //5
...
rule Trojan_BAT_Quasar_NQQ_MTB_3{
	...
	strings :
		$a_03_0 = {1f 10 28 19 00 00 0a 28 90 01 01 00 00 0a 0b 07 07 06 25 13 04 6f 90 01 01 00 00 0a 11 04 6f 90 01 01 00 00 0a 73 90 01 01 00 00 0a 0c 08 07 6f 90 01 01 00 00 0a 17 73 90 01 01 00 00 0a 0d 09 02 1f 10 02 8e 69 1f 10 59 6f 90 01 01 00 00 0a 90 00 } //5
