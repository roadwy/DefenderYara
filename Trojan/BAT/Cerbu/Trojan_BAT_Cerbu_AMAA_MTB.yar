...
rule Trojan_BAT_Cerbu_AMAA_MTB{
	...
	strings :
		$a_03_0 = {11 06 11 07 11 05 11 07 28 90 01 02 00 06 20 90 01 02 00 00 61 d1 9d 20 90 01 01 00 00 00 28 90 01 02 00 06 13 0c 2b a7 90 00 } //5
...
rule Trojan_BAT_Cerbu_AMAA_MTB_2{
	...
	strings :
		$a_03_0 = {0a 25 8e 69 0b 7e 90 01 01 00 00 0a 20 90 01 02 00 00 20 90 01 02 00 00 1f 40 28 90 01 01 00 00 06 0c 16 08 07 28 90 01 01 00 00 0a 7e 90 01 01 00 00 0a 16 08 7e 90 01 01 00 00 0a 16 7e 90 01 01 00 00 0a 28 90 01 01 00 00 06 15 28 90 01 01 00 00 06 26 2a 90 00 } //1
