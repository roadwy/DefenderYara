...
rule Trojan_BAT_Crysan_KLS_MTB{
	...
	strings :
		$a_03_0 = {d0 21 00 00 01 28 90 01 03 0a 72 01 00 00 70 17 8d 14 00 00 01 25 16 d0 21 00 00 01 28 90 01 03 0a a2 28 90 01 03 0a 14 17 8d 10 00 00 01 25 16 02 50 a2 6f 90 01 03 0a 26 2a 90 00 } //4
