...
rule Trojan_BAT_Crysan_KLS_MTB{
	...
	strings :
		...
		$a_81_1 = {47 65 74 45 78 70 6f 72 74 65 64 54 79 70 65 73 } //02 00 
		$a_81_2 = {47 65 74 41 73 73 65 6d 62 6c 69 65 73 } //02 00 
		$a_81_3 = {47 65 74 4d 65 74 68 6f 64 73 } //00 00 
	condition:
		any of ($a_*)
