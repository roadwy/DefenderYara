...
rule Trojan_BAT_Crysan_LWT_MTB{
	...
	strings :
		...
		$a_81_10 = {56 6f 69 7a 73 } //0a 00 
		$a_81_11 = {43 61 62 72 69 6f 6c 65 74 } //00 00 
	condition:
		any of ($a_*)
