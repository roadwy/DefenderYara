...
rule Trojan_BAT_Crysan_EAS_MTB{
	...
	strings :
		$a_03_0 = {02 11 01 28 90 01 01 00 00 06 13 02 20 00 00 00 00 7e 90 01 01 01 00 04 7b 90 01 01 01 00 04 39 90 01 01 ff ff ff 26 20 00 00 00 00 38 90 01 01 ff ff ff 28 90 01 01 00 00 0a 11 03 6f 90 01 01 00 00 0a 28 90 01 01 00 00 0a 13 01 38 90 00 } //3
