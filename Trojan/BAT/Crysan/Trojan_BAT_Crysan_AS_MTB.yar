...
rule Trojan_BAT_Crysan_AS_MTB{
	...
	strings :
		...
		$a_01_4 = {44 65 6c 65 67 61 74 65 } //01 00 
		$a_01_5 = {54 72 69 6d } //01 00 
		...
		$a_01_9 = {46 6c 75 73 68 46 69 6e 61 6c 42 6c 6f 63 6b } //01 00 
		$a_01_10 = {54 6f 42 61 73 65 36 34 53 74 72 69 6e 67 } //01 00 
		$a_01_11 = {67 65 74 5f 45 78 65 63 75 74 61 62 6c 65 50 61 74 68 } //01 00 
		$a_01_12 = {52 65 61 64 41 6c 6c 54 65 78 74 } //00 00 
	condition:
		any of ($a_*)
