...
rule Trojan_BAT_Crysan_BAN_MTB{
	...
	strings :
		$a_03_0 = {06 09 1a 5a 28 90 01 01 00 00 0a 6e 7e 90 01 01 00 00 04 8e 69 6a 5e 13 04 07 7e 90 01 01 00 00 04 11 04 28 90 01 01 00 00 0a 28 90 01 01 00 00 0a 93 6f 90 01 01 00 00 0a 26 09 17 58 0d 09 02 32 ca 90 00 } //2
