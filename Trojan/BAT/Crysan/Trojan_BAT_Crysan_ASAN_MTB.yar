...
rule Trojan_BAT_Crysan_ASAN_MTB{
	...
	strings :
		$a_03_0 = {0b 02 16 07 16 07 8e 69 28 ?? ?? ?? 0a 00 06 03 6f ?? ?? ?? 0a 00 06 07 6f ?? ?? ?? 0a 00 73 0f 00 00 0a 0c 00 08 06 6f ?? ?? ?? 0a 17 73 11 00 00 0a 13 04 00 11 04 02 07 8e 69 02 8e 69 07 8e 69 59 } //2
