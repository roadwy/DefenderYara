...
rule Trojan_BAT_Crysan_ABEY_MTB{
	...
	strings :
		$a_03_0 = {0a 08 09 6f 90 01 03 0a 7e 90 01 03 04 73 90 01 03 0a 13 06 11 06 02 7e 90 01 03 04 02 8e 69 6f 90 01 03 0a 11 06 6f 90 01 03 0a dd 90 01 03 00 11 06 39 90 01 03 00 11 06 6f 90 01 03 0a dc 90 0a 49 00 09 7e 90 01 03 04 6f 90 00 } //2
