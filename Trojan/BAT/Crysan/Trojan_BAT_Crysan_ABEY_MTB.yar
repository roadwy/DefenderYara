...
rule Trojan_BAT_Crysan_ABEY_MTB{
	...
	strings :
		...
		$a_01_2 = {49 00 73 00 44 00 65 00 62 00 75 00 67 00 67 00 65 00 72 00 50 00 72 00 65 00 73 00 65 00 6e 00 74 00 } //01 00  IsDebuggerPresent
		$a_01_3 = {43 00 41 00 44 00 31 00 30 00 39 00 34 00 33 00 38 00 38 00 38 00 37 00 35 00 } //00 00  CAD1094388875
	condition:
		any of ($a_*)
