...
rule Trojan_BAT_Crysan_MTB{
	...
	strings :
		$a_03_0 = {0a 06 0b 16 8d 4c 90 01 02 01 0c 07 7e 36 90 01 02 04 25 2d 17 26 7e 35 90 01 02 04 fe 06 90 01 03 06 73 5f 90 01 02 0a 25 80 36 90 01 02 04 28 01 90 01 02 2b 28 02 90 01 02 2b 0c 90 00 } //5
...
rule Trojan_BAT_Crysan_MTB_2{
	...
	strings :
		$a_03_0 = {07 16 fe 01 0d 09 2c 14 06 07 07 b4 9c 06 07 17 d6 03 28 b7 90 01 02 0a b4 9c 00 2b 18 07 17 fe 02 13 04 11 04 2c 0e 06 07 03 1f 63 d6 28 b7 90 01 02 0a b4 9c 90 00 } //6
