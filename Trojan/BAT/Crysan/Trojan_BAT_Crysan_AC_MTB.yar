...
rule Trojan_BAT_Crysan_AC_MTB_2{
	...
	strings :
		$a_03_0 = {a2 25 17 7e 90 01 01 00 00 0a a2 25 18 09 a2 25 19 17 8c 90 01 01 00 00 01 a2 13 04 14 13 05 07 28 90 01 01 00 00 0a 72 90 01 01 02 00 70 6f 90 01 01 00 00 0a 72 90 00 } //00 00 
	condition:
		any of ($a_*)
