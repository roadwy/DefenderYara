...
rule Trojan_BAT_Dcstl_ABCQ_MTB{
	...
	strings :
		...
		$a_01_2 = {43 72 79 69 6e 67 57 6f 6c 66 2e 50 72 6f 70 65 72 74 69 65 73 2e 52 65 73 6f 75 72 63 65 73 2e 72 65 73 6f 75 72 63 65 73 } //00 00  CryingWolf.Properties.Resources.resources
	condition:
		any of ($a_*)
