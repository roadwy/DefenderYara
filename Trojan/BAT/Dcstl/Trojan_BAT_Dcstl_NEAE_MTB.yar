...
rule Trojan_BAT_Dcstl_NEAE_MTB{
	...
	strings :
		...
		$a_01_1 = {52 65 6c 65 61 73 65 5c 53 65 74 75 70 2e 70 64 62 } //02 00  Release\Setup.pdb
		$a_01_2 = {41 62 61 64 64 6f 6e 53 74 75 62 2e 53 74 61 72 74 } //00 00  AbaddonStub.Start
	condition:
		any of ($a_*)
