...
rule Trojan_BAT_Dcstl_NA_MTB{
	meta:
		description = "Trojan:BAT/Dcstl.NA!MTB,SIGNATURE_TYPE_PEHSTR_EXT,10 00 10 00 08 00 00 05 00 "
		
	strings :
		$a_01_0 = {3a 00 2f 00 2f 00 69 00 63 00 61 00 6e 00 68 00 61 00 7a 00 69 00 70 00 2e 00 63 00 6f 00 6d 00 2f 00 } //05 00  ://icanhazip.com/
		...
		$a_01_7 = {53 70 72 65 61 64 4d 6f 64 65 } //00 00  SpreadMode
	condition:
		any of ($a_*)
