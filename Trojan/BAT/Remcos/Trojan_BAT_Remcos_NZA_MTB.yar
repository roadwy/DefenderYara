...
rule Trojan_BAT_Remcos_NZA_MTB{
	...
	strings :
		$a_03_0 = {0a 02 16 02 8e 69 6f ?? 00 00 0a 0a 2b 00 06 } //1
...
rule Trojan_BAT_Remcos_NZA_MTB_2{
	...
	strings :
		$a_03_0 = {fe 0c 07 00 fe 0c 28 00 20 05 00 00 00 9c fe 0c 1e 00 fe 0c 28 00 7e ?? ?? ?? 04 fe 0c 0f 00 fe 0c 03 00 58 4a 97 29 0d 00 00 11 a2 fe 0c 28 00 20 01 00 00 00 58 fe 0e 28 00 fe 0c 0f 00 } //1
