...
rule Trojan_BAT_Remcos_ABVC_MTB{
	...
	strings :
		$a_03_0 = {11 05 11 02 6f 90 01 01 00 00 0a 25 26 11 03 1f 18 28 90 01 01 00 00 06 14 14 11 06 74 90 01 01 00 00 1b 6f 90 01 01 00 00 0a 25 26 26 38 90 01 01 ff ff ff 28 90 01 01 00 00 06 25 26 28 90 01 01 00 00 0a 25 26 13 05 90 00 } //3
