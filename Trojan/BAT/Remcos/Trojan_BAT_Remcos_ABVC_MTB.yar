...
rule Trojan_BAT_Remcos_ABVC_MTB{
	...
	strings :
		...
		$a_01_1 = {32 32 32 30 36 66 62 30 2d 63 39 38 30 2d 34 61 63 38 2d 38 32 39 34 2d 38 36 32 31 35 30 32 63 66 31 38 36 } //00 00  22206fb0-c980-4ac8-8294-8621502cf186
	condition:
		any of ($a_*)
