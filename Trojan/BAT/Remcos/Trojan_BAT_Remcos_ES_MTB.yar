...
rule Trojan_BAT_Remcos_ES_MTB{
	...
	strings :
		$a_02_0 = {13 04 11 04 16 09 16 1f 10 28 90 01 03 0a 00 11 04 16 09 1f 0f 1e 28 90 01 03 0a 00 06 09 6f 90 01 03 0a 00 06 18 6f 90 01 03 0a 00 06 6f 90 01 03 0a 13 05 02 28 90 01 03 0a 13 06 28 90 01 03 0a 11 05 11 06 16 11 06 8e 69 6f 90 01 03 0a 6f 90 01 03 0a 0c 08 13 08 de 0c 90 00 } //10
