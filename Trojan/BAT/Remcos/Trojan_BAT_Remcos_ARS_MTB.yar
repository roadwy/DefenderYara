...
rule Trojan_BAT_Remcos_ARS_MTB{
	...
	strings :
		$a_03_0 = {03 08 03 8e 69 5d 7e 03 01 00 04 03 08 03 8e 69 5d 91 07 08 07 8e 69 5d 91 61 28 ?? ?? ?? 06 03 08 19 58 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_BAT_Remcos_ARS_MTB_3{
	...
	strings :
		$a_03_0 = {0b 16 0c 16 0c 2b 46 03 08 03 8e 69 5d 1b 59 1b 58 03 08 03 8e 69 5d 91 07 08 07 8e 69 5d 91 61 28 ?? 00 00 0a 03 08 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_BAT_Remcos_ARS_MTB_5{
	...
	strings :
		$a_03_0 = {02 8e 69 8d ?? 00 00 01 0a 16 0b 38 ?? 00 00 00 06 07 02 07 91 72 ?? 00 00 70 28 ?? 00 00 0a 59 d2 9c 07 17 58 0b 07 02 8e 69 32 e4 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_BAT_Remcos_ARS_MTB_6{
	...
	strings :
		$a_03_0 = {0b 7e 01 00 00 04 07 6f ?? ?? ?? 0a 00 7e 01 00 00 04 18 6f ?? ?? ?? 0a 00 02 05 03 04 16 28 ?? ?? ?? 06 0c 2b 00 08 2a } //2
...
rule Trojan_BAT_Remcos_ARS_MTB_7{
	...
	strings :
		$a_03_0 = {16 0a 38 3f 00 00 00 28 ?? ?? ?? 06 75 01 00 00 1b 28 ?? ?? ?? 0a 0b d0 01 00 00 01 28 ?? ?? ?? 0a 72 01 00 00 70 28 ?? ?? ?? 0a 07 14 6f ?? ?? ?? 0a 75 02 00 00 1b 28 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_BAT_Remcos_ARS_MTB_8{
	...
	strings :
		$a_03_0 = {2b 20 00 11 0a 11 0f 8f ?? 00 00 01 25 47 11 0b 11 0f 11 0b 8e 69 5d 91 61 d2 52 00 11 0f 17 58 13 0f 11 0f 11 0a 8e 69 } //2
		$a_03_1 = {2b 21 00 11 09 11 08 11 0d 18 6f ?? 00 00 0a 1f 10 28 ?? 00 00 0a 6f ?? 00 00 0a 00 00 11 0d 18 58 13 0d 11 0d 11 08 6f ?? 00 00 0a fe 04 13 0e 11 0e 2d ce } //2
