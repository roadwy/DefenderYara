...
rule Trojan_BAT_Remcos_EP_MTB{
	...
	strings :
		$a_02_0 = {01 25 16 02 28 90 01 03 06 a2 14 14 14 28 90 01 03 0a 74 90 01 03 01 13 0c 11 07 6c 04 6c 5b 13 0d 02 11 0c 72 90 01 03 70 6f 90 01 03 0a 7d 90 01 03 04 11 0d 0a 2b 25 00 00 11 07 13 06 16 13 0e 2b 90 00 } //10
