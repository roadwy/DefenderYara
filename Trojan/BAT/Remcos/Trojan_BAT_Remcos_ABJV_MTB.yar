...
rule Trojan_BAT_Remcos_ABJV_MTB{
	...
	strings :
		...
		$a_01_1 = {53 00 69 00 6d 00 75 00 6c 00 61 00 74 00 69 00 6f 00 6e 00 52 00 65 00 6d 00 6f 00 6e 00 74 00 65 00 65 00 53 00 6b 00 69 00 } //00 00  SimulationRemonteeSki
	condition:
		any of ($a_*)
