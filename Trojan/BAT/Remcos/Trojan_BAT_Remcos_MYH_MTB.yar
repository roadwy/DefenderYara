...
rule Trojan_BAT_Remcos_MYH_MTB{
	...
	strings :
		$a_03_0 = {7e 1e 00 00 04 72 e9 04 00 70 72 ed 04 00 70 6f 90 01 03 0a 28 90 01 03 06 28 90 01 03 0a 28 90 01 03 06 28 90 01 03 0a 0b 28 90 01 03 06 14 72 f3 04 00 70 17 8d 17 00 00 01 25 16 07 90 00 } //2
