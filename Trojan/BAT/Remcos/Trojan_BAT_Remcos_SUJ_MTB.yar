...
rule Trojan_BAT_Remcos_SUJ_MTB{
	...
	strings :
		$a_02_0 = {00 02 6f 89 00 00 0a 18 5b 8d 76 00 00 01 0a 16 0b 2b 1a 00 06 07 02 07 18 5a 18 [0-05] 1f 10 28 8b 00 00 0a 9c 00 07 17 58 0b 07 06 8e 69 fe 04 0c 08 2d dc } //1
