...
rule Trojan_BAT_Remcos_HE_MTB{
	meta:
		description = "Trojan:BAT/Remcos.HE!MTB,SIGNATURE_TYPE_PEHSTR_EXT,16 00 16 00 0d 00 00 14 00 "
		
	strings :
		$a_00_0 = {24 39 63 30 32 36 35 39 30 2d 66 39 31 38 2d 34 63 36 61 2d 61 33 65 62 2d 30 36 32 65 35 38 36 33 38 32 34 34 } //14 00  $9c026590-f918-4c6a-a3eb-062e58638244
		$a_00_1 = {24 32 32 63 32 62 38 61 63 2d 34 65 31 61 2d 34 61 37 65 2d 62 34 64 30 2d 63 32 38 65 37 61 38 37 63 62 63 36 } //14 00  $22c2b8ac-4e1a-4a7e-b4d0-c28e7a87cbc6
		$a_00_2 = {24 66 30 35 64 30 64 64 36 2d 61 36 65 64 2d 34 37 34 64 2d 61 38 32 35 2d 64 61 30 62 38 62 30 32 39 61 63 35 } //01 00  $f05d0dd6-a6ed-474d-a825-da0b8b029ac5
