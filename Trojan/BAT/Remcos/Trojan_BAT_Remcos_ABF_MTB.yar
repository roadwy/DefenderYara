...
rule Trojan_BAT_Remcos_ABF_MTB{
	...
	strings :
		$a_03_0 = {06 16 06 8e 69 6f 90 01 03 0a 13 04 11 04 03 28 90 01 03 06 28 90 01 03 06 72 90 01 03 70 6f 90 01 03 0a 80 90 01 03 04 02 03 73 90 01 03 0a 8c 90 01 03 01 13 05 2b 00 11 05 2a 90 00 } //5
