...
rule Trojan_BAT_Remcos_ARM_MTB{
	...
	strings :
		$a_03_0 = {16 0a 2b 38 16 0b 2b 21 08 06 07 28 90 01 03 06 13 09 09 12 09 28 90 01 03 0a 8c 07 00 00 01 28 90 01 03 06 26 07 17 58 0b 07 08 28 90 01 03 06 fe 04 13 06 11 06 2d d0 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_BAT_Remcos_ARM_MTB_2{
	...
	strings :
		...
		$a_03_1 = {7b 28 00 00 04 59 0c 90 01 09 06 5a 06 5a 07 07 5a 58 08 08 5a 58 28 90 00 } //1
	condition:
...
rule Trojan_BAT_Remcos_ARM_MTB_4{
	...
	strings :
		...
		$a_03_1 = {16 0b 2b 1a 00 06 07 02 07 18 5a 18 6f 90 01 01 00 00 0a 1f 10 28 90 01 01 00 00 0a 9c 00 07 17 58 0b 07 06 8e 69 fe 04 0c 08 2d dc 90 00 } //2
...
rule Trojan_BAT_Remcos_ARM_MTB_5{
	...
	strings :
		$a_03_0 = {0a 02 8e 69 20 00 10 00 00 1f 40 28 90 01 01 00 00 06 0a 16 0b 25 06 02 02 8e 69 12 01 28 90 01 01 00 00 06 26 7e 90 01 01 00 00 0a 0c 7e 90 01 01 00 00 0a 16 20 ff 0f 00 00 28 90 01 01 00 00 0a 7e 90 01 01 00 00 0a 1a 12 02 28 90 00 } //1
