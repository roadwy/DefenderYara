...
rule Trojan_BAT_Remcos_HM_MTB{
	meta:
		description = "Trojan:BAT/Remcos.HM!MTB,SIGNATURE_TYPE_PEHSTR_EXT,18 00 18 00 0c 00 00 14 00 "
		
	strings :
		$a_81_0 = {24 63 32 63 64 30 30 66 38 2d 30 38 37 64 2d 34 64 39 35 2d 61 63 62 32 2d 38 31 31 61 32 37 39 38 39 61 31 35 } //14 00  $c2cd00f8-087d-4d95-acb2-811a27989a15
		$a_81_1 = {24 34 63 35 33 39 31 35 61 2d 31 66 30 35 2d 34 65 35 63 2d 38 64 63 66 2d 32 66 34 65 32 32 39 31 62 33 62 34 } //14 00  $4c53915a-1f05-4e5c-8dcf-2f4e2291b3b4
		$a_81_2 = {24 35 35 36 65 39 36 36 30 2d 66 61 33 62 2d 34 33 32 39 2d 62 63 31 62 2d 63 38 35 31 39 33 65 63 37 34 39 62 } //01 00  $556e9660-fa3b-4329-bc1b-c85193ec749b
