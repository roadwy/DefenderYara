...
rule Trojan_BAT_Remcos_MI_MTB{
	...
	strings :
		$a_81_0 = {53 74 61 72 5f 57 61 72 73 5f 54 68 65 5f 45 6d 70 69 72 65 5f 53 74 72 69 6b 65 73 5f 42 61 63 6b 5f 69 63 6f 6e } //01 00  Star_Wars_The_Empire_Strikes_Back_icon
		$a_01_1 = {58 43 43 56 56 } //01 00  XCCVV
		...
		$a_01_6 = {47 65 74 44 6f 6d 61 69 6e } //00 00  GetDomain
	condition:
		any of ($a_*)
