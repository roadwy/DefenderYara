...
rule Trojan_BAT_Remcos_EU_MTB{
	...
	strings :
		...
		$a_03_2 = {43 6f 6e 73 6f 6c 65 41 70 70 90 02 03 2e 65 78 65 90 00 } //20
		$a_03_3 = {43 6f 6e 73 6f 6c 65 41 70 70 90 02 03 2e 44 65 66 69 6e 69 74 69 6f 6e 73 90 00 } //20
		$a_03_4 = {43 6f 6e 73 6f 6c 65 41 70 70 90 02 03 2e 41 74 74 72 69 62 75 74 65 73 90 00 } //20
