...
rule Trojan_BAT_Remcos_EU_MTB{
	...
	strings :
		$a_81_0 = {6d 6f 6e 65 79 2e 53 74 72 61 74 65 67 69 65 73 } //14 00 
		$a_81_1 = {6d 6f 6e 65 79 2e 65 78 65 } //14 00 
		...
		$a_81_5 = {53 61 6e 64 62 6f 78 69 65 20 48 6f 6c 64 69 6e 67 73 2c 20 4c 4c 43 } //01 00 
		$a_81_6 = {53 61 6e 64 62 6f 78 69 65 20 4c 69 63 65 6e 73 65 20 4d 61 6e 61 67 65 72 } //01 00 
