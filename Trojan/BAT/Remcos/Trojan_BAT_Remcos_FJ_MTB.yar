...
rule Trojan_BAT_Remcos_FJ_MTB{
	meta:
		description = "Trojan:BAT/Remcos.FJ!MTB,SIGNATURE_TYPE_PEHSTR_EXT,18 00 18 00 0b 00 00 14 00 "
		
	strings :
		$a_00_0 = {24 31 37 64 62 66 39 66 35 2d 37 65 31 35 2d 34 36 61 63 2d 62 34 63 63 2d 61 35 32 61 33 64 39 63 64 38 30 37 } //01 00  $17dbf9f5-7e15-46ac-b4cc-a52a3d9cd807
