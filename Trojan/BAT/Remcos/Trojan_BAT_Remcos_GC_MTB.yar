...
rule Trojan_BAT_Remcos_GC_MTB_2{
	...
	strings :
		...
		$a_02_1 = {74 00 74 00 70 00 73 00 3a 00 2f 00 2f 00 90 02 14 2e 00 90 02 1e 2e 00 72 00 75 00 2f 00 90 02 28 90 0a 96 00 68 00 90 00 } //5
		$a_02_2 = {74 74 70 73 3a 2f 2f 90 02 14 2e 90 02 1e 2e 72 75 2f 90 02 28 90 0a 96 00 68 90 00 } //5
		$a_02_3 = {74 00 74 00 70 00 73 00 3a 00 2f 00 2f 00 90 02 1e 2e 00 72 00 75 00 2f 00 90 02 28 90 0a 5a 00 68 00 90 00 } //5
		$a_02_4 = {74 74 70 73 3a 2f 2f 90 02 1e 2e 72 75 2f 90 02 28 90 0a 5a 00 68 90 00 } //5
