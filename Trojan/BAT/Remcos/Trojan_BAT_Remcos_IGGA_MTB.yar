...
rule Trojan_BAT_Remcos_IGGA_MTB{
	...
	strings :
		...
		$a_01_1 = {35 00 37 00 48 00 33 00 46 00 4e 00 50 00 43 00 35 00 34 00 4a 00 48 00 58 00 46 00 46 00 46 00 38 00 44 00 43 00 33 00 34 00 37 00 } //01 00  57H3FNPC54JHXFFF8DC347
		$a_01_2 = {51 00 61 00 75 00 6c 00 69 00 } //00 00  Qauli
	condition:
		any of ($a_*)
