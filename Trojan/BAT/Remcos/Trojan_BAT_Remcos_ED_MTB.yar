...
rule Trojan_BAT_Remcos_ED_MTB{
	meta:
		description = "Trojan:BAT/Remcos.ED!MTB,SIGNATURE_TYPE_PEHSTR_EXT,21 00 21 00 0b 00 00 14 00 "
		
	strings :
		$a_81_0 = {24 62 34 63 37 36 35 32 62 2d 32 34 38 36 2d 34 34 66 33 2d 38 33 35 38 2d 34 62 64 30 39 61 30 33 65 63 37 63 } //05 00  $b4c7652b-2486-44f3-8358-4bd09a03ec7c
		...
		$a_81_4 = {43 44 41 2e 4d 79 2e 52 65 73 6f 75 72 63 65 73 } //01 00  CDA.My.Resources
