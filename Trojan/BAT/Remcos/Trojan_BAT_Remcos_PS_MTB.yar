...
rule Trojan_BAT_Remcos_PS_MTB{
	meta:
		description = "Trojan:BAT/Remcos.PS!MTB,SIGNATURE_TYPE_PEHSTR_EXT,19 00 19 00 0c 00 00 14 00 "
		
	strings :
		$a_81_0 = {24 65 32 35 61 30 34 63 39 2d 64 32 65 38 2d 34 36 63 63 2d 61 38 39 38 2d 63 64 37 66 34 30 63 31 38 37 30 33 } //14 00  $e25a04c9-d2e8-46cc-a898-cd7f40c18703
		$a_81_1 = {24 32 31 36 34 35 63 30 39 2d 34 30 35 39 2d 34 31 36 61 2d 61 32 39 31 2d 37 30 31 63 61 62 31 37 33 34 32 33 } //14 00  $21645c09-4059-416a-a291-701cab173423
		$a_81_2 = {24 37 34 64 62 35 37 66 31 2d 39 36 34 66 2d 34 36 33 62 2d 61 33 35 38 2d 65 38 63 33 37 61 64 66 66 38 30 65 } //01 00  $74db57f1-964f-463b-a358-e8c37adff80e
