...
rule Trojan_BAT_Remcos_AR_MTB_2{
	...
	strings :
		$a_03_0 = {11 00 11 01 02 11 01 91 72 90 01 01 00 00 70 28 90 01 01 00 00 06 59 d2 9c 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_BAT_Remcos_AR_MTB_3{
	...
	strings :
		$a_03_0 = {11 04 08 06 08 8e 69 5d 91 09 06 91 61 d2 6f 90 01 03 0a 06 17 58 0a 06 09 8e 69 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_BAT_Remcos_AR_MTB_5{
	...
	strings :
		$a_03_0 = {1d 5f 58 13 04 2b 15 02 7b 69 00 00 04 18 1f 0a 28 90 01 03 06 11 04 1f 0a 59 13 04 11 04 16 30 e6 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_BAT_Remcos_AR_MTB_6{
	...
	strings :
		$a_03_0 = {04 06 1a 58 4a 04 8e 69 5d 91 07 06 1a 58 4a 07 8e 69 5d 91 61 28 90 01 03 06 04 06 1a 58 4a 1b 58 19 59 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_BAT_Remcos_AR_MTB_12{
	...
	strings :
		$a_03_0 = {02 06 1a 58 4a 02 8e 69 5d 91 07 06 1a 58 4a 07 8e 69 5d 91 61 28 90 01 03 06 02 06 1a 58 4a 1b 58 19 59 17 59 02 8e 69 5d 91 59 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_BAT_Remcos_AR_MTB_13{
	...
	strings :
		$a_03_0 = {0d 16 13 04 2b 1e 09 06 11 04 06 8e 69 5d 91 08 11 04 91 61 d2 6f 90 01 03 0a 11 04 13 05 11 05 17 58 13 04 11 04 08 8e 69 32 db 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_BAT_Remcos_AR_MTB_14{
	...
	strings :
		$a_03_0 = {0a 16 0b 2b 21 06 07 9a 0c 08 72 90 01 03 70 20 00 01 00 00 14 14 14 6f 90 01 03 0a 26 de 03 26 de 00 07 17 58 0b 07 06 8e 69 32 d9 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_BAT_Remcos_AR_MTB_15{
	...
	strings :
		$a_03_0 = {11 05 11 04 06 11 04 8e 69 5d 91 09 06 91 61 d2 6f 90 01 03 0a 06 0c 08 17 58 0a 06 09 8e 69 32 dc 11 05 6f 90 01 03 0a 13 06 16 2d ee 90 00 } //2
	condition:
		((#a_03_0  & 1)*2) >=2
...
rule Trojan_BAT_Remcos_AR_MTB_16{
	...
	strings :
		$a_03_0 = {1c 2d 1d 26 07 28 90 01 03 0a 0c 08 16 08 8e 69 28 90 01 03 0a 08 0d de 25 90 00 } //2
		$a_01_1 = {46 72 6f 6d 42 61 73 65 36 34 53 74 72 69 6e 67 } //1 FromBase64String
	condition:
...
rule Trojan_BAT_Remcos_AR_MTB_17{
	...
	strings :
		$a_03_0 = {07 11 08 72 95 49 00 70 28 90 01 03 0a 72 b3 49 00 70 20 00 01 00 00 14 14 18 8d 10 00 00 01 25 16 06 11 08 9a a2 25 17 1f 10 90 00 } //2
...
rule Trojan_BAT_Remcos_AR_MTB_18{
	...
	strings :
		$a_03_0 = {0d 16 13 04 2b 3b 09 17 8d 90 01 03 01 25 16 08 17 8d 90 01 03 01 25 16 11 04 8c 90 01 03 01 a2 14 28 90 00 } //2
...
rule Trojan_BAT_Remcos_AR_MTB_19{
	...
	strings :
		$a_03_0 = {0d 09 17 6f 90 01 03 06 08 6f 90 01 03 06 09 6f 90 01 03 0a 72 29 00 00 70 28 90 01 03 06 08 6f 90 01 03 06 6f 90 01 03 06 73 2e 04 00 06 1f 16 73 95 06 00 06 13 04 09 6f 90 01 03 06 11 04 6f 90 01 03 0a 16 13 05 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_BAT_Remcos_AR_MTB_20{
	...
	strings :
		$a_03_0 = {16 13 15 2b 28 00 11 13 11 15 18 6f 90 01 03 0a 20 03 02 00 00 28 90 01 03 0a 13 17 11 14 11 17 6f 90 01 03 0a 00 11 15 18 58 13 15 00 11 15 11 13 6f 90 01 03 0a fe 04 13 18 11 18 2d c7 90 00 } //2
...
rule Trojan_BAT_Remcos_AR_MTB_22{
	...
	strings :
		$a_03_0 = {13 04 09 28 90 01 03 06 13 05 18 8d 90 01 03 01 13 06 11 06 16 72 90 01 03 70 a2 11 06 17 11 05 28 90 01 03 0a a2 11 06 13 07 11 04 28 90 00 } //2
...
rule Trojan_BAT_Remcos_AR_MTB_27{
	...
	strings :
		$a_03_0 = {0a 0b 1d 13 05 06 28 90 01 03 0a 7e 09 00 00 04 15 16 28 90 01 03 0a 18 9a 72 15 01 00 70 16 28 90 01 03 0a 16 33 3b 1e 13 05 07 28 90 01 03 0a 2d 2e 1f 09 13 05 07 06 28 90 01 03 0a 7e 09 00 00 04 15 16 28 90 01 03 0a 16 9a 28 90 00 } //2
