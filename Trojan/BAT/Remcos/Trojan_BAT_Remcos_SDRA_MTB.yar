...
rule Trojan_BAT_Remcos_SDRA_MTB{
	...
	strings :
		...
		$a_01_3 = {4b 61 73 68 61 } //01 00  Kasha
		$a_01_4 = {53 61 73 68 61 } //01 00  Sasha
		$a_01_5 = {49 6e 76 6f 6b 65 } //01 00  Invoke
		$a_01_6 = {73 00 64 00 61 00 66 00 61 00 73 00 66 00 77 00 71 00 66 00 77 00 71 00 66 00 67 00 64 00 66 00 73 00 66 00 73 00 64 00 67 00 64 00 73 00 } //01 00  sdafasfwqfwqfgdfsfsdgds
		$a_01_7 = {64 00 73 00 66 00 64 00 73 00 66 00 65 00 2e 00 64 00 73 00 66 00 64 00 73 00 66 00 65 00 } //01 00  dsfdsfe.dsfdsfe
		$a_01_8 = {67 00 72 00 72 00 72 00 72 00 } //00 00  grrrr
	condition:
		any of ($a_*)
