...
rule Trojan_BAT_Remcos_GN_MTB{
	meta:
		description = "Trojan:BAT/Remcos.GN!MTB,SIGNATURE_TYPE_PEHSTR_EXT,18 00 18 00 0b 00 00 14 00 "
		
	strings :
		$a_00_0 = {24 63 32 37 61 32 61 65 33 2d 31 63 66 33 2d 34 37 33 62 2d 38 66 37 34 2d 37 64 38 34 66 64 65 63 65 64 31 37 } //01 00  $c27a2ae3-1cf3-473b-8f74-7d84fdeced17
