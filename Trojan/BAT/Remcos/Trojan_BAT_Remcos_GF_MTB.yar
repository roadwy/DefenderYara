...
rule Trojan_BAT_Remcos_GF_MTB{
	meta:
		description = "Trojan:BAT/Remcos.GF!MTB,SIGNATURE_TYPE_PEHSTR_EXT,18 00 18 00 0d 00 00 14 00 "
		
	strings :
		$a_00_0 = {24 30 62 66 63 61 64 37 34 2d 31 32 32 36 2d 34 65 65 61 2d 38 38 62 30 2d 39 66 38 31 30 66 66 39 34 30 66 35 } //14 00  $0bfcad74-1226-4eea-88b0-9f810ff940f5
		$a_00_1 = {24 34 63 30 38 36 32 39 39 2d 38 63 31 31 2d 34 66 65 31 2d 39 34 66 65 2d 36 34 37 66 33 36 34 66 66 31 35 35 } //14 00  $4c086299-8c11-4fe1-94fe-647f364ff155
		$a_00_2 = {24 39 30 36 37 34 64 38 33 2d 34 39 65 34 2d 34 30 30 66 2d 62 66 62 36 2d 31 61 33 37 32 61 62 39 64 37 34 61 } //01 00  $90674d83-49e4-400f-bfb6-1a372ab9d74a
