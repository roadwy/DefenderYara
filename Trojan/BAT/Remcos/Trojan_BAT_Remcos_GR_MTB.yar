...
rule Trojan_BAT_Remcos_GR_MTB{
	meta:
		description = "Trojan:BAT/Remcos.GR!MTB,SIGNATURE_TYPE_PEHSTR_EXT,18 00 18 00 0b 00 00 14 00 "
		
	strings :
		$a_00_0 = {24 66 33 32 31 30 62 33 37 2d 34 37 39 35 2d 34 37 65 35 2d 62 32 30 65 2d 31 34 63 64 31 62 31 34 36 34 62 36 } //01 00  $f3210b37-4795-47e5-b20e-14cd1b1464b6
