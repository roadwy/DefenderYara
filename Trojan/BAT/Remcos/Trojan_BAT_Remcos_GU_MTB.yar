...
rule Trojan_BAT_Remcos_GU_MTB{
	meta:
		description = "Trojan:BAT/Remcos.GU!MTB,SIGNATURE_TYPE_PEHSTR_EXT,18 00 18 00 0b 00 00 "
		
	strings :
		$a_00_0 = {24 38 37 33 39 34 32 62 37 2d 30 32 31 36 2d 34 37 38 66 2d 61 63 35 31 2d 38 32 66 63 34 37 32 35 38 31 37 65 } //20 $873942b7-0216-478f-ac51-82fc4725817e
