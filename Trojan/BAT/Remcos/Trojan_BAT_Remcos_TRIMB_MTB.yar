...
rule Trojan_BAT_Remcos_TRIMB_MTB{
	meta:
		description = "Trojan:BAT/Remcos.TRIMB!MTB,SIGNATURE_TYPE_PEHSTR_EXT,33 00 33 00 08 00 00 0a 00 "
		
	strings :
		$a_01_0 = {47 65 74 4d 65 74 68 6f 64 } //0a 00  GetMethod
		$a_01_1 = {52 65 70 6c 61 63 65 } //0a 00  Replace
		$a_01_2 = {49 6e 76 6f 6b 65 } //0a 00  Invoke
		$a_01_3 = {52 65 76 65 72 73 65 } //0a 00  Reverse
		$a_01_4 = {54 6f 41 72 72 61 79 } //01 00  ToArray
		$a_80_5 = {68 74 74 70 3a 2f 2f 74 72 69 65 74 6c 6f 6e 67 76 69 6e 68 76 69 65 6e 2e 69 6e 66 6f 2f 2e 74 6d 62 2f } //http://trietlongvinhvien.info/.tmb/  01 00 
