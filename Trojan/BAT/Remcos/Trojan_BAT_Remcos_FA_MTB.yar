...
rule Trojan_BAT_Remcos_FA_MTB{
	...
	strings :
		$a_03_0 = {16 0a 2b 2b 02 7b 90 01 03 04 25 6f 90 01 03 0a 12 00 28 90 01 03 0a 28 90 01 03 0a 6f 90 01 03 0a 06 17 58 0a 20 e8 03 00 00 28 90 01 03 0a 06 1f 0a 32 d0 90 00 } //10
...
rule Trojan_BAT_Remcos_FA_MTB_2{
	...
	strings :
		$a_02_0 = {57 69 6e 64 6f 77 73 46 6f 72 6d 73 41 70 70 90 02 05 2e 50 72 6f 70 65 72 74 69 65 73 90 00 } //1
		$a_02_1 = {43 6f 6e 73 6f 6c 65 41 70 70 90 02 05 2e 65 78 65 90 00 } //1
		$a_02_2 = {68 00 74 00 74 00 70 00 3a 00 2f 00 2f 00 39 00 31 00 2e 00 32 00 34 00 33 00 2e 00 34 00 34 00 2e 00 32 00 32 00 2f 00 90 02 0f 2e 00 70 00 6e 00 67 00 90 00 } //1
