...
rule Trojan_BAT_Remcos_EO_MTB{
	meta:
		description = "Trojan:BAT/Remcos.EO!MTB,SIGNATURE_TYPE_PEHSTR_EXT,17 00 17 00 0c 00 00 14 00 "
		
	strings :
		$a_81_0 = {24 31 31 34 35 35 37 66 37 2d 33 34 66 61 2d 34 61 64 64 2d 39 62 37 32 2d 65 36 62 62 36 63 39 37 34 64 35 66 } //14 00  $114557f7-34fa-4add-9b72-e6bb6c974d5f
		$a_81_1 = {24 33 36 38 38 66 65 32 61 2d 61 63 31 39 2d 34 64 33 34 2d 38 30 61 38 2d 32 31 36 38 64 33 61 35 32 32 37 32 } //14 00  $3688fe2a-ac19-4d34-80a8-2168d3a52272
		$a_81_2 = {24 30 30 35 62 65 33 34 34 2d 63 66 31 61 2d 34 35 65 35 2d 39 64 32 34 2d 30 34 36 63 36 38 63 36 64 39 35 37 } //01 00  $005be344-cf1a-45e5-9d24-046c68c6d957
