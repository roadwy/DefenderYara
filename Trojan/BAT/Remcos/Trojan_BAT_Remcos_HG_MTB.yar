...
rule Trojan_BAT_Remcos_HG_MTB{
	...
	strings :
		$a_81_0 = {45 6d 6c 61 6b 4f 74 6f 6d 61 73 79 6f 6e 75 2e 50 72 6f 70 65 72 74 69 65 73 2e 52 65 73 6f 75 72 63 65 73 } //01 00  EmlakOtomasyonu.Properties.Resources
