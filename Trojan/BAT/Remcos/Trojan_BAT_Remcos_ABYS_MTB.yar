...
rule Trojan_BAT_Remcos_ABYS_MTB{
	...
	strings :
		$a_03_0 = {02 72 0d 00 00 70 28 90 01 01 00 00 06 6f 90 01 01 00 00 0a 28 90 01 01 00 00 0a 28 90 01 01 00 00 06 0a dd 90 01 01 00 00 00 26 dd 00 00 00 00 06 2c d1 06 2a 90 00 } //3
