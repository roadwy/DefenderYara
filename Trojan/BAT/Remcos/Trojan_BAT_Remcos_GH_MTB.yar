...
rule Trojan_BAT_Remcos_GH_MTB{
	meta:
		description = "Trojan:BAT/Remcos.GH!MTB,SIGNATURE_TYPE_PEHSTR_EXT,17 00 17 00 0d 00 00 14 00 "
		
	strings :
		$a_00_0 = {24 38 66 63 38 39 32 30 39 2d 66 64 61 30 2d 34 64 62 33 2d 39 32 62 35 2d 62 30 31 33 64 37 34 35 30 33 65 31 } //14 00  $8fc89209-fda0-4db3-92b5-b013d74503e1
		$a_00_1 = {24 64 33 31 61 39 37 30 36 2d 36 63 34 39 2d 34 65 63 33 2d 39 32 63 62 2d 65 61 32 61 30 39 38 38 33 66 65 30 } //14 00  $d31a9706-6c49-4ec3-92cb-ea2a09883fe0
		$a_00_2 = {24 65 37 32 33 38 35 31 36 2d 34 34 63 64 2d 34 32 65 62 2d 39 39 34 61 2d 37 63 35 65 33 61 33 33 66 30 65 34 } //01 00  $e7238516-44cd-42eb-994a-7c5e3a33f0e4
