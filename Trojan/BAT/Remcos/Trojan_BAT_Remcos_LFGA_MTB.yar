...
rule Trojan_BAT_Remcos_LFGA_MTB{
	...
	strings :
		$a_03_0 = {72 d1 26 00 70 28 90 01 03 06 0b 73 0e 02 00 0a 0c 08 07 1f 10 6f 90 01 03 0a 6f 90 01 03 0a 00 08 07 1f 10 6f 90 01 03 0a 6f 90 01 03 0a 00 08 6f 90 01 03 0a 06 16 06 8e 69 6f 90 01 03 0a 0d 09 8e 69 1f 10 59 90 00 } //2
