...
rule Trojan_BAT_Remcos_EV_MTB{
	...
	strings :
		$a_81_0 = {24 37 36 36 35 63 38 65 39 2d 63 32 65 64 2d 34 38 62 35 2d 38 39 66 36 2d 39 34 38 32 38 37 64 31 62 64 64 64 } //20 $7665c8e9-c2ed-48b5-89f6-948287d1bddd
		...
		$a_81_8 = {41 5a 5a 5a 5a 5a 5a 5a 5a 5a 5a 5a 5a 5a 5a 5a 58 } //1 AZZZZZZZZZZZZZZZX
