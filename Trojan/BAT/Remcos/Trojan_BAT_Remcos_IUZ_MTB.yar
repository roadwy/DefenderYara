...
rule Trojan_BAT_Remcos_IUZ_MTB{
	...
	strings :
		$a_81_0 = {6b 6f 74 61 64 69 61 69 6e 63 2e 63 6f 6d } //0a 00 
		$a_81_1 = {70 68 69 6c 6f 78 2e 64 64 6e 73 2e 6e 65 74 } //01 00 
		$a_81_2 = {47 65 74 52 65 73 70 6f 6e 73 65 53 74 72 65 61 6d } //01 00 
