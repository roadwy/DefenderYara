...
rule Trojan_BAT_Remcos_EZ_MTB{
	...
	strings :
		$a_03_0 = {0a 09 5a 1a 11 04 5a 58 28 ?? ?? ?? 0a 13 05 08 6f ?? ?? ?? 0a 08 6f ?? ?? ?? 0a 09 5a 1a 11 04 5a 58 11 05 28 ?? ?? ?? 0a 00 00 11 04 17 58 13 04 11 04 07 6f ?? ?? ?? 0a 17 59 fe 02 16 fe 01 13 06 11 06 2d ae } //10
