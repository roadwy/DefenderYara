...
rule Trojan_BAT_Remcos_MD_MTB{
	meta:
		description = "Trojan:BAT/Remcos.MD!MTB,SIGNATURE_TYPE_PEHSTR_EXT,0f 00 0f 00 06 00 00 0a 00 "
	...
	strings :
		...
		$a_01_1 = {57 3f a2 1f 09 1f 00 00 00 fa 01 33 00 16 00 00 01 00 00 00 7a 00 00 00 1a } //01 00 
