...
rule Trojan_BAT_Remcos_HB_MTB{
	meta:
		description = "Trojan:BAT/Remcos.HB!MTB,SIGNATURE_TYPE_PEHSTR_EXT,18 00 18 00 0d 00 00 14 00 "
		
	strings :
		$a_00_0 = {24 30 36 62 62 37 66 65 32 2d 31 34 66 61 2d 34 35 64 35 2d 38 64 35 61 2d 65 66 34 62 66 34 35 62 32 38 31 34 } //14 00  $06bb7fe2-14fa-45d5-8d5a-ef4bf45b2814
		$a_00_1 = {24 30 66 32 34 30 39 63 33 2d 38 38 66 30 2d 34 38 38 31 2d 61 61 34 64 2d 34 39 61 34 31 63 30 31 63 39 38 35 } //14 00  $0f2409c3-88f0-4881-aa4d-49a41c01c985
		$a_00_2 = {24 30 39 63 36 64 31 39 36 2d 35 30 64 61 2d 34 33 63 66 2d 62 65 65 37 2d 66 36 64 32 37 37 65 63 64 39 63 33 } //01 00  $09c6d196-50da-43cf-bee7-f6d277ecd9c3
