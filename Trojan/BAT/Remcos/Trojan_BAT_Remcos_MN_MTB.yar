...
rule Trojan_BAT_Remcos_MN_MTB{
	...
	strings :
		...
		$a_01_1 = {24 64 30 32 36 36 39 35 37 2d 63 31 63 38 2d 34 30 61 36 2d 61 31 38 31 2d 32 33 63 32 38 36 30 36 66 32 33 66 } //01 00 
		...
		$a_01_6 = {47 65 74 42 79 74 65 73 } //00 00 
	condition:
		any of ($a_*)
