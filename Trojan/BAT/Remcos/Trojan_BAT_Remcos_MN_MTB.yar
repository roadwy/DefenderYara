...
rule Trojan_BAT_Remcos_MN_MTB{
	...
	strings :
		$a_01_0 = {57 95 02 20 09 0a 00 00 00 00 00 00 00 00 00 00 01 00 00 00 36 00 00 00 08 00 00 00 73 00 00 00 25 } //10
		$a_01_1 = {24 64 30 32 36 36 39 35 37 2d 63 31 63 38 2d 34 30 61 36 2d 61 31 38 31 2d 32 33 63 32 38 36 30 36 66 32 33 66 } //1 $d0266957-c1c8-40a6-a181-23c28606f23f
