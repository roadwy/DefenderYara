...
rule Trojan_BAT_Remcos_FJN_MTB{
	...
	strings :
		...
		$a_01_2 = {6c 00 65 00 65 00 65 00 73 00 } //01 00 
		$a_01_3 = {41 00 53 00 44 00 41 00 53 00 66 00 73 00 61 00 66 00 61 00 73 00 66 00 73 00 61 00 66 00 61 00 73 00 66 00 73 00 61 00 66 00 73 00 61 00 66 00 61 00 73 00 66 00 61 00 73 00 } //00 00 
	condition:
		any of ($a_*)
