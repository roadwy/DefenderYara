...
rule Trojan_BAT_Remcos_EB_MTB{
	meta:
		description = "Trojan:BAT/Remcos.EB!MTB,SIGNATURE_TYPE_PEHSTR_EXT,21 00 21 00 0b 00 00 14 00 "
		
	strings :
		$a_81_0 = {24 30 65 30 33 39 64 30 31 2d 38 63 36 66 2d 34 61 34 36 2d 61 30 37 31 2d 38 38 36 65 34 63 33 64 30 32 63 65 } //05 00  $0e039d01-8c6f-4a46-a071-886e4c3d02ce
		$a_81_1 = {43 72 65 61 74 65 49 6e 73 74 61 6e 63 65 } //05 00  CreateInstance
		$a_81_2 = {41 63 74 69 76 61 74 6f 72 } //01 00  Activator
		$a_81_3 = {47 61 6d 65 4d 61 6b 65 72 2e 52 65 73 6f 75 72 63 65 73 } //01 00  GameMaker.Resources
