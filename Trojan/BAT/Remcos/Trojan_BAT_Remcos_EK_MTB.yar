...
rule Trojan_BAT_Remcos_EK_MTB{
	...
	strings :
		$a_03_0 = {0a 1e 5b 8d 1a 00 00 01 0b 16 0c 2b 17 07 08 06 08 1e 5a 1e 6f ?? ?? ?? 0a 18 28 ?? ?? ?? 0a 9c 08 17 58 0c 08 07 8e 69 17 59 31 e1 90 09 0b 00 28 ?? ?? ?? 0a 0a 06 6f } //10
