...
rule Trojan_BAT_Remcos_GHAZ_MTB{
	...
	strings :
		$a_81_0 = {47 65 74 4d 65 74 68 6f 64 } //0a 00 
		$a_81_1 = {52 65 70 6c 61 63 65 } //0a 00 
		$a_81_2 = {49 6e 76 6f 6b 65 } //0a 00 
		$a_81_3 = {52 65 76 65 72 73 65 } //0a 00 
		$a_81_4 = {54 6f 41 72 72 61 79 } //05 00 
