...
rule Trojan_BAT_Remcos_MK_MTB{
	...
	strings :
		...
		$a_01_1 = {24 62 38 63 61 31 66 39 37 2d 63 63 32 31 2d 34 31 39 65 2d 38 63 36 62 2d 35 31 65 36 34 33 63 30 65 39 39 37 } //01 00 
		...
		$a_01_5 = {41 63 74 69 76 61 74 6f 72 } //01 00 
