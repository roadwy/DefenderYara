...
rule Trojan_BAT_Remcos_GK_MTB{
	meta:
		description = "Trojan:BAT/Remcos.GK!MTB,SIGNATURE_TYPE_PEHSTR_EXT,18 00 18 00 0b 00 00 "
		
	strings :
		$a_00_0 = {24 34 61 37 35 66 61 63 35 2d 39 62 33 36 2d 34 38 33 38 2d 39 64 33 32 2d 63 35 64 30 37 36 35 35 64 64 66 39 } //20 $4a75fac5-9b36-4838-9d32-c5d07655ddf9
