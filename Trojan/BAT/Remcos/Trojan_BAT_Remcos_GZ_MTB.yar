...
rule Trojan_BAT_Remcos_GZ_MTB{
	meta:
		description = "Trojan:BAT/Remcos.GZ!MTB,SIGNATURE_TYPE_PEHSTR_EXT,17 00 17 00 0b 00 00 "
		
	strings :
		$a_00_0 = {24 61 63 38 39 33 30 35 37 2d 36 37 64 65 2d 34 65 37 61 2d 38 30 64 66 2d 39 34 61 31 32 33 32 30 31 39 30 66 } //20 $ac893057-67de-4e7a-80df-94a12320190f
