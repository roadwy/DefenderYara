...
rule Trojan_BAT_Dropper_PSP_MTB{
	...
	strings :
		$a_03_0 = {72 8c 06 00 70 a2 28 36 90 01 03 6f 1f 90 01 03 11 0f 16 6f 38 90 01 03 11 0f 17 6f 37 90 01 03 11 0f 28 3a 90 01 03 20 e8 03 00 00 6f 3c 90 01 03 26 72 3a 06 00 70 73 3b 90 01 03 13 0f 11 0f 1b 8d 21 00 00 01 25 90 00 } //5
