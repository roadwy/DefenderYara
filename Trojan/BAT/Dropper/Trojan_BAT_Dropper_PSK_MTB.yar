...
rule Trojan_BAT_Dropper_PSK_MTB{
	...
	strings :
		$a_03_0 = {81 0b 00 00 01 73 7d 00 00 0a 13 0e 11 0e 11 13 28 82 90 01 03 6f 7e 90 01 03 07 11 0d 6f 7f 90 01 03 73 80 90 01 03 13 14 06 6f 81 90 01 03 07 6f 82 90 01 03 16 73 83 90 01 03 13 15 90 00 } //5
