...
rule Trojan_BAT_Metasploit_AMBF_MTB{
	...
	strings :
		...
		$a_03_1 = {0a 00 0b 07 6f 90 01 01 00 00 0a 0c 08 06 16 06 8e 69 6f 90 01 01 00 00 0a 0d 28 90 01 01 00 00 0a 09 6f 90 01 01 00 00 0a 13 05 2b 00 11 05 2a 90 00 } //1
	condition:
