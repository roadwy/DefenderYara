...
rule Trojan_BAT_Zilla_AMAD_MTB{
	...
	strings :
		$a_03_0 = {08 06 09 91 07 09 07 8e 69 5d 91 61 28 90 01 01 00 00 0a 13 04 12 04 28 90 01 01 00 00 0a 28 90 01 01 00 00 0a 0c 09 17 58 0d 09 06 8e 69 32 d6 90 00 } //4
