...
rule Trojan_BAT_Zilla_AMAA_MTB{
	...
	strings :
		$a_03_0 = {0a 06 07 6f 90 01 01 00 00 0a 06 18 6f 90 01 01 00 00 0a 06 19 6f 90 01 01 00 00 0a 06 6f 90 01 01 00 00 0a 0d 09 03 16 03 8e 69 6f 90 01 01 00 00 0a 2a 90 00 } //4
