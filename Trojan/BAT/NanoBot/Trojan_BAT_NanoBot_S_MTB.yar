...
rule Trojan_BAT_NanoBot_S_MTB{
	...
	strings :
		$a_81_0 = {24 35 63 64 63 31 63 37 36 2d 38 39 39 63 2d 34 36 39 65 2d 39 37 61 66 2d 61 38 63 36 30 66 38 36 31 64 35 65 } //01 00 
		$a_81_1 = {6c 79 4d 43 36 3d 33 5f } //01 00 
		$a_81_2 = {43 59 27 30 21 4c 6b } //01 00 
