...
rule Trojan_BAT_NanoBot_DA_MTB{
	...
	strings :
		$a_03_0 = {70 02 7b 05 00 00 04 02 7b 04 00 00 04 8c 18 00 00 01 28 ?? ?? ?? 0a ?? ?? 04 26 06 2b 03 0a 2b fa 2a } //1
		$a_03_1 = {2d 03 26 2b 1b 0a 2b fb 06 ?? 2d 0a 26 06 17 58 ?? ?? 0a 26 2b 0a 28 ?? ?? ?? 0a 2b f0 0a 2b 00 06 1b fe 04 0b 07 2d e0 2a } //1
