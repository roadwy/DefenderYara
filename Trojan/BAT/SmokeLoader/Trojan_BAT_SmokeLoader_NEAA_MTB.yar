...
rule Trojan_BAT_SmokeLoader_NEAA_MTB{
	...
	strings :
		...
		$a_01_1 = {66 00 69 00 6c 00 69 00 66 00 69 00 6c 00 6d 00 2e 00 63 00 6f 00 6d 00 2e 00 62 00 72 00 } //02 00 
		$a_01_2 = {53 6f 63 63 65 72 } //02 00 
		$a_01_3 = {42 61 73 6b 65 74 62 61 6c 6c } //00 00 
	condition:
		any of ($a_*)
