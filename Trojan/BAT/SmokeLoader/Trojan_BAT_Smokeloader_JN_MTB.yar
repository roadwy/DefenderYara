...
rule Trojan_BAT_Smokeloader_JN_MTB{
	...
	strings :
		$a_03_0 = {0c 1d 2c de 07 08 07 6f 90 01 03 0a 1e 5b 6f 90 01 03 0a 6f 90 01 03 0a 07 08 07 6f 90 01 03 0a 1e 5b 6f 90 01 03 0a 6f 90 01 03 0a 07 17 6f 90 01 03 0a 06 07 6f 90 01 03 0a 17 73 90 01 03 0a 0d 90 00 } //10
