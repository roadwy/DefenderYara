...
rule Trojan_BAT_Starter_AT_MTB{
	...
	strings :
		$a_02_0 = {0b de 0a 07 2c 06 07 6f 90 01 03 0a dc 73 05 00 00 0a 0a 06 6f 90 01 03 0a 72 90 01 03 70 6f 90 01 03 0a 06 6f 90 01 03 0a 28 90 01 03 0a 6f 90 01 03 0a 6f 90 01 03 0a 06 6f 90 01 03 0a 26 de 03 26 de 00 1f 64 28 90 01 03 0a 2b a8 90 00 } //10
