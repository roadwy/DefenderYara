...
rule Trojan_BAT_Vidar_NVF_MTB{
	...
	strings :
		$a_03_0 = {02 7b 16 00 00 04 17 6f 90 01 01 00 00 0a 00 72 90 01 01 00 00 70 28 90 01 01 00 00 0a 26 2a 90 00 } //5
...
rule Trojan_BAT_Vidar_NVF_MTB_2{
	...
	strings :
		$a_03_0 = {72 37 00 00 70 6f 90 01 02 00 0a 28 90 01 02 00 0a 0a 2b 00 06 2a 90 00 } //5
