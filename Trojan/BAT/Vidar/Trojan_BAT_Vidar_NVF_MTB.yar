...
rule Trojan_BAT_Vidar_NVF_MTB{
	...
	strings :
		...
		$a_01_1 = {39 61 6d 6f 75 73 2e 50 72 6f 70 65 72 74 69 65 73 } //00 00  9amous.Properties
	condition:
		any of ($a_*)
...
rule Trojan_BAT_Vidar_NVF_MTB_2{
	...
	strings :
		...
		$a_01_1 = {66 61 33 61 31 36 38 34 33 33 36 30 31 37 2e 52 65 73 6f 75 72 63 65 73 2e 72 65 73 6f 75 72 63 65 73 } //00 00  fa3a1684336017.Resources.resources
	condition:
		any of ($a_*)
