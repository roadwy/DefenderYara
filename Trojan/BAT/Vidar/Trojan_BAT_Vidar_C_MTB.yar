...
rule Trojan_BAT_Vidar_C_MTB{
	meta:
		description = "Trojan:BAT/Vidar.C!MTB,SIGNATURE_TYPE_PEHSTR_EXT,08 00 08 00 07 00 00 02 00 "
		
	strings :
		$a_01_0 = {00 00 0a 13 07 09 11 07 d2 6e 1e 11 06 5a 1f 3f 5f 62 60 0d 11 06 17 58 13 06 11 06 1e 32 de 09 69 8d 37 00 00 01 25 17 73 11 00 00 0a 13 04 06 6f 12 00 00 0a 1f 0d 6a 59 } //01 00 
