...
rule Trojan_BAT_Vidar_AAGT_MTB{
	...
	strings :
		$a_03_0 = {0a 0c 06 08 6f 90 01 01 00 00 0a 06 18 6f 90 01 01 00 00 0a 06 6f 90 01 01 00 00 0a 02 16 02 8e 69 6f 90 01 01 00 00 0a 0d 09 13 04 11 04 2a 90 00 } //3
