...
rule Trojan_BAT_Vidar_RDB_MTB{
	...
	strings :
		...
		$a_01_2 = {64 36 37 32 65 66 30 64 2d 39 35 62 32 2d 34 34 39 30 2d 38 39 62 38 2d 37 38 39 61 39 33 39 64 66 61 64 32 } //00 00  d672ef0d-95b2-4490-89b8-789a939dfad2
	condition:
		any of ($a_*)
