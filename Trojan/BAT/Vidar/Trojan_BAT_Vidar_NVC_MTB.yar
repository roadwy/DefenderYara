...
rule Trojan_BAT_Vidar_NVC_MTB{
	...
	strings :
		$a_03_0 = {1f 0a 8d 02 00 00 01 25 0a 06 16 20 90 01 03 1a 20 90 01 03 1a 61 9d 06 17 20 90 01 03 6c 20 90 01 03 6c 61 9d 06 18 20 90 01 03 3e 20 90 01 03 3e 61 9d 90 00 } //5
