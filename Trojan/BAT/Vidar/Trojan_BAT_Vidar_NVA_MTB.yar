...
rule Trojan_BAT_Vidar_NVA_MTB{
	...
	strings :
		$a_03_0 = {6f 76 00 00 0a 0b 07 02 16 02 8e 69 6f 90 01 01 00 00 0a 0c 08 0d 90 00 } //5
...
rule Trojan_BAT_Vidar_NVA_MTB_2{
	...
	strings :
		$a_03_0 = {11 03 11 07 16 73 90 01 01 00 00 0a 13 0b 20 90 01 01 00 00 00 7e 90 01 01 00 00 04 7b 90 01 01 00 00 04 39 90 01 01 00 00 00 26 20 90 01 01 00 00 00 38 90 01 01 00 00 00 fe 0c 09 00 90 00 } //5
...
rule Trojan_BAT_Vidar_NVA_MTB_3{
	...
	strings :
		$a_03_0 = {28 07 00 00 2b 1f 20 28 90 01 01 00 00 2b 28 90 01 01 00 00 2b 02 1f 30 28 90 01 01 00 00 2b 28 90 01 01 00 00 2b 0b 73 90 01 01 00 00 0a 28 90 01 01 00 00 06 03 6f 90 01 01 00 00 0a 28 90 01 01 00 00 06 0c 08 73 90 01 01 00 00 0a 07 06 28 90 01 01 00 00 2b 28 90 01 01 00 00 2b 28 90 01 01 00 00 0a 28 90 01 01 00 00 2b 16 fe 01 90 00 } //5
