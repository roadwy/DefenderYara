...
rule Trojan_BAT_Vidar_AF_MTB{
	...
	strings :
		$a_02_0 = {fa 25 33 00 16 90 01 02 01 90 01 03 19 90 01 03 02 90 01 03 02 90 01 03 01 90 01 03 17 90 01 03 0a 90 01 03 01 90 01 03 02 90 01 03 01 90 00 } //10
