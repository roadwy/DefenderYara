...
rule Trojan_BAT_Vidar_SPQ_MTB{
	...
	strings :
		...
		$a_01_1 = {52 65 63 65 69 76 65 43 61 70 74 75 72 65 52 65 71 75 65 73 74 } //01 00 
		$a_01_2 = {52 65 63 65 69 76 65 45 6e 63 72 79 70 74 69 6f 6e 53 74 61 74 75 73 } //00 00 
	condition:
		any of ($a_*)
