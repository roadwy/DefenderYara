...
rule Trojan_BAT_Hawkeye_AHW_MTB{
	...
	strings :
		...
		$a_01_1 = {38 00 64 00 36 00 38 00 39 00 66 00 39 00 62 00 2d 00 66 00 34 00 33 00 35 00 2d 00 34 00 33 00 65 00 36 00 2d 00 38 00 66 00 34 00 33 00 2d 00 36 00 65 00 34 00 65 00 62 00 36 00 32 00 35 00 37 00 66 00 38 00 65 00 } //00 00  8d689f9b-f435-43e6-8f43-6e4eb6257f8e
	condition:
		any of ($a_*)
