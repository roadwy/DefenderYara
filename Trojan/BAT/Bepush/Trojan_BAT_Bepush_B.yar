...
rule Trojan_BAT_Bepush_B{
	...
	strings :
		...
		$a_03_4 = {08 09 8e 69 fe 04 13 09 11 09 3a a1 fe ff ff 7e 11 00 00 04 16 fe 01 13 09 11 09 2d 12 00 7e 08 00 00 04 72 90 01 02 00 70 28 90 01 01 00 00 0a 90 00 } //10
	condition:
