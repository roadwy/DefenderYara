...
rule Trojan_BAT_Stealer_AK_MTB{
	...
	strings :
		...
		$a_01_1 = {6c 00 6f 00 61 00 64 00 65 00 72 00 2f 00 75 00 70 00 6c 00 6f 00 61 00 64 00 73 00 } //02 00  loader/uploads
		$a_01_2 = {51 75 69 63 6b 65 73 74 } //02 00  Quickest
		$a_01_3 = {52 65 74 68 65 72 6d } //00 00  Retherm
	condition:
		any of ($a_*)
