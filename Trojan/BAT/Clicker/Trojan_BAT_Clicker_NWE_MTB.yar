...
rule Trojan_BAT_Clicker_NWE_MTB{
	...
	strings :
		$a_03_0 = {38 02 00 00 00 26 16 00 02 28 2a 00 00 0a 02 28 90 01 01 03 00 06 02 16 28 2f 00 00 0a 02 28 2b 00 00 0a 28 cb 00 00 0a 6f cc 00 00 0a 6f 16 00 00 0a 20 62 12 01 00 28 90 01 02 00 06 28 84 00 00 0a 28 cd 00 00 0a 02 02 fe 06 a7 02 00 90 02 01 73 33 00 00 0a 28 34 00 00 0a 2a 90 00 } //1
