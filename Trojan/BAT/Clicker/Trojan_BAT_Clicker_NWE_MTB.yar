...
rule Trojan_BAT_Clicker_NWE_MTB{
	...
	strings :
		...
		$a_81_1 = {57 69 6e 64 6f 77 73 46 6f 72 6d 73 41 70 70 6c 69 63 61 74 69 6f 6e 32 35 2e 70 64 62 } //01 00 
		$a_81_2 = {6e 73 49 43 6f 6f 6b 69 65 4d 61 6e 61 67 65 72 } //01 00 
		$a_81_3 = {53 48 44 6f 63 56 77 } //01 00 
		$a_81_4 = {49 48 54 4d 4c 44 6f 63 75 6d 65 6e 74 } //01 00 
		$a_81_5 = {6d 73 68 74 6d 6c } //01 00 
		$a_81_6 = {49 57 65 62 42 72 6f 77 73 65 72 } //00 00 
	condition:
		any of ($a_*)
