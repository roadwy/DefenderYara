...
rule Trojan_BAT_Redline_NEI_MTB{
	...
	strings :
		...
		$a_01_1 = {54 00 52 00 65 00 70 00 6c 00 61 00 63 00 65 00 6f 00 6b 00 52 00 65 00 70 00 6c 00 61 00 63 00 65 00 65 00 6e 00 52 00 65 00 70 00 6c 00 61 00 63 00 65 00 73 00 2e 00 74 00 52 00 65 00 70 00 6c 00 61 00 63 00 65 00 78 00 } //00 00 
	condition:
		any of ($a_*)
