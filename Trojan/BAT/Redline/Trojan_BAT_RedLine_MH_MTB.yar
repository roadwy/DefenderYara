...
rule Trojan_BAT_RedLine_MH_MTB{
	...
	strings :
		...
		$a_01_1 = {39 38 61 34 32 61 31 35 2d 63 31 36 65 2d 34 35 63 65 2d 62 34 62 63 2d 63 30 35 64 30 34 65 38 32 66 31 66 } //02 00 
		$a_01_2 = {4d 69 6e 65 73 77 65 65 70 65 72 5f 57 69 6e 64 6f 77 73 2e 50 72 6f 70 65 72 74 69 65 73 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_BAT_RedLine_MH_MTB_2{
	...
	strings :
		...
		$a_01_1 = {4d 65 6d 62 65 72 52 65 66 73 50 72 6f 78 79 } //01 00 
		...
		$a_01_5 = {47 65 74 54 65 6d 70 50 61 74 68 } //00 00 
	condition:
		any of ($a_*)
