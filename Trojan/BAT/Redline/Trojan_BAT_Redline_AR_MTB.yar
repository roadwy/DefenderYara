...
rule Trojan_BAT_Redline_AR_MTB{
	...
	strings :
		...
		$a_01_1 = {75 00 70 00 64 00 61 00 74 00 65 00 61 00 64 00 6f 00 62 00 65 00 2e 00 65 00 78 00 65 00 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_BAT_Redline_AR_MTB_2{
	...
	strings :
		...
		$a_01_1 = {76 00 69 00 72 00 74 00 6b 00 69 00 6f 00 73 00 6b 00 2e 00 65 00 78 00 65 00 } //00 00 
	condition:
		any of ($a_*)
