...
rule Trojan_BAT_Redline_IA_MTB{
	...
	strings :
		$a_03_0 = {2b 2d 2b 2e 2b 2f 2b 34 07 09 6f ?? ?? ?? 0a 07 18 6f ?? ?? ?? 0a 02 13 04 07 6f ?? ?? ?? 0a 11 04 16 11 04 8e 69 6f ?? ?? ?? 0a 13 05 de 24 08 2b d0 06 2b cf 6f ?? ?? ?? 0a 2b ca 0d 2b c9 } //10
