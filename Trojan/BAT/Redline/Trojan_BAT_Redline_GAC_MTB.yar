...
rule Trojan_BAT_Redline_GAC_MTB{
	...
	strings :
		$a_01_0 = {43 59 50 58 63 58 35 4f 56 62 57 45 62 61 37 54 33 48 52 } //01 00  CYPXcX5OVbWEba7T3HR
		$a_01_1 = {41 4f 58 67 76 62 35 75 6b 59 48 4d 4d 47 48 48 58 58 74 } //01 00  AOXgvb5ukYHMMGHHXXt
