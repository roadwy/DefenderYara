...
rule Trojan_BAT_Redline_GJS_MTB{
	...
	strings :
		$a_03_0 = {03 08 03 8e 69 5d 91 07 08 07 8e 69 5d 91 61 28 ?? ?? ?? 06 03 08 17 58 03 8e 69 5d 91 59 20 ?? ?? ?? ?? 58 17 58 20 ?? ?? ?? ?? 5d d2 9c 08 17 58 0c 08 6a 03 8e 69 17 59 6a 06 17 58 6e 5a 31 ac 0f 01 03 8e 69 17 59 28 ?? ?? ?? 2b 03 2a } //10
