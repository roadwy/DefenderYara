...
rule Trojan_BAT_Redline_GEI_MTB{
	...
	strings :
		$a_03_0 = {72 45 00 00 70 72 19 00 00 70 14 28 90 01 03 0a 18 8d 1c 00 00 01 25 16 d0 90 01 04 28 90 01 03 0a a2 25 17 d0 90 01 04 28 90 01 03 0a a2 28 90 00 } //10
