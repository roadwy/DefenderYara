...
rule Trojan_BAT_Redline_GLY_MTB{
	...
	strings :
		$a_03_0 = {25 16 1f 3a 9d 6f ?? ?? ?? 0a 0c 08 16 9a 28 ?? ?? ?? 06 0d 06 09 6f ?? ?? ?? 0a 00 08 17 9a 28 ?? ?? ?? 06 0b 28 ?? ?? ?? 0a 06 6f ?? ?? ?? 0a 07 16 07 8e 69 6f ?? ?? ?? 0a 6f ?? ?? ?? 0a 13 04 11 04 13 05 de 10 } //10
