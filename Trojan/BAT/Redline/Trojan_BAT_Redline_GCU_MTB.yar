...
rule Trojan_BAT_Redline_GCU_MTB{
	...
	strings :
		...
		$a_01_1 = {41 72 61 5a 5a 61 68 41 61 61 41 75 68 61 61 5a 41 41 } //01 00  AraZZahAaaAuhaaZAA
		$a_01_2 = {41 75 61 61 61 68 41 68 72 61 61 61 5a 72 41 5a 72 } //00 00  AuaaahAhraaaZrAZr
	condition:
		any of ($a_*)
