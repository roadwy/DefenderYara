...
rule Trojan_BAT_Redline_NEBE_MTB{
	...
	strings :
		$a_03_0 = {09 08 11 04 08 8e 69 5d 91 07 11 04 91 61 d2 6f 90 01 01 00 00 0a 11 04 13 05 11 05 17 58 13 04 11 04 07 8e 69 3f d8 ff ff ff 09 6f 90 01 01 00 00 0a 13 06 90 00 } //10
