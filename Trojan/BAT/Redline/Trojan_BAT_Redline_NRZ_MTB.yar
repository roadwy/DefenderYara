...
rule Trojan_BAT_Redline_NRZ_MTB{
	...
	strings :
		...
		$a_01_1 = {51 6f 36 34 47 6a } //01 00  Qo64Gj
		$a_01_2 = {64 00 65 00 6c 00 65 00 74 00 65 00 20 00 66 00 72 00 6f 00 6d 00 20 00 74 00 62 00 6c 00 5f 00 61 00 6e 00 67 00 67 00 6f 00 74 00 61 00 } //00 00  delete from tbl_anggota
	condition:
		any of ($a_*)
