...
rule Trojan_BAT_Redline_CR_MTB{
	...
	strings :
		$a_03_0 = {06 72 05 00 00 70 73 90 01 01 00 00 06 6f 90 01 01 00 00 0a 6f 90 01 01 00 00 0a 28 90 01 01 00 00 0a 6f 90 01 01 00 00 0a 0b 16 0c 2b 21 90 00 } //5
