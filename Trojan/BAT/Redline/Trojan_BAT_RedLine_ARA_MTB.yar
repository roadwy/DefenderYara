...
rule Trojan_BAT_RedLine_ARA_MTB{
	...
	strings :
		...
		$a_03_3 = {07 06 08 1f 0a 06 6f 90 01 03 0a 6f 90 01 03 0a 6f 90 01 03 0a 13 05 12 05 28 90 01 03 0a 28 90 01 03 0a 0b 11 04 17 58 13 04 11 04 09 fe 04 13 06 11 06 2d cb 90 00 } //2
	condition:
