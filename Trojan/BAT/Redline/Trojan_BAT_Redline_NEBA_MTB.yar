...
rule Trojan_BAT_Redline_NEBA_MTB{
	...
	strings :
		$a_03_0 = {16 2d 93 11 05 18 6f 90 01 01 00 00 0a 1c 2c f2 11 05 18 6f 90 01 01 00 00 0a 11 05 6f 90 01 01 00 00 0a 13 06 11 06 07 16 07 8e 69 6f 90 01 01 00 00 0a 13 07 90 00 } //10
