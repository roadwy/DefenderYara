...
rule Trojan_BAT_Redline_T_MTB{
	...
	strings :
		$a_03_0 = {07 72 01 00 00 70 6f 90 01 03 0a 0a de 0a 07 2c 06 07 6f 90 01 03 0a dc 28 90 01 03 0a 72 8a 00 00 70 28 90 01 03 0a 06 28 90 01 03 0a 90 00 } //10
