...
rule Trojan_BAT_RedLine_NZV_MTB{
	...
	strings :
		...
		$a_81_1 = {67 68 67 62 65 76 6e 79 2e 74 6c 6e } //01 00  ghgbevny.tln
		$a_81_2 = {72 7a 63 67 6c } //01 00  rzcgl
		$a_81_3 = {57 57 51 57 51 57 } //01 00  WWQWQW
		$a_81_4 = {47 5a 69 70 53 74 72 65 61 6d } //00 00  GZipStream
	condition:
		any of ($a_*)
