...
rule Trojan_BAT_Redline_NEAB_MTB{
	...
	strings :
		$a_03_0 = {16 0b 2b 2d 02 07 6f 27 00 00 0a 03 07 03 6f 4d 00 00 0a 5d 6f 27 00 00 0a 61 0c 06 72 90 01 02 00 70 08 28 3a 01 00 0a 6f 3b 01 00 0a 26 07 17 58 0b 07 02 90 00 } //10
