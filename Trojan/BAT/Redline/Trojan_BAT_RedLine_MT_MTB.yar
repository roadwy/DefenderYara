...
rule Trojan_BAT_RedLine_MT_MTB{
	...
	strings :
		...
		$a_01_1 = {39 32 61 64 39 38 65 64 2d 38 63 33 62 2d 34 63 63 62 2d 39 34 66 39 2d 63 35 30 64 61 37 36 34 64 35 34 38 } //01 00 
		$a_01_2 = {4a 61 6d 62 6f } //01 00 
		$a_01_3 = {43 72 65 61 74 65 49 6e 73 74 61 6e 63 65 } //01 00 
		$a_01_4 = {50 65 72 76 61 73 69 76 65 4d 69 6e 64 43 68 61 6c 6c 65 6e 67 65 2e 50 72 6f 70 65 72 74 69 65 73 } //01 00 
