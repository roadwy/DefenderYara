...
rule Trojan_BAT_Redline_GDE_MTB{
	...
	strings :
		...
		$a_01_1 = {39 38 61 34 32 61 31 35 2d 63 31 36 65 2d 34 35 63 65 2d 62 34 62 63 2d 63 30 35 64 30 34 65 38 32 66 31 66 } //01 00  98a42a15-c16e-45ce-b4bc-c05d04e82f1f
		$a_01_2 = {67 65 74 5f 49 73 48 69 64 64 65 6e } //00 00  get_IsHidden
	condition:
		any of ($a_*)
