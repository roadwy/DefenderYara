...
rule Trojan_BAT_Redline_GCX_MTB{
	...
	strings :
		...
		$a_01_1 = {39 00 4a 00 5a 00 77 00 45 00 65 00 6d 00 4e 00 66 00 65 00 6d 00 41 00 77 00 6f 00 51 00 44 00 4b 00 54 00 7a 00 30 00 46 00 77 00 3d 00 3d 00 } //01 00  9JZwEemNfemAwoQDKTz0Fw==
		$a_01_2 = {43 6f 6e 63 65 6e 37 72 61 37 65 } //01 00  Concen7ra7e
