...
rule Trojan_BAT_Redline_NEAW_MTB{
	...
	strings :
		...
		$a_01_1 = {2a 00 77 00 61 00 6c 00 6c 00 65 00 74 00 2a 00 } //02 00 
		$a_01_2 = {6d 00 6f 00 7a 00 5f 00 63 00 6f 00 6f 00 6b 00 69 00 65 00 73 00 } //02 00 
		$a_01_3 = {56 00 61 00 6c 00 76 00 65 00 5c 00 53 00 74 00 65 00 61 00 6d 00 4c 00 6f 00 67 00 69 00 6e 00 20 00 44 00 61 00 74 00 61 00 } //00 00 
	condition:
		any of ($a_*)
