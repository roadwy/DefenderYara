...
rule Trojan_BAT_Redline_GMG_MTB{
	...
	strings :
		$a_03_0 = {03 08 03 8e 69 5d 91 07 08 07 8e 69 5d 91 61 28 90 01 03 06 03 08 1b 58 1b 59 17 58 03 8e 69 5d 91 59 20 90 01 04 58 1c 58 20 90 01 04 5d d2 9c 08 90 00 } //10
