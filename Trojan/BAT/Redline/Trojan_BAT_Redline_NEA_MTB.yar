...
rule Trojan_BAT_Redline_NEA_MTB{
	...
	strings :
		...
		$a_01_1 = {4c 00 68 00 65 00 77 00 7a 00 67 00 76 00 62 00 6c 00 64 00 63 00 76 00 70 00 67 00 61 00 69 00 72 00 } //01 00 
		$a_01_2 = {52 00 65 00 6e 00 65 00 76 00 63 00 74 00 5f 00 5a 00 64 00 72 00 70 00 6b 00 70 00 71 00 7a 00 2e 00 62 00 6d 00 70 00 } //00 00 
	condition:
		any of ($a_*)
