...
rule Trojan_BAT_Redline_GWD_MTB{
	...
	strings :
		$a_03_0 = {04 13 04 28 ?? ?? ?? 0a 11 04 6f ?? ?? ?? 0a 13 05 09 11 05 6f ?? ?? ?? 0a 00 09 6f ?? ?? ?? 0a 13 06 11 06 06 16 06 8e 69 6f ?? ?? ?? 0a 13 07 28 ?? ?? ?? 0a 11 07 6f ?? ?? ?? 0a 13 08 11 08 13 09 de 16 } //10
