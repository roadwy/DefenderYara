...
rule Trojan_BAT_Redline_GFM_MTB{
	...
	strings :
		$a_03_0 = {08 8d 4f 00 00 01 13 04 7e 8f 01 00 04 02 1a 58 11 04 16 08 28 90 01 03 0a 28 90 01 03 0a 11 04 16 11 04 8e 69 6f 90 01 03 0a 13 05 7e 7f 01 00 04 11 05 90 00 } //10
