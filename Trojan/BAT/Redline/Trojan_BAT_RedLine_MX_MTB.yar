...
rule Trojan_BAT_RedLine_MX_MTB{
	...
	strings :
		...
		$a_01_2 = {43 6f 6e 6e 65 63 74 69 6f 6e 53 74 61 74 65 } //01 00  ConnectionState
		$a_01_3 = {66 72 6d 46 65 65 50 61 79 6d 65 6e 74 52 65 63 65 69 70 74 } //00 00  frmFeePaymentReceipt
	condition:
		any of ($a_*)
