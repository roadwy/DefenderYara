...
rule Trojan_BAT_RedLine_MY_MTB{
	...
	strings :
		...
		$a_01_2 = {46 72 6f 6d 42 61 73 65 36 34 53 74 72 69 6e 67 } //05 00 
		$a_01_3 = {3a 00 2f 00 2f 00 38 00 31 00 2e 00 31 00 36 00 31 00 2e 00 32 00 32 00 39 00 2e 00 31 00 31 00 30 00 2f 00 } //01 00 
		$a_01_4 = {49 6e 76 6f 6b 65 4d 65 6d 62 65 72 } //01 00 
		$a_01_5 = {67 65 74 5f 4c 6f 63 61 74 69 6f 6e } //00 00 
	condition:
		any of ($a_*)
