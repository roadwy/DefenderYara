...
rule Trojan_BAT_Redline_GFV_MTB{
	...
	strings :
		$a_03_0 = {7e 02 00 00 04 72 59 00 00 70 28 90 01 03 0a 28 90 01 03 06 0a 06 28 90 01 03 06 00 02 02 73 1c 00 00 06 7d 01 00 00 04 02 7b 01 00 00 04 6f 90 00 } //10
