...
rule Trojan_BAT_RedLine_SPRT_MTB{
	...
	strings :
		$a_03_0 = {fe 0c 01 00 fe 09 00 00 fe 0c 03 00 6f ?? ?? ?? 0a fe 0c 00 00 fe 0c 03 00 fe 0c 00 00 6f ?? ?? ?? 0a 5d 6f ?? ?? ?? 0a 61 d1 fe 0e 05 00 fe 0d 05 00 28 ?? ?? ?? 0a 28 ?? ?? ?? 0a fe 0e 01 00 20 00 00 00 00 fe 0e 06 00 38 18 00 00 00 } //3
