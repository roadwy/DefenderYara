...
rule Trojan_BAT_Redline_GEK_MTB{
	...
	strings :
		$a_03_0 = {0a 06 72 4a 03 00 70 28 90 01 03 06 6f 90 01 03 0a 00 06 18 6f 90 01 03 0a 00 06 18 6f 90 01 03 0a 00 06 6f 90 01 03 0a 0b 07 02 16 02 8e 69 6f 90 01 03 0a 0c 2b 00 08 2a 90 00 } //10
