...
rule Trojan_BAT_RedLine_ML_MTB{
	...
	strings :
		$a_03_0 = {11 04 8e 69 8d 90 01 03 01 13 02 38 90 01 04 11 02 11 03 11 01 11 03 11 01 8e 69 5d 91 11 04 11 03 91 61 d2 9c 20 90 01 04 7e 90 01 03 04 7b 90 01 03 04 39 90 01 03 ff 90 00 } //10
