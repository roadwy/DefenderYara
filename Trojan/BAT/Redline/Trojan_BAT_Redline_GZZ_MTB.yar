...
rule Trojan_BAT_Redline_GZZ_MTB_2{
	...
	strings :
		$a_03_0 = {07 11 40 18 5b 06 11 40 18 6f ?? ?? ?? 0a 1f 10 28 ?? ?? ?? 0a 9c 00 11 40 18 58 13 40 11 40 06 6f ?? ?? ?? 0a fe 04 13 41 11 41 2d d2 } //10
...
rule Trojan_BAT_Redline_GZZ_MTB_3{
	...
	strings :
		$a_03_0 = {73 04 00 00 0a 0a 06 28 ?? ?? ?? 0a 03 50 6f ?? ?? ?? 0a 6f ?? ?? ?? 0a 0b 73 08 00 00 0a 0c 08 07 6f ?? ?? ?? 0a 08 18 6f 0a ?? ?? 0a 08 6f ?? ?? ?? 0a 02 50 16 02 50 8e 69 6f ?? ?? ?? 0a 2a } //10
