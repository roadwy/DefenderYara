...
rule Trojan_BAT_Redline_GCE_MTB{
	...
	strings :
		...
		$a_01_2 = {4a 00 6e 00 50 00 45 00 48 00 7a 00 2f 00 61 00 43 00 52 00 46 00 79 00 73 00 2b 00 74 00 61 00 46 00 34 00 58 00 66 00 31 00 51 00 3d 00 3d 00 } //01 00 
		$a_01_3 = {31 00 34 00 2b 00 4a 00 68 00 54 00 58 00 55 00 72 00 4c 00 68 00 5a 00 42 00 77 00 35 00 46 00 2b 00 32 00 6b 00 76 00 55 00 51 00 3d 00 3d 00 } //00 00 
	condition:
		any of ($a_*)
