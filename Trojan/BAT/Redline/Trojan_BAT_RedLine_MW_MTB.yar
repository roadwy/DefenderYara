...
rule Trojan_BAT_RedLine_MW_MTB{
	...
	strings :
		...
		$a_01_3 = {54 72 61 6e 73 66 6f 72 6d 42 6c 6f 63 6b } //01 00 
		$a_01_4 = {46 72 6f 6d 42 61 73 65 36 34 43 68 61 72 41 72 72 61 79 } //01 00 
		$a_01_5 = {43 6c 69 65 6e 74 43 72 65 64 65 6e 74 69 61 6c 73 } //01 00 
		$a_01_6 = {47 65 74 44 65 63 6f 64 65 64 } //00 00 
	condition:
		any of ($a_*)
