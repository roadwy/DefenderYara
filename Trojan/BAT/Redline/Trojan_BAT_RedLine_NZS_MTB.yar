...
rule Trojan_BAT_RedLine_NZS_MTB{
	...
	strings :
		...
		$a_81_1 = {4a 4a 34 56 57 51 44 52 53 44 33 55 35 59 56 } //01 00  JJ4VWQDRSD3U5YV
		$a_81_2 = {50 4f 52 54 52 41 59 2e 65 } //01 00  PORTRAY.e
		$a_81_3 = {43 4f 4c 4c 45 41 47 55 45 5f 54 50 2e 50 } //00 00  COLLEAGUE_TP.P
	condition:
		any of ($a_*)
