...
rule Trojan_BAT_AveMariaRat_MW_MTB{
	...
	strings :
		$a_01_0 = {50 68 77 73 6d 6e 76 72 78 78 64 73 64 71 72 74 6a 64 71 66 76 64 62 } //01 00 
		...
		$a_01_5 = {3a 00 2f 00 2f 00 32 00 2e 00 35 00 38 00 2e 00 31 00 34 00 39 00 2e 00 32 00 2f 00 } //00 00 
	condition:
		any of ($a_*)
