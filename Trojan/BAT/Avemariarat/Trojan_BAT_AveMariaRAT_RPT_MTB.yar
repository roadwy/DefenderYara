...
rule Trojan_BAT_AveMariaRAT_RPT_MTB{
	...
	strings :
		$a_03_0 = {62 00 6c 00 75 00 65 00 63 00 6f 00 76 00 65 00 72 00 74 00 72 00 61 00 64 00 69 00 6e 00 67 00 2e 00 63 00 6f 00 6d 00 [0-20] 2e 00 74 00 78 00 74 00 } //1
