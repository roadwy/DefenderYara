...
rule Trojan_BAT_AveMariaRAT_NT_MTB{
	...
	strings :
		...
		$a_01_3 = {6c 70 42 66 64 73 64 68 73 64 73 64 73 66 75 66 66 65 72 } //01 00  lpBfdsdhsdsdsfuffer
		$a_01_4 = {43 6f 70 6f 6f 6f 70 6f 6f 6f 70 6f 70 6f 6f 6f 70 70 70 70 70 71 70 6f 6f 6f 70 6f 6f } //01 00  Copooopooopopooopppppqpooopoo
		$a_01_5 = {41 74 73 73 73 73 73 73 73 73 73 73 73 73 73 73 73 73 73 73 73 73 73 } //00 00  Atsssssssssssssssssssss
	condition:
		any of ($a_*)
...
rule Trojan_BAT_AveMariaRAT_NT_MTB_2{
	...
	strings :
		...
		$a_01_3 = {39 32 62 36 33 36 65 37 2d 37 66 38 30 2d 34 61 33 35 2d 62 66 35 39 2d 30 38 39 65 33 30 62 30 64 64 37 32 } //01 00  92b636e7-7f80-4a35-bf59-089e30b0dd72
		$a_01_4 = {43 50 54 31 38 35 } //00 00  CPT185
	condition:
		any of ($a_*)
