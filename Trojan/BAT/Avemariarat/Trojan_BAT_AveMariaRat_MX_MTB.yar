...
rule Trojan_BAT_AveMariaRat_MX_MTB{
	...
	strings :
		$a_03_0 = {0b 07 16 07 90 0a 22 00 06 6f 22 00 00 0a 00 00 de 05 26 00 00 de 00 72 29 00 00 70 28 05 00 00 06 90 02 06 8e 69 28 23 00 00 0a 00 07 0c 2b 00 08 2a 90 00 } //1
