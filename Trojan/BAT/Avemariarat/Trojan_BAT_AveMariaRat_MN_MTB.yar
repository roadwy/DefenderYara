...
rule Trojan_BAT_AveMariaRat_MN_MTB{
	...
	strings :
		$a_03_0 = {0b 16 0d 2b 1a 00 07 90 0a 1f 00 28 90 01 03 0a 0a 20 00 58 00 00 8d 46 00 00 01 90 02 09 09 06 09 18 5a 18 6f 90 01 03 0a 1f 10 28 90 01 03 0a 9c 00 09 17 58 0d 09 20 00 58 00 00 fe 04 13 04 11 04 2d 90 00 } //1
