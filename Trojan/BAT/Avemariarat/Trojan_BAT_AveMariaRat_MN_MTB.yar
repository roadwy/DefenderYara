...
rule Trojan_BAT_AveMariaRat_MN_MTB{
	...
	strings :
		...
		$a_01_2 = {47 65 74 50 6c 61 63 65 64 47 65 6d 73 53 74 72 69 6e 67 } //01 00 
		$a_01_3 = {57 00 65 00 6c 00 63 00 6f 00 6d 00 65 00 20 00 74 00 6f 00 20 00 47 00 68 00 6f 00 73 00 74 00 20 00 50 00 61 00 72 00 74 00 79 00 } //01 00 
		$a_01_4 = {49 6e 76 6f 6b 65 4d 65 6d 62 65 72 } //01 00 
		$a_01_5 = {42 63 65 6c 6c 65 72 6d 30 33 } //01 00 
		$a_01_6 = {44 65 62 75 67 } //00 00 
	condition:
		any of ($a_*)
