...
rule Trojan_BAT_AveMariaRat_MY_MTB{
	meta:
		description = "Trojan:BAT/AveMariaRat.MY!MTB,SIGNATURE_TYPE_PEHSTR_EXT,0a 00 0a 00 0a 00 00 01 00 "
		
	strings :
		$a_03_0 = {08 07 2b 03 00 2b 07 6f 90 01 03 0a 2b f6 00 de 11 08 2b 08 08 6f 90 01 03 0a 2b 04 2c 03 2b f4 00 dc 07 6f 90 01 03 0a 0d de 1c 90 00 } //01 00 
		...
		$a_01_5 = {54 68 72 65 61 64 57 61 73 53 75 73 70 65 6e 64 65 64 } //01 00  ThreadWasSuspended
		$a_01_6 = {44 65 62 75 67 67 65 72 49 6e 61 63 74 69 76 65 } //01 00  DebuggerInactive
