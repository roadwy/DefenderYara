...
rule Trojan_BAT_AveMariaRAT_NYJ_MTB_2{
	...
	strings :
		...
		$a_81_1 = {53 53 4d 53 53 53 65 53 53 74 53 68 53 6f 53 53 53 64 53 53 30 53 53 } //01 00 
		$a_81_2 = {44 65 61 74 48 } //01 00 
		$a_81_3 = {47 65 74 4d 61 6e 69 66 65 73 74 52 65 73 6f 75 72 63 65 4e 61 6d 65 73 } //01 00 
		$a_81_4 = {43 6f 69 73 64 68 76 70 73 64 75 79 70 73 39 38 79 76 68 61 6a 6e } //00 00 
	condition:
		any of ($a_*)
