...
rule Trojan_BAT_Taskun_AMBE_MTB_2{
	...
	strings :
		$a_03_0 = {8e 69 6a 5d d4 91 61 90 02 0e 6a 5d d4 91 28 90 00 } //2
	condition:
		((#a_03_0  & 1)*2) >=2
...
rule Trojan_BAT_Taskun_AMBE_MTB_3{
	...
	strings :
		$a_03_0 = {07 11 05 07 6f 90 01 01 00 00 0a 5d 6f 90 01 01 00 00 0a 11 90 01 01 61 13 90 01 01 07 11 90 01 01 07 90 00 } //2
	condition:
		((#a_03_0  & 1)*2) >=2
