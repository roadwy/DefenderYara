...
rule Trojan_BAT_Taskun_ABS_MTB{
	...
	strings :
		$a_03_0 = {11 07 07 09 58 08 11 04 58 6f 90 01 01 00 00 0a 13 0a 12 0a 28 90 01 01 00 00 0a 13 08 11 06 11 05 11 08 9c 11 05 17 58 13 05 11 04 17 58 13 04 11 04 17 32 cf 09 17 58 0d 09 90 00 } //1
