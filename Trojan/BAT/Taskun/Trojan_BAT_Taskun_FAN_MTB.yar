...
rule Trojan_BAT_Taskun_FAN_MTB{
	...
	strings :
		$a_03_0 = {0c 16 0d 2b 23 00 07 09 18 6f 90 01 01 00 00 0a 20 03 02 00 00 28 90 01 01 00 00 0a 13 05 08 11 05 6f 90 01 01 00 00 0a 00 09 18 58 0d 00 09 07 6f 90 01 01 00 00 0a fe 04 13 06 11 06 2d ce 90 00 } //3
