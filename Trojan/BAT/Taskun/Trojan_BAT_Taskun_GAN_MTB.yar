...
rule Trojan_BAT_Taskun_GAN_MTB{
	...
	strings :
		$a_03_0 = {07 09 18 7e ?? 02 00 04 28 ?? 01 00 06 1f 10 7e ?? 02 00 04 28 ?? 01 00 06 7e ?? 02 00 04 28 ?? 01 00 06 16 91 13 05 08 17 8d ?? 00 00 01 25 16 11 05 9c 6f ?? 00 00 0a 00 09 18 58 0d 00 09 07 7e ?? 02 00 04 28 ?? 01 00 06 fe 04 13 06 11 06 3a } //3
