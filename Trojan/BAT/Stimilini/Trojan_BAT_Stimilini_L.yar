...
rule Trojan_BAT_Stimilini_L{
	...
	strings :
		$a_00_0 = {49 6e 76 65 6e 74 6f 72 79 49 74 65 6d } //01 00  InventoryItem
		$a_00_1 = {53 65 6e 64 54 6f 54 72 61 64 65 } //01 00  SendToTrade
		$a_00_2 = {53 4c 6f 67 69 6e } //01 00  SLogin
		$a_00_3 = {53 74 65 61 6d 53 65 73 73 69 6f 6e } //02 00  SteamSession
		$a_80_4 = {72 65 63 61 70 74 63 68 61 } //recaptcha  05 00 
		$a_00_5 = {50 6f 6b 65 53 53 2e 64 6c 6c } //0a 00  PokeSS.dll
