...
rule Trojan_BAT_Stimilini_H{
	...
	strings :
		...
		$a_00_1 = {00 73 74 65 61 6d 43 6f 6f 6b 69 65 73 00 } //01 00 
		$a_00_2 = {00 53 74 65 61 6d 50 72 6f 66 69 6c 65 00 } //01 00 
		$a_00_3 = {00 47 65 74 53 74 65 61 6d 49 74 65 6d 73 00 } //01 00 
		$a_00_4 = {00 53 74 65 61 6d 57 65 62 52 65 71 75 65 73 74 00 } //01 00 
		$a_00_5 = {00 6d 5f 44 65 63 6f 64 65 72 73 00 } //00 00 
...
rule Trojan_BAT_Stimilini_H_2{
	...
	strings :
		$a_01_0 = {53 74 65 61 6d 53 74 65 61 6c 65 72 45 78 74 72 65 6d 65 } //01 00 
		$a_01_1 = {2e 49 74 65 6d 3e 3e 2e 47 65 74 45 6e 75 6d 65 72 61 74 6f 72 } //01 00 
		$a_01_2 = {2e 49 74 65 6d 3e 3e 2e 67 65 74 5f 43 75 72 72 65 6e 74 } //00 00 
