...
rule Trojan_BAT_DarkTortilla_AALG_MTB{
	...
	strings :
		...
		$a_01_1 = {71 00 71 00 61 00 7a 00 73 00 67 00 67 00 66 00 67 00 66 00 64 00 64 00 64 00 67 00 67 00 64 00 64 00 67 00 73 00 64 00 77 00 } //00 00  qqazsggfgfdddggddgsdw
	condition:
		any of ($a_*)
