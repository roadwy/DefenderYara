...
rule Trojan_BAT_DarkTortilla_O_MTB{
	...
	strings :
		...
		$a_03_1 = {00 00 01 25 16 16 8c 90 01 01 00 00 01 a2 14 28 90 01 01 00 00 0a 14 14 90 00 } //5
		$a_03_2 = {00 00 01 25 17 16 8d 90 01 01 00 00 01 a2 14 14 14 17 28 90 00 } //5
	condition:
