...
rule Trojan_BAT_DuckTail_ADI_MTB{
	...
	strings :
		$a_03_0 = {13 04 2b 31 09 11 04 9a 13 05 11 05 6f 90 01 01 01 00 0a 72 90 01 01 d8 00 70 6f 90 01 01 00 00 0a 2c 0a 1f fd fe 1c 78 00 00 01 58 0b 11 04 1f fd fe 1c 78 00 00 01 58 58 13 04 11 04 09 8e 69 32 c8 90 00 } //2
