...
rule Trojan_BAT_Ursu_AUR_MTB_2{
	...
	strings :
		$a_03_0 = {17 59 0c 17 0d 2b 2d 17 13 04 2b 1f 02 11 04 09 6f 90 01 03 0a 13 05 06 12 05 28 90 01 03 0a 6f 90 01 03 0a 26 11 04 17 58 13 04 11 04 07 31 dc 90 00 } //2
...
rule Trojan_BAT_Ursu_AUR_MTB_3{
	...
	strings :
		$a_03_0 = {0a 06 16 72 1b 00 00 70 a2 06 17 28 90 01 01 00 00 06 a2 06 18 72 5f 00 00 70 a2 06 19 28 90 01 01 00 00 06 a2 06 1a 72 77 00 00 70 a2 06 1b 28 90 01 01 00 00 06 a2 06 1c 72 83 00 00 70 a2 06 1d 28 90 00 } //1
