...
rule Trojan_BAT_Marsilia_NM_MTB{
	...
	strings :
		$a_03_0 = {07 08 6f 55 00 00 0a 08 16 28 90 01 02 00 0a 0d 06 72 90 01 02 00 70 09 72 90 01 02 00 70 6f 90 01 02 00 0a 5e 6f 90 01 02 00 0a 6f 90 01 02 00 0a 26 02 25 17 59 10 00 16 30 cb 90 00 } //5
