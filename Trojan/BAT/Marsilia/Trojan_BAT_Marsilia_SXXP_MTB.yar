...
rule Trojan_BAT_Marsilia_SXXP_MTB{
	...
	strings :
		$a_03_0 = {0b 02 72 17 00 00 70 72 1b 00 00 70 6f 90 01 03 0a 28 90 01 03 0a 0c 28 90 01 03 0a 07 08 16 08 8e 69 6f 90 01 03 0a 6f 90 01 03 0a 0d 2b 00 90 00 } //4
