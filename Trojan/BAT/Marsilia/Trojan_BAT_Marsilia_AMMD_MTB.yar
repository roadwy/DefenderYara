...
rule Trojan_BAT_Marsilia_AMMD_MTB{
	...
	strings :
		$a_03_0 = {0a 13 0b 73 90 01 01 00 00 0a 11 0b 72 90 01 02 00 70 07 28 90 01 01 00 00 0a 6f 90 01 01 00 00 0a 11 0b 6f 90 01 01 00 00 0a 6f 90 01 01 00 00 0a 25 28 90 01 01 00 00 0a 13 0c 72 90 01 02 00 70 28 90 01 01 00 00 06 16 8d 90 01 01 00 00 01 28 90 01 01 00 00 06 72 90 00 } //2
