...
rule Trojan_BAT_BluStealer_RDA_MTB{
	...
	strings :
		$a_03_0 = {00 07 08 09 28 90 01 04 28 90 01 04 00 28 90 01 04 28 90 01 04 28 90 01 04 00 7e 90 01 04 06 28 90 01 04 d2 9c 00 09 17 58 0d 09 17 fe 04 13 04 11 04 90 00 } //2
