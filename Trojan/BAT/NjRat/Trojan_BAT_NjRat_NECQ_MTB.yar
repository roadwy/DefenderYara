...
rule Trojan_BAT_NjRat_NECQ_MTB{
	...
	strings :
		$a_03_0 = {06 00 06 0b 07 6f 90 01 01 00 00 0a 17 da 0c 16 0d 2b 20 7e 90 01 01 03 00 04 07 09 16 6f 90 01 01 00 00 0a 13 04 12 04 28 90 01 01 00 00 0a 6f 90 01 01 00 00 0a 00 09 17 d6 0d 09 08 31 dc 90 00 } //10
