...
rule Trojan_BAT_NjRat_NEAH_MTB{
	...
	strings :
		$a_03_0 = {2b 0a 2b 0b 18 2b 0b 1f 10 2b 0e 2a 02 2b f3 03 2b f2 6f 90 01 01 00 00 0a 2b ee 28 90 01 01 00 00 0a 2b eb 90 00 } //10
		$a_03_1 = {2a 2b 18 14 2b 18 16 2d eb 2a 28 90 01 01 00 00 06 2b df 28 90 01 01 00 00 0a 2b da 0a 2b d9 06 2b e5 6f 90 01 01 00 00 0a 2b e1 90 00 } //10
