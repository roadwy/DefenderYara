...
rule Trojan_BAT_Njrat_MH_MTB{
	...
	strings :
		...
		$a_01_1 = {48 65 78 44 65 63 72 79 70 74 } //01 00  HexDecrypt
		$a_01_2 = {37 35 39 30 31 39 31 32 2d 61 39 30 39 2d 34 37 31 36 2d 39 38 35 38 2d 65 62 65 61 39 36 63 63 35 38 39 39 } //00 00  75901912-a909-4716-9858-ebea96cc5899
	condition:
		any of ($a_*)
