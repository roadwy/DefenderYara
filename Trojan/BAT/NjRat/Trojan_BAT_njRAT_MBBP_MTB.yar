...
rule Trojan_BAT_njRAT_MBBP_MTB{
	...
	strings :
		...
		$a_01_1 = {43 00 30 00 59 00 4f 00 56 00 53 00 39 00 42 00 75 00 43 00 39 00 42 00 71 00 56 00 53 00 4e 00 33 00 74 00 6a 00 58 00 41 00 55 00 6d 00 48 00 31 00 50 00 62 00 4e 00 30 00 48 00 44 00 } //00 00  C0YOVS9BuC9BqVSN3tjXAUmH1PbN0HD
	condition:
		any of ($a_*)
