...
rule Trojan_BAT_njRAT_RDO_MTB{
	...
	strings :
		$a_01_0 = {65 36 31 66 64 36 39 33 2d 64 35 65 64 2d 34 66 32 32 2d 61 34 34 31 2d 35 33 61 30 65 30 64 35 32 36 32 62 } //01 00  e61fd693-d5ed-4f22-a441-53a0e0d5262b
		$a_01_1 = {56 00 6f 00 6f 00 6c 00 79 00 20 00 4e 00 62 00 61 00 } //02 00  Vooly Nba
