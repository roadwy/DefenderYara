...
rule Trojan_BAT_njRAT_A_MTB_2{
	...
	strings :
		$a_03_0 = {07 06 11 06 9a 6f 90 01 01 00 00 0a 28 90 01 01 00 00 0a 0b 11 06 17 d6 13 06 11 06 11 05 31 90 00 } //2
		$a_03_1 = {00 00 0a 0c 08 14 72 90 01 03 70 17 8d 90 01 01 00 00 01 25 16 07 28 90 01 01 00 00 0a 28 90 01 01 00 00 0a a2 14 14 14 28 90 01 01 00 00 0a 28 90 01 01 00 00 0a 0d 09 14 72 90 01 03 70 16 8d 90 01 01 00 00 01 14 14 14 28 90 01 01 00 00 0a 28 90 01 01 00 00 0a 13 04 11 04 14 72 90 01 03 70 18 8d 90 01 01 00 00 01 25 16 72 90 01 03 70 a2 14 14 14 17 28 90 00 } //2
	condition:
