...
rule Trojan_BAT_njRAT_MBBC_MTB{
	...
	strings :
		...
		$a_01_1 = {30 63 64 37 66 61 36 31 64 30 34 64 } //01 00  0cd7fa61d04d
		$a_01_2 = {6c 00 69 00 6e 00 6b 00 70 00 69 00 63 00 74 00 75 00 72 00 65 00 2e 00 63 00 6f 00 6d 00 2f 00 71 00 2f 00 } //00 00  linkpicture.com/q/
	condition:
		any of ($a_*)
