...
rule Trojan_BAT_NjRat_NEX_MTB{
	...
	strings :
		$a_03_0 = {fe 01 13 04 11 04 2d dc 28 90 01 01 00 00 0a 07 28 90 01 01 00 00 0a 28 90 01 01 00 00 0a 6f 90 01 01 00 00 0a 6f 90 01 01 00 00 0a 72 90 01 01 01 00 70 90 00 } //5
