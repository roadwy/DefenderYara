...
rule Trojan_BAT_NjRat_NEBU_MTB{
	...
	strings :
		...
		$a_01_1 = {54 00 56 00 20 00 71 00 71 00 20 00 51 00 20 00 41 00 } //02 00 
		$a_01_2 = {64 37 33 36 37 36 33 34 64 33 38 36 34 64 30 66 38 61 63 33 65 36 33 38 36 62 38 36 35 31 31 65 } //01 00 
