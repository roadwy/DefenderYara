...
rule Trojan_BAT_NjRat_NECR_MTB{
	...
	strings :
		$a_03_0 = {11 37 11 36 fe 02 16 fe 01 13 3c 11 3c 3a 90 01 01 fc ff ff 28 90 01 01 00 00 0a 11 38 28 90 01 01 00 00 0a 6f 90 01 01 00 00 0a 13 39 11 39 90 00 } //10
