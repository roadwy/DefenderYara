...
rule Trojan_BAT_NjRat_NEBC_MTB{
	...
	strings :
		...
		$a_01_2 = {44 65 63 6f 6d 70 72 65 73 73 } //02 00 
		$a_01_3 = {52 50 46 3a 53 6d 61 72 74 41 73 73 65 6d 62 6c 79 } //02 00 
		$a_01_4 = {53 79 73 74 65 6d 2e 57 69 6e 64 6f 77 73 2e 46 6f 72 6d 73 } //00 00 
	condition:
		any of ($a_*)
