...
rule Trojan_BAT_NjRat_NEBC_MTB{
	...
	strings :
		$a_03_0 = {0b 06 07 16 1a 28 90 01 01 00 00 06 26 07 16 28 90 01 01 00 00 06 0c 06 16 73 90 01 01 00 00 0a 0d 08 8d 26 00 00 01 13 04 90 00 } //5
		$a_03_1 = {46 00 00 00 26 20 02 00 00 00 38 1d 00 00 00 09 11 04 16 08 28 90 01 01 00 00 06 26 90 00 } //5
