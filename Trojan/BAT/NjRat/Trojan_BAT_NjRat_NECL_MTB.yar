...
rule Trojan_BAT_NjRat_NECL_MTB{
	...
	strings :
		$a_03_0 = {28 0d 00 00 0a 28 0e 00 00 0a d0 11 00 00 01 28 0f 00 00 0a 72 90 01 01 00 00 70 28 10 00 00 0a 0a 16 8c 90 01 01 00 00 01 0b 17 8d 90 01 01 00 00 01 0d 09 16 90 00 } //10
