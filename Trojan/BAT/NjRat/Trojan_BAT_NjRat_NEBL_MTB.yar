...
rule Trojan_BAT_NjRat_NEBL_MTB{
	...
	strings :
		...
		$a_01_1 = {53 74 75 62 2e 65 78 65 } //02 00 
		$a_01_2 = {50 6f 77 65 72 65 64 20 62 79 20 53 6d 61 72 74 41 73 73 65 6d 62 6c 79 20 38 2e 30 2e 32 2e 34 37 37 39 } //00 00 
	condition:
		any of ($a_*)
