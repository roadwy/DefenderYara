...
rule Trojan_BAT_NjRAT_NR_MTB{
	...
	strings :
		$a_03_0 = {26 08 09 02 09 91 11 04 11 04 06 84 95 11 04 07 84 95 d7 6e 90 01 05 6a 5f b7 95 61 86 9c 90 00 } //3
	condition:
		((#a_03_0  & 1)*3) >=3
...
rule Trojan_BAT_NjRAT_NR_MTB_2{
	...
	strings :
		$a_03_0 = {0a 06 72 10 4a 01 70 28 90 01 03 06 28 90 01 03 0a 28 90 01 03 0a 0b 07 28 90 01 03 0a 0c 08 6f 90 01 03 0a 14 14 6f 90 01 03 0a 90 00 } //5
