...
rule Trojan_BAT_NjRat_NEZ_MTB{
	...
	strings :
		$a_03_0 = {07 06 08 9a 6f 90 01 01 00 00 0a 28 90 01 01 00 00 0a 0b 08 17 58 0c 08 06 8e 69 17 59 fe 02 16 fe 01 13 07 11 07 2d dc 90 00 } //5
		$a_03_1 = {07 28 09 00 00 0a 28 90 01 01 00 00 0a 28 90 01 01 00 00 06 0d 09 90 00 } //5
