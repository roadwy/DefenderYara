...
rule Trojan_BAT_Njrat_ABY_MTB{
	...
	strings :
		...
		$a_01_2 = {6f 00 61 00 6e 00 73 00 65 00 65 00 65 00 65 00 65 00 65 00 } //01 00 
		$a_01_3 = {7a 00 77 00 6f 00 61 00 61 00 61 00 65 00 65 00 65 00 65 00 65 00 } //00 00 
	condition:
		any of ($a_*)
