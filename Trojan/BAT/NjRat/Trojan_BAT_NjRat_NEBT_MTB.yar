...
rule Trojan_BAT_NjRat_NEBT_MTB{
	...
	strings :
		$a_03_0 = {04 16 0a 2b 1b 00 7e ?? 00 00 04 06 7e ?? 00 00 04 06 91 20 ?? ?? 00 00 59 d2 9c 00 06 17 58 0a 06 7e ?? 00 00 04 8e 69 fe 04 0b 07 2d d7 7e ?? 00 00 04 0c 2b 00 08 2a } //10
