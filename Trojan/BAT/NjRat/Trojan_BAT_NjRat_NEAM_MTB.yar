...
rule Trojan_BAT_NjRat_NEAM_MTB{
	...
	strings :
		$a_03_0 = {04 08 04 6f 90 01 01 00 00 0a 5d 17 d6 28 90 01 01 00 00 0a da 0d 06 09 28 90 01 01 00 00 0a 28 90 01 01 00 00 0a 28 90 01 01 00 00 0a 0a 00 08 17 d6 0c 08 11 04 13 05 11 05 31 c7 90 00 } //10
