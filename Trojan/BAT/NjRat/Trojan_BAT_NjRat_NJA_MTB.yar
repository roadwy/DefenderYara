...
rule Trojan_BAT_NjRat_NJA_MTB_2{
	...
	strings :
		$a_03_0 = {38 0f 00 00 00 26 20 90 01 03 00 fe 90 01 02 00 38 90 01 03 ff 08 14 72 90 01 03 70 18 8d 90 01 03 01 14 14 14 17 28 90 01 03 0a 26 dd 90 01 03 00 90 00 } //5
