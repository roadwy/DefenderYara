...
rule Trojan_BAT_NjRat_NEDK_MTB{
	...
	strings :
		$a_03_0 = {0a 06 28 4b 00 00 0a 72 e6 25 01 70 18 18 28 29 00 00 06 0b 07 28 90 01 01 00 00 0a 0c 08 6f 90 01 01 00 00 0a 14 14 6f 90 01 01 00 00 0a 26 00 2a 90 00 } //10
