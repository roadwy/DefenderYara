...
rule Trojan_BAT_NjRat_NEAO_MTB{
	...
	strings :
		$a_03_0 = {28 4a 00 00 0a 0b 72 90 01 02 00 70 07 73 90 01 01 00 00 0a 0c 08 02 6f 90 01 01 00 00 0a 74 90 01 01 00 00 1b 28 90 01 01 00 00 06 0a 2b 00 06 2a 90 00 } //10
