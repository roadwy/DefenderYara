...
rule Trojan_BAT_NjRat_NEDJ_MTB{
	...
	strings :
		$a_03_0 = {13 0d 08 17 d6 0c 00 08 09 fe 02 16 fe 01 13 10 11 10 3a 53 ff ff ff 28 90 01 01 00 00 0a 11 0d 28 90 01 01 00 00 0a 6f 90 01 01 00 00 0a 0a 06 14 90 00 } //10
