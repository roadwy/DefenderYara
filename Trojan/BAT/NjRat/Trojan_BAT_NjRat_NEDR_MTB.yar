...
rule Trojan_BAT_NjRat_NEDR_MTB{
	...
	strings :
		$a_03_0 = {13 05 0d 2b 39 02 09 28 90 01 01 00 00 0a 28 90 01 01 00 00 0a 6a 03 28 90 01 01 00 00 0a 04 07 5d 6c 58 28 90 01 01 00 00 0a b8 6e da 0c 06 08 90 00 } //10
