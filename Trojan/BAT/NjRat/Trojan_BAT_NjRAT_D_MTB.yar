...
rule Trojan_BAT_NjRAT_D_MTB{
	...
	strings :
		$a_03_0 = {00 00 04 25 2d 17 26 7e 90 01 01 00 00 04 fe 06 07 00 00 06 73 90 01 01 00 00 0a 25 80 90 01 01 00 00 04 28 90 01 01 00 00 2b 28 90 01 01 00 00 2b 73 90 00 } //2
