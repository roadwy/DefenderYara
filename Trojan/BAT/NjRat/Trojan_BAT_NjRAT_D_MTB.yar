...
rule Trojan_BAT_NjRAT_D_MTB{
	...
	strings :
		...
		$a_01_1 = {2f 00 41 00 70 00 70 00 44 00 61 00 74 00 61 00 2f 00 4c 00 6f 00 63 00 61 00 6c 00 2f 00 54 00 65 00 6d 00 70 00 2f 00 } //00 00  /AppData/Local/Temp/
	condition:
		any of ($a_*)
