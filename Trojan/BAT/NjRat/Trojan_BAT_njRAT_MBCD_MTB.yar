...
rule Trojan_BAT_njRAT_MBCD_MTB{
	...
	strings :
		...
		$a_01_1 = {61 64 30 61 39 30 66 30 2d 61 64 35 38 2d 34 65 35 62 2d 38 35 37 37 2d 31 34 63 66 34 37 30 33 64 33 64 33 } //00 00  ad0a90f0-ad58-4e5b-8577-14cf4703d3d3
	condition:
		any of ($a_*)
