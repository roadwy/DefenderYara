...
rule Trojan_BAT_NJRat_TW_MTB{
	...
	strings :
		...
		$a_81_1 = {48 69 64 64 65 6e 53 54 55 70 } //01 00 
		$a_81_2 = {5c 6f 69 2e 63 6f 6d 2e 6a 73 } //01 00 
		$a_81_3 = {5c 6f 69 2e 63 6f 6d 2e 6c 6e 6b } //01 00 
		$a_81_4 = {5c 41 56 47 5c 41 6e 74 69 76 69 72 75 73 5c 41 56 47 55 49 2e 65 78 65 } //01 00 
		$a_81_5 = {5c 41 56 41 53 54 20 53 6f 66 74 77 61 72 65 5c 41 76 61 73 74 5c 61 76 61 73 74 55 49 2e 65 78 65 } //01 00 
		$a_81_6 = {5c 4b 61 73 70 65 72 53 6b 79 20 4c 61 62 5c } //00 00 
