...
rule Trojan_BAT_NjRat_NECH_MTB{
	...
	strings :
		$a_03_0 = {08 09 8e b7 32 0c 20 93 00 00 00 13 04 38 bb 53 ff ff 20 b7 00 00 00 2b f2 06 28 90 01 01 00 00 0a 28 90 01 01 00 00 0a 6f 90 01 01 00 00 0a 14 14 6f 90 01 01 00 00 0a 26 2a 90 00 } //10
