...
rule Trojan_BAT_NjRAT_L_MTB{
	...
	strings :
		$a_03_0 = {06 13 04 7e 90 01 01 00 00 04 11 04 02 16 02 8e 69 28 90 00 } //2
	condition:
		((#a_03_0  & 1)*2) >=2
...
rule Trojan_BAT_NjRAT_L_MTB_2{
	...
	strings :
		$a_03_0 = {11 06 11 04 11 07 11 07 08 91 11 07 09 91 d6 90 01 05 5f 91 06 11 04 91 61 9c 2b 07 13 07 90 00 } //3
	condition:
		((#a_03_0  & 1)*3) >=3
