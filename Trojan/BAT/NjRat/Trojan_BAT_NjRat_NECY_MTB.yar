...
rule Trojan_BAT_NjRat_NECY_MTB{
	...
	strings :
		...
		$a_01_1 = {71 33 6f 4d 56 65 35 34 77 45 34 37 77 34 76 36 38 43 37 73 32 49 } //02 00  q3oMVe54wE47w4v68C7s2I
		$a_01_2 = {57 72 69 74 65 50 72 6f 63 65 73 73 4d 65 6d 6f 72 79 } //02 00  WriteProcessMemory
