...
rule Trojan_BAT_NjRat_NEDP_MTB{
	...
	strings :
		$a_03_0 = {03 8e 69 18 da 17 d6 8d 90 01 01 00 00 01 0a 03 8e 69 17 da 0b 38 1b 00 00 00 06 07 17 da 02 03 07 91 03 07 17 da 91 65 b5 28 90 01 01 00 00 06 25 26 9c 07 15 d6 0b 07 17 90 00 } //10
