...
rule Trojan_BAT_NjRAT_C_MTB{
	...
	strings :
		...
		$a_03_1 = {00 00 01 11 05 11 0a 74 90 01 01 00 00 1b 11 0c 11 07 58 11 09 59 93 61 11 0b 74 90 01 01 00 00 1b 11 09 11 0c 58 1f 90 01 01 58 11 08 5d 93 61 d1 6f 90 00 } //2
	condition:
