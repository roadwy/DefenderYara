...
rule Trojan_BAT_OrcusRat_ACU_MTB{
	...
	strings :
		...
		$a_01_1 = {31 00 39 00 33 00 2e 00 31 00 33 00 38 00 2e 00 31 00 39 00 35 00 2e 00 32 00 31 00 31 00 } //01 00 
		$a_01_2 = {52 00 75 00 6e 00 6e 00 65 00 72 00 2e 00 65 00 78 00 65 00 } //00 00 
	condition:
		any of ($a_*)
