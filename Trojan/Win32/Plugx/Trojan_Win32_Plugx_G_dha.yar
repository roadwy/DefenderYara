...
rule Trojan_Win32_Plugx_G_dha_2{
	...
	strings :
		$a_03_0 = {60 6a 00 ff 55 f8 61 8b 0d 00 30 00 10 [0-10] 8d 81 ?? 30 00 10 83 c1 06 [0-10] c7 00 53 6c 65 65 66 c7 40 04 70 00 89 0d 00 30 00 10 } //1
		$a_03_1 = {ff d0 8b 0d 00 30 00 10 89 45 fc 8d 81 ?? 30 00 10 83 c1 09 c7 00 6c 73 74 72 c7 40 04 63 70 79 57 } //1
		$a_03_2 = {8a 1c 01 80 c3 ?? 80 f3 ?? 80 eb 90 1b 00 88 18 40 4f 75 ee 83 c2 } //1
		$a_03_3 = {8b 0d 00 30 00 10 8d 81 ?? 30 00 10 83 c1 09 [0-10] c7 00 52 65 61 64 c7 40 04 46 69 6c 65 [0-30] 81 79 1c 18 00 1a 00 } //1
	condition:
