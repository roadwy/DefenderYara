...
rule Trojan_Win32_Plugx_C{
	...
	strings :
		$a_03_0 = {52 6a 40 03 f0 6a 10 56 ff d7 85 c0 74 35 b8 90 01 04 2b c6 83 e8 05 88 46 01 8b c8 8b d0 c1 e8 18 c1 e9 08 88 46 04 c1 ea 10 8d 44 24 08 50 c6 06 e9 88 4e 02 88 56 03 8b 4c 24 0c 90 00 } //1
