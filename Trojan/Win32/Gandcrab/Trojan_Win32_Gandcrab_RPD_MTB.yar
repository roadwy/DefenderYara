...
rule Trojan_Win32_Gandcrab_RPD_MTB{
	...
	strings :
		...
		$a_02_2 = {30 04 1f 56 ff 15 90 01 04 56 ff 15 90 01 04 33 c0 89 b5 e8 f7 ff ff 8d bd ec f7 ff ff ab 8d 85 e8 f7 ff ff 50 56 56 56 ff 15 90 01 04 8d 85 f4 f7 ff ff 50 56 ff 15 90 01 04 43 3b 5d 90 00 } //2
		$a_02_3 = {8a e3 8a c3 80 e3 f0 c0 e0 06 0a 44 3a 90 01 01 80 e4 fc c0 e3 02 0a 1c 3a c0 e4 04 0a 64 3a 90 01 01 83 c7 04 88 1c 31 88 64 31 01 88 44 31 02 83 c1 03 3b 7d 00 72 90 00 } //2
	condition:
