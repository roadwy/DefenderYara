...
rule Trojan_Win32_GandCrab_VDSK_MTB{
	...
	strings :
		$a_02_0 = {6a 00 05 c3 9e 26 00 a3 90 09 0a 00 69 05 90 01 04 fd 43 03 00 90 00 } //1
		...
		$a_02_3 = {33 c4 89 84 24 00 08 00 00 a1 90 01 04 69 c0 fd 43 03 00 8d 0c 24 51 05 c3 9e 26 00 68 90 01 04 a3 90 00 } //2
	condition:
