...
rule Trojan_Win32_Gandcrab_CC_MTB{
	meta:
		description = "Trojan:Win32/Gandcrab.CC!MTB,SIGNATURE_TYPE_PEHSTR_EXT,04 00 04 00 04 00 00 01 00 "
		
	strings :
		$a_01_0 = {33 c1 8b 4d dc c1 e9 05 03 4d ec 33 c1 8b 4d f4 2b c8 89 4d } //01 00 
