...
rule Trojan_Win32_GandCrab_KSD_MTB{
	...
	strings :
		...
		$a_02_1 = {0f b6 45 ff 88 99 ?? ?? ?? ?? 0f b6 9a ?? ?? ?? ?? 03 d8 81 f9 2c 87 14 00 76 90 09 0c 00 8b 0d ?? ?? ?? ?? 8b 15 } //2
		...
		$a_02_3 = {8a 81 80 ef 42 00 8a 9a 80 ef 42 00 88 82 80 ef 42 00 81 f9 0a 0d 00 00 73 90 09 0c 00 8b 0d ?? ?? ?? ?? 8b 15 } //2
	condition:
