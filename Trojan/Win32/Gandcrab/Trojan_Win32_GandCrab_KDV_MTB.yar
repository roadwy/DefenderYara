...
rule Trojan_Win32_GandCrab_KDV_MTB{
	...
	strings :
		...
		$a_00_4 = {63 47 77 4c 76 41 7d 24 24 57 4e 4e 2a 68 50 35 75 56 35 70 4c 63 50 78 61 68 77 4d 4c 56 4b 55 44 50 40 25 4c 6e 66 47 47 24 57 6e 48 6f 70 76 6a 24 68 64 78 33 51 31 66 54 64 6b 43 72 23 51 } //00 00 
	condition:
		any of ($a_*)
