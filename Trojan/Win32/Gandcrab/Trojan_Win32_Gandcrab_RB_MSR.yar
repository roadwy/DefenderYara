...
rule Trojan_Win32_Gandcrab_RB_MSR{
	...
	strings :
		$a_00_0 = {33 00 36 00 30 00 4e 00 65 00 74 00 42 00 61 00 73 00 65 00 2e 00 64 00 6c 00 6c 00 } //-50 360NetBase.dll
		$a_00_1 = {33 00 36 00 30 00 44 00 65 00 63 00 72 00 79 00 70 00 74 00 6f 00 72 00 5f 00 50 00 72 00 69 00 76 00 61 00 74 00 65 00 4b 00 65 00 79 00 2e 00 69 00 6e 00 69 00 } //-50 360Decryptor_PrivateKey.ini
		$a_00_2 = {33 00 36 00 30 00 2e 00 63 00 6e 00 20 00 49 00 6e 00 63 00 } //-50 360.cn Inc
		$a_00_3 = {54 00 65 00 73 00 6c 00 61 00 43 00 72 00 79 00 70 00 74 00 44 00 65 00 63 00 6f 00 64 00 65 00 72 00 2e 00 64 00 6c 00 6c 00 } //-50 TeslaCryptDecoder.dll
		$a_00_4 = {52 65 6c 65 61 73 65 5c 54 65 73 6c 61 43 72 79 70 74 44 65 63 6f 64 65 72 2e 70 64 62 } //-50 Release\TeslaCryptDecoder.pdb
	...
	condition:
		((#a_00_0  & 1)*-50+(#a_00_1  & 1)*-50+(#a_00_2  & 1)*-50+(#a_00_3  & 1)*-50+(#a_00_4  & 1)*-50+(#a_01_5  & 1)*20+(#a_01_6  & 1)*20+(#a_01_7  & 1)*1+(#a_01_8  & 1)*1+(#a_01_9  & 1)*1+(#a_01_10  & 1)*1+(#a_01_11  & 1)*1+(#a_01_12  & 1)*1+(#a_01_13  & 1)*1+(#a_01_14  & 1)*1+(#a_01_15  & 1)*1+(#a_01_16  & 1)*1+(#a_01_17  & 1)*1+(#a_01_18  & 1)*1+(#a_01_19  & 1)*1+(#a_01_20  & 1)*1) >=25
