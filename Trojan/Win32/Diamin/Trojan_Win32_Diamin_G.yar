...
rule Trojan_Win32_Diamin_G{
	...
	strings :
		...
		$a_00_4 = {44 69 73 69 6e 73 74 61 6c 6c 61 2e 6c 6e 6b } //01 00  Disinstalla.lnk
		$a_00_5 = {70 3a 2f 2f 66 6c 61 74 2e 74 72 61 66 66 } //01 00  p://flat.traff
		$a_00_6 = {69 61 6c 31 2e 65 } //01 00  ial1.e
		$a_00_7 = {74 69 2c 20 73 63 65 67 6c 69 65 72 65 20 22 4e 6f 22 20 70 65 72 20 61 63 63 65 64 65 72 65 20 64 69 72 65 74 74 61 6d 65 6e 74 65 2e } //00 00  ti, scegliere "No" per accedere direttamente.
	condition:
		any of ($a_*)
