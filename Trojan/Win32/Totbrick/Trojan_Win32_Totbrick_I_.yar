...
rule Trojan_Win32_Totbrick_I_{
	meta:
		description = "Trojan:Win32/Totbrick.I!!Totbrick.gen!B,SIGNATURE_TYPE_ARHSTR_EXT,03 00 03 00 06 00 00 01 00 "
	...
	strings :
		...
		$a_00_4 = {8d 4c 24 1c ba 20 00 00 00 c7 41 f4 08 02 00 00 c7 41 f8 10 66 00 00 89 51 fc } //01 00 
		$a_03_5 = {0f be 39 41 03 fa 8b df c1 e3 0a 03 df 8b d3 c1 ea 06 33 d3 48 75 90 01 01 8b 3c 24 8d 04 d2 eb 02 33 c0 8b c8 c1 e9 0b 90 00 } //00 00 
	condition:
		any of ($a_*)
