...
rule Trojan_Win32_LightNeuron_D_dha{
	...
	strings :
		$a_01_0 = {45 76 65 6e 74 33 33 33 } //01 00 
		$a_01_1 = {56 71 56 49 a9 b9 e3 ef e0 ef } //02 00 
		$a_01_2 = {33 36 62 31 66 34 61 2d 38 32 62 39 2d 65 62 30 36 2d 37 63 31 65 2d 39 30 62 34 62 32 64 35 63 32 37 64 } //02 00 
		$a_01_3 = {46 4c 00 53 56 00 42 4c 45 } //02 00 
		$a_01_4 = {c8 cb ca cd cc f6 c2 cc d0 f6 ce cc c7 cc db c8 dd c0 c6 c7 } //02 00 
		$a_01_5 = {12 50 30 74 12 50 31 43 0c 56 64 4a 0a 6a 42 53 } //02 00 
		...
		$a_01_8 = {73 69 6d 70 6c 65 56 61 6c 69 64 61 74 65 } //00 00 
	condition:
		any of ($a_*)
