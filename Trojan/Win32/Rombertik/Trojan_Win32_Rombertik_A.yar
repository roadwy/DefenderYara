...
rule Trojan_Win32_Rombertik_A{
	...
	strings :
		...
		$a_01_2 = {2f 65 6d 65 2f 30 33 2f 69 6e 64 65 78 2e 70 68 70 3f 61 3d 69 6e 73 65 72 74 } //01 00 
		$a_01_3 = {46 6f 72 6d 47 72 61 62 62 65 72 4b 69 74 2e 70 64 62 } //00 00 
	condition:
		any of ($a_*)
