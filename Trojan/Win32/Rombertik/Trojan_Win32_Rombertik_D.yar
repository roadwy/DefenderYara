...
rule Trojan_Win32_Rombertik_D{
	...
	strings :
		...
		$a_01_3 = {61 57 56 34 63 47 78 76 63 6d 55 75 5a 58 68 6c } //01 00  aWV4cGxvcmUuZXhl
		$a_01_4 = {5a 58 68 77 62 47 39 79 5a 58 49 75 5a 58 68 6c } //00 00  ZXhwbG9yZXIuZXhl
