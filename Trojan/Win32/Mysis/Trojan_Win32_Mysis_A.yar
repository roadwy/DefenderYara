...
rule Trojan_Win32_Mysis_A{
	...
	strings :
		...
		$a_01_1 = {69 6e 76 65 73 74 2e 66 33 33 32 32 2e 6e 65 74 } //01 00  invest.f3322.net
		$a_01_2 = {57 69 6e 64 6f 77 73 20 48 65 6c 70 20 53 79 73 74 65 6d 20 4d 79 73 73 } //02 00  Windows Help System Myss
