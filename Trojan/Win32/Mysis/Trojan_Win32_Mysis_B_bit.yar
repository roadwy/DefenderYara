...
rule Trojan_Win32_Mysis_B_bit{
	...
	strings :
		...
		$a_01_1 = {57 69 6e 64 6f 77 73 20 48 65 6c 70 20 53 79 73 74 65 6d 20 4d 79 73 73 } //01 00  Windows Help System Myss
		$a_01_2 = {25 63 25 63 25 63 25 63 25 63 2e 65 78 65 } //01 00  %c%c%c%c%c.exe
