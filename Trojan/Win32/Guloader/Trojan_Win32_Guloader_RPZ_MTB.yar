...
rule Trojan_Win32_Guloader_RPZ_MTB_2{
	...
	strings :
		$a_01_0 = {43 6f 72 70 6f 72 61 32 32 30 2e 46 69 6c } //01 00  Corpora220.Fil
		$a_01_1 = {62 65 73 74 6e 69 6e 67 73 6d 65 64 6c 65 6d 2e 63 68 61 } //01 00  bestningsmedlem.cha
		$a_01_2 = {70 6f 6c 6c 69 6e 6f 73 69 73 2e 4b 74 74 } //01 00  pollinosis.Ktt
		$a_01_3 = {75 6e 73 77 61 79 61 62 6c 65 6e 65 73 73 } //01 00  unswayableness
		$a_01_4 = {73 69 64 65 68 6e 67 74 65 2e 69 6e 69 } //00 00  sidehngte.ini
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Guloader_RPZ_MTB_3{
	...
	strings :
		$a_01_0 = {4d 61 64 6d 6f 64 65 72 65 6e 2e 64 6c 6c } //01 00  Madmoderen.dll
		$a_01_1 = {43 61 62 6d 65 6e 5c 61 66 68 75 64 65 74 } //01 00  Cabmen\afhudet
		$a_01_2 = {77 6f 72 74 68 77 68 69 6c 65 6e 65 73 73 } //01 00  worthwhileness
		$a_01_3 = {6f 76 65 72 6a 65 67 65 72 73 } //01 00  overjegers
		$a_01_4 = {53 75 6b 6b 65 72 6b 75 67 6c 65 72 6e 65 73 32 30 31 2e 68 65 72 } //00 00  Sukkerkuglernes201.her
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Guloader_RPZ_MTB_4{
	...
	strings :
		$a_01_0 = {66 6f 6f 74 69 65 73 2e 72 77 61 } //01 00  footies.rwa
		$a_01_1 = {6e 6f 6e 63 68 61 72 67 65 61 62 6c 65 2e 66 61 6c } //01 00  nonchargeable.fal
		$a_01_2 = {73 69 6c 6b 65 70 61 70 69 72 73 2e 67 75 6c } //01 00  silkepapirs.gul
		$a_01_3 = {72 65 76 61 6c 69 64 65 72 69 6e 67 73 63 65 6e 74 72 65 73 2e 62 72 75 } //01 00  revalideringscentres.bru
		$a_01_4 = {53 75 7a 61 6e 6e 61 68 } //00 00  Suzannah
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Guloader_RPZ_MTB_5{
	...
	strings :
		$a_01_0 = {72 65 67 69 6f 6e 70 6c 61 6e 72 65 74 6e 69 6e 67 73 6c 69 6e 6a 65 72 } //01 00  regionplanretningslinjer
		$a_01_1 = {73 6c 65 74 68 76 61 72 72 65 72 73 } //01 00  slethvarrers
		$a_01_2 = {67 79 6e 61 6e 64 72 6f 6d 6f 72 70 68 79 } //01 00  gynandromorphy
		$a_01_3 = {73 65 6b 72 65 74 61 72 69 61 74 73 6d 65 64 61 72 62 65 6a 64 65 72 65 6e } //01 00  sekretariatsmedarbejderen
		$a_01_4 = {54 61 61 73 74 72 75 70 67 61 61 72 64 32 33 30 } //00 00  Taastrupgaard230
	condition:
		any of ($a_*)
