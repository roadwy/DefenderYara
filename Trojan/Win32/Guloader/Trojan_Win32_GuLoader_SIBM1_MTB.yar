...
rule Trojan_Win32_GuLoader_SIBM1_MTB{
	...
	strings :
		...
		$a_03_2 = {b8 00 00 00 00 90 02 0a 50 90 02 6a b8 90 01 04 90 02 f0 01 c2 90 02 6a ff 12 90 02 70 ff 37 90 02 0a 5d 90 02 6a 31 f5 90 02 0a 31 2c 10 90 02 6a 83 c2 04 90 02 0a 83 c7 04 90 02 6a 81 fa 90 01 04 0f 85 90 01 04 90 02 6a 50 90 02 0a c3 90 00 } //1
	condition:
