...
rule Trojan_Win32_GuLoader_SIBU_MTB{
	...
	strings :
		...
		$a_03_1 = {aa 81 34 1a 90 01 04 90 02 40 43 90 02 3a 43 90 02 40 43 90 02 30 43 90 02 2a 81 fb 90 01 04 90 02 30 0f 85 90 01 04 90 02 3a 90 08 bc 01 ff d2 90 00 } //1
	condition:
