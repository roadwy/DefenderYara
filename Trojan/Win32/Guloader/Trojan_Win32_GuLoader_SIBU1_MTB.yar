...
rule Trojan_Win32_GuLoader_SIBU1_MTB{
	...
	strings :
		...
		$a_03_1 = {f9 81 34 1a 90 01 04 90 02 35 43 90 02 30 43 90 02 3a 43 90 02 30 43 90 02 3a 81 fb 90 01 04 90 02 40 0f 85 90 01 04 90 08 3a 01 81 36 90 01 04 90 02 40 81 2e 90 01 04 90 02 3a ff d2 90 00 } //1
	condition:
