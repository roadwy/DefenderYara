...
rule Trojan_Win32_GuLoader_SIBU17_MTB{
	...
	strings :
		...
		$a_03_1 = {ff 34 0f d9 90 01 04 90 02 6a 31 04 24 90 02 64 8f 04 0f 90 02 6c 83 c1 04 90 02 50 81 f9 90 01 04 90 02 40 0f 85 90 01 04 90 02 b0 ff d7 90 00 } //1
	condition:
