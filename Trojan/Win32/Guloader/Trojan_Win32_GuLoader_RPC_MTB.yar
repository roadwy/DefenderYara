...
rule Trojan_Win32_GuLoader_RPC_MTB{
	...
	strings :
		$a_02_0 = {83 c1 00 8b 34 39 90 02 10 90 13 90 02 10 01 34 3a 90 02 10 90 13 90 02 10 81 34 3a 90 02 10 90 13 90 02 10 83 ef 90 02 10 90 13 90 02 10 83 c7 90 02 10 90 13 90 02 10 0f 8d 90 00 } //1
	condition:
		((#a_02_0  & 1)*1) >=1
