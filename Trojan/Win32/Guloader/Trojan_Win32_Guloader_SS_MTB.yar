...
rule Trojan_Win32_Guloader_SS_MTB{
	...
	strings :
		$a_03_0 = {64 8b 1d c0 00 00 00 [0-10] 83 fb 00 0f 84 [0-04] e9 } //1
		$a_03_1 = {0f 6e c0 0f 6e 0b 0f ef c1 51 [0-10] 0f 7e c1 88 c8 [0-10] 59 } //1
		$a_03_2 = {89 e0 83 c4 06 ff 28 e8 ?? ff ff ff c3 } //1
	condition:
