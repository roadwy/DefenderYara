...
rule Trojan_Win32_GuLoader_AD_MTB_2{
	...
	strings :
		$a_01_0 = {72 00 6f 00 74 00 31 00 33 00 2e 00 64 00 6c 00 6c 00 } //01 00 
		$a_01_1 = {63 00 72 00 6f 00 6f 00 6b 00 65 00 64 00 65 00 72 00 2e 00 69 00 6e 00 69 00 } //01 00 
		...
		$a_01_3 = {77 00 69 00 67 00 77 00 61 00 6d 00 73 00 2e 00 69 00 6e 00 69 00 } //01 00 
		$a_01_4 = {66 00 75 00 7a 00 7a 00 65 00 72 00 2e 00 64 00 6c 00 6c 00 } //00 00 
	condition:
		any of ($a_*)
