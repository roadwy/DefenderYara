...
rule Trojan_Win32_GuLoader_SIBM16_MTB{
	...
	strings :
		...
		$a_03_1 = {83 c2 04 80 90 02 30 81 fa 90 01 04 90 18 90 02 30 81 34 17 90 01 04 90 02 30 83 c2 04 90 02 30 81 fa 90 01 04 0f 85 90 01 04 90 02 30 ff e7 90 00 } //1
	condition:
