...
rule Trojan_Win32_Sefnit_AP{
	...
	strings :
		...
		$a_00_3 = {57 00 69 00 6e 00 64 00 6f 00 77 00 73 00 20 00 49 00 6e 00 74 00 65 00 72 00 6e 00 65 00 74 00 20 00 4e 00 61 00 6d 00 65 00 20 00 53 00 65 00 72 00 76 00 69 00 63 00 65 00 } //00 00 
	condition:
		any of ($a_*)
