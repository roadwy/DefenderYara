...
rule Trojan_Win32_Sefnit_AX{
	...
	strings :
		$a_03_0 = {83 e8 1e 1b cb 39 8d 90 01 04 7c 0a 7f 59 39 85 90 01 04 73 51 53 e8 90 00 } //1
		$a_03_1 = {75 1f 83 ef 1e 83 db 00 39 9d 90 01 04 7c 0a 7f 2c 39 bd 90 01 04 73 24 68 90 00 } //1
		$a_03_2 = {75 27 83 ef 78 83 db 00 39 9d 90 01 04 7c 12 0f 8f 90 01 04 39 bd 90 01 04 0f 83 90 01 04 68 90 00 } //1
