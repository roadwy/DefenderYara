...
rule Trojan_Win32_Sefnit_AM{
	...
	strings :
		...
		$a_03_4 = {8d 45 f3 50 8d 45 f3 50 ff 75 e8 8d 4d d8 88 5d f3 e8 90 01 04 c6 45 fc 03 39 5d e8 74 1b 8d 45 ec 50 ff 75 e8 ff 75 d8 ff 76 08 90 00 } //1
		$a_03_5 = {8d 45 f3 50 ff 75 ec 8d 4d d8 88 5d f3 e8 90 01 04 8b 85 90 01 02 00 00 2b c3 74 3a 48 75 75 53 8d 45 e4 50 ff 75 ec 89 5d e4 ff 75 d8 ff 75 c8 90 00 } //1
	condition:
