...
rule Trojan_Win32_Sefnit_AU_2{
	...
	strings :
		...
		$a_03_1 = {7d 0a 68 57 00 07 80 e8 90 01 02 ff ff 89 79 f4 8b 0e 33 d2 66 89 51 18 b9 90 01 04 2b c8 8b d7 bb 90 01 02 00 00 66 33 1c 01 66 89 18 83 c0 02 4a 75 ee 90 00 } //1
	condition:
