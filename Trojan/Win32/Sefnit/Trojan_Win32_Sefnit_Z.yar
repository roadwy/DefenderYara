...
rule Trojan_Win32_Sefnit_Z{
	...
	strings :
		...
		$a_01_2 = {2f 67 65 74 38 00 } //01 00  术瑥8
		$a_01_3 = {47 30 74 44 30 6f 63 6d 64 00 } //01 00  ぇ䑴漰浣d
		$a_01_4 = {38 38 2e 31 39 38 2e 32 33 38 2e 31 33 2f } //01 00  88.198.238.13/
		$a_01_5 = {36 32 2e 31 30 39 2e 32 31 2e 39 30 2f } //00 00  62.109.21.90/
	condition:
		any of ($a_*)
