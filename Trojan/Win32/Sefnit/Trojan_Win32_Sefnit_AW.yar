...
rule Trojan_Win32_Sefnit_AW{
	...
	strings :
		$a_03_0 = {66 89 0c 07 83 c7 02 83 ff 90 01 01 72 dc 8b c6 e8 90 01 04 c3 90 09 0e 00 8b c6 b9 90 01 04 66 33 8f 90 00 } //1
		$a_03_1 = {83 c2 05 c1 e2 0a 52 90 09 0c 00 6a 64 59 99 f7 f9 8d 8d 90 00 } //1
