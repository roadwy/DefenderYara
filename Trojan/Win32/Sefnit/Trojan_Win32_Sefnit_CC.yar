...
rule Trojan_Win32_Sefnit_CC{
	...
	strings :
		...
		$a_00_2 = {2e 3f 41 56 57 61 74 63 68 65 72 45 78 65 63 40 40 } //01 00 
		$a_01_3 = {5c 00 74 00 68 00 65 00 6d 00 65 00 73 00 2e 00 64 00 6c 00 6c 00 } //01 00 
		$a_01_4 = {5c 00 73 00 74 00 61 00 72 00 74 00 75 00 70 00 5f 00 6d 00 6f 00 64 00 75 00 6c 00 65 00 2e 00 64 00 6c 00 6c 00 } //00 00 
