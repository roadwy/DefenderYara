...
rule Trojan_Win32_Sefnit_BZ{
	...
	strings :
		...
		$a_01_2 = {6f 00 63 00 6c 00 2e 00 65 00 78 00 65 00 } //01 00  ocl.exe
		$a_01_3 = {63 00 64 00 61 00 2e 00 65 00 78 00 65 00 } //01 00  cda.exe
		$a_01_4 = {63 00 70 00 75 00 2e 00 65 00 78 00 65 00 } //00 00  cpu.exe
	condition:
		any of ($a_*)
