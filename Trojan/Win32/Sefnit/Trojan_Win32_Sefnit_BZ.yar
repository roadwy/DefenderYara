...
rule Trojan_Win32_Sefnit_BZ{
	...
	strings :
		$a_03_0 = {46 83 fe 03 72 bd c6 45 90 01 01 01 eb 88 6a 04 90 00 } //3
		$a_03_1 = {6a 05 59 6a 0a 58 89 4d 90 01 01 89 4d 90 01 01 8d 8d 90 01 04 c7 45 90 01 01 3c 00 00 00 90 00 } //3
