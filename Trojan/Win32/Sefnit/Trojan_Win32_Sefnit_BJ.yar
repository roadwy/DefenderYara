...
rule Trojan_Win32_Sefnit_BJ{
	...
	strings :
		$a_03_0 = {2b c8 8b d7 bb 90 01 04 66 33 1c 01 66 89 18 83 c0 02 4a 75 ee 90 00 } //3
		$a_03_1 = {39 7e 4c 72 05 8b 7e 38 eb 03 8d 7e 38 ff 75 90 01 01 8b cb 68 90 00 } //3
