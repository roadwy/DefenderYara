...
rule Trojan_Win32_Sefnit_CA{
	...
	strings :
		...
		$a_01_1 = {57 00 69 00 6e 00 64 00 6f 00 77 00 73 00 20 00 4e 00 65 00 74 00 77 00 6f 00 72 00 6b 00 20 00 44 00 69 00 73 00 63 00 6f 00 76 00 65 00 72 00 79 00 20 00 53 00 65 00 72 00 76 00 69 00 63 00 65 00 } //00 00 
	condition:
		any of ($a_*)
