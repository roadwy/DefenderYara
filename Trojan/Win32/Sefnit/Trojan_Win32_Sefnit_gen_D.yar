...
rule Trojan_Win32_Sefnit_gen_D{
	...
	strings :
		...
		$a_03_2 = {8b 56 14 80 f1 90 01 01 88 0c 10 8a 90 90 90 01 04 8b 4e 14 80 f2 90 01 01 88 54 01 01 83 c0 02 83 f8 16 72 d9 90 00 } //2
		$a_03_3 = {8b 4e 24 ba 90 01 02 00 00 66 33 90 90 90 01 04 83 c0 02 66 89 54 08 fe 83 f8 90 01 01 72 e4 90 00 } //2
	condition:
