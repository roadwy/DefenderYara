...
rule Trojan_Win32_Raccrypt_GS_MTB{
	...
	strings :
		$a_02_0 = {88 0c 32 83 3d 90 01 04 33 90 00 } //1
...
rule Trojan_Win32_Raccrypt_GS_MTB_2{
	...
	strings :
		$a_02_0 = {6c 89 1a 60 c7 44 24 90 01 01 b8 38 69 0e c7 44 24 90 01 01 7d 00 8d 51 c7 44 24 90 01 01 d2 fb 1a 43 c7 44 24 90 01 01 2c 31 1b 28 90 00 } //1
	condition:
		((#a_02_0  & 1)*1) >=1
...
rule Trojan_Win32_Raccrypt_GS_MTB_3{
	...
	strings :
		$a_02_0 = {36 23 01 00 8b 0d 90 02 04 88 04 0f 81 3d 90 02 04 66 0c 00 00 90 00 } //1
...
rule Trojan_Win32_Raccrypt_GS_MTB_4{
	...
	strings :
		$a_02_0 = {6a 00 ff 15 90 0a 72 00 c6 05 90 01 04 61 c6 05 90 01 04 65 c6 05 90 01 04 75 c6 05 90 01 04 6c c6 05 90 01 04 69 c6 05 90 01 04 63 c6 05 90 01 04 74 c6 05 90 01 04 74 c6 05 90 01 04 72 c6 05 90 01 04 72 c3 90 00 } //1
	condition:
		((#a_02_0  & 1)*1) >=1
...
rule Trojan_Win32_Raccrypt_GS_MTB_5{
	...
	strings :
		$a_02_0 = {c7 45 f8 40 00 00 00 c6 05 90 01 04 65 c6 05 90 01 04 50 c6 05 90 01 04 00 c6 05 90 01 04 7c c6 05 90 01 04 63 c6 05 90 01 04 61 c6 05 90 01 04 74 c6 05 90 01 04 72 c6 05 90 01 04 75 90 00 } //10
...
rule Trojan_Win32_Raccrypt_GS_MTB_6{
	...
	strings :
		$a_02_0 = {55 8b ec 81 ec 90 01 04 c6 05 90 01 04 6c c6 05 90 01 04 69 c6 05 90 01 04 88 c6 05 90 01 04 79 c6 05 90 01 04 92 c6 05 90 01 04 6a 68 90 01 04 ff 15 90 01 04 a3 90 01 04 c7 85 90 00 } //10
		$a_02_1 = {b8 36 23 01 00 01 45 fc 8b 90 02 05 03 90 01 01 08 8b 90 01 01 fc 03 90 01 01 08 8a 90 01 01 88 90 01 01 8b 90 01 01 5d c2 04 00 90 00 } //2
	condition:
