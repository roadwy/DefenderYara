...
rule Trojan_Win32_Raccrypt_GC_MTB{
	...
	strings :
		$a_02_0 = {61 9b 21 1a c7 85 90 01 04 e7 d0 87 49 c7 85 90 01 04 96 3a d0 46 c7 85 90 01 04 29 5f 9d 30 c7 85 90 01 04 6b 33 00 4b 90 00 } //1
	condition:
		((#a_02_0  & 1)*1) >=1
...
rule Trojan_Win32_Raccrypt_GC_MTB_2{
	...
	strings :
		$a_02_0 = {51 ba 6c 00 00 00 6a 00 c7 05 90 01 04 6c 00 33 00 c7 05 90 01 04 6b 00 65 00 c7 05 90 01 04 6e 00 65 00 66 89 15 90 01 04 a3 90 01 04 ff 15 90 0a 58 00 2e 00 00 00 90 00 } //1
	condition:
		((#a_02_0  & 1)*1) >=1
...
rule Trojan_Win32_Raccrypt_GC_MTB_3{
	...
	strings :
		$a_02_0 = {6a 73 58 6a 6d 66 a3 90 01 04 58 6a 67 66 a3 90 01 04 58 6a 69 66 a3 90 01 04 58 6a 6c 66 a3 90 01 04 58 6a 32 66 a3 90 01 04 58 6a 6c 8b 3d 90 01 04 66 a3 90 01 04 58 6a 33 90 00 } //1
	condition:
		((#a_02_0  & 1)*1) >=1
...
rule Trojan_Win32_Raccrypt_GC_MTB_4{
	...
	strings :
		$a_02_0 = {6a 40 ff 35 90 02 14 c6 05 90 01 04 50 c6 05 90 01 04 61 c6 05 90 01 04 6f c6 05 90 01 04 75 c6 05 90 01 04 6c c6 05 90 01 04 63 c6 05 90 01 04 74 c6 05 90 01 04 74 c6 05 90 01 04 72 c6 05 90 01 04 56 c6 05 90 01 04 72 c6 05 90 01 04 69 ff 15 90 00 } //10
		$a_02_1 = {44 00 6b c6 05 90 01 04 65 c6 05 90 01 04 72 c6 05 90 01 04 2e c6 05 90 01 04 64 c6 05 90 01 04 6c 90 02 07 c6 05 90 01 04 6e c6 05 90 01 04 65 c6 05 90 01 04 6c c6 05 90 01 04 33 c6 05 90 01 04 32 c6 05 90 01 04 65 c6 05 90 01 04 74 ff 15 90 00 } //10
	condition:
...
rule Trojan_Win32_Raccrypt_GC_MTB_5{
	...
	strings :
		$a_02_0 = {3b 2d 0b 00 8b 0d 90 02 04 88 04 19 83 3d 90 02 04 44 90 00 } //1
