...
rule Trojan_Win32_Seodec_A{
	...
	strings :
		$a_01_0 = {51 51 31 30 30 33 31 37 35 } //01 00  QQ1003175
		$a_01_1 = {2e 65 78 65 00 74 69 6d 65 } //01 00 
		$a_01_2 = {2f 6e 65 77 2f 64 78 63 2e 74 78 74 } //01 00  /new/dxc.txt
		$a_01_3 = {2f 6e 65 77 2f 69 70 2e 61 73 70 } //01 00  /new/ip.asp
		$a_01_4 = {57 69 6e 48 74 74 70 2e 57 69 6e 48 74 74 70 52 65 71 75 65 73 74 2e 35 2e 31 00 47 45 54 } //01 00 
		$a_01_5 = {53 65 74 50 72 6f 78 79 00 53 65 74 50 72 6f 78 79 43 72 65 64 65 6e 74 69 61 6c 73 00 4f 70 65 6e 00 4f 70 74 69 6f 6e } //01 00  敓側潲祸匀瑥牐硯䍹敲敤瑮慩獬伀数n灏楴湯
