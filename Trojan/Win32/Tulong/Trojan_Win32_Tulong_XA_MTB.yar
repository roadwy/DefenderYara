...
rule Trojan_Win32_Tulong_XA_MTB{
	...
	strings :
		$a_01_0 = {31 32 31 2e 31 32 34 2e 31 32 34 2e 32 31 30 } //01 00 
		$a_01_1 = {5c 4d 79 52 61 74 53 65 72 76 65 72 5c 52 65 6c 65 61 73 65 5c 4d 79 52 61 74 53 65 72 76 65 72 2e 70 64 62 } //01 00 
