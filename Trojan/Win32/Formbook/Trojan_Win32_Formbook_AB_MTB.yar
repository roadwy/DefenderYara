...
rule Trojan_Win32_Formbook_AB_MTB_3{
	...
	strings :
		$a_01_0 = {71 00 68 00 6a 00 20 00 5a 00 74 00 75 00 51 00 68 00 61 00 3b 00 6a 00 64 00 66 00 6e 00 5b 00 69 00 61 00 65 00 74 00 72 00 } //01 00 
		$a_01_1 = {73 42 73 70 4b 42 73 } //01 00 
		$a_01_2 = {47 73 38 4c 48 73 7a 4a 48 73 } //01 00 
		$a_01_3 = {43 44 73 61 43 44 73 39 67 44 73 } //01 00 
		$a_01_4 = {4d 53 56 42 56 4d 36 30 2e 44 4c 4c } //01 00 
		$a_01_5 = {68 74 74 70 3a 2f 2f 6d 65 6d 62 65 72 73 2e 78 6f 6f 6d 2e 63 6f 6d 2f 64 65 76 73 66 6f 72 74 2f 69 6e 64 65 78 2e 68 74 6d 6c } //00 00 
	condition:
		any of ($a_*)
