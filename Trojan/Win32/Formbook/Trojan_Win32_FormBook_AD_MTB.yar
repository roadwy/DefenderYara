...
rule Trojan_Win32_FormBook_AD_MTB{
	...
	strings :
		$a_02_0 = {66 0f 58 c1 [0-10] 66 0f 74 c1 [0-10] 66 0f 6e e6 [0-10] 66 0f 6e e9 [0-10] 66 0f 57 ec [0-10] 66 0f 7e e9 [0-10] 39 c1 74 } //1
...
rule Trojan_Win32_FormBook_AD_MTB_2{
	...
	strings :
		...
		$a_02_1 = {55 8b ec 83 ec 20 a1 ?? ?? ?? ?? 33 c5 89 45 fc a1 ?? ?? ?? ?? 53 56 57 a8 01 75 17 83 c8 01 6a 0c } //10
	condition:
