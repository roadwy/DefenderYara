...
rule Trojan_Win32_Formbook_PB_MTB{
	...
	strings :
		$a_02_0 = {8b 4d f8 8b 45 fc 6a 00 81 c1 00 80 c1 2a 68 80 96 98 00 15 21 4e 62 fe 50 51 e8 90 01 02 00 00 83 fa 07 7c 90 01 01 7f 90 01 01 3d ff 6f 40 93 76 90 01 01 83 c8 ff 8b d0 8b 4d 08 85 c9 74 90 00 } //1
