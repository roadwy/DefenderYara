...
rule Trojan_Win32_FormBook_AP_MTB_2{
	...
	strings :
		$a_02_0 = {66 0f 58 c1 90 02 10 66 0f 74 c1 90 02 10 66 0f 6e e6 90 02 10 66 0f 6e e9 90 02 10 0f 57 ec 90 02 10 66 0f 7e e9 90 02 10 39 c1 90 02 25 90 13 0f 77 90 02 10 46 90 02 15 8b 0f 90 00 } //1
	condition:
		((#a_02_0  & 1)*1) >=1
