...
rule Trojan_Win32_Formbook_MG_MTB{
	...
	strings :
		$a_01_0 = {48 6b 63 6f 65 64 63 6c 78 66 6b 63 6b 64 6c } //02 00  Hkcoedclxfkckdl
		...
		$a_01_3 = {53 6c 65 65 70 } //02 00  Sleep
		$a_01_4 = {47 65 74 54 65 6d 70 50 61 74 68 41 } //00 00  GetTempPathA
	condition:
		any of ($a_*)
