...
rule Trojan_Win32_Formbook_MG_MTB{
	...
	strings :
		...
		$a_03_1 = {83 c1 01 89 90 02 06 8b 90 02 06 3b 90 02 06 0f 83 90 02 05 8b 45 90 01 01 03 90 02 06 8a 08 88 90 02 06 0f b6 90 02 40 f7 d2 88 90 02 06 0f b6 90 00 } //2
