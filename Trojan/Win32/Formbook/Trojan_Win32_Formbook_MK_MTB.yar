...
rule Trojan_Win32_Formbook_MK_MTB_3{
	...
	strings :
		$a_81_0 = {52 69 6e 4b 65 72 79 67 6d 61 } //01 00  RinKerygma
		$a_81_1 = {44 72 61 77 49 6e 63 69 73 75 72 65 36 34 } //01 00  DrawIncisure64
		$a_81_2 = {44 69 73 61 62 6c 65 41 78 69 6c } //01 00  DisableAxil
		$a_81_3 = {54 6f 47 61 6e 67 77 61 79 } //01 00  ToGangway
		$a_81_4 = {52 65 6a 65 63 74 53 65 6c 65 6e 69 75 6d 2e 64 6c 6c } //00 00  RejectSelenium.dll
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Formbook_MK_MTB_6{
	...
	strings :
		$a_00_0 = {44 00 72 00 61 00 77 00 54 00 69 00 74 00 6d 00 6f 00 75 00 73 00 65 00 } //01 00  DrawTitmouse
		$a_00_1 = {53 00 74 00 61 00 72 00 74 00 50 00 61 00 73 00 74 00 65 00 6c 00 } //01 00  StartPastel
		$a_01_2 = {47 61 6c 6c 69 77 61 73 70 } //01 00  Galliwasp
		$a_00_3 = {46 00 69 00 6e 00 64 00 4f 00 6c 00 69 00 67 00 61 00 72 00 63 00 68 00 36 00 34 00 } //01 00  FindOligarch64
		$a_00_4 = {4c 00 65 00 61 00 64 00 42 00 6f 00 6e 00 67 00 6f 00 33 00 32 00 } //01 00  LeadBongo32
		$a_01_5 = {5f 4c 6f 73 65 46 72 69 74 68 73 74 6f 6f 6c 2e 64 6c 6c } //00 00  _LoseFrithstool.dll
	condition:
		any of ($a_*)
