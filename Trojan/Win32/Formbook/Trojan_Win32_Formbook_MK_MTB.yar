...
rule Trojan_Win32_Formbook_MK_MTB{
	...
	strings :
		$a_03_0 = {c7 45 f4 7a 23 00 00 0f bf 15 90 01 04 83 f2 90 01 01 0f bf 05 90 01 04 3b d0 90 13 c7 45 f8 90 01 04 8b 0d 90 01 04 81 f1 90 01 04 39 0d 90 01 04 7f 07 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_Win32_Formbook_MK_MTB_2{
	...
	strings :
		...
		$a_03_1 = {6a 40 68 00 30 00 00 50 57 89 45 f0 ff 15 90 01 04 57 8b d8 8d 45 d4 50 ff 75 f0 53 56 ff 15 90 00 } //10
	condition:
...
rule Trojan_Win32_Formbook_MK_MTB_5{
	...
	strings :
		$a_03_0 = {c1 cf 10 c1 cb 90 01 01 33 fb 8b da 81 e3 90 01 04 0f b6 1c 9d 90 01 04 8b 1c 9d 90 01 04 c1 ea 90 01 01 0f b6 14 95 90 1b 02 c1 c3 90 1b 00 33 fb 33 3c 95 90 1b 03 89 79 90 01 01 4e 0f 85 90 00 } //1
		$a_03_1 = {33 cf 81 e2 90 01 04 33 ca 33 48 90 01 01 89 48 90 01 01 8b 50 90 01 01 33 d1 8b 48 90 01 01 33 ca 89 50 90 01 01 8b 50 90 01 01 33 d1 89 48 90 01 01 89 50 90 01 01 83 c6 90 01 01 83 c0 90 1b 08 83 fe 90 01 01 0f 8c 90 00 } //1
	condition:
