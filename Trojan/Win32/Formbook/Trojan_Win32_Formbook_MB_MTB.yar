...
rule Trojan_Win32_Formbook_MB_MTB{
	...
	strings :
		$a_81_0 = {57 41 5f 56 4d 53 49 42 } //03 00 
		$a_81_1 = {66 62 63 72 65 61 74 65 75 73 65 72 } //03 00 
		$a_81_2 = {54 5f 5f 32 33 65 33 31 63 30 55 } //03 00 
		$a_81_3 = {62 61 73 65 36 34 42 69 6e 61 72 79 } //03 00 
		$a_81_4 = {53 79 73 44 61 74 65 54 69 6d 65 50 69 63 6b 33 32 } //03 00 
		$a_81_5 = {47 65 74 4d 6f 6e 69 74 6f 72 49 6e 66 6f 41 } //03 00 
...
rule Trojan_Win32_Formbook_MB_MTB_2{
	...
	strings :
		$a_81_0 = {42 75 73 79 62 6f 64 79 } //01 00 
		$a_81_1 = {43 68 61 6e 67 65 4d 61 64 72 65 70 6f 72 69 74 65 } //01 00 
		$a_81_2 = {54 6f 43 61 72 74 75 6c 61 72 79 } //01 00 
		$a_81_3 = {46 65 65 6c 44 69 6f 73 67 65 6e 69 6e 33 32 } //01 00 
		$a_81_4 = {55 6e 6c 6f 63 6b 42 61 64 64 65 6c 65 79 69 74 65 36 34 } //01 00 
		$a_81_5 = {53 68 6f 77 53 70 72 65 63 68 67 65 73 61 6e 67 } //01 00 
		$a_81_6 = {5f 50 61 79 54 65 6c 65 67 6f 6e 79 } //01 00 
		$a_81_7 = {43 68 6f 6f 73 65 4d 6f 6e 74 61 67 65 33 32 2e 64 6c 6c } //00 00 
...
rule Trojan_Win32_Formbook_MB_MTB_3{
	...
	strings :
		...
		$a_01_3 = {53 48 45 6d 70 74 79 52 65 63 79 63 6c 65 42 69 6e 57 } //01 00 
		$a_01_4 = {49 73 44 65 62 75 67 67 65 72 50 72 65 73 65 6e 74 } //01 00 
		$a_01_5 = {53 6c 65 65 70 } //01 00 
		$a_01_6 = {43 72 65 61 74 65 54 68 72 65 61 64 70 6f 6f 6c 54 69 6d 65 72 } //00 00 
	condition:
		any of ($a_*)
