...
rule Trojan_Win32_Kradod_A{
	...
	strings :
		...
		$a_00_2 = {73 76 63 68 6f 73 74 2e 65 78 65 20 2d 6b 20 6e 65 74 73 76 63 73 } //01 00 
		$a_00_3 = {39 42 33 34 35 43 44 37 2d 42 30 30 36 2d 34 62 33 61 2d 41 46 43 36 2d 39 41 36 31 43 35 34 39 31 42 43 41 } //00 00 
	condition:
		any of ($a_*)
