...
rule Trojan_Win32_Grandoreiro_F{
	...
	strings :
		...
		$a_00_1 = {44 45 4c 45 54 41 4b 4c } //0a 00  DELETAKL
		$a_00_2 = {41 54 49 56 41 52 43 41 50 54 55 52 41 4d 41 47 } //0a 00  ATIVARCAPTURAMAG
		$a_00_3 = {52 65 69 6e 31 63 31 61 53 79 73 74 65 6d } //0a 00  Rein1c1aSystem
		$a_00_4 = {42 4c 4f 51 55 45 52 41 43 45 53 53 4f 42 41 4e 4b 49 4e 54 45 52 } //00 00  BLOQUERACESSOBANKINTER
