...
rule Trojan_Win32_CryptInject_HB_MTB{
	...
	strings :
		$a_03_0 = {48 63 c2 48 69 c0 ?? ?? ?? ?? 48 c1 e8 20 89 c1 c1 f9 03 89 d0 c1 f8 1f 29 c1 89 c8 c1 e0 05 01 c8 89 d1 29 c1 48 8b 55 b8 8b 45 f8 48 98 48 01 d0 89 ca 88 10 83 45 f8 01 8b 45 f8 48 98 48 3b 45 d8 72 } //10
