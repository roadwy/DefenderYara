...
rule Trojan_Win32_CryptInject_CD_MTB_2{
	...
	strings :
		...
		$a_02_1 = {81 fe 01 3f 14 22 7c cd a1 90 01 04 8b f7 05 3b 2d 0b 00 a3 90 01 04 81 fe 89 62 65 00 75 10 68 90 01 04 ff 15 90 01 04 a3 90 01 04 46 81 fe 56 d0 66 00 90 00 } //1
	condition:
