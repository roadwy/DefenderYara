...
rule Trojan_Win32_CryptInject_SBR_MSR_4{
	...
	strings :
		...
		$a_02_7 = {43 3a 5c 54 45 4d 50 5c 90 02 10 2e 69 6e 69 90 00 } //1
...
rule Trojan_Win32_CryptInject_SBR_MSR_5{
	...
	strings :
		$a_03_0 = {68 74 74 70 3a 2f 2f 64 6f 77 6e 2e 90 02 30 3a 38 38 38 38 2f 6f 6b 2e 74 78 74 90 00 } //2
		$a_02_1 = {68 00 74 00 74 00 70 00 3a 00 2f 00 2f 00 77 00 6d 00 69 00 2e 00 90 02 30 3a 00 38 00 38 00 38 00 38 00 2f 00 6b 00 69 00 6c 00 6c 00 2e 00 68 00 74 00 6d 00 6c 00 90 00 } //2
