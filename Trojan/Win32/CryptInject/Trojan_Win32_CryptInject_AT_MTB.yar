...
rule Trojan_Win32_CryptInject_AT_MTB{
	...
	strings :
		...
		$a_02_4 = {88 44 24 4f 8b 44 24 30 8b 4c 24 08 8a 1c 08 8b 44 24 28 32 1c 10 8b 54 24 2c 88 1c 0a 83 c1 01 8b 44 24 34 39 c1 8b 44 24 04 89 4c 24 1c 89 44 24 20 89 7c 24 24 0f 84 ?? ff ff ff e9 ?? ff ff ff } //1
		$a_02_5 = {0f b6 c9 8b 74 24 34 8b 7c 24 14 89 0c 24 8a 0c 3e 8b 34 24 01 de 81 e6 ff 00 00 00 8b 5c 24 2c 32 0c 33 8b 74 24 30 88 0c 3e 83 c7 01 8b 4c 24 38 39 cf 8b 4c 24 08 89 4c 24 1c 89 54 24 18 89 7c 24 20 0f 84 ?? ff ff ff e9 ?? ff ff ff } //1
	condition:
