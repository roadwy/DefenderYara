...
rule Trojan_Win32_CryptInject_BJ_MTB{
	...
	strings :
		$a_02_0 = {81 fb 70 0a 00 00 75 90 01 01 56 56 56 56 ff 15 90 01 04 56 56 56 56 56 56 ff 15 90 01 04 56 8d 85 18 fb ff ff 50 ff 15 90 01 04 e8 90 01 04 8b 8d 14 fb ff ff 30 04 39 81 fb 9b 0a 00 00 75 90 00 } //1
	condition:
		((#a_02_0  & 1)*1) >=1
