...
rule Trojan_Win32_CryptInject_BJ_MTB_2{
	...
	strings :
		$a_01_0 = {50 51 52 56 57 39 } //01 00 
		$a_01_1 = {50 51 52 56 57 3d 77 } //01 00 
		$a_01_2 = {50 51 52 56 57 3b 4d } //01 00 
		$a_01_3 = {50 51 52 56 57 3b 45 } //01 00 
		$a_01_4 = {50 51 52 56 57 3b 75 } //01 00 
		$a_01_5 = {77 69 6e 73 70 6f 6f 6c 2e 64 72 76 } //00 00 
	condition:
		any of ($a_*)
