...
rule Trojan_Win32_CryptInject_AK_MTB{
	...
	strings :
		$a_02_0 = {8b 55 08 03 55 f0 0f b6 02 8b 4d fc 03 4d ec 0f b6 d1 0f b6 8c 15 e8 fe ff ff 33 c1 8b 55 08 03 55 f0 88 02 e9 ?? ff ff ff 8b e5 5d c3 } //1
		$a_02_1 = {8b 55 08 03 55 f0 0f b6 02 8b 4d fc 03 4d ec 0f b6 d1 0f b6 8c 15 ?? ?? ff ff 33 c1 8b 55 08 03 55 f0 88 02 e9 ?? ff ff ff 8b 4d e4 33 cd e8 ?? ?? ?? 00 8b e5 5d c3 } //1
		...
		$a_02_3 = {43 00 3a 00 5c 00 50 00 72 00 6f 00 67 00 72 00 61 00 6d 00 44 00 61 00 74 00 61 00 5c 00 [0-30] 2e 00 65 00 78 00 65 00 } //1
