...
rule Trojan_Win32_CryptInject_DS_MTB{
	...
	strings :
		$a_03_0 = {01 45 fc 8b 45 fc 8a 04 38 8b 0d 90 02 04 88 04 0f 83 3d 90 02 04 44 75 0f 90 00 } //2
		$a_03_1 = {81 ff 0e 77 00 00 75 05 e8 90 02 04 47 81 ff 7d b9 86 02 7c e3 90 00 } //2
