...
rule Trojan_Win32_CryptInject_DJ_MTB{
	...
	strings :
		...
		$a_01_1 = {6d 73 6f 63 78 75 73 79 73 2e 64 6c 6c } //01 00  msocxusys.dll
		$a_01_2 = {73 6e 78 61 70 69 2e 65 78 65 } //01 00  snxapi.exe
		$a_01_3 = {45 6e 63 72 79 70 74 } //01 00  Encrypt
		$a_01_4 = {73 67 76 72 66 79 33 32 2e 65 78 65 } //00 00  sgvrfy32.exe
	condition:
		any of ($a_*)
