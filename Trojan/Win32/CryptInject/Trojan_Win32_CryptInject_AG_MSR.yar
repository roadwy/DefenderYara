...
rule Trojan_Win32_CryptInject_AG_MSR{
	...
	strings :
		$a_01_0 = {53 74 61 72 74 57 } //01 00 
		$a_01_1 = {55 70 64 61 74 65 57 } //01 00 
		...
		$a_01_4 = {44 6f 77 6e 6c 6f 61 64 2e 64 6c 6c } //01 00 
		$a_01_5 = {57 69 6e 48 74 74 70 43 6f 6e 6e 65 63 74 } //01 00 
