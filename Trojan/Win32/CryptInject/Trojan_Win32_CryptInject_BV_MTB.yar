...
rule Trojan_Win32_CryptInject_BV_MTB{
	...
	strings :
		$a_03_0 = {8b 4d e4 33 4d f0 89 4d e4 8b 55 e4 33 55 ec 89 55 e4 8b 45 d0 2b 45 e4 89 45 d0 8b 45 d8 29 45 e8 e9 ?? ff ff ff 8b 4d 08 8b 55 d0 89 11 8b 45 08 8b 4d f4 89 48 04 8b e5 5d c2 08 00 } //1
