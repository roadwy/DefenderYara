...
rule Trojan_Win32_CryptInject_PACG_MTB{
	meta:
		description = "Trojan:Win32/CryptInject.PACG!MTB,SIGNATURE_TYPE_PEHSTR_EXT,05 00 05 00 05 00 00 "
		
	strings :
		$a_01_0 = {74 61 73 6b 6b 69 6c 6c 20 2f 66 20 2f 69 6d 20 74 61 73 6b 6d 67 72 2e 65 78 65 } //1 taskkill /f /im taskmgr.exe
		...
		$a_01_2 = {5b 2b 5d 20 43 48 41 4e 47 49 4e 47 20 57 41 4c 4c 50 41 50 45 52 } //1 [+] CHANGING WALLPAPER
		$a_01_3 = {6d 61 6c 64 65 76 2e 70 64 62 } //1 maldev.pdb
		$a_01_4 = {53 00 4f 00 46 00 54 00 57 00 41 00 52 00 45 00 5c 00 4d 00 69 00 63 00 72 00 6f 00 73 00 6f 00 66 00 74 00 5c 00 57 00 69 00 6e 00 64 00 6f 00 77 00 73 00 5c 00 41 00 73 00 73 00 69 00 67 00 6e 00 65 00 64 00 41 00 63 00 63 00 65 00 73 00 73 00 43 00 6f 00 6e 00 66 00 69 00 67 00 75 00 72 00 61 00 74 00 69 00 6f 00 6e 00 } //1 SOFTWARE\Microsoft\Windows\AssignedAccessConfiguration
	condition:
