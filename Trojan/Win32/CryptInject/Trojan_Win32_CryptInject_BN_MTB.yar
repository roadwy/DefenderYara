...
rule Trojan_Win32_CryptInject_BN_MTB{
	...
	strings :
		$a_02_0 = {88 44 04 08 40 3d 90 01 02 00 00 72 f4 90 00 } //1
		$a_02_1 = {0f b6 44 34 14 0f b6 d3 03 c2 99 b9 90 01 02 00 00 f7 f9 45 0f b6 54 14 14 30 55 ff 83 bc 24 50 0c 00 00 00 75 90 00 } //1
