...
rule Trojan_Win32_CryptInject_BH_MTB_2{
	...
	strings :
		$a_01_0 = {59 6f 75 20 61 72 65 20 66 75 63 6b 69 6e 67 20 41 56 20 76 65 6e 64 6f 72 73 21 } //01 00 
		$a_01_1 = {6b 69 63 6b 69 6e 67 20 67 75 79 73 } //01 00 
		$a_01_2 = {59 6f 75 20 61 72 65 20 6d 79 20 73 75 6e 73 68 69 6e 65 } //00 00 
	condition:
		any of ($a_*)
