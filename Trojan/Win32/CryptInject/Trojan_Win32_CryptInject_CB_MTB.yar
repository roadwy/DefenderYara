...
rule Trojan_Win32_CryptInject_CB_MTB{
	...
	strings :
		$a_02_0 = {81 fb 69 04 00 00 75 17 56 ff 15 90 01 04 56 56 56 ff 15 90 01 04 56 ff 15 90 01 04 e8 90 01 04 8b 8d 90 01 04 30 04 39 90 00 } //1
		$a_02_1 = {05 f5 d0 00 00 a3 90 01 04 33 ff 3d f5 0b 00 00 75 0e 8d 45 90 01 01 50 56 56 56 ff d3 a1 90 01 04 81 ff aa c2 5f 00 75 90 00 } //1
	condition:
