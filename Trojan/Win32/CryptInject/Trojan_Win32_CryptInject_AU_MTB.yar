...
rule Trojan_Win32_CryptInject_AU_MTB{
	...
	strings :
		...
		$a_02_1 = {55 8b ec 83 ec 08 56 8b 15 90 01 04 ff 35 90 01 04 8f 45 f8 8b 75 f8 33 f2 8b d6 8b ca b8 90 01 04 03 c1 2d 90 01 04 89 45 fc a1 90 01 04 8b 4d fc 89 08 5e 8b e5 5d c3 90 00 } //1
