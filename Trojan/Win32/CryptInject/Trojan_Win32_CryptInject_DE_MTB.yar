...
rule Trojan_Win32_CryptInject_DE_MTB{
	...
	strings :
		$a_01_0 = {0f b6 c8 33 4d fc 89 4d fc 8b 55 08 83 c2 01 89 55 08 c7 45 f8 00 00 00 00 eb 09 } //2
...
rule Trojan_Win32_CryptInject_DE_MTB_2{
	...
	strings :
		$a_01_0 = {8a 8b f8 32 40 00 8a c1 0a cc 22 c4 f6 d0 22 c1 43 8a e0 88 24 3e 83 fb 04 72 e5 } //1
	condition:
		((#a_01_0  & 1)*1) >=1
