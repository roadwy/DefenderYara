...
rule Trojan_Win32_CryptInject_CV_MTB{
	...
	strings :
		$a_01_0 = {51 6d 68 68 64 6e 6c 68 55 32 39 6d 64 48 64 68 63 6d 56 7a 5c 6e 6f 64 65 5c 6e 6f 64 65 2e 65 78 65 } //01 00 
		$a_01_1 = {51 6d 68 68 64 6e 6c 68 55 32 39 6d 64 48 64 68 63 6d 56 7a 5c 73 65 72 76 65 72 2e 6a 73 } //01 00 
