...
rule Trojan_Win32_CryptInject_BE_MTB{
	...
	strings :
		$a_02_0 = {c8 0b 98 7f b8 c6 ee 57 15 81 45 90 01 01 be 6c 90 01 01 28 81 e3 15 2d 0d 0f 81 6d 90 01 01 36 18 c4 05 81 f3 26 ed 5f 56 81 45 90 01 01 40 b7 cb 5c 8b 5d 90 01 01 8b 45 90 01 01 33 d6 2b 4d 90 01 01 40 2b fa 89 4d 90 01 01 89 45 90 01 01 3b 45 90 01 01 0f 90 00 } //1
	condition:
		((#a_02_0  & 1)*1) >=1
...
rule Trojan_Win32_CryptInject_BE_MTB_2{
	...
	strings :
		$a_02_0 = {41 50 50 44 41 54 41 90 02 20 25 73 5c 62 6f 78 90 00 } //1
		$a_02_1 = {53 6f 66 74 77 61 72 65 5c 4d 69 63 72 6f 73 6f 66 74 5c 57 69 6e 64 6f 77 73 20 4e 54 5c 43 75 72 72 65 6e 74 56 65 72 73 69 6f 6e 5c 57 69 6e 64 6f 77 73 90 02 50 41 70 70 49 6e 69 74 5f 44 4c 4c 73 90 02 20 25 73 5c 62 6f 78 2e 6c 6e 6b 90 00 } //1
		$a_02_2 = {6c 61 75 6e 63 68 90 02 20 50 72 6f 67 72 61 6d 46 69 6c 65 73 90 02 20 64 72 6f 70 90 02 20 44 4c 4c 90 00 } //1
	condition:
