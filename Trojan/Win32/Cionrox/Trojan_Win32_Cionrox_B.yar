...
rule Trojan_Win32_Cionrox_B{
	...
	strings :
		...
		$a_00_2 = {2f 2f 69 6e 66 65 63 2e 70 68 70 } //01 00  //infec.php
		$a_00_3 = {75 73 65 72 5f 70 72 65 66 28 22 6e 65 74 77 6f 72 6b 2e 70 72 6f 78 79 2e 61 75 74 6f 63 6f 6e 66 69 67 5f 75 72 6c 22 2c 20 22 68 74 74 70 3a 2f 2f } //00 00  user_pref("network.proxy.autoconfig_url", "http://
	condition:
		any of ($a_*)
