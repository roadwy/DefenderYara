...
rule Trojan_Win32_TrickInj_B_MTB{
	...
	strings :
		$a_81_0 = {5b 49 4e 49 54 5d 20 42 43 20 3d 20 25 75 } //01 00  [INIT] BC = %u
		$a_81_1 = {23 70 67 69 64 23 } //01 00  #pgid#
		$a_81_2 = {69 6e 6a 5f 33 32 2e 64 6c 6c } //01 00  inj_32.dll
		$a_81_3 = {23 67 69 64 23 } //01 00  #gid#
		$a_03_4 = {23 69 64 23 90 02 2f 51 43 6f 6e 6e 65 63 74 69 6f 6e 90 00 } //01 00 
		$a_81_5 = {4e 74 57 72 69 74 65 56 69 72 74 75 61 6c 4d 65 6d 6f 72 79 } //01 00  NtWriteVirtualMemory
