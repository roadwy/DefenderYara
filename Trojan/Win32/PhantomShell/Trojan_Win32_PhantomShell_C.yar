...
rule Trojan_Win32_PhantomShell_C{
	...
	strings :
		...
		$a_02_1 = {5c 00 77 00 69 00 6e 00 64 00 6f 00 77 00 73 00 5c 00 74 00 65 00 6d 00 70 00 5c 00 90 02 ff 2e 00 63 00 6d 00 64 00 6c 00 69 00 6e 00 65 00 90 00 } //10
	condition:
