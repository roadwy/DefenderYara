...
rule Trojan_Win32_Meralifea_A_4{
	...
	strings :
		$a_03_0 = {8d 45 f8 6a 04 50 89 5d dc 89 5d e0 89 5d e4 ff 55 e8 85 c0 0f 84 90 01 02 00 00 c7 45 fc 01 00 00 00 83 c6 3a 6a 3a 90 00 } //1
		$a_03_1 = {83 7d fc 04 72 81 39 5d f8 0f 84 ea 00 00 00 53 53 53 6a 04 ff 75 f8 ff 15 90 01 04 8b f0 3b f3 0f 84 a8 00 00 00 81 3e 54 41 64 70 0f 85 95 00 00 00 8b 46 18 6a 40 05 00 04 00 00 68 00 10 00 00 90 00 } //1
...
rule Trojan_Win32_Meralifea_A_5{
	...
	strings :
		$a_03_0 = {8b f0 59 3b f3 89 75 f8 0f 84 90 01 02 00 00 8d 45 f0 53 50 ff 75 f0 56 ff 75 f4 ff 15 90 01 04 85 c0 0f 84 90 01 02 00 00 66 81 3e 4d 5a 90 00 } //1
		$a_03_1 = {81 7c 24 04 fe ca 00 00 75 12 8b 44 24 14 85 c0 74 0a c7 00 90 01 04 33 c0 eb 05 b8 02 00 00 c0 c2 18 00 90 00 } //1
		$a_03_2 = {6a 10 ff 75 10 8d 45 0c 6a 04 50 68 2c 00 22 00 ff 75 08 ff 15 90 01 04 f7 d8 1b c0 5b 25 90 01 04 05 90 00 } //2
		...
		$a_03_5 = {80 3b e8 75 90 01 01 8b 35 90 01 04 8d 4d 08 51 8d 43 01 6a 40 6a 04 50 89 45 90 01 01 ff d6 90 00 } //1
...
rule Trojan_Win32_Meralifea_A_6{
	...
	strings :
		...
		$a_03_3 = {81 7c 24 08 38 01 00 00 53 76 90 01 01 ff 74 24 08 e8 90 01 02 ff ff 85 c0 74 90 01 01 33 db 66 81 78 18 0b 01 75 90 00 } //1
		$a_01_4 = {68 4b 41 50 43 } //1 hKAPC
		$a_01_5 = {68 fe ca 00 00 6a 54 56 ff 15 } //1
		$a_03_6 = {8a 0b 80 f9 e9 74 0e 80 f9 e8 74 09 03 f8 03 d8 83 ff 05 72 90 01 01 83 ff 05 72 90 01 01 8b 5d 10 33 c9 8b c3 80 38 e9 90 00 } //2
		$a_01_7 = {80 3b e8 75 07 8b 4b 01 8d 7c 19 05 85 ff 74 03 ff 45 fc 83 f8 03 75 07 66 81 3b c2 1c } //2
		$a_03_8 = {66 81 3e ff 15 75 06 8b 4e 02 89 4d fc 83 7d fc 00 0f 84 90 01 02 00 00 ff 45 10 83 7d 10 14 73 90 01 01 83 f8 06 75 90 01 01 66 81 3e c7 01 90 00 } //2
...
rule Trojan_Win32_Meralifea_A_7{
	...
	strings :
		$a_03_0 = {68 30 00 22 00 ff 33 ff 15 90 01 04 85 c0 74 90 01 01 ff 75 90 01 01 ff 15 90 01 04 68 10 27 00 00 ff 75 90 01 01 ff 15 90 01 04 85 c0 75 1d 8d 45 0c 50 ff 75 90 01 01 ff 15 90 01 04 81 7d 0c dd cc bb aa 90 00 } //2
		$a_03_1 = {68 00 00 07 00 50 c7 46 1c 00 00 10 00 ff d7 85 c0 74 06 8b 45 90 01 01 89 46 24 8d 45 fc 53 50 8d 45 f4 6a 08 50 53 53 68 5c 40 07 00 ff 36 ff d7 90 00 } //2
		$a_01_2 = {68 20 00 22 00 ff 36 ff d7 85 c0 75 03 89 5d f8 81 7d f8 be ba fe ca } //2
		$a_03_3 = {68 00 20 49 82 53 89 7d fc ff 15 90 01 04 85 c0 74 0f 33 c0 81 7d fc 46 55 53 45 90 00 } //3
		$a_03_4 = {8b 45 10 8b 4e 24 8b 40 08 03 85 90 01 02 ff ff f7 e1 66 81 bd 90 01 02 ff ff 55 aa 89 45 f0 89 55 f4 75 90 00 } //2
		$a_01_5 = {81 c7 00 00 20 00 83 d2 00 3b d0 77 24 72 04 3b f9 77 1e 8b 7d 10 81 e9 00 00 10 00 } //1
		$a_03_6 = {66 81 b8 fe 01 00 00 55 aa 75 74 32 c9 33 d2 05 ca 01 00 00 83 78 fc 00 74 12 83 38 00 74 0d 8a 48 f8 46 42 83 c0 10 83 fa 04 72 90 01 01 83 fe 01 75 90 01 01 80 f9 ee 90 00 } //3
		$a_03_7 = {ff 50 04 8b f0 83 c4 10 85 f6 74 90 01 01 8b 46 04 53 8d 0c 40 8d 0c 8d 08 00 00 00 3b 4d 08 73 90 01 01 66 81 3e 38 9a 90 00 } //2
		$a_03_8 = {8b 75 08 57 80 7e 21 be 0f 85 90 01 02 00 00 80 7e 02 08 0f 85 fb 00 00 00 66 81 7e 06 00 04 0f 83 ef 00 00 00 8b 7d 0c 83 ff 2d 90 00 } //2
