...
rule Trojan_Win32_SharPyShell_STE{
	...
	strings :
		...
		$a_02_2 = {53 00 68 00 61 00 72 00 50 00 79 00 90 02 0a 6d 00 73 00 63 00 6f 00 72 00 6c 00 69 00 62 00 90 00 } //1
		$a_02_3 = {53 68 61 72 50 79 90 02 0a 6d 73 63 6f 72 6c 69 62 90 00 } //1
