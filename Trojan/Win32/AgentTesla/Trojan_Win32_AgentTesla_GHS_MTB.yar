...
rule Trojan_Win32_AgentTesla_GHS_MTB{
	...
	strings :
		...
		$a_01_2 = {63 6d 64 2e 65 78 65 20 2f 64 20 2f 63 20 62 64 76 69 70 61 70 66 78 6e 73 2e 62 61 74 } //1 cmd.exe /d /c bdvipapfxns.bat
		...
		$a_01_4 = {53 6f 66 74 77 61 72 65 5c 4d 69 63 72 6f 73 6f 66 74 5c 57 69 6e 64 6f 77 73 5c 43 75 72 72 65 6e 74 56 65 72 73 69 6f 6e 5c 41 70 70 20 50 61 74 68 73 } //1 Software\Microsoft\Windows\CurrentVersion\App Paths
