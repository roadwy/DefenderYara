...
rule Trojan_Win32_AgentTesla_A_MTB_2{
	...
	strings :
		...
		$a_01_1 = {2e 76 6d 5f 73 65 63 } //01 00  .vm_sec
		$a_01_2 = {2e 74 68 65 6d 69 64 61 } //01 00  .themida
		$a_01_3 = {43 00 68 00 6f 00 2d 00 43 00 68 00 75 00 6e 00 20 00 48 00 75 00 61 00 6e 00 67 00 } //01 00  Cho-Chun Huang
		$a_01_4 = {2f 63 68 65 63 6b 70 72 6f 74 65 63 74 69 6f 6e } //01 00  /checkprotection
		$a_01_5 = {65 00 2d 00 43 00 68 00 69 00 6e 00 61 00 20 00 50 00 65 00 74 00 72 00 6f 00 6c 00 65 00 75 00 6d 00 20 00 26 00 20 00 43 00 68 00 65 00 6d 00 69 00 63 00 61 00 6c 00 20 00 43 00 6f 00 72 00 70 00 } //00 00  e-China Petroleum & Chemical Corp
	condition:
		any of ($a_*)
