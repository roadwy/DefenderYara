...
rule Trojan_Win32_AgentTesla_A_MTB{
	...
	strings :
		$a_02_0 = {64 ff 30 64 89 20 ff 05 90 01 03 00 75 90 01 01 83 3d 90 01 03 00 00 74 0a a1 90 01 03 00 e8 90 00 } //1
		$a_02_1 = {8b c7 8b de 8b d3 90 05 10 01 90 e8 90 01 04 90 05 10 01 90 46 90 05 10 01 90 81 fe 90 01 02 00 00 75 90 00 } //1
		$a_02_2 = {8b c8 03 ca 8b c2 b2 90 01 01 32 90 90 90 01 03 00 88 11 c3 90 00 } //1
	condition:
