...
rule Trojan_Win32_AgentTesla_CD_MTB{
	...
	strings :
		...
		$a_01_2 = {73 74 61 72 74 20 52 69 63 6f 6e 6f 62 62 65 2e 65 78 65 2e 63 6f 6d } //01 00 
		$a_01_3 = {44 65 63 72 79 70 74 46 69 6c 65 41 } //01 00 
		$a_01_4 = {53 6f 66 74 77 61 72 65 5c 4d 69 63 72 6f 73 6f 66 74 5c 57 69 6e 64 6f 77 73 5c 43 75 72 72 65 6e 74 56 65 72 73 69 6f 6e 5c 52 75 6e 4f 6e 63 65 } //00 00 
	condition:
		any of ($a_*)
