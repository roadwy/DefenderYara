...
rule Trojan_Win32_AgentTesla_RS_MTB{
	...
	strings :
		$a_02_0 = {50 58 50 58 90 02 05 51 59 90 02 05 90 90 90 05 10 01 90 90 02 05 90 90 90 05 10 01 90 51 59 90 90 90 05 10 01 90 81 34 08 bf 15 cf e4 90 02 06 50 58 90 00 } //1
