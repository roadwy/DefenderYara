...
rule Trojan_Win32_AgentTesla_EVX_MTB{
	...
	strings :
		$a_03_0 = {6a 00 ff 15 90 01 04 6a 00 ff 15 90 01 04 6a 00 ff 15 90 01 04 6a 00 ff 15 90 01 04 6a 00 ff 15 90 01 04 6a 00 ff 15 90 01 04 6a 00 ff 15 90 01 04 68 90 01 04 68 90 01 04 ff 15 90 00 } //1
