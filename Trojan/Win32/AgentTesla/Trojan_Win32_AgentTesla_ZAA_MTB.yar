...
rule Trojan_Win32_AgentTesla_ZAA_MTB{
	...
	strings :
		$a_03_0 = {0f b6 75 e7 c1 fe 90 02 01 0f b6 7d e7 c1 e7 90 02 01 89 90 02 01 09 90 02 01 88 90 02 01 e7 0f b6 75 e7 89 90 02 01 83 90 02 02 88 90 02 01 e7 0f b6 75 e7 90 00 } //1
