...
rule Trojan_Win32_AgentTesla_RPX_MTB_3{
	...
	strings :
		$a_01_0 = {38 00 30 00 2e 00 36 00 36 00 2e 00 37 00 35 00 2e 00 33 00 36 00 } //01 00  80.66.75.36
		$a_01_1 = {61 00 73 00 2d 00 57 00 76 00 75 00 6e 00 6f 00 73 00 63 00 6b 00 65 00 2e 00 64 00 61 00 74 00 } //01 00  as-Wvunoscke.dat
		$a_01_2 = {45 6e 61 62 6c 65 41 63 63 6f 75 6e 74 } //01 00  EnableAccount
		$a_01_3 = {57 65 62 52 65 71 75 65 73 74 } //01 00  WebRequest
		$a_01_4 = {53 6c 65 65 70 } //01 00  Sleep
		$a_01_5 = {52 61 74 65 41 63 63 6f 75 6e 74 } //01 00  RateAccount
		$a_01_6 = {46 72 6f 6d 42 61 73 65 36 34 53 74 72 69 6e 67 } //01 00  FromBase64String
		$a_01_7 = {52 65 76 65 72 73 65 } //01 00  Reverse
		$a_01_8 = {48 74 74 70 57 65 62 52 65 71 75 65 73 74 } //01 00  HttpWebRequest
