...
rule Trojan_Win32_Swotter_BB_MTB{
	...
	strings :
		$a_02_0 = {25 25 5c 72 75 6e 64 6c 6c 33 32 2e 65 78 65 20 90 05 15 03 61 2d 7a 2c 50 72 65 74 6f 72 90 00 } //1
		$a_02_1 = {25 25 5c 72 75 6e 64 6c 6c 33 32 2e 65 78 65 20 90 05 15 03 61 2d 7a 2c 42 65 6e 74 6c 65 79 90 00 } //1
		$a_02_2 = {25 25 5c 72 75 6e 64 6c 6c 33 32 2e 65 78 65 20 90 05 15 03 61 2d 7a 2c 58 79 6c 6f 6c 90 00 } //1
