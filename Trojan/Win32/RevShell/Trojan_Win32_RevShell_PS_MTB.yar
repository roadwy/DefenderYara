...
rule Trojan_Win32_RevShell_PS_MTB{
	...
	strings :
		$a_03_0 = {89 8d c0 e5 ff ff ba ab 3c 00 00 66 89 95 f8 f7 ff ff b8 ?? ?? ?? ?? 66 89 85 fa f7 ff ff b9 ?? ?? ?? ?? 66 89 8d fc f7 ff ff 33 d2 66 89 95 fe f7 ff ff b8 ?? ?? ?? ?? 66 89 85 84 f4 ff ff b9 ?? ?? ?? ?? 66 89 8d 86 f4 ff ff ba ?? ?? ?? ?? 66 89 95 88 f4 ff ff 33 c0 66 89 85 8a f4 ff ff b9 } //1
