...
rule Trojan_Win32_Predator_AA_MTB{
	...
	strings :
		$a_00_0 = {53 63 72 65 65 6e 73 68 6f 74 2e 6a 70 65 67 } //01 00 
		$a_00_1 = {5c 46 6f 78 6d 61 69 6c 2e 75 72 6c 2e 6d 61 } //01 00 
		$a_00_2 = {42 63 72 79 70 74 2e 64 6c 6c } //01 00 
