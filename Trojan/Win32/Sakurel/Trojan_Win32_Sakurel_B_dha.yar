...
rule Trojan_Win32_Sakurel_B_dha{
	...
	strings :
		...
		$a_03_3 = {68 f4 01 00 00 ff 15 90 01 04 81 c3 00 90 90 01 00 3b 9d 90 01 02 ff ff 0f 86 90 01 02 ff ff 90 00 } //2
	condition:
...
rule Trojan_Win32_Sakurel_B_dha_2{
	...
	strings :
		...
		$a_03_2 = {3f 72 65 73 69 64 3d 25 64 90 02 0f 26 70 68 6f 74 6f 69 64 3d 00 90 00 } //1
		$a_03_3 = {68 f4 01 00 00 ff 15 90 01 04 81 c5 00 90 90 01 00 3b eb 0f 86 90 00 } //1
	condition:
