...
rule Trojan_Win32_LegionLoader_RPS_MTB{
	...
	strings :
		$a_03_0 = {89 55 b8 8b 45 b0 2d 90 01 04 89 45 b0 8b 4d c4 81 e9 90 01 04 89 4d c4 8b 55 cc 03 55 c0 89 55 cc 8b 45 c4 2b 45 ac 89 45 c4 8b 4d c0 81 c1 90 01 04 89 4d c0 8b 95 90 01 04 8b 45 94 89 02 90 00 } //1
