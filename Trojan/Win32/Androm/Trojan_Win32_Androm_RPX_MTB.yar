...
rule Trojan_Win32_Androm_RPX_MTB{
	...
	strings :
		...
		$a_01_1 = {33 00 38 00 2e 00 35 00 35 00 2e 00 31 00 39 00 34 00 2e 00 31 00 30 00 34 00 } //01 00  38.55.194.104
		$a_01_2 = {6f 00 75 00 74 00 70 00 75 00 74 00 5f 00 33 00 32 00 2e 00 62 00 69 00 6e 00 } //00 00  output_32.bin
	condition:
		any of ($a_*)
