...
rule Trojan_Win32_FakeMadoc{
	...
	strings :
		...
		$a_03_1 = {6a 64 ff 15 90 01 04 eb 2f 66 83 7c 24 90 01 01 2e 75 18 66 83 7c 24 90 01 01 00 74 1f 66 83 7c 24 90 01 01 2e 75 08 66 83 7c 24 90 01 01 00 74 0f 90 00 } //1
