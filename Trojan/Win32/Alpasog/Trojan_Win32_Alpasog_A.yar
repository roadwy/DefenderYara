...
rule Trojan_Win32_Alpasog_A{
	...
	strings :
		...
		$a_03_6 = {8b d1 c1 fa 90 01 01 08 14 30 03 f7 c0 e1 90 01 01 88 0c 30 90 00 } //1
		$a_03_7 = {8b f1 c1 ee 90 01 01 03 35 90 01 04 8b f9 c1 e7 90 01 01 03 3d 90 01 04 33 f7 8d 3c 0a 33 f7 2b c6 8b f0 c1 ee 90 01 01 03 35 90 00 } //1
	condition:
