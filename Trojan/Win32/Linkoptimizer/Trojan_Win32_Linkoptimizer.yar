...
rule Trojan_Win32_Linkoptimizer_3{
	...
	strings :
		$a_01_0 = {75 69 64 3d 25 30 38 78 25 30 38 78 25 30 38 78 26 64 69 3d 25 30 38 78 26 70 69 6e 3d 25 30 35 64 26 6c 69 66 65 3d 25 64 26 6c 74 3d 25 64 26 76 30 3d 31 26 6c 3d 25 64 26 64 3d 25 64 26 75 3d 25 64 26 61 63 74 3d 25 64 26 69 63 3d 25 64 } //02 00 
		$a_01_1 = {53 6f 66 74 77 61 72 65 5c 4d 69 63 72 6f 73 6f 66 74 5c 57 69 6e 64 6f 77 73 5c 43 75 72 72 65 6e 74 56 65 72 73 69 6f 6e 5c 55 6e 69 6e 73 74 61 6c 6c 5c 4c 69 6e 6b 4f 70 74 69 6d 69 7a 65 72 } //02 00 
		$a_01_2 = {26 61 63 74 3d 67 63 26 70 69 6e 3d 25 35 64 26 64 3d 25 73 } //02 00 
		$a_01_3 = {68 74 74 70 3a 2f 2f 77 77 77 2e 66 6c 61 73 68 6b 69 6e 2e 6e 65 74 } //02 00 
		$a_00_4 = {6c 00 61 00 75 00 74 00 6f 00 63 00 6c 00 69 00 63 00 6b 00 } //02 00 
		$a_00_5 = {5f 00 53 00 54 00 45 00 41 00 4c 00 54 00 48 00 5f 00 4c 00 49 00 4e 00 4b 00 5f 00 } //00 00 
	condition:
		any of ($a_*)
