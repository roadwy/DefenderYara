...
rule Trojan_Win32_Derbit_A{
	...
	strings :
		$a_03_0 = {50 6a 48 e8 90 01 04 8d 84 24 90 01 04 50 6a 49 e8 90 01 04 8d 84 24 90 01 04 50 6a 4a e8 90 00 } //3
		$a_03_1 = {8a 04 30 32 04 d5 90 01 04 32 04 d5 90 01 04 32 c3 43 88 04 3e 0f b7 f3 3b f1 72 db 90 09 07 00 8b 04 d5 90 00 } //3
