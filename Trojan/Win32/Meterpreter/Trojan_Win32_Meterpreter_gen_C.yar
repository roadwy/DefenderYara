...
rule Trojan_Win32_Meterpreter_gen_C{
	meta:
		description = "Trojan:Win32/Meterpreter.gen!C,SIGNATURE_TYPE_PEHSTR_EXT,02 00 02 00 02 00 00 01 00 "
		
	strings :
		$a_01_0 = {fc e8 82 00 00 00 60 89 e5 31 c0 64 8b 50 30 8b 52 0c 8b 52 14 8b 72 28 0f b7 4a 26 31 ff ac 3c 61 7c 02 } //01 00 
		$a_01_1 = {68 33 32 00 00 68 77 73 32 5f } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Meterpreter_gen_C_2{
	meta:
		description = "Trojan:Win32/Meterpreter.gen!C,SIGNATURE_TYPE_PEHSTR_EXT,05 00 05 00 05 00 00 01 00 "
...
rule Trojan_Win32_Meterpreter_gen_C_3{
	meta:
		description = "Trojan:Win32/Meterpreter.gen!C,SIGNATURE_TYPE_PEHSTR_EXT,06 00 06 00 05 00 00 02 00 "
		
	strings :
		$a_03_0 = {5f 5a 8b 12 eb 90 01 01 5d 68 6e 65 74 00 68 77 69 6e 69 54 68 4c 77 26 07 ff d5 90 00 } //01 00 
...
rule Trojan_Win32_Meterpreter_gen_C_5{
	...
	strings :
		$a_01_0 = {68 2d 06 18 7b ff d5 85 c0 75 } //01 00 
		$a_03_1 = {53 56 68 12 96 89 e2 ff d5 85 c0 74 90 01 01 8b 07 01 c3 85 c0 75 90 00 } //01 00 
		$a_01_2 = {68 6e 65 74 00 68 77 69 6e 69 54 68 4c 77 26 07 ff d5 } //01 00 
		$a_01_3 = {68 3a 56 79 a7 ff d5 } //01 00 
		$a_01_4 = {68 58 a4 53 e5 ff d5 } //00 00 
		$a_00_5 = {78 88 00 } //00 05 
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Meterpreter_gen_C_6{
	meta:
		description = "Trojan:Win32/Meterpreter.gen!C,SIGNATURE_TYPE_PEHSTR_EXT,05 00 05 00 06 00 00 01 00 "
...
rule Trojan_Win32_Meterpreter_gen_C_9{
	meta:
		description = "Trojan:Win32/Meterpreter.gen!C,SIGNATURE_TYPE_PEHSTR_EXT,05 00 05 00 07 00 00 01 00 "
...
rule Trojan_Win32_Meterpreter_gen_C_10{
	meta:
		description = "Trojan:Win32/Meterpreter.gen!C,SIGNATURE_TYPE_PEHSTR_EXT,04 00 04 00 04 00 00 01 00 "
