...
rule Trojan_Win32_Meterpreter_gen_C_3{
	...
	strings :
		$a_03_0 = {5f 5a 8b 12 eb 90 01 01 5d 68 6e 65 74 00 68 77 69 6e 69 54 68 4c 77 26 07 ff d5 90 00 } //2
...
rule Trojan_Win32_Meterpreter_gen_C_5{
	...
	strings :
		...
		$a_03_1 = {53 56 68 12 96 89 e2 ff d5 85 c0 74 90 01 01 8b 07 01 c3 85 c0 75 90 00 } //1
