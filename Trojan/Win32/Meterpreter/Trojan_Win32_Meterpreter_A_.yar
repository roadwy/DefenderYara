...
rule Trojan_Win32_Meterpreter_A__3{
	...
	strings :
		$a_01_0 = {68 6c 6c 20 41 68 33 32 2e 64 68 75 73 65 72 } //01 00 
		$a_01_1 = {68 6f 78 58 20 68 61 67 65 42 68 4d 65 73 73 } //01 00 
...
rule Trojan_Win32_Meterpreter_A__4{
	...
	strings :
		...
		$a_01_1 = {68 33 32 00 00 68 77 73 32 5f } //01 00 
...
rule Trojan_Win32_Meterpreter_A__21{
	...
	strings :
		...
		$a_01_4 = {5c 5c 2e 5c 70 69 70 65 5c } //01 00 
...
rule Trojan_Win32_Meterpreter_A__24{
	...
	strings :
		...
		$a_01_2 = {68 6f 78 58 20 68 61 67 65 42 68 4d 65 73 73 } //01 00 
...
rule Trojan_Win32_Meterpreter_A__29{
	...
	strings :
		...
		$a_01_2 = {53 74 61 67 65 6c 65 73 73 49 6e 69 74 } //01 00 
		$a_01_3 = {47 45 54 20 2f 31 32 33 34 35 36 37 38 39 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Meterpreter_A__35{
	...
	strings :
		...
		$a_01_3 = {73 74 64 61 70 69 5f 6e 65 74 5f 74 63 70 5f 63 6c 69 65 6e 74 } //01 00 
		$a_01_4 = {73 74 64 61 70 69 5f 6e 65 74 5f 74 63 70 5f 73 65 72 76 65 72 } //01 00 
		$a_01_5 = {73 74 64 61 70 69 5f 6e 65 74 5f 75 64 70 5f 63 6c 69 65 6e 74 } //01 00 
		$a_01_6 = {73 74 64 61 70 69 5f 66 73 5f 66 69 6c 65 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Meterpreter_A__38{
	...
	strings :
		$a_01_0 = {5f 52 65 66 6c 65 63 74 69 76 65 4c 6f 61 64 65 72 40 } //01 00 
...
rule Trojan_Win32_Meterpreter_A__43{
	...
	strings :
		...
		$a_01_4 = {77 65 62 63 61 6d 5f 61 75 64 69 6f 5f 72 65 63 6f 72 64 } //01 00 
		$a_01_5 = {25 54 45 4d 50 25 5c 68 6f 6f 6b 2e 64 6c 6c } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Meterpreter_A__44{
	...
	strings :
		...
		$a_01_7 = {68 6f 67 20 55 68 6f 70 20 74 68 21 64 6e 68 } //01 00 
...
rule Trojan_Win32_Meterpreter_A__45{
	...
	strings :
		...
		$a_01_4 = {6d 69 6d 69 6b 61 74 7a 5f 63 75 73 74 6f 6d 5f 63 6f 6d 6d 61 6e 64 } //01 00 
		$a_01_5 = {5c 00 5c 00 2e 00 5c 00 6d 00 69 00 6d 00 69 00 6b 00 61 00 74 00 7a 00 } //01 00 
		$a_01_6 = {4b 00 69 00 77 00 69 00 41 00 6e 00 64 00 52 00 65 00 67 00 69 00 73 00 74 00 72 00 79 00 54 00 6f 00 6f 00 6c 00 73 00 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Meterpreter_A__48{
	...
	strings :
		$a_01_0 = {50 41 59 4c 4f 41 44 5f 55 55 49 44 20 3d } //01 00 
		$a_01_1 = {73 75 70 65 72 28 4d 65 74 65 72 70 72 65 74 65 72 46 69 6c 65 2c 20 73 65 6c 66 29 2e 5f 5f 69 6e 69 74 5f 5f 28 29 } //01 00 
		$a_01_2 = {73 75 70 65 72 28 4d 65 74 65 72 70 72 65 74 65 72 50 72 6f 63 65 73 73 2c 20 73 65 6c 66 29 2e 5f 5f 69 6e 69 74 5f 5f 28 29 } //01 00 
		$a_01_3 = {65 78 70 6f 72 74 28 4d 65 74 65 72 70 72 65 74 65 72 53 6f 63 6b 65 74 54 43 50 53 65 72 76 65 72 29 } //01 00 
		$a_01_4 = {63 6c 61 73 73 20 50 79 74 68 6f 6e 4d 65 74 65 72 70 72 65 74 65 72 28 6f 62 6a 65 63 74 29 3a } //01 00 
		$a_01_5 = {6d 65 74 20 3d 20 50 79 74 68 6f 6e 4d 65 74 65 72 70 72 65 74 65 72 28 74 72 61 6e 73 70 6f 72 74 29 } //01 00 
		$a_01_6 = {6d 65 74 2e 72 75 6e 28 29 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Meterpreter_A__50{
	...
	strings :
		$a_81_0 = {5c 70 69 70 65 5c 73 70 6f 6f 6c 73 73 } //01 00 
		...
		$a_01_6 = {63 6d 64 2e 65 78 65 20 2f 63 20 65 63 68 6f 20 25 73 20 3e 20 25 73 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Meterpreter_A__53{
	...
	strings :
		$a_01_0 = {5b 53 79 73 74 65 6d 2e 43 6f 6e 76 65 72 74 5d 3a 3a 46 72 6f 6d 42 61 73 65 36 34 53 74 72 69 6e 67 28 22 2f 4f 69 43 41 41 41 41 59 49 6e 6c 4d 63 42 6b 69 31 41 77 69 31 49 4d 69 31 49 55 69 33 49 6f 44 37 64 4b 4a 6a 48 2f } //01 00 
