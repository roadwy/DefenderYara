...
rule Trojan_Win32_Meterpreter_A__3{
	...
	strings :
		...
		$a_03_3 = {84 c0 74 07 c1 cf ?? 01 c7 eb f4 3b 7c 24 28 75 e1 } //1
	condition:
...
rule Trojan_Win32_Meterpreter_A__12{
	...
	strings :
		$a_03_0 = {ff e0 5f 5f 5a 8b 12 eb ?? 5d 6a 01 8d 85 9a 00 00 00 50 68 31 8b 6f 87 ff d5 68 47 13 72 6f ff d5 } //1
...
rule Trojan_Win32_Meterpreter_A__13{
	...
	strings :
		$a_03_0 = {c7 04 24 c6 96 87 52 89 44 ?? ?? e8 [0-0a] c7 04 24 4c 77 26 07 } //1
		$a_03_1 = {77 73 32 5f c7 44 24 ?? 33 32 2e 64 [0-06] c6 44 24 ?? 00 e8 } //1
		$a_01_2 = {ff d0 83 ec 04 c7 04 24 99 a5 74 61 e8 } //1
		$a_03_3 = {c7 04 24 52 f3 e2 51 e8 ?? ?? ?? ?? c7 04 24 5f 78 54 ee } //1
	condition:
...
rule Trojan_Win32_Meterpreter_A__16{
	...
	strings :
		...
		$a_03_5 = {41 ba ea 0f df e0 ff d5 [0-20] 41 ba 99 a5 74 61 ff d5 } //1
	condition:
...
rule Trojan_Win32_Meterpreter_A__19{
	...
	strings :
		...
		$a_01_4 = {65 48 8b 52 60 48 8b 52 18 48 8b 52 20 48 8b 72 50 48 0f b7 4a 4a 4d 31 c9 } //1
		$a_03_5 = {49 be 77 69 6e 68 74 74 70 00 [0-08] 49 c7 c2 4c 77 26 07 ff d5 } //1
	condition:
		((#a_01_0  & 1)*1+(#a_01_1  & 1)*1+(#a_01_2  & 1)*1+(#a_01_3  & 1)*1+(#a_01_4  & 1)*1+(#a_03_5  & 1)*1) >=5
...
rule Trojan_Win32_Meterpreter_A__21{
	...
	strings :
		$a_03_0 = {65 48 8b 52 60 [0-04] 48 8b 52 18 [0-04] 48 8b 52 20 } //1
...
rule Trojan_Win32_Meterpreter_A__34{
	...
	strings :
		...
		$a_03_1 = {ff e0 58 41 59 5a 48 8b 12 e9 ?? ?? ?? ?? 5d 48 ba 01 00 00 00 00 00 00 00 48 8d 8d ?? ?? 00 00 41 ba 31 8b 6f 87 ff d5 bb f0 b5 a2 56 41 ba a6 95 bd 9d ff d5 } //1
...
rule Trojan_Win32_Meterpreter_A__36{
	...
	strings :
		...
		$a_03_1 = {ff e0 5f 5f 5a 8b 12 eb ?? 5d 6a 01 8d 85 ?? 00 00 00 50 68 31 8b 6f 87 ff d5 bb f0 b5 a2 56 68 a6 95 bd 9d ff d5 } //1
		$a_01_2 = {bb 47 13 72 6f 6a 00 53 ff d5 } //1
		$a_03_3 = {ff e0 5f 5f 5a 8b 12 eb 8d 5d 8d 85 ?? 00 00 00 50 68 4c 77 26 07 ff d5 bb f0 b5 a2 56 68 a6 95 bd 9d ff d5 } //1
	condition:
...
rule Trojan_Win32_Meterpreter_A__42{
	...
	strings :
		$a_03_0 = {4d 5a e8 00 00 00 00 5b 52 45 55 89 e5 81 c3 ?? ?? ?? ?? ff d3 81 c3 ?? ?? ?? ?? 89 3b 53 6a 04 50 ff d0 } //1
...
rule Trojan_Win32_Meterpreter_A__44{
	...
	strings :
		$a_03_0 = {64 8b 76 30 8b 76 0c 8b 76 1c 56 ?? ?? ?? ?? 5f 8b 6f 08 ff 37 8b 5d 3c 8b 5c 1d 78 01 eb 8b 4b 18 67 e3 eb } //1
...
rule Trojan_Win32_Meterpreter_A__49{
	...
	strings :
		...
		$a_03_8 = {83 f9 01 75 0c 51 eb 1c 8b 44 24 1c ff d0 89 c2 59 51 8b 4c bd 00 e8 ?? ?? ?? ?? 59 50 47 e2 e0 89 e5 eb 0f } //1
	condition:
...
rule Trojan_Win32_Meterpreter_A__52{
	...
	strings :
		$a_03_0 = {4d 5a 41 52 55 48 89 e5 48 83 ec 20 48 83 e4 f0 e8 00 00 00 00 5b 48 81 c3 ?? ?? ?? ?? ff d3 48 81 c3 ?? ?? ?? ?? 48 89 3b 49 89 d8 6a 04 5a ff d0 } //1
