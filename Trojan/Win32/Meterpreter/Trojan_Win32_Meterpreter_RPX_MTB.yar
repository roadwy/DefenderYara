...
rule Trojan_Win32_Meterpreter_RPX_MTB{
	...
	strings :
		...
		$a_01_1 = {34 39 2e 32 33 32 2e 31 39 32 2e 39 38 } //01 00 
		$a_01_2 = {67 75 6f 67 75 6f } //01 00 
		$a_01_3 = {52 65 76 65 72 73 65 5f 54 43 50 5f 52 43 34 } //01 00 
		$a_01_4 = {76 69 70 65 72 2e 70 64 62 } //00 00 
	condition:
		any of ($a_*)
