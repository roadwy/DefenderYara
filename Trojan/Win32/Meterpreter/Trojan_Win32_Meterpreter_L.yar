...
rule Trojan_Win32_Meterpreter_L{
	meta:
		description = "Trojan:Win32/Meterpreter.L,SIGNATURE_TYPE_PEHSTR_EXT,06 00 06 00 06 00 00 01 00 "
...
rule Trojan_Win32_Meterpreter_L_2{
	meta:
		description = "Trojan:Win32/Meterpreter.L,SIGNATURE_TYPE_PEHSTR_EXT,07 00 07 00 07 00 00 01 00 "
