...
rule Trojan_Win32_Fareit_VM_MTB{
	...
	strings :
		$a_03_0 = {8b 55 10 0f b6 14 3a 33 c2 3d 90 01 04 76 90 00 } //1
...
rule Trojan_Win32_Fareit_VM_MTB_2{
	...
	strings :
		$a_03_0 = {8b 06 03 c3 73 90 01 01 e8 90 01 04 50 68 90 01 04 ff 15 90 01 05 ff 06 81 3e 90 01 04 75 90 00 } //1
...
rule Trojan_Win32_Fareit_VM_MTB_3{
	...
	strings :
		...
		$a_03_1 = {8a 84 9d e8 fb ff ff 88 45 90 01 01 89 c0 89 f6 89 d2 87 ff 8b 84 bd e8 fb ff ff 89 84 9d e8 fb ff ff 90 90 89 db 90 90 33 c0 8a 45 90 01 01 89 84 bd 90 00 } //1
	condition:
...
rule Trojan_Win32_Fareit_VM_MTB_4{
	...
	strings :
		$a_03_0 = {8b c1 33 d2 52 50 8b 03 99 03 04 24 13 54 24 04 83 c4 90 01 01 c6 00 90 01 01 ff 03 81 3b 90 01 04 75 90 00 } //1
		...
		$a_03_2 = {68 68 17 47 00 e8 90 01 04 4b 75 90 00 } //1
	condition:
