...
rule Trojan_Win32_Fareit_RF_MTB{
	...
	strings :
		...
		$a_01_1 = {49 00 73 00 63 00 6f 00 62 00 61 00 71 00 75 00 65 00 62 00 75 00 2e 00 65 00 78 00 65 00 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Fareit_RF_MTB_3{
	...
	strings :
		$a_81_0 = {40 2a 5c 41 50 72 6f 6a 65 63 74 31 } //01 00 
		$a_81_1 = {31 38 35 2e 37 2e 32 31 34 2e 37 2f 41 44 53 31 31 2f 52 45 44 2e 50 4e 47 } //01 00 
		$a_81_2 = {68 74 74 70 73 3a 2f 2f 69 70 6c 6f 67 67 65 72 2e 6f 72 67 2f 31 70 75 63 75 37 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Fareit_RF_MTB_4{
	...
	strings :
		...
		$a_01_1 = {46 6f 6c 6b 65 62 69 62 6c 69 6f 74 65 6b 65 72 6e 65 32 } //01 00 
		$a_01_2 = {53 75 70 65 72 72 69 67 68 74 65 6f 75 73 6c 79 36 } //01 00 
		$a_01_3 = {54 65 6b 6e 6f 6c 6f 67 69 76 75 72 64 65 72 69 6e 67 73 70 72 6f 6a 65 6b 74 65 74 39 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Fareit_RF_MTB_5{
	...
	strings :
		...
		$a_81_1 = {49 65 62 47 6b 73 41 78 55 78 34 63 54 34 70 47 64 55 79 6f 4f 64 46 64 32 46 67 58 7a 5a 44 57 77 4d 46 55 46 32 32 39 } //01 00 
		$a_81_2 = {74 38 6d 75 6f 4e 6d 4c 32 45 46 75 36 59 77 50 45 4d 52 4a 71 67 63 73 63 70 49 6c 76 51 78 4f 45 32 31 38 36 } //00 00 
	condition:
		any of ($a_*)
