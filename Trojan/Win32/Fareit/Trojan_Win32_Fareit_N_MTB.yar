...
rule Trojan_Win32_Fareit_N_MTB_2{
	...
	strings :
		$a_01_0 = {68 00 55 00 41 00 57 00 45 00 41 00 } //01 00 
		$a_01_1 = {44 00 41 00 43 00 20 00 74 00 65 00 63 00 68 00 6e 00 6f 00 6c 00 4f 00 67 00 49 00 45 00 53 00 } //01 00 
		$a_01_2 = {43 00 41 00 6d 00 20 00 73 00 54 00 55 00 44 00 49 00 4f 00 20 00 67 00 72 00 6f 00 75 00 4f 00 } //01 00 
		$a_01_3 = {53 00 4f 00 55 00 52 00 43 00 6f 00 20 00 66 00 49 00 52 00 41 00 2c 00 20 00 67 00 6e 00 72 00 2e 00 } //01 00 
		$a_01_4 = {57 00 4f 00 52 00 6c 00 65 00 } //01 00 
		$a_01_5 = {5a 00 41 00 4c 00 4c 00 4f 00 20 00 43 00 52 00 65 00 20 00 4a 00 65 00 63 00 61 00 } //00 00 
	condition:
		any of ($a_*)
