...
rule Trojan_Win32_Lowzones_DZ{
	...
	strings :
		...
		$a_02_1 = {3c 62 6f 64 79 90 02 04 61 64 5f 75 72 6c 90 00 } //10
		...
		$a_02_9 = {68 74 74 70 3a 2f 2f 90 02 08 2e 63 6f 6d 2f 63 6c 69 63 6b 2f 3f 73 3d 90 02 08 26 63 3d 90 00 } //5
