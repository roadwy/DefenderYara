...
rule Trojan_Win32_Autophyte_M_dha{
	...
	strings :
		...
		$a_01_3 = {4d 44 2a 2e 74 6d 70 00 } //01 00  䑍⸪浴p
		$a_01_4 = {44 57 53 2a 2e 74 6d 70 00 } //01 00 
		$a_01_5 = {50 4d 2a 2e 74 6d 70 00 } //01 00  䵐⸪浴p
		$a_01_6 = {46 4d 2a 2e 74 6d 70 00 } //01 00  䵆⸪浴p
		$a_01_7 = {57 4d 2a 2e 74 6d 70 00 } //01 00  䵗⸪浴p
		$a_01_8 = {44 57 53 30 30 00 } //00 00  坄こ0
	condition:
		any of ($a_*)
