...
rule Trojan_Win32_Camec_I{
	...
	strings :
		...
		$a_00_1 = {54 5f 50 65 67 61 4a 61 6e 65 6c 61 43 6f 6d 61 6e 64 6f 73 } //01 00  T_PegaJanelaComandos
		$a_00_2 = {45 78 74 72 61 74 6f 5f 30 30 31 4a } //01 00  Extrato_001J
		$a_00_3 = {45 5f 47 69 72 6f 5f 52 61 70 69 64 6f } //00 00  E_Giro_Rapido
	condition:
		any of ($a_*)
