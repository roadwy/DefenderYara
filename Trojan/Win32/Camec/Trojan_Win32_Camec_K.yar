...
rule Trojan_Win32_Camec_K{
	...
	strings :
		...
		$a_03_4 = {66 3b f3 0f 8c ?? 00 00 00 66 6b ff 40 66 8b 45 dc 0f 80 ?? 01 00 00 66 03 fe 0f 80 ?? 01 00 00 66 05 06 00 0f 80 ?? 01 00 00 66 3d 08 00 89 45 dc 0f 8c ?? 00 00 00 0f bf f7 8d 55 dc 66 2d 08 00 } //10
	condition:
