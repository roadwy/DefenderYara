...
rule Trojan_Win32_Beaconpy_A{
	...
	strings :
		$a_00_0 = {5c 00 73 00 65 00 72 00 76 00 69 00 63 00 65 00 68 00 75 00 62 00 2e 00 68 00 6f 00 73 00 74 00 2e 00 63 00 6c 00 72 00 2e 00 65 00 78 00 65 00 } //01 00  \servicehub.host.clr.exe
