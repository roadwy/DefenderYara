...
rule Trojan_Win32_Qukart_ASP_MTB{
	...
	strings :
		...
		$a_03_2 = {1d 8b 00 e3 84 b6 3c 33 4b 8b 8b d6 3d 5b 42 e3 fa 2e 8d de 35 90 02 04 b6 34 33 4b 8b 59 bc 57 74 54 6c 0d d6 5e 68 54 90 00 } //5
		$a_03_3 = {b8 a2 ab 0a dc 01 68 0a 89 88 90 02 04 fc 81 81 90 02 04 73 cc 83 2c 30 5b 83 1a 82 90 02 04 54 7f 90 00 } //5
	condition:
