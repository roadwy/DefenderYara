...
rule Trojan_Win32_QHosts_AL{
	...
	strings :
		$a_00_0 = {72 65 6e 61 6d 65 20 43 3a 5c 57 49 4e 44 4f 57 53 5c 73 79 73 74 65 6d 33 32 5c 64 72 69 76 65 72 73 5c 65 74 63 5c 68 6f 73 74 73 20 73 65 72 76 69 63 65 } //01 00  rename C:\WINDOWS\system32\drivers\etc\hosts service
