...
rule Trojan_Win32_QHosts_AG{
	...
	strings :
		$a_03_0 = {84 c0 74 4e b8 90 01 03 00 e8 90 01 03 ff 50 e8 90 01 03 ff 68 e8 03 00 00 e8 90 01 03 ff b8 90 01 03 00 90 00 } //10
		$a_02_1 = {6d 61 67 65 6e 74 73 65 74 75 70 2e 65 78 65 90 02 07 55 8b ec 33 c0 55 68 90 01 03 00 64 ff 30 64 89 20 33 c0 5a 59 59 64 89 10 68 90 01 03 00 90 00 } //10
		$a_02_2 = {6d 61 67 65 6e 74 2e 65 78 65 90 02 07 55 8b ec 33 c0 55 68 90 01 03 00 64 ff 30 64 89 20 33 c0 5a 59 59 64 89 10 68 90 01 03 00 90 00 } //10
		...
		$a_02_5 = {77 69 6e 61 6d 70 2e 65 78 65 00 90 02 10 00 6d 61 67 65 6e 74 2e 65 78 65 00 90 00 } //10
