...
rule Trojan_Win32_QHosts_BC{
	...
	strings :
		$a_02_0 = {25 30 34 5c 90 02 10 2e 76 62 73 00 90 00 } //1
		$a_02_1 = {4c 4f 4b 49 20 3d 22 68 6f 90 02 04 73 90 02 04 74 90 02 04 73 90 00 } //1
		...
		$a_02_4 = {64 72 69 76 65 72 73 22 2b 90 02 04 2b 22 65 74 63 90 00 } //1
	condition:
