...
rule Trojan_Win32_QHosts_AP{
	...
	strings :
		$a_03_0 = {25 30 34 5c 90 02 10 2e 74 78 74 00 90 00 } //1
		$a_03_1 = {25 30 34 5c 90 02 10 2e 65 78 65 00 90 00 } //1
		$a_03_2 = {25 30 34 5c 90 02 10 2e 6a 70 67 00 90 00 } //1
		$a_01_3 = {25 30 32 5c 53 79 73 74 65 6d 33 32 5c 64 72 69 76 65 72 73 5c 65 74 63 5c } //1 %02\System32\drivers\etc\
		$a_03_4 = {65 63 68 6f 20 25 90 02 10 25 20 3e 3e 20 20 68 6f 73 74 73 0d 0a 90 00 } //1
		$a_03_5 = {65 63 68 6f 20 20 25 90 02 10 25 20 20 20 3e 3e 20 20 68 6f 73 74 73 0d 0a 90 00 } //1
		...
		$a_03_9 = {3d 2e 0d 0a 73 65 74 20 90 02 10 3d 72 0d 0a 73 65 74 20 90 02 10 3d 75 0d 0a 90 00 } //2
