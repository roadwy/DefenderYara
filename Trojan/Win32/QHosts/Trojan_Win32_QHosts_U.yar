...
rule Trojan_Win32_QHosts_U{
	...
	strings :
		$a_02_0 = {2f 63 6d 2e 70 68 70 3f 69 64 3d 90 02 04 26 68 61 73 68 3d 90 00 } //2
		$a_02_1 = {31 32 37 2e 30 2e 30 2e 31 90 02 10 6c 6f 63 61 6c 68 6f 73 74 90 00 } //2
