...
rule Trojan_Win32_Ofisus_A{
	...
	strings :
		...
		$a_00_1 = {40 00 68 00 74 00 74 00 70 00 3a 00 2f 00 2f 00 } //01 00  @http://
		$a_00_2 = {27 00 2e 00 53 00 70 00 6c 00 69 00 74 00 28 00 27 00 40 00 27 00 29 00 3b 00 } //01 00  '.Split('@');
		$a_00_3 = {2b 00 27 00 2e 00 65 00 78 00 65 00 27 00 3b 00 } //01 00  +'.exe';
		$a_00_4 = {7d 00 7d 00 63 00 61 00 74 00 63 00 68 00 7b 00 7d 00 7d 00 20 00 } //00 00  }}catch{}} 
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Ofisus_A_2{
	...
	strings :
		$a_00_0 = {5c 00 63 00 6d 00 64 00 2e 00 65 00 78 00 65 00 } //01 00  \cmd.exe
		$a_00_1 = {63 00 6d 00 64 00 20 00 2f 00 63 00 20 00 70 00 6f 00 77 00 65 00 72 00 73 00 68 00 65 00 6c 00 6c 00 } //01 00  cmd /c powershell
		$a_00_2 = {29 00 2e 00 64 00 6f 00 77 00 6e 00 6c 00 6f 00 61 00 64 00 66 00 69 00 6c 00 65 00 28 00 24 00 } //01 00  ).downloadfile($
		$a_00_3 = {27 00 27 00 25 00 74 00 6d 00 70 00 25 00 5c 00 } //01 00  ''%tmp%\
		$a_00_4 = {27 00 27 00 29 00 3b 00 73 00 74 00 61 00 72 00 74 00 2d 00 70 00 72 00 6f 00 63 00 65 00 73 00 73 00 } //00 00  '');start-process
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Ofisus_A_3{
	...
	strings :
		...
		$a_00_4 = {29 00 2e 00 49 00 6e 00 76 00 6f 00 6b 00 65 00 28 00 } //01 00  ).Invoke(
		$a_00_5 = {3a 00 3a 00 66 00 72 00 6f 00 6d 00 42 00 41 00 53 00 65 00 36 00 34 00 53 00 54 00 52 00 49 00 6e 00 47 00 28 00 } //00 00  ::fromBASe64STRInG(
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Ofisus_A_4{
	...
	strings :
		...
		$a_00_1 = {7d 00 7d 00 7b 00 68 00 63 00 74 00 61 00 63 00 7d 00 7d 00 } //01 00  }}{hctac}}
...
rule Trojan_Win32_Ofisus_A_6{
	...
	strings :
		...
		$a_00_1 = {26 00 26 00 66 00 6f 00 72 00 20 00 } //01 00  &&for 
		...
		$a_00_4 = {24 00 26 00 26 00 5e 00 66 00 5e 00 6f 00 72 00 } //00 00  $&&^f^or
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Ofisus_A_7{
	...
	strings :
		$a_00_0 = {5c 00 63 00 6d 00 64 00 2e 00 65 00 78 00 65 00 } //01 00  \cmd.exe
		$a_00_1 = {63 00 4d 00 64 00 2e 00 45 00 58 00 45 00 20 00 2f 00 63 00 20 00 70 00 6f 00 57 00 65 00 72 00 53 00 68 00 65 00 6c 00 4c 00 2e 00 65 00 78 00 65 00 20 00 2d 00 65 00 63 00 20 00 4b 00 41 00 42 00 4f 00 41 00 47 00 55 00 41 00 64 00 77 00 41 00 74 00 41 00 45 00 38 00 41 00 } //01 00  cMd.EXE /c poWerShelL.exe -ec KABOAGUAdwAtAE8A
		$a_00_2 = {63 00 6d 00 64 00 2e 00 65 00 78 00 65 00 20 00 2f 00 63 00 20 00 70 00 6f 00 77 00 65 00 72 00 73 00 68 00 65 00 6c 00 6c 00 2e 00 65 00 78 00 65 00 20 00 2d 00 4e 00 6f 00 50 00 20 00 2d 00 45 00 43 00 20 00 4a 00 41 00 42 00 70 00 41 00 47 00 34 00 41 00 63 00 77 00 42 00 30 00 41 00 47 00 45 00 41 00 } //01 00  cmd.exe /c powershell.exe -NoP -EC JABpAG4AcwB0AGEA
		$a_00_3 = {63 00 4d 00 64 00 2e 00 65 00 58 00 65 00 20 00 2f 00 63 00 20 00 70 00 5e 00 6f 00 5e 00 77 00 5e 00 65 00 5e 00 72 00 5e 00 73 00 5e 00 68 00 5e 00 45 00 5e 00 4c 00 5e 00 4c 00 5e 00 2e 00 5e 00 65 00 5e 00 78 00 5e 00 65 00 5e 00 20 00 5e 00 2d 00 5e 00 65 00 5e 00 63 00 5e 00 20 00 5e 00 4b 00 5e 00 41 00 5e 00 42 00 5e 00 4f 00 5e 00 } //00 00  cMd.eXe /c p^o^w^e^r^s^h^E^L^L^.^e^x^e^ ^-^e^c^ ^K^A^B^O^
	condition:
		any of ($a_*)
