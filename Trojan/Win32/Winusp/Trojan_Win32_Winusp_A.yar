...
rule Trojan_Win32_Winusp_A{
	...
	strings :
		...
		$a_01_2 = {25 64 3a 25 64 3a 25 64 20 25 73 20 65 72 72 3a 25 64 } //01 00  %d:%d:%d %s err:%d
		$a_01_3 = {3f 00 69 00 3d 00 25 00 73 00 26 00 6d 00 3d 00 75 00 26 00 66 00 3d 00 30 00 26 00 64 00 3d 00 25 00 64 00 } //00 00  ?i=%s&m=u&f=0&d=%d
	condition:
		any of ($a_*)
