...
rule Trojan_Win32_Relbma_A_dll{
	...
	strings :
		...
		$a_00_4 = {63 6c 69 63 6b 72 65 66 65 72 65 72 } //1 clickreferer
		$a_00_5 = {66 65 65 64 } //1 feed
		$a_00_6 = {00 5f 57 53 43 4c 41 53 5f 00 } //1 开南䱃十_
		$a_00_7 = {70 6f 70 75 72 6c } //1 popurl
		$a_00_8 = {63 6c 61 73 73 3d 79 73 63 68 74 74 6c 00 } //2 汣獡㵳獹档瑴l
	condition:
