...
rule Trojan_Win32_Relbma_A_dll{
	...
	strings :
		...
		$a_00_1 = {72 75 6e 64 6c 6c 33 32 2e 65 78 65 20 25 73 2c 52 75 6e 4d 61 69 6e 00 } //02 00 
		$a_00_2 = {6d 62 75 72 6c 00 00 00 62 75 72 6c 00 00 00 00 6d 62 74 65 78 74 00 00 62 74 65 78 74 00 } //01 00 
		$a_00_3 = {79 61 6e 64 65 78 } //01 00 
		$a_00_4 = {63 6c 69 63 6b 72 65 66 65 72 65 72 } //01 00 
		$a_00_5 = {66 65 65 64 } //01 00 
		$a_00_6 = {00 5f 57 53 43 4c 41 53 5f 00 } //01 00 
		$a_00_7 = {70 6f 70 75 72 6c } //02 00 
		$a_00_8 = {63 6c 61 73 73 3d 79 73 63 68 74 74 6c 00 } //00 00 
	condition:
		any of ($a_*)
