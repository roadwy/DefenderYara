...
rule Trojan_Win32_Relbma_A{
	...
	strings :
		...
		$a_10_3 = {70 72 6f 74 65 63 74 2e 61 64 76 61 6e 63 65 64 63 6c 65 61 6e 65 72 2e 63 6f 6d } //01 00 
		$a_10_4 = {4d 69 63 72 6f 73 6f 66 74 20 53 65 63 75 72 69 74 79 20 47 75 61 72 64 22 20 62 69 6e 74 65 72 76 61 6c } //00 00 
	condition:
		any of ($a_*)
