...
rule Trojan_Win32_Relbma_A{
	...
	strings :
		$a_03_0 = {76 0c 80 b0 90 01 02 40 00 90 01 01 40 3b c6 72 f4 46 56 57 6a 03 90 00 } //1
		$a_03_1 = {40 00 6a 66 e8 90 01 02 ff ff 68 90 01 02 40 00 6a 6a e8 90 01 02 ff ff 68 90 01 02 40 00 6a 69 e8 90 01 02 ff ff e8 90 01 02 ff ff e8 90 01 02 ff ff 90 00 } //1
		$a_03_2 = {76 09 80 34 38 90 01 01 40 3b c6 72 f7 8a 45 0f 53 6a 00 8d 90 00 } //1
