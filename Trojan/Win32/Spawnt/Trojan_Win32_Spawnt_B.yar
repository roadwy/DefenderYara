...
rule Trojan_Win32_Spawnt_B{
	...
	strings :
		$a_01_0 = {3a 5c 54 65 73 74 } //01 00 
		$a_01_1 = {4f 6c 78 55 5a 58 4e 30 } //04 00 
		$a_01_2 = {3a 46 6c 69 6e 63 68 65 64 } //04 00 
		$a_01_3 = {4f 6b 5a 73 61 57 35 6a 61 47 56 6b } //06 00 
