...
rule Trojan_Win32_Dogrobot_gen_E{
	...
	strings :
		...
		$a_01_3 = {43 4c 41 53 53 50 4e 50 2e 53 59 53 } //01 00  CLASSPNP.SYS
		$a_01_4 = {5c 44 65 76 69 63 65 5c 48 61 72 64 64 69 73 6b 30 5c 44 52 30 } //00 00  \Device\Harddisk0\DR0
	condition:
		any of ($a_*)
