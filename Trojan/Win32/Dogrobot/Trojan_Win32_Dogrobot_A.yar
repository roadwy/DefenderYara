...
rule Trojan_Win32_Dogrobot_A{
	...
	strings :
		$a_03_0 = {89 4c 82 fc 8b 0d 90 01 04 3b c1 7c e2 a1 90 01 04 0f 22 c0 fb c3 90 00 } //2
		$a_01_1 = {66 c7 45 fc e3 03 66 89 45 f8 66 89 45 fa ff 5d f8 8b c4 8b 64 24 04 } //2
		$a_03_2 = {6a 08 52 6a 26 ff 15 90 01 04 85 c0 7c 16 e8 90 01 02 00 00 85 c0 74 0d 68 90 01 04 e8 90 01 01 00 00 00 90 00 } //2
