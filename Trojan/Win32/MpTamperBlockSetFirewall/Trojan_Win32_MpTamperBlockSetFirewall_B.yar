...
rule Trojan_Win32_MpTamperBlockSetFirewall_B{
	meta:
		description = "Trojan:Win32/MpTamperBlockSetFirewall.B,SIGNATURE_TYPE_CMDHSTR_EXT,07 00 07 00 05 00 00 02 00 "
...
rule Trojan_Win32_MpTamperBlockSetFirewall_B_2{
	meta:
		description = "Trojan:Win32/MpTamperBlockSetFirewall.B,SIGNATURE_TYPE_CMDHSTR_EXT,07 00 07 00 05 00 00 02 00 "
