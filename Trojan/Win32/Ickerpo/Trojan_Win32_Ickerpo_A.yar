...
rule Trojan_Win32_Ickerpo_A{
	...
	strings :
		...
		$a_01_2 = {70 69 6e 67 20 31 2e 31 2e 31 2e 31 20 2d 77 20 35 30 30 30 20 3e 6e 75 6c 00 } //01 00 
		$a_01_3 = {23 78 63 6f 64 00 } //01 00 
		$a_01_4 = {52 61 7a 6f 72 4d 69 6e 74 } //00 00 
	condition:
		any of ($a_*)
