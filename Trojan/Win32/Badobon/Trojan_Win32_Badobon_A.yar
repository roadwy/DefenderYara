...
rule Trojan_Win32_Badobon_A{
	...
	strings :
		...
		$a_03_4 = {57 69 6e 64 6f 77 73 20 44 65 66 65 6e 64 65 72 90 02 10 42 41 53 53 5f 90 00 } //5
		$a_03_5 = {41 64 6f 62 65 90 02 10 46 6c 61 73 68 90 02 10 54 65 6d 70 90 02 10 49 6e 69 74 90 02 10 4c 6f 67 6f 6e 90 02 10 55 70 64 61 74 65 90 02 10 49 44 4d 90 00 } //5
	condition:
