...
rule Trojan_Win32_Badobon_A{
	...
	strings :
		$a_01_0 = {61 32 67 75 61 72 64 2e 65 78 65 } //01 00 
		$a_01_1 = {70 63 74 73 47 75 69 2e 65 78 65 } //01 00 
		$a_01_2 = {4e 6f 72 6d 61 6e 5f 4d 61 6c 77 61 72 65 5f 43 6c 65 61 6e 65 72 2e 65 78 65 } //01 00 
		$a_01_3 = {46 69 72 65 77 61 6c 6c 47 55 49 2e 65 78 65 } //05 00 
