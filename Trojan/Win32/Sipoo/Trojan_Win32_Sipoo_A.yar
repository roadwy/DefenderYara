...
rule Trojan_Win32_Sipoo_A{
	...
	strings :
		$a_03_0 = {6a 01 58 39 44 24 08 7e ?? 8b 4c 24 04 8a 54 08 ff 30 14 08 40 3b 44 24 08 7c ?? c3 } //1
		$a_03_1 = {ff 75 08 ff d6 01 45 0c 39 7d 0c 74 ?? ff 45 10 83 7d ?? ?? 72 ?? 32 c0 eb } //1
