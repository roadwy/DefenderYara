...
rule Trojan_Win32_Chroject_E_dll{
	...
	strings :
		...
		$a_03_2 = {6a 5c 52 e8 90 01 04 8b f8 83 c4 08 83 c7 01 90 00 } //1
		...
		$a_03_6 = {ff d3 85 c0 74 90 01 01 81 7c 24 14 80 00 00 00 75 90 01 01 6a 00 6a 00 55 57 6a 00 6a 00 56 c7 05 90 01 04 0b 00 00 00 ff 15 90 01 04 8b d8 ff 15 90 01 04 85 db 74 90 01 01 68 88 13 00 00 90 00 } //2
	condition:
