...
rule Trojan_Win32_Banload_MA_MTB{
	...
	strings :
		...
		$a_01_1 = {68 74 74 70 3a 2f 2f 31 37 36 2e 39 36 2e 31 33 38 2e 31 30 33 2f 6b 65 79 62 69 6e 64 65 72 } //01 00 
		$a_01_2 = {45 73 63 61 70 65 } //01 00 
		$a_01_3 = {43 61 70 73 4c 6f 63 6b } //00 00 
	condition:
		any of ($a_*)
