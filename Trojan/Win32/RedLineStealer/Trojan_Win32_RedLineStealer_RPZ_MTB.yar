...
rule Trojan_Win32_RedLineStealer_RPZ_MTB_2{
	...
	strings :
		$a_01_0 = {40 68 00 10 00 00 8b 45 08 8b 40 04 ff 70 09 6a 00 8b 45 08 ff 50 24 89 45 f8 83 65 f4 00 6a 00 8d 45 f4 50 ff 75 f8 8b 45 08 8b 40 04 ff 30 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win32_RedLineStealer_RPZ_MTB_4{
	...
	strings :
		$a_01_0 = {6a 00 6a 04 8d 4d dc 51 8b 8b a4 00 00 00 83 c1 08 51 ff 75 cc ff d0 6a 40 68 00 30 00 00 ff b7 } //00 00 
	condition:
		any of ($a_*)
