...
rule Trojan_Win32_RedLineStealer_DE_MTB{
	...
	strings :
		...
		$a_81_1 = {68 56 41 78 74 79 66 77 79 66 73 77 74 79 64 66 77 } //01 00 
		$a_81_2 = {67 76 63 67 66 78 72 64 72 74 77 64 77 74 65 79 73 64 67 66 79 75 66 77 34 36 37 33 65 66 64 73 67 79 74 75 } //00 00 
	condition:
		any of ($a_*)
