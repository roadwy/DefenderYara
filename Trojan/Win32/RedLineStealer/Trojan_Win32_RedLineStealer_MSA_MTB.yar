...
rule Trojan_Win32_RedLineStealer_MSA_MTB{
	...
	strings :
		$a_01_0 = {2e 51 68 45 36 6b 74 65 } //01 00  .QhE6kte
		...
		$a_01_4 = {50 61 73 73 77 6f 72 64 73 } //01 00  Passwords
		$a_01_5 = {47 65 74 4b 65 79 62 6f 61 72 64 54 79 70 65 } //01 00  GetKeyboardType
		$a_01_6 = {47 65 74 41 73 79 6e 63 4b 65 79 53 74 61 74 65 } //00 00  GetAsyncKeyState
	condition:
		any of ($a_*)
