...
rule Trojan_Win32_RedLineStealer_CG_MTB{
	...
	strings :
		...
		$a_81_2 = {53 74 6f 72 65 64 20 70 61 73 73 77 6f 72 64 20 69 73 20 63 6f 72 72 75 70 74 } //01 00  Stored password is corrupt
		$a_81_3 = {53 65 6c 65 63 74 20 76 69 72 75 73 20 73 63 61 6e 6e 65 72 } //00 00  Select virus scanner
	condition:
		any of ($a_*)
