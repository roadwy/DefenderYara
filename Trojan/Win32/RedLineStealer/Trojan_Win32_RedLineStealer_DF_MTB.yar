...
rule Trojan_Win32_RedLineStealer_DF_MTB{
	...
	strings :
		$a_03_0 = {03 d8 8b 45 d8 89 18 8b 45 c8 03 45 a0 8b 55 d8 31 02 6a 66 e8 90 01 04 bb 04 00 00 00 2b d8 6a 66 e8 90 01 04 03 d8 01 5d ec 83 45 d8 04 8b 45 ec 3b 45 d4 0f 82 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
