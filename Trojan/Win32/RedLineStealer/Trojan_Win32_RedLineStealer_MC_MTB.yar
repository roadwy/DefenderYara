...
rule Trojan_Win32_RedLineStealer_MC_MTB{
	...
	strings :
		...
		$a_01_1 = {55 6e 6c 6f 63 6b 46 69 6c 65 45 78 } //01 00 
		$a_01_2 = {47 65 74 43 50 49 6e 66 6f 45 78 57 } //01 00 
		$a_01_3 = {47 65 74 44 69 73 6b 46 72 65 65 53 70 61 63 65 41 } //01 00 
