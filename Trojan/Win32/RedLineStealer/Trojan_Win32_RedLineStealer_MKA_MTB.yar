...
rule Trojan_Win32_RedLineStealer_MKA_MTB{
	...
	strings :
		$a_03_0 = {fc b8 3b 2d 0b 00 01 45 fc 90 0a 12 00 a1 ?? ?? ?? ?? 89 45 [0-0a] 8b 45 fc 8a 04 38 8b 0d ?? ?? ?? ?? 88 04 39 83 3d ?? ?? ?? ?? 44 75 ?? 56 8d 85 b4 f6 ff ff 50 ff 15 ?? ?? ?? ?? 47 3b 3d 48 16 43 00 72 } //1
