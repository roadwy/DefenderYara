...
rule Trojan_Win32_RedLineStealer_MVA_MTB{
	...
	strings :
		$a_01_0 = {2e 75 30 6d 63 30 44 63 } //1 .u0mc0Dc
		...
		$a_01_4 = {45 00 6e 00 74 00 65 00 72 00 20 00 4d 00 6f 00 64 00 65 00 20 00 50 00 61 00 73 00 73 00 77 00 6f 00 72 00 64 00 } //1 Enter Mode Password
		$a_01_5 = {5c 00 54 00 45 00 4d 00 50 00 5c 00 61 00 73 00 70 00 72 00 5f 00 6b 00 65 00 79 00 73 00 2e 00 69 00 6e 00 69 00 } //1 \TEMP\aspr_keys.ini
		$a_01_6 = {47 65 74 4b 65 79 62 6f 61 72 64 54 79 70 65 } //1 GetKeyboardType
