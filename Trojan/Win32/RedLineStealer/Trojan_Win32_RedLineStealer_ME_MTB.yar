...
rule Trojan_Win32_RedLineStealer_ME_MTB_2{
	...
	strings :
		$a_03_0 = {8b 4d f4 8b d7 d3 ea 89 45 f0 03 55 e4 33 d0 89 55 ec 8b 45 ec 29 45 f8 25 90 01 04 8b 55 f8 8b c2 8d 4d f0 e8 90 01 04 8b 4d d8 8b c2 c1 e8 90 01 04 8d 45 ec e8 90 01 04 8b 45 fc 03 c2 50 8b 45 f0 03 45 dc e8 90 01 04 ff 75 ec 8d 75 f0 89 45 f0 e8 90 01 04 2b 7d f0 89 1d 90 01 04 8b 45 e0 29 45 fc ff 4d e8 0f 90 00 } //1
