...
rule Trojan_Win32_RedLineStealer_RT_MTB{
	...
	strings :
		$a_81_0 = {50 61 73 73 77 6f 72 64 20 5c 20 50 61 73 73 20 70 68 72 61 73 65 20 74 6f 20 62 65 20 74 65 73 74 65 64 } //0a 00  Password \ Pass phrase to be tested
		$a_81_1 = {47 65 6e 65 72 61 74 65 64 20 50 61 73 73 77 6f 72 64 20 5c 20 50 61 73 73 70 68 72 61 73 65 } //0a 00  Generated Password \ Passphrase
		$a_81_2 = {5a 6f 6d 62 69 65 5f 47 65 74 54 79 70 65 49 6e 66 6f } //0a 00  Zombie_GetTypeInfo
		$a_81_3 = {46 2a 5c 41 44 3a 5c 4a 75 6e 6b 20 50 72 6f 67 72 61 6d 73 5c 54 65 73 74 5f 50 61 73 73 77 32 30 32 34 33 32 35 32 30 31 37 5c 54 65 73 74 50 77 64 5c 54 65 73 74 50 77 64 2e 76 62 70 } //0a 00  F*\AD:\Junk Programs\Test_Passw20243252017\TestPwd\TestPwd.vbp
		$a_81_4 = {4b 65 6e 6e 65 74 68 20 49 76 65 73 20 6b 65 6e 61 73 6f 40 74 78 2e 72 72 2e 63 6f 6d } //01 00  Kenneth Ives kenaso@tx.rr.com
		$a_81_5 = {53 68 65 6c 6c 45 78 65 63 75 74 65 41 } //01 00  ShellExecuteA
		$a_81_6 = {53 65 74 57 69 6e 64 6f 77 73 48 6f 6f 6b 45 78 41 } //01 00  SetWindowsHookExA
		$a_81_7 = {55 6e 68 6f 6f 6b 57 69 6e 64 6f 77 73 48 6f 6f 6b 45 78 } //01 00  UnhookWindowsHookEx
		$a_81_8 = {47 65 74 54 69 63 6b 43 6f 75 6e 74 } //00 00  GetTickCount
	condition:
		any of ($a_*)
