...
rule Trojan_Win32_RedLineStealer_MPA_MTB{
	...
	strings :
		$a_01_0 = {2e 46 59 79 6b 70 44 63 } //01 00  .FYykpDc
		...
		$a_01_4 = {47 65 74 4b 65 79 62 6f 61 72 64 54 79 70 65 } //01 00  GetKeyboardType
		$a_01_5 = {61 73 70 72 5f 6b 65 79 73 2e 69 6e 69 } //01 00  aspr_keys.ini
		$a_01_6 = {45 00 6e 00 74 00 65 00 72 00 20 00 4d 00 6f 00 64 00 65 00 20 00 50 00 61 00 73 00 73 00 77 00 6f 00 72 00 64 00 } //00 00  Enter Mode Password
	condition:
		any of ($a_*)
