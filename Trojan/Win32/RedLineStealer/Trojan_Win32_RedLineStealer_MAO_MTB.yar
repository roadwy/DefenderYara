...
rule Trojan_Win32_RedLineStealer_MAO_MTB{
	...
	strings :
		...
		$a_02_5 = {8b 4c 24 18 8b 54 24 14 51 c1 ea 05 03 54 24 2c 8d 4c 24 14 c7 05 90 01 04 b4 02 d7 cb c7 05 90 01 04 ff ff ff ff e8 90 01 04 52 8d 4c 24 14 e8 90 01 04 2b 7c 24 10 8d 44 24 20 89 7c 24 1c e8 90 01 04 4d 0f 85 90 00 } //1
