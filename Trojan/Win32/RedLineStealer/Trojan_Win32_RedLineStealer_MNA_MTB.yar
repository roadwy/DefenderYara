...
rule Trojan_Win32_RedLineStealer_MNA_MTB{
	...
	strings :
		$a_01_0 = {62 5a 47 74 41 52 59 50 46 5c 41 65 57 47 35 } //01 00 
		...
		$a_01_2 = {46 69 6e 64 4e 65 78 74 46 69 6c 65 57 } //01 00 
		$a_01_3 = {49 73 44 65 62 75 67 67 65 72 50 72 65 73 65 6e 74 } //01 00 
		$a_01_4 = {4c 6f 63 6b 52 65 73 6f 75 72 63 65 } //01 00 
		$a_01_5 = {2e 35 62 69 31 6b 32 } //00 00 
	condition:
		any of ($a_*)
