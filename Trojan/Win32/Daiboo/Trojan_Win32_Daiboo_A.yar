...
rule Trojan_Win32_Daiboo_A{
	...
	strings :
		...
		$a_00_6 = {54 72 6f 6a 61 6e } //01 00 
		$a_00_7 = {46 69 72 65 77 61 6c 6c } //01 00 
		...
		$a_01_12 = {4a 75 6d 70 48 6f 6f 6b 4f 6e } //01 00 
		$a_01_13 = {4a 75 6d 70 48 6f 6f 6b 4f 66 66 } //01 00 
		$a_01_14 = {49 6e 73 65 72 74 2e 64 6c 6c } //9c ff 
		$a_01_15 = {53 70 65 63 69 61 6c 53 70 79 48 61 6e 64 6c 65 72 2e 64 6c 6c } //9c ff 
		$a_00_16 = {64 65 74 61 69 6c 2e 77 65 62 72 6f 6f 74 63 6c 6f 75 64 61 76 2e 63 6f 6d 2f } //9c ff 
		$a_00_17 = {57 00 65 00 62 00 72 00 6f 00 6f 00 74 00 20 00 53 00 65 00 63 00 75 00 72 00 65 00 41 00 6e 00 79 00 77 00 68 00 65 00 72 00 65 00 } //9c ff 
		$a_00_18 = {57 00 65 00 62 00 72 00 6f 00 6f 00 74 00 20 00 53 00 65 00 63 00 75 00 72 00 65 00 20 00 41 00 6e 00 79 00 77 00 68 00 65 00 72 00 65 00 } //00 00 
	condition:
		any of ($a_*)
