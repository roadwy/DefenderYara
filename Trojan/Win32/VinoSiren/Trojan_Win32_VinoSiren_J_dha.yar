...
rule Trojan_Win32_VinoSiren_J_dha{
	...
	strings :
		...
		$a_03_2 = {89 45 fc ba 02 00 00 00 8b 45 fc e8 90 01 04 8b d8 33 5d fc ba 03 00 00 00 8b 45 fc e8 90 01 04 33 d8 ba 07 00 00 00 8b 45 fc e8 90 01 04 33 d8 c1 e3 18 ba 08 00 00 00 8b 45 fc e8 90 01 04 0b d8 90 00 } //1
	condition:
