...
rule Trojan_Win32_Wantvi_E{
	...
	strings :
		$a_02_0 = {55 8b ec 81 ec 90 01 02 00 00 90 02 0c 68 04 01 00 00 8d 85 90 01 02 ff ff 50 ff 15 90 01 03 00 68 90 01 03 00 8d 8d 90 01 02 ff ff 51 ff 15 90 01 03 00 6a 1b 68 00 90 01 02 00 68 00 90 01 02 00 68 00 90 01 02 00 8d 95 90 01 02 ff ff 52 90 00 } //10
		$a_02_1 = {5c 75 73 65 72 90 02 01 33 32 2e 64 61 74 90 00 } //10
