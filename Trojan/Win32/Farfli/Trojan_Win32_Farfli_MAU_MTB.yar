...
rule Trojan_Win32_Farfli_MAU_MTB{
	...
	strings :
		...
		$a_01_1 = {6d 6f 64 5f 73 30 62 65 69 74 2e 64 6c 6c } //01 00 
		$a_01_2 = {5f 54 77 4d 6f 75 73 65 57 68 65 65 6c 40 34 } //01 00 
		$a_01_3 = {5f 54 77 44 65 6c 65 74 65 42 61 72 40 34 } //01 00 
