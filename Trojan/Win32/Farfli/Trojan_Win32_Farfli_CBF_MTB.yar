...
rule Trojan_Win32_Farfli_CBF_MTB{
	...
	strings :
		...
		$a_01_1 = {63 3a 5c 57 69 6e 64 6f 77 73 5c 25 73 25 64 2e 65 78 65 } //01 00  c:\Windows\%s%d.exe
		$a_01_2 = {63 3a 5c 57 69 6e 64 6f 77 73 5c 42 4a 2e 65 78 65 } //01 00  c:\Windows\BJ.exe
