...
rule Trojan_Win32_Farfli_DAX_MTB{
	...
	strings :
		...
		$a_01_2 = {72 6f 73 73 65 63 6f 72 50 6c 61 72 74 6e 65 43 5c 6d 65 74 73 79 53 5c 4e 4f 49 54 50 49 52 43 53 45 44 5c 45 52 41 57 44 52 41 48 } //01 00 
		$a_01_3 = {6f 70 6a 6b 72 6f 70 69 6f 69 61 73 64 6a 61 69 65 65 65 } //01 00 
		$a_01_4 = {69 6e 64 65 78 5b 33 5d 2e 74 78 74 } //00 00 
	condition:
		any of ($a_*)
