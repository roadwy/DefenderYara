...
rule Trojan_Win32_Farfli_DAS_MTB{
	...
	strings :
		...
		$a_01_2 = {65 6b 69 6d 68 75 71 63 72 6f 61 6e 66 6c 76 7a 67 64 6a 74 78 79 70 73 77 62 } //01 00  ekimhuqcroanflvzgdjtxypswb
		$a_01_3 = {63 6d 64 2e 65 78 65 20 2f 63 20 70 69 6e 67 20 31 32 37 2e 30 2e 30 2e 31 20 2d 6e 20 32 } //01 00  cmd.exe /c ping 127.0.0.1 -n 2
		$a_01_4 = {63 3a 5c 25 73 2e 65 78 65 } //00 00  c:\%s.exe
	condition:
		any of ($a_*)
