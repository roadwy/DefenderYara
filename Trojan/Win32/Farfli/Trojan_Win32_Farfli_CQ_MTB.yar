...
rule Trojan_Win32_Farfli_CQ_MTB{
	...
	strings :
		$a_81_0 = {68 61 69 64 69 73 68 69 6a 69 65 2e 33 33 32 32 2e 6f 72 67 } //01 00 
		...
		$a_01_5 = {75 6e 6b 6e 6f 77 6e 20 63 6f 6d 70 72 65 73 73 69 6f 6e 20 6d 65 74 68 6f 64 } //01 00 
		$a_01_6 = {53 48 47 65 74 53 70 65 63 69 61 6c 46 6f 6c 64 65 72 50 61 74 68 41 } //00 00 
	condition:
		any of ($a_*)
