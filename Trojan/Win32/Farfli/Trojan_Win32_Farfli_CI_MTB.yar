...
rule Trojan_Win32_Farfli_CI_MTB{
	...
	strings :
		$a_03_0 = {7a 41 50 63 43 90 01 01 4c 2f 5a 30 65 90 01 01 2f 42 66 62 37 41 76 43 90 00 } //1
		$a_03_1 = {30 30 4f 4f 4f 4f 4f 4f 32 66 90 01 01 31 2f 74 76 90 00 } //1
