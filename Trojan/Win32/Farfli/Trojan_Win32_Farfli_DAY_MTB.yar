...
rule Trojan_Win32_Farfli_DAY_MTB{
	...
	strings :
		...
		$a_01_3 = {43 64 65 66 67 68 69 6a 20 4c 6d 6e 6f 70 71 72 73 74 20 56 77 78 79 61 62 63 20 45 66 67 68 69 6a 6b 6c } //00 00  Cdefghij Lmnopqrst Vwxyabc Efghijkl
	condition:
		any of ($a_*)
