...
rule Trojan_Win32_Farfli_EM_MTB{
	...
	strings :
		$a_01_0 = {5f 73 65 74 6d 62 63 70 } //01 00  _setmbcp
		$a_01_1 = {70 72 6f 67 72 61 6d 42 2e 65 78 65 } //01 00  programB.exe
		$a_01_2 = {43 00 68 00 37 00 44 00 65 00 6d 00 6f 00 36 00 2e 00 45 00 58 00 45 00 } //01 00  Ch7Demo6.EXE
		$a_01_3 = {43 72 65 61 74 65 54 68 72 65 61 64 } //01 00  CreateThread
		$a_01_4 = {34 37 2e 32 34 32 2e 38 39 2e 33 34 } //00 00  47.242.89.34
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Farfli_EM_MTB_2{
	...
	strings :
		...
		$a_01_13 = {77 77 77 2e 6a 69 6e 6a 69 6e 2e 63 6f 6d } //01 00  www.jinjin.com
		$a_01_14 = {46 55 43 4b 20 59 4f 55 } //00 00  FUCK YOU
	condition:
		any of ($a_*)
