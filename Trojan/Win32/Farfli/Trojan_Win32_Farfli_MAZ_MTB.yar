...
rule Trojan_Win32_Farfli_MAZ_MTB{
	...
	strings :
		...
		$a_01_1 = {4b 79 64 68 48 78 38 36 63 32 45 6d 49 69 42 44 } //01 00 
		$a_01_2 = {38 76 54 32 43 51 59 4c 43 7a 6f 2d } //01 00 
...
rule Trojan_Win32_Farfli_MAZ_MTB_2{
	...
	strings :
		...
		$a_01_2 = {4d 00 79 00 50 00 6c 00 61 00 79 00 65 00 72 00 20 00 46 00 6f 00 72 00 20 00 4d 00 79 00 20 00 4c 00 6f 00 76 00 65 00 72 00 } //01 00 
		$a_01_3 = {40 2e 74 68 65 6d 69 64 61 } //00 00 
	condition:
		any of ($a_*)
