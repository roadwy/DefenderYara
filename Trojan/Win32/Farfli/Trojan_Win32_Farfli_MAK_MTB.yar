...
rule Trojan_Win32_Farfli_MAK_MTB{
	meta:
		description = "Trojan:Win32/Farfli.MAK!MTB,SIGNATURE_TYPE_PEHSTR_EXT,04 00 04 00 04 00 00 01 00 "
		
	strings :
		$a_03_0 = {8b 44 24 08 8d 0c 06 0f b6 04 06 c1 e8 04 83 f8 09 7e 90 01 01 04 37 eb 90 01 01 04 30 88 02 8a 01 83 e0 0f 83 f8 09 7e 90 01 01 04 37 eb 90 01 01 04 30 88 42 01 46 42 42 3b 74 24 10 7c 90 00 } //01 00 
