...
rule Trojan_Win32_Farfli_MAK_MTB{
	...
	strings :
		$a_03_0 = {8b 44 24 08 8d 0c 06 0f b6 04 06 c1 e8 04 83 f8 09 7e ?? 04 37 eb ?? 04 30 88 02 8a 01 83 e0 0f 83 f8 09 7e ?? 04 37 eb ?? 04 30 88 42 01 46 42 42 3b 74 24 10 7c } //1
