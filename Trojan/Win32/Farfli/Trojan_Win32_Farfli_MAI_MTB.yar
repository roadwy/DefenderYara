...
rule Trojan_Win32_Farfli_MAI_MTB{
	...
	strings :
		$a_03_0 = {8d 45 ec 89 65 f0 33 ff 50 c7 45 ec 02 00 00 80 8b 4d ec 6a 01 57 68 90 01 04 51 89 7d e0 89 7d c8 89 7d e4 89 7d e8 89 7d fc ff 15 90 00 } //1
		$a_03_1 = {81 ec 08 01 00 00 8b 8c 24 0c 01 00 00 56 57 8d 44 24 0c 68 04 01 00 00 50 51 c7 44 24 14 00 00 00 00 ff 15 90 01 04 6a 00 6a 00 6a 03 6a 00 6a 01 8d 54 24 20 68 00 00 00 80 52 ff 15 90 00 } //1
