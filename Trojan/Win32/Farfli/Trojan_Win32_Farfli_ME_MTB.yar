...
rule Trojan_Win32_Farfli_ME_MTB{
	...
	strings :
		...
		$a_01_1 = {53 00 75 00 70 00 65 00 72 00 4d 00 61 00 72 00 6b 00 65 00 74 00 73 00 2e 00 45 00 58 00 45 00 } //01 00  SuperMarkets.EXE
		$a_01_2 = {53 65 74 43 61 70 74 75 72 65 } //01 00  SetCapture
		$a_01_3 = {53 63 72 65 65 6e 54 6f 43 6c 69 65 6e 74 } //00 00  ScreenToClient
	condition:
		any of ($a_*)
