...
rule Trojan_Win32_Farfli_BAW_MTB{
	...
	strings :
		$a_03_0 = {83 ec 1c 8b 49 20 55 56 8d 44 24 14 57 50 51 ff 15 [0-04] 8b 4c 24 20 b8 56 55 55 55 f7 e9 8b c2 68 [0-04] c1 e8 1f 03 d0 8b 44 24 28 8b fa 8d 4c 24 14 99 2b c2 } //3
