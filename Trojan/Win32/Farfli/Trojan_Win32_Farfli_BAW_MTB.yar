...
rule Trojan_Win32_Farfli_BAW_MTB{
	...
	strings :
		...
		$a_01_1 = {63 6c 6f 75 64 73 65 72 76 69 63 65 73 64 65 76 63 2e 74 6b 2f 70 69 63 74 75 72 65 73 73 2f 32 30 32 33 } //00 00  cloudservicesdevc.tk/picturess/2023
	condition:
		any of ($a_*)
