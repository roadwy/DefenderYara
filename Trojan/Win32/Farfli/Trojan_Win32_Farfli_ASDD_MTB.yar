...
rule Trojan_Win32_Farfli_ASDD_MTB{
	...
	strings :
		...
		$a_03_1 = {ff 43 c6 85 [0-02] ff ff 6f c6 85 [0-02] ff ff 6e c6 85 [0-02] ff ff 6e c6 85 [0-02] ff ff 65 c6 85 [0-02] ff ff 63 c6 85 [0-02] ff ff 74 c6 85 [0-02] ff ff 47 c6 85 [0-02] ff ff 72 c6 85 } //1
	condition:
