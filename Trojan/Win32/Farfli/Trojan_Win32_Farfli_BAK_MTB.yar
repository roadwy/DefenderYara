...
rule Trojan_Win32_Farfli_BAK_MTB{
	...
	strings :
		...
		$a_01_2 = {5b 43 4c 45 41 52 5d } //01 00  [CLEAR]
		$a_01_3 = {5b 42 41 43 4b 53 50 41 43 45 5d } //01 00  [BACKSPACE]
		$a_01_4 = {5b 44 45 4c 45 54 45 5d } //01 00  [DELETE]
		$a_01_5 = {5b 49 4e 53 45 52 54 5d } //01 00  [INSERT]
		$a_01_6 = {5b 4e 75 6d 20 4c 6f 63 6b 5d } //01 00  [Num Lock]
		$a_01_7 = {46 55 43 4b 20 59 4f 55 } //00 00  FUCK YOU
	condition:
		any of ($a_*)
