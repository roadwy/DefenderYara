...
rule Trojan_Win32_Farfli_BAQ_MTB{
	...
	strings :
		...
		$a_01_1 = {43 3a 5c 32 2e 74 78 74 } //01 00 
		$a_01_2 = {5b 49 6e 73 65 72 74 5d } //01 00 
		$a_01_3 = {5b 53 63 72 6f 6c 6c 20 4c 6f 63 6b 5d } //01 00 
		$a_01_4 = {5b 50 72 69 6e 74 20 53 63 72 65 65 6e 5d } //00 00 
	condition:
		any of ($a_*)
