...
rule Trojan_Win32_Farfli_CCGF_MTB{
	...
	strings :
		$a_03_0 = {ff d3 0f 28 05 90 01 04 6a 18 0f 11 45 c8 c7 45 90 01 01 63 2f 2f 44 c7 45 90 01 01 6f 63 75 6d c7 45 90 01 01 65 6e 74 73 66 c7 45 90 01 01 2f 2f c6 45 e6 00 ff d3 90 00 } //1
