...
rule Trojan_Win32_Farfli_RPX_MTB{
	...
	strings :
		$a_01_0 = {09 c9 01 ff 8d 14 02 8b 12 81 e2 ff 00 00 00 81 c0 01 00 00 00 09 f9 } //1
	condition:
		((#a_01_0  & 1)*1) >=1
...
rule Trojan_Win32_Farfli_RPX_MTB_4{
	...
	strings :
		$a_01_0 = {8b 45 f8 83 c0 01 89 45 f8 8b 4d ff 81 e1 ff 00 00 00 8b 55 fe 81 e2 ff 00 00 00 0b ca 85 c9 } //1
	condition:
		((#a_01_0  & 1)*1) >=1
...
rule Trojan_Win32_Farfli_RPX_MTB_5{
	...
	strings :
		$a_01_0 = {8b d8 89 5c 24 50 85 db 74 78 33 c0 80 34 30 63 40 3d 8c 03 00 00 72 f4 8d 44 24 14 50 6a 00 6a 00 56 } //1
	condition:
		((#a_01_0  & 1)*1) >=1
...
rule Trojan_Win32_Farfli_RPX_MTB_7{
	...
	strings :
		$a_01_0 = {c6 44 24 2c 4b c6 44 24 2e 52 c6 44 24 2f 4e c6 44 24 31 4c c6 44 24 32 33 c6 44 24 33 32 c6 44 24 34 2e c6 44 24 35 64 c6 44 24 38 00 c6 44 24 1c 56 c6 44 24 1d 69 c6 44 24 1e 72 c6 44 24 1f 74 c6 44 24 20 75 c6 44 24 21 61 c6 44 24 23 41 c6 44 24 26 6f c6 44 24 27 63 c6 44 24 28 00 } //1
	condition:
		((#a_01_0  & 1)*1) >=1
