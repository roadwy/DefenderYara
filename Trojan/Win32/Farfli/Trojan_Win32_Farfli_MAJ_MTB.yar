...
rule Trojan_Win32_Farfli_MAJ_MTB{
	...
	strings :
		$a_00_0 = {8b 44 24 04 53 56 6a 00 6a 00 6a 02 6a 00 6a 01 68 00 00 00 40 50 32 db ff 15 } //1
		...
		$a_01_3 = {63 6d 64 20 2f 43 20 20 72 65 67 65 64 69 74 20 2f 73 20 55 61 63 2e 72 65 67 } //1 cmd /C  regedit /s Uac.reg
		...
		$a_01_7 = {5b 50 61 75 73 65 20 42 72 65 61 6b 5d } //1 [Pause Break]
		$a_01_8 = {5b 42 41 43 4b 53 50 41 43 45 5d } //1 [BACKSPACE]
