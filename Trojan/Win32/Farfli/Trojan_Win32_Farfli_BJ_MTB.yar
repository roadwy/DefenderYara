...
rule Trojan_Win32_Farfli_BJ_MTB{
	...
	strings :
		...
		$a_01_2 = {50 72 6f 67 72 61 6d 20 46 69 6c 65 73 5c 43 6f 6d 6d 6f 6e 20 46 69 6c 65 73 5c 73 63 76 68 30 73 74 2e 65 78 65 } //01 00 
		$a_01_3 = {66 75 63 6b 79 6f 75 } //00 00 
	condition:
		any of ($a_*)
