...
rule Trojan_Win32_Farfli_MB_MTB{
	...
	strings :
		...
		$a_81_2 = {53 6c 65 65 70 } //01 00 
		$a_81_3 = {47 65 74 41 73 79 6e 63 4b 65 79 53 74 61 74 65 } //01 00 
		$a_00_4 = {5b 43 4c 45 41 52 5d } //01 00 
		$a_00_5 = {5b 42 41 43 4b 53 50 41 43 45 5d } //01 00 
		$a_00_6 = {5b 44 6f 77 6e 5d } //01 00 
		$a_00_7 = {5b 52 69 67 68 74 5d } //01 00 
		$a_00_8 = {5b 4c 65 66 74 5d } //01 00 
		$a_00_9 = {5b 45 6e 64 5d } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Farfli_MB_MTB_2{
	...
	strings :
		...
		$a_01_5 = {47 65 74 54 68 72 65 61 64 50 72 69 6f 72 69 74 79 } //00 00 
	condition:
		any of ($a_*)
