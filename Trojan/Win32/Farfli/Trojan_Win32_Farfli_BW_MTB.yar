...
rule Trojan_Win32_Farfli_BW_MTB{
	...
	strings :
		...
		$a_01_1 = {43 3a 5c 50 72 6f 67 72 61 6d 44 61 74 61 5c 31 2e 74 78 74 } //01 00 
		$a_01_2 = {31 30 33 2e 35 39 2e 31 30 33 2e 31 36 2f 53 48 45 4c 4c 2e 74 78 74 } //00 00 
	condition:
		any of ($a_*)
