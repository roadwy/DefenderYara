...
rule Trojan_Win32_Farfli_ASDC_MTB{
	...
	strings :
		...
		$a_01_1 = {43 3a 5c 50 72 6f 67 72 61 6d 20 46 69 6c 65 73 5c 43 6f 6d 6d 6f 6e 20 46 69 6c 65 73 5c 73 63 76 68 6f 73 74 2e 65 78 65 } //00 00  C:\Program Files\Common Files\scvhost.exe
	condition:
		any of ($a_*)
