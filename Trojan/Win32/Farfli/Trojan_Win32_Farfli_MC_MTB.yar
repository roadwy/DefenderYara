...
rule Trojan_Win32_Farfli_MC_MTB_2{
	...
	strings :
		...
		$a_01_1 = {43 6f 6f 6b 69 65 3a 20 25 73 } //02 00 
		$a_01_2 = {61 6e 6f 6e 79 6d 6f 75 73 40 31 32 33 2e 63 6f 6d } //02 00 
		$a_01_3 = {5c 73 68 65 6c 6c 5c 6f 70 65 6e 5c 63 6f 6d 6d 61 6e 64 } //01 00 
		$a_01_4 = {47 65 74 53 63 72 6f 6c 6c 50 6f 73 } //01 00 
		$a_01_5 = {49 73 57 6f 77 36 34 50 72 6f 63 65 73 73 } //00 00 
	condition:
		any of ($a_*)
