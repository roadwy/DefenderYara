...
rule Trojan_Win32_Farfli_FF_MTB{
	...
	strings :
		...
		$a_01_3 = {68 74 74 70 3a 2f 2f 77 77 77 2e 77 6a 6d 73 68 6f 6d 65 2e 63 6f 6d 2f 53 65 63 72 65 74 43 68 61 74 2e 68 74 6d } //01 00 
		$a_01_4 = {77 77 77 2e 73 77 6f 72 64 61 61 2e 63 6f 6d } //01 00 
		$a_01_5 = {6d 61 69 6c 74 6f 3a 77 65 62 6d 61 73 74 65 72 40 77 6a 6d 73 68 6f 6d 65 2e 63 6f 6d 3f } //00 00 
	condition:
		any of ($a_*)
