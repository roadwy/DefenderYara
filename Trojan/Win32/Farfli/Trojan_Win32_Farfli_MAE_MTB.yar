...
rule Trojan_Win32_Farfli_MAE_MTB{
	...
	strings :
		...
		$a_01_2 = {44 6c 6c 55 70 64 61 74 65 } //01 00 
		$a_01_3 = {53 65 72 76 69 63 65 4d 61 69 6e } //01 00 
		$a_01_4 = {55 6e 69 6e 73 74 61 6c 6c } //01 00 
		$a_01_5 = {4d 61 69 6e 44 6c 6c 2e 64 6c 6c } //01 00 
		$a_01_6 = {53 4f 46 54 57 41 52 45 5c 4d 69 63 72 6f 73 6f 66 74 5c 57 69 6e 64 6f 77 73 20 4e 54 5c 43 75 72 72 65 6e 74 56 65 72 73 69 6f 6e 5c 53 76 63 68 6f 73 74 } //01 00 
