...
rule Trojan_Win32_SuspShadowDelete_E{
	...
	strings :
		$a_00_0 = {77 00 69 00 6e 00 33 00 32 00 5f 00 73 00 68 00 61 00 64 00 6f 00 77 00 63 00 6f 00 70 00 79 00 } //01 00 
		$a_00_1 = {64 00 65 00 6c 00 65 00 74 00 65 00 } //fb ff 
