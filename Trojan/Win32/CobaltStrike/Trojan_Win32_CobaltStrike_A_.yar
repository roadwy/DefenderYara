...
rule Trojan_Win32_CobaltStrike_A__5{
	...
	strings :
		...
		$a_01_2 = {25 63 25 63 25 63 25 63 25 63 25 63 25 63 25 63 25 63 4d 53 53 45 2d 25 64 2d 73 65 72 76 65 72 } //00 00  %c%c%c%c%c%c%c%c%cMSSE-%d-server
	condition:
		any of ($a_*)
...
rule Trojan_Win32_CobaltStrike_A__7{
	...
	strings :
		...
		$a_01_3 = {25 63 25 63 25 63 25 63 25 63 25 63 25 63 25 63 25 63 4d 53 53 45 2d 25 64 2d 73 65 72 76 65 72 } //00 00  %c%c%c%c%c%c%c%c%cMSSE-%d-server
	condition:
		any of ($a_*)
...
rule Trojan_Win32_CobaltStrike_A__17{
	...
	strings :
		$a_81_0 = {63 6f 75 6c 64 20 6e 6f 74 20 72 75 6e 20 63 6f 6d 6d 61 6e 64 20 28 77 2f 20 74 6f 6b 65 6e 29 20 62 65 63 61 75 73 65 20 6f 66 20 69 74 73 20 6c 65 6e 67 74 68 20 6f 66 20 25 64 20 62 79 74 65 73 21 } //01 00  could not run command (w/ token) because of its length of %d bytes!
		$a_81_1 = {63 6f 75 6c 64 20 6e 6f 74 20 73 70 61 77 6e 20 25 73 20 28 74 6f 6b 65 6e 29 3a 20 25 64 } //01 00  could not spawn %s (token): %d
		$a_81_2 = {49 27 6d 20 61 6c 72 65 61 64 79 20 69 6e 20 53 4d 42 20 6d 6f 64 65 } //01 00  I'm already in SMB mode
		$a_81_3 = {70 6f 77 65 72 73 68 65 6c 6c 20 2d 6e 6f 70 20 2d 65 78 65 63 20 62 79 70 61 73 73 20 2d 45 6e 63 6f 64 65 64 43 6f 6d 6d 61 6e 64 20 22 25 73 22 } //00 00  powershell -nop -exec bypass -EncodedCommand "%s"
	condition:
		any of ($a_*)
...
rule Trojan_Win32_CobaltStrike_A__19{
	...
	strings :
		...
		$a_01_3 = {52 65 66 6c 65 63 74 69 76 65 4c 6f 61 64 65 72 } //01 00  ReflectiveLoader
		$a_01_4 = {5c 5c 2e 5c 70 69 70 65 5c 73 73 68 61 67 65 6e 74 } //01 00  \\.\pipe\sshagent
		$a_01_5 = {63 6f 6e 6e 65 63 74 20 74 6f 20 25 73 3a 25 64 20 66 61 69 6c 65 64 3a 20 25 73 00 } //01 00  潣湮捥⁴潴┠㩳搥映楡敬㩤┠s
		$a_00_6 = {43 4f 42 41 4c 54 53 54 52 49 4b 45 } //01 00  COBALTSTRIKE
		$a_01_7 = {25 31 30 32 34 5b 5e 20 5d 20 25 38 5b 5e 3a 5d 3a 2f 2f 25 31 30 31 36 5b 5e 2f 5d 25 37 31 36 38 } //00 00  %1024[^ ] %8[^:]://%1016[^/]%7168
	condition:
		any of ($a_*)
...
rule Trojan_Win32_CobaltStrike_A__21{
	...
	strings :
		...
		$a_01_6 = {52 65 66 6c 65 63 74 69 76 65 4c 6f 61 64 65 72 } //00 00  ReflectiveLoader
	condition:
		any of ($a_*)
...
rule Trojan_Win32_CobaltStrike_A__25{
	...
	strings :
		...
		$a_01_26 = {5c 5c 25 73 5c 69 70 63 24 00 } //00 00  屜猥楜捰$
	condition:
		any of ($a_*)
...
rule Trojan_Win32_CobaltStrike_A__26{
	...
	strings :
		...
		$a_01_19 = {5c 5c 2e 5c 70 69 70 65 5c 73 63 72 65 65 6e 73 68 6f 74 } //01 00  \\.\pipe\screenshot
		$a_01_20 = {00 4a 50 45 47 4d 45 4d 00 } //01 00 
		$a_01_21 = {5c 5c 2e 5c 70 69 70 65 5c 6d 69 6d 69 6b 61 74 7a } //01 00  \\.\pipe\mimikatz
		$a_01_22 = {74 6f 6b 65 6e 3a 3a 65 6c 65 76 61 74 65 } //01 00  token::elevate
		$a_01_23 = {5c 5c 2e 5c 70 69 70 65 5c 68 61 73 68 64 75 6d 70 } //01 00  \\.\pipe\hashdump
		$a_01_24 = {47 6c 6f 62 61 6c 5c 53 41 4d } //01 00  Global\SAM
		$a_01_25 = {5c 5c 2e 5c 70 69 70 65 5c 65 6c 65 76 61 74 65 } //01 00  \\.\pipe\elevate
		$a_01_26 = {5b 2a 5d 20 25 73 20 6c 6f 61 64 65 64 20 69 6e 20 75 73 65 72 73 70 61 63 65 } //01 00  [*] %s loaded in userspace
		$a_01_27 = {5c 5c 2e 5c 70 69 70 65 5c 70 6f 72 74 73 63 61 6e } //01 00  \\.\pipe\portscan
		$a_01_28 = {5c 5c 25 73 5c 69 70 63 24 00 } //00 00  屜猥楜捰$
	condition:
		any of ($a_*)
