...
rule Trojan_Win32_CobaltStrike_A_{
	...
	strings :
		$a_03_0 = {e8 00 00 00 00 5b 89 df 52 45 55 89 e5 81 c3 90 01 04 ff d3 68 f0 b5 a2 56 68 04 00 00 00 57 ff d0 90 00 } //1
		$a_03_1 = {6a 40 68 00 30 00 00 57 6a 00 ff 75 08 ff 15 90 01 04 8b f0 85 f6 74 90 01 01 8d 45 fc 50 57 ff 75 f8 56 ff 75 08 ff 15 90 00 } //1
	condition:
...
rule Trojan_Win32_CobaltStrike_A__2{
	...
	strings :
		$a_03_0 = {41 52 55 48 89 e5 48 81 ec 20 00 00 00 48 8d 1d ea ff ff ff 48 89 df 48 81 c3 90 01 04 ff d3 41 b8 90 01 04 68 04 00 00 00 5a 48 89 f9 ff d0 00 00 00 00 00 00 00 00 90 00 } //1
		$a_01_1 = {41 b9 00 30 00 00 4d 8b c7 33 d2 48 8b cf c7 44 24 20 40 00 00 00 ff 15 } //1
	condition:
...
rule Trojan_Win32_CobaltStrike_A__3{
	...
	strings :
		$a_01_0 = {fc 48 83 e4 f0 e8 c8 00 00 00 41 51 41 50 52 51 56 48 31 d2 65 48 8b 52 60 48 8b 52 18 48 8b 52 20 48 8b 72 50 48 0f b7 4a 4a } //1
...
rule Trojan_Win32_CobaltStrike_A__5{
	...
	strings :
		$a_03_0 = {41 b9 00 10 00 00 4c 8d 87 80 00 00 00 48 89 d6 c7 44 24 20 04 00 00 00 31 d2 ff 15 90 01 04 48 89 c5 48 8d 44 24 50 4d 89 e0 49 89 f9 48 89 ea 48 89 d9 48 89 44 24 20 ff 15 90 00 } //1
...
rule Trojan_Win32_CobaltStrike_A__7{
	...
	strings :
		$a_03_0 = {41 b8 00 30 00 00 31 c9 48 89 f7 ff 15 90 01 04 48 89 c3 31 c0 39 f8 7d 16 48 89 c2 83 e2 03 41 8a 14 14 32 54 05 00 88 14 03 48 ff c0 eb e6 90 00 } //1
		$a_01_1 = {c7 44 24 48 65 00 00 00 c7 44 24 40 70 00 00 00 c7 44 24 38 69 00 00 00 c7 44 24 30 70 00 00 00 } //1
		$a_03_2 = {b9 60 ea 00 00 ff d3 eb f7 90 02 10 48 ff e1 90 00 } //1
...
rule Trojan_Win32_CobaltStrike_A__8{
	...
	strings :
		...
		$a_03_1 = {41 b8 20 00 00 00 ff 15 90 01 04 4c 8d 90 01 04 90 01 01 49 89 d9 31 d2 31 c9 48 c7 44 24 28 00 00 00 00 c7 44 24 20 00 00 00 00 ff 15 90 00 } //1
...
rule Trojan_Win32_CobaltStrike_A__12{
	...
	strings :
		...
		$a_03_1 = {8e 4e 0e ec 74 90 01 01 81 7d 90 01 01 aa fc 0d 7c 74 90 01 01 81 7d 90 01 01 54 ca af 91 74 90 00 } //1
		$a_01_2 = {0f b7 40 16 25 00 80 00 00 74 09 c7 45 f0 40 00 00 00 eb 07 c7 45 f0 04 00 00 00 83 65 c0 00 } //1
		$a_01_3 = {ff 75 f0 68 00 30 00 00 8b 45 f4 ff 70 50 6a 00 ff 55 } //1
		$a_01_4 = {83 7d 9c 40 73 19 0f b6 45 a7 8b 4d 98 03 4d 9c 0f b6 09 33 c8 8b 45 98 03 45 9c 88 08 eb da } //1
	condition:
		((#a_03_0  & 1)*1+(#a_03_1  & 1)*1+(#a_01_2  & 1)*1+(#a_01_3  & 1)*1+(#a_01_4  & 1)*1) >=5
...
rule Trojan_Win32_CobaltStrike_A__14{
	...
	strings :
		$a_03_0 = {48 ff e1 41 54 55 57 56 53 48 83 ec 40 41 b9 04 00 00 00 48 63 f2 48 89 cd 90 02 15 41 b8 00 30 00 00 90 00 } //1
		$a_03_1 = {4c 8d 4c 24 3c 48 89 f2 48 89 d9 41 b8 20 00 00 00 ff 15 90 01 04 4c 8d 90 01 02 ff ff ff 49 89 d9 31 d2 31 c9 48 c7 44 24 28 00 00 00 00 c7 44 24 20 00 00 00 00 ff 15 90 01 04 90 90 48 83 c4 40 90 00 } //1
		$a_01_2 = {c7 44 24 48 65 00 00 00 c7 44 24 40 70 00 00 00 c7 44 24 38 69 00 00 00 c7 44 24 30 70 00 00 00 } //1
		$a_01_3 = {25 63 25 63 25 63 25 63 25 63 25 63 25 63 25 63 25 63 4d 53 53 45 2d 25 64 2d 73 65 72 76 65 72 } //1 %c%c%c%c%c%c%c%c%cMSSE-%d-server
	condition:
...
rule Trojan_Win32_CobaltStrike_A__15{
	...
	strings :
		...
		$a_01_3 = {4d 00 61 00 6c 00 77 00 61 00 72 00 65 00 64 00 65 00 74 00 65 00 63 00 74 00 69 00 6f 00 6e 00 68 00 65 00 6c 00 70 00 65 00 72 00 00 00 } //65436
		$a_01_4 = {4f 00 75 00 74 00 62 00 79 00 74 00 65 00 20 00 50 00 43 00 20 00 52 00 65 00 70 00 61 00 69 00 72 00 00 00 } //65436
	condition:
		((#a_01_0  & 1)*1+(#a_01_1  & 1)*1+(#a_01_2  & 1)*1+(#a_01_3  & 1)*65436+(#a_01_4  & 1)*65436) >=3
...
rule Trojan_Win32_CobaltStrike_A__16{
	...
	strings :
		$a_03_0 = {55 89 e5 8b 45 08 5d ff e0 55 89 e5 90 02 20 c7 44 24 0c 04 00 00 00 c7 44 24 08 00 30 00 00 c7 04 24 00 00 00 00 90 00 } //1
		$a_03_1 = {c7 44 24 08 20 00 00 00 89 44 24 0c ff 15 90 01 04 83 ec 10 89 90 01 01 24 0c c7 44 24 14 00 00 00 00 c7 44 24 10 00 00 00 00 c7 44 24 08 90 01 04 c7 44 24 04 00 00 00 00 c7 04 24 00 00 00 00 ff 15 90 00 } //1
		$a_01_2 = {c7 44 24 24 65 00 00 00 c7 44 24 20 70 00 00 00 c7 44 24 1c 69 00 00 00 c7 44 24 18 70 00 00 00 } //1
		$a_01_3 = {25 63 25 63 25 63 25 63 25 63 25 63 25 63 25 63 25 63 4d 53 53 45 2d 25 64 2d 73 65 72 76 65 72 } //1 %c%c%c%c%c%c%c%c%cMSSE-%d-server
	condition:
		((#a_03_0  & 1)*1+(#a_03_1  & 1)*1+(#a_01_2  & 1)*1+(#a_01_3  & 1)*1) >=4
...
rule Trojan_Win32_CobaltStrike_A__21{
	...
	strings :
		...
		$a_01_1 = {0f b7 40 16 25 00 80 00 00 74 09 c7 45 f0 40 00 00 00 eb 07 c7 45 f0 04 00 00 00 83 65 c0 00 } //1
...
rule Trojan_Win32_CobaltStrike_A__23{
	...
	strings :
		$a_01_0 = {fc e8 89 00 00 00 60 89 e5 31 d2 64 8b 52 30 8b 52 0c 8b 52 14 8b 72 28 0f b7 4a 26 } //1
...
rule Trojan_Win32_CobaltStrike_A__25{
	meta:
		description = "Trojan:Win32/CobaltStrike.A!!CobaltStrike.gen!A,SIGNATURE_TYPE_ARHSTR_EXT,34 00 34 00 1b 00 00 "
...
rule Trojan_Win32_CobaltStrike_A__26{
	meta:
		description = "Trojan:Win32/CobaltStrike.A!!CobaltStrike.gen!A,SIGNATURE_TYPE_ARHSTR_EXT,34 00 34 00 1d 00 00 "
