...
rule Trojan_Win32_CobaltStrike_A__9{
	...
	strings :
		$a_03_0 = {6a 00 6a 01 6a 02 e8 [0-30] 6a 02 58 ff 75 08 66 89 45 ec e8 [0-40] 6a 78 56 ff 15 } //1
		$a_03_1 = {8e 4e 0e ec 74 ?? 81 7d ?? aa fc 0d 7c 74 ?? 81 7d ?? 54 ca af 91 74 } //1
...
rule Trojan_Win32_CobaltStrike_A__12{
	...
	strings :
		$a_03_0 = {4d 5a e8 00 00 00 00 5b 89 df 52 45 55 89 e5 81 c3 ?? ?? 00 00 ff d3 68 f0 b5 a2 56 68 04 00 00 00 57 ff d0 } //1
		$a_03_1 = {8e 4e 0e ec 74 ?? 81 7d ?? aa fc 0d 7c 74 ?? 81 7d ?? 54 ca af 91 74 } //1
...
rule Trojan_Win32_CobaltStrike_A__18{
	...
	strings :
		$a_03_0 = {4d 5a 41 52 55 48 89 e5 48 81 ec 20 00 00 00 48 8d 1d ea ff ff ff 48 89 df 48 81 c3 ?? ?? ?? ?? ff d3 41 b8 f0 b5 a2 56 68 04 00 00 00 5a 48 89 f9 ff d0 } //1
		$a_03_1 = {81 f9 8e 4e 0e ec 74 ?? 81 f9 aa fc 0d 7c 74 ?? 81 f9 54 ca af 91 74 } //1
...
rule Trojan_Win32_CobaltStrike_A__19{
	...
	strings :
		...
		$a_03_1 = {8e 4e 0e ec 74 ?? 81 ?? aa fc 0d 7c 74 ?? 81 ?? 54 ca af 91 } //10
		$a_03_2 = {3c 33 c9 41 b8 00 30 00 00 4c 03 ?? 44 8d 49 40 41 8b } //10
...
rule Trojan_Win32_CobaltStrike_A__20{
	...
	strings :
		$a_03_0 = {75 b1 81 7d ?? 5b bc 4a 6a 75 0b } //10
		$a_03_1 = {8e 4e 0e ec 74 ?? 81 7d ?? aa fc 0d 7c 74 ?? 81 7d ?? 54 ca af 91 } //10
		$a_03_2 = {6a 40 68 00 30 00 00 8b ?? ?? 8b ?? ?? ?? 6a 00 ff 55 } //10
		$a_01_3 = {52 65 66 6c 65 63 74 69 76 65 4c 6f 61 64 65 72 } //10 ReflectiveLoader
		$a_01_4 = {5c 5c 2e 5c 70 69 70 65 5c 73 73 68 61 67 65 6e 74 } //1 \\.\pipe\sshagent
		$a_01_5 = {63 6f 6e 6e 65 63 74 20 74 6f 20 25 73 3a 25 64 20 66 61 69 6c 65 64 3a 20 25 73 00 } //1 潣湮捥⁴潴┠㩳搥映楡敬㩤┠s
		$a_00_6 = {43 4f 42 41 4c 54 53 54 52 49 4b 45 } //1 COBALTSTRIKE
...
rule Trojan_Win32_CobaltStrike_A__21{
	...
	strings :
		$a_03_0 = {8e 4e 0e ec 74 ?? 81 7d ?? aa fc 0d 7c 74 ?? 81 7d ?? 54 ca af 91 74 } //1
		...
		$a_03_4 = {83 c4 10 33 c0 80 b0 ?? ?? ?? ?? 69 40 3d 00 10 00 00 7c f1 68 00 10 00 00 b9 ?? ?? ?? ?? 8d 44 24 14 e8 } //1
...
rule Trojan_Win32_CobaltStrike_A__23{
	...
	strings :
		...
		$a_03_2 = {eb 86 5d 68 33 32 00 00 68 77 73 32 5f 54 68 4c 77 26 07 ff d5 b8 90 00 29 c4 54 50 68 29 80 6b 00 ff d5 50 [0-08] 50 68 ea 0f df e0 ff d5 } //1
...
rule Trojan_Win32_CobaltStrike_A__24{
	...
	strings :
		$a_03_0 = {81 f9 8e 4e 0e ec 74 ?? 81 f9 aa fc 0d 7c 74 ?? 81 f9 54 ca af 91 74 } //10
...
rule Trojan_Win32_CobaltStrike_A__26{
	...
	strings :
		$a_03_0 = {81 f9 5b bc 4a 6a 0f 85 ?? 00 00 00 49 } //10
		$a_03_1 = {81 f9 8e 4e 0e ec 74 ?? 81 f9 aa fc 0d 7c 74 ?? 81 f9 54 ca af 91 } //10
		$a_01_2 = {b8 0a 4c 53 75 } //10
