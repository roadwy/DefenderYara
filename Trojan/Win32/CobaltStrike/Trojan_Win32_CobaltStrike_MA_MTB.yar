...
rule Trojan_Win32_CobaltStrike_MA_MTB_2{
	...
	strings :
		$a_01_0 = {34 00 33 00 2e 00 31 00 33 00 38 00 2e 00 33 00 30 00 2e 00 37 00 36 00 } //03 00 
		$a_01_1 = {2f 00 6c 00 6f 00 67 00 67 00 69 00 6e 00 67 00 2e 00 62 00 69 00 6e 00 } //02 00 
