...
rule Trojan_Win32_CobaltStrike_MA_MTB{
	...
	strings :
		$a_03_0 = {8b 45 fc 83 c0 01 89 45 fc 83 7d fc 90 01 01 73 14 8b 4d fc 0f be 54 0d e0 83 f2 44 8b 45 fc 88 54 05 e0 eb dd 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_Win32_CobaltStrike_MA_MTB_2{
	...
	strings :
		$a_03_0 = {ff 77 04 ff d6 59 85 c0 59 0f 84 90 01 04 68 90 01 04 ff 77 04 ff d6 59 85 c0 59 0f 84 90 01 04 68 90 01 04 ff 77 04 ff d6 59 85 c0 59 0f 84 90 01 04 68 90 01 04 ff 77 04 ff d6 59 85 c0 59 0f 84 90 00 } //10
	condition:
		((#a_03_0  & 1)*10) >=10
...
rule Trojan_Win32_CobaltStrike_MA_MTB_4{
	...
	strings :
		$a_03_0 = {8d 4a 01 89 08 8b 4c 90 90 90 02 01 89 ca c1 ea 90 02 01 23 90 90 90 02 02 00 00 31 ca 89 d0 c1 e0 90 02 01 25 90 02 04 31 d0 89 c1 c1 e1 90 02 01 81 e1 90 02 04 31 c1 89 c8 c1 e8 90 02 01 31 c8 90 00 } //1
