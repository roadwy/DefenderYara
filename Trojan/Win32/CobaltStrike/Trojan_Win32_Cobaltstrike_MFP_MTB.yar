...
rule Trojan_Win32_Cobaltstrike_MFP_MTB{
	...
	strings :
		$a_02_0 = {33 c0 33 c9 0f a2 44 8b c1 45 33 db 44 8b cb 41 81 f0 6e 74 65 6c 41 81 f1 47 65 6e 75 44 8b d2 8b f0 33 c9 41 8d ?? ?? 45 0b c8 0f a2 41 81 f2 } //5
		$a_02_1 = {66 0f 6e c3 8b fb f3 0f e6 c0 be 02 ?? ?? ?? e8 ?? ?? ?? ?? 66 0f 2f 05 ?? ?? ?? ?? 72 ?? 8b c7 99 f7 fe 85 d2 0f 45 c7 ff c6 8b f8 66 0f 6e c0 f3 0f e6 c0 66 0f 6e f6 f3 0f e6 f6 e8 66 66 01 00 66 0f 2f c6 73 ?? ff c3 81 fb 7f 84 1e 00 7c } //5
