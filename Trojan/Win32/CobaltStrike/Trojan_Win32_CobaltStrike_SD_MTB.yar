...
rule Trojan_Win32_CobaltStrike_SD_MTB{
	...
	strings :
		...
		$a_01_4 = {54 00 68 00 72 00 65 00 61 00 74 00 5f 00 53 00 6f 00 6e 00 61 00 72 00 } //-10 Threat_Sonar
		$a_03_5 = {73 6f 6e 61 72 5f 6c 65 76 65 6c 90 02 04 6d 61 6c 77 61 72 65 5f 66 61 6d 69 6c 79 90 00 } //-10
	condition:
