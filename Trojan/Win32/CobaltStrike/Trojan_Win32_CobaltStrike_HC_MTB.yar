...
rule Trojan_Win32_CobaltStrike_HC_MTB{
	...
	strings :
		$a_03_0 = {8b 45 e4 83 c0 01 89 45 e4 8b 4d e4 3b 4d b0 73 27 8b 55 e4 0f b6 8a 90 01 04 8b 45 e4 33 d2 be 90 01 04 f7 f6 0f b6 54 15 90 01 01 33 ca 8b 45 f0 03 45 e4 88 08 eb 90 00 } //10
