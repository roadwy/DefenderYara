...
rule Trojan_Win32_CobaltStrike_E_ibt{
	...
	strings :
		...
		$a_03_4 = {8e 4e 0e ec 74 90 01 01 81 90 01 02 aa fc 0d 7c 74 90 01 01 81 90 01 02 54 ca af 91 74 90 01 01 81 90 01 02 1b c6 46 79 74 90 01 01 81 90 01 02 fc a4 53 07 74 90 01 01 81 90 01 02 04 49 32 d3 0f 90 00 } //1
	condition:
