...
rule Trojan_Win32_CobaltStrike_DY_MTB{
	meta:
		description = "Trojan:Win32/CobaltStrike.DY!MTB,SIGNATURE_TYPE_PEHSTR_EXT,01 00 01 00 01 00 00 01 00 "
		
	strings :
		$a_03_0 = {8b c1 33 d2 f7 75 f8 8a 44 15 90 01 01 30 44 0b 04 41 3b ce 72 ec 90 00 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win32_CobaltStrike_DY_MTB_2{
	...
	strings :
		...
		$a_01_1 = {48 55 42 20 44 4f 47 53 20 59 4f 55 52 53 45 4c 46 20 48 4f 4c 4c 4f 57 20 52 45 50 52 45 53 45 4e 54 20 4c 41 4e 44 53 20 4b 4e 4f 43 4b } //00 00  HUB DOGS YOURSELF HOLLOW REPRESENT LANDS KNOCK
	condition:
		any of ($a_*)
