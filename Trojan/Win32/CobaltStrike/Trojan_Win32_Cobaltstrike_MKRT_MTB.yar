...
rule Trojan_Win32_Cobaltstrike_MKRT_MTB{
	...
	strings :
		...
		$a_00_1 = {4c 6f 63 61 6c 5c 52 75 73 74 42 61 63 6b 74 72 61 63 65 4d 75 74 65 78 } //01 00  Local\RustBacktraceMutex
		$a_81_2 = {72 75 73 74 5f 65 68 5f 70 65 72 73 6f 6e 61 6c 69 74 79 } //00 00  rust_eh_personality
	condition:
		any of ($a_*)
