...
rule Trojan_Win32_CobaltStrike_CCDE_MTB{
	...
	strings :
		...
		$a_03_1 = {88 0e 0f b6 50 90 01 01 0f b6 54 94 90 01 01 0f b6 48 90 01 01 c0 e2 90 01 01 0a 54 8c 90 01 01 83 c6 90 01 01 88 56 fe 83 c0 90 01 01 83 ef 90 01 01 75 90 00 } //1
	condition:
