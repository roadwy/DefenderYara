...
rule Trojan_Win32_Cobaltstrike_HD_MTB{
	...
	strings :
		$a_03_0 = {43 3a 5c 55 73 65 72 73 5c 61 64 6d 69 6e 5c 44 65 73 6b 74 6f 70 [0-0a] 5c 43 6c 65 61 6e 55 70 5c 52 65 6c 65 61 73 65 5c 43 6c 65 61 6e 55 70 2e 70 64 62 } //10
