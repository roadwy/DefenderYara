...
rule Trojan_Win32_Adialer_OU{
	...
	strings :
		$a_02_0 = {7e 21 70 61 73 73 77 6f 72 64 90 02 02 21 7e 21 90 02 20 40 6f 63 65 61 6e 90 00 } //10
		$a_02_1 = {68 74 74 70 3a 2f 2f 77 77 77 2e 61 72 65 61 78 78 78 2e 62 69 7a 2f 90 02 10 2e 70 68 70 90 00 } //10
