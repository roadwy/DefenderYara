...
rule Trojan_Win32_Adialer{
	...
	strings :
		$a_00_0 = {6d 6f 64 65 6d } //01 00 
		$a_00_1 = {53 4f 46 54 57 41 52 45 5c 4d 69 63 72 6f 73 6f 66 74 5c 49 6e 74 65 72 6e 65 74 20 45 78 70 6c 6f 72 65 72 5c 4d 61 69 6e } //01 00 
		$a_00_2 = {4d 5a 4b 45 52 4e 45 4c 33 32 2e 44 4c 4c } //01 00 
		$a_00_3 = {6d 62 70 2d 72 2d 61 67 65 6e 74 } //01 00 
		$a_00_4 = {52 61 73 44 69 61 6c 41 } //01 00 
		$a_00_5 = {43 72 65 61 74 65 4d 75 74 65 78 } //01 00 
...
rule Trojan_Win32_Adialer_2{
	...
	strings :
		...
		$a_01_3 = {73 74 72 73 74 72 } //00 00 
	condition:
		any of ($a_*)
