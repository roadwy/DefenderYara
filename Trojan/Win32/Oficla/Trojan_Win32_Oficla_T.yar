...
rule Trojan_Win32_Oficla_T{
	...
	strings :
		$a_03_0 = {8d 55 ec b8 53 00 00 00 e8 90 01 04 ff 75 ec 8d 55 90 01 01 b8 90 03 01 01 59 6f 00 00 00 90 00 } //20
		$a_03_1 = {8a 0c 03 80 f1 90 01 01 88 0c 03 40 4a 75 f3 90 00 } //10
