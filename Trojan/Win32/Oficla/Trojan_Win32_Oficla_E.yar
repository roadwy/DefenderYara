...
rule Trojan_Win32_Oficla_E{
	...
	strings :
		$a_03_0 = {41 30 29 18 e8 90 01 04 8d 95 90 01 02 ff ff b9 20 00 00 00 90 00 } //1
		$a_03_1 = {ff 53 04 8d 93 90 01 02 00 00 83 ec 08 89 90 01 02 ff d0 83 e8 01 83 ec 04 83 f8 01 76 22 90 00 } //1
	condition:
...
rule Trojan_Win32_Oficla_E_2{
	...
	strings :
		$a_03_0 = {c7 44 24 2c 13 04 18 5d 8d 85 90 01 04 ff d0 85 c0 75 04 90 00 } //2
		$a_03_1 = {c7 44 24 2c 8b f7 08 3e 8d 85 90 01 04 ff d0 8b 54 24 40 52 ff d0 90 00 } //2
		$a_03_2 = {0f b6 02 83 90 01 01 01 83 c2 01 33 05 90 01 04 88 03 83 c3 01 3b 90 01 01 48 77 ff ff 75 e4 90 00 } //1
...
rule Trojan_Win32_Oficla_E_3{
	...
	strings :
		...
		$a_03_4 = {c7 44 24 0c 3f 00 0f 00 c7 44 24 08 00 00 00 00 c7 04 24 90 03 01 01 00 02 00 00 80 90 00 } //8
		$a_03_5 = {83 c2 01 30 01 83 c1 01 83 fa 10 75 ec 83 c3 10 81 fb 90 01 04 75 d0 90 00 } //1
		$a_01_6 = {80 7b ff 3f 74 06 c6 03 26 83 c3 01 } //1
		$a_03_7 = {83 f8 04 be 01 00 00 00 77 f6 ff 24 85 90 01 04 8d 45 f3 b9 7c 00 00 00 90 00 } //2
	condition:
