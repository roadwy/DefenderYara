...
rule Trojan_Win32_Oficla_E_3{
	...
	strings :
		$a_01_0 = {67 6c 61 76 00 70 72 65 70 75 73 6b 00 70 75 73 } //02 00  汧癡瀀敲異歳瀀獵
		$a_01_1 = {67 6c 6c 61 76 00 67 6c 6c 61 76 00 70 70 75 73 } //02 00  汧慬v汧慬v灰獵
		$a_01_2 = {67 74 74 61 76 00 67 74 74 61 76 00 70 70 75 73 } //02 00  瑧慴v瑧慴v灰獵
		$a_01_3 = {67 69 69 61 76 00 67 69 69 61 76 00 70 72 65 62 } //08 00  楧慩v楧慩v牰扥
