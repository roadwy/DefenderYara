...
rule Trojan_Win32_Oficla_O{
	...
	strings :
		$a_03_0 = {c6 45 f4 64 c6 45 f5 25 90 03 03 0a 83 c0 78 8d 44 49 03 8d 04 80 c1 e0 03 88 45 f6 c6 45 f7 00 c7 44 24 0c 90 01 04 c7 44 24 08 90 01 04 8d 45 f3 89 44 24 04 90 00 } //1
