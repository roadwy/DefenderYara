...
rule Trojan_Win32_Oficla_AI{
	...
	strings :
		$a_03_0 = {64 62 67 68 65 6c 70 2e 64 6c 6c 00 90 02 04 73 62 69 65 64 6c 6c 2e 64 6c 6c 00 90 00 } //2
		$a_01_1 = {69 6d 67 2e 70 68 70 3f 76 3d 31 26 69 64 3d } //2 img.php?v=1&id=
		$a_03_2 = {7a 65 6e 74 6f 77 6f 72 6c 64 5f 90 10 0a 00 5f 64 61 64 61 00 90 00 } //2
