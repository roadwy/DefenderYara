...
rule Trojan_Win32_Strab_GCW_MTB{
	...
	strings :
		$a_03_0 = {88 d0 30 c8 20 d0 88 d5 80 f5 90 01 01 88 e1 20 e9 80 f4 90 01 01 20 e2 08 d1 88 c2 20 ca 30 c8 08 c2 b8 90 01 04 b9 90 01 04 f6 c2 90 01 01 0f 45 c1 89 45 90 01 01 e9 90 00 } //10
