...
rule Trojan_Win32_Trilark_A_dha{
	...
	strings :
		$a_01_0 = {5f 00 5f 00 53 00 54 00 41 00 52 00 54 00 5f 00 4d 00 59 00 54 00 45 00 53 00 54 00 5f 00 4d 00 41 00 52 00 4b 00 75 00 75 00 75 00 69 00 69 00 5f 00 5f 00 } //02 00  __START_MYTEST_MARKuuuii__
