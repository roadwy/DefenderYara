...
rule Trojan_Win32_Thundershell_A{
	...
	strings :
		$a_03_0 = {8b 5c 24 14 e8 90 01 04 83 fb 01 74 05 83 fb 02 75 05 e8 90 00 } //10
		$a_03_1 = {81 c1 01 10 00 00 89 94 24 1c 10 00 00 90 02 08 c1 e9 02 f3 a5 85 d2 90 00 } //10
