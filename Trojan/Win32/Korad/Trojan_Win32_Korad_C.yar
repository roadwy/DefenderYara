...
rule Trojan_Win32_Korad_C{
	...
	strings :
		$a_03_0 = {ff ff 27 c6 85 90 01 02 ff ff 6c c6 85 90 01 02 ff ff 6a c6 85 90 01 02 ff ff 6f c6 85 90 01 02 ff ff 65 90 00 } //5
		$a_03_1 = {27 6c 6a 6f c7 90 01 05 65 3e 35 00 e8 90 00 } //5
