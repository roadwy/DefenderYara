...
rule Trojan_Win32_BigpipeLoader_MA_MTB{
	...
	strings :
		...
		$a_01_1 = {43 72 79 70 74 44 65 63 72 79 70 74 } //01 00  CryptDecrypt
		$a_01_2 = {4e 74 51 75 65 72 79 49 6e 66 6f 72 6d 61 74 69 6f 6e 50 72 6f 63 65 73 73 } //00 00  NtQueryInformationProcess
	condition:
		any of ($a_*)
