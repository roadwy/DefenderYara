...
rule Trojan_Win32_Emotet_P_{
	meta:
		description = "Trojan:Win32/Emotet.P!!Emotet.gen!A,SIGNATURE_TYPE_ARHSTR_EXT,0a 00 0a 00 1e 00 00 04 00 "
...
rule Trojan_Win32_Emotet_P__2{
	meta:
		description = "Trojan:Win32/Emotet.P!!Emotet.gen!B,SIGNATURE_TYPE_ARHSTR_EXT,28 00 28 00 01 00 00 28 00 "
