...
rule Trojan_Win32_Emotet_C{
	...
	strings :
		...
		$a_00_1 = {6d 00 61 00 6a 00 6f 00 72 00 63 00 68 00 65 00 6c 00 73 00 65 00 61 00 31 00 61 00 6e 00 64 00 46 00 72 00 65 00 71 00 75 00 65 00 73 00 74 00 73 00 61 00 70 00 70 00 6c 00 69 00 63 00 61 00 74 00 69 00 6f 00 6e 00 } //01 00 
		$a_00_2 = {7a 31 65 2e 62 6d 61 69 32 39 38 52 73 42 53 32 } //01 00 
		$a_00_3 = {62 00 6f 00 66 00 38 00 30 00 66 00 54 00 72 00 69 00 6e 00 69 00 74 00 79 00 49 00 74 00 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Emotet_C_3{
	...
	strings :
		$a_00_0 = {76 62 61 72 76 75 6c 6e 65 72 61 62 69 6c 69 74 69 65 73 4a 61 7a 61 79 65 72 69 } //01 00 
		$a_00_1 = {5a 00 62 00 75 00 74 00 54 00 6f 00 72 00 72 00 65 00 6e 00 74 00 46 00 72 00 65 00 61 00 6b 00 41 00 70 00 72 00 69 00 6c 00 43 00 49 00 41 00 } //01 00 
		$a_00_2 = {53 00 31 00 36 00 38 00 64 00 6f 00 77 00 6e 00 6c 00 6f 00 61 00 64 00 65 00 64 00 } //01 00 
...
rule Trojan_Win32_Emotet_C_4{
	...
	strings :
		...
		$a_01_6 = {5c 73 70 61 6d 5c 65 78 70 6f 72 74 5f 65 6d 61 69 6c 5f 6f 75 74 6c 6f 6f 6b 5c } //01 00 
		$a_01_7 = {5c 6d 61 69 6c 64 65 6d 6f 2d 70 6f 69 73 6b 20 65 6d 61 69 6c 20 76 20 6f 75 74 6c 6f 6f 6b 5c } //01 00 
		$a_03_8 = {2f 6d 33 2f 64 61 74 61 2e 70 68 70 00 90 02 10 2e 90 03 02 05 72 75 63 6f 2e 75 61 00 90 00 } //01 00 
		$a_01_9 = {2f 69 6e 70 75 74 2f 69 6e 2f 69 6e 64 65 78 2e 70 68 70 } //01 00 
		$a_01_10 = {2f 69 6e 70 75 74 2f 69 6e 2f 4e 77 68 33 37 71 41 52 2e 70 68 70 } //00 00 
