...
rule Trojan_Win32_Emotet_PEJ_MTB{
	...
	strings :
		$a_02_0 = {0f b6 b4 04 90 02 04 88 54 0c 90 01 01 8a 54 04 90 01 01 0f b6 fa 03 f1 03 fe 8b cf 81 e1 ff 00 00 80 88 5c 04 90 00 } //1
		$a_02_1 = {0f b6 5c 34 90 01 01 0f b6 d2 03 da 81 e3 ff 00 00 80 79 90 01 01 4b 81 cb 90 01 04 43 8a 54 1c 90 01 01 32 14 0f 88 11 90 00 } //1
