...
rule Trojan_Win32_Emotet_DGH_MTB{
	...
	strings :
		...
		$a_81_1 = {35 66 4a 43 54 50 4d 4a 45 61 77 42 30 56 32 5a 47 36 35 4c 65 39 64 63 45 70 42 69 75 49 6b 58 61 6f 36 69 7a 6c 55 } //01 00 
		...
		$a_81_3 = {74 73 6e 51 4d 57 44 73 30 62 58 51 78 4b 6b 58 73 36 68 49 47 61 76 4f 50 53 71 43 59 79 30 47 59 37 4e 47 65 } //00 00 
	condition:
		any of ($a_*)
