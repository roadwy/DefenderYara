...
rule Trojan_Win32_Emotet_DGH_MTB{
	...
	strings :
		$a_02_0 = {81 e1 ff 00 00 00 03 c1 b9 74 59 01 00 99 f7 f9 8a 4d 00 8a 9c 14 90 01 04 32 d9 90 00 } //1
		...
		$a_02_2 = {0f b6 94 0d 90 01 04 03 c2 99 f7 bd 90 01 04 0f b6 84 15 90 1b 00 0f b6 8d 90 01 04 33 c8 88 8d 90 1b 03 68 90 01 04 e8 90 00 } //1
