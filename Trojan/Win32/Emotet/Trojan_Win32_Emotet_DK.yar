...
rule Trojan_Win32_Emotet_DK{
	...
	strings :
		$a_01_0 = {4f 37 68 53 42 4d 65 51 65 49 66 6d 2e 70 64 62 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Emotet_DK_2{
	...
	strings :
		$a_01_0 = {71 48 65 72 71 65 68 65 72 48 68 00 65 72 23 56 31 32 68 74 72 40 40 6a 47 65 00 72 6a 65 65 77 00 34 23 48 52 45 4e 45 } //01 00 
		...
		$a_01_2 = {74 77 65 72 6b 72 74 72 23 23 23 2e 70 64 62 } //01 00 
