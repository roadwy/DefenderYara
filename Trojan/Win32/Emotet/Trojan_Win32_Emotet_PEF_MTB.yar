...
rule Trojan_Win32_Emotet_PEF_MTB{
	...
	strings :
		...
		$a_81_1 = {63 49 4e 70 35 4e 4a 71 74 74 53 5a 73 67 66 42 45 74 4a 6b 7a 6a 71 4a 71 41 67 6e 4d 56 4e 49 6d 57 48 } //00 00  cINp5NJqttSZsgfBEtJkzjqJqAgnMVNImWH
	condition:
		any of ($a_*)
