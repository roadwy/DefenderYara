...
rule Trojan_Win32_Emotet_PEV_MTB{
	...
	strings :
		$a_02_0 = {03 c1 99 b9 90 01 04 f7 f9 89 95 90 01 04 8b 55 90 01 01 03 95 90 01 04 33 c0 8a 02 8b 8d 90 01 04 33 d2 8a 94 0d 90 01 04 33 c2 8b 4d 90 01 01 03 8d 90 01 04 88 01 90 00 } //1
