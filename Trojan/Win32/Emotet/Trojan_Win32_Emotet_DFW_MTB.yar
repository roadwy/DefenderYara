...
rule Trojan_Win32_Emotet_DFW_MTB{
	...
	strings :
		...
		$a_81_1 = {32 39 77 78 46 76 6c 79 57 64 6c 55 78 49 75 6d 65 33 48 54 75 68 35 41 6b 46 49 35 74 4d 35 6b 79 4f 30 72 6d } //00 00  29wxFvlyWdlUxIume3HTuh5AkFI5tM5kyO0rm
	condition:
		any of ($a_*)
