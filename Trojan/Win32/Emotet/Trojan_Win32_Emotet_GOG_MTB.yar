...
rule Trojan_Win32_Emotet_GOG_MTB{
	...
	strings :
		...
		$a_02_1 = {ff d6 33 f6 90 02 0c c6 90 02 03 74 c6 90 02 03 61 c6 90 02 03 73 c6 90 02 03 6b c6 90 02 03 6d c6 90 02 03 67 c6 90 02 03 72 c6 90 02 03 2e c6 90 02 03 65 c6 90 02 03 78 c6 90 02 03 65 90 02 0f ff 90 00 } //1
	condition:
