...
rule Trojan_Win32_Emotet_DFB_MTB{
	...
	strings :
		$a_02_0 = {03 c1 0f b6 4d 0f 89 85 ?? ?? ?? ?? 8b 45 f0 0f b6 84 05 ?? ?? ?? ?? 03 c1 8b cb 99 f7 f9 8b 85 90 1b 00 8a 8c 15 90 1b 01 30 08 } //1
		$a_02_1 = {57 53 ff 15 ?? ?? ?? ?? 8b f8 8b 45 ?? c1 e0 03 53 50 68 00 30 00 00 57 53 ff 15 ?? ?? ?? ?? 50 ff d6 8b f0 } //1
