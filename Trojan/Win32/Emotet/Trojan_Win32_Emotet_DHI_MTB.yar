...
rule Trojan_Win32_Emotet_DHI_MTB{
	...
	strings :
		...
		$a_02_1 = {8b f1 c1 ee 05 03 35 ?? ?? ?? ?? 8b f9 c1 e7 04 03 3d ?? ?? ?? ?? 33 f7 8d 3c 0a 33 f7 2b c6 8b f0 c1 ee 05 03 35 ?? ?? ?? ?? 8b f8 c1 e7 04 03 3d ?? ?? ?? ?? 33 f7 8d 3c 02 33 f7 2b ce 81 c2 ?? ?? ?? ?? 83 6d fc 01 75 b6 } //1
	condition:
