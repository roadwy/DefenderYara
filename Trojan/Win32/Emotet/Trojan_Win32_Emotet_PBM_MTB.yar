...
rule Trojan_Win32_Emotet_PBM_MTB{
	...
	strings :
		$a_02_0 = {0f b6 01 0f b6 ca 03 c1 25 90 01 04 79 90 01 01 48 0d 00 ff ff ff 40 8a 84 05 90 01 04 32 04 37 88 06 90 00 } //1
		$a_02_1 = {8a 04 0a 8b 4d 90 01 01 8b 11 8b 4d 90 01 01 33 db 8a 1c 11 33 c3 8b 15 90 01 04 8b 0a 8b 55 90 01 01 88 04 0a 90 00 } //1
