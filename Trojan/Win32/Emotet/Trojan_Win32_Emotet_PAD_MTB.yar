...
rule Trojan_Win32_Emotet_PAD_MTB{
	...
	strings :
		...
		$a_03_1 = {42 45 41 55 52 45 47 41 52 44 5c 50 69 63 74 75 72 65 73 5c 90 02 10 5c 57 6f 72 6b 65 72 54 68 72 65 61 64 73 5c 90 02 15 5c 57 6f 72 6b 65 72 54 68 72 65 61 64 73 2e 70 64 62 90 00 } //5
