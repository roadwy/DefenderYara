...
rule Trojan_Win32_Emotet_PAD_MTB{
	...
	strings :
		...
		$a_00_2 = {4c 6f 63 6b 57 69 6e 64 6f 77 55 70 64 61 74 65 } //01 00 
		$a_00_3 = {4e 6f 4e 65 74 43 6f 6e 6e 65 63 74 44 69 73 63 6f 6e 6e 65 63 74 } //01 00 
		$a_01_4 = {52 65 63 65 6e 74 44 6f 63 73 48 69 73 74 6f 72 79 } //01 00 
		$a_01_5 = {4c 6f 63 6b 46 69 6c 65 } //00 00 
