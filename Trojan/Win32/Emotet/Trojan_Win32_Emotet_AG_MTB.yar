...
rule Trojan_Win32_Emotet_AG_MTB{
	...
	strings :
		$a_03_0 = {03 c8 8b 44 24 90 01 01 03 ce 03 da 8d 0c 49 03 c9 2b d9 8d 14 fd 90 01 04 2b da 0f b6 0c 2b 30 08 8b 44 24 90 01 01 40 89 44 24 90 01 01 3b 44 24 90 01 01 0f 82 90 00 } //1
