...
rule Trojan_Win32_Emotet_SK_MTB{
	...
	strings :
		$a_81_0 = {4f 23 77 77 23 50 23 23 23 23 23 23 23 77 4f } //01 00 
		$a_81_1 = {59 55 51 39 46 2a 6d 69 4f 71 } //01 00 
		$a_81_2 = {36 21 68 40 4a 30 56 69 23 4f } //01 00 
		$a_81_3 = {6e 69 37 3d 38 68 4c 4f 36 6f } //00 00 
	condition:
		any of ($a_*)
