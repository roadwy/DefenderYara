...
rule Trojan_Win32_Emotet_PEG_MTB{
	...
	strings :
		$a_02_0 = {99 f7 f9 8a 4c 24 90 01 01 8b 84 24 90 01 04 8a 94 14 90 01 04 32 ca 85 c0 88 4c 24 90 09 0e 00 8a 84 14 90 01 04 03 c1 b9 90 00 } //1
		$a_02_1 = {0f b6 44 34 90 01 01 0f b6 cb 03 c1 99 b9 90 01 04 f7 f9 83 c5 01 0f b6 54 14 90 01 01 32 54 24 90 00 } //1
