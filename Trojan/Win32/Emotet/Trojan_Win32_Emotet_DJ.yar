...
rule Trojan_Win32_Emotet_DJ{
	...
	strings :
		$a_01_0 = {54 39 62 58 4d 71 65 76 3d 39 2d 79 55 50 4a 5f 49 32 32 2e 70 64 62 } //01 00 
...
rule Trojan_Win32_Emotet_DJ_2{
	...
	strings :
		$a_01_0 = {72 74 6a 68 65 57 52 4a 4b 65 79 57 59 40 23 79 68 4a 74 72 6a 45 52 2e 70 64 62 } //01 00 
