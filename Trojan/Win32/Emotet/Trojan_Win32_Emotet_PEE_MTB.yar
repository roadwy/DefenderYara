...
rule Trojan_Win32_Emotet_PEE_MTB{
	...
	strings :
		$a_02_0 = {0f b6 d1 03 c2 99 b9 90 01 04 f7 f9 8b 44 24 90 01 01 8a 5c 14 90 01 01 8b 54 24 90 01 01 32 1c 02 90 00 } //1
		$a_02_1 = {0f b6 44 04 90 01 01 03 c1 b9 90 01 04 99 f7 f9 8b 44 24 90 01 01 8a 4c 14 90 01 01 30 08 90 00 } //1
