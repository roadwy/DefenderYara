...
rule Trojan_Win32_Emotet_DGF_MTB{
	...
	strings :
		...
		$a_81_1 = {74 73 6e 51 4d 57 44 73 30 62 58 51 78 4b 6b 58 73 36 68 49 47 61 76 4f 50 53 71 43 59 79 30 47 59 37 4e 47 65 } //00 00  tsnQMWDs0bXQxKkXs6hIGavOPSqCYy0GY7NGe
	condition:
		any of ($a_*)
