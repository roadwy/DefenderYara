...
rule Trojan_Win32_Emotet_G{
	...
	strings :
		...
		$a_03_1 = {8a 04 16 32 81 ?? ?? ?? ?? 41 88 02 83 f9 ?? 72 02 } //1
...
rule Trojan_Win32_Emotet_G_2{
	...
	strings :
		$a_02_0 = {f7 f1 8a 0c 15 ?? ?? ?? ?? 89 7c 24 ?? 8b 54 24 ?? 8a 2c 1a 8b 7c 24 ?? 8b 54 24 ?? 29 d7 89 7c 24 ?? 28 cd 80 f5 ?? 8b 7c 24 ?? 89 7c 24 ?? 8b 54 24 ?? 88 2c 1a 01 f3 89 5c 24 ?? 8b 74 24 ?? 39 f3 72 } //1
	condition:
		((#a_02_0  & 1)*1) >=1
...
rule Trojan_Win32_Emotet_G_3{
	...
	strings :
		$a_03_0 = {79 09 81 ce 00 30 00 00 89 70 25 80 7c 24 ?? 00 75 44 8a 4c 24 ?? 80 c1 27 80 f9 06 } //1
		$a_01_1 = {69 c9 0d 66 19 00 0f be d2 40 8d 8c 11 5f f3 6e 3c 8a 10 84 d2 75 e9 } //1
		$a_03_2 = {bf 37 7e 13 a4 90 13 64 a1 30 00 00 00 8b 48 0c 56 8b 71 0c 83 7e 18 00 } //1
	condition:
...
rule Trojan_Win32_Emotet_G_5{
	...
	strings :
		$a_03_0 = {8a 04 16 32 81 ?? ?? ?? ?? 41 88 02 83 f9 [08-0c] 72 02 33 c9 42 83 ed 01 75 e7 } //1
		$a_01_1 = {0f b6 1c 0a 33 de 69 db 01 01 01 01 41 8b f3 3b c8 72 ed 5b } //1
		$a_03_2 = {41 66 0f b6 c0 66 89 04 56 83 f9 08 72 02 33 c9 8a 81 ?? ?? ?? ?? 32 82 ?? ?? ?? ?? 41 66 0f b6 c0 66 89 44 56 02 83 f9 08 72 02 33 c9 83 c2 02 83 fa 0e 72 bf } //1
		$a_03_3 = {79 09 81 ce 00 30 00 00 89 70 25 80 7c 24 ?? 00 75 44 8a 4c 24 ?? 80 c1 27 80 f9 06 } //1
	condition:
...
rule Trojan_Win32_Emotet_G_6{
	...
	strings :
		...
		$a_03_1 = {8a 1c 17 32 99 ?? ?? ?? ?? 41 88 1a 83 f9 15 72 02 33 c9 8a 1c 2a 32 99 ?? ?? ?? ?? 41 88 5a 01 83 f9 15 72 02 33 c9 8a 1c 10 32 99 ?? ?? ?? ?? 41 88 5a 02 83 f9 15 72 02 33 c9 } //10
		$a_03_2 = {79 09 81 ce 00 30 00 00 89 70 25 80 7c 24 ?? 00 75 44 8a 4c 24 ?? 80 c1 27 80 f9 06 } //1
