...
rule Trojan_Win32_Emotet_PVV_MTB{
	...
	strings :
		$a_02_0 = {0f b6 c9 03 c1 99 b9 05 17 00 00 f7 f9 0f b6 94 15 90 01 04 30 53 ff 90 09 1e 00 0f b6 94 3d 90 01 04 88 94 35 90 01 04 88 8c 3d 90 01 04 0f b6 84 35 90 00 } //1
