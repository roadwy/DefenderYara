...
rule Trojan_Win32_Emotet_PVV_MTB{
	...
	strings :
		...
		$a_00_1 = {63 6c 6f 57 43 51 62 64 43 4a 6c 38 55 53 34 56 44 64 4c 51 34 53 77 79 69 63 63 39 41 73 35 62 34 31 4d 61 36 4d 4f 48 64 42 4f } //00 00  cloWCQbdCJl8US4VDdLQ4Swyicc9As5b41Ma6MOHdBO
	condition:
		any of ($a_*)
