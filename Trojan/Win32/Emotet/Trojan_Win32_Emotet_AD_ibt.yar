...
rule Trojan_Win32_Emotet_AD_ibt{
	...
	strings :
		...
		$a_03_1 = {33 c0 59 c3 e8 43 c8 ff ff e8 ce c9 ff ff e8 e9 d8 ff ff e8 b4 e6 ff ff e8 df ea ff ff 83 ec 08 e8 c7 b6 ff ff 83 c4 08 85 c0 74 ca c7 05 90 01 04 b8 26 41 00 c7 05 90 01 04 f0 fb 40 00 c7 05 90 01 04 6a 00 00 00 c7 05 90 01 04 02 00 00 00 eb 89 c7 05 90 01 04 02 00 00 00 e8 97 fd ff ff 59 c3 ff 35 90 01 04 ff 15 90 01 04 33 c0 59 90 00 } //1
		$a_03_2 = {83 f8 03 0f 87 b8 00 00 00 ff 24 85 90 01 04 e8 f5 b9 ff ff e8 f0 bf ff ff e8 8b 22 00 00 85 c0 75 21 c7 05 90 01 04 01 00 00 00 ff 15 90 01 04 33 d2 b9 a0 0f 00 00 f7 f1 8d 82 a0 0f 00 00 59 c3 90 00 } //1
