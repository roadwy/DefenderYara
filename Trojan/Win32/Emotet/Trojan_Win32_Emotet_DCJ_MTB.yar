...
rule Trojan_Win32_Emotet_DCJ_MTB{
	...
	strings :
		...
		$a_81_2 = {41 7a 58 64 53 61 4b 76 62 72 66 67 68 52 54 59 68 } //04 00 
		$a_81_3 = {45 6d 6f 74 65 74 20 66 6f 72 65 76 65 } //03 00 
		$a_81_4 = {56 45 4e 45 53 55 45 4c 4c 41 } //05 00 
