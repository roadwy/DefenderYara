...
rule Trojan_Win32_Emotet_DCJ_MTB{
	...
	strings :
		$a_02_0 = {33 d2 8a 11 03 c2 99 b9 90 01 04 f7 f9 90 00 } //5
		...
		$a_02_5 = {33 d2 8a 11 b9 90 01 04 03 c2 99 f7 f9 90 00 } //5
		$a_02_6 = {0f b6 17 0f b6 06 03 c2 99 b9 90 01 04 f7 f9 68 90 01 04 68 90 00 } //5
		$a_02_7 = {8b 4c 24 04 8b 54 24 08 56 8b c1 8b f2 90 03 0b 0a 0b ca f7 d0 f7 d6 0b c6 5e 23 c1 f7 d0 f7 d6 0b c6 0b ca 23 c1 90 00 } //5
	condition:
