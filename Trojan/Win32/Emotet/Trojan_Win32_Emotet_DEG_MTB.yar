...
rule Trojan_Win32_Emotet_DEG_MTB{
	...
	strings :
		$a_02_0 = {03 c1 99 b9 ?? ?? ?? ?? f7 f9 8b 44 24 18 8b 4c 24 24 40 89 44 24 18 8a 54 14 28 30 54 01 ff } //1
		...
		$a_02_2 = {03 c1 99 b9 ?? ?? ?? ?? f7 f9 8b 4c 24 14 8b 44 24 18 83 c1 01 89 4c 24 14 8a 54 14 24 30 54 08 ff } //1
