...
rule Trojan_Win32_Emotet_PST_MTB{
	...
	strings :
		...
		$a_81_1 = {6d 6e 35 6f 51 46 65 79 70 6e 61 6f 4e 75 56 45 4a 6d 35 50 6c 74 6a 74 30 6d 61 66 61 38 41 77 4e 31 65 71 78 } //00 00  mn5oQFeypnaoNuVEJm5Pltjt0mafa8AwN1eqx
	condition:
		any of ($a_*)
