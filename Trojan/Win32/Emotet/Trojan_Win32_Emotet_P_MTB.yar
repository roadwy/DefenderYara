...
rule Trojan_Win32_Emotet_P_MTB{
	...
	strings :
		...
		$a_00_3 = {53 00 4f 00 46 00 54 00 57 00 41 00 52 00 45 00 5c 00 42 00 75 00 62 00 62 00 6c 00 65 00 20 00 42 00 72 00 65 00 61 00 6b 00 65 00 72 00 } //01 00 
		$a_00_4 = {43 00 72 00 79 00 70 00 74 00 53 00 74 00 72 00 69 00 6e 00 67 00 54 00 6f 00 42 00 69 00 6e 00 61 00 72 00 79 00 41 00 } //00 00 
	condition:
		any of ($a_*)
