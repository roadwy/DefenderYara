...
rule Trojan_Win32_Emotet_E_MTB{
	...
	strings :
		$a_02_0 = {6a 40 68 00 10 00 00 ff 75 0c 56 ff 55 c0 ff 75 0c 8b f8 ff 75 08 57 ff 55 e0 83 c4 0c ff 75 0c 8d 45 0c 50 57 56 53 56 ff 75 f4 ff 55 e4 f7 d8 1b c0 23 c7 5f 5e 5b c9 c3 90 0a ff 00 8d 45 f8 50 56 56 68 03 80 00 00 ff 75 fc ff 55 e8 85 c0 74 90 00 } //1
		$a_02_1 = {6a 40 68 00 10 00 00 ff 75 0c 56 ff 55 c0 ff 75 0c 8b f8 ff 75 08 57 ff 55 e0 83 c4 0c 8d 45 0c ff 75 0c 50 57 56 53 56 ff 75 f4 ff 55 e4 f7 d8 1b c0 23 c7 5f 5e 5b c9 c3 90 0a ff 00 8d 45 f8 50 56 56 68 03 80 00 00 ff 75 fc ff 55 e8 85 c0 74 90 00 } //1
