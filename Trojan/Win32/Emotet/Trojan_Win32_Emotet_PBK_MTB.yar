...
rule Trojan_Win32_Emotet_PBK_MTB{
	...
	strings :
		...
		$a_81_2 = {69 67 43 61 4c 42 51 7e 6a 7b 40 6f 6a 7a 32 23 56 39 71 7c 2a 33 36 77 70 24 31 67 66 75 50 37 45 4c 71 4d 40 32 3f 6a 38 41 32 51 50 61 47 55 2a 59 52 7a 7e 5a 79 48 41 36 44 77 41 45 56 39 79 35 64 7a 6e 30 4c 50 4d 53 65 44 53 } //00 00 
	condition:
		any of ($a_*)
