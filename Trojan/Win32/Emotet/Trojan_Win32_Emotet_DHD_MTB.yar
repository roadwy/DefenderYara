...
rule Trojan_Win32_Emotet_DHD_MTB{
	...
	strings :
		...
		$a_02_1 = {66 8b 44 24 78 66 b9 bd 61 66 29 c1 8b 54 24 38 66 89 0a 8b 54 24 2c 81 f2 48 61 4b 6b 90 02 16 c7 42 3c 38 01 00 00 8b 54 24 38 66 8b 44 24 1a 66 0d aa 22 66 89 44 24 76 90 00 } //1
	condition:
