...
rule Trojan_Win32_Emotet_RM_MTB_2{
	...
	strings :
		...
		$a_03_1 = {81 c9 00 10 00 00 51 8b 45 90 01 01 50 6a 00 6a ff ff 15 90 01 04 89 45 90 00 } //1
	condition:
...
rule Trojan_Win32_Emotet_RM_MTB_3{
	...
	strings :
		...
		$a_03_1 = {68 00 30 00 00 8b 45 90 01 01 50 6a 00 6a ff ff 90 00 } //1
	condition:
		((#a_80_0  & 1)*1+(#a_03_1  & 1)*1) >=2
...
rule Trojan_Win32_Emotet_RM_MTB_5{
	...
	strings :
		$a_03_0 = {0b f9 57 56 6a 00 6a ff ff 15 90 01 04 e9 90 00 } //1
...
rule Trojan_Win32_Emotet_RM_MTB_6{
	...
	strings :
		...
		$a_03_1 = {81 c9 00 10 00 00 51 56 53 6a ff ff 15 90 01 04 eb 90 01 01 6a 40 68 00 30 00 00 90 00 } //1
	condition:
		((#a_80_0  & 1)*1+(#a_03_1  & 1)*1) >=2
