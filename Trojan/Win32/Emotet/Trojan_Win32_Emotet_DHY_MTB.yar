...
rule Trojan_Win32_Emotet_DHY_MTB{
	...
	strings :
		$a_02_0 = {8b 5c b0 08 89 5c 88 08 89 54 b0 08 03 da 81 e3 90 01 04 0f b6 54 98 08 32 55 00 41 88 17 81 e1 90 1b 00 8b 54 88 08 03 f2 81 e6 ff 00 00 00 90 00 } //1
