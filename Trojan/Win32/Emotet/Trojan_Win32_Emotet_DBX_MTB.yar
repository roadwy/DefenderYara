...
rule Trojan_Win32_Emotet_DBX_MTB{
	...
	strings :
		...
		$a_81_1 = {65 72 7a 47 47 57 47 34 74 67 32 7a 79 7a 65 } //01 00  erzGGWG4tg2zyze
		$a_81_2 = {61 7a 67 61 34 61 67 33 67 33 71 67 } //01 00  azga4ag3g3qg
		$a_81_3 = {43 72 79 70 74 41 63 71 75 69 72 65 43 6f 6e 74 65 78 74 41 } //00 00  CryptAcquireContextA
	condition:
		any of ($a_*)
