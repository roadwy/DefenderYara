...
rule Trojan_Win32_Emotet_GD_MTB_2{
	...
	strings :
		...
		$a_81_1 = {6e 56 63 68 6d 4a 68 77 52 52 25 21 40 4a 69 7a 4f 39 72 5a 6d 43 4a 54 55 6f 6b 24 58 35 54 26 33 4f 40 48 65 63 75 31 34 41 4a 21 70 68 52 68 59 6a } //00 00 
	condition:
		any of ($a_*)
