...
rule Trojan_Win32_Emotet_PVQ_MTB{
	...
	strings :
		...
		$a_00_1 = {6d 66 35 44 6a 6a 34 63 62 49 79 6c 71 64 51 77 5a 4e 77 6e 48 38 77 43 5a 46 33 75 76 34 32 34 7a 79 64 36 79 65 67 } //00 00  mf5Djj4cbIylqdQwZNwnH8wCZF3uv424zyd6yeg
	condition:
		any of ($a_*)
