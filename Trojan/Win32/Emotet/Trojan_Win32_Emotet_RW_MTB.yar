...
rule Trojan_Win32_Emotet_RW_MTB{
	...
	strings :
		$a_03_0 = {83 c0 04 0f af 05 90 01 04 03 d0 8d 47 90 01 01 0f af c7 2b d0 8b 44 24 90 01 01 2b d3 2b d1 8a 0c 32 30 08 8b 44 24 90 01 01 40 89 44 24 90 01 01 3b 44 24 90 01 01 0f 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_Win32_Emotet_RW_MTB_2{
	...
	strings :
		...
		$a_03_1 = {83 c4 04 f7 d8 50 ff 15 90 01 04 89 45 90 01 01 eb 90 01 01 6a 40 68 00 30 00 00 90 00 } //1
	condition:
...
rule Trojan_Win32_Emotet_RW_MTB_3{
	...
	strings :
		...
		$a_03_1 = {0b e9 55 57 6a 00 6a ff ff 15 90 01 04 e9 90 00 } //1
	condition:
		((#a_80_0  & 1)*1+(#a_03_1  & 1)*1) >=2
