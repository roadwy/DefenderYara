...
rule Trojan_Win32_Emotet_AB_MTB_2{
	...
	strings :
		$a_02_0 = {81 f1 ed b5 77 61 89 45 90 01 01 8b 45 90 01 01 8b 55 90 01 01 8a 1c 02 8b 45 90 01 01 88 5d 90 01 01 39 c8 74 90 00 } //1
		$a_02_1 = {8a 14 01 8b 75 90 01 01 88 14 06 83 c0 01 8b 7d 90 01 01 39 f8 89 45 90 01 01 75 90 09 06 00 8b 45 90 01 01 8b 4d f0 90 00 } //1
		$a_02_2 = {81 f1 fb 0d eb 6e 8b 55 90 01 01 8a 1c 02 8b 75 90 01 01 88 1c 06 01 c8 8b 4d 90 01 01 39 c8 89 45 90 01 01 74 90 00 } //1
		$a_02_3 = {8a 1c 02 8b 44 24 90 01 01 88 1c 08 8b 4c 24 90 01 01 83 c1 01 89 4c 24 90 01 01 8b 74 24 90 01 01 39 f1 74 90 00 } //1
	condition:
