...
rule Trojan_Win32_Emotet_AB_MTB{
	...
	strings :
		$a_81_0 = {26 68 41 6f 76 54 46 6c 77 2b 66 33 55 46 41 23 29 21 79 52 73 66 4f 45 65 6b 23 53 4e 3f 75 6e 69 38 32 31 } //03 00  &hAovTFlw+f3UFA#)!yRsfOEek#SN?uni821
		$a_81_1 = {50 6f 73 74 51 75 69 74 4d 65 73 73 61 67 65 } //03 00  PostQuitMessage
		$a_81_2 = {50 6f 73 74 4d 65 73 73 61 67 65 57 } //03 00  PostMessageW
		$a_81_3 = {4e 6f 4e 65 74 43 6f 6e 6e 65 63 74 44 69 73 63 6f 6e 6e 65 63 74 } //03 00  NoNetConnectDisconnect
		$a_81_4 = {4e 6f 52 65 63 65 6e 74 44 6f 63 73 48 69 73 74 6f 72 79 } //00 00  NoRecentDocsHistory
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Emotet_AB_MTB_3{
	...
	strings :
		...
		$a_01_2 = {70 21 63 21 58 38 3c 30 61 69 52 31 3e 66 6b 64 79 6d 45 3c 58 21 21 78 66 64 74 5a 3f 3c 2a 26 6e 4a 78 52 5a 7a 39 56 6f 79 21 26 71 33 2a 49 54 6b 46 35 37 72 40 5f 45 61 43 4c 7a } //00 00  p!c!X8<0aiR1>fkdymE<X!!xfdtZ?<*&nJxRZz9Voy!&q3*ITkF57r@_EaCLz
	condition:
		any of ($a_*)
