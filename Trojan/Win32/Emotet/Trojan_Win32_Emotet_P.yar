...
rule Trojan_Win32_Emotet_P_4{
	...
	strings :
		...
		$a_00_3 = {54 45 51 55 49 4c 41 42 4f 4f 4d 42 4f 4f 4d } //01 00 
		$a_00_4 = {43 3a 5c 53 79 6d 62 6f 6c 73 5c 61 61 67 6d 6d 63 2e 70 64 62 } //01 00 
		$a_00_5 = {4b 4c 4f 4e 45 5f 58 36 34 2d 50 43 } //01 00 
		$a_00_6 = {43 3a 5c 74 61 6b 65 5f 73 63 72 65 65 6e 73 68 6f 74 2e 70 73 31 } //01 00 
		$a_00_7 = {43 3a 5c 65 6d 61 69 6c 2e 64 6f 63 } //01 00 
		$a_00_8 = {43 3a 5c 31 32 33 5c 65 6d 61 69 6c 2e 64 6f 63 } //01 00 
		$a_00_9 = {43 3a 5c 61 5c 66 6f 6f 62 61 72 2e 62 6d 70 } //03 00 
