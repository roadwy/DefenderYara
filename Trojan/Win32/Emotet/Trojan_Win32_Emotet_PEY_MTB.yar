...
rule Trojan_Win32_Emotet_PEY_MTB{
	...
	strings :
		$a_02_0 = {8a 04 0e 81 e2 ff 00 00 00 03 c2 99 f7 fd 8a 04 0a 8b 54 24 90 01 01 32 04 1a 43 88 43 90 00 } //1
		$a_02_1 = {0f b6 00 0f b6 d2 03 c2 99 f7 fb 8a 04 0a 8b 55 90 01 01 32 04 3a 88 07 90 00 } //1
