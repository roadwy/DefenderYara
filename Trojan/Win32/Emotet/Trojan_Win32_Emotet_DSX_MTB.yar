...
rule Trojan_Win32_Emotet_DSX_MTB{
	...
	strings :
		...
		$a_81_1 = {69 62 56 30 37 6b 38 4f 76 4c 49 63 33 43 43 39 74 51 41 54 6e 31 30 6e 7a 58 48 53 37 61 65 55 33 79 6a 55 50 36 68 6b 37 79 30 4f } //00 00  ibV07k8OvLIc3CC9tQATn10nzXHS7aeU3yjUP6hk7y0O
	condition:
		any of ($a_*)
