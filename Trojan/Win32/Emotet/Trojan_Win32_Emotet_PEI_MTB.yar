...
rule Trojan_Win32_Emotet_PEI_MTB{
	...
	strings :
		...
		$a_81_1 = {46 6b 6a 43 7a 70 53 73 34 43 4d 49 69 67 47 57 69 76 73 48 42 46 39 65 69 } //01 00  FkjCzpSs4CMIigGWivsHBF9ei
		$a_81_2 = {4a 36 38 6b 43 51 73 68 59 37 7d 68 62 76 4f 24 69 57 70 31 46 4d 25 63 36 25 6c 79 70 32 6b 75 } //00 00  J68kCQshY7}hbvO$iWp1FM%c6%lyp2ku
	condition:
		any of ($a_*)
