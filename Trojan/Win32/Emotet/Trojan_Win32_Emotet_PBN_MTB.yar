...
rule Trojan_Win32_Emotet_PBN_MTB{
	...
	strings :
		$a_02_0 = {03 c2 33 d2 f7 35 90 01 04 a1 90 01 04 8b 00 8b ea 8b 54 24 90 01 01 8a 14 10 32 14 2e 8b 6c 24 90 01 01 88 14 28 a1 90 01 04 40 3b c3 a3 90 00 } //1
		$a_02_1 = {8a 14 01 8b 45 90 01 01 8b 08 8b 45 90 01 01 33 db 8a 1c 08 33 d3 8b 0d 90 01 04 8b 01 8b 4d 90 01 01 88 14 01 90 00 } //1
