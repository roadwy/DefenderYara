...
rule Trojan_Win32_Emotet_AU{
	...
	strings :
		...
		$a_03_1 = {8b 16 8d 49 04 90 02 06 8d 76 04 88 51 fc 8b c2 c1 e8 08 47 c1 ea 10 88 41 fd 88 51 fe c1 ea 08 88 51 ff 3b fb 72 90 00 } //2
		$a_01_2 = {66 83 38 5c 74 0b 83 c0 02 66 83 38 00 75 f1 eb 06 33 c9 66 89 48 02 6a 00 } //1
		$a_03_3 = {83 c4 04 33 c9 39 4d 14 8b f0 0f 45 ce 6a 00 68 00 c3 4c 84 6a 00 6a 00 6a 00 90 02 03 51 57 ff 15 90 01 04 56 6a 00 8b f8 ff 15 90 00 } //1
	condition:
...
rule Trojan_Win32_Emotet_AU_2{
	...
	strings :
		$a_03_0 = {8d 45 a8 50 6a 00 6a 00 ff 75 08 6a 00 6a 00 6a 00 6a 00 56 ff 15 90 01 04 85 c0 74 36 8b 45 0c 85 c0 74 13 f3 0f 6f 45 f0 f3 0f 7f 00 b8 01 00 00 00 90 00 } //1
		$a_03_1 = {ff 75 f0 ff 15 90 01 04 ff 75 f4 ff 15 90 01 04 b8 01 00 00 00 5e 8b e5 5d 90 00 } //1
		$a_03_2 = {74 05 e8 72 dd ff ff 6a 00 ff 15 90 01 04 8b e5 5d 90 00 } //1
		$a_03_3 = {68 04 01 00 00 68 90 01 04 6a 00 ff 15 90 00 } //1
