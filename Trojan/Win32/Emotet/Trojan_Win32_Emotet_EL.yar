...
rule Trojan_Win32_Emotet_EL{
	...
	strings :
		$a_01_0 = {59 75 6d 44 57 50 2e 70 64 62 } //01 00 
		$a_01_1 = {73 00 43 00 32 00 77 00 45 00 40 00 51 00 65 00 50 00 25 00 44 00 } //05 00 
		$a_01_2 = {74 6b 57 53 75 2e 70 64 62 } //01 00 
