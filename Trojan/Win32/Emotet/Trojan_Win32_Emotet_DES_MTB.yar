...
rule Trojan_Win32_Emotet_DES_MTB{
	...
	strings :
		$a_02_0 = {6a 00 6a 01 6a 00 6a 00 8d 45 90 01 01 50 ff 55 90 01 01 85 c0 75 90 01 01 6a 08 6a 01 6a 00 6a 00 8d 4d 90 1b 00 51 ff 55 90 1b 01 85 c0 75 90 01 01 68 00 00 00 f0 6a 01 6a 00 6a 00 8d 55 90 1b 00 52 ff 55 90 00 } //1
