...
rule Trojan_Win32_Emotet_H_MTB{
	...
	strings :
		...
		$a_02_3 = {c7 44 24 0c 40 00 00 00 c7 44 24 08 00 10 00 00 8b 84 24 90 01 02 00 00 89 44 24 04 c7 04 24 00 00 00 00 90 00 } //1
		...
		$a_02_7 = {c7 44 24 0c 00 00 00 00 c7 44 24 08 01 00 00 00 c7 44 24 04 00 00 00 00 8b 84 24 90 01 02 00 00 89 04 24 90 00 } //1
