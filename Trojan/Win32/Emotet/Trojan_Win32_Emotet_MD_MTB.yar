...
rule Trojan_Win32_Emotet_MD_MTB{
	...
	strings :
		$a_01_0 = {65 2a 4a 71 41 6a 41 4c 6d 31 38 6c 41 40 55 40 37 5e 5a 41 56 37 46 34 2a 6a } //10 e*JqAjALm18lA@U@7^ZAV7F4*j
		$a_01_1 = {44 6c 6c 52 65 67 69 73 74 65 72 53 65 72 76 65 72 } //1 DllRegisterServer
		$a_01_2 = {44 6c 6c 55 6e 72 65 67 69 73 74 65 72 53 65 72 76 65 72 4b 61 73 6c } //1 DllUnregisterServerKasl
