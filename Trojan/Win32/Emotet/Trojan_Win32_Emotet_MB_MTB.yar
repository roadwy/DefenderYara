...
rule Trojan_Win32_Emotet_MB_MTB_2{
	...
	strings :
		$a_01_0 = {64 66 61 64 71 6b 69 6f 76 } //01 00 
		$a_01_1 = {64 66 61 6f 6f 70 64 71 6b 69 6f 76 } //01 00 
		$a_01_2 = {64 67 63 67 68 64 } //01 00 
		$a_01_3 = {67 67 76 64 77 } //01 00 
		$a_01_4 = {43 6f 6d 70 75 74 65 72 47 72 61 70 68 69 63 73 2e 64 6c 6c } //01 00 
		$a_01_5 = {4e 6f 4e 65 74 43 6f 6e 6e 65 63 74 44 69 73 63 6f 6e 6e 65 63 74 } //01 00 
		$a_01_6 = {47 65 74 44 69 73 6b 46 72 65 65 53 70 61 63 65 41 } //01 00 
