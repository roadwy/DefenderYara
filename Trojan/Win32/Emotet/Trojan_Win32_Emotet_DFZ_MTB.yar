...
rule Trojan_Win32_Emotet_DFZ_MTB{
	...
	strings :
		...
		$a_81_1 = {6c 54 6b 6f 4e 6b 46 71 6c 79 72 6c 64 38 74 43 79 36 4b 55 6d 6b 39 44 5a 35 64 57 69 34 35 37 59 6d 79 46 72 } //00 00  lTkoNkFqlyrld8tCy6KUmk9DZ5dWi457YmyFr
	condition:
		any of ($a_*)
