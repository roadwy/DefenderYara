...
rule Trojan_Win32_Emotet_HK_svc{
	...
	strings :
		...
		$a_03_3 = {68 bb 01 00 00 68 90 01 03 00 53 ff 15 90 01 03 00 8b f0 85 f6 74 90 00 } //1
		$a_03_4 = {6a 00 68 00 f7 04 84 6a 00 6a 00 68 90 01 03 00 68 90 01 03 00 8d 45 f4 90 00 } //1
	condition:
