...
rule Trojan_Win32_Emotet_HK_svc{
	...
	strings :
		$a_01_0 = {57 00 69 00 6e 00 44 00 65 00 66 00 53 00 65 00 72 00 76 00 69 00 63 00 65 00 } //01 00 
		$a_01_1 = {63 3d 69 6e 73 74 61 6c 6c 65 64 } //01 00 
		$a_01_2 = {5c 73 65 74 75 70 2e 65 78 65 } //01 00 
