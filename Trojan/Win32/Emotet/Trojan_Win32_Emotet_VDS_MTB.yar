...
rule Trojan_Win32_Emotet_VDS_MTB{
	...
	strings :
		...
		$a_02_2 = {33 c5 89 45 fc c7 05 90 01 04 30 5a 0a 00 6a 00 ff 15 90 01 04 8b 0d 90 01 04 03 c8 89 0d 90 09 05 00 a1 90 00 } //2
		$a_02_3 = {8b ca b8 ff 01 00 00 03 c1 2d ff 01 00 00 a3 90 01 04 a1 90 01 04 8b 0d 90 01 04 89 08 90 00 } //2
	condition:
