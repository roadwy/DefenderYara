...
rule Trojan_Win32_Emotet_PVK_MTB{
	...
	strings :
		...
		$a_02_2 = {8b d7 b8 a8 dd 00 00 8b ca b8 ff 01 00 00 03 c1 2d ff 01 00 00 a3 ?? ?? ?? ?? a1 ?? ?? ?? ?? 8b 0d ?? ?? ?? ?? 89 08 } //2
		$a_02_3 = {8a 4c 10 03 8a d9 8a f9 80 e3 f0 c0 e1 06 0a 4c 10 02 80 e7 fc c0 e3 02 0a 1c 10 c0 e7 04 0a 7c 10 01 81 3d ?? ?? ?? ?? be 00 00 00 88 8d fb fb ff ff } //2
