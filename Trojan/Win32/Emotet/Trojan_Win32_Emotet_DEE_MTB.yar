...
rule Trojan_Win32_Emotet_DEE_MTB{
	...
	strings :
		$a_02_0 = {03 c2 99 b9 90 01 04 f7 f9 8b 4c 24 90 01 01 8b 84 24 90 01 04 8a 1c 01 8a 54 14 90 01 01 32 da 88 1c 01 90 02 04 89 4c 24 90 01 01 8b 8c 24 90 01 04 85 c9 0f 85 90 00 } //1
