...
rule Trojan_Win32_Emotet_DEM_MTB{
	...
	strings :
		$a_02_0 = {8b 45 dc 2b c8 8b 55 e0 2b ca 8b 45 e4 2b c8 2b 0d 90 01 04 2b 0d 90 01 04 8b 55 0c 8b 45 e8 88 04 0a 90 00 } //10
	condition:
		((#a_02_0  & 1)*10) >=10
...
rule Trojan_Win32_Emotet_DEM_MTB_2{
	...
	strings :
		$a_02_0 = {0f b6 d3 03 c2 99 b9 90 01 04 f7 f9 8b 4c 24 1c 8b 44 24 24 41 89 4c 24 1c 8a 54 14 28 30 54 01 ff 90 00 } //1
