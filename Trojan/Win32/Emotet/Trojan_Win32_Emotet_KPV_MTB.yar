...
rule Trojan_Win32_Emotet_KPV_MTB{
	...
	strings :
		$a_02_0 = {8b 45 08 8a 8c 15 90 01 02 ff ff 30 08 40 ff 4d f8 89 45 08 0f 85 90 00 } //2
		$a_02_1 = {8a 08 32 8c 15 90 01 02 ff ff 8b 55 10 03 95 90 01 02 ff ff 88 0a 8b 85 90 01 02 ff ff 83 c0 01 89 85 90 00 } //2
