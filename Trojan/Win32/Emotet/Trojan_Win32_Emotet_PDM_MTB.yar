...
rule Trojan_Win32_Emotet_PDM_MTB{
	...
	strings :
		...
		$a_81_1 = {64 34 35 77 68 30 59 44 38 49 32 49 75 35 67 70 6c 76 6c 4d 65 50 54 54 57 63 34 33 70 4b 61 33 6f 59 4b 65 4a } //00 00  d45wh0YD8I2Iu5gplvlMePTTWc43pKa3oYKeJ
	condition:
		any of ($a_*)
