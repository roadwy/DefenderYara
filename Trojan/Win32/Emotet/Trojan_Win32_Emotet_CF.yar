...
rule Trojan_Win32_Emotet_CF_2{
	...
	strings :
		$a_03_0 = {55 54 b9 04 00 00 00 89 1d 90 01 02 40 00 83 f9 03 74 20 58 01 c8 8f 05 90 01 02 40 00 a3 90 01 02 40 00 39 e0 0f 84 90 00 } //7
		$a_03_1 = {83 f8 04 74 03 89 45 fc c3 5a 01 ca 85 c0 89 15 90 01 01 a5 40 00 90 00 } //8
