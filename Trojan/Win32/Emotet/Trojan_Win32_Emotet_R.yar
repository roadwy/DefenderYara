...
rule Trojan_Win32_Emotet_R{
	...
	strings :
		...
		$a_03_2 = {bb a3 0c 23 c7 84 90 02 05 e4 ac d0 19 c7 84 90 02 05 b1 e1 01 5d 8b 8c 90 02 05 c7 84 90 02 05 0a b0 51 23 90 00 } //10
		$a_03_3 = {c0 28 80 41 90 02 04 3d 27 74 00 2e 90 00 } //10
		$a_03_4 = {66 c7 44 24 90 01 01 78 dd c7 44 24 90 01 01 95 13 b3 5d 90 00 } //10
	condition:
