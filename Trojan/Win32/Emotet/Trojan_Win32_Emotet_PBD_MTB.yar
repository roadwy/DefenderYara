...
rule Trojan_Win32_Emotet_PBD_MTB{
	...
	strings :
		...
		$a_03_1 = {2b d7 03 54 24 ?? 03 54 24 ?? 03 54 24 ?? 0f b6 14 02 8b 44 24 ?? 30 54 28 ?? 3b ac 24 [0-04] 0f 82 } //2
		$a_03_2 = {03 d7 03 54 24 ?? 03 54 24 ?? 0f b6 14 02 8b 44 24 ?? 30 54 28 ?? 3b 6c 24 ?? 0f 82 } //2
	condition:
...
rule Trojan_Win32_Emotet_PBD_MTB_2{
	...
	strings :
		$a_02_0 = {0f b6 54 24 ?? 0f b6 04 2b 03 c2 33 d2 f7 35 ?? ?? ?? ?? 8a 04 2a 8b 54 24 ?? 32 04 11 8b 54 24 ?? 88 04 11 } //1
