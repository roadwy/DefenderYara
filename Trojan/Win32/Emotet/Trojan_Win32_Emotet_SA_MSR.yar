...
rule Trojan_Win32_Emotet_SA_MSR_2{
	...
	strings :
		$a_03_0 = {41 66 78 43 6f 6e 74 72 6f 6c 42 61 72 90 01 02 73 90 00 } //1
		$a_03_1 = {41 66 78 4d 44 49 46 72 61 6d 65 90 01 02 73 90 00 } //1
		$a_03_2 = {41 66 78 46 72 61 6d 65 4f 72 56 69 65 77 90 01 02 73 90 00 } //1
