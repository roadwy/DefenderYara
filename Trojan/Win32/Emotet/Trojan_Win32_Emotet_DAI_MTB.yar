...
rule Trojan_Win32_Emotet_DAI_MTB{
	...
	strings :
		$a_02_0 = {6a 00 6a 00 ff 15 ?? ?? ?? ?? 6a 00 6a 00 ff 15 90 1b 00 6a 00 6a 00 ff 15 90 1b 00 6a 00 6a 00 ff 15 90 1b 00 6a 00 6a 00 ff 15 90 1b 00 8b 55 08 03 55 ec 33 c0 8a 02 8b 4d fc 03 4d f8 81 e1 ff 00 00 00 33 d2 8a 94 0d ?? ?? ?? ?? 33 c2 8b 4d 08 03 4d ec 88 01 } //1
