...
rule Trojan_Win32_Emotet_PSV_MTB{
	...
	strings :
		...
		$a_81_1 = {30 64 71 6b 69 7a 4c 50 62 6c 65 7a 37 33 6b 30 6b 43 77 4d 47 71 6a 66 7a 70 33 72 57 67 65 68 45 73 46 74 } //00 00  0dqkizLPblez73k0kCwMGqjfzp3rWgehEsFt
	condition:
		any of ($a_*)
