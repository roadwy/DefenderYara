...
rule Trojan_Win32_Emotet_PAE_MTB{
	...
	strings :
		...
		$a_03_2 = {03 c2 99 f7 fb 0f b6 c2 0f b6 14 08 30 55 90 01 01 83 6c 24 90 01 01 01 75 90 01 01 8a 4c 24 90 01 01 8b 44 24 90 01 01 8a 54 24 90 01 01 5f 5e 5d 88 50 01 88 08 5b 83 c4 90 01 01 c3 90 00 } //3
	condition:
