...
rule Trojan_Win32_Emotet_PAE_MTB{
	...
	strings :
		$a_01_0 = {36 33 5b 34 5d 35 6d 6d 5d 35 5c 5d 6d 5d 6d 6d 35 5c 6d 6d 35 35 35 35 35 35 35 5c 5c 5c 35 5c 5c 5c 35 6d 5c 35 35 5c 5c 35 65 64 } //01 00 
		$a_01_1 = {63 4f 58 59 2f 50 2e 5a 30 2e 30 2e 51 52 30 30 2f 5a 50 50 30 30 30 30 30 30 30 2f 30 50 50 5a 52 2e 42 49 40 2f 44 45 30 } //03 00 
