...
rule Trojan_Win32_Emotet_PSQ_MTB{
	...
	strings :
		...
		$a_81_1 = {41 71 4e 57 5a 52 50 6e 38 4b 50 44 78 38 59 56 36 41 44 6e 75 54 69 73 30 4d 32 5a 6d 49 37 31 56 6e 6e 51 38 72 77 55 67 } //00 00  AqNWZRPn8KPDx8YV6ADnuTis0M2ZmI71VnnQ8rwUg
	condition:
		any of ($a_*)
