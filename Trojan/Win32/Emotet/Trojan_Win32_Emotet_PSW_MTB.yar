...
rule Trojan_Win32_Emotet_PSW_MTB{
	...
	strings :
		...
		$a_81_1 = {36 53 78 57 57 6e 6e 5a 30 66 63 7a 71 76 68 70 64 34 31 7a 30 79 6e 37 62 66 42 43 68 54 57 4f 78 68 61 46 4b 68 64 56 45 78 37 5a 4b } //00 00  6SxWWnnZ0fczqvhpd41z0yn7bfBChTWOxhaFKhdVEx7ZK
	condition:
		any of ($a_*)
