...
rule Trojan_Win32_Emotet_CC_MTB_2{
	...
	strings :
		$a_02_0 = {81 e1 32 88 db 0e 33 c1 8b 55 ec c1 e2 1b c1 fa 1f 81 e2 64 10 b7 1d 33 c2 8b 4d ec c1 e1 1a c1 f9 1f 81 e1 c8 20 6e 3b 33 c1 8b 55 ec c1 e2 19 c1 fa 1f 81 e2 90 01 01 41 dc 76 33 c2 8b 4d ec c1 e1 18 c1 f9 1f 81 e1 20 83 b8 ed 33 c1 90 00 } //1
		$a_02_1 = {20 83 b8 ed c7 45 90 01 02 41 dc 76 c7 45 90 01 01 c8 20 6e 3b c7 45 90 01 01 64 10 b7 1d c7 45 90 01 01 32 88 db 0e c7 45 90 01 01 19 c4 6d 07 c7 45 90 01 01 2c 61 0e ee c7 45 90 01 01 96 30 07 77 90 00 } //1
	condition:
