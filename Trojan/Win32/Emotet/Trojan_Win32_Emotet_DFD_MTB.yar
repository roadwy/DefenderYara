...
rule Trojan_Win32_Emotet_DFD_MTB{
	...
	strings :
		...
		$a_81_1 = {63 6f 52 43 43 4a 37 32 71 33 70 68 30 6c 4d 59 6b 6e 39 64 65 37 34 4e 4b 79 30 79 62 4e 79 79 6a 78 45 58 6b 38 } //00 00  coRCCJ72q3ph0lMYkn9de74NKy0ybNyyjxEXk8
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Emotet_DFD_MTB_2{
	...
	strings :
		...
		$a_81_1 = {4c 6f 6b 56 37 44 35 6a 66 72 69 34 56 6a 48 50 64 31 6d 74 56 31 70 70 4e 4a 71 73 47 68 35 38 42 6a 67 6d 52 6f 42 44 4d 45 69 77 58 46 50 } //00 00  LokV7D5jfri4VjHPd1mtV1ppNJqsGh58BjgmRoBDMEiwXFP
	condition:
		any of ($a_*)
