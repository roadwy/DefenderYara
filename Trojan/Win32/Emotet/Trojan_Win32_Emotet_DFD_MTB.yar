...
rule Trojan_Win32_Emotet_DFD_MTB{
	...
	strings :
		$a_02_0 = {8b 45 e8 0f b6 84 05 90 01 04 0f b6 4d 17 03 c1 99 8b cb f7 f9 8b 45 e4 8a 8c 15 90 1b 00 30 08 90 00 } //1
...
rule Trojan_Win32_Emotet_DFD_MTB_2{
	...
	strings :
		$a_02_0 = {03 c2 99 f7 bd 90 01 04 0f b6 84 15 90 01 04 8b 4d 10 03 8d 90 01 04 0f b6 11 33 d0 8b 45 10 03 85 90 1b 02 88 10 90 00 } //1
