...
rule Trojan_Win32_Emotet_PC_bit{
	...
	strings :
		...
		$a_03_4 = {31 d2 f7 f1 8b 0d 90 01 04 8a 1c 11 8b 4d 90 01 01 8b 55 90 01 01 8a 3c 11 28 df 88 3c 11 81 c2 ff 00 00 00 8b 75 90 01 01 39 f2 89 55 90 01 01 72 90 00 } //1
		$a_03_5 = {89 f1 01 c1 83 c1 08 8b 01 8b 4d 90 01 01 c6 01 90 01 01 8b 4d 90 01 01 29 cf 8b 4d 90 01 01 01 f9 01 d9 8b 7d 90 01 01 89 0f 90 00 } //1
	condition:
