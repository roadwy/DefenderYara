...
rule Trojan_Win32_Emotet_PPP_MTB{
	...
	strings :
		$a_02_0 = {0f b6 c9 03 c1 99 b9 90 01 04 f7 f9 0f b6 94 15 90 01 04 30 53 ff 90 00 } //1
		...
		$a_02_2 = {0f b6 84 05 90 01 04 03 c1 b9 90 01 04 99 f7 f9 8b 45 90 01 01 8a 8c 15 90 01 04 30 08 90 00 } //1
		...
		$a_02_4 = {81 e1 ff 00 00 00 03 c1 b9 90 01 04 99 f7 f9 8a 03 8a 54 14 90 01 01 32 c2 88 03 90 00 } //1
		...
		$a_02_6 = {0f b6 cb 03 c1 99 b9 90 01 04 f7 f9 8a 5d 00 8b 44 24 90 01 01 8a 54 14 90 01 01 32 da 88 5d 00 90 00 } //1
		...
		$a_02_8 = {0f b6 8c 05 90 01 04 0f b6 c3 03 c1 b9 90 01 04 99 f7 f9 8b 85 90 01 04 8a 8c 15 90 01 04 30 08 90 00 } //1
		...
		$a_02_10 = {0f b6 8c 05 90 01 04 0f b6 c3 03 c1 99 b9 90 01 04 f7 f9 8b 85 90 01 04 8a 8c 15 90 01 04 30 08 90 00 } //1
		...
		$a_02_12 = {0f b6 cb 03 c1 99 b9 90 01 04 f7 f9 83 c4 90 01 01 83 c5 01 0f b6 54 14 90 01 01 30 55 90 00 } //1
		...
		$a_02_14 = {0f b6 cb 03 c1 99 b9 90 01 04 f7 f9 8b 44 24 90 01 01 8b 4c 24 90 01 01 40 89 44 24 90 01 01 8a 54 14 90 01 01 30 54 01 90 00 } //1
		...
		$a_02_16 = {0f b6 16 0f b6 c3 03 c2 8b f1 99 f7 fe 8b 45 90 01 01 8a 94 15 90 01 04 30 10 90 00 } //1
		...
		$a_02_18 = {0f b6 44 14 90 01 01 0f b6 cb 03 c1 99 b9 90 01 04 f7 f9 8b 4c 24 90 01 01 8b 44 24 90 01 01 83 c1 01 89 4c 24 90 01 01 8a 54 14 90 01 01 30 54 08 90 00 } //1
		$a_02_19 = {0f b6 44 14 90 01 01 0f b6 cb 03 c1 99 b9 90 01 04 f7 f9 8b 4c 24 90 01 01 8b 84 24 90 01 04 8a 1c 01 8a 54 14 90 01 01 32 da 88 1c 01 90 00 } //1
		...
		$a_02_21 = {0f b6 84 35 90 01 04 0f b6 c9 03 c1 99 b9 90 01 04 f7 f9 0f b6 94 15 90 01 04 30 53 ff 90 00 } //1
