...
rule Trojan_Win32_Emotet_DEB_MTB{
	...
	strings :
		$a_02_0 = {0f b6 cb 03 c1 99 b9 90 01 04 f7 f9 8a 5d 00 8b 44 24 90 01 01 8a 54 14 90 01 01 32 da 88 5d 00 45 48 89 44 24 90 01 01 75 90 00 } //1
		$a_02_1 = {0f b6 06 0f b6 cb 03 c1 8b cf 99 f7 f9 8b 45 14 8a 8c 15 90 01 04 30 08 40 ff 4d 0c 89 45 14 75 90 00 } //1
