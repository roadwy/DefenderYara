...
rule Trojan_Win32_Emotet_PBE_MTB{
	...
	strings :
		$a_03_0 = {03 c2 99 bd 2c 4d 00 00 f7 fd a1 ?? ?? ?? ?? 8d 04 42 2b c6 2b c1 03 44 24 ?? 8b 54 24 ?? 03 44 24 ?? 03 44 24 ?? 03 c7 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_Win32_Emotet_PBE_MTB_2{
	...
	strings :
		$a_02_0 = {8b 08 8b 55 ?? 33 c0 8a 04 0a 8b 4d ?? 03 4d ?? 33 d2 8a 11 33 c2 8b 0d ?? ?? ?? ?? 8b 11 8b 4d ?? 88 04 11 } //1
		$a_02_1 = {0f b6 04 0b 03 c2 33 d2 f7 35 ?? ?? ?? ?? 8a 04 0a 8b 55 ?? 32 04 17 8b 55 ?? 88 04 17 } //1
