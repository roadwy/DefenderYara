...
rule Trojan_Win32_Emotet_J_MTB{
	...
	strings :
		$a_00_0 = {40 2e 65 68 5f 66 72 61 6d } //01 00 
		$a_00_1 = {53 65 74 55 6e 68 61 6e 64 6c 65 64 45 78 63 65 70 74 69 6f 6e 46 69 6c 74 65 72 } //01 00 
...
rule Trojan_Win32_Emotet_J_MTB_2{
	...
	strings :
		...
		$a_00_16 = {53 65 74 55 6e 68 61 6e 64 6c 65 64 45 78 63 65 70 74 69 6f 6e 46 69 6c 74 65 72 } //01 00 
		$a_00_17 = {5f 65 78 63 65 70 74 5f 68 61 6e 64 6c 65 72 } //00 00 
	condition:
		any of ($a_*)
