...
rule Trojan_Win32_Emotet_RFA_MTB{
	...
	strings :
		...
		$a_03_2 = {88 14 08 e9 90 09 46 00 90 02 20 33 d1 a1 90 01 04 0f af 05 90 01 04 0f af 05 90 01 04 8b 4d 90 01 01 2b 0d 90 01 04 2b c8 2b 0d 90 01 04 03 0d 90 01 04 03 0d 90 01 04 8b 45 90 00 } //5
	condition:
