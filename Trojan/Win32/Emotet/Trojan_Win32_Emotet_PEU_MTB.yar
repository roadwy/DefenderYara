...
rule Trojan_Win32_Emotet_PEU_MTB{
	...
	strings :
		$a_02_0 = {0f b6 54 3c 90 01 01 0f b6 c0 03 c2 99 f7 fb 8a 1c 2e 8a 44 14 90 01 01 32 c3 88 06 90 00 } //1
		$a_02_1 = {8a 14 31 8b 44 24 90 01 01 32 94 04 90 01 04 8d 4c 24 90 01 01 88 16 c7 84 24 90 01 04 ff ff ff ff 90 09 08 00 8b 4c 24 90 01 01 8b 74 24 90 00 } //1
