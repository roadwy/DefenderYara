...
rule Trojan_Win32_Emotet_PF_bit{
	...
	strings :
		$a_03_0 = {8a 18 8d b4 bd fc fb ff ff 88 5d ff 8b 1e 89 18 0f b6 5d ff 89 1e 8b 00 03 c3 25 ff 00 00 80 79 07 48 0d 00 ff ff ff 40 8a 84 85 fc fb ff ff 30 82 ?? ?? ?? ?? 42 81 fa 4e 0e 00 00 72 } //1
