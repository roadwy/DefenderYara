...
rule Trojan_Win32_Emotet_DEF_MTB{
	...
	strings :
		$a_02_0 = {33 c0 81 e2 ff 00 00 00 8a 44 0c 90 01 01 b9 90 01 04 03 c2 8b ac 24 90 01 04 99 f7 f9 8b 4c 24 90 01 01 8a 04 29 8a 54 14 90 01 01 32 c2 88 04 29 90 00 } //1
