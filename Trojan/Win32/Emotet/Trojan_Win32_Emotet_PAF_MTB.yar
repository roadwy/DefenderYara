...
rule Trojan_Win32_Emotet_PAF_MTB{
	...
	strings :
		...
		$a_01_1 = {64 00 72 00 74 00 66 00 66 00 44 00 57 00 45 00 55 00 46 00 45 00 55 00 46 00 55 00 57 00 45 00 47 00 46 00 55 00 59 00 42 00 47 00 } //00 00  drtffDWEUFEUFUWEGFUYBG
	condition:
		any of ($a_*)
