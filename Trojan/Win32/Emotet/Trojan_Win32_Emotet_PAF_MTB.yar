...
rule Trojan_Win32_Emotet_PAF_MTB{
	...
	strings :
		$a_03_0 = {8b da 03 d9 ff 15 90 01 04 8a 14 33 8a 44 24 90 01 01 8b 4c 24 90 01 01 02 d0 8b 44 24 90 01 01 32 14 01 88 10 40 89 44 24 90 01 01 ff 4c 24 90 01 01 75 90 00 } //1
