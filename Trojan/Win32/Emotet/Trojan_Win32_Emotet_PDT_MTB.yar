...
rule Trojan_Win32_Emotet_PDT_MTB{
	...
	strings :
		...
		$a_81_1 = {54 4b 32 59 50 4c 71 38 6b 7a 39 56 6d 78 65 77 42 6a 79 39 72 4b 78 53 51 66 67 50 59 42 74 6e 73 51 79 31 51 58 } //00 00  TK2YPLq8kz9VmxewBjy9rKxSQfgPYBtnsQy1QX
	condition:
		any of ($a_*)
