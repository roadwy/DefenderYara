...
rule Trojan_Win32_Emotet_PED_MTB{
	...
	strings :
		...
		$a_81_1 = {59 6f 4f 39 71 34 75 58 5a 4f 56 44 59 7a 30 59 73 31 51 4b 4b 58 52 54 77 65 38 54 71 42 50 6f 46 4f 44 6c 46 49 69 } //00 00  YoO9q4uXZOVDYz0Ys1QKKXRTwe8TqBPoFODlFIi
	condition:
		any of ($a_*)
