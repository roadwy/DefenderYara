...
rule Trojan_Win32_Emotet_PSO_MTB{
	...
	strings :
		$a_02_0 = {0f b6 4c 24 90 01 01 89 84 24 90 01 04 8b 44 24 90 01 01 0f b6 84 04 90 01 04 03 c1 99 b9 90 01 04 f7 f9 8b 84 24 90 01 04 8a 8c 14 90 01 04 30 08 90 00 } //1
