...
rule Trojan_Win32_Emotet_DAP_MTB{
	...
	strings :
		...
		$a_00_1 = {56 69 72 74 75 61 6c 41 6c 6c 6f 63 45 78 4e 75 6d 61 } //01 00 
		$a_00_2 = {6d 65 6d 63 70 79 } //01 00 
		$a_00_3 = {43 00 6f 00 70 00 79 00 46 00 69 00 6c 00 65 00 57 00 } //01 00 
		$a_00_4 = {53 00 68 00 65 00 6c 00 6c 00 45 00 78 00 65 00 63 00 75 00 74 00 65 00 57 00 } //01 00 
		$a_00_5 = {43 00 72 00 79 00 70 00 74 00 53 00 74 00 72 00 69 00 6e 00 67 00 54 00 6f 00 42 00 69 00 6e 00 61 00 72 00 79 00 41 00 } //00 00 
	condition:
		any of ($a_*)
