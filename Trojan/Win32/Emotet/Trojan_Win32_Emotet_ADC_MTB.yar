...
rule Trojan_Win32_Emotet_ADC_MTB{
	...
	strings :
		...
		$a_00_6 = {5d 04 00 00 02 13 05 80 5c 2b 00 00 03 13 05 80 00 00 01 00 08 00 15 00 af 01 41 67 65 6e 74 54 65 73 6c 61 2e 52 50 58 4d 21 4d 54 42 00 00 02 40 05 82 70 00 04 00 67 16 00 00 d8 e2 b8 5d 6d 70 d6 5b 2a ad de 52 00 5c 00 00 01 20 2a ad de 52 e7 59 00 00 00 00 55 00 17 3f fc 73 bc f2 ea 8f e6 80 bc c2 f2 d1 80 d0 80 8f e6 80 bc c2 bc d1 ea 0b c2 99 f2 1e c2 d1 80 1e 8f e6 80 bc c2 3f d0 } //c2 99 
	condition:
		any of ($a_*)
