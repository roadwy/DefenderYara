...
rule Trojan_Win32_Emotet_PEC_MTB{
	...
	strings :
		$a_02_0 = {0f b6 cb 03 c1 8b ce 99 f7 f9 8b 45 90 01 01 8a 9c 15 90 01 04 32 18 90 00 } //1
		$a_02_1 = {81 e1 ff 00 00 00 03 c1 b9 90 01 04 99 f7 f9 8a 4d 00 8a 5c 14 90 01 01 32 d9 90 09 04 00 8a 44 34 90 00 } //1
