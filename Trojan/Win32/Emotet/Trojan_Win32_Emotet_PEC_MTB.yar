...
rule Trojan_Win32_Emotet_PEC_MTB{
	...
	strings :
		...
		$a_81_2 = {5a 48 51 58 43 62 78 79 44 46 59 35 6a 45 50 44 39 79 39 57 51 41 67 76 42 69 7a 41 68 53 5a 69 52 32 53 31 72 } //00 00  ZHQXCbxyDFY5jEPD9y9WQAgvBizAhSZiR2S1r
	condition:
		any of ($a_*)
