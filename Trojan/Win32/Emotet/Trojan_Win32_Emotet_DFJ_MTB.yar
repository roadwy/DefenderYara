...
rule Trojan_Win32_Emotet_DFJ_MTB{
	...
	strings :
		...
		$a_81_1 = {41 47 7a 6a 32 47 48 6d 58 51 73 75 5a 71 74 67 64 35 52 50 6a 47 6a 6a 39 6e 42 50 53 4c 39 6c 35 41 56 36 64 } //00 00  AGzj2GHmXQsuZqtgd5RPjGjj9nBPSL9l5AV6d
	condition:
		any of ($a_*)
