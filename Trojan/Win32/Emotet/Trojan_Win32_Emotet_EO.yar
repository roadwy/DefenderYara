...
rule Trojan_Win32_Emotet_EO{
	...
	strings :
		...
		$a_01_1 = {73 6d 35 69 6e 59 64 61 79 73 2e 31 39 37 65 78 74 65 6e 73 69 6f 6e 73 } //01 00  sm5inYdays.197extensions
		$a_01_2 = {6f 66 32 64 48 28 64 6f 6e 6b 65 79 29 34 35 35 33 34 32 39 49 66 20 69 6e 69 74 69 61 6c 2d 66 6f 72 } //00 00  of2dH(donkey)4553429If initial-for
	condition:
		any of ($a_*)
