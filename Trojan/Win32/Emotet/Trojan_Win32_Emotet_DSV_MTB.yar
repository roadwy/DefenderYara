...
rule Trojan_Win32_Emotet_DSV_MTB{
	...
	strings :
		...
		$a_81_1 = {59 56 33 57 4e 32 4a 36 59 42 4d 43 47 56 49 44 38 55 55 } //01 00  YV3WN2J6YBMCGVID8UU
		$a_81_2 = {51 5a 4d 4a 47 47 34 4d 48 50 48 4b 36 45 5a 47 30 45 53 } //00 00  QZMJGG4MHPHK6EZG0ES
	condition:
		any of ($a_*)
