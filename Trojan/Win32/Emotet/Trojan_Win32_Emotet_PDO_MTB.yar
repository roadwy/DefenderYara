...
rule Trojan_Win32_Emotet_PDO_MTB{
	...
	strings :
		$a_02_0 = {81 e1 ff 00 00 00 03 c1 b9 90 01 04 99 f7 f9 8a 03 8a 94 14 90 01 04 32 c2 88 03 90 00 } //1
		$a_02_1 = {0f b6 cb 03 c1 99 b9 90 01 04 f7 f9 8a 5d 90 01 01 8a 94 14 90 01 04 32 da 88 5d 90 00 } //1
