...
rule Trojan_Win32_Emotet_PDP_MTB{
	...
	strings :
		...
		$a_81_1 = {63 68 71 69 54 72 5a 71 69 6f 51 39 57 66 70 4a 43 45 5a 6b 5a 78 42 46 6a 62 41 6e 72 65 7a 73 45 58 67 5a 46 55 57 42 } //00 00  chqiTrZqioQ9WfpJCEZkZxBFjbAnrezsEXgZFUWB
	condition:
		any of ($a_*)
