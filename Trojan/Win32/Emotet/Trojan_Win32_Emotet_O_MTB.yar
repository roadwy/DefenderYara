...
rule Trojan_Win32_Emotet_O_MTB{
	...
	strings :
		$a_00_0 = {43 4c 53 49 44 5c 25 31 5c 49 6e 50 72 6f 63 53 65 72 76 65 72 33 32 } //02 00  CLSID\%1\InProcServer32
		$a_00_1 = {65 47 4e 6b 5a 67 3d } //02 00  eGNkZg=
		...
		$a_00_3 = {43 52 59 50 54 33 32 2e 44 4c 4c 00 43 72 79 70 74 53 74 72 69 6e 67 54 6f 42 69 6e 61 72 79 41 } //01 00  剃偙㍔⸲䱄L牃灹却牴湩呧䉯湩牡䅹
