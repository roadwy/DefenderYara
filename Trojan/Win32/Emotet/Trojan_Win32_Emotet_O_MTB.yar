...
rule Trojan_Win32_Emotet_O_MTB{
	...
	strings :
		...
		$a_02_2 = {4e 6f 52 75 6e 90 02 10 4e 6f 44 72 69 76 65 73 90 02 10 52 65 73 74 72 69 63 74 52 75 6e 90 02 10 4e 6f 4e 65 74 43 6f 6e 6e 65 63 74 44 69 73 63 6f 6e 6e 65 63 74 90 02 10 4e 6f 52 65 63 65 6e 74 44 6f 63 73 48 69 73 74 6f 72 79 90 02 10 4e 6f 43 6c 6f 73 65 90 00 } //2
