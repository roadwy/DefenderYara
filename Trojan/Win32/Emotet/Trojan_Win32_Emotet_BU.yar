...
rule Trojan_Win32_Emotet_BU{
	...
	strings :
		$a_01_0 = {6c 65 68 41 68 2e 70 64 62 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Emotet_BU_2{
	...
	strings :
		$a_01_0 = {40 64 4d 6c 45 7c 76 4b 70 71 2e 70 64 62 } //01 00 
		$a_01_1 = {72 53 56 7a 2f 66 39 3d 47 49 30 2e 70 64 62 } //03 00 
		$a_01_2 = {6b 65 79 62 64 5f 65 76 65 6e 74 } //02 00 
