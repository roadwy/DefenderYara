...
rule Trojan_Win32_Emotet_A{
	...
	strings :
		...
		$a_02_2 = {5c 41 70 70 6c 69 63 61 74 69 6f 6e 20 44 61 74 61 5c 4d 69 63 72 6f 73 6f 66 74 5c [0-0a] 2e 65 78 65 3a 5a 6f 6e 65 2e 49 64 65 6e 74 69 66 69 65 72 } //1
		...
		$a_03_5 = {72 65 67 3a 5c 75 6e 6b 6e 6f 77 6e [0-0a] 66 73 3a 5c 75 6e 6b 6e 6f 77 6e } //1
	condition:
