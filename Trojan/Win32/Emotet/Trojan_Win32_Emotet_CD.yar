...
rule Trojan_Win32_Emotet_CD{
	...
	strings :
		$a_01_0 = {4e 6a 68 5a 57 4e 5f 63 33 34 65 } //01 00 
		$a_01_1 = {65 00 3c 00 23 00 40 00 4d 00 3d 00 59 00 45 00 65 00 63 00 64 00 } //01 00 
		...
		$a_01_3 = {69 46 6e 4b 32 2e 70 64 62 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Emotet_CD_2{
	...
	strings :
		$a_01_0 = {43 7a 6a 64 45 47 79 35 57 4a 68 4f 75 75 4d 59 77 72 69 54 33 5f 70 36 41 74 2b 2e 70 64 62 } //01 00 
