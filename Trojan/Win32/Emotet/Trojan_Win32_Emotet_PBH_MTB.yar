...
rule Trojan_Win32_Emotet_PBH_MTB{
	...
	strings :
		...
		$a_81_1 = {62 7e 65 62 64 6e 7e 78 6d 61 68 74 4f 47 48 64 35 56 6d 47 65 6a 70 6e 24 6e 66 36 4c 69 43 70 6f 68 36 67 56 69 4f 45 38 56 7a 4f 40 43 5a 63 35 40 6c 24 69 54 31 40 40 43 43 77 50 49 48 41 6f 47 43 4e 30 } //00 00 
	condition:
		any of ($a_*)
