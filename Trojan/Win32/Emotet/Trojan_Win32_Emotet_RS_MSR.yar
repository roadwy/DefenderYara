...
rule Trojan_Win32_Emotet_RS_MSR{
	...
	strings :
		...
		$a_03_4 = {66 0f b6 32 8b cf 66 d3 e6 42 66 f7 d6 0f b7 ce 88 28 88 48 ?? 03 45 ?? ff 4d ?? 75 } //1
		$a_03_5 = {2a c3 88 07 47 ff 4d [0-04] 8a 02 42 3a c3 7d [0-04] eb } //1
	condition:
...
rule Trojan_Win32_Emotet_RS_MSR_2{
	...
	strings :
		...
		$a_02_1 = {b8 c6 01 00 00 b8 c6 01 00 00 b8 c6 01 00 00 b8 c6 01 00 00 8b d6 8b ca b8 89 dc 00 00 03 c1 2d 89 dc 00 00 89 45 fc a1 ?? ?? ?? ?? 8b 4d fc 89 08 5e 8b e5 5d } //1
