...
rule Trojan_Win32_Emotet_DDP_MTB{
	...
	strings :
		$a_02_0 = {6a 00 ff 55 90 01 01 56 6a 00 89 45 90 01 01 ff 55 90 01 01 8b 55 90 01 01 52 89 45 90 01 01 ff 55 90 01 01 8b 4d 90 01 01 6a 00 89 45 90 01 01 8b 85 90 01 04 50 68 00 30 00 00 51 6a 00 ff d3 50 ff d7 90 00 } //1
