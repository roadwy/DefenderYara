...
rule Trojan_Win32_Emotet_PDQ_MTB{
	...
	strings :
		...
		$a_81_1 = {75 39 4a 72 39 77 4f 6f 4c 79 45 6a 71 49 49 37 48 6d 37 66 6b 74 61 65 71 48 72 41 38 49 6f 34 54 30 57 38 66 34 70 58 } //00 00  u9Jr9wOoLyEjqII7Hm7fktaeqHrA8Io4T0W8f4pX
	condition:
		any of ($a_*)
