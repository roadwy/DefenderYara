...
rule Trojan_Win32_Emotet_CD_MTB{
	...
	strings :
		...
		$a_81_1 = {77 21 53 6c 65 55 2b 2b 51 68 42 6d 72 46 4a 39 53 4a 5f 52 43 5e 66 4f 29 32 55 78 4e 35 4d 6c 4e 46 39 53 29 67 30 30 66 66 48 32 37 2a 69 78 45 46 4b 2a 58 26 25 4b 5e 40 65 6c 56 38 4c 74 49 25 50 43 6b 32 6f 2a 31 52 2b 63 36 2a 74 78 32 48 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Emotet_CD_MTB_2{
	...
	strings :
		$a_81_0 = {2a 57 49 4d 51 56 2a 34 56 37 73 69 23 61 48 78 3f 24 73 28 24 6d 55 7a 21 6b 2a 65 58 28 29 49 35 5a 34 23 24 6f 3c 69 28 6f 5a 64 48 41 66 45 34 6d 7a 53 3c 31 25 40 4e 40 4e 47 59 35 57 5e 32 62 59 59 56 56 70 29 } //03 00 
		$a_81_1 = {52 65 73 74 72 69 63 74 52 75 6e } //03 00 
		$a_81_2 = {4e 6f 44 72 69 76 65 73 } //03 00 
		$a_81_3 = {4f 74 68 65 72 2e 64 6c 6c } //03 00 
