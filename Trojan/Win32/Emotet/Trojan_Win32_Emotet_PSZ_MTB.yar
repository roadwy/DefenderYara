...
rule Trojan_Win32_Emotet_PSZ_MTB{
	...
	strings :
		...
		$a_81_1 = {49 47 4c 69 56 4b 42 75 64 6e 74 4a 71 52 49 4a 4b 36 71 4a 47 46 4b 70 34 7a 4c 65 55 78 45 42 71 50 72 76 6d 56 58 51 54 } //00 00  IGLiVKBudntJqRIJK6qJGFKp4zLeUxEBqPrvmVXQT
	condition:
		any of ($a_*)
