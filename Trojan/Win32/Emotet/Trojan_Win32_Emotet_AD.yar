...
rule Trojan_Win32_Emotet_AD_2{
	...
	strings :
		$a_03_0 = {8b ff 8b ca a3 90 01 04 8b c0 8b c0 8b c0 8b c0 8b c0 8b c0 8b c0 8b c0 8b c0 8b c0 8b c0 8b c0 8b c0 8b c0 8b c0 8b c0 8b c0 8b c0 8b c0 31 0d 90 01 04 a1 90 01 04 8b ff c7 05 90 01 04 00 00 00 00 8b ff 01 05 90 01 04 8b ff 8b 0d 90 01 04 8b 15 90 01 04 89 11 5f 5d 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_Win32_Emotet_AD_3{
	...
	strings :
		...
		$a_03_2 = {8b 45 e4 8b 4d f4 81 c1 7a 04 8e b7 89 c2 21 ca 8b 4d e8 89 0c 24 8b 75 ec 89 74 24 04 89 44 24 08 0f b6 14 15 90 01 04 89 54 24 0c 89 45 e0 e8 d2 0b 00 00 8b 45 e0 83 c0 01 8b 4d f0 39 c8 90 00 } //1
	condition:
