...
rule Trojan_Win32_Emotet_K{
	...
	strings :
		$a_03_0 = {55 54 89 1d bc 90 01 02 00 8f 05 c4 90 01 02 00 83 05 c4 90 01 02 00 08 83 2d c4 90 01 02 00 04 8f 05 c0 90 01 02 00 a1 c8 90 01 02 00 83 05 c4 90 01 02 00 04 83 2d c4 90 01 02 00 04 89 35 b4 90 01 02 00 89 3d b8 90 01 02 00 ff e0 cc ff 25 90 00 } //8
		$a_03_1 = {b9 00 d0 00 00 90 02 20 c7 04 24 00 00 00 00 90 00 } //1
		$a_03_2 = {c7 04 24 00 00 00 00 90 02 20 c7 44 24 04 00 d0 00 00 90 00 } //1
		$a_03_3 = {c7 44 24 04 00 d0 00 00 90 02 20 c7 44 24 0c 40 00 00 00 90 00 } //1
		$a_03_4 = {c7 40 0c 40 00 00 00 90 02 20 c7 40 08 00 10 00 00 90 00 } //1
		$a_03_5 = {c7 40 04 00 d0 00 00 90 02 20 c7 00 00 00 00 00 90 00 } //1
	condition:
...
rule Trojan_Win32_Emotet_K_2{
	...
	strings :
		...
		$a_03_1 = {8a 04 1e 88 04 3e 46 3b 75 f8 72 e0 8d 45 f8 8b d7 e8 90 01 02 ff ff ff 55 f0 5f 5e 33 c0 90 00 } //1
...
rule Trojan_Win32_Emotet_K_3{
	...
	strings :
		...
		$a_03_2 = {8d 44 24 0c ba 0c 00 00 00 50 68 90 01 04 b9 90 01 04 e8 90 01 02 ff ff 8b 90 01 01 24 14 83 c4 08 90 01 01 ff 15 90 01 04 85 c0 74 1b 68 90 00 } //1
		$a_03_3 = {8d 45 f8 ba 0c 00 00 00 50 68 90 01 04 b9 90 01 04 e8 90 01 02 ff ff 8b 75 f8 68 90 00 } //1
		$a_03_4 = {83 c0 04 c7 85 cc fb ff ff 04 01 00 00 89 85 c4 fb ff ff 57 c7 00 00 00 00 00 8d 85 dc fb ff ff 50 68 90 01 04 e8 be db ff ff 8d 85 d0 fb ff ff ba 28 00 00 00 50 68 90 00 } //1
		$a_03_5 = {8d 45 f8 ba 04 00 00 00 50 68 90 01 04 b9 90 01 04 e8 90 01 04 68 90 01 04 ff 75 f8 8d 90 01 04 ff 68 90 00 } //1
		$a_03_6 = {75 2a 8d 04 5d 02 00 00 00 50 8d 90 01 04 ff 50 6a 01 6a 00 68 90 01 04 ff 75 f4 ff 15 90 00 } //1
	condition:
