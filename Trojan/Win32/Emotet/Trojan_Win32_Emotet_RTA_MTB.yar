...
rule Trojan_Win32_Emotet_RTA_MTB{
	...
	strings :
		$a_03_0 = {6b c9 03 0f af d7 03 d3 03 d0 8b 44 24 90 01 01 8a 0c 11 30 08 ff 44 24 90 01 01 8b 44 24 90 01 01 3b 44 24 90 01 01 0f 82 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_Win32_Emotet_RTA_MTB_3{
	...
	strings :
		$a_03_0 = {0b c1 50 56 6a 00 6a ff ff 15 90 01 04 e9 90 00 } //1
		$a_03_1 = {03 c5 03 44 24 90 01 01 8b 6c 24 90 01 01 03 44 24 90 01 01 83 c5 01 03 44 24 90 01 01 89 6c 24 90 01 01 0f b6 14 10 8b 44 24 90 01 01 30 54 28 90 01 01 3b ac 24 90 00 } //1
	condition:
...
rule Trojan_Win32_Emotet_RTA_MTB_4{
	...
	strings :
		$a_03_0 = {03 c2 0b c8 51 8b 45 90 01 01 50 6a 00 6a ff ff 15 90 01 04 89 45 90 01 01 e9 90 00 } //1
