...
rule Trojan_Win32_Emotet_DCA_MTB{
	...
	strings :
		$a_02_0 = {03 c1 99 b9 90 01 04 f7 f9 8b 44 24 90 01 01 83 c0 01 83 c4 0c 89 44 24 90 01 01 8a 54 14 90 01 01 30 50 ff 83 bc 24 90 01 04 00 0f 85 90 00 } //50
		$a_02_1 = {03 c1 99 b9 90 01 04 f7 f9 8b 44 24 90 01 01 8a 18 8a 54 14 90 01 01 32 da 88 18 90 00 } //50
		$a_02_2 = {03 c2 83 c4 0c 99 f7 f9 8b 44 24 90 01 01 8a 08 8a 54 14 90 01 01 32 ca 88 08 90 00 } //50
