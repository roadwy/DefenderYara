...
rule Trojan_Win32_Emotet_L{
	...
	strings :
		...
		$a_00_3 = {67 70 6f 57 42 4f 49 49 68 64 54 6d 67 53 6b 57 } //01 00 
		$a_00_4 = {46 00 67 00 55 00 79 00 75 00 62 00 6a 00 65 00 54 00 69 00 46 00 71 00 51 00 6f 00 43 00 50 00 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Emotet_L_2{
	...
	strings :
		$a_01_0 = {64 66 73 67 64 66 68 64 66 67 68 64 66 67 68 2e 6a 70 67 } //01 00 
...
rule Trojan_Win32_Emotet_L_3{
	...
	strings :
		$a_01_0 = {73 00 71 00 6b 00 53 00 4b 00 7a 00 51 00 61 00 6d 00 44 00 6b 00 73 00 75 00 59 00 67 00 75 00 } //01 00 
		$a_01_1 = {67 77 48 4a 6c 39 4c 4c 77 2e 70 64 62 } //00 00 
	condition:
		any of ($a_*)
