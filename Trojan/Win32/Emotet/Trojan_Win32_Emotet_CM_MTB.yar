...
rule Trojan_Win32_Emotet_CM_MTB{
	...
	strings :
		$a_02_0 = {6a 00 6a 00 ff d6 6a 00 6a 00 ff d6 6a 00 6a 00 ff d6 02 5c 24 90 01 01 83 c7 01 0f b6 c3 8a 4c 04 1c 8b 44 24 90 01 01 30 4c 38 ff 3b bc 24 90 01 04 0f 8c 90 00 } //1
