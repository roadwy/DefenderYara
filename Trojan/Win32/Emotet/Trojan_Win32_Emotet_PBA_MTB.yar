...
rule Trojan_Win32_Emotet_PBA_MTB{
	...
	strings :
		$a_02_0 = {0f b6 04 0e 0f b6 d2 03 c2 33 d2 f7 35 90 01 04 0f b6 04 0a 32 44 2b 90 01 01 83 6c 24 90 01 01 01 88 45 90 00 } //1
		$a_02_1 = {0f b6 04 0f 0f b6 d2 03 c2 33 d2 f7 35 90 01 04 8a 04 0a 32 04 2b 88 45 90 00 } //1
