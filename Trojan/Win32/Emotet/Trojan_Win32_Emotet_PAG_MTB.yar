...
rule Trojan_Win32_Emotet_PAG_MTB_2{
	...
	strings :
		$a_03_0 = {6a 0a 8b 01 8b 40 90 01 01 ff d0 0f b6 c0 8b ce 50 e8 90 02 04 8b ce e8 90 02 04 a1 90 02 04 8b d7 0f b6 90 02 04 47 2b 15 90 02 04 8a 04 01 b9 90 01 02 00 00 30 04 1a 8b 45 90 01 01 3b 7d 90 01 01 0f 8c 90 00 } //2
