...
rule Trojan_Win32_Mupad_D{
	...
	strings :
		$a_03_0 = {66 89 45 f6 c7 45 e4 00 00 00 00 c7 45 cc 00 00 00 00 8b 4d b4 89 4d b8 ba 90 01 03 00 85 d2 0f 84 90 01 02 00 00 83 7d b8 00 0f 84 90 01 02 00 00 b8 90 01 03 00 85 c0 0f 84 90 01 01 00 00 00 90 00 } //1
		$a_03_1 = {6a 00 ff 15 90 01 02 40 00 6a 00 ff 15 90 01 02 40 00 83 f8 23 74 90 01 01 8b 90 01 01 c8 90 00 } //1
		$a_03_2 = {6a 00 ff 15 90 01 02 40 00 85 c0 75 10 c7 45 c8 ff ff ff ff b9 40 00 00 00 51 ff 75 c4 ba 00 13 00 00 52 6a 00 b8 00 00 00 00 40 83 7d b8 42 90 00 } //1
	condition:
...
rule Trojan_Win32_Mupad_D_3{
	...
	strings :
		$a_03_0 = {c7 45 e4 00 00 00 00 c7 45 cc 00 00 00 00 8b 4d b4 89 4d b8 ba 90 01 03 00 85 d2 0f 84 90 01 02 00 00 83 7d b8 00 0f 84 90 01 02 00 00 b8 90 01 03 00 85 c0 0f 84 90 01 01 00 00 00 90 00 } //1
		$a_03_1 = {89 45 c0 6a 00 ff 15 90 01 02 40 00 6a 00 ff 15 90 01 02 40 00 83 f8 23 74 08 6a 00 ff 15 90 01 02 40 00 8b 55 c8 89 15 90 01 02 4c 00 6a 00 90 00 } //1
		$a_01_2 = {85 c0 75 10 c7 45 c8 ff ff ff ff b9 40 00 00 00 51 ff 75 c4 b9 70 13 00 00 51 b9 00 00 00 00 51 83 7d b8 42 } //1
		$a_03_3 = {6a 0a ff 15 90 01 02 40 00 6a 00 ff 15 90 01 02 40 00 85 c0 75 90 01 01 a1 90 01 02 40 00 89 45 b8 8b 4d b8 ff d1 a3 90 01 02 4c 00 c7 45 b4 0c 00 00 00 90 00 } //1
	condition:
