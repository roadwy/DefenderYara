...
rule Trojan_Win32_Batload_K_MSR{
	...
	strings :
		...
		$a_81_1 = {6e 65 77 74 65 73 74 2e 62 61 74 } //01 00  newtest.bat
		$a_81_2 = {61 76 6f 6c 6b 6f 76 5c 78 36 34 5c 52 65 6c 65 61 73 65 20 47 61 72 62 5c 61 76 6f 6c 6b 6f 76 2e 70 64 62 } //00 00  avolkov\x64\Release Garb\avolkov.pdb
	condition:
		any of ($a_*)
