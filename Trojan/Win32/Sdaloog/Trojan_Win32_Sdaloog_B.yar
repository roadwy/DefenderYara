...
rule Trojan_Win32_Sdaloog_B{
	...
	strings :
		$a_03_0 = {81 7d 00 50 45 00 00 0f 85 90 01 04 6a 04 68 00 30 00 00 ff 75 50 ff 75 34 ff 90 00 } //1
		$a_03_1 = {c0 e0 04 2c 10 0a c3 32 c1 32 90 02 05 88 06 32 e8 90 02 06 eb 0e 90 00 } //1
