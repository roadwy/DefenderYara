...
rule Trojan_Win32_Torl_A{
	...
	strings :
		$a_03_0 = {8b 93 80 03 00 00 0f b6 92 6a 02 00 00 4a 80 ea 01 0f 92 c1 ba 90 01 04 e8 90 01 02 ff ff 8b 83 84 03 00 00 8b 80 70 02 00 00 8b 10 ff 52 14 90 00 } //1
