...
rule Trojan_Win32_Simeda_A{
	...
	strings :
		$a_03_0 = {55 8b ec 83 ec 4c 53 56 57 b9 05 00 00 00 be 90 01 04 8d 7d ec f3 a5 a1 90 01 04 89 45 dc 8b 0d 90 01 04 89 4d e0 8b 15 90 01 04 89 55 e4 a0 90 01 04 88 45 e8 8d 4d ec 51 ff 15 90 00 } //1
		...
		$a_02_4 = {4e 65 74 42 6f 74 5f 41 74 74 61 63 6b 90 02 04 5c 53 65 72 76 65 72 5c 73 76 63 68 6f 73 74 5c 52 65 6c 65 61 73 65 5c 33 36 35 43 6b 6a 78 2e 70 64 62 90 00 } //1
	condition:
