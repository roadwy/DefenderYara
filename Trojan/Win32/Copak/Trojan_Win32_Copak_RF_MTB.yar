...
rule Trojan_Win32_Copak_RF_MTB{
	...
	strings :
		$a_03_0 = {68 a0 36 4b 00 c3 90 02 09 52 ca 4e 00 90 02 30 31 90 00 } //1
...
rule Trojan_Win32_Copak_RF_MTB_2{
	...
	strings :
		$a_03_0 = {96 87 a7 00 90 02 15 8a 89 a7 00 90 02 40 31 90 02 35 ac 89 a7 00 0f 8c 90 01 01 ff ff ff 90 00 } //5
