...
rule Trojan_Win32_Tibs_IZ{
	...
	strings :
		...
		$a_03_2 = {6a 06 6a 01 6a 02 e8 90 01 04 8b f8 83 ff ff 74 90 01 01 ff 75 08 e8 90 01 04 8b f0 85 f6 74 90 01 01 6a 19 66 c7 45 f0 02 00 e8 90 01 04 66 89 45 f2 8b 46 0c 8b 00 8b 00 89 45 f4 6a 10 8d 45 f0 50 57 e8 90 00 } //1
	condition:
