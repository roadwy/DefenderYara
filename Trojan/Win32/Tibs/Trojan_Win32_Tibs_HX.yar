...
rule Trojan_Win32_Tibs_HX_2{
	...
	strings :
		$a_03_0 = {ff 83 e8 03 29 c2 49 eb 90 01 01 89 d7 85 c9 74 02 29 c9 81 c1 90 90 4c 00 00 e8 90 01 01 ff ff ff 59 eb 90 01 01 e8 90 01 01 ff ff ff 90 09 08 00 90 02 02 c3 51 eb 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
