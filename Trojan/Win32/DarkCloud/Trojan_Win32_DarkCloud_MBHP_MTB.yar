...
rule Trojan_Win32_DarkCloud_MBHP_MTB{
	...
	strings :
		...
		$a_81_1 = {73 76 70 61 41 66 68 57 44 4f 5a 68 63 66 51 74 74 6a 41 55 72 65 4f 70 48 54 47 43 62 48 4d 68 77 57 44 51 75 77 67 65 51 50 46 } //01 00 
		$a_81_2 = {68 76 6b 4c 78 4b 62 43 74 56 49 68 73 53 78 59 75 42 74 52 70 46 65 6b 5a 72 46 47 6a 4b 5a 74 } //00 00 
	condition:
		any of ($a_*)
