...
rule Trojan_Win32_Chadivendo_STE{
	...
	strings :
		$a_03_0 = {50 6a 00 6a 00 6a 00 6a 00 6a 00 6a 00 6a 00 68 90 01 02 01 10 90 01 04 ff 15 90 01 01 e0 00 10 90 02 06 68 90 01 02 01 10 ff 15 90 01 01 e0 00 10 90 00 } //1
