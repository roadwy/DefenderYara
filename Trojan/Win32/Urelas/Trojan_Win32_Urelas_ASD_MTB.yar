...
rule Trojan_Win32_Urelas_ASD_MTB{
	...
	strings :
		$a_03_0 = {8b c2 c1 f8 05 8b 04 85 90 02 03 00 8b fa 83 e7 1f c1 e7 06 8b 04 07 83 f8 ff 74 08 3b c6 74 04 85 c0 75 02 89 31 83 c1 20 42 81 f9 38 22 42 00 7c 90 00 } //2
