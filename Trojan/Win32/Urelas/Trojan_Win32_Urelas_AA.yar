...
rule Trojan_Win32_Urelas_AA{
	...
	strings :
		...
		$a_00_4 = {67 00 6f 00 6c 00 66 00 69 00 6e 00 66 00 6f 00 2e 00 69 00 6e 00 69 00 } //01 00 
		$a_00_5 = {67 00 6f 00 6c 00 66 00 73 00 65 00 74 00 2e 00 69 00 6e 00 69 00 } //00 00 
	condition:
		any of ($a_*)
