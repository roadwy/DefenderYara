...
rule Trojan_Win32_Urelas_K{
	...
	strings :
		$a_01_0 = {67 00 6f 00 6c 00 66 00 69 00 6e 00 66 00 6f 00 2e 00 69 00 6e 00 69 00 } //0a 00 
		$a_01_1 = {5f 00 75 00 6e 00 69 00 6e 00 73 00 65 00 70 00 2e 00 62 00 61 00 74 00 } //0a 00 
		$a_01_2 = {73 00 79 00 73 00 74 00 65 00 6d 00 6b 00 65 00 79 00 } //01 00 
