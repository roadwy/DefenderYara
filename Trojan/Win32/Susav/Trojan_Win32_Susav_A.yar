...
rule Trojan_Win32_Susav_A{
	...
	strings :
		$a_01_0 = {45 6e 75 6d 57 69 6e 64 6f 77 73 } //01 00 
		$a_01_1 = {47 65 74 43 6c 61 73 73 4e 61 6d 65 41 } //01 00 
		$a_01_2 = {8b 85 c0 fe ff ff 3d 41 56 50 2e 75 02 } //01 00 
		$a_01_3 = {41 64 6a 75 73 74 54 6f 6b 65 6e 50 72 69 76 69 6c 65 67 65 73 } //01 00 
