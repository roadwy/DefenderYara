...
rule Trojan_Win32_Wazabre_A{
	...
	strings :
		...
		$a_03_1 = {66 c7 05 02 70 40 00 06 00 66 c7 05 06 70 40 00 11 00 66 c7 05 08 70 40 00 12 00 66 c7 05 0a 70 40 00 25 00 68 90 01 02 40 00 68 90 01 02 40 00 e8 90 01 02 00 00 90 00 } //1
	condition:
