...
rule Trojan_Win32_YYpass_A{
	...
	strings :
		...
		$a_00_1 = {6c 69 62 65 69 74 61 38 37 40 67 6d 61 69 6c 2e 63 6f 6d } //01 00  libeita87@gmail.com
		$a_01_2 = {b1 bb b5 c1 59 59 c3 dc c2 eb a3 ba 00 } //01 00 
		$a_00_3 = {64 75 6f 73 70 65 61 6b 2e 65 78 65 } //00 00  duospeak.exe
	condition:
		any of ($a_*)
