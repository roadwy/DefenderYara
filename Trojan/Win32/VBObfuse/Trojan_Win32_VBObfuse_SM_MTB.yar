...
rule Trojan_Win32_VBObfuse_SM_MTB{
	...
	strings :
		...
		$a_01_2 = {6e 00 49 00 78 00 76 00 74 00 71 00 49 00 6f 00 5a 00 4a 00 7a 00 4f 00 59 00 68 00 31 00 31 00 } //01 00 
		$a_01_3 = {55 00 73 00 6c 00 69 00 6e 00 67 00 65 00 67 00 65 00 72 00 6e 00 69 00 6e 00 67 00 65 00 6e 00 36 00 } //01 00 
		$a_01_4 = {4d 00 79 00 41 00 48 00 62 00 31 00 38 00 39 00 } //00 00 
	condition:
		any of ($a_*)
