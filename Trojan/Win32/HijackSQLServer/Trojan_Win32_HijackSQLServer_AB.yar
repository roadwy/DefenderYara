...
rule Trojan_Win32_HijackSQLServer_AB{
	...
	strings :
		...
		$a_00_5 = {63 00 68 00 6f 00 63 00 6f 00 6c 00 61 00 74 00 65 00 79 00 } //65486 chocolatey
	condition:
		((#a_00_0  & 1)*10+(#a_00_1  & 1)*10+(#a_00_2  & 1)*10+(#a_00_3  & 1)*5+(#a_00_4  & 1)*5+(#a_00_5  & 1)*65486) >=35
