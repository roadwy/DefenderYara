...
rule Trojan_Win32_MarsStealer_MB_MTB{
	...
	strings :
		$a_02_0 = {c1 f9 02 33 c1 0f b7 15 ?? ?? ?? 00 c1 fa 03 33 c2 0f b7 0d ?? ?? ?? 00 c1 f9 05 33 c1 83 e0 01 a3 ?? ?? ?? 00 } //5
		$a_02_1 = {33 d2 b9 24 00 00 00 f7 f1 8b 85 e4 fe ff ff 8a 8a ?? ?? ?? 00 88 8c 05 f8 fe ff ff } //5
	condition:
...
rule Trojan_Win32_MarsStealer_MB_MTB_2{
	...
	strings :
		$a_03_0 = {0f b6 08 8d 94 11 ?? ?? ?? ?? 8b 45 fc 03 45 e0 88 10 8b 4d fc 03 4d e0 0f b6 11 81 ea 8b 10 00 00 8b 45 fc 03 45 e0 88 10 c7 45 f0 01 00 00 00 8b 4d f8 83 c1 01 89 4d f8 e9 } //10
