...
rule Trojan_Win32_Veslorn_gen_D{
	...
	strings :
		$a_01_0 = {00 42 46 44 44 4f 53 2f 25 64 2d 25 64 00 } //01 00 
		$a_01_1 = {00 46 59 48 48 4f 53 3d 25 64 2b 25 64 28 4d 42 29 00 } //01 00 
		...
		$a_01_4 = {41 54 54 41 43 4b } //05 00 
		$a_01_5 = {00 52 45 54 55 52 4e 50 4f 57 45 52 } //00 00 
	condition:
		any of ($a_*)
