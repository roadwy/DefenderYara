...
rule Trojan_Win32_Ejik_gen_A{
	...
	strings :
		...
		$a_00_3 = {73 65 74 75 70 64 61 79 } //01 00 
		$a_00_4 = {65 2d 6a 6f 6b 2e 63 6e 2f 63 6e 66 67 } //01 00 
		$a_02_5 = {62 69 7a 36 37 38 2e 63 6e 2f 53 90 03 05 0a 4b 6c 69 73 74 65 61 72 63 68 49 6d 61 67 65 2e 74 78 74 90 00 } //01 00 
		$a_00_6 = {72 65 73 69 69 66 65 72 73 2e 69 6e 69 } //01 00 
		$a_00_7 = {77 69 6e 64 6f 77 6e 65 77 73 75 70 73 2e 69 6e 69 } //01 00 
		...
		$a_01_9 = {45 49 64 49 6e 76 61 6c 69 64 53 65 72 76 69 63 65 4e 61 6d 65 } //00 00 
	condition:
		any of ($a_*)
