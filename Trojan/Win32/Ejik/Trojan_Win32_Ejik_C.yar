...
rule Trojan_Win32_Ejik_C{
	...
	strings :
		...
		$a_02_2 = {45 58 45 46 49 4c 45 90 05 04 01 00 ff ff ff ff 15 00 00 00 73 65 74 75 70 6f 6c 5f 90 0f 04 00 5f 90 0f 04 00 2e 65 78 65 00 90 00 } //1
		$a_02_3 = {2e 63 6e 2f 64 61 74 61 5f 61 64 64 2e 61 73 70 78 3f 66 69 6c 65 6e 61 6d 65 3d 73 65 74 75 70 6f 6c 5f 90 0f 04 00 5f 90 0f 04 00 2e 65 78 65 00 90 00 } //1
	condition:
