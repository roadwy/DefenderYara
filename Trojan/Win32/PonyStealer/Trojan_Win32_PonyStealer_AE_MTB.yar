...
rule Trojan_Win32_PonyStealer_AE_MTB{
	...
	strings :
		$a_03_0 = {66 0f 6e c6 [0-25] 66 0f 6e c9 [0-40] 0f 7e c9 [0-25] 90 13 0f 77 [0-25] 46 [0-25] 8b 0f } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_Win32_PonyStealer_AE_MTB_2{
	...
	strings :
		$a_03_0 = {66 0f 6e c6 [0-15] 66 0f 6e c9 [0-15] 66 0f ef c8 [0-15] 66 0f 7e c9 [0-25] 90 13 0f 77 [0-15] [0-15] ff 37 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_Win32_PonyStealer_AE_MTB_3{
	...
	strings :
		$a_03_0 = {0f 6e d0 0f 6e d0 0f 6e d0 90 13 [0-15] 46 [0-15] 8b 0f [0-15] 0f 6e c6 [0-15] 0f 6e c9 [0-15] 0f ef c8 [0-15] 0f 7e c9 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_Win32_PonyStealer_AE_MTB_4{
	...
	strings :
		$a_03_0 = {0f 7e d2 85 [0-25] 90 13 [0-15] 46 [0-15] 8b 17 [0-15] 0f 6e fe [0-15] 90 18 0f 6e d2 [0-15] 0f ef d7 [0-15] c3 } //1
		$a_03_1 = {0f 7e d2 83 [0-25] 90 13 [0-15] 46 [0-15] 8b 17 [0-25] 90 18 0f 6e d2 [0-15] 0f ef d7 [0-15] c3 } //1
	condition:
...
rule Trojan_Win32_PonyStealer_AE_MTB_5{
	...
	strings :
		$a_03_0 = {0f 7e d2 66 [0-25] 90 13 [0-15] 46 [0-15] 8b 17 [0-15] 0f 6e fe [0-15] 90 18 0f 6e d2 [0-15] 0f ef d7 [0-15] c3 } //1
		$a_03_1 = {0f 7e d2 66 [0-25] 90 13 [0-15] 46 [0-15] 8b 17 [0-15] 0f 6e fe [0-15] 0f 6e d2 [0-15] 90 18 [0-15] 0f ef d7 [0-15] c3 } //1
	condition:
		((#a_03_0  & 1)*1+(#a_03_1  & 1)*1) >=1
...
rule Trojan_Win32_PonyStealer_AE_MTB_6{
	...
	strings :
		$a_03_0 = {0f 7e d2 85 [0-30] 90 13 [0-15] 46 [0-15] 8b 17 [0-25] 0f 6e fe [0-25] 0f 6e d2 [0-25] 90 18 [0-15] 0f ef d7 [0-25] c3 } //1
		$a_03_1 = {0f 7e d2 81 [0-30] 90 13 [0-15] 46 [0-15] 8b 17 [0-25] 0f 6e fe [0-25] 0f 6e d2 [0-25] 90 18 [0-15] 0f ef d7 [0-25] c3 } //1
		$a_03_2 = {0f 7e d2 83 [0-30] 90 13 [0-15] 46 [0-15] 8b 17 [0-25] 0f 6e fe [0-25] 0f 6e d2 [0-25] 90 18 [0-15] 0f ef d7 [0-25] c3 } //1
		$a_03_3 = {0f 7e d2 66 [0-30] 90 13 [0-15] 46 [0-15] 8b 17 [0-25] 0f 6e fe [0-25] 0f 6e d2 [0-25] 90 18 [0-15] 0f ef d7 [0-25] c3 } //1
		$a_03_4 = {0f 7e d2 3d [0-30] 90 13 [0-15] 46 [0-15] 8b 17 [0-25] 0f 6e fe [0-25] 0f 6e d2 [0-25] 90 18 [0-15] 0f ef d7 [0-25] c3 } //1
	condition:
...
rule Trojan_Win32_PonyStealer_AE_MTB_7{
	...
	strings :
		$a_03_0 = {0f 6e da 3d [0-40] 31 f1 } //6
		$a_03_1 = {0f 6e da 81 [0-40] 31 f1 } //6
		$a_03_2 = {0f 6e da 66 [0-40] 31 f1 } //6
		$a_03_3 = {0f 6e da 83 [0-40] 31 f1 } //6
		$a_03_4 = {0f 6e da 85 [0-40] 31 f1 } //6
		$a_03_5 = {0f 6e da eb [0-40] 31 f1 } //6
