...
rule Trojan_Win32_Picrosia_D{
	...
	strings :
		...
		$a_03_1 = {55 00 53 00 45 00 52 00 4e 00 41 00 4d 00 45 00 90 02 12 57 00 69 00 6e 00 64 00 6f 00 77 00 73 00 20 00 58 00 50 00 90 00 } //1
		$a_03_2 = {69 00 74 00 6d 00 90 04 01 03 31 32 33 00 90 02 06 65 00 78 00 65 90 00 } //1
		$a_03_3 = {69 00 74 00 6d 00 90 04 01 03 31 32 33 00 90 02 06 6d 00 70 00 34 90 00 } //1
	condition:
