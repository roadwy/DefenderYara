...
rule Trojan_Win32_Stuxnet_F{
	...
	strings :
		$a_00_0 = {73 37 6f 74 62 78 73 78 2e 64 6c 6c } //01 00  s7otbxsx.dll
		$a_00_1 = {73 37 5f 67 65 74 5f 70 61 73 73 77 6f 72 64 } //01 00  s7_get_password
		$a_00_2 = {73 37 48 5f 73 74 61 72 74 5f 63 70 75 } //01 00  s7H_start_cpu
