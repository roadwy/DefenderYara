...
rule Trojan_Win32_AveMaria_AA_MTB{
	...
	strings :
		$a_00_0 = {41 56 45 5f 4d 41 52 49 41 } //01 00  AVE_MARIA
		...
		$a_00_8 = {73 68 75 74 64 6f 77 6e 70 63 } //0a 00  shutdownpc
		$a_00_9 = {72 65 73 74 61 72 74 62 6f 74 } //0a 00  restartbot
		$a_00_10 = {64 6f 77 6e 6c 6f 61 64 66 69 6c 65 } //0a 00  downloadfile
		$a_00_11 = {67 65 74 73 63 72 65 65 6e } //0a 00  getscreen
		$a_00_12 = {73 74 61 72 74 61 73 61 64 6d 69 6e 65 78 65 } //00 00  startasadminexe
	condition:
		any of ($a_*)
