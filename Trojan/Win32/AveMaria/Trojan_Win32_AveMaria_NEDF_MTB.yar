...
rule Trojan_Win32_AveMaria_NEDF_MTB{
	...
	strings :
		...
		$a_01_1 = {2f 00 70 00 72 00 6f 00 67 00 49 00 44 00 4f 00 70 00 65 00 6e 00 } //02 00 
		$a_01_2 = {2f 00 65 00 78 00 65 00 63 00 } //02 00 
		$a_01_3 = {2f 00 72 00 65 00 61 00 6c 00 74 00 69 00 6d 00 65 00 } //00 00 
	condition:
		any of ($a_*)
