...
rule Trojan_Win32_AveMaria_MA_MTB{
	...
	strings :
		$a_03_0 = {6a 00 68 84 00 00 00 6a 02 6a 00 6a 01 68 00 00 00 10 68 58 37 40 00 ff 15 90 01 04 6a 00 8b f0 8d 85 e8 fb ff ff 50 ff 35 2c 33 40 00 ff 35 54 37 40 00 56 ff 15 90 00 } //1
