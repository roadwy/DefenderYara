...
rule Trojan_Win32_Brackash_gen_C{
	...
	strings :
		...
		$a_01_2 = {6d 65 6d 6f 72 79 } //01 00 
		$a_01_3 = {72 61 6e 64 6f 6d } //01 00 
		$a_01_4 = {62 62 6f 79 } //01 00 
		$a_01_5 = {62 65 61 75 74 79 } //01 00 
		$a_01_6 = {67 72 6f 75 70 } //01 00 
		$a_01_7 = {66 75 6e 63 69 6f 6e } //01 00 
		$a_01_8 = {62 6f 62 61 65 } //01 00 
		$a_01_9 = {68 61 74 65 } //00 00 
	condition:
		any of ($a_*)
