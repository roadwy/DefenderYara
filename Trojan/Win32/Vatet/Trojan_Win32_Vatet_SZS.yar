...
rule Trojan_Win32_Vatet_SZS{
	...
	strings :
		...
		$a_03_3 = {40 3b c3 72 90 09 04 00 80 ?? ?? fe } //10
		$a_03_4 = {5c 5c 31 30 2e [0-03] 2e [0-03] 2e [0-03] 5c } //1
		$a_03_5 = {5c 5c 31 37 32 2e [0-03] 2e [0-03] 2e [0-03] 5c } //1
		$a_03_6 = {5c 5c 31 39 32 2e 31 36 38 2e [0-03] 2e [0-03] 5c } //1
	condition:
