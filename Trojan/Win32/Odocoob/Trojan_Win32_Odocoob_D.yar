...
rule Trojan_Win32_Odocoob_D{
	...
	strings :
		...
		$a_02_1 = {7b 00 72 00 65 00 67 00 73 00 76 00 72 00 20 00 90 02 06 5c 00 5c 00 90 00 } //1
		$a_02_2 = {7b 00 72 00 65 00 67 00 73 00 76 00 72 00 20 00 90 02 06 68 00 74 00 74 00 70 00 90 00 } //1
	condition:
