...
rule Trojan_Win32_Datimorn_A{
	...
	strings :
		$a_01_0 = {53 54 41 52 54 20 20 2f 44 20 43 3a 20 2f 42 20 77 69 6e 33 32 2e 65 78 65 20 2d 75 20 68 74 74 70 3a 2f 2f } //01 00 
		...
		$a_00_2 = {43 3a 2f 4b 65 72 6e 65 6c 73 2f 64 72 69 76 65 72 73 2e 76 62 73 } //01 00 
