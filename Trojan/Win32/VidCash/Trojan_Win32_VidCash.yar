...
rule Trojan_Win32_VidCash_2{
	...
	strings :
		$a_02_0 = {64 3a 5c 77 6f 72 6b 5c 6d 79 70 72 6f 6a 65 63 74 73 5c 76 69 64 65 6f 63 61 63 68 5c 6c 6f 61 64 65 72 5c 5f 5f 63 6f 6e 66 5f [0-40] 2e 70 64 62 } //2
