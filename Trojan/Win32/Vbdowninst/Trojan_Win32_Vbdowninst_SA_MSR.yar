...
rule Trojan_Win32_Vbdowninst_SA_MSR{
	...
	strings :
		$a_01_0 = {3a 5c 50 72 6f 67 72 61 6d 44 61 74 61 5c 69 70 72 61 73 2e 76 62 73 } //01 00  :\ProgramData\ipras.vbs
		$a_01_1 = {69 70 6c 6f 67 67 65 72 2e 6f 72 67 2f } //01 00  iplogger.org/
