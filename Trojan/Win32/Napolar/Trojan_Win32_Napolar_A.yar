...
rule Trojan_Win32_Napolar_A{
	...
	strings :
		...
		$a_03_1 = {8b 10 81 fa 50 45 00 00 0f 85 ?? ?? ?? ?? 89 85 ?? ?? ff ff 8b 95 ?? ?? ff ff 8b 42 78 03 85 ?? ?? ff ff 89 85 ?? ?? ff ff 8b 50 18 4a } //1
	condition:
...
rule Trojan_Win32_Napolar_A_2{
	...
	strings :
		$a_03_0 = {8b 40 3c 99 03 04 24 13 54 24 04 83 c4 08 89 45 ?? 8b 45 [0-10] 2d 00 10 00 00 05 00 02 00 00 89 45 ?? 8b 45 ?? 8b 40 18 8b 55 ?? 2b 42 34 03 45 ?? 2d 00 10 00 00 05 00 02 00 00 89 45 ?? 6a 00 6a 01 6a 00 ff 55 } //10
		$a_00_1 = {05 75 4c 6f 63 6b 07 53 79 73 49 6e 69 74 06 53 79 73 74 65 6d 8d 40 00 00 00 00 00 } //10
		$a_03_2 = {8d 45 fc 50 6a 40 6a 06 68 a4 42 40 00 6a ff e8 ?? ?? ?? ?? 3c 01 75 36 b8 a4 42 40 00 c6 00 68 b8 ?? ?? 40 00 ba a4 42 40 00 42 89 02 b8 a4 42 40 00 83 c0 05 c6 00 c3 8d 45 fc 50 8b 45 fc 50 6a 06 68 a4 42 40 00 6a ff } //10
