...
rule Trojan_Win32_Vidar_PC_MTB{
	...
	strings :
		$a_03_0 = {8b 45 88 8d 0c 07 33 d2 8b c7 f7 f3 8b 85 90 01 04 56 8a 04 02 8b 55 84 32 04 0a 88 01 90 00 } //1
		$a_03_1 = {2b c1 89 45 90 01 01 8b 45 90 01 01 8d 0c 90 01 01 33 d2 8b c3 f7 75 90 01 01 8b 85 90 01 04 57 8a 04 02 8b 55 84 32 04 0a 88 01 90 00 } //1
	condition:
