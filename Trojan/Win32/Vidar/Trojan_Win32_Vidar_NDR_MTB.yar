...
rule Trojan_Win32_Vidar_NDR_MTB{
	...
	strings :
		$a_03_0 = {e8 f5 08 ff ff 0f b6 45 90 01 01 8b 4d f4 8a 55 90 01 01 84 54 01 1d 75 1e 83 7d 10 90 01 01 74 12 8b 4d f0 8b 89 90 01 04 0f b7 04 41 23 45 90 01 01 eb 02 33 c0 85 c0 74 03 33 c0 40 90 00 } //5
