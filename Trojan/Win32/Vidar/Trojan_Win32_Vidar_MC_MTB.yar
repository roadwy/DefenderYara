...
rule Trojan_Win32_Vidar_MC_MTB_2{
	...
	strings :
		...
		$a_03_3 = {b9 48 08 45 00 e8 90 01 04 8d 4d ff e8 90 01 04 89 45 f8 c6 45 dc 21 c6 45 dd 32 c6 45 de 26 c6 45 df 6f c6 45 e0 54 90 00 } //1
...
rule Trojan_Win32_Vidar_MC_MTB_3{
	...
	strings :
		...
		$a_03_2 = {47 65 63 6b 6f 20 2f 20 90 02 25 20 46 69 72 65 66 6f 78 90 00 } //1
