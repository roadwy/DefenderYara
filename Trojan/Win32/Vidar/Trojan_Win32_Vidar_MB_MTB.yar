...
rule Trojan_Win32_Vidar_MB_MTB_3{
	...
	strings :
		...
		$a_01_1 = {73 64 66 6b 6a 6e 73 64 66 6b 6a 6c 6e 6b 20 6a 68 73 64 62 66 6a 73 68 64 } //14 00  sdfkjnsdfkjlnk jhsdbfjshd
		...
		$a_01_3 = {73 6b 6a 64 33 38 37 32 36 32 38 37 33 34 36 77 75 79 67 32 33 37 36 34 74 32 67 66 37 36 66 67 79 74 72 } //00 00  skjd38726287346wuyg23764t2gf76fgytr
	condition:
		any of ($a_*)
