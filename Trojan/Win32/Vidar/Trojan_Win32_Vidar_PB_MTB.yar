...
rule Trojan_Win32_Vidar_PB_MTB_2{
	...
	strings :
		...
		$a_02_7 = {27 48 23 6f 72 [0-0a] 73 65 48 6f [0-0a] 75 72 73 27 27 [0-0a] 29 [0-0a] 7c [0-0a] 69 [0-0a] 65 [0-0a] 78 27 2e 72 65 70 6c 61 63 65 28 27 ?? 27 2c 27 27 29 2e 73 70 6c 69 74 28 27 40 27 2c 35 29 3b } //1
	condition:
