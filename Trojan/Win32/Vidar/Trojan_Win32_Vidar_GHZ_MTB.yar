...
rule Trojan_Win32_Vidar_GHZ_MTB{
	...
	strings :
		$a_03_0 = {b8 8a a5 08 00 c7 45 ?? 8d 00 00 00 c7 45 ?? f0 d0 05 00 c7 45 ?? 01 14 00 00 c7 45 ?? 79 00 00 00 c7 45 ?? 15 00 00 00 b8 ?? ?? ?? ?? 89 45 c0 6a 40 68 00 10 00 00 8b 45 f8 8b 10 ff 12 } //10
