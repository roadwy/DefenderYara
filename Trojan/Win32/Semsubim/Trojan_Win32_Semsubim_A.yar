...
rule Trojan_Win32_Semsubim_A{
	...
	strings :
		...
		$a_03_1 = {c6 44 24 08 b8 50 6a 40 6a 08 56 c6 44 24 19 01 c6 44 24 1d c2 c6 44 24 1e 04 ff 15 ?? ?? ?? ?? 8b 4c 24 08 8b 54 24 0c 89 0e 89 56 04 } //1
		$a_03_2 = {c1 fe 02 ff 15 ?? ?? ?? ?? 33 d2 8b 4c 24 ?? f7 f6 8b 14 91 52 8b 54 24 ?? ?? 68 02 05 00 00 8b 42 20 50 ff d7 } //1
	condition:
