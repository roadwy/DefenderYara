...
rule Trojan_Win32_Noratops_A_dha{
	...
	strings :
		$a_03_0 = {83 fa 40 7c 90 01 01 a8 03 0f 85 90 01 04 8b d0 c1 ea 02 6a 3d 6b d2 03 90 00 } //1
		...
		$a_03_3 = {6a 02 53 56 e8 90 01 04 56 e8 90 01 04 bf 6c 0e 00 00 83 c4 10 3b c7 75 90 00 } //1
	condition:
