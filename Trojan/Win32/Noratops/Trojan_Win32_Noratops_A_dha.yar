...
rule Trojan_Win32_Noratops_A_dha{
	...
	strings :
		...
		$a_01_1 = {7e 00 24 00 63 00 6f 00 6d 00 2e 00 66 00 69 00 72 00 65 00 66 00 6f 00 78 00 2e 00 64 00 65 00 62 00 75 00 67 00 2e 00 74 00 6d 00 70 00 } //01 00  ~$com.firefox.debug.tmp
		$a_00_2 = {49 6e 6a 65 63 74 6f 72 2e 64 6c 6c } //01 00  Injector.dll
