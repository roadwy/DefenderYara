...
rule Trojan_Win32_RisePro_RP_MTB{
	...
	strings :
		$a_01_0 = {53 6f 66 74 77 61 72 65 5c 57 69 6e 4c 69 63 65 6e 73 65 } //1 Software\WinLicense
		$a_01_1 = {53 74 65 61 6c 65 72 43 6c 69 65 6e 74 } //1 StealerClient
	condition:
...
rule Trojan_Win32_RisePro_RP_MTB_2{
	...
	strings :
		$a_01_0 = {53 6f 66 74 77 61 72 65 5c 57 69 6e 4c 69 63 65 6e 73 65 } //1 Software\WinLicense
		$a_01_1 = {5c 5c 2e 5c 53 49 57 56 49 44 } //1 \\.\SIWVID
		$a_01_2 = {6f 72 65 61 6e 73 33 32 2e 73 79 73 } //1 oreans32.sys
		$a_01_3 = {6f 72 65 61 6e 73 78 36 34 2e 73 79 73 } //1 oreansx64.sys
		$a_01_4 = {48 41 52 44 57 41 52 45 5c 41 43 50 49 5c 44 53 44 54 5c 56 42 4f 58 5f 5f } //1 HARDWARE\ACPI\DSDT\VBOX__
		$a_01_5 = {68 00 65 00 69 00 64 00 69 00 73 00 71 00 6c 00 2e 00 65 00 78 00 65 00 } //1 heidisql.exe
		$a_01_6 = {41 00 6e 00 73 00 67 00 61 00 72 00 20 00 42 00 65 00 63 00 6b 00 65 00 72 00 2c 00 20 00 73 00 65 00 65 00 20 00 67 00 70 00 6c 00 2e 00 74 00 78 00 74 00 } //1 Ansgar Becker, see gpl.txt
	condition:
...
rule Trojan_Win32_RisePro_RP_MTB_4{
	...
	strings :
		$a_01_0 = {57 4c 4e 75 6d 44 4c 4c 73 50 72 6f 74 } //1 WLNumDLLsProt
		$a_01_1 = {5c 5c 2e 5c 47 6c 6f 62 61 6c 5c 6f 72 65 61 6e 73 78 36 34 } //1 \\.\Global\oreansx64
		$a_01_2 = {58 70 72 6f 74 45 76 65 6e 74 } //1 XprotEvent
		$a_01_3 = {53 6f 66 74 77 61 72 65 5c 57 69 6e 4c 69 63 65 6e 73 65 } //1 Software\WinLicense
		$a_01_4 = {52 65 73 74 61 72 74 41 70 70 2e 65 78 65 } //1 RestartApp.exe
...
rule Trojan_Win32_RisePro_RP_MTB_5{
	meta:
		description = "Trojan:Win32/RisePro.RP!MTB,SIGNATURE_TYPE_PEHSTR_EXT,42 00 42 00 0c 00 00 "
		
	strings :
		$a_01_0 = {57 4c 4e 75 6d 44 4c 4c 73 50 72 6f 74 } //5 WLNumDLLsProt
		$a_01_1 = {5c 5c 2e 5c 47 6c 6f 62 61 6c 5c 6f 72 65 61 6e 73 78 36 34 } //5 \\.\Global\oreansx64
		$a_01_2 = {58 70 72 6f 74 45 76 65 6e 74 } //5 XprotEvent
		$a_01_3 = {53 6f 66 74 77 61 72 65 5c 57 69 6e 4c 69 63 65 6e 73 65 } //5 Software\WinLicense
		...
		$a_01_11 = {66 00 69 00 6c 00 65 00 7a 00 69 00 6c 00 6c 00 61 00 2e 00 65 00 78 00 65 00 } //1 filezilla.exe
	condition:
		((#a_01_0  & 1)*5+(#a_01_1  & 1)*5+(#a_01_2  & 1)*5+(#a_01_3  & 1)*5+(#a_01_4  & 1)*10+(#a_01_5  & 1)*10+(#a_01_6  & 1)*50+(#a_03_7  & 1)*1+(#a_01_8  & 1)*1+(#a_01_9  & 1)*1+(#a_01_10  & 1)*1+(#a_01_11  & 1)*1) >=66
