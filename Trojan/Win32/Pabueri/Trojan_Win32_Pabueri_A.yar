...
rule Trojan_Win32_Pabueri_A{
	...
	strings :
		$a_03_0 = {2b c2 8b 4d e0 03 4d 90 01 01 88 01 8b 55 e0 03 55 90 01 01 0f b6 02 8b 4d 90 01 01 0f be 54 0d c0 90 03 00 03 90 01 04 33 c2 8b 4d e0 03 4d 90 01 01 88 01 eb 90 00 } //1
