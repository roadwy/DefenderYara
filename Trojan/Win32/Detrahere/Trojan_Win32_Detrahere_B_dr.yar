...
rule Trojan_Win32_Detrahere_B_dr{
	...
	strings :
		...
		$a_03_2 = {33 d2 85 f6 90 01 02 83 c0 03 90 01 02 83 c0 40 f7 f3 8a 44 15 b8 88 01 90 00 } //10
		$a_00_3 = {85 db 74 05 83 c0 fd eb 03 83 c0 46 99 } //10
		$a_03_4 = {31 6e 59 6f c7 90 01 02 70 35 73 64 c7 90 01 02 4e 43 76 36 c7 90 01 02 47 74 72 4c 90 00 } //10
		$a_03_5 = {44 72 76 50 90 02 03 c7 90 02 07 72 6f 74 65 90 02 03 c7 90 02 07 63 74 00 00 90 00 } //10
		$a_03_6 = {2e 00 5c 00 c7 90 01 02 44 00 72 00 c7 90 01 02 76 00 50 00 c7 90 01 02 72 00 6f 00 c7 90 01 02 74 00 65 00 c7 90 01 02 63 00 74 00 90 00 } //10
		...
		$a_03_12 = {72 00 71 00 c7 90 02 03 32 00 63 00 c7 90 02 03 43 00 79 00 c7 90 02 03 38 00 66 00 90 00 } //10
		$a_03_13 = {6d 00 4e 00 c7 90 02 03 79 00 52 00 c7 90 02 03 70 00 36 00 c7 90 02 03 6b 00 59 00 c7 90 02 03 48 00 35 00 90 00 } //10
		$a_03_14 = {78 35 31 00 65 00 c7 90 02 03 63 00 54 00 c7 90 02 03 6d 00 7a 00 c7 90 02 03 67 00 63 90 00 } //10
		$a_03_15 = {69 6e 73 74 c7 90 02 03 61 00 00 00 90 00 } //10
		$a_03_16 = {18 49 67 6f 76 c7 90 02 06 1c 54 00 00 00 8d 51 01 90 00 } //10
		$a_03_17 = {6d 38 36 67 c7 90 01 02 38 79 45 72 c7 90 01 02 2e 70 79 79 90 00 } //10
		$a_03_18 = {43 38 76 37 c7 90 01 02 38 36 6f 49 c7 90 01 02 31 67 74 41 66 90 01 02 dc 44 00 90 00 } //10
		$a_03_19 = {43 38 76 35 c7 90 01 02 54 76 49 64 c7 90 01 02 38 58 62 6f c7 90 01 02 76 38 6c 4a c7 90 01 02 67 51 31 00 90 00 } //10
		$a_03_20 = {52 00 6a 00 c7 90 01 02 79 00 55 00 c7 90 01 02 35 00 46 00 c7 90 01 02 64 00 79 90 00 } //10
