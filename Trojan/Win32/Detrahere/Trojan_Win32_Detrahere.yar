...
rule Trojan_Win32_Detrahere{
	...
	strings :
		$a_03_0 = {7b 00 41 00 c7 84 24 90 01 04 42 00 45 00 c7 84 24 90 01 04 34 00 37 00 c7 84 24 90 01 04 42 00 37 00 c7 84 24 90 01 04 32 00 2d 00 c7 84 24 90 01 04 30 00 43 00 c7 84 24 90 01 04 32 00 46 00 c7 84 24 90 01 04 2d 00 34 00 c7 84 24 90 01 04 32 00 31 00 c7 84 24 90 01 04 46 00 2d 00 90 00 } //1
