...
rule Trojan_Win32_Bocinex_gen_B{
	...
	strings :
		...
		$a_00_2 = {5c 43 75 72 72 65 6e 74 56 65 72 73 69 6f 6e 5c 50 6f 6c 69 63 69 65 73 5c 45 78 70 6c 6f 72 65 72 5c 72 75 6e } //05 00 
		$a_01_3 = {2e 65 78 65 20 2d 67 20 79 65 73 20 2d 6f 20 68 74 74 70 3a 2f 2f } //00 00 
	condition:
		any of ($a_*)
