...
rule Trojan_Win32_Mewpet_gen_A{
	...
	strings :
		...
		$a_01_2 = {3f 00 63 00 70 00 75 00 3d 00 25 00 35 00 2e 00 32 00 66 00 26 00 6d 00 65 00 6d 00 3d 00 25 00 35 00 2e 00 32 00 66 00 26 00 70 00 3d 00 25 00 64 00 } //00 00 
	condition:
		any of ($a_*)
