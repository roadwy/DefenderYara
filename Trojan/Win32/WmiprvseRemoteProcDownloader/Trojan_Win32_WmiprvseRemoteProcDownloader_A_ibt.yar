...
rule Trojan_Win32_WmiprvseRemoteProcDownloader_A_ibt{
	...
	strings :
		...
		$a_02_2 = {64 00 6f 00 77 00 6e 00 6c 00 6f 00 61 00 64 00 73 00 74 00 72 00 69 00 6e 00 67 00 28 00 27 00 68 00 74 00 74 00 70 00 3a 00 2f 00 2f 00 77 00 6d 00 69 00 [0-35] 2f 00 70 00 6f 00 77 00 65 00 72 00 } //1
	condition:
