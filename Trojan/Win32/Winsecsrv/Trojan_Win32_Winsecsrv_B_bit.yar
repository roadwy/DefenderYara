...
rule Trojan_Win32_Winsecsrv_B_bit{
	...
	strings :
		$a_01_0 = {32 39 46 48 6b 65 68 4c 46 49 48 6b 64 6f 77 28 39 33 70 5b 6c 4b 46 48 4f 65 73 72 6c 77 65 68 6a 72 32 33 } //01 00  29FHkehLFIHkdow(93p[lKFHOesrlwehjr23
