...
rule Trojan_Win32_Gleishug_A{
	...
	strings :
		$a_03_0 = {2e 63 6f 6d 2f 3f 73 69 64 3d 90 02 12 26 73 3d 7b 73 65 61 72 63 68 54 65 72 6d 73 7d 90 00 } //3
		$a_03_1 = {2e 6e 65 74 2f 3f 73 69 64 3d 90 02 12 26 73 3d 7b 73 65 61 72 63 68 54 65 72 6d 73 7d 90 00 } //3
