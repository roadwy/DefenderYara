...
rule Trojan_Win32_Sopinar_B{
	...
	strings :
		...
		$a_01_1 = {7b 38 36 31 65 34 64 38 61 2d 31 36 38 62 2d 34 62 39 30 2d 61 30 34 66 2d 33 34 66 37 32 65 65 37 30 31 65 30 7d } //00 00  {861e4d8a-168b-4b90-a04f-34f72ee701e0}
	condition:
		any of ($a_*)
