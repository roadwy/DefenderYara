...
rule Trojan_Win32_NetLoader_RPJ_MTB{
	...
	strings :
		...
		$a_01_2 = {41 70 70 44 61 74 61 5c 4c 6f 63 61 6c 5c 54 65 6d 70 5c 4a 6f 70 61 2e 65 78 65 } //01 00 
		$a_01_3 = {63 64 6e 2d 31 31 31 2e 61 6e 6f 6e 66 69 6c 65 73 2e 63 6f 6d } //01 00 
		$a_01_4 = {58 79 69 5f 31 2e 65 78 65 } //00 00 
	condition:
		any of ($a_*)
