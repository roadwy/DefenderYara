...
rule Trojan_Win32_Wuprad_A{
	...
	strings :
		...
		$a_01_6 = {83 f8 02 74 44 8b 04 24 8d 4c 24 04 51 8d 54 24 0c 52 6a 00 6a 00 } //01 00 
		$a_03_7 = {75 34 6a 00 8d 45 fc 50 68 90 09 0a 00 74 05 83 e8 04 8b 00 83 f8 20 90 00 } //01 00 
		$a_03_8 = {ff d6 3d fd 2e 00 00 0f 84 90 01 04 ff d6 3d e7 2e 00 00 0f 84 90 01 04 6a 31 90 00 } //00 00 
	condition:
		any of ($a_*)
