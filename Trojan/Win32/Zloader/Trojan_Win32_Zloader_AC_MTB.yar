...
rule Trojan_Win32_Zloader_AC_MTB{
	...
	strings :
		...
		$a_81_3 = {3a 5c 57 69 6e 64 6f 77 73 5c 69 65 78 70 6c 6f 72 65 2e 65 78 65 } //01 00  :\Windows\iexplore.exe
		$a_81_4 = {5c 51 75 69 65 74 5c 46 75 6e 5c 49 6e 73 65 63 74 5c 43 61 72 72 79 2e 70 64 62 } //00 00  \Quiet\Fun\Insect\Carry.pdb
	condition:
		any of ($a_*)
