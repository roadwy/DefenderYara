...
rule Trojan_Win32_Zloader_AF_MTB{
	...
	strings :
		...
		$a_03_2 = {5c 68 69 6c 6c 5c 44 61 6e 63 65 5c 90 02 04 5c 63 6f 6d 70 61 6e 79 5c 42 65 61 75 74 79 5c 6b 65 65 70 5c 53 63 61 6c 65 5c 90 02 04 5c 45 78 70 65 72 69 65 6e 63 65 2e 70 64 62 90 00 } //1
	condition:
