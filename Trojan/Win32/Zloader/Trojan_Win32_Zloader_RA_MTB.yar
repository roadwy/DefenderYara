...
rule Trojan_Win32_Zloader_RA_MTB{
	...
	strings :
		$a_01_0 = {63 3a 5c 63 6c 65 61 6e 5c 74 68 65 72 65 5c 63 6c 6f 74 68 65 5c 77 69 6e 74 65 72 5c 46 72 61 63 74 69 6f 6e 5c 72 61 63 65 5c 43 61 72 64 5c 57 6f 72 6c 64 63 6c 6f 75 64 2e 70 64 62 } //01 00 
		$a_01_1 = {6d 61 69 6e 2e 64 6c 6c } //01 00 
		$a_01_2 = {44 72 79 73 74 72 61 6e 67 65 31 } //01 00 
		$a_01_3 = {4c 69 67 68 74 73 68 65 65 74 40 31 32 } //01 00 
