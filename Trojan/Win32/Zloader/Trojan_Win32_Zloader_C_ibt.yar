...
rule Trojan_Win32_Zloader_C_ibt_2{
	...
	strings :
		$a_01_0 = {70 61 74 68 2e 64 6c 6c 00 44 6c 6c 52 65 67 69 73 74 65 72 53 65 72 76 65 72 00 57 61 6c 6b 6b 6e 65 77 00 } //01 00 
		$a_01_1 = {53 61 6d 65 41 66 72 61 69 64 5c 61 6e 69 6d 61 6c 53 74 6f 6e 65 5c 6f 75 72 57 69 66 65 5c 4c 69 71 75 69 64 4a 75 73 74 5c 70 61 74 68 2e 70 64 62 } //01 00 
		$a_01_2 = {49 6e 74 65 72 6e 65 74 52 65 61 64 46 69 6c 65 } //01 00 
		$a_01_3 = {49 6e 74 65 72 6e 65 74 57 72 69 74 65 46 69 6c 65 } //01 00 
		$a_01_4 = {48 74 74 70 53 65 6e 64 52 65 71 75 65 73 74 45 78 57 } //00 00 
	condition:
		any of ($a_*)
