...
rule Trojan_Win32_Zloader_DHB_MTB{
	...
	strings :
		$a_02_0 = {0f b6 07 89 4d f0 89 c3 f6 d3 80 e3 90 01 01 6a 00 6a 00 6a 90 01 01 50 e8 90 01 04 8b 4d f0 83 c4 10 08 d8 30 c8 c1 c1 90 01 01 34 90 01 01 88 07 47 4e 75 90 00 } //1
