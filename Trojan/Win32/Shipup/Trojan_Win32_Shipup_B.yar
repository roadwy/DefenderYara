...
rule Trojan_Win32_Shipup_B{
	...
	strings :
		$a_00_0 = {8b 44 24 04 8a 08 84 c9 74 08 80 c1 03 88 08 40 eb f2 c3 8b 44 24 04 8a 08 84 c9 74 07 fe c1 88 08 40 eb f3 c3 } //10
		$a_01_1 = {4d 69 63 72 6f 73 6f 66 74 46 6c 61 73 68 } //5 MicrosoftFlash
		$a_00_2 = {5c 6c 64 2e 65 78 65 } //1 \ld.exe
