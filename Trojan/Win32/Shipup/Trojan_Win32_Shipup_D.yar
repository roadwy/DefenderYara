...
rule Trojan_Win32_Shipup_D{
	...
	strings :
		...
		$a_03_1 = {3b c3 75 27 8a 85 78 ff ff ff 3a c3 74 12 fe c8 88 86 90 01 02 40 00 8a 84 35 79 ff ff ff 46 eb ea 39 5d 08 88 9e 90 01 02 40 00 74 77 57 8d 85 78 fd ff ff 68 00 02 00 00 90 00 } //5
