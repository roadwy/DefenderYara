...
rule Trojan_Win32_ShipUp_GNW_MTB{
	...
	strings :
		$a_03_0 = {8b 07 d2 ed 66 81 fc ee 14 0b d4 8b 57 04 66 0f be c8 c1 f1 f5 8d bf 90 01 04 66 f7 d1 d3 e1 36 89 10 80 ed 1f 8d b6 90 01 04 0b cb 8b 0e 33 cb c1 c1 03 e9 90 00 } //10
