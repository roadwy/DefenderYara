...
rule Trojan_Win32_Tarifarch_O{
	...
	strings :
		...
		$a_01_1 = {62 00 69 00 6c 00 6c 00 2f 00 72 00 75 00 6c 00 } //01 00  bill/rul
		$a_01_2 = {3a 00 2f 00 2f 00 68 00 65 00 6c 00 70 00 70 00 72 00 69 00 63 00 65 00 2e 00 69 00 } //00 00  ://helpprice.i
	condition:
		any of ($a_*)
