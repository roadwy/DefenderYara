...
rule Trojan_Win32_Tarifarch_X{
	...
	strings :
		...
		$a_03_2 = {15 62 74 6e 53 75 62 73 63 72 69 70 74 69 6f 6e 73 43 6c 69 63 6b 17 00 90 01 04 10 6f 6e 4b 63 61 70 74 63 68 61 52 65 6c 6f 61 64 1b 00 90 00 } //1
	condition:
