...
rule Trojan_Win32_GandCrypt_DSC_MTB{
	...
	strings :
		...
		$a_81_1 = {44 65 20 62 65 6d 6f 6a 65 79 75 7a 65 20 62 61 7a 6f 62 75 70 75 79 6f 62 75 6d 65 74 65 6c 61 77 65 66 69 62 75 20 64 69 77 75 7a 61 20 68 69 62 65 6c 69 67 61 63 61 6b 75 6a 61 6b 61 63 6f } //00 00 
	condition:
		any of ($a_*)
