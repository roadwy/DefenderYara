...
rule Trojan_Win32_GandCrypt_DSK_MTB{
	...
	strings :
		$a_02_0 = {8b 4c 24 70 8b 54 24 30 89 35 90 01 04 89 35 90 01 04 8b f7 c1 ee 05 03 74 24 78 03 d9 03 d7 33 da 81 3d 90 01 04 72 07 00 00 75 90 00 } //2
		$a_02_1 = {0f b6 c8 56 89 0d 90 01 04 0f b6 81 90 01 04 03 05 90 01 04 0f b6 f0 89 35 90 01 04 81 f9 66 0d 00 00 73 90 00 } //2
