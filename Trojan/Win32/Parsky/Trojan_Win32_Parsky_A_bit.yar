...
rule Trojan_Win32_Parsky_A_bit{
	...
	strings :
		$a_01_0 = {5c 6b 61 73 70 65 72 5c 52 65 6c 65 61 73 65 5c 6b 61 73 70 65 72 2e 70 64 62 } //01 00  \kasper\Release\kasper.pdb
		$a_01_1 = {00 72 6f 6f 74 69 6e 66 6f 23 23 00 } //01 00  爀潯楴普⍯#
