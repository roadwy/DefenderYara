...
rule Trojan_Win32_Ellikic_A{
	...
	strings :
		...
		$a_01_1 = {3c 69 66 72 61 6d 65 20 73 72 63 3d 22 25 73 22 20 77 69 64 74 68 3d 30 20 68 65 69 67 68 74 3d 30 3e 3c 2f 69 66 72 61 6d 65 3e } //01 00 
		$a_01_2 = {69 65 68 65 6c 70 65 72 2e 64 6c 6c 00 44 6c 6c } //00 00 
	condition:
		any of ($a_*)
