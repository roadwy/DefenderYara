...
rule Trojan_Win32_Lethic_B{
	...
	strings :
		...
		$a_03_2 = {8b 4d 08 89 41 38 68 90 01 04 8b 55 90 01 01 52 ff 15 90 00 } //1
		$a_03_3 = {8d 8c 01 f8 00 00 00 89 4d f8 68 90 01 04 8b 55 f8 52 e8 90 01 04 85 c0 74 0b 90 00 } //1
	condition:
