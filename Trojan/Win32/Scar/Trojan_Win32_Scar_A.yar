...
rule Trojan_Win32_Scar_A{
	...
	strings :
		...
		$a_02_8 = {db e2 9b 0f 01 e0 a8 08 75 f9 0f 01 e0 a8 02 74 f9 68 90 01 02 40 00 e8 90 01 02 00 00 6b c0 02 8b c8 a0 90 01 02 40 00 8d 3d 90 01 02 40 00 80 3f 00 74 02 30 07 90 00 } //10
	condition:
