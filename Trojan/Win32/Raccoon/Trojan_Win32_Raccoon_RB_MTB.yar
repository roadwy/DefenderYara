...
rule Trojan_Win32_Raccoon_RB_MTB_3{
	...
	strings :
		...
		$a_03_1 = {8b c6 c1 e0 04 03 45 ?? 33 45 ?? 33 45 } //1
	condition:
...
rule Trojan_Win32_Raccoon_RB_MTB_4{
	...
	strings :
		$a_03_0 = {8b c8 c1 e1 04 03 4c 24 ?? 89 4c 24 ?? 8d 0c 07 c1 e8 05 89 44 24 ?? 8b 44 24 ?? 01 44 24 ?? 8b 44 24 ?? 33 c1 33 44 24 [0-12] 2b f0 89 44 24 ?? 8b c6 c1 e0 04 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_Win32_Raccoon_RB_MTB_5{
	...
	strings :
		$a_03_0 = {55 8b ec 51 83 65 fc 00 8b 45 10 01 45 fc 8b 45 0c 33 45 fc 89 45 fc 8b 45 08 8b 4d fc 89 08 c9 c2 0c 00 [0-25] 55 8b ec 51 c7 45 fc 02 00 00 00 83 45 fc 02 8b 4d fc 8b 45 0c d3 e0 8b 4d 08 89 01 c9 c2 08 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
