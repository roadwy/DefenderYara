...
rule Trojan_Win32_Tinba_PDSK_MTB{
	...
	strings :
		$a_02_0 = {30 04 39 47 3b fb 7c 90 09 0b 00 e8 ?? ?? ?? ?? 8b 8d ?? ?? ff ff } //1
		$a_02_1 = {69 c0 fd 43 03 00 a3 ?? ?? ?? ?? 81 05 ?? ?? ?? ?? c3 9e 26 00 81 3d ?? ?? ?? ?? a5 02 00 00 8b 35 ?? ?? ?? ?? 75 90 09 05 00 a1 } //1
		$a_02_2 = {0f af df 03 c8 89 8d ?? ?? ff ff 8a 09 03 de 32 cb 88 8c 35 ?? ?? ff ff 90 09 0c 00 8b 8d ?? ?? ff ff 89 9d ?? ?? ff ff } //2
