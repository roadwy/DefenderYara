...
rule Trojan_Win32_Bedefco_A{
	...
	strings :
		...
		$a_02_5 = {57 69 6e 64 6f 77 73 20 44 72 69 76 65 72 20 53 65 72 76 69 63 65 00 90 02 1e 00 5c 77 69 6e 69 6e 69 74 2e 65 78 65 00 90 02 0f 20 2d 73 65 72 76 69 63 65 00 90 02 3c 5c 73 79 73 74 65 6d 33 32 5c 78 62 6f 78 2d 73 65 72 76 69 63 65 2e 65 78 65 00 90 00 } //3
	condition:
