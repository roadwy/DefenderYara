...
rule Trojan_Win32_Zonsterarch_A{
	...
	strings :
		$a_02_0 = {2d 44 5a 00 01 0f 84 90 01 02 00 00 2d 00 00 00 0b 0f 85 90 01 02 00 00 83 90 01 01 08 71 90 00 } //2
		$a_02_1 = {3c 73 74 72 20 69 64 3d 22 90 01 02 22 3e 59 6f 75 20 6e 65 65 64 20 74 6f 20 73 65 6e 64 20 25 64 20 53 4d 53 90 00 } //1
