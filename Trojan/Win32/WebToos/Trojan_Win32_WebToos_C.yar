...
rule Trojan_Win32_WebToos_C{
	...
	strings :
		...
		$a_03_4 = {c6 44 24 3c 05 6a 0c 68 90 01 04 8d 4c 24 20 89 6c 24 38 89 5c 24 34 88 5c 24 24 e8 90 01 04 8d 44 24 18 50 c6 44 24 40 06 e8 90 01 04 c6 44 24 3c 05 83 7c 24 30 10 72 0d 8b 4c 24 1c 51 e8 90 01 04 83 c4 04 6a 0b 68 90 00 } //5
	condition:
