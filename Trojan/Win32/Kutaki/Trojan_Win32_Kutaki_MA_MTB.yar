...
rule Trojan_Win32_Kutaki_MA_MTB{
	...
	strings :
		...
		$a_01_1 = {53 00 48 00 41 00 44 00 4f 00 } //01 00  SHADO
		$a_01_2 = {6d 75 66 75 63 6b 72 } //01 00  mufuckr
		$a_01_3 = {5b 00 20 00 41 00 4c 00 54 00 44 00 4f 00 57 00 4e 00 20 00 5d 00 } //01 00  [ ALTDOWN ]
		$a_01_4 = {74 00 61 00 73 00 6b 00 6b 00 69 00 6c 00 6c 00 20 00 2f 00 69 00 6d 00 } //00 00  taskkill /im
	condition:
		any of ($a_*)
