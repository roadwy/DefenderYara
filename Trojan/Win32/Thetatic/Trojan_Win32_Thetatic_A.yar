...
rule Trojan_Win32_Thetatic_A{
	...
	strings :
		...
		$a_01_2 = {63 73 74 79 70 65 3d 73 65 72 76 65 72 } //01 00  cstype=server
		$a_01_3 = {63 6f 6d 6d 61 6e 64 3d 72 65 73 75 6c 74 } //01 00  command=result
		$a_01_4 = {76 61 6c 73 5b 69 5d 5e 6b 65 79 63 6f 64 65 } //00 00  vals[i]^keycode
	condition:
		any of ($a_*)
