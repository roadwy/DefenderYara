...
rule Trojan_Win32_Exchrom_B{
	...
	strings :
		...
		$a_01_2 = {68 74 74 70 3a 2f 2f 25 73 2f 63 70 70 2f 73 74 61 74 65 } //02 00  http://%s/cpp/state
		$a_01_3 = {68 74 74 70 3a 2f 2f 25 73 2f 63 70 70 2f 61 70 70 2e 63 72 78 } //01 00  http://%s/cpp/app.crx
		$a_01_4 = {66 69 6c 6d 70 69 6b 61 2e 63 6f 6d } //01 00  filmpika.com
		$a_01_5 = {6b 65 74 61 6e 74 2e 6e 65 74 } //01 00  ketant.net
		$a_01_6 = {62 61 6b 73 74 6f 72 61 6e 2e 63 6f 6d } //00 00  bakstoran.com
