...
rule Trojan_Win32_Shelm_RB_MTB{
	...
	strings :
		$a_03_0 = {53 53 6a 03 53 66 ab 6a 03 53 68 90 01 03 00 c7 45 ec 90 01 03 00 aa c7 45 f0 90 01 03 00 c7 45 f4 90 01 03 00 c7 45 f8 90 01 03 00 ff 15 90 00 } //5
