...
rule Trojan_Win32_BHO_KC{
	...
	strings :
		...
		$a_01_1 = {2e 37 37 30 33 30 34 31 32 33 2e 63 6e } //01 00  .770304123.cn
		$a_01_2 = {6a 76 76 72 38 2d 2d 3a 3a 3a 2c 3a 36 31 61 63 6e 6e 2c 61 6c 2d 63 66 72 63 61 69 2c 76 7a 76 } //01 00  jvvr8--:::,:61acnn,al-cfrcai,vzv
