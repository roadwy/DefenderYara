...
rule Trojan_Win32_BHO_CF{
	meta:
		description = "Trojan:Win32/BHO.CF,SIGNATURE_TYPE_PEHSTR,04 00 04 00 04 00 00 "
		
	strings :
		$a_01_0 = {47 45 54 20 68 74 74 70 3a 2f 2f 25 73 25 73 20 48 54 54 50 2f 31 2e 31 } //1 GET http://%s%s HTTP/1.1
