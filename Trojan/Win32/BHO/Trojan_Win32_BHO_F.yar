...
rule Trojan_Win32_BHO_F{
	...
	strings :
		...
		$a_00_2 = {2e 67 6f 32 65 61 73 79 2e 63 6f 6d 2f 69 73 6f } //01 00  .go2easy.com/iso
		$a_00_3 = {37 00 33 00 41 00 37 00 46 00 46 00 41 00 37 00 2d 00 41 00 41 00 33 00 41 00 2d 00 34 00 39 00 45 00 35 00 2d 00 41 00 37 00 37 00 37 00 2d 00 37 00 31 00 33 00 42 00 37 00 44 00 42 00 37 00 38 00 45 00 39 00 43 00 } //00 00  73A7FFA7-AA3A-49E5-A777-713B7DB78E9C
	condition:
		any of ($a_*)
