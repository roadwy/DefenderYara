...
rule Trojan_Win32_BHO_K{
	...
	strings :
		$a_03_0 = {6a 40 33 c0 59 8d bd ?? ?? ff ff 88 95 ?? ?? ff ff 68 3f 00 0f 00 f3 ab 66 ab 68 ?? ?? ?? ?? 68 02 00 00 80 8d ?? ?? 89 ?? ?? c7 ?? ?? 04 01 00 00 aa } //10
		$a_02_1 = {69 65 67 75 69 64 65 2e 63 6f 2e 6b 72 2f [0-20] 2e 70 68 70 3f } //2
