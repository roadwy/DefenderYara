...
rule Trojan_Win32_BHO_CQ_dll{
	...
	strings :
		...
		$a_03_2 = {2f 00 2f 00 6a 00 73 00 90 01 02 2e 00 31 00 38 00 90 00 } //1
		...
		$a_03_5 = {46 6d 5f 69 65 5f 44 6f 63 75 6d 65 6e 74 43 6f 6d 70 6c 65 74 65 90 05 08 01 00 53 74 72 54 6f 48 65 78 90 00 } //1
	condition:
