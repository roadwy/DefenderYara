...
rule Trojan_Win32_BHO_BW{
	...
	strings :
		$a_02_0 = {f2 ae 8b cd 4f c1 e9 02 f3 a5 8b cd 5d 83 e1 03 f3 a4 8b fa 83 c9 ff f2 ae f7 d1 2b f9 8b f7 8b d1 8b fb 83 c9 ff f2 ae 8b ca 4f c1 e9 02 f3 a5 8b ca 83 e1 03 f3 a4 8d 44 90 01 02 8d 4c 90 01 02 50 51 6a 00 6a 00 6a 00 6a 00 6a 00 8d 54 90 01 02 6a 00 52 6a 00 ff 15 90 00 } //10
		$a_02_1 = {68 61 6f 63 68 61 6a 69 61 6e 2e 63 6f 6d 90 02 10 73 6e 69 66 66 65 72 2e 65 78 65 90 00 } //10
