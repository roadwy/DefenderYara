...
rule Trojan_Win32_BHO_CM{
	...
	strings :
		$a_03_0 = {f3 ab 66 ab aa 8d 85 e4 fe ff ff c7 04 24 90 01 04 50 89 5d f4 89 5d f0 e8 90 01 04 59 8d 85 e4 fe ff ff 59 68 90 01 04 68 04 01 00 00 50 e8 90 01 04 59 50 8d 85 e4 fe ff ff 50 e8 90 01 04 83 c4 10 8d 45 f8 50 8d 45 fc 50 53 68 3f 00 0f 00 90 00 } //1
