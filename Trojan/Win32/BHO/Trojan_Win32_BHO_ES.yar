...
rule Trojan_Win32_BHO_ES{
	...
	strings :
		...
		$a_00_1 = {73 61 66 65 6d 6f 6e 2e 64 6c 6c } //01 00 
		$a_00_2 = {74 61 73 6b 6b 69 6c 6c 20 2f 46 20 2f 49 4d 20 25 73 } //01 00 
		$a_00_3 = {25 73 3f 75 73 65 72 3d 25 73 26 70 61 73 73 3d 25 73 26 } //00 00 
	condition:
		any of ($a_*)
