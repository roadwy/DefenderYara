...
rule Trojan_Win32_BHO_CL{
	...
	strings :
		$a_03_0 = {f3 ab 66 ab aa bf ?? ?? ?? ?? 83 c9 ff 33 c0 68 ?? ?? ?? ?? f2 ae f7 d1 2b f9 68 04 01 00 00 8b c1 8b f7 8b fa 89 5c ?? ?? c1 e9 02 f3 a5 8b c8 33 c0 83 e1 03 89 5c ?? ?? f3 a4 8d 7c ?? ?? 83 c9 ff f2 ae f7 d1 49 51 8d 4c ?? ?? 51 e8 } //1
