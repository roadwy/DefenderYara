...
rule Trojan_Win32_BHO_AU{
	...
	strings :
		...
		$a_03_2 = {68 74 74 70 3a 2f 2f 34 2e 67 75 7a 68 69 6a 69 6a 69 6e 2e 63 6f 6d 2f 62 69 67 64 2f [0-08] 2f 00 00 43 3a 5c 57 49 4e 44 4f 57 53 5c 54 65 6d 70 } //1
	condition:
