...
rule Trojan_Win32_BHO_CK{
	...
	strings :
		$a_03_0 = {f2 ae f7 d1 2b f9 68 90 01 04 8b c1 8b f7 8b fa 68 04 01 00 00 c1 e9 02 f3 a5 8b c8 33 c0 83 e1 03 f3 a4 8d 7c 90 01 02 83 c9 ff f2 ae f7 d1 49 51 8d 4c 90 01 02 51 e8 90 00 } //1
