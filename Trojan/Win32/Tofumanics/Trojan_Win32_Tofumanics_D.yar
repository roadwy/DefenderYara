...
rule Trojan_Win32_Tofumanics_D{
	...
	strings :
		...
		$a_01_3 = {2f 63 20 65 72 61 73 65 20 22 43 3a 5c 57 49 4e 44 4f 57 53 5c 73 79 73 74 65 6d 33 32 5c 64 72 69 76 65 72 73 5c 65 74 63 5c 68 6f 73 74 73 } //00 00 
	condition:
		any of ($a_*)
