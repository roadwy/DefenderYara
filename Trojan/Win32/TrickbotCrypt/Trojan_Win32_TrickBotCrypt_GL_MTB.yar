...
rule Trojan_Win32_TrickBotCrypt_GL_MTB{
	...
	strings :
		...
		$a_81_1 = {4c 55 58 75 52 66 41 6c 58 68 72 43 5e 39 63 77 29 73 6f 3f 6f 47 52 74 4f 39 54 73 49 4f 48 73 43 2b 71 78 56 57 23 4d 74 65 58 34 48 29 61 } //00 00  LUXuRfAlXhrC^9cw)so?oGRtO9TsIOHsC+qxVW#MteX4H)a
	condition:
		any of ($a_*)
