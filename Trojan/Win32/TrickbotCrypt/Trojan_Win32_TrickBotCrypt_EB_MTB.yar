...
rule Trojan_Win32_TrickBotCrypt_EB_MTB{
	...
	strings :
		$a_03_0 = {8b 4d e8 3b 4d f4 73 ?? 8b 55 e8 0f b6 02 0f b6 4d e7 33 c1 8b 55 e8 2b 55 08 0f b6 ca 81 e1 e0 00 00 00 33 c1 8b 55 e8 88 02 8b 45 e8 03 45 fc 89 45 e8 eb cb } //5
...
rule Trojan_Win32_TrickBotCrypt_EB_MTB_2{
	...
	strings :
		$a_03_0 = {03 d0 03 c1 0f b6 1c 10 02 5d ?? 8b 45 ?? 02 1d ?? ?? ?? ?? 8b 55 ?? 30 1c 10 40 89 45 ?? 3b 45 ?? 72 } //5
