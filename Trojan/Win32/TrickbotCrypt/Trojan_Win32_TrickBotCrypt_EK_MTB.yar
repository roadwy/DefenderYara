...
rule Trojan_Win32_TrickBotCrypt_EK_MTB_2{
	...
	strings :
		...
		$a_81_1 = {6d 67 49 4c 25 5e 51 39 25 61 21 76 68 46 34 35 36 33 5f 58 23 23 25 6f 5e 6d 6d 7a 42 6b 6c 33 72 41 71 72 39 46 28 5e 47 35 2a 29 46 44 67 4a 4a 75 62 64 3c 2b 73 4b 3c 33 6f 66 6c 45 26 5a 43 43 73 70 41 58 44 48 50 3f 62 48 33 65 53 47 50 37 37 26 34 75 6b 63 66 23 36 } //00 00 
	condition:
		any of ($a_*)
