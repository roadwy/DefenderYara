...
rule Trojan_Win32_TrickBotCrypt_FL_MTB{
	...
	strings :
		...
		$a_81_1 = {63 30 63 62 35 3e 6a 29 3f 7a 29 6c 6e 24 4b 72 6d 35 6b 44 28 69 25 2b 38 4d 6b 70 41 4a 68 4b 24 5e 48 30 39 46 } //00 00  c0cb5>j)?z)ln$Krm5kD(i%+8MkpAJhK$^H09F
	condition:
		any of ($a_*)
