...
rule Trojan_Win32_TrickBotCrypt_EQ_MTB{
	...
	strings :
		$a_03_0 = {45 33 c9 45 33 c0 ba 04 10 00 00 48 8b 49 40 ff 15 90 01 04 44 3b f8 0f 8d 90 01 04 3d 01 00 00 8a 06 52 46 30 07 5a 4a 47 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_Win32_TrickBotCrypt_EQ_MTB_2{
	...
	strings :
		$a_03_0 = {03 ce 89 54 24 90 01 01 03 c1 8a 0c 3a 8a 15 90 01 04 8a 18 02 ca 32 d9 8b 4c 24 90 01 01 88 18 8b 44 24 90 01 01 40 3b c1 89 44 24 90 01 01 0f 82 90 00 } //1
