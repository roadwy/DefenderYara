...
rule Trojan_Win32_TrickBotCrypt_GA_MTB{
	...
	strings :
		$a_03_0 = {8b 54 24 14 8a 04 32 8b 54 24 18 8a 14 3a 88 14 0e 8b 54 24 1c 88 04 3a 0f b6 14 0e 0f b6 04 0f 03 c2 33 d2 f7 f5 8b 6c 24 20 2b 15 ?? ?? ?? ?? 0f b6 04 0a 30 44 2b ff } //1
