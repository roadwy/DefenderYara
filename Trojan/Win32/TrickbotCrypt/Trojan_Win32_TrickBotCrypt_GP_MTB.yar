...
rule Trojan_Win32_TrickBotCrypt_GP_MTB{
	...
	strings :
		...
		$a_81_1 = {71 61 75 21 33 42 50 32 4e 5a 4a 39 39 6e 75 44 6a 23 62 5f 7a 30 28 4b 63 4a 69 49 59 44 6a 64 48 78 71 58 40 62 4c 4e 40 5a 49 31 54 28 55 51 51 68 63 25 63 68 4c 21 63 73 64 6b 61 69 72 53 33 50 48 59 43 } //00 00 
	condition:
		any of ($a_*)
