...
rule Trojan_Win32_TrickBotCrypt_ET_MTB{
	...
	strings :
		$a_03_0 = {8a 0c 08 32 0c 16 8b 15 90 01 04 0f af 15 90 01 04 a1 90 01 04 0f af 05 90 01 04 0f af 05 90 01 04 0f af 05 90 01 04 8b 75 ec 2b f0 03 f2 2b 35 90 01 04 2b 35 90 01 04 03 35 90 01 04 2b 35 90 01 04 8b 55 0c 88 0c 32 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_Win32_TrickBotCrypt_ET_MTB_2{
	...
	strings :
		$a_03_0 = {33 c0 81 e2 ff 00 00 00 8a 04 0e 03 c2 33 d2 f7 35 90 01 04 8a 04 0a 8a 13 32 d0 8b 44 24 90 01 01 45 88 13 90 09 04 00 8b 54 24 90 00 } //1
