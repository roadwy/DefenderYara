...
rule Trojan_Win32_TrickBotCrypt_ET_MTB_2{
	...
	strings :
		...
		$a_81_1 = {31 59 34 4f 47 26 77 73 26 56 44 6c 79 3e 71 3e 62 29 57 76 52 33 48 63 5a 36 49 67 72 78 4e 55 49 47 62 5f 37 30 47 74 49 26 38 65 4a 23 2a 35 40 43 69 2a 61 72 46 37 48 46 70 } //00 00  1Y4OG&ws&VDly>q>b)WvR3HcZ6IgrxNUIGb_70GtI&8eJ#*5@Ci*arF7HFp
	condition:
		any of ($a_*)
