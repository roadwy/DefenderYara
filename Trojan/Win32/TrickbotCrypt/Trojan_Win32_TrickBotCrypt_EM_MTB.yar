...
rule Trojan_Win32_TrickBotCrypt_EM_MTB{
	...
	strings :
		$a_03_0 = {8a 04 29 33 d2 8a 14 0e 03 c2 33 d2 f7 35 ?? ?? ?? ?? 2b 15 ?? ?? ?? ?? 8a 04 0a 8a 17 32 d0 8b 44 24 20 43 88 17 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_Win32_TrickBotCrypt_EM_MTB_2{
	...
	strings :
		$a_03_0 = {8b 54 24 1c 2b c3 8a 1d ?? ?? ?? ?? 83 c0 02 0f af 05 ?? ?? ?? ?? 03 c5 03 c2 8b 54 24 ?? 8a 14 0a 02 d3 8a 18 32 da 45 88 18 } //1
