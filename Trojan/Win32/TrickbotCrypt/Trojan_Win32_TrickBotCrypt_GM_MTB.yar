...
rule Trojan_Win32_TrickBotCrypt_GM_MTB_2{
	...
	strings :
		...
		$a_81_1 = {64 2b 25 37 46 4d 38 4d 55 65 53 48 30 5f 78 48 34 29 4c 71 46 6c 36 44 5e 44 37 77 73 71 6b 34 4a 78 69 50 71 30 56 6d 40 24 3f 38 6d 4d 26 53 6a 43 3c 58 51 39 66 37 4c 74 2b 4b 62 3e 53 52 4a 51 39 } //00 00 
	condition:
		any of ($a_*)
