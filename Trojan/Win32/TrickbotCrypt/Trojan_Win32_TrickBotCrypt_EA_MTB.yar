...
rule Trojan_Win32_TrickBotCrypt_EA_MTB{
	...
	strings :
		$a_03_0 = {0f b6 08 0f b6 55 ?? 33 ca 8b 45 ?? 2b 45 ?? 0f b6 d0 81 e2 ff 00 00 00 33 ca 8b 45 ?? 88 08 8b 4d ?? 03 4d ?? 89 4d ?? eb } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_Win32_TrickBotCrypt_EA_MTB_2{
	...
	strings :
		$a_03_0 = {0f b6 04 0e 03 c2 33 d2 f7 35 ?? ?? ?? ?? a1 ?? ?? ?? ?? 8b d8 0f af d8 4b 0f af d8 a1 ?? ?? ?? ?? 03 d3 2b d0 8b 44 24 10 8a 18 8a 14 0a 32 da 88 18 } //5
