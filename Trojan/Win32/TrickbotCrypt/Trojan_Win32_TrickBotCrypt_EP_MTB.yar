...
rule Trojan_Win32_TrickBotCrypt_EP_MTB_2{
	...
	strings :
		$a_03_0 = {2b c3 0f af c7 8d 04 58 2b 05 90 01 04 03 45 f8 03 c2 8b 55 f4 0f b6 14 32 89 45 f0 8b 45 fc 0f b6 04 30 03 c2 33 d2 f7 35 90 01 04 8b 45 f0 41 0f af cf 2b d1 03 d3 8a 0c 32 30 08 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_Win32_TrickBotCrypt_EP_MTB_3{
	...
	strings :
		$a_03_0 = {03 d0 8b 0d 90 01 04 0f af 0d 90 01 04 03 d1 a1 90 01 04 0f af 05 90 01 04 03 45 0c 8b 4d e4 8b 09 8b 75 08 33 db 8a 1c 0e 03 1d 90 01 04 8a 14 10 32 d3 90 00 } //1
