...
rule Trojan_Win32_TrickBotCrypt_FU_MTB{
	...
	strings :
		...
		$a_81_1 = {3c 52 33 61 5f 63 5e 6d 43 4e 77 34 2b 5e 36 4d 6c 65 37 3c 47 48 5a 49 58 39 6a 69 6d 3e 45 4a 57 39 3c 46 4c 40 31 55 40 75 37 54 6b 41 57 3e 24 36 75 4a 62 6d 6b 34 23 58 76 41 50 6d 24 38 } //00 00  <R3a_c^mCNw4+^6Mle7<GHZIX9jim>EJW9<FL@1U@u7TkAW>$6uJbmk4#XvAPm$8
	condition:
		any of ($a_*)
