...
rule Trojan_Win32_TrickBotCrypt_FU_MTB{
	...
	strings :
		$a_03_0 = {8b 45 0c 89 4d f8 8b 0d 90 01 04 2b d9 6b c9 05 03 1d 90 01 04 03 5d fc 03 d8 8b 45 f4 0f b6 04 30 03 c2 33 d2 f7 35 90 01 04 2b d1 03 d7 03 15 90 01 04 8a 04 32 30 03 90 00 } //5
