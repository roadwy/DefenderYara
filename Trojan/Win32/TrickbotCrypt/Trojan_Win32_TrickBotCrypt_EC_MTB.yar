...
rule Trojan_Win32_TrickBotCrypt_EC_MTB_2{
	...
	strings :
		...
		$a_81_2 = {3e 42 2a 58 21 55 66 5a 59 45 39 49 63 65 61 48 37 63 64 78 3c 68 5f 68 5e 31 44 44 33 51 74 75 73 79 3f 64 64 4f 38 7a 24 52 70 41 32 6f 25 38 28 66 66 3e 23 6b 65 55 4d 5f 46 73 33 55 7a 5e 64 62 65 43 24 71 2b 6e 58 70 6b 73 78 45 4d 57 67 75 77 55 7a 2b 6a 6e 76 } //00 00 
	condition:
		any of ($a_*)
