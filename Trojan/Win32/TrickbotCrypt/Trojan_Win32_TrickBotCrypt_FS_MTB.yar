...
rule Trojan_Win32_TrickBotCrypt_FS_MTB{
	...
	strings :
		$a_03_0 = {8a 14 0f 03 c2 33 d2 f7 35 90 01 04 a1 90 01 04 8b d8 0f af d8 4b 0f af d8 a1 90 01 04 03 d3 2b d0 8b 44 24 90 01 01 8a 14 0a 8a 18 32 da 45 88 18 90 00 } //10
