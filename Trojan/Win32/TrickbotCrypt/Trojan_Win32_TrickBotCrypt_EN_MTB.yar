...
rule Trojan_Win32_TrickBotCrypt_EN_MTB{
	...
	strings :
		$a_03_0 = {03 c2 8b 0d 90 01 04 0f af 0d 90 01 04 03 c1 8b 15 90 01 04 0f af 15 90 01 04 03 55 0c 8b 4d e4 8b 09 8b 75 08 33 db 8a 1c 0e 03 1d 90 01 04 8a 14 02 32 d3 90 00 } //1
