...
rule Trojan_Win32_TrickBotCrypt_GC_MTB{
	...
	strings :
		...
		$a_01_1 = {67 56 74 23 28 50 71 42 50 52 55 69 41 4d 50 65 4c 58 4e 4f 4b 44 63 63 68 61 44 64 6c 68 6d 34 26 6f 56 34 45 51 55 33 42 26 2b 59 74 63 5f 47 72 69 26 48 46 3f 2a 43 6a 4e 55 67 70 6e 77 44 24 6c 5e 73 6b 79 } //00 00 
	condition:
		any of ($a_*)
