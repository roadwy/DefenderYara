...
rule Trojan_Win32_TrickBotCrypt_FX_MTB{
	...
	strings :
		...
		$a_81_1 = {44 30 63 6b 2a 3c 3e 24 47 66 55 4f 4a 32 59 66 29 4e 5f 45 3c 52 5e 55 32 3e 6d 45 21 45 51 2a 2a 2a 75 54 75 2a 44 5f 58 6d 25 57 72 76 53 36 4e 34 6c 39 70 } //00 00 
	condition:
		any of ($a_*)
