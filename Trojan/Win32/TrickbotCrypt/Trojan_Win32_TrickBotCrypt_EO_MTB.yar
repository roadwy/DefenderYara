...
rule Trojan_Win32_TrickBotCrypt_EO_MTB{
	...
	strings :
		$a_03_0 = {8a 14 0e 03 df 8a 04 0b 03 c2 33 d2 f7 35 90 01 04 8d 45 ff 0f af 05 90 01 04 03 ea 03 c5 8b 6c 24 1c 8a 14 08 8b 44 24 10 8a 1c 28 32 da 8b 54 24 20 88 1c 28 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_Win32_TrickBotCrypt_EO_MTB_2{
	...
	strings :
		$a_03_0 = {03 d3 2b 15 90 01 04 8a 1d 90 01 04 83 c2 02 0f af d0 8b 44 24 1c 03 d5 03 c2 8b 54 24 10 8a 14 0a 02 d3 30 10 90 00 } //1
