...
rule Trojan_Win32_TrickbotCrypt_SQ_MTB_2{
	...
	strings :
		$a_03_0 = {ff d3 8b d0 8d 4d 90 01 01 ff d6 50 6a 90 01 01 ff d3 8b d0 8d 4d 90 01 01 ff d6 50 ff d7 8b d0 8d 4d 90 01 01 ff d6 50 6a 90 01 01 ff d3 90 00 } //2
		$a_03_1 = {50 6a 00 e8 90 01 04 89 85 90 01 04 ff 15 90 01 04 8b 8d 90 01 04 8d 95 90 01 04 8d 85 90 01 04 89 0d 90 01 04 52 50 8d 4d 90 01 01 8d 55 90 01 01 51 8d 45 90 00 } //2
	condition:
