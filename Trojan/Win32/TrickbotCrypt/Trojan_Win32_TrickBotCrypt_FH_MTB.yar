...
rule Trojan_Win32_TrickBotCrypt_FH_MTB{
	...
	strings :
		$a_03_0 = {8b 75 0c 8a 04 06 32 04 0a 8b 0d 90 01 04 0f af 0d 90 01 04 8b 15 90 01 04 0f af 15 90 01 04 8b 75 ec 2b 35 90 01 04 2b 35 90 01 04 2b f2 2b 35 90 01 04 03 f1 2b 35 90 01 04 03 35 90 01 04 8b 4d 0c 88 04 31 e9 90 00 } //1
