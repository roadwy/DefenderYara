...
rule Trojan_Win32_TrickBotCrypt_GS_MTB{
	...
	strings :
		...
		$a_81_1 = {39 42 47 64 68 63 5f 68 48 5f 56 55 36 6b 79 54 71 32 5f 41 34 6c 64 33 78 41 56 73 68 57 29 2a 5f 70 79 52 44 26 2a 6e 3c 32 23 6f 5e 76 68 53 43 7a 41 34 34 55 6a 69 5e 4c 6f 4d 39 6c } //00 00  9BGdhc_hH_VU6kyTq2_A4ld3xAVshW)*_pyRD&*n<2#o^vhSCzA44Uji^LoM9l
	condition:
		any of ($a_*)
