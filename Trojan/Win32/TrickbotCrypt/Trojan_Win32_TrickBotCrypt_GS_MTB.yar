...
rule Trojan_Win32_TrickBotCrypt_GS_MTB{
	...
	strings :
		$a_02_0 = {8b d5 8b 6c 24 90 01 01 03 d5 8a 1c 3a 33 d2 03 c3 f7 35 90 01 04 8b c7 03 c2 8a 0c 06 8b 44 24 90 01 01 8a 18 32 d9 8b 4c 24 90 01 01 88 18 8b 44 24 90 01 01 40 3b c1 89 44 24 90 01 01 0f 82 90 00 } //1
