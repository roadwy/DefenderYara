...
rule Trojan_Win32_TrickBotCrypt_GV_MTB{
	...
	strings :
		$a_02_0 = {8b 45 e0 3b 45 f0 73 90 01 01 8b 4d e0 0f b6 11 0f b6 45 df 33 d0 8b 4d e0 2b 4d 08 0f b6 c1 83 e0 20 33 d0 8b 4d e0 88 11 8b 55 e0 03 55 fc 89 55 e0 eb 90 00 } //10
