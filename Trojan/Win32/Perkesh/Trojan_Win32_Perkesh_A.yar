...
rule Trojan_Win32_Perkesh_A{
	...
	strings :
		$a_03_0 = {00 10 6a 03 ff 15 90 01 02 00 10 a3 90 01 02 00 10 6a 64 ff 15 90 01 02 00 10 eb f6 90 00 } //2
		$a_03_1 = {8b 46 04 3d 01 02 00 00 74 14 3d 02 02 00 00 74 0d 3d 02 01 00 00 75 90 01 01 83 7e 08 0d 90 00 } //2
