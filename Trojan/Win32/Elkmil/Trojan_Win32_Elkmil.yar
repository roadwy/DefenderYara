...
rule Trojan_Win32_Elkmil{
	...
	strings :
		...
		$a_03_3 = {c7 45 fc 33 00 00 00 c7 85 58 ff ff ff 90 01 04 c7 85 50 ff ff ff 08 00 00 00 8d 95 50 ff ff ff 8d 8d 60 ff ff ff ff 15 90 01 04 6a 00 8d 8d 60 ff ff ff 51 ff 15 90 00 } //3
	condition:
