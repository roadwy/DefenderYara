...
rule Trojan_Win32_Fleercivet_F{
	...
	strings :
		...
		$a_01_1 = {63 6c 5f 75 72 6c 31 3d } //01 00 
		$a_01_2 = {20 5b 25 30 34 64 2d 25 30 32 64 2d 25 30 32 64 5d 20 5b 25 30 32 64 2d 25 30 32 64 2d 25 30 32 64 2d 25 30 33 64 5d 20 2d 3e 5b 5d 3c 20 20 25 73 20 20 3e } //01 00 
