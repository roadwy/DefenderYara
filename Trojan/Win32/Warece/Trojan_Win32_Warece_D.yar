...
rule Trojan_Win32_Warece_D{
	...
	strings :
		...
		$a_03_1 = {c6 00 77 a1 90 01 03 10 c6 40 08 6c 90 00 } //1
		$a_03_2 = {74 1a 8b ce 8a 94 90 01 03 ff ff 3a c2 75 0d 84 d2 74 09 8a 41 01 90 01 01 41 84 c0 75 e8 90 00 } //1
