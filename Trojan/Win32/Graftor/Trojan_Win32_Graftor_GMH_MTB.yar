...
rule Trojan_Win32_Graftor_GMH_MTB{
	...
	strings :
		$a_03_0 = {8b 45 fc 83 c4 14 48 89 35 90 01 01 f6 60 00 5f 5e 90 00 } //10
		$a_03_1 = {56 53 ff 15 90 01 04 a1 90 01 01 49 61 00 89 35 90 01 01 f7 60 00 8b fe 38 18 90 00 } //10
