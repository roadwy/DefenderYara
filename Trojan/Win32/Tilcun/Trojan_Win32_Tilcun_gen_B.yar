...
rule Trojan_Win32_Tilcun_gen_B{
	...
	strings :
		...
		$a_00_2 = {53 6f 66 74 61 6e 79 } //f6 ff  Softany
		$a_00_3 = {36 38 42 34 32 44 31 42 35 30 31 38 46 34 33 30 35 46 39 32 45 41 30 33 42 46 46 35 38 36 36 43 37 34 33 45 32 46 37 30 34 35 39 34 } //00 00  68B42D1B5018F4305F92EA03BFF5866C743E2F704594
	condition:
		any of ($a_*)
