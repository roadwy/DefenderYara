...
rule Trojan_Win32_Snakeklg_GB_MTB{
	...
	strings :
		...
		$a_02_2 = {4b 00 45 00 59 00 4c 00 4f 00 47 00 47 00 45 00 52 00 90 02 1e 53 00 90 02 19 4e 00 90 02 19 41 00 90 02 19 4b 00 90 02 19 45 00 90 00 } //1
		$a_02_3 = {4b 45 59 4c 4f 47 47 45 52 90 02 1e 53 90 02 19 4e 90 02 19 41 90 02 19 4b 90 02 19 45 90 00 } //1
	condition:
