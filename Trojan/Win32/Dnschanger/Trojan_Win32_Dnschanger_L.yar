...
rule Trojan_Win32_Dnschanger_L{
	...
	strings :
		...
		$a_01_3 = {44 4e 53 53 65 72 76 69 63 65 } //01 00  DNSService
		$a_01_4 = {69 6e 69 2d 69 6e 20 68 65 72 65 } //01 00  ini-in here
		$a_01_5 = {4e 45 54 20 53 54 4f 50 20 22 25 53 22 } //00 00  NET STOP "%S"
	condition:
		any of ($a_*)
