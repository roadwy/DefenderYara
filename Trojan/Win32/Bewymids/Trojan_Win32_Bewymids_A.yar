...
rule Trojan_Win32_Bewymids_A{
	...
	strings :
		$a_03_0 = {74 18 6a 02 6a 98 57 e8 90 01 04 83 c4 0c 85 c0 74 0b 90 00 } //1
		$a_03_1 = {80 3b 63 8b f8 0f 85 90 01 02 00 00 80 7b 01 64 0f 85 90 01 02 00 00 80 7b 02 20 0f 85 90 00 } //1
