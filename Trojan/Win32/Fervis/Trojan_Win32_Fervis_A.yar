...
rule Trojan_Win32_Fervis_A{
	...
	strings :
		...
		$a_00_3 = {53 65 74 57 69 6e 64 6f 77 54 65 78 74 41 } //01 00  SetWindowTextA
		$a_01_4 = {47 65 74 53 79 73 74 65 6d 44 69 72 65 63 74 6f 72 79 41 } //00 00  GetSystemDirectoryA
	condition:
		any of ($a_*)
