...
rule Trojan_Win32_TaskSchedulerQakBot_B{
	meta:
		description = "Trojan:Win32/TaskSchedulerQakBot.B,SIGNATURE_TYPE_CMDHSTR_EXT,07 00 07 00 07 00 00 01 00 "
	...
	strings :
		...
		$a_00_5 = {2f 00 73 00 63 00 20 00 6f 00 6e 00 63 00 65 00 } //01 00  /sc once
