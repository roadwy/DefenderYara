...
rule Trojan_Win32_Dopplof_AR__3{
	...
	strings :
		...
		$a_80_10 = {5c 67 6c 6f 62 61 6c 72 6f 6f 74 5c 64 65 76 69 63 65 5c 63 73 76 } //\globalroot\device\csv  -10
		$a_80_11 = {5c 67 6c 6f 62 61 6c 72 6f 6f 74 5c 64 65 76 69 63 65 5c 63 64 72 6f 6d } //\globalroot\device\cdrom  -10
		$a_80_12 = {5c 64 65 76 69 63 65 5c 64 72 6d 75 73 62 64 73 6b 6f 62 6a } //\device\drmusbdskobj  -10
		$a_80_13 = {75 73 62 73 74 6f 72 23 64 69 73 6b 26 76 65 6e 5f 67 65 6e 65 72 69 63 } //usbstor#disk&ven_generic  -10
	condition:
		((#a_80_0  & 1)*1+(#a_80_1  & 1)*1+(#a_80_2  & 1)*1+(#a_80_3  & 1)*1+(#a_80_4  & 1)*1+(#a_80_5  & 1)*1+(#a_80_6  & 1)*1+(#a_80_7  & 1)*1+(#a_02_8  & 1)*1+(#a_02_9  & 1)*1+(#a_80_10  & 1)*-10+(#a_80_11  & 1)*-10+(#a_80_12  & 1)*-10+(#a_80_13  & 1)*-10) >=1
