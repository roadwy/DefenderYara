...
rule Trojan_Win32_Woripecs_gen_A{
	...
	strings :
		$a_03_0 = {83 fa 50 74 38 6a 01 8d 4d e4 e8 90 01 04 0f be 00 83 f8 4f 74 26 6a 02 8d 4d e4 e8 90 01 04 0f be 08 83 f9 53 74 14 6a 03 8d 4d e4 e8 90 01 04 0f be 10 83 fa 54 74 02 90 00 } //4
