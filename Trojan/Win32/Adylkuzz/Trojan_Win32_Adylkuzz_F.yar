...
rule Trojan_Win32_Adylkuzz_F{
	...
	strings :
		...
		$a_03_2 = {73 70 6f 6f 6c 73 76 2e 65 78 65 [0-04] 53 65 72 76 65 72 } //1
		$a_03_3 = {4d 69 6e 65 72 ?? 65 78 65 6e 61 6d 65 [0-08] 70 72 6f 63 65 73 73 2e 65 78 65 } //1
		$a_03_4 = {57 69 6e 53 65 73 [0-04] 64 69 73 70 6c 61 79 [0-04] 57 69 6e 64 6f 77 73 20 53 65 63 75 72 69 74 79 20 53 65 72 76 69 63 65 73 } //1
	condition:
