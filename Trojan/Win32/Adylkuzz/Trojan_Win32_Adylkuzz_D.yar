...
rule Trojan_Win32_Adylkuzz_D{
	...
	strings :
		...
		$a_03_5 = {77 69 6e 64 72 69 76 65 72 2e 65 78 65 90 02 04 53 65 72 76 65 72 90 00 } //1
		$a_03_6 = {57 48 44 4d 49 44 45 90 02 04 64 69 73 70 6c 61 79 90 02 04 57 69 6e 64 6f 77 73 20 48 61 72 64 77 61 72 65 20 44 72 69 76 65 72 20 4d 61 6e 61 67 65 6d 65 6e 74 90 00 } //1
	condition:
