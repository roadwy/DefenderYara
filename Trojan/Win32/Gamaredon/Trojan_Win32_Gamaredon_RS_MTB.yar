...
rule Trojan_Win32_Gamaredon_RS_MTB{
	...
	strings :
		...
		$a_02_2 = {43 72 65 61 74 65 53 68 6f 72 74 63 75 74 28 90 02 10 5c 53 79 73 74 65 6d 20 56 6f 6c 75 6d 65 20 49 6e 66 6f 72 6d 61 74 69 6f 6e 2e 6c 6e 6b 90 00 } //1
		$a_00_3 = {73 70 72 65 61 64 2d 73 73 2e 72 75 } //1 spread-ss.ru
		$a_02_4 = {64 65 6c 20 2f 66 20 2f 71 20 90 02 10 5c 6e 74 75 73 65 72 2e 69 6e 69 90 00 } //1
	condition:
