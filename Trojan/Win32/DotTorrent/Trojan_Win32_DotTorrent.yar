...
rule Trojan_Win32_DotTorrent_3{
	...
	strings :
		...
		$a_01_4 = {55 6e 69 6e 73 74 61 6c 6c 5c 49 51 4d 61 6e 61 67 65 72 } //01 00 
		$a_01_5 = {49 2d 51 20 4d 61 6e 61 67 65 72 2e 6c 6e 6b } //01 00 
		$a_01_6 = {55 6e 69 6e 73 74 61 6c 6c 5c 41 50 4d 61 6e 61 67 65 72 } //01 00 
		$a_01_7 = {41 50 20 4d 61 6e 61 67 65 72 2e 6c 6e 6b } //01 00 
		$a_01_8 = {55 6e 69 6e 73 74 61 6c 6c 5c 41 52 4d 61 6e 61 67 65 72 } //01 00 
		$a_01_9 = {41 52 4d 61 6e 61 67 65 72 2e 6c 6e 6b } //01 00 
