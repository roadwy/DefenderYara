...
rule Trojan_Win32_BladaInjector_MTB{
	...
	strings :
		$a_02_0 = {28 02 00 00 0a a2 25 1a 11 04 a2 28 03 00 00 0a 6f 04 00 00 0a 13 05 28 05 00 00 0a 72 90 01 01 35 00 70 18 17 8d 01 00 00 01 25 16 11 05 16 11 05 8e 69 28 06 00 00 0a a2 28 07 00 00 0a 74 02 00 00 01 13 06 11 06 6f 08 00 00 0a 16 9a 13 07 73 01 00 00 06 13 08 11 07 19 8d 01 00 00 01 25 90 00 } //1
	condition:
		((#a_02_0  & 1)*1) >=1
...
rule Trojan_Win32_BladaInjector_MTB_2{
	...
	strings :
		...
		$a_02_1 = {28 82 00 00 0a 28 90 01 02 00 06 6f 90 01 02 00 0a 13 90 01 01 11 90 01 01 20 90 01 02 00 00 28 90 01 02 00 06 6f 90 01 02 00 0a 13 90 01 01 2b 90 00 } //1
		$a_02_2 = {28 52 00 00 06 6f 85 00 00 0a 13 90 01 01 73 90 01 01 00 00 06 80 90 01 01 00 00 04 11 90 01 01 14 1f 90 01 01 8d 90 01 01 00 00 01 90 00 } //1
	condition:
