...
rule Trojan_Win32_Lukicsel_F{
	...
	strings :
		...
		$a_03_1 = {8d 45 08 e8 90 01 04 32 06 88 07 46 47 4b 75 ef 90 00 } //1
		$a_03_2 = {6a 00 6a 02 ff 15 90 01 04 8b d8 85 db 75 90 01 01 e8 90 01 04 83 f8 02 75 05 e8 90 01 04 68 e8 03 00 00 e8 90 00 } //1
	condition:
