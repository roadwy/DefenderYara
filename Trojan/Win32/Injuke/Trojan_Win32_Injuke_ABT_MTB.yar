...
rule Trojan_Win32_Injuke_ABT_MTB{
	...
	strings :
		...
		$a_01_1 = {32 32 79 6c 6b 75 38 79 68 30 34 39 79 75 30 33 34 68 6b 6f 66 77 34 32 68 34 72 79 6a 30 32 67 39 34 30 67 39 76 72 67 68 77 30 38 } //00 00  22ylku8yh049yu034hkofw42h4ryj02g940g9vrghw08
	condition:
		any of ($a_*)
