...
rule Trojan_Win32_Injuke_ABT_MTB{
	...
	strings :
		$a_03_0 = {33 18 89 1d 90 01 04 a1 90 01 04 8b 15 90 01 04 89 10 8b 45 f8 83 c0 04 89 45 f8 33 c0 a3 90 01 04 a1 90 01 04 83 c0 04 03 05 90 01 04 a3 90 01 04 8b 45 f8 3b 05 90 00 } //5
