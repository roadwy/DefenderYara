...
rule Trojan_Win32_Tepoyx_J{
	...
	strings :
		$a_03_0 = {68 3a 04 00 00 6a 0b 6a 49 6a 46 6a 41 6a 6e 8b 4c 24 90 01 01 8b d3 8b c6 e8 90 01 04 a3 90 00 } //2
		$a_03_1 = {68 1d 06 00 00 6a 10 6a 12 6a 4e 6a 65 6a 42 8b 4c 24 90 01 01 8b d3 8b c6 e8 90 01 04 a3 90 00 } //2
