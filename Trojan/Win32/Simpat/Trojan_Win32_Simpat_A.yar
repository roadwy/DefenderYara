...
rule Trojan_Win32_Simpat_A{
	...
	strings :
		$a_01_0 = {65 00 73 00 69 00 6d 00 70 00 5f 00 64 00 6c 00 6c 00 2e 00 64 00 6c 00 6c 00 } //01 00 
		$a_01_1 = {53 00 79 00 73 00 74 00 65 00 6d 00 33 00 32 00 5c 00 73 00 69 00 6d 00 70 00 5f 00 64 00 6c 00 6c 00 2e 00 64 00 6c 00 6c 00 } //01 00 
