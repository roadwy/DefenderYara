...
rule Trojan_Win32_Banker_Z{
	...
	strings :
		...
		$a_02_1 = {42 00 6f 00 72 00 6c 00 61 00 6e 00 64 00 20 00 53 00 65 00 63 00 75 00 72 00 69 00 74 00 79 00 90 02 10 46 00 69 00 6c 00 65 00 56 00 65 00 72 00 73 00 69 00 6f 00 6e 00 90 02 08 31 00 2e 00 30 00 2e 00 30 00 2e 00 30 00 90 00 } //1
