...
rule Trojan_Win32_Gatoodit_A{
	...
	strings :
		$a_03_0 = {68 bd 01 00 00 e8 90 01 02 ff ff 66 89 45 ee 6a 10 8d 45 ec 50 53 e8 90 00 } //1
		$a_03_1 = {68 5c 11 00 00 e8 90 01 02 ff ff 66 89 45 ee 6a 10 8d 45 ec 50 53 e8 90 00 } //1
