...
rule Trojan_Win32_Wiszr_C{
	...
	strings :
		$a_01_0 = {79 6f 5a 45 64 48 58 75 4b 76 63 67 62 71 6f 48 61 6c 65 73 51 4d 74 44 6f 52 66 74 4f 7a 62 6b 4e 69 77 45 4d 48 68 6f 6d 50 } //02 00  yoZEdHXuKvcgbqoHalesQMtDoRftOzbkNiwEMHhomP
		$a_01_1 = {2e 64 6c 6c 00 72 75 6e 6d 65 } //04 00  搮汬爀湵敭
