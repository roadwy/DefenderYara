...
rule Trojan_Win32_Finkmilt_gen_B{
	...
	strings :
		...
		$a_01_1 = {6c 64 72 2e 64 6c 6c 2c 70 72 6b 74 } //01 00  ldr.dll,prkt
		$a_00_2 = {6e 6f 70 6f 72 2e 73 79 73 } //01 00  nopor.sys
		$a_00_3 = {64 6f 70 6f 70 2e 73 79 73 } //00 00  dopop.sys
	condition:
		any of ($a_*)
