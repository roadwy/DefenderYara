...
rule Trojan_Win32_Torrost_A{
	...
	strings :
		$a_03_0 = {68 4c cc 00 00 ff d0 0f b7 c8 51 68 7f 00 00 01 e8 90 01 02 ff ff 8b f0 85 f6 0f 84 90 01 01 01 00 00 8b 15 90 01 04 8b 90 02 05 6a 00 6a 03 90 00 } //10
