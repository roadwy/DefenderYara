...
rule Trojan_Win32_Torrost_A{
	...
	strings :
		...
		$a_01_1 = {2e 6f 6e 69 6f 6e 2f 63 74 34 2e 70 68 70 } //01 00  .onion/ct4.php
		$a_01_2 = {53 6f 63 6b 73 50 6f 72 74 20 35 32 33 30 30 20 2d 2d 46 61 73 63 69 73 74 46 69 72 65 77 61 6c 6c 20 31 } //00 00  SocksPort 52300 --FascistFirewall 1
