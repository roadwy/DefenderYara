...
rule Trojan_Win32_Starter_P{
	...
	strings :
		$a_03_0 = {81 39 52 65 67 4f 75 90 01 01 8d 41 04 81 38 70 65 6e 4b 90 00 } //1
		$a_03_1 = {81 39 45 78 69 74 75 90 01 01 8d 41 04 81 38 50 72 6f 63 90 00 } //1
		$a_01_2 = {66 c7 85 00 fd ff ff 73 00 66 c7 85 02 fd ff ff 68 00 66 c7 85 04 fd ff ff 65 00 } //1
		$a_03_3 = {32 84 95 00 90 02 01 ff ff 8b 95 4c ff ff ff 88 04 32 46 ff 8d 3c ff ff ff 75 90 00 } //1
