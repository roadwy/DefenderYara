...
rule Trojan_Win32_Almanahe_C{
	...
	strings :
		$a_03_0 = {74 50 89 75 e4 81 7d e4 d0 04 00 00 73 17 8b 45 e4 8d 80 90 01 04 33 c9 8a 08 83 f1 23 88 08 ff 45 e4 eb e0 56 8d 45 e4 50 68 00 26 00 00 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_Win32_Almanahe_C_2{
	...
	strings :
		$a_03_0 = {81 7d e4 00 09 00 00 73 17 8b 45 e4 8d 80 90 01 04 33 c9 8a 08 83 f1 3a 88 08 ff 45 e4 eb e0 90 00 } //1
...
rule Trojan_Win32_Almanahe_C_3{
	...
	strings :
		$a_03_0 = {75 7c 33 c0 8a 88 90 01 04 80 f1 66 88 8c 05 fc fe ff ff 40 3d c8 00 00 00 7c e8 90 00 } //5
