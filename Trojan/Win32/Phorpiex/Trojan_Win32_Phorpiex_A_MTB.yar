...
rule Trojan_Win32_Phorpiex_A_MTB{
	...
	strings :
		$a_02_0 = {b9 30 75 00 00 f7 f9 81 c2 10 27 00 00 52 e8 90 01 04 99 b9 30 75 00 00 f7 f9 81 c2 10 27 00 00 52 8d 95 f0 fb ff ff 52 90 00 } //1
		$a_02_1 = {99 b9 60 ea 00 00 f7 f9 6b d2 90 01 01 81 c2 10 27 00 00 52 ff 15 90 00 } //1
