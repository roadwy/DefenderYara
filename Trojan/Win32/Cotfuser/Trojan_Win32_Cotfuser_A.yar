...
rule Trojan_Win32_Cotfuser_A{
	...
	strings :
		...
		$a_00_2 = {63 00 61 00 63 00 6c 00 73 00 20 00 63 00 3a 00 5c 00 20 00 2f 00 65 00 20 00 2f 00 67 00 20 00 65 00 76 00 65 00 72 00 79 00 6f 00 6e 00 65 00 3a 00 66 00 } //00 00  cacls c:\ /e /g everyone:f
	condition:
		any of ($a_*)
