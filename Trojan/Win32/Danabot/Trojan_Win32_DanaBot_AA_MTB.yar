...
rule Trojan_Win32_Danabot_AA_MTB_2{
	...
	strings :
		$a_03_0 = {8a 00 88 45 90 01 01 8a 45 90 01 01 04 9f 2c 1a 73 90 01 01 80 6d 90 01 01 20 a1 90 01 04 8a 00 88 45 90 01 01 8a 45 90 01 01 04 9f 2c 1a 73 90 01 01 80 6d 90 01 01 20 a1 90 01 04 8a 00 88 45 90 01 01 8a 45 90 01 01 04 9f 2c 1a 73 90 00 } //00 00 
	condition:
		any of ($a_*)
