...
rule Trojan_Win32_Medfos_AF_2{
	...
	strings :
		...
		$a_01_2 = {3a 2f 2f 25 64 2e 25 64 2e 25 64 2e 25 64 2f } //0a 00  ://%d.%d.%d.%d/
		$a_01_3 = {00 75 70 6c 6f 61 64 69 6e 67 2f 69 64 3d 25 64 26 6d 3d 25 64 26 6e 3d 25 64 } //0a 00  甀汰慯楤杮椯㵤搥洦┽♤㵮搥
