...
rule Trojan_Win32_Medfos_V_dll{
	...
	strings :
		...
		$a_01_3 = {68 74 74 70 73 2f 2f 25 73 3a 25 64 2f 57 69 6e 44 61 74 61 25 64 2e 44 6c 6c 3f 48 45 4c 4f 2d 53 54 58 2d 32 2a 25 73 2a 25 73 2a 25 73 24 } //01 00 
		$a_01_4 = {5c 57 69 6e 44 61 74 61 2e 64 6c 6c 00 } //01 00 
		$a_01_5 = {31 31 31 2e 31 31 31 2e 31 31 31 2e 31 31 31 00 } //01 00 
