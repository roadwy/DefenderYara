...
rule Trojan_Win32_RacoonStealer_AY_MTB{
	...
	strings :
		$a_03_0 = {45 08 5f 89 30 5e 89 58 04 5b c9 c2 04 00 90 0a 2b 00 2b 75 90 01 01 8d 45 90 01 01 89 3d 90 01 04 e8 90 01 04 ff 4d 90 01 01 0f 85 90 01 04 8b 90 00 } //1
