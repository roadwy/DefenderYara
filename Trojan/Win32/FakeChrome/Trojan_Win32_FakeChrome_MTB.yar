...
rule Trojan_Win32_FakeChrome_MTB{
	...
	strings :
		$a_03_0 = {47 6f 6f 67 6c 65 43 68 72 6f 6d 65 2d 90 02 05 2e 65 78 65 90 00 } //1
		...
		$a_02_3 = {74 00 64 00 6c 00 31 00 90 02 10 2d 00 90 02 20 40 00 40 00 43 00 6f 00 6e 00 74 00 72 00 6f 00 6c 00 6c 00 65 00 72 00 2e 00 47 00 6f 00 6f 00 67 00 6c 00 65 00 20 00 43 00 68 00 72 00 6f 00 6d 00 65 00 90 00 } //1
	condition:
