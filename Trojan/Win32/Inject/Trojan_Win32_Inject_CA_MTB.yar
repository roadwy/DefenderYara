...
rule Trojan_Win32_Inject_CA_MTB{
	...
	strings :
		$a_03_0 = {33 d0 88 55 90 02 04 8b 4d 90 02 04 03 4d 90 02 04 8b 55 90 02 04 83 ea 90 02 04 33 ca 66 89 4d 90 00 } //1
		$a_03_1 = {03 d0 33 55 90 02 04 66 89 95 90 02 04 eb 2a 90 00 } //1
