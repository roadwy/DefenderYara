...
rule Trojan_Win32_Inject_V{
	...
	strings :
		...
		$a_03_1 = {30 03 43 81 fb 9c 59 00 01 75 (f2|f3) e8 ?? ?? ff ff eb 0a } //1
		$a_03_2 = {8b 00 8b f0 85 f6 7e 1c bb 01 00 00 00 8b c5 e8 ?? ?? ff ff 0f b6 14 24 32 54 1f ff 88 54 18 ff 43 4e 75 e9 5a 5d 5f 5e 5b c3 } //1
	condition:
