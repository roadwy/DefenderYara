...
rule Trojan_Win32_TitanStealer_PA_MTB{
	...
	strings :
		...
		$a_03_1 = {5f 2f 43 5f 2f 55 73 65 72 73 2f [0-15] 2f 44 65 73 6b 74 6f 70 2f 73 74 65 61 6c 65 72 5f 76 } //2
		$a_01_2 = {37 37 2e 37 33 2e 31 33 33 2e 38 38 } //2 77.73.133.88
		$a_03_3 = {01 d6 89 f0 c1 fe 1f c1 ee 17 01 c6 c1 fe 09 c1 e6 09 29 f0 89 05 ?? ?? ?? ?? 01 d3 8b 44 24 ?? 89 ea 39 da 7e } //3
	condition:
