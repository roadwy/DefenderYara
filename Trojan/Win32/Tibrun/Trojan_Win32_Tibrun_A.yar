...
rule Trojan_Win32_Tibrun_A{
	...
	strings :
		$a_00_0 = {2f 77 77 77 2f 63 6d 64 2e 70 68 70 20 48 54 54 } //01 00  /www/cmd.php HTT
		$a_00_1 = {22 67 6f 6f 64 73 6c 69 73 74 22 20 3a 20 22 00 2c 20 22 70 70 73 22 20 3a } //01 00 
		$a_00_2 = {22 62 72 75 74 69 6e 67 22 20 3a 20 } //01 00  "bruting" : 
...
rule Trojan_Win32_Tibrun_A_2{
	...
	strings :
		$a_01_0 = {22 62 61 64 22 20 3a 20 00 2c 20 22 62 72 75 74 69 6e 67 22 20 3a } //0a 00  戢摡•›Ⰰ∠牢瑵湩≧㨠
		$a_01_1 = {62 72 75 74 2e 6c 6f 63 2f 77 77 77 } //0a 00  brut.loc/www
