...
rule Trojan_Win32_Tibrun_RPO_MTB{
	...
	strings :
		...
		$a_01_2 = {41 64 64 56 65 63 74 6f 72 65 64 45 78 63 65 70 74 69 6f 6e 48 61 6e 64 6c 65 72 } //01 00 
		$a_01_3 = {52 65 6d 6f 76 65 56 65 63 74 6f 72 65 64 45 78 63 65 70 74 69 6f 6e 48 61 6e 64 6c 65 72 } //00 00 
	condition:
		any of ($a_*)
