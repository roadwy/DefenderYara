...
rule Trojan_Win32_Lokibot_SH_MTB_2{
	...
	strings :
		...
		$a_81_3 = {52 65 73 6f 6c 76 69 6e 67 20 68 6f 73 74 6e 61 6d 65 20 25 73 } //01 00 
		$a_81_4 = {44 69 73 63 6f 6e 6e 65 63 74 69 6e 67 20 66 72 6f 6d 20 25 73 } //00 00 
	condition:
		any of ($a_*)
