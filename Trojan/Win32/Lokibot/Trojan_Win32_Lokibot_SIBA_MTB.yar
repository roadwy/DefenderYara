...
rule Trojan_Win32_Lokibot_SIBA_MTB{
	...
	strings :
		$a_00_0 = {4d 00 75 00 72 00 65 00 78 00 } //01 00 
...
rule Trojan_Win32_Lokibot_SIBA_MTB_2{
	...
	strings :
		$a_00_0 = {63 75 72 6f 67 61 79 65 6e 65 73 6f 2d 6b 75 63 6f 6e 75 6e 65 67 6f 6e 75 5c 79 61 63 69 62 61 76 2d 62 65 74 65 63 69 62 75 74 65 6d 65 6b 5c 67 69 64 69 6a 69 2e 70 64 62 } //01 00 
