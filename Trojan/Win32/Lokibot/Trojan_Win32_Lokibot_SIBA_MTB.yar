...
rule Trojan_Win32_Lokibot_SIBA_MTB{
	...
	strings :
		...
		$a_03_1 = {66 0f ec e5 0f 90 02 5a 81 34 1a 90 01 04 90 02 30 43 90 02 35 43 90 02 2a 43 90 02 40 43 90 02 3a 81 fb 8c 0d 01 00 90 02 05 90 18 0f 85 90 01 04 90 08 bd 01 ff d2 90 00 } //1
	condition:
