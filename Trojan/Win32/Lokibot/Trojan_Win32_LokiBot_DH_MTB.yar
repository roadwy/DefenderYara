...
rule Trojan_Win32_LokiBot_DH_MTB_2{
	...
	strings :
		$a_81_0 = {24 65 65 61 34 65 63 36 64 2d 34 37 61 66 2d 34 65 31 35 2d 39 66 65 62 2d 35 38 39 31 63 36 62 61 62 37 32 63 } //01 00 
		$a_81_1 = {66 72 6d 42 61 73 65 53 46 } //01 00 
