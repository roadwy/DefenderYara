...
rule Trojan_Win32_Lokibot_AV_MTB_2{
	...
	strings :
		$a_03_0 = {39 c1 0f 85 ?? ff ff ff 90 0a 20 00 8b 0f [0-06] 31 f1 [0-08] 39 c1 0f 85 ?? ff ff ff } //1
		$a_03_1 = {83 c2 04 e9 ?? 00 00 00 90 0a 40 00 8b 0f [0-10] 31 f1 [0-10] 11 0c 18 [0-10] 83 c2 04 e9 ?? 00 00 00 } //1
	condition:
