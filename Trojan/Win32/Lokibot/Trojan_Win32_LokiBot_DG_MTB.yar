...
rule Trojan_Win32_LokiBot_DG_MTB{
	...
	strings :
		$a_03_0 = {be 01 00 00 00 90 05 10 01 90 8b d0 03 d6 90 05 10 01 90 c6 02 59 90 05 10 01 90 46 81 fe a5 a6 f1 22 75 eb } //1
		$a_03_1 = {33 c0 89 07 [0-40] b3 ?? 90 05 10 01 90 a3 ?? ?? ?? ?? 90 05 10 01 90 8b c6 90 05 10 01 90 8a 80 ?? ?? ?? ?? a2 ?? ?? ?? ?? 90 05 10 01 90 8b d3 a0 ?? ?? ?? ?? e8 ?? ?? ?? ?? a2 ?? ?? ?? ?? 90 05 10 01 90 8a 1d ?? ?? ?? ?? 90 05 10 01 90 8b c3 e8 ?? ?? ?? ?? 90 05 10 01 90 8b 07 90 05 10 01 90 40 89 07 90 05 10 01 90 46 81 fe ?? ?? ?? ?? 75 } //1
	condition:
...
rule Trojan_Win32_LokiBot_DG_MTB_2{
	...
	strings :
		...
		$a_03_1 = {5c 54 45 4d 50 5c 6e 73 [0-0f] 2e 74 6d 70 5c [0-0f] 2e 64 6c 6c } //1
		$a_81_2 = {75 6e 6b 6e 6f 77 6e 64 6c 6c 2e 70 64 62 } //1 unknowndll.pdb
		$a_03_3 = {5c 4c 6f 61 64 65 72 5c [0-0f] 5c 52 65 6c 65 61 73 65 5c [0-0f] 2e 70 64 62 } //1
