...
rule Trojan_Win32_LokiBot_RPT_MTB{
	...
	strings :
		$a_03_0 = {88 45 ff 0f b6 4d ff 2b 4d f8 88 4d ff 0f b6 55 ff 81 f2 90 01 04 88 55 ff 0f b6 45 ff f7 d8 88 45 ff 0f b6 4d ff 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_Win32_LokiBot_RPT_MTB_2{
	...
	strings :
		$a_03_0 = {8a 04 0e 2c 90 02 10 02 c1 90 02 10 f6 d8 90 02 10 f6 d0 90 02 10 32 c1 90 02 10 02 c1 90 02 10 f6 d8 90 02 10 32 c1 f6 d8 88 04 0e 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
