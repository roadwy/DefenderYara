...
rule Trojan_Win32_Lokibot_AU_MTB{
	...
	strings :
		$a_03_0 = {00 00 5a 80 34 01 90 01 01 41 39 d1 75 f7 05 90 01 02 00 00 ff e0 90 0a 30 00 e8 90 01 01 ff ff ff b8 90 01 03 00 31 c9 68 90 01 02 00 00 5a 90 00 } //1
		$a_03_1 = {53 51 8b d8 54 6a 40 68 90 01 02 00 00 53 e8 90 01 04 50 e8 90 01 04 5a 5b c3 90 00 } //1
	condition:
