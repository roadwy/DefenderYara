...
rule Trojan_Win32_Puzlice_C{
	...
	strings :
		...
		$a_01_1 = {26 61 3d 70 61 79 5f 69 6e 70 6c 61 74 26 63 6f 6e 66 69 72 6d 3d 4f 4b 26 61 6d 6f 75 6e 74 3d 31 30 30 26 6e 65 77 5f 75 69 3d 26 26 00 } //0a 00 
