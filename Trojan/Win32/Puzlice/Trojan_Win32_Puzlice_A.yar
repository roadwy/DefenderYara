...
rule Trojan_Win32_Puzlice_A{
	...
	strings :
		$a_01_0 = {41 00 46 00 54 00 45 00 52 00 44 00 4f 00 57 00 4e 00 4c 00 4f 00 41 00 44 00 } //01 00  AFTERDOWNLOAD
		$a_01_1 = {26 00 50 00 75 00 62 00 6c 00 69 00 63 00 65 00 72 00 3d 00 } //01 00  &Publicer=
		$a_01_2 = {7a 00 68 00 2d 00 63 00 6e 00 2c 00 7a 00 68 00 3b 00 71 00 } //01 00  zh-cn,zh;q
