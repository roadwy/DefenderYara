...
rule Trojan_Win32_Sanpec_gen_B{
	...
	strings :
		$a_03_0 = {b9 38 01 00 00 8a 10 80 f2 ?? 88 10 40 49 75 f5 c3 } //5
		$a_03_1 = {50 c6 44 24 ?? 4f c6 44 24 ?? 77 c6 44 24 ?? 34 c6 44 24 ?? 2e c6 44 24 ?? 63 c6 44 24 ?? 67 c6 44 24 ?? 69 c6 44 24 ?? 00 } //5
		$a_03_2 = {32 d1 88 14 30 48 75 f1 8a 16 80 f2 ?? 88 16 8a c2 33 d2 8a f0 8d 85 ?? ?? ?? ?? 8a 56 01 50 53 8b fa c7 03 00 00 00 00 ff 95 ?? ?? ?? ?? 8b c7 25 ff ff 00 00 3d 05 02 00 00 } //5
		$a_03_3 = {68 00 00 00 40 51 ff 15 ?? ?? 40 00 8b f0 83 fe ff 0f 84 ?? ?? 00 00 8d 54 24 18 6a 00 52 68 00 72 00 00 68 } //5
