...
rule Trojan_Win32_Duzse_A{
	...
	strings :
		...
		$a_03_2 = {8b 45 e4 03 85 90 01 01 ff ff ff 0f 80 7c 01 00 00 89 45 e4 8b 45 e4 3b 85 90 01 01 ff ff ff 0f 8f ad 00 00 00 8b 45 e8 89 85 90 01 01 ff ff ff c7 85 90 01 01 ff ff ff 08 00 00 00 c7 45 d8 01 00 00 00 c7 45 d0 02 00 00 00 90 00 } //2
	condition:
