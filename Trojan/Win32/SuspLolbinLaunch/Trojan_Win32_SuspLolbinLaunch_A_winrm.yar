...
rule Trojan_Win32_SuspLolbinLaunch_A_winrm{
	...
	strings :
		...
		$a_02_1 = {69 00 6e 00 76 00 6f 00 6b 00 65 00 90 02 f0 5c 00 5c 00 90 00 } //1
		$a_02_2 = {69 00 6e 00 76 00 6f 00 6b 00 65 00 90 02 f0 68 00 74 00 74 00 70 00 90 00 } //1
	condition:
