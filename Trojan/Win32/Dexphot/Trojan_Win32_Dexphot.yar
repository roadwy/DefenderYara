...
rule Trojan_Win32_Dexphot_3{
	...
	strings :
		$a_00_0 = {2e 00 48 00 65 00 61 00 64 00 65 00 72 00 73 00 5b 00 27 00 55 00 73 00 65 00 72 00 2d 00 41 00 67 00 65 00 6e 00 74 00 27 00 5d 00 20 00 3d 00 20 00 27 00 57 00 69 00 6e 00 64 00 6f 00 77 00 73 00 20 00 49 00 6e 00 73 00 74 00 61 00 6c 00 6c 00 65 00 72 00 27 00 } //01 00 
		$a_00_1 = {2e 00 44 00 6f 00 77 00 6e 00 6c 00 6f 00 61 00 64 00 46 00 69 00 6c 00 65 00 28 00 27 00 68 00 74 00 74 00 70 00 } //01 00 
		$a_00_2 = {2e 00 69 00 6e 00 66 00 6f 00 2f 00 } //01 00 
		$a_00_3 = {53 00 74 00 61 00 72 00 74 00 2d 00 50 00 72 00 6f 00 63 00 65 00 73 00 73 00 20 00 } //01 00 
		$a_00_4 = {2d 00 41 00 72 00 67 00 75 00 6d 00 65 00 6e 00 74 00 4c 00 69 00 73 00 74 00 20 00 27 00 2f 00 71 00 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Dexphot_4{
	...
	strings :
		$a_01_0 = {6f 63 65 73 73 4d 64 69 6e 6f 63 65 73 73 4d 69 64 73 73 4d 69 6e 69 6e 6f 63 65 73 73 4d 69 6e 64 6f 63 65 73 73 4d 69 6e 69 6e 6f 63 65 73 73 4d 69 6e 69 6e } //00 00 
	condition:
		any of ($a_*)
