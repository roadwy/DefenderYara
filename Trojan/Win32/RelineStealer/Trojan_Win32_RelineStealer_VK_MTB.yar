...
rule Trojan_Win32_RelineStealer_VK_MTB{
	...
	strings :
		$a_02_0 = {f0 3b 06 6c c7 84 24 90 01 04 91 d5 b8 3c c7 84 24 90 01 04 ed cf 0e 06 c7 84 24 90 01 04 da 73 71 22 c7 84 24 90 01 04 84 1f e8 75 c7 84 24 90 01 04 17 64 50 28 90 00 } //10
