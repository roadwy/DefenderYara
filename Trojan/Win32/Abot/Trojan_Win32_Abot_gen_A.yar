...
rule Trojan_Win32_Abot_gen_A{
	...
	strings :
		...
		$a_03_1 = {6f 70 48 54 54 50 44 44 6f 53 90 09 02 00 53 74 90 00 } //1
		$a_03_2 = {6f 70 54 43 50 44 44 6f 53 90 09 02 00 53 74 90 00 } //1
		$a_03_3 = {6f 70 44 44 6f 53 90 09 02 00 53 74 90 00 } //1
	condition:
