...
rule Trojan_Win32_CoinStealer_BC_MTB{
	...
	strings :
		$a_03_0 = {8b c8 83 f1 3c 81 e9 90 01 04 03 cf 81 e9 90 01 04 89 4d 90 00 } //1
		$a_03_1 = {2b c7 83 c0 4c 81 f0 90 01 04 2b c6 33 05 90 01 04 81 e8 90 01 04 03 05 90 01 04 89 45 90 00 } //1
