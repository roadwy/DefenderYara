...
rule Trojan_Win32_XPack_CZZ_MTB{
	...
	strings :
		...
		$a_81_1 = {4e 45 4f 78 47 65 74 50 72 6f 63 41 64 64 72 65 73 73 } //01 00 
		$a_81_2 = {56 69 72 74 75 61 6c 46 72 65 65 } //01 00 
		$a_81_3 = {56 69 72 74 75 61 6c 41 6c 6c 6f 63 } //00 00 
	condition:
		any of ($a_*)
