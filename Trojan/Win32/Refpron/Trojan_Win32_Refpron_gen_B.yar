...
rule Trojan_Win32_Refpron_gen_B{
	...
	strings :
		...
		$a_03_1 = {c7 40 0c c8 20 00 00 ba c0 d4 01 00 8b 45 90 01 01 e8 90 00 } //2
		$a_03_2 = {68 0d ba db 00 8b 45 f0 50 e8 90 01 02 ff ff 89 45 90 01 01 81 7d 90 01 01 02 01 00 00 75 90 00 } //1
		$a_03_3 = {68 0d ba db 00 56 e8 90 01 02 ff ff 3d 02 01 00 00 75 90 00 } //1
		...
		$a_02_5 = {00 53 65 74 20 90 0e 04 00 46 69 6c 65 20 90 0e 04 00 54 69 6d 65 20 90 0e 04 00 53 75 63 63 65 73 73 66 75 6c 6c 79 21 21 21 00 90 00 } //1
	condition:
