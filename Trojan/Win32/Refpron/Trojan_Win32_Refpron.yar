...
rule Trojan_Win32_Refpron{
	...
	strings :
		$a_03_0 = {8d 4d e8 66 ba 88 2e b8 90 01 02 00 10 e8 90 01 02 ff ff 8b 4d e8 8b 15 90 01 02 00 10 8b 12 8d 45 ec e8 90 00 } //1
		$a_03_1 = {89 45 fc 8d 4d f8 66 ba 88 2e b8 90 01 02 00 10 e8 90 01 02 ff ff 33 c0 55 68 90 00 } //1
