...
rule Trojan_Win32_Qhost_DT{
	...
	strings :
		...
		$a_00_1 = {25 70 72 6f 67 72 61 6d 66 69 6c 65 73 25 5c 41 56 47 } //01 00  %programfiles%\AVG
		$a_00_2 = {69 70 63 6f 6e 66 69 67 20 2f 66 6c 75 73 68 64 6e 73 } //01 00  ipconfig /flushdns
