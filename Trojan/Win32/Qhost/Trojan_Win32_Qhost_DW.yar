...
rule Trojan_Win32_Qhost_DW{
	...
	strings :
		...
		$a_03_1 = {6c 6c 33 32 c7 45 90 01 01 2e 65 78 65 c7 45 90 01 01 20 73 65 74 c7 45 90 01 01 75 70 61 70 90 00 } //1
		$a_03_2 = {c1 ee 1b c1 90 01 01 05 0b 90 01 01 0f 90 01 01 c1 8a 90 01 01 01 03 c6 42 84 c9 75 e9 90 00 } //1
