...
rule Trojan_Win32_Qhost_FD{
	...
	strings :
		$a_03_0 = {24 24 5c 73 79 73 74 65 6d 33 32 5c 64 72 69 76 65 72 73 5c 65 74 63 5c 68 6f 73 74 73 00 90 02 10 fd 9a 80 5c 69 6e 65 74 63 2e 64 6c 6c 00 2f 65 6e 64 00 90 00 } //1
