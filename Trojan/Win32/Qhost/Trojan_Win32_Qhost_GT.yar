...
rule Trojan_Win32_Qhost_GT{
	...
	strings :
		...
		$a_03_1 = {83 ec 04 89 c2 c7 44 24 10 00 00 00 00 8d 45 f8 89 44 24 0c 89 54 24 08 a1 ?? ?? ?? ?? 89 44 24 04 8b 45 fc 89 04 24 e8 ?? ?? ?? ?? 83 ec 14 a1 ?? ?? ?? ?? 89 04 24 e8 ?? ?? ?? ?? 83 ec 04 89 c2 c7 44 24 10 00 00 00 00 8d 45 f8 89 44 24 0c 89 54 24 08 } //1
	condition:
