...
rule Trojan_Win32_Tookibe_A{
	...
	strings :
		$a_03_0 = {b9 04 00 02 80 89 45 dc 89 45 cc 89 45 bc 89 45 8c 89 4d a4 b8 0a 00 00 00 89 4d b4 bf 08 00 00 00 8d 95 7c ff ff ff 8d 4d bc 89 45 9c 89 45 ac c7 45 84 ?? ?? ?? ?? 89 bd 7c ff ff ff ff d6 } //5
		$a_03_1 = {6a ff 68 00 00 b4 44 68 00 00 87 45 68 00 00 b4 44 52 50 ff 15 ?? ?? ?? ?? 50 56 ff 93 8c 07 00 00 } //5
