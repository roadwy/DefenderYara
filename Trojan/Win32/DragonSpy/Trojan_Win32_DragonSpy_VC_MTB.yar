...
rule Trojan_Win32_DragonSpy_VC_MTB{
	...
	strings :
		...
		$a_03_2 = {74 00 61 00 73 00 6b 00 6b 00 69 00 6c 00 6c 00 20 00 2f 00 49 00 4d 00 20 00 90 02 0a 2e 00 65 00 78 00 65 00 20 00 2f 00 46 00 90 00 } //1
		$a_03_3 = {74 61 73 6b 6b 69 6c 6c 20 2f 49 4d 20 90 02 0a 2e 65 78 65 20 2f 46 90 00 } //1
