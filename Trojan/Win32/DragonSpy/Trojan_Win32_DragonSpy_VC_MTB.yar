...
rule Trojan_Win32_DragonSpy_VC_MTB{
	...
	strings :
		$a_81_0 = {43 3a 5c 50 72 6f 67 72 61 6d 20 46 69 6c 65 73 5c 73 76 6d 5c 73 76 6d 2e 65 78 65 } //01 00  C:\Program Files\svm\svm.exe
		$a_81_1 = {70 72 6f 63 65 73 73 2e 74 78 74 } //01 00  process.txt
		...
		$a_81_4 = {77 77 77 2e 6e 69 6e 67 7a 68 69 64 61 74 61 2e 63 6f 6d } //00 00  www.ningzhidata.com
	condition:
		any of ($a_*)
