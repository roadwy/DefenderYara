...
rule Trojan_Win32_Nombsu_A{
	...
	strings :
		...
		$a_00_1 = {25 73 5c 6c 73 61 73 73 2e 65 78 65 22 20 75 20 2d 61 70 20 2d 68 70 25 73 20 2d 72 20 2d 74 6b 20 22 25 73 5c 70 6c 75 67 69 6e 2e 64 6c 6c } //01 00 
		$a_00_2 = {78 63 6f 70 79 2e 65 78 65 20 2f 73 20 2f 61 20 2f 79 20 2f 64 3a 25 73 20 25 73 5c 25 73 20 22 25 73 } //01 00 
