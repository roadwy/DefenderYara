...
rule Trojan_Win32_Mikey_BK_MSR{
	...
	strings :
		...
		$a_03_2 = {8b 44 24 0c 88 c1 88 4c 24 27 c7 44 24 28 00 00 00 00 8a 44 24 27 8b 4c 24 28 8b 54 24 2c 81 f2 90 02 04 8b 74 24 08 88 04 0e 01 d1 89 4c 24 28 8b 54 24 14 39 d1 90 00 } //2
