...
rule Trojan_Win32_Dinwod_AM_MTB{
	meta:
		description = "Trojan:Win32/Dinwod.AM!MTB,SIGNATURE_TYPE_PEHSTR_EXT,06 00 06 00 06 00 00 01 00 "
		
	strings :
		$a_01_0 = {76 67 75 61 72 64 65 72 2e 39 31 69 2e 6e 65 74 2f 75 73 65 72 2e 68 74 6d } //01 00  vguarder.91i.net/user.htm
		$a_01_1 = {75 70 64 61 74 65 78 2e 65 78 65 } //01 00  updatex.exe
		$a_01_2 = {53 65 72 76 65 72 78 2e 65 78 65 } //01 00  Serverx.exe
