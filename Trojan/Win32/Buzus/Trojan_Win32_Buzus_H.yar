...
rule Trojan_Win32_Buzus_H{
	...
	strings :
		...
		$a_00_2 = {47 00 62 00 74 00 73 00 6d 00 5f 00 52 00 45 00 2e 00 76 00 62 00 70 00 } //01 00  Gbtsm_RE.vbp
		$a_00_3 = {44 00 4a 00 5f 00 53 00 75 00 6e 00 2e 00 76 00 62 00 70 00 } //01 00  DJ_Sun.vbp
		$a_00_4 = {45 00 72 00 73 00 6d 00 73 00 5f 00 4a 00 4b 00 2e 00 76 00 62 00 70 00 } //00 00  Ersms_JK.vbp
	condition:
		any of ($a_*)
