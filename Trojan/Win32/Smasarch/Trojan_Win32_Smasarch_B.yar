...
rule Trojan_Win32_Smasarch_B{
	...
	strings :
		...
		$a_01_1 = {73 6d 73 2f 69 73 76 61 6c 69 64 32 2e 70 68 70 3f 63 6f 64 65 3d } //01 00 
		$a_01_2 = {65 6e 76 6f 79 65 72 20 75 6e 20 53 4d 53 20 61 76 65 63 20 6c 65 20 6d 6f 74 20 53 48 41 52 45 } //01 00 
		$a_01_3 = {54 58 54 5f 4d 45 53 53 41 47 45 53 4f 4e 45 } //01 00 
