...
rule Trojan_Win32_Smasarch_A{
	...
	strings :
		$a_02_0 = {73 6d 73 73 74 61 74 75 73 2e 63 6f 6d 2f 73 6d 73 2f 69 73 76 61 6c 69 64 ?? 2e 70 68 70 3f 63 6f 64 65 3d ?? ?? ?? 26 63 6f 75 6e 74 72 79 3d ?? ?? 26 70 72 3d [0-20] 26 61 66 3d } //1
