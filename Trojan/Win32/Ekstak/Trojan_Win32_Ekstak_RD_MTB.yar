...
rule Trojan_Win32_Ekstak_RD_MTB{
	...
	strings :
		$a_01_0 = {55 8b ec 51 e8 97 65 fb ff e8 12 65 fb ff e9 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Ekstak_RD_MTB_2{
	...
	strings :
		$a_01_0 = {55 8b ec 51 68 34 2f 65 00 e8 c2 64 fb ff e8 8d 65 fb ff e9 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Ekstak_RD_MTB_6{
	...
	strings :
		$a_03_0 = {55 8b ec 51 56 57 68 98 90 01 01 54 00 68 48 90 01 01 54 00 e8 cb 90 01 01 fa ff b9 41 00 00 00 33 c0 bf 50 90 01 01 54 00 f3 ab e9 90 00 } //00 00 
	condition:
		any of ($a_*)
