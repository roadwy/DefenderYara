...
rule Trojan_Win32_Ekstak_G_MTB{
	...
	strings :
		$a_02_0 = {33 45 ec 89 45 90 01 01 53 b8 90 01 04 b9 90 01 04 33 c1 a9 90 01 04 e9 90 09 0b 00 a1 90 01 04 33 05 90 00 } //1
		$a_02_1 = {8b 45 08 8b 00 a3 90 01 04 3b 45 90 01 01 0f 95 c1 53 b8 90 01 04 b9 90 01 04 33 c1 a9 90 01 04 e9 90 00 } //1
	condition:
