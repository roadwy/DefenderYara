...
rule Trojan_Win32_Ekstak_RC_MTB{
	...
	strings :
		$a_01_0 = {55 8b ec 51 68 24 1f 65 00 e8 42 65 fb ff e9 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Ekstak_RC_MTB_2{
	...
	strings :
		$a_01_0 = {55 8b ec 83 ec 0c 53 56 57 e8 d2 ee f5 ff 89 45 fc e9 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Ekstak_RC_MTB_3{
	...
	strings :
		$a_01_0 = {8b 44 24 04 50 ff 15 00 e0 64 00 8b 44 24 0c 8b 4c 24 10 0b c1 5e 83 f0 11 f7 d8 1b c0 40 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Ekstak_RC_MTB_4{
	...
	strings :
		$a_01_0 = {55 8b ec 83 ec 0c 57 68 70 0a 4d 00 e8 1f ed fc ff b9 41 00 00 00 33 c0 bf 00 06 4d 00 f3 ab } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Ekstak_RC_MTB_8{
	...
	strings :
		$a_01_0 = {ff 15 00 00 65 00 68 34 30 65 00 6a 00 8d 4c 24 10 6a 01 51 c7 44 24 18 0c 00 00 00 89 74 24 1c c7 44 24 20 00 00 00 00 ff 15 2c 02 65 00 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Ekstak_RC_MTB_11{
	...
	strings :
		$a_01_0 = {ff 15 00 f0 64 00 68 34 00 65 00 6a 00 8d 4c 24 20 6a 01 51 c7 44 24 28 0c 00 00 00 89 74 24 2c c7 44 24 30 00 00 00 00 ff 15 38 f0 64 00 8b f0 ff 15 28 f2 64 00 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Ekstak_RC_MTB_13{
	...
	strings :
		...
		$a_01_1 = {46 00 6f 00 6c 00 64 00 41 00 6c 00 79 00 7a 00 65 00 72 00 2e 00 65 00 78 00 65 00 } //00 00  FoldAlyzer.exe
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Ekstak_RC_MTB_14{
	...
	strings :
		...
		$a_01_1 = {46 00 69 00 6c 00 65 00 41 00 6c 00 79 00 7a 00 65 00 72 00 2e 00 65 00 78 00 65 00 } //00 00  FileAlyzer.exe
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Ekstak_RC_MTB_15{
	...
	strings :
		...
		$a_01_1 = {43 00 4a 00 6e 00 67 00 42 00 61 00 63 00 6b 00 75 00 70 00 } //00 00  CJngBackup
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Ekstak_RC_MTB_16{
	...
	strings :
		...
		$a_01_1 = {53 00 68 00 72 00 65 00 64 00 64 00 65 00 72 00 2e 00 65 00 78 00 65 00 } //00 00  Shredder.exe
	condition:
		any of ($a_*)
