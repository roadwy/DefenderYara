...
rule Trojan_Win32_Ekstak_RC_MTB_3{
	...
	strings :
		$a_01_0 = {55 8b ec 83 ec 10 53 56 57 e8 82 e8 f5 ff 89 45 fc e9 } //1
	condition:
		((#a_01_0  & 1)*1) >=1
...
rule Trojan_Win32_Ekstak_RC_MTB_4{
	...
	strings :
		$a_01_0 = {55 8b ec 51 56 57 68 5f bf 65 00 e8 a0 55 fb ff 8b f0 e9 } //1
	condition:
		((#a_01_0  & 1)*1) >=1
...
rule Trojan_Win32_Ekstak_RC_MTB_5{
	...
	strings :
		$a_01_0 = {55 8b ec 83 ec 10 53 56 57 e8 62 eb f5 ff 0f be c0 89 45 fc e9 } //1
	condition:
		((#a_01_0  & 1)*1) >=1
...
rule Trojan_Win32_Ekstak_RC_MTB_12{
	...
	strings :
		$a_03_0 = {33 d2 f7 f1 a3 ?? ?? ?? 00 e8 ?? 00 00 00 6a 00 6a 01 e8 90 09 19 00 6a 32 e8 ?? ?? ?? 00 01 05 ?? ?? ?? 00 e8 ?? ?? ?? 00 8b c8 b8 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_Win32_Ekstak_RC_MTB_13{
	...
	strings :
		$a_03_0 = {e8 46 07 00 00 59 a3 ?? 0b 08 01 e8 ?? 07 00 00 8b c8 33 d2 b8 ?? ?? ?? ?? f7 f1 31 05 7c 0b 08 01 e8 ?? 0d 00 00 33 c0 50 50 e8 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_Win32_Ekstak_RC_MTB_15{
	...
	strings :
		$a_03_0 = {83 c4 04 03 c8 89 0d ?? ?? ?? 00 e8 ?? ?? ?? 00 8b c8 b8 ?? ?? ?? ?? 33 d2 8b 1d ?? ?? ?? 00 f7 f1 33 d8 89 1d ?? ?? ?? 00 e8 90 09 0d 00 6a 32 e8 ?? ?? ?? 00 8b 0d } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_Win32_Ekstak_RC_MTB_18{
	...
	strings :
		$a_03_0 = {55 8b ec 83 ec 03 83 e4 f8 83 c4 04 57 56 8b 7d 14 3b 7d 0c a9 00 00 80 00 57 e8 ?? 8d 06 00 e9 } //5
...
rule Trojan_Win32_Ekstak_RC_MTB_19{
	...
	strings :
		$a_03_0 = {33 c0 5e 5d c3 8b c6 5e 5d c3 ?? ?? ?? ?? ?? 55 8b ec 56 8b 75 14 56 6a 00 ff 15 ?? 67 65 00 56 e8 ?? ?? 20 00 e9 } //5
