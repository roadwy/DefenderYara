...
rule Trojan_Win32_Ekstak_GMH_MTB{
	...
	strings :
		$a_03_0 = {56 53 ff 15 90 01 04 a1 90 01 01 00 47 00 89 35 90 01 01 f9 46 00 8b fe 38 18 90 00 } //10
		$a_03_1 = {8b 45 fc 83 c4 14 48 89 35 90 01 01 f9 46 00 5f 5e 90 00 } //10
