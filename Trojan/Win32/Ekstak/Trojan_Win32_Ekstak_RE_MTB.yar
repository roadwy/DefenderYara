...
rule Trojan_Win32_Ekstak_RE_MTB{
	...
	strings :
		$a_01_0 = {33 c0 5e 5d c3 8b c6 5e 5d c3 90 90 90 90 90 55 8b ec 8b 45 14 50 ff 15 e8 94 65 00 e9 } //5
	condition:
		((#a_01_0  & 1)*5) >=5
...
rule Trojan_Win32_Ekstak_RE_MTB_3{
	...
	strings :
		$a_01_0 = {8d 4d b0 e8 f0 93 07 00 68 9c 20 6b 00 8d 4d b0 e8 43 94 07 00 b9 41 00 00 00 33 c0 bf a4 29 72 00 f3 ab } //1
	condition:
		((#a_01_0  & 1)*1) >=1
...
rule Trojan_Win32_Ekstak_RE_MTB_5{
	...
	strings :
		$a_01_0 = {55 8b ec 51 56 e8 36 65 fb ff e9 } //1
		$a_01_1 = {53 8b 1d e4 33 65 00 56 8b 74 24 0c 57 6a 00 6a 00 6a 00 8d 46 1c 83 cf ff } //1
	condition:
...
rule Trojan_Win32_Ekstak_RE_MTB_6{
	...
	strings :
		$a_01_0 = {55 8b ec 51 56 57 68 71 69 4c 00 68 a4 30 4c 00 ff 15 3c 10 4c 00 50 e8 74 0d fd ff b9 41 00 00 00 33 c0 bf 00 65 4c 00 f3 ab } //1
	condition:
		((#a_01_0  & 1)*1) >=1
...
rule Trojan_Win32_Ekstak_RE_MTB_7{
	...
	strings :
		$a_01_0 = {8a 4c 24 0c 66 33 c0 80 e1 3f 5e 8a c1 83 c8 c0 83 c4 10 c3 90 90 90 90 90 90 90 90 90 90 90 90 90 90 55 8b ec e8 58 ff ff ff e9 } //1
	condition:
		((#a_01_0  & 1)*1) >=1
