...
rule Trojan_Win32_Ekstak_RG_MTB_2{
	meta:
		description = "Trojan:Win32/Ekstak.RG!MTB,SIGNATURE_TYPE_PEHSTR_EXT,02 00 02 00 02 00 00 01 00 "
		
	strings :
		$a_01_0 = {55 8b ec 51 53 56 e8 c5 ff ff ff e9 } //01 00 
		$a_03_1 = {40 00 00 40 2e 90 01 01 64 65 78 00 00 00 90 00 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Ekstak_RG_MTB_3{
	...
	strings :
		$a_01_0 = {55 8b ec 53 56 57 e8 25 ff ff ff e8 60 ff ff ff 8b d8 b9 41 00 00 00 33 c0 bf 64 f7 4c 00 f3 ab e9 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Ekstak_RG_MTB_5{
	...
	strings :
		$a_01_0 = {55 8b ec 56 e8 e7 ca f6 ff 68 38 b9 85 00 6a 00 ff 15 98 44 65 00 50 e8 d4 fe ff ff 31 05 78 ac 65 00 e9 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Ekstak_RG_MTB_10{
	...
	strings :
		...
		$a_01_1 = {41 00 63 00 72 00 6f 00 42 00 72 00 6f 00 6b 00 65 00 72 00 2e 00 65 00 78 00 65 00 } //00 00  AcroBroker.exe
	condition:
		any of ($a_*)
