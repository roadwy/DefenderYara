...
rule Trojan_Win32_Ekstak_RF_MTB_9{
	...
	strings :
		...
		$a_01_1 = {53 00 6d 00 61 00 72 00 74 00 20 00 54 00 75 00 72 00 6e 00 20 00 4f 00 66 00 66 00 20 00 43 00 4f 00 4d 00 70 00 75 00 74 00 65 00 72 00 } //00 00 
	condition:
		any of ($a_*)
