...
rule Trojan_Win32_Ekstak_RB_MTB{
	...
	strings :
		$a_01_0 = {55 8b ec 51 68 90 40 65 00 e8 12 65 fb ff e9 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Ekstak_RB_MTB_5{
	...
	strings :
		$a_03_0 = {83 f0 11 f7 d8 1b c0 40 83 c4 90 01 01 c3 33 c0 5f 83 c4 90 00 } //01 00 
		$a_01_1 = {55 8b ec 51 56 e8 f6 69 fb ff e9 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Ekstak_RB_MTB_7{
	...
	strings :
		$a_01_0 = {55 8b ec 81 ec 04 01 00 00 56 57 b9 41 00 00 00 33 c0 8d bd fc fe ff ff f3 ab 8b 45 10 8d 8d fc fe ff ff 50 51 ff 15 60 40 4b 00 } //00 00 
	condition:
		any of ($a_*)
