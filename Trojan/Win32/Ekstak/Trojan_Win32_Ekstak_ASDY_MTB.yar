...
rule Trojan_Win32_Ekstak_ASDY_MTB{
	...
	strings :
		$a_03_0 = {72 44 6c 50 74 53 cd e6 d7 7b 0b 2a 01 00 00 00 7d 13 81 00 9f 77 7d 00 00 be [0-04] 14 99 2c 3b 7d } //5
		...
		$a_03_2 = {72 44 6c 50 74 53 cd e6 d7 7b 0b 2a 01 00 00 00 56 4e 6b 00 78 b2 67 00 00 be [0-04] 14 99 02 6c 67 } //5
		$a_03_3 = {72 44 6c 50 74 53 cd e6 d7 7b 0b 2a 01 00 00 00 17 a4 6b 00 39 08 68 00 00 be [0-04] 14 99 db c1 } //5
