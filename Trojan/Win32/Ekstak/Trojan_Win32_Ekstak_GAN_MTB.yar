...
rule Trojan_Win32_Ekstak_GAN_MTB_2{
	...
	strings :
		$a_03_0 = {2a 01 00 00 00 67 53 80 00 89 b7 7c 00 00 be 0a 00 d4 bd 14 99 0c 7b ?? ?? 00 d4 00 00 1e } //10
		$a_03_1 = {2a 01 00 00 00 2c 96 80 00 4e fa 7c 00 00 be 0a 00 d4 bd 14 99 ef bd ?? ?? 00 d4 00 00 } //10
