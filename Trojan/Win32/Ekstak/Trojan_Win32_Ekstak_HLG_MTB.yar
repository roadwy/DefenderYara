...
rule Trojan_Win32_Ekstak_HLG_MTB{
	...
	strings :
		...
		$a_01_1 = {40 2e 72 69 67 63 } //01 00 
		$a_01_2 = {4c 64 72 55 6e 6c 6f 63 6b 4c 6f 61 64 65 72 4c 6f 63 6b } //01 00 
		$a_01_3 = {40 47 65 74 50 72 6f 63 41 64 64 72 65 73 73 } //00 00 
	condition:
		any of ($a_*)
