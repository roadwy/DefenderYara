...
rule Trojan_Win32_Ursnif_BE_MTB{
	...
	strings :
		$a_02_0 = {2b c2 0f b7 0d 90 01 04 2b c8 66 89 0d 90 01 04 8b 15 90 01 04 81 c2 90 01 04 89 15 90 01 04 a1 90 01 04 03 45 90 01 01 8b 0d 90 01 04 89 88 90 01 04 0f b7 15 90 01 04 0f b6 05 90 01 04 2b d0 0f b7 0d 90 01 04 03 d1 90 00 } //2
		$a_02_1 = {03 ca 88 0d 90 01 04 e9 90 00 } //1
	condition:
