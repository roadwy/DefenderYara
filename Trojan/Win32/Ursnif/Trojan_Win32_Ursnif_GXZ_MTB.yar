...
rule Trojan_Win32_Ursnif_GXZ_MTB{
	...
	strings :
		$a_03_0 = {8b 4d fc 8b 45 f8 8b 00 83 e1 01 c1 e1 03 d3 e0 01 05 90 01 04 ff 4d fc 90 01 02 ff 75 f4 ff 15 90 01 04 ff 75 fc 83 45 f8 04 ff 75 f4 ff 15 90 01 04 3d 02 01 00 00 90 00 } //00 00 
	condition:
		any of ($a_*)
