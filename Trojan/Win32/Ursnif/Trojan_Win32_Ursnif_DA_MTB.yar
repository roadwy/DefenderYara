...
rule Trojan_Win32_Ursnif_DA_MTB{
	...
	strings :
		$a_03_0 = {8a da 89 15 ?? ?? ?? ?? 02 db 80 c3 0d 8b 54 24 28 8a c1 2a 44 24 10 81 c6 04 9c 01 01 2c 52 89 35 ?? ?? ?? ?? 02 d8 8b 44 24 24 89 34 02 83 c0 04 8b 15 ?? ?? ?? ?? 89 44 24 24 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_Win32_Ursnif_DA_MTB_2{
	...
	strings :
		$a_03_0 = {8a 55 2f 02 d3 f6 ea 8a d0 8b 45 1c 05 ?? ?? ?? ?? 89 45 24 fe c8 f6 e9 02 d0 02 55 47 30 14 31 83 3d ?? ?? ?? ?? 00 74 } //1
