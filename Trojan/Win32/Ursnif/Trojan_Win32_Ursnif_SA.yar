...
rule Trojan_Win32_Ursnif_SA{
	...
	strings :
		$a_02_0 = {ff 74 24 0c 52 ff 50 90 01 01 8b 54 90 01 02 8b 48 90 01 01 3b 4a 90 01 01 75 0e 8b 00 3b 02 75 08 b0 01 90 00 } //1
		...
		$a_02_3 = {8d 44 24 18 68 ee 07 00 00 50 68 90 01 04 89 0d 90 01 04 ff 15 20 60 44 00 81 3d 90 01 08 75 05 90 00 } //1
	condition:
