...
rule Trojan_Win32_Ursnif_RF_MTB_4{
	...
	strings :
		$a_81_0 = {63 3a 5c 54 68 65 79 5c 62 79 5c 53 61 79 5c 44 72 69 76 65 5c 36 35 30 2d 42 72 65 61 6b 5c 50 72 6f 64 75 63 74 2e 70 64 62 } //01 00  c:\They\by\Say\Drive\650-Break\Product.pdb
		...
		$a_81_3 = {47 65 74 4c 6f 63 61 6c 65 49 6e 66 6f 57 } //01 00  GetLocaleInfoW
		$a_81_4 = {49 73 44 65 62 75 67 67 65 72 50 72 65 73 65 6e 74 } //01 00  IsDebuggerPresent
		$a_81_5 = {53 65 74 53 65 63 75 72 69 74 79 44 65 73 63 72 69 70 74 6f 72 44 61 63 6c } //00 00  SetSecurityDescriptorDacl
	condition:
		any of ($a_*)
