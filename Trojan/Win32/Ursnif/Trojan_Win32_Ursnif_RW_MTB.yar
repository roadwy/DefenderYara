...
rule Trojan_Win32_Ursnif_RW_MTB{
	...
	strings :
		$a_03_0 = {81 c2 e0 0e 00 01 89 15 90 01 04 a1 90 01 04 03 45 90 01 01 8b 0d 90 01 04 89 88 90 01 04 e9 90 00 } //5
		...
		$a_03_2 = {80 eb 3d 8b 00 05 c0 20 0f 01 89 01 8b 0d 90 01 04 a3 90 01 04 0f b6 c3 90 00 } //5
