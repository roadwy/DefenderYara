...
rule Trojan_Win32_Ursnif_RC_MTB_2{
	...
	strings :
		$a_02_0 = {2b d9 01 1d 90 01 04 8b 5c 24 90 01 01 33 c9 85 d2 0f 94 c1 85 c9 74 90 01 01 2b ca 90 00 } //1
		$a_02_1 = {2b c8 03 f1 8b c8 2b ce 83 c1 90 01 01 8d 84 00 90 01 04 2b c1 03 c6 83 3d 90 01 05 89 0d 90 01 04 a3 90 01 04 75 90 01 01 8d 4e 90 01 01 03 f6 2b f0 90 00 } //1
	condition:
