...
rule Trojan_Win32_Ursnif_EB_MTB_2{
	...
	strings :
		$a_03_0 = {99 1c 00 00 89 35 90 01 04 81 25 90 01 04 70 02 00 00 89 1d 90 01 04 a1 90 01 04 81 35 90 01 04 e0 30 00 00 89 2d 90 01 04 81 35 90 01 04 5b 18 00 00 89 25 90 00 } //5
	condition:
		((#a_03_0  & 1)*5) >=5
