...
rule Trojan_Win32_Ursnif_AD_MTB_2{
	...
	strings :
		$a_01_0 = {63 3a 5c 73 61 74 5c 53 65 63 74 69 6f 6e 5c 73 74 6f 6f 64 5c 63 6f 75 6e 74 72 79 5c 73 74 72 6f 6e 67 5c 73 65 67 6d 65 6e 74 5c 46 65 6c 6c 5c 6d 6f 73 74 63 68 69 6c 64 2e 70 64 62 } //01 00  c:\sat\Section\stood\country\strong\segment\Fell\mostchild.pdb
		$a_01_1 = {69 66 20 65 78 69 73 74 73 20 28 73 65 6c 65 63 74 20 2a 20 66 72 6f 6d 20 64 62 6f 2e 73 79 73 6f 62 6a 65 63 74 73 20 77 68 65 72 65 20 69 64 20 3d 20 6f 62 6a 65 63 74 5f 69 64 28 4e 27 5b 64 62 6f 5d 2e 5b 50 72 63 5f 51 75 65 72 79 4c 6f 61 64 54 65 73 74 52 65 71 75 65 73 74 53 75 6d 6d 61 72 79 5d 27 29 20 61 6e 64 20 4f 42 4a 45 43 54 50 52 4f 50 45 52 54 59 28 69 64 2c 20 4e 27 49 73 50 72 6f 63 65 64 75 72 65 27 29 20 3d 20 31 29 } //01 00  if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[Prc_QueryLoadTestRequestSummary]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
		$a_01_2 = {75 67 6f 65 6f 64 54 5d 74 6e 73 35 61 4c 6e 52 61 20 4e 20 75 6d 4c 75 6e 20 5d 6c 74 20 63 65 72 6f 67 50 20 20 6e 20 6d 54 54 6f 52 20 50 20 6c 45 73 74 64 4f 41 5d 4b 6f 5d 45 74 54 46 29 73 61 20 43 72 } //00 00  ugoeodT]tns5aLnRa N umLun ]lt cerogP  n mTToR P lEstdOA]Ko]EtTF)sa Cr
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Ursnif_AD_MTB_4{
	...
	strings :
		$a_01_0 = {71 6c 6a 6e 6f 69 69 6e 5a 54 53 72 } //01 00  qljnoiinZTSr
		$a_01_1 = {39 37 36 3b 34 33 32 33 34 32 32 33 3f 3d 3d 33 4e 4b 4b 33 68 63 62 40 78 72 70 4d 6e 68 67 4f 6e 68 } //01 00  976;43234223?==3NKK3hcb@xrpMnhgOnh
		$a_01_2 = {39 38 37 56 3a 39 39 56 3c 3b 3b 56 41 3f 3f 56 45 44 43 56 47 47 46 56 48 48 47 51 45 44 44 09 } //01 00  㠹嘷㤺嘹㬼嘻㽁嘿䑅噃䝇噆䡈兇䑅ॄ
		$a_01_3 = {35 34 34 6b 30 2f 2f 4f 50 4c 4b 52 6e 67 66 } //01 00  544k0//OPLKRngf
