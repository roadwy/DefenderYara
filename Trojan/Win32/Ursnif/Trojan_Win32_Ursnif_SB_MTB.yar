...
rule Trojan_Win32_Ursnif_SB_MTB{
	...
	strings :
		$a_81_0 = {62 45 4e 48 57 52 4a 4e 52 77 40 23 47 48 4e 65 2e 70 64 62 } //01 00  bENHWRJNRw@#GHNe.pdb
		$a_81_1 = {5a 4b 39 20 4c 54 44 } //01 00  ZK9 LTD
		$a_81_2 = {37 20 42 72 6f 78 62 6f 75 72 6e 65 20 52 6f 61 64 } //01 00  7 Broxbourne Road
		$a_81_3 = {43 65 72 74 75 6d 20 45 56 20 54 53 41 20 53 48 41 32 } //01 00  Certum EV TSA SHA2
		$a_01_4 = {68 00 74 00 6e 00 52 00 6e 00 65 00 } //01 00  htnRne
		$a_81_5 = {7a 6e 66 75 } //00 00  znfu
	condition:
		any of ($a_*)
