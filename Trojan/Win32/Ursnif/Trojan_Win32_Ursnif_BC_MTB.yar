...
rule Trojan_Win32_Ursnif_BC_MTB{
	...
	strings :
		...
		$a_02_3 = {c1 e0 06 33 c9 03 05 90 01 04 8b 15 90 01 04 13 d1 90 02 11 83 c0 62 2b 05 90 01 04 33 c9 90 00 } //1
	condition:
...
rule Trojan_Win32_Ursnif_BC_MTB_2{
	...
	strings :
		$a_02_0 = {2b d0 0f b7 0d 90 01 04 03 d1 0f b7 05 90 01 04 03 c2 66 a3 90 01 04 8b 0d 90 01 04 81 c1 90 01 04 89 0d 90 01 04 8b 15 90 01 04 03 55 90 01 01 a1 90 01 04 89 82 90 00 } //1
		$a_02_1 = {2b ca 88 0d 90 01 04 0f b7 05 90 01 04 0f b6 0d 90 08 20 00 0f b7 05 90 01 04 0f b6 0d 90 01 04 03 c1 2b 05 90 01 04 a2 90 00 } //1
	condition:
