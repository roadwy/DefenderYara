...
rule Trojan_Win32_Ursnif_BC_MTB{
	...
	strings :
		$a_81_0 = {42 6f 72 6e } //01 00  Born
		$a_81_1 = {46 69 74 73 65 63 6f 6e 64 } //01 00  Fitsecond
		$a_81_2 = {50 61 73 74 70 75 74 } //01 00  Pastput
...
rule Trojan_Win32_Ursnif_BC_MTB_3{
	...
	strings :
		$a_01_0 = {2e 65 78 65 00 40 47 65 74 46 69 72 73 74 56 69 63 65 43 69 74 79 40 34 } //00 00  攮數䀀敇䙴物瑳楖散楃祴㑀
	condition:
		any of ($a_*)
