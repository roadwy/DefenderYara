...
rule Trojan_Win32_Ursnif_MFP_MTB{
	...
	strings :
		...
		$a_02_1 = {0f af f0 89 f0 83 f0 ?? 85 f0 40 0f 94 c5 83 fa 0a 0f 9c c3 40 30 eb bb 6c 95 b0 0f bf b2 df 8f 21 0f 45 df 85 f0 89 dd 0f 44 ef 83 fa 0a 4c 89 4c 24 08 0f 4d eb } //5
		$a_02_2 = {0f af d0 89 d0 83 f0 ?? 85 d0 41 0f 94 c0 83 f9 0a 0f 9c c3 44 30 c3 bb 61 20 ca 7d be a9 33 3d 09 0f 45 de 85 d0 89 d8 0f 44 c6 83 f9 0a 8b 4c 24 5c 0f 4d c3 3b 0d 96 6f 02 } //5
	condition:
