...
rule Trojan_Win32_Koobface_gen_F{
	...
	strings :
		$a_03_0 = {ff 51 70 8b 45 90 01 01 3b 90 01 01 74 0d 8b 90 01 01 94 01 00 00 8b 08 52 50 ff 51 68 90 09 06 00 90 90 01 00 00 90 00 } //1
		$a_03_1 = {ff 91 e0 00 00 00 8b 45 ec 90 03 01 01 46 47 81 90 03 01 01 fe ff 04 01 00 00 7e 0f 90 00 } //1
