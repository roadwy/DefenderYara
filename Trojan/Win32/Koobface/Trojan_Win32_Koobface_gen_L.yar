...
rule Trojan_Win32_Koobface_gen_L{
	...
	strings :
		...
		$a_01_2 = {66 62 63 68 65 63 6b } //01 00  fbcheck
		$a_01_3 = {67 63 68 65 63 6b 67 65 6e } //02 00  gcheckgen
		$a_00_4 = {26 63 72 63 3d 25 64 } //01 00  &crc=%d
		$a_00_5 = {25 73 3f 61 25 73 6e 3d 25 73 67 65 6e 26 76 3d 25 73 26 } //00 00  %s?a%sn=%sgen&v=%s&
	condition:
		any of ($a_*)
