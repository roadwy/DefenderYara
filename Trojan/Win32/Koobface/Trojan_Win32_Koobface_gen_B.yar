...
rule Trojan_Win32_Koobface_gen_B{
	...
	strings :
		$a_03_0 = {05 00 ff ff ff 56 50 53 ff 15 90 01 04 8d 45 08 56 50 68 00 01 00 00 90 00 } //1
		$a_03_1 = {59 0f 84 35 04 00 00 8b 3d 90 01 04 6a 3d ff 75 0c ff d7 90 00 } //1
