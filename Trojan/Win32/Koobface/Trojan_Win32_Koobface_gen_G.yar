...
rule Trojan_Win32_Koobface_gen_G{
	...
	strings :
		...
		$a_01_2 = {2f 63 61 70 2f 3f 61 3d 71 75 65 72 79 } //01 00 
		$a_01_3 = {2f 63 61 70 2f 3f 61 3d 73 61 76 65 } //01 00 
		$a_01_4 = {2f 67 6f 6f 2f 3f 61 3d 25 73 } //01 00 
		$a_01_5 = {2f 67 6f 6f 67 6c 65 72 65 61 64 65 72 2f } //00 00 
	condition:
		any of ($a_*)
