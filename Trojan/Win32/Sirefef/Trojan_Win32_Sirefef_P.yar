...
rule Trojan_Win32_Sirefef_P{
	...
	strings :
		$a_03_0 = {3d 64 69 73 63 0f 84 90 01 04 3d 73 65 6e 64 90 00 } //10
		...
		$a_03_2 = {53 68 73 65 6e 64 8b c7 8b ce e8 90 01 04 8b d8 85 db 75 0d ff 76 90 01 01 e8 90 01 04 6a 08 58 90 00 } //10
		$a_03_3 = {c6 06 e8 6a 07 56 c6 46 05 eb c6 46 06 90 01 01 ff d7 90 00 } //1
	condition:
