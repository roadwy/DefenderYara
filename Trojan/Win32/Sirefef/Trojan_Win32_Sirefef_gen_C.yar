...
rule Trojan_Win32_Sirefef_gen_C{
	...
	strings :
		$a_00_0 = {3a 5c 56 43 35 5c 72 65 6c 65 61 73 65 5c 6b 69 6e 6a 65 63 74 2e 64 6c 6c 2e 70 64 62 } //01 00  :\VC5\release\kinject.dll.pdb
		$a_00_1 = {76 65 72 73 69 6f 6e 3d 30 26 65 72 72 3d 25 73 26 6c 3d 25 64 26 63 3d 25 64 20 48 54 54 50 2f 31 2e 31 } //01 00  version=0&err=%s&l=%d&c=%d HTTP/1.1
		...
		$a_00_3 = {52 65 66 65 72 65 72 3a 20 25 53 25 53 } //00 00  Referer: %S%S
	condition:
		any of ($a_*)
