...
rule Trojan_Win32_Sirefef_AK{
	...
	strings :
		...
		$a_03_2 = {8b 55 14 04 b6 e4 37 bf bb 01 aa 9a b0 d2 0a 33 90 09 10 00 00 24 00 00 90 00 } //1
		$a_03_3 = {d1 37 0c 1e 3f a3 64 1e 2b d7 a6 ea c7 e7 18 c1 90 09 10 00 00 a4 00 00 90 00 } //1
	condition:
