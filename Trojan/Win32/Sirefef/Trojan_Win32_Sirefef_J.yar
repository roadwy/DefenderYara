...
rule Trojan_Win32_Sirefef_J{
	...
	strings :
		$a_00_0 = {25 00 77 00 5a 00 5c 00 53 00 6f 00 66 00 74 00 77 00 61 00 72 00 65 00 5c 00 25 00 30 00 38 00 78 00 } //01 00  %wZ\Software\%08x
		$a_01_1 = {68 63 6e 63 74 } //01 00  hcnct
