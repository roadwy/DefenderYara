...
rule Trojan_Win32_Sirefef_AD{
	...
	strings :
		...
		$a_03_1 = {83 c6 14 8b 46 0c 85 c0 75 90 01 01 e9 90 01 01 00 00 00 8b 5e 10 8b 06 03 5d 08 03 45 08 eb 1d 78 15 8b 55 08 8d 74 11 02 6a 12 bf 90 01 04 59 33 d2 f3 a6 74 11 83 c3 04 83 c0 04 8b 08 85 c9 75 dd 90 00 } //1
	condition:
