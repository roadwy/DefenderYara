...
rule Trojan_Win32_Minix_NLA_MTB{
	...
	strings :
		$a_03_0 = {c7 44 0d 00 7c 33 a2 ee 81 44 0d 00 20 a2 eb 90 01 04 b5 8e 81 74 0d 00 3c ba 9e 90 01 04 81 74 0d 00 90 01 04 66 f7 c3 7f ca 66 39 d8 89 bd 90 00 } //5
