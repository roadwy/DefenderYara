...
rule Trojan_Win32_FakeFilecoder_PA_MTB{
	...
	strings :
		...
		$a_02_2 = {54 6f 20 72 65 74 72 69 65 76 65 20 74 68 65 20 70 72 69 76 61 74 65 20 6b 65 79 2e 20 79 6f 75 20 6e 65 65 64 20 74 6f 20 70 61 79 20 90 02 04 20 62 69 74 63 6f 69 6e 73 2e 90 00 } //1
	condition:
