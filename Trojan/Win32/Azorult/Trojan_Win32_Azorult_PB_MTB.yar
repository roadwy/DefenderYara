...
rule Trojan_Win32_Azorult_PB_MTB{
	...
	strings :
		$a_02_0 = {bf 06 f8 e5 c2 81 fe 87 0d 00 00 0f 44 c7 8b fa a3 90 01 04 8b 45 90 01 01 c1 ef 05 03 c1 03 7d 90 01 01 33 f8 8b 45 90 01 01 03 c2 33 f8 81 fe 98 05 00 00 75 90 00 } //20
