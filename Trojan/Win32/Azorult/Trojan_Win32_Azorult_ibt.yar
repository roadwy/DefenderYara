...
rule Trojan_Win32_Azorult_ibt{
	...
	strings :
		...
		$a_01_1 = {53 45 4c 45 43 54 20 44 41 54 45 54 49 4d 45 28 20 28 28 76 69 73 69 74 73 2e 76 69 73 69 74 5f 74 69 6d 65 2f 31 30 30 30 30 30 30 29 2d 31 31 36 34 34 34 37 33 36 30 30 29 2c 22 75 6e 69 78 65 70 6f 63 68 22 29 } //00 00 
	condition:
		any of ($a_*)
