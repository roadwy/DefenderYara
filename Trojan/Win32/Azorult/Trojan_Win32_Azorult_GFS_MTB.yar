...
rule Trojan_Win32_Azorult_GFS_MTB{
	...
	strings :
		...
		$a_01_3 = {6f 6d 65 66 6e 73 78 73 64 63 77 61 79 } //01 00 
		$a_01_4 = {6e 61 76 65 66 6b 64 65 65 63 73 66 77 } //01 00 
		$a_01_5 = {6d 6b 73 61 6d 66 65 73 61 73 66 } //01 00 
		$a_01_6 = {61 6d 76 73 69 76 6d 65 6f 66 6a 63 73 } //00 00 
	condition:
		any of ($a_*)
