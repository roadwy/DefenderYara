...
rule Trojan_Win32_Racealer_Y_MTB{
	meta:
		description = "Trojan:Win32/Racealer.Y!MTB,SIGNATURE_TYPE_PEHSTR_EXT,02 00 02 00 02 00 00 01 00 "
	...
	strings :
		...
		$a_00_1 = {8b 4d e4 33 4d f0 89 4d e4 8b 55 ec 33 55 e4 89 55 ec } //00 00 
	condition:
		any of ($a_*)
