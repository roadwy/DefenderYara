...
rule Trojan_Win32_Racealer_DEA_MTB{
	...
	strings :
		...
		$a_81_1 = {73 6c 6f 6b 61 64 6e 69 61 73 64 62 66 69 61 73 64 } //01 00  slokadniasdbfiasd
		$a_81_2 = {66 61 69 75 73 64 66 69 61 73 64 68 67 6f 73 64 66 6a 67 6f 73 } //01 00  faiusdfiasdhgosdfjgos
		$a_81_3 = {64 67 6f 73 64 66 6a 67 6f 69 73 64 6f 66 67 6d } //00 00  dgosdfjgoisdofgm
	condition:
		any of ($a_*)
