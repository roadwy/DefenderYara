...
rule Trojan_Win32_Racealer_MSM_MTB{
	...
	strings :
		...
		$a_02_1 = {81 e3 8d 5a 7d 6f c1 e0 04 81 6c 24 14 82 66 52 58 c1 eb 12 81 44 24 14 84 66 52 58 8b 54 24 14 0f af d6 8d 4c 95 00 8b 54 24 1c e8 90 01 04 46 c7 05 90 01 05 42 ae 83 3b f7 90 00 } //1
	condition:
