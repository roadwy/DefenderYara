...
rule Trojan_Win32_Racealer_GKM_MTB{
	meta:
		description = "Trojan:Win32/Racealer.GKM!MTB,SIGNATURE_TYPE_PEHSTR_EXT,01 00 01 00 01 00 00 01 00 "
		
	strings :
		$a_02_0 = {bb 74 19 00 00 8b 15 90 01 04 8a 8c 32 90 01 04 8b 15 90 01 04 88 0c 32 3d 03 02 00 00 75 90 01 01 6a 00 6a 00 ff d7 a1 90 01 04 89 1d 90 01 04 46 3b f0 72 90 00 } //00 00 
	condition:
		any of ($a_*)
