...
rule Trojan_Win32_ModiLoader_HNA_MTB{
	...
	strings :
		...
		$a_03_4 = {00 42 43 72 79 70 74 00 00 ff ff ff ff 02 00 00 00 56 65 00 00 ff ff ff ff 02 00 00 00 72 69 00 00 ff ff ff ff 02 00 00 00 66 79 00 00 ff ff ff ff 02 00 00 00 90 01 02 00 90 00 } //1
