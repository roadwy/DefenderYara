...
rule Trojan_Win32_Dapterup_A_B{
	meta:
		description = "Trojan:Win32/Dapterup.A!B,SIGNATURE_TYPE_PEHSTR_EXT,05 00 05 00 04 00 00 02 00 "
	...
	strings :
		...
		$a_01_3 = {8a 4c 30 ff 30 0c 30 83 e8 01 75 } //00 00 
		$a_00_4 = {5d 04 00 00 } //fe 0f 
	condition:
		any of ($a_*)
