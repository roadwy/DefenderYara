...
rule Trojan_Win32_DevilsTongue_A_dha{
	...
	strings :
		$a_03_0 = {53 79 6d 49 6e 69 74 69 61 6c 69 7a 65 90 02 04 64 62 67 68 65 6c 70 2e 64 6c 6c 90 00 } //2
		$a_03_1 = {64 00 62 00 67 00 48 00 65 00 6c 00 70 00 2e 00 64 00 6c 00 6c 00 90 02 04 53 74 61 63 6b 57 61 6c 6b 36 34 90 00 } //2
