...
rule Trojan_Win32_DevilsTongue_A_dha{
	...
	strings :
		...
		$a_01_2 = {77 00 69 00 6e 00 64 00 6f 00 77 00 73 00 2e 00 6f 00 6c 00 64 00 5c 00 77 00 69 00 6e 00 64 00 6f 00 77 00 73 00 } //03 00 
		$a_00_3 = {8b 29 ee ed bd d3 cf bb 35 66 6c 63 3f ca ae 4a } //01 00 
		$a_01_4 = {53 4d 4e 65 77 2e 64 6c 6c } //02 00 
