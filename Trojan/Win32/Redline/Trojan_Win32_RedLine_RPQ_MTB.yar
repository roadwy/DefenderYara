...
rule Trojan_Win32_RedLine_RPQ_MTB{
	...
	strings :
		$a_03_0 = {89 75 cc 3b f7 0f 83 81 00 00 00 8a 14 30 8b c6 83 e0 03 8a 88 ?? ?? ?? ?? 32 ca 0f b6 da 8d 04 19 8b 4d d0 88 04 31 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_Win32_RedLine_RPQ_MTB_2{
	...
	strings :
		$a_03_0 = {89 75 dc 3b f0 73 57 8b c6 83 e0 03 8a 88 ?? ?? ?? ?? 32 0c 37 0f b6 1c 37 8d 04 19 88 04 37 } //1
