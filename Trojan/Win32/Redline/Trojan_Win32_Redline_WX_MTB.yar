...
rule Trojan_Win32_Redline_WX_MTB{
	meta:
		description = "Trojan:Win32/Redline.WX!MTB,SIGNATURE_TYPE_PEHSTR_EXT,0b 00 0b 00 02 00 00 0a 00 "
		
	strings :
		$a_03_0 = {51 33 cb 59 8b c8 83 e1 03 8a 89 90 01 04 30 88 90 01 04 40 3d 7e 07 00 00 72 e3 90 00 } //01 00 
