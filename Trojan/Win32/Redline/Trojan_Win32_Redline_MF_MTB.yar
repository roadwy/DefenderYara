...
rule Trojan_Win32_Redline_MF_MTB_3{
	...
	strings :
		...
		$a_01_2 = {47 65 74 46 6f 72 65 67 72 6f 75 6e 64 57 69 6e 64 6f 77 } //01 00 
		$a_01_3 = {47 65 74 53 79 73 74 65 6d 49 6e 66 6f } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Redline_MF_MTB_5{
	...
	strings :
		...
		$a_01_1 = {55 00 6e 00 6d 00 65 00 72 00 63 00 69 00 66 00 75 00 6c 00 2e 00 65 00 78 00 65 00 } //02 00 
		$a_01_2 = {2e 31 32 38 78 65 71 32 } //02 00 
		$a_01_3 = {50 00 6c 00 65 00 61 00 73 00 65 00 2c 00 20 00 63 00 6f 00 6e 00 74 00 61 00 63 00 74 00 20 00 79 00 6f 00 75 00 72 00 73 00 69 00 74 00 65 00 40 00 79 00 6f 00 75 00 72 00 73 00 69 00 74 00 65 00 2e 00 63 00 6f 00 6d 00 2e 00 20 00 54 00 68 00 61 00 6e 00 6b 00 20 00 79 00 6f 00 75 00 21 00 } //00 00 
	condition:
		any of ($a_*)
