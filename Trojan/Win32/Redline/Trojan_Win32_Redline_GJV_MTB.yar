...
rule Trojan_Win32_Redline_GJV_MTB{
	...
	strings :
		$a_03_0 = {8b d6 d3 ea 03 c6 89 44 24 90 01 01 8b cb 8d 44 24 90 01 01 89 54 24 90 01 01 c7 05 90 01 04 ee 3d ea f4 e8 90 01 04 8b 44 24 90 01 01 31 44 24 90 01 01 81 3d 90 00 } //10
	condition:
		((#a_03_0  & 1)*10) >=10
