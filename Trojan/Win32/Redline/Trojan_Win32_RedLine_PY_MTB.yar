...
rule Trojan_Win32_RedLine_PY_MTB{
	...
	strings :
		...
		$a_01_1 = {73 00 65 00 79 00 6f 00 78 00 65 00 64 00 65 00 64 00 75 00 64 00 69 00 62 00 61 00 72 00 75 00 78 00 75 00 66 00 61 00 79 00 75 00 76 00 69 00 } //00 00 
	condition:
		any of ($a_*)
