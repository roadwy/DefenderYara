...
rule Trojan_Win32_RedLine_PY_MTB{
	...
	strings :
		$a_03_0 = {81 84 24 a8 01 00 00 90 01 04 b8 90 01 04 f7 a4 24 b4 00 00 00 8b 84 24 b4 00 00 00 81 84 24 a4 01 00 00 90 01 04 ff d7 6a 00 ff d3 81 fe 56 53 1c 00 7f 90 01 01 46 81 fe 44 ad cd 13 0f 8c 90 00 } //1
