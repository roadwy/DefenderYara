...
rule Trojan_Win32_Redline_TQ_MTB{
	meta:
		description = "Trojan:Win32/Redline.TQ!MTB,SIGNATURE_TYPE_PEHSTR,02 00 02 00 02 00 00 01 00 "
		
	strings :
		$a_01_0 = {51 c7 45 fc 02 00 00 00 8b 45 0c 01 45 fc 83 6d fc 02 8b 45 08 8b 4d 0c 31 08 } //01 00 
