...
rule Trojan_Win32_Redline_BY_MTB{
	...
	strings :
		$a_03_0 = {0f be 14 10 6b d2 2e 81 e2 [0-04] 33 ca 88 4d d7 0f be 45 d7 0f be 4d d7 03 c1 8b 55 0c 03 55 d8 88 02 0f be 45 d7 8b 4d 0c 03 4d d8 0f be 11 2b d0 8b 45 0c 03 45 d8 88 10 eb } //2
