...
rule Trojan_Win32_RedLine_MBHM_MTB{
	...
	strings :
		...
		$a_01_1 = {6e 75 6d 61 6c 69 68 69 6a 75 77 75 66 61 74 61 72 61 6d 6f 20 76 6f 6c 65 6b 61 78 6f 79 75 66 75 79 6f 6a 6f 74 61 7a 75 77 } //00 00  numalihijuwufataramo volekaxoyufuyojotazuw
	condition:
		any of ($a_*)
