...
rule Trojan_Win32_Redline_MK_MTB{
	...
	strings :
		$a_03_0 = {f6 17 80 07 ?? 80 2f ?? f6 2f 47 e2 f3 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_Win32_Redline_MK_MTB_2{
	...
	strings :
		$a_03_0 = {8b 4d e8 8b 45 08 8b 75 0c 8d 55 ec 89 34 24 8a 12 88 54 24 04 89 44 24 08 e8 ?? ?? ?? ?? 83 ec 0c 89 45 f8 8b 45 f8 83 c4 20 } //5
