...
rule Trojan_Win32_Redline_ASAE_MTB{
	...
	strings :
		$a_03_0 = {43 0f b6 84 1c 20 01 00 00 88 84 3c 20 01 00 00 88 8c 1c 20 01 00 00 0f b6 84 3c 20 01 00 00 03 c2 0f b6 c0 0f b6 84 04 20 01 00 00 30 86 90 02 04 46 81 fe 90 02 04 72 90 00 } //1
