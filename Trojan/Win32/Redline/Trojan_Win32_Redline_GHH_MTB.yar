...
rule Trojan_Win32_Redline_GHH_MTB{
	meta:
		description = "Trojan:Win32/Redline.GHH!MTB,SIGNATURE_TYPE_PEHSTR_EXT,0b 00 0b 00 02 00 00 0a 00 "
		
	strings :
		$a_03_0 = {8b c6 83 e0 03 8a 80 90 01 04 30 04 3e 46 3b f3 72 ed 90 00 } //01 00 
