...
rule Trojan_Win32_Redline_GNM_MTB{
	...
	strings :
		$a_01_0 = {78 72 4f 51 57 4a 52 56 4f 51 57 4f 4a 52 58 5a 4f 4a 51 57 4f } //01 00 
		$a_01_1 = {71 79 78 6b 65 62 66 73 63 6c 68 75 } //01 00 
		$a_01_2 = {74 78 7a 79 63 72 7a 73 6f 72 6e 6b 79 67 76 67 6b 63 6a 64 66 72 61 70 } //01 00 
