...
rule Trojan_Win32_Redline_GCA_MTB{
	meta:
		description = "Trojan:Win32/Redline.GCA!MTB,SIGNATURE_TYPE_PEHSTR_EXT,0b 00 0b 00 02 00 00 0a 00 "
		
	strings :
		$a_03_0 = {0f b6 4d d7 8b 45 d8 33 d2 f7 75 10 0f b6 92 90 01 04 33 ca 88 4d df 8b 45 0c 03 45 d8 8a 08 88 4d d6 90 00 } //01 00 
