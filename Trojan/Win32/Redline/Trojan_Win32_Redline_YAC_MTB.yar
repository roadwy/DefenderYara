...
rule Trojan_Win32_Redline_YAC_MTB{
	...
	strings :
		...
		$a_03_1 = {ff d7 80 b6 90 01 05 ff d7 80 86 90 01 05 ff d7 80 b6 90 01 05 ff d7 80 86 90 01 05 ff d7 80 86 90 01 05 ff d7 80 86 90 01 05 46 81 fe 00 76 03 00 0f 82 90 01 04 5f 5e c3 90 00 } //1
	condition:
