...
rule Trojan_Win32_Redline_GHN_MTB{
	...
	strings :
		$a_03_0 = {8a 4c 1d 10 88 4c 3d 10 88 54 1d 10 0f b6 4c 3d 10 03 ce 0f b6 c9 c7 45 90 01 05 8a 4c 0d 90 01 01 32 88 90 01 04 88 88 90 01 04 c7 45 fc 90 01 04 40 90 00 } //10
	condition:
		((#a_03_0  & 1)*10) >=10
...
rule Trojan_Win32_Redline_GHN_MTB_2{
	...
	strings :
		$a_03_0 = {8b d0 83 e2 03 8a 8a 90 01 04 30 0c 38 40 3b c6 72 90 01 01 5f 5e c3 90 00 } //10
