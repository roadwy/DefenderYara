...
rule Trojan_Win32_Redline_MD_MTB_2{
	meta:
		description = "Trojan:Win32/Redline.MD!MTB,SIGNATURE_TYPE_PEHSTR_EXT,0f 00 0f 00 02 00 00 0a 00 "
		
	strings :
		$a_03_0 = {ff d3 80 34 3e 90 01 01 ff d3 80 04 3e 90 01 01 ff d3 80 34 3e 90 02 0c 80 34 3e 90 01 01 ff d3 80 04 3e 90 01 01 ff d3 80 04 3e 90 01 01 ff d3 80 04 3e 90 01 01 46 3b 74 24 90 01 01 0f 82 90 00 } //05 00 
		$a_01_1 = {5f 4c 6f 61 64 45 6e 76 69 72 6f 6e 6d 65 6e 74 40 30 } //00 00  _LoadEnvironment@0
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Redline_MD_MTB_4{
	...
	strings :
		...
		$a_01_1 = {71 75 65 79 61 6c 6f 64 74 61 6b 65 79 74 69 6b 65 70 69 63 69 } //01 00  queyalodtakeytikepici
		$a_01_2 = {52 65 66 69 63 65 20 6a 61 72 65 77 20 64 69 6a 6f 73 20 6c 69 76 20 71 75 6f 6a 6f 6b } //01 00  Refice jarew dijos liv quojok
		$a_01_3 = {43 72 65 61 74 65 4d 75 74 65 78 57 } //01 00  CreateMutexW
		$a_01_4 = {47 65 74 43 50 49 6e 66 6f 45 78 41 } //01 00  GetCPInfoExA
		$a_01_5 = {43 6c 69 65 6e 74 54 6f 53 63 72 65 65 6e } //00 00  ClientToScreen
	condition:
		any of ($a_*)
