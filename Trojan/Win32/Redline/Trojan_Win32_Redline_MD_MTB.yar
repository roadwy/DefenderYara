...
rule Trojan_Win32_Redline_MD_MTB{
	...
	strings :
		$a_03_0 = {8b 4c 24 10 8b 44 24 14 03 44 24 90 01 01 c7 05 90 01 04 00 00 00 00 33 90 01 01 33 90 01 01 2b 90 01 01 89 44 24 14 8b 90 01 01 c1 e0 04 89 44 24 10 8b 44 24 2c 01 44 24 10 81 3d 90 01 04 be 01 00 00 8d 90 01 02 75 0e 90 00 } //5
	condition:
		((#a_03_0  & 1)*5) >=5
...
rule Trojan_Win32_Redline_MD_MTB_2{
	...
	strings :
		$a_03_0 = {ff d3 80 34 3e 90 01 01 ff d3 80 04 3e 90 01 01 ff d3 80 34 3e 90 02 0c 80 34 3e 90 01 01 ff d3 80 04 3e 90 01 01 ff d3 80 04 3e 90 01 01 ff d3 80 04 3e 90 01 01 46 3b 74 24 90 01 01 0f 82 90 00 } //10
...
rule Trojan_Win32_Redline_MD_MTB_4{
	...
	strings :
		$a_03_0 = {8b 55 f4 83 c2 01 89 55 f4 8b 45 f4 3b 45 10 73 90 01 01 8b 4d fc 03 4d f4 8b 55 f8 03 55 f4 8a 02 88 01 eb 90 00 } //1
...
rule Trojan_Win32_Redline_MD_MTB_5{
	...
	strings :
		$a_03_0 = {0f 42 c1 8b 4d 04 0f 42 c3 03 0c 24 52 50 ff 75 00 51 c5 f8 77 ff 15 90 01 04 8b 44 24 04 46 83 c5 28 0f b7 40 06 39 c6 72 90 00 } //1
