...
rule Trojan_Win32_Redline_MI_MTB{
	...
	strings :
		$a_03_0 = {8b c2 d3 e8 03 45 cc 89 45 f0 33 45 dc 31 45 fc 8b 45 fc 29 45 f8 81 c3 90 01 04 89 5d ec 4f 0f 85 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_Win32_Redline_MI_MTB_2{
	...
	strings :
		$a_03_0 = {89 c8 f7 e7 89 c8 29 d0 d1 e8 01 c2 89 c8 c1 ea 06 6b d2 5b 29 d0 89 c2 89 f0 c1 ea 02 f6 a2 90 01 04 30 81 90 01 04 83 c1 01 81 f9 7e 07 00 00 75 90 00 } //10
...
rule Trojan_Win32_Redline_MI_MTB_3{
	...
	strings :
		...
		$a_03_1 = {c1 ee 05 03 74 24 34 8b 44 24 20 31 44 24 10 81 3d f4 90 01 04 01 00 00 75 90 02 15 8b 4c 24 10 33 ce 8d 44 24 28 89 4c 24 10 e8 90 01 04 8b 44 24 30 29 44 24 14 83 6c 24 2c 01 8b 54 24 28 0f 85 90 00 } //5
	condition:
