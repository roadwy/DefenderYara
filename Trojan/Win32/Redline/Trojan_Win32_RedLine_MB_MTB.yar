...
rule Trojan_Win32_Redline_MB_MTB{
	...
	strings :
		$a_03_0 = {8b c0 f6 17 80 07 90 01 01 80 2f 90 01 01 f6 2f 47 e2 90 00 } //5
	condition:
		((#a_03_0  & 1)*5) >=5
...
rule Trojan_Win32_Redline_MB_MTB_2{
	...
	strings :
		$a_03_0 = {f6 2f 47 e2 90 0a 37 00 f6 17 90 01 18 80 2f 90 01 01 80 07 90 01 13 f6 2f 47 e2 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_Win32_Redline_MB_MTB_4{
	...
	strings :
		$a_03_0 = {33 f7 c1 c1 0d f7 d6 33 fe c1 c8 17 f3 a4 81 f1 09 48 a0 61 33 1d 90 01 04 09 0d 90 01 04 2b c2 21 3d 90 01 04 2b fc c1 c2 1f 81 f3 ec 0c e1 82 0b 15 90 01 04 09 35 90 01 04 46 c1 ca 1a 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_Win32_Redline_MB_MTB_5{
	...
	strings :
		$a_03_0 = {f7 64 24 10 8b 44 24 10 b8 90 01 04 f7 a4 24 48 02 00 00 8b 84 24 48 02 00 00 81 ac 24 60 01 00 00 90 01 04 b8 90 01 04 f7 a4 24 cc 00 00 00 8b 84 24 cc 00 00 00 81 ac 24 48 02 00 00 90 01 04 8a 84 37 90 01 04 88 04 0e 46 3b 35 90 01 04 0f 82 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
