...
rule Trojan_Win32_RedLine_MQ_MTB{
	...
	strings :
		$a_01_0 = {47 6f 6f 64 20 68 41 4b 4a 62 31 37 20 78 68 56 67 73 32 37 } //05 00 
		...
		$a_01_3 = {49 6e 69 74 4f 6e 63 65 45 78 65 63 75 74 65 4f 6e 63 65 } //02 00 
		$a_01_4 = {47 65 74 54 69 6d 65 5a 6f 6e 65 49 6e 66 6f 72 6d 61 74 69 6f 6e } //00 00 
	condition:
		any of ($a_*)
