...
rule Trojan_Win32_Redline_GJ_MTB{
	...
	strings :
		$a_03_0 = {75 5c 50 72 c7 40 90 01 01 6f 67 72 61 c7 40 90 01 01 6d 73 5c 53 c7 40 90 01 01 74 61 72 74 c7 40 90 01 01 75 70 5c 6b c7 40 90 01 01 6c 53 65 72 c7 40 90 01 01 76 69 63 65 c7 40 90 01 01 2e 65 78 65 90 00 } //10
