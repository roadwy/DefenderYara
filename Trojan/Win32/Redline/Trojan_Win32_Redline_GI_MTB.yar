...
rule Trojan_Win32_Redline_GI_MTB{
	meta:
		description = "Trojan:Win32/Redline.GI!MTB,SIGNATURE_TYPE_PEHSTR_EXT,0b 00 0b 00 02 00 00 0a 00 "
		
	strings :
		$a_03_0 = {8b c8 83 e1 03 8a 89 90 01 04 30 0c 07 40 3b c2 72 90 00 } //01 00 
