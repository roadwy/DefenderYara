...
rule Trojan_Win32_Redline_MA_MTB_2{
	...
	strings :
		...
		$a_01_2 = {55 6e 6c 6f 63 6b 46 69 6c 65 } //01 00 
		$a_01_3 = {44 65 6c 65 74 65 46 69 6c 65 57 } //01 00 
		$a_01_4 = {47 65 74 44 69 73 6b 46 72 65 65 53 70 61 63 65 45 78 41 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Redline_MA_MTB_3{
	...
	strings :
		$a_01_0 = {48 00 41 00 54 00 4f 00 54 00 41 00 47 00 } //05 00 
		$a_01_1 = {4a 00 45 00 59 00 41 00 47 00 4f 00 51 00 } //05 00 
		$a_01_2 = {53 00 4f 00 42 00 45 00 48 00 41 00 56 00 4f 00 42 00 41 00 } //05 00 
		$a_01_3 = {72 65 72 6f 71 20 6e 6f 67 69 6e 65 74 69 20 66 6f 70 61 78 61 20 66 61 68 20 6c 61 6e 61 66 20 76 65 63 61 62 } //01 00 
		$a_01_4 = {5c 68 65 64 6f 2e 70 64 62 } //01 00 
		$a_01_5 = {41 62 6f 72 74 53 79 73 74 65 6d 53 68 75 74 64 6f 77 6e 41 } //00 00 
	condition:
		any of ($a_*)
