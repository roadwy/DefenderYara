...
rule Trojan_Win32_Redline_GNR_MTB_2{
	meta:
		description = "Trojan:Win32/Redline.GNR!MTB,SIGNATURE_TYPE_PEHSTR_EXT,14 00 14 00 02 00 00 0a 00 "
		
	strings :
		$a_03_0 = {ff 80 04 1f 90 01 01 83 c4 90 01 01 47 3b fe 0f 82 90 00 } //0a 00 
		$a_03_1 = {ff 80 34 1f 90 01 01 68 90 01 04 68 90 01 04 e8 90 01 04 50 e8 90 01 04 80 04 1f 90 00 } //00 00 
	condition:
		any of ($a_*)
