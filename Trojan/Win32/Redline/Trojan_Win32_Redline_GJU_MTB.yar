...
rule Trojan_Win32_Redline_GJU_MTB_2{
	...
	strings :
		...
		$a_01_1 = {79 78 76 78 73 69 77 76 6f 73 } //01 00 
		$a_01_2 = {72 6a 6c 64 6f 76 70 76 74 6d 6f 61 68 64 75 64 } //01 00 
		$a_01_3 = {65 69 6b 68 71 71 72 79 71 67 62 66 61 74 } //01 00 
		$a_01_4 = {53 79 73 74 65 6d 46 75 6e 63 74 69 6f 6e 30 33 36 } //00 00 
	condition:
		any of ($a_*)
