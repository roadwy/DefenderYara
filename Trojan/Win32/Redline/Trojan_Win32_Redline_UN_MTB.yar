...
rule Trojan_Win32_Redline_UN_MTB{
	...
	strings :
		...
		$a_03_1 = {7a 08 e3 2c c7 45 90 01 01 3e 75 03 10 c7 45 90 01 01 d4 44 89 40 c7 45 90 01 01 bd 6a 3f 79 c7 85 90 01 04 22 0b 95 10 c7 85 90 01 04 7a 62 23 1f ff 15 90 00 } //10
	condition:
