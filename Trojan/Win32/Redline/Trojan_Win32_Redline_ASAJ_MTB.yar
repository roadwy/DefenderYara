...
rule Trojan_Win32_Redline_ASAJ_MTB{
	...
	strings :
		$a_03_0 = {03 c6 d3 ee 89 45 90 01 01 c7 05 90 02 04 ee 3d ea f4 03 75 90 01 01 8b 45 90 01 01 31 45 90 01 01 33 75 90 01 01 81 3d 90 02 04 13 02 00 00 75 90 00 } //1
