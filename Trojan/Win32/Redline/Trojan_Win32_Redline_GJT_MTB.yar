...
rule Trojan_Win32_Redline_GJT_MTB{
	...
	strings :
		...
		$a_03_1 = {d1 f8 0f b6 8d ?? ?? ?? ?? c1 e1 07 0b c1 88 85 ?? ?? ?? ?? 0f b6 95 ?? ?? ?? ?? f7 da } //10
	condition:
...
rule Trojan_Win32_Redline_GJT_MTB_2{
	...
	strings :
		$a_03_0 = {89 e8 31 d2 83 ec 04 f7 74 24 3c c1 ea ?? 0f be 0c 16 69 c9 ?? ?? ?? ?? 89 c8 f7 ef 01 ca c1 f9 ?? c1 fa ?? 29 ca 8d 04 92 8d 14 42 30 14 2b 83 c5 ?? 39 6c 24 } //10
