...
rule Trojan_Win32_Redline_GLB_MTB{
	meta:
		description = "Trojan:Win32/Redline.GLB!MTB,SIGNATURE_TYPE_PEHSTR_EXT,0b 00 0b 00 02 00 00 0a 00 "
		
	strings :
		$a_03_0 = {8b c6 83 c4 0c 83 e0 03 8a 80 90 01 04 30 86 90 01 04 46 81 fe 90 01 04 72 90 00 } //01 00 
