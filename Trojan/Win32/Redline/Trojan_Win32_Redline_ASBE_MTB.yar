...
rule Trojan_Win32_Redline_ASBE_MTB{
	...
	strings :
		$a_03_0 = {ff 80 34 1e 90 01 01 6a 6f 68 90 01 04 e8 90 01 04 80 04 1e 90 01 01 6a 6f 68 90 01 04 e8 90 01 04 80 04 1e 90 01 01 83 c4 90 01 01 46 3b f7 0f 82 90 00 } //1
		$a_03_1 = {83 c4 08 8b 55 08 03 55 fc 0f b6 02 83 f0 90 01 01 8b 4d 08 03 4d fc 88 01 6a 6f 68 90 00 } //1
...
rule Trojan_Win32_Redline_ASBE_MTB_2{
	...
	strings :
		$a_03_0 = {01 f8 03 70 0c 8d 85 90 02 04 89 34 24 89 54 24 04 89 4c 24 08 89 44 24 0c ff 15 90 00 } //4
