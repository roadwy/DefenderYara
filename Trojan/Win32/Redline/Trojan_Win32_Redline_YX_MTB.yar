...
rule Trojan_Win32_Redline_YX_MTB{
	meta:
		description = "Trojan:Win32/Redline.YX!MTB,SIGNATURE_TYPE_PEHSTR_EXT,0b 00 0b 00 02 00 00 0a 00 "
		
	strings :
		$a_03_0 = {51 33 cb 59 8b c8 83 e1 03 8a 89 90 01 04 30 0c 30 40 3b c2 72 e9 5e c3 90 00 } //01 00 
