...
rule Trojan_Win32_Redline_GBT_MTB{
	meta:
		description = "Trojan:Win32/Redline.GBT!MTB,SIGNATURE_TYPE_PEHSTR_EXT,0b 00 0b 00 02 00 00 0a 00 "
		
	strings :
		$a_03_0 = {8b 75 dc 8b 5d d4 8b 7d d0 83 e7 03 8a 87 90 01 04 30 04 33 46 eb 90 00 } //01 00 
