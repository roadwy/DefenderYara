...
rule Trojan_Win32_Redline_GMA_MTB_2{
	...
	strings :
		$a_03_0 = {0f b6 45 db 03 45 dc 88 45 db 0f b6 4d db c1 f9 06 0f b6 55 db c1 e2 02 0b ca 88 4d db 0f b6 45 db 05 90 01 04 88 45 db 0f b6 4d db f7 d9 88 4d db 90 00 } //00 00 
	condition:
		any of ($a_*)
