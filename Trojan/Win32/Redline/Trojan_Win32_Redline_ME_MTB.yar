...
rule Trojan_Win32_Redline_ME_MTB_3{
	...
	strings :
		$a_01_0 = {73 61 6c 20 68 6f 63 69 68 61 6d 61 20 68 69 6e 6f 20 6a 69 6e 61 71 75 } //01 00 
		$a_01_1 = {74 69 71 75 6f 64 20 6b 69 64 6f } //01 00 
		$a_01_2 = {6b 6f 6e 61 66 20 73 61 71 75 6f 70 65 20 67 69 67 20 70 6f 62 65 6a 65 } //01 00 
		$a_01_3 = {56 69 72 74 75 61 6c 50 72 6f 74 65 63 74 } //01 00 
		$a_01_4 = {47 65 74 54 69 63 6b 43 6f 75 6e 74 } //01 00 
		$a_01_5 = {47 65 74 43 75 72 73 6f 72 49 6e 66 6f } //01 00 
		$a_01_6 = {68 00 6f 00 74 00 6b 00 65 00 79 00 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Redline_ME_MTB_4{
	...
	strings :
		...
		$a_01_1 = {55 6e 68 61 6e 64 6c 65 64 45 78 63 65 70 74 69 6f 6e 46 69 6c 74 65 72 } //01 00 
		$a_01_2 = {43 72 65 61 74 65 4d 61 69 6c 73 6c 6f 74 57 } //01 00 
		$a_01_3 = {47 65 74 43 50 49 6e 66 6f } //00 00 
	condition:
		any of ($a_*)
