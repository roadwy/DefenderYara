...
rule Trojan_Win32_Redline_GNB_MTB{
	...
	strings :
		$a_03_0 = {ff 80 34 3e 90 01 01 83 c4 28 46 3b 74 24 18 0f 82 90 00 } //10
	condition:
		((#a_03_0  & 1)*10) >=10
...
rule Trojan_Win32_Redline_GNB_MTB_2{
	...
	strings :
		$a_03_0 = {f7 e6 66 c1 df fa 66 81 ca cc 00 66 f7 e1 33 d8 81 ee 90 01 04 8b fe 66 0b db c1 e7 5a 03 d9 0f bf d2 8b c7 66 f7 e0 66 03 f0 42 90 00 } //10
	condition:
		((#a_03_0  & 1)*10) >=10
...
rule Trojan_Win32_Redline_GNB_MTB_3{
	...
	strings :
		$a_03_0 = {c1 e2 02 0b ca 88 4d 90 01 01 0f b6 45 90 01 01 f7 d0 88 45 90 01 01 0f b6 4d 90 01 01 81 c1 90 01 04 88 4d 90 01 01 0f b6 55 90 01 01 83 f2 90 01 01 88 55 90 00 } //10
	condition:
		((#a_03_0  & 1)*10) >=10
...
rule Trojan_Win32_Redline_GNB_MTB_4{
	...
	strings :
		$a_03_0 = {8b c8 83 e1 03 8a 89 90 01 04 30 88 90 01 04 40 3d 90 01 04 72 90 00 } //10
