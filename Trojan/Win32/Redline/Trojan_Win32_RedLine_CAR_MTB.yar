...
rule Trojan_Win32_RedLine_CAR_MTB{
	...
	strings :
		$a_03_0 = {8b 45 fc 99 b9 [0-04] f7 f9 8b 45 08 0f be 0c 10 83 e1 ?? 8b 55 0c 03 55 fc 0f b6 02 33 c1 8b 4d 0c 03 4d fc 88 01 eb } //5
	condition:
		((#a_03_0  & 1)*5) >=5
...
rule Trojan_Win32_RedLine_CAR_MTB_2{
	...
	strings :
		$a_03_0 = {03 55 f8 8a 02 88 45 fe 0f b6 4d fe 8b 45 f8 33 d2 f7 75 10 0f b6 92 [0-04] 33 ca 88 4d ff 8b 45 08 03 45 f8 8a 08 88 4d fd } //3
