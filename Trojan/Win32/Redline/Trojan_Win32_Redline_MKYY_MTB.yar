...
rule Trojan_Win32_Redline_MKYY_MTB{
	...
	strings :
		$a_03_0 = {8b 4d f8 83 25 90 01 05 8d 14 01 8b c8 c1 e1 90 01 01 03 4d 90 01 01 c1 e8 90 01 01 33 ca 03 c3 33 c1 89 55 90 01 01 89 4d 90 01 01 89 45 90 01 01 8b 45 90 01 01 01 05 90 00 } //1
