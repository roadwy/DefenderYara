...
rule Trojan_Win32_Redline_GEB_MTB{
	meta:
		description = "Trojan:Win32/Redline.GEB!MTB,SIGNATURE_TYPE_PEHSTR_EXT,0b 00 0b 00 02 00 00 0a 00 "
		
	strings :
		$a_03_0 = {83 e0 03 8a 98 90 01 04 32 1c 2e e8 90 01 04 8b f8 8b 0f 8b 49 90 01 01 8b 4c 39 90 01 01 8b 49 90 01 01 89 4c 24 90 01 01 8b 11 ff 52 90 00 } //01 00 
