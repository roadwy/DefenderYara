...
rule Trojan_Win32_Redline_GHL_MTB{
	meta:
		description = "Trojan:Win32/Redline.GHL!MTB,SIGNATURE_TYPE_PEHSTR_EXT,0b 00 0b 00 02 00 00 0a 00 "
		
	strings :
		$a_03_0 = {8b cb 8b c1 83 e0 03 8a 80 90 01 04 30 81 90 01 04 41 81 f9 90 01 04 72 90 00 } //01 00 
