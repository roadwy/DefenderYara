...
rule Trojan_Win32_RedLine_T_MTB{
	...
	strings :
		$a_03_0 = {29 f9 29 ce 81 c1 90 01 04 89 85 90 01 04 c1 e9 02 f3 a5 89 de 83 c3 01 c7 04 24 00 e0 52 00 89 5c 24 04 83 e6 03 e8 90 01 04 0f b6 86 90 01 04 30 83 90 01 04 81 fb 00 ac 01 00 75 d3 90 00 } //10
