...
rule Trojan_Win32_Redline_GEF_MTB{
	...
	strings :
		$a_03_0 = {8a 3c 3e 8b c6 83 e0 03 ba 90 01 04 8a 98 90 01 04 32 df e8 90 01 04 8b f8 8b 0f 8b 49 90 01 01 8b 4c 39 90 01 01 8b 49 90 01 01 89 4c 24 90 00 } //10
