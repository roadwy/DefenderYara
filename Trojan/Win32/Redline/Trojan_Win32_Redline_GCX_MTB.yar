...
rule Trojan_Win32_Redline_GCX_MTB_2{
	...
	strings :
		$a_03_0 = {0f b6 4d bf 8b 45 c0 33 d2 be 90 01 04 f7 f6 0f b6 92 90 01 04 33 ca 88 4d c7 8b 45 c0 8a 88 90 01 04 88 4d be 0f b6 55 c7 8b 45 c0 0f b6 88 90 01 04 03 ca 8b 55 c0 88 8a 90 00 } //10
	condition:
		((#a_03_0  & 1)*10) >=10
