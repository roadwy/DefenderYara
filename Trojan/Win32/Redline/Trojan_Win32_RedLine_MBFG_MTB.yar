...
rule Trojan_Win32_RedLine_MBFG_MTB{
	...
	strings :
		...
		$a_01_1 = {66 6f 64 61 6a 69 7a 69 74 69 66 75 76 75 68 61 63 69 6c 75 76 65 73 69 67 69 7a 6f 6d 6f 20 6d 69 77 75 64 6f 78 69 70 65 64 6f 67 61 70 6f } //00 00  fodajizitifuvuhaciluvesigizomo miwudoxipedogapo
	condition:
		any of ($a_*)
