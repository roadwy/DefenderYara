...
rule Trojan_Win32_Redline_GCR_MTB{
	meta:
		description = "Trojan:Win32/Redline.GCR!MTB,SIGNATURE_TYPE_PEHSTR_EXT,0b 00 0b 00 02 00 00 0a 00 "
		
	strings :
		$a_03_0 = {31 c0 29 c8 88 45 e3 8b 4d e4 0f b6 45 e3 31 c8 88 45 e3 0f b6 45 e3 2d 90 01 04 88 45 e3 8a 4d e3 8b 45 e4 88 4c 05 e9 8b 45 e4 83 c0 90 01 01 89 45 e4 90 00 } //01 00 
