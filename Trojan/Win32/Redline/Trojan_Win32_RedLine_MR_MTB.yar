...
rule Trojan_Win32_RedLine_MR_MTB{
	...
	strings :
		$a_01_0 = {53 6f 20 47 6f 30 64 20 68 43 4b 4a 62 31 34 20 78 68 56 67 73 35 37 } //05 00 
		...
		$a_01_3 = {57 61 69 74 46 6f 72 53 69 6e 67 6c 65 4f 62 6a 65 63 74 45 78 } //02 00 
		$a_01_4 = {47 65 74 43 50 49 6e 66 6f } //00 00 
	condition:
		any of ($a_*)
