...
rule Trojan_Win32_Cadlotcorg_A_dha{
	...
	strings :
		...
		$a_01_2 = {43 3a 5c 50 72 6f 67 72 61 6d 44 61 74 61 5c 4c 6f 67 2e 74 78 74 } //01 00 
		$a_01_3 = {58 3a 5c 00 58 3a 5c 00 53 79 73 74 65 6d 44 72 69 76 65 00 } //00 00 
		$a_00_4 = {87 10 } //00 00 
	condition:
		any of ($a_*)
