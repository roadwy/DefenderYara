...
rule Trojan_Win32_Trickbot_CJ_MTB{
	...
	strings :
		$a_81_0 = {68 67 66 68 67 64 68 67 64 68 33 } //01 00  hgfhgdhgdh3
		$a_81_1 = {77 69 6e 70 65 2e 65 78 65 } //01 00  winpe.exe
		$a_81_2 = {68 67 66 68 67 64 68 67 64 68 31 } //01 00  hgfhgdhgdh1
		$a_81_3 = {29 6a 51 58 3f 30 4b 6d 23 6b 4f 30 72 61 47 24 40 63 24 26 41 50 56 44 3c 52 4f 4f 53 72 31 68 6a 24 43 43 44 40 6c 32 23 66 59 3c 3e 65 35 3f 43 4e 61 44 } //01 00  )jQX?0Km#kO0raG$@c$&APVD<ROOSr1hj$CCD@l2#fY<>e5?CNaD
		$a_81_4 = {30 30 33 77 6e 74 63 7a 4d 47 63 6c 46 48 78 21 42 23 6b 4d 69 2b 69 } //00 00  003wntczMGclFHx!B#kMi+i
	condition:
		any of ($a_*)
