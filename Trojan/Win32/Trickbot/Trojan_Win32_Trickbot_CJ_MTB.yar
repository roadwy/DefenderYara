...
rule Trojan_Win32_Trickbot_CJ_MTB_2{
	...
	strings :
		$a_03_0 = {8b 45 08 03 45 90 01 01 8a 4d 90 01 01 88 08 8b 45 90 01 01 33 d2 f7 75 90 01 01 8b 45 90 01 01 03 45 90 01 01 8b 4d 90 01 01 8a 14 11 88 10 90 00 } //1
		$a_03_1 = {03 d0 8b 0d 90 01 04 0f af 0d 90 01 04 03 d1 a1 90 01 04 0f af 05 90 01 04 03 d0 8b 0d 90 01 04 0f af 0d 90 01 04 03 d1 a1 90 01 04 0f af 05 90 01 04 03 d0 8b 0d 90 01 04 0f af 0d 90 01 04 03 4d 08 8a 45 fc 88 04 11 e9 90 00 } //1
	condition:
