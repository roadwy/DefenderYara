...
rule Trojan_Win32_TrickBot_I{
	...
	strings :
		$a_03_0 = {8b 45 0c 83 c0 0c c6 80 90 01 04 00 8b 45 0c 90 02 03 89 45 90 01 01 eb 90 01 01 8b 45 90 01 01 83 c0 0c c6 80 90 01 04 01 90 02 04 83 7d 90 01 02 90 02 07 c7 45 90 01 01 00 00 00 00 c7 45 90 01 01 4c 00 00 00 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
