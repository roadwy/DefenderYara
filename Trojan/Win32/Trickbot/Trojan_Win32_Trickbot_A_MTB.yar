...
rule Trojan_Win32_Trickbot_A_MTB{
	...
	strings :
		...
		$a_02_2 = {8b c1 33 d2 f7 f7 41 8a 82 90 01 03 00 30 44 31 ff 81 f9 90 01 02 00 00 75 e7 eb 90 00 } //1
	condition:
...
rule Trojan_Win32_Trickbot_A_MTB_2{
	...
	strings :
		$a_02_0 = {8b 45 fc 83 c0 01 89 45 fc 8b 4d fc 3b 4d 10 74 90 01 01 8b 55 08 52 e8 90 01 04 83 c4 04 8b c8 8b 45 fc 33 d2 f7 f1 8b 45 0c 03 45 fc 8b 4d 08 8a 00 32 04 11 8b 4d 0c 03 4d fc 88 01 eb 90 00 } //2
		$a_02_1 = {57 8b ec 8b c7 05 90 01 04 68 f0 ff 00 00 89 45 04 59 8b d7 8b f7 8b c1 66 ad 85 c0 74 90 00 } //1
