...
rule Trojan_Win32_Trickbot_A_MTB{
	...
	strings :
		$a_00_0 = {43 00 3a 00 5c 00 50 00 72 00 6f 00 67 00 72 00 61 00 6d 00 44 00 61 00 74 00 61 00 5c 00 } //01 00  C:\ProgramData\
		$a_00_1 = {6b 00 6c 00 59 00 4b 00 41 00 6e 00 4d 00 2e 00 65 00 78 00 65 00 } //01 00  klYKAnM.exe
