...
rule Trojan_Win32_TrickBot_GQ_MTB_2{
	...
	strings :
		...
		$a_81_1 = {5c 44 4c 4c 50 4f 52 54 41 42 4c 45 58 38 36 5c 33 32 5c 52 65 6c 65 61 73 65 5c 64 6c 6c 33 32 73 6d 70 6c 2e 70 64 62 } //01 00  \DLLPORTABLEX86\32\Release\dll32smpl.pdb
		$a_81_2 = {44 6c 6c 52 65 67 69 73 74 65 72 53 65 72 76 65 72 } //01 00  DllRegisterServer
		$a_81_3 = {4b 72 61 73 49 6f 64 57 } //01 00  KrasIodW
		$a_81_4 = {61 73 73 62 31 } //01 00  assb1
		$a_81_5 = {69 6d 69 74 34 } //01 00  imit4
		$a_81_6 = {6c 74 72 69 64 70 } //01 00  ltridp
