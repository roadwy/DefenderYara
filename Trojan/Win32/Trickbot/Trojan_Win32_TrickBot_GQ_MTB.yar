...
rule Trojan_Win32_TrickBot_GQ_MTB{
	...
	strings :
		$a_02_0 = {61 00 66 c7 90 02 02 73 00 66 c7 90 02 02 77 00 66 c7 90 02 02 68 00 66 c7 90 02 02 6f 00 66 c7 90 02 02 6f 00 66 c7 90 02 02 6b 00 66 c7 90 02 02 2e 00 66 c7 90 02 02 64 00 66 c7 90 02 02 6c 00 66 c7 90 02 02 6c 00 90 00 } //1
		$a_02_1 = {33 d2 5b 8d 0c 90 02 02 8b 90 02 02 f7 90 02 02 8b 44 90 02 02 8a 90 02 02 30 01 46 3b 74 90 00 } //1
	condition:
