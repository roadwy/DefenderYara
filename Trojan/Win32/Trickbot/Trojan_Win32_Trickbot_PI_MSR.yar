...
rule Trojan_Win32_Trickbot_PI_MSR{
	...
	strings :
		$a_01_0 = {46 00 75 00 63 00 6b 00 20 00 53 00 6f 00 70 00 68 00 6f 00 73 00 } //01 00  Fuck Sophos
		$a_01_1 = {5c 43 75 73 74 6f 6d 54 6f 6f 6c 54 69 70 50 6c 75 73 44 65 6d 6f 2e 70 64 62 } //00 00  \CustomToolTipPlusDemo.pdb
	condition:
		any of ($a_*)
