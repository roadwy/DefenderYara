...
rule Trojan_Win32_Trickbot_CM_MTB{
	...
	strings :
		$a_00_0 = {32 5c 64 6c 6c 5c 52 65 6c 65 61 73 65 5c 54 65 73 74 30 31 2e 70 64 62 } //01 00  2\dll\Release\Test01.pdb
		$a_81_1 = {31 2e 64 6c 6c } //01 00  1.dll
		$a_81_2 = {44 70 69 38 30 30 } //01 00  Dpi800
		$a_81_3 = {47 65 74 4d 6f 75 73 65 } //01 00  GetMouse
		$a_81_4 = {5b 20 47 4f 4f 44 20 5d } //01 00  [ GOOD ]
