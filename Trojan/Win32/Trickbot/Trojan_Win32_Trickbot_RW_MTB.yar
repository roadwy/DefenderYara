...
rule Trojan_Win32_Trickbot_RW_MTB_2{
	...
	strings :
		$a_01_0 = {5e 32 3f 53 6e 72 77 6b 5a 53 7a 70 75 50 49 } //0a 00  ^2?SnrwkZSzpuPI
		$a_01_1 = {46 75 63 6b 20 44 65 66 } //01 00  Fuck Def
		...
		$a_01_5 = {47 65 74 4d 6f 6e 69 74 6f 72 49 6e 66 6f 41 } //00 00  GetMonitorInfoA
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Trickbot_RW_MTB_3{
	...
	strings :
		...
		$a_81_1 = {23 61 29 46 26 53 50 66 63 45 67 72 47 74 46 63 34 74 72 6a 79 35 4a 73 35 37 21 77 4d 41 6c 73 4c 3f 30 64 6c 4a 41 47 35 3e 62 53 47 72 62 4b 37 40 75 33 73 61 58 6c 6c 74 65 51 31 5e 2a 71 6a 57 2a 35 48 7a 26 44 56 50 50 69 } //00 00  #a)F&SPfcEgrGtFc4trjy5Js57!wMAlsL?0dlJAG5>bSGrbK7@u3saXllteQ1^*qjW*5Hz&DVPPi
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Trickbot_RW_MTB_5{
	...
	strings :
		...
		$a_01_1 = {5f 7a 31 4c 42 75 64 58 56 63 7a 3c 67 54 62 } //01 00  _z1LBudXVcz<gTb
		$a_01_2 = {73 35 56 4d 3f 39 44 40 52 71 21 21 73 55 5a } //01 00  s5VM?9D@Rq!!sUZ
		$a_01_3 = {6d 73 75 79 44 43 59 6a 46 26 49 51 34 45 59 } //01 00  msuyDCYjF&IQ4EY
		$a_01_4 = {42 72 78 75 5f 6c 61 44 26 51 68 65 39 53 6f } //01 00  Brxu_laD&Qhe9So
		$a_01_5 = {72 44 6c 3c 4f 6c 76 4e 72 78 77 30 6e 35 32 } //01 00  rDl<OlvNrxw0n52
		$a_01_6 = {34 6c 32 61 25 38 58 7a 65 4f 62 38 56 47 28 } //00 00  4l2a%8XzeOb8VG(
	condition:
		any of ($a_*)
