...
rule Trojan_Win32_Trickbot_RW_MTB{
	...
	strings :
		$a_03_0 = {03 c1 8b 4d 90 01 01 8b 09 8a 0c 39 02 0d 90 01 04 30 08 8b 0d 90 01 04 0f af 0d 90 01 04 8b 35 90 01 04 ff 45 90 01 01 8b c6 2b c1 6b c0 70 03 45 90 01 01 39 45 90 01 01 0f 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_Win32_Trickbot_RW_MTB_3{
	...
	strings :
		$a_03_0 = {33 d2 03 c6 f7 f7 8b f2 8a 04 2e 88 01 8b 44 24 90 01 01 88 1c 2e 8b 3d 90 01 04 40 41 3b c7 89 44 24 18 72 90 00 } //1
...
rule Trojan_Win32_Trickbot_RW_MTB_4{
	...
	strings :
		$a_03_0 = {33 d2 f7 35 90 01 04 a1 90 01 04 8d 04 80 2b d0 03 d5 8b 2d 90 01 04 03 d5 8b 6c 24 90 01 01 8a 14 0a 8a 45 90 01 01 32 c2 43 88 45 90 01 01 8b 44 24 90 01 01 3b d8 0f 90 00 } //1
...
rule Trojan_Win32_Trickbot_RW_MTB_5{
	...
	strings :
		$a_02_0 = {c1 e9 02 8d b8 90 01 04 b8 01 01 01 01 f3 ab 8b ca 83 e1 03 f3 aa 8b 4c 24 90 01 01 8b 54 24 90 01 01 8d 44 24 90 01 01 50 53 51 6a 90 01 01 68 90 01 04 52 89 5c 24 90 01 01 ff 54 24 90 01 01 85 c0 75 90 01 01 5f 5e 5d 32 c0 90 00 } //5
