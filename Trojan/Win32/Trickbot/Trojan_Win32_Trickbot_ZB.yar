...
rule Trojan_Win32_Trickbot_ZB{
	...
	strings :
		$a_01_0 = {47 72 61 62 62 65 72 20 61 74 74 65 6d 70 74 2e } //02 00 
		$a_01_1 = {43 6f 75 6c 64 20 6e 6f 74 20 67 61 74 68 65 72 20 62 72 6f 77 73 65 72 20 64 61 74 61 } //02 00 
		$a_01_2 = {67 72 61 62 62 65 72 5f 74 65 6d 70 2e 65 64 62 } //03 00 
