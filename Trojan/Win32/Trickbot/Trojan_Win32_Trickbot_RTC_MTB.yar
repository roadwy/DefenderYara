...
rule Trojan_Win32_Trickbot_RTC_MTB{
	...
	strings :
		...
		$a_01_1 = {66 6f 72 74 69 20 61 6e 74 69 76 69 72 75 73 20 73 74 75 70 69 64 20 70 72 6f 74 65 63 74 69 6f 6e } //05 00 
		$a_01_2 = {26 54 37 37 34 61 29 77 25 2a 4b 50 6a 39 53 } //05 00 
		$a_01_3 = {6d 73 75 79 44 43 59 6a 46 26 49 51 34 45 59 } //00 00 
	condition:
		any of ($a_*)
