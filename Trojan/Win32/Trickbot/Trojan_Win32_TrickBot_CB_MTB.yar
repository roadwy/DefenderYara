...
rule Trojan_Win32_TrickBot_CB_MTB{
	...
	strings :
		$a_02_0 = {03 c6 51 03 de 89 44 24 2c e8 90 01 04 83 c4 04 50 e8 90 01 04 8a 08 83 c4 0c 33 d2 84 c9 74 90 01 01 8d 64 24 00 8b ea c1 e5 13 c1 ea 0d 0b d5 80 f9 61 0f b6 c9 72 90 01 01 83 e9 20 03 d1 8a 48 01 40 84 c9 75 90 01 01 81 fa 90 00 } //1
	condition:
		((#a_02_0  & 1)*1) >=1
...
rule Trojan_Win32_TrickBot_CB_MTB_2{
	...
	strings :
		$a_02_0 = {8a 0a 84 c9 74 90 01 01 56 8b f0 c1 e6 13 c1 e8 0d 0b c6 80 f9 61 72 90 01 01 81 e1 ff 00 00 00 83 e9 20 eb 90 01 01 81 e1 ff 00 00 00 03 c1 8a 4a 01 42 84 c9 75 90 00 } //2
