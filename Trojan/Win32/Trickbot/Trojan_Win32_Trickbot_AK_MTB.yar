...
rule Trojan_Win32_Trickbot_AK_MTB_2{
	...
	strings :
		$a_81_0 = {2f 25 73 2f 25 73 2f 35 2f 25 73 2f } //01 00  /%s/%s/5/%s/
		$a_81_1 = {2f 35 2f 73 70 6b 2f } //01 00  /5/spk/
		$a_81_2 = {70 77 67 72 61 62 } //01 00  pwgrab
		$a_81_3 = {6d 63 63 6f 6e 66 } //01 00  mcconf
		$a_81_4 = {61 75 74 6f 72 75 6e } //01 00  autorun
		$a_81_5 = {2f 73 72 76 } //01 00  /srv
		$a_81_6 = {31 38 36 2e 37 31 2e 31 35 30 2e 32 33 } //00 00  186.71.150.23
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Trickbot_AK_MTB_3{
	...
	strings :
		$a_81_0 = {70 77 67 72 61 62 } //01 00  pwgrab
		$a_81_1 = {2f 25 73 2f 25 73 2f 35 2f 25 73 2f } //01 00  /%s/%s/5/%s/
		$a_81_2 = {2f 35 2f 73 70 6b 2f } //01 00  /5/spk/
		$a_81_3 = {6d 63 63 6f 6e 66 } //01 00  mcconf
		$a_81_4 = {61 75 74 6f 72 75 6e } //01 00  autorun
		$a_81_5 = {31 38 36 2e 37 31 2e 31 35 30 2e 32 33 } //00 00  186.71.150.23
	condition:
		any of ($a_*)
