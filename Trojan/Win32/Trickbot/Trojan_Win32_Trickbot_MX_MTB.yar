...
rule Trojan_Win32_Trickbot_MX_MTB{
	...
	strings :
		$a_02_0 = {8a 03 83 c4 0c 8a 54 14 ?? 32 c2 88 03 43 4d } //1
	condition:
		((#a_02_0  & 1)*1) >=1
...
rule Trojan_Win32_Trickbot_MX_MTB_2{
	...
	strings :
		$a_02_0 = {99 b9 42 1a 00 00 f7 f9 0f b6 94 15 ?? ?? ?? ?? 30 53 ff 83 7d 0c 00 } //1
	condition:
		((#a_02_0  & 1)*1) >=1
...
rule Trojan_Win32_Trickbot_MX_MTB_3{
	...
	strings :
		$a_02_0 = {99 f7 f9 8b 45 ?? 8a 8c 15 ?? ?? ?? ?? 30 08 40 ff 4d 0c 89 45 } //1
	condition:
		((#a_02_0  & 1)*1) >=1
...
rule Trojan_Win32_Trickbot_MX_MTB_4{
	...
	strings :
		$a_02_0 = {f7 f9 8b 85 ?? ?? ?? ?? 40 83 c4 04 89 85 ?? ?? ?? ?? 0f b6 94 15 ?? ?? ?? ?? 30 50 ff 83 bd ?? ?? ?? ?? 00 75 } //1
	condition:
		((#a_02_0  & 1)*1) >=1
...
rule Trojan_Win32_Trickbot_MX_MTB_5{
	...
	strings :
		$a_02_0 = {f7 f9 8b 44 24 ?? 8a 18 83 c4 0c 8a 54 14 ?? 32 da 88 18 40 89 44 24 ?? ff 4c 24 ?? 0f 85 } //1
	condition:
		((#a_02_0  & 1)*1) >=1
...
rule Trojan_Win32_Trickbot_MX_MTB_6{
	...
	strings :
		$a_02_0 = {03 c1 99 b9 55 02 00 00 f7 f9 8b 44 24 ?? 40 83 c4 38 89 44 24 ?? 0f b6 54 14 ?? 30 50 ff 83 bc 24 84 02 00 00 00 } //1
	condition:
		((#a_02_0  & 1)*1) >=1
...
rule Trojan_Win32_Trickbot_MX_MTB_7{
	...
	strings :
		$a_02_0 = {f7 f9 8a 03 83 c4 0c 8a 54 14 ?? 32 c2 88 03 43 4d } //1
...
rule Trojan_Win32_Trickbot_MX_MTB_8{
	...
	strings :
		$a_02_0 = {52 53 6a 01 53 50 ff 15 ?? ?? ?? ?? 85 c0 5b 0f 95 c0 } //1
		$a_02_1 = {33 c0 3b f3 7e ?? 8b 4c 24 ?? 8d 4c 31 ?? ?? 8a 11 88 ?? ?? ?? ?? ?? 83 c0 01 83 e9 01 3b c6 } //1
	condition:
...
rule Trojan_Win32_Trickbot_MX_MTB_9{
	...
	strings :
		$a_02_0 = {f7 f9 8b 85 ?? ?? ?? ?? 8d 7f 01 8a 8c 15 ?? ?? ?? ?? 30 4f ff 4e } //1
...
rule Trojan_Win32_Trickbot_MX_MTB_10{
	...
	strings :
		$a_02_0 = {99 f7 f9 8b 85 ?? ?? ?? ?? 8a 8c 15 ?? ?? ?? ?? 30 4f ff 4e 0f 85 } //1
...
rule Trojan_Win32_Trickbot_MX_MTB_11{
	...
	strings :
		$a_02_0 = {8b 0f 83 c3 01 0f 80 ?? ?? ?? ?? 8b 51 0c 88 04 2a 8b 44 24 10 3b d8 } //1
		$a_02_1 = {6a 40 8b b4 24 4c 01 00 00 56 50 e8 ?? ?? ?? ?? 8b 4c 24 ?? 81 e1 ff ff 00 00 81 f9 4d 5a 00 00 } //1
	condition:
		((#a_02_0  & 1)*1+(#a_02_1  & 1)*1) >=2
...
rule Trojan_Win32_Trickbot_MX_MTB_12{
	...
	strings :
		...
		$a_02_1 = {f7 f9 0f b6 94 15 ?? ?? ?? ?? 30 53 ff 83 7d ?? 00 75 } //1
	condition:
...
rule Trojan_Win32_Trickbot_MX_MTB_13{
	...
	strings :
		$a_02_0 = {83 c4 2c 8a 8c 15 ?? ?? ?? ?? 30 08 40 83 7d 10 00 89 85 ?? ?? ?? ?? 0f 85 } //1
...
rule Trojan_Win32_Trickbot_MX_MTB_14{
	...
	strings :
		$a_02_0 = {99 f7 f9 8b 85 ?? ?? ?? ?? 8a 8c 15 ?? ?? ?? ?? 30 4e ff 8b 8d ?? ?? ?? ?? 4f 75 } //1
...
rule Trojan_Win32_Trickbot_MX_MTB_15{
	...
	strings :
		$a_02_0 = {b9 9a 1e 00 00 f7 f9 8b 85 ?? ?? ?? ?? 8a 8c 15 ?? ?? ?? ?? 30 08 40 89 85 ?? ?? ?? ?? 8b 85 ?? ?? ?? ?? 4f } //1
...
rule Trojan_Win32_Trickbot_MX_MTB_16{
	...
	strings :
		$a_02_0 = {f7 f9 8b 44 24 ?? 83 c0 01 89 44 24 ?? 8a 54 14 ?? 30 50 ff 83 bc 24 ?? ?? 00 00 00 0f 85 } //1
