...
rule Trojan_Win32_Trickbot_AT{
	...
	strings :
		$a_03_0 = {0c 41 41 41 41 90 09 1c 00 81 ?? 41 41 41 41 75 ?? 81 ?? 04 41 41 41 41 75 ?? 81 ?? 08 41 41 41 41 75 } //1
		$a_03_1 = {55 41 56 56 57 53 48 83 ec [0-80] 8b ?? 48 ?? 8b ?? 40 ?? 8b ?? 38 ?? 8b ?? 30 ?? 8b ?? 28 ?? 8b ?? 20 ?? 8b ?? 10 ?? 8b ?? 18 } //1
		...
		$a_03_5 = {6a 00 e2 fc 48 8b ?? ?? 48 8b ?? 48 05 ?? ?? ?? ?? 48 89 ?? ?? ?? 48 89 ?? ?? 48 89 ?? ?? 48 c7 ?? ?? ff 00 00 } //2
