...
rule Trojan_Win32_TrickBot_R_MTB{
	meta:
		description = "Trojan:Win32/TrickBot.R!MTB,SIGNATURE_TYPE_PEHSTR_EXT,01 00 01 00 01 00 00 01 00 "
		
	strings :
		$a_02_0 = {eb 09 8b 45 90 01 01 83 c0 01 89 45 90 01 01 8b 4d 90 01 01 3b 4d 10 74 4e 8b 55 08 89 55 90 01 01 8b 45 90 01 01 83 c0 01 89 45 90 01 01 8b 4d 90 01 01 8a 11 88 55 90 01 01 83 45 90 01 01 01 80 7d 90 01 01 00 75 ee 8b 45 90 01 01 2b 45 90 01 01 89 45 ec 8b 45 90 01 01 33 d2 f7 75 ec 8b 4d 08 0f be 14 11 8b 45 0c 03 45 90 01 01 0f b6 08 33 ca 8b 55 0c 03 55 90 01 01 88 0a eb a1 90 00 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win32_TrickBot_R_MTB_2{
	meta:
		description = "Trojan:Win32/TrickBot.R!MTB,SIGNATURE_TYPE_PEHSTR,03 00 03 00 02 00 00 01 00 "
		
	strings :
		$a_01_0 = {b8 db 4b 68 2f f7 e1 8b c1 2b c2 d1 e8 03 c2 c1 e8 04 6b c0 1b 8b d1 2b d0 8a 04 1a 30 04 31 83 c1 01 3b cf 75 } //02 00 
		$a_01_1 = {83 ee 08 8b da 8b ce d3 fb 83 c7 01 85 f6 88 5c 07 ff 75 ec 8b 4c 24 18 83 c5 04 83 e9 01 89 4c 24 18 0f 85 } //00 00 
	condition:
		any of ($a_*)
