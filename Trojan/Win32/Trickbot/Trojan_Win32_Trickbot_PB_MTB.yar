...
rule Trojan_Win32_Trickbot_PB_MTB{
	...
	strings :
		$a_00_0 = {54 72 39 6a 6e 58 79 35 52 23 4b 7b 71 7a 6b } //01 00  Tr9jnXy5R#K{qzk
		$a_00_1 = {64 75 7a 24 45 23 6b 51 25 65 74 49 71 30 46 2a 39 55 4e 76 48 66 46 72 4d 51 } //01 00  duz$E#kQ%etIq0F*9UNvHfFrMQ
