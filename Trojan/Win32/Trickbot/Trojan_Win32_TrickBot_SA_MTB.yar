...
rule Trojan_Win32_TrickBot_SA_MTB{
	...
	strings :
		$a_03_0 = {8a 5c 8c 10 8b 74 bc 10 89 74 8c 10 0f b6 f3 89 74 bc 10 8b 5c 8c 10 03 de 81 e3 ff 00 00 80 79 ?? 4b 81 cb 00 ff ff ff 43 0f b6 5c 9c 10 30 1c 2a 42 3b d0 72 } //1
