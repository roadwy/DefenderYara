...
rule Trojan_Win32_Trickbot_KM_MTB{
	...
	strings :
		$a_02_0 = {f6 d2 f6 d1 0a d1 22 d3 83 c4 0c 88 10 40 ff 4d ?? 89 45 ?? 75 } //2
	condition:
		((#a_02_0  & 1)*2) >=2
...
rule Trojan_Win32_Trickbot_KM_MTB_2{
	...
	strings :
		$a_02_0 = {33 c0 3b fb 7e ?? 8b 54 24 ?? 8d 4c 3a ?? 8a 11 88 ?? ?? ?? ?? ?? 40 49 3b c7 7c ?? 8d 47 ?? 83 f8 3e 88 9f ?? ?? ?? ?? 7d } //1
