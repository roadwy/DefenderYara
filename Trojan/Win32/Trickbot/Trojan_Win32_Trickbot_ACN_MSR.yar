...
rule Trojan_Win32_Trickbot_ACN_MSR{
	...
	strings :
		...
		$a_00_1 = {63 61 6e 70 61 72 65 6e 74 2e 64 6c 6c } //01 00  canparent.dll
		$a_00_2 = {74 65 6d 70 6c 2e 64 6c 6c } //01 00  templ.dll
		$a_00_3 = {00 45 52 4e 45 4c 33 32 2e 64 6c 6c } //01 00  䔀乒䱅㈳搮汬
		$a_00_4 = {68 74 74 70 73 3a 2f 2f 77 77 77 2e 77 65 6e 74 73 70 65 6e 64 2e 72 75 2f } //00 00  https://www.wentspend.ru/
