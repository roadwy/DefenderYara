...
rule Trojan_Win32_Trickbot_GKM_MTB_19{
	...
	strings :
		...
		$a_00_1 = {71 62 77 43 2b 3c 46 24 7a 40 49 76 33 70 5f } //00 00  qbwC+<F$z@Iv3p_
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Trickbot_GKM_MTB_23{
	...
	strings :
		...
		$a_00_1 = {31 43 24 49 79 71 7a 48 2a 51 4d 39 76 48 4c } //00 00  1C$IyqzH*QM9vHL
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Trickbot_GKM_MTB_24{
	...
	strings :
		$a_02_0 = {33 c0 3b df 7e 90 01 01 8b 4c 24 90 01 01 8d 4c 19 90 01 01 8a 11 88 90 01 05 40 49 3b c3 7c 90 01 01 8d 43 90 01 01 c6 83 90 01 04 00 83 f8 3e 7d 90 00 } //01 00 
		$a_00_1 = {52 43 72 42 4b 63 6f 21 23 62 6f 44 4c 30 44 } //00 00  RCrBKco!#boDL0D
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Trickbot_GKM_MTB_28{
	...
	strings :
		...
		$a_00_1 = {45 46 6f 71 65 6b 6b 6b 42 43 65 67 41 72 62 67 72 6d 47 72 6d 67 74 47 47 6d 6b 61 } //00 00  EFoqekkkBCegArbgrmGrmgtGGmka
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Trickbot_GKM_MTB_29{
	...
	strings :
		...
		$a_00_2 = {48 24 49 3c 4a 52 45 4a 2b 77 31 23 4d 2b 48 } //00 00  H$I<JREJ+w1#M+H
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Trickbot_GKM_MTB_31{
	...
	strings :
		...
		$a_00_1 = {69 39 6a 32 31 3f 74 47 4f 56 29 52 77 41 70 } //00 00  i9j21?tGOV)RwAp
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Trickbot_GKM_MTB_33{
	...
	strings :
		...
		$a_00_2 = {53 74 75 70 69 64 20 77 69 6e 64 6f 77 73 20 64 65 66 65 6e 64 65 72 } //01 00  Stupid windows defender
		$a_00_3 = {61 6d 75 4e 78 45 63 6f 6c 6c 41 6c 61 75 74 72 69 56 } //00 00  amuNxEcollAlautriV
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Trickbot_GKM_MTB_34{
	...
	strings :
		$a_02_0 = {8a 04 33 f6 d0 8b ce 3b f7 73 90 01 01 eb 90 01 01 8d 49 00 8a d9 2a da 32 19 32 d8 88 19 03 4d 90 01 01 3b cf 72 90 01 01 8b 5d 90 01 01 46 ff 4d 90 01 01 75 90 00 } //01 00 
		$a_00_1 = {51 4d 53 56 4d 49 46 54 4f 49 54 41 4d 41 49 54 45 51 4a 42 4b 51 4e 47 53 50 48 56 56 51 43 4a 53 4b 47 4d 53 44 46 46 4a 48 4f 56 4a } //01 00  QMSVMIFTOITAMAITEQJBKQNGSPHVVQCJSKGMSDFFJHOVJ
		$a_00_2 = {4c 47 51 51 57 59 50 4a 42 54 47 45 53 46 51 54 58 55 4a 4b 4f 58 49 5a 59 44 49 56 44 4e 41 55 43 45 43 4f 4d 56 } //01 00  LGQQWYPJBTGESFQTXUJKOXIZYDIVDNAUCECOMV
		$a_00_3 = {66 61 71 78 73 7a 75 72 62 76 79 66 77 6f 63 77 6e 79 72 76 6c 73 62 70 75 68 78 62 68 74 66 61 63 79 61 7a 6e 72 70 74 73 6a 62 } //00 00  faqxszurbvyfwocwnyrvlsbpuhxbhtfacyaznrptsjb
	condition:
		any of ($a_*)
