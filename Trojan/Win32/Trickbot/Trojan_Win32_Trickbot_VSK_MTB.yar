...
rule Trojan_Win32_Trickbot_VSK_MTB_2{
	...
	strings :
		$a_01_0 = {69 48 5a 4c 43 76 79 58 74 44 73 4c 76 68 36 43 30 38 46 57 47 55 6e 71 4a 56 66 34 77 } //02 00  iHZLCvyXtDsLvh6C08FWGUnqJVf4w
		$a_01_1 = {69 67 52 4b 70 56 71 4a 66 42 65 6f 48 31 67 4d 41 76 53 72 44 55 44 35 6e 6f 37 66 45 73 } //02 00  igRKpVqJfBeoH1gMAvSrDUD5no7fEs
		$a_01_2 = {68 48 64 59 77 41 75 4b 6e 78 6f 6b 35 42 35 6e 72 43 70 59 52 30 4b 69 65 61 } //02 00  hHdYwAuKnxok5B5nrCpYR0Kiea
		$a_01_3 = {68 31 6f 54 6f 6e 35 44 75 42 37 76 65 78 46 74 46 31 72 63 54 38 37 31 } //02 00  h1oTon5DuB7vexFtF1rcT871
		$a_01_4 = {69 34 4a 56 52 45 72 4f 35 46 63 74 4d 56 65 4c 36 6b 66 32 61 67 43 42 59 36 4a 42 68 75 } //00 00  i4JVRErO5FctMVeL6kf2agCBY6JBhu
	condition:
		any of ($a_*)
