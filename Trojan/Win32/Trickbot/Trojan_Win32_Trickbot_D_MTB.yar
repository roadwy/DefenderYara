...
rule Trojan_Win32_Trickbot_D_MTB_2{
	...
	strings :
		$a_02_0 = {55 8b ec a1 90 01 03 00 03 05 90 01 03 00 0f b6 08 8b 15 90 01 03 00 03 15 90 01 03 00 0f b6 02 03 c1 8b 0d 90 01 03 00 03 0d 90 01 03 00 88 01 5d c3 90 00 } //1
