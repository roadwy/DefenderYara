...
rule Trojan_Win32_Trickbot_CL_MTB{
	...
	strings :
		$a_03_0 = {8b 55 08 03 55 fc 0f b6 02 03 45 f0 8b 4d f4 03 4d fc 0f be 11 03 c2 33 d2 f7 35 ?? ?? ?? ?? 89 55 f0 8b 45 08 03 45 fc 8a 08 88 4d fb 8b 55 08 03 55 fc 8b 45 08 03 45 f0 8a 08 88 0a 8b 55 08 03 55 f0 8a 45 fb 88 02 eb } //1
