...
rule Trojan_Win32_Trickbot_ARN_MSR{
	...
	strings :
		$a_02_0 = {3a 5c 55 73 65 72 73 5c 55 73 65 72 5c 44 65 73 6b 74 6f 70 5c 32 30 30 38 5c 43 4e 65 74 77 6f 72 6b 69 6e 90 02 14 5c 53 61 6d 70 6c 65 5c 52 65 6c 65 61 73 65 5c 43 4e 65 74 77 6f 72 6b 69 6e 67 2e 70 64 62 90 00 } //2
