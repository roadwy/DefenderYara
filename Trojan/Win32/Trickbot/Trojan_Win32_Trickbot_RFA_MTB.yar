...
rule Trojan_Win32_Trickbot_RFA_MTB{
	...
	strings :
		$a_02_0 = {33 c9 66 8b 0b 8d 3c 8a 8b 4c 24 90 01 01 8a 15 90 01 04 03 f8 8b 31 33 c9 03 f0 84 d2 74 90 01 01 8b ee 81 ed 90 01 04 8a 94 29 90 01 04 84 d2 74 90 00 } //1
