...
rule Trojan_Win32_TrickBot_DA_MTB{
	...
	strings :
		$a_03_0 = {8a d0 0a 44 24 90 01 01 f6 d2 f6 d1 0a d1 22 d0 8b 44 24 90 01 01 88 10 90 02 04 83 6c 24 90 01 01 01 89 44 24 90 01 01 0f 85 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_Win32_TrickBot_DA_MTB_2{
	...
	strings :
		$a_03_0 = {8b c1 51 b9 90 01 01 00 00 00 33 d2 f7 f1 59 8a 04 13 30 04 0e 41 3b f9 75 90 00 } //1
