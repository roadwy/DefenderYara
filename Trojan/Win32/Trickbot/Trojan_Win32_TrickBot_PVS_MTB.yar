...
rule Trojan_Win32_TrickBot_PVS_MTB{
	...
	strings :
		$a_02_0 = {8a 4c 24 10 8b 84 24 ?? ?? ?? ?? 02 d9 8a 14 06 81 e3 ff 00 00 00 8a 4c 1c 14 32 d1 88 14 06 8b 84 24 ?? ?? ?? ?? 46 3b f0 } //2
		$a_00_1 = {8b 55 10 89 54 9e 08 8b 5d fc 03 da 23 d8 8a 54 9e 08 32 51 06 ff 4d f8 88 57 06 } //2
		$a_02_2 = {69 c9 d6 2f 00 00 8b 5c 24 10 81 c5 e8 68 74 01 89 2d ?? ?? ?? ?? 03 ce 89 ac 1f 11 e2 ff ff 0f b7 c9 39 15 ?? ?? ?? ?? 90 09 06 00 8b 3d } //2
