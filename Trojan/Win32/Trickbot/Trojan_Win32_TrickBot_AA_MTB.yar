...
rule Trojan_Win32_Trickbot_AA_MTB{
	...
	strings :
		...
		$a_01_1 = {54 68 69 73 20 69 73 20 61 20 50 45 20 65 78 65 63 75 74 61 62 6c 65 } //00 00  This is a PE executable
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Trickbot_AA_MTB_2{
	...
	strings :
		...
		$a_00_1 = {8a 0c 32 8b 7c 24 1c 30 0c 38 40 3b 44 24 20 89 44 24 14 } //00 00 
	condition:
		any of ($a_*)
