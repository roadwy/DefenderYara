...
rule Trojan_Win32_Trickbot_C_MTB_2{
	...
	strings :
		...
		$a_01_2 = {4d 63 56 6a 64 30 6c 7c 65 50 78 43 50 67 2a 68 79 54 49 40 48 63 38 } //01 00  McVjd0l|ePxCPg*hyTI@Hc8
		$a_01_3 = {5a 7b 6f 38 6a 7b 49 58 58 63 30 63 40 33 71 } //01 00  Z{o8j{IXXc0c@3q
		$a_01_4 = {50 6c 61 79 65 72 2e 62 6d 70 } //00 00  Player.bmp
	condition:
		any of ($a_*)
