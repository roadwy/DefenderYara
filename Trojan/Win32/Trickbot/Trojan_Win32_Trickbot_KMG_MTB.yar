...
rule Trojan_Win32_Trickbot_KMG_MTB{
	...
	strings :
		$a_02_0 = {03 c6 99 f7 f9 0f b6 04 2b 8b f2 8a 14 2e 88 14 2b 88 04 2e 0f b6 0c 2e 0f b6 04 2b 03 c1 99 b9 90 01 04 f7 f9 90 00 } //1
	condition:
		((#a_02_0  & 1)*1) >=1
...
rule Trojan_Win32_Trickbot_KMG_MTB_2{
	...
	strings :
		$a_02_0 = {c0 ec 02 80 e4 0f 0a e1 8b 4c 24 90 01 01 88 64 24 90 01 01 88 44 24 90 01 01 88 47 90 01 01 0f b7 44 24 90 01 01 66 89 07 83 44 24 08 03 8b 44 24 90 01 01 40 e9 90 00 } //1
	condition:
		((#a_02_0  & 1)*1) >=1
...
rule Trojan_Win32_Trickbot_KMG_MTB_6{
	...
	strings :
		$a_02_0 = {50 c7 45 8c 00 01 00 00 c7 45 90 01 01 02 00 00 00 ff 15 90 01 04 8b d0 8d 4d 90 01 01 ff 15 90 01 04 8d 4d 90 01 01 51 ff 15 90 01 04 8b 56 90 01 01 8b 4e 90 01 01 2b d1 88 04 1a 8b 85 90 01 04 03 d8 e9 90 01 04 68 90 01 04 eb 90 00 } //1
	condition:
		((#a_02_0  & 1)*1) >=1
...
rule Trojan_Win32_Trickbot_KMG_MTB_7{
	...
	strings :
		$a_02_0 = {33 f6 3b fb 7e 90 01 01 8d 87 90 01 04 8a 08 88 8e 90 01 04 46 48 3b f7 7c 90 01 01 8d 47 90 01 01 83 f8 3e 88 9f 90 01 04 7d 90 00 } //1
...
rule Trojan_Win32_Trickbot_KMG_MTB_8{
	...
	strings :
		$a_02_0 = {33 c0 3b fb 7e 90 01 01 8b 54 24 90 01 01 8d 4c 3a 90 01 01 8b ff 8a 11 88 90 01 05 40 49 3b c7 7c 90 01 01 8d 47 01 83 f8 3e 88 9f 90 01 04 7d 90 00 } //1
