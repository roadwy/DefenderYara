...
rule Trojan_Win32_Trickbot_KMG_MTB_3{
	...
	strings :
		...
		$a_00_1 = {38 42 68 66 31 41 51 41 62 38 38 4d 40 72 77 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Trickbot_KMG_MTB_4{
	...
	strings :
		$a_02_0 = {33 c0 3b df 7e 90 01 01 8b 4c 24 90 01 01 8d 4c 19 90 01 01 8a 11 88 90 01 05 40 49 3b c3 7c 90 01 01 8d 43 01 c6 83 90 01 04 00 83 f8 3e 7d 90 00 } //01 00 
		$a_00_1 = {6f 64 71 40 29 64 35 56 30 66 25 52 31 26 50 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Trickbot_KMG_MTB_5{
	...
	strings :
		$a_02_0 = {33 c0 3b df 7e 90 01 01 8b 4c 24 90 01 01 8d 4c 19 90 01 01 8a 11 88 90 01 05 40 49 3b c3 7c 90 01 01 8d 43 01 c6 83 90 01 04 00 83 f8 3e 7d 90 00 } //01 00 
		$a_00_1 = {7a 31 3e 67 3e 61 55 66 51 2b 37 68 63 39 3e } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Trickbot_KMG_MTB_7{
	...
	strings :
		...
		$a_00_2 = {62 29 58 21 51 4d 42 4a 49 5f 78 54 41 76 4a } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Trickbot_KMG_MTB_8{
	...
	strings :
		...
		$a_00_1 = {23 6f 71 34 34 64 32 3f 45 31 41 56 31 30 6b } //01 00 
		$a_00_2 = {53 74 75 70 20 77 69 6e 64 6f 77 73 20 64 65 66 65 6e 64 65 72 20 68 61 68 61 68 } //00 00 
	condition:
		any of ($a_*)
