...
rule Trojan_Win32_TrickBot_RT_MTB_2{
	...
	strings :
		...
		$a_01_1 = {3f 6f 47 62 21 64 6f 24 50 62 23 2b 69 51 4a } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win32_TrickBot_RT_MTB_5{
	...
	strings :
		...
		$a_01_1 = {70 4d 32 77 74 30 62 34 31 34 21 6e 66 72 61 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win32_TrickBot_RT_MTB_6{
	...
	strings :
		...
		$a_81_1 = {51 67 3c 47 32 4f 6c 71 2b 25 78 61 48 79 53 6d 7a 57 6f 68 45 48 6b 65 29 42 2a 43 32 36 41 69 4b 28 50 4c 2a 62 38 33 30 36 43 40 3c 6f 30 38 50 31 72 30 7a 50 6a 50 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win32_TrickBot_RT_MTB_7{
	...
	strings :
		...
		$a_81_1 = {28 33 28 61 6e 39 31 58 70 37 70 4e 26 51 47 3c 66 4b 43 5e 48 74 42 26 74 73 69 37 72 4c 35 29 62 74 74 70 57 6a 44 6c 73 32 38 4a 64 59 28 4a 4e 76 45 69 53 61 57 62 72 51 55 5a 6b 54 38 4a 79 41 3c 48 62 46 5a 78 28 6a 4e 4b 4e 43 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win32_TrickBot_RT_MTB_9{
	...
	strings :
		$a_81_0 = {41 66 78 4f 6c 64 57 6e 64 50 72 6f 63 34 32 33 } //01 00 
		$a_81_1 = {68 74 74 70 3a 2f 2f 77 77 77 2e 78 78 78 2e 63 6f 6d 2f 31 2e 6a 70 67 } //01 00 
		$a_81_2 = {53 65 74 57 69 6e 64 6f 77 73 48 6f 6f 6b 45 78 41 } //01 00 
		$a_81_3 = {55 6e 68 6f 6f 6b 57 69 6e 64 6f 77 73 48 6f 6f 6b 45 78 } //01 00 
		$a_81_4 = {49 73 44 65 62 75 67 67 65 72 50 72 65 73 65 6e 74 } //01 00 
		$a_81_5 = {47 65 74 54 69 63 6b 43 6f 75 6e 74 } //01 00 
		$a_81_6 = {50 6f 73 74 4d 65 73 73 61 67 65 41 } //01 00 
		$a_81_7 = {47 65 74 53 79 73 74 65 6d 4d 65 74 72 69 63 73 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win32_TrickBot_RT_MTB_10{
	...
	strings :
		...
		$a_01_1 = {4f 3e 79 31 2a 56 74 3c 5f 79 58 50 2a 44 54 44 77 37 40 2a 32 3f 30 43 6d 2b 43 47 3e 40 36 6e 56 4d 6f 30 54 75 48 37 40 24 68 30 5a 21 46 74 3e 6f 69 47 47 47 51 74 28 2a 35 41 68 78 2a 71 } //01 00 
		$a_01_2 = {6e 68 57 58 29 72 4e 4c 6d 62 2a 37 23 50 39 2a 74 74 73 51 3f 23 6c 5a 53 64 4c 6d 38 34 39 4a 23 57 44 4c 35 49 53 57 70 73 70 35 31 54 3f 4b 68 34 31 58 56 6d 77 49 37 3c 36 72 4a 67 67 5f 28 5a 35 72 6b 44 48 45 49 5f 71 3c 64 5f 71 61 63 67 57 4b 4d 21 6f 52 3e } //00 00 
	condition:
		any of ($a_*)
