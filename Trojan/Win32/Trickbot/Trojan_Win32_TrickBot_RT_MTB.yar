...
rule Trojan_Win32_TrickBot_RT_MTB{
	...
	strings :
		$a_03_0 = {99 f7 f9 80 c2 64 85 f6 76 90 01 01 8b 45 90 01 01 8a 08 32 ca 02 ca 88 08 40 4e 75 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_Win32_TrickBot_RT_MTB_2{
	...
	strings :
		$a_02_0 = {33 c0 3b eb 7e 90 01 01 8b 54 24 90 01 01 8d 4c 2a 90 01 01 8a 11 88 90 01 05 40 49 3b c5 7c 90 01 01 8d 45 90 01 01 83 f8 3e 88 9d 90 01 04 7d 90 00 } //1
...
rule Trojan_Win32_TrickBot_RT_MTB_3{
	...
	strings :
		$a_03_0 = {32 04 0e 8b 0d 90 01 04 0f af 0d 90 01 04 8b 15 90 01 04 0f af 15 90 01 04 8b 35 90 01 04 0f af 35 90 01 04 8b 3d 90 01 04 0f af 3d 90 01 04 0f af 3d 90 01 04 8b 5d ec 2b df 90 00 } //1
...
rule Trojan_Win32_TrickBot_RT_MTB_4{
	...
	strings :
		$a_03_0 = {33 c0 8a 04 37 81 e1 ff 00 00 00 03 c1 f7 35 90 01 04 8b ea ff 15 90 01 04 85 c0 74 90 01 01 ff 15 90 01 04 8a 14 2e 8b 44 24 90 01 01 8b 6c 24 90 01 01 8a 0c 28 32 ca 88 0c 28 8b 4c 24 90 01 01 40 3b c1 89 44 24 90 01 01 72 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_Win32_TrickBot_RT_MTB_5{
	...
	strings :
		$a_02_0 = {c1 e9 02 f3 ab 8b ca 83 e1 03 f3 aa 8d 45 90 01 01 89 5d 90 01 01 50 53 ff 75 90 01 01 6a 4c 68 b8 51 47 00 ff 75 90 01 01 ff 55 90 01 01 85 c0 74 90 01 01 8b 45 90 01 01 ff 30 50 ff 75 90 01 01 53 6a 01 53 ff 75 90 01 01 ff 55 90 01 01 85 c0 0f 95 c0 eb 90 01 01 32 c0 90 00 } //1
...
rule Trojan_Win32_TrickBot_RT_MTB_6{
	...
	strings :
		$a_03_0 = {2b c2 2b 05 90 01 04 8b 55 90 01 01 8b 75 90 01 01 8a 0c 0a 32 0c 06 8b 15 90 01 04 0f af 15 90 01 04 0f af 15 90 01 04 a1 90 01 04 0f af 05 90 01 04 8b 75 90 00 } //1
...
rule Trojan_Win32_TrickBot_RT_MTB_7{
	...
	strings :
		$a_03_0 = {8b c3 03 f2 25 ff 00 00 00 33 d2 03 c6 f7 f7 8b f2 8a 04 2e 88 01 8b 44 24 90 01 01 88 1c 2e 8b 3d 90 01 04 40 41 3b c7 89 44 24 90 01 01 72 90 00 } //1
...
rule Trojan_Win32_TrickBot_RT_MTB_8{
	...
	strings :
		$a_03_0 = {03 c1 f7 35 90 01 04 8b 90 01 02 89 90 01 02 8b 90 01 02 8d 0c 02 8a c3 f6 eb 8b 90 01 02 8a 1c 33 2a d8 30 19 42 3b 90 01 02 89 90 01 02 72 90 00 } //1
...
rule Trojan_Win32_TrickBot_RT_MTB_10{
	...
	strings :
		$a_03_0 = {83 c1 01 89 4d 90 01 01 8b 55 90 01 01 3b 15 90 01 04 73 90 01 01 8b 45 90 01 01 03 45 90 01 01 8a 4d 90 01 01 88 08 8b 45 90 01 01 33 d2 f7 75 90 01 01 8b 45 90 01 01 03 45 90 01 01 8b 4d 90 01 01 8a 14 11 88 10 eb 90 00 } //1
