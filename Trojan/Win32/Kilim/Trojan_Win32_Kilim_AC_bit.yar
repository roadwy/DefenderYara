...
rule Trojan_Win32_Kilim_AC_bit{
	...
	strings :
		...
		$a_03_2 = {63 68 72 6f 6d 65 2e 65 78 65 00 90 02 08 6f 70 65 72 61 2e 65 78 65 90 00 } //1
		...
		$a_03_4 = {66 65 69 64 6f 77 6e 73 2e 63 6f 6d 2f 90 02 20 2e 70 68 70 90 00 } //1
	condition:
