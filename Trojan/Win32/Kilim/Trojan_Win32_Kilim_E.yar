...
rule Trojan_Win32_Kilim_E{
	...
	strings :
		...
		$a_01_3 = {30 30 30 72 61 73 67 65 6c 65 6b 6c 61 73 6f 72 30 30 30 00 25 72 61 73 67 65 6c 65 6b 6c 61 73 6f 72 25 } //1
		...
		$a_01_5 = {52 65 67 45 78 52 65 70 6c 61 63 65 28 43 68 72 6f 6d 65 50 72 65 66 2c 20 22 5c 5c 5c 5c 22 20 2e 20 50 72 65 66 69 78 20 2e } //1 RegExReplace(ChromePref, "\\\\" . Prefix .
		$a_01_6 = {28 6f 70 65 72 61 20 3d 20 31 29 } //1 (opera = 1)
		$a_01_7 = {54 77 61 69 6e 73 5f 36 34 00 } //1 睔楡獮㙟4
	condition:
