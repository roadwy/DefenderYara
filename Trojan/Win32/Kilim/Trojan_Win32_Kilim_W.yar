...
rule Trojan_Win32_Kilim_W{
	...
	strings :
		...
		$a_03_5 = {47 65 74 44 6f 77 6e 6c 6f 61 64 28 22 68 74 74 70 3a 2f 2f 90 02 10 2f 79 65 6e 69 2e 65 78 65 22 2c 20 22 79 65 6e 69 2e 65 78 65 22 2c 20 31 2c 20 31 29 90 00 } //1
	condition:
