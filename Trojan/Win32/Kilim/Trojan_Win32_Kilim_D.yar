...
rule Trojan_Win32_Kilim_D{
	...
	strings :
		...
		$a_03_3 = {30 30 30 72 61 73 67 65 6c 65 6b 6c 61 73 6f 72 30 30 30 90 02 03 25 72 61 73 67 65 6c 65 6b 6c 61 73 6f 72 25 90 00 } //1
		...
		$a_02_8 = {2f 63 72 78 90 02 03 2e 7a 69 70 00 90 00 } //1
		$a_03_9 = {5c 43 75 72 72 65 6e 74 56 65 72 73 69 6f 6e 5c 52 75 6e 90 02 31 25 72 65 67 70 61 74 68 25 90 00 } //1
		$a_03_10 = {5c 50 6f 6c 69 63 69 65 73 5c 53 79 73 74 65 6d 90 02 03 45 6e 61 62 6c 65 4c 55 41 90 02 03 30 90 00 } //1
