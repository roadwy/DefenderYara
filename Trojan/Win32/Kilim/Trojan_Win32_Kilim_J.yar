...
rule Trojan_Win32_Kilim_J{
	...
	strings :
		...
		$a_02_1 = {61 70 69 22 3a 20 5b 90 02 40 22 63 6c 69 70 62 6f 61 72 64 57 72 69 74 65 90 00 } //1
		...
		$a_02_3 = {63 68 72 6f 6d 65 2e 65 78 65 00 90 02 08 6f 70 65 72 61 2e 65 78 65 90 00 } //1
