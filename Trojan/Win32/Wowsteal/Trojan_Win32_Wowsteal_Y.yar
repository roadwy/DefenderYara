...
rule Trojan_Win32_Wowsteal_Y{
	...
	strings :
		...
		$a_01_1 = {00 77 6f 6f 6f 6c 2e 64 61 74 } //0a 00  眀潯汯搮瑡
		$a_01_2 = {5c 6d 61 70 5c 38 38 58 36 30 30 2e 6e 6d 70 } //01 00  \map\88X600.nmp
		$a_01_3 = {66 74 79 6f 75 } //01 00  ftyou
		$a_01_4 = {53 68 61 6e 64 61 } //00 00  Shanda
	condition:
		any of ($a_*)
