...
rule Trojan_Win32_Fileson_A{
	...
	strings :
		$a_02_0 = {65 73 6f 6e 69 63 2e 63 6f 6d 00 00 00 90 01 08 47 45 54 20 2f 6c 69 6e 6b 3f 6d 65 74 68 6f 64 3d 67 65 74 44 6f 77 6e 6c 6f 61 64 4c 69 6e 6b 26 66 6f 72 6d 61 74 3d 78 6d 6c 26 75 3d 90 00 } //1
