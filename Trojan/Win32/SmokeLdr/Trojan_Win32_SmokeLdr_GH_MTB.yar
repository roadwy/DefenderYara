...
rule Trojan_Win32_SmokeLdr_GH_MTB{
	...
	strings :
		...
		$a_02_1 = {3d 03 02 00 00 75 90 02 09 41 3b c8 90 0a 32 00 8b 15 90 01 04 8a 94 0a 90 01 04 8b 90 01 05 88 14 90 00 } //1
		$a_02_2 = {88 0c 02 8b 0d 90 01 04 81 f9 03 02 00 00 75 90 01 01 89 90 01 05 40 3b 90 01 01 72 90 00 } //1
	condition:
