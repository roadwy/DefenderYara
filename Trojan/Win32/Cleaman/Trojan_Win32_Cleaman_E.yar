...
rule Trojan_Win32_Cleaman_E{
	...
	strings :
		$a_03_0 = {c7 85 2c fd ff ff ?? ?? ?? ?? 8b 45 ec c6 40 01 65 8b 4d ec c6 41 08 65 } //1
		$a_01_1 = {c6 45 fa 00 8b 45 ec c6 40 01 65 8b 4d ec c6 41 04 70 8d 55 f4 52 ff 15 } //1
		$a_03_2 = {0f b7 04 4a c1 f8 0c 83 f8 03 75 ?? c7 85 78 ff ff ff ?? ?? 00 00 8b 4d 8c 8b 95 7c ff ff ff 0f b7 04 4a 50 e8 } //1
