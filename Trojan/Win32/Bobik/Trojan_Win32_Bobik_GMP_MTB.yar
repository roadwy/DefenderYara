...
rule Trojan_Win32_Bobik_GMP_MTB{
	...
	strings :
		$a_03_0 = {83 c4 0c 8d 45 c4 50 c7 45 90 01 01 3c 00 00 00 c7 45 90 01 01 0c 00 00 00 c7 45 90 01 01 a0 f9 40 00 c7 45 90 01 01 e8 e4 40 00 c7 45 90 01 01 05 00 00 00 ff 15 90 00 } //10
