...
rule Trojan_Win32_Zapchast_ABS_MTB{
	...
	strings :
		$a_03_0 = {2b 2c 11 07 6f ?? 00 00 0a 74 ?? 00 00 01 0d 09 6f ?? 00 00 0a 2c 17 09 6f ?? 00 00 0a 17 6f ?? 00 00 0a 6f ?? 00 00 0a 28 ?? 00 00 0a 0b 11 07 6f ?? 00 00 0a 2d cb } //10
		$a_03_1 = {07 8e 69 1b 59 8d ?? 00 00 01 13 04 07 1b 11 04 16 07 8e 69 1b 59 28 ?? 00 00 0a 11 04 } //10
