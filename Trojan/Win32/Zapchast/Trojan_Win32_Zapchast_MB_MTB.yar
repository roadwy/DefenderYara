...
rule Trojan_Win32_Zapchast_MB_MTB{
	...
	strings :
		$a_03_0 = {8b 45 f0 83 c4 0c 8b 55 ec 8b 4d e8 66 89 0c 02 33 c9 66 89 4c 02 02 8d 14 5d 90 01 04 8b cf e8 90 01 04 8b 45 f0 89 06 eb 90 01 01 57 56 50 e8 90 01 04 8b 45 f0 8d 55 f0 8b 4d e8 83 c4 0c 66 89 0c 07 33 c9 66 89 4c 07 02 8b ce e8 90 01 04 8b 45 08 40 89 45 08 3b 45 0c 0f 85 90 00 } //1
