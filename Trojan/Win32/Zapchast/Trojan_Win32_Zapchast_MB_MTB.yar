...
rule Trojan_Win32_Zapchast_MB_MTB{
	...
	strings :
		...
		$a_01_1 = {2e 64 65 62 75 67 5f 77 65 61 6b 6e 61 6d 65 73 } //01 00  .debug_weaknames
		$a_01_2 = {2e 64 65 62 75 67 5f 70 75 62 6e 61 6d 65 73 } //01 00  .debug_pubnames
		$a_01_3 = {53 6c 65 65 70 } //01 00  Sleep
		$a_01_4 = {70 00 72 00 6f 00 78 00 69 00 65 00 73 00 2e 00 74 00 78 00 74 00 } //00 00  proxies.txt
	condition:
		any of ($a_*)
