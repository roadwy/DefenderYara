...
rule Trojan_Win32_Cinmus_F{
	meta:
		description = "Trojan:Win32/Cinmus.F,SIGNATURE_TYPE_PEHSTR,09 00 09 00 07 00 00 04 00 "
		
	strings :
		$a_01_0 = {01 00 44 6f 53 53 53 65 74 75 70 2e 44 4c 4c 00 44 65 73 50 72 6f 00 44 6f 53 53 53 65 74 75 70 00 00 } //01 00 
