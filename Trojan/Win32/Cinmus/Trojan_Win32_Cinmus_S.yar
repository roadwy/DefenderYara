...
rule Trojan_Win32_Cinmus_S{
	...
	strings :
		$a_01_0 = {55 49 44 5f 31 33 32 39 31 34 37 36 30 32 5f 4d 49 45 45 76 65 6e 74 00 } //01 00  䥕彄㌱㤲㐱㘷㈰䵟䕉癅湥t
		$a_01_1 = {5f 7a 63 64 79 5f 73 6d 63 00 } //01 00  穟摣役浳c
		$a_00_2 = {44 6f 77 6e 6c 6f 61 64 4d 44 35 00 } //01 00  潄湷潬摡䑍5
