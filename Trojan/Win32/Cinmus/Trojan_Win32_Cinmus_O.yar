...
rule Trojan_Win32_Cinmus_O{
	...
	strings :
		$a_01_0 = {25 73 3f 66 69 64 3d 25 64 26 6b 69 64 3d 25 64 26 61 69 64 3d 25 64 26 6d 61 63 3d 25 73 26 6b 77 3d 25 73 } //01 00 
		$a_01_1 = {68 70 6f 70 63 6f 75 6e 74 00 } //01 00 
		$a_01_2 = {61 63 70 69 64 69 73 6b 00 } //01 00 
		$a_01_3 = {6d 70 72 6d 73 67 73 65 2e 61 78 7a } //01 00 
