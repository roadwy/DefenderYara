...
rule Trojan_Win32_ClipBanker_MD_MTB{
	...
	strings :
		$a_03_0 = {8b 4d fc 8b 55 f8 8b 04 8a 50 8d 8d f0 fe ff ff 51 ff 15 90 01 04 68 00 01 00 00 e8 90 01 04 83 c4 04 89 85 ec fe ff ff 8b 55 fc 8b 45 f4 8b 8d ec fe ff ff 89 0c 90 01 01 68 80 00 00 00 8b 55 fc 8b 45 f4 8b 0c 90 01 01 51 6a ff 8d 95 f0 fe ff ff 52 6a 00 6a 00 ff 15 90 01 04 e9 90 00 } //1
