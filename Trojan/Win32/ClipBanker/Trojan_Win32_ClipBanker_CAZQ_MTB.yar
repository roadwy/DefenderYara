...
rule Trojan_Win32_ClipBanker_CAZQ_MTB{
	...
	strings :
		$a_03_0 = {8b 45 08 0f be 0c 10 83 f9 90 01 01 75 2b ba 90 01 04 c1 e2 90 01 01 8b 45 08 0f be 0c 10 83 f9 90 01 01 75 17 ba 90 01 04 d1 e2 8b 45 08 0f be 0c 10 83 f9 90 01 01 75 04 b0 01 eb 90 00 } //1
