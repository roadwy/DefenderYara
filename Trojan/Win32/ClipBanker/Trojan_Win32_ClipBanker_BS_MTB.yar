...
rule Trojan_Win32_ClipBanker_BS_MTB{
	...
	strings :
		$a_01_0 = {28 5b 31 33 5d 5b 61 2d 6b 6d 2d 7a 41 2d 48 4a 2d 4e 50 2d 5a 31 2d 39 5d 7b 32 35 2c 33 34 7d 29 } //02 00  ([13][a-km-zA-HJ-NP-Z1-9]{25,34})
		$a_01_1 = {6e 6f 77 20 74 68 65 20 70 72 6f 67 72 61 6d 20 69 73 20 6d 6f 6e 69 74 6f 72 69 6e 67 20 63 6c 69 70 62 6f 61 72 64 } //02 00  now the program is monitoring clipboard
