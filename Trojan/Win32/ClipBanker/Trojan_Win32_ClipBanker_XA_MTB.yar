...
rule Trojan_Win32_ClipBanker_XA_MTB{
	...
	strings :
		$a_02_0 = {8b 54 24 18 33 c0 85 db 74 18 8d 0c c2 8b 74 0c 90 01 01 8b 4c 0c 90 01 01 31 74 c4 90 01 01 31 4c c4 90 01 01 40 3b c3 72 e8 8d 74 24 90 01 01 e8 90 01 04 8b 44 24 90 01 01 01 7c 24 14 01 7c 24 18 2b c7 89 44 24 90 01 01 3b c7 73 bf 90 00 } //5
