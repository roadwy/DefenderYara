...
rule Trojan_Win32_Clipbanker_RF_MTB_3{
	...
	strings :
		$a_81_0 = {47 65 74 53 74 61 72 74 75 70 49 6e 66 6f 41 } //01 00 
		$a_81_1 = {47 65 74 43 50 49 6e 66 6f } //01 00 
		$a_81_2 = {49 73 44 65 62 75 67 67 65 72 50 72 65 73 65 6e 74 } //01 00 
		$a_81_3 = {47 65 74 43 75 72 72 65 6e 74 50 72 6f 63 65 73 73 49 64 } //01 00 
		$a_81_4 = {47 65 74 53 79 73 74 65 6d 54 69 6d 65 41 73 46 69 6c 65 54 69 6d 65 } //0a 00 
		$a_81_5 = {62 63 31 71 35 6c 67 32 70 76 66 75 39 66 77 64 68 72 6d 63 33 6d 74 65 6d 38 76 76 30 35 65 61 34 78 79 33 34 37 66 68 7a 68 } //0a 00 
		$a_81_6 = {33 46 6d 59 31 61 38 48 45 64 4d 56 75 6e 43 41 35 64 65 63 79 68 53 56 54 33 6b 6e 39 64 63 4e 42 70 } //00 00 
	condition:
		any of ($a_*)
