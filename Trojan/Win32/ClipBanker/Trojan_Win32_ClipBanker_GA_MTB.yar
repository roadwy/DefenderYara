...
rule Trojan_Win32_ClipBanker_GA_MTB{
	meta:
		description = "Trojan:Win32/ClipBanker.GA!MTB,SIGNATURE_TYPE_PEHSTR_EXT,1b 00 1b 00 0d 00 00 "
	...
	condition:
		((#a_80_0  & 1)*10+(#a_80_1  & 1)*10+(#a_80_2  & 1)*1+(#a_80_3  & 1)*1+(#a_80_4  & 1)*1+(#a_80_5  & 1)*1+(#a_80_6  & 1)*1+(#a_80_7  & 1)*1+(#a_80_8  & 1)*1+(#a_80_9  & 1)*1+(#a_80_10  & 1)*1+(#a_80_11  & 1)*1+(#a_80_12  & 1)*1) >=27
