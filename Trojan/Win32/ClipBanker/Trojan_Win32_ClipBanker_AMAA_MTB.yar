...
rule Trojan_Win32_ClipBanker_AMAA_MTB{
	...
	strings :
		$a_01_0 = {28 5e 7c 5c 73 29 5b 31 33 5d 7b 31 7d 5b 61 2d 6b 6d 2d 7a 41 2d 48 4a 2d 4e 50 2d 5a 31 2d 39 5d 7b 32 35 2c 33 34 7d 28 24 7c 5c 73 29 } //01 00  (^|\s)[13]{1}[a-km-zA-HJ-NP-Z1-9]{25,34}($|\s)
		$a_01_1 = {7c 5c 73 29 62 6e 62 5b 61 2d 7a 41 2d 5a 30 2d 39 5d 7b 33 38 2c 34 30 7d 28 24 7c 5c 73 29 } //01 00  |\s)bnb[a-zA-Z0-9]{38,40}($|\s)
