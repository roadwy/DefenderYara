...
rule Trojan_Win32_ClipBanker_RPA_MTB{
	...
	strings :
		$a_02_0 = {50 ff d6 68 90 01 04 a3 90 01 04 ff d0 68 90 01 04 89 45 f8 ff 15 90 01 04 68 90 01 04 89 45 f0 ff 15 90 01 04 68 90 01 04 8b d8 ff 15 90 01 04 68 90 01 04 8b f8 ff 15 90 00 } //1
