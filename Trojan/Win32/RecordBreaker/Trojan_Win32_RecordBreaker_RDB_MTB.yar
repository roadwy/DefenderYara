...
rule Trojan_Win32_RecordBreaker_RDB_MTB{
	...
	strings :
		$a_01_0 = {4d 00 6f 00 6c 00 64 00 6f 00 76 00 61 00 } //01 00 
		$a_01_1 = {6b 65 72 6e 65 6c 33 32 2e 64 6c 6c } //01 00 
		$a_01_2 = {74 69 6d 65 47 65 74 54 69 6d 65 } //01 00 
		$a_01_3 = {57 44 41 47 55 74 69 6c 69 74 79 41 63 63 6f 75 6e 74 } //02 00 
