...
rule Trojan_Win32_Killav_FE{
	...
	strings :
		...
		$a_00_2 = {6e 65 74 73 68 20 66 69 72 65 77 61 6c 6c 20 73 65 74 20 6f 70 6d 6f 64 65 20 6d 6f 64 65 3d 64 69 73 61 62 6c 65 } //01 00 
		$a_00_3 = {74 73 6b 69 6c 6c 20 2f 41 20 61 76 2a } //00 00 
	condition:
		any of ($a_*)
