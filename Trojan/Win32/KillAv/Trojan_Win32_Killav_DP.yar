...
rule Trojan_Win32_Killav_DP{
	...
	strings :
		$a_03_0 = {00 61 6e 74 69 5f 61 76 90 0f 01 00 2e 64 6c 6c 00 90 00 } //2
		$a_03_1 = {66 c7 45 ea 0f 04 66 89 7d e8 e8 90 01 04 6a 32 ff 15 90 01 04 6a 1c 8d 45 e4 6a 00 50 e8 90 01 04 83 4d ec 02 83 c4 0c 6a 1c 8d 45 e4 50 56 89 75 e4 66 c7 45 ea 0f 04 90 00 } //2
		$a_03_2 = {00 10 6a 09 e8 90 01 04 6a 09 e8 90 01 04 6a 09 e8 90 01 04 6a 0d e8 90 00 } //2
