...
rule Trojan_Win32_Killav_FO{
	...
	strings :
		...
		$a_03_1 = {51 50 68 38 04 00 00 ff 15 90 01 04 8b e8 85 ed 0f 84 90 01 04 33 c0 6a 1c 90 00 } //2
		$a_03_2 = {83 f8 10 74 11 83 f8 20 74 0c 83 f8 40 74 07 3d 80 00 00 00 75 90 01 01 8b 44 24 90 01 01 6a 04 68 00 30 00 00 50 6a 00 ff 15 90 00 } //2
