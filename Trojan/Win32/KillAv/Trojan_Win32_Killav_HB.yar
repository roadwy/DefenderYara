...
rule Trojan_Win32_Killav_HB{
	...
	strings :
		...
		$a_00_1 = {69 64 3d 25 73 26 64 61 74 61 3d } //0a 00  id=%s&data=
		$a_01_2 = {4e 54 46 00 25 64 2e 25 64 2e 25 64 20 25 73 00 43 72 79 70 74 64 6c 6c 2e 64 6c 6c } //01 00 
		$a_00_3 = {31 38 37 2e 33 33 2e 31 2e 31 37 31 } //01 00  187.33.1.171
		$a_00_4 = {39 31 2e 31 32 31 2e 31 36 2e 32 34 } //01 00  91.121.16.24
		$a_00_5 = {31 39 38 2e 31 30 31 2e 32 34 31 2e 31 35 39 } //01 00  198.101.241.159
		$a_00_6 = {39 31 2e 31 32 31 2e 35 35 2e 31 32 37 } //00 00  91.121.55.127
