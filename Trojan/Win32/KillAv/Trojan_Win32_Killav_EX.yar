...
rule Trojan_Win32_Killav_EX{
	...
	strings :
		...
		$a_02_2 = {5d 54 6a 00 6a 00 6a 0c 8d 4c 24 90 01 01 51 6a 09 ff 15 90 00 } //2
		$a_02_3 = {6a 0b ff 15 90 01 04 8d 43 04 8b 50 08 89 15 90 01 04 0f b7 48 1a 03 c1 83 c0 1c 90 00 } //1
