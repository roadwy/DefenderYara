...
rule Trojan_Win32_Killav_DR{
	...
	strings :
		...
		$a_01_5 = {00 5c 53 65 74 75 70 5c 73 65 74 69 66 61 63 65 2e 64 6c 6c 22 2c 52 75 6e 53 65 74 75 70 } //01 00  尀敓畴屰敳楴慦散搮汬Ⱒ畒卮瑥灵
		$a_01_6 = {00 2f 74 55 6e 49 6e 73 74 61 6c 6c } //01 00  ⼀啴䥮獮慴汬
		$a_01_7 = {00 6d 63 75 6e 69 6e 73 74 } //01 00 
		$a_01_8 = {00 2f 52 45 4d 4f 56 45 } //01 00  ⼀䕒位䕖
		$a_01_9 = {00 67 20 64 61 74 61 00 } //01 00  最搠瑡a
		$a_01_10 = {00 73 6f 75 70 38 38 00 } //01 00  猀畯㡰8
		$a_01_11 = {00 74 76 66 31 00 } //01 00  琀晶1
		$a_01_12 = {00 70 6f 73 74 69 6e 73 74 61 } //01 00  瀀獯楴獮慴
		$a_00_13 = {00 42 75 74 74 6f 6e 00 00 41 56 47 } //01 00  䈀瑵潴n䄀䝖
		$a_01_14 = {00 63 61 6c 6c 6d 73 69 2e 65 78 65 } //00 00  挀污浬楳攮數
	condition:
		any of ($a_*)
