...
rule Trojan_Win32_Killav_CK{
	...
	strings :
		...
		$a_01_2 = {53 65 74 43 75 72 73 6f 72 50 6f 73 } //0a 00  SetCursorPos
		$a_01_3 = {45 6e 75 6d 43 68 69 6c 64 57 69 6e 64 6f 77 73 } //0a 00  EnumChildWindows
		$a_01_4 = {46 69 6e 64 57 69 6e 64 6f 77 45 78 41 } //0a 00  FindWindowExA
		$a_01_5 = {4e 6f 74 69 66 79 57 6e 64 } //0a 00  NotifyWnd
		$a_01_6 = {53 65 74 54 69 6d 65 72 } //0a 00  SetTimer
		$a_01_7 = {d7 dc ca c7 d4 ca d0 ed } //0a 00 
		$a_01_8 = {b7 c5 b9 fd } //0a 00 
		$a_01_9 = {bc d3 c8 eb d0 c5 c8 ce b2 e5 bc fe c1 d0 b1 ed } //01 00 
		$a_01_10 = {62 69 61 6f 6a 69 } //00 00  biaoji
	condition:
		any of ($a_*)
