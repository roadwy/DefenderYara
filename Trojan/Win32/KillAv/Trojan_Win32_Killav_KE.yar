...
rule Trojan_Win32_Killav_KE{
	...
	strings :
		...
		$a_00_1 = {64 65 6c 20 2f 51 20 22 43 3a 5c 50 72 6f 67 72 61 6d 20 46 69 6c 65 73 5c 53 79 6d 61 6e 74 65 63 5c 4c 69 76 65 55 70 64 61 74 65 5c 2a 2e 65 78 65 22 } //01 00 
