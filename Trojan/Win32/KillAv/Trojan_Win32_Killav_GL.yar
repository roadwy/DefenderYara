...
rule Trojan_Win32_Killav_GL{
	...
	strings :
		$a_00_0 = {33 36 30 74 72 61 79 3b 61 76 67 6e 74 3b 61 76 67 61 75 72 64 3b 61 76 63 65 6e 74 65 72 3b 61 64 61 6d 3b 41 67 65 6e 74 53 76 72 3b 41 6e 74 69 41 72 70 3b } //01 00 
		$a_00_1 = {3b 6b 69 73 73 76 63 3b 6b 73 77 65 62 73 68 69 65 6c 64 3b 5a 68 75 44 6f 6e 67 46 61 6e 67 59 75 3b 53 75 70 65 72 4b 69 6c 6c 65 72 3b } //01 00 
