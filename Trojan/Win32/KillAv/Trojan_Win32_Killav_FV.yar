...
rule Trojan_Win32_Killav_FV{
	...
	strings :
		$a_02_0 = {8d 85 38 ff ff ff ba 12 00 00 00 e8 90 01 04 8b 85 38 ff ff ff e8 90 01 04 50 e8 90 01 04 83 f8 01 1b c0 40 b8 90 01 04 e8 90 01 04 84 c0 74 0a b8 90 01 04 e8 90 01 04 b8 90 01 04 e8 90 01 04 84 c0 74 0a b8 90 00 } //1
		$a_03_1 = {50 6a 00 68 3f 00 0f 00 6a 00 6a 00 6a 00 68 90 01 04 68 90 01 01 00 00 80 e8 90 01 04 85 c0 75 90 01 01 8b 5d fc 85 db 74 90 01 01 83 eb 04 8b 1b 43 53 8b 45 fc e8 90 01 04 50 6a 01 6a 00 8b 45 f8 90 00 } //1
