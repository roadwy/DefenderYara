...
rule Trojan_Win32_Killav_FA{
	...
	strings :
		...
		$a_01_1 = {73 79 73 74 65 6d 33 32 5c 64 72 69 76 65 72 73 5c 33 36 30 } //01 00  system32\drivers\360
		$a_01_2 = {5c 5c 2e 5c 4b 69 6c 6c 50 72 6f 63 65 73 73 } //02 00  \\.\KillProcess
