...
rule Trojan_Win32_Virlock_GMH_MTB{
	...
	strings :
		...
		$a_01_1 = {6f 45 38 4d 6e 4f 74 } //01 00  oE8MnOt
...
rule Trojan_Win32_Virlock_GMH_MTB_2{
	...
	strings :
		...
		$a_01_1 = {56 4f 55 37 75 75 78 75 } //01 00  VOU7uuxu
		$a_01_2 = {7a 41 75 4e 76 69 45 55 } //01 00  zAuNviEU
		$a_01_3 = {50 2e 76 6d 70 30 } //00 00  P.vmp0
	condition:
		any of ($a_*)
