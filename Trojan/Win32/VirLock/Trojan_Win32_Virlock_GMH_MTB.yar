...
rule Trojan_Win32_Virlock_GMH_MTB{
	...
	strings :
		$a_03_0 = {40 00 fc 3a 40 00 e8 ?? ?? ?? ?? 5c 40 00 10 3b 40 00 04 3b 40 00 04 5d 40 00 98 38 40 00 d4 38 40 00 } //10
...
rule Trojan_Win32_Virlock_GMH_MTB_2{
	...
	strings :
		$a_03_0 = {00 0c 3b 40 00 10 3b 40 00 04 3b 40 00 7c 38 40 00 98 ?? ?? ?? ?? 38 40 00 0a 45 4c 69 73 ?? 45 72 72 6f } //10
