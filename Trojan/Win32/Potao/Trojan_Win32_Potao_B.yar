...
rule Trojan_Win32_Potao_B{
	...
	strings :
		...
		$a_03_1 = {81 7d 1c 07 20 01 00 8b f0 75 90 01 01 a1 90 00 } //1
		$a_01_2 = {80 fa 0a 75 05 88 14 0e eb 0b 2a } //1
		$a_03_3 = {88 07 47 4b 75 f1 90 09 09 00 6a 7a 6a 61 e8 90 00 } //1
		$a_03_4 = {dd 1c 24 33 c0 ff d0 90 09 03 00 dd 45 90 00 } //1
	condition:
