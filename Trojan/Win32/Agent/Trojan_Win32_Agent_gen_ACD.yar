...
rule Trojan_Win32_Agent_gen_ACD{
	...
	strings :
		...
		$a_01_2 = {68 74 74 70 3a 2f 2f 73 6f 66 74 2e 74 72 75 73 74 69 6e 63 61 73 68 2e 63 6f 6d 2f 75 72 6c 2f 63 6f 6e 66 69 67 2e 78 6d 6c } //02 00 
		$a_01_3 = {43 43 68 61 6e 67 65 72 42 48 4f 20 74 72 69 65 73 20 74 6f 20 70 65 72 66 6f 72 6d 20 73 74 61 72 74 20 61 63 74 69 6f 6e 73 } //02 00 
		$a_01_4 = {4c 61 73 74 43 66 67 46 65 74 63 68 } //00 00 
	condition:
		any of ($a_*)
