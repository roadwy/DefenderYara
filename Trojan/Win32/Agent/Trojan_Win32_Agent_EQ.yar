...
rule Trojan_Win32_Agent_EQ{
	...
	strings :
		...
		$a_02_7 = {52 65 6d 6f 74 65 20 6e 65 74 43 6f 6e 74 72 6f 6c 20 53 65 72 76 69 63 65 3c 2f 64 69 73 3e 3c 64 65 73 3e 72 65 6d 6f 74 65 20 6e 65 74 77 6f 72 6b 20 26 20 63 6f 6e 63 74 72 6f 6c 20 73 65 72 76 69 63 65 3c 2f 64 65 73 3e 3c 69 6e 66 3e 90 02 50 3a 90 00 } //1
