...
rule Trojan_Win32_Agent_OL{
	...
	strings :
		...
		$a_00_1 = {55 52 4c 44 6f 77 6e 6c 6f 61 64 54 6f 46 69 6c 65 41 } //14 00 
		$a_00_2 = {57 69 6e 45 78 65 63 } //02 00 
		$a_00_3 = {5c 72 75 64 6c 6c 33 32 2e 65 78 65 } //02 00 
		$a_00_4 = {5c 6e 6f 74 70 61 64 2e 65 78 65 } //02 00 
		$a_00_5 = {5c 61 73 68 4d 61 69 6c 73 2e 65 78 65 } //02 00 
		$a_00_6 = {5c 61 73 68 53 65 72 76 73 2e 65 78 65 } //02 00 
		$a_00_7 = {5c 78 30 30 30 2e 65 78 65 } //02 00 
		$a_00_8 = {5c 61 67 65 6e 74 65 73 66 69 72 65 77 61 6c 6c 2e 65 78 65 } //02 00 
		$a_00_9 = {5c 70 6c 75 67 69 6e 2e 65 78 65 } //00 00 
	condition:
		any of ($a_*)
