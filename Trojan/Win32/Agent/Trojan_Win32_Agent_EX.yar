...
rule Trojan_Win32_Agent_EX{
	...
	strings :
		...
		$a_03_1 = {80 f9 3a 75 47 c6 84 05 90 01 04 00 8a 8c 05 90 01 02 ff ff 40 80 f9 2f c7 45 90 01 01 01 00 00 00 75 1c 8a 8c 05 90 01 02 ff ff 40 80 f9 2f 75 2d 40 90 00 } //1
