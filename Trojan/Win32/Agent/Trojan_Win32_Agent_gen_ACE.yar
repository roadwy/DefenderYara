...
rule Trojan_Win32_Agent_gen_ACE{
	...
	strings :
		$a_01_0 = {57 53 63 72 69 70 74 } //01 00  WScript
		$a_01_1 = {52 64 75 21 65 60 75 64 3c 24 65 60 75 64 24 } //01 00  Rdu!e`ud<$e`ud$
		...
		$a_01_3 = {65 60 75 64 21 30 38 } //00 00  e`ud!08
	condition:
		any of ($a_*)
