...
rule Trojan_Win32_Agent_EV{
	...
	strings :
		...
		$a_03_1 = {8b 45 08 a3 ?? ?? ?? ?? 8b 45 0c ff 1d ?? ?? ?? ?? 8b 45 0c 8b 4d 08 50 51 6a 00 e8 } //1
		$a_03_2 = {0f 01 45 f8 8b 4d fa 8d 45 08 50 51 e8 ?? ?? ff ff 8b 75 f8 8b 55 08 81 e6 ff ff 00 00 83 c4 08 8d 0c 16 51 50 6a 00 6a 06 57 ff 15 ?? ?? ?? ?? 85 c0 a3 ?? ?? ?? ?? 75 08 5f 32 c0 5e 8b e5 5d c3 8b 55 08 bf 00 ff 00 00 8d 4c 10 08 } //1
	condition:
