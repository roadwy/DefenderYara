...
rule Trojan_Win32_Agent_GA{
	...
	strings :
		$a_02_0 = {8a 47 fe 50 e8 90 01 04 83 c4 04 85 c0 0f 8c 90 01 04 8a 4f ff c1 e0 06 51 8b f0 e8 90 01 04 83 c4 04 85 c0 0f 8c 90 01 04 03 f0 8a 07 c1 e6 06 3c 3d 90 00 } //10
