...
rule Trojan_Win32_Agent_EAB{
	...
	strings :
		...
		$a_00_2 = {5f 41 70 70 65 6e 64 5f 54 65 78 74 5f 56 61 6c 75 65 40 31 32 } //01 00  _Append_Text_Value@12
		$a_00_3 = {5f 43 6c 65 61 72 5f 44 61 74 61 54 65 78 74 40 38 } //00 00  _Clear_DataText@8
	condition:
		any of ($a_*)
