...
rule Trojan_Win32_Agent_EAB{
	...
	strings :
		$a_03_0 = {8b 48 3c 8b 7c 01 78 03 f8 8b 77 24 8b 4f 1c 8b 57 20 8b 5f 18 03 f0 89 75 ?? 8b 77 14 03 c8 03 d0 89 45 ?? 89 4d ?? 89 55 } //2
		$a_03_1 = {0f b7 40 0e 8b 4d ?? 0f b7 49 0c 03 c1 39 45 } //1
