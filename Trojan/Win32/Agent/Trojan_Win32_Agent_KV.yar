...
rule Trojan_Win32_Agent_KV{
	...
	strings :
		...
		$a_03_4 = {ff 33 c6 85 90 01 01 fe ff ff 36 c6 85 90 01 01 fe ff ff 30 c6 85 90 01 01 fe ff ff 53 c6 85 90 01 01 fe ff ff 61 c6 85 90 01 01 fe ff ff 66 c6 85 90 01 01 fe ff ff 65 90 00 } //1
	condition:
