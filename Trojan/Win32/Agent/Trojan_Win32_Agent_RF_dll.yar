...
rule Trojan_Win32_Agent_RF_dll{
	...
	strings :
		...
		$a_01_1 = {25 73 5c 25 7a 34 5e 3c 64 2e 6c 6e 6b } //01 00 
		$a_01_2 = {55 7a 34 5e 3c 52 4c 44 7a 34 5e 3c 6f 77 6e 7a 34 5e 3c 6c 6f 61 7a 34 5e 3c 64 54 6f 46 69 6c 65 41 } //00 00 
	condition:
		any of ($a_*)
