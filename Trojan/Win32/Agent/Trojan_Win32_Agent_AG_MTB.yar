...
rule Trojan_Win32_Agent_AG_MTB{
	...
	strings :
		...
		$a_01_1 = {2e 00 74 00 6d 00 70 00 22 00 20 00 2d 00 2d 00 70 00 69 00 6e 00 67 00 } //01 00 
		$a_01_2 = {22 00 25 00 73 00 22 00 20 00 73 00 74 00 61 00 72 00 74 00 20 00 22 00 25 00 73 00 22 00 } //00 00 
	condition:
		any of ($a_*)
