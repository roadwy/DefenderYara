...
rule Trojan_Win32_Agent_ZAN{
	...
	strings :
		...
		$a_02_2 = {b2 61 b1 65 c6 45 90 01 01 75 c6 45 90 01 01 72 88 45 90 01 01 c6 45 90 01 01 6d c6 45 90 01 01 2e 90 00 } //10
		$a_02_3 = {8b d2 8b c9 8b c9 90 90 8b d2 8d 85 90 01 02 ff ff 68 04 01 00 00 50 6a 00 ff 15 90 01 03 00 8d 8d 90 01 02 ff ff 6a 5c 51 ff 15 90 01 03 00 90 00 } //6
