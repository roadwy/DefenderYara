...
rule Trojan_Win32_Agent_ZAN{
	...
	strings :
		...
		$a_00_1 = {68 74 74 70 3a 2f 2f 6e 65 77 2e 37 34 39 35 37 31 2e 63 6f 6d 2f 78 69 6e 2e 74 78 74 } //0a 00 
		...
		$a_00_4 = {73 74 72 72 63 68 72 } //03 00 
		$a_00_5 = {49 6e 74 65 72 6e 65 74 4f 70 65 6e 41 } //03 00 
		$a_00_6 = {57 69 6e 45 78 65 63 } //03 00 
		$a_00_7 = {23 33 32 37 37 30 } //00 00 
	condition:
		any of ($a_*)
