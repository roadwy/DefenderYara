...
rule Trojan_Win32_Agent_2{
	...
	strings :
		...
		$a_02_4 = {89 5c 24 1c e8 92 12 00 00 bf 90 01 04 83 c9 ff 33 c0 f2 ae f7 d1 49 51 68 90 01 04 68 90 01 04 e8 09 0c 00 00 90 00 } //1
	condition:
...
rule Trojan_Win32_Agent_3{
	...
	strings :
		...
		$a_03_1 = {68 88 13 00 00 c7 44 24 90 01 01 01 00 00 00 c7 44 24 90 01 04 00 66 89 44 24 90 01 01 ff 15 90 01 03 00 8d 44 24 90 01 01 8d 4c 24 90 01 01 50 51 6a 00 6a 00 6a 00 6a 01 6a 00 6a 00 68 90 01 03 00 6a 00 ff 15 90 01 03 00 5f 33 c0 5e 83 c4 90 01 01 c2 10 00 90 00 } //1
