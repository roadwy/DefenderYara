...
rule Trojan_Win32_Agent_RPJ_MTB{
	...
	strings :
		$a_01_0 = {44 3a 5c 57 6f 72 6b 73 70 61 63 65 5c 43 72 79 70 74 65 64 5c 61 2e 70 64 62 } //01 00  D:\Workspace\Crypted\a.pdb
		...
		$a_01_2 = {77 63 66 67 6d 67 72 33 32 2e 65 78 65 } //01 00  wcfgmgr32.exe
		$a_01_3 = {6c 73 74 72 6c 65 6e 41 } //01 00  lstrlenA
		$a_01_4 = {53 6c 65 65 70 } //01 00  Sleep
		$a_01_5 = {6d 61 6c 6c 6f 63 } //00 00  malloc
	condition:
		any of ($a_*)
