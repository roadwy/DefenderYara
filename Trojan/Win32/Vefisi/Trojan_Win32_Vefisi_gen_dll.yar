...
rule Trojan_Win32_Vefisi_gen_dll{
	...
	strings :
		$a_01_0 = {3f 69 64 3d 25 73 26 74 69 6d 65 3d 25 73 } //01 00 
		$a_01_1 = {3f 69 64 3d 25 73 26 43 6f 75 6e 74 3d 25 64 } //01 00 
		$a_01_2 = {3f 69 64 3d 25 73 26 63 61 62 3d 25 73 } //01 00 
		$a_01_3 = {3f 69 64 3d 25 73 26 74 3d 25 73 26 6d 61 63 3d 25 73 } //01 00 
		$a_01_4 = {70 6e 67 3f 69 64 3d 25 73 26 74 3d 25 73 } //01 00 
