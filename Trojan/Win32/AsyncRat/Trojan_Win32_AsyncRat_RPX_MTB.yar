...
rule Trojan_Win32_AsyncRat_RPX_MTB_2{
	...
	strings :
		...
		$a_01_1 = {31 33 34 2e 31 32 32 2e 31 33 33 2e 34 39 } //01 00  134.122.133.49
		$a_01_2 = {43 6c 69 65 6e 74 2e 62 69 6e } //01 00  Client.bin
		$a_01_3 = {47 61 72 62 61 67 65 31 } //00 00  Garbage1
	condition:
		any of ($a_*)
...
rule Trojan_Win32_AsyncRat_RPX_MTB_3{
	...
	strings :
		$a_01_0 = {61 48 52 30 63 48 4d 36 4c 79 39 77 59 58 4e 30 5a 53 35 6d 62 79 39 79 59 58 63 76 4d 47 45 78 4e 57 59 79 5a 44 68 6b 4e 47 4d 31 } //01 00  aHR0cHM6Ly9wYXN0ZS5mby9yYXcvMGExNWYyZDhkNGM1
		$a_01_1 = {57 61 69 74 46 6f 72 53 69 6e 67 6c 65 4f 62 6a 65 63 74 } //01 00  WaitForSingleObject
		$a_01_2 = {43 72 79 70 74 53 74 72 69 6e 67 54 6f 42 69 6e 61 72 79 41 } //01 00  CryptStringToBinaryA
		...
		$a_01_5 = {47 65 74 54 65 6d 70 50 61 74 68 41 } //01 00  GetTempPathA
		$a_01_6 = {53 6c 65 65 70 } //01 00  Sleep
		$a_01_7 = {55 52 4c 44 6f 77 6e 6c 6f 61 64 54 6f 46 69 6c 65 41 } //01 00  URLDownloadToFileA
		$a_01_8 = {66 74 65 6c 6c } //01 00  ftell
		$a_01_9 = {66 73 65 65 6b } //01 00  fseek
		$a_01_10 = {66 6f 70 65 6e 5f 73 } //00 00  fopen_s
	condition:
		any of ($a_*)
