...
rule Trojan_Win32_AsyncRat_RPZ_MTB{
	...
	strings :
		$a_03_0 = {ff d6 ff b5 98 fb ff ff ff d6 0f 57 c0 c7 85 ec fb ff ff 00 00 00 00 8d 95 c0 fb ff ff 66 0f d6 85 e4 fb ff ff 8d 8d e4 fb ff ff e8 ?? ?? ?? ?? c6 45 fc 04 8b 85 e8 fb ff ff 2b 85 e4 fb ff ff 6a 40 68 00 10 00 00 50 6a 00 ff 15 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_Win32_AsyncRat_RPZ_MTB_2{
	...
	strings :
		$a_03_0 = {8b 45 fc 8b f0 ff d6 8d 45 f8 50 8b 45 f8 50 53 8b 45 fc 50 e8 ?? ?? ?? ?? 33 c0 5a 59 59 64 89 10 } //1
