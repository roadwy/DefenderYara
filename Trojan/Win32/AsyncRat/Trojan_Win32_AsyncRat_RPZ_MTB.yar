...
rule Trojan_Win32_AsyncRat_RPZ_MTB{
	...
	strings :
		...
		$a_01_1 = {6d 00 79 00 71 00 63 00 6c 00 6f 00 75 00 64 00 2e 00 63 00 6f 00 6d 00 } //01 00 
		$a_01_2 = {43 00 6c 00 69 00 65 00 6e 00 74 00 2e 00 62 00 69 00 6e 00 } //00 00 
	condition:
		any of ($a_*)
