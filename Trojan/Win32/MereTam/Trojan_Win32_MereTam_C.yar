...
rule Trojan_Win32_MereTam_C{
	...
	strings :
		...
		$a_00_3 = {43 00 3a 00 5c 00 50 00 72 00 6f 00 67 00 72 00 61 00 6d 00 44 00 61 00 74 00 61 00 5c 00 } //0a 00 
		$a_00_4 = {25 73 5c 73 68 65 6c 6c 5c 6f 70 65 6e 5c 25 73 } //00 00 
