...
rule Trojan_Win32_Stratklonk_A{
	...
	strings :
		$a_01_0 = {6c 00 6f 00 61 00 64 00 65 00 72 00 2d 00 73 00 79 00 73 00 5c 00 4c 00 6f 00 61 00 64 00 73 00 4f 00 72 00 69 00 67 00 69 00 6e 00 61 00 69 00 73 00 5c 00 6b 00 61 00 63 00 } //02 00  loader-sys\LoadsOriginais\kac
