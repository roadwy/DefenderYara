...
rule Trojan_Win32_Loasum_A{
	...
	strings :
		...
		$a_01_4 = {6e 65 74 77 6f 72 6b 65 78 70 6c 6f 72 65 72 2e 44 4c 4c } //01 00 
		$a_01_5 = {4e 6c 73 44 61 74 61 30 30 30 30 2e 44 4c 4c } //01 00 
		$a_01_6 = {4e 65 74 50 72 6f 6a 57 2e 44 4c 4c } //01 00 
		$a_01_7 = {47 68 6f 66 72 2e 44 4c 4c } //01 00 
		$a_01_8 = {66 67 31 32 32 2e 44 4c 4c } //00 00 
