...
rule Trojan_Win32_Lickore_A{
	...
	strings :
		...
		$a_03_3 = {85 c9 74 19 8b 06 83 78 f4 00 7c 11 51 50 e8 90 01 02 01 00 83 c4 08 85 c0 74 03 2b 06 c3 90 00 } //2
		$a_01_4 = {8b 08 8b 11 50 8b 42 04 ff d0 8b 5c 24 14 83 7b f4 00 0f 8c d5 00 00 00 } //2
		$a_03_5 = {8d 70 10 83 c4 04 89 74 24 14 c6 84 24 90 01 04 07 83 7e f4 00 0f 8c 94 12 00 00 90 00 } //2
	condition:
