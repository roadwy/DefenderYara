...
rule Trojan_Win32_Lickore_B{
	...
	strings :
		...
		$a_00_1 = {63 6c 69 63 6b 73 74 6f 72 79 2e 63 6f 2e 6b 72 2f 3f } //01 00 
		$a_00_2 = {63 6c 69 63 6b 2e 6c 69 6e 6b 70 72 69 63 65 2e 63 6f 6d 2f 63 6c 69 63 6b 2e 70 68 70 3f 6d 3d } //01 00 
