...
rule Trojan_Win32_Lickore_B{
	...
	strings :
		$a_03_0 = {8b 55 f4 b1 01 8b 45 f8 e8 90 01 04 84 c0 74 90 01 01 8b 45 f8 e8 90 01 04 ba 00 00 00 80 8b 45 f8 e8 90 01 04 8d 45 f0 90 00 } //2
		...
		$a_03_3 = {6a 61 76 61 73 63 72 69 70 74 3a 90 02 20 61 62 6f 75 74 3a 62 6c 61 6e 6b 90 00 } //1
	condition:
