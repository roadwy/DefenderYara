...
rule Trojan_Win32_Zlob_AD{
	...
	strings :
		...
		$a_02_7 = {68 06 00 02 00 6a 00 6a 00 6a 00 8b 95 90 01 02 ff ff 52 68 02 00 00 80 ff 15 90 01 04 6a 00 6a 01 8d 4d 90 01 01 e8 90 01 02 ff ff ba 90 01 04 8d 4d 90 01 01 e8 90 01 02 ff ff 89 45 90 01 01 8b 45 90 01 01 83 78 90 01 01 08 72 0e 8b 4d 90 01 01 8b 51 04 89 95 90 01 02 ff ff eb 90 01 01 8b 45 90 01 01 83 c0 04 89 85 90 01 02 ff ff 6a 00 6a 00 6a 03 6a 00 90 00 } //1
		$a_02_8 = {6a 28 6a 20 5e 56 e8 90 01 02 ff ff 59 59 3b c7 0f 84 90 01 02 00 00 a3 90 01 04 89 35 90 01 04 8d 88 00 05 00 00 eb 90 01 01 c6 40 04 00 83 08 ff c6 40 05 0a 89 78 08 c6 40 24 00 c6 40 25 0a c6 40 26 0a 83 c0 28 8b 0d 90 01 04 81 c1 00 05 00 00 90 00 } //1
		$a_02_9 = {8b 44 24 04 8b 00 8b 00 3d 4d 4f 43 e0 74 18 3d 63 73 6d e0 75 90 01 01 e8 90 01 02 ff ff 83 a0 90 90 00 00 00 00 e9 90 01 02 00 00 e8 90 01 02 ff ff 83 b8 90 90 00 00 00 00 7e 90 01 01 e8 90 01 02 ff ff 05 90 90 00 00 00 ff 08 33 c0 c3 90 00 } //1
	condition:
