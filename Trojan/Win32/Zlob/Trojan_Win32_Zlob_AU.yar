...
rule Trojan_Win32_Zlob_AU{
	...
	strings :
		...
		$a_03_1 = {81 78 08 94 01 00 00 75 90 03 08 04 0b 8b 44 24 14 c7 40 20 07 c7 46 20 02 00 00 00 90 00 } //1
		$a_01_2 = {00 74 73 5c 00 72 20 4f 62 6a 65 63 00 72 20 48 65 6c 70 65 00 72 5c 42 72 6f 77 73 65 00 } //1 琀屳爀传橢捥爀䠠汥数爀䉜潲獷e
		$a_03_3 = {74 73 5c 00 65 72 20 4f 62 6a 65 63 00 90 02 03 73 65 72 20 48 65 6c 70 00 90 02 03 72 65 72 5c 42 72 6f 77 00 90 00 } //1
