...
rule Trojan_Win32_Zlob_AMJ{
	...
	strings :
		...
		$a_01_2 = {2e 70 68 70 3f 71 71 3d 25 73 } //01 00 
		$a_00_3 = {72 00 65 00 73 00 3a 00 2f 00 2f 00 25 00 73 00 } //01 00 
		$a_01_4 = {2e 64 6c 6c 00 44 6c 6c 43 61 6e 55 6e 6c 6f 61 } //00 00 
	condition:
		any of ($a_*)
