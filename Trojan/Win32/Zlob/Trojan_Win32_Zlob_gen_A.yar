...
rule Trojan_Win32_Zlob_gen_A{
	...
	strings :
		...
		$a_02_15 = {89 45 c0 8b 4d c0 83 79 18 08 72 0e 8b 55 c0 8b 42 04 89 85 90 01 02 ff ff eb 0c 8b 4d c0 83 c1 04 89 8d 90 01 02 ff ff 6a 00 8d 55 fc 52 6a 00 68 06 00 02 00 6a 00 6a 00 6a 00 8b 85 90 01 02 ff ff 50 68 02 00 00 80 ff 15 04 f0 01 10 6a 00 6a 01 8d 4d e0 e8 90 01 01 ca ff ff 68 90 01 01 00 02 10 8d 4d c4 51 e8 90 01 02 ff ff 90 00 } //100
	condition:
