...
rule Trojan_Win32_Zlob_G{
	...
	strings :
		...
		$a_00_1 = {7b 42 38 33 30 31 41 46 37 2d 44 30 30 45 2d 34 45 41 34 2d 38 37 43 31 2d 35 46 46 34 36 34 34 46 42 42 41 31 7d } //01 00  {B8301AF7-D00E-4EA4-87C1-5FF4644FBBA1}
		$a_00_2 = {68 6f 6d 65 73 65 63 75 72 65 70 61 67 65 2e 63 6f 6d } //00 00  homesecurepage.com
	condition:
		any of ($a_*)
