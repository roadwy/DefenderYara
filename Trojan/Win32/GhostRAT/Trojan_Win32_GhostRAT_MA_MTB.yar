...
rule Trojan_Win32_GhostRAT_MA_MTB_2{
	...
	strings :
		...
		$a_01_1 = {5c 00 6a 00 69 00 73 00 75 00 70 00 64 00 66 00 2e 00 65 00 78 00 65 00 } //02 00 
		$a_01_2 = {52 00 75 00 6e 00 4f 00 6e 00 6c 00 79 00 4f 00 6e 00 65 00 49 00 6e 00 73 00 74 00 61 00 6e 00 63 00 65 00 } //00 00 
	condition:
		any of ($a_*)
