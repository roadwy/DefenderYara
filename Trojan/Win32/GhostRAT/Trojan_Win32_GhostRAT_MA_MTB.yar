...
rule Trojan_Win32_GhostRAT_MA_MTB{
	...
	strings :
		$a_03_0 = {83 ec 0c 0f b6 45 10 99 b9 90 01 04 53 f7 f9 56 57 89 65 f0 80 c2 17 83 65 ec 00 88 55 13 8b 45 ec 3b 45 0c 73 90 00 } //1
		$a_03_1 = {8b 45 08 8a 08 32 4d 13 02 4d 13 88 08 40 89 45 08 b8 90 01 04 c3 90 00 } //1
	condition:
...
rule Trojan_Win32_GhostRAT_MA_MTB_2{
	...
	strings :
		$a_03_0 = {55 8b ec 83 e4 f8 81 ec 5c 0b 00 00 a1 90 01 04 33 c4 89 84 24 58 0b 00 00 53 56 57 68 90 01 04 6a 00 6a 00 ff 15 90 00 } //5
