...
rule Trojan_Win32_GhostRAT_MB_MTB{
	...
	strings :
		$a_01_0 = {46 75 63 6b 42 61 62 79 2e 64 6c 6c } //02 00  FuckBaby.dll
		$a_01_1 = {77 69 6e 64 6f 77 73 5c 74 65 6d 70 5c 73 76 63 68 6f 73 74 2e 65 78 65 } //01 00  windows\temp\svchost.exe
