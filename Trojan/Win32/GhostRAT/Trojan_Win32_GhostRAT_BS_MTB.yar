...
rule Trojan_Win32_GhostRAT_BS_MTB{
	...
	strings :
		...
		$a_01_1 = {66 75 63 6b 79 6f 75 } //01 00 
		$a_01_2 = {43 3a 5c 77 69 6e 64 6f 77 73 73 36 34 5c 63 6f 6d 70 75 74 65 72 2e 65 78 65 } //01 00 
		$a_01_3 = {34 37 2e 39 33 2e 36 30 2e 36 33 3a 38 30 30 30 2f 65 78 70 6c 6f 72 6f 72 2e 65 78 65 } //00 00 
	condition:
		any of ($a_*)
