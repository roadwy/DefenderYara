...
rule Trojan_Win32_GhostRAT_MC_MTB{
	...
	strings :
		$a_03_0 = {83 c0 01 89 45 f8 8b 0d 90 01 04 8b 55 f8 3b 91 fc 05 00 00 73 90 01 01 8b 45 f4 33 c9 8a 08 8b 55 fc 81 e2 ff 00 00 00 33 ca 8b 45 f4 88 08 8b 4d f4 83 c1 01 89 4d f4 eb 90 00 } //1
