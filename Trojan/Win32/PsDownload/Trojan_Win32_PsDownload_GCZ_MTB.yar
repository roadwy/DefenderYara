...
rule Trojan_Win32_PsDownload_GCZ_MTB{
	meta:
		description = "Trojan:Win32/PsDownload.GCZ!MTB,SIGNATURE_TYPE_PEHSTR_EXT,0b 00 0b 00 02 00 00 0a 00 "
		
	strings :
		$a_03_0 = {33 c0 66 89 85 90 01 04 66 0f 1f 44 00 90 01 01 8b 8d 90 01 04 03 c8 66 31 8c 45 90 01 04 40 83 f8 90 01 01 72 90 00 } //01 00 
