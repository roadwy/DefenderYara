...
rule Trojan_Win32_PsDownload_GDT_MTB{
	meta:
		description = "Trojan:Win32/PsDownload.GDT!MTB,SIGNATURE_TYPE_PEHSTR_EXT,0c 00 0c 00 03 00 00 "
		
	strings :
		$a_01_0 = {8b 85 30 fb ff ff 03 c1 66 31 84 4d 32 fb ff ff 41 83 f9 49 72 } //10
