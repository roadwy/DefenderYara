...
rule Trojan_Win32_PsDownload_GHA_MTB{
	meta:
		description = "Trojan:Win32/PsDownload.GHA!MTB,SIGNATURE_TYPE_PEHSTR_EXT,0c 00 0c 00 03 00 00 "
		
	strings :
		$a_03_0 = {03 14 81 52 e8 90 01 04 83 c4 90 01 01 35 90 01 04 89 45 d8 8b 45 d8 3b 45 08 75 17 8b 4d f4 8b 55 e0 0f b7 04 4a 8b 4d dc 8b 55 fc 03 14 81 8b c2 eb 90 00 } //10
