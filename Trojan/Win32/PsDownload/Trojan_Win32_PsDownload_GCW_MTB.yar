...
rule Trojan_Win32_PsDownload_GCW_MTB{
	meta:
		description = "Trojan:Win32/PsDownload.GCW!MTB,SIGNATURE_TYPE_PEHSTR_EXT,0c 00 0c 00 03 00 00 "
		
	strings :
		$a_03_0 = {03 14 81 52 e8 ?? ?? ?? ?? 59 35 ?? ?? ?? ?? 89 45 d8 8b 45 d8 3b 45 08 75 ?? 8b 45 f4 8b 4d e0 0f b7 04 41 8b 4d dc 8b 55 fc 03 14 81 8b c2 } //10
