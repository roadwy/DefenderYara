...
rule Trojan_Win32_PsDownload_GBX_MTB{
	meta:
		description = "Trojan:Win32/PsDownload.GBX!MTB,SIGNATURE_TYPE_PEHSTR_EXT,0b 00 0b 00 02 00 00 0a 00 "
		
	strings :
		$a_01_0 = {33 c1 66 89 85 c2 fb ff ff 33 c0 5f 66 89 85 c4 fb ff ff 5e 0f 1f 44 00 00 66 31 8c 45 32 fb ff ff 40 83 f8 49 73 09 66 8b 8d 30 fb ff ff eb } //01 00 
