...
rule Trojan_Win32_PsDownload_GJJ_MTB{
	meta:
		description = "Trojan:Win32/PsDownload.GJJ!MTB,SIGNATURE_TYPE_PEHSTR_EXT,0b 00 0b 00 02 00 00 0a 00 "
		
	strings :
		$a_03_0 = {33 c1 66 89 85 90 01 04 33 c0 53 66 89 85 90 01 04 5b 66 90 90 66 31 8c 45 90 01 04 40 83 f8 19 73 09 66 8b 8d 90 00 } //01 00 
