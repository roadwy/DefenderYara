...
rule Trojan_Win32_Sacto_A_dha{
	...
	strings :
		...
		$a_01_4 = {5c 53 73 6c 4d 4d } //01 00  \SslMM
		$a_01_5 = {25 77 73 3a 25 64 2f 25 64 25 73 25 64 48 54 54 50 2f 31 2e 31 00 } //01 00  眥㩳搥┯╤╳䡤呔⽐⸱1
		$a_01_6 = {6f 63 74 61 73 2e 74 6d 70 00 } //01 00 
		$a_01_7 = {2e 00 35 00 31 00 76 00 69 00 70 00 2e 00 62 00 69 00 7a 00 } //00 00  .51vip.biz
	condition:
		any of ($a_*)
