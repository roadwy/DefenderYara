...
rule Trojan_Win32_Vundo_JI{
	...
	strings :
		$a_01_0 = {41 74 74 65 6d 70 74 20 74 6f 20 75 73 65 20 4d 53 49 4c 20 63 6f 64 65 } //01 00  Attempt to use MSIL code
		$a_01_1 = {56 4d 4d 61 69 6e 4d 75 74 65 78 00 56 43 4d 4d 54 58 } //01 00  䵖慍湩畍整x䍖䵍塔
