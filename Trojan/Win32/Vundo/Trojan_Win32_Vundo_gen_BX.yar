...
rule Trojan_Win32_Vundo_gen_BX{
	...
	strings :
		$a_03_0 = {8d 14 88 8b 02 8b f8 33 7d 90 01 01 33 7d 90 01 01 89 45 90 01 01 89 3a 8b 45 90 01 01 8d 50 ff c1 ea 02 41 42 90 00 } //1
		$a_03_1 = {6a 07 99 59 f7 f9 85 d2 74 24 8b 44 24 90 01 01 85 c0 75 05 b8 90 00 } //1
