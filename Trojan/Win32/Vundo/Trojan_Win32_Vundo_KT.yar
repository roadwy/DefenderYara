...
rule Trojan_Win32_Vundo_KT{
	...
	strings :
		...
		$a_01_3 = {73 00 6f 00 66 00 74 00 6e 00 6f 00 74 00 69 00 66 00 79 00 2e 00 70 00 68 00 70 00 3f 00 } //01 00 
		...
		$a_01_5 = {46 00 48 00 44 00 54 00 69 00 6d 00 65 00 72 00 } //00 00 
	condition:
		any of ($a_*)
