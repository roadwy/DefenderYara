...
rule Trojan_Win32_Vundo_gen_Y{
	...
	strings :
		$a_03_0 = {6a 02 eb 01 53 53 ff 75 0c 56 ff 15 90 01 04 53 8d 45 08 50 6a 0d 57 56 ff 15 90 00 } //1
		...
		$a_03_3 = {e9 93 00 00 00 56 57 6a 0a 59 be 90 01 04 8d 7d a8 f3 a5 6a 29 33 f6 90 00 } //1
		$a_03_4 = {74 5a 6a 02 53 68 54 ff ff ff 56 ff 15 90 01 04 83 f8 ff 74 3f 57 6a 11 59 90 00 } //1
	condition:
