...
rule Trojan_Win32_Vundo_HM{
	...
	strings :
		...
		$a_03_2 = {73 0f 8a 88 90 01 03 10 30 88 90 01 03 10 40 eb ec 68 90 01 03 10 8d 4d d0 90 03 01 02 e8 ff 15 90 01 04 68 e0 93 04 00 ff 15 90 01 03 10 83 7d e8 10 8b 45 d4 73 03 8d 45 d4 57 57 56 8d 8d d0 fb ff ff 51 50 57 e8 90 09 1c 00 83 f8 90 00 } //3
		$a_02_3 = {25 73 3f 71 3d 25 73 26 75 3d 25 73 26 67 3d 25 73 26 76 3d 25 2e 32 66 26 6e 3d 90 01 03 26 61 3d 90 00 } //1
