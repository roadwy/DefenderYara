...
rule Trojan_Win32_Vundo_gen_AV{
	...
	strings :
		...
		$a_03_1 = {c1 e8 1f f7 d0 a8 01 74 ?? 81 e7 ff 00 00 00 83 ff 05 72 } //1
		$a_03_2 = {0f b7 04 02 03 c6 33 d2 8b 5d 0c f7 f3 8b f2 89 75 ?? 8a 04 0f 88 45 e7 8a 14 0e 88 14 0f 88 04 0e 47 89 7d ?? 8b 55 ?? eb } //1
