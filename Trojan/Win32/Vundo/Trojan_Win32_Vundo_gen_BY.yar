...
rule Trojan_Win32_Vundo_gen_BY{
	...
	strings :
		$a_03_0 = {68 b6 1f 00 00 e8 90 01 04 66 89 45 90 01 01 6a 00 6a 01 6a 02 90 00 } //1
		$a_03_1 = {8d 14 81 89 55 90 01 01 8b 45 90 01 01 8b 08 89 4d 90 01 01 8b 55 90 01 01 33 55 90 01 01 8b 45 90 01 01 33 10 90 00 } //1
