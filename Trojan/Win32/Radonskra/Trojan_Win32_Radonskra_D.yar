...
rule Trojan_Win32_Radonskra_D{
	...
	strings :
		...
		$a_00_2 = {64 2e 6c 6f 63 61 74 69 6f 6e 2e 70 72 6f 74 6f 63 6f 6c 3d 3d 27 68 74 74 70 73 3a 27 29 65 78 69 74 3b 6f 75 72 64 6f 6d 3d 27 48 54 54 50 27 } //00 00  d.location.protocol=='https:')exit;ourdom='HTTP'
