...
rule Trojan_Win32_Danglo_A{
	...
	strings :
		...
		$a_00_2 = {41 63 63 65 70 74 3a 20 2a 2f 2a } //01 00 
		$a_00_3 = {4c 49 42 47 43 43 57 33 32 2d 45 48 2d 32 2d 53 4a 4c 4a 2d 47 54 48 52 2d 4d 49 4e 47 57 33 32 } //00 00 
	condition:
		any of ($a_*)
