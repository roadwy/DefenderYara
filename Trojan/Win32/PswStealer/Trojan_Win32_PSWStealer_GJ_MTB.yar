...
rule Trojan_Win32_PSWStealer_GJ_MTB{
	...
	strings :
		...
		$a_01_2 = {53 48 43 68 61 6e 67 65 4e 6f 74 69 66 79 52 65 67 69 73 74 65 72 } //01 00  SHChangeNotifyRegister
		$a_01_3 = {52 65 67 69 73 74 65 72 45 76 65 6e 74 53 6f 75 72 63 65 } //01 00  RegisterEventSource
		$a_01_4 = {73 72 61 6e 64 } //00 00  srand
	condition:
		any of ($a_*)
