...
rule Trojan_Win32_Cryptbot_GLM_MTB{
	...
	strings :
		...
		$a_01_1 = {47 65 74 55 73 65 72 4e 61 6d 65 } //01 00  GetUserName
		$a_01_2 = {55 52 4c 44 6f 77 6e 6c 6f 61 64 54 6f 46 69 6c 65 } //01 00  URLDownloadToFile
		$a_01_3 = {53 68 65 6c 6c 45 78 65 63 75 74 65 } //01 00  ShellExecute
		$a_01_4 = {43 72 79 70 74 55 6e 70 72 6f 74 65 63 74 44 61 74 61 } //00 00  CryptUnprotectData
	condition:
		any of ($a_*)
