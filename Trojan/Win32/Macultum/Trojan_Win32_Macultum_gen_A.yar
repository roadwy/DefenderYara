...
rule Trojan_Win32_Macultum_gen_A{
	...
	strings :
		...
		$a_01_2 = {58 3a 5c 70 72 6f 6a 65 63 74 73 5c 70 78 5c 6d 6f 6e 69 74 6f 72 5c 4d 6f 6e 69 74 6f 72 2e 70 64 62 } //01 00  X:\projects\px\monitor\Monitor.pdb
		$a_01_3 = {4d 75 74 75 61 6c 20 69 6e 73 74 61 6c 6c 20 7c 20 72 65 6d 6f 76 65 } //00 00  Mutual install | remove
	condition:
		any of ($a_*)
