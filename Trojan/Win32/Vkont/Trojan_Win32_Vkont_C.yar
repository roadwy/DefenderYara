...
rule Trojan_Win32_Vkont_C{
	...
	strings :
		$a_00_0 = {5c 68 6f 73 74 73 5c 72 65 6c 65 61 73 65 5c 68 6f 73 74 73 2e 70 64 62 } //01 00 
		$a_00_1 = {44 41 54 41 3a 20 25 78 20 25 78 20 25 78 20 25 78 20 25 78 20 25 78 21 } //01 00 
