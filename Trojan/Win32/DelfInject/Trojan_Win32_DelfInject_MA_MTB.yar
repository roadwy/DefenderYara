...
rule Trojan_Win32_DelfInject_MA_MTB{
	...
	strings :
		...
		$a_01_2 = {43 74 72 6c 2b } //01 00  Ctrl+
		$a_01_3 = {73 68 75 74 64 6f 77 6e } //01 00  shutdown
		$a_01_4 = {67 65 74 70 72 6f 74 6f 62 79 6e 75 6d 62 65 72 } //01 00  getprotobynumber
		$a_01_5 = {57 53 41 55 6e 68 6f 6f 6b 42 6c 6f 63 6b 69 6e 67 48 6f 6f 6b } //01 00  WSAUnhookBlockingHook
		$a_01_6 = {47 65 74 4b 65 79 53 74 61 74 65 } //00 00  GetKeyState
	condition:
		any of ($a_*)
