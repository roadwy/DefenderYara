...
rule Trojan_Win32_DelfInject_A{
	...
	strings :
		...
		$a_01_1 = {20 2f 31 73 74 65 6d 61 69 6c 2e 70 68 70 20 48 54 54 50 2f 31 2e 31 } //01 00 
		$a_01_2 = {2e 31 36 32 2e 38 35 2e 32 33 34 } //01 00 
		$a_01_3 = {32 30 35 2e 32 35 31 2e 31 34 30 2e 31 37 38 } //00 00 
	condition:
		any of ($a_*)
