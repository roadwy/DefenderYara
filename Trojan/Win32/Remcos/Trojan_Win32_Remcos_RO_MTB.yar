...
rule Trojan_Win32_Remcos_RO_MTB{
	...
	strings :
		$a_02_0 = {8a 04 0a 34 90 01 01 04 90 01 01 34 90 01 01 2c 90 01 01 88 01 41 83 ee 01 75 90 01 01 68 de c0 ad de 90 00 } //1
		$a_02_1 = {8a 04 0a 34 90 01 01 2c 90 01 01 34 90 01 01 2c 90 01 01 88 01 41 83 ee 01 75 90 01 01 68 de c0 ad de 90 00 } //1
	condition:
