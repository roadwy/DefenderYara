...
rule Trojan_Win32_Remcos_ARM_MTB_2{
	...
	strings :
		$a_03_0 = {8b d8 03 5d a4 6a 00 e8 90 01 04 2b d8 8b 45 d4 31 18 83 45 ec 04 6a 00 e8 90 01 04 83 c0 04 01 45 d4 8b 45 ec 3b 45 d0 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_Win32_Remcos_ARM_MTB_4{
	...
	strings :
		$a_03_0 = {8b 07 8b 4f f8 05 90 01 04 03 4d e8 6a 00 ff 77 fc 50 51 53 ff d6 8b 45 e4 8d 7f 28 8b 4d e0 41 90 00 } //1
		$a_03_1 = {03 02 03 f0 c7 45 f8 90 01 04 8d 45 ec 50 6a 04 8d 45 f8 50 56 ff 75 d4 ff 15 90 01 04 8b 45 c4 01 45 f8 8d 45 f8 6a 00 6a 04 50 56 ff 75 d4 ff 15 90 00 } //1
	condition:
