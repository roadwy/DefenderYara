...
rule Trojan_Win32_SKNet{
	...
	strings :
		...
		$a_01_4 = {53 4b 4e 65 74 53 72 76 5f 44 4c 4c 2e } //05 00 
		$a_01_5 = {5b 21 5d 44 65 76 69 63 65 49 6f 43 6f 6e 74 72 6f 6c 20 66 61 69 6c 65 64 2e 20 6d 61 79 62 65 20 68 61 73 20 62 65 65 6e 20 69 6e 6a 65 63 74 65 64 21 } //00 00 
	condition:
		any of ($a_*)
