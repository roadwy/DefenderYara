...
rule Trojan_Win32_Vxidl_gen_C{
	...
	strings :
		...
		$a_02_3 = {40 00 8b c0 53 33 db 6a 00 e8 90 01 02 ff ff 83 f8 07 75 90 00 } //2
		$a_02_4 = {8b 55 f0 8d 45 f4 e8 90 01 02 ff ff 6a 00 68 80 00 00 00 6a 04 6a 00 6a 00 68 00 00 00 40 8b 45 fc 90 00 } //2
