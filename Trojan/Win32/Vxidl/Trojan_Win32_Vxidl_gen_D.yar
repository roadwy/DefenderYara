...
rule Trojan_Win32_Vxidl_gen_D{
	...
	strings :
		$a_02_0 = {83 ff ff 75 04 31 c0 eb 90 01 01 6a 02 6a 00 6a 00 57 e8 90 02 06 6a 00 90 02 0a 8d 45 fc 50 ff 75 10 ff 75 0c 57 90 00 } //4
		$a_02_1 = {00 75 0c c7 45 fc 90 01 01 00 00 00 e9 90 01 01 00 00 00 6a 00 6a 00 6a 00 6a 00 90 00 } //3
