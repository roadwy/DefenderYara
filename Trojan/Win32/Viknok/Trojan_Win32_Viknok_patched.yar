...
rule Trojan_Win32_Viknok_patched{
	...
	strings :
		...
		$a_03_1 = {81 ef 51 6a 00 00 8d 8f 51 6a 00 00 5f 66 81 ea 63 bf 66 81 c2 63 bf 51 81 eb 21 fd 4e 28 81 c3 21 fd 4e 28 68 90 01 04 58 04 69 2c 69 ff d0 90 00 } //1
