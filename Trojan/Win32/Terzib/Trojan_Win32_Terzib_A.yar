...
rule Trojan_Win32_Terzib_A{
	...
	strings :
		...
		$a_01_1 = {44 45 4c 20 2f 51 20 2f 53 20 22 25 73 5c 68 69 73 74 6f 72 79 } //01 00 
		$a_01_2 = {43 6f 6f 6b 69 65 3a 20 2f 73 65 61 72 63 68 3f 68 6c 3d 65 6e 3d 71 3d } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Terzib_A_3{
	...
	strings :
		$a_01_0 = {44 45 4c 20 2f 51 20 2f 53 20 22 25 73 5c 68 69 73 74 6f 72 79 } //01 00 
		$a_01_1 = {43 6f 6f 6b 69 65 3a 20 2f 73 65 61 72 63 68 3f 68 6c 3d 65 6e 3d 71 3d } //01 00 
