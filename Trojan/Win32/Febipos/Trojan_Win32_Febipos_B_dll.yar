...
rule Trojan_Win32_Febipos_B_dll{
	...
	strings :
		...
		$a_03_4 = {89 5d fc 8b 45 d0 be 08 00 00 00 39 75 e4 73 03 8d 45 d0 68 90 01 04 68 78 dc 00 10 50 e8 90 01 04 83 c4 0c 89 5d cc 39 5d e0 75 12 be 13 00 00 00 8d 45 d0 90 00 } //2
