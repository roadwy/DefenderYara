...
rule Trojan_Win32_Febipos_C{
	...
	strings :
		...
		$a_03_4 = {8d 85 c4 e9 ff ff 66 c7 00 58 58 c6 40 02 00 8d 85 d4 fd ff ff 89 04 24 e8 7b 0a 00 00 c7 44 24 04 90 01 04 8d 85 c4 e9 ff ff 89 04 24 e8 90 01 04 85 c0 0f 85 0a 02 00 00 8b 45 dc 89 44 24 08 c7 44 24 04 90 01 04 8d 85 d4 fd ff ff 89 04 24 e8 90 00 } //2
	condition:
