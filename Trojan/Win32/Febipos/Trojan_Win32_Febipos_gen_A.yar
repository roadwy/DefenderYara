...
rule Trojan_Win32_Febipos_gen_A{
	...
	strings :
		...
		$a_03_7 = {74 04 c6 45 e2 01 8a 45 e2 83 f0 01 84 c0 74 7e 8b 85 90 01 02 ff ff 89 04 24 e8 90 01 04 89 45 e4 eb 01 90 90 8b 85 90 01 02 ff ff 89 04 24 e8 90 00 } //2
		$a_03_8 = {3b 45 e4 7c cf eb 08 83 7d 90 01 01 65 75 a6 eb 02 eb a2 8b 45 f4 40 89 45 90 00 } //2
		$a_01_9 = {89 45 d8 eb 58 8a 45 f3 83 f0 01 84 c0 74 15 8b 45 dc 89 44 24 04 8d 85 d8 f5 ff ff 89 04 24 e8 } //2
		$a_03_10 = {7c c2 eb 08 83 7d 90 01 01 65 75 99 eb 02 eb 95 8a 45 e3 83 f0 01 84 c0 0f 84 7e 02 00 00 90 00 } //2
	condition:
