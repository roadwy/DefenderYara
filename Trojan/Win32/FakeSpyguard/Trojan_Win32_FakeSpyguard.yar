...
rule Trojan_Win32_FakeSpyguard_4{
	...
	strings :
		...
		$a_03_3 = {6a ff 68 01 00 1f 00 e8 90 01 04 85 c0 75 90 01 01 68 90 01 04 6a 00 e8 90 01 04 85 c0 77 90 01 01 6a 00 90 00 } //3
		$a_03_4 = {68 dc 05 00 00 e8 90 01 04 68 90 01 04 6a 00 e8 90 01 04 6a 00 6a 00 68 03 04 00 00 50 e8 90 01 04 eb 90 00 } //3
	condition:
...
rule Trojan_Win32_FakeSpyguard_5{
	...
	strings :
		$a_02_0 = {5c 4d 69 63 72 6f 73 6f 66 74 20 90 03 01 01 41 50 44 61 74 61 5c 90 00 } //2
...
rule Trojan_Win32_FakeSpyguard_6{
	...
	strings :
		...
		$a_02_2 = {57 69 6e 64 6f 77 73 20 53 65 63 75 72 69 74 79 20 43 65 6e 74 65 72 20 72 65 70 6f 72 74 73 20 74 68 61 74 20 90 02 20 20 69 73 20 69 6e 61 63 74 69 76 65 2e 90 00 } //1
...
rule Trojan_Win32_FakeSpyguard_7{
	...
	strings :
		...
		$a_02_6 = {5c 4d 69 63 72 6f 73 6f 66 74 20 90 03 01 01 41 50 44 61 74 61 5c 90 00 } //1
...
rule Trojan_Win32_FakeSpyguard_8{
	...
	strings :
		...
		$a_02_8 = {53 70 79 77 61 72 65 20 47 75 61 72 64 20 32 30 90 02 02 20 69 6e 73 74 61 6c 6c 61 74 69 6f 6e 90 00 } //1
	condition:
