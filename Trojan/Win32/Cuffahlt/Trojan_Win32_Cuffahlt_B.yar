...
rule Trojan_Win32_Cuffahlt_B{
	...
	strings :
		...
		$a_01_1 = {53 45 4c 45 43 54 20 2a 20 46 52 4f 4d 20 57 69 6e 33 32 5f 42 61 73 65 42 6f 61 72 64 } //01 00 
		$a_01_2 = {63 6d 64 2e 65 78 65 20 2f 43 20 69 70 63 6f 6e 61 65 69 } //01 00 
