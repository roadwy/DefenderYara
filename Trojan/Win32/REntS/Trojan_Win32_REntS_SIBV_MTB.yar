...
rule Trojan_Win32_REntS_SIBV_MTB{
	meta:
		description = "Trojan:Win32/REntS.SIBV!MTB,SIGNATURE_TYPE_PEHSTR_EXT,02 00 02 00 02 00 00 01 00 "
		
	strings :
		$a_00_0 = {6f 6f 61 63 6d 6a 69 67 2e 70 64 62 } //01 00  ooacmjig.pdb
