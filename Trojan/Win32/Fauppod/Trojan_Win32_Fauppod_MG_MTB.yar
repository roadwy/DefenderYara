...
rule Trojan_Win32_Fauppod_MG_MTB{
	...
	strings :
		$a_01_0 = {55 62 79 63 6f 6d 69 54 72 67 79 62 } //02 00  UbycomiTrgyb
		$a_01_1 = {50 6e 75 62 79 45 63 66 76 67 62 68 } //02 00  PnubyEcfvgbh
		$a_01_2 = {50 6e 75 79 62 44 74 76 79 62 } //01 00  PnuybDtvyb
