...
rule Trojan_Win32_Fauppod_A{
	...
	strings :
		...
		$a_03_2 = {e8 de ff ff ff 40 90 0a 1a 00 89 18 89 f0 01 05 90 01 04 89 ea 01 15 90 00 } //1
		$a_03_3 = {e8 df ff ff ff 40 90 0a 2a 00 e8 90 01 04 89 d8 a3 90 01 04 89 f0 31 05 90 01 04 89 ea 01 15 90 00 } //1
