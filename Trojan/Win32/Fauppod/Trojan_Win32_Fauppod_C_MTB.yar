...
rule Trojan_Win32_Fauppod_C_MTB{
	...
	strings :
		...
		$a_01_2 = {57 64 72 63 74 66 50 6a 6e 6b 68 62 67 } //02 00  WdrctfPjnkhbg
		$a_01_3 = {4d 62 69 68 75 79 76 74 79 44 74 72 63 79 76 } //02 00  MbihuyvtyDtrcyv
		$a_01_4 = {52 63 79 74 76 67 48 76 75 62 68 6d } //00 00  RcytvgHvubhm
	condition:
		any of ($a_*)
