...
rule Trojan_Win32_Phyiost_B{
	...
	strings :
		$a_00_0 = {73 66 63 5f 6f 73 2e 64 6c 6c } //01 00  sfc_os.dll
		$a_00_1 = {63 6d 64 20 2f 63 20 6e 65 74 20 73 74 61 72 74 20 73 72 73 65 72 76 69 63 } //01 00  cmd /c net start srservic
		$a_00_2 = {63 6d 64 20 2f 63 20 72 65 6e 20 } //01 00  cmd /c ren 
