...
rule Trojan_Win32_Phyiost_B{
	...
	strings :
		...
		$a_02_3 = {c7 07 64 6c 6c 63 83 c7 04 c7 07 61 63 68 65 83 c7 04 c7 07 5c 73 72 73 83 c7 04 c7 07 76 63 2e 64 83 c7 04 66 c7 07 6c 6c 83 c7 02 c6 07 00 6a 00 68 90 01 04 e8 90 01 04 8d 3d 90 01 04 8d 35 90 01 04 b9 0b 00 00 00 f3 a4 90 00 } //1
	condition:
