...
rule Trojan_Win32_BatchWiper_MA_MTB{
	...
	strings :
		$a_03_0 = {8b 55 f8 81 c2 00 40 00 00 89 15 90 01 04 a1 90 01 04 83 c0 05 50 8b 0d 90 01 04 51 6a 01 8b 15 90 01 04 52 ff 15 90 01 04 a3 90 01 04 a1 90 01 04 03 45 0c 89 45 fc 8b 4d 0c 03 4d 08 89 0d b0 b3 40 00 8b 45 fc 8b e5 5d c2 90 00 } //5
