...
rule Trojan_Win32_BatchWiper_MA_MTB{
	...
	strings :
		...
		$a_01_1 = {2e 74 6d 70 5c 44 72 65 53 5f 58 2e 62 61 74 } //01 00 
		$a_01_2 = {74 61 73 6b 6b 69 6c 6c 20 2f 66 20 2f 69 6d 20 74 61 73 6b 6d 67 72 2e 65 78 65 } //01 00 
		$a_01_3 = {50 6c 65 61 73 65 20 65 6e 74 65 72 20 74 68 65 20 70 61 73 73 77 6f 72 64 2e } //01 00 
		$a_01_4 = {40 65 63 68 6f 20 6f 66 66 } //00 00 
	condition:
		any of ($a_*)
