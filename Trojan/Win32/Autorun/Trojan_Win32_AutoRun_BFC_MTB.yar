...
rule Trojan_Win32_AutoRun_BFC_MTB{
	...
	strings :
		...
		$a_00_1 = {73 68 65 6c 6c 5c 53 65 61 72 63 68 2e 2e 2e 5c 63 6f 6d 6d 61 6e 64 3d 4d 79 5f 4d 75 73 69 63 2e 65 78 65 20 3a 3a 7b 31 66 34 64 65 33 37 30 2d 64 36 32 37 2d 31 31 64 31 2d 62 61 34 66 2d 30 30 61 30 63 39 31 65 65 64 62 61 7d } //01 00  shell\Search...\command=My_Music.exe ::{1f4de370-d627-11d1-ba4f-00a0c91eedba}
