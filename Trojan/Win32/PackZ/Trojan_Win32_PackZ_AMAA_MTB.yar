...
rule Trojan_Win32_PackZ_AMAA_MTB{
	...
	strings :
		...
		$a_03_1 = {8a 07 09 d9 09 c9 88 06 21 cb 09 c9 bb 90 01 04 46 81 c1 90 01 04 81 c3 90 01 04 81 c3 01 00 00 00 81 c7 02 00 00 00 01 cb 43 39 d7 0f 8e 90 00 } //1
	condition:
