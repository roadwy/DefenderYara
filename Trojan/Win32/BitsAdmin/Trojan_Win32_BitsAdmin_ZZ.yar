...
rule Trojan_Win32_BitsAdmin_ZZ{
	...
	strings :
		$a_00_0 = {62 00 69 00 74 00 73 00 61 00 64 00 6d 00 69 00 6e 00 } //01 00 
		$a_00_1 = {2f 00 74 00 72 00 61 00 6e 00 73 00 66 00 65 00 72 00 } //01 00 
		$a_00_2 = {2f 00 64 00 6f 00 77 00 6e 00 6c 00 6f 00 61 00 64 00 } //01 00 
		$a_00_3 = {2f 00 70 00 72 00 69 00 6f 00 72 00 69 00 74 00 79 00 } //01 00 
