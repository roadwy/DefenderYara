...
rule Trojan_Win32_Clopdor_A{
	...
	strings :
		...
		$a_03_2 = {6a 00 6a 00 6a 00 8b 55 ec 52 ff 15 90 01 02 00 10 6a 05 90 00 } //2
		$a_03_3 = {8a 0a 32 8c 05 90 01 02 ff ff 8b 95 90 01 02 ff ff 03 95 90 01 02 ff ff 88 0a eb bd 6a 00 90 00 } //2
