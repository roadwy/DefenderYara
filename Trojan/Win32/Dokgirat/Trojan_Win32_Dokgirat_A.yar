...
rule Trojan_Win32_Dokgirat_A{
	...
	strings :
		$a_01_0 = {5c 46 69 6e 61 6c 31 73 74 73 70 79 5c 4c 6f 61 64 44 6c 6c 5c 52 65 6c 65 61 73 65 5c 4c 6f 61 64 44 6c 6c 2e 70 64 62 } //01 00  \Final1stspy\LoadDll\Release\LoadDll.pdb
