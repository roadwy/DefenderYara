...
rule Trojan_Win32_Fiya_E{
	...
	strings :
		...
		$a_01_1 = {70 61 73 73 3d 65 72 61 69 6a 6f 6b 6c 34 38 39 69 6f 68 6a 34 6b 72 64 73 } //01 00  pass=eraijokl489iohj4krds
		$a_03_2 = {74 47 bf ff 00 00 00 e8 90 01 04 99 f7 ff ff b5 4c fc ff ff 30 95 ef fc ff ff 90 00 } //01 00 
		$a_01_3 = {6e 6f 74 69 66 69 63 61 74 65 2e 70 68 70 } //01 00  notificate.php
