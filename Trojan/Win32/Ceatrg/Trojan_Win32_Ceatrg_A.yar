...
rule Trojan_Win32_Ceatrg_A{
	...
	strings :
		...
		$a_03_1 = {6a 00 68 01 20 00 00 56 8b 43 04 50 e8 90 01 04 85 c0 7e 03 40 75 90 01 01 8b 43 04 50 e8 90 01 04 68 88 13 00 00 e8 90 01 04 e9 90 01 02 ff ff 90 00 } //1
	condition:
