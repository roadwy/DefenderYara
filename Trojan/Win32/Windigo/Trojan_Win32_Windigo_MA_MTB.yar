...
rule Trojan_Win32_Windigo_MA_MTB{
	...
	strings :
		$a_01_0 = {45 75 7a 42 33 4b 69 70 47 73 73 61 62 42 6f 38 } //05 00  EuzB3KipGssabBo8
		$a_01_1 = {76 7a 79 37 57 79 53 36 58 6f 31 63 55 7a 39 50 58 6d 2f 35 36 47 30 78 45 6f 39 75 } //05 00  vzy7WyS6Xo1cUz9PXm/56G0xEo9u
		...
		$a_01_4 = {55 50 58 30 } //01 00  UPX0
		$a_01_5 = {55 50 58 31 } //00 00  UPX1
	condition:
		any of ($a_*)
