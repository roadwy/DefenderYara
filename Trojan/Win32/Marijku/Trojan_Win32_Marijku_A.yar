...
rule Trojan_Win32_Marijku_A{
	...
	strings :
		$a_03_0 = {81 78 0c 64 26 08 00 74 09 c7 46 18 0d 00 00 c0 eb 22 57 68 90 01 02 01 00 57 57 57 68 ff 03 1f 00 90 00 } //1
		$a_03_1 = {6a 1b 8d 7e 38 59 b8 90 01 02 01 00 f3 ab c7 46 34 90 01 02 01 00 fa 0f 20 c0 25 ff ff fe ff 0f 22 c0 0f 20 c0 0d 00 00 01 00 0f 22 c0 fb 53 90 00 } //1
	condition:
...
rule Trojan_Win32_Marijku_A_2{
	...
	strings :
		$a_03_0 = {68 64 26 08 00 8b 4d f0 51 ff 15 90 01 03 10 89 45 a8 8b 55 f0 52 ff 15 90 01 03 10 8b 4d f4 64 89 0d 00 00 00 00 90 00 } //10
