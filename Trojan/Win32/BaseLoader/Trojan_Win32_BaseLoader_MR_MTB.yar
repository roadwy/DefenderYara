...
rule Trojan_Win32_BaseLoader_MR_MTB{
	...
	strings :
		...
		$a_81_2 = {53 74 61 72 74 73 57 69 74 68 } //01 00 
		$a_81_3 = {45 6e 64 73 57 69 74 68 } //01 00 
		$a_81_4 = {54 6f 43 68 61 72 } //01 00 
		$a_81_5 = {54 6f 53 74 72 69 6e 67 } //01 00 
		$a_81_6 = {54 6f 42 79 74 65 } //01 00 
		$a_81_7 = {54 6f 49 6e 74 33 32 } //00 00 
	condition:
		any of ($a_*)
