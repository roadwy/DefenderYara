...
rule Trojan_Win32_QQPhishing_A{
	...
	strings :
		...
		$a_00_3 = {51 51 50 6f 70 2e 63 53 79 73 54 72 61 79 } //01 00  QQPop.cSysTray
		$a_00_4 = {23 00 51 00 51 00 55 00 73 00 65 00 72 00 23 00 } //01 00  #QQUser#
		$a_00_5 = {63 00 6f 00 75 00 6e 00 74 00 75 00 72 00 6c 00 } //00 00  counturl
	condition:
		any of ($a_*)
