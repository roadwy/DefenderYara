...
rule Trojan_Win32_QakBot_RPR_MTB_2{
	...
	strings :
		$a_01_0 = {41 46 64 39 72 48 4d 31 61 } //01 00  AFd9rHM1a
		$a_01_1 = {42 61 74 61 4d 36 6f 68 6f 6f } //01 00  BataM6ohoo
		$a_01_2 = {41 78 69 6f 39 50 35 57 } //01 00  Axio9P5W
		$a_01_3 = {43 4e 6e 45 50 78 } //01 00  CNnEPx
		$a_01_4 = {43 5a 78 44 51 6b 56 } //01 00  CZxDQkV
		$a_01_5 = {44 59 63 66 43 42 78 53 } //00 00  DYcfCBxS
	condition:
		any of ($a_*)
