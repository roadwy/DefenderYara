...
rule Trojan_Win32_Qakbot_PC_MTB{
	...
	strings :
		$a_01_0 = {6f 6c 65 33 34 35 34 2e 64 6c 6c } //01 00 
		$a_01_1 = {5c 44 6c 6c 5c 6f 75 74 2e 70 64 62 } //01 00 
		$a_01_2 = {44 6c 6c 52 65 67 69 73 74 65 72 53 65 72 76 65 72 } //04 00 
