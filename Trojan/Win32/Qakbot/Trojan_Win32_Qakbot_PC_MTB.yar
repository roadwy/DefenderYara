...
rule Trojan_Win32_Qakbot_PC_MTB{
	...
	strings :
		...
		$a_03_3 = {d3 fa 89 15 90 01 04 8b 4d 90 01 01 2b 4d 90 01 01 2b 0d 90 01 04 03 4d 90 01 01 8b 45 90 01 01 d3 f8 33 45 90 01 01 8b 55 90 01 01 8b 0d 90 01 04 d3 fa 33 55 90 01 01 8b 4d 90 01 01 2b 4d 90 01 01 8b 35 90 01 04 d3 e6 33 d6 3b c2 7f 90 00 } //4
	condition:
