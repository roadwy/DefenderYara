...
rule Trojan_Win32_Qakbot_EY_MTB{
	...
	strings :
		$a_03_0 = {89 18 6a 00 e8 90 01 04 8b d8 8b 45 c4 03 45 a4 03 d8 6a 00 e8 90 01 04 2b d8 8b 45 d8 33 18 89 5d a0 6a 00 e8 90 01 04 8b d8 03 5d a0 6a 00 e8 90 01 04 2b d8 8b 45 d8 89 18 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
