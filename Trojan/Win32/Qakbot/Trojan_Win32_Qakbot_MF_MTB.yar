...
rule Trojan_Win32_Qakbot_MF_MTB_3{
	...
	strings :
		$a_01_0 = {00 6d 76 5f 61 64 64 5f 69 00 } //01 00 
		$a_01_1 = {6d 76 5f 61 64 6c 65 72 33 32 5f 75 70 64 61 74 65 } //01 00 
		$a_01_2 = {6d 76 5f 61 65 73 5f 61 6c 6c 6f 63 } //01 00 
		$a_01_3 = {6d 76 5f 61 65 73 5f 63 74 72 5f 69 6e 63 72 65 6d 65 6e 74 5f 69 76 } //01 00 
		$a_01_4 = {6d 76 5f 61 73 73 65 72 74 30 5f 66 70 75 } //01 00 
		$a_01_5 = {6d 76 5f 62 6c 6f 77 66 69 73 68 5f 63 72 79 70 74 } //01 00 
		$a_01_6 = {6d 76 5f 61 75 64 69 6f 5f 66 69 66 6f 5f 64 72 61 69 6e } //01 00 
		$a_01_7 = {6d 76 5f 61 75 64 69 6f 5f 66 69 66 6f 5f 70 65 65 6b 5f 61 74 } //01 00 
		$a_01_8 = {6d 76 5f 63 61 6d 65 6c 6c 69 61 5f 63 72 79 70 74 } //01 00 
		$a_01_9 = {6e 65 78 74 } //00 00 
	condition:
		any of ($a_*)
