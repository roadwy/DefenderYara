...
rule Trojan_Win32_Qakbot_AI_MTB{
	...
	strings :
		$a_01_0 = {32 66 30 61 62 32 37 31 37 61 66 39 62 66 65 30 } //01 00  2f0ab2717af9bfe0
		$a_01_1 = {33 61 36 66 37 64 63 30 36 62 37 63 31 62 66 31 } //01 00  3a6f7dc06b7c1bf1
		$a_01_2 = {35 33 63 64 37 65 37 34 36 39 63 33 33 32 63 30 } //00 00  53cd7e7469c332c0
	condition:
		any of ($a_*)
