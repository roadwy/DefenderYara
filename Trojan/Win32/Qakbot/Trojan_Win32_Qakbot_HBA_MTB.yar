...
rule Trojan_Win32_Qakbot_HBA_MTB{
	...
	strings :
		...
		$a_01_1 = {6d 6e 6a 68 75 69 76 34 30 } //01 00 
		$a_01_2 = {61 65 72 6f 66 6c 6f 74 } //01 00 
		$a_01_3 = {4a 6a 69 73 63 68 75 67 } //01 00 
		$a_01_4 = {44 72 61 77 54 68 65 6d 65 49 63 6f 6e } //00 00 
	condition:
		any of ($a_*)
