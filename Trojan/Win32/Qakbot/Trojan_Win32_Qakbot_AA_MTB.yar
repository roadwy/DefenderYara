...
rule Trojan_Win32_Qakbot_AA_MTB{
	...
	strings :
		$a_03_0 = {d3 c0 8a fc 8a e6 d3 cb ff 4d ?? 75 ?? 89 4d ?? 2b 4d ?? 09 d9 83 e0 00 09 c8 8b 4d ?? 59 aa 49 75 } //2
	condition:
		((#a_03_0  & 1)*2) >=2
...
rule Trojan_Win32_Qakbot_AA_MTB_2{
	...
	strings :
		$a_03_0 = {0f b6 1c 30 8b 55 ?? d3 c2 23 d3 ac 0a c2 88 07 47 ff 4d } //1
		$a_03_1 = {d3 c0 8a fc 8a e6 d3 cb ff 4d ?? 75 ?? 59 8b c3 aa 49 75 } //1
	condition:
