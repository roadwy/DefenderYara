...
rule Trojan_Win32_Qakbot_DK_MTB{
	...
	strings :
		$a_03_0 = {2d 80 0d 00 00 03 05 90 01 04 a3 90 01 04 a1 90 01 04 03 05 90 01 04 8b 15 90 01 04 31 02 6a 00 e8 90 01 04 8b d8 a1 90 01 04 83 c0 04 03 d8 6a 00 e8 90 01 04 2b d8 6a 00 e8 90 01 04 03 d8 6a 00 e8 90 01 04 2b d8 6a 00 e8 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
