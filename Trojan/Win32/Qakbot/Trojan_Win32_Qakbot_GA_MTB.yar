...
rule Trojan_Win32_Qakbot_GA_MTB_2{
	...
	strings :
		$a_02_0 = {0f b6 c1 2b c3 83 c0 90 01 01 a3 90 02 04 8b 06 05 90 02 04 89 06 83 c6 04 a3 90 02 04 0f b6 c1 66 03 05 90 02 04 66 03 c2 89 74 24 90 01 01 66 03 44 24 90 01 01 8b f2 66 03 f8 83 6c 24 90 01 01 01 66 89 7c 24 90 01 01 0f 85 90 00 } //10
	condition:
		((#a_02_0  & 1)*10) >=10
...
rule Trojan_Win32_Qakbot_GA_MTB_3{
	...
	strings :
		$a_02_0 = {8b 00 8b d9 2b 5c 24 90 01 01 05 90 01 04 52 81 c3 a6 eb 00 00 a3 90 01 04 51 89 1d 90 01 04 8b 5c 24 90 01 01 6a 00 ff 74 24 90 01 01 89 03 e8 90 01 04 8b c8 8b c3 8b 1d 90 01 04 83 c0 04 83 6c 24 90 01 01 01 89 44 24 90 01 01 75 90 00 } //10
	condition:
		((#a_02_0  & 1)*10) >=10
...
rule Trojan_Win32_Qakbot_GA_MTB_5{
	...
	strings :
		$a_02_0 = {b9 40 00 00 00 90 02 04 00 ff 75 90 02 04 68 00 10 00 00 90 02 06 00 ff 75 90 02 04 57 83 90 02 02 00 31 90 02 02 ff 93 90 00 } //1
		$a_02_1 = {fc f3 a4 b9 ff ff 90 02 02 ff b3 90 02 04 8f 45 90 02 02 ff 75 90 02 02 58 68 90 02 04 8f 83 90 02 04 21 8b 90 02 04 57 8b bb 90 02 04 50 8f 45 90 02 02 01 7d 90 02 02 ff 75 90 02 02 58 5f ff e0 90 00 } //1
	condition:
...
rule Trojan_Win32_Qakbot_GA_MTB_6{
	...
	strings :
		...
		$a_02_2 = {8a 0c 32 88 0c 38 8b 55 90 01 01 83 c2 90 01 01 89 55 90 02 06 5f 5e 8b e5 5d c3 90 0a 28 00 03 45 90 01 01 8b 55 90 00 } //1
		$a_02_3 = {8b ff 8b 0d 90 01 04 8b 15 90 01 04 89 11 90 0a ff 00 90 17 04 01 01 01 01 31 32 30 33 90 02 c8 a1 90 01 04 c7 05 90 01 04 00 00 00 00 01 05 90 00 } //1
	condition:
...
rule Trojan_Win32_Qakbot_GA_MTB_8{
	...
	strings :
		...
		$a_02_4 = {03 f0 8b 45 90 01 01 03 30 8b 4d 90 01 01 89 31 8b 55 90 01 01 8b 02 2d bc 01 00 00 8b 4d 90 01 01 89 01 5e 8b e5 5d c3 90 00 } //10
		$a_02_5 = {8a 0c 32 88 0c 38 8b 55 90 01 01 83 c2 90 01 01 89 55 90 01 01 eb 90 01 01 5f 5e 8b e5 5d c3 90 00 } //10
		$a_02_6 = {8b ff 8b 0d 90 01 04 8b 15 90 01 04 89 11 90 0a ff 00 90 17 04 01 01 01 01 31 32 30 33 90 02 c8 a1 90 01 04 c7 05 90 01 04 00 00 00 00 01 05 90 00 } //10
	condition:
