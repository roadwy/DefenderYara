...
rule Trojan_Win32_Qakbot_DE_MTB{
	...
	strings :
		$a_03_0 = {0f b6 c0 3b c2 90 01 02 2a 5c 24 0c 8b 06 2b 4c 24 14 05 94 d4 08 01 03 cf 89 06 a3 90 01 04 83 c6 04 8a c1 89 0d 90 01 04 2a 44 24 0c 04 6f 83 6c 24 10 01 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
