...
rule Trojan_Win32_QakBot_BA_MTB_3{
	...
	strings :
		$a_01_0 = {43 33 7a 49 73 62 52 34 75 64 41 } //03 00 
		$a_01_1 = {43 43 36 50 73 46 } //03 00 
		$a_01_2 = {43 62 4a 56 79 51 30 39 38 76 64 } //03 00 
		$a_01_3 = {44 6c 6c 52 65 67 69 73 74 65 72 53 65 72 76 65 72 } //03 00 
		$a_01_4 = {47 65 74 43 6f 6d 6d 61 6e 64 4c 69 6e 65 41 } //03 00 
		$a_01_5 = {46 69 6e 64 46 69 72 73 74 46 69 6c 65 45 78 57 } //00 00 
	condition:
		any of ($a_*)
