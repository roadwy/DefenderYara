...
rule Trojan_Win32_QakBot_BA_MTB{
	...
	strings :
		$a_03_0 = {8a 04 0f 88 01 41 83 ea 90 01 01 75 f5 90 00 } //1
		$a_03_1 = {8b c1 83 e0 90 01 01 8a 44 10 90 01 01 30 04 31 41 3b cf 72 90 00 } //1
	condition:
...
rule Trojan_Win32_QakBot_BA_MTB_2{
	...
	strings :
		$a_03_0 = {8b d8 03 1d 90 02 04 6a 00 e8 90 02 04 2b d8 a1 90 02 04 33 18 89 1d 90 02 04 6a 00 e8 90 02 04 03 05 90 02 04 8b 15 90 02 04 89 02 a1 90 02 04 83 c0 04 a3 90 02 04 33 c0 a3 90 02 04 a1 90 02 04 83 c0 04 03 05 90 02 04 a3 90 02 04 a1 90 02 04 3b 05 90 02 04 0f 90 00 } //5
	condition:
		((#a_03_0  & 1)*5) >=5
