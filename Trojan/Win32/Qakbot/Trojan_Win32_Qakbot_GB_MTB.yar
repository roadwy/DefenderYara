...
rule Trojan_Win32_Qakbot_GB_MTB_2{
	...
	strings :
		$a_02_0 = {8a 02 88 01 8b 4d 90 01 01 83 c1 01 89 4d 90 01 01 8b 55 90 01 01 83 c2 01 89 55 90 01 01 8b 45 90 01 01 2d 44 49 00 00 03 45 fc 2b 05 90 01 04 8b 0d 90 01 04 03 c8 89 0d 90 01 04 c7 45 90 01 01 01 00 00 00 eb 90 00 } //10
	condition:
		((#a_02_0  & 1)*10) >=10
...
rule Trojan_Win32_Qakbot_GB_MTB_3{
	...
	strings :
		$a_02_0 = {0f b7 f3 02 c6 02 c2 0f b6 c0 6b c0 90 01 01 2b f0 89 35 90 02 04 8a 15 90 02 04 8d 87 90 02 04 8b 7c 24 90 01 01 8a f3 80 c2 90 01 01 a3 90 02 04 02 d6 8a 35 90 02 04 89 07 83 c7 04 83 6c 24 90 01 01 01 89 7c 24 90 01 01 0f 85 90 00 } //10
	condition:
		((#a_02_0  & 1)*10) >=10
...
rule Trojan_Win32_Qakbot_GB_MTB_4{
	...
	strings :
		$a_02_0 = {0f b6 da 2b d8 83 c3 01 89 1d 90 01 04 8a c1 b3 90 01 01 f6 eb 2a c2 8a d0 83 7c 24 90 01 01 00 75 90 00 } //10
		$a_02_1 = {8b cb 6b c9 90 01 01 2b c8 2b c8 8d 4c 19 01 8b 6c 24 90 01 01 6b c0 90 01 01 81 c6 90 01 04 2b c7 89 75 00 03 c2 83 c5 04 83 6c 24 90 01 01 01 90 00 } //10
	condition:
...
rule Trojan_Win32_Qakbot_GB_MTB_8{
	...
	strings :
		...
		$a_02_1 = {03 f0 8b 45 90 01 01 03 30 8b 4d 90 01 01 89 31 8b 55 90 01 01 8b 02 2d 90 01 02 00 00 8b 4d 90 01 01 89 01 5e 8b e5 5d c3 90 00 } //1
		$a_02_2 = {8a 14 31 88 14 38 8b 45 90 01 01 83 c0 90 01 01 89 45 90 02 06 5f 5e 8b e5 5d c3 90 0a 28 00 03 45 90 01 01 8b 90 00 } //1
		$a_02_3 = {8b ff 8b 0d 90 01 04 8b 15 90 01 04 89 11 90 0a ff 00 90 17 04 01 01 01 01 31 32 30 33 90 02 c8 c7 05 90 01 04 00 00 00 00 01 05 90 00 } //1
	condition:
...
rule Trojan_Win32_Qakbot_GB_MTB_9{
	...
	strings :
		$a_02_0 = {be ac 00 00 a1 90 01 04 8b 0d 90 01 04 8d 94 01 90 01 04 89 15 90 01 04 a1 90 01 04 2d be ac 00 00 a3 90 01 04 a1 90 01 04 5d c3 90 00 } //1
		$a_02_1 = {03 f0 8b 45 90 01 01 03 30 8b 4d 90 01 01 89 31 8b 55 90 01 01 8b 02 2d 90 01 04 8b 4d 90 01 01 89 01 5e 8b e5 5d c3 90 00 } //1
		$a_02_2 = {8a 0c 32 88 0c 38 8b 55 90 01 01 83 c2 90 01 01 89 55 90 01 01 eb 90 01 01 a1 90 01 04 a3 90 01 04 5f 5e 8b e5 5d c3 90 00 } //1
		$a_02_3 = {89 08 5f 5d c3 90 0a ff 00 90 17 04 01 01 01 01 31 32 30 33 90 02 c8 c7 05 90 01 04 00 00 00 00 01 05 90 01 04 a1 90 01 04 8b 0d 90 00 } //1
	condition:
