...
rule Trojan_Win32_Qakbot_ED_MTB_3{
	...
	strings :
		$a_01_0 = {44 69 73 63 6f 6e 6e 65 63 74 4e 61 6d 65 64 50 69 70 65 } //01 00 
		$a_01_1 = {4f 70 65 6e 53 74 6f 72 61 67 65 } //01 00 
		$a_01_2 = {6d 6e 6a 68 75 69 76 34 30 } //01 00 
		$a_01_3 = {31 38 32 39 33 } //01 00 
		$a_01_4 = {61 65 72 6f 66 6c 6f 74 } //01 00 
		$a_01_5 = {4a 6a 69 73 63 68 75 67 } //01 00 
		$a_01_6 = {31 2e 32 2e 31 31 } //01 00 
