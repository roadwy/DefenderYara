...
rule Trojan_Win32_Qakbot_GP_MTB{
	...
	strings :
		$a_03_0 = {2b d8 4b 8b 45 d8 33 18 89 5d a0 [0-32] 03 d8 8b 45 d8 89 18 8b 45 a8 83 c0 04 89 45 a8 33 c0 89 45 a4 8b 45 d8 83 c0 04 03 45 a4 89 45 d8 8b 45 a8 3b 45 cc 0f 82 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_Win32_Qakbot_GP_MTB_2{
	...
	strings :
		$a_02_0 = {c7 04 e4 ff ff 0f 00 59 51 33 0c [0-01] 33 8b [0-04] 83 e0 00 31 c8 59 68 [0-04] 8f 83 [0-04] 21 8b [0-04] 89 4d [0-01] 8b 8b [0-04] 01 c1 51 8b 4d [0-01] 58 ff e0 } //1
	condition:
		((#a_02_0  & 1)*1) >=1
...
rule Trojan_Win32_Qakbot_GP_MTB_3{
	...
	strings :
		$a_02_0 = {c7 04 e4 ff ff 0f 00 59 89 4d [0-01] 33 4d [0-01] 0b 8b [0-04] 83 e0 00 09 c8 8b 4d [0-01] 54 c7 04 e4 [0-04] 8f 83 [0-04] 21 8b [0-04] 6a 00 89 3c [0-01] 50 5f 03 bb [0-04] 89 f8 5f ff e0 } //1
	condition:
		((#a_02_0  & 1)*1) >=1
...
rule Trojan_Win32_Qakbot_GP_MTB_4{
	...
	strings :
		$a_02_0 = {2b c8 89 4d ?? 0f b6 15 ?? ?? ?? ?? 8b 45 ?? 2b c2 89 45 ?? 0f b6 0d ?? ?? ?? ?? 8b 55 ?? 2b d1 89 55 ?? 0f b6 05 ?? ?? ?? ?? 33 45 ?? 89 45 ?? 8b 0d ?? ?? ?? ?? 03 4d ?? 8a 55 ?? 88 11 e9 } //10
	condition:
		((#a_02_0  & 1)*10) >=10
...
rule Trojan_Win32_Qakbot_GP_MTB_5{
	...
	strings :
		$a_02_0 = {31 d2 31 c2 89 93 ?? ?? ?? ?? 8b 55 ?? ff 93 ?? ?? ?? ?? 83 bb ?? ?? ?? ?? 00 } //10
		$a_02_1 = {59 fc 83 bb ?? ?? ?? ?? 00 90 18 f3 a4 83 bb ?? ?? ?? ?? 00 75 ?? ff 93 ?? ?? ?? ?? 6a 00 89 34 e4 29 f6 31 c6 89 b3 ?? ?? ?? ?? 5e 57 c7 04 e4 ff ff 0f 00 59 83 bb ?? ?? ?? ?? 00 } //10
	condition:
...
rule Trojan_Win32_Qakbot_GP_MTB_6{
	...
	strings :
		$a_02_0 = {b8 4c 66 44 00 cc cc ff 15 ?? ?? ?? ?? 68 dc 0f 07 10 c3 } //5
...
rule Trojan_Win32_Qakbot_GP_MTB_7{
	...
	strings :
		$a_02_0 = {55 8b ec a1 [0-04] a3 [0-04] 8b [0-06] 89 [0-06] 8b [0-06] 8b 02 a3 [0-04] 8b [0-06] 81 [0-06] 89 [0-06] 8b [0-06] 81 [0-06] a1 [0-04] a3 [0-04] 31 0d [0-04] a1 [0-04] c7 05 [0-08] 01 [0-05] 8b 15 [0-04] a1 [0-04] 89 02 5d c3 } //1
		$a_02_1 = {88 0a 8b 55 ?? 83 c2 ?? 89 55 ?? e9 } //1
	condition:
...
rule Trojan_Win32_Qakbot_GP_MTB_8{
	...
	strings :
		$a_02_0 = {ff 75 fc ff 75 f8 ff 75 f0 ff 75 f4 ff 35 ?? ?? ?? ?? 6a 01 ff 90 0a 30 00 8b ?? ?? 03 ?? ?? 89 ?? ?? 83 ?? ?? 04 81 ?? ?? 00 10 00 00 } //10
...
rule Trojan_Win32_Qakbot_GP_MTB_9{
	...
	strings :
		...
		$a_02_3 = {8b ff 8b 0d ?? ?? ?? ?? 8b 15 ?? ?? ?? ?? 89 11 33 c0 90 0a ff 00 90 17 04 01 01 01 01 31 32 30 33 [0-c8] a1 ?? ?? ?? ?? c7 05 ?? ?? ?? ?? 00 00 00 00 01 05 } //10
	condition:
...
rule Trojan_Win32_Qakbot_GP_MTB_10{
	...
	strings :
		$a_02_0 = {6a 01 ff 25 90 0a 48 00 a1 ?? ?? ?? ?? 03 05 ?? ?? ?? ?? a3 ?? ?? ?? ?? 83 05 ?? ?? ?? 00 04 81 2d ?? ?? ?? 00 00 10 00 00 ff 35 ?? ?? ?? 00 ff 35 ?? ?? ?? 00 ff 35 ?? ?? ?? 00 ff 35 ?? ?? ?? 00 ff 35 ?? ?? ?? 00 } //10
		$a_00_1 = {fd f3 a5 89 c1 83 e1 03 83 c6 03 83 c7 03 f3 a4 fc 5f 5e c3 } //5
...
rule Trojan_Win32_Qakbot_GP_MTB_11{
	...
	strings :
		$a_02_0 = {83 c0 04 03 05 ?? ?? ?? ?? a3 ?? ?? ?? ?? a1 ?? ?? ?? ?? 3b 05 ?? ?? ?? ?? 0f 82 90 0a c8 00 03 d8 a1 ?? ?? ?? ?? 01 18 [0-05] 8b 1d ?? ?? ?? ?? 03 1d ?? ?? ?? ?? 03 1d ?? ?? ?? ?? 4b 2b d8 [0-05] 03 d8 a1 ?? ?? ?? ?? 90 17 02 01 01 31 33 } //10
		$a_00_1 = {fd f3 a5 89 c1 83 e1 03 83 c6 03 83 c7 03 f3 a4 fc 5f 5e c3 } //5
		$a_80_2 = {56 69 72 74 75 61 6c 41 6c 6c 6f 63 } //VirtualAlloc  1
		$a_80_3 = {56 69 72 74 75 61 6c 41 6c 6c 6f 63 45 78 } //VirtualAllocEx  1
	condition:
...
rule Trojan_Win32_Qakbot_GP_MTB_12{
	...
	strings :
		$a_02_0 = {57 c7 45 ec 0e dc eb d2 3a d2 74 00 81 6d ec c4 00 00 00 e8 ?? ?? ?? ?? 66 3b c9 74 } //10
...
rule Trojan_Win32_Qakbot_GP_MTB_13{
	...
	strings :
		$a_02_0 = {2b d8 01 5d ?? 8b 45 ?? 3b 45 ?? 0f 82 90 0a c8 00 8b d8 8b 45 ?? 03 45 ?? 2d 67 2b 00 00 03 45 ?? 03 d8 [0-4b] 90 17 02 01 01 31 33 } //10
		$a_00_1 = {fd f3 a5 89 c1 83 e1 03 83 c6 03 83 c7 03 f3 a4 fc 5f 5e c3 } //5
		$a_02_2 = {8b 55 e0 03 55 ?? 8b 45 ?? 03 45 ?? 8b 4d ?? e8 } //5
		$a_80_3 = {56 69 72 74 75 61 6c 41 6c 6c 6f 63 } //VirtualAlloc  1
		$a_80_4 = {56 69 72 74 75 61 6c 41 6c 6c 6f 63 45 78 } //VirtualAllocEx  1
	condition:
...
rule Trojan_Win32_Qakbot_GP_MTB_14{
	...
	strings :
		...
		$a_80_1 = {62 31 39 36 62 32 38 37 2d 62 61 62 34 2d 31 30 31 61 2d 62 36 39 63 2d 30 30 61 61 30 30 33 34 31 64 30 37 } //b196b287-bab4-101a-b69c-00aa00341d07  1
		$a_80_2 = {52 65 67 4f 70 65 6e 4b 65 79 41 } //RegOpenKeyA  1
		$a_02_3 = {03 f0 8b 45 ?? 03 30 8b 4d ?? 89 31 8b 55 ?? 8b 02 2d bc 01 00 00 8b 4d ?? 89 01 5e 8b e5 5d c3 } //1
		$a_02_4 = {8a 0c 32 88 0c 38 8b 55 ?? 83 c2 ?? 89 55 ?? eb ?? 5f 5e 8b e5 5d c3 } //1
	condition:
