...
rule Trojan_Win32_Qakbot_AL_MTB{
	...
	strings :
		...
		$a_03_2 = {8b 55 f0 68 50 3c 0a 60 68 5a 6e 00 00 6a 00 e8 90 01 04 5a ff d0 e9 90 00 } //1
	condition:
...
rule Trojan_Win32_Qakbot_AL_MTB_2{
	...
	strings :
		$a_03_0 = {01 02 8b 45 90 01 01 2d 80 0d 00 00 03 45 90 01 01 89 45 90 01 01 8b 45 90 01 01 03 45 90 01 01 8b 55 90 01 01 31 02 90 02 20 e8 90 0a 40 00 8b 45 90 01 01 8b 55 90 00 } //2
	condition:
		((#a_03_0  & 1)*2) >=2
