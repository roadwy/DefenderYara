...
rule Trojan_Win32_Qakbot_EK_MTB_2{
	...
	strings :
		...
		$a_01_1 = {6a 6e 53 59 67 64 48 62 2e 64 6c 6c } //01 00 
		$a_01_2 = {41 66 6d 71 56 53 43 } //01 00 
		$a_01_3 = {42 33 67 74 71 78 45 65 6a } //01 00 
		$a_01_4 = {43 31 74 65 63 58 65 62 73 } //01 00 
		$a_01_5 = {44 36 70 6e 38 4d 7a 41 } //01 00 
		$a_01_6 = {49 55 72 67 4c 50 51 72 2e 64 6c 6c } //01 00 
		$a_01_7 = {42 78 68 6c 7a 70 41 59 } //01 00 
		$a_01_8 = {43 6a 58 4e 7a 79 34 6c 42 } //01 00 
		$a_01_9 = {46 37 4d 49 6c 63 37 6b 4a 6e 6d } //01 00 
		$a_01_10 = {4a 57 73 6c 37 59 69 56 57 } //00 00 
	condition:
		any of ($a_*)
