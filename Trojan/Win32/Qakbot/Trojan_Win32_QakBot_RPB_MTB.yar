...
rule Trojan_Win32_QakBot_RPB_MTB_2{
	...
	strings :
		$a_03_0 = {8b 12 03 15 90 01 03 00 03 c2 8b 15 90 01 03 00 89 02 a1 90 01 03 00 03 05 90 01 03 00 48 a3 90 01 08 00 03 05 90 01 03 00 a3 90 01 03 00 90 00 } //1
		$a_03_1 = {00 83 c0 04 a3 90 01 03 00 33 c0 a3 90 01 03 00 a1 90 01 03 00 83 c0 04 03 05 90 01 03 00 a3 90 01 03 00 a1 90 01 03 00 3b 05 90 01 03 00 0f 82 59 ff ff ff 90 00 } //1
	condition:
