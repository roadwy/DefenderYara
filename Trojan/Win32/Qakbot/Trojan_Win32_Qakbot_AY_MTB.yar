...
rule Trojan_Win32_Qakbot_AY_MTB{
	...
	strings :
		$a_03_0 = {33 d2 8b c7 f7 75 90 01 01 8a 04 0a 8b 55 90 01 01 32 04 17 88 04 3b 47 83 ee 01 75 90 00 } //1
