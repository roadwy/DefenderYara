...
rule Trojan_Win32_QakBot_RPY_MTB{
	...
	strings :
		...
		$a_03_1 = {50 8b 46 64 33 44 24 2c 03 41 20 8d 8f 51 ff ff ff 50 69 c2 90 01 02 00 00 50 8b c7 35 90 01 02 00 00 05 90 01 02 00 00 50 8b 86 ac 00 00 00 90 00 } //1
	condition:
