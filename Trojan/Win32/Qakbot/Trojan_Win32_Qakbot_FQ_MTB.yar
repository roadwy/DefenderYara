...
rule Trojan_Win32_Qakbot_FQ_MTB{
	...
	strings :
		...
		$a_01_1 = {43 44 55 4a 50 } //01 00  CDUJP
		$a_01_2 = {44 4c 64 77 6d 70 } //01 00  DLdwmp
		$a_01_3 = {48 6c 56 54 39 31 6a } //01 00  HlVT91j
		$a_01_4 = {4e 6f 6e 43 32 } //01 00  NonC2
		$a_01_5 = {53 55 6e 31 35 44 } //00 00  SUn15D
	condition:
		any of ($a_*)
