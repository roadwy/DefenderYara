...
rule Trojan_Win32_Qakbot_GY_MTB_2{
	...
	strings :
		$a_01_0 = {64 64 66 6e 62 64 66 6e 64 6e 64 64 6e 64 66 64 62 64 66 } //01 00 
		$a_01_1 = {73 64 66 73 64 66 73 64 } //01 00 
		...
		$a_01_4 = {70 69 6e 6e 69 67 72 61 64 61 } //01 00 
		$a_01_5 = {73 6f 70 68 6f 6d 6f 72 69 63 61 6c 6c 79 } //01 00 
