...
rule Trojan_Win32_Qakbot_GY_MTB{
	...
	strings :
		$a_02_0 = {56 83 e6 00 0b b3 90 01 04 83 e1 00 31 f1 5e fc f3 a4 52 c7 04 e4 ff ff 0f 00 59 83 bb 90 01 04 00 75 90 00 } //10
		$a_02_1 = {83 c4 04 81 e0 00 00 00 00 8f 45 f8 33 45 f8 8f 83 90 01 04 21 8b 90 01 04 01 83 90 01 04 83 bb 90 01 04 00 75 90 01 01 ff 93 90 01 04 50 8f 45 fc ff 75 fc 8f 83 90 01 04 ff a3 90 01 04 e8 90 00 } //10
	condition:
