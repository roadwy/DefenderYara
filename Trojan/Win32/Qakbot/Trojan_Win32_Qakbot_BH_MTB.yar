...
rule Trojan_Win32_Qakbot_BH_MTB{
	...
	strings :
		$a_03_0 = {99 f7 7d e4 89 55 90 01 01 8b 45 90 01 01 03 45 90 01 01 0f b6 08 8b 55 90 01 01 03 55 90 01 01 0f b6 02 33 c1 8b 4d 90 01 01 03 4d 90 01 01 88 01 eb 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
