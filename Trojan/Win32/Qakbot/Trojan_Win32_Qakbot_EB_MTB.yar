...
rule Trojan_Win32_Qakbot_EB_MTB_6{
	...
	strings :
		$a_01_0 = {45 58 50 42 4c 47 32 47 79 } //01 00  EXPBLG2Gy
		$a_01_1 = {45 7a 4d 4e 62 51 4c } //01 00  EzMNbQL
		$a_01_2 = {48 6e 67 57 4d 30 78 } //01 00  HngWM0x
		$a_01_3 = {4e 73 72 36 34 30 59 } //01 00  Nsr640Y
		$a_01_4 = {52 4f 55 4f 38 30 39 } //00 00  ROUO809
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Qakbot_EB_MTB_7{
	...
	strings :
		$a_01_0 = {43 58 66 50 38 33 36 71 36 } //01 00  CXfP836q6
		$a_01_1 = {44 72 61 77 54 68 65 6d 65 49 63 6f 6e } //01 00  DrawThemeIcon
		$a_01_2 = {47 72 58 70 34 30 } //01 00  GrXp40
		$a_01_3 = {53 6b 6a 39 32 57 } //01 00  Skj92W
		$a_01_4 = {57 49 75 64 4b 33 39 38 } //00 00  WIudK398
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Qakbot_EB_MTB_9{
	...
	strings :
		$a_01_0 = {6b 6f 59 4c 6f 41 55 6c 58 7a 4f 6e 62 43 64 4b 65 73 77 68 4a 61 70 } //01 00  koYLoAUlXzOnbCdKeswhJap
		$a_01_1 = {67 5a 4a 58 77 59 47 4a 77 44 4d 67 50 6c 68 4c 65 63 70 49 76 71 70 } //01 00  gZJXwYGJwDMgPlhLecpIvqp
		$a_01_2 = {4a 58 53 51 49 50 47 4b 71 63 6c 68 44 50 4f 4a 61 6b 6a } //01 00  JXSQIPGKqclhDPOJakj
		$a_01_3 = {48 5a 31 30 4b 49 31 38 4e 5f 4b 55 49 54 76 } //01 00  HZ10KI18N_KUITv
		$a_01_4 = {48 5a 32 33 72 65 6d 6f 76 65 41 63 63 65 6c 65 72 61 74 6f 72 4d 61 72 6b 65 72 52 4b 37 51 53 74 72 69 6e 67 } //01 00  HZ23removeAcceleratorMarkerRK7QString
		$a_01_5 = {48 5a 35 4b 49 31 38 4e 76 } //01 00  HZ5KI18Nv
		$a_01_6 = {48 5a 35 6b 69 31 38 6e 50 4b 63 } //00 00  HZ5ki18nPKc
	condition:
		any of ($a_*)
