...
rule Trojan_Win32_QakBot_BM_MTB_2{
	...
	strings :
		...
		$a_01_2 = {48 69 65 66 70 6c 6e 42 61 79 64 6f 66 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win32_QakBot_BM_MTB_3{
	...
	strings :
		$a_01_0 = {63 6f 65 6e 61 6d 6f 75 72 6d 65 6e 74 } //01 00 
		$a_01_1 = {67 69 61 6e 74 68 6f 6f 64 } //01 00 
		$a_01_2 = {68 6f 61 78 65 72 } //01 00 
		$a_01_3 = {73 75 70 65 72 63 61 72 67 6f } //01 00 
		$a_01_4 = {70 73 6f 72 69 61 74 69 66 6f 72 6d } //01 00 
		$a_01_5 = {75 6e 65 78 70 6c 69 63 69 74 6e 65 73 73 } //01 00 
		$a_01_6 = {6d 65 63 6f 6e 6f 70 68 61 67 69 73 6d } //01 00 
		$a_01_7 = {74 68 75 72 69 66 65 72 } //00 00 
	condition:
		any of ($a_*)
