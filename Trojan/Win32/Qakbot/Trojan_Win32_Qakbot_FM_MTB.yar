...
rule Trojan_Win32_Qakbot_FM_MTB{
	...
	strings :
		...
		$a_01_2 = {44 46 58 71 6d 31 38 38 39 } //01 00 
		$a_01_3 = {4a 59 6e 56 38 55 } //01 00 
		$a_01_4 = {4e 6b 7a 4b 54 31 59 38 } //01 00 
		$a_01_5 = {53 49 48 57 30 35 32 54 } //01 00 
		$a_01_6 = {54 7a 4b 38 36 36 30 31 } //00 00 
	condition:
		any of ($a_*)
