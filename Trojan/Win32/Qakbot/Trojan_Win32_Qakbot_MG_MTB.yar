...
rule Trojan_Win32_Qakbot_MG_MTB_2{
	...
	strings :
		...
		$a_01_2 = {47 65 74 4b 65 79 62 6f 61 72 64 54 79 70 65 } //02 00 
		$a_01_3 = {47 65 74 54 68 72 65 61 64 4c 6f 63 61 6c 65 } //02 00 
...
rule Trojan_Win32_Qakbot_MG_MTB_3{
	...
	strings :
		$a_01_0 = {6c 63 6d 73 31 35 46 69 78 65 64 31 36 74 6f 44 6f 75 62 6c 65 } //01 00 
		$a_01_1 = {6c 63 6d 73 43 61 6c 6c 6f 63 } //01 00 
		$a_01_2 = {6c 63 6d 73 43 72 65 61 74 65 4d 75 74 65 78 } //01 00 
		$a_01_3 = {6c 63 6d 73 44 65 73 74 72 6f 79 4d 75 74 65 78 } //01 00 
		$a_01_4 = {6c 63 6d 73 47 65 74 54 72 61 6e 73 66 6f 72 6d 46 6f 72 6d 61 74 74 65 72 73 31 36 } //01 00 
		$a_01_5 = {6c 63 6d 73 4c 6f 63 6b 4d 75 74 65 78 } //01 00 
		$a_01_6 = {6c 63 6d 73 4d 41 54 33 73 6f 6c 76 65 } //01 00 
		$a_01_7 = {6c 6d 73 43 49 45 43 41 4d 30 32 52 65 76 65 72 73 65 } //01 00 
		$a_01_8 = {6e 65 78 74 } //00 00 
	condition:
		any of ($a_*)
