...
rule Trojan_Win32_Qakbot_AD_MTB_3{
	...
	strings :
		...
		$a_81_1 = {44 78 61 5a 69 } //03 00 
		$a_81_2 = {45 41 70 76 66 70 76 4e 79 } //03 00 
		$a_81_3 = {45 51 70 76 62 65 44 52 } //03 00 
		$a_81_4 = {43 72 79 70 74 41 63 71 75 69 72 65 43 6f 6e 74 65 78 74 57 } //03 00 
		$a_81_5 = {43 72 79 70 74 52 65 6c 65 61 73 65 43 6f 6e 74 65 78 74 } //00 00 
	condition:
		any of ($a_*)
