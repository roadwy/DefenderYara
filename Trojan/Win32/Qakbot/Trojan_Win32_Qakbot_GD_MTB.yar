...
rule Trojan_Win32_Qakbot_GD_MTB{
	...
	strings :
		$a_02_0 = {59 fc 51 8d 83 90 01 04 50 8d 83 90 01 04 50 ff 93 90 01 04 89 83 90 01 04 59 f3 a4 8d 83 90 01 04 50 ff 93 90 01 04 89 83 90 01 04 57 c7 04 e4 ff ff 0f 00 59 51 90 00 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Qakbot_GD_MTB_2{
	meta:
		description = "Trojan:Win32/Qakbot.GD!MTB,SIGNATURE_TYPE_PEHSTR_EXT,01 00 01 00 01 00 00 01 00 "
		
	strings :
		$a_02_0 = {8b d2 8b d2 8b d2 8b d2 8b d2 8b d2 8b d2 8b d2 8b d2 8b d2 8b 15 90 02 04 33 d1 c7 05 90 02 04 00 00 00 00 8b da 01 1d 90 02 04 a1 90 02 04 8b 0d 90 02 04 89 08 5b 5d c3 90 00 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Qakbot_GD_MTB_3{
	...
	strings :
		$a_02_0 = {31 d1 8b 55 fc fc f3 a4 52 c7 04 e4 ff ff 0f 00 59 89 75 fc 33 75 fc 0b b3 90 01 04 83 e0 00 09 f0 8b 75 fc 68 90 01 04 8f 83 90 01 04 21 8b 90 01 04 01 83 90 01 04 ff a3 90 00 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Qakbot_GD_MTB_4{
	...
	strings :
		$a_02_0 = {8b 17 80 c1 21 0f b6 c1 3b 05 90 01 04 8b 44 24 90 01 01 90 18 81 c2 b0 70 08 01 8a cd 02 0d 90 01 04 89 17 83 c7 04 ff 4c 24 90 01 01 89 15 90 01 04 8b 54 24 90 01 01 75 90 00 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Qakbot_GD_MTB_5{
	meta:
		description = "Trojan:Win32/Qakbot.GD!MTB,SIGNATURE_TYPE_PEHSTR_EXT,02 00 02 00 02 00 00 01 00 "
		
	strings :
		$a_01_0 = {03 d8 8b 45 d8 33 18 89 5d a0 8b 45 a0 03 45 9c 2b 45 9c 8b 55 d8 89 02 } //01 00 
		$a_01_1 = {03 d8 89 5d d8 8b 45 9c 2b 45 9c 89 45 a4 8b 45 a8 83 c0 04 03 45 a4 89 45 a8 8b 45 a8 3b 45 cc 0f 82 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Qakbot_GD_MTB_8{
	...
	strings :
		...
		$a_00_6 = {5d 04 00 00 90 4d 04 80 5c 25 00 00 91 4d 04 80 00 00 01 00 08 00 0f 00 ac 21 51 61 6b 62 6f } //74 2e 
	condition:
		any of ($a_*)
