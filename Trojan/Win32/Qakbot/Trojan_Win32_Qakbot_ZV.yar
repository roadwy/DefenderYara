...
rule Trojan_Win32_Qakbot_ZV{
	...
	strings :
		...
		$a_03_2 = {a0 0f 00 00 90 09 02 00 81 90 00 } //5
		$a_03_3 = {d0 07 00 00 90 09 02 00 81 90 00 } //5
		$a_03_4 = {70 17 00 00 90 09 02 00 81 90 00 } //5
		$a_03_5 = {f7 04 84 ff 90 09 04 00 c7 45 90 01 01 00 90 00 } //5
	condition:
