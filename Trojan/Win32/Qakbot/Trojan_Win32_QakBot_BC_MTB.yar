...
rule Trojan_Win32_QakBot_BC_MTB_2{
	...
	strings :
		$a_03_0 = {2b d8 6a 00 e8 [0-04] 2b d8 a1 [0-04] 33 18 89 1d [0-04] 6a 00 e8 [0-04] 8b d8 03 1d [0-04] 6a 00 e8 [0-04] 03 d8 6a 00 e8 [0-04] 03 d8 6a 00 e8 [0-04] 03 d8 6a 00 e8 [0-04] 03 d8 a1 [0-04] 89 18 6a 00 e8 [0-04] 8b d8 a1 [0-04] 83 c0 04 03 d8 } //5
	condition:
		((#a_03_0  & 1)*5) >=5
...
rule Trojan_Win32_QakBot_BC_MTB_3{
	...
	strings :
		$a_03_0 = {0f af da 8b d3 c1 ea 08 88 14 01 ff 47 68 8b 4f 68 8b 87 b4 00 00 00 88 1c 01 8b 47 78 ff 47 68 35 40 77 20 00 29 47 6c 8b 87 c0 00 00 00 2b 47 6c 2d [0-04] 31 47 78 8b 47 74 2d [0-04] 01 47 64 8b 47 64 83 c0 ed 01 87 80 00 00 00 81 fd [0-04] 0f } //4
