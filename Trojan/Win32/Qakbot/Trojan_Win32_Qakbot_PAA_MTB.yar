...
rule Trojan_Win32_Qakbot_PAA_MTB_2{
	...
	strings :
		$a_01_0 = {49 76 5f 65 6e 63 72 79 70 74 69 6f 6e 5f 69 6e 69 74 5f 69 6e 66 6f 5f 61 64 64 5f 73 69 64 65 5f 64 61 74 61 } //01 00 
		$a_01_1 = {49 76 5f 66 72 61 6d 65 5f 73 65 74 5f 62 65 73 74 5f 65 66 66 6f 72 74 5f 74 69 6d 65 73 74 61 6d 70 } //01 00 
		$a_01_2 = {49 76 5f 78 74 65 61 5f 6c 65 5f 63 72 79 70 74 } //01 00 
		$a_01_3 = {49 76 70 72 69 76 5f 73 6c 69 63 65 74 68 72 65 61 64 5f 63 72 65 61 74 65 } //01 00 
		$a_01_4 = {4d 6f 74 64 } //00 00 
	condition:
		any of ($a_*)
