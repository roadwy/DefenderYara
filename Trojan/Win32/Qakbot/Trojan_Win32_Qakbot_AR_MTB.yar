...
rule Trojan_Win32_Qakbot_AR_MTB_3{
	...
	strings :
		$a_01_0 = {33 61 64 37 35 65 33 30 30 32 38 31 32 33 31 65 } //01 00  3ad75e300281231e
		$a_01_1 = {34 66 31 38 39 32 34 38 33 39 62 63 39 65 63 30 } //01 00  4f18924839bc9ec0
		$a_01_2 = {61 30 37 38 38 65 61 62 64 31 36 66 36 34 39 37 } //00 00  a0788eabd16f6497
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Qakbot_AR_MTB_7{
	...
	strings :
		$a_01_0 = {62 75 69 6c 64 61 62 6c 65 } //01 00  buildable
		$a_01_1 = {65 75 6f 72 6e 69 74 68 69 63 } //01 00  euornithic
		$a_01_2 = {70 61 72 61 6e 69 74 72 6f 73 6f 70 68 65 6e 6f 6c } //01 00  paranitrosophenol
		$a_01_3 = {70 68 6f 74 6f 73 79 6e 74 68 65 74 69 63 61 6c 6c 79 } //01 00  photosynthetically
		$a_01_4 = {70 73 65 70 68 6f 6d 61 6e 63 79 } //01 00  psephomancy
		$a_01_5 = {73 63 79 70 68 6f 73 74 6f 6d 61 } //01 00  scyphostoma
