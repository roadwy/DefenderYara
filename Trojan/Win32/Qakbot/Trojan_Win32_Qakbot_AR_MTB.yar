...
rule Trojan_Win32_Qakbot_AR_MTB{
	...
	strings :
		$a_02_0 = {8b 4d f4 8b 55 fc 8d 84 0a 59 11 00 00 89 45 f0 8b 0d 90 01 04 89 0d 90 01 04 8b 55 f0 89 15 90 01 04 8b 45 fc 90 00 } //2
	condition:
		((#a_02_0  & 1)*2) >=2
...
rule Trojan_Win32_Qakbot_AR_MTB_2{
	...
	strings :
		$a_02_0 = {8d 8c 10 fd 8a 67 00 89 4d f8 8b 55 f8 81 ea fd 8a 67 00 89 55 f8 b8 23 5f ff ff 03 05 90 01 04 8b 80 19 a1 00 00 a3 90 00 } //1
	condition:
		((#a_02_0  & 1)*1) >=1
...
rule Trojan_Win32_Qakbot_AR_MTB_4{
	...
	strings :
		$a_02_0 = {56 8b 45 0c 89 45 fc 8b 0d 90 01 04 89 4d 08 8b 55 08 8b 02 8b 4d fc 8d 94 01 c2 5a 00 00 8b 45 08 89 10 90 00 } //1
...
rule Trojan_Win32_Qakbot_AR_MTB_5{
	...
	strings :
		$a_02_0 = {56 8b 45 0c 89 45 fc 8b 0d 90 01 04 89 4d 08 8b 55 08 8b 02 8b 4d fc 8d 94 01 c2 5a 00 00 8b 45 08 89 10 90 00 } //2
...
rule Trojan_Win32_Qakbot_AR_MTB_6{
	...
	strings :
		$a_02_0 = {8d 8c 10 fd 8a 67 00 89 4d f8 8b 55 f8 81 ea fd 8a 67 00 89 55 f8 b8 3b bb fa ff 03 05 90 01 04 8b 80 01 45 05 00 a3 90 00 } //1
		$a_02_1 = {03 4d f4 03 4d f4 8b 15 90 01 04 8b 35 90 01 04 8a 04 06 88 04 0a 8b 0d 90 01 04 83 c1 01 89 0d 90 01 04 eb 98 90 00 } //1
	condition:
...
rule Trojan_Win32_Qakbot_AR_MTB_8{
	...
	strings :
		$a_03_0 = {03 75 f4 03 c6 03 45 f4 8b 0d 90 01 04 03 4d f4 03 4d f4 03 4d f4 8b 15 90 01 04 8b 35 90 01 04 8a 04 06 88 04 0a 8b 0d 90 01 04 83 c1 01 89 0d 90 00 } //2
		$a_03_1 = {8b d2 8b d2 a1 90 01 04 8b d2 8b 0d 90 01 04 8b d2 a3 90 01 04 8b c0 a1 90 01 04 a3 90 00 } //1
		$a_03_2 = {8b d2 8b 35 90 01 04 33 f1 90 02 08 c7 05 90 02 08 01 35 90 01 04 a1 90 01 04 8b 0d 90 01 04 89 08 90 00 } //1
	condition:
...
rule Trojan_Win32_Qakbot_AR_MTB_9{
	...
	strings :
		$a_03_0 = {03 75 f4 03 c6 03 45 f4 8b 0d 90 01 04 03 4d f4 03 4d f4 03 4d f4 8b 15 90 01 04 8b 35 90 01 04 8a 04 06 88 04 0a 8b 0d 90 01 04 83 c1 01 89 0d 90 00 } //1
		$a_03_1 = {8b d2 8b d2 8b d2 a1 90 01 04 8b d2 8b 0d 90 01 04 8b d2 a3 90 01 04 8b c0 a1 90 01 04 a3 90 01 04 31 0d 90 01 04 c7 05 90 01 08 8b 1d 90 01 04 01 1d 90 01 04 a1 90 01 04 8b 0d 90 01 04 89 08 90 00 } //1
		$a_03_2 = {8b d2 8b d2 8b 15 90 01 04 31 0d 90 02 08 c7 05 90 02 08 8b 1d 90 01 04 01 1d 90 01 04 a1 90 01 04 8b 0d 90 01 04 89 08 5b 5d 90 00 } //1
	condition:
...
rule Trojan_Win32_Qakbot_AR_MTB_10{
	...
	strings :
		$a_03_0 = {03 75 f4 03 c6 03 45 f4 8b 15 90 01 04 03 55 f4 03 55 f4 03 55 f4 8b 0d 90 01 04 8b 35 90 01 04 8a 04 06 88 04 11 8b 0d 90 01 04 83 c1 01 89 0d 90 00 } //2
		$a_03_1 = {8b d2 8b d2 a1 90 01 04 8b d2 8b 0d 90 01 04 8b d2 a3 90 01 04 8b c0 a1 90 01 04 a3 90 00 } //1
		$a_03_2 = {b8 bc 01 00 00 b8 bc 01 00 00 31 0d 90 02 08 c7 05 90 02 08 a1 90 01 04 01 05 90 01 04 a1 90 01 04 8b 0d 90 01 04 89 08 90 00 } //1
		$a_03_3 = {b8 bc 01 00 00 b8 bc 01 00 00 31 0d 90 01 04 eb 90 02 04 c7 05 90 02 08 ff 35 90 01 04 5a 01 15 90 01 04 a1 90 01 04 8b 0d 90 01 04 89 08 90 00 } //1
		$a_03_4 = {b8 bc 01 00 00 31 0d 90 01 04 eb 00 c7 05 90 02 08 8b 35 90 01 04 01 35 90 01 04 a1 90 01 04 8b 0d 90 01 04 89 08 90 00 } //1
		$a_03_5 = {b8 bc 01 00 00 b8 bc 01 00 00 31 0d 90 01 04 eb 00 c7 05 90 01 04 00 00 00 00 90 02 46 a1 90 01 04 8b 0d 90 01 04 89 08 90 03 01 01 5e 5d 90 00 } //1
	condition:
