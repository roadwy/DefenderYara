...
rule Trojan_Win32_Qakbot_DL_MTB{
	...
	strings :
		$a_03_0 = {2d 80 0d 00 00 03 45 ?? 89 45 ?? 8b 45 ?? 03 45 ?? 8b 55 ?? 31 02 6a 00 e8 ?? ?? ?? ?? 8b d8 8b 45 9c 83 c0 04 03 d8 6a 00 e8 ?? ?? ?? ?? 2b d8 6a 00 e8 ?? ?? ?? ?? 03 d8 6a 00 e8 ?? ?? ?? ?? 2b d8 6a 00 e8 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
