...
rule Trojan_Win32_Qakbot_PAB_MTB_2{
	...
	strings :
		...
		$a_81_1 = {44 68 57 74 65 63 53 35 32 4c 48 36 67 33 34 2e 64 6c 6c } //01 00  DhWtecS52LH6g34.dll
		$a_81_2 = {44 6c 6c 52 65 67 69 73 74 65 72 53 65 72 76 65 72 } //01 00  DllRegisterServer
		$a_81_3 = {46 6f 6e 6b 49 6b 4e } //01 00  FonkIkN
		$a_81_4 = {4d 71 76 64 45 76 5a 76 } //01 00  MqvdEvZv
		$a_81_5 = {56 42 46 6a 48 78 46 4f 78 43 } //01 00  VBFjHxFOxC
		$a_81_6 = {63 6c 45 78 72 56 71 52 } //01 00  clExrVqR
		$a_81_7 = {6b 4d 55 61 6b } //01 00  kMUak
		$a_81_8 = {6b 72 42 56 45 75 57 6a 64 6c } //01 00  krBVEuWjdl
		$a_81_9 = {74 67 57 7a 42 54 } //01 00  tgWzBT
		$a_81_10 = {74 77 48 49 73 } //01 00  twHIs
		$a_81_11 = {76 61 6f 62 43 6a } //01 00  vaobCj
		$a_81_12 = {79 4d 42 65 47 49 } //00 00  yMBeGI
	condition:
		any of ($a_*)
