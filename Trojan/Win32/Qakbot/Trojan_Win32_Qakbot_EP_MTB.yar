...
rule Trojan_Win32_Qakbot_EP_MTB_2{
	...
	strings :
		...
		$a_01_1 = {6a 4c 2e 64 6c 6c } //01 00 
		$a_01_2 = {41 75 70 47 47 59 56 4d 53 49 58 } //01 00 
		$a_01_3 = {42 55 51 4a 66 45 68 51 43 } //01 00 
		$a_01_4 = {43 4b 4f 57 73 49 69 7a 52 64 6a } //01 00 
		$a_01_5 = {44 4d 48 6b 42 57 71 } //00 00 
	condition:
		any of ($a_*)
