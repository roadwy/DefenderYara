...
rule Trojan_Win32_Qakbot_DD_MTB{
	...
	strings :
		$a_03_0 = {8b 44 24 1c 83 44 24 10 04 05 64 b2 00 01 a3 90 01 04 89 06 8d 04 0a 8b 0d 90 01 04 03 c7 8b 35 90 01 04 81 c1 8f 27 01 00 8d 04 42 03 c8 ff 4c 24 14 90 00 } //1
		$a_03_1 = {0f af cf 89 3d 90 01 04 69 f9 bc 6a 00 00 0f b6 cb 81 c6 f8 39 0b 01 8a 1d 90 01 04 66 2b c8 66 2b ca 89 35 90 01 04 0f b7 d1 8b 4c 24 10 89 54 24 0c 89 31 90 00 } //1
		$a_03_2 = {0f b7 55 fc a1 90 01 04 8d 4c 02 a9 03 0d 90 01 04 89 0d 90 01 04 8b 15 90 01 04 81 c2 d8 1f 0b 01 89 15 90 01 04 a1 90 01 04 03 45 f8 8b 0d 90 01 04 89 88 90 00 } //1
	condition:
