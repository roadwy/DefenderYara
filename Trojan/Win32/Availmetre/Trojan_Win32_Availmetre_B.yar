...
rule Trojan_Win32_Availmetre_B{
	...
	strings :
		$a_01_0 = {74 62 2e 44 4c 4c 00 62 6f 74 6b 6f 6d 61 6e 64 } //01 00  扴䐮䱌戀瑯潫慭摮
...
rule Trojan_Win32_Availmetre_B_2{
	...
	strings :
		...
		$a_01_2 = {55 3b 20 57 69 6e 64 6f 77 73 20 4e 54 20 35 2e 31 3b 20 72 75 3b 20 72 76 3a 31 2e 39 2e 30 2e 31 31 29 20 47 65 63 6b 6f 2f 32 30 30 39 30 36 30 32 31 35 20 46 69 72 65 66 6f 78 2f 33 2e 30 2e 31 31 } //00 00  U; Windows NT 5.1; ru; rv:1.9.0.11) Gecko/2009060215 Firefox/3.0.11
	condition:
		any of ($a_*)
