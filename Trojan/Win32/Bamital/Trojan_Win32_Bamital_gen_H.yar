...
rule Trojan_Win32_Bamital_gen_H{
	...
	strings :
		...
		$a_03_1 = {89 01 c7 41 04 2e 64 61 74 c7 41 08 00 00 00 00 8d 45 ?? 50 ff 75 08 e8 ?? ?? ?? ?? 89 45 e0 } //1
		$a_03_2 = {83 3c 03 00 75 16 c7 04 03 01 00 00 00 8d 0d ?? ?? ?? ?? 83 c1 04 03 cb 8b c1 ff d1 61 } //1
	condition:
