...
rule Trojan_Win32_Ctoevade_G{
	...
	strings :
		...
		$a_03_1 = {c7 00 47 45 54 20 c7 40 90 01 01 2f 72 65 73 c7 40 90 01 01 6f 75 72 63 c7 40 90 01 01 65 2e 68 74 c7 40 90 01 01 6d 6c 20 48 c7 40 90 01 01 54 54 50 2f c7 40 90 01 01 31 2e 31 0d 66 c7 40 90 01 01 0a 00 90 00 } //1
	condition:
