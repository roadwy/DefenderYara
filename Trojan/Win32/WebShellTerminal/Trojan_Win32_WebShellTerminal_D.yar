...
rule Trojan_Win32_WebShellTerminal_D{
	...
	strings :
		...
		$a_02_1 = {26 00 65 00 63 00 68 00 6f 00 90 02 02 5b 00 90 01 02 5d 00 26 00 63 00 64 00 26 00 65 00 63 00 68 00 6f 00 90 02 02 5b 00 90 01 02 5d 00 90 00 } //10
	condition:
