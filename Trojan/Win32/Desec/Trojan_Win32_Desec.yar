...
rule Trojan_Win32_Desec{
	...
	strings :
		...
		$a_01_2 = {53 65 63 75 72 69 74 79 20 53 65 72 76 69 63 65 } //01 00  Security Service
		$a_01_3 = {6d 61 64 44 69 73 41 73 6d } //01 00  madDisAsm
		$a_01_4 = {6d 61 64 43 6f 64 65 48 6f 6f 6b } //01 00  madCodeHook
		$a_01_5 = {55 6e 6b 6e 6f 77 6e 20 65 78 63 65 70 74 69 6f 6e 2e 20 49 66 20 79 6f 75 20 77 61 6e 74 20 74 6f 20 6b 6e 6f 77 20 6d 6f 72 65 2c 20 79 6f 75 20 68 61 76 65 20 74 6f 20 61 64 64 20 53 79 73 55 74 69 6c 73 20 74 6f 20 79 6f 75 72 20 70 72 6f 6a 65 63 74 2e } //02 00  Unknown exception. If you want to know more, you have to add SysUtils to your project.
		$a_01_6 = {5f 66 75 63 6b 69 6e 67 5f } //02 00  _fucking_
		$a_01_7 = {5f 73 6d 6f 6b 69 6e 67 5f } //00 00  _smoking_
	condition:
		any of ($a_*)
