...
rule Trojan_Win32_Babar_ABR_MTB{
	...
	strings :
		...
		$a_03_1 = {83 c0 40 8d 95 f4 5f ff ff e8 90 01 04 8b 85 f0 5f ff ff 33 d2 89 50 3c 8b 85 f0 5f ff ff 33 d2 89 50 44 8b 85 f0 5f ff ff 33 d2 89 50 48 90 00 } //00 00 
	condition:
		any of ($a_*)
