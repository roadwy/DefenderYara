...
rule Trojan_Win32_Hecsem_gen_A{
	...
	strings :
		...
		$a_01_2 = {48 6f 6f 6b 4f 66 66 00 48 6f 6f 6b 4f 6e } //01 00  潈歯晏f潈歯湏
		$a_01_3 = {5c 53 68 65 6c 6c 5c 4f 70 65 6e 5c 43 6f 6d 6d 61 6e 64 } //01 00  \Shell\Open\Command
