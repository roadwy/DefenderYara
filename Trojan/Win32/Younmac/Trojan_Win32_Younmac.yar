...
rule Trojan_Win32_Younmac{
	...
	strings :
		...
		$a_01_2 = {63 3a 5c 61 75 74 6f 65 78 65 63 2e 64 61 74 } //01 00 
		$a_01_3 = {53 4c 4f 57 4e 45 54 00 } //01 00 
		$a_01_4 = {75 6e 70 61 73 73 72 75 6e 2e 63 66 6d 20 48 54 54 50 2f 31 00 } //01 00 
		$a_01_5 = {57 69 6e 33 32 4c 64 72 2e 44 6c 6c } //01 00 
		$a_01_6 = {4d 61 63 5f 53 6e 69 66 66 5f 46 69 6c 65 4d 61 70 00 } //01 00 
		$a_01_7 = {59 4f 4e 47 5f 4d 61 63 5f 53 6e 69 66 66 5f } //00 00 
	condition:
		any of ($a_*)
