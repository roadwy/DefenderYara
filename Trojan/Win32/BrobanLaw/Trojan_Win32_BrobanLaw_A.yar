...
rule Trojan_Win32_BrobanLaw_A_2{
	...
	strings :
		$a_03_0 = {64 ff 35 00 00 00 00 64 89 25 00 00 00 00 58 c3 e9 90 09 05 00 68 90 00 } //1
		$a_03_1 = {8b f9 8b f2 4e 85 f6 7c 90 03 01 01 15 16 46 33 d2 8b e8 03 ea 90 02 04 8b df 2a cb 88 4d 00 42 4e 75 90 03 01 01 ed ee 90 00 } //1
		$a_03_2 = {ba c4 06 00 00 e8 90 01 04 b8 90 01 04 8b 0d 90 01 04 ba 3c 00 00 00 e8 90 00 } //1
	condition:
