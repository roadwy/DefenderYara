...
rule Trojan_Win32_Koutodoor_C_dll{
	...
	strings :
		...
		$a_01_2 = {39 33 34 38 2e 63 6e } //01 00  9348.cn
		$a_01_3 = {33 32 39 41 36 32 34 41 2d 31 44 32 32 2d 34 38 61 65 2d 39 35 37 36 2d 41 30 32 46 31 45 44 42 31 33 37 32 } //00 00  329A624A-1D22-48ae-9576-A02F1EDB1372
	condition:
		any of ($a_*)
