...
rule Trojan_Win32_Koutodoor_A{
	...
	strings :
		...
		$a_00_2 = {69 64 3d 25 64 26 6d 61 63 3d 25 73 26 74 79 70 65 3d 25 64 26 73 65 74 75 70 64 61 74 65 3d 25 64 25 30 32 64 25 30 32 64 26 68 6f 6d 65 70 61 67 65 3d 25 73 } //01 00 
		$a_00_3 = {69 64 3d 25 64 26 75 70 64 61 74 65 76 65 72 73 69 6f 6e 3d 25 64 } //01 00 
		$a_00_4 = {5c 5c 2e 5c 47 6c 6f 62 61 6c 5c 72 6b 64 6f 6f 72 } //01 00 
		$a_00_5 = {25 73 5c 25 73 20 25 73 5c 25 73 2e 64 6c 6c 2c 25 73 } //02 00 
