...
rule Trojan_Win32_Koutodoor_B_dll{
	...
	strings :
		$a_00_0 = {2e 64 6c 6c 00 44 6c 6c 52 65 67 69 73 74 65 72 53 65 72 76 65 72 00 44 6c 6c 55 6e 72 65 67 69 73 74 65 72 53 65 72 76 65 72 } //01 00  搮汬䐀汬敒楧瑳牥敓癲牥䐀汬湕敲楧瑳牥敓癲牥
