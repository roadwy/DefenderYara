...
rule Trojan_Win32_Koutodoor_B{
	...
	strings :
		...
		$a_03_2 = {3d 20 04 00 00 74 0d ff d7 3d 22 04 00 00 74 04 33 90 01 01 eb 05 90 00 } //1
		$a_03_3 = {44 50 00 00 90 09 03 00 c7 45 90 01 05 c7 45 90 01 01 45 50 00 00 c7 45 90 01 01 3d 50 00 00 90 00 } //2
	condition:
