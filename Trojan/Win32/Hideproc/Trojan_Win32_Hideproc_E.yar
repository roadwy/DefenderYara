...
rule Trojan_Win32_Hideproc_E{
	...
	strings :
		...
		$a_02_4 = {50 6a 05 e8 6b f9 ff ff a3 90 01 04 c3 90 00 } //1
		$a_02_5 = {0f 94 c2 f6 da 1b d2 85 d2 74 2c 8d 45 ec 50 6a 40 6a 04 53 e8 90 01 04 50 e8 90 01 04 8d 45 ec 50 6a 04 8d 45 f4 50 53 e8 90 01 04 50 e8 90 01 04 eb 08 90 00 } //1
	condition:
