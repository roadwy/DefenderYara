...
rule Trojan_Win32_Hideproc_E{
	...
	strings :
		$a_00_0 = {4e 74 48 69 64 65 46 69 6c 65 4d 61 70 70 69 6e 67 } //01 00 
		$a_00_1 = {48 69 64 65 50 72 6f 63 65 73 73 } //01 00 
		$a_00_2 = {49 6e 73 74 61 6c 6c 48 6f 6f 6b } //01 00 
		$a_00_3 = {53 65 74 57 69 6e 64 6f 77 73 48 6f 6f 6b 45 78 41 } //01 00 
