...
rule Trojan_Win32_Wysotot_gen_A{
	...
	strings :
		...
		$a_01_2 = {65 3a 5c 6c 61 62 73 5c 6f 75 74 5c 76 39 68 6f 6d 65 5f 74 6f 6f 6c 73 5c 52 65 6c 65 61 73 65 5c 76 39 68 74 2e 70 64 62 } //01 00  e:\labs\out\v9home_tools\Release\v9ht.pdb
		$a_01_3 = {2e 3f 41 56 43 56 39 68 6f 6d 65 5f 74 6f 6f 6c 73 41 70 70 } //01 00  .?AVCV9home_toolsApp
		$a_01_4 = {2e 00 6c 00 6e 00 6b 00 } //01 00  .lnk
