...
rule Trojan_Win32_Multsarch_U{
	...
	strings :
		$a_02_0 = {68 74 74 70 3a 2f 2f 67 77 2e 6e 65 74 6c 69 6e 6b 69 6e 76 65 73 74 2e 63 6f 6d 2f 63 68 65 63 6b 63 6f 64 65 2e 70 68 70 3f 67 77 3d 90 02 02 26 64 6f 63 75 6d 65 6e 74 3d 90 02 20 26 63 6f 75 6e 74 72 79 3d 65 73 26 63 6f 64 65 3d 90 00 } //10
		...
		$a_02_3 = {68 74 74 70 3a 2f 2f 65 6c 70 61 72 74 69 64 6f 2e 73 6f 66 74 32 30 31 32 2e 6e 65 74 2f 65 73 2f 63 6f 6e 66 69 67 5f 90 02 04 2e 78 6d 6c 90 00 } //1
