...
rule Trojan_Win32_FolSoc_A_MTB{
	...
	strings :
		...
		$a_03_1 = {6a 00 68 00 20 00 00 8d 84 24 c0 01 00 00 50 ff 35 3c 45 40 00 ff 15 64 30 40 00 85 c0 0f 8e 90 01 04 50 8d 8c 24 bc 01 00 00 51 8b 0d 90 01 04 81 c1 90 01 04 03 ce 51 8b cf 90 00 } //2
	condition:
