...
rule Trojan_Win32_Nedsym_G{
	...
	strings :
		$a_03_0 = {75 af 6a 04 68 00 10 00 00 68 54 96 01 00 6a 00 e8 90 01 04 89 45 f0 90 00 } //1
...
rule Trojan_Win32_Nedsym_G_2{
	...
	strings :
		...
		$a_03_2 = {81 3e 52 4d 5f 51 0f 85 90 01 04 81 7e 04 50 5f 45 4e 0f 85 90 01 04 81 7e 08 43 4f 44 45 0f 85 90 00 } //1
	condition:
