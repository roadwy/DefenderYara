...
rule Trojan_Win32_Nedsym_B{
	...
	strings :
		$a_03_0 = {ff 57 0c ff b5 44 ff ff ff 68 90 01 02 43 00 ff 75 e4 68 90 01 02 43 00 8d 45 dc ba 05 00 00 00 e8 90 01 02 fc ff 43 ff 4d c4 0f 85 90 01 01 fd ff ff 90 00 } //4
