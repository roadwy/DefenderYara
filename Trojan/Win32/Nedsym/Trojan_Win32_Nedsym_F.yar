...
rule Trojan_Win32_Nedsym_F{
	...
	strings :
		...
		$a_01_1 = {00 2f 73 74 61 74 32 2e 70 68 70 00 } //01 00 
		$a_01_2 = {00 5c 73 79 73 74 65 6d 33 32 5c 71 74 70 6c 75 67 69 6e 2e 65 78 65 00 } //01 00 
		$a_01_3 = {00 26 6d 61 63 72 6f 73 65 73 5f 76 65 72 73 69 6f 6e 3d 00 } //01 00 
		$a_01_4 = {00 26 64 65 6c 69 76 65 72 65 64 70 65 72 63 65 6e 74 3d 00 } //01 00 
		$a_01_5 = {00 47 4c 4f 42 41 4c 5f 52 41 4e 44 4f 4d 49 5a 45 44 5f 42 4f 44 59 00 } //01 00 
