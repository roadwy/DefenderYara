...
rule Trojan_Win32_Gamafeshi_A{
	...
	strings :
		$a_00_0 = {44 47 4d 4e 4f 45 50 00 } //0a 00  䝄乍䕏P
		$a_00_1 = {25 00 73 00 20 00 2d 00 20 00 25 00 73 00 20 00 2d 00 20 00 25 00 32 00 2e 00 32 00 78 00 } //0a 00  %s - %s - %2.2x
