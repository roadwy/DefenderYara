...
rule Trojan_Win32_Discper_gen_A{
	...
	strings :
		...
		$a_01_1 = {34 35 34 48 44 4c 44 74 71 43 4c 53 32 34 45 73 44 41 59 6f 72 66 39 51 41 56 6b 4e 71 51 50 64 4a 54 61 45 42 72 64 69 39 70 56 45 4c 55 48 36 5a 53 55 33 37 56 71 56 38 55 41 6f 54 59 56 37 6b } //00 00 
	condition:
		any of ($a_*)
