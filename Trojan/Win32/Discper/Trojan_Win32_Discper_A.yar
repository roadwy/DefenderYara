...
rule Trojan_Win32_Discper_A{
	...
	strings :
		$a_81_0 = {2d 75 20 34 35 34 48 44 4c 44 74 71 43 4c 53 } //01 00  -u 454HDLDtqCLS
		$a_81_1 = {2d 61 20 63 72 79 70 74 6f 6e 69 67 68 74 20 2d 6f 20 73 74 72 61 74 75 6d 2b 74 63 70 3a 2f 2f } //01 00  -a cryptonight -o stratum+tcp://
