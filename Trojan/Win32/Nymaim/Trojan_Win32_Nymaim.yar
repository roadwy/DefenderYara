...
rule Trojan_Win32_Nymaim{
	...
	strings :
		...
		$a_01_1 = {6f 64 62 63 63 6f 6e 66 2e 64 6c 6c 00 63 6e 61 61 61 72 6f 5f 65 73 73 5f 5f 6d 6f 72 79 00 63 69 72 74 75 75 6c 41 6c 6c 6f 63 00 64 62 72 6e 65 6c 33 32 2e 64 6c 6c } //00 00 
	condition:
		any of ($a_*)
