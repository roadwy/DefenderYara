...
rule Trojan_Win32_Nymaim_NM_MTB{
	...
	strings :
		$a_03_0 = {83 ec 10 89 44 24 ?? 8b 4c 24 18 89 e2 89 4a ?? 89 02 e8 39 00 00 00 83 ec ?? 8b 44 24 1c 05 ?? ?? ?? ?? 89 44 24 40 8b 44 24 ?? 8b 4c 24 1c 89 48 ?? 8b 44 24 44 8b 4c 24 ?? 89 48 58 8b 44 24 1c } //5
