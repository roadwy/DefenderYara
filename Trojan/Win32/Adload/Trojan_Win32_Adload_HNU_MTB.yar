...
rule Trojan_Win32_Adload_HNU_MTB{
	...
	strings :
		$a_02_0 = {89 48 04 89 01 c7 80 ec ff 13 00 02 00 00 00 b9 90 01 04 29 f1 89 0d 90 01 04 ba 90 01 04 29 f2 8d 0c 02 89 0d 90 01 04 83 ce 02 89 74 02 fc eb 0c c7 05 d8 4c 42 01 00 00 00 00 31 c9 89 c8 83 c4 90 01 01 5e c3 90 00 } //10
