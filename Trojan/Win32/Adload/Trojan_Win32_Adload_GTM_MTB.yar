...
rule Trojan_Win32_Adload_GTM_MTB{
	...
	strings :
		...
		$a_01_2 = {66 79 43 68 61 6e 67 65 4b 65 79 } //01 00  fyChangeKey
		$a_01_3 = {6b 4c 6f 61 64 65 72 4c 6f 63 6b } //01 00  kLoaderLock
		$a_01_4 = {44 62 67 50 72 6f 6d 70 74 } //00 00  DbgPrompt
	condition:
		any of ($a_*)
