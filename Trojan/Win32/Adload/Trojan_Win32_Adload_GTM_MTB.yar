...
rule Trojan_Win32_Adload_GTM_MTB{
	...
	strings :
		$a_02_0 = {89 4e fc 33 c0 a2 e7 ec 45 01 89 1e 89 46 08 c7 46 0c ?? ?? ?? ?? 89 73 10 8d 46 20 0f b7 4b 02 8d 14 08 89 53 08 03 fe 2b f9 89 7b 0c c6 03 00 89 70 fc } //10
