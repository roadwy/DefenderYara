...
rule Trojan_Win32_Adload_GEM_MTB{
	...
	strings :
		...
		$a_01_2 = {4b 69 6c 6c 54 69 6d 65 72 } //01 00  KillTimer
		$a_01_3 = {44 62 67 50 72 6f 6d 70 74 } //01 00  DbgPrompt
		$a_01_4 = {44 6c 6c 49 6e 73 74 61 6c 6c } //01 00  DllInstall
		$a_01_5 = {6b 4c 6f 61 64 65 72 4c 6f 63 6b } //01 00  kLoaderLock
		$a_01_6 = {66 79 43 68 61 6e 67 65 4b 65 79 } //00 00  fyChangeKey
	condition:
		any of ($a_*)
