...
rule Trojan_Win32_Lapsavok_B{
	...
	strings :
		...
		$a_01_3 = {67 65 74 31 2e 70 68 70 3f 73 69 64 3d } //01 00 
		$a_01_4 = {69 6e 66 2e 70 68 70 3f 74 70 3d 31 26 73 69 64 3d } //01 00 
		$a_01_5 = {73 63 68 74 61 73 6b 73 2e 65 78 65 20 2f 63 72 65 61 74 65 20 2f 73 63 20 4d 49 4e 55 54 45 20 2f 6d 6f 20 33 20 2f 74 72 20 22 } //00 00 
	condition:
		any of ($a_*)
