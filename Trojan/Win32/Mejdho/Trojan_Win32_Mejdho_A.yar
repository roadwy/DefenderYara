...
rule Trojan_Win32_Mejdho_A{
	...
	strings :
		...
		$a_00_2 = {5c 53 56 43 48 4f 53 54 2e 45 58 45 } //01 00 
		$a_00_3 = {6d 79 67 75 69 64 } //01 00 
		$a_00_4 = {6d 79 70 61 72 65 6e 74 74 68 72 65 61 64 69 64 } //01 00 
		$a_00_5 = {47 6c 6f 62 61 6c 5c 70 73 } //01 00 
