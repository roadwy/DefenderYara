...
rule Trojan_Win32_Mejdho_A{
	...
	strings :
		$a_02_0 = {6a 02 6a 00 6a c4 ff b5 ac fe ff ff ff 15 90 01 03 00 83 65 ec 00 6a 00 8d 45 ec 50 6a 3c 8d 85 b0 fe ff ff 50 ff b5 ac fe ff ff ff 15 90 00 } //10
		$a_02_1 = {74 35 68 44 10 00 00 ff 75 10 e8 90 01 03 00 59 59 6a 00 8d 45 f8 50 68 44 10 00 00 ff 75 10 ff 75 d4 ff 15 90 01 03 00 68 44 10 00 00 ff 75 10 e8 90 01 03 00 59 59 90 00 } //10
