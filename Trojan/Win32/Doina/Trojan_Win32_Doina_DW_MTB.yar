...
rule Trojan_Win32_Doina_DW_MTB{
	...
	strings :
		$a_03_0 = {66 81 f6 5d 52 81 c9 6e 00 46 f7 89 f9 38 de 66 d3 ee 29 d9 66 0f be f2 f9 89 e6 f9 83 ef 04 66 0f a3 ce f9 f8 ff 37 e8 90 01 04 84 f1 f9 39 df e9 90 00 } //1
