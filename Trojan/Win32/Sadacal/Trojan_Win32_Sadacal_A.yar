...
rule Trojan_Win32_Sadacal_A{
	...
	strings :
		$a_03_0 = {50 56 6a 13 ff 75 90 01 01 c7 45 90 01 01 0a 00 00 00 ff 15 90 00 } //5
		$a_03_1 = {c6 45 d4 5c 47 e8 90 01 04 6a 1a 99 59 f7 f9 80 c2 61 88 54 3d d4 47 83 ff 0b 90 00 } //5
