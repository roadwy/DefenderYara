...
rule Trojan_Win32_Mariofev_gen_dll{
	...
	strings :
		...
		$a_01_2 = {4d 46 43 34 32 2e 44 4c 4c 00 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Mariofev_gen_dll_2{
	...
	strings :
		...
		$a_01_1 = {63 3a 5c 63 72 61 73 68 64 75 6d 70 2e 6c 6f 67 } //02 00 
		...
		$a_01_5 = {4c 6f 61 64 52 65 73 6f 75 72 63 65 } //00 00 
	condition:
		any of ($a_*)
