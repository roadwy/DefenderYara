...
rule Trojan_Win32_Servswin_A{
	...
	strings :
		$a_01_0 = {57 69 6e 73 65 72 76 69 63 65 73 2e 65 78 65 00 6f 70 65 6e 00 } //1
		...
		$a_01_3 = {76 73 6f 6c 6c 6f 2d 65 6f 6d } //1 vsollo-eom
		$a_01_4 = {68 68 5f 6d 6d 5f 73 73 5f 74 74 } //1 hh_mm_ss_tt
	condition:
