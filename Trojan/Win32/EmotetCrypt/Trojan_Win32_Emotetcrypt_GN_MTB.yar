...
rule Trojan_Win32_Emotetcrypt_GN_MTB{
	...
	strings :
		$a_03_0 = {8b df 0f af de 0f af de 8d 5c 0b 90 01 01 0f af df 03 d5 03 d3 2b d0 8b 44 24 90 01 01 03 d6 03 d1 0f b6 0c 02 8b 44 24 90 01 01 30 08 8b 44 24 90 01 01 83 c0 01 3b 44 24 90 01 01 89 44 24 90 01 01 0f 82 90 00 } //1
