...
rule Trojan_Win32_Emotetcrypt_GS_MTB{
	...
	strings :
		...
		$a_81_1 = {5a 4a 36 53 6a 68 4b 30 5f 23 72 39 45 24 6f 75 3e 78 30 64 76 63 5a 3f 53 44 64 26 34 67 72 21 29 51 49 24 6f 6c 66 72 6e 3f 76 39 65 65 } //00 00  ZJ6SjhK0_#r9E$ou>x0dvcZ?SDd&4gr!)QI$olfrn?v9ee
	condition:
		any of ($a_*)
