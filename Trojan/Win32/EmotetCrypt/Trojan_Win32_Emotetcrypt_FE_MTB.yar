...
rule Trojan_Win32_Emotetcrypt_FE_MTB{
	...
	strings :
		$a_03_0 = {2b c1 8b 4d 08 0f b6 04 01 8b 4d 0c 0f b6 14 11 33 d0 8b 45 f4 03 05 90 01 04 03 05 90 01 04 03 05 90 01 04 03 05 90 01 04 03 05 90 01 04 03 05 90 01 04 03 05 90 01 04 03 05 90 01 04 8b 4d 0c 88 14 01 90 00 } //1
