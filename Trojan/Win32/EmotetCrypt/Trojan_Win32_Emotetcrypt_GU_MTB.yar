...
rule Trojan_Win32_Emotetcrypt_GU_MTB{
	...
	strings :
		...
		$a_81_1 = {58 4e 31 5a 40 33 29 66 53 6d 6b 3c 62 43 36 2b 77 5a 78 38 33 2a 6f 62 31 45 5a 6c 42 25 5e 71 6c 38 48 4d 75 72 66 74 77 } //00 00  XN1Z@3)fSmk<bC6+wZx83*ob1EZlB%^ql8HMurftw
	condition:
		any of ($a_*)
