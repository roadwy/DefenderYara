...
rule Trojan_Win32_Emotetcrypt_RM_MTB{
	...
	strings :
		$a_03_0 = {83 e2 07 03 c2 8b c8 c1 f9 03 69 c9 b4 00 00 00 8b c7 2b c1 03 c6 8a c8 32 8d 90 01 04 85 db 75 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_Win32_Emotetcrypt_RM_MTB_2{
	...
	strings :
		$a_03_0 = {c1 e6 02 0b d6 52 ff 74 24 90 01 01 53 68 90 01 04 e8 90 01 04 59 f7 d8 50 ff 15 90 01 04 e9 90 00 } //1
