...
rule Trojan_Win32_Emotetcrypt_DV_MTB{
	...
	strings :
		$a_02_0 = {6a 40 68 00 30 00 00 8b 49 90 01 01 83 c1 0c 51 6a 00 ff d0 90 00 } //10
		$a_02_1 = {48 89 44 24 20 3b cf 7e 90 01 01 e8 90 01 04 8b 54 24 54 f2 0f 59 44 24 68 8a 02 42 89 54 24 54 8b 54 24 38 f2 0f 58 44 24 48 88 02 42 8b 44 24 20 f2 0f 11 44 24 48 89 54 24 38 85 c0 74 90 01 01 f2 0f 10 44 24 78 8b 4c 24 1c eb 90 00 } //10
