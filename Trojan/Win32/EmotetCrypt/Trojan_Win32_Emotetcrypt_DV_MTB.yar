...
rule Trojan_Win32_Emotetcrypt_DV_MTB{
	...
	strings :
		...
		$a_81_2 = {52 61 69 73 65 45 78 63 65 70 74 69 6f 6e } //0a 00 
		$a_81_3 = {44 6c 6c 52 65 67 69 73 74 65 72 53 65 72 76 65 72 } //01 00 
		$a_81_4 = {61 73 62 69 71 73 74 61 65 71 7a 73 79 63 63 } //01 00 
		$a_81_5 = {61 74 77 75 68 6b 79 63 66 79 62 6b 6a } //01 00 
		$a_81_6 = {62 64 6b 69 70 79 76 71 } //01 00 
		$a_81_7 = {62 67 62 62 79 74 7a 69 6f 6c 6f } //00 00 
	condition:
		any of ($a_*)
