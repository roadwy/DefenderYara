...
rule Trojan_Win32_EmotetCrypt_MZ_MTB{
	meta:
		description = "Trojan:Win32/EmotetCrypt.MZ!MTB,SIGNATURE_TYPE_PEHSTR_EXT,01 00 01 00 02 00 00 01 00 "
	...
	strings :
		...
		$a_02_1 = {55 8b ec 83 90 02 02 c7 45 90 02 05 8b 90 02 02 33 90 02 02 89 90 02 02 c7 45 90 02 05 c7 45 90 02 05 c7 45 90 02 05 8b 90 02 02 83 90 02 02 0f 90 02 03 8b 90 02 02 99 f7 90 01 01 89 90 00 } //00 00 
	condition:
		any of ($a_*)
