...
rule Trojan_Win32_Emotetcrypt_IP_MTB{
	...
	strings :
		$a_03_0 = {0f b6 04 28 03 c2 99 bd ?? ?? ?? ?? f7 fd 8b 44 24 58 8b 6c 24 14 83 c5 01 89 6c 24 14 2b 54 24 18 2b d1 03 54 24 4c 03 54 24 50 03 d7 0f b6 14 02 8b 44 24 10 30 54 28 ff } //1
