...
rule Trojan_Win32_Emotetcrypt_IK_MTB{
	...
	strings :
		...
		$a_81_1 = {61 52 3c 47 2b 4b 62 29 66 29 47 58 63 71 58 29 23 49 4f 61 34 4e 63 73 37 31 26 3e 51 36 3f 58 3e 64 49 38 39 40 42 42 3e 44 70 63 6b 26 24 3f 30 } //00 00  aR<G+Kb)f)GXcqX)#IOa4Ncs71&>Q6?X>dI89@BB>Dpck&$?0
	condition:
		any of ($a_*)
