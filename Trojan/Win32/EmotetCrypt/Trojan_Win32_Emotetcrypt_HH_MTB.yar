...
rule Trojan_Win32_Emotetcrypt_HH_MTB{
	...
	strings :
		...
		$a_81_1 = {38 32 79 40 6b 6f 73 3c 65 39 62 3f 24 23 55 66 55 53 54 46 45 64 70 75 47 76 40 4b 38 25 75 4b 28 31 24 62 37 4f 74 4d 2b 25 36 4b 35 62 3e 6a } //00 00  82y@kos<e9b?$#UfUSTFEdpuGv@K8%uK(1$b7OtM+%6K5b>j
	condition:
		any of ($a_*)
