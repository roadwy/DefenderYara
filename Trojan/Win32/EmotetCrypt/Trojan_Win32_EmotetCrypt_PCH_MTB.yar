...
rule Trojan_Win32_EmotetCrypt_PCH_MTB{
	...
	strings :
		...
		$a_03_1 = {0f b6 14 33 0f b6 c0 03 c2 33 d2 f7 35 ?? ?? ?? ?? 89 54 24 14 ff 15 ?? ?? ?? ?? 8b 44 24 10 8a 0c 28 8b 54 24 14 32 0c 32 8b 44 24 20 88 4d 00 } //1
		$a_03_2 = {0f b6 12 0f b6 c0 03 c2 33 d2 f7 f1 8b da ff 15 ?? ?? ?? ?? 8b 45 f4 8a 04 38 32 04 33 88 07 } //1
	condition:
