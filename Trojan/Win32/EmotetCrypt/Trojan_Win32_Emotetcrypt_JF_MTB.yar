...
rule Trojan_Win32_Emotetcrypt_JF_MTB{
	...
	strings :
		...
		$a_01_1 = {66 6c 69 63 6b 72 } //02 00 
		$a_01_2 = {56 67 37 4d 2b 4a 4a 62 30 44 35 4f 44 38 45 28 54 6f 3c 28 42 25 23 33 55 39 4a 44 69 65 6a 7a 59 3e 54 6f 4e 55 65 68 44 } //0a 00 
