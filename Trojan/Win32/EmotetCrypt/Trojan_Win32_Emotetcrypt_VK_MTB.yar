...
rule Trojan_Win32_Emotetcrypt_VK_MTB{
	...
	strings :
		$a_02_0 = {ff d3 50 ff 15 90 02 04 8b 0d 90 02 04 89 08 8b 15 90 02 04 89 50 90 02 02 8a 0d 90 02 04 8d 55 90 02 02 52 50 57 88 48 90 02 02 ff 15 90 00 } //1
		$a_02_1 = {8a 06 88 07 8a 46 90 01 01 88 47 90 01 01 8a 46 90 01 01 88 47 90 01 01 8b 45 90 01 01 5e 5f c9 c3 90 00 } //1
		$a_02_2 = {48 83 c8 fc 40 40 83 f8 90 02 02 7e 90 02 02 8b 4d 90 02 02 8b 45 90 02 02 51 8d 55 90 02 02 52 56 57 6a 01 57 50 ff 15 90 02 04 85 c0 0f 84 90 02 04 ff 90 00 } //1
...
rule Trojan_Win32_Emotetcrypt_VK_MTB_2{
	...
	strings :
		...
		$a_02_6 = {68 00 10 00 00 90 01 02 ff 90 01 01 8b 90 01 03 8b 90 01 03 8b 90 01 01 8b 90 01 01 c1 90 01 02 8b 90 01 01 f3 90 01 01 8b 90 01 01 83 90 01 02 f3 a4 8b 90 01 03 8b 90 01 03 90 01 01 8d 90 01 03 90 01 03 6a 01 90 01 02 ff 15 90 00 } //1
		$a_02_7 = {83 c4 04 50 90 02 08 68 00 10 00 00 90 01 02 ff 90 01 01 8b 90 01 03 8b 90 01 01 8b 90 01 06 e8 90 01 04 8b 90 01 03 8b 90 01 03 83 90 01 03 8d 90 01 06 6a 01 90 01 02 ff 15 90 00 } //1
	condition:
