...
rule Trojan_Win32_Emotetcrypt_GZ_MTB{
	...
	strings :
		$a_03_0 = {8b c3 0f af c3 8b 1d 90 01 04 0f af c7 03 e8 a1 90 01 04 03 d1 0f af d8 8d 0c 36 be 90 01 04 2b f1 0f af f0 8d 44 7e 90 01 01 0f af 05 90 01 04 03 eb 2b 2d 90 01 04 8d 0c 6a 8a 14 08 8b 44 24 90 01 01 8a 18 8b 4c 24 90 01 01 32 da 88 18 90 00 } //1
