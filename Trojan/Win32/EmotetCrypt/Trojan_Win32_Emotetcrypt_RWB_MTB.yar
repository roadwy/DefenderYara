...
rule Trojan_Win32_Emotetcrypt_RWB_MTB{
	...
	strings :
		...
		$a_03_1 = {03 cf 03 ce 2b ca 8b 45 90 01 01 2b c8 2b 0d 90 01 04 2b 0d 90 01 04 8b 55 90 01 01 8b 45 90 00 } //1
	condition:
...
rule Trojan_Win32_Emotetcrypt_RWB_MTB_2{
	...
	strings :
		$a_03_0 = {68 00 30 00 00 8b 95 90 01 04 52 6a 00 6a ff ff 15 90 00 } //1
