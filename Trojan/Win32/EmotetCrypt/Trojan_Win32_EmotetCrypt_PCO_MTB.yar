...
rule Trojan_Win32_EmotetCrypt_PCO_MTB{
	...
	strings :
		...
		$a_03_1 = {0f b6 14 0f 0f b6 c0 03 c2 33 d2 f7 f6 8b 74 24 90 01 01 83 c6 01 89 74 24 90 01 01 03 54 24 90 01 01 0f b6 04 0a 8b 54 24 90 01 01 02 c3 32 44 32 ff 83 6c 24 90 01 01 01 88 46 ff 90 00 } //1
	condition:
