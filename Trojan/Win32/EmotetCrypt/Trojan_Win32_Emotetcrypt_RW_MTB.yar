...
rule Trojan_Win32_Emotetcrypt_RW_MTB{
	...
	strings :
		$a_03_0 = {68 00 30 00 00 8b 45 90 01 01 50 6a 00 6a ff ff 15 90 00 } //1
...
rule Trojan_Win32_Emotetcrypt_RW_MTB_2{
	...
	strings :
		...
		$a_03_1 = {03 c2 33 d2 f7 35 90 01 04 8b 44 24 90 01 01 2b d1 8a 0c 1a 30 08 ff 44 24 90 01 01 8b 44 24 90 01 01 3b 44 24 90 00 } //1
	condition:
