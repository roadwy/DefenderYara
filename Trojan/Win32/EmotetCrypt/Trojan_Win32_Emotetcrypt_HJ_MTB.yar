...
rule Trojan_Win32_Emotetcrypt_HJ_MTB{
	...
	strings :
		...
		$a_81_1 = {21 6c 58 70 2a 38 6f 5a 50 47 4c 61 5a 6a 4c 21 77 32 46 32 34 50 68 64 73 49 49 33 30 50 38 25 76 5e 28 62 3c 32 77 6b 68 63 79 41 44 48 75 69 72 77 28 30 37 30 3c 41 5f 29 3e 4c 3e 41 76 6d 24 } //00 00 
	condition:
		any of ($a_*)
