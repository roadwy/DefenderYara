...
rule Trojan_Win32_Emotetcrypt_GT_MTB{
	...
	strings :
		$a_03_0 = {0f b6 0c 1a 03 c1 99 b9 ?? ?? ?? ?? f7 f9 a1 ?? ?? ?? ?? 8d 0c 85 ?? ?? ?? ?? b8 ?? ?? ?? ?? 2b c1 0f af c6 8b c8 a1 ?? ?? ?? ?? 8d 04 c0 2b c8 83 e9 ?? 0f af cf 03 d1 8b 0d ?? ?? ?? ?? 8d 04 76 03 d0 8d 04 8d ?? ?? ?? ?? 2b d0 0f b6 0c 1a 8b 44 24 ?? 30 08 } //1
