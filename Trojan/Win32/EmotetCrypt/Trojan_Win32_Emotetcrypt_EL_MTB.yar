...
rule Trojan_Win32_Emotetcrypt_EL_MTB{
	...
	strings :
		$a_03_0 = {0f af d8 a1 90 01 04 0f af c3 8d 1c 06 a1 90 01 04 29 c3 a1 90 01 04 01 d8 89 c3 8b 45 08 01 d8 0f b6 00 31 c8 88 02 83 45 ec 01 8b 45 ec 3b 45 10 0f 82 90 00 } //10
		...
		$a_03_2 = {8b c3 0f af 05 90 01 04 2b 05 90 01 04 83 c0 04 0f af 05 90 01 04 03 d0 8d 47 01 0f af c7 2b d0 8b 44 24 1c 2b d3 2b d1 8a 0c 32 30 08 8b 44 24 14 40 89 44 24 14 3b 44 24 2c 0f 82 90 00 } //10
