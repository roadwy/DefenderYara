...
rule Trojan_Win32_Emotetcrypt_HD_MTB{
	...
	strings :
		$a_03_0 = {03 d2 2b ea 8b 15 ?? ?? ?? ?? 03 ea 8d 2c a8 8b 44 24 20 83 c0 01 0f af c2 03 c6 0f af 05 ?? ?? ?? ?? 03 c6 0f af f7 03 c7 03 c1 8d 0c b5 ?? ?? ?? ?? 0f af cb 83 c1 04 0f af cb 8d 04 40 2b e8 03 6c 24 2c 8b 44 24 24 0f b6 14 29 30 10 } //1
