...
rule Trojan_Win32_Emotetcrypt_GM_MTB{
	...
	strings :
		...
		$a_81_1 = {54 67 28 54 29 26 50 2a 43 54 35 32 44 48 4a 33 25 4c 4e 48 74 57 52 4d 75 41 4d 52 66 5a 57 76 63 21 4c 76 76 4d 32 70 68 44 37 31 23 6b 35 50 52 36 21 37 43 29 68 4c 71 3e 61 4f 66 67 78 25 6a 72 47 6f 21 65 44 52 } //00 00  Tg(T)&P*CT52DHJ3%LNHtWRMuAMRfZWvc!LvvM2phD71#k5PR6!7C)hLq>aOfgx%jrGo!eDR
	condition:
		any of ($a_*)
