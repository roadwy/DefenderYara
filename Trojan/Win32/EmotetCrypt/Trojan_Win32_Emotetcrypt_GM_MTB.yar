...
rule Trojan_Win32_Emotetcrypt_GM_MTB{
	...
	strings :
		$a_03_0 = {8b c7 0f af 3d 90 01 04 0f af c6 be 02 00 00 00 2b f0 0f af 35 90 01 04 2b 74 24 90 01 01 8b 44 24 90 01 01 2b 74 24 90 01 01 2b f9 03 74 24 90 01 01 03 d5 8d 0c 7f 8d 14 72 8a 0c 11 30 08 8b 44 24 90 01 01 83 c0 01 3b 44 24 90 01 01 89 44 24 90 01 01 0f 82 90 00 } //1
