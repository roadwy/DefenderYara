...
rule Trojan_Win32_Emotetcrypt_JB_MTB{
	...
	strings :
		...
		$a_01_1 = {73 5f 29 78 37 23 34 56 46 2b 55 72 5f 6b 63 25 72 58 5e 72 36 23 6f 55 2a 28 40 71 23 3f 36 2a 5a 36 52 39 5f 6c 5a 54 33 62 54 5a 76 38 57 39 2a 46 55 3f 5a 4f 53 36 66 77 5e 69 5e 31 51 4a 4c 47 77 35 36 75 } //00 00 
	condition:
		any of ($a_*)
