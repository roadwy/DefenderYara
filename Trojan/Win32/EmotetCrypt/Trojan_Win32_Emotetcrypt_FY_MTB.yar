...
rule Trojan_Win32_Emotetcrypt_FY_MTB{
	...
	strings :
		$a_03_0 = {0f b6 04 30 0f b6 0c 11 33 d2 03 c1 b9 90 01 04 f7 f1 8b 45 90 01 01 03 55 90 01 01 8b 4d 90 01 01 0f b6 04 02 8b 55 90 01 01 30 04 0a 41 89 4d 90 01 01 3b cf b9 90 01 04 72 90 00 } //1
