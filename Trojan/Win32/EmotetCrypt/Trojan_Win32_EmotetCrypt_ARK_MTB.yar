...
rule Trojan_Win32_EmotetCrypt_ARK_MTB{
	...
	strings :
		$a_03_0 = {f7 f1 8b 2d 90 01 04 8b fa 0f b6 04 37 03 c3 33 d2 f7 f1 8a 0c 37 8b da 8a 04 33 88 0c 33 88 04 37 0f b6 14 33 90 00 } //1
		$a_03_1 = {8b 45 08 8b 4d f8 8b 15 90 01 04 03 c1 0f b6 4d ff 8a 0c 11 30 08 ff 45 f8 8b 45 f8 3b 45 0c 7c 90 00 } //1
		$a_03_2 = {0f b6 13 03 c2 99 b9 e3 03 00 00 f7 f9 a1 90 01 04 45 0f b6 d2 8a 0c 02 30 4d ff 83 6c 24 14 01 75 90 00 } //1
	condition:
...
rule Trojan_Win32_EmotetCrypt_ARK_MTB_2{
	...
	strings :
		...
		$a_03_2 = {8a 0c 11 30 08 ff 44 24 14 8b 44 24 14 3b 44 24 24 0f 8c 90 01 04 8b 44 24 28 8a 4c 24 12 8a 54 24 13 5f 5e 5d 5b 88 08 90 00 } //1
		$a_03_3 = {8b 4c 24 44 8b 44 24 4c 8b 15 90 01 04 03 c1 0f b6 4c 24 41 8a 0c 11 30 08 83 c4 30 ff 44 24 14 8b 44 24 14 3b 44 24 20 0f 8c 3c ff ff ff 90 00 } //1
...
rule Trojan_Win32_EmotetCrypt_ARK_MTB_3{
	...
	strings :
		$a_03_0 = {8a 14 08 32 14 2e 8b 4c 24 2c 88 14 08 90 02 1f 72 90 00 } //1
		...
		$a_03_3 = {0f b6 84 34 90 01 04 0f b6 cb 03 c1 99 b9 90 01 04 f7 f9 83 c5 01 0f b6 94 14 90 1b 00 30 55 ff 90 02 4f 0f 85 90 00 } //1
		$a_03_4 = {99 f7 f9 8a 03 90 02 3f 8a 94 14 90 01 04 32 c2 88 03 90 0a 8f 00 8a 84 34 90 1b 01 81 e1 90 02 04 03 c1 b9 90 00 } //1
		$a_03_5 = {0f b6 84 34 90 01 04 0f b6 cb 03 c1 99 b9 90 01 04 f7 f9 8d 4c 24 14 90 02 05 c7 84 24 90 01 04 ff ff ff ff 0f b6 94 14 90 1b 00 30 55 ff 90 00 } //1
		$a_03_6 = {33 d2 8a 94 0d 90 01 04 03 c2 99 f7 bd 90 01 04 8a 85 90 01 04 32 84 15 90 1b 00 88 85 90 1b 02 8b 4d 10 03 8d 90 01 04 8a 95 90 1b 02 88 11 8b 85 90 1b 05 83 c0 01 89 85 90 1b 05 e9 90 00 } //1
		$a_03_7 = {0f b6 84 34 90 01 04 0f b6 c9 03 c1 99 b9 90 01 04 f7 f9 8d 4c 24 18 8a 9c 14 90 1b 00 32 5d 00 90 02 1f 88 5d 00 90 00 } //1
		$a_03_8 = {33 d2 8a 54 04 90 02 04 8b c2 03 c1 b9 90 01 04 99 f7 f9 8a 5c 14 90 1b 00 8b 54 24 1c 32 1a 90 00 } //1
		...
		$a_03_11 = {8a 44 0c 34 b9 90 01 04 03 c2 99 f7 f9 8a 4c 24 17 90 02 05 8a 54 14 34 32 ca 90 00 } //1
		...
		$a_03_14 = {81 e1 ff 00 00 00 90 02 0f 8a 84 14 90 01 04 03 c1 b9 90 01 04 99 f7 f9 8a 4c 24 13 8b 84 24 90 01 04 8a 94 14 90 1b 01 32 ca 90 00 } //1
		...
		$a_03_16 = {8b 4c 24 1c 0f b6 44 0c 90 02 04 0f b6 d3 03 c2 99 b9 4a 2f 01 00 f7 f9 8a 5c 24 1b 32 5c 14 90 1b 00 90 00 } //1
		$a_01_17 = {0f b6 44 04 28 0f b6 cb 03 c1 99 b9 4a 2f 01 00 f7 f9 8a 5c 24 17 32 5c 14 28 } //1
		$a_03_18 = {0f b6 44 0c 90 02 04 0f b6 d3 03 c2 99 b9 90 01 04 f7 f9 8a 5c 24 1b 32 5c 14 90 1b 00 3b fe 0f 90 00 } //1
		$a_01_19 = {32 14 01 83 c0 01 83 6c 24 14 01 88 50 ff 89 44 24 10 0f 85 24 ff ff ff } //1
		$a_03_20 = {41 8a 8c 0d 8c 00 00 00 8b 55 80 32 0c 3a 88 0f 47 90 02 1f 75 90 00 } //1
		...
		$a_03_23 = {8a 14 01 8b 4c 24 1c 32 54 0c 20 40 88 50 ff 90 02 1f 0f 90 00 } //1
		$a_03_24 = {8a 0c 02 8b 54 24 1c 32 4c 14 20 83 c0 01 90 02 1f 0f 85 90 00 } //1
		$a_03_25 = {8a 14 2e 32 c2 88 06 46 4b 75 a4 90 0a 4f 00 8a 44 3c 90 01 01 81 90 02 1f f7 90 02 0f 8a 44 14 90 1b 01 90 00 } //1
		$a_01_26 = {0f b6 04 0f 0f b6 d2 03 c2 33 d2 f7 35 50 b1 49 00 8a 04 0a 32 04 2b 88 45 00 } //1
		$a_03_27 = {8b 00 8b ea 8b 54 24 1c 8a 14 10 32 14 2e 8b 6c 24 2c 88 14 28 90 02 1f 72 90 00 } //1
		$a_03_28 = {8a 04 17 8a 14 2e 32 c2 8b 54 24 2c 88 04 17 90 02 0f 40 90 02 0f 72 90 00 } //1
		$a_03_29 = {8a 14 01 8a 1d 90 01 04 2a d3 88 10 40 4e 75 90 00 } //1
		...
		$a_03_32 = {0f b6 8c 15 90 01 04 03 c1 b9 90 01 04 99 f7 f9 8b 8d 90 01 04 0f b6 84 15 90 1b 00 32 44 1f ff ff 4d 0c 88 43 ff 75 90 00 } //1
		$a_03_33 = {8a 1c 06 2a 1d 90 01 04 2a d9 02 da 88 18 40 4f 75 90 01 01 5e 5b 5f c3 90 00 } //1
		$a_03_34 = {33 d2 f7 35 90 01 04 8a 04 0a 8b 54 24 28 32 04 2a 45 88 45 ff 8b 44 24 90 02 04 48 89 44 24 90 1b 01 75 90 00 } //1
		$a_01_35 = {0f b6 00 0f b6 d2 03 c2 33 d2 f7 f1 8b 4d f8 8a 04 32 32 04 39 88 07 } //1
		$a_03_36 = {88 04 33 0f b6 09 0f b6 c0 03 c1 33 d2 f7 35 90 01 04 8b 4d f4 8a 04 32 32 04 39 88 07 90 00 } //1
		...
		$a_03_41 = {0f b6 0c 0a 90 02 0f 33 d2 f7 35 34 60 41 00 90 02 2f 0f b6 09 33 c1 8b 4d 18 03 4d dc 88 01 90 00 } //1
		$a_03_42 = {8a 14 08 8b 44 24 18 30 14 28 90 02 0f 45 3b e8 0f 8c 70 90 00 } //1
...
rule Trojan_Win32_EmotetCrypt_ARK_MTB_4{
	...
	strings :
		$a_03_0 = {f7 f7 8b fa 8a 94 3d 90 01 04 88 11 8d 84 3d 90 1b 00 88 18 8b 45 fc 40 3d 90 01 04 89 45 fc 72 90 0a 8f 00 8d 8c 05 90 1b 00 f7 75 0c 90 02 0a 0f b6 14 02 0f b6 c3 03 fa 33 d2 03 c7 bf 90 1b 02 90 00 } //5
		$a_03_1 = {83 c2 01 89 95 90 01 04 8b 85 90 1b 00 3b 85 90 01 04 73 90 01 01 eb 90 0a 6f 00 c7 85 90 1b 02 90 01 04 c7 85 90 1b 00 00 00 00 00 eb 90 02 05 8b 85 90 1b 00 8a 8d 90 1b 00 88 8c 05 90 02 05 8b 95 90 1b 00 90 00 } //2
		$a_03_2 = {03 c2 99 f7 bd 90 01 04 8a 85 90 01 04 32 84 15 90 01 04 90 0a 4f 00 8a 94 0d 90 1b 02 90 00 } //3
