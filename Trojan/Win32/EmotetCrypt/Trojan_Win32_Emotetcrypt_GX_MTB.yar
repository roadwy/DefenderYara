...
rule Trojan_Win32_Emotetcrypt_GX_MTB{
	...
	strings :
		...
		$a_81_1 = {72 5f 78 61 76 24 6e 61 32 4c 29 46 4f 65 54 31 23 71 44 33 53 57 52 23 44 4f 51 42 7a 40 68 3f 26 2b 68 79 4a 25 43 62 59 2a 6a 31 7a 25 6b 28 6b 53 77 55 58 24 45 4c 44 49 78 77 66 75 68 62 79 44 49 65 } //00 00 
	condition:
		any of ($a_*)
