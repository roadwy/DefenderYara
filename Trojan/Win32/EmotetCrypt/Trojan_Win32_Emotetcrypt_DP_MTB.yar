...
rule Trojan_Win32_Emotetcrypt_DP_MTB{
	...
	strings :
		$a_02_0 = {6a 40 68 00 30 00 00 ff 73 90 01 01 2b c8 6a 00 89 4c 24 90 01 01 ff d1 90 00 } //1
		$a_02_1 = {8b 54 24 2c 4b 8b 4c 24 20 8b c3 25 ff 03 00 00 88 0c 10 8b 4f f8 8b 17 03 cd 03 54 24 14 8b 77 fc 85 f6 74 90 01 01 8a 02 8d 49 01 88 41 ff 8d 52 01 83 ee 01 75 90 01 01 83 c7 28 85 db 75 90 00 } //1
