...
rule Trojan_Win32_Emotetcrypt_DP_MTB{
	...
	strings :
		...
		$a_81_2 = {72 75 73 74 5f 70 61 6e 69 63 } //01 00 
		$a_81_3 = {52 61 69 73 65 45 78 63 65 70 74 69 6f 6e } //01 00 
		$a_81_4 = {43 6f 6e 74 72 6f 6c 5f 52 75 6e 44 4c 4c } //01 00 
		$a_81_5 = {61 68 6e 7a 74 73 63 6b 79 6b } //01 00 
		$a_81_6 = {61 6a 6c 76 62 6e 7a 76 76 6b 77 61 62 62 69 75 } //00 00 
	condition:
		any of ($a_*)
