...
rule Trojan_Win32_Emotetcrypt_JC_MTB{
	...
	strings :
		$a_03_0 = {8b ea 0f af e9 2b dd 2b d8 2b d8 2b d8 2b d8 8b 44 24 90 01 01 2b de 2b d9 2b d9 2b d9 2b d9 03 df 03 df 8a 0c 03 8b 44 24 90 01 01 8a 18 32 d9 8b 4c 24 90 01 01 88 18 90 00 } //1
