...
rule Trojan_Win32_Emotetcrypt_GI_MTB{
	...
	strings :
		$a_02_0 = {6a 40 68 00 30 00 00 8b 4d 90 01 01 8b 51 90 01 01 52 8b 45 90 01 01 8b 48 90 01 01 51 ff 15 90 00 } //1
...
rule Trojan_Win32_Emotetcrypt_GI_MTB_2{
	...
	strings :
		$a_02_0 = {6a 40 68 00 30 00 00 8b 90 01 02 8b 90 01 03 8b 90 01 02 8b 90 01 03 ff 15 90 00 } //1
		$a_00_1 = {f3 a4 8b 44 24 0c 5e 5f c3 } //10
		$a_02_2 = {83 c4 0c 8b 90 01 02 83 90 01 01 28 89 90 01 02 eb 90 00 } //1
...
rule Trojan_Win32_Emotetcrypt_GI_MTB_3{
	...
	strings :
		$a_03_0 = {0f b6 14 2a 03 c2 99 bd 90 01 04 f7 fd 8b c1 0f af c3 83 c0 02 0f af c7 83 c0 02 0f af 05 90 01 04 2b f0 8d 44 1b 02 0f af c3 03 44 24 2c 2b f1 0f af 0d 90 01 04 2b f7 8d 14 72 03 c2 8d 0c 89 0f b6 14 01 8b 44 24 20 30 10 90 00 } //1
