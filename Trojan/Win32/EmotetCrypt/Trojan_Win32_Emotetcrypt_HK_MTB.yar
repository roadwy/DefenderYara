...
rule Trojan_Win32_Emotetcrypt_HK_MTB{
	...
	strings :
		$a_03_0 = {2b ca 2b 0d ?? ?? ?? ?? 8b 15 ?? ?? ?? ?? 2b c8 8d 8c 8f 00 10 00 00 8d 04 95 00 20 00 00 0b c8 51 56 55 ff 15 } //1
		...
		$a_03_14 = {0f b6 04 30 03 c3 99 bb ?? ?? ?? ?? f7 fb 03 54 24 ?? 8b da 8b 54 24 ?? 8a 04 32 8b 54 24 ?? 0f b6 14 1a 88 14 2e 8b 54 24 ?? 88 04 1a 8b 44 24 ?? 0f b6 04 30 8b 54 24 ?? 0f b6 14 1a 03 c2 99 bd ?? ?? ?? ?? f7 fd 8b 44 24 ?? 8b 6c 24 ?? 03 d7 0f b6 14 02 30 54 29 } //14
	condition:
