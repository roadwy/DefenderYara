...
rule Trojan_Win32_Emotetcrypt_II_MTB{
	...
	strings :
		$a_03_0 = {8b 54 24 28 bf 90 01 04 8b 44 24 24 0f be 1c 08 8b 44 24 20 0f b6 04 08 03 da 03 c3 99 8b df f7 fb 8b 5c 24 2c 8b 44 24 1c 8a 04 08 8a 1c 13 88 1c 0e 8b 5c 24 30 41 3b cf 88 04 13 90 00 } //1
