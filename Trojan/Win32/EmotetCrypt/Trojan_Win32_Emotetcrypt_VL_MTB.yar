...
rule Trojan_Win32_Emotetcrypt_VL_MTB{
	...
	strings :
		$a_02_0 = {03 c2 99 b9 [0-04] f7 f9 [0-19] 0f b6 [0-04] a1 [0-04] 8a 0c [0-02] 8b 44 [0-02] 30 0c 28 8b 44 [0-02] 45 3b e8 0f 8c } //1
	condition:
		((#a_02_0  & 1)*1) >=1
...
rule Trojan_Win32_Emotetcrypt_VL_MTB_2{
	...
	strings :
		...
		$a_02_7 = {8b cf c1 e9 ?? 8b c7 c1 e8 ?? 83 e0 01 83 e1 01 8d 0c 48 8b c7 c1 e8 ?? 8d 04 48 8b 04 85 ?? ?? ?? ?? f7 c7 00 00 00 04 ?? ?? 0d ?? ?? ?? ?? 8d 4d ?? 51 50 56 ff 32 ff 15 ?? ?? ?? ?? f7 d8 1b c0 [0-02] f7 d8 [0-03] c2 } //1
	condition:
