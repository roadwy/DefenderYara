...
rule Trojan_Win32_EmotetCrypt_DM_MTB{
	...
	strings :
		$a_03_0 = {03 5c 24 14 0f b6 14 3b 03 c2 33 d2 f7 35 90 01 04 03 ca 8d 04 71 8a 0c 38 8b 44 24 20 30 08 ff 44 24 18 8b 44 24 18 3b 44 24 28 0f 82 90 00 } //1
		...
		$a_03_2 = {8b 5c 24 28 0f b6 14 1a 03 c2 33 d2 f7 35 90 01 04 8b 44 24 20 2b d1 8a 0c 1a 30 08 ff 44 24 18 8b 44 24 18 3b 44 24 30 0f 82 90 00 } //1
