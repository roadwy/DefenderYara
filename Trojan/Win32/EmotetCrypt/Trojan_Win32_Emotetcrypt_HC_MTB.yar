...
rule Trojan_Win32_Emotetcrypt_HC_MTB{
	...
	strings :
		$a_03_0 = {8d 04 80 03 d8 a1 90 01 04 0f af d9 6b c9 fd 03 eb 8d 5e 04 0f af d8 2b cb 2b ce 03 ca 8d 50 02 0f af d6 8d 04 42 8d 04 80 8d 4c 8d 00 2b c8 8b 44 24 24 8a 18 8a 0c 39 32 d9 8b 4c 24 34 88 18 90 00 } //1
