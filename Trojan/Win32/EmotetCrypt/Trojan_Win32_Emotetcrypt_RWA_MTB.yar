...
rule Trojan_Win32_Emotetcrypt_RWA_MTB{
	...
	strings :
		$a_03_0 = {33 c1 c1 e9 08 0f b6 c0 33 8c 84 ?? ?? ?? ?? 83 ee 01 75 ?? 8b 5c 24 ?? f6 d1 8b 44 24 ?? 88 0c 03 43 89 5c 24 ?? 81 fb ce 40 00 00 73 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_Win32_Emotetcrypt_RWA_MTB_2{
	...
	strings :
		...
		$a_03_1 = {b9 20 1f 00 00 f7 f1 8b 45 ?? 03 55 ?? 8b 4d ?? 0f b6 04 02 8b 55 ?? 30 04 0a 41 89 4d ?? 3b cf b9 20 1f 00 00 72 } //1
	condition:
...
rule Trojan_Win32_Emotetcrypt_RWA_MTB_3{
	...
	strings :
		...
		$a_03_2 = {33 d2 f7 35 ?? ?? ?? ?? 03 ca 8d 04 71 8a 0c 38 8b 44 24 ?? 30 08 ff 44 24 ?? 8b 44 24 ?? 3b 44 24 ?? 0f } //1
	condition:
