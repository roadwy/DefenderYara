...
rule Trojan_Win32_EmotetCrypt_AR_MTB{
	...
	strings :
		$a_81_0 = {43 3a 5c 55 73 65 72 73 5c 44 4f 44 4f 5c 56 69 64 65 6f 73 5c 77 69 6e 33 32 5f 6d 65 6d 64 63 5f 73 72 63 5c 52 65 6c 65 61 73 65 5c 57 69 6e 33 32 5f 4d 65 6d 44 43 2e 70 64 62 } //01 00 
...
rule Trojan_Win32_EmotetCrypt_AR_MTB_2{
	...
	strings :
		...
		$a_81_2 = {4c 39 67 66 65 66 64 54 54 52 76 68 } //00 00 
		$a_00_3 = {78 } //8c 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win32_EmotetCrypt_AR_MTB_3{
	...
	strings :
		...
		$a_81_3 = {42 35 36 77 72 67 37 51 72 78 74 74 68 } //00 00 
		$a_00_4 = {78 94 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win32_EmotetCrypt_AR_MTB_4{
	...
	strings :
		...
		$a_81_3 = {51 79 69 6e 79 68 6a 6a 62 74 36 37 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win32_EmotetCrypt_AR_MTB_5{
	...
	strings :
		...
		$a_81_1 = {79 36 69 74 68 67 72 68 68 79 74 74 } //01 00 
		$a_81_2 = {63 3a 5c 55 73 65 72 73 5c 44 6f 64 6f 5c 44 6f 77 6e 6c 6f 61 64 73 5c 57 65 62 50 61 67 65 53 6e 61 70 53 68 6f 74 5c 52 65 6c 65 61 73 65 5c 57 65 62 50 61 67 65 53 6e 61 70 53 68 6f 74 2e 70 64 62 } //00 00 
		$a_00_3 = {78 9d } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win32_EmotetCrypt_AR_MTB_6{
	...
	strings :
		...
		$a_81_3 = {64 72 74 66 66 44 57 45 55 46 45 55 46 55 57 45 47 46 55 59 42 47 } //00 00 
		$a_00_4 = {7e } //15 00 
	condition:
		any of ($a_*)
