...
rule Trojan_Win32_Emotetcrypt_JD_MTB{
	...
	strings :
		...
		$a_01_1 = {58 40 69 28 4f 35 53 4e 33 56 6e 50 3f 41 36 5f 66 72 5e 56 59 2b 40 52 5f 6d 39 24 3c 46 75 34 70 4e 5f 48 23 79 47 4d 76 51 29 35 46 55 56 69 31 36 34 5e 5e 31 24 7a 6d 75 6d 45 31 46 7a } //00 00 
	condition:
		any of ($a_*)
