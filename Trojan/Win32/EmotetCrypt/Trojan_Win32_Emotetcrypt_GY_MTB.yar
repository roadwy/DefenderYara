...
rule Trojan_Win32_Emotetcrypt_GY_MTB{
	...
	strings :
		$a_03_0 = {03 d7 8d 3c 09 bd 90 01 04 2b ef 0f af ee bf 90 01 04 2b f8 8d 44 7d 00 0f af 05 90 01 04 03 d0 a1 90 01 04 8d 34 46 8d 04 85 90 01 04 0f af c1 d1 e6 2b d6 03 d3 8a 0c 10 8b 44 24 90 01 01 8a 18 32 d9 8b 4c 24 90 01 01 88 18 90 00 } //1
