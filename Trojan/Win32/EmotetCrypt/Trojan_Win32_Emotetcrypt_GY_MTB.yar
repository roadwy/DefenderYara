...
rule Trojan_Win32_Emotetcrypt_GY_MTB{
	...
	strings :
		...
		$a_81_1 = {61 33 74 72 37 6d 78 36 42 4a 72 73 37 3c 66 62 54 25 59 28 64 75 4a 28 4d 76 6a 52 40 30 64 41 62 35 21 51 6d 36 37 29 36 43 4b 76 77 55 68 37 4f 55 72 30 55 5f 72 58 46 68 4f 77 54 29 24 6b 48 39 71 77 24 55 40 6b } //00 00  a3tr7mx6BJrs7<fbT%Y(duJ(MvjR@0dAb5!Qm67)6CKvwUh7OUr0U_rXFhOwT)$kH9qw$U@k
	condition:
		any of ($a_*)
