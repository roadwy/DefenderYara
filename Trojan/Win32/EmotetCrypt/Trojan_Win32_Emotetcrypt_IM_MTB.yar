...
rule Trojan_Win32_Emotetcrypt_IM_MTB{
	...
	strings :
		...
		$a_81_1 = {50 69 69 66 47 57 25 45 61 37 33 72 33 69 29 6f 65 75 4a 71 45 71 4f 4e 5f 2b 33 52 78 48 29 65 32 4d 6b 72 32 52 21 5f 6d 6b 34 47 46 44 36 4d 6d 2b 58 46 5f } //00 00 
	condition:
		any of ($a_*)
