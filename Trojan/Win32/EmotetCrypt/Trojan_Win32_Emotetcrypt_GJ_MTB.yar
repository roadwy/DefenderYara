...
rule Trojan_Win32_Emotetcrypt_GJ_MTB{
	...
	strings :
		...
		$a_81_1 = {58 3e 4a 54 51 28 44 6b 54 25 78 6b 48 5e 38 4a 70 52 40 40 38 77 58 6a 79 68 5a 6f 79 44 45 46 37 67 23 31 6b 4c 44 70 6d 32 33 70 41 49 32 75 6c 77 77 79 65 56 } //00 00 
	condition:
		any of ($a_*)
