...
rule Trojan_Win32_Emotetcrypt_HU_MTB{
	...
	strings :
		$a_03_0 = {0f b6 14 2b 03 c2 99 bd ?? ?? ?? ?? f7 fd a1 ?? ?? ?? ?? 0f af c7 5d 2b e8 0f af e9 8d 44 0f 02 0f af c6 2b e8 a1 ?? ?? ?? ?? 0f af c0 03 e8 6b ed 03 03 d5 8d 04 09 2b d0 2b 54 24 20 8b 44 24 2c 03 15 ?? ?? ?? ?? 03 d6 8a 0c 1a 30 08 } //1
