...
rule Trojan_Win32_Emotetcrypt_FV_MTB{
	...
	strings :
		...
		$a_81_1 = {6b 65 62 61 31 63 71 73 71 36 2e 64 6c 6c } //1 keba1cqsq6.dll
		...
		$a_81_5 = {47 65 74 43 6f 6d 6d 61 6e 64 4c 69 6e 65 41 } //1 GetCommandLineA
		$a_81_6 = {43 72 65 61 74 65 4d 75 74 65 78 41 } //1 CreateMutexA
