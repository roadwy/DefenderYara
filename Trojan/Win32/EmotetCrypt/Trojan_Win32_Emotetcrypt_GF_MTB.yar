...
rule Trojan_Win32_Emotetcrypt_GF_MTB{
	...
	strings :
		$a_03_0 = {2b d0 03 15 90 01 04 03 15 90 01 04 a1 90 01 04 0f af 05 90 01 04 03 15 90 01 04 03 c2 8b 15 90 01 04 0f af 15 90 01 04 03 c2 2b 05 90 01 04 2b 05 90 01 04 8b 55 08 0f b6 04 02 8b 55 0c 0f b6 0c 0a 33 c8 90 00 } //1
