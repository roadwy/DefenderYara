...
rule Trojan_Win32_Emotetcrypt_HZ_MTB{
	...
	strings :
		$a_03_0 = {03 d1 2b 15 90 01 04 a1 90 01 04 0f af 05 90 01 04 03 d0 8b 0d 90 01 04 0f af 0d 90 01 04 03 d1 8b 45 f0 03 05 90 01 04 8b 4d 08 0f b6 04 01 8b 4d 0c 0f b6 14 11 33 d0 a1 90 01 04 0f af 05 90 01 04 8b 0d 90 00 } //1
