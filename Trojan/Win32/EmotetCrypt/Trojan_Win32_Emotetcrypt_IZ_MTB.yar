...
rule Trojan_Win32_Emotetcrypt_IZ_MTB{
	...
	strings :
		$a_03_0 = {0f af d6 0f af 15 90 01 04 8b 2d 90 01 04 03 e9 8d 4c 6a 02 0f af 0d 90 01 04 2b d9 48 0f af c6 03 fb 8b 4c 24 48 8a 14 38 8b 44 24 28 8a 18 32 da 88 18 90 00 } //1
