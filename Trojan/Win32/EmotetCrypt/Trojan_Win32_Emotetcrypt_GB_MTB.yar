...
rule Trojan_Win32_Emotetcrypt_GB_MTB{
	...
	strings :
		$a_03_0 = {03 c2 33 d2 f7 35 90 01 04 89 55 ec 8b 45 f4 03 05 90 01 04 8b 4d ec 2b 0d 90 01 04 8b 55 08 0f b6 0c 0a 8b 55 0c 0f b6 04 02 33 c1 8b 4d f4 03 0d 90 01 04 8b 55 0c 88 04 0a 90 00 } //1
