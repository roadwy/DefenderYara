...
rule Trojan_Win32_Emotetcrypt_DZ_MTB{
	...
	strings :
		...
		$a_03_1 = {8b 55 f0 0f b7 42 06 39 45 dc 7d 90 01 01 8b 4d e4 8b 51 10 52 8b 45 e4 8b 48 14 03 4d ec 51 8b 55 e4 8b 42 0c 03 45 e8 90 01 04 07 00 83 c4 0c 8b 4d e4 83 c1 28 89 4d e4 eb 90 00 } //10
		$a_03_2 = {8b 4d dc 83 c1 01 89 4d dc 8b 55 f0 0f b7 42 06 39 45 dc 7d 90 01 01 8b 4d e4 8b 51 10 52 8b 45 e4 8b 48 14 03 4d ec 51 8b 55 e4 8b 42 0c 03 45 e8 50 e8 90 01 04 83 c4 0c 8b 4d e4 83 c1 28 89 4d e4 eb 90 00 } //10
