...
rule Trojan_Win32_Emotetcrypt_EQ_MTB{
	...
	strings :
		...
		$a_81_1 = {43 51 56 46 51 4e 45 5e 78 30 2a 3c 26 43 4b 73 75 39 35 28 50 45 57 63 4b 33 55 74 65 46 28 46 4c 58 3c 79 4c 45 6c 3f 57 38 4f 25 6a 26 23 32 43 63 25 4e 56 38 46 31 50 43 67 24 63 } //00 00 
	condition:
		any of ($a_*)
