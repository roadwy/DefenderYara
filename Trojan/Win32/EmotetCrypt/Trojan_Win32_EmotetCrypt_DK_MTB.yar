...
rule Trojan_Win32_EmotetCrypt_DK_MTB{
	...
	strings :
		...
		$a_81_1 = {64 57 79 44 49 68 51 28 2a 66 53 65 6f 72 65 44 57 74 39 44 26 45 2b 38 74 65 55 54 73 61 77 25 40 49 40 37 47 39 2b 33 4f 42 30 58 30 4a 73 63 41 42 4c 4f } //01 00 
		...
		$a_81_3 = {72 4b 30 50 2b 58 58 25 40 59 61 70 39 63 64 72 29 48 79 56 3c 76 65 37 71 4b 36 2b 42 45 57 68 51 3e 5e 41 59 70 32 61 74 4a 23 4e 4c 6a 73 7a 55 6c 4c 40 63 64 6c 45 53 5f 6f 54 6e 44 4e 77 64 6d } //00 00 
	condition:
		any of ($a_*)
