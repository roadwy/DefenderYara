...
rule Trojan_Win32_Emotetcrypt_JA_MTB{
	...
	strings :
		$a_03_0 = {8b 44 24 2c 83 c0 02 0f af c7 6b c0 03 03 d0 8d 41 03 0f af 05 90 01 04 03 44 24 5c 2b d6 8b 74 24 44 0f af f1 03 c2 8a 0c 06 8b 44 24 48 30 08 90 00 } //1
