...
rule Trojan_Win32_EmotetCrypt_PBR_MTB{
	...
	strings :
		$a_03_0 = {0f b6 8c 15 90 01 03 ff 03 c1 b9 90 01 04 99 f7 f9 8b 8d 90 01 03 ff 0f b6 84 15 90 01 03 ff 32 44 1f ff ff 4d 90 01 01 88 43 ff 90 00 } //1
		$a_03_1 = {0f b6 54 3c 90 01 01 0f b6 c0 03 c2 99 f7 fb 0f b6 44 14 90 01 01 32 44 29 ff 83 6c 24 90 01 01 01 88 41 ff 90 00 } //1
