...
rule Trojan_Win32_Emotetcrypt_DQ_MTB{
	...
	strings :
		...
		$a_81_5 = {61 6b 79 6e 63 62 67 6f 6c 6c 6d 6a } //01 00 
		$a_81_6 = {61 6c 72 63 69 64 78 6c 6a 78 79 62 64 67 67 73 } //01 00 
		$a_81_7 = {68 61 6a 7a 62 61 70 63 6d 67 7a 6e 71 } //01 00 
		$a_81_8 = {70 66 6f 79 61 65 73 74 6b 6d 6d 76 62 7a 79 72 } //00 00 
	condition:
		any of ($a_*)
