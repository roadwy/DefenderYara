...
rule Trojan_Win32_Emotetcrypt_GW_MTB{
	...
	strings :
		$a_03_0 = {0f b6 14 1a 03 c2 99 bd ?? ?? ?? ?? f7 fd a1 ?? ?? ?? ?? 8b e9 0f af ce 0f af e8 0f af c8 0f af ef 45 0f af 2d ?? ?? ?? ?? 41 0f af ee 0f af cf 2b cd 8d 04 49 03 d3 8a 0c 10 8b 44 24 ?? 30 08 } //1
