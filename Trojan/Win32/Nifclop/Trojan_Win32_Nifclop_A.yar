...
rule Trojan_Win32_Nifclop_A{
	...
	strings :
		$a_03_0 = {66 2d 07 00 8d 4d 98 0f 80 90 01 02 00 00 0f bf c0 50 51 90 00 } //2
		$a_03_1 = {6a 79 8d 8d 90 01 02 ff ff 51 ff 15 90 01 04 8d 95 90 01 02 ff ff 6a 70 52 ff 15 90 01 04 8d 85 90 01 02 ff ff 6a 6e 50 ff 15 90 01 04 8d 8d 90 01 02 ff ff 6a 6f 51 ff 15 90 01 04 8d 95 90 01 02 ff ff 6a 7b 90 00 } //2
