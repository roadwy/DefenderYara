...
rule Trojan_Win32_Nifclop_A{
	...
	strings :
		...
		$a_00_2 = {3c 00 21 00 2d 00 2d 00 49 00 6e 00 69 00 63 00 69 00 6f 00 70 00 2d 00 2d 00 3e 00 } //01 00 
		$a_00_3 = {3c 00 21 00 2d 00 2d 00 46 00 69 00 6e 00 70 00 2d 00 2d 00 3e 00 } //00 00 
	condition:
		any of ($a_*)
