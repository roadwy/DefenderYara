...
rule Trojan_Win32_InfoStealer_VZ_MTB{
	...
	strings :
		$a_02_0 = {d4 fe ff ff 83 c0 90 01 01 89 85 90 01 04 8b 8d 90 01 04 3b 4d 0c 73 22 0f b6 15 90 01 04 8b 45 08 03 85 90 01 04 0f b6 08 2b ca 8b 55 08 03 95 90 01 04 88 0a eb c4 90 00 } //10
