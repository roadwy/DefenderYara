...
rule Trojan_Win32_Msposer_L{
	...
	strings :
		...
		$a_03_2 = {43 6f 70 79 72 69 67 68 74 20 c2 a9 20 4d 90 03 05 04 69 63 72 6f 73 65 67 61 53 6f 66 74 20 32 30 31 32 90 02 0f 43 68 72 6f 6d 65 90 02 0f 4d 90 03 05 04 69 63 72 6f 73 65 67 61 53 6f 66 74 90 00 } //1
	condition:
