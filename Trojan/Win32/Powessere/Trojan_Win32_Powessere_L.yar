...
rule Trojan_Win32_Powessere_L{
	...
	strings :
		$a_00_0 = {6d 00 73 00 68 00 74 00 61 00 2e 00 65 00 78 00 65 00 } //-10 mshta.exe
		...
		$a_02_4 = {6a 00 61 00 76 00 61 00 73 00 63 00 72 00 69 00 70 00 74 00 3a 00 [0-20] 3d 00 [0-20] 3b 00 } //1
		...
		$a_02_6 = {2e 00 52 00 65 00 67 00 52 00 65 00 61 00 64 00 28 00 48 00 4b 00 43 00 55 00 5c 00 5c 00 73 00 6f 00 66 00 74 00 77 00 61 00 72 00 65 00 5c 00 5c 00 [0-20] 5c 00 5c 00 [0-20] 29 00 3b 00 } //1
		$a_02_7 = {3b 00 65 00 76 00 61 00 6c 00 28 00 [0-20] 29 00 3b 00 } //1
	condition:
		((#a_00_0  & 1)*-10+(#a_00_1  & 1)*1+(#a_00_2  & 1)*1+(#a_00_3  & 1)*1+(#a_02_4  & 1)*1+(#a_00_5  & 1)*1+(#a_02_6  & 1)*1+(#a_02_7  & 1)*1) >=7
