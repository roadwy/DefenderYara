...
rule Trojan_Win32_Powessere_S{
	...
	strings :
		...
		$a_02_4 = {28 00 67 00 70 00 20 00 90 02 02 48 00 4b 00 90 01 04 3a 00 5c 00 53 00 6f 00 66 00 74 00 77 00 61 00 72 00 65 00 5c 00 4d 00 69 00 63 00 72 00 6f 00 73 00 6f 00 66 00 74 00 90 00 } //1
	condition:
