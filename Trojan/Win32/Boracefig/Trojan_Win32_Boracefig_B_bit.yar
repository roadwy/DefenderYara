...
rule Trojan_Win32_Boracefig_B_bit{
	...
	strings :
		$a_03_0 = {80 7c 24 18 76 0f 85 90 01 04 80 7c 24 19 64 0f 85 90 00 } //1
		$a_01_1 = {32 c2 66 0f b6 d2 66 c1 e7 08 66 0b fa 66 33 7c 24 14 88 44 24 0d } //1
		$a_03_2 = {8a 4c 14 30 8a c2 f6 ea 04 03 84 c9 74 0a 3a c8 74 06 32 c8 88 4c 14 30 42 81 fa 90 01 04 72 90 00 } //2
