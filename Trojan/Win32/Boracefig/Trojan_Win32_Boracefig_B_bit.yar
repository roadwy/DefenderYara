...
rule Trojan_Win32_Boracefig_B_bit{
	...
	strings :
		...
		$a_01_3 = {44 45 4c 45 54 45 2d 54 43 42 } //01 00  DELETE-TCB
		$a_01_4 = {44 69 72 20 25 64 6b 20 28 25 64 29 } //01 00  Dir %dk (%d)
		$a_01_5 = {2f 2f 25 73 2f 25 35 2e 35 64 2e 68 74 6d 6c } //00 00  //%s/%5.5d.html
	condition:
		any of ($a_*)
