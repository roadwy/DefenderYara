...
rule Trojan_Win32_Helbsly_A{
	...
	strings :
		...
		$a_01_5 = {76 64 70 6c 75 67 69 6e 2e 64 6c 6c 00 76 64 70 6c 75 67 69 6e 5f 73 74 61 72 74 75 70 00 } //01 00 
		$a_01_6 = {62 61 69 79 75 61 6e 66 61 6e 40 53 74 65 65 6c 4b 65 72 6e 65 6c 47 72 6f 75 70 } //00 00 
	condition:
		any of ($a_*)
