...
rule Trojan_Win32_Trayntadd{
	...
	strings :
		...
		$a_01_3 = {65 2e 65 6e 67 6c 61 6e 64 70 72 65 76 61 69 6c 2e 63 } //03 00 
		$a_01_4 = {6f 6d 2f 70 72 6f 64 75 63 74 73 2f 64 72 69 76 65 2f 69 6e 64 65 78 2e 68 74 6d } //03 00 
