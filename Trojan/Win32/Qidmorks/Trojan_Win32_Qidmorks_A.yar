...
rule Trojan_Win32_Qidmorks_A{
	...
	strings :
		...
		$a_01_2 = {3f 00 64 57 6c 6b 50 51 3d 3d 00 26 00 64 6d 56 79 50 51 3d 3d 00 62 57 73 39 00 62 33 4d 39 00 63 6e 4d 39 00 59 7a 30 3d 00 63 6e 45 39 } //00 00  ?坤歬児㴽☀搀噭偹㵑=坢㥳戀䴳9湣㥍夀ぺ=湣㥅
	condition:
		any of ($a_*)
