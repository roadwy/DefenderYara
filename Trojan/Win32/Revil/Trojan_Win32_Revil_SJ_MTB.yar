...
rule Trojan_Win32_Revil_SJ_MTB{
	meta:
		description = "Trojan:Win32/Revil.SJ!MTB,SIGNATURE_TYPE_PEHSTR_EXT,16 00 16 00 08 00 00 0a 00 "
		
	strings :
		$a_81_0 = {7b 45 58 54 7d 2d 72 65 61 64 6d 65 2e 74 78 74 } //0a 00  {EXT}-readme.txt
