...
rule Trojan_Win32_Revil_SF_MTB{
	...
	strings :
		...
		$a_03_3 = {22 73 75 62 22 3a 22 90 02 08 22 2c 22 64 62 67 22 3a 90 02 08 2c 22 65 74 22 3a 90 02 02 2c 22 77 69 70 65 22 3a 90 02 05 2c 22 77 68 74 22 3a 7b 90 00 } //1
	condition:
