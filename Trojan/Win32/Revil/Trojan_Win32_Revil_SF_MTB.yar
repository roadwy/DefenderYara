...
rule Trojan_Win32_Revil_SF_MTB{
	...
	strings :
		...
		$a_81_2 = {22 66 6c 73 22 3a 5b 22 62 6f 6f 74 2e 69 6e 69 22 2c 22 69 63 6f 6e 63 61 63 68 65 2e 64 62 22 2c 22 62 6f 6f 74 73 65 63 74 2e 62 61 6b 22 2c } //01 00  "fls":["boot.ini","iconcache.db","bootsect.bak",
