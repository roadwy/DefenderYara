...
rule Trojan_Win32_Midie_SIBJ_MTB{
	meta:
		description = "Trojan:Win32/Midie.SIBJ!MTB,SIGNATURE_TYPE_PEHSTR_EXT,02 00 02 00 02 00 00 01 00 "
		
	strings :
		$a_00_0 = {79 7a 6c 68 62 78 78 68 2e 64 6c 6c } //01 00  yzlhbxxh.dll
		$a_03_1 = {33 c9 85 db 74 90 01 01 8a 04 39 90 02 20 34 a2 90 02 20 fe c0 34 4f 90 02 20 88 04 39 41 3b cb 72 90 01 01 6a 00 57 6a 00 ff 15 90 00 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Midie_SIBJ_MTB_2{
	...
	strings :
		$a_00_0 = {5c 62 72 65 61 6b 74 68 72 6f 75 67 68 2e 65 78 65 } //01 00  \breakthrough.exe
