...
rule Trojan_Win32_Midie_SIBH_MTB{
	...
	strings :
		$a_00_0 = {6a 73 61 6c 66 68 78 68 2e 64 6c 6c } //01 00 
...
rule Trojan_Win32_Midie_SIBH_MTB_2{
	...
	strings :
		$a_00_0 = {64 63 6e 77 6e 71 73 67 2e 70 64 62 } //01 00 
...
rule Trojan_Win32_Midie_SIBH_MTB_3{
	...
	strings :
		$a_00_0 = {5c 63 6f 6d 70 69 6c 69 6e 67 5c 66 6c 6f 63 6b 5c 61 64 6d 6f 6e 69 73 68 2e 6a 70 67 } //01 00 
		$a_00_1 = {5c 70 72 6f 76 69 64 65 73 2e 65 78 65 } //01 00 
