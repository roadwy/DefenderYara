...
rule Trojan_Win32_Midie_SIBG_MTB{
	...
	strings :
		$a_00_0 = {5c 73 74 65 70 66 61 74 68 65 72 5c 62 6f 77 65 6c 73 2e 70 64 66 } //01 00 
		$a_00_1 = {5c 61 69 72 77 61 76 65 73 5c 6c 65 6d 6f 6e 61 64 65 2e 62 6d 70 } //01 00 
