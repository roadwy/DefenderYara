...
rule Trojan_Win32_Midie_SIBM_MTB{
	...
	strings :
		...
		$a_03_2 = {b9 00 00 00 00 8a 84 0d ?? ?? ?? ?? 81 f9 ?? ?? ?? ?? 74 ?? [0-08] 04 ?? [0-08] 2c ?? [0-08] 34 ?? [0-08] 88 84 0d 90 1b 00 83 c1 01 90 18 8a 84 0d 90 1b 00 81 f9 90 1b 01 90 18 b0 00 b9 00 00 00 00 68 ?? ?? ?? ?? 68 ?? 90 1b 10 ff 15 ?? ?? ?? ?? 50 ff 15 ?? ?? ?? ?? 8d 4d ?? 51 6a 40 56 8d 8d 90 1b 00 51 ff d0 8d 85 90 1b 00 ff d0 } //1
	condition:
