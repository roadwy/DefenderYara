...
rule Trojan_Win32_Midie_SIBM_MTB{
	meta:
		description = "Trojan:Win32/Midie.SIBM!MTB,SIGNATURE_TYPE_PEHSTR_EXT,03 00 03 00 03 00 00 01 00 "
		
	strings :
		$a_00_0 = {5c 69 6e 74 65 67 72 61 6c 5c 64 65 76 69 6c 73 2e 65 78 65 } //01 00  \integral\devils.exe
		$a_00_1 = {5c 63 68 75 72 63 68 65 73 5c 62 72 6f 63 6b 2e 61 75 } //01 00  \churches\brock.au
