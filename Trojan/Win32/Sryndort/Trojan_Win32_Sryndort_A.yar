...
rule Trojan_Win32_Sryndort_A{
	meta:
		description = "Trojan:Win32/Sryndort.A,SIGNATURE_TYPE_PEHSTR_EXT,04 00 04 00 04 00 00 02 00 "
		
	strings :
		$a_03_0 = {8b 4d e8 2b c8 46 8a 51 19 88 54 3e ff eb 90 01 01 8a 04 1e 8d 4d ec 50 e8 90 00 } //01 00 
