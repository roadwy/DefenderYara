...
rule Trojan_Win32_Fasong_dwuq_MTB{
	...
	strings :
		...
		$a_01_1 = {6b 61 76 39 78 2e 65 78 65 } //01 00 
		$a_01_2 = {72 61 76 6d 6f 6e 2e 65 78 65 } //01 00 
		$a_01_3 = {77 61 74 63 68 65 72 2e 65 78 65 } //01 00 
		$a_01_4 = {70 61 73 73 77 6f 72 64 67 75 61 72 64 2e 65 78 65 } //01 00 
