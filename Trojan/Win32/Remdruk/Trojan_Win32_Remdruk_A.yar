...
rule Trojan_Win32_Remdruk_A{
	...
	strings :
		...
		$a_01_1 = {31 64 4d 33 75 75 34 6a 37 46 77 34 73 6a 6e 62 63 77 6c 44 71 65 74 34 46 37 4a 79 75 } //01 00 
		$a_01_2 = {77 69 74 68 20 4d 53 30 35 2d 30 31 30 2b } //00 00 
	condition:
		any of ($a_*)
