...
rule Trojan_Win32_Foosace_E_dha{
	...
	strings :
		...
		$a_01_1 = {49 6e 69 74 31 } //2 Init1
		$a_80_2 = {37 30 2e 38 35 2e 32 32 31 2e 31 30 } //70.85.221.10  2
		$a_80_3 = {7e 78 68 2f 63 68 2e 63 67 69 } //~xh/ch.cgi  2
	condition:
...
rule Trojan_Win32_Foosace_E_dha_2{
	...
	strings :
		...
		$a_01_4 = {8a 54 37 fe 03 d3 03 d1 d3 ea 32 c2 8d 56 ff 83 e2 07 8a 1c 3a 8a 14 2e 32 c3 32 d0 41 88 14 2e 46 83 fe 0a 7c bb } //1
		$a_00_5 = {f7 f7 2b 4d ec 8b 45 e0 f7 d9 1b c9 f7 d1 23 ca 33 d2 f7 f6 89 4d fc 3b ca 89 55 e0 73 7a } //1
		$a_00_6 = {03 c1 03 45 14 d3 e8 8d 4e ff 83 e1 07 32 d0 32 14 39 8b 45 f8 30 14 30 8b 75 f4 8d 56 fe 83 fa 08 72 b7 } //1
		$a_00_7 = {8a c3 03 db 03 db 03 db 8b fe 2b fb 89 7d e8 bf 01 00 00 00 2b fb 89 7d ec 02 c0 bf 03 00 00 00 2b fb 02 c0 89 7d 0c 02 c0 bf 02 00 00 00 2b fb 88 45 13 8d 04 0b 89 7d 14 8b 7d 0c 8a 5d 13 02 d9 8b 4d 14 03 c8 03 f8 } //1
	condition:
