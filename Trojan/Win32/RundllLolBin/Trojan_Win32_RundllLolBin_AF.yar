...
rule Trojan_Win32_RundllLolBin_AF{
	...
	strings :
		...
		$a_00_1 = {6c 00 73 00 61 00 73 00 73 00 } //01 00  lsass
		$a_00_2 = {72 00 75 00 6e 00 64 00 6c 00 6c 00 33 00 32 00 } //01 00  rundll32
		$a_00_3 = {4d 00 69 00 6e 00 69 00 44 00 75 00 6d 00 70 00 } //00 00  MiniDump
	condition:
		any of ($a_*)
