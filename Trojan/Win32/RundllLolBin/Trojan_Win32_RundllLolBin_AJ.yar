...
rule Trojan_Win32_RundllLolBin_AJ{
	...
	strings :
		...
		$a_00_5 = {73 00 65 00 6e 00 74 00 69 00 6e 00 65 00 6c 00 43 00 6f 00 6d 00 6d 00 61 00 6e 00 64 00 } //65535 sentinelCommand
		$a_00_6 = {63 00 75 00 73 00 74 00 6f 00 6d 00 73 00 63 00 72 00 69 00 70 00 74 00 68 00 61 00 6e 00 64 00 6c 00 65 00 72 00 } //65535 customscripthandler
	condition:
		((#a_00_0  & 1)*1+(#a_00_1  & 1)*1+(#a_00_2  & 1)*1+(#a_00_3  & 1)*1+(#a_00_4  & 1)*1+(#a_00_5  & 1)*65535+(#a_00_6  & 1)*65535) >=4
