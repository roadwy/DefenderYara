...
rule Trojan_Win32_RundllLolBin_AA{
	meta:
		description = "Trojan:Win32/RundllLolBin.AA,SIGNATURE_TYPE_CMDHSTR_EXT,04 00 04 00 04 00 00 01 00 "
	...
	strings :
		...
		$a_00_3 = {45 00 78 00 65 00 63 00 75 00 74 00 65 00 45 00 78 00 63 00 65 00 6c 00 34 00 4d 00 61 00 63 00 72 00 6f 00 } //00 00  ExecuteExcel4Macro
	condition:
		any of ($a_*)
