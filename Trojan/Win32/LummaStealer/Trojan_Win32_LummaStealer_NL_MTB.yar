...
rule Trojan_Win32_LummaStealer_NL_MTB{
	...
	strings :
		...
		$a_03_1 = {e8 36 fa ff ff 83 c4 90 01 01 80 7e 48 00 75 10 85 c0 78 0c 8b 4c 24 14 88 90 00 } //3
	condition:
...
rule Trojan_Win32_LummaStealer_NL_MTB_2{
	...
	strings :
		$a_03_0 = {7c 16 43 33 f6 8b 47 90 01 01 8b d6 e8 e3 08 fc ff e8 26 fd fa ff 46 4b 75 ed 90 00 } //5
