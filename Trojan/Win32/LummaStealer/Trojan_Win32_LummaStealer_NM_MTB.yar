...
rule Trojan_Win32_LummaStealer_NM_MTB{
	...
	strings :
		$a_03_0 = {8b 35 08 91 75 00 8d 4f 90 01 01 03 74 24 18 ba 90 01 04 8b 5e 04 2b f7 90 00 } //3
		$a_03_1 = {8b 04 0e 8d 49 90 01 01 03 c3 89 41 fc 83 ea 01 75 f0 a1 0c 91 75 00 89 47 08 8d 44 24 10 90 00 } //3
