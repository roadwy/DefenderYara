...
rule Trojan_Win32_Miuref_F_{
	...
	strings :
		...
		$a_03_2 = {b8 6b 09 14 00 74 ?? 8a 0c 16 80 f9 61 7c 0d 80 f9 7a 7f 08 0f be c9 83 e9 20 eb 03 0f be c9 6b c0 1f 03 c1 42 3b d7 72 de } //1
		$a_03_3 = {3d c7 50 58 e8 75 ?? c7 05 ?? ?? ?? ?? 01 00 00 00 } //1
	condition:
