...
rule Trojan_Win32_Miuref_G_{
	...
	strings :
		$a_03_0 = {59 3d c7 50 58 e8 75 ?? c7 05 ?? ?? ?? ?? 01 00 00 00 } //2
		$a_03_1 = {50 6a 40 68 00 04 00 00 ff 75 f4 ff 15 ?? ?? ?? ?? 85 c0 74 37 6a 04 8d 45 fc 50 68 00 04 00 00 ff 75 f4 e8 ?? ?? ?? ?? 83 c4 10 68 60 ea 00 00 ff 15 ?? ?? ?? ?? 6a 04 8d 45 fc 50 68 00 04 00 00 ff 75 f4 e8 } //1
