...
rule Trojan_Win32_Fsblock_A{
	...
	strings :
		$a_01_0 = {42 49 54 42 54 4e 31 5f 42 49 54 4d 41 50 } //01 00 
...
rule Trojan_Win32_Fsblock_A_2{
	...
	strings :
		...
		$a_01_1 = {74 61 73 6b 6d 67 72 2e 65 78 65 2c 20 6d 73 63 6f 6e 66 69 67 2e 65 78 65 2c 20 72 65 67 65 64 69 74 2e 65 78 65 2c 20 63 6d 64 2e 65 78 65 } //01 00 
...
rule Trojan_Win32_Fsblock_A_3{
	...
	strings :
		$a_00_0 = {74 61 73 6b 6d 67 72 2e 65 78 65 2c 20 6d 73 63 6f 6e 66 69 67 2e 65 78 65 2c 20 72 65 67 65 64 69 74 2e 65 78 65 2c 20 63 6d 64 2e 65 78 65 } //01 00 
		...
		$a_00_2 = {52 45 47 20 41 44 44 20 48 4b 43 55 5c 53 6f 66 74 77 61 72 65 5c 4d 69 63 72 6f 73 6f 66 74 5c 57 69 6e 64 6f 77 73 5c 43 75 72 72 65 6e 74 56 65 72 73 69 6f 6e 5c 52 75 6e 20 2f 76 } //02 00 
		$a_00_3 = {72 65 67 20 61 64 64 20 48 4b 43 55 5c 53 6f 66 74 77 61 72 65 5c 4d 69 63 72 6f 73 6f 66 74 5c 57 69 6e 64 6f 77 73 5c 43 75 72 72 65 6e 74 56 65 72 73 69 6f 6e 5c 50 6f 6c 69 63 69 65 73 5c 53 79 73 74 65 6d 20 2f 76 20 44 69 73 61 62 6c 65 52 65 67 69 73 74 72 79 54 6f 6f 6c 73 20 2f 74 20 72 65 67 5f 64 77 6f 72 64 20 2f 64 20 31 20 2d 79 } //02 00 
		...
		$a_01_5 = {6d 72 62 65 6c 79 61 73 68 6e 6f 00 } //00 00 
	condition:
		any of ($a_*)
