...
rule Trojan_Win32_Wepiall_A{
	...
	strings :
		$a_03_0 = {56 67 63 51 7d 71 71 66 69 90 01 03 23 4a 6b 6f 69 22 45 6e 69 28 56 64 70 75 6b 66 66 2a 90 00 } //10
		$a_03_1 = {4a 6b 69 6f 44 64 6e 90 01 03 21 75 61 61 21 52 6c 73 74 6d 60 64 90 00 } //10
