...
rule Trojan_Win32_DarkGate_ZZ{
	...
	strings :
		...
		$a_81_1 = {5f 5f 5f 5f 70 61 64 6f 72 75 5f 5f 5f 5f } //0a 00 
		$a_81_2 = {45 72 72 6f 72 3a 20 6e 6f 20 64 65 6c 69 6d 69 74 61 64 6f 72 20 6d 6f 6e 69 74 6f 72 } //0a 00 
		$a_81_3 = {68 76 6e 63 20 65 72 72 6f 72 } //0a 00 
		$a_81_4 = {2d 61 63 63 65 70 74 65 75 6c 61 20 2d 64 20 2d 75 20 } //00 00 
