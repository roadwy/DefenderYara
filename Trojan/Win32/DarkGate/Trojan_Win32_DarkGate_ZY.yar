...
rule Trojan_Win32_DarkGate_ZY{
	...
	strings :
		...
		$a_03_1 = {80 e1 3f c1 e1 02 8a 5d 90 01 01 80 e3 30 81 e3 ff 00 00 00 c1 eb 04 02 cb 90 00 } //100
		$a_03_2 = {80 e1 0f c1 e1 04 8a 5d 90 01 01 80 e3 3c 81 e3 ff 00 00 00 c1 eb 02 02 cb 90 00 } //100
