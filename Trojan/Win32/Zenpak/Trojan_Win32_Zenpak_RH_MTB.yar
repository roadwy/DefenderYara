...
rule Trojan_Win32_Zenpak_RH_MTB_2{
	...
	strings :
		$a_03_0 = {29 d0 83 f2 08 01 35 90 01 04 01 d0 b8 09 00 00 00 48 ba 06 00 00 00 89 f8 50 8f 05 90 01 04 8d 05 90 01 04 01 28 b9 02 00 00 00 e2 bf 90 00 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Zenpak_RH_MTB_3{
	...
	strings :
		$a_03_0 = {b8 07 00 00 00 83 c0 0a 31 1d 90 01 04 42 31 d0 8d 05 90 01 04 01 28 8d 05 90 01 04 01 30 8d 05 90 01 04 ff d0 89 d0 8d 05 90 01 04 01 38 90 00 } //00 00 
	condition:
		any of ($a_*)
