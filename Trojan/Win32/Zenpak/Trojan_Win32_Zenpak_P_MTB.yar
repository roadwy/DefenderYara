...
rule Trojan_Win32_Zenpak_P_MTB{
	...
	strings :
		$a_03_0 = {8b 75 ec 89 34 24 8b 7d f0 89 7c 24 04 89 44 24 08 0f b6 04 0d 90 01 04 89 44 24 0c 89 55 e4 e8 90 01 04 8b 45 e4 8b 4d f4 39 c8 89 45 e8 75 bb 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_Win32_Zenpak_P_MTB_2{
	...
	strings :
		$a_03_0 = {8b 75 cc 32 0c 32 8b 55 90 01 01 88 0c 32 90 00 } //2
