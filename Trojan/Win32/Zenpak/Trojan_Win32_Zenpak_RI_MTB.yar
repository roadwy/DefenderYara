...
rule Trojan_Win32_Zenpak_RI_MTB{
	...
	strings :
		$a_03_0 = {b9 89 88 88 88 89 44 24 90 01 01 f7 e1 c1 ea 03 6b c2 0f 8b 4c 24 90 01 01 29 c1 89 c8 83 e8 04 89 4c 24 90 01 01 89 44 24 90 00 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Zenpak_RI_MTB_3{
	...
	strings :
		$a_01_0 = {8b 84 24 a8 00 00 00 b9 39 8e e3 38 89 84 24 a4 00 00 00 f7 e1 c1 ea 02 6b c2 12 8b 8c 24 a4 00 00 00 29 c1 89 c8 83 e8 0b 89 8c 24 a0 00 00 00 89 84 24 9c 00 00 00 74 7f } //00 00 
	condition:
		any of ($a_*)
