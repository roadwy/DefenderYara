...
rule Trojan_Win32_Zenpak_DEA_MTB{
	...
	strings :
		...
		$a_81_1 = {52 6c 34 4a 33 63 4d 74 46 72 69 45 76 38 63 59 4e 4d 64 68 72 35 33 74 76 44 72 53 58 64 4c 57 31 36 6c 68 36 57 77 } //00 00  Rl4J3cMtFriEv8cYNMdhr53tvDrSXdLW16lh6Ww
	condition:
		any of ($a_*)
