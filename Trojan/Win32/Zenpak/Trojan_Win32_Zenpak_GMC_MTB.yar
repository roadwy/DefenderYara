...
rule Trojan_Win32_Zenpak_GMC_MTB_2{
	...
	strings :
		$a_01_0 = {36 32 2e 31 37 31 2e 31 37 36 2e 32 34 } //01 00  62.171.176.24
		$a_01_1 = {70 61 79 6c 6f 61 64 2e 64 6c 6c } //01 00  payload.dll
		$a_01_2 = {30 40 2e 69 64 61 74 61 } //0a 00  0@.idata
