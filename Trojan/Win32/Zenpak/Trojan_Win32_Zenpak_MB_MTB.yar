...
rule Trojan_Win32_Zenpak_MB_MTB{
	...
	strings :
		$a_03_0 = {8b 55 08 31 f6 c7 05 90 01 08 3d 00 00 00 00 89 45 f4 89 4d f0 89 55 ec 89 75 e8 74 1e 8b 45 e8 8b 4d f0 8a 14 01 8b 75 ec 88 14 06 05 01 00 00 00 8b 7d f4 39 f8 89 45 e8 75 90 00 } //10
