...
rule Trojan_Win32_Zenpak_SM_MSR_2{
	...
	strings :
		...
		$a_00_1 = {46 00 49 00 5a 00 45 00 5a 00 55 00 42 00 41 00 52 00 45 00 46 00 4f 00 47 00 55 00 44 00 55 00 53 00 49 00 53 00 45 00 4c 00 49 00 5a 00 49 00 4d 00 } //00 00  FIZEZUBAREFOGUDUSISELIZIM
	condition:
		any of ($a_*)
