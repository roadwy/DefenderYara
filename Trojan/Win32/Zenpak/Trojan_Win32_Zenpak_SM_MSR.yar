...
rule Trojan_Win32_Zenpak_SM_MSR{
	...
	strings :
		$a_02_0 = {8a 94 07 f8 94 08 00 8b 1d 90 01 03 00 88 14 03 81 f9 03 02 00 00 90 13 40 3b c1 90 00 } //1
		$a_02_1 = {30 04 1e 83 ff 19 90 13 46 3b f7 90 00 } //1
	condition:
...
rule Trojan_Win32_Zenpak_SM_MSR_2{
	...
	strings :
		$a_02_0 = {28 8b 15 f8 90 01 02 02 8a 94 0a f8 94 08 00 8b 3d 3c 90 01 02 00 88 14 0f 3d 03 02 00 00 90 00 } //1
