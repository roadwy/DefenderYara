...
rule Trojan_Win32_Zenpak_GXZ_MTB{
	...
	strings :
		$a_03_0 = {89 20 83 ea 90 01 01 31 d0 48 48 e8 90 01 04 e8 90 01 04 83 f0 90 01 01 29 d0 89 2d 90 01 04 31 35 90 01 04 89 d8 50 8f 05 90 01 04 8d 05 90 01 04 31 38 90 00 } //00 00 
	condition:
		any of ($a_*)
