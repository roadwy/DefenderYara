...
rule Trojan_Win32_Zenpak_RB_MTB{
	...
	strings :
		$a_03_0 = {31 20 29 c2 4a e8 21 00 00 00 c3 31 c2 01 c2 42 31 1d 90 01 04 b8 06 00 00 00 8d 05 90 01 04 01 30 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_Win32_Zenpak_RB_MTB_2{
	...
	strings :
		$a_03_0 = {89 e1 c7 41 08 00 00 00 00 c7 41 04 41 01 00 00 c7 01 c7 b6 90 01 01 00 8b 0d 90 01 04 89 90 01 05 ff d1 83 ec 0c 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
