...
rule Trojan_Win32_Neoreblamy_RM_MTB{
	...
	strings :
		...
		$a_03_1 = {49 49 23 c8 74 90 01 01 33 c0 40 8b 90 01 05 d3 e0 8b 90 01 05 2b c8 89 90 09 0e 00 d3 e0 8b 90 01 05 2b 90 00 } //1
	condition:
...
rule Trojan_Win32_Neoreblamy_RM_MTB_2{
	...
	strings :
		$a_03_0 = {6a 04 58 d1 e0 8b 84 05 90 01 02 ff ff 48 6a 04 59 d1 e1 89 84 0d 90 01 02 ff ff 6a 04 58 d1 e0 83 bc 05 90 01 02 ff ff 00 7c 72 90 00 } //1
