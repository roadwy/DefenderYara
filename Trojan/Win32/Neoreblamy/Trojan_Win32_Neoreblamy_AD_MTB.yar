...
rule Trojan_Win32_Neoreblamy_AD_MTB{
	...
	strings :
		$a_02_0 = {23 ca 2b c1 8b 4d 90 01 01 0f b6 4c 0d 90 01 01 8b 55 90 01 01 2b 55 90 01 01 0f b6 54 15 90 01 01 0f b7 54 55 90 01 01 23 ca 2b c1 8b 4d 90 01 01 0f b6 4c 0d 90 01 01 66 89 44 4d 90 00 } //10
