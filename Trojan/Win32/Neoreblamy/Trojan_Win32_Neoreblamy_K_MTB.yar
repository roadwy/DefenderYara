...
rule Trojan_Win32_Neoreblamy_K_MTB{
	...
	strings :
		$a_02_0 = {33 c0 40 c1 e0 00 0f b6 44 05 90 01 01 83 c8 90 01 01 33 c9 41 c1 e1 00 0f b6 4c 0d 90 01 01 83 e1 90 01 01 2b c1 33 c9 41 6b c9 00 0f b6 4c 0d 90 01 01 66 89 44 4d 90 00 } //1
