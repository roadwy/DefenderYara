...
rule Trojan_Win32_Neoreblamy_KY_MTB{
	...
	strings :
		...
		$a_03_4 = {89 cb c1 e3 03 09 d3 00 dc be 90 01 04 66 ad 31 db 89 cb c1 e3 03 09 d3 00 dc be 90 01 04 66 ad 00 d4 b8 ff ff ff ff be 90 01 04 66 ad 00 d4 b8 ff ff ff ff be 90 01 04 66 ad 31 db 89 cb c1 e3 03 09 d3 00 dc 90 00 } //1
	condition:
