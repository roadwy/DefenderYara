...
rule Trojan_Win32_Neoreblamy_GMH_MTB{
	...
	strings :
		$a_03_0 = {8b cf 8a 1c 01 8d 50 56 8a cb e8 90 01 04 0f be f0 33 d2 0f be c3 03 45 fc 6a 19 59 f7 f1 8b 45 fc 8b ca d3 e6 8b 4d f8 03 ce 40 89 4d f8 89 45 fc 39 47 10 90 00 } //10
	condition:
		((#a_03_0  & 1)*10) >=10
...
rule Trojan_Win32_Neoreblamy_GMH_MTB_2{
	...
	strings :
		$a_03_0 = {8b 45 ec 40 89 45 ec 83 7d ec 03 90 01 02 6a 01 8d 45 f8 50 6a 01 68 68 35 00 00 6a 00 68 32 2c 00 00 68 b9 38 00 00 e8 90 01 04 83 c4 1c 90 00 } //10
