...
rule Trojan_Win32_TopAntiSpyware{
	...
	strings :
		$a_00_0 = {57 49 4e 44 4f 57 53 5c 57 65 62 5c 64 65 73 6b 74 6f 70 2e 68 74 6d 6c } //01 00 
		$a_00_1 = {63 6f 6d 2e 6d 73 2e 61 70 70 6c 65 74 2e 65 6e 61 62 6c 65 2e } //01 00 
