...
rule Trojan_Win32_Pakes_gen_I{
	...
	strings :
		...
		$a_03_1 = {8a 4c 04 08 80 f1 90 01 01 88 4c 04 08 40 83 f8 10 7c ef 90 00 } //1
		$a_03_2 = {8b 54 24 14 8b ce 8d 44 1a c1 50 8d 46 04 50 e8 90 01 01 00 00 00 83 c3 40 83 c5 40 3b df 72 e2 90 00 } //5
	condition:
