...
rule Trojan_Win32_Pakes_I{
	...
	strings :
		...
		$a_02_6 = {55 8b ec 51 56 8b 35 90 01 02 01 00 ff d6 ff d6 3a c3 73 0d 8a cb ff 15 90 01 02 01 00 88 90 01 02 eb 0d ff d6 8a cb 88 90 01 02 ff 15 90 01 02 01 00 8a 90 01 02 5e 90 00 } //1
