...
rule Trojan_Win32_Pakes_I{
	...
	strings :
		$a_00_0 = {4b 66 4c 6f 77 65 72 49 72 71 6c } //01 00 
		$a_00_1 = {4b 65 47 65 74 43 75 72 72 65 6e 74 49 72 71 6c } //01 00 
		$a_00_2 = {5a 77 51 75 65 72 79 44 69 72 65 63 74 6f 72 79 46 69 6c 65 } //01 00 
		$a_00_3 = {5a 77 43 72 65 61 74 65 46 69 6c 65 } //01 00 
		$a_00_4 = {5a 77 45 6e 75 6d 65 72 61 74 65 4b 65 79 } //01 00 
