...
rule Trojan_Win32_PapCut_B{
	...
	strings :
		$a_02_0 = {63 00 6d 00 64 00 90 08 00 02 68 00 74 00 74 00 70 00 90 00 } //10
		...
		$a_02_11 = {77 00 6d 00 69 00 63 00 90 02 10 70 00 72 00 6f 00 63 00 65 00 73 00 73 00 20 00 63 00 61 00 6c 00 6c 00 20 00 63 00 72 00 65 00 61 00 74 00 65 00 90 00 } //10
