...
rule Trojan_Win32_Hupigon_GME_MTB{
	...
	strings :
		$a_01_0 = {31 36 37 2e 31 31 34 2e 30 2e 31 34 34 } //01 00 
		...
		$a_01_3 = {50 61 73 73 77 6f 72 64 } //01 00 
		...
		$a_01_10 = {74 6d 72 53 74 6f 70 4b 69 6c 6c } //01 00 
		$a_01_11 = {63 6d 64 43 6f 6e 6e 65 63 74 } //01 00 
		$a_01_12 = {63 6d 64 44 6f 77 6e 6c 6f 61 64 } //01 00 
		$a_01_13 = {4b 69 6c 6c 54 69 6d 65 72 } //00 00 
	condition:
		any of ($a_*)
