...
rule Trojan_Win32_Lyzapo_A{
	...
	strings :
		...
		$a_03_1 = {83 c0 1e 50 ff 15 90 01 03 10 ff 75 fc ff 15 90 01 03 10 ff 45 f8 83 45 0c 04 8b 45 f8 3b 86 90 01 02 00 00 0f 82 90 00 } //1
		$a_03_2 = {59 59 8b 75 0c c1 ee 0a 83 e6 01 e8 90 01 03 00 6a 05 99 59 f7 f9 90 00 } //1
