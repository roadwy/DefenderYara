...
rule Trojan_Win32_DllInject_BU_MTB{
	...
	strings :
		$a_01_0 = {4c 6f 73 66 67 6b 73 6f 64 66 67 41 6f 73 6a 67 69 73 6a 64 67 6a } //03 00  LosfgksodfgAosjgisjdgj
		$a_01_1 = {4a 69 6f 61 65 6a 67 66 69 39 61 65 73 6a 69 66 67 73 6a } //01 00  Jioaejgfi9aesjifgsj
