...
rule Trojan_Win32_DllInject_MB_MTB{
	...
	strings :
		$a_01_0 = {54 66 74 76 67 45 64 72 74 63 66 } //02 00 
		$a_01_1 = {49 6e 66 66 62 54 76 66 63 72 66 67 } //02 00 
		$a_01_2 = {50 6b 6d 6a 6e 4c 6d 69 6e 75 } //01 00 
...
rule Trojan_Win32_DllInject_MB_MTB_2{
	...
	strings :
		...
		$a_01_1 = {4f 6e 65 46 } //03 00 
		$a_01_2 = {54 77 6f 46 } //03 00 
		$a_01_3 = {54 68 72 46 } //03 00 
		$a_01_4 = {71 77 65 72 2e 64 6c 6c } //01 00 
		$a_01_5 = {57 61 69 74 46 6f 72 53 69 6e 67 6c 65 4f 62 6a 65 63 74 } //00 00 
	condition:
		any of ($a_*)
