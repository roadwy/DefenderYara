...
rule Trojan_Win32_DllInject_MW_MTB{
	...
	strings :
		$a_03_0 = {33 c9 88 4d bd 33 d2 88 55 bc 33 c0 88 45 bb 8a 4d bd 88 4d a4 8a 55 bc 88 55 a0 8a 45 bb 88 45 9c b9 90 01 04 c7 85 18 ff ff ff 90 01 04 89 8d 1c ff ff ff 8b 95 18 ff ff ff 8b 85 90 00 } //1
