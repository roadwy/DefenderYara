...
rule Trojan_Win32_DllInject_Q_MTB{
	...
	strings :
		...
		$a_01_1 = {6d 63 64 65 64 78 78 64 69 75 } //03 00 
		$a_01_2 = {52 65 76 6f 6b 65 42 69 6e 64 53 74 61 74 75 73 43 61 6c 6c 62 61 63 6b } //03 00 
		$a_01_3 = {55 72 6c 4d 6b 47 65 74 53 65 73 73 69 6f 6e 4f 70 74 69 6f 6e } //00 00 
	condition:
		any of ($a_*)
