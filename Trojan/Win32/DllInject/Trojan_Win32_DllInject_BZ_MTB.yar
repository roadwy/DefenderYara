...
rule Trojan_Win32_DllInject_BZ_MTB{
	...
	strings :
		$a_01_0 = {4a 69 61 6a 6f 69 66 6a 61 65 67 65 61 69 6a 67 64 6a } //03 00  Jiajoifjaegeaijgdj
		$a_01_1 = {4c 61 69 6f 66 67 6a 61 65 6f 69 67 65 61 67 68 } //01 00  Laiofgjaeoigeagh
