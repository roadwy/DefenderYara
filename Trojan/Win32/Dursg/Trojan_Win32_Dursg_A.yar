...
rule Trojan_Win32_Dursg_A{
	...
	strings :
		...
		$a_01_2 = {39 00 44 00 43 00 44 00 2d 00 37 00 32 00 38 00 32 00 41 00 32 00 44 00 30 00 37 00 38 00 36 00 32 00 } //0a 00 
		$a_01_3 = {47 6c 6f 62 61 6c 5c 4d 69 6c 61 5f 74 65 72 6d } //0a 00 
		$a_01_4 = {25 53 26 76 65 72 3d 25 53 26 75 69 64 3d 25 53 } //0a 00 
		$a_01_5 = {5c 4d 69 63 72 6f 73 6f 66 74 5c 56 53 55 } //00 00 
	condition:
		any of ($a_*)
