...
rule Trojan_Win32_Dacic_AMAA_MTB{
	...
	strings :
		...
		$a_03_1 = {6a 01 6a 00 e8 90 01 03 00 e8 90 01 03 00 3d b7 00 00 00 74 90 01 01 e8 90 01 03 ff 54 6a 00 6a 00 68 90 01 03 00 6a 00 6a 00 e8 90 01 03 00 90 00 } //1
	condition:
