...
rule Trojan_Win32_CryptTrickload_B_MTB{
	...
	strings :
		$a_03_0 = {2e 70 68 70 3f 73 69 3d [0-10] 26 6b 6f 3d [0-10] 26 63 76 3d [0-20] 2c 20 22 66 61 6c 73 65 22 29 3b } //1
		...
		$a_03_2 = {2e 6f 70 65 6e 28 22 47 45 54 22 2c 20 22 68 74 74 70 73 3a 2f 2f [0-20] 2f [0-10] 2f [0-15] 2e 70 68 70 } //1
		...
		$a_03_7 = {2e 53 6c 65 65 70 28 22 [0-10] 22 29 3b } //1
