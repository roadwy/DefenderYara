...
rule Trojan_Win32_SelfDel_GZA_MTB{
	...
	strings :
		$a_03_0 = {8b 55 f8 3b 4a 18 7d 90 01 01 8b 5d fc 8b 1c 8b 03 5d 08 ff 75 0c 53 e8 90 01 04 83 f8 01 74 03 41 eb 90 01 01 8b 45 f8 8b 40 24 03 45 08 31 db 66 8b 1c 48 8b 45 f8 8b 40 1c 03 45 08 8b 04 98 03 45 08 90 00 } //10
