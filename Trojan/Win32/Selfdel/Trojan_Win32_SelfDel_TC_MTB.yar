...
rule Trojan_Win32_SelfDel_TC_MTB{
	...
	strings :
		$a_03_0 = {03 df 33 1d 90 01 04 81 c3 90 01 04 83 eb 07 33 1d 90 01 04 89 5d e0 90 00 } //1
		$a_03_1 = {8b f0 81 c6 90 01 04 83 f6 0f 03 f3 83 ee 41 33 f7 89 35 90 00 } //1
