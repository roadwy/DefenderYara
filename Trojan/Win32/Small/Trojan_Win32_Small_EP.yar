...
rule Trojan_Win32_Small_EP{
	...
	strings :
		$a_03_0 = {47 c6 44 24 90 01 01 61 c6 44 24 90 01 01 6d 88 5c 24 90 01 01 c6 44 24 90 01 01 44 c6 44 24 90 01 01 6c c6 44 24 90 01 01 2e 88 5c 24 90 01 01 c6 44 24 90 01 01 78 88 5c 24 90 00 } //2
