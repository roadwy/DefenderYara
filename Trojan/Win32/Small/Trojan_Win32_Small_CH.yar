...
rule Trojan_Win32_Small_CH{
	...
	strings :
		$a_03_0 = {ac 84 c0 75 fb 83 ee 05 81 0e 20 20 20 20 81 3e 2e 65 78 65 0f 90 01 03 00 00 0f b7 46 fe 0d 20 20 00 00 3d 71 71 00 00 0f 90 01 03 00 00 8b 46 f9 0d 20 20 20 20 3d 74 68 75 6e 0f 90 01 03 00 00 90 00 } //1
