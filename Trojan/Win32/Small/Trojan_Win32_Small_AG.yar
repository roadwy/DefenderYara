...
rule Trojan_Win32_Small_AG{
	...
	strings :
		...
		$a_01_2 = {25 73 5c 64 73 25 63 25 63 25 63 2e 25 73 } //01 00 
		$a_01_3 = {53 46 46 44 4a 44 53 45 52 59 24 34 35 36 34 35 } //01 00 
		$a_01_4 = {64 65 73 5f 62 6f 74 2e 65 78 65 } //01 00 
		$a_01_5 = {5f 57 6f 72 6b 50 72 6f 63 40 34 } //00 00 
	condition:
		any of ($a_*)
