...
rule Trojan_Win32_Small_AM{
	...
	strings :
		$a_02_0 = {8b 45 f8 e8 90 01 02 ff ff 50 e8 90 01 02 ff ff 8d 45 f4 e8 90 01 02 ff ff ff 75 f4 68 90 01 02 40 00 6a 00 68 90 01 02 40 00 8d 45 fc ba 04 00 00 00 90 00 } //10
