...
rule Trojan_Win32_Small_GP_dll{
	...
	strings :
		$a_01_0 = {5a 38 3d 3b 58 6a 6d 6e 46 64 65 48 67 6a 78 78 } //01 00 
		$a_01_1 = {58 44 4d 5f 5c 4a 59 4e 57 57 38 3d 3b 58 6a 6d 6e } //01 00 
		$a_01_2 = {c3 bc bd a3 00 } //01 00 
		$a_01_3 = {38 3d 3b 7f 79 6a 72 25 6e 73 6e 00 } //01 00 
