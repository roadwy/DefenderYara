...
rule Trojan_Win32_Malgent_CSG_MSR{
	...
	strings :
		$a_01_0 = {53 00 6f 00 66 00 74 00 77 00 61 00 72 00 65 00 5c 00 4d 00 69 00 63 00 72 00 6f 00 73 00 6f 00 66 00 74 00 5c 00 57 00 69 00 6e 00 64 00 6f 00 77 00 73 00 5c 00 44 00 65 00 66 00 65 00 6e 00 64 00 65 00 72 00 5c 00 41 00 75 00 74 00 6f 00 55 00 70 00 64 00 61 00 74 00 65 00 2e 00 64 00 6c 00 6c 00 } //64 00 
		$a_01_1 = {64 65 6c 20 22 43 3a 5c 44 6f 63 75 6d 65 6e 74 73 20 61 6e 64 20 53 65 74 74 69 6e 67 73 5c 41 6c 6c 20 55 73 65 72 73 } //64 00 
		$a_01_2 = {74 00 65 00 6d 00 70 00 2e 00 62 00 61 00 74 00 } //01 00 
