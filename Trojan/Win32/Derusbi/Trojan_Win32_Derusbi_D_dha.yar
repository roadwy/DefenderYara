...
rule Trojan_Win32_Derusbi_D_dha{
	...
	strings :
		...
		$a_03_1 = {6a 40 68 00 10 00 00 68 00 50 00 00 6a 00 ff 15 90 01 04 89 45 fc 33 c0 8a 88 90 01 04 80 f1 90 01 01 88 8c 05 bc ec ff ff 40 3d 90 01 01 13 00 00 7c e8 90 00 } //1
	condition:
