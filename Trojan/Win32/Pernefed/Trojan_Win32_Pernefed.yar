...
rule Trojan_Win32_Pernefed{
	...
	strings :
		...
		$a_00_2 = {43 3a 5c 57 49 4e 44 4f 57 53 5c 70 64 2e 64 6c 6c } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Pernefed_4{
	...
	strings :
		$a_00_0 = {53 4f 46 54 57 41 52 45 5c 42 6f 72 6c 61 6e 64 5c 44 65 6c 70 68 69 5c 52 54 4c } //01 00 
		$a_01_1 = {53 4f 46 54 57 41 52 45 5c 4d 69 63 72 6f 73 6f 66 74 5c 50 44 65 66 65 6e 64 65 72 } //01 00 
		$a_01_2 = {50 65 72 66 65 63 74 20 44 65 66 65 6e 64 65 72 } //01 00 
		$a_00_3 = {53 6f 66 74 57 61 72 65 5c 4d 69 63 72 6f 73 6f 66 74 5c 57 69 6e 64 6f 77 73 5c 43 75 72 72 65 6e 74 56 65 72 73 69 6f 6e 5c 52 75 6e } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Pernefed_6{
	...
	strings :
		...
		$a_01_3 = {55 6e 69 6e 73 74 61 6c 6c 5c 50 44 65 66 65 6e 64 65 72 } //01 00 
		$a_01_4 = {4d 69 63 72 6f 73 6f 66 74 5c 50 44 65 66 65 6e 64 65 72 } //01 00 
...
rule Trojan_Win32_Pernefed_7{
	...
	strings :
		...
		$a_00_1 = {53 63 68 74 61 73 6b 73 2e 65 78 65 20 2f 63 72 65 61 74 65 20 2f 74 6e 20 22 44 65 66 65 6e 64 65 72 20 4d 6f 6e 69 74 6f 72 22 } //01 00 
		$a_00_2 = {2f 75 70 64 61 74 65 2e 70 68 70 3f 62 3d 00 } //01 00 
		$a_00_3 = {41 66 74 65 72 20 79 6f 75 72 20 63 6f 6d 70 75 74 65 72 20 73 74 61 72 74 65 64 20 75 70 2c 20 72 75 6e 20 49 6e 73 74 61 6c 61 74 69 6f 6e 20 61 67 61 69 6e 2e } //01 00 
		$a_00_4 = {50 65 72 66 65 63 74 20 44 65 66 65 6e 64 65 72 20 32 30 30 } //02 00 
		...
		$a_00_10 = {53 4f 46 54 57 41 52 45 5c 4d 69 63 72 6f 73 6f 66 74 5c 50 44 65 66 65 6e 64 65 72 } //00 00 
	condition:
		any of ($a_*)
