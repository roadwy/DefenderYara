...
rule Trojan_Win32_Dridex_PU_MTB{
	...
	strings :
		...
		$a_02_10 = {21 c0 8b 4d 90 01 01 8b 90 02 06 89 90 02 06 8a 90 02 02 0f 90 02 07 29 90 01 01 8b 90 02 03 89 90 02 02 89 90 02 03 e8 90 02 04 8b 90 02 03 01 90 01 01 88 90 02 08 8b 90 02 02 8a 90 02 06 8b 90 02 06 88 90 00 } //10
	condition:
