...
rule Trojan_Win32_Dridex_A_MSR{
	...
	strings :
		...
		$a_03_1 = {8b 5c 24 20 8a 24 0b 0f b6 d8 01 fb 81 e3 90 01 04 8b 7c 24 90 01 01 32 24 1f 8b 5c 24 90 01 01 88 24 0b 83 c1 90 01 01 8b 7c 90 01 02 39 f9 89 4c 24 90 01 01 89 54 24 90 01 01 89 74 24 90 01 01 0f 84 90 01 04 e9 90 00 } //1
