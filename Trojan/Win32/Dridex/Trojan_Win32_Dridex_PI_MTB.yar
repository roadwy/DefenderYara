...
rule Trojan_Win32_Dridex_PI_MTB{
	...
	strings :
		...
		$a_81_3 = {46 69 6e 64 43 6c 6f 73 65 55 72 6c 43 61 63 68 65 } //01 00 
		$a_81_4 = {53 77 69 74 63 68 54 6f 54 68 69 73 57 69 6e 64 6f 77 } //01 00 
		$a_81_5 = {4c 6f 61 64 4b 65 79 62 6f 61 72 64 4c 61 79 6f 75 74 41 } //01 00 
		$a_81_6 = {4f 70 65 6e 53 65 6d 61 70 68 6f 72 65 57 } //00 00 
	condition:
		any of ($a_*)
