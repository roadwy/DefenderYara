...
rule Trojan_Win32_Dridex_AQ_MTB{
	meta:
		description = "Trojan:Win32/Dridex.AQ!MTB,SIGNATURE_TYPE_PEHSTR_EXT,15 00 15 00 07 00 00 03 00 "
	...
	strings :
		...
		$a_80_4 = {46 69 6e 64 46 69 72 73 74 56 6f 6c 75 6d 65 4d 6f 75 6e 74 50 6f 69 6e 74 41 } //FindFirstVolumeMountPointA  03 00 
		$a_80_5 = {54 47 38 31 2d 62 69 74 74 6f 34 49 6e 63 6f 67 6e 69 74 6f 49 4b 69 6e 66 } //TG81-bitto4IncognitoIKinf  03 00 
		$a_80_6 = {4b 35 6e 6c 6e 6f 74 } //K5nlnot  00 00 
	condition:
		any of ($a_*)
