...
rule Trojan_Win32_Dridex_AFC_MTB{
	...
	strings :
		$a_00_0 = {9e d9 30 dd 1f 7c 7e 9a a6 b0 5f 36 74 03 40 c8 90 80 8e 5e f7 42 2c 56 fa 74 b1 fd 97 38 6c 3c 6b d9 31 dd d3 af fe 9b a6 10 92 36 88 03 a0 c8 11 34 c2 3f e3 42 0c 56 19 55 32 b1 97 38 6c bb } //10
