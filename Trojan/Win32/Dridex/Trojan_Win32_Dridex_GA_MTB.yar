...
rule Trojan_Win32_Dridex_GA_MTB{
	...
	strings :
		$a_02_0 = {0f b6 cb 66 3b cf 74 90 01 01 0f b7 10 0f af d6 8a ca 8b f2 2a cb 89 35 90 01 04 2a 4c 24 90 01 01 8a d9 0f b7 cd 3b d1 74 90 01 01 83 c0 02 3d 90 01 04 7c 90 00 } //10
	condition:
		((#a_02_0  & 1)*10) >=10
...
rule Trojan_Win32_Dridex_GA_MTB_2{
	...
	strings :
		$a_02_0 = {81 f6 5b fe c5 47 39 f0 89 45 90 01 01 89 4d 90 01 01 89 55 90 02 30 8b 45 90 01 01 8b 4d 90 01 01 8a 55 90 01 01 88 14 01 83 c0 90 01 01 8b 75 90 01 01 39 f0 89 45 90 00 } //1
	condition:
		((#a_02_0  & 1)*1) >=1
...
rule Trojan_Win32_Dridex_GA_MTB_4{
	...
	strings :
		$a_02_0 = {8b 04 24 64 a3 00 00 00 00 83 c4 08 eb 0d 8b 44 24 0c ff 80 b8 00 00 00 31 c0 c3 c3 90 0a 23 00 cc cc 90 02 01 cc 90 00 } //10
		$a_02_1 = {29 df 89 fb 88 dc 88 64 24 90 01 01 8b 7d 90 01 01 8b 5d 90 01 01 8a 64 24 90 01 01 88 24 3b 66 8b 7c 24 90 01 01 66 89 7c 24 90 01 01 88 44 24 90 00 } //5
	condition:
...
rule Trojan_Win32_Dridex_GA_MTB_5{
	...
	strings :
		$a_02_0 = {8b 04 24 64 a3 00 00 00 00 83 c4 08 eb 90 01 01 8b 44 24 90 01 01 ff 80 90 01 04 31 c0 c3 c3 90 0a 23 00 cc cc cc eb 90 00 } //10
...
rule Trojan_Win32_Dridex_GA_MTB_6{
	...
	strings :
		$a_02_0 = {83 ea 01 2b 55 90 01 01 89 15 90 01 04 0f b7 45 90 01 01 0f af 05 90 01 04 2b 45 90 01 01 66 89 45 90 01 01 0f b7 4d 90 01 01 0f af 0d 90 01 04 2b 4d 90 01 01 66 89 4d 90 01 01 0f b7 55 90 01 01 8b 45 90 01 01 8d 8c 10 90 01 04 89 0d 90 01 04 8b 75 90 01 01 81 c2 90 01 04 83 c6 03 83 ee 03 81 c2 90 01 04 ff e6 90 00 } //10
		$a_02_1 = {64 a1 00 00 00 00 50 83 c4 f0 53 56 57 a1 90 01 04 31 45 90 01 01 33 c5 50 90 00 } //10
	condition:
...
rule Trojan_Win32_Dridex_GA_MTB_7{
	...
	strings :
		$a_02_0 = {89 fa 81 f2 90 01 04 89 54 24 90 01 01 89 5c 24 90 01 01 0f b6 04 08 89 c1 0f b6 55 90 01 01 29 d0 88 c5 89 5c 24 90 01 01 89 7c 24 90 01 01 88 6c 24 90 01 01 8b 45 90 01 01 8b 55 90 01 01 8a 6c 24 90 01 01 80 f1 ff 88 4c 24 90 01 01 88 2c 10 89 74 24 90 01 01 8d 65 90 00 } //10
