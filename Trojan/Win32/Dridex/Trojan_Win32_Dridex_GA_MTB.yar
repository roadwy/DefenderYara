...
rule Trojan_Win32_Dridex_GA_MTB_5{
	...
	strings :
		...
		$a_01_1 = {4d 00 59 00 41 00 50 00 50 00 2e 00 45 00 58 00 45 00 } //0a 00 
		$a_01_2 = {73 00 65 00 6c 00 66 00 2e 00 65 00 78 00 65 00 } //0a 00 
		$a_01_3 = {57 00 6e 00 65 00 65 00 64 00 73 00 77 00 68 00 69 00 63 00 68 00 47 00 68 00 6f 00 73 00 74 00 65 00 72 00 79 00 78 00 41 00 44 00 } //00 00 
	condition:
		any of ($a_*)
