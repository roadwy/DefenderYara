...
rule Trojan_Win32_Dridex_BA_MTB{
	...
	strings :
		$a_02_0 = {81 ea 2d ad 00 00 89 15 90 01 04 a1 90 01 04 03 85 90 01 04 03 05 90 01 04 a3 90 01 04 8b 0d 90 01 04 2b 0d 90 01 04 89 0d 90 01 04 ba 01 00 00 00 90 00 } //1
	condition:
		((#a_02_0  & 1)*1) >=1
