...
rule Trojan_Win32_Dridex_SB_MTB{
	...
	strings :
		$a_80_0 = {5d 53 5f 42 49 53 5f 26 } //]S_BIS_&  3
		$a_80_1 = {52 61 73 47 65 74 41 75 74 6f 64 69 61 6c 41 64 64 72 65 73 73 57 } //RasGetAutodialAddressW  3
		...
		$a_80_6 = {52 65 61 64 46 69 6c 65 45 78 } //ReadFileEx  3
		$a_80_7 = {54 65 72 6d 69 6e 61 74 65 4a 6f 62 4f 62 6a 65 63 74 } //TerminateJobObject  3
	condition:
