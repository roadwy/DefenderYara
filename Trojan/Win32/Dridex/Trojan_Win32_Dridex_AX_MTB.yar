...
rule Trojan_Win32_Dridex_AX_MTB{
	...
	strings :
		$a_02_0 = {ff ff b8 08 00 00 00 c1 e0 02 89 45 fc 8b 4d fc 81 b9 ?? ?? ?? ?? 1e 04 00 00 75 25 8b 55 fc 83 ba 34 c0 12 01 00 75 19 b8 08 00 00 00 d1 e0 8b 0d ?? ?? ?? ?? 03 88 } //10
