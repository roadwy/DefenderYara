...
rule Trojan_Win32_Dridex_GT_MTB{
	...
	strings :
		$a_02_0 = {0f b7 ce 03 c1 81 c7 90 01 04 a3 90 01 04 89 3d 90 01 04 89 bb 90 01 04 8b 2d 90 01 04 a1 90 01 04 83 c0 90 01 01 8d 14 29 8b 4c 24 90 01 01 83 c1 04 03 d0 89 15 90 01 04 89 4c 24 90 01 01 81 f9 90 01 04 73 90 00 } //10
	condition:
		((#a_02_0  & 1)*10) >=10
...
rule Trojan_Win32_Dridex_GT_MTB_2{
	...
	strings :
		$a_02_0 = {54 89 e7 89 17 c7 47 90 01 01 01 00 00 00 c7 47 90 01 01 00 00 00 00 8b 15 90 01 04 89 4c 24 90 01 01 ff d2 90 00 } //10
