...
rule Trojan_Win32_Dridex_QM_MTB_2{
	...
	strings :
		...
		$a_81_1 = {6d 6e 75 69 65 68 64 62 72 77 65 72 } //03 00  mnuiehdbrwer
		$a_81_2 = {46 70 6f 72 65 6f 6e 69 59 6a 64 65 67 74 65 73 73 } //03 00  FporeoniYjdegtess
		...
		$a_81_5 = {57 69 6e 53 43 61 72 64 } //03 00  WinSCard
		$a_81_6 = {4a 64 69 64 62 72 6f 77 73 65 72 } //00 00  Jdidbrowser
	condition:
		any of ($a_*)
