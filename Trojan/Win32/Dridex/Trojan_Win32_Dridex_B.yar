...
rule Trojan_Win32_Dridex_B{
	...
	strings :
		$a_02_0 = {8b 45 c4 b1 10 66 8b 55 d2 66 81 e2 ?? ?? 66 89 55 d2 8a 2c 05 ?? ?? ?? ?? 8b 75 cc 29 f6 89 75 d4 28 e9 02 0c 05 ?? ?? ?? ?? 88 4c 05 d8 83 c0 01 83 f8 0e 89 45 c4 75 c7 } //5
		$a_02_1 = {8b 45 88 b1 39 8a 14 05 ?? ?? ?? ?? 66 c7 45 d4 88 65 28 d1 02 0c 05 ?? ?? ?? ?? 88 4c 05 dc 83 c0 01 83 f8 0e 89 45 88 74 cf eb d4 } //5
