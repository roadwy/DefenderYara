...
rule Trojan_Win32_Dridex_GE_MTB{
	...
	strings :
		$a_02_0 = {8b c3 2b 05 90 01 04 81 c7 2c 3d 05 01 05 90 01 04 80 c2 90 01 01 66 a3 90 01 04 89 3d 90 01 04 89 bc 2e 90 01 04 8b 0d 90 01 04 02 d2 02 d1 02 15 90 01 04 83 c6 04 81 fe 50 27 00 00 88 54 24 90 01 01 0f 82 90 00 } //10
	condition:
		((#a_02_0  & 1)*10) >=10
...
rule Trojan_Win32_Dridex_GE_MTB_3{
	...
	strings :
		$a_02_0 = {29 c3 88 d8 88 45 90 01 01 8b 5d 90 01 01 8b 45 90 01 01 89 45 90 01 01 8a 45 90 01 01 8b 7d 90 01 01 88 04 3b 89 75 90 01 01 89 4d 90 01 01 89 55 90 01 01 83 c4 90 00 } //1
		$a_02_1 = {66 8b 54 24 04 66 81 c2 32 7b 66 89 54 24 90 01 01 8a 5c 24 90 01 01 88 1c 01 8d 65 f4 5f 5e 90 00 } //1
		$a_02_2 = {40 cc cc cc eb 90 01 01 8b 04 24 64 a3 00 00 00 00 83 c4 08 eb 90 01 01 8b 44 24 90 01 01 ff 80 90 01 04 31 c0 c3 c3 90 00 } //5
		$a_02_3 = {8b 04 24 64 a3 00 00 00 00 83 c4 08 eb 90 01 01 8b 44 24 90 01 01 ff 80 90 01 04 31 c0 c3 c3 90 0a 23 00 cc cc cc 40 eb 90 00 } //5
