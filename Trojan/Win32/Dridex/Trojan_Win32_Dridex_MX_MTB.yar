...
rule Trojan_Win32_Dridex_MX_MTB{
	...
	strings :
		...
		$a_01_1 = {43 3a 5c 5c 54 45 53 54 41 50 50 2e 45 58 45 00 50 50 2e 45 58 45 00 54 41 50 50 2e 45 58 45 00 } //02 00  㩃屜䕔呓偁⹐塅E偐䔮䕘吀偁⹐塅E
		$a_01_2 = {73 65 6c 66 2e 45 58 45 } //02 00  self.EXE
		$a_01_3 = {73 00 65 00 6c 00 66 00 2e 00 45 00 58 00 45 00 } //00 00  self.EXE
	condition:
		any of ($a_*)
