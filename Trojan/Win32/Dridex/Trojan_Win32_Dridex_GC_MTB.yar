...
rule Trojan_Win32_Dridex_GC_MTB{
	...
	strings :
		$a_02_0 = {8a 14 01 8b 75 90 01 01 88 14 06 83 c0 90 01 01 89 45 90 01 01 66 c7 45 90 02 20 66 81 7d 90 02 20 8b 45 90 01 01 8b 4d 90 01 01 89 4d 90 01 01 8b 4d 90 01 01 39 c8 90 00 } //1
	condition:
		((#a_02_0  & 1)*1) >=1
...
rule Trojan_Win32_Dridex_GC_MTB_2{
	...
	strings :
		$a_02_0 = {8b 04 24 64 a3 00 00 00 00 83 c4 08 eb 0d 8b 44 24 0c ff 80 b8 00 00 00 31 c0 c3 c3 90 0a 4b 00 cc 90 02 0a cc 90 02 0a cc 90 00 } //10
...
rule Trojan_Win32_Dridex_GC_MTB_3{
	...
	strings :
		$a_02_0 = {c7 44 24 08 0e 00 00 00 90 02 08 89 4c 24 90 02 0a e8 90 00 } //1
...
rule Trojan_Win32_Dridex_GC_MTB_4{
	...
	strings :
		$a_02_0 = {8b 04 24 64 a3 00 00 00 00 90 02 28 83 ec 08 eb 0d 8b 44 24 0c ff 80 b8 00 00 00 31 c0 c3 c3 90 0a 53 00 cc 90 02 0c cc 90 02 0c cc 90 00 } //10
...
rule Trojan_Win32_Dridex_GC_MTB_5{
	...
	strings :
		$a_02_0 = {69 88 b4 24 90 01 04 c6 84 24 90 01 04 74 c6 84 24 90 01 04 75 c6 84 24 90 01 04 61 c6 84 24 90 01 04 6c 8b 84 24 90 01 04 35 90 01 04 c6 84 24 90 01 04 41 90 00 } //10
		$a_02_1 = {4c 00 64 00 72 00 47 00 65 00 74 00 50 00 72 00 6f 00 63 00 65 00 64 00 75 00 72 00 65 00 41 00 90 01 10 79 00 90 00 } //10
		$a_02_2 = {4c 64 72 47 65 74 50 72 6f 63 65 64 75 72 65 41 90 01 10 79 90 00 } //10
	condition:
...
rule Trojan_Win32_Dridex_GC_MTB_6{
	...
	strings :
		$a_02_0 = {8b 04 24 64 a3 00 00 00 00 90 02 14 83 ec 08 eb 0d 8b 44 24 0c ff 80 b8 00 00 00 31 c0 c3 c3 90 0a 4b 00 cc 90 02 0c cc 90 02 0c cc 90 00 } //10
		$a_80_1 = {46 47 74 6b 65 6d 76 62 } //FGtkemvb  2
		$a_80_2 = {52 54 54 59 45 42 48 55 59 2e 70 64 62 } //RTTYEBHUY.pdb  2
...
rule Trojan_Win32_Dridex_GC_MTB_7{
	...
	strings :
		$a_02_0 = {8b 04 24 64 a3 00 00 00 00 90 02 0f 83 c4 08 eb 0d 8b 44 24 0c ff 80 b8 00 00 00 31 c0 c3 c3 90 0a 4b 00 cc 90 02 0a cc 90 02 0a cc 90 00 } //10
		$a_02_1 = {8b 04 24 64 a3 00 00 00 00 90 02 0f 83 ec 04 eb 0d 8b 44 24 0c ff 80 b8 00 00 00 31 c0 c3 c3 90 0a 4b 00 cc 90 02 0a cc 90 02 0a cc 90 00 } //10
		$a_02_2 = {8b 04 24 64 a3 00 00 00 00 90 02 0f 83 ec 08 eb 0d 8b 44 24 0c ff 80 b8 00 00 00 31 c0 c3 c3 90 0a 4b 00 cc 90 02 0a cc 90 02 0a cc 90 00 } //10
