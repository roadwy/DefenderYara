...
rule Trojan_Win32_Dridex_A_MTB{
	...
	strings :
		$a_02_0 = {88 54 24 6b 8b 5c 24 38 8b 54 24 1c 8a 04 1a 8b 54 24 50 69 d2 90 02 04 01 f1 21 f9 89 54 24 50 8b 54 24 14 8a 24 0a 30 c4 31 c9 89 4c 24 5c c7 44 24 58 6b 0a f2 61 8b 74 24 18 88 24 1e 8b 7c 24 58 81 e7 bf 89 6f 54 8b 5c 24 38 43 90 00 } //1
