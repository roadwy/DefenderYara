...
rule Trojan_Win32_Dridex_PA_MTB_2{
	...
	strings :
		...
		$a_03_3 = {8b 44 24 10 8a 8c 24 90 01 04 80 f1 46 8a 90 02 06 8b b4 24 90 01 04 81 f6 90 01 04 88 8c 24 90 01 04 8b bc 24 90 01 04 81 c7 90 01 04 89 bc 24 90 01 04 8a 88 90 01 04 8b 7c 24 90 01 01 89 bc 24 90 01 04 8b 5c 24 90 01 01 89 9c 24 90 01 04 28 d1 88 4c 04 90 01 01 83 c0 01 39 f0 89 44 24 90 01 01 75 90 00 } //3
	condition:
...
rule Trojan_Win32_Dridex_PA_MTB_3{
	...
	strings :
		$a_02_0 = {55 8b ec 57 a1 90 01 03 00 a3 90 01 03 00 8b 0d 90 01 03 00 89 0d 90 01 03 00 8b 15 90 01 03 00 8b 02 a3 90 01 03 00 8b 0d 90 01 03 00 81 e9 fc 1a 01 00 89 0d 90 01 03 00 8b 0d 90 01 03 00 81 c1 fc 1a 01 00 a1 90 01 03 00 a3 90 01 03 00 b8 13 00 01 00 90 08 00 03 a1 90 01 03 00 31 0d 90 01 03 00 90 02 f0 8b ff c7 05 90 01 03 00 00 00 00 00 a1 90 01 03 00 01 05 90 01 03 00 8b ff 8b 15 90 01 03 00 a1 90 01 03 00 89 02 5f 5d c3 90 00 } //10
