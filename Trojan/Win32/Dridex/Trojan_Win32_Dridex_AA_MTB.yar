...
rule Trojan_Win32_Dridex_AA_MTB{
	...
	strings :
		$a_02_0 = {8b 16 03 f8 0f b7 c1 03 d8 89 1d 90 01 04 0f b7 1d 90 01 04 2b eb 81 fd 6a 02 00 00 90 00 } //10
		$a_02_1 = {8d 4c 28 01 81 c2 cc bc 05 01 0f b7 c9 89 16 89 15 90 01 04 0f b7 d1 8d 84 00 e8 3b 00 00 2b c2 03 c7 83 c6 04 83 6c 24 10 01 90 00 } //10
	condition:
...
rule Trojan_Win32_Dridex_AA_MTB_2{
	...
	strings :
		...
		$a_02_1 = {8b 4d e8 8b 55 ec 8a 5d e7 32 5d de 29 d0 8b 55 b4 88 1c 0a 8b 4d d8 03 45 e8 89 4d c8 89 45 c4 8b 4d c0 89 4d d0 8b 4d bc 39 c8 0f 84 90 01 02 00 00 e9 90 01 02 00 00 90 00 } //1
	condition:
