...
rule Trojan_Win32_Dridex_AR_MTB{
	...
	strings :
		$a_02_0 = {8b 44 24 1c 05 fc 55 0e 01 89 02 8b 15 90 01 04 89 44 24 1c a3 90 01 04 8b c7 90 00 } //1
	condition:
		((#a_02_0  & 1)*1) >=1
...
rule Trojan_Win32_Dridex_AR_MTB_2{
	...
	strings :
		$a_02_0 = {ba 60 01 01 00 ba 9c ad 00 00 a1 90 01 04 a3 90 02 0c 31 0d 90 01 04 c7 05 90 01 08 a1 90 01 04 01 05 90 01 04 8b ff 90 00 } //1
	condition:
		((#a_02_0  & 1)*1) >=1
...
rule Trojan_Win32_Dridex_AR_MTB_3{
	...
	strings :
		$a_02_0 = {83 c4 08 8b 4d fc 03 0d 90 01 04 8b 55 f4 03 15 90 01 04 8a 02 88 01 33 c9 0f 84 90 01 04 6a 04 6a 04 90 00 } //2
...
rule Trojan_Win32_Dridex_AR_MTB_4{
	...
	strings :
		$a_02_0 = {81 c2 00 73 02 00 89 15 90 01 04 a1 90 01 04 5d 90 0a 32 00 a1 90 01 04 a3 90 01 04 8b 0d 90 01 04 89 0d 90 01 04 8b 15 90 00 } //2
		$a_02_1 = {8d 8c 10 9e 9a 56 00 2b 4d b0 03 0d 90 01 04 89 0d 90 01 04 8b 15 90 01 04 81 ea 9e 9a 56 00 89 15 90 00 } //2
	condition:
...
rule Trojan_Win32_Dridex_AR_MTB_5{
	...
	strings :
		$a_02_0 = {2b ca 88 4d d7 b8 02 00 00 00 6b c8 09 0f b7 91 90 01 04 b8 02 00 00 00 6b c8 06 0f b7 81 90 00 } //10
