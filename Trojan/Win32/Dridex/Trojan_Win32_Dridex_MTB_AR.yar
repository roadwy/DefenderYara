...
rule Trojan_Win32_Dridex_MTB_AR{
	...
	strings :
		$a_03_0 = {8d 0c 96 89 5c 24 10 66 89 1d ?? ?? ?? ?? 8d 1c 4d 74 7b fe ff 89 1d ?? ?? ?? ?? 8b 4c 24 0c 81 c7 30 50 07 01 8b f2 89 3d ?? ?? ?? ?? 2b f0 83 c6 33 89 39 8b 4c 24 10 0f b7 c9 83 e9 01 74 } //1
