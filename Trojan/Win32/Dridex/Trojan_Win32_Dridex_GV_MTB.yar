...
rule Trojan_Win32_Dridex_GV_MTB{
	...
	strings :
		$a_02_0 = {2e 8b 74 24 90 01 01 c6 06 54 8b 74 24 90 01 01 89 e7 89 37 c7 47 08 01 00 00 00 c7 47 04 00 00 00 00 8b 35 90 01 04 89 44 24 90 01 01 89 4c 24 90 01 01 89 54 24 90 01 01 ff d6 90 00 } //10
