...
rule Trojan_Win32_Dridex_GD_MTB_3{
	...
	strings :
		...
		$a_01_2 = {72 6f 74 65 63 74 20 62 65 67 69 6e } //01 00  rotect begin
		$a_01_3 = {2f 2f 46 69 6c 65 41 70 69 2e 67 79 61 6f 2e 74 6f 70 2f 30 30 32 2f 70 75 70 70 } //01 00  //FileApi.gyao.top/002/pupp
		$a_01_4 = {48 54 54 50 2f 31 2e 31 } //01 00  HTTP/1.1
		$a_01_5 = {73 77 73 79 71 62 45 52 4d 51 31 67 73 77 73 79 71 62 45 52 4d 51 31 67 73 77 73 79 71 62 45 52 4d 51 31 67 } //00 00  swsyqbERMQ1gswsyqbERMQ1gswsyqbERMQ1g
	condition:
		any of ($a_*)
