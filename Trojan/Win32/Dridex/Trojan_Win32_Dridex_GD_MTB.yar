...
rule Trojan_Win32_Dridex_GD_MTB{
	...
	strings :
		$a_02_0 = {8a 14 01 8b 75 90 01 01 88 14 06 83 c0 90 01 01 89 45 90 01 01 8b 7d 90 01 01 39 f8 90 13 90 02 20 8b 45 90 01 01 8b 4d 90 00 } //1
	condition:
		((#a_02_0  & 1)*1) >=1
...
rule Trojan_Win32_Dridex_GD_MTB_2{
	...
	strings :
		$a_02_0 = {88 e8 f6 e2 88 44 24 90 01 01 8a 44 24 90 01 01 8b 74 24 90 01 01 81 e6 74 db 20 7e 89 74 24 90 01 01 c7 44 24 90 01 01 00 00 00 00 8b 75 90 01 01 8b 7d 90 01 01 88 04 37 8d 65 90 00 } //10
...
rule Trojan_Win32_Dridex_GD_MTB_4{
	...
	strings :
		$a_02_0 = {0f b6 d8 29 fb 88 d8 88 44 24 90 01 01 8a 44 24 90 01 01 8b 7d 90 01 01 8b 5d 90 01 01 88 04 1f 90 00 } //1
		...
		$a_02_2 = {40 cc cc cc eb 90 01 01 8b 04 24 64 a3 00 00 00 00 83 c4 08 eb 90 01 01 8b 44 24 90 01 01 ff 80 90 01 04 31 c0 c3 c3 90 00 } //10
