...
rule Trojan_Win32_Ghopog_A{
	...
	strings :
		$a_01_0 = {62 61 63 6b 64 6f 6f 72 2e 64 6c 6c } //01 00 
		$a_01_1 = {5c 55 70 64 61 74 65 5c 76 65 72 2e 6c 69 73 74 } //01 00 
		$a_01_2 = {25 73 3f 54 47 3d 25 73 26 4d 61 63 3d 25 73 26 56 65 72 3d 25 73 26 4a 63 3d 25 64 26 59 70 3d 25 73 26 4b 45 59 3d 25 64 26 43 50 3d 25 73 } //01 00 
