...
rule Trojan_Win32_Fifesock_gen_C{
	...
	strings :
		...
		$a_03_3 = {c7 44 24 10 40 00 00 00 c7 44 24 0c 00 30 00 00 b8 90 01 04 2d 90 01 04 89 44 24 08 c7 44 24 04 00 00 00 00 8b 45 ec 89 04 24 a1 90 01 04 ff d0 90 00 } //1
