...
rule Trojan_Win32_Fifesock_gen_C{
	...
	strings :
		$a_01_0 = {73 79 73 74 65 6d 73 6d 73 73 72 76 63 } //01 00  systemsmssrvc
		$a_01_1 = {69 6e 6a 65 63 74 2e 64 6c 6c 00 43 61 6c 63 48 61 73 68 00 } //01 00  湩敪瑣搮汬䌀污䡣獡h
		$a_01_2 = {4c 6f 6f 70 49 6e 6a 65 63 74 40 34 } //01 00  LoopInject@4
