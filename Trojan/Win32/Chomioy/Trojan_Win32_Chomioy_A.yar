...
rule Trojan_Win32_Chomioy_A{
	...
	strings :
		$a_03_0 = {33 db 6a 67 e8 90 01 02 ff ff 0f bf c0 50 e8 90 01 02 ff ff 66 85 c0 7d 0e 6a 11 e8 90 01 02 ff ff 66 85 c0 7d 02 b3 01 84 db 74 1f 80 3c 24 00 75 19 c6 04 24 01 6a 40 90 00 } //1
