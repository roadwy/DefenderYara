...
rule Trojan_Win32_DorkBot_RDA_MTB{
	...
	strings :
		...
		$a_01_1 = {4c 64 72 46 69 6e 64 52 65 73 6f 75 72 63 65 5f 55 } //01 00 
		$a_01_2 = {4c 64 72 41 63 63 65 73 73 52 65 73 6f 75 72 63 65 } //01 00 
		$a_01_3 = {56 69 72 74 75 61 6c 41 6c 6c 6f 63 } //01 00 
		$a_01_4 = {73 00 63 00 2e 00 65 00 78 00 65 00 } //00 00 
	condition:
		any of ($a_*)
