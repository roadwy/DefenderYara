...
rule Trojan_Win32_Seedna_A_2{
	...
	strings :
		$a_01_0 = {7b 00 45 00 30 00 37 00 44 00 42 00 30 00 32 00 43 00 2d 00 33 00 38 00 37 00 45 00 2d 00 34 00 33 00 62 00 32 00 2d 00 41 00 36 00 46 00 32 00 2d 00 43 00 35 00 39 00 42 00 34 00 39 00 33 00 34 00 42 00 37 00 44 00 36 00 7d 00 } //02 00 
		$a_01_1 = {53 65 6e 64 44 61 74 61 54 6f 44 72 69 76 65 72 } //02 00 
		$a_01_2 = {2e 64 6c 6c 00 43 6f 6e 66 44 65 6c 65 74 65 00 43 6f 6e 66 52 65 61 64 00 43 6f 6e 66 57 72 69 74 65 } //02 00 
