...
rule Trojan_Win32_Mafiat{
	...
	strings :
		...
		$a_00_2 = {6b 00 6b 00 69 00 6c 00 6c 00 20 00 2d 00 66 00 20 00 2d 00 69 00 6d 00 20 00 66 00 69 00 } //01 00 
		$a_00_3 = {64 00 65 00 6c 00 20 00 2a 00 2e 00 62 00 } //01 00 
		$a_00_4 = {74 00 20 00 28 00 67 00 6f 00 74 00 6f 00 20 00 6c 00 } //01 00 
		$a_00_5 = {64 00 20 00 4d 00 6f 00 7a 00 69 00 6c 00 6c 00 } //00 00 
	condition:
		any of ($a_*)
