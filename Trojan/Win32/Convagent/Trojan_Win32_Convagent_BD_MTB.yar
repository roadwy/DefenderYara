...
rule Trojan_Win32_Convagent_BD_MTB_2{
	...
	strings :
		$a_01_0 = {55 6e 72 65 67 69 73 74 65 72 43 6c 61 73 73 41 } //01 00 
		$a_01_1 = {43 00 3a 00 5c 00 42 00 75 00 67 00 72 00 65 00 70 00 6f 00 72 00 74 00 5f 00 65 00 72 00 72 00 6f 00 72 00 2e 00 69 00 6e 00 69 00 } //01 00 
		$a_01_2 = {6e 6a 6a 6f 63 } //01 00 
		$a_01_3 = {57 41 71 72 72 73 69 66 } //01 00 
		$a_01_4 = {44 4c 4c 20 45 52 52 4f 52 } //00 00 
	condition:
		any of ($a_*)
