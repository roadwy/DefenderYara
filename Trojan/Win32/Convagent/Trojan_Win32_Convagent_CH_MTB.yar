...
rule Trojan_Win32_Convagent_CH_MTB{
	...
	strings :
		...
		$a_01_4 = {55 49 5c 63 61 6e 76 61 73 2e 62 6d 70 } //01 00  UI\canvas.bmp
		$a_01_5 = {58 4d 65 64 69 61 55 49 46 61 63 74 6f 72 79 2e 64 6c 6c } //01 00  XMediaUIFactory.dll
		$a_01_6 = {75 00 63 00 61 00 73 00 74 00 2e 00 63 00 6f 00 6d 00 2e 00 63 00 6e 00 } //00 00  ucast.com.cn
	condition:
		any of ($a_*)
