...
rule Trojan_Win32_Convagent_GMC_MTB{
	...
	strings :
		$a_03_0 = {68 04 01 00 00 56 53 ff 15 90 01 04 a1 98 90 01 01 45 01 89 35 c0 90 01 01 45 01 8b fe 38 18 90 00 } //10
		$a_03_1 = {8b 45 fc 83 c4 14 48 89 35 a8 90 01 01 45 01 5f 5e a3 a4 90 01 01 45 01 5b 90 00 } //10
