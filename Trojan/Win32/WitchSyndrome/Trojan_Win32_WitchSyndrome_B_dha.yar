...
rule Trojan_Win32_WitchSyndrome_B_dha{
	...
	strings :
		...
		$a_03_5 = {3c 00 61 00 20 00 68 00 72 00 65 00 66 00 3d 00 27 00 23 00 27 00 90 01 01 6f 00 6e 00 63 00 6c 00 69 00 63 00 6b 00 3d 00 22 00 22 00 66 00 70 00 6f 00 73 00 74 00 28 00 27 00 90 00 } //1
		$a_03_6 = {3c 61 20 68 72 65 66 3d 27 23 27 90 01 01 6f 6e 63 6c 69 63 6b 3d 22 22 66 70 6f 73 74 28 27 90 00 } //1
		$a_03_7 = {3c 00 62 00 72 00 3e 00 3c 00 69 00 6e 00 70 00 75 00 74 00 90 01 01 74 00 79 00 70 00 65 00 3d 00 22 00 22 00 68 00 69 00 64 00 64 00 65 00 6e 00 22 00 90 00 } //1
		$a_03_8 = {3c 62 72 3e 3c 69 6e 70 75 74 90 01 01 74 79 70 65 3d 22 22 68 69 64 64 65 6e 22 90 00 } //1
