...
rule Trojan_Win32_Jorik_MB_MTB{
	...
	strings :
		$a_03_0 = {8b 85 74 fd ff ff 03 05 90 01 04 8b 08 03 0d 90 01 04 8b 95 74 fd ff ff 03 15 90 01 04 89 0a a1 90 01 04 83 c0 71 8b 8d 74 fd ff ff 03 0d 90 01 04 33 01 8b 95 74 fd ff ff 03 15 90 01 04 89 02 eb 90 00 } //1
