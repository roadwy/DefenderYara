...
rule Trojan_Win32_RedCap_SPD_MTB{
	...
	strings :
		$a_01_0 = {4e 6f 61 64 66 67 69 6f 61 65 6a 66 69 67 6f 61 65 66 } //02 00  Noadfgioaejfigoaef
		$a_01_1 = {4e 6f 65 61 6a 69 6f 66 67 73 65 61 6a 69 67 66 65 73 69 66 67 } //01 00  Noeajiofgseajigfesifg
