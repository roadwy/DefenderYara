...
rule Trojan_Win32_RedCap_CB_MTB{
	...
	strings :
		...
		$a_01_1 = {43 6f 6e 74 72 6f 6c 20 50 61 6e 65 6c 5c 44 65 73 6b 74 6f 70 5c 52 65 73 6f 75 72 63 65 4c 6f 63 61 6c 65 } //00 00  Control Panel\Desktop\ResourceLocale
	condition:
		any of ($a_*)
