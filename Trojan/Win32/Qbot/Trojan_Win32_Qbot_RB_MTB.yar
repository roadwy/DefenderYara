...
rule Trojan_Win32_Qbot_RB_MTB{
	...
	strings :
		$a_03_0 = {8b 55 d8 8b 1a 03 5d a8 2b d8 4b 68 90 01 04 e8 90 01 04 03 d8 8b 45 d8 89 18 8b 45 c4 03 45 a4 89 45 a0 6a 00 e8 90 01 04 8b 55 a0 2b d0 4a 8b 45 d8 33 10 89 55 a0 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_Win32_Qbot_RB_MTB_2{
	...
	strings :
		$a_02_0 = {83 c4 04 8b 90 01 05 89 15 90 01 04 a1 90 01 04 8b 0d 90 01 04 8d 54 01 90 01 01 2b 55 90 01 01 03 15 90 01 04 89 15 90 01 04 a1 90 01 04 83 e8 15 a3 90 01 04 8b 0d 90 01 04 03 4d 90 01 01 03 0d 90 01 04 89 0d 90 01 04 8b 15 90 01 04 2b 15 90 01 04 89 15 90 01 04 b8 01 00 00 00 90 00 } //2
	condition:
		((#a_02_0  & 1)*2) >=2
