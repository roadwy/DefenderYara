...
rule Trojan_Win32_Qbot_BB_MTB{
	...
	strings :
		...
		$a_01_1 = {42 58 4a 62 54 5a 65 64 58 } //01 00 
		$a_01_2 = {42 5a 35 64 57 6a } //01 00 
		$a_01_3 = {42 6e 53 33 5a 39 6b } //01 00 
		$a_01_4 = {43 4d 54 6a 77 56 65 } //01 00 
		$a_01_5 = {44 57 55 61 63 51 31 67 62 } //00 00 
	condition:
		any of ($a_*)
