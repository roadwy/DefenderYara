...
rule Trojan_Win32_Qbot_DC_MTB{
	...
	strings :
		...
		$a_81_3 = {62 65 6c 65 6d 6e 6f 69 64 65 61 } //01 00 
		$a_81_4 = {69 73 63 68 69 6f 61 6e 61 6c } //01 00 
		$a_81_5 = {6f 76 65 72 68 6f 6e 65 73 74 6c 79 } //01 00 
		$a_81_6 = {70 65 74 61 6c 6f 64 69 63 } //00 00 
	condition:
		any of ($a_*)
