...
rule Trojan_Win32_Qbot_RMA_MTB{
	...
	strings :
		...
		$a_03_1 = {89 10 33 c0 a3 90 01 04 a1 90 01 04 83 c0 04 03 05 90 01 04 a3 90 01 04 6a 00 e8 90 01 04 8b d8 a1 90 01 04 83 c0 04 90 00 } //1
	condition:
...
rule Trojan_Win32_Qbot_RMA_MTB_4{
	...
	strings :
		$a_02_0 = {01 02 8b 45 90 01 01 05 8a a5 08 00 03 45 90 01 01 8b 55 90 01 01 31 02 6a 90 01 01 e8 90 01 04 6a 90 01 01 e8 90 01 04 6a 90 01 01 e8 90 01 04 6a 90 01 01 e8 90 01 04 6a 90 01 01 e8 90 01 04 6a 90 01 01 e8 90 01 04 83 45 90 01 01 04 83 45 90 01 01 04 8b 45 90 01 01 3b 45 90 01 01 72 90 00 } //1
	condition:
		((#a_02_0  & 1)*1) >=1
...
rule Trojan_Win32_Qbot_RMA_MTB_5{
	...
	strings :
		$a_02_0 = {05 8a a5 08 00 03 45 90 01 01 03 d8 68 8c 12 00 00 6a 00 e8 90 01 04 03 d8 68 8c 12 00 00 6a 90 00 } //1
		$a_02_1 = {03 d8 68 8c 12 00 00 6a 00 e8 90 01 04 03 d8 a1 90 01 04 31 18 68 90 01 04 e8 90 01 04 68 90 01 04 e8 90 01 04 83 45 90 01 01 04 83 05 90 01 04 04 8b 45 90 01 01 3b 05 90 01 04 0f 82 90 00 } //1
	condition:
