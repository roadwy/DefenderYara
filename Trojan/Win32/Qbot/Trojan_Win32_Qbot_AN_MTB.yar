...
rule Trojan_Win32_Qbot_AN_MTB{
	...
	strings :
		$a_01_0 = {41 52 79 5a 69 69 4f 72 6d 66 6c } //02 00 
		$a_01_1 = {41 72 77 33 71 67 } //02 00 
		$a_01_2 = {42 4d 65 47 6a 54 4b } //02 00 
		$a_01_3 = {42 52 57 78 47 57 59 63 57 69 33 } //02 00 
		$a_01_4 = {42 64 54 68 38 75 4b 44 } //02 00 
...
rule Trojan_Win32_Qbot_AN_MTB_2{
	...
	strings :
		$a_01_0 = {00 58 35 35 35 00 } //01 00 
		...
		$a_01_3 = {00 55 7a 6d 61 5f 69 6e 64 65 78 5f 75 6e 63 6f 6d 70 72 65 73 73 65 64 5f 73 69 7a 65 00 } //01 00 
		$a_01_4 = {00 55 7a 6d 61 5f 70 68 79 73 6d 65 6d 00 } //00 00 
	condition:
		any of ($a_*)
