...
rule Trojan_Win32_Qbot_SN_MTB{
	...
	strings :
		...
		$a_03_4 = {8d 0c 10 8d 1c 0f 83 e3 90 01 01 8a 9b 90 01 04 32 1c 16 42 88 19 3b 55 fc 72 e6 90 00 } //1
		$a_03_5 = {50 ff 36 83 e9 05 c6 45 f4 e9 89 4d f5 c7 45 fc 05 00 00 00 ff 15 90 01 04 85 c0 78 1c 90 00 } //1
