...
rule Trojan_Win32_Qbot_DEH_MTB{
	...
	strings :
		$a_02_0 = {01 f9 81 e1 ff 00 00 00 8b 7c 24 34 8a 1c 0f 8b 4c 24 2c 81 e9 ?? ?? ?? ?? 8b 7c 24 28 89 0c 24 8b 4c 24 0c 8a 3c 0f 8b 0c 24 89 4c 24 48 30 fb 8b 4c 24 24 8b 7c 24 0c 88 1c 39 } //1
	condition:
		((#a_02_0  & 1)*1) >=1
...
rule Trojan_Win32_Qbot_DEH_MTB_2{
	...
	strings :
		$a_02_0 = {0f af ca 89 4c 24 1c 8b 4c 24 14 8a 1c 01 8b 74 24 10 88 1c 06 8b 7c 24 1c 81 f7 [0-08] 89 7c 24 1c 31 ff b9 ?? ?? ?? ?? 8b 54 24 08 29 d1 8b 54 24 0c 19 d7 89 7c 24 24 89 4c 24 20 } //1
	condition:
		((#a_02_0  & 1)*1) >=1
