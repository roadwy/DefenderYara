...
rule Trojan_Win32_Qbot_PVD_MTB{
	...
	strings :
		$a_02_0 = {69 d2 fd 43 03 00 89 15 ?? ?? ?? ?? 81 05 ?? ?? ?? ?? c3 9e 26 00 a0 ?? ?? ?? ?? 30 04 1e 46 3b f7 7c 90 09 06 00 8b 15 } //2
		$a_02_1 = {8b d7 b8 b9 5e 01 00 8b ca b8 ff 01 00 00 03 c1 2d ff 01 00 00 a3 ?? ?? ?? ?? a1 ?? ?? ?? ?? 8b 0d ?? ?? ?? ?? 89 08 } //2
