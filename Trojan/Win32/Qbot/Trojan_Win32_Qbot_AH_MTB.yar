...
rule Trojan_Win32_Qbot_AH_MTB{
	...
	strings :
		$a_01_0 = {00 58 53 38 38 00 } //01 00  堀㡓8
		...
		$a_01_3 = {00 52 65 5f 67 65 74 43 68 61 72 49 6e 64 69 63 65 73 5f 35 37 00 } //01 00  刀彥敧䍴慨䥲摮捩獥㕟7
		$a_01_4 = {00 52 65 5f 63 72 65 61 74 65 5f 35 37 00 } //00 00  刀彥牣慥整㕟7
	condition:
		any of ($a_*)
