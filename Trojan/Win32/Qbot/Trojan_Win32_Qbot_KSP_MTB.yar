...
rule Trojan_Win32_Qbot_KSP_MTB{
	...
	strings :
		...
		$a_02_1 = {8b f6 33 3d ?? ?? ?? ?? 8b cf b8 04 00 00 00 03 c1 83 e8 04 a3 ?? ?? ?? ?? a1 ?? ?? ?? ?? 8b 0d ?? ?? ?? ?? 89 08 } //2
		$a_02_2 = {0f b6 c3 03 f8 81 e7 ff 00 00 00 81 3d 64 2b 4f 00 81 0c 00 00 75 90 09 0c 00 a1 ?? ?? ?? ?? 0f b6 b8 } //1
		$a_02_3 = {30 04 1f 4f 79 90 09 05 00 e8 } //1
	condition:
