...
rule Trojan_Win32_Qbot_DD_MTB{
	...
	strings :
		...
		$a_81_3 = {70 79 6c 65 74 68 72 6f 6d 62 6f 70 68 6c 65 62 69 74 69 73 } //01 00 
		$a_81_4 = {62 61 63 74 65 72 69 63 69 64 65 } //01 00 
		$a_81_5 = {64 65 6c 69 63 61 74 65 73 73 65 } //01 00 
		$a_81_6 = {74 6f 73 73 69 63 61 74 65 64 } //00 00 
	condition:
		any of ($a_*)
