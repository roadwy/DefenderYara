...
rule Trojan_Win32_Powemet_A_attk{
	...
	strings :
		$a_02_0 = {72 00 65 00 67 00 73 00 76 00 72 00 33 00 32 00 90 02 f0 2f 00 69 00 3a 00 68 00 74 00 74 00 70 00 90 00 } //1
		$a_02_1 = {72 00 65 00 67 00 73 00 76 00 72 00 33 00 32 00 90 02 f0 2d 00 69 00 3a 00 68 00 74 00 74 00 70 00 90 00 } //1
	condition:
