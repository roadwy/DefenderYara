...
rule Trojan_Win32_Powemet_B_attk{
	...
	strings :
		...
		$a_00_1 = {2f 00 69 00 3a 00 75 00 72 00 6c 00 3a 00 68 00 74 00 74 00 70 00 } //01 00 
		$a_00_2 = {2d 00 69 00 3a 00 75 00 72 00 6c 00 3a 00 68 00 74 00 74 00 70 00 } //0a 00 
