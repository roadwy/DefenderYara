...
rule Trojan_Win32_Bitlocker_E_rsm{
	meta:
		description = "Trojan:Win32/Bitlocker.E!rsm,SIGNATURE_TYPE_CMDHSTR_EXT,64 00 1e 00 03 00 00 0a 00 "
	...
	strings :
		...
		$a_00_1 = {52 00 65 00 63 00 6f 00 76 00 65 00 72 00 79 00 4b 00 65 00 79 00 55 00 72 00 6c 00 } //0a 00  RecoveryKeyUrl
