...
rule Trojan_Win32_Bitlocker_B_rsm{
	meta:
		description = "Trojan:Win32/Bitlocker.B!rsm,SIGNATURE_TYPE_CMDHSTR_EXT,64 00 1e 00 03 00 00 0a 00 "
	...
	strings :
		...
		$a_00_1 = {45 00 6e 00 61 00 62 00 6c 00 65 00 42 00 44 00 45 00 57 00 69 00 74 00 68 00 4e 00 6f 00 54 00 50 00 4d 00 } //0a 00  EnableBDEWithNoTPM
