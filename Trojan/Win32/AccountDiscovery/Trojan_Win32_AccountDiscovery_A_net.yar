...
rule Trojan_Win32_AccountDiscovery_A_net{
	...
	strings :
		...
		$a_02_1 = {6e 00 65 00 74 00 20 00 [0-40] 75 00 73 00 65 00 72 00 } //3
		$a_02_2 = {6e 00 65 00 74 00 2e 00 65 00 78 00 65 00 [0-40] 75 00 73 00 65 00 72 00 } //3
		$a_02_3 = {6e 00 65 00 74 00 31 00 20 00 [0-40] 75 00 73 00 65 00 72 00 } //3
		$a_02_4 = {6e 00 65 00 74 00 31 00 2e 00 65 00 78 00 65 00 [0-40] 75 00 73 00 65 00 72 00 } //3
