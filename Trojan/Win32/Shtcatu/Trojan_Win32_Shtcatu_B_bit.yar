...
rule Trojan_Win32_Shtcatu_B_bit{
	...
	strings :
		...
		$a_01_1 = {48 4b 43 55 5c 53 4f 46 54 57 41 52 45 5c 4d 69 63 72 6f 73 6f 66 74 5c 57 69 6e 64 6f 77 73 5c 43 75 72 72 65 6e 74 56 65 72 73 69 6f 6e 5c 52 75 6e } //01 00 
		$a_01_2 = {52 45 47 5f 53 5a 20 2f 46 20 2f 44 20 22 43 3a 5c 74 65 6d 70 } //01 00 
		$a_03_3 = {63 6c 61 6d 61 74 30 2e 64 75 63 6b 64 6e 73 2e 6f 72 67 90 02 10 53 62 69 65 44 6c 6c 90 00 } //01 00 
		$a_01_4 = {63 61 70 74 75 72 61 2e 62 6d 70 } //00 00 
	condition:
		any of ($a_*)
