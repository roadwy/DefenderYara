...
rule Trojan_Win32_WebHijack_A_dll{
	...
	strings :
		...
		$a_00_2 = {57 65 62 48 69 6a 61 63 6b } //01 00 
		$a_00_3 = {5c 77 65 62 73 61 66 65 2e 73 79 73 } //01 00 
		$a_00_4 = {5c 53 61 66 65 42 6f 6f 74 5c 4d 69 6e 69 6d 61 6c 5c 25 73 2e 73 79 73 } //01 00 
		$a_00_5 = {49 73 44 72 69 76 65 72 52 75 6e 6e 69 6e 67 } //01 00 
		$a_00_6 = {4c 6f 61 64 43 6f 6e 66 69 67 } //01 00 
		$a_00_7 = {63 75 74 69 6c 5f 64 72 69 76 65 72 5f 4f 70 65 6e 44 65 76 69 63 65 } //00 00 
	condition:
		any of ($a_*)
