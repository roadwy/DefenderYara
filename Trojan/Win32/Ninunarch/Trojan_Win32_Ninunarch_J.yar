...
rule Trojan_Win32_Ninunarch_J{
	...
	strings :
		$a_01_0 = {76 70 61 74 63 68 66 69 6c 65 } //0a 00 
		$a_01_1 = {73 6d 73 39 31 31 2e 72 75 2f 74 61 72 69 66 73 2e 70 68 70 3f 63 6f 75 6e 74 72 79 5f 69 64 3d 31 26 6e 75 6d 3d 32 38 35 38 } //0a 00 
