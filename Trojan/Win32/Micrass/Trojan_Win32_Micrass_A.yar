...
rule Trojan_Win32_Micrass_A{
	...
	strings :
		...
		$a_01_5 = {49 00 50 00 3a 00 25 00 73 00 20 00 50 00 6f 00 72 00 74 00 3a 00 25 00 64 00 } //01 00  IP:%s Port:%d
		$a_01_6 = {4c 00 53 00 4d 00 41 00 53 00 53 00 00 00 } //01 00 
		$a_01_7 = {25 00 2e 00 34 00 58 00 2e 00 65 00 78 00 65 00 } //01 00  %.4X.exe
