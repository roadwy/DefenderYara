...
rule Trojan_Win32_FakePlayer_B{
	...
	strings :
		$a_03_0 = {0f 85 c2 00 00 00 80 7d 90 01 01 47 0f 85 90 01 02 00 00 80 7d 90 01 01 49 0f 85 90 01 02 00 00 80 7d 90 01 01 46 0f 85 90 01 02 00 00 80 7d 90 01 01 38 0f 85 90 01 02 00 00 90 00 } //1
		$a_02_1 = {75 09 80 81 90 01 03 00 fd eb 33 8b 90 01 01 6a 03 99 90 01 01 f7 90 01 01 85 90 01 01 75 08 fe 89 90 01 03 00 eb 1f 90 00 } //2
