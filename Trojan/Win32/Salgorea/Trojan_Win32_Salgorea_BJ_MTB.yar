...
rule Trojan_Win32_Salgorea_BJ_MTB{
	...
	strings :
		...
		$a_02_3 = {68 3c 1b 00 00 8b 0d 90 01 09 68 e0 63 a9 00 c7 46 10 90 01 04 68 a8 c9 0e 10 68 90 01 04 8a 81 98 00 00 00 0d 9d c3 83 9f 65 32 1e 4f 10 41 01 90 00 } //1
	condition:
