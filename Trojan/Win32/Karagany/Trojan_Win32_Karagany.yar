...
rule Trojan_Win32_Karagany{
	...
	strings :
		...
		$a_01_3 = {2f 6b 6e 6f 63 6b 2e 70 68 70 } //01 00 
		$a_01_4 = {67 65 6f 2f 70 72 6f 64 75 63 74 69 64 2e 70 68 70 } //01 00 
		$a_00_5 = {6d 00 73 00 68 00 74 00 61 00 2e 00 65 00 78 00 65 00 } //01 00 
		$a_00_6 = {5c 00 41 00 64 00 6f 00 62 00 65 00 5c 00 41 00 64 00 6f 00 62 00 65 00 55 00 70 00 64 00 61 00 74 00 65 00 20 00 2e 00 65 00 78 00 65 00 } //01 00 
		$a_00_7 = {64 6f 77 6e 65 78 65 63 00 } //01 00 
		$a_00_8 = {41 64 62 55 70 64 2e 6c 6e 6b 00 } //01 00 
		$a_00_9 = {78 64 69 65 78 00 } //01 00 
		$a_01_10 = {70 6c 75 67 69 6e 2f 78 67 61 74 65 2e 70 68 70 } //00 00 
	condition:
		any of ($a_*)
