...
rule Trojan_Win32_MatanbuchusLoader_MA_MTB{
	...
	strings :
		...
		$a_01_1 = {3f 48 61 63 6b 43 68 65 63 6b 40 40 59 47 58 58 5a } //01 00  ?HackCheck@@YGXXZ
		$a_01_2 = {44 6c 6c 49 6e 73 74 61 6c 6c } //01 00  DllInstall
		$a_01_3 = {36 30 30 31 2e 69 63 6c } //00 00  6001.icl
	condition:
		any of ($a_*)
