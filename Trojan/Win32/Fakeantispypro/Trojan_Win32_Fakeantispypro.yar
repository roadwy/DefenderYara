...
rule Trojan_Win32_Fakeantispypro_3{
	...
	strings :
		$a_03_0 = {80 bc 24 50 10 00 00 30 75 02 33 db 8d bc 24 52 10 00 00 57 e8 90 01 02 00 00 83 c4 04 66 83 7c 24 4a 00 8b f8 75 54 90 00 } //1
		$a_03_1 = {83 fd e0 0f 87 90 01 02 00 00 53 8b 1d 90 01 02 00 10 56 57 33 f6 39 35 90 01 02 00 10 8b fd 75 18 e8 90 01 02 00 00 6a 1e e8 90 01 02 00 00 68 ff 00 00 00 e8 90 00 } //1
