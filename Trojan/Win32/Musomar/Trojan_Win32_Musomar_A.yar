...
rule Trojan_Win32_Musomar_A{
	...
	strings :
		$a_03_0 = {68 2b 80 00 00 6a 00 ff 15 90 01 03 00 85 c0 7c 90 01 01 8d 90 01 01 ec fc ff ff 90 01 01 68 90 01 03 00 68 04 01 00 00 8d 90 00 } //2
		$a_03_1 = {aa 68 95 00 00 00 8d 90 01 01 68 ff ff ff 90 00 } //2
