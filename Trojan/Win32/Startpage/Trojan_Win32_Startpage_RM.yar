...
rule Trojan_Win32_Startpage_RM{
	...
	strings :
		...
		$a_00_3 = {68 74 74 70 3a 2f 2f 77 77 77 2e 6c 65 6c 65 34 34 34 2e 63 6f 6d 2f 3f } //01 00  http://www.lele444.com/?
		$a_00_4 = {55 52 4c 3d 68 74 74 70 3a 2f 2f 38 38 38 2e 71 71 32 32 33 33 2e 63 6f 6d 2f } //00 00  URL=http://888.qq2233.com/
	condition:
		any of ($a_*)
