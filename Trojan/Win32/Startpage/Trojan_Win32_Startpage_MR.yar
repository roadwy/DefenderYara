...
rule Trojan_Win32_Startpage_MR{
	...
	strings :
		...
		$a_00_2 = {68 00 74 00 74 00 70 00 3a 00 2f 00 2f 00 77 00 77 00 77 00 2e 00 39 00 36 00 38 00 38 00 2e 00 6c 00 61 00 2f 00 3f 00 } //01 00  http://www.9688.la/?
		$a_00_3 = {33 00 36 00 30 00 73 00 65 00 2e 00 65 00 78 00 65 00 } //00 00  360se.exe
	condition:
		any of ($a_*)
