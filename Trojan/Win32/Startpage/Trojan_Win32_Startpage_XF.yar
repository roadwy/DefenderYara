...
rule Trojan_Win32_Startpage_XF{
	...
	strings :
		$a_01_0 = {64 49 4e 49 41 3a } //01 00 
		$a_01_1 = {25 73 5c 32 32 38 2e 74 6d 70 } //01 00 
		$a_01_2 = {5c 74 62 68 64 7a 2e 69 63 6f } //01 00 
		$a_01_3 = {2e 00 4c 00 41 00 49 00 54 00 41 00 4f 00 2e 00 49 00 4e 00 46 00 4f 00 } //01 00 
