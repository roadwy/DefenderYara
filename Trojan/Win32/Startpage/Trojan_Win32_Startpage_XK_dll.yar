...
rule Trojan_Win32_Startpage_XK_dll{
	...
	strings :
		$a_01_0 = {2e 36 64 75 64 75 2e 63 6f 6d } //01 00  .6dudu.com
		$a_01_1 = {2f 2f 31 32 32 2e 32 32 34 2e 39 2e 31 31 33 3a 38 30 32 32 2f 49 6e 73 65 72 74 62 7a 2e 61 73 70 78 3f } //01 00  //122.224.9.113:8022/Insertbz.aspx?
