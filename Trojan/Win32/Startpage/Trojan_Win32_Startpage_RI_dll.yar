...
rule Trojan_Win32_Startpage_RI_dll{
	...
	strings :
		...
		$a_00_3 = {46 65 78 70 6c 6f 72 65 72 2e 65 78 } //01 00  Fexplorer.ex
		$a_00_4 = {3a 2f 2f 77 77 77 2e 25 73 2f 3f 39 } //01 00  ://www.%s/?9
		$a_00_5 = {57 49 4e 44 4f 57 53 5c 6b 73 77 65 62 73 68 69 65 6c 64 2e 64 6c } //01 00  WINDOWS\kswebshield.dl
		$a_00_6 = {67 6f 32 30 30 30 2e 63 } //00 00  go2000.c
	condition:
		any of ($a_*)
