...
rule Trojan_Win32_Startpage_RI_dll{
	...
	strings :
		$a_02_0 = {99 f7 7d 0c 8b 90 01 01 08 90 01 03 32 90 01 01 32 45 14 90 00 } //4
		$a_00_1 = {76 d5 83 f8 07 73 d0 } //1
		$a_02_2 = {85 c0 74 ed 83 7d 90 01 01 02 75 e7 8b 40 04 33 90 01 01 66 83 38 2d 0f 94 90 00 } //1
