...
rule Trojan_Win32_Startpage_SQ{
	...
	strings :
		$a_03_0 = {8a 08 40 84 c9 75 90 02 05 2b c2 50 90 02 04 68 90 01 04 6a 01 56 68 90 01 05 ff 15 90 01 04 85 c0 90 00 } //1
		$a_03_1 = {68 57 00 07 80 e8 90 01 04 55 8b 6c 90 01 02 56 55 53 e8 90 01 04 8b f0 8b 07 8b 50 f8 83 e8 10 90 00 } //1
