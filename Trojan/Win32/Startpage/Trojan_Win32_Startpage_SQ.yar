...
rule Trojan_Win32_Startpage_SQ{
	...
	strings :
		...
		$a_00_2 = {69 6c 63 2e 6e 62 7a 2e 63 6f 2e 6b 72 2f 69 6e 73 74 61 6c 6c 2e 61 73 70 3f 69 64 3d 31 38 36 26 6d 61 63 3d 25 73 } //01 00  ilc.nbz.co.kr/install.asp?id=186&mac=%s
		$a_00_3 = {64 69 73 6b 6d 61 6e 69 61 2e 63 6f 2e 6b 72 2f 70 72 6f 67 72 61 6d 2f 79 61 68 6f 6f 5f } //00 00  diskmania.co.kr/program/yahoo_
	condition:
		any of ($a_*)
