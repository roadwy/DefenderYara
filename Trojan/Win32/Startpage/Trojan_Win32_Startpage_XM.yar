...
rule Trojan_Win32_Startpage_XM{
	...
	strings :
		$a_01_0 = {71 00 77 00 78 00 79 00 78 00 2e 00 63 00 6f 00 6d 00 2f 00 } //01 00  qwxyx.com/
		$a_01_1 = {6d 00 6d 00 74 00 70 00 35 00 2e 00 69 00 6e 00 66 00 6f 00 2f 00 } //01 00  mmtp5.info/
