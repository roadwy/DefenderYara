...
rule Trojan_Win32_Startpage_RL{
	...
	strings :
		...
		$a_01_1 = {77 77 77 2e 67 6f 32 30 30 30 2e 63 6e 2f 3f 31 } //01 00  www.go2000.cn/?1
		$a_01_2 = {77 77 77 2e 6c 65 69 6c 65 69 6b 75 61 69 2e 63 6e 2f 77 65 6c 63 6f 6d 65 2e 70 68 70 3f 74 6e 3d } //01 00  www.leileikuai.cn/welcome.php?tn=
