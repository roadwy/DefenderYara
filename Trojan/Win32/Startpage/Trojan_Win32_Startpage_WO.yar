...
rule Trojan_Win32_Startpage_WO{
	...
	strings :
		$a_01_0 = {59 7a 44 6f 63 6b 43 6c 61 73 73 } //01 00  YzDockClass
		$a_01_1 = {5c 4d 61 63 4a 69 65 2e 6b 65 79 } //01 00  \MacJie.key
		$a_01_2 = {6e 64 66 68 69 7e 2e 74 6d 70 } //01 00  ndfhi~.tmp
		$a_01_3 = {6e 64 66 68 69 2e 62 61 74 } //01 00  ndfhi.bat
