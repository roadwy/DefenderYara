...
rule Trojan_Win32_Startpage_XH_dll{
	...
	strings :
		$a_01_0 = {2e 64 68 30 30 35 2e 63 6f 6d 2f 3f } //01 00  .dh005.com/?
		$a_01_1 = {32 00 2e 00 2e 00 5c 00 2e 00 2e 00 5c 00 50 00 72 00 6f 00 67 00 72 00 61 00 6d 00 20 00 46 00 69 00 6c 00 65 00 73 00 5c 00 49 00 } //01 00  2..\..\Program Files\I
