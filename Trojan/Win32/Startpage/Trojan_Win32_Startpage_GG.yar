...
rule Trojan_Win32_Startpage_GG{
	...
	strings :
		...
		$a_02_1 = {53 6f 66 74 57 61 72 65 5c 4d 69 63 72 6f 73 6f 66 74 5c 49 6e 74 65 72 6e 65 74 20 45 78 70 6c 6f 72 65 72 5c 4d 61 69 6e 90 02 10 53 74 61 72 74 20 50 61 67 65 90 00 } //1
