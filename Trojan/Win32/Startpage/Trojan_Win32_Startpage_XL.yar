...
rule Trojan_Win32_Startpage_XL{
	...
	strings :
		$a_01_0 = {67 2e 66 72 65 65 73 68 69 70 69 6e 2e 69 6e 66 6f 3a 31 31 38 38 2f } //01 00 
		$a_01_1 = {66 61 63 61 69 2e 6a 69 61 6e 6b 61 6e 67 6d 6d 2e 63 6f 6d 2f } //01 00 
