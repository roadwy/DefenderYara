...
rule Trojan_Win32_Startpage_WM{
	...
	strings :
		...
		$a_01_1 = {2f 63 20 72 65 67 20 61 64 64 20 22 48 4b 43 55 5c 53 6f 66 74 77 61 72 65 5c 4d 69 63 72 6f 73 6f 66 74 5c 49 6e 74 65 72 6e 65 74 20 45 78 70 6c 6f 72 65 72 5c 4d 61 69 6e 22 20 2f 76 20 22 53 74 61 72 74 20 50 61 67 65 22 20 2f 74 20 52 45 47 5f 53 5a 20 2f 64 } //01 00  /c reg add "HKCU\Software\Microsoft\Internet Explorer\Main" /v "Start Page" /t REG_SZ /d
