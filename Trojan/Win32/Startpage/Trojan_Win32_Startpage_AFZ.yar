...
rule Trojan_Win32_Startpage_AFZ{
	...
	strings :
		...
		$a_02_4 = {65 63 68 6f 20 79 7c 20 63 61 63 6c 73 20 22 90 02 15 2e 75 72 6c 22 90 02 04 2f 70 20 65 76 65 72 79 6f 6e 65 3a 66 90 00 } //2
		$a_02_5 = {5c 6b 77 73 2e 69 6e 69 22 90 02 04 2b 52 20 2b 53 90 00 } //2
		$a_02_6 = {5c 6b 77 73 2e 69 6e 69 22 90 02 04 2f 70 20 65 76 65 72 79 6f 6e 65 3a 52 90 00 } //2
	condition:
