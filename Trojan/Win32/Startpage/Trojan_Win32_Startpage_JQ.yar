...
rule Trojan_Win32_Startpage_JQ{
	...
	strings :
		...
		$a_02_1 = {72 75 6e 64 6c 6c 33 32 2e 65 78 65 20 22 73 79 73 90 02 02 6b 65 79 73 2e 64 6c 6c 22 90 00 } //1
		$a_00_2 = {77 77 77 2e 68 61 6f 31 32 33 2e 63 6f 6d } //1 www.hao123.com
		$a_00_3 = {77 77 77 2e 39 39 36 39 2e 6e 65 74 } //1 www.9969.net
	condition:
