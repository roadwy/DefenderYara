...
rule Trojan_Win32_Startpage_OF{
	...
	strings :
		$a_00_0 = {57 49 4e 44 4f 57 53 5c 73 79 73 74 65 6d 33 32 5c 64 72 69 76 65 72 73 5c 65 74 63 5c 73 65 72 76 69 63 65 } //01 00 
		$a_00_1 = {50 72 6f 67 72 61 6d 20 46 69 6c 65 73 5c 73 74 61 72 74 75 70 } //01 00 
