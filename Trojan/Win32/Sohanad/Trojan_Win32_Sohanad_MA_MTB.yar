...
rule Trojan_Win32_Sohanad_MA_MTB{
	...
	strings :
		...
		$a_01_3 = {44 65 76 69 63 65 49 6f 43 6f 6e 74 72 6f 6c } //01 00  DeviceIoControl
		$a_01_4 = {4c 6f 63 6b 53 65 72 76 69 63 65 44 61 74 61 62 61 73 65 } //00 00  LockServiceDatabase
	condition:
		any of ($a_*)
