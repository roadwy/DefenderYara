...
rule Trojan_Win32_NgrBot_MA_MTB{
	...
	strings :
		$a_03_0 = {69 c0 fd 43 03 00 05 c3 9e 26 00 a3 90 01 04 c1 f8 10 25 ff 7f 00 00 c3 90 00 } //1
		$a_03_1 = {99 b9 e8 03 00 00 f7 f9 81 c2 f4 01 00 00 0f af d6 52 ff 15 90 01 04 68 90 01 04 6a 00 68 01 00 1f 00 ff 15 90 00 } //1
