...
rule Trojan_Win32_NgrBot_MA_MTB{
	...
	strings :
		...
		$a_01_2 = {66 72 6f 6d 20 72 65 6d 6f 76 69 6e 67 20 6f 75 72 20 62 6f 74 20 66 69 6c 65 21 } //01 00  from removing our bot file!
		$a_01_3 = {4d 65 73 73 61 67 65 20 68 69 6a 61 63 6b 65 64 21 } //01 00  Message hijacked!
		$a_01_4 = {2a 79 6f 75 70 6f 72 6e 2e 2a 2f 6c 6f 67 69 6e 2a } //01 00  *youporn.*/login*
		$a_01_5 = {6e 67 72 42 6f 74 } //00 00  ngrBot
	condition:
		any of ($a_*)
