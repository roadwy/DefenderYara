...
rule Trojan_Win32_Antivirusxp{
	...
	strings :
		...
		$a_00_2 = {54 68 69 73 20 69 73 20 74 72 69 61 6c 20 76 65 72 73 69 6f 6e } //01 00  This is trial version
...
rule Trojan_Win32_Antivirusxp_2{
	...
	strings :
		...
		$a_01_3 = {65 63 68 6f 20 3e 20 25 31 } //01 00  echo > %1
		$a_01_4 = {69 66 20 65 78 69 73 74 20 25 31 20 67 6f 74 6f } //02 00  if exist %1 goto
...
rule Trojan_Win32_Antivirusxp_3{
	...
	strings :
		...
		$a_00_1 = {34 32 37 64 62 41 65 30 2d 37 37 39 39 2d 34 36 31 31 2d 39 37 38 39 2d 64 65 62 33 36 31 35 36 64 31 61 64 4c 4f 41 44 45 44 4d 55 54 58 } //01 00  427dbAe0-7799-4611-9789-deb36156d1adLOADEDMUTX
		...
		$a_00_4 = {53 6f 66 74 77 61 72 65 5c 4d 69 63 72 6f 73 6f 66 74 5c 57 69 6e 64 6f 77 73 5c 43 75 72 72 65 6e 74 56 65 72 73 69 6f 6e 5c 53 68 65 6c 6c 20 45 78 74 65 6e 73 69 6f 6e 73 5c 41 70 70 72 6f 76 65 64 } //00 00  Software\Microsoft\Windows\CurrentVersion\Shell Extensions\Approved
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Antivirusxp_4{
	...
	strings :
		$a_01_0 = {2f 62 75 79 32 2f } //0a 00  /buy2/
		$a_01_1 = {42 75 79 55 72 6c 00 } //0a 00 
		$a_01_2 = {2f 70 75 72 63 68 61 73 65 32 2f } //0a 00  /purchase2/
		$a_00_3 = {42 75 79 44 69 73 63 55 72 6c 00 } //0a 00 
		$a_00_4 = {5c 70 69 6e 2e 76 62 73 20 22 } //0a 00  \pin.vbs "
		$a_00_5 = {64 61 74 61 62 61 73 65 2e 64 61 74 00 } //0a 00 
		$a_01_6 = {44 61 74 61 62 61 73 65 56 65 72 73 69 6f 6e 00 } //0a 00  慄慴慢敳敖獲潩n
		$a_01_7 = {50 72 6f 67 72 61 6d 56 65 72 73 69 6f 6e 00 } //0a 00 
		$a_01_8 = {45 6e 67 69 6e 65 56 65 72 73 69 6f 6e 00 } //0a 00  湅楧敮敖獲潩n
		...
		$a_01_12 = {53 63 61 6e 44 65 70 74 68 00 } //0a 00  捓湡敄瑰h
		$a_01_13 = {53 63 61 6e 53 79 73 74 65 6d 4f 6e 53 74 61 72 74 75 70 00 } //0a 00  捓湡祓瑳浥湏瑓牡畴p
		...
		$a_01_16 = {42 61 63 6b 67 72 6f 75 6e 64 53 63 61 6e 54 69 6d 65 6f 75 74 00 } //0a 00  慂正牧畯摮捓湡楔敭畯t
		$a_00_17 = {34 32 37 64 62 41 65 30 2d 37 37 39 39 2d 34 36 31 31 2d 39 37 38 39 2d 64 65 62 33 36 31 35 36 64 31 61 64 4c 4f 41 44 45 44 4d 55 54 58 } //0a 00  427dbAe0-7799-4611-9789-deb36156d1adLOADEDMUTX
		...
		$a_00_19 = {2f 52 45 47 49 53 54 45 52 00 } //05 00  刯䝅卉䕔R
		$a_01_20 = {2f 72 65 67 69 73 74 72 61 74 69 6f 6e 2f } //05 00  /registration/
...
rule Trojan_Win32_Antivirusxp_6{
	...
	strings :
		$a_01_0 = {61 00 6e 00 74 00 69 00 76 00 69 00 72 00 75 00 73 00 2d 00 78 00 70 00 70 00 72 00 6f 00 2d 00 32 00 30 00 30 00 39 00 2e 00 63 00 6f 00 6d 00 2f 00 62 00 75 00 79 00 2f 00 3f 00 63 00 6f 00 64 00 65 00 3d 00 } //01 00  antivirus-xppro-2009.com/buy/?code=
		$a_01_1 = {53 00 6f 00 66 00 74 00 77 00 61 00 72 00 65 00 5c 00 41 00 6e 00 74 00 69 00 76 00 69 00 72 00 75 00 73 00 58 00 50 00 } //01 00  Software\AntivirusXP
		$a_01_2 = {5c 56 69 72 75 73 49 73 6f 6c 61 74 6f 72 5c } //00 00  \VirusIsolator\
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Antivirusxp_7{
	...
	strings :
		$a_01_0 = {73 00 75 00 70 00 70 00 6f 00 72 00 74 00 40 00 61 00 6e 00 74 00 69 00 76 00 69 00 72 00 75 00 73 00 78 00 70 00 32 00 30 00 30 00 38 00 2e 00 63 00 6f 00 6d 00 } //01 00  support@antivirusxp2008.com
		$a_01_1 = {68 00 74 00 74 00 70 00 3a 00 2f 00 2f 00 77 00 77 00 77 00 2e 00 61 00 6e 00 74 00 69 00 76 00 69 00 72 00 75 00 73 00 78 00 70 00 32 00 30 00 30 00 38 00 2e 00 63 00 6f 00 6d 00 } //01 00  http://www.antivirusxp2008.com
		$a_01_2 = {41 00 6e 00 74 00 69 00 76 00 69 00 72 00 75 00 73 00 20 00 58 00 50 00 20 00 32 00 30 00 30 00 38 00 } //00 00  Antivirus XP 2008
	condition:
		any of ($a_*)
