...
rule Trojan_Win32_Slupim_B{
	...
	strings :
		...
		$a_01_2 = {5c 5c 2e 5c 70 69 70 65 5c 24 25 64 24 } //01 00 
		$a_01_3 = {74 79 70 65 3d 6a 70 67 26 } //01 00 
		$a_00_4 = {48 00 69 00 70 00 49 00 6d 00 61 00 67 00 65 00 } //00 00 
	condition:
		any of ($a_*)
