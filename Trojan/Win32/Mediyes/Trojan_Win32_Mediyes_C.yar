...
rule Trojan_Win32_Mediyes_C{
	...
	strings :
		$a_00_0 = {26 00 73 00 79 00 73 00 3d 00 77 00 69 00 6e 00 64 00 6f 00 77 00 73 00 2b 00 25 00 64 00 2e 00 25 00 64 00 } //01 00  &sys=windows+%d.%d
		$a_00_1 = {26 00 73 00 79 00 73 00 3d 00 75 00 6e 00 6b 00 6e 00 6f 00 77 00 6e 00 } //01 00  &sys=unknown
