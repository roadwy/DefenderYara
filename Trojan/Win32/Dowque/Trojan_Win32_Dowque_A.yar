...
rule Trojan_Win32_Dowque_A{
	...
	strings :
		...
		$a_00_3 = {7b 41 36 30 31 31 46 38 46 2d 41 37 46 38 2d 34 39 41 41 2d 39 41 44 41 2d 34 39 31 32 37 44 34 33 31 33 38 46 7d } //01 00 
		$a_00_4 = {46 69 6c 65 73 5c 4d 69 63 72 6f 73 6f 66 74 20 53 68 61 72 65 64 5c 4d 53 49 4e 46 4f } //01 00 
		$a_00_5 = {48 54 54 50 2f 31 2e 30 } //00 00 
	condition:
		any of ($a_*)
