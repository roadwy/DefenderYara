...
rule Trojan_Win32_Cridex_GZM_MTB{
	...
	strings :
		...
		$a_01_1 = {62 65 73 74 68 6f 74 65 6c 33 36 30 2e 63 6f 6d } //01 00  besthotel360.com
		$a_01_2 = {56 69 72 74 75 61 6c 50 72 6f 74 65 63 74 } //01 00  VirtualProtect
		$a_01_3 = {6c 43 51 68 41 6d 61 6c 43 51 68 41 6d 61 6c 43 51 68 41 6d 61 } //00 00  lCQhAmalCQhAmalCQhAma
	condition:
		any of ($a_*)
