...
rule Trojan_Win32_Cridex_AR_MTB_9{
	...
	strings :
		$a_01_0 = {89 74 24 20 8d 34 09 2b f0 8b ca 81 c6 71 f2 fe ff 03 f2 33 d2 89 74 24 34 85 c9 0f 94 c2 89 54 24 3c } //1
	condition:
		((#a_01_0  & 1)*1) >=1
...
rule Trojan_Win32_Cridex_AR_MTB_10{
	...
	strings :
		$a_01_0 = {8d 51 03 05 2c f9 04 01 03 d6 89 45 00 6b ca 52 83 c5 04 2b cf 03 f1 83 6c 24 } //1
		$a_01_1 = {83 44 24 10 04 81 c3 90 4b 08 01 69 c1 3e 5c 01 00 89 1e 8b f2 2b f0 2b 74 24 14 8d 4e 08 } //1
	condition:
