...
rule Trojan_Win32_Webprefix_A{
	...
	strings :
		...
		$a_03_2 = {8b 4d 0c bf 04 01 00 00 57 c7 45 90 01 01 3c 00 00 00 e8 90 01 04 8b 4d 10 56 89 45 90 01 01 89 7d 90 01 01 e8 90 01 04 89 45 90 01 01 8d 45 90 01 01 50 6a 00 6a 00 89 75 90 01 01 ff 75 fc ff 15 90 01 04 8b 4d 0c 6a ff 90 00 } //1
	condition:
