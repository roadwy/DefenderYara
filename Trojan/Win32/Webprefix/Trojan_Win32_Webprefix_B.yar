...
rule Trojan_Win32_Webprefix_B{
	...
	strings :
		$a_00_0 = {2e 76 70 6c 61 79 63 68 65 63 6b 2e 63 6f 6d 2f 67 6f 2f } //01 00  .vplaycheck.com/go/
		$a_00_1 = {76 70 6c 61 79 2d 74 6f 2e 63 6f 6d } //01 00  vplay-to.com
		$a_00_2 = {53 6f 66 74 77 61 72 65 61 6b 74 75 61 6c 69 73 69 65 72 75 6e 67 7c 68 74 74 70 3a } //0a 00  Softwareaktualisierung|http:
