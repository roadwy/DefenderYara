...
rule Trojan_Win32_Redosdru_S{
	...
	strings :
		...
		$a_00_3 = {46 6c 61 67 3a 25 73 20 4e 61 6d 65 3a 25 73 20 49 50 3a 25 73 20 4f 53 3a 25 73 } //01 00  Flag:%s Name:%s IP:%s OS:%s
		$a_00_4 = {25 00 73 00 44 00 61 00 79 00 25 00 73 00 48 00 6f 00 75 00 72 00 25 00 73 00 4d 00 69 00 6e 00 } //00 00  %sDay%sHour%sMin
	condition:
		any of ($a_*)
