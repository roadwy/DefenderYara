...
rule Trojan_Win32_Redosdru_S{
	...
	strings :
		$a_03_0 = {7e 0e 8a 0c 90 01 01 80 f1 90 01 01 88 0c 90 01 01 40 3b 90 01 01 7c f2 90 00 } //2
		$a_03_1 = {74 23 8a 8a 90 01 04 bf 90 01 04 80 f1 90 01 01 33 c0 88 8a 90 01 04 83 c9 ff 42 f2 ae f7 d1 49 3b d1 72 dd 90 00 } //1
