...
rule Trojan_Win32_Redosdru_AB{
	...
	strings :
		...
		$a_03_1 = {fb ff ff 4d c6 85 90 01 01 fb ff ff 6f c6 85 90 01 01 fb ff ff 7a c6 85 90 01 01 fb ff ff 69 c6 85 90 01 01 fb ff ff 6c c6 85 90 01 01 fb ff ff 6c c6 85 90 01 01 fb ff ff 61 c6 85 90 01 01 fb ff ff 2f c6 85 90 01 01 fb ff ff 34 90 00 } //1
	condition:
