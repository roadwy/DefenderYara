...
rule Trojan_Win32_Redosdru_O{
	...
	strings :
		...
		$a_01_1 = {43 00 56 00 69 00 64 00 65 00 6f 00 43 00 61 00 70 00 } //01 00 
		$a_01_2 = {47 00 6c 00 6f 00 62 00 61 00 6c 00 5c 00 6d 00 6f 00 75 00 73 00 65 00 20 00 25 00 64 00 } //00 00 
	condition:
		any of ($a_*)
