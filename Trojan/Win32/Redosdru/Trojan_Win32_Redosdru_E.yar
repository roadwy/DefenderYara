...
rule Trojan_Win32_Redosdru_E{
	...
	strings :
		$a_03_0 = {6a 7c 56 e8 90 01 03 00 83 c4 08 85 c0 74 da 90 00 } //1
...
rule Trojan_Win32_Redosdru_E_2{
	...
	strings :
		...
		$a_03_1 = {8d 0c ad 00 00 00 00 b8 56 55 55 55 f7 e9 8b 47 04 8b ca c1 e9 1f 8d 54 0a 04 52 6a 08 50 ff 15 90 01 02 40 00 8b f0 89 47 0c 85 f6 75 08 90 00 } //1
