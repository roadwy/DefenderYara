...
rule Trojan_Win32_Redosdru_D{
	...
	strings :
		...
		$a_01_1 = {65 3a 5c 6a 6f 62 5c 67 68 30 73 74 5c 52 65 6c 65 61 73 65 5c 4c 6f 61 64 65 72 2e 70 64 62 } //01 00  e:\job\gh0st\Release\Loader.pdb
		$a_01_2 = {47 48 30 53 54 43 } //00 00  GH0STC
	condition:
		any of ($a_*)
