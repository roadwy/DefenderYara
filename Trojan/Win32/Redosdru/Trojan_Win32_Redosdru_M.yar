...
rule Trojan_Win32_Redosdru_M{
	...
	strings :
		...
		$a_01_1 = {50 43 52 61 74 20 55 70 64 61 74 65 } //01 00  PCRat Update
		$a_02_2 = {25 73 5c 64 6c 6c 63 61 63 68 65 5c 25 73 90 02 05 25 73 2e 64 6c 6c 90 00 } //01 00 
		$a_01_3 = {50 43 52 61 74 53 74 61 63 74 } //01 00  PCRatStact
		$a_00_4 = {25 73 5c 25 64 5f 72 65 73 2e 74 6d 70 } //00 00  %s\%d_res.tmp
	condition:
		any of ($a_*)
