...
rule Trojan_Win32_Peglegmorb_A{
	...
	strings :
		...
		$a_01_1 = {53 4f 4d 45 54 48 49 4e 47 20 48 41 53 20 4f 56 45 52 57 52 49 54 54 45 4e 20 59 4f 55 52 20 4d 42 52 21 } //02 00 
		...
		$a_01_4 = {50 45 47 47 4c 45 43 52 45 57 } //01 00 
		$a_01_5 = {28 40 43 55 4c 54 4f 46 52 41 5a 45 52 20 4f 4e 20 54 57 49 54 54 45 52 29 } //00 00 
