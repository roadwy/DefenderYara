...
rule Trojan_Win32_Rpdactaele_A{
	...
	strings :
		...
		$a_00_7 = {5d 04 00 00 12 be 03 80 5c 24 00 00 13 be 03 80 00 00 01 00 08 00 0e 00 ac 21 52 70 64 61 63 74 61 65 6c 65 2e 42 00 00 02 40 05 82 70 00 04 00 40 35 00 00 03 00 01 03 00 02 00 01 00 21 30 00 42 3f c0 e8 a5 00 00 00 00 02 00 01 00 4a 30 00 05 21 9c 10 39 00 00 00 00 02 00 01 00 20 30 00 0a 66 ed 57 48 00 00 00 00 67 16 00 00 d7 b6 } //e6 e7 
	condition:
		any of ($a_*)
