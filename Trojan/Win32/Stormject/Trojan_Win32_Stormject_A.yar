...
rule Trojan_Win32_Stormject_A{
	...
	strings :
		$a_01_0 = {53 74 6f 72 6d 20 64 64 6f 73 20 53 65 72 76 65 72 } //01 00  Storm ddos Server
		$a_01_1 = {57 65 6c 63 6f 6d 65 20 74 6f 20 75 73 65 20 73 74 6f 72 6d 20 64 64 6f 73 } //01 00  Welcome to use storm ddos
		$a_01_2 = {53 74 6f 72 6d 53 65 72 76 65 72 2e 64 6c 6c } //0a 00  StormServer.dll
