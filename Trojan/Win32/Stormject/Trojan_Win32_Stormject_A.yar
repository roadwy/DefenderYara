...
rule Trojan_Win32_Stormject_A{
	...
	strings :
		...
		$a_03_3 = {50 ff d3 ff d0 80 65 90 01 01 00 8b c8 c6 45 90 01 01 55 c6 45 90 01 01 70 c6 45 90 01 01 64 c6 45 90 01 01 61 c6 45 90 01 01 74 c6 45 90 01 01 65 90 00 } //10
	condition:
