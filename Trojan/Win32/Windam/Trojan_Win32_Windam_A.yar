...
rule Trojan_Win32_Windam_A{
	...
	strings :
		...
		$a_03_1 = {68 2f 75 00 00 8d 8d 90 01 02 ff ff 6a 00 c7 45 fc 01 00 00 00 51 c6 85 90 01 02 ff ff 00 e8 90 01 04 83 c4 0c 6a 00 6a 00 6a 00 6a 00 68 90 01 04 ff 15 90 01 04 8b f8 85 ff 75 90 00 } //1
	condition:
