...
rule Trojan_Win32_Stealer_CF_MTB{
	...
	strings :
		$a_03_0 = {81 fe 43 d0 bc 00 7d 08 57 57 ff 15 [0-04] 81 fe e5 e7 0c 09 7f 09 46 81 fe 7a c0 7c 70 7c df } //1
		$a_03_1 = {81 f9 16 76 00 00 75 05 e8 [0-04] 41 81 f9 e9 66 24 00 7c ea } //1
