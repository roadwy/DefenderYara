...
rule Trojan_Win32_Stealer_CC_MTB{
	...
	strings :
		$a_03_0 = {33 f9 8b 4d 90 02 04 d3 e8 c7 05 90 02 08 03 45 90 02 04 33 c7 8b f8 83 fa 90 02 04 75 2c 90 00 } //1
		$a_01_1 = {03 c3 33 ca 33 c8 89 4d } //1
		$a_03_2 = {81 fe 06 0c 00 00 75 05 e8 90 02 04 46 81 fe 35 6b 24 00 7c ea 90 00 } //1
