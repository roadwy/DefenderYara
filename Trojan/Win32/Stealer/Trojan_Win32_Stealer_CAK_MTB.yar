...
rule Trojan_Win32_Stealer_CAK_MTB{
	...
	strings :
		...
		$a_01_2 = {55 52 4c 4f 70 65 6e 42 6c 6f 63 6b 69 6e 67 53 74 72 65 61 6d 41 } //01 00  URLOpenBlockingStreamA
		...
		$a_01_5 = {51 75 65 72 79 50 65 72 66 6f 72 6d 61 6e 63 65 43 6f 75 6e 74 65 72 } //00 00  QueryPerformanceCounter
	condition:
		any of ($a_*)
