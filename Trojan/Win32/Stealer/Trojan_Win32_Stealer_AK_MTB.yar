...
rule Trojan_Win32_Stealer_AK_MTB_2{
	...
	strings :
		...
		$a_01_1 = {64 00 66 00 70 00 61 00 74 00 68 00 } //01 00  dfpath
		...
		$a_01_3 = {47 00 65 00 74 00 44 00 65 00 6c 00 65 00 67 00 61 00 74 00 65 00 46 00 6f 00 72 00 46 00 75 00 6e 00 63 00 74 00 69 00 6f 00 6e 00 50 00 6f 00 69 00 6e 00 74 00 65 00 72 00 } //01 00  GetDelegateForFunctionPointer
		$a_01_4 = {6c 00 69 00 63 00 65 00 6e 00 73 00 65 00 2e 00 6b 00 65 00 79 00 } //01 00  license.key
		$a_01_5 = {53 00 43 00 52 00 49 00 50 00 54 00 } //00 00  SCRIPT
	condition:
		any of ($a_*)
