...
rule Trojan_Win32_Stealer_MA_MTB{
	...
	strings :
		$a_03_0 = {8b 45 08 2b c7 89 45 08 8b 45 0c 8d 48 01 8a 10 40 84 d2 75 ?? 2b c1 8b d8 33 d2 8b c6 f7 f3 8b 45 0c 8d 0c 3e 8a 04 02 8b 55 08 32 04 0a 46 88 01 3b 75 10 72 } //1
