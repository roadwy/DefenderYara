...
rule Trojan_Win32_Disstl_AQ_MTB{
	...
	strings :
		...
		$a_01_1 = {43 72 79 70 74 55 6e 70 72 6f 74 65 63 74 4d 65 6d 6f 72 79 } //01 00  CryptUnprotectMemory
		$a_01_2 = {73 66 78 72 61 72 2e 65 78 65 } //01 00  sfxrar.exe
		$a_01_3 = {46 69 74 69 74 79 4e 75 6b 65 72 2d 76 31 2e 65 78 65 } //00 00  FitityNuker-v1.exe
	condition:
		any of ($a_*)
