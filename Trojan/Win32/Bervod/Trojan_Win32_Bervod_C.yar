...
rule Trojan_Win32_Bervod_C{
	...
	strings :
		...
		$a_01_1 = {49 62 68 6f 52 61 79 32 30 30 39 } //01 00 
		$a_00_2 = {25 73 5c 73 79 73 74 65 6d 5c 6d 73 74 73 63 2e 65 78 65 00 } //01 00 
		$a_01_3 = {63 6f 75 6e 74 3d 25 73 26 64 61 74 61 3d 25 73 26 63 6f 70 79 3d 25 73 26 69 6e 66 6f 3d 25 73 } //01 00 
		$a_00_4 = {55 00 73 00 65 00 72 00 2d 00 41 00 67 00 65 00 6e 00 74 00 3a 00 20 00 28 00 43 00 75 00 73 00 74 00 6f 00 6d 00 53 00 70 00 79 00 29 00 } //03 00 
