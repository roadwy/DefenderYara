...
rule Trojan_Win32_Chaflicon_C{
	...
	strings :
		...
		$a_00_1 = {5b 56 45 52 53 41 4f 4c 4f 41 44 45 52 5d } //01 00  [VERSAOLOADER]
		$a_00_2 = {5b 4c 49 4e 4b 43 4f 4e 54 41 44 4f } //01 00  [LINKCONTADO
		$a_00_3 = {5b 46 54 50 55 53 45 52 5d } //01 00  [FTPUSER]
		$a_00_4 = {5b 4c 49 4e 4b 45 58 45 5d } //00 00  [LINKEXE]
