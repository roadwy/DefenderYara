...
rule Trojan_Win32_Enfal_F{
	...
	strings :
		...
		$a_03_1 = {53 65 74 74 69 6e 67 73 5c 41 70 70 6c 69 63 61 74 69 6f 6e 20 44 61 74 61 5c 53 74 61 72 74 5c 90 02 0a 2e 65 78 65 90 00 } //1
		$a_03_2 = {2f 63 67 69 2d 62 69 6e 2f 90 02 06 2e 63 67 69 00 90 00 } //1
		$a_02_3 = {56 8b 44 24 08 6a 0a 5e 03 c1 8a 96 90 01 04 30 10 4e 79 90 01 01 41 3b 4c 24 0c 7c 90 00 } //1
		$a_02_4 = {8d 45 fc 50 68 3f 00 0f 00 8d 86 90 01 04 53 50 68 01 00 00 80 ff 90 00 } //1
	condition:
