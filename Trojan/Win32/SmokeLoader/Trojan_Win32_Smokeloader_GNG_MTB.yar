...
rule Trojan_Win32_Smokeloader_GNG_MTB{
	...
	strings :
		$a_03_0 = {8b d6 d3 ea 03 c6 89 45 90 01 01 c7 05 90 01 04 ee 3d ea f4 03 55 90 01 01 8b 45 90 01 01 31 45 90 01 01 33 55 90 01 01 81 3d 90 01 08 89 55 90 00 } //00 00 
	condition:
		any of ($a_*)
