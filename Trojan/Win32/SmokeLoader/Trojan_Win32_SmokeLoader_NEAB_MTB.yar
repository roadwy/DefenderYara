...
rule Trojan_Win32_SmokeLoader_NEAB_MTB{
	...
	strings :
		...
		$a_03_1 = {89 45 08 8b 45 ec 01 45 08 03 f3 33 75 08 33 75 0c 89 75 e0 8b 45 e0 29 45 fc 81 45 f4 90 01 04 ff 4d f0 8b 45 fc 0f 85 90 01 04 89 07 89 4f 04 90 00 } //10
	condition:
