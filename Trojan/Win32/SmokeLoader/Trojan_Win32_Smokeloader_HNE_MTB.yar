...
rule Trojan_Win32_Smokeloader_HNE_MTB{
	...
	strings :
		$a_03_0 = {ee 3d ea f4 90 03 01 01 89 8b 90 09 a0 00 90 02 a0 02 00 00 00 83 90 02 03 03 90 02 20 c1 e0 04 90 02 30 89 90 02 60 8b 90 02 30 c7 05 90 01 04 ee 3d ea f4 90 02 b0 c1 e0 04 90 02 40 d3 e8 90 02 30 8b 90 02 30 8b 90 02 30 90 17 02 01 01 0f e9 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_Win32_Smokeloader_HNE_MTB_2{
	...
	strings :
		...
		$a_03_3 = {29 45 f4 83 6d f4 90 09 04 00 83 45 f4 90 01 01 29 45 f4 83 6d f4 90 1b 01 90 00 } //1
		$a_03_4 = {8b d7 d3 ea 8d 04 3b 89 45 90 01 01 c7 05 90 00 } //1
	condition:
