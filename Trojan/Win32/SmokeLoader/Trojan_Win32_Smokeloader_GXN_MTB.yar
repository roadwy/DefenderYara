...
rule Trojan_Win32_Smokeloader_GXN_MTB{
	...
	strings :
		$a_03_0 = {8d 04 2a 89 44 24 90 01 01 8b 44 24 90 01 01 c1 e8 90 01 01 89 44 24 90 01 01 8b 4c 24 90 01 01 8b 44 24 90 01 01 33 4c 24 90 01 01 03 44 24 90 01 01 33 c1 c7 05 90 01 04 ee 3d ea f4 90 00 } //00 00 
	condition:
		any of ($a_*)
