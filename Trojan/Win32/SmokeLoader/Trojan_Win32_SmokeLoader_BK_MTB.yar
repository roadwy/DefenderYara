...
rule Trojan_Win32_SmokeLoader_BK_MTB{
	...
	strings :
		$a_03_0 = {c1 e8 05 03 45 ec 03 f2 33 c6 33 45 fc c7 05 90 02 04 19 36 6b ff 89 45 f4 8b 45 f4 29 45 08 83 65 0c 00 8b 45 dc 01 45 0c 2b 7d 0c ff 4d f0 8b 45 08 89 7d f4 0f 90 00 } //2
