...
rule Trojan_Win32_SmokeLoader_I_MTB{
	...
	strings :
		$a_03_0 = {8b c6 c1 e8 05 03 44 24 24 c7 05 ?? ?? ?? ?? 19 36 6b ff 33 c3 31 44 24 10 c7 05 ?? ?? ?? ?? ff ff ff ff 8b 44 24 10 29 44 24 14 81 c7 47 86 c8 61 4d 0f 85 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_Win32_SmokeLoader_I_MTB_2{
	...
	strings :
		...
		$a_03_1 = {31 7d fc 8b 45 fc 29 45 f4 81 c3 ?? ?? ?? ?? ff 4d e8 0f } //2
