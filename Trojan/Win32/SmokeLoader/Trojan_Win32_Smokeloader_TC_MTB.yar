...
rule Trojan_Win32_Smokeloader_TC_MTB{
	...
	strings :
		...
		$a_03_1 = {8d 4d fc 51 90 0a 51 00 c6 05 90 01 04 6c c6 05 90 01 04 63 c6 05 90 01 04 74 c6 05 90 01 04 74 c6 05 90 01 04 72 c6 05 90 01 04 72 ff 15 90 00 } //10
	condition:
