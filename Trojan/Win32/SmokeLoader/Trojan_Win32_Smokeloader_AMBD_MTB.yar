...
rule Trojan_Win32_Smokeloader_AMBD_MTB_2{
	...
	strings :
		$a_03_0 = {8b 44 24 40 01 44 24 24 8b 44 24 14 33 44 24 24 89 44 24 24 8b 54 24 24 89 54 24 24 8b 44 24 24 29 44 24 1c 8b 4c 24 1c 8b 74 24 18 8b c1 c1 e0 04 03 44 24 48 03 f1 81 3d ?? ?? ?? ?? be 01 00 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
