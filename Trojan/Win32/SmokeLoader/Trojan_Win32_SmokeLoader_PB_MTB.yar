...
rule Trojan_Win32_SmokeLoader_PB_MTB{
	...
	strings :
		$a_00_0 = {40 62 61 6e 67 50 72 65 63 69 73 69 6f 6e 40 34 } //01 00 
		$a_00_1 = {40 70 6c 75 73 54 6f 6b 65 6e 41 66 74 65 72 40 34 } //01 00 
		$a_00_2 = {40 79 75 72 69 69 40 34 } //01 00 
