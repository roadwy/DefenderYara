...
rule Trojan_Win32_SmokeLoader_PB_MTB{
	...
	strings :
		...
		$a_02_3 = {6a 02 59 cd 29 a3 90 01 04 89 0d 90 01 04 89 15 90 01 04 89 1d 90 01 04 89 35 90 01 04 89 3d 90 01 04 66 8c 15 90 01 04 66 8c 0d 90 01 04 66 8c 1d 90 01 04 66 8c 05 90 01 04 66 8c 25 90 01 04 66 8c 2d 90 00 } //1
		$a_02_4 = {6a 00 6a 00 6a 00 6a 00 ff 15 90 01 04 6a 00 6a 00 8d 44 24 90 01 01 50 6a 00 6a 00 6a 00 ff 15 90 00 } //1
	condition:
