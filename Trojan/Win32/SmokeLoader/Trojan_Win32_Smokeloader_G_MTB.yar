...
rule Trojan_Win32_Smokeloader_G_MTB{
	...
	strings :
		$a_01_0 = {01 45 fc 8b 45 f4 8b 4d f8 03 c2 d3 ea 89 45 f0 03 55 d4 8b 45 f0 31 45 fc 31 55 fc } //1
	condition:
		((#a_01_0  & 1)*1) >=1
...
rule Trojan_Win32_Smokeloader_G_MTB_2{
	...
	strings :
		...
		$a_80_2 = {63 75 6a 61 6c 75 6e 6f 64 69 67 } //cujalunodig  1
		$a_80_3 = {46 65 79 6f 63 69 78 75 67 6f 77 61 } //Feyocixugowa  1
		$a_80_4 = {79 75 6d 65 6a 69 6e 65 66 } //yumejinef  1
