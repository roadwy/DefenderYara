...
rule Trojan_Win32_SmokeLoader_MA_MTB_2{
	...
	strings :
		$a_03_0 = {8b 7d f4 8b c7 c1 e0 04 03 45 e0 89 45 f8 8b 45 f4 03 45 f0 89 45 0c ff 75 0c 83 0d ?? ?? ?? ?? ff 8b d7 8d 45 f8 c1 ea 05 03 55 e8 50 c7 05 } //5
		$a_03_1 = {6a 73 58 6a 6d 66 a3 ?? ?? ?? ?? 58 6a 67 66 a3 ?? ?? ?? ?? 58 6a 69 66 a3 ?? ?? ?? ?? 58 6a 6c 66 a3 ?? ?? ?? ?? 58 6a 32 66 a3 ?? ?? ?? ?? 58 } //5
	condition:
