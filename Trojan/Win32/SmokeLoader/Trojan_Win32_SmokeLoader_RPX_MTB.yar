...
rule Trojan_Win32_SmokeLoader_RPX_MTB{
	...
	strings :
		$a_01_0 = {8b 45 fc 33 c6 89 45 fc 2b f8 8b 45 cc 29 45 f8 83 6d e0 01 0f 85 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win32_SmokeLoader_RPX_MTB_6{
	...
	strings :
		$a_01_0 = {6a 00 ff d6 ff d7 4b 75 f7 } //01 00 
		$a_01_1 = {56 6a 00 6a 00 6a 00 6a 00 6a 00 6a 00 6a 00 6a 00 6a 00 6a 00 ff d3 6a 30 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win32_SmokeLoader_RPX_MTB_7{
	...
	strings :
		$a_01_0 = {31 45 f0 8b 45 f8 33 45 f0 2b f0 89 45 f8 8b c6 c1 e0 04 89 45 fc 8b 45 d8 01 45 fc 8b 4d f4 8d 04 33 89 45 e8 8b c6 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win32_SmokeLoader_RPX_MTB_8{
	...
	strings :
		$a_01_0 = {8b 45 f0 83 45 f8 64 29 45 f8 83 6d f8 64 8b 55 f8 c1 e2 04 89 55 fc 8b 45 e4 01 45 fc 8b 4d f8 8b f1 c1 ee 05 03 75 e0 } //00 00 
	condition:
		any of ($a_*)
