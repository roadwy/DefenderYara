...
rule Trojan_Win32_SmokeLoader_NEAD_MTB{
	...
	strings :
		$a_03_0 = {2b f0 89 44 24 90 01 01 8b c6 c1 e0 90 01 01 89 44 24 10 8b 44 24 28 01 44 24 10 8b 44 24 18 8b d6 c1 ea 90 01 01 03 d5 03 c6 31 44 24 90 00 } //10
