...
rule Trojan_Win32_Winnti_E_dha{
	...
	strings :
		$a_03_0 = {62 61 73 5f 5f 2e 66 6f 6e [0-05] 66 6f 6e 74 73 5c [0-10] 5c 5c 2e 5c 50 68 79 73 69 63 61 6c 44 72 69 76 65 25 64 [0-10] 53 43 53 49 44 49 53 4b [0-10] 5c 5c 2e 5c 53 63 73 69 25 64 3a } //4
