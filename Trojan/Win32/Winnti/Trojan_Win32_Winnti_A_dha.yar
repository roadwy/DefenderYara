...
rule Trojan_Win32_Winnti_A_dha{
	...
	strings :
		...
		$a_00_2 = {6e 65 74 73 76 63 73 } //01 00  netsvcs
		$a_00_3 = {53 65 74 41 70 70 49 6e 69 74 44 6c 6c 44 61 74 61 49 6e 66 } //01 00  SetAppInitDllDataInf
		$a_00_4 = {5c 73 76 63 68 6f 73 74 2e 65 78 65 } //00 00  \svchost.exe
	condition:
		any of ($a_*)
