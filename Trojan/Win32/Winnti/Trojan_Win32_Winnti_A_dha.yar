...
rule Trojan_Win32_Winnti_A_dha{
	...
	strings :
		$a_02_0 = {8a 11 3a 10 75 90 01 01 84 d2 74 90 01 01 8a 51 01 3a 50 01 75 90 01 01 83 c1 02 83 c0 02 84 d2 75 90 01 01 33 c0 eb 90 01 01 1b c0 83 d8 ff 85 c0 74 90 01 01 43 83 c6 04 90 00 } //1
