...
rule Trojan_Win32_DxmStrt_J_ibt{
	...
	strings :
		...
		$a_02_3 = {2b 43 03 28 29 00 00 0a 80 07 00 00 04 7e 07 00 00 04 8e b7 16 fe 02 0b 07 2c 12 72 90 01 01 00 00 70 28 31 00 00 0a 28 32 00 00 0a 00 2b 16 00 73 33 00 00 0a 0a 06 02 6f 34 00 00 0a 00 06 28 35 00 00 0a 26 00 00 17 0b 07 2d b8 00 2a 90 00 } //1
	condition:
