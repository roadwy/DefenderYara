...
rule Trojan_Win32_Conhook_C{
	...
	strings :
		...
		$a_02_10 = {4c 6f 63 61 6c 90 01 01 56 4d 50 72 6f 74 65 63 74 69 6f 6e 4d 75 74 65 78 90 00 } //1
		$a_02_11 = {4c 6f 63 61 6c 90 01 01 56 4d 4d 61 69 6e 4d 75 74 65 78 90 00 } //1
