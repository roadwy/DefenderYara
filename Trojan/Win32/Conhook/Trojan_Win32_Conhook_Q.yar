...
rule Trojan_Win32_Conhook_Q{
	...
	strings :
		$a_02_0 = {2f 72 65 64 69 72 65 63 74 2f [0-03] 2e 70 68 70 } //100
		$a_02_1 = {73 6f 66 74 77 61 72 65 5c 6d 69 63 72 6f 73 6f 66 74 5c (6a 75 61 6e|6d 73 20 6a 75 61 6e) } //50
