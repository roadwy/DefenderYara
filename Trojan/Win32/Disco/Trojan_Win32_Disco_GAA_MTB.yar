...
rule Trojan_Win32_Disco_GAA_MTB{
	...
	strings :
		$a_03_0 = {8b 75 e8 8b 4d dc b8 90 01 04 8b 7d d8 2b cf ff 85 90 01 04 83 85 90 01 04 18 f7 e9 c1 fa 02 8b c2 c1 e8 1f 03 c2 39 85 ac fe ff ff 8b 85 90 00 } //10
