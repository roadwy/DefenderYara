...
rule Trojan_Win32_Dabvegi_E{
	...
	strings :
		$a_00_0 = {46 69 6e 64 4e 65 78 74 55 72 6c 43 61 63 68 65 45 6e 74 72 79 41 } //0a 00  FindNextUrlCacheEntryA
		$a_00_1 = {55 52 4c 53 74 61 72 74 73 57 69 74 68 } //0a 00  URLStartsWith
		...
		$a_00_3 = {2d 00 5b 00 38 00 38 00 5d 00 2d 00 } //00 00  -[88]-
	condition:
		any of ($a_*)
