...
rule Trojan_Win32_Dabvegi_A{
	...
	strings :
		$a_00_0 = {2d 00 5b 00 38 00 38 00 5d 00 2d 00 } //01 00 
		$a_01_1 = {21 00 6e 00 75 00 6b 00 6b 00 68 00 6e 00 62 00 41 00 } //01 00 
		$a_01_2 = {43 72 54 78 74 00 } //01 00 
		$a_01_3 = {08 00 00 00 2e 00 62 00 61 00 74 00 00 00 } //01 00 
		$a_01_4 = {54 00 4d 00 50 00 45 00 55 00 3d 00 } //01 00 
		$a_01_5 = {67 65 72 61 6c } //01 00 
		$a_01_6 = {50 00 49 00 4e 00 20 00 31 00 } //01 00 
		$a_00_7 = {70 61 73 73 63 68 61 72 } //01 00 
		$a_01_8 = {6f 00 63 00 77 00 6f 00 6d 00 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Dabvegi_A_2{
	...
	strings :
		$a_00_0 = {43 3a 5c 41 72 71 75 69 76 6f 73 20 64 65 20 70 72 6f 67 72 61 6d 61 73 5c 4d 69 63 72 6f 73 6f 66 74 20 56 69 73 75 61 6c 20 53 74 75 64 69 6f 5c 56 42 39 38 5c 56 42 36 2e 4f 4c 42 } //01 00 
		$a_01_1 = {43 72 54 78 74 00 } //01 00 
		...
		$a_01_3 = {2d 00 5b 00 38 00 38 00 5d 00 2d 00 3b 00 } //01 00 
		$a_01_4 = {2d 00 5b 00 37 00 37 00 5d 00 2d 00 3b 00 } //01 00 
		$a_01_5 = {2d 00 5b 00 37 00 36 00 5d 00 2d 00 3b 00 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Dabvegi_A_3{
	...
	strings :
		...
		$a_00_2 = {2d 00 5b 00 38 00 38 00 5d 00 2d 00 } //02 00 
...
rule Trojan_Win32_Dabvegi_A_4{
	...
	strings :
		$a_01_0 = {45 6e 63 72 79 70 74 69 6f 6e 46 69 6c 65 } //0a 00 
		$a_01_1 = {52 65 6d 6f 76 65 43 6f 6e 63 6f 72 72 65 6e 74 65 73 } //0a 00 
		$a_01_2 = {2e 00 62 00 61 00 74 00 } //01 00 
		$a_01_3 = {2d 00 5b 00 38 00 38 00 5d 00 2d 00 } //01 00 
		$a_01_4 = {21 00 6e 00 75 00 6b 00 6b 00 68 00 6e 00 62 00 41 00 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Dabvegi_A_5{
	...
	strings :
		$a_01_0 = {46 69 6e 64 4e 65 78 74 55 72 6c 43 61 63 68 65 45 6e 74 72 79 41 } //0a 00 
		$a_01_1 = {55 52 4c 53 74 61 72 74 73 57 69 74 68 } //0a 00 
		$a_01_2 = {2e 00 62 00 61 00 74 00 } //01 00 
		$a_01_3 = {2d 00 5b 00 38 00 38 00 5d 00 2d 00 } //01 00 
		$a_01_4 = {21 00 6e 00 75 00 6b 00 6b 00 68 00 6e 00 62 00 41 00 } //00 00 
	condition:
