...
rule Trojan_Win32_Mobsularch_A{
	...
	strings :
		...
		$a_01_4 = {2f 00 63 00 75 00 73 00 74 00 6f 00 6d 00 65 00 72 00 73 00 2f 00 61 00 70 00 70 00 5f 00 6c 00 61 00 75 00 6e 00 63 00 68 00 2e 00 70 00 68 00 70 00 3f 00 69 00 64 00 5f 00 70 00 72 00 6f 00 6a 00 65 00 63 00 74 00 3d 00 } //00 00  /customers/app_launch.php?id_project=
	condition:
		any of ($a_*)
