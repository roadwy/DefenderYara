...
rule Trojan_Win32_Delfobfus_C{
	...
	strings :
		$a_03_0 = {40 00 02 00 01 00 90 02 20 e8 90 01 02 ff ff 84 c0 0f 84 90 01 02 00 00 90 02 10 a1 90 01 02 40 00 50 a1 90 01 02 40 00 50 ff 15 90 00 } //10
		$a_03_1 = {6a 04 68 00 30 00 00 a1 90 01 02 40 00 8b 40 50 50 a1 90 01 02 40 00 8b 40 34 50 a1 90 01 02 40 00 50 ff 15 90 01 02 40 00 a3 90 01 02 40 00 68 90 01 02 40 00 90 00 } //10
