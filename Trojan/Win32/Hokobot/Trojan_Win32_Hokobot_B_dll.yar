...
rule Trojan_Win32_Hokobot_B_dll{
	...
	strings :
		$a_01_0 = {5c 50 72 6f 66 69 6c 65 72 2d 50 5c 53 6d 61 72 74 53 65 6e 64 65 72 5c 77 6e 68 65 6c 70 } //01 00 
		...
		$a_01_2 = {46 64 6f 77 6e } //01 00 
		$a_01_3 = {49 6e 65 74 52 65 61 64 46 } //01 00 
		$a_01_4 = {50 61 74 68 50 72 6f 63 65 73 73 } //00 00 
