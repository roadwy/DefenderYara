...
rule Trojan_Win32_Zusy_RD_MTB_4{
	...
	strings :
		$a_03_0 = {0f b6 e8 0f b6 44 2c 30 88 44 1c 30 88 4c 2c 30 0f b6 44 1c 30 03 c2 0f b6 c0 0f b6 44 04 30 32 87 90 01 04 88 44 3c 1c 47 83 ff 14 72 c1 90 00 } //00 00 
	condition:
		any of ($a_*)
