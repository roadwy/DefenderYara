...
rule Trojan_Win32_Zusy_NZ_MTB{
	...
	strings :
		$a_03_0 = {a3 60 c6 40 00 a1 90 01 04 a3 90 01 04 33 c0 a3 90 01 04 33 c0 a3 90 01 04 e8 90 01 04 ba 94 b0 40 00 8b c3 e8 b1 e8 ff ff 90 00 } //5
	condition:
		((#a_03_0  & 1)*5) >=5
...
rule Trojan_Win32_Zusy_NZ_MTB_2{
	...
	strings :
		$a_03_0 = {33 cc 4c b3 0a 81 aa 90 01 04 45 a8 93 fb 0c 67 13 4b 90 01 01 7e f3 ff b3 9f bb b9 b5 90 00 } //5
...
rule Trojan_Win32_Zusy_NZ_MTB_3{
	...
	strings :
		$a_03_0 = {e8 6f fd ff ff 8b 4c 24 90 01 01 8b 54 24 08 85 c9 88 48 14 89 90 01 05 75 09 6a fd ff 15 2c 32 90 00 } //5
