...
rule Trojan_Win32_Zusy_CA_MTB{
	...
	strings :
		$a_01_0 = {46 73 6f 69 61 73 67 69 6f 73 67 69 6f 73 61 67 69 6a 73 64 } //02 00  Fsoiasgiosgiosagijsd
		$a_01_1 = {4a 69 6f 6a 61 65 6f 69 67 6a 61 69 65 67 6a 61 64 } //02 00  Jiojaeoigjaiegjad
		$a_01_2 = {4d 69 6a 66 67 69 65 67 66 61 68 73 75 67 68 73 61 64 75 } //02 00  Mijfgiegfahsughsadu
		$a_01_3 = {4f 49 6f 69 6a 73 67 39 38 30 73 65 67 69 6f 73 67 68 6a } //01 00  OIoijsg980segiosghj
