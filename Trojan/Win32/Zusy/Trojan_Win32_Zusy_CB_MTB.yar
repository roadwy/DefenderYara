...
rule Trojan_Win32_Zusy_CB_MTB_2{
	...
	strings :
		$a_01_0 = {4f 49 6f 61 67 38 39 77 67 6f 69 65 67 68 61 73 65 67 69 68 } //02 00  OIoag89wgoieghasegih
		$a_01_1 = {4f 49 6f 69 61 6a 66 67 39 38 61 6a 67 6f 69 61 6a 65 67 65 } //02 00  OIoiajfg98ajgoiajege
		$a_01_2 = {56 66 67 6f 69 61 65 66 67 69 6f 75 61 65 6f 67 69 61 68 65 6a 67 } //02 00  Vfgoiaefgiouaeogiahejg
		$a_01_3 = {62 76 41 45 47 4f 69 6f 61 68 67 69 61 73 68 65 67 } //01 00  bvAEGOioahgiasheg
