...
rule Trojan_Win32_Zusy_AA_MTB_2{
	...
	strings :
		$a_01_0 = {59 54 56 55 42 56 54 55 2e 44 4c 4c } //01 00 
		$a_01_1 = {48 63 66 79 76 67 4f 68 62 76 67 } //01 00 
		$a_01_2 = {59 79 76 67 4b 62 75 76 67 79 } //01 00 
		$a_01_3 = {57 78 64 74 63 66 76 67 4f 6e 6a 6b 68 62 6a 67 } //00 00 
	condition:
		any of ($a_*)
