...
rule Trojan_Win32_Zusy_GMH_MTB{
	...
	strings :
		$a_03_0 = {8b c2 83 e0 07 b9 90 01 04 2b c8 b0 01 d2 e0 8a 0e 0a c8 88 0e 8b 74 24 20 8b 44 24 10 42 3b d0 0f 82 90 01 04 8b 44 24 14 47 3b f8 0f 82 90 00 } //10
