...
rule Trojan_Win32_Zusy_GNS_MTB{
	...
	strings :
		$a_03_0 = {89 f7 89 f0 31 db 83 c7 58 81 2e 90 01 04 83 c6 04 66 ba 90 01 02 39 fe 7c 90 01 01 66 be 90 01 02 bb 90 01 04 53 50 90 00 } //10
	condition:
		((#a_03_0  & 1)*10) >=10
...
rule Trojan_Win32_Zusy_GNS_MTB_2{
	...
	strings :
		$a_03_0 = {f7 f3 8d 41 f8 01 55 fc 33 d2 f7 f3 8b c1 03 f2 33 d2 f7 f3 8d 41 08 83 c1 20 03 fa 33 d2 f7 f3 01 55 f8 ff 4d f4 90 01 02 8b 45 f8 8b 4d f0 03 c7 03 c6 01 45 fc 83 c1 65 89 4d f0 81 f9 10 50 06 00 90 00 } //10
