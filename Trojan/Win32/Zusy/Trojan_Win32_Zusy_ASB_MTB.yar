...
rule Trojan_Win32_Zusy_ASB_MTB{
	...
	strings :
		...
		$a_01_2 = {43 3a 5c 55 73 65 72 73 5c 50 75 62 6c 69 63 5c 64 77 77 6d 6d 2e 74 78 74 } //01 00  C:\Users\Public\dwwmm.txt
		$a_01_3 = {2f 6d 31 2e 74 78 74 } //00 00  /m1.txt
	condition:
		any of ($a_*)
