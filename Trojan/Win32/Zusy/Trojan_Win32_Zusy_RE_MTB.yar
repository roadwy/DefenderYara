...
rule Trojan_Win32_Zusy_RE_MTB{
	...
	strings :
		$a_01_0 = {33 d2 8b c1 6a 37 5e f7 f6 83 c2 32 66 31 54 4d ac 41 83 f9 17 7c e9 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Zusy_RE_MTB_3{
	meta:
		description = "Trojan:Win32/Zusy.RE!MTB,SIGNATURE_TYPE_PEHSTR_EXT,02 00 02 00 02 00 00 01 00 "
		
	strings :
		$a_01_0 = {8d 04 3a 8b 18 89 ce 31 de 89 30 8d 47 04 89 c7 3b 7d fc 72 eb } //01 00 
		$a_01_1 = {67 77 59 39 62 4d 55 63 63 67 67 67 68 51 46 34 6a 75 42 4b 51 37 49 6f 75 47 6b 79 50 52 70 65 69 70 35 } //00 00  gwY9bMUccggghQF4juBKQ7IouGkyPRpeip5
	condition:
		any of ($a_*)
