...
rule Trojan_Win32_Zusy_BY_MTB{
	...
	strings :
		$a_01_0 = {4b 6a 69 61 6a 66 67 69 61 65 67 68 64 61 69 68 } //03 00  Kjiajfgiaeghdaih
		$a_01_1 = {4e 61 65 75 69 67 6f 68 61 65 67 69 68 64 64 } //01 00  Naeuigohaegihdd
