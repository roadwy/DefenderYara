...
rule Trojan_Win32_Zusy_GND_MTB{
	...
	strings :
		$a_03_0 = {9c 2d 45 00 a3 90 01 04 c7 05 90 01 04 02 2e 45 00 c7 05 90 01 04 42 2d 45 00 c7 05 90 01 04 ea 2d 45 00 90 00 } //10
		$a_03_1 = {fc 29 45 00 a3 90 01 04 c7 05 90 01 04 62 2a 45 00 c7 05 90 01 04 a2 29 45 00 c7 05 90 01 04 4a 2a 45 00 90 00 } //10
