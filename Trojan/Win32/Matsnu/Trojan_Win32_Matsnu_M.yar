...
rule Trojan_Win32_Matsnu_M{
	...
	strings :
		$a_01_0 = {25 73 7e 25 30 38 78 2d 25 30 34 78 2d 25 30 34 78 2e 70 72 65 } //01 00 
		$a_01_1 = {73 65 6e 64 65 64 3d 25 75 26 65 72 72 6f 72 3d 25 75 26 65 78 65 72 72 3d 25 75 26 } //01 00 
