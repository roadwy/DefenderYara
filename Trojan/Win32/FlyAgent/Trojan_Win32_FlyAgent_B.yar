...
rule Trojan_Win32_FlyAgent_B{
	...
	strings :
		...
		$a_03_2 = {14 00 00 00 50 ff 75 f4 e8 90 01 04 83 c4 08 83 f8 00 b8 00 00 00 00 0f 94 c0 89 45 f0 8b 5d f4 85 db 74 09 53 e8 90 01 04 83 c4 04 83 7d f0 00 0f 84 90 00 } //1
	condition:
