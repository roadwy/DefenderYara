...
rule Trojan_Win32_FlyAgent_GMF_MTB{
	...
	strings :
		...
		$a_01_1 = {5c 57 69 6e 64 6f 77 73 5c 43 75 72 72 65 6e 74 56 65 72 73 69 6f 6e 5c 52 75 6e 5c 33 36 30 73 6f 66 65 } //01 00 
		$a_01_2 = {40 4d 69 63 72 6f 73 6f 66 74 5c 43 6f 6e 66 69 67 2e 69 6e 69 } //00 00 
	condition:
		any of ($a_*)
