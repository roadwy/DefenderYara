...
rule Trojan_Win32_Chksyn_F{
	...
	strings :
		...
		$a_00_1 = {4d 69 63 72 6f 73 6f 66 74 20 57 69 6e 64 6f 77 73 20 45 78 70 6c 6f 72 65 72 22 20 6d 6f 64 65 20 3d 20 45 4e 41 42 4c 45 } //01 00 
		$a_00_2 = {53 65 72 76 69 63 65 22 20 6d 6f 64 65 20 3d 20 45 4e 41 42 4c 45 } //01 00 
