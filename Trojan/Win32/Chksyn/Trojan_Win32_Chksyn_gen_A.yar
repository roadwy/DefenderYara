...
rule Trojan_Win32_Chksyn_gen_A{
	...
	strings :
		...
		$a_02_1 = {50 8b 4d f0 83 c1 04 51 e8 90 01 01 23 00 00 83 c4 08 85 c0 74 07 c7 45 f4 34 00 00 c0 68 90 01 04 6a 00 90 00 } //1
		$a_03_2 = {74 4e 68 00 01 00 00 ff 15 90 01 04 50 ff 15 90 01 04 b8 90 01 04 99 52 50 68 76 01 00 00 e8 90 01 02 ff ff 85 c0 74 17 90 00 } //1
	condition:
...
rule Trojan_Win32_Chksyn_gen_A_2{
	...
	strings :
		...
		$a_03_2 = {8b 70 1c ad 8b 40 08 90 03 01 01 5e e9 90 00 } //1
		$a_01_3 = {8b 34 9a 5a 5b } //1
		$a_01_4 = {8b 04 9a 5a 5b } //1
		$a_03_5 = {8b 40 30 83 b8 b0 00 00 00 02 0f 90 03 01 01 84 85 90 00 } //1
