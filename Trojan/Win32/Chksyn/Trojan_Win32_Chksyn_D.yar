...
rule Trojan_Win32_Chksyn_D{
	...
	strings :
		$a_03_0 = {74 3c ba 6c 00 00 00 8b 85 90 01 04 66 89 50 04 b9 6f 00 00 00 8b 95 90 01 04 66 89 4a 08 b8 73 00 00 00 8b 8d 90 01 04 66 89 41 0c ba 74 00 00 00 90 00 } //1
		$a_01_1 = {8a 11 88 10 8b 45 08 83 c0 01 89 45 08 8b 4d 0c 83 c1 01 89 4d 0c 8b 55 10 83 ea 01 89 55 10 75 d9 } //1
		$a_03_2 = {0f be 48 ff 83 f9 3a 75 27 8d 55 f4 52 8b 45 fc 83 c0 01 50 e8 90 01 04 85 c0 75 13 90 00 } //1
