...
rule Trojan_Win32_Dender_D{
	...
	strings :
		...
		$a_00_2 = {62 00 79 00 70 00 61 00 73 00 73 00 2d 00 74 00 61 00 6d 00 70 00 65 00 72 00 2d 00 70 00 72 00 6f 00 74 00 65 00 63 00 74 00 69 00 6f 00 6e 00 } //00 00  bypass-tamper-protection
	condition:
		any of ($a_*)
