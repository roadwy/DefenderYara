...
rule Trojan_Win32_Miemoes_A{
	...
	strings :
		...
		$a_01_1 = {6d 69 65 6b 69 65 6d 6f 65 73 } //01 00 
		$a_01_2 = {72 64 73 2e 79 61 68 6f 6f } //01 00 
		$a_01_3 = {66 6f 72 6d 61 74 3d 72 73 73 } //01 00 
		$a_01_4 = {69 63 71 00 79 69 6d 67 } //00 00 
	condition:
		any of ($a_*)
