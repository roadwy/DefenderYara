...
rule Trojan_Win32_Deepdo_2{
	...
	strings :
		...
		$a_02_3 = {6f 70 65 6e 00 00 00 00 72 65 67 73 76 72 33 32 2e 65 78 65 00 00 00 00 20 22 25 73 25 73 22 20 2f 73 00 00 72 65 67 25 64 00 00 00 25 73 25 73 00 00 00 00 25 73 5c [0-10] 2e 74 6d 70 00 00 00 00 66 69 6c 65 25 64 00 00 75 72 6c 25 64 00 00 00 76 65 72 25 64 00 00 00 6d 61 69 6e } //10
	condition:
