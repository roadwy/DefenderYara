...
rule Trojan_Win32_Rootkit_F{
	...
	strings :
		$a_00_0 = {54 50 4f 43 20 52 6f 6f 74 6b 69 74 } //01 00  TPOC Rootkit
...
rule Trojan_Win32_Rootkit_F_2{
	...
	strings :
		$a_01_0 = {6e 74 6f 73 6b 72 6e 6c 2e 65 78 65 } //02 00  ntoskrnl.exe
		$a_01_1 = {2e 78 64 61 74 61 } //01 00  .xdata
