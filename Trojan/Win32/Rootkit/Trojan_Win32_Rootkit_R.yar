...
rule Trojan_Win32_Rootkit_R{
	...
	strings :
		...
		$a_02_7 = {8b c8 03 0d 90 01 02 01 00 83 ca ff e8 90 01 02 ff ff 3d 5b f0 6a c7 74 15 3d 45 30 34 01 74 0e 3d 45 d0 fa 58 74 07 5d ff 25 14 09 01 00 e8 90 01 02 ff ff b8 34 00 00 c0 5d c2 2c 00 90 00 } //1
	condition:
