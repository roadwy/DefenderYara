...
rule Trojan_Win32_Duppatch_A{
	...
	strings :
		...
		$a_03_2 = {74 aa 8b 3d ?? ?? 40 00 8b 0f 83 c7 04 8b d3 51 52 8b 07 3b 05 ?? ?? 40 00 0f 85 ce 00 00 00 e8 ?? ?? 00 00 8b d0 33 c0 66 8b 47 06 6a 02 } //1
		$a_03_3 = {8b 7f 04 57 68 ?? ?? 40 00 e8 ?? ?? 00 00 83 f8 01 74 1d bf ?? ?? 40 00 b8 02 00 00 00 8b 7f 04 57 68 ?? ?? 40 00 e8 ?? ?? 00 00 83 f8 01 75 36 } //1
	condition:
