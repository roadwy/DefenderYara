...
rule Trojan_Win32_Esendi_D{
	...
	strings :
		$a_03_0 = {56 33 f6 46 eb 29 8b 0c b5 ?? ?? ?? ?? 8d 04 b5 ?? ?? ?? ?? 50 ff 30 8d 82 ?? ?? ?? ?? 51 50 ff 15 ?? ?? ?? ?? 8b 14 b5 ?? ?? ?? ?? 8d 76 03 } //20
		$a_03_1 = {80 fb 21 8b c2 0f 45 c1 42 8b c8 8a 1a 84 db ?? ?? 85 c9 ?? ?? 8d 41 01 } //10
