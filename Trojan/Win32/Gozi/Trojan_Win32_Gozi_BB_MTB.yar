...
rule Trojan_Win32_Gozi_BB_MTB{
	...
	strings :
		...
		$a_81_1 = {44 72 69 76 65 2e 64 6c 6c } //01 00  Drive.dll
		$a_81_2 = {43 6c 6f 63 6b 63 6f 6e 64 69 74 69 6f 6e } //01 00  Clockcondition
		$a_81_3 = {44 6f 67 77 68 65 6e } //01 00  Dogwhen
		$a_81_4 = {53 69 6e 67 } //01 00  Sing
		$a_81_5 = {57 68 6f 6c 65 67 72 61 79 } //00 00  Wholegray
	condition:
		any of ($a_*)
