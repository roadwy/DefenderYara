...
rule Trojan_Win32_Gozi_GM_MTB{
	...
	strings :
		$a_02_0 = {66 2b d0 0f b7 c2 8b 55 90 01 01 89 45 90 01 01 0f b7 75 90 01 01 8d 42 90 01 01 02 c8 8d 04 b7 88 0d 90 01 04 03 c6 a3 90 01 04 0f b6 c1 2b c2 83 c0 90 01 01 89 45 90 01 01 ff 15 90 00 } //10
	condition:
		((#a_02_0  & 1)*10) >=10
...
rule Trojan_Win32_Gozi_GM_MTB_2{
	...
	strings :
		...
		$a_02_1 = {83 e9 21 89 0d 90 01 04 8b 0d 90 01 04 83 c1 90 01 01 a1 90 01 04 a3 90 01 04 b8 90 01 04 b8 90 01 04 a1 90 02 c8 31 0d 90 00 } //1
	condition:
