...
rule Trojan_Win32_Gozi_MA_MTB{
	...
	strings :
		$a_03_0 = {c1 ea 10 88 14 08 8b d3 ff 05 90 01 04 8b 4e 64 8b 86 88 00 00 00 c1 ea 08 88 14 01 ff 46 64 8b 0d 90 01 04 8b 81 08 01 00 00 35 90 01 04 01 05 90 01 04 8b 89 88 00 00 00 8b 46 64 88 1c 01 ff 46 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_Win32_Gozi_MA_MTB_2{
	...
	strings :
		$a_03_0 = {8b 75 c8 01 f1 81 e1 90 01 04 8b 75 ec 8b 5d cc 8a 1c 1e 8b 75 e4 32 1c 0e 8b 4d e8 8b 75 cc 88 1c 31 8b 4d f0 39 cf 8b 4d c4 89 4d dc 89 7d d8 89 55 d4 0f 85 90 00 } //5
