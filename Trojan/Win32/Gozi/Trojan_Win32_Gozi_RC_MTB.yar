...
rule Trojan_Win32_Gozi_RC_MTB_6{
	...
	strings :
		$a_01_0 = {6f 4c 73 7a 6c 47 2e 64 6c 6c } //01 00  oLszlG.dll
		$a_01_1 = {53 38 44 53 31 51 35 78 6e 56 49 63 62 61 } //01 00  S8DS1Q5xnVIcba
		$a_01_2 = {55 79 4d 39 6b 6a 59 51 55 38 35 75 6d 32 33 67 } //01 00  UyM9kjYQU85um23g
		$a_01_3 = {56 75 4b 64 63 55 4a 38 68 48 51 4f 67 68 61 } //01 00  VuKdcUJ8hHQOgha
		$a_01_4 = {65 31 77 46 67 33 47 35 4e 61 71 4f } //01 00  e1wFg3G5NaqO
		$a_01_5 = {75 62 4a 73 45 34 44 47 6e 49 32 7a 58 65 } //01 00  ubJsE4DGnI2zXe
		$a_01_6 = {79 74 76 34 4c 36 75 4d 37 68 42 51 47 42 45 6d } //00 00  ytv4L6uM7hBQGBEm
	condition:
		any of ($a_*)
