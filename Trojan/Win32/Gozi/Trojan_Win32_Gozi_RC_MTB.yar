...
rule Trojan_Win32_Gozi_RC_MTB_5{
	...
	strings :
		$a_03_0 = {0f b7 d1 8b c8 81 f1 90 01 04 57 8b 3d 90 01 04 8b 0c 39 03 cf 0f b7 59 90 01 01 0f b7 71 90 01 01 43 6b db 28 03 f1 8b ce 8b f0 81 f6 90 01 04 03 cb 03 f1 35 90 01 04 89 55 90 01 01 89 45 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
