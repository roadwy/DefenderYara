...
rule Trojan_Win32_Gozi_BA_MTB{
	...
	strings :
		$a_02_0 = {b8 04 00 00 00 6b c8 12 81 b9 90 01 04 b5 18 00 00 75 42 ba 04 00 00 00 c1 e2 02 90 02 30 81 e9 1d 9b 00 00 0f b6 15 90 01 04 2b ca 03 0d 90 00 } //1
		$a_02_1 = {b9 04 00 00 00 6b d1 09 b8 04 00 00 00 c1 e0 00 90 02 15 81 f9 a4 02 00 00 90 00 } //1
