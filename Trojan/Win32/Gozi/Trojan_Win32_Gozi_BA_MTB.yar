...
rule Trojan_Win32_Gozi_BA_MTB{
	...
	strings :
		...
		$a_81_2 = {4e 6f 6f 6e 2e 64 6c 6c } //01 00 
		$a_81_3 = {43 6c 6f 73 65 77 68 65 74 68 65 72 } //01 00 
		$a_81_4 = {4d 65 61 6e 74 64 75 63 6b } //01 00 
		$a_81_5 = {52 6f 70 65 6d 61 79 } //00 00 
	condition:
		any of ($a_*)
