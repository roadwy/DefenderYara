...
rule Trojan_Win32_Gozi_RD_MTB_2{
	...
	strings :
		$a_03_0 = {0f af c3 c1 ca 05 8b ca d3 c7 8b 4c 24 90 01 01 2b 31 c1 c8 05 8b c8 33 f8 d3 c6 8b 44 24 90 01 01 8b 4c 24 90 01 01 83 e9 08 33 f2 48 89 44 24 90 01 01 89 4c 24 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
