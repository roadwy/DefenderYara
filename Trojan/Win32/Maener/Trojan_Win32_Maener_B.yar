...
rule Trojan_Win32_Maener_B{
	...
	strings :
		$a_03_0 = {52 61 75 6d 2d 90 02 05 77 69 74 68 90 02 05 4d 65 90 00 } //1
		...
		$a_03_3 = {36 34 62 69 74 90 02 05 33 32 62 69 74 90 00 } //1
		$a_03_4 = {53 74 6f 70 70 65 72 2d 6d 75 74 65 78 90 02 05 50 47 68 30 62 57 77 3d 90 02 05 5c 62 69 6e 90 00 } //1
	condition:
