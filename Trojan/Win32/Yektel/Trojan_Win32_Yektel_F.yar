...
rule Trojan_Win32_Yektel_F{
	...
	strings :
		$a_03_0 = {66 72 65 65 73 63 61 6e 2e 70 68 70 3f 90 02 01 69 64 3d 25 76 61 72 25 2d 90 00 } //1
		...
		$a_03_3 = {e8 df fe ff ff 83 7d f0 00 0f 84 e1 00 00 00 0f b6 05 90 09 05 00 b8 01 00 00 80 90 00 } //2
	condition:
