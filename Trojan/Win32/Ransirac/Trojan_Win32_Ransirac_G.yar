...
rule Trojan_Win32_Ransirac_G{
	...
	strings :
		...
		$a_02_1 = {4e 54 5c 43 75 72 72 65 6e 74 56 65 72 73 69 6f 6e 5c 57 69 6e 6c 6f 67 6f 6e 90 02 20 73 68 65 6c 6c 90 00 } //1
		$a_02_2 = {4e 54 5c 43 75 72 72 65 6e 74 56 65 72 73 69 6f 6e 5c 77 69 6e 6c 6f 67 6f 6e 90 02 20 75 73 65 72 69 6e 69 74 90 00 } //1
