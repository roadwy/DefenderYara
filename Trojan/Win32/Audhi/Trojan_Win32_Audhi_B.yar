...
rule Trojan_Win32_Audhi_B{
	...
	strings :
		$a_03_0 = {eb 0b 44 72 69 76 65 72 50 72 6f 63 00 68 90 01 03 10 ff 35 90 01 03 10 e8 90 01 04 a3 90 01 03 10 eb 0b 90 00 } //1
		$a_02_1 = {eb 0b 61 75 78 4d 65 73 73 61 67 65 00 68 90 01 03 10 ff 35 90 01 03 10 e8 90 00 } //1
