...
rule Trojan_Win32_Rigtoy{
	...
	strings :
		$a_01_0 = {25 73 3f 67 69 64 3d 25 64 26 25 73 } //03 00 
		$a_01_1 = {41 64 6f 62 65 41 69 64 2e 64 6c 6c } //01 00 
		$a_01_2 = {62 61 69 64 75 2e 63 6f 6d } //02 00 
		$a_01_3 = {47 50 6c 61 79 65 72 2e 64 6c 6c } //03 00 
		$a_01_4 = {53 79 73 5f 52 75 6e 5f 33 } //01 00 
		$a_01_5 = {79 61 68 6f 6f 2e 63 6f 6d 2e 63 6e } //01 00 
		$a_01_6 = {7a 68 6f 6e 67 73 6f 75 2e 63 6f 6d } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Rigtoy_2{
	...
	strings :
		...
		$a_01_1 = {53 79 73 5f 52 75 6e 5f 33 } //02 00 
		$a_01_2 = {53 47 4d 49 47 45 58 } //02 00 
		$a_01_3 = {41 64 6f 62 65 41 69 64 2e 64 6c 6c } //02 00 
		$a_01_4 = {4d 73 4e 65 74 45 78 2e 65 78 65 } //02 00 
		$a_00_5 = {4d 00 6f 00 64 00 75 00 6c 00 65 00 5f 00 52 00 61 00 77 00 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Rigtoy_3{
	...
	strings :
		...
		$a_01_3 = {53 47 4d 49 47 45 58 } //00 00 
	condition:
		any of ($a_*)
