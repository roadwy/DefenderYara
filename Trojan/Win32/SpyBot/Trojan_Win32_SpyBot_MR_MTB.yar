...
rule Trojan_Win32_SpyBot_MR_MTB{
	...
	strings :
		$a_02_0 = {29 f6 2b 37 f7 de 90 02 0a c1 ce 90 01 01 29 d6 83 ee 90 01 01 29 d2 29 f2 f7 da c1 c2 90 01 01 d1 ca 6a 90 01 01 8f 01 01 31 83 e9 90 01 01 83 eb 90 01 01 85 db 75 90 00 } //3
