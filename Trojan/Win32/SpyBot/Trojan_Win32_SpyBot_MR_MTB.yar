...
rule Trojan_Win32_SpyBot_MR_MTB{
	...
	strings :
		...
		$a_00_1 = {70 00 6e 00 63 00 6f 00 62 00 6a 00 61 00 70 00 69 00 2e 00 64 00 6c 00 6c 00 } //01 00 
		$a_00_2 = {70 00 69 00 2e 00 64 00 6c 00 6c 00 } //01 00 
		$a_01_3 = {6e 64 64 65 61 70 69 2e 64 6c 6c } //00 00 
	condition:
		any of ($a_*)
