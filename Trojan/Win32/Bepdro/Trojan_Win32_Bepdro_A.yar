...
rule Trojan_Win32_Bepdro_A_2{
	...
	strings :
		...
		$a_01_2 = {2d 66 75 63 6b } //01 00 
		$a_01_3 = {73 61 66 65 6d 6f 6e 2e 64 6c 6c } //01 00 
		$a_01_4 = {69 65 62 75 64 64 79 2e 64 6c 6c } //01 00 
		$a_01_5 = {52 61 76 4d 6f 6e 2e 65 78 65 2c 61 76 70 2e 65 78 65 2c 33 36 30 74 72 61 79 2e 65 78 65 2c 52 53 54 72 61 79 2e 65 78 65 } //01 00 
		$a_01_6 = {64 72 69 76 65 72 73 5c 42 65 65 70 2e 73 79 73 } //01 00 
		$a_01_7 = {69 66 20 65 78 69 73 74 } //01 00 
		$a_01_8 = {77 65 30 34 77 65 30 35 } //00 00 
	condition:
		any of ($a_*)
