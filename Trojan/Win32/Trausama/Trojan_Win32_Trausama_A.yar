...
rule Trojan_Win32_Trausama_A{
	...
	strings :
		...
		$a_00_1 = {39 35 2e 31 36 38 2e 31 37 32 2e 34 36 } //01 00 
		$a_00_2 = {44 45 46 53 45 52 } //01 00 
		$a_00_3 = {4d 4f 52 45 00 00 00 00 77 62 2b 00 72 62 00 00 4e 4f 52 52 } //01 00 
		$a_00_4 = {4b 65 72 6e 65 6c 20 50 61 67 65 20 46 61 75 6c 74 20 78 78 78 78 78 78 68 } //00 00 
	condition:
		any of ($a_*)
