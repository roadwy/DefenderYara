...
rule Trojan_Win32_VB_DC{
	...
	strings :
		...
		$a_02_3 = {5c 00 47 00 62 00 50 00 6c 00 75 00 67 00 69 00 6e 00 5c 00 47 00 62 00 [0-10] 2e 00 65 00 78 00 65 00 } //10
		$a_02_4 = {5c 00 44 00 6f 00 77 00 6e 00 6c 00 6f 00 61 00 64 00 65 00 64 00 20 00 50 00 72 00 6f 00 67 00 72 00 61 00 6d 00 20 00 46 00 69 00 6c 00 65 00 73 00 5c 00 67 00 62 00 [0-10] 2e 00 64 00 6c 00 6c 00 } //10
		...
		$a_02_6 = {68 74 74 70 3a 2f 2f 77 77 77 2e [0-12] 2e 63 6f 6d 2e 62 72 } //1
	condition:
