...
rule Trojan_Win32_VB_ADR{
	...
	strings :
		$a_02_0 = {50 6a 01 6a ff 6a 02 ff 15 90 01 04 8d 4d 90 01 01 ff 15 90 01 04 c7 45 fc 90 01 01 00 00 00 c7 85 90 01 01 fe ff ff 90 01 04 c7 85 90 01 01 fe ff ff 08 00 00 00 c7 85 90 01 01 fe ff ff 90 01 04 c7 85 90 01 01 fe ff ff 08 00 00 00 8d 8d 90 01 01 fe ff ff 51 8b 55 08 83 c2 34 52 90 00 } //1
