...
rule Trojan_Win32_VB_PQ{
	...
	strings :
		...
		$a_00_2 = {64 00 61 00 70 00 68 00 61 00 2e 00 6e 00 65 00 74 00 } //01 00 
		$a_00_3 = {4d 61 6b 65 6d 61 69 6c } //01 00 
		$a_00_4 = {74 78 74 73 65 72 76 65 72 } //01 00 
		$a_00_5 = {74 78 74 6b 65 79 6c 6f 67 } //00 00 
	condition:
		any of ($a_*)
