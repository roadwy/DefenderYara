...
rule Trojan_Win32_VB_QM{
	...
	strings :
		...
		$a_03_1 = {8b 45 0c ff 30 e8 90 01 02 ff ff 8b d0 8d 8d 90 01 02 ff ff e8 90 01 02 ff ff 50 e8 90 01 02 ff ff 33 85 90 01 02 ff ff 66 89 85 90 01 02 ff ff 89 bd 90 01 02 ff ff 8d 95 90 01 02 ff ff 90 00 } //1
	condition:
