...
rule Trojan_Win32_TerraLoader_LK_MTB{
	...
	strings :
		$a_03_0 = {c1 e3 02 8b 5c 1d 00 8b 7c 24 90 01 04 81 e7 ff ff ff 00 31 fb 89 5c 24 90 01 01 8b 1c 24 43 89 1c 24 eb 90 00 } //1
		$a_03_1 = {ff 74 24 08 8b 5c 24 04 8b 2d 90 01 04 c1 e3 02 58 89 44 1d 00 ff 04 24 71 85 90 00 } //1
