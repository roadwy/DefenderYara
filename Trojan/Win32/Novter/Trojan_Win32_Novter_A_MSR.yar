...
rule Trojan_Win32_Novter_A_MSR{
	...
	strings :
		$a_02_0 = {7b 22 61 63 63 6c 22 3a 5b 22 90 02 05 3a 2f 2f 90 02 03 2e 90 02 03 2e 90 02 03 2e 90 02 03 3a 90 02 03 2f 22 2c 22 90 02 05 3a 2f 2f 90 02 03 2e 90 02 03 2e 90 02 03 2e 90 02 03 3a 90 02 03 2f 22 2c 90 00 } //1
