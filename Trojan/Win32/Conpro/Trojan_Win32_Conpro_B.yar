...
rule Trojan_Win32_Conpro_B{
	...
	strings :
		...
		$a_00_1 = {61 73 3a 70 3a 65 3a 6d 3a 78 3a 75 3a } //01 00 
		...
		$a_00_5 = {74 75 6e 6e 65 6c 20 74 65 73 74 20 6f 6b 21 21 21 } //01 00 
		$a_00_6 = {6e 6f 20 63 72 65 61 74 65 20 75 64 70 20 73 6f 63 6b 65 74 21 } //00 00 
	condition:
		any of ($a_*)
