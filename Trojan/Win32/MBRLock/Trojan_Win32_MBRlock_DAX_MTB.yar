...
rule Trojan_Win32_MBRlock_DAX_MTB{
	...
	strings :
		...
		$a_03_4 = {83 c4 1c 68 04 00 00 80 6a 00 68 90 01 04 6a 00 6a 00 6a 00 68 02 00 00 00 bb 90 01 02 40 00 e8 90 01 02 00 00 83 c4 1c 90 00 } //1
		$a_03_5 = {8b 44 24 08 6a ff 50 ff 15 90 01 04 eb 10 8b 4c 24 08 68 e8 03 00 00 51 ff 15 90 00 } //1
	condition:
