...
rule Trojan_Win32_MBRLock_EQ_MTB{
	...
	strings :
		...
		$a_01_2 = {59 6f 75 72 20 64 69 73 6b 20 68 61 76 65 20 61 20 6c 6f 63 6b 21 21 21 50 6c 65 61 73 65 20 65 6e 74 65 72 20 74 68 65 20 75 6e 6c 6f 63 6b 20 70 61 73 73 77 6f 72 64 } //00 00 
	condition:
		any of ($a_*)
