...
rule Trojan_Win32_Ramdo_E{
	...
	strings :
		$a_03_0 = {6a 03 6a 00 e8 90 01 04 89 45 fc ff 75 10 ff 75 0c ff 75 08 ff 55 fc 90 00 } //1
		...
		$a_03_4 = {89 85 bc fb ff ff 83 bd bc fb ff ff 00 76 0f c7 85 dc fd ff ff 01 00 00 00 e9 90 01 02 00 00 eb 90 01 01 c7 85 b8 fb ff ff 08 02 00 00 83 bd d8 fd ff ff 00 74 90 00 } //1
	condition:
