...
rule Trojan_Win32_Minxer_A{
	...
	strings :
		$a_03_0 = {2e 65 78 65 20 2d 61 20 90 02 40 3a 90 00 } //1
		$a_03_1 = {2e 65 78 65 20 2d 70 6f 6f 6c 69 70 3d 90 02 10 20 2d 70 6f 6f 6c 70 6f 72 74 3d 90 00 } //1
		$a_01_2 = {00 6d 73 75 70 64 61 74 65 37 31 5c } //1 洀畳摰瑡㝥就
		$a_03_3 = {00 69 73 77 69 7a 61 72 64 90 02 04 5c 90 00 } //1
