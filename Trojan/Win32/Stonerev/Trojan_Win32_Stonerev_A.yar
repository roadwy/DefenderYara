...
rule Trojan_Win32_Stonerev_A{
	...
	strings :
		...
		$a_03_5 = {ff 72 c6 85 90 01 01 ff ff ff 5c c6 85 90 01 01 ff ff ff 63 c6 85 90 01 01 ff ff ff 61 c6 85 90 01 01 ff ff ff 72 c6 85 90 01 01 ff ff ff 73 c6 85 90 01 01 ff ff ff 73 c6 85 90 01 01 ff ff ff 2e c6 85 90 01 01 ff ff ff 65 c6 85 90 01 01 ff ff ff 78 c6 85 90 01 01 ff ff ff 65 90 00 } //1
	condition:
