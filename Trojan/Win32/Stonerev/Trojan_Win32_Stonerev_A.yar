...
rule Trojan_Win32_Stonerev_A{
	...
	strings :
		$a_01_0 = {00 53 54 4f 4e 45 53 00 } //01 00  匀佔䕎S
		$a_01_1 = {65 78 65 2e 79 61 72 74 73 52 } //01 00  exe.yartsR
		$a_01_2 = {73 25 5c 70 6d 65 54 5c 53 57 4f 44 4e 49 57 5c 3a 43 } //01 00  s%\pmeT\SWODNIW\:C
		$a_01_3 = {70 5c 57 69 6e 55 70 64 61 74 65 2e 74 6d 70 } //01 00  p\WinUpdate.tmp
		$a_01_4 = {4c 6f 61 64 65 72 4d 69 72 61 } //01 00  LoaderMira
