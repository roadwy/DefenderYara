...
rule Trojan_Win32_Allegato_MA_MTB{
	...
	strings :
		...
		$a_01_3 = {68 00 6f 00 73 00 74 00 2e 00 65 00 78 00 65 00 } //01 00 
		$a_01_4 = {54 53 68 69 66 74 53 74 61 74 65 } //01 00 
		$a_01_5 = {54 4b 65 79 50 72 65 73 73 45 76 65 6e 74 } //01 00 
		$a_01_6 = {4d 6f 75 73 65 50 6f 73 } //01 00 
		$a_01_7 = {47 65 74 54 69 63 6b 43 6f 75 6e 74 } //00 00 
	condition:
		any of ($a_*)
