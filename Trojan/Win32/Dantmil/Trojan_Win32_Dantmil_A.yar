...
rule Trojan_Win32_Dantmil_A{
	...
	strings :
		...
		$a_00_3 = {44 00 30 00 35 00 36 00 34 00 45 00 46 00 34 00 37 00 34 00 43 00 46 00 39 00 32 00 31 00 44 00 33 00 41 00 34 00 36 00 32 00 46 00 42 00 38 00 } //00 00  D0564EF474CF921D3A462FB8
	condition:
		any of ($a_*)
