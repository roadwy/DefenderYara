...
rule Trojan_Win32_CoinMiner_RD_bit{
	...
	strings :
		...
		$a_03_2 = {2d 2d 64 6f 6e 61 74 65 2d 6c 65 76 65 6c 90 02 10 2d 2d 6d 61 78 2d 63 70 75 2d 75 73 61 67 65 90 02 10 2d 6f 90 02 50 2d 75 90 02 50 2d 70 90 02 50 2d 6b 90 00 } //1
	condition:
