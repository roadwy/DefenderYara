...
rule Trojan_Win32_CoinMiner_PK_bit{
	...
	strings :
		...
		$a_01_2 = {73 74 72 61 74 75 6d 2b 74 63 70 3a 2f 2f 67 65 74 2e 62 69 2d 63 68 69 2e 63 6f 6d 3a 33 33 33 33 20 2d 75 } //00 00  stratum+tcp://get.bi-chi.com:3333 -u
	condition:
		any of ($a_*)
...
rule Trojan_Win32_CoinMiner_PK_bit_2{
	...
	strings :
		...
		$a_01_5 = {2f 00 53 00 43 00 20 00 4d 00 49 00 4e 00 55 00 54 00 45 00 20 00 2f 00 4d 00 4f 00 20 00 31 00 20 00 2f 00 46 00 20 00 2f 00 43 00 72 00 65 00 61 00 74 00 65 00 20 00 2f 00 54 00 4e 00 } //00 00  /SC MINUTE /MO 1 /F /Create /TN
