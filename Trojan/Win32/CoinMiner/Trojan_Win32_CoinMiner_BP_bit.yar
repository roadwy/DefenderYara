...
rule Trojan_Win32_CoinMiner_BP_bit{
	...
	strings :
		$a_03_0 = {53 46 58 20 73 63 72 69 70 74 20 63 6f 6d 6d 61 6e 64 73 0d 0a 0d 0a 50 61 74 68 3d 90 02 10 6d 69 6e 65 72 0d 0a 53 61 76 65 50 61 74 68 0d 0a 53 65 74 75 70 3d 22 90 02 10 6d 69 6e 65 72 5c 90 02 10 2e 76 62 73 22 0d 0a 53 69 6c 65 6e 74 3d 31 90 00 } //1
