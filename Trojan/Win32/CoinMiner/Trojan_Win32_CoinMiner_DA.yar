...
rule Trojan_Win32_CoinMiner_DA{
	...
	strings :
		...
		$a_01_2 = {22 6d 65 74 68 6f 64 22 3a 22 70 69 6e 67 22 2c 22 70 61 72 61 6d 73 22 3a 7b 22 69 64 22 3a 22 25 73 22 2c 22 63 6c 69 65 6e 74 22 } //01 00 
...
rule Trojan_Win32_CoinMiner_DA_2{
	...
	strings :
		$a_01_0 = {25 00 73 00 20 00 2f 00 6e 00 20 00 2f 00 73 00 20 00 2f 00 69 00 3a 00 22 00 2f 00 25 00 30 00 31 00 36 00 49 00 36 00 34 00 78 00 20 00 2f 00 71 00 22 00 20 00 22 00 25 00 73 00 22 00 } //01 00 
		...
		$a_01_3 = {61 63 74 69 76 69 74 79 5f 64 6f 6d 61 69 6e 73 } //01 00 
		$a_01_4 = {6d 69 6e 65 72 5f 61 63 74 69 76 69 74 79 } //01 00 
		$a_01_5 = {69 64 6c 65 5f 70 6f 6c 6c 5f 69 6e 74 65 72 76 61 6c } //00 00 
