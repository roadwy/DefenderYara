...
rule Trojan_Win32_CoinMiner_OF_bit{
	...
	strings :
		...
		$a_03_2 = {50 72 6f 63 65 73 73 20 48 61 63 6b 65 72 [0-03] 41 6e 56 69 72 } //1
...
rule Trojan_Win32_CoinMiner_OF_bit_3{
	...
	strings :
		...
		$a_03_2 = {5c 57 69 6e 64 6f 77 73 54 61 73 6b 5c [0-10] 2e 65 78 65 20 2f 72 69 20 31 20 2f 73 74 20 30 30 3a 30 30 20 2f 64 75 20 39 39 39 39 3a 35 39 20 2f 73 63 20 64 61 69 6c 79 20 2f 66 } //2
