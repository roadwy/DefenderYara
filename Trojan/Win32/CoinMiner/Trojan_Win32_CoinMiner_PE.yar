...
rule Trojan_Win32_CoinMiner_PE{
	...
	strings :
		$a_03_0 = {68 00 74 00 74 00 70 00 3a 00 2f 00 2f 00 90 02 20 2e 00 72 00 75 00 2f 00 90 02 10 2e 00 70 00 68 00 70 00 90 00 } //1
		...
		$a_03_4 = {61 74 74 72 69 62 20 2b 73 20 2b 68 20 22 43 3a 5c 90 02 40 2e 65 78 65 22 90 00 } //1
	condition:
