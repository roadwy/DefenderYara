...
rule Trojan_Win32_CoinMiner_BT_bit{
	...
	strings :
		$a_03_0 = {2d 6f 20 73 74 72 61 74 75 6d 2b 74 63 70 3a 2f 2f 78 6d 72 2e 6d 69 6e 65 72 63 69 72 63 6c 65 2e 63 6f 6d 3a 38 30 20 2d 75 20 90 05 10 03 30 2d 39 20 2d 70 90 00 } //2
