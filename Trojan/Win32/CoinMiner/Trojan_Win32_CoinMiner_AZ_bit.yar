...
rule Trojan_Win32_CoinMiner_AZ_bit_2{
	...
	strings :
		...
		$a_03_1 = {75 00 73 00 65 00 72 00 20 00 90 02 20 40 00 67 00 68 00 6f 00 73 00 74 00 6d 00 61 00 69 00 6c 00 2e 00 63 00 6f 00 6d 00 20 00 2d 00 62 00 63 00 6e 00 90 00 } //1
