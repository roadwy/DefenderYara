...
rule Trojan_Win32_CoinMiner_BK_bit{
	...
	strings :
		$a_01_0 = {63 70 75 5f 74 72 6f 6d 70 5f 53 53 45 } //0a 00 
		$a_01_1 = {5c 00 53 00 79 00 73 00 74 00 65 00 6d 00 5c 00 6e 00 68 00 65 00 71 00 6d 00 69 00 6e 00 65 00 72 00 } //01 00 
