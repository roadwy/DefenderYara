...
rule Trojan_Win32_CoinMiner_OT_bit{
	...
	strings :
		...
		$a_03_3 = {70 00 72 00 6f 00 63 00 65 00 78 00 70 00 2e 00 65 00 78 00 65 00 [0-06] 70 00 72 00 6f 00 63 00 65 00 78 00 70 00 36 00 34 00 2e 00 65 00 78 00 65 00 [0-06] 70 00 72 00 6b 00 69 00 6c 00 6c 00 65 00 72 00 2e 00 65 00 78 00 65 00 [0-06] 4b 00 69 00 6c 00 6c 00 50 00 72 00 6f 00 63 00 65 00 73 00 73 00 2e 00 65 00 78 00 65 00 } //1
	condition:
