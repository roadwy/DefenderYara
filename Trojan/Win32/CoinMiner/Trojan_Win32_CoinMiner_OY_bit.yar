...
rule Trojan_Win32_CoinMiner_OY_bit{
	...
	strings :
		$a_81_0 = {63 70 75 6d 69 6e 65 72 2d 6d 75 6c 74 69 } //01 00  cpuminer-multi
		$a_01_1 = {5c 77 69 6e 5f 78 38 36 2e 76 62 73 } //01 00  \win_x86.vbs
		$a_01_2 = {5c 52 55 4e 2d 58 31 31 2d 78 38 36 2e 62 61 74 } //02 00  \RUN-X11-x86.bat
