...
rule Trojan_Win32_Pexby_gen_A{
	...
	strings :
		...
		$a_03_1 = {66 83 7e 02 2d 75 90 01 01 8b 4d 08 83 c6 04 83 c0 fe 89 31 89 07 43 90 02 01 3b 5d fc 7c 90 00 } //5
		$a_03_2 = {0f b7 01 8b f0 81 e6 00 f0 00 00 bb 00 30 00 00 66 3b f3 75 90 01 01 8b 90 01 02 25 ff 0f 00 00 03 c2 01 30 90 00 } //5
