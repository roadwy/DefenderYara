...
rule Trojan_Win32_Ramgad_A{
	...
	strings :
		$a_03_0 = {bb 01 00 00 00 8b 06 8a 44 18 ff 04 90 01 01 2c 90 01 01 72 06 04 9b 2c 20 73 15 8b c6 e8 90 01 04 8b 16 0f b6 54 1a ff 83 ea 20 88 54 18 ff 43 4f 75 90 00 } //2
