...
rule Trojan_Win32_AgeDown_DA_MTB{
	...
	strings :
		$a_01_0 = {25 41 70 70 44 61 74 61 25 5c 44 6c 6c } //01 00 
		$a_01_1 = {56 53 63 61 6e 50 61 74 68 3d 25 25 53 } //01 00 
		$a_01_2 = {63 72 61 63 6b 69 6e 67 63 69 74 79 } //01 00 
