...
rule Trojan_Win32_ChChes_A_dha{
	...
	strings :
		...
		$a_00_2 = {52 65 6c 65 61 73 65 5c 48 75 79 61 } //65534 Release\Huya
		$a_00_3 = {68 79 64 65 76 69 63 65 2e 70 64 62 } //65534 hydevice.pdb
	condition:
		((#a_03_0  & 1)*1+(#a_03_1  & 1)*1+(#a_00_2  & 1)*65534+(#a_00_3  & 1)*65534) >=2
