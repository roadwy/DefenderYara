...
rule Trojan_Win32_ArrowRat_CAJ_MTB{
	...
	strings :
		...
		$a_01_2 = {49 00 6e 00 73 00 74 00 61 00 6c 00 6c 00 55 00 74 00 69 00 6c 00 2e 00 65 00 78 00 65 00 } //01 00 
		$a_01_3 = {53 65 74 54 68 72 65 61 64 43 6f 6e 74 65 78 74 } //01 00 
		$a_01_4 = {52 65 73 75 6d 65 54 68 72 65 61 64 } //00 00 
	condition:
		any of ($a_*)
