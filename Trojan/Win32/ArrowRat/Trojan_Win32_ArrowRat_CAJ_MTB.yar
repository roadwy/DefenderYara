...
rule Trojan_Win32_ArrowRat_CAJ_MTB{
	...
	strings :
		$a_03_0 = {8b 8d f8 fe 90 01 02 8a 95 f8 90 01 03 88 94 0d fc 90 01 03 8b 85 f8 90 01 03 99 f7 7d 14 8b 85 f8 90 01 03 8b 4d 10 8a 14 11 88 94 05 ec fd 90 01 02 eb 90 00 } //5
		$a_03_1 = {89 8d ec fe 90 01 02 8b 8d ec 90 01 03 0f b6 94 0d fc 90 01 03 8b 45 08 03 85 f0 90 01 03 0f b6 08 33 ca 8b 55 08 03 95 f0 90 01 03 88 0a e9 90 00 } //5
