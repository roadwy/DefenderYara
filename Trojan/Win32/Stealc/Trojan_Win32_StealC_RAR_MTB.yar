...
rule Trojan_Win32_StealC_RAR_MTB{
	...
	strings :
		$a_03_0 = {33 db 8b c6 8b d6 c1 e0 04 c1 ea 05 03 54 24 30 03 c5 8d 0c 37 33 c1 89 54 24 18 89 44 24 10 89 1d ?? ?? ?? ?? 8b 44 24 18 01 05 84 40 7b 00 8b 15 ?? ?? ?? ?? 89 54 24 28 89 5c 24 18 8b 44 24 28 } //1
