...
rule Trojan_Win32_Keylogger_DAL_MTB{
	...
	strings :
		$a_03_0 = {f7 02 84 dc 87 43 44 d1 11 89 06 00 a0 c9 11 00 49 67 0d 26 db 8c b9 05 4e 83 9c 6e df 77 1d 5b 0e 21 3d [0-04] 68 10 a7 38 08 00 2b 33 71 b5 43 6c 61 73 } //2
