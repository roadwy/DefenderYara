...
rule Trojan_Win32_Keylogger_AB_MTB{
	...
	strings :
		...
		$a_02_2 = {5b 4e 55 4d 50 41 44 5f 53 45 50 41 52 41 54 4f 52 5d 90 02 10 5b 43 41 50 53 5d 90 02 10 5b 45 4e 44 5d 90 02 10 5b 48 4f 4d 45 5d 90 02 10 5b 49 4e 53 45 52 54 5d 90 02 10 5b 44 45 4c 45 54 45 5d 90 00 } //1
