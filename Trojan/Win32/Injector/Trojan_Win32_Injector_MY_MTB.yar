...
rule Trojan_Win32_Injector_MY_MTB{
	meta:
		description = "Trojan:Win32/Injector.MY!MTB,SIGNATURE_TYPE_PEHSTR_EXT,05 00 05 00 05 00 00 01 00 "
	...
	strings :
		...
		$a_81_4 = {49 55 6e 6b 6e 6f 77 6e 5f 41 64 64 52 65 66 5f 50 72 6f 78 79 } //00 00  IUnknown_AddRef_Proxy
	condition:
		any of ($a_*)
