...
rule Trojan_Win32_Injector_MY_MTB{
	...
	strings :
		...
		$a_81_2 = {53 74 67 47 65 74 49 46 69 6c 6c 4c 6f 63 6b 42 79 74 65 73 4f 6e 46 69 6c 65 } //01 00 
		$a_81_3 = {6c 6f 61 64 70 65 72 66 2e 64 6c 6c } //01 00 
		$a_81_4 = {49 55 6e 6b 6e 6f 77 6e 5f 41 64 64 52 65 66 5f 50 72 6f 78 79 } //01 00 
