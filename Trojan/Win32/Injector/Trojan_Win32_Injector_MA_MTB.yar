...
rule Trojan_Win32_Injector_MA_MTB{
	...
	strings :
		...
		$a_01_1 = {4c 6f 61 64 65 72 2e 70 64 62 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Injector_MA_MTB_2{
	...
	strings :
		$a_01_0 = {75 6a 6d 61 6b 66 75 6e 2e 64 6c 6c } //01 00 
		$a_01_1 = {68 72 79 61 62 77 } //01 00 
		$a_01_2 = {69 6e 65 68 70 } //01 00 
		$a_01_3 = {56 69 72 74 75 61 6c 50 72 6f 74 65 63 74 } //01 00 
		$a_01_4 = {43 72 65 61 74 65 46 69 6c 65 } //01 00 
		$a_01_5 = {57 4e 65 74 41 64 64 43 6f 6e 6e 65 63 74 69 6f 6e } //00 00 
	condition:
		any of ($a_*)
