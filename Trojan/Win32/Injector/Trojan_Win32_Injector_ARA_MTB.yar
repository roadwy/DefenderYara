...
rule Trojan_Win32_Injector_ARA_MTB_2{
	...
	strings :
		$a_01_0 = {43 3a 5c 55 73 65 72 73 5c 50 75 62 6c 69 63 5c 44 6f 63 75 6d 65 6e 74 73 5c 7a 79 2e 6c 6f 67 } //02 00 
		$a_01_1 = {73 6f 66 74 77 61 72 65 5c 57 4f 57 36 34 33 32 4e 6f 64 65 5c 54 65 6e 63 65 6e 74 5c 51 51 32 30 30 39 5c 49 6e 73 74 61 6c 6c } //02 00 
		$a_01_2 = {48 69 70 73 54 72 61 79 2e 65 78 65 } //02 00 
		$a_01_3 = {33 36 30 74 72 61 79 2e 65 78 65 } //02 00 
		$a_01_4 = {56 40 5c 62 68 64 6c 6c 2e 64 61 74 } //02 00 
		$a_01_5 = {66 75 63 6b 79 6f 75 32 } //00 00 
	condition:
		any of ($a_*)
