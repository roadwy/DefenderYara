...
rule Trojan_Win32_Injector_YQ_bit{
	...
	strings :
		$a_03_0 = {83 c4 0c 89 45 90 01 01 6a 0c 68 90 01 02 40 00 68 90 01 02 40 00 e8 90 01 02 ff ff 83 c4 0c 89 45 90 01 01 6a 08 68 90 01 02 40 00 68 90 01 02 40 00 e8 90 01 02 ff ff 83 c4 0c 90 00 } //1
