...
rule Trojan_Win32_Injector_EPQX_MTB_2{
	...
	strings :
		...
		$a_81_1 = {55 74 69 6c 67 69 76 65 6c 69 67 68 65 64 65 72 6e 65 73 31 } //01 00  Utilgivelighedernes1
		$a_81_2 = {53 61 6d 6d 65 6e 74 72 79 6b 6b 65 73 32 } //01 00  Sammentrykkes2
		$a_81_3 = {54 65 6d 70 6f 72 69 73 65 72 73 34 } //00 00  Temporisers4
	condition:
		any of ($a_*)
