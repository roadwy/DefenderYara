...
rule Trojan_Win32_Injector_MR_MTB_2{
	...
	strings :
		$a_02_0 = {0a 0a 02 17 8d 90 01 03 01 25 16 1f 90 01 01 9d 6f 90 01 03 0a 0b 00 07 0c 16 0d 2b 90 01 01 08 09 9a 13 90 01 01 00 06 11 90 01 01 1f 90 01 01 28 90 01 03 0a d1 6f 90 01 03 0a 26 00 09 17 58 0d 09 08 8e 69 32 90 00 } //1
		$a_02_1 = {06 0b 07 13 90 01 01 11 90 01 01 0d 09 2c 90 01 01 09 72 90 01 03 70 28 90 01 03 0a 2d 90 01 01 2b 90 01 01 2b 90 01 01 07 28 90 01 03 06 74 90 01 03 01 0c 08 28 90 01 03 06 00 2b 90 00 } //1
	condition:
