...
rule Trojan_Win32_Injector_AN{
	...
	strings :
		$a_03_0 = {6a 40 68 00 30 00 00 8b 95 fc fe ff ff 8b 42 50 50 8b 4d 10 51 8b 55 08 8b 02 50 ff 95 ?? ?? ?? ?? 6a 00 8b 8d fc fe ff ff 8b 51 54 52 8b 45 0c 50 8b 4d 10 51 8b 55 08 8b 02 50 } //1
