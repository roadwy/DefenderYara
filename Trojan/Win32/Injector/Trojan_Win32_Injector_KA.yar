...
rule Trojan_Win32_Injector_KA{
	...
	strings :
		$a_03_0 = {89 47 20 48 8d 05 90 01 04 48 89 47 28 48 8d 05 90 01 04 48 89 47 30 48 8d 05 90 01 04 48 89 47 38 48 8d 05 90 01 04 48 89 47 40 48 8d 05 90 01 04 48 89 47 48 8b 44 90 00 } //2
