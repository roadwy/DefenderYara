...
rule Trojan_Win32_Mesdetty_D{
	...
	strings :
		$a_02_0 = {5c 00 6d 00 73 00 64 00 74 00 90 02 f0 70 00 63 00 77 00 64 00 69 00 61 00 67 00 6e 00 6f 00 73 00 74 00 69 00 63 00 90 00 } //100
		...
		$a_02_17 = {72 00 6f 00 77 00 73 00 65 00 46 00 6f 00 72 00 46 00 69 00 6c 00 65 00 3d 00 90 02 50 3f 00 90 00 } //1
		...
		$a_00_25 = {72 65 67 20 64 65 6c 65 74 65 } //65336 reg delete
		$a_00_26 = {6e 65 74 73 68 } //65336 netsh
		$a_00_27 = {6d 73 64 74 20 2d 20 50 68 61 73 65 } //65336 msdt - Phase
		$a_00_28 = {43 61 64 65 6e 63 65 20 4c 69 63 65 6e 73 65 20 4d 61 6e 61 67 65 72 } //65336 Cadence License Manager
		$a_00_29 = {61 70 70 65 6e 64 74 6f 6f 6c 2e 65 78 65 20 2d 66 69 6c 65 } //65336 appendtool.exe -file
		$a_00_30 = {53 58 53 5f 41 53 53 45 4d 42 4c 59 5f 4e 41 4d 45 3d 4d 69 63 72 6f 73 6f 66 74 2e 57 69 6e 64 6f 77 73 2e 4d 53 44 54 } //65336 SXS_ASSEMBLY_NAME=Microsoft.Windows.MSDT
	condition:
		((#a_02_0  & 1)*100+(#a_00_1  & 1)*1+(#a_00_2  & 1)*1+(#a_00_3  & 1)*1+(#a_00_4  & 1)*1+(#a_00_5  & 1)*1+(#a_00_6  & 1)*1+(#a_00_7  & 1)*1+(#a_00_8  & 1)*1+(#a_00_9  & 1)*1+(#a_00_10  & 1)*1+(#a_00_11  & 1)*1+(#a_00_12  & 1)*1+(#a_00_13  & 1)*1+(#a_00_14  & 1)*1+(#a_00_15  & 1)*1+(#a_00_16  & 1)*1+(#a_02_17  & 1)*1+(#a_00_18  & 1)*1+(#a_00_19  & 1)*1+(#a_00_20  & 1)*1+(#a_00_21  & 1)*1+(#a_00_22  & 1)*1+(#a_00_23  & 1)*1+(#a_00_24  & 1)*1+(#a_00_25  & 1)*65336+(#a_00_26  & 1)*65336+(#a_00_27  & 1)*65336+(#a_00_28  & 1)*65336+(#a_00_29  & 1)*65336+(#a_00_30  & 1)*65336) >=101
