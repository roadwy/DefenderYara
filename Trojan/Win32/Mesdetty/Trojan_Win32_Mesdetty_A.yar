...
rule Trojan_Win32_Mesdetty_A{
	...
	strings :
		...
		$a_02_17 = {72 00 6f 00 77 00 73 00 65 00 46 00 6f 00 72 00 46 00 69 00 6c 00 65 00 3d 00 90 02 10 3f 00 90 00 } //1
		...
		$a_02_25 = {70 00 63 00 77 00 64 00 69 00 61 00 67 00 6e 00 6f 00 73 00 74 00 69 00 63 00 90 02 50 61 00 66 00 20 00 90 00 } //1
	condition:
