...
rule Trojan_Win32_Buniq_A{
	...
	strings :
		...
		$a_00_2 = {53 00 74 00 61 00 62 00 69 00 6c 00 69 00 74 00 79 00 4d 00 75 00 74 00 65 00 78 00 53 00 74 00 72 00 69 00 6e 00 67 00 } //01 00  StabilityMutexString
		$a_01_3 = {50 6f 72 74 46 6f 72 77 61 72 64 69 6e 67 73 22 3d } //00 00  PortForwardings"=
	condition:
		any of ($a_*)
