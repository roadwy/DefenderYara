...
rule Trojan_Win32_Dronzho_A{
	...
	strings :
		...
		$a_00_1 = {43 3a 5c 57 49 4e 44 4f 57 53 5c 73 76 63 68 6f 73 74 2e 65 78 65 } //01 00 
		$a_00_2 = {43 3a 5c 57 49 4e 44 4f 57 53 5c 53 59 53 54 45 4d 33 32 5c 63 68 6b 64 73 6b 2e 65 78 65 } //0a 00 
