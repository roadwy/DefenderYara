...
rule Trojan_Win32_Redaman_B{
	...
	strings :
		$a_02_0 = {ff 10 50 8f 05 90 01 04 8d 90 01 05 c7 90 01 01 48 65 61 70 66 c7 90 01 01 04 43 72 90 02 01 c7 90 01 01 06 65 61 90 02 03 50 ff 35 90 0a 38 00 8d 05 90 00 } //3
