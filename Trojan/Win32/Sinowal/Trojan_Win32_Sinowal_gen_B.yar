...
rule Trojan_Win32_Sinowal_gen_B{
	...
	strings :
		$a_03_0 = {81 3a 50 45 00 00 74 04 32 c0 eb 90 01 01 8b 45 f0 83 c0 04 89 45 f0 8b 4d f0 83 c1 14 89 4d f8 8b 55 f8 0f b7 02 3d 0b 01 00 00 74 90 00 } //5
		$a_03_1 = {83 ec 44 c7 45 fc ff ff ff ff c7 45 bc 00 00 00 00 90 13 83 7d bc 90 01 01 73 90 00 } //1
