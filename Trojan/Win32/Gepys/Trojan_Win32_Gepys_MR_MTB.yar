...
rule Trojan_Win32_Gepys_MR_MTB{
	...
	strings :
		...
		$a_00_1 = {28 63 74 73 5c 70 72 6f 67 73 5c 53 79 73 50 72 6f 67 5c 77 6f 72 6b 5c 72 6d 5c 74 65 6d 70 6c 61 74 65 73 5c 65 78 65 5c 72 75 6e 69 6e 6d 65 6d 32 2e 65 78 65 } //00 00 
	condition:
		any of ($a_*)
