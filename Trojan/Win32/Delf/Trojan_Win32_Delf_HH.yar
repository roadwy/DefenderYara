...
rule Trojan_Win32_Delf_HH{
	...
	strings :
		$a_02_0 = {64 ff 30 64 89 20 ba ?? ?? ?? ?? 8b 45 ec 8b 08 ff 51 38 33 d2 8b 45 ec 8b 08 ff 51 38 ba ?? ?? ?? ?? 8b 45 ec 8b 08 ff 51 38 8d 45 e4 50 8b 45 f8 89 45 d4 c6 45 d8 0b } //1
