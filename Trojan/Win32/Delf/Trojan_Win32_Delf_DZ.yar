...
rule Trojan_Win32_Delf_DZ{
	...
	strings :
		...
		$a_03_3 = {52 50 8d 46 48 50 e8 ?? ?? ff ff 83 f8 ff 0f 84 08 01 00 00 89 06 66 81 7e 04 b3 d7 0f 85 c3 00 00 00 66 ff 4e 04 6a 00 ff 36 e8 ?? ?? ff ff 40 } //10
		$a_02_4 = {2a 72 2a 2e ?? 70 ?? 68 ?? 70 ?? 3f ?? 75 ?? 72 ?? 6c ?? 3d } //2
	condition:
