...
rule Trojan_Win32_Delf_CM{
	...
	strings :
		...
		$a_00_3 = {53 59 53 54 45 4d 5c 43 75 72 72 65 6e 74 43 6f 6e 74 72 6f 6c 53 65 74 5c 43 6f 6e 74 72 6f 6c 5c 54 65 72 6d 69 6e 61 6c 20 53 65 72 76 65 72 } //01 00 
...
rule Trojan_Win32_Delf_CM_2{
	...
	strings :
		$a_01_0 = {53 65 72 76 69 63 65 44 6c 6c 2e 64 6c 6c 00 53 65 72 76 69 63 65 4d 61 69 6e } //01 00 
		$a_01_1 = {6e 65 74 73 76 63 73 00 ff ff ff ff 34 00 00 00 53 4f 46 54 57 41 52 45 5c 4d 69 63 72 6f 73 6f 66 74 5c 57 69 6e 64 6f 77 73 20 4e 54 5c 43 75 72 72 65 6e 74 56 65 72 73 69 6f 6e 5c 53 76 63 48 6f 73 74 } //01 00 
		$a_00_2 = {68 74 6f 6e 73 } //01 00 
		$a_00_3 = {52 65 67 69 73 74 65 72 53 65 72 76 69 63 65 43 74 72 6c 48 61 6e 64 6c 65 72 41 } //01 00 
		$a_00_4 = {43 61 6c 6c 4e 65 78 74 48 6f 6f 6b 45 78 } //01 00 
		$a_01_5 = {6d 6f 75 73 65 5f 65 76 65 6e 74 } //01 00 
		$a_00_6 = {53 6f 66 74 77 61 72 65 5c 4d 69 63 72 6f 73 6f 66 74 5c 57 69 6e 64 6f 77 73 5c 43 75 72 72 65 6e 74 56 65 72 73 69 6f 6e 5c 49 6e 74 65 72 6e 65 74 20 53 65 74 74 69 6e 67 73 } //01 00 
		$a_00_7 = {4f 70 65 6e 43 6c 69 70 62 6f 61 72 64 } //00 00 
	condition:
		any of ($a_*)
