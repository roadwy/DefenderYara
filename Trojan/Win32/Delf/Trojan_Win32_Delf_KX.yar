...
rule Trojan_Win32_Delf_KX{
	...
	strings :
		$a_01_0 = {64 3a 5c 33 36 30 5c 33 36 30 53 61 66 65 2e 72 65 67 } //01 00 
		$a_01_1 = {64 3a 5c 33 36 30 53 61 66 65 2e 72 65 67 } //01 00 
		$a_01_2 = {64 3a 5c 33 36 30 2e 72 65 67 } //05 00 
