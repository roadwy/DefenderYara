...
rule Trojan_Win32_Delf_KX{
	...
	strings :
		...
		$a_03_3 = {68 c8 00 00 00 e8 90 01 02 ff ff e8 90 01 02 ff ff 68 c8 00 00 00 e8 90 01 02 ff ff e8 90 01 02 ff ff 68 90 01 02 40 00 e8 90 01 02 ff ff 6a 64 e8 90 00 } //5
	condition:
