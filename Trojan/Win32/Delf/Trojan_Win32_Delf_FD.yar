...
rule Trojan_Win32_Delf_FD{
	...
	strings :
		...
		$a_03_6 = {e8 00 00 00 00 5b 90 02 04 8d 53 32 90 02 04 8d 43 2a 90 02 04 52 ff 10 8b f0 90 02 04 8d 53 72 90 02 04 8d 43 2e 90 02 04 52 56 ff 10 83 f8 00 74 02 90 02 04 ff d0 90 00 } //1
	condition:
