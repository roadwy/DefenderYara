...
rule Trojan_Win32_Delf_ES{
	...
	strings :
		...
		$a_03_2 = {bf 01 00 00 00 8b 45 fc 8a 5c 38 ff 80 e3 0f b8 ?? ?? ?? ?? 8a 44 30 ff 24 0f 32 d8 80 f3 0a 8d 45 fc e8 ?? ?? ?? ?? 8b 55 fc 8a 54 3a ff 80 e2 f0 02 d3 88 54 38 ff 46 } //1
	condition:
