...
rule Trojan_Win32_Delf_J_ibt{
	...
	strings :
		...
		$a_01_2 = {38 33 30 33 30 32 37 38 33 35 42 36 38 36 39 35 38 36 46 37 34 33 37 32 31 44 34 46 31 41 42 34 32 31 31 32 32 31 35 44 38 45 31 43 38 30 45 33 33 } //00 00 
	condition:
		any of ($a_*)
