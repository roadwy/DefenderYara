...
rule Trojan_Win32_Delf_IO{
	...
	strings :
		...
		$a_02_1 = {6f 76 2e 6f 76 65 72 74 6e 2e 63 6f 6d 2f 90 02 20 2f 65 78 65 2f 75 70 5f 74 2e 68 74 6d 6c 90 00 } //1
		$a_02_2 = {64 6f 77 6e 2e 6f 76 65 72 74 6e 2e 63 6f 6d 2f 90 02 20 2f 62 68 6f 6e 2f 90 00 } //1
