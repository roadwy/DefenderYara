...
rule Trojan_Win32_Delf_IU_dll{
	...
	strings :
		$a_01_0 = {21 40 23 77 61 6e 67 6a 69 26 68 79 7a 2a 2a } //01 00 
		$a_01_1 = {79 64 67 69 64 63 6e 61 66 67 2e 64 61 74 } //01 00 
		$a_01_2 = {75 64 70 5c 68 6a 6f 62 31 32 33 5c 63 6f 6d } //01 00 
