...
rule Trojan_Win32_Delf_KB{
	...
	strings :
		...
		$a_00_1 = {77 69 6e 6e 65 77 64 6c 6c 2e 64 6c 6c } //01 00  winnewdll.dll
		$a_00_2 = {77 69 6e 64 6f 77 73 70 72 6f 78 79 2e 6f 72 67 2f 77 69 6e 2e 6c 61 63 } //01 00  windowsproxy.org/win.lac
		$a_00_3 = {63 73 73 2f 6c 6f 67 73 2f 61 64 64 2e 70 68 70 } //00 00  css/logs/add.php
	condition:
		any of ($a_*)
