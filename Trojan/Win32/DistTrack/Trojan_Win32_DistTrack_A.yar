...
rule Trojan_Win32_DistTrack_A{
	...
	strings :
		...
		$a_03_1 = {e8 d3 e6 ff ff bb 11 00 00 00 b8 90 01 04 e8 e4 be ff ff 8d 4c 24 20 51 89 44 24 24 c7 44 24 28 90 01 04 89 7c 24 2c 89 7c 24 30 ff 15 90 01 04 85 c0 75 36 90 00 } //1
	condition:
