...
rule Trojan_Win32_Zbot_RT_MTB_2{
	...
	strings :
		$a_81_0 = {50 53 41 50 49 2e 44 4c 4c } //01 00 
		$a_81_1 = {55 6e 68 6f 6f 6b 57 69 6e 64 6f 77 73 48 6f 6f 6b 45 78 } //01 00 
		$a_81_2 = {53 65 74 57 69 6e 64 6f 77 73 48 6f 6f 6b 45 78 41 } //01 00 
		$a_81_3 = {6b 65 79 62 64 5f 65 76 65 6e 74 } //01 00 
		$a_81_4 = {4d 61 70 56 69 72 74 75 61 6c 4b 65 79 41 } //01 00 
		$a_81_5 = {56 6b 4b 65 79 53 63 61 6e 45 78 41 } //05 00 
		$a_81_6 = {68 74 74 70 3a 2f 2f 72 6c 2e 61 6d 6d 79 79 2e 63 6f 6d } //00 00 
	condition:
		any of ($a_*)
