...
rule Trojan_Win32_Zbot_DA_MTB{
	...
	strings :
		$a_03_0 = {8b 7d 84 c1 cf 17 0f b6 17 47 47 c1 c7 17 89 7d 84 b9 bb ea 54 3f 81 c1 05 16 ab c0 3b d1 0f 82 90 01 04 2b d1 03 d2 8b 45 fc c1 c8 13 03 c2 03 c2 c1 c8 0d 89 45 fc 85 d2 75 c4 90 00 } //1
