...
rule Trojan_Win32_Zbot_BB_MTB_2{
	...
	strings :
		...
		$a_01_1 = {44 6f 63 74 72 69 6e 69 73 6d } //01 00  Doctrinism
		$a_01_2 = {46 6f 72 63 69 70 61 74 65 38 } //01 00  Forcipate8
		$a_01_3 = {48 61 62 69 74 75 61 74 65 64 } //00 00  Habituated
	condition:
		any of ($a_*)
