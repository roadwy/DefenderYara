...
rule Trojan_Win32_Zbot_WM_MTB{
	...
	strings :
		$a_02_0 = {92 52 d0 14 c7 05 ?? ?? ?? ?? 78 11 d0 14 66 89 35 c8 16 d1 14 c7 05 ?? ?? ?? ?? bd 52 d0 14 c7 05 ?? ?? ?? ?? 64 11 d0 14 66 89 35 d8 16 d1 14 c7 05 ?? ?? ?? ?? f7 52 d0 14 c7 05 ?? ?? ?? ?? 50 11 d0 14 } //10
