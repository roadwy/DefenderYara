...
rule Trojan_Win32_Zbot_AAN_MTB{
	...
	strings :
		$a_02_0 = {8b 55 08 03 55 f4 8b 02 03 45 f4 8b 4d 08 03 4d f4 89 01 c7 45 fc 90 01 04 8b 55 f4 83 c2 18 89 15 90 01 04 8b 45 f8 89 45 f0 c7 45 fc 6a 01 00 00 8b 0d c0 21 44 00 89 4d ec 8b 55 08 03 55 f4 8b 02 33 45 ec 8b 4d 08 03 4d f4 89 01 eb 97 90 00 } //10
