...
rule Trojan_Win32_Zbot_GLL_MTB{
	...
	strings :
		$a_02_0 = {2b fe 33 30 8b ff 8b 75 b8 81 c6 90 01 04 ba 90 01 04 81 f2 90 01 04 23 f2 b9 90 01 04 c1 c9 05 b8 90 01 04 35 90 01 04 e9 0b 01 00 00 90 00 } //10
