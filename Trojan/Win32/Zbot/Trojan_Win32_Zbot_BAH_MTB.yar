...
rule Trojan_Win32_Zbot_BAH_MTB{
	...
	strings :
		$a_03_0 = {8b ec c7 05 90 02 04 7e d2 4a 50 c7 05 90 02 04 61 00 00 00 c7 05 90 02 04 e6 ff be 09 c7 05 90 02 04 62 00 00 00 c7 05 90 02 04 a0 f0 76 e0 c7 05 90 02 04 63 00 00 00 c7 05 90 02 04 3e a2 aa ac c7 05 90 02 04 64 00 00 00 c7 05 90 02 04 ca f3 a2 81 90 00 } //2
