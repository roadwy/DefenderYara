...
rule Trojan_Win32_Zbot_GIM_MTB{
	...
	strings :
		$a_02_0 = {8b 5d d8 c1 cb 13 0f b6 03 43 43 c1 cb ?? 89 5d d8 b9 18 00 00 00 c1 c1 03 3b c1 72 23 2b c1 03 c0 8b 55 fc 81 c2 ?? ?? ?? ?? 03 d0 03 d0 81 c2 ?? ?? ?? ?? 89 55 fc 85 c0 75 c5 c3 } //10
