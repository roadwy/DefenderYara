...
rule Trojan_Win32_Zbot_RPY_MTB{
	...
	strings :
		$a_03_0 = {56 56 68 00 00 04 00 ff 15 90 01 03 00 8b 4c 24 10 83 c1 0a 51 6a 08 50 ff 15 90 01 03 00 ff 74 24 10 8b f8 53 57 e8 8c 36 00 00 83 c4 0c 56 56 57 ff 15 90 00 } //1
