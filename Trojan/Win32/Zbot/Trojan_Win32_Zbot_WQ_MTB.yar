...
rule Trojan_Win32_Zbot_WQ_MTB{
	...
	strings :
		...
		$a_02_1 = {56 33 de 33 f3 33 de 5e 81 c3 90 01 04 83 ec 90 01 01 c7 04 24 90 01 04 54 68 32 01 00 00 83 ec 90 01 01 89 3c 24 83 ec 90 01 01 89 04 24 ff 13 8d 07 8b 40 90 01 01 03 c7 8b 40 29 90 00 } //10
