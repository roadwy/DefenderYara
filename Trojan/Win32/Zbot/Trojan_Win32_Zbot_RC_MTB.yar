...
rule Trojan_Win32_Zbot_RC_MTB{
	...
	strings :
		$a_03_0 = {05 0b 42 51 00 8b 0d ?? ?? ?? ?? bb ?? ?? ?? ?? 30 03 43 49 85 c9 75 f8 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_Win32_Zbot_RC_MTB_2{
	...
	strings :
		$a_02_0 = {b8 6b fa 03 00 01 85 ?? ?? ?? ?? 8b 85 ?? ?? ?? ?? 8a 0c 30 a1 ?? ?? ?? ?? 88 0c 30 46 8b 0d ?? ?? ?? ?? 3b f1 72 } //1
...
rule Trojan_Win32_Zbot_RC_MTB_3{
	...
	strings :
		$a_03_0 = {98 6c 00 8b c6 05 ?? 98 6c 00 ec c6 05 ?? 98 6c 00 83 c6 05 ?? 98 6c 00 c4 c6 05 ?? 98 6c 00 f0 c6 05 ?? 98 6c 00 b8 c6 05 ?? 98 6c 00 00 c6 05 ?? 98 6c 00 05 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
