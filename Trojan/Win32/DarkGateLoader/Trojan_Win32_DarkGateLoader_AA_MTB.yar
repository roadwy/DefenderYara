...
rule Trojan_Win32_DarkGateLoader_AA_MTB{
	...
	strings :
		...
		$a_03_1 = {89 16 8d 57 04 8b 12 33 90 90 90 01 02 00 00 8d 4e 04 89 11 8d 57 08 8b 12 33 90 90 90 01 02 00 00 8d 4e 08 89 11 8d 57 0c 8b 12 33 90 90 90 01 02 00 00 8d 4e 0c 89 11 33 d2 8a 16 8a 92 90 01 04 88 17 90 00 } //100
		$a_03_2 = {88 57 0f 8b 90 90 90 01 02 00 00 31 17 8d 57 04 8b 88 90 01 02 00 00 31 0a 8d 57 08 8b 88 90 01 02 00 00 31 0a 8d 57 0c 8b 80 90 01 02 00 00 31 02 90 00 } //100
