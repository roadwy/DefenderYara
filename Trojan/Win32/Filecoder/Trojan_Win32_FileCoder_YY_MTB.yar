...
rule Trojan_Win32_FileCoder_YY_MTB{
	...
	strings :
		...
		$a_03_1 = {6a 40 68 00 10 00 00 52 53 90 0a 40 00 c6 05 90 01 04 41 c6 05 90 01 04 6c c6 05 90 01 04 6c c6 05 90 01 04 6f c6 05 90 01 04 63 c6 05 90 01 04 00 ff 15 90 01 04 8b 15 90 00 } //1
	condition:
