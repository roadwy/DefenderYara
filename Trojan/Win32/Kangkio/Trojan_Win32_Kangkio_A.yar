...
rule Trojan_Win32_Kangkio_A{
	...
	strings :
		...
		$a_02_3 = {68 7a 29 40 00 64 a1 00 00 00 00 50 64 89 25 00 00 00 00 51 56 57 8b f9 6a 00 e8 90 01 02 00 00 83 c4 04 8b cf e8 90 01 02 00 00 68 90 01 02 40 00 6a 00 6a 00 ff 15 90 01 02 40 00 8b f0 85 f6 74 2f ff 15 90 01 02 40 00 3d b7 00 00 00 75 22 56 ff 15 48 30 40 00 6a 00 ff 15 34 30 40 00 90 00 } //3
	condition:
