...
rule Trojan_Win32_VBKrypt_AB_MTB{
	...
	strings :
		$a_02_0 = {8b 55 d8 8b 52 0c 8b 49 0c 8a 14 1a 8b 7d 94 32 14 39 83 c6 01 88 14 01 8b 45 e8 0f 80 ?? ?? ?? ?? 3b f0 7e 02 33 f6 8b 45 e4 83 c0 01 0f 80 ?? ?? ?? ?? 89 45 e4 e9 ?? ff ff ff } //1
