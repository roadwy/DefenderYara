...
rule Trojan_Win32_VBKrypt_AP_MTB_2{
	...
	strings :
		$a_01_0 = {44 00 65 00 63 00 69 00 73 00 69 00 6f 00 6e 00 73 00 6d 00 6f 00 64 00 65 00 6c 00 6c 00 65 00 6e 00 } //01 00 
		$a_01_1 = {53 00 54 00 4f 00 52 00 42 00 52 00 49 00 54 00 41 00 4e 00 4e 00 49 00 45 00 4e 00 53 00 } //01 00 
		$a_01_2 = {42 00 55 00 53 00 54 00 45 00 52 00 4d 00 49 00 4e 00 41 00 4c 00 45 00 52 00 4e 00 45 00 53 00 } //01 00 
		$a_01_3 = {50 41 52 4b 45 52 49 4e 47 53 4c 59 47 54 45 52 } //01 00 
		$a_01_4 = {53 4d 41 41 42 4f 52 47 45 52 4c 49 47 53 54 45 } //01 00 
		$a_01_5 = {4e 4f 4e 41 50 50 45 41 4c 49 4e 47 4c 59 } //00 00 
	condition:
		any of ($a_*)
