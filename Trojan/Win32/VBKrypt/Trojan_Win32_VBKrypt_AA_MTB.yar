...
rule Trojan_Win32_VBKrypt_AA_MTB{
	...
	strings :
		$a_02_0 = {8b c8 8b c6 99 f7 f9 8b 45 ac 66 33 1c 50 8b 4d 08 8b 31 8d 55 d0 52 ff 15 90 01 04 8b 4d 08 8b 11 2b 42 14 8b 4e 0c 88 1c 01 8d 4d 84 90 00 } //1
		$a_02_1 = {8b c8 8b c6 99 f7 f9 8b 45 ac 66 33 1c 50 8b 4d 0c 8b 31 8d 55 d0 52 ff 15 90 01 04 8b 4d 0c 8b 11 2b 42 14 8b 4e 0c 88 1c 01 8d 4d 84 90 00 } //1
