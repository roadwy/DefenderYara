...
rule Trojan_Win32_Thedlowner_A{
	...
	strings :
		$a_01_0 = {4e 55 52 5c 4e 4f 49 53 52 45 56 54 4e 45 52 52 55 43 5c 53 57 4f 44 4e 49 57 5c 54 46 4f 53 4f 52 43 49 4d 5c 45 52 41 57 54 46 4f 53 } //01 00  NUR\NOISREVTNERRUC\SWODNIW\TFOSORCIM\ERAWTFOS
		...
		$a_01_4 = {5c 6c 6f 61 64 65 72 49 6e 69 2e 69 6e 69 } //00 00  \loaderIni.ini
	condition:
		any of ($a_*)
