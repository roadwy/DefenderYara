...
rule Trojan_Win32_CrypterX_DSK_MTB{
	...
	strings :
		$a_01_0 = {58 54 6e 2a 45 31 72 4a 5a 63 64 43 41 7b 32 63 79 72 49 51 6e 73 43 73 30 } //01 00  XTn*E1rJZcdCA{2cyrIQnsCs0
		$a_01_1 = {67 79 58 44 56 70 30 76 74 53 35 5a 75 6a 73 } //01 00  gyXDVp0vtS5Zujs
