...
rule Trojan_Win32_RanumBot_MT_MTB{
	...
	strings :
		...
		$a_02_3 = {46 69 6c 65 55 52 4c 20 73 74 72 69 6e 67 90 02 09 66 69 6c 65 5f 75 72 6c 90 00 } //1
		$a_02_4 = {52 75 6e 41 73 54 49 20 62 6f 6f 6c 90 02 09 72 75 6e 61 73 74 69 90 00 } //1
	condition:
