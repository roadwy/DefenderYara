...
rule Trojan_Win32_Vodvit_B{
	...
	strings :
		...
		$a_01_1 = {61 75 5f 75 70 64 61 74 61 2e 65 78 65 } //01 00  au_updata.exe
		$a_01_2 = {61 75 63 6f 64 65 5f 31 39 39 32 5f 30 39 31 35 } //01 00  aucode_1992_0915
		$a_01_3 = {61 75 6c 69 73 74 2e 74 78 74 } //00 00  aulist.txt
	condition:
		any of ($a_*)
