...
rule Trojan_Win32_Misfox_A_{
	meta:
		description = "Trojan:Win32/Misfox.A!!Misfox.gen!A,SIGNATURE_TYPE_ARHSTR_EXT,04 00 04 00 04 00 00 01 00 "
	...
	strings :
		...
		$a_01_3 = {47 6c 6f 62 61 6c 5c 6d 73 69 66 66 30 78 31 } //00 00  Global\msiff0x1
	condition:
		any of ($a_*)
