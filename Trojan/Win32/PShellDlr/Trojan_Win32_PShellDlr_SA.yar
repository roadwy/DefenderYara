...
rule Trojan_Win32_PShellDlr_SA{
	...
	strings :
		...
		$a_02_2 = {64 00 6f 00 77 00 6e 00 6c 00 6f 00 61 00 64 00 73 00 74 00 72 00 69 00 6e 00 67 00 28 00 90 02 02 68 00 74 00 74 00 70 00 90 02 01 3a 00 2f 00 2f 00 90 00 } //1
	condition:
