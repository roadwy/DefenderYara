...
rule Trojan_Win32_Sluegot_D{
	...
	strings :
		...
		$a_01_3 = {00 64 6f 77 6e 66 69 6c 65 00 } //01 00 
		$a_01_4 = {28 69 6e 66 6f 29 25 73 2d 3e 25 73 3a 25 73 } //01 00 
		$a_01_5 = {72 61 6e 64 73 3d 25 73 26 61 63 63 3d 25 73 26 } //00 00 
	condition:
		any of ($a_*)
