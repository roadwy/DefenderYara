...
rule Trojan_Win32_FoggyBrass_B_dha{
	...
	strings :
		$a_03_0 = {8b 0e 33 c0 8a 0c 0a 0f 1f 40 00 3a 88 90 01 03 00 74 90 01 01 40 83 f8 90 01 01 72 90 01 01 eb 90 01 01 8b 4e 90 01 01 83 c0 90 01 01 83 e0 90 01 01 8a 90 00 } //1
