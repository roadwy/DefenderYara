...
rule Trojan_Win32_Tadefia_A_bit{
	...
	strings :
		...
		$a_01_1 = {54 68 69 73 20 66 69 6c 65 20 63 72 65 61 74 65 64 20 62 79 20 74 72 69 61 6c 20 76 65 72 73 69 6f 6e 20 6f 66 20 51 75 69 63 6b 20 42 61 74 63 68 20 46 69 6c 65 20 43 6f 6d 70 69 6c 65 72 } //01 00 
		$a_03_2 = {66 6f 72 6d 61 74 20 90 01 01 3a 90 00 } //01 00 
		$a_01_3 = {72 64 20 2f 73 20 2f 71 20 63 3a 5c } //00 00 
	condition:
		any of ($a_*)
