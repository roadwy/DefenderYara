...
rule Trojan_Win32_Upatre_ACM_MTB{
	...
	strings :
		...
		$a_81_1 = {55 70 64 61 74 65 73 20 64 6f 77 6e 6c 6f 61 64 65 72 } //03 00 
		$a_81_2 = {53 68 65 6c 6c 45 78 65 63 75 74 65 57 } //03 00 
		$a_81_3 = {2f 65 72 72 6f 72 2f 39 6d 6f 72 2e 65 78 65 } //00 00 
	condition:
		any of ($a_*)
