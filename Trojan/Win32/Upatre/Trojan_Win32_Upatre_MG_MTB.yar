...
rule Trojan_Win32_Upatre_MG_MTB{
	...
	strings :
		...
		$a_01_2 = {58 00 6f 00 76 00 65 00 66 00 78 00 75 00 } //01 00 
		$a_01_3 = {2f 00 69 00 6d 00 61 00 67 00 65 00 73 00 2f 00 6e 00 65 00 77 00 2f 00 54 00 41 00 52 00 47 00 54 00 73 00 70 00 2e 00 65 00 78 00 65 00 } //00 00 
	condition:
		any of ($a_*)
