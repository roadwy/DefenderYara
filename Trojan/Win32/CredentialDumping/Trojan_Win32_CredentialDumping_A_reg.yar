...
rule Trojan_Win32_CredentialDumping_A_reg{
	...
	strings :
		$a_00_0 = {72 00 65 00 67 00 62 00 61 00 63 00 6b 00 75 00 70 00 33 00 } //65526 regbackup3
		$a_00_1 = {5c 00 72 00 61 00 70 00 69 00 64 00 37 00 5c 00 } //65526 \rapid7\
	...
	condition:
		((#a_00_0  & 1)*65526+(#a_00_1  & 1)*65526+(#a_00_2  & 1)*1+(#a_00_3  & 1)*1+(#a_00_4  & 1)*1) >=3
