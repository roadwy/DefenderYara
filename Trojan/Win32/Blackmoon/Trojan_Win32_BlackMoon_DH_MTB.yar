...
rule Trojan_Win32_BlackMoon_DH_MTB{
	...
	strings :
		...
		$a_01_2 = {68 75 74 61 6f 2e 70 78 78 68 74 2e 69 63 75 2f 64 6f 77 6e 6c 6f 61 64 2e 65 78 65 } //01 00 
		$a_01_3 = {73 74 66 75 31 2e 70 69 78 78 76 76 2e 63 6c 75 62 } //00 00 
	condition:
		any of ($a_*)
