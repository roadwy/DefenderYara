...
rule Trojan_Win32_Zenpack_NEAD_MTB{
	...
	strings :
		...
		$a_01_1 = {77 00 65 00 72 00 65 00 2e 00 6f 00 6e 00 65 00 36 00 6d 00 75 00 6c 00 74 00 69 00 70 00 6c 00 79 00 6c 00 63 00 72 00 65 00 61 00 74 00 75 00 72 00 65 00 2e 00 } //00 00  were.one6multiplylcreature.
	condition:
		any of ($a_*)
