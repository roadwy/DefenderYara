...
rule Trojan_Win32_Zenpack_EB_MTB_13{
	...
	strings :
		...
		$a_01_1 = {4f 75 74 70 75 74 44 65 62 75 67 53 74 72 69 6e 67 41 } //01 00 
		$a_01_2 = {4c 6f 61 64 52 65 73 6f 75 72 63 65 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Zenpack_EB_MTB_14{
	...
	strings :
		$a_01_0 = {41 4f 49 6a 38 39 73 67 68 6a 34 73 69 6f 68 6a 72 68 } //01 00 
		$a_01_1 = {49 6f 73 62 76 73 65 72 69 6f 48 6a 65 72 49 73 68 } //01 00 
		$a_01_2 = {4f 70 78 76 62 73 65 67 65 34 68 72 68 69 72 74 6a } //01 00 
		$a_01_3 = {55 79 69 61 77 73 70 72 67 6a 77 34 30 67 68 73 72 65 68 } //01 00 
		$a_01_4 = {69 6f 73 67 6f 34 6a 67 73 72 6f 68 73 6a 72 6f 68 69 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Zenpack_EB_MTB_15{
	...
	strings :
		$a_01_0 = {6d 00 75 00 6c 00 74 00 69 00 70 00 6c 00 79 00 74 00 4e 00 35 00 54 00 68 00 69 00 6e 00 67 00 71 00 66 00 69 00 66 00 74 00 68 00 } //01 00 
		$a_01_1 = {50 00 72 00 65 00 70 00 6c 00 65 00 6e 00 69 00 73 00 68 00 69 00 77 00 68 00 6f 00 73 00 65 00 61 00 44 00 42 00 73 00 } //01 00 
		$a_01_2 = {70 00 79 00 64 00 69 00 76 00 69 00 64 00 65 00 64 00 79 00 6f 00 75 00 2e 00 6c 00 6c 00 6c 00 } //01 00 
		$a_01_3 = {6d 00 6f 00 76 00 69 00 6e 00 67 00 66 00 6f 00 77 00 6c 00 74 00 68 00 65 00 6c 00 62 00 72 00 69 00 6e 00 67 00 } //01 00 
		$a_01_4 = {63 00 72 00 65 00 65 00 70 00 69 00 6e 00 67 00 2c 00 4c 00 35 00 48 00 43 00 61 00 6e 00 2e 00 74 00 } //01 00 
		$a_01_5 = {54 00 68 00 65 00 33 00 4c 00 41 00 58 00 69 00 6e 00 2e 00 67 00 49 00 74 00 73 00 65 00 6c 00 66 00 6e 00 } //00 00 
	condition:
		any of ($a_*)
