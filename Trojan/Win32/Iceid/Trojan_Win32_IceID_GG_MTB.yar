...
rule Trojan_Win32_IceID_GG_MTB{
	...
	strings :
		$a_02_0 = {8b fa 8d 84 3d 90 02 04 8a 10 88 16 88 18 0f b6 90 02 02 0f b6 90 02 02 03 c2 99 8b f1 f7 fe 8b 85 90 02 04 8a 94 90 02 05 30 10 40 83 7d 90 02 02 00 89 85 90 02 04 75 90 0a 88 00 ff 4d 90 02 02 40 33 d2 90 00 } //1
