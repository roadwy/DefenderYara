...
rule Trojan_Win32_Ozopige_A{
	...
	strings :
		$a_03_0 = {ba 7a 00 00 00 b8 61 00 00 00 e8 90 01 04 8b d0 8d 45 e4 e8 90 01 04 8b 55 e4 8d 45 ec e8 90 01 04 ff 45 f4 ff 4d e8 75 d4 90 00 } //1
		$a_03_1 = {83 f8 03 74 30 68 90 01 04 6a 00 6a 00 e8 90 01 04 a3 90 01 04 e8 90 01 04 3d b7 00 00 00 0f 84 90 00 } //1
