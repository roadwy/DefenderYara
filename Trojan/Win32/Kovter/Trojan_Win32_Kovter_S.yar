...
rule Trojan_Win32_Kovter_S{
	...
	strings :
		$a_03_0 = {8b 72 28 6a 18 59 31 ff 31 c0 ac 3c 61 7c 02 2c 20 c1 cf 0d 01 c7 e2 f0 81 ff ?? ?? ?? ?? 8b 5a 10 8b 12 75 db } //1
		...
		$a_03_3 = {03 cb 81 39 52 65 67 4f 75 ?? 8d 41 04 81 38 70 65 6e 4b 75 50 } //1
