...
rule Trojan_Win32_Kolbot_A{
	...
	strings :
		...
		$a_00_1 = {4e 75 6a 5a 6f 56 4e 4d 5a 2b 32 61 43 44 } //01 00 
		$a_00_2 = {76 6d 6f 37 72 39 50 2b 59 4d 79 46 35 79 35 4d 43 4b 6c 67 59 4e 37 59 37 66 56 69 33 36 4c 58 31 6d 65 47 6b 44 } //0a 00 
