...
rule Trojan_Win32_Downloader_BI_MTB{
	...
	strings :
		...
		$a_01_2 = {50 61 79 6c 6f 61 64 20 50 6f 73 69 74 69 6f 6e } //01 00  Payload Position
		$a_01_3 = {56 69 72 74 75 61 6c 41 6c 6c 6f 63 } //01 00  VirtualAlloc
		$a_01_4 = {44 3a 5c 72 75 6e 6e 65 72 5c 73 6f 75 72 63 65 73 5c 72 75 6e 6e 65 72 2e 64 70 72 } //00 00  D:\runner\sources\runner.dpr
	condition:
		any of ($a_*)
