...
rule Trojan_Win32_Downloader_MG_MTB{
	...
	strings :
		...
		$a_03_1 = {8b 45 f0 88 08 8b 4d f0 83 c1 01 89 4d f0 8b 55 f8 0f b6 42 02 0f b6 88 ?? ?? ?? ?? c1 e1 06 8b 55 f8 0f b6 42 03 0f b6 ?? ?? ?? ?? ?? 0b ca 8b 45 f0 88 08 8b 4d f0 83 c1 01 89 4d f0 8b 55 f8 83 c2 04 89 55 f8 8b 45 f4 83 e8 04 89 45 f4 e9 } //1
	condition:
