...
rule Trojan_Win32_Downloader_CS_eml{
	...
	strings :
		$a_03_0 = {30 30 31 2e 65 78 65 90 0a 18 00 43 3a 5c 50 72 6f 67 72 61 6d 20 46 69 6c 65 73 5c } //2
		...
		$a_03_4 = {31 31 30 33 2f 90 0a 20 00 68 74 74 70 3a 2f 2f [0-0f] 2f } //2
	condition:
