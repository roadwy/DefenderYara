...
rule Trojan_Win32_Downloader_BG_MTB{
	...
	strings :
		...
		$a_01_2 = {70 00 61 00 73 00 74 00 65 00 62 00 69 00 6e 00 2e 00 63 00 6f 00 6d 00 } //01 00 
		$a_01_3 = {32 00 31 00 32 00 2e 00 31 00 39 00 33 00 2e 00 33 00 30 00 2e 00 32 00 39 00 } //00 00 
	condition:
		any of ($a_*)
