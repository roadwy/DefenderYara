...
rule Trojan_Win32_Vebeesc_A{
	...
	strings :
		...
		$a_02_5 = {c7 45 fc 17 00 00 00 c7 85 c8 fe ff ff 90 01 03 00 c7 85 c0 fe ff ff 08 00 00 00 c7 85 b8 fe ff ff 90 01 03 00 c7 85 b0 fe ff ff 08 00 00 00 8d 95 c0 fe ff ff 52 8d 45 b0 50 8d 8d 60 ff ff ff 51 90 00 } //1
	condition:
