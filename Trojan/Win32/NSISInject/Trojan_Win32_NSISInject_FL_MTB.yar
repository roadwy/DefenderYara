...
rule Trojan_Win32_NSISInject_FL_MTB{
	...
	strings :
		...
		$a_03_1 = {88 14 08 8b 45 f8 83 c0 01 89 45 f8 8b 45 f8 3b 45 f0 0f 83 90 01 04 e9 90 01 04 8b 45 f4 31 c9 89 04 24 c7 44 24 04 00 00 00 00 ff 15 90 01 04 83 ec 08 c7 45 fc 00 00 00 00 8b 45 fc 83 c4 34 5d c3 90 00 } //1
	condition:
