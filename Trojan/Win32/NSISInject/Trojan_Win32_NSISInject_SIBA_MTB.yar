...
rule Trojan_Win32_NSISInject_SIBA_MTB{
	...
	strings :
		...
		$a_03_1 = {88 0a 8b 45 ?? 03 45 ?? 8a 08 80 c1 ?? 8b 55 90 1b 00 03 55 90 1b 01 88 0a } //1
		$a_03_2 = {88 0a 8b 45 ?? 03 45 ?? 0f b6 08 83 f1 ?? 8b 55 90 1b 00 03 55 90 1b 01 88 0a } //1
		$a_03_3 = {88 0a 8b 45 ?? 03 45 ?? 0f b6 08 81 e9 ?? ?? ?? ?? 8b 55 90 1b 00 03 55 90 1b 01 88 0a } //1
	condition:
