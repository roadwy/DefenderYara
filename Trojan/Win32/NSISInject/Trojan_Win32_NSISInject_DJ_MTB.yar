...
rule Trojan_Win32_NSISInject_DJ_MTB{
	...
	strings :
		...
		$a_03_1 = {c1 fe 02 0f b6 3d 90 01 04 c1 e7 06 89 f0 09 f8 a2 90 01 04 0f b6 35 90 09 1b 00 88 0d 90 01 04 0f b6 35 90 01 04 29 f0 a2 90 01 04 0f b6 35 90 00 } //1
	condition:
