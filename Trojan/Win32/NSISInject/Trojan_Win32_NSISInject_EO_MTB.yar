...
rule Trojan_Win32_NSISInject_EO_MTB{
	...
	strings :
		...
		$a_01_2 = {47 65 74 43 6f 6d 6d 61 6e 64 4c 69 6e 65 57 } //01 00  GetCommandLineW
		$a_01_3 = {56 69 72 74 75 61 6c 41 6c 6c 6f 63 } //01 00  VirtualAlloc
		$a_01_4 = {43 72 65 61 74 65 46 69 6c 65 57 } //01 00  CreateFileW
		$a_01_5 = {52 65 61 64 46 69 6c 65 } //01 00  ReadFile
		$a_01_6 = {47 65 74 46 69 6c 65 53 69 7a 65 } //00 00  GetFileSize
	condition:
		any of ($a_*)
