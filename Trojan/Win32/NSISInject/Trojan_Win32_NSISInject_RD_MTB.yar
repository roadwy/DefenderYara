...
rule Trojan_Win32_NSISInject_RD_MTB{
	...
	strings :
		$a_03_0 = {b8 ab aa aa aa f7 e1 c1 ea 03 8d 14 52 03 d2 03 d2 8b c1 2b c2 8a 90 01 05 30 14 0e 41 3b cf 72 dd 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_Win32_NSISInject_RD_MTB_2{
	...
	strings :
		$a_03_0 = {b8 ab aa aa aa f7 e6 8b c6 c1 ea 03 8d 0c 52 c1 e1 02 2b c1 8a 80 90 01 04 30 04 1e 46 3b f7 72 de 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_Win32_NSISInject_RD_MTB_3{
	...
	strings :
		$a_03_0 = {31 c0 c7 04 24 00 00 00 00 c7 44 24 04 00 09 3d 00 c7 44 24 08 00 30 00 00 c7 44 24 0c 40 00 00 00 ff 15 90 02 35 83 7d f4 00 0f 84 1d 00 00 00 8b 45 ec c6 00 00 8b 45 ec 83 c0 01 89 45 ec 8b 45 f4 83 c0 ff 89 45 f4 e9 d9 ff ff ff 8b 45 10 31 c9 89 04 24 c7 44 24 04 00 00 00 80 c7 44 24 08 01 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
