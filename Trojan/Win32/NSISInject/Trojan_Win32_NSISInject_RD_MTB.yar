...
rule Trojan_Win32_NSISInject_RD_MTB_4{
	...
	strings :
		$a_01_0 = {47 61 72 64 65 6e 6d 61 6b 69 6e 67 2e 6c 6e 6b } //01 00 
		$a_01_1 = {53 6f 66 74 77 61 72 65 5c 55 6e 67 64 6f 6d 73 73 65 6b 74 69 6f 6e 65 72 } //01 00 
		$a_01_2 = {54 61 6b 69 73 74 6f 73 6b 6f 70 73 32 33 30 2e 6c 6e 6b } //01 00 
		$a_01_3 = {43 68 65 6c 61 74 69 6f 6e 73 2e 69 6e 69 } //01 00 
		$a_01_4 = {55 6e 69 6e 73 74 61 6c 6c 5c 4f 76 65 72 68 61 6e 67 73 } //01 00 
		$a_01_5 = {41 70 70 65 74 69 74 6c 73 65 73 74 65 73 2e 64 6c 6c } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win32_NSISInject_RD_MTB_5{
	...
	strings :
		$a_01_0 = {53 00 6f 00 66 00 74 00 77 00 61 00 72 00 65 00 5c 00 50 00 6c 00 61 00 64 00 72 00 65 00 6e 00 64 00 65 00 } //01 00 
		$a_01_1 = {50 00 72 00 65 00 61 00 73 00 73 00 69 00 67 00 6e 00 73 00 2e 00 69 00 6e 00 69 00 } //01 00 
		$a_01_2 = {41 00 6e 00 74 00 69 00 6d 00 65 00 6e 00 73 00 69 00 75 00 6d 00 2e 00 64 00 6c 00 6c 00 } //01 00 
		$a_01_3 = {41 00 6e 00 65 00 6e 00 63 00 65 00 70 00 68 00 61 00 6c 00 69 00 61 00 2e 00 69 00 6e 00 69 00 } //01 00 
		$a_01_4 = {55 00 6e 00 69 00 6e 00 73 00 74 00 61 00 6c 00 6c 00 5c 00 42 00 6c 00 6f 00 64 00 72 00 69 00 67 00 74 00 } //00 00 
	condition:
		any of ($a_*)
