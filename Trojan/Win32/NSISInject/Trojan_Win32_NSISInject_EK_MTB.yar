...
rule Trojan_Win32_NSISInject_EK_MTB{
	...
	strings :
		...
		$a_03_4 = {8b 3c 24 40 eb ?? 8b 04 24 ff e0 83 c4 0c 5e 5f 5b 5d c3 90 09 04 00 39 c5 74 } //1
		$a_03_5 = {8b 75 f0 40 eb ?? 8b 45 f0 ff e0 81 f1 bd cb 00 00 4a 81 e3 2f e1 00 00 81 ea 51 57 00 00 c2 60 32 90 09 04 00 39 c3 74 } //1
		$a_03_6 = {40 39 c6 0f 85 ?? ?? ff ff 8b 04 24 ff e0 83 c4 0c 5e 5f 5b c3 } //1
	condition:
