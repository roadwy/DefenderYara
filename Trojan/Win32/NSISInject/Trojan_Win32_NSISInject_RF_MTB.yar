...
rule Trojan_Win32_NSISInject_RF_MTB_2{
	...
	strings :
		$a_01_0 = {41 67 67 72 65 67 61 74 66 75 6e 6b 74 69 6f 6e 65 72 6e 65 5c 53 75 62 74 65 78 74 2e 49 6e 74 } //01 00  Aggregatfunktionerne\Subtext.Int
		$a_01_1 = {4d 75 6c 74 69 6c 61 6d 69 6e 61 74 65 64 5c 57 61 72 6c 6f 63 6b 72 79 2e 69 6e 69 } //01 00  Multilaminated\Warlockry.ini
		$a_01_2 = {50 69 74 66 61 6c 6c 73 5c 4e 69 6b 6b 65 64 65 2e 69 6e 69 } //01 00  Pitfalls\Nikkede.ini
		$a_01_3 = {42 65 76 69 64 73 74 68 65 64 65 72 73 5c 55 6e 72 65 64 5c 54 68 69 65 6c 6f 2e 6c 6e 6b } //00 00  Bevidstheders\Unred\Thielo.lnk
	condition:
		any of ($a_*)
...
rule Trojan_Win32_NSISInject_RF_MTB_3{
	...
	strings :
		$a_01_0 = {53 00 6f 00 64 00 61 00 76 00 61 00 6e 00 64 00 73 00 66 00 6c 00 61 00 73 00 6b 00 65 00 72 00 73 00 5c 00 67 00 69 00 61 00 6e 00 6e 00 69 00 6e 00 61 00 5c 00 6f 00 72 00 67 00 65 00 6c 00 73 00 } //01 00  Sodavandsflaskers\giannina\orgels
		$a_01_1 = {53 00 75 00 73 00 65 00 6e 00 64 00 65 00 73 00 5c 00 53 00 63 00 72 00 75 00 6d 00 70 00 74 00 69 00 6f 00 6e 00 } //01 00  Susendes\Scrumption
		$a_01_2 = {41 00 65 00 73 00 6f 00 70 00 69 00 61 00 6e 00 5c 00 55 00 6e 00 64 00 65 00 72 00 73 00 74 00 79 00 72 00 2e 00 54 00 65 00 69 00 } //00 00  Aesopian\Understyr.Tei
	condition:
		any of ($a_*)
