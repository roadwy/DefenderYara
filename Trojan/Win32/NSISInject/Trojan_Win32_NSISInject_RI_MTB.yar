...
rule Trojan_Win32_NSISInject_RI_MTB_5{
	...
	strings :
		$a_01_0 = {41 66 74 65 72 73 75 70 70 65 72 2e 69 6e 69 } //01 00  Aftersupper.ini
		$a_01_1 = {4d 69 64 74 73 61 6d 6c 69 6e 67 2e 46 6f 72 } //01 00  Midtsamling.For
		$a_01_2 = {53 75 73 70 65 6e 64 79 6a 72 2e 69 6e 69 } //01 00  Suspendyjr.ini
		$a_01_3 = {53 6f 66 74 77 61 72 65 5c 49 72 72 65 76 6f 63 61 62 6c 79 } //01 00  Software\Irrevocably
		$a_01_4 = {75 6e 63 69 76 69 6c 6e 65 73 73 2e 64 6c 6c } //00 00  uncivilness.dll
	condition:
		any of ($a_*)
...
rule Trojan_Win32_NSISInject_RI_MTB_6{
	...
	strings :
		$a_01_0 = {4c 00 69 00 6e 00 6a 00 65 00 76 00 6f 00 67 00 74 00 65 00 72 00 73 00 31 00 38 00 38 00 2e 00 69 00 6e 00 69 00 } //01 00  Linjevogters188.ini
		$a_01_1 = {45 00 66 00 74 00 65 00 72 00 73 00 70 00 6f 00 72 00 65 00 74 00 2e 00 42 00 72 00 61 00 } //01 00  Eftersporet.Bra
		$a_01_2 = {6d 00 65 00 74 00 61 00 73 00 74 00 6f 00 6d 00 61 00 2e 00 69 00 6e 00 69 00 } //01 00  metastoma.ini
		$a_01_3 = {41 00 6d 00 70 00 68 00 69 00 73 00 74 00 6f 00 6d 00 75 00 6d 00 2e 00 64 00 6c 00 6c 00 } //01 00  Amphistomum.dll
		$a_01_4 = {4b 00 72 00 65 00 61 00 74 00 69 00 63 00 2e 00 69 00 6e 00 69 00 } //01 00  Kreatic.ini
		$a_01_5 = {55 00 65 00 6e 00 69 00 67 00 68 00 65 00 64 00 2e 00 64 00 6c 00 6c 00 } //00 00  Uenighed.dll
	condition:
		any of ($a_*)
