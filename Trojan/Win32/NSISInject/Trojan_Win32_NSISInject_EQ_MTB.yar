...
rule Trojan_Win32_NSISInject_EQ_MTB{
	...
	strings :
		...
		$a_03_2 = {8b 45 f8 03 45 fc 90 02 0f 8b 55 f8 03 55 fc 88 0a e9 90 01 04 8b 45 f8 ff e0 8b e5 5d c2 10 00 90 00 } //1
		$a_03_3 = {88 14 08 8b 45 d0 83 c0 01 89 45 d0 e9 90 01 04 8b 45 e8 ff e0 83 c4 50 5e 5f 5b 5d c3 90 00 } //1
	condition:
