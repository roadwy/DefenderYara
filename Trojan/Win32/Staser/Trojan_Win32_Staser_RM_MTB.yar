...
rule Trojan_Win32_Staser_RM_MTB{
	meta:
		description = "Trojan:Win32/Staser.RM!MTB,SIGNATURE_TYPE_PEHSTR_EXT,06 00 06 00 02 00 00 05 00 "
		
	strings :
		$a_01_0 = {55 8b ec 6a 00 6a 00 ff 15 78 f4 46 00 ff 15 70 f0 46 00 e9 } //01 00 
