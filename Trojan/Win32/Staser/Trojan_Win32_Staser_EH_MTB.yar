...
rule Trojan_Win32_Staser_EH_MTB{
	...
	strings :
		...
		$a_01_1 = {47 65 74 4b 65 79 62 6f 61 72 64 4c 61 79 6f 75 74 4e 61 6d 65 41 } //01 00  GetKeyboardLayoutNameA
		$a_01_2 = {47 65 74 4b 65 79 62 6f 61 72 64 53 74 61 74 65 } //00 00  GetKeyboardState
	condition:
		any of ($a_*)
