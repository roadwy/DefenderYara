...
rule Trojan_Win32_Staser_RO_MTB{
	...
	strings :
		...
		$a_01_1 = {53 00 68 00 75 00 74 00 64 00 6f 00 77 00 6e 00 53 00 63 00 68 00 65 00 64 00 75 00 6c 00 65 00 72 00 2e 00 65 00 78 00 65 00 } //01 00  ShutdownScheduler.exe
		$a_01_2 = {41 00 63 00 65 00 62 00 79 00 74 00 65 00 } //00 00  Acebyte
	condition:
		any of ($a_*)
