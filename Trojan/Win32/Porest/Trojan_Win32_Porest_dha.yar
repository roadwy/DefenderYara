...
rule Trojan_Win32_Porest_dha{
	...
	strings :
		...
		$a_01_3 = {4d 6f 7a 69 6c 6c 61 2f 35 2e 30 20 28 57 69 6e 64 6f 77 73 20 4e 54 20 36 2e 31 3b 20 57 69 6e 33 32 3b 20 78 38 36 3b 20 72 76 3a 32 30 2e 30 29 20 47 65 63 6b 6f 2f 32 30 31 30 30 31 30 31 20 46 69 72 65 66 6f 78 2f 32 30 2e 30 } //00 00 
	condition:
		any of ($a_*)
