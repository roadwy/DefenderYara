...
rule Trojan_Win32_RemcosRAT_NCA_MTB{
	...
	strings :
		$a_03_0 = {77 39 6a 09 e8 94 be ff ff 59 c7 45 fc 90 01 04 8b c6 c1 e8 04 50 e8 a0 e7 ff ff 59 89 45 e0 90 00 } //2
		$a_03_1 = {a1 30 e3 46 00 85 c0 74 22 8b 0d 90 01 04 56 8d 71 fc 3b f0 72 13 8b 06 85 c0 74 02 ff d0 90 00 } //2
