...
rule Trojan_Win32_Glupteba_KS_MTB{
	meta:
		description = "Trojan:Win32/Glupteba.KS!MTB,SIGNATURE_TYPE_PEHSTR_EXT,14 00 14 00 02 00 00 0a 00 "
	...
	strings :
		...
		$a_00_1 = {3d cb d9 0b 00 75 06 81 c1 00 00 00 00 40 3d 3d a6 15 00 7c eb } //00 00 
	condition:
		any of ($a_*)
