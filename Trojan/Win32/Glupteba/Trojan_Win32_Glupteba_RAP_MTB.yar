...
rule Trojan_Win32_Glupteba_RAP_MTB{
	...
	strings :
		$a_03_0 = {8b d0 c1 ea 05 03 d5 8b c8 c1 e1 04 89 54 24 20 03 cb 8d 14 06 33 ca 89 4c 24 10 89 3d 90 01 04 8b 44 24 20 01 05 90 01 04 a1 90 01 04 89 44 24 38 89 7c 24 20 90 00 } //1
