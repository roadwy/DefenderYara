...
rule Trojan_Win32_Glupteba_RPB_MTB{
	...
	strings :
		$a_02_0 = {31 16 41 4f 46 bf 90 01 04 39 de 75 e0 90 00 } //1
	condition:
		((#a_02_0  & 1)*1) >=1
...
rule Trojan_Win32_Glupteba_RPB_MTB_2{
	...
	strings :
		$a_03_0 = {31 18 81 c2 90 01 04 81 e9 90 01 04 81 c0 04 00 00 00 09 fa 39 f0 75 e1 90 00 } //1
		$a_03_1 = {31 30 21 d1 81 c1 90 01 04 81 c0 04 00 00 00 01 d1 39 f8 75 e5 90 00 } //1
	condition:
