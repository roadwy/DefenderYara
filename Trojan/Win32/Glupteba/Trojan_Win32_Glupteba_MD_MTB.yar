...
rule Trojan_Win32_Glupteba_MD_MTB{
	...
	strings :
		$a_02_0 = {03 f1 8b 4d f8 81 45 f8 90 01 04 8b c7 c1 e8 05 03 45 e8 03 cf 33 f1 33 f0 2b de ff 4d f4 c7 05 90 01 08 89 45 fc 0f 85 90 01 04 8b 45 08 89 78 04 5f 5e 89 18 5b c9 c2 90 00 } //3
