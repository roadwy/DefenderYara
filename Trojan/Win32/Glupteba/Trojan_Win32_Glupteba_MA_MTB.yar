...
rule Trojan_Win32_Glupteba_MA_MTB{
	...
	strings :
		$a_02_0 = {7e 49 55 8b 2d 90 01 04 8b ff 81 ff 85 02 00 00 75 14 90 00 } //10
...
rule Trojan_Win32_Glupteba_MA_MTB_2{
	...
	strings :
		$a_02_0 = {0f b6 06 46 85 c0 74 1d bb 90 02 04 8b d6 c7 45 90 02 05 d1 c0 8a fc 8a e6 d1 cb ff 4d fc 75 f3 8b c3 aa 49 75 90 00 } //1
	condition:
		((#a_02_0  & 1)*1) >=1
