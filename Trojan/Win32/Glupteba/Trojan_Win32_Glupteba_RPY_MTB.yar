...
rule Trojan_Win32_Glupteba_RPY_MTB{
	...
	strings :
		$a_01_0 = {31 17 09 db 89 f3 47 4e 39 cf 75 e3 c3 81 eb 01 00 00 00 09 db 8d 14 02 8b 12 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Glupteba_RPY_MTB_2{
	...
	strings :
		$a_01_0 = {50 ff 75 d4 8b 45 fc ff 50 18 8b 55 fc 89 42 28 8d 45 d8 50 8b 45 fc ff 50 1c 8b 45 fc 8b 55 dc 89 50 38 } //00 00 
	condition:
		any of ($a_*)
