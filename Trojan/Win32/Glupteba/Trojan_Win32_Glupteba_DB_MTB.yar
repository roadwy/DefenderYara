...
rule Trojan_Win32_Glupteba_DB_MTB{
	...
	strings :
		$a_03_0 = {89 14 24 b8 d1 05 00 00 01 04 24 8b 04 24 8a 0c 30 8b 15 ?? ?? ?? ?? 88 0c 32 81 c4 10 08 00 00 90 09 06 00 8b 15 } //1
		$a_03_1 = {89 04 24 b8 d1 05 00 00 01 04 24 8b 0c 24 8a 14 31 a1 ?? ?? ?? ?? 88 14 30 81 c4 10 0c 00 00 90 09 05 00 a1 } //1
	condition:
...
rule Trojan_Win32_Glupteba_DB_MTB_2{
	...
	strings :
		$a_03_0 = {8b 4c 24 4c 8b f0 83 64 24 ?? ?? d3 e6 03 74 24 ?? 81 6c 24 ?? aa a0 5b 7e 81 44 24 ?? 62 7e e6 6f 81 44 24 ?? 4d 22 75 0e 8b 4c 24 ?? 8b d0 8b 5c 24 ?? 03 c3 d3 ea 03 54 24 ?? 33 d0 33 d6 2b fa 81 3d ?? ?? ?? ?? fd 13 00 00 75 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
