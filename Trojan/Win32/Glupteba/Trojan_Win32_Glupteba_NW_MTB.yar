...
rule Trojan_Win32_Glupteba_NW_MTB_2{
	...
	strings :
		$a_02_0 = {03 df 03 ca 33 90 02 03 33 90 02 03 89 90 02 03 89 90 02 05 8b 90 02 05 29 90 02 03 8b 90 02 05 29 90 02 03 ff 90 02 05 8b 90 02 03 0f 90 02 05 5f 89 90 02 03 89 90 02 05 c3 90 00 } //1
	condition:
		((#a_02_0  & 1)*1) >=1
