...
rule Trojan_Win32_Glupteba_ASI_MTB{
	...
	strings :
		$a_03_0 = {81 fe c3 e6 12 00 75 05 e8 90 01 04 81 3d 90 01 04 dc 03 00 00 c7 05 90 01 04 f0 a6 46 8e 75 13 6a 00 6a 00 6a 00 6a 00 6a 00 6a 00 68 90 01 04 ff d7 46 81 fe a5 19 15 00 7c 90 00 } //4
