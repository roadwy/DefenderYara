...
rule Trojan_Win32_Glupteba_DSO_MTB{
	...
	strings :
		$a_03_0 = {8b 4d ec 8b 55 f4 8b f3 c1 ee 05 03 75 e4 03 f9 03 d3 33 fa 81 3d 90 01 04 f5 03 00 00 c7 05 90 01 04 36 06 ea e9 75 90 00 } //2
		$a_01_1 = {8b 45 08 8b 4d fc 8b 55 f8 89 08 89 50 04 75 } //1
		$a_03_2 = {8b f3 c1 ee 05 03 74 24 90 01 01 03 f9 8d 14 2b 33 fa 81 3d 90 01 04 f5 03 00 00 c7 05 90 01 04 36 06 ea e9 75 90 00 } //2
