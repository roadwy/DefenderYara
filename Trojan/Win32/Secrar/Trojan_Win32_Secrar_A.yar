...
rule Trojan_Win32_Secrar_A{
	...
	strings :
		$a_03_0 = {89 45 fc 83 7d 08 05 75 ?? 83 7d fc 00 75 ?? c7 45 f4 00 00 00 00 8b 4d 0c 89 4d f8 8b 55 f8 89 55 f4 8b 45 f4 8b 4d f4 03 08 89 4d f8 8b 55 f8 0f b7 42 38 50 } //1
