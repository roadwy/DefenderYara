...
rule Trojan_Win32_Floganix_A{
	...
	strings :
		...
		$a_01_1 = {43 46 6f 78 67 6c 69 6e 61 4d 6f 64 75 6c 65 } //01 00 
		$a_01_2 = {66 6f 78 67 6c 69 6e 61 2e 64 6c 6c 00 4e 53 47 65 74 4d 6f 64 75 6c 65 } //01 00 
		$a_01_3 = {66 69 72 65 68 66 78 74 69 65 7a } //00 00 
	condition:
		any of ($a_*)
