...
rule Trojan_Win32_JackServn_C_bit{
	...
	strings :
		...
		$a_01_1 = {44 30 37 46 35 38 37 31 43 38 38 39 41 30 38 38 46 44 43 41 42 41 39 36 32 38 30 30 33 32 30 33 } //01 00 
		$a_01_2 = {25 63 25 63 25 63 25 63 25 63 25 63 25 63 25 63 25 63 25 63 } //01 00 
		$a_01_3 = {6b 69 6c 6c 66 69 6c 65 2e 62 61 74 } //01 00 
		$a_01_4 = {25 73 5c 25 73 2e 65 78 65 } //00 00 
	condition:
		any of ($a_*)
