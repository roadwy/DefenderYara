...
rule Trojan_Win32_Cydata_A{
	...
	strings :
		$a_00_0 = {63 74 5f 69 6e 69 74 3a 20 6c 65 6e 67 74 68 20 21 3d 20 32 35 36 } //0a 00 
		$a_00_1 = {63 74 5f 69 6e 69 74 3a 20 32 35 36 2b 64 69 73 74 20 21 3d 20 35 31 32 } //01 00 
		$a_00_2 = {68 74 74 70 73 3a 2f 2f 63 62 69 2e 68 61 6e 79 61 6e 67 2e 61 63 2e 6b 72 2f 73 6b 69 6e 2f 70 61 67 65 2f 62 6f 61 72 64 2e 61 73 70 } //01 00 
		$a_00_3 = {68 74 74 70 73 3a 2f 2f 77 77 77 2e 61 73 70 73 2e 63 6f 2e 6b 72 2f 6d 65 64 69 61 2f 76 69 65 77 2e 61 73 70 } //0a 00 
