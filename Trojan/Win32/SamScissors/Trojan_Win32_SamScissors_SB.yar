...
rule Trojan_Win32_SamScissors_SB{
	...
	strings :
		...
		$a_03_3 = {33 c1 45 8b ca 8b c8 c1 e9 90 01 01 33 c1 81 c2 90 01 04 8b c8 c1 e1 90 01 01 33 c1 41 8b c8 90 0a 1e 00 c1 e1 90 00 } //1
		$a_03_4 = {ff d5 48 85 c0 74 90 01 01 81 7b 90 01 01 ca 7d 0f 00 75 90 01 01 48 8d 54 24 90 01 01 48 8d 4c 24 90 01 01 ff d0 8b f8 44 8b 44 24 90 01 01 4c 8d 4c 24 90 01 01 ba 00 10 00 00 48 8b cd ff 15 90 0a 3b 00 ff 15 90 01 04 85 c0 74 90 00 } //1
	condition:
