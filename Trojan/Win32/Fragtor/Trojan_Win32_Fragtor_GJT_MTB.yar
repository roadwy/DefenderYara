...
rule Trojan_Win32_Fragtor_GJT_MTB{
	...
	strings :
		$a_03_0 = {0f b7 ce c1 e9 08 33 d1 66 8b 54 93 04 c1 e6 08 66 33 d6 8b f2 eb ?? 8b 55 f0 0f b6 12 8b 4d ec 81 e1 ?? ?? ?? ?? 33 d1 8b 54 93 04 8b 4d ec c1 e9 08 33 d1 89 55 ec ff 45 f0 48 } //10
