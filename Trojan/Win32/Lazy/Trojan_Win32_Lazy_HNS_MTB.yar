...
rule Trojan_Win32_Lazy_HNS_MTB{
	...
	strings :
		...
		$a_03_1 = {85 c0 78 0d 8b 40 90 01 01 8b 40 90 01 01 8b 00 8b 00 8b 40 90 01 01 c3 90 00 } //2
		$a_03_2 = {8b c3 0f ac c1 90 01 01 0f b7 f1 33 c9 85 f6 74 1a 0f be 14 0b c1 cf 90 01 01 80 3c 0b 90 00 } //2
	condition:
