...
rule Trojan_Win32_Lazy_CC_MTB{
	meta:
		description = "Trojan:Win32/Lazy.CC!MTB,SIGNATURE_TYPE_PEHSTR_EXT,04 00 04 00 04 00 00 01 00 "
		
	strings :
		$a_01_0 = {32 c1 34 0c c0 c8 07 04 21 04 21 2a c1 c0 c8 07 34 0c c0 c0 07 34 0c aa 4a 0f 85 } //01 00 
