...
rule Trojan_Win32_Chymine_A{
	...
	strings :
		...
		$a_00_2 = {52 00 4f 00 4f 00 54 00 5c 00 43 00 49 00 4d 00 56 00 32 00 } //01 00  ROOT\CIMV2
		$a_00_3 = {25 00 73 00 20 00 73 00 68 00 65 00 6c 00 6c 00 33 00 32 00 2e 00 64 00 6c 00 6c 00 2c 00 43 00 6f 00 6e 00 74 00 72 00 6f 00 6c 00 5f 00 52 00 75 00 6e 00 44 00 4c 00 4c 00 41 00 20 00 22 00 25 00 73 00 22 00 } //04 00  %s shell32.dll,Control_RunDLLA "%s"
