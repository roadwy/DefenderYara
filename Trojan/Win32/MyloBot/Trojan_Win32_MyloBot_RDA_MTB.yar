...
rule Trojan_Win32_MyloBot_RDA_MTB{
	...
	strings :
		...
		$a_01_2 = {0f b6 06 33 c1 c1 e9 08 0f b6 c0 33 8c 85 00 fc ff ff 46 83 ea 01 } //2
		$a_03_3 = {0f b6 06 33 c1 c1 e9 08 0f b6 c0 33 0c 85 90 01 04 46 83 ea 01 90 00 } //2
	condition:
