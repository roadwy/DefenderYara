...
rule Trojan_Win32_ProxyChanger_D{
	...
	strings :
		...
		$a_01_2 = {50 4f 53 54 20 2f 69 6e 63 6c 75 64 65 73 2f 61 72 65 6e 61 2d 69 6e 66 65 63 74 2f 63 6f 6e 74 61 5f 69 6e 66 65 63 74 73 2e 70 68 70 20 48 54 54 50 2f 31 2e 30 } //00 00  POST /includes/arena-infect/conta_infects.php HTTP/1.0
	condition:
		any of ($a_*)
