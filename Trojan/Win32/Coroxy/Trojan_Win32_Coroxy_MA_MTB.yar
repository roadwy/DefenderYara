...
rule Trojan_Win32_Coroxy_MA_MTB{
	...
	strings :
		...
		$a_01_2 = {72 75 6e 64 6c 6c } //02 00  rundll
		$a_01_3 = {47 65 74 55 73 65 72 4e 61 6d 65 45 78 41 } //02 00  GetUserNameExA
		$a_01_4 = {73 6f 63 6b 73 33 32 2e 64 6c 6c } //00 00  socks32.dll
	condition:
		any of ($a_*)
