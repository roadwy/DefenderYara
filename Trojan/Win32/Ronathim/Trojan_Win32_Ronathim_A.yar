...
rule Trojan_Win32_Ronathim_A{
	...
	strings :
		...
		$a_01_3 = {73 00 79 00 73 00 74 00 65 00 6d 00 33 00 32 00 5c 00 44 00 53 00 43 00 30 00 33 00 30 00 30 00 31 00 2e 00 65 00 78 00 65 00 } //01 00 
		$a_01_4 = {73 00 79 00 73 00 74 00 65 00 6d 00 33 00 32 00 5c 00 5c 00 54 00 69 00 6d 00 65 00 2e 00 4e 00 41 00 48 00 52 00 4f 00 } //01 00 
		$a_01_5 = {44 00 65 00 73 00 6b 00 74 00 6f 00 70 00 5c 00 4e 00 65 00 77 00 20 00 46 00 6f 00 6c 00 64 00 65 00 72 00 20 00 28 00 32 00 29 00 5c 00 4e 00 65 00 77 00 20 00 46 00 6f 00 6c 00 64 00 65 00 72 00 } //00 00 
	condition:
		any of ($a_*)
