...
rule Trojan_Win32_C2Lop_gen_A{
	...
	strings :
		$a_03_0 = {8d a4 24 00 00 00 00 0f b6 14 37 52 e8 ?? ?? ?? ?? 8b d8 0f b6 44 37 01 50 c0 e3 04 e8 ?? ?? ?? ?? 02 d8 8b c6 d1 e8 03 c5 99 f7 3d ?? ?? ?? ?? 8b 0d ?? ?? ?? ?? 8b 44 24 20 [0-10] 89 44 24 18 32 1c 0a 3b 74 24 14 88 58 ff 7c } //10
		$a_03_1 = {0f b6 14 2e 52 e8 ?? ?? ?? ?? 8b d8 0f b6 44 2e 01 50 c0 e3 04 e8 ?? ?? ?? ?? 02 d8 8b c6 d1 e8 03 44 24 18 8b 0d ?? ?? ?? ?? 99 f7 3d ?? ?? ?? ?? 83 c6 02 83 c4 08 47 32 1c 0a 3b 74 24 14 88 5f ff 7c } //10
