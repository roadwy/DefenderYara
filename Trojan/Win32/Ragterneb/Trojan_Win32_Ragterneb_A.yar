...
rule Trojan_Win32_Ragterneb_A{
	...
	strings :
		$a_00_0 = {64 00 65 00 76 00 5c 00 5f 00 77 00 65 00 62 00 62 00 72 00 6f 00 77 00 73 00 65 00 72 00 73 00 } //01 00 
		$a_00_1 = {26 00 62 00 6f 00 74 00 73 00 3d 00 } //01 00 
