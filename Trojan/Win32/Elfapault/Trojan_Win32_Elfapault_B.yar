...
rule Trojan_Win32_Elfapault_B{
	...
	strings :
		...
		$a_02_2 = {63 3a 5c 50 72 6f 67 72 61 6d 20 46 69 6c 65 73 5c 6c 73 61 73 73 90 01 01 2e 65 78 65 90 00 } //1
		...
		$a_02_6 = {68 74 74 70 3a 2f 2f 90 02 30 2f 65 6c 66 5f 6c 69 73 74 6f 2e 74 78 74 90 00 } //1
		...
		$a_02_10 = {63 3a 5c 50 72 6f 67 72 61 6d 20 46 69 6c 65 73 5c 63 74 66 6d 6f 6e 90 01 01 2e 65 78 65 90 00 } //1
