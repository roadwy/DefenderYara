...
rule Trojan_Win32_AveMariaRat_MW_MTB{
	...
	strings :
		$a_03_0 = {33 c9 41 6b c9 00 8b 55 94 8a 04 02 88 44 0d 90 01 01 33 c0 40 c1 e0 00 33 c9 41 c1 e1 00 8b 55 94 8a 04 02 88 44 0d 90 01 01 33 c0 40 d1 e0 33 c9 41 d1 e1 8b 55 94 8a 04 02 88 44 90 00 } //1
