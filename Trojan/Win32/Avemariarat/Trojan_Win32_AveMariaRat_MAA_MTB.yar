...
rule Trojan_Win32_AveMariaRat_MAA_MTB{
	...
	strings :
		$a_03_0 = {99 f7 bd 6c ff ff ff 89 95 5c ff ff ff 81 7d 90 01 05 74 90 01 01 8b 4d 80 03 4d 90 01 01 0f be 11 8b 85 5c ff ff ff 0f be 4c 05 98 33 d1 8b 45 80 03 45 90 01 01 88 10 eb 90 00 } //1
