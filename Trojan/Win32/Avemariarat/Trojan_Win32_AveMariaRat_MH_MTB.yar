...
rule Trojan_Win32_AveMariaRat_MH_MTB{
	...
	strings :
		$a_03_0 = {83 c1 01 89 4d 00 8b 55 fc 83 ea 01 39 55 00 7f 90 01 01 8b 45 fc 83 e8 01 2b 45 00 8b 4d dc 8b 14 81 f7 d2 89 55 e8 83 7d e8 00 74 90 01 01 8b 45 f8 03 45 00 8a 4d e8 88 08 eb 90 00 } //1
