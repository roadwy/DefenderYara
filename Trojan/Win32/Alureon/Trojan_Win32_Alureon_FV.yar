...
rule Trojan_Win32_Alureon_FV{
	...
	strings :
		...
		$a_03_3 = {81 ec 88 00 00 00 c7 45 c8 18 00 00 00 c7 45 b4 04 00 00 00 c7 45 e4 06 1c c8 16 c7 45 a2 40 00 00 00 c7 45 90 90 00 30 00 00 c7 45 e0 00 80 00 00 } //1
