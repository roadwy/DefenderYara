...
rule Trojan_Win32_Alureon_AL_MTB{
	...
	strings :
		$a_02_0 = {8a 0c 14 52 b2 90 01 02 5a 8a 2f 52 b2 04 90 01 01 5a 32 e9 52 b2 04 90 01 01 5a 88 2f 52 b2 04 90 01 01 5a 47 52 b2 04 90 01 01 5a 4d 52 b2 04 90 01 01 5a 0f 85 90 00 } //1
