...
rule Trojan_Win32_Alureon_BK{
	...
	strings :
		...
		$a_00_6 = {5c 00 6b 00 6e 00 6f 00 77 00 6e 00 64 00 6c 00 6c 00 73 00 5c 00 64 00 6c 00 6c 00 2e 00 64 00 6c 00 6c 00 } //01 00 
		$a_01_7 = {25 73 25 73 25 73 2e 74 6d 70 } //01 00 
		$a_01_8 = {25 73 25 73 2e 73 79 73 } //01 00 
		$a_01_9 = {5c 5c 3f 5c 67 6c 6f 62 61 6c 72 6f 6f 74 5c 73 79 73 74 65 6d 72 6f 6f 74 5c 73 79 73 74 65 6d 33 32 5c 6f 6c 65 33 32 2e 64 6c 6c } //01 00 
		$a_01_10 = {5c 5c 3f 5c 67 6c 6f 62 61 6c 72 6f 6f 74 5c 73 79 73 74 65 6d 72 6f 6f 74 5c 73 79 73 74 65 6d 33 32 5c 6d 73 76 63 72 74 2e 64 6c 6c } //00 00 
	condition:
		any of ($a_*)
