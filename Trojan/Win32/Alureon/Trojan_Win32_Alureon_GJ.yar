...
rule Trojan_Win32_Alureon_GJ{
	...
	strings :
		$a_01_0 = {6a 00 66 00 6c 00 73 00 64 00 6b 00 6a 00 66 00 30 00 30 00 31 00 2e 00 64 00 61 00 74 00 } //3c 00 
		$a_01_1 = {73 68 69 6d 61 6e 6f 73 74 6f 72 65 2e 63 6f 6d 2e 74 77 3a 38 30 3b 73 72 61 6d 73 74 6f 72 65 2e 63 6f 6d 2e 74 77 3a 38 30 } //0a 00 
		$a_01_2 = {8b 78 0c 68 3c 20 00 00 6a 08 51 ff d3 8b f0 33 c0 3b f0 74 76 8b 4d 0c 8d 56 34 89 96 34 20 00 00 89 7e 1c } //05 00 
		$a_01_3 = {25 64 2e 25 64 2e 25 64 5f 25 64 2e 25 64 5f 25 64 } //05 00 
		...
		$a_01_6 = {6b 6e 6f 63 6b 2e 70 68 70 3f 6c 6f 67 3d 25 73 7c 69 64 3d 25 73 7c 6f 73 3d 25 73 20 25 73 7c 76 65 72 73 69 6f 6e 3d 25 75 2e 25 75 2e 25 75 2e 25 75 } //05 00 
		$a_01_7 = {70 65 65 72 63 6d 64 5f 25 75 5f 25 75 2e 25 75 2e 25 75 2e 25 75 3a 25 75 5f 25 75 3d 25 75 } //00 00 
