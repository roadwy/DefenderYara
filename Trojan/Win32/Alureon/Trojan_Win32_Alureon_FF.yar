...
rule Trojan_Win32_Alureon_FF{
	...
	strings :
		...
		$a_01_3 = {5b 50 41 4e 45 4c 5f 53 49 47 4e 5f 43 48 45 43 4b 5d } //01 00 
		$a_01_4 = {47 45 54 5f 50 41 52 41 4d 53 } //01 00 
		$a_01_5 = {5b 72 65 66 65 72 65 72 5f 65 6e 64 5d } //00 00 
	condition:
		any of ($a_*)
