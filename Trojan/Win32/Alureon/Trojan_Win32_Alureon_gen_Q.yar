...
rule Trojan_Win32_Alureon_gen_Q{
	...
	strings :
		$a_03_0 = {8a d0 80 c2 54 30 90 90 90 01 04 40 3b c1 72 f0 90 00 } //1
		$a_03_1 = {6a 1a 50 c7 45 f4 90 01 04 c7 45 f8 90 01 04 ff 15 90 01 04 85 c0 0f 85 aa 00 00 00 90 00 } //1
