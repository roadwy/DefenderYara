...
rule Trojan_Win32_Alureon_gen_J{
	...
	strings :
		$a_03_0 = {24 04 76 0f 8a d1 80 c2 90 01 01 30 14 01 41 3b 4c 24 04 72 f1 90 00 } //2
		$a_03_1 = {39 4c 24 08 76 14 8b 44 24 04 8a d1 03 c1 80 c2 90 01 01 30 10 41 3b 4c 24 08 72 ec 90 00 } //2
		$a_03_2 = {8a c8 80 c1 90 01 01 30 88 90 01 04 40 3d 90 01 04 72 ed 90 00 } //2
		$a_03_3 = {83 2c 24 0a c6 90 03 02 01 44 24 45 90 01 01 b8 89 90 03 02 01 44 24 45 90 01 01 66 c7 90 03 02 01 44 24 45 90 01 01 ff e0 90 00 } //2
		$a_03_4 = {39 28 75 d2 eb 07 8b 1c b5 90 01 04 83 c7 04 81 ff 90 01 04 7c ab 5f 90 00 } //1
		$a_03_5 = {eb 06 8d 58 01 6a 5c 53 ff d7 85 c0 59 59 75 f2 68 90 01 04 53 ff 15 90 01 04 85 c0 59 59 74 07 90 00 } //2
		...
		$a_03_13 = {50 8b 43 28 6a 40 6a 15 03 c7 50 ff 15 90 01 04 8b 43 28 6a 05 90 00 } //2
		$a_03_14 = {8b 46 28 03 45 0c 6a 40 6a 15 50 89 75 f0 ff 15 90 01 04 8b 46 28 8b 4d 0c 8d 34 38 8d 3c 08 6a 05 90 00 } //2
		$a_03_15 = {3b c6 89 45 08 74 47 6a 40 68 00 30 00 00 40 50 56 ff 15 90 01 04 8b f8 3b fe 74 31 90 00 } //2
