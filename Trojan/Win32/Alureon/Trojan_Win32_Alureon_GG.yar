...
rule Trojan_Win32_Alureon_GG{
	...
	strings :
		$a_03_0 = {ff 70 54 57 53 e8 ?? ?? ?? ?? 0f b7 70 06 0f b7 48 14 8d 4c 01 18 85 f6 7e 5d } //1
		$a_03_1 = {c6 04 38 b8 b9 ff e0 00 00 66 89 4c 38 05 8b 06 8b 3d ?? ?? ?? ?? c6 00 fa ff 76 08 ff 36 e8 ?? ?? ?? ?? 59 59 } //1
		$a_03_2 = {8b 5e 0c 8b 09 ff 76 08 03 d9 53 ff 75 ?? e8 } //1
