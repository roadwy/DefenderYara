...
rule Trojan_Win32_Alureon_CO{
	...
	strings :
		$a_03_0 = {8b 44 24 04 8a d1 03 c1 80 c2 90 01 01 30 10 41 3b 4c 24 08 72 ec 90 00 } //2
		$a_03_1 = {8b 48 3c 8d 4c 01 04 90 03 06 09 66 81 49 12 00 20 ba 00 20 00 00 66 09 51 12 90 00 } //1
