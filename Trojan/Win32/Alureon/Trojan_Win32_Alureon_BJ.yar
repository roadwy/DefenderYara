...
rule Trojan_Win32_Alureon_BJ{
	...
	strings :
		...
		$a_01_2 = {68 44 44 41 4d 68 58 4b 4e 53 } //01 00  hDDAMhXKNS
		$a_01_3 = {6a 73 2e 70 68 70 3f 75 3d 25 73 } //01 00  js.php?u=%s
		$a_01_4 = {6b 65 79 77 6f 72 64 20 3d 20 52 65 67 45 78 70 2e 24 31 3b } //00 00  keyword = RegExp.$1;
	condition:
		any of ($a_*)
