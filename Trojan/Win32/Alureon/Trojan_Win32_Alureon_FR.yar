...
rule Trojan_Win32_Alureon_FR{
	...
	strings :
		...
		$a_01_3 = {73 75 62 69 64 3d 25 64 26 73 65 3d 25 73 26 6b 65 79 77 6f 72 64 3d 25 73 } //01 00  subid=%d&se=%s&keyword=%s
		$a_01_4 = {43 6d 64 52 75 6e 45 78 65 55 72 6c 00 43 6d 64 } //00 00  浃剤湵硅啥汲䌀摭
	condition:
		any of ($a_*)
