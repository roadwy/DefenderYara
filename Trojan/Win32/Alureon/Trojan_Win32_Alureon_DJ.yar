...
rule Trojan_Win32_Alureon_DJ{
	...
	strings :
		$a_03_0 = {6a 2f 57 ff 15 90 01 04 85 c0 75 14 56 ff 15 90 01 04 8d 44 30 ff 8b f0 2b f7 83 c6 01 eb 04 8b f0 2b f7 85 c0 74 90 01 01 6a 40 68 00 30 00 00 8d 46 01 50 6a 00 ff 15 90 00 } //2
