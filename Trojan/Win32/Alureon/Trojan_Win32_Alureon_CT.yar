...
rule Trojan_Win32_Alureon_CT{
	...
	strings :
		$a_03_0 = {c6 45 fc 74 c6 45 fd 64 c6 45 fe 6c 33 c0 90 01 01 00 01 00 00 88 90 00 } //2
		$a_03_1 = {c6 45 f8 74 c6 45 f9 64 c6 45 fa 6c 90 03 01 0a 39 33 c0 88 90 01 08 00 01 00 00 90 00 } //2
		...
		$a_03_8 = {76 0f 8a d1 80 c2 90 01 01 30 14 01 41 3b 4c 24 04 72 f1 90 00 } //2
		$a_03_9 = {6a 6d 58 6a 61 66 89 45 90 01 01 58 6a 63 66 89 45 90 01 01 58 6a 68 90 00 } //1
