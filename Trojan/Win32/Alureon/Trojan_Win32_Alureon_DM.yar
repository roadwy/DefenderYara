...
rule Trojan_Win32_Alureon_DM{
	...
	strings :
		...
		$a_01_2 = {5c 5c 3f 5c 67 6c 6f 62 61 6c 72 6f 6f 74 } //01 00  \\?\globalroot
		$a_01_3 = {54 68 72 65 61 64 53 70 61 6d 28 29 31 31 31 31 31 31 31 31 31 31 } //02 00  ThreadSpam()1111111111
