...
rule Trojan_Win32_SystemDiscovery_B_sysinfo{
	meta:
		description = "Trojan:Win32/SystemDiscovery.B!sysinfo,SIGNATURE_TYPE_CMDHSTR_EXT,01 00 01 00 02 00 00 01 00 "
		
	strings :
		$a_00_0 = {73 00 79 00 73 00 74 00 65 00 6d 00 69 00 6e 00 66 00 6f 00 } //f6 ff  systeminfo
