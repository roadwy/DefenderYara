...
rule Trojan_Win32_Gawime_A{
	...
	strings :
		...
		$a_01_1 = {43 3a 5c 74 6d 70 2e 64 6f 77 6e 00 } //01 00 
		...
		$a_01_5 = {69 66 20 25 65 72 72 6f 72 6c 65 76 65 6c 25 3d 3d 31 20 28 67 6f 74 6f 20 6b 69 6c 6c 29 } //01 00 
		$a_01_6 = {74 61 73 6b 6c 69 73 74 20 7c 66 69 6e 64 } //01 00 
		$a_01_7 = {57 69 6e 47 61 6d 65 5f } //01 00 
