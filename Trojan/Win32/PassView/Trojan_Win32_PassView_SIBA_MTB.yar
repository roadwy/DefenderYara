...
rule Trojan_Win32_PassView_SIBA_MTB{
	...
	strings :
		...
		$a_03_3 = {33 db 88 1f 8a 06 90 18 84 c0 90 18 b1 90 01 01 2a cb 32 c8 6a 90 01 01 8d 45 90 01 01 50 80 f1 90 01 01 57 88 4d 90 1b 04 e8 90 01 04 83 c4 0c 43 8a 04 33 84 c0 75 90 00 } //50
	condition:
