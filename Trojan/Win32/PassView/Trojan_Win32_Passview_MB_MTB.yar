...
rule Trojan_Win32_Passview_MB_MTB{
	...
	strings :
		$a_03_0 = {89 47 0c 8b 4d f4 8b 07 89 0c b0 8b 75 0c 8b 4d e4 8b 7d f8 8a 01 88 45 fc 8b d7 8d 45 d0 e8 90 01 04 8b 45 d0 8a 4d fc 88 0c 38 47 89 7d f8 89 5d e8 ff 45 f4 8b 45 f4 38 1c 30 0f 85 90 00 } //1
