...
rule Trojan_Win32_Tionas_C_dha{
	...
	strings :
		...
		$a_00_1 = {74 68 65 75 70 64 61 74 65 } //01 00  theupdate
		$a_00_2 = {75 70 64 61 74 65 72 2e 65 78 65 } //01 00  updater.exe
		$a_00_3 = {69 63 74 33 32 2e 6d 73 6e 61 6d 65 2e 6f 72 67 } //00 00  ict32.msname.org
