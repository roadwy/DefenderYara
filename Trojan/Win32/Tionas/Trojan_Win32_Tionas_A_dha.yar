...
rule Trojan_Win32_Tionas_A_dha{
	...
	strings :
		$a_03_0 = {33 c2 8b 4d 90 01 01 03 4d 90 01 01 88 41 90 00 } //1
		$a_03_1 = {33 c2 8b 4d 90 01 01 03 4d 90 01 01 88 01 90 00 } //1
		$a_03_2 = {83 f9 41 7e 90 01 01 8b 95 04 ff ff ff 0f be 84 15 10 ff ff ff 83 e8 2e 8b 8d 04 ff ff ff 88 84 0d 10 ff ff ff eb 90 00 } //1
