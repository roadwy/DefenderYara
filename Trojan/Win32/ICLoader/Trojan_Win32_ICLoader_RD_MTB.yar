...
rule Trojan_Win32_ICLoader_RD_MTB{
	...
	strings :
		...
		$a_01_1 = {62 00 75 00 72 00 6e 00 69 00 6e 00 67 00 73 00 74 00 75 00 64 00 69 00 6f 00 2e 00 65 00 78 00 65 00 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win32_ICLoader_RD_MTB_2{
	...
	strings :
		...
		$a_01_1 = {43 00 6f 00 72 00 74 00 65 00 78 00 4c 00 61 00 75 00 6e 00 63 00 68 00 65 00 72 00 53 00 65 00 72 00 76 00 69 00 63 00 65 00 2e 00 65 00 78 00 65 00 } //00 00 
	condition:
		any of ($a_*)
