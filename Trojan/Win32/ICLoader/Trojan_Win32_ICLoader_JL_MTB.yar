...
rule Trojan_Win32_ICLoader_JL_MTB{
	...
	strings :
		...
		$a_01_1 = {4e 65 74 77 6f 72 6b 4d 69 6e 65 72 } //01 00  NetworkMiner
		$a_01_2 = {57 69 72 65 73 68 61 72 6b } //01 00  Wireshark
		$a_01_3 = {72 6f 78 69 66 69 65 72 } //01 00  roxifier
		$a_01_4 = {48 54 54 50 20 41 6e 61 6c 79 7a 65 72 } //01 00  HTTP Analyzer
		$a_01_5 = {2f 63 20 74 61 73 6b 6b 69 6c 6c 20 2f 69 6d } //01 00  /c taskkill /im
		$a_01_6 = {2f 66 20 26 20 65 72 61 73 65 } //00 00  /f & erase
	condition:
		any of ($a_*)
