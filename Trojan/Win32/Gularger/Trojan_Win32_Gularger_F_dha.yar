...
rule Trojan_Win32_Gularger_F_dha{
	...
	strings :
		...
		$a_03_1 = {6a 02 8b 45 08 50 8d 4d fc 51 e8 90 01 04 83 c4 0c 6a 02 8b 55 08 83 c2 02 52 8d 85 d4 f6 ff ff 50 e8 90 01 04 83 c4 0c 81 7d fc 00 08 00 00 90 00 } //2
	condition:
