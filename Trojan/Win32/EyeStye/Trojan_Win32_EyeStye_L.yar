...
rule Trojan_Win32_EyeStye_L{
	...
	strings :
		...
		$a_03_1 = {8d 43 ff 3b c8 73 0c 8b 45 08 80 3c 01 3b 75 03 47 8b f1 3b 7d 0c 75 ?? 83 fe ff 74 09 } //1
		$a_03_2 = {ba 17 00 00 00 66 89 16 ff 15 ?? ?? ?? ?? 66 89 46 02 8d 45 ?? 50 8b cf c7 46 04 00 00 00 00 e8 } //1
	condition:
