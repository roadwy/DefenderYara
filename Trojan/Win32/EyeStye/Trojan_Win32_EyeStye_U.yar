...
rule Trojan_Win32_EyeStye_U{
	...
	strings :
		$a_10_0 = {63 6c 65 61 6e 73 77 65 65 70 2e 65 78 65 } //01 00  cleansweep.exe
		$a_10_1 = {5f 5f 53 50 59 4e 45 54 } //01 00  __SPYNET
		$a_10_2 = {2d 25 42 4f 54 4e 41 4d 45 25 } //01 00  -%BOTNAME%
