...
rule Trojan_Win32_EyeStye_2{
	...
	strings :
		...
		$a_01_5 = {2a 44 72 6f 70 70 65 72 2a 21 6d 61 69 6e 20 3a 20 43 72 65 61 74 65 4d 75 74 65 78 2d 3e 45 52 52 4f 52 5f 41 4c 52 45 41 44 59 5f 45 58 49 53 54 53 00 } //65535
	condition:
		((#a_01_0  & 1)*1+(#a_03_1  & 1)*2+(#a_00_2  & 1)*2+(#a_03_3  & 1)*2+(#a_03_4  & 1)*2+(#a_01_5  & 1)*65535) >=5
