...
rule Trojan_Win32_EyeStye{
	...
	strings :
		$a_02_0 = {ff 00 8d 85 90 09 46 00 ff 63 c6 85 ?? ?? ?? ff 6f c6 85 ?? ?? ?? ff 6e c6 85 ?? ?? ?? ff 66 c6 85 ?? ?? ?? ff 69 c6 85 ?? ?? ?? ff 67 c6 85 ?? ?? ?? ff 2e c6 85 ?? ?? ?? ff 62 c6 85 ?? ?? ?? ff 69 c6 85 ?? ?? ?? ff 6e c6 85 } //3
...
rule Trojan_Win32_EyeStye_2{
	...
	strings :
		...
		$a_03_1 = {8d 45 f4 50 68 9c 96 78 bf 6a 00 e8 [0-15] ff 75 10 ff 75 0c ff 75 08 ff d0 } //2
		$a_00_2 = {80 7e 01 41 75 2f 80 7e 02 53 75 29 80 7e 03 53 75 23 } //2
		$a_03_3 = {c6 45 ec 25 c6 45 ed 73 c6 45 ee 5c c6 45 ef 25 c6 45 f0 73 88 5d ?? e8 } //2
		$a_03_4 = {c6 45 6c 25 c6 45 6d 73 c6 45 6e 5c c6 45 6f 25 c6 45 70 73 88 5d ?? e8 } //2
...
rule Trojan_Win32_EyeStye_5{
	...
	strings :
		$a_03_0 = {b8 07 63 f5 53 66 c7 44 24 ?? bf b6 } //1
...
rule Trojan_Win32_EyeStye_6{
	...
	strings :
		...
		$a_03_1 = {3f 70 6c 5f 6e 61 6d 65 3d [0-08] 26 75 69 64 3d } //1
		$a_01_2 = {64 61 74 61 73 68 69 74 3d } //1 datashit=
		$a_02_3 = {8b f0 81 7d fc c8 00 00 00 76 ?? 8b [0-15] 8b c6 e8 ?? ?? ?? ?? 8b f8 8d ?? ?? 50 8b cf ba 50 00 00 00 } //1
	condition:
...
rule Trojan_Win32_EyeStye_10{
	...
	strings :
		...
		$a_02_5 = {83 f8 23 0f 84 29 01 00 00 83 f8 3b 0f 84 20 01 00 00 6a 5b 57 e8 ?? ?? ?? ?? 83 c4 08 } //1
