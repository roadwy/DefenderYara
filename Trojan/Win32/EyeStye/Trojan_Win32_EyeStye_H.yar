...
rule Trojan_Win32_EyeStye_H{
	...
	strings :
		$a_00_0 = {5f 54 45 4e 59 50 53 5f 5f } //01 00 
		$a_02_1 = {6c 6d 78 2e 90 02 08 2d 73 65 69 6b 6f 6f 63 90 00 } //01 00 
		$a_00_2 = {45 4d 41 4e 54 4f 42 25 } //01 00 
...
rule Trojan_Win32_EyeStye_H_2{
	...
	strings :
		...
		$a_01_2 = {5f 5f 53 50 59 4e 45 54 5f 5f } //01 00 
		$a_01_3 = {53 70 79 45 79 65 5f 53 74 6f 70 00 } //01 00 
		$a_01_4 = {53 70 79 45 79 65 5f 49 6e 69 74 00 } //01 00 
		...
		$a_01_8 = {25 42 4f 54 4e 41 4d 45 25 00 } //00 00 
	condition:
		any of ($a_*)
