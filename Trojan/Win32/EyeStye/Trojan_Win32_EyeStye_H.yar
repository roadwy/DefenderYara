...
rule Trojan_Win32_EyeStye_H{
	...
	strings :
		...
		$a_02_1 = {6c 6d 78 2e 90 02 08 2d 73 65 69 6b 6f 6f 63 90 00 } //1
		$a_00_2 = {45 4d 41 4e 54 4f 42 25 } //1 EMANTOB%
		$a_02_3 = {1b 6a 00 43 dc fe 04 dc fe 04 0c ff 0a 08 00 08 00 04 b0 fe 04 0c ff fd fe 90 01 01 fe 04 3c ff fd fe 90 01 01 fe 07 08 00 80 00 24 0a 00 0d 20 00 0b 00 90 00 } //1
	condition:
...
rule Trojan_Win32_EyeStye_H_2{
	...
	strings :
		$a_03_0 = {ff 6e c6 85 90 01 02 ff ff 44 c6 85 90 01 02 ff ff 72 c6 85 90 01 02 ff ff 69 c6 85 90 01 02 ff ff 76 c6 85 90 01 02 ff ff 78 c6 85 90 01 02 ff ff 78 90 00 } //3
		$a_03_1 = {ff 6e c6 85 9f fb 90 01 02 66 c6 85 a0 fb 90 01 02 69 c6 85 a1 fb 90 01 02 67 c6 85 a2 fb 90 01 02 2e c6 85 a3 fb 90 01 02 62 c6 85 a4 fb 90 01 02 69 90 00 } //3
