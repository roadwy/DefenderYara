...
rule Trojan_Win32_KillDisk_K{
	...
	strings :
		...
		$a_03_1 = {8a 0c 38 80 f1 90 01 01 88 0c 38 40 3d fe 01 00 00 7c ef 90 00 } //1
		$a_03_2 = {68 00 02 00 00 57 56 ff 15 90 01 04 85 c0 74 5a 81 7c 24 14 00 02 00 00 72 50 90 00 } //1
	condition:
