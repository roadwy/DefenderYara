...
rule Trojan_Win32_Kryptik_GA_MTB{
	...
	strings :
		...
		$a_02_1 = {8b 75 d8 81 fe 00 00 00 01 77 9b c7 05 90 01 04 50 72 6f 63 c7 05 90 01 04 65 73 73 33 c7 05 90 01 04 32 46 69 72 66 c7 05 90 01 04 73 74 68 90 01 04 56 e8 90 00 } //1
	condition:
...
rule Trojan_Win32_Kryptik_GA_MTB_2{
	...
	strings :
		$a_02_0 = {8a 0c 30 a1 90 01 04 88 0c 30 a1 90 01 04 3d 90 01 04 75 90 00 } //1
		...
		$a_02_2 = {24 fc c0 e0 90 01 01 c0 e1 90 01 01 0a d0 08 8d 90 01 04 88 34 3e 81 3d 90 02 08 88 95 90 01 04 75 90 00 } //1
		$a_02_3 = {8b c7 c1 e8 90 01 01 03 85 90 01 04 33 c3 33 c2 2b f0 83 90 02 06 75 90 00 } //1
	condition:
