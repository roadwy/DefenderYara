...
rule Trojan_Win32_Wrokni_AD_MTB{
	...
	strings :
		$a_02_0 = {0f b6 02 50 b8 ?? ?? ?? ?? ff e0 8b f9 90 90 58 2b c1 50 b8 ?? ?? ?? ?? ff e0 f7 } //2
		$a_02_1 = {58 8b 4d 08 50 b8 ?? ?? ?? ?? ff e0 } //1
		$a_02_2 = {58 03 4d fc 50 b8 ?? ?? ?? ?? ff e0 } //1
		$a_02_3 = {58 88 01 50 b8 ?? ?? ?? ?? ff e0 } //1
	condition:
