...
rule Trojan_Win32_NetStream_DSK_MTB{
	...
	strings :
		$a_02_0 = {8b d6 8b ca b8 89 dc 00 00 03 c1 2d 89 dc 00 00 89 45 fc a1 90 01 04 8b 4d fc 89 08 90 00 } //2
	condition:
		((#a_02_0  & 1)*2) >=2
...
rule Trojan_Win32_NetStream_DSK_MTB_2{
	...
	strings :
		...
		$a_02_1 = {b8 26 09 00 00 8b d6 8b ca b8 89 dc 00 00 03 c1 2d 89 dc 00 00 89 45 fc a1 90 01 04 8b 4d fc 89 08 90 00 } //2
	condition:
