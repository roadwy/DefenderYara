...
rule Trojan_Win32_BitRat_NEE_MTB{
	...
	strings :
		...
		$a_01_1 = {73 74 64 6f 6c 65 32 2e 74 6c 62 } //01 00  stdole2.tlb
		$a_01_2 = {4c 00 79 00 6e 00 78 00 47 00 72 00 69 00 64 00 2e 00 76 00 62 00 70 00 } //01 00  LynxGrid.vbp
		$a_01_3 = {50 00 61 00 74 00 72 00 69 00 63 00 69 00 61 00 } //00 00  Patricia
	condition:
		any of ($a_*)
