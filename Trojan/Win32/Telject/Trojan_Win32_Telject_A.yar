...
rule Trojan_Win32_Telject_A{
	...
	strings :
		...
		$a_00_4 = {61 70 70 66 72 65 65 74 6f 6f 6c 73 2e 63 6f 6d 20 } //02 00 
		$a_00_5 = {63 6f 6c 6f 72 62 61 6c 6c 73 6f 75 74 2e 63 6f 6d } //03 00 
		$a_00_6 = {53 75 70 70 6f 72 74 2f 6c 69 62 73 2f 61 64 73 6c 69 73 74 73 2e 70 68 70 } //05 00 
		$a_01_7 = {50 49 6e 47 20 20 20 20 20 33 2e 33 2e 33 2e 32 35 35 20 2d 77 20 20 20 20 20 32 30 30 30 20 20 20 2d 6e 20 31 } //00 00 
	condition:
		any of ($a_*)
