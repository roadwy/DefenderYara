...
rule Trojan_Win32_Yangxiay_A_sys{
	...
	strings :
		$a_02_0 = {bb 10 00 00 c0 8b 75 0c 8b 46 60 8b 48 0c 8b 50 10 89 55 e4 8b 7e 3c 8b 40 04 89 45 d4 81 f9 4b e1 22 00 0f 85 90 01 01 00 00 00 83 65 fc 00 6a 04 5b 53 53 52 ff 90 01 03 01 00 90 00 } //1
