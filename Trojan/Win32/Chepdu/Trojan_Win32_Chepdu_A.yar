...
rule Trojan_Win32_Chepdu_A{
	...
	strings :
		$a_01_0 = {25 73 73 69 64 3d 25 73 26 75 72 6c 3d 25 73 26 69 64 3d 25 73 26 69 64 66 65 65 64 3d 25 69 26 65 66 6b 77 64 3d 25 73 } //01 00 
		$a_01_1 = {73 69 64 3d 25 73 26 75 72 6c 3d 25 73 26 69 64 3d 25 73 26 6b 65 79 3d 25 73 26 69 64 66 65 65 64 3d 25 69 } //01 00 
