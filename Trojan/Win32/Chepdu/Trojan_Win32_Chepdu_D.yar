...
rule Trojan_Win32_Chepdu_D{
	...
	strings :
		...
		$a_01_2 = {25 73 75 73 65 72 69 6e 69 74 7c 25 73 7c 25 73 } //02 00 
		$a_01_3 = {72 65 67 73 76 72 33 32 2e 65 78 65 00 00 00 00 69 65 78 70 6c 6f 72 65 2e 65 78 65 } //01 00 
		$a_01_4 = {43 6f 49 6e 74 65 72 6e 65 74 43 6f 6d 70 61 72 65 55 72 6c } //01 00 
		$a_01_5 = {55 52 4c 44 6f 77 6e 6c 6f 61 64 54 6f 46 69 6c 65 41 27 } //01 00 
		$a_01_6 = {71 3d 00 73 65 61 72 63 68 3f } //00 00 
	condition:
		any of ($a_*)
