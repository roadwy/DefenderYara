...
rule Trojan_Win32_WinTools_5{
	...
	strings :
		...
		$a_03_8 = {41 5f 53 5f 56 5f 32 90 01 01 43 6c 6f 73 65 90 00 } //1
	condition:
...
rule Trojan_Win32_WinTools_10{
	...
	strings :
		...
		$a_03_3 = {68 74 74 70 3a 2f 2f 64 6f 77 6e 6c 6f 61 64 2e 77 65 62 73 65 61 72 63 68 2e 63 6f 6d 2f 44 6e 6c 2f 54 5f 90 01 05 2f 57 69 6e 54 6f 6f 6c 73 2e 63 61 62 90 00 } //1
		$a_03_4 = {68 74 74 70 3a 2f 2f 64 6f 77 6e 6c 6f 61 64 2e 77 65 62 73 65 61 72 63 68 2e 63 6f 6d 2f 54 62 90 02 04 49 6e 73 74 4c 6f 67 2e 61 73 6d 78 2f 47 65 74 58 4d 4c 3f 54 62 49 64 3d 90 00 } //1
	condition:
