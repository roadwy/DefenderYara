...
rule Trojan_Win32_Patched_V{
	...
	strings :
		$a_03_0 = {83 e8 34 89 85 ?? ?? ?? ?? 61 ff 34 24 60 e8 00 00 00 00 5d 81 ed ?? ?? ?? ?? 8b 85 ?? ?? ?? ?? 89 44 24 24 61 5d 83 7c 24 0c 01 75 26 60 e8 00 00 00 00 5d 81 ed ?? ?? ?? ?? 8d b5 ?? ?? ?? ?? 56 8b bd ?? ?? ?? ?? ff d7 } //1
		$a_03_1 = {55 60 e8 00 00 00 00 90 90 90 90 8b f6 5d 81 ed ?? ?? ?? ?? 60 e8 00 00 00 00 58 25 00 f0 ff ff } //1
