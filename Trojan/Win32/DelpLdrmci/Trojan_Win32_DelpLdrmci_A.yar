...
rule Trojan_Win32_DelpLdrmci_A{
	...
	strings :
		$a_03_0 = {68 00 01 00 00 53 6a 00 e8 ?? ?? fa ff 90 90 e8 ?? ?? fa ff 80 3b 43 75 1f 80 7b 03 53 75 19 80 7b 05 4c 75 13 80 7b 04 45 75 0d 80 7b 06 46 75 07 6a 00 e8 ?? ?? fa ff } //2
		$a_03_1 = {ba d7 88 00 00 31 c9 80 34 01 ?? 41 39 d1 75 f7 05 4d 32 00 00 ff e0 } //2
