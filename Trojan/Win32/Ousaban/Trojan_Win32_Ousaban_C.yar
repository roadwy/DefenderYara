...
rule Trojan_Win32_Ousaban_C{
	...
	strings :
		...
		$a_81_1 = {23 4f 4e 2d 4c 49 4e 45 23 } //0a 00  #ON-LINE#
		$a_81_2 = {23 73 74 72 50 69 6e 67 4f 6b 23 } //0a 00  #strPingOk#
		$a_81_3 = {23 78 79 53 63 72 65 65 23 } //0a 00  #xyScree#
		$a_81_4 = {23 73 74 72 49 6e 69 53 63 72 65 65 23 } //00 00  #strIniScree#
