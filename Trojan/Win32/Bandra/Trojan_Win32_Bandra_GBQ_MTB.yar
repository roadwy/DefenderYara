...
rule Trojan_Win32_Bandra_GBQ_MTB{
	...
	strings :
		$a_03_0 = {8a 1c 2e 68 ?? ?? ?? ?? e8 ?? ?? ?? ?? 59 8b c8 31 d2 8b c6 f7 f1 8a 82 ?? ?? ?? ?? 32 c3 88 04 2e 46 3b f7 72 } //10
		$a_03_1 = {8b c8 33 d2 8b c6 83 c4 04 f7 f1 8a 82 ?? ?? ?? ?? 32 c3 88 86 ?? ?? ?? ?? 46 81 fe ?? ?? ?? ?? 72 } //10
