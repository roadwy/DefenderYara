...
rule Trojan_Win32_KerrDown_D_dha{
	...
	strings :
		...
		$a_03_3 = {6d 73 76 63 c7 90 02 03 72 74 2e 64 66 c7 90 02 03 6c 6c c6 90 00 } //2
		$a_03_4 = {ff c5 dc 62 c7 85 90 01 02 ff ff ed 2b a2 cb 90 00 } //1
		$a_03_5 = {52 29 fa 17 c7 90 02 06 1b 74 ee 47 90 00 } //1
	condition:
