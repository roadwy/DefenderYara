...
rule Trojan_Win32_KerrDown_D_dha{
	...
	strings :
		$a_01_0 = {75 00 70 00 64 00 61 00 74 00 65 00 2e 00 6d 00 73 00 6f 00 66 00 66 00 69 00 63 00 65 00 2d 00 74 00 65 00 6d 00 70 00 6c 00 61 00 74 00 65 00 73 00 2e 00 69 00 6e 00 66 00 6f 00 } //01 00 
