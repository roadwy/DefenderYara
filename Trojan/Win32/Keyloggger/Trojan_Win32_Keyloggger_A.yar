...
rule Trojan_Win32_Keyloggger_A{
	...
	strings :
		$a_00_0 = {25 43 44 25 5c 61 75 74 6f 72 75 6e 2e 69 6e 66 20 2f 59 20 2f 68 20 2f 6b 20 2f 72 20 25 57 49 4e 44 49 52 25 } //01 00 
		$a_00_1 = {5b 2a 5d 4b 65 79 6c 6f 67 } //01 00 
