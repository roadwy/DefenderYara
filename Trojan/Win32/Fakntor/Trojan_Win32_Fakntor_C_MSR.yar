...
rule Trojan_Win32_Fakntor_C_MSR{
	...
	strings :
		$a_00_0 = {63 3a 5c 77 69 6e 64 6f 77 73 5c 73 79 73 74 65 6d 33 32 5c 4e 61 72 72 61 74 6f 72 4d 61 69 6e 2e 65 78 65 } //01 00  c:\windows\system32\NarratorMain.exe
