...
rule Trojan_Win32_Zoxpng_B{
	...
	strings :
		...
		$a_00_2 = {43 6c 65 61 72 46 69 6c 65 00 53 74 61 72 74 53 68 65 6c 6c 00 67 5f 69 69 73 65 78 69 74 00 67 5f 69 69 73 6b 69 6c 6c } //00 00  汃慥䙲汩e瑓牡却敨汬最楟獩硥瑩最楟獩楫汬
	condition:
		any of ($a_*)
