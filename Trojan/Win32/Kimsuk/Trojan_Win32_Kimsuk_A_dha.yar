...
rule Trojan_Win32_Kimsuk_A_dha{
	...
	strings :
		...
		$a_03_4 = {68 a9 04 bc 6a e8 90 01 04 8b 90 01 05 a3 90 01 04 51 68 cf 72 18 6c e8 90 01 04 8b 15 90 01 04 a3 90 01 04 52 68 f2 e2 b7 1b e8 90 01 04 a3 90 01 04 a1 90 01 04 50 68 99 9f 81 de e8 90 01 04 8b 0d 90 01 04 a3 90 01 04 51 68 56 07 cc e5 e8 90 00 } //1
