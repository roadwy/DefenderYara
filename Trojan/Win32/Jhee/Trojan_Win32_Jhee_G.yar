...
rule Trojan_Win32_Jhee_G{
	meta:
		description = "Trojan:Win32/Jhee.G,SIGNATURE_TYPE_PEHSTR_EXT,05 00 05 00 06 00 00 01 00 "
		
	strings :
		$a_01_0 = {4e 65 66 6b 68 65 55 } //01 00  NefkheU
		$a_00_1 = {57 72 69 74 65 50 72 6f 63 65 73 73 4d 65 6d 6f 72 79 } //01 00  WriteProcessMemory
		$a_00_2 = {43 72 65 61 74 65 52 65 6d 6f 74 65 54 68 72 65 61 64 } //01 00  CreateRemoteThread
		...
		$a_03_4 = {68 d0 07 00 00 ff d6 8d 54 24 08 52 57 e8 90 01 03 ff 83 c4 08 85 c0 74 e7 5e 90 00 } //01 00 
		$a_03_5 = {25 0f 00 00 80 79 05 48 83 c8 f0 40 83 c0 05 85 c0 7e 0c 8b f0 68 90 01 04 ff d7 4e 75 f6 90 00 } //00 00 
	condition:
		any of ($a_*)
