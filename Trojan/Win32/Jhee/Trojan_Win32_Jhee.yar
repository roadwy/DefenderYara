...
rule Trojan_Win32_Jhee{
	...
	strings :
		...
		$a_00_1 = {75 70 2e 64 6c 6c 2e 7a 67 78 } //01 00  up.dll.zgx
		$a_00_2 = {73 79 73 6f 70 74 69 6f 6e 2e 69 6e 69 } //01 00  sysoption.ini
		$a_00_3 = {6d 69 6e 69 44 6c 6c 2e 64 6c 6c 2e 7a 67 78 } //01 00  miniDll.dll.zgx
		$a_00_4 = {5c 45 78 70 6c 6f 72 65 72 5c 52 75 6e } //00 00  \Explorer\Run
	condition:
		any of ($a_*)
