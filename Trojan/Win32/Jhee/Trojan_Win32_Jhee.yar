...
rule Trojan_Win32_Jhee{
	...
	strings :
		$a_03_0 = {f3 a5 8b c8 33 c0 83 e1 03 8d 90 01 03 f3 a4 bf 90 01 04 83 c9 ff f2 ae f7 d1 2b f9 50 8b f7 8b fa 8b d1 83 c9 ff f2 ae 8b ca 4f c1 e9 02 f3 a5 68 80 00 00 00 90 00 } //1
