...
rule Trojan_Win32_TrueBot_PA_MTB{
	...
	strings :
		$a_01_0 = {25 30 38 78 2d 25 30 38 78 2e 70 73 31 } //01 00 
		$a_01_1 = {6e 3d 25 73 26 6f 3d 25 73 26 61 3d 25 64 26 75 3d 25 73 26 70 3d 25 73 26 64 3d 25 73 } //03 00 
