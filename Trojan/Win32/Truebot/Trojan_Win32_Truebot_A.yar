...
rule Trojan_Win32_Truebot_A{
	...
	strings :
		...
		$a_01_1 = {5c 5c 2e 5c 70 69 70 65 5c 7b 37 33 46 37 39 37 35 41 2d 41 34 41 32 2d 34 41 42 36 2d 39 31 32 31 2d 41 45 43 41 45 36 38 41 41 42 42 42 7d } //01 00  \\.\pipe\{73F7975A-A4A2-4AB6-9121-AECAE68AABBB}
		$a_01_2 = {5c 53 63 72 65 65 6e 4d 6f 6e 69 74 6f 72 53 65 72 76 69 63 65 5c } //00 00  \ScreenMonitorService\
		$a_00_3 = {78 a0 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Truebot_A_2{
	...
	strings :
		...
		$a_01_2 = {5c 5c 2e 5c 70 69 70 65 5c 7b 37 33 46 37 39 37 35 41 2d 41 34 41 32 2d 34 41 42 36 2d 39 31 32 31 2d 41 45 43 41 45 36 38 41 41 42 42 42 7d } //00 00  \\.\pipe\{73F7975A-A4A2-4AB6-9121-AECAE68AABBB}
		$a_00_3 = {5d } //04 00  ]
	condition:
		any of ($a_*)
