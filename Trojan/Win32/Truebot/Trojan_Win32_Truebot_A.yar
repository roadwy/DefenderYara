...
rule Trojan_Win32_Truebot_A_2{
	...
	strings :
		$a_03_0 = {8d 9b 00 00 00 00 8d 88 90 01 04 03 ce 81 f9 cc b8 00 00 73 72 8a 88 90 01 04 30 8c 10 90 01 04 8d 4a 01 03 c8 81 f9 cc b8 00 00 73 57 8a 88 90 01 04 30 8c 10 90 01 04 8d 4a 02 03 c8 81 f9 cc b8 00 00 90 00 } //1
		$a_03_1 = {5c 6d 73 73 2e 74 78 74 90 02 10 5c 6d 73 73 2e 65 78 65 90 00 } //1
