...
rule Trojan_Win32_Amadey_MB_MTB{
	...
	strings :
		...
		$a_01_1 = {44 3a 5c 4d 6b 74 6d 70 5c 41 6d 61 64 65 79 5c 52 65 6c 65 61 73 65 5c 41 6d 61 64 65 79 2e 70 64 62 } //00 00  D:\Mktmp\Amadey\Release\Amadey.pdb
	condition:
		any of ($a_*)
...
rule Trojan_Win32_Amadey_MB_MTB_2{
	...
	strings :
		...
		$a_01_3 = {6e 62 76 65 65 6b 2e 65 78 65 } //01 00  nbveek.exe
