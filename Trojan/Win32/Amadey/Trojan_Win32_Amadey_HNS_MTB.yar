...
rule Trojan_Win32_Amadey_HNS_MTB{
	...
	strings :
		$a_03_0 = {e9 00 20 00 00 90 09 0a 00 eb 08 0f 90 01 02 00 00 00 00 00 90 00 } //20
		$a_01_1 = {31 cb 31 e1 83 ea 01 52 ff 0c 24 5a } //1
		$a_03_2 = {89 1c 24 e8 01 00 00 00 cc 8b 04 24 90 01 01 89 90 01 01 81 90 01 01 04 00 00 00 83 90 01 01 04 90 00 } //1
