...
rule Trojan_Win32_Reconyc_HMP_MTB{
	...
	strings :
		...
		$a_01_1 = {2e 70 6f 6c 79 70 68 61 48 } //01 00  .polyphaH
		$a_01_2 = {2e 64 75 6d 70 73 } //01 00  .dumps
		$a_01_3 = {2e 65 72 6f 74 6f 67 65 } //01 00  .erotoge
		$a_01_4 = {2e 6e 6f 6e 63 61 74 65 } //01 00  .noncate
		$a_01_5 = {2e 66 69 6e 6b 65 6c } //00 00  .finkel
	condition:
		any of ($a_*)
