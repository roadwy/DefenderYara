...
rule Trojan_Win32_Lycutosso_A{
	...
	strings :
		$a_01_0 = {43 6f 70 79 46 69 6c 65 53 61 66 65 00 63 72 65 61 74 65 5f 64 69 72 5f 6c 69 6e 6b } //02 00  潃祰楆敬慓敦挀敲瑡彥楤彲楬歮
		$a_01_1 = {64 65 63 72 79 70 74 00 64 69 73 69 6e 66 65 63 74 00 69 6e 66 65 63 74 } //01 00  敤牣灹t楤楳普捥t湩敦瑣
