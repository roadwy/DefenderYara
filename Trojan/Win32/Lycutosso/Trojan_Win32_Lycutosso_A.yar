...
rule Trojan_Win32_Lycutosso_A{
	...
	strings :
		...
		$a_03_2 = {b8 ff ff 00 00 66 89 01 46 81 fe 2a 2c 0a 00 7c 90 01 01 83 c1 02 4a 75 90 00 } //1
		$a_03_3 = {80 e1 06 0f be c9 f7 d9 1b c9 f7 d1 85 c8 0f 84 90 01 01 00 00 00 8d 74 24 30 e8 90 00 } //1
	condition:
