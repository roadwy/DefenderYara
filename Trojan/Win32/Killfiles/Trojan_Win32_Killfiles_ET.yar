...
rule Trojan_Win32_Killfiles_ET{
	...
	strings :
		...
		$a_01_1 = {4e 74 44 65 6c 65 74 65 46 69 6c 65 } //01 00 
		$a_01_2 = {4e 74 54 65 72 6d 69 6e 61 74 65 50 72 6f 63 65 73 73 } //01 00 
		$a_01_3 = {47 00 62 00 50 00 6c 00 75 00 67 00 69 00 6e 00 5c 00 } //01 00 
