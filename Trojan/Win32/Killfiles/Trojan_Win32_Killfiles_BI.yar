...
rule Trojan_Win32_Killfiles_BI{
	...
	strings :
		$a_03_0 = {8b 95 6c fe ff ff 8b 02 89 85 bc fe ff ff c7 85 f0 fe ff ff ?? ?? 40 00 c7 85 e8 fe ff ff 08 00 00 00 c7 85 00 ff ff ff 02 00 00 00 c7 85 f8 fe ff ff 02 00 00 00 8d 4d 8c 51 b8 10 00 00 00 } //1
