...
rule Trojan_Win32_FakeIA_J{
	...
	strings :
		...
		$a_01_2 = {77 00 69 00 6e 00 6c 00 6f 00 67 00 6f 00 6e 00 73 00 2e 00 65 00 78 00 65 00 } //01 00 
		$a_00_3 = {5a 77 51 75 65 72 79 53 79 73 74 65 6d 49 6e 66 6f 72 6d 61 74 69 6f 6e } //00 00 
	condition:
		any of ($a_*)
