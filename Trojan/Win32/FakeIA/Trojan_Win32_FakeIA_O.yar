...
rule Trojan_Win32_FakeIA_O{
	...
	strings :
		...
		$a_02_3 = {41 50 50 44 41 54 41 5c 90 02 0a 2e 67 69 66 90 00 } //1
		$a_02_4 = {c6 02 4c 8b 10 c6 42 01 53 8b 10 90 02 30 50 6a 00 6a 00 e8 90 01 02 ff ff 8b d8 e8 90 01 02 ff ff 85 c0 75 16 54 6a 00 6a 00 68 90 01 04 6a 00 6a 00 e8 62 89 ff ff 90 00 } //1
	condition:
