...
rule Trojan_Win32_ExtenBro_A{
	...
	strings :
		$a_03_0 = {3c 6e 61 6d 65 3e 51 75 69 63 6b 20 53 65 61 72 63 68 65 72 90 02 04 3c 2f 6e 61 6d 65 3e 90 00 } //10
		$a_03_1 = {3c 65 6d 3a 64 65 73 63 72 69 70 74 69 6f 6e 3e 51 75 69 63 6b 20 53 65 61 72 63 68 65 72 90 02 04 3c 2f 65 6d 3a 64 65 73 63 72 69 70 74 69 6f 6e 3e 90 00 } //10
