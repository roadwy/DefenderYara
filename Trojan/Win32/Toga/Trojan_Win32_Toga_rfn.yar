...
rule Trojan_Win32_Toga_rfn{
	...
	strings :
		...
		$a_03_1 = {8b 45 fc 83 c0 78 8b 10 85 d2 74 18 03 55 f4 8b 4d f0 89 91 ?? ?? ?? ?? 8b 40 04 8b 55 f0 89 82 ?? ?? ?? ?? 8b 45 fc } //1
...
rule Trojan_Win32_Toga_rfn_2{
	...
	strings :
		$a_03_0 = {0f bf d0 8b 85 b0 fe ff ff 8d 8d 54 ff ff ff 33 c2 50 51 ff 15 ?? ?? ?? ?? 8d 95 c4 fe ff ff 8d 85 54 ff ff ff 52 8d 8d 44 ff ff ff } //1
