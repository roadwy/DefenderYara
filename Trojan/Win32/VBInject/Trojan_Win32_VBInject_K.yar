...
rule Trojan_Win32_VBInject_K{
	...
	strings :
		$a_01_0 = {73 45 73 70 61 63 69 6f 50 6f 69 73 6f 6e } //01 00 
		$a_01_1 = {53 68 65 6c 6c 45 78 65 63 75 74 65 41 } //01 00 
		$a_01_2 = {4d 00 6f 00 64 00 4d 00 65 00 50 00 75 00 62 00 6c 00 69 00 63 00 6f 00 5c 00 53 00 74 00 75 00 23 00 62 00 5c 00 50 00 72 00 6f 00 79 00 65 00 63 00 74 00 6f 00 31 00 2e 00 76 00 62 00 70 00 } //01 00 
