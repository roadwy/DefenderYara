...
rule Trojan_Win32_VBInject_N{
	...
	strings :
		$a_02_0 = {81 bd bc fe ff ff 50 45 00 00 0f 85 90 01 04 8b 0e 8b c3 8d 95 bc fe ff ff 83 c0 34 52 6a 04 0f 80 90 01 04 50 56 ff 51 24 8b 8d bc fe ff ff 8b 55 c4 89 4d d4 8d 8d 68 ff ff ff c7 02 44 00 00 00 ba 90 01 04 ff 15 90 00 } //5
