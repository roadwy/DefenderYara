...
rule Trojan_Win32_Tinshel_A_bit{
	...
	strings :
		...
		$a_01_2 = {3c 73 75 62 73 63 20 72 65 71 75 65 73 74 20 63 6f 64 65 3d 22 31 22 3e 25 75 3c 2f 72 65 71 75 65 73 74 3e } //01 00 
		$a_01_3 = {25 64 2e 25 64 2e 25 64 2e 25 64 20 25 73 } //00 00 
	condition:
		any of ($a_*)
