...
rule Trojan_Win32_Tapaoux_L{
	...
	strings :
		...
		$a_03_4 = {c6 45 fc 51 c6 45 fd 52 c6 45 fe 00 e8 90 01 04 89 45 f0 83 c4 14 33 c0 39 75 f0 7e 0b 80 44 05 f4 13 40 3b 45 f0 7c f5 39 75 e8 7e 29 89 5d ec 90 00 } //1
	condition:
