...
rule Trojan_Win32_Tapaoux_A{
	...
	strings :
		...
		$a_01_2 = {50 6c 61 79 53 50 5f 64 6c 6c 2e 64 6c 6c 00 4d 65 6d 6f 72 79 41 6c 6c 6f 63 45 72 72 6f 72 00 } //01 00 
		$a_00_3 = {25 73 5c 25 73 2e 64 6c 6c } //01 00 
		$a_00_4 = {25 73 5c 25 73 2e 73 79 73 } //01 00 
		$a_00_5 = {25 73 5c 25 73 2e 6c 6e 6b } //00 00 
	condition:
		any of ($a_*)
