...
rule Trojan_Win32_CrimSon_J_ibt{
	...
	strings :
		...
		$a_02_2 = {70 17 8d 05 00 00 01 13 90 01 01 11 90 01 01 16 06 a2 00 11 90 01 01 14 14 14 28 90 01 01 00 00 0a 28 0a 00 00 0a 13 90 00 } //1
		$a_02_3 = {02 72 b9 00 00 70 17 8d 90 01 01 00 00 01 0a 06 16 1f 7c 9d 06 6f 61 00 00 0a 16 9a 7d 0d 00 00 04 90 00 } //1
	condition:
