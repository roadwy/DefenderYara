...
rule Trojan_Win32_Adclicker_AR{
	...
	strings :
		$a_00_0 = {31 32 37 2e 30 2e 30 2e 31 20 20 77 77 77 31 2e 74 6d 64 71 71 2e 6e 65 74 } //01 00 
		$a_00_1 = {44 65 6c 2e 62 61 74 } //01 00 
		$a_00_2 = {64 65 6c 20 22 63 3a 5c 6e 65 77 2e 65 78 65 22 } //01 00 
		$a_00_3 = {31 32 37 2e 30 2e 30 2e 31 20 20 77 77 77 33 2e 35 37 31 38 35 2e 63 6f 6d } //01 00 
