...
rule Trojan_Win32_Zombie_NBJ_MTB{
	...
	strings :
		...
		$a_01_3 = {43 4f 4d 53 50 45 43 } //01 00 
		$a_01_4 = {5f 2e 65 78 65 } //01 00 
		$a_01_5 = {5c 5a 6f 6d 62 69 65 2e 65 78 65 } //01 00 
		$a_01_6 = {57 49 4e 4e 54 } //01 00 
		$a_01_7 = {53 68 65 6c 6c 45 78 65 63 75 74 65 45 78 41 } //00 00 
	condition:
		any of ($a_*)
