...
rule Trojan_Win32_Matcash_gen_D{
	...
	strings :
		...
		$a_01_1 = {53 6f 66 74 77 61 72 65 5c 4d 69 63 72 6f 73 6f 66 74 5c 49 6e 74 65 72 6e 65 74 20 45 78 70 6c 6f 72 65 72 5c 54 6f 6f 6c 62 61 72 } //10 Software\Microsoft\Internet Explorer\Toolbar
