...
rule Trojan_Win32_Matcash_5{
	...
	strings :
		$a_02_0 = {2f 63 61 70 74 75 72 65 90 02 02 2f 90 02 06 2f 6d 63 61 73 68 2f 00 68 74 74 70 3a 2f 2f 00 63 6f 6d 90 00 } //10
		$a_02_1 = {6e 61 6d 65 00 00 00 00 63 61 70 74 75 72 65 90 02 02 2e 6a 73 90 00 } //2
