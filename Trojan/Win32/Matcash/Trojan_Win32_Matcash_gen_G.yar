...
rule Trojan_Win32_Matcash_gen_G{
	...
	strings :
		...
		$a_00_1 = {53 6f 66 74 77 61 72 65 5c 4d 69 63 72 6f 73 6f 66 74 5c 57 69 6e 64 6f 77 73 5c 43 75 72 72 65 6e 74 56 65 72 73 69 6f 6e 5c 45 78 70 6c 6f 72 65 72 5c 53 68 65 6c 6c 20 46 6f 6c 64 65 72 73 } //02 00 
		...
		$a_00_4 = {62 6f 6f 74 2e 70 68 70 3f 6d 61 63 3d 00 } //01 00 
		$a_00_5 = {25 30 32 58 25 30 32 58 25 30 32 58 25 30 32 58 25 30 32 58 25 30 32 58 } //01 00 
		$a_00_6 = {49 6e 74 65 72 6e 65 74 53 68 6f 72 74 63 75 74 2e 57 } //00 00 
	condition:
		any of ($a_*)
