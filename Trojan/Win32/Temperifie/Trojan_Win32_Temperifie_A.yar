...
rule Trojan_Win32_Temperifie_A{
	...
	strings :
		...
		$a_01_1 = {70 65 72 6d 69 74 65 2e 69 6e 66 6f 2f } //01 00 
		$a_01_2 = {2f 68 76 73 62 74 6e 2e 65 78 65 } //01 00 
		$a_01_3 = {2f 6e 32 73 74 6e 2e 65 78 65 } //01 00 
		$a_01_4 = {2f 68 6b 6d 73 67 72 2e 65 78 65 } //00 00 
	condition:
		any of ($a_*)
