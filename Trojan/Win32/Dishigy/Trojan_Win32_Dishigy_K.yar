...
rule Trojan_Win32_Dishigy_K{
	...
	strings :
		...
		$a_03_1 = {bf 01 00 00 00 8b 45 90 01 01 90 17 03 06 05 05 33 db 8a 5c 38 ff 0f b6 5c 38 ff 0f b7 5c 78 fe 33 5d 90 01 01 3b 5d 90 01 01 7f 0b 81 c3 ff 00 00 00 90 00 } //1
...
rule Trojan_Win32_Dishigy_K_2{
	...
	strings :
		...
		$a_03_2 = {74 17 8d 55 f4 b8 90 01 04 e8 90 01 04 8b 55 f4 8b c3 e8 90 01 04 8d 55 f0 a1 90 01 04 e8 90 01 04 8b 45 f0 50 8d 55 ec b8 90 01 04 e8 90 01 04 8b 45 ec 5a e8 90 01 04 84 c0 74 17 8d 55 e8 b8 90 01 04 e8 90 00 } //1
	condition:
