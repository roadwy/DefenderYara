...
rule Trojan_Win32_Tracur_AC{
	...
	strings :
		$a_01_0 = {5a 3a 5c 64 65 76 5c 63 62 5f 6c 6f 61 64 65 72 5c 52 65 6c 65 61 73 65 5c 63 62 5f 6c 6f 61 64 65 72 2e 70 64 62 } //01 00  Z:\dev\cb_loader\Release\cb_loader.pdb
