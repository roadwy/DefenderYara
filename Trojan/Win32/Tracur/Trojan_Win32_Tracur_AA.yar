...
rule Trojan_Win32_Tracur_AA{
	...
	strings :
		...
		$a_01_1 = {63 61 6e 6e 6f 74 20 67 65 74 20 63 6c 69 63 6b 20 69 6e 66 6f 00 } //02 00 
		...
		$a_01_5 = {2f 6c 6f 67 69 6e 2f 20 2f 74 77 65 65 74 2f 20 61 63 74 69 6f 6e 3d 65 6d 62 65 64 2d 66 6c 61 73 68 } //00 00 
	condition:
		any of ($a_*)
