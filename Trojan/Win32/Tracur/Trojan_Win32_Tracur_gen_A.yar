...
rule Trojan_Win32_Tracur_gen_A{
	...
	strings :
		$a_0b_0 = {81 fa 22 67 3f 7a 74 90 01 01 81 fa 67 22 7a 3f 0f 84 90 01 02 00 00 90 00 } //1
		$a_0b_1 = {81 fa 30 75 2d 68 0f 84 90 01 02 00 00 81 fa 3e 7b 23 66 0f 84 90 01 02 00 00 90 00 } //1
