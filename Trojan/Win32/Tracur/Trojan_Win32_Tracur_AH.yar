...
rule Trojan_Win32_Tracur_AH{
	...
	strings :
		$a_03_0 = {3d 2e 4a 50 47 74 ?? 3d 2e 6a 70 67 74 ?? 3d 2e 65 78 65 74 ?? 3d 2e 74 6d 70 74 ?? 3d 2e 45 58 45 74 ?? 3d 2e 54 4d 50 } //1
		$a_03_1 = {8b 45 08 89 c7 89 d3 90 90 31 1f 90 90 83 c7 04 50 58 e2 f5 } //1
