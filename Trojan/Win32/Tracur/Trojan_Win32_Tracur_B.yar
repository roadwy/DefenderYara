...
rule Trojan_Win32_Tracur_B{
	...
	strings :
		...
		$a_03_2 = {68 b8 0b 00 00 ff 15 90 01 03 10 68 88 13 00 00 ff 74 24 08 6a 00 90 00 } //1
		$a_03_3 = {39 54 24 10 8b f8 7e 1d 8b 44 24 0c 8d 0c 06 8a 82 90 01 03 10 30 01 42 90 00 } //1
	condition:
