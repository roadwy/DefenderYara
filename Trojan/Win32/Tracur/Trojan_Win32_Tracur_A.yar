...
rule Trojan_Win32_Tracur_A_2{
	...
	strings :
		...
		$a_01_5 = {70 31 39 45 33 4e 55 53 48 41 47 43 68 75 73 68 79 73 6a 77 76 00 } //02 00  ㅰ䔹丳单䅈䍇畨桳獹睪v
		$a_01_6 = {51 75 69 77 38 32 68 64 44 65 67 5b 75 61 56 31 6e 32 78 75 53 00 } //00 00  畑睩㈸摨敄孧慵ㅖ㉮畸S
	condition:
		any of ($a_*)
