...
rule Trojan_Win32_Tracur_A{
	...
	strings :
		$a_03_0 = {8a 1c 0e 32 9a 90 01 02 40 00 83 c2 01 3b d5 88 5c 0e ff 75 02 33 d2 83 c1 01 3b cf 7e e3 5b 5f 88 44 31 ff 5d c3 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_Win32_Tracur_A_2{
	...
	strings :
		$a_03_0 = {44 65 66 c7 46 90 01 01 74 6f 66 c7 46 90 01 01 75 72 66 c7 46 90 01 01 73 21 90 00 } //2
