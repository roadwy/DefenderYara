...
rule Trojan_Win32_Tracur_J{
	...
	strings :
		...
		$a_01_1 = {25 73 3f 71 3d 25 73 26 73 75 3d 25 73 } //01 00 
		$a_01_2 = {75 3d 25 73 26 61 3d 25 73 26 69 3d 25 73 26 73 3d 25 73 } //01 00 
		$a_01_3 = {25 73 3f 70 69 6e 67 3d 31 26 25 73 } //00 00 
	condition:
		any of ($a_*)
