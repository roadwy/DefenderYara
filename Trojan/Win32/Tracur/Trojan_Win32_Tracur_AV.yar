...
rule Trojan_Win32_Tracur_AV{
	...
	strings :
		...
		$a_03_5 = {72 75 6e 64 6c 6c 33 32 90 03 04 00 2e 65 78 65 20 22 25 73 22 2c 25 73 00 90 05 04 01 00 43 68 65 63 6b 65 72 00 90 00 } //2
		$a_03_6 = {8a 4c 16 01 32 8b 90 01 04 88 0c 10 42 43 3b d7 72 e6 90 00 } //1
		$a_03_7 = {8a 08 80 f9 75 75 06 ff 74 24 14 eb 09 80 f9 72 75 0e ff 74 24 30 83 c0 02 e8 90 01 04 eb 90 01 01 80 f9 74 75 90 01 01 83 c0 02 90 00 } //2
