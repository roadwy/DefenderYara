...
rule Trojan_Win32_Nanocore_BA_MTB{
	meta:
		description = "Trojan:Win32/Nanocore.BA!MTB,SIGNATURE_TYPE_PEHSTR_EXT,ffffff8c 00 ffffff8c 00 0e 00 00 0a 00 "
	...
	strings :
		...
		$a_80_4 = {2e 70 70 74 } //.ppt  0a 00 
		$a_80_5 = {2e 69 63 6d } //.icm  0a 00 
		$a_80_6 = {2e 6d 70 33 } //.mp3  0a 00 
		$a_80_7 = {2e 70 64 66 } //.pdf  0a 00 
		$a_80_8 = {2e 6d 73 63 } //.msc  0a 00 
		$a_80_9 = {45 78 74 72 61 63 74 69 6e 67 20 66 69 6c 65 73 20 74 6f 20 43 3a 5c 20 66 6f 6c 64 65 72 } //Extracting files to C:\ folder  0a 00 
