...
rule Trojan_Win32_Nanocore_ST_MTB{
	...
	strings :
		...
		$a_02_1 = {8b 04 0a 01 f3 90 02 04 0f ef c0 90 02 04 0f ef c9 0f 6e c0 0f 6e 0b 0f ef c1 90 02 04 51 0f 7e c1 88 c8 90 02 04 59 29 f3 90 02 04 83 c3 01 75 90 01 01 90 02 04 89 fb 90 02 04 90 02 04 89 04 0a 90 02 04 83 c1 01 75 c9 90 00 } //1
	condition:
