...
rule Trojan_Win32_IcedId_SIBJ6_MTB{
	...
	strings :
		...
		$a_03_1 = {83 c5 04 83 90 02 05 81 fd 90 01 04 90 02 0a 90 18 90 02 50 a1 90 01 04 90 02 0a 8b 94 28 90 01 04 90 02 4a 81 c2 90 01 04 90 02 0a a1 90 1b 05 89 94 28 90 00 } //1
	condition:
