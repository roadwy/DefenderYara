...
rule Trojan_Win32_IcedID_MC_MTB{
	...
	strings :
		...
		$a_01_2 = {4a 00 69 00 70 00 6f 00 6b 00 65 00 72 00 } //05 00  Jipoker
		$a_01_3 = {4b 00 69 00 6f 00 70 00 66 00 6a 00 65 00 6a 00 64 00 67 00 79 00 6b 00 } //01 00  Kiopfjejdgyk
		$a_01_4 = {66 72 6d 57 65 62 42 72 6f 77 73 65 72 } //01 00  frmWebBrowser
		$a_01_5 = {74 78 74 50 61 73 73 57 6f 72 64 } //00 00  txtPassWord
	condition:
		any of ($a_*)
