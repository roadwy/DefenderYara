...
rule Trojan_Win32_IcedId_PVS_MTB{
	...
	strings :
		$a_02_0 = {8b 5c 24 24 69 c5 83 e5 00 00 66 03 c8 8b 02 05 2c 5a 16 01 66 89 0d 90 01 04 8b 3d 90 01 04 2b df 89 02 90 00 } //2
		...
		$a_02_3 = {81 c2 f0 a5 f7 01 89 15 90 01 04 89 94 1e e9 fc ff ff 8b 35 90 01 04 ba 04 00 00 00 03 da 81 fb 07 04 00 00 89 15 90 09 06 00 8b 15 90 00 } //2
	condition:
