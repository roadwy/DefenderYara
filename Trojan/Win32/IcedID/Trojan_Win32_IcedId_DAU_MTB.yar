...
rule Trojan_Win32_IcedId_DAU_MTB{
	...
	strings :
		$a_02_0 = {53 6a 01 53 53 8d 44 24 90 01 01 50 89 5c 24 90 01 01 ff 15 90 01 04 85 c0 75 90 01 01 6a 08 6a 01 53 53 8d 4c 24 90 1b 00 51 ff 15 90 1b 02 85 c0 90 00 } //1
