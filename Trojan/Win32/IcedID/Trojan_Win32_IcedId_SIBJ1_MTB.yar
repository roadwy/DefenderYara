...
rule Trojan_Win32_IcedId_SIBJ1_MTB{
	...
	strings :
		$a_00_0 = {57 68 65 6e 62 6f 79 5c 74 65 6e 6b 65 70 74 5c 45 61 72 6c 79 56 61 6c 75 65 5c 63 6f 75 6c 64 2e 70 64 62 } //01 00  Whenboy\tenkept\EarlyValue\could.pdb
