...
rule Trojan_Win32_IcedId_SIBJ1_MTB{
	...
	strings :
		...
		$a_03_1 = {83 c6 04 8d 90 02 10 81 fe 90 01 04 90 18 90 02 3a 8b 15 90 01 04 90 02 0a 8b ac 32 90 01 04 90 02 5a a1 90 1b 04 81 c5 90 01 04 90 02 0a 89 ac 30 90 00 } //1
	condition:
