...
rule Trojan_Win32_IcedId_EC_MTB_2{
	...
	strings :
		$a_01_0 = {66 61 72 2e 64 6c 6c } //01 00 
		$a_01_1 = {44 65 73 65 72 74 } //01 00 
		$a_01_2 = {44 6c 6c 52 65 67 69 73 74 65 72 53 65 72 76 65 72 } //01 00 
		$a_01_3 = {46 72 75 69 74 62 6c 6f 77 } //01 00 
		$a_01_4 = {57 68 61 74 70 69 65 63 65 } //01 00 
		$a_01_5 = {47 65 74 45 6e 76 69 72 6f 6e 6d 65 6e 74 56 61 72 69 61 62 6c 65 57 } //01 00 
		$a_01_6 = {43 72 65 61 74 65 4d 75 74 65 78 57 } //00 00 
	condition:
		any of ($a_*)
