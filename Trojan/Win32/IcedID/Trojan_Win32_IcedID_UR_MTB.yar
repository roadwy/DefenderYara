...
rule Trojan_Win32_IcedID_UR_MTB{
	...
	strings :
		...
		$a_01_1 = {41 6f 6b 76 63 4f 69 67 6e 67 69 } //01 00  AokvcOigngi
		$a_01_2 = {55 71 6d 71 63 57 7a 66 69 6e } //01 00  UqmqcWzfin
		$a_01_3 = {51 66 70 51 6e 75 6d 68 6e 48 63 63 7a 6a 68 65 } //00 00  QfpQnumhnHcczjhe
	condition:
		any of ($a_*)
