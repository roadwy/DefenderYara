...
rule Trojan_Win32_IcedId_DAT_MTB{
	...
	strings :
		...
		$a_81_1 = {56 56 58 4e 48 5a 45 66 70 37 31 6b 46 6c 47 55 58 76 35 64 75 36 30 43 35 39 39 72 67 61 6d 53 42 79 53 73 6a 58 41 } //00 00  VVXNHZEfp71kFlGUXv5du60C599rgamSBySsjXA
	condition:
		any of ($a_*)
