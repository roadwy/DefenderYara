...
rule Trojan_Win32_IcedId_PK_MTB{
	...
	strings :
		...
		$a_01_1 = {74 68 75 73 20 62 61 6c 20 48 69 74 20 72 69 76 65 20 43 6f 6f 6b 20 4c 69 6e } //01 00  thus bal Hit rive Cook Lin
		$a_01_2 = {5c 54 68 69 73 5c 34 39 5c 73 6f 6c 64 69 65 72 5c 48 6f 70 65 2e 70 64 62 } //00 00  \This\49\soldier\Hope.pdb
	condition:
		any of ($a_*)
...
rule Trojan_Win32_IcedId_PK_MTB_2{
	...
	strings :
		...
		$a_01_1 = {5c 53 74 65 70 5c 53 68 6f 65 5c 57 61 76 65 5c 70 75 6c 6c 5c 41 6c 6c 6f 77 5c 63 6f 6e 64 69 74 69 6f 6e 5c 63 6f 70 79 2e 70 64 62 } //00 00  \Step\Shoe\Wave\pull\Allow\condition\copy.pdb
	condition:
		any of ($a_*)
