...
rule Trojan_Win32_IcedId_PK_MTB{
	...
	strings :
		$a_03_0 = {33 ff 8b f0 33 c9 8b 84 90 01 05 ba 90 01 04 f7 e2 03 c7 89 84 90 01 05 83 d2 00 41 8b fa 3b ce 75 90 00 } //1
...
rule Trojan_Win32_IcedId_PK_MTB_2{
	...
	strings :
		$a_03_0 = {0f b7 c2 2b d8 83 c3 1e 8b 44 24 18 81 c7 90 01 04 89 3d 90 01 04 89 1d 90 01 04 89 38 a1 90 01 04 8b 7c 24 18 2b c6 03 d0 83 c7 04 ff 4c 24 1c 89 54 24 90 01 01 89 7c 24 90 01 01 0f 90 00 } //1
