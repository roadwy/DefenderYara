...
rule Trojan_Win32_IcedId_DBF_MTB{
	...
	strings :
		...
		$a_81_1 = {50 72 65 63 65 64 69 6e 67 20 77 69 74 68 20 7a 65 72 6f 73 3a 20 25 30 31 30 64 } //02 00 
		$a_81_2 = {24 7d 2a 74 6e 4b 45 50 47 46 48 42 4c 53 4f } //00 00 
	condition:
		any of ($a_*)
