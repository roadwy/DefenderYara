...
rule Trojan_Win32_IcedId_DBL_MTB{
	...
	strings :
		...
		$a_81_1 = {45 63 58 31 45 73 41 64 75 5a 70 4a 72 51 47 6e 73 47 72 48 6c 32 50 73 44 4b 35 62 58 52 31 30 66 36 59 6d 75 43 75 30 6e 41 55 63 61 37 36 4d 67 70 4e } //00 00 
	condition:
		any of ($a_*)
