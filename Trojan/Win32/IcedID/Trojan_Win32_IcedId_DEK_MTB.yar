...
rule Trojan_Win32_IcedId_DEK_MTB{
	...
	strings :
		...
		$a_81_1 = {6f 6e 49 74 72 4f 78 38 63 7a 39 33 5a 70 79 6b 66 4a 6c 42 61 59 54 44 5a 76 5a 59 56 66 48 52 51 6a 69 45 42 34 61 } //00 00  onItrOx8cz93ZpykfJlBaYTDZvZYVfHRQjiEB4a
	condition:
		any of ($a_*)
