...
rule Trojan_Win32_IcedID_PVK_MTB{
	...
	strings :
		$a_02_0 = {8b 54 24 10 05 9c 29 cd 01 a3 90 01 04 89 02 90 09 05 00 a1 90 00 } //2
		$a_02_1 = {8b d7 b8 7c 00 00 00 03 c2 83 e8 7c a3 90 01 04 a1 90 01 04 8b 0d 90 01 04 89 08 90 00 } //2
