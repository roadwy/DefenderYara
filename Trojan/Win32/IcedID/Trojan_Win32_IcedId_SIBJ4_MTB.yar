...
rule Trojan_Win32_IcedId_SIBJ4_MTB{
	...
	strings :
		...
		$a_03_1 = {8b 00 89 44 24 90 01 01 90 02 20 8b 4c 24 90 01 01 8b 44 24 90 1b 00 83 44 24 90 1b 02 04 05 90 01 04 90 02 05 89 01 90 02 10 ff 4c 24 90 01 01 90 18 90 02 7a 8b 44 24 90 1b 02 90 02 0a 8b 00 89 44 24 90 00 } //1
	condition:
