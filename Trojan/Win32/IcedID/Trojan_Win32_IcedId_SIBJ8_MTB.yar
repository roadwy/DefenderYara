...
rule Trojan_Win32_IcedId_SIBJ8_MTB{
	...
	strings :
		$a_00_0 = {57 6f 72 6c 64 67 65 74 5c 42 69 67 2e 70 64 62 } //01 00  Worldget\Big.pdb
...
rule Trojan_Win32_IcedId_SIBJ8_MTB_2{
	...
	strings :
		$a_00_0 = {46 61 6d 69 6c 79 77 6f 6e 64 65 72 2e 70 64 62 } //01 00  Familywonder.pdb
