...
rule Trojan_Win32_IcedID_AF_MTB_2{
	...
	strings :
		$a_00_0 = {8b 41 24 8b 08 8d 51 01 89 10 8a 44 24 04 88 01 0f b6 c0 eb 0b } //10
		$a_80_1 = {44 6f 57 68 69 74 } //DoWhit  3
		$a_80_2 = {47 65 74 54 65 6d 70 50 61 74 68 41 } //GetTempPathA  3
		$a_80_3 = {4d 6f 76 65 46 69 6c 65 45 78 41 } //MoveFileExA  3
		$a_80_4 = {49 6d 61 67 65 4c 69 73 74 5f 44 72 61 67 53 68 6f 77 4e 6f 6c 6f 63 6b } //ImageList_DragShowNolock  3
	condition:
