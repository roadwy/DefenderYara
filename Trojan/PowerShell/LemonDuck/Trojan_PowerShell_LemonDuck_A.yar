...
rule Trojan_PowerShell_LemonDuck_A{
	...
	strings :
		...
		$a_02_5 = {2f 00 74 00 6e 00 20 00 52 00 74 00 73 00 61 00 [0-02] 20 00 2f 00 46 00 20 00 2f 00 74 00 72 00 20 00 22 00 70 00 6f 00 77 00 65 00 72 00 73 00 68 00 65 00 6c 00 6c 00 } //4
	condition:
