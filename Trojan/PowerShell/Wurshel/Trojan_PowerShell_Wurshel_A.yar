...
rule Trojan_PowerShell_Wurshel_A{
	...
	strings :
		...
		$a_02_1 = {2e 00 63 00 6c 00 61 00 73 00 73 00 27 00 2c 00 20 00 24 00 65 00 6e 00 76 00 3a 00 41 00 50 00 50 00 44 00 41 00 54 00 41 00 20 00 2b 00 20 00 27 00 5c 00 5c 00 5c 00 90 02 20 2e 00 65 00 78 00 65 00 27 00 90 00 } //1
	condition:
