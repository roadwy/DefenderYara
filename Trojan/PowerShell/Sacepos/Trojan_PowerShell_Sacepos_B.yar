...
rule Trojan_PowerShell_Sacepos_B{
	...
	strings :
		$a_00_0 = {64 00 6c 00 2e 00 64 00 72 00 6f 00 70 00 62 00 6f 00 78 00 75 00 73 00 65 00 72 00 63 00 6f 00 6e 00 74 00 65 00 6e 00 74 00 } //01 00  dl.dropboxusercontent
		$a_00_1 = {64 00 72 00 6f 00 70 00 62 00 6f 00 78 00 2e 00 63 00 6f 00 6d 00 2f 00 } //0a 00  dropbox.com/
		$a_00_2 = {2e 00 70 00 73 00 31 00 3f 00 64 00 6c 00 3d 00 } //0a 00  .ps1?dl=
