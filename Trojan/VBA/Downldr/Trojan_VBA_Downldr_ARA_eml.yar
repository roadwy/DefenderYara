...
rule Trojan_VBA_Downldr_ARA_eml{
	...
	strings :
		$a_02_0 = {70 72 61 6c 74 64 2e 63 6f 6d 2f [0-05] 2e 65 78 65 90 0a 28 00 44 6f 77 6e 6c 6f 61 64 46 69 6c 65 28 27 68 74 74 70 3a 2f 2f } //10
		$a_02_1 = {31 73 74 63 68 6f 69 63 65 70 65 73 74 63 6f 6e 74 72 6f 6c 2e 63 6f 2e 7a 61 2f [0-05] 2e 65 78 65 90 0a 2b 00 68 74 74 70 3a 2f 2f } //10
		...
		$a_03_7 = {20 2b 20 49 49 66 28 28 [0-03] 20 2b 20 [0-03] 29 20 3d 20 [0-03] 2c 20 22 [0-05] 22 2c 20 22 56 22 29 } //1
		$a_03_8 = {41 70 70 6c 69 63 61 74 69 6f 6e 2e 52 75 6e 20 22 [0-2f] 22 2c 20 [0-2f] 2c 20 [0-05] 20 2b 20 } //1
		$a_03_9 = {20 2b 20 49 49 66 28 28 [0-03] 20 2b 20 [0-03] 29 20 3d 20 [0-03] 2c 20 22 [0-05] 22 2c 20 22 [0-0a] 22 29 } //8
	condition:
