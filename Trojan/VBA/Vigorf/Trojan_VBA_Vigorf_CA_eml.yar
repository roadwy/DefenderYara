...
rule Trojan_VBA_Vigorf_CA_eml{
	...
	strings :
		$a_03_0 = {72 65 64 65 66 69 6c 65 70 72 2e 73 73 6c 62 6c 69 6e 64 61 64 6f 2e 63 6f 6d 2f 90 02 0f 2e 68 74 61 90 00 } //1
		$a_03_1 = {3d 20 47 65 74 4f 62 6a 65 63 74 28 22 77 69 6e 6d 67 6d 74 73 3a 90 02 50 5c 72 6f 6f 74 5c 63 69 6d 76 32 22 29 90 00 } //1
