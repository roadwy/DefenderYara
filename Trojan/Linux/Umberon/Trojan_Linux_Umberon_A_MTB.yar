...
rule Trojan_Linux_Umberon_A_MTB{
	...
	strings :
		...
		$a_02_3 = {75 73 72 2f 73 68 61 72 65 2f 6c 69 62 63 2e 73 6f 2e 90 02 15 2e 24 7b 50 4c 41 54 46 4f 52 4d 7d 2e 6c 64 2d 32 2e 32 32 2e 73 6f 90 00 } //2
		...
		$a_02_6 = {2f 6c 69 62 63 2e 73 6f 2e 90 02 15 2f 62 69 6e 2f 65 73 70 65 6f 6e 2d 73 68 65 6c 6c 90 00 } //2
