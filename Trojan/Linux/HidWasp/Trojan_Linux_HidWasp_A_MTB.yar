...
rule Trojan_Linux_HidWasp_A_MTB{
	...
	strings :
		...
		$a_02_1 = {78 78 64 20 2d 72 20 2d 70 20 3e 20 25 73 2e 74 6d 70 90 02 02 63 68 6d 6f 64 20 2d 2d 72 65 66 65 72 65 6e 63 65 20 25 73 20 25 73 2e 74 6d 70 90 02 02 6d 76 20 25 73 2e 74 6d 70 90 00 } //1
