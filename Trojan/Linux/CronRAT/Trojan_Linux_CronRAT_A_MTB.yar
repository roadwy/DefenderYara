...
rule Trojan_Linux_CronRAT_A_MTB{
	...
	strings :
		$a_03_0 = {49 89 c5 31 c0 8a 14 06 32 14 01 41 88 54 05 00 48 ff c0 48 83 f8 06 75 ec bf 01 00 00 00 be 0a 00 00 00 4c 89 ac 24 c0 01 00 00 e8 ?? ?? ?? 00 31 d2 48 89 c7 8a 44 15 00 41 32 04 14 88 04 17 48 ff c2 48 83 fa 09 75 ec be 01 00 00 00 48 89 bc 24 c8 01 00 00 e8 b8 a6 ff ff 48 89 c5 } //2
