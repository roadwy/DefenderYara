...
rule Trojan_Linux_Sotdas_A_MTB{
	...
	strings :
		...
		$a_02_3 = {6e 65 74 73 74 61 74 20 2d 61 6e 70 20 7c 20 67 72 65 70 90 02 05 3a 90 02 06 7c 61 77 6b 20 27 7b 70 72 69 6e 74 20 24 4e 46 7d 27 20 7c 63 75 74 20 2d 64 90 02 15 78 61 72 67 73 20 6b 69 6c 6c 20 2d 39 20 3e 20 2f 64 65 76 2f 6e 75 6c 6c 20 3b 66 72 65 65 20 2d 6d 20 3e 20 2f 64 65 76 2f 6e 75 6c 6c 90 00 } //1
