...
rule Trojan_Linux_Dnsamp_A_MTB{
	...
	strings :
		$a_02_0 = {c6 40 01 00 e8 ?? ?? ?? ?? 89 c2 48 8b 45 f0 66 89 50 04 48 8b 45 f0 66 c7 40 02 00 00 48 8b 45 f0 66 c7 40 06 00 00 48 8b 85 e8 fe ff ff 48 83 c0 10 48 89 45 f8 48 8d 85 f0 fe ff ff c7 00 b0 a1 b0 a1 c7 40 04 b0 a1 b0 a1 66 c7 40 08 b0 a1 c6 40 0a 00 48 8d 85 f0 fe ff ff } //1
