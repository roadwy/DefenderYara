...
rule Trojan_Linux_Xarcen_C_MTB{
	...
	strings :
		$a_00_0 = {23 47 72 6f 75 6e 64 68 6f 67 } //01 00 
		$a_00_1 = {33 20 2a 20 2a 20 2a 20 2a 20 72 6f 6f 74 20 2f 65 74 63 2f 63 72 6f 6e 2e 68 6f 75 72 6c 79 2f 6e 6f 63 } //01 00 
