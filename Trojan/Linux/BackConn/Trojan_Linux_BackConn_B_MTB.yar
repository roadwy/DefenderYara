...
rule Trojan_Linux_BackConn_B_MTB{
	...
	strings :
		$a_00_0 = {2f 65 74 63 2f 69 6e 69 74 2e 64 2f 75 70 64 61 74 65 2d 6e 6f 74 69 66 69 65 72 } //01 00  /etc/init.d/update-notifier
		$a_00_1 = {65 74 63 2f 72 63 32 2e 64 2f 53 30 31 75 70 64 61 74 65 2d 6e 6f 74 69 66 69 65 72 } //02 00  etc/rc2.d/S01update-notifier
