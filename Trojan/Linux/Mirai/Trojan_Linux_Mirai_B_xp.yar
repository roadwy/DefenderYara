...
rule Trojan_Linux_Mirai_B_xp{
	...
	strings :
		$a_01_0 = {72 6d 20 2d 72 66 20 2f 6d 6e 74 2f 6d 79 64 69 72 } //01 00  rm -rf /mnt/mydir
		$a_01_1 = {68 6d 6f 64 20 37 37 37 20 2f 6d 6e 74 2f 6d 79 64 69 72 2f } //01 00  hmod 777 /mnt/mydir/
		...
		$a_01_4 = {59 52 46 25 36 75 64 43 4a 46 47 } //00 00  YRF%6udCJFG
	condition:
		any of ($a_*)
