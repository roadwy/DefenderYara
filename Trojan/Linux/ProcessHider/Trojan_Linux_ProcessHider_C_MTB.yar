...
rule Trojan_Linux_ProcessHider_C_MTB_2{
	...
	strings :
		$a_01_0 = {78 61 5f 66 69 6e 61 6c 69 7a 65 00 5f 4a 76 5f 52 65 67 69 73 74 65 72 43 6c 61 73 73 65 73 00 64 69 72 66 64 00 73 6e 70 72 69 6e 74 66 00 72 65 61 64 6c 69 6e 6b 00 73 74 72 73 70 6e 00 73 74 72 6c 65 6e 00 66 6f 70 65 6e 00 66 67 65 74 73 00 66 63 6c 6f 73 65 00 73 73 63 61 6e 66 00 72 65 61 64 64 69 72 36 34 00 64 6c 73 79 6d 00 } //01 00  慸晟湩污穩e䩟彶敒楧瑳牥汃獡敳s楤晲d湳牰湩晴爀慥汤湩k瑳獲湰猀牴敬n潦数n杦瑥s捦潬敳猀捳湡f敲摡楤㙲4汤祳m
		...
		$a_01_2 = {67 65 74 5f 70 72 6f 63 65 73 73 5f 6e 61 6d 65 } //00 00  get_process_name
	condition:
		any of ($a_*)
