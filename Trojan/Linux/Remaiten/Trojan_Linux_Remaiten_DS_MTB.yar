...
rule Trojan_Linux_Remaiten_DS_MTB{
	...
	strings :
		$a_03_0 = {2f 62 69 6e 2f 62 75 73 79 62 6f 78 20 74 66 74 70 20 2d 67 20 2d 72 20 61 2e 73 68 20 90 02 15 3b 74 66 74 70 20 2d 67 20 2d 72 20 61 2e 73 68 20 90 02 15 3b 2f 62 69 6e 2f 62 75 73 79 62 6f 78 20 77 67 65 74 20 68 74 74 70 90 02 18 2f 61 2e 73 68 3b 77 67 65 74 20 68 74 74 70 90 02 18 2f 61 2e 73 68 3b 2f 62 69 6e 2f 62 75 73 79 62 6f 78 20 73 68 20 61 2e 73 68 3b 73 68 20 61 2e 73 68 90 02 07 2e 74 90 00 } //1
