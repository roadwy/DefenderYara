...
rule Trojan_Linux_GitCredentials_A{
	...
	strings :
		...
		$a_00_1 = {70 00 61 00 73 00 73 00 77 00 6f 00 72 00 64 00 } //01 00 
		$a_00_2 = {70 00 61 00 73 00 73 00 } //01 00 
		$a_00_3 = {70 00 77 00 } //01 00 
		$a_00_4 = {6b 00 65 00 79 00 } //00 00 
	condition:
		any of ($a_*)
