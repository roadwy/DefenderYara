...
rule Trojan_Linux_Downldr_A_xp{
	...
	strings :
		...
		$a_02_1 = {65 63 68 6f 20 27 2a 20 2a 20 2a 20 2a 20 2a 20 65 63 68 6f 20 2d 6e 90 02 05 7c 20 62 61 73 65 36 34 20 2d 64 20 7c 73 68 20 3e 20 2f 64 65 76 2f 6e 75 6c 6c 20 32 3e 26 31 27 20 7c 20 63 72 6f 6e 74 61 62 90 00 } //1
