...
rule Trojan_Linux_MsfShellBin_C{
	...
	strings :
		...
		$a_03_1 = {6a 7d 58 99 b2 07 b9 00 10 00 00 89 e3 66 81 e3 00 f0 cd 80 31 db f7 e3 53 43 53 6a 90 01 01 89 e1 b0 66 cd 80 51 6a 04 54 6a 02 6a 01 50 97 89 e1 6a 0e 5b 6a 66 58 cd 80 90 00 } //1
