...
rule Trojan_Linux_Sniff_A_xp{
	...
	strings :
		$a_01_0 = {2f 76 61 72 2f 74 6d 70 2f 2e 66 73 5f 72 65 70 5f 73 6e 2e 6c 6f 67 } //01 00  /var/tmp/.fs_rep_sn.log
		...
		$a_01_3 = {52 45 53 53 44 41 54 45 43 4d 44 53 43 4f 4d 50 4d 4f 44 52 } //00 00  RESSDATECMDSCOMPMODR
	condition:
		any of ($a_*)
