...
rule Trojan_Linux_CoinMiner_P_MTB{
	...
	strings :
		...
		$a_00_1 = {63 68 6d 6f 64 20 2b 78 20 2f 74 6d 70 2f 2e 67 67 2f 2a } //01 00  chmod +x /tmp/.gg/*
		$a_00_2 = {63 64 20 2f 74 6d 70 2f 2e 67 67 20 26 26 20 72 6d 20 2d 72 66 20 74 6f 70 20 78 } //00 00  cd /tmp/.gg && rm -rf top x
	condition:
		any of ($a_*)
