...
rule Trojan_Linux_CoinMiner_C_xp{
	...
	strings :
		$a_03_0 = {48 31 ed 48 89 e7 48 8d 35 f4 e9 bf ff 48 83 e4 f0 e8 90 01 03 00 48 8d 57 08 50 48 8b 37 4c 8d 05 5e b9 0c 00 48 8b 0d dd 38 44 00 45 31 c9 48 8d 3d 7b f6 ff ff 90 00 } //1
