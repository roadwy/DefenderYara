...
rule Trojan_Linux_Tsunami_B_xp{
	...
	strings :
		...
		$a_01_1 = {66 51 52 61 51 52 6b 51 52 65 51 52 6e 51 52 61 51 52 6d 51 52 65 } //01 00  fQRaQRkQReQRnQRaQRmQRe
		$a_01_2 = {47 51 52 45 51 52 54 51 52 53 51 52 50 51 52 4f 51 52 4f 51 52 46 51 52 53 } //01 00  GQREQRTQRSQRPQROQROQRFQRS
		$a_01_3 = {51 52 42 51 52 4f 51 52 54 51 52 53 } //00 00  QRBQROQRTQRS
