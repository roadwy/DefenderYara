...
rule Trojan_Linux_ZHTrap_A_xp{
	...
	strings :
		$a_00_0 = {2f 62 69 6e 2f 62 75 73 79 62 6f 78 20 5a 48 54 52 41 50 } //01 00 
		$a_00_1 = {5a 6f 6e 65 53 65 63 } //01 00 
		$a_00_2 = {51 6a 66 6a 78 53 52 44 46 47 53 46 44 64 66 } //01 00 
		$a_00_3 = {74 30 74 61 6c 63 30 6e 74 72 30 6c 34 } //01 00 
		$a_00_4 = {68 61 63 6b 74 68 65 77 6f 72 6c 64 31 33 33 37 } //01 00 
