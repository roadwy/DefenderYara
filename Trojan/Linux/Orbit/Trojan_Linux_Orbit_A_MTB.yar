...
rule Trojan_Linux_Orbit_A_MTB{
	...
	strings :
		...
		$a_01_2 = {2f 74 6d 70 2f 2e 6f 72 62 69 74 } //05 00 
		$a_01_3 = {2f 64 65 76 2f 73 68 6d 2f 2e 6c 63 6b } //01 00 
		$a_01_4 = {73 6e 69 66 66 5f 73 73 68 5f 73 65 73 73 69 6f 6e } //00 00 
	condition:
		any of ($a_*)
