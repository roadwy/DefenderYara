...
rule Trojan_Linux_Orbit_A_MTB{
	...
	strings :
		$a_03_0 = {2f 6c 69 62 2f 90 02 15 2f 73 73 68 70 61 73 73 2e 74 78 74 90 00 } //5
		$a_03_1 = {6d 76 20 2f 6c 69 62 2f 90 02 15 2f 2e 62 61 63 6b 75 70 5f 6c 64 2e 73 6f 90 00 } //5
