...
rule Trojan_Linux_Reptile_C{
	...
	strings :
		$a_03_0 = {89 d8 31 d2 89 df 41 f7 f0 81 f7 ?? ?? ?? ?? 83 eb 04 88 d1 d3 c7 31 3e 48 83 c6 04 83 fb ?? 75 df } //2
		$a_03_1 = {89 f0 31 d2 41 89 f0 41 f7 f1 41 81 f0 ?? ?? ?? ?? 83 ee 04 88 d1 41 d3 c0 44 31 07 48 83 c7 04 83 fe 04 75 db } //2
		$a_03_2 = {44 89 c8 31 d2 29 f0 89 c7 41 f7 f0 81 f7 ?? ?? ?? ?? ?? ?? d3 c7 31 be ?? ?? ?? ?? 48 83 c6 04 48 81 fe ?? ?? ?? ?? 75 d7 } //2
