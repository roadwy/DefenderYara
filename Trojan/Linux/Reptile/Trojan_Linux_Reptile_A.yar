...
rule Trojan_Linux_Reptile_A{
	...
	strings :
		...
		$a_03_3 = {4f ec c4 4e 90 02 04 89 90 02 03 c1 90 01 01 02 89 90 01 01 01 90 01 01 01 90 01 01 c1 90 01 01 02 01 90 01 01 29 90 01 01 89 90 01 01 90 03 01 01 8b 89 90 02 08 90 03 01 01 33 31 90 00 } //1
		$a_03_4 = {2f 72 65 70 74 69 6c 65 2f 72 65 70 74 69 6c 65 5f 63 6d 64 90 01 01 66 69 6c 65 2d 74 61 6d 70 65 72 69 6e 67 90 00 } //4
	condition:
