...
rule Trojan_Linux_Pomedaj_A_MTB{
	...
	strings :
		$a_00_0 = {77 67 65 74 20 2d 63 20 70 6d 2e 69 70 66 73 77 61 6c 6c 65 74 2e 74 6b 2f } //01 00  wget -c pm.ipfswallet.tk/
		$a_00_1 = {2f 75 73 72 2f 69 6e 63 6c 75 64 65 2f 70 6d 2e 74 61 72 2e 67 7a } //02 00  /usr/include/pm.tar.gz
