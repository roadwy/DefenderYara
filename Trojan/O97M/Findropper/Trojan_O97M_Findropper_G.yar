...
rule Trojan_O97M_Findropper_G{
	...
	strings :
		...
		$a_02_1 = {3d 20 52 65 70 6c 61 63 65 28 55 73 65 72 46 6f 72 6d 31 2e [0-0a] 2e 43 61 70 74 69 6f 6e 2c 20 22 23 22 2c 20 22 22 29 } //1
		$a_00_2 = {4d 73 67 42 6f 78 20 28 22 44 65 63 72 79 70 74 69 6f 6e 20 65 72 72 6f 72 22 29 } //1 MsgBox ("Decryption error")
		$a_02_3 = {4f 70 65 6e 20 [0-0a] 20 46 6f 72 20 4f 75 74 70 75 74 20 41 73 20 23 34 39 } //1
	condition:
