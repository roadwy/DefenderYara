...
rule Trojan_O97M_Donoff_PK{
	...
	strings :
		$a_00_0 = {54 45 4d 50 24 } //0a 00  TEMP$
		$a_00_1 = {5c 72 65 73 75 6d 65 2e 68 74 61 } //01 00  \resume.hta
		$a_00_2 = {41 44 4f 44 42 2e 53 74 72 65 61 6d 24 } //0a 00  ADODB.Stream$
