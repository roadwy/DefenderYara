...
rule Trojan_O97M_Donoff_RM_MTB{
	...
	strings :
		...
		$a_03_1 = {3d 20 47 65 74 4f 62 6a 65 63 74 28 22 6e 65 77 3a [0-3f] 22 29 } //1
		...
		$a_03_3 = {2b 20 22 77 77 77 2e 70 73 31 22 0d 0a [0-07] 20 3d 20 [0-05] 20 2b 20 22 77 77 77 2e 74 78 74 22 0d 0a [0-05] 20 3d 20 22 22 0d 0a [0-0a] 20 3d 20 22 5a 5a 5a 5a 5a 5a 5a 5a 5a 5a 5a 5a 5a 5a 5a 5a 5a 5a 5a 5a 5a 5a 5a 5a 5a 5a 5a 5a 22 } //1
	condition:
