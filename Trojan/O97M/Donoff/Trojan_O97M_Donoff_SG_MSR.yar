...
rule Trojan_O97M_Donoff_SG_MSR{
	...
	strings :
		...
		$a_03_1 = {6f 62 6a 2e 52 75 6e 90 02 20 22 43 3a 2f 44 6f 63 75 6d 65 6e 74 73 20 61 6e 64 20 53 65 74 74 69 6e 67 73 2f 41 6c 6c 20 75 73 65 72 73 2f 44 65 73 6b 74 6f 70 2f 90 02 10 2e 62 61 74 90 00 } //1
		...
		$a_00_3 = {2f 2e 64 63 63 20 73 65 6e 64 20 24 6e 69 63 6b 20 43 3a 5c 57 69 6e 64 6f 77 73 5c 90 02 10 2e 64 6f 63 90 00 } //1
	condition:
