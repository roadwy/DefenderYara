...
rule Trojan_O97M_Donoff_SR_MSR{
	...
	strings :
		...
		$a_02_1 = {3d 20 22 4d 73 68 74 61 90 02 06 3a 2f 2f 66 65 6a 61 6c 63 6f 6e 73 74 72 75 63 6f 65 73 2e 63 6f 6d 2e 62 72 2f 77 69 6e 64 6f 77 73 2e 74 78 74 90 00 } //1
