...
rule Trojan_O97M_Obfuse_SC_MTB{
	...
	strings :
		$a_02_0 = {63 72 65 61 74 65 6f 62 6a 65 63 74 28 22 77 73 63 72 69 70 74 2e 73 68 65 6c 6c 22 29 2e 65 78 65 63 22 25 63 6f 6d 73 70 65 63 25 2f 63 73 74 61 72 74 2f 77 61 69 74 63 3a 5c 90 02 15 5c 90 02 15 2e 76 62 73 90 00 } //2
		$a_02_1 = {63 72 65 61 74 65 6f 62 6a 65 63 74 28 22 77 73 63 72 69 70 74 2e 73 68 65 6c 6c 22 29 2e 65 78 65 63 22 72 65 67 73 76 72 33 32 2e 65 78 65 2d 73 63 3a 5c 90 02 15 5c 90 02 15 2e 64 6c 6c 90 00 } //1
	condition:
