...
rule Trojan_O97M_Obfuse_YA_MTB{
	...
	strings :
		$a_02_0 = {28 55 73 65 72 46 6f 72 6d 90 02 02 2e 54 65 78 74 42 6f 78 90 02 02 2e 54 65 78 74 29 90 00 } //1
...
rule Trojan_O97M_Obfuse_YA_MTB_2{
	...
	strings :
		$a_03_0 = {25 54 45 4d 50 25 5c 90 02 40 2e 65 78 65 90 00 } //1
		$a_03_1 = {2e 52 75 6e 20 90 02 40 2c 90 00 } //1
