...
rule Trojan_O97M_Obfuse_BU{
	...
	strings :
		...
		$a_01_1 = {2e 54 65 78 74 46 72 61 6d 65 2e 54 65 78 74 52 61 6e 67 65 2e 54 65 78 74 20 2b 20 } //01 00 
		...
		$a_01_5 = {22 6e 65 77 3a 37 32 43 32 34 44 44 35 2d 44 37 30 41 2d 34 33 38 42 2d 38 41 34 32 2d 39 38 34 32 34 42 38 38 41 46 42 38 22 20 2b 20 } //00 00 
	condition:
		any of ($a_*)
