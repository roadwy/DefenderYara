...
rule Trojan_O97M_Obfuse_BU{
	...
	strings :
		$a_03_0 = {53 68 61 70 65 73 28 22 90 12 10 00 22 29 90 00 } //10
		$a_01_1 = {2e 54 65 78 74 46 72 61 6d 65 2e 54 65 78 74 52 61 6e 67 65 2e 54 65 78 74 20 2b 20 } //10 .TextFrame.TextRange.Text + 
		$a_03_2 = {2e 52 75 6e 20 90 02 10 2c 90 00 } //1
		$a_03_3 = {2e 52 75 6e 21 90 02 10 2c 90 00 } //1
		$a_03_4 = {2e 52 75 6e 23 90 02 10 2c 90 00 } //1
