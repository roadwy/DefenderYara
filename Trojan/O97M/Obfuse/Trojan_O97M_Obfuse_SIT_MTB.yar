...
rule Trojan_O97M_Obfuse_SIT_MTB{
	...
	strings :
		...
		$a_03_2 = {72 65 74 76 61 6c 20 3d 20 53 68 65 6c 6c 28 46 6e 61 6d 65 2c 20 76 62 4d 69 6e 69 6d 69 7a 65 64 46 6f 63 75 73 29 [0-03] 45 6e 64 20 53 75 62 } //1
