...
rule Trojan_O97M_Obfuse_SR_MTB{
	...
	strings :
		$a_01_0 = {45 78 65 63 43 6d 64 28 63 6d 64 6c 69 6e 65 20 41 73 20 53 74 72 69 6e 67 29 } //01 00  ExecCmd(cmdline As String)
		$a_01_1 = {3d 20 43 72 65 61 74 65 50 72 6f 63 65 73 73 41 28 } //01 00  = CreateProcessA(
