...
rule Trojan_O97M_Obfuse_SR_MTB{
	...
	strings :
		...
		$a_03_2 = {45 78 65 63 43 6d 64 20 22 43 3a 5c [0-10] 5c [0-0a] 2e 42 41 54 22 } //1
		$a_03_3 = {45 78 65 63 43 6d 64 20 22 43 3a 5c [0-0a] 5c [0-0a] 5c [0-0a] 2e 65 78 65 22 } //1
	condition:
