...
rule Trojan_O97M_Obfuse_K{
	...
	strings :
		...
		$a_03_1 = {2e 43 72 65 61 74 65 54 65 78 74 46 69 6c 65 28 90 02 20 2c 20 54 72 75 65 2c 20 54 72 75 65 29 0d 0a 90 02 20 2e 57 72 69 74 65 20 90 02 20 0d 0a 90 02 20 2e 43 6c 6f 73 65 90 00 } //1
