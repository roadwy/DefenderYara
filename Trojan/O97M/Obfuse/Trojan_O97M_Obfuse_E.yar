...
rule Trojan_O97M_Obfuse_E{
	...
	strings :
		...
		$a_03_3 = {20 3d 20 43 68 72 28 41 73 63 28 90 02 0f 29 20 2b 20 33 29 0d 0a 20 20 20 49 66 20 90 00 } //1
		$a_03_4 = {20 3d 20 4d 69 64 28 90 02 0f 2c 20 90 02 0f 2c 20 31 29 0d 0a 20 20 20 49 66 20 90 00 } //1
	condition:
