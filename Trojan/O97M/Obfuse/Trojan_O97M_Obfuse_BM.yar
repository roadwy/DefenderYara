...
rule Trojan_O97M_Obfuse_BM{
	...
	strings :
		$a_00_0 = {41 74 74 72 69 62 75 74 65 20 56 42 5f 4e 61 6d 65 20 3d 20 22 6b 61 69 70 77 55 7a 77 42 22 } //01 00 
		$a_00_1 = {56 42 5f 4e 61 6d 65 20 3d 20 22 62 77 69 4f 6e 69 69 7a 56 42 68 22 } //01 00 
		$a_00_2 = {53 75 62 20 41 75 74 6f 4f 70 65 6e 28 29 } //01 00 
