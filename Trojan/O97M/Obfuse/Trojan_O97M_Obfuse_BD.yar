...
rule Trojan_O97M_Obfuse_BD{
	...
	strings :
		$a_03_0 = {4d 64 2e 22 20 2b 90 02 30 2b 20 46 6f 72 6d 61 74 28 43 68 72 90 02 01 28 90 00 } //2
		$a_03_1 = {22 4d 64 22 20 2b 20 43 68 72 28 53 71 72 28 90 02 20 29 29 20 2b 20 22 22 20 2b 20 46 6f 72 6d 61 74 28 43 68 72 90 00 } //2
		$a_03_2 = {22 64 2e 22 20 2b 20 46 6f 72 6d 61 74 28 43 68 72 28 28 28 90 02 20 29 29 29 20 2b 20 22 90 02 01 22 20 2b 20 46 6f 72 6d 61 74 28 43 68 72 28 28 28 90 00 } //2
