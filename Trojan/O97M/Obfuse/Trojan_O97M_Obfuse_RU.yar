...
rule Trojan_O97M_Obfuse_RU{
	...
	strings :
		$a_01_0 = {50 72 69 76 61 74 65 20 53 75 62 20 44 6f 63 75 6d 65 6e 74 5f 6f 70 65 6e 28 29 } //01 00 
		...
		$a_01_2 = {2e 54 65 78 74 52 61 6e 67 65 2e 54 65 78 74 } //01 00 
