...
rule Trojan_O97M_Obfuse_CA{
	...
	strings :
		...
		$a_02_1 = {20 3d 20 41 72 72 61 79 28 90 02 10 2c 20 90 02 10 2c 20 90 02 10 2c 20 49 6e 74 65 72 61 63 74 69 6f 6e 20 5f 90 00 } //1
		$a_02_2 = {2e 53 68 61 70 65 73 28 90 02 10 20 2b 90 00 } //1
	condition:
