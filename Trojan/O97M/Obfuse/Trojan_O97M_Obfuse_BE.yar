...
rule Trojan_O97M_Obfuse_BE{
	...
	strings :
		...
		$a_00_2 = {20 28 4b 65 79 53 74 72 69 6e 67 28 } //01 00   (KeyString(
		$a_00_3 = {20 2b 20 4b 65 79 53 74 72 69 6e 67 28 } //01 00   + KeyString(
		$a_00_4 = {28 30 29 20 3d 20 } //01 00  (0) = 
		$a_00_5 = {28 31 29 20 3d 20 } //01 00  (1) = 
