...
rule Trojan_O97M_Obfuse_BG_2{
	...
	strings :
		...
		$a_03_1 = {53 68 61 70 65 73 28 22 90 02 20 22 29 90 00 } //1
		$a_03_2 = {53 68 61 70 65 73 28 90 02 20 20 2b 20 22 90 02 20 22 20 2b 20 90 00 } //1
		$a_03_3 = {49 6e 74 65 72 61 63 74 69 6f 6e 90 02 05 2e 53 68 65 6c 6c 90 00 } //1
		$a_03_4 = {46 69 78 28 90 02 20 20 2b 20 48 65 78 28 90 02 20 29 90 00 } //1
		$a_03_5 = {53 68 61 70 65 73 28 90 02 20 29 2e 54 65 78 74 46 72 61 6d 65 2e 43 6f 6e 74 61 69 6e 69 6e 67 52 61 6e 67 65 90 00 } //1
		$a_03_6 = {3d 20 53 68 61 70 65 73 28 90 02 20 20 2b 20 90 02 20 20 2b 20 90 02 02 20 2b 20 90 02 20 20 2b 20 90 02 20 29 2e 54 65 78 74 46 72 61 6d 65 2e 43 6f 6e 74 61 69 6e 69 6e 67 52 61 6e 67 65 90 00 } //1
		$a_03_7 = {53 68 65 6c 6c 28 90 02 20 20 2b 20 90 02 20 20 2b 20 90 02 20 2c 20 90 02 20 29 90 00 } //1
	condition:
