...
rule Trojan_O97M_Obfuse_AV{
	...
	strings :
		...
		$a_00_2 = {5e 62 5e 67 5e 42 5e 30 5e 41 5e 43 5e 6b 5e 41 5e 4c 5e 67 5e 42 5e 45 5e 41 5e 47 5e 38 5e 41 5e 64 5e 77 5e 42 5e 75 5e 41 5e 47 5e 77 5e } //00 00 
	condition:
		any of ($a_*)
