...
rule Trojan_O97M_EncDoc_RPM_MTB{
	...
	strings :
		$a_01_0 = {3d 73 74 72 72 65 76 65 72 73 65 28 22 74 78 74 2e 63 6e 65 2f 38 38 2f 35 34 2e 31 30 31 2e 32 33 31 2e 38 33 2f 2f 3a 70 74 74 68 22 29 } //01 00  =strreverse("txt.cne/88/54.101.231.83//:ptth")
		$a_01_1 = {52 65 70 6c 61 63 65 28 } //00 00  Replace(
	condition:
		any of ($a_*)
