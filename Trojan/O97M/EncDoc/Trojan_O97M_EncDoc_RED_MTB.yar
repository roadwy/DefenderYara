...
rule Trojan_O97M_EncDoc_RED_MTB{
	...
	strings :
		...
		$a_03_1 = {53 65 74 20 90 02 0f 20 3d 20 43 72 65 61 74 65 4f 62 6a 65 63 74 28 22 77 73 63 72 69 70 74 2e 73 68 65 6c 6c 22 29 0d 0a 90 1b 00 2e 65 78 65 63 20 70 28 67 65 74 77 63 29 90 00 } //1
	condition:
