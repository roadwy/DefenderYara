...
rule Trojan_O97M_JsDropper_B{
	...
	strings :
		...
		$a_00_1 = {2e 41 74 74 61 63 68 65 64 54 65 6d 70 6c 61 74 65 2e 50 61 74 68 } //0a 00 
		$a_00_2 = {26 20 22 2e 6a 73 65 22 } //01 00 
		$a_00_3 = {57 73 68 53 63 72 69 70 74 2e 53 68 65 6c 6c 45 78 65 63 75 74 65 } //01 00 
