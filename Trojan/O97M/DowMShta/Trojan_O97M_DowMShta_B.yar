...
rule Trojan_O97M_DowMShta_B{
	...
	strings :
		...
		$a_80_4 = {73 74 61 72 74 20 6d 73 68 74 61 } //start mshta  65436
		$a_80_5 = {63 6d 64 20 2f 63 20 6d 73 68 74 61 } //cmd /c mshta  65436
	condition:
		((#a_80_0  & 1)*10+(#a_80_1  & 1)*10+(#a_80_2  & 1)*10+(#a_80_3  & 1)*10+(#a_80_4  & 1)*65436+(#a_80_5  & 1)*65436) >=10
