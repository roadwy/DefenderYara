...
rule Trojan_O97M_Makform_A{
	...
	strings :
		$a_02_0 = {52 65 70 6c 61 63 65 41 6c 6c ?? 2e 53 65 6e 64 } //1
		$a_02_1 = {52 65 70 6c 61 63 65 41 6c 6c ?? 2e 73 61 76 65 74 6f 66 69 6c 65 20 22 66 74 7a 70 2e 65 22 20 26 20 22 78 65 22 2c 20 32 } //2
