...
rule Trojan_O97M_Vobfush_A{
	...
	strings :
		$a_02_0 = {20 2f 20 54 61 6e 28 90 1d 20 00 90 0a e0 00 20 3d 20 28 90 1f 10 00 20 2b 20 52 6f 75 6e 64 28 90 1d 20 00 29 20 2a 20 90 1f 10 00 20 2d 20 90 1d 20 00 20 2b 20 28 90 00 } //10
