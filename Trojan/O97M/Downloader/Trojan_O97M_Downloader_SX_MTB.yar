...
rule Trojan_O97M_Downloader_SX_MTB{
	...
	strings :
		$a_03_0 = {3a 5c 47 72 61 76 69 74 79 5c 47 72 61 76 69 74 79 32 [0-06] 70 6e 67 21 [0-06] 68 74 74 70 3a 2f 2f 65 72 69 6b 76 61 6e 77 65 6c 2e 6e 6c 2f 78 79 71 66 6f 73 6e 6d 63 6d 71 2f } //1
		...
		$a_03_3 = {65 78 70 6c 6f 72 65 72 [0-0a] 3a 5c 47 72 61 76 69 74 79 5c 47 72 61 76 69 74 79 32 5c [0-0a] 2e 65 78 65 } //1
	condition:
