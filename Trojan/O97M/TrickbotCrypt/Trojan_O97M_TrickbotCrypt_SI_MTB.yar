...
rule Trojan_O97M_TrickbotCrypt_SI_MTB{
	...
	strings :
		$a_02_0 = {6f 70 65 6e 22 63 3a 5c 90 02 15 5c 90 02 15 2e 76 62 65 22 66 6f 72 6f 75 74 70 75 74 61 63 63 65 73 73 77 72 69 74 65 61 73 90 00 } //1
		$a_02_1 = {73 68 63 72 65 61 74 65 64 69 72 65 63 74 6f 72 79 65 78 30 2c 90 02 0f 2c 62 79 76 61 6c 30 26 90 00 } //1
