...
rule Trojan_O97M_Predator_BB_MTB{
	...
	strings :
		$a_01_0 = {56 42 41 2e 43 72 65 61 74 65 4f 62 6a 65 63 74 28 22 4d 53 58 4d 4c 32 2e 44 4f 4d 44 6f 63 75 6d 65 6e 74 22 29 2e 43 72 65 61 74 65 45 6c 65 6d 65 6e 74 28 22 64 75 6d 6d 79 22 29 } //01 00 
		$a_01_1 = {2e 44 61 74 61 54 79 70 65 20 3d 20 22 62 69 6e 22 20 2b 20 22 2e 62 61 73 65 36 34 22 } //01 00 
