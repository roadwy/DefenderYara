...
rule Trojan_O97M_Schla_A_MTB{
	...
	strings :
		...
		$a_03_2 = {2e 54 61 67 90 09 10 00 3d 20 90 02 10 2e 54 61 67 90 00 } //1
		$a_03_3 = {41 70 70 6c 69 63 61 74 69 6f 6e 2e 52 75 6e 20 90 02 10 2e 4c 61 62 65 6c 90 02 02 2e 54 61 67 90 00 } //1
	condition:
