...
rule Trojan_O97M_Prenebevs{
	...
	strings :
		...
		$a_02_4 = {46 69 6c 65 43 6f 70 79 20 90 02 20 20 26 20 22 5c 57 69 6e 64 6f 77 73 5c 53 79 73 74 65 6d 33 32 5c 77 73 63 72 69 70 74 2e 65 78 65 22 2c 90 00 } //10
	condition:
