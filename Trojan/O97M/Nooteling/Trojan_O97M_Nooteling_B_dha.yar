...
rule Trojan_O97M_Nooteling_B_dha{
	...
	strings :
		...
		$a_00_1 = {73 74 61 67 65 5f 32 20 3d 20 22 41 41 45 41 41 41 44 2f 2f 2f 2f 2f } //01 00 
		$a_00_2 = {46 75 6e 63 74 69 6f 6e 20 62 36 34 44 65 63 6f 64 65 28 } //00 00 
	condition:
		any of ($a_*)
