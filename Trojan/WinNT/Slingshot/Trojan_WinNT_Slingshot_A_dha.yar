...
rule Trojan_WinNT_Slingshot_A_dha{
	...
	strings :
		$a_03_0 = {bf 73 6e 6d 65 57 6a 18 51 ff 15 ?? ?? ?? ?? 8b d8 85 db 75 09 c7 45 fc 9a 00 00 c0 } //2
		$a_03_1 = {7d 14 32 d2 8b ce 89 5e 18 ff 15 ?? ?? ?? ?? 8b c3 e9 ?? ?? 00 00 81 7f 0c 00 20 22 00 } //2
		$a_03_2 = {ff d5 85 c0 74 ?? 83 67 0c 00 83 27 00 89 47 08 53 ff 74 24 20 c7 00 58 89 04 24 } //2
