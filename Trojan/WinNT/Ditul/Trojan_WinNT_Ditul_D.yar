...
rule Trojan_WinNT_Ditul_D{
	...
	strings :
		...
		$a_01_4 = {00 10 8b 42 04 8d 14 24 cd 2e 83 c4 14 89 45 e0 83 7d e0 00 7c } //03 00 
		$a_03_5 = {6a 0a 8d 46 04 50 ff 76 1c e8 90 01 02 ff ff 8d 45 e8 50 8d 45 c4 50 ff 76 14 8d 46 10 50 ff 15 90 00 } //03 00 
		$a_01_6 = {8b 06 8b 09 8d 3c 81 57 c7 45 fc 20 00 00 00 ff d3 84 c0 74 } //04 00 
		$a_01_7 = {89 1f 0f 20 c0 0d 00 00 01 00 0f 22 c0 8b 7d 0c 8b 45 fc 8b 75 f4 } //05 00 
		$a_01_8 = {74 61 8b 1f 0f 20 c0 25 ff ff fe ff 0f 22 c0 8b 46 1c 6a 0a } //00 00 
	condition:
		any of ($a_*)
