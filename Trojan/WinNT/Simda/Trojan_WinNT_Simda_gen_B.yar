...
rule Trojan_WinNT_Simda_gen_B{
	...
	strings :
		$a_03_0 = {8a 14 01 3a 10 75 90 01 01 47 40 3b fe 72 90 01 01 eb 90 00 } //1
		$a_03_1 = {8d 41 9f 66 83 f8 19 77 90 01 01 81 c1 e0 ff 00 00 eb 90 01 01 0f b7 c9 90 00 } //1
