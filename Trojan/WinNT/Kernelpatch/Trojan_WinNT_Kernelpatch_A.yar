...
rule Trojan_WinNT_Kernelpatch_A{
	...
	strings :
		...
		$a_02_1 = {83 4d fc ff 8b 17 a1 ?? ?? ?? ?? 39 50 08 77 ?? c7 45 e4 0d 00 00 c0 e9 ?? ?? ?? ?? 8b 08 fa 0f 20 c0 25 ff ff fe ff 0f 22 c0 8b 06 89 04 91 0f 20 c0 0d 00 00 01 00 0f 22 c0 fb 83 65 e4 00 } //1
	condition:
