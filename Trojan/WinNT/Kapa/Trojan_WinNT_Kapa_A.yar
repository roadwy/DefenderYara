...
rule Trojan_WinNT_Kapa_A{
	...
	strings :
		...
		$a_01_1 = {4e 00 74 00 51 00 75 00 65 00 72 00 79 00 53 00 79 00 73 00 74 00 65 00 6d 00 49 00 6e 00 66 00 6f 00 72 00 6d 00 61 00 74 00 69 00 6f 00 6e 00 } //00 00  NtQuerySystemInformation
	condition:
		any of ($a_*)
