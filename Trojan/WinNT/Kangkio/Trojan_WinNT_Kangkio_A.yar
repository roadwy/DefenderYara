...
rule Trojan_WinNT_Kangkio_A{
	...
	strings :
		...
		$a_01_1 = {4e 74 51 75 65 72 79 53 79 73 74 65 6d 49 6e 66 6f 72 6d 61 74 69 6f 6e 20 66 61 69 6c 64 21 } //01 00  NtQuerySystemInformation faild!
		$a_01_2 = {4e 65 76 65 72 20 62 65 20 68 65 72 65 20 3f } //00 00  Never be here ?
	condition:
		any of ($a_*)
