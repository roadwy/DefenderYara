...
rule Trojan_WinNT_BitRt_A_MTB{
	...
	strings :
		...
		$a_02_1 = {62 69 74 73 61 64 6d 69 6e 2e 65 78 65 20 2f 74 72 61 6e 73 66 65 72 90 02 10 75 72 6c 90 02 20 73 74 72 90 02 05 66 69 6c 65 6e 61 6d 65 90 00 } //1
