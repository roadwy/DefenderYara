...
rule Trojan_WinNT_BitRt_A_MTB{
	...
	strings :
		$a_00_0 = {70 61 79 6c 6f 61 64 2e 65 78 65 } //01 00  payload.exe
		...
		$a_00_2 = {3a 2f 2f 67 72 6e 74 65 78 70 72 65 73 73 63 6f 75 72 69 65 72 2e 63 6f 6d 2f 46 69 6c 65 2f } //00 00  ://grntexpresscourier.com/File/
