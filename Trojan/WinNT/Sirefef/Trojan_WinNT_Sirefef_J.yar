...
rule Trojan_WinNT_Sirefef_J{
	...
	strings :
		$a_00_0 = {5c 00 64 00 72 00 69 00 76 00 65 00 72 00 5c 00 25 00 49 00 36 00 34 00 75 00 } //01 00 
		$a_00_1 = {5c 00 73 00 79 00 73 00 74 00 65 00 6d 00 72 00 6f 00 6f 00 74 00 5c 00 24 00 4e 00 74 00 55 00 6e 00 69 00 6e 00 73 00 74 00 61 00 6c 00 6c 00 4b 00 42 00 25 00 75 00 24 00 } //01 00 
