...
rule Trojan_WinNT_QHosts_B{
	...
	strings :
		...
		$a_02_1 = {6f 70 65 72 61 2e 65 78 65 00 90 02 10 66 69 72 65 66 6f 78 2e 65 78 65 00 90 00 } //1
		$a_02_2 = {68 6f 73 74 37 00 90 02 08 68 73 74 2e 65 78 65 90 00 } //1
	condition:
