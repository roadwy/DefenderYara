...
rule Trojan_WinNT_Cutwail_C_sys{
	...
	strings :
		...
		$a_02_4 = {63 3a 5c 30 62 75 6c 6b 6e 65 74 5c 62 75 69 6c 64 5f 72 6f 6f 74 5c 72 2d 6c 6f 61 64 65 72 2e 90 01 02 5c 72 6f 6f 74 5c 69 33 38 36 5c 6d 61 69 6e 2e 70 64 62 90 00 } //1
