...
rule Trojan_WinNT_Alureon_F{
	...
	strings :
		...
		$a_02_1 = {0f b7 81 06 02 00 00 81 e9 90 01 01 fe ff ff 81 90 00 } //1
		$a_02_2 = {25 00 f0 ff ff 66 81 38 4d 5a 0f 84 90 01 01 00 00 00 90 00 } //1
		$a_02_3 = {68 a2 b3 45 5e ff 75 90 01 01 e8 90 00 } //1
