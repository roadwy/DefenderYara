...
rule Trojan_WinNT_Alureon{
	...
	strings :
		$a_01_0 = {5c 00 44 00 72 00 69 00 76 00 65 00 72 00 5c 00 42 00 65 00 65 00 70 00 } //01 00 
		$a_01_1 = {73 00 65 00 72 00 76 00 69 00 63 00 65 00 73 00 2e 00 65 00 78 00 65 00 } //01 00 
		$a_01_2 = {46 00 69 00 72 00 65 00 46 00 6f 00 78 00 2e 00 65 00 78 00 65 00 } //0a 00 
