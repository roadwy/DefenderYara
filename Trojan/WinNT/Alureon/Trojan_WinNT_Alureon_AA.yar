...
rule Trojan_WinNT_Alureon_AA{
	...
	strings :
		...
		$a_01_2 = {5b 69 6e 6a 65 63 74 73 5f 65 6e 64 5d } //00 00  [injects_end]
	condition:
		any of ($a_*)
...
rule Trojan_WinNT_Alureon_AA_2{
	...
	strings :
		...
		$a_00_1 = {73 00 79 00 73 00 74 00 65 00 6d 00 73 00 74 00 61 00 72 00 74 00 6f 00 70 00 74 00 69 00 6f 00 6e 00 73 00 } //01 00  systemstartoptions
		$a_00_2 = {25 00 73 00 5c 00 70 00 68 00 2e 00 64 00 6c 00 6c 00 } //00 00  %s\ph.dll
	condition:
		any of ($a_*)
