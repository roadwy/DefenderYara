...
rule Trojan_WinNT_Alureon_AB{
	...
	strings :
		...
		$a_03_2 = {3b 46 18 0f 82 90 01 02 ff ff 83 45 90 01 01 04 ff 4d 90 01 01 0f 85 90 01 02 ff ff ff 4d 90 01 01 0f 85 fb fe ff ff 8b 45 90 01 01 8b 55 08 8b 4d 90 01 01 89 50 18 8b 71 58 89 70 40 8b 71 28 03 f2 5f 89 70 1c 8b 49 08 5e 89 48 44 90 00 } //1
	condition:
