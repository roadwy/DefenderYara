...
rule Trojan_WinNT_EvilRat_A_MTB{
	...
	strings :
		$a_01_0 = {2f 65 76 69 6c 63 6f 64 65 7a 2f 65 76 69 6c 72 61 74 2f 63 6c 69 65 6e 74 2f 42 72 6f 77 73 65 72 53 74 65 61 6c 65 72 } //01 00  /evilcodez/evilrat/client/BrowserStealer
		...
		$a_00_2 = {73 74 65 61 6c 41 6c 6c } //00 00  stealAll
	condition:
		any of ($a_*)
