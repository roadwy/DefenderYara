...
rule Trojan_WinNT_Duqu_D{
	...
	strings :
		...
		$a_03_1 = {66 c7 03 4d 5a 8b 0d 90 01 04 c7 04 19 50 45 00 00 8b 15 90 01 04 83 c4 0c 66 c7 04 1a 0b 01 a1 90 01 04 68 98 00 00 00 03 c3 6a 00 50 89 45 04 e8 90 00 } //1
	condition:
