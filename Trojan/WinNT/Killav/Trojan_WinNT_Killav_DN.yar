...
rule Trojan_WinNT_Killav_DN{
	...
	strings :
		...
		$a_01_5 = {53 65 61 72 63 68 5f 50 73 70 54 65 72 6d 69 6e 61 74 65 54 68 72 65 61 64 42 79 50 6f 69 6e 74 65 72 20 45 72 72 6f 72 } //01 00  Search_PspTerminateThreadByPointer Error
