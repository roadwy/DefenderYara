...
rule Trojan_WinNT_Mooqkel_A{
	...
	strings :
		...
		$a_01_2 = {48 54 54 50 2f 31 2e 31 20 33 30 32 20 46 6f 75 6e 64 } //01 00 
		$a_01_3 = {5c 00 44 00 65 00 76 00 69 00 63 00 65 00 5c 00 4d 00 32 00 54 00 64 00 69 00 } //01 00 
