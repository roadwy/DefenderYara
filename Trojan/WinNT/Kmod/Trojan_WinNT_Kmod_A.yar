...
rule Trojan_WinNT_Kmod_A{
	...
	strings :
		$a_02_0 = {6a 04 6a 04 53 ff 15 ?? ?? ?? ?? 6a 04 6a 04 57 ff 15 ?? ?? ?? ?? c7 45 fc fe ff ff ff 8b 13 a1 ?? ?? ?? ?? 39 50 08 77 ?? c7 45 e4 0d 00 00 c0 83 66 1c 00 8b 45 e4 89 46 18 32 d2 8b ce ff 15 ?? ?? ?? ?? 8b 45 e4 } //1
