...
rule Trojan_WinNT_Lechiket_A{
	...
	strings :
		...
		$a_03_4 = {80 c2 61 88 14 0e 46 83 fe 08 72 e2 c6 04 0e 00 b8 23 34 22 00 8b f9 4f f6 c3 01 74 0f 8a 47 01 47 84 c0 75 f8 be 90 01 04 eb 0d 8a 47 01 47 84 c0 75 f8 be 90 00 } //1
	condition:
