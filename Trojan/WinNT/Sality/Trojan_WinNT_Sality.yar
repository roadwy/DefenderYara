...
rule Trojan_WinNT_Sality{
	...
	strings :
		...
		$a_02_2 = {81 e2 ff ff 00 00 83 fa ?? 74 0d 8b 45 ?? 25 ff ff 00 00 83 f8 ?? 75 07 b8 01 00 00 00 eb ?? c7 45 fc 00 00 00 00 eb 09 8b 4d fc 83 c1 01 89 4d fc 8b 55 fc } //10
