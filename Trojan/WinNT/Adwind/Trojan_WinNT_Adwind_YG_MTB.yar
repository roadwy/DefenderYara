...
rule Trojan_WinNT_Adwind_YG_MTB{
	...
	strings :
		...
		$a_00_1 = {73 61 70 60 77 61 74 60 6a 61 69 75 6c 74 6d 60 65 63 33 } //01 00  sap`wat`jaiultm`ec3
		$a_00_2 = {7e 68 7f 7e 6d 7d 79 69 74 7f 62 7c 65 7f 33 } //01 00 
		$a_00_3 = {54 42 42 54 47 40 53 43 49 40 5f 61 6d 63 6e 43 44 42 } //01 00  TBBTG@SCI@_amcnCDB
