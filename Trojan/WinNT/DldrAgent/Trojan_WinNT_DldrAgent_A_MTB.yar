...
rule Trojan_WinNT_DldrAgent_A_MTB{
	...
	strings :
		...
		$a_00_2 = {4d 69 63 72 6f 73 6f 66 74 5f 53 65 63 75 72 65 5f 44 6f 63 75 6d 65 6e 74 5f 56 69 65 77 65 72 } //01 00  Microsoft_Secure_Document_Viewer
		$a_00_3 = {53 65 63 75 72 65 5f 56 69 65 77 65 72 2e 65 78 65 } //00 00  Secure_Viewer.exe
	condition:
		any of ($a_*)
