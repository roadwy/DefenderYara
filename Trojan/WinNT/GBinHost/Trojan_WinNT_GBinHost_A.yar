...
rule Trojan_WinNT_GBinHost_A{
	...
	strings :
		$a_00_0 = {50 00 72 00 6f 00 67 00 72 00 61 00 6d 00 61 00 73 00 5c 00 47 00 62 00 50 00 6c 00 75 00 67 00 69 00 6e 00 } //02 00 
		$a_00_1 = {00 00 70 00 64 00 69 00 73 00 74 00 00 00 63 00 65 00 66 00 00 00 } //02 00 
		$a_00_2 = {57 00 69 00 6e 00 64 00 6f 00 77 00 73 00 5c 00 73 00 79 00 73 00 74 00 65 00 6d 00 33 00 32 00 5c 00 64 00 72 00 69 00 76 00 65 00 72 00 73 00 } //0a 00 
