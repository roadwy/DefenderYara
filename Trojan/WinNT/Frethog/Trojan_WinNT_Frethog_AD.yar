...
rule Trojan_WinNT_Frethog_AD{
	...
	strings :
		$a_03_0 = {8b 40 04 89 45 90 01 01 81 e9 4b e1 22 00 90 02 07 83 e9 90 01 01 74 0a 90 01 01 bb 00 00 c0 e9 90 00 } //2
		$a_01_1 = {80 4e 06 01 6a 00 56 ff 15 } //1
		$a_03_2 = {83 65 fc 00 6a 04 6a 04 57 ff 15 90 01 02 01 00 6a 04 6a 04 90 01 01 ff 15 90 01 02 01 00 83 4d fc ff 8b 90 00 } //3
		$a_03_3 = {83 e8 05 89 45 90 01 01 6a 05 90 01 01 8d 45 90 09 03 00 e9 90 00 } //3
