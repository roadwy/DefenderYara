...
rule Trojan_WinNT_Fetrog_A{
	...
	strings :
		...
		$a_00_2 = {4e 00 65 00 74 00 5f 00 55 00 31 00 6f 00 63 00 69 00 6b 00 65 00 2e 00 5f 00 32 00 6b 00 } //01 00 
		$a_00_3 = {66 00 33 00 74 00 5f 00 30 00 67 00 2e 00 64 00 61 00 74 00 } //01 00 
		$a_00_4 = {5c 00 44 00 6f 00 73 00 44 00 65 00 76 00 69 00 63 00 65 00 73 00 5c 00 72 00 6d 00 70 00 64 00 6b 00 30 00 67 00 } //00 00 
		$a_00_5 = {80 } //10 00 
	condition:
		any of ($a_*)
