...
rule Trojan_WinNT_Dulom_B{
	...
	strings :
		$a_01_0 = {77 78 70 5f 78 38 36 5c 69 33 38 36 5c 65 6e 74 72 79 2e 70 64 62 } //01 00 
		$a_01_1 = {6e 74 6f 73 6b 72 6e 6c 2e 65 78 65 00 } //01 00 
		$a_01_2 = {47 00 62 00 70 00 4b 00 6d 00 } //01 00 
		$a_01_3 = {47 00 62 00 70 00 53 00 76 00 } //01 00 
