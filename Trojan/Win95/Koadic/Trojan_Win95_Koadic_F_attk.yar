...
rule Trojan_Win95_Koadic_F_attk{
	...
	strings :
		...
		$a_00_1 = {6d 69 6d 69 73 68 69 6d 2e 64 6c 6c } //64 00 
		$a_00_2 = {6d 69 6d 69 73 68 69 6d 2e 78 36 34 2e 64 6c 6c } //e8 03 
		$a_00_3 = {52 65 66 6c 65 63 74 69 76 65 4c 6f 61 64 65 72 40 } //00 00 
	condition:
		any of ($a_*)
