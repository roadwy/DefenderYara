...
rule Trojan_Win95_Koadic_F_attk{
	...
	strings :
		$a_02_0 = {5c 77 69 6e 33 32 5c 6d 69 6d 69 73 68 69 6d 5c 52 65 66 6c 65 63 74 69 76 65 44 4c 4c 49 6e 6a 65 63 74 69 6f 6e 5c 90 02 08 52 65 6c 65 61 73 65 5c 6d 69 6d 69 73 68 69 6d 2e 70 64 62 90 00 } //100
