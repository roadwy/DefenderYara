...
rule Trojan_AndroidOS_Plankton_gen_C{
	...
	strings :
		$a_00_0 = {4c 63 6f 6d 2f 70 6c 61 6e 6b 74 6f 6e 2f 64 65 76 69 63 65 2f 61 6e 64 72 6f 69 64 2f 73 65 72 76 69 63 65 2f 41 6e 64 72 6f 69 64 4d 44 4b 53 65 72 76 69 63 65 3b 00 } //01 00  捌浯瀯慬歮潴⽮敤楶散愯摮潲摩猯牥楶散䄯摮潲摩䑍卋牥楶散;
