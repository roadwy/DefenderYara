...
rule Trojan_AndroidOS_Fakeplayer{
	...
	strings :
		...
		$a_01_2 = {63 61 6e 77 65 } //05 00 
		$a_01_3 = {28 4c 6f 72 67 2f 6d 65 2f 61 6e 64 72 6f 69 64 61 70 70 6c 69 63 61 74 69 6f 6e 31 2f 4d 6f 76 69 65 50 6c 61 79 65 72 3b 00 } //05 00 
		$a_01_4 = {2f 74 65 6c 65 70 68 6f 6e 79 2f 53 6d 73 4d 61 6e 61 67 65 72 3b } //00 00 
	condition:
		any of ($a_*)
