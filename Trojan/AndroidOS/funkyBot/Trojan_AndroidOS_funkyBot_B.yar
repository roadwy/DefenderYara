...
rule Trojan_AndroidOS_funkyBot_B{
	...
	strings :
		$a_01_0 = {69 6e 20 66 69 6e 64 44 65 78 20 73 74 61 72 74 } //01 00 
		$a_00_1 = {63 73 6e 5f } //01 00 
		$a_01_2 = {61 70 70 5f 63 73 6e 30 2f 2e 75 6e 7a 69 70 2f 6f 61 74 } //01 00 
		$a_01_3 = {2e 63 73 6e 2e 64 65 78 } //01 00 
		$a_01_4 = {2e 75 6e 7a 69 70 2f 64 2d 63 6c 61 73 73 65 73 2e 64 65 78 } //01 00 
		$a_01_5 = {63 6f 6d 2f 73 65 63 75 72 69 74 79 2f 73 68 65 6c 6c 2f 4a 4e 49 54 6f 6f 6c 73 } //02 00 
