...
rule Trojan_AndroidOS_SAgnt_X_MTB{
	...
	strings :
		$a_03_0 = {12 01 6e 10 90 01 02 09 00 0c 03 21 34 21 a5 23 56 90 01 02 01 12 01 10 90 00 } //1
...
rule Trojan_AndroidOS_SAgnt_X_MTB_2{
	...
	strings :
		$a_03_0 = {71 00 17 00 00 00 0c 06 07 64 07 46 1a 07 90 01 02 12 08 1f 08 24 00 07 39 12 0a 1f 0a 04 00 12 0b 1f 0b 04 00 74 06 18 00 06 00 0e 00 90 00 } //1
