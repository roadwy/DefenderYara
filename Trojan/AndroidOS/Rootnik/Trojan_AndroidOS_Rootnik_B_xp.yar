...
rule Trojan_AndroidOS_Rootnik_B_xp{
	...
	strings :
		...
		$a_02_7 = {3a 2f 2f 71 64 63 75 30 31 2e 62 61 69 64 75 70 63 73 2e 63 6f 6d 2f 66 69 6c 65 2f 90 02 30 3f 62 6b 74 3d 90 00 } //1
		...
		$a_02_10 = {6d 6f 75 6e 74 20 2d 6f 20 72 65 6d 6f 75 6e 74 2c 72 77 20 2f 73 79 73 74 65 6d 90 02 02 65 63 68 6f 20 72 6f 6f 74 65 64 20 3e 20 2f 73 79 73 74 65 6d 2f 72 6f 6f 74 65 64 90 00 } //1
	condition:
