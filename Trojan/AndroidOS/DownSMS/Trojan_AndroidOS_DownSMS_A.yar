...
rule Trojan_AndroidOS_DownSMS_A{
	...
	strings :
		$a_01_0 = {5b 6d 4d 74 54 73 53 5d 2a } //01 00 
		$a_01_1 = {5b 62 42 65 45 65 45 5d 2a } //01 00 
		$a_01_2 = {44 45 46 31 37 37 33 } //01 00 
		$a_01_3 = {41 63 74 69 76 61 74 6f 72 41 63 74 69 76 69 74 79 } //01 00 
