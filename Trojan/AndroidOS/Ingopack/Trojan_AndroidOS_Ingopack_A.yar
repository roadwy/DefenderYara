...
rule Trojan_AndroidOS_Ingopack_A{
	...
	strings :
		...
		$a_02_2 = {12 02 08 00 16 00 71 20 65 00 20 00 0c 01 1a 04 ?? ?? ?? ?? ?? ?? ?? ?? 0c 03 1a 04 ?? ?? ?? ?? ?? ?? 04 00 0c 05 1a 04 ?? ?? 71 10 ?? ?? 04 00 0c 06 1a 04 ?? ?? 71 10 ?? ?? 04 00 0c 07 12 12 23 28 ?? 01 12 02 1c 09 ?? 01 4d 09 08 02 6e 20 ?? ?? 83 00 0c 0a 12 12 23 2b } //2
	condition:
