...
rule Trojan_AndroidOS_VolterSms_A{
	...
	strings :
		$a_01_0 = {41 6c 74 65 72 53 4d 53 41 63 74 69 76 69 74 79 2e 6a 61 76 61 } //01 00 
		$a_01_1 = {2f 61 70 69 2f 67 65 74 5f 6f 73 73 2f } //01 00 
		$a_01_2 = {53 4d 53 5f 44 45 4c 49 56 45 52 45 44 } //01 00 
