...
rule Trojan_AndroidOS_Dialer_C_MTB{
	...
	strings :
		$a_03_0 = {54 20 07 00 1a 01 72 00 6e 20 90 01 02 10 00 54 20 07 00 1a 01 bc 00 71 10 90 01 02 01 00 0c 01 6e 20 90 01 02 10 00 54 20 07 00 6e 20 90 01 02 02 00 90 00 } //1
