...
rule Trojan_AndroidOS_BrowBot_B_MTB{
	...
	strings :
		...
		$a_03_2 = {64 61 74 61 5f 90 01 02 2f 69 6e 73 74 61 6c 6c 5f 90 01 02 2e 70 68 70 90 00 } //1
		$a_03_3 = {53 6d 73 52 65 63 65 69 76 65 72 5f 90 01 02 00 90 00 } //1
		$a_03_4 = {63 68 65 63 6b 65 72 5f 90 01 02 2e 70 68 70 90 00 } //1
	condition:
