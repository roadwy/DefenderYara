...
rule Trojan_AndroidOS_FakeLogoSms_A{
	...
	strings :
		...
		$a_01_1 = {70 75 73 68 6d 65 2f 61 6e 64 72 6f 69 64 2f 50 75 73 68 6d 65 } //01 00 
		$a_01_2 = {61 70 70 5f 6e 61 6d 65 5f 73 6b 61 79 70 65 } //01 00 
		$a_01_3 = {50 75 73 68 6d 65 2e 6a 61 76 61 } //01 00 
		$a_01_4 = {72 75 6c 65 73 2e 68 74 6d } //00 00 
	condition:
		any of ($a_*)
