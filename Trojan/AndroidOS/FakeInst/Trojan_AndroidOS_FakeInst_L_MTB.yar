...
rule Trojan_AndroidOS_FakeInst_L_MTB{
	...
	strings :
		$a_03_0 = {63 6f 6d 2f 63 61 69 61 70 70 2f 73 6b 79 70 65 90 02 20 4d 61 69 6e 41 63 74 69 76 69 74 79 90 00 } //1
		$a_03_1 = {63 6f 6d 2f 6d 6f 62 69 61 64 73 2f 69 6e 73 74 61 6c 6c 65 72 2f 90 02 20 4d 61 69 6e 41 63 74 69 76 69 74 79 90 00 } //1
		...
		$a_03_3 = {68 74 74 70 3a 2f 2f 90 01 01 2e 74 61 69 67 61 6d 65 6d 6f 62 69 6c 65 68 61 79 2e 6e 65 74 90 02 10 2f 6d 6f 2d 6b 68 2e 6a 73 70 3f 61 70 70 3d 90 00 } //1
