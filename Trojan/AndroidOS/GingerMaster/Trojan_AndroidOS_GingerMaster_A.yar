...
rule Trojan_AndroidOS_GingerMaster_A{
	...
	strings :
		...
		$a_03_2 = {63 6c 69 65 6e 74 2e 90 03 09 0a 67 6f 33 36 30 64 61 79 73 6d 75 73 74 6d 6f 62 69 6c 65 2e 63 6f 6d 2f 63 6c 69 65 6e 74 2e 70 68 70 3f 61 63 74 69 6f 6e 3d 73 6f 66 74 26 73 6f 66 74 5f 69 64 3d 90 00 } //1
