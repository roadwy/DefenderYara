...
rule Trojan_AndroidOS_SmsHider_B{
	...
	strings :
		...
		$a_01_1 = {68 69 64 65 72 2e 41 70 70 49 6e 73 74 61 6c 6c } //01 00  hider.AppInstall
		$a_01_2 = {6e 65 74 77 6f 72 6b 20 69 73 20 6e 6f 74 20 77 6f 72 6b 21 } //00 00  network is not work!
	condition:
		any of ($a_*)
