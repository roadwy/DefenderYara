...
rule Trojan_AndroidOS_CallPay_A_MTB{
	...
	strings :
		$a_03_0 = {61 70 70 73 2f 90 02 13 2f 64 61 74 61 2f 67 65 6f 69 70 2e 70 68 70 90 00 } //1
		$a_03_1 = {61 70 70 73 2f 90 02 13 2f 64 61 74 61 2f 67 65 74 46 69 6e 67 65 72 70 72 69 6e 74 49 6e 66 6f 2e 70 68 70 90 00 } //1
