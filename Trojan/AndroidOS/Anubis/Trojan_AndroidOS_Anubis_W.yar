...
rule Trojan_AndroidOS_Anubis_W{
	...
	strings :
		...
		$a_02_1 = {12 08 e0 09 0b 10 b6 a9 4b 09 07 08 12 18 e0 09 0d 10 b6 c9 4b 09 07 08 44 90 02 04 07 90 02 04 dc 07 02 04 e0 07 07 03 b9 90 02 04 8d 90 02 04 48 07 90 02 04 03 b7 90 02 04 8d 90 02 04 8d 90 02 04 4f 90 02 04 03 90 00 } //1
	condition:
