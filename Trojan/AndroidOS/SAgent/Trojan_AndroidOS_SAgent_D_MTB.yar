...
rule Trojan_AndroidOS_SAgent_D_MTB{
	...
	strings :
		$a_00_0 = {61 70 70 5f 64 62 3d 61 70 6b 73 5f 64 61 74 61 } //01 00  app_db=apks_data
		$a_00_1 = {73 69 78 74 69 78 2e 63 68 61 69 6e 65 72 2e 72 61 64 69 6f } //02 00  sixtix.chainer.radio
