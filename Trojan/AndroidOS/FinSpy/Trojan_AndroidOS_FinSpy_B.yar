...
rule Trojan_AndroidOS_FinSpy_B{
	...
	strings :
		$a_00_0 = {2f 65 76 65 6e 74 62 61 73 65 64 2f 52 65 63 65 69 76 65 72 53 65 72 76 69 63 65 } //01 00 
		$a_00_1 = {4c 6f 72 67 2f 78 6d 6c 70 75 73 68 2f 76 33 2f 45 76 65 6e 74 42 61 73 65 64 53 65 72 76 69 63 65 } //01 00 
