...
rule Trojan_AndroidOS_Iconosys_A_MTB{
	...
	strings :
		$a_00_0 = {62 6c 61 63 6b 66 6c 79 64 61 79 2e 63 6f 6d 2f 6e 65 77 } //01 00  blackflyday.com/new
		$a_00_1 = {4d 65 49 6e 4a 61 69 6c } //01 00  MeInJail
		...
		$a_00_4 = {62 75 7a 7a 67 65 6f 64 61 74 61 2e 70 68 70 } //00 00  buzzgeodata.php
