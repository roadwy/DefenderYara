...
rule Trojan_AndroidOS_Triada_C_MTB{
	...
	strings :
		$a_03_0 = {12 01 21 73 6e 10 ?? ?? 08 00 0a 04 01 10 01 12 35 32 14 00 34 40 03 00 01 10 48 05 07 02 6e 20 ?? ?? 08 00 0a 06 b7 65 8d 55 4f 05 07 02 d8 02 02 01 d8 00 00 01 28 ed 11 07 } //2
