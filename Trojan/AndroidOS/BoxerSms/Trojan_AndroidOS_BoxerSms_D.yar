...
rule Trojan_AndroidOS_BoxerSms_D{
	...
	strings :
		...
		$a_03_5 = {73 6d 73 51 75 61 6e 74 69 74 79 90 02 05 73 6d 73 54 65 78 74 90 02 05 73 6d 73 5f 74 65 78 74 90 02 05 73 74 61 72 74 90 02 05 73 74 61 72 74 41 63 74 69 76 69 74 79 90 00 } //1
	condition:
