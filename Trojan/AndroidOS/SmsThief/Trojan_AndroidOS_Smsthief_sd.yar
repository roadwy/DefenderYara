...
rule Trojan_AndroidOS_Smsthief_sd{
	...
	strings :
		...
		$a_01_1 = {6d 65 73 73 61 66 67 65 } //01 00  messafge
		$a_01_2 = {73 75 63 63 65 73 73 66 75 6c 6c 79 20 72 65 67 69 73 74 65 72 65 64 } //00 00  successfully registered
	condition:
		any of ($a_*)
