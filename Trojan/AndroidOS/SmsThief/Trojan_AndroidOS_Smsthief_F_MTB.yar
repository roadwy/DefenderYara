...
rule Trojan_AndroidOS_Smsthief_F_MTB{
	...
	strings :
		...
		$a_01_1 = {6c 6f 6b 65 74 32 2d 66 61 73 74 70 61 79 2e 6f 6e 6c 69 6e 65 } //01 00  loket2-fastpay.online
		$a_01_2 = {63 6f 6d 2f 65 78 61 6d 70 6c 65 2f 6d 79 61 70 70 6c 69 63 61 74 69 6f 6e } //01 00  com/example/myapplication
		$a_01_3 = {53 65 6e 64 53 4d 53 } //01 00  SendSMS
		$a_01_4 = {52 65 63 65 69 76 65 53 6d 73 } //00 00  ReceiveSms
	condition:
		any of ($a_*)
