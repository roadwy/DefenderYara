...
rule Trojan_AndroidOS_FakeApp_H_MTB{
	...
	strings :
		$a_02_0 = {66 6c 69 78 6f 6e 6c 69 6e 65 90 02 01 2f 63 68 65 63 6b 53 65 72 76 65 72 41 6e 64 45 78 65 63 75 74 65 3b 90 00 } //1
		$a_02_1 = {66 6c 69 78 6f 6e 6c 69 6e 65 90 02 01 2f 54 68 65 4a 6f 62 43 68 72 6f 6d 69 75 6d 3b 90 00 } //1
