...
rule Trojan_AndroidOS_FakeApp_H_MTB{
	...
	strings :
		...
		$a_00_2 = {67 65 74 20 64 61 74 61 20 66 72 6f 6d 20 73 65 72 76 65 72 } //01 00 
		$a_00_3 = {62 72 6f 77 73 65 72 5f 75 72 6c } //01 00 
		$a_00_4 = {63 6f 6d 2e 61 6e 64 72 6f 69 64 2e 63 68 72 6f 6d 65 2f 63 6f 6d 2e 61 6e 64 72 6f 69 64 2e 63 68 72 6f 6d 65 2e 4d 61 69 6e } //01 00 
		$a_00_5 = {63 6f 6d 2e 77 68 61 74 73 61 70 70 } //00 00 
