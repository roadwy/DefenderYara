...
rule Trojan_AndroidOS_SmsSilence_B{
	...
	strings :
		$a_03_0 = {66 72 38 38 39 2e 63 6f 6d 2f 41 6e 64 72 6f 69 64 5f 53 4d 53 2f 90 03 0a 09 69 6e 73 74 61 6c 6c 69 6e 67 72 65 63 65 69 76 69 6e 67 2e 70 68 70 00 90 00 } //1
