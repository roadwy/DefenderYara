...
rule Trojan_AndroidOS_SmsSilence_A{
	...
	strings :
		...
		$a_03_2 = {69 74 37 39 38 30 2e 63 6f 6d 2f 41 6e 64 72 6f 69 64 5f 53 4d 53 2f 90 03 06 07 72 65 63 65 69 76 69 6e 73 74 61 6c 6c 69 6e 67 2e 70 68 70 90 00 } //1
