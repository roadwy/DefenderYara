...
rule Trojan_AndroidOS_Piom_TS_MTB{
	...
	strings :
		...
		$a_03_1 = {74 65 73 74 64 61 74 61 31 31 32 2e 6f 72 67 66 72 65 65 2e 63 6f 6d 2f 90 02 10 2e 70 68 70 90 00 } //1
		$a_03_2 = {4c 69 6e 2f 90 02 10 2f 72 65 77 61 72 64 73 2f 41 75 74 6f 53 74 61 72 74 53 65 72 76 69 63 65 90 00 } //1
		...
		$a_03_10 = {64 61 74 61 73 6d 73 61 6c 6c 75 73 65 72 2e 69 6e 2f 90 02 10 2e 70 68 70 90 00 } //1
	condition:
