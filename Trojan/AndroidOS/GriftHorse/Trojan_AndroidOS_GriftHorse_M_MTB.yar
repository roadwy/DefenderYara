...
rule Trojan_AndroidOS_GriftHorse_M_MTB{
	...
	strings :
		$a_03_0 = {4c 63 6f 6d 2f [0-20] 4d 61 69 6e 41 63 74 69 76 69 74 79 } //1
		$a_03_1 = {70 73 3a 2f 2f 64 [0-17] 2e 63 6c 6f 75 64 66 72 6f 6e 74 2e 6e 65 74 2f 63 6f 6d 2e [0-35] 2e 68 74 6d 6c } //2
