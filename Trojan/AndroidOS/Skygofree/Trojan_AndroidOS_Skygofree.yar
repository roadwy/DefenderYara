...
rule Trojan_AndroidOS_Skygofree{
	...
	strings :
		...
		$a_03_3 = {f0 b5 2d 4a 2d 4f 8b b0 7a 44 01 92 03 aa 7f 44 11 1c 70 cf 70 c1 3b 68 90 01 01 24 0b 60 90 01 01 28 48 d0 90 01 01 24 90 01 01 60 60 02 09 90 01 01 09 a9 08 aa 00 20 0a f0 90 01 02 0a f0 90 01 02 04 1c 42 1c 02 d0 00 28 06 d0 16 e0 90 00 } //1
	condition:
