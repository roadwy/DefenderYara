...
rule Trojan_AndroidOS_Skygofree{
	...
	strings :
		...
		$a_00_1 = {2f 73 79 73 74 65 6d 2f 62 69 6e 2f 73 68 20 2d 63 } //01 00  /system/bin/sh -c
		$a_00_2 = {63 68 6d 6f 64 20 2d 52 20 37 37 37 20 2f 64 61 74 61 2f 64 61 74 61 2f 63 6f 6d 2e 77 68 61 74 73 61 70 70 } //01 00  chmod -R 777 /data/data/com.whatsapp
