...
rule Trojan_MacOS_Padzer_A_MTB{
	...
	strings :
		...
		$a_00_2 = {69 66 20 70 67 72 65 70 20 22 41 63 74 69 76 69 74 79 20 4d 6f 6e 69 74 6f 72 22 20 3e 20 2f 64 65 76 2f 6e 75 6c 6c 3b 74 68 65 6e 20 6b 69 6c 6c 61 6c 6c } //01 00 
		$a_00_3 = {2f 41 70 70 6c 69 63 61 74 69 6f 6e 73 2f 46 69 6e 61 6c 5c 20 43 75 74 5c 20 50 72 6f 2e 61 70 70 2f 43 6f 6e 74 65 6e 74 73 2f 4d 61 63 4f 53 2f 2e 46 69 6e 61 6c 5c 20 43 75 74 5c 20 50 72 6f } //00 00 
