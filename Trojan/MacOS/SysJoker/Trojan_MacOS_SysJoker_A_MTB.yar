...
rule Trojan_MacOS_SysJoker_A_MTB{
	...
	strings :
		$a_03_0 = {74 74 70 73 3a 2f 2f 90 02 18 2f 75 63 3f 65 78 70 6f 72 74 3d 64 6f 77 6e 6c 6f 61 64 26 69 64 3d 31 57 36 34 50 51 51 78 72 77 59 33 58 6a 42 6e 76 5f 51 41 65 42 51 75 2d 65 50 72 35 33 37 65 75 90 00 } //1
