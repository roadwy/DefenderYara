...
rule Trojan_MacOS_Shlayer_B{
	...
	strings :
		...
		$a_02_2 = {0f b6 0c 01 48 8b 55 90 01 01 2a 4c 02 90 01 01 88 4d ff 0f b6 4d ff 48 8b 55 f0 88 4c 15 ea 48 ff 45 90 01 01 48 8b 4d 90 01 01 48 83 f9 90 01 01 76 d3 90 00 } //2
	condition:
