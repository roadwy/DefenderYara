...
rule Trojan_MacOS_Dropper_A{
	...
	strings :
		$a_00_0 = {47 6f 6c 64 65 6e 20 42 6f 6f 6b 31 } //01 00 
		$a_00_1 = {48 35 59 4c 35 36 36 38 43 37 31 } //02 00 
		...
		$a_00_4 = {70 67 72 65 70 20 2d 66 20 73 61 66 61 72 69 66 6f 6e 74 73 61 67 65 6e 74 } //00 00 
