...
rule Trojan_MacOS_Pwnet_D_MTB{
	...
	strings :
		...
		$a_02_2 = {8a 85 c7 fe ff ff 34 ff 24 01 0f b6 c8 48 63 d1 48 83 fa 00 0f 84 90 01 04 48 8d 3d ab 11 00 00 48 8d 35 b0 11 00 00 48 8d 0d 16 12 00 00 90 00 } //1
	condition:
...
rule Trojan_MacOS_Pwnet_D_MTB_2{
	...
	strings :
		...
		$a_02_4 = {2f 6f 73 78 69 6e 6a 2e 62 75 69 6c 64 2f 90 02 07 2f 6f 73 78 69 6e 6a 2e 62 75 69 6c 64 90 00 } //1
		$a_02_5 = {2f 67 6f 73 78 69 6e 6a 2e 62 75 69 6c 64 2f 90 02 07 2f 67 6f 73 78 69 6e 6a 2e 62 75 69 6c 64 90 00 } //1
