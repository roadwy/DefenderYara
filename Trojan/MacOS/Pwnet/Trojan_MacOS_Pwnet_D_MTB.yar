...
rule Trojan_MacOS_Pwnet_D_MTB{
	...
	strings :
		$a_00_0 = {49 6e 6a 65 63 74 65 64 } //01 00 
		$a_00_1 = {2f 44 6f 77 6e 6c 6f 61 64 73 2f 47 4f 2d 53 58 2d 49 6e 74 65 72 6e 61 6c 2d 4c 69 74 65 2d 6d 61 73 74 65 72 2f 6f 73 78 69 6e 6a 2f 6d 61 63 68 5f 69 6e 6a 65 63 74 } //01 00 
...
rule Trojan_MacOS_Pwnet_D_MTB_2{
	...
	strings :
		$a_00_0 = {6f 73 78 69 6e 6a 2f 6d 61 63 68 5f 69 6e 6a 65 63 74 2e 63 } //01 00 
		$a_00_1 = {2e 2f 6f 73 78 69 6e 6a 20 5b 70 72 6f 63 5f 6e 61 6d 65 5d 20 5b 6c 69 62 5d } //01 00 
		$a_00_2 = {2e 2f 6f 73 78 69 6e 6a 20 5b 70 69 64 5d 20 5b 6c 69 62 5d } //01 00 
		$a_00_3 = {69 6e 6a 65 63 74 6f 72 2e 63 70 70 } //01 00 
		...
		$a_00_6 = {70 6c 65 61 73 65 20 72 75 6e 20 6d 65 20 61 73 20 72 6f 6f 74 } //00 00 
	condition:
		any of ($a_*)
