...
rule Trojan_MacOS_UpdateAgent_A_MTB{
	...
	strings :
		$a_03_0 = {48 89 e5 48 83 ec 20 89 7d fc 48 89 75 f0 8b 7d fc e8 ?? ?? ?? 00 83 f8 00 0f ?? ?? ?? ?? 00 48 ?? ?? ?? ?? 00 00 48 63 4d fc 8b 54 88 3c 89 d0 48 23 45 f0 48 83 f8 00 40 0f 95 c6 40 80 f6 ff 40 80 f6 ff 40 88 75 ef } //2
