...
rule Trojan_MacOS_SpyAgent_B{
	...
	strings :
		...
		$a_00_1 = {6c 61 75 6e 63 68 63 74 6c 20 73 74 6f 70 20 63 6f 6d 2e 61 70 70 6c 65 2e 74 63 63 64 } //01 00 
		$a_00_2 = {63 73 72 75 74 69 6c 20 73 74 61 74 75 73 20 7c 20 67 72 65 70 20 64 69 73 61 62 6c 65 64 } //00 00 
	condition:
		any of ($a_*)
