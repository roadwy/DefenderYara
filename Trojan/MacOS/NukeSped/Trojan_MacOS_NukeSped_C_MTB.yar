...
rule Trojan_MacOS_NukeSped_C_MTB{
	...
	strings :
		...
		$a_02_5 = {48 8d 55 a8 e8 ?? ?? ?? ?? 83 f8 01 0f 85 9b 00 00 00 48 8b 7d a8 48 8d 35 41 0f 00 00 ba 03 00 00 00 e8 ?? ?? ?? ?? 48 85 c0 0f 84 a4 00 00 00 48 89 c6 b8 f5 ff ff ff 83 fb 02 0f 85 ec 00 00 00 4c 8d 75 a0 ba 04 00 00 00 b9 01 00 00 00 48 89 f7 4c 89 f6 e8 ?? ?? ?? ?? 4d 8b 06 41 8b 40 10 } //1
		$a_02_6 = {be ff 01 00 00 48 89 df e8 ?? ?? ?? ?? e8 ?? ?? ?? ?? 83 38 02 75 da 81 3b cf fa ed fe 75 d2 49 89 1e 31 c0 48 83 c4 08 5b 41 5c 41 5d 41 5e 41 5f 5d c3 } //1
	condition:
