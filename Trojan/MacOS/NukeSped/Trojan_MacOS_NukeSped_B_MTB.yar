...
rule Trojan_MacOS_NukeSped_B_MTB{
	...
	strings :
		$a_00_0 = {63 72 61 62 62 65 64 6c 79 2e 63 6c 75 62 2f 62 6f 61 72 64 2e 70 68 70 } //01 00  crabbedly.club/board.php
		$a_00_1 = {63 72 61 79 70 6f 74 2e 6c 69 76 65 2f 62 6f 61 72 64 2e 70 68 70 } //01 00  craypot.live/board.php
		$a_00_2 = {69 6e 64 61 67 61 74 6f 72 2e 63 6c 75 62 2f 62 6f 61 72 64 2e 70 68 70 } //01 00  indagator.club/board.php
