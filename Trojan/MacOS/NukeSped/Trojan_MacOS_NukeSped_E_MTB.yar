...
rule Trojan_MacOS_NukeSped_E_MTB{
	...
	strings :
		...
		$a_00_2 = {71 6e 61 6c 79 74 69 63 61 2e 63 6f 6d 2f 77 70 2d 72 73 73 2e 70 68 70 } //01 00 
		$a_00_3 = {42 61 72 62 65 71 75 65 3a 3a 7e 42 61 72 62 65 71 75 65 28 29 } //01 00 
		$a_00_4 = {63 75 72 6c 5f 65 61 73 79 5f 67 65 74 69 6e 66 6f } //00 00 
