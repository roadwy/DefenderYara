...
rule Trojan_MacOS_PassSteal_AB{
	...
	strings :
		$a_02_0 = {6f 73 61 73 63 72 69 70 74 20 2d 65 20 27 64 69 73 70 6c 61 79 20 64 69 61 6c 6f 67 90 02 a0 50 6c 65 61 73 65 20 65 6e 74 65 72 20 79 6f 75 72 20 70 61 73 73 77 6f 72 64 90 00 } //2
		...
		$a_02_2 = {2f 4c 69 62 72 61 72 79 2f 41 70 70 6c 69 63 61 74 69 6f 6e 20 53 75 70 70 6f 72 74 2f 46 69 72 65 66 6f 78 2f 50 72 6f 66 69 6c 65 73 2f 90 02 a0 63 6f 6f 6b 69 65 73 2e 73 71 6c 69 74 65 90 00 } //1
