...
rule Trojan_MacOS_PassSteal_A{
	...
	strings :
		...
		$a_03_1 = {66 69 6e 64 2d 67 65 6e 65 72 69 63 2d 70 61 73 73 77 6f 72 64 66 61 69 6c 65 64 20 74 6f 20 65 78 65 63 75 74 65 20 70 72 6f 63 65 73 73 73 72 63 2f 62 72 6f 77 73 65 72 73 2f 90 02 10 2f 6d 6f 64 75 6c 65 73 2f 6b 65 79 5f 73 74 65 61 6c 90 00 } //1
