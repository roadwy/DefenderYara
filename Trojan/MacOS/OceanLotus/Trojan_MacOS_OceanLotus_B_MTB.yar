...
rule Trojan_MacOS_OceanLotus_B_MTB{
	...
	strings :
		...
		$a_02_1 = {88 84 15 d0 fe ff ff 40 88 c7 40 00 ff 40 30 c7 88 c3 c0 fb 90 01 01 80 e3 90 01 01 0f b6 c0 88 94 05 d0 fd ff ff 40 30 fb 48 ff c2 81 fa 00 90 01 03 88 d8 75 ce 90 00 } //2
