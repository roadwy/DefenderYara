...
rule Trojan_MacOS_Niqtana_B_xp{
	...
	strings :
		$a_00_0 = {5f 73 77 69 74 63 68 65 72 6f 6f } //01 00  _switcheroo
		$a_00_1 = {53 77 69 74 63 68 69 6e 67 20 61 72 63 68 20 74 79 70 65 73 20 74 6f 20 65 78 65 63 75 74 65 20 6f 75 72 20 70 61 72 61 73 69 74 65 } //01 00  Switching arch types to execute our parasite
