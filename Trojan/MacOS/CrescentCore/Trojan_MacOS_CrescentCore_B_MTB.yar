...
rule Trojan_MacOS_CrescentCore_B_MTB{
	...
	strings :
		$a_00_0 = {63 6f 6d 2e 6c 69 67 68 74 73 2e 4f 62 6c 69 76 69 6f 6e } //01 00 
		$a_00_1 = {35 55 41 37 48 57 34 38 59 37 31 } //01 00 
		...
		$a_00_4 = {44 6f 77 6e 6c 6f 61 64 4f 66 66 65 72 4f 62 6a 65 63 74 } //02 00 
