...
rule Trojan_MacOS_Gimmick_A{
	...
	strings :
		$a_00_0 = {44 2f 75 2f 25 40 00 2e 25 40 2e 25 40 00 62 61 73 65 5f 6a 73 6f 6e 00 64 6f 77 6e 5f 6a 73 6f 6e 00 75 70 6c 6f 61 64 5f 6a 73 6f 6e 00 74 65 72 6d 69 6e 5f 6a 73 6f 6e 00 72 65 71 75 65 73 74 5f 6a 73 6f 6e 00 6f 6e 6c 69 6e 65 5f 6a 73 } //01 00  ⽄⽵䀥⸀䀥┮@慢敳機潳n潤湷機潳n灵潬摡機潳n整浲湩機潳n敲畱獥彴獪湯漀汮湩彥獪
