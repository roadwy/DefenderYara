...
rule Trojan_MacOS_Nukespd_B_MTB{
	meta:
		description = "Trojan:MacOS/Nukespd.B!MTB,SIGNATURE_TYPE_MACHOHSTR_EXT,06 00 06 00 02 00 00 02 00 "
		
	strings :
		$a_00_0 = {73 63 68 65 2d 65 67 2e 6f 72 67 2f 70 6c 75 67 69 6e 73 2f 74 6f 70 2e 70 68 70 } //04 00  sche-eg.org/plugins/top.php
