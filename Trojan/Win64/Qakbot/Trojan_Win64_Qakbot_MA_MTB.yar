...
rule Trojan_Win64_Qakbot_MA_MTB{
	...
	strings :
		$a_01_0 = {64 6c 6c 6d 61 69 6e 36 34 2e 64 6c 6c } //02 00 
		$a_01_1 = {63 75 72 6c 20 68 74 74 70 3a 2f 2f 31 30 39 2e 31 37 32 2e 34 35 2e 39 2f 4c 65 71 2f } //02 00 
