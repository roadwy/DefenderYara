...
rule Trojan_Win64_Meterpreter_A__2{
	...
	strings :
		...
		$a_03_1 = {81 f9 5d 68 fa 3c 0f 85 90 01 01 00 00 00 90 00 } //1
		$a_01_2 = {b8 0a 4c 53 75 } //1
		$a_03_3 = {8e 4e 0e ec 74 90 02 05 aa fc 0d 7c 74 90 02 05 54 ca af 91 74 90 02 05 1b c6 46 79 90 02 05 f2 32 f6 0e 75 90 00 } //1
		$a_03_4 = {8b 5f 28 45 33 c0 33 d2 48 83 c9 ff 90 01 01 03 90 01 01 ff 94 24 88 00 00 00 45 33 c0 90 01 01 8b 90 01 01 41 8d 90 01 02 ff d3 48 8b c3 90 00 } //1
		$a_03_5 = {3c 33 c9 41 b8 00 30 00 00 90 01 01 03 90 01 01 44 8d 49 90 02 10 ff d6 90 00 } //2
		$a_03_6 = {3c 45 8b cb 33 c9 90 01 01 03 90 01 01 41 b8 00 30 00 00 90 02 10 ff d6 90 00 } //2
	condition:
