...
rule Trojan_Win64_ClipBanker_H_MTB{
	...
	strings :
		...
		$a_01_7 = {6e 6f 74 68 69 6e 67 62 63 31 } //2 nothingbc1
		$a_01_8 = {62 6e 62 61 64 64 72 31 54 74 64 65 66 61 75 6c 74 5f 76 61 6c 75 65 5f 63 6c 69 70 70 65 72 5d } //2 bnbaddr1Ttdefault_value_clipper]
	condition:
