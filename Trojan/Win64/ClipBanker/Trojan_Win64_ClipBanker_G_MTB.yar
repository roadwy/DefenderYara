...
rule Trojan_Win64_ClipBanker_G_MTB{
	...
	strings :
		...
		$a_01_7 = {6e 6f 74 68 69 6e 67 62 63 31 42 54 43 } //02 00 
		$a_01_8 = {42 54 43 44 4f 47 45 45 54 43 4c 54 43 58 4d 52 44 41 53 48 52 49 50 50 4c 45 62 6e 62 42 4e 42 61 64 64 72 31 41 44 41 54 54 52 58 74 5a 43 41 53 48 64 65 66 61 75 6c 74 5f 76 61 6c 75 65 5f 63 6c 69 70 70 65 72 5d } //00 00 
	condition:
		any of ($a_*)
