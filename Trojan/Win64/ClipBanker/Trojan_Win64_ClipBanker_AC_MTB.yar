...
rule Trojan_Win64_ClipBanker_AC_MTB{
	...
	strings :
		$a_03_0 = {8b c1 89 05 90 01 04 eb 90 01 01 8b 44 24 90 01 01 99 83 e2 03 03 c2 83 e0 03 2b c2 8b 0d 90 01 04 03 c8 8b c1 89 44 24 90 01 01 8b 44 24 90 01 01 8b 0d 90 01 04 0b c8 8b c1 89 05 90 01 04 33 d2 8b 44 24 90 01 01 b9 03 00 00 00 f7 f1 8b 0d 90 01 04 03 c8 8b c1 89 44 24 90 01 01 0f be 05 90 01 04 85 c0 75 90 00 } //1
