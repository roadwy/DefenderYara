...
rule Trojan_Win64_ClipBanker_L_MTB{
	...
	strings :
		...
		$a_01_1 = {5c 62 28 30 78 5b 61 2d 66 41 2d 46 30 2d 39 5d 7b 34 30 7d 29 } //02 00 
		$a_01_2 = {5c 62 28 28 5b 31 33 5d 7c 62 63 31 29 5b 41 2d 48 4a 2d 4e 50 2d 5a 61 2d 6b 6d 2d 7a 31 2d 39 5d 7b 32 37 2c 33 34 7d 29 } //00 00 
	condition:
		any of ($a_*)
