...
rule Trojan_Win64_DiskWriter_SP_MTB{
	...
	strings :
		$a_03_0 = {48 89 54 24 30 48 8d 0d 90 01 04 89 54 24 28 45 33 c9 ba 00 00 00 10 c7 44 24 20 03 00 00 00 45 8d 41 03 ff 15 90 01 04 4c 8d 4c 24 40 48 c7 44 24 20 00 00 00 00 48 8b c8 48 8d 54 24 50 41 b8 00 02 00 00 90 00 } //5
