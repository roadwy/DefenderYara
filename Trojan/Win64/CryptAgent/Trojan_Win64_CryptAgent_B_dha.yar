...
rule Trojan_Win64_CryptAgent_B_dha{
	meta:
		description = "Trojan:Win64/CryptAgent.B!dha,SIGNATURE_TYPE_PEHSTR_EXT,03 00 03 00 03 00 00 01 00 "
	...
	strings :
		...
		$a_01_1 = {80 74 05 80 cc 48 ff c0 48 83 f8 42 7c f2 } //01 00 
		$a_01_2 = {80 74 04 50 aa 48 ff c0 48 83 f8 27 7c f2 } //00 00 
	condition:
		any of ($a_*)
