...
rule Trojan_Win64_Miancha_CAF_MTB{
	...
	strings :
		...
		$a_01_1 = {63 6d 64 73 68 65 6c 6c } //01 00  cmdshell
		$a_01_2 = {63 6d 64 73 68 65 6c 6c 5f 64 65 69 6e 69 74 } //01 00  cmdshell_deinit
		$a_01_3 = {63 6d 64 73 68 65 6c 6c 5f 69 6e 69 74 } //00 00  cmdshell_init
	condition:
		any of ($a_*)
