...
rule Trojan_Win64_Alureon_K{
	...
	strings :
		$a_01_0 = {5b 6b 69 74 36 34 5f 68 61 73 68 5f 65 6e 64 5d } //01 00  [kit64_hash_end]
		$a_01_1 = {5b 63 6d 64 5f 64 6c 6c 36 34 5f 68 61 73 68 5f 65 6e 64 5d } //01 00  [cmd_dll64_hash_end]
