...
rule Trojan_Win64_Apolmy_C{
	...
	strings :
		$a_03_0 = {48 b9 0b 00 00 00 01 00 00 00 48 8b 44 24 90 01 01 48 89 01 48 b8 25 00 00 00 01 00 00 00 c6 00 04 90 00 } //2
		$a_03_1 = {48 b8 0b 00 00 00 01 00 00 00 48 8b 4c 24 90 01 01 48 89 08 48 b8 25 00 00 00 01 00 00 00 c6 00 04 90 00 } //2
