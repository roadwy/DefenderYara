...
rule Trojan_Win64_Lazy_RS_MTB{
	...
	strings :
		$a_03_0 = {41 8b c4 41 f7 e0 41 8b c0 2b c2 d1 e8 03 c2 c1 e8 05 0f be c0 6b c8 90 01 01 41 8a c0 2a c1 41 02 c7 41 30 01 44 03 c7 4c 03 cf 41 83 f8 90 01 01 7c d1 90 00 } //1
