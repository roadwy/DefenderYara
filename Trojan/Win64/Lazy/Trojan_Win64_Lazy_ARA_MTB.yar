...
rule Trojan_Win64_Lazy_ARA_MTB{
	...
	strings :
		$a_03_0 = {89 c3 80 e3 90 01 01 80 cb 90 01 01 24 90 01 01 30 d8 34 90 01 01 88 05 90 00 } //2
		$a_03_1 = {89 c2 80 e2 90 01 01 80 ca 90 01 01 24 90 01 01 30 d0 34 90 01 01 88 05 90 00 } //2
