...
rule Trojan_Win64_Lazy_SPRP_MTB{
	...
	strings :
		...
		$a_03_1 = {49 8d 4e 30 45 33 c0 ba a0 0f 00 00 e8 ?? ?? ?? ?? 48 8b 05 ?? ?? ?? ?? 4c 8d 05 ?? ?? ?? ?? 48 8b d5 48 c1 fa 06 4c 89 34 03 48 8b c5 83 e0 3f 48 8d 0c c0 49 8b 04 d0 48 8b 4c c8 28 48 83 c1 02 48 83 f9 02 77 06 } //3
	condition:
