...
rule Trojan_Win64_Emotet_MD_MTB_2{
	...
	strings :
		...
		$a_03_4 = {41 f7 e0 41 8b c0 41 83 c0 01 2b c2 d1 e8 03 c2 c1 e8 05 48 6b c0 90 01 01 48 2b c8 0f b6 04 19 90 01 01 32 44 90 01 01 ff 90 01 01 3b 90 01 01 41 88 41 ff 72 90 00 } //10
		$a_03_5 = {f7 e6 48 63 c6 83 c6 01 c1 ea 03 48 8d 0c d2 48 8d 15 90 01 04 48 c1 e1 02 48 2b d1 0f b6 0c 02 41 32 4c 2d ff 41 3b f6 88 4d ff 0f 82 90 00 } //10
