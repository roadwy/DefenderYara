...
rule Trojan_Win64_Emotet_PAI_MTB{
	...
	strings :
		$a_03_0 = {99 44 8b 45 90 01 01 41 f7 f8 4c 63 ca 42 0f b6 14 09 44 8b 55 90 01 01 41 31 d2 45 88 d3 48 8b 8d 90 01 04 4c 63 8d 90 01 04 46 88 1c 09 8b 85 90 01 04 83 c0 01 89 85 90 01 04 e9 90 00 } //1
...
rule Trojan_Win64_Emotet_PAI_MTB_2{
	...
	strings :
		$a_03_0 = {b8 43 08 21 84 8b cb 48 8d 7f 01 f7 eb 03 d3 ff c3 c1 fa 05 8b c2 c1 e8 1f 03 d0 6b c2 3e 2b c8 48 8b 05 90 01 04 48 63 d1 0f b6 0c 02 32 4c 3e ff 88 4f ff 49 ff cf 75 b9 48 8d 0d 42 8e 02 90 00 } //1
