...
rule Trojan_Win64_Emotet_EK_MTB_3{
	...
	strings :
		$a_01_0 = {48 8d 04 40 49 0f af c3 48 03 d0 49 8d 46 02 48 03 c7 48 0f af c6 48 8d 04 40 48 2b d0 48 8b 44 24 28 49 03 d5 49 ff c5 44 88 0c 02 } //5
	condition:
		((#a_01_0  & 1)*5) >=5
...
rule Trojan_Win64_Emotet_EK_MTB_4{
	...
	strings :
		$a_01_0 = {41 f7 f8 4c 63 ca 4c 8b 55 b0 43 0f b6 14 0a 31 d1 41 88 cb 4c 8b 8d e8 0b 00 00 8b 4d 24 03 4d 28 2b 4d 28 48 63 f1 45 88 1c 31 8b 45 24 83 c0 01 89 45 24 } //5
	condition:
		((#a_01_0  & 1)*5) >=5
