...
rule Trojan_Win64_Emotet_BR_MTB{
	...
	strings :
		$a_01_0 = {48 ff c2 41 ff c0 0f b6 0c 08 41 32 4c 11 ff 88 4a ff 48 ff cb } //5
	condition:
		((#a_01_0  & 1)*5) >=5
...
rule Trojan_Win64_Emotet_BR_MTB_2{
	...
	strings :
		$a_03_0 = {c1 e8 1f 03 d0 8b c3 ff c3 6b d2 90 01 01 2b c2 48 63 c8 42 8a 04 09 43 32 04 02 41 88 00 49 ff c0 49 ff cb 74 90 00 } //2
	condition:
		((#a_03_0  & 1)*2) >=2
