...
rule Trojan_Win64_Emotet_PBG_MTB{
	...
	strings :
		$a_03_0 = {f7 e6 8b c6 8b ce 2b c2 ff c6 d1 ?? 03 c2 c1 e8 ?? 6b c0 ?? 2b c8 48 63 c1 42 0f b6 04 10 43 32 44 07 ?? 41 88 40 ?? 41 3b f4 72 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_Win64_Emotet_PBG_MTB_2{
	...
	strings :
		$a_03_0 = {48 03 c1 48 63 0d ?? ?? ?? ?? 48 03 c1 48 63 0d ?? ?? ?? ?? 48 03 4c 24 ?? 0f b6 04 01 03 44 24 ?? 8b 4c 24 ?? 33 c8 8b c1 8b 0d ?? ?? ?? ?? 8b 14 24 2b d1 8b ca } //1
