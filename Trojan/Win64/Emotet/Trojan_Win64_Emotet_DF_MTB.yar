...
rule Trojan_Win64_Emotet_DF_MTB{
	...
	strings :
		$a_03_0 = {f7 eb 8b cb 03 d3 ff c3 c1 fa 90 01 01 8b c2 c1 e8 90 01 01 03 d0 6b c2 90 01 01 2b c8 48 63 c1 42 0f b6 0c 00 43 32 4c 0a 90 01 01 41 88 49 90 01 01 48 83 ef 01 74 90 00 } //1
