...
rule Trojan_Win64_Emotet_MF_MTB{
	...
	strings :
		$a_03_0 = {41 f7 e8 c1 fa 02 8b c2 c1 e8 1f 03 d0 41 8b c0 41 ff c0 8d 0c 52 c1 e1 03 2b c1 48 63 c8 48 8d 05 ?? ?? ?? ?? 8a 04 01 42 32 04 0f 41 88 01 49 ff c1 44 3b c6 72 } //10
		...
		$a_03_2 = {4c 8b c8 48 2b f8 41 8b c0 41 83 c0 01 99 83 e2 1f 03 c2 83 e0 1f 2b c2 48 63 c8 48 8d 05 ?? ?? ?? ?? 8a 04 01 42 32 04 0f 41 88 01 49 83 c1 01 44 3b c6 72 } //10
