...
rule Trojan_Win64_Emotet_EM_MTB{
	meta:
		description = "Trojan:Win64/Emotet.EM!MTB,SIGNATURE_TYPE_PEHSTR_EXT,05 00 05 00 01 00 00 05 00 "
		
	strings :
		$a_01_0 = {89 c8 f7 ea d1 fa 89 c8 c1 f8 1f 89 d3 29 c3 89 d8 6b c0 37 89 ce 29 c6 89 f0 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win64_Emotet_EM_MTB_2{
	...
	strings :
		$a_01_0 = {41 29 d1 4d 63 c9 42 0f b6 04 08 32 04 0b 41 88 04 08 48 83 c1 01 4c 39 d9 75 c2 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win64_Emotet_EM_MTB_3{
	...
	strings :
		$a_03_0 = {f7 e1 c1 ea 04 89 55 90 01 01 81 45 90 01 05 81 75 90 01 05 c7 45 90 01 05 c1 65 90 01 02 81 75 90 00 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win64_Emotet_EM_MTB_4{
	meta:
		description = "Trojan:Win64/Emotet.EM!MTB,SIGNATURE_TYPE_PEHSTR_EXT,07 00 07 00 01 00 00 07 00 "
		
	strings :
		$a_01_0 = {8b c7 8b cf 2b c2 ff c7 d1 e8 03 c2 c1 e8 05 6b c0 3f 2b c8 48 63 c1 42 0f b6 04 20 41 32 44 2e ff 41 88 46 ff } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win64_Emotet_EM_MTB_5{
	...
	strings :
		$a_01_0 = {44 32 44 0c 20 49 2b d2 4a 8d 0c 5d fe ff ff ff 49 0f af d1 49 2b d2 49 03 d3 48 0f af c1 48 03 c7 48 ff c7 48 8d 0c 50 46 88 04 31 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win64_Emotet_EM_MTB_6{
	...
	strings :
		$a_01_0 = {89 45 b4 44 89 c0 89 55 b0 99 44 8b 45 b4 41 f7 f8 4c 63 ca 42 0f b6 14 09 44 8b 55 b0 41 31 d2 45 88 d3 48 8b 8d d0 0b 00 00 8b 55 18 2b 55 1c 03 55 1c 4c 63 ca 46 88 1c 09 } //00 00 
	condition:
		any of ($a_*)
