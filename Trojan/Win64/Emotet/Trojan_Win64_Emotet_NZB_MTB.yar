...
rule Trojan_Win64_Emotet_NZB_MTB{
	...
	strings :
		$a_03_0 = {2b c2 48 63 c8 48 63 05 ?? ?? ?? ?? 0f b6 14 39 48 63 0d ?? ?? ?? ?? 32 14 2b 49 0f af c9 49 2b c8 48 83 e9 02 48 0f af c8 48 63 05 ?? ?? ?? ?? 48 2b c8 49 2b c8 49 03 c9 48 8d 04 4b 48 ff c3 42 88 14 18 44 3b d6 72 95 } //1
