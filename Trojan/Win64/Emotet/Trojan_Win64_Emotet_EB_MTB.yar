...
rule Trojan_Win64_Emotet_EB_MTB_4{
	...
	strings :
		$a_01_0 = {4d 54 53 63 72 61 74 63 68 70 61 64 52 54 53 74 79 6c 75 73 2e 64 6c 6c } //01 00 
		...
		$a_01_4 = {52 74 6c 4c 6f 6f 6b 75 70 46 75 6e 63 74 69 6f 6e 45 6e 74 72 79 } //00 00 
	condition:
		any of ($a_*)
