...
rule Trojan_Win64_Emotet_AM_MTB_2{
	...
	strings :
		$a_03_0 = {03 d0 8b c3 ff c3 6b d2 ?? 2b c2 48 63 c8 42 8a 04 19 43 32 04 01 41 88 00 49 ff c0 48 83 ef 01 74 09 } //3
	condition:
		((#a_03_0  & 1)*3) >=3
...
rule Trojan_Win64_Emotet_AM_MTB_3{
	...
	strings :
		$a_03_0 = {8b 84 24 f0 0b 00 00 99 b9 ?? 00 00 00 f7 f9 8b c2 48 98 48 8b 0d ?? ?? ?? ?? 0f b6 04 01 8b 8c 24 fc 0b 00 00 33 c8 8b c1 } //6
	condition:
		((#a_03_0  & 1)*6) >=6
