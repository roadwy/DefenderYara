...
rule Trojan_Win64_Emotet_EN_MTB_3{
	...
	strings :
		$a_01_0 = {56 69 72 74 75 61 6c 41 6c 6c 6f 63 } //01 00 
		$a_01_1 = {43 72 65 61 74 65 4d 75 74 65 78 41 } //01 00 
		$a_01_2 = {57 61 69 74 46 6f 72 53 69 6e 67 6c 65 4f 62 6a 65 63 74 } //02 00 
		$a_01_3 = {6b 4c 31 5a 37 66 34 58 53 57 5a 70 62 69 49 4f 64 7a 61 4e 77 6d 56 6b } //02 00 
		$a_01_4 = {4d 6e 46 33 6a 70 45 70 4d 58 4e 79 73 51 68 62 74 78 61 62 50 53 4a 56 6a 66 35 6c 36 5a 36 58 63 65 43 72 32 6b 4b 74 71 49 64 6c } //00 00 
	condition:
		any of ($a_*)
