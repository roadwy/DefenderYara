...
rule Trojan_Win64_DllInject_MA_MTB{
	...
	strings :
		$a_03_0 = {48 33 c0 48 ff c0 c3 74 24 10 57 48 83 ec 20 49 8b f8 8b da 48 8b f1 83 fa 01 75 05 e8 90 01 04 4c 8b c7 8b d3 48 8b ce 48 8b 5c 24 30 48 8b 74 24 38 48 83 c4 20 5f e9 a7 fe ff ff 90 00 } //5
