...
rule Trojan_Win64_Icedidcrypt_GK_MTB{
	...
	strings :
		$a_02_0 = {88 0a 8a 0f 89 45 00 89 45 04 48 ff c2 48 89 55 90 01 01 8a 0f 89 45 00 89 45 04 8a 0f 89 45 00 89 45 04 eb 90 00 } //10
		$a_02_1 = {41 ff c0 48 8b 4d 90 01 01 44 3b 01 8a 0f 89 45 00 89 45 04 73 90 01 01 48 ff c3 48 89 5d 90 01 01 8b 0d 90 01 04 44 8b 1d 90 01 04 44 89 d3 e9 90 00 } //10
