...
rule Trojan_Win64_CrypInject_AFX_MTB{
	...
	strings :
		$a_02_0 = {8b 44 24 44 3b 84 24 90 01 04 7d 2b 8b 84 24 90 01 04 48 8b 4c 24 90 01 01 33 01 89 01 48 8b 44 24 90 01 01 48 83 c0 04 48 89 44 24 78 8b 44 24 44 83 c0 01 89 44 24 44 eb c8 90 00 } //10
