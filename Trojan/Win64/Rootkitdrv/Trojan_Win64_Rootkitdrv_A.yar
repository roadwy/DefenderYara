...
rule Trojan_Win64_Rootkitdrv_A{
	...
	strings :
		$a_03_0 = {44 46 75 6e 63 00 00 00 45 78 70 6f 72 74 46 75 6e 63 00 90 02 8a 68 65 61 64 4c 69 62 00 90 00 } //1
		...
		$a_00_5 = {49 3b f7 74 1d 81 3e 52 53 44 53 75 15 48 83 c9 ff 33 c0 48 8d 7e 18 f2 ae 48 f7 d1 48 2b cb 4c 8b f1 48 8b 4d 18 45 8b e7 e8 90 00 } //1
		$a_02_6 = {c7 44 24 28 80 00 00 00 c7 44 24 20 03 00 00 00 ff 15 90 01 04 48 8b f8 48 85 c0 74 21 4c 8d 4c 24 48 4c 8d 44 24 40 48 8d 54 24 50 48 8b c8 ff 15 90 00 } //1
	condition:
