...
rule Trojan_Win64_ShellRunner_JL_MTB{
	...
	strings :
		$a_01_0 = {73 68 65 6c 6c 63 6f 64 65 2e 64 6c 6c } //01 00 
		$a_01_1 = {46 61 69 6c 65 64 20 74 6f 20 6c 6f 61 64 20 73 68 65 6c 6c 63 6f 64 65 2e 64 6c 6c } //01 00 
		$a_01_2 = {52 75 6e 54 68 61 74 53 68 69 74 } //01 00 
