...
rule Trojan_Win64_IcedID_rrdh_MTB{
	...
	strings :
		...
		$a_01_1 = {42 74 74 66 6a 73 69 72 7a 7a 53 68 6e 62 77 61 79 61 67 } //01 00  BttfjsirzzShnbwayag
		$a_01_2 = {44 78 68 63 68 64 62 6c 76 4f 76 75 45 77 74 75 67 6e 74 62 75 } //00 00  DxhchdblvOvuEwtugntbu
	condition:
		any of ($a_*)
