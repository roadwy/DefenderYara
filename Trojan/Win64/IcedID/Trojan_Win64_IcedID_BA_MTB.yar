...
rule Trojan_Win64_IcedID_BA_MTB_2{
	...
	strings :
		$a_03_0 = {48 8b c1 0f b7 4c 24 90 01 01 3a d2 74 90 01 01 66 89 44 24 90 01 01 48 90 01 07 66 3b c9 74 90 01 01 33 c8 8b c1 66 3b c9 74 90 00 } //1
		$a_03_1 = {8b c0 3a ff 74 90 01 01 8b 44 24 90 01 01 f7 b4 24 90 01 04 66 3b c9 74 90 01 01 89 84 24 90 01 04 33 d2 66 3b f6 74 90 00 } //1
	condition:
