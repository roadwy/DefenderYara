...
rule Trojan_Win64_IcedID_MD_MTB_2{
	...
	strings :
		...
		$a_01_1 = {41 6b 71 45 57 2e 64 6c 6c } //01 00 
		$a_01_2 = {4a 72 69 61 41 44 76 50 37 64 4c } //01 00 
		$a_01_3 = {5a 47 6e 55 32 42 71 42 67 70 70 } //01 00 
		$a_01_4 = {68 4f 6e 34 32 65 62 62 33 } //01 00 
		$a_01_5 = {73 30 4a 72 70 79 64 54 61 71 70 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win64_IcedID_MD_MTB_3{
	...
	strings :
		...
		$a_01_1 = {68 69 61 75 73 66 62 75 73 6a 61 66 6b 68 79 61 73 6a 66 6b } //00 00 
	condition:
		any of ($a_*)
