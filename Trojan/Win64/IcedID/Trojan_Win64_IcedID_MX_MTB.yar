...
rule Trojan_Win64_IcedID_MX_MTB_2{
	...
	strings :
		...
		$a_01_1 = {44 74 35 72 65 2e 64 6c 6c } //01 00  Dt5re.dll
		$a_01_2 = {4d 51 6a 50 64 73 57 57 } //01 00  MQjPdsWW
		$a_01_3 = {50 64 73 31 35 56 38 52 6e 44 } //01 00  Pds15V8RnD
		$a_01_4 = {55 6e 43 58 35 62 36 51 } //01 00  UnCX5b6Q
		$a_01_5 = {58 4e 30 6e 4c 6e 36 } //00 00  XN0nLn6
	condition:
		any of ($a_*)
...
rule Trojan_Win64_IcedID_MX_MTB_3{
	...
	strings :
		...
		$a_01_1 = {54 6a 64 62 68 61 73 62 73 } //00 00  Tjdbhasbs
	condition:
		any of ($a_*)
