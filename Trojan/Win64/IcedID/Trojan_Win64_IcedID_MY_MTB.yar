...
rule Trojan_Win64_IcedID_MY_MTB_2{
	...
	strings :
		...
		$a_01_1 = {47 62 68 61 6a 61 73 64 61 73 } //00 00  Gbhajasdas
	condition:
		any of ($a_*)
...
rule Trojan_Win64_IcedID_MY_MTB_3{
	...
	strings :
		...
		$a_01_1 = {52 65 67 4f 70 65 6e 4b 65 79 54 72 61 6e 73 61 63 74 65 64 57 } //01 00  RegOpenKeyTransactedW
		$a_01_2 = {4c 6f 63 6b 52 65 73 6f 75 72 63 65 } //01 00  LockResource
		$a_01_3 = {46 69 6e 64 46 69 72 73 74 46 69 6c 65 57 } //01 00  FindFirstFileW
		$a_01_4 = {49 73 50 72 6f 63 65 73 73 6f 72 46 65 61 74 75 72 65 50 72 65 73 65 6e 74 } //01 00  IsProcessorFeaturePresent
		$a_01_5 = {50 6f 73 74 4d 65 73 73 61 67 65 57 } //01 00  PostMessageW
