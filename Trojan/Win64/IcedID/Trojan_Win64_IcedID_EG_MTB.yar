...
rule Trojan_Win64_IcedID_EG_MTB_2{
	...
	strings :
		$a_03_0 = {89 c8 f7 ea c1 fa 90 01 01 89 c8 c1 f8 90 01 01 29 c2 89 d0 c1 e0 90 01 01 01 d0 c1 e0 90 01 01 29 c1 89 ca 48 63 d2 48 8b 85 90 01 04 48 01 d0 0f b6 00 44 31 c8 41 88 00 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
