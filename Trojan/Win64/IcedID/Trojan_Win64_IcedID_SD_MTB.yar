...
rule Trojan_Win64_IcedID_SD_MTB{
	...
	strings :
		$a_01_0 = {8b 44 24 7c 41 b9 04 00 00 00 41 b8 00 30 00 00 8b d0 33 c9 ff 94 24 } //01 00 
		$a_03_1 = {48 8b c1 0f b6 44 04 90 01 01 8b 8c 24 90 01 04 33 c8 8b c1 48 63 4c 24 90 01 01 48 8b 54 24 90 01 01 88 04 0a e9 90 00 } //00 00 
	condition:
		any of ($a_*)
