...
rule Trojan_Win64_IcedID_GZK_MTB{
	...
	strings :
		$a_02_0 = {49 8b c6 4d 8d 40 90 01 01 48 f7 e1 41 ff c1 48 c1 ea 90 01 01 48 6b c2 90 01 01 48 2b c8 0f b6 44 8c 90 01 01 41 30 40 90 01 01 49 63 c9 48 81 f9 90 01 04 72 d3 90 00 } //10
