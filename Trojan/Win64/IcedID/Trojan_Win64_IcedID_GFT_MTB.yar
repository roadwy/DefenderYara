...
rule Trojan_Win64_IcedID_GFT_MTB{
	...
	strings :
		$a_02_0 = {48 8b 44 24 70 0f bf 00 0f bf 4c 24 44 03 c1 48 8b 4c 24 70 66 89 01 48 8b 44 24 70 0f bf 00 0f bf 0d ?? ?? ?? ?? 33 c1 66 89 44 24 44 0f b6 44 24 40 d1 f8 88 44 24 40 48 8b 44 24 70 0f bf 00 0f bf 0d ?? ?? ?? ?? 0b c1 66 89 44 24 44 0f be 44 24 43 d1 e0 88 44 24 43 } //10
