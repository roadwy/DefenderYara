...
rule Trojan_Win64_IcedID_ME_MTB{
	...
	strings :
		...
		$a_01_1 = {44 6c 6c 4d 61 69 6e } //00 00  DllMain
	condition:
		any of ($a_*)
...
rule Trojan_Win64_IcedID_ME_MTB_3{
	...
	strings :
		...
		$a_81_1 = {63 73 62 75 71 79 61 73 6e } //03 00  csbuqyasn
		$a_81_2 = {63 77 6c 76 71 70 71 70 69 63 64 64 66 70 } //03 00  cwlvqpqpicddfp
		$a_81_3 = {64 7a 78 76 65 72 76 65 64 67 79 } //00 00  dzxvervedgy
	condition:
		any of ($a_*)
...
rule Trojan_Win64_IcedID_ME_MTB_4{
	...
	strings :
		...
		$a_01_2 = {79 67 73 66 61 62 61 79 75 73 66 6a 6e 61 73 66 6b 61 } //00 00  ygsfabayusfjnasfka
	condition:
		any of ($a_*)
