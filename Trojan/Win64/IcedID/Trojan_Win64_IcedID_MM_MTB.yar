...
rule Trojan_Win64_IcedID_MM_MTB{
	meta:
		description = "Trojan:Win64/IcedID.MM!MTB,SIGNATURE_TYPE_PEHSTR_EXT,05 00 05 00 01 00 00 05 00 "
		
	strings :
		$a_01_0 = {48 89 04 24 48 8b 44 24 08 eb 3b 48 8b 44 24 40 48 ff c8 eb 61 48 8b 04 24 48 8b 4c 24 08 eb 00 8a 09 88 08 eb 00 48 8b 04 24 48 ff c0 eb } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win64_IcedID_MM_MTB_2{
	meta:
		description = "Trojan:Win64/IcedID.MM!MTB,SIGNATURE_TYPE_PEHSTR_EXT,01 00 01 00 01 00 00 01 00 "
		
	strings :
		$a_03_0 = {99 c1 ea 1c 01 d0 83 e0 90 01 01 29 d0 48 98 4c 01 c8 0f b6 00 44 31 c0 88 01 83 85 6c 0b 00 00 90 01 01 8b 85 6c 0b 00 00 3b 85 54 0b 00 00 7c 90 00 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win64_IcedID_MM_MTB_3{
	...
	strings :
		$a_03_0 = {41 f7 ea 89 c8 c1 f8 90 01 01 c1 fa 04 29 c2 89 c8 0f af d5 29 d0 48 63 d0 41 0f b6 14 10 41 32 14 0b 41 88 14 09 48 83 c1 01 48 81 f9 90 01 04 75 90 00 } //00 00 
	condition:
		any of ($a_*)
