...
rule Trojan_Win64_IcedID_YD_MTB{
	...
	strings :
		$a_03_0 = {02 02 43 32 04 31 41 90 01 03 49 90 01 02 8b 02 d3 c8 ff c0 89 02 83 e0 90 01 01 0f b6 c8 41 90 01 02 d3 c8 ff c0 41 90 01 02 48 90 01 04 4c 90 01 04 73 90 00 } //1
