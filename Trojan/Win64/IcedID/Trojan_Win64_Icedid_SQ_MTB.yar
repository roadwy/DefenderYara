...
rule Trojan_Win64_Icedid_SQ_MTB_2{
	...
	strings :
		...
		$a_01_1 = {63 3a 5c 50 72 6f 67 72 61 6d 44 61 74 61 5c } //05 00 
		$a_01_2 = {73 61 64 6c 5f 36 34 2e 64 6c 6c } //05 00 
		$a_01_3 = {44 6c 6c 52 65 67 69 73 74 65 72 53 65 72 76 65 72 } //01 00 
		$a_01_4 = {56 69 72 74 75 61 6c 50 72 6f 74 65 63 74 } //01 00 
		$a_01_5 = {43 72 65 61 74 65 54 68 72 65 61 64 } //01 00 
		$a_01_6 = {53 48 47 65 74 46 6f 6c 64 65 72 50 61 74 68 41 } //00 00 
	condition:
		any of ($a_*)
