...
rule Trojan_Win64_IcedID_MAX_MTB{
	...
	strings :
		$a_03_0 = {48 89 84 24 80 00 00 00 48 8b 84 24 80 00 00 00 e9 ?? ?? ?? ?? 33 c0 e9 ?? ?? ?? ?? 8b 84 24 94 00 00 00 e9 ?? ?? ?? ?? 48 8b 8c 24 48 01 00 00 48 3b c8 74 ?? eb ?? 48 8b 84 24 30 01 00 00 48 89 84 24 58 01 00 00 e9 ?? ?? ?? ?? 41 8a 04 00 88 04 0a e9 } //5
