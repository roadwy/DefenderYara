...
rule Trojan_Win64_IcedID_AW_MTB_2{
	...
	strings :
		...
		$a_81_1 = {73 61 64 6c 5f 36 34 2e 64 6c 6c } //03 00 
		$a_81_2 = {47 65 74 4d 6f 64 75 6c 65 48 61 6e 64 6c 65 41 } //03 00 
		$a_81_3 = {53 48 47 65 74 46 6f 6c 64 65 72 50 61 74 68 41 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win64_IcedID_AW_MTB_3{
	...
	strings :
		$a_01_0 = {41 47 69 65 57 72 51 36 6c 72 } //03 00 
		$a_01_1 = {41 6f 72 6c 4d 32 35 6c 75 } //03 00 
		$a_01_2 = {41 79 50 59 4f 37 6c } //03 00 
		$a_01_3 = {43 6f 47 65 74 53 74 64 4d 61 72 73 68 61 6c 45 78 } //03 00 
		$a_01_4 = {43 6f 49 6d 70 65 72 73 6f 6e 61 74 65 43 6c 69 65 6e 74 } //03 00 
		$a_01_5 = {50 72 6f 70 56 61 72 69 61 6e 74 43 6f 70 79 } //00 00 
	condition:
		any of ($a_*)
