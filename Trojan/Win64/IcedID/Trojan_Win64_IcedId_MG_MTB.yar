...
rule Trojan_Win64_IcedId_MG_MTB_2{
	...
	strings :
		...
		$a_01_1 = {41 4b 6f 73 75 47 55 70 } //01 00 
		$a_01_2 = {41 5a 6c 52 64 55 59 62 56 4c 6e } //01 00 
		$a_01_3 = {54 74 2e 64 6c 6c } //01 00 
		$a_01_4 = {42 41 79 58 66 63 44 6d 63 4b } //01 00 
		$a_01_5 = {43 66 4f 61 77 67 6f 6f 75 4a 66 } //00 00 
	condition:
		any of ($a_*)
