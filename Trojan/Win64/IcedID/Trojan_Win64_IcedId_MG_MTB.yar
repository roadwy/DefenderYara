...
rule Trojan_Win64_IcedId_MG_MTB{
	...
	strings :
		$a_03_0 = {44 0f af 0d 90 01 04 44 03 c0 48 8b 05 90 01 04 49 83 c3 04 44 89 05 90 01 04 41 8b d1 c1 ea 10 88 14 01 41 8b d1 8b 05 90 01 04 03 c6 c1 ea 08 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
