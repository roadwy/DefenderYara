...
rule Trojan_Win64_IcedID_MAZ_MTB_2{
	...
	strings :
		...
		$a_01_1 = {42 58 65 53 6b 49 34 64 35 75 } //01 00 
		$a_01_2 = {45 46 65 73 6e 78 75 56 } //01 00 
		$a_01_3 = {48 37 47 70 30 42 30 34 } //01 00 
		$a_01_4 = {4b 36 66 76 63 67 52 4c 4d 5a } //01 00 
		$a_01_5 = {55 39 6d 55 35 46 72 56 42 65 } //00 00 
	condition:
		any of ($a_*)
