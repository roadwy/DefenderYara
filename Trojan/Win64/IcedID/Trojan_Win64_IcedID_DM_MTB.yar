...
rule Trojan_Win64_IcedID_DM_MTB{
	...
	strings :
		...
		$a_01_1 = {65 78 67 44 58 2e 64 6c 6c } //01 00 
		$a_01_2 = {43 6f 46 69 6c 65 54 69 6d 65 54 6f 44 6f 73 44 61 74 65 54 69 6d 65 } //01 00 
		$a_01_3 = {47 65 74 50 6f 6c 79 46 69 6c 6c 4d 6f 64 65 } //01 00 
		$a_01_4 = {43 72 65 61 74 65 50 61 6c 65 74 74 65 } //00 00 
	condition:
		any of ($a_*)
