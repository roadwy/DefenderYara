...
rule Trojan_Win64_IcedID_MI_MTB{
	...
	strings :
		$a_03_0 = {4d 63 c2 4d 8d 5b 01 48 8b c7 41 ff c2 49 f7 e0 48 c1 ea 90 01 01 48 6b ca 90 01 01 4c 2b c1 42 0f b6 44 84 20 41 30 43 ff 41 81 fa 90 01 04 72 d2 90 00 } //5
	condition:
		((#a_03_0  & 1)*5) >=5
...
rule Trojan_Win64_IcedID_MI_MTB_2{
	...
	strings :
		$a_03_0 = {48 8b 44 24 20 48 89 04 24 66 3b ed 74 90 01 01 88 08 48 8b 04 24 3a db 74 90 01 01 48 ff c0 48 89 04 24 66 3b d2 74 90 00 } //5
