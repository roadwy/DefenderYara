...
rule Trojan_Win64_IcedID_EA_MTB_4{
	...
	strings :
		$a_01_0 = {68 62 6b 73 61 6a 6e 61 68 62 73 66 6a 61 6b 73 66 6e 68 62 61 6b 73 66 } //0a 00 
		$a_01_1 = {75 72 68 6a 62 74 6e 65 6b 73 75 62 61 73 68 64 61 6a 6b 73 64 61 73 } //01 00 
...
rule Trojan_Win64_IcedID_EA_MTB_5{
	...
	strings :
		$a_01_0 = {79 69 62 68 61 73 6e 64 75 79 62 61 73 6f 64 6d 6a 6e 75 68 79 61 73 64 6a 61 73 61 } //05 00 
		$a_01_1 = {75 61 73 69 66 62 79 75 67 61 73 68 66 6a 61 6b 73 68 62 61 73 73 } //01 00 
...
rule Trojan_Win64_IcedID_EA_MTB_6{
	...
	strings :
		$a_01_0 = {79 61 75 73 67 62 66 61 74 73 64 75 68 61 73 64 61 6a 64 68 61 79 73 75 64 6a 61 73 } //05 00 
		$a_01_1 = {61 6a 69 6f 73 64 75 61 68 79 67 73 64 61 68 69 69 73 6b 61 73 } //05 00 
		$a_01_2 = {75 61 73 69 66 62 79 75 67 61 73 68 66 6a 61 6b 73 68 62 61 73 73 } //01 00 
		$a_01_3 = {57 61 69 74 46 6f 72 53 69 6e 67 6c 65 4f 62 6a 65 63 74 } //01 00 
		$a_01_4 = {43 72 65 61 74 65 45 76 65 6e 74 57 } //01 00 
