...
rule Trojan_Win64_IcedID_EA_MTB_2{
	...
	strings :
		$a_03_0 = {44 89 4c 24 20 4c 89 44 24 18 eb 90 01 01 80 44 24 90 01 02 c6 44 24 90 01 02 eb 90 01 01 80 44 24 90 01 02 c6 44 24 90 01 02 eb 90 01 01 80 44 24 90 01 02 c6 44 24 90 01 02 eb 90 00 } //4
	condition:
		((#a_03_0  & 1)*4) >=4
