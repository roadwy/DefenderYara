...
rule Trojan_Win64_Strilix_C_dha{
	...
	strings :
		...
		$a_01_1 = {63 3a 5c 77 69 6e 64 6f 77 73 5c 73 79 73 74 65 6d 33 32 5c 70 72 69 6e 74 68 65 6c 70 2e 64 61 74 } //02 00 
		$a_01_2 = {63 3a 5c 77 69 6e 64 6f 77 73 5c 61 70 70 68 65 6c 70 2e 64 6c 6c } //00 00 
	condition:
		any of ($a_*)
