...
rule Trojan_Win64_Coroxy_MB_MTB{
	...
	strings :
		$a_03_0 = {48 89 85 e0 fe ff ff 48 8b bd e0 fe ff ff 48 c7 07 00 01 00 00 48 83 ec 20 48 c7 c1 02 00 00 00 48 8d 57 52 4c 8b c7 ff 15 90 01 04 48 83 c4 20 48 83 7d 10 00 0f 85 90 00 } //5
