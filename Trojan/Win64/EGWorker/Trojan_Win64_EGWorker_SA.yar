...
rule Trojan_Win64_EGWorker_SA{
	...
	strings :
		...
		$a_80_1 = {70 61 79 6c 6f 6f 70 } //payloop  1
		$a_80_2 = {72 44 4f 6d 48 5a 73 37 75 5a 69 52 37 67 50 78 31 72 36 6f 53 51 75 45 57 55 6c 5a 54 4c 32 33 } //rDOmHZs7uZiR7gPx1r6oSQuEWUlZTL23  1
	condition:
