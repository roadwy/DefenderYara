...
rule Trojan_Win64_Bumblebee_PB_MTB{
	...
	strings :
		$a_03_0 = {41 8b 0c 80 41 31 0c 90 90 41 8b 90 02 04 00 00 23 90 01 01 7d 90 00 } //4
		$a_03_1 = {41 8b 0c 80 41 31 0c 90 90 41 8b 8e 90 02 04 00 00 41 23 ce 7d 90 00 } //4
