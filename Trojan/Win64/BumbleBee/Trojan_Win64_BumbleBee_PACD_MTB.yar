...
rule Trojan_Win64_BumbleBee_PACD_MTB{
	...
	strings :
		...
		$a_01_1 = {43 67 4b 36 32 } //01 00 
		$a_01_2 = {4c 76 71 4b 4d 6e 36 39 38 } //01 00 
		$a_01_3 = {4f 44 49 56 4e 31 41 64 34 } //01 00 
		$a_01_4 = {54 6e 63 67 48 43 38 37 36 58 59 33 } //01 00 
		$a_01_5 = {55 51 72 41 41 61 37 31 35 53 70 38 } //01 00 
