...
rule Trojan_Win64_BumbleBee_PACD_MTB{
	...
	strings :
		$a_03_0 = {43 8a 0c 0c 2a 8c 24 90 01 04 32 8c 24 90 01 04 49 8b 42 90 01 01 41 88 0c 01 83 fe 90 01 01 0f 84 90 01 04 49 8b 52 90 01 01 8b ce b8 90 01 04 44 8b ee d2 e0 fe c8 41 8a 0c 11 49 8b 92 90 01 04 22 c8 88 4c 24 90 01 01 48 8b c5 90 00 } //6
