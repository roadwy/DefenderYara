...
rule Trojan_Win64_Bumblebee_JD_MTB{
	...
	strings :
		$a_03_0 = {41 8b 0c 80 41 31 0c 90 01 01 8b 8b 90 01 04 81 e1 90 01 04 7d 90 01 01 2b cf 83 c9 90 01 01 03 cf 48 8b 93 90 01 04 48 63 83 90 01 04 44 8b 04 82 85 c9 90 00 } //00 00 
	condition:
		any of ($a_*)
