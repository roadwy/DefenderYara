...
rule Trojan_Win64_BumbleBee_JK_MTB{
	meta:
		description = "Trojan:Win64/BumbleBee.JK!MTB,SIGNATURE_TYPE_PEHSTR_EXT,01 00 01 00 01 00 00 01 00 "
		
	strings :
		$a_03_0 = {8b c5 01 2d 90 01 04 8b 4b 90 01 01 33 8b 90 01 04 2b c1 01 05 90 01 04 8b 83 90 01 04 33 05 90 01 04 2d 90 01 04 31 43 90 01 01 8b 83 90 01 04 05 90 01 04 09 83 90 01 04 48 8b 05 90 01 04 8b 48 90 00 } //00 00 
	condition:
		any of ($a_*)
