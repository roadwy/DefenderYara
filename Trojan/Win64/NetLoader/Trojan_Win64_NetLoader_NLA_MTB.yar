...
rule Trojan_Win64_NetLoader_NLA_MTB{
	...
	strings :
		$a_03_0 = {89 5d f4 89 55 fc 74 52 48 83 0d 6a 0c 02 00 90 01 01 41 83 c8 04 25 90 01 04 44 89 05 3a 31 02 00 3d 90 01 04 74 28 3d 60 06 02 00 74 21 90 00 } //5
