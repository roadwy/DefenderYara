...
rule Trojan_Win64_Phorpiex_NP_MTB{
	...
	strings :
		$a_03_0 = {0f 84 34 02 00 00 48 8b 44 24 90 01 01 8b 40 70 48 8b 4c 24 90 01 01 48 03 c8 48 8b c1 48 89 44 24 90 01 01 c7 44 24 50 90 01 04 48 8b 84 24 28 01 00 00 48 c1 e8 90 01 01 48 25 90 00 } //5
