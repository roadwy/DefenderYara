...
rule Trojan_Win64_Khalesi_GNZ_MTB{
	...
	strings :
		...
		$a_03_1 = {56 53 48 83 ec 50 48 8b 2d ?? ?? ?? ?? 45 31 c9 45 31 c0 31 d2 48 8b 45 00 48 89 44 24 48 31 c0 48 8d 74 24 3c 31 c0 48 89 cf 48 89 74 24 20 31 c9 89 44 24 3c e8 } //10
	condition:
