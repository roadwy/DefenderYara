...
rule Trojan_Win64_Chksyn_A{
	...
	strings :
		...
		$a_01_2 = {76 3d 25 64 26 73 3d 25 64 26 68 3d 25 64 26 75 6e 3d 25 73 26 6f 3d 25 64 26 63 3d 25 64 26 69 70 3d 25 73 26 73 79 73 3d 25 73 26 75 69 64 3d 25 64 26 77 3d 25 64 } //00 00 
	condition:
		any of ($a_*)
