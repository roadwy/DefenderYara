...
rule Trojan_Win64_Musixk_A{
	...
	strings :
		...
		$a_03_2 = {8d 77 01 4c 8d 3c c5 00 00 00 00 4c 8d 2d 90 01 04 66 0f 1f 90 02 07 8b e6 90 00 } //2
		$a_03_3 = {0f b6 07 84 c0 74 90 01 01 3c 20 74 90 01 01 8b 90 02 0a 41 ff c0 48 ff c7 90 00 } //2
