...
rule Trojan_Win64_Pupy_MA_MTB{
	...
	strings :
		$a_03_0 = {57 ba 58 3f 15 5a b9 75 ee 40 70 56 53 48 83 ec 30 48 c7 44 24 24 48 b8 00 00 c7 44 24 2c 00 00 ff e0 e8 ?? ?? ?? ?? ba 8d f1 4f 84 b9 75 ee 40 70 48 89 c3 e8 } //5
