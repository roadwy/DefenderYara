...
rule Trojan_Win64_Shelm_MB_MTB{
	...
	strings :
		...
		$a_01_2 = {2e 74 6c 73 } //01 00 
		$a_01_3 = {47 65 74 53 74 61 72 74 75 70 49 6e 66 6f 41 } //01 00 
		$a_01_4 = {53 65 74 55 6e 68 61 6e 64 6c 65 64 45 78 63 65 70 74 69 6f 6e 46 69 6c 74 65 72 } //00 00 
	condition:
		any of ($a_*)
