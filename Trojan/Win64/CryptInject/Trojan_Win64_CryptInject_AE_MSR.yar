...
rule Trojan_Win64_CryptInject_AE_MSR{
	...
	strings :
		...
		$a_02_2 = {66 61 63 65 62 6f 6f 6b 90 02 08 5f 6e 65 77 76 65 72 73 69 6f 6e 5c 64 61 74 61 62 61 73 65 5c 78 36 34 5c 52 65 6c 65 61 73 65 5c 57 69 6e 68 74 74 70 5f 36 34 2e 70 64 62 90 00 } //1
