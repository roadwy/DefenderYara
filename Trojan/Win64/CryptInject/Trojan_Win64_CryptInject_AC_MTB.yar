...
rule Trojan_Win64_CryptInject_AC_MTB_2{
	...
	strings :
		$a_03_0 = {0f af ca 89 88 90 01 04 81 c1 90 01 04 8b 50 10 0f af d1 89 50 10 8b 48 34 81 e9 90 01 04 31 48 28 41 8b c8 41 0f af c8 41 ff c0 01 88 90 01 04 44 3b 40 5c 76 ae 90 00 } //2
	condition:
		((#a_03_0  & 1)*2) >=2
