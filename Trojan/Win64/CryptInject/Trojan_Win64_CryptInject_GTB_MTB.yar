...
rule Trojan_Win64_CryptInject_GTB_MTB{
	...
	strings :
		$a_03_0 = {45 8b c1 48 8b 05 90 01 04 41 c1 e8 10 ff 80 a4 00 00 00 8b 82 50 01 00 00 33 05 34 5c 02 00 35 d2 a1 0c 00 89 05 29 5c 02 00 8b 4a 6c 2b 4a 48 8b 05 ed 5b 02 00 90 00 } //1
