...
rule Trojan_Win64_Farfli_BAZ_MTB{
	...
	strings :
		...
		$a_01_2 = {55 00 73 00 65 00 72 00 73 00 5c 00 50 00 75 00 62 00 6c 00 69 00 63 00 5c 00 44 00 6f 00 63 00 75 00 6d 00 65 00 6e 00 74 00 73 00 5c 00 4e 00 47 00 4c 00 41 00 } //01 00  Users\Public\Documents\NGLA
		$a_01_3 = {70 00 73 00 2e 00 7a 00 69 00 70 00 } //00 00  ps.zip
	condition:
		any of ($a_*)
