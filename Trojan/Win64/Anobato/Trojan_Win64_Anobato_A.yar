...
rule Trojan_Win64_Anobato_A{
	...
	strings :
		$a_03_0 = {48 83 ec 08 48 83 ec 20 eb 0a 6e 74 64 6c 6c 2e 64 6c 6c 00 48 8d 0d ef ff ff ff ff 15 ?? ?? ?? ?? 48 83 c4 20 } //1
...
rule Trojan_Win64_Anobato_A_2{
	...
	strings :
		...
		$a_03_1 = {48 83 ec 20 48 c7 c1 00 00 00 00 48 c7 c2 00 80 02 00 49 c7 c0 00 30 00 00 49 c7 c1 40 00 00 00 ff 15 ?? ?? ?? ?? 48 83 c4 20 48 83 f8 00 75 02 eb ce } //1
...
rule Trojan_Win64_Anobato_A_3{
	...
	strings :
		$a_03_0 = {48 83 ec 20 eb 0d 6b 65 72 6e 65 6c 33 32 2e 64 6c 6c 00 48 8d 0d ec ff ff ff ff 15 ?? ?? ?? ?? 48 83 c4 20 90 90 } //1
...
rule Trojan_Win64_Anobato_A_4{
	...
	strings :
		$a_03_0 = {41 8b 0f 67 8b 49 04 41 8b 17 01 da 83 c2 0c 67 31 0a 41 3b 87 ?? ?? 00 00 73 08 83 c0 04 83 c3 04 eb e4 } //1
