...
rule Trojan_Win64_GadgetBoy_B_dha{
	...
	strings :
		...
		$a_01_1 = {47 6c 6f 62 61 6c 2f 2f 43 43 41 50 50 25 64 } //01 00  Global//CCAPP%d
		$a_01_2 = {44 6d 70 74 66 58 6a 6f 65 70 78 54 75 62 75 6a 70 6f } //01 00  DmptfXjoepxTubujpo
		$a_01_3 = {51 73 70 64 66 74 74 34 33 4f 66 79 75 } //00 00  Qspdftt43Ofyu
	condition:
		any of ($a_*)
