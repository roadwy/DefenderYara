...
rule Trojan_Win64_Totbrick_H{
	meta:
		description = "Trojan:Win64/Totbrick.H,SIGNATURE_TYPE_PEHSTR_EXT,0a 00 0a 00 47 00 00 "
		
	strings :
		$a_03_0 = {48 b9 66 c7 44 24 ?? 48 b8 66 c7 44 24 ?? ff e0 4c 89 74 24 ?? 4c 89 6c 24 ?? 48 c7 44 24 ?? 16 00 00 00 } //1
		$a_01_1 = {c7 07 5a 49 50 41 } //1
		$a_03_2 = {6d 63 63 6f 90 09 03 00 81 7d } //1
		$a_03_3 = {76 65 72 00 90 09 03 00 81 7d } //1
		$a_03_4 = {67 74 61 67 90 09 03 00 81 7d } //1
		$a_03_5 = {73 65 72 76 90 09 03 00 81 7d } //1
		$a_03_6 = {61 75 74 6f 90 09 03 00 81 7d } //1
		$a_03_7 = {72 75 6e 00 90 09 03 00 81 7d } //1
		$a_01_8 = {41 81 3e 73 00 54 00 75 17 41 81 7e 04 61 00 72 00 } //1
		$a_01_9 = {41 81 3e 73 00 74 00 75 11 41 81 7e 04 41 00 72 00 } //1
		$a_03_10 = {32 c2 ff cb 88 45 ?? 85 db 7e } //1
		$a_01_11 = {4c 8d 44 1b fc 66 41 83 3c 10 33 75 08 66 83 7c 5a fe 32 74 10 66 41 83 3c 10 36 75 1b 66 83 7c 5a fe 34 } //1
		$a_03_12 = {08 02 00 00 c7 45 ?? 10 66 00 00 } //1
