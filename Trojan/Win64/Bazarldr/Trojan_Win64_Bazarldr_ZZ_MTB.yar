...
rule Trojan_Win64_Bazarldr_ZZ_MTB{
	...
	strings :
		...
		$a_03_3 = {4c 8b c7 48 8b d8 33 c0 48 85 db 48 8b cb 0f 45 d0 89 15 90 02 04 48 8b d6 e8 90 02 04 48 8b 74 24 38 48 8b c3 48 8b 5c 24 30 48 83 c4 90 01 01 5f c3 90 00 } //1
	condition:
