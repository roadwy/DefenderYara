...
rule Trojan_Win64_Gamaredon_ZA_MTB{
	...
	strings :
		...
		$a_03_2 = {2e 52 75 6e 20 22 77 73 63 72 69 70 74 2e 65 78 65 20 43 3a 5c 44 6f 63 75 6d 65 6e 74 73 20 61 6e 64 20 53 65 74 74 69 6e 67 73 5c 41 64 6d 69 6e 69 73 74 72 61 74 6f 72 5c [0-20] 2e 64 6c 6c 20 2f 2f 65 3a 56 42 53 63 72 69 70 74 20 2f 2f 62 22 2c 20 30 2c 20 54 52 55 45 } //10
