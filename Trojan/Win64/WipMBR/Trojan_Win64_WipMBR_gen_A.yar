...
rule Trojan_Win64_WipMBR_gen_A{
	...
	strings :
		$a_03_0 = {0f b6 06 3c 45 0f 84 90 01 04 3c 54 0f 85 90 01 04 4c 8d 0d 90 00 } //2
		...
		$a_03_2 = {83 e0 03 41 b8 01 00 00 00 48 8b cd 42 0f b6 04 28 4c 89 74 24 20 32 06 88 84 24 90 01 04 ff 15 90 01 04 ff c3 48 ff c6 90 00 } //2
