...
rule Trojan_Win64_Cometer_AM_MTB{
	...
	strings :
		$a_02_0 = {48 89 5c 24 08 48 89 6c 24 18 48 89 74 24 20 57 41 56 41 57 48 81 ec c0 00 00 00 48 8b 05 90 01 01 3c 01 00 48 33 c4 48 89 84 24 b0 00 00 00 48 8d 0d 90 01 01 1f 01 00 4c 8b 90 01 01 ff 15 eb ac 00 00 48 8b c8 48 8d 15 90 01 01 1f 01 00 48 8b d8 ff 15 90 01 01 ac 00 00 48 8d 15 90 01 01 1f 01 00 48 8b cb 48 8b f8 ff 15 90 01 01 ac 00 00 48 8d 15 90 01 01 1f 01 00 48 8b cb 48 8b f0 ff 15 90 01 01 ac 90 00 } //10
		$a_80_1 = {4c 6f 61 64 52 65 73 6f 75 72 63 65 } //LoadResource  3
		...
		$a_80_5 = {49 73 50 72 6f 63 65 73 73 6f 72 46 65 61 74 75 72 65 50 72 65 73 65 6e 74 } //IsProcessorFeaturePresent  3
	condition:
