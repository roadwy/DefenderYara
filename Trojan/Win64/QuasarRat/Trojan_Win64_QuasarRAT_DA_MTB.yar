...
rule Trojan_Win64_QuasarRAT_DA_MTB{
	...
	strings :
		...
		$a_03_1 = {2f 2f 63 64 6e 2e 64 69 73 63 6f 72 64 61 70 70 2e 63 6f 6d 2f 61 74 74 61 63 68 6d 65 6e 74 73 2f 90 02 64 2f 90 02 0f 2e 62 61 74 90 02 64 26 43 4f 4d 50 55 54 45 52 4e 41 4d 45 90 00 } //1
