...
rule Trojan_Win64_Thundershell_A{
	...
	strings :
		$a_03_0 = {83 ea 01 83 fa 01 77 05 e8 90 01 04 b8 01 00 00 00 48 83 c4 28 c3 90 00 } //10
		$a_03_1 = {41 b8 01 10 00 00 4c 8d 4c 24 20 4c 89 c9 e8 90 01 04 49 89 c1 8b 05 90 01 04 85 c0 74 08 90 00 } //10
