...
rule Trojan_Win64_Meralifea_A{
	...
	strings :
		$a_03_0 = {48 85 c0 48 8b f0 0f 84 90 01 02 00 00 44 8b 84 24 90 01 02 00 00 48 8b 8c 24 90 01 02 00 00 4c 8d 8c 24 90 01 02 00 00 48 8b d0 48 89 5c 24 90 01 01 ff 15 90 01 04 85 c0 0f 84 90 01 02 00 00 66 81 3e 4d 5a 90 00 } //1
		$a_03_1 = {48 81 f9 fe ca 00 00 75 90 01 01 48 8b 44 24 28 48 85 c0 74 90 01 01 48 8d 0d 90 01 04 48 89 08 33 c0 c3 90 00 } //1
		$a_03_2 = {c7 44 24 28 10 00 00 00 48 89 6c 24 20 ff 15 90 01 04 f7 d8 1b c0 25 10 ff ed dc 05 cd cd cd cd 90 00 } //1
...
rule Trojan_Win64_Meralifea_A_2{
	...
	strings :
		...
		$a_03_4 = {74 1b 41 83 fb 05 75 0a 80 3e e9 74 10 80 3e e8 74 0b 41 03 fb 49 03 f3 83 ff 06 72 90 01 01 83 ff 06 0f 82 90 01 02 00 00 48 8b 4b 30 66 81 39 4d 5a 90 00 } //2
		$a_03_5 = {74 0a 80 7f 05 cc 0f 85 90 01 02 00 00 48 8b 4b 30 66 81 39 4d 5a 90 00 } //2
...
rule Trojan_Win64_Meralifea_A_3{
	...
	strings :
		$a_03_0 = {ba 30 00 22 00 48 89 46 08 44 8b 4c 24 90 01 01 49 8b 0c 24 48 8d 44 24 90 01 01 41 83 c1 28 48 89 44 24 90 01 01 89 7c 24 90 01 01 48 89 7c 24 90 01 01 ff 15 90 01 04 3b c7 74 90 01 01 48 8b 4c 24 68 ff 15 90 01 04 48 8b 4c 24 60 ba 10 27 00 00 ff 15 90 01 04 3b c7 75 90 01 01 48 8b 4c 24 90 01 01 48 8d 54 24 90 01 01 ff 15 90 01 04 81 7c 24 90 01 01 dd cc bb aa 90 00 } //2
		$a_03_1 = {c7 43 1c 00 00 10 00 ff 15 90 01 04 3b c5 74 0a 8b 84 24 90 01 01 00 00 00 89 43 90 01 01 48 8b 0b 48 89 6c 24 90 01 01 48 8d 44 24 90 01 01 48 89 44 24 90 01 01 48 8d 44 24 90 01 01 45 33 c9 45 33 c0 ba 5c 40 07 00 90 00 } //2
		$a_03_2 = {ba 20 00 22 00 89 7c 24 90 01 01 48 89 44 24 90 01 01 ff 15 90 01 04 f7 d8 1b c9 23 4c 24 90 01 01 81 f9 be ba fe ca 90 00 } //2
		$a_03_3 = {ba 00 20 49 82 48 8b cb 44 89 6c 24 90 01 01 48 89 44 24 90 01 01 89 6c 24 90 01 01 ff 15 90 01 04 3b c5 74 0c 81 7c 24 90 01 01 46 55 53 45 90 00 } //2
		$a_03_4 = {8b 56 08 44 8b 84 24 90 01 02 00 00 8b 4b 90 01 01 41 03 d0 48 0f af d1 66 81 bc 24 90 01 02 00 00 55 aa 75 90 00 } //2
		$a_03_5 = {ff 50 08 33 f6 48 3b c6 48 8b d8 74 90 01 01 8b 50 04 4c 8b 4c 24 90 01 01 48 8d 0c 52 48 8d 0c 8d 08 00 00 00 49 3b c9 73 90 01 01 66 81 38 38 9a 90 00 } //2
