...
rule Trojan_Win64_Shelsy_B_MTB{
	...
	strings :
		...
		$a_03_1 = {66 89 85 d4 02 00 00 c6 85 d0 02 00 00 4b 80 b5 d1 02 00 00 ?? 80 b5 d2 02 00 00 ?? 80 b5 d3 02 00 00 ?? 34 ?? 88 85 d4 02 00 00 80 b5 d5 02 00 00 ?? 48 8d 95 d0 02 00 00 } //1
	condition:
