...
rule Trojan_Win64_BazarLoader_CM_MTB{
	...
	strings :
		...
		$a_81_1 = {4c 49 42 52 41 52 59 2e 64 6c 6c } //03 00  LIBRARY.dll
		$a_81_2 = {37 63 65 33 65 38 30 31 37 33 32 36 34 65 61 31 39 62 30 35 33 30 36 62 38 36 35 65 61 64 66 39 } //00 00  7ce3e80173264ea19b05306b865eadf9
	condition:
		any of ($a_*)
