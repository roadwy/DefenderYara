...
rule Trojan_Win64_BazarLoader_DC_MTB{
	meta:
		description = "Trojan:Win64/BazarLoader.DC!MTB,SIGNATURE_TYPE_PEHSTR_EXT,0c 00 0c 00 04 00 00 03 00 "
	...
	strings :
		...
		$a_81_3 = {42 6d 74 70 7a 68 6c 44 68 65 64 61 78 74 43 73 64 75 70 64 79 77 62 61 62 } //00 00  BmtpzhlDhedaxtCsdupdywbab
	condition:
		any of ($a_*)
