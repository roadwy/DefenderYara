...
rule Trojan_Win64_Cobaltstrike_EM_MTB{
	meta:
		description = "Trojan:Win64/Cobaltstrike.EM!MTB,SIGNATURE_TYPE_PEHSTR_EXT,05 00 05 00 01 00 00 05 00 "
		
	strings :
		$a_01_0 = {5b 53 5f b0 c6 fc ae 75 fd 57 59 53 5e 8a 06 30 07 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win64_Cobaltstrike_EM_MTB_2{
	meta:
		description = "Trojan:Win64/Cobaltstrike.EM!MTB,SIGNATURE_TYPE_PEHSTR_EXT,01 00 01 00 01 00 00 01 00 "
		
	strings :
		$a_01_0 = {0f b6 44 1e ff 41 03 d0 c1 fa 09 8b ca c1 e9 1f 03 d1 69 ca 7b 03 00 00 44 2b c1 41 fe c0 41 32 c0 40 32 c5 88 43 ff } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win64_Cobaltstrike_EM_MTB_3{
	...
	strings :
		$a_03_0 = {4c 63 cb 31 d2 4c 89 e1 ff 15 90 01 04 49 89 c0 31 c0 48 89 c2 83 e2 07 8a 14 17 32 14 06 41 88 14 00 48 ff c0 39 c3 7f 90 00 } //00 00 
	condition:
		any of ($a_*)
