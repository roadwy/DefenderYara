...
rule Trojan_Win64_CobaltStrike_DK_MTB{
	...
	strings :
		$a_03_0 = {0f 28 4c 08 d0 0f 57 c8 0f 28 54 08 e0 0f 57 d0 0f 29 4c 08 d0 0f 29 54 08 e0 0f 28 4c 08 f0 0f 57 c8 0f 28 14 08 0f 57 d0 0f 29 4c 08 f0 0f 29 14 08 48 83 c0 90 01 01 48 3d 90 02 05 75 90 00 } //1
...
rule Trojan_Win64_CobaltStrike_DK_MTB_2{
	...
	strings :
		$a_03_0 = {0f b6 c9 48 8d 15 90 01 02 00 00 33 04 8a b9 04 00 00 00 48 6b c9 07 48 8b 54 24 20 33 04 0a 89 44 24 1c 48 8b 44 24 20 48 83 c0 20 48 89 44 24 20 8b 44 24 2c ff c8 89 44 24 2c 83 7c 24 2c 00 75 90 00 } //2
