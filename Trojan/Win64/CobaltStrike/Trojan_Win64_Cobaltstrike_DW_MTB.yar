...
rule Trojan_Win64_Cobaltstrike_DW_MTB{
	...
	strings :
		...
		$a_03_1 = {44 89 64 24 30 4c 8d 4c 24 30 ba 08 00 00 00 44 8d 42 38 49 8b ce ff 15 90 01 02 02 00 33 c9 ff 15 90 00 } //2
	condition:
...
rule Trojan_Win64_Cobaltstrike_DW_MTB_2{
	...
	strings :
		$a_03_0 = {2b c1 03 05 90 01 04 2b 05 90 01 04 2b 05 90 01 04 03 05 90 01 04 03 05 90 01 04 8b 0d 90 01 04 0f af 0d 90 01 04 2b c1 8b 0d 90 01 04 0f af 0d 90 01 04 03 c1 48 63 c8 48 8b 44 24 70 0f b6 0c 08 48 8b 44 24 78 0f b6 04 10 33 c1 89 44 24 14 8b 05 90 01 04 0f af 05 90 00 } //1
