...
rule Trojan_Win64_Cobaltstrike_DQ_MTB{
	...
	strings :
		$a_03_0 = {4c 63 c1 48 8d 43 01 49 2b d3 4d 03 c6 4a 8d 0c a5 90 01 04 49 0f af c3 48 2b c7 49 0f af d2 48 ff c8 49 0f af cc 48 0f af c3 48 03 d0 48 8d 04 7f 48 03 d0 48 2b d6 48 03 d5 49 8d 04 90 01 01 0f b6 0c 01 48 8b 44 24 68 41 30 0c 01 90 00 } //1
