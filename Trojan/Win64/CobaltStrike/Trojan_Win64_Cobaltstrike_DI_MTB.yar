...
rule Trojan_Win64_Cobaltstrike_DI_MTB{
	...
	strings :
		$a_03_0 = {48 98 48 3d 90 01 04 77 90 01 01 8b 85 90 01 04 48 98 0f b6 44 05 90 01 01 32 85 90 01 04 89 c2 8b 85 90 01 04 48 98 88 54 05 90 01 01 83 85 90 01 05 eb 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
