...
rule Trojan_Win64_CobaltStrike_BH_MTB{
	...
	strings :
		...
		$a_03_1 = {49 8b 14 24 48 39 d7 72 ?? 48 ff ca eb ?? 48 83 ca ff 48 89 f9 e8 [0-04] 8a 44 33 10 41 88 44 3c 10 48 83 c7 01 71 ?? e8 [0-04] 48 83 c6 01 71 ?? e8 [0-04] 48 3b 2b 74 } //1
	condition:
