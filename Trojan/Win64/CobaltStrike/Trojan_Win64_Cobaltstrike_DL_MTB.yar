...
rule Trojan_Win64_Cobaltstrike_DL_MTB{
	...
	strings :
		...
		$a_00_1 = {33 65 33 6d 31 6c 30 65 30 65 30 67 30 68 30 69 30 66 30 6b 30 6c 30 6d 30 6e 30 6f 30 70 30 71 30 72 31 63 31 64 31 } //03 00 
...
rule Trojan_Win64_Cobaltstrike_DL_MTB_2{
	...
	strings :
		...
		$a_81_1 = {6e 25 72 21 77 3f 24 2b 4f 56 77 64 76 68 35 37 24 37 41 40 33 31 54 2b 4b 4f 36 6a 4a 73 21 69 32 72 66 23 53 3c 76 6b 5e 5a 44 6a 5a 35 56 32 69 4d 33 25 6f 34 51 32 3c 36 2b 44 28 47 } //00 00 
	condition:
		any of ($a_*)
