...
rule Trojan_Win64_CobaltStrike_ME_MTB_2{
	...
	strings :
		$a_03_0 = {f0 00 23 00 0b 02 0e 1d 00 bc 08 00 00 90 01 01 66 90 00 } //5
...
rule Trojan_Win64_CobaltStrike_ME_MTB_3{
	...
	strings :
		$a_03_0 = {48 33 c4 48 89 44 24 38 33 c9 48 8d 44 24 30 48 89 44 24 28 4c 8d 05 90 01 04 45 33 c9 89 4c 24 20 33 d2 89 4c 24 30 ff 15 90 00 } //5
