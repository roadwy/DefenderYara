...
rule Trojan_Win64_CobaltStrike_PSS_MTB{
	...
	strings :
		...
		$a_03_1 = {41 f7 e9 c1 fa 04 8b c2 c1 e8 ?? 03 d0 41 8b c1 41 ff c1 6b d2 42 2b c2 48 63 c8 48 8d 05 10 93 04 00 8a 04 01 43 32 04 10 41 88 02 49 ff c2 44 3b cf 72 c7 } //1
	condition:
