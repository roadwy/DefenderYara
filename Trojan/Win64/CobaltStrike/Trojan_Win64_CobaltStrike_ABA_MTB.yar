...
rule Trojan_Win64_CobaltStrike_ABA_MTB{
	...
	strings :
		$a_03_0 = {8b 44 24 10 03 c8 b8 53 2e 97 a0 f7 e9 03 d1 c1 fa 0e 8b c2 c1 e8 1f 03 d0 48 ?? ?? ?? ?? 69 d2 06 66 00 00 2b ca 03 cd 4c 63 d1 89 8c 24 ?? ?? ?? ?? 41 0f b6 0c 02 b8 53 2e 97 a0 03 0c 24 f7 e9 03 d1 c1 fa 0e 8b c2 c1 } //1
