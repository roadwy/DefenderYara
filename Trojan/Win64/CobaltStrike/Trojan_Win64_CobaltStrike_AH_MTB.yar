...
rule Trojan_Win64_CobaltStrike_AH_MTB{
	...
	strings :
		$a_03_0 = {03 c1 2b 05 90 01 04 03 05 90 01 04 8b 0d 90 01 04 0f af 0d 90 01 04 03 c1 2b 05 90 01 04 03 05 90 01 04 8b 0d 90 01 04 0f af 0d 90 01 04 03 c1 2b 05 90 01 04 48 63 d0 48 8b 4c 24 90 01 01 48 8b 44 24 90 01 01 42 0f b6 04 00 88 04 11 e9 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_Win64_CobaltStrike_AH_MTB_2{
	...
	strings :
		$a_03_0 = {03 c8 48 8b 05 90 01 03 00 31 0d 90 01 03 00 49 63 48 90 01 01 41 8b d1 c1 ea 10 88 14 01 90 00 } //2
		$a_03_1 = {48 8b 44 24 90 01 01 80 e9 90 01 01 32 0d 90 01 03 00 41 88 0c 02 41 0f b7 44 5e 90 00 } //2
		$a_03_2 = {44 03 c9 8b 53 90 01 01 33 c9 41 81 f0 00 30 00 00 ff 15 90 00 } //1
	condition:
...
rule Trojan_Win64_CobaltStrike_AH_MTB_3{
	...
	strings :
		$a_03_0 = {48 89 c2 49 89 f0 e8 90 01 04 48 8d 15 90 01 04 48 89 f9 e8 90 01 04 48 c7 44 24 20 90 01 04 41 b9 90 01 04 48 c7 c1 90 00 } //5
...
rule Trojan_Win64_CobaltStrike_AH_MTB_4{
	...
	strings :
		$a_03_0 = {88 14 01 ff 43 90 01 01 8b 83 90 01 04 33 83 90 01 04 35 90 01 04 89 83 90 01 04 8b 83 90 01 04 48 63 4b 90 01 01 2d 90 01 04 31 43 90 01 01 48 8b 43 90 01 01 44 88 04 01 ff 43 90 01 01 8b 43 90 01 01 33 83 90 01 04 2d 90 01 04 31 43 90 01 01 8b 43 90 01 01 2b 83 90 01 04 2d 90 01 04 01 83 90 01 04 49 81 f9 90 01 04 0f 8c 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
