...
rule Trojan_Win64_CobaltStrike_MW_MTB_2{
	...
	strings :
		$a_03_0 = {48 8b 44 24 60 48 63 48 04 f6 44 0c 70 06 75 48 33 c9 ff 15 90 01 04 41 b9 40 00 00 00 41 b8 00 30 00 00 48 8b d6 33 c9 ff 15 90 01 04 48 8b d8 4c 8b c6 48 8b d5 48 8b c8 e8 90 01 04 45 33 c0 48 8b d3 33 c9 ff 15 90 01 04 48 8b c8 ff 15 90 00 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win64_CobaltStrike_MW_MTB_3{
	...
	strings :
		...
		$a_01_1 = {41 42 50 4e 52 77 44 75 67 76 72 65 46 4b 4b 54 58 6d 43 41 66 } //02 00  ABPNRwDugvreFKKTXmCAf
		$a_01_2 = {41 42 67 47 4d 62 55 45 50 64 63 61 72 62 } //00 00  ABgGMbUEPdcarb
	condition:
		any of ($a_*)
