...
rule Trojan_Win64_CobaltStrike_BF_MTB{
	...
	strings :
		$a_03_0 = {44 8a 4c 04 90 01 01 8b 74 24 90 01 01 44 89 c9 44 30 c1 40 20 f1 44 30 c6 44 20 ce 40 08 ce 40 88 74 04 90 01 01 49 ff c2 48 ff c0 48 83 f8 90 01 01 75 90 00 } //2
	condition:
		((#a_03_0  & 1)*2) >=2
