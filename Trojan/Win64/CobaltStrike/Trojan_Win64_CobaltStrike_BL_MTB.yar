...
rule Trojan_Win64_CobaltStrike_BL_MTB_4{
	...
	strings :
		...
		$a_01_2 = {41 55 54 4f } //01 00 
		$a_01_3 = {21 54 68 69 73 20 69 73 20 61 20 57 69 6e 64 6f 77 73 20 4e 54 20 77 69 6e 64 6f 77 65 64 20 64 79 6e 61 6d 69 63 20 6c 69 6e 6b 20 6c 69 62 72 61 72 79 } //00 00 
