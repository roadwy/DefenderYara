...
rule Trojan_Win64_CobaltStrike_BL_MTB_2{
	...
	strings :
		$a_03_0 = {48 8b c6 48 ff c6 48 c1 ea 90 01 01 48 69 d2 90 01 04 48 2b c2 0f b6 44 04 90 01 01 41 30 43 90 01 01 48 ff c9 75 90 00 } //2
	condition:
		((#a_03_0  & 1)*2) >=2
...
rule Trojan_Win64_CobaltStrike_BL_MTB_3{
	...
	strings :
		$a_03_0 = {48 8b 4c 24 90 01 01 39 c3 7e 90 01 01 48 89 c2 83 e2 90 01 01 8a 14 17 32 14 06 88 14 01 48 ff c0 eb 90 00 } //1
		$a_03_1 = {41 89 d0 42 80 3c 01 90 01 01 74 90 01 01 41 89 c1 46 0f b7 04 01 ff c2 41 c1 c9 90 01 01 45 01 c8 44 31 c0 eb 90 00 } //1
	condition:
...
rule Trojan_Win64_CobaltStrike_BL_MTB_4{
	...
	strings :
		$a_03_0 = {33 d2 0f b7 01 90 02 04 66 2b 90 01 05 90 02 04 66 f7 90 02 09 88 06 90 02 04 46 90 02 04 43 90 02 04 83 c1 02 90 00 } //1
		$a_03_1 = {33 d2 0f b7 01 90 02 04 66 2b 90 01 05 90 02 04 66 f7 90 02 09 88 06 90 02 04 46 90 02 04 43 90 02 04 83 c1 02 90 02 04 4f 8b d7 85 fa 75 90 00 } //10
