...
rule Trojan_Win64_CobaltStrike_MB_MTB{
	...
	strings :
		$a_01_0 = {45 33 c0 41 b9 9e 03 00 00 49 8b c0 49 ff c0 83 e0 0f 8a 04 10 30 01 48 ff c1 49 83 e9 01 75 } //1
	condition:
		((#a_01_0  & 1)*1) >=1
...
rule Trojan_Win64_CobaltStrike_MB_MTB_4{
	...
	strings :
		$a_01_0 = {41 41 78 67 44 4d 78 75 4b 7a 4c 55 } //2 AAxgDMxuKzLU
		$a_01_1 = {41 4f 4f 75 43 68 72 54 49 54 4e 79 50 67 64 6b 4a 6a 46 50 54 6e 42 } //2 AOOuChrTITNyPgdkJjFPTnB
		$a_01_2 = {41 58 4d 71 6e 78 6c 4a 7a 44 58 4b 4b 4e 46 67 77 4d 43 72 4a 55 6b } //2 AXMqnxlJzDXKKNFgwMCrJUk
		$a_01_3 = {42 59 7a 7a 42 7a 57 56 62 4e 6a 4b 64 58 70 4f 50 68 41 6d } //2 BYzzBzWVbNjKdXpOPhAm
		$a_01_4 = {43 43 68 51 52 79 55 56 69 6b 4d 61 42 47 44 45 47 75 6c 72 } //2 CChQRyUVikMaBGDEGulr
		$a_01_5 = {43 57 45 4d 52 76 77 74 4a 4e 6f 76 72 72 57 73 49 77 45 52 6a 53 6a 44 } //2 CWEMRvwtJNovrrWsIwERjSjD
		$a_01_6 = {43 6a 6a 42 74 5a 4c 5a 6b 4b 64 6b 4d 66 52 70 6c 41 57 } //2 CjjBtZLZkKdkMfRplAW
		$a_01_7 = {44 43 51 74 78 6c 4a 69 74 4d 72 71 4c 57 7a 79 } //2 DCQtxlJitMrqLWzy
		$a_01_8 = {44 54 5a 4e 51 78 59 4f 58 49 6f 74 75 72 7a 48 72 45 7a 52 70 78 75 } //2 DTZNQxYOXIoturzHrEzRpxu
	condition:
...
rule Trojan_Win64_CobaltStrike_MB_MTB_5{
	...
	strings :
		$a_01_0 = {8b 83 80 00 00 00 48 8b 8b e0 00 00 00 42 31 04 01 49 83 c0 04 8b 83 e8 00 00 00 01 83 80 00 00 00 8b 43 24 ff c8 01 83 d0 00 00 00 8b 83 94 00 00 00 8b 93 a8 00 00 00 81 c2 37 9f fd ff 03 53 74 0f af c2 89 83 94 00 00 00 b8 6f 15 f8 ff } //1
	condition:
		((#a_01_0  & 1)*1) >=1
