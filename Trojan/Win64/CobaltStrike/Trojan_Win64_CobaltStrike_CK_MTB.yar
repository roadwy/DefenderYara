...
rule Trojan_Win64_CobaltStrike_CK_MTB{
	...
	strings :
		$a_03_0 = {49 8b d0 48 8d 49 90 01 01 83 e2 90 01 01 49 ff c0 0f b6 04 3a 32 44 0b 90 01 01 88 41 90 01 01 49 83 e9 90 01 01 75 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_Win64_CobaltStrike_CK_MTB_2{
	...
	strings :
		$a_03_0 = {30 c1 41 88 4d 0f 88 83 90 01 02 00 00 49 83 c5 10 4d 39 f5 74 90 00 } //2
