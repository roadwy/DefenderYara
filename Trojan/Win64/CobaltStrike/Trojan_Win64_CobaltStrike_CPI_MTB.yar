...
rule Trojan_Win64_CobaltStrike_CPI_MTB{
	...
	strings :
		...
		$a_03_1 = {48 63 44 24 20 48 8b 4c 24 28 0f b6 04 01 89 44 24 30 48 63 4c 24 20 33 d2 48 8b c1 b9 ?? ?? ?? ?? 48 f7 f1 48 8b c2 8b 4c 24 30 33 4c 84 40 8b c1 48 63 4c 24 20 48 8b 54 24 28 88 04 0a } //1
	condition:
