...
rule Trojan_Win64_CobaltStrike_SDN_MTB{
	...
	strings :
		$a_03_0 = {8b ce b8 e1 83 0f 3e f7 ee ff c6 c1 fa 90 01 01 8b c2 c1 e8 90 01 01 03 d0 6b c2 90 01 01 2b c8 48 63 c1 48 8d 0d 90 01 04 8a 04 08 43 32 04 01 41 88 00 49 ff c0 3b f7 72 90 00 } //1
