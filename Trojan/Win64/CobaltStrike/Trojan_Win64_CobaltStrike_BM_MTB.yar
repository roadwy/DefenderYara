...
rule Trojan_Win64_CobaltStrike_BM_MTB_2{
	...
	strings :
		$a_03_0 = {42 0f b6 0c 2b 09 c1 0f c9 41 33 08 0f c9 43 89 4c 32 0c 31 c0 48 8b 94 24 80 00 00 00 48 8b 6c 24 70 48 83 f8 10 74 90 01 01 8a 0c 02 30 4c 05 00 48 ff c0 eb 90 00 } //1
...
rule Trojan_Win64_CobaltStrike_BM_MTB_3{
	...
	strings :
		$a_03_0 = {48 63 d0 48 90 01 06 48 01 d0 44 0f b6 00 8b 85 90 01 04 48 63 d0 48 90 01 06 48 c1 ea 90 01 01 01 c2 c1 fa 90 01 01 89 c1 c1 f9 90 01 01 29 ca 6b ca 90 01 01 29 c8 89 c2 89 d0 83 c0 90 01 01 44 89 c1 31 c1 48 90 01 06 8b 85 90 01 04 48 98 88 0c 02 83 85 90 01 05 83 bd 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
