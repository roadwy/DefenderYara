...
rule Trojan_Win64_CobaltStrike_CA_MTB_2{
	...
	strings :
		$a_01_0 = {80 44 24 47 02 c6 44 24 48 55 } //1
		$a_01_1 = {80 44 24 4a 24 c6 44 24 4b 4b } //1
		$a_01_2 = {80 44 24 4f 0a c6 44 24 50 3b } //1
		$a_01_3 = {80 44 24 48 11 c6 44 24 49 4a } //1
	condition:
...
rule Trojan_Win64_CobaltStrike_CA_MTB_4{
	...
	strings :
		$a_01_0 = {b8 89 88 88 88 41 f7 e8 41 03 d0 c1 fa 04 8b c2 c1 e8 1f 03 d0 6b c2 0f 41 8b c9 2b c8 41 8d 04 4a 41 03 c0 48 63 c8 0f b6 14 31 41 32 14 24 43 8d 04 18 48 63 c8 88 14 19 41 ff c0 4d 8d 64 24 01 8b 4d af 03 cf 44 3b c1 72 } //8
		$a_01_1 = {31 76 35 33 64 50 32 76 34 40 66 5a 49 3f 53 65 78 76 4c 55 35 4b 7a 37 4e 29 74 3e 67 } //1 1v53dP2v4@fZI?SexvLU5Kz7N)t>g
