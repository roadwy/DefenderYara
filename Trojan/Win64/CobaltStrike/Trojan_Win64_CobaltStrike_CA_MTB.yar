...
rule Trojan_Win64_CobaltStrike_CA_MTB_4{
	...
	strings :
		...
		$a_01_1 = {31 76 35 33 64 50 32 76 34 40 66 5a 49 3f 53 65 78 76 4c 55 35 4b 7a 37 4e 29 74 3e 67 } //01 00  1v53dP2v4@fZI?SexvLU5Kz7N)t>g
		$a_01_2 = {43 72 79 70 74 53 74 72 69 6e 67 54 6f 42 69 6e 61 72 79 41 } //00 00  CryptStringToBinaryA
	condition:
		any of ($a_*)
