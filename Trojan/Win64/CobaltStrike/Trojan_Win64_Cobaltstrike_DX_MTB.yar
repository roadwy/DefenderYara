...
rule Trojan_Win64_Cobaltstrike_DX_MTB{
	...
	strings :
		...
		$a_81_1 = {66 75 2b 6d 65 4e 21 5f 44 7a 58 46 21 46 44 42 4d 55 67 38 5a 2a 33 7a 62 49 34 3c 69 2b 79 5a 3c 44 6e 79 39 61 77 6f 29 23 53 64 } //00 00  fu+meN!_DzXF!FDBMUg8Z*3zbI4<i+yZ<Dny9awo)#Sd
	condition:
		any of ($a_*)
