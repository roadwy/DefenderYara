...
rule Trojan_Win64_CobaltStrike_KA_MTB{
	...
	strings :
		$a_03_0 = {41 8b c8 41 8b d2 d3 ea 8a 08 48 8b 47 ?? 80 f1 ?? 22 d1 48 63 8f ?? ?? ?? ?? 88 14 01 ff 87 ?? ?? ?? ?? 45 85 c0 75 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Trojan_Win64_CobaltStrike_KA_MTB_2{
	...
	strings :
		...
		$a_03_1 = {8b 13 8b 4b f8 49 ?? ?? 44 8b 43 fc 48 03 ce e8 ?? ?? ?? ?? 0f b7 45 06 48 8d 5b 28 ff c7 3b f8 7c } //1
