...
rule Trojan_Win64_CobaltStrike_DHO_MTB{
	...
	strings :
		...
		$a_01_2 = {5c 70 72 6f 6a 65 63 74 73 5c 67 61 72 64 61 5c 73 74 6f 72 61 67 65 5c 74 61 72 67 65 74 73 5c 77 6f 72 6b 36 2e 78 32 2e 70 64 62 } //00 00  \projects\garda\storage\targets\work6.x2.pdb
	condition:
		any of ($a_*)
