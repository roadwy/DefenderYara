...
rule Trojan_Win64_CobaltStrike_LP_MTB{
	...
	strings :
		$a_03_0 = {41 8b c0 99 83 e2 90 01 01 03 c2 83 e0 90 01 01 2b c2 48 63 c8 42 0f b6 04 19 43 32 04 0a 41 88 01 41 ff c0 49 ff c1 41 81 f8 90 01 04 72 d4 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
