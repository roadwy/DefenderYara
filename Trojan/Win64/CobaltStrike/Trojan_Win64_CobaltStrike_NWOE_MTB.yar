...
rule Trojan_Win64_CobaltStrike_NWOE_MTB{
	...
	strings :
		...
		$a_81_1 = {4e 74 41 6c 6c 6f 63 61 74 65 56 69 72 74 75 61 6c 4d 65 6d 6f 72 79 } //01 00  NtAllocateVirtualMemory
		$a_81_2 = {53 79 73 74 65 6d 55 70 64 61 74 65 } //00 00  SystemUpdate
	condition:
		any of ($a_*)
