...
rule Trojan_Win64_Cobaltstrike_FE_MTB{
	...
	strings :
		...
		$a_00_1 = {44 3a 5c 73 76 6e 32 5c 6b 64 64 72 69 76 65 72 5c 6b 64 5f 64 72 69 76 65 72 5f 63 6f 6e 66 69 67 5c 78 36 34 5c 52 65 6c 65 61 73 65 5c 4b 44 44 72 69 76 65 72 53 65 74 74 69 6e 67 2e 70 64 62 } //-1 D:\svn2\kddriver\kd_driver_config\x64\Release\KDDriverSetting.pdb
	condition:
