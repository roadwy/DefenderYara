...
rule Trojan_Win64_Cobaltstrike_DT_MTB_2{
	...
	strings :
		...
		$a_81_2 = {70 62 6d 62 64 75 61 75 2e 64 6c 6c } //01 00 
		$a_81_3 = {64 6f 65 71 7a 68 73 77 65 74 61 71 7a 75 72 74 6b } //01 00 
		$a_81_4 = {66 66 67 71 63 78 7a 68 65 70 75 72 65 6c 61 69 6a } //01 00 
		$a_81_5 = {6a 6e 73 78 64 61 6b 68 64 6f 66 78 78 71 } //01 00 
		$a_81_6 = {6b 70 71 68 62 6a 68 6f 73 61 65 61 72 75 73 } //00 00 
	condition:
		any of ($a_*)
