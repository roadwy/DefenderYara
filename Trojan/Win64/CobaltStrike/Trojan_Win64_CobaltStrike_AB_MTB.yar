...
rule Trojan_Win64_CobaltStrike_AB_MTB{
	...
	strings :
		$a_03_0 = {ff d7 48 89 d8 83 e0 07 8a 44 05 00 30 04 ?? 48 ff c3 48 83 fb 40 75 e8 } //3
	condition:
		((#a_03_0  & 1)*3) >=3
...
rule Trojan_Win64_CobaltStrike_AB_MTB_3{
	...
	strings :
		$a_03_0 = {f3 0f 6f 41 ?? 48 8d 49 ?? 66 0f 6f ca 66 0f ef c8 f3 0f 7f 49 ?? f3 0f 6f 41 ?? 66 0f ef c2 f3 0f 7f 41 ?? f3 0f 6f 49 ?? 66 0f ef ca f3 0f 7f 49 ?? 66 0f 6f ca f3 0f 6f 41 ?? 66 0f ef c8 f3 0f 7f 49 ?? 49 83 ee } //1
		$a_03_1 = {41 8b c1 4d 8d 40 01 99 41 ff c1 f7 ff 48 63 c2 0f b6 4c 04 ?? 41 30 48 ff 49 83 ea 01 75 } //1
	condition:
