...
rule Trojan_Win64_CobaltStrike_E_ibt{
	...
	strings :
		$a_00_0 = {66 41 5d 5a } //01 00 
		$a_00_1 = {59 47 40 4a 47 5c } //01 00 
		$a_00_2 = {5d 57 5d 40 4f 5a 47 58 4b } //01 00 
		$a_00_3 = {7c 5a 42 7b 5d 4b 5c 7a 46 5c 4b 4f 4a 7d 5a 4f 5c 5a } //01 00 
