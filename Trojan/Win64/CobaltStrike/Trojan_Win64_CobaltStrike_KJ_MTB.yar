...
rule Trojan_Win64_CobaltStrike_KJ_MTB{
	...
	strings :
		...
		$a_03_2 = {77 69 6e 64 6f 77 73 5c 74 65 6d 70 5c 90 02 02 2e 65 78 65 90 00 } //1
	condition:
...
rule Trojan_Win64_CobaltStrike_KJ_MTB_2{
	...
	strings :
		$a_03_0 = {ff c0 89 85 90 01 04 8b 45 90 01 01 39 85 90 01 04 7d 90 01 01 8b 85 90 01 04 83 c0 90 01 01 99 f7 7d 90 01 01 8b c2 89 85 90 00 } //1
		$a_03_1 = {0f be 0c 0a 33 c1 48 63 8d 90 01 04 48 8b 95 90 01 04 88 04 0a eb 90 00 } //1
	condition:
