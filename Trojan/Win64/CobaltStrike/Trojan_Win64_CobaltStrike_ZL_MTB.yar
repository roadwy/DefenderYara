...
rule Trojan_Win64_CobaltStrike_ZL_MTB_2{
	...
	strings :
		$a_03_0 = {49 ff c5 40 88 2c 30 48 ff c6 48 89 74 24 90 01 01 4d 39 ef 74 2d 44 89 e9 83 e1 90 01 01 42 0f b6 2c 21 42 32 2c 2f 48 3b 74 24 90 01 01 75 90 00 } //2
	condition:
		((#a_03_0  & 1)*2) >=2
