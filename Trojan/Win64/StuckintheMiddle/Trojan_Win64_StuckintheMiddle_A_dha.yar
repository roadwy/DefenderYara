...
rule Trojan_Win64_StuckintheMiddle_A_dha{
	...
	strings :
		$a_01_0 = {55 39 45 4c 65 74 78 38 65 4d 52 38 70 64 35 6b 6f 46 61 6d 6f 4f 79 75 66 39 74 54 52 54 50 47 } //01 00 
		$a_01_1 = {45 74 77 45 76 65 6e 74 57 72 69 74 65 } //01 00 
		$a_01_2 = {6c 69 63 65 6e 73 65 } //01 00 
