...
rule Trojan_Win64_Winnti_ZC_dha{
	...
	strings :
		...
		$a_01_2 = {49 49 53 46 69 6c 74 65 72 36 34 2e 64 6c 6c } //01 00 
		$a_01_3 = {47 65 74 46 69 6c 74 65 72 56 65 72 73 69 6f 6e } //01 00 
		$a_01_4 = {48 74 74 70 46 69 6c 74 65 72 50 72 6f 63 } //01 00 
		$a_01_5 = {54 65 72 6d 69 6e 61 74 65 46 69 6c 74 65 72 } //00 00 
	condition:
		any of ($a_*)
