...
rule Trojan_Win64_Winnti_F_dha{
	...
	strings :
		$a_01_0 = {25 73 5c 72 75 6e 64 6c 6c 33 32 2e 65 78 65 20 22 25 73 22 2c 20 44 6c 67 50 72 6f 63 20 25 73 } //01 00 
		$a_01_1 = {41 65 6d 61 4e 65 6c 69 46 70 6d 65 54 74 65 47 } //00 00 
	condition:
		any of ($a_*)
