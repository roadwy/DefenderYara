...
rule Trojan_Win64_Winnti_I_dha{
	...
	strings :
		$a_01_0 = {70 61 6e 67 6f 2d 62 61 73 69 63 2d 77 69 6e 33 32 2e 64 6c 6c } //01 00 
		$a_01_1 = {74 61 6e 67 6f 2e 64 6c 6c } //01 00 
		$a_01_2 = {25 73 5c 25 64 25 64 2e 64 61 74 } //01 00 
		$a_01_3 = {25 73 5c 73 79 73 70 72 65 70 5c 63 72 79 70 74 62 61 73 65 2e 64 6c 6c } //00 00 
	condition:
		any of ($a_*)
