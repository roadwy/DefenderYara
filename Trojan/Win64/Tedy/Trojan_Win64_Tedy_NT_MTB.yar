...
rule Trojan_Win64_Tedy_NT_MTB{
	...
	strings :
		$a_03_0 = {e8 2e 62 00 00 44 8b cb 4c 8b c0 33 d2 48 8d 0d 90 01 04 e8 aa e8 ff ff 90 00 } //3
		$a_03_1 = {e8 0a 31 00 00 e8 0d 31 00 00 48 8d 2d 90 01 04 48 8d 15 55 00 02 00 41 b8 00 10 00 00 48 89 e9 90 00 } //3
	condition:
...
rule Trojan_Win64_Tedy_NT_MTB_3{
	...
	strings :
		$a_03_0 = {74 12 45 33 c0 41 8d 50 90 01 01 33 c9 48 8b 03 ff 15 d1 2f 00 00 e8 f8 06 00 00 48 8b d8 48 83 38 90 01 01 74 14 48 8b c8 90 00 } //5
