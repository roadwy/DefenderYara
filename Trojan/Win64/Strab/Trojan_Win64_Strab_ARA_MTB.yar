...
rule Trojan_Win64_Strab_ARA_MTB{
	...
	strings :
		...
		$a_01_1 = {5c 64 64 76 73 6d 5c 30 38 30 34 5f 31 36 31 34 32 36 5c 63 6d 64 5c 73 5c 6f 75 74 5c 62 69 6e 61 72 69 65 73 5c 61 6d 64 36 34 72 65 74 5c 62 69 6e 5c 61 6d 64 36 34 5c 42 6c 65 6e 64 2e 70 64 62 } //01 00 
		$a_01_2 = {47 65 74 43 6c 69 70 62 6f 61 72 64 46 6f 72 6d 61 74 4e 61 6d 65 57 } //00 00 
	condition:
		any of ($a_*)
