...
rule Trojan_Win64_Emotetcrypt_A_MTB{
	...
	strings :
		$a_81_0 = {53 72 65 69 73 6d 65 6f 57 } //01 00  SreismeoW
		$a_81_1 = {65 70 6e 65 63 67 67 7a 67 6c 6b 70 69 6c 61 6d } //01 00  epnecggzglkpilam
		$a_81_2 = {66 79 71 7a 78 75 76 66 67 77 6a 77 79 75 6b } //01 00  fyqzxuvfgwjwyuk
