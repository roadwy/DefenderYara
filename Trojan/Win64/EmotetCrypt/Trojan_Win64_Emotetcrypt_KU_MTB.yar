...
rule Trojan_Win64_Emotetcrypt_KU_MTB{
	...
	strings :
		$a_03_0 = {4d 8d 40 01 f7 e7 8b cf 4d 8d 49 01 c1 ea 90 01 01 ff c7 6b c2 90 01 01 2b c8 48 63 c1 42 0f b6 0c 10 41 32 49 ff 41 88 48 ff 41 3b fb 7d 09 4c 8b 15 90 01 04 eb 90 00 } //1
