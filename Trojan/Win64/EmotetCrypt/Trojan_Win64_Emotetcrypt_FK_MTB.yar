...
rule Trojan_Win64_Emotetcrypt_FK_MTB{
	...
	strings :
		$a_81_0 = {7a 71 64 67 6d 61 6a 74 73 75 6a 62 6d 6b 2e 64 6c 6c } //10 zqdgmajtsujbmk.dll
		...
		$a_81_5 = {62 65 64 76 72 66 6f 6d 61 74 62 78 73 75 73 } //1 bedvrfomatbxsus
		$a_81_6 = {62 67 72 76 65 6e 67 68 68 6c 63 6e 6d 65 } //1 bgrvenghhlcnme
		$a_81_7 = {66 72 75 65 7a 76 65 69 6e 6c 6a 79 69 74 72 7a } //1 fruezveinljyitrz
		$a_81_8 = {67 68 78 7a 6c 78 77 6d 74 78 70 66 6d 76 68 } //1 ghxzlxwmtxpfmvh
	condition:
