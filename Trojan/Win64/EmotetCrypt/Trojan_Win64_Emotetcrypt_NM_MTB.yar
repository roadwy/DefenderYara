...
rule Trojan_Win64_Emotetcrypt_NM_MTB{
	...
	strings :
		$a_03_0 = {48 0f af c3 48 03 c5 44 32 44 04 30 49 8b c1 48 0f af c3 48 2b d0 49 8d 42 90 01 01 48 83 c2 90 01 01 49 0f af c3 49 0f af d1 48 2b d0 49 63 c5 48 0f af c8 48 8d 04 2a 48 ff c5 48 03 c8 48 03 cb 48 03 cf 46 88 04 39 90 00 } //1
