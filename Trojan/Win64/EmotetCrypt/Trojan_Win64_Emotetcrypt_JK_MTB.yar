...
rule Trojan_Win64_Emotetcrypt_JK_MTB{
	...
	strings :
		...
		$a_01_1 = {7a 5e 67 66 66 30 49 47 4a 72 70 68 76 4c 6d 34 4c 58 4c 2b 41 41 62 68 24 58 4b 3f 3f 40 46 68 67 47 49 4f 3e 30 26 6a 52 74 24 5f 6a 4f 38 73 68 6b 24 44 5e 25 35 7a 78 3f 32 6c } //00 00 
	condition:
		any of ($a_*)
