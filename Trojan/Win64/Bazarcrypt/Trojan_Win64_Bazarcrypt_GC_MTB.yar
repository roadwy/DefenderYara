...
rule Trojan_Win64_Bazarcrypt_GC_MTB{
	...
	strings :
		$a_02_0 = {88 10 8b 2d 90 02 04 0f b6 90 02 02 0f b6 90 02 02 03 c2 99 bb 90 02 04 f7 fb 0f b6 90 02 02 8a 14 90 02 02 8b 44 90 02 02 30 14 07 8b 44 90 02 02 47 3b f8 7c 90 00 } //5
