...
rule Trojan_Win64_Zusy_BV_MTB{
	...
	strings :
		$a_01_0 = {50 6f 70 73 65 67 6b 66 77 6f 69 65 73 77 67 6a 69 77 6f 65 68 67 69 6f 65 72 6a } //02 00  Popsegkfwoieswgjiwoehgioerj
		$a_01_1 = {56 72 68 65 72 6f 69 67 6a 77 34 6f 69 75 67 68 6a 73 65 72 } //02 00  Vrheroigjw4oiughjser
