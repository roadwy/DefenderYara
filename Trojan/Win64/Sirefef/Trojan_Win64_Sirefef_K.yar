...
rule Trojan_Win64_Sirefef_K{
	...
	strings :
		...
		$a_01_1 = {63 6e 71 61 7a 77 73 78 65 64 63 72 66 76 74 67 65 61 62 79 68 6e 75 6a 6d 69 6b 6f 69 6a 6c 70 } //01 00 
		$a_01_2 = {6e 65 77 2f 6c 69 6e 6b 73 2e 70 68 70 } //01 00 
		$a_01_3 = {70 2f 74 61 73 6b 32 2e 70 68 70 } //01 00 
		$a_01_4 = {47 45 54 20 2f 25 75 3f 77 3d 25 75 26 69 3d 25 75 26 76 3d } //00 00 
	condition:
		any of ($a_*)
