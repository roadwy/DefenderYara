...
rule Trojan_Win64_Sirefef_M{
	...
	strings :
		...
		$a_00_4 = {43 6f 6e 74 65 6e 74 2d 4c 65 6e 67 74 68 3a 20 } //01 00 
		$a_00_5 = {55 73 65 72 2d 41 67 65 6e 74 3a 20 } //02 00 
		$a_00_6 = {ba 72 65 63 76 } //02 00 
		$a_00_7 = {ba 63 6e 63 74 } //06 00 
		$a_00_8 = {63 6e 71 61 7a 77 73 78 65 64 63 72 66 76 74 67 65 61 62 79 68 6e 75 6a 6d 69 6b 6f 69 6a 6c 70 } //02 00 
		$a_03_9 = {61 73 6b 3f 61 3d 90 02 04 26 75 3d 25 75 26 6d 3d 25 78 26 68 3d 25 78 90 00 } //02 00 
		$a_00_10 = {49 6f 70 46 61 69 6c 5a 65 72 6f 41 63 63 65 73 73 43 72 65 61 74 65 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win64_Sirefef_M_2{
	...
	strings :
		...
		$a_00_7 = {63 6e 71 61 7a 77 73 78 65 64 63 72 66 76 74 67 65 61 62 79 68 6e 75 6a 6d 69 6b 6f 69 6a 6c 70 } //02 00 
		$a_03_8 = {61 73 6b 3f 61 3d 90 02 04 26 75 3d 25 75 26 6d 3d 25 78 26 68 3d 25 78 90 00 } //02 00 
		$a_00_9 = {49 6f 70 46 61 69 6c 5a 65 72 6f 41 63 63 65 73 73 43 72 65 61 74 65 } //00 00 
	condition:
		any of ($a_*)
