...
rule Trojan_Win64_Sirefef_C{
	...
	strings :
		...
		$a_01_3 = {73 74 61 74 32 2e 70 68 70 3f 77 3d 25 75 26 69 3d 25 73 26 61 3d } //01 00  stat2.php?w=%u&i=%s&a=
		$a_01_4 = {78 36 34 5c 72 65 6c 65 61 73 65 5c 73 68 65 6c 6c } //03 00  x64\release\shell
