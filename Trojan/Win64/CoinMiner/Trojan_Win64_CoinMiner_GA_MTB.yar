...
rule Trojan_Win64_CoinMiner_GA_MTB{
	meta:
		description = "Trojan:Win64/CoinMiner.GA!MTB,SIGNATURE_TYPE_PEHSTR_EXT,18 00 18 00 07 00 00 0a 00 "
	...
	strings :
		...
		$a_80_2 = {4d 72 70 45 4e 6b 47 5a 67 34 57 42 6c 64 79 78 71 75 31 6a 7a 67 3d 3d } //MrpENkGZg4WBldyxqu1jzg==  01 00 
