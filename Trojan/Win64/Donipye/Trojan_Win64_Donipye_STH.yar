...
rule Trojan_Win64_Donipye_STH{
	...
	strings :
		$a_03_0 = {41 88 3c 08 48 ff c1 48 c1 ff 08 ff cb 4c 39 c9 0f 8d 90 01 02 00 00 84 db 75 90 00 } //1
		$a_03_1 = {48 b8 01 23 45 67 89 ab cd ef 48 89 90 01 06 48 b8 fe dc ba 98 76 54 32 10 48 89 90 00 } //1
		$a_03_2 = {14 84 d7 17 48 90 01 04 14 84 d7 17 e8 90 00 } //1
