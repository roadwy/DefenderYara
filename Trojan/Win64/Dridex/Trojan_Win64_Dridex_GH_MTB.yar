...
rule Trojan_Win64_Dridex_GH_MTB{
	...
	strings :
		...
		$a_02_3 = {e5 44 15 de 71 f2 89 90 01 02 e6 90 00 } //1
	condition:
...
rule Trojan_Win64_Dridex_GH_MTB_2{
	...
	strings :
		$a_02_0 = {88 d8 41 f6 e2 88 84 24 0d 01 00 00 89 4c 24 90 01 01 4c 89 c1 44 8b 44 24 90 01 01 e8 90 01 04 48 8b 8c 24 d0 00 00 00 e8 90 00 } //10
		$a_02_1 = {4c 89 f2 44 8b 5c 24 90 01 01 44 89 44 24 90 01 01 45 89 d8 8b 6c 24 90 01 01 44 89 4c 24 90 01 01 41 89 e9 48 89 7c 24 90 01 01 ff d0 90 00 } //10
	condition:
