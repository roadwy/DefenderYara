...
rule Trojan_Win64_Dridex_ACL_MTB{
	...
	strings :
		$a_00_0 = {e2 71 29 c7 7b 56 9d fa b4 46 08 4b 3e e4 b5 43 97 5b 4c 29 d3 83 6f 0a 35 b2 5d 94 a2 a7 6d ba } //10
		$a_80_1 = {55 75 69 64 49 73 4e 69 6c } //UuidIsNil  3
		$a_80_2 = {43 72 79 70 74 43 41 54 50 75 74 41 74 74 72 49 6e 66 6f } //CryptCATPutAttrInfo  3
		$a_80_3 = {43 6f 70 79 45 6e 68 4d 65 74 61 46 69 6c 65 57 } //CopyEnhMetaFileW  3
		$a_80_4 = {43 72 65 61 74 65 44 69 73 63 61 72 64 61 62 6c 65 42 69 74 6d 61 70 } //CreateDiscardableBitmap  3
		$a_80_5 = {55 72 6c 55 6e 65 73 63 61 70 65 41 } //UrlUnescapeA  3
	condition:
