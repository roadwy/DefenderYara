...
rule Trojan_Win64_Dridex_GF_MTB{
	...
	strings :
		$a_02_0 = {4c 89 d9 44 89 44 24 90 01 01 41 89 c0 44 89 54 24 90 01 01 e8 90 01 04 48 8b 8c 24 90 01 04 48 8b 54 24 90 01 01 48 81 ca 90 01 04 48 89 94 24 90 01 04 e8 90 00 } //1
