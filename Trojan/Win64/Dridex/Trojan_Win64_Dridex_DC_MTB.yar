...
rule Trojan_Win64_Dridex_DC_MTB{
	meta:
		description = "Trojan:Win64/Dridex.DC!MTB,SIGNATURE_TYPE_PEHSTR_EXT,15 00 15 00 07 00 00 03 00 "
	...
	strings :
		...
		$a_80_4 = {4c 64 72 47 65 74 50 72 6f 63 65 64 75 72 65 41 64 64 72 65 73 73 } //LdrGetProcedureAddress  03 00 
		$a_80_5 = {43 52 59 50 54 33 32 2e 64 6c 6c } //CRYPT32.dll  03 00 
		$a_80_6 = {58 36 6d 6f 34 3a } //X6mo4:  00 00 
	condition:
		any of ($a_*)
