...
rule Trojan_Win64_Dridex_EC_MTB{
	meta:
		description = "Trojan:Win64/Dridex.EC!MTB,SIGNATURE_TYPE_PEHSTR_EXT,05 00 05 00 01 00 00 05 00 "
		
	strings :
		$a_01_0 = {45 32 f6 33 ff 42 8b 94 28 88 00 00 00 41 89 d2 46 8b 8c 28 8c 00 00 00 44 03 ca 43 8b 44 2a 20 47 8b 44 2a 24 49 03 c5 4d 03 c5 } //00 00 
	condition:
		any of ($a_*)
...
rule Trojan_Win64_Dridex_EC_MTB_2{
	...
	strings :
		$a_01_0 = {7c 61 6a 67 7a 26 } //01 00  |ajgz&
		$a_01_1 = {72 65 77 65 72 74 77 65 72 } //01 00  rewertwer
		$a_01_2 = {6e 37 33 34 35 37 33 34 6d 37 33 34 35 } //01 00  n7345734m7345
		$a_01_3 = {4c 6f 67 6f 6e 55 73 65 72 45 78 57 } //01 00  LogonUserExW
		$a_01_4 = {69 73 61 6c 6e 75 6d } //01 00  isalnum
		$a_01_5 = {56 69 72 74 75 61 6c 50 72 6f 74 65 63 74 45 78 } //00 00  VirtualProtectEx
	condition:
		any of ($a_*)
...
rule Trojan_Win64_Dridex_EC_MTB_3{
	...
	strings :
		...
		$a_81_1 = {47 65 74 4e 4c 53 56 65 72 73 69 6f 6e } //03 00  GetNLSVersion
		$a_81_2 = {49 63 6d 70 53 65 6e 64 45 63 68 6f 32 } //03 00  IcmpSendEcho2
		$a_81_3 = {6d 61 6c 6c 6f 63 } //03 00  malloc
		$a_81_4 = {4f 4c 45 41 55 54 33 32 2e 64 6c 6c } //03 00  OLEAUT32.dll
		$a_81_5 = {47 65 74 4c 61 73 74 45 72 72 6f 72 } //00 00  GetLastError
	condition:
		any of ($a_*)
