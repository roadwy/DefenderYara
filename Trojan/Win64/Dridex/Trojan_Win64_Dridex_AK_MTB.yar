...
rule Trojan_Win64_Dridex_AK_MTB_2{
	...
	strings :
		$a_81_0 = {4c 4f 47 4f 4e 53 45 52 56 45 52 } //03 00 
		$a_81_1 = {64 69 73 63 6f 72 64 61 70 70 } //03 00 
		$a_81_2 = {67 61 79 5f 6e 69 67 67 65 72 5f 70 6f 72 6e } //03 00 
		$a_81_3 = {48 65 6c 6c 6f 57 6f 72 6c 64 58 6c 6c 2e 70 64 62 } //03 00 
		$a_81_4 = {53 68 65 6c 6c 45 78 65 63 75 74 65 45 78 57 } //03 00 
		$a_81_5 = {55 52 4c 44 6f 77 6e 6c 6f 61 64 54 6f 46 69 6c 65 57 } //03 00 
		$a_81_6 = {44 69 72 53 79 6e 63 53 63 68 65 64 75 6c 65 44 69 61 6c 6f 67 } //00 00 
	condition:
		any of ($a_*)
