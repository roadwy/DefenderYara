...
rule Trojan_Win64_Dridex_EF_MTB_2{
	...
	strings :
		$a_81_0 = {46 47 54 37 74 2e 70 64 62 } //03 00  FGT7t.pdb
		$a_81_1 = {43 72 79 70 74 49 6d 70 6f 72 74 50 75 62 6c 69 63 4b 65 79 49 6e 66 6f } //03 00  CryptImportPublicKeyInfo
		$a_81_2 = {72 61 69 73 69 6e 67 6e 35 38 37 } //03 00  raisingn587
		$a_81_3 = {61 69 6e 63 6c 75 64 69 6e 67 31 70 } //03 00  aincluding1p
		$a_81_4 = {4c 64 72 47 65 74 50 72 6f 63 65 64 75 72 65 41 64 64 72 65 73 73 } //03 00  LdrGetProcedureAddress
		$a_81_5 = {43 52 59 50 54 33 32 2e 64 6c 6c } //03 00  CRYPT32.dll
		$a_81_6 = {56 69 72 74 75 61 6c 41 6c 6c 6f 63 } //00 00  VirtualAlloc
	condition:
		any of ($a_*)
