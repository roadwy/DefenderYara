...
rule Trojan_Win64_Dridex_GC_MTB{
	...
	strings :
		$a_02_0 = {44 8a 0a 48 81 c1 90 01 04 44 8a 54 24 90 01 01 41 80 e2 90 01 01 44 88 54 24 90 01 01 89 44 24 2c 48 8b 54 24 90 01 01 46 8a 14 02 45 28 ca 8b 44 24 90 01 01 05 90 01 04 44 8b 5c 24 90 01 01 4c 8b 44 24 90 01 01 48 8b 74 24 90 01 01 46 88 14 06 48 89 4c 24 90 01 01 41 39 c3 0f 84 90 00 } //10
