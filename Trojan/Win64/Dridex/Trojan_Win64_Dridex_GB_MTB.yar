...
rule Trojan_Win64_Dridex_GB_MTB_2{
	...
	strings :
		$a_02_0 = {45 8a 1c 12 45 28 cb 48 8b 54 24 90 01 01 44 8a 4c 24 90 01 01 44 88 8c 24 90 02 04 4c 29 c1 8b 44 24 90 01 01 0f af c0 89 84 24 90 02 04 4c 8b 44 24 48 45 88 1c 10 48 03 4c 24 90 01 01 66 8b 74 24 90 01 01 66 29 f6 66 89 b4 24 90 02 04 48 8b 94 24 90 02 04 48 89 4c 24 90 01 01 48 39 d1 0f 85 90 00 } //10
		$a_02_1 = {89 c1 48 8d 15 90 02 04 8b 44 24 90 01 01 89 84 24 90 02 04 4c 8b 44 24 90 01 01 44 8a 4c 24 90 01 01 41 80 f1 ff 90 00 } //10
