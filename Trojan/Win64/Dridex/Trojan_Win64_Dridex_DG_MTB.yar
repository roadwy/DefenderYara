...
rule Trojan_Win64_Dridex_DG_MTB_2{
	...
	strings :
		$a_81_0 = {40 77 61 6c 6b 65 72 61 72 65 70 6c 61 63 65 64 41 75 6e 61 6e 69 6d 6f 75 73 6c 79 73 6e 4d } //03 00  @walkerareplacedAunanimouslysnM
		$a_81_1 = {69 6e 74 6f 35 38 77 65 62 73 69 74 65 73 } //03 00  into58websites
		$a_81_2 = {47 65 74 57 69 6e 64 6f 77 73 41 63 63 6f 75 6e 74 44 6f 6d 61 69 6e 53 69 64 } //03 00  GetWindowsAccountDomainSid
		$a_81_3 = {47 65 74 55 73 65 72 4e 61 6d 65 41 } //03 00  GetUserNameA
		$a_81_4 = {4c 6f 6f 6b 75 70 41 63 63 6f 75 6e 74 53 69 64 57 } //03 00  LookupAccountSidW
		$a_81_5 = {47 65 74 43 75 72 72 65 6e 74 48 77 50 72 6f 66 69 6c 65 57 } //03 00  GetCurrentHwProfileW
		$a_81_6 = {47 65 74 53 65 63 75 72 69 74 79 44 65 73 63 72 69 70 74 6f 72 4f 77 6e 65 72 } //00 00  GetSecurityDescriptorOwner
	condition:
		any of ($a_*)
