...
rule Trojan_Win64_Trickbot_PA_MTB{
	...
	strings :
		$a_03_0 = {40 88 7c 24 90 01 01 c6 44 24 90 01 02 c6 44 24 90 01 02 c6 44 24 90 01 02 c6 44 24 90 01 02 c6 44 24 90 01 02 c6 44 24 90 01 02 c6 44 24 90 01 02 c6 44 24 90 01 03 44 24 90 02 10 75 90 00 } //1
