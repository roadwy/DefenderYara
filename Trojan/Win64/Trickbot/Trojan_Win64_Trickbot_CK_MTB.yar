...
rule Trojan_Win64_Trickbot_CK_MTB{
	...
	strings :
		$a_03_0 = {c7 44 24 48 60 73 65 00 b9 f8 2a 00 00 ff 15 90 01 04 8b 05 90 01 04 85 c0 74 eb c7 44 24 90 01 01 53 65 6c 65 8b 44 24 90 01 01 ff c0 89 44 24 90 01 01 c7 44 24 90 01 01 57 61 6e 74 8b 44 24 90 01 01 ff c8 90 00 } //1
