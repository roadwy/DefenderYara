...
rule Trojan_Win64_LucaStealer_NC_MTB{
	...
	strings :
		$a_03_0 = {0f 84 a3 00 00 00 48 8d 55 e0 49 89 c1 49 89 d8 48 c7 44 24 38 90 01 04 48 8d 0d dc 41 0d 00 48 89 54 24 90 01 01 48 8d 55 e8 48 89 4c 24 90 01 01 31 c9 48 89 54 24 28 90 00 } //5
