...
rule Trojan_Win64_Convagent_NG_MTB{
	...
	strings :
		$a_03_0 = {0f 84 7d 01 00 00 8b 16 48 8b 00 48 c7 04 d0 90 01 04 e9 f9 fe ff ff 45 31 c0 ba 90 01 04 48 8d 0d 87 f4 09 00 e8 6f 22 00 00 81 38 90 01 04 48 89 05 da 7c 0c 90 00 } //5
