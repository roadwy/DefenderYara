...
rule Trojan_Win64_PSWStealer_GNN_MTB{
	...
	strings :
		$a_02_0 = {48 8b 05 82 d6 07 00 48 33 c4 48 89 84 24 90 01 04 45 8b d9 45 0f b6 d0 48 8b 01 48 83 7a 10 00 75 2b 44 0f b6 8c 24 90 01 04 45 8b c3 41 0f b6 d2 ff 50 60 48 8b 8c 24 90 01 04 48 33 cc e8 90 01 04 48 81 c4 90 01 04 c3 90 00 } //10
