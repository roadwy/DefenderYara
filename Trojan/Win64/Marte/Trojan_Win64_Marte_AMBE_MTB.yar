...
rule Trojan_Win64_Marte_AMBE_MTB{
	...
	strings :
		$a_03_0 = {4c 8d 4c 24 90 01 01 ba 90 01 04 41 b8 20 00 00 00 48 8b cb ff 15 90 01 04 85 c0 74 90 01 01 48 c7 44 24 28 90 01 04 45 33 c9 4c 8b c3 c7 44 24 20 90 01 04 33 d2 33 c9 ff 15 90 01 04 48 8b c8 ba 90 01 04 ff 15 90 00 } //2
