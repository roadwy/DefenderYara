...
rule Spoofer_Win32_Arpspoof_A{
	...
	strings :
		...
		$a_00_2 = {48 69 6a 61 63 6b 20 72 65 63 65 69 76 65 64 20 25 64 20 70 61 63 6b 65 74 73 } //01 00  Hijack received %d packets
		$a_00_3 = {54 61 74 6f 6c 20 25 64 20 68 6f 73 74 73 } //00 00  Tatol %d hosts
	condition:
		any of ($a_*)
