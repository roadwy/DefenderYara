...
rule Backdoor_WinNT_Mansys{
	...
	strings :
		$a_02_0 = {56 68 80 00 00 00 6a 02 56 6a 02 68 00 00 00 40 ff 75 90 01 01 ff 15 90 00 } //1
		$a_02_1 = {66 81 e3 00 f0 66 81 fb 00 30 75 1e 90 02 15 75 90 01 01 66 90 02 06 c7 05 74 15 90 00 } //1
