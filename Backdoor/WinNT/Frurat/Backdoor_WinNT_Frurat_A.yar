...
rule Backdoor_WinNT_Frurat_A{
	...
	strings :
		$a_03_0 = {63 6f 6e 65 78 69 6f 6e 90 02 10 6a 61 76 61 2f 6e 65 74 2f 53 6f 63 6b 65 74 90 00 } //5
		$a_03_1 = {6f 70 63 69 6f 6e 65 73 2f 4f 70 63 69 6f 6e 90 02 10 66 69 6c 65 90 00 } //5
		$a_03_2 = {70 75 65 72 74 6f 90 02 10 70 75 65 72 74 6f 90 02 10 70 61 73 73 90 02 10 74 69 6d 65 90 00 } //5
		...
		$a_03_6 = {70 6c 75 67 69 6e 4c 6f 63 61 6c 90 02 10 75 72 6c 90 02 10 75 72 6c 90 00 } //1
	condition:
...
rule Backdoor_WinNT_Frurat_A_2{
	...
	strings :
		...
		$a_03_2 = {70 61 73 73 90 02 10 70 6f 72 74 90 02 10 70 6f 72 74 90 00 } //2
		...
		$a_03_7 = {74 6d 70 64 69 72 90 02 10 66 72 61 75 74 61 73 2e 6c 6f 63 6b 90 00 } //10
		$a_01_8 = {66 72 75 74 61 73 72 61 74 2e } //10 frutasrat.
		$a_03_9 = {68 6f 73 74 90 02 10 70 61 73 73 90 02 10 70 6f 72 74 90 02 10 70 6f 72 74 90 02 10 74 65 6d 70 90 00 } //10
	condition:
...
rule Backdoor_WinNT_Frurat_A_3{
	...
	strings :
		...
		$a_03_3 = {44 65 73 69 6e 73 74 61 6c 61 90 02 10 72 75 74 61 90 00 } //5
		$a_03_4 = {72 75 74 61 90 02 10 4c 6a 61 76 61 2f 6c 61 6e 67 2f 53 74 72 69 6e 67 90 02 10 72 65 67 69 73 74 72 6f 90 00 } //5
