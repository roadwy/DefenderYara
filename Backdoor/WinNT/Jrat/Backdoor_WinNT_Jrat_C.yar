...
rule Backdoor_WinNT_Jrat_C{
	...
	strings :
		...
		$a_01_2 = {0d 41 4c 4c 41 54 4f 52 49 78 44 45 4d 4f } //01 00  䄍䱌呁剏硉䕄位
		$a_01_3 = {2f 62 72 69 64 6a 2f 6a 61 77 74 2f } //00 00  /bridj/jawt/
	condition:
		any of ($a_*)
...
rule Backdoor_WinNT_Jrat_C_2{
	...
	strings :
		...
		$a_01_3 = {11 63 6f 6e 66 69 67 2f 42 79 74 65 4c 6f 61 64 65 72 } //05 00  挑湯楦⽧祂整潌摡牥
...
rule Backdoor_WinNT_Jrat_C_3{
	...
	strings :
		...
		$a_01_4 = {09 49 4e 4a 45 43 54 4a 41 52 } //01 00  䤉䩎䍅䩔剁
		$a_01_5 = {0d 4c 4f 41 44 50 52 4f 43 45 53 53 45 53 } //05 00  䰍䅏偄佒䕃卓卅
...
rule Backdoor_WinNT_Jrat_C_4{
	...
	strings :
		...
		$a_01_1 = {11 4c 63 6f 6e 66 69 67 2f 52 65 67 69 73 74 72 79 3b } //01 00  䰑潣普杩刯来獩牴㭹
		$a_01_2 = {13 4c 63 6f 6e 66 69 67 2f 42 79 74 65 4c 6f 61 64 65 72 3b } //04 00  䰓潣普杩䈯瑹䱥慯敤㭲
		$a_01_3 = {0d 63 6f 6e 66 69 67 2f 52 65 61 64 49 4f } //01 00  挍湯楦⽧敒摡佉
		$a_01_4 = {07 5d 15 44 18 45 0b 59 } //01 00  崇䐕䔘夋
...
rule Backdoor_WinNT_Jrat_C_5{
	...
	strings :
		$a_01_0 = {2f 6a 73 74 65 61 6c 74 68 2f 61 70 69 2f 6c 6f 61 64 65 72 73 2f 43 43 4c 6f 61 64 65 72 } //01 00  /jstealth/api/loaders/CCLoader
		$a_01_1 = {2f 6a 73 74 65 61 6c 74 68 2f 61 70 69 2f 43 6c 69 65 6e 74 50 6c 75 67 69 6e } //01 00  /jstealth/api/ClientPlugin
		$a_01_2 = {14 4a 61 72 49 6e 6a 65 63 74 55 70 6c 6f 61 64 2e 6a 61 76 61 } //01 00 
		$a_01_3 = {6e 65 74 2f 6f 73 63 70 2f 63 6c 69 65 6e 74 2f 6a 61 72 69 6e 6a 65 63 74 6f 72 2f 4a 61 72 49 6e 6a 65 63 74 55 70 6c 6f 61 64 } //01 00  net/oscp/client/jarinjector/JarInjectUpload
