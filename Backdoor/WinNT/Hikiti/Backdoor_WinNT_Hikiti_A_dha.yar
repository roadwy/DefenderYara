...
rule Backdoor_WinNT_Hikiti_A_dha{
	...
	strings :
		$a_00_0 = {69 6d 61 67 65 6e 61 6d 65 20 66 6f 75 6e 64 20 61 74 3a 25 73 } //02 00  imagename found at:%s
		$a_00_1 = {68 69 64 65 2d 2d 2d 70 6f 72 74 20 3d 20 25 64 } //02 00  hide---port = %d
