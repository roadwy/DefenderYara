...
rule Backdoor_WinNT_Sinowal_A{
	...
	strings :
		...
		$a_03_1 = {2e a1 34 f0 df ff 0b c0 74 90 01 01 8b 40 70 90 00 } //1
		$a_03_2 = {ff 45 fc 83 7d fc 25 72 90 01 01 be 01 00 00 c0 90 00 } //1
		$a_03_3 = {8b 40 10 03 c7 eb 02 33 c0 3b c6 74 90 01 01 ff 75 08 ff 75 90 01 01 57 ff d0 90 00 } //1
	condition:
