...
rule Backdoor_WinNT_Pfinet_A_dha{
	...
	strings :
		...
		$a_03_6 = {c7 45 e0 66 00 59 21 eb 2a a1 90 01 02 01 00 89 45 d0 3b c3 75 e3 b8 01 00 00 c0 e9 90 01 02 ff ff 56 ff 75 10 8b 00 ff 34 88 e8 90 01 02 ff ff 89 45 e0 89 7e 90 01 01 83 4d fc ff 90 00 } //5
		$a_03_7 = {46 66 83 fe 5a 76 9d 38 5d 0b 0f 84 90 01 02 00 00 8b 45 fc 66 8b 48 30 66 81 f9 f2 01 0f 87 77 90 01 02 00 8b 70 34 0f b7 c9 ff 75 0c 8b d1 c1 e9 02 90 00 } //5
	condition:
