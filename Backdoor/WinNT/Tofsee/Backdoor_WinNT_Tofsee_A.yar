...
rule Backdoor_WinNT_Tofsee_A{
	...
	strings :
		$a_03_0 = {2b fe 8a c1 90 01 02 b3 90 01 01 f6 eb 8d 14 31 32 04 17 41 81 f9 90 01 02 00 00 88 02 75 e7 90 00 } //3
		$a_03_1 = {47 47 66 3b c3 75 f5 8d 90 01 02 f7 ff ff be 90 01 04 50 f3 a5 90 00 } //2
		$a_03_2 = {68 c0 a6 00 00 8d 90 01 03 ff ff 50 8d 45 90 01 01 50 53 90 00 } //2
