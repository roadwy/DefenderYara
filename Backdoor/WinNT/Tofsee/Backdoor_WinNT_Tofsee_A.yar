...
rule Backdoor_WinNT_Tofsee_A{
	...
	strings :
		...
		$a_00_3 = {2f 00 69 00 6e 00 64 00 65 00 78 00 2e 00 68 00 74 00 6d 00 6c 00 } //01 00 
		$a_01_4 = {48 6f 74 20 69 6e 74 65 72 6e 65 74 20 6f 66 66 65 72 73 00 } //00 00 
	condition:
		any of ($a_*)
