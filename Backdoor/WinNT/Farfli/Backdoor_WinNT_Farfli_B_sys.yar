...
rule Backdoor_WinNT_Farfli_B_sys{
	...
	strings :
		$a_02_0 = {50 ff d7 8d 45 fc 89 75 fc 50 6a 01 5b 8d 45 ec 53 56 68 00 80 00 00 50 56 ff 75 08 ff 15 90 01 02 01 00 3b c6 0f 8c 90 01 01 00 00 00 8d 45 e4 68 90 01 02 01 00 50 ff d7 8d 45 ec 50 8d 45 e4 50 ff 15 90 01 02 01 00 8b f8 3b fe 7d 10 ff 75 fc ff 15 90 01 02 01 00 8b c7 90 00 } //1
		$a_02_1 = {89 7d e0 89 75 dc 89 75 e4 89 75 e8 ff 15 90 01 02 01 00 8b 3d 90 01 02 01 00 85 c0 7c 40 6a 04 68 00 00 10 00 8d 45 fc 6a 01 50 56 68 00 10 00 00 56 68 90 01 02 01 00 6a ff ff 35 90 01 02 01 00 89 75 fc ff 15 90 01 02 01 00 85 c0 7c 04 b0 01 eb 18 ff 35 90 01 02 01 00 89 35 90 01 02 01 00 ff d7 ff 35 90 01 02 01 00 ff d7 32 c0 5f 5e 5b c9 c3 cc 90 00 } //1
