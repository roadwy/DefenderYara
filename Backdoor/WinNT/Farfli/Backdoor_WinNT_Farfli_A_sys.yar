...
rule Backdoor_WinNT_Farfli_A_sys{
	...
	strings :
		...
		$a_01_4 = {5a 77 53 65 74 56 61 6c 75 65 4b 65 79 } //01 00 
		$a_01_5 = {4f 62 52 65 66 65 72 65 6e 63 65 4f 62 6a 65 63 74 42 79 48 61 6e 64 6c 65 } //01 00 
		$a_01_6 = {4f 62 66 44 65 72 65 66 65 72 65 6e 63 65 4f 62 6a 65 63 74 } //01 00 
		$a_01_7 = {5a 77 44 65 6c 65 74 65 56 61 6c 75 65 4b 65 79 } //01 00 
		$a_01_8 = {5a 77 57 72 69 74 65 46 69 6c 65 } //00 00 
	condition:
		any of ($a_*)
