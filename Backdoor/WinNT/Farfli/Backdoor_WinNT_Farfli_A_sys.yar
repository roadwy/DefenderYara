...
rule Backdoor_WinNT_Farfli_A_sys{
	...
	strings :
		$a_02_0 = {fa 8d 45 fc 50 e8 90 01 01 ff ff ff 8b 0d 90 01 02 01 00 a1 90 01 02 01 00 8b 51 01 8b 30 8b 14 96 89 15 90 01 02 01 00 8b 49 01 8b 00 c7 04 88 90 01 02 01 00 ff 75 fc e8 90 01 01 ff ff ff fb 90 00 } //1
		$a_02_1 = {8d 45 e8 68 00 80 00 00 50 6a 04 57 ff 15 90 01 02 01 00 85 c0 7c 90 01 01 8d 45 e0 68 90 01 02 01 00 50 ff d6 8d 45 e8 50 8d 45 e0 50 ff 15 90 01 02 01 00 8b f0 85 f6 7d 0d ff 75 fc ff 15 90 00 } //1
		$a_02_2 = {8d 45 e8 68 00 80 00 00 50 6a 04 90 02 03 ff 15 90 01 02 01 00 3b 90 01 01 7c 90 01 01 8d 45 e0 68 90 01 02 01 00 50 ff 90 01 01 8d 45 e8 50 8d 45 e0 50 ff 15 90 01 02 01 00 8b 90 01 01 3b 90 01 01 7d 0d ff 75 fc ff 15 90 00 } //1
