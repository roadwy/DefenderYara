...
rule Backdoor_WinNT_Farfli_H_sys{
	...
	strings :
		...
		$a_02_2 = {89 7d e0 89 75 dc 89 75 e4 89 75 e8 ff 15 90 01 02 01 00 8b 3d 90 01 02 01 00 85 c0 7c 40 6a 04 68 00 00 10 00 8d 45 fc 6a 01 50 56 68 00 10 00 00 56 68 90 01 02 01 00 6a ff ff 35 90 01 02 01 00 89 75 fc ff 15 90 01 02 01 00 85 c0 7c 04 b0 01 eb 18 ff 35 90 01 02 01 00 89 35 90 01 02 01 00 ff d7 ff 35 90 01 02 01 00 ff d7 32 c0 5f 5e 5b c9 c3 90 00 } //100
		$a_02_3 = {53 55 56 57 ff 15 90 01 01 02 01 00 8b e8 33 db be 90 01 02 01 00 8b fe 83 c9 ff 33 c0 f2 ae f7 d1 49 8d 04 2b 51 50 56 ff 90 01 02 02 01 00 83 c4 0c 85 c0 74 10 43 81 fb 00 30 00 00 7c d8 33 c0 5f 5e 5d 5b c3 8b c3 eb f7 90 00 } //100
