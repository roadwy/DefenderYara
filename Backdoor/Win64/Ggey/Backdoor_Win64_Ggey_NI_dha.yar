...
rule Backdoor_Win64_Ggey_NI_dha{
	...
	strings :
		...
		$a_03_1 = {48 c7 c1 02 00 00 80 48 8d 15 ?? ?? ?? ?? ff 15 ?? ?? ?? ?? 85 c0 75 ?? 48 8b ?? ?? ?? 48 8d } //1
		$a_03_2 = {c7 44 24 28 04 00 00 00 48 8d ?? ?? ?? ?? ?? 41 b9 04 00 00 00 48 89 44 24 20 45 33 c0 44 89 ?? ?? ?? ff 15 ?? ?? ?? ?? 85 c0 } //1
	condition:
