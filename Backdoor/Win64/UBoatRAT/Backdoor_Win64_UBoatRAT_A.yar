...
rule Backdoor_Win64_UBoatRAT_A{
	...
	strings :
		...
		$a_03_2 = {62 69 74 73 61 64 6d 69 6e 20 2f 61 64 64 66 69 6c 65 20 90 02 10 20 63 3a 5c 77 69 6e 64 6f 77 73 5c 73 79 73 74 65 6d 33 32 5c 90 02 10 2e 65 78 65 20 20 25 25 74 65 6d 70 25 25 5c 73 79 73 2e 6c 6f 67 90 00 } //5
