...
rule Backdoor_Win64_Plugx_A_dha{
	...
	strings :
		$a_01_0 = {6c 69 6e 65 3d 25 64 20 65 72 72 6f 72 3d 25 64 } //01 00  line=%d error=%d
		$a_01_1 = {56 65 72 73 69 6f 6e 3a 20 6d 61 6a 6f 72 3a 25 64 2c 20 6d 69 6e 6f 72 3a 25 64 } //01 00  Version: major:%d, minor:%d
		$a_01_2 = {66 6f 75 6e 64 20 73 65 72 76 69 63 65 5f 72 65 63 6f 72 64 20 74 61 62 6c 65 21 } //01 00  found service_record table!
