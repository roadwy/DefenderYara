...
rule Backdoor_Win64_Spiderpig_A{
	...
	strings :
		$a_02_0 = {53 68 65 6c 6c 45 78 65 63 75 74 65 41 90 02 10 55 52 4c 44 6f 77 6e 6c 6f 61 64 54 6f 46 69 6c 65 41 90 02 30 74 61 73 6b 6b 69 6c 6c 20 2f 66 20 2f 70 69 64 90 02 10 65 78 65 00 6f 70 65 6e 90 00 } //10
