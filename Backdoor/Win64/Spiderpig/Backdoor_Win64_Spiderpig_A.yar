...
rule Backdoor_Win64_Spiderpig_A{
	...
	strings :
		...
		$a_00_1 = {5c 53 70 69 64 65 72 2d 52 61 74 5c 43 6c 69 65 6e 74 5c } //01 00 
		$a_00_2 = {48 61 72 64 77 61 72 65 5c 44 65 73 63 72 69 70 74 69 6f 6e 5c 53 79 73 74 65 6d 5c 43 65 6e 74 72 61 6c 50 72 6f 63 65 73 73 6f 72 5c 30 } //00 00 
	condition:
		any of ($a_*)
