...
rule Backdoor_Win64_Androm_KK_MTB{
	...
	strings :
		...
		$a_03_1 = {48 8d 0d cb 86 20 00 45 33 c9 45 33 c0 ff 15 90 01 04 48 c7 44 24 28 00 00 00 00 45 33 c9 48 8b c8 c7 44 24 20 00 00 20 80 45 33 c0 48 8b d3 48 8b f8 ff 15 90 00 } //1
