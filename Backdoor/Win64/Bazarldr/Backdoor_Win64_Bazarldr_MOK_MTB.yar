...
rule Backdoor_Win64_Bazarldr_MOK_MTB{
	...
	strings :
		...
		$a_01_3 = {45 53 45 54 20 68 79 75 6e 79 61 } //01 00 
		$a_81_4 = {53 6f 66 74 77 61 72 65 5c 4d 69 63 72 6f 73 6f 66 74 5c 57 69 6e 64 6f 77 73 5c 43 75 72 72 65 6e 74 56 65 72 73 69 6f 6e 5c 50 6f 6c 69 63 69 65 73 5c 45 78 70 6c 6f 72 65 72 } //01 00 
		$a_81_5 = {25 73 25 73 2e 64 6c 6c } //00 00 
