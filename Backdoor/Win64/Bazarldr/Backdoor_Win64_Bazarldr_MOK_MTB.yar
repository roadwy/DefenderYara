...
rule Backdoor_Win64_Bazarldr_MOK_MTB{
	...
	strings :
		$a_03_0 = {41 8b f8 48 8b f2 48 8b e9 ff 15 90 02 04 48 85 c0 75 04 33 c0 eb 4b 48 8b c8 ff 15 90 02 04 48 8b d8 48 85 c0 74 eb 48 8b d6 48 8b cd ff 15 90 02 04 44 8b d8 4c 03 db 83 e7 0f 76 90 00 } //10
		$a_03_1 = {48 8b 04 0a 4c 8b 54 0a 08 48 83 c1 90 02 01 48 89 41 e0 4c 89 51 e8 48 8b 44 0a f0 4c 8b 54 0a f8 49 ff c9 48 89 41 f0 4c 89 51 f8 75 d4 90 00 } //10
		$a_03_2 = {41 8a 00 48 ff c2 49 ff c8 48 3b d7 88 44 2a 90 02 01 7c 90 00 } //10
