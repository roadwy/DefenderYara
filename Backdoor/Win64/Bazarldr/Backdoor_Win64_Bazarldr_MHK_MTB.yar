...
rule Backdoor_Win64_Bazarldr_MHK_MTB{
	...
	strings :
		...
		$a_01_4 = {53 6f 66 74 77 61 72 65 5c 4d 69 63 72 6f 73 6f 66 74 5c 57 69 6e 64 6f 77 73 5c 43 75 72 72 65 6e 74 56 65 72 73 69 6f 6e 5c 50 6f 6c 69 63 69 65 73 5c 45 78 70 6c 6f 72 65 72 } //01 00  Software\Microsoft\Windows\CurrentVersion\Policies\Explorer
		...
		$a_01_6 = {43 4c 53 49 44 5c 25 31 5c 49 6e 50 72 6f 63 53 65 72 76 65 72 33 32 } //00 00  CLSID\%1\InProcServer32
	condition:
		any of ($a_*)
