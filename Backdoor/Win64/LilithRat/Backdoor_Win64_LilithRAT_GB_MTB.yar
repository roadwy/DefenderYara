...
rule Backdoor_Win64_LilithRAT_GB_MTB{
	...
	strings :
		...
		$a_80_4 = {67 65 74 61 73 79 6e 63 6b 65 79 73 74 61 74 65 } //getasynckeystate  01 00 
		$a_80_5 = {4b 65 79 6c 6f 67 67 65 72 } //Keylogger  01 00 
		$a_80_6 = {6b 69 6c 6c 69 6e 67 20 73 65 6c 66 } //killing self  01 00 
		$a_80_7 = {70 6f 77 65 72 73 68 65 6c 6c 2e 65 78 65 } //powershell.exe  01 00 
		$a_80_8 = {6b 65 79 64 75 6d 70 } //keydump  01 00 
		$a_80_9 = {72 65 6d 6f 74 65 43 6f 6e 74 72 6f 6c } //remoteControl  00 00 
	condition:
		any of ($a_*)
