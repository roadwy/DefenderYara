...
rule Backdoor_Win64_Hackdoor_A_dll{
	...
	strings :
		...
		$a_01_2 = {47 6c 6f 62 61 6c 5c 64 6f 6f 72 6e 65 65 64 73 68 75 74 00 } //01 00 
		$a_01_3 = {68 6b 64 6f 6f 72 65 76 74 00 } //01 00 
		...
		$a_01_6 = {44 6f 6d 61 69 6e 3a 25 53 2c 55 73 65 72 3a 25 53 2c 50 61 73 73 77 6f 72 64 3a 25 73 00 } //01 00 
...
rule Backdoor_Win64_Hackdoor_A_dll_2{
	...
	strings :
		$a_01_0 = {5c 44 6f 73 44 65 76 69 63 65 73 5c 6b 69 66 65 73 } //01 00 
		$a_01_1 = {5c 44 65 76 69 63 65 5c 6b 69 66 65 73 } //01 00 
		$a_01_2 = {68 65 6c 6c 6f 68 61 68 61 } //01 00 
		$a_01_3 = {69 70 66 6c 74 64 72 76 2e 73 79 73 } //01 00 
		$a_01_4 = {5c 00 44 00 65 00 76 00 69 00 63 00 65 00 5c 00 49 00 50 00 46 00 49 00 4c 00 54 00 45 00 52 00 44 00 52 00 49 00 56 00 45 00 52 00 } //00 00 
	condition:
		any of ($a_*)
