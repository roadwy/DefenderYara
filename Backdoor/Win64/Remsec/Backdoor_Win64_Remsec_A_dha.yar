...
rule Backdoor_Win64_Remsec_A_dha{
	...
	strings :
		...
		$a_01_4 = {50 61 73 73 77 6f 72 64 43 68 61 6e 67 65 4e 6f 74 69 66 79 } //0a 00  PasswordChangeNotify
		$a_01_5 = {49 6e 69 74 69 61 6c 69 7a 65 43 68 61 6e 67 65 4e 6f 74 69 66 79 } //00 00  InitializeChangeNotify
	condition:
		any of ($a_*)
