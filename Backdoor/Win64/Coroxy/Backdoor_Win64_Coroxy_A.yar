...
rule Backdoor_Win64_Coroxy_A{
	...
	strings :
		...
		$a_00_1 = {2f 74 6f 72 2f 72 65 6e 64 65 7a 76 6f 75 73 32 2f 25 73 } //01 00  /tor/rendezvous2/%s
		$a_00_2 = {42 45 47 49 4e 20 52 53 41 20 50 55 42 4c 49 43 20 4b 45 59 } //00 00  BEGIN RSA PUBLIC KEY
	condition:
		any of ($a_*)
