...
rule Backdoor_Win64_CobaltStrike_AA_MTB{
	...
	strings :
		$a_02_0 = {55 48 89 e5 48 83 ec 50 c7 45 e4 90 01 04 8b 05 90 01 01 2a 03 00 89 c0 41 b9 90 01 04 4c 8d 05 90 01 02 03 00 48 89 c2 48 8d 0d 90 01 01 29 03 00 e8 90 01 01 ff ff ff 48 8d 0d 90 01 02 03 00 48 8b 05 90 01 02 03 90 00 } //10
