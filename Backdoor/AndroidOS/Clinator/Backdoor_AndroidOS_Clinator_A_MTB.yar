...
rule Backdoor_AndroidOS_Clinator_A_MTB{
	...
	strings :
		$a_03_0 = {15 00 00 00 12 12 62 00 90 01 02 12 01 6e 30 90 01 02 10 02 0a 00 38 00 0a 00 22 00 90 01 02 70 10 90 01 02 00 00 6e 10 90 01 02 00 00 0f 02 0d 00 28 fe 90 00 } //1
