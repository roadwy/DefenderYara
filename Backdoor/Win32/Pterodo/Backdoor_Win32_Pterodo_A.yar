...
rule Backdoor_Win32_Pterodo_A{
	...
	strings :
		...
		$a_03_2 = {2e 70 68 70 90 02 06 00 50 4f 53 54 90 00 } //1
		$a_03_3 = {5c 64 65 76 65 6c 6f 70 5c 72 65 61 64 79 5c 90 02 50 5c 77 69 6e 72 65 73 74 6f 72 65 2e 70 64 62 90 00 } //1
	condition:
