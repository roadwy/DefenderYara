...
rule Backdoor_Win32_PornDialer_H{
	...
	strings :
		...
		$a_02_8 = {83 f8 05 7f 36 74 2d 2b c7 74 22 48 74 18 48 74 0e 48 0f 85 8d 00 00 00 68 90 01 02 40 00 eb 7f 68 90 01 02 40 00 eb 78 68 90 01 02 40 00 eb 71 68 90 01 02 40 00 eb 6a 68 90 01 02 40 00 eb 63 83 e8 06 74 59 2d fa 1f 00 00 74 0a 48 75 5b 68 90 01 02 40 00 eb 4d 68 90 01 02 40 00 8b ce e8 90 01 04 6a 01 58 50 90 00 } //10
	condition:
