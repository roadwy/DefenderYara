...
rule Backdoor_Win32_Votwup_A{
	...
	strings :
		$a_03_0 = {75 25 8d 45 f8 50 8b 45 fc e8 90 01 02 ff ff 8b c8 ba 05 00 00 00 8b 45 fc e8 90 01 02 ff ff b2 01 8b 45 f8 e8 90 01 02 ff ff 68 60 ea 00 00 e8 90 01 02 ff ff e9 90 00 } //5
