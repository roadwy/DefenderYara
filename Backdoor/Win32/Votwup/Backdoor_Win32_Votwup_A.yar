...
rule Backdoor_Win32_Votwup_A{
	...
	strings :
		...
		$a_01_1 = {2f 67 65 74 63 6d 64 2e 70 68 70 } //02 00 
		$a_01_2 = {2f 6e 65 77 62 6f 74 2e 70 68 70 } //02 00 
		$a_01_3 = {3f 75 69 64 3d } //01 00 
		$a_01_4 = {77 74 66 00 } //01 00 
		$a_01_5 = {64 64 31 00 } //01 00 
		$a_01_6 = {64 64 32 00 } //01 00 
		$a_01_7 = {75 70 64 00 } //00 00 
	condition:
		any of ($a_*)
