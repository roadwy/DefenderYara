...
rule Backdoor_Win32_Androm_BG_MTB{
	...
	strings :
		$a_03_0 = {8b ff 8b 0d 90 02 04 8a 94 31 90 02 04 a1 90 02 04 88 14 30 81 3d 90 02 04 ab 05 00 00 75 90 00 } //2
		$a_03_1 = {3d cb d9 0b 00 75 06 81 c1 90 02 04 40 3d 3d a6 15 00 7c 90 00 } //1
