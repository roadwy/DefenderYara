...
rule Backdoor_Win32_Androm_GCS_MTB{
	...
	strings :
		$a_03_0 = {8b 45 f4 83 c0 01 89 45 f4 81 7d f4 ff 00 00 00 7d 0b 8b 4d f0 33 4d f4 89 4d f0 eb 90 01 01 8b 55 f0 33 55 ec 83 f2 0f 8b 45 08 03 45 fc 88 10 90 00 } //10
