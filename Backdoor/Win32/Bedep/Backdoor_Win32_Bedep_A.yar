...
rule Backdoor_Win32_Bedep_A{
	meta:
		description = "Backdoor:Win32/Bedep.A,SIGNATURE_TYPE_PEHSTR_EXT,03 00 03 00 07 00 00 02 00 "
	...
	strings :
		...
		$a_01_5 = {ff d2 41 b8 2b 00 00 00 45 8b 8d bc 00 00 00 41 8b a5 c8 00 00 00 41 8e d0 } //01 00 
		$a_01_6 = {c7 40 60 45 76 38 12 } //00 00 
