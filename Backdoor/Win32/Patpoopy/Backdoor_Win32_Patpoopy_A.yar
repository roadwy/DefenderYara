...
rule Backdoor_Win32_Patpoopy_A_2{
	...
	strings :
		$a_00_0 = {00 70 75 70 79 78 36 34 2e 64 6c 6c 00 52 65 66 6c 65 63 74 69 76 65 4c 6f 61 64 65 72 00 } //05 00 
		$a_00_1 = {00 70 75 70 79 78 36 34 2e 75 6e 63 2e 64 6c 6c 00 52 65 66 6c 65 63 74 69 76 65 4c 6f 61 64 65 72 00 } //05 00 
