...
rule Backdoor_Win32_Prorat_AZ{
	...
	strings :
		$a_00_0 = {40 5b 50 72 6f 52 61 74 20 54 72 6f 6a 61 6e 20 48 6f 72 73 65 20 2d 20 43 6f 64 65 64 20 62 79 20 50 52 4f 20 47 72 6f 75 70 20 2d 20 4d 61 64 65 20 69 6e 20 54 75 72 6b 65 79 5d } //01 00 
		$a_00_1 = {6e 63 6f 6d 5f 2e } //01 00 
		$a_00_2 = {6e 63 6f 6d 2e 65 78 65 } //01 00 
		$a_00_3 = {69 66 20 65 78 69 73 74 20 20 25 63 25 73 25 63 20 67 6f 74 6f 20 31 } //0a 00 
