...
rule Backdoor_Win32_Prorat_AN{
	...
	strings :
		$a_01_0 = {47 65 74 57 69 6e 64 6f 77 54 65 78 74 41 } //01 00 
		$a_01_1 = {73 65 74 57 69 6e 64 6f 77 73 48 6f 6f 6b 45 78 41 } //01 00 
		...
		$a_01_3 = {5c 6b 74 64 33 32 2e 61 74 6d } //00 00 
	condition:
		any of ($a_*)
