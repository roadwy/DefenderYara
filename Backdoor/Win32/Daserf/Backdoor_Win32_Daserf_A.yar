...
rule Backdoor_Win32_Daserf_A{
	...
	strings :
		...
		$a_01_2 = {74 30 3d 25 73 26 74 31 3d } //01 00  t0=%s&t1=
		$a_01_3 = {70 69 6e 66 73 2e 64 61 74 } //01 00  pinfs.dat
		$a_01_4 = {2a 46 49 4c 45 4c 49 53 54 2a } //01 00  *FILELIST*
		$a_01_5 = {49 6e 6a 65 63 74 20 50 72 6f 63 65 73 73 3a 25 73 } //00 00  Inject Process:%s
	condition:
		any of ($a_*)
