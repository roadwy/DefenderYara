...
rule Backdoor_Win32_Numnom_A{
	...
	strings :
		...
		$a_03_10 = {59 b9 40 9c 00 00 99 f7 f9 8d 82 ?? ?? 00 00 a3 ?? ?? 40 00 a1 ?? ?? 40 00 3d 5a 4d 00 00 74 ?? 3d 18 06 00 00 74 } //5
		$a_03_11 = {c7 85 64 ff ff ff fa 00 00 00 e8 ?? ?? ff ff 89 85 7c ff ff ff 85 c0 0f 84 ?? ?? 00 00 66 c7 85 6c ff ff ff 02 00 8b 85 7c ff ff ff 89 85 70 ff ff ff 68 e7 14 00 00 } //5
	condition:
