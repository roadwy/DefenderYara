...
rule Backdoor_Win32_Hackdef_gen_A{
	meta:
		description = "Backdoor:Win32/Hackdef.gen!A,SIGNATURE_TYPE_PEHSTR_EXT,14 00 12 00 69 00 00 03 00 "
	...
	strings :
		...
		$a_00_67 = {2d 3a 49 4e 53 54 41 4c 4c 4f 4e 4c 59 } //03 00  -:INSTALLONLY
		$a_00_68 = {2d 3a 52 45 46 52 45 53 48 } //03 00  -:REFRESH
		$a_00_69 = {2d 3a 4e 4f 53 45 52 56 49 43 45 } //03 00  -:NOSERVICE
		$a_00_70 = {2d 3a 55 4e 49 4e 53 54 41 4c 4c } //02 00  -:UNINSTALL
		$a_00_71 = {5f 5f 49 4e 53 54 41 4c 4c } //02 00  __INSTALL
		$a_00_72 = {5f 5f 52 45 4c 4f 41 44 } //02 00  __RELOAD
		$a_00_73 = {5f 5f 53 54 45 41 4c 54 48 } //02 00  __STEALTH
		$a_00_74 = {5f 5f 44 49 45 } //02 00  __DIE
		$a_00_75 = {47 48 61 6e 64 6c 65 73 20 76 31 2e 30 20 66 6f 72 20 47 4b 69 74 20 62 79 20 67 72 61 79 2c 74 68 78 20 66 6f 72 20 48 6f 6c 79 5f 46 61 74 68 65 72 20 26 26 20 52 61 74 74 65 72 2f 32 39 41 } //03 00  GHandles v1.0 for GKit by gray,thx for Holy_Father && Ratter/29A
		$a_00_76 = {5c 5c 2e 5c 6d 61 69 6c 73 6c 6f 74 5c 6d 65 64 69 61 2d 63 6b 72 } //03 00  \\.\mailslot\media-ckr
		$a_00_77 = {5c 5c 2e 5c 6d 61 69 6c 73 6c 6f 74 5c 6d 65 64 69 61 2d 72 6b 62 } //03 00  \\.\mailslot\media-rkb
		$a_00_78 = {5c 5c 2e 5c 6d 61 69 6c 73 6c 6f 74 5c 6d 65 64 69 61 2d 72 6b 73 } //03 00  \\.\mailslot\media-rks
		$a_00_79 = {5c 5c 2e 5c 6d 61 69 6c 73 6c 6f 74 5c 6d 65 64 69 61 2d 62 6c 61 63 6b 30 41 43 45 45 37 36 31 } //02 00  \\.\mailslot\media-black0ACEE761
		$a_00_80 = {5c 5c 2e 5c 6d 61 69 6c 73 6c 6f 74 5c 6d 65 64 69 61 2d 62 6c 61 63 6b } //02 00  \\.\mailslot\media-black
		$a_00_81 = {5c 5c 2e 5c 6d 61 69 6c 73 6c 6f 74 5c 6d 79 61 70 70 2d 6e 74 73 } //02 00  \\.\mailslot\myapp-nts
		$a_00_82 = {2d 2d 4a 55 53 54 5f 49 4e 53 54 41 4c 4c } //02 00  --JUST_INSTALL
		$a_00_83 = {2d 2d 52 45 50 4c 41 59 } //02 00  --REPLAY
		$a_00_84 = {2d 2d 42 45 5f 43 4f 4f 4c } //02 00  --BE_COOL
		$a_00_85 = {2d 2d 52 45 4d 4f 56 45 5f 4d 45 } //02 00  --REMOVE_ME
		$a_00_86 = {2d 2d 4e 54 2d 2d } //02 00  --NT--
		$a_00_87 = {3d 21 3d 25 3d 29 3d 2d 3d 31 3d 35 3d 39 3d 3d 3d 41 3d 45 3d 49 3d 4d 3d 51 3d 55 3d 59 3d 5d 3d 61 3d 65 3d 69 3d 6d 3d 71 3d 75 3d 79 3d 7d 3d } //01 00  =!=%=)=-=1=5=9===A=E=I=M=Q=U=Y=]=a=e=i=m=q=u=y=}=
		$a_00_88 = {43 72 65 61 74 65 4d 61 69 6c 53 6c 6f 74 } //02 00  CreateMailSlot
		$a_00_89 = {5c 5c 2e 5c 6d 61 69 6c 73 6c 6f 74 5c 74 75 66 68 6b 2d 6e 74 31 30 30 73 30 41 43 45 45 37 36 31 } //02 00  \\.\mailslot\tufhk-nt100s0ACEE761
		$a_00_90 = {5c 5c 2e 5c 6d 61 69 6c 73 6c 6f 74 5c 74 75 66 68 6b 2d 6e 74 31 30 30 73 } //02 00  \\.\mailslot\tufhk-nt100s
		$a_00_91 = {5c 5c 2e 5c 6d 61 69 6c 73 6c 6f 74 5c 74 75 66 68 6b 2d 6e 74 63 } //02 00  \\.\mailslot\tufhk-ntc
		$a_00_92 = {5c 5c 2e 5c 6d 61 69 6c 73 6c 6f 74 5c 74 75 66 68 6b 2d 6e 74 62 } //03 00  \\.\mailslot\tufhk-ntb
		$a_00_93 = {2d 3a 62 64 3a 2d } //02 00  -:bd:-
		$a_02_94 = {5c 5c 2e 5c 6d 61 69 6c 73 6c 6f 74 5c 90 01 05 2d 72 6b 73 90 00 } //02 00 
		$a_02_95 = {5c 5c 2e 5c 6d 61 69 6c 73 6c 6f 74 5c 90 01 05 2d 72 6b 62 90 00 } //02 00 
		$a_02_96 = {5c 5c 2e 5c 6d 61 69 6c 73 6c 6f 74 5c 90 01 05 2d 72 6b 63 90 00 } //02 00 
		$a_02_97 = {5c 5c 2e 5c 6d 61 69 6c 73 6c 6f 74 5c 90 01 05 2d 72 6b 31 30 30 73 90 00 } //02 00 
		$a_02_98 = {5c 5c 2e 5c 6d 61 69 6c 73 6c 6f 74 5c 90 01 08 31 30 30 73 90 00 } //02 00 
		$a_02_99 = {5c 5c 2e 5c 6d 61 69 6c 73 6c 6f 74 5c 90 02 06 2d 78 64 62 90 00 } //02 00 
		$a_02_100 = {5c 5c 2e 5c 6d 61 69 6c 73 6c 6f 74 5c 90 02 06 2d 78 64 63 90 00 } //02 00 
		$a_02_101 = {5c 5c 2e 5c 6d 61 69 6c 73 6c 6f 74 5c 90 02 06 2d 78 64 31 33 30 73 90 00 } //02 00 
		$a_02_102 = {5c 5c 2e 5c 6d 61 69 6c 73 6c 6f 74 5c 90 02 06 2d 78 64 31 33 30 73 41 42 43 44 90 00 } //02 00 
		$a_02_103 = {5c 5c 2e 5c 6d 61 69 6c 73 6c 6f 74 5c 90 02 06 62 63 62 90 00 } //02 00 
		$a_02_104 = {5c 5c 2e 5c 6d 61 69 6c 73 6c 6f 74 5c 90 02 06 62 63 63 90 00 } //00 00 
	condition:
		any of ($a_*)
