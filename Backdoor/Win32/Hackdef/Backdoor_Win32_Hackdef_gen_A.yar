...
rule Backdoor_Win32_Hackdef_gen_A{
	...
	strings :
		...
		$a_02_94 = {5c 5c 2e 5c 6d 61 69 6c 73 6c 6f 74 5c 90 01 05 2d 72 6b 73 90 00 } //2
		$a_02_95 = {5c 5c 2e 5c 6d 61 69 6c 73 6c 6f 74 5c 90 01 05 2d 72 6b 62 90 00 } //2
		$a_02_96 = {5c 5c 2e 5c 6d 61 69 6c 73 6c 6f 74 5c 90 01 05 2d 72 6b 63 90 00 } //2
		$a_02_97 = {5c 5c 2e 5c 6d 61 69 6c 73 6c 6f 74 5c 90 01 05 2d 72 6b 31 30 30 73 90 00 } //2
		$a_02_98 = {5c 5c 2e 5c 6d 61 69 6c 73 6c 6f 74 5c 90 01 08 31 30 30 73 90 00 } //2
		$a_02_99 = {5c 5c 2e 5c 6d 61 69 6c 73 6c 6f 74 5c 90 02 06 2d 78 64 62 90 00 } //2
		$a_02_100 = {5c 5c 2e 5c 6d 61 69 6c 73 6c 6f 74 5c 90 02 06 2d 78 64 63 90 00 } //2
		$a_02_101 = {5c 5c 2e 5c 6d 61 69 6c 73 6c 6f 74 5c 90 02 06 2d 78 64 31 33 30 73 90 00 } //2
		$a_02_102 = {5c 5c 2e 5c 6d 61 69 6c 73 6c 6f 74 5c 90 02 06 2d 78 64 31 33 30 73 41 42 43 44 90 00 } //2
		$a_02_103 = {5c 5c 2e 5c 6d 61 69 6c 73 6c 6f 74 5c 90 02 06 62 63 62 90 00 } //2
		$a_02_104 = {5c 5c 2e 5c 6d 61 69 6c 73 6c 6f 74 5c 90 02 06 62 63 63 90 00 } //2
	condition:
