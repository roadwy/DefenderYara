...
rule Backdoor_Win32_Simda_A{
	...
	strings :
		...
		$a_03_1 = {4b 85 db 75 90 01 01 bb 90 01 02 00 00 b8 90 01 04 8b cb ba 90 01 02 00 00 e8 90 01 04 4b 85 db 75 90 01 01 6a 00 90 00 } //1
	condition:
...
rule Backdoor_Win32_Simda_A_2{
	...
	strings :
		...
		$a_03_2 = {ff 4a f8 e8 90 01 04 5a 5f 5e 5b 58 8d 24 94 ff e0 c3 90 00 } //1
		$a_03_3 = {85 c0 7e 24 50 83 c0 0a 83 e0 fe 50 e8 90 01 04 5a 66 c7 44 02 fe 00 00 83 c0 08 5a 89 50 fc c7 40 f8 01 00 00 00 c3 90 00 } //1
