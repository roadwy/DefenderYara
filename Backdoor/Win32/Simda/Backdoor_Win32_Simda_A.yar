...
rule Backdoor_Win32_Simda_A_2{
	...
	strings :
		...
		$a_11_4 = {4c 67 47 30 30 43 30 30 30 30 34 30 30 30 30 2f 2f 79 30 30 42 57 30 30 30 30 30 30 30 30 30 47 30 30 30 30 30 30 30 30 30 30 30 30 30 30 30 00 } //00 7e 
	condition:
		any of ($a_*)
