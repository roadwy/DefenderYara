...
rule Backdoor_Win32_Simda_AT{
	...
	strings :
		...
		$a_01_1 = {43 6c 61 73 73 65 73 5c 53 55 50 45 52 41 6e 74 69 53 70 79 77 61 72 65 43 6f 6e 74 65 78 74 4d 65 6e 75 45 78 74 2e 53 41 53 43 6f 6e 2e 31 } //01 00 
		$a_01_2 = {57 69 6e 64 6f 77 73 5c 43 75 72 72 65 6e 74 56 65 72 73 69 6f 6e 5c 55 6e 69 6e 73 74 61 6c 6c 5c 45 52 55 4e 54 5f 69 73 31 } //01 00 
