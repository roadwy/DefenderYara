...
rule Backdoor_Win32_Nosrawec_B{
	...
	strings :
		$a_01_0 = {55 73 65 4e 61 67 6c 65 53 } //01 00  UseNagleS
		$a_01_1 = {54 72 61 6e 73 6d 69 74 46 69 6c 65 } //02 00  TransmitFile
		$a_01_2 = {77 69 6e 75 70 64 61 74 65 2e 62 61 74 } //02 00  winupdate.bat
