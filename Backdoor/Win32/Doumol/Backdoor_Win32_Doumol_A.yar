...
rule Backdoor_Win32_Doumol_A{
	...
	strings :
		$a_03_0 = {83 fe 03 74 05 80 fb 03 75 37 8b c3 e8 90 01 04 83 fa ff 75 03 83 f8 ff 74 26 90 00 } //1
		$a_03_1 = {8b c7 ba 06 00 00 00 e8 90 01 04 83 c3 24 4e 0f 85 65 ff ff ff 83 7d f4 00 0f 85 23 ff ff ff 90 00 } //1
