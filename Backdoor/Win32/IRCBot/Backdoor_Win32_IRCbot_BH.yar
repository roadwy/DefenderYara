...
rule Backdoor_Win32_IRCbot_BH{
	...
	strings :
		...
		$a_03_1 = {ff d7 85 c0 75 47 83 7d fc 02 77 41 ff 15 90 01 04 83 f8 05 74 0b ff 15 90 01 04 83 f8 20 75 1a ff d6 2b 45 f8 3d a0 86 01 00 73 0b 68 e8 03 00 00 90 00 } //5
		$a_03_2 = {7e 59 c7 45 08 90 01 02 40 00 8b 4d 08 66 8b 46 14 66 39 01 75 18 57 68 90 01 02 40 00 6a 02 57 66 89 47 10 89 5f 14 e8 90 01 02 00 00 83 c4 10 83 45 08 28 90 00 } //5
