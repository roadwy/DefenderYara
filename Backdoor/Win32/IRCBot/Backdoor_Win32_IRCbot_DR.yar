...
rule Backdoor_Win32_IRCbot_DR{
	...
	strings :
		$a_03_0 = {8b 45 f4 83 3c 85 18 ?? ?? ?? ?? 0f 84 ?? 00 00 00 83 65 fc 00 eb ?? 8b 45 fc 40 89 45 fc 8b 45 f4 ff 34 85 ?? ?? ?? ?? ff 15 } //2
		$a_01_1 = {8b 4d 08 03 4d f8 8b 55 fc 8a 04 10 32 01 8b 4d f4 } //2
		$a_03_2 = {8b 4d fc 0f be 04 08 f7 d0 8b 4d f4 8b 0c 8d ?? ?? ?? ?? 8b 55 fc 88 04 11 } //2
