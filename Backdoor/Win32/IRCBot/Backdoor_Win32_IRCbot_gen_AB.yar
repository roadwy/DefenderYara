...
rule Backdoor_Win32_IRCbot_gen_AB{
	...
	strings :
		...
		$a_03_1 = {85 c0 59 76 15 8a 83 90 01 02 40 00 55 30 04 3e 43 e8 90 01 02 00 00 3b d8 59 72 eb 90 00 } //1
		$a_03_2 = {59 39 45 f8 73 1b 8b 45 08 03 45 fc 8b 4d f8 8a 00 32 81 90 01 02 40 00 8b 4d 08 03 4d fc 88 01 eb ce 90 00 } //1
	condition:
