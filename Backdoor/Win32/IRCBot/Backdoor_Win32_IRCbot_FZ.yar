...
rule Backdoor_Win32_IRCbot_FZ{
	...
	strings :
		...
		$a_01_1 = {28 63 6f 6d 70 61 74 69 62 6c 65 3b 20 47 6f 6f 67 6c 65 62 6f 74 2f } //01 00 
		$a_01_2 = {3a 53 4c 4f 57 4c 4f 52 49 53 20 46 6c 6f 6f 64 20 41 63 74 69 76 61 74 65 64 21 } //01 00 
