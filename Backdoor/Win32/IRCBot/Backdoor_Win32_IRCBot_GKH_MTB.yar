...
rule Backdoor_Win32_IRCBot_GKH_MTB{
	...
	strings :
		...
		$a_01_1 = {63 2e 69 72 61 63 62 6c 61 72 6b 63 72 2e 64 65 74 } //01 00 
		$a_01_2 = {61 64 66 74 53 6f 72 65 77 61 69 63 5c 4d 73 6f 72 6f 5c 57 66 74 64 6f 69 6e 5c 43 77 73 72 65 75 72 56 65 6e 74 69 6f 72 73 52 75 6e 5c } //00 00 
	condition:
		any of ($a_*)
