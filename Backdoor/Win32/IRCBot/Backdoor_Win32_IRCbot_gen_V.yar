...
rule Backdoor_Win32_IRCbot_gen_V{
	...
	strings :
		...
		$a_03_1 = {62 74 3e 8d 45 08 50 ff 15 ?? ?? ?? ?? 83 f8 02 75 2f } //2
		$a_03_2 = {55 30 04 3e 43 e8 ?? ?? ?? ?? 3b d8 59 72 eb } //2
		$a_03_3 = {7e 72 56 8d 45 ?? 6a 28 50 ff 75 ?? 89 75 ?? 89 5d ?? ff 75 ?? ff 15 ?? ?? ?? ?? ff 75 ?? ff 75 ?? 68 2d 10 00 00 ff 75 ?? ff 15 } //2
