...
rule Backdoor_Win32_IRCbot_FH{
	...
	strings :
		$a_03_0 = {eb ee fe 45 90 01 01 80 7d 90 01 01 5b 0f 85 90 00 } //1
		$a_03_1 = {6a 05 8d 44 24 04 50 6a 5a 68 00 04 00 00 e8 90 01 04 83 f8 03 90 00 } //1
		$a_03_2 = {83 c3 04 4e 75 d7 8b 90 09 23 00 6a 00 6a 01 6a 02 90 00 } //1
