...
rule Backdoor_Win32_IRCBot_HL{
	...
	strings :
		...
		$a_01_2 = {20 3a 20 75 70 6c 6f 61 64 20 6f 6b } //01 00   : upload ok
		$a_01_3 = {5c 55 73 65 72 73 5c 41 63 63 6f 75 6e 74 73 2e 63 66 67 } //01 00  \Users\Accounts.cfg
		$a_01_4 = {5c 77 65 62 6d 6f 6e 65 79 5c } //00 00  \webmoney\
