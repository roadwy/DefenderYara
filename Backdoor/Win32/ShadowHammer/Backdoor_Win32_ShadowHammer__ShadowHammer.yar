...
rule Backdoor_Win32_ShadowHammer__ShadowHammer{
	...
	strings :
		$a_03_0 = {da b6 ac e6 c7 90 02 05 c2 5c 37 99 90 00 } //10
		$a_03_1 = {59 77 ba a3 c7 90 02 05 f8 ce 0c a1 90 00 } //10
		$a_03_2 = {ad e6 2a 25 c7 90 02 05 7a df 11 84 90 00 } //10
	condition:
