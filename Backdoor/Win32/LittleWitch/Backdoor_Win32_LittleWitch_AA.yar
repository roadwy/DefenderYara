...
rule Backdoor_Win32_LittleWitch_AA{
	...
	strings :
		...
		$a_01_3 = {45 78 70 6c 6f 72 65 57 43 6c 61 73 73 } //01 00 
		$a_01_4 = {4d 53 4e 00 } //01 00 
		$a_01_5 = {56 45 52 4c 57 53 45 52 56 45 52 36 } //01 00 
		$a_01_6 = {50 41 53 53 57 4f 52 44 43 41 48 59 4e 41 } //01 00 
		$a_01_7 = {6c 69 74 74 6c 65 77 69 74 63 68 } //01 00 
		$a_01_8 = {4e 69 63 6b 6e 61 6d 65 } //01 00 
		$a_01_9 = {57 41 52 4e 49 4e 47 } //00 00 
	condition:
		any of ($a_*)
