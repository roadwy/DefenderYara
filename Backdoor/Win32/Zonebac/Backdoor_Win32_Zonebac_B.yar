...
rule Backdoor_Win32_Zonebac_B{
	meta:
		description = "Backdoor:Win32/Zonebac.B,SIGNATURE_TYPE_PEHSTR,2d 00 28 00 37 00 00 01 00 "
	...
	strings :
		...
		$a_01_4 = {69 65 78 70 6c 6f 72 65 2e 65 78 65 20 20 68 74 74 70 3a 2f 2f 25 73 2f 64 63 2f 25 64 2f 25 64 2f 25 64 2f 25 64 2f 25 64 2f 68 74 6d 6c 25 64 2e 68 74 6d 6c } //01 00  iexplore.exe  http://%s/dc/%d/%d/%d/%d/%d/html%d.html
		...
		$a_01_54 = {6f 61 73 63 6c 6e 74 2e 65 78 65 } //00 00  oasclnt.exe
	condition:
		any of ($a_*)
