...
rule Backdoor_Win32_Trochil_A_{
	meta:
		description = "Backdoor:Win32/Trochil.A!!Trochil.A.dll!dha,SIGNATURE_TYPE_ARHSTR_EXT,05 00 05 00 2e 00 00 01 00 "
	...
	strings :
		...
		$a_80_45 = {58 4c 53 65 72 76 61 6e 74 } //XLServant  0a 00 
	condition:
		any of ($a_*)
