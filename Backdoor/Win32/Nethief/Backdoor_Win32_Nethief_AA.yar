...
rule Backdoor_Win32_Nethief_AA{
	...
	strings :
		$a_02_0 = {83 c9 ff 33 c0 83 c4 08 f2 ae f7 d1 2b f9 6a 00 8b c1 8b f7 8b fa 68 80 00 00 00 c1 e9 02 f3 a5 8b c8 6a 03 83 e1 03 6a 00 f3 a4 6a 01 8d 8c 24 8c 90 01 03 68 00 00 00 80 51 90 00 } //10
