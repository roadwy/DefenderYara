...
rule Backdoor_Win32_Nethief_AA_dll{
	...
	strings :
		$a_00_0 = {69 69 70 43 6f 6e 6e 65 63 74 53 65 72 76 65 72 } //0a 00 
		$a_00_1 = {49 49 50 43 6c 69 65 6e 74 2e 64 6c 6c } //0a 00 
		$a_00_2 = {69 69 70 49 6e 73 74 61 6c 6c 43 61 6c 6c 62 61 63 } //01 00 
