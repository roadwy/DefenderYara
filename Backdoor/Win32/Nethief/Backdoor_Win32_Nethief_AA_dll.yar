...
rule Backdoor_Win32_Nethief_AA_dll{
	...
	strings :
		...
		$a_02_3 = {c7 46 04 01 00 00 00 89 08 8b 4c 24 18 89 50 04 8b 54 24 1c 89 48 08 8b 4c 24 20 89 50 0c 8b 44 24 24 8b 54 24 0c 50 51 52 ff 15 90 01 04 83 c4 10 90 00 } //1
		$a_02_4 = {8b 4e 1c 8b 56 18 51 8b 4c 24 2c 52 8b 54 24 2c 51 8b 4c 24 2c 52 51 53 8b c8 e8 90 01 04 b8 01 00 00 00 8b 4c 24 0c 64 89 0d 00 00 00 00 5f 5e 5b 83 c4 0c 90 00 } //1
	condition:
