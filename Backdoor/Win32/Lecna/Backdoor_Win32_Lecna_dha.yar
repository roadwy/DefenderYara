...
rule Backdoor_Win32_Lecna_dha{
	...
	strings :
		...
		$a_01_2 = {55 73 65 72 2d 41 67 65 6e 74 3a 20 53 4a 5a 4a 20 28 63 6f 6d 70 61 74 69 62 6c 65 3b 20 4d 53 49 45 20 36 2e 30 3b 20 57 69 6e 33 32 29 } //00 00  User-Agent: SJZJ (compatible; MSIE 6.0; Win32)
		$a_00_3 = {80 10 } //00 00 
	condition:
		any of ($a_*)
