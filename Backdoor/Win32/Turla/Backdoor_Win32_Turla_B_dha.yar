...
rule Backdoor_Win32_Turla_B_dha{
	...
	strings :
		...
		$a_03_1 = {8b 04 24 8b 4c 24 08 83 e9 04 0f 84 90 01 04 83 e9 01 74 5a 83 e9 01 75 c3 8b 4c 24 0c 83 e9 00 74 36 83 e9 01 74 1b 83 e9 01 75 b0 f7 d8 90 00 } //1
	condition:
