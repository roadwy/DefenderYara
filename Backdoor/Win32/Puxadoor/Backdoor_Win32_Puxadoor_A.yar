...
rule Backdoor_Win32_Puxadoor_A{
	...
	strings :
		...
		$a_03_4 = {be 08 00 00 00 83 c4 0c 8d 95 54 fd ff ff 8d 8d 84 fd ff ff c7 85 5c fd ff ff 90 01 03 00 89 b5 54 fd ff ff ff 15 90 01 03 00 8d 85 84 fd ff ff 8d 8d 74 fd ff ff 50 51 ff 15 90 01 03 00 90 00 } //2
	condition:
