...
rule Backdoor_Win32_Puxadoor_A{
	...
	strings :
		$a_00_0 = {70 00 75 00 78 00 61 00 73 00 69 00 73 00 74 00 65 00 6d 00 61 00 } //01 00 
		$a_01_1 = {70 75 78 61 64 6f 72 } //02 00 
		$a_01_2 = {56 65 72 69 66 69 63 61 72 41 70 6c 69 63 61 74 69 76 6f } //02 00 
