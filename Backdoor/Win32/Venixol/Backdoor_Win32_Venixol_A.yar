...
rule Backdoor_Win32_Venixol_A{
	...
	strings :
		$a_01_0 = {73 00 63 00 68 00 74 00 61 00 73 00 6b 00 73 00 2e 00 65 00 78 00 65 00 20 00 2f 00 64 00 65 00 6c 00 65 00 74 00 65 00 20 00 2f 00 66 00 20 00 2f 00 74 00 6e 00 20 00 58 00 4d 00 4c 00 52 00 50 00 43 00 53 00 52 00 56 00 33 00 } //32 00 
		...
		$a_01_6 = {58 33 4e 31 63 47 56 79 58 32 4e 7a 62 54 70 36 64 47 55 6b 4e 7a 51 78 4e 54 63 77 4f 47 46 32 62 47 6c 7a } //1e 00 
		$a_01_7 = {56 45 4e 49 58 33 4e 31 63 47 56 79 58 32 4e 7a 62 54 70 36 64 47 55 6b 4e 7a 51 78 4e 54 63 77 4f 47 46 32 62 47 6c 7a } //1e 00 
		$a_01_8 = {59 57 52 74 61 57 34 36 63 47 46 7a 63 33 64 76 63 6d 51 3d } //1e 00 
		$a_01_9 = {4d 54 49 7a 4e 44 6f 78 4d 6a 4d 30 } //14 00 
