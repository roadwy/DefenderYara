...
rule Backdoor_Win32_Venixol_B{
	...
	strings :
		...
		$a_01_11 = {59 57 52 74 61 57 34 36 } //14 00 
		$a_01_12 = {56 45 4e 49 58 33 4e 31 63 47 56 79 58 32 4e 7a 62 54 70 36 64 47 55 6b 4e 7a 51 78 4e 54 63 77 4f 47 46 32 62 47 6c 7a } //00 00 
