...
rule Backdoor_Win32_Turkojan_C{
	...
	strings :
		$a_00_0 = {44 6f 73 79 61 20 62 75 6c 75 6e 61 6d 61 64 } //01 00 
		$a_00_1 = {5b 43 41 50 53 20 4c 4f 43 4b 5d } //01 00 
		$a_00_2 = {5b 46 74 70 2f 49 45 2f 46 69 72 65 66 6f 78 2f 4f 75 74 6c 6f 6f 6b 20 50 61 73 73 77 6f 72 64 73 5d } //01 00 
		$a_00_3 = {5b 49 4d 20 50 61 73 73 77 6f 72 64 73 5d } //01 00 
		$a_00_4 = {57 42 43 41 4d 23 23 23 } //01 00 
		$a_00_5 = {4e 75 6d 4c 6f 63 6b 20 44 75 72 75 6d 75 20 3a } //0a 00 
