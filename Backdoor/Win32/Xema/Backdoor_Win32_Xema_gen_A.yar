...
rule Backdoor_Win32_Xema_gen_A{
	...
	strings :
		$a_02_0 = {ba 01 00 00 80 8b 90 01 01 e8 90 01 03 ff b1 01 ba 90 01 04 8b 90 01 01 e8 90 01 03 ff b9 90 01 04 ba 90 01 04 8b 90 00 } //100
		$a_02_1 = {ba 02 00 00 80 8b 90 01 01 e8 90 01 03 ff b1 01 ba 90 01 04 8b 90 01 01 e8 90 01 03 ff b9 90 01 04 ba 90 01 04 8b 90 00 } //100
