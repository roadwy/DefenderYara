...
rule Backdoor_Win32_Coolvidoor_D{
	...
	strings :
		...
		$a_02_1 = {43 6f 6f 6c 90 02 03 73 65 72 76 65 72 90 00 } //3
		...
		$a_02_11 = {3c 47 45 54 46 49 4c 45 53 3e 90 02 0c 3c 4c 49 53 54 4f 46 46 49 4c 45 53 3e 90 02 0c 4c 49 53 54 41 52 53 45 52 56 49 43 49 4f 53 90 00 } //7
	condition:
