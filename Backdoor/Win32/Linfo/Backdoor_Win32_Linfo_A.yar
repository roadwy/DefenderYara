...
rule Backdoor_Win32_Linfo_A_2{
	...
	strings :
		$a_01_0 = {25 73 5c 73 6d 65 72 70 30 2e 64 62 6c } //01 00  %s\smerp0.dbl
		$a_01_1 = {50 4f 53 54 20 68 74 74 70 3a 2f 2f 25 73 3a 25 73 2f 62 6b 73 2e 61 73 70 } //01 00  POST http://%s:%s/bks.asp
