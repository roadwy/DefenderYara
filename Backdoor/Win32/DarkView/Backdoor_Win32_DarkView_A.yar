...
rule Backdoor_Win32_DarkView_A{
	...
	strings :
		...
		$a_00_3 = {25 64 65 73 6b 74 6f 70 25 00 } //01 00 
		$a_00_4 = {25 6f 77 6e 64 61 74 61 25 00 } //01 00 
		$a_00_5 = {25 73 79 73 74 65 6d 72 6f 6f 74 25 00 } //01 00 
		$a_00_6 = {25 73 79 73 74 65 6d 33 32 25 00 } //01 00 
		$a_00_7 = {5c 53 68 65 6c 6c 5c 4f 70 65 6e 5c 43 6f 6d 6d 61 6e 64 00 } //00 00 
	condition:
		any of ($a_*)
