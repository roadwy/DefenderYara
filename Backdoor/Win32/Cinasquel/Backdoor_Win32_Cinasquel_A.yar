...
rule Backdoor_Win32_Cinasquel_A{
	...
	strings :
		...
		$a_03_2 = {25 74 65 6d 70 5c 74 6d 70 90 02 05 5c 90 02 10 2e 65 78 65 90 00 } //2
		...
		$a_03_8 = {8b 84 24 b0 00 00 00 83 e8 04 90 02 10 48 74 90 01 01 48 8d 54 24 48 90 00 } //10
	condition:
