...
rule Backdoor_Win32_Cinasquel_A{
	...
	strings :
		$a_01_0 = {78 70 64 6c 33 5f 69 6e 69 74 } //02 00 
		...
		$a_01_3 = {70 00 69 00 72 00 65 00 73 00 73 00 } //02 00 
		$a_01_4 = {61 00 64 00 6d 00 69 00 6e 00 6c 00 76 00 31 00 32 00 33 00 } //02 00 
		$a_01_5 = {6d 79 73 71 6c 2e 64 6c 6c 00 78 70 64 6c 33 } //0a 00 
		$a_01_6 = {83 e8 04 74 3e 48 74 0e 48 8d 54 24 48 75 43 } //02 00 
		$a_01_7 = {28 25 73 29 20 70 6f 72 74 6e 75 6d 62 65 72 20 28 25 64 29 20 6f 73 76 65 72 73 69 6f 6e 20 28 25 73 29 } //0a 00 
