...
rule Backdoor_Win32_Midie_A_MTB{
	...
	strings :
		...
		$a_00_1 = {47 65 74 46 69 72 6d 77 61 72 65 45 6e 76 69 72 6f 6e 6d 65 6e 74 56 61 72 69 61 62 6c 65 57 } //01 00 
		$a_00_2 = {53 43 61 72 64 45 73 74 61 62 6c 69 73 68 43 6f 6e 74 65 78 74 } //0a 00 
