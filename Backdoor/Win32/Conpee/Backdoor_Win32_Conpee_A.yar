...
rule Backdoor_Win32_Conpee_A{
	...
	strings :
		$a_01_0 = {50 65 65 72 43 6f 6e 6e 5e 5f 5e 4d 65 32 } //01 00  PeerConn^_^Me2
...
rule Backdoor_Win32_Conpee_A_2{
	...
	strings :
		...
		$a_01_1 = {3c 72 65 6d 6f 74 65 66 69 6c 65 3e 20 3c 6c 6f 63 61 6c 66 69 6c 65 3e } //01 00  <remotefile> <localfile>
		$a_01_2 = {50 6c 75 67 4d 67 72 5f 52 65 67 69 73 74 65 72 43 6f 6d 6d 61 6e 64 } //01 00  PlugMgr_RegisterCommand
		$a_01_3 = {69 69 73 67 65 74 64 69 72 } //00 00  iisgetdir
	condition:
		any of ($a_*)
...
rule Backdoor_Win32_Conpee_A_3{
	...
	strings :
		...
		$a_01_1 = {69 69 73 70 75 74 } //01 00  iisput
		$a_01_2 = {69 69 73 67 65 74 } //01 00  iisget
		$a_01_3 = {70 65 65 72 5f 70 6c 75 67 69 6e 5f 6d 61 69 6e } //00 00  peer_plugin_main
	condition:
		any of ($a_*)
