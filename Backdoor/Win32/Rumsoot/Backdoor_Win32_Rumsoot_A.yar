...
rule Backdoor_Win32_Rumsoot_A{
	...
	strings :
		...
		$a_00_4 = {5c 70 72 6f 6a 65 63 74 73 5c 63 76 73 5f 70 6f 72 74 5c 70 6f 72 74 5c 74 6f 6f 6c 73 5c 6c 6f 61 64 65 72 5f 6f 75 72 5c 42 69 6e 5c 69 33 38 36 5c 61 5f 6c 6f 61 64 65 72 2e 70 64 62 } //1 \projects\cvs_port\port\tools\loader_our\Bin\i386\a_loader.pdb
	condition:
