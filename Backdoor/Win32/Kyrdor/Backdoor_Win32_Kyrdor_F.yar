...
rule Backdoor_Win32_Kyrdor_F{
	...
	strings :
		$a_02_0 = {43 3a 5c 57 49 4e 44 4f 57 53 5c 53 59 53 54 45 4d 33 32 5c 90 02 08 2e 65 78 65 90 00 } //10
		$a_02_1 = {43 3a 5c 57 49 4e 44 4f 57 53 5c 53 59 53 54 45 4d 33 32 5c 90 02 08 2e 64 6c 6c 90 00 } //10
