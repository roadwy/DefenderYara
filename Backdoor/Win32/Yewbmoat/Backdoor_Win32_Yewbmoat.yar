...
rule Backdoor_Win32_Yewbmoat{
	...
	strings :
		...
		$a_00_4 = {6b 69 6c 6c 5f 62 65 67 69 6e } //01 00 
		$a_00_5 = {6b 69 6c 6c 5f 65 6e 64 } //01 00 
		$a_00_6 = {64 65 6c 65 74 65 5f 62 65 67 69 6e } //01 00 
		$a_00_7 = {64 65 6c 65 74 65 5f 65 6e 64 } //01 00 
		$a_00_8 = {26 73 74 61 74 75 73 3d 31 26 76 65 72 73 69 6f 6e 3d } //01 00 
		$a_00_9 = {75 73 72 73 76 70 69 61 2e 69 6e 69 } //00 00 
	condition:
		any of ($a_*)
