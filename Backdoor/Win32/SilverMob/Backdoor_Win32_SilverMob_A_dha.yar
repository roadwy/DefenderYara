...
rule Backdoor_Win32_SilverMob_A_dha{
	...
	strings :
		$a_03_0 = {b2 c0 50 51 c6 44 24 0c 90 02 05 c6 44 24 0e 90 01 01 c6 44 24 0f 90 01 01 c6 44 24 11 90 01 01 c6 44 24 12 90 01 01 c6 44 24 14 90 01 01 c6 44 24 15 90 01 01 c6 44 24 16 90 02 05 c6 44 24 18 90 01 01 c6 44 24 19 90 01 01 c6 44 24 1a 90 01 01 c6 44 24 1b 90 01 01 e8 90 03 05 06 90 01 04 33 c0 90 01 04 83 c4 1c 90 00 } //20
		$a_03_1 = {33 d2 8a 91 90 01 04 ff 24 95 90 01 04 8b 44 24 08 50 e8 90 01 02 00 00 83 c4 04 c3 90 00 } //10
