...
rule Backdoor_Win32_Tapazom_A{
	...
	strings :
		...
		$a_00_10 = {80 10 00 00 93 7a 29 7b 42 a4 07 fe c9 c1 d9 a9 00 10 00 80 5d 04 00 00 5e ca 02 80 5c 20 00 00 5f ca 02 80 00 00 01 00 06 00 0a 00 84 21 46 61 72 66 6c 69 2e 5a 00 00 01 40 05 82 42 00 04 00 78 4f 00 00 08 00 } //08 00 
	condition:
		any of ($a_*)
