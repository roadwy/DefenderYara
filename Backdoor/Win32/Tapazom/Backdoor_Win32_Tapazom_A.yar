...
rule Backdoor_Win32_Tapazom_A{
	...
	strings :
		...
		$a_01_2 = {6d 7a 6f 2e 68 6f 70 74 6f 2e 6f 72 67 3a } //1e 00 
		$a_01_3 = {89 45 e8 89 55 ec 83 7d ec 00 75 08 83 7d e8 00 77 bc eb 02 7f b8 84 db 74 0b 57 e8 } //14 00 
		$a_00_4 = {2d 63 6f 72 65 } //14 00 
		$a_01_5 = {43 61 72 76 69 65 72 } //0a 00 
		$a_01_6 = {73 79 74 65 6d 33 32 2e 64 6c 6c } //0a 00 
		$a_01_7 = {7b 31 32 46 34 38 38 38 31 2d 46 46 36 44 2d 34 33 41 31 2d 42 38 30 42 2d 39 32 36 35 43 32 35 43 43 39 46 36 7d 5c } //0a 00 
