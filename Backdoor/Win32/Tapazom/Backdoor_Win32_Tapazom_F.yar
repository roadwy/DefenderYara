...
rule Backdoor_Win32_Tapazom_F{
	...
	strings :
		...
		$a_01_2 = {6d 6d 7a 6f 2e 64 79 6e 64 6e 73 2e 6f 72 67 3a 31 31 34 33 } //32 00  mmzo.dyndns.org:1143
		$a_01_3 = {0b 49 6e 63 6c 6f 75 64 2e 65 78 65 } //14 00  䤋据潬摵攮數
		$a_01_4 = {48 49 44 2d 44 65 76 69 63 65 } //14 00  HID-Device
		$a_01_5 = {6d 7a 73 72 36 34 2e 64 6c 6c } //00 00  mzsr64.dll
