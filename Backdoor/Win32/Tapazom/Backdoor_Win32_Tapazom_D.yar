...
rule Backdoor_Win32_Tapazom_D{
	...
	strings :
		...
		$a_01_2 = {6d 7a 6f 2e 68 6f 70 74 6f 2e 6f 72 67 3a 31 34 33 31 } //32 00 
		$a_01_3 = {2d 4d 75 6c 74 69 63 6f 72 65 2e 65 78 65 } //14 00 
		$a_01_4 = {43 61 72 76 69 65 72 } //0a 00 
		$a_01_5 = {64 6f 74 33 64 6c 78 65 2e 64 6c 6c } //00 00 
