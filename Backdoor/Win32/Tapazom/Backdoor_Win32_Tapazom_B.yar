...
rule Backdoor_Win32_Tapazom_B{
	...
	strings :
		...
		$a_01_1 = {6d 6d 7a 6f 2e 64 79 6e 64 6e 73 2e 6f 72 67 3a 31 34 33 31 } //32 00 
		$a_01_2 = {43 61 72 76 69 65 72 } //1e 00 
		$a_01_3 = {07 49 6e 66 2e 65 78 65 08 55 74 69 6c 69 74 79 } //1e 00 
		$a_01_4 = {16 48 49 44 2d 49 6e 74 65 72 66 61 63 65 73 20 44 65 76 69 63 65 ae 00 } //0a 00 
		$a_01_5 = {75 74 69 6c 69 2e 65 78 65 } //0a 00 
		$a_01_6 = {77 69 64 2e 64 6c 6c } //00 00 
