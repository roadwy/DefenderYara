...
rule Backdoor_Win32_Rmtsvc_C_bit{
	...
	strings :
		...
		$a_03_2 = {73 65 6e 64 69 6e 67 90 02 10 2e 6a 70 67 90 00 } //1
		...
		$a_03_4 = {6a 40 68 00 10 00 00 53 6a 00 55 ff 15 90 01 04 8b f0 85 f6 0f 84 90 00 } //1
		$a_03_5 = {6a 00 6a 00 56 53 6a 00 6a 00 55 ff 15 90 01 04 8b d8 85 db 74 90 00 } //1
	condition:
