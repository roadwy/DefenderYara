...
rule Backdoor_Win32_Kreen_dha{
	...
	strings :
		...
		$a_03_6 = {c6 43 4b 22 8b 15 ?? ?? ?? ?? 89 53 4c a1 ?? ?? ?? ?? 8b b5 ec fe ff ff 89 43 50 8b 0d ?? ?? ?? ?? 89 4b 54 8b 15 ?? ?? ?? ?? 89 53 58 a1 ?? ?? ?? ?? 8b 95 43 ff ff ff 89 43 5c 66 8b 0d 20 10 07 10 8b 85 47 ff ff ff 66 89 4b 60 8b 8d 4b ff ff ff c6 43 62 22 89 53 63 66 8b 95 4f ff ff ff 89 43 67 89 4b 6b 8b c6 66 89 53 6f 83 c4 20 c6 43 71 22 } //5
