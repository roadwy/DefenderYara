...
rule Backdoor_Win32_Hupigon_EE{
	...
	strings :
		$a_01_0 = {44 00 65 00 76 00 69 00 63 00 65 00 5c 00 50 00 68 00 79 00 73 00 69 00 63 00 61 00 6c 00 4d 00 65 00 6d 00 6f 00 72 00 79 00 } //01 00 
		...
		$a_01_3 = {69 6e 66 6f 3a 53 68 65 6c 6c 20 43 6f 64 65 } //00 00 
	condition:
		any of ($a_*)
