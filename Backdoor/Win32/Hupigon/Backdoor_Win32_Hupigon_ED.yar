...
rule Backdoor_Win32_Hupigon_ED{
	...
	strings :
		...
		$a_01_1 = {44 65 76 69 63 65 5c 50 68 79 73 69 63 61 6c 4d 65 6d } //02 00 
		$a_01_2 = {28 57 69 6e 44 69 72 29 5c 33 36 30 2e 63 6f 6d } //01 00 
		$a_01_3 = {64 65 6c 20 25 30 } //01 00 
