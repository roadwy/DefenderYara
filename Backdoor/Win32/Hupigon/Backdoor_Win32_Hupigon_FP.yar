...
rule Backdoor_Win32_Hupigon_FP{
	...
	strings :
		$a_00_0 = {6b 76 6d 6f 6e 78 70 2e 6b 78 70 } //01 00  kvmonxp.kxp
		$a_00_1 = {6b 2d 6d 65 6c 65 6f 6e 2e 65 78 65 } //01 00  k-meleon.exe
		$a_00_2 = {6b 77 61 74 63 68 75 69 2e 65 78 65 } //01 00  kwatchui.exe
