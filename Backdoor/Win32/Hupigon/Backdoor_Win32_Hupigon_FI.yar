...
rule Backdoor_Win32_Hupigon_FI{
	...
	strings :
		$a_01_0 = {67 52 41 59 70 49 47 45 4f 4e } //01 00  gRAYpIGEON
		$a_01_1 = {50 4f 73 43 52 45 45 4e 63 45 4e 54 45 52 } //01 00  POsCREENcENTER
		$a_01_2 = {6f 4e 6b 45 59 64 4f 57 4e } //01 00  oNkEYdOWN
		$a_01_3 = {61 55 54 6c 4f 47 49 4e 74 63 70 63 4c 49 45 4e 54 } //00 00  aUTlOGINtcpcLIENT
	condition:
		any of ($a_*)
...
rule Backdoor_Win32_Hupigon_FI_2{
	...
	strings :
		...
		$a_00_1 = {5c 44 65 76 69 63 65 5c 50 68 79 73 69 63 61 6c 4d 65 6d 6f 72 79 } //01 00  \Device\PhysicalMemory
