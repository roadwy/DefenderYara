...
rule Backdoor_Win32_Hupigon_YB{
	meta:
		description = "Backdoor:Win32/Hupigon.YB,SIGNATURE_TYPE_PEHSTR_EXT,ffffffcd 0f ffffffbe 0f 1d 00 00 "
	...
	strings :
		...
		$a_00_24 = {eb f0 5f 5e 5b 59 59 5d c2 08 00 00 ff ff ff ff 1a 00 00 00 71 77 65 72 74 79 75 69 6f 70 61 73 64 66 67 68 6a 6b 6c 7a 78 63 76 62 6e 6d 00 00 55 8b ec 81 c4 04 f0 ff ff 50 81 c4 28 ff ff ff } //1000
		$a_00_25 = {0e 0b 54 47 55 49 5f 53 54 52 49 4e 47 0d 00 00 00 03 00 00 00 00 } //1000
		$a_01_26 = {4b 4b 74 69 53 53 36 } //5 KKtiSS6
		$a_01_27 = {65 65 4b 5c 5a } //5 eeK\Z
		$a_01_28 = {5e 5e 78 66 5a 5a 5c 4b 65 65 58 4e 62 62 } //5 ^^xfZZ\KeeXNbb
	condition:
		((#a_01_0  & 1)*1+(#a_01_1  & 1)*1+(#a_01_2  & 1)*1+(#a_01_3  & 1)*1+(#a_01_4  & 1)*1+(#a_01_5  & 1)*1+(#a_01_6  & 1)*1+(#a_01_7  & 1)*2+(#a_01_8  & 1)*4+(#a_01_9  & 1)*2+(#a_01_10  & 1)*1+(#a_01_11  & 1)*1+(#a_01_12  & 1)*1+(#a_01_13  & 1)*1+(#a_01_14  & 1)*1+(#a_01_15  & 1)*1+(#a_01_16  & 1)*2+(#a_01_17  & 1)*1+(#a_01_18  & 1)*1+(#a_01_19  & 1)*2+(#a_01_20  & 1)*2+(#a_01_21  & 1)*1+(#a_00_22  & 1)*1000+(#a_00_23  & 1)*1000+(#a_00_24  & 1)*1000+(#a_00_25  & 1)*1000+(#a_01_26  & 1)*5+(#a_01_27  & 1)*5+(#a_01_28  & 1)*5) >=4030
