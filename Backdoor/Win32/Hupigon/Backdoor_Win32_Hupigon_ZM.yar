...
rule Backdoor_Win32_Hupigon_ZM{
	...
	strings :
		...
		$a_01_1 = {43 3a 5c 52 65 67 52 75 6e 2e 72 65 67 } //01 00  C:\RegRun.reg
		...
		$a_00_6 = {43 68 61 6e 67 65 53 65 72 76 69 63 65 43 6f 6e 66 69 67 32 41 } //00 00  ChangeServiceConfig2A
	condition:
		any of ($a_*)
