...
rule Backdoor_Win32_Hupigon_CK{
	...
	strings :
		$a_01_0 = {50 61 73 73 69 76 65 20 4d 6f 64 65 20 28 31 32 37 2c 30 2c 30 2c 31 2c 25 64 2c 25 64 29 } //01 00 
		$a_01_1 = {54 50 69 67 65 6f 6e 53 65 72 76 69 63 65 } //01 00 
		$a_01_2 = {5b 50 61 67 65 44 6f 77 6e 5d } //01 00 
		$a_01_3 = {50 69 67 65 6f 6e 5f 56 49 50 5f } //01 00 
		$a_01_4 = {54 56 69 64 65 6f 43 61 70 } //01 00 
		$a_01_5 = {50 58 46 32 30 30 30 2e 76 69 63 70 2e 6e 65 74 3a 38 30 38 30 } //01 00 
		$a_01_6 = {57 69 6e 64 6f 77 73 5f 72 65 6a 6f 69 63 65 } //03 00 
