...
rule Backdoor_Win32_Toyecma_A_dha{
	...
	strings :
		...
		$a_03_3 = {0f b6 59 01 88 1c 08 0f b6 19 fe cb 88 5c 37 01 83 c6 02 83 c1 02 3b f2 7e 90 01 01 8b 90 01 02 8b 90 01 02 8b c3 25 01 00 00 80 79 90 01 01 48 83 c8 fe 40 90 00 } //1
	condition:
