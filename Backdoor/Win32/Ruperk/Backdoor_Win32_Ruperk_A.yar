...
rule Backdoor_Win32_Ruperk_A{
	...
	strings :
		...
		$a_03_5 = {83 c0 01 89 45 f0 74 57 6a 05 8d 4d e0 51 e8 90 01 04 83 c4 08 8d 55 e0 52 68 90 01 04 ff 15 90 01 04 89 45 f0 83 7d f0 00 74 31 68 90 01 04 8d 45 e0 50 68 90 01 04 e8 90 01 04 83 c4 0c 89 45 f0 83 7d f0 00 74 12 68 90 00 } //10
	condition:
