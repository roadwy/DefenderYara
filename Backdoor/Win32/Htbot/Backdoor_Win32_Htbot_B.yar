...
rule Backdoor_Win32_Htbot_B{
	...
	strings :
		...
		$a_00_1 = {3f 00 63 00 6f 00 6d 00 6d 00 61 00 6e 00 64 00 3d 00 67 00 65 00 74 00 62 00 61 00 63 00 6b 00 63 00 6f 00 6e 00 6e 00 65 00 63 00 74 00 } //00 00  ?command=getbackconnect
	condition:
		any of ($a_*)
