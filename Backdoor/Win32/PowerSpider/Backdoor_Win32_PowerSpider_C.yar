...
rule Backdoor_Win32_PowerSpider_C{
	...
	strings :
		$a_03_0 = {6c 6f 63 61 6c 69 70 3d [0-07] 64 6e 73 33 3d } //1
		...
		$a_02_5 = {50 61 73 73 77 6f 72 64 32 [0-05] 53 6f 66 74 77 61 72 65 5c 4d 69 63 72 6f 73 6f 66 74 5c 49 6e 74 65 72 6e 65 74 20 41 63 63 6f 75 6e 74 20 4d 61 6e 61 67 65 72 5c 41 63 63 6f 75 6e 74 73 5c 25 30 38 64 [0-05] 5c 61 70 70 5c 45 6e 74 65 72 4e 65 74 2e 69 6e 69 } //1
