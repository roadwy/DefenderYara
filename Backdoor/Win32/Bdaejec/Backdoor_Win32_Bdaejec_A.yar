...
rule Backdoor_Win32_Bdaejec_A{
	...
	strings :
		$a_01_0 = {5c 5c 2e 5c 69 61 53 74 6f 72 79 00 } //01 00 
		$a_01_1 = {49 6e 66 6f 72 74 6d 70 2e 74 78 74 00 } //01 00 
		$a_01_2 = {44 6f 77 6e 4c 6f 61 64 4c 69 73 74 3a 00 } //01 00 
		$a_01_3 = {49 44 3d 25 73 26 66 6e 3d 25 73 5f 25 73 26 56 61 72 3d 25 2e 38 58 00 } //01 00 
