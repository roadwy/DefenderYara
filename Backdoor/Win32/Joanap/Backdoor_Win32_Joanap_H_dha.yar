...
rule Backdoor_Win32_Joanap_H_dha{
	...
	strings :
		$a_00_0 = {25 73 62 00 25 73 5c 53 79 73 57 4f 57 36 34 00 } //01 00 
		$a_00_1 = {00 56 42 6f 78 48 6f 6f 6b 4e 6f 74 69 66 79 45 76 65 6e 74 00 56 4d 77 61 72 65 55 73 65 72 4d 61 6e 61 67 65 72 45 76 65 6e 74 00 } //01 00 
