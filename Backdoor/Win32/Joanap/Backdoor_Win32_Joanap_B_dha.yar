...
rule Backdoor_Win32_Joanap_B_dha{
	...
	strings :
		...
		$a_03_1 = {68 30 75 00 00 8d 44 24 0c 6a 04 50 56 c7 44 24 18 00 10 00 00 e8 90 01 02 00 00 83 c4 14 83 f8 ff 0f 90 01 02 00 00 00 8d 4c 24 08 51 e8 90 01 02 ff ff 6a 00 68 30 75 00 00 90 00 } //1
	condition:
