...
rule Backdoor_Win32_Joanap_D_dha{
	...
	strings :
		$a_03_0 = {99 f7 fd 8a 5c 0c 10 03 f3 8a 92 90 01 04 03 d6 81 e2 ff 00 00 00 41 8b f2 81 f9 00 01 00 00 8a 44 34 10 88 5c 34 10 88 44 0c 0f 7c 90 01 01 8b 94 24 18 01 00 00 33 f6 33 c0 85 d2 7e 90 00 } //1
