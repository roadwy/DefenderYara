...
rule Backdoor_Win32_Flibot{
	...
	strings :
		$a_00_0 = {50 00 49 00 4e 00 47 00 } //01 00  PING
		$a_00_1 = {50 00 4f 00 4e 00 47 00 } //01 00  PONG
		$a_00_2 = {4a 00 4f 00 49 00 4e 00 } //05 00  JOIN
		$a_00_3 = {46 00 4c 00 56 00 50 00 40 00 4a 00 4b 00 49 00 } //0a 00  FLVP@JKI
