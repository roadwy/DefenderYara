...
rule Backdoor_Win32_Delf_JG{
	...
	strings :
		...
		$a_03_2 = {8b 45 fc 0f b6 5c 38 ff 80 e3 0f b8 90 01 04 0f b6 44 30 ff 24 0f 32 d8 80 f3 90 01 01 8d 45 fc e8 90 01 04 8b 55 fc 0f b6 54 3a ff 80 e2 f0 02 d3 88 54 38 ff 90 00 } //1
	condition:
