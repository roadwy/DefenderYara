...
rule Backdoor_Win32_Delf_ADH{
	...
	strings :
		...
		$a_01_2 = {43 6f 6e 74 72 6f 6c 53 65 72 76 69 63 65 } //01 00 
		$a_01_3 = {51 75 65 72 79 53 65 72 76 69 63 65 53 74 61 74 75 73 } //01 00 
		$a_01_4 = {44 65 6c 65 74 65 53 65 72 76 69 63 65 } //01 00 
		$a_00_5 = {73 76 63 68 6f 73 74 } //01 00 
		$a_00_6 = {6b 65 72 6e 6c 33 32 } //00 00 
	condition:
		any of ($a_*)
