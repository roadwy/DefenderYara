...
rule Backdoor_Win32_Delf_IW{
	...
	strings :
		...
		$a_03_1 = {6a 00 8d 85 ?? ?? ff ff 50 68 10 02 00 00 8d 85 ?? ?? ff ff 50 6a 20 8d 85 ?? ?? ff ff 50 68 88 c0 07 00 8b 85 ?? ?? ff ff 50 e8 ?? ?? ?? ?? 85 c0 75 } //1
		$a_03_2 = {66 ba 2e 00 66 b8 03 00 e8 ?? ?? ?? ?? 50 6a 00 68 12 03 00 00 68 ff ff 00 00 e8 } //1
	condition:
