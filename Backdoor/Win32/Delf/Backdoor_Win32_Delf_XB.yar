...
rule Backdoor_Win32_Delf_XB{
	...
	strings :
		...
		$a_02_1 = {32 32 32 2e 31 32 32 2e 90 10 03 00 2e 90 10 03 00 2f 64 6f 77 6e 6c 6f 61 64 2f 6d 6f 72 69 7a 2e 73 79 73 90 00 } //1
		$a_02_2 = {32 32 32 2e 31 32 32 2e 90 10 03 00 2e 90 10 03 00 2f 69 6e 73 74 61 6c 6c 5f 63 6f 75 6e 74 2e 68 74 6d 6c 3f 69 64 3d 90 00 } //1
		$a_02_3 = {32 32 32 2e 31 32 32 2e 90 10 03 00 2e 90 10 03 00 2f 61 63 63 65 73 73 5f 63 6f 75 6e 74 2e 68 74 6d 6c 3f 69 64 3d 90 00 } //1
