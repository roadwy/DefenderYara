...
rule Backdoor_Win32_Delf_BO{
	...
	strings :
		...
		$a_02_6 = {8b 95 38 fe ff ff 8d 45 f4 59 e8 90 01 02 ff ff 68 90 01 02 40 00 ff 75 f8 68 90 01 02 40 00 ff 75 f4 8d 85 2c fe ff ff ba 04 00 00 00 e8 90 01 02 ff ff 8b 95 2c fe ff ff a1 90 01 02 40 00 e8 90 01 02 ff ff 8b 45 f4 e8 90 01 02 ff ff b9 0a 00 00 00 99 f7 f9 90 00 } //1
	condition:
