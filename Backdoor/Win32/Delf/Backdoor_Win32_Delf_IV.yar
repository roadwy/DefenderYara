...
rule Backdoor_Win32_Delf_IV{
	...
	strings :
		...
		$a_03_1 = {68 3f 00 0f 00 6a 00 6a 00 e8 ?? ?? ?? ?? 89 45 e0 6a 00 6a 00 8d 45 d8 50 8d 45 dc 50 68 00 80 00 00 8d 85 ?? ?? ff ff 50 6a 03 6a 30 6a 00 8b 45 e0 50 e8 } //1
		$a_03_2 = {50 6a 00 6a 01 e8 ?? ?? ?? ?? 8b d8 6a 00 53 e8 ?? ?? ?? ?? 53 e8 ?? ?? ?? ?? 68 88 13 00 00 e8 } //1
	condition:
