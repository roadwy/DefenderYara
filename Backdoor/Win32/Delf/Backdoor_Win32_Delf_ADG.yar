...
rule Backdoor_Win32_Delf_ADG{
	...
	strings :
		...
		$a_00_1 = {53 6f 66 74 77 61 72 65 5c 4d 69 63 72 6f 73 6f 66 74 5c 57 69 6e 64 6f 77 73 5c 43 75 72 72 65 6e 74 56 65 72 73 69 6f 6e 5c 52 75 6e 5c } //01 00  Software\Microsoft\Windows\CurrentVersion\Run\
		$a_01_2 = {57 69 6e 33 32 20 53 65 72 76 69 63 65 } //01 00  Win32 Service
		$a_01_3 = {73 61 75 3d 79 65 73 3f 3f 3f } //01 00  sau=yes???
		$a_01_4 = {6c 6f 6c 2e 68 74 6d 6c } //01 00  lol.html
		$a_01_5 = {73 79 73 33 32 } //00 00  sys32
	condition:
		any of ($a_*)
