...
rule Backdoor_Win32_Delf_ZSW_bit{
	...
	strings :
		$a_01_0 = {53 6f 66 74 77 61 72 65 5c 4d 69 63 72 6f 73 6f 66 74 5c 57 69 6e 64 6f 77 73 5c 43 75 72 72 65 6e 74 56 65 72 73 69 6f 6e 5c 52 75 6e 5c } //0a 00 
		...
		$a_01_3 = {73 64 6e 3d } //01 00 
		$a_01_4 = {73 63 6f 3d } //01 00 
		$a_01_5 = {73 6e 61 3d } //01 00 
		$a_01_6 = {73 70 61 3d } //01 00 
		$a_01_7 = {73 6c 6e 3d } //01 00 
		$a_01_8 = {73 70 6f 3d } //00 00 
