...
rule Backdoor_Win32_Delf_RAK{
	...
	strings :
		...
		$a_02_3 = {89 45 fc 33 c0 55 68 90 01 04 64 ff 30 64 89 20 ba 90 01 04 8b 45 fc e8 90 01 04 33 c9 ba 90 01 04 8b 45 fc e8 90 01 04 84 c0 74 0d ba 90 01 04 8b 45 fc e8 90 01 04 8b 45 fc e8 90 01 04 33 c0 5a 59 59 64 89 10 90 00 } //5
	condition:
