...
rule Backdoor_Win32_Delf_RAK{
	...
	strings :
		$a_00_0 = {30 78 25 2e 32 78 25 2e 32 78 25 2e 32 78 25 2e 32 78 25 2e 32 78 25 2e 32 78 } //01 00  0x%.2x%.2x%.2x%.2x%.2x%.2x
		$a_00_1 = {53 65 74 20 63 64 61 75 64 69 6f 20 64 6f 6f 72 20 6f 70 65 6e 20 77 61 69 74 } //01 00  Set cdaudio door open wait
