...
rule Backdoor_Win32_Delf_RAN{
	...
	strings :
		$a_00_0 = {25 53 79 73 74 65 6d 52 6f 6f 74 25 5c 53 79 73 74 65 6d 33 32 5c 73 76 63 68 6f 73 74 2e 65 78 65 20 2d 6b 20 6b 72 6e 6c 73 72 76 63 } //01 00  %SystemRoot%\System32\svchost.exe -k krnlsrvc
		$a_00_1 = {45 52 41 53 45 20 2f 46 20 2f 41 20 22 } //01 00  ERASE /F /A "
		$a_00_2 = {22 20 67 6f 74 6f 20 54 4e 4e 44 } //0a 00  " goto TNND
