...
rule Backdoor_Win32_Delf_ADI{
	...
	strings :
		$a_02_0 = {81 c4 f8 fe ff ff c6 04 24 00 68 90 01 04 8d 44 24 04 50 e8 90 01 04 68 90 01 04 8d 44 24 04 50 e8 90 01 04 6a 00 8d 44 24 04 50 e8 90 01 04 6a 00 e8 90 01 04 81 c4 08 01 00 00 c3 90 00 } //1
