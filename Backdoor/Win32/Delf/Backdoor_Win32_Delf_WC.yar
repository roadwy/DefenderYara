...
rule Backdoor_Win32_Delf_WC{
	...
	strings :
		...
		$a_00_2 = {53 4f 46 54 57 41 52 45 5c 4d 69 63 72 6f 73 6f 66 74 5c 57 69 6e 64 6f 77 73 20 4e 54 5c 43 75 72 72 65 6e 74 56 65 72 73 69 6f 6e 5c 53 76 63 48 6f 73 74 } //05 00  SOFTWARE\Microsoft\Windows NT\CurrentVersion\SvcHost
		$a_00_3 = {73 76 63 68 6f 73 74 2e 65 78 65 20 2d 6b 20 6e 65 74 73 76 63 73 } //00 00  svchost.exe -k netsvcs
	condition:
		any of ($a_*)
