...
rule Backdoor_Win32_Dapsol{
	...
	strings :
		$a_03_0 = {4d 61 69 6e 00 63 6f 6e 63 00 90 02 04 2d 70 61 72 74 6e 65 72 90 02 04 2d 90 01 02 40 63 6f 6e 63 65 61 6c 61 72 65 61 90 00 } //2
...
rule Backdoor_Win32_Dapsol_2{
	...
	strings :
		$a_03_0 = {4d 61 69 6e 00 63 6f 6e 63 00 90 02 04 2d 70 61 72 74 6e 65 72 90 02 04 2d 90 01 02 40 64 61 70 73 6f 6c 90 00 } //2
