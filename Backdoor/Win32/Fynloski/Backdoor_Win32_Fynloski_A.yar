...
rule Backdoor_Win32_Fynloski_A{
	...
	strings :
		$a_01_0 = {44 43 50 45 52 53 46 57 42 50 } //03 00 
...
rule Backdoor_Win32_Fynloski_A_2{
	...
	strings :
		...
		$a_01_4 = {23 62 6f 74 43 6f 6d 6d 61 6e 64 25 } //01 00 
		$a_01_5 = {50 6f 72 74 53 63 61 6e 41 64 64 } //01 00 
		$a_01_6 = {52 50 43 4c 61 6e 53 63 61 6e } //01 00 
		$a_01_7 = {57 69 6e 64 6f 77 73 4c 69 76 65 3a 6e 61 6d 65 3d 2a } //01 00 
		$a_01_8 = {44 44 4f 53 48 54 54 50 46 4c 4f 4f 44 } //01 00 
		$a_01_9 = {44 44 4f 53 53 59 4e 46 4c 4f 4f 44 } //01 00 
		$a_01_10 = {44 44 4f 53 55 44 50 46 4c 4f 4f 44 } //01 00 
		$a_01_11 = {41 63 74 69 76 65 4f 66 66 6c 69 6e 65 4b 65 79 6c 6f 67 67 65 72 } //f6 ff 
		$a_01_12 = {43 6f 6d 65 74 20 52 41 54 20 4c 65 67 61 63 79 20 69 73 20 61 6c 72 65 61 64 79 20 61 63 74 69 76 65 20 69 6e 20 79 6f 75 72 20 73 79 73 74 65 6d } //00 00 
	condition:
		any of ($a_*)
