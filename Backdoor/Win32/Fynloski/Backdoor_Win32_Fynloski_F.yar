...
rule Backdoor_Win32_Fynloski_F{
	...
	strings :
		...
		$a_03_11 = {80 fb 31 75 0d 8d 90 01 02 b8 90 01 04 e8 90 01 04 80 fb 32 75 0d 8d 90 01 02 b8 90 01 04 e8 90 01 04 80 fb 33 75 0d 8d 90 01 02 b8 90 01 04 e8 90 01 04 80 fb 34 75 0d 8d 90 01 02 b8 90 01 04 e8 90 01 04 80 fb 35 75 0d 90 00 } //15
	condition:
