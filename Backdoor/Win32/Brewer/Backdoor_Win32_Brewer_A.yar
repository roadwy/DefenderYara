...
rule Backdoor_Win32_Brewer_A{
	...
	strings :
		...
		$a_02_1 = {fc b9 06 00 00 00 83 ec 10 f3 a6 0f 85 90 01 02 ff ff 31 ff be 00 04 00 00 8d 9d 90 01 02 ff ff 89 74 24 08 89 7c 24 04 31 ff 89 1c 24 bb 01 00 00 00 e8 90 01 02 00 00 8b b5 90 01 02 ff ff 31 d2 b9 90 01 04 89 54 24 0c b8 0f 00 00 00 89 4c 24 04 89 44 24 08 89 34 24 90 00 } //1
