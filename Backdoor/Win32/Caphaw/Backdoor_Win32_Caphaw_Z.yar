...
rule Backdoor_Win32_Caphaw_Z{
	...
	strings :
		$a_03_0 = {89 44 24 08 89 44 24 04 8b 44 24 04 83 c4 04 3d 00 00 90 01 01 01 73 2c e8 90 01 02 00 00 89 44 24 08 db 44 24 08 d9 fa e8 90 01 02 00 00 03 44 24 04 89 44 24 04 8b 0c 24 41 90 00 } //2
