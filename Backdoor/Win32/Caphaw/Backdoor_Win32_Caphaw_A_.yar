...
rule Backdoor_Win32_Caphaw_A_{
	meta:
		description = "Backdoor:Win32/Caphaw.A!!Caphaw,SIGNATURE_TYPE_ARHSTR_EXT,05 00 05 00 0a 00 00 03 00 "
	...
	strings :
		...
		$a_01_7 = {41 56 43 49 6e 6a 65 63 74 73 50 61 63 6b 40 40 } //01 00 
		$a_01_8 = {41 56 46 46 5f 48 6f 6f 6b 40 40 } //01 00 
		$a_01_9 = {41 56 49 45 5f 48 6f 6f 6b 40 40 } //05 00 
	condition:
		any of ($a_*)
