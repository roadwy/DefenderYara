...
rule Backdoor_Win32_Caphaw_N{
	...
	strings :
		...
		$a_01_1 = {6d 73 70 72 65 61 64 6d 75 74 65 78 } //01 00 
		$a_01_2 = {2f 68 69 6a 61 63 6b 63 66 67 2f 75 72 6c 73 5f 73 65 72 76 65 72 2f 75 72 6c 5f 73 65 72 76 65 72 } //00 00 
	condition:
		any of ($a_*)
