...
rule Backdoor_Win32_Agent_CAB{
	...
	strings :
		...
		$a_00_1 = {00 64 74 72 2e 64 6c 6c } //05 00  搀牴搮汬
		...
		$a_01_5 = {57 72 69 74 65 50 72 6f 63 65 73 73 4d 65 6d 6f 72 79 } //9c ff  WriteProcessMemory
		$a_01_6 = {5c 43 53 43 68 65 61 74 5c 44 72 69 76 65 72 } //00 00  \CSCheat\Driver
	condition:
		any of ($a_*)
