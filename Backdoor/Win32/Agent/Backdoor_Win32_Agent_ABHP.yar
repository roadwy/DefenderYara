...
rule Backdoor_Win32_Agent_ABHP{
	...
	strings :
		$a_02_0 = {31 c0 0f a2 85 c0 0f 84 90 01 04 b8 01 00 00 00 0f a2 f6 c6 01 74 90 00 } //1
		$a_02_1 = {68 63 d6 00 00 e8 90 01 04 66 89 45 da 6a 00 e8 90 01 04 89 45 dc 90 00 } //1
