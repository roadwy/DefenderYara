...
rule Backdoor_Win32_Escad_S_dha_2{
	...
	strings :
		...
		$a_00_1 = {25 00 73 00 64 00 2e 00 65 00 25 00 73 00 63 00 20 00 22 00 25 00 73 00 20 00 3e 00 20 00 25 00 73 00 22 00 20 00 32 00 3e 00 26 00 31 00 } //01 00  %sd.e%sc "%s > %s" 2>&1
		$a_00_2 = {25 00 73 00 6d 00 64 00 2e 00 65 00 78 00 25 00 73 00 63 00 20 00 22 00 25 00 73 00 20 00 3e 00 20 00 25 00 73 00 22 00 20 00 32 00 3e 00 26 00 31 00 } //00 00  %smd.ex%sc "%s > %s" 2>&1
	condition:
		any of ($a_*)
