...
rule Backdoor_Win32_Escad_G_dha{
	...
	strings :
		...
		$a_02_1 = {64 65 6c 20 22 90 02 10 69 66 20 65 78 69 73 74 20 22 90 00 } //1
		$a_02_2 = {6d 63 75 2e 69 6e 66 90 02 05 52 65 67 69 73 74 65 72 90 02 10 6d 63 75 2e 64 6c 6c 90 02 10 72 62 90 00 } //1
	condition:
