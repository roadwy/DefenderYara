...
rule Backdoor_Win32_Escad_J_dha{
	meta:
		description = "Backdoor:Win32/Escad.J!dha,SIGNATURE_TYPE_PEHSTR_EXT,0b 00 0b 00 03 00 00 0a 00 "
...
rule Backdoor_Win32_Escad_J_dha_3{
	meta:
		description = "Backdoor:Win32/Escad.J!dha,SIGNATURE_TYPE_PEHSTR_EXT,02 00 02 00 04 00 00 01 00 "
		
	strings :
		$a_02_0 = {69 66 20 65 78 69 73 74 20 22 25 73 22 20 67 6f 74 6f 20 52 0d 0a 64 65 6c 20 2f 61 20 22 25 73 22 90 02 50 4e 74 51 75 65 72 79 49 6e 66 6f 72 6d 61 74 69 6f 6e 50 72 6f 63 65 73 73 90 00 } //01 00 
		$a_03_1 = {8b c1 33 d2 be 90 01 04 f7 f6 8a 82 90 01 04 8a 91 90 01 04 32 d0 88 91 90 01 04 41 81 f9 90 01 04 72 d8 90 00 } //01 00 
		$a_00_2 = {c6 44 24 16 2e f7 f9 c6 44 24 17 64 c6 44 24 18 6c c6 44 24 19 6c } //01 00 
		$a_02_3 = {44 65 6c 65 74 65 55 72 6c 43 61 63 68 65 45 6e 74 72 79 41 90 02 05 68 74 74 70 3a 2f 2f 90 02 60 2e 65 78 65 90 02 20 53 74 61 72 74 49 6e 73 74 61 6c 6c 90 00 } //00 00 
	condition:
		any of ($a_*)
