...
rule Backdoor_Win32_Crugup_A{
	...
	strings :
		...
		$a_03_6 = {83 ec 04 8d 45 fc ff 00 eb d1 83 3d ?? ?? ?? ?? 06 75 54 c7 45 fc 00 00 00 00 83 7d fc 09 7f 47 8b 45 fc c1 e0 09 05 ?? ?? ?? ?? 89 44 24 08 8b 45 fc c1 e0 09 05 ?? ?? ?? ?? 89 44 24 04 8b 45 fc c1 e0 09 05 ?? ?? ?? ?? 89 04 24 e8 } //2
	condition:
