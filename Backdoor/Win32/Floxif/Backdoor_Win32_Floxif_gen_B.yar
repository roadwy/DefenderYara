...
rule Backdoor_Win32_Floxif_gen_B{
	...
	strings :
		...
		$a_03_1 = {68 19 00 02 00 8d 45 90 01 01 6a 00 50 68 02 00 00 80 c7 45 90 01 01 30 30 31 00 90 00 } //2
		$a_01_2 = {8a d0 8a c1 b3 07 f6 eb 2c 33 32 c2 88 44 0d } //1
		$a_03_3 = {b8 17 93 28 f3 33 c8 89 7d 90 01 01 89 0f 90 00 } //1
