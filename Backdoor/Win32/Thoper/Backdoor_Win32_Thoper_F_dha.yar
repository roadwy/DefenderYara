...
rule Backdoor_Win32_Thoper_F_dha{
	...
	strings :
		$a_01_0 = {77 00 69 00 6e 00 73 00 74 00 61 00 30 00 5c 00 64 00 65 00 66 00 61 00 75 00 6c 00 74 00 } //01 00  winsta0\default
		$a_01_1 = {52 00 55 00 4e 00 41 00 53 00 } //01 00  RUNAS
