...
rule Backdoor_Win32_CobaltStrikeLoader_CM_dha{
	...
	strings :
		...
		$a_00_2 = {2a 28 70 20 2b 20 25 64 29 20 3a 20 25 66 } //00 00 
	condition:
		any of ($a_*)
...
rule Backdoor_Win32_CobaltStrikeLoader_CM_dha_2{
	...
	strings :
		$a_00_0 = {72 00 75 00 6e 00 64 00 6c 00 6c 00 33 00 32 00 2e 00 65 00 78 00 65 00 } //05 00 
		$a_00_1 = {31 00 31 00 39 00 38 00 35 00 } //01 00 
		$a_00_2 = {43 00 6c 00 65 00 61 00 72 00 4d 00 79 00 54 00 72 00 61 00 63 00 6b 00 73 00 42 00 79 00 50 00 72 00 6f 00 63 00 65 00 73 00 73 00 } //01 00 
		$a_00_3 = {41 00 6c 00 6c 00 6f 00 63 00 43 00 6f 00 6e 00 73 00 6f 00 6c 00 65 00 } //9c ff 
		$a_00_4 = {69 00 6e 00 65 00 74 00 63 00 70 00 6c 00 2e 00 63 00 70 00 6c 00 } //00 00 
	condition:
		any of ($a_*)
