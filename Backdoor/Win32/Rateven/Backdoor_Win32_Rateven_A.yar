...
rule Backdoor_Win32_Rateven_A{
	...
	strings :
		...
		$a_02_3 = {83 3b 00 0f 85 90 01 04 68 90 01 02 40 00 e8 90 01 01 fe ff ff 89 03 83 3b 00 0f 84 90 01 04 68 90 01 02 40 00 8b 03 50 e8 90 01 01 fe ff ff a3 90 01 02 40 00 68 90 01 02 40 00 8b 03 50 e8 90 00 } //1
	condition:
