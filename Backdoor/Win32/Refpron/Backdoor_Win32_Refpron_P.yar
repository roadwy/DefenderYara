...
rule Backdoor_Win32_Refpron_P{
	...
	strings :
		...
		$a_01_1 = {62 66 6b 71 2e 63 6f 6d 7c } //01 00  bfkq.com|
		$a_01_2 = {7c 6a 73 61 63 74 69 76 69 74 79 2e 63 6f 6d } //01 00  |jsactivity.com
		$a_01_3 = {4e 65 65 64 4b 69 6c 6c 00 } //01 00 
		$a_01_4 = {6e 72 6e 64 66 6f 72 63 74 72 31 00 } //01 00  牮摮潦捲牴1
		$a_01_5 = {5c 53 79 73 74 65 6d 45 78 63 6c 61 6d 61 74 69 6f 6e 5c 2e 43 75 72 72 65 6e 74 00 } //01 00 
		$a_01_6 = {64 69 73 63 6f 76 65 72 2e 65 78 65 3d 00 } //01 00  楤捳癯牥攮數=
