...
rule Backdoor_Win32_Refpron_C{
	...
	strings :
		...
		$a_01_3 = {65 5f 72 72 6f 5f 72 } //01 00 
		$a_01_4 = {65 5f 72 72 5f 6f 5f 72 } //01 00 
		$a_01_5 = {4f 70 65 6e 20 20 20 46 69 6c 65 20 20 20 45 72 72 6f 72 21 21 21 } //01 00 
		$a_01_6 = {54 4d 79 5f 4d 5f 69 5f 6e 69 54 5f 43 5f 50 43 5f 6c 69 65 6e 74 } //00 00 
	condition:
		any of ($a_*)
