...
rule Backdoor_Win32_Dridex_SE_MTB{
	...
	strings :
		...
		$a_01_1 = {5c 62 61 67 5c 46 41 53 54 5c 74 72 61 6e 73 61 63 74 69 6f 6e 61 6c 5c 75 6e 70 6c 65 61 73 61 2e 70 64 62 } //00 00  \bag\FAST\transactional\unpleasa.pdb
		$a_00_2 = {5d } //04 00  ]
	condition:
		any of ($a_*)
