...
rule Backdoor_Win32_Idicaf_gen_A{
	...
	strings :
		...
		$a_00_4 = {73 68 75 74 64 6f 77 6e } //1 shutdown
		$a_00_5 = {6c 6f 67 6f 6e 75 69 2e 65 78 65 } //1 logonui.exe
		$a_00_6 = {72 75 6e 64 6c 6c 36 34 2e 65 78 65 } //1 rundll64.exe
		$a_00_7 = {64 65 6c 68 6f 73 74 69 6e 66 6f } //1 delhostinfo
		$a_00_8 = {25 73 5c 49 45 58 50 4c 4f 52 45 2e 45 58 45 } //1 %s\IEXPLORE.EXE
		$a_00_9 = {64 65 6c 20 22 25 73 } //1 del "%s
		$a_00_10 = {5c 76 6d 73 65 6c 66 64 65 6c 2e 62 61 74 } //1 \vmselfdel.bat
		$a_00_11 = {61 74 74 72 69 62 20 2d 61 20 2d 72 20 2d 73 20 2d 68 20 22 25 73 } //1 attrib -a -r -s -h "%s
