...
rule Backdoor_Win32_Losfondup_B{
	...
	strings :
		...
		$a_01_5 = {6e 65 74 20 6c 6f 63 61 6c 67 72 6f 75 70 20 41 64 6d 69 6e 69 73 74 72 61 74 6f 72 73 20 22 4c 4f 43 41 4c 20 53 45 52 56 6c 43 45 22 20 2f 61 64 64 } //01 00  net localgroup Administrators "LOCAL SERVlCE" /add
	condition:
		any of ($a_*)
