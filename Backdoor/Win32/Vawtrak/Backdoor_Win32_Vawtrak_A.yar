...
rule Backdoor_Win32_Vawtrak_A_2{
	...
	strings :
		...
		$a_01_2 = {50 49 44 3a 20 25 75 20 5b 25 30 2e 32 75 3a 25 30 2e 32 75 3a 25 30 2e 32 75 5d } //01 00  PID: %u [%0.2u:%0.2u:%0.2u]
		$a_01_3 = {5b 53 6f 63 6b 73 5d 20 46 61 69 6c 74 20 63 6f 6e 6e 65 63 74 20 42 43 20 5b 25 73 3a 25 75 5d } //00 00  [Socks] Failt connect BC [%s:%u]
	condition:
		any of ($a_*)
