...
rule Backdoor_Win32_Webcont_A{
	...
	strings :
		$a_03_0 = {83 7c b5 c4 00 75 90 01 01 46 83 fe 0f 7c f3 8a 07 3c 65 74 0c 3c 70 74 08 3c 45 74 04 3c 50 75 01 47 8a 07 90 00 } //1
		$a_03_1 = {80 3f 30 75 15 8a 47 01 3c 78 74 04 3c 58 75 0a c7 45 90 01 01 10 00 00 00 83 c7 02 83 8d 90 01 01 ff ff ff ff 8a 07 3c 30 7c 12 3c 39 7f 0e 0f be 07 83 e8 30 90 00 } //1
