...
rule Backdoor_Win32_Loretsys_A{
	...
	strings :
		$a_03_0 = {53 65 54 74 49 6e 47 73 90 02 0a 72 75 73 73 69 61 6e 90 00 } //1
		$a_02_1 = {41 50 54 52 41 20 20 20 20 20 20 20 25 73 90 02 04 54 72 61 6e 73 61 63 74 69 6f 6e 73 20 25 64 90 00 } //1
