...
rule Backdoor_Win32_Spybot{
	...
	strings :
		...
		$a_03_25 = {b9 a0 05 00 00 31 d2 f7 f1 89 95 90 01 03 ff b8 60 ea 00 00 f7 a5 90 00 } //10
		$a_03_26 = {59 31 f6 eb 1c e8 90 01 03 00 b9 1a 00 00 00 99 f7 f9 89 d7 83 c7 61 89 fa 88 14 35 90 00 } //10
	condition:
