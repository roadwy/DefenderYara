...
rule Backdoor_Win32_Firefly_J{
	...
	strings :
		...
		$a_02_3 = {64 ff 30 64 89 20 6a 00 6a 00 6a 00 6a 00 68 90 01 04 e8 90 01 04 89 45 90 00 } //10
		$a_02_4 = {6a 01 8d 44 24 10 50 e8 90 01 04 6a 00 6a 00 6a ff 8d 44 24 18 50 e8 90 01 04 c7 04 24 0c 00 00 00 8d 44 24 0c 89 44 24 04 c7 44 24 08 ff ff ff ff 68 90 01 04 6a ff 6a 06 90 00 } //10
	condition:
