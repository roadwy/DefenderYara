...
rule Backdoor_Win32_Kasidet_C{
	...
	strings :
		$a_01_0 = {62 6f 74 6b 69 6c 6c 65 72 } //01 00 
		$a_01_1 = {64 77 66 6c 6f 6f 64 } //02 00 
		$a_01_2 = {63 00 6d 00 64 00 3d 00 31 00 26 00 75 00 69 00 64 00 3d 00 25 00 73 00 26 00 6f 00 73 00 3d 00 25 00 73 00 26 00 61 00 76 00 3d 00 25 00 73 00 26 00 76 00 65 00 72 00 73 00 69 00 6f 00 6e 00 3d 00 25 00 73 00 26 00 71 00 75 00 61 00 6c 00 69 00 74 00 79 00 3d 00 25 00 69 00 } //0a 00 
		$a_01_3 = {4e 33 4e 4e 65 74 77 6f 72 6b } //01 00 
