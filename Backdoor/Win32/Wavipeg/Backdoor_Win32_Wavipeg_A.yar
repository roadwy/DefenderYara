...
rule Backdoor_Win32_Wavipeg_A{
	...
	strings :
		$a_01_0 = {66 74 2f 73 69 2e 70 68 70 3f } //01 00  ft/si.php?
		$a_01_1 = {61 76 70 00 65 73 65 74 00 65 67 75 69 } //01 00 
		$a_01_2 = {25 73 3d 64 64 6f 73 26 63 6f 6d 70 3d 25 73 } //01 00  %s=ddos&comp=%s
		$a_01_3 = {26 63 6f 6d 70 3d 25 73 26 65 78 74 3d } //01 00  &comp=%s&ext=
