...
rule Backdoor_Win32_Lisuife_A_dha{
	...
	strings :
		...
		$a_03_1 = {b9 80 96 98 00 f7 f9 03 d3 52 e8 90 01 04 83 c4 08 e8 90 01 04 99 b9 60 00 00 00 90 00 } //1
		$a_03_2 = {b9 80 96 98 00 f7 f9 03 f2 56 e8 90 01 04 83 c4 04 e8 90 01 04 99 b9 60 00 00 00 90 00 } //1
	condition:
