...
rule Backdoor_Win32_Riprova_5{
	...
	strings :
		...
		$a_02_5 = {6f 77 73 5c 43 75 72 72 65 6e 74 56 65 72 73 69 6f 6e 5c 49 6e 74 65 72 6e 65 74 20 53 65 74 74 69 6e 67 73 5c 5a 6f 6e 65 4d 61 70 5c 44 6f 6d 61 69 6e 73 5c 90 02 18 5c 77 77 77 00 90 00 } //5
		...
		$a_02_13 = {2e 6c 6e 6b 00 90 02 30 5c 4d 69 63 72 6f 73 6f 66 74 5c 49 6e 74 65 72 6e 65 74 20 45 78 70 6c 6f 72 65 72 5c 51 75 69 63 6b 20 4c 61 75 6e 63 68 5c 00 90 00 } //4
