...
rule Backdoor_Win32_Pedryak_A_dll{
	...
	strings :
		$a_03_0 = {05 04 fc ff ff 3d c8 00 00 00 0f 87 90 01 01 00 00 00 33 c9 8a 88 90 01 02 00 10 ff 24 8d 90 01 02 00 10 e8 90 01 02 00 00 c3 90 00 } //3
		$a_03_1 = {3d 64 23 00 00 7f 90 01 03 3d 14 05 00 00 7f 90 00 } //3
		$a_03_2 = {8b 30 c1 e9 02 f3 a5 8b ca 83 e1 03 f3 a4 ff 15 90 01 02 00 10 39 44 24 1c 75 0d 68 e0 93 04 00 ff 15 90 01 02 00 10 eb bc b9 90 00 } //2
