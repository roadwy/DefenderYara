...
rule Backdoor_Win32_R2d2_A{
	...
	strings :
		...
		$a_01_1 = {43 33 50 4f 2d 72 32 64 32 2d 50 4f 45 } //01 00 
		$a_01_2 = {5c 5c 2e 5c 70 69 70 65 5c 73 61 70 69 70 69 70 65 } //01 00 
		$a_01_3 = {53 59 53 21 49 50 43 21 } //01 00 
		$a_01_4 = {5c 5c 2e 5c 4b 65 79 62 6f 61 72 64 43 6c 61 73 73 43 } //00 00 
	condition:
		any of ($a_*)
...
rule Backdoor_Win32_R2d2_A_2{
	...
	strings :
		...
		$a_01_2 = {44 55 4d 4d 59 21 44 55 4d 4d 59 00 } //01 00 
		$a_01_3 = {6d 73 6e 6d 73 67 72 2e 65 78 65 } //01 00 
		$a_01_4 = {53 6b 79 70 65 50 4d 2e 65 78 65 } //01 00 
		$a_01_5 = {79 61 68 6f 6f 6d 65 73 73 65 6e 67 65 72 2e 65 78 65 } //00 00 
	condition:
		any of ($a_*)
