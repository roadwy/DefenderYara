...
rule Backdoor_Win32_Small_IR{
	...
	strings :
		...
		$a_00_3 = {49 6e 74 65 72 6e 65 74 4f 70 65 6e 55 72 6c 41 } //01 00 
		$a_00_4 = {53 68 65 6c 6c 45 78 65 63 75 74 65 45 78 41 } //01 00 
		$a_01_5 = {46 53 54 53 57 20 00 4c 4c 44 54 20 00 4c 4c 44 54 20 77 6f 72 64 00 4c 4d 53 57 20 00 4c 4d 53 57 20 77 6f 72 64 } //00 00 
	condition:
		any of ($a_*)
