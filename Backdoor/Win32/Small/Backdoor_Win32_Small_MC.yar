...
rule Backdoor_Win32_Small_MC{
	...
	strings :
		$a_01_0 = {5c 73 79 73 6d 6f 6e 2e 65 78 65 } //0a 00 
		$a_01_1 = {77 77 77 2e 72 69 6e 67 7a 2e 6f 72 67 } //0a 00 
		$a_01_2 = {62 61 63 6b 64 6f 6f 72 20 77 72 69 74 74 65 6e 20 62 79 } //01 00 
		$a_01_3 = {57 53 41 53 6f 63 6b 65 74 41 } //01 00 
