...
rule Backdoor_Win32_Craunpirp_A{
	...
	strings :
		...
		$a_03_1 = {68 0c 00 00 08 50 50 50 ff 75 10 ff 75 08 ff 15 ?? ?? ?? ?? 85 c0 0f 84 ?? ?? ?? ?? a1 ?? ?? ?? ?? 85 c0 0f 85 ?? ?? ?? ?? 8d 85 ?? ?? ?? ?? c7 85 ?? ?? ?? ?? 07 00 01 00 } //2
		...
		$a_03_3 = {8b f1 8a 04 95 ?? ?? ?? ?? 30 06 46 42 33 c0 83 fa 08 0f 4d d0 38 06 75 e9 } //1
