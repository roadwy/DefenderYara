...
rule Backdoor_Win32_Damatak_A{
	...
	strings :
		$a_00_0 = {77 69 6e 68 6f 73 74 33 32 2e 65 78 65 } //01 00 
		$a_00_1 = {7a 65 78 70 6c 6f 72 65 72 2e 65 78 65 } //01 00 
		$a_00_2 = {67 75 69 64 3d 25 69 36 34 75 26 62 75 69 6c 64 3d 25 73 26 69 6e 66 6f 3d 25 73 26 69 70 3d 25 73 26 74 79 70 65 3d 31 26 77 69 6e 3d 25 64 2e 25 64 28 78 } //01 00 
