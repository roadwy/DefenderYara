...
rule Backdoor_Win32_Tupty_A{
	...
	strings :
		$a_00_0 = {57 65 6c 43 6f 6d 65 20 54 6f 20 54 70 6f 72 74 } //01 00  WelCome To Tport
		$a_00_1 = {45 78 65 63 75 74 65 20 54 68 65 20 43 6f 6d 6d 61 6e 64 20 77 69 74 68 20 4c 6f 6e 67 6f 6e 20 55 73 65 72 20 46 61 69 6c 65 64 } //01 00  Execute The Command with Longon User Failed
