...
rule Backdoor_Win32_Afcore_M{
	meta:
		description = "Backdoor:Win32/Afcore.M,SIGNATURE_TYPE_PEHSTR_EXT,05 00 05 00 07 00 00 02 00 "
		
	strings :
		$a_03_0 = {f3 a4 c7 07 2e 64 90 01 01 6c c6 47 04 00 6a 01 68 00 00 00 c0 90 00 } //02 00 
		$a_01_1 = {83 c3 07 8b 45 0c 89 45 fc 6a 10 8d 4d f0 b8 78 56 34 12 } //02 00 
