...
rule Backdoor_Win32_Zegost_gen_B{
	...
	strings :
		...
		$a_00_3 = {48 74 74 70 2f 31 2e 31 20 34 30 33 20 46 6f 72 62 69 64 64 65 6e } //01 00 
		$a_01_4 = {6d 6f 7a 68 65 55 70 64 61 74 65 } //01 00 
		$a_01_5 = {45 6e 61 62 6c 65 64 00 cf fb cf a2 00 } //01 00 
		$a_01_6 = {5b 46 31 32 5d 00 00 00 5b 46 31 31 5d } //01 00 
		$a_01_7 = {53 65 72 76 69 63 65 4d 61 69 6e 00 6d 61 69 6e } //00 00 
	condition:
		any of ($a_*)
