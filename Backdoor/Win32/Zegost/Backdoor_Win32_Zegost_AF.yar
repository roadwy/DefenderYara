...
rule Backdoor_Win32_Zegost_AF{
	...
	strings :
		...
		$a_01_1 = {4e 65 74 53 75 62 4b 65 79 00 } //02 00 
		$a_01_2 = {5c 78 68 6a 6d 6a 6a 2e 64 61 74 00 } //01 00 
		$a_01_3 = {47 6c 6f 62 61 6c 5c 4e 65 74 5f 25 64 } //01 00 
		$a_01_4 = {77 69 73 74 65 6e 00 } //01 00 
		$a_00_5 = {48 74 74 70 2f 31 2e 31 20 34 30 33 20 46 6f 72 62 69 64 64 65 6e } //01 00 
		$a_00_6 = {70 62 6b 5c 72 61 73 70 68 6f 6e 65 2e 70 62 6b } //02 00 
