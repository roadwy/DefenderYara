...
rule Backdoor_Win32_Zegost_U{
	...
	strings :
		...
		$a_03_1 = {6a 04 50 68 02 10 00 00 68 ff ff 00 00 51 c7 44 24 ?? 00 80 00 00 ff d7 8b 06 8d 54 24 ?? 6a 04 52 68 01 10 00 00 68 ff ff 00 00 } //1
		...
		$a_03_3 = {50 44 46 2d 90 10 05 00 00 } //1
	condition:
