...
rule Backdoor_Win32_Zegost_CG_2{
	...
	strings :
		$a_01_0 = {47 68 30 73 74 20 55 70 64 61 74 65 } //01 00  Gh0st Update
		$a_01_1 = {53 59 53 54 45 4d 5c 43 75 72 72 65 6e 74 43 6f 6e 74 72 6f 6c 53 65 74 5c 53 65 72 } //01 00  SYSTEM\CurrentControlSet\Ser
		$a_01_2 = {5c 69 6e 73 74 61 6c 6c 2e 64 61 74 } //01 00  \install.dat
		$a_01_3 = {5c 73 79 73 6c 6f 67 2e 64 61 74 } //01 00  \syslog.dat
		$a_01_4 = {53 65 72 76 69 63 65 44 6c 6c } //01 00  ServiceDll
		$a_01_5 = {53 74 61 72 74 53 65 72 76 69 63 65 41 } //01 00  StartServiceA
		$a_01_6 = {57 69 6e 53 74 61 30 5c 44 65 66 61 75 6c 74 } //01 00  WinSta0\Default
		$a_01_7 = {5c 73 68 65 6c 6c 5c 6f 70 65 6e 5c 63 6f 6d 6d 61 6e 64 } //01 00  \shell\open\command
		$a_01_8 = {73 76 63 68 6f 73 74 2e 65 78 65 20 2d 6b 20 6e 65 74 73 76 63 73 } //01 00  svchost.exe -k netsvcs
