...
rule Backdoor_Win32_Zegost_C_dll{
	...
	strings :
		...
		$a_00_2 = {47 6c 6f 62 61 6c 5c 54 6f 72 72 65 6e 74 20 25 64 } //01 00 
		$a_00_3 = {46 75 63 6b 5f 6b 61 76 5f 72 69 73 69 6e 67 } //01 00 
		$a_00_4 = {52 65 67 51 75 65 72 79 56 61 6c 75 65 45 78 28 53 76 63 68 6f 73 74 5c 6e 65 74 73 76 63 73 29 } //00 00 
	condition:
		any of ($a_*)
