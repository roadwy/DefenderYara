...
rule Backdoor_Win32_Zegost_CV{
	...
	strings :
		$a_03_0 = {8b 4d fc 03 4d f8 8a 90 01 01 80 ea 86 8b 45 fc 03 45 f8 88 10 90 00 } //3
		$a_03_1 = {8b 4d fc 03 4d f8 8a 90 01 01 80 f2 19 8b 45 fc 03 45 f8 88 10 90 00 } //3
		$a_03_2 = {83 c4 0c c6 45 90 01 01 53 c6 45 90 01 01 41 c6 45 90 01 01 4d c6 45 90 01 01 5c c6 45 90 01 01 53 c6 45 90 01 01 41 c6 45 90 01 01 4d c6 45 90 01 01 5c c6 45 90 01 01 44 c6 45 90 01 01 6f c6 45 90 01 01 6d 90 00 } //1
