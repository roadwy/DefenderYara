...
rule Backdoor_Win32_Zegost_AP{
	...
	strings :
		...
		$a_01_1 = {25 73 2f 63 67 69 2f 63 6f 6d 6d 61 6e 64 2e 61 73 70 3f 68 6f 73 74 6e 61 6d 65 3d 25 73 26 63 6f 6d 6d 61 6e 64 3d 74 65 73 74 26 64 65 6c 3d 64 65 6c 66 69 6c 65 00 } //01 00  猥振楧振浯慭摮愮灳栿獯湴浡㵥猥挦浯慭摮琽獥♴敤㵬敤晬汩e
		...
		$a_01_4 = {25 73 5c 73 79 73 74 65 6d 5c 25 64 2e 74 78 74 } //01 00  %s\system\%d.txt
		...
		$a_01_7 = {5c 68 65 6c 70 6d 73 67 2e 74 65 6d 70 00 } //00 00  桜汥浰杳琮浥p
	condition:
		any of ($a_*)
