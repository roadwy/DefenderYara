...
rule Backdoor_Win32_Zegost_gen_A{
	...
	strings :
		$a_01_0 = {57 69 6e 53 74 61 30 5c 44 65 66 61 75 6c 74 } //01 00 
		...
		$a_00_4 = {48 74 74 70 2f 31 2e 31 20 34 30 33 20 46 6f 72 62 69 64 64 65 6e } //01 00 
		$a_00_5 = {5b 70 72 69 6e 74 20 73 63 72 65 65 6e 5d } //00 00 
