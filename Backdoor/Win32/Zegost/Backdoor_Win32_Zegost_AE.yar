...
rule Backdoor_Win32_Zegost_AE{
	...
	strings :
		...
		$a_01_3 = {47 6c 6f 62 61 6c 5c 55 55 50 50 20 25 64 } //00 00  Global\UUPP %d
	condition:
		any of ($a_*)
...
rule Backdoor_Win32_Zegost_AE_2{
	...
	strings :
		...
		$a_01_3 = {54 65 72 6d 69 6e 61 74 65 54 68 72 65 61 64 00 25 73 3a 5c 57 69 6e 64 6f 77 73 5c 53 79 73 74 65 6d 33 32 } //00 00  敔浲湩瑡呥牨慥d猥尺楗摮睯屳祓瑳浥㈳
	condition:
		any of ($a_*)
