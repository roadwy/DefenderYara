...
rule Backdoor_Win32_Zegost_CW{
	...
	strings :
		$a_03_0 = {8a 1c 11 80 c3 90 01 01 88 1c 11 8b 90 01 03 8a 1c 11 80 f3 90 01 01 88 1c 11 90 00 } //2
		$a_03_1 = {8a 0c 30 80 f1 90 01 01 88 0c 30 40 3b c7 72 f2 90 00 } //2
