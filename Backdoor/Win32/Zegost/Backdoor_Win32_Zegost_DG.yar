...
rule Backdoor_Win32_Zegost_DG{
	...
	strings :
		...
		$a_03_2 = {83 ec 0c c6 45 90 01 01 44 c6 45 90 01 01 6c c6 45 90 01 01 6c c6 45 90 01 01 41 c6 45 90 01 01 75 c6 45 90 01 01 64 c6 45 90 01 01 69 c6 45 90 01 01 6f c6 45 90 01 01 00 90 00 } //1
	condition:
