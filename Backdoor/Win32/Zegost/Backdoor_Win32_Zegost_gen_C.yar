...
rule Backdoor_Win32_Zegost_gen_C{
	...
	strings :
		$a_03_0 = {ff 2e c6 85 90 01 02 ff ff 70 c6 85 90 01 02 ff ff 62 90 00 } //1
		$a_03_1 = {ff 5c c6 85 90 01 02 ff ff 74 c6 85 90 01 02 ff ff 63 90 00 } //1
		$a_03_2 = {ff 2e c6 85 90 01 02 ff ff 64 c6 85 90 01 02 ff ff 6c 90 00 } //1
		$a_03_3 = {ff 53 c6 85 90 01 02 ff ff 4f c6 85 90 01 02 ff ff 46 90 00 } //1
		$a_03_4 = {ff 5c c6 85 90 01 02 ff ff 41 c6 85 90 01 02 ff ff 70 90 00 } //1
		$a_03_5 = {ff 5c c6 85 90 01 02 ff ff 4d c6 85 90 01 02 ff ff 69 90 00 } //1
