...
rule Backdoor_Win32_Zegost_gen_C{
	...
	strings :
		...
		$a_00_6 = {00 5b 43 61 70 73 4c 6f 63 6b 5d 00 } //0a 00  嬀慃獰潌正]
		$a_00_7 = {57 69 6e 53 74 61 30 5c 44 65 66 61 75 6c 74 } //0a 00  WinSta0\Default
		$a_01_8 = {25 2d 32 34 73 20 25 2d 31 35 73 } //0a 00  %-24s %-15s
		$a_00_9 = {68 74 74 70 2f 31 2e 31 20 34 30 33 20 66 6f 72 62 69 64 64 65 6e } //0a 00  http/1.1 403 forbidden
		$a_00_10 = {70 62 6b 5c 72 61 73 70 68 6f 6e 65 2e 70 62 6b } //00 00  pbk\rasphone.pbk
	condition:
		any of ($a_*)
