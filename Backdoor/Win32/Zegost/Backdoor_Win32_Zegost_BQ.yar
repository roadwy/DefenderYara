...
rule Backdoor_Win32_Zegost_BQ{
	...
	strings :
		...
		$a_03_1 = {ff 68 c6 85 90 01 01 ff ff ff 6f c6 85 90 01 01 ff ff ff 6e c6 85 90 01 01 ff ff ff 65 c6 85 90 01 01 ff ff ff 2e c6 85 90 01 01 ff ff ff 70 c6 85 90 01 01 ff ff ff 62 c6 85 90 01 01 ff ff ff 6b c6 85 90 01 01 ff ff ff 00 90 00 } //1
