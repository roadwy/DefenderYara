...
rule Backdoor_Win32_Zegost_CL_bit{
	...
	strings :
		...
		$a_03_1 = {66 81 38 4d 5a 0f 85 f9 00 00 00 8b 70 3c 03 f0 81 3e 50 45 00 00 0f 85 e8 00 00 00 bf 00 20 00 00 8b 1d 90 01 03 00 6a 04 57 ff 76 90 01 01 ff 76 90 01 01 ff d3 90 00 } //1
		$a_03_2 = {03 4d 08 89 45 f4 51 50 e8 90 01 03 00 8b 45 f4 83 c4 0c 89 46 f8 8b 45 10 ff 45 fc 83 c6 28 8b 00 0f b7 40 06 39 45 fc 7c 90 00 } //1
