...
rule Backdoor_Win32_Zegost_CI_bit{
	...
	strings :
		...
		$a_03_1 = {4b c6 44 24 90 01 01 52 c6 44 24 90 01 01 4e c6 44 24 90 01 01 4c c6 44 24 90 01 01 33 c6 44 24 90 01 01 32 c6 44 24 90 01 01 2e 90 00 } //2
		$a_03_2 = {8b 03 8b c8 8b d0 c1 e9 90 01 01 c1 ea 90 01 01 8b f0 83 e1 01 83 e2 01 c1 ee 90 01 01 a9 90 01 04 74 15 90 00 } //1
...
rule Backdoor_Win32_Zegost_CI_bit_2{
	...
	strings :
		$a_03_0 = {8a 11 80 ea 90 01 01 8b 45 fc 03 45 f8 88 10 8b 4d fc 03 4d f8 8a 11 80 f2 90 01 01 8b 45 fc 03 45 f8 88 10 eb 90 00 } //1
