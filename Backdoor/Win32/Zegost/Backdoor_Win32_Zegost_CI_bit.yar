...
rule Backdoor_Win32_Zegost_CI_bit_2{
	...
	strings :
		...
		$a_01_1 = {53 68 65 6c 6c 65 78 00 } //01 00  桓汥敬x
		...
		$a_01_3 = {41 70 70 6c 69 63 61 74 69 6f 6e 73 5c 69 65 78 70 6c 6f 72 65 2e 65 78 65 5c 73 68 65 6c 6c 5c 6f 70 65 6e 5c 63 6f 6d 6d 61 6e 64 } //00 00  Applications\iexplore.exe\shell\open\command
	condition:
		any of ($a_*)
