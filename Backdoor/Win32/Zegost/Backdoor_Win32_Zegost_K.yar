...
rule Backdoor_Win32_Zegost_K{
	...
	strings :
		$a_02_0 = {b2 74 b1 5c 50 c6 44 24 90 01 01 53 c6 44 24 90 01 01 6f c6 44 24 90 01 01 66 90 00 } //1
		$a_02_1 = {b2 65 b0 73 51 c6 44 24 90 01 01 47 90 00 } //1
		$a_02_2 = {44 51 c6 44 24 90 01 01 65 c6 44 24 90 01 01 62 c6 44 24 90 01 01 75 90 00 } //1
	condition:
...
rule Backdoor_Win32_Zegost_K_2{
	...
	strings :
		$a_03_0 = {80 30 44 40 3d 90 01 04 72 f5 90 00 } //2
		...
		$a_02_5 = {57 69 6e 53 74 61 30 5c 44 65 66 61 75 6c 74 00 63 3a 5c 90 02 03 2e 65 78 65 90 00 } //1
