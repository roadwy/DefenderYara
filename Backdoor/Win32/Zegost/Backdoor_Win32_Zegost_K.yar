...
rule Backdoor_Win32_Zegost_K_2{
	...
	strings :
		...
		$a_01_1 = {68 6f 75 6e 74 68 69 63 6b 43 68 47 65 74 54 54 } //01 00  hounthickChGetTT
		$a_00_2 = {5c 5c 2e 5c 44 61 72 6b } //01 00  \\.\Dark
		$a_00_3 = {25 75 2e 31 39 33 2e 25 64 2e 25 64 } //01 00  %u.193.%d.%d
		$a_00_4 = {25 73 20 53 50 25 64 } //01 00  %s SP%d
