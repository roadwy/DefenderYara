...
rule Backdoor_Win32_Zegost_DB{
	...
	strings :
		...
		$a_01_2 = {6e 75 52 5c 6e 6f 69 73 72 65 56 74 6e 65 72 72 75 43 5c 73 77 6f 64 6e 69 57 5c 74 66 6f 73 6f 72 63 69 4d 5c 45 52 41 57 54 46 4f 53 00 } //00 00 
		$a_00_3 = {5d } //04 00 
	condition:
		any of ($a_*)
