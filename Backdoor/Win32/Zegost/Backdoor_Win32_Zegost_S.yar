...
rule Backdoor_Win32_Zegost_S{
	...
	strings :
		...
		$a_03_2 = {ff ff 83 fa 53 0f 85 90 01 02 00 00 0f be 85 90 01 02 ff ff 83 f8 50 0f 85 90 01 02 00 00 0f be 8d 90 01 02 ff ff 83 f9 36 0f 85 90 01 02 00 00 c6 85 64 90 01 02 ff 53 90 00 } //2
		$a_03_3 = {68 04 01 00 00 ff 15 90 01 04 c6 45 f8 25 c6 45 f9 73 c6 45 fa 5c c6 45 fb 25 c6 45 fc 64 c6 45 fd 00 90 00 } //2
	condition:
