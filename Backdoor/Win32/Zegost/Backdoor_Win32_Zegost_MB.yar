...
rule Backdoor_Win32_Zegost_MB{
	...
	strings :
		...
		$a_00_2 = {2e 76 69 72 2c 6d 61 69 6e 00 } //01 00 
		$a_00_3 = {25 73 5c 25 64 5f 6d 7a 2e 75 72 6c } //01 00 
		$a_00_4 = {47 6c 6f 62 61 6c 5c 7a 77 6a 20 25 64 } //01 00 
		$a_00_5 = {73 25 5c 73 65 63 69 76 72 65 73 5c 74 65 73 6c 6f 72 74 6e 6f 63 74 6e 65 72 72 75 63 5c 6d 65 74 73 79 73 } //01 00 
		$a_01_6 = {6d 6f 7a 68 65 55 70 64 61 74 65 } //01 00 
