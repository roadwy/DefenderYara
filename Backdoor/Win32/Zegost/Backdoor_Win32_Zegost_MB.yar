...
rule Backdoor_Win32_Zegost_MB{
	...
	strings :
		...
		$a_03_1 = {4d c6 44 24 90 01 01 6f c6 44 24 90 01 01 5a c6 44 24 90 01 01 68 90 00 } //2
		...
		$a_00_7 = {66 69 6c 65 3a 43 3a 5c 50 72 6f 67 72 61 7e 31 5c 25 25 50 72 6f 67 72 7e 31 5c 44 45 53 54 2e 42 41 54 00 } //1
	condition:
