...
rule Backdoor_Win32_Zegost_N{
	...
	strings :
		$a_03_0 = {53 c6 44 24 90 01 01 70 c6 44 24 90 01 01 69 c6 44 24 90 01 01 64 8b 54 24 90 01 01 8d 8e 90 01 04 c6 44 24 90 01 01 65 c6 44 24 90 01 01 72 90 00 } //2
		$a_03_1 = {7e 1a 53 8b 54 24 90 01 01 8a 1c 11 80 f3 90 01 01 88 1c 11 41 3b c8 7c ee 90 00 } //2
