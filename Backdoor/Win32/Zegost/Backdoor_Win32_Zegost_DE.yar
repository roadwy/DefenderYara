...
rule Backdoor_Win32_Zegost_DE{
	...
	strings :
		...
		$a_03_1 = {5c c6 44 24 90 01 01 6f c6 44 24 90 01 01 75 c6 44 24 90 01 01 72 c6 44 24 90 01 01 6c c6 44 24 90 01 01 6f c6 44 24 90 01 01 67 c6 44 24 90 01 01 2e c6 44 24 90 01 01 64 c6 44 24 90 01 01 61 c6 44 24 90 01 01 74 c6 44 24 90 01 01 00 ff 90 00 } //1
	condition:
...
rule Backdoor_Win32_Zegost_DE_2{
	...
	strings :
		$a_03_0 = {8a 11 32 54 90 01 02 8b 90 01 02 03 90 01 02 88 10 66 8b 90 01 02 66 83 c1 01 66 89 90 01 02 eb 90 00 } //2
