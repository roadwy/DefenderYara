...
rule Backdoor_Win32_Zegost_AY{
	...
	strings :
		...
		$a_01_5 = {54 57 39 36 61 57 78 73 59 53 38 30 4c 6a 41 67 4b 47 4e 76 62 58 42 68 64 47 6c 69 62 47 55 70 } //01 00  TW96aWxsYS80LjAgKGNvbXBhdGlibGUp
		$a_01_6 = {55 30 39 47 56 46 64 42 55 6b 56 63 51 57 68 75 54 47 46 69 58 46 59 7a 54 47 6c 30 5a 51 3d 3d } //01 00  U09GVFdBUkVcQWhuTGFiXFYzTGl0ZQ==
		$a_01_7 = {25 73 20 25 73 2c 41 4c 53 54 53 5f 45 78 65 63 75 74 65 41 63 74 69 6f 6e 00 } //01 00  猥┠ⱳ䱁呓当硅捥瑵䅥瑣潩n
		...
		$a_01_9 = {5c 36 43 34 44 41 36 46 42 5c 73 76 63 68 73 6f 74 2e 65 78 65 } //00 00  \6C4DA6FB\svchsot.exe
