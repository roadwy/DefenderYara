...
rule Backdoor_Win32_Zegost_BH{
	...
	strings :
		...
		$a_01_4 = {4c 49 4e 4e 55 58 20 50 41 53 53 57 52 4f } //01 00 
		$a_01_5 = {2d 2d 2d 3e 54 6f 20 4d 79 53 65 72 76 65 72 32 30 31 30 20 5e 5f 5e 20 5b 25 64 5d } //00 00 
		$a_00_6 = {5d 04 } //00 00 
	condition:
		any of ($a_*)
