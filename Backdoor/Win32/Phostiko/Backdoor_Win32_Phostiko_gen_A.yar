...
rule Backdoor_Win32_Phostiko_gen_A{
	...
	strings :
		$a_00_0 = {53 4f 46 54 57 41 52 45 5c 42 6f 72 6c 61 6e 64 5c 44 65 6c 70 68 69 } //03 00 
		...
		$a_00_2 = {48 65 69 2e 2e 21 20 77 68 6f 20 61 72 65 20 79 6f 75 3f } //01 00 
		$a_00_3 = {38 7a 65 72 6f 38 78 32 } //01 00 
		$a_00_4 = {49 20 6b 69 63 6b 20 75 2e 2e 2e } //01 00 
		$a_00_5 = {68 6f 73 74 69 70 6f 6b } //00 00 
	condition:
		any of ($a_*)
