...
rule Backdoor_Win32_Wolyx_B{
	...
	strings :
		$a_01_0 = {66 75 63 6b 79 6f 75 00 } //01 00  畦正潹u
		...
		$a_01_2 = {49 45 69 6e 66 6f 2e 64 6c 6c 00 57 53 50 53 74 61 72 74 75 70 00 } //00 00  䕉湩潦搮汬圀偓瑓牡畴p
...
rule Backdoor_Win32_Wolyx_B_2{
	...
	strings :
		...
		$a_01_2 = {41 44 31 38 42 42 34 35 42 32 37 43 38 39 34 36 41 44 31 39 41 30 37 36 38 45 37 34 39 34 35 38 41 45 32 39 41 30 35 42 42 32 34 37 38 38 34 37 41 46 30 32 41 31 35 41 38 44 37 37 38 45 } //00 00  AD18BB45B27C8946AD19A0768E749458AE29A05BB2478847AF02A15A8D778E
	condition:
		any of ($a_*)
