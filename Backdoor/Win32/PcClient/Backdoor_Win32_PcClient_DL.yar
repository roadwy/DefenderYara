...
rule Backdoor_Win32_PcClient_DL{
	...
	strings :
		...
		$a_00_2 = {6d 79 70 61 72 65 6e 74 74 68 72 65 61 64 69 64 } //01 00 
		$a_00_3 = {25 73 25 30 37 78 2e 69 6d 69 } //01 00 
		$a_00_4 = {47 6c 6f 62 61 6c 5c 70 73 25 30 37 78 } //01 00 
		$a_00_5 = {6a 65 61 6e 2e 35 32 30 38 31 35 2e 63 6f 6d 2f 6d 73 2f 69 70 2e 72 61 72 } //01 00 
		$a_00_6 = {74 68 75 6e 64 65 72 35 } //00 00 
	condition:
		any of ($a_*)
