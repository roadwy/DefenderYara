...
rule Backdoor_Win32_PcClient_DI{
	...
	strings :
		...
		$a_00_5 = {6d 79 74 68 72 65 61 64 69 64 } //01 00 
		$a_00_6 = {25 64 25 64 2e 65 78 65 } //01 00 
		$a_00_7 = {5c 73 76 63 68 6f 73 74 2e 65 78 65 20 2d 6b } //01 00 
		$a_00_8 = {5b 25 30 32 64 2d 25 30 34 64 2d 25 30 32 64 20 25 30 32 64 3a 25 30 32 64 3a 25 30 32 64 5d } //01 00 
		$a_00_9 = {50 4f 53 54 20 2f 25 73 20 48 54 54 50 2f 31 2e 31 } //00 00 
	condition:
		any of ($a_*)
