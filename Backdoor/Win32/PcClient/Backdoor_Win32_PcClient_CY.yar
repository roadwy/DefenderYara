...
rule Backdoor_Win32_PcClient_CY{
	...
	strings :
		...
		$a_00_2 = {48 69 70 48 6f 70 31 32 33 } //01 00 
		$a_00_3 = {4f 70 65 6e 53 65 72 76 69 63 65 41 } //01 00 
		$a_00_4 = {4f 70 65 6e 53 43 4d 61 6e 61 67 65 72 41 } //01 00 
		$a_00_5 = {44 6f 53 65 72 76 69 63 65 } //01 00 
		$a_00_6 = {75 70 64 61 74 65 65 76 65 6e 74 } //01 00 
		$a_00_7 = {64 72 69 76 65 72 73 5c } //01 00 
		$a_00_8 = {5c 73 76 63 68 6f 73 74 2e 65 78 65 } //00 00 
	condition:
		any of ($a_*)
