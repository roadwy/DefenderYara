...
rule Backdoor_Win32_PcClient_DX{
	...
	strings :
		$a_02_0 = {3d 25 64 3b 90 01 04 69 64 3d 25 73 90 00 } //2
		$a_02_1 = {47 6c 6f 62 61 6c 5c 25 73 2d 90 01 03 2d 90 00 } //2
		$a_02_2 = {70 61 73 73 90 02 07 6e 61 6d 65 90 02 07 70 6f 72 74 90 00 } //2
