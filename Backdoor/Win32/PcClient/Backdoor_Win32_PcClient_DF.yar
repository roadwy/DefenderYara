...
rule Backdoor_Win32_PcClient_DF{
	...
	strings :
		$a_02_0 = {ff ff 00 eb 0d 8b 85 90 01 02 ff ff 40 89 85 90 01 02 ff ff 83 bd 90 01 02 ff ff 06 7d 37 ff 15 90 01 04 99 6a 1a 59 f7 f9 8b 85 90 01 02 ff ff 88 94 90 01 02 fd ff ff 8b 85 90 01 02 ff ff 8a 84 90 01 02 fd ff ff 04 61 90 00 } //2
		$a_02_1 = {50 8b 45 08 05 f4 03 00 00 50 68 90 01 04 e8 90 01 02 00 00 83 c4 0c c6 85 90 01 02 ff ff 08 c6 85 90 01 02 ff ff 08 c6 85 90 01 02 ff ff 04 c6 85 90 01 02 ff ff 02 83 65 fc 00 ff 75 08 8b 45 08 05 06 05 00 00 50 90 00 } //2
