...
rule Backdoor_Win32_PcClient_CW{
	...
	strings :
		$a_00_0 = {53 65 72 76 69 63 65 4d 61 69 6e 00 } //01 00 
		$a_00_1 = {53 65 6e 73 4e 6f 74 69 66 79 4e 65 74 63 6f 6e 45 76 65 6e 74 00 } //01 00 
		$a_00_2 = {53 65 6e 73 4e 6f 74 69 66 79 52 61 73 45 76 65 6e 74 00 } //01 00 
		$a_00_3 = {53 65 6e 73 4e 6f 74 69 66 79 57 69 6e 6c 6f 67 6f 6e 45 76 65 6e 74 00 } //01 00 
