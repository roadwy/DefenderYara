...
rule Backdoor_Win32_PcClient_ZF{
	...
	strings :
		$a_02_0 = {5c 73 76 63 68 6f 73 74 2e 65 78 65 90 02 08 44 6f 53 65 72 76 69 63 65 90 02 06 75 70 64 61 74 65 65 76 65 6e 74 00 25 73 3d 00 2e 73 79 73 90 02 06 64 72 69 76 65 72 73 5c 90 02 06 2e 70 78 79 90 02 06 2e 64 72 76 90 02 06 2e 64 6c 6c 90 00 } //1
	condition:
		((#a_02_0  & 1)*1) >=1
...
rule Backdoor_Win32_PcClient_ZF_2{
	...
	strings :
		$a_03_0 = {83 fa 63 7c f6 6a 63 6a 00 8d 95 04 ff ff ff 52 e8 90 01 02 00 00 83 c4 0c 0f be 0e 83 f9 31 75 0e 8d 85 04 ff ff ff 50 6a 63 e8 90 01 02 00 00 0f be 16 83 fa 32 75 0e 90 00 } //1
