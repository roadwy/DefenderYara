...
rule Backdoor_Win32_PcClient_ZT_dll{
	...
	strings :
		$a_03_0 = {81 c2 2c 35 00 00 40 3b c1 89 15 90 01 04 7c dc 90 00 } //2
		$a_03_1 = {8b 50 3c 81 c5 90 01 01 3e 00 00 89 0d 90 01 04 89 2d 90 01 04 8b 54 02 50 83 c2 f8 90 00 } //1
