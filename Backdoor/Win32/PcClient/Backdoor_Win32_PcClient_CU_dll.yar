...
rule Backdoor_Win32_PcClient_CU_dll{
	...
	strings :
		$a_03_0 = {32 30 30 20 25 73 25 73 25 73 00 90 02 30 3e 20 6e 75 6c 00 90 02 30 43 4f 4d 53 50 45 43 90 00 } //3
		...
		$a_03_4 = {5c 53 79 73 74 65 6d 33 32 5c 64 72 69 76 65 72 73 5c 90 02 10 2e 73 79 73 00 90 00 } //3
