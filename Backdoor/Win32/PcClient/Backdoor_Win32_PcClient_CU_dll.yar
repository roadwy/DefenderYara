...
rule Backdoor_Win32_PcClient_CU_dll{
	...
	strings :
		...
		$a_01_1 = {67 6f 6f 67 31 65 2e } //03 00 
		$a_01_2 = {68 74 74 70 3a 2f 2f 25 73 3a 25 64 2f 25 73 25 64 25 30 38 64 } //03 00 
		$a_01_3 = {69 6e 64 65 78 2e 61 73 70 3f } //03 00 
		$a_03_4 = {5c 53 79 73 74 65 6d 33 32 5c 64 72 69 76 65 72 73 5c 90 02 10 2e 73 79 73 00 90 00 } //14 00 
		$a_01_5 = {43 72 65 61 74 65 52 65 6d 6f 74 65 54 68 72 65 61 64 } //14 00 
