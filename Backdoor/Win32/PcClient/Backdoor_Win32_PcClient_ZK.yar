...
rule Backdoor_Win32_PcClient_ZK{
	...
	strings :
		$a_03_0 = {78 c6 44 24 90 01 01 2e c6 44 24 90 01 01 61 c6 44 24 90 01 01 73 c6 44 24 90 01 01 70 c6 44 24 90 01 01 3f 90 00 } //3
		$a_03_1 = {c6 45 e7 65 c6 45 e8 78 c6 45 e9 2e 90 02 08 c6 45 ea 61 c6 45 eb 73 90 02 08 c6 45 ec 70 90 00 } //3
		$a_03_2 = {c6 45 e4 69 89 55 e5 c6 45 e5 6e 89 55 e9 90 02 08 c6 45 e7 65 89 55 90 01 01 c6 45 e8 78 90 02 04 c6 45 e9 2e 90 00 } //2
