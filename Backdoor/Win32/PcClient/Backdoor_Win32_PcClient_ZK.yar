...
rule Backdoor_Win32_PcClient_ZK{
	...
	strings :
		...
		$a_00_3 = {50 63 43 6c 69 65 6e 74 2e 64 6c 6c } //01 00 
		$a_00_4 = {32 30 30 00 25 73 25 73 25 73 } //01 00 
		$a_00_5 = {53 65 72 76 69 63 65 4d 61 69 6e } //01 00 
		$a_00_6 = {46 75 63 6b 5f 44 72 77 65 62 } //00 00 
	condition:
		any of ($a_*)
