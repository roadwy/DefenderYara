...
rule Backdoor_Win32_PcClient_T{
	...
	strings :
		...
		$a_00_1 = {64 72 69 76 65 72 73 5c } //01 00  drivers\
		$a_00_2 = {25 73 25 30 37 78 2e 69 6e 69 } //01 00  %s%07x.ini
		$a_00_3 = {47 6c 6f 62 61 6c 5c 70 73 25 30 38 78 } //00 00  Global\ps%08x
	condition:
		any of ($a_*)
