...
rule Backdoor_Win32_PcClient_ZN{
	...
	strings :
		$a_03_0 = {25 73 3d 00 2e 73 79 73 00 00 00 00 64 72 69 76 65 72 73 5c 00 90 02 05 2e 6b 65 79 00 00 00 00 2e 65 78 65 90 02 05 2e 73 63 6f 00 00 00 00 2e 70 72 6f 00 00 00 00 2e 64 6c 6c 90 00 } //4
