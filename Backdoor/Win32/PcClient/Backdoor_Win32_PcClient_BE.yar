...
rule Backdoor_Win32_PcClient_BE{
	...
	strings :
		...
		$a_03_1 = {51 8d 4e 0c 51 0f b7 0e 51 8d 4e 90 01 01 51 ff b6 90 01 02 00 00 ff b6 90 01 02 00 00 ff d0 83 c4 18 68 b8 0b 00 00 ff b6 58 03 00 00 ff 15 90 01 04 3d 02 01 00 00 90 00 } //1
	condition:
