...
rule Backdoor_Win32_PcClient_CI{
	...
	strings :
		$a_02_0 = {f3 ab 6a 02 6a 00 6a d0 ff b5 b8 fe ff ff ff 15 ?? ?? 40 00 83 65 ec 00 6a 00 8d 45 ec 50 6a 30 8d 85 bc fe ff ff 50 ff b5 b8 fe ff ff ff 15 ?? ?? 40 00 6a 30 8d 85 bc fe ff ff 50 e8 68 ?? ?? 00 59 59 8b 45 08 8b 8d c4 fe ff ff 89 08 8b 45 08 8b 8d c8 fe ff ff 89 48 04 8b 45 08 8b 8d cc fe ff ff 89 48 08 8b 45 08 8b 8d d0 fe ff ff 89 48 0c 8b 45 08 8b 8d d4 fe ff ff 89 48 10 0f b7 85 e0 fe ff ff 0f b7 8d da fe ff ff 03 c1 0f b7 8d d8 fe ff ff 03 c1 0f b7 8d dc fe ff ff 03 c1 0f b7 8d e4 fe ff ff 03 c1 0f b7 8d e2 fe ff ff 03 c1 0f b7 8d de fe ff ff 03 c1 0f b7 8d e6 fe ff ff 03 c1 0f b7 8d e8 fe ff ff } //1
		$a_02_1 = {43 3a 5c 57 49 4e 44 4f 57 53 5c 53 59 53 54 45 4d 33 32 5c ?? ?? ?? ?? ?? ?? ?? ?? 2e 64 6c 6c } //1
		$a_02_2 = {43 3a 5c 57 49 4e 44 4f 57 53 5c 53 59 53 54 45 4d 33 32 5c 64 72 69 76 65 72 73 5c ?? ?? ?? ?? ?? ?? ?? ?? 2e 73 79 73 } //1
		$a_02_3 = {43 3a 5c 57 49 4e 44 4f 57 53 5c 53 59 53 54 45 4d 33 32 5c ?? ?? ?? ?? ?? ?? ?? ?? 2e 64 72 76 } //1
