...
rule Backdoor_Win32_Remcos_ZL_MTB{
	...
	strings :
		$a_02_0 = {0f 8a 54 11 90 01 01 32 c2 5a 88 02 ff 06 4b 75 d1 90 09 19 00 8b 16 8d 44 10 90 01 01 50 8b 45 90 01 01 8b 16 8a 44 10 90 01 01 8b 16 2b 15 90 01 04 8b 90 00 } //1
