...
rule Backdoor_Win32_Uclinu_A{
	...
	strings :
		$a_03_0 = {55 55 55 53 55 55 51 55 ff 15 90 01 04 a0 14 56 40 00 b9 ff 01 00 00 88 84 24 98 02 00 00 33 c0 8d bc 24 99 02 00 00 8b 54 24 2c f3 ab 66 8b 0d 90 01 04 89 15 90 01 04 66 ab aa 66 89 8c 24 98 0a 00 00 b9 ff 03 00 00 33 c0 8d bc 24 9a 0a 00 00 f3 ab 88 1d 00 56 40 00 66 ab ff 15 90 00 } //1
