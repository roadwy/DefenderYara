...
rule Backdoor_Win32_Heloag_A{
	...
	strings :
		...
		$a_00_1 = {68 65 6c 6c 6f 41 67 65 6e 74 } //01 00  helloAgent
		$a_00_2 = {25 64 2d 25 64 2d 25 64 2d 25 64 2d 25 64 2e 68 74 6d } //01 00  %d-%d-%d-%d-%d.htm
		$a_00_3 = {25 73 5c 25 64 2d 25 64 2d 25 64 2d 25 64 2d 25 64 2e 65 78 65 } //01 00  %s\%d-%d-%d-%d-%d.exe
