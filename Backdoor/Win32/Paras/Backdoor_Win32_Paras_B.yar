...
rule Backdoor_Win32_Paras_B{
	...
	strings :
		$a_03_0 = {8a 1c 11 80 f3 11 88 1c 11 8b 55 90 01 01 80 04 11 89 90 00 } //2
		$a_01_1 = {99 b9 19 00 00 00 f7 f9 83 c2 61 52 } //1
		$a_02_2 = {b1 52 b0 75 c6 44 24 90 01 01 4c c6 44 24 90 01 01 6f c6 44 24 90 01 01 61 c6 44 24 90 01 01 64 90 00 } //1
