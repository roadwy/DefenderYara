...
rule Backdoor_Win32_Androme_MR_MTB{
	...
	strings :
		$a_03_0 = {8b 13 89 42 90 01 01 8b 03 8b 16 89 50 90 01 01 8b 03 89 06 83 03 90 01 01 8b 03 2b 45 90 01 01 3d 90 09 12 00 8b 03 c6 00 90 01 01 8b 45 90 01 01 8d 50 90 01 01 8b 03 e8 90 00 } //10
		$a_03_1 = {2b d0 8b c2 c3 90 09 03 00 83 c0 90 00 } //10
