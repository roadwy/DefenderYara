...
rule Backdoor_Win32_Deselia_A_dha{
	...
	strings :
		...
		$a_01_4 = {53 bb 00 00 00 00 b8 01 00 00 00 0f 3f 07 0b 85 db 0f 94 45 e7 5b } //1
		$a_00_5 = {b8 68 58 4d 56 bb 00 00 00 00 b9 0a 00 00 00 ba 58 56 00 00 ed 81 fb 68 58 4d 56 } //1
	condition:
