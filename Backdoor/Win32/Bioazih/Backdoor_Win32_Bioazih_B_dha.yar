...
rule Backdoor_Win32_Bioazih_B_dha_2{
	...
	strings :
		$a_01_0 = {64 00 73 00 73 00 65 00 6d 00 68 00 2e 00 64 00 6c 00 6c 00 } //02 00 
		$a_01_1 = {73 00 75 00 63 00 63 00 65 00 73 00 73 00 20 00 74 00 6f 00 20 00 6b 00 69 00 6c 00 6c 00 20 00 70 00 72 00 6f 00 63 00 65 00 73 00 73 00 } //02 00 
		$a_01_2 = {74 00 68 00 65 00 20 00 66 00 69 00 6c 00 65 00 20 00 72 00 65 00 63 00 76 00 20 00 65 00 72 00 72 00 6f 00 72 00 } //03 00 
		$a_01_3 = {73 00 75 00 63 00 63 00 65 00 73 00 73 00 20 00 74 00 6f 00 20 00 64 00 65 00 6c 00 65 00 74 00 65 00 20 00 66 00 69 00 6c 00 65 00 66 00 6f 00 72 00 64 00 65 00 72 00 } //00 00 
