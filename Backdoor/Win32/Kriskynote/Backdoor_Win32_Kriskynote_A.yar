...
rule Backdoor_Win32_Kriskynote_A{
	...
	strings :
		...
		$a_01_2 = {49 6e 73 74 61 6c 6c 5f 75 61 63 } //00 00 
	condition:
		any of ($a_*)
...
rule Backdoor_Win32_Kriskynote_A_2{
	...
	strings :
		...
		$a_11_1 = {00 79 00 73 00 74 00 65 00 6d 00 33 00 32 00 5c 00 4e 00 74 00 55 00 73 00 65 00 72 00 45 00 78 00 01 } //00 15 
		$a_8a_2 = {31 } //34 36 
