...
rule Backdoor_Win32_Wydtin_A{
	...
	strings :
		...
		$a_03_4 = {4c 4f 47 49 4e 90 02 20 45 48 4c 4f 20 25 73 90 00 } //1
		$a_01_5 = {4d 41 49 4c 20 46 52 4f 4d 3a 3c 25 73 3e } //1 MAIL FROM:<%s>
		$a_01_6 = {52 43 50 54 20 54 4f 3a 3c 25 73 3e } //1 RCPT TO:<%s>
		$a_03_7 = {61 74 74 61 63 68 6d 65 6e 74 90 02 10 66 69 6c 65 6e 61 6d 65 3d 25 73 90 00 } //1
...
rule Backdoor_Win32_Wydtin_A_2{
	...
	strings :
		$a_01_0 = {64 79 77 74 2e 63 6f 6d 2e 63 6e } //1 dywt.com.cn
		$a_01_1 = {3d 3f 67 62 32 33 31 32 3f 42 3f } //1 =?gb2312?B?
		$a_03_2 = {6b 72 6e 6c 6e 2e 66 6e 72 90 02 05 64 30 39 66 32 33 34 30 38 31 38 35 31 31 64 33 39 36 66 36 61 61 66 38 34 34 63 37 65 33 32 35 90 00 } //1
		$a_03_3 = {70 6f 70 33 90 02 05 36 36 33 39 31 33 34 45 38 32 33 34 34 36 33 37 41 37 31 41 42 31 44 36 42 37 30 43 32 30 35 31 90 00 } //1
		$a_03_4 = {69 6e 74 65 72 6e 65 74 90 02 05 37 30 37 63 61 33 37 33 32 32 34 37 34 66 36 63 61 38 34 31 66 30 65 32 32 34 66 34 62 36 32 30 90 00 } //1
		$a_03_5 = {4c 4f 47 49 4e 90 02 20 45 48 4c 4f 20 25 73 90 00 } //1
		$a_01_6 = {4d 41 49 4c 20 46 52 4f 4d 3a 3c 25 73 3e } //1 MAIL FROM:<%s>
		$a_01_7 = {52 43 50 54 20 54 4f 3a 3c 25 73 3e } //1 RCPT TO:<%s>
		$a_03_8 = {61 74 74 61 63 68 6d 65 6e 74 90 02 10 66 69 6c 65 6e 61 6d 65 3d 25 73 90 00 } //1
