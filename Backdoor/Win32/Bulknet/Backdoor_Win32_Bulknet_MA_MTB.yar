...
rule Backdoor_Win32_Bulknet_MA_MTB{
	...
	strings :
		...
		$a_01_2 = {55 6e 6d 61 70 56 69 65 77 4f 66 46 69 6c 65 } //01 00  UnmapViewOfFile
		$a_01_3 = {49 6e 74 65 72 6e 65 74 43 6f 6e 6e 65 63 74 57 } //00 00  InternetConnectW
	condition:
		any of ($a_*)
