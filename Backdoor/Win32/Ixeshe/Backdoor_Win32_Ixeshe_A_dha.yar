...
rule Backdoor_Win32_Ixeshe_A_dha{
	...
	strings :
		...
		$a_03_3 = {b9 08 00 00 00 b8 ae ae ae ae 8d 90 02 09 f3 ab 90 00 } //1
		$a_03_4 = {b9 e1 04 00 00 33 c0 8d bd 90 01 02 ff ff f3 ab 66 ab aa c6 85 90 01 02 ff ff 27 c6 85 90 01 02 ff ff 25 c6 85 90 01 02 ff ff 73 90 00 } //1
	condition:
