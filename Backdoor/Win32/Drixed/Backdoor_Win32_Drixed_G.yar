...
rule Backdoor_Win32_Drixed_G{
	...
	strings :
		$a_03_0 = {8b 5c d6 10 8b 6c d6 14 33 d8 89 5c 24 90 02 01 33 ef 89 7c 24 90 02 01 89 6c 24 90 02 01 8b e9 89 04 24 8b 74 24 90 02 01 8b 4c 24 90 02 01 8b 5c 24 90 02 01 8b 7c 24 90 02 01 0f be 44 2c 90 02 01 85 c0 75 07 46 3b f7 7f 12 eb 08 3b f7 75 04 88 04 19 41 45 83 fd 08 72 e2 eb 9d 90 00 } //10
