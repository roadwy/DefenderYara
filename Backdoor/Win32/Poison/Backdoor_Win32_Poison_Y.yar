...
rule Backdoor_Win32_Poison_Y{
	...
	strings :
		...
		$a_01_2 = {54 57 65 62 43 61 6d 54 68 72 65 61 64 } //01 00 
		$a_01_3 = {54 44 6f 77 6e 46 69 6c 65 54 68 72 65 61 64 } //01 00 
		$a_01_4 = {54 53 63 72 65 65 6e 53 70 79 } //01 00 
		$a_01_5 = {00 2e 6b 6c 67 00 } //01 00 
