...
rule Backdoor_Win32_Poison_Y{
	...
	strings :
		$a_03_0 = {7e 25 bf 01 00 00 00 8d 45 f8 8b 55 fc 8a 54 3a ff 80 f2 90 01 01 e8 90 01 02 fe ff 8b 55 f8 8b c6 e8 90 01 02 fe ff 47 4b 75 e0 90 00 } //3
		$a_03_1 = {74 58 b8 61 09 00 00 e8 90 01 02 ff ff 89 45 00 33 c0 89 07 6a 00 57 68 60 09 00 00 90 00 } //2
		...
		$a_03_6 = {5c 5c 2e 5c 50 68 79 73 69 63 61 6c 44 72 69 76 65 30 00 00 90 02 05 2e 5c 53 4d 41 52 54 56 53 44 90 00 } //1
	condition:
