...
rule Backdoor_Win32_Poison_BD{
	...
	strings :
		$a_03_0 = {33 c0 8a 88 90 01 04 80 f1 90 01 01 88 8c 05 90 01 04 40 83 f8 40 72 ea 33 c0 8a 88 90 01 04 80 f1 90 01 01 88 4c 05 90 01 01 40 83 f8 40 72 ed 90 00 } //5
