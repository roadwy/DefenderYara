...
rule Backdoor_Win32_Poison_P{
	...
	strings :
		$a_03_0 = {eb 11 c7 85 90 01 04 63 6b 73 3d c6 86 90 01 04 01 90 00 } //2
		...
		$a_02_4 = {e8 2e 00 00 00 53 4f 46 54 57 41 52 45 5c 4d 69 63 72 6f 73 6f 66 74 5c 57 69 6e 64 6f 77 73 5c 43 75 72 72 65 6e 74 56 65 72 73 69 6f 6e 5c 72 75 6e 00 57 ff 96 90 02 04 80 be 90 02 04 01 75 07 b9 02 00 00 80 90 00 } //2
	condition:
