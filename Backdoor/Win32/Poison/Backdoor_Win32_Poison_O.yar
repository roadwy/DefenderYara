...
rule Backdoor_Win32_Poison_O{
	...
	strings :
		...
		$a_00_1 = {53 74 61 72 74 53 65 72 76 69 63 65 41 } //01 00  StartServiceA
		$a_00_2 = {52 65 67 53 65 74 56 61 6c 75 65 45 78 41 } //01 00  RegSetValueExA
		$a_00_3 = {47 65 74 53 68 6f 72 74 50 61 74 68 4e 61 6d 65 41 } //01 00  GetShortPathNameA
		$a_00_4 = {47 65 74 46 69 6c 65 54 69 6d 65 } //01 00  GetFileTime
		$a_00_5 = {47 65 74 46 69 6c 65 53 69 7a 65 } //01 00  GetFileSize
