...
rule Backdoor_Win32_Poison_BE_2{
	...
	strings :
		$a_01_0 = {69 64 3d 25 73 26 69 64 3d 25 73 26 69 64 3d 25 73 26 69 64 3d 25 73 26 69 64 3d 25 73 26 69 64 3d 25 73 } //02 00 
		...
		$a_01_3 = {4f 70 65 6e 20 48 4f 53 54 5f 55 52 4c 20 65 72 72 6f 72 } //01 00 
		$a_01_4 = {56 53 54 25 64 2e 25 64 2e 25 64 2e 25 73 } //00 00 
	condition:
		any of ($a_*)
