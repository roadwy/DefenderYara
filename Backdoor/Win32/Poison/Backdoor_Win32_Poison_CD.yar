...
rule Backdoor_Win32_Poison_CD{
	...
	strings :
		...
		$a_03_1 = {56 2b c8 8d 72 01 8a 14 90 01 01 80 f2 90 01 01 88 10 40 4e 75 90 01 01 5e c3 90 00 } //1
...
rule Backdoor_Win32_Poison_CD_2{
	...
	strings :
		$a_03_0 = {33 c0 85 f6 90 01 02 03 cb 8a 54 07 90 01 01 32 14 29 40 3b c6 88 90 01 03 8b 4c 24 90 01 01 8b 54 24 90 01 01 8d 42 90 01 01 3b d8 90 01 02 51 68 90 01 04 ff 15 90 01 04 8b 4c 90 01 02 8b 54 90 01 02 83 c4 90 01 01 43 3b da 72 90 00 } //1
		$a_03_1 = {77 11 8a 98 90 01 04 32 da 80 eb 90 01 01 88 98 90 01 04 8d bc 06 90 01 04 81 ff 90 01 04 77 11 8a 98 90 01 04 32 d9 80 eb 90 01 01 88 98 90 01 04 83 c0 90 01 01 3d 90 01 04 7e 90 00 } //1
	condition:
...
rule Backdoor_Win32_Poison_CD_3{
	...
	strings :
		...
		$a_02_1 = {73 74 75 62 70 61 74 68 90 01 04 73 6f 66 74 77 61 72 65 5c 63 6c 61 73 73 65 73 5c 68 74 74 70 5c 73 68 65 6c 6c 5c 6f 70 65 6e 5c 63 6f 6d 6d 61 6e 64 76 90 00 } //3
