...
rule Backdoor_Win32_Poison_CB_dha{
	...
	strings :
		...
		$a_03_1 = {6b 61 73 70 65 72 73 6b 79 90 02 04 61 6c 77 69 6c 90 00 } //1
		$a_00_2 = {5c 5c 2e 5c 56 42 6f 78 4d 69 6e 69 52 64 72 44 4e } //1 \\.\VBoxMiniRdrDN
		$a_03_3 = {43 75 72 72 65 6e 74 56 65 72 73 69 6f 6e 5c 52 75 6e 90 02 04 25 73 5c 25 73 2e 6c 6e 6b 90 00 } //1
