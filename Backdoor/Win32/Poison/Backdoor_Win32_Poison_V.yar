...
rule Backdoor_Win32_Poison_V{
	...
	strings :
		...
		$a_01_3 = {54 4d 79 53 76 72 } //02 00 
		$a_01_4 = {54 4d 79 54 68 64 } //02 00 
		$a_01_5 = {54 4d 79 53 70 79 } //02 00 
		$a_01_6 = {54 4d 79 41 75 64 } //02 00 
		$a_01_7 = {54 4d 79 43 61 6d } //00 00 
	condition:
		any of ($a_*)
