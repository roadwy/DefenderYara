...
rule Backdoor_Win32_Poison_E_2{
	...
	strings :
		...
		$a_02_1 = {e8 09 00 00 00 61 64 76 61 70 69 33 32 00 ff 90 01 04 ff 90 03 01 01 89 09 90 01 04 ff e8 06 00 00 00 6e 74 64 6c 6c 00 ff 90 01 04 ff 89 90 01 04 ff e8 07 00 00 00 75 73 65 72 33 32 00 ff 90 00 } //1
		...
		$a_02_3 = {56 8d 86 6b 09 00 00 50 8d 86 45 01 00 00 50 ff 96 fd 00 00 00 e8 90 01 01 00 00 00 77 73 32 5f 33 32 00 58 50 ff 96 9d 00 00 00 90 01 01 86 c3 0a 00 00 e8 3a 00 00 00 e1 60 90 00 } //2
		$a_02_4 = {e8 08 00 00 00 61 64 76 70 61 63 6b 00 ff 95 90 01 02 ff ff 68 6b 37 04 7e 50 6a 00 e8 90 01 03 ff 6a 00 6a 00 ff d0 90 03 01 01 88 08 85 90 01 02 ff ff 68 0e 03 e5 e6 ff b5 90 01 02 ff ff 6a 00 e8 90 01 03 ff 0b c0 75 12 68 94 2c d5 87 ff b5 90 01 02 ff ff 6a 00 e8 90 01 03 ff 89 85 90 01 02 ff ff 90 00 } //3
