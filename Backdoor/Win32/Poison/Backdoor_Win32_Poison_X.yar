...
rule Backdoor_Win32_Poison_X{
	...
	strings :
		$a_01_0 = {6d 5f 53 74 75 62 } //01 00 
		$a_01_1 = {66 69 6c 65 2e 65 78 65 } //01 00 
		...
		$a_01_4 = {46 69 6e 64 52 65 73 6f 75 72 63 65 41 } //01 00 
		$a_01_5 = {43 72 65 61 74 65 4d 75 74 65 78 41 } //01 00 
		$a_01_6 = {6a 40 68 00 30 00 00 } //01 00 
		$a_01_7 = {6a 00 6a 00 6a 04 6a 00 6a 00 6a 00 } //01 00 
