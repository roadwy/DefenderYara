...
rule Backdoor_Win32_Poison_BG{
	...
	strings :
		$a_01_0 = {69 6f 71 3d 25 73 26 69 6f 71 3d 25 73 26 69 6f 71 3d 25 73 26 69 6f 71 3d 25 73 00 } //01 00 
		...
		$a_01_6 = {4f 70 65 6e 20 48 4f 53 54 5f 55 52 4c 20 65 72 72 6f 72 00 } //00 00 
	condition:
		any of ($a_*)
