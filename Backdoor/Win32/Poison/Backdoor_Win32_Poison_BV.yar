...
rule Backdoor_Win32_Poison_BV{
	...
	strings :
		...
		$a_03_2 = {61 72 64 2e 65 78 65 00 90 02 02 61 76 67 75 00 90 00 } //1
		$a_03_3 = {83 c9 ff f2 ae f7 d1 2b f9 6a 03 8b f7 8b d9 8b fa 83 c9 ff f2 ae 8b cb 4f c1 e9 02 f3 a5 8b cb 50 83 e1 03 6a 01 8d 90 02 06 68 00 00 00 80 f3 a4 50 90 00 } //1
	condition:
