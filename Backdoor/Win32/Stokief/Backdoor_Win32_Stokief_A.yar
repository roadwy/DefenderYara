...
rule Backdoor_Win32_Stokief_A{
	...
	strings :
		...
		$a_01_2 = {2f 70 75 62 6c 69 63 5f 68 74 6d 6c 2f 6b 6c 6f 67 2f 25 73 2f 00 6b 65 79 6c 6f 67 2e 6c 6f 67 } //01 00  瀯扵楬彣瑨汭欯潬⽧猥/敫汹杯氮杯
		$a_01_3 = {69 6e 66 65 63 74 61 6e 64 6f 20 64 69 73 63 6f 20 6c 6f 63 61 6c 2e 2e 2e } //00 00  infectando disco local...
	condition:
		any of ($a_*)
