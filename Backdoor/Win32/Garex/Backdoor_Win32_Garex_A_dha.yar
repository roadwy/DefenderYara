...
rule Backdoor_Win32_Garex_A_dha{
	...
	strings :
		...
		$a_01_2 = {50 79 74 68 6f 6e 54 68 72 65 61 64 53 74 61 72 74 } //02 00 
		$a_01_3 = {53 4f 46 54 57 41 52 45 5c 4d 69 63 72 6f 73 6f 66 74 5c 57 69 6e 64 6f 77 73 20 55 70 64 61 74 65 20 52 65 70 6f 72 74 69 6e 67 } //02 00 
		$a_01_4 = {7b 36 37 42 44 45 35 44 37 2d 43 32 46 43 2d 38 38 39 38 2d 39 30 39 36 2d 43 32 35 35 41 42 37 39 31 42 37 35 7d } //02 00 
		$a_01_5 = {7b 41 43 36 33 34 30 32 38 2d 39 42 46 32 2d 34 61 36 38 2d 38 43 39 33 2d 46 35 31 35 44 41 38 39 33 37 37 39 7d } //00 00 
