...
rule Backdoor_Win32_Darkddoser_A{
	...
	strings :
		$a_01_0 = {48 54 54 50 20 46 6c 6f 6f 64 20 41 63 74 69 76 65 } //01 00 
		...
		$a_01_3 = {64 61 72 6b 64 64 6f 73 65 72 } //01 00 
		$a_01_4 = {53 59 4e 20 46 6c 6f 6f 64 20 41 63 74 69 76 65 } //00 00 
	condition:
		any of ($a_*)
