...
rule Backdoor_Win32_Darkddoser_E{
	...
	strings :
		...
		$a_01_1 = {28 2a 2e 65 78 65 29 7c 2a 2e 65 78 65 7c 63 6f 6d 20 28 2a 2e 63 6f 6d 29 7c 2a 2e 63 6f 6d 7c 70 69 66 20 28 2a 2e 70 69 66 29 7c 2a 2e 70 69 66 } //01 00  (*.exe)|*.exe|com (*.com)|*.com|pif (*.pif)|*.pif
		$a_01_2 = {64 61 72 6b 64 64 6f 73 65 72 } //05 00  darkddoser
