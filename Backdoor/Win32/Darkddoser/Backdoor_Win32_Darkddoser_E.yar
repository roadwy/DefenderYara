...
rule Backdoor_Win32_Darkddoser_E{
	...
	strings :
		$a_03_0 = {55 44 50 7c 90 02 19 53 59 4e 7c 90 02 10 48 54 54 50 7c 90 00 } //1
		...
		$a_03_3 = {0f b6 08 2a 0a 75 90 01 01 53 8b 58 fc 2b 5a fc 53 83 d1 ff 21 d9 2b 48 fc 29 c8 29 ca 8b 1c 01 33 1c 11 90 00 } //5
	condition:
