...
rule Backdoor_Win32_Darkddoser_B{
	...
	strings :
		$a_03_0 = {0f b6 08 2a 0a 75 ?? 53 8b 58 fc 2b 5a fc 53 83 d1 ff 21 d9 2b 48 fc 29 c8 29 ca 8b 1c 01 33 1c 11 } //5
		...
		$a_03_7 = {73 76 63 68 6f 73 74 2e 65 78 65 [0-10] 44 61 52 4b } //1
	condition:
