...
rule Backdoor_Win32_Darkddoser_B{
	...
	strings :
		...
		$a_01_1 = {53 54 41 54 55 53 7c 45 78 65 63 75 74 } //01 00 
		$a_01_2 = {53 54 41 54 55 53 7c 49 64 6c 65 } //01 00 
		$a_01_3 = {53 54 41 54 55 53 7c 44 6f 77 6e 6c 6f 61 64 } //01 00 
		$a_01_4 = {53 54 41 54 55 53 7c 46 6c 6f 6f 64 } //01 00 
		$a_01_5 = {64 61 72 6b 64 64 6f 73 65 72 } //01 00 
		$a_01_6 = {53 54 4f 50 46 4c 4f 4f 44 } //01 00 
