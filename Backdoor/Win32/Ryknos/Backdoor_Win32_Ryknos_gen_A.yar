...
rule Backdoor_Win32_Ryknos_gen_A{
	...
	strings :
		...
		$a_01_6 = {69 66 20 65 78 69 73 74 20 22 22 43 3a 5c 6d 79 61 70 70 2e 65 78 65 22 22 20 67 6f 74 6f } //01 00 
		$a_01_7 = {6e 65 74 73 68 20 66 69 72 65 77 61 6c 6c 20 73 65 74 } //01 00 
		$a_01_8 = {64 65 6c 20 22 43 3a 5c 54 45 4d 50 5c } //01 00 
		$a_01_9 = {25 73 5c 65 64 25 73 2e 25 73 } //01 00 
		$a_01_10 = {50 52 49 56 4d 53 47 } //00 00 
	condition:
		any of ($a_*)
