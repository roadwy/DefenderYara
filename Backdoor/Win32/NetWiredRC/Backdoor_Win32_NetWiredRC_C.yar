...
rule Backdoor_Win32_NetWiredRC_C{
	...
	strings :
		$a_01_0 = {73 65 6c 65 63 74 20 2a 20 20 66 72 6f 6d 20 6d 6f 7a 5f 6c 6f 67 69 6e 73 00 } //01 00  敳敬瑣⨠†牦浯洠穯江杯湩s
		...
		$a_01_6 = {5b 42 61 63 6b 73 70 61 63 65 5d 00 5b 45 6e 74 65 72 5d 00 5b 54 61 62 5d 00 } //01 00  䉛捡獫慰散]䕛瑮牥]呛扡]
		$a_01_7 = {25 73 07 25 73 07 25 73 07 25 49 36 34 75 07 25 49 36 34 75 07 25 49 36 34 75 07 } //01 00 
		$a_01_8 = {57 49 4e 4e 54 00 4c 41 4e 4d 41 4e 4e 54 00 53 45 52 56 45 52 4e 54 00 } //01 00  䥗乎T䅌䵎乁呎匀剅䕖乒T
