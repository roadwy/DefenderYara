...
rule Backdoor_Win32_Plugx_K_dha_2{
	...
	strings :
		...
		$a_03_2 = {68 8b c4 5d 63 56 a3 90 01 04 e8 90 01 02 ff ff 68 b2 bb 55 3a 56 a3 90 01 04 e8 90 01 02 ff ff 68 5a 6e db db 56 a3 90 01 04 e8 90 01 02 ff ff 90 00 } //1
		$a_03_3 = {8a 4f 01 47 84 c9 75 f8 8b c8 c1 e9 02 8b f2 f3 a5 8b c8 83 e1 03 8d 85 90 01 04 f3 a4 8d 48 01 8a 10 40 84 d2 75 90 01 01 2b c1 80 90 01 05 ff 5c 90 00 } //1
	condition:
