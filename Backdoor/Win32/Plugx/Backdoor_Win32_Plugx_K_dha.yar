...
rule Backdoor_Win32_Plugx_K_dha{
	...
	strings :
		...
		$a_01_1 = {43 00 6f 00 6e 00 66 00 69 00 67 00 2e 00 77 00 61 00 76 00 } //0a 00 
		$a_01_2 = {7b 42 32 38 45 30 45 37 38 2d 38 38 32 44 2d 34 30 33 63 2d 41 46 34 45 2d 42 44 45 43 39 43 38 46 41 33 37 42 7d } //00 00 
...
rule Backdoor_Win32_Plugx_K_dha_2{
	...
	strings :
		$a_00_0 = {43 61 6e 27 74 20 66 69 6e 64 20 46 75 6e 63 20 30 78 25 78 20 69 6e 20 25 73 21 } //01 00 
