...
rule Backdoor_Win32_Plugx_H{
	...
	strings :
		...
		$a_03_10 = {66 83 3b 25 56 57 75 90 01 01 66 83 7b 02 41 75 90 01 01 66 83 7b 04 55 75 90 01 01 66 83 7b 06 54 75 90 01 01 66 83 7b 08 4f 75 90 01 01 66 83 7b 0a 25 90 00 } //10
		$a_03_11 = {80 3c 07 44 75 90 01 01 80 7c 07 01 5a 75 90 01 01 80 7c 07 02 4a 75 90 01 01 80 7c 07 03 53 90 00 } //10
	condition:
