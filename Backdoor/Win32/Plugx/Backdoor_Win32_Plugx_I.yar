...
rule Backdoor_Win32_Plugx_I{
	...
	strings :
		...
		$a_03_3 = {68 00 00 00 80 57 ff 15 90 01 02 00 10 83 f8 ff 74 2f 56 8d 4d fc 51 53 57 50 ff 15 90 01 02 00 10 85 c0 74 1d 53 56 57 6a 00 ff 55 90 01 01 5f 5e 5f 8b 35 90 01 02 00 10 6a ff ff d6 6a ff ff d6 6a ff ff d6 90 00 } //1
	condition:
