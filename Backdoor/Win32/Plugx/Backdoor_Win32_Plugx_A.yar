...
rule Backdoor_Win32_Plugx_A{
	...
	strings :
		...
		$a_03_1 = {75 61 6c 41 c7 90 02 10 6c 6c 6f 63 90 00 } //5
		$a_03_2 = {45 78 69 74 c7 85 90 01 01 ff ff ff 54 68 72 65 66 c7 85 90 01 01 ff ff ff 61 64 90 00 } //5
...
rule Backdoor_Win32_Plugx_A_2{
	...
	strings :
		...
		$a_03_1 = {75 61 6c 41 c7 85 90 01 01 ff ff ff 6c 6c 6f 63 90 00 } //2
		$a_03_2 = {45 78 69 74 c7 85 90 01 01 ff ff ff 54 68 72 65 66 c7 85 90 01 01 ff ff ff 61 64 90 00 } //2
