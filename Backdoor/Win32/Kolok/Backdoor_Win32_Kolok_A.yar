...
rule Backdoor_Win32_Kolok_A{
	...
	strings :
		...
		$a_01_2 = {25 32 62 75 69 6c 64 3d 25 31 26 76 65 72 73 69 6f 6e 3d 32 2e 30 2e 46 69 78 26 63 6f 6e 6e 65 63 74 3d 31 } //01 00 
		$a_01_3 = {25 76 78 25 68 78 25 62 70 70 20 2d 20 25 66 } //0a 00 
