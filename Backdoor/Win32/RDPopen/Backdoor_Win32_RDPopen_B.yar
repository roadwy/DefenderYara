...
rule Backdoor_Win32_RDPopen_B{
	...
	strings :
		...
		$a_02_2 = {2b c2 03 45 90 01 01 99 b9 1a 00 00 00 f7 f9 0f be 45 90 01 01 03 d0 8b 4d 90 01 01 88 11 90 00 } //1
	condition:
...
rule Backdoor_Win32_RDPopen_B_2{
	...
	strings :
		$a_03_0 = {6a 06 6a 01 6a 02 8b 85 90 01 04 8b 88 84 01 00 00 ff d1 90 00 } //1
		$a_03_1 = {ff d0 3d 33 27 00 00 75 90 01 01 6a 05 8b 4d 08 8b 91 24 01 00 00 ff d2 eb 90 01 01 33 c0 90 00 } //1
