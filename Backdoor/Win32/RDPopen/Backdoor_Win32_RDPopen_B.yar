...
rule Backdoor_Win32_RDPopen_B{
	...
	strings :
		...
		$a_01_1 = {57 69 6e 64 6f 77 2d 52 50 43 20 48 6f 73 2d 53 65 72 76 69 63 65 } //01 00  Window-RPC Hos-Service
...
rule Backdoor_Win32_RDPopen_B_2{
	...
	strings :
		...
		$a_00_2 = {7c 67 65 74 68 6f 73 74 6e 61 6d 65 } //01 00  |gethostname
		$a_00_3 = {6a 69 65 66 68 68 66 75 66 68 } //01 00  jiefhhfufh
		$a_00_4 = {68 64 32 68 30 38 30 68 63 68 } //00 00  hd2h080hch
	condition:
		any of ($a_*)
