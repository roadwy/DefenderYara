...
rule Backdoor_Win32_Farfli_AQ{
	...
	strings :
		...
		$a_01_7 = {3c 48 31 3e 34 30 33 20 46 6f 72 62 69 64 64 65 6e 3c 2f 48 31 3e } //05 00  <H1>403 Forbidden</H1>
		$a_01_8 = {74 74 70 3a 2f 2f 31 32 37 2e 30 2e 30 2e 31 3a 38 38 38 38 2f 69 70 2e 74 78 74 } //00 00  ttp://127.0.0.1:8888/ip.txt
