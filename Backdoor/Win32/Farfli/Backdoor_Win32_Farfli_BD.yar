...
rule Backdoor_Win32_Farfli_BD{
	...
	strings :
		...
		$a_03_3 = {b4 d8 ff ff 90 09 10 00 e8 90 01 02 00 00 83 c4 0c 3b c3 75 40 81 7c 24 90 00 } //1
		$a_03_4 = {51 8d 54 24 90 01 01 52 bb 90 03 01 01 9e 91 01 00 00 e8 90 00 } //4
	condition:
