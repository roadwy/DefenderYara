...
rule Backdoor_Win32_Farfli_BX_MTB{
	...
	strings :
		...
		$a_01_1 = {43 3a 5c 73 79 73 6c 6f 67 2e 64 61 74 } //02 00  C:\syslog.dat
		$a_01_2 = {43 63 4d 61 69 6e 44 6c 6c 2e 64 6c 6c } //01 00  CcMainDll.dll
		$a_01_3 = {54 65 73 74 46 75 6e } //00 00  TestFun
	condition:
		any of ($a_*)
