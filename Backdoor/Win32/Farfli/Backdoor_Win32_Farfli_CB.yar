...
rule Backdoor_Win32_Farfli_CB{
	...
	strings :
		...
		$a_03_2 = {95 bf 8e 4e 0e ec e8 ?? ?? ff ff 83 ec 04 83 2c 24 3c e9 } //1
		$a_03_3 = {89 34 24 bf 98 fe 8a 0e e8 ?? ff ff ff 83 ec 04 83 2c 24 70 83 ec 64 bf 72 fa 4d db } //1
		$a_03_4 = {bf 54 ca af 91 e8 ?? fe ff ff 6a 04 68 00 10 00 00 6a 44 6a 00 ff d0 } //1
	condition:
