...
rule Backdoor_Win32_Farfli_A{
	...
	strings :
		$a_01_0 = {2e 66 61 72 66 6c 79 2e 6f 72 67 2f 74 6a 2f } //03 00 
		$a_01_1 = {4e 6f 77 20 69 73 20 74 68 65 20 74 69 6d 65 20 66 6f 72 20 61 6c 6c } //03 00 
		$a_01_2 = {77 68 61 74 20 64 6f 20 79 61 20 77 61 6e 74 20 66 6f 72 20 6e 6f 74 68 69 6e 67 3f } //01 00 
		$a_01_3 = {53 4f 46 54 57 41 52 45 5c 4d 69 63 72 6f 73 6f 66 74 5c 49 45 34 5c } //01 00 
		$a_01_4 = {2e 74 78 74 3f } //03 00 
		$a_01_5 = {73 65 74 75 70 69 64 3d 25 64 26 6d 61 63 3d 25 73 } //03 00 
		$a_01_6 = {26 74 79 70 65 3d 25 64 26 76 65 72 73 69 6f 6e 3d } //03 00 
		$a_01_7 = {26 74 64 5f 72 64 3d 25 64 26 68 70 5f 31 3d 25 73 } //01 00 
		$a_01_8 = {5c 5c 2e 5c 47 6c 6f 62 61 6c 5c 43 6c 61 6e 41 76 62 } //01 00 
		$a_00_9 = {45 78 70 6c 6f 72 65 72 5f 53 65 72 76 65 72 } //03 00 
		$a_01_10 = {34 33 66 36 39 63 63 39 2d 38 30 30 37 2d 34 62 } //00 00 
	condition:
		any of ($a_*)
