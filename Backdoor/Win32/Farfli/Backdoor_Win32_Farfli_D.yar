...
rule Backdoor_Win32_Farfli_D{
	meta:
		description = "Backdoor:Win32/Farfli.D,SIGNATURE_TYPE_PEHSTR_EXT,09 00 09 00 07 00 00 04 00 "
		
	strings :
		$a_02_0 = {68 00 00 01 c0 ff 75 08 ff 15 90 01 02 40 00 89 85 d0 fd ff ff 83 bd d0 fd ff ff ff 75 04 33 c0 eb 30 8d 85 ec fe ff ff 90 00 } //04 00 
