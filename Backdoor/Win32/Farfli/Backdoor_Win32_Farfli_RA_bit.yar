...
rule Backdoor_Win32_Farfli_RA_bit{
	...
	strings :
		...
		$a_01_1 = {53 79 73 74 65 6d 25 63 25 63 25 63 2e 65 78 65 } //01 00  System%c%c%c.exe
		$a_01_2 = {58 58 4f 4f 58 58 4f 4f 3a 25 73 7c 25 64 7c 25 64 7c 25 73 } //00 00  XXOOXXOO:%s|%d|%d|%s
	condition:
		any of ($a_*)
