...
rule Backdoor_Win32_Webdor_AJ{
	...
	strings :
		$a_00_0 = {53 6f 66 74 77 61 72 65 5c 43 61 74 } //01 00 
		$a_00_1 = {54 55 70 64 61 74 65 43 6d 64 } //01 00 
		$a_00_2 = {54 45 78 65 63 75 74 65 43 6d 64 } //01 00 
		$a_00_3 = {54 43 6d 64 43 6d 64 } //01 00 
		$a_00_4 = {54 54 61 67 43 6d 64 } //01 00 
		$a_00_5 = {54 4e 65 77 55 72 6c 43 6d 64 } //01 00 
