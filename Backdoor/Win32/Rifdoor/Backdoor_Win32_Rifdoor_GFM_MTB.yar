...
rule Backdoor_Win32_Rifdoor_GFM_MTB{
	...
	strings :
		...
		$a_01_1 = {55 52 4c 4f 70 65 6e 42 6c 6f 63 6b 69 6e 67 53 74 72 65 61 6d } //01 00  URLOpenBlockingStream
		...
		$a_01_3 = {5c 50 72 6f 67 72 61 6d 44 61 74 61 5c 55 70 64 61 74 65 5c 57 77 61 6e 53 76 63 2e 65 78 65 } //00 00  \ProgramData\Update\WwanSvc.exe
	condition:
		any of ($a_*)
