...
rule Backdoor_Win32_Visel_gen_A{
	...
	strings :
		$a_02_0 = {81 ec 34 02 00 00 a1 ?? ?? 40 00 53 55 56 bd 01 00 00 00 55 68 ?? ?? 40 00 89 84 24 44 02 00 00 e8 ?? ?? ff ff 83 c4 08 8d 44 24 18 50 6a 28 c7 44 24 20 00 00 00 00 ff 15 ?? ?? 40 00 50 ff 15 ?? ?? 40 00 85 c0 74 4a 8d 4c 24 20 51 68 ?? ?? 40 00 6a 00 ff 15 ?? ?? 40 00 85 c0 74 34 8b 54 24 20 8b 44 24 24 6a 00 6a 00 6a 10 8d 4c 24 34 51 89 54 24 3c 8b 54 24 28 6a 00 52 89 6c 24 40 89 44 24 48 c7 44 24 4c 02 00 00 00 ff 15 28 b0 40 00 8d 44 24 38 50 8d 4c 24 20 51 6a 00 68 3f 00 0f 00 6a 00 68 ?? ?? 40 00 6a 00 68 ?? ?? 40 00 68 02 00 00 80 ff 15 ?? ?? 40 00 } //100
