...
rule Backdoor_Win32_Koceg_gen_E{
	...
	strings :
		...
		$a_02_5 = {8b 45 08 03 45 fc 0f be 00 33 45 ?? 8b 4d 08 03 4d fc 88 01 eb } //1
		$a_02_6 = {8b 45 08 03 45 fc 0f be 00 35 ?? ?? ?? ?? 8b 4d 08 03 4d fc 88 01 eb } //1
		$a_02_7 = {8b 45 08 03 45 ?? 0f be 00 0f be 4d fc 33 ?? 8b 4d f8 03 4d f4 88 41 fe eb } //1
	condition:
