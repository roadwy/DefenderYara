...
rule Backdoor_Win32_Koceg_gen_C{
	...
	strings :
		...
		$a_01_6 = {6f 63 30 63 68 67 30 3a 2c 72 6a 72 } //01 00 
		$a_01_7 = {67 7a 72 6e 6d 70 67 70 2c 66 6e 6e } //01 00 
		$a_01_8 = {23 53 6e 69 66 66 } //01 00 
		$a_01_9 = {26 65 6d 61 69 6c 73 3d } //01 00 
		$a_01_10 = {26 63 69 70 3d 00 } //01 00 
		$a_01_11 = {26 6c 69 64 3d 00 } //00 00 
	condition:
		any of ($a_*)
