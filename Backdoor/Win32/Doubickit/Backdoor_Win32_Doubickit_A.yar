...
rule Backdoor_Win32_Doubickit_A{
	...
	strings :
		...
		$a_03_2 = {50 8d 85 bc ca ff ff 50 e8 ?? ?? ?? ?? 83 c4 08 c7 85 bc cb ff ff 51 00 00 00 8d 55 d4 52 6a 00 8d 8d a4 c9 ff ff 51 68 fc 14 40 00 6a 00 6a 00 e8 ?? ?? ?? ?? ff 75 ec e8 } //1
