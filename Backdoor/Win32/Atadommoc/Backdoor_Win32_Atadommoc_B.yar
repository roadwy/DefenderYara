...
rule Backdoor_Win32_Atadommoc_B{
	...
	strings :
		...
		$a_01_2 = {63 6f 6d 6d 6f 6e 2e 64 61 74 61 } //01 00  common.data
		$a_01_3 = {4a 6f 62 3a 3a 44 65 63 72 79 70 74 } //01 00  Job::Decrypt
		$a_01_4 = {43 4f 44 45 5f 53 4e 41 50 28 29 } //01 00  CODE_SNAP()
		$a_01_5 = {46 6f 72 6b 49 6e 53 70 6f 6f 6c 28 29 3a } //00 00  ForkInSpool():
	condition:
		any of ($a_*)
