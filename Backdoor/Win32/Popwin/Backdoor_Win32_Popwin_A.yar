...
rule Backdoor_Win32_Popwin_A{
	...
	strings :
		...
		$a_02_8 = {be 00 10 40 00 b9 04 00 00 00 8b f9 81 fe 90 01 04 7f 10 ac 47 04 18 2c 02 73 f0 29 3e 03 f1 03 f9 eb e8 ba 00 00 40 00 8d b2 90 01 02 00 00 8b 46 0c 85 c0 90 02 06 03 c2 8b 7e 10 8b 1e 85 db 75 02 8b df 03 da 03 fa 52 57 50 ff 15 90 00 } //5
	condition:
