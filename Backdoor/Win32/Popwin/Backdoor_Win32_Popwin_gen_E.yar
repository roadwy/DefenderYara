...
rule Backdoor_Win32_Popwin_gen_E{
	...
	strings :
		...
		$a_00_1 = {44 65 6c 65 74 65 55 72 6c 43 61 63 68 65 45 6e 74 72 79 } //01 00  DeleteUrlCacheEntry
		...
		$a_00_4 = {77 77 77 2e 33 36 30 2e 63 6e } //9c ff  www.360.cn
		$a_00_5 = {33 36 30 73 61 66 65 75 70 6c 6f 61 64 5f 6d 75 74 65 78 } //00 00  360safeupload_mutex
	condition:
		any of ($a_*)
