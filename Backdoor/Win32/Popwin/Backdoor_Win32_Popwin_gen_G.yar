...
rule Backdoor_Win32_Popwin_gen_G{
	...
	strings :
		...
		$a_03_1 = {7e 4e bb 01 00 00 00 8b 45 fc 8a 44 18 ff 24 0f 8b 55 e8 8a 54 32 ff 80 e2 0f 32 c2 88 45 f7 8d 45 fc e8 90 01 04 8b 55 fc 8a 54 1a ff 80 e2 f0 8a 4d f7 02 d1 88 54 18 ff 90 00 } //1
