...
rule Backdoor_Win32_Wkysol_F{
	...
	strings :
		...
		$a_01_2 = {3f 61 31 3d 25 73 26 61 32 3d 25 73 26 61 33 3d 25 64 26 61 35 3d 25 73 26 61 34 3d 25 73 26 61 36 3d 25 } //01 00 
		$a_01_3 = {4a 41 47 45 58 4c 41 55 4e 43 48 45 52 2e 45 58 45 } //01 00 
		$a_01_4 = {47 75 61 72 64 43 6f 72 65 2e 64 6c 6c } //01 00 
		$a_00_5 = {57 54 46 5c 43 6f 6e 66 69 67 2e 77 74 66 } //00 00 
	condition:
		any of ($a_*)
