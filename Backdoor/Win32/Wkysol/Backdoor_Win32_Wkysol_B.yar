...
rule Backdoor_Win32_Wkysol_B{
	...
	strings :
		...
		$a_01_4 = {6b 79 73 5f 61 6c 6c 6f 77 5f 67 65 74 2e 61 73 70 3f 6e 61 6d 65 3d 67 65 74 6b 79 73 2e 6b 79 73 } //01 00 
		$a_01_5 = {6b 79 73 5f 61 6c 6c 6f 77 5f 70 75 74 2e 61 73 70 3f 74 79 70 65 3d } //01 00 
		$a_01_6 = {50 49 44 3a 25 35 64 20 20 20 20 50 41 54 48 3a 25 73 } //00 00 
	condition:
		any of ($a_*)
