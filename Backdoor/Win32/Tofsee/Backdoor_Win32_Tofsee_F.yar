...
rule Backdoor_Win32_Tofsee_F{
	...
	strings :
		$a_03_0 = {8b 54 24 04 8b 44 24 08 53 56 b3 90 01 01 8d 34 02 eb 14 0f b6 0a 8b c1 c1 e8 03 c0 e1 05 0a c1 32 c3 88 02 8a d8 42 3b d6 72 e8 90 00 } //4
		$a_03_1 = {8b 4c 24 04 8b 54 24 08 56 b0 90 01 01 8d 34 11 eb 14 30 01 0f b6 11 8b c2 c1 e8 05 c0 e2 03 0a c2 88 01 34 c6 41 3b ce 72 e8 90 00 } //4
