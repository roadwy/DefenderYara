...
rule Backdoor_Win32_Tofsee_gen_B{
	...
	strings :
		...
		$a_01_1 = {67 68 65 67 64 6a 66 00 } //01 00  桧来橤f
		$a_00_2 = {6e 65 74 73 68 20 66 69 72 65 77 61 6c 6c 20 73 65 74 20 61 6c 6c 6f 77 65 64 70 72 6f 67 72 61 6d 20 22 25 73 22 20 45 4e 41 42 4c 45 } //01 00  netsh firewall set allowedprogram "%s" ENABLE
		$a_01_3 = {5f 50 41 53 53 57 44 5f 00 } //01 00 
		$a_01_4 = {5f 41 43 43 5f 00 } //01 00  䅟䍃_
		$a_01_5 = {68 74 74 70 25 73 3a 2f 2f 25 73 25 73 25 73 25 73 25 73 00 } //00 00  瑨灴猥⼺┯╳╳╳╳s
	condition:
		any of ($a_*)
