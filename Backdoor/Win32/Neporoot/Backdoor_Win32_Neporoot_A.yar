...
rule Backdoor_Win32_Neporoot_A{
	...
	strings :
		$a_03_0 = {b9 3f 00 00 00 33 c0 8d 7c 24 90 01 01 8d 54 24 90 01 01 f3 ab 66 ab aa bf 90 01 04 83 c9 ff 33 c0 53 f2 ae f7 d1 2b f9 8b c1 8b f7 8b fa 8d 54 24 90 01 01 c1 e9 02 f3 a5 8b c8 33 c0 83 e1 03 f3 a4 8d bc 24 90 00 } //2
