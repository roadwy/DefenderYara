...
rule Backdoor_Win32_Dumadoor_BN{
	...
	strings :
		$a_00_0 = {6f 63 6b 73 2f 62 6f 74 } //01 00 
		$a_00_1 = {26 6d 61 63 68 69 6e 65 69 64 3d } //01 00 
		$a_00_2 = {53 6f 66 74 77 61 72 65 5c 53 41 52 53 } //01 00 
		$a_00_3 = {3f 63 6d 64 5f 61 6c 61 72 6d 3d } //01 00 
		$a_00_4 = {66 74 70 70 61 73 73 77 6f 72 64 3a } //01 00 
		$a_00_5 = {5c 6e 65 74 64 78 2e 64 61 74 } //01 00 
		$a_00_6 = {5c 77 6d 70 6c 61 79 65 72 2e 65 78 65 } //02 00 
