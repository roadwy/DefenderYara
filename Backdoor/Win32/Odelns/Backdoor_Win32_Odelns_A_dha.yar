...
rule Backdoor_Win32_Odelns_A_dha{
	...
	strings :
		...
		$a_01_1 = {2d 2d 2d 5b 20 25 73 20 5d 2d 2d 2d 25 34 64 2f 25 30 32 64 2f 25 30 32 64 20 25 30 32 64 3a 25 30 32 64 3a 25 30 32 64 } //01 00  ---[ %s ]---%4d/%02d/%02d %02d:%02d:%02d
