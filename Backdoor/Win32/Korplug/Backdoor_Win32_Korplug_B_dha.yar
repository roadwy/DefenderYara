...
rule Backdoor_Win32_Korplug_B_dha{
	...
	strings :
		$a_03_0 = {33 c0 f2 ae f7 d1 49 51 68 90 01 04 e8 90 01 04 83 c4 08 33 c0 b9 19 00 00 00 8d 7c 90 01 02 50 50 50 50 f3 ab 68 90 01 04 c7 44 90 01 02 00 00 00 00 ff 15 90 00 } //3
