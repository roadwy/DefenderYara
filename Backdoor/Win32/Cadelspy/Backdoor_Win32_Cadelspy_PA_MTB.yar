...
rule Backdoor_Win32_Cadelspy_PA_MTB{
	meta:
		description = "Backdoor:Win32/Cadelspy.PA!MTB,SIGNATURE_TYPE_PEHSTR_EXT,04 00 04 00 04 00 00 "
		
	strings :
		$a_03_0 = {50 6a 00 6a 00 6a 00 6a 00 6a 00 6a 00 68 20 02 00 00 6a 20 6a 02 8d 45 ?? 66 ?? ?? ?? ?? 05 50 } //1
		...
		$a_01_2 = {43 00 3a 00 5c 00 57 00 69 00 6e 00 64 00 6f 00 77 00 73 00 5c 00 53 00 79 00 73 00 45 00 76 00 65 00 6e 00 74 00 2e 00 65 00 78 00 65 00 } //1 C:\Windows\SysEvent.exe
		$a_03_3 = {5c 70 69 65 63 65 6f 66 73 68 69 74 5c [0-10] 5c 70 69 65 63 65 6f 66 73 68 69 74 2e 70 64 62 } //1
	condition:
