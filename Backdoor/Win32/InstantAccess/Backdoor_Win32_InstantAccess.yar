...
rule Backdoor_Win32_InstantAccess{
	...
	strings :
		...
		$a_02_2 = {65 67 61 63 63 65 73 73 90 02 03 2e 44 4c 4c 90 00 } //1
...
rule Backdoor_Win32_InstantAccess_2{
	...
	strings :
		$a_03_0 = {59 85 c0 59 0f 85 90 01 02 00 00 8d 85 90 01 02 ff ff 68 90 01 04 50 ff 15 90 01 02 40 00 59 85 c0 59 0f 85 90 01 02 00 00 90 01 01 8d 85 90 01 02 ff ff 56 50 e8 90 01 02 00 00 83 c4 0c 8d 85 90 01 02 ff ff 90 01 01 50 ff 15 90 01 02 40 00 8d 85 90 01 02 ff ff 68 90 01 04 50 ff 15 90 01 02 40 00 90 00 } //10
		$a_02_1 = {5c 45 78 65 44 69 61 6c 65 72 2e 65 78 65 90 02 10 65 78 65 64 69 61 6c 65 72 90 02 10 69 6e 73 74 61 6e 74 20 61 63 63 65 73 73 2e 65 78 65 90 00 } //1
		$a_02_2 = {5c 49 6e 73 74 61 6e 74 20 41 63 63 65 73 73 5c 43 65 6e 74 65 72 5c 90 02 10 43 44 69 61 6c 65 72 45 58 45 44 6c 67 3a 3a 43 72 65 61 74 65 53 68 6f 72 74 43 75 74 28 29 90 00 } //1
	condition:
...
rule Backdoor_Win32_InstantAccess_3{
	...
	strings :
		...
		$a_02_3 = {65 67 61 63 63 65 73 73 90 02 03 2e 44 4c 4c 90 00 } //1
		$a_02_4 = {49 6e 73 74 61 6e 74 41 63 63 65 73 73 90 02 05 4f 70 65 6e 41 63 63 65 73 73 90 02 05 52 65 67 69 73 74 65 72 45 58 45 90 02 05 65 63 6e 68 65 90 02 05 65 73 77 68 65 90 02 05 65 75 68 77 65 90 02 05 69 65 64 69 73 63 6f 90 02 05 73 64 73 90 00 } //1
		$a_02_5 = {4f 00 72 00 69 00 67 00 69 00 6e 00 61 00 6c 00 46 00 69 00 6c 00 65 00 6e 00 61 00 6d 00 65 00 90 02 06 49 00 6e 00 73 00 74 00 61 00 6e 00 74 00 20 00 41 00 63 00 63 00 65 00 73 00 73 00 2e 00 65 00 78 00 65 00 90 02 10 50 00 72 00 69 00 76 00 61 00 74 00 65 00 42 00 75 00 69 00 6c 00 64 00 90 02 09 50 00 72 00 6f 00 64 00 75 00 63 00 74 00 4e 00 61 00 6d 00 65 00 90 02 06 41 00 70 00 70 00 6c 00 69 00 63 00 61 00 74 00 69 00 6f 00 6e 00 90 02 06 49 00 6e 00 73 00 74 00 61 00 6e 00 74 00 20 00 41 00 63 00 63 00 65 00 73 00 73 00 90 00 } //5
	condition:
