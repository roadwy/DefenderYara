...
rule Backdoor_Win32_Beksnoc_A{
	...
	strings :
		$a_03_0 = {09 c0 74 13 3d e3 00 00 00 74 0c 0f b6 04 90 01 01 35 e3 00 00 00 88 04 90 00 } //1
		$a_01_1 = {0f b6 04 18 8b 55 fc 0f b6 54 15 e9 01 da 31 d0 88 45 fb 80 7d fb 00 } //1
		$a_03_2 = {83 f8 01 74 5e c6 45 90 01 01 26 c6 45 90 01 01 6c c6 45 90 01 01 70 c6 45 90 01 01 25 c6 45 90 01 01 75 c6 45 90 01 01 3d c6 45 90 01 01 25 c6 45 90 01 01 73 c6 45 90 01 01 00 90 00 } //1
		...
		$a_03_5 = {6a 53 6a 4f 6a 46 68 90 01 04 8d 85 4c f7 ff ff 50 e8 90 00 } //1
		...
		$a_03_18 = {09 c0 75 31 c6 90 01 01 45 c6 90 01 01 01 53 c6 90 01 01 02 3a c6 90 01 01 03 53 c6 90 01 01 04 4d c6 90 01 01 05 53 c6 90 01 01 06 53 c6 90 01 01 07 5f c6 90 01 01 08 42 c6 90 01 01 09 55 90 00 } //1
	condition:
