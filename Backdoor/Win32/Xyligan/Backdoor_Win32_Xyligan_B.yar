...
rule Backdoor_Win32_Xyligan_B{
	...
	strings :
		...
		$a_03_3 = {8b 44 24 10 50 ff d3 b9 41 00 00 00 33 c0 8d bc 24 90 01 04 8d 94 24 90 01 04 f3 ab bf 90 01 03 00 83 c9 ff f2 ae f7 d1 2b f9 8b c1 8b f7 8b fa c1 e9 02 f3 a5 8b c8 83 e1 03 f3 a4 8d 4c 24 24 33 ed 51 68 3f 00 0f 00 8d 94 24 90 01 04 55 52 68 02 00 00 80 90 00 } //5
	condition:
