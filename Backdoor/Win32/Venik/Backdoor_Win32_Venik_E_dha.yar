...
rule Backdoor_Win32_Venik_E_dha{
	...
	strings :
		$a_01_0 = {63 61 63 6c 73 2e 65 78 65 20 63 3a 5c } //fe ff 
		$a_01_1 = {2f 73 65 61 72 63 68 3f 68 6c 3d 65 6e 26 71 } //01 00 
		$a_00_2 = {5c 53 79 73 74 65 6d 33 32 5c 73 76 63 68 6f 73 74 2e 65 78 65 20 2d 6b } //01 00 
		$a_01_3 = {00 49 6e 73 74 61 6c 6c 00 52 75 6e } //01 00 
