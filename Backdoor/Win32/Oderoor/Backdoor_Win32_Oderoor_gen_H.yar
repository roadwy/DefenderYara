...
rule Backdoor_Win32_Oderoor_gen_H{
	...
	strings :
		$a_03_0 = {b8 01 00 00 00 f0 0f c1 01 40 83 3d 90 01 03 00 00 75 08 8d 85 00 ff ff ff eb 06 90 00 } //1
		$a_03_1 = {8a 85 00 ff ff ff 0a c0 74 09 83 3d 90 01 03 00 00 76 e6 90 00 } //1
