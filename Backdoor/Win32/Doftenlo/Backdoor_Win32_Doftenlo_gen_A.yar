...
rule Backdoor_Win32_Doftenlo_gen_A{
	...
	strings :
		$a_03_0 = {33 c0 8a 88 90 01 04 30 0c 37 40 83 f8 09 72 f1 83 3d 90 01 04 00 74 03 f6 14 37 56 47 e8 90 01 04 3b f8 59 72 d7 90 00 } //1
		$a_03_1 = {68 0c 17 00 00 57 8d 04 40 ff 34 85 90 01 04 e8 90 01 04 83 c4 0c 85 c0 74 af 90 00 } //1
