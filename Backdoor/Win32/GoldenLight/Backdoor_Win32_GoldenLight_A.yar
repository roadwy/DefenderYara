...
rule Backdoor_Win32_GoldenLight_A{
	...
	strings :
		...
		$a_01_3 = {2a 2a 74 78 74 78 2a 2a } //01 00 
		$a_01_4 = {5c 61 6c 67 2e 65 78 65 } //01 00 
		$a_80_5 = {54 4d 50 2e 42 41 54 } //TMP.BAT  01 00 
		$a_01_6 = {69 6d 72 70 69 2e 65 78 65 } //01 00 
		$a_80_7 = {7e 44 43 58 41 4f 38 2e 74 6d 70 } //~DCXAO8.tmp  01 00 
		$a_01_8 = {43 3a 5c 54 45 4d 50 5c 48 69 73 74 6f 72 79 5c 48 69 73 74 6f 72 79 2e 49 45 35 5c 77 73 6e 63 74 66 79 2e 65 78 65 } //01 00 
		$a_01_9 = {73 4f 66 74 57 61 72 45 5c 4d 49 63 72 4f 73 4f 66 74 5c 57 49 6e 64 4f 77 53 5c 43 75 72 52 65 6e 54 56 65 52 73 69 4f 6e 5c 52 75 4e } //00 00 
