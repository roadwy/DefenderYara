...
rule Backdoor_Win32_Telemot_D{
	...
	strings :
		$a_03_0 = {75 28 83 bd 90 01 02 ff ff 40 73 1f 8b 95 90 01 02 ff ff 8b 45 0c 89 84 95 90 01 02 ff ff 8b 8d 90 1b 00 ff ff 83 c1 01 89 8d 90 1b 00 ff ff 33 d2 85 d2 90 00 } //2
