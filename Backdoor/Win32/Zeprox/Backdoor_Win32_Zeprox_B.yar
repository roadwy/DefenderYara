...
rule Backdoor_Win32_Zeprox_B{
	...
	strings :
		$a_03_0 = {8b 00 8b f0 85 f6 7e 38 c7 45 90 01 01 01 00 00 00 8b 45 90 01 01 8b 55 90 01 01 0f b6 44 10 ff 83 e8 20 8b df 33 d8 83 c3 20 8d 45 90 01 01 8b d3 e8 90 01 02 ff ff 8b 55 90 01 01 8d 45 90 01 01 e8 90 01 02 ff ff 47 ff 45 90 01 01 4e 75 cf 90 00 } //2
