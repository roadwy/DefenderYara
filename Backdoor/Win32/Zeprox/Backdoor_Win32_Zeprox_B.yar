...
rule Backdoor_Win32_Zeprox_B{
	...
	strings :
		...
		$a_01_1 = {53 76 63 32 64 6c 6c } //01 00 
		$a_01_2 = {23 6a 6e 64 } //01 00 
		$a_01_3 = {5c 41 70 70 6c 69 63 61 74 69 6f 6e 20 44 61 74 61 5c 4d 61 63 72 6f 6d 65 64 69 61 5c 46 6c 61 73 68 20 50 6c 61 79 65 72 5c 23 53 68 61 72 65 64 4f 62 6a 65 63 74 73 } //00 00 
		$a_00_4 = {80 10 } //00 00 
	condition:
		any of ($a_*)
