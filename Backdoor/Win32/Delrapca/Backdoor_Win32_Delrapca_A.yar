...
rule Backdoor_Win32_Delrapca_A{
	...
	strings :
		...
		$a_01_2 = {3c 62 72 3e 20 53 79 73 40 55 73 65 72 20 3a 20 25 73 40 25 73 20 28 25 73 29 } //01 00 
		$a_01_3 = {25 73 3f 61 72 67 31 3d 25 73 26 61 72 67 32 3d 25 73 26 61 72 67 33 3d 25 73 } //00 00 
	condition:
		any of ($a_*)
