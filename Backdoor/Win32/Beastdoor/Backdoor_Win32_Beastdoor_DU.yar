...
rule Backdoor_Win32_Beastdoor_DU{
	...
	strings :
		...
		$a_01_3 = {53 41 4d 5c 41 } //01 00 
		$a_00_4 = {5c 73 68 65 6c 6c 5c 6f 70 65 6e 5c 63 6f 6d 6d 61 6e 64 } //01 00 
		$a_00_5 = {48 61 72 64 77 61 72 65 5c 44 65 73 63 72 69 70 74 69 6f 6e 5c 53 79 73 74 65 6d 5c 43 65 6e 74 72 61 6c 50 72 6f 63 65 73 73 6f 72 5c 30 } //01 00 
		$a_00_6 = {7e 7e 7e 7e 7e 7e 7e 7e 7e 7e 7e 7e 20 42 6f 6f 74 3a 5b } //01 00 
		$a_00_7 = {2a 70 61 73 73 2a } //00 00 
	condition:
		any of ($a_*)
