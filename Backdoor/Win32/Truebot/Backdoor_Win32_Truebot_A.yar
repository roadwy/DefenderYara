...
rule Backdoor_Win32_Truebot_A{
	...
	strings :
		...
		$a_01_4 = {55 00 70 00 73 00 73 00 73 00 2e 00 20 00 50 00 72 00 6f 00 63 00 65 00 73 00 73 00 20 00 65 00 78 00 69 00 74 00 20 00 63 00 6f 00 64 00 65 00 } //00 00  Upsss. Process exit code
