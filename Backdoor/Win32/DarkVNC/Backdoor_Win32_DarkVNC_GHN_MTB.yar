...
rule Backdoor_Win32_DarkVNC_GHN_MTB{
	...
	strings :
		$a_03_0 = {57 54 53 51 c7 44 24 90 01 01 75 65 72 79 c7 44 24 90 01 01 53 65 73 73 c7 44 24 90 01 01 69 6f 6e 49 c7 44 24 90 01 01 6e 66 6f 72 c7 44 24 90 01 01 6d 61 74 69 c7 44 24 90 01 01 6f 6e 57 00 ff d6 90 00 } //10
