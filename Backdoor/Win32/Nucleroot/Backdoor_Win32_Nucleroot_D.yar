...
rule Backdoor_Win32_Nucleroot_D{
	...
	strings :
		...
		$a_00_1 = {68 74 74 70 3a 2f 2f 77 77 77 2e 63 75 74 65 71 71 2e 63 6e 2f 3f 66 72 6f 6d 3d } //01 00 
		$a_00_2 = {2e 53 68 65 6c 6c 45 78 65 63 75 74 65 28 77 77 77 63 75 74 65 71 71 63 6e 2c 27 20 2f 63 20 27 2b } //01 00 
