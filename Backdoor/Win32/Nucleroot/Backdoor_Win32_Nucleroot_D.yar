...
rule Backdoor_Win32_Nucleroot_D{
	...
	strings :
		$a_02_0 = {68 74 74 70 3a 2f 2f 77 77 77 2e 63 75 74 65 71 71 2e 63 6e 2f 90 02 10 2e 65 78 65 90 00 } //1
		...
		$a_03_3 = {89 4d fc c7 45 f8 90 01 04 c7 45 f4 90 01 04 c7 45 f0 90 01 04 c7 45 ec 90 01 04 68 90 01 04 68 90 01 04 e8 90 01 02 00 00 83 c4 08 89 45 e8 90 00 } //1
	condition:
