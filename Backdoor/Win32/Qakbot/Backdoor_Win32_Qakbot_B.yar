...
rule Backdoor_Win32_Qakbot_B{
	...
	strings :
		$a_01_0 = {5f 71 62 6f 74 69 6e 6a 2e 65 78 65 } //1 _qbotinj.exe
		$a_01_1 = {5f 71 62 6f 74 2e 64 6c 6c } //1 _qbot.dll
		$a_01_2 = {5f 71 62 6f 74 6e 74 69 2e 65 78 65 } //1 _qbotnti.exe
		$a_01_3 = {6d 61 64 77 61 79 2e 6e 65 74 2f 75 2f 75 70 64 61 74 65 73 } //1 madway.net/u/updates
