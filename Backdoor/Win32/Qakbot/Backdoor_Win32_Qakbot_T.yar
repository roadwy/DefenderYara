...
rule Backdoor_Win32_Qakbot_T{
	...
	strings :
		...
		$a_01_5 = {20 75 73 65 72 3d 5b 25 73 5d 20 70 61 73 73 3d 5b 25 73 5d } //00 00 
		$a_00_6 = {78 08 } //01 00 
	condition:
		any of ($a_*)
...
rule Backdoor_Win32_Qakbot_T_2{
	...
	strings :
		...
		$a_01_4 = {53 74 6f 70 51 62 6f 74 54 68 72 65 61 64 28 29 3a 20 77 61 69 74 69 6e 67 20 6f 6e 20 73 7a 51 62 6f 74 52 75 6e 4d 75 74 65 78 3d 27 25 73 27 } //01 00 
