...
rule Backdoor_Win32_Qakbot_gen_A{
	...
	strings :
		$a_03_0 = {7d 29 8b 45 08 03 45 f8 0f be 08 8b 45 f8 99 f7 7d f0 0f be 82 90 01 04 33 c8 88 4d fc 8b 45 08 90 00 } //2
		$a_03_1 = {7d 1f 8b 45 fc 99 f7 7d f4 8b 45 08 03 45 fc 8a 00 32 82 90 01 04 8b 4d 08 03 4d fc 88 01 eb d2 90 00 } //2
		$a_03_2 = {75 0c c7 45 08 fd ff ff ff e9 67 01 00 00 56 68 00 04 00 00 68 90 01 04 ff 75 f8 53 90 00 } //2
		$a_03_3 = {e9 03 02 00 00 6a 00 68 00 04 00 00 68 90 01 04 ff 75 f4 ff b5 90 00 } //2
