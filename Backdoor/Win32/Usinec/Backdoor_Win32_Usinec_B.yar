...
rule Backdoor_Win32_Usinec_B{
	...
	strings :
		$a_03_0 = {8b 00 ff d0 69 de 90 01 02 00 00 89 84 1d 90 01 02 ff ff 89 bc 1d 90 01 02 ff ff 89 bc 1d 90 01 02 ff ff 8d 45 fc 50 a1 90 01 04 8b 00 b9 06 00 00 00 ba 01 00 00 00 90 00 } //1
