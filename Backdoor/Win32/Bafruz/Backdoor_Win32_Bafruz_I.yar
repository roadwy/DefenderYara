...
rule Backdoor_Win32_Bafruz_I{
	...
	strings :
		$a_00_0 = {64 64 6f 73 5f 68 74 74 70 5f 6c 69 73 74 } //01 00  ddos_http_list
		$a_00_1 = {4b 41 56 5f 53 54 41 52 54 } //01 00  KAV_START
		...
		$a_01_4 = {77 5f 64 69 73 74 72 69 62 5f 69 70 6c 69 73 74 2e 74 78 74 } //01 00  w_distrib_iplist.txt
