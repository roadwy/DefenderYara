...
rule Backdoor_Win32_Bafruz_J{
	...
	strings :
		$a_03_0 = {80 7b 0d 00 74 c2 33 c0 90 09 19 00 75 0d 53 68 90 01 04 8b c3 e8 90 01 04 68 90 01 04 e8 90 00 } //2
		...
		$a_03_3 = {b9 40 42 0f 00 ba 3b d9 00 00 b8 90 01 04 e8 90 01 04 84 c0 75 90 01 01 c6 05 90 01 04 00 eb 90 00 } //2
	condition:
