...
rule Backdoor_Win32_Bafruz_E{
	...
	strings :
		...
		$a_03_6 = {ba e8 fd 00 00 b8 10 27 00 00 e8 90 01 04 a3 90 01 04 c6 05 90 01 04 01 8d 4d 90 00 } //2
		$a_03_7 = {b8 17 f6 00 00 e8 90 01 04 68 88 13 00 00 e8 90 00 } //2
	condition:
