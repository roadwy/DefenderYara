...
rule Backdoor_Win32_Bafruz_O{
	...
	strings :
		$a_03_0 = {6a 50 68 10 27 00 00 6a 01 6a 00 8d 90 01 02 50 8d 90 01 02 b8 90 01 04 e8 90 00 } //1
		$a_03_1 = {67 65 74 5f 69 70 5f 70 61 79 5f 6e 65 65 64 62 6c 6f 63 6b 90 02 05 2e 70 68 70 90 00 } //2
