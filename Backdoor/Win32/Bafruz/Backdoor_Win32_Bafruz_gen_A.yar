...
rule Backdoor_Win32_Bafruz_gen_A{
	...
	strings :
		...
		$a_03_8 = {6a 50 68 10 27 00 00 6a 01 6a 00 8d 90 01 02 50 90 02 0b b8 90 01 04 e8 90 00 } //2
		...
		$a_03_11 = {8b 45 08 8b 00 e8 90 01 04 3d c2 01 00 00 7d 90 01 01 6a 50 68 10 27 00 00 6a 01 6a 00 90 00 } //1
	condition:
