...
rule Backdoor_Win32_Morix_A{
	...
	strings :
		$a_03_0 = {81 78 04 02 01 00 00 0f 85 90 01 01 00 00 00 8b 4d 90 01 01 83 79 08 7f 77 90 01 01 8b 55 90 01 01 83 7a 08 14 90 00 } //2
		$a_03_1 = {8b 55 08 03 55 90 01 01 0f be 02 83 f0 62 8b 4d 90 01 01 03 4d 90 01 01 88 01 eb 90 00 } //3
