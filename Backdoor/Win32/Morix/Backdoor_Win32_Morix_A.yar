...
rule Backdoor_Win32_Morix_A{
	...
	strings :
		...
		$a_00_2 = {5c 73 74 61 72 74 75 70 5c 33 36 30 74 72 61 79 2e 65 78 65 } //01 00 
		$a_00_3 = {5f 6b 61 73 70 65 72 73 6b 79 } //01 00 
		...
		$a_00_6 = {43 75 72 72 65 6e 74 43 6f 6e 74 72 6f 6c 53 65 74 5c 43 6f 6e 74 72 6f 6c 5c 54 65 72 6d 69 6e 61 6c 20 53 65 72 76 65 72 5c 52 44 50 54 63 70 } //00 00 
	condition:
		any of ($a_*)
