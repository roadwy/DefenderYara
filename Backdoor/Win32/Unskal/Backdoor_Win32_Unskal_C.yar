...
rule Backdoor_Win32_Unskal_C{
	...
	strings :
		...
		$a_01_3 = {6f 70 72 61 74 3d 32 26 75 69 64 3d 25 49 36 34 75 26 75 69 6e 66 6f 3d 25 73 26 77 69 6e 3d 25 64 2e 25 64 26 76 65 72 73 3d 25 73 } //05 00 
		...
		$a_01_6 = {5b 50 72 69 6e 74 53 63 72 65 65 6e 5d } //00 00 
