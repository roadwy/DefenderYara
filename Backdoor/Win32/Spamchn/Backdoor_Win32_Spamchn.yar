...
rule Backdoor_Win32_Spamchn{
	...
	strings :
		...
		$a_01_1 = {2c 53 75 62 48 6f 73 74 3a } //01 00  ,SubHost:
		$a_01_2 = {4c 6f 67 69 6e 73 3b } //01 00  Logins;
		$a_01_3 = {5c 53 79 6e 53 65 6e 64 2e 65 78 65 } //01 00  \SynSend.exe
		$a_01_4 = {32 31 38 2e 37 2e 31 32 30 2e 37 30 } //00 00  218.7.120.70
	condition:
		any of ($a_*)
