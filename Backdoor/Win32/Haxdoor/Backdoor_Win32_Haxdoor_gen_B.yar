...
rule Backdoor_Win32_Haxdoor_gen_B{
	...
	strings :
		$a_03_0 = {40 ff d0 6a 00 90 09 08 00 b8 90 01 04 83 c0 90 00 } //2
		$a_03_1 = {50 83 2c 24 90 01 01 ff 0c 24 c3 90 09 05 00 b8 90 00 } //2
		...
		$a_03_7 = {d1 ef 6a 18 56 e8 90 01 04 83 c6 18 4f 75 f2 ff 35 90 01 04 81 2c 24 90 01 04 c3 90 00 } //3
	condition:
