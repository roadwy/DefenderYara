...
rule Backdoor_Win32_DarkEnergy_A_bit{
	...
	strings :
		$a_03_0 = {2f 50 61 6e 65 6c 2f 63 61 6c 6c 62 61 63 6b 2e 70 68 70 90 02 30 31 38 35 2e 31 37 37 2e 35 39 2e 31 37 39 90 00 } //1
		...
		$a_03_2 = {6b 61 73 70 65 72 73 6b 79 90 02 10 74 72 65 6e 64 6d 69 63 72 6f 90 02 10 74 72 75 73 74 6c 6f 6f 6b 90 00 } //1
