...
rule Backdoor_Win32_Adialer_B{
	...
	strings :
		...
		$a_00_3 = {45 72 72 65 75 72 20 74 68 65 20 41 70 70 6c 20 42 75 66 66 65 72 } //05 00  Erreur the Appl Buffer
		$a_00_4 = {45 72 72 65 75 72 20 64 65 20 6c 65 63 74 75 72 65 20 64 75 20 66 69 63 68 69 65 72 } //00 00  Erreur de lecture du fichier
	condition:
		any of ($a_*)
