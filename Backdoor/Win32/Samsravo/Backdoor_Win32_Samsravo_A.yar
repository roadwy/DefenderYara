...
rule Backdoor_Win32_Samsravo_A{
	...
	strings :
		...
		$a_01_4 = {7b 00 4d 00 53 00 43 00 2e 00 57 00 31 00 37 00 35 00 38 00 46 00 2d 00 41 00 41 00 34 00 33 00 38 00 46 00 31 00 32 00 39 00 43 00 2e 00 43 00 46 00 46 00 7d 00 } //01 00 
		$a_03_5 = {5c 53 55 44 50 5c 52 65 6c 65 61 73 65 5c 90 02 10 2e 70 64 62 90 00 } //01 00 
		$a_01_6 = {4e 65 64 64 79 53 65 72 76 69 63 65 2e 70 64 62 } //01 00 
