...
rule Backdoor_Win32_Plite_SE_MTB{
	...
	strings :
		...
		$a_01_1 = {69 66 20 65 78 69 73 74 20 22 25 73 22 20 67 6f 74 6f 20 52 65 70 65 61 74 0d 0a 72 6d 64 69 72 20 22 25 73 22 0d 0a 64 65 6c 20 22 25 73 } //01 00 
		$a_01_2 = {48 61 6e 41 67 65 6e 74 5f 70 65 2e 65 78 65 } //00 00 
	condition:
		any of ($a_*)
