...
rule Backdoor_Win32_Lobparck_B{
	...
	strings :
		$a_01_0 = {6c 70 6b 2e 64 6c 6c } //01 00  lpk.dll
		$a_01_1 = {6d 79 57 6f 72 6b 53 74 61 72 74 00 64 6f 75 62 6c 65 73 61 66 65 } //01 00  祭潗歲瑓牡t潤扵敬慳敦
		$a_01_2 = {43 44 41 20 6d 67 72 } //01 00  CDA mgr
