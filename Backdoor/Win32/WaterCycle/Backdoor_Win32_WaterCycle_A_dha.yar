...
rule Backdoor_Win32_WaterCycle_A_dha{
	...
	strings :
		...
		$a_02_8 = {6c 6f 67 69 c7 90 01 02 6e 2e 6c 69 c7 90 01 02 76 65 2e 63 90 00 } //1
		$a_02_9 = {12 3f e0 56 c7 90 01 02 90 90 ac b2 09 90 00 } //2
		$a_02_10 = {f7 e6 8b c6 c1 ea 03 8d 0c 92 03 c9 2b c1 8a 44 90 01 02 30 04 1e 46 3b f7 90 00 } //2
	condition:
