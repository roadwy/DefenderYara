...
rule Backdoor_Win32_Swami_A{
	...
	strings :
		$a_03_0 = {8a 44 31 ff 8a 14 31 32 c2 8a d0 c0 ea 90 01 01 c0 e0 90 01 01 0a d0 88 14 31 49 75 90 01 01 8a 06 8a 4c 24 90 01 01 32 c1 8a c8 c0 e9 90 01 01 c0 e0 90 01 01 0a c8 88 0e 90 00 } //5
