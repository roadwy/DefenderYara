...
rule Backdoor_Win32_Swami_A{
	...
	strings :
		...
		$a_01_1 = {2f 69 6d 2f 6c 69 6e 75 78 2e 70 68 70 } //01 00 
		$a_01_2 = {2f 69 6d 2f 73 6f 6c 61 72 69 73 2e 70 68 70 } //01 00 
		$a_01_3 = {2f 69 6d 2f 66 72 65 65 62 73 64 2e 70 68 70 } //01 00 
		$a_01_4 = {73 79 73 77 6d 69 2e 65 78 65 } //01 00 
		$a_01_5 = {2f 63 67 69 2d 62 69 6e 2f 6d 6d 6c 6f 67 69 6e 2e 63 67 69 } //01 00 
