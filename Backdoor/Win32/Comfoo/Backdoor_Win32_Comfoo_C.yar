...
rule Backdoor_Win32_Comfoo_C{
	...
	strings :
		...
		$a_01_1 = {54 48 49 53 33 32 34 4e 45 57 47 41 4d 45 } //01 00 
		$a_01_2 = {70 65 72 66 64 69 2e 69 6e 69 } //01 00 
		$a_01_3 = {5c 75 73 62 61 6b 2e 73 79 73 } //01 00 
		$a_01_4 = {5c 5c 2e 5c 44 65 76 43 74 72 6c 4b 72 6e 6c } //00 00 
	condition:
		any of ($a_*)
