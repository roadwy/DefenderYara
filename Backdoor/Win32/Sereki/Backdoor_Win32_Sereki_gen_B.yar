...
rule Backdoor_Win32_Sereki_gen_B{
	...
	strings :
		$a_00_0 = {73 65 6c 66 6b 00 } //01 00  敳晬k
		$a_01_1 = {72 65 62 6f 6f 74 00 } //01 00 
		$a_01_2 = {63 6f 6d 6d 61 6e 64 00 } //01 00  潣浭湡d
		$a_00_3 = {53 65 53 68 75 74 64 6f 77 6e 50 72 69 76 69 6c 65 67 65 } //0a 00  SeShutdownPrivilege
