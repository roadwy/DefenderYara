...
rule Backdoor_Win32_Pingback_STA{
	...
	strings :
		...
		$a_02_2 = {73 68 65 6c 6c 90 02 0a 64 69 72 20 90 00 } //1
		$a_02_3 = {4e 45 4e 44 90 02 0a 65 78 65 70 00 90 00 } //1
		$a_02_4 = {43 72 65 61 74 65 46 69 6c 65 90 02 0a 50 65 65 6b 4e 61 6d 65 64 50 69 70 90 02 0a 57 72 69 74 65 46 69 6c 65 90 00 } //1
	condition:
