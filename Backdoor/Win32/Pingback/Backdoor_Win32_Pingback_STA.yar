...
rule Backdoor_Win32_Pingback_STA{
	...
	strings :
		$a_00_0 = {5c 54 43 50 42 44 53 56 32 2e 70 64 62 } //01 00 
		$a_00_1 = {6f 70 65 6e 66 69 6c 65 20 6f 6e 20 72 65 6d 6f 74 65 20 63 6f 6d 70 75 74 65 72 73 20 73 75 63 63 65 73 73 } //01 00 
