...
rule Backdoor_Win32_Quisset_A{
	...
	strings :
		...
		$a_00_1 = {2e 70 68 70 3f 6d 61 63 3d } //01 00  .php?mac=
		$a_00_2 = {2e 64 65 6c 65 74 65 64 } //01 00  .deleted
		$a_00_3 = {64 65 6c 6f 6e 6c 79 } //01 00  delonly
		$a_00_4 = {73 74 61 72 74 75 72 6c } //00 00  starturl
	condition:
		any of ($a_*)
