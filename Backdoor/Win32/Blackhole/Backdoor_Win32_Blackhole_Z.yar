...
rule Backdoor_Win32_Blackhole_Z{
	...
	strings :
		$a_00_0 = {73 74 72 53 65 72 76 65 72 43 6c 61 73 73 4e 61 6d 65 } //01 00 
		$a_00_1 = {3d 6d 4c 47 2b 41 4d 32 57 51 7a 63 69 52 38 77 } //01 00 
		$a_00_2 = {3a 28 52 61 6d 20 44 69 73 6b 29 } //01 00 
		$a_00_3 = {53 65 74 20 63 64 61 75 64 69 6f 20 64 6f 6f 72 20 6f 70 65 6e } //01 00 
		$a_00_4 = {62 72 63 5f 53 65 72 76 65 72 2e 65 78 65 } //01 00 
		$a_00_5 = {63 3a 5c 62 72 63 6c 6f 67 2e 74 78 74 } //0a 00 
