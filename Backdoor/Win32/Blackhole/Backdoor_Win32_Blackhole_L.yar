...
rule Backdoor_Win32_Blackhole_L{
	...
	strings :
		...
		$a_02_3 = {0f 84 8e 00 00 00 b8 90 01 04 ba 1c 00 00 00 e8 90 01 04 c7 05 90 01 04 10 01 00 00 c7 05 90 01 04 02 00 00 00 c7 05 90 01 04 03 00 00 00 c7 05 90 01 04 e8 03 00 00 68 90 01 04 a1 90 01 04 50 e8 90 01 04 c6 05 90 01 04 00 c6 05 90 01 04 00 c7 05 90 01 04 04 00 00 00 90 00 } //10
	condition:
