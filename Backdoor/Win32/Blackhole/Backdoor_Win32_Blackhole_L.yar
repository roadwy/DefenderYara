...
rule Backdoor_Win32_Blackhole_L{
	...
	strings :
		$a_00_0 = {31 33 38 73 6f 66 74 2e 63 6f 6d 2f 62 6c 61 63 6b 68 6f 6c 65 2f 76 65 72 69 66 79 2e 61 73 70 3f 6d 64 35 3d } //01 00 
		$a_00_1 = {3a 28 52 61 6d 20 44 69 73 6b 29 } //01 00 
		$a_00_2 = {42 72 63 53 65 72 76 65 72 32 2e 45 78 65 } //0a 00 
