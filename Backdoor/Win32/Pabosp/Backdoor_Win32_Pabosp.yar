...
rule Backdoor_Win32_Pabosp{
	...
	strings :
		$a_03_0 = {8d 4c 24 08 51 ff 15 90 01 04 68 90 01 04 68 90 01 04 e8 90 01 04 84 c0 74 90 01 01 6a 05 68 90 01 04 ff 15 90 01 04 e8 90 01 04 8b 54 24 04 8b 44 24 00 89 42 04 b0 01 90 00 } //5
