...
rule Backdoor_Win32_Lojax_A_dha{
	...
	strings :
		...
		$a_00_2 = {53 79 73 74 65 6d 5c 43 75 72 72 65 6e 74 43 6f 6e 74 72 6f 6c 53 65 74 5c 53 65 72 76 69 63 65 73 5c 72 70 63 6e 65 74 70 } //0a 00  System\CurrentControlSet\Services\rpcnetp
		$a_00_3 = {72 70 63 6e 65 74 70 2e 65 78 65 } //0a 00  rpcnetp.exe
