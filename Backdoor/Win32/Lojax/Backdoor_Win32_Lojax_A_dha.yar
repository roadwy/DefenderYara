...
rule Backdoor_Win32_Lojax_A_dha{
	...
	strings :
		...
		$a_03_1 = {6a 04 be 00 10 00 00 56 56 6a 00 53 ff 15 ?? ?? ?? ?? 8b f8 85 ff 74 40 6a 00 ff 75 08 ff 15 ?? ?? ?? ?? 40 50 ff 75 08 57 53 ff 15 } //10
		...
		$a_03_4 = {68 3f 00 0f 00 33 f6 56 ff 35 ?? ?? ?? ?? 68 02 00 00 80 ff 15 18 10 40 00 } //10
	condition:
