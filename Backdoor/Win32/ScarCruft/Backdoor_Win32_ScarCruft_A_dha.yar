...
rule Backdoor_Win32_ScarCruft_A_dha{
	...
	strings :
		$a_01_0 = {53 4f 46 54 57 41 52 45 5c 54 65 6e 63 65 6e 74 5c 51 51 50 43 4d 67 72 } //01 00  SOFTWARE\Tencent\QQPCMgr
		$a_01_1 = {6f 70 65 6e 66 61 69 6c 00 } //01 00 
		$a_01_2 = {6d 65 6d 66 61 69 6c 00 } //01 00  敭晭楡l
		$a_01_3 = {61 6c 6c 6f 63 66 61 69 6c 00 } //01 00  污潬晣楡l
