...
rule Backdoor_Win32_Bifrose_gen_D{
	...
	strings :
		...
		$a_00_1 = {70 6c 75 67 69 6e 31 2e 64 61 74 00 } //01 00 
		$a_00_2 = {53 4f 46 54 57 41 52 45 5c 57 67 65 74 00 } //01 00 
		...
		$a_00_6 = {70 69 66 00 73 63 72 00 65 78 65 00 } //02 00 
