...
rule Backdoor_Win32_Bifrose_CB_MTB{
	...
	strings :
		$a_01_0 = {63 3a 5c 74 65 6d 70 5c 76 69 72 75 73 2e 65 78 65 } //01 00  c:\temp\virus.exe
		$a_01_1 = {74 65 6d 70 32 2e 65 78 65 } //01 00  temp2.exe
		$a_01_2 = {74 65 6d 70 31 2e 64 6f 63 } //01 00  temp1.doc
