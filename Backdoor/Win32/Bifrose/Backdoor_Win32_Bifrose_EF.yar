...
rule Backdoor_Win32_Bifrose_EF{
	meta:
		description = "Backdoor:Win32/Bifrose.EF,SIGNATURE_TYPE_PEHSTR,20 00 20 00 05 00 00 "
		
	strings :
		$a_01_0 = {72 00 67 00 4d 00 77 00 46 00 2e 00 67 00 66 00 43 00 74 00 65 00 4e 00 48 00 } //10 rgMwF.gfCteNH
		$a_01_1 = {6c 00 6c 00 65 00 68 00 53 00 2e 00 74 00 70 00 69 00 72 00 63 00 53 00 57 00 } //10 llehS.tpircSW
		...
		$a_01_3 = {56 42 35 21 36 26 56 42 36 45 53 2e 44 4c 4c } //1 VB5!6&VB6ES.DLL
