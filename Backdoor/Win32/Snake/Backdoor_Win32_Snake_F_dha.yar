...
rule Backdoor_Win32_Snake_F_dha{
	...
	strings :
		$a_03_0 = {8d 04 1f 32 08 6a 01 88 4d 90 01 01 8d 4d 90 01 01 51 50 e8 90 01 04 83 c4 0c 46 3b 35 90 01 04 72 02 33 f6 47 3b 7d 0c 72 d2 90 00 } //1
		$a_03_1 = {8a 0c 31 03 c7 32 08 6a 01 88 4d 90 01 01 8d 4d 90 01 01 51 50 e8 90 01 04 83 c4 0c 46 3b f3 72 02 33 f6 47 3b 7d 90 01 01 72 d4 90 00 } //1
