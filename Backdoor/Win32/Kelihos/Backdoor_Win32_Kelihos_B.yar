...
rule Backdoor_Win32_Kelihos_B{
	...
	strings :
		$a_00_0 = {66 69 6e 64 5f 61 6e 64 5f 6b 69 6c 6c 5f 6f 6c 64 5f 63 6c 69 65 6e 74 73 00 } //02 00  楦摮慟摮歟汩彬汯彤汣敩瑮s
		...
		$a_00_3 = {73 6d 61 72 74 69 6e 64 65 78 } //01 00  smartindex
		$a_01_4 = {49 44 32 00 } //00 00  䑉2
	condition:
		any of ($a_*)
