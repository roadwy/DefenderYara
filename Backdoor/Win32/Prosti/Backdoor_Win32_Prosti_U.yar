...
rule Backdoor_Win32_Prosti_U{
	...
	strings :
		...
		$a_02_1 = {4e 6f 52 65 61 6c 4d 6f 64 65 [0-05] 53 6f 66 74 77 61 72 65 5c 4d 69 63 72 6f 73 6f 66 74 5c 57 69 6e 64 6f 77 73 5c 43 75 72 72 65 6e 74 56 65 72 73 69 6f 6e 5c 50 6f 6c 69 63 69 65 73 5c 57 69 6e 4f 6c 64 41 70 70 [0-10] 44 65 6c 65 74 65 [0-02] 2e 62 61 74 [0-10] 3a 74 72 79 } //1
		$a_02_2 = {6d 79 64 6c 6c [0-10] 64 6c 6c 66 69 6c 65 } //1
