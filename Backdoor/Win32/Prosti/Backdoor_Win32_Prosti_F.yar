...
rule Backdoor_Win32_Prosti_F{
	...
	strings :
		...
		$a_02_1 = {68 74 74 70 3a 2f 2f 77 77 77 2e 73 63 72 65 65 6e 62 6c 61 7a 65 2e 63 6f 6d 2f 90 02 08 2e 70 68 70 3f 69 64 3d 90 00 } //1
		...
		$a_02_3 = {8b e5 5d c3 ff ff ff ff 90 01 01 00 00 00 68 74 74 70 3a 2f 2f 77 77 77 2e 73 63 72 65 65 6e 62 6c 61 7a 65 2e 63 6f 6d 2f 90 00 } //1
	condition:
