...
rule Backdoor_Win32_Pingbed_A{
	...
	strings :
		$a_03_0 = {68 ff 0f 1f 00 ff 15 90 01 04 8b f8 85 ff 74 90 01 01 6a 00 57 ff 15 90 01 04 8b d8 85 db 75 90 01 01 68 f4 01 00 00 ff 15 90 00 } //2
		$a_03_1 = {68 fb 1f 00 00 50 ff 75 90 01 01 ff 15 90 01 04 83 7d 90 01 01 00 74 90 00 } //2
