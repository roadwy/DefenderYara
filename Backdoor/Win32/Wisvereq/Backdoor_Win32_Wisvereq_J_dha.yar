...
rule Backdoor_Win32_Wisvereq_J_dha{
	...
	strings :
		$a_01_0 = {25 30 32 58 2d 25 30 32 58 2d 25 30 32 58 2d 25 30 32 58 2d 25 30 32 58 2d 25 30 32 58 00 } //05 00  〥堲┭㈰ⵘ〥堲┭㈰ⵘ〥堲┭㈰X
		...
		$a_01_4 = {65 62 76 69 33 30 37 2e 62 61 74 00 } //01 00  扥楶〳⸷慢t
		$a_01_5 = {57 69 6e 32 30 30 30 } //00 00  Win2000
	condition:
		any of ($a_*)
