...
rule Backdoor_Win32_Hikiti_I_dha{
	...
	strings :
		...
		$a_02_1 = {25 00 73 00 25 00 64 00 2e 00 64 00 61 00 74 00 [0-40] 5c 00 63 00 6d 00 64 00 2e 00 65 00 78 00 65 00 [0-20] 43 00 61 00 6e 00 27 00 74 00 20 00 6f 00 70 00 65 00 6e 00 20 00 73 00 68 00 65 00 6c 00 6c 00 } //2
