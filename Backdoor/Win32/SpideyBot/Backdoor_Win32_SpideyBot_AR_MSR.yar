...
rule Backdoor_Win32_SpideyBot_AR_MSR{
	...
	strings :
		...
		$a_01_1 = {62 57 39 6b 64 57 78 6c 4c 6d 56 34 63 47 39 79 64 48 4d 67 50 53 42 79 5a 58 46 31 61 58 4a 6c 4b 43 63 75 4c 32 4e 76 63 6d 55 75 59 58 4e 68 63 69 63 70 4f 77 3d 3d } //00 00 
	condition:
		any of ($a_*)
