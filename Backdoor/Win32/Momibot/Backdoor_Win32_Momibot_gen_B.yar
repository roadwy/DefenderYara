...
rule Backdoor_Win32_Momibot_gen_B{
	...
	strings :
		$a_02_0 = {56 6a 14 6a 40 ff 90 90 90 01 02 00 00 b9 90 01 04 8b f0 e8 90 01 02 00 00 35 57 34 98 12 50 a1 90 01 04 68 90 01 04 56 ff 90 90 90 01 02 00 00 90 00 } //4
		$a_02_1 = {85 c0 74 63 a1 90 01 04 53 83 c6 08 56 ff 90 90 90 01 02 00 00 8b f8 8d 47 01 50 a1 90 09 0e 00 eb 73 68 90 01 04 56 ff 90 90 90 01 02 00 00 90 00 } //4
