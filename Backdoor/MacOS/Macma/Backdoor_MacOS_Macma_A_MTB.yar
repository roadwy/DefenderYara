...
rule Backdoor_MacOS_Macma_A_MTB{
	...
	strings :
		$a_03_0 = {48 63 ca 48 89 8d ?? ?? ff ff 48 8b 85 ?? ?? ff ff 48 8b 8d ?? ?? ff ff ba 01 00 00 00 48 8b bd ?? ?? ff ff 48 89 c6 e8 ?? ?? ?? 00 48 89 85 ?? ?? ff ff e9 00 00 00 00 48 8d 85 ?? ?? ff ff 48 89 85 ?? ?? ff ff 48 8d 05 ?? ?? 04 00 48 89 85 ?? ?? ff ff 48 8b bd ?? ?? ff ff 48 89 c6 e8 ?? ?? ?? 00 48 89 85 ?? ?? ff ff e9 00 00 00 00 } //2
