...
rule Backdoor_MacOS_Twenbc_A_MTB{
	...
	strings :
		$a_03_0 = {48 89 f7 48 89 f5 e8 ?? ?? ?? 00 4c 8d 64 05 00 48 83 f8 0f 48 89 44 24 08 76 1b 48 8d 74 24 08 31 d2 48 89 df e8 ?? ?? ?? 00 48 89 03 48 8b 44 24 08 48 89 43 10 } //1
