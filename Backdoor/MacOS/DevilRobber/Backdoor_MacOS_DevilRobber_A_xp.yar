...
rule Backdoor_MacOS_DevilRobber_A_xp{
	...
	strings :
		$a_01_0 = {75 6e 7a 69 70 20 62 69 6e 61 72 79 2e 7a 69 70 20 3e 20 2f 64 65 76 2f 6e 75 6c 6c } //01 00 
		$a_01_1 = {64 5f 73 74 61 74 75 73 2e 63 66 67 } //01 00 
		$a_01_2 = {2e 2f 64 5f 73 74 6f 70 2e 73 68 } //01 00 
		$a_01_3 = {2e 2f 70 5f 73 74 61 72 74 2e 73 68 } //03 00 
