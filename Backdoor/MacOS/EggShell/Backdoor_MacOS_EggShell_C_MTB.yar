...
rule Backdoor_MacOS_EggShell_C_MTB{
	...
	strings :
		...
		$a_00_2 = {2f 2e 75 70 64 61 74 65 } //01 00 
		$a_00_3 = {6f 62 66 75 73 63 61 74 65 42 61 73 68 53 68 65 6c 6c 3a } //01 00 
		$a_00_4 = {4b 65 79 6c 6f 67 54 68 72 65 61 64 } //00 00 
