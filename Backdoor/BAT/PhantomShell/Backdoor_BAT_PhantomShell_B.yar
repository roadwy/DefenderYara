...
rule Backdoor_BAT_PhantomShell_B{
	...
	strings :
		...
		$a_01_1 = {58 00 2d 00 73 00 69 00 4c 00 6f 00 63 00 6b 00 2d 00 43 00 6f 00 6d 00 6d 00 65 00 6e 00 74 00 } //01 00  X-siLock-Comment
		$a_01_2 = {78 00 2d 00 73 00 69 00 4c 00 6f 00 63 00 6b 00 2d 00 53 00 74 00 65 00 70 00 31 00 } //01 00  x-siLock-Step1
