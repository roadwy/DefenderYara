...
rule Backdoor_BAT_LimeRat_AY_MTB{
	...
	strings :
		...
		$a_03_1 = {0a 1f 28 8d 90 01 01 00 00 01 25 d0 90 01 01 00 00 04 28 90 01 01 00 00 0a 6f 90 01 01 00 00 0a 0a 28 90 01 01 00 00 0a 1f 28 8d 90 01 01 00 00 01 25 90 00 } //2
