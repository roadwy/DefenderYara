...
rule Backdoor_BAT_QuasarRAT_A_MTB{
	meta:
		description = "Backdoor:BAT/QuasarRAT.A!MTB,SIGNATURE_TYPE_PEHSTR_EXT,06 00 06 00 05 00 00 02 00 "
		
	strings :
		$a_03_0 = {0a 17 2d 01 00 02 17 59 45 03 00 00 00 02 00 00 00 1b 00 00 00 12 00 00 00 2b 28 04 14 06 05 14 14 14 16 28 90 01 01 00 00 0a 0b 2b 1c 02 8c 90 01 01 00 00 01 0b 2b 13 04 14 06 05 14 14 14 28 90 00 } //01 00 
