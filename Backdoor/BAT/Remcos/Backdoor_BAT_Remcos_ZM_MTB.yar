...
rule Backdoor_BAT_Remcos_ZM_MTB{
	...
	strings :
		$a_02_0 = {0b 00 2b 35 16 2b 35 2b 3a 2b 3f 00 2b 0b 2b 0c 6f 90 01 03 0a 00 00 de 14 08 2b f2 07 2b f1 08 2c 0a 16 2d 06 08 6f 90 01 03 0a 00 dc 07 6f 90 01 03 0a 0d 16 2d cb de 30 06 2b c8 73 90 01 03 0a 2b c4 73 90 01 03 0a 2b bf 0c 2b be 90 00 } //1
