...
rule Backdoor_BAT_Nanocore_ABG_MTB{
	...
	strings :
		...
		$a_01_4 = {63 76 68 6e 67 66 67 } //00 00  cvhngfg
	condition:
		any of ($a_*)
...
rule Backdoor_BAT_Nanocore_ABG_MTB_2{
	...
	strings :
		...
		$a_01_2 = {41 00 63 00 74 00 69 00 6f 00 6e 00 73 00 32 00 45 00 76 00 65 00 6e 00 74 00 73 00 4d 00 61 00 70 00 70 00 69 00 6e 00 67 00 2e 00 52 00 65 00 73 00 6f 00 75 00 72 00 63 00 65 00 73 00 } //01 00  Actions2EventsMapping.Resources
		$a_01_3 = {64 00 6f 00 77 00 6e 00 6c 00 6f 00 61 00 64 00 } //01 00  download
		$a_01_4 = {72 00 65 00 64 00 5f 00 6c 00 6f 00 76 00 65 00 } //00 00  red_love
	condition:
		any of ($a_*)
