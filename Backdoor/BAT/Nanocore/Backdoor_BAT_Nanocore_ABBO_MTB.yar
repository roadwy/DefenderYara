...
rule Backdoor_BAT_Nanocore_ABBO_MTB{
	...
	strings :
		...
		$a_01_1 = {48 79 76 65 73 } //01 00 
		$a_01_2 = {43 68 65 61 74 4d 65 6e 75 2e 50 72 6f 70 65 72 74 69 65 73 2e 52 65 73 6f 75 72 63 65 73 2e 72 65 73 6f 75 72 63 65 73 } //01 00 
		$a_01_3 = {43 72 65 61 74 65 49 6e 73 74 61 6e 63 65 } //01 00 
		$a_01_4 = {47 65 74 50 69 78 65 6c } //00 00 
	condition:
		any of ($a_*)
