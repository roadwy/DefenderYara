...
rule Backdoor_BAT_Noancooe_A_{
	...
	strings :
		...
		$a_01_1 = {4e 61 6e 6f 43 6f 72 65 20 43 6c 69 65 6e 74 2e 65 78 65 } //01 00 
		...
		$a_01_4 = {46 69 6c 65 44 61 74 61 00 46 69 6c 65 44 6f 77 6e 6c 6f 61 64 00 } //01 00 
		$a_01_5 = {48 6f 73 74 44 61 74 61 00 50 6c 75 67 69 6e 44 65 74 61 69 6c 73 00 50 6c 75 67 69 6e 44 61 74 61 00 } //00 00 
	condition:
		any of ($a_*)
