...
rule Backdoor_BAT_Noancooe_A{
	...
	strings :
		$a_01_0 = {4e 61 6e 6f 43 6f 72 65 20 43 6c 69 65 6e } //01 00 
...
rule Backdoor_BAT_Noancooe_A_2{
	...
	strings :
		$a_01_0 = {4e 61 6e 6f 43 6f 72 65 2e 65 78 65 } //01 00 
		$a_01_1 = {4c 56 5f 47 52 4f 55 50 00 48 65 61 64 65 72 73 00 42 61 73 65 43 6f 6d 6d 61 6e 64 00 } //01 00 
		$a_01_2 = {42 72 6f 6e 7a 65 00 53 69 6c 76 65 72 00 47 6f 6c 64 00 50 6c 61 74 69 6e 75 6d 00 44 69 61 6d 6f 6e 64 00 } //01 00 
...
rule Backdoor_BAT_Noancooe_A_3{
	...
	strings :
		$a_01_0 = {4e 61 6e 6f 43 6f 72 65 20 43 6c 69 65 6e 74 2e 65 78 65 } //01 00 
		...
		$a_01_3 = {46 69 6c 65 44 61 74 61 00 46 69 6c 65 44 6f 77 6e 6c 6f 61 64 00 } //01 00 
		$a_01_4 = {48 6f 73 74 44 61 74 61 00 50 6c 75 67 69 6e 44 65 74 61 69 6c 73 00 50 6c 75 67 69 6e 44 61 74 61 00 } //0a 00 
