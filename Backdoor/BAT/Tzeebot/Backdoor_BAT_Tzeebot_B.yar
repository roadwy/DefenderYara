...
rule Backdoor_BAT_Tzeebot_B{
	...
	strings :
		$a_01_0 = {43 68 65 63 6b 46 69 6c 65 4d 44 35 43 6f 6d 70 6c 65 74 65 64 } //01 00  CheckFileMD5Completed
		$a_01_1 = {67 65 74 5f 48 61 69 66 61 } //05 00  get_Haifa
		...
		$a_01_3 = {54 69 6e 79 5a 42 6f 74 } //00 00  TinyZBot
