...
rule Backdoor_BAT_CrimsonRat_C_MTB{
	...
	strings :
		...
		$a_02_1 = {4c 00 45 00 5f 00 41 00 55 00 90 02 02 54 00 4f 00 3c 00 21 00 90 0a 1e 00 3c 00 46 00 49 00 90 00 } //10
		$a_02_2 = {4c 45 5f 41 55 90 02 02 54 4f 3c 21 90 0a 1e 00 3c 46 49 90 00 } //10
		...
		$a_02_8 = {66 00 6f 00 3d 00 75 00 7a 00 90 02 02 65 00 72 00 7c 00 90 0a 1e 00 69 00 6e 00 90 00 } //1
		$a_02_9 = {66 6f 3d 75 7a 90 02 02 65 72 7c 90 0a 1e 00 69 6e 90 00 } //1
