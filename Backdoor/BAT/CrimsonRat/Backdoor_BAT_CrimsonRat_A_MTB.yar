...
rule Backdoor_BAT_CrimsonRat_A_MTB{
	meta:
		description = "Backdoor:BAT/CrimsonRat.A!MTB,SIGNATURE_TYPE_PEHSTR_EXT,18 00 18 00 09 00 00 0a 00 "
	...
	strings :
		...
		$a_80_5 = {63 61 70 53 63 72 65 65 6e } //capScreen  01 00 
		$a_80_6 = {69 6e 66 6f 3d 75 73 65 72 7c } //info=user|  01 00 
		$a_80_7 = {63 6c 69 65 6e 74 73 5f 64 61 74 61 7c } //clients_data|  01 00 
		$a_02_8 = {5c 6f 62 6a 5c 44 65 62 75 67 90 02 14 2e 70 64 62 90 00 } //00 00 
	condition:
		any of ($a_*)
