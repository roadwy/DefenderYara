...
rule Backdoor_BAT_SpyNoon_MTB{
	meta:
		description = "Backdoor:BAT/SpyNoon!MTB,SIGNATURE_TYPE_PEHSTR_EXT,0b 00 0b 00 0b 00 00 "
		
	strings :
		$a_01_0 = {45 6e 74 72 79 50 6f 69 6e 74 } //1 EntryPoint
		...
		$a_01_4 = {67 65 74 5f 4d 61 63 68 69 6e 65 4e 61 6d 65 } //1 get_MachineName
		...
		$a_01_8 = {57 00 73 00 68 00 53 00 68 00 65 00 6c 00 6c 00 2e 00 52 00 75 00 6e 00 22 00 43 00 3a 00 5c 00 } //1 WshShell.Run"C:\
		$a_01_9 = {53 00 6f 00 66 00 74 00 77 00 61 00 72 00 65 00 5c 00 4d 00 69 00 63 00 72 00 6f 00 73 00 6f 00 66 00 74 00 5c 00 57 00 69 00 6e 00 64 00 6f 00 77 00 73 00 5c 00 43 00 75 00 72 00 72 00 65 00 6e 00 74 00 56 00 65 00 72 00 73 00 69 00 6f 00 6e 00 5c 00 52 00 75 00 6e 00 } //1 Software\Microsoft\Windows\CurrentVersion\Run
		$a_81_10 = {49 6e 73 74 61 6c 6c 55 74 69 6c 2e 65 78 65 } //1 InstallUtil.exe
	condition:
		((#a_01_0  & 1)*1+(#a_01_1  & 1)*1+(#a_01_2  & 1)*1+(#a_01_3  & 1)*1+(#a_01_4  & 1)*1+(#a_01_5  & 1)*1+(#a_01_6  & 1)*1+(#a_01_7  & 1)*1+(#a_01_8  & 1)*1+(#a_01_9  & 1)*1+(#a_81_10  & 1)*1) >=11
