...
rule Backdoor_BAT_Rescoms_C_MTB{
	...
	strings :
		$a_02_0 = {08 13 0d 11 0c 13 0e 11 0d 11 0e 11 0d 11 0e 6f ?? 00 00 0a 08 11 0c 17 59 6f ?? 00 00 0a 58 6f ?? 00 00 0a 00 00 11 0c 17 58 13 0c 11 0c 08 6f ?? 00 00 0a fe 04 13 0f 11 0f 2d c3 } //10
