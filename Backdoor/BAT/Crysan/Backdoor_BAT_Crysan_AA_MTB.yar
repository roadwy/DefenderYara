...
rule Backdoor_BAT_Crysan_AA_MTB{
	...
	strings :
		...
		$a_81_1 = {53 79 73 74 65 6d 2e 4e 65 74 2e 53 6f 63 6b 65 74 73 } //03 00  System.Net.Sockets
		$a_81_2 = {48 74 74 70 57 65 62 52 65 71 75 65 73 74 } //03 00  HttpWebRequest
		$a_81_3 = {46 74 70 57 65 62 52 65 71 75 65 73 74 } //00 00  FtpWebRequest
	condition:
		any of ($a_*)
