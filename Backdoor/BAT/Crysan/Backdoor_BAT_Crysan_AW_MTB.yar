...
rule Backdoor_BAT_Crysan_AW_MTB{
	...
	strings :
		...
		$a_81_1 = {6d 69 6c 65 73 66 69 6e 64 65 72 } //03 00  milesfinder
		$a_81_2 = {64 75 63 6b 63 68 6f 69 63 65 73 65 6c 65 63 74 6f 72 } //03 00  duckchoiceselector
		$a_81_3 = {62 75 72 63 61 73 74 35 } //00 00  burcast5
	condition:
		any of ($a_*)
