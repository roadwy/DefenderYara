...
rule Backdoor_BAT_Crysan_AAXM_MTB{
	...
	strings :
		$a_03_0 = {0a 0c 07 08 1f 20 6f ?? 00 00 0a 6f ?? 00 00 0a 07 08 1f 10 6f ?? 00 00 0a 6f ?? 00 00 0a 73 ?? 00 00 0a 0d 09 07 6f ?? 00 00 0a 17 73 ?? 00 00 0a 13 04 11 04 02 16 02 8e 69 6f ?? 00 00 0a 11 04 6f ?? 00 00 0a de 0b 26 09 6f ?? 00 00 0a 13 05 de 2f } //4
