...
rule Backdoor_BAT_Crysan_ABI_MTB{
	...
	strings :
		...
		$a_01_1 = {44 65 62 75 67 67 65 72 } //01 00 
		...
		$a_01_7 = {4c 78 65 6f 6d 72 63 63 77 6c 6b 6d 66 37 2e 65 78 65 } //01 00 
		$a_01_8 = {24 31 37 32 63 32 64 66 32 2d 33 36 66 65 2d 34 33 38 34 2d 62 34 34 30 2d 62 65 30 34 63 62 36 38 65 34 63 63 } //00 00 
	condition:
		any of ($a_*)
