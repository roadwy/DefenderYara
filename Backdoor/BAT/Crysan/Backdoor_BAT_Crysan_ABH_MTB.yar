...
rule Backdoor_BAT_Crysan_ABH_MTB{
	...
	strings :
		...
		$a_01_3 = {4b 00 73 00 69 00 72 00 75 00 6e 00 69 00 72 00 79 00 77 00 } //01 00 
		$a_01_4 = {56 00 7a 00 74 00 63 00 6e 00 76 00 66 00 6e 00 70 00 78 00 70 00 74 00 72 00 63 00 64 00 61 00 72 00 } //00 00 
	condition:
		any of ($a_*)
...
rule Backdoor_BAT_Crysan_ABH_MTB_2{
	...
	strings :
		...
		$a_01_4 = {62 74 71 62 71 77 77 63 65 74 61 63 72 63 65 61 74 72 77 62 2e 72 65 73 6f 75 72 63 65 73 } //01 00 
		$a_01_5 = {49 00 73 00 44 00 65 00 62 00 75 00 67 00 67 00 65 00 72 00 50 00 72 00 65 00 73 00 65 00 6e 00 74 00 } //00 00 
	condition:
		any of ($a_*)
