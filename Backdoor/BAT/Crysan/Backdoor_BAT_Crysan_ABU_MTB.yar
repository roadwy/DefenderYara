...
rule Backdoor_BAT_Crysan_ABU_MTB{
	...
	strings :
		$a_03_0 = {02 11 08 95 06 11 08 1f 0f 5f 95 61 13 09 06 11 08 1f 0f 5f 06 11 08 1f 0f 5f 95 11 09 61 20 19 90 01 02 3d 58 9e 09 11 04 11 09 d2 9c 09 11 04 90 00 } //3
		$a_03_1 = {08 16 1a 28 2d 90 01 02 0a 08 16 28 2e 90 01 02 0a 13 04 11 04 8d 18 90 01 02 01 25 17 73 2f 90 01 02 0a 13 05 06 6f 27 90 01 02 0a 1b 6a 59 90 00 } //3
