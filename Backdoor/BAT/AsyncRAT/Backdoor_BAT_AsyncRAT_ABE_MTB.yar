...
rule Backdoor_BAT_AsyncRAT_ABE_MTB{
	...
	strings :
		$a_03_0 = {16 0c 0f 00 08 20 90 01 03 00 58 28 01 90 01 02 2b 07 02 08 20 90 01 03 00 6f 1a 90 01 02 0a 0d 08 09 58 0c 09 20 90 01 03 00 2f d8 0f 00 08 28 01 90 01 02 2b 07 6f 1b 90 01 02 0a de 0a 07 2c 06 07 6f 90 01 03 0a dc 90 00 } //5
