...
rule Backdoor_BAT_AsyncRAT_W_MTB{
	...
	strings :
		$a_03_0 = {0a 2c 15 7e 90 01 01 00 00 04 20 90 01 03 06 28 90 01 01 00 00 06 73 90 01 01 00 00 0a 7a 03 7e 90 01 01 00 00 04 20 50 c3 00 00 73 90 01 01 00 00 0a 0a 02 06 1f 20 6f 90 01 01 00 00 0a 7d 90 01 01 00 00 04 02 06 1f 40 6f 90 01 01 00 00 0a 7d 90 01 01 00 00 04 de 90 00 } //2
