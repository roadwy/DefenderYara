...
rule Backdoor_BAT_AsyncRAT_NRZ_MTB{
	...
	strings :
		$a_03_0 = {06 08 28 3d 00 00 0a 7e ?? 00 00 04 6f ?? 00 00 0a 6f ?? 00 00 0a 6f ?? 00 00 0a 06 18 6f ?? 00 00 0a 06 6f ?? 00 00 0a 13 04 02 0d 11 04 09 16 09 8e b7 6f ?? 00 00 0a 0b de 11 } //5
