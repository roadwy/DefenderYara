...
rule Backdoor_BAT_AsyncRAT_O_MTB{
	...
	strings :
		$a_03_0 = {72 01 00 00 70 7e ?? ?? 00 04 28 ?? ?? 00 06 a4 ?? 00 00 01 11 ?? 7e ?? ?? 00 04 28 ?? ?? 00 06 7e ?? ?? 00 04 28 ?? ?? 00 06 11 ?? 11 ?? 11 ?? 7e ?? ?? 00 04 28 ?? ?? 00 06 20 00 01 00 00 14 14 11 ?? 7e ?? ?? 00 04 28 ?? ?? 00 06 26 20 } //2
