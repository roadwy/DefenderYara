...
rule Backdoor_BAT_AsyncRAT_Q_MTB{
	...
	strings :
		$a_03_0 = {04 25 2d 17 26 7e 90 01 02 00 04 fe 06 90 01 02 00 06 73 90 01 02 00 0a 25 80 90 01 02 00 04 28 90 01 01 00 00 2b 28 90 01 01 00 00 2b 28 90 01 01 00 00 2b 0b 72 90 00 } //2
		$a_03_1 = {01 07 18 16 8d 90 01 01 00 00 01 28 90 01 02 00 0a 13 07 11 07 08 18 16 90 00 } //2
