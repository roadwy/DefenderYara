...
rule Backdoor_BAT_DCRat_SPD_MTB{
	...
	strings :
		...
		$a_01_1 = {42 00 75 00 69 00 6c 00 64 00 49 00 6e 00 73 00 74 00 61 00 6c 00 6c 00 61 00 74 00 69 00 6f 00 6e 00 54 00 77 00 65 00 61 00 6b 00 73 00 50 00 6c 00 75 00 67 00 69 00 6e 00 2e 00 64 00 6c 00 6c 00 } //00 00 
	condition:
		any of ($a_*)
