...
rule Backdoor_BAT_DCRat_H_MTB{
	...
	strings :
		...
		$a_01_1 = {55 4e 43 4f 4d 50 52 45 53 53 45 44 5f 45 4e 44 } //01 00  UNCOMPRESSED_END
		$a_01_2 = {55 4e 43 4f 4e 44 49 54 49 4f 4e 41 4c 5f 4d 41 54 43 48 4c 45 4e } //00 00  UNCONDITIONAL_MATCHLEN
	condition:
		any of ($a_*)
