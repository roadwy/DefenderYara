...
rule Backdoor_BAT_WebShell_AI_MTB{
	...
	strings :
		$a_03_0 = {0a 06 06 6f 90 01 01 00 00 0a 07 16 07 8e 69 6f 90 01 01 00 00 0a 28 90 01 01 00 00 0a 72 90 01 02 00 70 6f 90 01 01 00 00 0a 02 6f 90 01 01 00 00 0a 26 2a 90 00 } //4
