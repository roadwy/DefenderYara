...
rule Backdoor_BAT_WebShell_GMH_MTB{
	...
	strings :
		$a_01_0 = {41 70 70 5f 67 6c 6f 62 61 6c 2e 61 73 61 78 2e 79 78 36 61 72 65 71 77 } //01 00  App_global.asax.yx6areqw
		$a_01_1 = {53 79 73 74 65 6d 2e 54 65 78 74 } //01 00  System.Text
		$a_01_2 = {72 6f 6f 74 5c 38 35 30 62 38 32 38 37 5c 61 65 32 64 33 66 65 39 } //01 00  root\850b8287\ae2d3fe9
