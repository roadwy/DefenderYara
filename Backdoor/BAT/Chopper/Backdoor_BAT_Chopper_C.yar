...
rule Backdoor_BAT_Chopper_C{
	...
	strings :
		$a_03_0 = {28 15 00 00 0a 28 16 00 00 0a 25 72 90 01 04 72 90 01 04 28 90 01 04 25 72 90 01 04 72 90 01 04 28 90 01 04 25 72 90 01 04 72 90 01 04 28 90 01 04 0a 02 90 00 } //1
		...
		$a_03_3 = {25 00 37 00 34 00 25 00 35 00 62 00 25 00 32 00 32 00 90 02 40 25 00 32 00 32 00 25 00 35 00 64 00 25 00 32 00 39 00 25 00 33 00 62 00 90 00 } //1
	condition:
