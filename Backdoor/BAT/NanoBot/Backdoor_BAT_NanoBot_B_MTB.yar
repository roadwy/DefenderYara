...
rule Backdoor_BAT_NanoBot_B_MTB{
	...
	strings :
		...
		$a_00_1 = {67 65 74 5f 45 6e 63 72 79 70 74 65 64 32 } //01 00 
		$a_00_2 = {43 72 65 61 74 65 44 65 63 72 79 70 74 6f 72 } //01 00 
		$a_00_3 = {59 00 6f 00 64 00 61 00 2d 00 43 00 6f 00 66 00 66 00 65 00 65 00 33 00 } //00 00 
	condition:
		any of ($a_*)
