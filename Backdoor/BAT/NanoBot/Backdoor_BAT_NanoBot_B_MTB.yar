...
rule Backdoor_BAT_NanoBot_B_MTB{
	...
	strings :
		$a_03_0 = {11 00 02 28 90 01 04 72 90 01 04 28 90 01 04 0a 28 90 01 04 06 6f 90 01 04 0b 07 6f 90 01 04 17 9a 0c 02 08 28 90 01 04 00 28 90 01 04 00 16 0d 2b 00 09 90 00 } //1
