...
rule Backdoor_BAT_NanoBot_PA_MTB{
	...
	strings :
		...
		$a_03_1 = {8e 69 17 da 17 d8 13 90 01 01 16 13 90 01 01 2b 90 00 } //1
		$a_03_2 = {8e 69 5d 91 09 11 90 01 01 09 8e 69 5d 91 61 90 02 10 17 d6 90 02 08 8e 69 5d 91 da 20 90 02 08 d6 20 90 02 08 5d b4 9c 90 00 } //1
	condition:
