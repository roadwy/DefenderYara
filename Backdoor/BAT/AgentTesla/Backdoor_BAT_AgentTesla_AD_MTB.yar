...
rule Backdoor_BAT_AgentTesla_AD_MTB{
	...
	strings :
		$a_02_0 = {72 22 01 00 70 6f 90 01 03 0a 6f 90 01 03 0a 90 02 05 6f 90 01 03 0a 72 2e 01 00 70 6f 90 01 03 0a 6f 90 01 03 0a 90 02 0a 72 38 01 00 70 6f 90 01 03 0a 90 02 05 72 3c 01 00 70 6f 90 01 03 0a 90 02 05 72 40 01 00 70 6f 90 01 03 0a 90 00 } //1
	condition:
		((#a_02_0  & 1)*1) >=1
...
rule Backdoor_BAT_AgentTesla_AD_MTB_2{
	...
	strings :
		...
		$a_02_16 = {80 9a 01 00 80 94 5f 5f 5f 5f 90 04 90 01 5f 00 00 90 00 } //5
	condition:
