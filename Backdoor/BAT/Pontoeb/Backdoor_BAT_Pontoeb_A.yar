...
rule Backdoor_BAT_Pontoeb_A{
	...
	strings :
		...
		$a_00_1 = {6d 00 6f 00 64 00 65 00 3d 00 30 00 26 00 68 00 77 00 69 00 64 00 3d 00 } //01 00  mode=0&hwid=
		$a_01_2 = {6e 55 44 50 46 6c 6f 6f 64 00 } //01 00  啮偄汆潯d
		$a_01_3 = {6e 53 59 4e 46 6c 6f 6f 64 00 } //01 00  卮乙汆潯d
