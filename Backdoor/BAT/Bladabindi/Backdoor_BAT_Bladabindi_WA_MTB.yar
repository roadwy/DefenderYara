...
rule Backdoor_BAT_Bladabindi_WA_MTB{
	...
	strings :
		$a_02_0 = {01 0b 11 04 11 04 6f 90 01 03 0a 1b 6a da 6f 90 01 03 0a 11 04 07 16 1a 6f 90 01 03 0a 26 07 16 28 90 01 03 0a 0c 11 04 16 6a 6f 90 01 03 0a 08 17 da 17 d6 17 da 17 d6 17 da 17 d6 8d 90 01 03 01 0a 09 06 16 08 6f 90 01 03 0a 26 09 90 00 } //10
