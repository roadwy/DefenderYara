...
rule Backdoor_BAT_Bladabindi_AR_{
	...
	strings :
		$a_03_0 = {1f 1d 0f 01 1a 28 90 01 01 00 00 06 90 00 } //10
		$a_03_1 = {20 a0 00 00 00 90 02 30 20 a1 00 00 00 90 02 30 20 00 00 01 00 90 02 30 1f 10 90 02 30 20 00 00 02 00 90 02 30 1f 11 90 02 30 20 a3 00 00 00 90 00 } //1
		$a_03_2 = {1f 64 14 13 04 12 04 1f 64 28 90 01 01 00 00 06 90 00 } //1
