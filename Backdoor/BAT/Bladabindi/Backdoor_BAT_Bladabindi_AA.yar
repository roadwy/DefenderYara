...
rule Backdoor_BAT_Bladabindi_AA{
	meta:
		description = "Backdoor:BAT/Bladabindi.AA,SIGNATURE_TYPE_PEHSTR_EXT,04 00 04 00 04 00 00 01 00 "
...
rule Backdoor_BAT_Bladabindi_AA_2{
	meta:
		description = "Backdoor:BAT/Bladabindi.AA,SIGNATURE_TYPE_PEHSTR_EXT,1f 00 1f 00 06 00 00 0a 00 "
	...
	strings :
		...
		$a_00_6 = {80 10 00 00 f3 51 b9 3a 58 97 11 b5 33 5e c8 26 ae 02 00 80 } //80 10 
	condition:
		any of ($a_*)
