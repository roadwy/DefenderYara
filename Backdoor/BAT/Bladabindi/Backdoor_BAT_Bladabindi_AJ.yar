...
rule Backdoor_BAT_Bladabindi_AJ_2{
	...
	strings :
		$a_03_0 = {1f 1d 0f 01 1a 28 ?? ?? 00 06 26 } //1
		$a_03_1 = {1f 1d 0f 00 1a 28 ?? ?? 00 06 26 } //1
...
rule Backdoor_BAT_Bladabindi_AJ_3{
	...
	strings :
		$a_03_0 = {1f 1d 0f 01 1a 28 90 09 05 00 (6f|28) ?? ?? 00 [0a 06 2b] ?? ?? ?? ?? ?? ?? ?? ?? 00 06 26 } //1
...
rule Backdoor_BAT_Bladabindi_AJ_5{
	...
	strings :
		...
		$a_02_4 = {63 6d 64 2e 65 78 65 20 2f ?? 20 70 69 6e 67 20 30 20 26 20 64 65 6c 20 22 } //1
		$a_02_5 = {63 6d 64 2e 65 78 65 20 2f ?? 20 70 69 6e 67 20 30 20 2d 6e 20 [0-04] 20 26 20 64 65 6c 20 22 } //1
		$a_02_6 = {63 6d 64 2e 65 78 65 20 2f ?? 20 70 69 6e 67 20 31 32 37 2e 30 2e 30 2e 31 20 26 20 64 65 6c 20 22 } //1
	condition:
...
rule Backdoor_BAT_Bladabindi_AJ_6{
	...
	strings :
		...
		$a_02_4 = {45 00 78 00 65 00 63 00 75 00 74 00 65 00 20 00 45 00 52 00 52 00 4f 00 52 00 [0-10] 44 00 6f 00 77 00 6e 00 6c 00 6f 00 61 00 64 00 20 00 45 00 52 00 52 00 4f 00 52 00 } //1
		$a_02_5 = {44 00 6f 00 77 00 6e 00 6c 00 6f 00 61 00 64 00 20 00 45 00 52 00 52 00 4f 00 52 00 [0-10] 45 00 78 00 65 00 63 00 75 00 74 00 65 00 20 00 45 00 52 00 52 00 4f 00 52 00 } //1
	condition:
...
rule Backdoor_BAT_Bladabindi_AJ_8{
	...
	strings :
		...
		$a_02_4 = {63 00 6d 00 64 00 2e 00 65 00 78 00 65 00 20 00 2f 00 ?? ?? 20 00 70 00 69 00 6e 00 67 00 20 00 30 00 20 00 26 00 20 00 64 00 65 00 6c 00 20 00 22 00 } //1
		$a_02_5 = {63 00 6d 00 64 00 2e 00 65 00 78 00 65 00 20 00 2f 00 ?? ?? 20 00 70 00 69 00 6e 00 67 00 20 00 30 00 20 00 2d 00 6e 00 20 00 [0-08] 20 00 26 00 20 00 64 00 65 00 6c 00 20 00 22 00 } //1
		$a_02_6 = {63 00 6d 00 64 00 2e 00 65 00 78 00 65 00 20 00 2f 00 ?? ?? 20 00 70 00 69 00 6e 00 67 00 20 00 31 00 32 00 37 00 2e 00 30 00 2e 00 30 00 2e 00 31 00 20 00 26 00 20 00 64 00 65 00 6c 00 20 00 22 00 } //1
	condition:
		((#a_00_0  & 1)*10+(#a_00_1  & 1)*10+(#a_00_2  & 1)*10+(#a_00_3  & 1)*10+(#a_02_4  & 1)*1+(#a_02_5  & 1)*1+(#a_02_6  & 1)*1) >=41
