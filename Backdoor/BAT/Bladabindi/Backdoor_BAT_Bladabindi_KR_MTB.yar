...
rule Backdoor_BAT_Bladabindi_KR_MTB{
	...
	strings :
		...
		$a_01_3 = {43 75 72 72 65 6e 74 44 6f 6d 61 69 6e } //01 00  CurrentDomain
		$a_01_4 = {45 6e 74 72 79 50 6f 69 6e 74 } //01 00  EntryPoint
		$a_01_5 = {43 6f 6e 76 65 72 73 69 6f 6e 73 } //00 00  Conversions
	condition:
		any of ($a_*)
