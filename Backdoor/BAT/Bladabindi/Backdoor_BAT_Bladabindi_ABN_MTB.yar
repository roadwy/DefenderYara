...
rule Backdoor_BAT_Bladabindi_ABN_MTB{
	...
	strings :
		$a_03_0 = {03 11 0c 16 11 0a 6f 40 90 01 02 0a 25 26 26 11 09 11 0c 16 11 0a 11 0b 16 6f 4a 90 01 02 0a 13 0e 7e 0b 90 01 02 04 11 0b 16 11 0e 6f 4b 90 01 02 0a 11 0d 11 0a 58 13 0d 90 00 } //2
		$a_03_1 = {14 13 05 de 34 06 07 1f 10 6f 36 90 01 02 0a 0c 08 20 03 90 01 02 00 28 39 90 01 02 0a 25 26 0d 09 28 3a 90 01 02 0a 25 26 13 04 11 04 28 3b 90 01 02 0a 11 04 13 05 de 05 90 00 } //2
