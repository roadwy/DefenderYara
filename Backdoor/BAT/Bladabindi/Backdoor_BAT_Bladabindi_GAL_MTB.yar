...
rule Backdoor_BAT_Bladabindi_GAL_MTB{
	...
	strings :
		$a_03_0 = {0b 07 06 6f 90 01 01 00 00 0a 16 73 90 01 01 00 00 0a 0c 02 8e b7 17 d6 8d 90 01 01 00 00 01 0d 08 09 16 02 8e b7 6f 90 01 01 00 00 0a 13 04 11 04 17 d6 8d 90 01 01 00 00 01 13 05 09 11 05 11 04 28 90 01 01 00 00 0a 08 6f 90 01 01 00 00 0a de 10 90 00 } //3
