...
rule Backdoor_BAT_Bladabindi_N{
	...
	strings :
		...
		$a_00_3 = {64 64 62 35 66 66 64 37 36 65 31 30 34 35 30 65 39 32 33 35 36 39 61 62 30 30 65 32 63 32 31 39 } //01 00  ddb5ffd76e10450e923569ab00e2c219
		$a_00_4 = {73 65 72 76 65 72 2e 65 78 65 } //01 00  server.exe
		$a_00_5 = {70 61 73 73 77 6f 72 64 } //01 00  password
		$a_00_6 = {5c 4e 6f 75 76 65 61 75 } //00 00  \Nouveau
	condition:
		any of ($a_*)
