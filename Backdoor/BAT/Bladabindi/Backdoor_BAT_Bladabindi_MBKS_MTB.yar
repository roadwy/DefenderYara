...
rule Backdoor_BAT_Bladabindi_MBKS_MTB{
	...
	strings :
		$a_03_0 = {0a 0b 08 6f ?? 00 00 0a 00 73 ?? 00 00 0a 0d 09 07 6f ?? 00 00 0a 00 09 04 6f ?? 00 00 0a 00 09 05 6f ?? 00 00 0a 00 09 6f ?? 00 00 0a 13 04 11 04 02 16 02 8e 69 6f } //10
