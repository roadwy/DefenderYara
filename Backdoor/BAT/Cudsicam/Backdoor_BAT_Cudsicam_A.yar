...
rule Backdoor_BAT_Cudsicam_A{
	...
	strings :
		$a_01_0 = {43 6d 64 53 75 69 63 69 64 00 53 75 69 63 69 64 } //01 00 
		$a_01_1 = {50 61 72 73 65 43 6f 6d 6d 61 6e 64 00 63 6f 6d 6d 61 6e 64 00 63 6f 6d 6d 61 6e 64 4e 61 6d 65 } //01 00 
