...
rule Backdoor_BAT_Peekserve_B_dha{
	...
	strings :
		$a_00_0 = {33 61 66 38 35 62 62 33 2d 66 63 36 64 2d 34 35 34 35 2d 38 31 33 36 2d 64 64 30 36 33 39 65 63 38 64 34 39 } //02 00  3af85bb3-fc6d-4545-8136-dd0639ec8d49
		...
		$a_00_2 = {67 65 74 5f 49 6e 73 74 61 6c 6c 65 72 73 } //00 00  get_Installers
	condition:
		any of ($a_*)
