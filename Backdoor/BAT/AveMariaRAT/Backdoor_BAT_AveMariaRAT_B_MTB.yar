...
rule Backdoor_BAT_AveMariaRAT_B_MTB{
	...
	strings :
		$a_01_0 = {0a 13 07 09 11 07 d2 6e 1e 11 06 5a 1f 3f 5f 62 60 0d 11 06 17 58 13 06 11 06 1e 32 de 09 69 8d 32 00 00 01 25 17 73 10 00 00 0a 13 04 06 6f 11 00 00 0a 1f 0d 6a 59 } //2
