...
rule Backdoor_BAT_CryptInject_MTB{
	...
	strings :
		...
		$a_02_1 = {00 00 04 7e 0f 00 00 04 3a 11 00 00 00 14 fe 06 90 01 01 00 00 06 73 90 01 01 00 00 0a 80 90 01 01 00 00 04 7e 90 01 01 00 00 04 28 01 00 00 2b 28 02 00 00 2b 2a 90 00 } //1
		$a_02_2 = {28 18 00 00 06 28 90 01 01 00 00 0a 28 90 01 01 00 00 0a fe 0e 00 00 fe 0c 00 00 28 19 00 00 06 dd 06 00 00 00 26 dd 00 00 00 00 2a 90 00 } //1
		$a_02_3 = {fe 0e 00 00 fe 0c 00 00 90 0a 20 00 28 90 01 01 00 00 06 28 90 01 01 00 00 0a 28 90 01 01 00 00 0a fe 0e 00 00 fe 0c 00 00 28 90 01 01 00 00 06 dd 06 00 00 00 26 dd 00 00 00 00 2a 90 00 } //1
	condition:
