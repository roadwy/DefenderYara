...
rule Backdoor_Linux_Yakuza_YA_MTB{
	...
	strings :
		$a_02_0 = {63 64 20 2f 74 6d 70 3b 20 77 67 65 74 20 68 74 74 70 3a 2f 2f 90 02 03 2e 90 02 03 2e 90 02 03 2e 90 02 03 2f 62 69 6e 73 2e 73 68 3b 20 63 68 6d 6f 64 20 37 37 37 20 2a 3b 20 73 68 20 62 69 6e 73 2e 73 68 3b 90 00 } //5
