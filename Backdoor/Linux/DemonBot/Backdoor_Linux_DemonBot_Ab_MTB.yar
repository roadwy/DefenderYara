...
rule Backdoor_Linux_DemonBot_Ab_MTB{
	...
	strings :
		...
		$a_02_2 = {63 64 20 2f 74 6d 70 3b 62 75 73 79 62 6f 78 20 77 67 65 74 20 90 01 04 3a 2f 2f 90 02 03 2e 90 02 03 2e 90 02 03 2e 90 02 03 2f 69 6e 66 65 63 74 20 2d 4f 20 2d 20 3e 20 90 02 10 3b 20 62 75 73 79 62 6f 78 20 63 68 6d 6f 64 20 37 37 37 20 90 02 10 3b 20 73 68 20 2f 74 6d 70 2f 90 00 } //2
