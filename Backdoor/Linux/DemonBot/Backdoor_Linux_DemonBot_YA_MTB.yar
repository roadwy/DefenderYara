...
rule Backdoor_Linux_DemonBot_YA_MTB{
	...
	strings :
		...
		$a_00_1 = {54 53 6f 75 72 63 65 20 45 6e 67 69 6e 65 20 51 75 65 72 79 20 2b 20 2f 78 35 34 2f 78 } //01 00  TSource Engine Query + /x54/x
		$a_01_2 = {33 31 6d 56 35 2e 30 } //01 00  31mV5.0
		$a_01_3 = {33 31 6d 44 65 6d 6f 6e } //00 00  31mDemon
	condition:
		any of ($a_*)
