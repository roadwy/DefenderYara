...
rule Backdoor_Linux_GetShell_B_MTB{
	...
	strings :
		$a_03_0 = {31 db f7 e3 53 43 53 6a 02 b0 66 89 e1 cd 80 97 5b 68 7f 00 00 01 68 02 00 15 b3 89 e1 6a 66 58 50 51 57 89 e1 43 cd 80 85 c0 79 90 01 01 4e 74 90 01 01 68 a2 00 00 00 58 6a 00 6a 05 89 e3 31 c9 cd 80 85 c0 90 00 } //1
		$a_03_1 = {cd 80 93 59 b0 3f cd 80 49 79 90 01 01 68 c0 a8 01 4e 68 02 00 10 e1 89 e1 b0 66 50 51 53 b3 03 89 e1 cd 80 52 ba 00 00 73 68 66 ba 6e 2f 52 ba 00 00 62 69 66 ba 2f 2f 52 31 d2 89 e3 52 53 89 e1 b0 0b cd 80 90 00 } //1
