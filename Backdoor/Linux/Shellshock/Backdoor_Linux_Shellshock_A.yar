...
rule Backdoor_Linux_Shellshock_A{
	...
	strings :
		...
		$a_00_1 = {2f 62 69 6e 2f 62 75 73 79 62 6f 78 3b 65 63 68 6f 20 2d 65 20 27 5c 31 34 37 5c 31 34 31 5c 31 37 31 5c 31 34 36 5c 31 34 37 5c 31 36 34 27 } //01 00  /bin/busybox;echo -e '\147\141\171\146\147\164'
