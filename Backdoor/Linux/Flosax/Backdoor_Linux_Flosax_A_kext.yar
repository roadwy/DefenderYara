...
rule Backdoor_Linux_Flosax_A_kext{
	...
	strings :
		$a_01_0 = {61 70 70 6c 65 4f 73 61 78 } //01 00 
		$a_01_1 = {2e 6b 65 78 74 2e 6d 63 68 6f 6f 6b } //01 00 
		$a_01_2 = {61 70 70 6c 65 48 49 44 } //02 00 
		$a_01_3 = {2f 74 6d 70 2f 34 33 74 39 39 30 33 7a 7a } //02 00 
