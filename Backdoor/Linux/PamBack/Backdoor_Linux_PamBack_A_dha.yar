...
rule Backdoor_Linux_PamBack_A_dha{
	...
	strings :
		$a_01_0 = {65 72 72 6f 72 20 53 65 72 76 69 63 65 55 6e 6b 6e 6f 77 6e 2d 3e 25 73 } //01 00 
		$a_01_1 = {75 6e 69 78 5f 73 65 74 63 72 65 64 5f 72 65 74 75 72 6e } //03 00 
