...
rule Backdoor_Linux_WireLurker_A{
	...
	strings :
		...
		$a_01_2 = {43 6f 75 6c 64 20 6e 6f 74 20 73 74 61 72 74 20 63 6f 6d 2e 61 70 70 6c 65 2e 6d 6f 62 69 6c 65 2e 69 6e 73 74 61 6c 6c 61 74 69 6f 6e 5f 70 72 6f 78 79 21 } //01 00 
		$a_01_3 = {2f 75 73 72 2f 6c 6f 63 61 6c 2f 6d 61 63 68 6f 6f 6b 2f 77 61 74 63 68 2e 73 68 00 } //01 00 
