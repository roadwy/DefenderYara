...
rule Backdoor_Linux_Tsunami_L_xp{
	...
	strings :
		$a_03_0 = {8b 45 08 0f b6 00 0f b6 c0 89 04 24 e8 90 01 04 89 c3 8b 45 0c 0f b6 00 0f b6 c0 89 04 24 e8 90 01 04 39 c3 75 18 8b 45 0c 40 8b 55 08 42 89 44 24 04 89 14 24 90 00 } //1
