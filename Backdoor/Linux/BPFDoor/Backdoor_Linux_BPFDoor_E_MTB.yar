...
rule Backdoor_Linux_BPFDoor_E_MTB{
	...
	strings :
		$a_00_0 = {6b 64 6d 74 6d 70 66 6c 75 73 68 } //01 00  kdmtmpflush
		$a_00_1 = {70 69 63 6b 75 70 20 2d 6c 20 2d 74 20 66 69 66 6f 20 2d 75 } //01 00  pickup -l -t fifo -u
		$a_00_2 = {64 62 75 73 2d 64 61 65 6d 6f 6e 20 2d 2d 73 79 73 74 65 6d } //02 00  dbus-daemon --system
