...
rule Backdoor_Linux_BPFDoor_B_MTB{
	...
	strings :
		$a_03_0 = {8d 85 c4 fd ff ff 8d 50 0e 8b 45 ?? 8d 04 02 89 45 ?? 8b 45 ?? 0f b6 40 0c 0f b6 c0 25 f0 00 00 00 c1 f8 04 c1 e0 02 89 45 ?? 8d 85 c4 fd ff ff 8d 50 0e 8b 45 ?? 01 c2 8b 45 ?? 8d 04 02 89 45 } //1
		$a_03_1 = {83 c0 14 89 45 ?? 8b 45 ?? 83 c0 08 89 45 ?? eb 12 8b 45 ?? 83 c0 14 89 45 ?? 8b 45 ?? 83 c0 08 89 45 } //1
