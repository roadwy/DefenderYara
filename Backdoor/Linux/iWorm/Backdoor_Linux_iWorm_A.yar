...
rule Backdoor_Linux_iWorm_A{
	...
	strings :
		...
		$a_03_1 = {47 45 54 20 25 73 20 48 54 54 50 2f 31 2e 30 [0-10] 48 6f 73 74 3a 20 25 73 [0-10] 41 63 63 65 70 74 3a 20 74 65 78 74 2f 68 74 6d 6c } //1
		...
		$a_03_3 = {65 63 6b 65 79 2e 51 [0-20] 75 69 64 00 25 32 78 00 68 74 74 70 3a 2f 2f } //1
