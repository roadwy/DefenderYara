...
rule Backdoor_Linux_Apmod_A{
	...
	strings :
		...
		$a_01_1 = {61 70 5f 68 6f 6f 6b 5f 69 6e 73 65 72 74 5f 66 69 6c 74 65 72 00 } //01 00 
		$a_01_2 = {61 70 5f 72 65 67 69 73 74 65 72 5f 6f 75 74 70 75 74 5f 66 69 6c 74 65 72 00 } //00 00 
