...
rule Backdoor_Linux_Mirai_Q_MTB{
	...
	strings :
		$a_00_0 = {63 68 6d 6f 64 2b 37 37 37 2b 6c 6f 6c 6f 6c 2e 73 68 } //01 00  chmod+777+lolol.sh
		$a_00_1 = {2f 62 61 63 6b 75 70 6d 67 74 2f 6c 6f 63 61 6c 4a 6f 62 2e 70 68 70 } //01 00  /backupmgt/localJob.php
		$a_00_2 = {73 68 2b 6c 6f 6c 6f 6c 2e 73 68 } //01 00  sh+lolol.sh
