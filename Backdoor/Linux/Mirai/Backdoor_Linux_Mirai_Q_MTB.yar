...
rule Backdoor_Linux_Mirai_Q_MTB{
	...
	strings :
		...
		$a_03_3 = {77 67 65 74 2b 68 74 74 70 90 02 20 2f 6c 6f 6c 6f 6c 2e 73 68 90 00 } //1
		$a_03_4 = {63 75 72 6c 2b 2d 4f 90 01 02 68 74 74 70 90 02 20 2f 6c 6f 6c 6f 6c 2e 73 68 90 00 } //1
	condition:
