...
rule Backdoor_Linux_Mirai_CG_xp{
	...
	strings :
		$a_03_0 = {00 40 9e 00 d4 93 bf 00 1c 48 00 90 01 02 80 01 00 24 83 a1 00 14 83 c1 00 18 7c 08 03 a6 83 e1 00 1c 38 21 00 20 4e 80 00 20 38 80 00 09 3b a0 90 00 } //1
