...
rule Backdoor_Linux_Mirai_BY_xp{
	...
	strings :
		$a_03_0 = {83 c4 10 80 7f 14 1f 77 2a 8b 5f 10 e8 90 01 02 00 00 66 c1 cb 08 c1 cb 10 66 c1 cb 08 31 c9 8a 4f 14 d3 e8 01 d8 66 c1 c8 08 c1 c8 10 66 c1 c8 08 89 46 10 90 00 } //1
