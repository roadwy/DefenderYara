...
rule Backdoor_Linux_Mirai_FV_MTB{
	...
	strings :
		...
		$a_03_1 = {20 6e 00 08 30 10 00 40 00 08 22 6e 00 08 32 80 20 6e 00 08 20 28 00 0c 22 00 22 6e 00 08 20 29 00 08 24 01 94 80 2d 42 ff f8 4a ae ff f8 ?? ?? 20 2e ff f8 b0 ae ff f0 ?? ?? 2d 6e ff f0 ff f8 } //1
	condition:
