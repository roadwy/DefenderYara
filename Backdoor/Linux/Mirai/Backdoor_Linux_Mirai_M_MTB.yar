...
rule Backdoor_Linux_Mirai_M_MTB_2{
	...
	strings :
		$a_03_0 = {00 50 50 e2 12 00 00 0a 04 40 95 e5 90 01 01 ff ff eb 00 10 d5 e5 90 01 01 06 00 eb 90 01 01 31 94 e7 05 00 a0 e1 04 30 8d e5 90 01 01 01 00 eb 06 00 a0 e1 0d 10 a0 e1 10 20 a0 e3 90 01 03 eb 01 00 70 e3 00 40 a0 e1 90 02 09 06 00 a0 e1 10 d0 8d e2 70 90 01 01 bd e8 90 00 } //5
		$a_03_1 = {8f bc 00 10 24 03 ff ff 8f 99 81 40 10 90 01 03 02 40 20 21 02 40 10 21 8f bf 00 34 8f b2 00 30 8f b1 00 2c 8f b0 00 28 03 e0 00 08 27 bd 00 38 03 20 f8 09 24 12 ff ff 8f bc 00 10 10 90 01 03 02 40 10 21 03 90 01 03 24 12 ff ff 8f bc 00 10 90 00 } //5
