...
rule Backdoor_Linux_Mirai_BG_MTB{
	...
	strings :
		$a_01_0 = {7a 77 6e 61 6d 73 6d 71 66 68 64 } //01 00 
		$a_01_1 = {69 6b 6c 6d 68 6f 6a 64 } //01 00 
		$a_01_2 = {63 6d 6e 76 6d 72 4f 61 59 6d 6e 76 68 64 65 } //01 00 
		$a_00_3 = {63 68 6d 6f 64 20 2b 78 20 73 68 61 6b 65 72 } //01 00 
