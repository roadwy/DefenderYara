...
rule Backdoor_Linux_Mirai_CK_xp{
	...
	strings :
		$a_00_0 = {72 6d 20 2d 72 66 20 2f 74 6d 70 2f 2a 20 2f 76 61 72 2f 2a 20 2f 76 61 72 2f 72 75 6e 2f 2a 20 2f 76 61 72 2f 74 6d 70 2f 2a } //01 00  rm -rf /tmp/* /var/* /var/run/* /var/tmp/*
