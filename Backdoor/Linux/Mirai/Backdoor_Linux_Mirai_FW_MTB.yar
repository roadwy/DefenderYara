...
rule Backdoor_Linux_Mirai_FW_MTB{
	...
	strings :
		$a_03_0 = {04 00 42 92 00 00 43 8e 05 00 52 26 14 00 a2 a0 04 00 a3 ac 10 00 a3 ac 00 00 a6 a4 f8 90 01 03 18 00 a5 24 21 10 d7 02 23 10 22 02 fa ff 54 24 90 00 } //1
