...
rule Backdoor_Linux_Mirai_Ci_MTB{
	...
	strings :
		$a_03_0 = {63 64 20 2f 64 61 74 61 2f 6c 6f 63 61 6c 2f 74 6d 70 3b 20 62 75 73 79 62 6f 78 20 77 67 65 74 20 68 74 74 70 3a 2f 2f 90 02 15 2f 77 67 65 74 20 2d 4f 90 00 } //3
		$a_03_1 = {63 75 72 6c 20 2d 4f 20 68 74 74 70 3a 2f 2f 90 02 15 2f 63 75 72 6c 3b 20 73 68 20 63 75 72 6c 3b 20 72 6d 90 00 } //3
