...
rule Backdoor_Linux_Mirai_D_MTB{
	...
	strings :
		$a_00_0 = {2f 62 69 6e 2f 62 75 73 79 62 6f 78 20 43 4f 52 4f 4e 41 } //02 00  /bin/busybox CORONA
		...
		$a_00_2 = {68 75 6e 74 35 37 35 39 } //01 00  hunt5759
		$a_00_3 = {74 73 67 6f 69 6e 67 6f 6e } //01 00  tsgoingon
		$a_00_4 = {78 6d 68 64 69 70 63 } //01 00  xmhdipc
		$a_00_5 = {73 79 6e 6e 65 74 } //01 00  synnet
		$a_00_6 = {65 70 69 63 72 6f 75 74 65 } //01 00  epicroute
		$a_00_7 = {74 65 6c 65 63 6f 6d 61 64 6d 69 6e } //00 00  telecomadmin
	condition:
		any of ($a_*)
...
rule Backdoor_Linux_Mirai_D_MTB_2{
	...
	strings :
		$a_00_0 = {2f 65 74 63 2f 63 72 6f 6e 74 61 62 2f 72 6f 6f 74 } //01 00  /etc/crontab/root
		$a_00_1 = {72 6d 20 2d 72 66 20 6c 6f 6c 6f 6c 2e 73 68 } //01 00  rm -rf lolol.sh
		...
		$a_00_4 = {62 61 63 6b 75 70 6d 67 74 2f 6c 6f 63 61 6c 4a 6f 62 2e 70 68 70 } //00 00  backupmgt/localJob.php
	condition:
		any of ($a_*)
