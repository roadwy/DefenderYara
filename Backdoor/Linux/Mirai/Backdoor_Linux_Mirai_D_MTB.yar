...
rule Backdoor_Linux_Mirai_D_MTB_2{
	...
	strings :
		...
		$a_02_2 = {62 75 73 79 62 6f 78 20 77 67 65 74 20 68 74 74 70 90 02 08 2e 90 02 03 2e 90 02 03 2e 90 01 02 2f 6c 6f 6c 6f 6c 2e 73 68 90 00 } //1
		$a_02_3 = {73 68 65 6c 6c 20 63 64 20 2f 74 6d 70 3b 20 77 67 65 74 20 68 74 74 70 90 02 08 2e 90 02 03 2e 90 02 03 2e 90 01 02 2f 6c 6f 6c 6f 6c 2e 73 68 3b 20 63 68 6d 6f 64 20 37 37 37 20 6c 6f 6c 6f 6c 2e 73 68 3b 20 73 68 20 6c 6f 6c 6f 6c 2e 73 68 90 00 } //1
