...
rule Backdoor_Linux_Mirai_bc_MTB{
	...
	strings :
		...
		$a_00_2 = {49 4e 46 45 43 54 45 44 } //01 00  INFECTED
		$a_00_3 = {6b 69 6c 6c 65 72 5f 6b 69 6c 6c 5f 62 79 5f 70 6f 72 74 } //01 00  killer_kill_by_port
		$a_00_4 = {72 65 61 6c 74 65 6b 73 63 61 6e 6e 65 72 5f 73 63 61 6e 6e 65 72 5f 6b 69 6c 6c } //01 00  realtekscanner_scanner_kill
		$a_00_5 = {61 6b 34 37 74 65 6c 73 63 61 6e } //01 00  ak47telscan
		$a_00_6 = {64 6e 73 66 6c 6f 6f 64 } //00 00  dnsflood
	condition:
		any of ($a_*)
