...
rule Backdoor_Linux_Mirai_Bv_MTB{
	...
	strings :
		...
		$a_01_2 = {61 74 74 61 63 6b 5f 73 70 6f 6f 66 65 64 } //01 00 
		$a_01_3 = {61 74 74 61 63 6b 5f 74 63 70 } //01 00 
		$a_00_4 = {65 78 70 6c 6f 69 74 65 72 2e 63 } //01 00 
		$a_01_5 = {41 74 74 61 63 6b 70 69 64 } //00 00 
	condition:
		any of ($a_*)
