...
rule Backdoor_Linux_Mirai_BJ_xp{
	...
	strings :
		$a_00_0 = {8b 04 85 20 e1 50 00 31 c2 8b 45 fc 31 d0 89 c2 81 f2 b9 79 37 9e 48 63 c1 89 14 85 20 e1 50 00 } //1
		$a_00_1 = {8b 0d 39 d9 10 00 8b 55 f0 8b 45 f4 89 c3 29 d3 89 da 89 c8 89 14 85 20 e1 50 00 89 c8 8b 04 85 20 e1 50 00 } //1
	condition:
...
rule Backdoor_Linux_Mirai_BJ_xp_2{
	...
	strings :
		$a_01_0 = {68 62 6f 74 20 70 72 6f 63 20 73 74 61 72 74 69 6e 67 2e 2e 2e } //1 hbot proc starting...
		$a_01_1 = {2f 62 69 6e 2f 62 75 73 79 62 6f 78 } //1 /bin/busybox
