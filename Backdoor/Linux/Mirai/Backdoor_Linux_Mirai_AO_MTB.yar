...
rule Backdoor_Linux_Mirai_AO_MTB{
	...
	strings :
		...
		$a_02_2 = {63 64 20 2f 76 61 72 3b 20 72 6d 20 2d 72 66 20 6e 69 67 3b 20 77 67 65 74 20 68 74 74 70 3a 2f 2f 90 02 03 2e 90 02 03 2e 90 02 03 2e 90 02 03 2f 48 69 6c 69 78 2e 73 68 20 2d 4f 20 68 78 3b 20 63 68 6d 6f 64 20 37 37 37 20 68 78 3b 20 2e 2f 68 78 90 00 } //2
	condition:
