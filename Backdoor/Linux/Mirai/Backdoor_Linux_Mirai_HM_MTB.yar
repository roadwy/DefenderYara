...
rule Backdoor_Linux_Mirai_HM_MTB{
	...
	strings :
		...
		$a_03_1 = {18 00 c3 00 98 80 99 8f 24 00 44 26 12 30 00 00 09 f8 20 03 21 28 20 02 60 00 a2 8f 4c 00 a3 8f 20 00 bc 8f 18 00 43 00 12 10 00 00 21 a0 22 02 00 00 92 ae 60 00 a2 8f 09 90 01 03 ff ff 43 24 90 00 } //1
	condition:
