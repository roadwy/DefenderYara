...
rule Backdoor_Linux_Mirai_BJ_MTB{
	...
	strings :
		...
		$a_00_2 = {6f 64 30 32 39 65 6a 73 6c 6b 77 6e 32 38 64 39 32 6c 73 30 32 70 77 6c 32 30 64 67 71 6e 77 } //01 00 
		$a_00_3 = {65 67 76 6e 6d 61 63 6e 6b 72 } //01 00 
		$a_00_4 = {68 6c 4c 6a 7a 74 71 5a } //00 00 
	condition:
		any of ($a_*)
