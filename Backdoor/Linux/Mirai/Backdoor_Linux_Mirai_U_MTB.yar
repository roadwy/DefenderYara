...
rule Backdoor_Linux_Mirai_U_MTB{
	...
	strings :
		...
		$a_00_1 = {4d 45 49 4e 53 4d } //01 00  MEINSM
		$a_00_2 = {54 53 55 4e 41 4d 49 } //01 00  TSUNAMI
		$a_00_3 = {58 4d 48 44 49 50 43 } //01 00  XMHDIPC
		$a_00_4 = {54 45 4c 45 43 4f 4d 41 44 4d 49 4e } //00 00  TELECOMADMIN
	condition:
		any of ($a_*)
