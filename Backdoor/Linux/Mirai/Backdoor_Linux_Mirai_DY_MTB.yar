...
rule Backdoor_Linux_Mirai_DY_MTB{
	...
	strings :
		...
		$a_03_1 = {06 00 1c 3c 90 01 02 9c 27 21 e0 99 03 e0 ff bd 27 10 00 bc af 1c 00 bf af 18 00 bc af 01 00 11 04 00 00 00 00 06 00 1c 3c 90 01 02 9c 27 21 e0 9f 03 20 80 99 8f 00 00 00 00 dc 01 39 27 09 f8 20 03 00 00 00 00 10 00 bc 8f 00 00 00 00 01 00 11 04 90 00 } //1
	condition:
