...
rule Backdoor_Linux_Mirai_IH_MTB{
	...
	strings :
		$a_03_0 = {8f 99 80 64 8e 44 00 04 03 20 f8 09 02 20 28 21 8f bc 00 10 04 90 01 03 00 00 00 00 02 22 88 21 10 90 01 03 02 02 80 23 96 42 00 00 8e 44 00 08 8e 43 00 0c 34 42 00 08 00 64 18 23 90 00 } //1
