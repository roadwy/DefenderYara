...
rule Backdoor_Linux_Mirai_Z_MTB{
	...
	strings :
		$a_03_0 = {a0 e1 18 10 1b e5 01 38 a0 e1 23 38 a0 e1 03 20 82 e0 90 01 01 20 0b e5 18 20 1b e5 22 38 a0 e1 18 10 1b e5 03 10 81 e0 18 10 0b e5 18 20 1b 90 00 } //1
