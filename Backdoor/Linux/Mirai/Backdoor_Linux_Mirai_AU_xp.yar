...
rule Backdoor_Linux_Mirai_AU_xp{
	...
	strings :
		...
		$a_01_1 = {54 56 57 53 56 50 56 54 } //01 00  TVWSVPVT
		$a_01_2 = {50 4f 53 54 20 2f 63 64 6e 2d 63 67 69 2f } //01 00  POST /cdn-cgi/
		$a_01_3 = {2f 64 65 76 2f 6e 75 6c 6c } //00 00  /dev/null
	condition:
		any of ($a_*)
