...
rule Backdoor_Linux_Mirai_DW_MTB{
	...
	strings :
		...
		$a_00_2 = {6b 75 63 6b 2e 74 65 63 68 } //01 00 
		$a_00_3 = {54 43 50 20 43 6f 6e 6e 65 63 74 } //01 00 
		$a_00_4 = {54 53 6f 75 72 63 65 20 45 6e 67 69 6e 65 20 51 75 65 72 79 } //00 00 
	condition:
		any of ($a_*)
