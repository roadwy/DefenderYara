...
rule Backdoor_Linux_Mirai_BL_MTB{
	...
	strings :
		$a_00_0 = {64 73 6e 63 74 6f 64 74 6f 65 75 70 65 75 70 65 75 70 } //01 00 
		$a_00_1 = {76 66 6d 67 75 66 6e 68 76 67 6e 68 77 68 6f 69 77 68 6f 69 77 68 6f 69 } //01 00 
		$a_00_2 = {31 76 65 71 68 62 6e 66 30 76 65 71 69 63 6f 67 31 77 66 72 69 63 6f 67 32 78 67 73 6a 64 70 68 32 78 67 73 6a 64 70 68 32 78 67 73 6a 64 70 68 } //02 00 
