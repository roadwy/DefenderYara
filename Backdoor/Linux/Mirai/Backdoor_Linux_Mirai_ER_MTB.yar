...
rule Backdoor_Linux_Mirai_ER_MTB{
	...
	strings :
		...
		$a_03_1 = {05 00 00 3f a3 30 60 10 ac 10 a3 ff 82 10 20 00 a5 37 60 10 83 28 60 02 d4 07 be b8 a7 3d e0 18 e0 02 80 01 80 a4 80 16 02 80 90 01 02 b6 04 20 14 90 00 } //1
	condition:
