...
rule Backdoor_Linux_BitXo_A_MTB{
	...
	strings :
		...
		$a_03_5 = {01 10 8f e0 01 20 a0 e3 10 80 8d e5 0c 40 8d e5 08 00 8d e5 04 00 8d e5 00 00 8d e5 01 00 70 e3 00 70 a0 e1 90 02 05 00 10 a0 e1 08 30 a0 e1 05 20 a0 e1 04 00 a0 e1 90 02 05 01 00 70 e3 90 02 05 01 00 a0 e3 90 02 05 08 30 a0 e1 05 20 a0 e1 07 10 a0 e1 04 00 a0 e1 90 02 05 01 00 70 e3 90 00 } //1
