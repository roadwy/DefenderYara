...
rule Backdoor_Linux_Powbot_A{
	...
	strings :
		$a_00_0 = {6b 69 6c 6c 00 75 64 70 00 73 79 6e 00 74 63 70 61 6d 70 00 64 69 6c 64 6f 73 00 68 74 74 70 00 6d 69 6e 65 6c 6f 72 69 73 00 } //01 00  楫汬甀灤猀湹琀灣浡p楤摬獯栀瑴p業敮潬楲s
