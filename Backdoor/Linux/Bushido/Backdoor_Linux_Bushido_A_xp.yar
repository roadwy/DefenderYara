...
rule Backdoor_Linux_Bushido_A_xp{
	...
	strings :
		...
		$a_03_4 = {47 45 54 20 2f 73 68 65 6c 6c 3f 63 64 2b 2f 74 6d 70 3b 2b 77 67 65 74 2b 68 74 74 70 3a 2f 5c 2f 90 02 03 2e 90 02 03 2e 90 02 03 2e 90 02 03 2f 90 02 10 2f 90 02 10 2e 61 72 6d 3b 2b 63 68 6d 6f 64 2b 37 37 37 2b 90 02 10 2e 61 72 6d 3b 2b 2e 2f 90 02 10 2e 61 72 6d 20 4a 61 77 73 2e 53 65 6c 66 72 65 70 3b 72 6d 2b 2d 72 66 2b 90 02 10 2e 61 72 6d 90 00 } //2
	condition:
