...
rule Backdoor_Linux_Gafgyt_K_xp{
	...
	strings :
		...
		$a_02_4 = {2f 62 69 6e 2f 62 75 73 79 62 6f 78 20 77 67 65 74 20 68 74 74 70 3a 2f 2f [0-03] 2e [0-03] 2e [0-03] 2e [0-03] 2f [0-10] 2e 73 68 3b 20 2f 62 69 6e 2f 62 75 73 79 62 6f 78 20 63 68 6d 6f 64 20 2b 78 20 [0-10] 2e 73 68 3b 20 73 68 20 [0-10] 2e 73 68 } //1
