...
rule Backdoor_Linux_Gafgyt_BB_MTB{
	...
	strings :
		$a_02_0 = {2f 62 69 6e 2f 62 75 73 79 62 6f 78 20 77 67 65 74 20 2d 67 20 90 02 03 2e 90 02 03 2e 90 02 03 2e 90 02 03 20 2d 6c 90 00 } //1
		$a_02_1 = {2f 74 6d 70 2f 90 02 10 20 2d 72 20 2f 62 69 6e 73 2f 74 65 6c 6e 65 74 2e 6d 69 70 73 90 00 } //1
		$a_02_2 = {63 68 6d 6f 64 20 37 37 37 20 2a 20 2f 74 6d 70 2f 90 02 10 3b 20 2f 74 6d 70 2f 90 02 10 20 68 75 61 77 65 69 90 00 } //1
