...
rule Backdoor_Linux_Gafgyt_AS_MTB{
	...
	strings :
		$a_02_0 = {63 64 20 2f 74 6d 70 20 7c 7c 20 63 64 20 2f 76 61 72 2f 72 75 6e 3b 77 67 65 74 20 68 74 74 70 3a 2f 2f 90 02 15 2f 90 02 10 3b 73 68 20 90 02 10 3b 72 6d 20 90 02 10 3b 74 66 74 70 20 2d 72 20 90 02 10 20 2d 67 20 90 02 20 3b 63 68 6d 6f 64 20 37 37 37 90 00 } //5
