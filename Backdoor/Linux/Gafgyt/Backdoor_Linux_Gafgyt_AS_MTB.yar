...
rule Backdoor_Linux_Gafgyt_AS_MTB{
	...
	strings :
		...
		$a_01_1 = {53 43 41 4e 5a 45 52 20 4f 4e 20 7c 20 4f 46 46 } //01 00  SCANZER ON | OFF
		$a_01_2 = {4c 4f 4c 4e 4f 47 54 46 4f } //01 00  LOLNOGTFO
		$a_01_3 = {67 61 79 66 67 74 } //01 00  gayfgt
		$a_01_4 = {54 45 4c 53 43 41 4e 4e 45 52 } //00 00  TELSCANNER
	condition:
		any of ($a_*)
