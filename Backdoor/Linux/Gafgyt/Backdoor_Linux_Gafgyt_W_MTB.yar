...
rule Backdoor_Linux_Gafgyt_W_MTB{
	meta:
		description = "Backdoor:Linux/Gafgyt.W!MTB,SIGNATURE_TYPE_ELFHSTR_EXT,02 00 02 00 02 00 00 01 00 "
	...
	strings :
		...
		$a_03_1 = {26 10 22 01 27 18 02 00 21 10 4b 00 26 10 43 00 24 10 4a 00 f8 ff 40 10 04 00 84 24 fc ff 82 90 01 01 ff ff 88 24 fc ff 83 24 fd ff 86 24 03 00 45 14 fe ff 87 24 08 00 e0 03 21 10 60 00 90 00 } //00 00 
	condition:
		any of ($a_*)
