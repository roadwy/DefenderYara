...
rule Backdoor_Linux_Gafgyt_W_xp{
	...
	strings :
		...
		$a_02_2 = {66 74 70 67 65 74 20 2d 76 20 2d 75 20 61 6e 6f 6e 79 6d 6f 75 73 20 2d 70 20 61 6e 6f 6e 79 6d 6f 75 73 20 2d 50 20 32 31 20 90 02 15 20 66 74 70 31 2e 73 68 20 66 74 70 31 2e 73 68 90 00 } //1
		$a_02_3 = {8b 4d fc 8b 45 fc 83 e8 03 8b 14 85 90 01 04 8b 45 fc 83 e8 02 8b 04 85 90 01 04 31 c2 8b 45 fc 31 d0 35 b9 79 37 9e 89 04 8d 80 43 05 08 ff 45 fc 90 00 } //1
