...
rule Backdoor_Linux_Gafgyt_BE_MTB{
	...
	strings :
		...
		$a_00_1 = {72 6d 20 2d 72 66 20 2f 76 61 72 2f 6c 6f 67 2f 77 74 6d 70 } //01 00 
		$a_00_2 = {70 6b 69 6c 6c 20 2d 39 20 62 75 73 79 62 6f 78 } //01 00 
		$a_01_3 = {42 4f 54 4b 49 4c 4c } //01 00 
		$a_01_4 = {54 45 4c 4e 45 54 20 4f 4e 20 7c 20 4f 46 46 } //00 00 
	condition:
		any of ($a_*)
