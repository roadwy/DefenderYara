...
rule Backdoor_Linux_Gafgyt_JJ{
	...
	strings :
		$a_03_0 = {37 9e 02 3c b9 79 42 34 21 18 62 00 18 80 82 8f 00 00 00 00 90 02 02 42 24 04 00 43 ac 18 00 c3 8f 6e 3c 02 3c 72 f3 42 34 90 00 } //1
		$a_03_1 = {3c 02 9e 37 34 42 79 b9 00 62 18 21 8f 82 80 18 00 00 00 00 24 42 90 02 02 ac 43 00 04 8f c3 00 18 3c 02 3c 6e 34 42 f3 72 90 00 } //1
