...
rule Backdoor_Linux_Gafgyt_U_xp{
	...
	strings :
		...
		$a_02_3 = {63 64 20 2f 74 6d 70 3b 20 77 67 65 74 20 68 74 74 70 3a 2f 2f [0-03] 2e [0-03] 2e [0-03] 2e [0-03] 2f [0-10] 2e 73 68 3b 20 63 68 6d 6f 64 20 37 37 37 20 2a 3b 20 73 68 20 [0-10] 2e 73 68 } //1
	condition:
