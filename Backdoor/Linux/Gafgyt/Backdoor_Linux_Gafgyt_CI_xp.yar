...
rule Backdoor_Linux_Gafgyt_CI_xp{
	...
	strings :
		$a_00_0 = {6b 69 6c 6c 20 2d 39 20 24 28 70 69 64 6f 66 20 62 75 73 79 62 6f 78 } //01 00  kill -9 $(pidof busybox
		$a_00_1 = {2f 75 73 72 2f 73 62 69 6e 2f 64 72 6f 70 62 65 61 72 } //01 00  /usr/sbin/dropbear
		$a_00_2 = {62 75 73 79 62 6f 78 20 74 66 74 70 20 2d 72 20 74 66 74 70 32 2e 73 68 20 2d 67 } //01 00  busybox tftp -r tftp2.sh -g
