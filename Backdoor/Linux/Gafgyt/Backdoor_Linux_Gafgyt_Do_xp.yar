...
rule Backdoor_Linux_Gafgyt_Do_xp{
	...
	strings :
		...
		$a_03_1 = {63 64 20 2f 74 6d 70 3b 20 72 6d 20 2d 72 66 20 2a 3b 20 77 67 65 74 20 2d 71 20 68 74 74 70 3a 2f 2f 90 02 12 2f 63 6f 63 6b 73 2e 73 68 3b 20 63 68 6d 6f 64 20 2b 78 20 63 6f 63 6b 73 2e 73 68 3b 20 73 68 20 63 6f 63 6b 73 2e 73 68 3b 20 72 6d 20 2d 72 66 20 2a 90 00 } //1
