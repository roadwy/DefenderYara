...
rule Backdoor_Linux_Gafgyt_F_MTB{
	...
	strings :
		...
		$a_00_1 = {2e 2f 2e 61 6b 61 6d 65 } //01 00 
		$a_00_2 = {61 6b 61 6d 65 62 6f 74 6e 65 74 } //01 00 
		$a_00_3 = {73 70 6f 6f 66 65 64 } //01 00 
		$a_00_4 = {62 69 6e 73 2f 61 6b 61 6d 65 2e } //00 00 
	condition:
		any of ($a_*)
