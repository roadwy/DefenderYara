...
rule Backdoor_Linux_Gafgyt_AC_xp{
	...
	strings :
		...
		$a_01_1 = {55 54 53 44 54 53 50 } //01 00  UTSDTSP
		$a_01_2 = {4c 54 53 4f 54 53 4c 54 53 4e 54 53 4f 54 53 47 54 53 54 54 53 46 54 53 4f } //01 00  LTSOTSLTSNTSOTSGTSTTSFTSO
		$a_01_3 = {4a 54 53 55 54 53 4e 54 53 4b } //00 00  JTSUTSNTSK
