...
rule Backdoor_Linux_Gafgyt_AG_xp{
	...
	strings :
		$a_01_0 = {74 6f 72 5f 61 64 64 5f 73 6f 63 6b } //01 00 
		$a_01_1 = {74 63 70 72 61 77 } //01 00 
		$a_01_2 = {75 64 70 70 6c 61 69 6e } //01 00 
		$a_01_3 = {6d 61 69 6e 5f 69 6e 73 74 61 6e 63 65 5f 6b 69 6c 6c } //00 00 
