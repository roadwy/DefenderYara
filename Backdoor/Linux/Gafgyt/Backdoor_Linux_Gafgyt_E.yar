...
rule Backdoor_Linux_Gafgyt_E_2{
	...
	strings :
		$a_00_0 = {31 38 35 2e 32 31 36 2e 32 31 33 2e 31 33 37 } //02 00  185.216.213.137
		$a_00_1 = {31 39 33 2e 31 34 32 2e 35 38 2e 31 37 31 } //01 00  193.142.58.171
		$a_00_2 = {34 35 28 34 33 32 28 34 37 33 28 37 36 34 } //02 00  45(432(473(764
		$a_00_3 = {39 31 2e 32 30 36 2e 39 32 2e 32 30 38 } //01 00  91.206.92.208
		$a_00_4 = {62 6f 74 6e 65 74 } //01 00  botnet
		$a_00_5 = {62 6f 74 6b 69 6c 6c } //02 00  botkill
		$a_00_6 = {24 55 49 43 49 44 45 42 4f 59 24 } //01 00  $UICIDEBOY$
		$a_00_7 = {50 49 4e 47 } //01 00  PING
		$a_00_8 = {50 4f 4e 47 } //01 00  PONG
		$a_00_9 = {42 30 54 4b 31 6c 6c } //00 00  B0TK1ll
	condition:
		any of ($a_*)
