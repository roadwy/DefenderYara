...
rule Backdoor_Linux_Gafgyt_BB_xp_2{
	...
	strings :
		$a_01_0 = {72 6d 20 2d 72 66 20 43 68 65 61 74 73 2a } //01 00  rm -rf Cheats*
		$a_00_1 = {63 64 20 2f 72 6f 6f 74 } //01 00  cd /root
		$a_01_2 = {4d 6f 6a 65 65 6b 42 6f 74 2f 32 2e 30 } //01 00  MojeekBot/2.0
		$a_00_3 = {2f 65 74 63 2f 72 65 73 6f 6c 76 2e 63 6f 6e 66 } //01 00  /etc/resolv.conf
