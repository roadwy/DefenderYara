...
rule Backdoor_Linux_Gafgyt_S_xp{
	...
	strings :
		...
		$a_02_4 = {63 64 20 2f 74 6d 70 3b 20 62 75 73 79 62 6f 78 20 77 67 65 74 20 68 74 74 70 3a 2f 2f 90 02 30 2f 6c 6f 6c 69 2e 73 68 3b 20 63 68 6d 6f 64 20 37 37 37 20 6c 6f 6c 69 2e 73 68 90 00 } //2
	condition:
