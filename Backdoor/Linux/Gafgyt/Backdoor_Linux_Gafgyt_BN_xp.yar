...
rule Backdoor_Linux_Gafgyt_BN_xp{
	...
	strings :
		...
		$a_01_1 = {2f 75 73 72 2f 73 62 69 6e 73 2f 64 72 6f 70 62 65 61 72 } //01 00  /usr/sbins/dropbear
		$a_01_2 = {52 4d 42 55 53 59 } //01 00  RMBUSY
		$a_01_3 = {42 75 73 79 42 6f 78 } //01 00  BusyBox
