...
rule Backdoor_Linux_Gafgyt_AL_MTB{
	...
	strings :
		$a_02_0 = {63 64 20 2f 74 6d 70 3b 62 75 73 79 62 6f 78 20 77 67 65 74 20 68 74 74 70 3a 2f 2f 90 02 03 2e 90 02 03 2e 90 02 03 2e 90 02 03 2f 69 6e 66 65 63 74 20 2d 4f 90 00 } //2
