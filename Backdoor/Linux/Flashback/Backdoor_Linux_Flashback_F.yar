...
rule Backdoor_Linux_Flashback_F{
	...
	strings :
		$a_01_0 = {25 73 2e 25 73 2e 73 6f } //01 00 
		$a_01_1 = {25 73 7c 25 73 7c 25 73 7c 25 73 7c 25 73 7c 25 73 7c 25 64 } //01 00 
		$a_01_2 = {25 73 20 22 25 73 25 73 25 73 22 20 25 73 20 22 25 73 } //01 00 
		$a_01_3 = {49 4f 50 6c 61 74 66 6f 72 6d 55 55 49 44 } //01 00 
		$a_01_4 = {73 79 73 63 74 6c 2e 70 72 6f 63 5f 63 70 75 74 79 70 65 } //06 00 
		$a_01_5 = {64 46 64 31 6a 73 } //06 00 
