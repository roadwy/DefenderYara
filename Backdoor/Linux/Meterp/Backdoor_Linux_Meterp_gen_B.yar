...
rule Backdoor_Linux_Meterp_gen_B{
	...
	strings :
		$a_00_0 = {2f 6d 65 74 74 6c 65 2f 6d 65 74 74 6c 65 2f 73 72 63 2f 6d 61 69 6e 2e 63 } //2 /mettle/mettle/src/main.c
		$a_00_1 = {70 72 6f 63 65 73 73 5f 6b 69 6c 6c 5f 62 79 5f 70 69 64 } //1 process_kill_by_pid
		$a_00_2 = {2d 2d 70 65 72 73 69 73 74 20 5b 6e 6f 6e 65 7c 69 6e 73 74 61 6c 6c 7c 75 6e 69 6e 73 74 61 6c 6c 5d 20 6d 61 6e 61 67 65 20 70 65 72 73 69 73 74 65 6e 63 65 } //1 --persist [none|install|uninstall] manage persistence
		$a_00_3 = {2d 2d 62 61 63 6b 67 72 6f 75 6e 64 20 5b 30 7c 31 5d 20 73 74 61 72 74 20 61 73 20 61 20 62 61 63 6b 67 72 6f 75 6e 64 20 73 65 72 76 69 63 65 } //1 --background [0|1] start as a background service
		$a_00_4 = {6d 65 74 74 6c 65 73 70 6c 6f 69 74 } //2 mettlesploit
	condition:
