...
rule Backdoor_Linux_Dakkatoni_B_MTB_2{
	...
	strings :
		...
		$a_00_2 = {2f 74 6d 70 2f 41 6e 74 69 56 69 72 74 6d 70 } //01 00 
		$a_00_3 = {70 79 74 68 6f 6e 20 2d 63 20 27 69 6d 70 6f 72 74 20 70 74 79 3b 70 74 79 2e 73 70 61 77 6e 28 22 2f 62 69 6e 2f 73 68 } //00 00 
	condition:
		any of ($a_*)
