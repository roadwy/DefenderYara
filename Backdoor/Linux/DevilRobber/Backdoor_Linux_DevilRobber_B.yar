...
rule Backdoor_Linux_DevilRobber_B{
	...
	strings :
		...
		$a_01_1 = {25 23 2e 38 78 20 25 23 2e 38 78 20 25 23 2e 38 78 20 25 23 2e 38 78 20 25 23 2e 38 78 } //01 00 
		$a_01_2 = {25 23 2e 38 78 5f 25 23 2e 38 78 5f 25 23 2e 38 78 2e 7a 69 70 20 7a 69 70 20 2d 72 20 2d 58 } //01 00 
		$a_01_3 = {64 5f 73 74 61 74 75 73 2e 63 66 67 } //01 00 
		$a_01_4 = {2e 2f 70 5f 73 74 61 72 74 2e 73 68 } //03 00 
