...
rule TrojanClicker_BAT_Balamid_A_6{
	...
	strings :
		$a_01_0 = {65 00 78 00 65 00 63 00 20 00 73 00 61 00 61 00 74 00 } //01 00 
		$a_01_1 = {59 00 61 00 42 00 72 00 6f 00 77 00 73 00 65 00 72 00 } //01 00 
		$a_01_2 = {65 00 78 00 65 00 63 00 20 00 75 00 79 00 65 00 6d 00 63 00 6b 00 6f 00 6e 00 74 00 72 00 6f 00 6c 00 20 00 40 00 6d 00 61 00 63 00 } //01 00 
		...
		$a_01_6 = {2f 00 74 00 6f 00 79 00 2e 00 74 00 78 00 74 00 } //00 00 
