...
rule TrojanClicker_Win32_Olafre_A{
	...
	strings :
		...
		$a_03_1 = {64 ff 30 64 89 20 8b d6 b8 90 01 02 45 00 e8 90 01 03 ff 85 c0 7e 0c 8d 45 90 01 01 8b d6 e8 90 01 03 ff eb 0f 8d 45 fc 8b ce ba 90 01 02 45 00 e8 90 01 03 ff 84 db 0f 84 1e 01 00 00 6a 00 8d 45 90 01 01 50 33 c9 ba 90 01 02 45 00 b8 00 00 00 80 90 00 } //1
	condition:
