...
rule TrojanClicker_Win32_Eiderf_gen_A{
	...
	strings :
		...
		$a_01_2 = {54 45 53 54 20 30 36 2e 30 37 2e 31 31 } //01 00 
		$a_01_3 = {63 6c 69 63 6b 72 61 6e 64 6f 6d 6c 69 6e 6b 3d } //01 00 
		$a_01_4 = {53 00 65 00 72 00 74 00 69 00 66 00 69 00 65 00 64 00 } //00 00 
	condition:
		any of ($a_*)
