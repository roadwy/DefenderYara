...
rule TrojanClicker_Win32_Zirit_C{
	...
	strings :
		...
		$a_02_6 = {50 6a 00 6a 00 68 ?? ?? ?? 10 6a 00 6a 00 ff d7 8b 1d ?? ?? ?? 10 be 0a 00 00 00 8d 4c 24 0c 51 6a 00 6a 00 68 ?? ?? ?? 10 6a 00 6a 00 ff d7 68 ?? ?? ?? ?? ff d3 } //100
		$a_02_7 = {53 83 c0 da 53 50 56 ff 15 ?? ?? ?? 10 8d ?? ?? ?? 53 51 6a 26 68 ?? ?? ?? 10 56 ff 15 ?? ?? ?? 10 } //100
	condition:
