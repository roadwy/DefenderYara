...
rule TrojanClicker_Win32_Zirit_Z{
	...
	strings :
		...
		$a_03_11 = {2b c7 3d 30 75 00 00 73 2b 8b 6c 24 14 8b 1d 90 01 02 00 10 6a 00 6a 01 55 ff 15 90 01 02 00 10 85 c0 75 90 01 01 68 e8 03 00 00 ff d3 ff d6 2b c7 3d 30 75 00 00 72 90 00 } //20
		$a_03_12 = {8b f0 83 fe ff 74 90 02 18 83 c0 da 90 00 } //20
	condition:
