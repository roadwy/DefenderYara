...
rule TrojanClicker_Win32_Zirit_B{
	...
	strings :
		...
		$a_03_8 = {57 ff d6 8b f8 ff d6 2b c7 3d 30 75 00 00 73 2b 8b 6c 24 14 8b 1d 90 01 03 10 6a 00 6a 01 55 ff 15 90 01 03 10 85 c0 75 19 68 e8 03 00 00 ff d3 ff d6 2b c7 3d 30 75 00 00 72 90 00 } //20
		$a_03_9 = {83 fe ff 74 4b 8d 44 24 10 50 56 ff 15 90 01 03 10 6a 00 83 c0 da 6a 00 50 56 ff 15 90 01 03 10 8d 4c 24 0c 6a 00 51 6a 26 68 60 64 00 10 56 ff 15 90 00 } //20
	condition:
