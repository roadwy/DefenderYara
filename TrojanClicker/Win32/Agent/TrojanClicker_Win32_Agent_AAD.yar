...
rule TrojanClicker_Win32_Agent_AAD{
	...
	strings :
		...
		$a_01_3 = {5c 73 79 73 74 65 6d 33 32 5c 63 61 74 63 6c 6f 67 64 2e 64 6c 6c } //01 00  \system32\catclogd.dll
		$a_01_4 = {72 75 6e 64 6c 6c 33 32 2e 65 78 65 20 25 73 2c 53 74 61 72 74 } //01 00  rundll32.exe %s,Start
		...
		$a_01_7 = {46 74 70 47 65 74 46 69 6c 65 41 } //01 00  FtpGetFileA
