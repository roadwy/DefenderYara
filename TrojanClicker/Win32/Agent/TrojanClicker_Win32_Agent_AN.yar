...
rule TrojanClicker_Win32_Agent_AN{
	...
	strings :
		...
		$a_00_1 = {73 65 61 72 63 68 2e 73 65 61 72 63 68 66 69 6e 64 65 72 2e 62 69 7a } //01 00 
		$a_00_2 = {62 65 73 74 66 69 6e 64 7a 6f 6e 65 2e 63 6f 6d 2f 73 65 61 72 63 68 2e 70 68 70 } //01 00 
		$a_00_3 = {62 72 6f 77 73 65 72 65 73 75 6c 74 73 2e 63 6f 6d } //01 00 
		$a_00_4 = {74 68 65 64 72 65 61 6d 73 65 61 72 63 68 2e 63 6f 6d } //00 00 
	condition:
		any of ($a_*)
