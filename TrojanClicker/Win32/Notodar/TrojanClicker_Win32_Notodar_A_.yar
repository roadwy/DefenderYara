...
rule TrojanClicker_Win32_Notodar_A_{
	...
	strings :
		...
		$a_01_1 = {64 00 65 00 62 00 72 00 6f 00 76 00 6f 00 72 00 64 00 61 00 2e 00 63 00 6f 00 6d 00 2f 00 61 00 61 00 2f 00 } //01 00  debrovorda.com/aa/
		$a_01_2 = {72 00 75 00 6d 00 6f 00 6c 00 6f 00 74 00 74 00 72 00 61 00 2e 00 63 00 6f 00 6d 00 2f 00 61 00 61 00 2f 00 } //01 00  rumolottra.com/aa/
