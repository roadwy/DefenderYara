...
rule TrojanClicker_Win32_Delf_BA{
	...
	strings :
		...
		$a_00_2 = {5c 74 61 73 6b 6d 6f 72 2e 65 78 65 } //01 00 
		$a_00_3 = {68 74 74 70 3a 2f 2f 77 77 77 2e 77 7a 64 71 2e 63 6e 2f 73 66 } //01 00 
		$a_00_4 = {5c 77 69 6e 6c 6f 67 69 6e 2e 65 78 65 } //00 00 
	condition:
		any of ($a_*)
