...
rule TrojanClicker_Win32_Delf_U{
	...
	strings :
		...
		$a_03_2 = {64 ff 30 64 89 20 8b 55 08 b8 90 01 03 00 e8 90 01 04 85 c0 0f 84 2d 01 00 00 8b 55 08 b8 4c 03 4a 00 e8 90 01 04 85 c0 0f 84 8e 00 00 00 8b 55 08 b8 4c 03 4a 00 e8 90 00 } //1
	condition:
