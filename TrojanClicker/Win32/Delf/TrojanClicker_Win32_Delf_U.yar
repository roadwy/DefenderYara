...
rule TrojanClicker_Win32_Delf_U{
	...
	strings :
		$a_01_0 = {68 74 74 70 3a 2f 2f 77 77 77 2e 69 6c 69 6b 65 63 6c 69 63 6b 2e } //01 00 
		$a_01_1 = {68 74 74 70 3a 2f 2f 63 6c 69 63 6b 2e 63 6c 69 63 6b 73 74 6f 72 79 2e } //01 00 
