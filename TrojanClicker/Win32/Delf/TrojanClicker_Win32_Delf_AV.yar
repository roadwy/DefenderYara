...
rule TrojanClicker_Win32_Delf_AV{
	...
	strings :
		$a_00_0 = {68 74 74 70 3a 2f 2f 77 77 77 2e 77 68 61 74 69 73 6d 79 69 70 2e 63 6f 6d 2f 61 75 74 6f 6d 61 74 69 6f 6e 2f 6e 30 39 32 33 30 39 34 35 2e 61 73 70 } //01 00 
		$a_00_1 = {68 74 74 70 3a 2f 2f 6c 32 74 6f 70 2e 72 75 2f 76 6f 74 65 2f 25 64 2f } //01 00 
