...
rule TrojanClicker_Win32_Delf_AV{
	...
	strings :
		...
		$a_02_2 = {b8 31 00 00 00 e8 90 01 04 ff 34 85 90 01 04 b8 0b 00 00 00 e8 90 01 04 ff 34 85 90 01 04 b8 38 00 00 00 e8 90 01 04 ff 34 85 90 01 04 8b c3 ba 03 00 00 00 e8 90 01 04 5b c3 90 00 } //1
		$a_02_3 = {73 65 63 5f 72 65 66 65 72 65 72 3d 90 02 04 ff ff ff ff 09 00 00 00 76 6f 74 65 4f 6b 3d 6f 6b 90 02 20 6e 61 6d 65 3d 90 00 } //1
	condition:
