...
rule TrojanClicker_Win32_Qaccel_A_bit{
	...
	strings :
		$a_01_0 = {44 45 36 32 32 44 31 38 35 43 31 42 43 37 36 30 45 34 30 43 43 44 42 32 34 39 42 39 35 36 31 32 } //01 00  DE622D185C1BC760E40CCDB249B95612
		$a_03_1 = {5c 51 51 41 63 63 65 6c 65 78 2e 65 78 65 90 02 05 5c 54 65 6e 63 65 6e 74 90 00 } //01 00 
		$a_01_2 = {43 57 65 62 42 72 6f 77 73 65 72 32 } //01 00  CWebBrowser2
