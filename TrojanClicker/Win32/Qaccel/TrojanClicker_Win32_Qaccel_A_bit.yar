...
rule TrojanClicker_Win32_Qaccel_A_bit{
	...
	strings :
		...
		$a_03_1 = {5c 51 51 41 63 63 65 6c 65 78 2e 65 78 65 90 02 05 5c 54 65 6e 63 65 6e 74 90 00 } //1
		$a_01_2 = {43 57 65 62 42 72 6f 77 73 65 72 32 } //1 CWebBrowser2
		$a_03_3 = {68 74 74 70 73 3a 2f 2f 77 77 77 2e 90 02 10 2e 63 6f 6d 2f 3f 74 6e 3d 25 73 90 02 20 5f 68 61 6f 5f 70 67 90 00 } //1
	condition:
