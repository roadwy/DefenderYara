...
rule TrojanClicker_Win32_Hatigh_B{
	meta:
		description = "TrojanClicker:Win32/Hatigh.B,SIGNATURE_TYPE_PEHSTR,06 00 05 00 07 00 00 01 00 "
	...
	strings :
		...
		$a_01_4 = {76 61 6c 75 65 3d 6e 6f 5f 73 70 79 77 61 72 65 } //01 00  value=no_spyware
		$a_01_5 = {68 74 74 70 3a 2f 2f 36 36 2e 31 39 39 2e 31 37 39 2e 38 2f 73 65 61 72 63 68 2e 70 68 70 } //01 00  http://66.199.179.8/search.php
		$a_01_6 = {36 36 2e 32 35 30 2e 37 34 2e 31 35 32 2f 6b 77 5f 69 6d 67 2f 69 6d 67 5f 67 65 6e 2e 70 68 70 } //00 00  66.250.74.152/kw_img/img_gen.php
	condition:
		any of ($a_*)
