...
rule TrojanClicker_Win32_Befeenk_A{
	...
	strings :
		...
		$a_01_4 = {3f 65 78 65 3d 31 26 75 69 64 3d } //01 00  ?exe=1&uid=
		$a_01_5 = {6e 6f 63 6f 6f 6b 69 65 00 00 00 00 ff ff ff ff 05 00 00 00 6e 6f 6b 65 79 } //02 00 
		$a_01_6 = {6d 6f 76 69 65 2d 68 2e 63 6f 6d } //01 00  movie-h.com
		$a_01_7 = {63 68 65 63 6b 5f 70 61 79 2e 70 68 70 } //00 00  check_pay.php
	condition:
		any of ($a_*)
