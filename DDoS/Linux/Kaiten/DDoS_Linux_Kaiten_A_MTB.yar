...
rule DDoS_Linux_Kaiten_A_MTB{
	...
	strings :
		$a_03_0 = {85 c0 75 16 c7 44 24 04 09 00 00 00 c7 04 24 00 00 00 00 e8 ?? ?? 00 00 eb 3c a1 ?? ?? 06 08 c7 44 24 18 02 00 00 00 c7 44 24 14 03 00 00 00 c7 44 24 10 03 00 00 00 c7 44 24 0c 02 00 00 00 89 44 24 08 c7 44 24 04 bc a1 05 08 8b 45 08 89 04 24 } //1
