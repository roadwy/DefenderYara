...
rule DDoS_Linux_Liquad_A_MTB{
	...
	strings :
		...
		$a_00_1 = {25 63 5d 30 3b 42 6f 74 73 20 63 6f 6e 6e 65 63 74 65 64 3a 20 25 64 20 7c 20 43 6c 69 65 6e 74 73 20 63 6f 6e 6e 65 63 74 65 64 3a 20 25 64 25 63 } //01 00  %c]0;Bots connected: %d | Clients connected: %d%c
		$a_00_2 = {4c 4f 4c 4e 4f 47 54 46 4f } //00 00  LOLNOGTFO
	condition:
		any of ($a_*)
