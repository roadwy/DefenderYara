...
rule DDoS_Linux_Znaich_BD_MTB{
	...
	strings :
		...
		$a_00_4 = {43 4f 4d 4d 41 4e 44 5f 44 44 4f 53 5f 53 54 4f 50 } //01 00 
		$a_00_5 = {73 65 64 20 2d 69 20 27 2f 5c 2f 65 74 63 5c 2f 63 72 6f 6e 2e 68 6f 75 72 6c 79 5c 2f 63 72 6f 6e 2e 73 68 2f 64 27 20 2f 65 74 63 2f 63 72 6f 6e 74 61 62 } //00 00 
	condition:
		any of ($a_*)
