...
rule DDoS_Linux_Chalubo_A_MTB{
	...
	strings :
		$a_00_0 = {64 68 63 70 72 65 6e 65 77 } //0a 00 
		...
		$a_00_2 = {2f 64 61 74 61 2f 6c 6f 63 61 6c 2f 74 6d 70 2f 74 6d 70 2e 6c } //01 00 
		$a_00_3 = {2f 74 6d 70 2f 74 6d 70 6e 61 6d 5f 58 58 58 58 58 58 } //00 00 
	condition:
		any of ($a_*)
