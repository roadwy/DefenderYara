...
rule DDoS_Linux_Mirai_KA_MTB{
	...
	strings :
		...
		$a_01_1 = {6d 61 69 6e 5f 69 6e 73 74 61 6e 63 65 5f 6b 69 6c 6c } //01 00  main_instance_kill
		$a_01_2 = {61 74 74 61 63 6b 5f 6d 65 74 68 6f 64 5f 75 64 70 66 6c 6f 6f 64 } //01 00  attack_method_udpflood
		$a_01_3 = {61 74 74 61 63 6b 5f 6d 65 74 68 6f 64 5f 74 63 70 66 6c 6f 6f 64 } //01 00  attack_method_tcpflood
		$a_01_4 = {61 74 74 61 63 6b 5f 66 72 65 65 } //00 00  attack_free
	condition:
		any of ($a_*)
