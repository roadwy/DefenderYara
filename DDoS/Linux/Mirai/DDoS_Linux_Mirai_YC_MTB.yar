...
rule DDoS_Linux_Mirai_YC_MTB{
	...
	strings :
		$a_02_0 = {77 67 65 74 20 68 74 74 70 90 02 02 3a 2f 2f 90 02 03 2e 90 02 03 2e 90 02 03 2e 90 02 03 2f 90 02 60 3b 20 63 68 6d 6f 64 20 37 37 37 20 2a 3b 20 2e 2f 90 00 } //1
