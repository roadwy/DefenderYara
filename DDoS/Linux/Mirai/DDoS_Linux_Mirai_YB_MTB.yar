...
rule DDoS_Linux_Mirai_YB_MTB{
	...
	strings :
		...
		$a_01_2 = {55 73 65 72 2d 41 67 65 6e 74 3a 20 53 45 46 41 } //01 00 
		$a_01_3 = {50 4f 53 54 20 2f 47 70 6f 6e 46 6f 72 6d 2f 64 69 61 67 5f 46 6f 72 6d 3f 69 6d 61 67 65 73 2f } //01 00 
		$a_01_4 = {50 4f 53 54 20 2f 70 69 63 64 65 73 63 2e 78 6d 6c } //01 00 
		$a_01_5 = {50 4f 53 54 20 2f 77 61 6e 69 70 63 6e 2e 78 6d 6c } //00 00 
	condition:
		any of ($a_*)
