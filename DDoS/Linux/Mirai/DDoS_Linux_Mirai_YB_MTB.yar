...
rule DDoS_Linux_Mirai_YB_MTB{
	...
	strings :
		$a_03_0 = {47 45 54 20 2f 6c 6f 67 69 6e 2e 63 67 69 3f 63 6c 69 3d 90 02 10 77 67 65 74 25 32 30 68 74 74 70 90 02 02 3a 2f 2f 90 02 03 2e 90 02 03 2e 90 02 03 2e 90 00 } //5
		$a_03_1 = {24 28 2f 62 69 6e 2f 62 75 73 79 62 6f 78 20 77 67 65 74 20 2d 67 20 90 02 03 2e 90 02 03 2e 90 02 03 2e 90 00 } //5
