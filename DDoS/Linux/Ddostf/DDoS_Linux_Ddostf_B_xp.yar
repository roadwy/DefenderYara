...
rule DDoS_Linux_Ddostf_B_xp{
	...
	strings :
		$a_03_0 = {c7 44 24 08 06 00 00 00 c7 44 24 04 01 00 00 00 c7 04 24 02 00 00 00 89 44 24 20 e8 90 01 03 00 c7 44 24 08 10 00 00 00 89 c3 8d 44 24 1c 89 44 24 04 89 1c 24 e8 90 01 03 00 83 f8 ff 90 00 } //1
