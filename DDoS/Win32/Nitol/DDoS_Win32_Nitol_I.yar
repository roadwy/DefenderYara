...
rule DDoS_Win32_Nitol_I{
	...
	strings :
		$a_03_0 = {2e c6 84 24 ?? 00 00 00 65 c6 84 24 ?? 00 00 00 78 c6 84 24 ?? 00 00 00 65 c6 84 24 ?? 00 00 00 00 } //1
		$a_03_1 = {8b 55 fc 8a 1c 11 80 f3 ?? 88 1c 11 41 3b c8 7c e6 } //1
