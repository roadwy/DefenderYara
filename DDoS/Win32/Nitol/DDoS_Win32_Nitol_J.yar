...
rule DDoS_Win32_Nitol_J{
	...
	strings :
		...
		$a_01_1 = {44 4e 53 46 6c 6f 6f 64 } //01 00 
		$a_01_2 = {31 39 32 2e 31 36 38 2e 31 2e 32 34 34 } //02 00 
		$a_01_3 = {6a 64 66 77 6b 65 79 } //02 00 
		$a_01_4 = {83 c0 03 33 d2 0f af c6 f7 74 24 } //03 00 
		$a_01_5 = {64 64 6f 73 2e 68 61 63 6b 78 6b 2e 63 6f 6d } //00 00 
