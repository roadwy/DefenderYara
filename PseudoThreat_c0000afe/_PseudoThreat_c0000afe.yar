...
rule _PseudoThreat_c0000afe{
	meta:
		description = "!PseudoThreat_c0000afe,SIGNATURE_TYPE_PEHSTR,0c 00 09 00 06 00 00 03 00 "
		
	strings :
		$a_01_0 = {43 52 59 50 54 4b 45 59 } //03 00 
		$a_01_1 = {43 52 59 50 54 45 4e 44 } //03 00 
		$a_01_2 = {00 5c 00 64 00 65 00 76 00 69 00 63 00 65 00 5c 00 70 00 68 00 79 00 73 00 69 00 63 00 61 00 6c 00 6d 00 65 00 6d 00 6f 00 72 00 79 } //03 00 
