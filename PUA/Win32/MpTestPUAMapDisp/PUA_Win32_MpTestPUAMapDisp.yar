...
rule PUA_Win32_MpTestPUAMapDisp{
	meta:
		description = "PUA:Win32/MpTestPUAMapDisp,SIGNATURE_TYPE_PEHSTR,0b 00 0a 00 05 00 00 01 00 "
		
	strings :
		$a_01_0 = {50 55 41 20 74 65 73 74 20 66 69 6c 65 20 4d 70 50 55 41 4d 61 70 44 69 73 70 } //01 00  PUA test file MpPUAMapDisp
		...
		$a_01_4 = {32 32 37 33 61 32 34 63 2d 62 64 31 61 2d 34 30 36 31 2d 39 65 62 30 2d 33 64 34 66 65 31 34 34 66 30 38 66 } //00 00  2273a24c-bd1a-4061-9eb0-3d4fe144f08f
	condition:
		any of ($a_*)
