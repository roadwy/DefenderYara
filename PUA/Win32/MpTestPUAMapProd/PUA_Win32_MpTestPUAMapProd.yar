...
rule PUA_Win32_MpTestPUAMapProd{
	meta:
		description = "PUA:Win32/MpTestPUAMapProd,SIGNATURE_TYPE_PEHSTR,0b 00 0a 00 05 00 00 01 00 "
		
	strings :
		$a_01_0 = {50 55 41 20 74 65 73 74 20 66 69 6c 65 20 4d 70 50 55 41 4d 61 70 50 72 6f 64 } //01 00  PUA test file MpPUAMapProd
		...
		$a_01_4 = {64 62 34 33 63 38 61 33 2d 61 37 64 35 2d 34 30 35 34 2d 38 34 61 36 2d 64 34 62 66 39 32 61 65 39 66 31 39 } //00 00  db43c8a3-a7d5-4054-84a6-d4bf92ae9f19
	condition:
		any of ($a_*)
