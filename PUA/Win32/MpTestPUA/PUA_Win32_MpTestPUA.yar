...
rule PUA_Win32_MpTestPUA{
	meta:
		description = "PUA:Win32/MpTestPUA,SIGNATURE_TYPE_PEHSTR,0b 00 0a 00 05 00 00 01 00 "
		
	strings :
		$a_01_0 = {50 55 41 20 74 65 73 74 20 66 69 6c 65 } //01 00  PUA test file
		...
		$a_01_4 = {30 64 32 64 31 34 36 35 2d 37 34 30 36 2d 34 39 37 33 2d 39 65 61 63 2d 63 31 38 30 31 66 35 61 39 61 33 36 } //00 00  0d2d1465-7406-4973-9eac-c1801f5a9a36
	condition:
		any of ($a_*)
