...
rule PUA_Win32_MpTestPUAMapSha1{
	meta:
		description = "PUA:Win32/MpTestPUAMapSha1,SIGNATURE_TYPE_PEHSTR,0b 00 0a 00 05 00 00 "
		
	strings :
		$a_01_0 = {50 55 41 20 74 65 73 74 20 66 69 6c 65 20 4d 70 50 55 41 4d 61 70 53 68 61 31 } //1 PUA test file MpPUAMapSha1
		...
		$a_01_4 = {35 61 35 34 61 36 32 37 2d 39 39 31 33 2d 34 61 62 31 2d 62 63 66 38 2d 39 38 31 65 37 64 32 37 61 63 37 36 } //3 5a54a627-9913-4ab1-bcf8-981e7d27ac76
	condition:
