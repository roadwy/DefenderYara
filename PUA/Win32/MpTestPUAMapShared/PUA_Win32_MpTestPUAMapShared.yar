...
rule PUA_Win32_MpTestPUAMapShared{
	...
	strings :
		$a_01_0 = {50 55 41 20 74 65 73 74 20 66 69 6c 65 20 4d 70 50 55 41 4d 61 70 53 68 61 72 65 64 } //01 00  PUA test file MpPUAMapShared
		...
		$a_01_4 = {33 30 64 32 63 36 38 62 2d 39 37 61 62 2d 34 65 62 34 2d 61 32 31 33 2d 61 62 39 62 65 33 32 39 62 30 30 33 } //00 00  30d2c68b-97ab-4eb4-a213-ab9be329b003
	condition:
		any of ($a_*)
