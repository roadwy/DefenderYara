...
rule PUA_Win32_MpTestPUAMapSigseq{
	meta:
		description = "PUA:Win32/MpTestPUAMapSigseq,SIGNATURE_TYPE_PEHSTR,0b 00 0a 00 05 00 00 "
		
	strings :
		$a_01_0 = {50 55 41 20 74 65 73 74 20 66 69 6c 65 20 4d 70 50 55 41 4d 61 70 53 69 67 73 65 71 } //1 PUA test file MpPUAMapSigseq
		...
		$a_01_4 = {63 37 37 63 30 35 37 33 2d 36 66 33 30 2d 34 39 64 31 2d 61 38 63 39 2d 66 65 34 63 36 63 61 39 36 66 37 39 } //3 c77c0573-6f30-49d1-a8c9-fe4c6ca96f79
	condition:
