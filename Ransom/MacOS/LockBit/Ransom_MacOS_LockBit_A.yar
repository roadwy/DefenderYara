...
rule Ransom_MacOS_LockBit_A{
	...
	strings :
		...
		$a_00_2 = {72 65 73 74 6f 72 65 2d 6d 79 2d 66 69 6c 65 73 2e 74 78 74 } //01 00 
		$a_00_3 = {73 6f 64 69 75 6d 5f 63 72 69 74 5f 65 6e 74 65 72 } //01 00 
		$a_00_4 = {62 6c 61 6b 65 32 62 2d 72 65 66 2e 63 } //00 00 
