...
rule Ransom_MacOS_Filecoder_YA_MTB{
	...
	strings :
		...
		$a_01_2 = {74 6f 69 64 69 65 76 69 74 63 65 66 66 65 2f 6c 69 62 70 65 72 73 69 73 74 2f 72 65 6e 6e 75 72 2e 63 } //00 00  toidievitceffe/libpersist/rennur.c
	condition:
		any of ($a_*)
