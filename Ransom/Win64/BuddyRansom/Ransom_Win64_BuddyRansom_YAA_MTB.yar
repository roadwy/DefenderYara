...
rule Ransom_Win64_BuddyRansom_YAA_MTB{
	...
	strings :
		$a_03_0 = {38 c2 73 17 41 0f b7 cb 41 ff c3 0f b6 2c 0b 89 d1 83 c2 08 d3 e5 41 01 e8 eb 90 01 01 44 89 c1 29 c2 21 f9 66 43 89 4c 51 90 01 01 44 89 e1 49 ff c2 41 d3 e8 90 00 } //1
