...
rule Ransom_Win64_BianLian_PB_MTB{
	...
	strings :
		...
		$a_03_2 = {48 8b 54 24 90 01 01 48 8d 4a 90 01 01 48 8b 84 24 90 02 04 48 8b 54 24 90 01 01 48 39 ca 0f 8e 90 02 04 48 89 4c 24 90 01 01 48 8b b4 24 90 02 04 48 89 f7 48 0f af f1 48 03 35 90 01 04 48 89 b4 24 90 02 04 48 89 c3 48 8b 84 24 90 02 04 48 89 f9 e8 90 02 04 48 8b b4 24 90 02 04 48 39 f0 75 90 00 } //10
	condition:
