...
rule Ransom_Win64_Zudochka_LK_MTB{
	...
	strings :
		...
		$a_01_1 = {48 41 43 4b 45 44 2e 70 6e 67 } //01 00 
		$a_01_2 = {50 65 6e 74 65 73 74 5c 73 6f 75 72 63 65 5c 72 65 70 6f 73 5c 72 75 73 74 77 61 72 65 5c 72 75 73 74 77 61 72 65 5c 74 61 72 67 65 74 5c 72 65 6c 65 61 73 65 5c 64 65 70 73 5c 72 75 73 74 77 61 72 65 2e 70 64 62 } //01 00 
		$a_01_3 = {2e 72 73 6d } //00 00 
	condition:
		any of ($a_*)
