...
rule Ransom_Win64_ClopCrypt_PB_MTB{
	...
	strings :
		...
		$a_03_2 = {4c 0f b7 ee 48 8b 4c 24 90 01 01 e8 63 d2 fc ff 48 8b 4c 24 90 01 01 48 8b 09 0f b7 d7 c1 ea 08 4a 0f b6 4c 29 ff 32 ca 42 88 4c 28 ff 66 42 0f b6 44 2b ff 66 03 c7 66 69 c0 6d ce 66 81 c0 bf 58 89 c7 66 83 c6 01 66 41 83 ee 01 66 45 85 f6 75 90 00 } //10
	condition:
