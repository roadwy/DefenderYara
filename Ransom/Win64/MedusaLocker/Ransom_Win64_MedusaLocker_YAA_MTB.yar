...
rule Ransom_Win64_MedusaLocker_YAA_MTB{
	...
	strings :
		$a_03_0 = {49 8d 79 08 41 8b c8 41 8b c2 83 e0 3f 2b c8 49 8b 47 08 48 8b 10 41 8b c0 48 d3 ca 49 33 d2 49 89 11 48 8b 15 90 01 04 8b ca 83 e1 3f 2b c1 8a c8 49 8b 07 48 d3 ce 48 33 f2 48 8b 08 48 89 31 41 8b c8 90 00 } //2
