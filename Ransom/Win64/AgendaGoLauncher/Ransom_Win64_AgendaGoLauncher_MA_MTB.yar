...
rule Ransom_Win64_AgendaGoLauncher_MA_MTB{
	...
	strings :
		...
		$a_03_2 = {48 8d 44 24 50 45 33 c9 48 89 44 24 48 48 8d 0d ?? ?? ?? ?? 48 8d 44 24 70 45 33 c0 48 89 44 24 40 33 d2 48 c7 44 24 38 00 00 00 00 48 c7 44 24 30 00 00 00 00 c7 44 24 28 20 00 00 00 c7 44 24 20 00 00 00 00 ff 15 } //1
	condition:
