...
rule Ransom_Win64_PANDORA_REL_MTB{
	...
	strings :
		...
		$a_01_1 = {75 73 61 67 65 3a 20 72 73 61 5f 76 65 72 69 66 79 5f 70 73 73 20 3c 6b 65 79 5f 66 69 6c 65 3e 20 3c 66 69 6c 65 6e 61 6d 65 3e } //00 00  usage: rsa_verify_pss <key_file> <filename>
	condition:
		any of ($a_*)
