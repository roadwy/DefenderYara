...
rule Ransom_Win64_BlackByte_DKC_MTB{
	...
	strings :
		$a_03_0 = {b9 98 df 00 00 44 8b 90 02 06 83 ee 20 90 01 01 8b f8 e8 90 00 } //1
		...
		$a_03_2 = {0f b6 04 1f 30 03 48 ff c3 48 83 e9 01 75 f1 48 83 ef 10 0f 29 90 01 02 48 83 ee 01 75 c3 90 00 } //1
	condition:
