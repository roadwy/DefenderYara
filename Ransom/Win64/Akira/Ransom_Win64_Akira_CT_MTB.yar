...
rule Ransom_Win64_Akira_CT_MTB{
	meta:
		description = "Ransom:Win64/Akira.CT!MTB,SIGNATURE_TYPE_PEHSTR_EXT,05 00 05 00 04 00 00 "
		
	strings :
		$a_01_0 = {61 6b 69 72 61 5f 72 65 61 64 6d 65 2e 74 78 74 } //2 akira_readme.txt
		...
		$a_01_3 = {57 65 6c 6c 2c 20 66 6f 72 20 6e 6f 77 20 6c 65 74 27 73 20 6b 65 65 70 20 61 6c 6c 20 74 68 65 20 74 65 61 72 73 20 61 6e 64 20 72 65 73 65 6e 74 6d 65 6e 74 20 74 6f 20 6f 75 72 73 65 6c 76 65 73 20 61 6e 64 20 74 72 79 20 74 6f 20 62 75 69 6c 64 20 61 20 63 6f 6e 73 74 72 75 63 74 69 76 65 20 64 69 61 6c 6f 67 75 65 } //1 Well, for now let's keep all the tears and resentment to ourselves and try to build a constructive dialogue
	condition:
