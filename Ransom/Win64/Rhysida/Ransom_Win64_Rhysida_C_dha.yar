...
rule Ransom_Win64_Rhysida_C_dha{
	...
	strings :
		...
		$a_02_4 = {54 6f 20 75 74 69 6c 69 7a 65 20 74 68 69 73 20 6b 65 79 2c 20 76 69 73 69 74 20 6f 75 72 20 73 65 63 75 72 65 20 70 6f 72 74 61 6c 3a 20 90 02 ff 6f 6e 69 6f 6e 90 00 } //1
	condition:
