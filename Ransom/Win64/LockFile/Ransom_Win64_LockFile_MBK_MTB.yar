...
rule Ransom_Win64_LockFile_MBK_MTB{
	...
	strings :
		...
		$a_02_4 = {52 00 45 00 41 00 44 00 4d 00 45 00 2d 00 46 00 49 00 4c 00 45 00 [0-20] 2e 00 68 00 74 00 61 00 } //1
		$a_02_5 = {52 45 41 44 4d 45 2d 46 49 4c 45 [0-20] 2e 68 74 61 } //1
	condition:
