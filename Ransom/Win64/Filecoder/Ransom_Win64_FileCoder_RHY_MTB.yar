...
rule Ransom_Win64_FileCoder_RHY_MTB{
	...
	strings :
		...
		$a_01_5 = {53 65 72 76 65 72 2d 53 69 64 65 2d 45 6e 63 72 79 70 74 69 6f 6e 2d 43 75 73 74 6f 6d 65 72 2d 4b 65 79 } //1 Server-Side-Encryption-Customer-Key
		$a_01_6 = {2e 62 61 63 6b } //1 .back
		$a_01_7 = {2e 70 70 74 78 } //1 .pptx
		$a_03_8 = {50 45 00 00 64 86 08 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? 0b 02 03 00 00 ?? 3e 00 00 b2 04 00 00 00 00 00 ?? ?? 06 } //2
	condition:
