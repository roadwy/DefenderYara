...
rule Ransom_Win64_FileCoder_AB_MTB{
	...
	strings :
		$a_81_0 = {21 21 21 52 45 41 44 4d 45 21 21 21 2e 74 78 74 } //01 00 
		$a_81_1 = {63 72 79 70 74 65 64 30 30 30 30 30 37 } //01 00 
		$a_81_2 = {5c 2e 6e 6f 5f 6d 6f 72 65 5f 72 61 6e 73 6f 6d } //01 00 
		$a_81_3 = {5c 74 61 73 6b 73 5c 68 64 64 69 64 6c 65 73 63 61 6e 2e 6a 6f 62 } //01 00 
		$a_81_4 = {5c 61 61 61 5f 54 6f 75 63 68 4d 65 4e 6f 74 5f 2e 74 78 74 } //01 00 
		$a_81_5 = {2e 6b 65 79 62 74 63 40 67 6d 61 69 6c 5f 63 6f 6d } //01 00 
		$a_81_6 = {2e 70 61 79 63 72 79 70 74 40 67 6d 61 69 6c 5f 63 6f 6d } //01 00 
		$a_81_7 = {2e 77 6e 63 72 79 } //00 00 
