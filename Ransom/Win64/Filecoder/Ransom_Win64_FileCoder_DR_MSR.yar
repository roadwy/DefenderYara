...
rule Ransom_Win64_FileCoder_DR_MSR{
	...
	strings :
		...
		$a_80_1 = {47 6f 20 62 75 69 6c 64 20 49 44 3a } //Go build ID:  1
		$a_80_2 = {2d 2d 2d 2d 2d 42 45 47 49 4e 20 52 53 41 20 50 55 42 4c 49 43 20 4b 45 59 2d 2d 2d 2d 2d } //-----BEGIN RSA PUBLIC KEY-----  1
		$a_80_3 = {50 41 53 53 57 4f 52 44 } //PASSWORD  1
	condition:
