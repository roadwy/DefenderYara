...
rule Ransom_Win64_Filecoder_SB_MTB{
	...
	strings :
		$a_02_0 = {59 00 6f 00 75 00 72 00 20 00 46 00 69 00 6c 00 65 00 73 00 90 02 20 45 00 6e 00 63 00 72 00 79 00 70 00 74 00 65 00 64 00 90 00 } //1
		$a_02_1 = {59 6f 75 72 20 46 69 6c 65 73 90 02 20 45 6e 63 72 79 70 74 65 64 90 00 } //1
