...
rule Ransom_Win64_Filecoder_PBC_MTB{
	...
	strings :
		$a_01_0 = {59 4f 55 5f 48 41 56 45 5f 42 45 45 4e 5f 48 34 43 4b 33 44 } //01 00  YOU_HAVE_BEEN_H4CK3D
		$a_01_1 = {67 6f 74 20 68 61 63 6b 65 64 } //01 00  got hacked
		$a_01_2 = {67 65 74 20 79 6f 75 72 20 64 61 74 61 20 62 61 63 6b } //01 00  get your data back
