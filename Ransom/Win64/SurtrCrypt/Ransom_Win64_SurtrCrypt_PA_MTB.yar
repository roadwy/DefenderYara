...
rule Ransom_Win64_SurtrCrypt_PA_MTB{
	...
	strings :
		...
		$a_02_2 = {5c 00 44 00 72 00 6f 00 70 00 70 00 65 00 72 00 5c 00 [0-04] 5c 00 [0-10] 5c 00 44 00 72 00 6f 00 70 00 70 00 65 00 72 00 2e 00 70 00 64 00 62 00 } //1
		$a_02_3 = {5c 44 72 6f 70 70 65 72 5c [0-04] 5c [0-10] 5c 44 72 6f 70 70 65 72 2e 70 64 62 } //1
	condition:
