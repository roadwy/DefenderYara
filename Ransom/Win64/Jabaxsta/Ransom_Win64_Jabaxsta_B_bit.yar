...
rule Ransom_Win64_Jabaxsta_B_bit{
	...
	strings :
		...
		$a_01_3 = {55 00 4e 00 49 00 51 00 55 00 45 00 5f 00 49 00 44 00 5f 00 44 00 4f 00 5f 00 4e 00 4f 00 54 00 5f 00 52 00 45 00 4d 00 4f 00 56 00 45 00 } //01 00  UNIQUE_ID_DO_NOT_REMOVE
		$a_01_4 = {52 00 79 00 75 00 6b 00 52 00 65 00 61 00 64 00 4d 00 65 00 2e 00 74 00 78 00 74 00 } //01 00  RyukReadMe.txt
