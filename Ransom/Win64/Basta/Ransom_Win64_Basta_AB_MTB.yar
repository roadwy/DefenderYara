...
rule Ransom_Win64_Basta_AB_MTB{
	...
	strings :
		$a_03_0 = {b8 ab aa aa aa 41 f7 e7 d1 ea 8d 04 52 0f b6 54 24 ?? 44 2b f8 41 c1 e8 ?? 33 c0 41 0f be cf 33 4c 24 ?? 41 0b cc 39 4d ?? 0f 94 c0 33 c9 31 05 ?? ?? ?? ?? 8b 44 24 ?? 0b 45 f0 89 44 24 ?? 89 05 ?? ?? ?? ?? 85 c9 74 } //10
