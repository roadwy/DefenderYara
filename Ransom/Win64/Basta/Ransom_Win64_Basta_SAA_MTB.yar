...
rule Ransom_Win64_Basta_SAA_MTB{
	...
	strings :
		$a_03_0 = {88 01 0f be 44 24 90 01 01 0f be 4c 24 90 01 01 d3 e0 88 44 24 90 01 01 0f be 44 24 90 01 01 0f be 4c 24 90 01 01 0b c1 88 44 24 90 01 01 48 90 01 07 48 b9 90 01 08 48 90 01 02 48 90 01 02 48 90 00 } //1
