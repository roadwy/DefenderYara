...
rule Ransom_Win64_Basta_SAA_MTB{
	...
	strings :
		...
		$a_00_1 = {44 00 69 00 73 00 69 00 6e 00 63 00 6c 00 69 00 6e 00 61 00 74 00 69 00 6f 00 20 00 69 00 6d 00 70 00 69 00 6e 00 67 00 65 00 6d 00 65 00 6e 00 } //00 00  Disinclinatio impingemen
	condition:
		any of ($a_*)
