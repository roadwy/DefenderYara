...
rule Ransom_Win64_MoneyBird_MA_MTB{
	...
	strings :
		...
		$a_03_3 = {48 89 4c 24 08 48 83 ec 38 48 8b 44 24 40 48 89 44 24 20 48 8b 44 24 40 0f b6 00 85 c0 74 18 83 3d 76 bd 27 00 00 74 0f ff 15 90 01 04 39 05 90 01 04 75 01 90 00 } //1
	condition:
