...
rule Ransom_Win64_MoneyBird_MA_MTB{
	...
	strings :
		$a_01_0 = {6d 6f 6e 65 79 62 69 72 64 2e 70 64 62 } //01 00  moneybird.pdb
		$a_01_1 = {5f 46 61 6e 63 79 70 74 72 } //01 00  _Fancyptr
		$a_01_2 = {5f 50 72 6f 78 79 } //01 00  _Proxy
