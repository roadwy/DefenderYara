...
rule Ransom_Win64_Knight_ZA_MTB{
	...
	strings :
		$a_03_0 = {48 63 c8 ff c3 48 b8 [0-0a] 48 f7 e1 48 c1 ea ?? 48 6b c2 ?? 48 2b c8 0f be 44 0c ?? 66 41 89 06 4d 8d 76 ?? 3b 9c 24 ?? ?? ?? ?? 72 } //1
		$a_03_1 = {42 8a 4c 04 ?? 41 8d 40 ?? 41 30 09 45 33 c0 49 ff c1 83 f8 ?? 44 0f 45 c0 49 83 ea ?? 75 } //1
		$a_03_2 = {47 00 45 00 c7 ?? ?? 54 00 00 00 ff } //1
		$a_03_3 = {73 00 3a 00 [0-0a] 2f 00 2f 00 e8 ?? ?? 00 00 81 3b 68 74 74 70 } //1
	condition:
