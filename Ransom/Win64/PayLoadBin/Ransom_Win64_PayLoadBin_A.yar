...
rule Ransom_Win64_PayLoadBin_A{
	...
	strings :
		...
		$a_00_1 = {7b 61 61 35 62 36 61 38 30 2d 62 38 33 34 2d 31 31 64 30 2d 39 33 32 66 2d 30 30 61 30 63 39 30 64 63 61 61 39 7d } //00 00  {aa5b6a80-b834-11d0-932f-00a0c90dcaa9}
	condition:
		any of ($a_*)
