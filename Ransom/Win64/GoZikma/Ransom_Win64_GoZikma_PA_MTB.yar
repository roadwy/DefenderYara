...
rule Ransom_Win64_GoZikma_PA_MTB{
	...
	strings :
		...
		$a_03_2 = {0f b6 8c 04 90 01 04 0f b6 54 04 90 01 01 31 d1 88 8c 04 90 01 04 48 ff c0 48 3d ca 01 00 00 7c 90 00 } //3
		$a_03_3 = {0f b6 5c 04 90 01 01 31 da 88 94 04 90 01 04 40 3d ca 01 00 00 7d 90 00 } //3
	condition:
