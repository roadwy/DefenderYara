...
rule Ransom_Win64_Reveton_B{
	...
	strings :
		...
		$a_01_1 = {77 00 6f 00 72 00 6b 00 } //01 00 
		$a_00_2 = {4e 00 74 00 43 00 72 00 65 00 61 00 74 00 65 00 54 00 68 00 72 00 65 00 61 00 64 00 45 00 78 00 } //01 00 
		$a_01_3 = {53 00 56 00 43 00 48 00 4f 00 53 00 54 00 2e 00 45 00 58 00 45 00 } //01 00 
		$a_00_4 = {2e 00 63 00 70 00 70 00 } //00 00 
