...
rule Ransom_Win64_Weelsof_A{
	...
	strings :
		...
		$a_01_1 = {6c 6f 63 6b 65 72 5f 66 69 6c 65 5f 6e 61 6d 65 } //01 00 
		$a_01_2 = {63 6f 72 65 5f 72 65 6d 6f 74 65 5f 65 6e 74 72 79 } //01 00 
		$a_01_3 = {2f 67 65 74 5f 64 73 6e 2e 70 68 70 } //01 00 
		$a_01_4 = {2f 67 65 74 5f 63 6f 63 65 2e 70 68 70 } //01 00 
