...
rule Ransom_Win64_Cartel_AA_MTB{
	...
	strings :
		$a_03_0 = {0f b7 4c 24 ?? 48 8b 54 24 ?? 0f b6 0c 0a 03 c1 0f b6 4c 24 ?? 03 c1 25 ff 00 00 00 88 44 24 ?? 0f b7 44 24 ?? 48 8b 4c 24 ?? 0f b6 04 01 88 44 24 ?? 0f b6 44 24 ?? 0f b7 4c 24 ?? 48 8b 54 24 ?? 4c 8b 44 24 ?? 41 0f b6 04 00 88 04 0a } //1
