...
rule Ransom_Win32_Wyhymyz_D{
	...
	strings :
		...
		$a_03_4 = {8d a4 24 00 00 00 00 30 9e 90 01 02 40 00 46 68 90 01 02 40 00 e8 90 01 02 ff ff 83 c4 04 3b f0 7c 90 00 } //8
		$a_03_5 = {66 0f 1f 84 00 00 00 00 00 30 9e 90 01 02 40 00 46 68 90 01 02 40 00 e8 90 01 02 ff ff 83 c4 04 3b f0 7c 90 00 } //8
	condition:
