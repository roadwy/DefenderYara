...
rule Ransom_Win32_Wyhymyz_B{
	...
	strings :
		$a_03_0 = {80 7d f4 48 90 02 04 80 7d f5 45 90 02 04 80 7d f6 52 90 02 04 80 7d f7 4d 90 02 04 80 7d f8 45 90 02 04 80 7d f9 53 90 00 } //4
		...
		$a_03_3 = {6a 01 68 10 66 00 00 ff 90 01 02 ff 15 90 00 } //1
