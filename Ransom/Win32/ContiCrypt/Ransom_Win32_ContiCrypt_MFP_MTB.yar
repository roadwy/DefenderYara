...
rule Ransom_Win32_ContiCrypt_MFP_MTB{
	...
	strings :
		...
		$a_02_1 = {88 5d c7 c6 45 c8 ?? c6 45 c9 ?? c6 45 ca ?? c6 45 cb ?? c6 45 cc ?? ?? ?? ?? ?? c6 45 ce ?? c6 45 cf ?? c6 45 d0 ?? c6 45 d1 ?? c6 45 d2 ?? c6 45 d3 ?? c6 45 d4 ?? 48 89 45 6f 0f b6 45 c8 0f b6 45 c7 } //5
