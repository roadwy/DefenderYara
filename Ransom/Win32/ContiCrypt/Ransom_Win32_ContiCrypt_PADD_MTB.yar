...
rule Ransom_Win32_ContiCrypt_PADD_MTB{
	...
	strings :
		$a_03_0 = {8b 45 e8 8b 08 8b 55 f0 8d 44 11 02 89 45 c0 8b 4d c0 51 8b 55 d4 52 ff 15 90 01 04 8b 4d e0 89 01 8b 55 e0 83 c2 04 89 55 e0 8b 45 e8 83 c0 04 90 00 } //1
