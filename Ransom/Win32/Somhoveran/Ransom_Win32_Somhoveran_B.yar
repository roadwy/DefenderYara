...
rule Ransom_Win32_Somhoveran_B{
	...
	strings :
		...
		$a_01_3 = {41 6e 74 69 57 69 6e 4c 6f 63 6b 65 72 54 72 61 79 2e 65 78 65 } //01 00 
		$a_01_4 = {57 61 72 6e 69 6e 67 21 20 57 69 6e 64 6f 77 73 20 42 6c 6f 63 6b 65 64 21 } //00 00 
