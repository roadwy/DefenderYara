...
rule Ransom_Win32_Gulcrypt_A_2{
	...
	strings :
		...
		$a_03_2 = {21 21 d4 e0 e9 eb fb 20 e7 e0 f8 e8 f4 f0 ee e2 e0 ed fb 90 02 05 2e 74 78 74 00 90 00 } //5
		$a_03_3 = {b9 19 00 00 00 bb 01 00 00 00 d3 e3 23 d8 74 2d 80 c1 41 88 0d 90 01 02 40 00 80 e9 41 c7 05 90 01 02 40 00 3a 5c 2a 2e c6 05 90 01 02 40 00 2a c6 05 90 01 02 40 00 00 50 51 e8 90 01 02 ff ff 59 58 49 7d c5 90 00 } //5
	condition:
