...
rule Ransom_Win32_Gulcrypt_B{
	...
	strings :
		$a_01_0 = {40 46 69 6c 65 73 5f 79 6f 75 72 5f 69 44 } //01 00  @Files_your_iD
		$a_01_1 = {2f 61 73 6d 2f 74 65 73 74 2e 70 68 70 00 68 65 6c 6c 6f 3d } //01 00 
		$a_01_2 = {62 75 6b 61 73 68 6b 61 } //01 00  bukashka
		$a_01_3 = {70 6c 6f 67 61 65 72 6f } //01 00  plogaero
...
rule Ransom_Win32_Gulcrypt_B_2{
	...
	strings :
		$a_01_0 = {3d 01 10 10 00 7d } //01 00  Ľတ紀
