...
rule Ransom_Win32_Tobfy_H{
	...
	strings :
		...
		$a_03_1 = {8b 08 52 50 ff 51 2c 90 02 10 68 90 01 04 68 90 01 04 68 e9 03 00 00 56 ff 15 90 01 04 68 e8 03 00 00 56 ff 15 90 00 } //1
		...
		$a_03_3 = {6a 01 52 68 c8 00 00 00 68 90 01 01 01 00 00 6a 00 6a 00 ff 15 90 01 04 99 2b c2 d1 f8 2d 85 00 00 00 50 68 00 00 00 50 68 90 01 04 ff 15 90 00 } //1
	condition:
