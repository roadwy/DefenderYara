...
rule Ransom_Win32_Tobfy_N{
	...
	strings :
		$a_03_0 = {68 ee 02 00 00 68 e8 03 00 00 8b 85 90 01 04 99 2b c2 d1 f8 2d 77 01 00 00 50 8b 85 90 01 04 99 2b c2 d1 f8 2d f4 01 00 00 90 00 } //1
		$a_01_1 = {03 55 f8 0f be 02 83 f0 01 8b 4d fc 03 4d f8 88 01 eb af } //1
		$a_03_2 = {83 fa 4f 74 0c 0f be 05 90 01 04 83 f8 4b 75 19 e8 90 00 } //1
