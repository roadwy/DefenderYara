...
rule Ransom_Win32_Genasom_DN{
	...
	strings :
		...
		$a_03_1 = {ff d3 50 ff d6 68 d0 01 00 00 8d 94 24 ?? ?? 00 00 6a 00 b9 0e 00 00 00 be ?? ?? ?? ?? 8d bc 24 ?? ?? 00 00 52 f3 a5 e8 ?? ?? ?? ?? 83 c4 0c 83 7c 24 10 00 0f 85 ?? ?? 00 00 33 c0 68 06 02 00 00 } //1
	condition:
