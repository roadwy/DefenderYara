...
rule Ransom_Win32_Genasom_SD_MTB{
	...
	strings :
		$a_81_0 = {61 76 70 2e 65 78 65 } //01 00 
		$a_81_1 = {5c 46 49 4c 45 53 2e 74 78 74 } //01 00 
		$a_81_2 = {5c 5c 2e 5c 70 69 70 65 5c 74 75 72 75 6d } //01 00 
		$a_81_3 = {61 76 70 75 69 2e 65 78 65 } //01 00 
