...
rule Ransom_Win32_Genasom_GG{
	...
	strings :
		$a_01_0 = {64 65 63 6f 64 65 72 73 6f 66 74 40 53 61 66 65 2d 6d 61 69 6c 2e 6e 65 74 } //01 00  decodersoft@Safe-mail.net
		...
		$a_01_2 = {2e 6b 73 72 } //01 00  .ksr
		$a_01_3 = {53 4f 4c 4c 54 45 20 45 55 45 52 20 55 4b 41 53 48 2d 43 4f 44 45 20 49 4e 20 4f 52 44 4e 55 4e 47 20 53 45 49 4e } //01 00  SOLLTE EUER UKASH-CODE IN ORDNUNG SEIN
