...
rule Ransom_Win32_Genasom_FF{
	...
	strings :
		...
		$a_03_2 = {ff ff 54 00 61 00 c7 85 90 01 02 ff ff 73 00 6b 00 c7 85 90 01 02 ff ff 6d 00 67 00 c7 85 90 01 02 ff ff 72 00 2e 00 c7 85 90 01 02 ff ff 65 00 78 00 c7 85 90 01 02 ff ff 65 00 00 00 90 00 } //1
