...
rule Ransom_Win32_Genasom_JJ{
	...
	strings :
		...
		$a_03_3 = {8a 08 40 84 c9 75 90 01 01 2b c6 8b c8 8d 74 14 90 01 01 33 c0 f3 a6 74 90 01 01 1b c0 83 d8 ff 85 c0 0f 84 90 01 02 00 00 42 81 fa 00 02 00 00 72 90 01 01 6a 00 6a 00 68 00 02 00 00 53 ff 15 90 01 04 83 f8 ff 90 00 } //2
