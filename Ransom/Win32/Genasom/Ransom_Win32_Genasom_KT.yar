...
rule Ransom_Win32_Genasom_KT{
	...
	strings :
		$a_01_0 = {46 69 72 65 2d 74 6f 6c 6c 20 46 6f 72 20 53 45 4f 20 4d 61 73 74 65 72 73 2e 65 78 65 } //01 00 
		...
		$a_01_3 = {6e 3d 62 30 33 66 35 66 37 66 31 31 64 35 30 61 33 61 50 41 44 50 } //00 00 
	condition:
		any of ($a_*)
...
rule Ransom_Win32_Genasom_KT_2{
	...
	strings :
		...
		$a_01_1 = {42 65 68 72 69 6e 67 65 72 58 33 32 41 64 6d 69 6e 69 73 74 72 61 74 6f 72 } //01 00 
