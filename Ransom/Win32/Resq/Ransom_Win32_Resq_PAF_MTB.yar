...
rule Ransom_Win32_Resq_PAF_MTB{
	...
	strings :
		...
		$a_01_2 = {4e 45 54 57 4f 52 4b 20 48 41 53 20 42 45 45 4e 20 50 45 4e 45 54 52 41 54 45 44 } //01 00  NETWORK HAS BEEN PENETRATED
		$a_01_3 = {65 6e 63 72 79 70 74 65 64 } //01 00  encrypted
		$a_00_4 = {76 00 73 00 73 00 61 00 64 00 6d 00 69 00 6e 00 2e 00 65 00 78 00 65 00 20 00 64 00 65 00 6c 00 65 00 74 00 65 00 20 00 73 00 68 00 61 00 64 00 6f 00 77 00 73 00 } //00 00  vssadmin.exe delete shadows
	condition:
		any of ($a_*)
