...
rule Ransom_Win32_Jaffrans_B_{
	...
	strings :
		...
		$a_03_5 = {8d 44 24 58 50 ff d6 85 c0 0f 84 90 01 02 00 00 8d 4c 24 54 51 ff 15 90 01 04 f6 44 24 28 14 90 00 } //2
		$a_03_6 = {8b 45 f8 53 8d 55 e8 52 50 57 56 89 5d e8 ff 15 90 01 04 8b 5d 0c 8d 4d f4 89 7d f4 51 8d 7d f8 e8 90 00 } //2
		$a_03_7 = {ff d7 6a 02 6a 00 6a 00 56 ff 15 90 01 04 8b 55 ec 6a 00 8d 4d fc 51 52 53 56 ff d7 90 00 } //2
		$a_03_8 = {8d 43 41 51 66 89 55 f6 88 45 f0 ff 15 90 01 04 83 f8 05 74 90 01 01 8d 55 f0 52 ff 15 90 01 04 8d 44 00 02 90 00 } //2
		$a_03_9 = {ff d3 ff d3 3d 16 00 09 80 0f 85 90 01 04 68 08 00 00 f0 6a 18 57 57 8d 4d fc 51 ff d6 90 00 } //2
	condition:
