...
rule Ransom_Win32_Xorist_SU_MTB{
	...
	strings :
		...
		$a_03_6 = {53 4f 46 54 57 41 52 45 5c 4d 69 63 72 6f 73 6f 66 74 5c 57 69 6e 64 6f 77 73 5c 43 75 72 72 65 6e 74 56 65 72 73 69 6f 6e 5c 52 75 6e 90 02 06 41 6c 63 6d 65 74 65 72 90 00 } //1
	condition:
