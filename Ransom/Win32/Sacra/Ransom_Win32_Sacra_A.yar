...
rule Ransom_Win32_Sacra_A{
	...
	strings :
		$a_01_0 = {63 72 72 73 61 40 69 6e 65 74 2e 75 61 } //01 00 
		$a_01_1 = {2e 62 37 38 31 63 62 62 32 39 30 35 34 64 62 31 32 66 38 38 66 30 38 63 36 65 31 36 31 63 31 39 39 2e 72 73 61 } //01 00 
