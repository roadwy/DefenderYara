...
rule Ransom_Win32_Bartcrypt_A{
	...
	strings :
		...
		$a_01_2 = {2e 62 61 72 74 00 } //01 00 
		$a_01_3 = {44 65 63 72 79 70 74 69 6e 67 20 6f 66 20 79 6f 75 72 20 66 69 6c 65 73 20 69 73 20 6f 6e 6c 79 20 70 6f 73 73 69 62 6c 65 } //00 00 
	condition:
		any of ($a_*)
