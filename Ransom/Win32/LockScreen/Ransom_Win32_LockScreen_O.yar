...
rule Ransom_Win32_LockScreen_O{
	...
	strings :
		...
		$a_01_2 = {44 69 73 61 62 6c 65 54 61 73 6b 4d 67 72 } //01 00 
		$a_01_3 = {6e 75 6d 00 } //01 00 
		$a_01_4 = {70 61 6c 6f 00 } //02 00 
		$a_01_5 = {4d 49 43 52 4f 53 4f 46 54 20 53 59 53 54 45 4d 20 53 45 43 55 52 49 54 59 00 } //02 00 
