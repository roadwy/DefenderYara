...
rule Ransom_Win32_LockScreen_CG{
	...
	strings :
		$a_01_0 = {3e 00 3e 00 75 00 6e 00 6c 00 6f 00 63 00 6b 00 2e 00 4e 00 61 00 6d 00 65 00 } //01 00  >>unlock.Name
		$a_01_1 = {3e 00 3e 00 63 00 6f 00 64 00 65 00 2e 00 4e 00 61 00 6d 00 65 00 } //02 00  >>code.Name
		$a_01_2 = {77 69 6e 6c 6f 63 6b 2e 50 72 6f 70 65 72 74 69 65 73 } //01 00  winlock.Properties
		$a_01_3 = {6d 61 73 74 65 72 77 69 6e } //05 00  masterwin
