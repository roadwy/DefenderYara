...
rule Ransom_Win32_LockScreen_BD{
	...
	strings :
		$a_03_0 = {89 03 ba 01 00 00 80 8b 03 e8 90 01 04 b1 01 90 00 } //1
		$a_03_1 = {8b c3 8b d4 b9 01 04 00 00 e8 90 01 04 81 c4 04 04 00 00 5b c3 90 00 } //1
		$a_03_2 = {40 65 63 68 6f 20 6f 66 66 90 01 0b 54 69 74 6c 65 90 00 } //1
