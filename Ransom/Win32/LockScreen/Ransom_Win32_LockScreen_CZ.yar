...
rule Ransom_Win32_LockScreen_CZ{
	...
	strings :
		...
		$a_03_5 = {6e 6f 63 6c 6f 73 65 00 90 01 08 6e 6f 6c 6f 67 6f 66 66 00 90 00 } //1
		$a_03_6 = {5c 43 6f 6e 74 72 6f 6c 5c 53 61 66 65 42 6f 6f 74 5c 4d 00 90 01 04 31 00 90 00 } //1
	condition:
