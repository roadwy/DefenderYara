...
rule Ransom_Win32_LockScreen_CL{
	...
	strings :
		$a_01_0 = {00 5c 6e 75 52 5c 6e 6f 69 73 72 65 56 74 6e 65 72 72 75 43 5c 73 77 6f 64 6e 69 57 5c 74 66 6f 73 6f 72 63 69 4d 5c 45 52 41 57 54 46 4f 53 00 } //01 00  尀畮屒潮獩敲瑖敮牲䍵獜潷湤坩瑜潦潳捲䵩䕜䅒呗但S
