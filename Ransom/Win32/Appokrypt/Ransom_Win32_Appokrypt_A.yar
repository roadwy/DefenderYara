...
rule Ransom_Win32_Appokrypt_A{
	...
	strings :
		...
		$a_03_1 = {33 ff 33 f6 eb 06 8d 9b 00 00 00 00 8b 86 90 01 04 50 8d 8c 24 90 01 02 00 00 51 ff 90 01 01 85 c0 74 05 bf 01 00 00 00 83 c6 04 83 fe 34 72 de 85 ff 90 00 } //1
