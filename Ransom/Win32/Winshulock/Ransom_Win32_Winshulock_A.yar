...
rule Ransom_Win32_Winshulock_A{
	...
	strings :
		$a_03_0 = {c7 04 01 01 01 01 01 83 c1 04 3b 4d 90 01 01 72 f1 59 58 ba 02 00 00 00 8b 45 90 01 01 e8 90 01 04 8b d8 83 fb ff 74 2f 90 00 } //2
		...
		$a_02_2 = {5c 5c 2e 5c 50 68 79 73 69 63 61 6c 44 72 69 76 65 36 90 02 0c 5c 5c 2e 5c 50 68 79 73 69 63 61 6c 44 72 69 76 65 37 90 00 } //1
