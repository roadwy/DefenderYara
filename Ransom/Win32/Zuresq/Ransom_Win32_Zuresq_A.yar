...
rule Ransom_Win32_Zuresq_A{
	...
	strings :
		$a_03_0 = {28 60 00 00 06 13 ?? 45 08 00 00 00 00 00 00 00 ?? ff ff ff ?? ff ff ff ?? ff ff ff ?? ff ff ff ?? ff ff ff ?? ff ff ff [0-80] 11 ?? 13 ?? 11 ?? 20 ?? ?? 00 00 28 60 00 00 06 30 ?? 18 45 01 00 00 00 f6 ff ff ff [0-10] 20 ?? ?? 00 00 28 60 00 00 06 2b 02 11 ?? 45 02 00 00 00 00 00 00 00 ?? ff ff ff de 34 75 4b 00 00 01 14 fe 03 11 } //3
		$a_03_1 = {28 60 00 00 06 13 06 45 08 00 00 00 00 00 00 00 ?? ff ff ff ?? ff ff ff ?? ff ff ff ?? ff ff ff ?? ff ff ff ?? ff ff ff ?? ff ff ff [0-06] 11 07 13 06 11 05 20 } //3
