...
rule Ransom_Win32_Basta_C{
	...
	strings :
		...
		$a_02_4 = {2e 00 62 00 61 00 73 00 74 00 61 00 00 90 08 00 02 66 00 61 00 78 00 90 00 } //2
		$a_02_5 = {62 00 6f 00 6f 00 74 00 90 02 10 72 00 65 00 61 00 64 00 6d 00 65 00 2e 00 74 00 78 00 74 00 90 02 30 2e 00 6a 00 70 00 67 00 90 00 } //2
