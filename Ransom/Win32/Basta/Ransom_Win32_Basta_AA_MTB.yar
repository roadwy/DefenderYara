...
rule Ransom_Win32_Basta_AA_MTB{
	...
	strings :
		$a_03_0 = {2b c1 8b 4d 90 01 01 8a 44 08 90 01 01 32 46 90 01 01 8b 4d 90 01 01 89 55 90 01 01 88 41 90 01 01 8b ca 8b 47 90 01 01 40 0f af 07 c1 e0 90 01 01 3b d8 0f 8c 90 00 } //10
