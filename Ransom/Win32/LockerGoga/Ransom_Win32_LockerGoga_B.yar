...
rule Ransom_Win32_LockerGoga_B{
	...
	strings :
		$a_02_0 = {63 72 79 70 74 6f 2d 6c 6f 63 6b 65 72 5c 74 70 6c 73 5f 4d 53 56 43 5c [0-20] 2f 65 78 63 65 70 74 69 6f 6e 2f 64 65 74 61 69 6c 2f 65 78 63 65 70 74 69 6f 6e 5f 70 74 72 2e 68 70 70 } //1
