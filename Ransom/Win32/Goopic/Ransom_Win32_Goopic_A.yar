...
rule Ransom_Win32_Goopic_A{
	meta:
		description = "Ransom:Win32/Goopic.A,SIGNATURE_TYPE_PEHSTR_EXT,06 00 06 00 13 00 00 01 00 "
	...
	strings :
		...
		$a_80_11 = {00 6f 75 74 2e 62 69 6e 00 } //  02 00 
		$a_80_12 = {62 64 35 38 33 63 61 36 33 39 38 61 33 30 37 35 38 65 65 66 34 35 32 35 62 38 62 39 31 65 64 30 36 32 35 61 34 33 64 65 } //bd583ca6398a30758eef4525b8b91ed0625a43de  01 00 
		$a_01_13 = {b8 64 6a 00 00 } //02 00 
		$a_03_14 = {6a 5a 68 00 08 00 00 ff 90 01 01 ff 15 90 01 07 d3 4d 62 10 90 00 } //02 00 
		$a_03_15 = {75 17 68 c0 27 09 00 c7 05 90 01 04 01 00 00 00 ff 15 90 01 04 eb ce 90 00 } //03 00 
		$a_03_16 = {ff d6 6a 05 6a 10 ff d7 50 6a 10 ff d7 50 ff 74 24 28 ff 74 24 28 6a ff ff 35 90 01 04 ff 15 90 01 04 ff 35 90 01 04 ff 15 90 01 04 ff 35 90 01 04 ff d6 68 60 ea 00 00 ff 15 90 01 04 e9 90 01 01 ff ff ff 90 00 } //02 00 
		$a_80_17 = {59 6f 75 72 20 66 69 6c 65 73 20 68 61 76 65 20 62 65 65 6e 20 63 72 79 70 74 65 64 } //Your files have been crypted  01 00 
		$a_80_18 = {49 6e 74 65 72 6e 65 74 45 78 70 6c 6f 72 65 72 2e 41 70 70 6c 69 63 61 74 69 6f 6e } //InternetExplorer.Application  00 00 
	condition:
		any of ($a_*)
