...
rule Ransom_Win32_Tovicrypt_A{
	...
	strings :
		...
		$a_03_18 = {72 00 75 00 c7 90 02 06 6e 00 61 00 c7 90 02 06 73 00 00 00 90 00 } //1
		...
		$a_03_21 = {42 00 2e 00 c7 90 02 03 4b 00 45 00 c7 90 02 03 59 00 00 00 90 00 } //2
