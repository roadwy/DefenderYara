...
rule Ransom_Win32_MBRLocker_A_bit{
	...
	strings :
		$a_01_0 = {5c 5c 2e 5c 5c 70 68 79 73 69 63 61 6c 64 72 69 76 65 30 } //0a 00  \\.\\physicaldrive0
		$a_01_1 = {59 6f 75 72 20 63 6f 6d 70 75 74 65 72 20 69 73 20 6c 6f 63 6b 65 64 } //03 00  Your computer is locked
		$a_01_2 = {77 77 65 31 30 30 } //02 00  wwe100
