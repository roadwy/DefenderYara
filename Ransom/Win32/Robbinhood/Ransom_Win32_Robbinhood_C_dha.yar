...
rule Ransom_Win32_Robbinhood_C_dha{
	...
	strings :
		...
		$a_00_1 = {67 6f 2f 73 72 63 2f 4e 65 77 42 6f 73 73 32 2f 6d 61 69 6e 2e 67 6f } //05 00  go/src/NewBoss2/main.go
		$a_00_2 = {5f 53 71 75 61 72 65 5c 75 70 5c 77 69 6e 6c 6f 67 6f 6e 2e 65 78 65 } //00 00  _Square\up\winlogon.exe
