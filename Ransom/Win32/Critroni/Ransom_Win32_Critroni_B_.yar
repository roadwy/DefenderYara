...
rule Ransom_Win32_Critroni_B_{
	...
	strings :
		...
		$a_03_6 = {6b 65 79 3d 90 02 08 75 73 64 3d 90 02 0c 61 64 64 72 65 73 73 3d 00 90 00 } //1
		$a_03_7 = {62 74 63 70 72 69 63 65 90 02 08 75 73 64 70 72 69 63 65 90 00 } //1
