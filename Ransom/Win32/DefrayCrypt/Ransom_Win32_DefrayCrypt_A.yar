...
rule Ransom_Win32_DefrayCrypt_A{
	meta:
		description = "Ransom:Win32/DefrayCrypt.A,SIGNATURE_TYPE_PEHSTR_EXT,0a 00 0a 00 12 00 00 03 00 "
	...
	strings :
		...
		$a_03_17 = {be 40 01 00 00 39 b5 90 01 02 00 00 7c 90 01 01 8d 45 90 01 01 50 56 8b c8 e8 90 01 02 00 00 ff 75 90 01 01 8b 45 90 00 } //00 00 
		$a_00_18 = {5d 04 00 00 b4 a7 03 80 } //5c 43 
	condition:
		any of ($a_*)
