...
rule Ransom_Win32_CylanCrypt_PAC_MTB{
	...
	strings :
		...
		$a_03_3 = {0b c8 8b 85 90 01 04 03 c6 03 ca 03 ce 89 85 90 01 04 8b f0 89 8d 90 01 04 c1 c0 07 8b d1 c1 ce 0b 33 f0 c1 ca 0d 8b 85 90 01 04 c1 c8 06 90 00 } //1
	condition:
