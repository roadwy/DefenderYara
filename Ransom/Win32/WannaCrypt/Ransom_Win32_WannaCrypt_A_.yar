...
rule Ransom_Win32_WannaCrypt_A_{
	meta:
		description = "Ransom:Win32/WannaCrypt.A!!WannaCrypt.gen!A,SIGNATURE_TYPE_ARHSTR_EXT,02 00 02 00 02 00 00 01 00 "
		
	strings :
		$a_00_0 = {6c 61 75 6e 63 68 65 72 2e 64 6c 6c 00 50 6c 61 79 47 61 6d 65 00 } //01 00  慬湵档牥搮汬倀慬䝹浡e
		$a_00_1 = {6d 73 73 65 63 73 76 63 2e 65 78 65 00 } //00 00 
	condition:
		any of ($a_*)
...
rule Ransom_Win32_WannaCrypt_A__2{
	meta:
		description = "Ransom:Win32/WannaCrypt.A!!WannaCrypt.gen!A,SIGNATURE_TYPE_ARHSTR_EXT,02 00 02 00 0b 00 00 01 00 "
	...
	strings :
		...
		$a_00_9 = {77 64 00 00 57 00 61 00 6e 00 61 00 43 00 72 00 79 00 70 00 74 00 30 00 72 00 00 00 53 00 6f 00 66 00 74 00 77 00 61 00 72 00 65 00 5c 00 00 00 } //01 00 
		$a_01_10 = {31 c0 40 90 74 08 e8 09 00 00 00 c2 24 00 e8 a7 00 00 00 c3 e8 01 00 00 00 eb 90 5b b9 76 01 00 00 0f 32 a3 fc ff df ff 8d 43 17 31 d2 0f 30 c3 } //00 00 
	condition:
		any of ($a_*)
