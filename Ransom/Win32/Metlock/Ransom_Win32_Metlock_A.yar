...
rule Ransom_Win32_Metlock_A{
	...
	strings :
		$a_01_0 = {5f 44 61 72 6b 4d 65 74 72 6f } //01 00  _DarkMetro
		$a_01_1 = {41 6e 74 69 57 69 6e 4c 6f 63 6b 65 72 54 72 61 79 2e 65 78 65 } //01 00  AntiWinLockerTray.exe
