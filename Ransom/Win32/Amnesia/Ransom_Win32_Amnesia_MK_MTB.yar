...
rule Ransom_Win32_Amnesia_MK_MTB{
	...
	strings :
		...
		$a_00_7 = {76 00 6d 00 73 00 73 00 32 00 63 00 6f 00 72 00 65 00 2e 00 65 00 78 00 65 00 } //65436 vmss2core.exe
	condition:
		((#a_81_0  & 1)*5+(#a_81_1  & 1)*5+(#a_81_2  & 1)*10+(#a_81_3  & 1)*2+(#a_81_4  & 1)*2+(#a_81_5  & 1)*2+(#a_81_6  & 1)*10+(#a_00_7  & 1)*65436) >=34
