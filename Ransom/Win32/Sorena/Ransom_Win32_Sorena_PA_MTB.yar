...
rule Ransom_Win32_Sorena_PA_MTB{
	...
	strings :
		...
		$a_03_5 = {43 6f 6e 74 61 63 74 20 3a 20 90 02 15 40 67 6d 61 69 6c 2e 63 6f 6d 20 6f 72 20 68 74 74 70 73 3a 2f 2f 74 2e 6d 65 2f 46 69 6c 65 90 00 } //2
		$a_03_6 = {43 3a 2f 55 73 65 72 73 2f 90 02 10 2f 67 6f 2f 73 72 63 2f 90 02 10 2f 45 6e 63 72 79 70 74 2e 67 6f 90 00 } //2
