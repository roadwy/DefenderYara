...
rule Ransom_Win32_Denisca_A{
	...
	strings :
		$a_01_0 = {44 65 6e 69 73 6b 61 } //01 00 
		$a_01_1 = {5c 4d 69 63 72 6f 73 6f 66 74 5c 57 69 6e 64 6f 77 73 5c 43 75 72 72 65 6e 74 56 65 72 73 69 6f 6e 5c 52 75 6e } //01 00 
