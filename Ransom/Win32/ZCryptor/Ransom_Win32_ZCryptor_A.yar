...
rule Ransom_Win32_ZCryptor_A{
	...
	strings :
		$a_01_0 = {5c 52 65 6c 65 61 73 65 5c 4d 79 45 6e 63 72 79 70 74 65 72 32 2e 70 64 62 00 } //01 00 
		...
		$a_01_3 = {41 4c 4c 20 59 4f 55 52 20 50 45 52 53 4f 4e 41 4c 20 46 49 4c 45 53 20 41 52 45 20 45 4e 43 52 59 50 54 45 44 3c 2f 66 6f 6e 74 3e 3c 2f 70 3e } //01 00 
		$a_01_4 = {5b 48 6f 77 20 54 6f 20 44 65 63 72 79 70 74 20 59 6f 75 72 20 46 69 6c 65 73 5d 3c } //01 00 
