...
rule Ransom_Win32_FileCoder_PAX_MTB{
	meta:
		description = "Ransom:Win32/FileCoder.PAX!MTB,SIGNATURE_TYPE_PEHSTR_EXT,05 00 04 00 05 00 00 "
	...
	strings :
		...
		$a_01_2 = {43 00 3a 00 5c 00 43 00 4f 00 4e 00 54 00 49 00 5f 00 4c 00 4f 00 47 00 2e 00 74 00 78 00 74 00 } //1 C:\CONTI_LOG.txt
		$a_01_3 = {54 65 73 74 4c 6f 63 6b 65 72 2e 70 64 62 } //1 TestLocker.pdb
