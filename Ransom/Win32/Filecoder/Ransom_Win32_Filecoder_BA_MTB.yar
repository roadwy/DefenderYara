...
rule Ransom_Win32_Filecoder_BA_MTB_5{
	...
	strings :
		...
		$a_02_1 = {54 00 68 00 65 00 20 00 90 02 10 20 00 69 00 73 00 20 00 4c 00 4f 00 43 00 4b 00 45 00 44 00 90 00 } //1
		$a_02_2 = {54 68 65 20 90 02 10 20 69 73 20 4c 4f 43 4b 45 44 90 00 } //1
