...
rule Ransom_Win32_Filecoder_F_MTB{
	...
	strings :
		$a_01_0 = {74 65 73 74 52 61 6e 73 6f 6d 65 2e 70 64 62 } //01 00 
		$a_01_1 = {44 61 74 61 2e 74 78 74 } //01 00 
		$a_01_2 = {52 61 6e 73 6f 6d 65 77 61 72 65 49 6e 66 6f 42 61 63 6b 75 70 } //01 00 
