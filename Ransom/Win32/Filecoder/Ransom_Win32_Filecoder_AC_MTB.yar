...
rule Ransom_Win32_Filecoder_AC_MTB_3{
	meta:
		description = "Ransom:Win32/Filecoder.AC!MTB,SIGNATURE_TYPE_PEHSTR_EXT,21 00 21 00 06 00 00 01 00 "
		
	strings :
		$a_01_0 = {2d 00 61 00 75 00 74 00 6f 00 73 00 70 00 72 00 65 00 61 00 64 00 69 00 66 00 6e 00 6f 00 61 00 76 00 3d 00 } //01 00  -autospreadifnoav=
		$a_01_1 = {63 00 68 00 61 00 63 00 68 00 61 00 20 00 66 00 61 00 69 00 6c 00 65 00 64 00 2c 00 20 00 70 00 6c 00 65 00 61 00 73 00 65 00 20 00 72 00 75 00 6e 00 20 00 78 00 36 00 34 00 20 00 76 00 65 00 72 00 73 00 69 00 6f 00 6e 00 20 00 6f 00 72 00 20 00 72 00 65 00 73 00 74 00 61 00 72 00 74 00 } //0a 00  chacha failed, please run x64 version or restart
		$a_01_2 = {64 00 69 00 73 00 62 00 61 00 6c 00 65 00 64 00 20 00 6e 00 65 00 74 00 77 00 6f 00 72 00 6b 00 20 00 65 00 6e 00 63 00 72 00 79 00 70 00 74 00 69 00 6e 00 67 00 } //01 00  disbaled network encrypting
		$a_01_3 = {5c 00 73 00 6c 00 63 00 6f 00 6e 00 66 00 69 00 67 00 2e 00 74 00 78 00 74 00 } //0a 00  \slconfig.txt
		$a_01_4 = {44 00 65 00 6c 00 65 00 74 00 65 00 20 00 53 00 68 00 61 00 64 00 6f 00 77 00 73 00 20 00 2f 00 41 00 6c 00 6c 00 20 00 2f 00 51 00 75 00 69 00 65 00 74 00 } //0a 00  Delete Shadows /All /Quiet
		$a_01_5 = {5c 00 70 00 72 00 6f 00 67 00 72 00 61 00 6d 00 64 00 61 00 74 00 61 00 5c 00 73 00 65 00 63 00 6c 00 65 00 73 00 } //00 00  \programdata\secles
	condition:
		any of ($a_*)
