...
rule Ransom_Win32_Malasypt_A{
	...
	strings :
		...
		$a_03_4 = {6a 09 50 ff 35 ?? ?? ?? ?? 8d 05 ?? ?? ?? ?? 03 05 ?? ?? ?? ?? 8b 00 ff d0 0b c0 74 31 ff 75 08 e8 ?? ?? ff ff 40 8b c8 d1 e1 8d 45 fc 6a 00 50 51 ff 75 08 ff 35 ?? ?? ?? ?? 8d 05 ?? ?? ?? ?? 03 05 ?? ?? ?? ?? 8b 00 ff d0 } //4
		...
		$a_03_8 = {66 8b 04 8a 66 3d ?? ?? 74 0c 66 3d ?? ?? 74 06 66 3d ?? ?? 75 09 c7 45 f4 01 00 00 00 eb 06 41 3b 4d f8 75 db ff 75 fc } //4
	condition:
