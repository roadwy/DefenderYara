...
rule Ransom_Win32_Kattisrypt_A{
	...
	strings :
		...
		$a_02_4 = {5b 53 41 4e 44 42 4f 58 45 53 5d 90 01 0c 5b 2f 54 41 53 4b 4e 41 90 00 } //1
		$a_02_5 = {5b 57 41 49 54 44 41 54 45 5d 90 01 0d 5b 2f 54 41 53 4b 4e 41 90 00 } //1
	condition:
