...
rule Ransom_Win32_Hackrypt_MTB{
	...
	strings :
		...
		$a_03_4 = {43 6f 6e 74 61 63 74 20 3a 20 90 02 10 40 67 6d 61 69 6c 2e 63 6f 6d 20 6f 72 20 68 74 74 70 73 3a 2f 2f 74 2e 6d 65 2f 66 69 6c 65 64 65 63 72 79 70 74 30 30 32 90 00 } //1
	condition:
