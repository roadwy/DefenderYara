...
rule Ransom_Win32_Loktrom_B{
	...
	strings :
		$a_03_0 = {b9 03 03 00 00 be 90 01 02 40 00 8d bd c8 f3 ff ff f3 a5 a4 c7 45 f8 90 01 01 00 00 00 c7 45 f0 00 00 00 00 e8 14 01 00 00 89 45 f4 c7 45 f0 00 00 00 00 eb 09 8b 4d f0 83 c1 01 89 4d f0 8b 55 f0 3b 55 f4 0f 8d d0 00 00 00 8b 45 f0 8a 8c 05 c8 f3 ff ff 88 4d fe 8b 55 f0 83 c2 01 89 55 dc 0f be 45 fe 8b 4d dc 33 4d f8 03 c1 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Ransom_Win32_Loktrom_B_3{
	...
	strings :
		$a_03_0 = {8d 40 00 80 60 27 ef 84 d2 74 04 80 48 27 10 8b 48 1c e3 14 50 74 12 ff 15 90 01 04 58 6a 05 ff 70 1c e8 90 00 } //1
		...
		$a_03_12 = {75 68 6a 11 e8 90 01 04 93 6a 12 e8 90 01 04 09 d8 78 48 90 00 } //2
