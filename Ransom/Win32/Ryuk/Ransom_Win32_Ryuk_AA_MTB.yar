...
rule Ransom_Win32_Ryuk_AA_MTB{
	...
	strings :
		...
		$a_02_1 = {8b 45 f0 8b 55 0c 01 d0 8a 00 0f be c0 89 44 24 04 8b 45 e8 89 04 24 e8 90 01 02 ff ff 88 03 ff 45 f0 8b 45 f0 3b 45 ec 0f 92 c0 84 c0 0f 85 90 01 01 ff ff ff 90 00 } //1
