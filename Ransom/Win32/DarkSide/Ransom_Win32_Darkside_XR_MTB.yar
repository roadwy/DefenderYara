...
rule Ransom_Win32_Darkside_XR_MTB{
	meta:
		description = "Ransom:Win32/Darkside.XR!MTB,SIGNATURE_TYPE_PEHSTR_EXT,04 00 04 00 05 00 00 "
		
	strings :
		$a_81_0 = {41 6c 6c 20 6f 66 20 79 6f 75 72 20 66 69 6c 65 73 20 61 72 65 20 65 6e 63 72 79 70 74 65 64 21 20 41 6e 64 20 79 6f 75 72 20 44 61 74 61 20 4c 65 61 6b 21 } //1 All of your files are encrypted! And your Data Leak!
		...
		$a_03_2 = {68 74 74 70 3a 2f 2f 64 61 72 6b 73 69 64 65 90 02 10 2e 6f 6e 69 6f 6e 2f 90 00 } //1
		...
		$a_81_4 = {57 65 20 67 75 61 72 61 6e 74 65 65 20 74 6f 20 64 65 63 72 79 70 74 20 6f 6e 65 20 66 69 6c 65 20 66 6f 72 20 66 72 65 65 2e 20 47 6f 20 74 6f 20 74 68 65 20 73 69 74 65 20 61 6e 64 20 63 6f 6e 74 61 63 74 20 75 73 } //1 We guarantee to decrypt one file for free. Go to the site and contact us
	condition:
		((#a_81_0  & 1)*1+(#a_81_1  & 1)*1+(#a_03_2  & 1)*1+(#a_81_3  & 1)*1+(#a_81_4  & 1)*1) >=4
