...
rule Ransom_Win32_Conti_AB_MTB{
	...
	strings :
		$a_01_0 = {44 00 6e 00 44 00 20 00 46 00 69 00 6c 00 65 00 73 00 } //01 00 
		$a_01_1 = {2a 00 2e 00 64 00 6e 00 64 00 } //01 00 
		$a_01_2 = {44 00 6e 00 44 00 2e 00 44 00 6f 00 63 00 75 00 6d 00 65 00 6e 00 74 00 } //01 00 
