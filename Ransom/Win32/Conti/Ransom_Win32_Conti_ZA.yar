...
rule Ransom_Win32_Conti_ZA{
	...
	strings :
		...
		$a_03_3 = {8b c1 c1 e8 18 33 c1 69 f8 95 e9 d1 5b 69 c6 95 e9 d1 5b be 03 00 00 00 33 f8 8b 90 01 02 99 f7 fe 8b 90 01 02 85 d2 74 90 0a 40 00 69 90 01 01 95 e9 d1 5b c7 90 00 } //10
	condition:
