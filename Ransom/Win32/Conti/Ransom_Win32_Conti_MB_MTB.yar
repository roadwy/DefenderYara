...
rule Ransom_Win32_Conti_MB_MTB{
	...
	strings :
		...
		$a_01_1 = {65 78 70 61 6e 64 20 33 32 2d 62 79 74 65 20 6b } //0a 00  expand 32-byte k
		$a_01_2 = {65 78 70 61 6e 64 20 31 36 2d 62 79 74 65 20 6b } //05 00  expand 16-byte k
		$a_81_3 = {2e 4a 56 55 41 45 } //00 00  .JVUAE
