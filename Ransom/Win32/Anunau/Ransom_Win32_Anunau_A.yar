...
rule Ransom_Win32_Anunau_A{
	...
	strings :
		...
		$a_03_7 = {6a 5c 58 8b 4d fc 66 89 84 4d 90 01 02 ff ff 6a 73 58 8b 4d fc 66 89 84 4d 90 01 02 ff ff 6a 74 90 00 } //2
		$a_03_8 = {75 21 6a 02 58 c1 e0 00 8b 4d 90 01 01 0f b7 04 01 83 f8 3a 75 0f 90 00 } //1
		$a_03_9 = {6a 02 58 6b c0 00 0f b7 84 05 90 01 02 ff ff 83 f8 25 74 09 c7 45 f8 01 00 00 00 eb 04 90 00 } //1
		$a_03_10 = {74 09 c7 45 f0 66 00 00 00 eb 07 c7 45 f0 73 00 00 00 ff 75 f0 ff 35 90 01 04 ff 35 90 01 04 68 90 00 } //2
	condition:
