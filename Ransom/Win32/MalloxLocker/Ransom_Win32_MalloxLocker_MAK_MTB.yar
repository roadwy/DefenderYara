...
rule Ransom_Win32_MalloxLocker_MAK_MTB{
	...
	strings :
		...
		$a_02_2 = {48 00 4f 00 57 00 20 00 54 00 4f 00 20 00 52 00 45 00 43 00 4f 00 56 00 45 00 52 00 90 02 0a 2e 00 54 00 58 00 54 00 90 00 } //1
		$a_02_3 = {48 4f 57 20 54 4f 20 52 45 43 4f 56 45 52 90 02 0a 2e 54 58 54 90 00 } //1
