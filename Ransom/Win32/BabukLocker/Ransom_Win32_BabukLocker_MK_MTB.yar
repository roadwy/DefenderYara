...
rule Ransom_Win32_BabukLocker_MK_MTB_2{
	...
	strings :
		...
		$a_02_4 = {68 00 74 00 74 00 70 00 3a 00 2f 00 2f 00 62 00 61 00 62 00 75 00 6b 00 [0-10] 2e 00 6f 00 6e 00 69 00 6f 00 6e 00 2f 00 6c 00 6f 00 67 00 69 00 6e 00 2e 00 70 00 68 00 70 00 3f 00 69 00 64 00 3d 00 } //1
		$a_02_5 = {68 74 74 70 3a 2f 2f 62 61 62 75 6b [0-10] 2e 6f 6e 69 6f 6e 2f 6c 6f 67 69 6e 2e 70 68 70 3f 69 64 3d } //1
