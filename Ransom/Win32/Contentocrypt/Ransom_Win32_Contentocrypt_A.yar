...
rule Ransom_Win32_Contentocrypt_A{
	...
	strings :
		$a_02_0 = {4a 45 6e 63 72 79 70 74 [0-20] 50 61 73 5a 69 70 [0-10] 43 6f 6e 66 69 67 [0-20] 53 61 6e 64 62 6f 78 65 73 } //1
		...
		$a_03_4 = {2e 65 78 65 20 44 [0-10] 65 6c 65 74 [0-10] 65 20 53 68 61 [0-10] 64 6f 77 73 20 2f 41 [0-10] 6c 6c 20 2f 51 [0-10] 75 69 65 74 } //2
	condition:
