...
rule Ransom_Win32_Weenloc_A{
	...
	strings :
		$a_02_0 = {6a 00 6a 01 e8 90 01 04 8b f0 85 f6 74 27 6a 00 56 e8 90 01 04 83 f8 01 1b db 43 56 e8 90 01 04 eb 11 90 00 } //3
		$a_03_1 = {00 65 78 70 6c 6f 72 65 72 2e 65 78 65 00 00 00 00 90 01 07 00 74 61 73 6b 6d 67 72 2e 65 78 65 00 55 8b 90 00 } //1
