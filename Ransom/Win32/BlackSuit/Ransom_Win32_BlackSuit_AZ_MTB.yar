...
rule Ransom_Win32_BlackSuit_AZ_MTB{
	...
	strings :
		$a_03_0 = {8b c2 8d 0c 16 83 e0 1f 42 8a 80 90 01 04 32 04 0f 88 01 81 fa 90 01 04 72 e4 90 00 } //1
		$a_03_1 = {8b c6 8d 0c 37 33 d2 46 f7 74 90 01 02 8a 82 90 01 04 32 04 0b 88 01 81 fe 90 01 04 72 e1 90 00 } //1
