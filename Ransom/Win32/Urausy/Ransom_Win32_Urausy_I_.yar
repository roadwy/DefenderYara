...
rule Ransom_Win32_Urausy_I_{
	...
	strings :
		...
		$a_01_9 = {25 00 78 00 25 00 78 00 2e 00 78 00 6d 00 6c 00 } //01 00  %x%x.xml
		$a_01_10 = {26 6c 74 3b 00 26 67 74 3b 00 26 61 6d 70 3b 00 47 65 74 4d 6f 64 75 6c 65 46 69 6c 65 4e 61 6d 65 41 } //01 00  氦㭴☀瑧;愦灭;敇䵴摯汵䙥汩乥浡䅥
