...
rule Ransom_Win32_Teerac_A_{
	...
	strings :
		...
		$a_00_4 = {53 00 3a 00 28 00 4d 00 4c 00 3b 00 3b 00 4e 00 52 00 4e 00 57 00 4e 00 58 00 3b 00 3b 00 3b 00 4c 00 57 00 29 00 } //01 00  S:(ML;;NRNWNX;;;LW)
		$a_01_5 = {72 61 63 6b 65 74 65 65 72 } //9c ff  racketeer
...
rule Ransom_Win32_Teerac_A__4{
	...
	strings :
		...
		$a_00_5 = {21 21 21 20 53 49 53 54 45 4d 49 4e 49 5a 20 48 41 43 4b 4c 45 4e 44 49 20 21 21 21 } //01 00  !!! SISTEMINIZ HACKLENDI !!!
		$a_00_6 = {58 3a 5c 72 61 63 6b 65 74 65 65 72 5c } //9c ff  X:\racketeer\
...
rule Ransom_Win32_Teerac_A__5{
	...
	strings :
		...
		$a_00_3 = {2e 00 65 00 6e 00 63 00 72 00 79 00 70 00 74 00 65 00 64 00 } //01 00  .encrypted
		$a_00_4 = {2f 00 74 00 6f 00 70 00 69 00 63 00 2e 00 70 00 68 00 70 00 } //01 00  /topic.php
		$a_00_5 = {43 00 72 00 79 00 70 00 74 00 6f 00 4c 00 6f 00 63 00 6b 00 65 00 72 00 } //01 00  CryptoLocker
		$a_00_6 = {44 00 45 00 43 00 52 00 59 00 50 00 54 00 5f 00 49 00 4e 00 53 00 54 00 52 00 55 00 43 00 54 00 49 00 4f 00 4e 00 53 00 2e 00 68 00 74 00 6d 00 6c 00 } //01 00  DECRYPT_INSTRUCTIONS.html
		$a_00_7 = {6c 00 65 00 62 00 61 00 6e 00 6f 00 6e 00 77 00 61 00 72 00 72 00 69 00 6f 00 72 00 2e 00 72 00 75 00 } //01 00  lebanonwarrior.ru
		$a_00_8 = {6d 00 6f 00 6e 00 65 00 79 00 77 00 65 00 6c 00 6c 00 } //01 00  moneywell
		$a_00_9 = {73 00 61 00 73 00 37 00 62 00 64 00 61 00 74 00 } //01 00  sas7bdat
		$a_00_10 = {76 00 73 00 73 00 61 00 64 00 6d 00 69 00 6e 00 2e 00 65 00 78 00 65 00 20 00 44 00 65 00 6c 00 65 00 74 00 65 00 20 00 53 00 68 00 61 00 64 00 6f 00 77 00 73 00 20 00 2f 00 41 00 6c 00 6c 00 20 00 2f 00 51 00 75 00 69 00 65 00 74 00 } //01 00  vssadmin.exe Delete Shadows /All /Quiet
		$a_00_11 = {79 00 63 00 62 00 63 00 72 00 61 00 } //9c ff  ycbcra
...
rule Ransom_Win32_Teerac_A__6{
	...
	strings :
		$a_00_0 = {44 00 45 00 43 00 52 00 59 00 50 00 54 00 5f 00 49 00 4e 00 53 00 54 00 52 00 55 00 43 00 54 00 49 00 4f 00 4e 00 53 00 2e 00 68 00 74 00 6d 00 6c 00 } //01 00  DECRYPT_INSTRUCTIONS.html
		$a_00_1 = {2e 00 65 00 6e 00 63 00 72 00 79 00 70 00 74 00 65 00 64 00 } //01 00  .encrypted
		$a_00_2 = {44 00 65 00 6c 00 65 00 74 00 65 00 20 00 53 00 68 00 61 00 64 00 6f 00 77 00 73 00 20 00 2f 00 41 00 6c 00 6c 00 20 00 2f 00 51 00 75 00 69 00 65 00 74 00 } //01 00  Delete Shadows /All /Quiet
		$a_00_3 = {5f 63 72 65 61 74 65 5f 65 6e 63 64 65 63 5f 74 68 72 64 } //01 00  _create_encdec_thrd
		$a_00_4 = {5f 64 69 73 70 6c 61 79 5f 72 61 6e 73 6f 6d 5f 70 61 67 65 } //01 00  _display_ransom_page
		$a_00_5 = {5f 64 72 6f 70 5f 72 61 6e 73 6f 6d 5f 70 61 67 65 } //01 00  _drop_ransom_page
		$a_00_6 = {5f 65 6e 63 64 65 63 5f 66 69 6c 65 5f 64 61 74 61 } //01 00  _encdec_file_data
		$a_00_7 = {5f 65 6e 75 6d 5f 66 69 6c 65 73 5f 63 62 } //01 00  _enum_files_cb
		$a_00_8 = {5f 65 78 74 65 72 6e 61 6c 5f 64 69 73 70 6c 61 79 5f 72 61 6e 73 6f 6d 5f 70 61 67 65 } //01 00  _external_display_ransom_page
		$a_00_9 = {5f 67 65 74 5f 6c 63 66 67 5f 66 69 6c 65 5f 70 61 74 68 } //01 00  _get_lcfg_file_path
		$a_00_10 = {5f 6c 63 66 67 5f 67 65 74 5f 76 61 6c 5f 66 69 6c 65 } //01 00  _lcfg_get_val_file
		$a_00_11 = {5f 6c 63 66 67 5f 73 65 74 5f 76 61 6c 5f 66 69 6c 65 } //01 00  _lcfg_set_val_file
		$a_00_12 = {5f 6f 6e 5f 62 65 66 6f 72 65 5f 65 6e 63 72 79 70 74 69 6f 6e 5f } //01 00  _on_before_encryption_
		$a_00_13 = {5f 6f 6e 5f 65 6e 63 72 79 70 74 69 6f 6e 5f 77 6f 72 6b } //01 00  _on_encryption_work
		$a_00_14 = {5f 70 72 6f 63 65 73 73 5f 64 65 73 6b 74 6f 70 5f 66 69 6c 65 73 } //01 00  _process_desktop_files
		$a_00_15 = {5f 70 72 6f 63 65 73 73 5f 70 63 5f 66 69 6c 65 73 } //01 00  _process_pc_files
		$a_00_16 = {5f 73 65 74 5f 64 65 63 72 79 70 74 65 64 5f 66 69 6c 65 5f 6e 61 6d 65 } //01 00  _set_decrypted_file_name
		$a_00_17 = {5f 73 65 74 5f 65 6e 63 72 79 70 74 65 64 5f 66 69 6c 65 5f 6e 61 6d 65 } //01 00  _set_encrypted_file_name
		$a_00_18 = {5f 77 61 69 74 5f 66 6f 72 5f 70 72 6f 63 65 73 73 69 6e 67 5f 74 68 72 64 73 } //01 00  _wait_for_processing_thrds
		$a_00_19 = {72 61 63 6b 5f 63 68 65 63 6b 5f 61 6e 64 5f 73 65 74 5f 69 6e 73 74 61 6e 63 65 } //01 00  rack_check_and_set_instance
		$a_00_20 = {72 61 63 6b 5f 65 6e 63 72 79 70 74 5f 70 63 } //01 00  rack_encrypt_pc
		$a_00_21 = {72 61 63 6b 5f 67 65 74 5f 72 61 6e 73 6f 6d 5f 70 61 67 65 } //01 00  rack_get_ransom_page
		$a_00_22 = {72 61 63 6b 5f 69 6e 73 74 61 6c 6c } //01 00  rack_install
		$a_00_23 = {72 61 63 6b 5f 6c 63 66 67 5f 67 65 74 5f 64 72 6f 70 70 65 72 5f 70 65 } //01 00  rack_lcfg_get_dropper_pe
		$a_00_24 = {72 61 63 6b 5f 73 65 74 5f 65 78 65 63 5f 65 76 65 6e 74 } //01 00  rack_set_exec_event
		$a_00_25 = {72 61 63 6b 5f 73 68 6f 77 5f 67 75 69 } //01 00  rack_show_gui
		$a_00_26 = {72 61 63 6b 5f 75 6e 69 6e 73 74 61 6c 6c } //9c ff  rack_uninstall
