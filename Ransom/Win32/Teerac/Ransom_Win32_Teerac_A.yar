...
rule Ransom_Win32_Teerac_A{
	meta:
		description = "Ransom:Win32/Teerac.A,SIGNATURE_TYPE_PEHSTR_EXT,03 00 03 00 06 00 00 01 00 "
	...
	strings :
		...
		$a_01_5 = {72 61 63 6b 65 74 65 65 72 } //00 00  racketeer
	condition:
		any of ($a_*)
...
rule Ransom_Win32_Teerac_A_2{
	meta:
		description = "Ransom:Win32/Teerac.A,SIGNATURE_TYPE_PEHSTR_EXT,04 00 04 00 06 00 00 01 00 "
	...
	strings :
		...
		$a_03_5 = {be 06 00 00 00 f7 f6 66 0f be 92 90 01 04 66 89 14 4b eb 13 be 14 00 00 00 f7 f6 66 0f be 82 90 01 04 66 89 04 4b 90 00 } //00 00 
	condition:
		any of ($a_*)
...
rule Ransom_Win32_Teerac_A_3{
	meta:
		description = "Ransom:Win32/Teerac.A,SIGNATURE_TYPE_PEHSTR_EXT,06 00 06 00 07 00 00 05 00 "
	...
	strings :
		...
		$a_00_6 = {58 3a 5c 72 61 63 6b 65 74 65 65 72 5c } //00 00  X:\racketeer\
		$a_00_7 = {7e } //15 00  ~
	condition:
		any of ($a_*)
