...
rule Ransom_Win32_Teerac_F{
	...
	strings :
		...
		$a_03_6 = {66 83 3c 46 2e 74 0a 48 85 c0 7f f4 5f 33 c0 5e c3 8d 7c 46 02 85 ff 74 f3 68 90 01 04 57 e8 90 00 } //3
		...
		$a_03_9 = {8a 14 08 80 f2 90 01 01 88 14 03 40 3b 86 90 01 04 72 e8 90 00 } //1
		$a_03_10 = {8a 14 01 80 f2 90 01 01 88 14 07 40 3b 86 90 01 04 72 e8 90 00 } //1
		$a_03_11 = {8a 0c 06 30 08 8b 4c 24 90 01 01 42 40 3b d1 72 f1 90 00 } //1
		$a_03_12 = {8b 14 06 33 11 8b 28 89 29 89 14 03 8b 54 24 90 01 01 83 c1 04 03 d1 83 c0 04 3b 57 04 7c e3 90 00 } //1
		$a_01_13 = {8b 14 28 31 14 06 83 c0 04 3b 47 04 7c f2 } //1
		$a_03_14 = {8b 54 24 10 2b d5 8b b4 07 90 01 01 00 00 00 8d 0c 28 33 34 0a 83 c0 04 89 31 3b 47 04 7c e9 90 00 } //1
		$a_03_15 = {8b 47 08 8a 8c 07 90 01 01 00 00 00 8b 44 24 90 01 01 32 08 40 88 4d 00 ff 47 08 45 89 44 24 90 01 01 4b 85 db 0f 85 90 00 } //1
