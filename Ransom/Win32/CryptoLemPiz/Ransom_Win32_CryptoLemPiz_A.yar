...
rule Ransom_Win32_CryptoLemPiz_A{
	...
	strings :
		...
		$a_00_5 = {43 72 79 70 74 4f 4e 5c 6c 6f 63 6b 5c 78 41 45 53 2e 70 61 73 00 } //02 00 
		$a_00_6 = {8b c3 e8 98 ff ff ff 88 04 2e 45 8a 04 2e 84 c0 75 ec 8b c6 } //00 00 
		$a_00_7 = {80 10 00 00 } //c2 8e 
	condition:
		any of ($a_*)
