...
rule Ransom_Win32_Ransoc_A{
	...
	strings :
		...
		$a_00_3 = {31 32 37 2e 30 2e 30 2e 31 3a 25 75 2f 73 70 6c 61 73 68 3f 63 74 72 6c 3d 25 75 26 66 3d 31 26 69 64 3d 25 73 } //01 00 
		$a_00_4 = {69 70 69 6e 66 6f 5f 69 6f 5f 67 65 6f } //01 00 
		$a_00_5 = {61 70 69 2e 69 70 69 66 79 2e 6f 72 67 } //01 00 
		$a_00_6 = {6c 69 6e 6b 65 64 69 6e 2e 63 6f 6d } //01 00 
		$a_01_7 = {25 73 5c 73 68 61 72 65 64 2e 78 6d 6c } //00 00 
