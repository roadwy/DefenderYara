...
rule Ransom_Win32_Shieldcrypt_A{
	meta:
		description = "Ransom:Win32/Shieldcrypt.A,SIGNATURE_TYPE_PEHSTR_EXT,08 00 08 00 08 00 00 02 00 "
		
	strings :
		$a_03_0 = {83 f8 09 74 14 83 f8 07 74 0f 83 f8 08 74 0a 83 f8 06 74 05 83 f8 04 75 1a e8 90 01 04 e8 90 01 04 3d 00 30 00 00 90 00 } //01 00 
		$a_01_1 = {00 26 6e 75 6d 62 65 72 73 3d 00 } //01 00 
		$a_01_2 = {00 26 63 6f 75 6e 74 73 3d 00 } //01 00  ☀潣湵獴=
		$a_01_3 = {2f 74 65 73 74 5f 73 69 74 65 5f 73 63 72 69 70 74 73 2f 6d 6f 64 75 6c 73 2f 74 72 61 66 66 69 63 2f 67 65 74 5f 69 6e 66 6f 2e 70 68 70 } //01 00  /test_site_scripts/moduls/traffic/get_info.php
		$a_01_4 = {2f 00 43 00 20 00 76 00 73 00 73 00 61 00 64 00 6d 00 69 00 6e 00 2e 00 65 00 78 00 65 00 20 00 44 00 65 00 6c 00 65 00 74 00 65 00 20 00 53 00 68 00 61 00 64 00 6f 00 77 00 73 00 20 00 2f 00 41 00 6c 00 6c 00 20 00 2f 00 51 00 75 00 69 00 65 00 74 00 } //01 00  /C vssadmin.exe Delete Shadows /All /Quiet
		$a_01_5 = {2f 00 43 00 20 00 62 00 63 00 64 00 65 00 64 00 69 00 74 00 20 00 2f 00 73 00 65 00 74 00 20 00 7b 00 64 00 65 00 66 00 61 00 75 00 6c 00 74 00 7d 00 20 00 72 00 65 00 63 00 6f 00 76 00 65 00 72 00 79 00 65 00 6e 00 61 00 62 00 6c 00 65 00 64 00 20 00 4e 00 6f 00 } //01 00  /C bcdedit /set {default} recoveryenabled No
		$a_01_6 = {2f 00 43 00 20 00 62 00 63 00 64 00 65 00 64 00 69 00 74 00 20 00 2f 00 73 00 65 00 74 00 20 00 7b 00 64 00 65 00 66 00 61 00 75 00 6c 00 74 00 7d 00 20 00 62 00 6f 00 6f 00 74 00 73 00 74 00 61 00 74 00 75 00 73 00 70 00 6f 00 6c 00 69 00 63 00 79 00 20 00 69 00 67 00 6e 00 6f 00 72 00 65 00 61 00 6c 00 6c 00 66 00 61 00 69 00 6c 00 75 00 72 00 65 00 73 00 } //01 00  /C bcdedit /set {default} bootstatuspolicy ignoreallfailures
		$a_01_7 = {6e 00 65 00 74 00 20 00 73 00 74 00 6f 00 70 00 20 00 76 00 73 00 73 00 } //00 00  net stop vss
		$a_00_8 = {78 95 02 00 08 } //00 08 
	condition:
		any of ($a_*)
...
rule Ransom_Win32_Shieldcrypt_A_2{
	meta:
		description = "Ransom:Win32/Shieldcrypt.A,SIGNATURE_TYPE_PEHSTR_EXT,08 00 08 00 19 00 00 01 00 "
