...
rule Ransom_Win32_Mytreex_A{
	...
	strings :
		...
		$a_03_22 = {83 f8 02 74 0a 83 f8 03 74 05 83 f8 04 75 90 01 01 8d 45 f4 8b d3 e8 90 01 04 8d 45 f4 ba 90 01 04 e8 90 01 04 8b 55 f4 8b 06 8b 08 ff 51 3c 4b 83 fb 42 75 90 00 } //1
	condition:
