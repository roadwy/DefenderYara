...
rule Ransom_Win32_DMALocker_B{
	meta:
		description = "Ransom:Win32/DMALocker.B,SIGNATURE_TYPE_PEHSTR_EXT,07 00 07 00 06 00 00 02 00 "
		
	strings :
		$a_01_0 = {5b 00 2b 00 5d 00 20 00 44 00 65 00 63 00 72 00 79 00 70 00 74 00 69 00 6e 00 67 00 20 00 73 00 75 00 63 00 63 00 65 00 65 00 64 00 65 00 64 00 2c 00 20 00 73 00 61 00 76 00 69 00 6e 00 67 00 3a 00 20 00 25 00 73 00 } //02 00  [+] Decrypting succeeded, saving: %s
		$a_01_1 = {33 00 2e 00 20 00 49 00 66 00 20 00 79 00 6f 00 75 00 20 00 61 00 6c 00 72 00 65 00 61 00 64 00 79 00 20 00 68 00 61 00 76 00 65 00 20 00 42 00 69 00 74 00 63 00 6f 00 69 00 6e 00 73 00 2c 00 20 00 70 00 61 00 79 00 20 00 75 00 73 00 } //02 00  3. If you already have Bitcoins, pay us
		$a_01_2 = {5c 00 64 00 65 00 63 00 72 00 79 00 70 00 74 00 69 00 6e 00 67 00 2e 00 74 00 78 00 74 00 } //02 00  \decrypting.txt
		$a_01_3 = {5c 00 63 00 72 00 79 00 70 00 74 00 69 00 6e 00 66 00 6f 00 2e 00 74 00 78 00 74 00 } //01 00  \cryptinfo.txt
		$a_01_4 = {42 00 41 00 43 00 4b 00 47 00 52 00 4f 00 55 00 4e 00 44 00 00 00 } //02 00 
		$a_01_5 = {44 4d 41 20 4c 6f 63 6b 65 72 } //00 00  DMA Locker
		$a_00_6 = {78 f6 } //01 00 
	condition:
		any of ($a_*)
...
rule Ransom_Win32_DMALocker_B_2{
	meta:
		description = "Ransom:Win32/DMALocker.B,SIGNATURE_TYPE_PEHSTR_EXT,08 00 08 00 14 00 00 01 00 "
