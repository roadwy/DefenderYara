...
rule Ransom_Win32_BastaLoader_SA{
	...
	strings :
		...
		$a_00_2 = {64 00 61 00 76 00 73 00 65 00 74 00 63 00 6f 00 6f 00 6b 00 69 00 65 00 } //65436 davsetcookie
		$a_00_3 = {68 00 67 00 73 00 70 00 6f 00 72 00 74 00 61 00 6c 00 73 00 65 00 74 00 75 00 70 00 78 00 38 00 36 00 5f 00 63 00 } //65436 hgsportalsetupx86_c
	condition:
		((#a_00_0  & 1)*1+(#a_00_1  & 1)*10+(#a_00_2  & 1)*65436+(#a_00_3  & 1)*65436) >=11
