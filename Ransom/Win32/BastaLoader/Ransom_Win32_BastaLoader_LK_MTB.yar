...
rule Ransom_Win32_BastaLoader_LK_MTB{
	...
	strings :
		$a_03_0 = {8b 55 d8 83 c2 01 89 55 d8 8b 45 d8 3b 45 d0 7d 1a 8b 4d c0 03 4d d8 89 4d bc 8b 55 bc 52 8d 4d b0 e8 ?? ?? ?? ?? 89 45 a0 eb d5 } //1
		$a_03_1 = {6a 00 6a 40 68 00 30 00 00 ?? ?? ?? ?? ?? ?? 50 6a 00 e8 } //1
