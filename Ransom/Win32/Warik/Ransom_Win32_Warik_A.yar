...
rule Ransom_Win32_Warik_A{
	...
	strings :
		$a_03_0 = {31 f6 8d 74 26 00 8b 04 b5 90 01 04 8d 90 02 10 e8 90 01 02 ff ff 85 c0 75 90 01 01 83 c6 01 81 fe 90 01 01 00 00 00 75 90 00 } //3
		$a_03_1 = {83 c6 01 83 fe 79 0f 90 02 05 8b 04 b5 90 01 04 89 90 02 04 89 90 02 04 e8 90 01 04 85 c0 74 90 00 } //3
