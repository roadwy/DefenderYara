...
rule Ransom_Win32_LiquidCrypt_PA_MTB{
	meta:
		description = "Ransom:Win32/LiquidCrypt.PA!MTB,SIGNATURE_TYPE_PEHSTR_EXT,06 00 06 00 06 00 00 "
		
	strings :
		$a_01_0 = {5c 00 72 00 75 00 6e 00 73 00 2e 00 74 00 78 00 74 00 } //1 \runs.txt
		$a_01_1 = {4c 00 69 00 71 00 75 00 69 00 64 00 2e 00 68 00 74 00 61 00 } //1 Liquid.hta
		$a_01_2 = {73 00 74 00 61 00 72 00 74 00 65 00 64 00 20 00 6e 00 65 00 74 00 20 00 73 00 63 00 61 00 6e 00 } //1 started net scan
		...
		$a_03_5 = {5c 63 70 70 45 6e 64 5c 90 02 10 5c 63 70 70 45 6e 64 78 36 34 2e 70 64 62 90 00 } //1
	condition:
