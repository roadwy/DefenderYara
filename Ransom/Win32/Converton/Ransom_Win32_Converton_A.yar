...
rule Ransom_Win32_Converton_A{
	...
	strings :
		...
		$a_02_2 = {25 00 30 00 32 00 78 00 90 02 08 43 00 6f 00 76 00 65 00 72 00 74 00 6f 00 6e 00 90 02 08 25 00 78 00 25 00 78 00 25 00 78 00 25 00 78 00 90 00 } //2
		$a_02_3 = {25 30 32 78 90 02 08 43 6f 76 65 72 74 6f 6e 90 02 08 25 78 25 78 25 78 25 78 90 00 } //2
	condition:
