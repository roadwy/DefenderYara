...
rule Ransom_Win32_Troldesh_B{
	...
	strings :
		...
		$a_01_2 = {73 63 61 6e 5f 70 6f 72 74 00 } //01 00 
		$a_01_3 = {2f 74 61 73 6b 2e 70 68 70 3f 00 } //01 00 
		$a_01_4 = {44 65 61 72 20 41 56 20 61 6e 61 6c 79 73 74 73 2c } //01 00 
		$a_01_5 = {2e 6f 6e 69 6f 6e 00 } //01 00 
		$a_01_6 = {5c 43 73 72 73 73 5c 43 6f 6e 66 69 67 75 72 61 74 69 6f 6e 5c } //01 00 
