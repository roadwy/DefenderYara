...
rule Ransom_Win32_MedusaLocker_PB_MTB{
	...
	strings :
		$a_01_0 = {2e 00 53 00 4f 00 46 00 54 00 57 00 41 00 52 00 45 00 5c 00 50 00 41 00 49 00 44 00 4d 00 45 00 4d 00 45 00 53 00 } //01 00 
		$a_01_1 = {50 55 54 49 4e 48 55 49 4c 4f 31 33 33 37 } //01 00 
