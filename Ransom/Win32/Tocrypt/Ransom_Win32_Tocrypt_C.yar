...
rule Ransom_Win32_Tocrypt_C{
	...
	strings :
		...
		$a_00_1 = {5c 54 4f 58 20 52 41 4e 53 4f 4d 2e 68 74 6d 6c } //01 00 
		$a_00_2 = {5c 74 6f 78 2e 6c 6f 67 } //01 00 
		$a_00_3 = {5c 74 6f 78 5f 74 6f 72 5c } //01 00 
		$a_00_4 = {2e 74 6f 78 63 72 79 70 74 } //01 00 
		$a_00_5 = {5c 74 6f 78 2e 64 6f 6e 65 2e 6c 6f 67 } //00 00 
