...
rule Ransom_Win32_Tescrypt_D{
	...
	strings :
		$a_03_0 = {99 b9 7a 00 00 00 f7 f9 8b f2 83 fe 61 7c ec 6a 01 e8 90 01 04 8b 55 08 83 c4 04 6a 0f 66 89 34 7a ff 15 90 01 04 47 3b fb 7c 90 09 1f 00 90 02 0f ff 15 90 01 04 50 e8 90 00 } //2
		$a_03_1 = {52 ff d7 83 c4 08 85 c0 74 16 68 42 a8 6f 9e 6a 01 6a 00 e8 90 01 04 83 c4 0c 6a 00 56 ff d0 90 09 05 00 68 90 00 } //2
		...
		$a_02_3 = {59 6f 75 72 20 70 65 72 73 6f 6e 61 6c 20 90 02 09 54 4f 52 90 01 01 42 72 6f 77 73 65 72 90 02 05 20 90 01 08 90 02 08 2e 6f 6e 69 6f 6e 2f 25 53 90 00 } //1
