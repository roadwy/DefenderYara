...
rule Ransom_Win32_Tescrypt_R{
	...
	strings :
		...
		$a_03_1 = {68 5c 01 00 00 68 90 01 04 53 c7 85 90 01 02 ff ff 00 00 00 00 ff 15 90 01 04 85 c0 74 a8 90 00 } //1
		$a_03_2 = {68 f0 9a b8 6f 6a 01 6a 00 e8 90 01 04 8b 4d 08 83 c4 0c 6a 00 6a 00 6a 00 51 6a 00 6a 00 ff d0 90 00 } //1
