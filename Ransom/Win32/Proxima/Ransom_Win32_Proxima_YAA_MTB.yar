...
rule Ransom_Win32_Proxima_YAA_MTB{
	...
	strings :
		$a_03_0 = {0a c8 88 0e 0f b6 47 01 0f b6 88 ?? ?? ?? ?? 0f b6 47 02 c0 e1 04 0f b6 80 ?? ?? ?? ?? c0 e8 02 0a c8 88 4e 01 0f b6 47 02 0f b6 4f 03 83 c7 04 0f b6 80 ?? ?? ?? ?? c0 e0 06 0a 81 ?? ?? ?? ?? 88 46 02 83 c6 03 } //1
