...
rule Ransom_Win32_Scarab_PA_MTB{
	...
	strings :
		$a_02_0 = {0f b6 06 46 85 c0 74 90 01 01 bb 00 00 00 00 23 d3 21 5d fc ff 75 fc 81 04 24 08 00 00 00 8f 45 fc d1 c0 8a fc 8a e6 d1 cb ff 4d fc 75 90 01 01 55 33 2c 24 33 eb 83 e0 00 03 c5 5d aa 49 75 90 00 } //1
