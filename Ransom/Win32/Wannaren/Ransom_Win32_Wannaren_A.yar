...
rule Ransom_Win32_Wannaren_A{
	...
	strings :
		...
		$a_03_2 = {41 ff ff ff 81 90 01 01 3f ff ff ff c1 90 01 01 0a 81 90 01 01 ff 01 00 00 81 90 01 01 ff 01 00 00 81 90 01 01 ff 7f 00 00 90 00 } //1
		$a_03_3 = {75 50 80 7c 90 01 02 64 75 49 80 7c 90 01 02 6f 75 42 80 7c 90 01 02 62 75 3b 80 7c 90 01 02 65 75 90 00 } //1
	condition:
