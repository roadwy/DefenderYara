...
rule Ransom_Win32_Clop_PE_MTB{
	...
	strings :
		$a_00_0 = {2e 00 43 00 49 00 49 00 70 00 } //0a 00  .CIIp
		$a_00_1 = {2e 00 43 00 49 00 30 00 70 00 } //01 00  .CI0p
		$a_01_2 = {42 45 47 49 4e 20 50 55 42 4c 49 43 20 4b 45 59 } //01 00  BEGIN PUBLIC KEY
		$a_00_3 = {5c 00 52 00 45 00 41 00 44 00 4d 00 45 00 5f 00 52 00 45 00 41 00 44 00 4d 00 45 00 2e 00 74 00 78 00 74 00 } //01 00  \README_README.txt
		$a_00_4 = {25 00 73 00 20 00 72 00 75 00 6e 00 72 00 75 00 6e 00 } //01 00  %s runrun
