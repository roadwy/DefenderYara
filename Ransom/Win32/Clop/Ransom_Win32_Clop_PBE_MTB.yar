...
rule Ransom_Win32_Clop_PBE_MTB{
	...
	strings :
		...
		$a_03_3 = {33 ca 0b 0d 90 01 04 89 0d 90 01 04 0f be 05 90 01 04 0f bf 4d f0 03 c1 0f bf 55 f8 03 c2 0f bf 55 f0 8b 0d 90 01 04 d3 fa 33 c2 0f be 0d 90 01 04 23 c8 88 0d 90 00 } //4
	condition:
