...
rule Ransom_Win32_Clop_PBE_MTB{
	...
	strings :
		$a_01_0 = {52 00 45 00 41 00 44 00 4d 00 45 00 5f 00 52 00 45 00 41 00 44 00 4d 00 45 00 2e 00 74 00 78 00 74 00 } //02 00 
		$a_01_1 = {2d 2d 42 45 47 49 4e 20 50 55 42 4c 49 43 20 4b 45 59 2d 2d } //01 00 
		$a_01_2 = {72 00 75 00 6e 00 72 00 75 00 6e 00 } //04 00 
