...
rule Ransom_Win32_HydraCrypt_B{
	...
	strings :
		...
		$a_03_1 = {30 06 46 0f af c1 ba 90 01 04 ff 4d 0c 4a 03 c2 83 7d 0c 00 77 e9 90 00 } //1
		...
		$a_03_4 = {30 07 47 0f af c1 ba 90 01 04 ff 4d 0c 03 c2 40 40 83 7d 0c 00 77 e8 90 00 } //1
		$a_03_5 = {30 07 47 0f af c1 68 90 01 04 5a ff 4d 0c 03 c2 40 83 7d 0c 00 77 e8 90 00 } //1
