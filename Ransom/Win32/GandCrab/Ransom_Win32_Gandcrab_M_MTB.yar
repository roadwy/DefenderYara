...
rule Ransom_Win32_Gandcrab_M_MTB{
	...
	strings :
		...
		$a_02_1 = {8b 4d c4 03 4d fc 0f be 19 e8 90 01 02 ff ff 33 d8 8b 55 c4 03 55 fc 88 1a eb 90 01 01 5b 8b e5 5d c3 90 00 } //1
		$a_02_2 = {55 8b ec 81 ec 00 08 00 00 a1 90 01 03 00 69 c0 90 01 04 05 90 01 04 a3 90 01 03 00 90 02 50 a1 90 01 03 00 c1 e8 10 25 ff 7f 00 00 8b e5 5d c3 90 00 } //1
	condition:
