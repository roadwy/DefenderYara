...
rule Ransom_Win32_Gandcrab_K_MTB{
	...
	strings :
		$a_00_0 = {21 54 68 69 73 20 70 72 6f 67 72 61 6d } //65535 !This program
		...
		$a_02_3 = {ff 74 24 0c 53 53 53 53 53 53 53 53 53 53 ff 15 90 01 03 00 8b cf e8 90 01 01 ff ff ff 83 c7 08 83 ee 01 75 90 00 } //1
	condition:
		((#a_00_0  & 1)*65535+(#a_00_1  & 1)*1+(#a_00_2  & 1)*1+(#a_02_3  & 1)*1) >=3
