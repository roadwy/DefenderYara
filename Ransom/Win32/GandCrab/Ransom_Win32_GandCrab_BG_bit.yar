...
rule Ransom_Win32_GandCrab_BG_bit{
	meta:
		description = "Ransom:Win32/GandCrab.BG!bit,SIGNATURE_TYPE_PEHSTR_EXT,02 00 02 00 02 00 00 01 00 "
	...
	strings :
		...
		$a_03_1 = {8b 4d 08 8b c1 c1 e0 90 01 01 89 45 f8 8b 45 0c 01 45 f8 8b c1 c1 e8 90 01 01 89 45 fc 8b 45 14 01 45 fc 8b 45 10 03 c1 33 45 fc 33 45 f8 90 00 } //00 00 
	condition:
		any of ($a_*)
