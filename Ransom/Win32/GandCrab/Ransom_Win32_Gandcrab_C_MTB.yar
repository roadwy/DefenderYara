...
rule Ransom_Win32_Gandcrab_C_MTB{
	...
	strings :
		$a_02_0 = {ff ff eb 08 e8 90 01 04 30 04 37 83 ee 01 79 f3 5f 5e c2 04 00 90 00 } //2
		...
		$a_00_3 = {21 54 68 69 73 20 70 72 6f 67 72 61 6d } //65535 !This program
	condition:
		((#a_02_0  & 1)*2+(#a_00_1  & 1)*2+(#a_00_2  & 1)*1+(#a_00_3  & 1)*65535) >=4
