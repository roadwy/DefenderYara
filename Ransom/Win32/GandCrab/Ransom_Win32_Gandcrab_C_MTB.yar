...
rule Ransom_Win32_Gandcrab_C_MTB{
	...
	strings :
		...
		$a_00_2 = {63 61 6e 6e 6f 74 20 62 65 20 72 75 6e 20 69 6e 20 44 4f 53 20 6d 6f 64 65 2e } //ff ff  cannot be run in DOS mode.
		$a_00_3 = {21 54 68 69 73 20 70 72 6f 67 72 61 6d } //00 00  !This program
