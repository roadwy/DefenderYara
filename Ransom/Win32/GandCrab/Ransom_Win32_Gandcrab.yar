...
rule Ransom_Win32_Gandcrab{
	...
	strings :
		$a_02_0 = {81 ff 9c 19 00 00 7d 04 6a 00 ff d6 e8 90 01 01 fa ff ff 8b 4c 24 0c 30 04 39 83 ef 01 79 e3 ff 15 90 90 c7 41 00 64 8b 0d 2c 00 00 00 8b 11 5f 5e c7 42 04 01 00 00 00 33 c0 5b 8b e5 5d c2 10 90 00 } //1
	condition:
		((#a_02_0  & 1)*1) >=1
...
rule Ransom_Win32_Gandcrab_2{
	...
	strings :
		$a_02_0 = {e8 a7 ff ff ff 30 04 37 6a 00 ff 15 90 01 02 41 00 8d 85 fc f7 ff ff 50 6a 00 ff 15 90 01 02 41 00 46 3b 75 08 7c cd 90 09 0e 00 6a 00 ff 15 90 01 02 41 00 ff 15 90 01 02 41 00 90 00 } //1
		$a_02_1 = {69 c0 fd 43 03 00 05 c3 9e 26 00 a3 90 01 02 41 00 c1 e8 10 25 ff 7f 00 00 c3 90 09 05 00 a1 90 01 02 41 00 90 00 } //1
	condition:
...
rule Ransom_Win32_Gandcrab_3{
	...
	strings :
		...
		$a_02_1 = {69 c0 fd 43 03 00 05 c3 9e 26 00 a3 90 01 02 41 00 3d fe 44 05 00 75 1f 8d 85 fc fb ff ff 50 ff 15 90 01 02 41 00 6a 00 68 90 01 02 41 00 68 90 01 02 41 00 ff 15 90 01 02 41 00 0f b7 05 90 01 02 41 00 8b 4d fc 33 cd 25 ff 7f 00 00 90 09 05 00 a1 90 01 02 41 00 90 00 } //1
	condition:
...
rule Ransom_Win32_Gandcrab_4{
	...
	strings :
		...
		$a_02_1 = {81 fe 37 0e 00 00 7d 14 6a 00 6a 00 6a 00 6a 00 ff d7 6a 00 6a 00 ff 15 90 01 02 41 00 0f be 1c 1e e8 7b ff ff ff 32 c3 8b 5d fc 88 04 1e 46 3b 75 f8 7c cd 90 00 } //1
	condition:
		((#a_00_0  & 1)*1+(#a_02_1  & 1)*1) >=2
