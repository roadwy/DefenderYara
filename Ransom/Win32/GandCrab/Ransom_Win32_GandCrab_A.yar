...
rule Ransom_Win32_GandCrab_A{
	...
	strings :
		$a_03_0 = {6a 47 66 89 90 01 02 58 6a 44 66 89 90 01 02 58 6a 43 66 89 90 01 02 58 6a 42 66 89 90 01 02 58 66 89 90 00 } //25
		$a_03_1 = {6a 62 66 89 90 01 03 58 6a 76 66 89 90 01 03 58 6a 6a 66 89 90 01 03 66 89 90 01 03 5a 6a 79 66 89 90 01 03 66 89 90 01 03 66 89 90 01 03 59 6a 71 58 6a 37 90 00 } //25
		...
		$a_02_6 = {6e 00 73 00 6c 00 6f 00 6f 00 6b 00 75 00 70 00 20 00 90 02 20 20 00 64 00 6e 00 73 00 31 00 2e 00 73 00 6f 00 70 00 72 00 6f 00 64 00 6e 00 73 00 2e 00 72 00 75 00 90 00 } //10
		$a_02_7 = {6e 00 73 00 6c 00 6f 00 6f 00 6b 00 75 00 70 00 20 00 90 02 20 20 00 61 00 2e 00 64 00 6e 00 73 00 70 00 6f 00 64 00 2e 00 63 00 6f 00 6d 00 90 00 } //10
