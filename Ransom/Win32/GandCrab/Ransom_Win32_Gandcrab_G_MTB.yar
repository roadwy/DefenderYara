...
rule Ransom_Win32_Gandcrab_G_MTB{
	...
	strings :
		$a_03_0 = {57 8b 38 8a 44 0f 03 8a d8 80 e3 ?? c0 e3 04 0a 5c 0f 01 88 5d ff 8a d8 24 ?? c0 e0 02 0a 04 0f c0 e3 06 0a 5c 0f 02 88 04 16 8a 45 ff 46 88 04 16 8b 45 0c 46 88 1c 16 83 c1 04 46 3b 08 72 c3 5f } //1
		$a_03_1 = {8b 44 24 14 8d ?? ?? e8 ?? ?? ff ff 30 06 } //1
	condition:
...
rule Ransom_Win32_Gandcrab_G_MTB_2{
	...
	strings :
		...
		$a_02_1 = {8b f9 85 db 7e 37 8d 49 00 ff 15 ?? ?? ?? ?? ff 15 ?? ?? ?? ?? e8 ?? ?? ?? ?? 30 84 37 00 fe ff ff 6a 00 ff 15 ?? ?? ?? ?? 8d 85 ?? ?? ?? ?? 50 6a 00 ff 15 ?? ?? ?? ?? 46 3b f3 7c cc } //1
		$a_00_2 = {8d 45 0c 50 6a 00 ff d7 8b 4d 08 a0 3e f4 b7 03 30 04 0e 46 3b f3 7c 92 5f 5e 5b 8b e5 5d c2 08 00 } //1
		$a_02_3 = {cc 6a 00 ff 15 ?? ?? ?? ?? a1 ?? ?? ?? ?? 69 c0 fd 43 03 00 05 c3 9e 26 00 a3 ?? ?? ?? ?? c1 e8 10 25 ff 7f 00 00 c3 } //1
