...
rule Ransom_Win32_Edicrypt_A_{
	meta:
		description = "Ransom:Win32/Edicrypt.A!!Edicrypt.gen!A,SIGNATURE_TYPE_ARHSTR_EXT,04 00 04 00 04 00 00 01 00 "
	...
	strings :
		...
		$a_80_3 = {4b 65 79 20 74 6f 20 64 65 63 72 79 70 74 3a 20 } //Key to decrypt:   05 00 
	condition:
		any of ($a_*)
