...
rule Ransom_Win32_Maze_PS_MTB{
	...
	strings :
		...
		$a_00_1 = {43 61 72 64 65 72 73 4c 69 76 65 4d 61 74 74 65 72 2e 70 64 62 } //01 00  CardersLiveMatter.pdb
		$a_00_2 = {67 66 67 39 75 72 77 79 66 37 2e 70 64 62 } //00 00  gfg9urwyf7.pdb
