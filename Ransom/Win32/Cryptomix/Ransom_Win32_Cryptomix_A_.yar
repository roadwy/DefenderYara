...
rule Ransom_Win32_Cryptomix_A_{
	...
	strings :
		...
		$a_03_5 = {53 6a 61 5b 6a 41 c7 45 90 01 01 1a 00 00 00 5a 0f b7 01 66 3b c3 72 90 01 01 83 f8 7a 77 90 01 01 83 e8 54 99 f7 7d 90 01 01 03 d3 eb 90 01 01 66 3b c2 72 90 01 01 83 f8 5a 77 90 01 01 83 e8 34 99 f7 7d 90 01 01 83 c2 41 6a 41 90 00 } //3
	condition:
