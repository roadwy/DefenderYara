...
rule Ransom_Win32_Fortrypt_A{
	...
	strings :
		$a_01_0 = {28 25 69 29 00 2a 00 5c 00 25 30 32 58 00 7b 25 73 31 7d 00 7b 25 73 32 7d 00 7b 25 73 33 7d 00 77 61 6c 6c 00 2e 62 6d 70 00 2e 00 2e 2e 00 25 } //01 00  ┨⥩⨀尀─㈰X╻ㅳ}╻㉳}╻㍳}慷汬⸀浢p.⸮─
