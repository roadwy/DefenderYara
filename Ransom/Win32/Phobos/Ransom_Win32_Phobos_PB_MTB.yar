...
rule Ransom_Win32_Phobos_PB_MTB_2{
	...
	strings :
		$a_02_0 = {6a 2c 8d 44 24 24 6a 00 50 e8 90 01 03 ff 6a 20 8d 4c 24 10 51 8d 54 24 40 52 66 c7 44 24 38 08 02 66 c7 44 24 3c 10 66 c6 44 24 40 20 e8 90 01 03 ff 8b 16 83 c4 18 8d 46 04 50 6a 00 6a 00 6a 2c 8d 4c 24 30 51 52 ff 15 90 01 03 00 85 c0 75 15 ff 15 90 01 03 00 50 e8 90 01 03 00 83 c4 04 32 c0 83 c4 4c c3 90 00 } //10
		$a_02_1 = {0f b7 54 24 12 03 56 08 57 52 53 e8 90 01 03 ff 83 c4 0c 8d 6e 0c 55 ff 15 90 01 03 00 e8 90 01 03 ff 84 c0 74 90 01 01 8b 44 24 24 50 53 6a 00 6a 00 89 38 8b 46 04 6a 00 50 ff 15 90 01 03 00 85 c0 75 90 00 } //5
