...
rule Ransom_Win32_Phobos_A{
	...
	strings :
		$a_02_0 = {57 33 c0 89 5d d4 8d 7d d8 ab ab 33 c0 89 5d c4 8d 7d c8 ab ab 33 c0 89 5d b8 8d 7d bc ab 8d b6 ?? ?? ?? ?? 89 5d f0 89 5d f4 89 5d e0 ab } //2
	condition:
		((#a_02_0  & 1)*2) >=2
...
rule Ransom_Win32_Phobos_A_2{
	...
	strings :
		...
		$a_03_2 = {8d 7d e0 ab ab ab ab 8d ?? ?? 8d ?? ?? 50 8d ?? ?? e8 ?? ?? ?? ?? ff ?? ?? 8b ?? ff ?? ?? 50 e8 } //2
	condition:
