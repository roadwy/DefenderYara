...
rule Ransom_Win32_Phobos_PA_MTB{
	...
	strings :
		$a_02_0 = {0f b7 54 24 12 03 56 08 57 52 53 e8 90 01 03 ff 83 c4 0c 8d 6e 0c 55 ff 15 90 01 03 00 e8 90 01 03 ff 84 c0 74 90 01 01 8b 44 24 24 50 53 6a 00 6a 00 89 38 8b 46 04 6a 00 50 ff 15 90 01 03 00 85 c0 75 90 00 } //20
