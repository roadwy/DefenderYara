...
rule Ransom_Win32_StopCrypt_PBM_MTB{
	...
	strings :
		$a_03_0 = {8d 04 3b 33 44 24 90 01 01 33 c1 81 3d 90 02 08 89 44 24 90 01 01 75 90 00 } //3
		$a_03_1 = {8d 04 3b 33 44 24 90 01 01 33 c1 83 3d 90 02 08 89 44 24 90 01 01 75 90 00 } //3
