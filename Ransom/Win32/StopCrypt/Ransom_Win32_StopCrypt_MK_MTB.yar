...
rule Ransom_Win32_StopCrypt_MK_MTB{
	...
	strings :
		$a_03_0 = {8b 45 70 89 45 90 02 01 8b 85 b0 fe ff ff 01 45 90 1b 00 8b 7d 70 8b 4d 6c 33 5d 90 1b 00 d3 ef c7 05 90 02 08 03 bd a4 fe ff ff 33 fb 81 3d 90 02 06 00 00 75 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule Ransom_Win32_StopCrypt_MK_MTB_2{
	...
	strings :
		$a_03_0 = {8b c8 c1 e1 90 02 01 03 8d 90 02 02 ff ff 81 3d 90 02 06 00 00 90 13 8b 5d 90 02 01 03 d8 c1 e8 90 02 01 89 45 90 02 01 c7 05 90 02 08 8b 85 90 02 02 ff ff 01 45 90 02 01 81 3d 90 02 06 00 00 75 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
