...
rule Ransom_Win32_StopCrypt_MK_MTB_3{
	...
	strings :
		$a_81_0 = {65 6e 63 72 79 70 74 69 6f 6e 77 69 6e 61 70 69 5c 53 61 6c 73 61 32 30 2e 69 6e 6c } //01 00  encryptionwinapi\Salsa20.inl
		$a_81_1 = {62 6f 77 73 61 6b 6b 64 65 73 74 78 2e 74 78 74 } //01 00  bowsakkdestx.txt
		$a_81_2 = {43 3a 5c 53 79 73 74 65 6d 49 44 5c 50 65 72 73 6f 6e 61 6c 49 44 2e 74 78 74 } //01 00  C:\SystemID\PersonalID.txt
		$a_81_3 = {54 69 6d 65 20 54 72 69 67 67 65 72 20 54 61 73 6b } //01 00  Time Trigger Task
		$a_81_4 = {54 72 69 67 67 65 72 31 } //01 00  Trigger1
		$a_81_5 = {2d 2d 41 75 74 6f 53 74 61 72 74 } //01 00  --AutoStart
		$a_81_6 = {64 65 6c 73 65 6c 66 2e 62 61 74 } //01 00  delself.bat
		$a_81_7 = {65 78 70 61 6e 64 20 33 32 2d 62 79 74 65 20 6b } //00 00  expand 32-byte k
	condition:
		any of ($a_*)
