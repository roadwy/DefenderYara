...
rule Ransom_Win32_StopCrypt_MPK_MTB{
	...
	strings :
		...
		$a_03_3 = {d3 e0 89 45 f8 8b 45 d0 01 45 f8 8b 4d d4 8b c3 c1 e8 90 02 01 89 45 f4 8d 45 f4 90 00 } //1
		$a_03_4 = {d3 e0 89 45 f8 8b 45 d0 01 45 f8 8b 4d d4 8b c2 c1 e8 90 02 01 89 45 f4 8d 45 f4 90 00 } //1
		$a_03_5 = {d3 e0 89 45 fc 8b 45 d4 01 45 fc 8b 4d d8 8b c2 c1 e8 90 02 01 89 45 f8 8d 45 f8 90 00 } //1
	condition:
