...
rule Ransom_Win32_StopCrypt_SK_MTB{
	...
	strings :
		$a_03_0 = {8d 0c 1f 33 4d 90 01 01 89 35 90 01 04 33 4d 90 01 01 89 4d 90 01 01 8b 45 90 00 } //1
		$a_03_1 = {8b ec 8b 45 90 01 01 8b 4d 90 01 01 31 08 5d 90 00 } //1
	condition:
...
rule Ransom_Win32_StopCrypt_SK_MTB_2{
	...
	strings :
		...
		$a_02_1 = {f7 65 b0 8b 45 b0 81 45 0c 90 01 04 81 ad fc fe ff ff 90 01 04 81 45 bc 90 01 04 8b 85 80 00 00 00 30 0c 30 b8 01 00 00 00 83 f0 04 83 ad 80 00 00 00 01 39 bd 80 00 00 00 0f 8d 90 01 02 ff ff 90 00 } //2
	condition:
