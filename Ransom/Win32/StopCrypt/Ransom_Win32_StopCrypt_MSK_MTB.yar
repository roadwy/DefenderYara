...
rule Ransom_Win32_StopCrypt_MSK_MTB{
	...
	strings :
		...
		$a_03_1 = {33 74 24 0c 8b 44 24 08 89 30 5e c2 08 00 33 44 24 04 c2 04 00 81 00 90 02 04 c3 90 00 } //1
	condition:
...
rule Ransom_Win32_StopCrypt_MSK_MTB_2{
	...
	strings :
		$a_03_0 = {8b 55 f4 c1 e2 90 02 01 89 55 e4 8b 45 f8 01 45 e4 8b 45 f4 03 45 e8 89 45 f0 c7 05 90 02 08 c7 05 90 02 04 ff ff ff ff 8b 45 f4 8b 8d 40 ff ff ff d3 e8 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
