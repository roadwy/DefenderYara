...
rule Ransom_Win32_Reveton_gen_A{
	...
	strings :
		...
		$a_03_4 = {8b ce ba 01 00 00 00 d3 e2 4a 23 54 24 28 0f b7 4c 24 42 03 d1 8b 4c 24 34 8b 14 91 89 54 24 40 e9 ?? ?? ff ff 8b 04 24 c7 40 18 ?? ?? ?? ?? 8b 44 24 04 c7 00 12 00 00 00 eb ?? f7 c6 40 00 00 00 75 ?? 8b ce ba 01 00 00 00 d3 e2 4a 23 54 24 28 0f b7 44 24 42 03 d0 8b 4c 24 30 8b 14 91 89 54 24 40 } //5
	condition:
