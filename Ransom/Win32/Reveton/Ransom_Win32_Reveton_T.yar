...
rule Ransom_Win32_Reveton_T{
	meta:
		description = "Ransom:Win32/Reveton.T,SIGNATURE_TYPE_PEHSTR_EXT,0c 00 0c 00 03 00 00 0a 00 "
	...
	strings :
		...
		$a_01_1 = {52 55 4e 44 4c 4c 33 32 2e 45 58 45 00 00 00 00 ff ff ff ff 0d 00 00 00 72 65 67 6d 6f 6e 73 74 64 2e 6c 6e 6b } //01 00 
