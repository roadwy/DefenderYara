...
rule Ransom_Win32_Reveton_D{
	...
	strings :
		$a_03_0 = {6a 00 68 38 01 00 00 8d 85 ac fe ff ff 50 53 e8 90 01 04 40 0f 84 90 01 04 6a 00 68 00 01 00 00 8d 85 ac fd ff ff 50 53 e8 90 01 04 3d 00 01 00 00 90 00 } //1
