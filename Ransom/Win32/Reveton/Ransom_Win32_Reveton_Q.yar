...
rule Ransom_Win32_Reveton_Q{
	...
	strings :
		$a_03_0 = {8d 93 00 05 00 00 e8 90 01 04 a1 90 01 04 8a 93 00 06 00 00 88 10 a1 90 01 04 8a 93 01 06 00 00 88 10 a1 90 01 04 8b 93 02 06 00 00 89 10 90 00 } //2
