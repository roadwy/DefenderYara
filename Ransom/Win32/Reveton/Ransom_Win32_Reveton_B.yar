...
rule Ransom_Win32_Reveton_B{
	...
	strings :
		...
		$a_01_6 = {5c 53 45 4e 53 5c 50 61 72 61 6d 65 74 65 72 73 5c 53 65 72 76 69 63 65 44 6c 6c 00 } //01 00 
		...
		$a_01_11 = {53 42 72 6f 77 73 65 72 20 2d 20 } //01 00 
		$a_01_12 = {53 74 61 72 74 65 72 20 4f 4b 20 4e 61 6d 65 3a 20 } //00 00 
	condition:
		any of ($a_*)
