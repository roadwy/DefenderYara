...
rule Ransom_Win32_Reveton_AA{
	...
	strings :
		...
		$a_03_1 = {64 65 66 61 75 6c 74 58 31 00 90 01 0a 5c 73 79 73 74 65 6d 33 32 5c 72 75 6e 64 6c 6c 33 32 2e 65 78 65 90 00 } //1
		$a_03_2 = {a7 02 00 00 6a 00 6a 04 8d 45 90 01 01 50 53 e8 90 01 04 40 0f 84 90 09 03 00 c7 90 00 } //10
	condition:
