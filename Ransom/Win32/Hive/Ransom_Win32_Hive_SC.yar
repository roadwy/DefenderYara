...
rule Ransom_Win32_Hive_SC{
	...
	strings :
		...
		$a_02_1 = {5c 00 6e 00 65 00 74 00 6c 00 6f 00 67 00 6f 00 6e 00 5c 00 79 00 79 00 79 00 2e 00 64 00 6c 00 6c 00 90 02 10 2d 00 75 00 90 02 30 3a 00 90 00 } //100
	condition:
