...
rule Ransom_Win32_Wyverlock_PA_MTB{
	...
	strings :
		$a_00_0 = {78 69 65 6e 76 6b 64 6f 63 } //01 00 
		$a_00_1 = {64 65 73 6b 74 6f 70 2e 69 6e 69 } //01 00 
		$a_00_2 = {61 75 74 6f 72 75 6e 2e 69 6e 66 } //01 00 
		$a_00_3 = {54 6f 72 20 42 72 6f 77 73 65 72 } //05 00 
		$a_00_4 = {5f 52 45 41 44 5f 4d 45 5f 2e 74 78 74 } //05 00 
