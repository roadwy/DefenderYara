...
rule Ransom_Win32_Avaddon_AA_MTB{
	meta:
		description = "Ransom:Win32/Avaddon.AA!MTB,SIGNATURE_TYPE_PEHSTR,05 00 05 00 06 00 00 01 00 "
	...
	strings :
		...
		$a_01_3 = {31 5c 42 49 4e 5c 67 6d 2e 65 78 65 } //01 00  1\BIN\gm.exe
		$a_01_4 = {5c 58 4d 65 64 43 6f 6e 5c 62 69 6e 5c 6d 65 64 63 6f 6e 2e 65 78 65 } //01 00  \XMedCon\bin\medcon.exe
		$a_01_5 = {3c 70 3e 44 6f 20 6e 6f 74 20 74 72 79 20 74 6f 20 72 65 63 6f 76 65 72 20 66 69 6c 65 73 20 79 6f 75 72 73 65 6c 66 21 3c 2f 70 3e } //00 00  <p>Do not try to recover files yourself!</p>
