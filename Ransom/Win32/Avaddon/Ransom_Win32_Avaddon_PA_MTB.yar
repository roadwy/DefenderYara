...
rule Ransom_Win32_Avaddon_PA_MTB{
	meta:
		description = "Ransom:Win32/Avaddon.PA!MTB,SIGNATURE_TYPE_PEHSTR,05 00 05 00 05 00 00 01 00 "
	...
	strings :
		...
		$a_01_3 = {31 5c 42 49 4e 5c 25 73 2e 65 78 65 } //01 00  1\BIN\%s.exe
		$a_01_4 = {5c 58 4d 65 64 43 6f 6e 5c 62 69 6e 5c 6d 65 64 63 6f 6e 2e 65 78 65 } //00 00  \XMedCon\bin\medcon.exe
