...
rule Ransom_Win32_Lorenz_MAK_MTB{
	...
	strings :
		$a_03_0 = {52 45 47 20 41 44 44 20 22 48 4b 45 59 5f 55 53 45 52 53 5c [0-05] 5c 43 6f 6e 74 72 6f 6c 20 50 61 6e 65 6c 5c 44 65 73 6b 74 6f 70 22 20 2f 56 20 57 61 6c 6c 70 61 70 65 72 20 2f 54 20 52 45 47 5f 53 5a 20 2f 46 20 2f 44 } //1
		...
		$a_03_4 = {68 74 74 70 3a 2f 2f 6c 6f 72 65 6e 7a [0-35] 2e 6f 6e 69 6f 6e } //1
	condition:
