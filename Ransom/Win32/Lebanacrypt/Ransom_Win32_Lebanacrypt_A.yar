...
rule Ransom_Win32_Lebanacrypt_A{
	...
	strings :
		...
		$a_03_8 = {bb e0 07 8e c3 8e db b8 16 02 b9 02 00 b6 00 bb 00 00 cd 13 31 c0 89 c3 89 c1 89 c2 be 00 00 bf ?? ?? ac 81 fe ?? ?? 73 31 3c 80 73 02 eb 0f } //5
		$a_03_9 = {b9 00 20 00 00 f3 a5 5f 5e 6a 00 8d 45 ?? 50 68 00 80 00 00 8d 85 ?? ?? ff ff 50 53 e8 } //5
