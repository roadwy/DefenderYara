...
rule Ransom_Win32_Sagecrypt_A_{
	meta:
		description = "Ransom:Win32/Sagecrypt.A!!Sagecrypt.gen!A,SIGNATURE_TYPE_ARHSTR_EXT,0a 00 0a 00 13 00 00 "
		
	strings :
		$a_01_0 = {32 51 ff 83 c3 01 88 53 ff } //2
		$a_03_1 = {52 74 20 a1 90 01 04 8b 98 90 01 02 00 00 ff 90 90 90 01 01 00 00 00 c7 44 24 04 00 00 00 00 89 04 24 ff d3 90 00 } //2
		...
		$a_03_5 = {43 00 3a 00 8b 7d 08 c7 45 90 01 01 5c 00 00 00 eb 11 90 00 } //2
		$a_03_6 = {66 83 3b 57 0f 85 90 01 01 00 00 00 66 83 7b 02 53 75 7b 66 83 7b 04 2d 90 00 } //2
		$a_03_7 = {0f 45 d9 8b 92 90 01 02 00 00 89 5c 24 18 c7 44 24 14 00 00 00 00 c7 44 24 10 00 00 00 00 c7 44 24 0c 00 00 00 00 89 44 24 08 c7 44 24 04 50 41 f3 5c 89 3c 24 ff d2 90 00 } //3
