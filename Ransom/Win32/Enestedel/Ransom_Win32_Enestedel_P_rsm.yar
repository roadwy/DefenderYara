...
rule Ransom_Win32_Enestedel_P_rsm{
	...
	strings :
		...
		$a_03_2 = {6a 50 6a 03 90 01 01 6a 01 68 00 00 00 80 68 90 02 02 00 10 ff 90 00 } //100
		$a_03_3 = {00 10 0f be 0d 90 09 05 00 0f bf 05 90 00 } //10
		$a_03_4 = {00 10 0f bf 0d 90 09 05 00 0f be 05 90 00 } //10
		$a_03_5 = {00 10 0f be 05 90 09 05 00 0f be 0d 90 00 } //10
	condition:
