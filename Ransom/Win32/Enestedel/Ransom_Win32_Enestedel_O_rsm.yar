...
rule Ransom_Win32_Enestedel_O_rsm{
	...
	strings :
		...
		$a_03_3 = {00 10 0f bf 15 90 09 05 00 0f bf 0d 90 00 } //10
	condition:
...
rule Ransom_Win32_Enestedel_O_rsm_2{
	...
	strings :
		$a_03_0 = {83 fa 62 75 09 83 f9 0b 75 04 89 6c 24 90 01 01 0f be b0 02 00 40 00 83 fe 47 75 0e 83 fa 46 75 09 83 f9 0b 75 04 89 6c 24 90 01 01 83 fe 52 75 0d 80 b8 06 00 40 00 46 90 00 } //2
