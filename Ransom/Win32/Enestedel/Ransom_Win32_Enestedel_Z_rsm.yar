...
rule Ransom_Win32_Enestedel_Z_rsm{
	...
	strings :
		...
		$a_03_3 = {00 10 0f bf 0d 90 09 05 00 0f 90 04 01 02 be bf 15 } //10
		$a_03_4 = {00 10 0f bf 15 90 09 05 00 0f 90 04 01 02 be bf 0d } //10
		$a_03_5 = {00 10 0f be 2d 90 09 05 00 0f 90 04 01 02 be bf 15 } //10
		$a_03_6 = {00 10 0f be 0d 90 09 05 00 0f 90 04 01 02 be bf 05 } //10
		$a_03_7 = {00 10 0f be 15 90 09 05 00 0f 90 04 01 02 be bf 0d } //10
	condition:
