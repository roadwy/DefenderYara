...
rule Ransom_Win32_FileCryptor_G_MTB{
	...
	strings :
		$a_02_0 = {45 6e 63 6f 64 65 72 3a 20 25 73 90 02 20 25 73 2e 6c 6f 63 6b 90 00 } //1
		$a_02_1 = {45 6e 63 6f 64 65 72 20 90 02 20 20 53 74 61 72 74 90 00 } //1
		$a_00_2 = {46 69 6e 64 46 69 72 73 74 46 69 6c 65 41 } //1 FindFirstFileA
		$a_02_3 = {44 6f 63 75 6d 65 6e 74 73 20 61 6e 64 20 53 65 74 74 69 6e 67 73 90 02 30 65 6d 70 74 79 2e 6c 6f 63 6b 90 00 } //1
