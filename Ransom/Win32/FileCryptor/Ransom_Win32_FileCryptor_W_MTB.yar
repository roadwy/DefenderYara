...
rule Ransom_Win32_FileCryptor_W_MTB{
	...
	strings :
		...
		$a_02_1 = {2a 00 2e 00 74 00 78 00 74 00 90 02 2f 2a 00 2e 00 6f 00 64 00 74 00 90 02 2f 2a 00 2e 00 77 00 70 00 73 00 90 00 } //1
		$a_02_2 = {2a 2e 74 78 74 90 02 2f 2a 2e 6f 64 74 90 02 2f 2a 2e 77 70 73 90 00 } //1
