...
rule Ransom_Win32_FileCryptor_W_MTB{
	...
	strings :
		$a_81_0 = {5c 53 4f 46 54 57 41 52 45 5c 4c 75 63 79 } //01 00 
		...
		$a_81_3 = {43 72 79 70 74 6f 6c 6f 63 6b 65 72 } //01 00 
		$a_81_4 = {2e 45 6e 63 6f 64 65 } //01 00 
		$a_81_5 = {46 69 6c 65 2e 4c 75 73 79 } //01 00 
		$a_81_6 = {44 43 50 63 72 79 70 74 } //01 00 
		$a_81_7 = {44 43 50 62 61 73 65 36 34 } //00 00 
	condition:
		any of ($a_*)
