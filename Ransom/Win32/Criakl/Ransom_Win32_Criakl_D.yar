...
rule Ransom_Win32_Criakl_D{
	...
	strings :
		$a_01_0 = {7d 7b 45 4e 43 52 59 50 54 45 4e 44 45 44 7d 00 } //01 00  筽久剃偙䕔䑎䑅}
		$a_01_1 = {7b 42 4c 4f 43 4b 53 53 54 41 52 54 7d 00 } //01 00  䉻佌䭃卓䅔呒}
		$a_01_2 = {2e 72 61 6e 64 6f 6d 6e 61 6d 65 2d 00 } //01 00 
		$a_01_3 = {7b 42 4c 4f 43 4b 53 45 4e 44 7d 00 } //02 00  䉻佌䭃䕓䑎}
