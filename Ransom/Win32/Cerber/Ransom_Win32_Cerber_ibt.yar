...
rule Ransom_Win32_Cerber_ibt{
	...
	strings :
		$a_00_0 = {52 61 74 6c 69 6e 2e 53 56 4d 66 } //01 00 
		$a_00_1 = {46 75 6b 6b 58 4d 45 6e } //01 00 
		$a_00_2 = {52 4d 74 50 4d 71 2e 4c 42 4d 66 68 46 75 6b 6b 58 4d 45 6e } //01 00 
		$a_00_3 = {48 72 65 46 74 66 46 69 6d 43 41 } //01 00 
