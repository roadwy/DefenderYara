...
rule Ransom_Win32_Cerber_A{
	...
	strings :
		$a_00_0 = {43 72 79 70 74 45 6e 63 72 79 70 74 } //01 00 
		$a_00_1 = {43 72 79 70 74 49 6d 70 6f 72 74 50 75 62 6c 69 63 4b 65 79 49 6e 66 6f } //03 00 
		$a_00_2 = {4b 00 65 00 79 00 73 00 69 00 7a 00 65 00 3a 00 20 00 25 00 64 00 2c 00 20 00 45 00 6e 00 63 00 72 00 79 00 70 00 74 00 69 00 6f 00 6e 00 20 00 74 00 69 00 6d 00 65 00 3a 00 20 00 25 00 64 00 } //02 00 
		$a_00_3 = {54 00 6f 00 74 00 61 00 6c 00 20 00 66 00 69 00 6c 00 65 00 73 00 20 00 66 00 6f 00 75 00 6e 00 64 00 3a 00 20 00 25 00 64 00 2c 00 20 00 46 00 69 00 6c 00 65 00 73 00 20 00 63 00 72 00 79 00 70 00 74 00 65 00 64 00 3a 00 20 00 25 00 64 00 } //02 00 
...
rule Ransom_Win32_Cerber_A_2{
	...
	strings :
		...
		$a_00_9 = {4c 6f 63 61 6c 20 70 72 69 76 61 74 65 2e 6b 65 79 20 66 69 6c 65 20 66 6f 75 6e 64 } //00 00 
