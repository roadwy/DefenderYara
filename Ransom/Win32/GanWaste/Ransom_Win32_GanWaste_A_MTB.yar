...
rule Ransom_Win32_GanWaste_A_MTB{
	...
	strings :
		...
		$a_03_1 = {8a 16 32 d0 4f 88 11 74 90 01 01 8b d0 c1 ea 08 32 56 01 88 51 01 4f 74 90 01 01 c1 e8 10 32 46 02 88 41 02 5f c3 90 00 } //1
		$a_03_2 = {8a 1f 4d 8a d3 47 e8 90 01 04 0f b6 c8 0f b6 d3 83 e1 0f c1 ea 04 33 ca c1 e8 04 33 04 8e 85 ed 75 90 00 } //1
	condition:
