...
rule Ransom_Win32_Betisrypt_A__2{
	...
	strings :
		$a_00_0 = {5c 00 48 00 45 00 4c 00 50 00 2e 00 68 00 74 00 61 00 } //0a 00 
		$a_00_1 = {44 00 45 00 43 00 52 00 59 00 50 00 54 00 49 00 4e 00 46 00 4f 00 } //0a 00 
		$a_00_2 = {4e 00 55 00 43 00 4c 00 45 00 41 00 52 00 } //0a 00 
		$a_00_3 = {2f 00 63 00 20 00 76 00 73 00 73 00 61 00 64 00 6d 00 69 00 6e 00 2e 00 65 00 78 00 65 00 20 00 44 00 65 00 6c 00 65 00 74 00 65 00 20 00 53 00 68 00 61 00 64 00 6f 00 77 00 73 00 20 00 2f 00 41 00 6c 00 6c 00 20 00 2f 00 51 00 75 00 69 00 65 00 74 00 } //0a 00 
		$a_00_4 = {2f 00 63 00 20 00 62 00 63 00 64 00 65 00 64 00 69 00 74 00 2e 00 65 00 78 00 65 00 20 00 2f 00 73 00 65 00 74 00 20 00 7b 00 64 00 65 00 66 00 61 00 75 00 6c 00 74 00 7d 00 20 00 72 00 65 00 63 00 6f 00 76 00 65 00 72 00 79 00 65 00 6e 00 61 00 62 00 6c 00 65 00 64 00 20 00 4e 00 6f 00 } //0a 00 
		$a_00_5 = {2f 00 63 00 20 00 62 00 63 00 64 00 65 00 64 00 69 00 74 00 2e 00 65 00 78 00 65 00 20 00 2f 00 73 00 65 00 74 00 20 00 7b 00 64 00 65 00 66 00 61 00 75 00 6c 00 74 00 7d 00 20 00 62 00 6f 00 6f 00 74 00 73 00 74 00 61 00 74 00 75 00 73 00 70 00 6f 00 6c 00 69 00 63 00 79 00 20 00 69 00 67 00 6e 00 6f 00 72 00 65 00 61 00 6c 00 6c 00 66 00 61 00 69 00 6c 00 75 00 72 00 65 00 73 00 } //0a 00 
		$a_00_6 = {6e 6f 63 74 75 72 6e 61 6c 6e 6f 63 74 75 72 6e 61 6c 6e 6f 63 74 75 72 6e 61 6c 6e 6f 63 74 75 72 6e 61 6c } //05 00 
	condition:
		any of ($a_*)
