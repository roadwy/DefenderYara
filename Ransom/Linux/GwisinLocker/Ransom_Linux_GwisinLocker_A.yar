...
rule Ransom_Linux_GwisinLocker_A{
	...
	strings :
		$a_01_0 = {2f 74 6d 70 2f 2e 36 36 34 38 36 66 30 34 2d 62 66 32 34 2d 34 66 35 65 2d 61 65 31 36 2d 30 61 } //01 00  /tmp/.66486f04-bf24-4f5e-ae16-0a
		$a_01_1 = {66 30 66 64 62 33 64 38 66 65 } //06 00  f0fdb3d8fe
