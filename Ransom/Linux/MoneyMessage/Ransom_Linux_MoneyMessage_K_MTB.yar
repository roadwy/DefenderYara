...
rule Ransom_Linux_MoneyMessage_K_MTB{
	...
	strings :
		...
		$a_00_3 = {63 72 79 70 74 5f 6f 6e 6c 79 5f 74 68 65 73 65 5f 64 69 72 65 63 74 6f 72 69 65 73 } //1 crypt_only_these_directories
		$a_00_4 = {6d 6f 6e 65 79 70 75 6e 63 74 5f 62 79 6e 61 6d 65 } //1 moneypunct_byname
	condition:
