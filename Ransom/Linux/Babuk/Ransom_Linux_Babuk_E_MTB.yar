...
rule Ransom_Linux_Babuk_E_MTB{
	...
	strings :
		...
		$a_01_1 = {2f 70 61 74 68 2f 74 6f 2f 62 65 2f 65 6e 63 72 79 70 74 65 64 } //01 00 
		$a_01_2 = {62 65 73 74 77 61 79 34 75 40 6d 61 69 6c 66 65 6e 63 65 2e 63 6f 6d } //01 00 
		$a_01_3 = {62 65 73 74 77 61 79 34 75 40 6f 6e 69 6f 6e 6d 61 69 6c 2e 63 6f 6d } //01 00 
		$a_01_4 = {43 79 6c 61 6e 63 65 20 52 61 6e 73 6f 6d 77 61 72 65 } //00 00 
	condition:
		any of ($a_*)
