...
rule Ransom_Linux_Babuk_B_MTB{
	...
	strings :
		...
		$a_01_1 = {2e 76 6d 64 6b } //01 00  .vmdk
		$a_01_2 = {2e 76 73 77 70 } //01 00  .vswp
		$a_01_3 = {45 6e 63 72 79 70 74 65 64 20 66 69 6c 65 73 3a } //01 00  Encrypted files:
		$a_01_4 = {53 6b 69 70 70 65 64 20 66 69 6c 65 73 3a } //00 00  Skipped files:
	condition:
		any of ($a_*)
