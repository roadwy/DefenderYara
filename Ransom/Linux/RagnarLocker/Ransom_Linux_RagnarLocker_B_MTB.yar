...
rule Ransom_Linux_RagnarLocker_B_MTB{
	...
	strings :
		$a_00_0 = {2e 52 45 41 44 4d 45 5f 54 4f 5f 52 45 53 54 4f 52 45 } //01 00 
		$a_00_1 = {46 69 6c 65 20 4c 6f 63 6b 65 64 3a 25 73 20 50 49 44 3a 25 64 } //01 00 
		$a_00_2 = {2e 63 72 79 70 74 65 64 } //01 00 
		$a_00_3 = {77 72 6b 6d 61 6e 2e 6c 6f 67 } //01 00 
		$a_00_4 = {55 73 61 67 65 3a 25 73 20 5b 2d 6d 20 28 31 30 2d 32 30 2d 32 35 2d 33 33 2d 35 30 29 20 5d 20 53 74 61 72 74 20 50 61 74 68 } //01 00 
