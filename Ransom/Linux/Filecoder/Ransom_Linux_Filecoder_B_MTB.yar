...
rule Ransom_Linux_Filecoder_B_MTB{
	...
	strings :
		$a_00_0 = {21 4e 45 57 53 5f 46 4f 52 5f 53 54 4a 21 2e 74 78 74 } //01 00  !NEWS_FOR_STJ!.txt
		$a_00_1 = {2e 73 74 6a 38 38 38 } //01 00  .stj888
		$a_00_2 = {59 6f 75 72 20 66 69 6c 65 73 20 61 72 65 20 66 75 6c 6c 79 20 43 52 59 50 54 45 44 } //01 00  Your files are fully CRYPTED
		$a_00_3 = {67 5f 52 61 6e 73 6f 6d 48 65 61 64 65 72 } //01 00  g_RansomHeader
		$a_00_4 = {21 4e 4f 54 49 43 45 5f 46 4f 52 5f 50 45 54 52 41 4d 49 4e 41 21 2e 74 58 74 } //01 00  !NOTICE_FOR_PETRAMINA!.tXt
		$a_00_5 = {2e 70 33 74 72 34 6d 31 6e 34 } //01 00  .p3tr4m1n4
		$a_00_6 = {65 6e 63 72 79 70 74 5f 77 6f 72 6b 65 72 } //01 00  encrypt_worker
