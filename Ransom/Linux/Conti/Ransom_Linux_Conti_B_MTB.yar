...
rule Ransom_Linux_Conti_B_MTB{
	...
	strings :
		...
		$a_00_1 = {45 6e 74 72 61 6e 64 6f 20 61 20 72 75 74 61 3a 20 25 73 } //01 00 
		$a_00_2 = {2d 2d 49 6e 69 63 69 61 6e 64 6f 20 45 6e 63 72 69 70 74 61 63 69 6f 6e 2d 2d } //01 00 
