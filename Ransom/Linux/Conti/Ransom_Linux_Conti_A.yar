...
rule Ransom_Linux_Conti_A{
	...
	strings :
		$a_00_0 = {4d 49 49 43 43 41 4b 43 41 67 45 41 39 66 41 33 75 76 4d 73 53 42 56 30 70 57 75 39 66 56 59 4e 63 38 7a 58 48 42 65 35 6d 41 44 61 4a 35 39 64 65 65 63 63 61 43 42 41 67 59 35 54 } //01 00 
		$a_00_1 = {2d 2d 76 6d 6b 69 6c 6c 65 72 } //01 00 
		$a_00_2 = {2d 2d 70 72 6f 63 6b 69 6c 6c 65 72 } //01 00 
		$a_00_3 = {70 61 72 65 6d 65 74 65 72 20 2d 2d 73 69 7a 65 20 63 61 6e 6e 6f 74 20 62 65 20 25 64 } //02 00 
		$a_00_4 = {41 6c 6c 20 6f 66 20 79 6f 75 72 20 66 69 6c 65 73 20 61 72 65 20 63 75 72 72 65 6e 74 6c 79 20 65 6e 63 72 79 70 74 65 64 20 62 79 20 43 4f 4e 54 49 20 73 74 72 61 69 6e } //01 00 
