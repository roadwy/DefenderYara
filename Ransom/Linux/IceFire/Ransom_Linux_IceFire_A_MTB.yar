...
rule Ransom_Linux_IceFire_A_MTB{
	...
	strings :
		$a_00_0 = {2f 69 46 69 72 65 2d 72 65 61 64 6d 65 2e 74 78 74 } //01 00  /iFire-readme.txt
		$a_00_1 = {2e 69 46 69 72 65 } //01 00  .iFire
		$a_00_2 = {2e 2f 62 6f 6f 74 2e 2f 64 65 76 2e 2f 65 74 63 2e 2f 6c 69 62 2e 2f 70 72 6f 63 2e 2f 73 72 76 2e 2f 73 79 73 2e 2f 75 73 72 2e 2f 76 61 72 2e 2f 72 75 6e } //01 00  ./boot./dev./etc./lib./proc./srv./sys./usr./var./run
