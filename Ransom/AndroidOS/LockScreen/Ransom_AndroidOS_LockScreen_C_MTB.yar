...
rule Ransom_AndroidOS_LockScreen_C_MTB{
	...
	strings :
		...
		$a_00_2 = {6d 61 6d 61 64 31 37 6d } //01 00  mamad17m
		$a_00_3 = {67 65 74 53 79 73 74 65 6d 53 65 72 76 69 63 65 28 22 6c 61 79 6f 75 74 5f 69 6e 66 6c 61 74 65 72 } //00 00  getSystemService("layout_inflater
	condition:
		any of ($a_*)
