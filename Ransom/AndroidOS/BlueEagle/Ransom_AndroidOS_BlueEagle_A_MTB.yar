...
rule Ransom_AndroidOS_BlueEagle_A_MTB{
	...
	strings :
		...
		$a_03_1 = {0a 05 2b 05 90 01 02 00 00 d8 05 06 0a 01 46 01 5a 07 05 01 a0 2b 00 90 01 02 00 00 98 00 07 08 1a 01 7b 00 07 51 d8 00 00 ff df 04 00 20 32 62 90 01 02 49 00 01 02 95 05 0b 04 b7 05 d8 0b 0b 01 d8 00 02 01 8e 55 50 05 01 02 01 02 28 f1 90 00 } //10
	condition:
