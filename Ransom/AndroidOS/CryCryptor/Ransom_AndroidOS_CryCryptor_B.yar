...
rule Ransom_AndroidOS_CryCryptor_B{
	...
	strings :
		...
		$a_00_2 = {2f 72 65 61 64 6d 65 } //01 00 
		$a_00_3 = {55 6e 6c 6f 63 6b 65 64 2e 20 50 65 72 73 6f 6e 61 6c 20 66 69 6c 65 73 20 64 65 63 72 79 70 74 65 64 } //01 00 
		$a_00_4 = {2e 65 6e 63 } //00 00 
	condition:
		any of ($a_*)
