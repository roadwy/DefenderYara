...
rule Ransom_AndroidOS_SauranLocker_A{
	...
	strings :
		$a_00_0 = {2e 65 6e 63 72 79 70 74 65 64 } //01 00 
		$a_00_1 = {7b 7b 57 41 4c 4c 45 54 7d 7d } //01 00 
		$a_00_2 = {2f 67 61 74 65 77 61 79 2f 61 74 74 61 63 68 2e 70 68 70 3f 75 69 64 3d } //01 00 
