...
rule Ransom_MSIL_CryptJoker_ARA_MTB{
	...
	strings :
		...
		$a_81_1 = {43 72 79 70 74 6f 4a 6f 6b 65 72 4d 65 73 73 61 67 65 } //03 00 
		$a_81_2 = {52 61 6e 73 6f 6d 77 61 72 65 } //03 00 
		$a_81_3 = {42 69 74 63 6f 69 6e 41 64 72 65 73 73 } //00 00 
	condition:
		any of ($a_*)
