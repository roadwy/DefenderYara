...
rule Ransom_MSIL_WannaCrypt_DC_MTB{
	...
	strings :
		...
		$a_81_1 = {45 6e 63 72 79 70 74 65 64 20 46 69 6c 65 73 } //01 00  Encrypted Files
		$a_81_2 = {43 72 79 2e 69 6d 67 } //01 00  Cry.img
		$a_81_3 = {40 74 6f 75 74 75 74 61 2e 63 6f 6d } //00 00  @toututa.com
	condition:
		any of ($a_*)
