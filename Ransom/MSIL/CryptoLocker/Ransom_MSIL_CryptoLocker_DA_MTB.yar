...
rule Ransom_MSIL_CryptoLocker_DA_MTB{
	...
	strings :
		...
		$a_81_3 = {72 61 6e 73 6f 6d 77 61 72 65 } //00 00  ransomware
	condition:
		any of ($a_*)
...
rule Ransom_MSIL_CryptoLocker_DA_MTB_2{
	...
	strings :
		$a_81_0 = {72 61 6e 73 6f 6d 77 61 72 65 2e 65 78 65 } //01 00  ransomware.exe
		...
		$a_81_3 = {50 61 73 73 77 6f 72 64 } //01 00  Password
		$a_81_4 = {31 32 33 34 35 36 } //00 00  123456
	condition:
		any of ($a_*)
