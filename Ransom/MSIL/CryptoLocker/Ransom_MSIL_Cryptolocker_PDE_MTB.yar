...
rule Ransom_MSIL_Cryptolocker_PDE_MTB{
	...
	strings :
		$a_81_0 = {4b 34 4b 72 61 6e 73 6f 6d } //01 00 
		$a_81_1 = {43 72 65 61 74 65 45 6e 63 72 79 70 74 6f 72 } //01 00 
		$a_81_2 = {46 69 6c 65 45 6e 63 72 79 70 74 } //01 00 
		$a_81_3 = {45 6e 63 72 79 70 74 65 72 } //01 00 
		$a_81_4 = {53 74 61 6c 69 6e } //00 00 
	condition:
		any of ($a_*)
...
rule Ransom_MSIL_Cryptolocker_PDE_MTB_2{
	...
	strings :
		...
		$a_81_1 = {44 61 72 6b 20 52 61 6e 73 6f 6d 65 77 61 72 65 } //01 00 
		$a_81_2 = {50 6c 65 61 73 65 5f 52 65 61 64 2e 74 78 74 } //01 00 
		$a_81_3 = {40 6d 61 69 6c 2e 63 6f 6d } //00 00 
	condition:
		any of ($a_*)
