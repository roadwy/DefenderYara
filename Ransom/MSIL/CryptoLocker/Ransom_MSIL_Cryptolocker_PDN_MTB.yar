...
rule Ransom_MSIL_Cryptolocker_PDN_MTB{
	...
	strings :
		$a_81_0 = {69 6e 66 65 63 74 65 64 20 77 69 74 68 20 72 61 6e 73 6f 6d 77 61 72 65 } //1 infected with ransomware
		$a_81_1 = {45 6e 63 72 79 70 74 65 64 46 69 6c 65 4c 69 73 74 } //1 EncryptedFileList
...
rule Ransom_MSIL_Cryptolocker_PDN_MTB_2{
	...
	strings :
		...
		$a_81_2 = {2f 43 20 73 63 20 64 65 6c 65 74 65 20 56 53 53 } //1 /C sc delete VSS
	condition:
		((#a_81_0  & 1)*1+(#a_81_1  & 1)*1+(#a_81_2  & 1)*1) >=3
...
rule Ransom_MSIL_Cryptolocker_PDN_MTB_3{
	...
	strings :
		...
		$a_81_1 = {53 65 61 72 63 68 46 69 6c 65 73 } //1 SearchFiles
		$a_81_2 = {45 6e 63 72 79 70 74 } //1 Encrypt
		$a_81_3 = {47 65 6e 65 72 61 74 65 4b 65 79 } //1 GenerateKey
