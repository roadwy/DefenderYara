...
rule Ransom_MSIL_CryptoLocker_DE_MTB{
	...
	strings :
		$a_81_0 = {43 72 79 70 74 6f 4c 6f 63 6b 65 72 } //1 CryptoLocker
		$a_81_1 = {45 6e 63 72 79 70 74 65 64 } //1 Encrypted
		$a_81_2 = {2e 6c 6f 63 6b 65 64 } //1 .locked
		$a_81_3 = {46 69 6c 65 73 20 44 65 63 72 79 70 74 65 64 } //1 Files Decrypted
	condition:
...
rule Ransom_MSIL_CryptoLocker_DE_MTB_2{
	...
	strings :
		...
		$a_81_1 = {52 45 43 4f 56 45 52 5f 5f 46 49 4c 45 53 5f 5f 2e 6c 6f 63 6b 65 64 2e 74 78 74 } //1 RECOVER__FILES__.locked.txt
