...
rule Ransom_MSIL_Cryptolocker_PDQ_MTB{
	...
	strings :
		$a_81_0 = {57 68 61 74 20 68 61 70 70 65 6e 20 74 6f 20 6d 79 20 66 69 6c 65 73 } //1 What happen to my files
		$a_81_1 = {54 72 75 6d 70 4c 6f 63 6b 65 72 } //1 TrumpLocker
		$a_81_2 = {52 61 6e 73 6f 6d 4e 6f 74 65 } //1 RansomNote
	condition:
...
rule Ransom_MSIL_Cryptolocker_PDQ_MTB_2{
	...
	strings :
		$a_81_0 = {44 75 6d 6d 79 52 61 6e 73 6f 6d } //1 DummyRansom
...
rule Ransom_MSIL_Cryptolocker_PDQ_MTB_3{
	...
	strings :
		...
		$a_81_2 = {62 69 74 63 6f 69 6e 73 } //1 bitcoins
...
rule Ransom_MSIL_Cryptolocker_PDQ_MTB_4{
	...
	strings :
		$a_81_0 = {49 27 6d 20 72 75 6e 6e 69 6e 67 20 69 6e 20 44 65 62 75 67 20 6d 6f 64 65 } //1 I'm running in Debug mode
		$a_81_1 = {45 78 74 65 6e 73 69 6f 6e 73 54 6f 45 6e 63 72 79 70 74 } //1 ExtensionsToEncrypt
		$a_81_2 = {4a 69 67 73 61 77 52 61 6e 73 6f 6d 77 61 72 65 } //1 JigsawRansomware
	condition:
		((#a_81_0  & 1)*1+(#a_81_1  & 1)*1+(#a_81_2  & 1)*1) >=3
...
rule Ransom_MSIL_Cryptolocker_PDQ_MTB_5{
	...
	strings :
		...
		$a_81_1 = {2e 48 41 4e 54 41 } //1 .HANTA
		$a_81_2 = {42 54 43 20 77 61 6c 6c 65 74 3a } //1 BTC wallet:
	condition:
		((#a_81_0  & 1)*1+(#a_81_1  & 1)*1+(#a_81_2  & 1)*1) >=3
...
rule Ransom_MSIL_Cryptolocker_PDQ_MTB_6{
	...
	strings :
		$a_81_0 = {57 69 6e 33 32 5f 53 68 61 64 6f 77 43 6f 70 79 } //1 Win32_ShadowCopy
		$a_81_1 = {45 6e 63 72 79 70 74 65 64 46 69 6c 65 4e 61 6d 65 } //1 EncryptedFileName
		$a_81_2 = {45 6e 63 72 79 70 74 65 64 4b 65 79 } //1 EncryptedKey
		$a_81_3 = {43 6f 75 6c 64 20 6e 6f 74 20 64 65 6c 65 74 65 20 73 68 61 64 6f 77 20 63 6f 70 79 } //1 Could not delete shadow copy
		$a_81_4 = {4f 50 45 4e 5f 4d 45 5f 54 4f 5f 52 45 53 54 4f 52 45 } //1 OPEN_ME_TO_RESTORE
	condition:
