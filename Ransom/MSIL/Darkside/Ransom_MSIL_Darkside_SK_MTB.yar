...
rule Ransom_MSIL_Darkside_SK_MTB{
	meta:
		description = "Ransom:MSIL/Darkside.SK!MTB,SIGNATURE_TYPE_PEHSTR_EXT,03 00 03 00 03 00 00 01 00 "
	...
	strings :
		...
		$a_81_2 = {57 65 20 67 75 61 72 61 6e 74 65 65 20 74 6f 20 64 65 63 72 79 70 74 20 6f 6e 65 20 66 69 6c 65 20 66 6f 72 20 66 72 65 65 2e 20 47 6f 20 74 6f 20 74 68 65 20 73 69 74 65 20 61 6e 64 20 63 6f 6e 74 61 63 74 20 75 73 2e } //00 00  We guarantee to decrypt one file for free. Go to the site and contact us.
	condition:
		any of ($a_*)
