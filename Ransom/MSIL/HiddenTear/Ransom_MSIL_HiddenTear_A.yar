...
rule Ransom_MSIL_HiddenTear_A{
	...
	strings :
		...
		$a_01_1 = {68 00 74 00 74 00 70 00 73 00 3a 00 2f 00 2f 00 76 00 69 00 72 00 6f 00 2e 00 6d 00 6c 00 65 00 79 00 64 00 69 00 65 00 72 00 2e 00 66 00 72 00 2f 00 6e 00 6f 00 61 00 75 00 74 00 68 00 } //01 00  https://viro.mleydier.fr/noauth
