...
rule Ransom_MSIL_HiddenTear_DD_MTB{
	...
	strings :
		...
		$a_81_1 = {59 6f 75 72 20 63 6f 6d 70 75 74 65 72 20 69 73 20 69 6e 66 65 63 74 65 64 20 77 69 74 68 20 61 20 76 69 72 75 73 } //01 00 
		$a_81_2 = {40 74 75 74 61 6e 6f 74 61 2e 63 6f 6d } //01 00 
		$a_81_3 = {2e 69 6e 66 6f 2e 68 74 61 } //00 00 
	condition:
		any of ($a_*)
