...
rule Ransom_MSIL_RanserCrypt_PA_MTB{
	...
	strings :
		$a_01_0 = {55 6e 6c 6f 63 6b 59 6f 75 72 46 69 6c 65 73 2e 4c 6f 67 69 6e } //01 00 
		$a_01_1 = {38 00 31 00 63 00 35 00 66 00 63 00 30 00 64 00 2d 00 33 00 64 00 64 00 64 00 2d 00 34 00 34 00 62 00 36 00 2d 00 38 00 31 00 30 00 65 00 2d 00 37 00 63 00 31 00 63 00 65 00 36 00 33 00 36 00 64 00 33 00 64 00 65 00 } //01 00 
