...
rule Ransom_MSIL_Filecoder_GER_MTB{
	meta:
		description = "Ransom:MSIL/Filecoder.GER!MTB,SIGNATURE_TYPE_PEHSTR_EXT,06 00 06 00 06 00 00 01 00 "
		
	strings :
		$a_80_0 = {41 74 20 74 68 65 20 6d 6f 6d 65 6e 74 2c 20 79 6f 75 72 20 73 79 73 74 65 6d 20 69 73 20 6e 6f 74 20 70 72 6f 74 65 63 74 65 64 } //At the moment, your system is not protected  01 00 
		$a_80_1 = {57 65 20 63 61 6e 20 66 69 78 20 69 74 20 61 6e 64 20 72 65 73 74 6f 72 65 20 66 69 6c 65 73 2e } //We can fix it and restore files.  01 00 
