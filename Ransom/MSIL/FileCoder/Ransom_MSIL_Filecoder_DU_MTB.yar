...
rule Ransom_MSIL_Filecoder_DU_MTB{
	...
	strings :
		$a_81_0 = {42 54 43 20 41 64 64 72 65 73 73 20 3a } //01 00  BTC Address :
		$a_81_1 = {4c 4f 43 4b 54 48 41 54 } //01 00  LOCKTHAT
		$a_81_2 = {53 50 4c 49 54 54 54 54 } //01 00  SPLITTTT
		$a_81_3 = {73 74 75 62 41 45 53 2e 52 65 73 6f 75 72 63 65 73 } //01 00  stubAES.Resources
		$a_81_4 = {53 45 4c 45 43 54 20 2a 20 46 52 4f 4d 20 41 6e 74 69 76 69 72 75 73 50 72 6f 64 75 63 74 } //01 00  SELECT * FROM AntivirusProduct
		$a_81_5 = {2e 64 73 66 64 73 66 } //00 00  .dsfdsf
	condition:
		any of ($a_*)
