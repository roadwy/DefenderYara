...
rule Ransom_MSIL_FileCoder_PBB_MTB{
	...
	strings :
		...
		$a_01_1 = {53 65 72 6f 58 65 6e 5c 53 65 72 6f 58 65 6e 5c 6f 62 6a 5c 78 36 34 5c 52 65 6c 65 61 73 65 5c 53 65 72 6f 58 65 6e 2e 70 64 62 } //01 00 
		$a_01_2 = {41 00 63 00 65 00 2e 00 65 00 78 00 65 00 } //00 00 
	condition:
		any of ($a_*)
