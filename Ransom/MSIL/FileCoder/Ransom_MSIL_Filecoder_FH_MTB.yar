...
rule Ransom_MSIL_Filecoder_FH_MTB{
	...
	strings :
		...
		$a_81_1 = {66 72 69 65 6e 64 6c 79 2e 63 79 62 65 72 2e 63 72 69 6d 69 6e 61 6c } //01 00  friendly.cyber.criminal
		$a_81_2 = {52 45 43 4f 56 45 52 5f 5f 46 49 4c 45 53 } //01 00  RECOVER__FILES
		$a_81_3 = {42 69 74 63 6f 69 6e 41 64 64 72 65 73 73 } //01 00  BitcoinAddress
		$a_81_4 = {2e 6a 63 72 79 70 74 } //00 00  .jcrypt
	condition:
		any of ($a_*)
