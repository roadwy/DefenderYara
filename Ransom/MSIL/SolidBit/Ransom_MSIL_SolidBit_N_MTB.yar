...
rule Ransom_MSIL_SolidBit_N_MTB{
	...
	strings :
		$a_03_0 = {04 02 07 6f 90 01 03 0a 7e 90 01 03 04 07 7e 90 01 03 04 8e 69 5d 91 61 28 90 01 03 06 28 90 01 03 06 26 07 17 58 0b 07 02 6f 90 01 03 0a 90 00 } //1
