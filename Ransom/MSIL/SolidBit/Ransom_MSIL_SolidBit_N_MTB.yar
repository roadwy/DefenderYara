...
rule Ransom_MSIL_SolidBit_N_MTB{
	...
	strings :
		...
		$a_01_1 = {24 30 66 66 61 39 33 62 39 2d 36 62 63 62 2d 34 34 34 36 2d 62 32 39 38 2d 66 36 31 39 38 36 62 37 38 34 36 32 } //00 00  $0ffa93b9-6bcb-4446-b298-f61986b78462
	condition:
		any of ($a_*)
