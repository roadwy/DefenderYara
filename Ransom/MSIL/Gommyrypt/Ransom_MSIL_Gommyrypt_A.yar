...
rule Ransom_MSIL_Gommyrypt_A{
	...
	strings :
		$a_01_0 = {2f 00 62 00 74 00 63 00 2e 00 74 00 78 00 74 00 } //01 00 
		$a_01_1 = {46 00 75 00 63 00 6b 00 20 00 6f 00 66 00 66 00 2e 00 } //01 00 
		$a_01_2 = {54 00 6d 00 46 00 6f 00 4c 00 67 00 3d 00 3d 00 } //02 00 
