...
rule Ransom_MSIL_Deniz_K_MSR{
	...
	strings :
		$a_00_0 = {44 00 65 00 6e 00 69 00 7a 00 5f 00 4b 00 69 00 7a 00 69 00 2e 00 4e 00 45 00 54 00 } //02 00  Deniz_Kizi.NET
		$a_00_1 = {52 00 65 00 61 00 64 00 4d 00 45 00 } //01 00  ReadME
