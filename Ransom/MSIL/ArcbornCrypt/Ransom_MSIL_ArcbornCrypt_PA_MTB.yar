...
rule Ransom_MSIL_ArcbornCrypt_PA_MTB{
	...
	strings :
		$a_01_0 = {74 00 61 00 73 00 6b 00 6d 00 67 00 72 00 } //01 00  taskmgr
		$a_01_1 = {53 00 61 00 6c 00 62 00 61 00 65 00 6c 00 68 00 4e 00 63 00 63 00 50 00 64 00 51 00 41 00 65 00 6d 00 4f 00 65 00 57 00 } //01 00  SalbaelhNccPdQAemOeW
