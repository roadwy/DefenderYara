...
rule Ransom_MSIL_CobraLocker_DA_MTB{
	...
	strings :
		$a_81_0 = {64 65 6c 20 43 3a 5c 57 69 6e 64 6f 77 73 5c 53 79 73 74 65 6d 33 32 5c 54 61 73 6b 6d 67 72 2e 65 78 65 } //01 00  del C:\Windows\System32\Taskmgr.exe
