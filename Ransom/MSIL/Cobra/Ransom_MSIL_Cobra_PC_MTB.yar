...
rule Ransom_MSIL_Cobra_PC_MTB{
	...
	strings :
		...
		$a_03_3 = {5c 43 6f 62 72 61 5f 4c 6f 63 6b 65 72 5c 43 6f 62 72 61 5f 4c 6f 63 6b 65 72 5c 90 02 20 5c 43 6f 62 72 61 5f 4c 6f 63 6b 65 72 2e 70 64 62 90 00 } //1
	condition:
