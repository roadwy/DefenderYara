...
rule Ransom_MSIL_Small_B_MTB{
	...
	strings :
		...
		$a_81_1 = {65 78 74 65 6e 73 69 6f 6e 73 54 6f 45 6e 63 72 79 70 74 } //01 00 
		$a_81_2 = {44 69 72 65 63 74 6f 72 69 65 73 54 6f 45 6e 63 72 79 70 74 } //01 00 
		$a_81_3 = {2e 58 65 72 6f 67 } //00 00 
	condition:
		any of ($a_*)
