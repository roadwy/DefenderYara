...
rule Ransom_MSIL_SatnEncrypt_PA_MTB{
	...
	strings :
		...
		$a_03_2 = {5c 53 41 54 41 4e 20 45 4e 43 52 59 50 54 45 44 20 59 4f 55 5c 90 02 10 5c 90 02 10 5c 53 41 54 41 4e 20 45 4e 43 52 59 50 54 45 44 20 59 4f 55 2e 70 64 62 90 00 } //1
