...
rule Ransom_MSIL_DeathShadow_PA_MTB{
	...
	strings :
		...
		$a_03_1 = {5c 44 65 61 74 68 5f 53 68 61 64 6f 77 5c 62 69 6e 5c 90 02 10 5c 53 65 63 75 72 65 64 5c 44 65 61 74 68 5f 53 68 61 64 6f 77 2e 70 64 62 90 00 } //1
