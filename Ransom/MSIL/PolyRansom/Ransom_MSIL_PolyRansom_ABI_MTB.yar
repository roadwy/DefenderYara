...
rule Ransom_MSIL_PolyRansom_ABI_MTB{
	...
	strings :
		...
		$a_01_2 = {47 65 74 54 65 6d 70 50 61 74 68 } //01 00 
		$a_01_3 = {47 65 74 44 65 63 6f 64 65 72 53 74 72 65 61 6d } //01 00 
		$a_01_4 = {43 6d 52 63 63 53 65 72 76 69 63 65 } //00 00 
	condition:
		any of ($a_*)
