...
rule Ransom_MSIL_Troli_B_bit{
	meta:
		description = "Ransom:MSIL/Troli.B!bit,SIGNATURE_TYPE_PEHSTR_EXT,06 00 06 00 06 00 00 01 00 "
		
	strings :
		$a_01_0 = {2e 00 63 00 72 00 79 00 } //01 00  .cry
		$a_01_1 = {52 69 6a 6e 64 61 65 6c 4d 61 6e 61 67 65 64 } //01 00  RijndaelManaged
		$a_01_2 = {70 72 6f 63 65 73 73 6b 69 6c 6c 65 72 } //01 00  processkiller
		$a_01_3 = {73 74 61 72 74 64 65 73 6b 74 6f 70 } //01 00  startdesktop
