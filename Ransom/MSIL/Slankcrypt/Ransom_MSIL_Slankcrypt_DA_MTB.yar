...
rule Ransom_MSIL_Slankcrypt_DA_MTB{
	meta:
		description = "Ransom:MSIL/Slankcrypt.DA!MTB,SIGNATURE_TYPE_PEHSTR_EXT,04 00 04 00 04 00 00 01 00 "
	...
	strings :
		...
		$a_81_2 = {44 45 41 52 20 49 4e 46 45 43 54 45 44 20 43 4c 49 45 4e 54 53 } //01 00  DEAR INFECTED CLIENTS
		$a_81_3 = {2e 73 6c 61 6e 6b } //00 00  .slank
	condition:
		any of ($a_*)
