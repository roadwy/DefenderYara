...
rule Ransom_MSIL_KarmaLock_A_{
	meta:
		description = "Ransom:MSIL/KarmaLock.A!!KarmaLock.gen!A,SIGNATURE_TYPE_ARHSTR_EXT,05 00 05 00 07 00 00 "
	...
	strings :
		...
		$a_03_4 = {6b 61 72 6d 61 90 02 0f 2e 6f 6e 69 6f 6e 2f 78 31 32 33 34 90 00 } //1
