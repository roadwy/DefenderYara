...
rule Ransom_MSIL_Loki_MBIS_MTB{
	...
	strings :
		...
		$a_01_1 = {38 00 38 00 34 00 35 00 55 00 53 00 42 00 34 00 5a 00 35 00 35 00 34 00 49 00 48 00 59 00 46 00 37 00 34 00 59 00 49 00 44 00 41 00 } //00 00  8845USB4Z554IHYF74YIDA
	condition:
		any of ($a_*)
