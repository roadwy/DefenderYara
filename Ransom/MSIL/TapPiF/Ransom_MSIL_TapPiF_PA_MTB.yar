...
rule Ransom_MSIL_TapPiF_PA_MTB{
	...
	strings :
		...
		$a_03_4 = {5c 00 54 00 61 00 70 00 50 00 69 00 46 00 5c 00 6f 00 62 00 6a 00 5c 00 90 02 10 5c 00 54 00 61 00 70 00 50 00 69 00 46 00 2e 00 70 00 64 00 62 00 90 00 } //1
		$a_03_5 = {5c 54 61 70 50 69 46 5c 6f 62 6a 5c 90 02 10 5c 54 61 70 50 69 46 2e 70 64 62 90 00 } //1
	condition:
