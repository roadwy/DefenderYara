...
rule Ransom_MSIL_EnryLocker_PAA_MTB{
	...
	strings :
		$a_01_0 = {52 61 6e 73 6f 6d 65 57 61 72 65 2e 50 72 6f 70 65 72 74 69 65 73 2e 52 65 73 6f 75 72 63 65 73 2e 72 65 73 6f 75 72 63 65 73 } //01 00 
		$a_01_1 = {52 61 6e 73 6f 6d 65 57 61 72 65 2e 70 64 62 } //01 00 
		...
		$a_01_3 = {2e 00 68 00 65 00 6e 00 72 00 79 00 } //00 00 
	condition:
		any of ($a_*)
