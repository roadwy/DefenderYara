...
rule Ransom_MSIL_FileCrypter_MBCT_MTB{
	...
	strings :
		...
		$a_01_1 = {64 00 35 00 61 00 30 00 31 00 73 00 39 00 75 00 } //01 00  d5a01s9u
		$a_01_2 = {52 00 41 00 4e 00 53 00 4f 00 4d 00 57 00 41 00 52 00 45 00 33 00 2e 00 5f 00 30 00 } //00 00  RANSOMWARE3._0
	condition:
		any of ($a_*)
