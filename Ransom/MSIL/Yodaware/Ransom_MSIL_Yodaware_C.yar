...
rule Ransom_MSIL_Yodaware_C{
	...
	strings :
		...
		$a_02_3 = {53 00 65 00 6e 00 64 00 20 00 24 00 90 02 10 20 00 77 00 6f 00 72 00 74 00 68 00 20 00 6f 00 66 00 20 00 4d 00 6f 00 6e 00 65 00 72 00 6f 00 90 00 } //1
	condition:
