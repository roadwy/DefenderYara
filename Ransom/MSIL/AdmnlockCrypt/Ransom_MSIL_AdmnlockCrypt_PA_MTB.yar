...
rule Ransom_MSIL_AdmnlockCrypt_PA_MTB{
	meta:
		description = "Ransom:MSIL/AdmnlockCrypt.PA!MTB,SIGNATURE_TYPE_PEHSTR_EXT,04 00 04 00 04 00 00 01 00 "
		
	strings :
		$a_01_0 = {2e 00 61 00 64 00 6d 00 69 00 6e 00 31 00 } //01 00  .admin1
		...
		$a_01_2 = {41 00 6c 00 6c 00 20 00 66 00 69 00 6c 00 65 00 73 00 20 00 61 00 72 00 65 00 20 00 65 00 6e 00 63 00 72 00 79 00 70 00 74 00 65 00 64 00 } //01 00  All files are encrypted
