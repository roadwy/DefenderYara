...
rule Ransom_MSIL_FileCryptor_MAK_MTB{
	...
	strings :
		...
		$a_02_1 = {50 00 61 00 79 00 20 00 77 00 69 00 74 00 68 00 20 00 90 02 10 20 00 42 00 54 00 43 00 90 00 } //1
		$a_02_2 = {50 61 79 20 77 69 74 68 20 90 02 10 20 42 54 43 90 00 } //1
...
rule Ransom_MSIL_FileCryptor_MAK_MTB_2{
	...
	strings :
		...
		$a_02_2 = {41 00 6c 00 6c 00 20 00 66 00 69 00 6c 00 65 00 73 00 20 00 77 00 69 00 6c 00 6c 00 20 00 62 00 65 00 20 00 6c 00 65 00 61 00 6b 00 65 00 64 00 20 00 61 00 66 00 74 00 65 00 72 00 20 00 90 02 05 20 00 68 00 6f 00 75 00 72 00 73 00 90 00 } //1
		$a_02_3 = {41 6c 6c 20 66 69 6c 65 73 20 77 69 6c 6c 20 62 65 20 6c 65 61 6b 65 64 20 61 66 74 65 72 20 90 02 05 20 68 6f 75 72 73 90 00 } //1
