...
rule Ransom_MSIL_FileCryptor_PB_MTB{
	meta:
		description = "Ransom:MSIL/FileCryptor.PB!MTB,SIGNATURE_TYPE_PEHSTR_EXT,04 00 04 00 04 00 00 "
		
	strings :
		$a_01_0 = {2e 00 4c 00 4f 00 43 00 4b 00 32 00 47 00 } //1 .LOCK2G
		...
		$a_01_2 = {68 00 61 00 76 00 65 00 20 00 62 00 65 00 65 00 6e 00 20 00 65 00 6e 00 63 00 72 00 79 00 70 00 74 00 65 00 64 00 20 00 6f 00 6e 00 20 00 74 00 68 00 69 00 73 00 20 00 50 00 43 00 } //1 have been encrypted on this PC
