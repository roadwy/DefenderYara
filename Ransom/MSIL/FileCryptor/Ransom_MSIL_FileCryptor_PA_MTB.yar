...
rule Ransom_MSIL_FileCryptor_PA_MTB{
	...
	strings :
		$a_01_0 = {66 69 6c 65 45 6e 63 72 79 70 74 65 64 } //01 00 
		$a_01_1 = {4f 46 46 5f 45 6e 63 72 79 70 74 } //01 00 
		$a_01_2 = {69 00 6d 00 67 00 5f 00 35 00 36 00 36 00 39 00 34 00 } //01 00 
		$a_01_3 = {55 00 4e 00 4c 00 4f 00 43 00 4b 00 45 00 44 00 } //01 00 
		$a_01_4 = {5c 00 64 00 65 00 73 00 6b 00 74 00 6f 00 70 00 2e 00 69 00 6e 00 69 00 } //01 00 
		$a_01_5 = {52 00 61 00 6e 00 73 00 6f 00 6d 00 77 00 61 00 72 00 65 00 32 00 2e 00 30 00 } //0a 00 
