...
rule Ransom_MSIL_SPARTCRYPT_DA_MTB{
	...
	strings :
		...
		$a_81_1 = {48 6f 77 5f 54 6f 5f 52 65 73 74 6f 72 65 5f 59 6f 75 72 5f 46 69 6c 65 73 } //01 00 
		$a_81_2 = {2e 45 6e 63 72 79 70 74 65 64 } //01 00 
		$a_81_3 = {45 6e 63 72 79 70 74 65 64 46 69 6c 65 73 4c 69 73 74 } //00 00 
	condition:
		any of ($a_*)
