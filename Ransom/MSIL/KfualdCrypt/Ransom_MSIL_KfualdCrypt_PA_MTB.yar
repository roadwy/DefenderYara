...
rule Ransom_MSIL_KfualdCrypt_PA_MTB{
	...
	strings :
		$a_01_0 = {2e 00 6b 00 66 00 75 00 61 00 6c 00 64 00 } //01 00 
		$a_01_1 = {5f 00 45 00 6e 00 63 00 72 00 79 00 70 00 74 00 65 00 64 00 24 00 } //01 00 
		$a_01_2 = {55 00 6d 00 46 00 75 00 63 00 32 00 39 00 74 00 4a 00 41 00 3d 00 3d 00 } //01 00 
