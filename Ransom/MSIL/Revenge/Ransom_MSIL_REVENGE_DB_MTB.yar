...
rule Ransom_MSIL_REVENGE_DB_MTB{
	...
	strings :
		...
		$a_81_1 = {47 65 6e 65 72 61 74 65 50 61 73 73 77 6f 72 64 } //01 00  GeneratePassword
		$a_81_2 = {65 6e 63 72 79 70 74 44 69 72 65 63 74 6f 72 79 } //00 00  encryptDirectory
	condition:
		any of ($a_*)
