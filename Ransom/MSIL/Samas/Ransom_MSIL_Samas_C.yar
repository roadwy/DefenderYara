...
rule Ransom_MSIL_Samas_C{
	...
	strings :
		$a_03_0 = {16 0b 2b 13 7e 0b 00 00 04 73 ?? 00 00 0a 6f ?? 00 00 0a 07 17 58 0b 07 1f 12 32 e8 1f 1a 8d ?? 00 00 01 13 0b 11 0b 16 72 ?? ?? 00 70 a2 11 0b 17 72 ?? ?? 00 70 a2 11 0b 18 72 ?? ?? 00 70 a2 11 0b 19 } //5
