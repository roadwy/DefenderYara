...
rule Ransom_MSIL_Kraken_B{
	...
	strings :
		...
		$a_03_4 = {4e 6f 20 77 61 79 20 74 6f 20 72 65 63 6f 76 65 72 79 20 79 6f 75 72 20 66 69 6c 65 73 20 77 69 74 68 6f 75 74 [0-06] 4b 52 41 4b 45 4e 20 44 45 43 52 59 50 54 4f 52 } //1
	condition:
