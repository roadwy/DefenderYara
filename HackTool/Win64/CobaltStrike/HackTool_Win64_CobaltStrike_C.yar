...
rule HackTool_Win64_CobaltStrike_C{
	meta:
		description = "HackTool:Win64/CobaltStrike.C,SIGNATURE_TYPE_PEHSTR_EXT,0b 00 0b 00 0a 00 00 01 00 "
	...
	strings :
		...
		$a_01_5 = {0f af d1 44 8b c8 b8 1f 85 eb 51 f7 e2 41 8b c1 44 8b c2 33 d2 41 c1 e8 05 41 f7 f0 } //9c ff 
