...
rule HackTool_Win64_CobaltStrike_D_{
	meta:
		description = "HackTool:Win64/CobaltStrike.D!!CobaltStrike.D64,SIGNATURE_TYPE_ARHSTR_EXT,0b 00 0b 00 09 00 00 01 00 "
	...
	strings :
		...
		$a_03_4 = {b9 00 00 10 00 e8 90 02 3c ba 7f 66 04 40 8b c8 48 8b 90 02 08 89 08 48 8b 4b 20 90 00 } //9c ff 
