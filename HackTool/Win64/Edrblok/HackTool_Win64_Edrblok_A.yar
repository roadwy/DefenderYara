...
rule HackTool_Win64_Edrblok_A{
	...
	strings :
		...
		$a_03_5 = {d1 57 8d c3 90 01 04 a7 05 90 01 04 33 4c 90 01 02 90 90 4f 7f bc ee e6 0e 82 90 00 } //1
		$a_03_6 = {87 1e 8e d7 90 01 04 44 86 90 01 04 a5 4e 90 01 02 94 37 d8 09 ec ef c9 71 90 00 } //1
		$a_03_7 = {3b 39 72 4a 90 01 04 9f 31 90 01 04 bc 44 90 01 02 84 c3 ba 54 dc b3 b6 b4 90 00 } //1
	condition:
