...
rule HackTool_Win64_CallBckHel_MTB{
	...
	strings :
		$a_02_0 = {41 b8 04 00 00 00 48 8d 15 90 02 04 e8 90 02 04 85 c0 90 02 06 8b c7 48 3b 43 08 90 02 06 48 83 c3 18 48 3b de 90 02 06 48 8b 5c 24 90 02 02 48 8b 74 24 90 02 02 90 02 10 48 8b 03 48 8b 5c 24 90 02 02 48 83 e0 f0 90 00 } //1
