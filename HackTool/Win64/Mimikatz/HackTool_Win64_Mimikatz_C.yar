...
rule HackTool_Win64_Mimikatz_C{
	...
	strings :
		...
		$a_00_1 = {67 00 65 00 6e 00 74 00 69 00 6c 00 6b 00 69 00 77 00 69 00 2e 00 63 00 6f 00 6d 00 } //01 00 
		$a_00_2 = {42 00 65 00 6e 00 6a 00 61 00 6d 00 69 00 6e 00 20 00 44 00 45 00 4c 00 50 00 59 00 } //00 00 
	condition:
		any of ($a_*)
