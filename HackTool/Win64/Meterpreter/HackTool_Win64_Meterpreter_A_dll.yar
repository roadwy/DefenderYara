...
rule HackTool_Win64_Meterpreter_A_dll_3{
	...
	strings :
		...
		$a_03_4 = {3c 45 8b cb 33 c9 90 01 01 03 90 01 01 41 b8 00 30 00 00 90 02 10 ff d6 90 00 } //2
		$a_03_5 = {3c 33 c9 41 b8 00 30 00 00 90 01 01 03 90 01 01 44 8d 49 90 02 10 ff d6 90 00 } //2
		$a_03_6 = {8b 5f 28 45 33 c0 33 d2 48 83 c9 ff 90 01 01 03 90 01 01 ff 94 24 88 00 00 00 45 33 c0 90 01 01 8b 90 01 01 41 8d 90 01 02 ff d3 48 8b c3 90 00 } //1
	condition:
