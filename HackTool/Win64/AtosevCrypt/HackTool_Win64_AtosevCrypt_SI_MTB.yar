...
rule HackTool_Win64_AtosevCrypt_SI_MTB{
	...
	strings :
		...
		$a_03_1 = {48 8b d0 48 8b cf ff 15 90 01 02 00 00 48 85 c0 74 90 01 01 48 8b c8 ff 15 90 01 02 00 00 48 8b d5 48 8b cf 4c 8b f0 ff 15 90 01 02 00 00 8b e8 4d 85 f6 90 00 } //2
	condition:
