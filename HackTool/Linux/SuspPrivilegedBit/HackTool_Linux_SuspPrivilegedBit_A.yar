...
rule HackTool_Linux_SuspPrivilegedBit_A{
	...
	strings :
		$a_00_0 = {63 00 68 00 6d 00 6f 00 64 00 20 00 } //01 00 
		$a_00_1 = {75 00 2b 00 73 00 20 00 } //01 00 
		$a_00_2 = {67 00 2b 00 73 00 20 00 } //01 00 
		$a_00_3 = {2b 00 73 00 20 00 } //01 00 
		$a_00_4 = {2b 00 74 00 20 00 } //06 00 
