...
rule HackTool_Linux_CryptoMiner_A{
	...
	strings :
		...
		$a_02_1 = {73 00 74 00 72 00 61 00 74 00 75 00 6d 00 90 02 02 2b 00 74 00 63 00 70 00 3a 00 2f 00 2f 00 90 00 } //1
		$a_02_2 = {73 00 74 00 72 00 61 00 74 00 75 00 6d 00 90 02 02 2b 00 73 00 73 00 6c 00 3a 00 2f 00 2f 00 90 00 } //1
