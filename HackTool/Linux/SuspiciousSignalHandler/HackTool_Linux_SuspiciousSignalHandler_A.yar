...
rule HackTool_Linux_SuspiciousSignalHandler_A{
	...
	strings :
		$a_00_0 = {74 00 72 00 61 00 70 00 } //0a 00  trap
		$a_00_1 = {53 00 42 00 53 00 69 00 67 00 6e 00 61 00 6c 00 } //0a 00  SBSignal
		$a_00_2 = {45 00 58 00 49 00 54 00 } //00 00  EXIT
	condition:
		any of ($a_*)
