...
rule HackTool_Linux_SuspUnixReShellCmd_G{
	...
	strings :
		...
		$a_02_2 = {63 00 6f 00 6e 00 6e 00 65 00 63 00 74 00 [0-02] 28 00 [0-50] 2c 00 } //10
		$a_02_3 = {73 00 6f 00 63 00 6b 00 61 00 64 00 64 00 72 00 5f 00 69 00 6e 00 [0-02] 28 00 [0-50] 2c 00 } //10
