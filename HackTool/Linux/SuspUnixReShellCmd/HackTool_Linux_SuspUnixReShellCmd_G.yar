...
rule HackTool_Linux_SuspUnixReShellCmd_G{
	meta:
		description = "HackTool:Linux/SuspUnixReShellCmd.G,SIGNATURE_TYPE_CMDHSTR_EXT,18 00 18 00 09 00 00 01 00 "
	...
	strings :
		...
		$a_00_7 = {6c 00 6f 00 63 00 61 00 6c 00 68 00 6f 00 73 00 74 00 } //b0 ff  localhost
