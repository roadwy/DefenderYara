...
rule HackTool_Linux_SuspUnixReShellCmd_D{
	...
	strings :
		...
		$a_02_1 = {73 00 75 00 62 00 70 00 72 00 6f 00 63 00 65 00 73 00 73 00 2e 00 63 00 61 00 6c 00 6c 00 [0-02] 28 00 [0-02] 5b 00 [0-04] 2f 00 62 00 69 00 6e 00 2f 00 [0-04] 73 00 68 00 } //10
		...
		$a_02_4 = {63 00 6f 00 6e 00 6e 00 65 00 63 00 74 00 [0-01] 28 00 [0-01] 28 00 [0-50] 29 00 } //1
