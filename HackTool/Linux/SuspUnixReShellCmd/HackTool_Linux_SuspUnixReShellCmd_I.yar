...
rule HackTool_Linux_SuspUnixReShellCmd_I{
	...
	strings :
		$a_02_0 = {3c 00 3e 00 [0-02] 2f 00 64 00 65 00 76 00 2f 00 74 00 63 00 70 00 2f 00 } //2
		$a_02_1 = {3c 00 3e 00 [0-02] 2f 00 64 00 65 00 76 00 2f 00 75 00 64 00 70 00 2f 00 } //2
