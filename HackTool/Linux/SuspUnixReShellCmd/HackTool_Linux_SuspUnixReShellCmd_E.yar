...
rule HackTool_Linux_SuspUnixReShellCmd_E{
	...
	strings :
		$a_02_0 = {70 00 65 00 72 00 6c 00 90 02 20 2d 00 65 00 90 02 20 75 00 73 00 65 00 90 00 } //10
		$a_02_1 = {65 00 78 00 65 00 63 00 90 02 02 28 00 90 02 04 2f 00 62 00 69 00 6e 00 2f 00 90 02 04 73 00 68 00 90 00 } //10
		...
		$a_02_4 = {63 00 6f 00 6e 00 6e 00 65 00 63 00 74 00 90 02 02 28 00 90 02 50 2c 00 90 00 } //1
