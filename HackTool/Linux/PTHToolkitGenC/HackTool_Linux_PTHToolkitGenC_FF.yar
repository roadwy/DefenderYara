...
rule HackTool_Linux_PTHToolkitGenC_FF{
	meta:
		description = "HackTool:Linux/PTHToolkitGenC.FF,SIGNATURE_TYPE_CMDHSTR_EXT,79 00 15 00 07 00 00 14 00 "
		
	strings :
		$a_00_0 = {77 00 69 00 6e 00 72 00 6d 00 20 00 } //01 00 
		$a_00_1 = {2d 00 75 00 20 00 } //01 00 
		$a_00_2 = {2d 00 69 00 64 00 20 00 } //01 00 
		$a_00_3 = {2d 00 78 00 20 00 } //01 00 
		$a_00_4 = {2d 00 6b 00 } //01 00 
