...
rule HackTool_Linux_SudoNoPassAttempt_A{
	...
	strings :
		...
		$a_00_4 = {61 00 7a 00 75 00 72 00 65 00 5f 00 70 00 69 00 70 00 65 00 6c 00 69 00 6e 00 65 00 73 00 5f 00 73 00 75 00 64 00 6f 00 } //00 00  azure_pipelines_sudo
	condition:
		any of ($a_*)
