...
rule HackTool_Win32_Patched_Y{
	...
	strings :
		$a_03_0 = {8b 18 81 38 90 01 03 00 74 0c 89 1d 90 01 03 00 c7 00 90 01 03 00 68 90 01 03 00 c3 60 b9 20 00 00 00 8d 3d 90 01 03 00 8b 74 24 28 f3 a6 74 07 61 ff 25 90 01 03 00 61 b8 90 01 03 00 c2 08 00 90 00 } //1
