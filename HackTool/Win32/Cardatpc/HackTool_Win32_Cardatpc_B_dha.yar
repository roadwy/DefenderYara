...
rule HackTool_Win32_Cardatpc_B_dha{
	...
	strings :
		...
		$a_01_3 = {63 6c 65 61 6e 6c 61 73 74 2d 71 75 69 74 20 3c 31 7c 30 3e } //01 00 
		$a_01_4 = {3c 50 49 44 3a 55 53 45 52 3a 44 4f 4d 41 49 4e 3a 4e 54 4c 4d 3e } //01 00 
		$a_01_5 = {5c 5c 2e 5c 70 69 70 65 5c 6c 73 61 73 73 70 } //00 00 
	condition:
		any of ($a_*)
