...
rule HackTool_Win32_Impacketwmiexec_RG{
	...
	strings :
		...
		$a_02_2 = {3e 00 20 00 43 00 3a 00 5c 00 57 00 69 00 6e 00 64 00 6f 00 77 00 73 00 5c 00 54 00 65 00 6d 00 70 00 5c 00 90 02 20 2e 00 74 00 6d 00 70 00 90 00 } //100
