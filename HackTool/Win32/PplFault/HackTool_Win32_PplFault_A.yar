...
rule HackTool_Win32_PplFault_A{
	...
	strings :
		...
		$a_03_2 = {48 87 c9 c7 90 01 02 48 87 d2 4d c7 90 01 02 87 c0 4d 87 66 c7 90 01 02 c9 90 00 } //1
		$a_03_3 = {4c 8b e8 c7 44 24 90 01 01 d3 c0 ad 1b c7 44 24 90 01 01 ef be ad de 90 00 } //10
		$a_01_4 = {c7 03 d3 c0 ad 1b c7 43 04 ef be ad de } //10
		$a_03_5 = {23 65 9c 11 90 01 03 7b 40 6b 44 90 01 03 b0 e3 e0 30 90 00 } //10
	condition:
