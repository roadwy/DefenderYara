...
rule HackTool_Win32_LSASecretsView_BH{
	meta:
		description = "HackTool:Win32/LSASecretsView.BH,SIGNATURE_TYPE_PEHSTR,04 00 04 00 04 00 00 01 00 "
	...
	strings :
		...
		$a_01_3 = {5c 50 72 6f 6a 65 63 74 73 5c 56 53 32 30 30 35 5c 4c 53 41 53 65 63 72 65 74 73 56 69 65 77 5c 52 65 6c 65 61 73 65 5c 4c 53 41 53 65 63 72 65 74 73 56 69 65 77 } //00 00  \Projects\VS2005\LSASecretsView\Release\LSASecretsView
	condition:
		any of ($a_*)
