...
rule HackTool_Win32_DumpLsass_E{
	...
	strings :
		...
		$a_00_2 = {5c 00 70 00 72 00 6f 00 63 00 64 00 75 00 6d 00 70 00 } //05 00  \procdump
		$a_00_3 = {20 00 6c 00 73 00 61 00 73 00 73 00 20 00 } //05 00   lsass 
		$a_00_4 = {20 00 6c 00 73 00 61 00 73 00 73 00 2e 00 65 00 78 00 65 00 20 00 } //00 00   lsass.exe 
	condition:
		any of ($a_*)
