...
rule HackTool_Win32_ProcKiller_B{
	...
	strings :
		$a_00_0 = {57 69 6e 53 74 61 74 69 6f 6e 54 65 72 6d 69 6e 61 74 65 50 72 6f 63 65 73 73 } //0a 00 
		$a_00_1 = {43 73 72 47 65 74 50 72 6f 63 65 73 73 49 64 } //0a 00 
		$a_00_2 = {44 75 70 6c 69 63 61 74 65 48 61 6e 64 6c 65 } //0a 00 
		...
		$a_00_6 = {53 75 73 70 65 6e 64 54 68 72 65 61 64 } //01 00 
		$a_00_7 = {4c 6f 6f 6b 75 70 50 72 69 76 69 6c 65 67 65 56 61 6c 75 65 } //01 00 
