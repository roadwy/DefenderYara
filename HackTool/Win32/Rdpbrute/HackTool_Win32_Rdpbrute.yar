...
rule HackTool_Win32_Rdpbrute{
	...
	strings :
		$a_01_0 = {44 55 42 72 75 74 65 } //01 00  DUBrute
		$a_01_1 = {68 74 74 70 3a 2f 2f 75 62 72 75 74 65 2e 63 6f 6d } //01 00  http://ubrute.com
		$a_01_2 = {43 72 61 73 68 2e 2e 2e 20 25 73 3a 25 73 3a 25 73 } //01 00  Crash... %s:%s:%s
