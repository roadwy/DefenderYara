...
rule HackTool_Win32_DefenderRmv_A{
	...
	strings :
		...
		$a_00_2 = {3b 63 6f 70 79 20 2f 62 20 63 6f 6d 70 69 6c 65 72 2e 6d 70 6d 20 2b 20 63 6f 6e 66 69 67 2e 74 78 74 20 2b 20 72 65 62 64 2e 37 7a 20 67 61 6c 6c 65 72 79 5f 6d 70 6d 2e 65 78 65 3b } //00 00 
	condition:
		any of ($a_*)
