...
rule HackTool_Win32_WDigest_A{
	...
	strings :
		$a_03_0 = {ff d0 89 44 24 10 e9 ?? ?? ?? ?? 8b 7d 0c 8b 4f 04 39 19 0f 85 ?? ?? ?? ?? 8b 40 04 53 ff 75 10 ff 37 ff 36 ff 30 ff 15 } //2
		$a_03_1 = {89 41 04 3b c7 74 ?? 8b 06 8b 40 04 81 38 4d 44 4d 50 75 ?? b9 ?? ?? ?? ?? 66 39 48 04 } //1
		$a_03_2 = {4c 73 61 49 c7 44 24 ?? 43 61 6e 63 c7 44 24 ?? 65 6c 4e 6f } //1
		$a_03_3 = {72 1c 81 79 0c ?? ?? ?? ?? 73 13 6a 0b 58 6a 24 5f 6a 1e } //1
		$a_03_4 = {42 43 72 79 c7 45 ?? 70 74 47 65 c7 45 ?? 6e 65 72 61 } //1
		$a_03_5 = {81 7d d8 52 55 55 55 0f 85 ?? ?? 00 00 8b 45 08 } //1
		$a_03_6 = {81 7e 04 4b 53 53 4d 75 ?? 03 75 f8 } //1
		$a_03_7 = {6a 6c 58 6a 73 66 89 ?? e8 58 6a 61 } //1
