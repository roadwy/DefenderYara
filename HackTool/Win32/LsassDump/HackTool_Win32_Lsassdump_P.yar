...
rule HackTool_Win32_Lsassdump_P{
	...
	strings :
		$a_01_0 = {63 72 65 61 74 65 20 61 20 64 75 6d 70 20 77 69 74 68 20 61 20 76 61 6c 69 64 20 73 69 67 6e 61 74 75 72 65 } //01 00 
		$a_01_1 = {74 68 65 20 50 49 44 20 6f 66 20 4c 53 41 53 53 } //03 00 
