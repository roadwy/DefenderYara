...
rule HackTool_Win32_DarkComet{
	...
	strings :
		...
		$a_01_4 = {44 00 61 00 72 00 6b 00 43 00 6f 00 6d 00 65 00 74 00 20 00 52 00 65 00 6d 00 6f 00 74 00 65 00 20 00 41 00 64 00 6d 00 69 00 6e 00 69 00 73 00 74 00 72 00 61 00 74 00 69 00 6f 00 6e 00 20 00 54 00 6f 00 6f 00 6c 00 } //1 DarkComet Remote Administration Tool
		$a_01_5 = {44 00 61 00 72 00 6b 00 43 00 6f 00 6d 00 65 00 74 00 20 00 61 00 6b 00 61 00 20 00 55 00 6e 00 72 00 65 00 6d 00 6f 00 74 00 65 00 20 00 4e 00 41 00 54 00 20 00 61 00 6b 00 61 00 20 00 53 00 79 00 6e 00 52 00 41 00 54 00 } //1 DarkComet aka Unremote NAT aka SynRAT
	condition:
		((#a_03_0  & 1)*1+(#a_01_1  & 1)*1+(#a_01_2  & 1)*1+(#a_01_3  & 1)*1+(#a_01_4  & 1)*1+(#a_01_5  & 1)*1) >=2
