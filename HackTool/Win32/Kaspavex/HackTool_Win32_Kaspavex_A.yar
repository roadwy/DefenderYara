...
rule HackTool_Win32_Kaspavex_A{
	...
	strings :
		...
		$a_03_4 = {68 ff 00 00 00 ff 15 90 01 02 40 00 6a 32 68 90 01 02 40 00 68 90 01 02 40 00 ff 15 90 01 02 40 00 68 90 01 02 40 00 6a 00 68 90 01 02 40 00 68 90 01 02 40 00 ff 15 90 01 02 40 00 68 90 01 02 40 00 ff 15 90 01 02 40 00 e8 02 00 00 00 20 00 68 90 01 02 40 00 ff 15 90 01 02 40 00 6a 32 90 00 } //2
	condition:
