...
rule HackTool_Win32_AutoKMS_C{
	...
	strings :
		...
		$a_02_7 = {46 75 6c 6c 43 72 61 63 6b 2e 76 6e 5f 4b 4d 53 70 69 63 6f 5f 31 30 2e 90 01 03 5f 73 65 74 75 70 2e 72 61 72 90 00 } //10
		$a_00_8 = {50 61 73 73 77 6f 72 64 20 3a 20 66 75 6c 6c 63 72 61 63 6b 2e 76 6e } //1 Password : fullcrack.vn
		$a_02_9 = {40 24 26 25 90 01 02 5c 4b 4d 53 70 69 63 6f 2d 73 65 74 75 70 2e 65 78 65 90 00 } //10
		$a_02_10 = {40 24 26 25 90 01 02 5c 6b 6d 73 64 6c 6c 2e 65 78 65 90 00 } //1
	condition:
