...
rule HackTool_Win32_Keygen_10{
	...
	strings :
		$a_01_0 = {4b 65 79 67 65 6e 20 62 79 20 50 41 52 41 44 4f 58 } //01 00  Keygen by PARADOX
		$a_01_1 = {53 74 6f 70 2f 50 6c 61 79 20 4d 75 73 69 63 } //01 00  Stop/Play Music
		$a_01_2 = {47 65 6e 65 72 61 74 65 20 43 44 2d 4b 65 79 } //00 00  Generate CD-Key
	condition:
		any of ($a_*)
...
rule HackTool_Win32_Keygen_11{
	...
	strings :
		$a_01_0 = {77 77 77 2e 64 61 79 61 6e 7a 61 69 2e 6d 65 } //04 00  www.dayanzai.me
		$a_01_1 = {43 6f 72 65 6c 20 50 72 6f 64 75 63 74 73 20 4b 65 79 67 65 6e } //01 00  Corel Products Keygen
		$a_01_2 = {53 6f 66 74 77 61 72 65 5c 41 53 50 72 6f 74 65 63 74 5c 4b 65 79 } //01 00  Software\ASProtect\Key
		$a_01_3 = {61 73 70 72 5f 6b 65 79 73 2e 69 6e 69 } //00 00  aspr_keys.ini
	condition:
		any of ($a_*)
...
rule HackTool_Win32_Keygen_12{
	...
	strings :
		$a_01_0 = {41 00 75 00 74 00 6f 00 64 00 65 00 73 00 6b 00 20 00 50 00 72 00 6f 00 64 00 75 00 63 00 74 00 73 00 } //01 00  Autodesk Products
		$a_01_1 = {45 78 74 65 6e 64 65 64 20 4d 6f 64 75 6c 65 3a 20 43 68 69 70 65 78 32 } //01 00  Extended Module: Chipex2
		$a_01_2 = {46 61 73 74 54 72 61 63 6b 65 72 20 76 32 2e 30 30 20 } //01 00  FastTracker v2.00 
		$a_01_3 = {4d 69 63 72 6f 58 6d 20 42 79 20 4d 72 20 47 61 6d 65 72 } //01 00  MicroXm By Mr Gamer
		$a_01_4 = {43 72 65 61 74 65 64 20 42 79 20 4d 72 47 61 6d } //00 00  Created By MrGam
	condition:
		any of ($a_*)
...
rule HackTool_Win32_Keygen_13{
	...
	strings :
		$a_01_0 = {4c 69 63 65 6e 73 65 20 66 69 6c 65 20 67 65 6e 65 72 61 74 65 64 21 } //01 00  License file generated!
		$a_01_1 = {5b 20 53 46 58 20 62 79 20 67 68 69 64 6f 72 61 68 20 5d } //01 00  [ SFX by ghidorah ]
		$a_01_2 = {46 69 6c 65 20 73 75 63 63 65 73 73 66 75 6c 6c 79 20 70 61 74 63 68 65 64 21 } //01 00  File successfully patched!
		$a_01_3 = {67 68 69 64 6f 72 61 68 40 6d 75 73 69 63 69 61 6e 2e 6f 72 67 } //01 00  ghidorah@musician.org
		$a_01_4 = {68 74 74 70 3a 2f 2f 77 77 77 2e 43 6f 6c 6c 61 6b 65 53 6f 66 74 77 61 72 65 2e 63 6f 6d } //00 00  http://www.CollakeSoftware.com
	condition:
		any of ($a_*)
