...
rule HackTool_Win32_SmbAgent_J_ibt{
	...
	strings :
		...
		$a_00_3 = {50 69 6e 67 43 61 73 74 6c 65 2e 53 63 61 6e 6e 65 72 73 } //01 00  PingCastle.Scanners
		$a_00_4 = {52 65 61 64 53 6d 62 52 65 73 70 6f 6e 73 65 } //01 00  ReadSmbResponse
		$a_00_5 = {6d 31 37 73 63 } //00 00  m17sc
	condition:
		any of ($a_*)
