...
rule HackTool_Win32_CobaltStrike_F_{
	meta:
		description = "HackTool:Win32/CobaltStrike.F!!CobaltStrike.F,SIGNATURE_TYPE_ARHSTR_EXT,01 00 01 00 07 00 00 01 00 "
	...
	strings :
		...
		$a_01_3 = {42 65 68 61 76 69 6f 72 3a } //9c ff 
		$a_01_4 = {54 72 6f 6a 61 6e 3a } //9c ff 
		$a_01_5 = {6d 70 61 74 74 72 69 62 75 74 65 } //9c ff 
		$a_01_6 = {48 61 63 6b 54 6f 6f 6c 3a } //00 00 
	condition:
		any of ($a_*)
