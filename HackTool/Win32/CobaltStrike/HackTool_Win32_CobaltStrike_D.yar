...
rule HackTool_Win32_CobaltStrike_D{
	meta:
		description = "HackTool:Win32/CobaltStrike.D,SIGNATURE_TYPE_PEHSTR_EXT,0b 00 0b 00 0a 00 00 01 00 "
	...
	strings :
		...
		$a_03_5 = {68 00 00 10 00 90 02 3c 50 68 7f 66 04 40 ff 76 1c 90 02 08 81 7d fc fc ff 0f 00 90 00 } //9c ff 
