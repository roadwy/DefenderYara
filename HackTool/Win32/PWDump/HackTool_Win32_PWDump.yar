...
rule HackTool_Win32_PWDump{
	...
	strings :
		$a_00_0 = {50 77 44 75 6d 70 } //01 00  PwDump
		...
		$a_00_3 = {52 65 67 51 75 65 72 79 56 61 6c 75 65 45 78 57 } //01 00  RegQueryValueExW
		$a_00_4 = {43 72 79 70 74 43 72 65 61 74 65 48 61 73 68 } //00 00  CryptCreateHash
	condition:
		any of ($a_*)
