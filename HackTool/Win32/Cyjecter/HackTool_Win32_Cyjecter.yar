...
rule HackTool_Win32_Cyjecter{
	...
	strings :
		$a_00_0 = {6d 6f 64 69 6e 6a 65 63 74 } //01 00 
		$a_00_1 = {57 65 6c 63 68 47 49 46 76 69 65 77 65 72 2e 75 63 41 6e 69 47 49 46 } //01 00 
		...
		$a_00_4 = {46 00 61 00 69 00 6c 00 65 00 64 00 20 00 74 00 6f 00 20 00 57 00 72 00 69 00 74 00 65 00 20 00 44 00 4c 00 4c 00 20 00 74 00 6f 00 20 00 50 00 72 00 6f 00 63 00 65 00 73 00 73 00 } //00 00 
	condition:
		any of ($a_*)
