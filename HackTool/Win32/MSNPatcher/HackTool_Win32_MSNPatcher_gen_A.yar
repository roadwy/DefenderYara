...
rule HackTool_Win32_MSNPatcher_gen_A{
	...
	strings :
		...
		$a_01_2 = {4d 53 4e 5c 57 69 6e 64 6f 77 73 20 4d 65 73 73 65 6e 67 65 72 20 55 6e 69 76 65 72 73 61 6c 20 4c 6f 61 64 65 72 } //01 00 
		$a_01_3 = {6a 6e 72 7a 2e 32 6b 7a 6f 6e 65 2e 6e 65 74 } //01 00 
		$a_01_4 = {55 6e 69 76 65 72 73 61 6c 20 4a 6e 72 7a 4c 6f 61 64 65 72 } //00 00 
	condition:
		any of ($a_*)
