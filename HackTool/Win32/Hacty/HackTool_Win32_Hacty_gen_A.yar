...
rule HackTool_Win32_Hacty_gen_A{
	...
	strings :
		$a_02_0 = {4c 6f 61 64 65 72 3e 20 48 6f 6f 6b 20 73 68 6f 75 6c 64 20 62 65 20 73 65 74 20 6e 6f 77 [0-10] 4c 6f 61 64 65 72 3e 20 43 61 6c 6c 69 6e 67 20 6c 6f 61 64 20 66 75 6e 63 74 69 6f 6e [0-10] 4c 6f 61 64 65 72 3e 20 46 41 49 4c 45 44 } //10
		$a_02_1 = {53 65 74 55 70 48 6f 6f 6b [0-05] 4c 6f 61 64 65 72 3e 20 52 65 73 6f 6c 76 69 6e 67 20 6c 6f 61 64 20 66 75 6e 63 74 69 6f 6e [0-10] 4e 74 49 6c 6c 75 73 69 6f 6e [0-02] 64 6c 6c [0-02] 4c 6f 61 64 65 72 3e 20 6c 6f 61 64 69 6e 67 20 4e 54 49 6c 6c 75 73 69 6f 6e } //10
