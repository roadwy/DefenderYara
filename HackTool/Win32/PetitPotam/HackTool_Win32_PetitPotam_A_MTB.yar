...
rule HackTool_Win32_PetitPotam_A_MTB{
	...
	strings :
		$a_03_0 = {68 08 4b 4f 00 6a 64 8d 90 01 05 51 e8 90 01 04 83 c4 10 8b f4 8d 90 01 05 50 6a 00 8b 0d 58 4a 4f 00 51 8d 90 01 05 52 68 14 4b 4f 00 a1 54 90 01 03 50 ff 15 90 00 } //1
