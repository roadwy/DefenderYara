...
rule HackTool_Win32_Mimikatz_NPTT_5{
	...
	strings :
		$a_02_0 = {6b 00 65 00 72 00 62 00 65 00 72 00 6f 00 73 00 3a 00 3a 00 70 00 74 00 74 00 20 00 90 02 40 40 00 90 00 } //1
		$a_02_1 = {6b 65 72 62 65 72 6f 73 3a 3a 70 74 74 20 90 02 40 40 90 00 } //1
		$a_02_2 = {6b 00 65 00 72 00 62 00 65 00 72 00 6f 00 73 00 3a 00 3a 00 70 00 74 00 74 00 20 00 90 02 40 2e 00 6b 00 69 00 72 00 62 00 69 00 90 00 } //1
		$a_02_3 = {6b 65 72 62 65 72 6f 73 3a 3a 70 74 74 20 90 02 40 2e 6b 69 72 62 69 90 00 } //1
		$a_02_4 = {6b 00 65 00 72 00 62 00 65 00 72 00 6f 00 73 00 3a 00 3a 00 70 00 74 00 74 00 20 00 90 01 01 3a 00 5c 00 90 00 } //1
		$a_02_5 = {6b 65 72 62 65 72 6f 73 3a 3a 70 74 74 20 90 01 01 3a 5c 90 00 } //1
	condition:
