...
rule HackTool_Win32_ICQFlood_A{
	...
	strings :
		$a_00_0 = {49 43 51 20 46 6c 6f 6f 64 65 72 20 62 79 20 6c 2d 6c 30 30 } //01 00  ICQ Flooder by l-l00
		$a_00_1 = {49 43 51 46 6c 6f 6f 64 65 72 20 62 79 20 48 30 30 4b } //02 00  ICQFlooder by H00K
