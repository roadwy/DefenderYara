...
rule HackTool_Win32_ICQFlood_A{
	...
	strings :
		...
		$a_02_2 = {4d 65 73 73 61 67 65 73 20 61 72 65 20 73 65 6e 74 3a 20 90 02 10 4f 66 66 6c 69 6e 65 2c 20 69 6e 63 72 65 61 73 65 20 74 69 6d 65 6f 75 74 90 00 } //2
	condition:
