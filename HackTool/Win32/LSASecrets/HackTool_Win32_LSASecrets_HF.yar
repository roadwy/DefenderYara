...
rule HackTool_Win32_LSASecrets_HF{
	meta:
		description = "HackTool:Win32/LSASecrets.HF,SIGNATURE_TYPE_PEHSTR,05 00 05 00 05 00 00 01 00 "
	...
	strings :
		...
		$a_01_4 = {72 69 63 68 65 64 32 30 2e 64 6c 6c } //00 00  riched20.dll
	condition:
		any of ($a_*)
