...
rule HackTool_MacOS_SuspNetcatCmd_A_BindShell{
	...
	strings :
		$a_00_0 = {6d 00 6b 00 66 00 69 00 66 00 6f 00 } //1e 00  mkfifo
		$a_02_1 = {6e 00 63 00 20 00 90 02 20 2d 00 6c 00 90 00 } //0a 00 
		$a_00_2 = {73 00 68 00 20 00 } //ce ff  sh 
		$a_00_3 = {6c 00 6f 00 63 00 61 00 6c 00 68 00 6f 00 73 00 74 00 } //ce ff  localhost
