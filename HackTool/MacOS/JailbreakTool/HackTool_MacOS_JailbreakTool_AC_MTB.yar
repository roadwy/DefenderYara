...
rule HackTool_MacOS_JailbreakTool_AC_MTB{
	...
	strings :
		...
		$a_00_1 = {68 65 61 70 20 73 70 72 61 79 } //01 00  heap spray
		$a_00_2 = {6c 69 6d 65 72 61 31 6e 20 65 78 70 6c 6f 69 74 20 28 68 65 61 70 20 6f 76 65 72 66 6c 6f 77 29 } //02 00  limera1n exploit (heap overflow)
		...
		$a_00_4 = {46 69 72 6d 77 61 72 65 2f 64 66 75 2f 69 42 53 53 2e 6e 34 32 61 70 2e 52 45 4c 45 41 53 45 2e 64 66 75 } //00 00  Firmware/dfu/iBSS.n42ap.RELEASE.dfu
	condition:
		any of ($a_*)
