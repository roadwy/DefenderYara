...
rule HackTool_MacOS_Aircrack_A_MTB{
	...
	strings :
		$a_00_0 = {2f 70 72 69 76 61 74 65 2f 74 6d 70 2f 61 69 72 63 72 61 63 6b 2d 6e 67 } //01 00  /private/tmp/aircrack-ng
		$a_00_1 = {2f 75 73 72 2f 6c 6f 63 61 6c 2f 43 65 6c 6c 61 72 2f 61 69 72 63 72 61 63 6b 2d 6e 67 } //01 00  /usr/local/Cellar/aircrack-ng
