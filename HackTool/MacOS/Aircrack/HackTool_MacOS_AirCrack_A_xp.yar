...
rule HackTool_MacOS_AirCrack_A_xp{
	...
	strings :
		...
		$a_02_1 = {64 6f 20 73 63 72 69 70 74 90 02 10 2d 61 20 25 6c 75 20 2d 62 20 25 40 20 2f 70 72 69 76 61 74 65 2f 74 6d 70 2f 61 69 72 70 6f 72 74 53 6e 69 66 66 2a 2e 63 61 70 90 00 } //1
