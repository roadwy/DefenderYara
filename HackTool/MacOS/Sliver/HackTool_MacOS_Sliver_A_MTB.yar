...
rule HackTool_MacOS_Sliver_A_MTB{
	meta:
		description = "HackTool:MacOS/Sliver.A!MTB,SIGNATURE_TYPE_MACHOHSTR_EXT,02 00 02 00 02 00 00 01 00 "
	...
	strings :
		...
		$a_00_1 = {49 3b 66 10 0f 86 e9 00 00 00 48 83 ec 40 48 89 6c 24 38 48 8d 6c 24 38 48 ba a3 e0 84 65 9e 46 a4 9c 48 89 54 24 1f 48 ba 65 9e 46 a4 9c 84 d0 a8 48 89 54 24 22 48 ba 01 05 06 01 08 02 07 09 48 89 54 24 2a 48 ba 07 09 0a 0a 00 01 00 04 48 89 54 24 30 31 c0 eb 1a 44 0f b6 4c 34 1f 41 8d 14 11 8d 52 8e 88 54 3c 1f 44 88 44 34 1f 48 83 } //00 00 
	condition:
		any of ($a_*)
