...
rule HackTool_MacOS_Keygen_MTB{
	...
	strings :
		...
		$a_00_2 = {4b 47 53 65 72 69 61 6c 4e 75 6d 62 65 72 47 65 6e 65 72 61 74 6f 72 20 63 72 65 61 74 65 53 65 72 69 61 6c 3a } //01 00  KGSerialNumberGenerator createSerial:
		$a_00_3 = {5f 6d 6f 75 73 65 49 73 48 6f 76 65 72 69 6e 67 } //01 00  _mouseIsHovering
		$a_00_4 = {43 4f 52 45 20 4b 65 79 67 65 6e } //00 00  CORE Keygen
	condition:
		any of ($a_*)
