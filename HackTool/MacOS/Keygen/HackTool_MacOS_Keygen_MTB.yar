...
rule HackTool_MacOS_Keygen_MTB{
	...
	strings :
		$a_02_0 = {43 4f 52 45 20 4b 65 79 67 65 6e 2e 62 75 69 6c 64 2f 4f 62 6a 65 63 74 73 2d 6e 6f 72 6d 61 6c 2f [0-04] 2f 6d 61 69 6e 2e 6f } //1
		$a_02_1 = {43 4f 52 45 5f 4b 47 2e 62 75 69 6c 64 2f 4f 62 6a 65 63 74 73 2d 6e 6f 72 6d 61 6c 2f [0-04] 2f 6d 61 69 6e 2e 6f } //1
