...
rule HackTool_MacOS_SuspPythonCmd_A_ReverseShellSsl{
	...
	strings :
		...
		$a_02_5 = {6f 00 73 00 2e 00 73 00 65 00 74 00 75 00 69 00 64 00 90 02 02 28 00 90 02 02 30 00 90 00 } //15
		...
		$a_02_8 = {63 00 6f 00 6e 00 6e 00 65 00 63 00 74 00 90 02 02 28 00 90 00 } //5
