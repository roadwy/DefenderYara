...
rule HackTool_AndroidOS_UsbCleaver_A_MTB{
	...
	strings :
		...
		$a_02_3 = {63 70 20 2f 73 64 63 61 72 64 2f 44 6f 77 6e 6c 6f 61 64 2f 90 02 10 20 2f 64 61 74 61 2f 64 61 74 61 2f 63 6f 6d 2e 62 75 67 74 72 6f 69 64 2f 90 00 } //1
