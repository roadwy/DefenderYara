...
rule HackTool_AndroidOS_Whapsni_A_MTB{
	...
	strings :
		...
		$a_03_4 = {4c 63 6f 6d 2f 77 68 61 74 73 61 70 70 2f 73 6e 69 66 66 65 72 90 02 10 73 65 72 76 69 63 65 73 2f 41 72 70 73 70 6f 6f 66 53 65 72 76 69 63 65 90 00 } //1
	condition:
