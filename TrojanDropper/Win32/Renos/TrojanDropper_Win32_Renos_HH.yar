...
rule TrojanDropper_Win32_Renos_HH{
	...
	strings :
		...
		$a_00_7 = {46 69 6e 64 52 65 73 6f 75 72 63 65 41 00 } //01 00 
		$a_00_8 = {44 65 6c 65 74 65 46 69 6c 65 41 00 } //01 00 
		$a_00_9 = {53 65 74 46 69 6c 65 50 6f 69 6e 74 65 72 00 } //01 00 
		$a_00_10 = {57 49 4e 49 4e 45 54 2e 44 4c 4c 00 } //01 00 
		$a_00_11 = {4d 53 56 43 50 36 30 2e 64 6c 6c 00 } //00 00 
	condition:
		any of ($a_*)
