...
rule TrojanDropper_Win32_Surldoe_gen_A{
	...
	strings :
		...
		$a_00_4 = {68 00 74 00 74 00 70 00 3a 00 2f 00 2f 00 77 00 77 00 77 00 2e 00 65 00 78 00 65 00 6a 00 6f 00 69 00 6e 00 65 00 72 00 2e 00 63 00 6f 00 6d 00 } //65516 http://www.exejoiner.com
		$a_01_5 = {5c 5c 2e 5c 53 4d 41 52 54 56 53 44 } //65516 \\.\SMARTVSD
	condition:
		((#a_03_0  & 1)*1+(#a_01_1  & 1)*1+(#a_03_2  & 1)*1+(#a_01_3  & 1)*1+(#a_00_4  & 1)*65516+(#a_01_5  & 1)*65516) >=3
