...
rule TrojanDropper_Win32_Dowque_A{
	...
	strings :
		...
		$a_00_2 = {45 78 70 6c 6f 72 65 72 5c 50 4c 55 47 49 4e 53 5c } //01 00  Explorer\PLUGINS\
		$a_01_3 = {48 6f 6f 6b 4f 6e } //02 00  HookOn
		$a_00_4 = {69 66 20 65 78 69 73 74 20 22 } //01 00  if exist "
		$a_00_5 = {45 78 70 6c 6f 72 65 72 5c 53 68 65 6c 6c 45 78 65 63 75 74 65 48 6f 6f 6b 73 } //01 00  Explorer\ShellExecuteHooks
		$a_00_6 = {53 79 73 74 65 6d 4b 62 } //00 00  SystemKb
	condition:
		any of ($a_*)
