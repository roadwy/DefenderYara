...
rule TrojanDropper_Win32_Wlock_A{
	...
	strings :
		$a_03_0 = {24 01 3c 01 74 04 d2 0b eb 02 d2 03 8a 85 90 01 02 ff ff 30 03 90 00 } //2
		$a_03_1 = {c6 41 05 ff 8b 95 90 01 02 ff ff 03 95 90 01 02 ff ff c6 42 06 e3 c7 85 90 01 02 ff ff 00 00 00 00 90 00 } //2
