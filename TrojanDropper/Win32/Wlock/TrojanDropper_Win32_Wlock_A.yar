...
rule TrojanDropper_Win32_Wlock_A{
	...
	strings :
		...
		$a_00_2 = {2f 76 20 77 6c 6f 63 6b 5f 64 65 6c 20 2f 74 20 52 45 47 5f 53 5a 20 2f 64 20 22 63 6d 64 20 2f 63 20 64 65 6c } //01 00 
		$a_00_3 = {5c 57 69 6e 6c 6f 67 6f 6e 22 20 2f 76 20 55 73 65 72 69 6e 69 74 20 2f 74 20 52 45 47 5f 53 5a 20 2f 64 20 22 25 57 49 4e 44 49 52 25 } //00 00 
	condition:
		any of ($a_*)
