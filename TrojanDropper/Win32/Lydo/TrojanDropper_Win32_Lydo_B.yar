...
rule TrojanDropper_Win32_Lydo_B{
	...
	strings :
		...
		$a_00_1 = {4c 00 59 00 4d 00 41 00 4e 00 47 00 52 00 2e 00 44 00 4c 00 4c 00 } //01 00 
		$a_00_2 = {4d 00 53 00 44 00 45 00 47 00 33 00 32 00 2e 00 44 00 4c 00 4c 00 } //01 00 
		$a_00_3 = {52 00 45 00 47 00 4b 00 45 00 59 00 2e 00 48 00 49 00 56 00 } //01 00 
		$a_00_4 = {4c 6f 61 64 52 65 73 6f 75 72 63 65 } //01 00 
		$a_00_5 = {52 74 6c 5a 65 72 6f 4d 65 6d 6f 72 79 } //01 00 
		$a_00_6 = {57 72 69 74 65 46 69 6c 65 } //0a 00 
