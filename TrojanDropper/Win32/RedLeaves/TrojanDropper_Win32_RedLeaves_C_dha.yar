...
rule TrojanDropper_Win32_RedLeaves_C_dha{
	...
	strings :
		...
		$a_01_4 = {43 89 9d cc f5 ff ff 89 18 83 c9 ff 83 38 09 7f 1a 8b 95 d8 f5 ff ff 41 83 f9 51 7c 99 8b 85 d0 f5 ff ff 8b 9d d4 f5 ff ff eb 1b 8b 9d d4 f5 ff ff c7 00 00 00 00 00 8b 85 d0 f5 ff ff 8b 10 4a 83 eb 02 83 e8 08 83 fb ff 7c 18 b9 01 00 00 00 } //00 00 
	condition:
		any of ($a_*)
