...
rule TrojanDropper_Win32_Twores{
	...
	strings :
		...
		$a_03_5 = {8a 44 10 ff 8a 54 1d ff 32 c2 88 07 47 43 8b c5 e8 90 01 04 3b d8 7e 05 bb 01 00 00 00 ff 44 24 90 01 01 4e 75 90 00 } //10
		$a_03_6 = {83 e8 01 72 0a 74 1b 48 74 2b 48 74 3b eb 4a 68 04 01 00 00 8d 85 90 01 02 ff ff 50 e8 90 00 } //10
	condition:
