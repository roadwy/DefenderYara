...
rule TrojanDropper_Win32_Hokobot_A_dha{
	...
	strings :
		...
		$a_00_2 = {5e 2a 21 23 5e 60 7c 77 69 6e 73 65 63 2e 64 6c 6c 5e 2a 21 23 5e 60 7c 77 69 6e 69 6e 65 74 2e 65 78 65 } //01 00 
		$a_00_3 = {54 56 71 51 41 41 4d 41 41 41 41 45 41 41 41 41 2f 2f } //00 00 
