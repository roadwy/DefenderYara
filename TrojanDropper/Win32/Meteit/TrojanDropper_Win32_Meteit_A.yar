...
rule TrojanDropper_Win32_Meteit_A{
	...
	strings :
		...
		$a_03_1 = {5c 6d 73 61 64 6f 90 02 04 2e 90 00 } //1
		$a_03_2 = {83 c4 14 8d 85 90 01 02 ff ff 68 90 01 04 50 8d 45 90 01 01 50 ff 15 90 01 04 8d 85 90 01 02 ff ff 50 8d 85 90 01 02 ff ff 50 ff 15 90 01 04 83 f8 ff 74 09 8d 85 90 01 02 ff ff 50 ff d7 90 00 } //1
	condition:
