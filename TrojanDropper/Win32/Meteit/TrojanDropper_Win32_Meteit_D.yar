...
rule TrojanDropper_Win32_Meteit_D{
	...
	strings :
		$a_03_0 = {8b 54 24 04 33 c0 8a 0a 84 c9 74 90 01 01 6b c0 1f 0f be c9 03 c1 42 90 00 } //1
		$a_01_1 = {8b 48 04 ff 45 08 83 e9 08 42 d1 e9 42 39 4d 08 72 } //2
		$a_03_2 = {8b 46 08 8b 4d 08 8b 04 88 83 f8 ff 74 90 01 01 50 ff 57 08 90 00 } //1
