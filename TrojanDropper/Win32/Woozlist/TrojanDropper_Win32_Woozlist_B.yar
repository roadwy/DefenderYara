...
rule TrojanDropper_Win32_Woozlist_B{
	...
	strings :
		$a_01_0 = {6b 72 6e 6c 6e 2e 66 6e 72 } //01 00  krnln.fnr
		...
		$a_01_2 = {5c 00 44 00 6f 00 73 00 44 00 65 00 76 00 69 00 63 00 65 00 73 00 5c 00 62 00 61 00 62 00 79 00 } //01 00  \DosDevices\baby
		...
		$a_01_5 = {2f 67 6f 6e 67 67 61 6f 2e 74 78 74 2f } //05 00  /gonggao.txt/
		$a_01_6 = {2e 74 6d 70 } //00 00  .tmp
...
rule TrojanDropper_Win32_Woozlist_B_2{
	...
	strings :
		...
		$a_01_2 = {64 30 39 66 32 33 34 30 38 31 38 35 31 31 64 33 39 36 66 36 61 61 66 38 34 34 63 37 65 33 32 35 } //01 00  d09f2340818511d396f6aaf844c7e325
		$a_01_3 = {37 30 37 63 61 33 37 33 32 32 34 37 34 66 36 63 61 38 34 31 66 30 65 32 32 34 66 34 62 36 32 30 } //01 00  707ca37322474f6ca841f0e224f4b620
		$a_03_4 = {5c 65 74 63 5c 68 6f 73 74 73 90 02 10 68 74 74 70 3a 2f 2f 90 00 } //01 00 
		$a_01_5 = {46 72 6f 6d 3a 20 25 73 } //01 00  From: %s
		$a_01_6 = {53 75 62 6a 65 63 74 3a 20 25 73 } //01 00  Subject: %s
		$a_01_7 = {43 3a 5c 75 73 65 72 2e 65 78 65 } //00 00  C:\user.exe
...
rule TrojanDropper_Win32_Woozlist_B_3{
	...
	strings :
		...
		$a_01_2 = {64 30 39 66 32 33 34 30 38 31 38 35 31 31 64 33 39 36 66 36 61 61 66 38 34 34 63 37 65 33 32 35 } //01 00  d09f2340818511d396f6aaf844c7e325
		$a_01_3 = {37 30 37 63 61 33 37 33 32 32 34 37 34 66 36 63 61 38 34 31 66 30 65 32 32 34 66 34 62 36 32 30 } //01 00  707ca37322474f6ca841f0e224f4b620
		$a_01_4 = {46 72 6f 6d 3a 20 25 73 } //01 00  From: %s
		$a_01_5 = {53 75 62 6a 65 63 74 3a 20 25 73 } //01 00  Subject: %s
		...
		$a_01_7 = {43 3a 5c 66 73 64 6c 6b 6a 73 6b 6c 2e 65 78 65 } //01 00  C:\fsdlkjskl.exe
