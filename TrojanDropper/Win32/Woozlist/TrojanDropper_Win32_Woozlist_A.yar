...
rule TrojanDropper_Win32_Woozlist_A{
	...
	strings :
		...
		$a_01_2 = {5c 64 72 69 76 65 72 73 5c 65 74 63 5c 68 6f 73 74 73 } //01 00 
		$a_01_3 = {73 72 63 3d 22 25 75 72 6c 25 22 3e 3c 2f 69 66 72 61 6d 65 3e } //01 00 
		$a_01_4 = {00 50 6f 6c 69 63 79 41 67 65 6e 74 00 } //01 00 
		$a_01_5 = {77 73 32 5f 33 32 2e 64 6c 6c 5c 68 6f 6f 6b 64 66 } //01 00 
		$a_01_6 = {25 73 5c 63 6d 64 20 2f 63 20 72 64 20 22 25 73 22 20 2f 53 20 2f 51 } //01 00 
		...
		$a_01_8 = {50 72 6f 63 65 73 73 4d 6f 69 6e 74 65 72 } //00 00 
