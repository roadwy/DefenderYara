...
rule TrojanDropper_Win32_Hupigon_UC{
	...
	strings :
		...
		$a_02_3 = {00 43 3a 5c 77 77 77 5c 68 75 69 67 65 7a 69 38 90 01 03 2e 63 90 00 } //1
		$a_02_4 = {00 43 3a 5c 77 77 77 5c 68 75 69 67 65 7a 69 35 90 01 03 2e 63 90 00 } //1
	condition:
