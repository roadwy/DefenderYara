...
rule TrojanDropper_Win32_Perkesh_B{
	...
	strings :
		...
		$a_02_1 = {68 3f 00 0f 00 6a 00 6a 00 e8 90 01 04 89 45 ec 33 c0 55 68 90 01 03 00 64 ff 30 64 89 20 83 7d ec 00 74 75 6a 00 6a 00 6a 00 6a 00 6a 00 53 6a 00 6a 03 6a 01 6a 30 90 02 20 3d 31 04 00 00 90 00 } //1
