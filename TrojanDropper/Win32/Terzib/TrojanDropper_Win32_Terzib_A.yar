...
rule TrojanDropper_Win32_Terzib_A{
	...
	strings :
		$a_02_0 = {33 c0 b1 85 8a 90 01 03 40 00 32 d1 88 90 01 03 40 00 40 3d 80 54 01 00 72 ea 56 68 80 54 01 00 6a 01 68 90 01 02 40 00 e8 90 01 01 00 00 00 90 00 } //1
