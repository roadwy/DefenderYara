...
rule TrojanDropper_Win32_Notodar_A_{
	...
	strings :
		...
		$a_03_1 = {8b 4d 7c 83 c4 14 6a 0a 6a 1e 58 8d 7d dc e8 90 01 04 53 8b c7 50 68 02 00 00 80 e8 90 01 04 8b f8 3b fe 75 11 53 8d 45 dc 50 68 01 00 00 80 e8 90 00 } //1
