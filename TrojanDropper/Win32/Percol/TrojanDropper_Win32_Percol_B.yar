...
rule TrojanDropper_Win32_Percol_B{
	...
	strings :
		$a_90_0 = {43 3a 5c 50 72 6f 67 72 61 6d 20 46 69 6c 65 73 5c 5c 41 41 56 5c 5c 43 44 72 69 76 65 72 2e 73 79 73 } //01 00 
		$a_01_1 = {43 44 72 69 76 65 72 2e 49 6e 66 } //01 00 
		$a_01_2 = {2a 43 44 72 69 76 65 72 } //01 00 
