...
rule TrojanDropper_Win32_Pedrp_A{
	...
	strings :
		...
		$a_03_1 = {83 c9 ff 33 c0 c6 44 24 ?? 76 c6 44 24 ?? 6f c6 44 24 ?? 2e c6 44 24 ?? 68 88 54 24 10 } //1
		$a_03_2 = {f3 a5 8b cb 68 80 00 00 00 83 e1 03 f3 a4 8b 3d ?? ?? ?? ?? 6a 03 50 6a 01 8d 44 24 ?? 68 00 00 00 80 50 ff d7 } //1
