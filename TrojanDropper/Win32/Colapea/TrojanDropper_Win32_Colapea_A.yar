...
rule TrojanDropper_Win32_Colapea_A{
	...
	strings :
		...
		$a_01_2 = {30 78 32 33 34 32 32 34 34 68 20 69 6e 20 55 73 65 72 33 32 2e 64 6c 6c } //01 00  0x2342244h in User32.dll
		$a_01_3 = {57 45 20 53 49 4c 49 4e 45 45 2c 20 51 55 49 43 4b 45 52 2c } //00 00  WE SILINEE, QUICKER,
	condition:
		any of ($a_*)
