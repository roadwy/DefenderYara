...
rule TrojanDropper_Win32_Zegost_W{
	...
	strings :
		$a_03_0 = {50 ff d6 8d 85 90 01 02 ff ff 50 ff 15 90 01 04 8b 75 fc 81 be 90 01 02 00 00 20 01 00 00 8d 46 10 50 74 0d 68 90 01 04 e8 90 01 02 ff ff 59 eb 05 90 00 } //2
