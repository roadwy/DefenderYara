...
rule TrojanDropper_Win32_Zegost_E{
	...
	strings :
		...
		$a_01_3 = {2e 6a 70 67 } //01 00 
		$a_01_4 = {69 61 6d 73 6c 65 65 70 69 6e 67 } //01 00 
		$a_01_5 = {6c 6b 6e 78 6f 74 64 } //01 00 
		$a_01_6 = {46 64 72 31 33 38 69 70 32 } //01 00 
		$a_01_7 = {73 67 66 64 66 64 73 35 38 72 } //00 00 
	condition:
		any of ($a_*)
