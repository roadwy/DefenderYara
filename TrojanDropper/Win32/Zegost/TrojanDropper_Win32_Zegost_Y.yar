...
rule TrojanDropper_Win32_Zegost_Y{
	...
	strings :
		...
		$a_03_3 = {c6 44 24 10 7e 89 44 24 04 89 44 24 08 8d 44 24 00 c6 44 24 11 4d 50 68 90 01 04 68 02 00 00 80 c6 44 24 1e 48 c6 44 24 1f 7a c6 44 24 20 00 90 00 } //1
	condition:
