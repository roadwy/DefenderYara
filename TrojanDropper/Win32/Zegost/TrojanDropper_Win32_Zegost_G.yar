...
rule TrojanDropper_Win32_Zegost_G{
	...
	strings :
		$a_02_0 = {46 75 63 6b 59 6f 75 90 02 10 53 4f 46 54 57 41 52 45 5c 4d 69 63 72 6f 73 6f 66 74 5c 57 69 6e 64 6f 77 73 20 4e 54 5c 43 75 72 72 65 6e 74 56 65 72 73 69 6f 6e 5c 53 76 63 68 6f 73 74 90 02 10 46 75 63 6b 59 6f 75 90 00 } //2
		...
		$a_03_2 = {80 04 11 7a 03 ca 8b 90 01 02 80 34 11 19 03 ca 42 3b 90 01 01 7c 90 00 } //1
		$a_02_3 = {25 73 3a 5c 44 6f 63 75 6d 65 6e 74 73 20 61 6e 64 20 53 65 74 74 69 6e 67 73 5c 4c 6f 63 61 6c 20 53 65 72 76 65 72 90 02 10 57 69 6e 64 73 90 00 } //1
...
rule TrojanDropper_Win32_Zegost_G_2{
	...
	strings :
		$a_03_0 = {68 3f 00 0f 00 8d 4d 90 01 01 6a 00 90 01 01 68 02 00 00 80 c6 45 90 01 01 4f c6 45 90 01 01 46 c6 45 90 01 01 54 c6 45 90 01 01 57 c6 45 90 01 01 41 c6 45 90 01 01 52 c6 45 90 01 01 45 c6 45 90 01 01 33 c6 45 90 01 01 36 90 00 } //5
		$a_03_1 = {53 50 ff 75 90 01 01 c6 45 90 01 01 6e c6 45 90 01 01 65 c6 45 90 01 01 74 c6 45 90 01 01 73 c6 45 90 01 01 76 c6 45 90 01 01 63 c6 45 90 01 01 73 88 5d 90 01 01 ff 15 90 00 } //4
		...
		$a_03_11 = {6a 02 6a 00 68 00 fc ff ff 56 ff 15 90 01 04 68 00 04 00 00 e8 90 00 } //3
		$a_80_12 = {25 73 5c 25 73 33 32 2e 64 6c 6c } //%s\%s32.dll  1
		$a_03_13 = {68 02 00 00 80 c7 45 90 01 01 20 01 00 00 c6 45 90 01 01 54 c6 45 90 01 01 79 c6 45 90 01 01 70 c6 45 90 01 01 65 c6 45 90 01 01 00 e8 90 00 } //3
		$a_03_14 = {00 80 b8 7f 75 90 01 01 8b 44 24 90 01 01 85 c0 75 90 00 } //2
		$a_03_15 = {00 08 f5 7f 75 90 01 01 8b 44 24 90 01 01 85 c0 75 90 00 } //2
		$a_03_16 = {6a 00 50 c6 44 24 90 01 01 73 c6 44 24 90 01 01 74 c6 44 24 90 01 01 61 c6 44 24 90 01 01 6c c6 44 24 90 01 01 6c c6 44 24 90 01 01 4d c6 44 24 90 01 01 6f c6 44 24 90 01 01 64 c6 44 24 90 01 01 75 c6 44 24 90 01 01 6c 88 5c 24 90 00 } //2
	condition:
