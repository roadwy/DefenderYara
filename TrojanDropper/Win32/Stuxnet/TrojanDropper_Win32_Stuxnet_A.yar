...
rule TrojanDropper_Win32_Stuxnet_A{
	...
	strings :
		$a_03_0 = {56 8b 70 3c 03 f0 81 3e 50 45 00 00 74 04 33 c0 5e 90 02 08 0f b7 46 14 53 57 8d 7c 30 18 33 c0 33 db 66 3b 46 06 73 90 00 } //3
		...
		$a_03_3 = {81 38 0d 12 39 ae 75 90 01 01 8b 54 24 10 83 c0 04 89 02 8b 44 24 14 90 00 } //3
