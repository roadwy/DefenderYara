...
rule TrojanDropper_Win32_Lespy_gen_A{
	...
	strings :
		...
		$a_02_2 = {73 63 72 69 70 74 00 6d 79 63 6c 6f 73 65 65 76 65 6e 74 67 6c 6f 62 61 66 72 61 6d 65 72 6c 31 00 3a 6c 0d 0a 64 65 6c 20 25 73 0d 0a 69 66 [0-01] 65 78 69 73 74 20 25 73 20 67 6f 74 6f 20 6c 0d 0a 64 65 6c 20 25 73 00 64 65 6c 74 2e 62 61 74 00 6f 70 65 6e } //10
