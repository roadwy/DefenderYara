...
rule TrojanDropper_Win32_Microjoin_M{
	...
	strings :
		$a_03_0 = {c1 c2 03 32 10 40 80 38 00 75 f5 8b 04 24 83 04 24 02 8b fb 39 17 75 13 0f b7 00 c1 e0 02 03 44 ?? ?? 03 c5 8b 00 03 c5 ab eb 01 af 83 3f 00 75 e3 e2 } //1
