...
rule TrojanDropper_Win32_Microjoin_gen_B{
	...
	strings :
		$a_02_0 = {6a 0a 58 6a 04 59 60 57 e8 90 01 02 00 00 95 8b 55 3c 8b 74 2a 78 8d 74 2e 18 ad 91 ad 50 ad 03 c5 92 ad 03 c5 50 8b f2 ad 03 c5 33 d2 c1 c2 03 32 10 40 80 38 00 90 00 } //10
		...
		$a_02_3 = {8b 73 68 ff 53 54 eb 13 ff 53 20 eb 0e ff 53 14 eb 09 8b 90 01 02 58 5a 50 52 ff d1 80 7d 00 00 90 00 } //1
	condition:
