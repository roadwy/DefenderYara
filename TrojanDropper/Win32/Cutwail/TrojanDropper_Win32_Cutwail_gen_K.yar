...
rule TrojanDropper_Win32_Cutwail_gen_K{
	...
	strings :
		$a_03_0 = {33 f6 66 be c5 ee 66 81 ee b6 ee 2b f1 2b fe eb ?? 33 c0 66 8b 07 c1 e0 02 8b 73 1c 03 f2 03 f0 ad 03 c2 } //1
		$a_00_1 = {8b 7d 08 8a 45 0c 8a e0 66 50 c1 e0 10 66 58 8b 4d 10 c1 e9 02 fc f2 ab 8b 4d 10 83 e1 03 f2 aa } //1
		$a_03_2 = {8b 45 f0 33 d2 b9 3d 00 00 00 f7 f1 8b 45 08 03 45 f8 8a 8a ?? ?? ?? ?? 88 08 } //1
	condition:
