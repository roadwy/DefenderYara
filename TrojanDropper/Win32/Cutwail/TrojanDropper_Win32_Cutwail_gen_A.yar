...
rule TrojanDropper_Win32_Cutwail_gen_A{
	...
	strings :
		...
		$a_02_1 = {8b 00 03 c6 05 80 00 00 00 8b 18 03 de 8b 43 0c 03 45 08 50 ff 15 90 02 06 89 45 fc 8b 33 03 75 08 8b 7b 10 03 7d 08 8b 0e 03 4d 08 41 41 51 ff 75 fc ff 15 90 01 04 89 07 83 c6 04 83 c7 04 83 3e 00 75 e2 90 00 } //1
	condition:
