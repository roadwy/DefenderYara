...
rule TrojanDropper_Win32_Obvod_A{
	...
	strings :
		$a_03_0 = {c3 85 db 74 0d 6a 02 6a 00 6a 00 56 ff 15 90 01 02 40 00 8b 5c 24 1c 8b 54 24 18 8d 4c 24 20 6a 00 90 00 } //5
		$a_01_1 = {32 da 40 3b c6 88 19 7c e6 5b } //5
		$a_03_2 = {ff d7 6a 00 8d 54 24 6c 68 90 01 02 40 00 52 e8 90 01 02 ff ff 8b 44 24 18 6a 00 50 8d 4c 24 7c 56 51 e8 90 00 } //6
