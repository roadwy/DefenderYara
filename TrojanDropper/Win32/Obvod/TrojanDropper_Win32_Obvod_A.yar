...
rule TrojanDropper_Win32_Obvod_A{
	...
	strings :
		...
		$a_01_3 = {25 73 7b 25 73 7d } //01 00  %s{%s}
		$a_01_4 = {2f 73 20 2f 69 20 25 73 } //01 00  /s /i %s
		$a_01_5 = {6e 75 6c 00 00 20 2f 63 20 64 65 6c 20 00 } //01 00 
		$a_01_6 = {63 6f 6c 6c 65 63 74 2f 62 2e 70 68 70 2f 25 64 2f 25 64 } //00 00  collect/b.php/%d/%d
	condition:
		any of ($a_*)
