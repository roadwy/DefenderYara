...
rule TrojanDropper_Win32_Zirit_D{
	...
	strings :
		$a_03_0 = {47 81 ff d0 07 00 00 7c c2 6a 00 e8 90 01 02 00 00 8b 54 24 14 83 c4 04 2b c2 3d 60 54 00 00 89 44 24 10 73 79 6a 00 e8 90 01 02 00 00 99 b9 14 00 00 00 83 c4 04 f7 f9 52 ff d5 90 00 } //4
...
rule TrojanDropper_Win32_Zirit_D_2{
	...
	strings :
		...
		$a_02_1 = {6a 00 6a 00 6a 00 6a 00 6a 00 6a 00 68 90 01 03 00 6a 00 ff 15 90 01 03 00 6a 04 8d 85 90 01 04 6a 00 50 ff 15 90 01 03 00 ff 15 90 01 03 00 50 6a 00 6a 11 ff 15 90 01 03 00 85 c0 74 09 6a 00 50 ff 15 90 01 03 00 5f 5e 8b e5 5d c3 90 00 } //4
