...
rule TrojanDropper_Win32_Keremod_A{
	...
	strings :
		...
		$a_00_2 = {25 73 5c 64 72 69 76 65 72 73 5c 25 73 2e 73 79 73 } //01 00 
		$a_00_3 = {73 63 2e 65 78 65 20 63 72 65 61 74 65 20 25 73 20 74 79 70 65 3d 20 6b 65 72 6e 65 6c } //01 00 
		$a_00_4 = {35 44 34 32 34 33 34 45 2d 42 43 41 33 2d 34 30 36 31 2d 39 46 41 43 2d 43 33 41 42 45 45 30 42 38 32 45 43 } //00 00 
	condition:
		any of ($a_*)
