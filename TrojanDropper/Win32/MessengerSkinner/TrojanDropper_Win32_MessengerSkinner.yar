...
rule TrojanDropper_Win32_MessengerSkinner{
	...
	strings :
		...
		$a_01_1 = {48 74 74 70 4f 70 65 6e 52 65 71 75 65 73 74 41 } //0a 00 
		$a_01_2 = {43 72 65 61 74 65 4d 75 74 65 78 41 } //02 00 
		$a_01_3 = {6d 65 73 73 65 6e 67 65 72 73 6b 69 6e 6e 65 72 2e 63 6f 6d } //01 00 
		...
		$a_01_6 = {4d 65 73 73 65 6e 67 65 72 53 6b 69 6e 6e 65 72 20 63 6f 75 6c 64 20 6e 6f 74 20 73 74 61 72 74 } //01 00 
