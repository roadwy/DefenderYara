...
rule TrojanDropper_Win32_Gamarue_gen_A{
	...
	strings :
		$a_03_0 = {99 b9 ff 00 00 00 f7 f9 4e 00 56 01 4f 75 ec 53 6a 06 6a 02 53 53 68 00 00 00 40 8d 95 90 01 02 ff ff 52 90 00 } //1
		$a_03_1 = {74 09 80 34 30 90 01 01 40 3b c7 72 f7 90 00 } //1
