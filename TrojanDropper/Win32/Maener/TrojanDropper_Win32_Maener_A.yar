...
rule TrojanDropper_Win32_Maener_A{
	...
	strings :
		$a_01_0 = {5c 4d 69 6e 69 6e 67 5f 66 72 61 6d 65 77 6f 72 6b 5c } //02 00  \Mining_framework\
		$a_01_1 = {00 52 61 75 6d 20 45 78 74 72 61 63 74 } //01 00 
		$a_01_2 = {00 5c 69 6e 74 65 6c 2e 65 78 65 } //01 00 
		$a_01_3 = {6f 72 69 67 69 6e 61 6c 5f 65 78 65 5f 6c 6f 6c } //05 00  original_exe_lol
