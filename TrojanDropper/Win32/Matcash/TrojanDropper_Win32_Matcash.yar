...
rule TrojanDropper_Win32_Matcash{
	...
	strings :
		...
		$a_01_1 = {53 68 65 6c 6c 45 78 65 63 75 74 65 41 } //0a 00 
		$a_01_2 = {52 65 67 53 65 74 56 61 6c 75 65 45 78 41 } //0a 00 
		$a_01_3 = {55 6e 68 6f 6f 6b 57 69 6e 64 6f 77 73 48 6f 6f 6b 45 78 } //01 00 
