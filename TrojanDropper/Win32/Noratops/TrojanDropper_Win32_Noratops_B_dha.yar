...
rule TrojanDropper_Win32_Noratops_B_dha{
	...
	strings :
		...
		$a_01_1 = {52 65 66 6c 65 63 74 69 76 65 4c 6f 61 64 65 72 } //01 00 
		$a_01_2 = {49 6e 6a 65 63 74 6f 72 2e 64 6c 6c } //01 00 
		$a_01_3 = {5f 64 65 63 } //01 00 
		$a_01_4 = {5f 5f 64 65 63 } //01 00 
		$a_01_5 = {56 00 25 00 64 00 00 00 } //01 00 
		$a_01_6 = {49 00 4e 00 46 00 4f 00 } //00 00 
	condition:
		any of ($a_*)
