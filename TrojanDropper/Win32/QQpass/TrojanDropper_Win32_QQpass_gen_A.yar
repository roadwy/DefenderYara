...
rule TrojanDropper_Win32_QQpass_gen_A{
	...
	strings :
		...
		$a_00_15 = {73 76 77 8b fa 8b f0 8b c6 e8 90 01 04 8b d8 eb 01 6b 85 db 7e 15 80 7c 1e ff 5c 74 0e 80 7c 1e ff 3a 74 07 80 7c 1e ff 2f 75 e6 77 8b c6 e8 90 01 04 8b c8 2b cb 8d 73 01 8b c6 e8 90 01 04 5f 5e 5b c3 90 00 } //5
		$a_00_16 = {73 33 db 6a 00 e8 ee ff ff ff 83 f8 07 75 1c 6a 01 e8 e2 ff ff ff } //5
		$a_00_17 = {75 2e 6a f4 53 e8 90 01 02 ff ff 3d b4 00 00 00 74 23 6a f0 53 e8 90 01 02 ff ff a8 20 75 17 6a 00 6a 00 68 d2 00 00 00 53 e8 90 01 02 ff ff 90 00 } //5
		...
		$a_02_26 = {53 6f 66 74 77 61 72 65 5c 90 02 03 5c 51 51 42 65 74 61 33 20 48 6f 6f 6b 65 72 90 00 } //15
		...
		$a_00_42 = {64 61 74 61 0d 0a 00 00 ff ff ff ff 90 01 01 00 00 00 66 72 6f 6d 3a 20 3c 90 00 } //5
