...
rule TrojanDropper_Win32_Chyup_A{
	...
	strings :
		$a_01_0 = {46 50 43 20 31 2e 30 2e 36 20 5b 32 30 30 32 2f 30 34 2f 32 33 5d 20 66 6f 72 20 69 33 38 36 20 2d 20 57 49 4e 33 32 } //01 00  FPC 1.0.6 [2002/04/23] for i386 - WIN32
