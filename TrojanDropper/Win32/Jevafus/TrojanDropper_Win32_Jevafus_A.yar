...
rule TrojanDropper_Win32_Jevafus_A{
	...
	strings :
		...
		$a_00_2 = {28 00 43 00 29 00 20 00 47 00 72 00 61 00 6e 00 64 00 73 00 6f 00 66 00 74 00 20 00 43 00 6f 00 72 00 70 00 2e 00 20 00 4c 00 74 00 64 00 2e 00 } //00 00  (C) Grandsoft Corp. Ltd.
	condition:
		any of ($a_*)
