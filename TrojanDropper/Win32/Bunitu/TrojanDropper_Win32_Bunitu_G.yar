...
rule TrojanDropper_Win32_Bunitu_G{
	...
	strings :
		$a_03_0 = {87 de 42 42 03 c3 4b 75 fa 5b bf 90 01 04 0f 31 c1 c0 03 50 48 8f 07 90 09 0a 00 90 02 08 d1 e6 90 00 } //2
		...
		$a_03_2 = {13 81 68 2d 90 01 04 83 68 2d 03 e8 90 01 04 e8 90 01 04 b8 02 00 00 80 e8 90 01 04 b9 00 00 00 00 83 3d 90 01 04 02 75 0f 3b c1 75 0b 90 00 } //2
