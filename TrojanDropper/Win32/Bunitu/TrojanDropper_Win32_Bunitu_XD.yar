...
rule TrojanDropper_Win32_Bunitu_XD{
	...
	strings :
		...
		$a_03_1 = {b8 02 30 00 00 48 48 50 ff 90 01 02 ff 90 01 02 ff 35 90 01 04 5a 68 90 01 03 00 52 c3 90 00 } //1
		$a_03_2 = {83 c0 7b 8b 0d 90 01 04 8b 15 90 01 04 66 89 44 4a 14 90 00 } //1
		$a_03_3 = {83 c0 7d 8b 0d 90 01 04 8b 15 90 01 04 66 89 44 4a 5e 90 00 } //1
