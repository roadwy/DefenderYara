...
rule TrojanDropper_Win32_Bradop_A{
	...
	strings :
		...
		$a_01_2 = {5c 72 75 6e 64 6c 6c 33 32 2e 65 78 65 00 00 4f 50 45 4e 00 } //01 00  牜湵汤㍬⸲硥e伀䕐N
		$a_01_3 = {4a 4c 66 49 6d 6f 58 33 41 4b 39 62 4b 63 79 58 } //00 00  JLfImoX3AK9bKcyX
	condition:
		any of ($a_*)
