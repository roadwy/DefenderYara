...
rule TrojanDropper_Win32_Bancos_A{
	...
	strings :
		$a_02_0 = {8b 55 d8 8d 45 dc b9 00 00 00 00 e8 90 01 02 fa ff 8b 45 dc e8 90 01 02 fa ff 50 e8 90 01 02 fa ff 8d 45 d4 50 8b cb ba 90 01 04 8b c6 90 00 } //10
