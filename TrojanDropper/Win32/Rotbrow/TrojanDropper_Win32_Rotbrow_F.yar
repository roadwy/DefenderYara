...
rule TrojanDropper_Win32_Rotbrow_F{
	...
	strings :
		...
		$a_01_2 = {43 68 72 6f 6d 65 50 72 6f 74 65 63 74 69 6f 6e 45 6e 61 62 6c 65 64 00 } //01 00 
		$a_01_3 = {61 70 70 6c 69 63 61 74 69 6f 6e 2f 78 2d 76 6e 64 2e 70 72 6f 74 65 63 74 6f 72 2e 73 65 74 74 69 6e 67 73 74 72 61 63 6b 65 72 } //00 00 
	condition:
		any of ($a_*)
