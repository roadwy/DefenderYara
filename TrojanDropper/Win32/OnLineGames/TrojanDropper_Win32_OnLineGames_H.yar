...
rule TrojanDropper_Win32_OnLineGames_H{
	...
	strings :
		$a_03_0 = {f7 f9 8a 82 90 01 04 8a 54 1f ff 32 c2 5a 88 02 43 4e 75 d7 90 00 } //2
		$a_03_1 = {6a 00 6a 00 68 f5 00 00 00 90 01 01 e8 90 01 02 ff ff 83 f8 01 90 00 } //1
