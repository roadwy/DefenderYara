...
rule TrojanDropper_Win32_Dogrobot_G{
	...
	strings :
		$a_03_0 = {85 c0 0f 84 ?? ?? 00 00 81 7d ?? 02 76 19 89 0f 85 ?? ?? 00 00 8b 45 0c 39 45 ?? 74 } //2
		$a_03_1 = {c1 ee 0b 0f af f7 39 75 10 73 ?? 8b d6 be 00 08 00 00 2b f7 c1 fe 05 03 f0 d1 e3 } //2
		$a_03_2 = {8b 5d 10 8b d3 83 c2 3c 8b ?? 03 ?? 83 c3 18 83 c3 10 8b 1b 8b 4d 0c 03 cb } //1
