...
rule TrojanDropper_Win32_Dogrobot_E{
	...
	strings :
		$a_01_0 = {65 78 74 25 73 25 64 74 2e 65 78 65 } //01 00 
		$a_01_1 = {74 65 25 73 25 64 74 2e 64 6c 6c } //01 00 
		$a_01_2 = {40 64 65 6c 20 33 35 39 36 37 39 39 61 31 35 34 33 62 63 39 66 2e 61 71 71 } //01 00 
		$a_01_3 = {61 66 63 39 66 65 32 66 34 31 38 62 30 30 61 30 2e 62 61 74 } //01 00 
		$a_01_4 = {5c 5c 2e 5c 70 63 69 64 75 6d 70 } //01 00 
