...
rule TrojanDropper_Win32_Sirefef_B{
	...
	strings :
		$a_02_0 = {8b 70 58 85 f6 75 90 01 01 be 53 50 43 33 e8 90 00 } //1
...
rule TrojanDropper_Win32_Sirefef_B_2{
	...
	strings :
		$a_02_0 = {81 f1 2e 8e 40 42 35 47 42 ca 72 89 4d f0 8b 0d 90 01 02 40 00 89 45 ec a1 90 01 02 40 00 81 f1 0a 30 76 9d 35 88 b3 5e bb 89 4d f8 32 c9 90 00 } //1
		$a_02_1 = {01 00 00 9d 90 90 68 90 01 02 41 00 6a 00 6a 00 68 90 01 02 41 00 6a fe ff 15 90 01 02 41 00 90 00 } //1
...
rule TrojanDropper_Win32_Sirefef_B_3{
	...
	strings :
		$a_03_0 = {8b f8 3b fe 74 42 53 68 90 01 04 6a fc 57 ff 15 90 01 04 6a 01 57 90 00 } //3
		...
		$a_03_7 = {8b 48 fc 83 c0 28 4a f3 a4 75 ea 33 c0 8d bd 90 01 04 b9 90 01 04 f3 ab c7 85 90 01 04 10 00 01 00 c7 90 00 } //7
	condition:
...
rule TrojanDropper_Win32_Sirefef_B_4{
	...
	strings :
		$a_03_0 = {8b 48 fc 83 c0 28 4a f3 a4 75 ea 33 c0 8d bd 90 01 04 b9 90 01 04 f3 ab c7 85 90 01 04 10 00 01 00 c7 90 00 } //7
	condition:
		((#a_03_0  & 1)*7) >=7
