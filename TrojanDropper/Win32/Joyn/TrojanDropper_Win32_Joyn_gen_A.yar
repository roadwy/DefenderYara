...
rule TrojanDropper_Win32_Joyn_gen_A{
	...
	strings :
		$a_02_0 = {6a 00 68 80 00 00 00 6a 30 6a 30 6a 02 68 00 00 00 40 68 90 01 04 e8 90 00 } //1
		$a_02_1 = {68 04 01 00 00 e8 90 01 04 6a 01 68 90 01 04 6a 00 68 90 01 04 68 90 01 04 6a 90 01 01 e8 90 01 04 b8 01 00 00 00 c9 c2 10 00 90 00 } //1
		$a_03_2 = {4e 00 4a 00 4f 00 59 00 90 02 30 2e 00 4a 00 50 00 47 00 90 00 } //1
	condition:
...
rule TrojanDropper_Win32_Joyn_gen_A_2{
	...
	strings :
		...
		$a_03_5 = {6a 00 68 80 00 00 00 6a 90 03 01 01 02 30 6a 00 6a 02 68 00 00 00 40 68 90 01 04 e8 90 01 04 89 45 f8 6a 00 8d 45 fc 50 ff 75 e8 ff 75 ec ff 75 f8 e8 90 01 04 ff 75 f8 e8 90 01 04 68 90 01 04 68 04 01 00 00 e8 90 01 04 6a 01 68 90 01 04 6a 00 68 90 01 04 68 90 01 04 6a 00 e8 90 00 } //10
	condition:
