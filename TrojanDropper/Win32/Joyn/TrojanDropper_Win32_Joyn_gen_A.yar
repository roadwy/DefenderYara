...
rule TrojanDropper_Win32_Joyn_gen_A_2{
	...
	strings :
		$a_00_0 = {45 6e 75 6d 52 65 73 6f 75 72 63 65 4e 61 6d 65 73 41 } //01 00  EnumResourceNamesA
		$a_00_1 = {4c 6f 61 64 52 65 73 6f 75 72 63 65 } //01 00  LoadResource
		$a_00_2 = {53 69 7a 65 6f 66 52 65 73 6f 75 72 63 65 } //04 00  SizeofResource
		$a_00_3 = {00 4f 50 45 4e 00 } //05 00  伀䕐N
