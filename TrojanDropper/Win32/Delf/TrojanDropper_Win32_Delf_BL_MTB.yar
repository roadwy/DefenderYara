...
rule TrojanDropper_Win32_Delf_BL_MTB{
	...
	strings :
		...
		$a_01_1 = {6d 70 63 7a 26 2a 6e 6f 6c 66 6b 7e 6f } //01 00 
		$a_01_2 = {25 63 64 6e 6f 72 25 6d 6f 7e 69 6c 6d 35 63 6e 37 } //01 00 
		$a_01_3 = {2f 69 6e 64 65 78 2f 67 65 74 63 66 67 3f 69 64 3d } //00 00 
