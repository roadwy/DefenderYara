...
rule TrojanDropper_Win32_Nuwar_gen_A{
	...
	strings :
		...
		$a_02_2 = {81 e0 ff 00 00 00 8b 4d f8 0f b6 09 31 c1 8b 45 f8 88 08 eb ?? c9 c3 } //1
		$a_02_3 = {81 e0 ff 00 00 00 88 45 ?? 8b 45 08 8b 4d fc 01 c8 0f b6 4d ?? 0f b6 55 ?? 31 d1 88 08 eb ?? c9 c3 } //1
		$a_02_4 = {81 e0 ff 00 00 00 [0-03] 88 45 ?? 8b 45 08 8b 4d fc 01 c8 0f b6 4d ?? 51 0f b6 4d ?? 51 89 45 [0-40] 88 01 (eb ?? e9 ??|?? ?? ?? c9) c3 } //1
	condition:
