...
rule TrojanDropper_Win32_Nuwar_gen_C{
	...
	strings :
		...
		$a_03_1 = {8b 0e 8b d8 8b 01 ff 50 14 50 53 ff 15 90 01 04 8b 0e 8b 11 50 ff 12 8b 0e 8b 01 ff 50 04 47 83 ff 90 01 01 72 90 01 01 68 90 01 04 ff 15 90 00 } //1
		$a_03_2 = {8d 41 1b ff d0 85 c0 7c 13 8b 07 a3 90 01 04 8b 06 a3 90 01 04 b8 03 00 00 40 5f 5e eb 21 ff 75 2c 90 00 } //1
	condition:
