...
rule TrojanDropper_Win32_Jhee_V{
	...
	strings :
		...
		$a_02_1 = {62 68 6f 2e 64 6c 6c 90 02 10 70 6c 61 79 2e 64 6c 6c 90 02 10 73 65 72 2e 65 78 65 90 00 } //1
		$a_02_2 = {31 2e 72 6d 90 02 10 31 2e 74 78 74 90 02 10 31 2e 62 6d 70 90 02 10 31 2e 65 78 65 90 00 } //1
