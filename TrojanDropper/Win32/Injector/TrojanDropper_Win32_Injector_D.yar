...
rule TrojanDropper_Win32_Injector_D{
	...
	strings :
		...
		$a_00_4 = {65 73 5c 43 6f 6d 6d 6f 6e 20 46 69 6c 65 73 5c 53 65 72 76 65 74 44 6f 77 6e 2e 65 78 65 } //01 00 
		$a_00_5 = {4e 44 4f 57 53 5c 53 59 53 54 45 4d 33 32 5c 6d 73 74 73 63 2e 65 78 65 } //01 00 
