...
rule TrojanDropper_Win32_Injector_D{
	...
	strings :
		$a_02_0 = {83 f8 01 1b db 43 84 db 74 90 01 01 c7 90 01 01 07 00 01 00 90 00 } //3
		$a_00_1 = {8d 04 19 48 33 d2 f7 f1 f7 e9 } //1
		$a_02_2 = {f6 c4 20 0f 85 90 01 02 00 00 a8 02 0f 84 90 01 02 00 00 90 00 } //1
		...
		$a_02_6 = {3a 38 30 38 30 2f 44 6f 77 90 02 03 2e 65 78 65 90 00 } //1
	condition:
