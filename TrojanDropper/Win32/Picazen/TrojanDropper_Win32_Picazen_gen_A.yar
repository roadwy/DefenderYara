...
rule TrojanDropper_Win32_Picazen_gen_A{
	...
	strings :
		...
		$a_02_2 = {5c 00 73 00 79 00 73 00 74 00 65 00 6d 00 33 00 32 00 5c 00 68 00 66 00 62 00 6c 00 64 00 64 00 65 00 6c 00 2e 00 62 00 61 00 74 00 90 02 06 53 00 59 00 53 00 54 00 45 00 4d 00 52 00 4f 00 4f 00 54 00 90 00 } //1
		$a_02_3 = {6f 00 70 00 65 00 6e 00 90 02 06 25 00 73 00 5c 00 25 00 73 00 90 02 04 5c 00 90 02 04 54 00 45 00 4d 00 50 00 90 00 } //1
