...
rule TrojanDropper_Win32_Daonol_E{
	...
	strings :
		...
		$a_03_4 = {c7 44 24 04 2e 2e 5c 00 54 68 3f 00 0f 00 6a 00 b8 90 01 04 ba 37 00 00 00 90 00 } //2
		$a_03_5 = {4e 83 fe 00 7c 16 b8 19 00 00 00 e8 90 01 02 ff ff 83 c0 61 88 03 43 4e 83 fe ff 75 ea c6 03 00 90 00 } //2
	condition:
