...
rule TrojanDropper_Win32_VB_DK{
	...
	strings :
		...
		$a_02_10 = {20 44 65 43 72 53 76 72 00 69 6c 65 20 00 61 72 44 69 72 20 26 00 00 00 00 88 00 00 00 00 00 00 00 02 00 00 00 0b 00 00 00 90 01 10 01 00 00 00 90 90 00 00 00 a0 00 00 00 01 00 00 00 52 75 6e 41 01 20 28 50 72 6f 00 00 20 3d 20 46 61 6c 73 65 53 6f 63 6b 65 74 00 20 90 00 } //100
	condition:
