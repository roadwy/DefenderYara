...
rule TrojanDropper_Win32_VB_GR{
	...
	strings :
		$a_01_0 = {5c 00 6d 00 6d 00 74 00 6d 00 70 00 2e 00 62 00 61 00 74 00 } //01 00 
		$a_01_1 = {6e 00 65 00 74 00 20 00 73 00 74 00 61 00 72 00 74 00 20 00 51 00 6f 00 53 00 76 00 63 00 } //01 00 
		...
		$a_00_3 = {69 6e 73 74 61 6c 6c 00 61 70 70 00 00 61 70 70 } //01 00 
