...
rule TrojanDropper_Win32_VB_EE{
	...
	strings :
		...
		$a_03_2 = {04 68 ff 6c 74 ff 04 60 ff 34 6c 60 ff f5 00 00 00 00 f5 01 00 00 00 f5 00 00 00 00 6c 70 ff 5e 90 01 04 71 58 ff 3c 6c 60 ff 04 74 ff fc 58 90 00 } //1
	condition:
