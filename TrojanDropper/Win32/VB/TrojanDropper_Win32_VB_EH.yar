...
rule TrojanDropper_Win32_VB_EH{
	...
	strings :
		...
		$a_03_2 = {f5 01 00 00 00 f5 00 00 00 00 f5 00 00 00 00 04 90 01 01 ff 3a e8 fe 1c 00 fb ef f8 fe 3e 90 01 01 ff 46 90 01 01 fe fb ef b0 fe fd fe 90 01 01 ff 04 90 01 01 ff 34 6c 90 01 01 ff f5 00 00 00 00 f5 00 00 00 00 0a 32 00 18 00 3c 90 00 } //1
	condition:
