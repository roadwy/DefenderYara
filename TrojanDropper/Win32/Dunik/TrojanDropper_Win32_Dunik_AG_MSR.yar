...
rule TrojanDropper_Win32_Dunik_AG_MSR{
	...
	strings :
		$a_01_0 = {43 3a 5c 67 75 73 69 74 69 20 6b 69 6a 69 63 65 5c 64 61 7a 20 77 69 6d 61 6b 61 63 6f 76 69 76 65 35 33 5c 74 6f 6c 75 6a 36 38 2d 70 2e 70 64 62 } //02 00  C:\gusiti kijice\daz wimakacovive53\toluj68-p.pdb
		...
		$a_01_4 = {47 6c 6f 62 61 6c 52 65 41 6c 6c 6f 63 } //01 00  GlobalReAlloc
		$a_01_5 = {43 6c 69 65 6e 74 54 6f 53 63 72 65 65 6e } //01 00  ClientToScreen
		$a_01_6 = {43 72 65 61 74 65 46 69 6c 65 41 } //00 00  CreateFileA
	condition:
		any of ($a_*)
...
rule TrojanDropper_Win32_Dunik_AG_MSR_2{
	...
	strings :
		$a_01_0 = {43 3a 5c 62 61 74 61 6a 61 68 75 70 75 64 6f 62 75 5c 6b 65 6d 6f 33 31 20 63 61 6d 61 6c 69 78 75 68 69 78 61 2d 68 69 66 61 70 5c 74 6f 77 6f 76 2e 70 64 62 } //01 00  C:\batajahupudobu\kemo31 camalixuhixa-hifap\towov.pdb
		...
		$a_01_3 = {48 65 61 70 52 65 41 6c 6c 6f 63 } //01 00  HeapReAlloc
		$a_01_4 = {43 6c 69 65 6e 74 54 6f 53 63 72 65 65 6e } //01 00  ClientToScreen
