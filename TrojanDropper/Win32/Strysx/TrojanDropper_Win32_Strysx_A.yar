...
rule TrojanDropper_Win32_Strysx_A{
	...
	strings :
		$a_02_0 = {75 2d 8d 44 24 10 50 e8 90 01 01 ff ff ff 59 ff 70 04 ff 15 90 01 02 15 13 8d 4c 24 10 8b f0 e8 90 01 01 01 00 00 68 90 01 02 15 13 56 ff 15 90 01 02 15 13 ff d0 5e 90 00 } //3
