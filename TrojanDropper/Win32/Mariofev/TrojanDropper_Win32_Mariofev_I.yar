...
rule TrojanDropper_Win32_Mariofev_I{
	...
	strings :
		...
		$a_01_4 = {26 44 69 73 61 62 6c 65 53 66 63 3d 25 64 2d 25 64 } //05 00  &DisableSfc=%d-%d
		$a_01_5 = {26 50 61 74 63 68 46 69 6c 65 3d 25 64 2d 25 64 } //01 00  &PatchFile=%d-%d
		$a_01_6 = {64 6c 6c 63 61 63 68 65 5c 6f 6c 65 33 32 2e 64 6c 6c } //01 00  dllcache\ole32.dll
		$a_01_7 = {44 45 50 41 43 4b 45 4e 44 } //00 00  DEPACKEND
	condition:
		any of ($a_*)
