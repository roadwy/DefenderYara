...
rule TrojanDropper_Win32_Mariofev_A{
	...
	strings :
		...
		$a_02_2 = {57 69 6e 64 6f 77 73 20 4e 54 5c 43 75 72 72 65 6e 74 56 65 72 73 69 6f 6e 5c 57 69 6e 64 6f 77 73 90 02 10 41 70 70 49 6e 69 74 5f 44 6c 6c 73 00 90 00 } //2
