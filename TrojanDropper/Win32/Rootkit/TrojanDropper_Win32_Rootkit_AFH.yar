...
rule TrojanDropper_Win32_Rootkit_AFH{
	...
	strings :
		...
		$a_03_1 = {68 80 00 00 00 6a 02 6a 00 6a 01 68 00 00 00 40 51 ff 15 90 01 02 00 10 8d 54 24 0c 6a 00 52 8b f0 68 00 1a 00 00 68 90 01 02 00 10 56 c7 44 24 20 00 00 00 00 ff 15 90 01 02 00 10 90 00 } //1
