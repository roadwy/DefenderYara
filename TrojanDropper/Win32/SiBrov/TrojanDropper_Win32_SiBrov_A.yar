...
rule TrojanDropper_Win32_SiBrov_A{
	...
	strings :
		...
		$a_01_1 = {47 65 74 46 69 6c 65 53 69 7a 65 } //01 00  GetFileSize
		$a_01_2 = {52 65 61 64 46 69 6c 65 } //01 00  ReadFile
		$a_01_3 = {43 72 65 61 74 65 46 69 6c 65 41 } //01 00  CreateFileA
		$a_01_4 = {47 65 74 4d 6f 64 75 6c 65 48 61 6e 64 6c 65 41 } //00 00  GetModuleHandleA
