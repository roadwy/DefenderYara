...
rule TrojanDropper_Win32_Rovnix_P{
	...
	strings :
		...
		$a_01_2 = {42 6b 49 6e 73 74 61 6c 6c 00 } //01 00 
		$a_01_3 = {6a 04 8d 4d d4 51 68 18 00 36 83 8b 55 dc 52 ff 15 } //01 00 
		$a_01_4 = {47 00 6c 00 6f 00 62 00 61 00 6c 00 5c 00 55 00 41 00 43 00 25 00 73 00 25 00 75 00 } //01 00 
		$a_01_5 = {47 00 6c 00 6f 00 62 00 61 00 6c 00 5c 00 42 00 44 00 25 00 73 00 25 00 75 00 } //00 00 
	condition:
		any of ($a_*)
