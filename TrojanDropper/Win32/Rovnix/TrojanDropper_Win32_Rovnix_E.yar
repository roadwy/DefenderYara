...
rule TrojanDropper_Win32_Rovnix_E{
	...
	strings :
		...
		$a_00_1 = {42 4b 49 6e 73 74 61 6c 6c } //01 00  BKInstall
		$a_00_2 = {42 00 4b 00 53 00 65 00 74 00 75 00 70 00 } //01 00  BKSetup
		$a_00_3 = {61 74 74 72 69 62 20 2d 72 20 2d 73 20 2d 68 25 25 31 } //01 00  attrib -r -s -h%%1
