...
rule TrojanDropper_Win32_Sharke_B{
	...
	strings :
		...
		$a_01_2 = {69 66 76 6b 63 6b 3b 3b 24 6f 60 61 } //01 00 
		$a_01_3 = {77 70 61 77 35 35 26 6d 66 67 } //01 00 
		$a_01_4 = {63 67 72 64 76 6e 3b 3b 24 6f 60 61 } //01 00 
		$a_01_5 = {75 6a 6a 6c 68 62 7c 27 6e 67 60 } //00 00 
	condition:
		any of ($a_*)
