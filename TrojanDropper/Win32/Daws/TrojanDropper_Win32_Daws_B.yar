...
rule TrojanDropper_Win32_Daws_B{
	...
	strings :
		...
		$a_03_6 = {b8 4d 5a 00 00 8b 9d 54 ff ff ff 0f b7 0b 3b c8 75 1e db 05 90 01 04 8b 9d 50 ff ff ff 8b 03 e8 90 01 04 de d9 df e0 9e 0f 84 05 00 00 00 e9 90 01 04 6a 00 31 c0 8b dc 53 89 03 8b c7 50 ff 15 90 00 } //5
	condition:
