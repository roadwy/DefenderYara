...
rule TrojanDropper_Win32_Nonaco_D{
	...
	strings :
		$a_01_0 = {53 6f 66 74 77 61 72 65 5c 4d 69 63 72 6f 73 6f 66 74 5c 49 6e 74 65 72 6e 65 74 20 45 78 70 6c 6f 72 65 72 5c 4d 61 69 6e } //02 00  Software\Microsoft\Internet Explorer\Main
		...
		$a_01_4 = {77 62 6c 6f 67 6f 6e 00 25 73 25 73 } //00 00  扷潬潧n猥猥
	condition:
		any of ($a_*)
