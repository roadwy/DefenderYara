...
rule TrojanDropper_Win32_Alpasog_A{
	...
	strings :
		...
		$a_01_3 = {63 3a 5c 77 69 6e 64 6f 77 73 5c 6e 6f 74 65 2e 69 6e 69 } //01 00 
		$a_01_4 = {75 64 2e 62 61 74 } //01 00 
		$a_01_5 = {25 53 79 73 74 65 6d 52 6f 6f 74 25 5c 53 79 73 74 65 6d 33 32 5c 73 76 63 68 6f 73 74 2e 65 78 65 20 2d 6b 20 6e 65 74 73 76 63 73 } //00 00 
