...
rule TrojanDropper_Win32_Scudy_A{
	...
	strings :
		...
		$a_01_1 = {45 6e 75 6d 52 65 73 4e 61 6d 65 50 72 6f 63 3a 3a 46 69 6e 64 52 65 73 6f 75 72 63 65 } //01 00 
		$a_01_2 = {53 68 6f 77 53 75 70 65 72 48 69 64 64 65 6e } //01 00 
