...
rule TrojanDropper_Win32_Dapato_V_MTB{
	...
	strings :
		$a_02_0 = {8b d6 6a 08 c1 e2 90 01 01 59 f7 c2 00 00 00 80 74 90 01 01 03 d2 81 f2 b7 1d c1 04 eb 90 01 01 d1 e2 49 75 90 01 01 89 17 46 83 c7 90 01 01 81 fe 00 01 00 00 7c 90 00 } //1
