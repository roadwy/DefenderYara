...
rule TrojanDropper_Win32_QQplug_A{
	...
	strings :
		...
		$a_03_1 = {33 f6 50 68 90 01 02 40 00 6a 69 56 e8 90 01 02 ff ff 83 c4 10 89 90 01 01 f0 90 00 } //1
		$a_03_2 = {56 50 8d 45 fc 6a 02 50 ff 75 f8 c7 45 fc 50 45 00 00 ff d7 ff 75 f8 ff 15 90 01 02 40 00 5f 90 00 } //1
	condition:
