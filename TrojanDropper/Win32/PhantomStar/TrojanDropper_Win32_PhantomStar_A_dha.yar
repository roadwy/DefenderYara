...
rule TrojanDropper_Win32_PhantomStar_A_dha{
	...
	strings :
		...
		$a_01_1 = {25 73 5c 45 6e 54 61 73 6b 4c 6f 61 64 65 72 2e 65 78 65 } //01 00 
		$a_01_2 = {2f 00 74 00 61 00 73 00 6b 00 2d 00 72 00 65 00 73 00 74 00 61 00 72 00 74 00 } //00 00 
	condition:
		any of ($a_*)
