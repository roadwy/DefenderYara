...
rule TrojanDropper_Win32_Warece_B{
	...
	strings :
		...
		$a_02_11 = {8d 85 ec fc ff ff 6a 1a 50 56 ff 15 ?? ?? 40 00 8d 85 ec fc ff ff 50 8d 85 f4 fe ff ff 50 e8 ?? ?? 00 00 8d 85 f4 fe ff ff 68 ?? ?? 40 00 50 e8 ?? ?? 00 00 8d 85 ec fc ff ff 50 8d 85 f0 fd ff ff 50 e8 ?? ?? 00 00 8d 85 f0 fd ff ff 68 ?? ?? 40 00 50 e8 ?? ?? 00 00 68 ?? ?? 40 00 e8 ?? ?? ff ff 83 c4 24 33 c0 bb 00 26 00 00 } //10
	condition:
