...
rule TrojanDropper_Win32_Evotob_C{
	...
	strings :
		...
		$a_03_2 = {3d 00 10 00 00 74 90 01 01 3d 00 20 00 00 72 90 01 01 3d 00 30 00 00 73 90 01 01 43 eb 90 01 01 3d 00 30 00 00 72 90 01 01 6a 02 eb 90 01 01 3d 00 40 00 00 72 90 01 01 6a 03 90 00 } //2
	condition:
