...
rule TrojanDropper_Win32_Rofis{
	...
	strings :
		$a_02_0 = {68 02 00 00 80 ff 90 02 05 0f 90 02 10 51 56 6a 03 50 68 90 01 04 52 ff 90 00 } //1
		$a_02_1 = {6a 00 6a 00 6a 03 6a 00 6a 07 68 00 00 00 80 68 90 01 04 ff 15 90 00 } //1
		$a_02_2 = {6a 00 6a 05 68 90 01 04 ff 15 90 01 04 50 ff 15 90 01 04 ff d0 0f 31 90 00 } //1
