...
rule TrojanDropper_Win32_Vawtrak_A{
	...
	strings :
		...
		$a_01_2 = {72 00 65 00 67 00 73 00 76 00 72 00 33 00 32 00 2e 00 65 00 78 00 65 00 20 00 22 00 25 00 73 00 22 00 } //01 00 
		$a_01_3 = {53 3a 28 4d 4c 3b 3b 4e 57 3b 3b 3b 4c 57 29 00 44 3a 28 41 3b 4f 49 43 49 3b 47 41 3b 3b 3b 57 44 29 } //00 00 
	condition:
		any of ($a_*)
