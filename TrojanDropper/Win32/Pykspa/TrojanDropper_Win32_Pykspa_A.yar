...
rule TrojanDropper_Win32_Pykspa_A{
	...
	strings :
		...
		$a_03_1 = {0f be 8d aa fd ff ff 85 c9 75 0b 0f be 95 8f fc ff ff 85 d2 75 0b 0f b6 85 d7 fd ff ff 85 c0 74 19 0f b6 8d d7 fd ff ff 85 c9 0f 84 ?? ?? 00 00 83 7d fc 78 0f 8e ?? ?? 00 00 c7 45 fc 00 00 00 00 } //2
		$a_01_2 = {00 2e 64 00 00 6c 6c 00 } //2 ⸀d氀l
		$a_03_3 = {00 2e 65 00 00 78 [0-03] 65 00 } //2
