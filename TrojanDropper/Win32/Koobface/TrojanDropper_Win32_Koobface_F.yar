...
rule TrojanDropper_Win32_Koobface_F{
	...
	strings :
		...
		$a_01_1 = {5c 00 44 00 6f 00 73 00 44 00 65 00 76 00 69 00 63 00 65 00 73 00 5c 00 43 00 74 00 72 00 6c 00 } //01 00  \DosDevices\Ctrl
		$a_01_2 = {73 25 73 25 73 5c 64 72 69 25 73 25 73 54 45 25 73 73 } //00 00  s%s%s\dri%s%sTE%ss
	condition:
		any of ($a_*)
