...
rule TrojanDropper_Win32_Hesperbot_A{
	...
	strings :
		$a_00_0 = {5f 68 65 73 70 65 72 75 73 5f 63 6f 72 65 5f 65 6e 74 72 79 } //08 00  _hesperus_core_entry
		...
		$a_00_4 = {49 6e 73 74 61 6c 6c 44 61 74 65 } //02 00  InstallDate
		$a_00_5 = {44 69 67 69 74 61 6c 50 72 6f 64 75 63 74 49 64 } //02 00  DigitalProductId
		$a_00_6 = {4d 61 63 68 69 6e 65 47 75 69 64 } //00 00  MachineGuid
