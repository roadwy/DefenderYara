...
rule TrojanDropper_Win32_Frethog_N{
	...
	strings :
		$a_00_0 = {75 70 78 64 6e 64 2e 65 78 65 } //01 00  upxdnd.exe
		$a_00_1 = {75 70 78 64 6e 64 2e 64 6c 6c } //01 00  upxdnd.dll
		$a_00_2 = {65 78 70 6c 6f 72 65 72 2e 65 78 65 } //01 00  explorer.exe
		$a_00_3 = {35 31 33 34 33 32 38 31 } //01 00  51343281
