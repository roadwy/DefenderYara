...
rule TrojanDropper_Win32_Frethog_E{
	...
	strings :
		$a_03_0 = {6a 08 50 68 73 00 09 00 ff 76 2c ff 15 ?? ?? ?? 00 85 c0 74 09 6a 01 89 9e 98 61 00 00 58 } //1
		$a_00_1 = {c7 44 37 fc 4b 43 55 46 89 30 8b c7 5f } //1
		$a_03_2 = {83 7d fc 64 73 ?? 6a 02 53 6a fc 58 2b 45 fc 50 ff 75 f4 ff d6 } //1
	condition:
