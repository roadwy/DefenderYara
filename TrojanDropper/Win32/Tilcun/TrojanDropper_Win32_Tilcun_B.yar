...
rule TrojanDropper_Win32_Tilcun_B{
	...
	strings :
		$a_03_0 = {8b cf 0f b6 45 ff 2b c8 6a 00 83 e9 07 6a 00 51 ff 75 f8 ff d3 8d 45 f4 6a 00 50 8d 85 90 01 02 ff ff 6a 06 50 ff 75 f8 ff 15 90 01 02 40 00 33 c0 80 b4 05 90 01 02 ff ff 90 01 01 40 83 f8 06 7c f2 90 00 } //3
