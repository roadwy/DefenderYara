...
rule TrojanDropper_Win32_Safadrew_A{
	...
	strings :
		...
		$a_03_2 = {66 81 3a 4d 5a 74 90 01 01 ff 73 d0 90 00 } //3
		$a_03_3 = {c1 c2 04 ff 73 90 03 01 01 d0 fc 90 00 } //2
		$a_03_4 = {8f 43 d0 80 74 01 90 01 02 ff 73 d0 90 00 } //3
		$a_03_5 = {8f 43 fc 80 74 01 90 01 02 ff 73 fc 90 00 } //3
	condition:
