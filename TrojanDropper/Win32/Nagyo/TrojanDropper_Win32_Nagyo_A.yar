...
rule TrojanDropper_Win32_Nagyo_A{
	...
	strings :
		...
		$a_03_1 = {68 00 04 00 00 81 c9 00 b0 08 00 52 8b 90 01 03 8d 90 01 03 6a 02 50 c1 e1 02 51 52 ff 90 00 } //1
		$a_03_2 = {6a 66 6a 00 ff 15 90 01 02 40 00 8b f0 85 f6 75 07 5f 5e 5b 83 c4 44 c3 56 6a 00 90 00 } //1
	condition:
