...
rule TrojanDropper_Win32_Maran_AU{
	...
	strings :
		$a_01_0 = {56 6f 69 63 65 4d 61 6e 61 67 65 72 44 6f 77 6e } //01 00  VoiceManagerDown
		$a_01_1 = {5c 6f 64 33 6d 64 69 2e 64 6c 6c } //01 00  \od3mdi.dll
		$a_01_2 = {5c 5c 2e 5c 50 68 79 73 69 63 61 6c 44 72 69 76 65 30 } //01 00  \\.\PhysicalDrive0
