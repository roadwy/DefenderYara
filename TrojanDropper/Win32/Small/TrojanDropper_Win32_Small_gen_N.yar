...
rule TrojanDropper_Win32_Small_gen_N{
	...
	strings :
		...
		$a_01_3 = {62 6f 6f 6b 2e 65 78 65 } //01 00  book.exe
		$a_01_4 = {62 6f 6f 6b 2e 70 64 66 } //01 00  book.pdf
		$a_01_5 = {41 63 72 6f 52 64 33 32 2e 65 78 65 } //00 00  AcroRd32.exe
	condition:
		any of ($a_*)
