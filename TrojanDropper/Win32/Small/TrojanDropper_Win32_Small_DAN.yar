...
rule TrojanDropper_Win32_Small_DAN{
	...
	strings :
		...
		$a_00_2 = {77 69 6e 6d 73 64 6e 2e 65 78 65 } //01 00  winmsdn.exe
		$a_00_3 = {64 6c 6c 63 61 63 68 65 5c 66 75 75 72 6f 64 2e 73 79 73 } //01 00  dllcache\fuurod.sys
		$a_00_4 = {64 72 69 76 65 72 73 5c 62 65 65 70 2e 73 79 73 } //01 00  drivers\beep.sys
		$a_00_5 = {64 6c 6c 63 61 63 68 65 5c 62 65 65 70 2e 73 79 73 } //00 00  dllcache\beep.sys
	condition:
		any of ($a_*)
