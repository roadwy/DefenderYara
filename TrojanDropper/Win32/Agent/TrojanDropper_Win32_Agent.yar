...
rule TrojanDropper_Win32_Agent_2{
	...
	strings :
		...
		$a_00_1 = {73 6f 66 74 77 61 72 65 5c 62 6f 72 6c 61 6e 64 5c 64 65 6c 70 68 69 5c 72 74 6c } //01 00  software\borland\delphi\rtl
		$a_00_2 = {00 6f 70 65 6e 00 } //01 00  漀数n
		$a_00_3 = {77 72 69 74 65 66 69 6c 65 } //01 00  writefile
		$a_00_4 = {73 68 65 6c 6c 65 78 65 63 75 74 65 61 } //01 00  shellexecutea
		$a_00_5 = {43 3a 5c 57 49 4e 44 4f 57 53 5c 53 59 53 54 45 4d 33 32 5c 50 72 6f 67 2e 45 58 45 } //00 00  C:\WINDOWS\SYSTEM32\Prog.EXE
	condition:
		any of ($a_*)
