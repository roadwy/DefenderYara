...
rule TrojanDropper_Win32_Agent_AS{
	...
	strings :
		$a_02_0 = {58 40 ff e0 ff 15 90 01 04 c3 55 89 e5 83 90 01 02 e8 ea ff ff ff 90 00 } //1
		$a_02_1 = {c7 00 54 45 4d 50 c6 40 04 00 51 8d 85 90 01 04 68 00 01 00 00 50 50 ff 15 90 00 } //1
