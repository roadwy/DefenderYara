...
rule TrojanDropper_Win32_Agent_DQ{
	...
	strings :
		...
		$a_03_5 = {40 55 50 ff 15 90 01 02 40 00 83 c4 08 85 c0 75 90 01 01 8b 44 24 24 50 6a 01 68 01 00 10 00 ff 15 90 01 02 40 00 8b 8c 24 4c 01 00 00 8b 54 24 24 8b f8 89 11 eb 04 90 00 } //5
	condition:
