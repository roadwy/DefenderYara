...
rule TrojanDropper_Win32_Agent_DP{
	...
	strings :
		...
		$a_00_2 = {25 53 79 73 74 65 6d 52 6f 6f 74 25 5c 53 79 73 74 65 6d 33 32 5c 73 76 63 68 6f 73 74 2e 65 78 65 20 2d 6b 20 6e 65 74 73 76 63 73 } //01 00  %SystemRoot%\System32\svchost.exe -k netsvcs
