...
rule TrojanDropper_Win32_Agent_JZ{
	...
	strings :
		...
		$a_03_1 = {8a 1c 28 32 d8 88 1c 28 8b 4c 24 10 40 3b 90 01 01 76 ef 90 00 } //2
		$a_03_2 = {8b 44 24 10 3d 10 2f 00 00 0f 87 90 01 02 00 00 83 f8 0a 0f 82 90 01 02 00 00 90 00 } //1
