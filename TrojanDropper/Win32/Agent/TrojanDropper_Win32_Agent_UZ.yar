...
rule TrojanDropper_Win32_Agent_UZ{
	...
	strings :
		$a_00_0 = {2e 33 33 32 32 2e 6f 72 67 } //01 00 
		$a_00_1 = {44 4f 57 53 5c 5c 73 79 73 74 65 6d 33 32 5c 5c 43 6f 6d 5c } //01 00 
		$a_00_2 = {6f 70 65 6e 33 33 38 39 } //01 00 
		$a_00_3 = {72 76 69 63 65 73 5c 70 6f 7a 69 61 69 6e 69 5c } //02 00 
