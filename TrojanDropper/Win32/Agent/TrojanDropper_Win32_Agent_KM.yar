...
rule TrojanDropper_Win32_Agent_KM{
	...
	strings :
		$a_03_0 = {40 65 63 68 6f 20 6f 66 66 0d 0a 73 65 74 20 2d ?? ?? ?? ?? 2d 3d 30 0d 0a 73 65 74 20 2d ?? ?? ?? ?? 2d 3d 31 0d 0a 73 65 74 20 2d ?? ?? ?? ?? 2d 3d 32 0d 0a 73 65 74 20 2d ?? ?? ?? ?? 2d 3d 33 0d 0a 73 65 74 20 2d ?? ?? ?? ?? 2d 3d 34 0d 0a } //1
