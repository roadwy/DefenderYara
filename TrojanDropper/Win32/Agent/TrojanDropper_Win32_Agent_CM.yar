...
rule TrojanDropper_Win32_Agent_CM{
	...
	strings :
		...
		$a_00_1 = {5c 53 79 73 74 65 6d 5c 53 79 73 74 65 6d 33 32 2e 65 78 65 } //10 \System\System32.exe
		$a_00_2 = {5c 53 79 73 74 65 6d 5c 75 70 64 61 74 65 2e 65 78 65 } //10 \System\update.exe
		$a_00_3 = {5c 65 4d 75 6c 65 5c 49 6e 63 6f 6d 69 6e 67 5c } //10 \eMule\Incoming\
