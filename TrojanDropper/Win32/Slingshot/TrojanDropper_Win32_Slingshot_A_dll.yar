...
rule TrojanDropper_Win32_Slingshot_A_dll{
	...
	strings :
		$a_03_0 = {75 20 8b 54 24 0c 8b 87 90 01 04 8d 8b 90 01 04 51 52 ff d0 8b 5c 24 18 8b 74 24 10 85 c0 75 12 5e 5d b8 39 01 00 c0 90 00 } //1
		...
		$a_03_4 = {80 3b 50 75 24 80 7b 01 45 75 1e 80 7b 02 4d 75 18 80 7b 03 43 75 12 80 7b 04 52 75 0c 80 7b 05 54 75 06 8b 54 24 90 01 01 89 32 85 f6 75 13 85 c9 75 0f 90 00 } //2
		$a_03_5 = {66 83 f8 09 72 90 01 01 75 0a 66 83 be 90 01 02 00 00 04 72 90 01 01 c6 45 f8 5a c6 45 f9 2a c6 45 fa d7 c6 45 fb 39 c6 45 fc 25 c6 45 fd ae c6 45 fe 18 90 00 } //2
		...
		$a_03_12 = {53 00 73 00 20 00 2d 00 61 00 20 00 90 02 10 20 00 2d 00 73 00 20 00 90 02 10 20 00 2d 00 6f 00 90 00 } //2
		$a_03_13 = {53 73 20 2d 61 20 90 02 10 20 2d 73 20 90 02 10 20 2d 6f 90 00 } //2
		$a_03_14 = {6d 65 70 67 90 09 04 00 c7 44 24 90 00 } //2
		$a_03_15 = {0d d0 ad 2b 90 09 03 00 c7 45 90 00 } //2
	condition:
