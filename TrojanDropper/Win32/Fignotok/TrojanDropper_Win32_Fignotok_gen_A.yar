...
rule TrojanDropper_Win32_Fignotok_gen_A{
	...
	strings :
		...
		$a_03_3 = {57 69 6e 64 6f 77 73 20 90 02 05 50 68 6f 74 6f 20 47 61 6c 6c 65 72 79 90 00 } //1
		...
		$a_02_5 = {43 3a 5c 55 73 65 72 73 5c 73 5c 44 65 73 6b 74 6f 70 5c 90 02 08 5c 43 6f 64 65 5c 6d 61 69 6e 5c 64 77 6e 5c 52 65 6c 65 61 73 65 5c 64 77 6e 2e 70 64 62 90 00 } //1
	condition:
