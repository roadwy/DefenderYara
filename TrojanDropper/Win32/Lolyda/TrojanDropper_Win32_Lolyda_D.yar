...
rule TrojanDropper_Win32_Lolyda_D{
	...
	strings :
		...
		$a_02_2 = {2d 20 05 00 00 8d 8d 90 01 04 50 68 20 05 00 00 8d 95 90 01 04 51 52 e8 90 02 0f 90 90 90 02 0f 8d 85 90 01 04 68 20 05 00 00 8d 8d 90 01 04 50 51 e8 90 00 } //1
	condition:
