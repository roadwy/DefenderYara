...
rule TrojanDropper_Win32_Alureon_J{
	...
	strings :
		$a_03_0 = {8a d1 80 c2 90 01 01 30 14 90 04 01 04 01 19 31 39 83 c1 01 3b 90 04 01 04 c8 cb ce cf 72 f1 c3 90 00 } //10
		...
		$a_02_6 = {61 64 77 5f 64 6c 6c 90 02 01 2e 64 6c 6c 00 90 00 } //1
	condition:
