...
rule TrojanDropper_Win32_Alureon_V{
	...
	strings :
		...
		$a_01_1 = {37 7a 61 2e 65 78 65 20 78 } //01 00  7za.exe x
		$a_01_2 = {61 31 2e 37 7a 20 2d 61 6f 61 20 2d 6f } //01 00  a1.7z -aoa -o
		$a_01_3 = {2d 70 6c 6f 6c 6d 69 6c 66 00 } //00 00  瀭潬浬汩f
	condition:
		any of ($a_*)
