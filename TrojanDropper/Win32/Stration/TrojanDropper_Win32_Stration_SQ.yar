...
rule TrojanDropper_Win32_Stration_SQ{
	...
	strings :
		...
		$a_02_3 = {74 72 79 2d 61 6e 79 74 68 69 6e 67 2d 65 6c 73 65 2e 63 6f 6d 2f [0-0a] 2e 65 78 65 } //1
		$a_02_4 = {6c 6f 63 61 6c 68 6f 73 74 2d 32 2e 63 6f 6d 2f [0-0a] 2e 65 78 65 } //1
		$a_02_5 = {72 78 2d 66 72 6f 6d 2d 77 61 72 65 68 6f 75 73 65 33 2e 63 6f 6d 2f [0-0a] 2e 65 78 65 } //1
	condition:
