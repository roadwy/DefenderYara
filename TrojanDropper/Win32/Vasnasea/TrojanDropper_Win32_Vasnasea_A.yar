...
rule TrojanDropper_Win32_Vasnasea_A{
	...
	strings :
		...
		$a_01_3 = {38 39 37 32 33 34 6b 6a 64 73 66 34 35 32 33 32 33 34 2e 63 6f 6d } //02 00  897234kjdsf4523234.com
		$a_01_4 = {5c 5c 2e 5c 70 69 70 65 5c 6d 73 70 69 70 65 5f 6f 67 } //02 00  \\.\pipe\mspipe_og
		$a_01_5 = {64 61 6f 37 65 72 6d 73 5f 61 } //04 00  dao7erms_a
