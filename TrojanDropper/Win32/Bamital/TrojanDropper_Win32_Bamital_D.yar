...
rule TrojanDropper_Win32_Bamital_D{
	...
	strings :
		...
		$a_03_2 = {8b 75 0c 80 3e e9 75 18 e8 90 01 04 83 f8 05 75 07 ba 0a 00 00 00 eb 0c e9 a0 00 00 00 eb 05 ba 05 00 00 00 bb 00 00 00 00 8b 75 0c eb 90 01 01 e8 90 01 04 83 f8 ff 75 90 00 } //1
	condition:
