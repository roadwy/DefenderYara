...
rule TrojanDropper_AndroidOS_SAgent_CA_MTB{
	...
	strings :
		...
		$a_01_1 = {61 73 73 65 74 5f 6e 61 6d 65 } //01 00 
		$a_01_2 = {64 65 78 5f 6e 61 6d 65 } //01 00 
		$a_01_3 = {73 74 61 72 74 44 65 6c 61 79 65 64 4f 70 65 6e 41 64 54 69 6d 65 72 } //01 00 
		$a_01_4 = {67 65 74 44 65 78 43 6c 61 73 73 6c 6f 61 64 65 72 } //01 00 
		$a_01_5 = {67 65 74 41 73 73 65 74 73 } //00 00 
	condition:
		any of ($a_*)
