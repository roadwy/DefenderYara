...
rule TrojanDropper_AndroidOS_Agent_B_MTB{
	...
	strings :
		$a_02_0 = {0d 01 6e 10 ?? 00 01 00 6e 10 ?? 00 02 00 0c 01 21 12 35 20 13 00 48 02 01 00 d7 22 ff 00 8d 22 4f 02 01 00 d8 00 00 01 28 f4 6e 10 ?? 00 05 00 6e 10 ?? 00 02 00 28 e9 07 10 28 cd } //1
