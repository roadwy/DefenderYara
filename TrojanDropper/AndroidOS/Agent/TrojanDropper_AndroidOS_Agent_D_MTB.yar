...
rule TrojanDropper_AndroidOS_Agent_D_MTB{
	...
	strings :
		...
		$a_01_1 = {2f 61 74 2e 73 6f } //01 00 
		$a_00_2 = {56 31 37 31 32 30 31 30 31 41 6a 31 61 72 73 6f } //01 00 
		$a_00_3 = {2f 47 50 4a 61 72 30 4c } //01 00 
		$a_01_4 = {4c 63 6f 6d 2f 64 2f 6d 2f 67 70 2f 61 2f 69 3b } //00 00 
