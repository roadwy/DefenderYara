...
rule TrojanDropper_AndroidOS_Wroba_D_MTB{
	...
	strings :
		...
		$a_01_3 = {63 6f 6d 2e 4c 6f 61 64 65 72 } //01 00  com.Loader
		$a_01_4 = {2f 56 6f 6c 75 6d 65 73 2f 41 6e 64 72 6f 69 64 2f 62 75 69 6c 64 62 6f 74 } //00 00  /Volumes/Android/buildbot
	condition:
		any of ($a_*)
