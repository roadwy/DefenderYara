...
rule TrojanDropper_AndroidOS_Sova_C_MTB{
	...
	strings :
		...
		$a_03_2 = {91 02 05 04 23 20 90 02 05 12 01 91 02 05 04 35 21 0f 00 62 02 90 02 05 90 90 03 04 01 4a 02 02 03 b7 62 8e 22 50 02 00 01 d8 01 01 01 28 f0 90 00 } //2
	condition:
