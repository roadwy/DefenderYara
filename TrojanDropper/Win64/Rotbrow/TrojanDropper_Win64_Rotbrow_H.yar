...
rule TrojanDropper_Win64_Rotbrow_H{
	...
	strings :
		$a_03_0 = {24 0f 04 41 88 42 ff 83 f9 40 72 e8 c6 02 00 ff 15 90 01 04 0f b6 c8 44 8b d8 80 e1 0f 80 c1 41 88 4b 46 8b c8 c1 e9 04 80 e1 0f 80 c1 41 88 4b 47 90 00 } //5
