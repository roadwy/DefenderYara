...
rule TrojanDropper_O97M_GraceWire_CK_MTB{
	...
	strings :
		...
		$a_03_1 = {74 6f 6f 6f 6c 73 65 74 43 68 75 6e 6b 51 20 3d 20 46 61 6c 73 65 90 02 08 47 65 74 50 2e 61 72 61 6d 20 3d 20 22 22 90 00 } //1
		...
		$a_03_3 = {46 72 65 65 46 69 6c 65 90 02 04 4f 70 65 6e 20 43 6f 6d 70 6f 73 69 74 69 6f 6e 32 20 46 6f 72 20 42 69 6e 61 72 79 20 41 63 63 65 73 73 20 52 65 61 64 20 41 73 20 50 72 6f 73 74 6f 50 6c 61 6e 90 00 } //1
		$a_03_4 = {4e 65 78 74 20 48 53 50 90 0c 02 00 45 6e 64 20 53 75 62 90 00 } //1
	condition:
