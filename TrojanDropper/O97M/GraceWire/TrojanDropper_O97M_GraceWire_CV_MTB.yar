...
rule TrojanDropper_O97M_GraceWire_CV_MTB{
	...
	strings :
		$a_03_0 = {76 61 72 52 65 73 31 20 3d 20 45 78 65 63 75 74 65 45 78 63 65 6c 34 4d 61 63 72 6f 28 22 43 41 4c 22 20 2b 20 22 4c 28 22 20 2b 20 73 4f 66 62 6c 20 2b 20 22 90 02 10 22 22 2c 22 22 4a 22 22 29 22 29 90 00 } //1
		...
		$a_03_4 = {44 6f 45 76 65 6e 74 73 90 0c 02 00 56 6f 6f 6f 6f 6f 68 65 61 64 90 0c 02 00 44 6f 45 76 65 6e 74 73 90 00 } //1
	condition:
