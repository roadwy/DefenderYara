...
rule TrojanDropper_O97M_GraceWire_CQ_MTB{
	...
	strings :
		...
		$a_01_1 = {50 75 62 6c 69 63 20 53 75 62 20 57 75 7a 7a 79 42 75 64 28 64 49 6d 6d 65 72 20 41 73 20 49 6e 74 65 67 65 72 29 } //1 Public Sub WuzzyBud(dImmer As Integer)
		...
		$a_01_3 = {73 20 3d 20 22 4e 6f 20 68 65 61 6c 74 68 20 70 72 6f 62 6c 65 6d 73 22 } //1 s = "No health problems"
	condition:
