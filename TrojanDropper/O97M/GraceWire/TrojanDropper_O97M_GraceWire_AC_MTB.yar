...
rule TrojanDropper_O97M_GraceWire_AC_MTB{
	meta:
		description = "TrojanDropper:O97M/GraceWire.AC!MTB,SIGNATURE_TYPE_MACROHSTR_EXT,05 00 05 00 05 00 00 01 00 "
	...
	strings :
		...
		$a_01_2 = {46 4d 4f 44 5f 45 72 72 6f 2e 72 53 74 72 69 6e 67 28 72 65 73 75 6c 74 29 29 } //01 00  FMOD_Erro.rString(result))
