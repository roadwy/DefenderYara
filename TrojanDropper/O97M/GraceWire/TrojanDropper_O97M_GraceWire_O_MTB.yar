...
rule TrojanDropper_O97M_GraceWire_O_MTB{
	...
	strings :
		...
		$a_03_3 = {50 75 62 6c 69 63 20 53 75 62 20 4b 69 6c 6c 41 72 72 61 79 28 90 02 25 28 29 20 41 73 20 56 61 72 69 61 6e 74 29 90 02 10 4f 6e 20 45 72 72 6f 72 20 52 65 73 75 6d 65 20 4e 65 78 74 90 00 } //1
		$a_03_4 = {2e 53 70 65 63 69 61 6c 46 6f 6c 64 65 72 73 28 55 73 65 72 46 6f 72 6d 90 01 01 2e 54 65 78 74 42 6f 78 90 01 01 2e 54 61 67 29 90 00 } //1
	condition:
