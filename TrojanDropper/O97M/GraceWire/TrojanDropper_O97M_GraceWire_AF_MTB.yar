...
rule TrojanDropper_O97M_GraceWire_AF_MTB{
	...
	strings :
		$a_03_0 = {26 20 22 64 6c 90 02 09 6c 22 90 00 } //1
		$a_03_1 = {3d 20 55 73 65 72 46 6f 72 6d 90 01 01 2e 54 65 78 74 42 6f 78 90 01 01 2e 54 61 67 20 26 20 22 5c 90 02 20 22 20 2b 20 22 2e 78 6c 90 00 } //1
		$a_03_2 = {2b 20 22 2e 22 20 2b 20 22 7a 90 02 09 70 22 90 00 } //1
