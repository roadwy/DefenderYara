...
rule TrojanDropper_O97M_GraceWire_BW_MTB{
	...
	strings :
		...
		$a_03_1 = {63 74 61 63 6b 50 75 70 20 3d 20 4b 36 47 4f 41 4d 2e 54 65 78 74 42 6f 78 31 2e 54 61 67 20 2b 20 22 5c 90 02 12 2e 78 6c 73 22 20 2b 20 22 78 22 90 00 } //1
