...
rule TrojanDropper_O97M_GraceWire_BH_MTB{
	...
	strings :
		$a_03_0 = {43 6f 6d 70 6f 73 69 74 69 6f 6e 20 90 02 15 20 26 20 55 73 65 72 46 6f 72 6d 36 2e 4c 61 62 65 6c 31 2e 54 61 67 2c 20 6f 66 62 6c 2c 20 43 75 72 72 65 6e 74 53 69 7a 65 4f 66 41 54 2c 20 73 65 6e 64 69 6e 67 73 90 00 } //1
		...
		$a_03_3 = {44 6f 45 76 65 6e 74 73 90 0c 02 00 44 65 72 54 69 70 90 0c 02 00 44 6f 45 76 65 6e 74 73 90 0c 02 00 45 6e 64 20 53 75 62 90 00 } //1
