...
rule TrojanDropper_O97M_GraceWire_DH_MTB{
	...
	strings :
		...
		$a_03_5 = {4d 6f 64 75 6c 65 35 2e 52 65 64 42 75 74 74 6f 6e 20 32 39 31 30 90 0c 02 00 45 6e 64 20 53 75 62 90 00 } //1
		$a_03_6 = {44 6f 45 76 65 6e 74 73 90 0c 02 00 56 6f 6f 6f 6f 6f 68 65 61 64 90 0c 02 00 44 6f 45 76 65 6e 74 73 90 0c 02 00 45 6e 64 20 53 75 62 90 00 } //1
	condition:
