...
rule TrojanDropper_O97M_GraceWire_AO_MTB{
	...
	strings :
		...
		$a_03_1 = {3d 20 57 68 65 72 65 54 6f 47 6f [0-12] 22 7a [0-09] 69 [0-09] 70 } //1
		...
		$a_03_4 = {4f 6e 20 45 72 72 6f 72 20 52 65 73 75 6d 65 20 4e 65 78 74 [0-10] 44 69 6d } //1
	condition:
