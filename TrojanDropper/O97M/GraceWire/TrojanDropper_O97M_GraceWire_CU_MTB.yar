...
rule TrojanDropper_O97M_GraceWire_CU_MTB{
	...
	strings :
		$a_03_0 = {63 74 61 63 6b 50 75 70 20 3d 20 63 74 61 63 6b 50 75 70 20 2b 20 22 [0-08] 2e 78 6c 73 78 22 } //1
		$a_03_1 = {63 74 61 63 6b 50 69 70 20 3d 20 63 74 61 63 6b 50 75 70 20 26 20 50 61 67 65 31 31 2e 52 61 6e 67 65 28 22 [0-10] 22 29 2e 56 61 6c 75 65 } //1
