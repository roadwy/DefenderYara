...
rule TrojanDropper_O97M_GraceWire_CT_MTB{
	...
	strings :
		...
		$a_03_2 = {73 20 3d 20 63 61 72 2e 43 68 65 63 6b 43 61 72 28 [0-15] 2c 20 44 69 61 6c 6f 67 34 2e 54 65 78 74 42 6f 78 33 2e 43 6f 6e 74 72 6f 6c 54 69 70 54 65 78 74 20 26 20 22 22 29 } //1
	condition:
