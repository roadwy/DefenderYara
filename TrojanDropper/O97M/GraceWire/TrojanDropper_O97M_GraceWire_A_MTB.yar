...
rule TrojanDropper_O97M_GraceWire_A_MTB{
	...
	strings :
		...
		$a_01_3 = {2e 49 74 65 6d 28 22 78 6c 5c 65 6d 62 65 64 64 69 6e 67 73 5c 6f 6c 65 4f 62 6a 65 63 74 31 } //01 00 
		$a_01_4 = {2e 4e 61 6d 65 73 70 61 63 65 28 5a 69 70 46 6f 6c 64 65 72 29 2e 43 6f 70 79 48 65 72 65 } //00 00 
	condition:
		any of ($a_*)
