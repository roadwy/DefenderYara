...
rule TrojanDropper_O97M_GraceWire_DT_MTB{
	...
	strings :
		$a_03_0 = {44 6f 45 76 65 6e 74 73 90 0c 02 00 45 78 43 68 61 6e 67 65 4d 6f 6e 65 79 90 0c 02 00 44 6f 45 76 65 6e 74 73 90 0c 02 00 45 6e 64 20 53 75 62 } //1
		$a_03_1 = {4d 6f 64 75 6c 65 35 2e 52 65 64 42 75 74 74 6f 6e 20 31 39 39 39 39 90 0c 02 00 45 6e 64 20 53 75 62 } //1
