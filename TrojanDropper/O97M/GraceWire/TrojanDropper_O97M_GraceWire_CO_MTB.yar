...
rule TrojanDropper_O97M_GraceWire_CO_MTB{
	...
	strings :
		...
		$a_03_1 = {63 74 61 63 6b 50 75 70 20 3d 20 63 74 61 63 6b 50 75 70 20 2b 20 22 90 02 10 2e 78 6c 73 78 22 90 00 } //1
		$a_03_2 = {63 74 61 63 6b 50 75 70 20 3d 20 44 69 61 6c 6f 67 34 2e 54 65 78 74 42 6f 78 31 2e 54 61 67 20 2b 20 22 5c 90 02 10 22 90 00 } //1
