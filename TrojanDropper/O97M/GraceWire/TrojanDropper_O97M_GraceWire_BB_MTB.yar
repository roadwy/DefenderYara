...
rule TrojanDropper_O97M_GraceWire_BB_MTB{
	...
	strings :
		...
		$a_01_2 = {4d 69 2e 64 24 28 43 6f 6d 6d 61 2e 6e 64 24 2c 20 69 2c 20 31 29 } //01 00  Mi.d$(Comma.nd$, i, 1)
		$a_01_3 = {31 20 54 6f 20 4c 65 6e 28 43 6f 6d 6d 61 2e 6e 64 24 29 } //01 00  1 To Len(Comma.nd$)
