...
rule TrojanDropper_O97M_GraceWire_BB_MTB{
	...
	strings :
		...
		$a_03_1 = {74 74 20 3d 20 74 74 20 26 20 73 54 28 69 69 29 20 26 20 22 5c 22 90 02 10 4e 65 78 74 20 69 69 90 00 } //1
		...
		$a_03_5 = {55 6e 6c 6f 61 64 20 4d 2e 65 90 02 10 45 6e 64 90 0c 02 00 45 6e 64 20 53 75 62 90 00 } //1
	condition:
