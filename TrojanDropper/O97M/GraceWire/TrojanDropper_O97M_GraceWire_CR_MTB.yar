...
rule TrojanDropper_O97M_GraceWire_CR_MTB{
	...
	strings :
		$a_01_0 = {43 68 44 69 72 20 28 44 69 61 6c 6f 67 34 2e 54 65 78 74 42 6f 78 31 2e 54 61 67 29 } //01 00 
		$a_01_1 = {44 69 6d 20 63 61 72 20 41 73 20 52 65 70 6f 73 69 74 6f 72 } //01 00 
