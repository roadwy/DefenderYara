...
rule TrojanDropper_O97M_GraceWire_AI_MTB{
	...
	strings :
		...
		$a_03_2 = {2e 53 70 65 63 69 61 6c 46 6f 6c 64 65 72 73 28 55 73 65 72 46 6f 72 6d 90 01 01 2e 54 65 78 74 42 6f 78 90 01 01 2e 54 61 67 29 90 00 } //1
		$a_01_3 = {54 68 69 73 57 6f 72 6b 62 6f 6f 6b 2e 53 68 65 65 74 73 2e 43 6f 70 79 } //1 ThisWorkbook.Sheets.Copy
		$a_03_4 = {4f 6e 20 45 72 72 6f 72 20 52 65 73 75 6d 65 20 4e 65 78 74 90 02 25 43 61 6c 6c 20 49 49 74 6d 73 2e 52 65 6d 6f 76 65 28 4b 65 79 29 90 00 } //1
