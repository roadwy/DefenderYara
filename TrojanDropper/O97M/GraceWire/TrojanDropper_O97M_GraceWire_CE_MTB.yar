...
rule TrojanDropper_O97M_GraceWire_CE_MTB{
	...
	strings :
		$a_01_0 = {2b 20 22 2e 64 6c 6c 22 } //01 00 
		...
		$a_01_4 = {74 65 78 74 49 74 65 6d 20 3d 20 57 69 6e 64 6f 77 73 2e 4c 61 62 65 6c 31 31 2e 43 61 70 74 69 6f 6e } //01 00 
		$a_01_5 = {43 68 44 69 72 20 57 69 6e 64 6f 77 73 2e 54 65 78 74 42 6f 78 33 2e 54 61 67 } //01 00 
		$a_01_6 = {3d 20 73 4e 4d 53 50 2e 4e 61 6d 65 73 70 61 63 65 28 64 65 72 73 68 6c 65 70 29 } //00 00 
	condition:
		any of ($a_*)
