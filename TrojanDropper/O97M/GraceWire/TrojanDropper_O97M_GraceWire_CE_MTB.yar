...
rule TrojanDropper_O97M_GraceWire_CE_MTB{
	...
	strings :
		...
		$a_03_1 = {43 61 73 65 20 32 90 02 12 73 20 3d 20 22 4d 61 6a 6f 72 20 68 65 61 6c 74 68 20 70 72 6f 62 6c 65 6d 73 22 90 00 } //1
		$a_03_2 = {4e 65 78 74 20 6b 90 02 04 45 78 69 74 20 44 6f 90 02 04 45 6c 73 65 90 02 04 63 75 72 90 00 } //1
		$a_03_3 = {2e 54 65 78 74 42 6f 78 31 2e 54 61 67 90 02 08 44 69 6d 90 00 } //1
