...
rule TrojanDropper_O97M_Hancitor_IAG_MTB{
	meta:
		description = "TrojanDropper:O97M/Hancitor.IAG!MTB,SIGNATURE_TYPE_MACROHSTR_EXT,04 00 04 00 04 00 00 01 00 "
		
	strings :
		$a_01_0 = {2e 74 22 20 26 20 22 6d 22 20 26 20 22 70 22 20 41 73 20 57 6f 72 64 2e 41 63 74 69 76 65 44 6f 63 75 6d 65 6e 74 2e 41 74 74 61 63 68 65 64 54 65 6d 70 6c 61 74 65 2e 50 61 74 68 20 26 20 22 5c 22 20 26 20 22 57 30 22 20 26 20 22 72 64 2e 64 22 20 26 20 22 6c 6c 22 } //01 00  .t" & "m" & "p" As Word.ActiveDocument.AttachedTemplate.Path & "\" & "W0" & "rd.d" & "ll"
		...
		$a_01_3 = {43 61 6c 6c 20 6e 6d 28 6f 6c 6f 6c 6f 77 29 } //00 00  Call nm(ololow)
	condition:
		any of ($a_*)
