...
rule TrojanDropper_O97M_Hancitor_IAN_MTB{
	...
	strings :
		$a_01_0 = {49 66 20 44 69 72 28 6a 73 61 20 26 20 22 5c 22 20 26 20 22 57 30 22 20 26 20 22 72 64 2e 64 22 20 26 20 22 6c 22 20 26 20 22 6c 22 29 20 3d 20 22 22 20 54 68 65 6e } //1 If Dir(jsa & "\" & "W0" & "rd.d" & "l" & "l") = "" Then
		...
		$a_03_5 = {75 75 6a 20 3d 20 22 5c 22 20 26 20 22 90 02 10 2e 74 22 20 26 20 22 6d 70 22 90 00 } //1
	condition:
