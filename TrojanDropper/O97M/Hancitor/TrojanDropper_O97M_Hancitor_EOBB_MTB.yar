...
rule TrojanDropper_O97M_Hancitor_EOBB_MTB{
	...
	strings :
		...
		$a_01_1 = {65 77 72 77 73 64 66 20 3d 20 22 4c 6f 63 22 20 26 20 22 61 22 20 26 20 22 6c 22 } //1 ewrwsdf = "Loc" & "a" & "l"
		$a_01_2 = {65 77 72 77 73 64 66 20 3d 20 65 77 72 77 73 64 66 20 26 20 22 2f 22 20 26 20 22 54 65 6d 70 22 } //1 ewrwsdf = ewrwsdf & "/" & "Temp"
