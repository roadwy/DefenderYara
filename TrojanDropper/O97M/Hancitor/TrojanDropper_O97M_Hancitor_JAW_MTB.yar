...
rule TrojanDropper_O97M_Hancitor_JAW_MTB{
	...
	strings :
		$a_01_0 = {3d 20 22 5c 53 74 61 22 20 26 20 22 74 69 63 2e 64 } //01 00 
		...
		$a_01_4 = {44 69 6d 20 70 61 66 68 20 41 73 20 53 74 72 69 6e 67 } //01 00 
		$a_01_5 = {26 20 6a 73 64 20 26 20 22 6c 22 20 26 } //01 00 
