...
rule TrojanDropper_O97M_Hancitor_EMTU_MTB{
	...
	strings :
		...
		$a_03_3 = {2e 52 75 6e 20 66 61 20 26 20 22 20 22 20 26 20 79 79 2c 20 77 69 6e 64 6f 77 53 74 79 6c 65 2c 20 77 61 69 74 4f 6e 52 65 74 75 72 6e 90 0c 02 00 45 6e 64 20 49 66 90 0c 02 00 45 6e 64 20 53 75 62 90 00 } //1
	condition:
