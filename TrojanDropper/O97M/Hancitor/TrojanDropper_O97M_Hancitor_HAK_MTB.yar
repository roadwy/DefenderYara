...
rule TrojanDropper_O97M_Hancitor_HAK_MTB{
	...
	strings :
		...
		$a_03_5 = {73 74 72 46 69 6c 65 45 78 69 73 74 73 20 3d 20 44 69 72 28 52 6f 6f 74 50 61 74 68 20 26 20 22 5c 90 02 08 2e 74 6d 70 22 29 90 00 } //1
		$a_03_6 = {53 75 62 20 67 6f 74 6f 64 6f 77 6e 28 29 90 0c 02 00 43 61 6c 6c 20 67 6f 74 6f 74 77 6f 90 00 } //1
	condition:
