...
rule TrojanDropper_O97M_Hancitor_EOAG_MTB{
	...
	strings :
		...
		$a_03_2 = {41 63 74 69 76 65 53 68 65 65 74 2e 53 68 61 70 65 73 2e 52 61 6e 67 65 28 41 72 72 61 79 28 22 4f 62 6a 65 63 74 20 90 02 03 22 29 29 2e 53 65 6c 65 63 74 90 00 } //1
	condition:
