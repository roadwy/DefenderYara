...
rule TrojanDropper_O97M_Hancitor_EOAG_MTB{
	...
	strings :
		$a_01_0 = {45 6e 76 69 72 6f 6e 24 28 22 74 65 6d 70 22 29 20 26 20 22 5c 6f 6d 73 68 2e 64 6c 6c 2c } //01 00  Environ$("temp") & "\omsh.dll,
		$a_01_1 = {75 73 78 20 3d 20 45 6e 76 69 72 6f 6e 24 28 22 74 65 6d 70 22 29 } //01 00  usx = Environ$("temp")
