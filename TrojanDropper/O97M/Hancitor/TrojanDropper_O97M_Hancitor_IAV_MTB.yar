...
rule TrojanDropper_O97M_Hancitor_IAV_MTB{
	meta:
		description = "TrojanDropper:O97M/Hancitor.IAV!MTB,SIGNATURE_TYPE_MACROHSTR_EXT,07 00 07 00 07 00 00 01 00 "
	...
	strings :
		...
		$a_01_2 = {67 6c 6f 70 73 20 3d 20 57 6f 72 64 2e 41 63 74 69 76 65 44 6f 63 75 6d 65 6e 74 2e 41 74 74 61 63 68 65 64 54 65 6d 70 6c 61 74 65 2e 50 61 74 68 } //01 00  glops = Word.ActiveDocument.AttachedTemplate.Path
