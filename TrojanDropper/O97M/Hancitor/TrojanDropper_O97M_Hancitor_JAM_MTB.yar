...
rule TrojanDropper_O97M_Hancitor_JAM_MTB{
	...
	strings :
		...
		$a_01_1 = {53 65 6c 65 63 74 69 6f 6e 2e 4d 6f 76 65 44 6f 77 6e 20 55 6e 69 74 3a 3d 77 64 4c 69 6e 65 2c 20 43 6f 75 6e 74 3a 3d 31 } //1 Selection.MoveDown Unit:=wdLine, Count:=1
