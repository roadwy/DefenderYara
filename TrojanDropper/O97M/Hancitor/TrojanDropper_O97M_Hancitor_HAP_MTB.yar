...
rule TrojanDropper_O97M_Hancitor_HAP_MTB{
	...
	strings :
		...
		$a_01_2 = {43 61 6c 6c 20 67 6f 74 6f 64 6f 77 6e } //01 00 
		...
		$a_01_5 = {26 20 79 79 20 26 20 70 75 73 68 73 74 72 20 26 20 22 6c 6c 22 20 26 20 22 2c 22 20 26 20 22 55 6e 69 6e 73 74 61 6c 6c 46 6f 6e 74 } //01 00 
