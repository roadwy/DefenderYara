...
rule TrojanDropper_O97M_Hancitor_HAI_MTB{
	...
	strings :
		...
		$a_01_2 = {26 20 22 44 6c 6c 22 20 26 20 22 55 6e 72 65 67 69 73 74 65 72 53 65 72 76 65 72 22 } //01 00 
		$a_01_3 = {44 69 6d 20 70 69 66 70 61 66 20 41 73 20 53 74 72 69 6e 67 } //01 00 
		...
		$a_01_7 = {43 61 6c 6c 20 72 65 67 73 72 76 61 2e 53 68 65 6c 6c 45 78 65 63 75 74 65 28 66 61 2c } //00 00 
	condition:
		any of ($a_*)
