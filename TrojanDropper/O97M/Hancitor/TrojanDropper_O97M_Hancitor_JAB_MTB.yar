...
rule TrojanDropper_O97M_Hancitor_JAB_MTB{
	...
	strings :
		$a_01_0 = {53 74 61 74 69 63 2e 64 } //1 Static.d
		$a_01_1 = {43 61 6c 6c 20 68 68 68 68 68 } //1 Call hhhhh
		$a_01_2 = {43 61 6c 6c 20 73 74 65 74 70 74 77 77 6f } //1 Call stetptwwo
		...
		$a_01_6 = {67 6c 6f 70 73 20 3d 20 57 6f 72 64 2e 41 63 74 69 76 65 44 6f 63 75 6d 65 6e 74 2e 41 74 74 61 63 68 65 64 54 65 6d 70 6c 61 74 65 2e 50 61 74 68 } //1 glops = Word.ActiveDocument.AttachedTemplate.Path
	condition:
