...
rule TrojanDropper_O97M_Hancitor_IAQ_MTB{
	...
	strings :
		$a_01_0 = {43 61 6c 6c 20 68 68 68 68 68 } //1 Call hhhhh
		$a_01_1 = {57 30 22 20 26 20 22 72 64 2e 64 22 20 26 20 22 6c 22 20 26 20 22 6c 22 } //1 W0" & "rd.d" & "l" & "l"
		...
		$a_01_3 = {44 69 6d 20 70 75 73 68 73 74 72 20 41 73 20 53 74 72 69 6e 67 } //1 Dim pushstr As String
		...
		$a_01_5 = {79 79 20 3d 20 67 6c 6f 70 73 20 26 20 79 79 20 26 20 70 75 73 68 73 74 72 20 26 } //1 yy = glops & yy & pushstr &
