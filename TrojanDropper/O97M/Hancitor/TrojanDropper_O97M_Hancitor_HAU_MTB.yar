...
rule TrojanDropper_O97M_Hancitor_HAU_MTB{
	...
	strings :
		...
		$a_03_4 = {72 65 70 69 64 20 3d 20 41 63 74 69 76 65 44 6f 63 75 6d 65 6e 74 2e 41 70 70 6c 69 63 61 74 69 6f 6e 2e 53 74 61 72 74 75 70 50 61 74 68 90 0c 02 00 45 6e 64 20 46 75 6e 63 74 69 6f 6e } //1
