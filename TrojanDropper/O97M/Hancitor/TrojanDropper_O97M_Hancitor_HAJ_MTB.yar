...
rule TrojanDropper_O97M_Hancitor_HAJ_MTB{
	meta:
		description = "TrojanDropper:O97M/Hancitor.HAJ!MTB,SIGNATURE_TYPE_MACROHSTR_EXT,06 00 06 00 06 00 00 01 00 "
	...
	strings :
		...
		$a_03_4 = {43 61 6c 6c 20 47 65 74 6d 65 28 4c 65 66 74 28 90 02 06 2c 20 6e 74 67 73 29 20 26 20 22 4c 6f 63 22 20 26 20 22 61 6c 5c 54 65 22 20 26 20 22 6d 70 22 29 90 00 } //01 00 
		$a_01_5 = {41 73 20 41 63 74 69 76 65 44 6f 63 75 6d 65 6e 74 2e 41 74 74 61 63 68 65 64 54 65 6d 70 6c 61 74 65 2e 50 61 74 68 20 26 20 22 5c 22 20 26 20 22 57 30 72 64 2e 64 6c 6c 22 } //00 00  As ActiveDocument.AttachedTemplate.Path & "\" & "W0rd.dll"
	condition:
		any of ($a_*)
