...
rule TrojanDropper_O97M_Hancitor_JAG_MTB{
	...
	strings :
		...
		$a_03_5 = {43 61 6c 6c 20 6a 6f 70 28 6d 79 68 6f 6d 65 2c 20 70 6c 6f 70 20 26 20 22 5c 53 74 61 74 69 63 2e 64 6c 6c 22 29 90 0c 02 00 45 6e 64 20 53 75 62 90 00 } //1
	condition:
