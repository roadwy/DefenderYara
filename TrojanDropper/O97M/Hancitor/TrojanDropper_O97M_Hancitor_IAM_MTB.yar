...
rule TrojanDropper_O97M_Hancitor_IAM_MTB{
	...
	strings :
		$a_01_0 = {43 61 6c 6c 20 73 74 65 74 70 74 77 77 6f } //1 Call stetptwwo
		...
		$a_01_3 = {70 75 73 68 73 74 72 20 3d 20 22 5c 57 22 20 26 20 22 30 72 22 20 26 20 22 64 2e 64 22 } //1 pushstr = "\W" & "0r" & "d.d"
		...
		$a_01_6 = {26 20 79 79 20 26 20 70 75 73 68 73 74 72 20 26 20 22 6c 6c 22 20 26 } //1 & yy & pushstr & "ll" &
