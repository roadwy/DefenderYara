...
rule TrojanDropper_O97M_Hancitor_HAF_MTB{
	...
	strings :
		$a_01_0 = {79 61 2e 77 61 76 } //01 00  ya.wav
		$a_01_1 = {70 75 73 68 73 74 72 20 3d 20 22 5c 57 22 20 26 20 22 30 72 64 2e 64 22 } //01 00  pushstr = "\W" & "0rd.d"
		...
		$a_01_4 = {26 20 70 75 73 68 73 74 72 20 26 20 22 6c 6c 22 20 26 20 22 2c 22 20 26 20 22 44 6c 6c 22 20 26 20 22 55 6e 72 65 67 69 73 74 65 72 53 65 72 76 65 72 22 } //01 00  & pushstr & "ll" & "," & "Dll" & "UnregisterServer"
