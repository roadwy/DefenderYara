...
rule TrojanDropper_O97M_Hancitor_JAP_MTB{
	...
	strings :
		...
		$a_03_4 = {76 62 4e 75 6c 6c 53 74 72 69 6e 67 2c 20 53 57 5f 53 48 4f 57 4e 4f 52 4d 41 4c 90 0c 02 00 45 6e 64 20 49 66 90 0c 02 00 45 6e 64 20 53 75 62 90 00 } //1
	condition:
