...
rule TrojanDropper_O97M_Hancitor_JAK_MTB{
	meta:
		description = "TrojanDropper:O97M/Hancitor.JAK!MTB,SIGNATURE_TYPE_MACROHSTR_EXT,05 00 05 00 05 00 00 01 00 "
	...
	strings :
		...
		$a_03_2 = {4e 61 6d 65 20 6d 79 68 6f 6d 65 20 26 20 22 5c 90 02 10 2e 70 75 6d 70 6c 22 20 41 73 20 68 73 61 90 0c 02 00 45 6e 64 20 53 75 62 90 00 } //01 00 
