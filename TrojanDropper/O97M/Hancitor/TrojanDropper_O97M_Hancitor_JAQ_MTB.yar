...
rule TrojanDropper_O97M_Hancitor_JAQ_MTB{
	...
	strings :
		...
		$a_01_4 = {70 61 66 68 20 3d 20 69 65 70 } //01 00 
		$a_01_5 = {70 6c 6f 70 20 3d 20 70 61 66 68 } //01 00 
		$a_01_6 = {43 61 6c 6c 20 6a 6f 70 28 6d 79 68 6f 6d 65 2c 20 70 6c 6f 70 20 26 20 22 5c 22 20 26 20 22 53 74 61 74 69 63 2e 64 22 20 26 20 22 6c 22 20 26 20 22 6c 22 29 } //00 00 
	condition:
		any of ($a_*)
