...
rule TrojanDropper_O97M_Hancitor_HAQ_MTB{
	meta:
		description = "TrojanDropper:O97M/Hancitor.HAQ!MTB,SIGNATURE_TYPE_MACROHSTR_EXT,06 00 06 00 06 00 00 01 00 "
		
	strings :
		$a_01_0 = {57 30 72 64 2e 64 6c 6c } //01 00  W0rd.dll
		$a_01_1 = {26 20 6a 73 64 20 26 } //01 00  & jsd &
		$a_01_2 = {43 61 6c 6c 20 73 73 73 73 } //01 00  Call ssss
		...
		$a_01_4 = {26 20 79 79 20 26 20 70 75 73 68 73 74 72 20 26 20 22 6c 6c 22 20 26 20 22 2c 22 20 26 20 22 55 6e 69 6e 73 74 61 6c 6c 46 6f 6e 74 22 } //01 00  & yy & pushstr & "ll" & "," & "UninstallFont"
