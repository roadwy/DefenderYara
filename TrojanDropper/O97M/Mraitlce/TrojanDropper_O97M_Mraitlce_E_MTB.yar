...
rule TrojanDropper_O97M_Mraitlce_E_MTB{
	...
	strings :
		...
		$a_00_1 = {43 72 65 61 74 65 4f 62 6a 65 63 74 28 22 57 53 63 72 69 70 74 2e 53 68 65 6c 6c 22 29 } //01 00 
		$a_00_2 = {2e 65 78 65 22 } //01 00 
		$a_00_3 = {57 72 69 74 65 42 79 74 65 73 } //00 00 
	condition:
		any of ($a_*)
