...
rule TrojanDropper_O97M_Powdow_LLB_MTB{
	...
	strings :
		$a_01_0 = {22 6a 73 22 } //01 00 
		$a_01_1 = {26 20 22 65 22 29 } //01 00 
		...
		$a_01_3 = {54 68 69 73 57 6f 72 6b 62 6f 6f 6b 2e 53 68 65 65 74 73 2e 41 64 64 } //01 00 
		$a_01_4 = {2e 56 61 6c 75 65 20 3d 20 56 42 41 2e 41 72 72 61 79 28 22 23 22 2c 20 22 53 68 65 65 74 22 29 } //00 00 
	condition:
		any of ($a_*)
