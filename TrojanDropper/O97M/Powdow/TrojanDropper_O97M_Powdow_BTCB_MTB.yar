...
rule TrojanDropper_O97M_Powdow_BTCB_MTB{
	...
	strings :
		$a_03_0 = {53 75 62 20 44 6f 63 75 6d 65 6e 74 5f 6f 70 65 6e 28 29 [0-30] 20 3d 20 6d 61 69 6e 2e 72 28 22 63 3a 5c 70 72 6f 67 72 61 6d 64 61 74 61 5c [0-20] 2e 68 22 29 90 0c 02 00 45 6e 64 20 53 75 62 } //1
		$a_03_1 = {53 75 62 20 44 6f 63 75 6d 65 6e 74 5f 6f 70 65 6e 28 29 [0-30] 20 3d 20 6d 61 69 6e 2e 72 28 22 63 3a 5c 75 73 65 72 73 5c 70 75 62 6c 69 63 5c [0-20] 2e 68 74 22 29 90 0c 02 00 45 6e 64 20 53 75 62 } //1
		$a_03_2 = {41 74 74 72 69 62 75 74 65 20 56 42 5f 4e 61 6d 65 20 3d 20 22 6d 61 69 6e 22 90 0c 02 00 50 75 62 6c 69 63 20 46 75 6e 63 74 69 6f 6e 20 72 28 [0-20] 29 [0-20] 3d 20 [0-20] 20 26 20 22 [0-01] 61 22 } //1
		...
		$a_03_5 = {3d 20 4e 65 77 20 57 73 68 53 68 65 6c 6c [0-20] 2e 72 75 6e 20 [0-20] 45 6e 64 20 46 75 6e 63 74 69 6f 6e } //1
	condition:
