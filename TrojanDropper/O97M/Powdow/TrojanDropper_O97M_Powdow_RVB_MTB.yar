...
rule TrojanDropper_O97M_Powdow_RVB_MTB{
	...
	strings :
		$a_03_0 = {43 72 65 61 74 65 4f 62 6a 65 63 74 28 22 77 73 63 72 69 70 74 2e 73 68 65 6c 6c 22 29 0d 0a 90 02 0a 2e 65 78 65 63 90 00 } //1
		$a_03_1 = {22 63 3a 5c 77 69 6e 64 6f 77 73 5c 65 78 70 6c 6f 72 65 72 20 22 20 26 20 90 02 0a 0d 0a 45 6e 64 20 46 75 6e 63 74 69 6f 6e 90 00 } //1
