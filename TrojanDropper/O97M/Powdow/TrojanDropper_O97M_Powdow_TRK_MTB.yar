...
rule TrojanDropper_O97M_Powdow_TRK_MTB{
	...
	strings :
		...
		$a_03_3 = {70 2e 57 72 69 74 65 4c 69 6e 65 20 41 63 74 69 76 65 44 6f 63 75 6d 65 6e 74 2e 52 61 6e 67 65 90 0c 02 00 70 2e 57 72 69 74 65 4c 69 6e 65 20 28 22 27 90 00 } //1
