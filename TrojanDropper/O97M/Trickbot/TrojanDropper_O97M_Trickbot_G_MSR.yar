...
rule TrojanDropper_O97M_Trickbot_G_MSR{
	...
	strings :
		$a_01_0 = {53 70 65 61 6b 2e 57 72 69 74 65 20 46 61 78 49 6e 66 6f 2e 43 69 63 6c 65 73 } //01 00 
		$a_01_1 = {45 78 65 63 20 22 65 78 70 6c 6f 72 65 72 2e 65 78 65 20 43 3a 5c 42 61 74 74 6c 65 5c 54 68 65 6d 65 73 2e 76 62 73 22 } //02 00 
