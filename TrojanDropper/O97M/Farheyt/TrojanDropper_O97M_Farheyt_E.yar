...
rule TrojanDropper_O97M_Farheyt_E_2{
	...
	strings :
		...
		$a_00_1 = {20 2b 20 54 45 54 45 } //01 00 
		$a_00_2 = {20 2b 20 4a 4e 42 42 48 } //01 00 
		$a_00_3 = {3d 20 43 72 65 61 74 65 4f 62 6a 65 63 74 28 22 57 6f } //01 00 
		$a_00_4 = {2e 41 70 70 6c 69 63 61 74 69 6f 6e 22 29 } //01 00 
