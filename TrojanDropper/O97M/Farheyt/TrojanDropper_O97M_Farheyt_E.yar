...
rule TrojanDropper_O97M_Farheyt_E_2{
	...
	strings :
		$a_02_0 = {41 63 74 69 76 65 44 6f 63 75 6d 65 6e 74 2e 53 61 76 65 41 73 20 46 69 6c 65 4e 61 6d 65 3a 3d 90 02 08 2c 20 46 69 6c 65 46 6f 72 6d 61 74 3a 3d 77 64 46 6f 72 6d 61 74 52 54 46 90 00 } //1
		...
		$a_02_5 = {45 6e 76 69 72 6f 6e 24 28 90 02 0a 29 20 2b 90 00 } //1
	condition:
