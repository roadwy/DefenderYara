...
rule TrojanDropper_O97M_Farheyt_C{
	...
	strings :
		...
		$a_03_2 = {2e 56 69 73 69 62 6c 65 20 3d 20 46 61 6c 73 65 90 02 1a 2e 44 6f 63 75 6d 65 6e 74 73 2e 4f 70 65 6e 20 28 54 43 41 29 90 00 } //10
		$a_01_3 = {45 6e 76 69 72 6f 6e 24 28 } //5 Environ$(
		$a_01_4 = {22 72 74 22 20 26 20 43 68 72 28 31 30 32 29 } //10 "rt" & Chr(102)
		$a_03_5 = {41 63 74 69 76 65 44 6f 63 75 6d 65 6e 74 2e 53 61 76 65 41 73 20 46 69 6c 65 4e 61 6d 65 3a 3d 90 02 0a 2c 20 46 69 6c 65 46 6f 72 6d 61 74 3a 3d 77 64 46 6f 72 6d 61 74 52 54 46 90 00 } //2
		...
		$a_03_16 = {56 69 73 69 62 6c 65 20 3d 20 46 61 6c 73 65 90 02 1a 2e 44 6f 63 75 6d 65 6e 74 73 2e 4f 70 65 6e 20 28 54 54 54 44 41 44 53 53 29 90 00 } //10
		...
		$a_03_20 = {56 61 6c 28 90 02 0a 29 20 2d 20 38 90 00 } //7
		...
		$a_03_25 = {3d 20 43 72 65 61 74 65 4f 62 6a 65 63 74 28 90 02 30 29 0d 0a 90 02 15 2e 56 69 73 69 62 6c 65 20 3d 20 46 61 6c 73 65 90 00 } //5
		$a_01_26 = {22 2e 41 22 20 26 20 22 70 70 6c 69 63 61 74 69 6f 6e 22 29 } //7 ".A" & "pplication")
		$a_03_27 = {4d 6f 64 75 6c 65 31 2e 90 02 0a 20 28 31 29 0d 0a 90 02 0a 2e 51 75 69 74 90 00 } //7
	condition:
