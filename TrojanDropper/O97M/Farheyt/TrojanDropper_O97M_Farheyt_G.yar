...
rule TrojanDropper_O97M_Farheyt_G{
	...
	strings :
		...
		$a_01_3 = {28 31 39 20 2b 20 36 38 29 20 26 20 22 6f 72 22 20 2b 20 22 64 2e 41 70 70 6c 69 63 61 74 69 6f 6e 22 } //01 00 
		$a_01_4 = {2b 20 43 68 72 28 39 20 2b 20 39 32 29 } //01 00 
		$a_01_5 = {2b 20 22 72 22 20 26 20 22 74 66 22 } //02 00 
		$a_01_6 = {2b 20 22 72 72 61 31 22 20 26 } //00 00 
