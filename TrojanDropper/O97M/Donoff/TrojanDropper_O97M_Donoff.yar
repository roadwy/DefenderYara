...
rule TrojanDropper_O97M_Donoff_4{
	...
	strings :
		$a_02_0 = {2c 20 2c 20 43 42 79 74 65 28 22 26 22 20 2b 20 43 68 72 28 90 10 03 00 20 2d 20 90 10 03 00 29 20 26 90 00 } //1
		$a_02_1 = {53 74 72 52 65 76 65 72 73 65 28 22 61 70 78 45 22 29 20 2b 20 4d 69 64 28 22 90 02 10 6e 64 45 6e 76 69 72 90 02 10 22 2c 20 90 10 02 00 2c 20 37 29 20 2b 20 22 6f 6e 6d 65 6e 74 53 74 72 69 6e 67 73 22 90 00 } //1
	condition:
...
rule TrojanDropper_O97M_Donoff_5{
	...
	strings :
		...
		$a_03_1 = {29 20 2b 20 31 29 29 29 29 2c 20 28 28 90 10 10 00 20 90 04 01 04 2b 2f 2a 2d 20 90 10 10 00 29 29 29 90 00 } //1
	condition:
...
rule TrojanDropper_O97M_Donoff_6{
	...
	strings :
		$a_03_0 = {52 65 44 69 6d 20 90 02 20 28 28 28 28 55 42 6f 75 6e 64 28 90 02 20 29 20 2b 20 31 29 20 5c 20 90 05 09 04 61 2d 7a 34 29 20 2a 20 33 29 20 2d 20 31 29 90 00 } //3
		$a_03_1 = {3d 20 43 61 6c 6c 42 79 4e 61 6d 65 28 90 02 20 2c 20 22 47 65 74 53 70 65 63 69 61 6c 46 6f 6c 64 65 72 22 2c 20 90 00 } //1
		$a_03_2 = {26 20 22 5c 90 02 20 2e 65 78 65 22 90 00 } //2
		$a_03_3 = {2b 20 22 5c 22 20 2b 20 90 02 36 2e 65 90 03 01 01 58 78 90 03 01 01 45 65 22 90 00 } //2
		$a_03_4 = {53 65 74 20 90 02 20 20 3d 20 43 72 65 61 74 65 4f 62 6a 65 63 74 28 22 57 53 63 72 69 70 74 2e 53 68 65 6c 6c 22 29 90 00 } //1
	condition:
...
rule TrojanDropper_O97M_Donoff_7{
	...
	strings :
		...
		$a_03_1 = {29 20 2b 20 31 29 29 29 29 2c 20 28 28 90 05 01 01 2d 90 0f 03 00 90 10 10 00 20 90 04 01 04 2b 2f 2a 2d 20 90 0f 03 00 90 10 08 00 29 29 29 90 0c 03 00 90 1d 10 00 20 3d 20 90 1d 10 00 28 90 1d 10 00 29 90 02 30 90 0c 03 00 90 1b 08 28 90 1b 09 29 90 00 } //1
	condition:
		((#a_03_0  & 1)*1+(#a_03_1  & 1)*1) >=2
...
rule TrojanDropper_O97M_Donoff_8{
	...
	strings :
		...
		$a_03_1 = {45 6e 64 20 53 65 6c 65 63 74 0d 0a 90 03 08 00 45 6e 64 20 49 66 0d 0a 49 66 20 90 1c 03 00 90 1d 10 00 20 2b 20 90 1c 03 00 90 1d 10 00 20 3e 20 90 1c 03 00 90 1d 10 00 20 54 68 65 6e 20 90 1b 03 90 1d 10 00 20 3d 20 90 1b 05 90 1d 10 00 20 2d 20 90 1b 01 90 1d 10 00 90 00 } //1
		$a_03_2 = {29 20 2b 20 31 29 29 29 29 2c 20 28 28 90 05 01 04 2b 2a 2f 2d 90 0f 03 00 90 10 10 00 20 90 04 01 04 2b 2a 2f 2d 20 90 0f 03 00 90 10 10 00 29 29 29 90 00 } //1
	condition:
