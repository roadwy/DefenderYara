...
rule TrojanDropper_O97M_Donoff_CS_eml{
	...
	strings :
		...
		$a_03_2 = {46 69 6c 65 43 6f 70 79 20 4a 6f 69 6e 28 90 02 0c 2c 20 22 22 29 90 00 } //1
		$a_03_3 = {53 68 65 6c 6c 20 4a 6f 69 6e 28 90 02 0d 2c 20 22 22 29 90 00 } //1
