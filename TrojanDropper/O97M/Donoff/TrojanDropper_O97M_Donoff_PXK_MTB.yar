...
rule TrojanDropper_O97M_Donoff_PXK_MTB{
	...
	strings :
		$a_02_0 = {5c 63 61 6c 63 2e 65 78 65 90 0a 32 00 74 65 73 74 31 3d 73 68 65 6c 6c 28 22 63 3a 5c 77 69 6e 64 6f 77 73 5c 73 79 73 74 65 6d 33 32 90 00 } //1
		$a_02_1 = {5c 6d 73 70 61 69 6e 74 2e 65 78 65 90 0a 32 00 3d 73 68 65 6c 6c 28 22 63 3a 5c 77 69 6e 64 6f 77 73 5c 73 79 73 74 65 6d 33 32 90 00 } //1
