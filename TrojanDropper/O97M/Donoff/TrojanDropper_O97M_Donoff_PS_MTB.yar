...
rule TrojanDropper_O97M_Donoff_PS_MTB{
	...
	strings :
		...
		$a_03_1 = {73 74 72 73 61 76 65 74 6f 20 3d 20 69 6e 76 6f 69 63 65 20 26 20 22 90 05 28 06 61 2d 7a 30 2d 39 2e 6a 73 22 90 00 } //1
		$a_03_2 = {73 74 72 6c 69 6e 6b 20 3d 20 22 68 74 74 70 73 3a 2f 2f 90 02 14 2e 63 6f 6d 2f 90 02 09 2e 70 68 70 22 90 00 } //1
