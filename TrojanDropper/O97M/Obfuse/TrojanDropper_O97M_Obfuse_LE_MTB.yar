...
rule TrojanDropper_O97M_Obfuse_LE_MTB{
	...
	strings :
		...
		$a_03_1 = {54 65 78 74 3a 3d 22 3d 20 22 20 2b 20 [0-14] 20 2b 20 22 20 5c 2a 20 43 61 72 64 54 65 78 74 22 2c 20 5f } //1
		...
		$a_03_5 = {4f 70 65 6e 20 [0-25] 20 46 6f 72 20 4f 75 74 70 75 74 20 41 73 20 23 } //1
	condition:
