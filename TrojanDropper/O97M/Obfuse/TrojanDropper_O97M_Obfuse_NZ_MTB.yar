...
rule TrojanDropper_O97M_Obfuse_NZ_MTB{
	meta:
		description = "TrojanDropper:O97M/Obfuse.NZ!MTB,SIGNATURE_TYPE_MACROHSTR_EXT,06 00 06 00 06 00 00 01 00 "
