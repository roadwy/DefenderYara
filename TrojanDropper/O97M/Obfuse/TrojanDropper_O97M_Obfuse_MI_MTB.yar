...
rule TrojanDropper_O97M_Obfuse_MI_MTB{
	...
	strings :
		...
		$a_01_4 = {2e 54 61 67 20 3d 20 45 6e 76 69 72 6f 6e 28 22 54 45 4d 50 22 29 } //01 00  .Tag = Environ("TEMP")
		$a_01_5 = {2e 54 61 67 20 3d 20 45 6e 76 69 72 6f 6e 28 22 41 50 50 44 41 54 41 22 29 } //00 00  .Tag = Environ("APPDATA")
	condition:
		any of ($a_*)
