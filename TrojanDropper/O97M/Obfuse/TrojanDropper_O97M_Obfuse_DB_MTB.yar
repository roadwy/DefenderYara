...
rule TrojanDropper_O97M_Obfuse_DB_MTB{
	...
	strings :
		...
		$a_01_3 = {2e 54 65 78 74 52 65 74 72 69 65 76 61 6c 4d 6f 64 65 2e 49 6e 63 6c 75 64 65 48 69 64 64 65 6e 54 65 78 74 20 3d 20 54 72 75 65 } //00 00  .TextRetrievalMode.IncludeHiddenText = True
	condition:
		any of ($a_*)
