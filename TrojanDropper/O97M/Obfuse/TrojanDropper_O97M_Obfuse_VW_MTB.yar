...
rule TrojanDropper_O97M_Obfuse_VW_MTB{
	...
	strings :
		...
		$a_03_2 = {3d 20 73 74 72 50 61 72 68 20 26 20 22 90 02 0a 22 20 26 20 22 2e 62 61 74 22 90 00 } //1
		$a_00_3 = {3d 20 22 63 3a 5c 44 61 74 61 69 6e 76 5c 22 } //1 = "c:\Datainv\"
		$a_03_4 = {3d 20 72 65 63 6f 72 64 20 26 20 22 90 02 0a 22 20 26 20 22 2e 62 61 74 22 90 00 } //1
		$a_03_5 = {53 74 61 72 74 50 72 6f 63 65 73 73 20 90 02 0a 2c 90 00 } //1
	condition:
