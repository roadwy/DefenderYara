...
rule TrojanDropper_O97M_Obfuse_NB_MTB{
	...
	strings :
		...
		$a_01_1 = {2b 20 22 2e 64 22 20 2b 20 22 6c 6c 22 } //01 00 
		$a_01_2 = {22 5c 55 6e 7a 54 6d 70 22 } //01 00 
		$a_01_3 = {26 20 22 5c 6f 6c 65 4f 62 6a 22 20 2b 20 22 65 63 74 2a 2e 62 69 6e 22 2c 20 5a 69 70 4e 61 6d 65 2c } //01 00 
