...
rule TrojanDropper_O97M_Obfuse_ST_MTB{
	...
	strings :
		...
		$a_03_1 = {20 3d 20 73 74 72 50 61 72 68 20 26 20 22 [0-0a] 22 20 26 20 22 2e 6a 73 65 22 } //1
		$a_03_2 = {20 3d 20 22 63 3a 5c 52 65 77 69 5f 43 6f 6f 6c 5c [0-0a] 2e 63 6d 64 22 } //1
		$a_03_3 = {20 3d 20 22 63 3a 5c 55 73 65 72 5f 46 6f 74 6f 5c [0-0a] 2e 62 61 74 22 } //1
	condition:
