...
rule TrojanDropper_O97M_Obfuse_PT_MTB{
	...
	strings :
		$a_03_0 = {45 6e 76 69 72 6f 6e 28 22 55 53 45 52 50 52 4f 46 49 4c 45 22 29 20 26 20 22 2f 90 02 05 2e 6a 73 22 90 00 } //1
		...
		$a_03_4 = {2e 43 72 65 61 74 65 28 90 02 30 20 4e 75 6c 6c 2c 20 4e 75 6c 6c 2c 20 69 6e 74 50 72 6f 63 65 73 73 49 44 29 90 00 } //1
	condition:
