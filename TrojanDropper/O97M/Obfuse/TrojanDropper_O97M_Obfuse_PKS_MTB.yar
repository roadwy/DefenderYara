...
rule TrojanDropper_O97M_Obfuse_PKS_MTB{
	...
	strings :
		$a_01_0 = {43 3a 5c 55 73 65 72 73 5c 50 75 62 6c 69 63 5c 75 70 64 61 74 65 2e 6a 73 } //01 00  C:\Users\Public\update.js
		...
		$a_01_2 = {6d 65 64 69 61 66 69 72 65 2e 63 6f 6d 2f 66 69 6c 65 2f 76 77 74 32 75 38 37 6a 66 7a 70 62 30 66 34 2f 33 2e 68 74 6d 2f 66 69 6c 65 } //01 00  mediafire.com/file/vwt2u87jfzpb0f4/3.htm/file
