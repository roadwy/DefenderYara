...
rule TrojanDropper_O97M_Obfuse_PKS_MTB{
	...
	strings :
		...
		$a_03_1 = {77 69 6e 6d 67 6d 74 73 3a 27 2c 27 43 3a 5c 90 02 05 50 72 6f 67 72 61 6d 44 61 74 61 5c 90 02 05 64 64 6f 6e 64 2e 63 6f 6d 90 00 } //1
		...
		$a_03_3 = {3d 20 52 65 70 6c 61 63 65 28 90 02 0a 2c 20 22 90 02 05 22 2c 20 22 90 02 03 22 29 90 00 } //1
	condition:
