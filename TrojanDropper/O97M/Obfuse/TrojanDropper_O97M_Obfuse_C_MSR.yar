...
rule TrojanDropper_O97M_Obfuse_C_MSR{
	...
	strings :
		...
		$a_02_1 = {3d 20 42 65 6e 61 6a 2e 43 72 65 61 74 65 54 65 78 74 46 69 6c 65 28 22 63 3a 5c 90 02 02 5c 6b 65 79 6c 6f 61 64 90 02 10 2e 63 6d 64 22 2c 20 54 72 75 65 29 90 00 } //1
