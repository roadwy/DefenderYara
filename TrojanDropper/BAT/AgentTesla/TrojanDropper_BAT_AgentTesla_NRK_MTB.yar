...
rule TrojanDropper_BAT_AgentTesla_NRK_MTB{
	...
	strings :
		...
		$a_01_1 = {59 54 48 4f 50 4e 42 59 54 } //01 00 
		$a_01_2 = {50 72 6f 63 65 73 73 49 6e 66 6f 72 6d 61 74 69 6f 6e 43 6c 61 73 73 } //01 00 
		$a_01_3 = {4d 4a 43 4b 56 4b 4c 55 49 4f 52 } //01 00 
		$a_01_4 = {52 53 44 53 26 39 38 } //00 00 
	condition:
		any of ($a_*)
