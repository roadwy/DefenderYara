...
rule TrojanDropper_BAT_AgentTesla_NGT_MTB{
	...
	strings :
		$a_03_0 = {09 72 d7 00 00 70 28 90 01 03 0a 28 90 01 03 0a 13 0d 11 0d 2c 24 09 72 90 01 03 70 28 90 01 03 0a 73 90 01 03 0a 13 0e 11 0e 17 6f 90 01 03 0a 90 00 } //5
