...
rule TrojanDropper_BAT_AgentTesla_NGT_MTB{
	...
	strings :
		...
		$a_01_1 = {57 69 6e 64 6f 77 73 41 70 70 31 2e 52 65 73 6f 75 72 63 65 73 } //01 00 
		$a_01_2 = {43 79 70 68 65 72 54 65 61 6d } //01 00 
		$a_01_3 = {24 36 36 36 62 31 65 63 65 2d 37 61 39 65 2d 34 62 36 33 2d 61 33 61 31 2d 36 37 64 39 34 34 36 66 35 62 30 30 } //00 00 
	condition:
		any of ($a_*)
