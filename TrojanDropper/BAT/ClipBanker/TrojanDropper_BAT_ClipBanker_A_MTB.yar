...
rule TrojanDropper_BAT_ClipBanker_A_MTB{
	...
	strings :
		...
		$a_01_5 = {53 65 63 75 72 69 74 79 50 72 6f 74 6f 63 6f 6c } //01 00  SecurityProtocol
		$a_01_6 = {52 65 73 6f 75 72 63 65 4d 61 6e 61 67 65 72 } //00 00  ResourceManager
	condition:
		any of ($a_*)
