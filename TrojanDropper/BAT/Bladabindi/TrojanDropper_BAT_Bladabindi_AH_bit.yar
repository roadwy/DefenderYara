...
rule TrojanDropper_BAT_Bladabindi_AH_bit{
	...
	strings :
		$a_03_0 = {48 00 61 00 63 00 6b 00 65 00 64 00 00 90 01 01 74 00 68 00 65 00 64 00 61 00 79 00 73 00 2e 90 00 } //2
		...
		$a_03_3 = {5c 57 6f 72 6d 90 04 01 02 20 2d 43 6c 69 65 6e 74 90 04 01 02 20 2d 4e 6f 72 6d 61 6c 44 6f 77 6e 6c 6f 61 64 65 72 90 00 } //2
	condition:
