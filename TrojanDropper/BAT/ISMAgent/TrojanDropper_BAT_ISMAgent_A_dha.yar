...
rule TrojanDropper_BAT_ISMAgent_A_dha_2{
	...
	strings :
		...
		$a_03_1 = {63 6d 64 20 2f 63 20 73 63 68 74 61 73 6b 73 20 2f 71 75 65 72 79 20 2f 74 6e 20 54 69 6d 65 55 70 64 61 74 65 20 3e 20 4e 55 4c 20 32 3e 26 31 20 7c 7c 20 73 63 68 74 61 73 6b 73 20 2f 63 72 65 61 74 65 20 2f 73 63 20 6d 69 6e 75 74 65 20 2f 6d 6f 20 90 02 05 20 2f 74 6e 20 54 69 6d 65 55 70 64 61 74 65 20 2f 74 72 20 22 5c 22 90 00 } //1
		$a_01_2 = {2f 00 00 00 7c 7c 00 00 2e 64 2e 00 6e 2e 00 00 2e 66 2e 00 77 77 77 2e 00 00 00 00 2e 72 2e 00 } //1
		$a_03_3 = {25 25 25 25 00 00 00 00 5c 22 22 00 2e 90 02 20 00 5e 5e 5e 5e 5e 5e 90 00 } //1
		$a_01_4 = {5e 5e 5e 5e 5e 5e 5e 5e 5e 5e 5e 5e 5e 5e 5e 5e 5e 5e 5e 5e 5e 5e 5e 5e 5e 5e 5e 5e 00 00 00 00 48 65 6c 70 } //1
		$a_03_5 = {48 65 6c 70 00 00 00 00 75 73 61 67 65 3a 90 02 10 2d 63 20 20 53 61 6d 70 6c 65 44 6f 6d 61 69 6e 2e 63 6f 6d 20 2d 6d 20 73 63 68 65 64 75 6c 65 6d 69 6e 75 74 65 73 0a 0a 00 90 00 } //1
		...
		$a_03_9 = {00 53 75 63 63 65 73 73 00 90 02 08 6f 6e 66 69 67 75 72 65 64 20 73 75 63 63 65 73 73 66 75 6c 6c 79 0a 00 00 90 00 } //1
		$a_03_10 = {61 6e 20 6e 6f 74 20 62 65 20 63 6f 6e 66 69 67 75 72 65 64 0a 00 00 90 02 03 77 77 77 00 68 74 74 70 3a 2f 2f 00 90 00 } //1
