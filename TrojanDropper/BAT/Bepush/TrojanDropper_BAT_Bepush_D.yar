...
rule TrojanDropper_BAT_Bepush_D{
	...
	strings :
		...
		$a_01_1 = {6f 72 6d 73 41 70 70 6c 69 63 61 74 69 6f 6e 35 2e 46 6f 72 6d 31 2e 72 65 73 6f 75 72 63 65 73 00 46 6c 61 73 68 47 75 6e 63 65 6c 6c 65 2e 50 } //00 00 
	condition:
		any of ($a_*)
