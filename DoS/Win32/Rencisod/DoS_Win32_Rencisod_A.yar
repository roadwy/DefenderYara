...
rule DoS_Win32_Rencisod_A{
	...
	strings :
		$a_02_0 = {2e 00 70 00 64 00 66 00 90 02 04 2e 00 64 00 6f 00 63 00 90 02 04 2e 00 64 00 6f 00 63 00 78 00 90 00 } //10
		$a_02_1 = {2e 70 64 66 90 02 04 2e 64 6f 63 90 02 04 2e 64 6f 63 78 90 00 } //10
		$a_02_2 = {2e 00 73 00 71 00 6c 00 90 02 04 2e 00 6d 00 73 00 67 00 90 02 04 2e 00 70 00 73 00 74 00 90 00 } //10
		$a_02_3 = {2e 73 71 6c 90 02 04 2e 6d 73 67 90 02 04 2e 70 73 74 90 00 } //10
		...
		$a_02_7 = {68 00 74 00 74 00 70 00 3a 00 2f 00 2f 00 90 02 05 2f 00 64 00 61 00 74 00 61 00 2f 00 90 00 } //5
		$a_02_8 = {68 74 74 70 3a 2f 2f 90 02 05 2f 64 61 74 61 2f 90 00 } //5
