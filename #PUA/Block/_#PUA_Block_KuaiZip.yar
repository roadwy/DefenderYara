...
rule _#PUA_Block_KuaiZip_16{
	...
	strings :
		...
		$a_80_4 = {4d 69 6e 69 44 65 62 75 67 65 72 } //MiniDebuger  1
		$a_02_5 = {72 00 65 00 70 00 6f 00 72 00 74 00 2e 00 90 02 0f 2e 00 6d 00 75 00 78 00 69 00 6e 00 2e 00 66 00 75 00 6e 00 90 00 } //1
		$a_02_6 = {72 65 70 6f 72 74 2e 90 02 0f 2e 6d 75 78 69 6e 2e 66 75 6e 90 00 } //1
	condition:
...
rule _#PUA_Block_KuaiZip_21{
	...
	strings :
		...
		$a_02_2 = {43 3a 5c 44 6f 63 75 6d 65 6e 74 73 20 61 6e 64 20 53 65 74 74 69 6e 67 73 5c 90 02 0f 5c 41 70 70 6c 69 63 61 74 69 6f 6e 20 44 61 74 61 5c 43 61 6c 66 57 61 6c 6c 70 61 70 65 72 5c 90 00 } //1
