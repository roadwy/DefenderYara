...
rule _#PUA_Block_OfferCore_7{
	...
	strings :
		$a_00_0 = {47 45 54 4f 46 46 45 52 53 41 52 52 41 59 } //01 00 
		$a_00_1 = {47 45 54 49 4e 4a 45 43 54 45 44 50 41 52 41 4d } //01 00 
		$a_00_2 = {47 45 54 4f 46 46 45 52 49 4e 44 45 58 42 59 50 41 47 45 } //01 00 
		$a_00_3 = {50 41 47 45 4f 46 46 45 52 43 52 45 41 54 45 } //01 00 
		$a_00_4 = {50 61 67 65 4f 66 66 65 72 41 63 74 69 76 61 74 65 } //01 00 
