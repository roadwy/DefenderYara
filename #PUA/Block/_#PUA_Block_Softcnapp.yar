...
rule _#PUA_Block_Softcnapp_8{
	...
	strings :
		...
		$a_00_2 = {73 6f 66 74 74 6a 2e 70 61 6e 73 68 69 78 6b 2e 63 6f 6d } //01 00 
...
rule _#PUA_Block_Softcnapp_15{
	...
	strings :
		...
		$a_00_4 = {7a 6d 69 77 6e 2e 62 69 6a 69 61 74 75 2e 63 6f 6d } //01 00 
...
rule _#PUA_Block_Softcnapp_16{
	...
	strings :
		...
		$a_00_2 = {6a 00 69 00 61 00 2d 00 73 00 69 00 2e 00 63 00 6e 00 2f 00 61 00 70 00 69 00 2e 00 70 00 68 00 70 00 } //01 00 
		$a_00_3 = {31 00 30 00 31 00 2e 00 33 00 37 00 2e 00 31 00 38 00 38 00 2e 00 34 00 32 00 2f 00 } //01 00 
		$a_00_4 = {64 00 6f 00 77 00 6e 00 64 00 63 00 64 00 6e 00 2e 00 6a 00 69 00 61 00 2d 00 73 00 69 00 2e 00 63 00 6e 00 2f 00 78 00 69 00 61 00 7a 00 61 00 69 00 71 00 69 00 2f 00 78 00 69 00 61 00 7a 00 61 00 69 00 71 00 69 00 2e 00 68 00 74 00 6d 00 6c 00 } //01 00 
		$a_00_5 = {6b 00 78 00 65 00 74 00 72 00 61 00 79 00 2e 00 65 00 78 00 65 00 7c 00 6b 00 78 00 65 00 73 00 63 00 6f 00 72 00 65 00 2e 00 65 00 78 00 65 00 } //00 00 
	condition:
		any of ($a_*)
...
rule _#PUA_Block_Softcnapp_20{
	...
	strings :
		$a_01_0 = {65 73 74 2e 63 6f 6d 2f 77 75 6d 69 6e 67 2f 70 6e 67 2f 6d 6f 6e 69 64 73 2e 70 6e 67 } //01 00 
		$a_01_1 = {64 77 6f 6e 6c 6f 61 64 2e 73 69 6e 6f 73 74 65 65 6c 69 6e 76 65 73 74 2e 63 6f 6d } //01 00 
		$a_01_2 = {44 3a 5c 58 69 61 5a 61 69 51 69 5c 50 72 6f 6a 65 63 74 43 6f 70 79 5c 4d 69 78 65 64 5c 70 64 62 6d 61 70 5c 57 61 6e 4e 65 6e 67 5c 49 6e 73 74 61 6c 6c 2e 70 64 62 } //00 00 
	condition:
		any of ($a_*)
...
rule _#PUA_Block_Softcnapp_21{
	...
	strings :
		$a_01_0 = {5c 54 72 75 6e 6b 50 59 5c 42 69 6e 5c 70 64 62 6d 61 70 5c 53 6d 61 72 74 43 6c 6f 75 64 5c 4d 75 74 75 61 6c 33 32 2e 70 64 62 } //01 00 
		$a_01_1 = {53 43 4d 75 74 75 61 6c 2e 65 78 65 } //01 00 
		$a_01_2 = {2e 00 7a 00 6e 00 73 00 68 00 75 00 72 00 75 00 2e 00 63 00 6f 00 6d 00 } //01 00 
		$a_01_3 = {74 6a 74 76 33 2e 7a 6e 79 73 68 75 72 75 66 61 2e 63 6f 6d 2f } //01 00 
		$a_01_4 = {73 00 70 00 61 00 72 00 6b 00 2e 00 65 00 78 00 65 00 74 00 68 00 65 00 77 00 6f 00 72 00 6c 00 64 00 2e 00 65 00 78 00 65 00 } //00 00 
	condition:
		any of ($a_*)
...
rule _#PUA_Block_Softcnapp_22{
	...
	strings :
		$a_01_0 = {74 6a 69 2e 6c 65 69 73 75 72 65 6c 79 70 61 6e 64 61 2e 63 6f 6d } //01 00 
		$a_01_1 = {5c 00 42 00 75 00 6e 00 64 00 6c 00 65 00 73 00 5c 00 4c 00 69 00 74 00 74 00 6c 00 65 00 5c 00 53 00 6f 00 66 00 74 00 53 00 6b 00 69 00 6e 00 } //01 00 
		$a_01_2 = {4c 00 69 00 74 00 74 00 6c 00 65 00 50 00 69 00 63 00 } //01 00 
		$a_01_3 = {43 00 3a 00 5c 00 50 00 72 00 6f 00 67 00 72 00 61 00 6d 00 20 00 46 00 69 00 6c 00 65 00 73 00 5c 00 4c 00 69 00 74 00 74 00 6c 00 65 00 50 00 69 00 63 00 74 00 75 00 72 00 65 00 } //00 00 
	condition:
		any of ($a_*)
