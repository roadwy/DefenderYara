...
rule _#PUA_Block_Softcnapp_23{
	...
	strings :
		...
		$a_02_2 = {43 3a 5c 44 6f 63 75 6d 65 6e 74 73 20 61 6e 64 20 53 65 74 74 69 6e 67 73 5c 90 02 0f 5c 41 70 70 6c 69 63 61 74 69 6f 6e 20 44 61 74 61 5c 42 75 6e 64 6c 65 42 69 6e 64 5c 90 00 } //1
		$a_80_3 = {55 73 65 56 65 73 74 69 67 65 2e 69 6e 69 } //UseVestige.ini  1
		$a_02_4 = {64 00 6f 00 77 00 6e 00 2e 00 90 02 1f 2e 00 63 00 6f 00 6d 00 90 00 } //1
		$a_02_5 = {64 6f 77 6e 2e 90 02 1f 2e 63 6f 6d 90 00 } //1
	condition:
...
rule _#PUA_Block_Softcnapp_24{
	...
	strings :
		...
		$a_02_1 = {43 00 3a 00 5c 00 44 00 6f 00 63 00 75 00 6d 00 65 00 6e 00 74 00 73 00 20 00 61 00 6e 00 64 00 20 00 53 00 65 00 74 00 74 00 69 00 6e 00 67 00 73 00 5c 00 90 02 0f 5c 00 41 00 70 00 70 00 6c 00 69 00 63 00 61 00 74 00 69 00 6f 00 6e 00 20 00 44 00 61 00 74 00 61 00 5c 00 42 00 75 00 6e 00 64 00 6c 00 65 00 42 00 69 00 6e 00 64 00 5c 00 90 00 } //1
		$a_02_2 = {43 3a 5c 44 6f 63 75 6d 65 6e 74 73 20 61 6e 64 20 53 65 74 74 69 6e 67 73 5c 90 02 0f 5c 41 70 70 6c 69 63 61 74 69 6f 6e 20 44 61 74 61 5c 42 75 6e 64 6c 65 42 69 6e 64 5c 90 00 } //1
		$a_02_3 = {64 00 6f 00 77 00 6e 00 2e 00 90 02 1f 2e 00 63 00 6f 00 6d 00 90 00 } //2
		$a_02_4 = {64 6f 77 6e 2e 90 02 1f 2e 63 6f 6d 90 00 } //2
