...
rule TrojanSpy_BAT_Dordty_AB_MTB{
	...
	strings :
		...
		$a_02_1 = {44 69 73 63 6f 72 64 2d 54 6f 6b 65 6e 2d 47 72 61 62 62 65 72 2d 6d 61 73 74 65 72 90 02 20 44 69 73 63 6f 72 64 54 6f 6b 65 6e 47 72 61 62 62 65 72 90 00 } //1
