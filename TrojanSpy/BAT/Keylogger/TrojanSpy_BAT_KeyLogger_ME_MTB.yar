...
rule TrojanSpy_BAT_KeyLogger_ME_MTB{
	...
	strings :
		...
		$a_01_1 = {65 00 78 00 61 00 6d 00 70 00 6c 00 65 00 31 00 40 00 6d 00 7a 00 2e 00 6e 00 65 00 74 00 61 00 72 00 74 00 69 00 73 00 2e 00 70 00 6c 00 } //01 00 
		...
		$a_01_9 = {53 65 6e 64 4d 61 69 6c } //00 00 
	condition:
		any of ($a_*)
