...
rule TrojanSpy_BAT_KeyLogger_ME_MTB{
	...
	strings :
		$a_03_0 = {16 0a 2b 53 00 06 28 ?? ?? ?? 06 0b 07 17 2e 0a 07 20 01 ?? ?? ?? fe 01 2b 01 17 0c 08 2c 33 00 7e ?? ?? ?? 04 06 0d 12 03 fe ?? ?? ?? ?? 01 6f ?? ?? ?? 0a 6f ?? ?? ?? 0a 00 06 1f 51 fe 01 13 04 11 04 2c 0b 72 ?? ?? ?? 70 28 ?? ?? ?? 06 00 2b 13 } //1
