...
rule TrojanSpy_BAT_Keylogger_BQ{
	...
	strings :
		...
		$a_01_3 = {48 6f 6f 6b 44 65 6c 00 } //01 00 
		$a_01_4 = {2f 00 67 00 65 00 74 00 64 00 61 00 74 00 61 00 2f 00 67 00 65 00 74 00 64 00 61 00 74 00 61 00 2e 00 70 00 68 00 70 00 3f 00 74 00 79 00 70 00 65 00 31 00 3d 00 63 00 26 00 73 00 69 00 74 00 65 00 31 00 3d 00 } //00 00 
