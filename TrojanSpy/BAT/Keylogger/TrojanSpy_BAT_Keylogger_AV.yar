...
rule TrojanSpy_BAT_Keylogger_AV{
	meta:
		description = "TrojanSpy:BAT/Keylogger.AV,SIGNATURE_TYPE_PEHSTR_EXT,05 00 05 00 05 00 00 01 00 "
		
	strings :
		$a_01_0 = {55 00 6c 00 74 00 69 00 6d 00 61 00 74 00 65 00 20 00 4c 00 6f 00 67 00 67 00 65 00 72 00 } //01 00  Ultimate Logger
		...
		$a_01_2 = {74 6d 72 53 65 6e 64 4c 6f 67 5f 54 69 63 6b } //01 00  tmrSendLog_Tick
		$a_01_3 = {53 65 6e 64 4d 61 69 6c 43 6f 6e 66 69 72 6d 61 74 69 6f 6e } //01 00  SendMailConfirmation
