...
rule TrojanSpy_BAT_Reven_A_bit{
	meta:
		description = "TrojanSpy:BAT/Reven.A!bit,SIGNATURE_TYPE_PEHSTR_EXT,03 00 03 00 03 00 00 01 00 "
		
	strings :
		$a_01_0 = {75 73 62 53 70 72 65 61 64 65 72 } //01 00  usbSpreader
		$a_03_1 = {54 65 61 6d 52 65 76 65 6e 67 65 2d 90 02 08 2e 70 64 62 90 00 } //01 00 
