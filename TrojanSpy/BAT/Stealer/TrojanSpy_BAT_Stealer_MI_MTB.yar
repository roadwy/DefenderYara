...
rule TrojanSpy_BAT_Stealer_MI_MTB{
	...
	strings :
		...
		$a_01_1 = {4d 75 74 65 78 41 63 63 65 73 73 52 75 6c 65 } //01 00 
		$a_01_2 = {46 72 6f 6d 42 61 73 65 36 34 54 72 61 6e 73 66 6f 72 6d 4d 6f 64 65 } //01 00 
		...
		$a_01_6 = {52 65 67 69 73 74 72 79 4b 65 79 50 65 72 6d 69 73 73 69 6f 6e 43 68 65 63 6b } //01 00 
		$a_01_7 = {43 72 79 70 74 6f 4b 65 79 41 63 63 65 73 73 52 75 6c 65 } //01 00 
		$a_01_8 = {43 72 65 61 74 65 44 65 63 72 79 70 74 6f 72 } //01 00 
