...
rule TrojanSpy_BAT_Stealer_MK_MTB{
	...
	strings :
		$a_03_0 = {11 01 16 11 01 8e 69 28 1a 00 00 0a 13 ?? 38 ?? 00 00 00 [0-18] 11 ?? 16 11 ?? 8e 69 28 ?? ?? ?? ?? 13 04 38 ?? ff ff ff } //1
		$a_03_1 = {02 8e 69 8d 09 00 00 01 13 ?? 38 12 00 00 00 fe 0c ?? 00 45 01 00 00 00 ?? 00 00 00 38 ?? 00 00 00 11 ?? 11 ?? 16 11 ?? 8e 69 [0-1f] 26 20 00 00 00 00 } //1
