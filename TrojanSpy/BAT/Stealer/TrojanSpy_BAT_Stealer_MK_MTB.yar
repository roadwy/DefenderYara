...
rule TrojanSpy_BAT_Stealer_MK_MTB{
	meta:
		description = "TrojanSpy:BAT/Stealer.MK!MTB,SIGNATURE_TYPE_PEHSTR_EXT,08 00 08 00 08 00 00 "
		
	strings :
		$a_03_0 = {11 01 16 11 01 8e 69 28 1a 00 00 0a 13 90 01 01 38 90 01 01 00 00 00 90 02 18 11 90 01 01 16 11 90 01 01 8e 69 28 90 01 04 13 04 38 90 01 01 ff ff ff 90 00 } //1
		$a_03_1 = {02 8e 69 8d 09 00 00 01 13 90 01 01 38 12 00 00 00 fe 0c 90 01 01 00 45 01 00 00 00 90 01 01 00 00 00 38 90 01 01 00 00 00 11 90 01 01 11 90 01 01 16 11 90 01 01 8e 69 90 02 1f 26 20 00 00 00 00 90 00 } //1
