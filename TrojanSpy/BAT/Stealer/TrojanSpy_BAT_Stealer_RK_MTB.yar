...
rule TrojanSpy_BAT_Stealer_RK_MTB{
	...
	strings :
		...
		$a_01_3 = {67 65 74 5f 50 6f 74 65 6e 74 69 61 6c 6c 79 56 75 6c 6e 65 72 61 62 6c 65 50 61 73 73 77 6f 72 64 73 } //01 00  get_PotentiallyVulnerablePasswords
		$a_01_4 = {41 64 64 43 6c 69 70 62 6f 61 72 64 46 6f 72 6d 61 74 4c 69 73 74 65 6e 65 72 } //01 00  AddClipboardFormatListener
		$a_01_5 = {43 72 65 61 74 65 54 6f 6f 6c 68 65 6c 70 33 32 53 6e 61 70 73 68 6f 74 } //00 00  CreateToolhelp32Snapshot
	condition:
		any of ($a_*)
