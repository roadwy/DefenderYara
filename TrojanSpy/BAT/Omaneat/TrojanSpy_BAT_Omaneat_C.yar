...
rule TrojanSpy_BAT_Omaneat_C{
	...
	strings :
		...
		$a_01_1 = {53 54 4f 50 44 44 4f 53 } //01 00  STOPDDOS
		$a_01_2 = {53 54 41 52 54 43 41 4d } //01 00  STARTCAM
		$a_01_3 = {4c 75 6d 69 6e 6f 73 69 74 79 43 72 79 70 74 6f 4d 69 6e 65 72 } //00 00  LuminosityCryptoMiner
