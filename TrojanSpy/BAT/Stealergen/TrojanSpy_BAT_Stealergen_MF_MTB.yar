...
rule TrojanSpy_BAT_Stealergen_MF_MTB{
	...
	strings :
		...
		$a_01_4 = {42 43 72 79 70 74 44 65 63 72 79 70 74 } //01 00 
		$a_01_5 = {44 65 63 72 79 70 74 57 69 74 68 4b 65 79 } //01 00 
		$a_01_6 = {46 72 6f 6d 42 61 73 65 36 34 53 74 72 69 6e 67 } //01 00 
		$a_01_7 = {47 65 74 41 6c 6c 50 72 6f 66 69 6c 65 73 } //01 00 
		$a_01_8 = {44 65 62 75 67 67 61 62 6c 65 41 74 74 72 69 62 75 74 65 } //01 00 
		$a_01_9 = {67 65 74 5f 4b 65 79 } //00 00 
	condition:
		any of ($a_*)
