...
rule TrojanSpy_BAT_Stealergen_MC_MTB{
	meta:
		description = "TrojanSpy:BAT/Stealergen.MC!MTB,SIGNATURE_TYPE_PEHSTR_EXT,0c 00 0c 00 0c 00 00 01 00 "
		
	strings :
		$a_03_0 = {8e 69 1e 5a 90 0a 0c 00 08 02 7b 90 01 03 04 90 02 05 6f 90 01 03 0a 00 08 02 7b 90 01 03 04 6f 90 01 03 0a 00 08 02 7b 90 01 03 04 8e 69 1e 5a 6f 90 01 03 0a 00 08 02 7b 90 01 03 04 6f 90 01 03 0a 00 08 6f 90 01 03 0a 0d 00 03 73 90 01 03 0a 13 04 00 11 04 09 16 73 90 01 03 0a 13 05 00 03 8e 69 17 59 17 58 8d 90 01 01 00 00 01 13 06 11 05 11 06 16 03 8e 69 6f 90 01 03 0a 13 07 11 06 11 07 28 90 01 03 2b 28 90 01 03 2b 13 08 de 90 00 } //01 00 
