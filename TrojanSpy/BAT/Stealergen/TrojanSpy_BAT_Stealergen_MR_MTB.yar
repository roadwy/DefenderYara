...
rule TrojanSpy_BAT_Stealergen_MR_MTB{
	...
	strings :
		$a_03_0 = {8e 69 1e 5a 6f 90 01 03 0a 00 08 02 7b 90 01 03 04 6f 90 01 03 0a 00 08 02 7b 90 01 03 04 8e 69 1e 5a 6f 90 01 03 0a 00 08 02 7b 90 01 03 04 6f 90 01 03 0a 00 08 6f 90 01 03 0a 0d 90 00 } //1
		$a_03_1 = {03 8e 69 17 59 17 58 8d 90 01 03 01 13 06 11 05 11 06 16 03 8e 69 6f 90 01 03 0a 13 07 11 06 11 07 28 90 01 03 2b 28 90 01 03 2b 13 08 de 90 00 } //1
