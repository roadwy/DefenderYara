...
rule TrojanSpy_BAT_Tedy_ATY_MTB{
	...
	strings :
		...
		$a_01_1 = {6b 00 65 00 79 00 6c 00 6f 00 67 00 67 00 65 00 72 00 2e 00 6c 00 6f 00 67 00 } //01 00  keylogger.log
		$a_01_2 = {47 00 65 00 74 00 4b 00 65 00 79 00 73 00 } //00 00  GetKeys
	condition:
		any of ($a_*)
