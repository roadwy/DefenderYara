...
rule TrojanSpy_BAT_Yakbeex_B{
	...
	strings :
		...
		$a_01_2 = {4d 69 6f 43 61 72 64 00 } //01 00 
...
rule TrojanSpy_BAT_Yakbeex_B_2{
	...
	strings :
		$a_01_0 = {4b 00 65 00 79 00 73 00 74 00 72 00 6f 00 6b 00 65 00 73 00 20 00 74 00 79 00 70 00 65 00 64 00 3a 00 } //01 00 
		$a_01_1 = {4b 65 79 6c 6f 67 67 65 72 50 72 6f 63 65 73 73 } //01 00 
		$a_01_2 = {50 61 73 73 77 6f 72 64 52 65 63 6f 76 65 72 79 } //01 00 
		$a_01_3 = {52 65 63 6f 76 65 72 42 72 6f 77 73 65 72 73 } //01 00 
		$a_01_4 = {53 63 72 65 65 6e 73 68 6f 74 48 6f 74 4c 69 73 74 } //01 00 
		$a_01_5 = {26 00 6b 00 65 00 79 00 73 00 74 00 72 00 6f 00 6b 00 65 00 73 00 74 00 79 00 70 00 65 00 64 00 3d 00 } //00 00 
		$a_00_6 = {87 10 } //00 00 
	condition:
		any of ($a_*)
