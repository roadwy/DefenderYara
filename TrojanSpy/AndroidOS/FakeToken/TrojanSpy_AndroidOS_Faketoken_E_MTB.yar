...
rule TrojanSpy_AndroidOS_Faketoken_E_MTB{
	...
	strings :
		$a_01_0 = {4c 63 6f 6d 2f 61 6e 64 72 6f 69 64 2f 63 61 6c 63 75 6c 61 74 6f 72 } //5 Lcom/android/calculator
		$a_01_1 = {4c 63 6f 6d 2f 61 7a 69 61 6e 61 6d 65 73 2f 66 6f 72 6f 6e 65 79 68 61 72 } //5 Lcom/azianames/foroneyhar
