...
rule TrojanSpy_AndroidOS_Bankbot_A{
	...
	strings :
		...
		$a_03_2 = {d8 00 00 ff 3a 00 1b 00 6e 20 90 01 01 85 04 00 0a 02 d8 03 00 ff df 02 02 90 01 01 8e 22 50 02 01 00 3a 03 0e 00 d8 00 03 ff 6e 20 90 01 01 85 34 00 0a 02 df 02 02 90 01 01 8e 22 50 02 01 03 90 00 } //1
