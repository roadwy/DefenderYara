...
rule TrojanSpy_AndroidOS_Bankbot_A{
	...
	strings :
		$a_00_0 = {73 68 61 72 6b 65 64 2e 64 62 } //01 00 
		$a_00_1 = {2f 61 61 42 6f 6f 74 52 65 63 65 69 76 65 72 3b } //01 00 
		...
		$a_00_3 = {54 68 65 6d 65 5f 53 68 61 72 6b 65 64 31 } //00 00 
