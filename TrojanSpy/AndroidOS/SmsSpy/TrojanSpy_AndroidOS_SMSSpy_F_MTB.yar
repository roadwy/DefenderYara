...
rule TrojanSpy_AndroidOS_SMSSpy_F_MTB{
	...
	strings :
		...
		$a_03_3 = {61 70 70 5f 61 62 63 37 37 31 5f 32 73 66 61 63 73 6c 66 66 66 63 73 32 2f [0-30] 5f 38 38 38 61 2f 64 6c 2e 70 68 70 } //2
		$a_03_4 = {63 6f 6d 2f [0-07] 2f [0-15] 2f 4d 79 52 65 63 [0-02] 76 65 72 } //1
	condition:
