...
rule TrojanSpy_AndroidOS_SMSSpy_D_MTB{
	meta:
		description = "TrojanSpy:AndroidOS/SMSSpy.D!MTB,SIGNATURE_TYPE_DEXHSTR_EXT,03 00 03 00 02 00 00 02 00 "
	...
	strings :
		...
		$a_00_1 = {63 6e 2f 73 61 64 73 78 63 64 73 2f 73 61 64 63 63 63 63 2f 53 6d 53 73 65 72 76 65 72 } //00 00  cn/sadsxcds/sadcccc/SmSserver
	condition:
		any of ($a_*)
