...
rule TrojanSpy_AndroidOS_SmsThief_N_MTB{
	...
	strings :
		...
		$a_00_1 = {2f 63 6f 6c 6c 65 63 74 2f 70 6f 73 74 44 61 74 61 } //01 00  /collect/postData
		$a_00_2 = {75 70 6c 6f 61 64 4d 53 47 } //01 00  uploadMSG
		$a_00_3 = {68 69 64 65 41 70 70 } //01 00  hideApp
		$a_00_4 = {75 70 6c 6f 61 64 43 6f 6e 74 61 63 74 73 } //01 00  uploadContacts
		$a_00_5 = {63 6f 6d 2f 62 61 69 64 75 2f 6c 6f 63 61 73 73 2f 75 74 69 6c 73 } //00 00  com/baidu/locass/utils
