...
rule TrojanSpy_AndroidOS_SmsThief_T_MTB{
	...
	strings :
		...
		$a_00_1 = {72 65 71 75 65 73 74 53 6d 73 50 65 72 6d 69 73 73 69 6f 6e } //01 00  requestSmsPermission
		$a_00_2 = {68 69 64 65 41 70 70 } //01 00  hideApp
		$a_00_3 = {66 65 74 63 68 4c 6f 67 6f } //01 00  fetchLogo
		$a_00_4 = {61 75 74 6f 4c 61 75 6e 63 68 56 69 76 6f } //00 00  autoLaunchVivo
	condition:
		any of ($a_*)
