...
rule TrojanSpy_AndroidOS_SmsThief_Y_MTB{
	...
	strings :
		...
		$a_00_1 = {73 61 76 65 5f 73 6d 73 2e 70 68 70 } //01 00  save_sms.php
		$a_00_2 = {09 73 6d 73 5f 72 65 63 76 65 00 } //01 00 
		$a_00_3 = {73 65 6e 64 6f 72 5f 6e 6f } //01 00  sendor_no
		$a_00_4 = {2f 63 6f 6e 74 72 6f 6c 6c 65 72 2f 61 70 69 2f 63 6f 6d 6d 6f 6e 2f } //00 00  /controller/api/common/
	condition:
		any of ($a_*)
