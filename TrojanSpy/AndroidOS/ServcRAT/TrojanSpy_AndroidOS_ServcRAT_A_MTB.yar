...
rule TrojanSpy_AndroidOS_ServcRAT_A_MTB{
	...
	strings :
		...
		$a_00_1 = {68 69 64 65 41 70 70 49 63 6f 6e } //01 00 
		$a_00_2 = {67 65 74 50 68 6f 6e 65 4e 75 6d 62 65 72 } //01 00 
		$a_00_3 = {67 65 74 5f 6e 75 6d 62 65 72 4f 66 43 61 6d 65 72 61 73 } //01 00 
		$a_00_4 = {67 65 74 43 61 6c 6c 4c 6f 67 73 } //01 00 
		$a_00_5 = {67 65 74 53 4d 53 } //00 00 
	condition:
		any of ($a_*)
