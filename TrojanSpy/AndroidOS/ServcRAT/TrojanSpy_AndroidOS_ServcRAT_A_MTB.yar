...
rule TrojanSpy_AndroidOS_ServcRAT_A_MTB{
	...
	strings :
		$a_03_0 = {4c 63 6f 6d 2f 65 78 61 6d 70 6c 65 2f 72 65 76 65 72 73 65 73 68 65 6c 6c 90 02 03 2f 50 61 79 6c 6f 61 64 73 2f 6e 65 77 53 68 65 6c 6c 90 00 } //1
