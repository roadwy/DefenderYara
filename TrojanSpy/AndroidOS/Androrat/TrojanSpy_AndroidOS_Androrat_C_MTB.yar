...
rule TrojanSpy_AndroidOS_Androrat_C_MTB{
	...
	strings :
		...
		$a_01_1 = {43 61 6c 6c 52 65 63 6f 72 64 69 6e 67 } //01 00  CallRecording
		$a_01_2 = {6c 69 73 74 43 61 6c 6c 4c 6f 67 } //01 00  listCallLog
		$a_00_3 = {73 6d 73 4d 6f 6e 69 74 65 72 } //01 00  smsMoniter
		$a_01_4 = {61 70 70 63 6f 64 65 2f 53 63 72 65 65 6e 53 68 6f 74 } //00 00  appcode/ScreenShot
	condition:
		any of ($a_*)
