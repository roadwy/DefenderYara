...
rule TrojanSpy_AndroidOS_Asacub_B_MTB{
	...
	strings :
		...
		$a_03_2 = {0a 00 d8 03 01 ff df 00 90 01 02 8e 00 50 00 02 01 3a 03 90 01 02 d8 00 03 ff 90 00 } //1
		$a_03_3 = {0a 01 df 01 90 01 02 8e 11 50 01 02 03 01 01 90 00 } //1
	condition:
