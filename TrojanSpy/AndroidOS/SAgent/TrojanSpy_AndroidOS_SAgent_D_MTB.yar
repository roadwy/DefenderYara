...
rule TrojanSpy_AndroidOS_SAgent_D_MTB{
	...
	strings :
		$a_03_0 = {4c 63 6f 6d 2f 62 72 6f 77 73 65 72 2f 77 65 62 90 02 04 2f 53 6d 73 52 65 63 65 69 76 65 72 90 00 } //1
		$a_03_1 = {2f 61 70 69 2f 73 6d 73 2d 74 65 73 74 2f 90 02 10 2e 70 68 70 90 00 } //1
