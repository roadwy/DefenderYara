...
rule TrojanSpy_AndroidOS_SAgent_D_MTB{
	...
	strings :
		...
		$a_01_2 = {73 65 6e 64 65 72 70 68 6f 6e 65 34 } //01 00 
		$a_01_3 = {64 65 76 69 63 65 6d 6f 64 65 6c 34 } //01 00 
		$a_01_4 = {73 6f 75 72 63 65 7a 34 } //01 00 
		$a_01_5 = {67 65 74 44 69 73 70 6c 61 79 4f 72 69 67 69 6e 61 74 69 6e 67 41 64 64 72 65 73 73 } //01 00 
		$a_01_6 = {65 78 74 72 61 5f 73 6d 73 5f 6d 65 73 73 61 67 65 } //00 00 
	condition:
		any of ($a_*)
