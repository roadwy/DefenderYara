...
rule TrojanSpy_AndroidOS_SmsTheif_F_MTB{
	...
	strings :
		...
		$a_03_1 = {61 70 69 2e 78 6a 61 6b 75 76 2e 74 6b 2f 90 02 20 2f 69 6e 73 74 61 6c 6c 65 64 2e 70 68 70 3f 64 65 76 3d 90 00 } //1
		$a_03_2 = {61 70 69 2e 78 6a 61 6b 75 76 2e 74 6b 2f 90 02 20 3f 6d 73 67 3d 90 00 } //1
