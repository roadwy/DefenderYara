...
rule TrojanSpy_AndroidOS_Bray_E_MTB{
	...
	strings :
		...
		$a_00_1 = {67 65 74 4d 65 73 73 61 67 65 42 6f 64 79 } //01 00  getMessageBody
		$a_00_2 = {67 65 74 49 6e 73 74 61 6c 6c 65 64 50 61 63 6b 61 67 65 73 } //00 00  getInstalledPackages
	condition:
		any of ($a_*)
