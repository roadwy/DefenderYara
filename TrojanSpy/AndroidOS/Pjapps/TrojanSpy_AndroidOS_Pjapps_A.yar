...
rule TrojanSpy_AndroidOS_Pjapps_A{
	...
	strings :
		$a_03_0 = {3a 39 30 33 33 2f 90 02 07 2e 6c 6f 67 3f 69 64 3d 90 00 } //1
		$a_03_1 = {3a 38 31 31 38 2f 70 75 73 68 2f 90 02 03 61 6e 64 72 6f 69 64 78 6d 6c 2f 90 00 } //1
		$a_03_2 = {26 73 6f 66 74 69 64 3d 90 02 02 26 63 6e 3d 90 02 02 26 6e 74 3d 90 00 } //1
