...
rule TrojanSpy_AndroidOS_Pjapps_A{
	...
	strings :
		...
		$a_01_3 = {2f 6d 6d 2e 64 6f 3f 69 6d 65 69 3d } //01 00 
		$a_01_4 = {68 74 74 70 3a 2f 2f 78 78 78 78 78 78 78 78 78 39 3a 38 36 31 38 2f 63 6c 69 65 6e 74 2f 61 6e 64 72 6f 69 64 2f 61 2e 61 70 6b } //00 00 
	condition:
		any of ($a_*)
