...
rule TrojanSpy_AndroidOS_SAgnt_B_MTB{
	...
	strings :
		...
		$a_00_1 = {55 70 6c 6f 61 64 46 69 6c 65 50 68 70 } //01 00  UploadFilePhp
		$a_00_2 = {2f 53 6d 73 2e 74 78 74 } //01 00  /Sms.txt
		$a_00_3 = {55 70 6c 6f 61 64 4b 69 6c 6c } //00 00  UploadKill
