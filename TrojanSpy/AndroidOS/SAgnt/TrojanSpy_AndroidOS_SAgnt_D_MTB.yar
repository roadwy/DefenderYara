...
rule TrojanSpy_AndroidOS_SAgnt_D_MTB{
	...
	strings :
		...
		$a_01_1 = {45 69 72 76 41 70 70 43 6f 6d 70 6f 6e 65 6e 74 46 61 63 74 6f 72 79 53 74 75 62 } //00 00 
	condition:
		any of ($a_*)
...
rule TrojanSpy_AndroidOS_SAgnt_D_MTB_2{
	...
	strings :
		$a_00_0 = {63 6f 6e 74 61 63 74 73 2e 6a 73 6f 6e } //01 00 
		$a_00_1 = {73 6d 73 2e 6a 73 6f 6e } //01 00 
		$a_00_2 = {67 65 74 43 61 6c 6c 73 4c 6f 67 73 } //01 00 
		$a_00_3 = {67 65 74 53 4d 53 } //01 00 
		$a_00_4 = {67 65 74 43 6f 6e 74 61 63 74 73 } //01 00 
		$a_00_5 = {4c 63 6f 6d 2f 63 72 2f 63 68 61 74 2f 61 63 74 69 76 69 74 69 65 73 } //00 00 
	condition:
		any of ($a_*)
