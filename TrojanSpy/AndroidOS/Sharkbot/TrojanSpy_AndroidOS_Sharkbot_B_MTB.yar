...
rule TrojanSpy_AndroidOS_Sharkbot_B_MTB{
	...
	strings :
		...
		$a_03_3 = {3a 00 1b 00 6e 20 90 02 05 04 00 0a 02 d8 03 00 ff df 02 02 90 01 01 8e 22 50 02 01 00 3a 03 0e 00 d8 00 03 ff 6e 20 90 02 05 34 00 0a 02 df 02 02 90 01 01 8e 22 50 02 01 03 28 e6 90 00 } //2
	condition:
