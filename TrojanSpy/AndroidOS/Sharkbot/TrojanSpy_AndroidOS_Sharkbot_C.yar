...
rule TrojanSpy_AndroidOS_Sharkbot_C{
	...
	strings :
		...
		$a_00_8 = {5d 04 00 00 7d 0c 05 80 5c 27 00 00 7e 0c 05 80 00 00 01 00 22 00 11 00 cc 21 53 79 73 64 75 70 61 74 65 2e 46 21 4d 54 42 00 00 02 40 05 } //82 31 
	condition:
		any of ($a_*)
