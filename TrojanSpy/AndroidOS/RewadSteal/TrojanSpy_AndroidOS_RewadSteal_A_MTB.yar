...
rule TrojanSpy_AndroidOS_RewadSteal_A_MTB{
	...
	strings :
		...
		$a_00_4 = {61 64 64 41 75 74 6f 53 74 61 72 74 75 70 } //1 addAutoStartup
		$a_00_5 = {53 6d 73 42 72 6f 61 64 63 61 73 74 52 65 63 65 69 76 65 72 } //1 SmsBroadcastReceiver
	condition:
