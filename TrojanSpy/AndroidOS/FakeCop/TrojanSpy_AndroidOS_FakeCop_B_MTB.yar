...
rule TrojanSpy_AndroidOS_FakeCop_B_MTB{
	...
	strings :
		$a_01_0 = {4f 72 74 41 70 70 6c 69 63 61 74 69 6f 6e } //01 00  OrtApplication
		$a_01_1 = {52 35 35 52 65 63 65 69 76 65 72 } //01 00  R55Receiver
		$a_01_2 = {6c 6f 61 64 4c 69 62 72 61 72 79 } //01 00  loadLibrary
