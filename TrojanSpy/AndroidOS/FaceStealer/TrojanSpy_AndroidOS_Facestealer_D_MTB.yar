...
rule TrojanSpy_AndroidOS_Facestealer_D_MTB{
	...
	strings :
		$a_01_0 = {43 68 69 63 6b 65 6e 46 61 63 65 62 6f 6f 6b } //01 00 
		$a_01_1 = {6d 5f 6c 6f 67 69 6e 5f 70 61 73 73 77 6f 72 64 } //01 00 
		$a_01_2 = {6d 5f 6c 6f 67 69 6e 5f 65 6d 61 69 6c } //01 00 
