...
rule TrojanSpy_AndroidOS_Ewalls_T_MTB{
	...
	strings :
		...
		$a_00_1 = {73 65 6e 64 44 65 76 69 63 65 49 6e 66 6f 73 } //01 00  sendDeviceInfos
		$a_00_2 = {2f 61 70 69 2f 77 61 6c 6c 70 61 70 65 72 73 2f 6c 6f 67 2f 61 63 74 69 6f 6e 5f 6c 6f 67 3f 74 79 70 65 65 } //01 00  /api/wallpapers/log/action_log?typee
		$a_00_3 = {79 73 6c 65 72 2e 63 6f 6d } //01 00  ysler.com
		$a_00_4 = {61 70 70 73 63 6f 6c 6f 72 2e 6e 65 74 } //00 00  appscolor.net
	condition:
		any of ($a_*)
