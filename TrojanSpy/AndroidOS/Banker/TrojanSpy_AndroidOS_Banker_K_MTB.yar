...
rule TrojanSpy_AndroidOS_Banker_K_MTB{
	...
	strings :
		...
		$a_00_2 = {2f 53 6d 73 52 65 63 65 69 76 65 72 3b } //01 00 
		$a_00_3 = {66 69 6e 64 41 63 63 65 73 73 69 62 69 6c 69 74 79 4e 6f 64 65 49 6e 66 6f 73 42 79 54 65 78 74 } //00 00 
