...
rule TrojanSpy_AndroidOS_Banker_K_MTB{
	...
	strings :
		$a_02_0 = {4c 63 6f 6d 2f 65 78 61 6d 70 6c 65 2f 90 02 20 2f 42 61 6e 6b 3b 90 00 } //2
		$a_02_1 = {4c 63 6f 6d 2f 65 78 61 6d 70 6c 65 2f 90 02 20 2f 41 63 63 65 73 73 69 62 69 6c 69 74 79 53 65 72 76 69 63 65 3b 90 00 } //2
