...
rule TrojanSpy_AndroidOS_Banker_XO{
	...
	strings :
		...
		$a_00_1 = {50 65 72 69 6f 64 69 63 4a 6f 62 53 65 72 76 69 63 65 } //01 00 
		$a_00_2 = {49 6e 6a 41 63 63 65 73 73 69 62 69 6c 69 74 79 53 65 72 76 69 63 65 } //01 00 
		$a_00_3 = {53 63 72 65 65 6e 63 61 73 74 53 65 72 76 69 63 65 } //01 00 
		$a_00_4 = {4c 6f 63 6b 65 72 41 63 74 69 76 69 74 79 } //00 00 
