...
rule TrojanSpy_AndroidOS_Geimini_A{
	...
	strings :
		...
		$a_01_2 = {70 72 6f 63 65 73 73 44 4f 57 4e 4c 4f 41 44 5f 46 41 49 4c 55 45 5f 41 63 74 69 6f 6e } //01 00  processDOWNLOAD_FAILUE_Action
		$a_01_3 = {70 72 6f 63 65 73 73 50 41 52 53 45 5f 46 41 49 4c 55 45 5f 41 63 74 69 6f 6e } //01 00  processPARSE_FAILUE_Action
		$a_01_4 = {54 52 41 4e 53 41 43 54 5f 46 41 49 4c 55 45 } //00 00  TRANSACT_FAILUE
	condition:
		any of ($a_*)
