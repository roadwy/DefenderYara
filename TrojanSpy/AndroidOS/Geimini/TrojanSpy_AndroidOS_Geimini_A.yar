...
rule TrojanSpy_AndroidOS_Geimini_A{
	...
	strings :
		$a_03_0 = {68 69 2c 78 69 61 6f 6c 75 90 01 02 68 69 2c 6c 69 71 69 61 6e 90 01 02 63 6f 6d 6d 61 6e 64 20 6f 6b 90 01 02 62 79 65 90 00 } //1
		$a_03_1 = {41 64 41 63 74 69 76 69 74 79 90 09 0c 00 63 6f 6d 90 03 01 01 2e 2f 67 65 69 6e 69 6d 69 90 00 } //1
