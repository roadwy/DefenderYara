...
rule TrojanSpy_AndroidOS_Cambot_A{
	...
	strings :
		$a_03_0 = {3a 00 1c 00 6e 20 90 01 02 14 00 0a 00 d8 03 01 ff df 00 00 0d 8e 00 50 00 02 01 3a 03 0f 00 d8 00 03 ff 6e 20 90 01 02 34 00 0a 01 df 01 01 66 8e 11 50 01 02 03 01 01 28 e5 90 00 } //2
