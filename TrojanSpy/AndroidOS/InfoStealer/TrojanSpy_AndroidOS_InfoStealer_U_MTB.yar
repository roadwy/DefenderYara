...
rule TrojanSpy_AndroidOS_InfoStealer_U_MTB{
	...
	strings :
		...
		$a_00_1 = {4c 6d 65 2f 65 76 65 72 79 74 68 69 6e 67 2f 70 72 6f 76 69 64 65 72 73 2f } //01 00 
		$a_01_2 = {67 65 74 43 61 6c 6c 4c 6f 67 } //01 00 
		$a_01_3 = {67 65 74 53 4d 53 } //01 00 
		$a_01_4 = {67 65 74 41 6c 6c 41 70 70 73 } //00 00 
	condition:
		any of ($a_*)
