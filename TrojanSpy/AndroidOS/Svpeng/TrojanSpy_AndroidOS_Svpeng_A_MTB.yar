...
rule TrojanSpy_AndroidOS_Svpeng_A_MTB_2{
	...
	strings :
		...
		$a_03_7 = {43 6c 69 63 6b 90 02 10 74 6f 20 65 72 61 73 65 20 79 6f 75 72 20 64 61 74 61 20 61 6e 64 20 63 6f 6e 74 69 6e 75 65 90 02 08 66 6f 72 20 63 61 6e 63 65 6c 90 00 } //1
	condition:
