...
rule TrojanSpy_AndroidOS_Fakecalls_B_MTB{
	...
	strings :
		$a_03_0 = {63 68 61 6f 77 65 6e 30 90 02 02 2e 63 6f 6d 90 00 } //5
		$a_03_1 = {77 65 6e 64 69 6e 67 30 90 02 02 2e 63 6f 6d 90 00 } //5
		$a_03_2 = {50 68 6f 6e 65 43 61 6c 6c 90 02 08 53 65 72 76 69 63 65 90 00 } //1
		$a_03_3 = {63 6f 6d 2f 90 02 08 2f 72 74 6d 70 5f 63 6c 69 65 6e 74 90 00 } //1
