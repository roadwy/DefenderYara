...
rule TrojanSpy_iPhoneOS_Ftikser_A{
	...
	strings :
		...
		$a_03_1 = {78 73 73 65 72 2e 63 6f 6d 90 02 10 38 30 90 02 10 25 40 3a 25 40 2f 43 68 65 63 6b 4c 69 62 72 61 72 79 2e 61 73 70 78 90 00 } //1
		$a_03_2 = {48 74 74 70 46 75 6e 4d 61 69 6e 90 02 10 77 72 69 74 65 54 6f 46 69 6c 65 3a 61 74 6f 6d 69 63 61 6c 6c 79 90 00 } //1
...
rule TrojanSpy_iPhoneOS_Ftikser_A_2{
	...
	strings :
		...
		$a_03_3 = {52 75 6e 43 6f 6d 6d 61 6e 64 3a 90 02 05 53 65 6e 64 53 4d 53 3a 90 02 05 43 61 6c 6c 54 65 6c 3a 90 02 05 47 65 74 47 70 73 3a 90 02 05 47 65 74 57 65 69 58 69 6e 3a 90 02 05 47 65 74 4b 65 79 43 68 61 69 6e 90 00 } //1
	condition:
