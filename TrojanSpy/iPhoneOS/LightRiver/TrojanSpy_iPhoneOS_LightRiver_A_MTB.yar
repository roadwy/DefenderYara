...
rule TrojanSpy_iPhoneOS_LightRiver_A_MTB{
	...
	strings :
		...
		$a_03_5 = {3c 6b 65 79 3e 6b 65 79 63 68 61 69 6e 2d 61 63 63 65 73 73 2d 67 72 6f 75 70 73 3c 2f 6b 65 79 3e 90 05 15 04 09 20 0a 0d 3c 61 72 72 61 79 3e 90 05 15 04 09 20 0a 0d 3c 73 74 72 69 6e 67 3e 2a 3c 2f 73 74 72 69 6e 67 3e 90 05 15 04 09 20 0a 0d 3c 2f 61 72 72 61 79 3e 90 00 } //1
