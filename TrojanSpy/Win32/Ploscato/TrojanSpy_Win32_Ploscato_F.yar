...
rule TrojanSpy_Win32_Ploscato_F{
	...
	strings :
		$a_01_0 = {2d 73 65 74 64 00 } //01 00  猭瑥d
		$a_01_1 = {55 73 61 67 65 3a 20 2d 5b 73 74 61 72 74 7c 73 74 6f 70 7c 69 6e 73 74 61 6c 6c 7c 75 6e 69 6e 73 74 61 6c 6c 5d } //01 00  Usage: -[start|stop|install|uninstall]
