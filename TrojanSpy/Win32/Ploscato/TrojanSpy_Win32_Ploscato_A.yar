...
rule TrojanSpy_Win32_Ploscato_A{
	...
	strings :
		...
		$a_01_1 = {7a 3a 5c 50 72 6f 6a 65 63 74 73 5c 52 65 73 63 61 74 6f 72 5c 75 70 6c 6f 61 64 65 72 5c 44 65 62 75 67 5c 73 63 68 65 63 6b 2e 70 64 62 } //00 00 
	condition:
		any of ($a_*)
