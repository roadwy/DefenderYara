...
rule TrojanSpy_Win32_Abcrem_A{
	...
	strings :
		$a_00_0 = {52 55 4e 44 4c 4c 33 32 2e 65 78 65 20 22 25 73 22 2c 45 78 52 75 6e 64 6c 6c 20 30 78 41 41 } //01 00 
		...
		$a_01_4 = {56 20 4c 40 76 65 20 59 40 75 2c 24 68 61 74 20 41 62 40 75 74 20 59 40 75 } //0a 00 
