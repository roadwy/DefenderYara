...
rule TrojanSpy_Win32_Bafi_D{
	...
	strings :
		...
		$a_01_1 = {74 00 70 00 61 00 63 00 5f 00 25 00 64 00 2e 00 6d 00 76 00 74 00 } //01 00  tpac_%d.mvt
		$a_01_2 = {5f 00 69 00 66 00 72 00 6d 00 2e 00 68 00 74 00 6d 00 } //00 00  _ifrm.htm
	condition:
		any of ($a_*)
