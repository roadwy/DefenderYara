...
rule TrojanSpy_Win32_Bafi_Q{
	...
	strings :
		$a_02_0 = {33 db 33 c0 99 8a 11 80 ca 20 03 c2 8d 49 02 66 39 19 75 90 01 01 3d e0 1e 00 00 75 90 01 01 c7 44 3c 90 01 01 01 00 00 80 c7 05 90 01 04 01 00 90 00 } //1
	condition:
		((#a_02_0  & 1)*1) >=1
...
rule TrojanSpy_Win32_Bafi_Q_3{
	...
	strings :
		$a_03_0 = {3d 5a 35 4e d7 75 05 e8 90 01 01 00 00 00 b8 01 00 00 00 90 00 } //1
		$a_03_1 = {81 39 8b ff 55 8b 75 08 8d 05 90 01 02 00 10 eb 0e 80 39 e9 74 2d 90 00 } //1
		$a_03_2 = {81 39 8b ff 55 8b 90 02 02 75 08 8d 05 90 01 02 00 10 74 13 80 39 e9 74 32 90 00 } //1
