...
rule TrojanSpy_Win32_Bafi_E_2{
	...
	strings :
		...
		$a_02_4 = {40 25 0f 00 00 80 79 ?? 48 83 c8 f0 40 8b 16 88 45 ff 8a 44 39 02 32 c3 88 04 11 8a 5c 39 02 41 3b ?? ?? 7c } //10
	condition:
...
rule TrojanSpy_Win32_Bafi_E_3{
	...
	strings :
		$a_03_0 = {c6 45 fc 06 68 ?? ?? ?? ?? 8d 8d c0 fe ff ff e8 ?? ?? ?? ?? c6 45 fc 0a 68 ?? ?? ?? ?? 8d 95 c0 fe ff ff 52 8d 85 9c fe ff ff 50 e8 ?? ?? ?? ?? 83 c4 0c 89 85 38 fe ff ff 8b 8d 38 fe ff ff 89 8d 34 fe ff ff c6 45 fc 0b 68 ?? ?? ?? ?? 8b 95 34 fe ff ff 52 } //1
