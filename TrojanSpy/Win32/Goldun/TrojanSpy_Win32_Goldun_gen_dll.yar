...
rule TrojanSpy_Win32_Goldun_gen_dll{
	...
	strings :
		...
		$a_01_6 = {3b 20 6d 61 69 6c 73 65 72 76 3a 20 25 73 20 3b 20 70 61 73 73 77 6f 72 64 3a 20 25 73 } //03 00  ; mailserv: %s ; password: %s
		...
		$a_01_9 = {50 4f 53 54 20 2f 25 73 3f 6f 73 3d 6e 74 20 48 54 54 50 2f 31 2e 31 } //03 00  POST /%s?os=nt HTTP/1.1
		...
		$a_01_12 = {4e 74 50 72 6f 74 65 63 74 56 69 72 74 75 61 6c 4d 65 6d 6f 72 79 00 5c 64 72 69 76 65 72 73 5c } //02 00  瑎牐瑯捥噴物畴污敍潭祲尀牤癩牥屳
		$a_01_13 = {47 45 54 20 2f 25 73 3f 70 61 72 61 6d 3d 63 6d 64 } //02 00  GET /%s?param=cmd
		$a_00_14 = {2d 6c 61 62 73 2e 63 6f 6d 00 66 74 70 2e 66 2d 73 65 63 75 72 65 2e 63 6f 6d } //01 00 
		$a_00_15 = {3d 6c 6f 67 69 6e 20 61 63 74 69 6f 6e 3d 27 62 61 6c 61 6e 63 65 2e 61 73 70 27 3e } //01 00  =login action='balance.asp'>
		$a_00_16 = {5c 64 72 69 76 65 72 73 5c 65 74 63 5c 68 6f 73 74 73 } //01 00  \drivers\etc\hosts
		$a_00_17 = {63 65 73 5c 53 68 61 72 65 64 41 63 63 65 73 73 5c 50 61 72 61 6d 65 74 65 72 73 5c 46 69 72 65 77 61 6c 6c 50 6f 6c 69 } //01 00  ces\SharedAccess\Parameters\FirewallPoli
		$a_00_18 = {4e 74 57 72 69 74 65 56 69 72 74 75 61 6c 4d 65 6d 6f 72 79 } //01 00  NtWriteVirtualMemory
