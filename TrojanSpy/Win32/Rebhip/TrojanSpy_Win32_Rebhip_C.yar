...
rule TrojanSpy_Win32_Rebhip_C{
	...
	strings :
		...
		$a_01_1 = {43 00 47 00 2d 00 43 00 47 00 2d 00 43 00 47 00 2d 00 43 00 47 00 } //01 00  CG-CG-CG-CG
		$a_01_2 = {58 00 58 00 2d 00 58 00 58 00 2d 00 58 00 58 00 2d 00 58 00 58 00 } //01 00  XX-XX-XX-XX
		$a_01_3 = {06 00 53 00 50 00 59 00 4e 00 45 00 54 00 } //01 00 
		$a_01_4 = {7c 53 70 79 2d 4e 65 74 20 5b 52 41 54 5d 7c } //00 00  |Spy-Net [RAT]|
