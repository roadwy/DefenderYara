...
rule TrojanSpy_Win32_Dabvegi_A{
	...
	strings :
		$a_01_0 = {43 72 54 78 74 00 } //01 00  牃硔t
		$a_01_1 = {44 6f 53 70 79 00 } //01 00  潄灓y
		...
		$a_01_4 = {53 54 41 52 54 5f 53 4e 49 46 46 45 52 00 } //01 00  呓剁彔乓䙉䕆R
		$a_01_5 = {55 50 44 41 54 45 5f 50 41 53 54 41 5f 4b 45 59 00 } //01 00 
		$a_01_6 = {52 45 47 49 53 54 52 41 5f 49 4e 46 45 43 54 00 } //01 00  䕒䥇呓䅒䥟䙎䍅T
		$a_01_7 = {53 61 76 65 44 65 6c 65 74 65 53 74 61 72 74 75 70 4b 4c 00 } //00 00  慓敶敄敬整瑓牡畴䭰L
	condition:
		any of ($a_*)
