...
rule TrojanSpy_Win32_IcedId_RAI_MTB_2{
	...
	strings :
		$a_03_0 = {81 c1 f8 7a 0c 01 90 02 05 83 c7 04 90 02 1f 75 90 0a 3f 00 03 35 90 01 04 89 35 90 00 } //5
		$a_03_1 = {8b 0f 81 fa 90 01 04 75 90 02 1f 03 35 90 01 04 89 35 90 00 } //2
		$a_03_2 = {81 c7 cc cc 04 01 90 02 05 89 38 90 02 05 90 02 3f 0f 90 00 } //5
		$a_03_3 = {2b f0 8b 44 24 1c 1b da 8b 38 81 fe 90 01 04 75 90 02 2f 0f b7 05 90 00 } //2
		$a_01_4 = {81 c7 b0 8d 07 01 03 f2 89 38 } //5
		$a_03_5 = {03 c1 89 44 24 1c 8d 04 3e 90 0a 1f 00 05 90 00 } //2
