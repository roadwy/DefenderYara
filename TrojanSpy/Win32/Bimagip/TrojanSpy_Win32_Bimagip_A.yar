...
rule TrojanSpy_Win32_Bimagip_A{
	...
	strings :
		...
		$a_03_3 = {4f 70 74 69 6f 6e 73 2e 64 61 74 90 01 09 2e 61 73 7a 00 90 00 } //1
		$a_03_4 = {63 3a 5c 69 6e 73 69 64 65 74 6d 90 01 09 43 3a 5c 61 6e 61 6c 79 73 69 73 00 90 00 } //1
		$a_01_5 = {6a 6f 65 62 6f 78 63 6f 6e 74 72 6f 6c 2e 65 78 65 00 } //1
		$a_03_6 = {64 69 72 5f 77 61 74 63 68 2e 64 6c 6c 90 01 0b 75 73 65 72 6e 61 6d 65 00 90 00 } //1
	condition:
