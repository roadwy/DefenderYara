...
rule TrojanSpy_Win32_Migeon_A_dha{
	...
	strings :
		...
		$a_00_2 = {72 00 75 00 6e 00 64 00 6c 00 6c 00 33 00 32 00 2e 00 65 00 78 00 65 00 20 00 25 00 73 00 2c 00 50 00 6c 00 61 00 79 00 65 00 72 00 } //00 00  rundll32.exe %s,Player
