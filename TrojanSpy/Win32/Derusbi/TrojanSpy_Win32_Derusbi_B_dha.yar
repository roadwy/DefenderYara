...
rule TrojanSpy_Win32_Derusbi_B_dha{
	...
	strings :
		...
		$a_01_1 = {50 43 43 5f 49 44 45 4e 54 } //01 00 
		$a_01_2 = {50 43 43 5f 43 4d 44 } //01 00 
		$a_01_3 = {5f 24 24 24 24 24 24 00 2e 63 6d 64 00 } //01 00 
		$a_01_4 = {50 4f 53 54 20 2f 70 68 6f 74 6f 73 2f 70 68 6f 74 6f 2e 61 73 70 20 48 54 54 50 2f 31 2e 31 } //01 00 
