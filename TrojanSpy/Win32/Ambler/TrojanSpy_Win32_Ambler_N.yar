...
rule TrojanSpy_Win32_Ambler_N{
	...
	strings :
		...
		$a_01_2 = {68 74 74 70 3a 2f 2f 25 73 2f 66 69 6c 65 73 2f 25 73 25 73 2f } //01 00 
		$a_01_3 = {4f 72 64 65 72 5f 73 65 6c 2e 70 68 70 3f 43 6f 6f 6b 69 65 3d 4d 41 43 7c } //00 00 
	condition:
		any of ($a_*)
