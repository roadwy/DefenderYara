...
rule TrojanSpy_Win32_Ambler_K{
	...
	strings :
		...
		$a_08_2 = {5f 62 65 67 69 6e 74 68 72 65 61 64 65 78 } //01 00 
		$a_08_3 = {48 74 74 70 53 65 6e 64 52 65 71 75 65 73 74 41 } //01 00 
		$a_01_4 = {75 73 65 72 69 64 3d 25 73 } //01 00 
		$a_01_5 = {3c 52 55 4e } //00 00 
	condition:
		any of ($a_*)
