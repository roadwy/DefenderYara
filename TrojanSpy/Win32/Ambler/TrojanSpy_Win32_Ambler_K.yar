...
rule TrojanSpy_Win32_Ambler_K{
	...
	strings :
		$a_03_0 = {8b 45 08 8a 08 84 c9 74 08 80 f1 90 01 01 88 08 40 eb f2 90 00 } //2
		$a_03_1 = {2b fe 80 71 ff 90 01 01 80 31 90 01 01 80 71 01 90 01 01 83 c1 03 83 c2 03 8d 1c 0f 3b d8 72 e8 90 00 } //2
