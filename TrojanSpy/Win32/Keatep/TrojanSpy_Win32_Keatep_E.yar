...
rule TrojanSpy_Win32_Keatep_E{
	...
	strings :
		...
		$a_02_2 = {7c 24 70 61 73 73 3d 00 90 09 24 00 66 61 63 65 62 6f 6f 6b 2e 90 00 } //1
		$a_02_3 = {26 72 65 64 69 72 65 63 74 5f 74 6f 3d 00 00 00 50 4f 53 54 90 02 8f 77 70 2d 6c 6f 67 69 6e 2e 90 00 } //1
	condition:
