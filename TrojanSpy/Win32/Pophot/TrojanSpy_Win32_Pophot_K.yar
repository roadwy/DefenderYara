...
rule TrojanSpy_Win32_Pophot_K{
	...
	strings :
		$a_02_0 = {6a 00 6a 00 49 75 f9 53 56 57 8b f2 89 45 fc 8b 45 fc e8 90 01 04 33 c0 55 68 90 01 04 64 ff 30 64 89 20 8d 45 f0 e8 90 01 04 8b 45 fc e8 90 01 04 8b d8 d1 fb 79 03 83 d3 00 85 db 7e 48 bf 01 00 00 00 56 8b d7 03 d2 4a b9 02 00 00 00 8b 45 fc e8 90 00 } //10
		$a_03_1 = {68 74 74 70 3a 2f 2f 90 02 0f 2e 63 6e 90 00 } //1
		$a_01_2 = {47 45 54 20 2f 2f 79 79 2e 74 78 74 20 48 54 54 50 2f 31 2e 31 } //1 GET //yy.txt HTTP/1.1
		$a_03_3 = {76 65 72 3d 90 02 05 26 74 67 69 64 3d 90 02 0a 26 61 64 64 72 65 73 73 3d 90 02 02 2d 90 00 } //1
