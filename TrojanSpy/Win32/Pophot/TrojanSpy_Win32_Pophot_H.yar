...
rule TrojanSpy_Win32_Pophot_H{
	...
	strings :
		...
		$a_02_2 = {72 75 6e 64 6c 6c 33 32 2e 65 78 65 20 43 3a 5c 57 49 4e 44 4f 57 53 5c 53 59 53 54 45 4d 33 32 5c 6d 79 63 63 30 38 30 90 02 03 2e 64 6c 6c 20 6d 79 6d 61 69 6e 90 00 } //1
