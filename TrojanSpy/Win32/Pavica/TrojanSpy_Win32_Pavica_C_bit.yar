...
rule TrojanSpy_Win32_Pavica_C_bit{
	...
	strings :
		$a_03_0 = {56 55 6a 03 56 8b 35 90 01 04 6a 03 53 6a 90 01 01 68 90 01 04 ff d6 50 ff d7 90 00 } //1
		...
		$a_03_3 = {68 75 10 ad 01 ff 35 90 01 04 e8 90 01 04 59 59 50 e8 90 00 } //1
	condition:
