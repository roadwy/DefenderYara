...
rule TrojanSpy_Win32_Cmjspy_B{
	...
	strings :
		$a_00_0 = {47 65 74 49 70 41 64 64 72 54 61 62 6c 65 } //0a 00 
		$a_00_1 = {50 65 65 6b 4e 61 6d 65 64 50 69 70 65 } //04 00 
		...
		$a_00_4 = {68 6c 69 63 65 6e 73 65 2e 76 78 64 } //01 00 
		$a_00_5 = {73 73 73 64 64 61 33 33 34 33 34 32 2e 76 78 64 } //01 00 
		$a_00_6 = {68 6c 6f 67 6f 2e 32 74 78 } //01 00 
		$a_00_7 = {66 69 6c 65 2e 32 64 69 72 } //01 00 
		$a_00_8 = {72 65 67 2e 32 67 65 72 } //01 00 
