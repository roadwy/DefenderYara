...
rule TrojanSpy_Win32_Fakegina_E{
	...
	strings :
		...
		$a_01_1 = {4f 00 6c 00 64 00 50 00 61 00 73 00 73 00 20 00 3d 00 20 00 25 00 73 00 } //01 00 
		$a_01_2 = {44 00 6f 00 6d 00 61 00 69 00 6e 00 20 00 20 00 3d 00 20 00 25 00 73 00 } //00 00 
	condition:
		any of ($a_*)
