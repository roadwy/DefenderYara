...
rule TrojanSpy_Win32_Sybuex_B{
	...
	strings :
		...
		$a_00_1 = {6c 65 67 65 6e 64 20 6f 66 20 6d 69 72 } //01 00 
		$a_00_2 = {43 3a 5c 57 49 4e 44 4f 57 53 5c 69 6e 66 5c 73 70 61 74 69 64 2e 69 6e 66 } //01 00 
		$a_00_3 = {73 76 63 63 68 6f 73 74 65 72 2e 65 78 65 } //00 00 
	condition:
		any of ($a_*)
