...
rule TrojanSpy_Win32_Shiotob_A{
	...
	strings :
		$a_03_0 = {8b c0 80 fc 30 7c 90 01 01 80 fc 39 7f 90 01 01 80 ec 30 eb 90 01 01 80 fc 41 7c 90 01 01 80 fc 46 7f 90 01 01 80 ec 41 80 c4 0a 90 00 } //2
		$a_03_1 = {6a 00 6a 02 ff 15 90 01 04 8b d8 83 fb ff 74 90 01 01 c7 85 90 01 04 28 01 00 00 8d 85 90 00 } //2
