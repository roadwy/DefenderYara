...
rule TrojanSpy_Win32_Shiotob_C{
	...
	strings :
		$a_01_0 = {5c 42 65 73 74 2e 70 64 66 } //01 00 
		$a_01_1 = {68 00 74 00 74 00 70 00 3a 00 2f 00 2f 00 51 00 75 00 6f 00 74 00 69 00 65 00 } //01 00 
		$a_01_2 = {6d 00 65 00 61 00 73 00 75 00 72 00 2e 00 54 00 75 00 72 00 6e 00 } //01 00 
		$a_01_3 = {2e 00 53 00 69 00 6c 00 65 00 6e 00 74 00 } //02 00 
