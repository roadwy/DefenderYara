...
rule TrojanSpy_Win32_Shiotob_C{
	...
	strings :
		...
		$a_03_4 = {6a 00 6a 00 6a 01 6a 00 6a 02 68 00 00 00 40 8d 8d d8 fe ff ff 51 ff 15 90 01 04 89 45 f0 8b 55 ec 83 ea 1b 81 fa d5 00 00 00 76 17 8b 45 ec 03 05 90 01 04 0f b7 0d 90 01 04 03 c1 a3 90 01 04 83 7d f0 ff 74 17 6a 01 6a 00 6a 00 8d 95 d8 fe ff ff 52 6a 00 6a 00 ff 15 90 00 } //2
	condition:
