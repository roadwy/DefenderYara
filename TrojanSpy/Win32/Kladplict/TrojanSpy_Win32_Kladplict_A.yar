...
rule TrojanSpy_Win32_Kladplict_A{
	...
	strings :
		...
		$a_01_1 = {5b 63 6c 69 70 62 6f 61 72 64 20 62 65 67 69 6e 5d } //01 00 
		$a_01_2 = {6b 00 6c 00 2e 00 64 00 61 00 74 00 } //01 00 
		$a_01_3 = {4d 61 69 6e 20 52 65 74 75 72 6e 65 64 2e } //00 00 
