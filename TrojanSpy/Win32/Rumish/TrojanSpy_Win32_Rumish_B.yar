...
rule TrojanSpy_Win32_Rumish_B{
	...
	strings :
		$a_03_0 = {5c 42 72 6f 77 73 65 72 2e 48 65 6c 70 90 02 03 5c 42 72 6f 77 73 65 72 2e 48 65 6c 70 5c 52 65 6c 65 61 73 65 5c 72 76 72 73 2e 70 64 62 90 00 } //1
