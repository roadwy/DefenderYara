...
rule TrojanSpy_Win32_Nivdort_DH{
	...
	strings :
		...
		$a_03_1 = {79 05 49 83 c9 e0 41 0f b6 84 0c 90 01 02 00 00 99 bd 1a 00 00 00 f7 fd 80 c2 61 88 94 34 90 01 02 00 00 46 3b f7 75 90 00 } //2
		$a_03_2 = {77 61 74 63 68 5f 64 6f 67 5f 6e 61 6d 65 2e 65 78 65 90 02 10 2f 69 6e 64 65 78 2e 70 68 70 3f 64 61 74 61 3d 90 02 10 4c 4f 43 4b 90 02 10 77 62 90 00 } //2
