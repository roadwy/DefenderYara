...
rule TrojanSpy_Win32_Delf_BG{
	...
	strings :
		...
		$a_01_1 = {68 74 74 70 3a 2f 2f 6d 32 73 74 65 61 6c 65 72 2e 68 6f 73 74 69 6c 2e 70 6c 2f 63 2e 70 68 70 3f 6c 6f 67 69 3d } //01 00 
		$a_01_2 = {43 3a 5c 57 69 6e 64 6f 77 73 5c 77 64 6d 67 72 2e 65 78 65 } //00 00 
	condition:
		any of ($a_*)
