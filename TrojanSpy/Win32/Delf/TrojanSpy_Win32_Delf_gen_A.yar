...
rule TrojanSpy_Win32_Delf_gen_A{
	...
	strings :
		...
		$a_01_7 = {43 54 58 20 42 75 64 67 65 74 73 } //65436 CTX Budgets
	condition:
		((#a_00_0  & 1)*50+(#a_00_1  & 1)*1+(#a_00_2  & 1)*1+(#a_00_3  & 1)*1+(#a_00_4  & 1)*1+(#a_00_5  & 1)*1+(#a_00_6  & 1)*1+(#a_01_7  & 1)*65436) >=52
