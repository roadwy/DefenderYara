...
rule TrojanSpy_Win32_Wagiclas_B{
	...
	strings :
		$a_03_0 = {0f b7 fb 8b 55 00 8a 54 3a ff 0f b7 ce c1 e9 08 32 d1 88 54 38 ff 8b 04 24 0f 90 01 04 66 03 f0 66 69 c6 6d ce 66 05 bf 58 8b f0 43 90 00 } //5
		$a_03_1 = {c1 e2 06 03 c2 33 d2 8a 53 02 0f b6 92 90 01 03 00 c1 e2 0c 03 c2 33 d2 8a 53 03 0f b6 92 90 01 03 00 c1 e2 12 90 00 } //5
