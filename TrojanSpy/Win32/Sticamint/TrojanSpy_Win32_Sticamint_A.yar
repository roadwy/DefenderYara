...
rule TrojanSpy_Win32_Sticamint_A{
	...
	strings :
		$a_02_0 = {77 00 2e 00 77 00 64 00 77 00 90 02 16 67 00 2e 00 6e 00 65 00 74 00 2f 00 6e 00 65 00 74 00 90 00 } //1
		$a_02_1 = {77 00 2e 00 31 00 37 00 35 00 75 00 90 02 16 75 00 2e 00 63 00 6e 00 2f 00 6e 00 65 00 74 00 90 00 } //1
