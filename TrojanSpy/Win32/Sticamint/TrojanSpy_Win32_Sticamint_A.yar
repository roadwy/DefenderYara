...
rule TrojanSpy_Win32_Sticamint_A{
	...
	strings :
		...
		$a_00_2 = {2f 00 64 00 6c 00 6c 00 2e 00 61 00 73 00 70 00 78 00 3f 00 74 00 69 00 6d 00 65 00 3d 00 } //02 00 
		$a_00_3 = {26 00 49 00 4e 00 54 00 3d 00 } //02 00 
		$a_00_4 = {2f 00 73 00 74 00 61 00 74 00 2e 00 61 00 73 00 70 00 78 00 } //00 00 
	condition:
		any of ($a_*)
