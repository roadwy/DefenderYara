...
rule TrojanSpy_Win32_FastHookPOS_A{
	...
	strings :
		...
		$a_01_2 = {73 74 61 74 75 73 6c 6f 67 26 6c 6f 67 3d 47 65 74 4c 61 73 74 45 72 72 6f 72 2d 25 64 00 } //01 00 
		$a_01_3 = {6e 65 77 26 75 73 65 72 6e 61 6d 65 3d 25 73 26 63 6f 6d 70 75 74 65 72 6e 61 6d 65 3d 25 73 26 6f 73 3d 25 73 26 61 72 63 68 69 74 65 63 74 75 72 65 3d 25 73 00 } //01 00 
		$a_01_4 = {6e 6f 75 70 64 61 74 65 26 76 65 72 3d 33 00 } //01 00 
		$a_01_5 = {6b 65 79 26 6c 6f 67 3d 00 } //01 00 
		$a_01_6 = {5b 6c 63 74 72 6c 5d 00 } //01 00 
		$a_01_7 = {61 64 64 26 6c 6f 67 3d 25 73 26 66 6f 75 6e 64 69 6e 3d 25 73 00 } //01 00 
