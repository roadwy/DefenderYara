...
rule TrojanSpy_Win32_Winelpos_A{
	...
	strings :
		...
		$a_01_1 = {72 31 5c 52 65 6c 65 61 73 65 5c 72 31 2e 70 64 62 00 } //01 00  ㅲ剜汥慥敳牜⸱摰b
		$a_01_2 = {45 52 52 4c 4f 47 3a 00 } //01 00  剅䱒䝏:
		$a_01_3 = {65 72 72 6f 72 3a 20 6e 6f 74 20 61 64 6d 69 6e 20 75 73 65 72 00 } //01 00  牥潲㩲渠瑯愠浤湩甠敳r
