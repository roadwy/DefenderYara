...
rule TrojanSpy_Win32_Keylogger_AZ{
	...
	strings :
		...
		$a_00_1 = {6b 65 79 6c 6f 67 67 65 72 } //00 00 
	condition:
		any of ($a_*)
...
rule TrojanSpy_Win32_Keylogger_AZ_2{
	...
	strings :
		$a_01_0 = {2e 75 61 6e 65 73 6b 65 79 6c 6f 67 67 65 72 2e 70 6c } //02 00 
		...
		$a_01_3 = {26 70 61 67 65 00 26 6c 6f 67 69 6e 70 61 73 73 77 6f 72 64 3d 00 } //01 00 
		...
		$a_01_7 = {54 69 62 69 61 43 6c 69 65 6e 74 00 } //00 00 
	condition:
		any of ($a_*)
