...
rule TrojanSpy_Win32_Keylogger{
	...
	strings :
		...
		$a_01_1 = {5b 00 45 00 4e 00 54 00 45 00 52 00 5d 00 } //01 00 
		$a_01_2 = {5b 00 42 00 4b 00 53 00 50 00 5d 00 } //01 00 
		$a_01_3 = {5b 00 49 00 4e 00 53 00 45 00 52 00 54 00 5d 00 } //01 00 
...
rule TrojanSpy_Win32_Keylogger_2{
	...
	strings :
		...
		$a_01_2 = {5b 25 73 20 25 64 2d 25 64 2d 25 64 20 25 64 3a 25 64 3a 25 64 5d } //01 00 
		$a_01_3 = {5b 53 63 72 6f 6c 6c 20 4c 6f 63 6b 5d 00 } //01 00 
		$a_01_4 = {5b 50 72 69 6e 74 20 53 63 72 65 65 6e 5d 00 } //01 00 
		$a_01_5 = {55 6e 6b 6f 77 6e 20 55 73 65 72 00 } //00 00 
