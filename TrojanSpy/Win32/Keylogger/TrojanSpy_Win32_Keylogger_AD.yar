...
rule TrojanSpy_Win32_Keylogger_AD{
	...
	strings :
		$a_02_0 = {8d 85 e0 fe ff ff 50 e8 90 01 04 8d 8d dc fe ff ff b2 02 b0 15 e8 90 01 04 0f b6 46 08 88 45 eb 0f b7 46 0c c1 e8 08 88 45 ea 8d 8d d8 fe ff ff b2 01 b0 20 e8 90 00 } //10
