...
rule TrojanSpy_Win32_Keylogger_BT{
	...
	strings :
		$a_01_0 = {4b 65 79 4c 6f 67 20 53 65 72 76 69 63 65 20 53 74 61 72 74 2e 2e 2e } //01 00  KeyLog Service Start...
		...
		$a_01_3 = {25 32 2e 32 64 3a 25 32 2e 32 64 3a 25 32 2e 32 64 } //00 00  %2.2d:%2.2d:%2.2d
	condition:
		any of ($a_*)
