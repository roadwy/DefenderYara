...
rule TrojanSpy_Win32_Keylogger_B{
	...
	strings :
		$a_01_0 = {43 3a 5c 57 49 4e 44 4f 57 53 5c 53 59 53 54 45 4d 33 32 2f 2f 73 79 73 6d 6e 67 65 72 2e 65 78 65 } //01 00  C:\WINDOWS\SYSTEM32//sysmnger.exe
		$a_01_1 = {78 73 65 74 75 70 73 30 31 2e 62 63 72 00 } //01 00  獸瑥灵び⸱换r
		...
		$a_01_3 = {5b 45 6e 74 65 72 5d } //01 00  [Enter]
		$a_01_4 = {25 2e 32 64 2f 25 2e 32 64 2f 25 34 64 } //00 00  %.2d/%.2d/%4d
	condition:
		any of ($a_*)
