...
rule TrojanSpy_Win32_Keylogger_FX{
	...
	strings :
		...
		$a_03_4 = {83 ec 04 66 3d 01 80 0f 85 df 03 00 00 66 83 bd b2 fd ff ff 26 7e 48 66 83 bd b2 fd ff ff 40 7f 3e 0f bf 85 b2 fd ff ff 89 44 24 08 ?? ?? ?? ?? ?? ?? ?? ?? 8d 85 b8 fe ff ff 89 04 24 e8 } //1
	condition:
