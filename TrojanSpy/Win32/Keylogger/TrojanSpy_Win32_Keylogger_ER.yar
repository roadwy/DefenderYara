...
rule TrojanSpy_Win32_Keylogger_ER{
	...
	strings :
		$a_01_0 = {5c 77 69 6e 64 6f 77 73 5c 6c 73 61 73 73 2e 65 78 65 } //01 00  \windows\lsass.exe
		$a_01_1 = {5c 77 69 6e 64 6f 77 73 5c 73 65 72 76 69 63 65 73 2e 69 6e 69 } //01 00  \windows\services.ini
		$a_01_2 = {4b 6f 70 61 74 68 } //01 00  Kopath
		$a_01_3 = {4b 6e 69 67 68 74 4f 6e 6c 69 6e 65 } //0a 00  KnightOnline
