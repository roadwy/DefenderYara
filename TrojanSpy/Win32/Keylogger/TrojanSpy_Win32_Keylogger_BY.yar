...
rule TrojanSpy_Win32_Keylogger_BY{
	...
	strings :
		$a_01_0 = {5b 00 45 00 6e 00 74 00 65 00 72 00 5d 00 } //01 00 
		$a_01_1 = {5b 00 42 00 61 00 63 00 6b 00 53 00 70 00 61 00 63 00 65 00 5d 00 } //01 00 
		$a_01_2 = {5b 00 48 00 6f 00 6d 00 65 00 5d 00 } //0a 00 
		...
		$a_00_7 = {41 6d 69 6e 20 48 61 64 69 68 69 } //64 00 
		$a_01_8 = {54 63 68 65 63 6b 77 69 6e 74 78 74 } //00 00 
	condition:
		any of ($a_*)
