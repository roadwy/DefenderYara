...
rule TrojanSpy_Win32_Keylogger_BY{
	...
	strings :
		...
		$a_03_6 = {ff d3 50 68 90 01 02 40 00 ff 15 90 01 01 10 40 00 8b d0 8d 4d 90 01 01 ff d3 50 68 90 01 02 40 00 ff 15 90 01 01 10 40 00 8b d0 8d 4d 90 01 01 ff d3 90 00 } //100
