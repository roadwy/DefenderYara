...
rule TrojanSpy_Win32_Keylogger_EV{
	...
	strings :
		...
		$a_02_3 = {48 45 4c 4f 90 02 38 41 55 54 48 20 4c 4f 47 49 4e 0d 0a 00 00 00 00 ff ff ff ff 0c 00 00 00 4d 41 49 4c 20 46 52 4f 4d 3a 20 3c 00 00 00 00 ff ff ff ff 01 00 00 00 3e 00 00 00 ff ff ff ff 0a 00 00 00 52 43 50 54 20 54 4f 3a 20 3c 90 00 } //5
