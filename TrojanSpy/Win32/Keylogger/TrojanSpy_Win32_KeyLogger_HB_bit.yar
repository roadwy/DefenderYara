...
rule TrojanSpy_Win32_KeyLogger_HB_bit{
	...
	strings :
		...
		$a_03_1 = {50 6a 00 8d 85 90 01 03 ff 50 8d 85 90 01 03 ff 50 6a 00 56 c7 85 90 01 03 ff 00 00 00 00 ff 15 90 01 03 00 50 56 ff 15 90 01 03 00 85 c0 7e 0f 0f be 85 90 01 03 ff 50 68 90 01 03 00 eb 29 6a 20 8d 45 bc 50 6a 00 56 ff 15 90 01 03 00 0f b7 c0 c1 e0 10 50 ff 15 90 01 03 00 90 00 } //1
