...
rule TrojanSpy_Win32_Keylogger_AR{
	...
	strings :
		$a_01_0 = {7b 46 31 7d } //01 00 
		$a_01_1 = {7b 44 4f 57 4e 7d } //01 00 
		$a_01_2 = {7b 52 49 47 48 54 7d } //01 00 
		$a_01_3 = {7b 4c 45 46 54 7d } //01 00 
		$a_01_4 = {7b 55 50 7d } //01 00 
		$a_01_5 = {7b 43 41 50 53 7d } //01 00 
		$a_01_6 = {7b 45 53 43 7d } //01 00 
		$a_01_7 = {7b 54 41 42 7d } //05 00 
