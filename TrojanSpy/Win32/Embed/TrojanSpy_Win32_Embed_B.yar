...
rule TrojanSpy_Win32_Embed_B{
	...
	strings :
		...
		$a_01_3 = {2f 77 69 6e 64 6f 77 73 2f 75 70 64 61 74 65 2f 73 65 61 72 63 68 3f 68 6c 3d 25 73 26 71 3d 25 73 26 6d 65 74 61 3d 25 73 26 69 64 3d 25 73 } //01 00 
		$a_01_4 = {6e 65 74 73 74 61 74 20 2d 61 6e 6f 20 3e 3e } //01 00 
		$a_01_5 = {57 68 61 74 54 68 65 46 75 63 6b 69 6e 67 49 73 47 6f 69 6e 67 4f 6e 48 69 4d 61 6e 21 00 } //00 00 
	condition:
		any of ($a_*)
