...
rule TrojanSpy_Win32_Embed_B{
	...
	strings :
		...
		$a_01_4 = {6e 65 74 73 74 61 74 20 2d 61 6e 6f 20 3e 3e } //1 netstat -ano >>
		$a_01_5 = {57 68 61 74 54 68 65 46 75 63 6b 69 6e 67 49 73 47 6f 69 6e 67 4f 6e 48 69 4d 61 6e 21 00 } //1 桗瑡桔䙥捵楫杮獉潇湩佧䡮䵩湡!
	condition:
