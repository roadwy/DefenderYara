...
rule TrojanSpy_Win32_Embed_A{
	...
	strings :
		$a_01_0 = {66 66 6e 6f 73 7c 26 74 6d 2a 2a 2c 4c 30 46 47 } //01 00  ffnos|&tm**,L0FG
		$a_01_1 = {4d 00 63 00 61 00 66 00 65 00 65 00 20 00 46 00 72 00 61 00 6d 00 65 00 57 00 6f 00 72 00 6b 00 20 00 3a 00 28 00 } //01 00  Mcafee FrameWork :(
