...
rule TrojanSpy_Win32_Socelars_SB{
	...
	strings :
		$a_02_0 = {68 74 74 70 73 3a 2f 2f 62 69 74 62 75 63 6b 65 74 2e 6f 72 67 2f 90 02 30 2f 64 6f 77 6e 6c 6f 61 64 73 2f 6d 61 72 67 69 6e 31 32 2e 65 78 65 90 00 } //5
		...
		$a_02_4 = {63 64 70 6c 61 79 65 72 61 73 73 69 73 74 76 90 02 02 2e 65 78 65 90 00 } //1
