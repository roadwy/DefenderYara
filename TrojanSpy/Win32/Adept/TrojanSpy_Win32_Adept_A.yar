...
rule TrojanSpy_Win32_Adept_A{
	...
	strings :
		$a_03_0 = {80 fb 0a 74 15 80 fb 0d 74 10 8b c6 99 f7 7d 90 01 01 8b 45 90 01 01 8a 04 02 32 c3 88 01 90 00 } //2
		$a_03_1 = {74 37 66 81 7d 10 bb 01 74 07 68 90 01 04 eb 05 90 00 } //1
