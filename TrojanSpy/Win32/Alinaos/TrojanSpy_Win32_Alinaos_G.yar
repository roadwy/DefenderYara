...
rule TrojanSpy_Win32_Alinaos_G{
	...
	strings :
		$a_03_0 = {75 70 64 61 74 65 69 6e 74 65 72 76 61 6c 3d 90 02 08 63 61 72 64 69 6e 74 65 72 76 61 6c 3d 90 00 } //3
		$a_03_1 = {6c 6f 67 3d 31 90 02 08 7b 5b 21 31 37 21 5d 7d 7b 5b 21 31 38 21 5d 7d 90 02 08 6c 6f 67 3d 30 90 02 08 7b 5b 21 31 37 21 5d 7d 7b 5b 21 31 39 21 5d 7d 90 00 } //3
