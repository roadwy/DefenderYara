...
rule TrojanSpy_Win32_Alinaos_G{
	...
	strings :
		...
		$a_00_2 = {25 73 6e 74 66 73 2e 64 61 74 } //01 00 
		$a_01_3 = {68 74 74 70 3a 2f 2f 25 73 3a 25 64 7b 5b 21 34 21 5d } //01 00 
		$a_00_4 = {77 69 6e 2d 66 69 72 65 77 61 6c 6c 2e 65 78 65 } //00 00 
		$a_00_5 = {87 10 } //00 00 
	condition:
		any of ($a_*)
