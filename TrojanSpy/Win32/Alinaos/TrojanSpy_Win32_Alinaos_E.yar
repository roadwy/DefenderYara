...
rule TrojanSpy_Win32_Alinaos_E{
	...
	strings :
		$a_03_0 = {41 6c 69 6e 61 20 76 90 0f 01 00 2e 90 0f 01 00 } //1
		...
		$a_03_2 = {c7 01 00 00 00 00 6a 00 6a 00 6a 00 6a 01 68 ?? ?? ?? ?? ff 15 ?? ?? ?? ?? 89 45 ?? 85 c0 0f 84 ?? ?? ?? ?? 83 f8 ff 0f 84 ?? ?? ?? ?? 6a 00 6a 00 6a 03 6a 00 6a 00 53 56 50 ff 15 } //3
	condition:
