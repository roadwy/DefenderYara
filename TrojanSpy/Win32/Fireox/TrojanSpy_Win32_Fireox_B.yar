...
rule TrojanSpy_Win32_Fireox_B{
	...
	strings :
		...
		$a_01_1 = {66 66 70 73 63 61 63 68 65 2e 74 6d 70 } //01 00  ffpscache.tmp
		$a_01_2 = {53 4f 46 54 57 41 52 45 5c 4d 6f 7a 69 6c 6c 61 5c 4d 6f 7a 69 6c 6c 61 20 46 69 72 65 66 6f 78 } //01 00  SOFTWARE\Mozilla\Mozilla Firefox
