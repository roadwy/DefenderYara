...
rule TrojanSpy_Win32_Fucobha_A{
	...
	strings :
		...
		$a_03_6 = {8a 1c 0a 32 5c 35 90 01 01 46 3b f0 88 19 75 02 33 f6 41 4f 75 ec 90 00 } //2
	condition:
...
rule TrojanSpy_Win32_Fucobha_A_2{
	...
	strings :
		...
		$a_03_4 = {8a 4f 01 83 c7 01 3a cb 75 f6 8b c8 c1 e9 02 f3 a5 8b c8 83 e1 03 f3 a4 8d 90 02 04 00 00 90 00 } //10
	condition:
