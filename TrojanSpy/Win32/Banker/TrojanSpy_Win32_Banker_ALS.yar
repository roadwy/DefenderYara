...
rule TrojanSpy_Win32_Banker_ALS{
	...
	strings :
		...
		$a_01_3 = {5c 00 5f 00 4d 00 79 00 42 00 48 00 4f 00 5c 00 75 00 50 00 72 00 69 00 6e 00 63 00 5c 00 } //00 00  \_MyBHO\uPrinc\
	condition:
		any of ($a_*)
