...
rule TrojanSpy_Win32_Banker_AIZ{
	...
	strings :
		...
		$a_03_1 = {68 e0 93 04 00 e8 90 01 03 ff 6a 00 8d 95 90 01 03 ff b8 90 01 03 00 e8 90 01 03 ff 8b 85 90 01 03 ff e8 90 01 03 ff 50 e8 90 01 03 ff e8 90 01 03 ff eb 90 04 01 02 23 32 90 00 } //1
		$a_03_2 = {63 6d 64 20 2f 6b 20 00 90 01 06 90 02 03 43 90 04 01 04 23 25 2a 40 3a 90 04 01 04 23 25 2a 40 5c 90 04 01 04 23 25 2a 40 90 00 } //1
	condition:
