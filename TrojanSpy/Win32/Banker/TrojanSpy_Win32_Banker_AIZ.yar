...
rule TrojanSpy_Win32_Banker_AIZ_2{
	...
	strings :
		...
		$a_01_2 = {44 34 74 33 2e 2e 2e 2e 3a 00 } //02 00 
		$a_01_3 = {54 69 6d 65 2e 2e 2e 2e 3a 00 } //02 00 
		$a_01_4 = {4e 33 72 76 30 73 30 2e 2e 2e 2e 2e 3a 00 } //01 00 
		$a_01_5 = {44 41 54 45 2e 2e 2e 2e 3a 00 } //01 00 
		$a_01_6 = {6a 6f 68 6e 79 2d 64 61 40 75 6f 6c 2e 63 6f 6d 2e 62 72 } //01 00 
		$a_01_7 = {74 6f 64 61 69 6e 66 72 6f 40 67 6d 61 69 6c 2e 63 6f 6d } //01 00 
		$a_01_8 = {24 70 61 69 70 61 69 20 6e 6f 65 6c 20 69 6e 66 6f 72 24 } //01 00 
		$a_01_9 = {61 62 72 6f 75 6e 65 6c 73 61 6e 74 6f 73 } //01 00 
