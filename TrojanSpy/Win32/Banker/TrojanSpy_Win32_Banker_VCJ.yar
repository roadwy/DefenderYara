...
rule TrojanSpy_Win32_Banker_VCJ{
	meta:
		description = "TrojanSpy:Win32/Banker.VCJ,SIGNATURE_TYPE_PEHSTR,04 00 04 00 04 00 00 "
	...
	strings :
		...
		$a_01_1 = {53 00 65 00 6e 00 20 00 43 00 61 00 72 00 64 00 20 00 44 00 65 00 62 00 } //1 Sen Card Deb
		$a_01_2 = {40 00 67 00 6d 00 61 00 69 00 6c 00 2e 00 63 00 6f 00 6d 00 } //1 @gmail.com
		$a_01_3 = {5b 00 65 00 73 00 70 00 61 00 63 00 6f 00 5d 00 } //1 [espaco]
	condition:
