...
rule TrojanSpy_Win32_Banker_LW{
	...
	strings :
		...
		$a_01_3 = {2d 2d 2d 2d 2d 2d 2d 2d 2d 2d 2d 20 43 6f 6e 74 61 20 64 65 20 45 6d 61 69 6c 20 2d 2d 2d 2d 2d 2d 2d 2d 2d 2d 2d } //01 00  ----------- Conta de Email -----------
		$a_01_4 = {2d 2d 2d 2d 2d 2d 2d 2d 2d 2d 2d 2d 20 53 65 6e 68 61 73 20 2d 2d 2d 2d 2d 2d 2d 2d 2d 2d 2d 2d 2d 2d } //01 00  ------------ Senhas --------------
		$a_01_5 = {43 3a 5c 64 6f 77 6e 6c 6f 61 64 5c } //00 00  C:\download\
	condition:
		any of ($a_*)
