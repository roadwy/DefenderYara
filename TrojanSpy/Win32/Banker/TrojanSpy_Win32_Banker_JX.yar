...
rule TrojanSpy_Win32_Banker_JX{
	...
	strings :
		$a_01_0 = {5c 63 6f 6e 66 69 67 65 78 2e 64 6c 6c 00 00 } //10
		...
		$a_01_3 = {61 72 71 75 69 76 6f 75 70 67 72 61 64 65 72 2e 73 35 2e 63 6f 6d } //1 arquivoupgrader.s5.com
		$a_01_4 = {41 75 74 65 6e 74 69 63 61 63 61 6f 48 6f 74 6d 61 69 6c } //1 AutenticacaoHotmail
	condition:
