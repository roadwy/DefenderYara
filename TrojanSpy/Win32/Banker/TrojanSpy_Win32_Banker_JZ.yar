...
rule TrojanSpy_Win32_Banker_JZ{
	...
	strings :
		...
		$a_02_2 = {45 64 69 74 31 34 90 01 06 90 90 00 45 64 69 74 32 90 01 09 90 90 00 41 41 5f 64 6f 4d 53 4e 54 69 6d 65 72 90 01 07 46 6f 72 6d 43 72 65 61 74 65 90 00 } //3
		$a_02_3 = {4c 6f 67 69 6e 50 72 6f 6d 70 74 90 02 3a 50 72 6f 76 69 64 65 72 90 00 } //2
