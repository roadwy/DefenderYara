...
rule TrojanSpy_Win32_Banker_VL{
	...
	strings :
		...
		$a_02_1 = {53 56 8b d8 b1 37 b2 37 b0 37 e8 90 01 03 ff 8b d0 8b 83 e0 02 00 00 e8 90 01 03 ff b1 ff b2 ff b0 ff e8 90 01 03 ff 8b d0 8b c3 e8 90 01 03 ff 33 d2 8b 83 e0 02 00 00 e8 90 01 03 ff b2 01 a1 90 01 02 46 00 e8 90 01 03 ff 90 00 } //10
