...
rule TrojanSpy_Win32_Banker_ALI{
	...
	strings :
		$a_03_0 = {33 c0 8a 03 0f b6 80 90 01 04 33 d2 8a 53 01 0f b6 92 90 01 04 c1 e2 06 03 c2 33 d2 8a 53 02 0f b6 92 90 01 04 c1 e2 0c 03 c2 33 d2 8a 53 03 90 00 } //1
