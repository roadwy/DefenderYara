...
rule TrojanSpy_Win32_Banker_SY{
	...
	strings :
		...
		$a_00_1 = {6d 61 6e 64 6f 20 62 61 69 78 61 } //01 00 
		$a_00_2 = {53 45 4e 48 41 3d } //01 00 
		$a_00_3 = {70 69 63 61 73 61 63 68 65 63 6b } //01 00 
		$a_00_4 = {2e 63 6f 6d 2e 62 72 } //00 00 
	condition:
		any of ($a_*)
