...
rule TrojanSpy_Win32_Banker_ABJ{
	...
	strings :
		...
		$a_00_2 = {53 65 23 6e 68 23 61 20 43 61 72 23 74 61 23 6f } //01 00  Se#nh#a Car#ta#o
		$a_00_3 = {62 61 6e 63 23 6f 20 64 6f } //01 00  banc#o do
		$a_00_4 = {75 70 40 2e 65 78 65 } //00 00  up@.exe
	condition:
		any of ($a_*)
