...
rule TrojanSpy_Win32_Banker_HP{
	...
	strings :
		...
		$a_02_7 = {68 74 74 70 3a 2f 2f 77 77 77 2e 6f 72 6b 75 74 2e 63 6f 6d (2e 62 72 2f 66 72 69 65 6e 64 73 4c 69 73 74 2e 61 73 70 78|2f 73 63 72 61 70 62 6f 6f 6b 2e 61 73 70 78 3f) } //1
	condition:
