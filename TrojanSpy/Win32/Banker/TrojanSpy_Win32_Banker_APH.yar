...
rule TrojanSpy_Win32_Banker_APH{
	...
	strings :
		...
		$a_01_2 = {47 62 70 53 76 2e 65 78 65 22 20 2f 54 20 2f 45 20 2f 43 20 2f 50 } //01 00 
		$a_01_3 = {77 73 66 74 70 72 70 36 34 2e 73 79 73 22 20 2f 54 20 2f 45 20 2f 43 20 2f 50 } //00 00 
