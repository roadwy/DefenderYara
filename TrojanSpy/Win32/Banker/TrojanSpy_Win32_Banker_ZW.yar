...
rule TrojanSpy_Win32_Banker_ZW{
	...
	strings :
		$a_00_0 = {62 00 72 00 61 00 64 00 65 00 73 00 63 00 6f 00 2e 00 63 00 6f 00 6d 00 2e 00 62 00 72 00 } //01 00 
		$a_00_1 = {44 69 67 69 74 65 20 73 75 61 20 73 65 6e 68 61 } //01 00 
