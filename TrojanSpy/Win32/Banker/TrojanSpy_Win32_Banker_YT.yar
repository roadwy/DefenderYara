...
rule TrojanSpy_Win32_Banker_YT{
	...
	strings :
		...
		$a_03_1 = {eb ea 6a 03 6a 00 6a 00 8d 55 e0 a1 90 01 04 8b 00 e8 90 01 04 8b 45 e0 e8 90 01 04 50 6a 00 8b 45 fc e8 90 01 04 50 e8 90 00 } //1
		...
		$a_03_10 = {57 69 6e 64 6f 77 73 4c 69 76 65 3a 6e 61 6d 65 3d 2a 90 01 1e 69 6e 66 6f 90 01 10 70 63 90 00 } //1
	condition:
