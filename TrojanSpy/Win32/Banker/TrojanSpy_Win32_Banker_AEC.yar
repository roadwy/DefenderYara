...
rule TrojanSpy_Win32_Banker_AEC{
	...
	strings :
		...
		$a_01_2 = {2e 73 69 23 63 72 23 65 64 69 2e 63 6f 23 6d 2e 62 23 72 } //01 00 
		$a_01_3 = {3f 74 69 6d 23 65 4d 69 6c 6c 69 23 73 3d 30 26 63 6f 6f 70 46 69 6c 6c 3d } //01 00 
		$a_01_4 = {74 6d 72 53 61 6e 74 61 53 65 67 75 72 61 54 69 6d 65 72 } //01 00 
		$a_01_5 = {54 6d 72 52 65 69 6e 69 63 69 61 54 69 6d 65 72 } //01 00 
		$a_01_6 = {70 6e 6c 49 74 61 43 54 62 43 6c 69 63 6b } //01 00 
		$a_01_7 = {6c 62 6c 43 61 72 74 61 6f 31 } //01 00 
