...
rule TrojanSpy_Win32_Banker_VCP{
	...
	strings :
		...
		$a_03_1 = {8b c8 0f bf c3 99 f7 f9 83 c2 01 0f 80 ?? 01 00 00 52 8b 55 08 } //1
		$a_03_2 = {ff d7 50 b9 50 00 00 00 ff 15 ?? ?? ?? ?? 8b 55 ?? 50 8d 4d ?? 8b 02 50 51 ff d7 8b 56 ?? 50 52 e8 } //1
	condition:
