...
rule TrojanSpy_Win32_Banker_P{
	...
	strings :
		$a_03_0 = {40 89 c7 8d b3 90 01 04 8b c3 b9 26 00 00 00 99 f7 f9 8b 45 90 01 01 8a 14 10 32 16 90 00 } //4
		$a_03_1 = {8a 18 80 f3 90 01 01 88 1a 42 40 49 75 f4 90 00 } //3
