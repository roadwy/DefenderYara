...
rule TrojanSpy_Win32_Banker_ALT{
	...
	strings :
		$a_01_0 = {4a 47 6b 32 31 67 47 } //02 00  JGk21gG
		$a_01_1 = {55 70 64 61 74 65 72 4c 6f 67 54 65 63 6b } //01 00  UpdaterLogTeck
		$a_01_2 = {48 4a 49 38 2e 7a 69 70 } //01 00  HJI8.zip
		$a_01_3 = {49 36 48 38 2e 65 78 65 } //02 00  I6H8.exe
