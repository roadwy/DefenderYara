...
rule TrojanSpy_Win32_Banker_WD{
	...
	strings :
		...
		$a_01_1 = {6c 69 73 74 61 68 6f 74 6d 61 69 6c 77 65 63 68 61 6d 40 67 6d 61 69 6c 2e 63 6f 6d } //01 00 
		$a_01_2 = {43 3a 5c 41 72 71 75 69 76 6f 73 20 64 65 20 70 72 6f 67 72 61 6d 61 73 5c 6d 73 6e 5f 6c 69 76 65 72 73 2e 65 78 65 } //01 00 
