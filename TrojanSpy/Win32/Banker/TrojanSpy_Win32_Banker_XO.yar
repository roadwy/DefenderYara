...
rule TrojanSpy_Win32_Banker_XO{
	...
	strings :
		...
		$a_00_3 = {3c 2f 42 3e 3c 53 50 41 4e 20 69 64 3d 62 61 6e 6b 2d 6e 61 6d 65 3e } //01 00 
		$a_00_4 = {42 41 4e 4b 3d 25 73 26 51 49 41 4e 3d 25 73 26 41 4c 49 50 41 59 4e 41 4d 45 3d 25 73 26 41 4c 49 50 41 59 56 45 52 3d 25 73 } //01 00 
		$a_00_5 = {25 73 2f 50 61 79 54 6f 4d 65 2f 54 42 5f 50 61 79 2e 41 73 70 3f 6e 46 6c 61 67 3d 30 26 55 73 65 72 4e 61 6d 65 3d 25 73 } //00 00 
	condition:
		any of ($a_*)
