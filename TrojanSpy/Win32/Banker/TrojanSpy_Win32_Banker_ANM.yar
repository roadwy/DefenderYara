...
rule TrojanSpy_Win32_Banker_ANM{
	...
	strings :
		...
		$a_03_3 = {c1 e0 06 03 d8 89 90 01 02 83 c7 06 83 ff 08 7c 90 01 01 83 ef 08 8b cf 8b 90 01 02 d3 eb 8b cf b8 01 00 00 00 d3 e0 8b c8 8b 90 01 02 99 f7 f9 90 00 } //1
