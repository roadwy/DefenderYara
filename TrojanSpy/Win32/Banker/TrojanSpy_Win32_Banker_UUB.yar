...
rule TrojanSpy_Win32_Banker_UUB{
	...
	strings :
		...
		$a_01_3 = {52 75 6e 74 69 6d 65 20 65 72 72 6f 72 20 20 20 20 20 61 74 20 30 30 30 30 30 30 30 30 } //01 00 
		$a_01_4 = {48 74 74 70 4f 70 65 6e 52 65 71 75 65 73 74 41 } //01 00 
		$a_01_5 = {49 6e 74 65 72 6e 65 74 43 6f 6e 6e 65 63 74 41 } //01 00 
		$a_01_6 = {47 65 74 53 74 61 72 74 75 70 49 6e 66 6f 41 } //01 00 
		$a_01_7 = {53 79 73 52 65 41 6c 6c 6f 63 53 74 72 69 6e 67 4c 65 6e } //00 00 
	condition:
		any of ($a_*)
