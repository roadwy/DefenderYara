...
rule TrojanSpy_Win32_Banker_GY{
	...
	strings :
		...
		$a_02_10 = {8b 00 ba 88 ff ff ff e8 90 01 03 ff a1 90 01 03 00 8b 00 ba 98 03 00 00 e8 90 01 03 ff a1 90 01 03 00 8b 00 ba be 01 00 00 e8 90 01 03 ff a1 90 01 03 00 8b 00 b2 01 e8 90 01 03 ff 90 00 } //100
	condition:
