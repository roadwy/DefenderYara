...
rule TrojanSpy_Win32_Banker_AET{
	...
	strings :
		...
		$a_00_1 = {41 76 69 73 6f 20 49 6d 70 6f 72 74 61 6e 74 65 } //01 00 
		$a_00_2 = {43 72 68 6f 6d 65 2e 65 78 65 } //01 00 
		$a_00_3 = {66 65 6e 69 78 5c 54 41 4d 5c 7a 73 61 6e 74 61 6f } //00 00 
	condition:
		any of ($a_*)
