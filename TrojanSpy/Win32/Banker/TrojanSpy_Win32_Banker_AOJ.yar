...
rule TrojanSpy_Win32_Banker_AOJ{
	...
	strings :
		...
		$a_00_2 = {4e 6f 76 6f 20 61 63 65 73 73 6f 20 43 6f 6e 6e 65 63 74 20 42 61 6e 6b 2e } //01 00 
		$a_00_3 = {4e 6f 76 6f 20 61 63 65 73 73 6f 20 48 73 62 63 20 62 61 6e 6b 2d 6c 69 6e 65 2e 2e 2e } //00 00 
	condition:
		any of ($a_*)
