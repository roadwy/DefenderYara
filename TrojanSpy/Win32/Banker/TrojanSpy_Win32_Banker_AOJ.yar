...
rule TrojanSpy_Win32_Banker_AOJ{
	...
	strings :
		$a_02_0 = {70 00 68 00 70 00 2e 00 90 01 01 61 00 74 00 6c 00 75 00 73 00 6e 00 6f 00 63 00 2f 00 72 00 62 00 2e 00 6d 00 6f 00 63 00 2e 00 90 02 10 2e 00 77 00 77 00 77 00 90 00 } //4
		$a_02_1 = {70 68 70 2e 90 01 01 61 74 6c 75 73 6e 6f 63 2f 72 62 2e 6d 6f 63 2e 90 02 10 2e 77 77 77 90 00 } //4
