...
rule TrojanSpy_Win32_Banker_HG{
	...
	strings :
		...
		$a_00_4 = {69 6d 67 49 74 61 75 43 6c 69 63 6b } //1 imgItauClick
		$a_00_5 = {43 6f 6e 66 69 67 75 72 61 6f 64 65 62 6c 6f 71 75 65 61 64 6f 72 64 65 70 6f 70 75 70 73 } //1 Configuraodebloqueadordepopups
		$a_00_6 = {57 69 6e 64 6f 77 73 6d 65 73 73 65 6e 67 65 72 31 34 } //1 Windowsmessenger14
		$a_00_7 = {45 6d 61 69 6c 65 6e 6f 74 63 69 61 73 31 40 } //1 Emailenotcias1@
	condition:
