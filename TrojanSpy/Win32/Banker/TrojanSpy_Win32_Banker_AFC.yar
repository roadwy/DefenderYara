...
rule TrojanSpy_Win32_Banker_AFC{
	...
	strings :
		...
		$a_01_2 = {25 6e 2a 75 40 52 23 5c 25 6e 25 6f 2a 69 23 73 25 72 25 65 2a 56 40 74 40 6e 23 65 25 72 2a 72 2a 75 23 43 25 5c 2a 73 2a 77 40 6f 23 64 25 6e 25 69 2a 57 23 5c 25 74 2a 66 2a 6f 40 73 23 6f 25 72 2a 63 2a 69 23 4d 25 } //00 00 
	condition:
		any of ($a_*)
