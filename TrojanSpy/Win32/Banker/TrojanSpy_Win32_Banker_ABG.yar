...
rule TrojanSpy_Win32_Banker_ABG{
	...
	strings :
		$a_03_0 = {ba 03 00 00 00 e8 90 01 04 8b 85 90 01 01 ff ff ff e8 90 01 04 50 6a 00 e8 90 01 04 8b 90 01 01 6a 01 90 00 } //1
		$a_03_1 = {eb 07 b2 02 e8 90 01 02 ff ff 8b 45 fc 80 78 5b 00 74 90 01 01 8b 45 fc 8b 40 44 80 b8 90 01 02 00 00 01 90 01 02 8b 90 01 01 fc 90 00 } //1
