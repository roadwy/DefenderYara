...
rule TrojanSpy_Win32_Banker_MV{
	...
	strings :
		$a_00_0 = {40 67 6f 72 64 6f 2e 63 6f 6d 2e 62 72 } //01 00  @gordo.com.br
		$a_02_1 = {61 6e 74 72 61 78 5f 90 10 06 00 40 68 6f 74 6d 61 69 6c 2e 63 6f 6d 90 00 } //01 00 
		$a_00_2 = {45 2d 42 61 6e 6b 69 6e 67 20 69 6e 73 74 61 6c 61 64 6f 20 63 6f 6d 20 73 75 63 65 73 73 6f } //01 00  E-Banking instalado com sucesso
