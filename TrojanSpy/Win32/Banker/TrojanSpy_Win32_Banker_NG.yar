...
rule TrojanSpy_Win32_Banker_NG{
	...
	strings :
		...
		$a_01_1 = {60 7c 7c 78 32 27 27 } //10 `||x2''
		$a_01_2 = {5c 73 65 37 74 69 6e 67 73 2e 73 30 6c 00 } //1
		$a_01_3 = {5c 64 6f 77 6e 6c 30 61 64 2e 74 72 61 63 6b 00 } //1
		$a_01_4 = {5c 6e 6f 74 69 2e 66 79 00 } //1
	condition:
