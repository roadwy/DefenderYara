...
rule TrojanSpy_Win32_Banker_AKW{
	...
	strings :
		...
		$a_01_5 = {6d 61 63 72 6f 64 69 72 65 63 74 2e 63 6f 6d 2e 61 72 2f } //01 00 
		$a_01_6 = {2f 52 65 74 61 69 6c 48 6f 6d 65 42 61 6e 6b 69 6e 67 57 65 62 2f 61 63 63 65 73 73 2e 64 6f } //01 00 
		$a_01_7 = {2f 52 65 74 61 69 6c 49 6e 73 74 69 74 75 63 69 6f 6e 61 6c 57 65 62 2f 68 6f 6d 65 2e 64 6f } //01 00 
		$a_01_8 = {53 75 70 65 72 76 69 65 6c 6c 65 20 42 61 6e 63 6f } //01 00 
		$a_01_9 = {42 61 6e 63 6f 20 43 72 65 64 69 63 6f 6f 70 20 43 6f 6f 70 2e 20 4c 74 64 6f 2e } //01 00 
		$a_01_10 = {42 61 6e 63 6f 20 47 61 6c 69 63 69 61 20 2d 20 50 65 72 73 6f 6e 61 73 } //01 00 
