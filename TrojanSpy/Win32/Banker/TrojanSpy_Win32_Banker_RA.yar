...
rule TrojanSpy_Win32_Banker_RA{
	...
	strings :
		...
		$a_02_2 = {57 69 64 74 68 90 02 06 48 65 69 67 68 74 90 02 06 43 61 70 74 69 6f 6e 90 02 18 49 6e 74 65 72 6e 65 74 20 42 61 6e 6b 69 6e 67 90 00 } //2
		...
		$a_02_5 = {4c 6f 67 69 6e 50 72 6f 6d 70 74 90 02 3a 50 72 6f 76 69 64 65 72 90 00 } //1
