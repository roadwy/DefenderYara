...
rule TrojanSpy_Win32_Banker_gen_F{
	...
	strings :
		...
		$a_00_1 = {70 00 65 00 64 00 72 00 6f 00 63 00 61 00 63 00 61 00 72 00 6e 00 65 00 69 00 72 00 6f 00 40 00 67 00 6d 00 61 00 69 00 6c 00 2e 00 63 00 6f 00 6d 00 } //00 00  pedrocacarneiro@gmail.com
	condition:
		any of ($a_*)
