...
rule TrojanSpy_Win32_Banker_AOA{
	...
	strings :
		$a_01_0 = {5c 47 62 50 6c 75 67 69 6e } //01 00  \GbPlugin
		$a_01_1 = {5c 53 63 70 61 64 } //01 00  \Scpad
		$a_01_2 = {42 72 61 64 69 6e 68 61 } //01 00  Bradinha
		$a_01_3 = {4c 61 72 61 6e 6a 61 } //01 00  Laranja
