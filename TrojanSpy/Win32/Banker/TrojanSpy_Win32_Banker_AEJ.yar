...
rule TrojanSpy_Win32_Banker_AEJ{
	...
	strings :
		...
		$a_03_4 = {41 75 74 6f 43 6f 6e 66 69 67 55 52 4c 00 00 00 ff ff ff ff 90 01 01 00 00 00 68 74 74 70 3a 2f 2f 90 00 } //1
		$a_03_5 = {0d 80 00 00 00 50 6a ec a1 90 01 02 44 00 53 e8 90 01 02 fb ff 68 88 13 00 00 e8 90 01 02 fb ff 90 00 } //1
	condition:
