...
rule TrojanSpy_Win32_Banker_VV{
	...
	strings :
		...
		$a_00_1 = {4b 65 79 6c 6f 67 67 65 72 20 6f 66 20 42 61 6e 6b 65 72 } //01 00  Keylogger of Banker
		$a_00_2 = {4b 65 79 6c 6f 67 67 65 72 5f 50 61 79 50 61 6c } //01 00  Keylogger_PayPal
		$a_00_3 = {78 2d 63 6f 64 65 72 2d 78 } //01 00  x-coder-x
		$a_00_4 = {53 65 6e 68 61 } //01 00  Senha
		$a_00_5 = {44 65 76 69 63 65 5c 76 61 72 73 61 6f } //00 00  Device\varsao
	condition:
		any of ($a_*)
