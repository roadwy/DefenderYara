...
rule TrojanSpy_Win32_Banker_VCE{
	...
	strings :
		...
		$a_03_2 = {85 c0 76 1e 68 01 00 11 00 6a 1b 68 00 01 00 00 68 90 01 04 6a 00 e8 90 00 } //1
		$a_03_3 = {0f 8e dd 00 00 00 bb 01 00 00 00 8d 45 f4 50 b9 01 00 00 00 8b d3 8b 45 fc e8 90 01 03 ff 8b 45 f4 ba 90 01 03 00 e8 90 01 03 ff 0f 84 aa 00 00 00 8d 45 f0 90 00 } //1
	condition:
