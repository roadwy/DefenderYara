...
rule TrojanSpy_Win32_Banker_AOT_4{
	...
	strings :
		$a_03_0 = {20 75 72 6c 3a 20 00 90 01 10 90 02 10 20 75 72 6c 32 3a 20 00 90 00 } //1
		$a_03_1 = {66 ba 57 00 a1 90 01 04 e8 08 fc ff ff 68 4d 01 00 00 e8 90 01 04 6a 00 8d 55 f4 b8 90 01 04 e8 a7 f7 ff ff ff 75 f4 68 90 01 04 ff 75 fc 8d 45 f8 ba 03 00 00 00 e8 90 01 04 8b 45 f8 e8 90 01 04 50 e8 90 00 } //1
		$a_03_2 = {75 17 8d 55 d4 8b c3 e8 e4 f1 ff ff 8b 55 d4 b8 90 01 04 e8 90 01 04 33 c0 55 68 90 01 04 64 ff 30 64 89 20 33 c9 b2 01 a1 90 01 04 e8 90 01 04 89 45 f4 8b 45 f4 c7 80 9c 00 00 00 e8 03 00 00 8d 55 d0 b8 90 01 04 e8 06 ca ff ff 8b 55 d0 8d 45 f0 8b 4d f8 e8 90 01 04 8d 55 cc b8 90 01 04 e8 eb c9 ff ff 90 00 } //1
