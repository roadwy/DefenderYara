...
rule TrojanSpy_Win32_Ursnif_gen_E{
	...
	strings :
		...
		$a_01_4 = {6f 70 74 5f 63 65 72 74 73 00 } //01 00 
		$a_01_5 = {33 70 6f 73 74 76 61 6c 75 65 } //01 00 
		$a_01_6 = {57 45 42 20 46 4f 55 4e 44 45 44 00 } //01 00 
		$a_01_7 = {6f 70 74 69 6f 6e 73 2e 63 67 69 } //00 00 
	condition:
		any of ($a_*)
