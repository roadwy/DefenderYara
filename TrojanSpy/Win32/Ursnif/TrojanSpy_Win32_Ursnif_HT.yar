...
rule TrojanSpy_Win32_Ursnif_HT{
	...
	strings :
		$a_03_0 = {89 45 08 8d 47 01 0f b6 f8 8d 76 01 8a 8f 90 01 04 0f b6 c1 03 c2 0f b6 d0 8a 82 90 1b 00 88 8a 90 1b 00 88 87 90 1b 00 0f b6 8a 90 1b 00 0f b6 c0 03 c8 0f b6 c1 8b 4d 08 0f b6 80 90 1b 00 32 44 31 ff 88 46 ff 83 eb 01 75 b2 90 00 } //1
