...
rule TrojanSpy_Win32_Ursnif__Ursnif_2{
	...
	strings :
		$a_03_0 = {8b 07 8b c8 74 90 01 01 85 c0 75 90 01 01 33 d2 42 eb 90 01 01 33 c3 33 45 90 01 01 83 c7 04 ff 45 90 01 01 8b d9 8a 4d 90 01 01 d3 c8 89 06 83 c6 04 4a 75 90 00 } //2
		$a_00_1 = {2e 62 73 73 00 00 00 00 22 25 53 22 } //1
		$a_03_2 = {3d 70 6e 6c 73 75 90 01 01 ff 73 90 01 01 03 d6 57 52 e8 90 00 } //1
		$a_00_3 = {8b 47 3c 03 c7 0f b7 50 06 0f b7 70 14 6b d2 28 81 f1 3a 24 00 00 0f b7 c9 03 d0 } //1
		$a_03_4 = {c6 04 03 00 83 7e 10 04 72 90 01 01 8b 46 90 01 01 31 03 8b 45 90 01 01 8b 4d 90 01 01 89 18 8b 46 10 89 01 8b 44 24 10 90 00 } //1
	condition:
...
rule TrojanSpy_Win32_Ursnif__Ursnif_3{
	...
	strings :
		...
		$a_03_2 = {70 6e 6c 73 ff d6 89 45 90 01 01 3b c7 0f 84 90 01 01 00 00 00 90 00 } //1
		$a_01_3 = {8b 43 3c 03 c3 0f b7 50 06 6b d2 28 56 0f b7 70 14 81 f1 3a 24 00 00 0f b7 c9 03 d0 } //1
		$a_03_4 = {c6 04 07 00 83 7e 10 04 72 90 01 01 8b 46 04 31 07 8b 45 90 01 01 8b 4d 90 01 01 89 38 8b 46 10 89 01 90 00 } //1
	condition:
