...
rule TrojanSpy_Win32_Ursnif__Ursnif{
	...
	strings :
		$a_00_0 = {73 6f 66 74 3d 25 75 26 76 65 72 73 69 6f 6e 3d 25 75 26 75 73 65 72 3d 25 30 38 78 25 30 38 78 25 30 38 78 25 30 38 78 26 73 65 72 76 65 72 3d 25 75 26 69 64 3d 25 75 26 63 72 63 3d 25 78 } //02 00  soft=%u&version=%u&user=%08x%08x%08x%08x&server=%u&id=%u&crc=%x
		$a_00_1 = {40 53 4f 43 4b 53 3d 2a 40 } //01 00  @SOCKS=*@
		$a_00_2 = {54 6f 72 43 6c 69 65 6e 74 } //01 00  TorClient
		$a_00_3 = {54 6f 72 43 72 63 } //01 00  TorCrc
		$a_00_4 = {2e 6f 6e 69 6f 6e 2f } //00 00  .onion/
	condition:
		any of ($a_*)
