...
rule TrojanSpy_Win32_Ursnif_ID_bit{
	...
	strings :
		...
		$a_01_1 = {63 3a 5c 43 61 70 69 74 61 6c 5c 44 65 73 65 72 74 5c 4c 65 74 5c 66 65 6c 6c 5c 43 6f 6f 6c 5c 53 6f 69 6c 5c 54 68 69 72 64 54 68 69 6e 2e 70 64 62 } //00 00  c:\Capital\Desert\Let\fell\Cool\Soil\ThirdThin.pdb
	condition:
		any of ($a_*)
