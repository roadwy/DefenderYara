...
rule TrojanSpy_Win32_Ursnif_IB_bit{
	...
	strings :
		...
		$a_03_1 = {2b ca 2b ce 81 c1 90 01 04 8b 41 04 2b 41 0c 03 01 3d 90 00 } //1
		$a_03_2 = {8a 0e 0f b6 d0 0f b6 c9 33 d1 83 e2 0f c1 e8 04 33 04 95 90 01 04 c1 e9 04 8b d0 83 e2 0f 4f 33 ca c1 e8 04 46 33 04 8d 90 00 } //1
	condition:
