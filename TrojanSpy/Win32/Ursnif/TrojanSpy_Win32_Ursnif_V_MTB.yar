...
rule TrojanSpy_Win32_Ursnif_V_MTB{
	...
	strings :
		...
		$a_00_2 = {63 3a 5c 45 76 65 72 79 5c 62 6c 61 63 6b 5c 53 75 67 67 65 73 74 5c 4f 6e 63 65 5c 53 6f 75 6e 64 69 72 6f 6e 2e 70 64 62 } //00 00  c:\Every\black\Suggest\Once\Soundiron.pdb
	condition:
		any of ($a_*)
