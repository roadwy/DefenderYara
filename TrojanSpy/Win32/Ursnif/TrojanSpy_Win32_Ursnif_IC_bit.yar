...
rule TrojanSpy_Win32_Ursnif_IC_bit_2{
	...
	strings :
		...
		$a_03_1 = {8a 0e 0f b6 d0 0f b6 c9 33 d1 83 e2 0f c1 e8 04 33 04 95 ?? ?? ?? ?? c1 e9 04 8b d0 83 e2 0f 4f 33 ca c1 e8 04 46 33 04 8d } //5
		$a_03_2 = {8b 10 3b 55 ?? 75 0a 8b 50 04 3b 55 ?? 75 02 8b d8 83 c0 28 49 74 04 85 db 74 e5 } //1
		...
		$a_03_4 = {2b ca 2b ce 81 c1 ?? ?? ?? ?? 8b 41 04 2b 41 0c 03 01 3d } //1
	condition:
