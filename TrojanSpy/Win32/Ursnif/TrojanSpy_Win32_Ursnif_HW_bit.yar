...
rule TrojanSpy_Win32_Ursnif_HW_bit{
	...
	strings :
		...
		$a_01_2 = {76 65 72 73 69 6f 6e 3d 25 75 26 73 6f 66 74 3d 31 26 75 73 65 72 3d 25 30 38 78 25 30 38 78 25 30 38 78 25 30 38 78 26 73 65 72 76 65 72 3d 25 75 26 69 64 3d 25 75 26 74 79 70 65 3d 25 75 26 6e 61 6d 65 3d 25 73 } //02 00  version=%u&soft=1&user=%08x%08x%08x%08x&server=%u&id=%u&type=%u&name=%s
