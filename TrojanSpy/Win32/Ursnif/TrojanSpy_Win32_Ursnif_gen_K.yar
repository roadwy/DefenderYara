...
rule TrojanSpy_Win32_Ursnif_gen_K{
	...
	strings :
		...
		$a_00_9 = {75 73 65 72 5f 69 64 3d 25 2e 34 75 26 76 65 72 73 69 6f 6e 5f 69 64 3d 25 6c 75 26 73 6f 63 6b 73 3d 25 6c 75 26 62 75 69 6c 64 3d 25 6c 75 26 63 72 63 3d 25 2e 38 78 } //01 00  user_id=%.4u&version_id=%lu&socks=%lu&build=%lu&crc=%.8x
		...
		$a_00_14 = {64 61 74 61 2e 70 68 70 3f 76 65 72 73 69 6f 6e 3d 25 75 26 75 73 65 72 3d 25 30 38 78 25 30 38 78 25 30 38 78 25 30 38 78 26 73 65 72 76 65 72 3d 25 75 26 69 64 3d 25 75 26 74 79 70 65 3d 25 75 26 6e 61 6d 65 3d 25 73 } //01 00  data.php?version=%u&user=%08x%08x%08x%08x&server=%u&id=%u&type=%u&name=%s
