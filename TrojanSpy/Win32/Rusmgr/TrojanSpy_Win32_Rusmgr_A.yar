...
rule TrojanSpy_Win32_Rusmgr_A{
	...
	strings :
		...
		$a_00_1 = {50 25 53 25 56 25 59 25 5c 25 } //01 00 
		$a_00_2 = {52 75 6e 4d 73 67 72 73 } //01 00 
		$a_00_3 = {52 43 50 54 20 54 4f 3a 3c } //01 00 
		$a_00_4 = {48 65 6c 6f 4e 61 6d 65 } //01 00 
		$a_00_5 = {55 73 65 45 68 6c 6f } //00 00 
	condition:
		any of ($a_*)
