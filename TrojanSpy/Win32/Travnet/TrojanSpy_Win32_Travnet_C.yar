...
rule TrojanSpy_Win32_Travnet_C{
	...
	strings :
		...
		$a_00_3 = {25 73 3f 61 63 74 69 6f 6e 3d 67 65 74 63 6d 64 26 68 6f 73 74 69 64 3d 25 73 26 68 6f 73 74 6e 61 6d 65 3d 25 73 } //05 00 
		$a_00_4 = {64 31 3d 25 73 0a 64 69 72 63 6f 75 6e 74 3d 31 } //01 00 
		$a_00_5 = {6e 74 76 62 61 30 30 2e 74 6d 70 5c } //01 00 
		$a_00_6 = {25 73 5c 75 65 6e 75 6d 66 73 2e 69 6e 69 } //01 00 
		$a_00_7 = {64 6e 6c 69 73 74 2e 69 6e 69 } //01 00 
		$a_00_8 = {5c 73 74 61 74 5f 74 2e 69 6e 69 } //00 00 
