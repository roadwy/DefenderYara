...
rule TrojanSpy_Win32_Travnet_B{
	...
	strings :
		...
		$a_03_1 = {8b 4c 24 04 57 f7 c1 03 00 00 00 74 90 01 01 8a 01 41 84 c0 74 90 01 01 f7 c1 03 00 00 00 75 90 01 01 8b 01 ba ff fe fe 7e 03 d0 83 f0 ff 33 c2 83 c1 04 a9 00 01 01 81 90 00 } //1
