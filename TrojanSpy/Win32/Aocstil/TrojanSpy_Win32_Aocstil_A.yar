...
rule TrojanSpy_Win32_Aocstil_A{
	...
	strings :
		$a_01_0 = {73 68 6f 77 31 32 33 34 2e 63 6f 6d } //01 00 
		$a_01_1 = {34 36 2e 31 35 31 2e 35 32 } //01 00 
		$a_01_2 = {61 64 64 20 48 4b 45 59 5f 43 55 52 52 45 4e 54 5f 55 53 45 52 5c 53 6f 66 74 77 61 72 65 5c 4d 69 63 72 6f 73 6f 66 74 5c 57 69 6e 64 6f 77 73 5c 43 75 72 72 65 6e 74 56 65 72 73 69 6f 6e 5c 52 75 6e 20 2f 76 } //01 00 
		...
		$a_01_5 = {26 00 63 00 6f 00 6e 00 66 00 69 00 67 00 3d 00 7b 00 } //01 00 
		$a_01_6 = {26 00 63 00 6f 00 64 00 69 00 } //01 00 
