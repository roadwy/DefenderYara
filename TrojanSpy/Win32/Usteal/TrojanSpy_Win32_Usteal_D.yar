...
rule TrojanSpy_Win32_Usteal_D{
	...
	strings :
		...
		$a_02_3 = {66 74 70 2e 66 72 6f 6e 74 2e 72 75 90 02 10 6d 61 6a 65 73 74 69 63 6b 31 32 90 02 10 6d 6a 31 32 67 70 33 32 30 90 00 } //1
		$a_03_4 = {68 ff 00 00 00 ff 75 fc 6a 01 68 90 01 04 68 90 01 04 6a 15 68 90 01 04 ff 35 90 01 04 ff 15 90 01 04 a3 90 01 04 0b c0 75 11 ff 35 90 01 04 ff 15 90 01 04 e9 b2 90 01 01 ff ff 90 00 } //1
	condition:
