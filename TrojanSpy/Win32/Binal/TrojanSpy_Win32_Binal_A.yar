...
rule TrojanSpy_Win32_Binal_A{
	...
	strings :
		...
		$a_03_1 = {8a 12 80 ea 41 8d 14 92 8d 14 92 8b 4d ?? 8a 49 01 80 e9 41 02 d1 8b ce 2a d1 8b cf 2a d1 } //10
		$a_03_2 = {66 81 3b 4d 5a 0f 85 ?? ?? 00 00 [0-40] 81 3f 50 45 00 00 0f 85 ?? ?? 00 00 } //1
	condition:
