...
rule TrojanSpy_Win32_BrobanDel_B{
	...
	strings :
		$a_03_0 = {50 72 6f 6a 65 63 74 31 00 00 00 00 46 6f 72 6d 31 00 00 00 46 6f 72 6d 33 00 00 00 46 6f 72 6d 35 00 00 00 46 6f 72 6d 37 [0-ff] 46 6f 72 6d 35 33 [0-ff] 46 6f 72 6d 31 30 31 [0-04] 46 6f 72 6d 31 30 33 } //1
