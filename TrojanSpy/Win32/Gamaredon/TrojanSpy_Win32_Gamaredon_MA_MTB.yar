...
rule TrojanSpy_Win32_Gamaredon_MA_MTB{
	...
	strings :
		...
		$a_02_5 = {52 00 75 00 6e 00 50 00 72 00 6f 00 67 00 72 00 61 00 6d 00 3d 00 22 00 68 00 69 00 64 00 63 00 6f 00 6e 00 3a 00 6e 00 6f 00 77 00 61 00 69 00 74 00 3a 00 63 00 6d 00 64 00 20 00 2f 00 63 00 20 00 69 00 66 00 20 00 6e 00 6f 00 74 00 20 00 65 00 78 00 69 00 73 00 74 00 20 00 68 00 6f 00 73 00 74 00 6e 00 61 00 6d 00 65 00 20 00 28 00 6e 00 6f 00 64 00 65 00 20 00 73 00 65 00 72 00 76 00 69 00 63 00 65 00 20 00 90 01 03 2e 00 90 01 03 2e 00 90 01 03 2e 00 90 01 03 29 00 22 00 90 00 } //1
		$a_02_6 = {52 75 6e 50 72 6f 67 72 61 6d 3d 22 68 69 64 63 6f 6e 3a 6e 6f 77 61 69 74 3a 63 6d 64 20 2f 63 20 69 66 20 6e 6f 74 20 65 78 69 73 74 20 68 6f 73 74 6e 61 6d 65 20 28 6e 6f 64 65 20 73 65 72 76 69 63 65 20 90 01 03 2e 90 01 03 2e 90 01 03 2e 90 01 03 29 22 90 00 } //1
	condition:
