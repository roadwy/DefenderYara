...
rule TrojanSpy_Win32_Logsnif_gen_F{
	...
	strings :
		$a_03_0 = {7a 7a 61 72 64 20 45 6e 74 65 72 74 61 69 6e 6d 65 6e 74 5c 57 6f 72 6c 64 20 6f 66 20 57 61 72 63 72 61 66 74 90 02 20 49 6e 73 74 61 6c 6c 50 61 74 68 00 90 00 } //1
