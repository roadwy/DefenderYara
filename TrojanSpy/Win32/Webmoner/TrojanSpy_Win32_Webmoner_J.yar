...
rule TrojanSpy_Win32_Webmoner_J{
	...
	strings :
		...
		$a_02_2 = {5c 26 73 23 79 32 73 57 74 37 65 2a 6d 6d 33 2f 32 77 5c 57 64 63 72 2a 69 23 76 51 65 32 72 35 73 77 5c 46 65 77 74 38 63 37 5c 26 68 2a 6f 35 73 23 74 37 73 26 00 00 90 01 08 5c 62 73 37 76 32 63 37 68 79 90 00 } //1
	condition:
