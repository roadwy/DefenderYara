...
rule TrojanSpy_Win32_Streespyer_D{
	...
	strings :
		...
		$a_03_1 = {16 53 65 72 76 69 63 65 42 65 66 6f 72 65 55 6e 69 6e 73 74 61 6c 6c 90 01 06 18 4d 65 73 73 61 67 65 5f 54 65 63 6c 61 73 5f 64 65 5f 41 74 61 6c 68 6f 0a 54 52 70 63 4c 6f 6f 6b 75 70 90 00 } //1
