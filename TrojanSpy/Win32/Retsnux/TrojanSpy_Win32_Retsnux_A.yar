...
rule TrojanSpy_Win32_Retsnux_A{
	...
	strings :
		...
		$a_03_3 = {73 41 74 74 61 63 68 90 05 05 01 20 3d 90 05 05 01 20 25 41 5f 41 70 70 44 61 74 61 25 5c 4d 69 63 72 6f 73 6f 66 74 5c 64 61 74 61 5c 4e 45 54 55 53 52 90 00 } //1
	condition:
