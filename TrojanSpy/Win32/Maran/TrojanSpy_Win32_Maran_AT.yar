...
rule TrojanSpy_Win32_Maran_AT{
	...
	strings :
		$a_01_0 = {4c 31 3a 4c 61 6e 64 73 6f 66 41 64 65 6e 28 } //1 L1:LandsofAden(
		$a_01_1 = {3b 75 73 65 72 3a } //1 ;user:
		$a_01_2 = {3b 70 61 73 73 3a } //1 ;pass:
		$a_01_3 = {51 51 51 51 51 53 56 57 } //1 QQQQQSVW
		...
		$a_03_7 = {ff ff ff ff 0a 00 00 00 3b 90 01 04 70 61 73 73 3a 00 90 00 } //1
	condition:
