...
rule TrojanSpy_Win32_Maran_gen_D{
	...
	strings :
		...
		$a_00_1 = {41 63 63 65 70 74 2d 4c 61 6e 67 75 61 67 65 3a 20 7a 68 2d 63 6e } //05 00 
		...
		$a_01_3 = {68 74 6f 6e 73 } //05 00 
		$a_00_4 = {73 6f 63 6b 65 74 } //01 00 
		$a_01_5 = {42 6c 6f 63 6b 20 53 68 65 65 70 20 57 61 6c 6c } //00 00 
	condition:
		any of ($a_*)
