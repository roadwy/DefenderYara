...
rule TrojanSpy_Win32_Gwghost_M{
	...
	strings :
		...
		$a_02_3 = {8b f0 6a 20 56 6a 00 6a 00 6a 00 68 00 04 00 00 e8 90 01 04 48 03 f0 c6 06 20 46 6a 20 56 6a 00 6a 00 6a 00 68 00 04 00 00 e8 90 01 04 48 03 f0 ba 90 01 04 8b c6 e8 90 01 04 8b f0 6a 00 8d 55 f4 52 8d 85 90 01 04 2b f0 56 50 53 e8 90 01 04 6a 00 90 00 } //5
	condition:
