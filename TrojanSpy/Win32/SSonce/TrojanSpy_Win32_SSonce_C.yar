...
rule TrojanSpy_Win32_SSonce_C{
	...
	strings :
		$a_01_0 = {5c 6b 65 79 6c 6f 67 2e 64 61 74 } //01 00 
		$a_01_1 = {7c 44 49 52 23 30 23 00 } //01 00 
		$a_00_2 = {73 74 75 62 70 61 74 68 00 } //01 00 
		$a_00_3 = {5b 73 68 69 66 74 5d } //00 00 
	condition:
		any of ($a_*)
...
rule TrojanSpy_Win32_SSonce_C_2{
	...
	strings :
		...
		$a_01_2 = {75 4b 65 79 4c 6f 67 67 65 72 } //01 00 
		$a_01_3 = {50 63 6e 52 61 77 69 6e 70 75 74 } //01 00 
		$a_01_4 = {75 45 6e 63 72 79 70 74 69 6f 6e } //01 00 
		$a_01_5 = {75 50 61 72 73 65 72 } //01 00 
		$a_01_6 = {5f 53 6f 63 6b 65 74 55 6e 69 74 } //01 00 
		$a_01_7 = {75 52 65 6d 6f 74 65 53 68 65 6c 6c } //00 00 
	condition:
		any of ($a_*)
