...
rule TrojanSpy_Win32_Dayek_A{
	...
	strings :
		...
		$a_01_1 = {61 00 64 00 6b 00 65 00 79 00 2e 00 70 00 68 00 70 00 } //02 00 
		...
		$a_01_3 = {5c 00 55 00 70 00 64 00 61 00 74 00 65 00 45 00 78 00 5c 00 55 00 70 00 64 00 61 00 74 00 65 00 45 00 78 00 2e 00 76 00 62 00 70 00 } //00 00 
	condition:
		any of ($a_*)
