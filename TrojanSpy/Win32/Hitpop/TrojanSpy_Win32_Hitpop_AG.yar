...
rule TrojanSpy_Win32_Hitpop_AG{
	...
	strings :
		$a_03_0 = {83 7d f8 00 0f 84 ?? ?? 00 00 8b 45 f8 8a 18 80 fb 25 0f 85 ?? ?? 00 00 8b 45 f8 80 78 01 75 75 7d 8d 45 f4 50 b9 06 00 00 00 ba 01 00 00 00 8b 45 f8 e8 90 09 07 00 6a 01 e8 } //1
		$a_03_1 = {0f b6 54 3a ff 33 c2 89 45 f8 8d 45 dc 8b 55 f8 e8 ?? ?? ?? ?? 8b 55 dc 8b c6 e8 ?? ?? ?? ?? 47 4b 75 b0 } //1
