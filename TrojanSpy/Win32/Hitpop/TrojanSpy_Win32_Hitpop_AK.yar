...
rule TrojanSpy_Win32_Hitpop_AK{
	...
	strings :
		...
		$a_03_10 = {6a 00 6a 00 8b 45 e4 e8 ?? ?? ff ff 50 8b 45 f4 e8 ?? ?? ff ff 50 6a 00 e8 ?? ?? ff ff 8b 45 e4 50 e8 ?? ?? ff ff 84 c0 75 0b 8b 55 e4 8b 45 f4 e8 ?? ?? ff ff 8b 45 f4 e8 ?? ?? ff ff 8b 45 e4 50 } //1
	condition:
