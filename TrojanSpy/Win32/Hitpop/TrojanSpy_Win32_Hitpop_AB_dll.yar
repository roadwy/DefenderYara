...
rule TrojanSpy_Win32_Hitpop_AB_dll{
	...
	strings :
		$a_02_0 = {43 6f 6d 6d 6f 6e 20 53 74 61 72 74 75 70 00 00 ff ff ff ff 90 02 25 2e 6c 6e 6b 90 00 } //5
		$a_02_1 = {45 78 70 6c 6f 72 65 72 5c 72 75 6e 90 02 20 2e 69 6e 69 90 00 } //5
		...
		$a_02_3 = {64 ff 30 64 89 20 8b 45 08 e8 90 01 02 fe ff 8d 45 f0 50 8b 45 f8 e8 90 01 02 fe ff 50 8b 45 fc 50 e8 90 01 02 fe ff 85 c0 90 00 } //10
