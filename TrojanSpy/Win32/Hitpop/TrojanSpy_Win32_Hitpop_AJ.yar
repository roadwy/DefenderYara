...
rule TrojanSpy_Win32_Hitpop_AJ{
	...
	strings :
		$a_03_0 = {7e 55 bf 01 00 00 00 ff 45 f4 83 7d f4 10 7e 07 c7 45 f4 01 00 00 00 8d 45 e0 8b 55 ec 8b 4d f4 8a 54 0a ff e8 90 01 02 fe ff 8b 45 e0 e8 90 01 02 ff ff 8b 55 f0 0f b6 54 3a ff 33 c2 89 45 f8 90 00 } //2
