...
rule TrojanSpy_Win32_USBThief_A_bit{
	...
	strings :
		...
		$a_01_1 = {5c 55 70 61 6e 5a 68 6f 6e 67 4d 61 5c 52 65 6c 65 61 73 65 5c 55 70 61 6e 5a 68 6f 6e 67 4d 61 2e 70 64 62 } //00 00  \UpanZhongMa\Release\UpanZhongMa.pdb
	condition:
		any of ($a_*)
