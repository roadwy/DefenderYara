...
rule TrojanSpy_Win32_Nosgiver_A{
	...
	strings :
		...
		$a_02_2 = {42 39 c2 7c f4 89 1c 24 b8 90 01 02 41 00 89 44 24 04 e8 90 01 02 00 00 a3 90 01 02 41 00 83 ec 08 90 00 } //1
		$a_02_3 = {6b 65 72 6e 65 6c 64 72 69 76 65 72 5c 90 02 20 5c 50 47 50 73 63 2e 70 64 62 90 00 } //1
