...
rule TrojanSpy_Win32_Nadebanker_F{
	...
	strings :
		...
		$a_01_2 = {64 74 77 35 64 5c } //01 00 
		$a_01_3 = {26 71 3d 68 64 26 76 65 6e 64 6f 72 3d 26 64 61 74 61 5f 74 79 70 65 3d 48 69 64 65 } //01 00 
		$a_01_4 = {26 68 69 64 65 5f 74 79 70 65 3d 44 65 6c } //01 00 
		...
		$a_01_6 = {4f 70 65 72 61 2f 39 2e 32 30 20 28 57 69 6e 64 6f 77 73 20 4e 54 20 35 2e 31 3a 20 55 3a 20 65 6e 29 } //01 00 
		$a_01_7 = {69 6e 67 20 55 52 4c 20 25 53 } //01 00 
		$a_01_8 = {72 65 67 73 76 72 33 32 2e 65 78 65 20 2f 75 20 2f 73 } //00 00 
	condition:
		any of ($a_*)
