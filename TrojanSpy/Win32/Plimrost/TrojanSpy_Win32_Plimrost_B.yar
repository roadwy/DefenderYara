...
rule TrojanSpy_Win32_Plimrost_B{
	...
	strings :
		$a_00_0 = {48 00 61 00 72 00 64 00 43 00 6f 00 72 00 65 00 20 00 53 00 6f 00 66 00 74 00 77 00 61 00 72 00 65 00 20 00 46 00 6f 00 72 00 20 00 3a 00 20 00 50 00 75 00 62 00 6c 00 69 00 63 00 } //01 00 
		$a_00_1 = {3f 00 61 00 63 00 74 00 69 00 6f 00 6e 00 3d 00 61 00 64 00 64 00 26 00 75 00 73 00 65 00 72 00 6e 00 61 00 6d 00 65 00 3d 00 } //01 00 
