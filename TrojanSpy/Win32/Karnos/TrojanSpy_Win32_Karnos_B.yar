...
rule TrojanSpy_Win32_Karnos_B{
	...
	strings :
		$a_00_0 = {74 69 65 62 61 5f 6e 61 6d 65 } //01 00 
		$a_00_1 = {6d 6f 6e 5f 77 65 62 5f 6b 65 79 77 6f 72 64 } //01 00 
		$a_01_2 = {5c 74 61 6f 6a 69 6e 5c 32 2e 30 5c 69 65 73 70 79 } //01 00 
