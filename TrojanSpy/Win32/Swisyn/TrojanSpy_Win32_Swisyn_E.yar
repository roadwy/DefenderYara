...
rule TrojanSpy_Win32_Swisyn_E{
	...
	strings :
		...
		$a_01_2 = {64 72 69 76 65 72 73 2e 6c 6f 67 } //01 00 
		$a_01_3 = {5b 44 65 6c 5d } //01 00 
		$a_01_4 = {5b 42 61 63 6b 73 70 61 63 65 5d } //01 00 
		$a_01_5 = {7b 53 69 6c 7d } //01 00 
		$a_01_6 = {7b 41 72 72 6f 77 5f 55 70 7d } //00 00 
	condition:
		any of ($a_*)
