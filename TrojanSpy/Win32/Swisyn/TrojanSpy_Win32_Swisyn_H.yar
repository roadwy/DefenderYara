...
rule TrojanSpy_Win32_Swisyn_H{
	...
	strings :
		...
		$a_01_1 = {5b 42 72 6f 77 73 65 72 42 61 63 6b 5d } //01 00  [BrowserBack]
		$a_01_2 = {5b 4e 4c 31 5d } //01 00  [NL1]
		$a_01_3 = {52 65 73 69 6d 20 63 65 6b 3a 5f 5f } //00 00  Resim cek:__
	condition:
		any of ($a_*)
