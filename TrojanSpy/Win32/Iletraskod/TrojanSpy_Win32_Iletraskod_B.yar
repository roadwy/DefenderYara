...
rule TrojanSpy_Win32_Iletraskod_B{
	...
	strings :
		...
		$a_01_1 = {43 6f 6e 6e 65 63 74 42 61 6e 6b 00 44 69 73 63 6f 6e 6e 65 63 74 } //01 00  潃湮捥䉴湡k楄捳湯敮瑣
		$a_01_2 = {23 56 45 52 53 49 4f 4e 2d 50 57 2d 32 2e 30 2e 30 2e 30 00 } //01 00  嘣剅䥓乏倭ⵗ⸲⸰⸰0
