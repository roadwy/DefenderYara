...
rule TrojanSpy_Win32_Gamker_A_dll{
	...
	strings :
		$a_03_0 = {62 6f 74 69 64 3d 25 73 26 76 65 72 3d 90 02 08 26 75 70 3d 25 75 26 6f 73 3d 25 30 33 75 26 6c 74 69 6d 65 3d 25 73 25 64 26 74 6f 6b 65 6e 3d 25 64 26 63 6e 3d 74 65 73 74 78 26 61 76 3d 25 73 90 00 } //1
		...
		$a_03_4 = {0f b6 5d 0f 88 1f 0f b6 5d 0f 0f b6 7d 0b 03 fb 8a 5d ff 81 e7 ff 00 00 00 32 1c 07 fe c1 88 88 00 01 00 00 88 90 90 01 01 00 00 88 1e 46 ff 4d f8 75 90 90 90 00 } //1
		$a_03_5 = {75 2d b8 02 00 00 00 e8 dc 46 00 00 85 c0 74 15 33 c9 80 38 31 8b f0 0f 94 c1 89 0d 94 c0 05 10 e8 90 01 04 c7 05 90 01 08 83 3d 90 01 06 75 6c 85 db 75 4f 33 f6 39 35 90 00 } //1
	condition:
