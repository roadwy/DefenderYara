...
rule TrojanSpy_Win32_Bancos_AGQ{
	...
	strings :
		$a_01_0 = {2f 00 5f 00 73 00 79 00 73 00 69 00 6e 00 69 00 2f 00 77 00 69 00 6e 00 6c 00 6f 00 67 00 2e 00 74 00 78 00 74 00 } //01 00  /_sysini/winlog.txt
		$a_01_1 = {36 32 42 46 35 38 44 45 33 32 45 41 36 30 42 43 34 32 43 34 } //01 00  62BF58DE32EA60BC42C4
