...
rule TrojanSpy_Win32_Bancos_TH{
	...
	strings :
		...
		$a_00_1 = {72 2a 62 2e 6d 2a 6f 63 2a 2e 62 2a 62 } //01 00  r*b.m*oc*.b*b
		$a_00_2 = {49 2a 45 46 2a 52 41 4d 2a 45 } //01 00  I*EF*RAM*E
		$a_00_3 = {2a 6c 2a 6d 2a 74 2a 68 2a 2e 2a 73 2a 6f 2a 64 2a 61 2a 64 } //00 00  *l*m*t*h*.*s*o*d*a*d
	condition:
		any of ($a_*)
