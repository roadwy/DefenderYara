...
rule TrojanSpy_Win32_Bancos_gen_Q{
	...
	strings :
		$a_03_0 = {89 45 ec 8b 45 ec 0f b6 00 8b 95 d4 fe ff ff 30 84 15 d8 fe ff ff ff 85 d4 fe ff ff 81 bd d4 fe ff ff 00 01 00 00 75 ?? 33 d2 89 95 d4 fe ff ff 8b 55 d8 30 44 15 dc ff 45 d8 83 7d d8 08 75 } //1
		...
		$a_03_3 = {8b 08 ff 51 1c 8b 85 ?? fa ff ff 8d 95 ?? fa ff ff e8 ?? ?? ?? ?? ff b5 ?? fa ff ff 8d 85 ?? fa ff ff ba 06 } //5
	condition:
