...
rule TrojanSpy_Win32_Bancos_ACB{
	...
	strings :
		...
		$a_00_2 = {2e 62 62 2e 63 6f 6d 2e 62 72 } //01 00  .bb.com.br
		$a_00_3 = {69 74 61 75 2e 63 6f 6d } //01 00  itau.com
		$a_00_4 = {70 61 72 61 20 61 63 65 73 73 61 72 20 6f 20 69 6e 74 65 72 6e 65 74 20 62 61 6e 6b 6e 67 } //00 00  para acessar o internet bankng
	condition:
		any of ($a_*)
