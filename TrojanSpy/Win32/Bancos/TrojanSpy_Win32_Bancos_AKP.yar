...
rule TrojanSpy_Win32_Bancos_AKP{
	...
	strings :
		...
		$a_00_2 = {64 00 61 00 74 00 61 00 63 00 61 00 64 00 61 00 73 00 74 00 72 00 6f 00 3d 00 } //01 00 
		$a_00_3 = {70 00 61 00 73 00 73 00 77 00 6f 00 72 00 64 00 3d 00 } //00 00 
	condition:
		any of ($a_*)
