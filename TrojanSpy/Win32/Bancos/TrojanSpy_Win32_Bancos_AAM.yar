...
rule TrojanSpy_Win32_Bancos_AAM{
	...
	strings :
		$a_00_0 = {69 00 62 00 32 00 6b 00 31 00 2e 00 64 00 6c 00 6c 00 2f 00 4c 00 4f 00 47 00 49 00 4e 00 } //01 00 
		...
		$a_00_2 = {2e 63 6f 6d 2e 62 72 } //01 00 
		$a_03_3 = {63 6f 6e 66 69 72 6d 61 90 02 10 63 6c 69 63 6b 90 00 } //01 00 
		$a_00_4 = {73 65 6e 68 61 63 61 72 74 61 6f } //00 00 
	condition:
		any of ($a_*)
