...
rule TrojanSpy_Win32_Bancos_AFE{
	...
	strings :
		...
		$a_01_2 = {53 65 6e 68 61 20 49 6e 74 65 72 6e 65 74 2e 2e 2e 2e 2e 2e 2e 2e 2e 2e 3a } //01 00 
		$a_01_3 = {4d 41 43 2e 2e 2e 2e 2e 2e 2e 2e 2e 2e 2e 2e 2e 2e 2e 3a } //00 00 
	condition:
		any of ($a_*)
