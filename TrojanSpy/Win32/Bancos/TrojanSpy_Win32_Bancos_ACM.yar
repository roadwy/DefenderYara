...
rule TrojanSpy_Win32_Bancos_ACM{
	...
	strings :
		$a_00_0 = {75 73 65 72 5f 70 72 65 66 28 22 6e 65 74 77 6f 72 6b 2e 70 72 6f 78 79 2e 61 75 74 6f 63 6f 6e 66 69 67 5f 75 72 6c 22 } //01 00  user_pref("network.proxy.autoconfig_url"
		$a_00_1 = {49 66 20 65 78 69 73 74 20 22 25 73 22 20 47 6f 74 6f 20 31 } //01 00  If exist "%s" Goto 1
