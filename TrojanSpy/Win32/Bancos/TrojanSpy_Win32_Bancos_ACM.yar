...
rule TrojanSpy_Win32_Bancos_ACM{
	...
	strings :
		...
		$a_03_2 = {8b 45 0c 33 db 8b d0 83 ea 02 74 0a 81 ea ff 03 00 00 74 0b eb 90 01 01 6a 00 e8 90 01 04 eb 90 01 01 a1 90 01 04 e8 90 01 04 a1 90 01 04 e8 90 01 04 68 e8 03 00 00 e8 90 01 04 e8 90 01 04 68 e8 03 00 00 e8 90 01 04 e8 90 01 04 6a 00 6a 00 6a 02 8b 45 08 50 e8 90 00 } //1
	condition:
