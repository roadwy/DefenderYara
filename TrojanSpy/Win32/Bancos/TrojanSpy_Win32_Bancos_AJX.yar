...
rule TrojanSpy_Win32_Bancos_AJX{
	...
	strings :
		...
		$a_02_1 = {2e 67 69 66 00 90 05 03 01 00 ff ff ff ff 0b 00 00 00 75 73 65 72 70 72 6f 66 69 6c 65 90 00 } //1
		$a_03_2 = {8d 55 fc b8 90 01 04 e8 90 01 04 8b 55 fc b8 90 01 04 b9 90 01 04 e8 90 01 04 8d 55 f8 b8 90 01 04 e8 90 01 04 8b 55 f8 b8 90 01 04 b9 90 00 } //1
	condition:
