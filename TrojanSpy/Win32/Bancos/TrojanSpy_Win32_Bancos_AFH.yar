...
rule TrojanSpy_Win32_Bancos_AFH{
	...
	strings :
		...
		$a_00_1 = {54 00 65 00 63 00 6c 00 61 00 64 00 6f 00 20 00 76 00 69 00 72 00 74 00 75 00 61 00 6c 00 20 00 64 00 65 00 73 00 61 00 62 00 69 00 6c 00 69 00 74 00 61 00 64 00 6f 00 2c 00 } //01 00 
		$a_00_2 = {6d 00 65 00 73 00 73 00 61 00 67 00 65 00 3d 00 } //00 00 
	condition:
		any of ($a_*)
