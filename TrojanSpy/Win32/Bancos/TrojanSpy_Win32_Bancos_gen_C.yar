...
rule TrojanSpy_Win32_Bancos_gen_C{
	...
	strings :
		...
		$a_01_1 = {62 6f 75 6e 64 61 72 79 3d 22 3d 5f 4e 65 78 74 50 61 72 74 5f 32 72 66 6b } //04 00 
		$a_01_2 = {62 6f 75 6e 64 61 72 79 3d 22 3d 5f 4e 65 78 74 50 61 72 74 5f 32 72 65 6c } //02 00 
		...
		$a_01_8 = {55 73 65 72 6e 61 6d 65 53 56 57 } //02 00 
		$a_01_9 = {55 73 75 61 72 69 6f 2e 2e } //f4 ff 
		$a_00_10 = {6f 6c 6d 5c 50 72 6f 74 65 73 74 6f } //f4 ff 
		$a_01_11 = {74 72 69 65 73 74 65 2e 63 6f 6d 2e 62 72 } //00 00 
	condition:
		any of ($a_*)
