...
rule TrojanSpy_Win32_Bancos_AAD{
	...
	strings :
		$a_03_0 = {63 6f 6d 6d 61 6e 64 2e 63 6f 6d 20 2f 63 20 72 65 67 73 76 72 33 32 20 43 3a 5c 57 49 4e 44 4f 57 53 5c 6e 65 74 [0-02] 2e 64 6c 6c 20 2f 73 } //2
		$a_03_1 = {63 6f 6d 6d 61 6e 64 2e 63 6f 6d 20 2f 63 20 72 65 67 73 76 72 33 32 20 43 3a 5c 57 49 4e 44 4f 57 53 5c 69 74 6d 6e 74 [0-02] 2e 64 6c 6c 20 2f 73 } //2
		$a_03_2 = {63 6f 6d 6d 61 6e 64 2e 63 6f 6d 20 2f 63 20 72 65 67 73 76 72 33 32 20 2f 75 20 2f 73 20 2f 63 20 69 74 [0-02] 2e 64 6c 6c 20 2f 73 } //2
		$a_01_3 = {54 65 72 6d 69 6e 6f 75 20 64 6f 77 6e 6c 6f 61 64 } //1 Terminou download
		$a_03_4 = {6d 64 69 74 [0-02] 2e 65 78 65 } //1
	condition:
...
rule TrojanSpy_Win32_Bancos_AAD_2{
	...
	strings :
		...
		$a_03_4 = {66 ba bf 07 b8 [0-1e] 8d ?? ?? 66 ba bf 07 b8 [0-1e] 8d ?? ?? 66 ba bf 07 b8 [0-1e] 8d } //50
		$a_03_5 = {c1 eb 08 66 33 cb 66 [0-19] 66 69 c0 01 d2 66 05 6a 7f 66 } //50
		$a_03_6 = {c1 e9 08 66 33 d1 66 [0-14] 66 69 c6 01 d2 66 05 6a 7f } //50
	condition:
