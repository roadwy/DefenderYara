...
rule TrojanSpy_Win32_Bancos_VN{
	...
	strings :
		...
		$a_00_2 = {5c 57 69 6e 64 6f 77 73 5c 53 43 52 2e 6a 70 67 } //00 00 
	condition:
		any of ($a_*)
...
rule TrojanSpy_Win32_Bancos_VN_2{
	...
	strings :
		$a_01_0 = {43 00 2a 00 5c 00 41 00 44 00 3a 00 5c 00 74 00 75 00 64 00 6f 00 5c 00 62 00 61 00 69 00 78 00 61 00 20 00 64 00 61 00 72 00 6c 00 61 00 6d 00 5c 00 50 00 72 00 6f 00 6a 00 65 00 63 00 74 00 31 00 2e 00 76 00 62 00 70 00 } //01 00 
		...
		$a_01_2 = {4d 00 41 00 49 00 4c 00 20 00 46 00 52 00 4f 00 4d 00 3a 00 20 00 3c 00 } //00 00 
	condition:
		any of ($a_*)
