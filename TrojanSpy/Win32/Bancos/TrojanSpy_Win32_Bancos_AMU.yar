...
rule TrojanSpy_Win32_Bancos_AMU{
	...
	strings :
		...
		$a_01_4 = {2f 00 47 00 43 00 4d 00 52 00 65 00 71 00 75 00 65 00 73 00 74 00 2e 00 64 00 6f 00 } //1 /GCMRequest.do
		$a_01_5 = {2f 00 6e 00 6f 00 72 00 6d 00 61 00 6c 00 2f 00 4e 00 4c 00 2f 00 6c 00 6f 00 67 00 69 00 6e 00 } //1 /normal/NL/login
		$a_01_6 = {55 00 6e 00 69 00 62 00 61 00 6e 00 63 00 6f 00 2e 00 63 00 6f 00 6d 00 20 00 2d 00 20 00 48 00 6f 00 6d 00 65 00 20 00 2d 00 20 00 4d 00 6f 00 7a 00 69 00 6c 00 6c 00 61 00 20 00 46 00 69 00 72 00 65 00 66 00 6f 00 78 00 } //1 Unibanco.com - Home - Mozilla Firefox
		$a_01_7 = {42 00 61 00 6e 00 63 00 6f 00 20 00 42 00 72 00 61 00 64 00 65 00 73 00 63 00 6f 00 20 00 53 00 2f 00 41 00 20 00 2d 00 20 00 4d 00 6f 00 7a 00 69 00 6c 00 6c 00 61 00 20 00 46 00 69 00 72 00 65 00 66 00 6f 00 78 00 } //1 Banco Bradesco S/A - Mozilla Firefox
	condition:
