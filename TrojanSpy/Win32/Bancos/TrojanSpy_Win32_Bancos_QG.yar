...
rule TrojanSpy_Win32_Bancos_QG{
	...
	strings :
		...
		$a_01_1 = {63 6f 6d 70 75 74 61 64 6f 72 3d 00 } //01 00  潣灭瑵摡牯=
		$a_01_2 = {75 73 75 61 72 69 6f 3d 00 } //01 00 
		$a_01_3 = {73 68 64 5f 66 69 73 69 63 6f 3d 00 } //01 00  桳彤楦楳潣=
		$a_01_4 = {73 68 64 5f 66 69 72 6d 77 61 72 65 3d 00 } //01 00  桳彤楦浲慷敲=
		$a_01_5 = {70 61 67 5f 69 6e 69 63 3d 00 } //00 00  慰彧湩捩=
	condition:
		any of ($a_*)
