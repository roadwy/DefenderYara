...
rule TrojanSpy_Win32_Bancos_XJ{
	meta:
		description = "TrojanSpy:Win32/Bancos.XJ,SIGNATURE_TYPE_PEHSTR_EXT,04 00 04 00 04 00 00 01 00 "
		
	strings :
		$a_03_0 = {31 43 6c 69 63 6b 13 00 90 02 08 49 6d 61 67 65 90 10 03 00 43 6c 69 63 6b 90 00 } //01 00 
		$a_00_1 = {62 6b 6c 63 6f 6d 2e 64 6c 6c 5f 61 72 71 75 69 76 6f 73 } //01 00  bklcom.dll_arquivos
		$a_00_2 = {73 65 6e 68 61 20 64 65 20 61 63 65 73 73 6f } //01 00  senha de acesso
