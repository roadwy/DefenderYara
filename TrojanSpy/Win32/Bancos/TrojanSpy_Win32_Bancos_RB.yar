...
rule TrojanSpy_Win32_Bancos_RB{
	...
	strings :
		$a_00_0 = {62 72 61 64 65 73 63 6f 20 6e 65 74 20 65 6d 70 72 65 73 61 } //01 00 
		$a_00_1 = {3a 2f 2f 25 73 3a 25 64 2f 25 73 3f 55 49 44 3d 25 73 3b 50 57 44 3d 25 73 } //01 00 
