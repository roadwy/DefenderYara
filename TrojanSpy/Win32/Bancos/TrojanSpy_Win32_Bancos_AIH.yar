...
rule TrojanSpy_Win32_Bancos_AIH{
	...
	strings :
		$a_01_0 = {2f 00 62 00 6c 00 75 00 65 00 6d 00 61 00 6e 00 73 00 70 00 69 00 6c 00 6c 00 2e 00 63 00 6f 00 6d 00 2f 00 6d 00 65 00 64 00 69 00 61 00 2f 00 73 00 79 00 73 00 74 00 65 00 6d 00 2f 00 6a 00 73 00 2f 00 72 00 6f 00 62 00 6c 00 65 00 2f 00 } //01 00 
