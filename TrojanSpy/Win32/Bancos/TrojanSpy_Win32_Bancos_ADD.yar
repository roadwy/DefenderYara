...
rule TrojanSpy_Win32_Bancos_ADD{
	...
	strings :
		...
		$a_03_5 = {6e 76 70 5f 62 75 5f 73 65 6e 64 00 90 02 40 72 65 64 69 72 5f 67 6d 61 69 6c 00 90 00 } //1
		...
		$a_03_8 = {2f 00 6d 00 61 00 69 00 6c 00 2f 00 68 00 2f 00 90 02 10 2f 00 3f 00 76 00 3d 00 62 00 26 00 70 00 76 00 3d 00 74 00 6c 00 26 00 63 00 73 00 3d 00 62 00 90 00 } //1
	condition:
