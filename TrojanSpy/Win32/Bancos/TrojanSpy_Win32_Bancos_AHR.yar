...
rule TrojanSpy_Win32_Bancos_AHR{
	...
	strings :
		...
		$a_01_1 = {2f 49 4d 20 69 65 78 70 6c 6f 72 65 2e 65 78 65 20 2f 46 } //01 00  /IM iexplore.exe /F
		...
		$a_01_5 = {73 6d 74 70 73 2e 75 6f 6c 2e 63 6f 6d 2e 62 72 } //00 00  smtps.uol.com.br
	condition:
		any of ($a_*)
