...
rule TrojanSpy_Win32_Bancos_AHQ{
	...
	strings :
		...
		$a_00_1 = {5c 00 41 00 4b 00 3a 00 5c 00 6e 00 6e 00 6e 00 6e 00 63 00 5c 00 50 00 5f 00 52 00 65 00 61 00 6c 00 54 00 41 00 43 00 50 00 2e 00 76 00 62 00 70 00 } //01 00  \AK:\nnnnc\P_RealTACP.vbp
		$a_01_2 = {45 72 72 6f 72 00 46 75 6e 63 5f 50 6f 73 74 6f } //01 00  牅潲r畆据偟獯潴
