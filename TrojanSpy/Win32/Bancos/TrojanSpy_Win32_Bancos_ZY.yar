...
rule TrojanSpy_Win32_Bancos_ZY{
	...
	strings :
		...
		$a_00_1 = {65 64 74 73 65 6e 68 61 } //01 00  edtsenha
		$a_00_2 = {70 6e 6c 62 62 70 61 73 73 } //01 00  pnlbbpass
		$a_00_3 = {73 65 6e 64 6d 61 69 6c } //01 00  sendmail
		$a_00_4 = {74 61 73 6b 6b 69 6c 6c 2e 65 78 65 20 2d 66 20 2d 69 6d } //00 00  taskkill.exe -f -im
	condition:
		any of ($a_*)
