...
rule TrojanSpy_Win32_Bancos_AHG{
	...
	strings :
		...
		$a_03_1 = {43 6f 6e 73 65 6e 74 50 72 6f 6d 70 74 42 65 68 61 76 69 6f 72 41 64 6d 69 6e 00 90 02 10 45 6e 61 62 6c 65 4c 55 41 00 90 00 } //1
		...
		$a_02_5 = {03 c7 b9 ff 00 00 00 99 f7 f9 8b da 3b 75 f0 7d 90 01 01 46 eb 90 01 01 be 01 00 00 00 8b 45 e8 0f b6 44 30 ff 33 d8 8d 45 cc 50 89 5d d0 c6 45 d4 00 8d 55 d0 90 00 } //1
	condition:
