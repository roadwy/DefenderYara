...
rule TrojanSpy_Win32_Bancos_Lowfi{
	...
	strings :
		...
		$a_01_1 = {2e 00 63 00 6f 00 6d 00 2e 00 62 00 72 00 2f 00 } //01 00 
		$a_01_2 = {6d 00 69 00 72 00 63 00 6f 00 73 00 6f 00 66 00 74 00 } //01 00 
		$a_01_3 = {42 00 61 00 6e 00 6b 00 } //00 00 
