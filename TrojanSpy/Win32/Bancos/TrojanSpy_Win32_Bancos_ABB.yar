...
rule TrojanSpy_Win32_Bancos_ABB{
	...
	strings :
		$a_01_0 = {43 3a 5c 41 72 71 75 69 76 6f 73 20 64 65 20 50 72 6f 67 72 61 6d 61 73 5c 47 62 70 6c 75 67 69 6e } //01 00 
		...
		$a_01_2 = {53 65 6e 68 61 20 69 6e 74 65 72 6e 65 74 3a } //01 00 
		$a_01_3 = {41 72 6d 61 7a 65 6e 61 } //00 00 
	condition:
		any of ($a_*)
