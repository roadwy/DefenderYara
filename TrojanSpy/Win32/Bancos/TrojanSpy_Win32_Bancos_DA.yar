...
rule TrojanSpy_Win32_Bancos_DA{
	...
	strings :
		...
		$a_02_9 = {57 69 6e 64 6f 77 73 20 4c 69 76 65 20 4d 65 73 73 65 6e 67 65 72 00 00 57 69 6e 64 6f 77 73 20 4c 69 76 65 20 4d 65 73 73 65 6e 67 65 72 20 90 02 09 25 43 53 00 43 3a 5c 57 69 6e 64 6f 77 73 5c 6c 6f 67 2e 74 78 74 90 00 } //1
		$a_02_10 = {63 3a 5c 77 69 6e 64 6f 77 73 5c 6c 6f 67 2e 74 78 74 90 02 0a 5c 6c 6f 67 2e 74 78 74 90 00 } //1
		$a_02_11 = {3a 5c 44 6f 63 75 6d 65 6e 74 73 20 61 6e 64 20 53 65 74 74 69 6e 67 73 5c 90 02 0c 5c 43 6f 6e 74 61 63 74 73 5c 90 02 0c 44 65 73 6b 74 6f 70 2e 69 6e 69 90 00 } //1
	condition:
