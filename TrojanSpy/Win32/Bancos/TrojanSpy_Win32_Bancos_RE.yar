...
rule TrojanSpy_Win32_Bancos_RE{
	...
	strings :
		...
		$a_02_2 = {c7 85 78 ff ff ff 08 00 00 00 8d 85 74 ff ff ff 50 8d 4d a8 51 8d 95 78 ff ff ff 52 8d 45 98 50 ff 15 90 01 04 50 8d 4d cc 51 ff 15 90 01 04 50 68 90 01 04 8b 55 08 8b 02 8b 4d 08 51 ff 90 90 f8 06 00 00 90 00 } //2
	condition:
