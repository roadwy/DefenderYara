...
rule TrojanSpy_Win32_Bancos_PH{
	...
	strings :
		...
		$a_03_1 = {20 20 63 61 69 78 61 2e 63 6f 6d 2e 62 72 90 02 25 90 10 03 00 2e 90 10 03 00 2e 90 10 03 00 2e 90 10 03 00 20 20 77 77 77 2e 63 65 66 2e 63 6f 6d 2e 62 72 90 02 25 90 1b 01 2e 90 1b 02 2e 90 1b 03 2e 90 1b 04 90 00 } //1
