...
rule TrojanSpy_Win32_Bancos_LL{
	...
	strings :
		$a_00_0 = {52 43 50 54 20 54 4f 3a 3c } //01 00  RCPT TO:<
		$a_00_1 = {3d 5f 4e 65 78 74 50 61 72 74 5f 32 72 66 6b 69 6e 64 79 73 61 64 76 6e 71 77 33 6e 65 72 61 73 64 66 } //01 00  =_NextPart_2rfkindysadvnqw3nerasdf
