...
rule TrojanSpy_Win32_Bancos_NV{
	...
	strings :
		...
		$a_01_2 = {62 00 72 00 61 00 64 00 65 00 73 00 63 00 6f 00 } //01 00 
		$a_01_3 = {63 00 61 00 69 00 78 00 61 00 } //01 00 
		$a_01_4 = {73 00 61 00 6e 00 74 00 61 00 6e 00 64 00 65 00 72 00 } //00 00 
	condition:
		any of ($a_*)
