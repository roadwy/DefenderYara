...
rule TrojanSpy_Win32_Bancos_AGB{
	...
	strings :
		...
		$a_00_1 = {26 26 20 63 64 20 3e 20 25 73 67 65 74 70 61 74 68 2e 74 78 74 20 26 26 20 65 78 69 74 } //01 00 
		...
		$a_00_3 = {75 73 65 72 5f 70 72 65 66 28 22 6e 65 74 77 6f 72 6b 2e 70 72 6f 78 79 2e 74 79 70 65 22 2c 20 32 29 3b } //00 00 
	condition:
		any of ($a_*)
