...
rule TrojanSpy_Win32_Bancos_BX{
	...
	strings :
		...
		$a_00_3 = {40 67 6d 61 69 6c 2e 63 6f 6d } //05 00 
		$a_01_4 = {0c 54 46 5f 50 52 49 4e 43 49 50 41 4c } //02 00 
		$a_01_5 = {49 74 61 75 7a 69 6e 68 6f 70 61 73 } //02 00 
		$a_01_6 = {4d 45 44 49 44 4f 52 5f 54 45 4d 50 4f } //02 00 
		$a_01_7 = {43 4f 4d 50 4f 4e 45 4e 54 45 5f 45 4e 56 49 41 52 } //00 00 
	condition:
		any of ($a_*)
