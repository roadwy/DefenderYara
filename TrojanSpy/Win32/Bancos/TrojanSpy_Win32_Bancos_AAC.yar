...
rule TrojanSpy_Win32_Bancos_AAC{
	...
	strings :
		$a_01_0 = {54 00 54 00 57 00 4f 00 42 00 52 00 4f 00 } //01 00 
		$a_01_1 = {54 74 77 6f 62 72 6f 06 74 77 6f 62 72 6f } //01 00 
		$a_01_2 = {4d 00 61 00 69 00 6e 00 5a 00 69 00 6f 00 6e 00 } //32 00 
