...
rule TrojanSpy_Win32_Bancos_AAC{
	...
	strings :
		...
		$a_03_3 = {66 ba bf 07 b8 90 01 04 e8 90 01 04 8d 90 01 02 66 ba bf 07 b8 90 01 04 e8 90 01 04 8d 90 01 02 66 ba bf 07 b8 90 01 04 e8 90 01 04 8d 90 00 } //50
		$a_03_4 = {c1 eb 08 66 33 cb 66 90 02 19 66 69 c0 01 d2 66 05 6a 7f 66 90 00 } //50
		$a_03_5 = {c1 e9 08 66 33 d1 66 90 02 14 66 69 c6 01 d2 66 05 6a 7f 90 00 } //50
	condition:
