...
rule TrojanSpy_Win32_Bancos_gen_A{
	...
	strings :
		...
		$a_01_5 = {2d 73 65 6e 68 61 2d } //01 00 
		$a_01_6 = {43 61 69 78 61 } //00 00 
	condition:
		any of ($a_*)
...
rule TrojanSpy_Win32_Bancos_gen_A_2{
	...
	strings :
		$a_01_0 = {5c 53 6f 66 74 77 61 72 65 5c 4d 69 63 72 6f 73 6f 66 74 5c 57 69 6e 64 6f 77 73 5c 43 75 72 72 65 6e 74 56 65 72 73 69 6f 6e 5c 52 75 6e } //01 00 
		$a_01_1 = {42 6f 63 61 6c 20 4d 61 6c 20 58 20 4d 61 6c 20 4d 20 44 4f 49 44 4f } //01 00 
		$a_01_2 = {53 65 6e 68 61 } //01 00 
		$a_01_3 = {5b 42 42 5d 3d 2d 3d 2d } //01 00 
		$a_01_4 = {5b 73 70 63 5d 3d 2d 3d 2d 3d } //01 00 
		$a_01_5 = {53 79 6d 61 6e 74 65 63 20 41 6e 74 69 20 56 69 72 75 73 } //01 00 
		$a_01_6 = {4e 6f 72 74 6f 6e 20 53 79 73 74 65 6d 57 6f 72 6b 73 } //01 00 
...
rule TrojanSpy_Win32_Bancos_gen_A_3{
	...
	strings :
		...
		$a_01_1 = {53 4f 46 54 57 41 52 45 5c 4d 49 43 52 4f 53 4f 46 54 5c 4d 53 20 53 45 54 55 50 20 28 41 43 4d 45 29 5c 00 } //01 00 
		...
		$a_01_5 = {42 61 6e 63 6f 44 4f 42 72 61 73 69 6c 00 } //01 00 
