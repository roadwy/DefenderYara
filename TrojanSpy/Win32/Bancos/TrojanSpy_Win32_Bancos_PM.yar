...
rule TrojanSpy_Win32_Bancos_PM{
	...
	strings :
		$a_03_0 = {8b f0 85 f6 7e 2c bb 01 00 00 00 8d 45 f4 8b 55 fc 0f b6 54 1a ff 2b d3 81 ea 90 01 04 e8 90 01 03 ff 8b 55 f4 8d 45 f8 e8 90 01 03 ff 43 4e 75 d9 90 00 } //3
