...
rule TrojanSpy_Win32_Bancos_PM{
	...
	strings :
		...
		$a_01_1 = {5f 4e 65 78 74 50 61 72 74 5f 32 72 66 6b 69 6e } //01 00  _NextPart_2rfkin
		$a_01_2 = {41 74 65 6e 64 69 6d 65 6e 74 6f 41 6f 43 6c 69 65 6e 74 65 } //00 00  AtendimentoAoCliente
	condition:
		any of ($a_*)
