...
rule TrojanSpy_Win32_Bancos_EF{
	...
	strings :
		...
		$a_01_2 = {76 65 69 73 20 6e 6f 20 4d 6f 6d 65 6e 74 6f 21 } //01 00  veis no Momento!
		$a_01_3 = {2e 6f 72 67 2f 6f 70 65 6e 2e 6a 70 67 } //01 00  .org/open.jpg
		$a_01_4 = {53 43 5f 50 4c 55 47 5f 42 54 54 5f 32 } //00 00  SC_PLUG_BTT_2
	condition:
		any of ($a_*)
