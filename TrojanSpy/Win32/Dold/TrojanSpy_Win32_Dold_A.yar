...
rule TrojanSpy_Win32_Dold_A{
	...
	strings :
		$a_03_0 = {0f b7 fb 8b 55 00 0f b6 54 3a ff 0f b7 ce c1 e9 08 32 d1 88 54 38 ff 8b 04 24 0f b6 44 38 ff 66 03 f0 66 0f af 35 90 01 04 66 03 35 90 01 04 43 66 ff 4c 24 04 75 c0 90 00 } //10
