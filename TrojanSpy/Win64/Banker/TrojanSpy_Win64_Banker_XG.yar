...
rule TrojanSpy_Win64_Banker_XG{
	...
	strings :
		$a_03_0 = {8b 4c 24 60 81 f1 90 01 02 00 00 3b c1 75 0b 90 09 05 00 e8 90 00 } //1
		$a_03_1 = {0f b7 04 48 83 f0 90 01 01 48 8b 4c 24 90 01 01 48 8b 54 24 90 01 01 66 89 04 51 eb 90 00 } //1
