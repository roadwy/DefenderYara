...
rule _PseudoThreat_c0000b81{
	meta:
		description = "!PseudoThreat_c0000b81,SIGNATURE_TYPE_PEHSTR_EXT,1e 00 19 00 0d 00 00 "
	...
	strings :
		...
		$a_02_5 = {43 3a 5c 57 49 4e 44 4f 57 53 5c 53 59 53 54 45 4d 33 32 5c 90 02 08 2e 64 6c 6c 2c 77 69 6e 64 6f 77 73 90 00 } //5
