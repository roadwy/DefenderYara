...
rule MonitoringTool_MSIL_Auxlogger{
	...
	strings :
		...
		$a_03_4 = {06 02 08 6f 90 01 01 00 00 0a 28 90 01 01 00 00 0a 1b 58 28 90 01 01 00 00 0a 28 90 01 01 00 00 0a 28 90 01 01 00 00 0a 0a 08 17 58 0c 08 09 31 d9 90 00 } //1
	condition:
