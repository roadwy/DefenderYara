...
rule MonitoringTool_Win64_AwardKeylogger{
	...
	strings :
		...
		$a_03_2 = {80 7b 10 aa 74 08 c6 04 25 00 00 00 00 78 44 8b 44 24 90 01 01 48 8b 54 24 90 01 01 48 8b cb e8 90 01 04 b2 20 48 8b cb e8 90 01 04 80 7b 10 aa 74 08 c6 04 25 00 00 00 00 78 90 00 } //1
	condition:
