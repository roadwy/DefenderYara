...
rule MonitoringTool_AndroidOS_OTSpy_B_MTB{
	...
	strings :
		...
		$a_03_4 = {63 6f 6d 2e 90 01 03 2e 72 65 6d 6f 74 65 73 65 63 75 72 69 74 79 90 00 } //1
	condition:
...
rule MonitoringTool_AndroidOS_OTSpy_B_MTB_2{
	...
	strings :
		...
		$a_03_4 = {4c 63 6f 6d 2f 90 02 04 6c 61 64 69 65 73 63 68 69 6c 64 70 72 6f 74 65 63 74 69 6f 6e 2f 61 63 74 69 76 69 74 69 65 73 90 00 } //5
