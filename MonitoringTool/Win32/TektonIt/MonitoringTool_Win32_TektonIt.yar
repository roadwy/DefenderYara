...
rule MonitoringTool_Win32_TektonIt_2{
	...
	strings :
		...
		$a_03_1 = {b8 10 80 40 00 a3 90 01 04 b8 30 80 40 00 a3 90 01 04 b8 90 01 02 40 00 a3 90 01 04 b8 10 14 40 00 a3 90 01 04 a0 60 80 40 00 a2 90 01 04 c3 90 00 } //1
	condition:
