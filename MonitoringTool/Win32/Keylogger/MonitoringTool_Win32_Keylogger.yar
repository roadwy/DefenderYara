...
rule MonitoringTool_Win32_Keylogger{
	...
	strings :
		...
		$a_01_2 = {5b 53 48 49 46 54 5d } //01 00 
		$a_01_3 = {5b 43 4f 4e 54 52 4f 4c 5d } //01 00 
		$a_01_4 = {5b 42 41 43 4b 53 50 41 43 45 5d } //01 00 
		$a_00_5 = {4c 4f 47 2e 74 78 74 00 } //01 00 
