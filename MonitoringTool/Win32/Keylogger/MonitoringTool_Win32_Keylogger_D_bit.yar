...
rule MonitoringTool_Win32_Keylogger_D_bit{
	...
	strings :
		$a_03_0 = {00 54 6f 6e 67 4b 65 79 4c 6f 67 67 65 72 [0-20] 53 4d 54 50 } //1
		...
		$a_03_3 = {7b 42 61 63 6b 73 70 61 63 65 7d [0-10] 7b 45 6e 74 65 72 7d [0-10] 7b 53 70 61 63 65 7d [0-10] 7b 50 72 69 6e 74 20 53 63 72 65 65 6e 7d [0-10] 7b 53 63 72 6f 6c 6c 20 4c 6f 63 6b 7d } //1
	condition:
