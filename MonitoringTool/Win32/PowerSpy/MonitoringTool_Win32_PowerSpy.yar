...
rule MonitoringTool_Win32_PowerSpy{
	...
	strings :
		$a_02_0 = {5c 00 65 00 6d 00 78 00 66 00 69 00 6c 00 65 00 2e 00 65 00 6d 00 78 00 90 02 20 69 00 6e 00 69 00 2e 00 69 00 6e 00 69 00 90 00 } //1
		$a_03_1 = {6a 65 8d 45 90 01 01 50 ff d6 6a 6d 8d 90 01 05 51 ff d6 6a 78 8d 90 01 05 52 ff d6 6a 70 8d 90 01 05 50 ff d6 6a 73 8d 90 01 05 51 ff d6 6a 74 8d 90 01 05 52 ff d6 6a 6d 8d 90 01 05 50 ff d6 6a 70 90 00 } //1
	condition:
...
rule MonitoringTool_Win32_PowerSpy_2{
	...
	strings :
		...
		$a_02_1 = {61 00 70 00 70 00 69 00 6e 00 69 00 2e 00 69 00 6e 00 69 00 90 02 20 75 00 73 00 72 00 2e 00 69 00 6e 00 69 00 90 02 20 5c 00 65 00 6d 00 78 00 66 00 69 00 6c 00 65 00 90 00 } //1
		$a_02_2 = {63 00 6c 00 64 00 72 00 44 00 61 00 74 00 65 00 3d 00 23 00 90 02 20 5c 00 65 00 6d 00 78 00 70 00 73 00 74 00 6d 00 70 00 66 00 69 00 6c 00 65 00 2e 00 65 00 6d 00 78 00 90 00 } //1
	condition:
