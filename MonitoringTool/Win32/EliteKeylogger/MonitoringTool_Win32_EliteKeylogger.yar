...
rule MonitoringTool_Win32_EliteKeylogger{
	...
	strings :
		$a_00_0 = {49 6e 76 69 73 69 62 6c 65 20 6d 6f 64 65 } //01 00  Invisible mode
		$a_00_1 = {53 6f 66 74 77 61 72 65 5c 57 69 64 65 53 74 65 70 5c 45 6c 69 74 65 4b 65 79 6c 6f 67 67 65 72 } //01 00  Software\WideStep\EliteKeylogger
