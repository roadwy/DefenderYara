...
rule MonitoringTool_Win32_SpyLanternKeylogger{
	...
	strings :
		$a_01_0 = {4c 6f 67 20 46 69 6c 65 73 20 28 2a 2e 6c 74 72 29 } //02 00 
		$a_01_1 = {69 00 73 00 5f 00 6c 00 6f 00 63 00 61 00 6c 00 73 00 70 00 79 00 } //02 00 
		$a_01_2 = {53 70 79 64 65 78 2c 20 49 6e 63 2e } //02 00 
		$a_01_3 = {72 65 70 6f 72 74 5f 6b 65 79 5f 62 6f 74 74 6f 6d 2e 74 65 6d 70 6c } //00 00 
	condition:
		any of ($a_*)
...
rule MonitoringTool_Win32_SpyLanternKeylogger_2{
	...
	strings :
		...
		$a_01_1 = {67 61 74 65 77 61 79 2e 6d 65 73 73 65 6e 67 65 72 2e 68 6f 74 6d 61 69 6c 2e 63 6f 6d } //01 00 
		$a_01_2 = {72 6b 5f 63 74 72 6c 5f 6e 6f 69 64 6c 65 33 32 } //01 00 
		$a_01_3 = {5f 5f 49 54 53 4e 4f 54 52 4f 4f 4d 5f 5f } //00 00 
	condition:
		any of ($a_*)
