...
rule MonitoringTool_Win32_Beyond{
	...
	strings :
		...
		$a_03_3 = {33 c6 44 24 90 01 01 32 c6 44 24 90 01 01 2e c6 44 24 90 01 01 64 90 00 } //2
		$a_03_4 = {b3 61 b2 65 50 51 c6 45 90 01 01 44 c6 45 90 01 01 69 c6 45 90 01 01 73 90 00 } //2
		$a_01_5 = {b2 65 b1 72 b3 61 b0 6c 88 55 } //2
		$a_03_6 = {48 c6 44 24 90 01 01 6b c6 44 24 90 01 01 45 c6 44 24 90 01 01 78 c6 44 24 90 01 01 41 90 00 } //2
	condition:
