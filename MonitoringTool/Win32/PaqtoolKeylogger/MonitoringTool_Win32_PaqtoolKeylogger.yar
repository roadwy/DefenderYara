...
rule MonitoringTool_Win32_PaqtoolKeylogger{
	...
	strings :
		$a_00_0 = {44 6f 20 79 6f 75 20 72 65 61 6c 6c 79 20 77 61 6e 74 20 74 6f 20 63 6c 6f 73 65 20 50 61 71 20 4b 65 79 4c 6f 67 } //01 00  Do you really want to close Paq KeyLog
