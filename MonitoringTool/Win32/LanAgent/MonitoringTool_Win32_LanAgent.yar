...
rule MonitoringTool_Win32_LanAgent{
	...
	strings :
		$a_02_0 = {6b 65 79 2e 64 61 74 00 ff ff ff ff 0f 00 00 00 73 63 72 65 65 6e 73 68 6f 74 73 2e 64 61 74 00 90 02 08 ff ff ff ff 07 00 00 00 61 70 70 2e 64 61 74 00 ff ff ff ff 0d 00 00 00 63 6c 69 70 62 6f 61 72 64 2e 64 61 74 00 00 00 ff ff ff ff 08 00 00 00 70 72 6e 74 2e 64 61 74 90 00 } //10
