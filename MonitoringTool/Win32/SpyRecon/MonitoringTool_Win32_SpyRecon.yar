...
rule MonitoringTool_Win32_SpyRecon{
	...
	strings :
		$a_01_0 = {57 69 6e 43 62 74 2e 64 6c 6c } //01 00 
		$a_01_1 = {53 65 74 57 69 6e 64 6f 77 73 48 6f 6f 6b 45 78 41 } //01 00 
		$a_01_2 = {5c 57 69 6e 43 62 74 5c 52 65 6c 65 61 73 65 5c 57 69 6e 43 62 74 2e 70 64 62 } //00 00 
	condition:
		any of ($a_*)
...
rule MonitoringTool_Win32_SpyRecon_2{
	...
	strings :
		...
		$a_01_2 = {31 2d 53 70 79 20 4d 6f 6e 69 74 6f 72 00 } //01 00 
