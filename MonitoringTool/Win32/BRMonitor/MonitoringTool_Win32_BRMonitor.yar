...
rule MonitoringTool_Win32_BRMonitor{
	...
	strings :
		$a_00_0 = {52 65 6c 61 74 6f 72 69 6f 2e 68 74 6d } //01 00  Relatorio.htm
		$a_00_1 = {4d 53 4e 4d 6f 6e 53 6e 69 66 66 65 72 4d 65 73 73 61 67 65 } //01 00  MSNMonSnifferMessage
