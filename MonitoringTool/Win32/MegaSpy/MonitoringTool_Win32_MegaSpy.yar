...
rule MonitoringTool_Win32_MegaSpy{
	...
	strings :
		...
		$a_01_2 = {64 6f 20 4d 65 67 61 2d 53 70 79 20 65 78 70 69 72 6f 75 } //01 00  do Mega-Spy expirou
		$a_01_3 = {4d 65 67 61 2d 53 70 79 20 6e 6f 76 61 6d 65 6e 74 65 20 75 74 69 6c 69 7a 65 } //00 00  Mega-Spy novamente utilize
	condition:
		any of ($a_*)
