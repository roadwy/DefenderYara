...
rule MonitoringTool_Win32_Ardamax{
	...
	strings :
		...
		$a_02_1 = {56 85 c9 74 0b 8b 71 44 3b 35 ?? ?? ?? ?? 74 0c 8b 31 85 f6 74 12 } //1
	condition:
...
rule MonitoringTool_Win32_Ardamax_2{
	...
	strings :
		...
		$a_02_2 = {55 8b ec 51 51 56 57 68 ?? ?? 00 10 33 ff 57 ff 15 ?? ?? 00 10 3b c7 74 0e 57 57 68 65 80 00 00 50 ff 15 } //2
	condition:
...
rule MonitoringTool_Win32_Ardamax_6{
	...
	strings :
		...
		$a_00_2 = {5a 77 51 75 65 72 79 53 79 73 74 65 6d 49 6e 66 6f 72 6d 61 74 69 6f 6e } //2 ZwQuerySystemInformation
		$a_01_3 = {2e 30 30 37 00 48 6f 6f 6b 00 55 6e 68 6f 6f 6b 00 } //2
		$a_02_4 = {68 48 20 00 10 68 3c 20 00 10 ff 15 14 20 00 10 50 ff 15 10 20 00 10 85 c0 a3 34 30 00 10 74 5b 56 be 14 30 00 10 56 ff 15 08 20 00 10 6a 00 6a 06 68 2c 30 00 10 ff 35 34 30 00 10 6a ff ff 15 0c 20 00 10 6a 00 6a 06 68 0c 30 00 10 ff 35 34 30 00 10 [0-30] c6 05 0c 30 00 10 68 } //2
	condition:
...
rule MonitoringTool_Win32_Ardamax_7{
	...
	strings :
		...
		$a_00_2 = {5a 77 51 75 65 72 79 53 79 73 74 65 6d 49 6e 66 6f 72 6d 61 74 69 6f 6e } //2 ZwQuerySystemInformation
		$a_01_3 = {2e 30 30 37 00 48 6f 6f 6b 00 55 6e 68 6f 6f 6b 00 } //2
		$a_02_4 = {68 4c 20 00 10 68 40 20 00 10 ff 15 18 20 00 10 50 ff 15 14 20 00 10 85 c0 a3 34 30 00 10 74 5d 56 be 14 30 00 10 56 ff 15 08 20 00 10 6a 00 6a 06 68 2c 30 00 10 ff 35 34 30 00 10 6a ff ff 15 10 20 00 10 6a 00 6a 06 68 0c 30 00 10 ff 35 34 30 00 10 [0-30] c6 05 0c 30 00 10 68 } //2
	condition:
		((#a_01_0  & 1)*2+(#a_01_1  & 1)*2+(#a_00_2  & 1)*2+(#a_01_3  & 1)*2+(#a_02_4  & 1)*2) >=10
...
rule MonitoringTool_Win32_Ardamax_9{
	...
	strings :
		$a_01_0 = {2e 3f 41 56 43 50 61 73 73 77 6f 72 64 45 6e 74 65 72 44 6c 67 40 40 } //-100 .?AVCPasswordEnterDlg@@
		$a_01_1 = {fa ee c2 99 ea 44 7c 06 } //1
		$a_03_2 = {ff 76 04 ff 36 ff 75 08 e8 ?? ?? ?? ?? 83 c4 0c ff 76 04 8b ce ff 75 08 e8 ?? ?? ?? ?? 90 90 90 90 90 90 90 90 90 90 90 90 90 90 90 90 5e 5d c2 04 00 } //1
...
rule MonitoringTool_Win32_Ardamax_10{
	...
	strings :
		...
		$a_03_2 = {22 6c 7a 6d 61 2e 65 78 65 22 20 22 64 22 20 22 ?? 2e 6c 7a 22 20 22 (41 4b 56|52 45 46) 2e 65 78 65 22 } //1
...
rule MonitoringTool_Win32_Ardamax_11{
	...
	strings :
		...
		$a_03_3 = {46 46 50 66 8b 46 44 66 03 85 ?? ?? ff ff 0f b7 c0 50 53 ff 15 ?? ?? ?? ?? 89 85 e4 fd ff ff 3b c3 0f 84 ?? ?? 00 00 50 53 ff 15 ?? ?? ?? ?? 3b c3 0f 84 cb 01 00 00 50 ff 15 ?? ?? ?? ?? 89 85 ?? ?? ff ff 3b c3 0f 84 ?? ?? 00 00 ff b5 ?? ?? ff ff 53 ff 15 ?? ?? ?? ?? 03 f8 89 85 ?? ?? ff ff 57 39 9d ?? ?? ff ff 74 0e ff b5 ?? ?? ff ff e8 ?? ?? ?? ?? 59 } //1
	condition:
...
rule MonitoringTool_Win32_Ardamax_12{
	...
	strings :
		$a_02_0 = {55 8b ec 83 7d 08 00 75 16 f7 45 10 00 00 00 80 75 0d ff 75 10 ff 75 0c e8 ?? ?? ?? ?? 59 59 ff 75 10 ff 75 0c ff 75 08 ff 35 ?? ?? ?? ?? ff 15 ?? ?? ?? ?? 5d c2 0c 00 } //3
...
rule MonitoringTool_Win32_Ardamax_13{
	...
	strings :
		...
		$a_03_5 = {8a 54 0d fc 03 c6 30 10 41 46 3b 75 0c 72 e7 5e c9 c2 08 00 90 09 1f 00 55 8b ec 51 56 33 c9 33 f6 c7 45 fc ?? ?? ?? ?? 39 4d 0c 76 19 83 f9 04 72 02 33 c9 8b 45 08 } //100
		...
		$a_03_7 = {46 46 50 66 8b 46 44 66 03 85 ?? ?? ff ff 0f b7 c0 50 53 ff 15 ?? ?? ?? ?? 89 85 e4 fd ff ff 3b c3 0f 84 ?? ?? 00 00 50 53 ff 15 ?? ?? ?? ?? 3b c3 0f 84 cb 01 00 00 50 ff 15 ?? ?? ?? ?? 89 85 ?? ?? ff ff 3b c3 0f 84 ?? ?? 00 00 ff b5 ?? ?? ff ff 53 ff 15 ?? ?? ?? ?? 03 f8 89 85 ?? ?? ff ff 57 39 9d ?? ?? ff ff 74 0e ff b5 ?? ?? ff ff e8 ?? ?? ?? ?? 59 } //1
		$a_03_8 = {74 2e 68 04 01 00 00 ff 75 0c 68 ?? ?? ?? 01 ff d0 a1 ?? ?? ?? 01 85 c0 74 16 6a 00 ff 35 ?? ?? ?? 01 68 ?? ?? ?? 01 6a 04 ff d0 a3 ?? ?? ?? 01 90 90 90 90 90 09 11 00 90 90 90 90 8b 45 08 a3 ?? ?? ?? 01 a1 ?? ?? ?? 01 85 c0 } //1
		$a_03_9 = {71 0c 6a 02 eb 05 ff 71 0c 6a 01 ff 35 ?? ?? ?? 01 ff 35 ?? ?? ?? 01 ff 15 ?? ?? ?? 01 90 90 90 90 90 09 0f 00 90 90 90 90 8b 4d 08 8b 41 08 48 74 0a 48 75 1e ff } //1
	condition:
