...
rule MonitoringTool_Win32_FamilyKeylogger_2{
	...
	strings :
		...
		$a_03_1 = {63 3a 5c 74 65 6d 70 5c 74 65 6d 70 90 05 02 03 30 2d 39 2e 74 78 74 90 00 } //1
		$a_03_2 = {c7 05 0c 21 01 10 00 00 00 00 68 c0 a1 00 10 8d 8d 90 09 0e 00 80 bd 20 90 01 01 ff ff 0d 75 90 01 01 83 fb 01 75 90 01 13 fe ff ff 51 ff 15 14 a0 00 10 68 00 02 00 00 90 00 } //1
	condition:
