...
rule _PseudoThreat_4000002a{
	...
	strings :
		...
		$a_01_4 = {72 65 6c 65 61 73 65 00 } //01 00  敲敬獡e
		$a_01_5 = {7b 35 44 44 45 35 35 39 31 2d 41 38 41 42 2d 34 38 39 37 2d 39 33 45 46 2d 31 45 34 45 39 34 33 46 38 35 41 37 7d } //00 00  {5DDE5591-A8AB-4897-93EF-1E4E943F85A7}
	condition:
		any of ($a_*)
