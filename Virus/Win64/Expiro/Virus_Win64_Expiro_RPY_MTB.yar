...
rule Virus_Win64_Expiro_RPY_MTB{
	...
	strings :
		...
		$a_03_1 = {48 81 c7 00 04 00 00 48 81 c0 00 04 00 00 48 81 ff 00 c0 08 00 74 05 e9 90 01 02 ff ff 59 e8 90 01 02 ff ff 48 8b e5 5d 41 5f 41 5e 41 5d 41 5c 90 00 } //1
	condition:
