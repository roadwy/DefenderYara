...
rule Virus_Win64_Expiro_MF_bit{
	...
	strings :
		$a_03_0 = {4d 8b 4f 60 4d 8b 19 43 81 e3 df 00 df 00 4f 8b 49 0b 47 01 d9 43 c1 e9 02 41 90 02 06 4d 85 c9 90 00 } //1
		$a_03_1 = {45 8b 5d 00 41 90 02 06 47 89 1f 4b ff c9 4d ff c5 90 00 } //1
