...
rule Virus_Win32_Xorer_B{
	...
	strings :
		...
		$a_00_2 = {5c 7e 2e 65 78 65 } //01 00  \~.exe
		$a_00_3 = {30 33 37 35 38 39 2e 6c 6f 67 } //01 00  037589.log
		$a_00_4 = {5c 63 6f 6d 5c 6c 73 61 73 73 2e 65 78 65 } //01 00  \com\lsass.exe
