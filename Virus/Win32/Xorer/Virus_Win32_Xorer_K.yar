...
rule Virus_Win32_Xorer_K{
	...
	strings :
		$a_02_0 = {c2 10 00 68 90 01 03 00 6a 01 6a 00 ff 15 90 01 03 00 ff 15 90 01 03 00 3d b7 00 00 00 75 12 5f 5e 5d b8 01 00 00 00 5b 81 c4 90 01 02 00 00 c2 10 00 90 00 } //2
