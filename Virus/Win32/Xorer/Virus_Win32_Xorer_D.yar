...
rule Virus_Win32_Xorer_D{
	...
	strings :
		...
		$a_00_2 = {78 63 6e 62 6b 6a 77 65 72 } //01 00 
		$a_00_3 = {4d 53 49 43 54 46 49 4d 45 20 53 4d 53 53 } //01 00 
		...
		$a_00_5 = {4d 43 49 20 50 72 6f 67 72 61 6d 20 43 6f 6d 20 41 70 70 6c 69 63 61 74 69 6f 6e } //01 00 
