...
rule Virus_Win32_Viking_JF{
	...
	strings :
		...
		$a_00_8 = {46 69 6e 64 52 65 73 6f 75 72 63 65 41 } //01 00 
		$a_01_9 = {57 72 69 74 65 50 72 6f 63 65 73 73 4d 65 6d 6f 72 79 } //01 00 
		$a_00_10 = {57 4e 65 74 4f 70 65 6e 45 6e 75 6d 41 } //01 00 
		$a_00_11 = {57 4e 65 74 45 6e 75 6d 52 65 73 6f 75 72 63 65 41 } //01 00 
		$a_00_12 = {57 4e 65 74 43 6c 6f 73 65 45 6e 75 6d } //01 00 
		$a_00_13 = {57 4e 65 74 43 61 6e 63 65 6c 43 6f 6e 6e 65 63 74 69 6f 6e 41 } //01 00 
		$a_00_14 = {57 4e 65 74 43 61 6e 63 65 6c 43 6f 6e 6e 65 63 74 69 6f 6e 32 41 } //01 00 
		$a_01_15 = {57 4e 65 74 41 64 64 43 6f 6e 6e 65 63 74 69 6f 6e 32 41 } //00 00 
	condition:
		any of ($a_*)
