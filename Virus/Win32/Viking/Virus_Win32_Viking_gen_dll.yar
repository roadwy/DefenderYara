...
rule Virus_Win32_Viking_gen_dll{
	...
	strings :
		...
		$a_01_4 = {63 3a 5c 31 2e 74 78 74 } //01 00  c:\1.txt
		$a_01_5 = {64 33 3a 00 ff ff ff ff 03 } //01 00 
		$a_01_6 = {64 34 3a 00 ff ff ff ff 03 } //01 00 
		$a_01_7 = {41 43 44 53 65 65 34 2e 65 78 65 } //01 00  ACDSee4.exe
		$a_01_8 = {55 65 64 69 74 33 32 2e 65 78 65 } //01 00  Uedit32.exe
		$a_01_9 = {20 2f 68 65 68 65 } //00 00   /hehe
	condition:
		any of ($a_*)
