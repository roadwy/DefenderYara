...
rule Virus_Win32_Ursnif_gen_B{
	...
	strings :
		...
		$a_03_5 = {8b c3 2b c6 a9 fe ff ff ff 74 3f 56 ff 15 90 01 04 83 f8 02 74 05 83 f8 04 75 13 8d 45 f0 50 ff 75 ec ff 75 08 51 56 8b cf e8 90 01 04 8b 45 fc 8d 73 02 8d 9d ec fd ff ff 2b c6 6a 00 03 c3 5b d1 f8 85 c0 7f 9e eb 02 90 00 } //1
	condition:
