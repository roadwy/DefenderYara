...
rule Virus_Win32_Ursnif_gen_B{
	...
	strings :
		...
		$a_01_1 = {00 53 43 52 45 45 4e 53 48 4f 54 00 } //01 00 
		$a_01_2 = {2f 70 6b 69 2f 6d 73 63 6f 72 70 2f 63 72 6c 2f 4d 53 49 54 } //01 00 
		$a_01_3 = {63 00 6d 00 64 00 20 00 2f 00 43 00 20 00 22 00 64 00 72 00 69 00 76 00 65 00 72 00 71 00 75 00 65 00 72 00 79 00 2e 00 65 00 78 00 65 00 20 00 3e 00 3e 00 20 00 25 00 73 00 22 00 } //01 00 
		$a_01_4 = {2f 73 63 72 69 70 74 3f 75 3d } //01 00 
