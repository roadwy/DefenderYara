...
rule Virus_Win32_Ursnif_gen_C{
	meta:
		description = "Virus:Win32/Ursnif.gen!C,SIGNATURE_TYPE_PEHSTR_EXT,19 00 19 00 05 00 00 "
	...
	strings :
		...
		$a_01_3 = {61 74 74 72 69 62 20 2d 72 20 2d 73 20 2d 68 20 22 25 73 22 } //5 attrib -r -s -h "%s"
		$a_01_4 = {6d 69 6e 69 63 68 65 63 6b 3a 20 25 73 } //5 minicheck: %s
	condition:
