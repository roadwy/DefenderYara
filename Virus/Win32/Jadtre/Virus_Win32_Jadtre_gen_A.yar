...
rule Virus_Win32_Jadtre_gen_A{
	...
	strings :
		$a_03_0 = {8b ff 55 a1 90 01 04 83 c0 03 ff e0 90 00 } //1
		$a_03_1 = {83 c4 10 0f be 05 90 01 04 83 f8 92 75 16 90 00 } //1
		$a_03_2 = {c7 40 24 20 00 00 e0 8b 45 90 01 01 8b 0d 90 01 04 66 8b 09 66 89 48 22 90 00 } //2
