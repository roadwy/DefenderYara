...
rule Virus_Win32_Pavsee_gen_A{
	...
	strings :
		...
		$a_03_1 = {ff ff 66 c7 85 ?? ?? ff ff ?? ?? 66 c7 85 ?? ?? ff ff ?? ?? 66 89 b5 ?? ?? ff ff 8d bd fc ?? ?? ff f3 ab 59 66 c7 85 ?? ?? ff ff 77 00 66 c7 85 ?? ?? ff ff 77 00 66 c7 85 ?? ?? ff ff 77 00 66 89 95 ?? ?? ff ff } //1
	condition:
