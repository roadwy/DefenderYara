...
rule Virus_Win32_Gael_gen_A{
	...
	strings :
		$a_02_0 = {47 45 54 20 2f 76 78 39 2f 64 6c 2e 65 78 65 [0-12] 48 54 54 50 2f 31 2e 31 [0-12] 48 6f 73 74 3a [0-12] 75 74 65 6e 74 69 2e 6c 79 63 6f 73 2e 69 74 } //1
