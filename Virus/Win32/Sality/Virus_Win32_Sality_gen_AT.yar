...
rule Virus_Win32_Sality_gen_AT{
	...
	strings :
		$a_02_0 = {68 74 74 70 3a 2f 2f 6b 75 6b 75 90 02 0f 2e 69 6e 66 6f 90 00 } //1
		$a_02_1 = {2e 69 6e 66 6f 2f 68 6f 6d 65 2e 67 69 66 00 68 74 74 70 3a 2f 2f 90 02 15 2e 69 6e 66 6f 2f 68 6f 6d 65 2e 67 69 66 90 00 } //1
		$a_03_2 = {60 e8 00 00 00 00 90 17 08 01 01 01 01 01 01 01 01 58 59 5a 5b 5c 5d 5e 5f 81 90 01 05 90 17 08 01 01 01 01 01 01 01 01 50 51 52 53 54 55 56 57 90 02 10 c3 90 00 } //2
	condition:
