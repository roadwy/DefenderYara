...
rule Virus_Win32_Ridnu_gen_A{
	...
	strings :
		$a_00_0 = {4d 72 5f 43 6f 6f 6c 46 61 63 65 2e 73 63 72 } //01 00  Mr_CoolFace.scr
		$a_00_1 = {2e 70 69 66 20 2e 62 61 74 20 2e 63 6f 6d 20 2e 73 63 72 20 2e 65 78 65 } //01 00  .pif .bat .com .scr .exe
