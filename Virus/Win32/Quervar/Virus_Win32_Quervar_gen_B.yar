...
rule Virus_Win32_Quervar_gen_B{
	...
	strings :
		$a_01_0 = {5b 2d 2d 2d 71 72 6e 71 79 76 61 72 2d 2d 2d 5d } //1 [---qrnqyvar---]
		$a_01_1 = {5b 2b 2b 2b 73 63 61 72 66 61 63 65 2b 2b 2b 5d } //1 [+++scarface+++]
		$a_01_2 = {5b 2d 2d 2d 64 65 61 64 6c 69 6e 65 2d 2d 2d 5d } //1 [---deadline---]
		$a_03_3 = {03 cb 81 e1 ff 00 00 00 8b 1c 24 8a 1c 13 32 99 90 01 04 8b 4c 24 04 88 1c 11 42 48 75 ad 59 5a 5f 5e 5b c3 90 00 } //10
	condition:
...
rule Virus_Win32_Quervar_gen_B_2{
	meta:
		description = "Virus:Win32/Quervar.gen!B,SIGNATURE_TYPE_PEHSTR_EXT,03 00 03 00 03 00 00 "
