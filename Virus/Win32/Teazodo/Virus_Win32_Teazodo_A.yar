...
rule Virus_Win32_Teazodo_A{
	...
	strings :
		...
		$a_02_2 = {66 c7 86 d0 00 00 00 50 45 eb 0e 83 f8 90 01 01 75 09 66 c7 86 d8 00 00 00 50 45 90 00 } //2
		$a_02_3 = {80 38 c6 75 05 38 50 01 74 90 01 01 83 c1 01 83 c0 01 81 f9 80 00 00 00 72 e8 eb 90 00 } //2
		$a_02_4 = {6a 00 6a 18 ff 15 90 01 04 8b f0 85 f6 74 90 01 01 8b 54 24 90 01 01 8b 44 24 90 01 01 52 56 50 ff 15 90 00 } //2
