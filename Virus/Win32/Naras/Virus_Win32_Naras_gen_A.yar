...
rule Virus_Win32_Naras_gen_A{
	...
	strings :
		$a_00_0 = {50 45 5f 74 68 75 6e 6b 5f 69 6e 66 65 63 74 } //65526 PE_thunk_infect
		$a_02_1 = {e8 00 00 00 00 5b 81 eb 90 01 04 56 90 00 } //3
	...
	condition:
		((#a_00_0  & 1)*65526+(#a_02_1  & 1)*3+(#a_01_2  & 1)*3+(#a_01_3  & 1)*1+(#a_01_4  & 1)*1) >=7
