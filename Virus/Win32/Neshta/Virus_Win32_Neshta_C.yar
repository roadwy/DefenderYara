...
rule Virus_Win32_Neshta_C{
	...
	strings :
		...
		$a_01_1 = {44 65 6c 70 68 69 2d 74 68 65 20 62 65 73 74 2e 20 46 75 63 6b 20 6f 66 66 20 61 6c 6c 20 74 68 65 20 72 65 73 74 2e 20 4e 65 73 68 74 61 20 31 2e 30 20 4d 61 64 65 20 69 6e 20 42 65 6c 61 72 75 73 2e } //01 00 
		$a_01_2 = {42 65 73 74 20 72 65 67 61 72 64 73 20 32 20 54 6f 6d 6d 79 20 53 61 6c 6f 2e 20 5b 4e 6f 76 2d 32 30 30 35 5d 20 79 6f 75 72 73 20 5b 44 7a 69 61 64 75 6c 6a 61 20 41 70 61 6e 61 73 5d } //00 00 
	condition:
		any of ($a_*)
