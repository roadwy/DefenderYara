...
rule Virus_Win32_Downexec_gen_A{
	...
	strings :
		$a_03_0 = {25 00 00 ff ff 81 38 4d 5a 90 90 00 74 07 2d 00 10 00 00 eb 90 00 } //1
		$a_03_1 = {81 3f 47 65 74 50 75 90 01 01 8b df 83 c3 04 81 3b 72 6f 63 41 90 00 } //1
