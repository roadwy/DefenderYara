...
rule Virus_Linux_Rcrgood_gen_A{
	...
	strings :
		...
		$a_00_2 = {5b 34 30 39 36 5d 20 76 69 72 75 73 20 63 6f 64 65 64 20 62 79 20 62 61 64 43 52 43 20 69 6e 20 32 30 30 33 } //00 00  [4096] virus coded by badCRC in 2003
	condition:
		any of ($a_*)
