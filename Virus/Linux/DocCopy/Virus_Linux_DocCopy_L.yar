...
rule Virus_Linux_DocCopy_L{
	...
	strings :
		...
		$a_02_1 = {41 70 70 6c 69 63 61 74 69 6f 6e 2e 4f 72 67 61 6e 69 7a 65 72 43 6f 70 79 20 53 6f 75 72 63 65 3a 3d 90 02 10 44 65 73 74 69 6e 61 74 69 6f 6e 3a 3d 90 02 10 2c 20 6e 61 6d 65 3a 3d 22 44 61 72 6b 22 2c 90 00 } //1
	condition:
