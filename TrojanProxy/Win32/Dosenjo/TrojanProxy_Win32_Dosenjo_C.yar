...
rule TrojanProxy_Win32_Dosenjo_C{
	...
	strings :
		...
		$a_01_4 = {66 75 73 65 61 63 74 69 6f 6e 3d 73 69 74 65 73 65 61 72 63 68 2e 72 65 73 75 6c 74 73 } //1 fuseaction=sitesearch.results
		$a_01_5 = {3f 71 75 65 72 79 3d 00 2f 66 75 6c 6c 73 65 61 72 63 68 00 53 70 65 63 69 61 6c 3a 53 65 61 72 63 68 00 } //2
	condition:
