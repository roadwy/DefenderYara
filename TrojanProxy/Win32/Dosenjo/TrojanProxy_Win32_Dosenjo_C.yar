...
rule TrojanProxy_Win32_Dosenjo_C{
	...
	strings :
		...
		$a_01_3 = {42 55 46 42 55 46 20 4e 4f 54 20 45 4e 43 } //01 00 
		$a_01_4 = {66 75 73 65 61 63 74 69 6f 6e 3d 73 69 74 65 73 65 61 72 63 68 2e 72 65 73 75 6c 74 73 } //02 00 
