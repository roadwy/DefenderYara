...
rule TrojanProxy_Win32_Dosenjo_D{
	...
	strings :
		$a_03_0 = {ff ff 02 00 8b f4 6a 6e ff 15 90 01 04 3b f4 e8 90 01 04 66 89 85 90 01 02 ff ff c7 85 90 01 02 ff ff 00 00 00 00 8b f4 6a 10 8d 85 90 01 02 ff ff 50 8b 8d 90 01 02 ff ff 51 ff 15 90 00 } //2
		$a_03_1 = {b8 cc cc cc cc f3 ab a0 90 01 04 88 85 90 01 02 ff ff b9 90 01 04 33 c0 8d bd 90 01 02 ff ff f3 ab 66 ab aa 8b f4 6a 00 6a 21 8d 85 90 01 02 ff ff 50 6a 00 ff 15 90 00 } //2
