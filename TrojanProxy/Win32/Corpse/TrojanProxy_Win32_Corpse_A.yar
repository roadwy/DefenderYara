...
rule TrojanProxy_Win32_Corpse_A{
	meta:
		description = "TrojanProxy:Win32/Corpse.A,SIGNATURE_TYPE_PEHSTR_EXT,03 00 03 00 03 00 00 01 00 "
		
	strings :
		$a_03_0 = {81 c4 2c e4 ff ff 68 d4 1b 00 00 8d 85 2c e4 ff ff 50 e8 90 01 04 81 7d 08 36 36 36 36 0f 84 90 00 } //01 00 
		$a_01_1 = {6a 00 68 88 13 00 00 8d 85 a0 e9 ff ff 50 ff b5 2c fd ff ff e8 } //01 00 
