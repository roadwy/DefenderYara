...
rule TrojanProxy_Win32_Gondolox_A{
	...
	strings :
		...
		$a_03_1 = {53 75 62 6a 65 63 74 3a 20 25 73 0d 0a 90 02 08 25 73 90 02 06 50 4f 53 54 20 68 74 74 70 3a 2f 2f 25 73 25 73 20 48 54 54 50 2f 31 2e 31 0d 90 00 } //1
		...
		$a_03_4 = {0f b6 1c 39 0f b6 d2 69 d2 90 01 04 03 db 8d 2c 10 03 ed 33 dd 33 d8 81 c3 90 01 04 83 c1 01 3b ce 8b c3 72 90 01 01 8b 5c 24 14 5d 89 03 90 00 } //1
	condition:
