...
rule TrojanProxy_Win32_Prorat_gen_A{
	...
	strings :
		$a_00_0 = {61 74 6d 5f 64 55 52 4c 3d 68 74 74 70 3a 2f 2f } //01 00 
		$a_00_1 = {30 30 2d 64 37 62 66 2d 31 31 64 31 2d 39 39 34 37 2d 30 30 63 30 43 66 39 38 62 62 63 39 7d } //01 00 
		$a_00_2 = {5c 66 66 73 65 72 76 69 63 65 2e 65 } //01 00 
		$a_00_3 = {5c 64 5f 73 65 72 76 69 63 65 2e 65 } //02 00 
