...
rule TrojanProxy_Win32_Banker_AL{
	...
	strings :
		...
		$a_01_1 = {64 65 73 74 69 6e 61 74 61 72 69 6f 3d } //01 00  destinatario=
		$a_01_2 = {61 73 73 75 6e 74 6f 3d 49 6e 66 65 63 74 } //01 00  assunto=Infect
		$a_01_3 = {72 65 6d 65 74 65 6e 74 65 3d } //00 00  remetente=
	condition:
		any of ($a_*)
