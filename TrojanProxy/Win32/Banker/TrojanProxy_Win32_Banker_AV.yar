...
rule TrojanProxy_Win32_Banker_AV{
	...
	strings :
		$a_03_0 = {8b d0 83 e2 03 8a 92 90 01 02 40 00 30 14 38 40 83 f8 11 7c ec ba fd ff ff ff 2b d1 90 00 } //10
		...
		$a_03_2 = {83 e3 03 0f b6 9b 90 01 02 40 00 30 58 02 0f b6 09 30 48 03 0f b6 0f 30 48 04 83 c0 06 8d 0c 02 83 f9 12 7c 8a 90 00 } //10
