...
rule TrojanProxy_Win32_Banker_AW{
	...
	strings :
		...
		$a_03_4 = {ff ba 02 00 00 80 8b c3 e8 90 01 03 ff 33 c9 ba 90 01 02 50 00 8b c3 e8 90 01 03 ff 8b 4d fc ba 90 01 02 50 00 8b c3 e8 90 00 } //1
		$a_03_5 = {84 c0 74 16 a1 90 01 02 50 00 8b 80 44 03 00 00 66 be eb ff e8 90 01 03 ff eb 1d 6a 00 6a 00 6a 00 68 90 01 02 50 00 68 90 01 02 50 00 8b c3 e8 90 01 03 ff 50 e8 90 00 } //1
	condition:
