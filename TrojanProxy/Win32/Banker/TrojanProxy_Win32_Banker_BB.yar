...
rule TrojanProxy_Win32_Banker_BB{
	...
	strings :
		$a_01_0 = {54 4b 65 6c 6c 5f 4d 61 72 71 75 65 73 } //01 00 
		...
		$a_01_4 = {75 73 65 72 5f 70 72 65 66 28 22 6e 65 74 77 6f 72 6b 2e 70 72 6f 78 79 2e 61 75 74 6f 63 6f 6e 66 69 67 5f 75 72 6c 22 2c 22 68 74 74 70 3a 2f 2f 77 77 77 2e } //01 00 
		$a_01_5 = {75 73 65 72 5f 70 72 65 66 28 22 6e 65 74 77 6f 72 6b 2e 70 72 6f 78 79 2e 74 79 70 65 22 2c 20 32 29 3b } //01 00 
