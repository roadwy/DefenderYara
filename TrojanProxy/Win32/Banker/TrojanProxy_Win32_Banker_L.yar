...
rule TrojanProxy_Win32_Banker_L{
	...
	strings :
		...
		$a_02_1 = {2e 70 61 63 90 02 10 75 73 65 72 5f 70 72 65 66 90 02 10 6e 65 74 77 6f 72 6b 2e 70 72 6f 78 79 2e 74 79 70 65 90 00 } //1
		$a_02_2 = {5c 70 72 65 66 73 2e 6a 73 90 02 10 75 73 65 72 5f 70 72 65 66 28 22 6e 65 74 77 6f 72 6b 2e 70 72 6f 78 79 2e 61 75 74 6f 63 6f 6e 66 69 67 5f 75 72 6c 90 00 } //1
