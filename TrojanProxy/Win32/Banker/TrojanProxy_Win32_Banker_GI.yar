...
rule TrojanProxy_Win32_Banker_GI{
	...
	strings :
		$a_01_0 = {5b 00 44 00 65 00 6c 00 69 00 6d 00 69 00 5d 00 } //01 00  [Delimi]
		$a_01_1 = {5c 00 6f 00 70 00 65 00 72 00 61 00 5c 00 6f 00 70 00 65 00 72 00 61 00 5c 00 6f 00 70 00 65 00 72 00 61 00 70 00 72 00 65 00 66 00 73 00 2e 00 69 00 6e 00 69 00 } //01 00  \opera\opera\operaprefs.ini
		$a_01_2 = {50 00 48 00 50 00 20 00 52 00 65 00 61 00 64 00 20 00 44 00 61 00 74 00 61 00 } //01 00  PHP Read Data
