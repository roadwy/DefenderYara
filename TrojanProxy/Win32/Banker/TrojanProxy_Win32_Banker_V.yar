...
rule TrojanProxy_Win32_Banker_V{
	...
	strings :
		$a_02_0 = {41 75 74 6f 43 6f 6e 66 69 67 55 52 4c 90 02 0c 68 74 74 70 3a 2f 2f 63 6f 6c 65 67 69 6f 62 6f 62 73 2e 63 6f 6d 2f 66 65 6c 69 63 69 64 61 64 65 2f 73 65 63 72 65 74 2e 70 61 63 90 00 } //2
