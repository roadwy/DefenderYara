...
rule TrojanProxy_Win32_Banker_BN{
	...
	strings :
		...
		$a_02_1 = {41 75 74 6f 43 6f 6e 66 69 67 55 52 4c 22 3d 22 68 74 74 70 3a 2f 2f 90 02 06 2e 90 02 06 2e 90 02 06 2e 90 02 06 2f 70 72 6f 78 79 70 61 63 90 00 } //1
		...
		$a_02_4 = {73 74 61 72 74 20 2f 6d 69 6e 20 43 3a 5c 90 02 08 2e 62 61 74 90 00 } //1
