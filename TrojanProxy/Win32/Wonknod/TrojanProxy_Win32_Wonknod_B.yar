...
rule TrojanProxy_Win32_Wonknod_B{
	...
	strings :
		$a_03_0 = {3d 25 64 2c c7 45 ?? 70 69 64 3d } //1
...
rule TrojanProxy_Win32_Wonknod_B_2{
	...
	strings :
		$a_03_0 = {6e 61 6d 65 66 ?? 45 e4 3d 00 c7 45 ?? 63 6f 6e 74 } //1
...
rule TrojanProxy_Win32_Wonknod_B_3{
	...
	strings :
		...
		$a_03_3 = {78 36 34 2e c7 84 24 ?? ?? 00 00 7a 69 70 00 c7 84 24 ?? ?? 00 00 78 36 34 2e c7 84 24 ?? ?? 00 00 65 78 65 00 c7 84 24 ?? ?? 00 00 78 33 32 2e c7 84 24 ?? ?? 00 00 7a 69 70 00 c7 84 24 ?? ?? 00 00 78 33 32 2e c7 84 24 ?? ?? 00 00 65 78 65 00 } //2
	condition:
