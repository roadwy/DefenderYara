...
rule TrojanProxy_Win32_Ranky{
	...
	strings :
		...
		$a_00_3 = {99 b9 40 9c 00 00 8b 1d 90 01 02 40 00 f7 f9 66 c7 44 24 90 01 01 02 00 81 c2 10 27 00 00 52 90 00 } //4
		$a_02_4 = {ff fe ff 83 f8 68 75 90 01 01 0f b6 8d df ff fe ff 83 f9 70 75 90 00 } //3
		...
		$a_02_8 = {00 00 68 b8 0b 00 00 8d 85 8c 90 01 01 ff ff 50 90 00 } //2
		$a_00_9 = {80 bd 8c f2 ff ff 47 74 0d 80 bd 8c f2 ff ff 50 } //2
		$a_00_10 = {8b 85 80 f1 ff ff 25 ff 00 00 00 83 f8 47 74 15 } //2
		$a_02_11 = {eb 13 68 20 4e 00 00 ff 76 08 e8 90 01 02 00 00 85 c0 7d 08 6a 05 90 00 } //2
		$a_00_12 = {0f b6 8d d8 ff fe ff 83 f9 47 0f 85 } //2
		$a_00_13 = {80 bd 88 f2 ff ff 47 74 0d 80 bd 88 f2 ff ff 50 } //2
		$a_02_14 = {8d 7e 28 66 c7 07 02 00 e8 90 01 02 00 00 6a 10 57 ff 76 08 66 89 46 2a e8 90 01 02 00 00 85 c0 90 00 } //2
		$a_00_15 = {88 18 59 53 53 53 53 53 53 53 6a ff 6a 04 6a ff 57 ff 15 } //2
		$a_02_16 = {40 00 3d b7 00 00 00 0f 84 90 01 02 00 00 57 6a 01 90 00 } //2
		...
		$a_02_19 = {2f 61 2e 70 68 70 3f 90 02 04 68 74 74 70 3a 2f 2f 90 00 } //2
