...
rule TrojanProxy_Win32_Ranky_gen_B{
	...
	strings :
		...
		$a_03_3 = {f2 ae f7 d1 49 51 8d 4c 24 ?? 51 52 e8 ?? ?? ?? ?? 8d 44 24 ?? 50 e8 ?? ?? ?? ?? 83 c4 10 68 a0 bb 0d 00 ff d6 e9 } //10
		$a_03_4 = {99 b9 fd fb 00 00 f7 f9 81 c2 01 04 00 00 66 89 15 ?? ?? ?? ?? 68 e8 03 00 00 ff d6 33 d2 66 8b 15 ?? ?? ?? ?? 52 68 ?? ?? ?? ?? e8 ?? ?? ?? ?? 83 c4 08 85 c0 75 c4 } //10
	condition:
