...
rule TrojanProxy_Win32_Koobface_gen_P{
	...
	strings :
		...
		$a_03_1 = {75 0f 47 83 c6 32 3b 7c 24 (10|14) 7c e5 } //1
		$a_03_2 = {50 44 52 56 2e 64 6c 6c 00 (53 65 72 76 69 63 65 4d 61 69 6e 00|3f 6e 66 5f 61 64 64 52 75 6c 65) } //1
	condition:
