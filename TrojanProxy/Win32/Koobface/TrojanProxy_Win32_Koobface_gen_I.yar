...
rule TrojanProxy_Win32_Koobface_gen_I{
	...
	strings :
		$a_00_0 = {70 6f 73 74 3d 74 72 75 65 26 70 61 74 68 3d 63 61 70 74 63 68 61 26 61 3d 71 75 65 72 79 26 62 3d 25 73 26 69 64 3d 25 73 } //01 00 
		$a_00_1 = {3f 61 63 74 69 6f 6e 3d 62 73 26 76 3d 32 30 26 61 3d 6e 61 6d 65 73 } //01 00 
		$a_00_2 = {68 74 74 70 3a 2f 2f 6e 65 77 73 2e 67 6f 6f 67 6c 65 2e 63 6f 6d 2f 6e 65 77 73 3f 6e 65 64 3d 75 73 26 6f 75 74 70 75 74 3d 72 73 73 } //01 00 
		$a_00_3 = {61 63 63 6f 75 6e 74 73 2f 43 61 70 74 63 68 61 } //01 00 
		$a_00_4 = {23 42 4c 41 43 4b 4c 41 42 45 4c } //01 00 
