...
rule TrojanProxy_Win32_Xorpix_gen_B{
	...
	strings :
		...
		$a_02_4 = {8b ec 81 c4 fc fe ff ff 8d 05 90 01 01 13 40 00 e8 90 01 02 00 00 50 8d 85 fc fe ff ff 50 68 04 01 00 00 e8 90 01 02 00 00 90 02 03 e8 90 01 02 00 00 59 33 c1 90 02 03 8b d0 ff 75 08 52 8d 15 90 01 02 40 00 52 87 d2 8d 95 90 00 } //6
		$a_02_5 = {55 8b ec 56 57 53 8b 45 08 90 02 02 8b f8 90 02 03 8b 75 10 90 02 02 8b df 90 02 03 87 d2 90 02 02 03 5d 0c 90 02 02 8a 06 90 02 05 86 c0 30 27 90 02 03 83 c7 01 90 02 03 46 90 02 03 3b fb 74 90 00 } //6
