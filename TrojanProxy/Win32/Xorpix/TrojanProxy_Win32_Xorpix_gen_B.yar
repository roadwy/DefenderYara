...
rule TrojanProxy_Win32_Xorpix_gen_B{
	...
	strings :
		...
		$a_00_6 = {47 65 74 54 69 63 6b 43 6f 75 6e 74 } //01 00 
		$a_00_7 = {47 65 74 54 65 6d 70 50 61 74 68 41 } //01 00 
		$a_00_8 = {41 64 64 41 74 6f 6d 41 } //01 00 
		$a_00_9 = {46 69 6e 64 46 69 72 73 74 46 69 6c 65 41 } //01 00 
		$a_00_10 = {46 69 6e 64 52 65 73 6f 75 72 63 65 41 } //00 00 
	condition:
		any of ($a_*)
