...
rule TrojanProxy_Win32_Xorpix_gen_D{
	...
	strings :
		...
		$a_01_3 = {64 65 73 6b 74 6f 70 2e 69 6e 69 } //2c 01 
		$a_01_4 = {70 72 6f 63 31 00 } //01 00 
		...
		$a_00_9 = {50 72 6f 63 65 73 73 33 32 46 69 72 73 74 } //01 00 
		...
		$a_01_12 = {43 72 65 61 74 65 52 65 6d 6f 74 65 54 68 72 65 61 64 } //01 00 
		$a_00_13 = {43 72 65 61 74 65 50 72 6f 63 65 73 73 41 } //01 00 
		$a_00_14 = {4f 70 65 6e 53 43 4d 61 6e 61 67 65 72 41 } //00 00 
	condition:
		any of ($a_*)
