...
rule TrojanProxy_Win32_Bunitu_C{
	...
	strings :
		...
		$a_03_2 = {36 c6 84 28 90 01 02 ff ff 00 36 80 bc 28 90 01 02 ff ff 2f 76 90 00 } //1
		$a_01_3 = {8b 45 08 8b 5d 0c c6 03 30 eb 0e 33 d2 f7 75 14 80 c2 30 36 88 54 2e } //1
		$a_03_4 = {83 c2 08 4e 75 90 01 01 83 ef 04 c6 47 24 03 c7 07 21 00 00 00 6a 25 57 90 00 } //1
	condition:
