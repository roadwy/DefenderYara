...
rule TrojanProxy_Win32_Bunitu_R_bit{
	...
	strings :
		...
		$a_03_1 = {89 4a 04 83 6a 04 ?? b8 01 00 00 00 48 b9 ?? ?? ?? ?? 41 } //1
		$a_03_2 = {fe 09 c6 41 ?? ?? fe 49 ?? c6 41 ?? ?? fe 49 ?? fe 09 51 e8 68 20 00 00 } //1
	condition:
...
rule TrojanProxy_Win32_Bunitu_R_bit_2{
	...
	strings :
		...
		$a_03_2 = {b2 6e 86 d6 88 70 04 b2 65 86 d6 88 70 08 51 b9 ?? ?? ?? ?? 87 d1 29 10 59 } //1
