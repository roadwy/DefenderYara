...
rule TrojanProxy_Win32_Bunitu_L{
	...
	strings :
		...
		$a_03_2 = {6e 73 79 2e 90 02 10 2e 90 17 04 03 03 03 04 78 79 7a 6e 65 74 63 6f 6d 69 6e 66 6f 00 90 00 } //1
		$a_01_3 = {74 72 65 77 2f 31 2e 30 20 32 30 30 20 4f 4b } //1 trew/1.0 200 OK
		$a_03_4 = {63 6c 64 33 2e 90 02 10 2e 63 6f 6d 00 90 00 } //1
	condition:
