...
rule TrojanProxy_Win32_Bunitu_B{
	...
	strings :
		...
		$a_01_3 = {65 6e 67 69 6e 65 20 32 2e 35 31 3c 2f 66 6f 6e 74 3e } //01 00  engine 2.51</font>
		$a_01_4 = {77 72 72 72 2f 31 2e 30 20 32 30 30 20 4f 4b } //05 00  wrrr/1.0 200 OK
