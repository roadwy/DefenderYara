...
rule TrojanProxy_Win32_Bunitu_G{
	...
	strings :
		...
		$a_03_1 = {2b d2 81 c2 90 01 04 89 15 90 01 04 81 ea 90 01 04 4a 83 ea 47 4a 4a 90 00 } //10
		...
		$a_03_4 = {8b 34 8a 03 f5 33 ff c1 cf 13 ac 03 f8 85 c0 75 90 01 01 3b fb 75 90 01 01 5a 8b 5a 24 03 dd 66 8b 0c 4b 8b 5a 1c 03 dd 8b 04 8b 8b c8 90 00 } //10
