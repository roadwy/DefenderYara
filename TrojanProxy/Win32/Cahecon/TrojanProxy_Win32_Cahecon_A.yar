...
rule TrojanProxy_Win32_Cahecon_A{
	...
	strings :
		...
		$a_03_1 = {75 6f 6c 2e 63 6f 6e 68 65 63 61 61 75 6f 6c 2e 63 6f 6d 2e 62 72 2f 62 6c 61 63 6b 2f 3f 90 02 05 74 69 70 6f 3d 61 6c 69 76 65 69 26 63 6c 69 65 6e 74 65 3d 74 65 73 74 65 90 00 } //1
	condition:
