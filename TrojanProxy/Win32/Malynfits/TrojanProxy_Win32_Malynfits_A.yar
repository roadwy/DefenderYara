...
rule TrojanProxy_Win32_Malynfits_A{
	...
	strings :
		...
		$a_03_16 = {8b 75 08 c7 05 28 e7 42 00 90 01 04 80 35 28 e7 42 00 90 01 01 80 35 2a e7 42 00 90 01 01 68 90 01 04 56 e8 90 01 02 ff ff 90 00 } //1
		...
		$a_01_21 = {63 66 67 00 25 00 55 00 53 00 45 00 52 00 50 00 } //1 晣g%USERP
