...
rule TrojanProxy_Win32_Bedri_A{
	...
	strings :
		$a_03_0 = {7c 73 30 63 6b 73 39 72 6f 78 90 02 01 7b 2d 2d 2d 7d 90 02 10 7c 90 01 02 2d 90 01 02 2d 90 01 02 2d 90 01 02 2d 90 01 02 2d 90 01 02 7c 90 02 10 7c 90 00 } //3
		$a_03_1 = {33 c0 8a 42 02 85 c0 74 90 01 01 8b 4d 90 01 01 33 d2 8a 51 02 83 fa 02 90 00 } //1
