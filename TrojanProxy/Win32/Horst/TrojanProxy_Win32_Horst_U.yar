...
rule TrojanProxy_Win32_Horst_U{
	...
	strings :
		$a_02_0 = {85 c0 74 3c ff 15 90 01 04 c1 e8 0a 33 d2 b9 3c 00 00 00 f7 f1 50 ff 15 90 01 04 50 68 90 01 04 8b 55 08 52 e8 90 01 02 00 00 83 c4 04 8b 4d 08 03 c8 51 ff 15 90 01 04 83 c4 10 90 00 } //5
