...
rule TrojanProxy_Win32_Wopla_Z{
	meta:
		description = "TrojanProxy:Win32/Wopla.Z,SIGNATURE_TYPE_PEHSTR_EXT,06 00 06 00 06 00 00 01 00 "
	...
	strings :
		...
		$a_00_1 = {53 6f 66 74 77 61 72 65 5c 4d 69 63 72 6f 73 6f 66 74 5c 59 4c 6f 61 64 5c 76 61 72 73 } //01 00  Software\Microsoft\YLoad\vars
		...
		$a_00_3 = {6c 61 6d 6f 64 61 6e 6f 2e 69 6e 66 6f 2f 61 66 66 2d 6c 69 67 68 74 } //01 00  lamodano.info/aff-light
		$a_00_4 = {47 65 74 53 79 73 74 65 6d 57 69 6e 64 6f 77 73 44 69 72 65 63 74 6f 72 79 41 } //01 00  GetSystemWindowsDirectoryA
