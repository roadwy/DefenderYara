...
rule TrojanProxy_Win32_Pramro_B{
	...
	strings :
		$a_03_0 = {0f be 85 d4 ef ff ff 83 f8 47 75 18 0f be 8d d5 ef ff ff 83 f9 45 75 0c 90 09 05 00 e9 ?? 04 00 00 } //1
		$a_03_1 = {8a 84 15 f4 eb ff ff 34 ?? 8b 8d ec db ff ff 88 84 0d f4 eb ff ff eb c5 } //1
