...
rule TrojanProxy_Linux_Stantinko_A_MTB{
	...
	strings :
		...
		$a_03_3 = {48 8b 45 f8 be 90 01 04 48 89 c7 e8 90 01 04 48 85 c0 74 1f 48 8b 45 f8 be 90 01 04 48 89 c7 e8 90 01 04 48 85 c0 74 09 48 8b 05 90 01 04 eb 55 90 00 } //4
	condition:
