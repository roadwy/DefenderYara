...
rule TrojanProxy_Linux_Stantinko_A_MTB{
	...
	strings :
		$a_00_0 = {70 72 6f 78 79 5f 69 70 3d } //02 00  proxy_ip=
		$a_00_1 = {2f 6b 62 64 6d 61 69 2f 44 52 54 49 50 52 4f 56 2f 69 6e 64 65 78 2e 70 68 70 } //02 00  /kbdmai/DRTIPROV/index.php
		$a_00_2 = {2f 6b 62 64 6d 61 69 2f 77 69 6e 73 76 63 2f 69 6e 64 65 78 2e 70 68 70 } //04 00  /kbdmai/winsvc/index.php
