...
rule SoftwareBundler_Win32_Chindo{
	...
	strings :
		$a_01_0 = {43 72 65 61 74 65 4d 75 74 65 78 41 28 69 20 30 2c 20 69 20 30 2c 20 74 20 22 4a 57 42 43 6c 69 65 6e 74 22 29 } //05 00 
		$a_01_1 = {5c 49 6e 74 72 65 6e 65 74 20 45 78 70 6c 6f 72 65 72 2e 6c 6e 6b } //02 00 
		...
		$a_01_5 = {64 6f 77 6e 6c 6f 61 64 5f 71 75 69 65 74 } //01 00 
...
rule SoftwareBundler_Win32_Chindo_2{
	...
	strings :
		$a_01_0 = {68 74 74 70 3a 2f 2f 64 6c 2e 73 74 61 74 69 63 2e 69 71 69 79 69 2e 63 6f 6d 2f 68 7a 2f 49 51 49 59 49 73 65 74 75 70 5f 73 65 6e 78 69 6e 67 40 6b 62 30 31 30 2e 65 78 65 } //03 00 
		$a_01_1 = {53 6f 48 75 56 41 5f 34 2e 35 2e 37 37 2e 30 2d 63 32 30 37 37 31 35 2d 6e 74 69 2d 6e 67 2d 74 70 2d 73 2e 65 78 65 } //02 00 
		$a_01_2 = {68 74 74 70 3a 2f 2f 69 6e 74 2e 64 70 6f 6f 6c 2e 73 69 6e 61 2e 63 6f 6d 2e 63 6e 2f 69 70 6c 6f 6f 6b 75 70 2f 69 70 6c 6f 6f 6b 75 70 2e 70 68 70 } //02 00 
		$a_01_3 = {43 3a 5c 54 45 4d 50 5c 32 2e 6a 70 67 } //01 00 
		$a_01_4 = {54 65 6e 63 65 6e 74 5c 51 51 42 72 6f 77 73 65 72 5c 75 6e 69 6e 73 74 2e 65 78 65 } //00 00 
...
rule SoftwareBundler_Win32_Chindo_3{
	...
	strings :
		...
		$a_01_4 = {3a 3a 43 72 65 61 74 65 4d 75 74 65 78 41 28 69 20 30 2c 20 69 20 30 2c 20 74 20 22 31 22 29 20 69 20 2e 72 31 20 3f 65 } //00 00 
	condition:
		any of ($a_*)
...
rule SoftwareBundler_Win32_Chindo_5{
	...
	strings :
		$a_01_0 = {28 69 20 30 2c 20 69 20 30 2c 20 74 20 22 4a 57 42 43 6c 69 65 6e 74 22 29 } //01 00 
		...
		$a_01_6 = {61 48 52 30 63 44 6f 76 4c 32 6c 75 64 43 35 6b 63 47 39 76 62 43 35 7a 61 57 35 68 4c 6d 4e 76 62 53 35 6a 62 69 39 70 63 47 78 76 62 32 74 31 63 43 39 70 63 47 78 76 62 32 74 31 63 43 35 77 61 48 41 } //01 00 
		$a_01_7 = {61 48 52 30 63 44 6f 76 4c 33 4e 76 5a 6e 52 77 61 47 39 30 62 } //00 00 
	condition:
		any of ($a_*)
...
rule SoftwareBundler_Win32_Chindo_6{
	...
	strings :
		$a_01_0 = {68 74 74 70 3a 2f 2f 64 6f 77 6e 32 2e 75 63 2e 63 6e 2f 70 63 62 72 6f 77 73 65 72 2f 64 6f 77 6e 2e 70 68 70 3f 70 69 64 3d 34 33 39 36 } //02 00 
		$a_01_1 = {68 74 74 70 3a 2f 2f 6d 69 73 63 2e 77 63 64 2e 71 71 2e 63 6f 6d 2f 61 70 70 3f 70 61 63 6b 61 67 65 4e 61 6d 65 3d 70 63 71 71 62 72 6f 77 73 65 72 26 63 68 61 6e 6e 65 6c 49 64 3d 38 31 35 32 39 } //02 00 
		...
		$a_01_3 = {68 74 74 70 3a 2f 2f 64 6f 77 6e 2e 6b 75 77 6f 2e 63 6e 2f 6d 62 6f 78 2f 6b 75 77 6f 5f 6a 6d 36 33 34 2e 65 78 65 } //02 00 
