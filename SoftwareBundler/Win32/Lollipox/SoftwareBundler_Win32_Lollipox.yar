...
rule SoftwareBundler_Win32_Lollipox{
	...
	strings :
		...
		$a_03_2 = {4d 65 63 61 4e 65 74 90 02 02 5f 4f 66 65 72 74 61 4c 6f 6c 6c 69 50 6f 70 90 00 } //2
	condition:
...
rule SoftwareBundler_Win32_Lollipox_2{
	...
	strings :
		...
		$a_01_1 = {4d 65 63 61 4e 65 74 } //1 MecaNet
		$a_03_2 = {4c 6f 6c 6c 69 70 6f 70 90 02 10 69 73 20 61 20 66 72 65 65 20 61 70 70 6c 69 63 61 74 69 6f 6e 90 00 } //2
	condition:
