...
rule SoftwareBundler_Win32_ICLoader{
	...
	strings :
		$a_03_0 = {66 81 39 4d 5a 0f 85 ?? ?? 00 00 8b 41 3c 68 00 01 00 00 03 c1 50 a3 ?? ?? ?? ?? ff d6 85 c0 0f 85 ?? ?? 00 00 a1 ?? ?? ?? ?? 66 81 38 50 45 } //1
...
rule SoftwareBundler_Win32_ICLoader_2{
	...
	strings :
		$a_03_0 = {8b 4d 08 8a 45 0f d3 e3 33 db 0b 1d ?? ?? ?? ?? 03 d9 8a 0b 90 90 90 90 33 c1 88 03 90 90 42 81 fa 27 07 00 00 89 55 08 7e } //1
