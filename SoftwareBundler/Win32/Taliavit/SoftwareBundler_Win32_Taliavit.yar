...
rule SoftwareBundler_Win32_Taliavit{
	...
	strings :
		$a_03_0 = {5c 6d 6f 63 6b 75 70 5f 73 6f 66 74 77 61 72 65 75 70 64 61 74 65 72 2e 62 6d 70 00 75 73 65 72 33 32 3a 3a 4c 6f 61 64 49 6d 61 67 65 90 01 50 90 02 50 4f 6e 43 6c 69 63 6b 90 02 0f 49 6e 73 74 61 6c 61 72 20 42 61 73 65 66 6c 61 73 68 90 00 } //1
...
rule SoftwareBundler_Win32_Taliavit_2{
	...
	strings :
		$a_03_0 = {3d 4f 4b 53 50 26 90 02 20 26 70 6d 64 35 3d 90 02 90 5c 62 61 73 65 66 6c 61 73 68 53 65 74 75 70 2e 65 78 65 90 00 } //2
