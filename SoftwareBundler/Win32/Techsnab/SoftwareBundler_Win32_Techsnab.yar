...
rule SoftwareBundler_Win32_Techsnab{
	...
	strings :
		$a_01_0 = {69 64 3d 25 73 26 68 77 61 64 64 72 3d 25 73 26 26 75 73 65 72 5f 6f 73 3d 25 73 26 68 64 64 5f 26 73 74 61 74 75 73 } //02 00  id=%s&hwaddr=%s&&user_os=%s&hdd_&status
		$a_01_1 = {63 68 61 6e 6e 65 6c 3d 25 73 73 65 72 69 61 6c 3d 25 73 26 77 69 6e 5f 75 75 2f 66 20 2f 69 6d 20 77 69 6e 75 70 64 2e 65 78 } //01 00  channel=%sserial=%s&win_uu/f /im winupd.ex
		$a_01_2 = {25 30 32 58 2d 25 30 32 58 2d 25 30 32 58 2d 25 30 32 58 2d 25 30 32 58 2d 25 30 32 58 } //02 00  %02X-%02X-%02X-%02X-%02X-%02X
		$a_01_3 = {26 76 65 72 73 69 65 20 2f 66 69 20 22 50 49 44 20 6e 65 20 25 6c 26 76 65 72 73 69 6f 6e 3d } //00 00  &versie /fi "PID ne %l&version=
		$a_00_4 = {78 21 } //02 00  x!
	condition:
		any of ($a_*)
...
rule SoftwareBundler_Win32_Techsnab_2{
	...
	strings :
		$a_01_0 = {76 3d 25 73 26 6e 75 75 69 64 3d 25 73 } //01 00  v=%s&nuuid=%s
		$a_03_1 = {73 26 76 3d 90 01 06 25 73 26 6e 90 01 06 75 75 69 64 90 01 06 3d 25 73 26 90 01 06 75 73 65 72 90 00 } //02 00 
		$a_01_2 = {25 30 32 78 25 30 32 78 25 30 32 78 25 30 32 78 2d 25 30 32 78 25 30 32 78 2d 25 30 32 78 25 30 32 78 2d 25 30 32 78 25 30 32 78 2d 25 30 32 78 25 30 32 78 25 30 32 78 25 30 32 78 25 30 32 78 25 30 32 78 } //02 00  %02x%02x%02x%02x-%02x%02x-%02x%02x-%02x%02x-%02x%02x%02x%02x%02x%02x
		$a_01_3 = {50 52 4f 43 45 53 53 4f 52 5f 49 44 45 4e 54 49 46 49 45 52 } //01 00  PROCESSOR_IDENTIFIER
		$a_01_4 = {43 6c 69 63 6b 20 6e 65 78 74 20 74 6f 20 73 74 61 72 74 20 64 6f 77 6e 6c 6f 61 64 21 00 } //01 00 
		$a_01_5 = {6e 6f 74 31 32 00 } //01 00  潮ㅴ2
