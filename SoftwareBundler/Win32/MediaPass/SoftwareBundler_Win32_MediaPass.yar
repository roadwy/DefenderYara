...
rule SoftwareBundler_Win32_MediaPass{
	...
	strings :
		...
		$a_01_8 = {72 65 67 69 73 74 65 72 40 68 61 76 69 6e 67 66 75 6e 6f 6e 6c 69 6e 65 2e 63 6f 6d } //65436 register@havingfunonline.com
	condition:
		((#a_01_0  & 1)*50+(#a_01_1  & 1)*2+(#a_01_2  & 1)*2+(#a_01_3  & 1)*1+(#a_01_4  & 1)*1+(#a_01_5  & 1)*1+(#a_01_6  & 1)*1+(#a_01_7  & 1)*1+(#a_01_8  & 1)*65436) >=56
