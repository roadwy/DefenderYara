...
rule SoftwareBundler_Win32_FileTour{
	...
	strings :
		$a_01_0 = {45 76 67 65 6e 20 4b 75 67 69 74 6b 6f } //01 00 
		$a_01_1 = {32 65 37 34 36 66 37 32 37 32 36 35 36 65 37 34 } //01 00 
		$a_01_2 = {68 6f 72 73 65 73 2e 66 69 6c 65 2d 74 6f 75 72 2e 72 75 } //01 00 
