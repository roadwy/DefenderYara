...
rule _#MpRequestHookwowM_49{
	...
	strings :
		...
		$a_01_2 = {4d 73 69 44 61 74 61 62 61 73 65 4d 65 72 67 65 2e 70 64 62 } //00 00 
	condition:
		any of ($a_*)
...
rule _#MpRequestHookwowM_92{
	...
	strings :
		...
		$a_01_1 = {33 33 31 35 33 31 35 24 } //00 00 
	condition:
		any of ($a_*)
...
rule _#MpRequestHookwowM_231{
	...
	strings :
		...
		$a_01_1 = {50 00 72 00 6f 00 74 00 65 00 63 00 74 00 6f 00 72 00 } //00 00 
	condition:
		any of ($a_*)
...
rule _#MpRequestHookwowM_243{
	...
	strings :
		$a_01_0 = {73 66 2e 65 78 65 } //01 00 
		$a_01_1 = {66 00 73 00 66 00 73 00 64 00 66 00 73 00 64 00 66 00 73 00 64 00 66 00 73 00 64 00 66 00 } //01 00 
		$a_01_2 = {23 00 6e 00 73 00 64 00 66 00 66 00 64 00 73 00 70 00 23 00 24 00 24 00 24 00 2e 00 65 00 78 00 65 00 24 00 24 00 24 00 } //00 00 
	condition:
		any of ($a_*)
...
rule _#MpRequestHookwowM_331{
	...
	strings :
		$a_01_0 = {70 00 72 00 69 00 6e 00 74 00 5f 00 73 00 63 00 72 00 65 00 65 00 6e 00 } //01 00 
...
rule _#MpRequestHookwowM_333{
	...
	strings :
		...
		$a_01_3 = {45 58 45 5f 74 65 6d 70 25 78 25 73 } //00 00 
	condition:
		any of ($a_*)
...
rule _#MpRequestHookwowM_335{
	...
	strings :
		...
		$a_01_1 = {23 00 6e 00 65 00 77 00 74 00 6d 00 70 00 23 00 24 00 24 00 24 00 2e 00 65 00 78 00 65 00 24 00 24 00 24 00 } //01 00 
		$a_01_2 = {66 00 73 00 66 00 73 00 64 00 66 00 73 00 64 00 66 00 73 00 64 00 66 00 73 00 64 00 66 00 } //00 00 
	condition:
		any of ($a_*)
...
rule _#MpRequestHookwowM_349{
	...
	strings :
		$a_01_0 = {53 00 79 00 73 00 74 00 65 00 6d 00 20 00 68 00 61 00 6c 00 74 00 65 00 64 00 } //01 00 
		$a_01_1 = {56 65 72 69 66 69 63 61 74 6f 72 00 62 6c 75 72 00 62 00 } //01 00 
		$a_01_2 = {45 00 78 00 69 00 73 00 74 00 73 00 20 00 69 00 6e 00 20 00 74 00 68 00 65 00 20 00 63 00 75 00 72 00 72 00 65 00 6e 00 74 00 20 00 64 00 69 00 72 00 20 00 6f 00 66 00 20 00 74 00 68 00 65 00 20 00 73 00 79 00 73 00 74 00 65 00 6d 00 } //01 00 
...
rule _#MpRequestHookwowM_359{
	...
	strings :
		$a_01_0 = {54 00 47 00 39 00 68 00 5a 00 41 00 3d 00 3d 00 } //01 00 
		$a_01_1 = {51 00 32 00 46 00 73 00 62 00 45 00 4a 00 35 00 54 00 6d 00 46 00 74 00 5a 00 51 00 3d 00 3d 00 } //01 00 
		$a_01_2 = {52 00 32 00 56 00 30 00 54 00 32 00 4a 00 71 00 5a 00 57 00 4e 00 30 00 56 00 6d 00 46 00 73 00 64 00 57 00 55 00 3d 00 } //01 00 
		$a_01_3 = {50 6f 73 74 5f 4d 61 72 6b 4d 61 69 6c 2e 52 65 73 6f 75 72 63 65 73 2e 72 65 73 6f 75 72 63 65 73 } //02 00 
