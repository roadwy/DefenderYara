...
rule PWS_BAT_Kelopol_B{
	...
	strings :
		...
		$a_00_1 = {73 00 6d 00 74 00 70 00 2e 00 67 00 6d 00 61 00 69 00 6c 00 2e 00 63 00 6f 00 6d 00 } //01 00 
		$a_00_2 = {4b 00 65 00 79 00 6c 00 6f 00 67 00 67 00 65 00 72 00 } //00 00 
	condition:
		any of ($a_*)
