...
rule PWS_BAT_Stimilini_M{
	...
	strings :
		...
		$a_01_2 = {4b 65 79 6c 6f 67 67 65 72 00 } //01 00 
		...
		$a_01_6 = {4c 6f 67 69 6e 44 61 74 61 00 } //01 00 
		$a_01_7 = {53 74 65 61 6d 46 69 6c 65 53 74 65 61 6c 65 72 45 78 74 72 65 6d 65 00 } //01 00 
		$a_01_8 = {46 69 72 65 66 6f 78 50 61 73 73 77 6f 72 64 00 } //00 00 
	condition:
		any of ($a_*)
