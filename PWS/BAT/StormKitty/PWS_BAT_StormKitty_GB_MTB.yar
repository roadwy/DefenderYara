...
rule PWS_BAT_StormKitty_GB_MTB{
	...
	strings :
		...
		$a_80_4 = {52 69 6a 6e 64 61 65 6c 4d 61 6e 61 67 65 64 } //RijndaelManaged  01 00 
		$a_80_5 = {43 6c 69 70 62 6f 61 72 64 } //Clipboard  01 00 
		$a_80_6 = {55 6e 68 6f 6f 6b 57 69 6e 64 6f 77 73 48 6f 6f 6b 45 78 } //UnhookWindowsHookEx  01 00 
		$a_80_7 = {73 65 74 77 69 6e 64 6f 77 73 68 6f 6f 6b 65 78 } //setwindowshookex  00 00 
	condition:
		any of ($a_*)
