...
rule PWS_BAT_Stimilina_A_2{
	...
	strings :
		...
		$a_02_7 = {74 00 73 00 65 00 63 00 72 00 65 00 74 00 34 00 36 00 37 00 [0-20] 40 00 67 00 6d 00 61 00 69 00 6c 00 2e 00 63 00 6f 00 6d 00 } //3
		$a_02_8 = {74 73 65 63 72 65 74 34 36 37 [0-20] 40 67 6d 61 69 6c 2e 63 6f 6d } //3
