...
rule PWS_BAT_Stimilina_B{
	...
	strings :
		...
		$a_00_4 = {5c 00 4c 00 6f 00 63 00 61 00 6c 00 53 00 65 00 72 00 76 00 69 00 63 00 65 00 2e 00 65 00 78 00 65 00 } //02 00  \LocalService.exe
		$a_00_5 = {2f 00 2f 00 70 00 69 00 63 00 2d 00 73 00 63 00 72 00 65 00 65 00 6e 00 73 00 68 00 6f 00 74 00 2e 00 63 00 6f 00 6d 00 2f 00 } //02 00  //pic-screenshot.com/
...
rule PWS_BAT_Stimilina_B_2{
	...
	strings :
		...
		$a_00_4 = {2f 00 2f 00 69 00 6d 00 61 00 67 00 65 00 34 00 79 00 6f 00 75 00 2e 00 75 00 73 00 2f 00 } //02 00  //image4you.us/
