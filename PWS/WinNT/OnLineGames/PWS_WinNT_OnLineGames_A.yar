...
rule PWS_WinNT_OnLineGames_A{
	...
	strings :
		...
		$a_02_2 = {39 5e 08 76 5e 53 e8 90 01 02 ff ff 8b 45 fc 8b 55 b8 8b c8 c1 e1 02 8b 84 0d 30 f2 ff ff 3b c2 76 37 8b 7d d4 03 fa 3b c7 73 2e 8b 3e 2b c2 53 8b 0c 39 8b f8 89 4d e8 e8 90 01 02 ff ff 03 7d f8 53 e8 58 fa ff ff 3b 7d e8 74 0e 53 e8 90 01 02 ff ff 90 00 } //1
	condition:
