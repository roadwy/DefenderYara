...
rule PWS_WinNT_OnLineGames_E{
	...
	strings :
		...
		$a_01_2 = {77 73 68 74 63 70 69 70 2e 64 6c 6c } //00 00  wshtcpip.dll
	condition:
		any of ($a_*)
...
rule PWS_WinNT_OnLineGames_E_2{
	...
	strings :
		...
		$a_01_2 = {4d 41 50 6c 65 73 74 6f 72 79 2e 65 78 65 } //01 00  MAPlestory.exe
		$a_01_3 = {56 33 6c 74 72 61 79 2e 65 78 65 } //01 00  V3ltray.exe
		$a_01_4 = {41 56 70 2e 65 78 65 } //00 00  AVp.exe
	condition:
		any of ($a_*)
