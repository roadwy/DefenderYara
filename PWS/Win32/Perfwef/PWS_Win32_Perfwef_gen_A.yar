...
rule PWS_Win32_Perfwef_gen_A{
	...
	strings :
		$a_01_0 = {53 74 61 72 74 48 6f 6f 6b } //01 00 
		$a_01_1 = {53 74 6f 70 48 6f 6f 6b } //01 00 
		$a_00_2 = {45 6c 65 6d 65 6e 74 43 6c 69 65 6e 74 20 57 69 6e 64 6f 77 } //01 00 
		$a_00_3 = {45 71 75 69 70 46 75 6e 63 } //02 00 
