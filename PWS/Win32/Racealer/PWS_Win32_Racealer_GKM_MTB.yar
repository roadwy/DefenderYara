...
rule PWS_Win32_Racealer_GKM_MTB{
	...
	strings :
		$a_02_0 = {b8 f8 94 08 00 01 45 90 01 01 8b 45 90 01 01 8a 04 30 8b 0d 90 01 04 88 04 31 81 3d 90 01 04 03 02 00 00 75 90 01 01 53 53 ff 15 90 01 04 89 1d 90 01 04 46 3b 35 90 01 04 72 90 00 } //1
	condition:
		((#a_02_0  & 1)*1) >=1
...
rule PWS_Win32_Racealer_GKM_MTB_3{
	...
	strings :
		...
		$a_02_17 = {f6 d1 30 4c 15 90 01 01 42 83 fa 05 73 90 01 01 8a 4d 90 01 01 eb 90 00 } //1
	condition:
