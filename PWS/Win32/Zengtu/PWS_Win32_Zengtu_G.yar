...
rule PWS_Win32_Zengtu_G{
	...
	strings :
		...
		$a_00_1 = {57 69 6e 64 6f 77 73 58 50 } //01 00 
		$a_01_2 = {57 69 6e 64 6f 77 73 32 33 } //01 00 
		$a_00_3 = {43 6f 6e 74 65 6e 74 2d 54 79 70 65 3a 20 61 70 70 6c 69 63 61 74 69 6f 6e } //01 00 
		...
		$a_01_6 = {53 74 61 72 74 48 6f 6f 6b } //00 00 
	condition:
		any of ($a_*)
