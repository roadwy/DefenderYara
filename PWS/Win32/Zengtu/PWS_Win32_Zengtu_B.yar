...
rule PWS_Win32_Zengtu_B{
	...
	strings :
		...
		$a_00_9 = {67 67 73 61 66 65 2e 63 6f 6d 2f 67 67 74 6f 6f 6c 73 2e 69 6e 69 } //-15 ggsafe.com/ggtools.ini
		$a_00_10 = {75 70 64 61 74 65 2e 67 67 73 61 66 65 2e 63 6f 6d 2f } //-15 update.ggsafe.com/
	condition:
