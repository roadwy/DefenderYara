...
rule PWS_Win32_Peerfit_A{
	...
	strings :
		...
		$a_01_1 = {6c 6f 67 20 69 6e 20 74 6f 20 79 6f 75 72 20 47 6d 61 69 6c } //01 00  log in to your Gmail
		$a_01_2 = {42 34 45 38 44 31 36 43 32 36 33 32 33 44 34 41 } //00 00  B4E8D16C26323D4A
	condition:
		any of ($a_*)
