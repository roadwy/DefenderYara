...
rule PWS_Win32_Sypak_A{
	...
	strings :
		$a_00_0 = {2e 47 65 74 53 6b 79 70 65 41 70 70 44 61 74 61 44 69 72 } //01 00 
		$a_00_1 = {53 00 6b 00 79 00 70 00 65 00 5c 00 41 00 70 00 70 00 73 00 5c 00 6c 00 6f 00 67 00 69 00 6e 00 5c 00 69 00 6e 00 64 00 65 00 78 00 2e 00 68 00 74 00 6d 00 6c 00 } //01 00 
		$a_00_2 = {50 72 6f 6a 65 63 74 73 5c 53 46 6c 6f 6f 64 65 72 5c } //02 00 
