...
rule PWS_Win32_Stegae_A{
	...
	strings :
		...
		$a_00_1 = {5c 50 62 6b 5c 72 61 73 70 68 6f 6e 65 2e 70 62 6b } //01 00 
		$a_00_2 = {52 00 61 00 73 00 44 00 69 00 61 00 6c 00 50 00 61 00 72 00 61 00 6d 00 73 00 21 00 25 00 73 00 23 00 30 00 } //01 00 
