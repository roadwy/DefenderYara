...
rule PWS_Win32_Keylogger_D{
	...
	strings :
		$a_03_0 = {8b 45 e8 89 44 24 04 c7 04 24 ?? 00 00 00 e8 ?? ?? 00 00 8b 45 e8 89 04 24 e8 ?? ?? 00 00 eb ?? 8b 45 e8 89 44 24 04 c7 04 24 ?? 00 00 00 e8 ?? ?? 00 00 8b 45 e8 89 04 24 e8 ?? ?? 00 00 eb } //10
