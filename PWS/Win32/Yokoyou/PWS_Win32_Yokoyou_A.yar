...
rule PWS_Win32_Yokoyou_A{
	...
	strings :
		$a_03_0 = {8b d0 8a 83 90 01 04 32 d0 8d 45 f4 e8 90 01 02 ff ff 8b 55 f4 8b c7 e8 90 01 02 ff ff 43 81 e3 07 00 00 80 79 05 4b 83 cb f8 43 ff 45 f8 4e 75 a1 90 00 } //2
