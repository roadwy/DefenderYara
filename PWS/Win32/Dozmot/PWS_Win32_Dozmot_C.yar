...
rule PWS_Win32_Dozmot_C{
	...
	strings :
		...
		$a_01_3 = {25 73 3f 75 3d 25 73 26 73 68 61 3d 25 73 26 70 3d 25 73 } //01 00  %s?u=%s&sha=%s&p=%s
		$a_01_4 = {25 73 2f 6c 69 6e 2e 70 68 70 3f 6d 3d 25 73 26 67 3d } //00 00  %s/lin.php?m=%s&g=
	condition:
		any of ($a_*)
