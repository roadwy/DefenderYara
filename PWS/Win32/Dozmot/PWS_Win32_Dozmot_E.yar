...
rule PWS_Win32_Dozmot_E{
	...
	strings :
		...
		$a_01_2 = {25 73 3f 61 63 74 69 6f 6e 3d 70 6f 73 74 6d 62 26 75 3d 25 73 26 6d 62 3d 25 73 } //01 00 
		$a_01_3 = {26 66 69 64 3d 25 73 26 6c 65 76 3d 25 64 26 6a 62 3d 25 64 } //00 00 
	condition:
		any of ($a_*)
