...
rule PWS_Win32_Dozmot_D{
	...
	strings :
		$a_00_0 = {6e 61 6d 65 3d 22 74 72 61 63 6b 64 61 74 61 22 3b } //02 00 
		$a_00_1 = {6e 61 6d 65 3d 22 73 75 62 6d 69 74 74 65 64 22 } //01 00 
		$a_00_2 = {00 69 73 6f 6e 6c 69 6e 65 00 } //01 00 
		...
		$a_00_6 = {2d 2d 2d 2d 2d 2d 2d 2d 2d 37 62 34 61 36 64 31 35 38 63 39 } //01 00 
