...
rule PWS_Win32_Rumrux_gen_A{
	...
	strings :
		...
		$a_00_3 = {53 4f 46 54 57 41 52 45 5c 4d 69 63 72 6f 73 6f 66 74 5c 57 69 6e 64 6f 77 73 5c 43 75 72 72 65 6e 74 56 65 72 73 69 6f 6e 5c 45 78 70 6c 6f 72 65 72 5c 44 65 73 6b 74 6f 70 } //01 00 
		$a_00_4 = {41 63 63 65 70 74 2d 4c 61 6e 67 75 61 67 65 3a 20 7a 68 2d 63 6e } //01 00 
		$a_01_5 = {72 78 6d 72 75 00 } //00 00 
	condition:
		any of ($a_*)
