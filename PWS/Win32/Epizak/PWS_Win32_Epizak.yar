...
rule PWS_Win32_Epizak{
	...
	strings :
		$a_00_0 = {69 00 76 00 77 00 74 00 3f 00 29 00 28 00 } //05 00 
		$a_00_1 = {55 00 73 00 65 00 72 00 20 00 4e 00 61 00 6d 00 65 00 2f 00 56 00 61 00 6c 00 75 00 65 00 } //01 00 
		$a_00_2 = {2f 00 73 00 74 00 65 00 78 00 74 00 20 00 43 00 3a 00 5c 00 78 00 2e 00 74 00 78 00 74 00 } //01 00 
		$a_00_3 = {6e 00 2e 00 62 00 61 00 74 00 } //0a 00 
