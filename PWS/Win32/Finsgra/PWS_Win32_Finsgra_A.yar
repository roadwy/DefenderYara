...
rule PWS_Win32_Finsgra_A{
	...
	strings :
		$a_03_0 = {c7 45 fc 41 3a 5c 00 ff 90 90 01 04 a3 90 01 04 c6 45 fc 41 8d 45 fc 50 a1 90 01 04 ff 39 90 01 02 00 00 85 c0 74 18 90 00 } //5
		$a_01_1 = {8a c8 80 e9 21 80 f9 5d 77 58 3c 20 74 54 3c 22 } //5
		$a_03_2 = {7e 79 8d 3c 02 8d 41 ff 6a 44 33 d2 59 f7 f1 8b f0 46 33 c0 8b d7 8a 0a 3a cb 88 8c 05 90 01 04 74 08 42 42 40 83 f8 44 7e eb 90 00 } //5
