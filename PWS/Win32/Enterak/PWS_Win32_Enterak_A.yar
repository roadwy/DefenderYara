...
rule PWS_Win32_Enterak_A_2{
	...
	strings :
		...
		$a_03_1 = {74 65 65 6e 63 61 73 68 90 02 05 68 61 70 70 79 6d 6f 6e 65 79 90 02 05 63 75 6c 74 75 72 65 6c 61 6e 64 90 00 } //1
...
rule PWS_Win32_Enterak_A_3{
	...
	strings :
		...
		$a_03_3 = {2e 61 73 70 3f 75 90 02 01 3d 25 73 26 70 90 02 01 3d 25 73 90 00 } //2
		$a_03_4 = {25 73 3f 61 90 02 01 3d 25 73 26 73 90 02 01 3d 25 73 26 90 00 } //1
...
rule PWS_Win32_Enterak_A_4{
	...
	strings :
		$a_02_0 = {0f 87 b4 00 00 00 be 90 01 02 00 10 ff 36 57 e8 90 01 02 00 00 59 85 c0 59 74 10 83 c6 04 81 fe 90 01 02 00 10 7c e7 e9 91 00 00 00 90 00 } //10
