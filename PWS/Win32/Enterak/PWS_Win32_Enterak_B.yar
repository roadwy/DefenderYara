...
rule PWS_Win32_Enterak_B{
	...
	strings :
		$a_01_0 = {25 73 3f 75 70 3d 25 73 26 70 70 3d 25 73 26 73 73 70 3d 25 73 00 } //01 00 
		$a_01_1 = {26 70 5f 6d 6e 79 5f 62 61 6c 3d 00 } //01 00 
		$a_01_2 = {68 6d 5f 70 5f 55 73 65 72 49 64 00 } //02 00 
