...
rule PWS_Win32_Primarypass_A_2{
	...
	strings :
		$a_01_0 = {4d 41 43 3d 25 30 32 58 25 30 32 58 25 30 32 58 49 4e 53 54 41 4c 4c 3d 25 30 38 58 25 30 38 58 6b } //0a 00  MAC=%02X%02X%02XINSTALL=%08X%08Xk
		$a_01_1 = {8a 04 39 30 04 16 41 33 c0 3b 4d 10 0f 4d c8 } //01 00 
		$a_01_2 = {25 00 73 00 5c 00 57 00 53 00 5f 00 46 00 54 00 50 00 5c 00 57 00 53 00 5f 00 46 00 54 00 50 00 2e 00 49 00 4e 00 49 00 } //01 00  %s\WS_FTP\WS_FTP.INI
		$a_01_3 = {5c 00 50 00 72 00 65 00 66 00 65 00 72 00 65 00 6e 00 63 00 65 00 73 00 5c 00 6b 00 65 00 79 00 63 00 68 00 61 00 69 00 6e 00 2e 00 70 00 6c 00 69 00 73 00 74 00 } //01 00  \Preferences\keychain.plist
		$a_01_4 = {46 52 4f 4d 20 6d 6f 7a 5f 6c 6f 67 69 6e 73 } //00 00  FROM moz_logins
