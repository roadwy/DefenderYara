...
rule PWS_Win32_Lineage_CK{
	...
	strings :
		$a_03_0 = {89 11 b0 d8 88 41 04 8b 54 24 04 8d 4c 24 04 51 52 6a 05 68 90 01 03 10 ff d6 90 00 } //2
		$a_01_1 = {ff d6 ff d0 5e 61 e9 } //1
		$a_03_2 = {51 6a 05 8d 55 d4 52 56 8b 7d 2c 8b 07 50 ff 15 90 01 02 00 10 85 c0 0f 84 90 01 02 00 00 83 bd 90 01 03 ff 05 0f 85 90 00 } //2
