...
rule PWS_Win32_Lineage_gen_E{
	meta:
		description = "PWS:Win32/Lineage.gen!E,SIGNATURE_TYPE_PEHSTR_EXT,05 00 05 00 05 00 00 01 00 "
		
	strings :
		$a_00_0 = {2e 62 61 74 00 00 6f 70 65 6e } //01 00 
		...
		$a_01_3 = {33 46 44 45 42 31 37 31 2d 38 46 38 36 2d 39 35 35 38 2d 30 30 30 31 2d 36 39 42 38 44 42 35 35 33 36 38 33 } //01 00  3FDEB171-8F86-9558-0001-69B8DB553683
		$a_01_4 = {73 79 73 74 65 6d 33 32 5c 73 79 73 6a 70 69 65 00 } //00 00 
	condition:
		any of ($a_*)
