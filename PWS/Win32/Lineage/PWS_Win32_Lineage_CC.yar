...
rule PWS_Win32_Lineage_CC{
	...
	strings :
		...
		$a_01_1 = {56 49 52 55 53 5f 41 53 4d 41 50 49 4e 47 5f 58 5a 41 53 44 57 52 54 54 59 45 45 57 44 38 32 34 37 33 4d } //01 00  VIRUS_ASMAPING_XZASDWRTTYEEWD82473M
		$a_00_2 = {43 72 65 61 74 65 4d 75 74 65 78 41 } //01 00  CreateMutexA
		$a_00_3 = {4f 70 65 6e 4d 75 74 65 78 41 } //00 00  OpenMutexA
	condition:
		any of ($a_*)
