...
rule PWS_Win32_Savnut_F{
	...
	strings :
		...
		$a_01_1 = {5c 73 72 76 62 6c 63 6b 32 2e 74 6d 70 } //01 00 
		$a_01_2 = {62 61 6e 6b 63 68 61 6e 67 65 68 6f 73 74 3a } //01 00 
		$a_01_3 = {5c 75 72 68 74 70 73 2e 64 61 74 } //01 00 
		$a_01_4 = {25 73 5c 25 73 5f 25 30 38 64 2e 6d 70 73 74 } //00 00 
	condition:
		any of ($a_*)
