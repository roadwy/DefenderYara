...
rule PWS_Win32_Iorgut_A{
	...
	strings :
		$a_03_0 = {bb 01 00 00 00 8d 45 f4 8b 55 fc 0f b6 54 1a ff 2b d3 90 03 01 01 81 83 ea 90 02 04 e8 90 01 03 ff 8b 55 f4 8d 45 f8 e8 90 01 03 ff 43 4e 75 90 00 } //10
