...
rule PWS_Win32_Tibia_C{
	...
	strings :
		...
		$a_02_3 = {6a 00 6a 00 68 90 01 02 40 00 ff 35 90 01 02 40 00 68 90 01 02 40 00 8d 45 cc ba 03 00 00 00 e8 90 01 02 ff ff 8b 45 cc e8 90 01 02 ff ff 50 68 90 01 02 40 00 68 90 01 02 40 00 6a 00 e8 90 01 02 ff ff e8 90 01 02 ff ff 33 c0 5a 59 59 64 89 10 90 00 } //10
		...
		$a_02_5 = {68 74 74 70 3a 2f 2f 90 02 10 2f 76 69 70 2f 64 6f 64 61 6a 2e 70 68 70 3f 6c 6f 67 69 6e 3d 90 00 } //1
