...
rule PWS_Win32_Tibia_BY{
	...
	strings :
		$a_03_0 = {47 45 54 20 2f 75 ?? ?? 2e 70 68 70 3f 64 61 74 61 3d 00 26 73 69 64 3d 00 20 48 54 54 50 2f 31 2e 31 0d 0a 00 48 6f 73 74 3a 20 77 77 77 2e 75 61 6e 65 73 6b 65 79 6c 6f 67 67 65 72 2e 70 6c } //10
