...
rule PWS_Win32_Tibia_N{
	...
	strings :
		$a_00_0 = {25 73 5c 73 79 73 74 65 6d 33 32 5c 64 72 69 76 65 72 73 5c 65 74 63 5c 68 6f 73 74 73 } //01 00  %s\system32\drivers\etc\hosts
		$a_00_1 = {70 72 6f 67 72 61 6d 66 69 6c 65 73 } //01 00  programfiles
		$a_00_2 = {25 73 5c 49 6e 74 65 72 6e 65 74 20 45 78 70 6c 6f 72 65 72 5c } //01 00  %s\Internet Explorer\
		$a_00_3 = {6c 73 61 73 73 2e 65 78 65 } //01 00  lsass.exe
		$a_00_4 = {53 6f 66 74 77 61 72 65 5c 4d 69 63 72 6f 73 6f 66 74 5c 57 69 6e 64 6f 77 73 5c 43 75 72 72 65 6e 74 56 65 72 73 69 6f 6e 5c 52 75 6e 5c } //01 00  Software\Microsoft\Windows\CurrentVersion\Run\
		$a_00_5 = {6f 77 6e 74 69 62 69 61 2e 63 6f 6d } //01 00  owntibia.com
		...
		$a_00_7 = {54 69 62 69 61 43 6c 69 65 6e 74 } //01 00  TibiaClient
		$a_00_8 = {53 68 65 6c 6c 45 78 65 63 75 74 65 41 } //01 00  ShellExecuteA
		$a_00_9 = {31 32 37 2e 30 2e 30 2e 31 20 20 20 20 20 20 20 6c 6f 63 61 6c 68 6f 73 74 } //0a 00  127.0.0.1       localhost
