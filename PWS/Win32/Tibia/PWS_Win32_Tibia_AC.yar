...
rule PWS_Win32_Tibia_AC{
	...
	strings :
		$a_03_0 = {05 8d 34 b6 81 c6 90 01 02 62 00 90 09 16 00 b8 90 01 02 62 00 e8 90 01 02 ff ff 88 04 24 90 01 02 0f b6 c3 8b f0 c1 e6 90 00 } //10
		$a_03_1 = {ff 0f 1f 00 e8 90 09 04 00 50 6a 00 68 90 00 } //10
		$a_03_2 = {7e 27 be 01 00 00 00 8d 45 f4 8b 55 fc 0f b6 54 32 ff 83 ea 03 e8 90 01 03 ff 8b 55 f4 8d 45 f8 e8 90 01 03 ff 46 4b 75 de 90 00 } //3
