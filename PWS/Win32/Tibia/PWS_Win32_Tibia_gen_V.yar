...
rule PWS_Win32_Tibia_gen_V{
	...
	strings :
		...
		$a_00_1 = {46 67 79 74 74 66 72 6a } //01 00  Fgyttfrj
		$a_00_2 = {74 6b 6f 68 71 69 } //01 00  tkohqi
		$a_00_3 = {46 47 47 76 69 64 65 } //01 00  FGGvide
		$a_00_4 = {6d 74 70 6b 7a 58 6d 6b 6c 65 67 76 } //00 00  mtpkzXmklegv
	condition:
		any of ($a_*)
