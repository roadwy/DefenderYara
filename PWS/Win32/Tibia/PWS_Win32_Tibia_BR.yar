...
rule PWS_Win32_Tibia_BR{
	...
	strings :
		...
		$a_01_1 = {61 63 63 6f 75 6e 74 2f 3f 73 75 62 74 6f 70 69 63 3d } //0a 00 
		$a_00_2 = {73 6f 66 74 77 61 72 65 5c 6d 69 63 72 6f 73 6f 66 74 5c 77 69 6e 64 6f 77 73 5c 63 75 72 72 65 6e 74 76 65 72 73 69 6f 6e 5c 72 75 6e } //01 00 
		$a_01_3 = {26 6c 6f 67 69 6e 70 61 73 73 77 6f 72 64 3d 00 } //01 00 
