...
rule PWS_Win32_Tibia_J{
	...
	strings :
		$a_00_0 = {54 69 62 69 61 2e 65 78 65 } //0a 00 
		$a_00_1 = {77 77 77 2e 74 69 62 69 61 2e 73 74 65 61 6c 65 72 2e } //0a 00 
		...
		$a_00_3 = {26 61 63 63 6f 75 6e 74 3d } //01 00 
		$a_00_4 = {26 68 61 73 6c 6f 3d } //01 00 
