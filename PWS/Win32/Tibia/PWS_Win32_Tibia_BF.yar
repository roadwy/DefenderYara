...
rule PWS_Win32_Tibia_BF{
	...
	strings :
		...
		$a_01_1 = {74 62 69 5f 64 61 74 61 30 00 } //01 00  扴彩慤慴0
		$a_01_2 = {38 37 2e 39 38 2e 31 34 31 2e 31 33 30 00 } //01 00  㜸㤮⸸㐱⸱㌱0
		$a_01_3 = {5b 00 44 00 45 00 42 00 55 00 47 00 5d 00 } //01 00  [DEBUG]
