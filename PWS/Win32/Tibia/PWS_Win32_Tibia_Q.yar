...
rule PWS_Win32_Tibia_Q{
	...
	strings :
		$a_03_0 = {b8 b4 c2 76 00 e8 90 01 02 ff ff 8d 4d 90 01 01 8b 15 90 01 03 00 b8 94 c2 76 00 e8 90 01 02 ff ff 8b 15 90 01 03 00 b8 c8 c2 76 00 e8 90 01 02 ff ff 90 00 } //10
		...
		$a_02_3 = {6c 6f 67 69 6e 90 02 02 2e 74 69 62 69 61 2e 63 6f 6d 90 00 } //10
