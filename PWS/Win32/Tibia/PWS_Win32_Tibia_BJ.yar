...
rule PWS_Win32_Tibia_BJ{
	...
	strings :
		$a_00_0 = {3a 74 74 69 62 69 61 2e 3a 31 28 } //01 00 
		$a_00_1 = {61 63 63 6f 75 6e 74 5f 6e 61 6d 65 } //01 00 
		$a_00_2 = {61 63 63 6f 75 6e 74 5f 70 61 73 73 77 6f 72 64 } //02 00 
