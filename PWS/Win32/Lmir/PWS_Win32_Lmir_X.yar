...
rule PWS_Win32_Lmir_X{
	...
	strings :
		...
		$a_01_3 = {66 69 6c 74 72 65 73 25 64 2e 73 61 76 } //01 00 
		$a_01_4 = {66 6f 65 6d 61 6e 25 64 2e 73 61 76 } //02 00 
		$a_01_5 = {2e 64 6c 6c 00 49 6e 73 74 48 6f 6f 6b 50 72 6f 63 00 55 6e 49 6e 73 74 48 6f 6f 6b 50 72 6f 63 } //00 00 
	condition:
		any of ($a_*)
