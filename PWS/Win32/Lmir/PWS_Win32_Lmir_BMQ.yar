...
rule PWS_Win32_Lmir_BMQ{
	...
	strings :
		$a_02_0 = {73 6f 75 6c c7 45 90 01 01 2e 65 78 65 90 00 } //2
		$a_02_1 = {41 75 74 6f c7 45 90 01 01 50 61 74 63 c7 45 90 01 01 68 2e 65 78 c7 45 90 01 01 65 00 00 00 90 00 } //2
		$a_02_2 = {2e 5c 73 6f c7 45 90 01 01 75 6c 2e 65 c7 45 90 01 01 78 65 00 00 90 00 } //2
