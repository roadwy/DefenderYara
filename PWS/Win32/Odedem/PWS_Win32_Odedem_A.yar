...
rule PWS_Win32_Odedem_A{
	...
	strings :
		$a_03_0 = {f6 c3 01 c6 02 00 74 2a bf 90 01 04 83 c9 ff 90 00 } //2
		$a_03_1 = {83 c9 02 eb 3e 68 90 01 04 55 e8 90 01 02 00 00 83 c4 08 85 c0 74 0e 8b 84 24 90 01 02 00 00 8b 08 83 c9 04 eb 1e 90 00 } //2
