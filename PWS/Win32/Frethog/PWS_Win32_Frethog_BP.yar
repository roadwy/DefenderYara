...
rule PWS_Win32_Frethog_BP{
	...
	strings :
		$a_00_0 = {26 68 61 76 65 6d 69 62 61 6f 3d 00 26 70 61 73 73 77 6f 72 64 32 3d 00 26 6d 6f 6e 65 79 3d 00 26 6c 65 76 65 6c } //01 00  栦癡浥扩潡=瀦獡睳牯㉤=洦湯祥=氦癥汥
		$a_00_1 = {43 3a 5c 57 49 4e 44 4f 57 53 5c 64 6e 66 2e 69 6e 69 } //01 00  C:\WINDOWS\dnf.ini
