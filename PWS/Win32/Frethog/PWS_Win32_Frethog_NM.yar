...
rule PWS_Win32_Frethog_NM{
	...
	strings :
		...
		$a_00_1 = {73 62 61 6e 6e 65 72 3d 79 65 73 26 6c 6f 67 69 6e 6e 61 6d 65 3d 64 66 } //01 00 
		$a_00_2 = {73 65 64 2e 64 72 61 75 47 65 6d 61 47 } //01 00 
		$a_00_3 = {47 4f 4f 44 42 4f 59 } //0a 00 
