...
rule PWS_Win32_Frethog_BW{
	...
	strings :
		...
		$a_00_1 = {41 63 63 65 70 74 3a 20 2a 2f 2a 00 48 54 54 50 2f 31 2e 30 } //01 00 
		$a_00_2 = {2f 63 68 64 2f 73 65 6e 64 6d 61 69 6c 2e 61 73 70 } //01 00 
		$a_00_3 = {69 6e 66 5c 44 6c 6c 41 64 64 72 65 73 73 2e 69 6e 69 } //01 00 
