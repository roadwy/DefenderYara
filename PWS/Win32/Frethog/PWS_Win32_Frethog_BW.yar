...
rule PWS_Win32_Frethog_BW{
	...
	strings :
		...
		$a_02_4 = {53 65 72 76 3d 90 02 0f 43 61 6e 6b 3d 90 02 0f 4c 65 76 65 3d 90 02 0f 4e 61 6d 65 3d 90 00 } //1
		$a_02_5 = {4d 69 62 61 6f 3d 90 02 0f 43 68 61 6e 67 3d 90 02 0f 44 69 61 6e 3d 90 00 } //1
	condition:
