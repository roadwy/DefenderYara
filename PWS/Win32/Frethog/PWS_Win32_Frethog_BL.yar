...
rule PWS_Win32_Frethog_BL{
	...
	strings :
		...
		$a_00_3 = {25 73 5c 64 6c 6c 63 61 63 68 65 5c 25 73 2e 6a 70 67 } //01 00  %s\dllcache\%s.jpg
		$a_00_4 = {6d 69 62 61 6f 2e 61 73 70 } //01 00  mibao.asp
		$a_00_5 = {25 73 3f 61 63 74 3d 67 65 74 70 6f 73 26 64 31 30 3d 25 73 26 70 6f 73 3d 26 64 38 30 3d } //01 00  %s?act=getpos&d10=%s&pos=&d80=
		$a_00_6 = {25 73 25 73 25 73 2d 25 64 2e 62 6d 70 } //00 00  %s%s%s-%d.bmp
	condition:
		any of ($a_*)
