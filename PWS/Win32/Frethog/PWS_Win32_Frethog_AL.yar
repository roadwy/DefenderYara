...
rule PWS_Win32_Frethog_AL{
	...
	strings :
		$a_01_0 = {57 72 69 74 65 50 72 6f 63 65 73 73 4d 65 6d 6f 72 79 } //05 00 
		$a_03_1 = {8b 44 24 04 03 c1 80 30 90 01 01 41 3b 4c 24 08 7c f0 90 00 } //03 00 
		$a_01_2 = {3d 25 73 26 73 72 76 3d 25 73 26 69 64 31 3d 25 73 26 64 6a 31 3d 25 73 26 70 63 3d 25 73 } //05 00 
