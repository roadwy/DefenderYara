...
rule PWS_Win32_Frethog_gen_I{
	...
	strings :
		...
		$a_00_1 = {50 72 6f 64 75 63 74 5f 4e 6f 74 69 66 69 63 61 } //02 00 
		...
		$a_00_4 = {43 75 72 72 65 6e 74 56 65 72 73 69 6f 6e 5c 52 75 6e } //02 00 
		$a_00_5 = {72 75 6e 64 6c 31 33 32 2e 65 78 65 } //02 00 
		...
		$a_00_9 = {54 65 72 6d 69 6e 61 74 65 50 72 6f 63 65 73 73 } //01 00 
		$a_01_10 = {43 72 65 61 74 65 52 65 6d 6f 74 65 54 68 72 65 61 64 } //00 00 
	condition:
		any of ($a_*)
