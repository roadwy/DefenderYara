...
rule PWS_Win32_Frethog_MR{
	...
	strings :
		...
		$a_01_5 = {49 44 52 5f 44 4c 4c 00 } //00 00  䑉归䱄L
	condition:
		any of ($a_*)
...
rule PWS_Win32_Frethog_MR_2{
	...
	strings :
		...
		$a_00_1 = {25 73 3a 5c 50 72 6f 67 72 61 6d 20 46 69 6c 65 73 5c 43 6f 6d 6d 6f 6e 20 46 69 6c 65 73 5c 25 73 } //01 00  %s:\Program Files\Common Files\%s
		...
		$a_00_3 = {25 73 3f 6e 3d 25 73 26 70 3d 25 73 26 6c 3d 25 73 } //01 00  %s?n=%s&p=%s&l=%s
		$a_01_4 = {4a 4d 56 5f 56 4d 4a 00 } //01 00  䵊彖䵖J
