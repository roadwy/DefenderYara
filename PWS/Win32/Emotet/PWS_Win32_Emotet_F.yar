...
rule PWS_Win32_Emotet_F{
	...
	strings :
		...
		$a_03_4 = {6a 64 33 d2 59 f7 f1 83 f8 02 74 05 6a 02 58 eb 15 8b 35 90 01 04 57 ff d6 ff 75 90 90 ff d6 ff 75 88 ff d6 33 c0 90 00 } //1
		$a_03_5 = {33 d2 6a 64 59 f7 f1 83 f8 02 74 05 6a 02 58 eb 11 56 8b 35 90 01 04 ff d6 53 ff d6 57 ff d6 33 c0 90 00 } //1
	condition:
