...
rule PWS_Win32_Emotet_E{
	...
	strings :
		...
		$a_03_4 = {6a 00 6a 1a 68 90 01 04 6a 00 ff 15 90 01 04 b8 90 01 04 c3 90 00 } //1
		$a_03_5 = {6a 00 6a 1a 68 90 01 04 6a 00 ff d7 90 00 } //1
		$a_03_6 = {b8 1f 85 eb 51 f7 64 24 90 01 01 c1 ea 05 83 fa 02 74 07 b8 02 00 00 00 eb 11 56 8b 35 90 01 04 ff d6 57 ff d6 53 ff d6 33 c0 90 00 } //10
	condition:
