...
rule PWS_Win32_Ldpinch_BK{
	...
	strings :
		...
		$a_01_2 = {2a 2a 52 65 74 43 6f 64 65 3a 20 00 } //01 00  ⨪敒䍴摯㩥 
		$a_01_3 = {68 74 74 70 73 65 6e 64 2e 64 6c 6c 00 49 45 43 6c 65 61 6e 55 70 00 49 45 49 6e 69 74 00 } //00 00  瑨灴敳摮搮汬䤀䍅敬湡灕䤀䥅楮t
	condition:
		any of ($a_*)
