...
rule PWS_Win32_Ldpinch_ZH{
	...
	strings :
		...
		$a_01_1 = {63 3a 5c 77 69 6e 64 6f 77 73 5c 73 79 73 74 65 6d 33 32 5c 69 70 2e 74 78 74 } //01 00 
		$a_01_2 = {51 51 2e 65 78 65 } //01 00 
		$a_01_3 = {33 36 35 32 30 36 39 38 38 40 71 71 2e 63 6f 6d } //00 00 
	condition:
		any of ($a_*)
