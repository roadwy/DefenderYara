...
rule PWS_Win32_Prefsap{
	...
	strings :
		$a_03_0 = {6a 0d 6a 7c ff 75 dc ff 75 e0 e8 ?? ?? 00 00 6a 0a 6a 5e ff 75 dc ff 75 e0 e8 ?? ?? 00 00 ff 75 e8 ff 75 ec 6a ff ff 75 e0 ff 75 f0 68 ?? ?? 00 10 ff 35 ?? ?? ?? ?? c3 83 f8 01 74 02 eb } //2
		$a_01_1 = {8a 07 3c 41 72 08 3c 5a 77 04 04 20 eb 0a 3c 61 72 06 3c 7a 77 02 2c 20 88 07 47 49 0b c9 75 e0 } //1
		$a_03_2 = {24 3f 3c 3e 73 12 3c 34 73 0a 04 41 3c 5b 72 0f 04 06 eb 0b 04 fc eb 07 2c 3e c0 e0 02 04 2b 90 09 05 00 c1 c2 06 } //1
