...
rule PWS_Win32_Lolyda_BE{
	...
	strings :
		...
		$a_01_1 = {61 63 3d 75 70 26 7a 7a 7a 3d 65 78 6b 26 64 64 32 3d } //01 00  ac=up&zzz=exk&dd2=
		$a_01_2 = {61 63 3d 75 70 26 7a 7a 7a 3d 6f 6c 26 64 64 32 3d } //00 00  ac=up&zzz=ol&dd2=
	condition:
		any of ($a_*)
