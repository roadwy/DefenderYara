...
rule PWS_Win32_Lolyda_BJ{
	...
	strings :
		...
		$a_01_1 = {41 65 6c 69 46 79 70 6f 43 } //01 00 
		$a_01_2 = {73 77 6f 64 6e 69 57 6d 75 6e 45 } //01 00 
		$a_01_3 = {4d 41 43 3a 25 30 32 58 2d 25 30 32 58 2d } //01 00 
		$a_00_4 = {25 73 25 64 2e 64 6c 6c } //01 00 
