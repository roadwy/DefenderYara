...
rule PWS_Win32_Lolyda_C{
	...
	strings :
		...
		$a_00_1 = {00 22 25 73 22 00 30 34 33 30 } //0a 00 
		$a_80_2 = {4d 5a 4b 45 52 4e 45 4c 33 32 2e 44 4c 4c } //MZKERNEL32.DLL  0a 00 
		$a_00_3 = {53 69 7a 65 6f 66 52 65 73 6f 75 72 63 65 } //0a 00 
		$a_00_4 = {46 69 6e 64 52 65 73 6f 75 72 63 65 41 } //0a 00 
		$a_00_5 = {52 74 6c 5a 65 72 6f 4d 65 6d 6f 72 79 } //0a 00 
