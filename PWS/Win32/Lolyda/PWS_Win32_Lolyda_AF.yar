...
rule PWS_Win32_Lolyda_AF{
	...
	strings :
		...
		$a_03_1 = {4e 75 f4 5e 90 09 09 00 8a 14 90 01 01 80 ea 90 01 01 88 90 00 } //1
		$a_02_2 = {66 6f 6e 74 73 5c 67 74 68 90 0f 05 00 2e 90 03 03 03 66 6f 6e 74 74 66 90 00 } //1
