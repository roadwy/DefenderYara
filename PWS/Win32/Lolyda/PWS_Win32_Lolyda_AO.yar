...
rule PWS_Win32_Lolyda_AO{
	...
	strings :
		$a_03_0 = {4b c6 44 24 90 01 01 56 c6 44 24 90 01 01 4d c6 44 24 90 01 01 6f c6 44 24 90 01 01 6e c6 44 24 90 01 01 58 c6 44 24 90 01 01 50 c6 44 24 90 01 01 2e 90 00 } //2
		$a_03_1 = {68 ec fe ff ff 56 ff d7 8d 54 24 90 01 01 6a 00 52 8d 84 24 90 01 02 00 00 68 14 01 00 00 90 00 } //2
		$a_03_2 = {8a 04 33 04 90 01 01 34 90 01 01 2c 90 01 01 88 06 90 02 05 47 55 46 ff 15 90 01 04 3b f8 7c 90 00 } //2
