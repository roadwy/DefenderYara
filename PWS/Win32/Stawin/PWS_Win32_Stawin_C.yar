...
rule PWS_Win32_Stawin_C{
	...
	strings :
		...
		$a_01_1 = {47 65 74 4b 65 79 62 6f 61 72 64 53 74 61 74 65 } //02 00  GetKeyboardState
		$a_01_2 = {48 6f 6f 6b 65 72 2e 64 6c 6c } //02 00  Hooker.dll
		$a_01_3 = {43 69 74 69 62 61 6e 6b } //00 00  Citibank
	condition:
		any of ($a_*)
