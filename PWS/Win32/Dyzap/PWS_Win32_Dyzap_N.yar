...
rule PWS_Win32_Dyzap_N{
	...
	strings :
		$a_03_0 = {83 c4 04 85 c0 74 15 8d 8d 40 fa ff ff 51 8d 85 10 fd ff ff e8 90 01 04 83 c4 04 6a 00 ff 15 90 00 } //1
		$a_03_1 = {8b d7 52 8d 85 90 01 04 33 c9 50 66 89 4d 90 01 01 ff d3 68 90 01 04 8d 8d 90 01 04 51 ff d3 8d 95 90 00 } //1
		...
		$a_03_8 = {69 72 74 75 61 6c 41 6c 6c 6f 63 00 90 09 02 00 00 90 04 01 06 41 2d 55 57 2d 5a 90 00 } //1
