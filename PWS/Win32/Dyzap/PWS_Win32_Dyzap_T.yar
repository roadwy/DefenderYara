...
rule PWS_Win32_Dyzap_T_2{
	...
	strings :
		...
		$a_81_3 = {47 6c 6f 62 61 6c 5c 75 31 6e 79 6a 33 72 74 32 30 } //01 00 
		$a_01_4 = {5c 00 5c 00 2e 00 5c 00 70 00 69 00 70 00 65 00 5c 00 67 00 32 00 66 00 61 00 62 00 67 00 35 00 37 00 31 00 33 00 } //00 00 
		$a_00_5 = {78 9f } //00 00 
	condition:
		any of ($a_*)
...
rule PWS_Win32_Dyzap_T_3{
	...
	strings :
		...
		$a_01_2 = {74 00 65 00 6d 00 70 00 00 00 00 00 67 00 75 00 70 00 64 00 61 00 74 00 65 00 } //01 00 
		$a_81_3 = {47 6c 6f 62 61 6c 5c 74 31 6e 79 6a 33 72 74 32 30 } //01 00 
		$a_01_4 = {5c 00 5c 00 2e 00 5c 00 70 00 69 00 70 00 65 00 5c 00 67 00 32 00 66 00 61 00 62 00 67 00 35 00 37 00 31 00 33 00 } //00 00 
		$a_00_5 = {80 10 } //00 00 
	condition:
		any of ($a_*)
