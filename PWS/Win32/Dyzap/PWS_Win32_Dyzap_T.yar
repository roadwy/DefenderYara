...
rule PWS_Win32_Dyzap_T{
	...
	strings :
		...
		$a_03_1 = {c6 45 f3 75 c6 45 f7 6a ff 15 90 01 04 85 c0 74 11 90 00 } //1
		$a_01_2 = {ff d0 6a 04 68 00 30 00 00 68 00 00 02 00 6a 00 89 44 24 34 ff 54 24 28 8b f8 } //1
		$a_03_3 = {c6 45 f0 50 ff 15 90 01 04 50 ff 15 90 01 04 8b 4d 08 51 6a 00 68 08 04 00 00 90 00 } //1
	condition:
...
rule PWS_Win32_Dyzap_T_2{
	...
	strings :
		...
		$a_03_1 = {c7 85 38 f2 ff ff 73 65 78 65 ff 15 90 01 04 8d 90 00 } //1
