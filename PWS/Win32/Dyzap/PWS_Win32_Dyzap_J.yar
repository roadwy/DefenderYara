...
rule PWS_Win32_Dyzap_J{
	...
	strings :
		$a_03_0 = {81 e3 ff 00 00 00 0f b6 9b 90 01 04 33 14 9d 90 01 04 03 c1 89 16 03 f1 ff 4d f8 75 90 01 01 4f 83 e8 20 90 00 } //1
		...
		$a_03_2 = {0f b6 58 0d 0f b6 40 0c c1 e7 08 0b fb c1 e7 08 0b f8 33 79 0c 8b 45 08 83 c1 10 83 7d 0c 00 89 7d f8 0f 85 90 01 04 8b 18 d1 fb 90 00 } //1
	condition:
...
rule PWS_Win32_Dyzap_J_2{
	...
	strings :
		$a_03_0 = {81 e3 ff 00 00 00 0f b6 9b 90 01 04 33 14 9d 90 01 04 03 c1 89 16 03 f1 ff 4d f8 75 90 01 01 4f 83 e8 20 90 00 } //5
