...
rule PWS_Win32_Bistik_A{
	...
	strings :
		$a_03_0 = {be 88 00 00 00 57 56 6a 01 53 e8 ?? ?? ?? ?? 57 e8 ?? ?? ?? ?? 83 c4 14 33 c0 8a c8 80 c1 ?? 30 0c 18 40 3b c6 72 f3 6a 01 58 } //2
		$a_02_1 = {89 5d fc 8d 45 ?? 66 0f be 91 ?? ?? ?? ?? c1 e2 02 66 89 10 41 40 40 83 f9 ?? 7c ea 8d 45 ?? c7 45 e0 4a 00 00 00 89 45 } //1
