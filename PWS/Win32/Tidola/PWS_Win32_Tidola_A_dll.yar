...
rule PWS_Win32_Tidola_A_dll{
	...
	strings :
		...
		$a_02_2 = {47 61 6d 65 3d [0-03] 26 70 61 72 61 3d 25 73 26 25 76 65 73 3d [0-03] 26 64 31 30 3d 25 73 26 64 31 31 3d 25 73 26 64 30 30 3d 25 73 26 64 30 31 3d 25 73 26 64 32 30 3d 25 73 3a 25 73 25 25 32 30 25 73 3a 25 73 25 25 32 30 25 73 3a 25 73 26 64 37 30 3d 25 64 26 64 39 30 3d 25 64 } //1
		...
		$a_00_9 = {43 72 6f 73 73 4c 69 6e 6b 53 56 43 } //-100 CrossLinkSVC
	condition:
