...
rule PWS_Win32_Wowsteal_AK{
	...
	strings :
		$a_02_0 = {6a 10 50 6a 00 c7 45 e0 01 00 00 00 ff 75 fc c7 45 ec 02 00 00 00 ff 15 90 01 02 00 10 85 c0 90 00 } //10
		...
		$a_02_4 = {6c 6f 67 69 6e 90 05 06 01 00 46 46 58 69 90 00 } //1
