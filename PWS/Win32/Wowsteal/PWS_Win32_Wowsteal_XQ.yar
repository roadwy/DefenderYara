...
rule PWS_Win32_Wowsteal_XQ{
	meta:
		description = "PWS:Win32/Wowsteal.XQ,SIGNATURE_TYPE_PEHSTR_EXT,07 00 07 00 07 00 00 01 00 "
		
	strings :
		$a_00_0 = {4c 61 54 61 6c 65 43 6c 69 65 6e 74 2e 45 58 45 } //01 00  LaTaleClient.EXE
		$a_00_1 = {67 61 6d 65 63 6c 69 65 6e 74 2e 65 78 65 } //01 00  gameclient.exe
		$a_01_2 = {63 61 62 61 6c 6d 61 69 6e 2e 65 78 65 } //01 00  cabalmain.exe
