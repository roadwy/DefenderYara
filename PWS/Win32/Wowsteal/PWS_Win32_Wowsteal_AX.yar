...
rule PWS_Win32_Wowsteal_AX{
	...
	strings :
		...
		$a_00_4 = {00 47 78 57 69 6e 64 6f 77 43 6c 61 73 73 44 33 64 00 } //01 00  䜀坸湩潤䍷慬獳㍄d
		$a_00_5 = {3a 36 35 31 35 31 2f 64 6a 62 7a 63 64 2f 69 2e 61 73 70 } //00 00  :65151/djbzcd/i.asp
	condition:
		any of ($a_*)
