...
rule PWS_Win32_Wowsteal_gen_C{
	...
	strings :
		...
		$a_03_2 = {b8 65 78 65 00 8b 35 90 01 04 89 45 f8 89 45 c8 8d 45 f0 33 db 50 c7 45 f0 33 36 30 54 ff 75 08 c7 45 f4 72 61 79 2e 89 5d fc c7 45 c0 33 36 30 53 c7 45 c4 61 66 65 2e 89 5d cc ff d6 90 00 } //1
