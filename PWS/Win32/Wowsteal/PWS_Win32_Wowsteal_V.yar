...
rule PWS_Win32_Wowsteal_V{
	...
	strings :
		...
		$a_00_1 = {69 66 20 65 78 69 73 74 } //01 00  if exist
		$a_00_2 = {57 6f 72 6c 64 20 6f 66 20 57 61 72 63 72 61 66 74 } //01 00  World of Warcraft
		$a_00_3 = {57 4f 57 2e 45 58 45 } //01 00  WOW.EXE
		$a_00_4 = {47 78 57 69 6e 64 6f 77 43 6c 61 73 73 44 33 64 } //01 00  GxWindowClassD3d
