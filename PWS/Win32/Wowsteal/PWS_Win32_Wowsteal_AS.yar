...
rule PWS_Win32_Wowsteal_AS{
	...
	strings :
		...
		$a_01_2 = {25 73 2f 63 2e 61 73 70 3f 63 3d 71 26 69 3d 25 73 00 } //01 00  猥振愮灳挿焽椦┽s
		$a_01_3 = {26 75 3d 25 73 26 70 3d 25 73 26 73 70 3d 25 73 26 6d 62 3d 25 73 26 72 3d 25 73 26 6c 3d 25 64 26 6d 3d 25 64 00 } //00 00  甦┽♳㵰猥猦㵰猥洦㵢猥爦┽♳㵬搥洦┽d
	condition:
		any of ($a_*)
