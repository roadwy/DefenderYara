...
rule PWS_Win32_Bzub{
	...
	strings :
		...
		$a_00_7 = {70 64 66 73 64 6b 63 6f 6d 2e 44 4c 4c } //9c ff 
		$a_00_8 = {2e 76 69 76 69 64 61 73 2e 63 6f 6d 2f 70 6c 61 79 65 72 } //fb ff 
		$a_00_9 = {4f 43 58 50 4c 41 59 2e 56 50 6c 61 79 65 72 50 72 6f 70 50 61 67 65 2e 31 } //9c ff 
		$a_00_10 = {56 65 72 79 50 44 46 } //9c ff 
		$a_00_11 = {00 6d 61 78 74 68 6f 6e 5f 70 72 65 66 2e 64 6c 6c 00 } //9c ff 
		$a_00_12 = {00 67 65 74 5f 6d 61 78 74 68 6f 6e 5f 68 6f 6d 65 70 61 67 65 00 } //9c ff 
		$a_00_13 = {00 73 65 74 5f 6d 61 78 74 68 6f 6e 33 5f 66 61 76 6f 72 69 74 65 73 00 } //9c ff 
		$a_00_14 = {00 73 65 74 5f 6d 61 78 74 68 6f 6e 35 5f 66 61 76 6f 72 69 74 65 73 00 } //9c ff 
		$a_00_15 = {00 73 65 74 5f 77 6e 69 65 5f 66 61 76 6f 72 69 74 65 73 00 } //00 00 
	condition:
		any of ($a_*)
