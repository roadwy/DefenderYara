...
rule PWS_Win32_Kapod_B{
	...
	strings :
		...
		$a_00_1 = {72 65 67 73 69 64 2e 70 68 70 3f 77 69 6e 64 6f 77 73 5f 6e 61 6d 65 3d } //05 00 
		$a_02_2 = {2e 6e 65 2e 6a 70 2f 90 02 10 2e 70 68 70 90 00 } //05 00 
		$a_00_3 = {5f 73 74 6f 70 2e 65 78 65 2e 74 78 74 } //01 00 
		$a_00_4 = {26 65 6d 61 69 6c 5f 6e 61 6d 65 3d } //01 00 
		$a_00_5 = {26 75 72 6c 5f 61 3d } //00 00 
	condition:
		any of ($a_*)
