...
rule PWS_Win32_Simda_gen_F{
	...
	strings :
		...
		$a_01_1 = {64 61 62 65 74 72 65 73 77 65 35 70 75 70 68 45 67 61 77 72 65 64 65 33 72 65 73 77 75 73 61 } //01 00 
		$a_01_2 = {26 63 6f 6d 6d 61 6e 64 3d 62 63 5f 61 63 74 69 76 61 74 65 26 73 74 61 74 75 73 3d } //00 00 
	condition:
		any of ($a_*)
