...
rule PWS_Win32_Sinowal_gen_X{
	...
	strings :
		$a_03_0 = {83 7d fc 1d 90 03 04 05 73 90 01 01 0f 83 90 01 04 90 03 05 06 8b 55 90 01 01 ff 75 90 01 01 5a c1 e2 04 90 03 05 06 8b 45 90 01 01 ff 75 90 01 01 58 c1 e8 05 90 00 } //10
		$a_01_1 = {03 44 11 0c 50 e8 } //10
		$a_03_2 = {42 65 65 70 90 09 02 00 81 90 03 01 01 38 3a 90 01 04 90 03 01 02 74 0f 84 90 00 } //10
		...
		$a_03_13 = {81 7d f4 54 bc 00 00 90 03 01 02 73 0f 83 90 00 } //1
		$a_01_14 = {81 7d fc 54 bc 00 00 73 } //1
		$a_01_15 = {81 7d fc 50 c3 00 00 73 } //1
		$a_01_16 = {81 7d fc c1 c3 00 00 73 } //1
		$a_03_17 = {81 7d f4 58 cc 00 00 90 03 01 02 73 0f 83 90 00 } //1
