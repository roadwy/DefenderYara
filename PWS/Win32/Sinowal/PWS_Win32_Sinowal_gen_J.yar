...
rule PWS_Win32_Sinowal_gen_J{
	...
	strings :
		$a_03_0 = {ff 15 20 b0 40 00 90 90 ff 25 90 01 02 40 00 90 02 07 90 90 ff 25 90 00 } //3
		$a_03_1 = {68 04 1b 40 00 90 90 ff 25 90 01 02 40 00 90 02 07 90 90 ff 25 90 00 } //3
