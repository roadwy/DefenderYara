...
rule PWS_Win32_Sinowal_AJ{
	...
	strings :
		...
		$a_00_3 = {66 64 73 6b 73 64 2e 70 64 62 } //0a 00  fdsksd.pdb
		$a_00_4 = {00 70 64 62 2e 70 64 62 00 } //0a 00 
		$a_00_5 = {34 66 62 64 73 76 39 38 34 6f 2e 70 64 62 } //0a 00  4fbdsv984o.pdb
		$a_00_6 = {6d 73 64 74 63 64 62 67 64 62 67 2e 70 64 62 } //00 00  msdtcdbgdbg.pdb
	condition:
		any of ($a_*)
