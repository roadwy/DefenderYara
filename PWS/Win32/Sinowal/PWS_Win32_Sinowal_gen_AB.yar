...
rule PWS_Win32_Sinowal_gen_AB{
	...
	strings :
		...
		$a_01_5 = {2f 54 20 2f 67 72 61 6e 74 20 2a 53 2d 31 2d 31 2d 30 3a 46 } //01 00 
		$a_01_6 = {26 69 74 61 67 3d 6f 64 79 26 71 3d 25 73 25 25 32 43 25 30 32 78 } //00 00 
	condition:
		any of ($a_*)
