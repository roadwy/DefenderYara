...
rule PWS_Win32_Sinowal_gen_P{
	...
	strings :
		...
		$a_03_5 = {b8 00 00 00 00 05 90 01 04 90 03 01 08 50 83 ec 04 89 90 01 01 24 90 00 } //1
		$a_01_6 = {0f b7 51 12 81 e2 00 20 00 00 } //1
		$a_01_7 = {b8 00 00 d9 6e 0d a1 eb 00 00 } //1
		$a_03_8 = {89 45 f0 b8 90 01 04 05 90 01 04 89 45 f4 90 09 0a 00 b8 90 01 04 2d 90 00 } //1
	condition:
