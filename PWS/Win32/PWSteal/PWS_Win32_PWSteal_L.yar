...
rule PWS_Win32_PWSteal_L{
	...
	strings :
		$a_02_0 = {85 c0 0f 84 90 01 02 00 00 b9 10 00 00 00 b8 90 90 90 90 90 90 90 90 8d bc 24 90 01 01 00 00 00 f3 ab 8d 84 24 90 01 02 00 00 8d 8c 24 90 01 01 00 00 00 90 00 } //10
		...
		$a_02_3 = {44 6f 6d 61 69 6e 3a 90 02 05 25 53 90 00 } //1
		$a_02_4 = {55 73 65 72 3a 90 02 05 25 53 90 00 } //1
		$a_02_5 = {50 61 73 73 77 6f 72 64 3a 90 02 05 25 53 90 00 } //1
	condition:
