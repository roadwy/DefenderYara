...
rule PWS_Win32_PWSteal_I{
	...
	strings :
		$a_00_0 = {5c 4d 6f 7a 69 6c 6c 61 5c 46 69 72 65 66 6f 78 5c 70 72 6f 66 69 6c 65 73 2e 69 6e 69 } //01 00 
		$a_01_1 = {46 69 72 65 66 6f 78 20 53 74 65 61 6c 65 72 } //01 00 
