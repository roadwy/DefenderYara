...
rule PWS_Win32_PWSteal_R_bit{
	...
	strings :
		...
		$a_03_5 = {83 ef 08 8b cf 8b 5d 90 01 01 d3 eb 8b cf b8 01 00 00 00 d3 e0 50 8b 45 90 01 01 5a 8b ca 99 f7 f9 89 55 90 00 } //2
		$a_03_6 = {46 81 e6 ff 00 00 00 03 84 b5 90 01 04 25 ff 00 00 00 8a 9c b5 90 01 04 88 5d 90 01 01 8b 9c 85 90 01 04 89 9c b5 90 01 04 33 db 8a 5d 90 01 01 89 9c 85 90 01 04 8b 9c b5 90 01 04 03 9c 85 90 01 04 81 e3 ff 00 00 00 8a 9c 9d 90 01 04 30 19 41 4a 75 90 00 } //2
	condition:
