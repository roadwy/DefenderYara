...
rule PWS_Win32_Delf_KI{
	...
	strings :
		$a_00_0 = {53 74 72 69 6b 65 4f 75 74 } //01 00 
		$a_00_1 = {48 6f 74 4c 69 67 68 74 } //02 00 
		$a_00_2 = {67 73 6d 74 70 31 38 35 2e 67 6f 6f 67 6c 65 2e 63 6f 6d } //02 00 
		$a_00_3 = {25 30 25 32 25 34 25 36 25 38 25 3a 25 3c 25 3e 25 40 25 42 25 45 25 47 25 49 25 } //02 00 
		$a_00_4 = {6d 73 6e 6c 69 73 74 2e 74 78 74 } //03 00 
