...
rule PWS_Win32_Ygebanel_A{
	...
	strings :
		...
		$a_00_1 = {45 6e 74 72 65 20 6e 6f 20 59 61 68 6f 6f } //01 00  Entre no Yahoo
		$a_00_2 = {2d 63 6f 6e 74 61 74 6f 73 2e 74 78 74 } //01 00  -contatos.txt
		$a_00_3 = {68 6f 74 73 65 6e 64 64 } //00 00  hotsendd
	condition:
		any of ($a_*)
