...
rule PWS_Win32_QQShou{
	...
	strings :
		...
		$a_01_10 = {43 61 70 74 75 72 65 2e 64 6c 6c } //65521 Capture.dll
		$a_01_11 = {4d 65 64 69 61 54 72 61 6e 73 6d 69 74 2e 64 6c 6c } //65521 MediaTransmit.dll
		$a_01_12 = {4e 65 74 44 69 73 6b 44 4c 4c 2e 64 6c 6c 00 42 61 73 65 36 34 44 65 63 6f 64 65 00 } //65521 敎䑴獩䑫䱌搮汬䈀獡㙥䐴捥摯e
		$a_01_13 = {50 6f 6c 69 63 79 4d 61 6e 61 67 65 2e 64 6c 6c } //65521 PolicyManage.dll
	condition:
		((#a_01_0  & 1)*2+(#a_01_1  & 1)*2+(#a_01_2  & 1)*2+(#a_01_3  & 1)*1+(#a_01_4  & 1)*1+(#a_01_5  & 1)*1+(#a_01_6  & 1)*1+(#a_01_7  & 1)*1+(#a_01_8  & 1)*1+(#a_01_9  & 1)*1+(#a_01_10  & 1)*65521+(#a_01_11  & 1)*65521+(#a_01_12  & 1)*65521+(#a_01_13  & 1)*65521) >=7
