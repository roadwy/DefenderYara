...
rule PWS_Win32_Banker_A{
	...
	strings :
		$a_01_0 = {43 3a 5c 57 69 6e 64 6f 77 73 5c 49 4d 45 } //01 00  C:\Windows\IME
		$a_01_1 = {77 2e 31 36 33 2e 63 6f 6d 2e 7a 31 2e 72 71 62 61 6f 2e 63 6f 6d } //01 00  w.163.com.z1.rqbao.com
