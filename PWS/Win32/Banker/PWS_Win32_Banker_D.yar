...
rule PWS_Win32_Banker_D{
	...
	strings :
		$a_01_0 = {53 61 6e 74 61 6e 64 65 72 } //01 00 
		$a_01_1 = {47 65 74 4d 6f 6e 69 74 6f 72 49 6e 66 6f } //01 00 
		$a_01_2 = {41 75 74 6f 43 6f 6e 6e 65 63 74 40 49 48 } //02 00 
		$a_01_3 = {69 6e 66 65 63 74 2e 70 68 70 } //02 00 
