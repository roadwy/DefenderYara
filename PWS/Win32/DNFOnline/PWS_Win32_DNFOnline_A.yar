...
rule PWS_Win32_DNFOnline_A{
	...
	strings :
		$a_02_0 = {68 b2 27 00 00 53 68 01 02 00 00 ff 35 ?? ?? 40 00 ff 15 ?? ?? 40 00 6a 0a } //1
		$a_03_1 = {33 f6 56 ff 35 ?? ?? 40 00 ff 15 ?? ?? 40 00 6a 03 56 56 56 56 6a 01 ff 35 ?? ?? 40 00 ff 15 } //1
