...
rule PWS_Win32_Kheagol_D{
	...
	strings :
		...
		$a_01_1 = {43 52 45 44 55 49 2e 64 6c 6c } //01 00 
		$a_01_2 = {43 72 65 64 55 49 50 72 6f 6d 70 74 46 6f 72 43 72 65 64 65 6e 74 69 61 6c 73 } //01 00 
		$a_01_3 = {50 46 58 49 6d 70 6f 72 74 43 65 72 74 53 74 6f 72 65 } //01 00 
