...
rule PWS_Win32_Fareit_K_MTB{
	...
	strings :
		...
		$a_00_3 = {73 68 65 6c 6c 33 32 2e 64 6c 6c } //65535 shell32.dll
		$a_00_4 = {6b 65 72 6e 65 6c 33 32 } //1 kernel32
		$a_00_5 = {6b 65 72 6e 65 6c 33 32 2e 64 6c 6c } //65535 kernel32.dll
	condition:
		((#a_02_0  & 1)*2+(#a_02_1  & 1)*2+(#a_00_2  & 1)*1+(#a_00_3  & 1)*65535+(#a_00_4  & 1)*1+(#a_00_5  & 1)*65535) >=4
