...
rule PWS_Win32_Fareit_VK_MTB{
	...
	strings :
		...
		$a_02_1 = {58 52 81 ca 90 01 04 5a 51 81 f1 90 01 04 59 8f 04 18 90 00 } //1
	condition:
...
rule PWS_Win32_Fareit_VK_MTB_2{
	...
	strings :
		$a_00_0 = {4d 53 56 42 56 4d 36 30 2e 44 4c 4c } //1 MSVBVM60.DLL
		$a_02_1 = {8f 04 18 16 17 eb 90 09 03 00 83 c4 90 00 } //1
		$a_02_2 = {31 34 24 68 90 09 03 00 83 c4 90 00 } //1
	condition:
