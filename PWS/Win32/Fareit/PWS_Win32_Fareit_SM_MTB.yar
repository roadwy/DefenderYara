...
rule PWS_Win32_Fareit_SM_MTB{
	...
	strings :
		...
		$a_03_1 = {89 f6 89 f6 89 f6 8b c1 be 03 00 00 00 33 d2 f7 f6 85 d2 75 1e 89 f6 89 f6 8b c3 03 c1 73 05 e8 4f af f9 ff 89 f6 89 f6 89 f6 89 f6 89 f6 80 30 90 02 04 89 f6 89 f6 41 81 f9 90 02 04 75 c2 90 00 } //1
	condition:
...
rule PWS_Win32_Fareit_SM_MTB_2{
	...
	strings :
		...
		$a_02_3 = {83 f9 00 74 11 83 7d fc 04 75 0b c7 45 fc 00 00 00 00 80 34 01 90 02 04 8b 7d fc 47 89 7d fc 41 89 d3 39 d9 75 dc 90 00 } //1
	condition:
