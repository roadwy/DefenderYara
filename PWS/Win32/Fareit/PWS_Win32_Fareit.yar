...
rule PWS_Win32_Fareit{
	...
	strings :
		...
		$a_03_4 = {48 57 49 44 90 02 05 7b 25 30 38 58 2d 25 30 34 58 2d 25 30 34 58 2d 25 30 32 58 25 30 32 58 2d 25 30 32 58 25 30 32 58 25 30 32 58 25 30 32 58 25 30 32 58 25 30 32 58 7d 90 00 } //1
	condition:
...
rule PWS_Win32_Fareit_2{
	...
	strings :
		$a_01_0 = {50 57 44 46 49 4c 45 30 59 55 49 50 4b 44 46 49 4c 45 30 59 55 49 43 52 59 50 54 45 44 } //20 PWDFILE0YUIPKDFILE0YUICRYPTED
		$a_01_1 = {2f 67 61 74 65 2e 70 68 70 } //1 /gate.php
		$a_01_2 = {73 6f 66 74 77 61 72 65 5c 77 69 6e 72 61 72 00 } //1 潳瑦慷敲睜湩慲r
	condition:
