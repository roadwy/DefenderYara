...
rule PWS_Win32_Fareit_AJ_bit{
	...
	strings :
		$a_03_0 = {e3 40 fe 45 90 01 01 0f b6 45 90 01 01 0f b6 14 38 88 55 90 01 01 00 55 90 01 01 0f b6 45 90 01 01 8a 14 38 88 55 90 01 01 0f b6 45 90 01 01 88 14 38 0f b6 45 90 01 01 8a 55 90 01 01 88 14 38 8a 55 90 01 01 02 55 90 01 01 8a 14 3a 8b 45 90 01 01 30 14 30 ff 45 90 01 01 e2 c0 90 00 } //3
		$a_03_1 = {8b d0 c1 ea 08 32 07 25 ff 00 00 00 8b 04 85 90 01 04 33 c2 47 e2 e8 90 00 } //3
