...
rule PWS_Win32_Fareit_N_MTB_2{
	...
	strings :
		$a_01_0 = {50 51 52 56 57 3d 4d } //01 00  PQRVW=M
		$a_01_1 = {50 51 52 56 57 39 } //01 00  PQRVW9
		$a_01_2 = {50 51 52 56 57 3d } //01 00  PQRVW=
		$a_01_3 = {50 51 52 56 57 3d 43 } //01 00  PQRVW=C
		$a_01_4 = {50 51 52 56 57 3d 2f } //01 00  PQRVW=/
		$a_01_5 = {50 51 52 56 57 3d 6e 31 } //01 00  PQRVW=n1
		$a_01_6 = {69 6d 61 67 65 68 6c 70 2e 64 6c 6c } //01 00  imagehlp.dll
		$a_01_7 = {73 68 65 6c 6c 33 32 2e 64 6c 6c } //00 00  shell32.dll
	condition:
		any of ($a_*)
