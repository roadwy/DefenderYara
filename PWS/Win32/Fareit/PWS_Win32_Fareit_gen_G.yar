...
rule PWS_Win32_Fareit_gen_G{
	...
	strings :
		...
		$a_01_1 = {50 4b 44 46 49 4c 45 30 59 55 49 43 52 59 50 54 45 44 30 59 55 49 31 2e 30 } //01 00 
		$a_01_2 = {50 57 44 46 49 4c 45 30 59 55 49 } //01 00 
		$a_00_3 = {00 43 6c 69 65 6e 74 20 48 61 73 68 00 53 54 41 54 55 53 2d 49 4d 50 4f 52 54 2d 4f 4b 00 } //00 00 
	condition:
		any of ($a_*)
...
rule PWS_Win32_Fareit_gen_G_2{
	...
	strings :
		...
		$a_01_1 = {50 4b 44 46 49 4c 45 30 59 55 49 43 52 59 50 54 45 44 30 59 55 49 31 2e 30 } //01 00 
		$a_01_2 = {50 57 44 46 49 4c 45 30 59 55 49 } //01 00 
		$a_00_3 = {00 43 6c 69 65 6e 74 20 48 61 73 68 00 53 54 41 54 55 53 2d 49 4d 50 4f 52 54 2d 4f 4b 00 } //05 00 
	condition:
		any of ($a_*)
