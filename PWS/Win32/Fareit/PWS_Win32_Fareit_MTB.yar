...
rule PWS_Win32_Fareit_MTB{
	meta:
		description = "PWS:Win32/Fareit!MTB,SIGNATURE_TYPE_PEHSTR_EXT,01 00 01 00 01 00 00 01 00 "
		
	strings :
		$a_02_0 = {31 c9 8b 1c 0a 81 f3 90 01 04 89 1c 08 f8 83 c1 04 81 f9 90 01 04 75 90 01 01 ff e0 90 00 } //00 00 
	condition:
		any of ($a_*)
...
rule PWS_Win32_Fareit_MTB_2{
	...
	strings :
		$a_02_0 = {83 d9 04 0f 8d 90 01 02 ff ff 90 0a 00 02 89 1c 08 90 0a 00 02 81 f3 90 0a 00 02 8b 1c 0a 90 00 } //00 00 
	condition:
		any of ($a_*)
...
rule PWS_Win32_Fareit_MTB_8{
	...
	strings :
		...
		$a_01_4 = {2d 00 00 70 02 } //01 00 
		$a_01_5 = {68 2f 37 02 00 } //01 00 
		$a_01_6 = {81 c2 1e 23 8e 00 } //00 00 
	condition:
		any of ($a_*)
