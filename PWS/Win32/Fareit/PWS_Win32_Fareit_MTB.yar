...
rule PWS_Win32_Fareit_MTB{
	...
	strings :
		$a_02_0 = {31 c9 8b 1c 0a 81 f3 ?? ?? ?? ?? 89 1c 08 f8 83 c1 04 81 f9 ?? ?? ?? ?? 75 ?? ff e0 } //1
	condition:
		((#a_02_0  & 1)*1) >=1
...
rule PWS_Win32_Fareit_MTB_2{
	...
	strings :
		$a_02_0 = {83 d9 04 0f 8d ?? ?? ff ff 90 0a 00 02 89 1c 08 90 0a 00 02 81 f3 90 0a 00 02 8b 1c 0a } //1
	condition:
		((#a_02_0  & 1)*1) >=1
...
rule PWS_Win32_Fareit_MTB_3{
	...
	strings :
		...
		$a_02_1 = {83 fb 00 7f 90 0a c0 00 83 eb 04 [0-20] ff 34 1f [0-20] 8f 04 18 [0-20] 31 34 18 } //1
	condition:
...
rule PWS_Win32_Fareit_MTB_4{
	...
	strings :
		...
		$a_02_1 = {83 f9 00 7f 90 0a 20 00 09 1c 08 90 0a 50 00 31 f3 90 0a 30 00 8b 1c 0f 90 0a 10 00 49 90 0a 10 00 49 90 0a 10 00 49 90 0a 10 00 49 } //1
	condition:
...
rule PWS_Win32_Fareit_MTB_6{
	...
	strings :
		$a_00_0 = {4d 53 56 42 56 4d 36 30 2e 44 4c 4c } //1 MSVBVM60.DLL
		$a_02_1 = {83 c7 04 85 90 0a ff 00 83 c2 04 90 0a ff 00 83 c4 04 90 0a ff 00 89 0c 18 90 0a ff 00 8b 0c 24 90 0a ff 00 31 34 24 90 0a ff 00 ff 37 } //1
		$a_02_2 = {83 c7 04 66 90 0a ff 00 83 c2 04 90 0a ff 00 83 c4 04 90 0a ff 00 89 0c 18 90 0a ff 00 8b 0c 24 90 0a ff 00 31 34 24 90 0a ff 00 ff 37 } //1
	condition:
...
rule PWS_Win32_Fareit_MTB_7{
	...
	strings :
		$a_00_0 = {4d 53 56 42 56 4d 36 30 2e 44 4c 4c } //1 MSVBVM60.DLL
		$a_02_1 = {8f 04 18 66 90 0a ff 00 ff 31 [0-ff] 31 34 24 [0-ff] 8f 04 18 [0-ff] 83 c2 04 [0-ff] 83 c7 04 } //1
		$a_02_2 = {8f 04 18 81 90 0a ff 00 ff 31 [0-ff] 31 34 24 [0-ff] 8f 04 18 [0-ff] 83 c2 04 [0-ff] 83 c7 04 } //1
		$a_02_3 = {8f 04 18 85 90 0a ff 00 ff 31 [0-ff] 31 34 24 [0-ff] 8f 04 18 [0-ff] 83 c2 04 [0-ff] 83 c7 04 } //1
	condition:
