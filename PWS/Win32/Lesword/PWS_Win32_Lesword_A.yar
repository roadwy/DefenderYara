...
rule PWS_Win32_Lesword_A{
	...
	strings :
		$a_01_0 = {25 73 5c 65 6c 73 77 6f 72 64 2e 65 78 65 } //01 00 
		$a_01_1 = {5c 64 61 74 61 5c 6d 61 69 6c 73 6d 74 70 2e 64 6c 6c } //01 00 
		$a_01_2 = {47 61 6d 65 44 6c 6c 2e 64 6c 6c } //01 00 
		$a_01_3 = {26 70 70 77 64 3d 25 73 26 6d 61 63 3d 25 73 26 6d 62 68 } //01 00 
