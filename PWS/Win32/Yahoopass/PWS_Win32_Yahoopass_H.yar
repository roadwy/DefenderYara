...
rule PWS_Win32_Yahoopass_H{
	...
	strings :
		...
		$a_03_1 = {65 6d 62 65 64 64 69 6e 67 90 02 02 73 6f 6c 90 02 04 73 68 75 74 64 6f 77 6e 90 02 04 2d 73 90 00 } //2
		$a_03_2 = {25 53 59 53 54 45 4d 52 4f 4f 54 25 90 02 02 2f 46 20 63 3a 5c 2a 2e 2a 90 02 04 64 65 6c 20 2f 41 3a 53 20 2f 51 20 90 02 04 63 3a 5c 6e 74 6c 64 72 2e 62 61 74 90 00 } //2
		$a_03_3 = {61 2e 30 36 90 02 02 67 6f 6f 67 6c 65 90 02 03 2e 64 6c 6c 90 02 04 5c 67 6f 6f 67 6c 65 3f 3f 2e 64 6c 6c 90 00 } //2
