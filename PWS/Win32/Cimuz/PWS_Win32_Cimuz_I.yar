...
rule PWS_Win32_Cimuz_I{
	...
	strings :
		$a_03_0 = {76 10 8b c1 6a 05 99 90 01 01 f7 90 01 01 30 14 90 01 01 41 3b 90 01 01 72 f0 8b 35 90 01 09 bd 90 01 05 55 ff d6 90 01 01 e8 90 01 02 ff ff 90 00 } //5
