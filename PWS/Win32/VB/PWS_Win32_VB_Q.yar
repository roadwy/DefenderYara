...
rule PWS_Win32_VB_Q{
	...
	strings :
		$a_00_0 = {6d 00 78 00 31 00 2e 00 6d 00 61 00 69 00 6c 00 2e 00 79 00 61 00 68 00 6f 00 6f 00 2e 00 63 00 6f 00 6d 00 } //01 00 
		$a_01_1 = {74 6d 72 47 45 54 4b 45 59 } //01 00 
