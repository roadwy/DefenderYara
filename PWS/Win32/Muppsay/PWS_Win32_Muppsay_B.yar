...
rule PWS_Win32_Muppsay_B{
	...
	strings :
		...
		$a_00_3 = {5c 00 53 00 79 00 73 00 74 00 65 00 6d 00 52 00 6f 00 6f 00 74 00 5c 00 74 00 65 00 6d 00 70 00 5c 00 73 00 79 00 73 00 74 00 65 00 6d 00 2e 00 62 00 69 00 6e 00 } //00 00 
	condition:
		any of ($a_*)
