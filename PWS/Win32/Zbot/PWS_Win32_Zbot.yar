...
rule PWS_Win32_Zbot_2{
	...
	strings :
		$a_03_0 = {b9 44 a8 65 00 b9 44 a8 65 00 b9 44 a8 65 00 8b d5 89 15 ?? ?? ?? 00 } //1
		$a_03_1 = {89 8d 34 fd ff ff 8b 15 ?? ?? ?? ?? 89 15 ?? ?? ?? ?? 8d 85 2c fd ff ff [0-ff] 68 00 00 00 80 ff 15 90 1b 01 } //1
