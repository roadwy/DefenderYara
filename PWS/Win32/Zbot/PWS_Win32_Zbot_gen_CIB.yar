...
rule PWS_Win32_Zbot_gen_CIB{
	...
	strings :
		$a_00_0 = {43 3a 5c 55 73 65 72 73 5c 5a 45 55 53 5c 44 65 73 6b 74 6f 70 5c 5a 65 75 73 20 53 6f 75 72 63 65 20 43 6f 64 65 20 32 5c 73 6f 75 72 63 65 5c 63 6c 69 65 6e 74 5c } //01 00 
		$a_00_1 = {74 72 79 54 6f 55 70 64 61 74 65 42 6f 74 } //01 00 
