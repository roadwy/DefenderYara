...
rule PWS_Win32_Zbot_FAO{
	...
	strings :
		...
		$a_00_2 = {47 45 54 20 2f 73 63 72 69 70 74 73 2f 67 65 74 5f 63 6f 6d 6d 61 6e 64 2e 70 68 70 3f 6e 61 6d 65 3d } //01 00  GET /scripts/get_command.php?name=
		$a_00_3 = {67 61 6d 75 6e 6b 75 6c 2e 63 6f 6d } //00 00  gamunkul.com
	condition:
		any of ($a_*)
