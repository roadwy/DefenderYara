...
rule PWS_Win32_Zbot_gen_V{
	...
	strings :
		...
		$a_02_2 = {50 6f 70 4f 70 90 01 03 2d 90 00 } //10
		...
		$a_02_10 = {8b f8 32 db 85 ff 74 4c 8b 45 10 2b c6 03 c7 33 c9 85 f6 76 1d 8a d1 02 d2 f6 c1 01 75 09 b3 f6 2a da 00 1c 01 eb 06 80 c2 07 00 14 01 41 3b ce 72 e3 ff 75 10 a1 90 01 04 57 6a 00 6a 00 6a 0f ff 70 28 e8 90 00 } //10
