...
rule PWS_Win32_Neonvestey_A{
	...
	strings :
		...
		$a_01_4 = {3d 00 20 00 46 00 69 00 72 00 65 00 66 00 6f 00 78 00 20 00 55 00 73 00 65 00 72 00 6e 00 61 00 6d 00 65 00 20 00 3d 00 3d 00 } //01 00  = Firefox Username ==
		$a_01_5 = {3d 00 20 00 52 00 65 00 63 00 65 00 6e 00 74 00 20 00 41 00 70 00 70 00 6c 00 69 00 63 00 61 00 74 00 69 00 6f 00 6e 00 20 00 4c 00 69 00 73 00 74 00 20 00 3d 00 3d 00 } //00 00  = Recent Application List ==
	condition:
		any of ($a_*)
