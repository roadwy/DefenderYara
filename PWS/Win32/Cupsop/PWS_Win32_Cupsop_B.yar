...
rule PWS_Win32_Cupsop_B{
	...
	strings :
		$a_03_0 = {7e 09 80 34 31 90 01 01 41 3b c8 7c f7 90 00 } //1
		$a_03_1 = {40 3b 45 fc 7d 11 8a 0c 18 80 f9 2a 74 f2 88 8f 90 01 04 47 eb e9 c6 87 90 01 04 20 90 00 } //1
