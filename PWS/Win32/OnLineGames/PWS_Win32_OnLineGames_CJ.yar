...
rule PWS_Win32_OnLineGames_CJ_2{
	...
	strings :
		...
		$a_03_1 = {6a 00 52 8d 90 01 04 00 00 68 14 01 00 00 50 56 ff 15 24 20 40 00 90 00 } //1
		$a_03_2 = {68 b8 0b 00 00 f3 ab ff 15 90 01 02 40 00 8d 90 01 03 51 68 04 01 00 00 ff 15 90 01 02 40 00 8d 90 01 03 68 90 01 02 40 00 52 ff 15 90 01 02 40 00 8d 90 01 03 50 6a 6b e8 90 00 } //1
	condition:
