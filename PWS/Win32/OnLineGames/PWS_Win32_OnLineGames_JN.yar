...
rule PWS_Win32_OnLineGames_JN{
	...
	strings :
		$a_00_0 = {5c 62 69 6e 33 32 5c 62 79 7a 79 68 2e 65 78 65 } //01 00 
		$a_00_1 = {5c 62 69 6e 33 32 5c 72 61 73 61 64 68 6c 70 2e 64 6c 6c } //01 00 
		$a_00_2 = {53 4f 46 54 57 41 52 45 5c 73 6e 64 61 5c 41 49 4f 4e 5c 50 61 74 68 } //01 00 
