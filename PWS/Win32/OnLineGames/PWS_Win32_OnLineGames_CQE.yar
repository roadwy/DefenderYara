...
rule PWS_Win32_OnLineGames_CQE{
	...
	strings :
		...
		$a_01_1 = {00 4d 2e 65 78 65 } //01 00  䴀攮數
		...
		$a_01_3 = {2f 63 20 64 65 6c } //01 00  /c del
		$a_01_4 = {2e 6e 6d 70 } //01 00  .nmp
		...
		$a_01_8 = {43 72 65 61 74 65 54 6f 6f 6c 68 65 6c 70 33 32 53 6e 61 70 73 68 6f 74 } //00 00  CreateToolhelp32Snapshot
	condition:
		any of ($a_*)
