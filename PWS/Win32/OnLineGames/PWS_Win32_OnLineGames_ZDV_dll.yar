...
rule PWS_Win32_OnLineGames_ZDV_dll{
	...
	strings :
		...
		$a_01_2 = {2f 6d 69 62 61 6f 2e 61 73 70 } //01 00 
		$a_01_3 = {25 73 3f 61 63 74 3d 26 64 31 30 3d 25 73 26 64 38 30 3d 25 64 } //01 00 
		$a_01_4 = {3f 64 31 30 3d 25 73 26 64 31 31 3d 25 73 26 64 30 30 3d 25 73 26 64 30 31 3d 25 73 26 64 32 32 3d 25 73 26 64 33 32 3d 25 73 26 64 37 30 3d 25 64 26 64 39 30 3d 25 64 } //00 00 
	condition:
		any of ($a_*)
