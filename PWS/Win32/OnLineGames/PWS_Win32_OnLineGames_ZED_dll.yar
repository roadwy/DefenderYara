...
rule PWS_Win32_OnLineGames_ZED_dll{
	...
	strings :
		...
		$a_01_2 = {25 73 3f 61 63 74 3d 67 65 74 70 6f 73 26 64 31 30 3d 25 73 26 64 38 30 3d } //01 00 
		$a_01_3 = {3f 61 3d 25 73 26 73 3d 25 73 26 75 3d 25 73 26 70 3d 25 73 26 70 69 6e 3d 25 73 26 } //02 00 
		$a_01_4 = {6d 69 62 61 6f 2e 61 73 70 } //02 00 
		$a_01_5 = {77 73 69 64 6e 79 2e 61 73 70 } //00 00 
	condition:
		any of ($a_*)
