...
rule PWS_Win32_OnLineGames_ZED_dll{
	...
	strings :
		...
		$a_03_1 = {b0 65 b2 2e b1 78 33 db c6 45 90 01 01 76 c6 45 90 01 01 73 c6 45 90 01 01 6e c6 45 90 01 01 69 c6 45 90 01 01 66 c6 45 90 01 01 66 88 45 90 00 } //1
