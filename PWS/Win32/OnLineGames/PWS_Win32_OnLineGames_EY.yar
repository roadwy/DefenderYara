...
rule PWS_Win32_OnLineGames_EY{
	...
	strings :
		...
		$a_00_1 = {68 74 74 70 3a 2f 2f 24 31 25 73 24 31 3a 25 64 25 73 3f 25 73 } //01 00  http://$1%s$1:%d%s?%s
		$a_00_2 = {25 73 24 31 25 73 24 31 2a 24 31 2e 64 6c 6c } //01 00  %s$1%s$1*$1.dll
		$a_00_3 = {64 72 69 24 31 76 65 72 73 5c 65 24 31 74 63 5c 68 6f 73 24 31 74 73 } //00 00  dri$1vers\e$1tc\hos$1ts
	condition:
		any of ($a_*)
