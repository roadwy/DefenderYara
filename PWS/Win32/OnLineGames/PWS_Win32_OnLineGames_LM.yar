...
rule PWS_Win32_OnLineGames_LM{
	...
	strings :
		...
		$a_01_1 = {4b 69 63 6b 55 73 65 72 4f 75 74 47 61 6d 65 3a 25 75 2c 25 75 } //01 00  KickUserOutGame:%u,%u
		$a_01_2 = {57 54 46 5c 43 6f 6e 66 69 67 2e 77 74 66 } //01 00  WTF\Config.wtf
