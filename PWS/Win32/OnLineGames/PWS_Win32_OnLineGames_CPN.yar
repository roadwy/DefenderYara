...
rule PWS_Win32_OnLineGames_CPN{
	...
	strings :
		$a_02_0 = {8b d8 85 db 74 ?? 68 ?? ?? ?? 00 53 e8 ?? ?? ff ff 89 c6 68 ?? ?? ?? 00 53 e8 ?? ?? ff ff } //10
		$a_02_1 = {4e 76 53 79 73 5f [30-39] [30-39] 2e 54 61 6f } //1
		$a_02_2 = {4e 76 53 79 73 5f [30-39] [30-39] 2e 53 79 73 } //1
		$a_00_3 = {4d 73 67 48 6f 6f 6b 4f 70 } //1 MsgHookOp
		$a_00_4 = {4d 73 67 48 6f 6f 6b 69 66 } //1 MsgHookif
		$a_02_5 = {4e 76 57 69 6e 5f [30-39] 2e 4c 73 74 } //1
		$a_02_6 = {4e 76 57 69 6e 5f [30-39] 2e 4a 6d 70 } //1
