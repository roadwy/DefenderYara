...
rule PWS_Win32_OnLineGames_DG{
	...
	strings :
		...
		$a_03_3 = {6a 00 6a 42 68 90 01 02 40 00 6a 00 6a 00 e8 90 01 02 ff ff 33 c0 5a 59 59 64 89 10 90 00 } //1
		$a_03_4 = {50 6a 02 e8 90 01 02 ff ff a3 90 01 02 40 00 6a 00 a1 90 01 02 40 00 50 b8 90 01 02 40 00 50 6a 07 90 00 } //1
	condition:
