...
rule PWS_Win32_OnLineGames_CTB{
	...
	strings :
		...
		$a_00_2 = {4b 69 63 6b 52 6f 6c 65 } //0a 00 
		$a_00_3 = {5c 76 65 72 63 6c 73 69 64 2e 65 78 65 } //0a 00 
		$a_00_4 = {3f 61 63 74 3d } //0a 00 
		$a_00_5 = {26 64 30 30 3d } //01 00 
		$a_00_6 = {54 65 72 6d 69 6e 61 74 65 54 68 72 65 61 64 } //01 00 
