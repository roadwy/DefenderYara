...
rule PWS_Win32_OnLineGames_CSD{
	...
	strings :
		...
		$a_02_6 = {8b 44 24 10 6a 00 6a 00 6a 00 6a 00 6a 00 50 6a 01 6a 03 6a 01 68 ff 01 0f 00 57 57 56 ff 15 90 01 02 00 10 85 c0 75 0c 56 ff 15 90 01 02 00 10 5f 32 c0 5e c3 90 00 } //100
	condition:
