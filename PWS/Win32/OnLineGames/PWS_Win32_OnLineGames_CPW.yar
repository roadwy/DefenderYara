...
rule PWS_Win32_OnLineGames_CPW{
	...
	strings :
		$a_00_0 = {76 62 36 63 68 73 2e 64 6c 6c } //0a 00  vb6chs.dll
		...
		$a_01_4 = {47 61 76 70 73 } //0a 00  Gavps
		$a_00_5 = {46 69 6e 64 57 69 6e 64 6f 77 41 } //0a 00  FindWindowA
		$a_00_6 = {53 65 74 57 69 6e 64 6f 77 4c 6f 6e 67 41 } //01 00  SetWindowLongA
