...
rule PWS_Win32_OnLineGames_AAC{
	...
	strings :
		$a_02_0 = {8b 45 0c 83 c0 05 89 45 f4 8b 4d 08 c1 e1 08 81 c1 ?? ?? ?? ?? 2b 4d f4 89 4d f4 8b 55 0c 03 55 fc c6 02 e9 8b 45 fc } //2
		$a_02_1 = {83 c4 14 68 ?? ?? ?? ?? 6a 05 8d 8d ?? ?? ff ff 51 8b 55 ?? 52 6a ?? e8 } //2
