...
rule PWS_Win32_OnLineGames_L_dll{
	...
	strings :
		$a_02_0 = {8b f3 85 f6 7e 1e bf 01 00 00 00 8b 5d ?? 8b 45 ?? e8 ?? ?? ?? ?? 8a 13 80 f2 ?? 88 54 38 ff 47 43 4e 75 ea 8b 7d ?? 8b 75 ?? 8b 5d ?? 8b e5 5d c3 } //10
		...
		$a_02_4 = {31 2e 68 69 76 90 09 04 00 43 3a 5c } //1
