...
rule PWS_Win32_OnLineGames_HM{
	...
	strings :
		$a_00_0 = {44 00 4e 00 46 00 2e 00 65 00 78 00 65 00 } //02 00  DNF.exe
		$a_00_1 = {48 00 4f 00 4f 00 4b 00 } //02 00  HOOK
		...
		$a_00_3 = {26 70 61 73 73 77 6f 72 64 32 3d } //01 00  &password2=
		$a_00_4 = {26 6d 6f 6e 65 79 3d } //01 00  &money=
