...
rule PWS_Win32_OnLineGames_FU{
	...
	strings :
		$a_01_0 = {26 75 3d 25 73 26 70 3d 25 73 26 72 3d 25 73 } //01 00 
		$a_01_1 = {61 63 74 69 6f 6e 3d 74 65 73 74 6c 6f 63 6b 26 75 3d 25 73 00 } //01 00 
		$a_01_2 = {61 63 74 69 6f 6e 3d 67 65 74 70 72 6f 63 26 75 3d 25 73 } //01 00 
		$a_01_3 = {61 63 74 69 6f 6e 3d 70 6f 73 74 6d 62 26 75 3d 25 73 26 6d 62 3d 25 73 } //02 00 
