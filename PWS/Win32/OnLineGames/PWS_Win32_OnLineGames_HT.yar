...
rule PWS_Win32_OnLineGames_HT{
	...
	strings :
		...
		$a_01_1 = {53 4f 46 54 57 41 52 45 5c 4d 69 63 72 6f 73 6f 66 74 5c 57 69 6e 64 6f 77 73 5c 43 75 72 72 65 6e 74 56 65 72 73 69 6f 6e 5c 55 6e 69 6e 73 74 61 6c 6c 5c 54 65 6e 63 65 6e 74 5c 44 4e 46 5c 4a 69 6e 53 68 61 49 4c 6f 76 65 59 6f 75 } //01 00 
		...
		$a_01_5 = {2e 73 6f 75 73 75 6f 31 30 30 2e 63 6f 6d 3a } //00 00 
	condition:
		any of ($a_*)
