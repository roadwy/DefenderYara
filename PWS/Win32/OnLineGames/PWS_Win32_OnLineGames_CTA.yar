...
rule PWS_Win32_OnLineGames_CTA{
	meta:
		description = "PWS:Win32/OnLineGames.CTA,SIGNATURE_TYPE_PEHSTR_EXT,03 00 02 00 03 00 00 01 00 "
	...
	strings :
		...
		$a_00_1 = {33 db c7 45 e4 54 41 32 45 c7 45 e8 64 69 74 00 89 5d ec c7 45 d4 54 46 72 6d c7 45 d8 4c 6f 67 4f c7 45 dc 6e 00 00 00 89 5d e0 8d 45 d4 53 50 53 } //01 00 
		$a_02_2 = {33 ff 8d 45 e0 57 50 57 ff 35 90 01 04 c7 45 e0 54 46 72 6d c7 45 e4 50 61 73 73 c7 45 e8 45 74 63 00 89 7d ec c7 45 f0 54 41 32 45 c7 45 f4 64 69 74 00 89 7d f8 ff d6 8b d8 8d 45 f0 57 50 57 53 ff d6 90 00 } //00 00 
	condition:
		any of ($a_*)
