...
rule PWS_Win32_OnLineGames_CTA{
	...
	strings :
		...
		$a_02_2 = {33 ff 8d 45 e0 57 50 57 ff 35 ?? ?? ?? ?? c7 45 e0 54 46 72 6d c7 45 e4 50 61 73 73 c7 45 e8 45 74 63 00 89 7d ec c7 45 f0 54 41 32 45 c7 45 f4 64 69 74 00 89 7d f8 ff d6 8b d8 8d 45 f0 57 50 57 53 ff d6 } //1
	condition:
