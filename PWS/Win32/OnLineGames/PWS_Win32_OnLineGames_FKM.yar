...
rule PWS_Win32_OnLineGames_FKM{
	...
	strings :
		$a_03_0 = {68 00 02 00 00 8d 85 90 01 02 ff ff 50 e8 90 01 02 ff ff 68 04 01 00 00 8d 85 90 01 02 ff ff 50 e8 90 01 02 ff ff 6a 05 68 90 01 04 8d 85 90 01 02 ff ff 50 e8 90 01 02 ff ff 90 00 } //1
