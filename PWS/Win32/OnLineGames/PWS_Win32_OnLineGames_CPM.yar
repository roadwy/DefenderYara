...
rule PWS_Win32_OnLineGames_CPM{
	...
	strings :
		$a_00_0 = {6d 61 70 5c 38 38 58 36 30 30 2e 6e 6d 70 } //0a 00  map\88X600.nmp
		$a_00_1 = {2f 63 20 64 65 6c 20 43 3a 5c } //0a 00  /c del C:\
		...
		$a_01_6 = {43 72 65 61 74 65 52 65 6d 6f 74 65 54 68 72 65 61 64 } //01 00  CreateRemoteThread
		$a_00_7 = {4f 70 65 6e 50 72 6f 63 65 73 73 } //01 00  OpenProcess
		$a_01_8 = {57 72 69 74 65 50 72 6f 63 65 73 73 4d 65 6d 6f 72 79 } //01 00  WriteProcessMemory
		$a_00_9 = {4f 70 65 6e 50 72 6f 63 65 73 73 54 6f 6b 65 6e } //00 00  OpenProcessToken
	condition:
		any of ($a_*)
