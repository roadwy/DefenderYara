...
rule PWS_Win32_OnLineGames_G{
	...
	strings :
		$a_00_0 = {6b 69 6c 6c 2e 73 79 73 } //01 00  kill.sys
		$a_00_1 = {67 72 6f 75 70 2e 69 6e 69 } //01 00  group.ini
		$a_00_2 = {63 73 72 73 73 2e 65 78 65 } //01 00  csrss.exe
		$a_00_3 = {6d 69 72 31 2e 64 61 74 } //01 00  mir1.dat
		$a_00_4 = {57 72 69 74 65 46 69 6c 65 } //01 00  WriteFile
...
rule PWS_Win32_OnLineGames_G_2{
	...
	strings :
		$a_00_0 = {61 64 64 72 25 73 68 65 6c 70 } //01 00  addr%shelp
		$a_00_1 = {71 64 73 68 6d 2e 64 6c 6c } //01 00  qdshm.dll
		$a_01_2 = {55 75 69 64 43 72 65 61 74 65 } //01 00  UuidCreate
		$a_01_3 = {57 53 43 57 72 69 74 65 50 72 6f 76 69 64 65 72 4f 72 64 65 72 } //0a 00  WSCWriteProviderOrder
