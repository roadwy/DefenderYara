...
rule PWS_Win32_OnLineGames_MQ{
	...
	strings :
		...
		$a_01_3 = {26 65 6d 61 69 6c 3d 00 26 72 65 71 75 65 73 74 54 79 70 65 3d 50 41 53 53 57 4f 52 44 5f 52 45 53 45 54 00 25 30 32 58 25 30 32 58 25 30 32 58 25 30 32 58 25 30 32 58 25 30 32 58 } //01 00  攦慭汩=爦煥敵瑳祔数倽十坓剏彄䕒䕓T〥堲〥堲〥堲〥堲〥堲〥堲
		$a_01_4 = {79 61 6f 79 61 6f 32 35 } //00 00  yaoyao25
	condition:
		any of ($a_*)
