...
rule PWS_Win32_OnLineGames_AQ{
	...
	strings :
		...
		$a_01_4 = {72 65 3d 25 73 26 73 3d 25 73 26 41 3d 25 73 26 50 3d 25 73 26 4d 42 3d 25 73 } //01 00 
		$a_01_5 = {3d 25 64 26 6d 61 63 3d 25 73 26 52 47 31 3d 25 64 26 5a 3d 25 73 3a 25 73 00 } //00 00 
	condition:
		any of ($a_*)
