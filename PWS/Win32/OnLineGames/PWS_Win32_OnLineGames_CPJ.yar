...
rule PWS_Win32_OnLineGames_CPJ_2{
	...
	strings :
		...
		$a_02_4 = {52 61 76 4d c7 45 90 01 01 6f 6e 2e 65 c7 45 90 01 01 78 65 00 00 90 00 } //5
		$a_02_5 = {67 61 6d 65 90 01 01 c7 45 90 01 01 63 6c 69 65 ff 75 90 01 01 c7 45 90 01 01 6e 74 2e 65 c7 45 90 01 01 78 65 00 00 90 00 } //3
		$a_02_6 = {63 61 62 61 90 01 01 c7 45 90 01 01 6c 6d 61 69 ff 75 90 01 01 c7 45 90 01 01 6e 2e 65 78 c7 45 90 01 01 65 00 00 00 90 00 } //3
		$a_02_7 = {41 75 74 6f 90 01 01 c7 45 90 01 01 4c 6f 67 69 c7 45 90 01 01 6e 2e 64 61 c7 45 90 01 01 74 00 00 00 c7 45 90 01 01 72 62 00 00 90 00 } //3
	condition:
