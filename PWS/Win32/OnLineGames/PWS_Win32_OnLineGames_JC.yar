...
rule PWS_Win32_OnLineGames_JC{
	...
	strings :
		...
		$a_03_3 = {6a 40 52 03 f0 56 51 ff 15 ?? ?? ?? ?? 8b 4c 24 1c 8b 44 24 24 83 c1 28 48 89 4c 24 1c 89 44 24 24 75 95 8b 8c 24 5c 02 00 00 8d 54 24 28 52 8b 54 24 10 6a 04 8d 44 24 28 50 83 c1 08 51 52 c7 84 24 cc 01 00 00 07 00 01 00 ff 15 ?? ?? ?? ?? 85 c0 0f 84 5b fe ff ff 8b 44 24 20 8b 8c 24 e8 00 00 00 03 c8 8b 44 24 10 8d 94 24 b8 01 00 00 52 50 89 8c 24 70 02 00 00 ff 15 } //2
	condition:
