...
rule PWS_Win32_OnLineGames{
	...
	strings :
		...
		$a_01_1 = {2f 64 61 74 61 2f 63 6f 75 6e 74 2e 61 73 70 3f 75 3d 25 73 } //00 00 
	condition:
		any of ($a_*)
...
rule PWS_Win32_OnLineGames_3{
	...
	strings :
		...
		$a_00_1 = {43 3a 5c 57 49 4e 44 4f 57 53 5c 53 59 53 54 45 4d 33 32 5c 6b 6e 6c 45 78 74 2e 64 6c 6c } //00 00 
	condition:
		any of ($a_*)
