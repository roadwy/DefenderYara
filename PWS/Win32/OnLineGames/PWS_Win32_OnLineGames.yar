...
rule PWS_Win32_OnLineGames{
	...
	strings :
		$a_03_0 = {6a 0e f3 ab 66 ab aa 59 33 c0 8d bd 90 01 01 ff ff ff 88 9d 90 01 01 ff ff ff f3 ab 66 ab c6 05 90 01 04 32 c6 05 90 01 04 32 c6 05 90 01 04 31 c6 05 90 01 04 2e c6 05 90 01 04 31 c6 05 90 01 04 32 90 00 } //1
...
rule PWS_Win32_OnLineGames_2{
	...
	strings :
		$a_03_0 = {8d 85 e4 fb ff ff 50 e8 90 01 02 ff ff 68 00 02 00 00 8d 85 ec fd ff ff 50 e8 90 01 02 ff ff 68 04 01 00 00 8d 85 e8 fc ff ff 50 e8 90 01 02 ff ff 6a 05 68 90 00 } //1
