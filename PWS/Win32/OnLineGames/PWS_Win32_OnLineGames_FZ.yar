...
rule PWS_Win32_OnLineGames_FZ{
	...
	strings :
		...
		$a_01_2 = {25 73 3f 75 73 3d 25 73 26 70 73 3d 25 73 26 6c 76 3d 25 73 26 73 65 3d 25 73 26 71 75 3d 25 73 26 6f 73 3d 25 73 } //01 00  %s?us=%s&ps=%s&lv=%s&se=%s&qu=%s&os=%s
		$a_01_3 = {25 73 3f 75 3d 25 73 26 6d 3d 25 73 26 75 72 6c 3d 25 73 26 61 63 74 69 6f 6e 3d 25 73 } //00 00  %s?u=%s&m=%s&url=%s&action=%s
	condition:
		any of ($a_*)
