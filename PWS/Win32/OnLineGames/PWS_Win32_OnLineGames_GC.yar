...
rule PWS_Win32_OnLineGames_GC{
	...
	strings :
		...
		$a_03_1 = {89 45 94 6a 00 6a 18 8d 45 98 50 6a 00 ff 75 94 e8 90 01 02 00 00 0b c0 75 72 ff 75 ac 6a 00 68 00 04 00 00 e8 90 01 02 00 00 0b c0 74 5f 90 00 } //1
	condition:
