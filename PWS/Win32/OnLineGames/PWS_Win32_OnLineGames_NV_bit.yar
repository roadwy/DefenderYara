...
rule PWS_Win32_OnLineGames_NV_bit{
	...
	strings :
		...
		$a_01_1 = {74 61 73 6b 6b 69 6c 6c 20 2f 66 20 2f 69 6d 20 25 73 2e 65 78 65 } //01 00  taskkill /f /im %s.exe
		$a_01_2 = {61 74 74 72 69 62 20 2b 73 20 2b 68 20 22 25 73 22 } //02 00  attrib +s +h "%s"
