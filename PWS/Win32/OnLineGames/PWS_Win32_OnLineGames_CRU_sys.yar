...
rule PWS_Win32_OnLineGames_CRU_sys{
	...
	strings :
		...
		$a_01_1 = {4d 6d 4d 61 70 4c 6f 63 6b 65 64 50 61 67 65 73 53 70 65 63 69 66 79 43 61 63 68 65 } //1 MmMapLockedPagesSpecifyCache
		$a_01_2 = {4b 65 53 65 72 76 69 63 65 44 65 73 63 72 69 70 74 6f 72 54 61 62 6c 65 } //1 KeServiceDescriptorTable
		$a_01_3 = {4f 62 66 44 65 72 65 66 65 72 65 6e 63 65 4f 62 6a 65 63 74 } //1 ObfDereferenceObject
	condition:
