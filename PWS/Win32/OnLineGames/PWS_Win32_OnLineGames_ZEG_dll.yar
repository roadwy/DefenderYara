...
rule PWS_Win32_OnLineGames_ZEG_dll{
	...
	strings :
		...
		$a_01_1 = {5c 64 6e 66 5c 62 69 65 73 68 61 77 6f 2e 65 78 65 } //01 00  \dnf\bieshawo.exe
		$a_01_2 = {5c 73 79 73 74 65 6d 33 32 5c 77 61 68 61 68 61 2e 69 6d 65 } //01 00  \system32\wahaha.ime
