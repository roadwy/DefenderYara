...
rule PWS_Win32_OnLineGames_HW{
	...
	strings :
		...
		$a_01_1 = {63 6d 64 20 2f 63 20 65 72 61 73 65 20 2f 46 } //01 00  cmd /c erase /F
		...
		$a_01_5 = {71 71 2e 75 70 64 61 74 65 2e 73 6f 75 73 75 6f 31 30 30 2e 63 6f 6d 3a } //00 00  qq.update.sousuo100.com:
	condition:
		any of ($a_*)
