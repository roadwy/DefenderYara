...
rule PWS_Win32_OnLineGames_CPG{
	...
	strings :
		$a_00_0 = {6d 73 70 6c 61 79 33 32 2e 64 6c 6c } //0a 00  msplay32.dll
		$a_00_1 = {4f 70 65 6e 50 72 6f 63 65 73 73 } //0a 00  OpenProcess
		...
		$a_01_4 = {00 4a 75 6d 70 4f 66 66 } //00 00  䨀浵佰晦
	condition:
		any of ($a_*)
