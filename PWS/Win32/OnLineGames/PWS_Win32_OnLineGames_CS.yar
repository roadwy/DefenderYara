...
rule PWS_Win32_OnLineGames_CS{
	...
	strings :
		...
		$a_01_2 = {69 6e 73 74 61 6c 6c 48 6f 6f 6b } //05 00  installHook
		$a_01_3 = {6d 73 67 43 61 6c 6c 42 61 63 6b 40 40 59 47 4a 48 49 4a 40 5a } //01 00  msgCallBack@@YGJHIJ@Z
		$a_01_4 = {75 6e 61 6d 65 2e 6e 6c 73 } //01 00  uname.nls
		$a_01_5 = {6b 69 6c 6c 47 61 6d 65 } //01 00  killGame
		$a_01_6 = {71 71 66 6f 2e 65 78 65 } //00 00  qqfo.exe
	condition:
		any of ($a_*)
