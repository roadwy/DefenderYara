...
rule PWS_Win32_OnLineGames_MZ{
	...
	strings :
		$a_01_0 = {25 73 3f 61 70 3d 25 73 26 75 70 3d 25 73 26 70 70 3d 25 73 26 73 73 70 3d 25 73 } //01 00  %s?ap=%s&up=%s&pp=%s&ssp=%s
		$a_01_1 = {25 73 3f 75 70 3d 25 73 26 70 70 3d 25 73 26 73 73 70 3d 25 73 } //02 00  %s?up=%s&pp=%s&ssp=%s
