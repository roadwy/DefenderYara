...
rule PWS_Win32_OnLineGames_CV{
	...
	strings :
		...
		$a_03_1 = {6a 05 52 68 d2 60 47 00 6a 00 e8 ?? ?? ff ff 68 ?? ?? 00 10 8d ?? ?? ?? 6a 06 50 68 9b e6 40 00 6a 01 e8 ?? ?? ff ff } //1
		$a_03_2 = {c6 06 e9 55 55 8d 83 ?? ?? ?? ?? 57 8b c8 8b d0 c1 e9 08 88 46 01 88 4e 02 c1 ea 10 c1 e8 18 88 56 03 56 88 46 04 e8 } //1
	condition:
