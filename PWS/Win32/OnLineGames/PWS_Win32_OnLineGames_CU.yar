...
rule PWS_Win32_OnLineGames_CU{
	...
	strings :
		...
		$a_03_1 = {81 ff 2c 01 00 00 77 ?? 68 ?? ?? 00 10 55 e8 ?? ?? ff ff 8b f0 bb ?? ?? 00 10 56 53 55 e8 ?? ?? ff ff 2b c6 83 c6 0d 83 e8 0d 50 56 } //1
		$a_03_2 = {85 c9 7c 26 85 c0 7c 22 85 ff 74 1e 83 c1 05 51 68 ?? ?? ?? ?? 55 e8 ?? ?? ff ff 8b 4c ?? ?? 2b c1 83 e8 0a 83 c1 0a 50 eb } //1
	condition:
