...
rule PWS_Win32_OnLineGames_ZDX_dll{
	...
	strings :
		$a_03_0 = {68 80 3e 00 00 ff 15 24 19 00 10 e9 4b ff ff ff e8 90 01 04 e8 90 01 04 f7 d8 1b c0 40 c3 90 00 } //1
		$a_03_1 = {57 56 c6 45 90 01 01 8b c6 45 90 01 01 4d c6 45 90 01 01 0c c6 45 90 01 01 8b c6 45 90 01 01 75 c6 45 90 01 01 10 c6 45 90 01 01 8a c6 45 90 01 01 45 c6 45 90 01 01 18 e8 90 00 } //1
