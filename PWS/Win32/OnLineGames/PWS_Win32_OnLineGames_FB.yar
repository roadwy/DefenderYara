...
rule PWS_Win32_OnLineGames_FB{
	...
	strings :
		...
		$a_01_1 = {53 47 43 51 } //01 00  SGCQ
		$a_00_2 = {77 6d 67 6d 62 2e 61 73 70 } //01 00  wmgmb.asp
		$a_00_3 = {63 67 61 6d 65 61 73 64 66 67 68 } //01 00  cgameasdfgh
		$a_00_4 = {67 61 6d 65 71 77 65 72 74 79 } //00 00  gameqwerty
	condition:
		any of ($a_*)
