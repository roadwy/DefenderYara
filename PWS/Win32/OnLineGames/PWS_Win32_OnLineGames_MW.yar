...
rule PWS_Win32_OnLineGames_MW{
	...
	strings :
		...
		$a_03_1 = {77 69 6e 30 90 04 01 02 36 37 25 30 38 78 2e 64 6c 6c 00 90 00 } //1
		$a_03_2 = {ff 2e c6 85 90 01 02 ff ff 65 c6 85 90 01 02 ff ff 78 c6 85 90 01 02 ff ff 65 90 02 06 90 03 04 04 6a 3e f3 ab f3 ab 6a 3e 90 00 } //1
