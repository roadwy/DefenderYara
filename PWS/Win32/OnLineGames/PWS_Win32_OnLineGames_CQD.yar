...
rule PWS_Win32_OnLineGames_CQD{
	...
	strings :
		...
		$a_01_9 = {48 00 65 00 75 00 72 00 69 00 73 00 74 00 69 00 63 00 73 00 20 00 65 00 6e 00 67 00 69 00 6e 00 65 00 } //65516 Heuristics engine
	condition:
		((#a_01_0  & 1)*10+(#a_01_1  & 1)*10+(#a_01_2  & 1)*3+(#a_01_3  & 1)*2+(#a_01_4  & 1)*1+(#a_01_5  & 1)*1+(#a_01_6  & 1)*1+(#a_01_7  & 1)*1+(#a_01_8  & 1)*1+(#a_01_9  & 1)*65516) >=26
