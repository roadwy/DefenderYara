...
rule PWS_Win32_OnLineGames_IR{
	...
	strings :
		$a_00_0 = {74 68 65 62 69 67 67 61 79 } //01 00  thebiggay
		$a_00_1 = {4f 48 4f 48 57 45 57 45 41 52 45 30 2e } //01 00  OHOHWEWEARE0.
		$a_00_2 = {52 58 4a 48 5f 4b 49 43 4b 41 52 53 45 30 2e } //01 00  RXJH_KICKARSE0.
		$a_00_3 = {44 49 41 4c 45 52 20 55 53 45 52 2e 45 58 45 } //01 00  DIALER USER.EXE
