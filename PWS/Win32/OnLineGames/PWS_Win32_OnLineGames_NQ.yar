...
rule PWS_Win32_OnLineGames_NQ{
	...
	strings :
		...
		$a_01_1 = {64 6f 6d 70 61 67 65 2e 63 6f 2e 6b 72 2f 62 6f 61 72 64 2f 64 61 74 61 2f 6c 6f 67 2f 74 65 73 74 2e 70 68 70 } //01 00  dompage.co.kr/board/data/log/test.php
		$a_01_2 = {63 3a 5c 61 2e 64 61 74 00 } //01 00 
		$a_01_3 = {8a 0e 80 e9 03 80 f1 03 88 0e 46 48 75 f2 8b c6 5e c3 } //01 00 
		$a_01_4 = {6d 69 7e 76 72 6f 74 69 30 69 7e 69 } //01 00  mi~vroti0i~i
