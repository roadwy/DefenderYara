...
rule PWS_Win32_OnLineGames_COK{
	...
	strings :
		...
		$a_02_4 = {c7 45 f0 6c 69 6e 6b 50 8d 85 0c ff ff ff 50 c7 45 f4 2e 00 00 00 ff 15 ?? ?? ?? ?? 59 59 5f 5e 5b 85 c0 74 2f 8b 40 05 c7 45 ec 77 6f 72 00 25 ff ff ff 00 c7 45 f0 77 32 69 00 c7 45 f4 7a 68 75 00 } //4
	condition:
