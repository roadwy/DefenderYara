...
rule PWS_Win32_OnLineGames_GZ{
	...
	strings :
		...
		$a_01_1 = {77 77 77 2e 78 69 61 6f 68 75 61 2e 6b 72 3a 38 30 30 31 } //01 00 
		$a_01_2 = {4e 65 74 42 6f 74 20 41 74 74 61 63 6b 65 72 } //00 00 
	condition:
		any of ($a_*)
...
rule PWS_Win32_OnLineGames_GZ_2{
	...
	strings :
		$a_01_0 = {53 59 53 54 45 4d 33 32 5c 68 66 30 30 32 31 2e 64 6c 6c } //01 00 
