...
rule PWS_Win32_OnLineGames_ZFL{
	...
	strings :
		...
		$a_00_3 = {00 5f 5f 25 73 5f 25 64 5f 00 } //00 00  开╟彳搥_
	condition:
		any of ($a_*)
...
rule PWS_Win32_OnLineGames_ZFL_2{
	...
	strings :
		$a_00_0 = {64 6e 66 2e 65 78 65 } //01 00  dnf.exe
		$a_00_1 = {64 73 6f 75 6e 64 30 31 30 2e 44 69 72 65 63 74 53 6f 75 6e 64 43 61 70 74 75 72 65 43 72 65 61 74 65 } //01 00  dsound010.DirectSoundCaptureCreate
