...
rule PWS_Win32_OnLineGames_ZFL{
	...
	strings :
		...
		$a_02_1 = {64 62 72 25 30 32 78 2a 2e 90 01 03 00 90 00 } //1
...
rule PWS_Win32_OnLineGames_ZFL_2{
	...
	strings :
		...
		$a_03_2 = {f2 ae f7 d1 49 51 8d 8c 24 90 01 04 68 90 01 02 00 10 51 ff 15 90 01 02 00 10 5f 5e 85 c0 75 0b 68 90 01 02 00 10 ff 15 90 01 02 00 10 33 c0 81 c4 08 02 00 00 c2 04 00 90 00 } //1
	condition:
