...
rule PWS_Win32_OnLineGames_KH{
	...
	strings :
		$a_02_0 = {83 c0 05 c6 00 e9 40 53 bb 90 01 02 00 10 2b d8 83 eb 04 89 18 5b 90 00 } //1
		$a_02_1 = {6a 02 52 6a 00 6a 5a ff 15 90 01 03 10 c6 44 24 13 01 68 30 75 00 00 ff 15 90 01 03 10 e9 90 01 02 ff ff 90 00 } //1
