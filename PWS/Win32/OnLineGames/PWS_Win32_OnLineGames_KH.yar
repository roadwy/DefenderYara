...
rule PWS_Win32_OnLineGames_KH{
	...
	strings :
		...
		$a_00_2 = {68 74 74 70 3a 2f 2f 25 73 3a 25 73 2f 70 6f 62 61 6f 2f 47 65 74 54 75 50 69 61 6e 2e 61 73 70 } //01 00  http://%s:%s/pobao/GetTuPian.asp
		$a_00_3 = {25 73 62 6c 69 6e 65 2e 61 73 70 25 73 } //01 00  %sbline.asp%s
		$a_00_4 = {57 49 4e 44 4f 57 53 5c 53 59 53 54 45 4d 33 32 5c 4d 53 57 43 2e 69 6d 65 } //00 00  WINDOWS\SYSTEM32\MSWC.ime
	condition:
		any of ($a_*)
