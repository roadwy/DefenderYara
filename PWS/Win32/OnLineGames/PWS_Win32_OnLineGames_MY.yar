...
rule PWS_Win32_OnLineGames_MY{
	...
	strings :
		...
		$a_00_1 = {41 48 4e 4c 45 53 54 4f 52 59 2e 45 58 45 } //01 00  AHNLESTORY.EXE
		$a_00_2 = {57 4f 57 2e 45 58 45 } //01 00  WOW.EXE
		$a_00_3 = {44 49 41 42 4c 4f 20 49 49 49 2e 45 58 45 } //00 00  DIABLO III.EXE
	condition:
		any of ($a_*)
