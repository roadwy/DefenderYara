...
rule PWS_Win32_OnLineGames_NO{
	...
	strings :
		...
		$a_00_3 = {25 73 3f 61 63 74 69 6f 6e 3d 74 65 73 74 6c 6f 63 6b 26 75 3d 25 73 } //01 00 
		$a_00_4 = {25 73 3f 61 63 74 69 6f 6e 3d 64 72 6f 70 6f 66 66 26 75 3d 25 73 } //00 00 
	condition:
		any of ($a_*)
