...
rule PWS_Win32_OnLineGames_GL{
	...
	strings :
		...
		$a_03_1 = {05 c0 bb 00 00 a3 90 01 04 60 e8 90 01 04 61 a1 90 01 04 05 b8 b3 00 00 90 00 } //1
		$a_03_2 = {05 10 bf 00 00 a3 90 01 04 60 e8 90 01 04 61 a1 90 01 04 05 08 b7 00 00 90 00 } //1
