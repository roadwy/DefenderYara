...
rule PWS_Win32_OnLineGames_CPX{
	...
	strings :
		...
		$a_02_2 = {8d bd e0 fe ff ff 83 c9 ff 33 c0 8d 95 d8 fc ff ff f2 ae f7 d1 2b f9 6a 2e 8b c1 8b f7 8b fa c1 e9 02 f3 a5 8b c8 83 e1 03 f3 a4 8d 8d d8 fc ff ff 51 ff 15 90 01 03 00 c6 40 01 00 90 00 } //20
