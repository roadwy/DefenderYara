...
rule PWS_Win32_OnLineGames_KZ{
	...
	strings :
		$a_00_0 = {4b 4a 44 4a 53 4b 4b 57 } //01 00  KJDJSKKW
...
rule PWS_Win32_OnLineGames_KZ_2{
	...
	strings :
		$a_01_0 = {32 33 6c 65 6e 72 65 4b } //0a 00  23lenreK
		$a_01_1 = {74 65 6e 69 6e 69 57 } //05 00  teniniW
		$a_01_2 = {6d 6f 64 4d 65 73 73 61 67 65 00 6d 6f 64 6d 43 61 6c 6c 62 61 63 6b 00 } //05 00  潭䵤獥慳敧洀摯䍭污扬捡k
		...
		$a_01_5 = {6d 61 70 6c 65 73 74 6f 72 79 2e 65 78 65 } //01 00  maplestory.exe
		$a_01_6 = {2e 6e 65 78 6f 6e 2e 63 6f 6d } //01 00  .nexon.com
		$a_01_7 = {44 4e 46 2e 65 78 65 } //00 00  DNF.exe
	condition:
		any of ($a_*)
