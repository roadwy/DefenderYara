...
rule PWS_Win32_OnLineGames_IB_2{
	...
	strings :
		...
		$a_03_4 = {83 f8 03 74 05 83 f8 04 75 ?? 68 20 40 00 00 } //2
	condition:
...
rule PWS_Win32_OnLineGames_IB_3{
	...
	strings :
		...
		$a_03_1 = {6a 02 68 6c fb ff ff 56 ff 15 ?? ?? ?? ?? 56 68 94 04 00 00 6a 01 } //1
		$a_03_2 = {59 85 c0 59 74 4f 8b 0d ?? ?? ?? ?? 47 81 c5 04 01 00 00 3b f9 7c e1 } //1
	condition:
...
rule PWS_Win32_OnLineGames_IB_4{
	...
	strings :
		...
		$a_02_4 = {3f 55 73 65 72 4e 61 6d 65 3d [0-10] 26 50 61 73 73 77 6f 72 64 3d [0-10] 26 50 [0-10] 6e 61 6d 65 3d } //1
		$a_02_5 = {26 63 61 72 64 70 61 73 73 3d [0-10] 26 63 61 72 64 6e 75 6d 3d } //1
	condition:
