...
rule PWS_Win32_OnLineGames_IC{
	...
	strings :
		...
		$a_01_1 = {25 73 3f 61 63 74 3d 67 65 74 70 6f 73 26 64 31 30 } //01 00  %s?act=getpos&d10
		$a_01_2 = {25 73 5c 64 6c 6c 63 61 63 68 65 5c 25 73 5f 25 64 2e 6a 70 67 } //00 00  %s\dllcache\%s_%d.jpg
	condition:
		any of ($a_*)
