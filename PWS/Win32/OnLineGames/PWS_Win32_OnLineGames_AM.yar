...
rule PWS_Win32_OnLineGames_AM{
	...
	strings :
		$a_03_0 = {5e 5b 74 0a e8 90 01 04 e8 90 01 04 68 90 01 02 40 00 ff 15 90 01 02 40 00 68 90 90 5f 01 00 ff 15 90 01 02 40 00 90 00 } //1
		$a_03_1 = {6a 0a 68 c8 00 00 00 56 ff 15 90 01 02 40 00 85 c0 74 29 50 56 ff 15 90 01 02 40 00 90 00 } //1
		$a_03_2 = {6a 64 ff d6 e8 90 01 02 ff ff 6a 64 ff d6 e8 90 01 02 ff ff 6a 64 ff d6 eb a6 90 00 } //2
	condition:
...
rule PWS_Win32_OnLineGames_AM_2{
	...
	strings :
		...
		$a_02_3 = {68 74 74 70 3a 2f 2f 90 02 20 77 6f 77 2f 70 6f 73 74 2e 61 73 70 90 00 } //1
