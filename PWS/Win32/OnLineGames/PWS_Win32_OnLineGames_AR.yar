...
rule PWS_Win32_OnLineGames_AR{
	...
	strings :
		$a_02_0 = {5c 73 79 73 74 65 6d 33 32 5c 72 75 6e 64 6c 6c 33 32 2e 65 78 65 20 90 02 10 5c 73 79 73 74 65 6d 33 32 5c 77 64 90 02 06 2e 64 6c 6c 2c 48 6f 6f 6b 00 90 00 } //2
		...
		$a_02_2 = {68 20 00 cc 00 68 02 01 00 00 68 a8 00 00 00 55 6a 19 56 6a 00 6a 00 57 ff 15 90 01 04 8b 2d 90 01 04 be 90 01 04 68 80 00 00 00 56 ff d5 90 00 } //1
