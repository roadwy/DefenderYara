...
rule PWS_Win32_OnLineGames_EX{
	...
	strings :
		$a_03_0 = {33 c0 8d 7d 90 01 01 c6 45 90 01 01 e9 90 00 } //1
		$a_03_1 = {33 f6 ff 75 08 89 90 01 01 0c 89 75 90 01 01 c6 45 90 01 01 60 56 68 ff 0f 1f 00 c6 45 90 01 02 c6 45 90 01 02 c6 45 90 00 } //1
