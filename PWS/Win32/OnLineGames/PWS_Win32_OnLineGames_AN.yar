...
rule PWS_Win32_OnLineGames_AN{
	...
	strings :
		...
		$a_00_2 = {48 42 51 51 2e 64 6c 6c } //05 00 
		$a_00_3 = {50 72 6f 67 72 61 6d 20 4d 61 6e 61 67 65 72 } //01 00 
		$a_00_4 = {33 36 30 73 61 66 65 62 6f 78 2e 65 78 65 } //01 00 
		$a_00_5 = {72 65 6e 61 6d 65 20 25 73 20 25 73 } //01 00 
		$a_00_6 = {69 66 20 65 78 69 73 74 20 25 73 20 67 6f 74 6f 20 52 65 70 65 61 74 } //01 00 
		$a_00_7 = {64 65 6c 20 25 73 } //01 00 
		$a_00_8 = {68 74 74 70 3a 2f 2f } //01 00 
		$a_00_9 = {46 6f 72 74 68 67 6f 6e 65 72 } //00 00 
	condition:
		any of ($a_*)
