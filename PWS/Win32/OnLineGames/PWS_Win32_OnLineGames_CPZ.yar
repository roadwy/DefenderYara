...
rule PWS_Win32_OnLineGames_CPZ{
	...
	strings :
		...
		$a_01_6 = {46 00 69 00 6c 00 65 00 44 00 65 00 73 00 63 00 72 00 69 00 70 00 74 00 69 00 6f 00 6e 00 00 00 00 00 4a 00 41 00 56 00 41 00 7b 76 46 96 68 56 00 } //65496
	condition:
		((#a_00_0  & 1)*10+(#a_00_1  & 1)*10+(#a_00_2  & 1)*10+(#a_00_3  & 1)*10+(#a_00_4  & 1)*1+(#a_00_5  & 1)*1+(#a_01_6  & 1)*65496) >=42
