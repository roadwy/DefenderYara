...
rule PWS_Win32_OnLineGames_CPZ{
	...
	strings :
		$a_00_0 = {6f 70 65 6e 70 72 6f 63 65 73 73 } //0a 00 
		$a_00_1 = {43 72 65 61 74 65 54 6f 6f 6c 68 65 6c 70 33 32 53 6e 61 70 73 68 6f 74 } //0a 00 
		$a_00_2 = {00 77 6f 6f 6f 6c } //0a 00 
		$a_00_3 = {6d 69 72 31 2e 64 61 74 } //01 00 
		$a_00_4 = {6d 6d 2e 64 6c 6c } //01 00 
		$a_00_5 = {6d 69 72 2e 65 78 65 } //d8 ff 
