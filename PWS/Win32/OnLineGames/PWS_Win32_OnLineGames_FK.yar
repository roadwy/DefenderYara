...
rule PWS_Win32_OnLineGames_FK{
	...
	strings :
		$a_01_0 = {73 3f 75 73 3d 25 73 26 70 73 3d 25 73 } //01 00 
		$a_01_1 = {70 6f 6c 63 6f 72 65 2e 64 6c 6c } //01 00 
		$a_01_2 = {2f 66 66 78 69 2f 6d 61 69 6c 2e 61 73 70 } //02 00 
