...
rule PWS_Win32_OnLineGames_ZEI_dll{
	...
	strings :
		$a_03_0 = {f3 ab 66 ab c6 45 90 01 01 78 c6 45 90 01 01 70 c6 45 90 01 01 6c c6 45 90 01 01 6f c6 45 90 01 01 72 c6 45 90 01 01 65 c6 45 90 01 01 72 c6 45 90 01 01 2e 90 00 } //1
		...
		$a_03_3 = {5f 72 65 67 61 6d 6c 65 5f 25 30 38 64 5f 90 09 0d 00 00 67 62 76 90 00 } //1
	condition:
