...
rule PWS_Win32_OnLineGames_FT{
	...
	strings :
		...
		$a_03_1 = {6a 0a ff 15 90 01 02 40 00 8d 85 90 01 02 ff ff 50 e8 90 01 02 00 00 50 8d 85 90 01 02 ff ff 50 8d 85 90 01 02 ff ff 50 e8 90 01 02 00 00 83 c4 10 6a 01 58 90 00 } //1
		$a_03_2 = {68 e8 03 00 00 ff 15 90 01 02 40 00 ff d3 2b 45 90 01 01 3d 40 77 1b 00 76 90 01 01 ff 35 90 01 02 40 00 ff 15 90 01 02 40 00 6a 00 ff 15 90 01 02 40 00 5f 90 00 } //1
	condition:
