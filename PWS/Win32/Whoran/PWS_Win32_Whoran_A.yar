...
rule PWS_Win32_Whoran_A{
	...
	strings :
		$a_03_0 = {83 c9 ff f2 ae f7 d1 49 85 c9 7e 21 8a 4c 14 90 01 01 8d 7c 24 90 01 01 80 f1 90 01 01 33 c0 88 8c 14 90 01 01 01 00 00 83 c9 ff 42 f2 ae 90 00 } //8
