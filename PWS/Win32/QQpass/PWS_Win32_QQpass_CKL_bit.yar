...
rule PWS_Win32_QQpass_CKL_bit{
	...
	strings :
		$a_01_0 = {33 36 30 74 72 61 79 } //01 00 
		$a_01_1 = {74 61 73 6b 6b 69 6c 6c 20 2f 69 6d 20 51 51 2e 45 58 45 } //01 00 
		...
		$a_01_3 = {26 70 61 73 73 77 6f 72 64 3d 31 26 6f 70 5f 74 79 70 65 3d 61 64 64 } //00 00 
	condition:
		any of ($a_*)
