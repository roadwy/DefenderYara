...
rule PWS_Win32_QQpass_CJS{
	...
	strings :
		...
		$a_00_2 = {3f 51 51 4e 75 6d 62 65 72 3d } //01 00  ?QQNumber=
		$a_00_3 = {26 51 51 50 61 73 73 57 6f 72 64 3d } //01 00  &QQPassWord=
		$a_00_4 = {54 58 47 75 69 46 6f 75 6e 64 61 74 69 6f 6e } //00 00  TXGuiFoundation
	condition:
		any of ($a_*)
