...
rule PWS_Win32_QQpass_EL{
	...
	strings :
		...
		$a_00_1 = {74 61 73 6b 6b 69 6c 6c 20 2f 66 20 2f 69 6d 20 25 73 20 2f 74 } //01 00  taskkill /f /im %s /t
		...
		$a_00_4 = {68 70 69 67 5f 57 53 32 2e 64 61 74 } //00 00  hpig_WS2.dat
	condition:
		any of ($a_*)
