...
rule PWS_Win32_QQpass_BJ{
	...
	strings :
		...
		$a_00_1 = {31 32 37 2e 30 2e 30 2e 31 90 02 10 6c 6f 63 61 6c 68 6f 73 74 90 00 } //1
		...
		$a_03_5 = {68 04 13 00 00 57 e8 90 01 02 ff ff 48 85 c0 0f 8c e4 00 00 00 40 89 45 90 01 01 33 f6 c7 45 90 01 01 01 00 00 00 33 c0 89 45 90 01 01 33 c0 89 45 90 01 01 c7 45 90 01 01 00 08 00 00 8b 45 90 01 01 83 c0 70 90 00 } //2
	condition:
