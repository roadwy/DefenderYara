...
rule PWS_Win32_QQpass_CD{
	...
	strings :
		...
		$a_02_5 = {8b 03 05 00 00 2f 00 50 6a 00 68 79 01 00 00 68 90 01 04 6a 00 8b 0b 81 c1 00 00 21 00 ba 90 01 04 a1 90 01 04 e8 90 01 04 89 06 83 3e 00 74 90 01 01 33 c0 a3 90 01 04 8b 06 83 c0 05 a3 90 01 04 68 00 00 4f 00 6a 07 6a 00 90 00 } //10
	condition:
