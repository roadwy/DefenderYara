...
rule PWS_Win32_QQpass_FX{
	...
	strings :
		$a_01_0 = {5c 49 6e 74 65 72 6e 61 6c 2e 65 78 65 } //01 00  \Internal.exe
		$a_01_1 = {5c 56 6f 64 43 61 74 63 68 } //01 00  \VodCatch
		$a_01_2 = {da d1 b6 51 51 2e 6c 6e 6b 00 } //01 00 
		$a_01_3 = {75 51 51 32 30 31 32 56 65 72 73 69 6f 6e } //01 00  uQQ2012Version
