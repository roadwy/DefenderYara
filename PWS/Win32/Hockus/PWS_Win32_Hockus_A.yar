...
rule PWS_Win32_Hockus_A{
	...
	strings :
		...
		$a_01_1 = {50 61 73 73 77 6f 72 64 3a } //01 00  Password:
		...
		$a_00_3 = {75 70 67 72 61 64 65 2e 74 78 74 3f 73 69 67 6e 3d } //01 00  upgrade.txt?sign=
		$a_00_4 = {72 62 6c 2e 74 78 74 3f 73 69 67 6e 3d } //00 00  rbl.txt?sign=
	condition:
		any of ($a_*)
