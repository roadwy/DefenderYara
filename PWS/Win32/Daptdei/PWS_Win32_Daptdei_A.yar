...
rule PWS_Win32_Daptdei_A{
	...
	strings :
		$a_03_0 = {83 c8 ff eb 18 8b c8 81 e1 ff 00 00 00 0f be d2 33 ca c1 e8 08 46 33 04 8d ?? ?? ?? ?? 8a 16 84 d2 75 e2 } //1
		$a_01_1 = {ba 00 00 00 70 59 3b c2 76 25 8b 48 3c 8b 4c 01 78 81 7c 01 18 00 03 00 00 77 10 05 00 00 ff ff } //1
		$a_03_2 = {74 06 40 80 30 ?? 75 fa } //1
		$a_03_3 = {75 3d 8d 45 fc 50 68 01 00 00 98 57 c7 45 fc 01 00 00 00 e8 ?? ?? ?? ?? 85 c0 75 23 } //1
		$a_03_4 = {66 39 46 16 0f 85 ?? ?? 00 00 53 83 c6 28 81 3e 55 53 45 52 } //1
