...
rule PWS_Win32_Karagany_A{
	...
	strings :
		...
		$a_03_1 = {88 0c 02 4f 75 90 01 01 c7 45 fc 64 a5 00 00 8b 75 f0 85 f6 7c 90 00 } //1
		...
		$a_03_4 = {8b 13 8a 54 32 ff 80 f2 5c 88 54 30 ff 46 4f 75 90 01 01 8b 03 0f b6 70 02 8b 03 0f b6 78 03 90 00 } //1
	condition:
