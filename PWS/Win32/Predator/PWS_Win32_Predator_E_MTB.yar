...
rule PWS_Win32_Predator_E_MTB{
	...
	strings :
		...
		$a_01_1 = {5c 41 70 70 6c 69 63 61 74 69 6f 6e 20 44 61 74 61 5c 70 74 73 74 } //01 00 
		$a_01_2 = {5c 41 70 70 6c 69 63 61 74 69 6f 6e 20 44 61 74 61 5c 7a 70 61 72 2e 7a 69 70 } //00 00 
	condition:
		any of ($a_*)
