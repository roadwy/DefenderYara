...
rule PWS_Win32_Predator_KM_MTB{
	...
	strings :
		$a_02_0 = {c1 e9 05 03 8d 90 01 04 89 90 01 05 89 90 01 05 89 90 01 05 8b 90 01 05 31 90 01 05 81 3d 90 01 04 72 07 00 00 75 90 00 } //1
	condition:
		((#a_02_0  & 1)*1) >=1
...
rule PWS_Win32_Predator_KM_MTB_2{
	...
	strings :
		$a_02_0 = {03 ce 89 4d e0 8b ce c1 e9 05 03 4d 90 01 01 89 45 90 01 01 89 1d 90 01 04 89 1d 90 01 04 8b 45 e0 31 45 fc 81 3d 90 01 04 72 07 00 00 75 90 00 } //1
	condition:
		((#a_02_0  & 1)*1) >=1
...
rule PWS_Win32_Predator_KM_MTB_3{
	...
	strings :
		$a_02_0 = {c1 e8 05 89 45 90 01 01 c7 05 90 01 04 2e ce 50 91 8b 85 90 01 05 45 90 01 01 33 d2 81 3d 90 01 04 12 09 00 00 75 90 00 } //1
...
rule PWS_Win32_Predator_KM_MTB_5{
	...
	strings :
		$a_02_0 = {c1 eb 05 03 9d 90 01 04 89 85 90 01 04 89 35 90 01 04 89 35 90 01 04 8b 85 90 01 04 31 85 90 01 04 81 3d 90 01 04 72 07 00 00 75 90 00 } //1
		$a_02_1 = {c1 e9 05 03 4d 90 01 01 c7 05 90 01 04 b4 1a 3a df 89 45 90 01 01 89 35 90 01 04 89 35 90 01 04 8b 45 90 01 01 31 45 90 01 01 81 3d 90 01 04 72 07 00 00 75 90 00 } //1
		$a_02_2 = {c1 e9 05 03 4c 24 90 01 01 c7 05 90 01 04 b4 1a 3a df 89 44 24 90 01 01 89 35 90 01 04 89 35 90 01 04 8b 44 24 90 01 01 31 44 24 90 01 01 81 3d 90 01 04 72 07 00 00 75 90 00 } //1
	condition:
