...
rule BrowserModifier_Win32_Pointfree{
	...
	strings :
		$a_00_0 = {2e 70 6f 69 6e 74 66 72 65 65 2e 63 6f 2e 6b 72 } //01 00  .pointfree.co.kr
		$a_00_1 = {72 65 67 73 76 72 33 32 20 2f 75 20 2f 73 20 } //01 00  regsvr32 /u /s 
		...
		$a_00_3 = {2e 70 68 70 3f 49 4c 5f 4e 4f 3d } //01 00  .php?IL_NO=
	condition:
		any of ($a_*)
...
rule BrowserModifier_Win32_Pointfree_2{
	...
	strings :
		$a_01_0 = {77 77 77 2e 70 6f 69 6e 74 66 72 65 65 2e 63 6f 2e 6b 72 2f 61 70 70 2f 72 65 6d 6f 76 65 2e 70 68 70 } //01 00  www.pointfree.co.kr/app/remove.php
		...
		$a_01_2 = {26 6d 32 63 6f 64 65 3d 25 73 } //01 00  &m2code=%s
		$a_01_3 = {52 65 63 6f 76 65 72 79 45 78 65 4e 61 6d 65 } //01 00  RecoveryExeName
	condition:
		any of ($a_*)
...
rule BrowserModifier_Win32_Pointfree_3{
	...
	strings :
		...
		$a_00_2 = {50 6f 69 6e 74 66 72 65 65 5c 50 46 48 65 6c 70 65 72 2e 62 61 6b } //01 00  Pointfree\PFHelper.bak
		...
		$a_00_5 = {52 65 73 74 61 72 74 2a 2e 62 61 74 22 } //01 00  Restart*.bat"
