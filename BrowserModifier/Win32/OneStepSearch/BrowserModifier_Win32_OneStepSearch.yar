...
rule BrowserModifier_Win32_OneStepSearch_4{
	...
	strings :
		...
		$a_01_2 = {43 6f 70 79 72 69 67 68 74 20 28 63 29 20 32 30 30 37 20 4f 6e 65 53 74 65 70 53 65 61 72 63 68 2e 6e 65 74 2c 20 49 6e 63 2e } //03 00 
		...
		$a_01_5 = {47 65 74 50 72 6f 63 41 64 64 72 65 73 73 } //02 00 
		$a_01_6 = {47 65 74 43 6f 6d 6d 61 6e 64 4c 69 6e 65 41 } //00 00 
	condition:
		any of ($a_*)
...
rule BrowserModifier_Win32_OneStepSearch_5{
	...
	strings :
		...
		$a_01_1 = {6f 6e 65 73 74 65 70 73 65 61 72 63 68 2e 6e 65 74 2f 3f 70 72 74 3d 25 73 26 } //07 00 
		...
		$a_01_6 = {4f 6e 65 53 74 65 70 53 65 61 72 63 68 5f 64 65 6c 65 74 65 64 5f } //06 00 
		$a_01_7 = {68 74 74 70 3a 2f 2f 75 70 67 72 61 64 65 2e 6f 6e 65 73 74 65 70 73 65 61 72 63 68 2e 6e 65 74 } //06 00 
		$a_01_8 = {4f 6e 65 53 74 65 70 20 53 65 61 72 63 68 20 4f 70 74 69 6f 6e 73 20 50 61 6e 65 6c } //06 00 
		$a_01_9 = {55 70 64 61 74 65 20 61 6e 64 20 63 6f 6e 74 72 6f 6c 20 66 6f 72 20 4f 6e 65 53 74 65 70 20 53 65 61 72 63 68 } //00 00 
	condition:
		any of ($a_*)
