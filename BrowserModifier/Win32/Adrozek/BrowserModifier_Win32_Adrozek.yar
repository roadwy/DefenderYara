...
rule BrowserModifier_Win32_Adrozek_4{
	...
	strings :
		$a_01_0 = {31 30 35 42 38 30 44 45 2d 39 35 46 31 2d 31 31 44 30 2d 42 30 41 30 2d 30 30 41 41 30 30 42 44 43 42 35 43 } //01 00 
...
rule BrowserModifier_Win32_Adrozek_5{
	...
	strings :
		...
		$a_00_1 = {46 00 6f 00 6c 00 64 00 65 00 72 00 5c 00 53 00 68 00 65 00 6c 00 6c 00 45 00 78 00 5c 00 43 00 6f 00 6e 00 74 00 65 00 78 00 74 00 4d 00 65 00 6e 00 75 00 48 00 61 00 6e 00 64 00 6c 00 65 00 72 00 73 00 5c 00 61 00 76 00 61 00 73 00 74 00 } //00 00 
	condition:
		any of ($a_*)
