...
rule BrowserModifier_Win32_PoinBag_2{
	...
	strings :
		...
		$a_03_1 = {43 4f 44 45 25 64 90 01 02 53 45 41 52 43 48 55 52 4c 90 01 0b 6b 65 79 63 6f 64 65 2e 64 61 74 90 00 } //1
		$a_01_2 = {64 6f 6d 61 69 6e 72 65 66 65 72 2e 64 61 74 } //1 domainrefer.dat
		$a_03_3 = {6a 65 6a 75 2e 6b 72 90 01 04 2e 67 79 65 6f 6e 67 6e 61 6d 2e 6b 72 90 00 } //1
		$a_01_4 = {70 6f 69 6e 62 61 67 75 70 2e 70 64 62 } //1 poinbagup.pdb
		$a_03_5 = {44 4f 57 4e 55 52 4c 90 01 01 46 49 4c 45 4e 41 4d 45 90 01 04 53 4f 46 54 57 41 52 45 5c 70 6f 69 6e 62 61 67 90 00 } //1
