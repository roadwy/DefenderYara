...
rule BrowserModifier_Win32_Zwangi{
	...
	strings :
		$a_01_0 = {3c 26 74 0a 3c 3d 74 06 } //01 00  ☼ੴ㴼ٴ
...
rule BrowserModifier_Win32_Zwangi_2{
	...
	strings :
		...
		$a_01_1 = {5a 75 6d 69 65 20 6c 6f 61 64 65 72 } //00 00  Zumie loader
	condition:
		any of ($a_*)
...
rule BrowserModifier_Win32_Zwangi_22{
	...
	strings :
		...
		$a_01_1 = {26 70 61 72 74 6e 65 72 3d 00 } //01 00  瀦牡湴牥=
...
rule BrowserModifier_Win32_Zwangi_31{
	...
	strings :
		$a_00_0 = {63 6d 64 20 2f 63 20 70 69 6e 67 20 31 32 37 2e 30 2e 30 2e 31 20 2d 6e 20 32 20 26 26 20 64 65 6c 20 22 } //01 00  cmd /c ping 127.0.0.1 -n 2 && del "
		$a_00_1 = {2f 69 6e 73 74 61 6c 6c 2e 61 73 70 78 3f 62 3d 62 61 73 69 63 73 63 61 6e 26 64 3d 6f 70 73 64 65 76 } //01 00  /install.aspx?b=basicscan&d=opsdev
...
rule BrowserModifier_Win32_Zwangi_33{
	...
	strings :
		$a_00_0 = {53 6f 66 74 77 61 72 65 5c 4d 69 63 72 6f 73 6f 66 74 5c 49 6e 74 65 72 6e 65 74 20 45 78 70 6c 6f 72 65 72 5c 45 78 74 65 6e 73 69 6f 6e 73 } //0a 00  Software\Microsoft\Internet Explorer\Extensions
		$a_00_1 = {61 70 70 6c 69 63 61 74 69 6f 6e 2f 78 2d 77 77 77 2d 66 6f 72 6d 2d 75 72 6c 65 6e 63 6f 64 65 64 } //0a 00  application/x-www-form-urlencoded
		$a_00_2 = {3c 55 72 6c 20 74 79 70 65 3d 22 74 65 78 74 2f 68 74 6d 6c 22 20 6d 65 74 68 6f 64 3d 22 47 45 54 22 20 74 65 6d 70 6c 61 74 65 3d 22 } //01 00  <Url type="text/html" method="GET" template="
		$a_03_3 = {3c 53 68 6f 72 74 4e 61 6d 65 3e 4b 77 90 03 01 01 69 61 6e 7a 79 3c 2f 53 68 6f 72 74 4e 61 6d 65 3e 90 00 } //01 00 
		$a_00_4 = {3c 53 68 6f 72 74 4e 61 6d 65 3e 5a 77 75 6e 7a 69 3c 2f 53 68 6f 72 74 4e 61 6d 65 3e } //01 00  <ShortName>Zwunzi</ShortName>
		$a_00_5 = {3c 53 68 6f 72 74 4e 61 6d 65 3e 46 69 6e 64 42 61 73 69 63 3c 2f 53 68 6f 72 74 4e 61 6d 65 3e } //00 00  <ShortName>FindBasic</ShortName>
	condition:
		any of ($a_*)
...
rule BrowserModifier_Win32_Zwangi_38{
	...
	strings :
		$a_01_0 = {41 64 6d 69 6e 69 73 74 72 61 74 6f 72 5c 41 70 70 6c 69 63 61 74 69 6f 6e 20 44 61 74 61 43 4c 49 45 4e 54 } //02 00  Administrator\Application DataCLIENT
		$a_01_1 = {53 6f 66 74 77 61 72 65 5c 4d 69 63 72 6f 73 6f 66 74 5c 57 69 6e 64 6f 77 73 5c 43 75 72 72 65 6e 74 56 65 72 73 69 6f 6e 5c 55 6e 69 6e 73 74 61 6c 6c 5c 5a 75 6d 69 65 } //02 00  Software\Microsoft\Windows\CurrentVersion\Uninstall\Zumie
		$a_01_2 = {63 68 65 63 6b 75 70 64 } //02 00  checkupd
		$a_01_3 = {43 6f 70 79 72 69 67 68 74 20 28 63 29 20 32 30 30 37 20 5a 75 6d 69 65 2e 63 6f 6d } //02 00  Copyright (c) 2007 Zumie.com
		$a_01_4 = {5a 75 6d 69 65 20 4f 70 74 69 6f 6e 73 20 50 61 6e 65 6c } //02 00  Zumie Options Panel
		$a_01_5 = {42 6c 69 6e 6b 20 4f 70 74 69 6f 6e 73 20 50 61 6e 65 6c 20 69 73 20 61 6c 72 65 61 64 79 20 72 75 6e 6e 69 6e 67 21 } //02 00  Blink Options Panel is already running!
		$a_01_6 = {62 6c 69 6e 6b 6f 70 74 2e 70 64 62 } //02 00  blinkopt.pdb
		$a_01_7 = {5a 00 75 00 6d 00 69 00 65 00 20 00 53 00 65 00 61 00 72 00 63 00 68 00 20 00 53 00 6f 00 66 00 74 00 77 00 61 00 72 00 65 00 20 00 41 00 63 00 74 00 69 00 76 00 61 00 74 00 65 00 64 00 } //00 00  Zumie Search Software Activated
	condition:
		any of ($a_*)
...
rule BrowserModifier_Win32_Zwangi_46{
	...
	strings :
		$a_01_0 = {32 31 30 31 20 52 6f 73 65 63 72 61 6e 73 20 41 76 65 6e 75 65 2c 20 53 75 69 74 65 20 32 30 30 30 20 45 6c 20 53 65 67 75 6e 64 6f 2c 20 43 41 20 39 30 32 34 35 } //01 00  2101 Rosecrans Avenue, Suite 2000 El Segundo, CA 90245
		...
		$a_01_2 = {74 75 72 6e 73 20 79 6f 75 72 20 62 72 6f 77 73 65 72 20 61 64 64 72 65 73 73 20 62 61 72 20 28 74 68 65 20 70 6c 61 63 65 20 77 68 65 72 65 20 79 6f 75 20 67 65 6e 65 72 61 6c 6c 79 20 74 79 70 65 20 69 6e 20 77 65 62 20 73 69 74 65 20 61 64 64 72 65 73 73 65 73 29 20 69 6e 74 6f 20 61 6e 20 49 6e 74 65 72 6e 65 74 20 73 65 61 72 63 68 20 62 6f 78 2e } //01 00  turns your browser address bar (the place where you generally type in web site addresses) into an Internet search box.
...
rule BrowserModifier_Win32_Zwangi_50{
	...
	strings :
		...
		$a_01_5 = {6e 3d 25 73 26 63 3d 25 73 26 76 3d 25 73 26 65 3d 25 64 26 75 3d 25 64 00 26 6e 25 64 3d 25 73 26 63 25 64 3d 25 73 26 76 25 64 3d 25 73 26 65 25 64 3d 25 64 26 75 25 64 3d 25 64 } //01 00  㵮猥挦┽♳㵶猥攦┽♤㵵搥☀╮㵤猥挦搥┽♳╶㵤猥攦搥┽♤╵㵤搥
		$a_00_6 = {62 61 72 64 69 73 63 6f 76 65 72 } //01 00  bardiscover
		$a_00_7 = {62 61 72 71 75 65 72 79 } //01 00  barquery
		$a_00_8 = {62 61 73 69 63 73 63 61 6e } //01 00  basicscan
		$a_00_9 = {62 72 6f 77 73 65 72 64 69 73 63 6f 76 65 72 } //01 00  browserdiscover
		$a_00_10 = {62 72 6f 77 73 65 72 71 75 65 72 79 } //01 00  browserquery
		$a_00_11 = {62 72 6f 77 73 65 72 71 75 65 73 74 } //01 00  browserquest
		$a_00_12 = {62 72 6f 77 73 65 72 73 65 65 6b } //01 00  browserseek
		$a_00_13 = {62 72 6f 77 73 65 72 7a 69 6e 63 } //01 00  browserzinc
		$a_00_14 = {66 69 6e 64 65 72 71 75 65 72 79 } //01 00  finderquery
		$a_00_15 = {66 69 6e 64 78 70 6c 6f 72 65 72 } //01 00  findxplorer
		$a_00_16 = {6b 77 61 6e 7a 79 } //01 00  kwanzy
		$a_00_17 = {71 75 65 72 79 62 61 72 } //01 00  querybar
		$a_00_18 = {71 75 65 72 79 62 72 6f 77 73 65 } //01 00  querybrowse
		$a_00_19 = {71 75 65 72 79 65 78 70 6c 6f 72 65 72 } //01 00  queryexplorer
		$a_00_20 = {71 75 65 72 79 72 65 73 75 6c 74 } //01 00  queryresult
		$a_00_21 = {71 75 65 72 79 73 63 61 6e } //01 00  queryscan
		$a_00_22 = {71 75 65 73 74 62 61 73 69 63 } //01 00  questbasic
		$a_00_23 = {71 75 65 73 74 62 61 73 69 63 6f 6e 65 } //01 00  questbasicone
		$a_00_24 = {71 75 65 73 74 62 72 6f 77 73 65 } //01 00  questbrowse
		$a_00_25 = {71 75 65 73 74 62 72 77 73 65 61 72 63 68 } //01 00  questbrwsearch
		$a_00_26 = {71 75 65 73 74 64 6e } //01 00  questdn
		$a_00_27 = {71 75 65 73 74 72 65 73 75 6c 74 } //01 00  questresult
		$a_00_28 = {71 75 65 73 74 73 63 61 6e } //01 00  questscan
		$a_00_29 = {71 75 65 73 74 73 63 61 6e 74 77 6f } //01 00  questscantwo
		$a_00_30 = {71 75 65 73 74 73 65 72 76 69 63 65 } //01 00  questservice
		$a_00_31 = {71 75 65 73 74 75 72 6c } //01 00  questurl
		$a_00_32 = {72 65 73 75 6c 63 6d 64 } //01 00  resulcmd
		$a_00_33 = {72 65 73 75 6c 74 62 61 72 } //01 00  resultbar
		$a_00_34 = {72 65 73 75 6c 74 62 72 6f 77 73 65 } //01 00  resultbrowse
		$a_00_35 = {72 65 73 75 6c 74 64 6e } //01 00  resultdn
		$a_00_36 = {72 65 73 75 6c 74 73 63 61 6e } //01 00  resultscan
		$a_00_37 = {72 65 73 75 6c 74 73 63 61 6e 6f 6e 65 } //01 00  resultscanone
		$a_00_38 = {72 65 73 75 6c 74 74 6f 6f 6c } //01 00  resulttool
		$a_00_39 = {72 65 73 75 6c 74 75 72 6c } //01 00  resulturl
		$a_00_40 = {73 63 61 6e 62 61 73 69 63 } //01 00  scanbasic
		$a_00_41 = {73 63 61 6e 71 75 65 72 79 } //01 00  scanquery
		$a_00_42 = {73 65 65 6b 64 6e } //01 00  seekdn
		$a_00_43 = {73 70 61 63 65 71 75 65 72 79 } //01 00  spacequery
		$a_00_44 = {74 61 62 64 69 73 63 6f 76 65 72 } //01 00  tabdiscover
		$a_00_45 = {74 61 62 71 75 65 72 79 } //01 00  tabquery
		$a_00_46 = {77 69 6e 6b 7a 69 6e 6b } //01 00  winkzink
		$a_00_47 = {77 79 65 6b 65 } //01 00  wyeke
		$a_00_48 = {7a 69 6e 69 6b 79 } //01 00  ziniky
		$a_00_49 = {7a 69 6e 6b 73 65 65 6b } //01 00  zinkseek
		$a_00_50 = {7a 69 6e 6b 77 69 6e 6b } //01 00  zinkwink
		$a_00_51 = {7a 69 6e 6b 7a 6f } //01 00  zinkzo
		$a_00_52 = {7a 6f 70 74 } //01 00  zopt
		$a_00_53 = {7a 75 6d 69 65 } //01 00  zumie
		$a_00_54 = {7a 77 61 6e 67 69 65 } //01 00  zwangie
		$a_00_55 = {7a 77 61 6e 6b 79 73 65 61 72 63 68 } //01 00  zwankysearch
		$a_00_56 = {7a 77 75 6e 7a 69 } //01 00  zwunzi
		$a_00_57 = {2d 70 20 51 73 74 62 73 63 } //01 00  -p Qstbsc
		$a_00_58 = {2d 70 20 42 73 63 73 63 6e } //01 00  -p Bscscn
		$a_01_59 = {40 23 40 26 6e 55 39 50 57 45 09 5e 59 62 57 55 40 23 40 26 40 23 40 26 57 3b 09 6d 4f 6b 4b 55 } //00 00  ⍀♀啮倹䕗帉扙啗⍀♀⍀♀㭗洉歏啋
...
rule BrowserModifier_Win32_Zwangi_52{
	...
	strings :
		$a_01_0 = {3a 43 72 65 61 74 65 4d 75 74 65 78 41 28 69 20 30 2c 20 69 20 30 2c 20 74 20 22 53 70 61 63 65 51 75 65 72 79 5f 49 6e 73 74 5f 6d 74 78 22 29 } //01 00  :CreateMutexA(i 0, i 0, t "SpaceQuery_Inst_mtx")
		$a_01_1 = {3a 43 72 65 61 74 65 4d 75 74 65 78 41 28 69 20 30 2c 20 69 20 30 2c 20 74 20 22 53 70 61 63 65 51 75 65 72 79 5f 55 6e 69 6e 73 74 5f 6d 74 78 22 29 } //00 00  :CreateMutexA(i 0, i 0, t "SpaceQuery_Uninst_mtx")
	condition:
		any of ($a_*)
