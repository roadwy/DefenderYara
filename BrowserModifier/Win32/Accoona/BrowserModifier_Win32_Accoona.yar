...
rule BrowserModifier_Win32_Accoona{
	...
	strings :
		...
		$a_01_1 = {68 74 74 70 3a 2f 2f 77 77 77 2e 61 63 63 6f 6f 6e 61 2e 63 6f 6d 2f } //01 00  http://www.accoona.com/
		$a_01_2 = {43 3a 5c 50 72 6f 67 72 61 6d 20 46 69 6c 65 73 5c 41 63 63 6f 6f 6e 61 } //00 00  C:\Program Files\Accoona
	condition:
		any of ($a_*)
