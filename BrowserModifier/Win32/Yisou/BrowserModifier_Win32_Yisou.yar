...
rule BrowserModifier_Win32_Yisou{
	...
	strings :
		...
		$a_01_1 = {53 6f 66 74 77 61 72 65 5c 33 37 32 31 5c 79 69 73 6f 75 } //01 00  Software\3721\yisou
		$a_01_2 = {63 6c 69 65 6e 74 5f 62 61 72 5f 73 64 72 61 67 26 70 3d 25 73 } //01 00  client_bar_sdrag&p=%s
		$a_01_3 = {42 68 6f 4f 62 6a 2e 44 4c 4c 00 44 6c 6c 43 61 6e 55 6e 6c 6f 61 64 4e 6f 77 } //00 00  桂佯橢䐮䱌䐀汬慃啮汮慯乤睯
	condition:
		any of ($a_*)
