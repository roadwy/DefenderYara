...
rule BrowserModifier_Win32_Xider_3{
	...
	strings :
		...
		$a_03_2 = {65 72 72 5f 75 6e 6d 69 78 69 6e 67 5f 69 65 5f 65 6e 61 62 6c 65 72 5f 90 02 09 43 6f 70 79 69 6e 67 20 66 72 6f 6d 90 02 09 5c 90 02 0f 2e 74 6d 70 90 00 } //1
		$a_03_3 = {65 72 72 5f 65 78 74 72 61 74 69 6e 67 5f 69 65 5f 65 6e 61 62 6c 65 72 90 0a a0 00 5c 90 02 08 2d 90 02 04 2d 90 02 04 2d 90 02 04 2d 90 02 0c 2d 32 2e 65 78 65 90 00 } //1
		$a_03_4 = {2f 6d 6f 6e 65 74 69 7a 61 74 69 6f 6e 2e 67 69 66 3f 65 76 65 6e 74 3d 90 02 02 26 69 62 69 63 3d 90 01 03 26 76 65 72 69 66 69 65 72 3d 90 01 03 26 63 61 6d 70 61 69 67 6e 3d 90 00 } //5
	condition:
