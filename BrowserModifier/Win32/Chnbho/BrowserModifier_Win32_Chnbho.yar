...
rule BrowserModifier_Win32_Chnbho{
	...
	strings :
		$a_01_0 = {4c 61 6e 67 75 61 67 65 5c 43 68 69 6e 65 73 65 5c 73 65 61 72 63 68 62 61 72 2e 69 6e 69 } //02 00 
		...
		$a_01_3 = {6e 61 6d 65 2e 63 6e 6e 69 63 2e 6e 65 74 } //01 00 
		$a_01_4 = {77 77 77 2e 62 61 69 64 75 2e 63 6f 6d 2f 62 61 69 64 75 } //01 00 
		$a_01_5 = {33 37 32 31 2e 63 6f 6d 2f 63 6e 73 2e 64 6c 6c } //01 00 
		$a_01_6 = {70 61 67 65 2e 7a 68 6f 6e 67 73 6f 75 2e 63 6f 6d 2f } //00 00 
	condition:
		any of ($a_*)
