...
rule BrowserModifier_Win32_Monkostey_2{
	...
	strings :
		$a_03_0 = {8b 45 0c 53 33 db 83 7d 08 02 c6 45 ?? 65 c6 45 ?? 6e c6 45 ?? 4d c6 45 ?? 75 c6 45 ?? 52 c6 45 ?? 61 } //1
		$a_03_1 = {8d 45 d4 50 6a 02 53 89 75 d4 c7 45 ?? 03 00 00 00 89 75 ?? 89 75 ?? 89 75 ?? ff 15 ?? ?? ?? ?? 53 8b f0 ff d7 eb } //1
		$a_03_2 = {ff d7 53 6a 26 bd ?? ?? ?? ?? 55 53 ff d6 68 ?? ?? ?? ?? 55 ff d7 53 6a 23 bd ?? ?? ?? ?? 55 53 ff d6 } //1
	condition:
...
rule BrowserModifier_Win32_Monkostey_3{
	...
	strings :
		$a_03_0 = {6a 73 58 6a 69 66 89 ?? ?? 58 6a 4d 66 89 ?? ?? 58 6a 61 66 89 ?? ?? 58 66 89 ?? ?? 6a 53 33 c0 66 89 ?? ?? 58 6a 66 } //1
		$a_03_1 = {0f b7 08 66 83 f9 2d 74 ?? 66 83 f9 2f 0f ?? ?? 00 00 00 6a 73 59 6a 61 66 89 4d ?? 66 89 4d ?? 59 6a 6d 66 89 4d ?? 59 66 89 4d ?? 33 c9 6a 73 } //1
		$a_03_2 = {c7 46 10 04 00 00 00 89 5e 14 89 5e 18 89 5e 1c 89 5e 20 89 5d fc 68 08 02 00 00 8d 46 3c 53 50 c7 ?? ?? ?? ?? 00 88 5e 28 89 5e 2c c7 46 34 e8 03 00 00 89 5e 38 e8 } //1
	condition:
		((#a_03_0  & 1)*1+(#a_03_1  & 1)*1+(#a_03_2  & 1)*1) >=3
...
rule BrowserModifier_Win32_Monkostey_4{
	...
	strings :
		...
		$a_03_6 = {83 7d 08 02 8b 45 0c c6 45 ?? 6f c6 45 ?? 6e c6 45 ?? 75 c6 45 ?? 46 c6 45 ?? 00 } //1
...
rule BrowserModifier_Win32_Monkostey_5{
	...
	strings :
		...
		$a_03_1 = {64 00 62 00 67 00 2e 00 70 00 68 00 70 00 3f 00 61 00 63 00 74 00 69 00 6f 00 6e 00 3d 00 53 00 65 00 72 00 76 00 69 00 63 00 65 00 4d 00 61 00 69 00 6e 00 44 00 6c 00 67 00 53 00 74 00 61 00 72 00 74 00 26 00 49 00 45 00 3d 00 ?? ?? ?? ?? ?? ?? 26 00 4f 00 53 00 3d 00 ?? ?? ?? ?? ?? ?? 26 00 74 00 65 00 73 00 74 00 3d 00 [0-06] 26 00 55 00 73 00 65 00 72 00 49 00 64 00 3d 00 } //1
