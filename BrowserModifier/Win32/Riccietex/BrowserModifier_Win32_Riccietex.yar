...
rule BrowserModifier_Win32_Riccietex{
	...
	strings :
		...
		$a_01_2 = {55 6e 5f 41 64 73 } //01 00  Un_Ads
		$a_01_3 = {55 6e 5f 4d 61 69 6e 50 61 67 65 } //01 00  Un_MainPage
		$a_01_4 = {43 68 6b 5f 44 65 73 6b 74 6f 70 4c 69 6e 6b } //01 00  Chk_DesktopLink
		$a_01_5 = {43 68 6b 5f 48 6f 6d 65 50 61 67 65 } //01 00  Chk_HomePage
		$a_01_6 = {43 68 6b 5f 51 75 69 63 6b 4c 61 75 6e 63 68 } //01 00  Chk_QuickLaunch
		$a_01_7 = {2f 72 65 61 64 2e 70 68 70 3f 74 3d } //01 00  /read.php?t=
		...
		$a_01_9 = {4b 6e 67 53 74 72 5f 49 41 4d } //01 00  KngStr_IAM
		$a_01_10 = {49 41 4d 5f 53 45 54 49 45 48 50 } //01 00  IAM_SETIEHP
		$a_01_11 = {49 41 4d 5f 44 4c } //01 00  IAM_DL
		$a_01_12 = {72 20 65 20 61 20 64 20 2e 20 70 20 68 20 20 70 20 3f 20 74 3d 20 61 20 64 20 73 20 26 64 3d } //01 00  r e a d . p h  p ? t= a d s &d=
		$a_01_13 = {71 20 71 20 62 20 20 72 20 6f 20 77 20 20 73 20 65 20 72 20 20 2c 75 20 63 20 62 20 20 72 20 6f 20 77 20 20 73 20 65 20 72 20 20 2c 62 20 61 20 69 20 20 64 20 75 20 62 20 20 72 20 6f 20 77 20 20 73 20 65 20 72 20 20 2c 69 20 65 20 78 20 20 70 20 6c 20 6f 20 20 72 20 65 20 2c 74 20 68 20 65 20 20 77 20 6f 20 72 20 20 6c 20 64 } //01 00  q q b  r o w  s e r  ,u c b  r o w  s e r  ,b a i  d u b  r o w  s e r  ,i e x  p l o  r e ,t h e  w o r  l d
		$a_01_14 = {73 20 6f 20 67 20 20 6f 20 75 20 65 20 20 78 20 70 20 6c 20 20 6f 20 72 20 65 20 20 72 20 2c 32 20 33 20 34 20 20 35 20 65 20 78 20 20 70 20 6c 20 6f 20 20 72 20 65 20 72 20 20 2c 63 20 68 20 72 20 20 6f 20 6d 20 65 20 20 2c 6a 20 75 20 7a 20 20 69 20 2c 68 20 61 20 6f 20 20 31 20 32 20 33 20 20 6a 20 75 20 7a 20 20 69 20 2c 66 20 69 20 72 20 20 65 20 66 20 6f 20 20 78 } //00 00  s o g  o u e  x p l  o r e  r ,2 3 4  5 e x  p l o  r e r  ,c h r  o m e  ,j u z  i ,h a o  1 2 3  j u z  i ,f i r  e f o  x
