...
rule BrowserModifier_Win32_Procesemes_B{
	...
	strings :
		$a_01_0 = {4c 6f 61 64 52 65 73 6f 75 72 63 65 } //01 00 
		$a_01_1 = {44 6c 6c 43 61 6e 55 6e 6c 6f 61 64 4e 6f 77 } //01 00 
		$a_01_2 = {48 74 74 70 4f 70 65 6e 52 65 71 75 65 73 74 57 } //01 00 
		...
		$a_01_4 = {49 6e 74 65 72 6e 65 74 53 65 74 43 6f 6f 6b 69 65 57 } //01 00 
