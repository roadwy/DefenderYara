...
rule BrowserModifier_Win32_Webalta{
	...
	strings :
		$a_01_0 = {47 6c 6f 62 61 6c 5c 53 65 61 72 63 68 53 65 72 76 69 63 65 } //01 00  Global\SearchService
		$a_01_1 = {57 65 62 61 6c 74 61 53 65 72 76 69 63 65 } //01 00  WebaltaService
		$a_01_2 = {50 24 72 6f 24 63 65 73 73 } //01 00  P$ro$cess
		$a_01_3 = {44 24 6f 77 6e 24 6c 6f 61 64 } //00 00  D$own$load
	condition:
		any of ($a_*)
...
rule BrowserModifier_Win32_Webalta_2{
	...
	strings :
		...
		$a_01_1 = {47 6c 6f 62 61 6c 5c 53 65 61 72 63 68 53 65 72 76 69 63 65 } //01 00  Global\SearchService
		$a_01_2 = {57 65 62 61 6c 74 61 53 65 72 76 69 63 65 } //01 00  WebaltaService
		$a_00_3 = {77 65 62 61 6c 74 61 2e 72 75 2f 73 72 63 68 } //00 00  webalta.ru/srch
	condition:
		any of ($a_*)
...
rule BrowserModifier_Win32_Webalta_4{
	...
	strings :
		...
		$a_01_8 = {2f 73 3d 31 20 2f 70 61 72 74 6e 65 72 3d } //00 00  /s=1 /partner=
	condition:
		any of ($a_*)
...
rule BrowserModifier_Win32_Webalta_5{
	...
	strings :
		$a_01_0 = {2f 67 65 74 5f 63 68 65 61 74 73 6d 61 6e 69 61 5f 6c 69 6e 6b 2e 70 68 70 3f } //01 00  /get_cheatsmania_link.php?
		$a_01_1 = {00 20 2f 70 61 72 74 6e 65 72 3d 00 } //01 00 
		$a_01_2 = {00 2f 70 61 72 74 6e 65 72 3d 00 } //01 00 
		$a_01_3 = {00 2f 73 3d 31 00 } //01 00  ⼀㵳1
		$a_01_4 = {00 5f 72 61 72 00 } //01 00  开慲r
		...
		$a_01_9 = {57 65 62 30 6c 74 30 2e 72 75 } //01 00  Web0lt0.ru
