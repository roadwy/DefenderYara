...
rule BrowserModifier_Win32_SupTab_11{
	...
	strings :
		...
		$a_03_5 = {75 00 6e 00 69 00 6e 00 73 00 74 00 61 00 6c 00 6c 00 [0-02] 44 00 6c 00 67 00 32 00 2e 00 78 00 6d 00 6c 00 00 } //2
		$a_03_6 = {75 6e 69 6e 73 74 61 6c 6c [0-02] 44 6c 67 32 2e 78 6d 6c 00 } //2
...
rule BrowserModifier_Win32_SupTab_14{
	...
	strings :
		...
		$a_03_14 = {8b d7 83 e2 03 c1 e2 06 83 e0 3f 0b c2 8b 55 ?? 8a 92 ?? ?? ?? ?? 8b d9 c1 fb 04 80 e3 03 c0 e2 02 0a da 8b 55 ?? 88 1c 16 8b df c1 fb 02 80 e3 0f c0 e1 04 0a d9 } //2
		...
		$a_03_22 = {0f b6 04 1e 8b 4d ?? 50 e8 ?? ?? ?? ?? 88 04 1e 46 3b f7 7c eb } //2
		$a_03_23 = {8b f0 83 7e 14 10 72 02 8b 36 85 f6 74 ?? 68 04 01 00 00 8d 44 24 48 50 6a 00 ff 15 } //1
		...
		$a_03_26 = {04 06 32 d2 32 db 80 c7 04 83 c7 04 ff 4d ?? 88 45 ?? 0f 85 ?? ?? ff ff } //2
