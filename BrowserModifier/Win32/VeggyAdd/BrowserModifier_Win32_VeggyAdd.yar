...
rule BrowserModifier_Win32_VeggyAdd{
	...
	strings :
		...
		$a_03_1 = {65 78 74 65 6e 64 5f 90 0f 04 00 2e 65 78 65 00 90 02 0f 00 65 3d 64 6f 77 6e 6c 6f 61 64 65 6e 64 26 73 3d 90 02 09 26 69 3d 90 02 09 26 76 3d 90 10 04 00 2e 90 10 04 00 2e 90 10 04 00 2e 90 10 04 00 26 65 63 3d 90 00 } //1
	condition:
