...
rule BrowserModifier_Win32_KlipPalCby{
	...
	strings :
		...
		$a_03_1 = {4f 00 46 00 53 00 5f 00 90 01 02 67 00 73 00 69 00 3f 00 63 00 69 00 64 00 3d 00 7b 00 30 00 7d 00 26 00 69 00 73 00 3d 00 7b 00 31 00 7d 00 90 00 } //1
		$a_03_2 = {6b 00 6d 00 73 00 56 00 65 00 72 00 73 00 69 00 6f 00 6e 00 90 01 02 69 00 6e 00 73 00 74 00 61 00 6c 00 6c 00 65 00 72 00 41 00 72 00 67 00 75 00 6d 00 65 00 6e 00 74 00 73 00 90 00 } //1
	condition:
