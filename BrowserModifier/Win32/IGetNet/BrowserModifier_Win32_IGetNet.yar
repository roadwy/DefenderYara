...
rule BrowserModifier_Win32_IGetNet{
	...
	strings :
		$a_02_0 = {73 68 65 6c 6c 33 32 32 2e 65 78 65 90 02 04 53 79 73 74 65 6d 90 00 } //1
		...
		$a_02_3 = {43 00 6f 00 6d 00 70 00 61 00 6e 00 79 00 4e 00 61 00 6d 00 65 00 90 02 08 69 00 47 00 65 00 74 00 4e 00 65 00 74 00 90 00 } //1
	condition:
