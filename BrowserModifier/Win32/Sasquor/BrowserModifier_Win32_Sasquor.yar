...
rule BrowserModifier_Win32_Sasquor_8{
	...
	strings :
		...
		$a_03_1 = {68 04 01 00 00 50 90 01 01 c7 85 90 01 04 2e 2e 5c 44 c7 85 90 01 04 61 74 61 42 66 c7 85 90 01 04 61 73 c6 85 90 01 04 65 ff 15 90 00 } //1
		$a_03_2 = {68 fe 00 00 00 a3 90 01 04 8d 85 90 01 05 50 90 02 06 c7 85 90 01 04 44 6f 57 6f 66 c7 85 90 01 04 72 6b e8 90 00 } //1
...
rule BrowserModifier_Win32_Sasquor_9{
	...
	strings :
		...
		$a_02_2 = {5c 00 64 00 61 00 6d 00 90 02 10 2e 00 65 00 78 00 65 00 20 00 2f 00 63 00 3d 00 64 00 61 00 6d 00 90 00 } //1
...
rule BrowserModifier_Win32_Sasquor_11{
	...
	strings :
		...
		$a_03_2 = {51 6a 00 6a 00 6a 14 8d 8d 90 01 04 51 ff b5 90 01 04 ff d0 85 c0 0f 84 90 01 04 b9 90 01 04 e8 90 01 04 50 51 90 00 } //2
		$a_03_3 = {51 6a 00 6a 00 6a 14 8d 8d 90 01 04 51 ff b5 90 01 04 ff d0 85 c0 0f 84 90 01 04 8b cf e8 90 01 04 b9 90 01 04 8b f0 e8 90 01 04 50 56 90 00 } //2
		...
		$a_03_5 = {30 45 e0 30 65 e1 30 45 e2 30 65 e3 30 45 e4 30 65 e5 30 45 e6 30 65 e7 8d 45 e0 50 e8 90 09 03 00 8b 45 90 00 } //1
		$a_03_6 = {8b c2 8a ca c1 e8 03 80 e1 07 8a 04 30 d2 f8 24 01 88 82 90 01 04 42 83 fa 40 7c e3 90 00 } //1
		$a_03_7 = {68 06 02 00 00 50 66 89 84 24 90 01 02 00 00 8d 84 24 90 01 02 00 00 50 e8 90 01 04 83 c4 0c b9 90 01 04 e8 90 01 04 b9 90 01 04 8b f8 e8 90 01 04 b9 90 01 04 8b f0 e8 90 01 04 8d 8c 24 90 01 02 00 00 51 68 04 01 00 00 8d 8c 24 90 01 02 00 00 51 57 56 50 ff 15 90 00 } //1
		$a_03_8 = {30 45 d8 30 65 d9 30 45 da 30 65 db 30 45 dc 30 65 dd 30 45 de 30 65 df 8d 45 d8 50 e8 90 09 03 00 8b 45 90 00 } //1
		$a_01_9 = {c1 fa 02 8b c2 c1 e8 1f 03 c2 8d 48 ff 3b c8 73 18 8d 04 49 83 7c c6 14 08 8d 34 c6 72 02 8b 36 } //1
		$a_03_10 = {30 45 d8 30 65 d9 30 45 da 30 65 db 30 45 dc 30 65 dd 30 45 de 30 65 df 8d 45 d8 50 e8 90 09 06 00 8b 85 90 01 02 ff ff 90 00 } //1
		$a_03_11 = {30 45 e0 30 65 e1 30 45 e2 30 65 e3 30 45 e4 30 65 e5 30 45 e6 30 65 e7 8d 45 e0 50 e8 90 09 06 00 8b 85 90 01 02 ff ff 90 00 } //1
		$a_03_12 = {51 6a 00 6a 00 6a 14 8d 8d 90 01 04 51 ff b5 90 01 04 ff d0 85 c0 0f 84 90 01 04 90 02 40 b9 90 01 04 e8 90 01 04 b9 90 01 04 8b f0 e8 90 01 04 50 56 90 00 } //2
		$a_03_13 = {8b d0 8a c8 c1 ea 03 80 e1 07 8a 14 32 d2 fa 80 e2 01 88 90 90 90 01 04 40 83 f8 40 7c e2 90 00 } //1
		$a_01_14 = {8b c2 8a ca c1 e8 03 80 e1 07 8a 04 38 d2 f8 24 01 88 04 16 42 3b d3 7c e7 33 c0 } //1
		$a_03_15 = {50 6a 00 6a 00 6a 14 8d 85 90 01 04 c7 85 90 01 04 01 66 00 00 50 ff b5 90 01 04 66 c7 90 01 04 ff 08 02 c7 85 90 01 04 08 00 00 00 ff 15 90 01 04 85 c0 0f 84 90 00 } //2
...
rule BrowserModifier_Win32_Sasquor_12{
	...
	strings :
		...
		$a_03_16 = {6a 5c 58 66 89 85 90 01 04 6a 4d 58 66 89 85 90 01 04 6a 52 58 66 89 85 90 01 04 6a 54 58 66 89 85 90 01 04 6a 2e 58 66 89 85 90 01 04 6a 65 58 66 89 85 90 01 04 6a 78 58 66 89 85 90 01 04 6a 65 90 00 } //1
		$a_03_17 = {6a 5c 58 6a 4d 90 02 06 66 89 85 90 01 04 58 6a 52 66 89 85 90 01 04 58 6a 54 90 02 08 6a 2e 66 89 85 90 01 04 58 6a 65 66 89 85 90 01 04 58 6a 78 90 00 } //1
		$a_03_18 = {6a 4d 58 6a 52 66 89 84 24 90 01 04 58 6a 54 66 89 84 24 90 01 04 58 6a 2e 66 89 84 24 90 01 04 58 6a 65 66 89 84 24 90 01 04 58 6a 78 90 00 } //1
		$a_03_19 = {33 c0 68 f6 01 00 00 50 66 89 84 24 90 01 04 8d 84 24 90 01 04 50 c7 84 24 90 01 04 5c 00 4d 00 c7 84 24 90 01 04 52 00 54 00 c7 84 24 90 01 04 2e 00 65 00 c7 84 24 90 01 04 78 00 65 00 90 00 } //1
		$a_03_20 = {68 f6 01 00 00 50 66 89 85 90 01 04 8d 85 90 01 04 50 c7 85 90 01 04 5c 00 4d 00 c7 85 90 01 04 52 00 54 00 c7 85 90 01 04 2e 00 65 00 c7 85 90 01 04 78 00 65 00 90 00 } //1
		$a_03_21 = {6a 00 50 c7 85 90 01 04 5c 00 4d 00 be 65 00 00 00 c7 85 90 01 04 52 00 54 00 c7 85 90 01 04 2e 00 65 00 c7 85 90 01 04 78 00 65 00 90 00 } //1
		$a_03_22 = {b9 4d 00 00 00 66 89 8d 90 01 04 ba 52 00 00 00 66 89 95 90 01 04 b8 54 00 00 00 66 89 85 90 01 04 b9 2e 00 00 00 66 89 8d 90 01 04 ba 65 00 00 00 66 89 95 90 01 04 b8 78 00 00 00 66 89 85 90 01 04 b9 65 00 00 00 90 00 } //1
	condition:
