...
rule BrowserModifier_Win32_Helpth{
	...
	strings :
		$a_02_0 = {68 74 74 70 90 02 03 3a 2f 2f 78 90 02 03 75 6c 65 69 90 02 03 38 38 38 2e 90 02 03 77 39 39 2e 90 02 03 6d 79 64 6e 90 02 03 6e 73 2e 63 90 02 03 6e 2f 64 61 90 02 03 74 61 90 02 09 65 90 02 03 78 65 90 00 } //100
