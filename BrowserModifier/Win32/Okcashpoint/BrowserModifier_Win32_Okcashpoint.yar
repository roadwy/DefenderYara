...
rule BrowserModifier_Win32_Okcashpoint{
	meta:
		description = "BrowserModifier:Win32/Okcashpoint,SIGNATURE_TYPE_PEHSTR,09 00 09 00 09 00 00 01 00 "
	...
	strings :
		...
		$a_01_2 = {4e 61 76 65 72 54 4f 4f 6c 62 61 72 } //01 00  NaverTOOlbar
		$a_01_3 = {6f 6b 63 70 6d 67 72 2e 65 78 65 } //01 00  okcpmgr.exe
		$a_01_4 = {75 73 65 72 2e 64 61 74 } //01 00  user.dat
		$a_01_5 = {72 65 77 6f 72 64 2e 63 66 67 } //01 00  reword.cfg
		$a_01_6 = {44 6c 6c 52 65 67 69 73 74 65 72 53 65 72 76 65 72 } //01 00  DllRegisterServer
...
rule BrowserModifier_Win32_Okcashpoint_2{
	meta:
		description = "BrowserModifier:Win32/Okcashpoint,SIGNATURE_TYPE_PEHSTR,07 00 07 00 07 00 00 01 00 "
	...
	strings :
		...
		$a_01_1 = {53 6f 66 74 77 61 72 65 5c 4d 69 63 72 6f 73 6f 66 74 5c 57 69 6e 64 6f 77 73 5c 43 75 72 72 65 6e 74 56 65 72 73 69 6f 6e 5c 52 75 6e } //01 00  Software\Microsoft\Windows\CurrentVersion\Run
		$a_01_2 = {6f 6b 2d 63 61 73 68 70 6f 69 6e 74 2e 63 6f 6d } //01 00  ok-cashpoint.com
		$a_01_3 = {6f 6b 63 70 6d 67 72 2e 65 78 65 } //01 00  okcpmgr.exe
		$a_01_4 = {41 41 41 39 46 45 33 33 2d 35 32 38 46 2d 34 38 41 38 2d 41 39 38 42 2d 34 39 39 31 46 39 44 39 36 44 44 41 } //01 00  AAA9FE33-528F-48A8-A98B-4991F9D96DDA
		$a_01_5 = {49 6e 74 65 72 6e 65 74 4f 70 65 6e 55 72 6c 41 } //01 00  InternetOpenUrlA
		$a_01_6 = {49 6e 74 65 72 6e 65 74 52 65 61 64 46 69 6c 65 } //00 00  InternetReadFile
	condition:
		any of ($a_*)
