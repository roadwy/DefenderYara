...
rule BrowserModifier_Win32_Prifou_2{
	...
	strings :
		...
		$a_02_3 = {8b 45 fc 80 b8 90 01 01 00 00 00 00 74 ec 90 00 } //1
		$a_02_4 = {ff ff 84 c0 74 90 01 01 e8 90 01 02 00 00 68 90 00 } //1
		$a_03_5 = {ff ff 5d c2 10 00 90 09 0a 00 a1 90 01 03 00 8b 00 e8 90 00 } //1
	condition:
...
rule BrowserModifier_Win32_Prifou_3{
	...
	strings :
		$a_03_0 = {bb 01 00 00 00 8b 06 0f b6 44 18 ff 89 45 f4 8b c6 e8 90 01 04 8b 55 f8 8b 4d f4 8a 14 0a 88 54 18 ff 43 4f 75 de 33 c0 5a 59 59 90 00 } //1
...
rule BrowserModifier_Win32_Prifou_8{
	...
	strings :
		...
		$a_03_3 = {3c 73 63 72 69 70 74 20 73 72 63 3d 27 68 74 74 70 3a 2f 2f 6a 2e 70 72 69 63 65 6a 73 2e 6e 65 74 2f 90 02 07 2f 63 6f 6d 6d 6f 6e 2e 6a 73 3f 63 68 61 6e 6e 65 6c 3d 90 00 } //1
	condition:
...
rule BrowserModifier_Win32_Prifou_12{
	...
	strings :
		...
		$a_03_5 = {2f 69 6e 73 74 61 6c 6c 20 2f 55 6e 4e 6d 3d 22 55 70 64 61 74 65 90 0e 05 00 66 6f 72 90 0e 05 00 50 72 69 63 65 46 6f 75 6e 74 61 69 6e 22 90 00 } //1
	condition:
