...
rule BrowserModifier_Win32_MalPro{
	...
	strings :
		...
		$a_02_2 = {68 00 74 00 74 00 70 00 3a 00 2f 00 2f 00 64 00 31 00 68 00 78 00 74 00 6c 00 39 00 7a 00 6e 00 71 00 77 00 65 00 6a 00 6a 00 2e 00 63 00 6c 00 6f 00 75 00 64 00 90 02 0f 2e 00 6e 00 65 00 74 00 2f 00 61 00 70 00 69 00 2f 00 69 00 6d 00 70 00 90 00 } //1
	condition:
