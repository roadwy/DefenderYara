...
rule BrowserModifier_Win32_MindQuizSearch{
	...
	strings :
		...
		$a_01_1 = {74 72 61 63 6b 2e 7a 75 67 6f 2e 63 6f 6d 2f 63 67 69 2d 62 69 6e 2f 64 65 62 75 67 2e 70 79 3f 66 69 6c 65 6e 61 6d 65 3d 6d 69 6e 64 71 75 69 7a 73 65 74 75 70 2d 73 69 6c 65 6e 74 2d 69 5f 61 63 63 65 70 74 26 75 72 6c 3d } //00 00  track.zugo.com/cgi-bin/debug.py?filename=mindquizsetup-silent-i_accept&url=
	condition:
		any of ($a_*)
