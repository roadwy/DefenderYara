...
rule TrojanDownloader_Win64_Lazy_RDA_MTB{
	...
	strings :
		...
		$a_01_2 = {77 61 73 64 2d } //01 00 
		$a_01_3 = {2f 2f 63 64 6e 2e 64 69 73 63 6f 72 64 61 70 70 2e 63 6f 6d 2f 61 74 74 61 63 68 6d 65 6e 74 73 } //01 00 
		$a_01_4 = {63 68 72 6f 6d 65 2e 65 78 65 } //01 00 
		$a_01_5 = {46 6f 72 74 6e 69 74 65 } //00 00 
	condition:
		any of ($a_*)
