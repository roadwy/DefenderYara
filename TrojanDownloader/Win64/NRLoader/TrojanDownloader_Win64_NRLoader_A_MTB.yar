...
rule TrojanDownloader_Win64_NRLoader_A_MTB{
	...
	strings :
		$a_03_0 = {48 33 c4 48 89 45 f8 45 33 90 01 01 48 8d 15 90 01 01 21 00 00 33 c9 ff 15 90 01 01 1f 00 00 48 8d 0d 90 01 01 21 00 00 ff 15 90 01 01 1f 00 00 4c 8b f8 90 00 } //2
