...
rule TrojanDownloader_Win64_AsyncRat_CEB_MTB{
	...
	strings :
		$a_03_0 = {f3 0f 7f 4c 24 90 01 01 66 c7 44 24 90 02 04 66 0f 6f 0d 90 01 01 20 00 00 f3 0f 7f 44 24 90 01 01 c6 44 24 90 01 02 f3 0f 7f 4c 24 90 02 03 c7 44 24 90 02 0a 48 c7 44 24 20 00 00 00 00 ff 90 00 } //5
