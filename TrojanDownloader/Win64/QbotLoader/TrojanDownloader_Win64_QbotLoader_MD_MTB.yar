...
rule TrojanDownloader_Win64_QbotLoader_MD_MTB{
	...
	strings :
		$a_03_0 = {63 75 72 6c 20 68 90 01 01 74 70 3a 2f 2f 31 30 39 2e 31 37 32 2e 34 35 2e 39 2f 4c 65 71 2f 31 35 20 2d 6f 20 63 3a 5c 75 73 65 72 73 5c 70 75 62 6c 69 63 5c 64 65 66 61 75 6c 74 2e 70 6e 67 90 00 } //1
