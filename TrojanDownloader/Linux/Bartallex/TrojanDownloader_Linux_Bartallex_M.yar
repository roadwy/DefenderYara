...
rule TrojanDownloader_Linux_Bartallex_M{
	...
	strings :
		$a_03_0 = {50 75 62 6c 69 63 20 46 75 6e 63 74 69 6f 6e 20 90 02 04 28 90 02 04 20 41 73 20 49 6e 74 65 67 65 72 29 0d 0a 90 02 04 20 3d 20 43 68 72 28 90 02 04 29 0d 0a 45 6e 64 20 46 75 6e 63 74 69 6f 6e 90 00 } //10
