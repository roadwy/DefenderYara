...
rule TrojanDownloader_Linux_Bartallex_M{
	...
	strings :
		...
		$a_01_1 = {26 20 22 6f 6d 2f 77 22 20 26 20 22 70 2d 69 6e 63 6c 75 64 65 73 2f 74 68 65 6d 65 2d 63 6f 6d 70 61 74 2f 22 } //01 00 
		$a_01_2 = {49 6e 74 28 } //01 00 
		$a_01_3 = {28 41 54 54 48 20 2b 20 53 54 54 31 20 2b 20 4c 4e 53 53 29 } //00 00 
