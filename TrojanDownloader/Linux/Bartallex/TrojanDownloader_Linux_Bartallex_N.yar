...
rule TrojanDownloader_Linux_Bartallex_N{
	...
	strings :
		...
		$a_03_1 = {45 6e 76 69 72 6f 6e 28 90 02 10 29 20 26 20 22 5c 90 02 10 2e 76 62 73 90 00 } //1
		$a_01_2 = {3d 20 22 65 6c 6c 2e 41 70 22 } //1 = "ell.Ap"
		$a_01_3 = {3d 20 22 63 61 74 69 22 } //1 = "cati"
		$a_03_4 = {3d 20 22 53 68 22 20 2b 20 90 02 0a 20 2b 20 22 70 6c 69 22 20 2b 20 90 02 0a 20 2b 20 22 6f 6e 22 90 00 } //1
