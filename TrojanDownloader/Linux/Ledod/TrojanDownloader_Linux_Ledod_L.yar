...
rule TrojanDownloader_Linux_Ledod_L{
	...
	strings :
		$a_03_0 = {73 75 6b 61 20 3d 20 22 68 74 74 70 3a 2f 2f [0-60] 2e 65 78 65 22 } //1
		...
		$a_03_3 = {2e 53 61 76 65 54 6f 46 69 6c 65 20 [0-10] 20 26 20 22 5c [0-10] 2e 63 6f 6d 22 2c 20 32 } //1
