...
rule TrojanDownloader_Linux_Ledod_P{
	...
	strings :
		$a_03_0 = {3d 20 56 61 6c 28 22 26 48 22 20 26 20 28 4d 69 64 24 28 90 02 0f 2c 20 28 32 20 2a 20 73 6e 69 70 70 65 74 44 59 79 44 71 29 20 2d 20 31 2c 20 32 29 29 29 90 00 } //1
		$a_03_1 = {3d 20 41 73 63 28 4d 69 64 24 28 90 02 0f 2c 20 28 28 90 02 0f 20 4d 6f 64 20 4c 65 6e 28 90 02 0f 29 29 20 2b 20 31 29 2c 20 31 29 29 90 00 } //1
