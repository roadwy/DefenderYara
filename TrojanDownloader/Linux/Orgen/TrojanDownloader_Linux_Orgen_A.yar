...
rule TrojanDownloader_Linux_Orgen_A{
	...
	strings :
		...
		$a_00_1 = {73 75 6b 61 20 3d 20 22 68 74 74 70 3a 2f 2f } //01 00 
		...
		$a_00_3 = {72 30 38 4c 6c 2e 4f 70 65 6e 20 22 47 45 54 22 2c 20 73 75 6b 61 2c 20 46 61 6c 73 65 } //00 00 
	condition:
		any of ($a_*)
