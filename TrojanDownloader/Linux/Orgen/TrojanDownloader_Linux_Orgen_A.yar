...
rule TrojanDownloader_Linux_Orgen_A{
	...
	strings :
		...
		$a_02_2 = {2e 77 72 69 74 65 20 72 30 38 4c 6c 2e 72 65 73 70 6f 6e 73 65 42 6f 64 79 0d 0a 2e 53 61 76 65 54 6f 46 69 6c 65 20 64 76 49 5a 35 31 20 26 20 22 5c 90 02 0a 2e 73 63 72 22 2c 20 32 90 00 } //1
