...
rule TrojanDownloader_Linux_Nocosteq_A{
	...
	strings :
		$a_03_0 = {43 61 6c 6c 20 44 6f 77 6e 6c 6f 61 64 46 69 6c 65 28 22 68 74 74 70 3a 2f 2f 90 02 35 2e 65 78 65 22 2c 20 22 90 02 10 2e 65 78 65 22 29 90 00 } //1
		$a_03_1 = {43 61 6c 6c 20 44 6f 77 6e 6c 6f 61 64 46 69 6c 65 28 53 74 72 52 65 76 65 72 73 65 28 22 65 78 65 2e 90 02 35 2f 2f 3a 70 74 74 68 22 29 2c 20 22 90 02 10 2e 65 78 65 22 29 90 00 } //1
