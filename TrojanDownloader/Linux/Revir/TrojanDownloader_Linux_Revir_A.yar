...
rule TrojanDownloader_Linux_Revir_A{
	...
	strings :
		...
		$a_03_1 = {55 89 e5 83 ec 18 e8 8b ff ff ff c7 44 24 04 90 01 02 00 00 a1 28 20 00 00 89 04 24 e8 a3 00 00 00 c7 04 24 90 01 02 00 00 e8 c7 00 00 00 c7 44 24 90 00 } //3
	condition:
