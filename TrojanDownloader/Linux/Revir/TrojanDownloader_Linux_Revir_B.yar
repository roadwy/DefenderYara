...
rule TrojanDownloader_Linux_Revir_B{
	...
	strings :
		$a_01_0 = {2e 6a 70 67 } //01 00  .jpg
		$a_01_1 = {2e 70 64 66 } //01 00  .pdf
		$a_00_2 = {73 74 61 72 74 21 } //01 00  start!
		$a_01_3 = {2f 74 6d 70 2f } //01 00  /tmp/
		$a_01_4 = {6f 70 65 6e 20 73 65 6c 66 } //05 00  open self
