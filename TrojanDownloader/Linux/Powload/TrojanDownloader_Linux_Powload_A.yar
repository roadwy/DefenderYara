...
rule TrojanDownloader_Linux_Powload_A{
	...
	strings :
		...
		$a_02_2 = {27 2c 27 25 54 45 4d 50 25 5c 90 02 10 2e 70 73 31 27 29 3b 20 70 6f 77 65 72 73 68 65 6c 6c 2e 65 78 65 90 00 } //1
		$a_02_3 = {2d 57 69 6e 64 6f 77 53 74 79 6c 65 20 68 69 64 64 65 6e 20 2d 45 78 65 63 75 74 69 6f 6e 50 6f 6c 69 63 79 20 42 79 70 61 73 73 20 2d 6e 6f 70 72 6f 66 69 6c 65 20 2d 66 69 6c 65 20 25 54 45 4d 50 25 5c 90 02 10 2e 70 73 31 90 00 } //1
		$a_02_4 = {22 63 6d 64 20 2f 4b 20 22 20 2b 20 22 70 90 02 01 22 20 26 20 22 90 02 01 57 65 52 22 20 26 20 22 53 68 22 20 2b 20 22 65 6c 6c 2e 65 22 20 2b 20 22 78 22 20 2b 20 22 65 90 00 } //1
	condition:
