...
rule TrojanDownloader_Linux_Powload_HAZ_MTB{
	...
	strings :
		...
		$a_03_2 = {53 65 74 20 90 02 10 20 3d 20 43 72 65 61 74 65 4f 62 6a 65 63 74 28 90 02 10 29 2e 43 72 65 61 74 65 45 6c 65 6d 65 6e 74 28 22 62 36 22 20 2b 20 22 34 22 29 90 00 } //1
		$a_03_3 = {53 65 74 20 90 02 10 20 3d 20 90 02 10 2e 43 6f 6e 6e 65 63 74 53 65 72 76 65 72 28 29 90 00 } //1
