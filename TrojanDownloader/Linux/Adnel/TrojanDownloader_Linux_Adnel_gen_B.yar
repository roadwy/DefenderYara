...
rule TrojanDownloader_Linux_Adnel_gen_B{
	...
	strings :
		$a_02_0 = {55 52 4c 20 3d 20 22 68 74 74 70 3a 2f 2f 90 02 40 2e 65 78 65 22 90 00 } //1
		$a_02_1 = {57 48 45 52 45 20 3d 20 45 6e 76 69 72 6f 6e 28 22 54 65 6d 70 22 29 20 26 20 22 5c 22 20 26 20 22 90 02 20 2e 65 78 65 22 90 00 } //1
