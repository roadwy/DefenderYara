...
rule TrojanDownloader_Linux_Adnel_gen_D{
	...
	strings :
		...
		$a_01_2 = {36 45 36 35 37 30 36 46 24 } //01 00  6E65706F$
		$a_01_3 = {34 35 35 38 34 35 32 45 } //01 00  4558452E
		$a_01_4 = {3d 20 53 74 72 52 65 76 65 72 73 65 28 48 65 78 32 53 74 72 28 22 } //00 00  = StrReverse(Hex2Str("
	condition:
		any of ($a_*)
