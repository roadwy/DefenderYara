...
rule TrojanDownloader_Linux_Adnel_gen_C{
	...
	strings :
		...
		$a_03_2 = {3d 20 45 6e 76 69 72 6f 6e 28 22 90 03 07 04 41 70 70 44 61 74 61 54 65 6d 70 22 29 20 26 20 22 5c 22 20 26 20 22 90 02 26 2e 90 05 05 03 22 20 26 65 78 65 22 90 00 } //1
		...
		$a_02_4 = {63 72 65 61 74 65 6f 62 6a 65 63 74 28 22 90 02 09 72 69 70 74 2e 73 68 90 05 05 03 22 20 26 65 6c 90 05 05 03 22 20 26 6c 22 29 90 02 26 2e 90 03 04 03 65 78 65 63 72 75 6e 90 00 } //1
	condition:
