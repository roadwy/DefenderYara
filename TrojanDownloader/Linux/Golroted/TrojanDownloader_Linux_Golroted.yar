...
rule TrojanDownloader_Linux_Golroted{
	...
	strings :
		$a_01_0 = {2f 62 6c 6f 62 3f 64 6f 77 6e 6c 6f 61 64 } //01 00  /blob?download
		...
		$a_01_2 = {67 65 2e 74 74 2f 61 70 69 2f } //01 00  ge.tt/api/
		$a_01_3 = {26 20 22 2e 74 74 2f 61 70 69 2f } //00 00  & ".tt/api/
		$a_00_4 = {cf 18 } //00 00 
	condition:
		any of ($a_*)
