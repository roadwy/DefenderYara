...
rule TrojanDownloader_Linux_Chacha_A_MTB{
	...
	strings :
		...
		$a_01_1 = {64 61 74 61 2f 6c 6f 63 61 6c 2f 74 6d 70 2f 74 6d 70 2e 6c 00 70 79 74 68 6f 6e 33 2e 4f } //01 00 
		$a_00_2 = {2f 65 74 63 2f 72 63 2e 64 2f 72 63 25 64 2e 64 2f 53 39 30 25 73 } //01 00 
		$a_00_3 = {2f 74 6d 70 2f 74 6d 70 6e 61 6d 5f 58 58 58 58 58 58 } //01 00 
