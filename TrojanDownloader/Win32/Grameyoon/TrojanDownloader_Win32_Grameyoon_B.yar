...
rule TrojanDownloader_Win32_Grameyoon_B{
	...
	strings :
		$a_01_0 = {6d 6f 6d 6f 63 65 6c 6c 2e 63 6f 6d 2f 6c 6f 67 2f 69 6e 73 74 61 6c 6c 2e 70 68 70 3f 6d 61 63 3d 00 } //01 00  潭潭散汬挮浯氯杯椯獮慴汬瀮灨洿捡=
		...
		$a_01_3 = {68 61 6e 75 73 00 77 69 6e 73 74 61 30 5c 64 65 66 61 75 6c 74 00 } //00 00  慨畮s楷獮慴尰敤慦汵t
	condition:
		any of ($a_*)
