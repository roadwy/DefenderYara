...
rule TrojanDownloader_Win32_Harnig_AB{
	...
	strings :
		...
		$a_02_3 = {68 74 74 70 3a 2f 2f 90 01 0a 2e 90 02 03 2f 70 72 6f 67 73 2f 90 02 0a 2f 90 02 08 2e 70 68 70 90 00 } //1
		$a_02_4 = {6a 08 59 6a 0c be 90 01 04 33 c0 56 8d 7d c8 68 90 01 04 f3 ab e8 90 01 03 ff 83 c4 0c 56 8d 45 c8 50 ff 15 90 01 02 40 00 8d 45 c8 50 e8 90 01 03 ff 90 00 } //1
	condition:
