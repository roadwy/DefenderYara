...
rule TrojanDownloader_Win32_Harnig_AB{
	...
	strings :
		$a_00_0 = {77 00 69 00 6e 00 69 00 6e 00 65 00 74 00 2e 00 64 00 6c 00 6c 00 } //01 00 
		$a_00_1 = {40 00 70 00 73 00 61 00 70 00 69 00 2e 00 64 00 6c 00 6c 00 } //01 00 
