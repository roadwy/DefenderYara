...
rule TrojanDownloader_Win32_Harnig_S{
	...
	strings :
		...
		$a_03_2 = {ff d6 8a 45 90 01 01 04 1d 88 45 90 01 01 8a 45 90 01 01 83 c4 0c 3a c3 75 06 c6 45 90 01 01 30 eb 05 04 13 88 45 90 01 01 0f b7 45 90 01 01 50 8d 45 90 01 01 68 90 01 04 50 ff d6 8a 45 90 01 01 04 17 90 00 } //2
	condition:
