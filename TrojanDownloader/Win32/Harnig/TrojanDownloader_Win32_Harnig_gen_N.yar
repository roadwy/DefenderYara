...
rule TrojanDownloader_Win32_Harnig_gen_N{
	...
	strings :
		...
		$a_03_1 = {89 45 f0 ff 15 90 01 04 ff 75 f0 89 45 f4 ff 15 90 01 04 83 7d f4 02 74 0d ff 45 fc 83 7d fc 02 0f 8c 90 00 } //1
		$a_03_2 = {83 ff 01 75 07 68 90 01 04 eb 90 01 01 83 ff 02 75 07 68 90 01 04 eb 90 01 01 83 ff 03 75 0e 90 00 } //1
