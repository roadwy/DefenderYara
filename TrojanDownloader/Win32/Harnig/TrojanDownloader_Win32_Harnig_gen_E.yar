...
rule TrojanDownloader_Win32_Harnig_gen_E{
	meta:
		description = "TrojanDownloader:Win32/Harnig.gen!E,SIGNATURE_TYPE_PEHSTR_EXT,1d 00 13 00 1e 00 00 "
	...
	strings :
		...
		$a_02_27 = {53 55 ff 15 90 01 03 00 bf 90 01 03 00 83 c9 ff 33 c0 6a 90 01 01 f2 ae f7 d1 2b f9 8b f7 8b d1 8b fd 83 c9 ff f2 ae 8b ca 4f c1 e9 02 f3 a5 8b ca 8d 44 24 90 01 01 83 e1 03 50 f3 a4 be 90 01 03 00 56 68 90 01 03 00 68 01 00 00 80 e8 90 01 03 ff 90 00 } //25
		$a_00_28 = {83 c9 ff 33 c0 6a 05 f2 ae f7 d1 2b f9 8b f7 8b d1 8b fd 83 c9 ff f2 ae 8b ca 4f c1 e9 02 f3 a5 8b ca 8d } //5
		$a_00_29 = {8a 17 8a ca 3a 10 75 1c 84 c9 74 12 8a 57 01 8a ca 3a 50 01 75 0e 47 47 40 40 84 c9 75 e2 33 ff 33 c0 eb 07 1b 0c 83 d8 ff 33 ff 3b c7 } //5
	condition:
		((#a_00_0  & 1)*1+(#a_00_1  & 1)*1+(#a_00_2  & 1)*1+(#a_01_3  & 1)*1+(#a_01_4  & 1)*1+(#a_01_5  & 1)*1+(#a_01_6  & 1)*1+(#a_00_7  & 1)*1+(#a_01_8  & 1)*1+(#a_00_9  & 1)*1+(#a_01_10  & 1)*1+(#a_01_11  & 1)*1+(#a_01_12  & 1)*1+(#a_02_13  & 1)*5+(#a_01_14  & 1)*5+(#a_01_15  & 1)*5+(#a_01_16  & 1)*1+(#a_01_17  & 1)*1+(#a_01_18  & 1)*1+(#a_01_19  & 1)*2+(#a_01_20  & 1)*1+(#a_01_21  & 1)*1+(#a_00_22  & 1)*1+(#a_01_23  & 1)*1+(#a_01_24  & 1)*1+(#a_01_25  & 1)*1+(#a_01_26  & 1)*1+(#a_02_27  & 1)*25+(#a_00_28  & 1)*5+(#a_00_29  & 1)*5) >=19
