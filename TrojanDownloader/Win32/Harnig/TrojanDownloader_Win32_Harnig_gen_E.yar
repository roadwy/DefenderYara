...
rule TrojanDownloader_Win32_Harnig_gen_E{
	...
	strings :
		...
		$a_02_27 = {53 55 ff 15 ?? ?? ?? 00 bf ?? ?? ?? 00 83 c9 ff 33 c0 6a ?? f2 ae f7 d1 2b f9 8b f7 8b d1 8b fd 83 c9 ff f2 ae 8b ca 4f c1 e9 02 f3 a5 8b ca 8d 44 24 ?? 83 e1 03 50 f3 a4 be ?? ?? ?? 00 56 68 ?? ?? ?? 00 68 01 00 00 80 e8 ?? ?? ?? ff } //25
