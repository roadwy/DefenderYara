...
rule TrojanDownloader_Win32_Harnig_gen_I{
	...
	strings :
		...
		$a_02_23 = {68 74 74 70 3a 2f 2f [0-10] 2e 62 69 7a 2f 70 72 6f 67 73 5f 74 72 61 66 66 2f [0-10] 2f [0-10] 2e 70 68 70 3f 65 78 70 3d } //4
		$a_02_24 = {68 74 74 70 3a 2f 2f [0-10] 2e 62 69 7a 2f 70 72 6f 67 73 5f 74 72 61 66 66 2f [0-10] 2f } //2
		$a_02_25 = {68 74 74 70 3a 2f 2f [0-10] 2e 62 69 7a 2f 70 72 6f 67 73 5f 65 78 65 2f [0-10] 2f [0-10] 2e 70 68 70 3f 61 64 76 3d } //4
	condition:
