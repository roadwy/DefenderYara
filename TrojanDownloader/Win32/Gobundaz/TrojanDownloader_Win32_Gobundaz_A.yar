...
rule TrojanDownloader_Win32_Gobundaz_A{
	...
	strings :
		$a_03_0 = {49 4e 46 45 43 54 20 46 41 43 45 20 4e 90 02 03 20 2d 20 90 00 } //10
		$a_01_1 = {5c 73 79 73 74 2e 64 61 74 } //4 \syst.dat
		$a_01_2 = {69 6e 73 64 62 2e 70 68 70 3f 74 61 62 6c 65 3d } //4 insdb.php?table=
		$a_03_3 = {72 2c 2f 73 35 38 40 34 2d 32 39 73 90 01 01 71 36 32 32 3f 3c 3e 40 3b 73 2e 32 2d 32 3b 72 72 67 31 90 00 } //1
