...
rule TrojanDownloader_Win32_Gobundaz_B{
	...
	strings :
		...
		$a_01_6 = {69 6e 73 64 62 2e 70 68 70 3f 74 61 62 6c 65 3d } //05 00  insdb.php?table=
		$a_01_7 = {72 32 3b 33 38 73 2d 2e 32 39 31 39 31 2e 38 2d 40 2f 3a 73 40 3d 38 3c 34 35 40 32 3e 3c 2f 72 } //00 00  r2;38s-.29191.8-@/:s@=8<45@2></r
	condition:
		any of ($a_*)
