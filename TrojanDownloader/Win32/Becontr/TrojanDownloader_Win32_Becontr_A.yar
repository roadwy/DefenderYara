...
rule TrojanDownloader_Win32_Becontr_A{
	...
	strings :
		...
		$a_03_3 = {41 50 50 44 41 54 41 [0-20] 4a 61 76 61 2e 65 78 65 } //1
		$a_03_4 = {6e 76 69 64 69 61 [0-20] 72 61 64 65 6f 6e } //1
		$a_03_5 = {2f 62 74 73 2f 32 33 2e 70 68 70 3f 69 64 3d [0-20] 26 76 69 64 3d [0-20] 26 76 3d [0-20] 26 74 79 70 65 3d [0-20] 26 64 77 6e 6c 64 3d } //1
	condition:
