...
rule TrojanDownloader_Win32_Cutwail_gen_A{
	...
	strings :
		$a_03_0 = {01 5a 74 0a ba ff ff ff ff e9 90 01 02 00 00 83 ec 90 01 01 8d 90 01 01 d8 fe ff ff 90 09 07 00 80 90 01 01 4d 75 06 80 90 00 } //1
		$a_03_1 = {74 14 83 ec 08 89 d8 29 d0 50 8d 04 16 50 e8 90 01 02 00 00 83 c4 10 e8 90 01 01 00 00 00 b8 00 00 00 00 90 00 } //1
