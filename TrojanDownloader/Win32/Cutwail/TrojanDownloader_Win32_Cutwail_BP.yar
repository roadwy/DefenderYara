...
rule TrojanDownloader_Win32_Cutwail_BP{
	...
	strings :
		$a_00_0 = {73 6f 66 74 77 61 72 65 5c 6d 69 63 72 6f 73 6f 66 74 5c 77 69 6e 64 6f 77 73 5c 63 75 72 72 65 6e 74 76 65 72 73 69 6f 6e 5c 72 75 6e } //01 00  software\microsoft\windows\currentversion\run
