...
rule TrojanDownloader_Win32_Cutwail{
	...
	strings :
		...
		$a_03_4 = {88 01 0f b6 c3 33 d2 f7 f7 fe c3 8a 90 02 10 88 41 01 80 79 01 65 58 75 17 f6 c3 08 74 12 0f b6 c3 6a 03 33 d2 5f f7 f7 8a 90 00 } //5
		$a_03_5 = {83 c4 04 69 c0 0d 66 19 00 8b 95 90 01 04 8b 8c 95 90 01 04 8d 90 01 02 5f f3 6e 3c 8b 85 90 00 } //5
