...
rule TrojanDownloader_Win32_Cutwail{
	...
	strings :
		$a_00_0 = {68 74 74 70 3a 2f 2f 25 73 2f } //01 00  http://%s/
		$a_00_1 = {4d 6f 7a 69 6c 6c 61 2f 34 2e 30 20 28 63 6f 6d 70 61 74 69 62 6c 65 3b 20 4d 53 49 45 20 36 2e 30 } //01 00  Mozilla/4.0 (compatible; MSIE 6.0
		...
		$a_00_6 = {71 7a 6c 62 74 67 72 6e 6b 78 73 66 64 63 6d 70 } //00 00  qzlbtgrnkxsfdcmp
