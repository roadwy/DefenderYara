...
rule TrojanDownloader_Win32_Cutwail_W{
	...
	strings :
		...
		$a_01_2 = {48 6f 73 74 3a 20 25 69 2e 25 69 2e 25 69 2e 25 69 25 73 } //01 00  Host: %i.%i.%i.%i%s
		$a_01_3 = {3b 25 34 2e 34 68 78 2d 25 34 2e 34 68 78 3b } //00 00  ;%4.4hx-%4.4hx;
	condition:
		any of ($a_*)
