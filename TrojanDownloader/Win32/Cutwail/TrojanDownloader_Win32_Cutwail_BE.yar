...
rule TrojanDownloader_Win32_Cutwail_BE_3{
	...
	strings :
		$a_03_0 = {50 6a 18 ff 35 90 01 04 90 17 03 01 06 02 e8 b8 90 01 04 ff d0 ff d7 90 00 } //10
		$a_03_1 = {81 c6 ca 01 00 00 90 03 04 04 90 09 11 00 90 09 0e 00 b9 90 17 03 02 02 02 00 24 e2 25 ca 29 00 00 8b 90 00 } //1
		$a_03_2 = {81 c6 ca 01 00 00 90 09 0e 00 b9 00 90 01 03 c1 e9 02 90 00 } //1
		$a_03_3 = {ac 32 c3 aa f7 c1 01 00 00 00 74 90 01 01 85 c0 60 90 00 } //1
		$a_01_4 = {ad 33 85 f4 fc ff ff ab e2 db b8 00 } //1
		$a_03_5 = {ff ff ad 33 85 90 01 02 ff ff ab e2 90 09 0a 00 05 90 01 04 50 8f 85 90 00 } //1
	condition:
