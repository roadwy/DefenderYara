...
rule TrojanDownloader_Win32_Cutwail_gen_B{
	...
	strings :
		...
		$a_01_4 = {83 f9 4d 75 11 8b 55 fc 0f be 42 01 83 f8 5a } //02 00 
		$a_01_5 = {74 5b c7 85 20 fd ff ff 07 00 01 00 68 c8 02 00 00 6a 00 8d 8d 24 fd ff ff } //02 00 
		$a_03_6 = {73 37 8b 4d fc 81 c1 90 01 02 00 08 90 00 } //02 00 
		$a_01_7 = {c6 45 c8 56 c6 45 c9 69 c6 45 ca 72 } //01 00 
		$a_01_8 = {68 40 24 08 9d } //00 00 
	condition:
		any of ($a_*)
