...
rule TrojanDownloader_Win32_Cutwail_AJ{
	...
	strings :
		...
		$a_00_1 = {6e 65 74 73 68 20 66 69 72 65 77 61 6c 6c 20 73 65 74 20 61 6c 6c 6f 77 65 64 70 72 6f 67 72 61 6d 20 22 25 73 22 20 45 4e 41 42 4c 45 } //0a 00 
		$a_00_2 = {43 6f 6d 53 70 65 63 00 20 3e 3e 20 4e 55 4c 00 2f 63 20 64 65 6c 20 } //0a 00 
		$a_00_3 = {47 45 54 20 2f 34 30 } //14 00 
