...
rule TrojanDownloader_Win32_Cutwail_gen_C{
	...
	strings :
		...
		$a_03_1 = {c1 eb 02 8d b7 90 01 04 8b 14 1e 81 ea 90 01 04 2b fa c2 04 00 cc cc cc cc 90 00 } //1
		$a_01_2 = {c3 8d 47 30 8b 04 08 8b 40 0c 8b 40 1c 8b 00 8b 40 08 c3 } //1
		$a_03_3 = {c1 e2 02 8d 88 90 01 04 8b 1c 11 03 ca 83 eb 28 8d 95 90 01 04 03 55 e4 89 1a 83 e9 04 90 00 } //1
	condition:
...
rule TrojanDownloader_Win32_Cutwail_gen_C_2{
	...
	strings :
		...
		$a_03_10 = {8b 48 50 51 8b 55 90 01 01 8b 42 34 50 90 00 } //1
	condition:
