...
rule TrojanDownloader_Win32_Cutwail_BM{
	...
	strings :
		$a_02_0 = {05 01 01 01 01 51 8a c8 d3 c0 59 51 8a c8 d3 c0 59 05 01 01 01 00 05 01 01 01 01 81 f9 90 01 04 72 03 89 45 f8 e2 d5 59 8b 5d f8 ac 32 c3 aa f7 c1 01 00 00 00 74 0b 85 c0 60 6a 01 e8 e5 01 00 00 61 90 00 } //1
