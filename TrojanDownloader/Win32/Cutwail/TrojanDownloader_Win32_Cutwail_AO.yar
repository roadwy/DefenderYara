...
rule TrojanDownloader_Win32_Cutwail_AO{
	...
	strings :
		$a_03_0 = {0f b6 1b 81 f3 90 01 04 81 fb 90 01 04 75 09 8b 1d 90 01 04 c6 03 8b 90 00 } //1
		$a_03_1 = {53 83 29 05 50 6a 00 6a 00 ff 11 6a ff 50 ff 15 90 01 04 ff 24 24 90 00 } //1
