...
rule TrojanDownloader_Win32_Fakr_A{
	...
	strings :
		$a_01_0 = {6c 69 76 65 66 6c 6f 61 74 2e 63 6f 6d } //01 00 
		$a_01_1 = {2e 7a 65 72 6f 63 6c 65 61 72 2e 6e 65 74 } //05 00 
		$a_02_2 = {2f 63 6f 75 6e 74 2f 69 6e 73 74 90 03 0e 05 61 6c 6c 5f 63 6f 75 6e 74 2e 70 68 70 3f 2e 70 68 70 3f 90 00 } //04 00 
		$a_00_3 = {26 6b 69 6e 64 3d } //03 00 
		...
		$a_01_5 = {61 64 64 65 6e 64 75 6d 5c 73 69 64 65 62 61 72 5c } //00 00 
	condition:
		any of ($a_*)
