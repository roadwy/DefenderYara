...
rule TrojanDownloader_Win32_Malsia_A{
	...
	strings :
		...
		$a_01_2 = {6d 61 6c 61 79 73 69 61 2e 62 62 63 63 64 64 65 65 66 66 67 67 2e 63 6f 6d } //01 00  malaysia.bbccddeeffgg.com
		$a_01_3 = {70 70 6c 31 2e 63 6d 6e } //01 00  ppl1.cmn
		$a_01_4 = {53 6f 66 74 77 61 72 65 5c 6d 61 6c 61 79 73 69 61 } //01 00  Software\malaysia
