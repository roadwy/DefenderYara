...
rule TrojanDownloader_Win32_Squiblydoo_AN_MTB{
	...
	strings :
		...
		$a_02_2 = {72 65 67 73 76 72 33 32 20 2f 75 20 2f 6e 20 2f 73 20 2f 69 3a 90 03 04 05 68 74 74 70 68 74 74 70 73 3a 2f 2f 90 02 25 20 73 63 72 6f 62 6a 2e 64 6c 6c 90 00 } //2
	condition:
