...
rule TrojanDownloader_Win32_Cojopesh_B{
	...
	strings :
		...
		$a_01_3 = {41 53 4d 44 4a 48 47 31 37 36 45 52 54 44 55 59 54 51 55 57 59 45 54 44 55 59 54 31 38 32 37 33 36 38 45 38 39 31 45 32 59 49 } //01 00 
		$a_01_4 = {39 38 37 39 38 31 32 33 38 37 36 } //00 00 
	condition:
		any of ($a_*)
