...
rule TrojanDownloader_Win32_Stealer_HSG_MSR{
	...
	strings :
		$a_03_0 = {70 6f 77 65 72 73 68 65 6c 6c 2e 65 78 65 20 49 6e 76 6f 6b 65 2d 57 65 62 52 65 71 75 65 73 74 20 2d 55 72 69 90 02 20 72 73 73 2e 66 62 76 69 64 63 64 6e 2e 63 6f 6d 2f 64 6c 2f 73 65 65 64 2f 20 2d 4f 75 74 46 69 6c 65 20 27 25 61 70 70 64 61 74 61 25 5c 73 2d 69 6e 73 74 61 6c 6c 65 72 2e 65 78 65 90 00 } //1
