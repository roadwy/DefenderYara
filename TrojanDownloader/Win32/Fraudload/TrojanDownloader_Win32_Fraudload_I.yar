...
rule TrojanDownloader_Win32_Fraudload_I{
	...
	strings :
		...
		$a_00_1 = {92 f2 80 c3 48 26 b6 0f 1a 4c 2a 1e cc b5 f9 1b a3 50 9e 53 f4 70 26 6b ef 61 } //1
		$a_00_2 = {81 76 08 8b 4e 86 d9 23 d7 fb ff 00 f4 08 e0 65 dc 56 7b 1d fe 3e b9 b9 } //1
	condition:
