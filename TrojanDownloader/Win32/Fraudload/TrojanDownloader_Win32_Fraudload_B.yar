...
rule TrojanDownloader_Win32_Fraudload_B{
	...
	strings :
		...
		$a_02_3 = {25 73 20 2f [0-10] 2e 70 68 70 3f 26 25 73 ?? ?? ?? ?? ?? ?? ?? ?? 26 75 3d 25 75 26 70 3d 25 75 20 25 73 [0-20] 2e 63 6f 6d } //1
		$a_01_4 = {25 73 43 61 63 68 65 2d 43 6f 6e 74 72 6f 6c 3a 20 6e 6f 2d 63 61 63 68 65 0d 25 73 0d 25 73 } //1
		$a_02_5 = {25 73 20 68 74 74 70 3a 2f 2f 64 6f 77 6e 6c 6f 61 64 2e 25 73 2e 63 6f 6d 2f [0-10] 2e 70 68 70 3f 25 73 ?? ?? ?? ?? ?? ?? ?? ?? 26 75 3d 25 75 26 70 3d 25 75 20 25 73 [0-20] 2e 63 6f 6d } //1
