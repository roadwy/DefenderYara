...
rule TrojanDownloader_Win32_Fraudload_gen_A{
	...
	strings :
		...
		$a_01_5 = {41 6e 74 69 53 70 79 77 61 72 65 53 68 69 65 6c 64 } //01 00  AntiSpywareShield
		$a_01_6 = {68 74 74 70 3a 2f 2f 64 6f 77 6e 6c 6f 61 64 2e 25 73 2e 63 6f 6d } //00 00  http://download.%s.com
	condition:
		any of ($a_*)
