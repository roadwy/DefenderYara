...
rule TrojanDownloader_Win32_Pelfpoi_L{
	...
	strings :
		$a_01_0 = {5b 7b 30 30 30 32 31 34 41 30 2d 30 30 30 30 2d 30 30 30 30 2d 43 30 30 30 2d 30 30 30 30 30 30 30 30 30 30 34 36 7d 5d } //01 00  [{000214A0-0000-0000-C000-000000000046}]
		$a_01_1 = {61 74 62 66 73 68 2e 65 78 65 } //02 00  atbfsh.exe
