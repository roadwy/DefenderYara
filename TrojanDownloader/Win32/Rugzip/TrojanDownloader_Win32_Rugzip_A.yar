...
rule TrojanDownloader_Win32_Rugzip_A{
	...
	strings :
		...
		$a_03_2 = {c8 00 00 00 8b f8 0f 85 90 01 02 00 00 3b fb 0f 84 90 01 02 00 00 8b 45 90 01 01 80 38 4d 0f 85 90 01 02 00 00 80 78 01 5a 0f 85 90 01 02 00 00 8d 45 90 01 01 6a 08 50 e8 90 00 } //10
	condition:
