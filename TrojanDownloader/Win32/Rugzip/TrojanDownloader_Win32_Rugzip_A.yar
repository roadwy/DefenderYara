...
rule TrojanDownloader_Win32_Rugzip_A{
	...
	strings :
		$a_00_0 = {41 00 63 00 63 00 65 00 70 00 74 00 2d 00 4c 00 61 00 6e 00 67 00 75 00 61 00 67 00 65 00 3a 00 20 00 72 00 75 00 } //01 00 
		$a_00_1 = {41 00 63 00 63 00 65 00 70 00 74 00 2d 00 45 00 6e 00 63 00 6f 00 64 00 69 00 6e 00 67 00 3a 00 20 00 67 00 7a 00 69 00 70 00 2c 00 20 00 64 00 65 00 66 00 6c 00 61 00 74 00 65 00 } //0a 00 
