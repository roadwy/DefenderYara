...
rule TrojanDownloader_Win32_Ahrocam_B{
	...
	strings :
		...
		$a_01_1 = {72 75 6e 69 6e 66 6f 2e 65 78 65 } //01 00  runinfo.exe
		$a_01_2 = {63 6f 6d 6d 61 6e 64 3d 4e 4f 26 72 65 73 75 6c 74 3d } //01 00  command=NO&result=
		$a_01_3 = {68 74 74 70 2d 67 65 74 2d 64 65 6d 6f } //00 00  http-get-demo
	condition:
		any of ($a_*)
