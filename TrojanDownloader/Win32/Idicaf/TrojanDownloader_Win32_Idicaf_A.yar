...
rule TrojanDownloader_Win32_Idicaf_A{
	...
	strings :
		$a_03_0 = {8a 08 84 c9 74 08 80 f1 90 01 01 88 08 40 eb f2 90 00 } //2
		$a_01_1 = {e9 b6 00 00 00 8b 4d f8 8b 51 01 89 55 e0 8b 45 e0 8b 4d f8 8d 54 01 05 89 55 d8 8b 45 d8 3b 45 0c 74 0f } //2
		$a_03_2 = {76 17 6a 19 53 e8 90 01 02 ff ff 8a 44 05 e0 59 88 04 3e 46 3b 75 0c 59 72 e9 90 00 } //1
