...
rule TrojanDownloader_Win32_Virtumonde_2{
	...
	strings :
		$a_02_0 = {61 64 64 69 6e 73 90 01 01 2a 2e 2a 00 00 00 90 00 } //10
		$a_02_1 = {41 70 70 50 61 74 63 68 90 01 01 2a 2e 2a 00 00 00 90 00 } //10
		$a_02_2 = {43 75 72 73 6f 72 73 90 01 01 2a 2e 2a 00 00 00 90 00 } //10
