...
rule TrojanDownloader_Win32_Vundo_A{
	...
	strings :
		...
		$a_02_1 = {8b 48 28 85 c9 74 14 a1 ?? ?? ?? 10 6a 00 03 c8 6a 03 50 89 0d ?? ?? ?? 10 ff d1 c3 } //1
		$a_02_2 = {8a 00 88 45 b0 0f b6 45 ac 0f b6 4d b0 33 c1 8b 0d ?? ?? ?? 10 03 0d ?? ?? ?? 10 88 01 e9 } //1
	condition:
...
rule TrojanDownloader_Win32_Vundo_A_2{
	...
	strings :
		...
		$a_03_4 = {64 ff 30 64 89 20 6a 00 6a 00 8b 45 f8 e8 ?? ?? ?? ?? 50 8b 45 fc e8 ?? ?? ?? ?? 50 6a 00 e8 ?? ?? ?? ?? 85 c0 75 04 b3 01 eb 02 33 db 33 c0 } //1
		$a_03_5 = {8b 45 f8 89 45 f0 8b 45 e4 8b 40 08 89 45 e0 81 45 e0 48 02 00 00 6a 04 8d 4d f0 8b 55 e0 8b c7 e8 ?? ?? ?? ?? 8b 45 f0 c1 e8 04 c1 e0 04 03 45 f8 89 45 f0 6a 04 8d 4d f0 8b 55 e0 8b c7 } //1
	condition:
