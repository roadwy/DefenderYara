...
rule TrojanDownloader_Win32_Svelta_A{
	...
	strings :
		$a_03_0 = {83 7c 24 40 00 75 1c 8b c6 38 9c 24 d2 00 00 00 75 07 68 90 01 03 00 eb 05 90 00 } //1
		$a_03_1 = {73 74 61 74 75 73 65 73 2f 75 73 65 72 5f 74 69 6d 65 6c 69 6e 65 2f 90 02 0a 2e 72 73 73 90 00 } //1
