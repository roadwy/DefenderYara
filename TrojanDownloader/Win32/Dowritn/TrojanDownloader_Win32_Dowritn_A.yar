...
rule TrojanDownloader_Win32_Dowritn_A{
	...
	strings :
		$a_00_0 = {74 6d 70 64 6f 77 6e 33 32 2e 64 6c 6c } //01 00 
		$a_00_1 = {68 74 74 70 3a 2f 2f 77 77 77 2e 6c 61 72 61 70 69 61 2e 63 6f 6d 2f 74 6d 70 2f 70 64 66 2e 70 64 66 } //01 00 
		$a_00_2 = {4d 6f 7a 69 6c 6c 61 2f 35 2e 30 20 28 57 69 6e 64 6f 77 73 3b 20 55 3b 20 57 69 6e 64 6f 77 73 20 4e 54 20 35 2e 31 3b 20 65 6e 3b 29 20 47 65 63 6b 6f 2f 33 30 30 36 30 33 30 39 20 46 69 72 65 66 6f 78 2f 31 2e 35 2e 30 2e 37 } //01 00 
		$a_00_3 = {65 64 30 33 35 30 43 45 33 34 39 34 45 42 44 34 35 42 32 41 45 38 41 } //01 00 
		$a_00_4 = {53 79 73 74 65 6d 52 6f 6f 74 } //01 00 
		...
		$a_00_7 = {57 69 6e 45 78 65 63 } //01 00 
