...
rule TrojanDownloader_Win32_Toselos_A{
	...
	strings :
		...
		$a_01_1 = {68 74 74 70 3a 2f 2f 25 73 2f 74 6f 6f 6c 73 2e 74 78 74 } //01 00  http://%s/tools.txt
		$a_01_2 = {74 61 73 6b 6b 69 6c 6c 20 2f 46 20 2f 50 49 44 20 25 64 } //00 00  taskkill /F /PID %d
	condition:
		any of ($a_*)
