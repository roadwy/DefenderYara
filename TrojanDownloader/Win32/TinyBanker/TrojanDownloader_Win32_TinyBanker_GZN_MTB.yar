...
rule TrojanDownloader_Win32_TinyBanker_GZN_MTB{
	...
	strings :
		$a_02_0 = {8a 9c 24 db 01 00 00 88 cf 28 df 66 89 c6 66 21 f2 66 89 94 24 90 01 04 88 bc 24 90 01 04 8b 84 24 90 01 04 8b 4c 24 2c 01 c8 89 84 24 90 01 04 e9 3d ff ff ff 90 00 } //10
