...
rule TrojanDownloader_Win32_Lickore_B{
	...
	strings :
		$a_03_0 = {ba 03 00 00 00 e8 90 01 04 8b 55 90 01 01 b8 90 01 04 e8 90 02 10 ff 90 02 05 68 90 01 04 68 90 01 04 8d 45 90 01 01 ba 03 00 00 00 90 00 } //1
		...
		$a_03_3 = {54 52 41 43 45 90 02 10 50 55 54 90 02 10 43 4f 4e 4e 45 43 54 90 00 } //1
	condition:
