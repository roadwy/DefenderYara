...
rule TrojanDownloader_Win32_Cbeplay_B{
	...
	strings :
		...
		$a_00_3 = {55 52 4c 44 6f 77 6e 6c 6f 61 64 54 6f 46 69 6c 65 41 } //03 00 
		$a_00_4 = {53 74 61 72 74 53 65 72 76 69 63 65 41 } //03 00 
		$a_01_5 = {47 65 74 43 75 72 72 65 6e 74 48 77 50 72 6f 66 69 6c 65 57 } //00 00 
	condition:
		any of ($a_*)
