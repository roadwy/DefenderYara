...
rule TrojanDownloader_Win32_Cbeplay_M{
	...
	strings :
		...
		$a_03_1 = {ff b7 08 02 00 00 8d 44 90 01 02 50 68 90 01 02 40 00 8d 87 04 01 00 00 68 04 01 00 00 50 e8 90 01 02 00 00 83 c4 14 90 00 } //1
		$a_03_2 = {8b 83 14 0c 00 00 90 02 04 83 bb 18 0c 00 00 00 74 90 01 01 50 68 08 01 00 00 e8 90 00 } //2
