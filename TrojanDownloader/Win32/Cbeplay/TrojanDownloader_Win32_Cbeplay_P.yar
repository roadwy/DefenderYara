...
rule TrojanDownloader_Win32_Cbeplay_P{
	...
	strings :
		...
		$a_01_4 = {2f 71 20 2f 63 20 66 6f 72 20 2f 6c 20 25 25 69 20 69 6e 20 28 31 2c 31 2c 34 30 30 30 30 30 30 30 30 30 29 20 64 6f 20 69 66 20 6e 6f 74 20 65 78 69 73 74 20 22 25 73 22 20 28 65 78 69 74 29 } //01 00  /q /c for /l %%i in (1,1,4000000000) do if not exist "%s" (exit)
