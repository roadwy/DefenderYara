...
rule TrojanDownloader_Win32_Traho_A{
	...
	strings :
		$a_02_0 = {00 68 74 74 70 3a 2f 2f 73 70 6f 72 74 73 2e 79 61 68 6f 6f 35 35 30 2e 63 6f 6d 2f 69 6d 61 67 65 2f 6c 6f 67 6f 2e 6a 70 67 3f 71 75 65 72 79 69 64 3d 38 30 ?? ?? ?? 00 } //10
