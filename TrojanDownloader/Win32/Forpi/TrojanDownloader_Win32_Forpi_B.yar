...
rule TrojanDownloader_Win32_Forpi_B{
	...
	strings :
		...
		$a_03_2 = {50 f3 ab b9 4a 00 00 00 8d bc 24 ?? ?? 00 00 f3 ab b9 4a 00 00 00 8d 7c 24 14 f3 ab 6a 0f e8 } //1
		$a_03_3 = {50 6a 00 8d 45 d4 52 50 ff d6 8b 4d dc 50 8d 55 d8 51 52 ff d6 50 53 e8 ?? ?? ff ff } //1
