...
rule TrojanDownloader_Win32_Gendwnurl_BT_bit{
	...
	strings :
		...
		$a_00_1 = {63 30 37 37 64 64 65 36 2d 36 33 36 34 2d 34 34 31 39 2d 61 63 64 32 2d 62 38 35 30 35 38 31 62 38 66 36 34 } //01 00  c077dde6-6364-4419-acd2-b850581b8f64
