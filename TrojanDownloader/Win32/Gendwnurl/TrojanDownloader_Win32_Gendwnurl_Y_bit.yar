...
rule TrojanDownloader_Win32_Gendwnurl_Y_bit{
	...
	strings :
		...
		$a_03_1 = {40 00 c6 45 90 01 01 68 c6 45 90 01 01 74 c6 45 90 01 01 74 c6 45 90 01 01 70 90 00 } //1
		$a_03_2 = {33 c0 89 45 90 01 01 89 45 90 09 08 00 c6 45 90 01 02 c6 45 90 00 } //1
	condition:
