...
rule TrojanDownloader_Win32_Gendwnurl_Y_bit{
	...
	strings :
		$a_01_0 = {4c 6f 63 61 6c 5c 62 77 61 70 69 5f 73 68 61 72 65 64 5f 6d 65 6d 6f 72 79 5f 67 61 6d 65 5f 6c 69 73 74 } //01 00  Local\bwapi_shared_memory_game_list
