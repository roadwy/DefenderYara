...
rule TrojanDownloader_Win32_Gendwnurl_BN_bit{
	...
	strings :
		...
		$a_03_1 = {53 65 74 57 6f 72 6b 69 6e 67 44 69 72 2c 20 25 41 70 70 44 61 74 61 25 0a 55 52 4c 44 6f 77 6e 6c 6f 61 64 54 6f 46 69 6c 65 2c 20 68 74 74 70 3a 2f 2f 37 38 2e 31 34 30 2e 32 32 30 2e 31 37 35 2f 90 02 20 2c 90 02 10 2e 65 78 65 90 00 } //1
	condition:
