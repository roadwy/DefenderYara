...
rule TrojanDownloader_Win32_Fomish{
	...
	strings :
		$a_03_0 = {68 74 74 70 3a 2f 2f 59 79 6c 2e 6d 6f 66 69 73 68 2e 63 6e 2f 77 65 76 6f 6f 2f 64 61 74 61 2f 64 61 74 61 90 01 01 2e 64 61 74 90 00 } //1
		...
		$a_03_4 = {68 74 74 70 3a 2f 2f 59 79 6c 2e 6d 6f 66 69 73 68 2e 63 6e 2f 77 65 76 6f 6f 2f 6c 69 73 74 73 2f 32 30 30 90 01 05 2f 6c 69 73 74 2e 74 78 74 90 00 } //1
		$a_03_5 = {68 74 74 70 3a 2f 2f 90 01 03 2e 6e 63 61 73 74 2e 63 6e 2f 6c 69 73 74 73 2f 32 30 30 90 01 05 2f 6c 69 73 74 2e 74 78 74 90 00 } //1
