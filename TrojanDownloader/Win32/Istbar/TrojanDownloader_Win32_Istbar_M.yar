...
rule TrojanDownloader_Win32_Istbar_M{
	...
	strings :
		$a_00_0 = {43 72 65 61 74 65 4d 75 74 65 78 41 28 69 20 30 2c 20 69 20 30 2c 20 74 20 22 79 73 62 4d 75 74 65 78 22 29 } //01 00 
		...
		$a_00_2 = {53 6f 66 74 77 61 72 65 5c 49 53 54 } //01 00 
		$a_00_3 = {65 78 65 5f 73 74 61 72 74 } //00 00 
	condition:
		any of ($a_*)
