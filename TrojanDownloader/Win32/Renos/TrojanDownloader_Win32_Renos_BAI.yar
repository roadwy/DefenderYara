...
rule TrojanDownloader_Win32_Renos_BAI{
	...
	strings :
		...
		$a_00_2 = {6d 69 6c 69 74 61 72 79 61 73 73 2e 63 6f 6d 2f } //01 00 
		$a_01_3 = {54 20 68 20 65 20 63 6f 6d 70 75 74 65 72 20 68 61 73 20 62 65 65 6e 20 63 72 75 73 68 65 64 21 21 } //01 00 
		...
		$a_00_7 = {69 6e 73 74 61 6c 6c 20 47 69 67 61 41 6e 74 69 56 69 72 75 73 } //00 00 
	condition:
		any of ($a_*)
