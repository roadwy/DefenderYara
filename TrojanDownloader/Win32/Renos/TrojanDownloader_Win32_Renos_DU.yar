...
rule TrojanDownloader_Win32_Renos_DU{
	...
	strings :
		$a_03_0 = {c7 45 fc 00 00 00 00 eb 09 8b 90 01 01 fc 83 90 01 01 01 89 90 01 01 fc 8b 90 01 01 fc 3b 90 01 01 f8 7d 16 8b 90 01 01 08 03 90 01 01 fc 0f be 90 01 01 83 90 01 02 8b 90 01 02 03 90 00 } //4
		...
		$a_03_9 = {2f 70 72 65 66 65 72 65 6e 63 65 73 90 02 08 2f 61 64 76 61 6e 63 65 64 5f 73 65 61 72 63 68 90 02 08 26 71 3d 90 02 05 3f 71 3d 90 00 } //1
