...
rule TrojanDownloader_Win32_Renos_IF{
	...
	strings :
		$a_03_0 = {68 a0 bb 0d 00 6a 00 6a 00 a3 ?? ?? ?? ?? ff d6 68 ?? ?? 00 10 68 e8 03 00 00 6a 00 6a 00 ff d6 68 ?? ?? 00 10 68 e0 93 04 00 6a 00 6a 00 ff d6 68 ?? ?? 00 10 68 00 f9 15 00 } //5
		...
		$a_03_6 = {5c 72 75 6e 64 6c 6c 33 32 2e 65 78 65 [0-04] 20 22 [0-04] 22 2c 20 73 74 61 72 74 } //1
