...
rule TrojanDownloader_Win32_Renos_DG{
	...
	strings :
		$a_03_0 = {c7 45 fc 00 00 00 00 eb 09 8b 45 fc 83 c0 01 89 45 fc 8b 4d fc 3b 4d f8 7d 18 8b 55 08 03 55 fc 0f be 02 35 ?? 00 00 00 8b 4d 0c 03 4d fc 88 01 eb d7 } //2
		$a_03_1 = {83 f8 06 0f 85 ?? ?? 00 00 68 ?? ?? ?? ?? e8 ?? ?? 00 00 83 c4 04 89 (45|85) 90 09 1f 00 6a 00 ff 15 ?? ?? 00 10 } //2
