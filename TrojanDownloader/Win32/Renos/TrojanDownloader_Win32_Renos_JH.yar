...
rule TrojanDownloader_Win32_Renos_JH{
	...
	strings :
		...
		$a_01_3 = {61 20 22 2e 2e 5c 25 73 2e 72 61 72 22 20 2a } //01 00 
	condition:
		any of ($a_*)
...
rule TrojanDownloader_Win32_Renos_JH_2{
	...
	strings :
		$a_01_0 = {43 00 6f 00 70 00 79 00 72 00 69 00 67 00 68 00 74 00 20 00 28 00 43 00 29 00 20 00 4d 00 69 00 63 00 72 00 6f 00 73 00 6f 00 66 00 74 00 20 00 43 00 6f 00 72 00 70 00 2e 00 20 00 31 00 39 00 38 00 31 00 2d 00 31 00 39 00 39 00 39 00 } //01 00 
