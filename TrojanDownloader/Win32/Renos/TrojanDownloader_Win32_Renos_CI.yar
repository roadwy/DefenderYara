...
rule TrojanDownloader_Win32_Renos_CI{
	...
	strings :
		...
		$a_02_3 = {47 45 54 20 2f 6d 68 61 62 68 66 64 62 2e 70 68 70 3f 26 61 64 76 69 64 3d 30 30 30 30 90 01 04 26 75 3d 25 75 26 70 3d 25 75 26 6c 61 6e 67 3d 5f 5f 5f 5f 5f 5f 5f 5f 26 76 73 3d 25 75 26 25 73 20 48 54 54 50 2f 31 2e 30 90 00 } //1
		$a_02_4 = {47 45 54 20 68 74 74 70 3a 2f 2f 25 73 2f 70 6f 69 65 68 72 67 62 2e 70 68 70 3f 26 61 64 76 69 64 3d 30 30 30 30 90 01 04 26 75 3d 25 75 26 70 3d 25 75 26 6c 61 6e 67 3d 5f 5f 5f 5f 5f 5f 5f 5f 26 76 73 3d 25 75 26 25 73 20 48 54 54 50 2f 31 2e 30 90 00 } //1
