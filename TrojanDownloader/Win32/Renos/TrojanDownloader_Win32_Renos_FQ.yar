...
rule TrojanDownloader_Win32_Renos_FQ{
	...
	strings :
		$a_03_0 = {8b f8 8b f1 2b f9 8a 0e 80 f1 90 01 01 88 0c 37 74 90 01 01 90 02 03 46 90 02 03 75 90 00 } //3
		...
		$a_03_3 = {81 fe 00 00 00 d0 90 03 01 01 a3 a2 90 01 03 00 90 02 06 77 08 81 fe 00 00 00 80 73 90 00 } //2
	condition:
