...
rule TrojanDownloader_Win32_Renos_LE{
	...
	strings :
		...
		$a_01_2 = {3c 75 72 6c 20 63 72 79 70 74 3d 22 6f 6e 22 3e 68 74 74 70 3a 2f 2f } //02 00  <url crypt="on">http://
		...
		$a_01_4 = {3c 75 72 6c 20 63 72 79 70 74 3d 22 6f 6e 22 20 70 6f 73 74 3d 22 6f 6e 22 3e 68 74 74 70 3a 2f 2f } //00 00  <url crypt="on" post="on">http://
	condition:
		any of ($a_*)
