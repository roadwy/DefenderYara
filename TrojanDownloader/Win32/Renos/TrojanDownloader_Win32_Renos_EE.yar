...
rule TrojanDownloader_Win32_Renos_EE{
	...
	strings :
		$a_03_0 = {8b ca 68 14 10 00 00 50 51 53 ff 15 90 01 04 83 f8 06 75 90 01 01 8d 90 01 01 20 90 00 } //1
		$a_03_1 = {68 98 04 02 00 8b 90 01 01 08 90 09 06 00 6a 1c 8d 90 01 01 9c 90 00 } //1
