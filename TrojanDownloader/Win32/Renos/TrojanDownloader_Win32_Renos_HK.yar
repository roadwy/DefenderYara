...
rule TrojanDownloader_Win32_Renos_HK{
	...
	strings :
		$a_03_0 = {89 45 f0 8b 45 fc 66 ff 0d 90 01 04 8b 34 85 90 01 04 8d 1c 85 90 01 04 85 f6 74 90 01 01 8b 4d f8 8d 3c 8d 90 01 04 8a 06 04 90 01 01 90 03 05 03 25 ff 00 00 00 0f b6 c0 83 c0 90 01 01 24 90 01 01 e8 90 01 04 8b cc 8b d6 e8 90 00 } //1
