...
rule TrojanDownloader_Win32_Renos_HL{
	...
	strings :
		$a_03_0 = {5b 24 c7 34 45 38 44 39 45 42 46 32 32 43 2d [0-05] 34 32 42 44 2d 41 38 43 42 2d 37 45 35 39 43 [0-02] 43 30 38 42 41 2f 23 } //1
		$a_03_1 = {41 6c 77 61 79 73 [0-02] 75 64 79 [0-10] 72 52 34 [0-02] 6e 65 72 [0-30] 4c 54 45 52 4e ce 55 52 4c } //1
