...
rule TrojanDownloader_Win32_Renos_EN{
	...
	strings :
		$a_03_0 = {8b f0 2b f2 8d 9b 00 00 00 00 8a 0a 80 f1 90 01 01 88 0c 16 74 08 8a 4a 01 42 84 c9 75 ee 90 00 } //3
		...
		$a_03_4 = {c7 06 01 23 45 67 0f bf 90 01 04 00 90 00 } //1
	condition:
