...
rule TrojanDownloader_Win32_Renos_L{
	...
	strings :
		...
		$a_01_1 = {6a 63 6c 2e 73 76 6e 2e 73 6f 75 72 63 65 66 6f 72 67 65 2e 6e 65 74 2f 73 76 6e 72 6f 6f 74 2f 6a 63 6c } //02 00  jcl.svn.sourceforge.net/svnroot/jcl
