...
rule TrojanDownloader_Win32_Renos_EI{
	...
	strings :
		...
		$a_01_3 = {75 69 64 3d 25 73 26 6f 73 3d 25 73 } //02 00 
		$a_01_4 = {69 64 3d 25 6c 75 26 61 64 76 3d 25 6c 75 26 75 69 64 3d 25 73 } //01 00 
		$a_01_5 = {5c 5c 2e 5c 50 68 79 73 69 63 61 6c 44 72 69 76 65 25 64 } //01 00 
