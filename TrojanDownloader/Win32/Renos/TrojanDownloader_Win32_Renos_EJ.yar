...
rule TrojanDownloader_Win32_Renos_EJ{
	...
	strings :
		$a_03_0 = {8a 1e 2b ca 80 f3 90 01 01 66 89 0d 90 01 04 66 49 66 89 0d 90 01 04 88 1c 37 90 00 } //4
		$a_03_1 = {0f 95 c0 a2 90 01 03 00 33 c0 66 39 1d 90 01 03 00 0f 95 c0 a2 90 01 03 00 eb 17 cc eb 90 00 } //2
