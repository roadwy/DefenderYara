...
rule TrojanDownloader_Win32_Renos_LN{
	...
	strings :
		...
		$a_00_4 = {3c 75 72 6c 20 70 6f 73 74 3d 22 6f 6e 22 3e 68 74 74 70 } //02 00  <url post="on">http
		...
		$a_01_6 = {3c 2f 75 72 6c 3e 3c 75 72 6c 20 67 65 74 3d 22 6f 6e 22 3e 68 74 74 70 3a 2f 2f } //00 00  </url><url get="on">http://
	condition:
		any of ($a_*)
