...
rule TrojanDownloader_Win32_Renos_gen_A{
	meta:
		description = "TrojanDownloader:Win32/Renos.gen!A,SIGNATURE_TYPE_PEHSTR,19 00 14 00 2c 00 00 05 00 "
	...
	strings :
		...
		$a_01_15 = {43 6c 69 63 6b 20 68 65 72 65 20 74 6f 20 69 6e 73 74 61 6c 6c 20 74 68 65 20 6c 61 74 65 73 74 20 70 72 6f 74 65 63 74 69 6f 6e 20 74 6f 6f 6c 73 21 } //01 00  Click here to install the latest protection tools!
