...
rule TrojanDownloader_Win32_Renos_gen_U{
	...
	strings :
		$a_00_0 = {56 69 72 75 73 20 41 74 74 61 63 6b 21 21 21 20 54 68 65 20 79 6f 75 72 20 73 79 73 74 65 6d 20 6f 6e 20 63 6f 6d 70 75 74 65 72 20 69 73 20 64 61 6d 61 67 65 64 2e } //05 00 
		...
		$a_01_6 = {53 68 65 6c 6c 5f 4e 6f 74 69 66 79 49 63 6f 6e 41 } //01 00 
		$a_01_7 = {61 6c 6c 65 72 74 00 } //01 00 
		$a_00_8 = {65 78 70 6c 6f 72 65 72 2e 65 78 65 } //01 00 
		$a_00_9 = {73 6f 66 74 77 61 72 65 5c 6d 69 63 72 6f 73 6f 66 74 5c 77 69 6e 64 6f 77 73 5c 63 75 72 72 65 6e 74 76 65 72 73 69 6f 6e 5c 75 6e 69 6e 73 74 61 6c 6c } //01 00 
		$a_00_10 = {73 68 65 6c 6c 65 78 65 63 75 74 65 61 } //01 00 
		$a_00_11 = {71 76 6c 5d 6a 76 5d 6c 6a 5d 79 5c 7e 71 74 5d } //01 00 
		$a_01_12 = {49 6e 74 65 72 6e 65 74 4f 70 65 6e 55 72 6c 41 } //00 00 
	condition:
		any of ($a_*)
