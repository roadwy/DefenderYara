...
rule TrojanDownloader_Win32_Renos_gen_U{
	...
	strings :
		...
		$a_02_1 = {75 8b ec 81 c4 00 fe ff ff 71 76 77 68 ff 00 00 00 8d 90 01 01 01 ff ff ff 90 01 01 e8 90 01 04 8d 85 02 fe ff ff 70 6a 00 68 90 01 04 8d 85 01 ff ff ff 70 e8 90 01 04 8d 85 02 fe ff ff 70 e8 90 01 04 8d 85 02 fe ff ff 70 ff 15 90 01 04 83 c4 04 b9 03 00 00 00 2b c1 8d bd 02 fe ff ff 90 00 } //5
		$a_02_2 = {8b ec 83 c4 f8 6a 01 6a 00 ff 75 08 8d 05 90 02 04 70 8d 05 90 02 04 70 6a 00 ff 15 90 02 04 b8 01 00 00 00 c9 90 00 } //5
		$a_02_3 = {75 8b ec 81 c4 18 fe ff ff 90 02 03 e8 90 01 04 83 f8 00 0f 85 90 01 01 00 00 00 90 00 } //5
		$a_00_4 = {6a 06 6a 00 6a 00 6a 00 6a 00 6a ff ff 75 08 e8 } //5
		$a_02_5 = {75 1e 6a 64 ff 35 90 01 04 e8 90 01 04 a3 90 01 04 c7 05 90 01 04 01 00 00 00 eb 1c 6a 66 ff 35 90 01 04 e8 90 01 04 a3 90 01 04 c7 05 90 01 04 00 00 00 00 68 90 01 04 6a 01 e8 90 01 04 c9 c2 10 00 90 00 } //5
