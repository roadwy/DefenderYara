...
rule TrojanDownloader_Win32_Gelode_A{
	...
	strings :
		...
		$a_01_1 = {30 37 33 31 31 30 31 31 36 31 30 31 31 31 34 31 31 30 31 30 31 31 31 36 30 38 32 31 30 31 30 39 37 31 30 30 30 37 30 31 30 35 31 30 38 31 30 31 } //00 00 
	condition:
		any of ($a_*)
