...
rule TrojanDownloader_Win32_Delf_KA{
	...
	strings :
		...
		$a_01_1 = {65 2d 6a 6f 6b 2e 63 6e 2f 63 6e 66 67 2f 5f 70 6f 70 77 7a 77 2e 74 78 74 } //01 00  e-jok.cn/cnfg/_popwzw.txt
		$a_01_2 = {65 2d 6a 6f 6b 2e 63 6e 2f 63 6f 75 6e 74 2f 75 70 64 61 74 65 64 61 74 61 2e 61 73 70 78 3f 69 64 3d } //01 00  e-jok.cn/count/updatedata.aspx?id=
		$a_01_3 = {63 61 6e 76 69 65 77 2e 74 78 74 } //01 00  canview.txt
