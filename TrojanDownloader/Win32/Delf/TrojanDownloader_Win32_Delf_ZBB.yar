...
rule TrojanDownloader_Win32_Delf_ZBB{
	...
	strings :
		...
		$a_02_5 = {8d 44 24 04 50 e8 90 01 04 8b c3 8b d4 b9 00 01 00 00 e8 90 01 04 81 c4 00 01 00 00 5b c3 8b c0 55 8b ec 6a 00 6a 00 53 33 c0 55 68 90 01 04 64 ff 30 64 89 20 b2 01 a1 90 01 04 e8 90 01 04 b9 90 01 04 b2 01 90 00 } //5
	condition:
