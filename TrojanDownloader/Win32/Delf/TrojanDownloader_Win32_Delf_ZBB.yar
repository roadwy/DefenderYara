...
rule TrojanDownloader_Win32_Delf_ZBB{
	...
	strings :
		$a_00_0 = {5c 77 69 6e 73 79 73 2e 62 61 74 } //01 00  \winsys.bat
		$a_00_1 = {5c 61 63 74 69 76 65 5f 75 72 6c 2e 64 6c 6c } //01 00  \active_url.dll
		$a_00_2 = {74 61 73 6b 6d 72 67 2e 65 78 65 } //01 00  taskmrg.exe
		$a_00_3 = {74 61 73 6b 69 6d 67 2e 65 78 65 } //01 00  taskimg.exe
		$a_00_4 = {4d 79 73 61 6d 70 6c 65 41 70 70 4d 75 74 65 78 5f 31 } //05 00  MysampleAppMutex_1
