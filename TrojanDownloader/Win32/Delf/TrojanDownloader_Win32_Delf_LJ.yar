...
rule TrojanDownloader_Win32_Delf_LJ{
	...
	strings :
		...
		$a_00_1 = {43 61 72 72 65 67 61 6e 64 6f 20 2e 2e 2e } //0a 00 
		$a_00_2 = {53 65 74 57 69 6e 64 6f 77 73 48 6f 6f 6b 45 78 41 } //0a 00 
		$a_00_3 = {47 65 74 4b 65 79 4e 61 6d 65 54 65 78 74 41 } //02 00 
		...
		$a_00_7 = {43 3a 5c 77 69 6e 64 6f 77 73 5c 77 69 6e 68 65 6c 70 33 32 2e 69 6e 69 } //01 00 
		$a_02_8 = {5c 4d 65 64 69 61 5c 90 02 08 2e 65 78 65 90 00 } //01 00 
		$a_02_9 = {5c 4d 65 64 69 61 5c 90 02 08 2e 63 70 6c 90 00 } //01 00 
		$a_00_10 = {5c 4d 65 64 69 61 5c 73 6d 73 73 2e 65 78 65 } //00 00 
	condition:
		any of ($a_*)
