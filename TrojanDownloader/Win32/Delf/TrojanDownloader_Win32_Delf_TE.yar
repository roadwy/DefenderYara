...
rule TrojanDownloader_Win32_Delf_TE{
	...
	strings :
		$a_03_0 = {8b 00 8b 40 30 50 e8 90 01 04 8d 55 fc b8 20 00 00 00 e8 90 01 04 8b 55 fc 8d 83 90 01 01 03 00 00 b9 90 01 04 e8 90 01 04 8d 83 90 01 01 03 00 00 90 00 } //1
		$a_03_1 = {8b 00 8b 40 30 50 e8 90 01 04 8d 55 fc b8 20 00 00 00 e8 90 01 04 ff 75 fc 68 90 01 04 68 90 01 04 8d 83 28 03 00 00 ba 03 00 00 00 90 00 } //1
