...
rule TrojanDownloader_Win32_Delf_TE{
	...
	strings :
		...
		$a_00_2 = {2f 56 45 52 59 53 49 4c 45 4e 54 20 2f 53 50 2d } //01 00  /VERYSILENT /SP-
		$a_00_3 = {66 69 6c 65 6e 6f 6c 6a 61 2e 63 6f 6d 2f 73 70 6f 6e } //01 00  filenolja.com/spon
		$a_00_4 = {43 00 6f 00 64 00 65 00 3a 00 20 00 25 00 64 00 } //00 00  Code: %d
	condition:
		any of ($a_*)
