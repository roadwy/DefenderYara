...
rule TrojanDownloader_Win32_Delf_CG{
	...
	strings :
		...
		$a_00_2 = {68 74 74 70 3a 2f 2f 77 77 77 2e 61 70 62 75 72 6f 2e 72 75 2f 63 6c 61 73 73 65 73 2f 66 64 73 2f 73 6d 61 73 68 2e 65 78 65 } //01 00 
		$a_00_3 = {63 3a 5c 77 69 6e 64 6f 77 73 5c 73 79 73 74 65 6d 5c 63 6f 6d 61 6e 64 73 32 2e 65 78 65 } //01 00 
		$a_00_4 = {68 74 74 70 3a 2f 2f 73 61 6b 61 6e 67 2e 6e 65 74 2f 62 62 73 2f 69 63 6f 6e 2f 70 69 63 32 32 32 32 2e 6a 70 67 } //01 00 
