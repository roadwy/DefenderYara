...
rule TrojanDownloader_Win32_Delf_QU{
	...
	strings :
		...
		$a_03_1 = {8d 45 f8 ba 90 01 03 00 e8 90 01 03 ff 8b 55 f8 8b 83 0c 03 00 00 8b ce e8 90 01 03 ff 8b c6 e8 90 01 03 ff 8b 83 90 01 01 03 00 00 b2 01 e8 90 01 03 ff 6a 05 68 90 01 03 00 e8 90 01 03 ff 90 00 } //1
	condition:
