...
rule TrojanDownloader_Win32_Delf_LR{
	...
	strings :
		...
		$a_01_1 = {2e 68 61 6f 79 65 31 32 33 2e 6e 65 74 } //01 00  .haoye123.net
...
rule TrojanDownloader_Win32_Delf_LR_2{
	...
	strings :
		...
		$a_01_1 = {4d 79 20 44 72 6f 70 62 6f 78 5c 50 72 6f 6a 65 74 6f 73 5c 4a 61 76 61 6e 5c 73 74 61 72 74 5c 70 75 6d 61 6e 65 77 5f 32 5c 70 75 6d 61 78 2e 64 70 72 } //01 00  My Dropbox\Projetos\Javan\start\pumanew_2\pumax.dpr
