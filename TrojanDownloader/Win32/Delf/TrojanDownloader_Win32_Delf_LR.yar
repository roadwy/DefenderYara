...
rule TrojanDownloader_Win32_Delf_LR{
	...
	strings :
		...
		$a_03_2 = {4b 75 6f 44 6f 75 53 65 74 75 70 73 2e 74 6d 70 90 01 0c 4b 75 6f 44 6f 75 53 65 74 75 70 73 2e 65 78 65 90 00 } //1
		$a_03_3 = {63 6e 69 65 73 65 74 75 70 2e 74 6d 70 90 01 0b 63 6e 4e 75 6f 49 45 73 2e 74 6d 70 90 01 0c 63 6e 4e 75 6f 49 45 73 2e 65 78 65 90 00 } //1
	condition:
