...
rule TrojanDownloader_Win32_Delf_OA{
	...
	strings :
		...
		$a_00_1 = {5c 00 6b 00 69 00 64 00 6b 00 2e 00 65 00 78 00 65 00 } //01 00  \kidk.exe
		$a_00_2 = {5c 00 6d 00 61 00 74 00 61 00 2e 00 65 00 78 00 65 00 } //01 00  \mata.exe
		$a_00_3 = {5c 00 6d 00 73 00 6e 00 2e 00 65 00 78 00 65 00 } //00 00  \msn.exe
	condition:
		any of ($a_*)
