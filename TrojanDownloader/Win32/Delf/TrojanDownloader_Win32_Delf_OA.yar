...
rule TrojanDownloader_Win32_Delf_OA{
	...
	strings :
		$a_02_0 = {74 00 70 00 73 00 3a 00 2f 00 2f 00 73 00 33 00 2e 00 61 00 6d 00 61 00 7a 00 6f 00 6e 00 61 00 77 00 73 00 2e 00 63 00 6f 00 6d 00 2f 00 6d 00 6f 00 64 00 75 00 6c 00 6f 00 73 00 31 00 2f 00 90 02 08 2e 00 6a 00 70 00 67 00 90 00 } //2
