...
rule TrojanDownloader_Win32_Delf_MS{
	...
	strings :
		$a_01_0 = {5c 44 65 62 75 67 73 5c 6c 73 61 73 73 30 30 2e 65 78 65 } //02 00 
		$a_01_1 = {37 35 32 37 34 35 37 34 34 37 34 35 37 34 35 37 38 39 38 31 32 37 34 36 37 35 32 37 35 32 } //01 00 
