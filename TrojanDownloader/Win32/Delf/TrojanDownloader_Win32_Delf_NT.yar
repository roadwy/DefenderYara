...
rule TrojanDownloader_Win32_Delf_NT{
	meta:
		description = "TrojanDownloader:Win32/Delf.NT,SIGNATURE_TYPE_PEHSTR,1f 00 1f 00 05 00 00 "
	...
	strings :
		...
		$a_01_2 = {6a 00 70 00 64 00 65 00 73 00 6b 00 } //10 jpdesk
		$a_01_3 = {35 00 38 00 2e 00 32 00 35 00 33 00 2e 00 32 00 33 00 35 00 2e 00 38 00 } //1 58.253.235.8
		$a_01_4 = {64 00 6c 00 5f 00 64 00 69 00 72 00 32 00 2e 00 71 00 71 00 2e 00 63 00 6f 00 6d 00 } //1 dl_dir2.qq.com
	condition:
