...
rule TrojanDownloader_Win32_Delf_ZXC{
	...
	strings :
		$a_02_0 = {43 3a 5c 50 72 6f 67 72 61 6d 44 61 74 65 73 5c 00 [0-10] 00 68 74 74 70 3a 2f 2f [0-20] 2e 6a 70 67 00 [0-10] 43 3a 5c 50 72 6f 67 72 61 6d 44 61 74 65 73 5c [0-10] 2e 65 78 65 00 } //4
