...
rule TrojanDownloader_Win32_Delf_GJ{
	...
	strings :
		...
		$a_02_3 = {2f 6d 79 6c 69 73 74 2e 61 73 70 3f 76 65 72 3d 90 02 08 26 74 67 69 64 3d 90 02 08 26 61 64 64 72 65 73 73 3d 30 30 2d 30 30 2d 30 30 2d 30 30 90 00 } //1
		$a_02_4 = {43 3a 5c 44 6f 63 75 6d 65 6e 74 73 20 61 6e 64 20 53 65 74 74 00 00 00 ff ff ff ff 90 01 01 00 00 00 69 6e 67 73 5c 41 6c 6c 20 55 73 65 72 73 90 00 } //1
		$a_02_5 = {64 65 6c 61 79 90 02 0f 72 75 6e 90 02 30 68 74 74 70 3a 2f 2f 90 00 } //1
	condition:
