...
rule TrojanDownloader_Win32_Delf_ZDH{
	...
	strings :
		...
		$a_03_2 = {53 6f 66 74 77 61 72 65 5c 4d 69 63 72 6f 73 6f 66 74 5c 57 69 6e 64 6f 77 73 5c 43 75 72 72 65 6e 74 56 65 72 73 69 6f 6e 5c 45 78 70 6c 6f 72 65 72 5c 53 68 65 6c 6c 20 46 6f 6c 64 65 72 73 [0-0c] 5c 49 6e 74 65 6c 5c 57 69 72 65 6c 65 73 73 5c 57 4c 41 4e 50 72 6f 66 69 6c 65 73 5c } //1
