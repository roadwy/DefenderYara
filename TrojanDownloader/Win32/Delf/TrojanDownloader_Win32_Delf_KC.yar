...
rule TrojanDownloader_Win32_Delf_KC{
	meta:
		description = "TrojanDownloader:Win32/Delf.KC,SIGNATURE_TYPE_PEHSTR,07 00 07 00 07 00 00 01 00 "
	...
	strings :
		...
		$a_01_1 = {67 2e 69 6e 66 6f 33 33 34 34 2e 63 6e 2f 6d 79 70 6f 70 } //01 00  g.info3344.cn/mypop
