...
rule TrojanDownloader_Win32_Delf_JX{
	...
	strings :
		$a_01_0 = {48 54 54 50 2f 31 2e 30 20 32 30 30 20 4f 4b } //01 00  HTTP/1.0 200 OK
		$a_01_1 = {49 66 20 65 78 69 73 74 20 22 25 73 22 20 47 6f 74 6f 20 31 } //02 00  If exist "%s" Goto 1
		$a_01_2 = {47 74 66 78 69 6e 73 74 61 6c 6c } //02 00  Gtfxinstall
