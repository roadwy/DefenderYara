...
rule TrojanDownloader_Win32_Delf_RAY{
	...
	strings :
		$a_01_0 = {3f 61 64 76 3d } //01 00 
		$a_01_1 = {69 6e 74 65 72 6e 61 74 2e 64 6c 6c 2c 4c 6f 61 64 4b 65 79 62 6f 61 72 64 50 72 6f 66 69 6c 65 } //01 00 
		$a_01_2 = {44 69 73 61 62 6c 65 54 61 73 6b 4d 67 72 } //0a 00 
