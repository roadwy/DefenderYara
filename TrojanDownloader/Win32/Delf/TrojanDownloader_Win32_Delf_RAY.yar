...
rule TrojanDownloader_Win32_Delf_RAY{
	...
	strings :
		...
		$a_02_3 = {88 58 03 8d 45 90 01 01 8b 15 90 01 04 8a 52 03 e8 90 01 02 ff ff 8b 45 90 01 01 e8 90 01 02 ff ff bb 73 00 00 00 2b d8 b8 90 01 04 e8 90 01 02 ff ff 88 58 06 b8 90 01 04 ba 90 01 04 e8 90 01 02 ff ff 90 00 } //10
