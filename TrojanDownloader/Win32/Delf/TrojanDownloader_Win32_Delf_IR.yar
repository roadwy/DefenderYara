...
rule TrojanDownloader_Win32_Delf_IR{
	...
	strings :
		$a_02_0 = {8d 40 00 85 d2 74 90 01 01 66 83 7a f6 02 74 90 01 01 e9 90 01 04 8b 4a f8 41 7e 90 01 01 f0 ff 42 f8 87 10 85 d2 74 90 01 01 8b 4a f8 49 7c 90 01 01 f0 ff 4a f8 75 90 01 01 8d 42 f4 e8 90 00 } //10
