...
rule TrojanDownloader_Win32_Delf_GL{
	...
	strings :
		$a_00_0 = {31 2e 68 69 76 } //01 00  1.hiv
		...
		$a_00_3 = {69 65 70 72 6f 6c 6f 61 64 65 72 2e 65 78 65 } //01 00  ieproloader.exe
		$a_00_4 = {53 6f 66 74 77 61 72 65 5c 6d 6d 74 65 73 74 } //01 00  Software\mmtest
