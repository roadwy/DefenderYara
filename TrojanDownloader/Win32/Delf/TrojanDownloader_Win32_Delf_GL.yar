...
rule TrojanDownloader_Win32_Delf_GL{
	...
	strings :
		...
		$a_03_5 = {52 50 8d 46 48 50 e8 90 01 02 ff ff 83 f8 ff 0f 84 90 01 02 00 00 89 06 66 81 7e 04 b3 d7 0f 85 90 01 02 00 00 66 ff 4e 04 6a 00 ff 36 e8 90 01 02 ff ff 40 0f 84 90 01 02 00 00 2d 81 00 00 00 90 00 } //1
	condition:
