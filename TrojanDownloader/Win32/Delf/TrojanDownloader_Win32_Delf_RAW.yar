...
rule TrojanDownloader_Win32_Delf_RAW{
	...
	strings :
		...
		$a_02_4 = {89 45 f8 33 c0 55 68 90 01 04 64 ff 30 64 89 20 6a 00 6a 00 6a 00 6a 00 8b 90 01 01 e8 90 01 04 50 8b 45 f8 50 e8 90 01 04 89 45 f4 33 c0 55 68 90 01 04 64 ff 30 64 89 20 56 68 00 04 00 00 8d 85 f0 fb ff ff 50 8b 45 f4 50 90 00 } //1
	condition:
