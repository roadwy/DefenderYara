...
rule TrojanDownloader_Win32_Delf_GE{
	...
	strings :
		...
		$a_02_8 = {68 74 74 70 3a 2f 2f 90 02 20 63 6f 6d 2e 62 72 2f 77 69 6e 64 6f 73 72 65 6d 6f 74 65 2e 74 78 74 90 00 } //1
		$a_02_9 = {68 74 74 70 3a 2f 2f 90 02 20 63 6f 6d 2e 62 72 2f 47 62 70 53 65 72 76 65 72 33 32 2e 74 78 74 90 00 } //1
		$a_02_10 = {68 74 74 70 3a 2f 2f 90 02 20 63 6f 6d 2e 62 72 2f 57 69 6e 55 70 64 61 74 65 64 61 74 61 2e 74 78 74 90 00 } //1
		$a_00_11 = {41 70 6c 69 63 61 69 76 6f 20 64 6f 20 4d 53 2d 44 4f 53 } //1 Aplicaivo do MS-DOS
		$a_02_12 = {33 c0 55 68 90 01 02 45 00 64 ff 30 64 89 20 8d 85 f7 fb ff ff 8b 55 fc e8 90 01 03 ff 8d 85 f6 f7 ff ff 8b 55 f8 e8 90 01 03 ff 6a 00 6a 00 8d 85 f6 f7 ff ff 50 8d 85 f7 fb ff ff 50 6a 00 6a 00 e8 90 01 03 ff 33 c0 5a 59 59 64 89 10 90 00 } //1
		$a_02_13 = {33 d2 33 c0 e8 90 01 02 ff ff ba 90 01 02 45 00 b8 90 01 02 45 00 e8 90 01 02 ff ff 84 c0 74 0c 33 d2 b8 90 01 02 45 00 e8 90 01 02 ff ff ba 90 01 02 45 00 b8 90 01 02 45 00 e8 90 01 02 ff ff 84 c0 74 0c 33 d2 b8 90 01 02 45 00 90 00 } //1
	condition:
