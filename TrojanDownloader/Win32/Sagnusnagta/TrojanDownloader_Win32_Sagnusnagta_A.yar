...
rule TrojanDownloader_Win32_Sagnusnagta_A{
	...
	strings :
		...
		$a_02_1 = {25 73 25 64 25 64 2e 65 78 65 90 02 10 63 3a 5c 90 02 03 2e 74 78 74 90 00 } //1
		$a_02_2 = {68 74 74 70 3a 2f 2f 90 02 08 2e 73 77 68 6d 7a 71 2e 63 6f 6d 2f 90 00 } //2
		$a_03_3 = {55 52 4c 00 90 02 04 25 64 90 02 04 63 3a 5c 90 02 03 2e 64 61 74 90 00 } //1
