...
rule TrojanDownloader_Win32_Brucryp_C{
	...
	strings :
		...
		$a_03_2 = {69 00 70 00 63 00 68 00 6f 00 6f 00 6b 00 73 00 79 00 6e 00 63 00 90 02 d0 25 00 41 00 50 00 50 00 44 00 41 00 54 00 41 00 25 00 5c 00 4d 00 69 00 63 00 72 00 6f 00 73 00 6f 00 66 00 74 00 5c 00 43 00 72 00 79 00 70 00 74 00 6f 00 5c 00 52 00 53 00 41 00 90 00 } //1
	condition:
