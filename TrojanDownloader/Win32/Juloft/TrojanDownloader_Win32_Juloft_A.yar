...
rule TrojanDownloader_Win32_Juloft_A{
	...
	strings :
		$a_02_0 = {68 74 74 70 3a 2f 2f 77 77 77 2e 6a 75 6c 79 73 6f 66 74 90 02 01 2e 63 6e 2f 64 61 74 61 2f 69 70 2e 70 68 70 90 00 } //100
		$a_00_1 = {49 6e 74 65 72 6e 65 74 20 45 78 70 6c 6f 72 65 72 5f 53 65 72 76 65 72 } //100 Internet Explorer_Server
		$a_02_2 = {68 74 74 70 3a 2f 2f 77 77 77 2e 6a 75 6c 79 73 6f 66 74 90 02 01 2e 63 6e 2f 64 61 74 61 2f 4c 4c 2e 74 78 74 90 00 } //10
		$a_00_3 = {4c 4c 43 6f 6e 66 69 67 2e 69 6e 69 } //1 LLConfig.ini
		$a_02_4 = {68 74 74 70 3a 2f 2f 77 77 77 2e 6a 75 6c 79 73 6f 66 74 90 02 01 2e 63 6e 2f 64 61 74 61 2f 44 4a 2e 74 78 74 90 00 } //10
		$a_00_5 = {44 4a 43 6f 6e 66 69 67 2e 69 6e 69 } //1 DJConfig.ini
		$a_02_6 = {68 74 74 70 3a 2f 2f 77 77 77 2e 6a 75 6c 79 73 6f 66 74 90 02 01 2e 63 6e 2f 64 61 74 61 2f 74 6a 2f 63 6f 75 6e 74 2e 70 68 70 3f 4d 41 43 3d 90 00 } //100
		...
		$a_02_8 = {68 74 74 70 3a 2f 2f 77 77 77 2e 6a 75 6c 79 73 6f 66 74 90 02 01 2e 63 6e 2f 64 61 74 61 2f 54 43 2e 74 78 74 90 00 } //10
