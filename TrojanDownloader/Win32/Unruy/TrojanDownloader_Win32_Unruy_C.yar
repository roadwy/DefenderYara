...
rule TrojanDownloader_Win32_Unruy_C_2{
	...
	strings :
		$a_01_0 = {2d 2d 43 4c 49 43 4b 5f 43 59 43 4c 45 53 } //01 00 
		$a_00_1 = {25 73 2e 64 65 6c 6d 65 25 75 } //01 00 
		$a_00_2 = {66 61 6b 65 72 5f 76 } //01 00 
		$a_00_3 = {25 73 2f 73 65 61 72 63 68 2e 70 68 70 3f 71 3d 25 64 2e 25 64 2e } //01 00 
		$a_00_4 = {2e 6d 65 67 61 77 65 62 66 69 6e 64 } //01 00 
		$a_00_5 = {31 32 32 2e 31 34 31 2e 38 36 2e 31 32 } //01 00 
		$a_00_6 = {61 64 2d 77 61 74 63 68 } //01 00 
		$a_00_7 = {70 61 76 66 6e 73 76 } //01 00 
		$a_00_8 = {41 64 6f 62 65 5f 52 65 61 64 65 72 } //01 00 
		$a_01_9 = {52 45 20 57 45 20 47 4f } //00 00 
	condition:
		any of ($a_*)
