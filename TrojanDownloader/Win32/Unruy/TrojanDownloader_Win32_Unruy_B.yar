...
rule TrojanDownloader_Win32_Unruy_B{
	...
	strings :
		...
		$a_03_1 = {80 78 ff 50 75 90 01 01 80 78 fe 55 75 90 01 01 56 56 56 90 00 } //1
		$a_03_2 = {80 38 58 89 45 10 0f 85 90 01 04 80 78 ff 50 75 7c 80 78 fe 55 75 76 90 00 } //1
