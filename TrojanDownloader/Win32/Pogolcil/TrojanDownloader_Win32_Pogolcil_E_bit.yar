...
rule TrojanDownloader_Win32_Pogolcil_E_bit{
	...
	strings :
		$a_03_0 = {8b d8 ff 15 90 01 03 00 3d 90 01 04 74 90 01 01 8b c7 8d 0c 37 99 f7 7d 90 01 01 8a 44 15 90 01 01 32 04 19 88 01 47 83 ff 90 01 01 7c db 90 00 } //1
