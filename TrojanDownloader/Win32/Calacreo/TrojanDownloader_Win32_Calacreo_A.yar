...
rule TrojanDownloader_Win32_Calacreo_A{
	...
	strings :
		...
		$a_03_3 = {6d 6f 64 75 6c 65 73 2f 64 6f 63 73 2f [0-20] 69 6e 64 65 78 31 2e 70 68 70 3f 76 65 72 3d } //1
		$a_03_4 = {6a 00 6a 1a 68 ?? ?? ?? ?? 6a 00 ff d0 be ?? ?? ?? ?? fc 83 e1 00 8a 06 50 9c 58 25 00 04 00 00 83 f8 00 75 05 83 c6 01 eb 03 83 ee 01 58 3c 00 74 } //2
	condition:
