...
rule TrojanDownloader_Win32_Copia_A{
	...
	strings :
		$a_01_0 = {3a 00 5c 00 63 00 6f 00 70 00 69 00 61 00 5f 00 62 00 68 00 6f 00 5c 00 } //01 00 
		$a_01_1 = {41 00 50 00 49 00 2d 00 47 00 75 00 69 00 64 00 65 00 20 00 74 00 65 00 73 00 74 00 20 00 70 00 72 00 6f 00 67 00 72 00 61 00 6d 00 } //01 00 
