...
rule TrojanDownloader_Win32_Ufraie_B{
	...
	strings :
		...
		$a_01_4 = {75 6e 69 71 3d 25 64 } //01 00  uniq=%d
		$a_01_5 = {66 75 63 6b 3d 25 64 } //01 00  fuck=%d
		$a_01_6 = {72 61 73 3d 25 64 } //01 00  ras=%d
		$a_01_7 = {61 76 3d 25 73 } //01 00  av=%s
		$a_01_8 = {77 69 6e 76 65 72 3d 25 64 7c 25 64 7c 25 64 7c 25 64 7c 25 64 7c 25 64 7c 25 73 } //01 00  winver=%d|%d|%d|%d|%d|%d|%s
		$a_01_9 = {6b 72 5f 64 6f 6e 65 } //02 00  kr_done
		$a_01_10 = {69 64 74 3d 25 30 38 78 26 76 6d 64 65 76 3d 25 64 26 61 76 66 3d 25 64 } //00 00  idt=%08x&vmdev=%d&avf=%d
	condition:
		any of ($a_*)
