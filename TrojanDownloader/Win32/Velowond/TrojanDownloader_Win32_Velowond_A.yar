...
rule TrojanDownloader_Win32_Velowond_A{
	...
	strings :
		$a_03_0 = {83 c6 02 53 68 90 01 04 8d 4d e8 89 75 c4 e8 90 01 04 8b f0 8d 4d e8 8d 7e 01 57 68 90 01 04 e8 90 01 04 8d 4d d4 89 45 10 e8 90 01 04 8d 4d d8 c6 45 fc 09 90 00 } //2
