...
rule TrojanDownloader_Win32_Velowond_A{
	...
	strings :
		...
		$a_01_1 = {25 74 65 6d 70 70 61 74 68 25 } //01 00  %temppath%
		$a_01_2 = {25 77 69 6e 70 61 74 68 25 } //01 00  %winpath%
		$a_01_3 = {25 73 79 73 74 65 6d 70 61 74 68 25 } //00 00  %systempath%
	condition:
		any of ($a_*)
