...
rule TrojanDownloader_Win32_Cefunlor_A{
	...
	strings :
		$a_03_0 = {8b 47 1c ba 00 00 01 00 e8 90 01 04 c7 47 10 90 90 5f 01 00 8d 47 08 ba 90 01 04 e8 90 00 } //1
		$a_03_1 = {69 6e 66 5f 66 61 63 65 5f 63 75 90 01 01 2e 6a 70 67 90 00 } //1
