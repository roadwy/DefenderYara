...
rule TrojanDownloader_Win32_Datamaikon_gen_A{
	...
	strings :
		$a_01_0 = {75 70 64 61 74 65 2e 6b 6f 6e 61 6d 69 64 61 74 61 2e 63 6f 6d 2f 74 65 73 74 2f } //01 00 
		$a_01_1 = {50 72 6f 78 79 2d 41 75 74 68 6f 72 69 7a 61 74 69 6f 6e 3a 42 61 73 69 63 } //01 00 
		$a_01_2 = {6d 79 41 67 65 6e 74 } //01 00 
		$a_01_3 = {41 76 61 6c 69 61 62 6c 65 20 64 61 74 61 3a 25 75 20 62 79 74 65 73 } //01 00 
