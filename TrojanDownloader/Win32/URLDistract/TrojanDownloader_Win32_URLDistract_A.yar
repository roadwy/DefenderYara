...
rule TrojanDownloader_Win32_URLDistract_A{
	...
	strings :
		...
		$a_03_2 = {0f bf 55 cc 0f bf 45 d4 8b 4d d8 33 d0 51 52 ff 15 90 01 04 8b d0 8d 4d c4 ff d6 50 ff 15 90 01 04 8b d0 8d 4d d8 ff d6 8d 4d c4 ff d3 b8 02 00 00 00 66 03 c7 70 73 8b f8 e9 f2 fe ff ff 90 00 } //1
	condition:
