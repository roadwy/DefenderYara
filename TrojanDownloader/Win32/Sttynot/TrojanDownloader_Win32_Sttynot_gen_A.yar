...
rule TrojanDownloader_Win32_Sttynot_gen_A{
	...
	strings :
		$a_03_0 = {8a 54 1a ff 80 f2 90 01 01 88 54 18 ff 43 4e 75 e6 90 00 } //1
		$a_03_1 = {ba 01 08 00 00 e8 90 01 04 6a 00 68 01 08 00 00 8d 85 90 01 02 ff ff 50 53 e8 90 00 } //1
