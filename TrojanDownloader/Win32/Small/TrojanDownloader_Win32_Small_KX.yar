...
rule TrojanDownloader_Win32_Small_KX{
	...
	strings :
		...
		$a_03_5 = {b9 00 00 00 00 e8 90 01 02 fe ff 8b 45 90 01 01 e8 90 01 02 fe ff 8b f0 8d 45 90 01 01 e8 90 01 02 ff ff 8d 45 90 01 01 50 8d 4d 90 01 01 ba 90 01 02 41 00 b8 90 01 02 41 00 e8 90 01 02 ff ff 8b 55 90 01 01 58 90 00 } //1
	condition:
