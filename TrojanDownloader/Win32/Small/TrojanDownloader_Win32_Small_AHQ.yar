...
rule TrojanDownloader_Win32_Small_AHQ{
	...
	strings :
		...
		$a_03_2 = {5c 4e 65 74 4d 65 65 ?? 69 6e 67 5c 55 6e 69 6e ?? 74 61 6c 6c 2e 65 78 65 } //1
		$a_03_3 = {69 75 75 71 3b 30 30 [0-03] 2f 79 79 38 2f 6a 6f 30 [0-03] 30 64 70 76 6f 75 2f 62 74 71 } //1
	condition:
