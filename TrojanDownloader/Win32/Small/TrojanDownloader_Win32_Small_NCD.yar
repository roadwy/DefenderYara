...
rule TrojanDownloader_Win32_Small_NCD{
	...
	strings :
		...
		$a_00_1 = {2f 63 20 64 65 6c 20 25 73 2e 65 78 65 } //01 00  /c del %s.exe
		$a_00_2 = {43 72 65 61 74 65 4d 75 74 65 78 } //01 00  CreateMutex
		$a_00_3 = {57 69 6e 45 78 65 63 } //00 00  WinExec
	condition:
		any of ($a_*)
