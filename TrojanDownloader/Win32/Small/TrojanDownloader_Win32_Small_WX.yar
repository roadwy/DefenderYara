...
rule TrojanDownloader_Win32_Small_WX{
	...
	strings :
		$a_03_0 = {55 68 80 00 00 00 6a 02 55 6a 04 68 ff 01 1f 00 53 ff 15 ?? ?? ?? ?? 8b d8 8d 44 24 20 55 50 57 56 53 89 6c 24 34 ff 15 } //2
		$a_03_1 = {b8 00 00 00 80 be 02 00 00 00 bd 04 00 00 00 eb 0f b8 00 00 00 c0 be 04 00 00 00 bd 06 00 00 00 6a 00 6a 00 6a 03 6a 00 6a 01 50 8b 44 24 2c 50 ff 15 ?? ?? ?? ?? 8b f8 83 ff ff } //2
