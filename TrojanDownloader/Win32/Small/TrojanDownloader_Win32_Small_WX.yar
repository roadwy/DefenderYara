...
rule TrojanDownloader_Win32_Small_WX{
	...
	strings :
		...
		$a_01_2 = {5c 64 6f 77 6e 2e 74 78 74 } //01 00 
		$a_01_3 = {63 6c 63 6f 75 6e 74 2f 63 6f 75 6e 74 2e 61 73 70 3f 6d 61 63 3d } //01 00 
		$a_01_4 = {47 6c 6f 62 61 6c 5c 45 56 45 4e 54 5f 62 6f 73 73 69 73 72 75 6e 69 6e 67 } //01 00 
		$a_01_5 = {47 6c 6f 62 61 6c 5c 45 56 45 4e 54 5f 44 4f 47 5f 44 4f 47 5f 58 58 58 } //00 00 
	condition:
		any of ($a_*)
