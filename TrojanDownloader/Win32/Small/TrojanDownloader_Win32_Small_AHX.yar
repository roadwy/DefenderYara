...
rule TrojanDownloader_Win32_Small_AHX{
	...
	strings :
		$a_01_0 = {71 64 2e 6e 65 74 6b 69 6c 6c 2e 63 6f 6d 2e 63 6e } //01 00  qd.netkill.com.cn
		$a_01_1 = {61 7d 7d 79 33 26 26 78 6d 27 67 6c 7d 62 60 65 65 27 6a 66 64 27 6a 67 26 79 7e 27 7d 71 7d } //01 00  a}}y3&&xm'gl}b`ee'jfd'jg&y~'}q}
