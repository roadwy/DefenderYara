...
rule TrojanDownloader_Win32_Small_AHR{
	...
	strings :
		$a_01_0 = {64 64 64 2e 69 70 33 33 30 33 33 2e 63 6f 6d } //01 00  ddd.ip33033.com
		$a_01_1 = {4e 59 30 37 48 6b 54 4a 6c 74 70 76 73 4d 61 31 48 6d 58 4f 47 63 35 6c 46 6d 2b 32 57 55 52 4d 48 63 6b 4e 4f 57 30 57 48 77 77 66 } //01 00  NY07HkTJltpvsMa1HmXOGc5lFm+2WURMHckNOW0WHwwf
		$a_01_2 = {25 73 4f 6e 65 47 25 64 2e 65 78 65 } //01 00  %sOneG%d.exe
