...
rule TrojanDownloader_Win32_Small_AAAB{
	...
	strings :
		$a_00_0 = {42 35 41 43 34 39 41 32 2d 39 34 46 33 2d 34 32 42 44 2d 46 34 33 34 2d 32 36 30 34 38 31 32 43 38 39 37 44 } //02 00 
		$a_00_1 = {62 65 6e 73 6f 72 74 79 2e 64 6c 6c } //01 00 
		...
		$a_00_5 = {4f 70 65 6e 50 72 6f 63 65 73 73 } //01 00 
