...
rule TrojanDownloader_Win32_Small_BKU{
	...
	strings :
		...
		$a_02_3 = {68 74 74 70 3a 2f 2f 90 02 30 2e 70 68 70 3f 69 64 3d 25 73 26 76 65 72 3d 90 00 } //1
