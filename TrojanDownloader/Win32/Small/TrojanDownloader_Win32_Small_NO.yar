...
rule TrojanDownloader_Win32_Small_NO{
	...
	strings :
		$a_00_0 = {63 6d 64 20 2f 63 20 73 68 75 74 64 6f 77 6e 20 2d 72 20 2d 74 20 30 } //01 00  cmd /c shutdown -r -t 0
		$a_00_1 = {75 72 6c 6d 30 6e 2e 64 6c 6c } //01 00  urlm0n.dll
