...
rule TrojanDownloader_Win32_Small_ZYN{
	...
	strings :
		$a_03_0 = {69 c0 00 a4 93 d6 50 ff 15 90 01 04 8b 45 f0 c6 45 fc 04 3b c3 74 06 90 00 } //1
		$a_01_1 = {25 73 5c 31 32 32 39 2e 74 6d 70 } //1 %s\1229.tmp
		$a_03_2 = {5c 56 4c 2e 69 6e 69 90 09 0a 00 43 3a 5c 57 49 4e 44 4f 57 53 90 00 } //1
