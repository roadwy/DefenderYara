...
rule TrojanDownloader_Win32_Small_KY{
	...
	strings :
		...
		$a_03_1 = {8d 7e 74 6a 68 56 8b cf e8 90 01 02 ff ff 68 90 01 02 40 00 8d 4c 24 14 e8 90 01 02 00 00 8b 44 90 01 02 8b cf 50 c7 84 90 01 03 00 00 00 00 00 00 e8 90 01 02 ff ff 8d 4c 90 01 02 68 08 02 00 00 51 6a 00 90 00 } //1
	condition:
