...
rule TrojanDownloader_Win32_Small_KY{
	...
	strings :
		$a_00_0 = {68 74 74 70 3a 2f 2f 77 77 77 2e 73 70 65 65 64 61 70 70 73 2e 63 6f 6d 2f 61 64 73 70 61 63 65 5f 62 63 5f 72 65 66 5f 31 2e 68 74 6d } //01 00  http://www.speedapps.com/adspace_bc_ref_1.htm
