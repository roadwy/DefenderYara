...
rule TrojanDownloader_Win32_Small_AABH{
	...
	strings :
		$a_02_0 = {6a 00 6a 00 90 02 05 6a 00 6a 00 e8 90 01 01 00 00 00 83 c4 04 eb 1c 83 7d 0c 00 75 16 ff 35 90 01 02 00 10 e8 90 01 01 00 00 00 ff 35 90 01 02 00 10 90 00 } //5
		$a_02_1 = {64 61 69 6c 75 70 90 02 03 6c 61 6e 90 02 03 75 6e 6b 6e 6f 77 00 90 00 } //2
