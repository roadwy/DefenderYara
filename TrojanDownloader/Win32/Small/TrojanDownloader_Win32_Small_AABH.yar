...
rule TrojanDownloader_Win32_Small_AABH{
	...
	strings :
		...
		$a_00_2 = {76 65 72 3d 25 6c 75 26 75 69 64 3d 25 6c 75 26 63 6f 6e 6e 3d 25 73 26 6f 73 3d 25 73 26 73 6f 63 6b 73 3d 25 6c 75 26 69 70 3d 25 73 } //01 00 
		$a_00_3 = {2f 67 65 74 2e 63 67 69 3f 64 61 74 61 3d } //00 00 
	condition:
		any of ($a_*)
