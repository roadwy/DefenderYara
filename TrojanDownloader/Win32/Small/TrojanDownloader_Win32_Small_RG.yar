...
rule TrojanDownloader_Win32_Small_RG{
	...
	strings :
		...
		$a_01_1 = {53 6b 79 4d 6f 6e 2e 65 78 65 } //01 00  SkyMon.exe
		$a_01_2 = {41 4c 59 61 63 2e 61 79 65 } //01 00  ALYac.aye
		$a_01_3 = {41 79 41 67 65 6e 74 2e 61 79 65 } //01 00  AyAgent.aye
		$a_01_4 = {5c 73 79 73 74 65 6d 49 6e 66 6f 2e 69 6e 69 } //0a 00  \systemInfo.ini
		$a_01_5 = {55 52 4c 44 6f 77 6e 6c 6f 61 64 54 6f 46 69 6c 65 41 } //0a 00  URLDownloadToFileA
