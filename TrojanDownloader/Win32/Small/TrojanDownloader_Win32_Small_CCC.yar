...
rule TrojanDownloader_Win32_Small_CCC{
	...
	strings :
		$a_02_0 = {b8 20 20 20 20 0b 90 01 01 81 90 01 01 65 78 70 6c 0f 85 90 01 01 00 00 00 8b 90 01 01 04 0b 90 01 01 81 90 01 01 6f 72 65 72 0f 85 90 01 01 00 00 00 8b 90 01 01 08 0b 90 01 01 81 90 01 01 2e 65 78 65 0f 85 90 01 01 00 00 00 90 00 } //10
