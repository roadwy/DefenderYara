...
rule TrojanDownloader_Win32_Small_BPM{
	...
	strings :
		...
		$a_02_17 = {8d 85 f4 fb ff ff 50 e8 ?? ?? ff ff 8d 85 f4 fb ff ff c7 04 24 ?? ?? 40 00 50 e8 ?? ?? 00 00 59 8d 85 f4 fb ff ff 59 53 50 8d 85 e8 f8 ff ff 50 ff 15 ?? ?? ?? ?? 8d 85 e8 f8 ff ff 50 ff 15 ?? ?? ?? ?? 8d 45 f8 50 68 ?? ?? 40 00 68 02 00 00 80 ff 15 ?? ?? ?? ?? 85 c0 75 27 8d 85 f4 fb ff ff 50 e8 ?? ?? 00 00 59 40 50 8d 85 f4 fb ff ff 50 6a 01 53 } //10
		$a_02_18 = {eb 00 b9 00 01 00 00 ba b1 c9 ec cc 8d 41 ff 51 b9 08 00 00 00 d1 e8 73 02 33 c2 49 75 f7 59 89 04 8d ?? ?? 40 00 49 75 e3 c3 } //10
	condition:
