...
rule TrojanDownloader_Win32_Small_NCC{
	...
	strings :
		...
		$a_02_2 = {55 8b ec 83 c4 ec e8 ?? ?? 00 00 8d 4d fc 51 6a 20 50 e8 ?? ?? 00 00 c7 45 ec 01 00 00 00 8d 45 f0 50 68 ?? ?? 40 00 6a 00 e8 ?? ?? 00 00 c7 45 f8 02 00 00 00 6a 00 6a 00 6a 10 } //10
