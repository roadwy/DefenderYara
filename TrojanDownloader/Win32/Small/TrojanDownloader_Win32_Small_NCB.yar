...
rule TrojanDownloader_Win32_Small_NCB{
	...
	strings :
		...
		$a_00_2 = {54 49 4d 50 6c 61 74 66 6f 72 6d 2e 65 78 65 } //01 00 
		$a_00_3 = {69 64 3d 25 73 26 70 3d 25 73 26 6d 62 3d 25 64 26 6a 31 3d 25 73 2e 26 7a 31 3d 25 73 26 64 31 3d 25 73 26 73 72 76 3d 25 73 } //01 00 
		$a_00_4 = {6a 6c 29 40 67 6d 6c 79 6c 67 6d 6c 67 7d 29 4b 60 7d 64 68 79 } //00 00 
	condition:
		any of ($a_*)
