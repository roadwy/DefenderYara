...
rule TrojanDownloader_Win32_Small_AHL{
	...
	strings :
		$a_02_0 = {76 65 72 00 75 75 00 00 2e 6c 6f 67 00 00 00 00 47 6c 6f 62 61 6c 5c 5f 5f 73 74 6f 70 90 02 10 4d 6f 7a 69 6c 6c 61 2f 34 2e 30 20 28 63 6f 6d 70 61 74 69 62 6c 65 29 90 02 10 68 74 74 70 3a 2f 2f 64 2e 72 6f 62 69 6e 74 73 2e 75 73 2f 90 00 } //1
