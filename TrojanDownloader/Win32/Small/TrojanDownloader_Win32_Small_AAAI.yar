...
rule TrojanDownloader_Win32_Small_AAAI{
	...
	strings :
		$a_01_0 = {68 74 74 70 3a 2f 2f 36 39 2e 33 31 2e 38 34 2e 32 32 33 2f } //01 00  http://69.31.84.223/
		$a_01_1 = {68 74 74 70 3a 2f 2f 74 72 61 63 6b 68 69 74 73 2e 63 63 2f 63 6e 74 } //01 00  http://trackhits.cc/cnt
