...
rule TrojanDownloader_Win32_Small_GS{
	...
	strings :
		$a_02_0 = {64 3a 5c 4d 79 44 6f 63 75 6d 65 6e 74 5c 56 69 73 75 61 6c 20 53 74 75 64 69 6f 20 50 72 6f 6a 65 63 74 73 5c 44 6f 77 6e 6c 6f 61 64 65 72 20 20 50 72 6f 6a 65 63 74 20 59 55 90 01 01 5c 44 6f 77 6e 6c 6f 61 64 65 72 4d 61 69 6e 5c 44 6f 77 6e 6c 6f 61 64 65 72 44 6c 6c 2e 70 64 62 00 00 90 00 } //2
		...
		$a_02_3 = {68 74 74 70 3a 2f 2f 6f 31 2e 6f 31 77 79 2e 63 6f 6d 2f 6d 69 73 73 2f 90 02 08 2e 67 69 66 90 00 } //1
