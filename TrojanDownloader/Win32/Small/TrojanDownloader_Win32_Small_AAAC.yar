...
rule TrojanDownloader_Win32_Small_AAAC{
	...
	strings :
		...
		$a_02_1 = {68 74 74 70 3a 2f 2f 67 69 63 69 61 2e 69 6e 66 6f 2f 63 64 2f 63 64 2e 70 68 70 3f 69 64 3d 25 73 26 76 65 72 3d 67 90 01 01 31 90 00 } //1
		$a_02_2 = {68 74 74 70 3a 2f 2f 6d 61 73 67 69 4f 2e 69 6e 66 6f 2f 63 64 2f 63 64 2e 70 68 70 3f 69 64 3d 25 73 26 76 65 72 3d 67 90 01 01 31 90 00 } //1
		$a_02_3 = {68 74 74 70 3a 2f 2f 66 31 76 69 73 61 2e 69 6e 66 6f 2f 63 64 2f 63 64 2e 70 68 70 3f 69 64 3d 25 73 26 76 65 72 3d 67 90 01 01 31 90 00 } //1
