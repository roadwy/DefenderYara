...
rule TrojanDownloader_Win32_Secdow_A{
	...
	strings :
		$a_00_0 = {53 45 43 20 44 6f 77 6e 6c 6f 61 64 65 72 } //02 00 
		$a_00_1 = {73 76 63 68 6f 73 74 2e 65 78 65 } //02 00 
		$a_00_2 = {63 3a 5c 73 65 63 2e 65 78 65 } //02 00 
		$a_00_3 = {55 52 4c 44 6f 77 6e 6c 6f 61 64 54 6f 46 69 6c 65 41 } //02 00 
		$a_00_4 = {76 69 72 75 73 2e 73 63 72 } //02 00 
		$a_00_5 = {63 3a 5c 76 69 72 75 73 2e 65 78 65 } //05 00 
