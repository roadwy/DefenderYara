...
rule TrojanDownloader_Win32_Seimon_D{
	...
	strings :
		...
		$a_01_2 = {6d 75 74 65 78 5f } //01 00 
		$a_01_3 = {25 4d 41 43 41 44 44 52 } //01 00 
		$a_01_4 = {25 73 5c 6d 73 61 67 65 6e 74 5c 25 73 } //01 00 
		$a_01_5 = {25 73 5f 6d 74 78 5f 6e 61 6d 65 } //01 00 
		...
		$a_01_7 = {25 41 43 54 49 4f 4e } //01 00 
		$a_01_8 = {25 43 4f 4d 50 41 4e 59 } //01 00 
		$a_01_9 = {25 73 5c 25 64 2e 65 78 65 } //00 00 
	condition:
		any of ($a_*)
