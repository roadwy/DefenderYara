...
rule TrojanDownloader_Win32_Tegtomp_A{
	...
	strings :
		$a_03_0 = {81 ec 8c 04 00 00 8d 6c 24 fc a1 90 01 03 00 33 c5 89 85 8c 04 00 00 6a 20 b8 90 00 } //1
		...
		$a_03_3 = {89 75 fc c7 45 f0 01 00 00 00 8a 9e 90 01 03 00 56 8b cf 80 f3 49 e8 90 00 } //1
		$a_03_4 = {83 c4 18 c7 07 44 00 00 00 38 5d 10 74 90 01 01 33 c0 c7 46 4c 01 00 00 00 66 89 46 50 8b 45 cc 83 78 18 08 90 00 } //1
	condition:
