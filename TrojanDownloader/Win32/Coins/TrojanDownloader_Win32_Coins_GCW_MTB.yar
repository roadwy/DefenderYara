...
rule TrojanDownloader_Win32_Coins_GCW_MTB{
	meta:
		description = "TrojanDownloader:Win32/Coins.GCW!MTB,SIGNATURE_TYPE_PEHSTR_EXT,0c 00 0c 00 03 00 00 0a 00 "
		
	strings :
		$a_03_0 = {0f be 09 03 c1 89 45 fc 8b 45 08 40 89 45 08 8b 45 fc 25 00 00 00 f0 89 45 f8 74 90 01 01 8b 45 f8 c1 e8 18 33 45 fc 89 45 fc 8b 45 f8 f7 d0 23 45 fc 89 45 fc 90 00 } //01 00 
