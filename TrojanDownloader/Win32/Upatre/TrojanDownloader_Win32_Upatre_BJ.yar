...
rule TrojanDownloader_Win32_Upatre_BJ{
	...
	strings :
		...
		$a_01_2 = {2f 73 6f 6b 61 31 31 2e 70 6e 67 00 33 38 2e 37 35 2e 33 38 2e 31 38 36 } //02 00  猯歯ㅡ⸱湰g㠳㜮⸵㠳ㄮ㘸
		$a_01_3 = {31 38 38 2e 32 35 35 2e 32 34 31 2e 35 39 00 2f 73 6f 6b 61 31 31 2e 70 6e 67 00 53 4b 41 31 31 } //02 00  㠱⸸㔲⸵㐲⸱㤵⼀潳慫ㄱ瀮杮匀䅋ㄱ
		$a_01_4 = {32 34 2e 31 35 39 2e 31 35 33 2e 31 35 33 00 2f 73 6f 6b 61 31 31 2e 70 6e 67 } //00 00  㐲ㄮ㤵ㄮ㌵ㄮ㌵⼀潳慫ㄱ瀮杮
