...
rule TrojanDownloader_Win32_Upatre{
	...
	strings :
		...
		$a_03_1 = {40 00 41 5f 41 89 07 51 47 47 58 47 47 6a 05 48 ab 5a bb 90 01 04 4a 90 09 04 00 54 b8 90 00 } //1
		$a_03_2 = {bb 10 a4 38 22 58 48 ab 8b c6 8b 00 83 c6 04 8b d3 2b c2 ab 49 75 f1 e8 90 01 04 bf 90 01 04 5e 68 10 65 00 00 90 00 } //1
