...
rule TrojanDownloader_Win32_Upatre_BD{
	...
	strings :
		$a_03_0 = {e8 00 00 00 00 5b 83 c3 09 e9 90 01 02 00 00 4c 6f 61 64 4c 69 62 72 61 72 79 41 90 00 } //1
		...
		$a_03_4 = {05 80 84 1e 00 89 45 90 01 01 05 80 8d 5b 00 89 45 90 01 01 b9 00 10 00 00 90 00 } //1
