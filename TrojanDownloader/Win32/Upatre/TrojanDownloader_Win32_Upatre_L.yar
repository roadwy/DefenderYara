...
rule TrojanDownloader_Win32_Upatre_L{
	...
	strings :
		...
		$a_03_1 = {8b 48 3c 89 45 90 01 01 81 e1 ff ff 00 00 03 c1 b9 18 00 00 00 03 c1 90 00 } //1
		$a_03_2 = {3d 5a 5a 50 00 0f 90 01 02 00 00 00 8b 45 90 01 01 c1 e0 02 89 45 90 01 01 50 6a 08 ff 75 90 01 01 ff 55 90 00 } //1
	condition:
