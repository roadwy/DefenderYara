...
rule TrojanDownloader_Win32_Upatre_H{
	...
	strings :
		$a_01_0 = {67 00 65 00 73 00 2f 00 68 00 74 00 6d 00 6c 00 2f 00 2a 00 78 00 65 00 } //01 00  ges/html/*xe
		$a_01_1 = {68 00 74 00 62 00 6b 00 67 00 72 00 6e 00 64 00 } //01 00  htbkgrnd
