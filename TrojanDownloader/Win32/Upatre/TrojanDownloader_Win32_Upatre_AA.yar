...
rule TrojanDownloader_Win32_Upatre_AA{
	...
	strings :
		$a_03_0 = {89 7c 24 2c 80 90 01 01 4d 75 90 01 01 80 90 01 01 01 5a 0f 84 90 01 04 8b 44 24 10 8b 14 90 01 05 33 c0 8b cf 40 c1 e9 02 3b c8 76 90 01 01 31 90 01 02 40 90 00 } //10
		...
		$a_03_4 = {8b 00 66 3d 4d 5a 0f 84 90 01 04 8b 45 b4 c1 e0 02 89 45 a8 90 00 } //10
		$a_03_5 = {8b 07 66 3d 4d 5a 74 90 01 01 8b 45 88 8b c8 8b 95 90 01 04 c1 e0 02 03 d0 8b 02 90 00 } //10
		$a_01_6 = {80 3b 4d 8b f8 75 12 80 7b 01 5a 75 0c ff 75 fc 53 57 e8 } //10
		$a_03_7 = {89 74 24 20 80 90 01 01 5a 0f 85 90 01 04 80 90 01 01 01 5a 0f 85 90 01 04 80 90 01 01 02 50 0f 85 90 01 04 80 90 01 01 03 00 0f 85 90 01 04 8b 54 24 28 33 c0 8b 14 90 01 05 8b ce c1 e9 02 40 3b c8 76 08 31 90 01 02 40 90 00 } //10
