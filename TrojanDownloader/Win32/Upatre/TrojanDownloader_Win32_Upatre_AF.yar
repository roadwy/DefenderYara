...
rule TrojanDownloader_Win32_Upatre_AF{
	...
	strings :
		...
		$a_03_7 = {57 ab 33 c0 ab e2 fd 8b 7d 90 01 01 57 ab ab ab ab 8b f8 90 00 } //1
		...
		$a_03_11 = {57 ab ab ab ab b8 90 01 04 57 ab 33 c0 ab e2 fd 90 00 } //2
		$a_03_12 = {b8 52 74 6c 44 89 06 56 ff 75 90 01 01 ff 55 90 01 01 50 b8 21 21 21 21 89 06 90 00 } //2
