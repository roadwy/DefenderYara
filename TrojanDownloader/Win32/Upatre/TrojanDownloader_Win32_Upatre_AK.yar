...
rule TrojanDownloader_Win32_Upatre_AK{
	...
	strings :
		...
		$a_03_2 = {66 81 3f 4d 5a 74 90 01 01 8b 90 01 01 ec 8b 55 c4 90 02 0a 3c 05 77 90 00 } //1
		$a_01_3 = {a5 66 ad ab e2 fa 5b 33 c0 b4 04 50 } //1
		$a_03_4 = {8b 4c 03 04 66 81 c9 20 20 90 02 04 81 e9 65 6c 33 32 90 00 } //1
		$a_03_5 = {ac 3c 01 74 0f 84 c0 74 02 34 90 01 01 66 ab 41 84 c0 75 ee 90 00 } //1
