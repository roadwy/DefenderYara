...
rule TrojanDownloader_Win32_Upatre_D{
	...
	strings :
		$a_01_0 = {00 55 70 64 61 74 65 73 20 64 6f 77 6e 6c 6f 61 64 65 72 00 } //05 00  唀摰瑡獥搠睯汮慯敤r
...
rule TrojanDownloader_Win32_Upatre_D_2{
	...
	strings :
		...
		$a_00_1 = {76 00 66 00 73 00 5c 00 73 00 6f 00 66 00 74 00 33 00 32 00 2e 00 64 00 6c 00 6c 00 } //01 00  vfs\soft32.dll
