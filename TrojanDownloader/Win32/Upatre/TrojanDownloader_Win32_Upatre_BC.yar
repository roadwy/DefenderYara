...
rule TrojanDownloader_Win32_Upatre_BC{
	...
	strings :
		...
		$a_00_10 = {00 74 65 78 74 2f 2a 00 } //01 00 
		$a_00_11 = {00 61 70 70 6c 69 63 61 74 69 6f 6e 2f 2a 00 } //01 00 
		$a_00_12 = {63 68 65 63 6b 69 70 2e 64 79 6e 64 6e 73 2e 6f 72 67 } //01 00 
		$a_00_13 = {72 74 6c 64 65 63 6f 6d 70 72 65 73 73 62 75 66 66 65 72 } //00 00 
	condition:
		any of ($a_*)
