...
rule TrojanDownloader_Win32_Upatre_BU{
	meta:
		description = "TrojanDownloader:Win32/Upatre.BU,SIGNATURE_TYPE_PEHSTR_EXT,03 00 03 00 04 00 00 02 00 "
		
	strings :
		$a_01_0 = {c7 00 63 61 74 73 05 04 00 00 00 c7 00 72 76 2e 64 05 04 00 00 00 c7 00 6c 6c 00 00 } //01 00 
