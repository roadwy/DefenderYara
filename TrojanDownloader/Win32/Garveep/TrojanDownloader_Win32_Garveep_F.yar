...
rule TrojanDownloader_Win32_Garveep_F{
	...
	strings :
		...
		$a_00_1 = {41 6e 74 69 53 70 79 57 61 72 65 32 47 75 61 72 64 2e 65 78 65 } //01 00  AntiSpyWare2Guard.exe
		$a_00_2 = {52 30 33 41 43 37 46 30 } //01 00  R03AC7F0
		$a_00_3 = {56 33 4c 53 76 63 2e 65 78 65 } //00 00  V3LSvc.exe
	condition:
		any of ($a_*)
