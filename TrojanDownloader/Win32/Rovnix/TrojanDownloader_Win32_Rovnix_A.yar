...
rule TrojanDownloader_Win32_Rovnix_A{
	...
	strings :
		...
		$a_00_1 = {5c 00 5c 00 2e 00 5c 00 70 00 69 00 70 00 65 00 5c 00 76 00 68 00 6f 00 73 00 74 00 25 00 75 00 } //01 00 
		$a_00_2 = {42 4f 4f 54 4b 49 54 5f 44 4c 4c 2e 64 6c 6c } //00 00 
	condition:
		any of ($a_*)
