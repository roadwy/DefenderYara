...
rule TrojanDownloader_Win32_Bizdup{
	...
	strings :
		...
		$a_01_4 = {54 68 69 72 64 53 6f 66 74 49 6e 66 6f 32 } //01 00  ThirdSoftInfo2
		$a_01_5 = {3f 53 6f 66 74 4e 61 6d 65 3d } //01 00  ?SoftName=
		$a_01_6 = {53 65 6e 64 53 6f 66 74 49 6e 66 6f 32 } //01 00  SendSoftInfo2
