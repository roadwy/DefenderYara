...
rule TrojanDownloader_Win32_Clagger_H{
	...
	strings :
		...
		$a_00_3 = {64 65 6c 20 63 3a 5c 31 2e 62 61 74 } //01 00  del c:\1.bat
		$a_00_4 = {3a 2a 3a 45 6e 61 62 6c 65 64 3a 7a 78 } //01 00  :*:Enabled:zx
		$a_00_5 = {72 3d 25 64 } //00 00  r=%d
	condition:
		any of ($a_*)
