...
rule TrojanDownloader_Win32_Clagger_H{
	...
	strings :
		$a_03_0 = {7e 27 8b 4d ec 0f be c0 8b 49 f8 2b c8 51 50 8d 4d ec e8 90 01 02 00 00 68 90 01 02 40 00 68 90 01 02 40 00 8d 4d ec e8 90 01 02 00 00 8d 90 01 01 ec 8d 4d e8 90 01 01 e8 90 01 02 00 00 68 00 00 00 04 90 00 } //3
		$a_03_1 = {99 6a 17 68 ff e7 76 48 52 50 e8 90 01 02 00 00 05 0f 27 00 00 90 00 } //3
