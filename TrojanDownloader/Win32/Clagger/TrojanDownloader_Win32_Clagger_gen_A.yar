...
rule TrojanDownloader_Win32_Clagger_gen_A{
	...
	strings :
		$a_00_0 = {54 5a 74 55 66 4e 5d 64 56 73 73 46 6f 75 44 70 6f 55 73 70 6d 54 66 75 5d 74 46 73 77 6a 44 66 54 5d 54 49 62 73 } //04 00 
		...
		$a_00_6 = {70 68 70 00 65 78 65 00 } //00 00 
	condition:
		any of ($a_*)
