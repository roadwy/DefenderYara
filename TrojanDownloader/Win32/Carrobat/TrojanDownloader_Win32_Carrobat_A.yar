...
rule TrojanDownloader_Win32_Carrobat_A{
	...
	strings :
		$a_00_0 = {43 3a 20 26 26 20 63 64 20 25 54 45 4d 50 25 20 26 26 20 63 5e 65 5e 72 5e 74 75 74 69 6c 20 2d 75 72 6c 63 61 5e 63 68 65 20 2d 73 70 6c } //01 00 
		...
		$a_00_2 = {26 26 20 31 2e 62 61 74 20 26 26 20 65 78 69 74 } //00 00 
	condition:
		any of ($a_*)
