...
rule TrojanDownloader_Win32_Carrobat_A{
	...
	strings :
		...
		$a_02_1 = {69 74 20 2d 66 20 68 74 74 70 90 02 02 3a 2f 2f 90 02 20 61 70 90 02 01 70 90 02 02 2e 63 6f 6d 90 02 10 2f 31 2e 74 78 74 20 26 26 20 72 65 6e 20 31 2e 74 78 74 20 31 2e 62 61 74 90 00 } //1
