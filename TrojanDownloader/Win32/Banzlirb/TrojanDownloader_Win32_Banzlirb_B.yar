...
rule TrojanDownloader_Win32_Banzlirb_B{
	...
	strings :
		...
		$a_03_1 = {2e 7a 6c 69 62 90 02 20 2e 65 78 65 90 02 20 41 50 50 44 41 54 41 90 00 } //1
		$a_03_2 = {2e 7a 6c 69 62 90 02 20 2e 65 78 65 90 02 20 41 56 49 53 4f 90 00 } //1
	condition:
