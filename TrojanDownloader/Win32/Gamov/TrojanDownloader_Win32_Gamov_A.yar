...
rule TrojanDownloader_Win32_Gamov_A{
	...
	strings :
		$a_01_0 = {47 55 49 44 54 61 6f 00 } //01 00 
		...
		$a_01_2 = {4c 6f 76 65 33 36 30 3d 34 2a 39 30 2b 52 2b 69 6e 67 2a 33 36 30 } //01 00 
		$a_01_3 = {36 31 72 72 2e 63 6f 6d } //00 00 
	condition:
		any of ($a_*)
