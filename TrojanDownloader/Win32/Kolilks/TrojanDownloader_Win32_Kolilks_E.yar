...
rule TrojanDownloader_Win32_Kolilks_E{
	...
	strings :
		$a_01_0 = {2f 6b 69 6c 6c 73 2e 74 78 74 3f 74 } //02 00 
		...
		$a_01_3 = {2e 6c 6d 6f 6b 31 32 33 2e 63 6f 6d 2f } //01 00 
		$a_01_4 = {62 61 69 64 75 61 73 70 2e 77 65 62 31 39 34 2e 64 6e 73 39 31 31 2e 63 6e 2f } //01 00 
		$a_01_5 = {2f 31 32 32 2e 32 32 34 2e 39 2e 31 35 31 2f } //00 00 
