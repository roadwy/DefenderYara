...
rule TrojanDownloader_Win32_Kolilks_B{
	...
	strings :
		...
		$a_03_1 = {6a 7c 8d 4d 90 01 01 89 5d 90 01 01 e8 90 01 04 83 c6 04 ff 4d f0 8b d8 75 b6 90 00 } //1
		$a_03_2 = {68 bb 01 00 00 50 8d 4d 90 01 01 e8 90 01 04 8b d8 f7 db 1a db 8d 4d fc fe c3 e8 90 01 04 84 db 75 90 00 } //1
	condition:
