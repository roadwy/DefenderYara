...
rule TrojanDownloader_Win32_Dogrobot_B{
	...
	strings :
		...
		$a_01_1 = {72 75 62 62 69 73 68 5c 64 6e 6c 6f 61 65 72 63 5c 52 65 6c 65 61 73 65 5c 64 6e 6c 6f 61 64 65 72 63 2e 70 64 62 } //00 00  rubbish\dnloaerc\Release\dnloaderc.pdb
	condition:
		any of ($a_*)
