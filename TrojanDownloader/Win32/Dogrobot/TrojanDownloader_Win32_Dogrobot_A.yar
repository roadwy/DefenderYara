...
rule TrojanDownloader_Win32_Dogrobot_A{
	...
	strings :
		...
		$a_03_2 = {6a 01 68 99 03 00 00 90 17 07 01 01 01 01 01 01 04 50 51 52 53 56 57 68 90 01 04 6a 01 e8 90 01 02 00 00 83 c4 90 01 01 68 f4 01 00 00 ff 15 90 01 04 90 02 10 6a 05 90 00 } //4
		...
		$a_02_8 = {4d 79 45 6e 74 72 79 50 6f 69 6e 74 90 02 05 6c 70 6b 2e 64 6c 6c 90 00 } //1
