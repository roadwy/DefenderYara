...
rule TrojanDownloader_Win32_Dogrobot_A{
	...
	strings :
		...
		$a_00_3 = {5c 64 6f 77 6e 2e 73 79 73 } //01 00 
		$a_00_4 = {25 30 32 58 2d 25 30 32 58 2d 25 30 32 58 2d 25 30 32 58 2d 25 30 32 58 2d 25 30 32 58 } //01 00 
		$a_00_5 = {5c 64 72 69 76 65 72 73 5c 65 74 63 5c 68 6f 73 74 73 } //01 00 
		$a_00_6 = {49 45 50 72 6f 74 41 63 63 65 73 73 } //01 00 
		$a_00_7 = {3f 78 3d 00 26 79 3d 00 47 4f 4f 47 4c 45 } //01 00 
		$a_02_8 = {4d 79 45 6e 74 72 79 50 6f 69 6e 74 90 02 05 6c 70 6b 2e 64 6c 6c 90 00 } //01 00 
		$a_00_9 = {25 73 25 64 5f 72 65 73 2e 74 6d 70 } //01 00 
		$a_01_10 = {6b 61 6b 61 } //00 00 
	condition:
		any of ($a_*)
