...
rule TrojanDownloader_Win32_Adload_A{
	...
	strings :
		...
		$a_02_2 = {53 55 57 6a 00 6a 00 6a 00 6a 00 68 90 01 03 00 bd 01 00 00 00 ff 15 90 01 03 00 8b d8 85 db 89 5c 24 14 0f 90 01 02 00 00 00 8b 84 24 2c 04 00 00 6a 00 68 00 01 00 84 6a 00 6a 00 50 53 ff 15 90 01 03 00 90 00 } //1
		$a_02_3 = {53 55 6a 00 6a 00 6a 00 6a 00 68 90 01 03 00 bd 01 00 00 00 ff 15 90 01 03 00 8b d8 85 db 89 5c 24 0c 0f 90 01 02 00 00 00 8b 84 24 14 04 00 00 57 6a 00 68 00 01 00 84 6a 00 6a 00 50 53 ff 15 90 01 03 00 90 00 } //1
	condition:
