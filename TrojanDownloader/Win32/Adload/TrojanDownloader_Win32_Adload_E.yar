...
rule TrojanDownloader_Win32_Adload_E{
	...
	strings :
		$a_01_0 = {64 6f 77 6e 2e 78 69 61 6c 64 2e 63 6f 6d } //01 00 
		$a_01_1 = {64 6f 77 6e 63 64 6e 2e 78 69 61 6c 64 2e 63 6f 6d } //01 00 
		$a_01_2 = {74 6a 76 31 2e 78 69 61 6c 64 2e 63 6f 6d } //01 00 
