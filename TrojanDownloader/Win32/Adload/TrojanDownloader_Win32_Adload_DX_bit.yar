...
rule TrojanDownloader_Win32_Adload_DX_bit{
	...
	strings :
		...
		$a_01_1 = {7b 74 6d 70 7d 5c 4a 61 77 5a 69 67 61 2e 65 78 65 } //01 00  {tmp}\JawZiga.exe
		$a_01_2 = {00 2e 63 6f 6e 66 69 67 } //00 00  ⸀潣普杩
	condition:
		any of ($a_*)
...
rule TrojanDownloader_Win32_Adload_DX_bit_2{
	...
	strings :
		$a_01_0 = {67 6f 6c 64 2e 70 6f 77 65 72 73 74 72 69 6e 67 2e 62 69 64 2f 73 74 61 74 73 2e 70 68 70 3f 62 75 3d } //01 00  gold.powerstring.bid/stats.php?bu=
