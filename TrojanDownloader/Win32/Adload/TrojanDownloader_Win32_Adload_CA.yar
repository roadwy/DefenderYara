...
rule TrojanDownloader_Win32_Adload_CA{
	...
	strings :
		$a_01_0 = {26 73 6f 63 6b 3d 31 } //01 00  &sock=1
		$a_01_1 = {73 69 64 65 62 61 72 5f 63 6c 69 63 6b 2e 61 73 70 } //01 00  sidebar_click.asp
		$a_01_2 = {2f 73 40 69 64 40 65 62 61 40 72 2e 61 40 73 24 70 3f 62 40 6e 3d 24 30 26 71 24 79 3d } //01 00  /s@id@eba@r.a@s$p?b@n=$0&q$y=
