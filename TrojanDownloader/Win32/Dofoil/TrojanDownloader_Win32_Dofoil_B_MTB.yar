...
rule TrojanDownloader_Win32_Dofoil_B_MTB{
	...
	strings :
		...
		$a_00_2 = {5c 64 72 69 76 65 72 73 5c 74 63 70 69 70 2e 73 79 73 } //01 00  \drivers\tcpip.sys
		$a_00_3 = {64 72 69 76 65 72 73 5c 62 65 65 70 2e 73 79 73 } //01 00  drivers\beep.sys
		$a_00_4 = {64 75 6d 70 5f 64 75 6d 70 66 76 65 2e 73 79 73 } //00 00  dump_dumpfve.sys
	condition:
		any of ($a_*)
