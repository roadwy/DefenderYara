...
rule TrojanDownloader_Win32_Dofoil_AG_bit{
	...
	strings :
		$a_03_0 = {eb 07 8b 45 90 01 01 40 89 45 90 01 01 8b 85 90 01 01 ff ff ff 8b 84 85 90 01 02 ff ff 8b 4d 90 01 01 0f be 04 08 0f b6 4d 90 01 01 33 c1 8b 4d 90 01 01 03 4d 90 01 01 88 01 8b 45 90 01 01 03 45 90 01 01 0f be 00 85 c0 75 02 eb 02 eb c6 90 00 } //1
