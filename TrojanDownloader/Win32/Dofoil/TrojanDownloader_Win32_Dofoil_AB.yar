...
rule TrojanDownloader_Win32_Dofoil_AB{
	...
	strings :
		$a_03_0 = {40 1a cd 00 0f 84 90 01 02 00 00 81 7d 90 01 01 46 46 14 70 90 00 } //1
		$a_03_1 = {3d 40 44 1e 42 74 90 01 01 3d 44 47 19 44 90 00 } //1
		$a_03_2 = {3c 69 0f 84 90 01 02 00 00 3c 72 0f 84 90 01 02 00 00 3c 75 74 90 00 } //1
		$a_01_3 = {c6 44 24 32 e9 51 b8 90 90 00 00 8d 4c 24 34 66 89 44 24 34 } //2
		$a_03_4 = {c6 04 48 2f b9 00 01 80 00 83 7c 24 90 01 01 02 b8 00 01 00 00 0f 44 c1 50 6a 00 6a 00 6a 00 ff 74 24 90 01 01 56 53 ff 15 90 01 04 8b f0 85 f6 0f 84 90 01 02 00 00 83 7c 24 90 01 01 02 75 90 01 01 6a 04 8d 44 24 90 01 01 c7 44 24 90 01 01 00 33 00 00 90 00 } //2
		$a_03_5 = {44 3a 50 00 90 09 03 00 c7 45 90 00 } //1
		$a_03_6 = {25 73 5c 25 90 09 04 00 c7 44 24 90 00 } //1
		$a_03_7 = {68 74 74 70 90 09 04 00 c7 44 24 90 00 } //1
		$a_03_8 = {25 30 32 58 90 09 03 00 c7 45 90 00 } //1
		$a_03_9 = {2e 62 69 74 90 09 03 00 c7 45 90 00 } //1
	condition:
