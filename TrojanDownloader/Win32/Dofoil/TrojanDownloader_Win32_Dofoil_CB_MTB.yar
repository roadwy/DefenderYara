...
rule TrojanDownloader_Win32_Dofoil_CB_MTB{
	...
	strings :
		$a_01_0 = {6f 74 65 77 69 6c 20 79 78 79 70 2e 64 6c 6c } //01 00 
		$a_01_1 = {65 73 6f 78 65 72 2e 64 6c 6c } //01 00 
		$a_01_2 = {79 70 65 7a 2e 64 6c 6c } //01 00 
		$a_01_3 = {75 67 65 6b 65 63 2e 64 6c 6c } //01 00 
