...
rule TrojanDownloader_Win32_Dofoil_AI_bit{
	...
	strings :
		...
		$a_03_2 = {8a d1 0f b6 94 15 90 01 04 8b f3 81 e6 ff 00 00 00 0f b6 b4 35 90 01 04 03 d6 81 e2 ff 00 00 00 32 84 15 90 01 04 8b 55 90 01 01 8b 75 90 01 01 88 04 32 90 00 } //2
