...
rule TrojanDownloader_Win32_Adclick{
	...
	strings :
		$a_01_0 = {6d 69 63 72 6f 73 6f 66 74 2e 6c 6f 67 69 6e 61 70 70 2e 63 6f 6d 2f 75 70 64 61 74 65 } //02 00  microsoft.loginapp.com/update
		...
		$a_01_2 = {25 25 57 49 4e 44 4f 57 53 5c 25 73 70 72 76 2e 69 6d 62 } //01 00  %%WINDOWS\%sprv.imb
		$a_01_3 = {25 41 46 46 49 4c 44 41 54 41 00 00 43 6c 69 63 6b 55 72 6c } //01 00 
		$a_01_4 = {00 63 6c 69 63 6b 63 79 63 6c 65 00 } //00 00  挀楬正祣汣e
	condition:
		any of ($a_*)
