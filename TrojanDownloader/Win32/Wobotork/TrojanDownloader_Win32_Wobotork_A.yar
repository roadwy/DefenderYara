...
rule TrojanDownloader_Win32_Wobotork_A{
	...
	strings :
		...
		$a_01_1 = {53 65 74 20 6f 53 68 65 6c 6c 20 3d 20 57 53 63 72 69 70 74 2e 43 72 65 61 74 65 4f 62 6a 65 63 74 28 22 57 53 63 72 69 70 74 2e 53 68 65 6c 6c 22 29 3a 6f 53 68 65 6c 6c 2e 45 78 65 63 28 } //00 00 
	condition:
		any of ($a_*)
