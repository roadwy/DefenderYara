...
rule TrojanDownloader_Win32_Losabel_H{
	...
	strings :
		$a_03_0 = {68 40 77 1b 00 6a 00 6a 00 e8 ?? ?? ff ff e8 ?? ?? ff ff 68 e8 03 00 00 e8 } //1
		$a_03_1 = {6a 00 ff 16 85 c0 68 c8 00 00 00 e8 ?? ?? ff ff 6a 00 6a 00 6a 00 68 ?? ?? 40 00 68 ?? ?? 40 00 6a 00 ff 13 6a 00 } //1
