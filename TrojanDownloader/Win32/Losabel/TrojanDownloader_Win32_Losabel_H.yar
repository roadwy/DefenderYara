...
rule TrojanDownloader_Win32_Losabel_H{
	...
	strings :
		...
		$a_00_2 = {76 69 73 74 61 41 2e 65 78 65 } //01 00 
		$a_00_3 = {4c 6f 76 65 48 65 62 65 } //01 00 
		$a_00_4 = {72 61 76 6d 6f 6e 64 2e 65 78 65 } //01 00 
		$a_00_5 = {33 36 30 53 61 66 65 2e 65 78 65 } //00 00 
	condition:
		any of ($a_*)
