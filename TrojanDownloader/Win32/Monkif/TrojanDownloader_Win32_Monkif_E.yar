...
rule TrojanDownloader_Win32_Monkif_E{
	...
	strings :
		...
		$a_01_2 = {47 6c 6f 62 61 6c 5c 55 49 45 49 00 } //01 00  汇扯污啜䕉I
		$a_01_3 = {54 3d 25 64 2c 53 3d 25 64 2c 25 73 2c 46 3d 25 73 2c 00 } //01 00 
		$a_01_4 = {53 6f 66 74 77 61 72 65 5c 43 6c 61 73 73 65 73 5c 50 52 4f 54 4f 43 4f 4c 53 5c 46 69 6c 74 65 72 5c 74 65 78 74 2f 68 74 6d 6c 00 } //01 00  潓瑦慷敲䍜慬獳獥停佒佔佃卌䙜汩整屲整瑸栯浴l
		$a_01_5 = {25 64 7c 25 64 7c 25 64 7c 25 64 00 } //01 00  搥╼籤搥╼d
