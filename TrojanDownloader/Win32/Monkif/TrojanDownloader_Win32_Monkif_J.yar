...
rule TrojanDownloader_Win32_Monkif_J{
	...
	strings :
		$a_00_0 = {75 72 6f 6d 6f 6e 2e 64 6c 6c } //0a 00  uromon.dll
		$a_10_1 = {31 36 33 38 30 31 } //0a 00  163801
		$a_00_2 = {25 75 7c 00 48 54 54 50 2f 31 2e 30 00 } //0a 00 
		$a_00_3 = {49 6e 74 65 72 6e 65 74 52 65 61 64 46 69 6c 65 } //01 00  InternetReadFile
