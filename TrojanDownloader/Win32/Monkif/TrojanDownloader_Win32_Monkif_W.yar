...
rule TrojanDownloader_Win32_Monkif_W{
	...
	strings :
		$a_03_0 = {4b 0f b6 04 19 90 03 02 02 2a c2 28 d0 90 02 06 88 04 19 90 03 01 02 49 ff c9 75 90 00 } //2
		$a_03_1 = {48 74 74 33 90 02 03 c7 85 90 01 04 53 65 6e 64 90 00 } //2
		...
		$a_02_5 = {25 63 25 73 25 63 25 73 90 02 05 70 68 6f 74 6f 2f 90 02 05 2e 70 68 70 90 00 } //2
	condition:
