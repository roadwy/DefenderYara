...
rule TrojanDownloader_Win32_Monkif_S{
	...
	strings :
		...
		$a_01_1 = {71 71 25 73 25 73 2e 00 } //01 00 
		$a_01_2 = {53 6f 66 74 77 61 72 65 5c 43 6c 61 73 73 65 73 5c 50 52 4f 50 4f 43 4f 4c 53 5c 46 69 6c 74 65 72 5c 74 65 78 74 2f 68 74 6d 6c 00 } //01 00 
