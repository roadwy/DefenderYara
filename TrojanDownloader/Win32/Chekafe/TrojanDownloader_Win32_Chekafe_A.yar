...
rule TrojanDownloader_Win32_Chekafe_A{
	...
	strings :
		$a_01_0 = {26 6c 6f 63 6b 63 6f 64 65 3d 25 64 26 6d 61 63 3d 25 73 00 } //01 00  氦捯捫摯㵥搥洦捡┽s
		$a_00_1 = {25 73 3f 69 64 3d 25 73 26 69 73 57 61 6e 67 42 61 72 3d 31 00 } //01 00 
		$a_00_2 = {26 50 63 54 79 70 65 3d 57 61 6e 67 62 61 72 50 63 26 } //01 00  &PcType=WangbarPc&
