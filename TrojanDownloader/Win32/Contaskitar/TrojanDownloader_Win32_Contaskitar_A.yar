...
rule TrojanDownloader_Win32_Contaskitar_A{
	...
	strings :
		$a_03_0 = {2e 73 6b 69 70 70 65 64 69 61 2e 6e 65 74 2f 90 02 04 30 32 31 34 64 2f 73 74 61 72 74 32 6d 65 2e 65 78 65 90 00 } //8
		...
		$a_03_8 = {77 77 77 2e 73 6b 69 70 70 65 64 69 61 2e 6e 65 74 2f 31 90 01 01 30 32 31 34 64 2f 31 90 01 01 30 32 31 34 5f 90 02 04 2e 65 78 65 90 00 } //1
