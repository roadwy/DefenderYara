...
rule TrojanDownloader_Win32_Axent_A{
	...
	strings :
		...
		$a_01_1 = {43 72 65 61 7a 65 50 72 6f 63 65 73 73 41 } //5 CreazeProcessA
		$a_01_2 = {75 53 6c 6d 6f 6e 2e 64 6c 6c } //5 uSlmon.dll
		...
		$a_01_5 = {78 73 78 73 6d 78 61 78 2e 45 58 45 } //2 xsxsmxax.EXE
