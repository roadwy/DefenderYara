...
rule TrojanDownloader_Win32_Remetrac_A{
	...
	strings :
		$a_03_0 = {b8 72 00 00 00 e8 90 01 02 ff ff ff b5 90 01 02 ff ff 8d 95 90 01 02 ff ff b8 65 00 00 00 e8 90 01 02 ff ff ff b5 90 01 02 ff ff 8d 95 90 01 02 ff ff b8 63 00 00 00 90 00 } //1
