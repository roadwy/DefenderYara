...
rule TrojanDownloader_Win32_Anedl_A{
	...
	strings :
		...
		$a_03_1 = {80 7d fb 01 75 90 01 01 81 fb b8 0b 00 00 76 90 01 01 6a 01 6a 00 6a 00 90 00 } //1
		$a_03_2 = {68 e8 03 00 00 e8 90 01 04 6a 00 8d 45 90 01 01 e8 90 01 04 ff 75 90 1b 01 90 00 } //1
	condition:
