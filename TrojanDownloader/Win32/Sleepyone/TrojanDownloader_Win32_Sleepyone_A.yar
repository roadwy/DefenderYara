...
rule TrojanDownloader_Win32_Sleepyone_A{
	...
	strings :
		...
		$a_02_1 = {6a 00 6a 00 6a 00 8d 45 e4 b9 90 01 02 41 00 8b 15 90 01 02 41 00 e8 90 01 02 ff ff 8b 45 e4 e8 90 01 02 ff ff 50 68 90 01 02 41 00 6a 00 e8 90 00 } //1000
		...
		$a_02_3 = {8d 45 c4 ba 03 00 00 00 e8 90 01 02 ff ff 8b 45 c4 e8 90 01 02 ff ff 50 68 90 01 02 40 00 68 90 01 02 40 00 6a 00 e8 90 00 } //1000
		$a_02_4 = {77 69 6e 64 6f 77 73 90 01 01 73 65 72 76 69 63 65 73 2e 65 78 65 90 00 } //100
		$a_02_5 = {77 69 6e 64 6f 77 73 90 01 01 75 73 65 72 69 6e 69 74 2e 65 78 65 90 00 } //100
