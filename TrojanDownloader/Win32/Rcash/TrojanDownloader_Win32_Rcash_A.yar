...
rule TrojanDownloader_Win32_Rcash_A{
	...
	strings :
		...
		$a_01_1 = {72 2d 63 61 73 68 2e 63 6f 2e 6b 72 2f 75 70 64 61 74 65 2f 64 69 73 74 72 69 62 75 74 65 2f 72 63 61 73 68 76 32 } //01 00  r-cash.co.kr/update/distribute/rcashv2
		$a_01_2 = {52 43 61 73 68 44 61 74 61 2e 64 6c 6c } //01 00  RCashData.dll
