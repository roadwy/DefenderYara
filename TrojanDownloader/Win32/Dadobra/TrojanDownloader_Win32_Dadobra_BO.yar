...
rule TrojanDownloader_Win32_Dadobra_BO{
	...
	strings :
		...
		$a_01_1 = {53 43 50 4e 45 57 43 54 2e 42 49 4e } //01 00  SCPNEWCT.BIN
		$a_01_2 = {53 43 50 4e 45 55 52 4c 2e 42 49 4e } //01 00  SCPNEURL.BIN
		$a_01_3 = {53 43 50 4e 45 4c 4f 47 2e 42 49 4e } //00 00  SCPNELOG.BIN
	condition:
		any of ($a_*)
