...
rule TrojanDownloader_Win32_Dadobra_BN{
	...
	strings :
		...
		$a_01_1 = {53 65 74 74 69 6e 67 73 5c 7b 46 43 41 44 44 43 31 34 2d 42 44 34 36 2d 34 30 38 41 2d 39 38 34 32 2d 43 44 42 45 31 43 36 44 33 37 45 42 } //01 00  Settings\{FCADDC14-BD46-408A-9842-CDBE1C6D37EB
		$a_01_2 = {6d 73 61 70 70 2e 65 78 65 } //00 00  msapp.exe
	condition:
		any of ($a_*)
