...
rule TrojanDownloader_Win32_Dadobra_BM{
	...
	strings :
		$a_00_0 = {54 45 52 52 41 2e 43 4f 4d 2e 42 52 4c 32 33 55 4f 4c 2e 43 4f 4d 2e 42 52 44 46 39 30 4e 41 4f 56 41 49 50 45 47 41 52 36 59 41 48 4f 4f 2e 43 4f 4d 2e } //01 00  TERRA.COM.BRL23UOL.COM.BRDF90NAOVAIPEGAR6YAHOO.COM.
