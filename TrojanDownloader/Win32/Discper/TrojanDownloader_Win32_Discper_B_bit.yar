...
rule TrojanDownloader_Win32_Discper_B_bit{
	...
	strings :
		...
		$a_01_4 = {41 00 76 00 61 00 73 00 74 00 5c 00 64 00 65 00 66 00 73 00 5c 00 } //01 00  Avast\defs\
		$a_01_5 = {70 00 69 00 6e 00 67 00 20 00 6c 00 6f 00 63 00 61 00 6c 00 68 00 6f 00 73 00 74 00 20 00 2d 00 6e 00 20 00 34 00 20 00 26 00 20 00 64 00 65 00 6c 00 20 00 2f 00 46 00 20 00 2f 00 51 00 } //00 00  ping localhost -n 4 & del /F /Q
	condition:
		any of ($a_*)
