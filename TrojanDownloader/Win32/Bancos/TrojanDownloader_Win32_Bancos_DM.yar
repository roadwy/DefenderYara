...
rule TrojanDownloader_Win32_Bancos_DM{
	...
	strings :
		$a_03_0 = {6a 00 6a 00 8d 85 f6 f7 ff ff 50 8d 85 f7 fb ff ff 50 6a 00 6a 00 e8 90 01 04 33 c0 5a 59 59 64 89 10 68 90 01 04 8d 45 f8 ba 02 00 00 00 e8 90 00 } //1
