...
rule TrojanDownloader_Win32_Bancos_FC{
	...
	strings :
		...
		$a_02_4 = {77 00 2e 00 66 00 75 00 6e 00 6f 00 72 00 70 00 2e 00 63 00 6f 00 6d 00 2e 00 62 00 72 00 2f 00 66 00 6f 00 74 00 6f 00 73 00 2f 00 90 02 18 2e 00 6a 00 70 00 67 00 90 00 } //1
	condition:
