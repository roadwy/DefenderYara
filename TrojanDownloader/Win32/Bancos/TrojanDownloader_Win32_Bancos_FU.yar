...
rule TrojanDownloader_Win32_Bancos_FU{
	...
	strings :
		$a_01_0 = {74 69 74 75 6c 6f 3d } //01 00  titulo=
		$a_01_1 = {74 65 78 74 6f 3d } //01 00  texto=
		$a_01_2 = {41 43 37 39 42 32 34 37 44 44 35 41 41 45 37 42 38 30 } //05 00  AC79B247DD5AAE7B80
		$a_01_3 = {70 72 61 71 75 65 6d 3d } //0a 00  praquem=
