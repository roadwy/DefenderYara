...
rule TrojanDownloader_Win32_Bancos_BD{
	...
	strings :
		...
		$a_03_2 = {c7 45 b8 44 00 00 00 c7 45 e4 01 00 00 00 66 c7 45 e8 00 00 8d 45 a8 50 8d 45 b8 50 6a 00 6a 00 68 90 90 00 00 00 6a 00 6a 00 6a 00 8b 45 fc e8 ?? ?? ?? ?? 50 6a 00 e8 ?? ?? ?? ?? 83 f8 01 } //1
		$a_03_3 = {0f b6 44 30 ff 33 d8 8d 45 d0 50 89 5d d4 c6 45 d8 00 8d 55 d4 33 c9 b8 ?? ?? ?? ?? e8 ?? ?? ?? ?? 8b 55 d0 8d 45 ec e8 ?? ?? ?? ?? 8b fb ff 45 e8 ff 4d e0 75 a3 } //1
	condition:
