...
rule TrojanDownloader_Win32_Bancos_FS{
	...
	strings :
		$a_03_0 = {75 00 6f 00 6c 00 2e 00 63 00 6f 00 6d 00 2e 00 62 00 72 00 2f 00 90 02 10 2e 00 6a 00 70 00 67 00 90 00 } //1
		$a_03_1 = {43 3a 5c 50 72 6f 67 72 61 6d 44 61 74 61 5c 61 74 6c 73 79 73 90 01 01 2e 65 78 65 90 00 } //1
