...
rule TrojanDownloader_Win32_Bancos_BY{
	...
	strings :
		$a_01_0 = {66 65 72 69 61 73 63 61 6e 63 75 6e 2e 68 70 67 2e 63 6f 6d 2e 62 72 2f 74 75 74 6f 2e 68 74 6d 6c } //01 00 
		$a_01_1 = {61 74 74 72 69 62 20 2b 72 20 2b 73 20 2b 68 20 43 3a 5c 73 76 63 68 6f 73 74 2e 65 78 65 } //01 00 
