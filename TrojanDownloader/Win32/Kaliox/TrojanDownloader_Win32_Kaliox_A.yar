...
rule TrojanDownloader_Win32_Kaliox_A{
	...
	strings :
		$a_03_0 = {68 00 00 00 a0 6a ff 68 44 61 00 10 52 ff 15 90 01 04 8b 15 90 01 04 8d 44 24 90 01 01 6a 04 50 6a 06 52 c7 44 24 90 01 01 00 5c 26 05 ff d6 90 00 } //2
