...
rule TrojanDownloader_Win32_Frethog_E{
	...
	strings :
		...
		$a_03_2 = {68 00 74 00 74 00 70 00 3a 00 2f 00 2f 00 77 00 77 00 77 00 2e 90 02 20 2e 00 6e 00 65 00 74 00 2f 00 66 00 69 00 6c 00 65 00 2e 00 74 00 78 00 74 90 00 } //1
	condition:
