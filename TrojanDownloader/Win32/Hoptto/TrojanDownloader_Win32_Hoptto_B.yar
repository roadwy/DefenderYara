...
rule TrojanDownloader_Win32_Hoptto_B{
	...
	strings :
		$a_01_0 = {31 34 32 2e 30 2e 33 36 2e 33 34 2f } //64 00  142.0.36.34/
		$a_01_1 = {6d 69 6e 65 72 2e 64 6c 6c } //64 00  miner.dll
		$a_01_2 = {75 73 66 74 5f 65 78 74 2e 74 78 74 } //c8 00  usft_ext.txt
		...
		$a_01_4 = {2f 6d 61 69 6e 2e 74 78 74 } //0a 00  /main.txt
		$a_01_5 = {70 68 61 74 6b 2e 74 78 74 } //64 00  phatk.txt
		$a_01_6 = {2f 33 37 2e 32 32 31 2e 31 36 30 2e 35 36 2f } //00 00  /37.221.160.56/
