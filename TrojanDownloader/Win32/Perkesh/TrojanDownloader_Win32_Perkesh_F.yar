...
rule TrojanDownloader_Win32_Perkesh_F{
	...
	strings :
		$a_03_0 = {74 35 55 bd 90 01 04 6a 01 e8 90 01 04 6a 00 55 55 6a ff e8 90 01 04 8a c3 b1 90 01 01 2c 90 01 01 8b fe f6 e9 00 04 33 90 00 } //2
		$a_03_1 = {68 78 e6 00 00 e8 90 01 04 46 3b 35 90 01 04 7c ed eb 10 6a 1e 90 00 } //2
