...
rule TrojanDownloader_Win32_Perkesh_E{
	...
	strings :
		$a_03_0 = {51 56 56 6a 0b ff d0 3b c6 0f 84 90 01 04 3d 04 00 00 c0 90 00 } //5
		$a_03_1 = {6a 00 6a 40 ff 15 90 01 04 85 c0 89 45 fc 74 1f 6a 01 6a 00 8d 4d fc 68 ff 0f 1f 00 51 6a ff 50 6a ff ff d7 6a 00 ff 75 fc ff 15 90 00 } //5
