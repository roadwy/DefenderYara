...
rule TrojanDownloader_Win32_Nymaim_B{
	...
	strings :
		$a_03_0 = {c7 45 e6 11 11 11 11 90 02 20 8d 9d fc fc ff ff 90 00 } //10
		$a_03_1 = {c7 03 66 69 6c 65 90 02 20 c7 43 04 6e 61 6d 65 90 02 20 c6 43 08 3d 90 00 } //1
		$a_03_2 = {c7 03 26 64 61 74 90 02 20 66 c7 43 04 61 3d 90 00 } //1
