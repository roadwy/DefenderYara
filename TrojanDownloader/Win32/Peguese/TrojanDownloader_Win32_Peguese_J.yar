...
rule TrojanDownloader_Win32_Peguese_J{
	...
	strings :
		...
		$a_01_2 = {0c 74 6d 72 42 6c 6f 71 54 69 6d 65 72 12 } //05 00  琌牭求煯楔敭ቲ
		$a_01_3 = {0a 74 6d 72 46 32 54 69 6d 65 72 11 } //05 00  琊牭㉆楔敭ᅲ
		$a_01_4 = {0b 74 6d 72 45 73 63 54 69 6d 65 72 } //01 00  琋牭獅呣浩牥
