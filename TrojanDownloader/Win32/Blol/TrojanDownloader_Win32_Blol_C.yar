...
rule TrojanDownloader_Win32_Blol_C{
	...
	strings :
		$a_03_0 = {68 b8 0b 00 00 e8 90 01 02 00 00 6a 00 ff 75 ec e8 90 01 02 00 00 68 85 00 00 00 68 90 01 02 40 00 e8 90 01 02 00 00 90 00 } //2
		$a_03_1 = {74 07 6a 00 e8 90 01 02 00 00 6a 90 01 01 68 90 01 02 40 00 6a ff 6a ff e8 90 01 02 ff ff 50 6a 18 68 90 01 02 40 00 c7 45 a4 00 00 00 00 c7 45 a8 00 00 00 00 c7 45 ac 00 00 00 00 90 00 } //2
		...
		$a_03_5 = {63 6d 64 2e 65 78 65 20 2f 63 20 72 65 6e 20 5c 53 79 73 74 65 6d 33 32 5c 68 61 68 61 68 61 90 02 05 6a 75 6d 70 65 72 72 2e 65 78 65 90 00 } //2
	condition:
