...
rule TrojanDownloader_Win32_Bledox_B{
	...
	strings :
		...
		$a_01_1 = {74 72 75 70 64 00 } //01 00  牴灵d
		$a_01_2 = {2d 2d 46 61 73 63 69 73 74 46 69 72 65 77 61 6c 6c 20 31 } //01 00  --FascistFirewall 1
		$a_01_3 = {5c 63 66 5f 2e 62 69 6e } //00 00  \cf_.bin
