...
rule TrojanDownloader_Win32_Tracur_AH{
	...
	strings :
		$a_00_0 = {73 72 66 69 76 76 65 75 65 6c 75 62 2e 64 6c 6c } //01 00  srfivveuelub.dll
		$a_00_1 = {68 74 74 70 3a 2f 2f 32 31 33 2e 31 37 34 2e 31 34 31 2e 31 31 2f 78 6d 6c 3f 61 3d } //01 00  http://213.174.141.11/xml?a=
