...
rule TrojanDownloader_Win32_Vividi_A{
	...
	strings :
		$a_02_0 = {4e 8b 45 dc 80 7c 30 ff 2f 75 90 01 01 8d 85 48 fe ff ff 50 68 01 01 00 00 e8 90 01 04 6a 00 6a 01 6a 02 e8 90 01 04 8b f0 66 c7 85 38 fe ff ff 02 00 83 ff 01 7c 90 01 01 81 ff ff ff 00 00 7e 90 01 01 bf 50 00 00 00 90 00 } //3
		$a_02_1 = {2e 69 6e 66 6f 2f 90 01 01 2e 65 78 65 90 00 } //1
