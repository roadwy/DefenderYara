...
rule TrojanDownloader_Win32_Vividi_A{
	...
	strings :
		...
		$a_00_2 = {43 3a 5c 54 45 4d 50 5c 31 2e 65 78 65 } //01 00  C:\TEMP\1.exe
		$a_00_3 = {31 32 30 2e 31 32 35 2e 32 30 31 2e 31 30 31 } //01 00  120.125.201.101
		$a_00_4 = {47 45 54 20 2f 31 2e 65 78 65 20 48 54 54 50 2f 31 2e 31 } //01 00  GET /1.exe HTTP/1.1
		$a_00_5 = {41 63 63 65 70 74 2d 4c 61 6e 67 75 61 67 65 3a 20 65 6e 2d 75 73 3b 71 3d 30 2e 35 } //00 00  Accept-Language: en-us;q=0.5
	condition:
		any of ($a_*)
