...
rule TrojanDownloader_Win32_Nonaco_B{
	...
	strings :
		...
		$a_03_2 = {2f 3f 6e 61 6d 65 3d 25 73 00 90 02 04 25 73 5c 25 90 00 } //1
		$a_01_3 = {54 69 6d 65 00 00 00 00 54 6f 46 65 65 64 00 00 79 65 73 00 4b 69 6c 6c 00 00 00 00 25 30 32 58 } //1
		$a_02_4 = {6a 06 99 59 f7 f9 8b da e8 90 01 02 00 00 99 b9 8c 00 00 00 f7 f9 8b f2 46 90 00 } //1
	condition:
