...
rule TrojanDownloader_Win32_Nonaco_J{
	...
	strings :
		...
		$a_01_2 = {49 6e 76 6f 6b 65 20 64 69 73 70 69 64 20 3d 20 25 64 } //01 00  Invoke dispid = %d
		$a_01_3 = {67 67 67 67 2e 44 4c 4c 00 44 6c 6c 43 61 6e 55 6e 6c 6f 61 64 4e 6f 77 00 } //01 00 
		$a_01_4 = {6d 61 69 6e 66 65 65 64 74 68 65 72 65 2e 63 6f 6d } //00 00  mainfeedthere.com
	condition:
		any of ($a_*)
