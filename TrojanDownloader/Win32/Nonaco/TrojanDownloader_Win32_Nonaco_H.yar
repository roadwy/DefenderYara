...
rule TrojanDownloader_Win32_Nonaco_H{
	...
	strings :
		$a_03_0 = {6a 03 5f 8d 8c 05 90 01 02 ff ff 99 f7 ff 28 11 ff 45 90 09 05 00 73 12 8b 45 90 00 } //2
		$a_03_1 = {8d 55 e6 8b c1 8b f7 8b fa c6 45 90 01 01 75 c1 e9 02 c6 45 90 01 01 72 c6 45 90 01 01 6c c6 45 90 01 01 63 90 00 } //2
		$a_03_2 = {74 04 6a 01 eb 19 8d 85 00 fc ff ff 68 90 01 04 50 e8 90 01 02 ff ff 59 84 c0 59 74 05 6a 02 58 eb 03 90 00 } //2
