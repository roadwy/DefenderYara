...
rule TrojanDownloader_Win32_Nonaco_H{
	...
	strings :
		...
		$a_01_3 = {70 69 64 3d 25 73 26 73 3d 25 73 26 76 3d 25 73 26 75 73 65 72 3d 25 73 } //01 00  pid=%s&s=%s&v=%s&user=%s
		$a_01_4 = {49 6e 76 6f 6b 65 20 64 69 73 70 69 64 20 3d 20 25 64 } //01 00  Invoke dispid = %d
