...
rule TrojanDownloader_Win32_Aentdwn_B_bit{
	...
	strings :
		$a_03_0 = {31 00 36 00 35 00 2e 00 32 00 32 00 37 00 2e 00 31 00 35 00 33 00 2e 00 31 00 38 00 31 00 2f 00 90 02 2f 75 00 70 00 64 00 61 00 74 00 65 00 90 00 } //1
