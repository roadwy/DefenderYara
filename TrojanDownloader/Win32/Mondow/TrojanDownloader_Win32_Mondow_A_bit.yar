...
rule TrojanDownloader_Win32_Mondow_A_bit{
	...
	strings :
		...
		$a_01_4 = {72 65 67 20 61 64 64 20 22 48 4b 45 59 5f 43 55 52 52 45 4e 54 5f 55 53 45 52 5c 53 6f 66 74 77 61 72 65 5c 4d 69 63 72 6f 73 6f 66 74 5c 57 69 6e 64 6f 77 73 5c 43 75 72 72 65 6e 74 56 65 72 73 69 6f 6e 5c 52 75 6e 22 } //00 00  reg add "HKEY_CURRENT_USER\Software\Microsoft\Windows\CurrentVersion\Run"
	condition:
		any of ($a_*)
