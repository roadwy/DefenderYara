...
rule TrojanDownloader_Win32_Swity_C{
	...
	strings :
		...
		$a_03_2 = {89 45 dc 8d 4d c4 51 8d 55 c8 52 6a 02 90 09 27 00 8d 4d c8 ff 15 90 01 04 50 68 90 01 04 ff 15 90 01 04 8b d0 8d 4d c4 ff 15 90 01 04 50 ff 15 90 00 } //1
		$a_03_3 = {e9 03 02 00 00 8b 55 0c 8d 4e 58 8b 02 50 51 ff 15 90 01 04 8b 17 68 90 01 04 52 ff 15 90 00 } //1
	condition:
