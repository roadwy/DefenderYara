...
rule TrojanDownloader_Win32_Horst_J{
	...
	strings :
		...
		$a_02_6 = {8b 54 24 10 52 ff 15 90 01 04 83 f8 ff 75 18 b8 07 00 00 00 8b 8c 24 3c 03 00 00 e8 90 01 04 5f 5e 5b 8b e5 5d c3 8b 35 90 01 04 ff d6 8b 45 10 85 c0 74 0d 8b 44 24 10 6a ff 50 ff 15 90 01 04 ff d6 8b 8c 24 3c 03 00 00 33 c0 e8 90 01 04 5f 5e 5b 8b e5 5d c3 90 00 } //1
	condition:
