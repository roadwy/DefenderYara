...
rule TrojanDownloader_Win32_Horst_L{
	...
	strings :
		$a_00_0 = {4f 70 65 6e 53 43 4d 61 6e 61 67 65 72 41 } //01 00  OpenSCManagerA
		$a_01_1 = {53 74 61 72 74 53 65 72 76 69 63 65 43 74 72 6c 44 69 73 70 61 74 63 68 65 72 41 } //01 00  StartServiceCtrlDispatcherA
		$a_00_2 = {53 6c 65 65 70 } //01 00  Sleep
