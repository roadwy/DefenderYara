...
rule TrojanDownloader_Win32_Misfox_A{
	...
	strings :
		...
		$a_00_2 = {59 3a 5c 00 58 3a 5c 00 5a 3a 5c 00 48 3a 5c 00 47 3a 5c 00 46 3a 5c 00 45 3a 5c 00 44 3a 5c 00 43 3a 5c 00 } //01 00  㩙\㩘\㩚\㩈\㩇\㩆\㩅\㩄\㩃\
		$a_02_3 = {68 74 74 70 3a 2f 2f 90 02 03 2e 90 02 03 2e 90 02 03 2e 90 02 03 2f 90 00 } //01 00 
		$a_00_4 = {62 69 6e 67 2e 63 6f 6d } //01 00  bing.com
		$a_00_5 = {4e 4a 42 23 } //00 00  NJB#
	condition:
		any of ($a_*)
