...
rule TrojanDownloader_Win32_Tufik_A{
	...
	strings :
		...
		$a_01_2 = {4d 59 5f 4d 41 49 4e 5f 4a 4e 4a 45 43 54 } //01 00  MY_MAIN_JNJECT
		$a_01_3 = {49 45 48 6c 70 72 4f 62 6a 2e 49 45 48 6c 70 72 4f 62 6a 2e 31 } //00 00  IEHlprObj.IEHlprObj.1
	condition:
		any of ($a_*)
