...
rule TrojanDownloader_Win32_CmdSecurityWid_B_dha{
	...
	strings :
		...
		$a_02_1 = {5c 00 5c 00 3f 00 5c 00 90 01 02 3a 00 5c 00 70 00 72 00 6f 00 67 00 72 00 61 00 6d 00 64 00 61 00 74 00 61 00 5c 00 63 00 6f 00 6d 00 5c 00 90 00 } //1
