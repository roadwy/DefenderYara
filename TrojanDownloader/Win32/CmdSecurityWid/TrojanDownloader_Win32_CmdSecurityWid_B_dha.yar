...
rule TrojanDownloader_Win32_CmdSecurityWid_B_dha{
	...
	strings :
		$a_00_0 = {69 00 63 00 61 00 63 00 6c 00 73 00 } //01 00 
		...
		$a_00_2 = {2f 00 69 00 6e 00 68 00 65 00 72 00 69 00 74 00 61 00 6e 00 63 00 65 00 3a 00 72 00 } //01 00 
		$a_00_3 = {2f 00 67 00 72 00 61 00 6e 00 74 00 3a 00 72 00 } //01 00 
		$a_00_4 = {73 00 79 00 73 00 74 00 65 00 6d 00 3a 00 } //00 00 
	condition:
		any of ($a_*)
