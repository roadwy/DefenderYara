...
rule TrojanDownloader_Win32_Agent_AAG{
	...
	strings :
		$a_00_0 = {61 61 61 61 61 61 61 61 61 61 61 61 61 61 61 61 61 61 61 61 61 61 2e 6c 69 6d 65 77 65 62 73 2e 63 6f 6d 2f 7a 2f 67 61 74 65 2e 70 68 70 } //01 00 
