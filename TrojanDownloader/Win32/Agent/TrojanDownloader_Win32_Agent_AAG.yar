...
rule TrojanDownloader_Win32_Agent_AAG{
	...
	strings :
		...
		$a_03_1 = {0d 2f 00 00 74 90 01 01 81 bd 90 01 02 ff ff 0c 2f 00 00 74 90 01 01 81 bd 90 01 02 ff ff 05 2f 00 00 74 90 01 01 81 bd 90 01 02 ff ff 06 2f 00 00 74 90 00 } //1
	condition:
