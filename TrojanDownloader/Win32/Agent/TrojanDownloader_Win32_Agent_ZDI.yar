...
rule TrojanDownloader_Win32_Agent_ZDI{
	...
	strings :
		$a_03_0 = {c7 45 fc 0c 00 00 00 68 90 01 04 8b 4d 08 8b 51 38 52 e8 90 01 04 89 90 01 02 ff ff ff c7 90 01 02 ff ff ff 08 00 00 00 8d 90 01 02 ff ff ff 8d 90 01 02 ff 15 90 00 } //1
