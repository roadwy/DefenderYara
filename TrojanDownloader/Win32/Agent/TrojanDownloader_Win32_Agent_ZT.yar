...
rule TrojanDownloader_Win32_Agent_ZT{
	...
	strings :
		$a_02_0 = {8d 4c 24 18 51 68 00 10 00 00 56 56 57 ff 15 90 01 04 81 c3 00 10 00 00 81 c6 00 10 00 00 90 00 } //10
		$a_02_1 = {68 04 01 00 00 51 56 55 e8 90 01 04 85 c0 75 90 01 01 55 68 80 00 00 00 6a 03 55 6a 01 8d 94 24 2c 01 00 00 68 00 00 00 80 52 ff 15 90 00 } //10
