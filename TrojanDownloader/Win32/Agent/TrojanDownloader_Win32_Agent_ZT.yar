...
rule TrojanDownloader_Win32_Agent_ZT{
	...
	strings :
		...
		$a_00_2 = {68 74 74 70 3a 2f 2f 77 6d 6a 71 72 2e 63 6e } //01 00 
		$a_00_3 = {4b 65 72 6e 65 6c 46 61 69 6c 43 68 65 63 6b } //01 00 
		$a_00_4 = {25 73 5c 73 79 73 63 68 65 63 6b 2e 65 78 65 } //00 00 
	condition:
		any of ($a_*)
