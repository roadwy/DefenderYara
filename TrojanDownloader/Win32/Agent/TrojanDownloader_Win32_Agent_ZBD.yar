...
rule TrojanDownloader_Win32_Agent_ZBD{
	...
	strings :
		$a_03_0 = {56 8b 74 24 08 85 f6 75 04 33 c0 5e c3 ff 15 ?? ?? ?? ?? 50 e8 ?? ?? 00 00 83 c4 04 e8 ?? ?? 00 00 99 b9 1a 00 00 00 f7 f9 83 c2 61 52 e8 ?? ?? 00 00 99 b9 1a 00 00 00 f7 f9 83 c2 61 52 } //1
		$a_03_1 = {83 f9 03 76 3c 50 8d 4c 24 28 50 8d 94 24 90 90 00 00 00 51 52 50 e8 ?? ?? 00 00 85 c0 75 12 6a 01 50 50 8d 44 24 30 50 68 ?? ?? ?? ?? 6a 00 ff d5 68 d0 07 00 00 46 ff 15 ?? ?? ?? ?? e9 1d ff ff ff } //1
