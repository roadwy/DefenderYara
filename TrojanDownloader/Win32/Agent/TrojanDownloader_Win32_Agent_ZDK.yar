...
rule TrojanDownloader_Win32_Agent_ZDK{
	...
	strings :
		$a_00_0 = {77 77 77 2e 63 30 72 72 75 70 74 65 64 2e 63 6f 6d } //0a 00  www.c0rrupted.com
...
rule TrojanDownloader_Win32_Agent_ZDK_2{
	...
	strings :
		...
		$a_00_1 = {43 3a 5c 57 49 4e 44 4f 57 53 5c 73 79 73 74 65 6d 33 32 5c 69 6d 67 6c 6f 67 2e 65 78 65 } //00 00  C:\WINDOWS\system32\imglog.exe
	condition:
		any of ($a_*)
...
rule TrojanDownloader_Win32_Agent_ZDK_3{
	...
	strings :
		$a_00_0 = {68 00 74 00 74 00 70 00 3a 00 2f 00 2f 00 76 00 69 00 64 00 61 00 72 00 65 00 61 00 6c 00 32 00 30 00 31 00 30 00 2e 00 70 00 69 00 73 00 65 00 6d 00 2e 00 73 00 75 00 2f 00 69 00 6d 00 67 00 6c 00 6f 00 67 00 2e 00 65 00 78 00 65 00 } //0a 00  http://vidareal2010.pisem.su/imglog.exe
