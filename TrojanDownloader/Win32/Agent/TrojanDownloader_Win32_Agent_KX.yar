...
rule TrojanDownloader_Win32_Agent_KX{
	...
	strings :
		...
		$a_03_1 = {c6 44 24 15 3a c6 44 24 16 5c be 03 00 00 00 e8 90 01 02 00 00 8b d0 8b fb 83 c9 ff 33 c0 f2 ae f7 d1 8b c2 49 33 d2 f7 f1 46 83 fe 09 8a 04 1a 90 00 } //1
	condition:
