...
rule TrojanDownloader_Win32_Agent_KJ{
	...
	strings :
		...
		$a_03_1 = {83 c4 40 85 c0 74 15 ff 90 01 02 8d 90 01 02 ff ff ff 50 e8 90 01 02 ff ff 59 85 c0 59 75 10 ff 45 ec ff 45 f8 83 7d ec 08 0f 8c 74 ff ff ff 90 00 } //1
	condition:
