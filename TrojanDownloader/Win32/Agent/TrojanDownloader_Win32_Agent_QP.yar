...
rule TrojanDownloader_Win32_Agent_QP{
	...
	strings :
		...
		$a_03_1 = {49 6e 74 6f 72 6e 6f 74 90 02 08 45 78 70 6c 6f 72 6f 72 90 02 08 2e 6c 6e 6b 90 00 } //2
		...
		$a_03_5 = {70 69 70 69 5f 64 61 65 5f 90 02 04 2e 65 78 65 90 00 } //1
	condition:
