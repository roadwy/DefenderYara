...
rule TrojanDownloader_Win32_Agent_AFN{
	...
	strings :
		...
		$a_03_1 = {46 c6 44 24 90 01 01 69 c6 44 24 90 01 01 65 c6 44 24 90 01 01 41 c6 44 24 90 01 01 00 c6 44 24 90 01 01 75 c6 44 24 90 01 01 72 90 00 } //1
		$a_03_2 = {6d c6 44 24 90 01 01 33 c6 44 24 90 01 01 32 c6 44 24 90 01 01 5c c6 44 24 90 01 01 75 90 00 } //1
