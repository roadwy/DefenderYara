...
rule TrojanDownloader_Win32_Agent_DAA{
	...
	strings :
		...
		$a_03_2 = {68 1c 40 40 00 50 e8 90 01 01 0e 00 00 8d 85 e4 fe ff ff 50 8d 85 70 fa ff ff 50 e8 90 01 01 0d 00 00 8d 85 70 fa ff ff 68 14 40 40 00 50 e8 90 01 01 0d 00 00 83 c4 28 8d 45 e8 50 8d 85 a0 fe ff ff 50 53 53 53 53 53 8d 85 70 fa ff ff 90 00 } //1
	condition:
