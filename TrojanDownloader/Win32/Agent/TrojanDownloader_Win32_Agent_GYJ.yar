...
rule TrojanDownloader_Win32_Agent_GYJ{
	...
	strings :
		...
		$a_00_1 = {43 3a 5c 50 72 6f 67 72 61 6d 20 46 69 6c 65 73 5c 73 79 73 2e 62 61 74 } //01 00 
		$a_00_2 = {26 6e 65 74 20 73 74 6f 70 20 4b 50 66 77 53 76 63 26 6e 65 74 20 73 74 6f 70 20 4b 57 61 74 63 68 73 76 63 26 6e 65 74 20 73 74 6f 70 20 4d 63 53 68 69 65 6c 64 26 6e 65 74 20 73 74 6f 70 20 22 4e 6f 72 74 6f 6e 20 41 6e 74 69 56 69 72 75 73 20 53 65 72 76 65 72 22 } //00 00 
	condition:
		any of ($a_*)
