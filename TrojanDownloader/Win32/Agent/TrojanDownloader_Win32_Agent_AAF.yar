...
rule TrojanDownloader_Win32_Agent_AAF{
	...
	strings :
		$a_00_0 = {5c 50 72 6f 67 72 61 6d 20 46 69 6c 65 73 5c 75 72 6c 63 6f 72 65 2e 65 78 65 20 2f 68 20 2f 72 20 2f 74 20 2f 62 } //01 00 
		$a_00_1 = {5c 49 6e 74 65 72 6e 65 74 20 45 78 70 6c 6f 72 65 72 2e 6c 6e 6b } //01 00 
