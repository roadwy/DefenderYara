...
rule TrojanDownloader_Win32_Agent_AAA{
	...
	strings :
		$a_02_0 = {83 ec 10 8d 44 24 04 50 68 1f 00 02 00 6a 00 68 90 01 02 41 00 68 01 00 00 80 c7 44 24 14 00 00 00 00 ff 15 90 01 02 41 00 85 c0 74 06 32 c0 83 c4 10 c3 90 00 } //10
		$a_02_1 = {2f 47 6f 6f 67 6c 65 5f 66 69 6c 65 73 2f 68 70 90 01 01 2e 67 69 66 90 00 } //10
