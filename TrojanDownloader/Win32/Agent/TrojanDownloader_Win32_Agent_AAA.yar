...
rule TrojanDownloader_Win32_Agent_AAA{
	...
	strings :
		...
		$a_00_2 = {53 6f 66 74 77 61 72 65 5c 4d 69 63 72 6f 73 6f 66 74 5c 6e 65 77 20 57 57 57 5c 76 61 72 73 } //0a 00 
		$a_00_3 = {53 6f 66 74 77 61 72 65 5c 4d 69 63 72 6f 73 6f 66 74 5c 57 65 62 53 65 72 76 65 72 20 44 61 74 61 } //01 00 
