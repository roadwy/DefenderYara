...
rule TrojanDownloader_Win32_Agent_BCK{
	...
	strings :
		...
		$a_02_1 = {68 74 74 70 3a 2f 2f 90 02 20 2f 70 72 6f 67 72 61 6d 2f 90 05 40 0d 61 2d 7a 41 2d 5a 30 2d 39 2e 5f 2f 2d 53 65 74 75 70 2e 65 78 65 90 00 } //10
