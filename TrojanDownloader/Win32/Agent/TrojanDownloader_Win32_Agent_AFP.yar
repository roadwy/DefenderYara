...
rule TrojanDownloader_Win32_Agent_AFP{
	...
	strings :
		...
		$a_00_2 = {25 41 50 50 44 41 54 41 25 5c 4d 69 63 72 6f 73 6f 66 74 5c 4d 65 64 69 61 20 50 6c 61 79 65 72 5c 44 52 4d 31 32 38 } //01 00  %APPDATA%\Microsoft\Media Player\DRM128
		$a_00_3 = {2f 70 61 74 63 68 2f 63 68 6b 75 70 64 61 74 65 2e 70 68 70 } //00 00  /patch/chkupdate.php
	condition:
		any of ($a_*)
