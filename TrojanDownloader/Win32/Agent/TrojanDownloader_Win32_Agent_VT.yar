...
rule TrojanDownloader_Win32_Agent_VT{
	...
	strings :
		...
		$a_02_1 = {40 40 00 55 8b 2d 90 01 02 40 00 56 8b 74 24 10 57 8b 3d 90 01 02 40 00 68 90 01 02 40 00 ff d3 68 90 01 04 ff d7 8b ce e8 90 01 02 00 00 85 c0 75 0b 8b ce e8 90 01 02 00 00 85 c0 74 f5 68 90 01 02 40 00 ff d5 eb d3 90 00 } //10
		$a_02_2 = {c7 44 24 0c 00 00 00 00 50 ff 15 90 01 02 40 00 8b 4c 24 18 8b 35 90 01 02 40 00 6a 00 51 ff d6 6a ff 56 ff 15 90 01 02 40 00 8d 4c 24 14 e8 90 01 04 8d 4c 24 18 c7 44 24 0c ff ff ff ff e8 90 00 } //10
