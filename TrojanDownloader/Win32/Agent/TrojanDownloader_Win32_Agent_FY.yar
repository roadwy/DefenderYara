...
rule TrojanDownloader_Win32_Agent_FY{
	...
	strings :
		...
		$a_02_6 = {8d 85 fc f7 ff ff 68 90 01 02 40 00 50 e8 90 01 02 00 00 8d 85 fc f7 ff ff 56 50 e8 90 01 02 00 00 8d 85 fc f7 ff ff 68 90 01 02 40 00 50 e8 90 01 02 00 00 8d 85 fc ef ff ff 50 8d 85 fc f7 ff ff 50 e8 90 01 02 00 00 8d 85 fc f7 ff ff 68 90 01 02 40 00 50 90 00 } //10
	condition:
