...
rule TrojanDownloader_Win32_Agent_FY{
	...
	strings :
		$a_00_0 = {73 63 2e 65 78 65 20 73 74 61 72 74 } //01 00 
		$a_00_1 = {5c 57 49 4e 44 4f 57 53 5c 73 79 73 74 65 6d 33 32 5c 72 65 67 73 76 72 33 32 2e 65 78 65 } //01 00 
		$a_00_2 = {5c 64 72 69 76 65 72 73 5c } //01 00 
		$a_00_3 = {41 4d 44 63 6f 72 65 32 } //0a 00 
		$a_00_4 = {35 38 2e 34 39 2e 35 38 2e 32 30 } //0a 00 
