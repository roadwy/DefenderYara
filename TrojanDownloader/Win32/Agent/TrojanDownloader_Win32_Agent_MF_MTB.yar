...
rule TrojanDownloader_Win32_Agent_MF_MTB{
	...
	strings :
		$a_03_0 = {57 56 8b 74 24 10 8b 4c 24 14 8b 7c 24 0c 8b c1 8b d1 03 c6 3b fe 90 01 01 08 3b f8 0f 82 90 01 04 0f ba 25 90 01 04 01 73 90 01 01 f3 a4 e9 90 00 } //1
		$a_03_1 = {66 39 11 74 90 01 01 40 83 c1 02 3b 45 0c 72 90 00 } //1
