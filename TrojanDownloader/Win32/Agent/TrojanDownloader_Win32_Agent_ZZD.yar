...
rule TrojanDownloader_Win32_Agent_ZZD{
	...
	strings :
		$a_00_0 = {25 73 5c 4e 74 5f 46 69 6c 65 5f 54 65 6d 70 5c 25 64 2e 74 6d 70 } //0a 00  %s\Nt_File_Temp\%d.tmp
		$a_00_1 = {25 77 69 6e 64 69 72 25 5c 4e 74 5f 46 69 6c 65 5f 54 65 6d 70 5c 6c 69 73 74 2e 74 6d 70 } //0a 00  %windir%\Nt_File_Temp\list.tmp
		$a_00_2 = {4d 49 43 4b 5f 44 4f 57 4e 4c 4f 41 44 5f 4d 55 54 45 58 } //0a 00  MICK_DOWNLOAD_MUTEX
