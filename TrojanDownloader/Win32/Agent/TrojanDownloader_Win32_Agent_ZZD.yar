...
rule TrojanDownloader_Win32_Agent_ZZD{
	...
	strings :
		...
		$a_02_4 = {68 74 74 70 3a 2f 2f 35 31 33 33 38 39 2e 63 6e 2f ?? ?? ?? 2e 74 78 74 } //1
		$a_02_5 = {68 74 74 70 3a 2f 2f 77 77 77 2e 61 6c 61 6e 67 61 2e 6e 65 74 2f ?? ?? ?? 2e 74 78 74 } //1
	condition:
