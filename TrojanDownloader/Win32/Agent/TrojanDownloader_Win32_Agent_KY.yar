...
rule TrojanDownloader_Win32_Agent_KY{
	...
	strings :
		$a_00_0 = {20 2f 63 20 70 69 6e 67 20 6c 6f 63 61 6c 68 6f 73 74 20 2d 6e 20 33 20 3e 3e 20 4e 55 4c 20 26 26 20 64 65 6c 20 } //01 00 
		$a_01_1 = {63 32 68 6c 62 47 77 7a 4d 69 35 6b 62 47 77 3d 00 56 56 4a 4d 52 47 39 33 62 6d 78 76 59 57 52 55 62 30 5a 70 62 47 56 42 00 } //01 00 
