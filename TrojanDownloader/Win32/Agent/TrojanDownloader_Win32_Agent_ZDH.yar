...
rule TrojanDownloader_Win32_Agent_ZDH{
	...
	strings :
		...
		$a_00_1 = {4e 74 51 75 65 72 79 53 79 73 74 65 6d 49 6e 66 6f 72 6d 61 74 69 6f 6e } //01 00 
		$a_00_2 = {4b 65 53 65 72 76 69 63 65 44 65 73 63 72 69 70 74 6f 72 54 61 62 6c 65 } //01 00 
		$a_00_3 = {4c 75 6f 58 75 65 } //01 00 
		$a_00_4 = {62 65 65 70 2e 73 79 73 } //01 00 
		$a_00_5 = {73 62 6c 2e 73 79 73 } //00 00 
	condition:
		any of ($a_*)
