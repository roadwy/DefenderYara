...
rule TrojanDownloader_Win32_Agent_U{
	...
	strings :
		$a_01_0 = {52 65 67 69 73 74 65 72 53 65 72 76 69 63 65 43 74 72 6c 48 61 6e 64 6c 65 72 41 } //01 00  RegisterServiceCtrlHandlerA
		$a_01_1 = {4b 65 53 65 72 76 69 63 65 44 65 73 63 72 69 70 74 6f 72 54 61 62 6c 65 } //01 00  KeServiceDescriptorTable
		$a_01_2 = {44 69 73 61 62 6c 65 53 63 72 69 70 74 44 65 62 75 67 67 65 72 49 45 } //01 00  DisableScriptDebuggerIE
		$a_01_3 = {53 65 4c 6f 61 64 44 72 69 76 65 72 50 72 69 76 69 6c 65 67 65 } //01 00  SeLoadDriverPrivilege
		$a_01_4 = {41 64 6a 75 73 74 54 6f 6b 65 6e 50 72 69 76 69 6c 65 67 65 73 } //01 00  AdjustTokenPrivileges
		$a_01_5 = {4f 70 65 6e 53 43 4d 61 6e 61 67 65 72 41 } //01 00  OpenSCManagerA
