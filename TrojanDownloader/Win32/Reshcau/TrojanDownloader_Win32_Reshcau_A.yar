...
rule TrojanDownloader_Win32_Reshcau_A{
	...
	strings :
		...
		$a_03_1 = {46 6a 00 6a 01 8d 45 ef 50 53 e8 90 01 04 85 c0 7f e3 90 00 } //1
		$a_03_2 = {b8 1d 00 00 00 e8 90 01 04 40 ba 90 01 04 8a 44 02 ff 88 03 43 4e 75 e6 90 00 } //1
	condition:
