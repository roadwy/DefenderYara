...
rule TrojanDownloader_Win32_Alureon_C{
	...
	strings :
		$a_01_0 = {2e 65 78 65 3b 68 74 74 70 3a 2f 2f } //01 00  .exe;http://
		$a_01_1 = {61 6c 6c 6f 77 65 64 70 72 6f 67 72 61 6d 20 25 73 20 65 6e 61 62 6c 65 } //01 00  allowedprogram %s enable
