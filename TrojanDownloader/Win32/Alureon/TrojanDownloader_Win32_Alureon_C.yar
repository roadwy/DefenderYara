...
rule TrojanDownloader_Win32_Alureon_C{
	...
	strings :
		...
		$a_03_2 = {68 80 96 98 00 6a 40 ff 15 90 01 03 00 8d 4d 90 01 01 51 68 40 54 89 00 50 53 90 00 } //1
		$a_03_3 = {0f 31 83 e0 0a 89 45 90 01 01 8b 45 90 01 01 69 c0 e8 03 00 00 50 ff 15 90 00 } //2
