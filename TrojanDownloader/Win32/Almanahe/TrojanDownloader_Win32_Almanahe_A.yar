...
rule TrojanDownloader_Win32_Almanahe_A{
	...
	strings :
		$a_03_0 = {8b 85 ec fe ff ff 83 c0 01 89 85 ec fe ff ff 81 bd ec fe ff ff 90 01 04 7d 21 8b 8d ec fe ff ff 0f be 91 90 01 04 81 f2 ff 00 00 00 8b 85 ec fe ff ff 88 90 90 90 01 04 eb c4 90 00 } //1
