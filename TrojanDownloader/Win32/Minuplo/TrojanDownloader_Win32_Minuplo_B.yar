...
rule TrojanDownloader_Win32_Minuplo_B{
	...
	strings :
		...
		$a_01_1 = {6d 69 6e 69 75 70 6c 6f 61 64 2e 6e 65 74 2f 69 72 2f 73 31 2e 70 68 70 } //01 00 
		$a_01_2 = {6d 69 6e 69 75 70 6c 6f 61 64 2e 6e 65 74 2f 69 72 2f 75 72 6c } //00 00 
	condition:
		any of ($a_*)
