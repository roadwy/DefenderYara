...
rule TrojanDownloader_Win32_Bredolab_AA{
	...
	strings :
		$a_03_0 = {85 ed 74 5f 83 c5 0e 8b dd a1 90 01 04 e8 90 01 04 a1 90 01 04 50 57 ff 15 90 01 04 83 c4 08 8b e8 a1 90 00 } //2
		$a_03_1 = {57 b9 50 00 00 00 8b d3 a1 90 01 04 e8 90 01 04 8b f8 8b c6 e8 90 00 } //1
