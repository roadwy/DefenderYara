...
rule TrojanDownloader_Win32_Bredolab_B{
	meta:
		description = "TrojanDownloader:Win32/Bredolab.B,SIGNATURE_TYPE_PEHSTR_EXT,03 00 03 00 06 00 00 02 00 "
		
	strings :
		$a_01_0 = {eb 17 81 e1 ff 00 00 00 8d 5a 01 03 db 33 cb 33 db 8a d8 } //02 00 
		$a_01_1 = {b8 4b 4c 43 cf e8 } //02 00 
