...
rule TrojanDownloader_Win32_Bredolab_gen_B{
	...
	strings :
		...
		$a_01_3 = {4d 61 67 69 63 2d 4e 75 6d 62 65 72 3a } //01 00  Magic-Number:
		$a_01_4 = {45 6e 74 69 74 79 2d 49 6e 66 6f 3a } //02 00  Entity-Info:
		$a_01_5 = {2f 6c 6f 61 64 65 72 62 62 2e 70 68 70 } //00 00  /loaderbb.php
	condition:
		any of ($a_*)
