...
rule TrojanDownloader_Win32_Seraph_PAAP_MTB{
	...
	strings :
		$a_01_0 = {3a 2f 2f 72 70 2e 6d 79 6c 32 33 2e 63 6f 6d 2f 61 70 69 2e 6a 73 70 } //01 00  ://rp.myl23.com/api.jsp
		...
		$a_01_2 = {69 20 61 6d 20 61 76 70 } //01 00  i am avp
		$a_01_3 = {3a 2f 2f 6c 69 76 65 2e 6d 79 6c 32 33 2e 63 6f 6d 2f 69 6e 73 74 61 6c 6c 2e 65 78 65 } //00 00  ://live.myl23.com/install.exe
	condition:
		any of ($a_*)
