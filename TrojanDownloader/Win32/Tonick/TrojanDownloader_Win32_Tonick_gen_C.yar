...
rule TrojanDownloader_Win32_Tonick_gen_C{
	...
	strings :
		$a_01_0 = {6c 00 71 00 60 00 6b 00 6b 00 60 00 6e 00 6f 00 27 00 6f 00 73 00 69 00 } //01 00  lq`kk`no'osi
		$a_01_1 = {72 00 67 00 71 00 72 00 6c 00 65 00 62 00 7b 00 27 00 6f 00 73 00 69 00 } //05 00  rgqrleb{'osi
		$a_00_2 = {49 6e 74 65 72 6e 65 74 52 65 61 64 46 69 6c 65 } //0a 00  InternetReadFile
