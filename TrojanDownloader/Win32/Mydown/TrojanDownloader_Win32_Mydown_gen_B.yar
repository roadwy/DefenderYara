...
rule TrojanDownloader_Win32_Mydown_gen_B{
	...
	strings :
		...
		$a_03_7 = {8b 4d fc 8a 4c 11 ff 8b 75 ec 88 0c 1e 43 42 48 75 ee 8b 45 f8 e8 ?? ?? ?? ?? 85 c0 7e 17 ba 01 00 00 00 8b 4d f8 8a 4c 11 ff 8b 75 ec 88 0c 1e 43 42 48 75 ee } //10
	condition:
