...
rule TrojanDownloader_Win32_VB_OG{
	...
	strings :
		...
		$a_01_3 = {40 00 2a 00 5c 00 41 00 46 00 3a 00 5c 00 41 00 70 00 70 00 6c 00 69 00 63 00 61 00 74 00 69 00 6f 00 6e 00 5c 00 76 00 63 00 5c 00 53 00 5c 00 31 00 32 00 5c 00 31 00 2e 00 76 00 62 00 70 00 } //00 00 
	condition:
		any of ($a_*)
