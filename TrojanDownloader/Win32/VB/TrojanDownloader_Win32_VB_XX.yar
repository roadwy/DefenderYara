...
rule TrojanDownloader_Win32_VB_XX{
	...
	strings :
		$a_02_0 = {2e 00 39 00 37 00 38 00 63 00 66 00 2e 00 63 00 6f 00 6d 00 2f 00 6d 00 61 00 2f 00 90 01 02 2e 00 65 00 78 00 65 00 90 00 } //1
		$a_02_1 = {43 00 3a 00 5c 00 57 00 49 00 4e 00 44 00 4f 00 57 00 53 00 5c 00 48 00 65 00 6c 00 70 00 5c 00 90 01 02 2e 00 65 00 78 00 65 00 90 00 } //1
