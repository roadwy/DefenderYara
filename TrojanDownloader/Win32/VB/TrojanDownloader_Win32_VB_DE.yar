...
rule TrojanDownloader_Win32_VB_DE{
	...
	strings :
		...
		$a_00_2 = {5c 00 43 00 6c 00 65 00 6d 00 69 00 73 00 2d 00 47 00 61 00 79 00 5c 00 50 00 72 00 6f 00 79 00 65 00 63 00 74 00 6f 00 31 00 2e 00 76 00 62 00 70 00 } //01 00  \Clemis-Gay\Proyecto1.vbp
		$a_00_3 = {55 52 4c 44 6f 77 6e 6c 6f 61 64 54 6f 46 69 6c 65 41 00 } //01 00 
		$a_00_4 = {4c 6f 61 64 45 58 45 00 } //00 00  潌摡塅E
	condition:
		any of ($a_*)
