...
rule TrojanDownloader_Win32_VB_YCS{
	...
	strings :
		...
		$a_02_4 = {55 00 73 00 65 00 72 00 5c 00 44 00 65 00 73 00 6b 00 74 00 6f 00 70 00 5c 00 90 02 70 5c 00 6e 00 65 00 77 00 32 00 39 00 31 00 31 00 2e 00 76 00 62 00 70 00 90 00 } //1
	condition:
