...
rule TrojanDownloader_Win32_VB_YE{
	...
	strings :
		...
		$a_03_2 = {4f 70 65 6e 48 54 54 50 90 02 0a 43 6c 6f 73 65 48 54 54 50 90 02 0a 53 65 6e 64 52 65 71 75 65 73 74 90 02 0a 55 52 4c 45 6e 63 6f 64 65 90 00 } //1
	condition:
