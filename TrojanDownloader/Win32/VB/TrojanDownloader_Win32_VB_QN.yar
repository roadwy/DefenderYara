...
rule TrojanDownloader_Win32_VB_QN{
	...
	strings :
		$a_02_0 = {5c 00 45 00 74 00 68 00 65 00 6d 00 5c 00 42 00 75 00 72 00 65 00 61 00 75 00 62 00 6c 00 61 00 64 00 5c 00 4e 00 69 00 65 00 75 00 77 00 65 00 20 00 6d 00 61 00 70 00 90 02 20 2e 00 76 00 62 00 70 00 90 00 } //1
