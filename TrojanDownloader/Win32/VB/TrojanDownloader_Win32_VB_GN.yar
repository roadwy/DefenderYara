...
rule TrojanDownloader_Win32_VB_GN{
	...
	strings :
		...
		$a_00_1 = {20 00 67 00 6f 00 74 00 6f 00 20 00 64 00 6c 00 6f 00 6f 00 70 00 } //01 00   goto dloop
		$a_00_2 = {69 00 66 00 20 00 65 00 78 00 69 00 73 00 74 00 20 00 } //01 00  if exist 
