...
rule TrojanDownloader_Win32_VB_TM{
	...
	strings :
		...
		$a_01_1 = {5c 00 6c 00 5c 00 44 00 65 00 73 00 6b 00 74 00 6f 00 70 00 5c 00 6c 00 61 00 6c 00 61 00 6c 00 61 00 6c 00 32 00 } //01 00 
		$a_01_2 = {5c 00 64 00 69 00 66 00 66 00 70 00 72 00 6a 00 2e 00 77 00 62 00 70 00 } //01 00 
		$a_01_3 = {5c 00 64 00 69 00 66 00 66 00 70 00 72 00 6a 00 2e 00 76 00 62 00 } //01 00 
