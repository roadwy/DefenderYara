...
rule TrojanDownloader_Win32_VB_YJ_bit{
	...
	strings :
		...
		$a_01_2 = {5c 00 53 00 65 00 63 00 75 00 72 00 69 00 74 00 79 00 20 00 44 00 6f 00 77 00 6e 00 6c 00 6f 00 61 00 64 00 65 00 72 00 5c 00 53 00 65 00 63 00 75 00 72 00 69 00 74 00 79 00 5f 00 44 00 6f 00 77 00 6e 00 6c 00 6f 00 61 00 64 00 65 00 72 00 2e 00 76 00 62 00 70 00 } //01 00 
