...
rule TrojanDownloader_Win32_VB_CJ{
	...
	strings :
		$a_00_0 = {56 42 35 21 36 26 76 62 36 63 68 73 2e 64 6c 6c } //0a 00 
		...
		$a_00_5 = {40 00 65 00 63 00 68 00 6f 00 20 00 6f 00 66 00 66 00 } //01 00 
		$a_00_6 = {6d 75 74 6f 75 78 69 61 7a 61 69 } //00 00 
	condition:
		any of ($a_*)
