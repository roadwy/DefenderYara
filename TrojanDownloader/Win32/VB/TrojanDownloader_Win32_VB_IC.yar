...
rule TrojanDownloader_Win32_VB_IC{
	...
	strings :
		...
		$a_03_3 = {74 00 2e 00 6e 00 65 00 74 00 70 00 6b 00 2e 00 63 00 6e 00 2f 00 73 00 6f 00 66 00 74 00 2f 00 31 00 2f 00 90 02 02 2e 00 65 00 78 00 65 00 90 00 } //1
		$a_02_4 = {5c 00 73 00 79 00 73 00 74 00 65 00 6d 00 33 00 32 00 5c 00 61 00 62 00 35 00 90 02 04 2e 00 65 00 78 00 65 00 90 00 } //1
	condition:
