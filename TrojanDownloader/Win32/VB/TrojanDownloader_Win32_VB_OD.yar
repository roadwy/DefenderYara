...
rule TrojanDownloader_Win32_VB_OD{
	...
	strings :
		...
		$a_03_1 = {50 00 72 00 6f 00 67 00 72 00 61 00 6d 00 46 00 69 00 6c 00 65 00 73 00 90 01 08 5c 00 79 00 78 00 79 00 36 00 31 00 33 00 2e 00 65 00 78 00 65 00 90 00 } //1
