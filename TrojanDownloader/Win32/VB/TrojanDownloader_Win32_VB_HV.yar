...
rule TrojanDownloader_Win32_VB_HV{
	...
	strings :
		$a_02_0 = {68 00 74 00 74 00 70 00 3a 00 2f 00 2f 00 77 00 77 00 77 00 2e 00 66 00 66 00 2d 00 70 00 75 00 72 00 6b 00 2e 00 61 00 74 00 2f 00 90 01 02 2e 00 6a 00 70 00 67 00 90 00 } //1
