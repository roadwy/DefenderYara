...
rule TrojanDownloader_Win32_Giku_B{
	...
	strings :
		$a_03_0 = {8b 45 fc 3b 45 08 72 12 8b 4d fc 8b 11 81 f2 90 01 04 8b 45 fc 89 10 eb dd 90 00 } //1
		$a_03_1 = {73 18 8b 55 08 03 55 fc 0f be 02 35 90 01 04 8b 4d 08 03 4d fc 88 01 eb d7 90 00 } //1
