...
rule TrojanDownloader_Win32_Argnot_A{
	...
	strings :
		...
		$a_00_1 = {61 00 76 00 73 00 63 00 68 00 65 00 2e 00 65 00 78 00 65 00 } //01 00 
		$a_00_2 = {45 00 41 00 53 00 65 00 6e 00 64 00 2e 00 64 00 6c 00 6c 00 } //01 00 
		$a_00_3 = {6e 00 6f 00 74 00 61 00 2e 00 72 00 61 00 72 00 } //00 00 
