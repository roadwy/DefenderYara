...
rule TrojanDownloader_Win32_Tapivat_A{
	...
	strings :
		...
		$a_00_3 = {53 68 69 65 6c 64 54 68 72 65 61 64 } //01 00  ShieldThread
		$a_00_4 = {41 6e 74 69 52 65 62 6f 6f 74 44 65 6c } //01 00  AntiRebootDel
		$a_00_5 = {52 65 61 64 4f 6c 64 49 6e 69 46 69 6c 65 } //01 00  ReadOldIniFile
		$a_00_6 = {42 65 67 69 6e 57 6f 72 6b } //00 00  BeginWork
	condition:
		any of ($a_*)
