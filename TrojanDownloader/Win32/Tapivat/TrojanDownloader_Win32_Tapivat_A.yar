...
rule TrojanDownloader_Win32_Tapivat_A{
	...
	strings :
		$a_03_0 = {68 b3 15 00 00 68 90 01 02 00 10 68 90 01 02 00 10 ff 15 90 01 04 8b 90 03 03 03 d8 81 fb f0 81 fe b3 15 00 00 90 03 05 02 89 75 fc 75 16 75 17 68 90 00 } //6
