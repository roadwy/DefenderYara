...
rule TrojanDownloader_Win32_Tapivat_B{
	...
	strings :
		$a_03_0 = {6a 03 6a 00 6a 00 68 00 00 00 80 56 ff 15 90 01 02 00 10 6a 00 50 a3 90 01 02 00 10 ff 15 90 01 02 00 10 6a 04 68 00 30 00 00 50 6a 00 90 00 } //3
		$a_03_1 = {99 b9 1a 00 00 00 68 dc 05 00 00 f7 f9 8b da 80 c3 41 ff 15 90 01 02 00 10 6a 00 90 00 } //3
