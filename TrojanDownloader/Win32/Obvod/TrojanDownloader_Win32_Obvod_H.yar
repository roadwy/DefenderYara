...
rule TrojanDownloader_Win32_Obvod_H{
	meta:
		description = "TrojanDownloader:Win32/Obvod.H,SIGNATURE_TYPE_PEHSTR_EXT,03 00 03 00 03 00 00 01 00 "
		
	strings :
		$a_00_0 = {25 73 2f 66 2e 70 68 70 3f 61 3d 25 73 26 62 3d 25 64 26 63 3d 25 64 00 } //01 00  猥是瀮灨愿┽♳㵢搥挦┽d
