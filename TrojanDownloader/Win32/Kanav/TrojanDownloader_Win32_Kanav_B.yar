...
rule TrojanDownloader_Win32_Kanav_B{
	...
	strings :
		...
		$a_00_1 = {38 31 41 36 41 38 44 32 30 43 41 32 41 45 } //01 00  81A6A8D20CA2AE
		$a_00_2 = {2d 73 74 61 72 74 00 73 74 61 72 74 } //01 00  猭慴瑲猀慴瑲
		$a_00_3 = {5c 41 59 4c 61 75 6e 63 68 2e 65 78 65 } //00 00  \AYLaunch.exe
	condition:
		any of ($a_*)
