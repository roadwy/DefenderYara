...
rule TrojanDownloader_Win32_Banker_H{
	...
	strings :
		...
		$a_01_1 = {64 69 6c 6d 61 2e 67 69 66 } //01 00 
		$a_01_2 = {6e 61 6d 6f 72 61 64 61 2e 67 69 66 } //01 00 
		$a_01_3 = {36 39 2e 36 34 2e 34 33 2e 31 32 39 } //01 00 
		$a_01_4 = {69 70 61 64 63 6f 6e 66 2e 65 78 65 } //00 00 
	condition:
		any of ($a_*)
