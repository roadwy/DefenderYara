...
rule TrojanDownloader_Win32_Notodar_A_{
	meta:
		description = "TrojanDownloader:Win32/Notodar.A!!Notodar.gen!A,SIGNATURE_TYPE_ARHSTR_EXT,05 00 05 00 06 00 00 01 00 "
	...
	strings :
		...
		$a_03_5 = {8b f0 85 f6 74 12 56 68 90 01 04 e8 90 01 04 2b f7 59 03 c6 ff d0 5f 33 c0 5e 90 00 } //05 00 
	condition:
		any of ($a_*)
