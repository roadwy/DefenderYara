...
rule TrojanDownloader_Win32_Ragterneb_B{
	...
	strings :
		...
		$a_02_2 = {75 00 70 00 64 00 61 00 74 00 65 00 5f 00 6c 00 6f 00 67 00 67 00 65 00 72 00 [0-04] 2e 00 70 00 68 00 70 00 3f 00 6c 00 6f 00 63 00 61 00 6c 00 65 00 3d 00 } //1
