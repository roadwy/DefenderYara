...
rule TrojanDownloader_Win32_Bitter_A{
	...
	strings :
		$a_01_0 = {47 45 54 20 2f 2f 2f 68 65 61 6c 74 68 6e 65 2f 61 63 63 65 70 74 2e 70 68 70 } //01 00 
		$a_01_1 = {37 66 35 65 64 38 35 64 2d 36 38 32 38 2d 34 66 39 32 2d 38 35 38 63 2d 66 34 30 62 30 61 63 36 38 31 33 38 } //01 00 
