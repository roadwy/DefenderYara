...
rule TrojanDownloader_Win32_Emerleox_gen_A{
	...
	strings :
		$a_01_0 = {65 6e 64 45 6d 61 69 6c 20 55 6e 69 74 20 42 79 20 41 6e 73 6b 79 61 } //01 00 
		$a_00_1 = {23 33 32 37 37 30 } //02 00 
		$a_01_2 = {20 20 a6 a6 2d 2b 51 51 } //02 00 
		$a_01_3 = {53 65 74 57 69 6e 64 6f 77 73 48 6f 6f 6b 45 78 41 } //02 00 
		$a_01_4 = {4d 73 48 78 2e 64 6c 6c } //09 00 
