...
rule TrojanDownloader_Win32_Waski_GEM_MTB{
	...
	strings :
		...
		$a_01_2 = {44 6f 20 79 6f 75 20 72 65 61 6c 79 20 77 61 6e 74 20 6d 65 3f } //01 00  Do you realy want me?
		$a_01_3 = {4d 79 20 6e 61 6d 65 20 69 73 20 48 65 72 6f 20 61 6e 64 20 6d 79 20 64 69 63 6b 20 69 73 20 62 72 69 6c 6c 69 61 6e 74 } //00 00  My name is Hero and my dick is brilliant
	condition:
		any of ($a_*)
