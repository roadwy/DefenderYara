...
rule TrojanDownloader_Win32_Tridmerc_gen_A{
	...
	strings :
		$a_03_0 = {68 04 01 00 00 6a 40 e8 54 00 00 00 8b d8 50 68 04 01 00 00 e8 41 00 00 00 6a 0b 59 8b fb 03 f8 be ?? 03 40 00 f3 a4 51 51 53 68 ?? 03 40 00 51 e8 3d 00 00 00 } //1
