...
rule TrojanDownloader_Win32_Neglemir_A{
	...
	strings :
		...
		$a_01_1 = {63 3a 5c 77 69 6e 64 6f 77 73 5c 68 65 6c 70 5c 77 69 6e 68 65 6c 70 2e 65 78 65 } //01 00 
		$a_01_2 = {2f 6a 2e 6a 73 70 3f 70 } //01 00 
		$a_03_3 = {26 70 33 3d 90 01 0c 26 70 34 3d 90 00 } //01 00 
		$a_01_4 = {2f 61 64 64 2e 6a 73 70 3f 75 69 64 3d } //01 00 
