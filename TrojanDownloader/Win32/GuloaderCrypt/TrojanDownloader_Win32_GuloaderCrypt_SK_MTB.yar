...
rule TrojanDownloader_Win32_GuloaderCrypt_SK_MTB{
	...
	strings :
		...
		$a_02_1 = {0f da ca 0f e4 ca 81 c1 90 01 04 0f e4 ca 0f ee ca 81 e9 90 01 04 0f da ca 0f ee ca 81 f1 90 01 04 0f e4 ca 0f ee ca 0f e4 ca 0f e4 ca ff 31 90 00 } //2
	condition:
