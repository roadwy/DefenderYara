...
rule TrojanDownloader_Win32_Yorcuts_A{
	...
	strings :
		$a_01_0 = {54 65 6c 6c 6d 65 57 68 79 6f 6b 2e 61 63 6c } //01 00 
		$a_01_1 = {53 69 67 56 65 72 } //01 00 
		$a_01_2 = {31 32 30 30 } //01 00 
		$a_01_3 = {70 77 65 66 6e 78 61 6c 6b 73 31 32 38 39 33 6b 61 6e 63 30 39 32 33 6a 61 61 64 63 61 61 65 33 } //01 00 
