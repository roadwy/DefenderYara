...
rule TrojanDownloader_Win32_Gulcrypt_B{
	...
	strings :
		...
		$a_01_1 = {2e 72 75 2f 73 79 73 } //01 00  .ru/sys
		$a_01_2 = {2e 72 75 2f 72 61 72 } //01 00  .ru/rar
		$a_01_3 = {63 3a 5c 74 65 65 6d 70 } //01 00  c:\teemp
		$a_01_4 = {70 69 70 65 63 } //00 00  pipec
