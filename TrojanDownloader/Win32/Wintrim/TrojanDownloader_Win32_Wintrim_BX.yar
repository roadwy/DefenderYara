...
rule TrojanDownloader_Win32_Wintrim_BX{
	...
	strings :
		...
		$a_01_2 = {25 73 25 63 69 74 79 70 65 3d 25 64 26 72 65 73 3d 25 64 00 } //01 00  猥挥瑩灹㵥搥爦獥┽d
		$a_01_3 = {5f 50 52 4f 47 52 41 4d 46 49 4c 45 53 5f 44 49 52 5f 00 } //01 00 
		$a_01_4 = {5f 53 59 53 54 45 4d 5f 44 49 52 5f 00 } //01 00 
		$a_01_5 = {5f 57 49 4e 44 4f 57 53 5f 44 49 52 5f 00 } //01 00  坟义佄南䑟剉_
		$a_01_6 = {26 67 72 70 69 64 3d 00 } //01 00  朦灲摩=
		$a_01_7 = {26 61 76 72 65 73 75 6c 74 3d 00 } //01 00 
		$a_01_8 = {26 61 76 65 72 72 6f 72 3d 00 } //01 00  愦敶牲牯=
		$a_01_9 = {26 64 6c 5f 6c 61 73 74 65 72 72 6f 72 3d 00 } //01 00 
		$a_01_10 = {26 64 6c 5f 73 74 61 74 75 73 63 6f 64 65 3d 00 } //00 00  搦彬瑳瑡獵潣敤=
	condition:
		any of ($a_*)
