...
rule TrojanDownloader_Win32_Spycos_J{
	...
	strings :
		$a_03_0 = {89 45 e0 8b 45 e8 33 45 e0 89 45 e4 8d 45 d4 8b 55 e4 e8 90 01 04 8b 55 d4 8b 45 ec e8 90 00 } //3
		$a_03_1 = {66 3d 16 04 74 20 8d 95 90 01 01 fe ff ff b8 90 01 04 e8 90 01 04 8b 85 90 01 01 fe ff ff 90 00 } //2
