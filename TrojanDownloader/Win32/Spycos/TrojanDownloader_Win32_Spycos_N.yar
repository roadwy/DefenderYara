...
rule TrojanDownloader_Win32_Spycos_N{
	...
	strings :
		...
		$a_03_1 = {68 00 00 0a 00 6a 00 6a 00 68 90 01 01 00 00 00 6a 90 01 01 6a 00 6a 00 90 01 01 6a 00 b9 90 01 04 ba 90 01 04 b8 90 01 04 e8 90 01 04 a3 90 01 04 68 90 01 04 90 03 02 05 6a 64 68 90 01 01 00 00 00 6a 00 a1 90 01 04 50 e8 90 01 04 eb 0c 90 00 } //9
