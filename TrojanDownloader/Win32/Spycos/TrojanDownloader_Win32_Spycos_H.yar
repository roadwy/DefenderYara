...
rule TrojanDownloader_Win32_Spycos_H{
	...
	strings :
		$a_03_0 = {35 ae ca 7b c3 ff 25 90 01 04 8b c0 53 33 db 6a 00 e8 ee ff ff ff 83 f8 07 75 90 00 } //2
		$a_00_1 = {69 6e 6f 76 61 6e 64 6f 6f 6f 6f 2e 2e 2e } //1 inovandoooo...
		$a_00_2 = {74 69 70 6f 3d 00 } //1 楴潰=
		$a_03_3 = {50 6c 75 67 69 6e 20 52 45 44 2e 2e 2e 2e 2e 2e 3a 20 90 03 03 07 53 49 4d 41 56 47 49 4e 48 4f 90 00 } //1
	condition:
