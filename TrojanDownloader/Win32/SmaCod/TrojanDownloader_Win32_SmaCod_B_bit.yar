...
rule TrojanDownloader_Win32_SmaCod_B_bit{
	meta:
		description = "TrojanDownloader:Win32/SmaCod.B!bit,SIGNATURE_TYPE_PEHSTR_EXT,03 00 03 00 03 00 00 02 00 "
	...
	strings :
		...
		$a_03_2 = {83 7d fc 00 74 90 01 01 ff 55 90 01 01 6a 00 ff 15 90 00 } //00 00 
	condition:
		any of ($a_*)
