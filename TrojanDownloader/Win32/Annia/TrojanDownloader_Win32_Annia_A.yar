...
rule TrojanDownloader_Win32_Annia_A{
	...
	strings :
		$a_03_0 = {be 82 23 00 00 68 90 01 02 40 00 ff 15 90 20 59 22 da 2d 4e 75 f2 90 00 } //1
		$a_01_1 = {75 67 67 63 3a 2f 2f 34 36 2e 31 34 38 2e 31 39 2e 37 34 2f 6e 69 2e 72 6b 72 } //1 uggc://46.148.19.74/ni.rkr
		$a_03_2 = {53 53 6a 03 53 6a 03 53 68 90 01 02 40 00 c7 45 64 90 01 02 40 00 c7 45 68 90 01 02 40 00 c7 45 6c 90 01 02 40 00 89 5d 70 ff 15 90 20 bb a0 ae 1d 90 00 } //1
	condition:
...
rule TrojanDownloader_Win32_Annia_A_2{
	...
	strings :
		$a_03_0 = {8a 07 04 0d eb 6e 8a 07 3c 4d 7f 1c 0f be c0 50 e8 90 01 04 59 85 c0 74 0e 0f be 07 50 e8 90 01 04 59 85 c0 75 d8 8a 07 3c 6e 90 00 } //1
		$a_03_1 = {75 67 67 63 3a 2f 2f 90 02 10 2f 6e 69 2e 72 6b 72 90 00 } //1
