...
rule TrojanDownloader_Win32_Beebone_AY{
	...
	strings :
		$a_01_0 = {5a 75 74 75 67 69 6c } //01 00  Zutugil
		$a_01_1 = {72 65 63 65 69 76 65 64 6e 65 73 73 } //01 00  receivedness
		$a_01_2 = {63 61 62 69 6e 65 74 77 6f 72 6b } //02 00  cabinetwork
