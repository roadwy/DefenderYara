...
rule TrojanDownloader_Win32_Ceysix_A{
	...
	strings :
		...
		$a_01_1 = {73 76 63 73 2e 65 78 65 } //01 00  svcs.exe
		$a_01_2 = {68 74 74 70 3a 2f 2f 73 65 79 36 2e 63 6f 6d 2f 76 65 72 2e 70 68 70 3f 6e 6f 3d } //01 00  http://sey6.com/ver.php?no=
		...
		$a_01_7 = {56 69 72 74 75 61 6c 50 72 6f 74 65 63 } //00 00  VirtualProtec
	condition:
		any of ($a_*)
