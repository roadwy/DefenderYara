...
rule TrojanDownloader_Win32_Socelar_PK{
	...
	strings :
		...
		$a_00_3 = {66 69 6c 65 72 65 61 64 2c 77 68 65 2c 25 74 65 6d 70 25 5c 25 4c 31 25 25 4c 32 25 25 4c 33 25 25 4c 34 25 25 4c 35 25 } //01 00  fileread,whe,%temp%\%L1%%L2%%L3%%L4%%L5%
