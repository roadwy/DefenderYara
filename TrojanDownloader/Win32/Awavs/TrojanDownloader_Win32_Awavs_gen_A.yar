...
rule TrojanDownloader_Win32_Awavs_gen_A{
	...
	strings :
		$a_03_0 = {6a 10 59 6a 04 33 db 58 f7 e1 0f 90 90 c3 89 4f 04 f7 db 0b d8 53 e8 90 01 04 6a 08 89 47 08 90 00 } //1
		$a_03_1 = {f7 d9 1b c9 99 81 e2 ff 01 00 00 03 c2 f7 d9 c1 f8 09 03 c8 c1 e1 09 51 89 0e e8 90 01 04 8b f8 8b 46 04 90 00 } //1
