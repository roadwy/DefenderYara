...
rule TrojanDownloader_Win32_Mavtost_A{
	...
	strings :
		...
		$a_02_2 = {30 0c 30 8b 0d 90 02 04 8a 49 02 0f b6 d9 40 81 90 01 01 24 6d 00 00 3b c3 90 00 } //2
		$a_02_3 = {30 0c 10 a1 90 02 04 8a 48 02 0f b6 c1 42 05 90 01 01 6d 00 00 3b d0 90 00 } //2
