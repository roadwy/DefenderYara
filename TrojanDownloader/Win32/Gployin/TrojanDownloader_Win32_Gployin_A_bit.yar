...
rule TrojanDownloader_Win32_Gployin_A_bit{
	...
	strings :
		$a_02_0 = {68 00 74 00 74 00 70 00 3a 00 2f 00 2f 00 69 00 6d 00 64 00 2e 00 67 00 64 00 79 00 69 00 70 00 69 00 6e 00 67 00 2e 00 63 00 6f 00 6d 00 [0-30] 2e 00 65 00 78 00 65 00 } //1
