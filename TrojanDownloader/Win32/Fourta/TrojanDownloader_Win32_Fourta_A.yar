...
rule TrojanDownloader_Win32_Fourta_A{
	...
	strings :
		$a_02_0 = {74 4f 68 ff ff 00 00 8d 85 fd ff fe ff 50 ff b5 dc ff fe ff e8 90 01 02 00 00 8d 85 fd ff fe ff 50 e8 90 01 02 00 00 59 ba 0a 00 00 00 39 c2 7f 08 6a 01 e8 90 01 02 00 00 59 68 ef cd 00 00 68 dc fe 00 00 68 00 04 00 00 90 00 } //1
