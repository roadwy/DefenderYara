...
rule TrojanDownloader_Win32_Allaple_gen_B{
	...
	strings :
		...
		$a_03_1 = {6a ff 6a 00 e8 90 01 03 ff 8b d8 85 db 74 0c e8 90 01 03 ff 3d b7 00 00 00 75 0d 53 e8 90 00 } //10
		...
		$a_03_6 = {53 79 73 74 65 6d 52 6f 6f 74 00 00 65 78 70 6c 6f 72 65 72 20 68 74 74 70 3a 2f 2f 90 02 30 2e 70 64 66 90 00 } //3
