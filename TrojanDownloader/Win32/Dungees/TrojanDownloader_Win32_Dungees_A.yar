...
rule TrojanDownloader_Win32_Dungees_A{
	...
	strings :
		...
		$a_00_2 = {2f 00 73 00 75 00 63 00 63 00 65 00 73 00 73 00 2e 00 65 00 78 00 65 00 } //01 00  /success.exe
		$a_00_3 = {2f 00 70 00 6f 00 72 00 74 00 72 00 61 00 69 00 74 00 2e 00 65 00 78 00 65 00 } //00 00  /portrait.exe
	condition:
		any of ($a_*)
