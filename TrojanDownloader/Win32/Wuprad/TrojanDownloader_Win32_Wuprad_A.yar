...
rule TrojanDownloader_Win32_Wuprad_A{
	...
	strings :
		...
		$a_03_1 = {10 27 00 00 7d 0a 6a 05 e8 90 01 04 83 c4 04 6a 01 90 00 } //1
		$a_03_2 = {8b 44 24 04 ff 24 95 90 01 04 68 90 01 04 51 68 90 01 04 50 ff 15 90 01 04 83 c4 10 b8 01 00 00 00 c3 90 00 } //1
	condition:
