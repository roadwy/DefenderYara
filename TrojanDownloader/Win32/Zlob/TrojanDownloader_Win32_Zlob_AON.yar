...
rule TrojanDownloader_Win32_Zlob_AON{
	...
	strings :
		...
		$a_00_1 = {44 33 35 38 2d 34 38 41 33 2d 41 35 43 37 } //01 00 
...
rule TrojanDownloader_Win32_Zlob_AON_2{
	...
	strings :
		$a_01_0 = {62 65 65 67 72 6f 63 6b 73 2e 64 6c 6c } //01 00 
		$a_01_1 = {7b 00 36 00 34 00 34 00 36 00 36 00 42 00 38 00 45 00 2d 00 32 00 30 00 41 00 37 00 2d 00 34 00 41 00 34 00 41 00 2d 00 41 00 46 00 46 00 34 00 2d 00 41 00 41 00 44 00 39 00 43 00 41 00 36 00 38 00 42 00 35 00 32 00 43 00 7d 00 } //01 00 
