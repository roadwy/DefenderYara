...
rule TrojanDownloader_Win32_Zlob_gen_W{
	...
	strings :
		...
		$a_01_1 = {4f 70 65 6e 45 76 65 6e 74 57 } //01 00 
		...
		$a_01_4 = {62 00 78 00 31 00 38 00 64 00 78 00 76 00 2e 00 64 00 61 00 74 00 } //01 00 
		$a_01_5 = {4d 00 79 00 42 00 49 00 54 00 53 00 54 00 72 00 61 00 6e 00 73 00 5f 00 6e 00 65 00 77 00 } //00 00 
	condition:
		any of ($a_*)
