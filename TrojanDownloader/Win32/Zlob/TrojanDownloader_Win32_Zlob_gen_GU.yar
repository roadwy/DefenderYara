...
rule TrojanDownloader_Win32_Zlob_gen_GU{
	meta:
		description = "TrojanDownloader:Win32/Zlob.gen!GU,SIGNATURE_TYPE_PEHSTR,0c 00 0c 00 0c 00 00 "
		
	strings :
		$a_01_0 = {e8 00 00 00 00 5d 81 ed 49 2b 40 00 e8 03 02 00 00 e8 c6 06 00 00 b8 00 00 00 00 85 c0 75 21 ff 85 5b 2b 40 00 e8 63 01 00 00 60 8d 50 2d d0 0a 71 e3 eb 03 } //1
		...
		$a_01_11 = {28 00 00 00 20 00 00 00 40 00 00 00 01 00 20 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 63 61 60 0c 64 62 61 2b 6c 6a 69 4c 74 72 71 64 74 72 71 6e 72 70 70 6f 6b 69 69 69 5c 5b 5a 58 54 52 51 43 55 53 52 2a 5a 58 } //1
	condition:
