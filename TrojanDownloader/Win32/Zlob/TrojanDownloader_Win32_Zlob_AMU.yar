...
rule TrojanDownloader_Win32_Zlob_AMU{
	...
	strings :
		$a_03_0 = {53 4f 46 54 57 41 52 45 20 49 4e 53 54 41 4c 4c 41 54 49 4f 4e 3a 90 05 05 01 20 43 6f 6d 70 6f 6e 65 6e 74 73 20 62 75 6e 64 6c 65 64 20 77 69 74 68 20 6f 75 72 20 73 6f 66 74 77 61 72 65 20 6d 61 79 90 05 05 01 20 66 65 65 64 90 05 05 01 20 62 61 63 6b 20 74 6f 20 4c 69 63 65 6e 73 6f 72 90 00 } //2
