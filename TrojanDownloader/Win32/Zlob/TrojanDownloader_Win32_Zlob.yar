...
rule TrojanDownloader_Win32_Zlob_6{
	...
	strings :
		$a_02_0 = {85 c0 75 14 68 2c 01 00 00 6a 08 ff 15 ?? ?? ?? ?? 50 ff 15 ?? ?? ?? ?? 56 8b 74 24 08 8a 16 84 d2 a3 ?? ?? ?? ?? 8b c8 74 10 2b f0 32 54 24 0c 88 11 41 8a 14 0e 84 d2 75 f2 c6 01 00 5e c3 } //1
...
rule TrojanDownloader_Win32_Zlob_16{
	meta:
