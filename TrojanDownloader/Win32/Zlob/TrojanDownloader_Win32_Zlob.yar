...
rule TrojanDownloader_Win32_Zlob{
	...
	strings :
		...
		$a_00_8 = {53 4f 46 54 57 41 52 45 5c 47 52 45 41 54 49 53 5c 52 45 47 52 55 4e 32 5c } //65036 SOFTWARE\GREATIS\REGRUN2\
	condition:
		((#a_01_0  & 1)*100+(#a_01_1  & 1)*100+(#a_00_2  & 1)*100+(#a_00_3  & 1)*50+(#a_01_4  & 1)*50+(#a_01_5  & 1)*10+(#a_00_6  & 1)*10+(#a_00_7  & 1)*10+(#a_00_8  & 1)*65036) >=420
