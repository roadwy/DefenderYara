...
rule TrojanDownloader_Win32_Zlob_AMT{
	...
	strings :
		...
		$a_01_2 = {2f 63 6f 6e 66 69 72 6d 2e 70 68 70 3f 61 69 64 3d 25 6c 75 26 73 61 69 64 3d 25 6c 75 26 6d 61 63 3d 25 73 26 68 61 73 68 3d 25 73 26 6d 6e 3d 25 6c 75 00 } //01 00  振湯楦浲瀮灨愿摩┽畬猦楡㵤氥♵慭㵣猥栦獡㵨猥洦㵮氥u
