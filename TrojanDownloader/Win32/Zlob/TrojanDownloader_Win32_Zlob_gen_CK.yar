...
rule TrojanDownloader_Win32_Zlob_gen_CK{
	...
	strings :
		$a_01_0 = {20 4e 41 56 20 67 75 79 73 } //01 00   NAV guys
		$a_01_1 = {56 43 32 30 58 43 30 30 } //01 00  VC20XC00
		$a_01_2 = {4e 61 6d 32 } //01 00  Nam2
		$a_01_3 = {49 45 56 55 } //03 00  IEVU
