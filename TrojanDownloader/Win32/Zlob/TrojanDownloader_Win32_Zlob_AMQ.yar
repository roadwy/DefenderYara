...
rule TrojanDownloader_Win32_Zlob_AMQ{
	...
	strings :
		...
		$a_02_9 = {00 00 83 c4 10 85 c0 74 90 01 01 6a 01 68 90 01 04 e8 90 01 02 ff ff 90 02 48 74 90 01 01 6a 02 68 90 01 04 e8 90 01 02 ff ff 90 02 48 74 90 01 01 6a 03 68 90 01 04 e8 90 01 02 ff ff 90 00 } //3
		$a_02_10 = {6a 00 c6 44 24 90 01 01 47 c6 44 24 90 01 01 45 c6 44 24 90 01 01 54 c6 44 24 90 01 01 00 90 00 } //3
	condition:
