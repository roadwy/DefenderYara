...
rule TrojanDownloader_Win32_Zlob_JN{
	...
	strings :
		...
		$a_03_1 = {10 75 2b 09 1d 90 01 03 10 83 65 fc 00 8d 45 90 01 01 50 8d 45 90 01 01 50 b9 90 01 03 10 e8 90 01 02 ff ff 68 90 01 03 10 e8 90 01 03 00 83 4d fc ff 90 00 } //1
	condition:
