...
rule TrojanDownloader_Win32_Zlob_gen_CE{
	...
	strings :
		...
		$a_01_1 = {72 65 61 6c 2e 64 6c 6c 00 44 6c 6c } //01 00  敲污搮汬䐀汬
		$a_00_2 = {72 00 65 00 73 00 3a 00 2f 00 2f 00 25 00 73 00 } //01 00  res://%s
		$a_00_3 = {72 00 25 00 73 00 73 00 3a 00 2f 00 2f 00 25 00 73 00 } //00 00  r%ss://%s
	condition:
		any of ($a_*)
