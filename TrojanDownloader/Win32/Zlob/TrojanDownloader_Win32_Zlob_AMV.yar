...
rule TrojanDownloader_Win32_Zlob_AMV{
	...
	strings :
		...
		$a_01_7 = {5f 5f 50 4d 32 5f 55 50 44 5f 5f } //02 00  __PM2_UPD__
		$a_01_8 = {69 65 62 74 6d 2e 65 78 65 00 } //02 00 
		$a_01_9 = {00 66 75 63 6b 00 } //02 00  昀捵k
		$a_01_10 = {6d 6d 6d 00 77 74 66 00 } //01 00  浭m瑷f
		$a_01_11 = {3f 4e 3d 53 37 50 25 31 2e 31 64 4e 38 4b 33 } //01 00  ?N=S7P%1.1dN8K3
		$a_01_12 = {67 61 74 65 2e 70 68 70 } //01 00  gate.php
		$a_01_13 = {64 75 6d 62 00 } //01 00 
		$a_01_14 = {25 64 2e 62 61 74 00 } //01 00 
		$a_01_15 = {53 6f 66 74 77 61 72 65 5c 41 70 70 6c 69 63 61 74 69 6f 6e 73 00 } //01 00  潓瑦慷敲䅜灰楬慣楴湯s
		$a_01_16 = {5f 5f 49 53 43 } //01 00  __ISC
		$a_01_17 = {5f 4d 4d 5f 46 } //00 00  _MM_F
	condition:
		any of ($a_*)
