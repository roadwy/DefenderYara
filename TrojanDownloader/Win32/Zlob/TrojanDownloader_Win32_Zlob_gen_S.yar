...
rule TrojanDownloader_Win32_Zlob_gen_S{
	meta:
		description = "TrojanDownloader:Win32/Zlob.gen!S,SIGNATURE_TYPE_PEHSTR_EXT,1f 00 1f 00 05 00 00 "
	...
	condition:
		((#a_01_0  & 1)*10+(#a_01_1  & 1)*10+(#a_01_2  & 1)*5+(#a_01_3  & 1)*5+(#a_00_4  & 1)*1) >=31
