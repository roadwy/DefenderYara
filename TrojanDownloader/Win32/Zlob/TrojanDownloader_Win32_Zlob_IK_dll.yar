...
rule TrojanDownloader_Win32_Zlob_IK_dll{
	...
	strings :
		$a_01_0 = {61 74 66 78 71 6f 67 70 2e 44 4c 4c } //01 00 
		$a_01_1 = {44 6c 6c 52 65 67 69 73 74 65 72 53 65 72 76 65 72 } //01 00 
		$a_00_2 = {5c 00 49 00 6d 00 70 00 6c 00 65 00 6d 00 65 00 6e 00 74 00 65 00 64 00 20 00 43 00 61 00 74 00 65 00 67 00 6f 00 72 00 69 00 65 00 73 00 } //01 00 
		$a_00_3 = {61 00 74 00 66 00 78 00 71 00 6f 00 67 00 70 00 54 00 4f 00 4f 00 4c 00 42 00 41 00 52 00 } //01 00 
		$a_00_4 = {46 00 6f 00 72 00 63 00 65 00 52 00 65 00 6d 00 6f 00 76 00 65 00 } //0a 00 
