...
rule TrojanDownloader_Win32_Zlob_ZWV{
	...
	strings :
		$a_03_0 = {bb 65 00 00 00 e8 90 01 02 ff ff 80 3e 00 75 0f e8 90 01 02 ff ff 6a 0a e8 90 01 02 ff ff 4b 75 e7 c6 06 00 bb 11 27 00 00 e8 90 01 02 ff ff 80 3e 00 75 0a 6a 0a e8 90 01 02 ff ff 90 00 } //2
