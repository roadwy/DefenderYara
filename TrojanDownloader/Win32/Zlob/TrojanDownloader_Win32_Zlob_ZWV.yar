...
rule TrojanDownloader_Win32_Zlob_ZWV{
	...
	strings :
		...
		$a_00_1 = {43 3a 5c 54 45 4d 50 5c 62 75 64 67 65 74 2e 78 70 69 } //01 00  C:\TEMP\budget.xpi
		$a_00_2 = {4d 6f 7a 69 6c 6c 61 55 49 57 69 6e 64 6f 77 43 6c 61 73 73 } //01 00  MozillaUIWindowClass
		$a_00_3 = {53 4f 46 54 57 41 52 45 5c 4d 6f 7a 69 6c 6c 61 5c 4d 6f 7a 69 6c 6c 61 20 46 69 72 65 66 6f 78 } //00 00  SOFTWARE\Mozilla\Mozilla Firefox
	condition:
		any of ($a_*)
