...
rule TrojanDownloader_Win32_Zlob_gen_M{
	...
	strings :
		...
		$a_01_3 = {45 6e 63 6f 64 65 50 6f 69 6e 74 65 72 } //0a 00 
		$a_01_4 = {49 73 44 65 62 75 67 67 65 72 50 72 65 73 65 6e 74 } //0a 00 
		$a_01_5 = {65 00 78 00 70 00 6c 00 6f 00 72 00 65 00 72 00 2e 00 65 00 78 00 65 00 } //0a 00 
		$a_01_6 = {47 65 74 50 72 6f 63 65 73 73 57 69 6e 64 6f 77 53 74 61 74 69 6f 6e } //0a 00 
		$a_01_7 = {47 65 74 41 63 74 69 76 65 57 69 6e 64 6f 77 } //00 00 
	condition:
		any of ($a_*)
...
rule TrojanDownloader_Win32_Zlob_gen_M_2{
	...
	strings :
		...
		$a_01_19 = {42 68 6f 4e 65 77 2e 44 4c 4c } //0a 00 
		$a_01_20 = {45 6e 63 6f 64 65 50 6f 69 6e 74 65 72 } //0a 00 
		$a_01_21 = {49 6e 74 65 72 6e 65 74 41 74 74 65 6d 70 74 43 6f 6e 6e 65 63 74 } //0a 00 
		$a_01_22 = {49 73 44 65 62 75 67 67 65 72 50 72 65 73 65 6e 74 } //05 00 
		$a_01_23 = {65 00 78 00 70 00 6c 00 6f 00 72 00 65 00 72 00 2e 00 65 00 78 00 65 00 } //00 00 
	condition:
		any of ($a_*)
...
rule TrojanDownloader_Win32_Zlob_gen_M_3{
	...
	strings :
		...
		$a_01_18 = {b5 64 7d c8 92 df 03 47 90 cb b4 65 b6 98 29 41 } //32 00 
		$a_01_19 = {42 68 6f 4e 65 77 2e 44 4c 4c } //0a 00 
		$a_01_20 = {73 00 65 00 61 00 72 00 63 00 68 00 2e 00 6d 00 73 00 6e 00 2e 00 63 00 6f 00 6d 00 2f 00 64 00 6e 00 73 00 65 00 72 00 72 00 6f 00 72 00 2e 00 61 00 73 00 70 00 78 00 } //0a 00 
		$a_01_21 = {45 6e 63 6f 64 65 50 6f 69 6e 74 65 72 } //0a 00 
		$a_01_22 = {49 6e 74 65 72 6e 65 74 41 74 74 65 6d 70 74 43 6f 6e 6e 65 63 74 } //0a 00 
		$a_01_23 = {49 73 44 65 62 75 67 67 65 72 50 72 65 73 65 6e 74 } //00 00 
	condition:
		any of ($a_*)
