...
rule TrojanDownloader_Win32_Zlob_ZWD{
	...
	strings :
		...
		$a_02_3 = {53 6f 66 74 77 61 72 65 5c 4d 69 63 72 6f 73 6f 66 74 5c 57 69 6e 64 6f 77 73 5c 43 75 72 72 65 6e 74 56 65 72 73 69 6f 6e 5c 55 6e 69 6e 73 74 61 6c 6c 5c ?? ?? ?? ?? ?? 20 41 64 64 2d 6f 6e } //1
