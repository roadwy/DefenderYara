...
rule TrojanDownloader_Win32_Zlob_gen_AC{
	...
	strings :
		...
		$a_02_11 = {2f 63 20 64 65 6c 90 02 05 25 73 90 02 05 3e 3e 90 02 05 6e 75 6c 6c 00 90 00 } //10
		$a_02_12 = {6a 00 6a 04 6a 02 6a 00 6a 01 68 00 00 00 40 68 90 01 02 40 00 e8 90 01 04 83 f8 ff 75 0c 90 00 } //100
