...
rule TrojanDownloader_Win32_Abcexp_A{
	...
	strings :
		$a_00_0 = {77 69 6e 64 6f 77 73 5c 73 79 73 74 65 6d 33 32 5c 65 78 70 31 6f 72 65 72 2e 65 78 65 } //02 00 
		$a_00_1 = {32 31 37 2e 31 37 2e 34 31 2e 39 33 } //02 00 
		...
		$a_00_4 = {44 6f 73 43 6f 6d 6d 61 6e 64 31 4e 65 77 4c 69 6e 65 } //00 00 
	condition:
		any of ($a_*)
