...
rule TrojanDownloader_Win32_Dimegup_A{
	...
	strings :
		$a_00_0 = {5c 6d 5f 65 64 69 74 65 72 72 6f 72 2e 74 6d 70 } //01 00 
		$a_00_1 = {68 74 74 70 3a 2f 2f 6e 65 74 77 6f 72 6b 73 65 63 75 72 69 74 79 78 2e 68 6f 70 74 6f 2e 6f 72 67 } //01 00 
		$a_00_2 = {78 78 78 78 5f 78 78 78 78 5f 78 78 78 78 } //01 00 
