...
rule TrojanDownloader_Win32_CoinMiner_QE_bit{
	...
	strings :
		...
		$a_03_3 = {24 65 6e 76 3a 41 50 50 44 41 54 41 5c 75 70 64 61 74 65 5c 90 02 10 2e 65 78 65 90 00 } //1
		$a_03_4 = {34 2e 70 72 6f 67 72 61 6d 2d 69 71 2e 63 6f 6d 2f 75 70 6c 6f 61 64 73 2f 90 02 20 2e 6a 70 67 90 00 } //1
	condition:
