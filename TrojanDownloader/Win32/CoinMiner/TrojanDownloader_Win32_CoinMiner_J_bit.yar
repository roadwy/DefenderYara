...
rule TrojanDownloader_Win32_CoinMiner_J_bit{
	...
	strings :
		$a_01_0 = {68 74 74 70 3a 2f 2f 77 68 61 74 61 6d 69 2e 75 73 2e 74 6f 2f 74 63 } //01 00  http://whatami.us.to/tc
		$a_01_1 = {6f 70 74 69 6f 6e 73 00 63 66 69 6c 65 00 63 63 61 72 67 73 } //01 00  灯楴湯s晣汩e捣牡獧
