...
rule TrojanDownloader_Win32_CoinMiner_M{
	...
	strings :
		...
		$a_03_6 = {68 74 74 70 3a 2f 2f 90 1d 05 00 2e 66 74 70 68 6f 73 74 69 6e 67 2e 70 77 2f 75 73 65 72 38 31 32 34 39 2f 34 39 31 38 2f 90 10 05 00 2e 74 78 74 90 00 } //1
	condition:
