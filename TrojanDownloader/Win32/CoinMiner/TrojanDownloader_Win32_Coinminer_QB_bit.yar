...
rule TrojanDownloader_Win32_Coinminer_QB_bit{
	...
	strings :
		$a_03_0 = {68 74 74 70 3a 2f 2f 69 6e 6e 66 69 6e 69 74 69 2e 75 63 6f 7a 2e 6e 65 74 2f 90 02 10 2e 7a 69 70 90 00 } //3
		$a_03_1 = {46 69 6c 65 44 65 6c 65 74 65 2c 20 43 3a 5c 50 72 6f 67 72 61 6d 44 61 74 61 5c 90 02 10 2e 76 62 73 90 00 } //2
