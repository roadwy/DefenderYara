...
rule TrojanDownloader_Win32_CoinMiner_K_bit{
	...
	strings :
		...
		$a_03_2 = {c7 04 24 00 00 00 00 e8 0a 46 02 00 89 04 24 e8 0a 46 02 00 e8 0d 46 02 00 b9 05 00 00 00 89 5c 24 90 01 01 8d 9d 90 01 04 89 1c 24 99 f7 f9 8b 04 95 90 01 04 89 44 24 90 01 01 ff 15 1c 54 43 00 90 00 } //1
