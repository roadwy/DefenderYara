...
rule TrojanDownloader_Win32_Talalpek_A{
	...
	strings :
		$a_03_0 = {6a 00 6a 0d 6a 05 68 df 07 00 00 68 ?? ?? 40 00 e8 ?? ?? ff ff 85 c0 74 0a c7 05 ?? ?? ?? 00 02 00 00 00 eb } //2
		$a_03_1 = {53 57 68 00 00 10 00 ff 15 ?? ?? 40 00 8b f0 85 f6 75 04 33 c0 eb ?? 68 10 27 00 00 56 ff 15 } //2
		$a_03_2 = {68 20 bf 02 00 50 ff 15 ?? ?? 40 00 33 f6 85 c0 74 ?? 56 ff 35 ?? ?? ?? 00 ff 15 } //2
		$a_03_3 = {51 0f 57 c0 66 0f 13 45 ?? 6a 33 e8 00 00 00 00 } //2
		$a_01_4 = {54 8f 45 f8 e8 00 00 00 00 c7 44 24 04 23 00 00 00 83 04 24 0d cb } //2
		$a_03_5 = {0f b6 c2 03 c8 0f b6 c1 8b 4d f8 8a 84 05 ?? ?? ff ff 30 04 0f 47 3b 7d fc 72 } //1
