...
rule TrojanDownloader_Win32_VidarStealer_SIB_MTB{
	...
	strings :
		...
		$a_03_2 = {8b d8 8b 45 90 01 01 8b 00 03 45 90 01 01 03 d8 90 02 20 2b d8 8b 45 90 1b 00 89 18 90 02 20 8b 90 03 01 01 45 55 90 1b 00 31 90 03 01 01 18 02 90 02 20 8b d8 90 02 20 2b d8 90 02 20 8b 45 90 1b 01 3b 45 90 00 } //1
	condition:
