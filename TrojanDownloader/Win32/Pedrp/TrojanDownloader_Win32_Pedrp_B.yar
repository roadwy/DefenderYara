...
rule TrojanDownloader_Win32_Pedrp_B{
	...
	strings :
		...
		$a_02_1 = {3d 94 01 00 00 74 ?? 3d 93 01 00 00 74 ?? 8d 54 24 ?? 8d 44 24 ?? 52 8d 4c 24 ?? 50 51 68 05 00 00 20 56 89 6c 24 24 c7 44 24 38 04 00 00 00 89 6c 24 3c ff d7 } //1
