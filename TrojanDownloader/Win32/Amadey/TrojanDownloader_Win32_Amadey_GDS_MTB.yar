...
rule TrojanDownloader_Win32_Amadey_GDS_MTB{
	...
	strings :
		$a_03_0 = {0f 43 ca 03 c1 3b f0 74 59 8b 45 e0 8b 57 10 8a 0c 30 32 0e 88 4d f0 3b 57 14 73 26 83 7f 14 10 8d 42 01 89 47 10 8b c7 72 ?? 8b 07 88 0c 10 46 c6 44 10 01 00 a1 ?? ?? ?? ?? 8b 15 ?? ?? ?? ?? eb } //10
