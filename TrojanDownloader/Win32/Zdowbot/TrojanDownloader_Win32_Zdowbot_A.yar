...
rule TrojanDownloader_Win32_Zdowbot_A_3{
	...
	strings :
		...
		$a_01_2 = {47 55 49 44 3d 25 49 36 34 75 26 42 55 49 4c 44 3d 25 73 26 49 4e 46 4f 3d 25 73 26 49 50 3d 25 73 26 54 59 50 45 3d 31 26 57 49 4e 3d 25 64 2e 25 64 28 25 73 29 } //00 00 
		$a_00_3 = {80 10 } //00 00 
	condition:
		any of ($a_*)
