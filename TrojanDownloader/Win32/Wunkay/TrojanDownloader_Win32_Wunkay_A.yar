...
rule TrojanDownloader_Win32_Wunkay_A{
	...
	strings :
		...
		$a_02_1 = {85 c0 74 0c 68 90 03 03 03 40 77 1b e0 8c 1a 00 e8 90 01 01 00 00 00 eb 90 01 01 8d 85 90 01 01 f9 ff ff 8d 95 90 01 01 fb ff ff 6a 00 6a 00 50 52 6a 00 90 00 } //1
		$a_02_2 = {8d 43 f0 50 8d 43 ac 50 90 03 09 0a 33 d2 52 52 52 52 52 52 52 33 c0 b9 07 00 00 00 50 e2 fd 90 00 } //1
		...
		$a_02_5 = {00 07 47 e2 fb 68 90 01 02 00 10 64 ff 35 00 00 00 00 64 89 25 00 00 00 00 e8 90 01 01 00 00 00 90 00 } //1
	condition:
