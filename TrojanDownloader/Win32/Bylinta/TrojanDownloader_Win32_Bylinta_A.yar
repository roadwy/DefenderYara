...
rule TrojanDownloader_Win32_Bylinta_A{
	...
	strings :
		...
		$a_01_4 = {41 56 50 2e 50 72 6f 64 75 63 74 5f 4e 6f 74 69 66 69 63 61 74 69 6f 6e } //02 00 
		$a_01_5 = {43 43 61 74 62 79 6c 69 6e } //01 00 
		$a_01_6 = {5b 25 30 32 58 25 30 32 58 25 30 32 58 25 30 32 58 25 30 32 58 25 30 32 58 5d } //01 00 
		$a_01_7 = {41 6e 67 65 6c 49 45 2f 31 2e 30 } //00 00 
	condition:
		any of ($a_*)
