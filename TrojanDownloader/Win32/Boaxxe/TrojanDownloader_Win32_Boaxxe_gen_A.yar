...
rule TrojanDownloader_Win32_Boaxxe_gen_A{
	...
	strings :
		...
		$a_01_1 = {47 6c 6f 62 61 6c 5c 61 6c 61 7a 68 6b 76 6b 70 72 6d 69 64 } //01 00  Global\alazhkvkprmid
		$a_01_2 = {4d 6f 7a 69 6c 6c 61 2f 34 2e 30 20 28 63 6f 6d 70 61 74 69 62 6c 65 3b 20 4d 53 49 45 20 36 2e 30 3b 20 57 69 6e 64 6f 77 73 20 4e 54 20 35 2e 31 3b 20 53 56 31 3b 20 2e 4e 45 54 20 43 4c 52 20 32 2e 30 2e 35 30 37 32 37 29 } //00 00  Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.1; SV1; .NET CLR 2.0.50727)
	condition:
		any of ($a_*)
