...
rule TrojanDownloader_Win32_Stration_CC{
	...
	strings :
		...
		$a_02_1 = {68 74 74 70 3a 2f 2f 90 05 40 03 61 2d 7a 2e 63 6f 6d 2f 64 66 72 67 33 32 2e 65 78 65 } //10
		$a_02_2 = {48 6f 73 74 3a 20 90 05 40 03 61 2d 7a 2e 63 6f 6d } //10
	condition:
