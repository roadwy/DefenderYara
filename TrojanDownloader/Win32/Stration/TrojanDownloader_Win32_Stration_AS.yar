...
rule TrojanDownloader_Win32_Stration_AS{
	...
	strings :
		$a_01_0 = {47 45 54 20 2f 62 74 63 68 65 63 6b 2e 65 78 65 20 48 54 54 50 2f 31 2e 31 } //01 00 
		$a_01_1 = {47 45 54 20 2f 77 69 6e 63 68 33 32 2e 65 78 65 20 48 54 54 50 2f 31 2e 31 } //0a 00 
