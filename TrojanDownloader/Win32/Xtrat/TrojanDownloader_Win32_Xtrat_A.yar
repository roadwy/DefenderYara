...
rule TrojanDownloader_Win32_Xtrat_A{
	...
	strings :
		...
		$a_00_1 = {54 00 6f 00 70 00 4d 00 6f 00 64 00 65 00 6c 00 2d 00 78 00 2d 00 } //01 00 
		$a_00_2 = {50 00 61 00 73 00 73 00 77 00 6f 00 72 00 64 00 2e 00 65 00 78 00 65 00 } //01 00 
		$a_00_3 = {43 00 4f 00 52 00 45 00 2e 00 63 00 63 00 63 00 3f 00 61 00 74 00 74 00 72 00 65 00 64 00 69 00 72 00 65 00 63 00 74 00 73 00 3d 00 30 00 26 00 64 00 3d 00 31 00 } //00 00 
	condition:
		any of ($a_*)
