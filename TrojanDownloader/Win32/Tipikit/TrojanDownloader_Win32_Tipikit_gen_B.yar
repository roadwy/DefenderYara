...
rule TrojanDownloader_Win32_Tipikit_gen_B{
	...
	strings :
		...
		$a_00_3 = {43 72 65 61 74 65 46 69 6c 65 41 } //0a 00 
		$a_00_4 = {43 72 65 61 74 65 50 72 6f 63 65 73 73 41 } //0a 00 
		$a_00_5 = {55 52 4c 44 6f 77 6e 6c 6f 61 64 54 6f 46 69 6c 65 41 } //0a 00 
		$a_00_6 = {53 4f 46 54 57 41 52 45 5c 4d 69 63 72 6f 73 6f 66 74 5c 57 69 6e 64 6f 77 73 5c 43 75 72 72 65 6e 74 56 65 72 73 69 6f 6e 5c 52 75 6e } //0a 00 
		$a_01_7 = {43 3a 5c 57 49 4e 44 4f 57 53 5c 53 59 53 54 45 4d 33 32 4b 42 52 75 6e 4f 6e 63 65 32 2e 74 6d 5f } //0a 00 
