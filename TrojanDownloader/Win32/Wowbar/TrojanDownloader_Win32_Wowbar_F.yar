...
rule TrojanDownloader_Win32_Wowbar_F{
	...
	strings :
		...
		$a_00_1 = {68 74 74 70 3a 2f 2f 63 6f 6d 6d 2e 77 6f 77 74 6f 6f 6c 62 61 72 2e 63 6f 2e 6b 72 } //01 00 
		$a_00_2 = {42 41 43 4b 4d 41 4e } //01 00 
		$a_00_3 = {57 54 5f 47 45 54 5f 43 4f 4d 4d } //00 00 
	condition:
		any of ($a_*)
