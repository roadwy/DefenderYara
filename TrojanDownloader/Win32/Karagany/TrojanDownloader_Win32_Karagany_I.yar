...
rule TrojanDownloader_Win32_Karagany_I{
	...
	strings :
		$a_00_0 = {73 68 6f 77 74 68 72 65 61 64 2e 70 68 70 3f 74 3d } //01 00  showthread.php?t=
		$a_00_1 = {63 6d 64 2e 65 78 65 20 2f 63 20 70 69 6e 67 20 2d 6e 20 31 20 2d 77 } //02 00  cmd.exe /c ping -n 1 -w
