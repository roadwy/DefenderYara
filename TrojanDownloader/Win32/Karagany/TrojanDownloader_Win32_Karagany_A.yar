...
rule TrojanDownloader_Win32_Karagany_A{
	...
	strings :
		...
		$a_01_1 = {68 7c 62 72 78 77 6b 6a 73 2a } //01 00 
		$a_01_2 = {65 6e 62 70 75 6f 61 74 70 3c 6d 60 3e 72 71 } //01 00 
		$a_01_3 = {7a 7d 3f 69 75 6f 7b 75 3f 62 66 7f } //01 00 
		$a_01_4 = {65 64 65 7f 7c 77 21 73 7e 7f } //00 00 
	condition:
		any of ($a_*)
