...
rule TrojanDownloader_Win32_Lukicsel_A{
	...
	strings :
		$a_03_0 = {8b 4d 0c 8b 09 8b 75 08 8b 36 4e a0 90 01 04 30 04 31 e2 fb 90 00 } //1
...
rule TrojanDownloader_Win32_Lukicsel_A_2{
	...
	strings :
		$a_03_0 = {42 48 75 f1 e8 90 09 05 00 80 74 11 ff 90 00 } //1
		$a_03_1 = {8a 54 3a ff 80 f2 90 01 01 e8 90 01 04 8b 55 f8 8b c6 90 00 } //1
