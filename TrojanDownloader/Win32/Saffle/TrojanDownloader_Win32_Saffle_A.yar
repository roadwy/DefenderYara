...
rule TrojanDownloader_Win32_Saffle_A{
	...
	strings :
		$a_02_0 = {68 d0 07 00 00 ff 15 ?? ?? ?? ?? ff 15 [0-20] 3d e8 03 00 00 7c 26 3d d0 07 00 00 7d 1f } //1
		...
		$a_03_3 = {2b c2 3d e8 03 00 00 7c 26 3d d0 07 00 00 7d 1f 6a ff 6a 00 6a 00 ff 15 ?? ?? 40 00 85 c0 75 0f } //3
	condition:
