...
rule TrojanDownloader_Win32_Paxer_A{
	...
	strings :
		$a_01_0 = {49 46 20 65 78 69 73 74 20 22 25 73 22 20 47 4f 54 4f 20 41 41 41 } //01 00 
		$a_01_1 = {49 46 20 65 78 69 73 74 20 22 25 73 22 20 47 4f 54 4f 20 42 42 42 } //01 00 
		$a_01_2 = {63 6f 6e 74 65 6e 74 2e 64 61 74 } //01 00 
		$a_03_3 = {66 6c 61 73 68 70 6c 61 79 65 72 5f 90 02 10 2e 65 78 65 00 90 00 } //01 00 
		$a_01_4 = {25 73 5c 64 65 6c 65 74 65 6d 65 2e 62 61 74 } //01 00 
