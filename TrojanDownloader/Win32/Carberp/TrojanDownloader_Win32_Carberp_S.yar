...
rule TrojanDownloader_Win32_Carberp_S{
	...
	strings :
		...
		$a_01_1 = {73 26 73 74 61 74 70 61 73 73 3d 25 73 } //01 00  s&statpass=%s
		$a_01_2 = {2e 61 70 61 72 74 6d 73 6b 2e 72 75 } //01 00  .apartmsk.ru
		$a_01_3 = {2e 72 75 70 6f 72 6e 6f 2e 74 76 } //00 00  .ruporno.tv
	condition:
		any of ($a_*)
