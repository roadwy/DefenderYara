...
rule TrojanDownloader_Win32_Carberp_A{
	...
	strings :
		...
		$a_03_1 = {ac 84 c0 74 09 2c ?? 34 ?? 04 ?? aa eb f2 aa } //1
		$a_03_2 = {8b 40 28 59 85 c0 74 ?? 03 c3 74 0d 6a 00 33 (f6 46 56|ff 47 57) 53 ff d0 } //1
		$a_03_3 = {68 35 bf a0 be 6a 01 6a 00 e8 ?? ?? ff ff 83 c4 0c ff 75 18 ff 75 14 ff 75 10 ff 75 0c ff 75 08 ff d0 } //1
		$a_03_4 = {68 b3 74 18 e6 6a 01 6a 00 e8 ?? ?? ff ff 83 c4 0c ff 75 20 ff 75 1c ff 75 18 ff 75 14 ff 75 10 ff 75 0c ff 75 08 ff d0 } //1
		$a_03_5 = {35 bf a0 be c7 45 ?? 8f 88 d6 9b } //1
		$a_03_6 = {b3 74 18 e6 c7 45 ?? 35 bf a0 be } //1
