...
rule TrojanDownloader_Win32_Carberp_BS{
	...
	strings :
		$a_03_0 = {80 30 4d 40 39 d0 75 90 01 01 89 4c 24 08 89 5c 24 04 c7 04 24 90 01 04 e8 90 01 04 e8 90 01 04 81 c4 10 28 00 00 90 00 } //1
		...
		$a_03_3 = {31 ee 0f b6 ee 0f b6 2c ed 90 01 04 c1 e5 08 31 ee 0f b6 ef 0f b6 2c ed 90 01 04 c1 e5 18 31 ee 0f b6 ea 0f b6 2c ed 90 01 04 31 ef 0f b6 ec 0f b6 2c ed 90 01 04 c1 e5 08 31 ef 90 00 } //10
	condition:
