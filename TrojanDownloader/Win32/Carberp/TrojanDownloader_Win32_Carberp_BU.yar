...
rule TrojanDownloader_Win32_Carberp_BU{
	...
	strings :
		$a_03_0 = {55 5f 42 54 5f 56 45 52 3a 90 02 0a 00 90 00 } //1
		$a_01_1 = {45 53 54 52 5f 50 41 53 53 5f 00 } //1
		$a_03_2 = {5f 44 4c 4c 5f 44 41 54 41 5f 90 02 10 4d 5a 90 00 } //2
		$a_03_3 = {8e fe 1f 4b 90 03 01 01 e8 74 90 00 } //3
