...
rule TrojanDownloader_Win32_Carberp_G{
	...
	strings :
		...
		$a_03_2 = {eb 5c c6 45 90 01 01 4c c6 45 90 01 01 65 c6 45 90 01 01 74 c6 45 90 01 01 73 c6 45 90 01 01 44 c6 45 90 01 01 61 c6 45 90 01 01 6e c6 45 90 01 01 63 c6 45 90 01 01 65 c6 45 90 01 01 00 90 00 } //2
		...
		$a_03_5 = {8b 43 28 03 45 90 01 01 c6 00 68 40 8b 55 90 01 01 89 10 83 c0 04 c6 00 c3 90 00 } //2
		$a_03_6 = {b8 5c 00 00 00 66 89 90 01 02 b9 73 00 00 00 66 89 90 01 02 ba 6d 00 00 00 66 89 90 01 02 b8 73 00 00 00 66 89 90 01 02 b9 73 90 00 } //2
		$a_03_7 = {83 fa 63 75 7e 0f b7 45 90 01 01 83 f8 06 74 05 e9 90 00 } //2
