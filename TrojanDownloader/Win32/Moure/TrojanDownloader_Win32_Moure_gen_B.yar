...
rule TrojanDownloader_Win32_Moure_gen_B{
	...
	strings :
		...
		$a_00_1 = {4d 53 41 53 43 75 69 2e 65 78 65 } //01 00 
		$a_00_2 = {4d 70 43 6d 64 52 75 6e 2e 65 78 65 } //01 00 
		$a_00_3 = {4d 73 4d 70 45 6e 67 2e 65 78 65 } //01 00 
		$a_00_4 = {4e 69 73 53 72 76 2e 65 78 65 } //01 00 
		$a_00_5 = {6d 73 73 65 63 65 73 2e 65 78 65 } //0a 00 
