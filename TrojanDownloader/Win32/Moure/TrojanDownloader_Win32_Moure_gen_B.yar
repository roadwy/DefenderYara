...
rule TrojanDownloader_Win32_Moure_gen_B{
	...
	strings :
		$a_03_0 = {35 e1 7a d7 af 3b ce 73 90 01 01 8b 54 24 90 01 01 8b 14 11 8b 7c 24 90 01 01 33 d0 89 14 0f 83 c1 04 3b ce 90 00 } //10
		...
		$a_03_6 = {8d 50 01 8a 08 40 3a cb 75 90 01 01 2b c2 3b c3 74 90 01 01 80 bc 04 9f 00 00 00 5c 74 90 01 01 c6 84 04 a0 00 00 00 5c 40 90 00 } //10
	condition:
