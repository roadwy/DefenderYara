...
rule TrojanDownloader_Win32_Uloadis_A{
	...
	strings :
		...
		$a_03_4 = {be 00 40 00 00 6a 04 68 00 30 00 00 56 6a 00 e8 90 01 02 ff ff 8b d8 85 db 74 45 6a 00 56 53 55 e8 90 01 02 ff ff 8b f8 81 ff 04 00 00 c0 75 13 68 00 80 00 00 90 00 } //3
		$a_03_5 = {66 81 3b 4d 5a 75 90 01 01 03 43 3c 0f b7 48 14 81 f9 e0 00 00 00 75 90 01 01 8b d0 83 c2 18 8b ca 81 c1 e0 00 00 00 90 00 } //1
	condition:
