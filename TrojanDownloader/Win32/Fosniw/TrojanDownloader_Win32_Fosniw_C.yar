...
rule TrojanDownloader_Win32_Fosniw_C{
	...
	strings :
		...
		$a_03_3 = {2f 72 65 63 65 69 76 65 2f 72 5f 61 75 74 6f 69 64 63 6e 74 2e 61 73 70 3f 6d 65 72 5f 73 65 71 3d 25 73 26 72 65 61 6c 69 64 3d 25 73 26 63 6e 74 5f 74 79 70 65 3d 90 02 02 26 6d 61 63 3d 25 73 90 00 } //5
