...
rule TrojanDownloader_Win32_Buckhs_A{
	...
	strings :
		...
		$a_01_2 = {25 57 49 4e 44 4f 57 53 5c 7a 62 6b 73 00 } //01 00  圥义佄南穜止s
		$a_03_3 = {25 48 45 41 44 2f 90 02 10 2e 70 68 70 3f 6e 70 69 63 3d 25 4e 49 44 90 00 } //01 00 
		$a_01_4 = {53 4f 46 54 57 41 52 45 5c 4d 69 63 72 6f 73 6f 66 74 5c 57 69 6e 64 6f 77 73 5c 43 75 72 72 65 6e 74 56 65 72 73 69 6f 6e 5c 45 78 70 6c 6f 72 65 72 5c 41 64 76 61 6e 63 65 64 5c 46 6f 6c 64 65 72 5c 48 69 64 64 65 6e 5c 53 48 4f 57 41 4c 4c 00 } //01 00  体呆䅗䕒䵜捩潲潳瑦坜湩潤獷䍜牵敲瑮敖獲潩屮硅汰牯牥䅜癤湡散層潆摬牥䡜摩敤屮䡓坏䱁L
		...
		$a_01_8 = {25 73 5f 72 74 77 6f 72 6b 00 } //00 00  猥牟睴牯k
	condition:
		any of ($a_*)
