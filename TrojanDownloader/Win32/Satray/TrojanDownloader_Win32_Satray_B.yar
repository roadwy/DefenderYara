...
rule TrojanDownloader_Win32_Satray_B{
	...
	strings :
		...
		$a_02_13 = {81 ec 0c 01 00 00 a1 a0 b0 00 10 53 56 57 89 84 24 14 01 00 00 8d 44 24 0c 50 68 3f 00 0f 00 6a 00 68 08 92 00 10 68 02 00 00 80 ff 15 90 01 04 85 c0 8b 1d 90 01 04 8b 3d 90 01 04 75 1b 8b 4c 24 0c 6a 00 6a 00 6a 01 6a 00 68 e0 91 00 10 51 ff d3 90 00 } //100
	condition:
