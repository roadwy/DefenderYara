...
rule TrojanDownloader_Win32_Mytonel_D{
	...
	strings :
		$a_03_0 = {6a 56 6a 08 68 09 02 00 00 51 ff d7 8b 56 90 01 01 6a 4f 6a 08 68 0a 02 00 00 52 ff d7 8b 46 90 01 01 6a 4b 6a 08 68 0b 02 00 00 50 ff d7 8b 4e 90 01 01 6a 53 6a 08 68 0c 02 00 00 51 ff d7 90 00 } //1
