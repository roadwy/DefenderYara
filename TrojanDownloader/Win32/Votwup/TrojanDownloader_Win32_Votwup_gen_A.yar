...
rule TrojanDownloader_Win32_Votwup_gen_A{
	...
	strings :
		$a_03_0 = {80 7d fb 01 75 90 01 01 81 ff b8 0b 00 00 76 90 01 01 6a 01 6a 00 90 00 } //3
		$a_03_1 = {6a 02 6a 00 6a 00 e8 90 01 02 ff ff e8 90 01 02 ff ff 3d b7 00 00 00 75 05 90 00 } //3
