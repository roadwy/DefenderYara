...
rule TrojanDownloader_Win32_Kuluoz_D{
	...
	strings :
		...
		$a_01_1 = {3c 6b 6e 6f 63 6b 3e 3c 69 64 3e 25 73 3c 2f 69 64 3e } //01 00 
		$a_01_2 = {68 74 74 70 3a 2f 2f 25 5b 5e 3a 5d 3a 25 64 2f 25 73 } //01 00 
		$a_01_3 = {25 31 30 32 34 5b 5e 3d 5d 3d 25 31 30 32 34 5b 5e 3b 5d } //00 00 
	condition:
		any of ($a_*)
