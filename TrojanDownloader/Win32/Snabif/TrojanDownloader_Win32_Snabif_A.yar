...
rule TrojanDownloader_Win32_Snabif_A{
	...
	strings :
		...
		$a_03_1 = {68 74 74 70 3a 2f 2f 66 61 62 69 61 6e 73 2e 63 6e 2f 68 62 2f 90 02 02 2e 65 78 65 90 00 } //1
		$a_00_2 = {70 72 63 76 69 65 77 } //1 prcview
		$a_00_3 = {57 69 6e 45 78 65 63 } //1 WinExec
		$a_02_4 = {f3 a5 66 a5 a4 b9 06 00 00 00 be 90 01 02 40 00 8d bd 90 01 02 ff ff f3 a5 66 a5 a4 b9 06 00 00 00 90 00 } //1
	condition:
