...
rule TrojanDownloader_Win32_Couly_A{
	...
	strings :
		$a_01_0 = {63 6f 75 6c 79 2e 63 6f 6d 2f 76 69 73 69 74 2e 70 68 70 } //01 00  couly.com/visit.php
		$a_01_1 = {63 6f 75 6c 79 2e 63 6f 6d 2f 75 70 64 61 74 65 2e 65 78 65 } //01 00  couly.com/update.exe
		...
		$a_01_3 = {64 61 74 61 2e 61 6c 65 78 61 2e 63 6f 6d } //01 00  data.alexa.com
		$a_01_4 = {62 6f 74 47 6f 57 61 79 } //01 00  botGoWay
