...
rule TrojanDownloader_Win32_Isnev{
	...
	strings :
		$a_00_0 = {4c 6f 6f 6b 75 70 50 72 69 76 69 6c 65 67 65 56 61 6c 75 65 41 } //01 00 
		$a_00_1 = {47 65 74 57 69 6e 64 6f 77 73 44 69 72 65 63 74 6f 72 79 41 } //01 00 
		$a_02_2 = {57 69 6e 45 78 65 63 90 01 03 47 65 74 54 65 6d 70 46 69 6c 65 4e 61 6d 65 41 90 00 } //01 00 
		$a_00_3 = {47 65 74 53 79 73 74 65 6d 44 69 72 65 63 74 6f 72 79 41 } //01 00 
		$a_00_4 = {57 72 69 74 65 50 72 69 76 61 74 65 50 72 6f 66 69 6c 65 53 74 72 69 6e 67 41 } //01 00 
		$a_00_5 = {76 65 6e 73 69 6f 6e 00 6f 72 67 00 5c 73 79 73 74 65 6d 49 6e 66 6f 6d 61 74 69 6f 6e 73 2e 69 6e 69 } //01 00 
