...
rule TrojanDownloader_Win32_Dalbot_A{
	...
	strings :
		...
		$a_01_1 = {2f 6c 6f 67 6f 2e 68 74 6d 6c } //01 00  /logo.html
		$a_01_2 = {2f 6c 6f 67 6f 2e 68 74 6d 6c 45 45 45 45 45 45 45 45 45 45 45 45 45 45 45 45 45 45 45 45 45 45 73 6c 65 65 70 3a } //03 00  /logo.htmlEEEEEEEEEEEEEEEEEEEEEEsleep:
