...
rule TrojanDownloader_Win32_Hegel_F{
	...
	strings :
		...
		$a_02_2 = {68 65 67 65 6c 69 61 6e 69 7a 65 2e 63 6f 6d 90 02 30 2f 74 61 6b 69 32 2e 70 68 70 90 00 } //1
		$a_02_3 = {68 69 64 3d 25 73 25 73 90 02 10 66 61 6b 65 90 00 } //1
	condition:
