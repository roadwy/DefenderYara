...
rule TrojanDownloader_Win32_Begseabug_A{
	...
	strings :
		...
		$a_03_1 = {63 6f 6d 3a 38 30 38 30 90 02 06 2f 73 63 2e 70 6e 67 90 00 } //1
...
rule TrojanDownloader_Win32_Begseabug_A_2{
	...
	strings :
		$a_03_0 = {55 8b ec 81 ec 74 08 00 00 8b 45 c4 53 33 db 56 3b c3 57 be 1f ab 01 01 74 90 01 01 be 1f ab 01 01 b9 81 00 00 00 90 00 } //5
