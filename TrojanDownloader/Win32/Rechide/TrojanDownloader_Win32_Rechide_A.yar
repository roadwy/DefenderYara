...
rule TrojanDownloader_Win32_Rechide_A{
	...
	strings :
		...
		$a_00_4 = {55 31 52 31 4c 31 44 31 6f 31 77 31 6e 31 6c 31 6f 31 61 31 64 31 54 31 6f 31 46 31 69 31 6c 31 65 31 41 31 } //01 00 
		$a_00_5 = {68 74 74 70 3a 2f 2f 25 73 2f 25 73 3f 68 3d 25 73 2d 25 78 26 72 3d 25 64 } //00 00 
	condition:
		any of ($a_*)
