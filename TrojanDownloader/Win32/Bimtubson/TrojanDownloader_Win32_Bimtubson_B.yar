...
rule TrojanDownloader_Win32_Bimtubson_B{
	...
	strings :
		...
		$a_03_1 = {65 78 65 63 2e 64 6c 6c 90 01 04 5c 69 65 70 73 65 74 75 70 2e 65 78 65 00 6f 70 65 6e 90 01 04 5c 53 63 61 63 68 65 2e 65 78 65 00 2d 70 90 00 } //1
