...
rule TrojanDownloader_Win32_Parkchicers_C{
	...
	strings :
		...
		$a_03_1 = {76 44 66 89 44 24 04 66 bb 01 00 8b c5 e8 90 01 04 0f b7 fb 8b 55 00 8a 54 3a ff 0f b7 ce c1 e9 08 32 d1 88 54 38 ff 8b 04 24 0f b6 44 38 ff 66 03 f0 66 69 c6 3c 96 66 05 75 45 8b f0 43 66 ff 4c 24 04 75 c5 90 00 } //1
		$a_03_2 = {66 ba 13 74 e8 90 01 02 ff ff 33 c0 5a 59 59 64 89 10 90 00 } //1
	condition:
