...
rule TrojanDownloader_Win32_Thoper_C{
	...
	strings :
		...
		$a_01_1 = {48 54 3a 20 73 65 6e 64 28 25 64 29 } //01 00  HT: send(%d)
		$a_01_2 = {50 4f 53 54 20 68 74 74 70 3a 2f 2f 25 73 2f 25 64 20 48 54 54 50 2f 31 2e 30 } //00 00  POST http://%s/%d HTTP/1.0
	condition:
		any of ($a_*)
