...
rule TrojanDownloader_Win32_Neup_A{
	...
	strings :
		$a_00_0 = {5c 73 73 70 69 33 32 2e 65 78 65 } //02 00 
		$a_00_1 = {25 73 5c 6e 65 77 75 70 2e 65 78 65 } //02 00 
		...
		$a_00_4 = {2f 2f 31 35 39 73 77 2e 63 6f 6d 2f } //01 00 
		$a_00_5 = {00 67 67 5f 62 68 6f 00 } //01 00 
		$a_00_6 = {00 67 67 5f 73 70 69 00 } //00 00 
	condition:
		any of ($a_*)
