...
rule TrojanDownloader_Win32_Banload_AFT{
	...
	strings :
		$a_03_0 = {54 46 69 6e 61 6c 46 61 6e 74 61 73 79 54 79 70 65 90 01 0b 70 75 74 61 72 69 61 62 62 62 90 00 } //1
		...
		$a_02_3 = {00 20 00 3a 00 2e 00 2e 00 20 00 41 00 4e 00 54 00 49 00 56 00 49 00 52 00 55 00 53 00 20 00 2e 00 2e 00 3a 00 20 00 20 00 90 01 10 20 00 20 00 3a 00 2e 00 2e 00 56 00 45 00 52 00 53 00 41 00 4f 00 20 00 4b 00 6c 00 2e 00 2e 00 3a 00 20 00 00 90 00 } //1
	condition:
...
rule TrojanDownloader_Win32_Banload_AFT_2{
	...
	strings :
		$a_03_0 = {8b f0 0f b6 c3 8b 6c 87 04 eb 90 01 01 8b 6d 00 85 ed 74 90 01 01 3b 75 04 75 90 00 } //2
...
rule TrojanDownloader_Win32_Banload_AFT_3{
	...
	strings :
		...
		$a_03_2 = {66 74 70 54 72 61 6e 73 66 65 72 90 02 02 66 74 70 52 65 61 64 79 90 00 } //1
