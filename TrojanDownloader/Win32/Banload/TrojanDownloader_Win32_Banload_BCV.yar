...
rule TrojanDownloader_Win32_Banload_BCV{
	...
	strings :
		$a_03_0 = {c7 80 9c 00 00 00 30 75 00 00 8b 45 ec e8 90 01 04 83 c0 54 ba 90 01 04 e8 90 01 04 8b 45 ec e8 90 01 04 83 c0 70 ba 90 01 04 e8 90 01 04 b2 01 90 00 } //1
