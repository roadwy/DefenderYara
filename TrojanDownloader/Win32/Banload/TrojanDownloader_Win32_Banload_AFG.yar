...
rule TrojanDownloader_Win32_Banload_AFG{
	...
	strings :
		$a_01_0 = {5c 00 61 00 72 00 71 00 2e 00 7a 00 69 00 70 00 } //01 00 
		$a_01_1 = {2f 00 43 00 6f 00 6e 00 74 00 61 00 63 00 74 00 36 00 34 00 2e 00 7a 00 69 00 70 00 } //01 00 
		$a_01_2 = {3f 00 64 00 69 00 72 00 65 00 63 00 74 00 44 00 6f 00 77 00 6e 00 6c 00 6f 00 61 00 64 00 3d 00 74 00 72 00 75 00 65 00 } //01 00 
