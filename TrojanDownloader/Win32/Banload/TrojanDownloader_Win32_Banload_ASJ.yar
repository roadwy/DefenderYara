...
rule TrojanDownloader_Win32_Banload_ASJ{
	...
	strings :
		...
		$a_03_3 = {ba 89 8a 01 00 b8 90 01 04 e8 90 01 02 ff ff 90 00 } //1
		$a_03_4 = {33 d2 8a 55 90 01 01 8b 4d 90 01 01 8a 54 11 ff 8b ce c1 e9 08 32 d1 e8 90 01 02 ff ff 8b 55 90 01 01 8d 45 90 01 01 e8 90 01 02 ff ff fe 45 90 01 01 fe cb 75 d3 90 00 } //1
	condition:
