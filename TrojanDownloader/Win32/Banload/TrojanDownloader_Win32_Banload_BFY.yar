...
rule TrojanDownloader_Win32_Banload_BFY{
	...
	strings :
		$a_01_0 = {74 6d 72 56 65 72 66 54 69 6d 65 72 } //01 00 
		$a_01_1 = {74 6d 72 42 61 69 78 61 54 69 6d 65 72 } //01 00 
		$a_01_2 = {78 2e 67 69 66 } //01 00 
		$a_01_3 = {75 4d 6f 64 41 76 73 } //01 00 
