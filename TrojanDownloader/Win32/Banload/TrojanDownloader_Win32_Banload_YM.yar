...
rule TrojanDownloader_Win32_Banload_YM{
	...
	strings :
		$a_00_0 = {7b 65 6e 74 65 72 7d 20 6a 61 20 74 69 6e 68 61 20 76 69 73 74 6f 20 65 73 74 61 73 20 66 6f 74 6f 73 20 61 6e 74 65 73 } //01 00  {enter} ja tinha visto estas fotos antes
