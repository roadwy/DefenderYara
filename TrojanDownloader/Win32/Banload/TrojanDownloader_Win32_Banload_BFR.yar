...
rule TrojanDownloader_Win32_Banload_BFR{
	...
	strings :
		$a_01_0 = {31 37 37 2e 35 34 2e 31 34 37 2e 39 31 2f 68 61 6e 6b 2f 76 69 73 75 61 6c 2e 70 68 70 } //01 00 
		$a_01_1 = {41 74 69 76 61 72 20 43 6f 6e 74 61 64 6f 72 } //01 00 
		$a_81_2 = {49 44 5f 4d 41 51 55 49 4e 41 3d } //01 00 
		$a_81_3 = {56 45 52 53 41 4f 3d } //01 00 
		$a_81_4 = {4e 41 56 45 47 41 44 4f 52 3d } //01 00 
