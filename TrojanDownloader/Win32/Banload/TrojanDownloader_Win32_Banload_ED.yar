...
rule TrojanDownloader_Win32_Banload_ED{
	...
	strings :
		...
		$a_03_2 = {16 00 00 00 43 3a 5c 57 69 6e 64 6f 77 73 5c 73 70 6f 6f 6c 90 03 01 01 73 75 76 2e 65 78 65 00 90 00 } //1
		$a_03_3 = {18 00 00 00 68 74 74 70 3a 2f 2f 77 77 77 2e 67 6f 6f 67 6c 65 2e 63 6f 6d 2e 62 72 00 00 00 00 ff ff ff ff 90 01 01 00 00 00 43 3a 5c 57 69 6e 64 6f 77 73 5c 90 00 } //1
		...
		$a_03_6 = {43 3a 5c 66 69 6c 65 2e 65 78 65 00 ff ff ff ff 90 01 01 00 00 00 68 74 74 70 3a 2f 2f 90 00 } //1
