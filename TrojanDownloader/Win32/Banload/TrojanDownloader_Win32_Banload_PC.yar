...
rule TrojanDownloader_Win32_Banload_PC{
	...
	strings :
		$a_03_0 = {72 65 67 73 76 72 33 32 00 90 0a 1f 00 2f 73 20 00 90 00 } //1
		...
		$a_03_5 = {5c 6d 6f 64 33 32 5f 00 90 02 0a 2e 64 6c 6c 90 00 } //2
		$a_03_6 = {5c 64 6c 6c 33 32 5f 00 90 02 0a 2e 64 6c 6c 90 00 } //2
	condition:
