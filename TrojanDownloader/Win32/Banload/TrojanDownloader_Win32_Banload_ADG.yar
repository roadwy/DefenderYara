...
rule TrojanDownloader_Win32_Banload_ADG{
	...
	strings :
		$a_01_0 = {69 2a 6e 23 66 40 31 23 } //01 00  i*n#f@1#
		$a_01_1 = {77 69 6e 78 2a 74 23 33 2a 32 2a 5c 2a 23 70 40 6a 63 23 74 40 61 2a 2e 6a 23 70 23 67 40 } //01 00  winx*t#3*2*\*#p@jc#t@a*.j#p#g@
		$a_01_2 = {52 23 75 23 6e 2a 44 23 4c 23 4c 40 33 23 32 2e 40 65 78 65 40 } //01 00  R#u#n*D#L#L@3#2.@exe@
		$a_01_3 = {63 68 23 61 2a 76 2a 65 2a 3d 2a 78 2a 63 2a 68 23 61 23 76 65 2a 26 23 75 23 72 2a 6c 23 3d 23 } //00 00  ch#a*v*e*=*x*c*h#a#ve*&#u#r*l#=#
	condition:
		any of ($a_*)
...
rule TrojanDownloader_Win32_Banload_ADG_2{
	...
	strings :
		...
		$a_00_3 = {59 4d 44 20 72 65 63 61 6c 63 20 6f 72 64 65 72 3a } //01 00  YMD recalc order:
		$a_00_4 = {44 4d 59 20 72 65 63 61 6c 63 20 6f 72 64 65 72 3a } //00 00  DMY recalc order:
	condition:
		any of ($a_*)
