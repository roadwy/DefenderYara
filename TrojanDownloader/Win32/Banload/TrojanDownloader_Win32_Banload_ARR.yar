...
rule TrojanDownloader_Win32_Banload_ARR{
	...
	strings :
		...
		$a_01_1 = {63 6d 64 20 2f 63 20 73 74 61 72 74 20 63 3a 5c 61 72 71 75 69 76 7e 31 5c 77 6c 61 6e 61 70 70 2e 63 70 6c } //00 00  cmd /c start c:\arquiv~1\wlanapp.cpl
	condition:
		any of ($a_*)
