...
rule TrojanDownloader_Win32_Banload_BEO{
	...
	strings :
		...
		$a_01_1 = {44 43 36 44 38 33 41 30 41 39 31 30 34 36 45 32 } //01 00  DC6D83A0A91046E2
		$a_01_2 = {42 35 37 38 38 38 41 42 35 36 38 39 43 36 42 32 41 38 45 34 37 41 41 32 34 39 } //01 00  B57888AB5689C6B2A8E47AA249
