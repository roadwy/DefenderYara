...
rule TrojanDownloader_Win32_Banload_ARM{
	...
	strings :
		...
		$a_03_2 = {8b 45 f4 05 a0 00 00 00 8b 55 fc e8 90 01 03 ff 8b 45 f4 05 b0 00 00 00 8b 55 f8 e8 90 01 03 ff 33 d2 8b 45 f4 8b 08 ff 51 40 33 c0 5a 59 59 90 00 } //1
		$a_03_3 = {80 7d ff 00 75 7e b8 1a 00 00 00 e8 90 01 03 ff 8b 14 85 90 01 04 8d 45 f8 e8 90 01 03 ff 80 7d fe 00 74 40 b8 02 00 00 00 e8 90 01 03 ff 2c 01 72 04 74 19 eb 43 90 00 } //1
	condition:
