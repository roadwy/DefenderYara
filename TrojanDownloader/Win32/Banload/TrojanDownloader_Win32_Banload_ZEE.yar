...
rule TrojanDownloader_Win32_Banload_ZEE_2{
	...
	strings :
		...
		$a_03_4 = {8d 45 f8 e8 85 fe ff ff ff 75 f8 68 90 01 04 68 90 01 04 68 90 01 04 68 90 01 04 68 90 01 04 68 90 01 04 68 90 01 04 68 90 01 04 90 02 10 8d 45 fc ba 90 01 01 00 00 00 e8 90 01 04 8b 4d fc ba 90 01 04 8b c3 e8 90 01 04 33 c0 90 00 } //1
	condition:
...
rule TrojanDownloader_Win32_Banload_ZEE_3{
	...
	strings :
		...
		$a_03_7 = {6d 6f 6d 33 00 90 01 0b 32 2e 90 00 } //1
	condition:
