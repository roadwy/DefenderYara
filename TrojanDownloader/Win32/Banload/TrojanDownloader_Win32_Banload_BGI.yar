...
rule TrojanDownloader_Win32_Banload_BGI{
	...
	strings :
		...
		$a_03_3 = {62 72 61 73 69 6c 90 02 10 70 6f 72 74 75 67 75 ea 73 90 00 } //1
		$a_03_4 = {7e 02 33 db 8b 15 90 01 04 b8 90 01 04 e8 90 01 04 85 c0 7f 14 8b 15 90 01 04 b8 90 01 04 e8 90 00 } //1
	condition:
