...
rule TrojanDownloader_Win32_Banload_DUN{
	...
	strings :
		$a_00_0 = {6e 65 74 20 73 74 6f 70 20 53 68 61 72 65 64 41 63 63 65 73 73 } //01 00  net stop SharedAccess
		$a_00_1 = {2e 74 78 74 } //01 00  .txt
		$a_00_2 = {2a 2e 6d 62 6f 78 } //01 00  *.mbox
		$a_00_3 = {2a 2e 77 61 62 } //01 00  *.wab
		$a_00_4 = {2a 2e 6d 62 78 } //01 00  *.mbx
		$a_00_5 = {2a 2e 65 6d 6c } //01 00  *.eml
		$a_00_6 = {2a 2e 74 62 62 } //01 00  *.tbb
