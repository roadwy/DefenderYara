...
rule TrojanDownloader_Win32_Banload_DUN{
	...
	strings :
		...
		$a_02_8 = {33 ff 8d 45 e0 50 b9 02 00 00 00 ba 01 00 00 00 8b 45 fc e8 90 01 02 fe ff 8b 4d e0 8d 45 e4 ba 90 01 02 41 00 e8 90 01 02 fe ff 8b 45 e4 e8 90 01 02 fe ff 89 45 f0 be 03 00 00 00 8d 45 d8 50 b9 02 00 00 00 8b d6 8b 45 fc 90 00 } //1
	condition:
...
rule TrojanDownloader_Win32_Banload_DUN_2{
	...
	strings :
		...
		$a_02_3 = {64 ff 30 64 89 20 33 d2 b8 90 01 04 e8 90 01 02 ff ff 8d 45 e8 e8 90 01 02 ff ff ff 75 e8 68 90 01 04 68 90 01 04 8d 45 ec ba 03 00 00 00 e8 90 01 02 ff ff 8b 55 ec b8 90 01 04 e8 90 01 02 ff ff 84 c0 74 2c 8d 45 e0 e8 90 01 02 ff ff ff 75 e0 68 90 01 04 68 90 01 04 8d 45 e4 ba 03 00 00 00 e8 90 01 02 ff ff 8b 45 e4 33 d2 e8 90 01 02 ff ff 8d 45 d8 e8 90 01 02 ff ff ff 75 d8 68 90 01 04 68 90 01 04 8d 45 dc ba 03 00 00 00 e8 90 01 02 ff ff 8b 55 dc b8 90 01 04 e8 90 01 02 ff ff 84 c0 74 2c 8d 45 d0 90 00 } //10
	condition:
