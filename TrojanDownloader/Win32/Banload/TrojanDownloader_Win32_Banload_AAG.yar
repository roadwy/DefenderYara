...
rule TrojanDownloader_Win32_Banload_AAG{
	...
	strings :
		$a_01_0 = {2f 6b 61 72 6c 61 2d 73 61 72 61 69 76 61 2e } //01 00 
		$a_01_1 = {68 74 74 70 3a 2f 2f 67 61 74 61 } //01 00 
		$a_01_2 = {2f 67 61 74 61 90 01 05 2e 6a 70 67 } //01 00 
		$a_01_3 = {63 3a 5c 77 69 6e 64 6f 77 73 5c 67 61 74 61 } //03 00 
