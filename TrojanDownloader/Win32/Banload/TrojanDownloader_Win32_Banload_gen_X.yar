...
rule TrojanDownloader_Win32_Banload_gen_X{
	...
	strings :
		...
		$a_03_1 = {2f 30 31 2f 00 00 00 00 ff ff ff ff 90 09 04 00 04 90 00 } //1
		$a_03_2 = {2f 30 31 00 ff ff ff ff 90 09 04 00 03 90 00 } //1
		...
		$a_03_6 = {83 c4 f8 dd 1c 24 9b 8d 90 09 1c 00 b8 90 01 04 e8 90 01 04 8d 90 01 02 ba 90 01 04 e8 90 01 04 e8 90 00 } //1
	condition:
