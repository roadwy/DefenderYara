...
rule TrojanDownloader_Win32_Banload_ACX{
	...
	strings :
		...
		$a_01_1 = {63 68 65 63 6b 0c } //01 00  档捥౫
		$a_01_2 = {65 6d 70 74 79 0c } //01 00  浥瑰౹
		$a_01_3 = {46 6c 61 73 68 20 50 6c 61 79 65 72 } //02 00  Flash Player
		...
		$a_00_6 = {36 32 34 46 38 37 38 45 31 32 34 35 38 42 37 35 } //00 00  624F878E12458B75
	condition:
		any of ($a_*)
