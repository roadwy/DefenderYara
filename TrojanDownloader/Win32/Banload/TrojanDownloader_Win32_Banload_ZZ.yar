...
rule TrojanDownloader_Win32_Banload_ZZ{
	...
	strings :
		...
		$a_02_2 = {53 65 63 75 72 69 74 79 20 43 65 6e 74 65 72 90 02 30 10 00 00 00 55 61 63 44 69 73 61 62 6c 65 90 00 } //1
		$a_02_3 = {69 65 78 70 6c 6f 72 65 72 90 02 30 70 6c 61 6e 65 74 68 6f 74 90 00 } //1
		$a_02_4 = {55 61 63 44 69 73 61 62 6c 65 4e 6f 74 69 66 79 90 02 30 2d 00 00 00 53 4f 46 54 57 41 52 45 5c 4d 49 43 52 4f 53 4f 46 54 90 00 } //1
		$a_02_5 = {43 55 52 52 45 4e 54 56 45 52 53 49 4f 4e 5c 52 55 4e 90 02 30 69 65 78 70 6c 6f 72 65 72 90 00 } //1
	condition:
