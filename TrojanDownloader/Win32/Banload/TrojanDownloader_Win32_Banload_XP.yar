...
rule TrojanDownloader_Win32_Banload_XP{
	...
	strings :
		...
		$a_00_4 = {77 77 77 2e 67 72 75 70 6f 62 63 69 2e 63 6f 6d 2e 62 72 2f 73 69 73 74 65 6d 61 2f } //1 www.grupobci.com.br/sistema/
		$a_00_5 = {42 61 6e 63 6f 20 53 61 6e 74 61 6e 64 65 72 20 42 72 61 73 69 6c } //1 Banco Santander Brasil
	condition:
...
rule TrojanDownloader_Win32_Banload_XP_2{
	...
	strings :
		$a_01_0 = {2f 74 65 6d 70 2f 73 73 2e 63 6f 6d } //1 /temp/ss.com
		$a_01_1 = {53 4f 46 54 57 41 52 45 5c 4d 69 63 72 6f 73 6f 66 74 5c 57 69 6e 64 6f 77 73 5c 43 75 72 72 65 6e 74 56 65 72 73 69 6f 6e 5c 50 6f 6c 69 63 69 65 73 5c 53 79 73 74 65 6d } //1 SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\System
		$a_01_2 = {58 50 50 52 4f 42 54 32 30 30 39 } //1 XPPROBT2009
	condition:
