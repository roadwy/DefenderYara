...
rule TrojanDownloader_Win32_Banload_AQS_2{
	...
	strings :
		...
		$a_01_1 = {00 68 74 74 70 3a 2f 2f 31 36 38 2e 36 31 2e 38 37 2e 31 37 39 2f } //32 00  栀瑴㩰⼯㘱⸸ㄶ㠮⸷㜱⼹
		$a_01_2 = {41 70 70 6c 65 74 4d 6f 64 75 6c 65 41 63 74 69 76 61 74 65 09 54 4f 76 6f 66 72 69 74 6f } //05 00  灁汰瑥潍畤敬捁楴慶整吉癏景楲潴
