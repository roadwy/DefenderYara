...
rule TrojanDownloader_Win32_Banload_DE{
	...
	strings :
		...
		$a_00_1 = {77 00 69 00 6e 00 64 00 69 00 72 00 } //01 00  windir
		$a_00_2 = {5c 00 6d 00 73 00 6e 00 6d 00 73 00 67 00 72 00 2e 00 65 00 78 00 65 00 } //01 00  \msnmsgr.exe
		$a_00_3 = {3a 5c 41 72 71 75 69 76 6f 73 20 64 65 20 70 72 6f 67 72 61 6d 61 73 5c } //05 00  :\Arquivos de programas\
