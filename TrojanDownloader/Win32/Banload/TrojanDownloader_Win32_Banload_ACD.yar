...
rule TrojanDownloader_Win32_Banload_ACD{
	...
	strings :
		...
		$a_02_4 = {4e 6f 41 73 49 6e 76 6f 6b 65 72 90 02 0a 5c 4d 53 44 4f 53 2e 70 69 66 90 00 } //1
		$a_02_5 = {5c 4d 53 44 4f 53 90 02 0a 53 6f 66 74 77 61 72 65 5c 43 6c 61 73 73 65 73 5c 41 70 70 6c 69 63 61 74 69 6f 6e 73 5c 42 65 68 6f 6c 64 65 72 2e 65 78 65 90 00 } //1
	condition:
