...
rule TrojanDownloader_Win32_Banload_AAI{
	...
	strings :
		...
		$a_02_2 = {74 72 8b 55 fc 8d 85 a8 fd ff ff e8 90 01 04 ba 01 00 00 00 8d 85 a8 fd ff ff e8 90 01 08 ff 8d 45 f8 50 68 00 04 00 00 8d 85 a8 f9 ff ff 50 57 e8 90 01 03 ff 6a 00 8d 95 a8 f9 ff ff 8b 4d f8 8d 85 a8 fd ff ff 90 00 } //1
	condition:
