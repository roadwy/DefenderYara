...
rule TrojanDownloader_Win32_Banload_BBP{
	...
	strings :
		...
		$a_03_1 = {6a 26 ff 15 94 10 40 00 8b d0 8d 8d 90 01 02 ff ff ff 15 cc 10 40 00 50 6a 61 ff 15 94 10 40 00 8b d0 8d 8d 90 01 02 ff ff ff 15 cc 10 40 00 50 ff 15 24 10 40 00 8b d0 8d 8d 90 01 02 ff ff ff 15 cc 10 40 00 50 6a 63 90 00 } //1
	condition:
