...
rule TrojanDownloader_Win32_Banload_AWP{
	...
	strings :
		...
		$a_03_1 = {6a 2e ff d7 8b d0 8d 8d ?? ?? ff ff ff d6 50 ff d3 8b d0 8d 8d ?? ?? ff ff ff d6 50 6a (6a|67) ff d7 8b d0 8d 8d ?? ?? ff ff ff d6 50 ff d3 8b d0 8d 8d ?? ?? ff ff ff d6 50 6a (|) 70 69 ff d7 8b d0 8d 8d ?? ?? ff ff ff d6 50 ff d3 8b d0 8d 8d ?? ?? ff ff ff d6 50 6a (|) 67 66 } //1
