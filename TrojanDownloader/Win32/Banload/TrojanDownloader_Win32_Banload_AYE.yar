...
rule TrojanDownloader_Win32_Banload_AYE{
	...
	strings :
		$a_01_0 = {24 31 74 33 5f 40 73 70 61 6d 40 } //01 00 
		$a_01_1 = {2f 00 78 00 6d 00 6c 00 2f 00 6a 00 6f 00 6e 00 2f 00 79 00 66 00 63 00 73 00 78 00 66 00 64 00 2e 00 7a 00 69 00 70 00 } //01 00 
		$a_01_2 = {5c 00 79 00 66 00 63 00 73 00 78 00 66 00 64 00 2e 00 65 00 78 00 65 00 } //01 00 
