...
rule TrojanDownloader_Win32_Banload_ZFO_bit{
	...
	strings :
		...
		$a_03_1 = {55 52 4c 44 6f 77 6e 6c 6f 61 64 54 6f 46 69 6c 65 41 [0-04] 75 72 6c 6d 6f 6e 2e 64 6c 6c } //1
		$a_03_2 = {4c 4f 43 41 4c 41 50 50 44 41 54 41 [0-20] 5c 6c 6f 67 2e 74 78 74 } //1
		$a_01_3 = {00 6e 6f 74 69 66 79 00 } //1 渀瑯晩y
		$a_03_4 = {3a 2f 2f 00 [0-40] 68 74 74 70 00 [0-30] 7a 69 70 00 [0-30] 70 68 70 00 } //1
	condition:
