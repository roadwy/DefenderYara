...
rule TrojanDownloader_Win32_Banload_ALM{
	...
	strings :
		$a_03_0 = {66 69 6c 65 73 75 70 64 6f 77 6e 90 02 0a 68 74 74 70 3a 2f 2f 31 38 39 2e 33 36 2e 31 33 37 2e 38 32 2f 69 6d 61 67 65 6e 73 2f 6e 6f 74 69 63 69 61 73 2f 76 69 73 69 74 61 2f 45 4e 2f 4d 79 53 71 6c 2f 65 6e 64 6e 6e 65 77 2f 90 00 } //1
