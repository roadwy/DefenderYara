...
rule TrojanDownloader_Win32_Banload_BGU{
	...
	strings :
		$a_00_0 = {74 00 68 00 6f 00 6d 00 70 00 73 00 6f 00 6e 00 2e 00 73 00 65 00 79 00 } //01 00 
		$a_80_1 = {42 41 49 58 41 4e 44 4f 5f 4e 4f 5f 50 43 } //BAIXANDO_NO_PC  01 00 
		$a_01_2 = {39 00 30 00 36 00 37 00 35 00 36 00 35 00 35 00 44 00 46 00 34 00 } //01 00 
