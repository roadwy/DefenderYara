...
rule TrojanDownloader_Win32_Banload_AWQ{
	...
	strings :
		$a_03_0 = {72 6f 61 6d 69 6e 67 90 02 10 2e 74 78 74 90 02 10 2e 65 78 65 90 02 10 2e 90 03 03 03 58 78 58 70 6e 67 90 00 } //1
		...
		$a_03_4 = {33 db 8a 5c 38 ff 33 9d 90 01 02 ff ff 3b 9d f0 fe ff ff 7f 0e 81 c3 ff 00 00 00 2b 9d 90 01 02 ff ff eb 06 90 00 } //1
	condition:
