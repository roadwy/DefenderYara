...
rule TrojanDownloader_Win32_Banload_DD{
	...
	strings :
		...
		$a_02_1 = {64 ff 30 64 89 20 6a 00 6a 00 8b 45 f8 e8 90 01 02 fb ff 50 8b 45 fc e8 90 01 02 fb ff 50 6a 00 e8 90 01 02 fd ff 90 00 } //5
		$a_02_2 = {83 2d b8 fb 44 00 01 73 28 b8 90 01 01 c6 44 00 e8 90 01 01 75 fb ff e8 00 ff ff ff 68 90 01 01 c6 44 00 e8 90 01 01 9e fb ff a3 bc fb 44 00 b8 90 01 01 23 44 00 e8 90 01 01 69 fc ff c3 00 00 54 61 73 6b 62 61 72 43 72 65 61 74 65 64 00 90 00 } //5
