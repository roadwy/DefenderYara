...
rule TrojanDownloader_Win32_Banload_YT{
	...
	strings :
		$a_01_0 = {61 76 67 73 65 74 75 70 31 2e 65 78 65 00 } //01 00  癡獧瑥灵⸱硥e
		...
		$a_01_3 = {67 7a 79 2e 6a 70 67 } //01 00  gzy.jpg
		$a_01_4 = {3a 5c 57 69 6e 64 6f 77 73 5c 53 79 73 74 65 6d 33 32 5c } //00 00  :\Windows\System32\
	condition:
		any of ($a_*)
