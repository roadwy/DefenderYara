...
rule TrojanDownloader_Win32_Banload_BCY_2{
	...
	strings :
		$a_03_0 = {8d 55 f8 b8 1c 00 00 00 e8 90 01 01 90 03 01 01 fd ff ff ff 8b 45 f8 8d 55 fc e8 90 01 04 8b 55 fc b8 90 01 04 e8 90 01 04 b8 90 01 04 b9 90 01 04 8b 15 90 00 } //10
		$a_01_1 = {5c 7a 2e 7a 6c 69 62 00 } //1 穜種楬b
		$a_01_2 = {5c 7a 69 70 2e 7a 00 } //1
		$a_03_3 = {eb f8 68 70 17 00 00 e8 90 01 03 ff a1 90 01 04 e8 90 01 03 ff 84 c0 90 00 } //1
		$a_03_4 = {eb f8 68 b8 0b 00 00 e8 90 01 03 ff a1 90 01 04 e8 90 01 03 ff 84 c0 90 00 } //1
		$a_03_5 = {eb f8 68 d0 07 00 00 e8 90 01 03 ff a1 90 01 04 e8 90 01 03 ff 84 c0 90 00 } //1
		$a_03_6 = {eb f8 68 58 1b 00 00 e8 90 01 03 ff a1 90 01 04 e8 90 01 03 ff 84 c0 90 00 } //1
		$a_03_7 = {eb f8 68 40 1f 00 00 e8 90 01 03 ff a1 90 01 04 e8 90 01 03 ff 84 c0 90 00 } //1
	condition:
