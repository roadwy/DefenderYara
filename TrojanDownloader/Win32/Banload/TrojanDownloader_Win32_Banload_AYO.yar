...
rule TrojanDownloader_Win32_Banload_AYO{
	...
	strings :
		...
		$a_03_3 = {6a ff 6a 00 e8 90 01 03 ff 8b d8 68 88 13 00 00 53 e8 90 01 03 ff 3d 02 01 00 00 75 07 6a 00 e8 90 01 03 ff 5b c3 4b 42 32 38 32 33 33 32 34 30 78 90 00 } //2
	condition:
