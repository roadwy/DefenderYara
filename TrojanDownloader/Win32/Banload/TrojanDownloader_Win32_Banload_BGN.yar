...
rule TrojanDownloader_Win32_Banload_BGN{
	...
	strings :
		...
		$a_03_4 = {64 89 20 b2 01 a1 90 01 04 e8 90 01 04 89 45 f8 8d 4d f4 ba 90 01 04 8b 45 f8 e8 90 01 04 33 c0 5a 59 59 64 89 10 68 90 01 04 8b 45 f8 e8 90 01 04 c3 e9 90 01 04 eb f0 90 00 } //1
	condition:
