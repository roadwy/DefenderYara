...
rule TrojanDownloader_Win32_Banload_EA{
	...
	strings :
		...
		$a_00_2 = {43 3a 5c 57 49 4e 44 4f 57 53 5c 53 59 53 54 45 4d 33 32 5c 49 73 61 73 73 2e 73 63 72 } //01 00 
		$a_00_3 = {43 3a 5c 57 49 4e 44 4f 57 53 5c 53 59 53 54 45 4d 33 32 5c 63 73 72 73 2e 73 63 72 } //01 00 
		...
		$a_00_6 = {43 3a 5c 57 49 4e 44 4f 57 53 5c 53 59 53 54 45 4d 33 32 5c 55 70 64 61 74 65 } //01 00 
