...
rule TrojanDownloader_Win32_Banload_AFC{
	...
	strings :
		...
		$a_01_1 = {64 75 61 72 74 65 2e 6d 61 63 68 61 64 6f 2e 73 69 74 65 73 2e 75 6f 6c 2e 63 6f 6d 2e 62 72 } //01 00 
		$a_01_2 = {7e 64 6f 6e 77 6c 6f 61 64 2f 6d 6f 64 75 6c 6f 73 } //01 00 
