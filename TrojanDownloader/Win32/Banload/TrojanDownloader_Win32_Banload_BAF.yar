...
rule TrojanDownloader_Win32_Banload_BAF{
	...
	strings :
		$a_03_0 = {35 2e 74 78 74 90 02 10 6d 69 6e 69 66 65 73 74 2e 6a 73 6f 6e 90 00 } //1
		$a_03_1 = {34 2e 74 78 74 90 02 10 69 63 6f 6e 2e 70 6e 67 90 00 } //1
		$a_03_2 = {32 2e 6a 70 67 90 02 10 32 2e 74 78 74 90 00 } //1
