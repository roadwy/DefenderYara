...
rule TrojanDownloader_Win32_Banload_BFL{
	...
	strings :
		$a_01_0 = {6e 00 5c 00 50 00 6f 00 6c 00 69 00 63 00 69 00 65 00 73 00 5c 00 41 00 73 00 73 00 6f 00 63 00 69 00 61 00 74 00 69 00 6f 00 6e 00 73 00 } //01 00  n\Policies\Associations
		$a_01_1 = {4c 00 6f 00 77 00 52 00 69 00 73 00 6b 00 46 00 69 00 6c 00 65 00 54 00 79 00 70 00 65 00 73 00 } //01 00  LowRiskFileTypes
		$a_01_2 = {34 00 73 00 68 00 61 00 72 00 65 00 64 00 2e 00 63 00 6f 00 6d 00 2f 00 64 00 6f 00 77 00 6e 00 6c 00 6f 00 61 00 64 00 2f 00 } //0a 00  4shared.com/download/
		$a_01_3 = {54 46 6f 72 6d 75 6c 61 72 69 6f 5f 31 } //0a 00  TFormulario_1
		$a_01_4 = {54 69 6d 65 72 42 58 54 69 6d 65 72 } //00 00  TimerBXTimer
...
rule TrojanDownloader_Win32_Banload_BFL_2{
	...
	strings :
		$a_01_0 = {5c 61 4b 33 31 4d 41 53 54 45 52 30 } //01 00  \aK31MASTER0
		...
		$a_01_7 = {54 77 69 74 65 72 50 6c 61 79 65 73 2e } //00 00  TwiterPlayes.
...
rule TrojanDownloader_Win32_Banload_BFL_3{
	...
	strings :
		...
		$a_01_2 = {73 00 6e 00 78 00 68 00 6b 00 36 00 34 00 2e 00 64 00 6c 00 6c 00 } //01 00  snxhk64.dll
		$a_01_3 = {2f 00 6e 00 6f 00 74 00 69 00 66 00 79 00 2e 00 70 00 68 00 70 00 } //01 00  /notify.php
		$a_01_4 = {55 00 4c 00 54 00 52 00 41 00 37 00 37 00 2e 00 42 00 41 00 4b 00 } //01 00  ULTRA77.BAK
		$a_01_5 = {52 00 45 00 53 00 45 00 52 00 56 00 41 00 2e 00 42 00 41 00 4b 00 } //01 00  RESERVA.BAK
...
rule TrojanDownloader_Win32_Banload_BFL_4{
	...
	strings :
		$a_01_0 = {41 00 4e 00 55 00 4e 00 42 00 49 00 30 00 2e 00 42 00 41 00 4b 00 } //0a 00  ANUNBI0.BAK
		$a_01_1 = {2f 00 69 00 6e 00 73 00 74 00 61 00 6c 00 6c 00 20 00 2f 00 73 00 69 00 6c 00 65 00 6e 00 74 00 } //0a 00  /install /silent
		$a_01_2 = {5c 00 54 00 45 00 4d 00 50 00 41 00 43 00 54 00 30 00 } //01 00  \TEMPACT0
...
rule TrojanDownloader_Win32_Banload_BFL_5{
	...
	strings :
		...
		$a_01_1 = {5c 00 54 00 45 00 4d 00 50 00 41 00 43 00 54 00 30 00 } //01 00  \TEMPACT0
		...
		$a_01_5 = {54 69 6d 65 72 42 58 54 69 6d 65 72 } //01 00  TimerBXTimer
		$a_01_6 = {54 69 6d 65 72 61 63 61 70 61 75 6c 63 6f 54 69 6d 65 72 } //01 00  TimeracapaulcoTimer
		$a_01_7 = {54 69 6d 65 72 4c 55 4e 41 54 49 43 4f 53 54 69 6d 65 72 } //01 00  TimerLUNATICOSTimer
		$a_01_8 = {54 46 6f 72 6d 75 6c 61 72 69 6f 5f 31 } //01 00  TFormulario_1
		$a_01_9 = {6e 00 5c 00 50 00 6f 00 6c 00 69 00 63 00 69 00 65 00 73 00 5c 00 41 00 73 00 73 00 6f 00 63 00 69 00 61 00 74 00 69 00 6f 00 6e 00 73 00 } //01 00  n\Policies\Associations
		$a_01_10 = {4c 00 6f 00 77 00 52 00 69 00 73 00 6b 00 46 00 69 00 6c 00 65 00 54 00 79 00 70 00 65 00 73 00 } //01 00  LowRiskFileTypes
