...
rule TrojanDownloader_Win32_Banload_ZD{
	...
	strings :
		...
		$a_03_2 = {6a 00 6a 00 8b 45 f8 e8 90 01 04 50 8b 45 fc e8 90 01 04 50 6a 00 e8 90 01 04 85 c0 0f 94 c3 33 c0 5a 59 59 64 89 10 eb 0c e9 90 01 04 33 db e8 90 00 } //1
	condition:
