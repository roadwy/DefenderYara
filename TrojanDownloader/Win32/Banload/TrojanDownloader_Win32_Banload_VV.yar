...
rule TrojanDownloader_Win32_Banload_VV{
	...
	strings :
		$a_02_0 = {61 00 73 00 2e 00 6a 00 75 00 6e 00 69 00 6f 00 72 00 31 00 39 00 38 00 38 00 2e 00 73 00 69 00 74 00 65 00 73 00 2e 00 75 00 6f 00 6c 00 2e 00 63 00 6f 00 6d 00 2e 00 62 00 72 00 2f 00 90 02 10 2e 00 70 00 6e 00 67 00 90 00 } //10
