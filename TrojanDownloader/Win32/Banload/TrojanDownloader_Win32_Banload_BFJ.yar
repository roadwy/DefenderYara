...
rule TrojanDownloader_Win32_Banload_BFJ{
	...
	strings :
		...
		$a_03_3 = {ff 83 c0 04 ba 90 01 02 69 00 e8 90 01 03 ff 33 c0 55 68 90 01 02 69 00 64 ff 30 64 89 20 8d 55 e4 b8 90 01 02 69 00 e8 5a fa ff ff 8b 55 e4 90 00 } //1
	condition:
