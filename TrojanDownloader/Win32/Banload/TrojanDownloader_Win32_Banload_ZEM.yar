...
rule TrojanDownloader_Win32_Banload_ZEM{
	...
	strings :
		$a_03_0 = {3c 4d 75 07 80 fb 48 75 02 b0 4e 8b d8 25 ff 00 00 00 83 c0 de 83 f8 38 0f 87 ?? ?? ?? ?? 8a 80 ?? ?? ?? ?? ff 24 85 } //2
		$a_03_1 = {8b 0e 8b 1f 38 d9 75 ?? 4a 74 ?? 38 fd 75 ?? 4a 74 ?? 81 e3 00 00 ff 00 81 e1 00 00 ff 00 39 d9 75 } //2
