...
rule TrojanDownloader_Win32_Banload_AMZ{
	...
	strings :
		$a_01_0 = {5c 00 52 00 65 00 76 00 6f 00 6c 00 74 00 61 00 2e 00 76 00 62 00 70 00 } //01 00  \Revolta.vbp
		$a_01_1 = {5c 00 44 00 69 00 61 00 20 00 64 00 61 00 20 00 4d 00 75 00 6c 00 68 00 65 00 72 00 } //01 00  \Dia da Mulher
