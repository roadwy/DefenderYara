...
rule TrojanDownloader_Win32_Banload_HR{
	...
	strings :
		...
		$a_03_1 = {84 c0 74 0c 33 d2 b8 90 01 02 44 00 e8 3d ff ff ff ba 90 01 02 44 00 b8 90 01 02 44 00 e8 90 01 02 ff ff 84 c0 74 0c 33 d2 b8 90 01 02 44 00 e8 90 00 } //1
	condition:
