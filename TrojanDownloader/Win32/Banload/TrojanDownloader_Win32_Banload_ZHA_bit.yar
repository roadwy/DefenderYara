...
rule TrojanDownloader_Win32_Banload_ZHA_bit{
	...
	strings :
		...
		$a_03_1 = {6a 04 68 00 10 00 00 8b 45 fc 50 8b 45 f8 03 43 0c 50 e8 90 01 04 8b f0 89 73 08 8b 55 fc 8b c6 90 02 20 6a 04 68 00 10 00 00 8b 43 10 50 8b 45 f8 03 43 0c 50 e8 90 00 } //1
	condition:
