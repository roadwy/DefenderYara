...
rule TrojanDownloader_Win32_Banload_ABQ{
	...
	strings :
		$a_02_0 = {63 6f 6e 66 69 67 2d 63 61 63 68 65 2e 63 6f 6d 2f 69 65 [0-10] 75 74 6f 43 6f 6e 66 69 67 55 52 4c } //1
		...
		$a_02_3 = {2e 00 63 00 6f 00 6d 00 2f 00 42 00 72 00 46 00 6c 00 61 00 73 00 68 00 2f 00 54 00 65 00 41 00 64 00 6f 00 72 00 6f 00 2f 00 [0-0a] 2e 00 73 00 77 00 66 00 } //1
	condition:
