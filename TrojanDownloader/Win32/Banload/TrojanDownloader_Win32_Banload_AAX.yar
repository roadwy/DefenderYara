...
rule TrojanDownloader_Win32_Banload_AAX{
	...
	strings :
		...
		$a_01_4 = {54 46 72 6d 44 77 50 72 67 72 } //01 00  TFrmDwPrgr
		$a_01_5 = {44 2e 77 2e 50 2e 72 2e 67 2e 72 2e } //05 00  D.w.P.r.g.r.
		$a_01_6 = {54 46 72 6d 53 74 72 74 44 77 6e } //01 00  TFrmStrtDwn
		$a_01_7 = {53 2e 74 2e 72 2e 74 2e 44 2e 77 2e 6e 2e } //05 00  S.t.r.t.D.w.n.
		$a_01_8 = {54 66 72 50 6c 69 74 } //01 00  TfrPlit
		$a_01_9 = {50 6c 69 74 } //00 00  Plit
	condition:
		any of ($a_*)
