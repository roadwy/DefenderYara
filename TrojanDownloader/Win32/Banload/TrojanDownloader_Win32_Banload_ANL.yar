...
rule TrojanDownloader_Win32_Banload_ANL{
	...
	strings :
		...
		$a_01_3 = {53 4f 46 54 57 41 52 45 5c 42 6f 72 6c 61 6e 64 5c 44 65 6c 70 68 69 5c } //01 00  SOFTWARE\Borland\Delphi\
		$a_01_4 = {2e 63 70 6c 00 43 50 6c 41 70 70 6c 65 74 } //00 00  挮汰䌀汐灁汰瑥
	condition:
		any of ($a_*)
