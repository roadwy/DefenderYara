...
rule TrojanDownloader_Win32_Banload_AMI{
	...
	strings :
		$a_00_0 = {57 69 6e 64 6f 77 73 4c 69 76 65 3a 6e 61 6d 65 3d 2a } //05 00  WindowsLive:name=*
		$a_00_1 = {50 4f 50 33 20 55 73 65 72 20 4e 61 6d 65 } //01 00  POP3 User Name
		$a_00_2 = {2e 6a 65 6d 61 74 6b 64 2e 63 6f 6d 2f 69 6d 67 2f 72 6f 75 6e 64 65 64 2d 62 6f 78 2f 2e 2e 2e 2f } //01 00  .jematkd.com/img/rounded-box/.../
