...
rule TrojanDownloader_Win32_Banload_KJ{
	...
	strings :
		...
		$a_01_5 = {5a 3a 5c 44 72 6f 70 62 6f 78 5c 4d 79 20 44 72 6f 70 62 6f 78 5c 50 72 6f 6a 65 74 6f 73 5c 4a 61 76 61 6e } //01 00 
		$a_01_6 = {3a 49 4e 49 43 49 4f } //01 00 
		$a_01_7 = {44 45 4c 41 50 50 20 45 4c 53 45 20 47 4f 54 4f 20 44 45 4c 42 41 54 } //01 00 
		$a_01_8 = {3a 44 45 4c 41 50 50 } //01 00 
		$a_01_9 = {3a 44 45 4c 42 41 54 } //01 00 
		$a_01_10 = {53 68 61 72 65 64 41 50 50 73 22 3d 2d } //01 00 
		...
		$a_01_13 = {32 33 38 37 37 34 39 31 31 00 } //00 00 
	condition:
		any of ($a_*)
