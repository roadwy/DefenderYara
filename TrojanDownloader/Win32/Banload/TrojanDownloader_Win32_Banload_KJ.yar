...
rule TrojanDownloader_Win32_Banload_KJ{
	...
	strings :
		$a_03_0 = {68 00 00 0a 00 6a 00 6a 00 68 90 01 01 00 00 00 6a 90 01 01 6a 00 6a 00 90 01 01 6a 00 b9 90 01 04 ba 90 01 04 b8 90 01 04 e8 90 01 04 a3 90 01 04 90 03 02 04 6a 00 68 90 01 04 90 03 02 06 6a 64 68 90 01 02 00 00 6a 00 a1 90 01 04 50 e8 90 01 04 eb 0c 90 00 } //10
		$a_01_1 = {75 72 8b 16 8b c2 89 45 ec 8b 45 ec 85 c0 74 05 83 e8 04 8b 00 83 f8 03 7e 4e } //2
		$a_03_2 = {74 50 6a 00 8d 55 90 01 01 b8 90 01 04 e8 90 01 04 ff 75 90 01 01 ff 75 fc b8 90 01 04 8d 55 90 01 01 e8 90 01 04 ff 75 90 01 01 8d 45 90 01 01 ba 03 00 00 00 90 00 } //2
		$a_03_3 = {7e 4f bf 01 00 00 00 8b 45 fc 0f b6 5c 38 ff 80 fb 5c 75 24 ff 75 f8 8d 45 90 01 01 8b d3 e8 90 00 } //2
		$a_03_4 = {50 68 00 04 00 00 8d 85 90 01 02 ff ff 50 56 e8 90 01 04 6a 00 8d 95 90 01 02 ff ff 8b 4d 90 01 01 8d 85 90 01 02 ff ff e8 90 01 04 e8 90 01 04 83 7d 90 01 01 00 75 c9 90 00 } //2
