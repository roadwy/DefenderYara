...
rule TrojanDownloader_Win32_Banload_ZDQ{
	...
	strings :
		...
		$a_03_1 = {43 3a 5c 41 72 71 75 69 76 6f 73 20 64 65 20 70 72 6f 67 72 61 6d 61 73 5c 41 72 71 75 69 76 6f 73 20 63 6f 6d 75 6e 73 5c 2d 90 03 02 01 2e 2e 2e 65 78 65 90 00 } //2
