...
rule TrojanDownloader_Win32_Banload_AMV{
	...
	strings :
		$a_01_0 = {51 37 48 71 53 33 65 6c 42 } //01 00 
		...
		$a_01_2 = {5c 73 79 73 74 65 6d 33 32 5c 73 69 73 74 65 6d 6b 69 6c 00 } //01 00 
		...
		$a_01_5 = {5c 73 79 73 74 65 6d 33 32 5c 70 69 6e 67 6b 69 6c 00 } //00 00 
	condition:
		any of ($a_*)
