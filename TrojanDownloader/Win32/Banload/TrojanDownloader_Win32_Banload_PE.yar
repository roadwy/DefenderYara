...
rule TrojanDownloader_Win32_Banload_PE{
	...
	strings :
		...
		$a_01_1 = {43 3a 5c 57 49 4e 44 4f 57 53 5c 68 75 6e 74 65 72 } //01 00  C:\WINDOWS\hunter
		$a_01_2 = {43 3a 5c 57 49 4e 44 4f 57 53 5c 69 65 70 6c 6f 72 65 72 69 74 61 75 2e 6a 73 } //01 00  C:\WINDOWS\ieploreritau.js
		$a_01_3 = {43 3a 5c 57 49 4e 44 4f 57 53 5c 63 74 66 72 6d 6f 6e 2e 65 78 65 } //01 00  C:\WINDOWS\ctfrmon.exe
