...
rule TrojanDownloader_Win32_Banload_AGY{
	...
	strings :
		$a_01_0 = {61 75 74 6c 6f 6f 6b 65 78 70 70 } //01 00  autlookexpp
		$a_01_1 = {6e 6b 63 2e 63 6f 6d 2e 76 6e } //01 00  nkc.com.vn
		$a_01_2 = {69 65 78 70 6c 6f 72 65 33 32 } //01 00  iexplore32
		$a_01_3 = {6a 61 76 61 66 6c 61 73 68 33 } //01 00  javaflash3
