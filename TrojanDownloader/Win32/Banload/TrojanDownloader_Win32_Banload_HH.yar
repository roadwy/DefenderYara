...
rule TrojanDownloader_Win32_Banload_HH{
	...
	strings :
		$a_03_0 = {81 3f 7b 73 6b 7d 74 90 01 01 8a 07 30 c8 28 e8 aa 4a 75 90 00 } //4
		$a_03_1 = {8b 45 fc 81 38 78 78 78 78 75 05 e9 90 01 02 00 00 90 00 } //3
		$a_03_2 = {6a 00 6a 00 6a 06 e8 90 01 04 50 68 ff 00 00 00 68 90 01 04 e8 90 01 04 6a 00 6a 00 6a 07 e8 90 01 04 50 68 ff 00 00 00 90 00 } //2
