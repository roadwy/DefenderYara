...
rule TrojanDownloader_Win32_Banload_BFH{
	...
	strings :
		$a_03_0 = {61 70 70 64 61 74 61 00 90 01 10 2a 00 2e 00 2a 00 90 00 } //1
		...
		$a_03_3 = {ff ff 84 c0 0f 84 90 01 02 00 00 8d 55 fc b8 90 01 03 00 e8 90 01 03 ff 8d 45 fc ba 90 01 03 00 e8 90 01 03 ff 8b 55 fc 8b 83 fc 02 00 00 e8 90 01 03 ff 8d 55 f8 8b 83 fc 02 00 00 e8 90 01 03 ff 8d 45 f8 50 8d 55 f0 8b 83 90 01 01 03 00 00 e8 90 01 03 ff 90 00 } //1
	condition:
