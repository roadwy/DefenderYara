...
rule TrojanDownloader_Win32_Banload_DV{
	...
	strings :
		$a_02_0 = {68 74 74 70 3a 2f 2f 90 02 40 2f 90 02 16 2e 90 03 03 03 65 78 65 6a 70 67 90 00 } //1
		...
		$a_02_2 = {0f 00 00 00 63 3a 5c 90 01 08 2e 6a 70 67 90 00 } //1
		$a_02_3 = {63 3a 5c 77 69 6e 64 6f 77 73 5c 6d 65 64 69 61 5c 90 02 08 2e 65 78 65 90 00 } //1
	condition:
