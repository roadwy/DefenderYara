...
rule TrojanDownloader_Win32_Banload_BED{
	...
	strings :
		$a_03_0 = {00 7a 69 70 66 69 6c 65 [0-05] 26 [0-05] 5c 4d 69 63 72 6f 73 6f 66 74 5c 57 69 6e 64 6f 77 73 5c 50 72 6f 70 65 72 74 69 65 73 5c 64 61 74 61 2e 7a 69 70 00 } //1
