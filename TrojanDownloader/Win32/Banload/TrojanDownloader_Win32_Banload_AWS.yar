...
rule TrojanDownloader_Win32_Banload_AWS{
	...
	strings :
		$a_01_0 = {5c 4d 49 43 52 4f 53 4f 46 54 5c 57 49 4e 44 4f 57 53 5c 43 55 52 52 45 4e 54 56 45 52 53 49 4f 4e 5c 52 55 4e 00 } //01 00 
...
rule TrojanDownloader_Win32_Banload_AWS_2{
	...
	strings :
		...
		$a_01_3 = {5c 4d 49 43 52 4f 53 4f 46 54 5c 57 49 4e 44 4f 57 53 5c 43 55 52 52 45 4e 54 56 45 52 53 49 4f 4e 5c 52 55 4e 00 } //0a 00 
		...
		$a_01_5 = {53 00 6f 00 75 00 72 00 63 00 65 00 3d 00 31 00 38 00 34 00 2e 00 31 00 36 00 38 00 2e 00 31 00 39 00 34 00 2e 00 35 00 35 00 } //00 00 
