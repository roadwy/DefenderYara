...
rule TrojanDownloader_Win32_Banload_JS{
	...
	strings :
		...
		$a_00_1 = {6d 6f 7a 69 6c 6c 61 2f 33 2e 30 20 28 63 6f 6d 70 61 74 69 62 6c 65 3b 20 69 6e 64 79 20 6c 69 62 72 61 72 79 29 } //01 00  mozilla/3.0 (compatible; indy library)
		$a_02_2 = {68 74 74 70 3a 2f 2f 73 69 74 65 68 6f 73 74 74 2e 63 6f 6d 2f 90 02 08 2e 72 61 72 90 00 } //01 00 
		$a_00_3 = {43 3a 5c 77 69 6e 64 6f 77 73 5c 69 6e 69 63 69 61 6c 69 7a 61 74 69 6f 6e 2e 65 78 65 } //00 00  C:\windows\inicialization.exe
	condition:
		any of ($a_*)
