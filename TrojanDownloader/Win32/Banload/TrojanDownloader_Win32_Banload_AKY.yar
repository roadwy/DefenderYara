...
rule TrojanDownloader_Win32_Banload_AKY{
	...
	strings :
		$a_03_0 = {ba 70 6a 45 00 e8 5d de fa ff a1 ?? 9a 45 00 b9 ?? 6a 45 00 8b 55 fc } //1
...
rule TrojanDownloader_Win32_Banload_AKY_2{
	...
	strings :
		$a_03_0 = {68 74 74 70 3a 2f 2f 64 6c 2e 64 72 6f 70 62 6f 78 2e 63 6f 6d 2f 75 2f [0-20] 2e 6a 70 67 } //1
		$a_03_1 = {68 74 74 70 3a 2f 2f 64 6c 2e 64 72 6f 70 62 6f 78 2e 63 6f 6d 2f 75 2f [0-20] 2e 73 77 66 } //1
