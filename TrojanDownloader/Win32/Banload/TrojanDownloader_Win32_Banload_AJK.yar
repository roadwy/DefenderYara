...
rule TrojanDownloader_Win32_Banload_AJK{
	...
	strings :
		...
		$a_01_1 = {7a 61 79 62 78 6a 6b 71 72 63 6c 6d 77 6e 6f 70 64 74 75 73 74 65 66 67 68 69 75 76 } //01 00  zaybxjkqrclmwnopdtustefghiuv
		$a_01_2 = {68 6f 73 70 2d 61 74 74 30 36 2e 6e 6d 2e 72 75 } //01 00  hosp-att06.nm.ru
