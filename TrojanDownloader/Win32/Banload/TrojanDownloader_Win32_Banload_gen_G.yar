...
rule TrojanDownloader_Win32_Banload_gen_G{
	...
	strings :
		...
		$a_01_1 = {47 65 72 61 6c 00 } //01 00  敇慲l
		$a_01_2 = {61 75 74 6f 6d 73 6e 00 } //01 00  畡潴獭n
		$a_01_3 = {61 75 74 6f 72 6b 00 } //01 00 
		$a_01_4 = {4d 65 6e 73 61 67 65 6d 48 6f 74 6d 61 69 6c 00 } //01 00  敍獮条浥潈浴楡l
		$a_01_5 = {41 75 74 65 6e 74 69 63 61 63 61 6f 48 6f 74 6d 61 69 6c 00 } //0a 00  畁整瑮捩捡潡潈浴楡l
