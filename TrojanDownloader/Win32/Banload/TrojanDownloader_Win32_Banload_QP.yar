...
rule TrojanDownloader_Win32_Banload_QP{
	...
	strings :
		...
		$a_03_1 = {8b 40 0c 8b 00 8b 00 89 85 ?? ?? ?? ?? 6a 06 6a 01 6a 02 e8 ?? ?? ?? ?? 89 45 ec 6a 10 8d 85 ?? ?? ?? ?? 50 8b 45 ec 50 e8 ?? ?? ?? ?? 40 0f 84 } //1
		$a_03_2 = {68 01 04 00 00 8d 85 ?? ?? ?? ?? 50 8b 45 ec 50 e8 ?? ?? ?? ?? 89 45 dc } //1
	condition:
