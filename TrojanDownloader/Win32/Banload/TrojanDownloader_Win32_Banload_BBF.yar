...
rule TrojanDownloader_Win32_Banload_BBF{
	...
	strings :
		...
		$a_03_4 = {63 6d 64 20 2f 63 20 72 65 67 2e 65 78 65 20 41 44 44 20 48 4b 43 55 5c 53 6f 66 74 77 61 72 65 5c 4d 69 63 72 6f 73 6f 66 74 5c 57 69 6e 64 6f 77 73 5c 43 75 72 72 65 6e 74 56 65 72 73 69 6f 6e 5c 52 75 6e 20 2f 76 20 90 02 28 20 2f 74 20 52 45 47 5f 53 5a 20 2f 64 20 22 72 75 6e 64 6c 6c 33 32 2e 65 78 65 20 25 54 45 4d 50 25 90 00 } //1
	condition:
