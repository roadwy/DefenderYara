...
rule TrojanDownloader_Win32_Banload_AAA{
	...
	strings :
		$a_02_0 = {4b 85 db 7c 90 01 01 8b 45 f0 c1 e0 06 03 d8 89 5d f0 83 c7 06 83 ff 08 7c 90 01 01 83 ef 08 8b cf 8b 5d f0 d3 eb 8b cf b8 01 00 00 00 d3 e0 50 8b 45 f0 5a 8b ca 99 f7 f9 89 55 f0 81 e3 ff 00 00 80 79 08 4b 81 cb 00 ff ff ff 43 90 00 } //10
		$a_02_1 = {8b d8 85 db 7e 2f be 01 00 00 00 8d 45 ec 8b 90 01 04 00 8a 54 3a ff 8b 4d fc 8a 4c 31 ff 32 d1 e8 b3 db f9 ff 8b 55 ec 8d 45 f4 e8 90 01 03 ff 46 4b 75 d6 8d 45 fc 8b 55 f4 90 00 } //10
		$a_02_2 = {ff 6a 00 a1 90 01 03 00 8b 00 8b 40 30 50 e8 90 01 0d ff 68 ff ff 00 00 8d 55 fc b8 90 01 04 e8 90 01 04 8b 4d fc b2 01 a1 90 01 08 ff 8b d8 8d 55 f8 b8 90 01 08 ff 8b 55 f8 8b cb 8b 86 f8 02 00 00 e8 90 00 } //2
