...
rule TrojanDownloader_Win32_Banload_MI{
	...
	strings :
		$a_01_0 = {26 62 74 6e 47 3d 47 6f 6f 67 6c 65 2b 25 43 42 25 44 31 25 43 42 25 46 37 26 61 71 3d 66 26 6f 71 3d } //01 00 
		...
		$a_01_2 = {5c 4d 69 63 72 6f 73 6f 66 74 5c 49 6e 74 65 72 6e 65 74 20 45 78 70 6c 6f 72 65 72 5c 51 75 69 63 6b 20 4c 61 75 6e 63 68 5c 49 6e 74 65 72 6e 65 74 20 45 78 70 6c 65 72 6f 72 2e 6c 6e 6b } //02 00 
