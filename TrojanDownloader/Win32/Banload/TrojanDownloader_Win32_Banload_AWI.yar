...
rule TrojanDownloader_Win32_Banload_AWI{
	...
	strings :
		...
		$a_01_1 = {5c 63 6d 64 2e 65 78 65 20 2f 6b 20 72 65 67 73 76 72 33 32 2e 65 78 65 20 20 22 } //01 00 
		$a_01_2 = {61 70 6c 69 63 61 74 69 76 6f 73 5c } //01 00 
		$a_01_3 = {32 2e 6a 70 67 22 } //01 00 
		$a_01_4 = {35 2e 63 70 6c } //00 00 
...
rule TrojanDownloader_Win32_Banload_AWI_2{
	...
	strings :
		...
		$a_00_2 = {00 61 74 61 5c 52 6f 61 6d 69 6e 67 5c 00 } //01 00 
		$a_00_3 = {54 63 61 62 65 63 61 64 6f 6d 65 75 70 61 75 } //00 00 
		$a_00_4 = {5d 04 } //00 00 
	condition:
		any of ($a_*)
