...
rule TrojanDownloader_Win32_Banload_JO{
	...
	strings :
		...
		$a_02_1 = {2f 70 6f 69 6e 74 2e 90 01 01 20 48 54 54 50 2f 31 2e 30 90 00 } //1
		$a_02_2 = {48 6f 73 74 3a 20 6e 69 6b 6f 6c 79 90 02 04 2e 69 66 72 61 6e 63 65 2e 63 6f 6d 90 00 } //1
	condition:
