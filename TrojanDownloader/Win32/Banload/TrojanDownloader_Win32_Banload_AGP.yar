...
rule TrojanDownloader_Win32_Banload_AGP{
	...
	strings :
		...
		$a_03_1 = {83 c0 05 8d 55 90 01 01 e8 90 01 04 8b 45 90 1b 00 89 45 90 01 01 c6 45 90 01 01 0b 8d 55 90 01 01 b8 03 00 00 00 e8 90 01 04 8b 45 90 1b 05 89 45 90 01 01 c6 45 90 01 01 0b 8d 55 90 01 01 b9 02 00 00 00 58 90 00 } //1
	condition:
