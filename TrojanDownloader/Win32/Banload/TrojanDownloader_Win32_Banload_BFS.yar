...
rule TrojanDownloader_Win32_Banload_BFS{
	...
	strings :
		$a_01_0 = {32 30 30 2e 39 38 2e 31 33 30 2e 38 30 2f 72 63 6f } //01 00  200.98.130.80/rco
		$a_01_1 = {5c 41 70 70 6c 69 63 61 74 69 6f 6e 20 44 61 74 61 5c 69 64 } //00 00  \Application Data\id
