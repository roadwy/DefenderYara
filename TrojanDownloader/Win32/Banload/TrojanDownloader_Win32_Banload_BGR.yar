...
rule TrojanDownloader_Win32_Banload_BGR{
	...
	strings :
		...
		$a_01_1 = {54 48 61 63 6b 4d 65 6d 6f 72 79 53 74 72 65 61 6d 47 } //01 00 
		$a_01_2 = {41 00 4c 00 41 00 53 00 43 00 41 00 44 00 4e 00 53 00 } //01 00 
		$a_01_3 = {77 00 6f 00 72 00 6b 00 73 00 6e 00 65 00 74 00 } //01 00 
		$a_01_4 = {4c 00 4f 00 47 00 53 00 44 00 41 00 52 00 46 00 } //0a 00 
		$a_01_5 = {53 00 50 00 41 00 52 00 54 00 41 00 4e 00 2e 00 70 00 69 00 67 00 } //0a 00 
		$a_01_6 = {6d 00 61 00 67 00 6f 00 2e 00 70 00 69 00 67 00 } //0a 00 
		...
		$a_01_8 = {6c 00 6f 00 76 00 65 00 6d 00 61 00 7a 00 } //0a 00 
