...
rule TrojanDownloader_Win32_Banload_AMW{
	...
	strings :
		...
		$a_01_1 = {4a 4d 62 5a 53 63 7a 70 52 73 50 71 38 34 7a 63 50 63 62 5a 50 47 } //01 00 
...
rule TrojanDownloader_Win32_Banload_AMW_2{
	...
	strings :
		...
		$a_01_3 = {55 61 63 44 69 73 61 62 6c 65 4e 6f 74 69 66 79 } //01 00 
		$a_01_4 = {53 65 63 75 72 69 74 79 20 43 65 6e 74 65 72 } //01 00 
		$a_01_5 = {45 72 72 6f 20 61 6f 20 61 62 72 69 72 20 6f 20 61 72 71 75 69 76 6f } //00 00 
