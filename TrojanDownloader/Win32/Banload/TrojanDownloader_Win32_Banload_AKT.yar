...
rule TrojanDownloader_Win32_Banload_AKT{
	...
	strings :
		...
		$a_01_2 = {64 6f 6d 69 6e 69 6f 74 65 6d 70 6f 72 61 72 69 6f 2e 63 6f 6d } //c8 00 
		$a_01_3 = {64 6c 2e 64 72 6f 70 62 6f 78 2e 63 6f 6d 2f 75 2f 37 34 36 34 37 39 36 30 } //14 00 
		$a_01_4 = {43 4d 44 20 2f 43 20 43 6f 70 79 00 } //14 00 
		$a_01_5 = {46 61 6c 68 61 21 21 21 20 41 72 71 75 69 76 6f 20 } //14 00 
