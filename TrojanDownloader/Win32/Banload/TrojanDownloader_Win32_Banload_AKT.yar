...
rule TrojanDownloader_Win32_Banload_AKT{
	...
	strings :
		...
		$a_01_4 = {43 4d 44 20 2f 43 20 43 6f 70 79 00 } //20 䵃⁄䌯䌠灯y
		$a_01_5 = {46 61 6c 68 61 21 21 21 20 41 72 71 75 69 76 6f 20 } //20 Falha!!! Arquivo 
		$a_01_6 = {62 69 67 6d 61 63 2e 65 78 65 00 } //20
		$a_01_7 = {72 65 61 72 64 65 72 2e 65 78 65 00 } //20
		$a_01_8 = {00 63 72 66 72 73 2e 65 78 65 00 } //20
	condition:
