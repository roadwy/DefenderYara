...
rule TrojanDownloader_Win32_Banload_BH{
	...
	strings :
		...
		$a_02_3 = {ff ff 4b 75 e3 6a 00 6a 00 68 90 01 02 40 00 68 90 01 02 40 00 6a 00 e8 b2 fe ff ff 6a 05 68 90 01 02 40 00 e8 f2 c6 ff ff 33 c0 5a 59 59 64 89 10 68 90 00 } //10
		$a_02_4 = {40 00 64 ff 30 64 89 20 b8 90 01 02 40 00 90 01 03 40 00 e8 90 01 02 ff ff 68 fe 00 00 00 68 90 01 02 40 00 e8 90 01 02 ff ff 8d 90 00 } //1
