...
rule TrojanDownloader_Win32_Banload_BGL{
	...
	strings :
		$a_01_0 = {42 00 41 00 4b 00 41 00 2e 00 42 00 41 00 4b 00 } //01 00  BAKA.BAK
		$a_01_1 = {42 00 55 00 4a 00 55 00 2e 00 42 00 41 00 4b 00 } //01 00  BUJU.BAK
		$a_01_2 = {70 00 6b 00 62 00 61 00 63 00 6b 00 23 00 } //01 00  pkback#
		$a_01_3 = {2e 00 67 00 6f 00 6f 00 67 00 6c 00 65 00 61 00 70 00 69 00 73 00 2e 00 63 00 6f 00 6d 00 2f 00 } //01 00  .googleapis.com/
