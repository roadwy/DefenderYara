...
rule TrojanDownloader_Win32_Banload_PB{
	...
	strings :
		...
		$a_01_1 = {4d 31 2d 28 25 32 30 25 32 30 29 } //01 00  M1-(%20%20)
		$a_01_2 = {63 6f 6e 74 61 64 6f 72 2e 70 68 70 3f 75 72 6c 3d 25 32 30 2d 7c 2d 25 32 30 } //00 00  contador.php?url=%20-|-%20
	condition:
		any of ($a_*)
