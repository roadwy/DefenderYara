...
rule TrojanDownloader_Win32_Banload_BAS{
	...
	strings :
		...
		$a_03_2 = {50 6a 00 6a 00 ff d3 8b d8 eb 0a 68 90 01 02 00 00 e8 90 01 04 84 db 74 f2 90 00 } //1
	condition:
...
rule TrojanDownloader_Win32_Banload_BAS_2{
	...
	strings :
		...
		$a_03_3 = {56 4d 57 61 72 65 90 02 0f 57 69 6e 65 90 02 0f 56 69 72 74 75 61 6c 20 50 43 90 00 } //1
	condition:
...
rule TrojanDownloader_Win32_Banload_BAS_3{
	...
	strings :
		$a_03_0 = {c7 83 6c 03 00 00 90 01 01 00 00 00 8d 83 70 03 00 00 ba 90 01 04 e8 90 01 04 8d 83 74 03 00 00 ba 90 01 04 e8 90 01 04 8d 83 78 03 00 00 ba 90 01 04 e8 90 01 04 33 c0 55 90 00 } //1
...
rule TrojanDownloader_Win32_Banload_BAS_4{
	...
	strings :
		...
		$a_03_5 = {0f b6 44 30 ff 33 c3 89 45 90 01 01 3b 7d 90 01 01 7c 0f 8b 45 90 01 01 05 ff 00 00 00 2b c7 89 45 90 01 01 eb 03 29 7d 90 01 01 8d 45 90 01 01 8b 55 90 01 01 e8 90 01 04 8b 55 90 00 } //10
	condition:
