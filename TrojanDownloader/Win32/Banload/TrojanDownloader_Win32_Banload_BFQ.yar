...
rule TrojanDownloader_Win32_Banload_BFQ{
	...
	strings :
		$a_01_0 = {63 61 73 69 6f 61 68 66 73 61 76 78 31 38 35 32 37 33 31 } //0a 00 
		$a_01_1 = {61 66 76 63 78 6f 75 65 72 69 75 76 63 78 39 38 33 34 32 38 33 } //0a 00 
		$a_01_2 = {6d 7a 69 75 73 64 30 39 38 33 32 35 33 34 37 35 7a 7a 71 65 } //01 00 
