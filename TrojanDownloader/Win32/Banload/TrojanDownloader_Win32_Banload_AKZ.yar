...
rule TrojanDownloader_Win32_Banload_AKZ{
	...
	strings :
		$a_03_0 = {43 3a 5c 50 72 6f 67 72 61 6d 44 61 74 61 5c 90 02 20 68 74 74 70 3a 2f 2f 64 6c 2e 64 72 6f 70 62 6f 78 2e 63 6f 6d 2f 75 2f 37 33 31 36 32 36 31 31 90 02 20 2e 73 77 66 90 02 20 2e 65 78 65 90 00 } //1
