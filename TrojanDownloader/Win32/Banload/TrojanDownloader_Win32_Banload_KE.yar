...
rule TrojanDownloader_Win32_Banload_KE{
	...
	strings :
		...
		$a_02_1 = {ff ff 6a 00 6a 00 6a 00 6a 00 8d 95 dc fb ff ff b8 90 01 04 e8 90 01 02 ff ff 8b 85 dc fb ff ff e8 90 01 02 ff ff 50 e8 90 01 02 ff ff 8b f8 8d 55 f4 b8 90 01 04 e8 90 01 02 ff ff 8b 5d f4 90 00 } //1
