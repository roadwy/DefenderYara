...
rule TrojanDownloader_Win32_Banload_AJO{
	...
	strings :
		$a_03_0 = {80 fb 01 75 df a1 90 01 01 b7 40 00 e8 90 01 02 ff ff 6a 00 68 90 01 02 40 00 68 90 01 02 40 00 6a 00 e8 90 01 02 ff ff e9 90 01 01 01 00 00 8d 55 cc 33 c0 e8 90 01 02 ff ff 8b 55 cc b8 90 01 02 40 00 e8 90 01 02 ff ff 85 c0 0f 8e 90 01 01 01 00 00 b8 90 01 01 b7 40 00 ba 90 01 02 40 00 90 00 } //1
