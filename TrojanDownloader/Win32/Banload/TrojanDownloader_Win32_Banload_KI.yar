...
rule TrojanDownloader_Win32_Banload_KI{
	...
	strings :
		...
		$a_01_3 = {3a 49 4e 49 43 49 4f } //01 00  :INICIO
		$a_01_4 = {44 45 4c 41 50 50 20 45 4c 53 45 20 47 4f 54 4f 20 44 45 4c 42 41 54 } //01 00  DELAPP ELSE GOTO DELBAT
		$a_01_5 = {53 68 61 72 65 64 41 50 50 73 22 3d 2d } //00 00  SharedAPPs"=-
	condition:
		any of ($a_*)
