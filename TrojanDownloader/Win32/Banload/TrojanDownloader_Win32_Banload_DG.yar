...
rule TrojanDownloader_Win32_Banload_DG{
	...
	strings :
		...
		$a_02_1 = {55 8b ec b9 0a 00 00 00 6a 00 6a 00 49 75 f9 90 02 04 33 c0 55 68 90 01 02 46 00 64 ff 30 64 89 20 6a 00 a1 08 88 46 00 8b 00 8b 40 30 50 e8 90 01 04 b8 90 01 02 46 00 e8 90 01 04 84 c0 0f 85 90 01 01 02 00 00 8d 45 fc ba 90 01 02 46 00 e8 90 00 } //10
