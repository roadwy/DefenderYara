...
rule TrojanDownloader_Win32_Banload_AOG{
	...
	strings :
		$a_01_0 = {73 4c 47 67 4c 61 4f 43 56 } //01 00  sLGgLaOCV
		$a_01_1 = {58 37 31 59 42 5a 54 50 42 75 6e 61 34 67 47 } //01 00  X71YBZTPBuna4gG
		$a_01_2 = {59 54 37 63 48 64 73 51 } //01 00  YT7cHdsQ
