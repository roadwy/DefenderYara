...
rule TrojanDownloader_Win32_Banload_JT{
	...
	strings :
		$a_01_0 = {78 69 65 78 70 6c 6f 72 65 72 72 2e 65 78 65 } //01 00 
		$a_01_1 = {45 6e 76 69 61 64 6f 72 20 58 5c 4c 6f 67 61 72 20 42 42 5c 50 75 78 61 64 6f 72 20 32 5c 70 75 78 61 64 6f 72 2e 65 78 65 } //01 00 
