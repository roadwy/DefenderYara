...
rule TrojanDownloader_Win32_Banload_ACY{
	...
	strings :
		...
		$a_00_1 = {76 75 6c 6c 6d 61 73 74 65 72 30 31 } //01 00  vullmaster01
		$a_00_2 = {4c 64 41 72 71 } //01 00  LdArq
		$a_00_3 = {4f 63 6f 72 72 65 75 20 75 6d 20 65 72 72 6f 20 69 6e 65 73 70 65 72 61 64 6f } //00 00  Ocorreu um erro inesperado
	condition:
		any of ($a_*)
