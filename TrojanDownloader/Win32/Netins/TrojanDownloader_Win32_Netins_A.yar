...
rule TrojanDownloader_Win32_Netins_A{
	...
	strings :
		...
		$a_00_1 = {63 6f 75 6e 74 3d 25 64 7c 25 64 26 64 61 74 61 3d 25 73 26 63 6f 70 79 3d 25 73 26 69 6e 66 6f 3d 25 73 26 61 63 74 3d 64 65 62 75 67 } //01 00 
		$a_00_2 = {4e 65 74 49 6e 73 74 61 6c 6c 65 72 32 30 31 30 } //01 00 
		$a_00_3 = {4e 65 74 47 65 74 65 72 } //00 00 
	condition:
		any of ($a_*)
