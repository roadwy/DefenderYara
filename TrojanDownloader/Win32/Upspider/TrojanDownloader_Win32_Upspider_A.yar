...
rule TrojanDownloader_Win32_Upspider_A{
	...
	strings :
		...
		$a_01_1 = {75 70 73 70 69 64 65 72 2e 63 6f 6d } //01 00 
		$a_01_2 = {5c 57 49 4e 44 4f 57 53 5c 73 79 73 74 65 6d 33 32 5c 44 43 42 } //01 00 
		$a_01_3 = {73 79 73 74 65 6d 33 32 5c 64 6c 30 37 2e 64 6c 6c } //01 00 
