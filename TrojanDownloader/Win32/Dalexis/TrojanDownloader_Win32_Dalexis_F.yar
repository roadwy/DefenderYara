...
rule TrojanDownloader_Win32_Dalexis_F{
	...
	strings :
		...
		$a_01_2 = {25 30 38 78 2e 6a 70 67 } //00 00  %08x.jpg
	condition:
		any of ($a_*)
...
rule TrojanDownloader_Win32_Dalexis_F_2{
	...
	strings :
		$a_01_0 = {6b 6c 69 70 6f 70 67 61 2e 70 64 62 } //01 00  klipopga.pdb
		$a_01_1 = {42 68 58 59 4a 6d 6c 65 6e 78 48 66 78 } //01 00  BhXYJmlenxHfx
