...
rule TrojanDownloader_Win32_Obitel_gen_A{
	...
	strings :
		$a_03_0 = {89 75 f8 33 c0 8a 4c 05 90 01 01 80 c1 07 00 4c 35 90 01 01 40 83 f8 15 72 02 33 c0 46 83 fe 0b 90 00 } //2
		...
		$a_03_3 = {3d 38 23 f1 d0 75 90 01 01 81 fa f9 39 9d a1 75 90 00 } //2
		$a_01_4 = {c7 04 24 73 8d c7 26 } //1
		$a_03_5 = {8a 00 3c 3b 74 2d 3a c3 74 29 3c 0d 74 25 3c 0a 74 21 8b 4f 90 09 0c 00 0f 83 90 00 } //3
		$a_03_6 = {8b 08 50 ff 51 1c 85 c0 7c 4d eb 17 8d 86 90 01 02 00 00 8b 08 83 f9 01 74 05 83 f9 02 75 1e 90 00 } //3
	condition:
