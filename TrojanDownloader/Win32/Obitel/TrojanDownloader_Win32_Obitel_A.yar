...
rule TrojanDownloader_Win32_Obitel_A{
	...
	strings :
		$a_00_0 = {66 69 78 61 73 65 72 76 65 72 2e 72 75 } //01 00  fixaserver.ru
		$a_00_1 = {6c 64 72 32 2f 67 61 74 65 2e 70 68 70 } //01 00  ldr2/gate.php
		$a_00_2 = {68 61 73 68 3d } //01 00  hash=
		$a_00_3 = {51 75 65 75 65 55 73 65 72 41 50 43 } //01 00  QueueUserAPC
		$a_00_4 = {75 73 65 72 69 6e 69 2e 65 78 65 } //01 00  userini.exe
