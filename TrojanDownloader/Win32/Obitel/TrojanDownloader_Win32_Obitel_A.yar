...
rule TrojanDownloader_Win32_Obitel_A{
	...
	strings :
		...
		$a_03_5 = {53 55 56 57 33 ed 55 55 55 68 90 01 04 55 55 ff 15 90 01 02 40 00 8b 90 01 05 55 8b f0 56 68 90 01 04 ff d7 8b 90 01 05 55 68 ec 00 00 00 ff d3 55 56 68 90 01 04 ff d7 56 ff 15 90 01 02 40 00 6a 01 6a ff ff d3 5f 5e 5d 33 c0 5b c2 10 00 90 00 } //1
	condition:
