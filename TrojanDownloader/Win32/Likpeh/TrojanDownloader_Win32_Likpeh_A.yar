...
rule TrojanDownloader_Win32_Likpeh_A{
	...
	strings :
		...
		$a_00_2 = {2f 2f 25 73 25 73 3f 61 63 74 25 73 6f 72 26 76 3d 31 26 61 3d 25 64 26 69 64 3d 25 73 26 68 61 72 64 69 64 3d 25 73 } //00 00  //%s%s?act%sor&v=1&a=%d&id=%s&hardid=%s
	condition:
		any of ($a_*)
