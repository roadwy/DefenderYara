...
rule TrojanDownloader_Win32_Chksyn_A{
	...
	strings :
		...
		$a_01_3 = {5c 5c 2e 5c 70 69 70 65 5c 4e 54 53 76 63 4c 6f 61 64 } //02 00 
		$a_01_4 = {69 64 3d 25 78 26 76 65 72 3d 25 64 2e 25 64 26 64 61 74 61 3d 25 73 } //01 00 
		$a_01_5 = {6e 00 74 00 6d 00 69 00 6e 00 69 00 6c 00 72 00 64 00 } //01 00 
		$a_01_6 = {6e 00 74 00 72 00 61 00 64 00 6c 00 64 00 72 00 } //00 00 
	condition:
		any of ($a_*)
