...
rule TrojanDownloader_Win32_Chksyn_A{
	...
	strings :
		$a_02_0 = {8a 06 6a 10 88 45 fd 8d 45 fc 6a 00 50 e8 90 01 02 00 00 8b 4d 90 01 01 83 c4 0c 34 90 01 01 ff 45 90 01 01 46 53 88 01 46 ff d7 90 00 } //4
		$a_01_1 = {8b 45 fc 35 11 ca ad de 5b c9 c3 } //4
		$a_03_2 = {56 ff d7 6a 05 8d 74 06 01 68 90 01 04 56 e8 90 01 02 00 00 83 c4 0c 85 c0 74 c4 90 00 } //4
