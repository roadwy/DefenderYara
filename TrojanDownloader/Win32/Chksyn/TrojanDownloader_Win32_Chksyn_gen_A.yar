...
rule TrojanDownloader_Win32_Chksyn_gen_A{
	...
	strings :
		...
		$a_02_1 = {68 ae d0 16 ab e8 90 01 01 00 00 00 50 e8 90 01 01 00 00 00 ff 74 24 10 ff 74 24 10 ff 74 24 10 ff 74 24 10 ff d0 c3 90 00 } //1
		$a_02_2 = {68 84 9b 50 f2 e8 90 01 01 fe ff ff 50 e8 90 01 01 fe ff ff ff 74 24 08 ff 74 24 08 ff d0 c3 90 00 } //1
		$a_00_3 = {c1 c2 03 32 10 40 80 38 00 0f } //1
		$a_02_4 = {64 a1 30 00 00 00 0f 90 01 02 00 00 00 90 00 } //1
	condition:
