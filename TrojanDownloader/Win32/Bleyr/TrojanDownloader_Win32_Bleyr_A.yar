...
rule TrojanDownloader_Win32_Bleyr_A{
	...
	strings :
		$a_03_0 = {8b c8 33 c0 83 e1 03 f3 a4 b9 3f 00 00 00 8d bc 24 ?? 00 00 00 f3 ab 66 ab aa 8d 7c 24 10 83 c9 ff 33 c0 f2 ae f7 d1 2b f9 8b c1 8b f7 8b fa 33 d2 c1 e9 02 f3 a5 8b c8 33 c0 83 e1 03 f3 a4 8d bc 24 ?? 00 00 00 83 c9 ff f2 ae f7 d1 49 } //5
