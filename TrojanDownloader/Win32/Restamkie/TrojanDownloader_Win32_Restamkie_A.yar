...
rule TrojanDownloader_Win32_Restamkie_A{
	...
	strings :
		...
		$a_01_1 = {52 75 6e 6e 69 6e 67 61 6d 65 73 2e 65 78 65 } //01 00 
		$a_01_2 = {5c 61 4b 33 31 4d 41 53 54 45 52 30 32 2e 65 78 65 } //01 00 
		$a_01_3 = {5c 74 6f 79 73 2e 64 61 74 } //01 00 
