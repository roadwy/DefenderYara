...
rule TrojanDownloader_Win32_Genmaldow_A_bit{
	...
	strings :
		$a_03_0 = {43 3a 5c 50 72 6f 67 72 61 6d 20 46 69 6c 65 73 5c 43 6d 64 20 46 69 6c 65 73 5c 90 02 10 2e 70 6e 67 90 00 } //1
		$a_03_1 = {69 6d 67 2e 73 79 75 61 6e 2e 6e 65 74 2f 66 6f 72 75 6d 2f 90 02 40 2e 6a 70 67 90 00 } //1
