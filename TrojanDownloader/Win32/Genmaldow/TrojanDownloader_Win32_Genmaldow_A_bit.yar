...
rule TrojanDownloader_Win32_Genmaldow_A_bit{
	...
	strings :
		...
		$a_01_2 = {4d 79 41 70 70 42 79 4d 75 6c 69 6e 42 } //01 00  MyAppByMulinB
		$a_01_3 = {45 78 65 50 72 6f 63 65 73 73 74 65 73 74 } //01 00  ExeProcesstest
		$a_01_4 = {73 65 72 76 65 72 2e 64 61 74 } //00 00  server.dat
