...
rule TrojanDownloader_Win32_Redosdru_C{
	...
	strings :
		$a_03_0 = {4b c6 44 24 90 01 01 6f c6 44 24 90 01 01 74 c6 44 24 90 01 01 68 c6 44 24 90 01 01 65 c6 44 24 90 01 01 72 c6 44 24 90 01 01 35 90 00 } //1
		$a_03_1 = {6a 00 80 04 06 90 01 01 ff d7 8b 44 24 0c 8a 14 06 80 f2 90 01 01 88 14 06 46 3b f3 7c 90 00 } //1
