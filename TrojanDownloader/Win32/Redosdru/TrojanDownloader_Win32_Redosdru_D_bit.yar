...
rule TrojanDownloader_Win32_Redosdru_D_bit{
	...
	strings :
		...
		$a_03_2 = {c6 45 f4 4b 90 02 08 c6 45 f5 6f c6 45 f6 74 c6 45 f7 68 c6 45 f8 65 c6 45 f9 72 c6 45 fa 35 c6 45 fb 39 c6 45 fc 39 90 00 } //1
		...
		$a_03_4 = {ff ff 4d c6 85 90 01 02 ff ff 6f c6 85 90 01 02 ff ff 7a c6 85 90 01 02 ff ff 69 c6 85 90 01 02 ff ff 6c c6 85 90 01 02 ff ff 6c c6 85 90 01 02 ff ff 61 c6 85 90 01 02 ff ff 2f c6 85 90 01 02 ff ff 34 c6 85 90 01 02 ff ff 2e 90 00 } //1
	condition:
