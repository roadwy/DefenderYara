...
rule TrojanDownloader_Win32_Redosdru_N_bit{
	...
	strings :
		$a_03_0 = {8b 55 ec 80 04 11 90 01 01 8b 55 ec 80 34 11 90 01 01 41 3b c8 7c ed 90 00 } //1
		...
		$a_03_3 = {4b c6 44 24 90 01 01 6f c6 44 24 90 01 01 74 c6 44 24 90 01 01 68 c6 44 24 90 01 01 65 c6 44 24 90 01 01 72 c6 44 24 90 01 01 35 90 00 } //1
	condition:
