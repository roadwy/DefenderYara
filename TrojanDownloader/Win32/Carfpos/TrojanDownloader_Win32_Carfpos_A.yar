...
rule TrojanDownloader_Win32_Carfpos_A{
	...
	strings :
		$a_01_0 = {46 75 63 6b 59 6f 75 } //01 00  FuckYou
		...
		$a_01_2 = {74 65 73 74 2f 3c 7c 3e 44 4e 46 2e 65 78 65 2c 4c 6f 6c 43 6c 69 65 6e 74 2e 65 78 65 2c 63 72 6f 73 73 66 69 72 65 2e 65 78 65 2c 57 6f 77 2d 36 34 2e 65 78 65 } //01 00  test/<|>DNF.exe,LolClient.exe,crossfire.exe,Wow-64.exe
		$a_01_3 = {2f 6c 6f 76 65 2f } //00 00  /love/
	condition:
		any of ($a_*)
