...
rule TrojanDownloader_Win32_Gotokum_A{
	...
	strings :
		...
		$a_02_3 = {56 8b 74 24 08 68 90 01 02 40 00 56 e8 d1 8d 00 00 68 90 01 02 40 00 56 e8 d6 8d 00 00 68 90 01 02 40 00 56 e8 cb 8d 00 00 68 90 01 02 40 00 56 e8 c0 8d 00 00 68 90 01 02 40 00 56 e8 b5 8d 00 00 68 90 01 02 40 00 56 e8 aa 8d 00 00 83 c4 30 90 00 } //1
	condition:
