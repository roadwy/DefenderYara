...
rule TrojanDownloader_Win32_Swizzor_gen_J{
	...
	strings :
		...
		$a_03_1 = {35 00 00 00 d8 89 0c fd 90 01 04 89 04 fd 90 01 04 47 81 ff ff 00 00 00 0f 8e 1d ff ff ff 90 00 } //1
		$a_03_2 = {8b 8e a4 00 00 00 53 68 58 1b 00 00 51 32 db ff 15 90 01 04 85 c0 75 33 39 46 38 74 21 8b 7c 24 10 8b 96 a8 00 00 00 90 00 } //1
	condition:
