...
rule TrojanDownloader_Win32_Swizzor_gen_E{
	...
	strings :
		$a_03_0 = {02 d8 8b c6 d1 e8 03 44 24 90 01 01 8b 0d 90 01 04 99 f7 3d 90 01 04 83 c6 02 83 c4 08 83 c7 01 32 1c 0a 3b 74 24 90 01 01 88 5f ff 7c ba 90 00 } //1
