...
rule TrojanDownloader_Win32_Bukvice{
	...
	strings :
		...
		$a_00_1 = {64 65 6c 20 2f 73 20 2f 71 20 22 6b 69 6c 6c 66 69 6c 65 2e 62 61 74 22 } //02 00 
		$a_00_2 = {5c 53 65 72 76 69 63 65 44 6f 77 6e 4c 6f 61 64 65 72 2e 69 6e 69 } //00 00 
	condition:
		any of ($a_*)
