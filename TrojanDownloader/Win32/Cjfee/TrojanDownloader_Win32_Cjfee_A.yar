...
rule TrojanDownloader_Win32_Cjfee_A{
	...
	strings :
		$a_01_0 = {62 6f 74 2e 63 6a 66 65 65 64 73 2e 63 6f 6d 2f 74 61 73 6b 73 2e 70 68 70 3f 63 6a 3d 25 73 26 64 6f 6d 61 69 6e 3d 25 73 26 76 3d } //01 00  bot.cjfeeds.com/tasks.php?cj=%s&domain=%s&v=
		$a_01_1 = {63 6a 62 5c 63 6a 62 38 2e 65 78 65 } //01 00  cjb\cjb8.exe
		...
		$a_01_3 = {49 6e 74 65 72 6e 65 74 43 72 61 63 6b 55 72 6c 41 } //01 00  InternetCrackUrlA
