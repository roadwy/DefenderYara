...
rule TrojanDownloader_BAT_CoinMiner_B_bit{
	...
	strings :
		...
		$a_03_5 = {26 00 63 00 70 00 75 00 3d 00 90 02 02 26 00 68 00 69 00 7a 00 3d 00 30 00 26 00 68 00 64 00 64 00 3d 00 90 02 02 26 00 75 00 73 00 65 00 72 00 73 00 3d 00 90 02 02 26 00 69 00 70 00 3d 00 90 02 02 26 00 64 00 6f 00 6d 00 61 00 69 00 6e 00 73 00 3d 00 90 02 02 26 00 6d 00 69 00 6e 00 69 00 6e 00 67 00 3d 00 90 00 } //1
	condition:
