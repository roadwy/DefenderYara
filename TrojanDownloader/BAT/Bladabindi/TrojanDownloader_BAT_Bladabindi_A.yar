...
rule TrojanDownloader_BAT_Bladabindi_A{
	...
	strings :
		...
		$a_00_2 = {6c 69 6e 6b 73 20 53 74 61 72 74 55 50 20 68 61 73 68 } //00 00  links StartUP hash
	condition:
		any of ($a_*)
...
rule TrojanDownloader_BAT_Bladabindi_A_2{
	...
	strings :
		...
		$a_00_3 = {6c 69 6e 6b 73 20 53 74 61 72 74 55 50 20 68 61 73 68 } //00 00  links StartUP hash
	condition:
		any of ($a_*)
