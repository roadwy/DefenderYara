...
rule TrojanDownloader_BAT_Bladabindi_A{
	...
	strings :
		$a_03_0 = {1d 28 05 00 00 0a 72 90 01 01 00 00 70 7e 03 00 00 04 72 90 01 01 00 00 70 28 06 00 00 0a 17 73 0b 00 00 0a 0b 28 0c 00 00 0a 6f 0d 00 00 0a 28 0e 00 00 0a 90 00 } //2
...
rule TrojanDownloader_BAT_Bladabindi_A_2{
	...
	strings :
		$a_03_0 = {de 00 1d 28 90 01 04 72 90 01 04 7e 90 01 04 72 90 01 04 28 90 00 } //1
		$a_03_1 = {11 08 14 72 90 01 04 16 8d 01 00 00 01 14 14 14 28 90 01 04 14 72 90 01 04 18 8d 01 00 00 01 90 00 } //1
