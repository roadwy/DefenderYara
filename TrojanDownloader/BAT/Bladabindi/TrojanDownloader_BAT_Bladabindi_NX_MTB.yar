...
rule TrojanDownloader_BAT_Bladabindi_NX_MTB{
	...
	strings :
		...
		$a_81_3 = {64 61 6f 4c } //01 00 
		$a_81_4 = {6d 6f 63 2e 6e 69 62 65 74 73 61 70 } //01 00 
		$a_81_5 = {53 74 72 52 65 76 65 72 73 65 } //01 00 
		$a_81_6 = {2f 77 61 72 2f 40 35 38 45 43 33 30 41 39 43 32 33 32 33 30 35 36 34 43 40 } //01 00 
