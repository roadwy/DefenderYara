...
rule TrojanDownloader_BAT_Lenwadu_C_bit{
	...
	strings :
		$a_03_0 = {68 00 74 00 74 00 70 00 3a 00 2f 00 2f 00 74 00 65 00 6e 00 64 00 61 00 6e 00 63 00 65 00 6b 00 61 00 72 00 74 00 2e 00 63 00 6f 00 6d 00 2f 00 [0-30] 2e 00 65 00 78 00 65 00 } //1
