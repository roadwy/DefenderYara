...
rule TrojanDownloader_BAT_FormBook_ABL_MTB{
	...
	strings :
		$a_03_0 = {1e 5b 6f 12 ?? ?? 0a 6f ?? ?? ?? 0a 07 17 6f ?? ?? ?? 0a 06 07 6f ?? ?? ?? 0a 17 73 ?? ?? ?? 0a 0d 16 2d ef 2b 03 0c 2b bb 09 02 16 02 8e 69 6f ?? ?? ?? 0a de 07 09 6f ?? ?? ?? 0a dc 06 6f ?? ?? ?? 0a 13 04 de 4c } //3
		$a_03_1 = {08 2b dc 6f ?? ?? ?? 0a 2b d7 07 2b d6 } //3
