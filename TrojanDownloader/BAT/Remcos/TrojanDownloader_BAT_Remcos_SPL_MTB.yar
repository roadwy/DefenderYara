...
rule TrojanDownloader_BAT_Remcos_SPL_MTB{
	...
	strings :
		$a_03_0 = {06 18 2d 05 26 16 0d 2b 03 0c 2b f9 08 12 03 28 90 01 03 0a 06 03 07 28 90 01 03 06 6f 90 01 03 0a de 0a 09 2c 06 08 28 90 01 03 0a dc 07 18 58 0b 07 03 6f 90 01 03 0a 32 c6 90 00 } //5
