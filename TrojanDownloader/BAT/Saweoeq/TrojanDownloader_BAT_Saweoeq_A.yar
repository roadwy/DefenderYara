...
rule TrojanDownloader_BAT_Saweoeq_A{
	...
	strings :
		...
		$a_02_2 = {3a 00 2f 00 2f 00 73 00 34 00 76 00 65 00 2e 00 72 00 75 00 2f 00 64 00 6f 00 77 00 6e 00 6c 00 6f 00 61 00 64 00 65 00 72 00 2f 00 73 00 34 00 76 00 65 00 5f 00 61 00 64 00 73 00 90 01 02 2e 00 65 00 78 00 65 00 90 00 } //2
	condition:
