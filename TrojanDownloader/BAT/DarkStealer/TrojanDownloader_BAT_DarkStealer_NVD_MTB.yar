...
rule TrojanDownloader_BAT_DarkStealer_NVD_MTB{
	...
	strings :
		...
		$a_01_3 = {30 00 2e 00 74 00 63 00 70 00 2e 00 6e 00 67 00 72 00 6f 00 6b 00 2e 00 69 00 6f 00 } //01 00  0.tcp.ngrok.io
		$a_01_4 = {68 00 61 00 63 00 6b 00 65 00 64 00 20 00 62 00 79 00 20 00 61 00 6d 00 67 00 } //01 00  hacked by amg
		$a_01_5 = {63 00 6d 00 64 00 2e 00 65 00 78 00 65 00 } //00 00  cmd.exe
	condition:
		any of ($a_*)
