...
rule TrojanDownloader_BAT_Nanocore_ABH_MTB{
	...
	strings :
		$a_03_0 = {07 08 07 6f 90 01 03 0a 1e 5b 6f 90 01 03 0a 6f 90 01 03 0a 07 17 6f 90 01 03 0a 06 07 6f 90 01 03 0a 17 73 90 01 03 0a 0d 09 02 16 02 8e 69 6f 90 01 03 0a de 0a 09 2c 06 09 6f 90 01 03 0a dc 06 6f 90 01 03 0a 13 04 de 4b 90 00 } //3
