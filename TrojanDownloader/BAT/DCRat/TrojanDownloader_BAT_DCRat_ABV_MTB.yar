...
rule TrojanDownloader_BAT_DCRat_ABV_MTB{
	...
	strings :
		$a_03_0 = {26 16 28 24 90 01 02 0a 72 21 90 01 02 70 28 25 90 01 02 0a 26 17 0c 16 90 0a 44 00 73 0e 90 01 02 06 0a 28 23 90 01 02 0a 0b 1f 1a 28 24 90 01 02 0a 72 0d 90 01 02 70 28 25 90 01 01 00 0a 90 00 } //4
