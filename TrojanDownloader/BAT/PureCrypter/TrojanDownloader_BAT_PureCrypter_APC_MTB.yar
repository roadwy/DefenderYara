...
rule TrojanDownloader_BAT_PureCrypter_APC_MTB{
	...
	strings :
		...
		$a_03_1 = {20 00 0c 00 00 28 90 01 03 06 38 00 00 00 00 dd 10 00 00 00 26 38 00 00 00 00 dd 05 00 00 00 38 00 00 00 00 02 28 90 01 03 0a 74 17 00 00 01 6f 90 01 03 0a 73 1a 00 00 0a 13 00 90 00 } //1
	condition:
