...
rule TrojanDownloader_BAT_PsDownload_ABAS_MTB{
	...
	strings :
		$a_03_0 = {00 00 0a 0b 16 0a 2b 36 07 13 05 16 13 06 11 05 12 06 28 ?? 00 00 0a 07 09 06 18 6f ?? 00 00 0a 1f 10 28 ?? 00 00 0a 6f ?? 00 00 0a de 0c 11 06 2c 07 11 05 28 ?? 00 00 0a dc 06 18 58 0a 06 09 6f ?? 00 00 0a fe 04 13 07 11 07 2d bb 07 6f ?? 00 00 0a 28 ?? 00 00 0a 13 08 11 08 } //10
