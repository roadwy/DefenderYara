...
rule TrojanDownloader_BAT_QuasarRAT_A_MTB{
	...
	strings :
		...
		$a_01_4 = {53 65 63 75 72 69 74 79 50 72 6f 74 6f 63 6f 6c 54 79 70 65 } //01 00 
		$a_01_5 = {4d 65 6d 6f 72 79 53 74 72 65 61 6d } //01 00 
		$a_01_6 = {48 74 74 70 57 65 62 52 65 71 75 65 73 74 } //01 00 
		...
		$a_01_10 = {47 65 74 4d 65 74 68 6f 64 73 } //00 00 
	condition:
		any of ($a_*)
