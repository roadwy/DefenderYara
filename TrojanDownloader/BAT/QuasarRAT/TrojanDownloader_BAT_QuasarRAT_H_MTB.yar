...
rule TrojanDownloader_BAT_QuasarRAT_H_MTB{
	...
	strings :
		$a_03_0 = {01 25 d0 01 00 00 04 90 01 01 2d 0e 26 26 6f 90 01 01 00 00 0a 28 90 01 01 00 00 06 2b 07 28 90 01 01 00 00 0a 2b ed 2a 90 00 } //2
		$a_03_1 = {07 08 18 5b 02 08 18 6f 90 01 01 00 00 0a 1f 10 28 90 01 01 00 00 0a 9c 08 18 58 0c 08 06 90 00 } //2
