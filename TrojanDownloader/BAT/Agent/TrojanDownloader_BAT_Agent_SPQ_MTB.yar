...
rule TrojanDownloader_BAT_Agent_SPQ_MTB{
	...
	strings :
		$a_03_0 = {11 04 08 1f 1a 28 90 01 03 0a 72 81 00 00 70 09 28 90 01 03 0a 6f 90 01 03 0a 00 1f 1a 28 90 01 03 0a 72 37 00 00 70 28 90 01 03 0a 28 90 01 03 0a 26 de 0e 90 00 } //2
