...
rule TrojanDownloader_BAT_Agent_MA_MTB{
	...
	strings :
		...
		$a_81_5 = {50 6c 65 61 73 65 57 61 69 74 2e 65 78 65 } //01 00 
		$a_81_6 = {43 3a 5c 55 73 65 72 73 5c 50 43 5c 44 65 73 6b 74 6f 70 5c 50 6c 65 61 73 65 57 61 69 74 5c 50 6c 65 61 73 65 57 61 69 74 5c 6f 62 6a 5c 44 65 62 75 67 5c 50 6c 65 61 73 65 57 61 69 74 2e 70 64 62 } //01 00 
		$a_81_7 = {46 6f 72 6d 31 5f 4c 6f 61 64 } //01 00 
		$a_81_8 = {64 6f 65 73 20 6e 6f 74 20 77 6f 72 6b 20 6f 6e 20 79 6f 75 72 20 63 6f 6d 70 75 74 65 72 } //00 00 
	condition:
		any of ($a_*)
