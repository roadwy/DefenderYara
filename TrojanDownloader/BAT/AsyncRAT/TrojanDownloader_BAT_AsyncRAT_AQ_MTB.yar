...
rule TrojanDownloader_BAT_AsyncRAT_AQ_MTB{
	...
	strings :
		$a_01_0 = {49 00 7a 00 66 00 6a 00 66 00 61 00 64 00 69 00 62 00 76 00 69 00 78 00 6a 00 6c 00 71 00 } //02 00  Izfjfadibvixjlq
		$a_01_1 = {48 00 6d 00 76 00 6e 00 69 00 6b 00 69 00 64 00 69 00 72 00 74 00 79 00 6b 00 76 00 62 00 } //01 00  Hmvnikidirtykvb
