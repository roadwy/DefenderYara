...
rule TrojanDownloader_BAT_AsyncRat_CCHZ_MTB{
	...
	strings :
		$a_03_0 = {13 14 11 14 6f 90 01 01 00 00 0a 26 73 90 01 04 13 15 11 15 72 90 01 01 06 00 70 73 90 01 03 0a 06 07 28 90 01 01 00 00 0a 6f 90 01 01 00 00 0a 00 73 90 01 01 00 00 0a 13 16 11 16 72 90 00 } //1
