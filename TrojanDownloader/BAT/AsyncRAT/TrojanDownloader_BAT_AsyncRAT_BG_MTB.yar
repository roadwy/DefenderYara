...
rule TrojanDownloader_BAT_AsyncRAT_BG_MTB{
	...
	strings :
		$a_03_0 = {00 00 0a 20 00 0c 00 00 28 ?? 00 00 0a d0 ?? 00 00 1b 28 ?? 00 00 0a 73 ?? 00 00 0a 06 28 ?? 00 00 0a 28 ?? 00 00 0a 72 48 01 00 70 6f ?? 00 00 0a 72 8a 01 00 70 6f ?? 00 00 0a 28 ?? 00 00 0a 74 ?? 00 00 1b 0b 07 72 ae 01 00 70 6f ?? 00 00 0a 26 2a } //2
