...
rule TrojanDownloader_BAT_AsyncRAT_BD_MTB{
	...
	strings :
		$a_03_0 = {07 09 16 6f 90 01 01 00 00 0a 13 04 12 04 28 90 01 01 00 00 0a 6f 90 01 01 00 00 0a 00 09 17 d6 0d 09 08 31 dc 7e ef 06 00 04 6f 90 01 01 00 00 0a 28 90 01 01 0d 00 06 26 de 90 00 } //2
