...
rule TrojanDownloader_BAT_AsyncRAT_AP_MTB{
	...
	strings :
		$a_03_0 = {0a 10 00 02 6f 90 01 01 00 00 0a 18 5b 8d 90 01 01 00 00 01 0a 16 0b 2b 18 06 07 02 07 18 5a 18 6f 90 01 01 00 00 0a 1f 10 28 90 01 01 00 00 0a 9c 07 17 58 0b 07 06 8e 69 32 90 00 } //2
		$a_03_1 = {0a 20 00 0f 00 00 60 28 90 01 01 00 00 0a 72 90 00 } //2
