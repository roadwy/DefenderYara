...
rule TrojanDownloader_BAT_AsyncRAT_S_MTB{
	...
	strings :
		$a_03_0 = {08 13 07 16 13 09 11 07 12 09 28 ?? 00 00 0a 08 11 06 06 18 6f ?? 00 00 0a 1f 10 28 ?? 00 00 0a 6f ?? 00 00 0a de } //2
		$a_03_1 = {06 18 58 0a 06 11 06 6f ?? 00 00 0a fe 04 13 0a 11 0a 2d } //2
