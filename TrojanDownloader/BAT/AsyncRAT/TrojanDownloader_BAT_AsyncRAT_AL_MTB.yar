...
rule TrojanDownloader_BAT_AsyncRAT_AL_MTB{
	...
	strings :
		$a_03_0 = {11 02 11 07 11 01 02 11 07 18 5a 18 6f 90 01 01 00 00 0a 6f 90 01 01 00 00 0a 9c 38 90 01 01 ff ff ff 11 03 6f 90 01 01 00 00 0a 13 07 38 90 00 } //2
