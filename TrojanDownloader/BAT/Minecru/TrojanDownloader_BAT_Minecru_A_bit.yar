...
rule TrojanDownloader_BAT_Minecru_A_bit{
	...
	strings :
		$a_03_0 = {07 06 28 22 00 00 0a 06 6f 23 00 00 0a 6b 5a 22 00 00 90 01 02 59 6b 6c 28 1e 00 00 0a b7 6f 24 00 00 0a 28 25 00 00 0a 28 26 00 00 0a 0b 09 17 d6 0d 09 1f 90 01 01 31 ca 90 00 } //1
