...
rule TrojanDownloader_BAT_RedLineStealer_KN_MTB{
	...
	strings :
		$a_03_0 = {06 12 01 28 90 01 01 00 00 0a 7e 90 01 01 00 00 04 02 28 90 01 01 00 00 0a 0c 08 7e 90 01 01 00 00 04 6f 90 01 01 00 00 0a 3c 90 01 01 00 00 00 7e 90 01 01 00 00 04 08 6f 90 01 01 00 00 0a 02 40 90 01 01 00 00 00 7e 90 01 01 00 00 04 08 6f 90 01 01 00 00 0a 0d dd 90 00 } //2
