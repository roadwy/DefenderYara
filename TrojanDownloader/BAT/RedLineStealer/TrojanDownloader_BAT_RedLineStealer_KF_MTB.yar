...
rule TrojanDownloader_BAT_RedLineStealer_KF_MTB{
	...
	strings :
		$a_03_0 = {06 28 01 00 00 2b 28 02 00 00 2b 90 02 15 28 90 01 03 0a 38 90 01 03 ff 6f 90 01 03 0a 38 90 01 03 ff 6f 90 01 03 0a 38 90 01 03 ff 73 90 01 03 0a 38 90 01 03 ff 6f 90 01 03 0a 38 90 01 03 ff 0a 38 90 00 } //1
