...
rule TrojanDownloader_BAT_RedLineStealer_KO_MTB{
	...
	strings :
		$a_03_0 = {02 06 07 72 6f 90 01 01 00 70 17 72 3d 90 01 01 00 70 6f 90 01 01 00 00 06 6f 90 01 01 00 00 06 7d 90 01 01 00 00 04 02 06 07 72 e5 90 01 01 00 70 17 72 5d 90 01 01 00 70 6f 90 01 01 00 00 06 6f 90 01 01 00 00 06 7d 90 01 01 00 00 04 06 17 1f 64 6a 1f 14 6a 16 6a 6f 90 01 01 00 00 06 0c 08 2c 31 00 06 02 7b 90 00 } //2
