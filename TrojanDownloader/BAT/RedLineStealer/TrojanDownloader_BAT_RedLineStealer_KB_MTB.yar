...
rule TrojanDownloader_BAT_RedLineStealer_KB_MTB{
	...
	strings :
		$a_03_0 = {0a 00 08 6f 90 01 03 0a 00 16 2d 90 01 01 06 08 6f 90 01 03 0a 16 08 6f 90 01 03 0a 8e 69 6f 90 01 03 0a 00 06 0d 90 0a 46 00 72 90 01 03 70 2b 90 01 01 2b 90 01 01 2b 90 01 01 2b 90 01 01 20 90 01 03 05 2b 90 01 01 2b 90 01 01 73 90 01 03 0a 0c 08 07 6f 90 00 } //1
