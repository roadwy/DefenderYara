...
rule TrojanDownloader_BAT_Sedato_ARA_MTB{
	...
	strings :
		...
		$a_01_1 = {44 6f 77 6e 6c 6f 61 64 46 69 6c 65 41 73 79 6e 63 } //03 00  DownloadFileAsync
		$a_01_2 = {68 74 74 70 73 3a 2f 2f 73 65 65 64 61 75 74 6f 2e 6e 65 74 2f 77 65 62 } //02 00  https://seedauto.net/web
		...
		$a_01_6 = {50 72 6f 63 65 73 73 53 74 61 72 74 49 6e 66 6f } //01 00  ProcessStartInfo
		...
		$a_01_9 = {67 65 74 5f 41 73 73 65 6d 62 6c 79 } //00 00  get_Assembly
	condition:
		any of ($a_*)
