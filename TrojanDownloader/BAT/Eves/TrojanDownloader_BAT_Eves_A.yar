...
rule TrojanDownloader_BAT_Eves_A_2{
	...
	strings :
		...
		$a_02_1 = {68 00 74 00 74 00 70 00 3a 00 2f 00 2f 00 31 00 39 00 38 00 2e 00 35 00 30 00 2e 00 31 00 35 00 39 00 2e 00 31 00 35 00 35 00 2f 00 90 02 06 2f 00 90 02 05 2e 00 65 00 78 00 65 00 90 00 } //1
	condition:
