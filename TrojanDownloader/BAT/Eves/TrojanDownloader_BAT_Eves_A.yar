...
rule TrojanDownloader_BAT_Eves_A{
	...
	strings :
		$a_01_0 = {62 37 32 62 53 49 4c 6c 7a 43 77 58 42 53 72 51 } //01 00  b72bSILlzCwXBSrQ
		$a_01_1 = {51 69 63 6f 77 49 47 4f 4e 79 64 46 45 76 } //00 00  QicowIGONydFEv
		$a_00_2 = {78 } //67 00  x
	condition:
		any of ($a_*)
...
rule TrojanDownloader_BAT_Eves_A_2{
	...
	strings :
		$a_00_0 = {49 00 73 00 61 00 73 00 73 00 33 00 32 00 33 00 2e 00 65 00 78 00 65 00 } //01 00  Isass323.exe
