...
rule TrojanDownloader_BAT_Zegost_A{
	...
	strings :
		$a_00_0 = {6d 00 61 00 78 00 31 00 32 00 33 00 34 00 } //01 00  max1234
		...
		$a_00_2 = {63 00 3a 00 2f 00 77 00 69 00 6e 00 64 00 6f 00 77 00 73 00 2f 00 73 00 79 00 73 00 2e 00 69 00 6e 00 69 00 } //00 00  c:/windows/sys.ini
	condition:
		any of ($a_*)
