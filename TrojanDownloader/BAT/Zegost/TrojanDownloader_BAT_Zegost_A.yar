...
rule TrojanDownloader_BAT_Zegost_A{
	...
	strings :
		...
		$a_02_1 = {66 00 74 00 70 00 3a 00 2f 00 2f 00 6d 00 61 00 31 00 32 00 33 00 34 00 2e 00 6d 00 69 00 72 00 65 00 65 00 6e 00 65 00 2e 00 63 00 6f 00 6d 00 2f 00 2f 00 68 00 74 00 6d 00 6c 00 2f 00 90 02 10 2e 00 65 00 78 00 65 00 90 00 } //1
