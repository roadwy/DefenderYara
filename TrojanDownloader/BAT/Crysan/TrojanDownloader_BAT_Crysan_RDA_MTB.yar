...
rule TrojanDownloader_BAT_Crysan_RDA_MTB{
	...
	strings :
		...
		$a_03_3 = {00 28 43 00 00 0a 03 90 01 05 16 1f 20 6f 40 00 00 0a 6f 44 00 00 0a 0a 28 43 00 00 0a 04 90 01 05 16 1f 10 6f 40 00 00 0a 6f 44 00 00 0a 0b 02 06 07 90 01 05 0c 2b 00 08 2a 90 00 } //2
	condition:
