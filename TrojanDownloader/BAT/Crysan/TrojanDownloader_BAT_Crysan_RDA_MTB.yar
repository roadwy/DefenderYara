...
rule TrojanDownloader_BAT_Crysan_RDA_MTB{
	...
	strings :
		$a_01_0 = {31 36 63 63 66 39 35 30 2d 64 31 30 66 2d 34 64 36 34 2d 39 31 65 30 2d 65 65 34 36 30 62 65 34 66 31 66 31 } //01 00  16ccf950-d10f-4d64-91e0-ee460be4f1f1
		$a_01_1 = {42 65 72 6e 79 53 70 6f 6f 66 65 72 } //01 00  BernySpoofer
		$a_01_2 = {53 74 6f 6e 65 6c 65 73 73 2d 32 34 35 37 } //02 00  Stoneless-2457
