...
rule TrojanDownloader_BAT_Crysan_IFL_MTB{
	...
	strings :
		$a_01_0 = {31 00 39 00 34 00 2e 00 32 00 36 00 2e 00 31 00 39 00 32 00 2e 00 31 00 33 00 31 00 } //01 00  194.26.192.131
		$a_01_1 = {74 00 75 00 74 00 6f 00 72 00 69 00 61 00 6c 00 2e 00 67 00 79 00 61 00 } //01 00  tutorial.gya
