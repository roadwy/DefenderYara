...
rule TrojanDownloader_BAT_BitRAT_ABL_MTB{
	...
	strings :
		$a_03_0 = {0d 08 09 6f 90 01 03 0a 00 09 6f 90 01 03 0a 80 90 01 03 04 16 13 04 2b 1f 00 7e 90 01 03 04 11 04 7e 90 01 03 04 11 04 91 20 90 01 03 00 59 d2 9c 00 11 04 17 58 13 04 11 04 7e 90 01 03 04 8e 69 fe 04 13 05 11 05 2d d0 90 00 } //1
