...
rule TrojanDownloader_BAT_BitRAT_J_MTB{
	...
	strings :
		$a_03_0 = {11 02 11 00 6f 90 01 01 00 00 0a 13 03 38 0d 00 00 00 11 01 18 6f 90 01 01 00 00 0a 38 28 00 00 00 11 01 11 03 6f 90 01 01 00 00 0a 38 e5 ff ff ff 11 01 6f 22 00 00 0a 11 04 16 11 04 8e 69 6f 90 01 01 00 00 0a 13 05 38 08 00 00 00 02 13 04 38 90 00 } //2
