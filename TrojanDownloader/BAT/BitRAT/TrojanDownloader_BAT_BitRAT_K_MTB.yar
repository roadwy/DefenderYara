...
rule TrojanDownloader_BAT_BitRAT_K_MTB{
	...
	strings :
		$a_03_0 = {0a 06 20 e8 03 00 00 73 ?? 00 00 0a 0d 08 09 08 6f ?? 00 00 0a 1e 5b 6f ?? 00 00 0a 6f ?? 00 00 0a 08 09 08 6f ?? 00 00 0a 1e 5b 6f ?? 00 00 0a 6f ?? 00 00 0a 08 17 6f } //2
		$a_03_1 = {0a 13 04 11 04 02 16 02 8e 69 6f ?? 00 00 0a 11 04 6f } //2
