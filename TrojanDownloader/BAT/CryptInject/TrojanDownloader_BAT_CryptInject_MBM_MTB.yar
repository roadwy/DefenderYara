...
rule TrojanDownloader_BAT_CryptInject_MBM_MTB{
	...
	strings :
		...
		$a_01_1 = {5a 00 78 00 63 00 68 00 61 00 71 00 6f 00 6c 00 6b 00 70 00 2e 00 46 00 68 00 78 00 6e 00 73 00 6b 00 61 00 } //01 00  Zxchaqolkp.Fhxnska
		$a_81_2 = {56 69 77 73 72 67 78 7a 65 76 } //00 00  Viwsrgxzev
	condition:
		any of ($a_*)
