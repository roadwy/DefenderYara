...
rule TrojanDownloader_BAT_RemcosRAT_C_MTB{
	...
	strings :
		$a_03_0 = {0a 0a 00 06 02 6f 90 01 03 0a 0b 00 73 90 01 03 0a 0c 00 07 08 6f 90 01 03 0a 00 08 6f 90 01 03 0a 0d de 90 00 } //1
		$a_03_1 = {0a 0c 00 08 07 90 0a 1f 00 02 73 90 01 03 0a 0a 00 73 90 01 03 0a 0b 00 06 16 73 90 01 03 0a 73 90 00 } //1
		$a_03_2 = {0a 0b 00 07 6f 90 01 03 0a 72 90 01 03 70 28 90 01 03 0a 0c 08 2c 90 01 01 07 0d de 90 00 } //1
