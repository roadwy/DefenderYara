...
rule TrojanDownloader_BAT_BrobanDel_A{
	...
	strings :
		...
		$a_03_3 = {5c 00 61 00 2e 00 64 00 6c 00 6c 00 90 02 06 77 00 69 00 6e 00 64 00 69 00 72 00 90 00 } //1
		...
		$a_03_5 = {5c 00 67 00 62 00 70 00 6c 00 75 00 67 00 69 00 6e 00 90 02 10 75 00 73 00 65 00 72 00 6e 00 61 00 6d 00 65 00 90 00 } //1
		...
		$a_03_7 = {6c 00 69 00 6e 00 6b 00 3d 90 02 08 64 00 6e 00 73 00 3d 90 02 08 5c 00 61 00 2e 00 64 00 6c 00 6c 90 00 } //1
	condition:
