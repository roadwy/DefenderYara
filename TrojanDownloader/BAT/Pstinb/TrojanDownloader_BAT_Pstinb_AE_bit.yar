...
rule TrojanDownloader_BAT_Pstinb_AE_bit{
	...
	strings :
		...
		$a_01_1 = {61 00 48 00 52 00 30 00 63 00 48 00 4d 00 36 00 4c 00 79 00 39 00 77 00 59 00 58 00 4e 00 30 00 5a 00 57 00 4a 00 70 00 62 00 69 00 35 00 6a 00 62 00 32 00 30 00 } //00 00  aHR0cHM6Ly9wYXN0ZWJpbi5jb20
	condition:
		any of ($a_*)
