...
rule TrojanDownloader_BAT_Tiny_AP_MTB{
	...
	strings :
		$a_02_0 = {0a 0d 09 09 6f 90 01 03 0a 72 90 01 03 70 72 90 01 03 70 72 90 01 03 70 6f 90 01 03 0a 18 8d 90 01 03 01 13 05 11 05 16 72 90 01 03 70 a2 11 05 14 14 90 00 } //10
