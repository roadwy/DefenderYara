...
rule TrojanDownloader_BAT_Tiny_KA_MTB{
	...
	strings :
		$a_03_0 = {00 00 0a 0b 07 72 90 01 01 00 00 70 6f 90 01 01 00 00 0a 0a 28 90 01 01 00 00 0a 72 90 01 01 00 00 70 28 90 01 01 00 00 0a 0c 08 06 28 90 01 01 00 00 0a 08 28 90 01 01 00 00 0a 26 2a 90 00 } //10
