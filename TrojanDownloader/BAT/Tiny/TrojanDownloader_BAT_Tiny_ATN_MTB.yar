...
rule TrojanDownloader_BAT_Tiny_ATN_MTB{
	...
	strings :
		$a_03_0 = {a2 08 1f 2a 1f 90 01 01 8c 07 00 00 01 a2 08 1f 2b 1f 90 01 01 8c 07 00 00 01 a2 08 1f 2c 1f 90 01 01 8c 07 00 00 01 a2 08 1f 2d 1f 90 01 01 8c 07 00 00 01 a2 08 1f 2e 1f 90 01 01 8c 07 00 00 01 a2 08 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule TrojanDownloader_BAT_Tiny_ATN_MTB_2{
	...
	strings :
		$a_03_0 = {0a 02 17 6f 90 01 01 00 00 0a 2d 2a 28 90 01 01 00 00 0a 6f 90 01 01 00 00 0a 6f 90 01 01 00 00 0a 02 28 90 01 01 00 00 06 02 28 90 01 01 00 00 06 02 28 90 00 } //2
