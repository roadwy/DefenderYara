...
rule TrojanDownloader_BAT_Tiny_AT_MTB{
	...
	strings :
		$a_03_0 = {0c 08 02 6f 90 01 01 00 00 0a 00 08 03 6f 90 01 01 00 00 0a 00 08 16 6f 90 01 01 00 00 0a 00 08 17 6f 90 01 01 00 00 0a 00 08 17 6f 90 01 01 00 00 0a 00 08 0a 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule TrojanDownloader_BAT_Tiny_AT_MTB_3{
	...
	strings :
		$a_03_0 = {0a 0c 00 08 06 6f 90 01 01 00 00 0a 6f 90 01 01 00 00 0a 0d 07 09 28 90 01 01 00 00 0a 00 00 de 0b 90 00 } //2
...
rule TrojanDownloader_BAT_Tiny_AT_MTB_4{
	...
	strings :
		$a_03_0 = {13 05 11 05 11 04 16 9a 6f 90 01 03 0a 6f 90 01 03 0a 13 06 11 05 11 04 17 9a 6f 90 01 03 0a 6f 90 01 03 0a 13 07 11 06 11 06 6f 90 01 03 0a 17 59 6f 90 01 03 0a 13 06 11 06 28 90 01 03 0a 13 08 28 90 01 03 0a 11 08 6f 90 01 03 0a 13 06 11 06 11 07 90 00 } //2
