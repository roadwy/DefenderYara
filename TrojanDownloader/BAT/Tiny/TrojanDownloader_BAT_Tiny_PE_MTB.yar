...
rule TrojanDownloader_BAT_Tiny_PE_MTB{
	...
	strings :
		...
		$a_03_2 = {68 00 74 00 74 00 70 00 90 02 02 3a 00 2f 00 2f 00 6c 00 69 00 67 00 68 00 74 00 2d 00 62 00 69 00 6e 00 2e 00 74 00 6b 00 2f 00 72 00 61 00 77 00 2f 00 90 00 } //1
