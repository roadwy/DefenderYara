...
rule TrojanDownloader_BAT_Tiny_PB_MTB{
	...
	strings :
		$a_02_0 = {28 06 00 00 0a 72 01 00 00 70 28 07 00 00 0a 18 73 08 00 00 0a 0a 00 72 90 01 01 00 00 70 28 09 00 00 0a 28 02 00 00 06 0b 06 07 16 07 8e 69 6f 90 01 01 00 00 0a 00 00 de 90 00 } //1
