...
rule TrojanDownloader_BAT_Seraph_MD_MTB{
	...
	strings :
		...
		$a_03_1 = {68 00 74 00 74 00 70 00 3a 00 2f 00 2f 00 39 00 31 00 2e 00 32 00 34 00 33 00 2e 00 34 00 34 00 2e 00 31 00 39 00 2f 00 90 02 10 2e 00 6a 00 70 00 65 00 67 00 90 00 } //1
