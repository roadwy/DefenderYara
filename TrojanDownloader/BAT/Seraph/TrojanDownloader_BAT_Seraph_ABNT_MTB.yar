...
rule TrojanDownloader_BAT_Seraph_ABNT_MTB{
	...
	strings :
		$a_03_0 = {11 04 06 09 06 09 8e 69 5d 91 08 06 91 61 d2 6f 90 01 03 0a 06 16 2d df 17 58 0a 16 2d b7 06 08 8e 69 32 dc 11 04 6f 90 01 03 0a 28 90 01 03 2b 13 06 1d 2c b7 90 00 } //4
