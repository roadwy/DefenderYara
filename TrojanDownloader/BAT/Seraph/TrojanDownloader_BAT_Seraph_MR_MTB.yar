...
rule TrojanDownloader_BAT_Seraph_MR_MTB{
	...
	strings :
		...
		$a_81_1 = {67 65 74 5f 4b 65 79 53 69 7a 65 } //01 00  get_KeySize
		$a_81_2 = {73 65 74 5f 49 56 } //01 00  set_IV
		$a_81_3 = {43 72 65 61 74 65 44 65 63 72 79 70 74 6f 72 } //01 00  CreateDecryptor
		$a_81_4 = {67 65 74 5f 55 54 46 38 } //01 00  get_UTF8
		$a_81_5 = {73 65 74 5f 42 6c 6f 63 6b 53 69 7a 65 } //00 00  set_BlockSize
	condition:
		any of ($a_*)
