...
rule TrojanDownloader_BAT_Seraph_D_MTB{
	...
	strings :
		...
		$a_81_1 = {53 70 6f 74 69 66 79 } //01 00  Spotify
		$a_81_2 = {41 6e 69 6d 61 6c 73 20 72 75 6e } //01 00  Animals run
		$a_81_3 = {48 75 6d 61 6e 73 20 72 75 6e } //00 00  Humans run
	condition:
		any of ($a_*)
