...
rule TrojanDownloader_BAT_Seraph_ABGH_MTB{
	...
	strings :
		$a_03_0 = {0a 06 73 16 90 01 02 0a 0b 00 73 90 01 03 0a 0c 00 07 16 73 90 01 03 0a 73 90 01 03 0a 0d 00 09 08 6f 90 01 03 0a 00 00 de 0b 09 2c 07 09 6f 90 01 03 0a 00 dc 08 6f 90 01 03 0a 13 04 de 16 08 2c 07 08 6f 90 01 03 0a 00 dc 90 00 } //2
