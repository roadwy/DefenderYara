...
rule TrojanDownloader_BAT_Seraph_ABFI_MTB{
	...
	strings :
		$a_03_0 = {16 2b 2e 2b 33 2b 38 16 2d 09 2b 09 2b 0a 6f 90 01 03 0a de 10 08 2b f4 07 2b f3 08 2c 06 08 6f 90 01 03 0a dc 07 6f 90 01 03 0a 0d de 2e 06 2b cf 90 00 } //2
