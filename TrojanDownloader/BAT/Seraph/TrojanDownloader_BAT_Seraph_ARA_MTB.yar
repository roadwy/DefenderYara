...
rule TrojanDownloader_BAT_Seraph_ARA_MTB{
	...
	strings :
		...
		$a_01_3 = {09 11 04 08 11 04 08 8e 69 5d 91 06 11 04 91 61 d2 9c 11 04 17 58 13 04 11 04 06 8e 69 32 e1 } //2
	condition:
...
rule TrojanDownloader_BAT_Seraph_ARA_MTB_2{
	...
	strings :
		$a_01_0 = {13 04 16 13 05 16 2d 15 2b 19 11 04 11 05 09 11 05 09 8e 69 5d 91 07 11 05 91 61 d2 9c 11 05 17 58 13 05 11 05 15 2c d3 16 2d f4 07 8e 69 32 da 11 04 13 06 de 65 28 } //2
