...
rule TrojanDownloader_BAT_Tedy_NE_MTB{
	...
	strings :
		...
		$a_01_1 = {45 00 54 00 48 00 20 00 43 00 4f 00 49 00 4e 00 74 00 2e 00 57 00 54 00 46 00 20 00 43 00 4f 00 49 00 4e 00 6c 00 49 00 4f 00 53 00 4e 00 54 00 } //02 00 
		$a_01_2 = {24 00 54 00 52 00 55 00 4d 00 50 00 } //00 00 
	condition:
		any of ($a_*)
