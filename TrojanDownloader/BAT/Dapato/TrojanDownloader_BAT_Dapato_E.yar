...
rule TrojanDownloader_BAT_Dapato_E{
	...
	strings :
		...
		$a_00_2 = {73 65 74 5f 55 73 65 53 68 65 6c 6c 45 78 65 63 75 74 65 } //01 00 
		$a_00_3 = {73 65 74 5f 4b 65 79 } //01 00 
		$a_00_4 = {64 6f 77 6e 65 78 65 63 75 74 65 } //01 00 
		$a_00_5 = {68 00 65 00 6b 00 52 00 66 00 6b 00 4a 00 4d 00 70 00 74 00 33 00 68 00 75 00 53 00 54 00 73 00 38 00 63 00 } //00 00 
	condition:
		any of ($a_*)
