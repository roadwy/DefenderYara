...
rule TrojanDownloader_BAT_Wagex_ABJI_MTB{
	meta:
		description = "TrojanDownloader:BAT/Wagex.ABJI!MTB,SIGNATURE_TYPE_PEHSTR_EXT,08 00 08 00 05 00 00 04 00 "
	...
	strings :
		...
		$a_01_3 = {53 79 6d 6d 65 74 72 69 63 41 6c 67 6f 72 69 74 68 6d } //01 00 
