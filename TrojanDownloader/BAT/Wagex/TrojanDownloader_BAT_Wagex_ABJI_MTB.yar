...
rule TrojanDownloader_BAT_Wagex_ABJI_MTB{
	...
	strings :
		$a_03_0 = {13 05 18 2c f6 18 2c 2b 07 08 6f 90 01 03 0a 17 73 90 01 03 0a 13 06 11 06 11 05 16 11 05 8e 69 6f 90 01 03 0a de 0c 11 06 2c 07 11 06 6f 90 01 03 0a dc 07 6f 90 01 03 0a 13 07 16 2d bd 90 00 } //4
