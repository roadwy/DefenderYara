...
rule TrojanDownloader_BAT_StormKitty_A_MTB{
	...
	strings :
		$a_03_0 = {00 00 0a 11 03 11 01 6f 90 01 01 00 00 0a 11 02 6f 90 01 01 00 00 0a 28 90 01 01 00 00 0a 74 90 01 01 00 00 01 28 05 00 00 06 38 90 00 } //2
		$a_03_1 = {00 00 70 1a 3a 58 00 00 00 26 38 00 00 00 00 72 90 01 01 00 00 70 13 02 38 90 00 } //2
