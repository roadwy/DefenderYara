...
rule TrojanDownloader_BAT_Lidared_A{
	...
	strings :
		...
		$a_01_1 = {2f 00 61 00 64 00 64 00 2e 00 70 00 68 00 70 00 3f 00 69 00 64 00 3d 00 7b 00 31 00 7d 00 26 00 6d 00 61 00 63 00 3d 00 7b 00 33 00 7d 00 } //01 00  /add.php?id={1}&mac={3}
		$a_01_2 = {2f 00 74 00 6f 00 6e 00 67 00 6a 00 69 00 2e 00 70 00 68 00 70 00 } //00 00  /tongji.php
		$a_00_3 = {5d } //04 00  ]
	condition:
		any of ($a_*)
