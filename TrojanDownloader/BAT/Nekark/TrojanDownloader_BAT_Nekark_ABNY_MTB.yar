...
rule TrojanDownloader_BAT_Nekark_ABNY_MTB{
	...
	strings :
		$a_03_0 = {70 2b 24 2b 29 2b 2e 2b 33 2b 34 16 2b 34 8e 69 17 2d 32 26 26 26 1d 2c 02 07 0c 16 2d dc de 55 28 ?? ?? ?? 0a 2b d5 28 ?? ?? ?? 06 2b d5 6f ?? ?? ?? 0a 2b d0 28 ?? ?? ?? 0a 2b cb 0b 2b ca 07 2b c9 07 2b c9 28 ?? ?? ?? 0a 2b ca } //5
