...
rule TrojanDownloader_BAT_Nekozillot_A_bit{
	...
	strings :
		$a_01_0 = {7a 00 69 00 6c 00 6c 00 6f 00 74 00 2e 00 6b 00 7a 00 2f 00 53 00 79 00 73 00 74 00 65 00 6d 00 } //01 00  zillot.kz/System
		$a_01_1 = {7a 00 69 00 6c 00 6c 00 6f 00 74 00 5f 00 6e 00 65 00 6b 00 6f 00 } //01 00  zillot_neko
