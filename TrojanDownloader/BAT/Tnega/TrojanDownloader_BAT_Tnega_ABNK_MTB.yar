...
rule TrojanDownloader_BAT_Tnega_ABNK_MTB{
	...
	strings :
		$a_03_0 = {0a 16 31 07 06 28 90 01 03 0a 2a 14 2a 90 0a 31 00 28 90 01 03 0a 28 90 01 03 06 6f 90 01 03 0a 72 90 01 03 70 7e 90 01 03 0a 6f 90 01 03 0a 0a 06 6f 90 00 } //3
