...
rule TrojanDownloader_BAT_Tnega_ABGR_MTB{
	...
	strings :
		...
		$a_01_2 = {4f 00 6c 00 70 00 6a 00 7a 00 66 00 66 00 77 00 6e 00 6f 00 66 00 6f 00 6e 00 74 00 74 00 73 00 6f 00 66 00 62 00 6f 00 } //00 00  Olpjzffwnofonttsofbo
	condition:
		any of ($a_*)
