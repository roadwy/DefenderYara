...
rule TrojanDownloader_BAT_Tnega_ABGR_MTB{
	...
	strings :
		$a_03_0 = {06 0c 16 0d 08 12 03 28 90 01 03 0a 06 02 07 28 90 01 03 06 6f 90 01 03 0a de 0a 09 2c 06 08 28 90 01 03 0a dc 90 00 } //1
		$a_03_1 = {02 03 18 6f 90 01 03 0a 1f 10 28 90 01 03 0a 2a 90 00 } //1
