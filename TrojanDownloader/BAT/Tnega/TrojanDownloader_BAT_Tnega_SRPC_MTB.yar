...
rule TrojanDownloader_BAT_Tnega_SRPC_MTB{
	...
	strings :
		$a_03_0 = {02 73 38 00 00 0a 28 90 01 03 0a 6f 90 01 03 0a 0a 06 6f 90 01 03 0a 0b 73 26 00 00 0a 0c 73 26 00 00 0a 0d 07 08 6f 90 01 03 0a 08 6f 90 01 03 0a 16 6a 31 33 08 6f 90 01 03 0a 13 04 08 6f 90 01 03 0a 09 11 04 16 11 04 8e 69 6f 90 01 03 0a 09 6f 90 01 03 0a 16 6a 31 0e 11 04 2c 0a 09 6f 90 01 03 0a 13 05 90 00 } //2
