...
rule TrojanDownloader_BAT_Ursu_AB_MTB{
	...
	strings :
		$a_03_0 = {08 07 11 04 28 90 01 01 00 00 0a 16 6f 90 01 01 00 00 0a 13 08 12 08 28 90 01 01 00 00 0a 6f 90 01 01 00 00 0a 00 11 04 11 06 12 04 28 90 01 01 00 00 0a 13 09 11 09 2d d1 08 6f 90 01 01 00 00 0a 28 90 01 01 00 00 0a 6f 90 01 01 00 00 0a 14 14 6f 90 01 01 00 00 0a 26 de 2b 90 00 } //5
