...
rule TrojanDownloader_BAT_Gendwnurl_QQ_MTB{
	...
	strings :
		$a_02_0 = {07 09 03 08 17 28 90 01 01 00 00 0a 28 90 01 01 00 00 0a 61 28 90 01 01 00 00 0a 28 90 01 01 00 00 0a 28 90 01 01 00 00 0a 0b 00 08 17 58 b5 0c 08 11 04 13 05 11 05 31 d1 90 00 } //10
