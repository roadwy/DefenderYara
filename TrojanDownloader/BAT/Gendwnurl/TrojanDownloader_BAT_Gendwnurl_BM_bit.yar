...
rule TrojanDownloader_BAT_Gendwnurl_BM_bit{
	...
	strings :
		...
		$a_03_1 = {68 00 74 00 74 00 70 00 3a 00 2f 00 2f 00 6d 00 6f 00 6e 00 65 00 63 00 6f 00 6d 00 2e 00 64 00 64 00 6e 00 73 00 2e 00 6e 00 65 00 74 00 90 02 10 2e 00 7a 00 69 00 70 00 90 00 } //1
