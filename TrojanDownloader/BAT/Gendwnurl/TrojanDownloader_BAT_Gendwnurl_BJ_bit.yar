...
rule TrojanDownloader_BAT_Gendwnurl_BJ_bit{
	...
	strings :
		$a_03_0 = {68 00 74 00 74 00 70 00 3a 00 2f 00 2f 00 34 00 37 00 2e 00 38 00 39 00 2e 00 31 00 38 00 37 00 2e 00 35 00 34 00 [0-20] 2e 00 72 00 61 00 72 00 20 00 43 00 3a 00 5c 00 54 00 45 00 4d 00 50 00 [0-10] 2e 00 65 00 78 00 65 00 } //1
