...
rule TrojanDownloader_BAT_Gendwnurl_BE_bit{
	meta:
		description = "TrojanDownloader:BAT/Gendwnurl.BE!bit,SIGNATURE_TYPE_PEHSTR_EXT,03 00 03 00 03 00 00 01 00 "
		
	strings :
		$a_01_0 = {6a 00 62 00 64 00 73 00 69 00 63 00 6f 00 69 00 6f 00 } //01 00  jbdsicoio
		$a_03_1 = {68 00 74 00 74 00 70 00 3a 00 2f 00 2f 00 69 00 6d 00 67 00 2d 00 73 00 61 00 76 00 65 00 2e 00 78 00 79 00 7a 00 90 02 20 2e 00 65 00 78 00 65 00 90 00 } //01 00 
