...
rule TrojanDownloader_BAT_Gendwnurl_B_bit{
	...
	strings :
		$a_03_0 = {06 08 03 07 17 28 90 01 01 00 00 0a 28 90 01 01 00 00 0a 61 28 90 01 01 00 00 0a 28 90 01 01 00 00 0a 28 90 01 01 00 00 0a 0a 00 07 17 58 b5 90 00 } //1
