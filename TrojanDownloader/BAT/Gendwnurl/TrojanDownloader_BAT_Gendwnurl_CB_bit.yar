...
rule TrojanDownloader_BAT_Gendwnurl_CB_bit{
	...
	strings :
		$a_03_0 = {43 00 3a 00 5c 00 5f 00 78 00 66 00 61 00 63 00 65 00 90 02 10 2e 00 65 00 78 00 65 00 90 00 } //1
		$a_03_1 = {68 00 74 00 74 00 70 00 3a 00 2f 00 2f 00 77 00 6d 00 64 00 39 00 65 00 2e 00 61 00 33 00 69 00 31 00 76 00 76 00 76 00 2e 00 66 00 65 00 74 00 65 00 62 00 6f 00 63 00 2e 00 63 00 6f 00 6d 00 2f 00 78 00 73 00 6f 00 90 02 10 2e 00 65 00 78 00 65 00 90 00 } //1
