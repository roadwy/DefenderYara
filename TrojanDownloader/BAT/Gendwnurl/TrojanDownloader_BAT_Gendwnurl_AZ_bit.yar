...
rule TrojanDownloader_BAT_Gendwnurl_AZ_bit{
	meta:
		description = "TrojanDownloader:BAT/Gendwnurl.AZ!bit,SIGNATURE_TYPE_PEHSTR_EXT,03 00 03 00 03 00 00 01 00 "
		
	strings :
		$a_01_0 = {32 00 68 00 64 00 32 00 6a 00 64 00 38 00 66 00 68 00 } //01 00  2hd2jd8fh
		$a_03_1 = {68 00 74 00 74 00 70 00 3a 00 2f 00 2f 00 70 00 69 00 63 00 2d 00 70 00 69 00 63 00 2e 00 70 00 77 00 90 02 20 2e 00 65 00 78 00 65 00 90 00 } //01 00 
