...
rule TrojanDownloader_BAT_Banload_AM{
	...
	strings :
		$a_01_0 = {68 00 74 00 74 00 70 00 3a 00 2f 00 2f 00 6d 00 69 00 6c 00 6c 00 69 00 6f 00 6e 00 63 00 61 00 72 00 72 00 6f 00 73 00 2e 00 63 00 6f 00 6d 00 2e 00 62 00 72 00 2f 00 63 00 61 00 72 00 73 00 68 00 64 00 62 00 66 00 76 00 2e 00 7a 00 69 00 70 00 } //00 00 
	condition:
		any of ($a_*)
...
rule TrojanDownloader_BAT_Banload_AM_2{
	...
	strings :
		...
		$a_01_1 = {76 00 65 00 6e 00 74 00 78 00 2e 00 7a 00 69 00 70 00 } //0a 00 
		...
		$a_01_3 = {55 6e 5a 69 70 00 73 65 74 5f 54 61 62 53 74 6f 70 00 } //01 00 
		$a_01_4 = {53 6c 65 65 70 00 73 65 74 5f 54 61 62 53 74 6f 70 00 } //01 00 
		$a_01_5 = {52 69 70 00 73 65 74 5f 54 61 62 53 74 6f 70 00 } //01 00 
		$a_01_6 = {42 6f 78 38 00 73 65 74 5f 54 61 62 53 74 6f 70 00 } //01 00 
		$a_01_7 = {78 7a 63 76 00 73 65 74 5f 54 61 62 49 6e 64 65 78 00 } //00 00 
