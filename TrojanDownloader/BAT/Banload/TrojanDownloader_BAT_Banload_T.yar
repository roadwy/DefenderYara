...
rule TrojanDownloader_BAT_Banload_T{
	...
	strings :
		$a_03_0 = {66 00 75 00 63 00 6b 00 65 00 72 00 90 01 04 23 00 90 00 } //1
		$a_03_1 = {66 75 63 6b 65 72 90 01 04 23 90 00 } //1
		...
		$a_03_4 = {72 01 00 00 70 0a 72 90 01 01 00 00 70 0b 72 90 01 01 00 00 70 0c 72 90 01 01 00 00 70 0d 1f 1a 28 01 00 00 0a 13 04 20 30 75 00 00 90 00 } //1
	condition:
...
rule TrojanDownloader_BAT_Banload_T_3{
	...
	strings :
		...
		$a_03_3 = {66 00 75 00 63 00 6b 00 65 00 72 00 90 01 04 23 00 90 00 } //2
		$a_03_4 = {66 75 63 6b 65 72 90 01 04 23 90 00 } //2
		$a_03_5 = {6d 00 6f 00 64 00 2e 00 7a 00 69 00 70 00 90 02 04 68 00 74 00 74 00 70 00 90 00 } //2
		$a_03_6 = {66 00 6c 00 61 00 73 00 68 00 70 00 90 02 10 44 00 6f 00 77 00 6e 00 6c 00 6f 00 61 00 64 00 90 00 } //2
		$a_03_7 = {0a 02 02 fe 06 90 01 01 00 00 06 73 90 01 01 00 00 0a 28 90 01 01 00 00 0a 90 02 01 02 1f 1a 28 90 01 01 00 00 0a 7d 01 00 00 04 02 72 01 00 00 70 7d 02 00 00 04 02 72 90 01 01 00 00 70 7d 03 00 00 04 02 72 90 01 01 00 00 70 7d 04 00 00 04 02 72 90 01 01 00 00 70 7d 05 00 00 04 02 90 00 } //2
	condition:
