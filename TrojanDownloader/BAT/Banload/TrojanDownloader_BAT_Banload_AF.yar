...
rule TrojanDownloader_BAT_Banload_AF{
	...
	strings :
		...
		$a_00_2 = {5b 00 5e 00 41 00 2d 00 5a 00 61 00 2d 00 7a 00 30 00 2d 00 39 00 5d 00 } //00 00  [^A-Za-z0-9]
	condition:
		any of ($a_*)
...
rule TrojanDownloader_BAT_Banload_AF_2{
	...
	strings :
		...
		$a_00_2 = {2e 00 65 00 78 00 65 00 3f 00 64 00 6c 00 3d 00 31 00 } //00 00  .exe?dl=1
	condition:
		any of ($a_*)
