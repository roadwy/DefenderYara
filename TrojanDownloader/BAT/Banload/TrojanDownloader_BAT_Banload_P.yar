...
rule TrojanDownloader_BAT_Banload_P{
	...
	strings :
		...
		$a_03_5 = {06 0d 09 02 7b 90 01 01 00 00 04 73 90 01 01 00 00 0a 0c 08 6f 90 01 01 00 00 0a 74 90 01 01 00 00 1b 90 00 } //3
		$a_03_6 = {06 13 05 11 05 02 7b 90 01 01 00 00 04 73 90 01 01 00 00 0a 13 04 11 04 6f 90 01 01 00 00 0a 74 90 01 01 00 00 1b 90 00 } //3
	condition:
...
rule TrojanDownloader_BAT_Banload_P_2{
	...
	strings :
		...
		$a_02_4 = {5c 62 61 69 78 61 90 05 06 08 72 6c 6f 61 64 30 2d 39 5c 90 00 } //1
		...
		$a_03_6 = {00 70 6f 2f 00 00 06 0d 09 02 7b 90 01 01 00 00 04 73 90 01 01 00 00 0a 0c 08 6f 90 01 01 00 00 0a 74 0c 00 00 1b 0a 02 7b 90 01 01 00 00 04 72 90 01 02 00 70 90 09 09 00 02 7b 90 01 01 00 00 04 72 90 00 } //2
	condition:
