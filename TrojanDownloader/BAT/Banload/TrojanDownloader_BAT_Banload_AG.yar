...
rule TrojanDownloader_BAT_Banload_AG{
	...
	strings :
		...
		$a_03_1 = {74 00 6f 00 70 00 69 00 63 00 73 00 2e 00 7a 00 69 00 70 00 90 01 04 64 00 66 00 67 00 78 00 2e 00 65 00 78 00 65 00 90 01 02 72 00 75 00 6e 00 61 00 73 00 90 00 } //1
	condition:
