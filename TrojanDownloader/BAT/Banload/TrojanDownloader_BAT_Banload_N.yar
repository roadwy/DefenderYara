...
rule TrojanDownloader_BAT_Banload_N{
	...
	strings :
		...
		$a_00_1 = {5c 42 61 6e 6b 73 5c 4c 6f 61 64 65 72 73 } //00 00 
		$a_00_2 = {78 1d } //01 00 
	condition:
		any of ($a_*)
...
rule TrojanDownloader_BAT_Banload_N_2{
	...
	strings :
		$a_00_0 = {5c 41 70 70 6c 69 63 61 74 69 6f 6e 20 44 61 74 61 5c 69 6d 61 64 77 6d 2e 65 78 65 } //02 00 
		...
		$a_00_3 = {45 00 78 00 65 00 6d 00 70 00 6c 00 6f 00 3a 00 20 00 22 00 55 00 70 00 64 00 61 00 74 00 65 00 20 00 74 00 65 00 72 00 6d 00 69 00 6e 00 61 00 64 00 6f 00 2e 00 20 00 4f 00 62 00 72 00 69 00 67 00 61 00 64 00 6f 00 2e 00 22 00 } //02 00 
		$a_00_4 = {45 00 78 00 65 00 6d 00 70 00 6c 00 6f 00 3a 00 20 00 22 00 4f 00 20 00 75 00 70 00 64 00 61 00 74 00 65 00 20 00 64 00 6f 00 20 00 66 00 6c 00 61 00 73 00 68 00 } //00 00 
