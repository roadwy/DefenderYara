...
rule TrojanDownloader_BAT_Banload_N{
	...
	strings :
		$a_03_0 = {5c 00 69 00 6d 00 61 00 64 00 77 00 6d 00 2e 00 65 00 78 00 65 00 90 02 0a 68 00 74 00 74 00 70 00 90 00 } //2
...
rule TrojanDownloader_BAT_Banload_N_2{
	...
	strings :
		...
		$a_02_1 = {5c 4c 6f 61 64 65 72 20 56 62 90 02 01 6e 65 74 5c 90 00 } //2
		$a_02_2 = {5c 00 69 00 6d 00 61 00 64 00 77 00 6d 00 2e 00 65 00 78 00 65 00 90 02 08 55 00 73 00 65 00 72 00 2d 00 41 00 67 00 65 00 6e 00 74 00 90 02 08 4d 00 6f 00 7a 00 69 00 6c 00 6c 00 61 00 90 02 10 68 00 74 00 74 00 70 00 3a 00 90 00 } //2
