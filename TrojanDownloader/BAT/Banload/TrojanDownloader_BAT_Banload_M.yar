...
rule TrojanDownloader_BAT_Banload_M{
	...
	strings :
		...
		$a_01_1 = {53 65 72 76 65 72 43 6f 6d 70 75 74 65 72 00 4e 65 74 77 6f 72 6b 00 67 65 74 5f 4e 65 74 77 6f 72 6b 00 50 69 6e 67 00 44 6f 77 6e 6c 6f 61 64 46 69 6c 65 } //01 00 
