...
rule TrojanDownloader_BAT_Banload_AR{
	...
	strings :
		...
		$a_03_2 = {44 69 73 70 6f 73 65 5f 5f 49 6e 73 74 61 6e 63 65 5f 5f [0-0a] 68 74 74 70 } //1
	condition:
...
rule TrojanDownloader_BAT_Banload_AR_2{
	...
	strings :
		...
		$a_03_2 = {2e 7a 69 70 ?? ?? ?? ?? ?? ?? 4d 79 2e 53 65 74 74 69 6e 67 73 } //1
		$a_03_3 = {44 69 73 70 6f 73 65 5f 5f 49 6e 73 74 61 6e 63 65 5f 5f [0-0a] 68 74 74 70 } //1
	condition:
...
rule TrojanDownloader_BAT_Banload_AR_3{
	...
	strings :
		$a_03_0 = {44 69 73 70 6f 73 65 5f 5f 49 6e 73 74 61 6e 63 65 5f 5f [0-0a] 68 74 74 70 } //1
		$a_03_1 = {2e 7a 69 70 [0-08] 4d 79 2e 53 65 74 74 69 6e 67 73 [0-08] 4d 79 2e 43 6f 6d 70 75 74 65 72 } //1
		$a_03_2 = {13 06 11 06 28 ?? ?? 00 06 6f ?? ?? 00 06 6f ?? ?? 00 0a 13 05 72 ?? ?? 00 70 28 ?? ?? 00 0a 13 07 02 6f ?? ?? 00 06 11 07 72 ?? ?? 00 70 28 ?? ?? 00 0a 6f ?? ?? 00 0a 00 11 07 72 ?? ?? 00 70 28 ?? ?? 00 06 6f } //10
	condition:
