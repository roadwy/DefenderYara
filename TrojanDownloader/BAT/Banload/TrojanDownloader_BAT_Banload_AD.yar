...
rule TrojanDownloader_BAT_Banload_AD{
	...
	strings :
		...
		$a_01_1 = {24 31 30 38 32 66 39 66 36 2d 32 36 36 31 2d 34 65 63 65 2d 62 32 65 64 2d 65 61 61 36 34 32 34 33 35 64 35 65 00 } //01 00 
		$a_01_2 = {75 00 69 00 78 00 70 00 71 00 6f 00 78 00 2e 00 7a 00 69 00 70 00 } //00 00 
		$a_00_3 = {5d 04 } //00 00 
	condition:
		any of ($a_*)
