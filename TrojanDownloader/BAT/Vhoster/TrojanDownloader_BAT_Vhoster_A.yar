...
rule TrojanDownloader_BAT_Vhoster_A{
	...
	strings :
		...
		$a_03_1 = {13 05 12 05 fe 16 90 01 04 6f 90 01 04 72 90 01 04 28 90 01 04 0c 73 90 01 04 72 90 01 04 28 90 01 04 08 28 90 01 04 73 90 01 04 0d 09 6f 90 00 } //1
