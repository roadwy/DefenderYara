...
rule TrojanDownloader_BAT_Async_GG_MTB{
	...
	strings :
		$a_02_0 = {68 74 74 70 73 3a 2f 2f 63 64 6e 2e 64 69 73 63 6f 72 64 61 70 70 2e 63 6f 6d 2f 61 74 74 61 63 68 6d 65 6e 74 73 2f [0-64] 2f 41 73 79 6e 63 43 6c 69 65 6e 74 2e 65 78 65 } //1
