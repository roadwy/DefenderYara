...
rule TrojanDownloader_BAT_Aentdwn_A_bit{
	...
	strings :
		$a_03_0 = {6d 00 72 00 61 00 6e 00 74 00 69 00 66 00 75 00 6e 00 2e 00 74 00 6b 00 2f 00 90 02 2f 77 00 69 00 6e 00 69 00 63 00 63 00 2e 00 66 00 69 00 6c 00 65 00 90 00 } //1
