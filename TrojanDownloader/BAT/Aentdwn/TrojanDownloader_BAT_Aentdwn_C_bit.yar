...
rule TrojanDownloader_BAT_Aentdwn_C_bit{
	...
	strings :
		$a_01_0 = {6c 00 6f 00 67 00 2e 00 6c 00 6f 00 67 00 } //01 00 
		...
		$a_01_2 = {44 00 6f 00 77 00 6e 00 6c 00 6f 00 61 00 64 00 4d 00 61 00 73 00 74 00 65 00 72 00 2e 00 65 00 78 00 65 00 } //00 00 
	condition:
		any of ($a_*)
