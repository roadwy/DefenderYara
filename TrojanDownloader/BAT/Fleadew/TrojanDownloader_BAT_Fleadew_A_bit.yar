...
rule TrojanDownloader_BAT_Fleadew_A_bit{
	...
	strings :
		$a_03_0 = {68 00 74 00 74 00 70 00 73 00 3a 00 2f 00 2f 00 66 00 2e 00 6c 00 65 00 77 00 64 00 2e 00 73 00 65 00 2f 00 90 02 40 2e 00 6a 00 70 00 67 00 90 00 } //10
