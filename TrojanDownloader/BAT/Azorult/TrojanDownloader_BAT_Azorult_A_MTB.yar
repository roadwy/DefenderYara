...
rule TrojanDownloader_BAT_Azorult_A_MTB{
	...
	strings :
		$a_03_0 = {ea 58 66 61 fe 90 01 02 00 61 d1 9d fe 90 01 02 00 20 90 01 03 db 65 20 90 01 03 24 59 59 25 fe 90 01 02 00 20 90 01 03 20 20 90 01 03 17 59 65 20 90 01 03 08 61 66 20 90 00 } //1
