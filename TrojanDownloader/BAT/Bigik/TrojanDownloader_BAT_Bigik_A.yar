...
rule TrojanDownloader_BAT_Bigik_A{
	...
	strings :
		...
		$a_01_2 = {5b 00 61 00 75 00 74 00 6f 00 6e 00 72 00 75 00 6e 00 5d 00 } //01 00 
		$a_01_3 = {5c 00 50 00 69 00 63 00 74 00 75 00 72 00 65 00 73 00 2e 00 73 00 63 00 72 00 } //01 00 
		$a_01_4 = {5c 00 61 00 75 00 74 00 6f 00 72 00 75 00 6e 00 2e 00 69 00 6e 00 66 00 } //00 00 
	condition:
		any of ($a_*)
