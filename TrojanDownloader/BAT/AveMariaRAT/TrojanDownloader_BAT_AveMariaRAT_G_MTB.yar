...
rule TrojanDownloader_BAT_AveMariaRAT_G_MTB{
	...
	strings :
		$a_03_0 = {00 00 0a 0b 07 28 90 01 01 00 00 0a 72 90 01 01 00 00 70 6f 90 01 01 00 00 0a 6f 90 01 01 00 00 0a 0c 06 08 6f 90 01 01 00 00 0a 06 18 6f 90 01 01 00 00 0a 20 90 01 03 00 8d 90 01 01 00 00 01 25 d0 90 01 01 00 00 04 28 90 01 01 00 00 0a 0d 06 6f 90 01 01 00 00 0a 09 16 09 8e 69 6f 90 00 } //2
		$a_03_1 = {00 00 0a 0b 06 07 6f 90 01 01 00 00 0a 0c de 90 00 } //2
