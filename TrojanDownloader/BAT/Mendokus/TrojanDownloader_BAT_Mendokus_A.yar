...
rule TrojanDownloader_BAT_Mendokus_A{
	...
	strings :
		...
		$a_03_1 = {fe 0e 02 00 fe 0d 02 00 4a 0b 38 ?? ?? ff ff 02 02 72 ?? 00 00 70 fe 0c 03 00 28 17 00 00 06 28 09 00 00 06 72 ?? 00 00 70 fe 0c 03 00 28 17 00 00 06 28 1a 00 00 0a 28 08 00 00 06 39 ?? ?? 00 00 20 ?? 00 00 00 fe 0e 02 00 fe 0d 02 00 4a 0b 38 ?? ?? ff ff 38 ?? ?? 00 00 20 ?? 00 00 00 fe 0e 02 00 } //1
	condition:
