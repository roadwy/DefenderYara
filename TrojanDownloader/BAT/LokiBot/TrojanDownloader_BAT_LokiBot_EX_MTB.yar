...
rule TrojanDownloader_BAT_LokiBot_EX_MTB{
	...
	strings :
		$a_01_0 = {33 00 38 00 46 00 34 00 57 00 50 00 39 00 45 00 34 00 48 00 48 00 38 00 35 00 38 00 46 00 41 00 53 00 43 00 4a 00 53 00 42 00 35 00 } //01 00 
		$a_01_1 = {52 00 6f 00 73 00 74 00 69 00 73 00 61 00 } //01 00 
