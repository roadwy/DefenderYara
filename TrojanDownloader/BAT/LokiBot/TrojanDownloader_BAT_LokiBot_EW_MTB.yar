...
rule TrojanDownloader_BAT_LokiBot_EW_MTB{
	...
	strings :
		$a_01_0 = {47 00 54 00 38 00 5a 00 5a 00 35 00 47 00 34 00 38 00 43 00 59 00 34 00 52 00 34 00 46 00 41 00 46 00 34 00 48 00 48 00 37 00 46 00 } //01 00  GT8ZZ5G48CY4R4FAF4HH7F
		$a_01_1 = {54 00 68 00 65 00 73 00 69 00 73 00 31 00 } //01 00  Thesis1
