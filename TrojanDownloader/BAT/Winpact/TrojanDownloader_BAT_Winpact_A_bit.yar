...
rule TrojanDownloader_BAT_Winpact_A_bit{
	...
	strings :
		$a_03_0 = {72 53 1c 00 70 ?? 04 28 5e 00 00 0a 0a 17 03 28 5f 00 00 0a b5 13 04 0d 2b 25 ?? 06 03 09 17 28 60 00 00 0a 28 5e 00 00 0a 61 28 61 00 00 0a 28 62 00 00 0a 28 63 00 00 0a ?? 09 17 58 b5 0d 09 11 04 31 d6 ?? 2a } //2
