...
rule TrojanDownloader_BAT_AgentTesla_BF_MTB{
	meta:
		description = "TrojanDownloader:BAT/AgentTesla.BF!MTB,SIGNATURE_TYPE_PEHSTR_EXT,07 00 07 00 03 00 00 05 00 "
		
	strings :
		$a_01_0 = {31 00 30 00 37 00 2e 00 31 00 37 00 32 00 2e 00 31 00 33 00 2e 00 31 00 35 00 34 00 } //01 00  107.172.13.154
...
rule TrojanDownloader_BAT_AgentTesla_BF_MTB_2{
	meta:
		description = "TrojanDownloader:BAT/AgentTesla.BF!MTB,SIGNATURE_TYPE_PEHSTR_EXT,06 00 06 00 06 00 00 01 00 "
		
	strings :
		$a_01_0 = {61 00 70 00 61 00 72 00 61 00 74 00 65 00 64 00 65 00 63 00 75 00 72 00 61 00 74 00 61 00 74 00 2e 00 72 00 6f 00 2f 00 4d 00 41 00 4e 00 4e 00 59 00 2f 00 6e 00 65 00 77 00 44 00 44 00 4c 00 4c 00 4c 00 4c 00 4c 00 2e 00 74 00 78 00 74 00 } //01 00  aparatedecuratat.ro/MANNY/newDDLLLLL.txt
		$a_01_1 = {55 00 45 00 38 00 77 00 4e 00 54 00 4d 00 79 00 4d 00 6a 00 41 00 79 00 4d 00 69 00 55 00 } //01 00  UE8wNTMyMjAyMiU
