...
rule TrojanDownloader_BAT_AgentTesla_ESM_MTB{
	...
	strings :
		$a_03_0 = {11 05 11 06 9a 13 07 00 d0 ?? ?? ?? 01 28 ?? ?? ?? 0a 14 11 07 28 ?? ?? ?? 0a 13 08 11 08 16 8d ?? ?? ?? 01 6f ?? ?? ?? 0a 13 09 00 11 06 17 58 } //1
		$a_03_1 = {06 07 02 07 91 6f ?? ?? ?? 0a 00 00 07 25 17 59 0b 16 fe 02 0c 08 } //1
