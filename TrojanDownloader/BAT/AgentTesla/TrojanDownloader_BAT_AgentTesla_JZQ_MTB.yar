...
rule TrojanDownloader_BAT_AgentTesla_JZQ_MTB{
	...
	strings :
		$a_81_0 = {30 30 30 77 65 62 68 6f 73 74 61 70 70 2e 63 6f 6d 2f 52 75 6e 50 45 2e 64 6c 6c } //01 00  000webhostapp.com/RunPE.dll
		$a_01_1 = {44 6f 77 6e 6c 6f 61 64 44 61 74 61 } //01 00  DownloadData
		$a_01_2 = {47 65 74 54 79 70 65 } //01 00  GetType
		$a_81_3 = {52 75 6e 50 45 2e 52 75 6e 50 45 } //01 00  RunPE.RunPE
