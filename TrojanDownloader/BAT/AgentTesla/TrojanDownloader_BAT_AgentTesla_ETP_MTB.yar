...
rule TrojanDownloader_BAT_AgentTesla_ETP_MTB{
	...
	strings :
		$a_03_0 = {07 09 02 09 91 6f 90 01 03 0a 2b 07 28 90 01 03 0a 2b ec 90 00 } //1
		$a_03_1 = {09 25 17 59 0d 16 fe 02 13 06 11 06 2d bd 28 90 01 03 0a 13 07 12 07 23 00 00 00 00 00 00 33 40 28 90 01 03 0a 0c 2b 02 90 00 } //1
