...
rule TrojanDownloader_BAT_AgentTesla_ETJ_MTB{
	...
	strings :
		$a_03_0 = {07 25 17 59 0b 16 fe 02 0c 2b 03 00 2b f2 08 2d 02 2b 09 2b e0 6f 90 01 03 0a 2b e1 06 6f 90 01 03 0a 28 90 01 03 2b 0d 2b 00 09 2a 90 00 } //10
		$a_03_1 = {06 07 02 07 91 90 01 05 00 00 07 25 17 59 0b 16 fe 02 0c 08 2d e7 90 00 } //10
