...
rule TrojanDownloader_BAT_AgentTesla_ABL_MTB{
	...
	strings :
		$a_03_0 = {06 0a 2b 07 28 90 01 03 06 2b eb 06 16 06 8e 69 28 90 01 03 0a 2b 07 90 0a 21 00 02 72 90 01 03 70 28 06 90 00 } //8
...
rule TrojanDownloader_BAT_AgentTesla_ABL_MTB_2{
	...
	strings :
		$a_03_0 = {08 06 6f 2a 90 01 02 0a 0d 07 09 6f 90 01 03 0a 07 18 6f 90 01 03 0a 02 13 04 07 6f 90 01 03 0a 11 04 16 11 04 8e 69 6f 90 01 03 0a 13 05 dd 90 01 03 00 08 39 90 01 03 00 08 6f 90 01 03 0a dc 90 00 } //5
		$a_03_1 = {07 09 16 11 04 6f 90 01 03 0a 08 09 16 09 8e 69 6f 90 01 03 0a 25 13 04 16 3d 90 01 03 ff 07 6f 90 01 03 0a 13 05 90 00 } //5
