...
rule TrojanDownloader_BAT_AgentTesla_LUU_MTB{
	meta:
		description = "TrojanDownloader:BAT/AgentTesla.LUU!MTB,SIGNATURE_TYPE_PEHSTR_EXT,05 00 05 00 05 00 00 01 00 "
		
	strings :
		$a_81_0 = {68 74 74 70 73 3a 2f 2f 62 75 79 73 72 69 6c 61 6e 6b 61 6e 2e 6c 6b 2f 6b 2f 43 6f 6e 73 6f 6c 65 41 70 70 } //01 00  https://buysrilankan.lk/k/ConsoleApp
