...
rule TrojanDownloader_BAT_AgentTesla_NPY_MTB{
	meta:
		description = "TrojanDownloader:BAT/AgentTesla.NPY!MTB,SIGNATURE_TYPE_PEHSTR_EXT,10 00 10 00 08 00 00 0a 00 "
		
	strings :
		$a_80_0 = {73 65 6c 69 66 2f 6d 6f 63 2e 30 31 2d 6e 69 6f 63 2d 6e 69 6f 63 2d 65 6c 69 66 2f 2f 3a 70 74 74 68 } //selif/moc.01-nioc-nioc-elif//:ptth  0a 00 
		$a_80_1 = {2f 74 65 67 2f 68 73 2e 72 65 66 73 6e 61 72 74 2f 2f 3a 73 70 74 74 68 } ///teg/hs.refsnart//:sptth  01 00 
