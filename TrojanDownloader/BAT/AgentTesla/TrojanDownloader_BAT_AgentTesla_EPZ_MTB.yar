...
rule TrojanDownloader_BAT_AgentTesla_EPZ_MTB{
	meta:
		description = "TrojanDownloader:BAT/AgentTesla.EPZ!MTB,SIGNATURE_TYPE_PEHSTR_EXT,03 00 03 00 03 00 00 01 00 "
	...
	strings :
		...
		$a_01_2 = {34 00 35 00 2e 00 31 00 33 00 37 00 2e 00 32 00 32 00 2e 00 31 00 36 00 33 00 } //00 00  45.137.22.163
	condition:
		any of ($a_*)
