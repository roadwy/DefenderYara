...
rule TrojanDownloader_BAT_AgentTesla_EQA_MTB{
	...
	strings :
		$a_01_0 = {34 00 35 00 2e 00 31 00 33 00 37 00 2e 00 32 00 32 00 2e 00 31 00 36 00 33 00 } //01 00  45.137.22.163
		...
		$a_01_5 = {48 74 74 70 57 65 62 52 65 73 70 6f 6e 73 65 } //00 00  HttpWebResponse
	condition:
		any of ($a_*)
