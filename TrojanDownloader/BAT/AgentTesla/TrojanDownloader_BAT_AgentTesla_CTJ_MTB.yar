...
rule TrojanDownloader_BAT_AgentTesla_CTJ_MTB{
	...
	strings :
		$a_03_0 = {68 00 74 00 74 00 70 00 73 00 3a 00 2f 00 2f 00 90 02 1f 2e 00 90 02 05 2f 00 6c 00 6f 00 61 00 64 00 65 00 72 00 2f 00 75 00 70 00 6c 00 6f 00 61 00 64 00 73 00 2f 00 77 00 69 00 74 00 68 00 6f 00 75 00 74 00 73 00 74 00 61 00 72 00 74 00 75 00 70 00 5f 00 90 02 20 2e 00 6a 00 70 00 67 00 90 00 } //10
		$a_03_1 = {68 74 74 70 73 3a 2f 2f 90 02 1f 2e 90 02 05 2f 6c 6f 61 64 65 72 2f 75 70 6c 6f 61 64 73 2f 77 69 74 68 6f 75 74 73 74 61 72 74 75 70 5f 90 02 20 2e 6a 70 67 90 00 } //10
