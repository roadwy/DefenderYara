...
rule TrojanDownloader_BAT_AgentTesla_ABBD_MTB{
	...
	strings :
		$a_03_0 = {0d 07 09 6f 90 01 03 0a 07 18 6f 90 01 03 0a 02 13 04 07 6f 90 01 03 0a 11 04 16 11 04 8e 69 6f 90 01 03 0a 13 05 dd 90 01 03 00 08 39 90 01 03 00 08 6f 90 01 03 0a dc 90 00 } //3
