...
rule TrojanDownloader_BAT_AgentTesla_EQO_MTB{
	...
	strings :
		$a_03_0 = {09 8e 69 8d 90 01 03 01 13 0a 11 09 11 0a 16 11 0a 8e 69 6f 90 01 03 0a 13 0b 11 08 6f 90 01 03 0a 11 09 6f 90 01 03 0a 28 90 01 03 0a 11 0a 16 90 00 } //1
