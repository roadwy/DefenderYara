...
rule TrojanDownloader_BAT_AgentTesla_EQO_MTB{
	...
	strings :
		...
		$a_01_1 = {55 00 24 00 24 00 76 00 58 00 2b 00 78 00 6c 00 79 00 } //01 00  U$$vX+xly
		$a_01_2 = {44 6f 77 6e 6c 6f 61 64 46 69 6c 65 41 73 79 6e 63 } //01 00  DownloadFileAsync
		...
		$a_01_5 = {63 69 70 68 65 72 54 65 78 74 } //01 00  cipherText
		$a_01_6 = {70 61 73 73 50 68 72 61 73 65 } //00 00  passPhrase
	condition:
		any of ($a_*)
