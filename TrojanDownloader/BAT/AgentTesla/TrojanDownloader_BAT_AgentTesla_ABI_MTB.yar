...
rule TrojanDownloader_BAT_AgentTesla_ABI_MTB_2{
	...
	strings :
		$a_03_0 = {13 06 11 06 28 26 ?? ?? 0a 13 07 28 27 ?? ?? 0a 11 07 6f 28 ?? ?? 0a 13 08 7e 29 ?? ?? 0a 26 08 28 26 ?? ?? 0a 13 09 28 27 ?? ?? 0a 11 09 6f 28 ?? ?? 0a 13 0a 07 28 26 ?? ?? 0a 13 0b 28 27 ?? ?? 0a 11 0b 6f 28 ?? ?? 0a 13 0c 73 24 ?? ?? 0a 11 0c 28 2a ?? ?? 0a 13 0d 06 11 0a 6f 2a ?? ?? 0a 13 0e 19 8d 01 ?? ?? 01 13 11 11 11 16 } //6
