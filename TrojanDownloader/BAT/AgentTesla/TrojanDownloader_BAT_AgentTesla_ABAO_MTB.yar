...
rule TrojanDownloader_BAT_AgentTesla_ABAO_MTB{
	...
	strings :
		...
		$a_01_2 = {57 69 6e 64 6f 77 73 46 6f 72 6d 73 41 70 70 39 36 2e 46 6f 72 6d 73 2e 46 6f 72 6d 31 2e 72 65 73 6f 75 72 63 65 73 } //01 00  WindowsFormsApp96.Forms.Form1.resources
