...
rule TrojanDownloader_BAT_AgentTesla_ABK_MTB{
	...
	strings :
		$a_03_0 = {1e 5b 6f 3b 90 01 02 0a 6f 90 01 03 0a 00 09 17 6f 90 01 03 0a 00 08 09 6f 90 01 03 0a 17 73 90 01 03 0a 13 06 00 11 06 02 16 02 8e 69 6f 90 01 03 0a 00 11 06 6f 90 01 03 0a 00 00 de 0d 11 06 2c 08 11 06 6f 90 01 03 0a 00 dc 08 6f 90 01 03 0a 0a 00 de 0b 90 00 } //4
