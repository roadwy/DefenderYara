...
rule TrojanDownloader_BAT_AgentTesla_ABK_MTB{
	...
	strings :
		...
		$a_01_2 = {73 00 61 00 66 00 73 00 61 00 73 00 2e 00 73 00 61 00 66 00 73 00 61 00 73 00 } //01 00  safsas.safsas
		$a_01_3 = {73 00 61 00 66 00 73 00 61 00 } //00 00  safsa
	condition:
		any of ($a_*)
