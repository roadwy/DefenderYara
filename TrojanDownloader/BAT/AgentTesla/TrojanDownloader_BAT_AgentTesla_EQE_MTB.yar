...
rule TrojanDownloader_BAT_AgentTesla_EQE_MTB{
	...
	strings :
		$a_03_0 = {06 03 07 91 6f 90 01 03 0a 00 00 07 25 17 59 0b 16 fe 02 0c 08 2d e8 90 00 } //1
		$a_03_1 = {11 04 11 08 16 11 09 6f 90 01 03 0a 00 00 11 06 11 08 16 11 07 6f 90 01 03 0a 25 13 09 16 fe 03 13 0a 11 0a 2d d9 90 00 } //1
