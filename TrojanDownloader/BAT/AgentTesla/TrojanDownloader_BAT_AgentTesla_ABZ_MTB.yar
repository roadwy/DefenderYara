...
rule TrojanDownloader_BAT_AgentTesla_ABZ_MTB{
	...
	strings :
		$a_03_0 = {06 1a 2d 15 2b 0d 06 16 06 8e 69 1c 2d 0e 26 26 26 2b 03 26 2b f0 06 2b 0a 0a 2b ea 28 90 01 03 0a 2b f3 2a 90 0a 2d 00 72 01 90 01 02 70 28 02 90 00 } //5
