...
rule TrojanDownloader_BAT_AgentTesla_ABFV_MTB{
	...
	strings :
		$a_03_0 = {2b 31 2b 61 2b 62 72 90 01 03 70 2b 65 2b 6d 38 90 01 03 00 72 90 01 03 70 6f 90 01 03 0a 8e 69 5d 91 06 08 91 61 d2 6f 90 01 03 0a 08 16 2d 04 17 58 0c 08 06 8e 90 00 } //2
