...
rule TrojanDownloader_BAT_AgentTesla_F_MTB{
	...
	strings :
		$a_03_0 = {2b 11 06 a2 25 1f 14 28 90 01 01 00 00 2b 1f 18 28 90 01 01 00 00 2b 8c 90 01 01 00 00 01 a2 13 90 09 16 00 a2 25 1f 90 01 01 28 90 01 01 00 00 2b 7e 90 01 01 00 00 0a a2 25 1f 10 28 90 00 } //2
