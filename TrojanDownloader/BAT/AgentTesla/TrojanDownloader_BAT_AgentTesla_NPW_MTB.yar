...
rule TrojanDownloader_BAT_AgentTesla_NPW_MTB{
	...
	strings :
		$a_01_0 = {62 75 73 5f 74 69 63 6b 65 74 2e 50 72 6f 70 65 72 74 69 65 73 2e 52 65 73 6f 75 72 63 65 73 2e 72 65 73 6f 75 72 63 65 73 } //01 00  bus_ticket.Properties.Resources.resources
		...
		$a_01_3 = {57 47 45 57 47 57 45 } //01 00  WGEWGWE
		...
		$a_81_7 = {47 46 46 51 46 57 51 46 57 51 46 57 51 } //00 00  GFFQFWQFWQFWQ
	condition:
		any of ($a_*)
