...
rule TrojanDownloader_BAT_AgentTesla_ABT_MTB{
	...
	strings :
		$a_03_0 = {06 0a 06 2a 90 0a 12 00 72 59 90 01 02 70 28 10 90 01 02 06 28 12 90 00 } //5
		$a_03_1 = {07 08 16 11 05 6f 90 01 03 0a 06 08 16 08 8e 69 6f 90 01 03 0a 25 13 05 16 fe 03 2d e3 07 6f 90 01 03 0a 13 06 de 0a 90 00 } //5
