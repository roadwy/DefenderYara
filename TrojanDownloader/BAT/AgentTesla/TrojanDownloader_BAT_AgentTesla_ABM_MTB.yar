...
rule TrojanDownloader_BAT_AgentTesla_ABM_MTB{
	...
	strings :
		$a_03_0 = {26 06 8e 69 1d 2d 09 26 2b 12 0a 2b eb 0b 2b f1 0c 2b f5 90 0a 2a 00 02 72 57 90 01 02 70 28 0b 90 01 02 06 1a 2d 13 26 73 34 90 01 02 0a 1b 2d 0d 90 00 } //2
...
rule TrojanDownloader_BAT_AgentTesla_ABM_MTB_2{
	...
	strings :
		$a_03_0 = {08 06 6f 18 90 01 02 0a 0d 07 09 6f 90 01 03 0a 07 18 6f 90 01 03 0a 02 13 04 07 6f 90 01 03 0a 11 04 16 11 04 8e 69 6f 90 01 03 0a 13 05 dd 90 01 03 00 08 39 90 01 03 00 08 6f 90 01 03 0a dc 90 00 } //5
...
rule TrojanDownloader_BAT_AgentTesla_ABM_MTB_3{
	...
	strings :
		$a_03_0 = {a2 09 17 7e 90 01 03 0a a2 09 18 06 72 90 01 03 70 6f 90 01 03 0a a2 09 13 04 08 90 00 } //3
		$a_01_1 = {44 6f 77 6e 6c 6f 61 64 44 61 74 61 } //1 DownloadData
