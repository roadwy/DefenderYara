...
rule TrojanDownloader_BAT_AgentTesla_ABM_MTB{
	...
	strings :
		...
		$a_01_1 = {73 65 74 5f 53 65 63 75 72 69 74 79 50 72 6f 74 6f 63 6f 6c } //01 00 
...
rule TrojanDownloader_BAT_AgentTesla_ABM_MTB_3{
	...
	strings :
		...
		$a_01_4 = {43 00 41 00 63 00 63 00 50 00 72 00 6f 00 70 00 53 00 65 00 72 00 76 00 69 00 63 00 65 00 73 00 43 00 6c 00 61 00 73 00 73 00 2e 00 49 00 41 00 63 00 63 00 50 00 72 00 6f 00 70 00 53 00 65 00 72 00 76 00 65 00 72 00 } //00 00 
	condition:
		any of ($a_*)
