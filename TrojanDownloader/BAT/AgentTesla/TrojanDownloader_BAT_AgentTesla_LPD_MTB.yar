...
rule TrojanDownloader_BAT_AgentTesla_LPD_MTB{
	...
	strings :
		$a_81_0 = {56 56 59 55 59 44 55 59 46 55 46 48 48 4a 46 4a } //01 00  VVYUYDUYFUFHHJFJ
		...
		$a_81_4 = {76 34 2e 30 2e 33 30 33 31 39 5c 74 68 65 64 65 76 69 6c 63 6f 64 65 72 2e 65 78 65 } //01 00  v4.0.30319\thedevilcoder.exe
