...
rule TrojanDownloader_BAT_AgentTesla_ETO_MTB{
	...
	strings :
		$a_03_0 = {06 13 04 16 13 05 11 04 12 05 28 90 01 03 0a 00 07 09 02 09 91 6f 90 01 03 0a 00 de 0d 11 05 2c 08 11 04 28 90 01 03 0a 00 dc 00 09 25 17 59 0d 16 90 00 } //10
