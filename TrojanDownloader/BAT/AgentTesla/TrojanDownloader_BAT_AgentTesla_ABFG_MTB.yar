...
rule TrojanDownloader_BAT_AgentTesla_ABFG_MTB{
	...
	strings :
		$a_03_0 = {2b 0d 2b 0f 18 2b 10 1f 10 2b 10 2b 12 de 35 2b 11 2b ef 2b 10 2b ed 2b 0f 2b ec 2b 12 2b ec 0a 2b eb 02 2b ec 03 2b ed 6f ?? ?? ?? 0a 2b ea 28 ?? ?? ?? 0a 2b e7 } //2
