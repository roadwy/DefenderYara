...
rule TrojanDownloader_BAT_AgentTesla_LSD_MTB{
	...
	strings :
		$a_01_0 = {24 63 32 37 61 32 61 65 33 2d 31 63 66 33 2d 34 37 33 62 2d 38 66 37 34 2d 37 64 38 34 66 64 65 63 65 64 31 37 } //01 00  $c27a2ae3-1cf3-473b-8f74-7d84fdeced17
		$a_01_1 = {53 75 73 70 65 6e 64 4c 61 79 6f 75 74 } //01 00  SuspendLayout
