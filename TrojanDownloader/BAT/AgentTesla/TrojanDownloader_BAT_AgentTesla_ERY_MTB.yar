...
rule TrojanDownloader_BAT_AgentTesla_ERY_MTB{
	...
	strings :
		$a_03_0 = {08 25 17 59 0c 16 2d 03 16 fe 02 16 2d 02 0d 09 2d dc 06 6f ?? ?? ?? 0a 0b 07 13 04 1c 2c e1 } //1
		$a_03_1 = {16 2d fc 20 00 0c 00 00 2b 07 00 1a 2c f2 00 de 0c 28 ?? ?? ?? 0a 2b f2 } //1
