...
rule TrojanDownloader_BAT_AgentTesla_ABOI_MTB{
	...
	strings :
		$a_03_0 = {04 8e 69 5d 91 02 07 91 61 d2 6f 90 01 03 0a 07 17 58 0b 07 02 8e 69 32 dc 06 6f 90 01 03 0a 25 2d 02 26 14 2a 90 0a 30 00 06 7e 90 01 03 04 07 7e 90 00 } //5
