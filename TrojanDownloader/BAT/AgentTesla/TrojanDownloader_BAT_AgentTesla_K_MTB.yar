...
rule TrojanDownloader_BAT_AgentTesla_K_MTB{
	...
	strings :
		$a_03_0 = {06 25 26 25 16 20 90 01 01 00 00 00 28 90 01 01 00 00 06 90 02 02 a2 25 17 7e 90 01 01 00 00 0a a2 25 18 11 06 a2 25 19 17 8c 90 01 01 00 00 01 a2 13 08 11 90 00 } //2
