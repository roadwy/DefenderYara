...
rule TrojanDownloader_BAT_AgentTesla_ABDQ_MTB{
	...
	strings :
		$a_03_0 = {26 06 08 6f 90 01 03 0a 06 18 6f 90 01 03 0a 28 90 01 03 06 0d 06 6f 90 01 03 0a 09 16 09 8e 69 6f 90 01 03 0a 13 04 de 11 0c 2b d5 07 6f 90 01 03 0a dc 90 00 } //3
