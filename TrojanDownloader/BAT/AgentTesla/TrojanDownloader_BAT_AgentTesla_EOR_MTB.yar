...
rule TrojanDownloader_BAT_AgentTesla_EOR_MTB{
	...
	strings :
		$a_03_0 = {09 11 04 16 20 00 04 00 00 6f ?? ?? ?? 0a 13 05 07 11 04 16 11 05 6f ?? ?? ?? 0a 00 00 11 05 16 fe 02 13 06 11 06 2d d7 } //1
		$a_03_1 = {07 06 08 91 6f ?? ?? ?? 0a 00 00 08 25 17 59 0c 16 fe 02 0d 09 2d e8 } //1
