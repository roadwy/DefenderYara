...
rule TrojanDownloader_BAT_AgentTesla_ABQ_MTB{
	...
	strings :
		$a_03_0 = {09 11 05 16 11 04 6f 90 01 03 0a 08 11 05 16 11 05 8e 69 6f 90 01 03 0a 25 13 04 16 30 e2 09 6f 90 01 03 0a 0a de 1e 90 00 } //5
		$a_03_1 = {0a 19 6f 17 90 01 02 0a 72 90 01 03 70 28 90 01 03 0a 28 90 01 03 06 d0 90 01 03 02 28 90 01 03 0a 6f 90 01 03 0a 17 8d 90 01 03 01 25 16 02 a2 6f 90 01 03 06 de 03 90 0a 3f 00 72 31 90 01 02 70 28 16 90 00 } //5
	condition:
