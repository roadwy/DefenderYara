...
rule TrojanDownloader_BAT_AgentTesla_ABAX_MTB{
	...
	strings :
		$a_03_0 = {06 11 04 2b 09 06 18 6f 90 01 03 0a 2b 07 6f 90 01 03 0a 2b f0 02 0c 2b 04 13 04 2b e3 06 6f 90 01 03 0a 08 16 08 8e 69 6f 90 01 03 0a 13 05 de 0e 90 00 } //1
