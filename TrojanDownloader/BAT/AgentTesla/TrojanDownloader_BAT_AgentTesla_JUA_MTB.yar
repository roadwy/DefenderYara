...
rule TrojanDownloader_BAT_AgentTesla_JUA_MTB{
	...
	strings :
		$a_81_0 = {54 65 73 74 2d 4e 65 74 43 6f 6e 6e 65 63 74 69 6f 6e 20 2d 54 72 61 63 65 52 6f 75 74 65 } //10 Test-NetConnection -TraceRoute
		...
		$a_81_6 = {62 69 6e 67 } //1 bing
		$a_81_7 = {49 6e 76 6f 6b 65 4d 65 6d 62 65 72 } //1 InvokeMember
		$a_81_8 = {44 65 62 75 67 20 4d 6f 64 65 21 } //1 Debug Mode!
	condition:
