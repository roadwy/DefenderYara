...
rule TrojanDownloader_BAT_AgentTesla_AS_MTB{
	...
	strings :
		$a_03_0 = {2c 21 69 16 2d 17 2b 60 2b 0e 00 2b 5e 2b 5f 08 91 6f 29 ?? ?? 0a 00 00 08 25 17 59 0c 16 25 2d fb fe 02 90 0a 36 00 72 71 ?? ?? 70 2b 5e 38 63 ?? ?? 00 38 64 ?? ?? 00 8e 1d } //2
		$a_03_1 = {13 04 2b 00 19 2c cf 11 04 2a 90 0a 12 00 06 6f 2a ?? ?? 0a 0b 07 } //2
