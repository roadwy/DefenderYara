...
rule TrojanDownloader_WinNT_OpenConnection_PP{
	...
	strings :
		...
		$a_01_1 = {6a 61 76 61 2f 69 6f 2f 42 79 74 65 41 72 72 61 79 49 6e 70 75 74 53 74 72 65 61 6d } //05 00  java/io/ByteArrayInputStream
		$a_01_2 = {6a 61 76 61 2f 6c 61 6e 67 2f 72 65 66 6c 65 63 74 2f 4d 65 74 68 6f 64 } //04 00  java/lang/reflect/Method
		$a_01_3 = {6a 61 76 61 2f 6c 61 6e 67 2f 53 74 72 69 6e 67 42 75 69 6c 64 65 72 } //04 00  java/lang/StringBuilder
