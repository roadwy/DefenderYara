...
rule TrojanDownloader_WinNT_Jban_A{
	...
	strings :
		...
		$a_03_1 = {57 10 08 b8 00 90 01 01 b6 00 90 01 01 12 90 01 01 b6 00 90 1b 01 12 90 01 01 b6 00 90 1b 01 12 90 01 01 b6 00 90 1b 01 b6 00 90 01 01 3a 90 00 } //1
