...
rule TrojanDownloader_WinNT_OpenStream_gen_A_2{
	...
	strings :
		...
		$a_03_3 = {11 04 00 bc 08 3a 90 01 01 19 90 01 01 19 90 01 01 03 19 90 01 01 be b6 00 90 01 01 59 36 90 01 01 02 9f 00 90 01 01 90 03 01 04 2d 19 90 01 01 19 90 01 01 03 15 90 01 01 b6 00 90 01 01 a7 ff 90 00 } //1
	condition:
