...
rule TrojanDownloader_O97M_Predator_AS_MTB{
	meta:
		description = "TrojanDownloader:O97M/Predator.AS!MTB,SIGNATURE_TYPE_MACROHSTR_EXT,07 00 07 00 07 00 00 "
	...
	strings :
		...
		$a_03_3 = {4f 6e 20 45 72 72 6f 72 20 5f 90 02 08 52 65 73 75 6d 65 20 4e 65 78 74 90 02 08 43 61 6c 6c 90 00 } //1
		$a_01_4 = {2e 43 72 65 61 74 65 45 6c 65 6d 65 6e 74 28 22 62 36 34 22 29 } //1 .CreateElement("b64")
		$a_01_5 = {2e 43 52 45 41 54 45 20 5f } //1 .CREATE _
		$a_03_6 = {4e 75 6c 6c 2c 20 4e 75 6c 6c 2c 20 90 02 10 29 90 00 } //1
	condition:
