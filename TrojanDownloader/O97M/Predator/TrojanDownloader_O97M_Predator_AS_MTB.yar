...
rule TrojanDownloader_O97M_Predator_AS_MTB{
	...
	strings :
		...
		$a_01_4 = {2e 43 72 65 61 74 65 45 6c 65 6d 65 6e 74 28 22 62 36 34 22 29 } //01 00  .CreateElement("b64")
		$a_01_5 = {2e 43 52 45 41 54 45 20 5f } //01 00  .CREATE _
		$a_03_6 = {4e 75 6c 6c 2c 20 4e 75 6c 6c 2c 20 90 02 10 29 90 00 } //00 00 
	condition:
		any of ($a_*)
