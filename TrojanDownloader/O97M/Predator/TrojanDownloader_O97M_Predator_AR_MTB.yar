...
rule TrojanDownloader_O97M_Predator_AR_MTB{
	...
	strings :
		...
		$a_01_4 = {2e 78 6c 73 22 } //01 00  .xls"
		$a_01_5 = {2e 43 72 65 61 74 65 45 6c 65 6d 65 6e 74 28 22 62 36 34 22 29 } //01 00  .CreateElement("b64")
		$a_01_6 = {2e 43 52 45 41 54 45 20 5f } //01 00  .CREATE _
