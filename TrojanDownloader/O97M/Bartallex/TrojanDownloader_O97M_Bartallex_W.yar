...
rule TrojanDownloader_O97M_Bartallex_W{
	...
	strings :
		...
		$a_01_1 = {53 70 6c 69 74 28 55 73 65 72 46 6f 72 6d 31 2e 4c 61 62 65 6c 31 2e 43 61 70 74 69 6f 6e 2c 20 22 2f 22 29 } //01 00  Split(UserForm1.Label1.Caption, "/")
