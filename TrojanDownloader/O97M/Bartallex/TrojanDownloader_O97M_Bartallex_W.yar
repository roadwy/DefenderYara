...
rule TrojanDownloader_O97M_Bartallex_W{
	...
	strings :
		$a_03_0 = {20 3d 20 41 72 72 61 79 28 90 10 05 00 2c 20 90 10 05 00 2c 20 90 10 05 00 90 00 } //1
		...
		$a_03_2 = {52 65 70 6c 61 63 65 28 90 12 10 00 28 90 10 02 00 29 2c 20 22 74 22 2c 20 22 65 22 29 90 00 } //1
		$a_03_3 = {2e 4f 70 65 6e 20 90 02 10 28 90 10 02 00 29 2c 20 90 02 14 5f 90 0f 01 00 2c 20 46 61 6c 73 65 90 00 } //1
	condition:
