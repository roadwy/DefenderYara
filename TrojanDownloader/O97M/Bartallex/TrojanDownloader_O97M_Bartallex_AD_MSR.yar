...
rule TrojanDownloader_O97M_Bartallex_AD_MSR{
	...
	strings :
		$a_01_0 = {68 74 74 70 73 3a 2f 2f 6d 61 72 65 6e 64 6f 67 65 72 2e 63 6f 6d } //01 00 
		...
		$a_01_2 = {43 53 74 72 28 45 6e 76 69 72 6f 6e 28 22 41 50 50 44 41 54 41 22 29 } //01 00 
