...
rule TrojanDownloader_O97M_Bartallex_F_2{
	...
	strings :
		$a_03_0 = {73 65 61 72 63 68 65 6e 67 69 6e 65 73 65 72 76 61 6e 74 2e 63 6f 6d 2f 61 66 66 69 6c 69 61 74 65 73 2f 66 6f 6e 74 73 2f 90 02 10 2e 74 78 74 90 00 } //10
		$a_03_1 = {73 63 6f 74 74 73 70 6f 74 73 6f 6e 2e 63 6f 6d 2f 77 70 2d 69 6e 63 6c 75 64 65 73 2f 63 65 72 74 69 66 69 63 61 74 65 73 2f 90 02 10 2e 74 78 74 90 00 } //10
