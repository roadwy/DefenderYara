...
rule TrojanDownloader_O97M_Bartallex{
	...
	strings :
		$a_03_0 = {2f 37 72 76 6d 6e 62 90 02 28 2f 61 66 2f 37 72 76 6d 6e 62 90 02 28 2f 61 66 2f 37 72 76 6d 6e 62 90 02 28 2f 37 72 76 6d 6e 62 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule TrojanDownloader_O97M_Bartallex_13{
	...
	strings :
		$a_03_0 = {50 75 62 6c 69 63 20 53 75 62 20 90 02 0f 28 29 90 0c 03 00 90 02 1f 20 3d 20 53 70 6c 69 74 28 22 90 10 04 00 7c 90 10 04 00 7c 90 10 04 00 7c 90 10 04 00 7c 90 10 04 00 7c 90 10 04 00 90 00 } //1
		$a_03_1 = {46 6f 72 20 90 02 0f 20 3d 20 4c 42 6f 75 6e 64 28 90 02 0f 29 20 54 6f 20 55 42 6f 75 6e 64 28 90 1b 01 29 90 02 1f 20 3d 20 90 02 1f 20 26 20 43 68 72 28 43 49 6e 74 28 90 1b 01 28 90 02 1f 29 29 20 2d 20 90 10 04 00 29 90 00 } //1
		$a_03_2 = {5f 31 2e 4f 70 65 6e 20 90 03 08 07 68 75 62 61 62 75 62 61 4b 72 69 70 6f 74 61 28 90 10 03 00 29 2c 20 90 02 1f 5f 31 2c 20 46 61 6c 73 65 90 00 } //1
		$a_03_3 = {41 73 20 42 6f 6f 6c 65 61 6e 90 02 20 5f 90 0f 01 00 20 3d 20 53 70 6c 69 74 28 22 90 10 04 00 2c 90 10 04 00 2c 90 10 04 00 2c 90 10 04 00 2c 90 10 04 00 2c 90 10 04 00 90 00 } //1
	condition:
