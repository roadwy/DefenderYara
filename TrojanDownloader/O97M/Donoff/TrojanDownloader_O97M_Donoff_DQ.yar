...
rule TrojanDownloader_O97M_Donoff_DQ{
	...
	strings :
		...
		$a_02_1 = {3d 20 22 22 20 54 68 65 6e 0d 0a 53 68 65 6c 6c 20 90 02 0f 2c 20 30 90 00 } //1
		$a_02_2 = {53 75 62 20 41 75 74 6f 4f 70 65 6e 28 29 0d 0a 90 02 0f 45 6e 64 20 53 75 62 90 00 } //1
	condition:
