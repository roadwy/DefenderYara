...
rule TrojanDownloader_O97M_Donoff_S{
	...
	strings :
		...
		$a_02_2 = {45 6e 76 69 72 6f 6e 28 52 65 70 6c 61 63 65 28 22 90 02 07 74 90 02 07 6d 90 02 07 70 90 00 } //1
		$a_00_3 = {2c 20 22 24 22 2c 20 22 22 29 29 } //1 , "$", ""))
		$a_02_4 = {52 65 70 6c 61 63 65 28 22 4f 90 02 07 70 90 02 07 65 90 02 07 6e 90 00 } //1
