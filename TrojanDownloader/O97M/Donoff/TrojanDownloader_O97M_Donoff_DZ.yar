...
rule TrojanDownloader_O97M_Donoff_DZ{
	...
	strings :
		$a_02_0 = {41 72 72 61 79 28 4a 6f 69 6e 28 41 72 72 61 79 28 90 1d 10 00 29 28 30 29 2c 20 22 22 29 29 28 30 29 90 0c 02 00 90 1d 10 00 2e 52 75 6e 20 90 1d 10 00 2c 20 76 62 48 69 64 65 90 00 } //20
