...
rule TrojanDownloader_O97M_Donoff_ATGS_MTB{
	...
	strings :
		...
		$a_03_2 = {6f 62 6a 2e 20 5f 90 0c 02 00 53 61 62 6f 74 61 67 65 20 5f 90 0c 02 00 28 54 68 65 6f 6e 61 73 2e 4d 69 6b 68 61 73 20 2b 20 54 68 65 6f 6e 61 73 2e 4e 6f 61 68 20 2b 20 54 68 65 6f 6e 61 73 2e 4e 6f 6e 6f 61 20 2b 20 54 68 65 6f 6e 61 73 2e 53 68 6f 6e 61 73 29 90 00 } //1
		$a_03_3 = {6f 62 6a 2e 20 5f 90 0c 02 00 53 65 74 4e 6f 6e 65 6e 65 90 00 } //1
		$a_03_4 = {6f 62 6a 2e 20 5f 90 0c 02 00 4d 6f 64 5f 41 75 74 6f 43 61 6c 6c 90 00 } //1
	condition:
