...
rule TrojanDownloader_O97M_Donoff_ER{
	...
	strings :
		$a_01_0 = {2b 20 41 72 72 61 79 28 22 63 6d 64 2e 65 78 65 20 2f 63 20 22 22 70 6f 77 65 72 73 68 65 22 29 28 30 29 } //01 00  + Array("cmd.exe /c ""powershe")(0)
		...
		$a_01_4 = {2c 20 22 63 6d 64 2e 65 78 65 20 2f 63 20 22 22 70 6f 77 65 72 73 68 65 6c 6c 20 20 24 } //01 00  , "cmd.exe /c ""powershell  $
