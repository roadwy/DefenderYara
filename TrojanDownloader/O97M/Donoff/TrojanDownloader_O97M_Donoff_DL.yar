...
rule TrojanDownloader_O97M_Donoff_DL{
	...
	strings :
		...
		$a_02_2 = {3d 20 22 43 3a 5c 5c 57 69 6e 64 6f 77 73 5c 5c 54 65 6d 70 5c 5c 90 02 20 2e 65 78 65 22 90 00 } //2
		...
		$a_02_5 = {43 61 6c 6c 20 53 68 65 6c 6c 28 90 02 10 29 90 00 } //2
	condition:
