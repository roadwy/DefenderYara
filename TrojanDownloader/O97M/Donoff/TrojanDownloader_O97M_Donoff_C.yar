...
rule TrojanDownloader_O97M_Donoff_C{
	...
	strings :
		...
		$a_03_2 = {3c 20 33 30 30 90 02 30 3d 20 22 68 74 74 70 3a 2f 2f 90 02 40 2e 65 78 65 22 90 00 } //1
	condition:
...
rule TrojanDownloader_O97M_Donoff_C_2{
	...
	strings :
		...
		$a_02_2 = {43 61 6c 6c 20 44 6f 77 6e 6c 6f 61 64 46 69 6c 65 28 90 02 10 22 68 74 74 90 02 05 70 90 02 05 3a 2f 2f 77 77 77 2e 69 6e 74 65 72 74 65 63 6e 90 02 30 2f 73 73 90 02 05 2e 90 02 05 65 90 02 05 78 90 02 05 65 22 2c 90 00 } //10
	condition:
