...
rule TrojanDownloader_O97M_Donoff_MTX_MTB{
	meta:
		description = "TrojanDownloader:O97M/Donoff.MTX!MTB,SIGNATURE_TYPE_MACROHSTR_EXT,0e 00 0e 00 07 00 00 "
	...
	strings :
		...
		$a_01_6 = {4c 79 42 6a 58 46 51 4b 63 44 62 41 43 47 74 20 3d 20 4c 79 42 6a 58 46 51 4b 63 44 62 41 43 47 74 20 2b 20 22 70 22 } //2 LyBjXFQKcDbACGt = LyBjXFQKcDbACGt + "p"
	condition:
