...
rule TrojanDownloader_O97M_Donoff_QB_2{
	...
	strings :
		...
		$a_03_1 = {47 65 74 46 69 6c 65 4f 6e 28 22 48 74 54 50 3a 2f 2f 61 66 67 63 6c 6f 75 64 37 2e 63 6f 6d 2f 75 70 6c 64 2f [0-10] 2e [0-05] 22 2c 20 45 6e 76 69 72 6f 6e 28 22 61 70 70 64 61 74 61 22 29 20 26 20 22 [0-10] 2e 73 63 72 22 29 } //2
		$a_03_2 = {43 61 6c 6c 20 53 76 69 65 72 28 45 6e 76 69 72 6f 6e 28 22 61 70 70 64 61 74 61 22 29 20 26 20 22 [0-10] 2e 73 63 72 22 2c 20 76 62 48 69 64 65 29 } //2
	condition:
