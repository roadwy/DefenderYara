...
rule TrojanDownloader_O97M_Donoff_DD{
	...
	strings :
		...
		$a_00_3 = {2e 52 75 6e 28 22 73 74 61 72 74 22 29 } //01 00  .Run("start")
		$a_00_4 = {2e 41 64 64 43 6f 64 65 20 } //01 00  .AddCode 
...
rule TrojanDownloader_O97M_Donoff_DD_2{
	...
	strings :
		...
		$a_00_3 = {2e 52 75 6e 20 22 73 74 61 72 74 22 } //01 00  .Run "start"
		$a_00_4 = {2e 41 64 64 43 6f 64 65 20 } //01 00  .AddCode 
		$a_02_5 = {29 20 58 6f 72 20 90 10 03 00 29 90 00 } //00 00 
