...
rule TrojanDownloader_O97M_Donoff_BF{
	...
	strings :
		$a_02_0 = {3d 20 57 69 6e 45 78 65 63 28 22 63 6d 64 22 20 26 20 90 02 0a 20 26 20 22 2f 43 22 20 26 20 90 02 0a 20 26 20 90 02 0a 2c 20 90 02 0a 29 90 00 } //1
		$a_02_1 = {2e 43 72 65 61 74 65 54 65 78 74 46 69 6c 65 28 90 02 03 20 2b 20 22 2e 65 78 65 22 2c 20 54 72 75 65 29 90 00 } //1
