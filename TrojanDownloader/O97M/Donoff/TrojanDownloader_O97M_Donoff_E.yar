...
rule TrojanDownloader_O97M_Donoff_E_2{
	...
	strings :
		...
		$a_03_2 = {45 6e 76 69 72 6f 6e 28 22 54 45 4d 50 22 29 20 26 20 22 5c 90 02 08 2e 65 78 65 90 00 } //1
		$a_03_3 = {52 75 6e 46 69 6c 65 28 45 6e 76 69 72 6f 6e 28 22 54 45 4d 50 22 29 20 26 20 22 90 02 08 2e 65 78 65 22 2c 20 76 62 48 69 64 65 29 90 00 } //1
...
rule TrojanDownloader_O97M_Donoff_E_3{
	...
	strings :
		$a_03_0 = {22 68 74 74 70 3a 2f 2f 90 02 30 2e 65 78 65 22 2c 20 45 6e 76 69 72 6f 6e 28 22 54 4d 50 22 29 20 26 20 22 5c 90 02 0a 2e 65 78 65 22 90 00 } //1
		$a_03_1 = {3d 20 55 52 4c 44 6f 77 6e 6c 6f 61 64 54 6f 46 69 6c 65 41 28 30 2c 20 90 02 08 2c 20 90 02 08 2c 20 30 2c 20 30 29 90 00 } //1
		$a_03_2 = {3d 20 53 68 65 6c 6c 28 90 02 08 2c 20 31 29 90 02 10 4d 73 67 42 6f 78 20 22 90 02 20 64 6f 63 75 6d 65 6e 74 6f 20 6e 6f 20 65 73 20 63 6f 6d 70 61 74 69 62 6c 65 20 63 6f 6e 20 65 73 74 65 20 65 71 75 69 70 6f 2e 22 90 00 } //1
