...
rule TrojanDownloader_O97M_Donoff_DB{
	...
	strings :
		...
		$a_01_2 = {53 68 65 6c 6c 20 28 22 63 6d 64 2e 65 78 65 20 2f 63 20 22 20 2b 20 } //01 00 
		$a_01_3 = {68 5e 74 5e 74 70 5e 73 3a 2f 2f } //01 00 
		$a_01_4 = {44 6f 5e 77 6e 6c 5e 6f 61 64 46 69 5e 6c 65 } //01 00 
		$a_01_5 = {2d 77 69 5e 6e 64 6f 5e 77 73 74 79 6c 65 20 68 5e 69 64 64 5e 65 6e } //00 00 
		$a_00_6 = {5d 04 } //00 00 
	condition:
		any of ($a_*)
