...
rule TrojanDownloader_O97M_Donoff_HTRB_MTB{
	...
	strings :
		$a_01_0 = {64 61 74 4c 69 62 52 65 66 20 3d 20 22 63 3a 5c 70 72 6f 67 72 61 6d 64 61 74 61 5c 62 6f 72 64 65 72 43 75 72 72 2e 68 74 61 } //01 00 
		$a_01_1 = {3d 20 53 68 65 6c 6c 28 22 63 6d 64 20 2f 63 20 22 20 26 20 64 61 74 4c 69 62 52 65 66 29 } //01 00 
