...
rule TrojanDownloader_O97M_Donoff_HTRB_MTB{
	...
	strings :
		...
		$a_03_2 = {4f 70 65 6e 20 64 61 74 4c 69 62 52 65 66 20 46 6f 72 20 4f 75 74 70 75 74 20 41 73 20 23 31 90 0c 02 00 50 72 69 6e 74 20 23 31 2c 90 00 } //1
		$a_03_3 = {3d 20 41 63 74 69 76 65 44 6f 63 75 6d 65 6e 74 2e 52 61 6e 67 65 2e 54 65 78 74 90 0c 02 00 45 6e 64 20 46 75 6e 63 74 69 6f 6e 90 00 } //1
	condition:
