...
rule TrojanDownloader_O97M_Donoff_DT_2{
	...
	strings :
		$a_02_0 = {73 20 3d 20 54 68 69 73 44 6f 63 75 6d 65 6e 74 2e 43 6f 64 65 4e 61 6d 65 90 0c 02 00 49 66 20 22 54 68 69 73 44 6f 63 75 6d 65 6e 74 22 20 3d 20 73 20 54 68 65 6e 20 6a 20 3d 20 6a 20 2d 20 31 90 0c 02 00 46 6f 72 20 69 20 3d 20 31 20 54 6f 20 33 32 90 0c 02 00 6a 20 3d 20 32 20 2a 20 6a 90 0c 02 00 4e 65 78 74 20 69 90 00 } //10
		...
		$a_02_2 = {46 75 6e 63 74 69 6f 6e 20 66 75 6e 63 32 28 29 90 0c 02 00 66 6f 72 6d 31 2e 43 6f 6d 6d 61 6e 64 42 75 74 74 6f 6e 31 2e 54 61 67 90 00 } //1
