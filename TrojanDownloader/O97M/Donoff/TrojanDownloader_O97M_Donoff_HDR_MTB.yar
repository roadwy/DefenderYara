...
rule TrojanDownloader_O97M_Donoff_HDR_MTB{
	...
	strings :
		$a_03_0 = {77 77 77 2e 79 65 73 66 6f 72 6d 2e 63 6f 6d 2f 61 63 74 69 76 65 2f 73 65 61 72 63 68 4d 65 73 73 65 6e 67 65 72 2f 75 70 64 61 74 65 32 2f 73 65 61 72 63 68 4d 65 73 73 65 6e 67 65 72 5f 75 70 67 72 61 64 65 5f 78 2e 65 78 65 90 0a 53 00 68 74 74 70 3a 2f 2f } //1
