...
rule TrojanDownloader_O97M_Donoff_PB{
	...
	strings :
		...
		$a_02_1 = {3d 20 22 63 6d 64 2e 65 78 65 20 2f 63 22 20 26 20 22 43 6d 44 20 [0-10] 22 20 26 20 22 20 63 6d 64 20 22 20 26 20 22 2f 63 22 20 26 } //1
		$a_00_2 = {25 54 45 4d 50 25 5c 70 2e 73 63 72 22 20 26 } //1 %TEMP%\p.scr" &
		$a_02_3 = {3d 20 53 68 65 6c 6c 28 [0-10] 2c 20 31 20 2f 20 32 2e 35 29 } //1
	condition:
