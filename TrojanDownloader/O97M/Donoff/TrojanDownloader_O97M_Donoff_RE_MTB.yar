...
rule TrojanDownloader_O97M_Donoff_RE_MTB{
	...
	strings :
		$a_03_0 = {31 37 38 2e 31 37 2e 31 37 31 2e 31 34 34 2f 90 0a 2f 00 68 74 74 70 3a 2f 2f 90 00 } //1
		$a_03_1 = {31 38 35 2e 31 31 37 2e 39 31 2e 31 39 39 2f 90 0a 2f 00 68 74 74 70 3a 2f 2f 90 00 } //1
		...
		$a_03_3 = {63 64 6e 2e 64 69 73 63 6f 72 64 61 70 70 2e 63 6f 6d 2f 61 74 74 61 63 68 6d 65 6e 74 73 2f 90 02 1f 2f 90 02 1f 2f 73 68 61 78 5f 73 65 72 76 65 72 2e 65 78 65 90 0a 5f 00 68 74 74 70 73 3a 2f 2f 90 00 } //1
		$a_03_4 = {32 30 39 2e 31 34 31 2e 36 31 2e 31 32 34 2f 90 0a 2f 00 68 74 74 70 3a 2f 2f 90 00 } //1
