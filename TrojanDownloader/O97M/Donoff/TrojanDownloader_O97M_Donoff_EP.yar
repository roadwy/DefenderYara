...
rule TrojanDownloader_O97M_Donoff_EP{
	...
	strings :
		$a_01_0 = {28 30 29 20 3d 20 22 77 73 63 72 69 22 } //01 00  (0) = "wscri"
		$a_01_1 = {28 31 29 20 3d 20 22 70 74 2e 73 22 } //01 00  (1) = "pt.s"
		$a_01_2 = {28 32 29 20 3d 20 22 68 65 6c 6c 22 } //01 00  (2) = "hell"
