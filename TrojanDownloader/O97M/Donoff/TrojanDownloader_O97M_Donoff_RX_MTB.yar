...
rule TrojanDownloader_O97M_Donoff_RX_MTB{
	...
	strings :
		...
		$a_03_1 = {53 65 74 20 57 73 68 53 68 65 6c 6c 20 3d 20 43 72 65 61 74 65 4f 62 6a 65 63 74 28 22 57 53 63 72 69 70 74 2e 53 68 65 6c 6c 22 29 0d 0a 57 73 68 53 68 65 6c 6c 2e 52 75 6e 20 28 90 02 05 29 90 00 } //1
	condition:
