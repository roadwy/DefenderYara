...
rule TrojanDownloader_O97M_Donoff_CK{
	...
	strings :
		$a_03_0 = {55 52 4c 20 3d 20 22 68 74 74 70 3a 2f 2f 90 02 50 2f 90 0f 03 00 90 10 03 00 2e 6a 61 72 22 90 02 0f 20 3d 20 53 70 6c 69 74 28 55 52 4c 2c 20 22 2e 22 29 90 00 } //1
		$a_03_1 = {2e 52 75 6e 20 22 90 02 2f 5c 63 72 73 73 2e 6a 61 72 22 2c 20 77 69 6e 64 6f 77 53 74 79 6c 65 90 00 } //1
	condition:
