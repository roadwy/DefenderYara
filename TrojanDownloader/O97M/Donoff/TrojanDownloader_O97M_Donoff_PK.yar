...
rule TrojanDownloader_O97M_Donoff_PK{
	...
	strings :
		...
		$a_02_1 = {20 20 50 75 74 20 23 90 02 10 2c 20 2c 20 41 63 74 69 76 65 44 6f 63 75 6d 65 6e 74 2e 43 6f 6e 74 65 6e 74 2e 54 65 78 74 90 00 } //1
		$a_02_2 = {43 61 6c 6c 42 79 4e 61 6d 65 28 43 72 65 61 74 65 4f 62 6a 65 63 74 28 90 02 10 20 26 20 22 2e 22 20 26 20 90 02 10 29 2c 20 90 02 30 2c 20 56 62 4d 65 74 68 6f 64 2c 90 00 } //1
