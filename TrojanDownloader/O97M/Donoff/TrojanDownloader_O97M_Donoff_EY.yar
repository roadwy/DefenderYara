...
rule TrojanDownloader_O97M_Donoff_EY_4{
	...
	strings :
		...
		$a_03_3 = {2e 6e 65 78 74 28 31 2c 20 36 35 35 33 36 29 3b 90 02 10 20 3d 20 24 65 6e 76 3a 74 65 6d 70 20 2b 20 27 27 20 2b 20 90 02 10 20 2b 20 27 2e 65 78 65 27 3b 66 6f 72 65 61 63 68 28 90 00 } //1
		$a_03_4 = {3d 20 22 63 6d 64 20 2f 63 20 62 69 74 73 61 22 20 2b 20 22 64 6d 69 6e 20 2f 74 72 61 6e 73 66 65 72 20 90 02 10 20 2f 70 72 69 6f 72 22 20 2b 20 22 69 74 79 20 68 69 67 68 20 68 74 74 70 3a 2f 2f 90 00 } //1
		$a_03_5 = {25 74 65 6d 22 20 2b 20 22 70 25 5c 90 02 10 2e 65 78 65 20 26 20 73 74 61 72 74 20 2f 57 41 49 54 20 25 74 65 22 20 2b 20 22 6d 70 25 5c 90 02 10 2e 65 78 65 90 00 } //1
	condition:
