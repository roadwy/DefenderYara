...
rule TrojanDownloader_O97M_Donoff_DJ{
	...
	strings :
		...
		$a_02_1 = {3d 20 53 70 6c 69 74 28 90 02 0f 2c 20 22 50 52 45 43 48 49 4c 22 29 90 00 } //1
		$a_02_2 = {2c 20 22 73 22 20 2b 20 90 02 0f 20 2b 20 22 69 6c 65 22 2c 90 00 } //1
	condition:
