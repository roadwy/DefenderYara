...
rule TrojanDownloader_O97M_Donoff_G_MSR_2{
	...
	strings :
		...
		$a_03_1 = {70 6f 70 33 72 2e 52 75 6e 20 73 6b 61 70 69 73 6b 61 20 26 20 90 02 09 2e 54 61 67 2c 20 30 2c 20 46 61 6c 73 65 90 00 } //1
		$a_03_2 = {46 69 6c 65 43 6f 70 79 20 90 02 09 2e 4c 61 62 65 6c 31 2e 54 61 67 2c 20 73 6b 61 70 69 73 6b 61 90 00 } //1
	condition:
