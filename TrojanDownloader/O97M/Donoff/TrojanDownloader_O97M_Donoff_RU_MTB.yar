...
rule TrojanDownloader_O97M_Donoff_RU_MTB_2{
	...
	strings :
		...
		$a_03_1 = {20 2b 20 22 41 70 41 48 77 41 53 51 42 46 41 46 67 41 22 0d 0a 90 02 1f 53 65 74 20 90 02 07 20 3d 20 43 72 65 61 74 65 4f 62 6a 65 63 74 28 22 57 53 63 72 69 70 74 2e 53 68 65 6c 6c 22 29 0d 0a 90 02 1f 90 1b 01 2e 52 75 6e 20 28 76 58 6f 79 45 58 4e 74 58 29 90 00 } //1
	condition:
