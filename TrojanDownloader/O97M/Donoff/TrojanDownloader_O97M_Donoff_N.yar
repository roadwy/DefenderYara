...
rule TrojanDownloader_O97M_Donoff_N{
	...
	strings :
		$a_03_0 = {27 61 73 64 77 [0-ff] 0a 53 65 74 20 [0-18] 3d 20 43 72 65 61 74 65 4f 62 6a 65 63 74 28 [41-5a] [41-5a] [41-5a] [41-5a] [41-5a] [41-5a] [41-5a] [41-5a] 90 05 10 03 41 2d 5a 29 } //1
