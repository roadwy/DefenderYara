...
rule TrojanDownloader_O97M_Donoff_N{
	...
	strings :
		...
		$a_01_1 = {3d 20 31 20 2d 20 28 41 74 6e 28 32 30 29 29 } //05 00  = 1 - (Atn(20))
		$a_01_2 = {2b 20 43 68 72 28 49 6e 74 28 31 32 31 20 2a 20 52 6e 64 29 20 2b 20 39 37 29 } //00 00  + Chr(Int(121 * Rnd) + 97)
	condition:
		any of ($a_*)
