...
rule TrojanDownloader_O97M_Donoff_CS_eml{
	...
	strings :
		$a_01_0 = {53 65 74 20 57 69 63 6d 64 20 3d 20 43 72 65 61 74 65 4f 62 6a 65 63 74 28 22 53 63 72 69 70 74 69 6e 67 2e 46 69 6c 65 53 79 73 74 65 6d 4f 62 6a 65 63 74 22 29 } //01 00  Set Wicmd = CreateObject("Scripting.FileSystemObject")
		$a_01_1 = {57 69 63 6d 64 2e 43 72 65 61 74 65 46 6f 6c 64 65 72 20 22 43 3a 5c 49 6d 67 43 6f 6e 74 65 6e 74 5c 22 } //01 00  Wicmd.CreateFolder "C:\ImgContent\"
