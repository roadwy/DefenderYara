...
rule TrojanDownloader_O97M_Donoff_ET_2{
	...
	strings :
		...
		$a_02_3 = {2e 52 65 70 6c 61 63 65 28 [0-0f] 2c 20 22 22 29 } //1
		...
		$a_00_6 = {68 74 74 70 3a 2f 2f 62 6b 61 69 6e 6c 69 6e 65 32 2f 66 69 6c 65 61 64 6d 69 6e } //-100 http://bkainline2/fileadmin
	condition:
		((#a_00_0  & 1)*1+(#a_00_1  & 1)*1+(#a_00_2  & 1)*1+(#a_02_3  & 1)*1+(#a_00_4  & 1)*1+(#a_00_5  & 1)*1+(#a_00_6  & 1)*-100) >=6
