...
rule TrojanDownloader_O97M_Donoff_gen_H{
	...
	strings :
		...
		$a_00_1 = {31 68 7b 68 22 29 2c 20 22 22 2c 20 76 62 4e 75 6c 6c 53 74 72 69 6e 67 2c 20 76 62 4e 6f 72 6d 61 6c 46 6f 63 75 73 } //01 00 
		$a_00_2 = {31 68 7b 68 22 29 2c 20 30 2c 20 30 0d 0a } //01 00 
		$a_00_3 = {20 30 2c 20 22 6f 70 65 6e 22 2c 20 45 6e 76 69 72 6f 6e 24 28 22 74 6d 70 22 29 20 26 } //02 00 
