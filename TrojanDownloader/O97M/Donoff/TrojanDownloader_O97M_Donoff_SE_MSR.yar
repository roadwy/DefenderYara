...
rule TrojanDownloader_O97M_Donoff_SE_MSR{
	...
	strings :
		...
		$a_03_1 = {2e 43 72 65 61 74 65 54 65 78 74 46 69 6c 65 28 22 63 3a 5c 31 5c 90 02 0a 2e 63 6d 64 22 2c 20 54 72 75 65 29 90 00 } //1
		$a_03_2 = {2e 57 72 69 74 65 4c 69 6e 65 20 28 22 90 02 64 22 29 90 00 } //1
		$a_03_3 = {2e 57 72 69 74 65 4c 69 6e 65 20 28 90 02 0f 2e 90 02 0a 2e 90 02 0a 29 90 00 } //1
		...
		$a_03_5 = {3d 20 43 72 65 61 74 65 50 72 6f 63 65 73 73 57 28 90 02 02 2c 20 53 74 72 50 74 72 28 22 63 3a 5c 31 5c 90 02 0a 2e 63 6d 64 22 29 90 00 } //1
		$a_03_6 = {49 66 20 4c 65 6e 28 90 02 05 28 44 65 6c 65 74 65 46 69 6c 65 29 29 20 3e 20 30 20 54 68 65 6e 90 00 } //1
