...
rule TrojanDownloader_O97M_Donoff_RA_MTB{
	...
	strings :
		$a_01_0 = {3d 20 22 74 70 73 3a 2f 2f 77 77 77 2e 64 69 61 6d 61 6e 74 65 73 76 69 61 67 65 6e 73 2e 63 6f 6d 2e 62 72 2f 72 65 69 32 2e } //01 00 
		$a_01_1 = {3d 20 22 68 74 61 22 22 20 68 74 22 } //00 00 
	condition:
		any of ($a_*)
...
rule TrojanDownloader_O97M_Donoff_RA_MTB_2{
	...
	strings :
		$a_01_0 = {61 72 72 61 79 6d 61 69 6e 28 69 29 2e 64 61 74 65 5f 62 6f 72 72 6f 77 65 64 20 3d 20 22 68 74 74 70 73 3a 2f 2f 77 77 77 2e } //01 00 
		$a_01_1 = {61 72 72 61 79 6d 61 69 6e 28 69 29 2e 64 61 74 65 5f 64 75 65 20 3d 20 22 62 69 74 6c 79 2e 63 6f 6d 2f 61 73 64 68 61 73 64 6f 6f 6b 64 6b 77 64 69 61 68 73 69 64 68 } //00 00 
	condition:
		any of ($a_*)
...
rule TrojanDownloader_O97M_Donoff_RA_MTB_3{
	...
	strings :
		...
		$a_01_1 = {53 65 74 20 6f 62 6a 73 68 65 6c 6c 20 3d 20 43 72 65 61 74 65 4f 62 6a 65 63 74 28 22 77 73 63 72 69 70 74 2e 73 68 65 6c 6c 22 29 } //00 00 
	condition:
		any of ($a_*)
...
rule TrojanDownloader_O97M_Donoff_RA_MTB_4{
	...
	strings :
		...
		$a_01_2 = {61 64 64 72 20 3d 20 56 69 72 74 75 61 6c 41 6c 6c 6f 63 28 30 2c 20 55 42 6f 75 6e 64 28 62 75 66 29 2c 20 26 48 33 30 30 30 2c 20 26 48 34 30 29 } //01 00 
		$a_01_3 = {72 65 73 20 3d 20 43 72 65 61 74 65 54 68 72 65 61 64 28 30 2c 20 30 2c 20 61 64 64 72 2c 20 30 2c 20 30 2c 20 30 29 } //01 00 
...
rule TrojanDownloader_O97M_Donoff_RA_MTB_5{
	...
	strings :
		...
		$a_01_4 = {2e 64 61 74 61 54 79 70 65 20 3d 20 22 62 69 6e 2e 62 61 73 65 36 34 22 } //01 00 
