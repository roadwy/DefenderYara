...
rule TrojanDownloader_O97M_Donoff_DP{
	...
	strings :
		...
		$a_02_2 = {54 68 65 6e 0d 0a 90 02 0f 20 3d 20 41 72 72 61 79 28 90 00 } //1
		$a_02_3 = {3d 20 41 72 72 61 79 28 4a 6f 69 6e 28 90 02 0f 2c 20 90 02 0f 29 29 28 30 29 90 00 } //1
		$a_02_4 = {53 75 62 20 41 75 74 6f 4f 70 65 6e 28 29 0d 0a 90 02 0f 45 6e 64 20 53 75 62 90 00 } //1
	condition:
