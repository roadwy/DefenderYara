...
rule TrojanDownloader_O97M_Donoff_AS{
	...
	strings :
		...
		$a_03_2 = {3d 20 22 68 74 74 70 3a 2f 2f 90 02 18 2f 90 02 30 2e 65 78 65 22 90 00 } //1
		$a_03_3 = {3d 20 45 6e 76 69 72 6f 6e 28 22 90 02 10 22 29 20 26 20 22 5c 90 02 10 2e 65 78 65 22 90 00 } //1
