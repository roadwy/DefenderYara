...
rule TrojanDownloader_O97M_Donoff_BE{
	...
	strings :
		$a_01_0 = {3d 20 53 70 6c 69 74 28 22 37 32 38 5f 38 31 32 5f 38 31 32 5f 37 38 34 5f 34 30 36 5f 33 32 39 5f 33 32 39 5f } //01 00 
		$a_01_1 = {2c 20 22 3a 3a 22 29 } //01 00 
		$a_01_2 = {3d 20 43 72 65 61 74 65 4f 62 6a 65 63 74 28 } //01 00 
		$a_01_3 = {22 5f 22 29 } //00 00 
	condition:
		any of ($a_*)
...
rule TrojanDownloader_O97M_Donoff_BE_2{
	...
	strings :
		...
		$a_01_4 = {53 65 6e 64 50 61 63 6b 65 74 20 22 22 2c 20 22 22 } //00 00 
		$a_00_5 = {5d 04 } //00 00 
	condition:
		any of ($a_*)
