...
rule TrojanDownloader_O97M_Donoff_AR_MTB{
	...
	strings :
		...
		$a_03_1 = {53 74 72 52 65 76 65 72 73 65 28 [0-03] 65 78 65 2e [0-14] 5c 61 74 61 44 6d 61 72 67 6f 72 50 5c 3a 43 } //1
	condition:
...
rule TrojanDownloader_O97M_Donoff_AR_MTB_2{
	...
	strings :
		$a_03_0 = {53 74 72 52 65 76 65 72 73 65 28 22 [0-05] 61 73 6a 6b 6c 61 64 38 37 33 32 31 61 73 6a 68 64 68 61 5c 70 6d 22 20 26 20 22 2e 22 20 26 20 22 6a 5c 5c 3a 73 22 20 26 20 22 70 74 74 68 22 [0-0f] 20 61 22 20 26 20 22 74 22 20 26 20 22 68 22 20 26 20 22 73 22 20 26 20 22 6d 22 20 26 } //1
		$a_03_1 = {53 68 65 6c 6c 28 22 [0-14] 2e 65 78 65 20 22 22 43 3a 5c } //1
	condition:
...
rule TrojanDownloader_O97M_Donoff_AR_MTB_3{
	...
	strings :
		$a_03_0 = {3d 20 22 77 22 0d 0a 45 6e 64 20 46 75 6e 63 74 69 6f 6e 0d 0a 46 75 6e 63 74 69 6f 6e 20 [0-0a] 28 29 0d 0a 90 1b 00 20 3d 20 22 69 22 0d 0a 45 6e 64 20 46 75 6e 63 74 69 6f 6e 0d 0a 46 75 6e 63 74 69 6f 6e 20 [0-0a] 28 29 0d 0a 90 1b 02 20 3d 20 22 6e 22 } //2
		$a_03_1 = {28 22 20 33 20 32 20 5f 20 22 29 20 26 20 [0-14] 28 22 20 50 20 72 20 6f 20 63 20 65 20 73 20 73 20 22 29 } //2
	condition:
...
rule TrojanDownloader_O97M_Donoff_AR_MTB_5{
	...
	strings :
		...
		$a_03_2 = {52 65 70 6c 61 63 65 28 22 7a 68 2e 73 65 74 61 64 70 75 2f 32 7a 68 2f 75 72 2e 41 42 56 6c 65 63 78 45 2f 2f 3a 70 74 74 68 22 2c [0-0f] 43 68 72 28 31 31 32 29 20 26 20 43 68 72 28 31 30 34 29 20 26 20 43 68 72 28 31 31 32 29 29 } //1
