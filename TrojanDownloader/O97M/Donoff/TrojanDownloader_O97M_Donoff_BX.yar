...
rule TrojanDownloader_O97M_Donoff_BX{
	...
	strings :
		$a_03_0 = {77 68 61 74 69 73 64 61 73 20 3d 20 6d 61 73 68 69 6e 61 28 77 68 61 74 69 73 64 61 73 2c 20 22 [0-08] 22 2c 20 22 4d 22 29 } //1
		$a_03_1 = {77 68 61 74 69 73 64 61 73 20 3d 20 6d 61 73 68 69 6e 61 28 22 [0-08] 69 63 72 6f [0-08] 6f 66 74 2e 58 [0-08] 4c 48 54 54 50 [0-08] 41 64 6f 64 62 } //1
