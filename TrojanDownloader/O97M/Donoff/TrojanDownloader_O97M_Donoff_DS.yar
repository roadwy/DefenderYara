...
rule TrojanDownloader_O97M_Donoff_DS{
	...
	strings :
		$a_02_0 = {61 74 74 72 69 62 75 74 65 20 76 62 5f 6e 61 6d 65 20 3d 20 22 6d 6f 64 65 22 0d 0a 73 75 62 20 90 05 10 06 61 2d 7a 30 2d 39 28 29 0d 0a 0d 0a 90 00 } //5
		$a_02_1 = {20 3d 20 22 22 20 74 68 65 6e 0d 0a 73 68 65 6c 6c 20 90 05 10 06 61 2d 7a 30 2d 39 2c 20 66 61 6c 73 65 0d 0a 65 6e 64 20 69 66 0d 0a 65 6e 64 20 73 75 62 0d 0a 73 75 62 20 61 75 74 6f 6f 70 65 6e 28 29 90 00 } //5
		$a_02_2 = {20 3d 20 22 22 20 74 68 65 6e 0d 0a 73 68 65 6c 6c 20 90 05 10 06 61 2d 7a 30 2d 39 2c 20 76 62 68 69 64 65 0d 0a 65 6e 64 20 69 66 0d 0a 65 6e 64 20 73 75 62 0d 0a 73 75 62 20 61 75 74 6f 6f 70 65 6e 28 29 90 00 } //5
		$a_02_3 = {20 3d 20 22 22 20 74 68 65 6e 0d 0a 73 68 65 6c 6c 20 90 05 10 06 61 2d 7a 30 2d 39 2c 20 30 0d 0a 65 6e 64 20 69 66 0d 0a 65 6e 64 20 73 75 62 0d 0a 73 75 62 20 61 75 74 6f 6f 70 65 6e 28 29 90 00 } //5
