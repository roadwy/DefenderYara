...
rule TrojanDownloader_O97M_Donoff_G{
	...
	strings :
		$a_03_0 = {3d 20 45 6e 76 69 72 6f 6e 28 90 02 15 29 20 26 20 22 2f 74 73 78 33 22 20 2b 20 90 00 } //1
...
rule TrojanDownloader_O97M_Donoff_G_5{
	...
	strings :
		$a_03_0 = {3d 20 43 61 6c 6c 42 79 4e 61 6d 65 28 90 02 20 2c 20 56 62 4d 65 74 68 6f 64 2c 20 22 25 74 65 6d 70 25 22 29 90 00 } //1
...
rule TrojanDownloader_O97M_Donoff_G_8{
	...
	strings :
		...
		$a_02_6 = {26 20 43 68 72 24 28 41 73 63 28 4d 69 64 24 28 90 02 0f 2c 20 49 2c 20 31 29 29 20 2b 20 41 73 63 28 4d 69 64 24 28 90 02 0f 2c 20 4a 2c 20 31 29 29 29 90 00 } //1
		$a_02_7 = {73 68 65 6c 6c 90 04 01 02 20 28 90 00 } //1
