...
rule TrojanDownloader_O97M_Donoff_EU{
	...
	strings :
		$a_00_0 = {2c 20 22 57 53 63 72 69 70 74 22 20 26 } //01 00 
...
rule TrojanDownloader_O97M_Donoff_EU_2{
	...
	strings :
		...
		$a_00_1 = {43 72 65 61 74 65 4f 62 6a 65 63 74 28 22 6d 53 58 6d 6c 32 2e 64 6f 4d 64 6f 43 55 4d 45 4e 74 } //01 00 
		$a_00_2 = {43 72 65 61 74 65 4f 62 6a 65 63 74 28 22 61 64 6f 64 42 2e 73 74 72 65 61 6d 22 29 } //00 00 
	condition:
		any of ($a_*)
