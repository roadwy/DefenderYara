...
rule TrojanDownloader_O97M_Donoff_EX{
	...
	strings :
		$a_00_0 = {3d 20 22 5e 78 65 5e 20 20 22 } //01 00  = "^xe^  "
		$a_00_1 = {2e 65 78 22 20 2b 20 22 65 } //01 00  .ex" + "e
		$a_00_2 = {28 24 75 6d 2e 54 6f 53 74 72 69 6e 67 28 29 2c 20 24 70 70 29 3b } //00 00  ($um.ToString(), $pp);
	condition:
		any of ($a_*)
...
rule TrojanDownloader_O97M_Donoff_EX_2{
	...
	strings :
		$a_00_0 = {3d 20 22 5e 2e 65 5e 22 20 2b 20 22 78 5e 65 22 20 2b 20 22 5e 20 20 22 20 26 } //01 00  = "^.e^" + "x^e" + "^  " &
		$a_00_1 = {24 6b 6f 73 3d 27 74 2e 77 65 27 3b 24 72 65 6d 3d 27 65 6e 74 29 2e 64 6f } //01 00  $kos='t.we';$rem='ent).do
		$a_00_2 = {2b 24 6e 69 6d 2b 27 68 74 74 70 73 3a 2f 2f } //00 00  +$nim+'https://
	condition:
		any of ($a_*)
...
rule TrojanDownloader_O97M_Donoff_EX_3{
	...
	strings :
		$a_00_0 = {22 70 6f 77 65 22 } //01 00  "powe"
		$a_00_1 = {22 74 2e 57 65 62 22 } //01 00  "t.Web"
		...
		$a_00_3 = {28 22 57 53 63 72 69 70 74 2e 53 68 65 6c 6c 22 29 2e 52 75 6e } //00 00  ("WScript.Shell").Run
		$a_00_4 = {8f 77 } //00 00 
	condition:
		any of ($a_*)
...
rule TrojanDownloader_O97M_Donoff_EX_4{
	...
	strings :
		...
		$a_01_1 = {29 2e 72 27 2b 27 65 50 6c 61 27 2b 27 63 65 28 28 5b 43 68 61 52 5d } //01 00  ).r'+'ePla'+'ce(([ChaR]
		$a_01_2 = {53 79 73 27 2b 27 74 27 2b 27 65 6d 2e 4e 65 74 } //01 00  Sys'+'t'+'em.Net
...
rule TrojanDownloader_O97M_Donoff_EX_5{
	...
	strings :
		$a_01_0 = {53 68 65 6c 6c 20 73 61 64 64 2c 20 6e } //01 00  Shell sadd, n
		$a_01_1 = {53 75 62 20 73 74 72 69 6e 67 73 5f 61 74 74 61 63 68 65 64 28 70 65 72 32 2c 20 42 79 52 65 66 20 61 72 67 31 29 } //01 00  Sub strings_attached(per2, ByRef arg1)
		$a_01_2 = {6e 20 3d 20 6d 20 2d } //01 00  n = m -
...
rule TrojanDownloader_O97M_Donoff_EX_6{
	...
	strings :
		$a_00_0 = {53 68 65 6c 6c 20 45 6e 76 69 72 6f 6e 28 53 74 72 43 6f 6e 76 28 44 65 63 6f 64 65 42 61 73 65 36 34 28 22 56 47 56 74 63 41 3d 3d 22 29 2c 20 76 62 55 6e 69 63 6f 64 65 29 29 20 26 } //01 00  Shell Environ(StrConv(DecodeBase64("VGVtcA=="), vbUnicode)) &
		$a_00_1 = {53 74 72 43 6f 6e 76 28 44 65 63 6f 64 65 42 61 73 65 36 34 28 22 58 44 59 75 63 47 6c 6d 22 29 2c 20 76 62 55 6e 69 63 6f 64 65 29 2c 20 76 62 48 69 64 65 } //00 00  StrConv(DecodeBase64("XDYucGlm"), vbUnicode), vbHide
	condition:
		any of ($a_*)
...
rule TrojanDownloader_O97M_Donoff_EX_8{
	...
	strings :
		...
		$a_00_2 = {76 46 69 6c 65 4e 61 6d 65 20 3d 20 76 46 69 6c 65 4e 61 6d 65 20 2b 20 76 41 64 64 20 26 20 22 2e 65 22 20 2b 20 22 78 22 20 26 20 22 65 22 } //01 00  vFileName = vFileName + vAdd & ".e" + "x" & "e"
...
rule TrojanDownloader_O97M_Donoff_EX_9{
	...
	strings :
		$a_00_0 = {3d 20 22 70 6f 77 65 22 20 2b 20 22 72 73 68 65 6c 6c 20 2d 57 69 6e 64 6f 77 53 74 79 6c 65 20 48 69 64 64 65 6e 20 24 } //01 00  = "powe" + "rshell -WindowStyle Hidden $
		$a_00_1 = {3d 20 6e 65 77 2d 6f 22 20 2b 20 22 62 6a 65 63 74 20 53 79 73 74 65 6d 2e 4e 65 74 2e 57 65 62 43 6c 69 65 6e 74 3b 24 } //01 00  = new-o" + "bject System.Net.WebClient;$
		$a_00_2 = {3d 20 6e 65 77 2d 6f 22 20 2b 20 22 62 6a 65 63 74 20 72 61 6e 64 6f 6d 3b 24 73 74 72 20 3d 20 27 } //01 00  = new-o" + "bject random;$str = '
		...
		$a_00_4 = {3d 20 24 65 6e 76 3a 74 65 6d 70 20 2b 20 27 27 20 2b 20 24 6e 61 6d 65 20 2b 20 27 2e 65 78 65 27 3b 66 6f 72 65 61 63 68 28 24 } //00 00  = $env:temp + '' + $name + '.exe';foreach($
	condition:
		any of ($a_*)
