...
rule TrojanDownloader_O97M_Donoff_PI{
	...
	strings :
		$a_02_0 = {78 48 74 74 70 2e 4f 70 65 6e 20 22 47 45 54 22 2c 20 22 68 74 74 70 90 02 02 3a 2f 2f 90 02 30 2f 90 02 20 2e 65 78 65 22 2c 20 46 61 6c 73 65 90 00 } //1
