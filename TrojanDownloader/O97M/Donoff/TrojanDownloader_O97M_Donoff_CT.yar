...
rule TrojanDownloader_O97M_Donoff_CT{
	...
	strings :
		...
		$a_02_3 = {45 78 70 61 6e 64 45 6e 90 02 20 76 69 72 6f 6e 6d 65 6e 74 53 90 02 20 25 54 45 4d 50 25 90 00 } //1
		$a_00_4 = {53 68 65 6c 6c 20 22 77 73 63 72 69 70 74 } //1 Shell "wscript
		$a_02_5 = {61 74 68 61 6e 6b 61 72 61 90 02 20 69 6b 61 62 61 64 64 69 2e 69 6e 90 02 20 6c 79 62 79 62 69 72 64 69 65 2e 90 00 } //1
		$a_02_6 = {63 68 2e 6e 61 76 69 74 90 02 20 65 6c 69 61 2e 63 6f 6d 20 63 61 72 73 67 90 02 20 61 6d 65 73 2e 6f 72 67 90 00 } //1
	condition:
