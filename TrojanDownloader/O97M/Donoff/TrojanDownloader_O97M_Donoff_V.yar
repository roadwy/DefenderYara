...
rule TrojanDownloader_O97M_Donoff_V{
	...
	strings :
		...
		$a_02_4 = {20 2b 20 22 2e 22 0d 0a 90 02 15 20 3d 20 90 05 10 06 61 2d 7a 30 2d 39 20 2b 20 22 65 22 0d 0a 90 02 15 20 3d 20 90 05 10 06 61 2d 7a 30 2d 39 20 2b 20 22 78 22 0d 0a 90 02 15 20 3d 20 90 05 10 06 61 2d 7a 30 2d 39 20 2b 20 22 65 22 90 00 } //1
	condition:
