...
rule TrojanDownloader_O97M_Donoff_DRV_MTB{
	...
	strings :
		...
		$a_03_1 = {67 69 74 68 75 62 2e 63 6f 6d 2f 6f 78 30 78 6f 2f 6f 78 30 78 6f 2e 67 69 74 68 75 62 2e 69 6f 2f 72 61 77 2f 6d 61 73 74 65 72 2f 61 72 74 69 66 61 63 74 2f 63 61 6c 63 2e 65 78 65 90 0a 4c 00 63 6d 64 20 26 20 22 68 74 74 70 73 3a 2f 2f 90 00 } //1
