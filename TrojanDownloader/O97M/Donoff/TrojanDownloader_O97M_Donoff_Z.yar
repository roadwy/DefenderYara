...
rule TrojanDownloader_O97M_Donoff_Z{
	...
	strings :
		...
		$a_03_1 = {26 20 43 68 72 24 28 56 61 6c 28 22 26 48 22 20 26 20 4d 69 64 24 28 90 05 20 06 61 2d 7a 30 2d 39 2c 20 90 05 20 06 61 2d 7a 30 2d 39 2c 20 32 29 29 29 90 00 } //1
