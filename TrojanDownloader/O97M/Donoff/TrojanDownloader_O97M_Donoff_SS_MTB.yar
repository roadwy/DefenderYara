...
rule TrojanDownloader_O97M_Donoff_SS_MTB_2{
	...
	strings :
		...
		$a_03_3 = {72 75 6e 63 61 6c 63 20 3d 20 53 68 65 6c 6c 28 22 90 02 20 26 20 53 74 72 52 65 76 65 72 73 65 28 76 6c 32 29 29 90 02 03 45 6e 64 20 53 75 62 90 00 } //1
...
rule TrojanDownloader_O97M_Donoff_SS_MTB_3{
	...
	strings :
		...
		$a_03_1 = {2e 73 61 76 65 74 6f 66 69 6c 65 20 22 43 3a 2f 2f 57 69 6e 64 6f 77 73 2f 54 65 6d 70 2f 4d 69 63 72 6f 73 6f 66 74 20 57 6f 72 6c 64 2e 65 78 65 22 2c 20 32 90 02 03 45 6e 64 20 57 69 74 68 90 00 } //1
...
rule TrojanDownloader_O97M_Donoff_SS_MTB_5{
	...
	strings :
		...
		$a_03_3 = {62 61 62 79 39 39 39 39 39 20 3d 20 22 2e 6d 70 22 20 2b 20 53 74 72 69 6e 67 28 31 2c 20 22 2f 22 29 20 2b 20 22 90 02 0f 22 20 26 20 53 74 72 69 6e 67 28 35 2c 90 00 } //1
	condition:
...
rule TrojanDownloader_O97M_Donoff_SS_MTB_8{
	...
	strings :
		...
		$a_03_1 = {23 49 66 20 56 42 41 37 20 54 68 65 6e 90 02 06 44 69 6d 20 59 67 6c 65 72 6a 20 41 73 20 4c 6f 6e 67 50 74 72 2c 20 50 6b 78 20 41 73 20 4c 6f 6e 67 50 74 72 90 00 } //1
...
rule TrojanDownloader_O97M_Donoff_SS_MTB_9{
	...
	strings :
		...
		$a_03_4 = {66 20 3d 20 78 73 61 64 77 71 64 77 71 64 28 90 02 15 29 90 00 } //1
...
rule TrojanDownloader_O97M_Donoff_SS_MTB_13{
	...
	strings :
		...
		$a_03_10 = {53 65 74 20 6f 4f 75 74 50 61 72 61 6d 73 20 3d 20 6f 50 72 6f 63 65 73 73 2e 45 78 65 63 4d 65 74 68 6f 64 5f 28 90 02 0f 28 22 34 33 37 32 36 35 36 31 37 34 36 35 22 29 2c 20 6f 49 6e 50 61 72 61 6d 73 90 00 } //1
	condition:
