...
rule TrojanDownloader_O97M_Donoff_YE_MTB{
	...
	strings :
		...
		$a_01_2 = {46 75 6e 63 74 69 6f 6e 20 63 61 6c 63 34 } //01 00 
		$a_00_3 = {63 72 65 61 74 65 6f 62 6a 65 63 74 28 22 77 73 63 72 69 70 74 2e 73 68 65 6c 6c 22 29 2e 65 78 65 63 6c 75 6c 6c 69 } //00 00 
	condition:
		any of ($a_*)
