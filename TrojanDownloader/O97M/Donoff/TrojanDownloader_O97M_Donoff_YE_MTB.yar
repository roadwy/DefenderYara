...
rule TrojanDownloader_O97M_Donoff_YE_MTB{
	...
	strings :
		$a_02_0 = {68 74 74 70 3a 2f 2f 25 32 30 25 32 30 40 6a 2e 6d 70 2f 61 78 61 73 [0-16] 73 6f 64 6b 61 6f 73 } //1
		$a_02_1 = {68 74 74 70 3a 2f 2f 25 32 30 25 32 30 40 6a 2e 6d 70 2f 61 73 [0-20] 6f 73 } //1
