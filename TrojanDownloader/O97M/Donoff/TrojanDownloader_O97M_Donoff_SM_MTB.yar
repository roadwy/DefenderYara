...
rule TrojanDownloader_O97M_Donoff_SM_MTB_3{
	...
	strings :
		...
		$a_03_3 = {5a 20 3d 20 22 90 02 aa 22 90 00 } //1
...
rule TrojanDownloader_O97M_Donoff_SM_MTB_12{
	...
	strings :
		...
		$a_03_4 = {48 6f 6f 74 69 79 61 5a 28 29 90 02 03 44 69 6d 20 79 61 7a 65 65 64 31 90 00 } //1
	condition:
...
rule TrojanDownloader_O97M_Donoff_SM_MTB_16{
	...
	strings :
		$a_03_0 = {42 61 53 74 72 20 3d 20 44 65 63 6f 64 65 36 34 28 90 02 15 28 29 29 90 02 03 45 6e 64 20 46 75 6e 63 74 69 6f 6e 90 00 } //1
		$a_03_1 = {53 68 65 6c 6c 28 22 72 65 67 73 76 72 33 32 20 2f 73 20 22 20 26 20 66 69 6c 65 50 61 74 68 29 90 02 03 45 6e 64 20 53 75 62 90 00 } //1
		...
		$a_03_4 = {5c 6e 6f 77 2e 64 6c 6c 22 90 0a 23 00 70 61 74 68 20 3d 20 22 43 3a 5c 50 72 6f 67 72 61 6d 44 61 74 61 90 00 } //1
	condition:
