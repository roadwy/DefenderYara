...
rule TrojanDownloader_O97M_Donoff_RBQ_MTB{
	...
	strings :
		$a_03_0 = {6e 61 62 68 61 7a 65 6e 61 2e 6f 72 67 2f 63 6f 6e 74 65 6e 74 2f 73 6c 69 64 65 73 2f 69 6d 61 67 65 2f 61 70 70 2f 50 52 4f 4c 45 41 4b 2e 65 78 65 90 0a 3a 00 68 74 74 70 73 3a 2f 2f 90 00 } //1
