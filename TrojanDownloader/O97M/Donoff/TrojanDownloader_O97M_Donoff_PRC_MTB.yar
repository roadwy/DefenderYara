...
rule TrojanDownloader_O97M_Donoff_PRC_MTB{
	...
	strings :
		...
		$a_03_2 = {52 75 6e 20 22 90 02 0a 2e 76 62 73 22 90 00 } //1
		$a_03_3 = {46 69 6c 65 43 6f 70 79 20 22 90 02 0a 2e 76 62 73 22 2c 20 45 6e 76 69 72 6f 6e 24 28 22 61 70 70 64 61 74 61 22 29 20 26 20 22 5c 4d 69 63 72 6f 73 6f 66 74 5c 57 69 6e 64 6f 77 73 5c 53 74 61 72 74 20 4d 65 6e 75 5c 50 72 6f 67 72 61 6d 73 5c 53 74 61 72 74 75 70 5c 22 90 00 } //1
	condition:
