...
rule TrojanDownloader_O97M_Donoff_I{
	...
	strings :
		...
		$a_02_1 = {2e 52 65 73 70 6f 6e 73 65 42 6f 64 79 0d 0a 20 90 02 0f 2e 53 61 76 65 54 6f 46 69 6c 65 20 28 22 43 3a 5c 57 69 6e 64 6f 77 73 5c 54 65 6d 70 5c 90 00 } //1
	condition:
