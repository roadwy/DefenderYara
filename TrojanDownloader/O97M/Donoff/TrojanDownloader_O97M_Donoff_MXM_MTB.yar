...
rule TrojanDownloader_O97M_Donoff_MXM_MTB{
	...
	strings :
		...
		$a_03_6 = {43 68 72 28 33 34 29 20 26 20 22 68 74 74 70 3a 2f 2f 73 63 61 6c 61 64 65 76 65 6c 6f 70 6d 65 6e 74 73 2e 73 63 61 6c 61 64 65 76 63 6f 2e 63 6f 6d 2f 90 02 11 2e 65 78 22 90 00 } //1
	condition:
