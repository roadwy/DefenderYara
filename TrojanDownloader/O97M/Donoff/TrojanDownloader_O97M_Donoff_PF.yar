...
rule TrojanDownloader_O97M_Donoff_PF{
	...
	strings :
		$a_00_0 = {3d 20 56 42 41 2e 45 6e 76 69 72 6f 6e 28 22 41 70 70 44 61 74 61 22 29 20 26 20 22 5c 4d 69 63 72 6f 73 6f 66 74 5c 45 78 63 65 6c 5c } //01 00 
		$a_00_1 = {3d 20 22 75 70 64 61 74 65 2e 74 78 74 } //01 00 
