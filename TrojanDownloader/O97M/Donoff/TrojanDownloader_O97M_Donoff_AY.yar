...
rule TrojanDownloader_O97M_Donoff_AY{
	...
	strings :
		...
		$a_02_1 = {26 20 43 68 72 24 28 41 73 63 28 4d 69 64 24 28 90 02 0f 2c 20 49 2c 20 31 29 29 20 2b 20 41 73 63 28 4d 69 64 24 28 90 02 0f 2c 20 4a 2c 20 31 29 29 29 90 00 } //1
