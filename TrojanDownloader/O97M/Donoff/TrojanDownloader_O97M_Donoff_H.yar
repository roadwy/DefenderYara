...
rule TrojanDownloader_O97M_Donoff_H_5{
	...
	strings :
		...
		$a_03_2 = {2e 54 65 78 74 42 6f 78 31 20 2b 20 90 05 0c 06 61 2d 7a 41 2d 5a 2e 54 65 78 74 42 6f 78 32 20 2b 20 90 1b 00 2e 54 65 78 74 42 6f 78 33 20 2b } //3
...
rule TrojanDownloader_O97M_Donoff_H_7{
	...
	strings :
		...
		$a_03_1 = {69 63 72 6f [0-03] 6f 66 74 2e 58 [0-03] 4c 48 54 54 50 [0-03] 41 64 6f 64 62 2e [0-1f] 2e 41 70 70 6c 69 63 61 74 69 6f 6e [0-03] 57 [0-03] 63 72 69 70 74 2e [0-20] 50 72 6f 63 } //1
...
rule TrojanDownloader_O97M_Donoff_H_8{
	...
	strings :
		...
		$a_03_3 = {2e 52 75 6e 20 [0-10] 20 26 20 22 73 74 61 72 74 20 22 22 22 22 20 22 22 22 20 26 } //1
	condition:
...
rule TrojanDownloader_O97M_Donoff_H_10{
	...
	strings :
		...
		$a_02_4 = {52 65 70 6c 61 63 65 28 [0-20] 2c 20 22 2a 22 2c 20 22 22 29 } //1
		$a_02_5 = {52 65 70 6c 61 63 65 28 [0-20] 2c 20 22 2c 22 2c 20 22 22 29 } //1
...
rule TrojanDownloader_O97M_Donoff_H_11{
	...
	strings :
		$a_02_0 = {22 68 74 74 22 20 26 20 53 74 72 52 65 76 65 72 73 65 28 22 7a 2e [0-10] 2f 6d 6f 63 2e [0-1f] 2f 2f 3a 70 22 29 20 26 20 22 69 70 22 } //2
		$a_02_1 = {22 25 41 50 50 22 20 26 20 53 74 72 52 65 76 65 72 73 65 28 22 65 2e [0-1f] 22 29 20 26 20 22 78 65 22 } //2
		...
		$a_02_4 = {4b 69 6c 6c ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? [0-2f] 2e 52 75 6e 20 90 1d 10 00 20 26 20 22 73 74 61 72 74 20 22 22 22 22 20 22 22 22 20 26 } //3
		$a_02_5 = {4b 69 6c 6c 20 90 1d 1f 00 20 26 20 90 1d 1f 00 28 90 10 02 00 29 [0-0f] 2e 52 75 6e 20 52 65 70 6c 61 63 65 28 90 1b 01 28 90 10 02 00 29 2c [0-1f] 2c 20 90 1b 00 29 } //3
	condition:
