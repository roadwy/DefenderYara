...
rule TrojanDownloader_O97M_Donoff_AE{
	...
	strings :
		$a_02_0 = {53 75 62 20 41 75 74 6f 4f 70 65 6e 28 29 [0-20] 55 52 4c 20 3d 20 22 68 74 74 70 3a 2f 2f } //1
		$a_02_1 = {3d 20 45 6e 76 69 72 6f 6e 28 22 54 65 6d 70 22 29 20 26 20 22 5c 22 20 26 20 22 90 05 20 06 61 2d 7a 30 2d 39 2e 73 63 72 22 } //1
