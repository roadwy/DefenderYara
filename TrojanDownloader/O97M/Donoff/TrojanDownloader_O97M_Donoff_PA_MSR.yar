...
rule TrojanDownloader_O97M_Donoff_PA_MSR{
	...
	strings :
		...
		$a_03_2 = {63 3a 5c 41 74 74 61 90 02 02 5c 6c 64 72 2e 65 78 65 27 90 00 } //2
		$a_03_3 = {68 74 74 70 90 02 01 3a 2f 2f 90 02 03 2e 90 02 03 2e 90 02 03 2e 90 02 03 2f 6c 64 72 2e 65 78 65 90 00 } //2
	condition:
