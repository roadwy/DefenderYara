...
rule TrojanDownloader_O97M_Donoff_PS{
	...
	strings :
		...
		$a_00_2 = {53 75 62 20 57 6f 72 6b 62 6f 6f 6b 5f 4f 70 65 6e 28 29 } //01 00  Sub Workbook_Open()
		$a_00_3 = {54 68 69 73 57 6f 72 6b 62 6f 6f 6b 2e 53 68 65 65 74 73 28 22 63 61 6c 63 73 68 65 65 74 22 29 2e 52 61 6e 67 65 28 } //00 00  ThisWorkbook.Sheets("calcsheet").Range(
	condition:
		any of ($a_*)
