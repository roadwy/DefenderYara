...
rule TrojanDownloader_O97M_Donoff_EO{
	...
	strings :
		...
		$a_02_1 = {61 72 72 61 79 28 2d 90 01 01 2c 20 22 63 6d 64 22 90 00 } //1
		$a_02_2 = {61 72 72 61 79 28 2d 90 01 01 2c 20 2d 90 01 01 2c 20 22 63 6d 64 22 90 00 } //1
		$a_02_3 = {61 72 72 61 79 28 2d 90 01 01 2c 20 2d 90 01 01 2c 20 2d 90 01 01 2c 20 22 63 6d 64 22 90 00 } //1
		$a_02_4 = {61 72 72 61 79 28 2d 90 01 01 2c 20 2d 90 01 01 2c 20 2d 90 01 01 2c 20 2d 90 01 01 2c 20 22 63 6d 64 22 90 00 } //1
		$a_00_5 = {4e 61 4e 2c 20 22 63 6d 64 22 } //1 NaN, "cmd"
		$a_00_6 = {61 72 72 61 79 28 22 2e 65 78 22 } //1 array(".ex"
		$a_02_7 = {61 72 72 61 79 28 2d 90 01 01 2c 20 22 2e 65 78 22 90 00 } //1
		$a_02_8 = {61 72 72 61 79 28 2d 90 01 01 2c 20 2d 90 01 01 2c 20 22 2e 65 78 22 90 00 } //1
		$a_02_9 = {61 72 72 61 79 28 2d 90 01 01 2c 20 2d 90 01 01 2c 20 2d 90 01 01 2c 20 22 2e 65 78 22 90 00 } //1
		$a_02_10 = {61 72 72 61 79 28 2d 90 01 01 2c 20 2d 90 01 01 2c 20 2d 90 01 01 2c 20 2d 90 01 01 2c 20 22 2e 65 78 22 90 00 } //1
		$a_00_11 = {4e 61 4e 2c 20 22 2e 65 78 22 } //1 NaN, ".ex"
		$a_03_12 = {49 66 20 41 63 74 69 76 65 44 6f 63 75 6d 65 6e 74 2e 53 63 72 69 70 74 73 2e 43 6f 75 6e 74 20 3d 20 30 20 54 68 65 6e 0d 0a 90 01 04 90 02 0a 20 3d 20 90 01 03 90 02 05 20 26 20 90 01 03 90 02 05 20 26 20 90 01 03 90 02 05 20 26 90 00 } //1
