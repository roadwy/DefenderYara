...
rule TrojanDownloader_O97M_FTCdedoc_E_MTB{
	...
	strings :
		...
		$a_03_1 = {3d 20 22 2e 90 02 20 22 90 00 } //1
		$a_03_2 = {26 20 28 52 65 70 6c 61 63 65 28 90 02 10 2c 20 22 90 02 10 22 2c 20 22 22 29 29 90 00 } //1
		$a_03_3 = {28 52 65 70 6c 61 63 65 28 90 02 10 2c 20 22 90 02 10 22 2c 20 22 22 29 2c 20 90 02 08 29 90 00 } //1
		$a_03_4 = {28 22 22 2c 20 43 68 72 28 90 02 07 29 29 90 00 } //1
