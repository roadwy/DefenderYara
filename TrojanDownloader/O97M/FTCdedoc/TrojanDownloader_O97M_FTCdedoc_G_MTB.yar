...
rule TrojanDownloader_O97M_FTCdedoc_G_MTB{
	...
	strings :
		...
		$a_01_2 = {3d 20 22 31 4e 6f 72 6d 61 6c 2e 54 68 69 73 44 6f 63 75 6d 65 6e 74 22 } //01 00  = "1Normal.ThisDocument"
		$a_01_3 = {50 72 69 76 61 74 65 20 53 75 62 20 44 6f 63 75 6d 65 6e 74 5f 4f 70 65 6e 28 29 } //00 00  Private Sub Document_Open()
	condition:
		any of ($a_*)
