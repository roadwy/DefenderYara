...
rule TrojanDownloader_O97M_FTCdedoc_G_MTB{
	...
	strings :
		$a_03_0 = {43 72 65 61 74 65 4f 62 6a 65 63 74 28 22 77 73 63 72 69 70 74 2e 73 68 65 6c 6c 22 29 2e 52 75 6e 20 90 02 05 2c 90 00 } //1
		$a_03_1 = {2b 20 43 68 72 28 90 02 05 29 90 00 } //1
