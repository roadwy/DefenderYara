...
rule TrojanDownloader_O97M_FTCdedoc_C_MTB{
	...
	strings :
		$a_03_0 = {43 72 65 61 74 65 4f 62 6a 65 63 74 28 22 57 53 22 20 26 20 90 02 15 29 2e 52 75 6e 20 90 02 15 2c 90 00 } //1
		$a_03_1 = {26 20 22 2e 22 20 26 20 28 52 65 70 6c 61 63 65 28 90 02 15 2c 20 22 90 02 08 22 2c 20 22 22 29 29 90 00 } //1
		$a_01_2 = {3d 20 22 22 } //1 = ""
		$a_03_3 = {28 22 22 2c 20 43 68 72 28 90 02 15 29 29 90 00 } //1
