...
rule TrojanDownloader_O97M_Gootkit_D_MSR{
	...
	strings :
		...
		$a_02_1 = {53 75 62 20 41 75 74 6f 4f 70 65 6e 28 29 90 02 10 20 90 0f 03 00 90 02 10 20 90 0f 03 00 90 02 10 20 90 0f 03 00 90 02 10 20 90 0f 03 00 90 02 10 20 90 0f 03 00 90 02 10 20 90 0f 03 00 90 02 10 20 90 0f 03 00 90 00 } //20
	condition:
