...
rule TrojanDownloader_O97M_Togkino_gen_A{
	...
	strings :
		...
		$a_03_3 = {22 2c 20 45 6e 76 69 72 6f 6e 28 22 90 03 07 04 41 50 50 44 41 54 41 54 45 4d 50 22 29 20 26 20 22 5c 90 00 } //1
		$a_03_4 = {53 68 65 6c 6c 20 45 6e 76 69 72 6f 6e 28 22 90 03 07 04 41 50 50 44 41 54 41 54 45 4d 50 22 29 20 26 20 22 5c 90 00 } //1
