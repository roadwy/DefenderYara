...
rule TrojanDownloader_O97M_Togkino_A{
	...
	strings :
		...
		$a_03_1 = {55 52 4c 44 6f 77 6e 6c 6f 61 64 54 6f 46 69 6c 65 20 30 2c 20 22 68 74 74 70 3a 2f 2f 90 02 15 2e 65 78 65 22 2c 20 45 6e 76 69 72 6f 6e 28 22 54 45 4d 50 22 29 20 26 20 22 90 02 09 2e 65 78 65 22 2c 20 30 2c 20 30 90 00 } //1
