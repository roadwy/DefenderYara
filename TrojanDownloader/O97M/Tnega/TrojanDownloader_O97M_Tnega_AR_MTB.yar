...
rule TrojanDownloader_O97M_Tnega_AR_MTB{
	...
	strings :
		...
		$a_03_2 = {2f 2f 73 6d 61 72 74 73 63 72 65 65 6e 74 65 73 74 72 61 74 69 6e 67 73 32 2e 6e 65 74 2f [0-1f] 2e 65 78 65 90 0a 4f 00 68 74 74 70 73 3a } //5
		...
		$a_03_4 = {2e 65 78 65 22 90 0a 4f 00 68 74 74 70 73 3a } //1
	condition:
