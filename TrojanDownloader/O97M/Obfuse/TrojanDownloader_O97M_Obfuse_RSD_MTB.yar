...
rule TrojanDownloader_O97M_Obfuse_RSD_MTB{
	...
	strings :
		...
		$a_03_1 = {43 61 6c 6c 20 [0-08] 2e 65 78 65 63 28 } //1
		$a_03_2 = {2e 4f 70 65 6e 20 22 47 45 54 22 2c 20 48 65 78 54 6f 53 74 72 69 6e 67 28 [0-08] 29 2c 20 46 61 6c 73 65 } //1
