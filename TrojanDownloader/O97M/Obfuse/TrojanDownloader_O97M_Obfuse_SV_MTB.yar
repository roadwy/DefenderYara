...
rule TrojanDownloader_O97M_Obfuse_SV_MTB{
	...
	strings :
		$a_03_0 = {53 65 74 20 41 20 3d 20 66 73 2e 43 72 65 61 74 65 54 65 78 74 46 69 6c 65 28 22 63 3a 5c 53 63 65 6e 65 31 5c 4c 6f 67 53 63 65 6e 65 90 02 02 2e 63 6d 64 22 2c 20 54 72 75 65 29 90 00 } //1
