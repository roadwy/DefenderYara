...
rule TrojanDownloader_O97M_Obfuse_EO_MTB{
	...
	strings :
		...
		$a_03_1 = {6d 79 55 52 4c 20 3d 20 22 90 02 05 3a 2f 2f 77 77 77 2e 65 6d 6f 6a 69 66 6f 72 6f 75 74 6c 6f 6f 6b 2e 63 6f 6d 2f 45 6d 6f 6a 69 2f 56 65 72 73 69 6f 6e 73 2f 22 20 26 20 57 65 62 56 65 72 73 69 6f 6e 4e 61 6d 65 90 00 } //1
