...
rule TrojanDownloader_O97M_Obfuse_LG_MTB{
	...
	strings :
		$a_01_0 = {22 76 65 72 69 6e 73 74 65 72 65 2e 78 6c 73 22 } //01 00  "verinstere.xls"
		$a_01_1 = {26 20 22 2e 68 74 6d 22 2c 20 5f } //01 00  & ".htm", _
		$a_01_2 = {28 45 6e 76 69 72 6f 6e 28 22 54 45 4d 50 22 29 29 } //01 00  (Environ("TEMP"))
