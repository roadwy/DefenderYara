...
rule TrojanDownloader_O97M_Obfuse_DJ{
	...
	strings :
		...
		$a_02_2 = {22 68 74 74 70 3a 2f 2f 90 02 14 2e 63 6f 6d 2f 90 02 06 2f 90 01 01 2e 6a 70 67 22 2c 20 45 6e 76 69 72 6f 6e 28 22 41 70 70 44 61 74 61 22 29 20 26 20 22 5c 90 02 0a 2e 65 78 65 22 29 90 00 } //1
	condition:
