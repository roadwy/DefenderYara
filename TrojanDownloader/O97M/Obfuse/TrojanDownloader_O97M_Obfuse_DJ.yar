...
rule TrojanDownloader_O97M_Obfuse_DJ{
	...
	strings :
		$a_00_0 = {50 75 62 6c 69 63 20 53 75 62 20 66 63 4c 34 71 4f 62 34 28 29 } //01 00  Public Sub fcL4qOb4()
		$a_00_1 = {2e 49 44 20 3d 20 22 50 22 20 26 20 49 73 73 71 77 65 36 } //01 00  .ID = "P" & Issqwe6
