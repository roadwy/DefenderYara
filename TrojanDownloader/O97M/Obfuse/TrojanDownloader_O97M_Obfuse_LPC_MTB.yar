...
rule TrojanDownloader_O97M_Obfuse_LPC_MTB{
	...
	strings :
		$a_03_0 = {3d 20 43 68 72 28 41 73 63 28 4d 69 64 28 53 68 65 65 74 73 28 22 90 02 10 22 29 2e 43 65 6c 6c 73 28 90 02 04 2c 20 90 02 03 29 2e 56 61 6c 75 65 2c 20 90 02 10 2c 20 90 02 02 29 29 20 2d 20 90 02 02 29 90 00 } //1
