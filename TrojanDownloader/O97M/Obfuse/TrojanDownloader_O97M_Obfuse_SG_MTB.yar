...
rule TrojanDownloader_O97M_Obfuse_SG_MTB{
	...
	strings :
		$a_03_0 = {73 61 73 20 3d 20 52 65 70 6c 61 63 65 28 22 6d 90 17 03 04 04 03 44 61 74 61 43 6f 64 65 4e 65 74 } //1
		$a_03_1 = {64 61 73 20 3d 20 52 65 70 6c 61 63 65 28 22 53 79 73 74 65 6d [0-70] 2e 65 78 65 53 79 73 74 65 6d [0-2e] 22 2c 20 22 53 79 73 74 65 6d 90 1b 01 22 2c 20 22 22 29 } //1
		$a_03_2 = {28 30 2c 20 64 61 73 2c 20 73 61 73 2c 20 30 2c 20 30 29 [0-03] 49 66 20 72 65 74 20 3d 20 30 20 54 68 65 6e } //1
	condition:
...
rule TrojanDownloader_O97M_Obfuse_SG_MTB_2{
	...
	strings :
		...
		$a_03_2 = {53 65 74 20 6f 50 72 6f 63 65 73 73 20 3d 20 43 72 65 61 74 65 4f 62 6a 65 63 74 28 43 65 6c 6c 73 28 [0-02] 2c 20 [0-02] 29 29 } //1
