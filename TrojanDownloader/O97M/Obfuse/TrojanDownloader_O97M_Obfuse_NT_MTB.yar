...
rule TrojanDownloader_O97M_Obfuse_NT_MTB{
	...
	strings :
		$a_03_0 = {2e 43 72 65 61 74 65 54 65 78 74 46 69 6c 65 28 90 02 20 20 26 20 22 5c 90 02 20 2e 78 73 22 20 26 20 90 02 20 28 29 2c 20 31 2c 20 31 29 90 00 } //1
