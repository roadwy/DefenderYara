...
rule TrojanDownloader_O97M_Obfuse_PLM_MTB{
	...
	strings :
		...
		$a_03_3 = {3d 20 22 6b 64 64 6a [0-0f] 77 69 22 } //1
		$a_03_4 = {44 65 62 75 67 2e 50 72 69 6e 74 20 58 90 0c 02 00 44 65 62 75 67 2e 50 72 69 6e 74 20 59 90 0c 02 00 44 65 62 75 67 2e 50 72 69 6e 74 20 5a } //1
		$a_03_5 = {44 65 62 75 67 2e 50 72 69 6e 74 20 28 53 68 65 6c 6c 28 58 20 2b 20 59 20 2b 20 5a 29 29 90 0c 02 00 45 6e 64 20 53 75 62 } //1
	condition:
