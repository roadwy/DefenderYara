...
rule TrojanDownloader_O97M_Obfuse_PAR_MTB{
	...
	strings :
		...
		$a_03_1 = {53 65 74 20 [0-08] 20 3d 20 43 72 65 61 74 65 4f 62 6a 65 63 74 28 22 57 53 63 72 69 70 74 2e 53 68 65 6c 6c 22 29 } //1
		$a_03_2 = {2e 52 75 6e 20 28 [0-06] 29 } //1
	condition:
