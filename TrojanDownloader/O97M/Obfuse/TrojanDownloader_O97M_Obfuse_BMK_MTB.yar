...
rule TrojanDownloader_O97M_Obfuse_BMK_MTB{
	...
	strings :
		$a_03_0 = {3d 20 53 70 6c 69 74 28 [0-09] 2c 20 43 68 72 28 31 31 20 2b 20 31 31 20 2b 20 31 31 20 2b 20 31 31 29 29 } //1
		$a_03_1 = {53 68 65 6c 6c 20 [0-09] 20 26 20 22 20 22 20 26 } //1
