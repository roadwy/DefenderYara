...
rule TrojanDownloader_O97M_Obfuse_QQ_MTB{
	...
	strings :
		...
		$a_01_2 = {3d 20 22 25 74 65 6d 70 25 22 20 26 } //01 00  = "%temp%" &
		...
		$a_01_5 = {3d 20 22 74 20 73 79 73 74 65 6d 2e 6e 65 74 2e 77 45 42 63 6c 49 65 6e 22 20 26 20 22 54 22 20 26 20 22 29 22 } //00 00  = "t system.net.wEBclIen" & "T" & ")"
	condition:
		any of ($a_*)
