...
rule TrojanDownloader_O97M_Obfuse_LLB_MTB{
	...
	strings :
		$a_03_0 = {3d 20 53 68 65 65 74 73 28 22 [0-10] 22 29 2e 43 65 6c 6c 73 28 [0-03] 2c 20 [0-02] 29 2e 56 61 6c 75 65 3a } //1
		$a_03_1 = {53 68 65 6c 6c 20 [0-c0] 45 78 69 74 20 53 75 62 } //1
