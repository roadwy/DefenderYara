...
rule TrojanDownloader_O97M_Obfuse_YB_MTB{
	...
	strings :
		$a_02_0 = {43 72 65 61 74 65 4f 62 6a 65 63 74 28 22 57 73 63 72 69 70 74 2e 73 68 65 6c 6c 22 29 2e 65 78 65 63 40 28 90 02 08 29 2e 90 00 } //1
		$a_02_1 = {76 62 4e 65 77 4c 69 6e 65 20 26 20 90 02 08 28 28 57 53 63 72 69 70 74 2e 45 63 68 6f 28 29 90 00 } //1
