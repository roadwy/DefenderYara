...
rule TrojanDownloader_O97M_Obfuse_PHJ_MTB{
	...
	strings :
		...
		$a_01_2 = {3d 20 43 72 65 61 74 65 4f 62 6a 65 63 74 28 73 68 65 65 65 20 26 20 22 6c 2e 61 70 70 6c 69 63 61 74 69 6f 6e 22 29 } //01 00 
		$a_01_3 = {2e 4f 70 65 6e 28 62 65 68 61 76 69 6f 72 65 78 61 63 74 6c 79 29 } //00 00 
	condition:
		any of ($a_*)
