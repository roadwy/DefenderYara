...
rule TrojanDownloader_O97M_Obfuse_ASM_MTB{
	...
	strings :
		$a_03_0 = {66 6a 64 6a 6b 61 73 66 20 3d 20 22 90 02 05 6a 64 73 6c 61 64 6b 66 22 90 00 } //1
		$a_01_1 = {66 6a 64 6a 6b 61 73 66 20 3d 20 4c 65 66 74 28 66 6a 64 6a 6b 61 73 66 2c 20 35 29 } //1 fjdjkasf = Left(fjdjkasf, 5)
		$a_03_2 = {64 6a 66 65 69 68 66 69 64 6b 61 73 6c 6a 66 2e 53 68 65 6c 6c 45 78 65 63 75 74 65 20 64 66 67 64 66 6a 69 65 6a 66 6a 64 73 68 61 6a 2c 20 90 02 1f 2c 20 22 22 2c 20 22 6f 70 65 6e 22 2c 20 30 90 00 } //1
