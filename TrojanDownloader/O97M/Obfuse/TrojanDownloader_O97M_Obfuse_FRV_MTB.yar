...
rule TrojanDownloader_O97M_Obfuse_FRV_MTB{
	...
	strings :
		...
		$a_03_2 = {53 75 62 20 5f 90 0c 02 00 41 75 74 6f 5f 63 6c 6f 73 65 28 29 90 00 } //1
	condition:
...
rule TrojanDownloader_O97M_Obfuse_FRV_MTB_2{
	...
	strings :
		...
		$a_03_3 = {53 75 62 20 90 02 19 28 29 0d 0a 68 68 66 67 67 68 67 66 66 20 3d 20 33 0d 0a 4f 6e 20 45 72 72 6f 72 20 52 65 73 75 6d 65 20 4e 65 78 74 90 00 } //1
	condition:
