...
rule TrojanDownloader_O97M_Obfuse_FX{
	...
	strings :
		...
		$a_01_2 = {43 61 6c 6c 20 55 6e 68 69 64 65 53 68 65 65 74 73 } //01 00 
		$a_01_3 = {53 68 65 65 74 73 28 22 50 72 6f 6d 70 74 22 29 2e 56 69 73 69 62 6c 65 20 3d 20 78 6c 53 68 65 65 74 56 65 72 79 48 69 64 64 65 6e } //00 00 
	condition:
		any of ($a_*)
