...
rule TrojanDownloader_O97M_Obfuse_LM_MTB{
	...
	strings :
		...
		$a_00_1 = {43 6d 64 4c 69 6e 65 20 3d 20 22 22 22 22 20 26 20 46 69 6c 65 6e 61 6d 65 20 26 20 22 22 22 22 } //01 00 
...
rule TrojanDownloader_O97M_Obfuse_LM_MTB_2{
	...
	strings :
		...
		$a_01_2 = {2e 53 68 6f 77 57 69 6e 64 6f 77 21 20 3d } //00 00 
	condition:
		any of ($a_*)
