...
rule TrojanDownloader_O97M_Obfuse_AB_MSR{
	...
	strings :
		...
		$a_02_1 = {3d 20 43 75 72 44 69 72 20 26 20 43 68 72 28 39 32 29 20 26 20 [0-06] 20 26 20 22 2e 6a 73 } //1
		$a_02_2 = {3d 20 43 72 65 61 74 65 4f 62 6a 65 63 74 28 22 53 63 72 69 70 74 69 6e 67 2e 46 69 6c 65 53 79 73 74 65 6d 4f 62 6a 65 63 74 22 29 2e 43 72 65 61 74 65 54 65 78 74 46 69 6c 65 28 [0-10] 2c 20 54 72 75 65 2c 20 54 72 75 65 29 } //1
