...
rule TrojanDownloader_O97M_Obfuse_AE_MSR{
	...
	strings :
		$a_02_0 = {59 6f 75 20 61 72 65 20 68 61 63 6b 65 64 22 2c 20 90 02 10 2c 20 22 59 6f 75 20 61 72 65 20 68 61 63 6b 65 64 90 00 } //1
		$a_02_1 = {53 68 65 6c 6c 20 22 43 3a 5c 77 69 6e 64 6f 77 73 5c 53 79 73 74 65 6d 33 32 5c 63 61 6c 63 2e 65 78 65 90 02 06 76 62 4d 61 78 69 6d 69 7a 65 64 46 6f 63 75 73 90 00 } //1
