...
rule TrojanDownloader_O97M_Obfuse_LHM_MTB{
	...
	strings :
		$a_03_0 = {3d 20 53 68 65 65 74 73 28 22 [0-08] 22 29 2e 43 65 6c 6c 73 28 [0-03] 2c 20 [0-02] 29 2e 56 61 6c 75 65 } //1
		$a_03_1 = {3d 20 54 72 75 65 90 0c 02 00 4f 70 74 69 6f 6e 20 45 78 70 6c 69 63 69 74 90 0c 02 00 50 75 62 6c 69 63 } //1
