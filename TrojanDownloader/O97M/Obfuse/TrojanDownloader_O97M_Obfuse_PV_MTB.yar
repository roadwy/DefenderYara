...
rule TrojanDownloader_O97M_Obfuse_PV_MTB_2{
	...
	strings :
		$a_02_0 = {3d 20 43 72 65 61 74 65 4f 62 6a 65 63 74 28 90 01 05 20 2b 20 22 63 72 69 70 74 2e 73 68 65 6c 6c 22 29 90 00 } //1
		$a_00_1 = {53 74 72 69 6e 67 20 3d 20 22 63 3a 5c 70 72 6f 67 72 61 6d 64 61 74 61 5c } //1 String = "c:\programdata\
		$a_02_2 = {28 30 29 20 2b 20 22 76 72 33 32 20 63 3a 5c 70 72 6f 67 72 61 6d 64 61 74 61 5c 90 01 05 2e 74 78 74 22 2c 20 22 77 73 22 90 00 } //6
		$a_02_3 = {28 30 29 20 2b 20 22 76 72 33 32 20 63 3a 5c 70 72 6f 67 72 61 6d 64 61 74 61 5c 90 01 05 2e 70 64 66 22 2c 20 22 77 73 22 90 00 } //6
		$a_02_4 = {53 70 6c 69 74 28 90 01 05 2c 20 90 01 05 29 90 00 } //1
