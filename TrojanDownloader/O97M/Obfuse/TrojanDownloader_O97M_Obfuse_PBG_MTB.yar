...
rule TrojanDownloader_O97M_Obfuse_PBG_MTB{
	...
	strings :
		...
		$a_03_1 = {52 65 70 6c 61 63 65 28 22 63 6d 64 20 2f 63 20 70 6f 77 61 61 64 72 6e 67 6d 36 72 73 68 61 61 64 72 6e 67 6d 36 6c 6c 2f 57 20 30 31 20 63 75 [0-04] 72 6c 20 68 74 74 [0-01] 70 3a 2f 2f 39 31 2e 31 30 37 2e 32 31 30 2e 32 30 37 2f 74 69 6e 79 74 61 73 6b 2e } //1
	condition:
