...
rule TrojanDownloader_O97M_Obfuse_IN_MTB{
	...
	strings :
		$a_03_0 = {43 61 6c 6c 20 90 02 10 28 90 02 10 2e 90 02 10 2c 20 22 76 65 72 69 6e 73 74 65 72 65 2e 78 6c 73 22 2c 20 30 29 90 00 } //1
		...
		$a_03_3 = {3d 20 43 72 65 61 74 65 4f 62 6a 65 63 74 28 90 02 10 2e 54 61 67 29 90 00 } //1
