...
rule TrojanDownloader_O97M_Obfuse_PAX_MTB{
	...
	strings :
		$a_03_0 = {50 72 69 76 61 74 65 20 61 28 90 02 06 29 20 41 73 20 56 61 72 69 61 6e 74 90 00 } //1
		...
		$a_03_3 = {3d 20 53 68 65 6c 6c 28 90 02 15 2c 20 31 29 90 00 } //1
	condition:
...
rule TrojanDownloader_O97M_Obfuse_PAX_MTB_2{
	...
	strings :
		...
		$a_03_2 = {3d 20 4d 69 64 24 28 90 02 0f 2c 20 58 2c 20 31 29 90 00 } //1
		$a_01_3 = {3d 20 56 61 6c 75 65 20 2b 20 43 68 72 28 56 61 6c 28 22 26 68 22 20 26 20 6e 75 6d 29 29 } //1 = Value + Chr(Val("&h" & num))
		$a_03_4 = {3d 20 43 72 65 61 74 65 4f 62 6a 65 63 74 28 48 32 41 28 48 32 41 28 41 72 72 61 79 4c 69 73 74 28 90 02 04 29 90 00 } //1
