...
rule TrojanDownloader_O97M_Obfuse_V_MTB{
	...
	strings :
		...
		$a_03_1 = {2e 57 72 69 74 65 20 90 02 1e 26 20 22 22 20 26 20 90 02 1e 26 20 22 20 2d 66 20 2d 64 65 63 6f 64 65 20 22 22 43 3a 25 48 4f 4d 45 50 41 54 48 25 5c 64 57 69 66 69 22 90 00 } //1
