...
rule TrojanDownloader_O97M_Obfuse_PAG_MTB{
	...
	strings :
		...
		$a_03_1 = {68 74 74 70 90 02 02 3a 2f 2f 90 02 30 2f 90 02 10 2e 65 78 65 20 2d 4f 75 74 46 69 6c 65 20 43 3a 5c 55 73 65 72 73 5c 50 75 62 6c 69 63 5c 90 02 50 2e 65 78 65 7d 3b 90 00 } //1
		$a_03_2 = {53 74 61 72 74 2d 50 72 6f 63 65 73 73 20 2d 46 69 6c 65 50 61 74 68 20 22 43 3a 5c 55 73 65 72 73 5c 50 75 62 6c 69 63 5c 90 02 50 2e 65 78 65 22 7d 90 00 } //1
	condition:
