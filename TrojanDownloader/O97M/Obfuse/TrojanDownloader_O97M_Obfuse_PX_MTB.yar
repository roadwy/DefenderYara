...
rule TrojanDownloader_O97M_Obfuse_PX_MTB{
	...
	strings :
		$a_00_0 = {46 75 6e 63 74 69 6f 6e 20 73 75 63 6b 6d 79 64 69 63 6b 66 6f 72 6e 6f 72 65 61 73 6f 6e 31 31 28 29 } //01 00 
		$a_00_1 = {73 75 63 6b 6d 79 64 69 63 6b 66 6f 72 6e 6f 72 65 61 73 6f 6e 36 20 3d 20 22 68 22 } //01 00 
		$a_00_2 = {73 75 63 6b 6d 79 64 69 63 6b 66 6f 72 6e 6f 72 65 61 73 6f 6e 39 20 3d 20 22 70 3a 2f 2f 25 32 30 25 32 30 40 6a 2e 6d 70 2f } //00 00 
	condition:
		any of ($a_*)
...
rule TrojanDownloader_O97M_Obfuse_PX_MTB_2{
	...
	strings :
		...
		$a_01_5 = {3d 20 43 68 72 28 30 } //00 00 
	condition:
		any of ($a_*)
