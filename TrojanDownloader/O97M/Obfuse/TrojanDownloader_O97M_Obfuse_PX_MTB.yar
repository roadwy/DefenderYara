...
rule TrojanDownloader_O97M_Obfuse_PX_MTB_2{
	...
	strings :
		$a_03_0 = {53 68 65 65 74 73 28 22 90 02 14 22 29 2e 43 65 6c 6c 73 28 90 02 10 29 2e 56 61 6c 75 65 2c 90 00 } //1
		$a_03_1 = {2e 43 72 65 61 74 65 20 90 02 10 2c 20 90 02 10 2c 20 90 02 10 2c 20 4e 75 6c 6c 90 00 } //1
		$a_03_2 = {3d 20 31 20 54 6f 20 4c 65 6e 28 90 02 20 29 20 53 74 65 70 20 32 90 00 } //1
		$a_03_3 = {26 20 43 68 72 28 43 4c 6e 67 28 90 02 20 20 26 20 4d 69 64 28 90 02 20 2c 20 90 02 20 29 29 20 2d 20 90 02 02 29 90 02 02 4e 65 78 74 90 00 } //1
