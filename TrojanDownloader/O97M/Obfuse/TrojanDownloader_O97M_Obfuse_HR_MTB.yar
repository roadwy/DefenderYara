...
rule TrojanDownloader_O97M_Obfuse_HR_MTB{
	...
	strings :
		...
		$a_03_1 = {31 39 35 2e 31 32 33 2e 32 34 31 2e 31 34 34 2f 61 70 69 2e 70 68 70 90 0a 1e 00 68 74 74 70 3a 2f 2f 90 00 } //1
		$a_00_2 = {43 3a 5c 56 65 72 74 69 73 5c 4b 6f 74 73 5c 73 76 63 68 6f 73 74 } //1 C:\Vertis\Kots\svchost
...
rule TrojanDownloader_O97M_Obfuse_HR_MTB_2{
	...
	strings :
		...
		$a_03_1 = {2e 56 61 6c 75 65 29 2e 52 75 6e 25 20 90 02 30 28 32 29 20 2b 20 90 02 30 28 30 29 2c 90 00 } //1
		$a_03_2 = {2e 52 75 6e 25 20 90 02 20 28 90 02 14 2e 43 6f 6e 74 72 6f 6c 73 2c 20 32 29 20 2b 90 00 } //1
		$a_01_3 = {2e 43 6f 6e 74 72 6f 6c 73 } //1 .Controls
		$a_01_4 = {3d 20 53 71 72 28 34 29 20 2d 20 31 } //1 = Sqr(4) - 1
	condition:
