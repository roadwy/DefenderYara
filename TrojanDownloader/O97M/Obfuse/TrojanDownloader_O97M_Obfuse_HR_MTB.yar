...
rule TrojanDownloader_O97M_Obfuse_HR_MTB{
	...
	strings :
		...
		$a_03_1 = {31 39 35 2e 31 32 33 2e 32 34 31 2e 31 34 34 2f 61 70 69 2e 70 68 70 90 0a 1e 00 68 74 74 70 3a 2f 2f } //1
...
rule TrojanDownloader_O97M_Obfuse_HR_MTB_2{
	...
	strings :
		...
		$a_03_1 = {2e 56 61 6c 75 65 29 2e 52 75 6e 25 20 [0-30] 28 32 29 20 2b 20 [0-30] 28 30 29 2c } //1
		$a_03_2 = {2e 52 75 6e 25 20 [0-20] 28 [0-14] 2e 43 6f 6e 74 72 6f 6c 73 2c 20 32 29 20 2b } //1
