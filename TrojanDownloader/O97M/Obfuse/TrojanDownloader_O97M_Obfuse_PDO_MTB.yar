...
rule TrojanDownloader_O97M_Obfuse_PDO_MTB{
	...
	strings :
		...
		$a_03_3 = {3d 73 70 65 63 69 61 6c 70 61 74 68 2b 28 22 5c 90 02 0a 2e 22 29 2e 6f 70 65 6e 22 67 65 74 22 2c 28 22 68 3a 2f 2f 77 77 77 2e 64 2e 6d 2f 6a 68 68 68 64 68 67 68 2f 6b 6b 6a 62 6b 6a 62 76 68 2e 90 00 } //1
	condition:
