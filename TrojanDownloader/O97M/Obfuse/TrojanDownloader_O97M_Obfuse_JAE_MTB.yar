...
rule TrojanDownloader_O97M_Obfuse_JAE_MTB{
	...
	strings :
		$a_03_0 = {4d 69 64 28 90 02 08 2c 20 90 02 08 2c 20 31 29 90 00 } //1
		...
		$a_03_2 = {52 65 70 6c 61 63 65 28 90 02 08 2c 20 90 02 08 2c 20 22 22 29 90 00 } //1
		$a_03_3 = {56 42 41 2e 43 68 72 28 90 02 08 29 90 00 } //1
	condition:
