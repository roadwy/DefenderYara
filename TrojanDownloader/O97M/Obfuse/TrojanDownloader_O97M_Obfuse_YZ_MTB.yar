...
rule TrojanDownloader_O97M_Obfuse_YZ_MTB{
	...
	strings :
		...
		$a_03_1 = {74 72 61 6e 73 76 61 6c 65 2e 73 73 6c 62 6c 69 6e 64 61 64 6f 2e 63 6f 6d 2f 90 02 09 2e 68 74 6d 6c 90 0a 27 00 68 74 74 70 3a 2f 2f 90 00 } //1
		$a_03_2 = {53 68 65 6c 6c 20 28 90 02 09 29 90 00 } //1
	condition:
