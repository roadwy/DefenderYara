...
rule TrojanDownloader_O97M_Obfuse_EC{
	...
	strings :
		...
		$a_01_1 = {3d 20 47 65 74 4f 62 6a 65 63 74 28 22 6e 65 77 3a 30 30 30 36 46 30 33 41 2d 30 30 30 30 2d 30 30 30 30 2d 43 30 30 30 2d 30 30 30 30 30 30 30 30 30 30 34 36 22 29 } //01 00 
