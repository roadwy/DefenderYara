...
rule TrojanDownloader_O97M_Obfuse_VIS_MTB{
	...
	strings :
		$a_03_0 = {46 6f 72 20 69 20 3d 20 31 20 54 6f 20 4c 65 6e 28 90 02 72 29 20 53 74 65 70 20 32 90 00 } //1
		$a_03_1 = {73 53 74 72 20 3d 20 73 53 74 72 20 2b 20 43 68 72 28 43 4c 6e 67 28 22 26 48 22 20 26 20 4d 69 64 28 90 02 72 2c 20 69 2c 20 32 29 29 20 2d 20 32 39 29 90 00 } //1
...
rule TrojanDownloader_O97M_Obfuse_VIS_MTB_2{
	...
	strings :
		...
		$a_03_1 = {4f 70 65 6e 20 90 02 0a 20 46 6f 72 20 4f 75 74 70 75 74 20 41 73 20 23 31 0d 0a 50 72 69 6e 74 20 23 31 2c 20 52 65 70 6c 61 63 65 28 41 63 74 69 76 65 44 6f 63 75 6d 65 6e 74 2e 52 61 6e 67 65 2e 54 65 78 74 2c 20 22 90 02 0a 22 2c 20 22 22 29 0d 0a 43 6c 6f 73 65 20 23 31 90 00 } //1
...
rule TrojanDownloader_O97M_Obfuse_VIS_MTB_3{
	...
	strings :
		...
		$a_03_2 = {26 20 22 43 3a 5c 55 73 65 72 73 5c 50 75 62 6c 69 63 5c 44 6f 63 75 6d 65 6e 74 73 5c 90 02 0f 2e 65 78 22 20 26 20 43 68 72 28 31 30 31 29 20 26 20 43 68 72 28 33 34 29 20 26 20 90 00 } //1
	condition:
