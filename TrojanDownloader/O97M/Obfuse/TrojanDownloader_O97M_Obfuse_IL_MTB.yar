...
rule TrojanDownloader_O97M_Obfuse_IL_MTB{
	...
	strings :
		$a_03_0 = {43 61 6c 6c 20 90 02 09 28 22 63 3a 5c 77 69 6e 64 6f 77 73 5c 74 65 6d 70 5c 90 02 09 2e 78 73 6c 22 2c 20 90 02 09 28 90 02 09 28 31 29 29 29 90 00 } //1
		$a_03_1 = {26 20 43 68 72 24 28 56 61 6c 28 22 26 48 22 20 26 20 4d 69 64 24 28 90 02 09 2c 20 90 02 09 2c 20 32 29 29 29 90 00 } //1
		$a_01_2 = {3d 20 4e 65 77 20 57 73 68 53 68 65 6c 6c } //1 = New WshShell
		$a_03_3 = {3d 20 31 20 54 6f 20 4c 65 6e 28 90 02 09 29 20 53 74 65 70 20 32 90 00 } //1
