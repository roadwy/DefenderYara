...
rule TrojanDownloader_O97M_Obfuse_BPD_MTB{
	...
	strings :
		...
		$a_03_1 = {73 70 65 63 69 61 6c 70 61 74 68 3d 77 73 68 73 68 65 6c 6c 2e 73 70 65 63 69 61 6c 66 6f 6c 64 65 72 73 28 22 90 02 0a 22 29 64 69 6d 90 00 } //1
		...
		$a_03_4 = {26 63 68 72 28 61 73 63 28 6d 69 64 28 90 02 d2 2c 90 02 d2 2c 31 29 29 2d 31 33 29 6e 65 78 74 90 00 } //1
	condition:
