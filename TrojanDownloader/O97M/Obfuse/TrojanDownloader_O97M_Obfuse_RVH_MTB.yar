...
rule TrojanDownloader_O97M_Obfuse_RVH_MTB{
	...
	strings :
		$a_02_0 = {31 38 35 2e 32 34 33 2e 32 31 35 2e 32 31 33 2f 73 79 73 5f 69 6e 66 6f 2e 76 62 73 22 2c 20 46 61 6c 73 65 90 0a 3e 00 78 48 74 74 70 2e 4f 70 65 6e 20 22 47 45 54 22 2c 20 22 68 74 74 70 3a 2f 2f 90 00 } //1
