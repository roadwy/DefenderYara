...
rule TrojanDownloader_O97M_Obfuse_JB_MTB{
	...
	strings :
		...
		$a_03_1 = {2e 54 65 78 74 42 6f 78 90 02 01 2e 54 65 78 74 90 00 } //1
		$a_01_2 = {3d 20 22 4e 65 77 4d 61 63 72 6f 73 31 22 } //1 = "NewMacros1"
		$a_03_3 = {3d 20 47 65 74 54 69 63 6b 43 6f 75 6e 74 20 2b 20 28 90 02 12 20 2a 20 31 30 30 30 29 90 00 } //1
		$a_03_4 = {3d 20 4d 69 64 28 90 02 09 2c 20 31 2c 90 00 } //1
		$a_03_5 = {53 68 65 6c 6c 90 02 10 20 26 90 00 } //1
