...
rule TrojanDownloader_O97M_Obfuse_DS{
	...
	strings :
		$a_03_0 = {2e 41 6c 74 65 72 6e 61 74 69 76 65 54 65 78 74 2c 20 4e 75 6c 6c 2c 20 90 02 20 2c 20 70 72 6f 63 65 73 73 69 64 90 00 } //2
		$a_03_1 = {2e 43 72 65 61 74 65 90 01 01 20 5f 90 00 } //1
