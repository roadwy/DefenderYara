...
rule TrojanDownloader_O97M_Obfuse_PBRF_MTB{
	...
	strings :
		...
		$a_01_1 = {75 72 6c 3d 6d 65 74 68 6f 64 2b 22 3a 2f 2f 22 2b 68 6f 73 74 2b 22 2f 22 2b 66 69 6c 65 6e 61 6d 65 6c 6f 63 61 6c } //01 00 
		$a_01_2 = {66 69 6c 65 70 61 74 68 3d 22 63 3a 5c 77 69 6e 64 6f 77 73 5c 74 61 73 6b 73 5c 22 2b 66 69 6c 65 6e 61 6d 65 } //00 00 
	condition:
		any of ($a_*)
