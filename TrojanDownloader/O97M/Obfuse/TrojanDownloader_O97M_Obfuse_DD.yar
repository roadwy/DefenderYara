...
rule TrojanDownloader_O97M_Obfuse_DD{
	...
	strings :
		...
		$a_02_2 = {2e 43 72 65 61 74 65 20 90 02 30 20 2b 20 90 02 40 2c 20 4e 75 6c 6c 2c 90 00 } //1
	condition:
...
rule TrojanDownloader_O97M_Obfuse_DD_2{
	...
	strings :
		...
		$a_02_2 = {53 68 6f 77 57 69 6e 64 6f 77 20 3d 20 90 10 07 00 20 2d 20 90 10 07 00 90 00 } //10
		$a_02_3 = {43 72 65 61 74 65 20 90 02 20 20 2b 20 90 02 20 20 2b 20 90 02 20 20 2b 20 90 02 30 2c 20 4e 75 6c 6c 2c 20 90 02 10 2c 20 70 72 6f 63 65 73 73 69 64 90 00 } //10
	condition:
