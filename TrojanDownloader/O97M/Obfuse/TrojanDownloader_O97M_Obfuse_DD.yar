...
rule TrojanDownloader_O97M_Obfuse_DD{
	...
	strings :
		...
		$a_01_1 = {47 65 74 4f 62 6a 65 63 74 28 22 77 69 6e 6d 67 6d 74 73 3a 57 69 6e 33 32 5f 50 72 6f 63 65 73 73 22 29 } //01 00  GetObject("winmgmts:Win32_Process")
...
rule TrojanDownloader_O97M_Obfuse_DD_2{
	...
	strings :
		$a_01_0 = {53 75 62 20 61 75 74 6f 6f 70 65 6e 28 29 } //01 00  Sub autoopen()
		$a_01_1 = {3d 20 47 65 74 4f 62 6a 65 63 74 28 22 77 69 6e 6d 67 6d 74 73 3a 57 69 6e 33 32 5f 50 72 6f 63 65 73 73 22 29 } //0a 00  = GetObject("winmgmts:Win32_Process")
