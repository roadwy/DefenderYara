...
rule TrojanDownloader_O97M_Obfuse_HZ_MTB_2{
	...
	strings :
		...
		$a_03_1 = {68 74 74 70 3a 2f 2f 64 75 6c 65 61 6c 2e 63 6f 6d 2f 90 02 19 2f 90 02 06 2e 65 78 65 90 00 } //1
		$a_03_2 = {68 74 74 70 3a 2f 2f 66 69 6b 69 6d 61 2e 63 6f 6d 2f 90 02 06 2e 65 78 65 90 00 } //1
		$a_03_3 = {68 74 74 70 3a 2f 2f 64 6a 61 63 65 6c 2e 63 6f 6d 2f 90 02 06 2e 65 78 65 90 00 } //1
		$a_03_4 = {68 74 74 70 3a 2f 2f 62 65 6c 6c 71 75 65 2e 63 6f 6d 2f 90 02 06 2e 65 78 65 90 00 } //1
		$a_03_5 = {68 74 74 70 3a 2f 2f 65 72 73 69 6d 70 2e 63 6f 6d 2f 90 02 06 2e 65 78 65 90 00 } //1
		$a_03_6 = {68 74 74 70 3a 2f 2f 61 72 63 6f 71 61 2e 63 6f 6d 2f 90 02 06 2e 65 78 65 90 00 } //1
		$a_03_7 = {68 74 74 70 3a 2f 2f 74 79 70 72 65 72 2e 63 6f 6d 2f 90 02 06 2e 65 78 65 90 00 } //1
		$a_03_8 = {68 74 74 70 73 3a 2f 2f 74 6f 75 6c 6f 75 73 61 2e 63 6f 6d 2f 90 02 14 2e 70 68 70 90 00 } //1
		$a_03_9 = {68 74 74 70 73 3a 2f 2f 74 6f 75 6c 6f 75 73 61 2e 63 6f 6d 2f 90 02 14 2e 65 78 65 90 00 } //1
	condition:
