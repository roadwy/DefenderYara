...
rule TrojanDownloader_O97M_Obfuse_PDRR_MTB{
	...
	strings :
		...
		$a_03_4 = {41 63 74 69 76 65 44 6f 63 75 6d 65 6e 74 2e 42 75 69 6c 74 49 6e 44 6f 63 75 6d 65 6e 74 50 72 6f 70 65 72 74 69 65 73 28 [0-0f] 28 22 [0-20] 22 29 29 2e 56 61 6c 75 65 29 } //1
		$a_03_5 = {73 68 65 6c 6c 43 6f 64 65 2c 20 [0-40] 2c 20 36 34 2c 20 56 61 72 50 74 72 28 [0-40] 29 } //1
	condition:
