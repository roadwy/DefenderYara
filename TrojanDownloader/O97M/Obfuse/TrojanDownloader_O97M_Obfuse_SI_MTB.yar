...
rule TrojanDownloader_O97M_Obfuse_SI_MTB{
	...
	strings :
		...
		$a_03_3 = {3d 20 53 74 72 52 65 76 65 72 73 65 28 52 61 6e 67 65 28 22 90 02 02 22 29 2e 43 6f 6d 6d 65 6e 74 2e 54 65 78 74 29 90 00 } //1
		$a_03_4 = {3d 20 4a 6f 69 6e 28 90 02 02 2c 20 22 22 29 90 00 } //1
	condition:
...
rule TrojanDownloader_O97M_Obfuse_SI_MTB_2{
	...
	strings :
		$a_03_0 = {50 75 62 6c 69 63 20 43 6f 6e 73 74 20 90 02 05 20 41 73 20 53 74 72 69 6e 67 20 3d 20 22 20 32 33 72 76 73 67 65 72 22 90 00 } //1
