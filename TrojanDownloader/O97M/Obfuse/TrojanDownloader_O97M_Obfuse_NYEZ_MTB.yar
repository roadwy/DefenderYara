...
rule TrojanDownloader_O97M_Obfuse_NYEZ_MTB{
	...
	strings :
		...
		$a_03_1 = {68 74 74 70 3a 2f 2f 73 63 61 6c 61 64 65 76 65 6c 6f 70 6d 65 6e 74 73 2e 73 63 61 6c 61 64 65 76 63 6f 2e 63 6f 6d 2f 31 37 2f 90 02 0a 2e 65 78 90 00 } //1
		$a_03_2 = {43 3a 5c 55 73 65 72 73 5c 50 75 62 6c 69 63 5c 44 6f 63 75 6d 65 6e 74 73 5c 90 02 14 2e 65 78 90 00 } //1
	condition:
