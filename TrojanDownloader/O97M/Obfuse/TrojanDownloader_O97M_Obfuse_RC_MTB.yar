...
rule TrojanDownloader_O97M_Obfuse_RC_MTB{
	...
	strings :
		...
		$a_01_2 = {3d 20 43 72 65 61 74 65 4f 62 6a 65 63 74 28 22 57 53 63 72 69 70 74 2e 53 68 65 6c 22 20 26 20 22 6c 22 29 } //01 00 
		$a_01_3 = {65 6e 62 6d 67 67 72 2e 52 75 6e } //00 00 
	condition:
		any of ($a_*)
