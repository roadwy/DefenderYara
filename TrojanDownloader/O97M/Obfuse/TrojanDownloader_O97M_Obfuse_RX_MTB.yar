...
rule TrojanDownloader_O97M_Obfuse_RX_MTB_2{
	...
	strings :
		$a_03_0 = {26 20 43 68 72 28 43 4c 6e 67 28 41 63 74 69 76 65 44 6f 63 75 6d 65 6e 74 2e 56 61 72 69 61 62 6c 65 73 28 22 90 02 18 22 29 2e 56 61 6c 75 65 20 26 20 52 69 67 68 74 28 4c 65 66 74 28 90 02 15 2c 20 90 02 15 29 2c 20 32 29 29 20 2d 20 90 02 02 29 90 00 } //1
...
rule TrojanDownloader_O97M_Obfuse_RX_MTB_3{
	...
	strings :
		...
		$a_03_3 = {77 65 62 63 65 6e 74 65 72 62 72 61 73 69 6c 2e 63 6f 6d 2e 62 72 2f 73 65 6f 2f 76 68 66 32 2e 90 0a 27 00 68 74 74 70 3a 2f 2f 90 00 } //1
