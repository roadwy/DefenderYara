...
rule TrojanDownloader_O97M_Obfuse_SD_MTB_2{
	...
	strings :
		$a_01_0 = {3d 20 22 43 3a 5c 57 69 6e 64 6f 77 73 5c 53 79 73 74 65 6d 33 32 5c 72 75 6e 64 6c 6c 33 32 2e 65 78 65 20 22 20 26 20 45 6e 76 69 72 6f 6e 28 22 54 45 4d 50 22 29 20 26 20 22 5c 70 6f 77 65 72 73 68 64 6c 6c 2e 64 6c 6c 2c 6d 61 69 6e } //01 00  = "C:\Windows\System32\rundll32.exe " & Environ("TEMP") & "\powershdll.dll,main
		$a_01_1 = {3d 20 45 6e 76 69 72 6f 6e 28 22 54 45 4d 50 22 29 20 26 20 22 5c 70 6f 77 65 72 73 68 64 6c 6c 2e 64 6c 6c 22 } //01 00  = Environ("TEMP") & "\powershdll.dll"
		$a_01_2 = {23 49 66 20 57 69 6e 36 34 20 54 68 65 6e } //01 00  #If Win64 Then
