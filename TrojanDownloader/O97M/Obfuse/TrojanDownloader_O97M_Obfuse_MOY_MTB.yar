...
rule TrojanDownloader_O97M_Obfuse_MOY_MTB{
	...
	strings :
		$a_01_0 = {2e 53 68 6f 77 57 69 6e 64 6f 77 20 3d 20 43 4c 6e 67 28 28 } //01 00 
		...
		$a_01_3 = {26 20 43 68 72 57 28 43 4c 6e 67 28 28 41 73 63 57 28 22 } //01 00 
		$a_01_4 = {44 65 62 75 67 2e 50 72 69 6e 74 20 } //01 00 
