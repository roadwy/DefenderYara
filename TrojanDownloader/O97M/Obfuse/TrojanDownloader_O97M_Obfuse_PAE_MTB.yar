...
rule TrojanDownloader_O97M_Obfuse_PAE_MTB{
	...
	strings :
		$a_01_0 = {70 6f 77 65 72 73 68 65 6c 6c 2e 65 78 65 20 2d 57 69 6e 64 6f 77 53 74 79 6c 65 20 48 69 64 64 65 6e 20 2d 45 78 65 63 75 74 69 6f 6e 50 6f 6c 69 63 79 20 42 79 70 61 73 73 20 20 2d 63 6f 6d 6d 61 6e 64 20 } //01 00  powershell.exe -WindowStyle Hidden -ExecutionPolicy Bypass  -command 
