...
rule TrojanDownloader_O97M_Obfuse_PAM_MTB{
	...
	strings :
		$a_03_0 = {3d 20 45 6e 76 69 72 6f 6e 28 90 02 10 29 90 00 } //1
		...
		$a_03_2 = {28 22 77 69 6e 22 20 26 20 22 64 69 72 22 29 20 26 20 90 02 10 20 26 20 22 73 79 73 74 65 22 20 26 20 22 6d 33 32 22 20 26 20 90 02 10 20 26 20 90 02 10 28 30 29 90 00 } //1
		$a_03_3 = {28 22 74 65 22 20 26 20 22 6d 70 22 29 20 26 20 90 02 10 20 26 20 90 02 10 28 31 29 90 00 } //1
	condition:
