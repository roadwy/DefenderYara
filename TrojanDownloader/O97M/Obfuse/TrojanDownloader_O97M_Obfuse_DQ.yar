...
rule TrojanDownloader_O97M_Obfuse_DQ{
	...
	strings :
		$a_03_0 = {3d 20 47 65 74 4f 62 6a 65 63 74 28 90 02 10 20 2b 20 90 02 10 20 2b 20 90 02 10 29 2e 20 5f 90 00 } //2
		$a_03_1 = {43 72 65 61 74 65 90 01 01 20 5f 90 00 } //1
