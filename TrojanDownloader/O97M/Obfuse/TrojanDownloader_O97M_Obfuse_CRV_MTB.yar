...
rule TrojanDownloader_O97M_Obfuse_CRV_MTB_2{
	...
	strings :
		$a_03_0 = {55 52 4c 44 6f 77 6e 6c 6f 61 64 54 6f 46 69 6c 65 20 30 2c 20 49 6d 61 67 65 6d 53 69 6d 70 6c 65 73 43 44 54 2c 20 4d 61 73 74 65 72 43 44 54 20 26 20 22 64 6f 63 75 6d 65 6e 74 2e 90 02 03 22 2c 20 30 2c 20 30 90 00 } //1
