...
rule TrojanDownloader_O97M_Obfuse_PKSX_MTB{
	...
	strings :
		...
		$a_01_1 = {27 2c 27 77 69 6e 6d 67 6d 74 73 3a 27 2c 27 } //01 00 
		$a_01_2 = {43 3a 5c 78 35 63 50 72 6f 67 72 61 6d 44 61 74 61 5c 78 35 63 64 64 6f 6e 64 2e 63 6f 6d } //01 00 
		$a_01_3 = {3d 20 22 43 3a 5c 55 73 65 72 73 5c 50 75 62 6c 69 63 5c 75 70 64 61 74 65 2e 6a 73 22 } //01 00 
		$a_01_4 = {27 2c 27 57 69 6e 33 32 5f 50 72 6f 63 65 73 73 53 74 61 72 74 75 70 27 2c 27 } //00 00 
	condition:
		any of ($a_*)
