...
rule TrojanDownloader_O97M_Obfuse_JAU_MTB_2{
	...
	strings :
		$a_03_0 = {52 65 70 6c 61 63 65 28 90 02 08 2c 20 22 20 22 2c 20 22 22 2c 20 31 2c 20 2d 31 29 90 00 } //1
		$a_03_1 = {43 72 65 61 74 65 28 90 02 08 2c 20 4e 75 6c 6c 2c 20 4e 75 6c 6c 2c 20 69 6e 74 50 72 6f 63 65 73 73 49 44 29 90 00 } //1
		...
		$a_03_4 = {4d 69 64 28 22 90 02 20 22 2c 20 31 2c 20 31 31 29 90 00 } //1
	condition:
