...
rule TrojanDownloader_O97M_Obfuse_ID_MTB{
	...
	strings :
		$a_03_0 = {4f 70 65 6e 20 22 43 3a 5c 57 69 6e 64 6f 77 73 5c 54 65 6d 70 5c 90 02 30 2e 6a 73 22 20 46 6f 72 20 4f 75 74 70 75 74 20 41 73 20 23 90 00 } //1
		...
		$a_01_3 = {2e 4e 61 6d 65 53 70 61 63 65 28 45 6e 76 69 72 6f 6e 28 22 77 69 6e 64 69 72 22 29 20 2b 20 22 5c 54 65 6d 70 22 29 } //1 .NameSpace(Environ("windir") + "\Temp")
