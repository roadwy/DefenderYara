...
rule TrojanDownloader_O97M_Obfuse_ID_MTB{
	meta:
		description = "TrojanDownloader:O97M/Obfuse.ID!MTB,SIGNATURE_TYPE_MACROHSTR_EXT,06 00 06 00 06 00 00 01 00 "
	...
	strings :
		...
		$a_01_3 = {2e 4e 61 6d 65 53 70 61 63 65 28 45 6e 76 69 72 6f 6e 28 22 77 69 6e 64 69 72 22 29 20 2b 20 22 5c 54 65 6d 70 22 29 } //01 00  .NameSpace(Environ("windir") + "\Temp")
