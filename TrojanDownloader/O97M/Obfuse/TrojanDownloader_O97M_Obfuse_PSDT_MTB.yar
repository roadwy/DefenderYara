...
rule TrojanDownloader_O97M_Obfuse_PSDT_MTB{
	...
	strings :
		...
		$a_03_2 = {3d 20 22 2e 22 20 26 20 6d 69 78 4d 70 33 49 6e 73 74 61 6c 6c 20 26 20 73 65 74 75 70 53 65 74 4d 70 33 90 0c 02 00 4f 70 65 6e 20 6d 69 78 4d 70 33 49 6e 73 74 61 6c 6c 20 46 6f 72 20 4f 75 74 70 75 74 20 41 73 20 23 31 90 00 } //1
		...
		$a_03_4 = {50 75 62 6c 69 63 20 53 75 62 20 61 75 74 6f 4f 70 65 6e 28 29 90 0c 02 00 6d 69 78 4d 69 78 4d 70 33 20 22 22 2c 20 22 48 54 41 22 90 0c 02 00 45 6e 64 20 53 75 62 90 00 } //1
	condition:
