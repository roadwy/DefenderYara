...
rule TrojanDownloader_O97M_Obfuse_AK_eml_2{
	...
	strings :
		$a_03_0 = {2e 49 74 65 6d 28 29 2e 44 6f 63 75 6d 65 6e 74 2e 41 70 70 6c 69 63 61 74 69 6f 6e 2e 53 68 65 6c 6c 45 78 65 63 75 74 65 20 [0-1a] 2c 20 [0-1c] 20 26 20 [0-1b] 2c 20 [0-1e] 28 } //1
		...
		$a_03_3 = {49 66 20 28 56 61 6c 28 41 70 70 6c 69 63 61 74 69 6f 6e 2e 56 65 72 73 69 6f 6e 29 29 20 54 68 65 6e [0-1e] 20 3d 20 41 72 72 61 79 28 } //1
	condition:
