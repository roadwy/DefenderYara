...
rule TrojanDownloader_O97M_Obfuse_BRK_MTB{
	...
	strings :
		...
		$a_03_2 = {28 4c 65 6e 28 [0-19] 29 20 3c 20 31 30 32 34 29 20 54 68 65 6e } //1
		$a_03_3 = {3d 20 4a 6f 69 6e 28 [0-19] 2c 20 22 22 29 } //1
		...
		$a_03_5 = {2e 65 78 65 63 20 28 73 72 28 [0-19] 29 29 } //1
	condition:
