...
rule TrojanDownloader_O97M_Obfuse_HK{
	...
	strings :
		$a_01_0 = {23 49 66 20 54 72 75 65 20 41 6e 64 20 31 20 41 6e 64 20 31 20 41 6e 64 20 31 20 41 6e 64 20 31 20 41 6e 64 20 31 20 5f } //01 00  #If True And 1 And 1 And 1 And 1 And 1 _
		$a_01_1 = {41 6e 64 20 31 20 41 6e 64 20 31 20 41 6e 64 20 31 20 41 6e 64 20 31 20 41 6e 64 20 31 20 41 6e 64 20 31 20 41 6e 64 20 31 20 54 68 65 6e } //01 00  And 1 And 1 And 1 And 1 And 1 And 1 And 1 Then
