...
rule TrojanDownloader_O97M_Obfuse_JU_MTB{
	...
	strings :
		...
		$a_03_3 = {26 20 43 68 72 24 28 56 61 6c 28 22 26 48 22 20 26 20 4d 69 64 24 28 [0-10] 2c } //1
...
rule TrojanDownloader_O97M_Obfuse_JU_MTB_2{
	...
	strings :
		...
		$a_03_1 = {7b 53 74 61 72 74 2d 50 72 6f 63 65 73 73 20 2d 46 69 6c 65 50 61 74 68 20 22 43 3a 5c 55 73 65 72 73 5c 50 75 62 6c 69 63 5c [0-0a] 5c [0-0a] 2e 65 78 65 } //2
		$a_03_2 = {68 74 74 70 3a 2f 2f 32 30 39 2e 31 34 31 2e 33 35 2e 32 33 39 2f 33 33 2f [0-0f] 2e 6a 70 67 } //2
		$a_03_3 = {43 3a 5c 55 73 65 72 73 5c 50 75 62 6c 69 63 5c 4d 75 73 69 63 5c [0-0f] 2e 65 78 65 } //2
