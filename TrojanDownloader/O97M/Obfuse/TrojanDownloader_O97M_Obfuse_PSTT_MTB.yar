...
rule TrojanDownloader_O97M_Obfuse_PSTT_MTB{
	...
	strings :
		...
		$a_03_1 = {2e 63 6f 6d 2f 61 63 74 69 76 65 2f 73 65 61 72 63 68 4d 65 73 73 65 6e 67 65 72 2f 64 77 2e 70 68 70 3f 6d 6f 64 65 3d 65 74 63 22 2c 90 0a 50 00 46 69 6c 65 5f 44 6f 77 6e 4c 6f 61 64 20 22 68 74 74 70 3a 2f 2f 77 77 77 2e 79 65 73 66 6f 72 6d 90 00 } //1
