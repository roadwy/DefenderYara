...
rule TrojanDownloader_O97M_Obfuse_ZK_MTB{
	...
	strings :
		...
		$a_01_3 = {2e 65 78 65 63 20 70 28 67 65 74 77 63 29 } //01 00  .exec p(getwc)
		$a_03_4 = {3d 20 52 65 70 6c 61 63 65 28 90 02 19 2c 20 90 02 1e 2c 20 90 02 19 29 90 00 } //01 00 
		$a_01_5 = {3d 20 53 70 6c 69 74 28 70 28 66 72 6d 2e 67 65 74 77 63 29 2c 20 22 20 22 29 } //01 00  = Split(p(frm.getwc), " ")
