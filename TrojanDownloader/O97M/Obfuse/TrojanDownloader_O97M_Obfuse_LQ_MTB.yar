...
rule TrojanDownloader_O97M_Obfuse_LQ_MTB{
	...
	strings :
		...
		$a_01_3 = {3d 20 43 72 65 61 74 65 4f 62 6a 65 63 74 28 22 53 63 72 69 70 74 69 6e 67 2e 46 69 6c 65 53 79 73 74 65 6d 4f 62 6a 65 63 74 22 29 } //01 00 
		$a_01_4 = {53 75 62 20 41 75 74 6f 4f 70 65 6e 28 29 } //01 00 
		$a_01_5 = {2e 43 6c 6f 73 65 } //00 00 
	condition:
		any of ($a_*)
