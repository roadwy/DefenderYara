...
rule TrojanDownloader_O97M_Obfuse_MN_MTB{
	...
	strings :
		$a_03_0 = {43 72 65 61 74 65 4f 62 6a 65 63 74 28 90 02 0a 28 22 20 61 57 20 61 53 63 20 61 72 69 20 61 70 74 20 61 22 20 26 20 22 20 61 2e 53 68 20 61 65 6c 20 61 6c 22 29 29 90 00 } //1
		...
		$a_03_3 = {4d 65 2e 4e 61 6d 65 20 26 20 90 02 0a 20 26 20 22 2e 74 78 74 74 78 74 74 78 74 2e 22 90 00 } //1
	condition:
