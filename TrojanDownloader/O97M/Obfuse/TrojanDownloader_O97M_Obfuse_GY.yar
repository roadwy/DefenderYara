...
rule TrojanDownloader_O97M_Obfuse_GY{
	...
	strings :
		$a_03_0 = {53 65 74 20 [0-05] 20 3d 20 [0-06] 2e 41 63 74 69 76 65 44 6f 63 75 6d 65 6e 74 } //1
		$a_03_1 = {3d 20 52 69 67 68 74 28 [0-08] 2c 20 4c 65 6e 28 [0-08] 29 20 2d 20 31 29 } //1
