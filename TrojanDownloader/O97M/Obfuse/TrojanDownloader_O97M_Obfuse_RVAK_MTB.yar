...
rule TrojanDownloader_O97M_Obfuse_RVAK_MTB{
	...
	strings :
		...
		$a_03_1 = {45 78 63 65 6c 20 68 6f 70 90 01 04 20 26 20 22 2e 2e 2e 68 54 61 22 90 00 } //1
		$a_03_2 = {4e 65 77 20 57 73 68 53 68 65 6c 6c 0d 0a 65 78 63 65 6c 90 02 0a 2e 72 75 6e 20 72 61 70 90 02 0a 0d 0a 45 6e 64 20 53 75 62 90 00 } //1
		$a_03_3 = {53 75 62 20 64 6f 63 75 6d 65 6e 74 5f 6f 70 65 6e 28 29 0d 0a 43 61 6c 6c 20 73 28 22 90 02 14 22 29 0d 0a 45 6e 64 20 53 75 62 90 00 } //1
	condition:
