...
rule TrojanDownloader_O97M_Obfuse_IR_MTB{
	...
	strings :
		$a_03_0 = {43 61 6c 6c 20 [0-10] 28 65 6e 76 69 72 6f 6e 28 22 74 65 6d 70 22 29 20 26 20 22 5c [0-09] 2e 78 73 6c 22 2c 20 [0-10] 28 [0-10] 28 31 29 29 29 } //1
		$a_03_1 = {26 20 43 68 72 24 28 56 61 6c 28 22 26 48 22 20 26 20 4d 69 64 24 28 [0-10] 2c 20 [0-10] 2c 20 32 29 29 29 } //1
