...
rule TrojanDownloader_O97M_Obfuse_ZM_MTB{
	...
	strings :
		...
		$a_03_1 = {3d 20 53 74 72 52 65 76 65 72 73 65 28 22 61 74 68 2e [0-1e] 5c 61 74 61 64 6d 61 72 67 6f 72 70 5c 3a 63 20 65 78 65 2e 72 65 72 6f 6c 70 78 65 5c 73 77 6f 64 6e 69 77 5c 3a 63 22 29 } //1
		...
		$a_03_4 = {2e 43 72 65 61 74 65 20 70 28 [0-05] 29 } //1
		$a_03_5 = {3d 20 53 70 6c 69 74 28 70 28 66 72 6d 2e [0-05] 29 2c 20 22 20 22 29 } //1
	condition:
