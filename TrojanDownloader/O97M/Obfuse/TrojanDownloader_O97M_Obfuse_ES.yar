...
rule TrojanDownloader_O97M_Obfuse_ES{
	...
	strings :
		...
		$a_03_1 = {53 68 65 6c 6c 90 02 01 20 5f 90 00 } //1
		$a_03_2 = {49 6e 6c 69 6e 65 53 68 61 70 65 73 28 90 02 10 29 2e 41 6c 74 65 72 6e 61 74 69 76 65 54 65 78 74 2c 20 5f 90 00 } //1
	condition:
