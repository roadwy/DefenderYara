...
rule TrojanDownloader_O97M_Obfuse_IH_MTB{
	...
	strings :
		$a_03_0 = {3d 20 43 68 72 24 28 56 61 6c 28 22 26 48 22 20 26 20 4d 69 64 24 28 [0-09] 2c 20 [0-09] 2c 20 32 29 29 29 } //1
		$a_03_1 = {3d 20 31 20 54 6f 20 4c 65 6e 28 [0-09] 29 20 53 74 65 70 20 32 } //1
		$a_03_2 = {43 61 6c 6c 20 [0-09] 28 [0-09] 2e 78 73 6c 22 2c 20 [0-09] 28 [0-09] 2e [0-09] 2e 54 65 78 74 29 29 } //1
