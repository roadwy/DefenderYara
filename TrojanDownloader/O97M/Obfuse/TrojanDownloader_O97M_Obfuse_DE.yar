...
rule TrojanDownloader_O97M_Obfuse_DE{
	...
	strings :
		...
		$a_02_2 = {47 65 74 4f 62 6a 65 63 74 28 22 77 69 6e 6d 67 6d 74 73 3a 57 69 6e 33 32 5f 50 72 6f 63 65 73 73 22 20 2b 20 90 02 30 29 2e 43 72 65 61 74 65 20 90 02 50 2c 20 4e 75 6c 6c 2c 20 90 00 } //1
	condition:
