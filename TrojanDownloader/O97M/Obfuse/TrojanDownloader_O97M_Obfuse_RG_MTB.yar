...
rule TrojanDownloader_O97M_Obfuse_RG_MTB_2{
	...
	strings :
		...
		$a_03_2 = {2e 56 61 6c 75 65 20 3d 20 57 53 2e 43 65 6c 6c 73 28 90 02 10 29 2e 56 61 6c 75 65 90 00 } //1
		$a_03_3 = {57 6f 72 6b 62 6f 6f 6b 73 28 22 90 02 08 2e 78 6c 73 22 29 2e 43 6c 6f 73 65 90 00 } //1
