...
rule TrojanDownloader_O97M_Obfuse_AD_MSR{
	...
	strings :
		...
		$a_03_1 = {44 69 6d 20 [0-09] 20 41 73 20 53 74 72 69 6e 67 } //1
		...
		$a_03_4 = {53 68 65 6c 6c 20 28 [0-06] 29 } //1
	condition:
...
rule TrojanDownloader_O97M_Obfuse_AD_MSR_2{
	...
	strings :
		$a_02_0 = {56 42 41 2e 43 72 65 61 74 65 4f 62 6a 65 63 74 28 22 [0-15] 22 29 2e 43 72 65 61 74 65 45 6c 65 6d 65 6e 74 28 22 [0-15] 22 29 } //1
		$a_02_1 = {4b 69 6c 6c 20 28 45 6e 76 69 72 6f 6e 28 22 54 45 4d 50 22 29 20 26 20 22 5c [0-10] 2e 65 78 65 } //1
		...
		$a_02_3 = {50 72 6f 63 65 73 73 2e 43 72 65 61 74 65 28 45 6e 76 69 72 6f 6e 28 22 54 45 4d 50 22 29 20 26 20 22 5c [0-10] 2e 65 78 65 22 2c 20 4e 75 6c 6c 2c 20 4e 75 6c 6c } //1
	condition:
