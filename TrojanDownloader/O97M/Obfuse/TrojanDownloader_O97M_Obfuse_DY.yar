...
rule TrojanDownloader_O97M_Obfuse_DY{
	...
	strings :
		...
		$a_01_3 = {3d 20 47 65 74 4f 62 6a 65 63 74 28 22 77 69 6e 6d 67 6d 74 73 3a 57 69 6e 33 32 5f 50 72 6f 63 65 73 73 22 29 } //00 00  = GetObject("winmgmts:Win32_Process")
	condition:
		any of ($a_*)
