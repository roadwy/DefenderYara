...
rule TrojanDownloader_O97M_Obfuse_KRN_MTB{
	...
	strings :
		...
		$a_01_3 = {26 20 22 22 20 3d 20 22 22 20 54 68 65 6e 20 45 78 69 74 20 46 75 6e 63 74 69 6f 6e } //01 00 
		$a_01_4 = {3d 20 43 68 72 28 35 30 29 20 2b 20 43 68 72 28 34 38 29 20 2b 20 43 68 72 28 34 38 29 } //00 00 
	condition:
		any of ($a_*)
