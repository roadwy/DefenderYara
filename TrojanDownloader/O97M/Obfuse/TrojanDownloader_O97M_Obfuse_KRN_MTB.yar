...
rule TrojanDownloader_O97M_Obfuse_KRN_MTB{
	...
	strings :
		$a_03_0 = {2e 4f 70 65 6e 20 22 67 65 74 22 2c 20 90 02 15 28 22 71 90 02 64 6e 22 29 2c 20 46 61 6c 73 65 90 00 } //1
		$a_03_1 = {2e 53 61 76 65 54 6f 46 69 6c 65 20 90 02 0c 2c 20 90 02 0c 20 2b 20 90 00 } //1
		$a_03_2 = {4d 73 67 42 6f 78 20 22 90 02 15 22 90 00 } //1
