...
rule TrojanDownloader_O97M_Obfuse_RW_MTB{
	...
	strings :
		...
		$a_03_5 = {72 65 76 65 72 73 65 64 54 65 78 74 20 3d 20 72 65 76 65 72 73 65 64 54 65 78 74 20 26 20 4d 69 64 28 74 65 78 74 2c 20 28 6c 65 6e 67 74 68 20 2d 20 69 29 2c 20 31 29 [0-20] 4e 65 78 74 20 69 } //1
	condition:
