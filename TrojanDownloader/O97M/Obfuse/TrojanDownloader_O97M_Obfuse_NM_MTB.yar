...
rule TrojanDownloader_O97M_Obfuse_NM_MTB{
	...
	strings :
		...
		$a_03_1 = {53 65 74 20 90 02 10 20 3d 20 43 72 65 61 74 65 4f 62 6a 65 63 74 28 22 57 53 63 72 69 70 74 2e 53 68 65 6c 6c 22 29 90 00 } //1
		$a_01_2 = {3d 20 22 22 } //1 = ""
		$a_03_3 = {43 68 72 28 90 02 08 2f 90 00 } //1
