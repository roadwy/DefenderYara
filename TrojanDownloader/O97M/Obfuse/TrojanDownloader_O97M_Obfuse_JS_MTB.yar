...
rule TrojanDownloader_O97M_Obfuse_JS_MTB{
	...
	strings :
		$a_01_0 = {68 74 74 70 3a 2f 2f 25 32 30 25 32 30 40 6a 2e 6d 70 2f 61 73 64 61 78 61 73 64 61 73 78 61 73 64 61 73 64 73 64 64 6f 64 6b 61 73 6f 64 6b 61 6f 73 } //00 00  http://%20%20@j.mp/asdaxasdasxasdasdsddodkasodkaos
	condition:
		any of ($a_*)
...
rule TrojanDownloader_O97M_Obfuse_JS_MTB_2{
	...
	strings :
		...
		$a_00_3 = {68 74 74 70 3a 2f 2f 39 33 2e 31 31 35 2e 31 39 2e 32 32 36 2f 65 76 6c 2e 65 78 65 } //00 00  http://93.115.19.226/evl.exe
	condition:
		any of ($a_*)
...
rule TrojanDownloader_O97M_Obfuse_JS_MTB_3{
	...
	strings :
		...
		$a_01_2 = {2e 47 65 74 28 53 52 65 76 65 72 73 65 4d 6f 64 28 48 65 78 32 53 74 72 28 22 } //01 00  .Get(SReverseMod(Hex2Str("
		$a_01_3 = {26 20 53 74 72 52 65 76 65 72 73 65 28 4d 69 64 28 54 65 78 74 2c } //01 00  & StrReverse(Mid(Text,
		$a_01_4 = {3d 20 31 20 54 6f 20 4c 65 6e 28 73 74 72 44 61 74 61 29 20 53 74 65 70 20 32 } //00 00  = 1 To Len(strData) Step 2
	condition:
		any of ($a_*)
...
rule TrojanDownloader_O97M_Obfuse_JS_MTB_4{
	...
	strings :
		$a_01_0 = {3d 20 22 63 6d 64 20 2f 63 22 } //01 00  = "cmd /c"
		$a_01_1 = {22 44 6f 77 6e 6c 6f 61 64 46 69 6c 65 22 } //01 00  "DownloadFile"
		...
		$a_01_4 = {47 65 74 28 22 57 69 6e 33 32 5f 50 72 6f 63 65 73 73 53 74 61 72 74 75 70 22 29 } //01 00  Get("Win32_ProcessStartup")
		$a_01_5 = {3d 20 47 65 74 4f 62 6a 65 63 74 28 22 77 69 6e 6d 67 6d 74 73 3a 72 6f 6f 74 5c 63 69 6d 76 32 3a 57 69 6e 33 32 5f 50 72 6f 63 65 73 73 22 29 } //01 00  = GetObject("winmgmts:root\cimv2:Win32_Process")
		$a_01_6 = {6f 62 6a 2e 44 6f 63 75 6d 65 6e 74 2e 41 70 70 6c 69 63 61 74 69 6f 6e 2e 53 68 65 6c 6c 45 78 65 63 75 74 65 20 22 63 6d 64 2e 65 78 65 20 22 2c 20 22 2f 63 20 22 } //00 00  obj.Document.Application.ShellExecute "cmd.exe ", "/c "
	condition:
		any of ($a_*)
