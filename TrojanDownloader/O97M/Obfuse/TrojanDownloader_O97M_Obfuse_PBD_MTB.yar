...
rule TrojanDownloader_O97M_Obfuse_PBD_MTB{
	...
	strings :
		...
		$a_03_2 = {73 65 72 76 69 63 65 2e 43 72 65 61 74 65 4f 62 6a 65 63 74 28 22 57 73 63 22 20 26 20 22 72 69 70 74 2e 53 68 [0-10] 65 6c 6c 22 2c 20 22 22 29 2e 52 75 6e 20 [0-10] 2c 20 30 } //1
		$a_03_3 = {3d 20 52 65 70 6c 61 63 65 28 [0-10] 2c 20 22 43 65 77 22 2c 20 22 22 29 } //1
	condition:
