...
rule TrojanDownloader_O97M_Obfuse_DV{
	...
	strings :
		...
		$a_03_2 = {2e 43 72 65 61 74 65 20 50 76 53 28 22 90 02 10 22 29 20 26 20 90 02 10 2c 20 4e 75 6c 6c 2c 20 6f 62 6a 43 6f 6e 66 69 67 2c 20 69 6e 74 50 72 6f 63 65 73 73 49 44 90 00 } //1
	condition:
