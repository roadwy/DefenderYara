...
rule TrojanDownloader_O97M_Obfuse_APD_MTB{
	meta:
		description = "TrojanDownloader:O97M/Obfuse.APD!MTB,SIGNATURE_TYPE_MACROHSTR_EXT,03 00 03 00 03 00 00 01 00 "
	...
	strings :
		...
		$a_03_2 = {3d 73 70 65 63 69 61 6c 70 61 74 68 2b 28 22 90 02 0a 2e 22 29 2e 6f 70 65 6e 22 67 65 74 22 2c 28 22 68 3a 2f 2f 6a 2d 68 6c 67 2e 6d 2f 62 2f 6d 62 6c 68 64 6c 2e 90 00 } //00 00 
	condition:
		any of ($a_*)
