...
rule TrojanDownloader_O97M_Obfuse_RVG_MTB{
	...
	strings :
		...
		$a_02_1 = {2e 72 75 6e 20 90 02 06 20 26 20 61 52 6c 4d 79 78 28 22 63 6f 6d 6d 65 6e 74 73 22 29 20 26 20 61 6d 45 32 61 6b 20 26 20 90 02 06 20 26 20 61 6d 45 32 61 6b 90 00 } //1
		$a_02_2 = {4f 70 65 6e 20 90 02 06 20 46 6f 72 20 4f 75 74 70 75 74 20 41 73 20 23 31 90 00 } //1
		$a_02_3 = {2e 42 75 69 6c 74 49 6e 44 6f 63 75 6d 65 6e 74 50 72 6f 70 65 72 74 69 65 73 28 90 02 06 29 90 00 } //1
