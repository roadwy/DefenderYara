...
rule TrojanDownloader_O97M_Obfuse_JAL_MTB{
	...
	strings :
		$a_03_0 = {68 74 74 70 3a 2f 2f 37 39 2e 31 34 31 2e 31 36 35 2e 31 37 33 2f 44 58 2f 46 44 2d [0-06] 2e 6a 70 67 } //2
		$a_03_1 = {53 74 61 72 74 2d 50 72 6f 63 65 73 73 20 2d 46 69 6c 65 50 61 74 68 20 22 43 3a 5c 55 73 65 72 73 5c 50 75 62 6c 69 63 5c [0-0f] 2e 65 78 65 } //2
