...
rule TrojanDownloader_O97M_Obfuse_TRV_MTB{
	...
	strings :
		$a_03_0 = {53 68 65 6c 6c 20 22 65 78 70 6c 6f 72 65 72 20 90 02 0f 2e 68 74 61 22 2c 20 76 62 4e 6f 72 6d 61 6c 46 6f 63 75 73 90 00 } //1
		$a_03_1 = {4f 70 65 6e 20 22 90 02 0f 2e 68 74 61 22 20 26 20 62 75 74 74 6f 6e 52 65 66 65 72 65 6e 63 65 20 46 6f 72 20 4f 75 74 70 75 74 20 41 73 20 23 90 00 } //1
...
rule TrojanDownloader_O97M_Obfuse_TRV_MTB_2{
	...
	strings :
		...
		$a_03_1 = {57 73 68 53 68 65 6c 6c 2e 52 75 6e 20 22 22 22 22 22 22 25 55 73 65 72 50 72 6f 66 69 6c 65 25 5c 90 02 0a 2e 65 78 65 22 22 22 22 20 2d 64 90 00 } //1
		$a_03_2 = {6d 79 46 69 6c 65 20 3d 20 75 73 65 72 50 72 6f 66 69 6c 65 50 61 74 68 20 2b 20 22 5c 6c 61 79 6f 66 66 73 90 02 02 2e 76 62 73 22 90 00 } //1
