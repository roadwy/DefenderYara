...
rule TrojanDownloader_O97M_Obfuse_KV_MTB{
	...
	strings :
		...
		$a_01_3 = {3d 20 55 73 65 72 46 6f 72 6d 31 2e 54 65 78 74 42 6f 78 33 2e 54 65 78 74 } //01 00 
		$a_01_4 = {4d 73 67 42 6f 78 20 22 4e 75 6d 62 65 72 20 74 6f 6f 20 6c 61 72 67 65 22 2c 20 76 62 4f 4b 4f 6e 6c 79 } //01 00 
		$a_01_5 = {2e 43 72 65 61 74 65 54 65 78 74 46 69 6c 65 28 66 69 6c 65 32 73 61 76 72 73 61 76 65 2c 20 54 72 75 65 2c 20 54 72 75 65 29 } //00 00 
	condition:
		any of ($a_*)
