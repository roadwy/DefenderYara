...
rule TrojanDownloader_O97M_Obfuse_ARY_MTB{
	...
	strings :
		...
		$a_03_1 = {3d 20 57 65 65 6b 64 61 79 28 90 02 16 29 90 00 } //1
		$a_03_2 = {3d 20 53 70 6c 69 74 28 90 02 10 2c 20 90 02 10 2c 20 90 02 10 29 90 00 } //1
		$a_01_3 = {3d 20 49 73 44 61 74 65 28 43 4c 6e 67 28 28 } //1 = IsDate(CLng((
		$a_01_4 = {44 65 62 75 67 2e 50 72 69 6e 74 } //1 Debug.Print
		$a_03_5 = {3d 20 52 65 70 6c 61 63 65 28 90 02 18 2c 20 90 02 18 2c 20 90 02 18 29 90 00 } //1
	condition:
