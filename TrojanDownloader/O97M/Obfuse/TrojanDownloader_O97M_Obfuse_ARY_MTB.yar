...
rule TrojanDownloader_O97M_Obfuse_ARY_MTB{
	...
	strings :
		$a_01_0 = {3d 20 4a 6f 69 6e 28 41 72 72 61 79 28 43 68 72 28 43 4c 6e 67 28 28 } //01 00 
		...
		$a_01_3 = {3d 20 49 73 44 61 74 65 28 43 4c 6e 67 28 28 } //01 00 
		$a_01_4 = {44 65 62 75 67 2e 50 72 69 6e 74 } //01 00 
