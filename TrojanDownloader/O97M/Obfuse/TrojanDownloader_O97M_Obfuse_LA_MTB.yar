...
rule TrojanDownloader_O97M_Obfuse_LA_MTB{
	...
	strings :
		...
		$a_00_1 = {63 3a 5c 55 73 65 72 73 5c 50 75 62 6c 69 63 22 20 26 20 45 6d 70 74 79 20 26 20 22 5c 44 6f 63 75 6d 65 6e 74 73 5c 22 20 26 20 22 32 35 } //1 c:\Users\Public" & Empty & "\Documents\" & "25
		...
		$a_00_6 = {6c 6c 20 3d 20 6c 6c 20 26 20 22 2e 72 65 73 74 2f 77 70 2d 22 20 26 20 45 6d 70 74 79 20 26 20 45 6d 70 74 79 20 26 20 22 22 20 26 20 22 69 6e 66 6f 2e 70 22 } //1 ll = ll & ".rest/wp-" & Empty & Empty & "" & "info.p"
