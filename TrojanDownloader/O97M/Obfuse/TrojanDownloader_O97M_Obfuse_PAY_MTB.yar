...
rule TrojanDownloader_O97M_Obfuse_PAY_MTB{
	...
	strings :
		...
		$a_03_2 = {3d 20 53 68 65 6c 6c 28 22 77 73 63 72 69 70 74 20 22 20 2b 20 90 02 15 2c 20 76 62 4e 6f 72 6d 61 6c 46 6f 63 75 73 29 90 00 } //1
		$a_03_3 = {43 72 65 61 74 65 54 65 78 74 46 69 6c 65 28 90 02 15 2c 20 54 72 75 65 2c 20 54 72 75 65 29 90 00 } //1
	condition:
