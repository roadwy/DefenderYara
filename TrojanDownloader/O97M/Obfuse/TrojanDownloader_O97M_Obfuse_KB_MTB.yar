...
rule TrojanDownloader_O97M_Obfuse_KB_MTB{
	...
	strings :
		...
		$a_01_2 = {2e 43 6f 6e 74 72 6f 6c 73 } //01 00 
		$a_03_3 = {4f 70 65 6e 20 90 02 24 20 46 6f 72 20 4f 75 74 70 75 74 20 41 73 20 23 90 00 } //01 00 
		$a_01_4 = {2e 43 61 70 74 69 6f 6e } //01 00 
		$a_01_5 = {3d 20 22 6e 65 77 3a 31 33 37 30 39 36 32 30 2d 43 32 37 39 2d 31 31 43 45 2d 41 34 39 45 2d 34 34 34 35 35 33 35 34 30 30 30 30 22 } //00 00 
	condition:
		any of ($a_*)
