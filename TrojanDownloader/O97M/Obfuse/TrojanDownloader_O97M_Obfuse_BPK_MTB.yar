...
rule TrojanDownloader_O97M_Obfuse_BPK_MTB_3{
	...
	strings :
		$a_03_0 = {3d 20 22 20 68 74 74 70 3a 2f 2f 31 32 33 30 39 34 38 25 31 32 33 30 39 34 38 40 6a 2e 6d 70 2f [0-28] 22 } //1
...
rule TrojanDownloader_O97M_Obfuse_BPK_MTB_5{
	...
	strings :
		$a_03_0 = {3d 20 67 67 67 20 2b 20 6c 75 6c 75 6c 75 20 2b 20 74 69 74 69 74 69 20 2b 20 22 74 61 20 68 74 74 70 3a 2f 2f 25 32 30 25 32 30 40 6a 2e 6d 70 2f [0-1e] 22 } //1
...
rule TrojanDownloader_O97M_Obfuse_BPK_MTB_10{
	...
	strings :
		...
		$a_03_2 = {3d 20 22 61 22 20 2b 20 22 73 22 20 2b 20 22 64 22 20 2b 20 22 69 22 20 2b 20 22 6d 22 20 2b 20 22 61 22 20 2b 20 22 77 22 20 2b 20 22 78 22 20 2b 20 22 [0-1e] 22 } //1
	condition:
...
rule TrojanDownloader_O97M_Obfuse_BPK_MTB_25{
	...
	strings :
		$a_03_0 = {3d 20 52 65 70 6c 61 63 65 28 22 [0-0c] 22 2c 20 22 [0-0c] 22 2c 20 22 6c 79 2f 22 29 } //1
...
rule TrojanDownloader_O97M_Obfuse_BPK_MTB_29{
	...
	strings :
		$a_03_0 = {6f 62 6a 2e 20 5f 90 0c 02 00 4d 61 69 6e 43 61 6c 6c 65 78 2e 20 5f 90 0c 02 00 52 75 6e 20 5f 90 0c 02 00 64 64 2c 20 30 } //1
		$a_03_1 = {44 69 6d 20 6f 62 6a 20 41 73 20 4e 65 77 20 43 6c 61 73 73 32 90 0c 02 00 20 20 20 20 6f 62 6a 2e 20 5f 90 0c 02 00 20 20 20 20 47 65 74 4d 6f 72 65 4d 6f 64 75 6c 65 20 28 64 64 31 20 2b 20 64 64 32 20 2b 20 64 64 33 29 } //1
...
rule TrojanDownloader_O97M_Obfuse_BPK_MTB_35{
	...
	strings :
		...
		$a_03_2 = {26 20 22 70 73 3a 2f 2f 25 36 39 25 36 39 25 36 39 25 36 39 25 36 39 25 36 39 25 22 20 26 20 22 36 39 25 36 39 25 36 39 25 36 39 25 36 39 25 36 39 25 36 22 20 26 20 22 39 25 36 39 25 36 39 25 36 39 25 36 39 25 36 39 25 36 39 25 36 39 22 20 26 20 [0-08] 20 2b 20 [0-08] 20 2b 20 53 74 72 69 6e 67 28 31 2c 20 22 2f 22 29 20 26 } //1
	condition:
		((#a_01_0  & 1)*1+(#a_01_1  & 1)*1+(#a_03_2  & 1)*1) >=3
...
rule TrojanDownloader_O97M_Obfuse_BPK_MTB_38{
	...
	strings :
		...
		$a_03_2 = {4d 5f 53 4f 69 4d 20 3d 20 [0-08] 47 4b 4a 48 67 6b 68 67 4b 48 4a 47 6b 4f 69 4d [0-0b] 20 2b 20 [0-08] 47 4b 4a 48 67 6b 68 67 4b 48 4a 47 6b 4f 69 4d 5f 31 [0-08] 20 2b 20 [0-08] 47 4b 4a 48 67 6b 68 67 4b 48 4a 47 6b 4f 69 4d 5f 32 [0-0c] 20 2b 20 [0-08] 47 4b 4a 48 67 6b 68 67 4b 48 4a 47 6b 4f 69 4d 5f 33 } //1
		$a_03_3 = {53 68 65 6c 6c 20 28 [0-08] 4d 5f 53 4f 69 4d 29 } //1
	condition:
