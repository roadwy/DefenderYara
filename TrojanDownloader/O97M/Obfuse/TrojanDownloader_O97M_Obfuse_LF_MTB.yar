...
rule TrojanDownloader_O97M_Obfuse_LF_MTB{
	...
	strings :
		...
		$a_03_4 = {26 20 43 68 72 28 90 02 15 20 26 20 4d 69 64 24 28 90 00 } //1
		$a_01_5 = {44 65 62 75 67 2e 50 72 69 6e 74 20 45 72 72 6f 72 28 } //1 Debug.Print Error(
		$a_03_6 = {4f 70 65 6e 20 90 02 15 20 46 6f 72 20 4f 75 74 70 75 74 20 41 73 20 23 90 00 } //1
	condition:
