...
rule TrojanDownloader_O97M_Obfuse_JG_MTB{
	...
	strings :
		$a_03_0 = {68 74 74 70 3a 2f 2f 77 6e 72 66 61 39 79 2e 63 6f 6d 2f 69 7a 35 2f [0-0a] 2e 70 68 70 3f 6c 3d [0-0a] 2e 63 61 62 22 2c 20 22 [0-0a] 2e 65 78 70 22 2c 20 30 2c 20 30 29 } //1
		$a_03_1 = {72 65 67 73 76 72 33 32 20 [0-0a] 2e 65 78 70 22 } //1
	condition:
...
rule TrojanDownloader_O97M_Obfuse_JG_MTB_2{
	...
	strings :
		...
		$a_03_4 = {44 69 6d 20 [0-09] 28 30 20 54 6f 20 32 35 35 29 20 41 73 20 49 6e 74 65 67 65 72 2c 20 73 65 63 6f 6e 64 20 41 73 20 49 6e 74 65 67 65 72 2c 20 74 68 69 72 64 20 41 73 20 4c 6f 6e 67 2c 20 66 6f 75 72 74 68 28 29 20 41 73 20 42 79 74 65 } //1
		$a_03_5 = {74 68 69 72 64 20 3d 20 28 74 68 69 72 64 20 2b 20 [0-09] 28 74 68 69 72 64 29 20 2b 20 31 29 20 4d 6f 64 20 32 35 36 } //1
