...
rule TrojanDownloader_O97M_Obfuse_QT_MTB{
	...
	strings :
		$a_03_0 = {2b 20 53 67 6e 28 49 6e 53 74 72 28 31 2c 20 90 02 25 2c 20 4d 69 64 28 90 02 20 2c 20 31 29 2c 20 76 62 42 69 6e 61 72 79 43 6f 6d 70 61 72 65 29 29 90 00 } //1
