...
rule TrojanDownloader_O97M_Obfuse_DPD_MTB{
	...
	strings :
		...
		$a_03_1 = {3d 6f 62 6a 77 73 68 73 68 65 6c 6c 2e 73 70 65 63 69 61 6c 66 6f 6c 64 65 72 73 28 22 [0-0f] 22 29 64 69 6d } //1
		$a_03_2 = {3d 67 65 74 75 73 65 72 64 65 73 6b 74 6f 70 2b [0-0f] 28 22 [0-0f] 6e 6e 22 29 [0-c8] 2e 6f 70 65 6e 22 67 65 74 22 2c 90 1b 00 28 } //1
		$a_03_3 = {26 63 68 72 28 61 73 63 28 6d 69 64 28 [0-c8] 2c [0-c8] 2c 31 29 29 2d 31 33 29 6e 65 78 74 } //1
	condition:
