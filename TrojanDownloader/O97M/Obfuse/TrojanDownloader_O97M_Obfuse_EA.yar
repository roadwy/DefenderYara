...
rule TrojanDownloader_O97M_Obfuse_EA{
	...
	strings :
		...
		$a_03_1 = {2e 43 72 65 61 74 65 90 01 01 28 90 02 14 2c 20 4e 75 6c 6c 2c 20 90 02 14 2c 20 90 02 14 29 90 00 } //1
		$a_03_2 = {3d 20 47 65 74 4f 62 6a 65 63 74 28 90 02 14 20 2b 20 22 3a 57 69 6e 33 32 5f 50 72 6f 63 65 73 73 22 29 90 00 } //1
	condition:
