...
rule TrojanDownloader_O97M_Obfuse_IJ_MTB{
	...
	strings :
		...
		$a_03_1 = {2b 20 22 5c 22 20 2b 20 90 02 24 20 46 6f 72 20 4f 75 74 70 75 74 20 41 73 20 23 90 00 } //1
		$a_01_2 = {3d 20 45 6e 76 69 72 6f 6e 28 22 77 69 6e 64 69 72 22 29 20 2b 20 22 5c 54 65 6d 70 22 } //1 = Environ("windir") + "\Temp"
		$a_03_3 = {43 72 65 61 74 65 4f 62 6a 65 63 74 28 22 53 68 65 6c 6c 2e 41 70 70 6c 69 63 61 74 69 6f 6e 22 29 2e 4f 70 65 6e 20 28 90 02 30 20 2b 20 22 5c 22 20 2b 90 00 } //1
...
rule TrojanDownloader_O97M_Obfuse_IJ_MTB_2{
	...
	strings :
		...
		$a_02_4 = {55 73 65 64 52 61 6e 67 65 2e 52 6f 77 73 2e 43 6f 75 6e 74 90 02 09 73 68 65 65 74 90 02 0f 72 6f 77 90 00 } //1
	condition:
