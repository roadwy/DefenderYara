...
rule TrojanDownloader_O97M_Obfuse_PRW_MTB{
	...
	strings :
		...
		$a_03_2 = {47 65 74 4f 62 6a 65 63 74 20 5f 90 0c 02 00 28 53 74 72 52 65 76 65 72 73 65 20 5f 90 0c 02 00 28 22 30 30 30 30 34 35 33 35 35 34 34 34 2d 45 39 34 41 2d 45 43 31 31 2d 39 37 32 43 2d 30 32 36 39 30 37 33 31 3a 77 65 6e 22 29 20 5f } //1
	condition:
