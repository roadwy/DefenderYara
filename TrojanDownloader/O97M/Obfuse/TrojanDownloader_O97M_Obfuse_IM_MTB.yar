...
rule TrojanDownloader_O97M_Obfuse_IM_MTB{
	...
	strings :
		...
		$a_03_3 = {4f 70 65 6e 20 90 02 15 20 46 6f 72 20 4f 75 74 70 75 74 20 41 73 20 23 90 00 } //1
		...
		$a_03_5 = {2e 43 72 65 61 74 65 54 65 78 74 46 69 6c 65 28 90 02 15 2c 20 54 72 75 65 29 90 00 } //1
