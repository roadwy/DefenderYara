...
rule TrojanDownloader_O97M_Obfuse_DO{
	...
	strings :
		...
		$a_03_1 = {3d 20 53 68 65 6c 6c 28 [0-10] 2c 20 30 29 } //1
		$a_03_2 = {3d 20 52 6f 75 6e 64 28 [0-08] 2e [0-10] 29 } //1
		$a_03_3 = {3d 20 53 67 6e 28 [0-04] 29 } //1
...
rule TrojanDownloader_O97M_Obfuse_DO_2{
	...
	strings :
		$a_01_0 = {50 75 62 6c 69 63 20 53 75 62 20 7a 28 29 } //1 Public Sub z()
		$a_03_1 = {3d 20 53 68 65 6c 6c 28 [0-10] 2c 20 30 29 } //1
		$a_03_2 = {53 74 72 52 65 76 65 72 73 65 28 [0-08] 2e 6d 79 6e 65 77 74 78 74 2e 54 65 78 74 29 } //1
		$a_03_3 = {3d 20 56 61 6c 28 [0-08] 2e [0-10] 29 } //1
		$a_01_4 = {43 61 6c 6c 20 7a } //1 Call z
	condition:
		((#a_01_0  & 1)*1+(#a_03_1  & 1)*1+(#a_03_2  & 1)*1+(#a_03_3  & 1)*1+(#a_01_4  & 1)*1) >=5
