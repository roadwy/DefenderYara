...
rule TrojanDownloader_O97M_Obfuse_NC_MTB{
	...
	strings :
		...
		$a_03_1 = {2e 57 72 69 74 65 4c 69 6e 65 20 28 [0-14] 2e 43 6f 6e 74 72 6f 6c 73 28 30 29 2e 43 61 70 74 69 6f 6e 29 } //1
		$a_03_2 = {2e 4f 70 65 6e 20 [0-25] 2e 56 61 6c 75 65 } //1
