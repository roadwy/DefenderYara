...
rule TrojanDownloader_O97M_Obfuse_NC_MTB{
	meta:
		description = "TrojanDownloader:O97M/Obfuse.NC!MTB,SIGNATURE_TYPE_MACROHSTR_EXT,06 00 06 00 06 00 00 01 00 "
	...
	strings :
		...
		$a_03_2 = {2e 4f 70 65 6e 20 90 02 25 2e 56 61 6c 75 65 90 00 } //01 00 
