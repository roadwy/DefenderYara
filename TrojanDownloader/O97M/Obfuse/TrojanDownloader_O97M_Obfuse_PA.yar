...
rule TrojanDownloader_O97M_Obfuse_PA{
	...
	strings :
		$a_02_0 = {41 72 72 61 79 28 [0-10] 2c 20 [0-10] 2c 20 [0-10] 2c 20 49 6e 74 65 72 61 63 74 69 6f 6e 2e 53 68 65 6c 6c 28 [0-10] 28 [0-10] 2e 54 65 78 74 42 6f 78 31 29 } //1
	condition:
		((#a_02_0  & 1)*1) >=1
...
rule TrojanDownloader_O97M_Obfuse_PA_2{
	...
	strings :
		...
		$a_02_3 = {53 65 74 20 [0-20] 20 3d 20 43 72 65 61 74 65 4f 62 6a 65 63 74 28 [0-20] 29 } //2
		$a_02_4 = {2e 52 75 6e 20 [0-10] 2c 20 } //2
		$a_02_5 = {24 70 61 74 68 [0-01] 27 3b 24 [0-10] 22 } //2
		$a_02_6 = {20 2d 53 63 6f 70 65 [0-20] 22 } //2
	condition:
