...
rule TrojanDownloader_O97M_Obfuse_IW_MTB{
	meta:
		description = "TrojanDownloader:O97M/Obfuse.IW!MTB,SIGNATURE_TYPE_MACROHSTR_EXT,06 00 06 00 06 00 00 01 00 "
		
	strings :
		$a_01_0 = {3d 20 22 78 73 6c 22 } //01 00  = "xsl"
		$a_03_1 = {43 61 6c 6c 20 90 02 09 28 90 02 08 28 22 74 65 6d 70 22 29 20 26 20 22 5c 90 00 } //01 00 
