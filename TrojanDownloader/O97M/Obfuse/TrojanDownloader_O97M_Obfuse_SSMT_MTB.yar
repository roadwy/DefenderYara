...
rule TrojanDownloader_O97M_Obfuse_SSMT_MTB{
	...
	strings :
		$a_01_0 = {6d 79 46 69 6c 65 20 3d 20 22 43 3a 5c 55 73 65 72 73 5c 50 75 62 6c 69 63 5c 75 70 64 61 74 65 2e 6a 73 } //01 00 
		...
		$a_01_2 = {3d 20 57 6f 72 6b 73 68 65 65 74 73 28 22 73 68 69 74 22 29 2e 52 61 6e 67 65 28 22 4b 33 33 35 22 29 } //00 00 
	condition:
		any of ($a_*)
