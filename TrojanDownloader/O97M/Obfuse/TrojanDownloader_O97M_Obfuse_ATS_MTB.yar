...
rule TrojanDownloader_O97M_Obfuse_ATS_MTB{
	...
	strings :
		...
		$a_03_3 = {53 68 65 6c 6c 20 90 02 06 20 26 20 22 20 22 20 26 20 90 02 08 45 6e 64 20 53 75 62 90 00 } //1
		$a_01_4 = {28 22 6b 65 79 77 6f 72 64 73 22 29 29 } //1 ("keywords"))
		$a_03_5 = {3d 20 56 42 41 2e 43 68 72 28 90 02 06 29 90 0c 02 00 45 6e 64 20 46 75 6e 63 74 69 6f 6e 90 0c 02 00 46 75 6e 63 74 69 6f 6e 20 90 02 06 28 90 02 06 29 20 41 73 20 53 74 72 69 6e 67 90 00 } //1
		$a_03_6 = {3d 20 52 65 70 6c 61 63 65 28 90 02 06 2c 20 90 02 06 2c 20 22 22 29 90 00 } //1
	condition:
