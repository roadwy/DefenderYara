...
rule TrojanDownloader_O97M_Obfuse_RVAE_MTB{
	...
	strings :
		...
		$a_03_1 = {49 6e 53 74 72 28 90 02 64 2c 20 4d 69 64 28 90 02 64 2c 20 69 2c 20 31 29 29 90 00 } //1
		...
		$a_03_3 = {2e 4f 70 65 6e 20 22 67 65 74 22 2c 20 90 02 64 28 22 90 02 64 22 29 2c 20 46 61 6c 73 65 90 00 } //1
	condition:
