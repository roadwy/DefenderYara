...
rule TrojanDownloader_O97M_Obfuse_RZ_MTB{
	...
	strings :
		$a_03_0 = {26 20 43 68 72 28 43 49 6e 74 28 41 63 74 69 76 65 44 6f 63 75 6d 65 6e 74 2e 56 61 72 69 61 62 6c 65 73 28 22 [0-18] 22 29 2e 56 61 6c 75 65 20 26 20 [0-18] 29 20 2d 20 [0-02] 29 } //1
...
rule TrojanDownloader_O97M_Obfuse_RZ_MTB_2{
	...
	strings :
		$a_03_0 = {63 2e 74 6f 70 34 74 6f 70 2e 69 6f 2f 70 5f 31 36 38 33 71 31 78 73 68 31 2e 6a 70 67 22 90 0a 34 00 2e 4f 70 65 6e 20 22 47 45 54 22 2c 20 22 68 74 74 70 73 3a 2f 2f } //1
		$a_00_1 = {45 6e 76 69 72 6f 6e 28 22 41 70 70 44 41 54 41 22 29 } //1 Environ("AppDATA")
		$a_03_2 = {2e 73 61 76 65 74 6f 66 69 6c 65 20 [0-05] 20 26 20 22 5c 61 76 67 2e 76 62 65 22 } //1
