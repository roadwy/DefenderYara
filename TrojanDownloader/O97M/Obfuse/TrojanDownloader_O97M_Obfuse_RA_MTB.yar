...
rule TrojanDownloader_O97M_Obfuse_RA_MTB{
	...
	strings :
		$a_01_0 = {43 68 72 28 39 32 29 20 26 20 52 6e 64 20 26 20 22 2e 6a 73 65 22 } //01 00 
		...
		$a_01_3 = {43 72 65 61 74 65 4f 62 6a 65 63 74 28 4d 69 64 28 } //01 00 
		$a_01_4 = {2e 43 6c 6f 73 65 } //01 00 
		$a_01_5 = {54 72 69 6d 28 4c 65 66 74 28 73 74 72 2c 20 4c 65 6e 28 73 74 72 29 20 2d 20 32 29 29 29 } //00 00 
	condition:
		any of ($a_*)
