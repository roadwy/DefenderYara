...
rule TrojanDownloader_O97M_Obfuse_JJ_MTB_2{
	...
	strings :
		...
		$a_03_3 = {52 65 70 6c 61 63 65 28 90 02 0a 2c 20 90 02 0a 2c 20 22 22 29 90 00 } //1
		...
		$a_03_6 = {4d 69 64 24 28 90 02 0a 2c 20 90 02 0a 2c 20 31 29 90 00 } //1
	condition:
...
rule TrojanDownloader_O97M_Obfuse_JJ_MTB_3{
	...
	strings :
		...
		$a_01_4 = {66 72 6d 2e 74 78 74 2e 74 65 78 74 } //1 frm.txt.text
		$a_01_5 = {50 72 69 6e 74 20 23 46 69 6c 65 4e 75 6d 62 65 72 2c 20 53 70 63 } //1 Print #FileNumber, Spc
		$a_03_6 = {41 73 63 28 4d 69 64 24 28 90 02 0a 2c 20 90 02 0a 2c 20 31 29 29 90 00 } //1
	condition:
		((#a_01_0  & 1)*1+(#a_01_1  & 1)*1+(#a_01_2  & 1)*1+(#a_03_3  & 1)*1+(#a_01_4  & 1)*1+(#a_01_5  & 1)*1+(#a_03_6  & 1)*1) >=7
...
rule TrojanDownloader_O97M_Obfuse_JJ_MTB_4{
	...
	strings :
		...
		$a_01_4 = {66 72 6d 2e 74 78 74 2e 74 65 78 74 } //1 frm.txt.text
		$a_01_5 = {50 72 69 6e 74 20 23 46 69 6c 65 4e 75 6d 62 65 72 2c 20 53 70 63 } //1 Print #FileNumber, Spc
		$a_03_6 = {4c 6f 6f 70 20 57 68 69 6c 65 20 90 02 0a 20 3e 20 28 90 02 0a 20 2d 20 31 29 90 00 } //1
		$a_03_7 = {41 73 63 28 4d 69 64 28 90 02 0a 2c 20 90 02 0a 2c 20 31 29 29 90 00 } //1
	condition:
