...
rule TrojanDownloader_O97M_Obfuse_GX{
	...
	strings :
		...
		$a_03_1 = {3d 20 47 65 74 4f 62 6a 65 63 74 28 90 02 14 28 31 29 20 2b 90 00 } //1
		$a_01_2 = {2e 43 6f 6e 74 72 6f 6c 73 28 30 29 2e 56 61 6c 75 65 } //1 .Controls(0).Value
		$a_03_3 = {2e 43 6f 6e 74 72 6f 6c 73 28 90 02 05 29 2e 56 61 6c 75 65 90 00 } //1
		$a_03_4 = {2e 52 75 6e 21 20 28 90 02 20 29 20 2b 20 22 22 2c 90 00 } //1
	condition:
