...
rule TrojanDownloader_O97M_Obfuse_SJ_MTB{
	...
	strings :
		...
		$a_01_1 = {6c 20 3d 20 41 63 74 69 76 65 44 6f 63 75 6d 65 6e 74 2e 50 61 74 68 20 2b 20 22 5c 6c 73 61 73 73 2e 65 78 65 22 } //01 00 
		$a_01_2 = {3d 20 43 72 65 61 74 65 4f 62 6a 65 63 74 28 22 4d 69 63 72 6f 73 6f 66 74 2e 58 4d 4c 48 54 54 50 22 29 } //01 00 
...
rule TrojanDownloader_O97M_Obfuse_SJ_MTB_2{
	...
	strings :
		...
		$a_01_1 = {57 6f 72 6b 73 68 65 65 74 73 28 31 29 2e 41 63 74 69 76 61 74 65 } //01 00 
