...
rule TrojanDownloader_O97M_Obfuse_PG_MSR{
	...
	strings :
		...
		$a_01_4 = {68 74 74 70 3a 2f 2f 32 30 67 6c 6f 72 79 6d 6d 61 75 73 61 2e 63 6f 6d 2f 41 2f 73 74 61 6e 7a 65 72 2e 65 78 65 } //02 00 
		...
		$a_01_7 = {68 74 74 70 3a 2f 2f 64 6f 77 6e 6c 6f 61 64 2e 73 61 62 61 6c 6f 6f 2e 63 6f 6d 2f 63 73 73 2f 6c 69 62 61 74 6b 2d 31 2e 30 2d 30 2e 64 61 74 } //02 00 
