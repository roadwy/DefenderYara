...
rule TrojanDownloader_O97M_Obfuse_SB_MSR{
	...
	strings :
		$a_01_0 = {44 6f 77 6e 6c 6f 61 64 } //01 00 
		$a_01_1 = {53 68 65 6c 6c 45 78 65 63 75 74 65 } //03 00 
...
rule TrojanDownloader_O97M_Obfuse_SB_MSR_2{
	...
	strings :
		...
		$a_01_1 = {65 78 70 61 6e 64 45 6e 76 69 72 6f 6e 6d 65 6e 74 53 74 72 69 6e 67 73 28 22 25 41 50 50 44 41 54 41 25 22 29 } //01 00 
		$a_01_2 = {4d 6b 44 69 72 20 22 43 3a 22 20 2b 20 22 5c 4b 42 34 22 20 2b 20 22 } //01 00 
		$a_01_3 = {43 72 65 61 74 65 4f 62 6a 65 63 74 28 22 57 73 63 72 69 70 74 2e 53 68 65 6c 6c 22 29 } //01 00 
		$a_01_4 = {53 68 65 6c 6c 2e 52 75 6e 20 22 53 63 68 54 61 73 6b 73 20 2f 43 72 65 61 74 65 20 2f 53 43 } //01 00 
		$a_01_5 = {43 6f 70 79 46 69 6c 65 20 45 6e 76 69 72 6f 6e 28 22 54 65 6d 70 22 29 20 26 20 22 5c 4b 42 34 22 20 2b } //00 00 
	condition:
		any of ($a_*)
