...
rule TrojanDownloader_O97M_Obfuse_SB_MSR{
	...
	strings :
		...
		$a_03_2 = {68 74 74 70 73 3a 2f 2f 64 61 6e 67 65 72 6f 75 73 6c 79 2e 90 02 15 73 76 63 2e 64 6c 6c 90 00 } //3
		$a_03_3 = {68 74 74 70 3a 2f 2f 67 72 61 72 73 2e 63 6f 6d 2f 90 02 06 2e 65 78 65 90 00 } //3
		$a_03_4 = {68 74 74 70 3a 2f 2f 74 61 6d 62 6f 65 2e 6e 65 74 2f 90 02 06 2e 65 78 65 90 00 } //3
		$a_03_5 = {68 74 74 70 3a 2f 2f 72 65 74 6f 68 2e 63 6f 6d 2f 90 02 06 2e 65 78 65 90 00 } //3
		$a_03_6 = {68 74 74 70 3a 2f 2f 6b 77 61 74 6f 76 2e 63 6f 6d 2f 90 02 06 2e 65 78 65 90 00 } //3
	condition:
...
rule TrojanDownloader_O97M_Obfuse_SB_MSR_2{
	...
	strings :
		$a_03_0 = {53 68 65 65 74 90 02 01 2e 4f 4c 45 4f 62 6a 65 63 74 73 28 22 4f 62 6a 65 63 74 90 02 02 22 29 2e 43 6f 70 79 90 00 } //1
