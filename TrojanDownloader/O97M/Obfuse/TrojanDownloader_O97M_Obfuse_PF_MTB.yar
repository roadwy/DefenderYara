...
rule TrojanDownloader_O97M_Obfuse_PF_MTB{
	...
	strings :
		...
		$a_02_2 = {2e 73 73 6c 62 6c 69 6e 64 61 64 6f 2e 63 6f 6d 2f 90 0a 3c 00 3d 20 22 6d 73 68 54 41 20 (68 74 74 70|68 74 74 70 73) 3a 2f 2f 74 72 61 6e 73 76 61 6c 65 } //1
	condition:
