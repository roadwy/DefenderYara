...
rule TrojanDownloader_O97M_Obfuse_PKJA_MTB{
	...
	strings :
		$a_03_0 = {73 62 76 2e 90 02 05 2f 63 65 73 2f 74 65 6e 2e 73 6e 64 2d 63 69 6d 61 6e 79 64 2e 6f 67 6e 6f 6d 70 75 78 2f 2f 3a 90 00 } //1
		$a_03_1 = {73 74 61 72 74 2d 70 72 6f 63 65 73 73 28 24 65 6e 76 3a 74 65 6d 70 2b 20 27 5c 90 02 0a 2e 76 62 73 90 00 } //1
