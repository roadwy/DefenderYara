...
rule TrojanDownloader_O97M_Obfuse_RVL_MTB{
	...
	strings :
		...
		$a_02_1 = {33 39 2e 31 30 30 2e 31 35 39 2e 38 2f 61 61 61 22 20 2b 20 52 75 6e 52 65 73 75 6c 74 20 2b 20 52 75 6e 52 65 73 75 6c 74 77 68 6f 61 6d 69 90 0a 3d 00 55 52 4c 20 3d 20 22 68 74 74 70 3a 2f 2f 90 00 } //1
