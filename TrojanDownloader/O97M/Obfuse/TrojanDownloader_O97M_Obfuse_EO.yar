...
rule TrojanDownloader_O97M_Obfuse_EO{
	...
	strings :
		$a_02_0 = {44 69 6d 20 90 02 20 20 41 73 20 43 75 72 72 65 6e 63 79 90 00 } //1
		$a_02_1 = {53 74 72 52 65 76 65 72 73 65 28 53 74 72 52 65 76 65 72 73 65 28 90 02 20 28 90 00 } //1
	condition:
...
rule TrojanDownloader_O97M_Obfuse_EO_2{
	...
	strings :
		$a_03_0 = {43 72 65 61 74 65 90 02 01 20 90 02 10 20 2b 20 90 02 25 20 2b 20 90 00 } //2
		$a_03_1 = {47 65 74 4f 62 6a 65 63 74 28 90 02 10 20 2b 20 22 53 74 61 22 20 2b 20 22 72 74 75 70 22 29 90 00 } //1
		...
		$a_03_5 = {53 68 6f 77 57 69 6e 64 6f 77 20 3d 20 90 02 14 20 90 00 } //1
	condition:
