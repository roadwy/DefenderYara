...
rule TrojanDownloader_O97M_Obfuse_PNO_MTB{
	...
	strings :
		...
		$a_03_2 = {3d 20 70 76 47 65 74 46 69 6c 65 28 22 68 74 74 70 3a 2f 2f 22 20 2b 20 90 02 08 20 2b 20 22 2f 65 61 73 79 64 6f 72 65 2f 64 6f 63 75 6d 65 6e 74 2f 63 68 61 6d 70 73 46 75 73 69 6f 6e 2e 68 74 6d 6c 3f 6e 6f 63 61 63 68 65 3d 22 20 26 20 4e 6f 77 29 90 00 } //1
