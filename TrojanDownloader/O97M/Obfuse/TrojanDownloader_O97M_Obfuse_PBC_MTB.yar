...
rule TrojanDownloader_O97M_Obfuse_PBC_MTB{
	...
	strings :
		...
		$a_03_1 = {34 74 6f 70 2e 69 6f 2f 90 02 0f 2e 6a 70 67 90 0a 3c 00 2e 4f 70 65 6e 20 22 47 45 54 22 2c 20 22 68 74 74 70 73 3a 2f 2f 62 2e 74 6f 70 90 00 } //1
...
rule TrojanDownloader_O97M_Obfuse_PBC_MTB_2{
	...
	strings :
		...
		$a_03_1 = {67 65 74 68 6f 73 74 62 79 6e 61 6d 65 20 28 74 73 20 26 20 22 2e 90 02 08 2e 63 61 63 68 65 64 6e 73 2e 69 6f 22 29 90 00 } //1
