...
rule TrojanDownloader_O97M_Obfuse_SK_MTB{
	...
	strings :
		...
		$a_03_1 = {3d 20 52 61 6e 67 65 28 [0-02] 29 2e 43 6f 6d 6d 65 6e 74 2e 54 65 78 74 } //1
		...
		$a_03_4 = {2e 4d 65 74 68 6f 64 73 5f 28 22 43 72 65 61 74 65 22 29 2e 20 5f [0-10] 49 6e 50 61 72 61 6d 65 74 65 72 73 2e 53 70 61 77 6e 49 6e 73 74 61 6e 63 65 5f } //1
	condition:
...
rule TrojanDownloader_O97M_Obfuse_SK_MTB_2{
	...
	strings :
		...
		$a_03_5 = {3d 20 6f 50 72 6f 63 65 73 73 2e 45 78 65 63 4d 65 74 68 6f 64 5f 28 73 48 65 78 44 65 63 6f 64 65 28 22 [0-18] 22 29 2c 20 6f 49 6e 50 61 72 61 6d 73 29 } //1
	condition:
