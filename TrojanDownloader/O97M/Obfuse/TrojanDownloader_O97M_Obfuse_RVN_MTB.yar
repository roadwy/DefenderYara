...
rule TrojanDownloader_O97M_Obfuse_RVN_MTB{
	...
	strings :
		...
		$a_00_1 = {6f 53 68 65 6c 6c 20 3d 20 43 72 65 61 74 65 4f 62 6a 65 63 74 28 22 57 53 63 72 69 70 74 2e 53 68 65 6c 6c 22 29 } //01 00 
		$a_00_2 = {2d 2d 6f 75 74 70 75 74 20 44 3a 5c 7a 7a 2e 7a 69 70 22 2c 20 30 2c 20 46 61 6c 73 65 } //01 00 
		$a_00_3 = {41 70 70 6c 69 63 61 74 69 6f 6e 2e 56 69 73 69 62 6c 65 20 3d 20 54 72 75 65 } //00 00 
	condition:
		any of ($a_*)
