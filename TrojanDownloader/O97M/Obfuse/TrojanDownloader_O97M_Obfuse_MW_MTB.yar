...
rule TrojanDownloader_O97M_Obfuse_MW_MTB{
	...
	strings :
		...
		$a_01_4 = {2c 20 4d 53 46 6f 72 6d 73 2c 20 54 65 78 74 42 6f 78 22 } //01 00 
		$a_01_5 = {53 75 62 20 61 75 74 6f 6f 70 65 6e 28 29 } //01 00 
		$a_01_6 = {27 68 74 74 70 73 3a 2f 2f 77 77 77 2e } //00 00 
	condition:
		any of ($a_*)
