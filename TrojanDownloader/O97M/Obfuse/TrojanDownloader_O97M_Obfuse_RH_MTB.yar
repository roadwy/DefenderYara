...
rule TrojanDownloader_O97M_Obfuse_RH_MTB{
	...
	strings :
		...
		$a_01_1 = {26 20 22 34 62 } //01 00  & "4b
		$a_01_2 = {26 20 22 35 } //01 00  & "5
		$a_01_3 = {26 20 22 37 } //01 00  & "7
		$a_01_4 = {33 33 33 34 33 33 } //01 00  333433
		$a_01_5 = {3d 20 49 73 4f 62 6a 65 63 74 28 22 22 29 } //01 00  = IsObject("")
