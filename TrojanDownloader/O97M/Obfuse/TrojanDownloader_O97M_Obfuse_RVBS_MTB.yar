...
rule TrojanDownloader_O97M_Obfuse_RVBS_MTB{
	...
	strings :
		...
		$a_01_1 = {70 6f 69 6c 28 22 33 36 32 34 37 33 33 31 35 34 31 30 32 36 38 33 36 39 34 36 36 33 31 38 34 31 33 34 36 32 32 35 36 33 30 37 33 35 39 34 30 35 35 30 35 33 36 30 34 35 39 22 29 } //01 00 
		$a_01_2 = {3d 63 68 72 28 63 69 6e 74 28 63 29 2d 32 35 36 29 } //01 00 
		$a_01_3 = {61 75 74 6f 6f 70 65 6e 28 29 61 6e 75 73 5f 64 65 5f 63 75 6c 65 6e 64 73 75 62 } //00 00 
	condition:
		any of ($a_*)
