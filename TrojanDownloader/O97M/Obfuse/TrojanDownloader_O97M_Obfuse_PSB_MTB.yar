...
rule TrojanDownloader_O97M_Obfuse_PSB_MTB{
	...
	strings :
		...
		$a_03_1 = {2e 65 78 65 63 24 20 28 72 69 67 68 74 44 61 74 61 46 75 6e 63 29 90 0c 02 00 45 6e 64 20 57 69 74 68 90 0c 02 00 45 6e 64 20 53 75 62 90 00 } //1
		$a_03_2 = {66 72 6d 2e 62 75 74 74 6f 6e 31 5f 43 6c 69 63 6b 90 0c 02 00 45 6e 64 20 53 75 62 90 00 } //1
