...
rule TrojanDownloader_O97M_Obfuse_RU_MTB{
	...
	strings :
		...
		$a_03_1 = {70 61 73 74 65 2e 65 65 2f 72 2f 76 35 65 38 45 90 0a 1b 00 68 74 27 2b 27 74 70 3a 2f 2f 90 00 } //1
...
rule TrojanDownloader_O97M_Obfuse_RU_MTB_2{
	...
	strings :
		...
		$a_03_2 = {22 26 48 22 90 02 06 26 20 4d 69 64 24 90 00 } //1
		$a_03_3 = {3d 20 52 65 70 6c 61 63 65 28 22 90 02 20 26 48 90 02 20 22 2c 90 00 } //1
		$a_03_4 = {3d 20 52 65 70 6c 61 63 65 28 90 02 18 2c 20 90 02 20 2c 20 22 22 29 90 00 } //1
