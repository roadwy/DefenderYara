...
rule TrojanDownloader_O97M_Lokibot_NA_MTB{
	...
	strings :
		$a_02_0 = {68 74 74 70 3a 2f 2f 73 70 61 72 65 70 61 72 74 69 72 61 6e 2e 63 6f 6d 2f 6a 73 2f 64 31 2f [0-14] 2e 65 78 65 } //1
		$a_02_1 = {43 3a 5c 55 73 65 72 73 5c 50 75 62 6c 69 63 5c 22 20 2b 22 [0-32] 2e 65 78 65 } //1
		$a_02_2 = {53 68 65 6c 6c 28 [0-32] 2c } //1
