...
rule TrojanDownloader_O97M_ZLoader_VIS_MTB{
	meta:
		description = "TrojanDownloader:O97M/ZLoader.VIS!MTB,SIGNATURE_TYPE_MACROHSTR_EXT,05 00 05 00 05 00 00 01 00 "
		
	strings :
		$a_01_0 = {55 73 65 72 46 6f 72 6d 31 2e 43 6f 6d 62 6f 42 6f 78 34 20 3d 20 55 73 65 72 46 6f 72 6d 31 2e 43 6f 6d 62 6f 42 6f 78 34 20 26 20 22 30 22 } //01 00  UserForm1.ComboBox4 = UserForm1.ComboBox4 & "0"
		...
		$a_01_4 = {3d 20 41 70 70 6c 69 63 61 74 69 6f 6e 2e 4f 70 74 69 6f 6e 73 2e 4d 61 74 63 68 46 75 7a 7a 79 } //00 00  = Application.Options.MatchFuzzy
	condition:
		any of ($a_*)
