...
rule TrojanDownloader_O97M_ZLoader_PIN_MTB{
	...
	strings :
		$a_01_0 = {2e 43 6f 6d 62 6f 42 6f 78 34 20 3d 20 55 73 65 72 46 6f 72 6d 31 2e 43 6f 6d 62 6f 42 6f 78 34 20 26 20 22 30 22 } //1 .ComboBox4 = UserForm1.ComboBox4 & "0"
		...
		$a_01_4 = {2e 44 6f 63 75 6d 65 6e 74 73 2e 4f 70 65 6e 20 41 63 74 69 76 65 44 6f 63 75 6d 65 6e 74 2e 46 75 6c 6c 4e 61 6d 65 2c 20 52 65 61 64 4f 6e 6c 79 3a 3d 54 72 75 65 } //1 .Documents.Open ActiveDocument.FullName, ReadOnly:=True
	condition:
