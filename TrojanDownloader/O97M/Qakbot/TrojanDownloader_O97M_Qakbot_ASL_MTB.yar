...
rule TrojanDownloader_O97M_Qakbot_ASL_MTB{
	...
	strings :
		...
		$a_03_2 = {68 74 74 70 3a 2f 2f 90 02 04 6e 61 72 75 6d 69 2e 6d 6e 2f 64 73 2f 30 34 31 32 32 30 2e 67 69 66 90 00 } //1
		$a_03_3 = {68 74 74 70 3a 2f 2f 90 02 04 74 65 74 65 6b 2e 72 75 2f 64 73 2f 30 34 31 32 32 30 2e 67 69 66 90 00 } //1
	condition:
