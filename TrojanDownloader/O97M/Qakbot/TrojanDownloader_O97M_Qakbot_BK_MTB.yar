...
rule TrojanDownloader_O97M_Qakbot_BK_MTB_3{
	...
	strings :
		...
		$a_03_3 = {26 20 61 74 5a 68 51 28 22 63 6f 6d 6d 65 6e 74 73 22 29 20 26 20 61 6f 54 41 36 53 20 26 20 90 02 0a 20 26 20 61 6f 54 41 36 53 90 00 } //1
	condition:
...
rule TrojanDownloader_O97M_Qakbot_BK_MTB_8{
	...
	strings :
		...
		$a_03_5 = {3d 20 61 65 41 46 53 28 61 45 41 4a 62 28 90 02 0a 28 90 02 0a 29 2c 20 31 31 31 29 29 90 00 } //1
	condition:
