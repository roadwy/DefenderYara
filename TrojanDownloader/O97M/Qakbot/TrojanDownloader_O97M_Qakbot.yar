...
rule TrojanDownloader_O97M_Qakbot{
	...
	strings :
		...
		$a_00_1 = {3d 22 75 72 22 26 22 6c 64 22 26 22 6f 77 22 26 22 6e 22 26 22 6c 6f 22 26 22 61 64 22 26 22 74 6f 22 26 22 66 69 22 26 22 6c 65 22 26 22 61 22 } //00 00  ="ur"&"ld"&"ow"&"n"&"lo"&"ad"&"to"&"fi"&"le"&"a"
	condition:
		any of ($a_*)
