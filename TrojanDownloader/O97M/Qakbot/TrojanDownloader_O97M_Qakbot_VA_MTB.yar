...
rule TrojanDownloader_O97M_Qakbot_VA_MTB{
	...
	strings :
		$a_01_0 = {43 3a 5c 67 76 6e 70 73 64 } //01 00 
		$a_01_1 = {5c 62 72 61 76 61 67 2e 65 78 65 } //01 00 
		$a_01_2 = {4a 4a 43 43 43 4a 4a } //01 00 
		$a_01_3 = {52 6f 75 74 } //01 00 
		$a_01_4 = {65 78 70 6c } //01 00 
		$a_01_5 = {55 52 4c 44 6f 77 6e } //00 00 
	condition:
		any of ($a_*)
...
rule TrojanDownloader_O97M_Qakbot_VA_MTB_3{
	...
	strings :
		...
		$a_00_2 = {72 75 6e 64 6c 6c 33 32 } //01 00 
		$a_00_3 = {43 3a 5c 65 72 76 69 6f 5c 63 6f 70 72 2e 72 73 67 73 } //00 00 
	condition:
		any of ($a_*)
...
rule TrojanDownloader_O97M_Qakbot_VA_MTB_4{
	...
	strings :
		$a_01_0 = {5c 4a 49 4f 4c 41 53 2e 52 52 54 54 4f 4f 4b 4b } //0a 00 
...
rule TrojanDownloader_O97M_Qakbot_VA_MTB_5{
	...
	strings :
		...
		$a_00_2 = {43 3a 5c 49 6e 74 65 6c 43 6f 6d 70 61 6e 79 5c 4a 49 4f 4c 41 53 2e 52 52 54 54 4f 4f 4b 4b } //0a 00 
...
rule TrojanDownloader_O97M_Qakbot_VA_MTB_6{
	...
	strings :
		$a_01_0 = {6c 73 78 2e 31 5c 61 74 61 64 6d 61 72 67 6f 72 70 5c 3a 63 } //01 00 
		$a_01_1 = {6d 6f 63 2e 31 5c 61 74 61 64 6d 61 72 67 6f 72 70 5c 3a 63 } //01 00 
		$a_01_2 = {65 78 65 2e 63 69 6d 77 5c 6d 65 62 77 5c 32 33 6d 65 74 73 79 73 5c 73 77 6f 64 6e 69 77 5c 3a 63 } //01 00 
...
rule TrojanDownloader_O97M_Qakbot_VA_MTB_7{
	...
	strings :
		...
		$a_01_5 = {43 3a 5c 49 6e 74 65 6c 43 6f 6d 70 61 6e 79 5c 4a 49 4f 4c 41 53 2e 52 52 54 54 4f 4f 4b 4b } //00 00 
	condition:
		any of ($a_*)
