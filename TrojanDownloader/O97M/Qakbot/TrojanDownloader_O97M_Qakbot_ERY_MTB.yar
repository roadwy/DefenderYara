...
rule TrojanDownloader_O97M_Qakbot_ERY_MTB{
	...
	strings :
		...
		$a_01_1 = {26 20 53 68 65 65 74 73 28 22 44 6f 63 73 32 22 29 2e 52 61 6e 67 65 28 22 41 41 35 22 29 } //01 00  & Sheets("Docs2").Range("AA5")
		$a_01_2 = {64 6c 70 61 74 68 20 3d 20 53 68 65 65 74 73 28 22 44 6f 63 73 33 22 29 2e 52 61 6e 67 65 28 22 41 41 31 33 22 29 } //01 00  dlpath = Sheets("Docs3").Range("AA13")
