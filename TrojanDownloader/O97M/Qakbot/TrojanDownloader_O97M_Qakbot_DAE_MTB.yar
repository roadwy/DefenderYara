...
rule TrojanDownloader_O97M_Qakbot_DAE_MTB{
	...
	strings :
		...
		$a_03_3 = {47 75 69 6b 67 68 6a 67 66 68 20 3d 20 [0-08] 20 26 20 53 68 65 65 74 73 28 22 46 69 6c 65 73 22 29 2e 52 61 6e 67 65 28 22 42 36 30 22 29 } //1
		...
		$a_03_5 = {55 52 4c 44 6f 77 6e 6c 6f 61 64 54 6f 46 69 6c 65 20 30 2c 20 47 75 69 6b 67 68 6a 67 66 68 2c 20 42 74 64 75 66 6a 6b 68 6e 2c 20 30 2c 20 30 90 0c 02 00 45 6e 64 20 46 75 6e 63 74 69 6f 6e } //1
	condition:
