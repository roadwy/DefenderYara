...
rule TrojanDownloader_O97M_Qakbot_PUB_MTB{
	...
	strings :
		...
		$a_00_3 = {68 74 74 70 73 3a 2f 2f 71 31 73 30 6f 63 69 34 39 6a 6f 2e 78 79 7a 2f 67 75 74 70 61 67 65 2e 70 68 70 } //01 00 
		$a_00_4 = {43 3a 5c 72 6f 69 77 6e 73 } //01 00 
		$a_00_5 = {5c 64 73 66 73 65 69 2e 65 78 65 } //00 00 
	condition:
		any of ($a_*)
