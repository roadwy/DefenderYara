...
rule TrojanDownloader_O97M_Qakbot_ALA_MTB{
	...
	strings :
		$a_01_0 = {34 34 36 38 36 2e 34 38 30 32 39 37 38 30 30 39 2e 64 61 74 } //01 00  44686.4802978009.dat
		$a_01_1 = {2e 4f 4f 4f 43 43 43 58 58 58 } //01 00  .OOOCCCXXX
		$a_01_2 = {44 69 72 65 63 74 6f 72 79 41 } //01 00  DirectoryA
