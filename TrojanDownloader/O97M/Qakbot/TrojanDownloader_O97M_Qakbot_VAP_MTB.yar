...
rule TrojanDownloader_O97M_Qakbot_VAP_MTB{
	...
	strings :
		$a_01_0 = {53 74 72 69 6e 67 20 3d 20 22 39 37 2c 31 32 34 2c 31 31 36 2c 31 30 34 2c 31 30 37 2c 31 31 38 2c 39 37 2c 31 31 38 22 } //01 00  String = "97,124,116,104,107,118,97,118"
		...
		$a_01_3 = {2e 53 68 65 6c 6c 45 78 65 63 75 74 65 } //00 00  .ShellExecute
	condition:
		any of ($a_*)
