...
rule TrojanDownloader_O97M_Qakbot_PUE_MTB{
	...
	strings :
		...
		$a_00_3 = {68 74 74 70 73 3a 2f 2f 79 63 31 6f 70 33 6a 68 33 39 72 2e 78 79 7a 2f 67 75 74 70 61 67 2e 70 68 70 } //01 00  https://yc1op3jh39r.xyz/gutpag.php
		$a_00_4 = {43 3a 5c 6d 76 6f 72 70 } //01 00  C:\mvorp
		$a_00_5 = {5c 6f 6f 6a 66 6a 2e 65 78 65 } //00 00  \oojfj.exe
	condition:
		any of ($a_*)
