...
rule TrojanDownloader_O97M_Malgent_A{
	...
	strings :
		...
		$a_00_1 = {68 74 74 70 3a 2f 2f 34 35 2e 37 38 2e 32 31 2e 31 35 30 2f 62 6f 6f 73 74 2f 62 6f 6f 73 74 69 6e 67 2e 65 78 65 } //00 00  http://45.78.21.150/boost/boosting.exe
	condition:
		any of ($a_*)
