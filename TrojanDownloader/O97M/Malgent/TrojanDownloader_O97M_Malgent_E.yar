...
rule TrojanDownloader_O97M_Malgent_E{
	...
	strings :
		...
		$a_03_4 = {20 3d 20 30 20 54 6f 20 55 42 6f 75 6e 64 28 90 02 20 29 20 2d 20 31 0d 0a 20 20 20 20 20 20 20 20 49 66 20 28 90 02 20 20 4d 6f 64 20 35 20 3d 20 28 90 00 } //1
		$a_03_5 = {20 3d 20 45 6e 76 69 72 6f 6e 28 90 02 20 28 90 02 01 90 10 05 00 20 90 00 } //1
	condition:
