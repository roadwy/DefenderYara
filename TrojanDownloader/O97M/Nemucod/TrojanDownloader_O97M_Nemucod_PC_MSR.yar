...
rule TrojanDownloader_O97M_Nemucod_PC_MSR{
	...
	strings :
		$a_03_0 = {68 74 74 70 [0-01] 3a 2f 2f [0-03] 2e [0-03] 2e [0-03] 2e [0-03] 2f 63 72 79 70 74 2e 64 6c 6c } //10
		$a_03_1 = {43 3a 5c 72 6e 63 77 6e 65 72 5c [0-0f] 2e 64 6c 6c 20 44 6c 6c 52 65 67 69 73 74 65 72 53 65 72 76 65 72 } //10
