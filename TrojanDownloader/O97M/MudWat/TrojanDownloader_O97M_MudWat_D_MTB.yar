...
rule TrojanDownloader_O97M_MudWat_D_MTB{
	...
	strings :
		...
		$a_03_1 = {2c 20 56 62 4d 65 74 68 6f 64 2c 20 90 02 20 2c 20 45 6e 76 69 72 6f 6e 28 90 02 20 29 20 26 90 00 } //1
		$a_03_2 = {3d 20 41 73 63 28 4d 69 64 28 90 01 01 2c 20 28 90 01 01 20 4d 6f 64 20 4c 65 6e 28 90 00 } //1
		$a_01_3 = {2e 54 65 78 74 2c 20 22 2e 22 29 } //1 .Text, ".")
		$a_01_4 = {3d 20 22 22 } //1 = ""
		$a_03_5 = {4f 70 65 6e 20 45 6e 76 69 72 6f 6e 28 90 02 20 29 20 26 20 90 02 20 20 46 6f 72 20 4f 75 74 70 75 74 20 41 73 20 23 90 00 } //1
