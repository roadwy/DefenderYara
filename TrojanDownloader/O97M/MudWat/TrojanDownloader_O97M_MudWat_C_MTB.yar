...
rule TrojanDownloader_O97M_MudWat_C_MTB{
	...
	strings :
		$a_03_0 = {56 62 4d 65 74 68 6f 64 2c 20 [0-15] 2c 20 45 6e 76 69 72 6f 6e 28 [0-15] 29 20 26 } //1
		...
		$a_03_6 = {4f 70 65 6e 20 45 6e 76 69 72 6f 6e 28 [0-15] 29 20 26 20 [0-15] 20 46 6f 72 20 4f 75 74 70 75 74 20 41 73 20 23 } //1
	condition:
