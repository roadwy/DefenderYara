...
rule TrojanDownloader_O97M_BazarLoader_R_MTB{
	...
	strings :
		...
		$a_01_1 = {20 3d 20 43 72 65 61 74 65 4f 62 6a 65 63 74 28 22 73 68 65 6c 6c 2e 61 70 70 6c 69 63 61 74 69 6f 6e 22 29 } //01 00   = CreateObject("shell.application")
		$a_01_2 = {6d 78 20 22 74 22 2c 20 22 22 } //01 00  mx "t", ""
