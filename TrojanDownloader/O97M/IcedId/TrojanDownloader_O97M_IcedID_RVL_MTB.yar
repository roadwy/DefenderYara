...
rule TrojanDownloader_O97M_IcedID_RVL_MTB_2{
	...
	strings :
		$a_01_0 = {72 65 70 6f 4c 69 73 74 43 6c 65 61 72 20 3d 20 66 75 6e 63 74 69 6f 6e 52 65 71 75 65 73 74 20 26 20 22 63 3a 5c 75 73 65 72 73 5c 70 75 62 6c 69 63 5c 6e 61 6d 65 56 2e 68 74 61 22 } //02 00  repoListClear = functionRequest & "c:\users\public\nameV.hta"
		$a_01_1 = {67 6c 6f 62 61 6c 43 6f 6c 6c 65 63 74 44 61 74 65 20 3d 20 76 61 72 69 61 62 6c 65 53 77 61 70 20 26 20 22 63 3a 5c 75 73 65 72 73 5c 70 75 62 6c 69 63 5c 73 63 72 54 65 78 74 62 6f 78 2e 68 74 61 22 } //01 00  globalCollectDate = variableSwap & "c:\users\public\scrTextbox.hta"
