...
rule TrojanDownloader_O97M_IcedID_ICE_MTB{
	...
	strings :
		...
		$a_01_2 = {57 69 74 68 20 43 72 65 61 74 65 4f 62 6a 65 63 74 28 22 4d 69 63 72 6f 73 6f 66 74 2e 58 4d 4c 44 4f 4d 22 29 2e 63 72 65 61 74 65 45 6c 65 6d 65 6e 74 28 22 62 36 34 22 29 } //01 00  With CreateObject("Microsoft.XMLDOM").createElement("b64")
		$a_01_3 = {2e 44 61 74 61 54 79 70 65 20 3d 20 22 62 69 6e 2e 62 61 73 65 36 34 22 } //01 00  .DataType = "bin.base64"
		$a_01_4 = {2e 74 65 78 74 20 3d 20 62 36 34 } //01 00  .text = b64
		$a_01_5 = {62 20 3d 20 2e 6e 6f 64 65 54 79 70 65 64 56 61 6c 75 65 } //01 00  b = .nodeTypedValue
		$a_01_6 = {3d 20 43 72 65 61 74 65 4f 62 6a 65 63 74 28 22 53 63 72 69 70 74 69 6e 67 2e 46 69 6c 65 53 79 73 74 65 6d 4f 62 6a 65 63 74 22 29 } //01 00  = CreateObject("Scripting.FileSystemObject")
		...
		$a_01_9 = {50 72 69 6e 74 20 23 31 2c } //01 00  Print #1,
		...
		$a_01_13 = {28 66 72 6d 2e 74 65 78 74 31 2e 76 61 6c 75 65 29 } //01 00  (frm.text1.value)
		$a_01_14 = {3d 20 43 68 72 28 33 34 29 } //01 00  = Chr(34)
