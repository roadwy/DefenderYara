...
rule TrojanDownloader_O97M_IcedID_VI_MTB{
	...
	strings :
		...
		$a_03_1 = {53 68 65 6c 6c 20 90 02 ff 28 22 63 6d 64 20 2f 63 20 22 29 90 00 } //1
		$a_03_2 = {20 26 20 22 72 73 5c 5c 70 75 62 6c 69 63 5c 5c 90 02 20 2e 68 22 20 26 20 90 00 } //1
		$a_03_3 = {53 70 6c 69 74 28 90 02 ff 2c 20 22 23 22 29 90 00 } //1
