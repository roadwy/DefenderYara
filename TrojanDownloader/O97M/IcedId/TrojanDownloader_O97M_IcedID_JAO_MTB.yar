...
rule TrojanDownloader_O97M_IcedID_JAO_MTB{
	...
	strings :
		...
		$a_01_1 = {53 70 6c 69 74 28 22 6d 73 68 74 61 2e 65 78 65 7c 69 6e 2e 63 6f 6d 7c 69 6e 2e 68 74 6d 6c 22 2c 20 22 7c 22 29 } //01 00  Split("mshta.exe|in.com|in.html", "|")
...
rule TrojanDownloader_O97M_IcedID_JAO_MTB_2{
	...
	strings :
		$a_03_0 = {52 65 70 6c 61 63 65 28 90 02 08 2c 20 90 02 08 2c 20 22 22 29 90 00 } //03 00 
		$a_01_1 = {53 70 6c 69 74 28 22 6d 73 68 74 61 2e 65 78 65 7c 69 6e 2e 63 6f 6d 7c 69 6e 2e 68 74 6d 6c 22 2c 20 22 7c 22 29 } //02 00  Split("mshta.exe|in.com|in.html", "|")
