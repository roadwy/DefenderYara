...
rule TrojanDownloader_O97M_IcedID_PCJ_MTB{
	...
	strings :
		...
		$a_02_1 = {50 72 69 6e 74 20 23 46 69 6c 65 4e 75 6d 62 65 72 2c 20 53 70 63 28 90 02 0f 29 90 00 } //1
		...
		$a_02_5 = {4d 69 64 24 28 90 02 0a 24 2c 20 74 74 2c 20 31 29 20 3d 20 43 68 72 24 28 78 25 29 90 00 } //1
