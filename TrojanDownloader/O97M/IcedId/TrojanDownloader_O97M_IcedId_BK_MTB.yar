...
rule TrojanDownloader_O97M_IcedId_BK_MTB_2{
	...
	strings :
		...
		$a_03_1 = {43 72 65 61 74 65 4f 62 6a 65 63 74 28 22 77 73 63 72 69 70 74 2e 73 68 65 6c 6c 22 29 2e 52 65 67 57 72 69 74 65 20 90 02 1e 2c 20 31 2c 20 22 52 45 47 5f 44 57 4f 52 44 22 90 00 } //1
		$a_03_2 = {3d 20 4d 69 64 28 90 02 1e 2c 20 34 20 2f 20 32 2c 20 33 30 30 30 30 30 30 29 90 00 } //1
