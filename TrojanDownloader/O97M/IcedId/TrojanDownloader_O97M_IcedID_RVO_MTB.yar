...
rule TrojanDownloader_O97M_IcedID_RVO_MTB{
	...
	strings :
		$a_03_0 = {3d 20 22 63 3a 5c 70 72 6f 67 72 61 6d 64 61 74 61 5c 90 02 14 2e 68 22 2c 20 4f 70 74 69 6f 6e 61 6c 20 90 02 14 20 3d 20 22 74 22 2c 20 4f 70 74 69 6f 6e 61 6c 20 90 02 14 20 3d 20 22 61 22 90 00 } //1
		...
		$a_03_3 = {26 20 43 68 72 28 90 02 14 28 90 02 14 29 20 58 6f 72 20 31 31 30 29 90 00 } //1
