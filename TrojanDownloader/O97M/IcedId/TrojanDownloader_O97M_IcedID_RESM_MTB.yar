...
rule TrojanDownloader_O97M_IcedID_RESM_MTB{
	...
	strings :
		$a_01_0 = {72 6e 26 6c 64 33 6c 75 26 32 } //01 00  rn&ld3lu&2
		...
		$a_01_2 = {63 2f 68 75 72 6c 66 3a 31 75 6f 70 63 31 79 74 72 6c 6e 72 63 76 } //00 00  c/hurlf:1uopc1ytrlnrcv
	condition:
		any of ($a_*)
