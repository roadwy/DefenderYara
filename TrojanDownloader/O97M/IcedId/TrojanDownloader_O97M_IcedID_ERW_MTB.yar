...
rule TrojanDownloader_O97M_IcedID_ERW_MTB{
	...
	strings :
		...
		$a_03_1 = {43 72 65 61 74 65 4f 62 6a 65 63 74 28 22 77 73 63 72 69 70 74 2e 73 68 65 6c 6c 22 29 2e 65 78 65 63 20 28 73 72 28 [0-25] 29 29 90 0c 02 00 45 6e 64 20 53 75 62 } //1
