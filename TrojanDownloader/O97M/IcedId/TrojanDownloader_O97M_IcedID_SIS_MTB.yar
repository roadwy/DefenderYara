...
rule TrojanDownloader_O97M_IcedID_SIS_MTB{
	...
	strings :
		...
		$a_03_1 = {41 63 74 69 76 65 44 6f 63 75 6d 65 6e 74 2e 42 75 69 6c 74 49 6e 44 6f 63 75 6d 65 6e 74 50 72 6f 70 65 72 74 69 65 73 28 [0-1f] 28 22 [0-1f] 22 29 29 2e 56 61 6c 75 65 29 } //1
		$a_01_2 = {53 75 62 20 44 6f 63 75 6d 65 6e 74 5f 4f 70 65 6e 28 29 } //1 Sub Document_Open()
		$a_03_3 = {73 68 65 6c 6c 43 6f 64 65 2c 20 [0-1e] 2c 20 36 34 2c 20 56 61 72 50 74 72 28 [0-1e] 29 0d 0a 47 65 74 4f 62 6a 65 63 74 } //1
