...
rule TrojanDownloader_O97M_IcedID_RVN_MTB{
	...
	strings :
		...
		$a_01_2 = {53 70 6c 69 74 28 41 63 74 69 76 65 44 6f 63 75 6d 65 6e 74 2e 52 61 6e 67 65 2e 54 65 78 74 2c 20 22 78 22 29 } //01 00 
		...
		$a_01_5 = {6f 75 74 20 26 20 43 68 72 28 61 72 72 28 63 6e 74 29 20 58 6f 72 20 31 30 30 29 } //00 00 
	condition:
		any of ($a_*)
