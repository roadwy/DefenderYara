...
rule TrojanDownloader_O97M_IcedID_PCO_MTB{
	...
	strings :
		...
		$a_02_2 = {2e 65 78 65 63 20 28 [0-0a] 29 } //1
		...
		$a_02_4 = {53 70 6c 69 74 28 [0-0a] 2c 20 22 7c 22 29 } //1
	condition:
...
rule TrojanDownloader_O97M_IcedID_PCO_MTB_2{
	...
	strings :
		...
		$a_02_1 = {2e 65 78 65 63 20 28 [0-0a] 29 } //1
		$a_02_2 = {3d 20 53 70 6c 69 74 28 [0-0a] 2c 20 22 7c 22 29 } //1
		$a_00_3 = {2e 6a 70 67 22 } //1 .jpg"
		$a_02_4 = {3d 20 53 74 72 43 6f 6e 76 28 [0-0a] 2c 20 76 62 55 6e 69 63 6f 64 65 29 } //1
