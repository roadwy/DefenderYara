...
rule TrojanDownloader_O97M_IcedID_RVC_MTB{
	...
	strings :
		$a_02_0 = {63 3a 5c 70 72 6f 67 72 61 6d 64 61 74 61 5c 90 02 05 2e 70 64 66 90 00 } //1
		$a_02_1 = {4f 70 65 6e 20 22 47 45 54 22 2c 20 90 02 05 2c 20 46 61 6c 73 65 90 00 } //1
		$a_00_2 = {58 4f 64 46 6f 28 2e 53 68 61 70 65 73 28 31 29 2e 54 69 74 6c 65 29 } //1 XOdFo(.Shapes(1).Title)
		$a_02_3 = {4c 65 6e 28 90 02 05 29 20 54 6f 20 31 20 53 74 65 70 20 2d 31 90 00 } //1
		...
		$a_02_6 = {69 64 41 6d 47 28 90 02 05 29 2e 65 78 65 63 90 00 } //1
		$a_02_7 = {4e 43 6c 45 44 28 90 02 05 29 20 26 20 22 20 22 20 26 20 73 42 6d 6e 50 20 26 20 22 2c 53 68 6f 77 44 69 61 22 20 2b 20 22 6c 6f 67 41 20 2d 72 22 90 00 } //1
	condition:
