...
rule TrojanDownloader_O97M_AgentTesla_RVD_MTB{
	...
	strings :
		...
		$a_01_1 = {22 68 74 74 70 73 3a 2f 2f 77 77 77 2e 62 69 74 6c 79 2e 63 6f 6d 2f 61 73 69 61 6a 69 61 } //01 00 
		$a_01_2 = {22 68 74 74 70 73 3a 2f 2f 77 77 77 2e 62 69 74 6c 79 2e 63 6f 6d 2f 61 73 61 68 64 6a 69 61 } //01 00 
