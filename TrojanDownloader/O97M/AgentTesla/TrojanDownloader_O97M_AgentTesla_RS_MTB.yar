...
rule TrojanDownloader_O97M_AgentTesla_RS_MTB{
	meta:
		description = "TrojanDownloader:O97M/AgentTesla.RS!MTB,SIGNATURE_TYPE_MACROHSTR_EXT,05 00 05 00 05 00 00 "
	...
	strings :
		...
		$a_02_2 = {6f 6b 66 66 72 20 3d 20 22 61 6b 90 02 0f 64 64 77 69 64 22 90 00 } //1
