...
rule TrojanDownloader_O97M_Remcos_GM_MTB{
	...
	strings :
		$a_02_0 = {53 65 74 20 90 02 20 20 3d 20 43 72 65 61 74 65 4f 62 6a 65 63 74 28 22 4d 73 78 6d 6c 32 2e 44 4f 4d 44 6f 63 75 6d 65 6e 74 2e 33 2e 30 22 29 90 00 } //1
