...
rule TrojanDownloader_O97M_Rietspoof_A{
	...
	strings :
		$a_03_0 = {2e 52 65 67 57 72 69 74 65 20 90 02 20 2c 90 02 20 2c 90 02 20 28 22 90 02 20 22 29 20 26 20 90 02 20 28 22 90 02 04 22 29 90 00 } //1
		...
		$a_03_3 = {3d 20 53 68 65 6c 6c 28 22 77 73 63 72 69 70 74 2e 65 78 65 20 22 22 22 20 2b 20 90 02 20 20 2b 20 22 22 2c 20 76 62 48 69 64 65 29 90 00 } //1
	condition:
