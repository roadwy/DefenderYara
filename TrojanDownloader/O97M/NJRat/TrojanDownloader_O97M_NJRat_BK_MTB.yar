...
rule TrojanDownloader_O97M_NJRat_BK_MTB{
	...
	strings :
		$a_03_0 = {3d 20 73 53 74 72 20 2b 20 43 68 72 28 43 4c 6e 67 28 22 26 48 22 20 26 20 4d 69 64 28 [0-0f] 2c 20 69 2c 20 32 29 29 20 2d 20 31 33 29 } //1
		$a_03_1 = {69 20 3d 20 31 20 54 6f 20 4c 65 6e 28 [0-0f] 29 20 53 74 65 70 20 32 } //1
