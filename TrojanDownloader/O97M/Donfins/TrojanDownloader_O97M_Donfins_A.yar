...
rule TrojanDownloader_O97M_Donfins_A{
	...
	strings :
		...
		$a_01_1 = {50 72 69 6e 74 20 23 } //01 00  Print #
		$a_01_2 = {43 6c 6f 73 65 20 23 } //01 00  Close #
		$a_01_3 = {46 6f 72 20 4f 75 74 70 75 74 20 41 73 20 23 } //01 00  For Output As #
		$a_01_4 = {2e 46 72 65 65 53 70 61 63 65 20 3e 20 31 30 30 30 30 20 54 68 65 6e } //00 00  .FreeSpace > 10000 Then
	condition:
		any of ($a_*)
