...
rule TrojanDownloader_O97M_Dridex_SS_MTB_2{
	...
	strings :
		$a_03_0 = {57 69 74 68 20 47 65 74 4f 62 6a 65 63 74 28 [0-0f] 29 } //1
		$a_03_1 = {20 3d 20 53 70 6c 69 74 28 [0-0f] 2c 20 [0-0e] 2c 20 [0-0f] 29 } //1
		$a_03_2 = {3d 20 52 65 70 6c 61 63 65 28 [0-0f] 2c 20 [0-0f] 2c 20 [0-0f] 29 } //1
		$a_03_3 = {2e 43 72 65 61 74 65 20 [0-17] 2c 20 4e 75 6c 6c 2c 20 } //1
		$a_03_4 = {46 6f 72 20 [0-0e] 20 3d 20 30 20 54 6f 20 43 4c 6e 67 28 28 } //1
		$a_03_5 = {78 6c 44 69 61 6c 6f [0-2f] 20 58 6f 72 20 } //1
...
rule TrojanDownloader_O97M_Dridex_SS_MTB_3{
	...
	strings :
		$a_03_0 = {2e 45 78 65 63 20 28 22 6d 73 68 74 61 20 22 20 26 20 43 68 72 28 33 34 29 20 26 20 45 6e 76 69 72 6f 6e 28 22 41 4c 4c 55 53 45 52 53 50 52 4f 46 49 4c 45 22 29 20 26 20 22 5c 71 44 69 61 6c 6f 67 47 61 6c 6c 65 72 79 53 63 61 74 74 65 72 2e 73 63 74 22 20 26 20 43 68 72 28 33 34 29 29 [0-03] 45 6e 64 20 57 69 74 68 } //1
		...
		$a_03_3 = {71 47 72 69 64 2e 57 72 69 74 65 20 28 71 41 78 69 73 29 [0-03] 71 47 72 69 64 2e 43 6c 6f 73 65 } //1
	condition:
...
rule TrojanDownloader_O97M_Dridex_SS_MTB_7{
	...
	strings :
		$a_03_0 = {3d 20 52 65 70 6c 61 63 65 28 22 [0-2f] 2e 64 6c 6c 22 2c 20 22 [0-0a] 22 2c 20 22 22 29 } //1
		$a_01_1 = {3d 20 52 65 70 6c 61 63 65 28 } //1 = Replace(
		$a_03_2 = {3d 20 4a 6f 69 6e 28 41 72 72 61 79 28 [0-15] 29 } //1
		$a_03_3 = {2e 4f 70 65 6e 20 [0-1e] 2e } //1
		$a_03_4 = {2e 52 75 6e 20 [0-20] 2e [0-21] 28 [0-0f] 29 2c 20 43 4c 6e 67 28 28 } //1
		...
		$a_03_8 = {2e 53 61 76 65 54 6f 46 69 6c 65 20 [0-20] 2e [0-21] 28 29 20 26 } //1
		$a_03_9 = {29 20 26 20 43 68 72 28 43 4c 6e 67 28 28 [0-20] 29 29 29 20 26 20 22 20 22 20 26 } //1
	condition:
...
rule TrojanDownloader_O97M_Dridex_SS_MTB_11{
	...
	strings :
		$a_03_0 = {3d 20 52 65 70 6c 61 63 65 28 22 [0-2f] 2e 64 6c 6c 22 2c 20 22 [0-0a] 22 2c 20 22 22 29 } //1
		$a_03_1 = {3d 20 4a 6f 69 6e 28 41 72 72 61 79 28 [0-15] 29 } //1
		$a_03_2 = {2e 4f 70 65 6e 20 [0-1e] 2e } //1
		$a_01_3 = {3d 20 52 65 70 6c 61 63 65 28 } //1 = Replace(
		$a_03_4 = {2e 53 61 76 65 54 6f 46 69 6c 65 20 [0-20] 2e [0-21] 28 29 20 26 } //1
		$a_01_5 = {49 66 20 45 72 72 2e 4e 75 6d 62 65 72 20 3c 3e 20 30 20 54 68 65 6e } //1 If Err.Number <> 0 Then
		$a_01_6 = {4d 73 67 20 3d 20 22 54 68 61 6e 6b 20 59 6f 75 21 22 } //1 Msg = "Thank You!"
		...
		$a_03_8 = {2e 70 68 70 22 2c 20 22 [0-0a] 22 2c 20 22 22 29 [0-15] 20 3d 20 4a 6f 69 6e 28 41 72 72 61 79 28 [0-15] 29 29 } //1
		$a_01_9 = {41 70 70 44 61 74 61 } //1 AppData
		$a_03_10 = {29 20 26 20 43 68 72 28 43 4c 6e 67 28 28 [0-20] 29 29 29 20 26 20 22 20 22 20 26 } //1
		$a_03_11 = {2e 52 75 6e 20 [0-20] 2e [0-21] 28 [0-0f] 29 2c 20 43 4c 6e 67 28 28 } //1
	condition:
...
rule TrojanDownloader_O97M_Dridex_SS_MTB_12{
	...
	strings :
		...
		$a_03_9 = {53 65 74 20 [0-15] 20 3d 20 43 72 65 61 74 65 4f 62 6a 65 63 74 28 [0-0f] 29 [0-03] 45 6e 64 20 46 75 6e 63 74 69 6f 6e } //1
		$a_03_10 = {2e 70 68 70 22 2c 20 22 [0-0a] 22 2c 20 22 22 29 [0-15] 20 3d 20 4a 6f 69 6e 28 41 72 72 61 79 28 [0-15] 29 29 } //1
	condition:
