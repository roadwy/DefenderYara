...
rule TrojanDownloader_O97M_Dridex_NYNC_MTB{
	...
	strings :
		$a_03_0 = {63 6f 6d 2f 6f 6c 64 2d 64 61 74 61 2f 77 70 2d 69 6e 63 6c 75 64 65 73 2f 6a 73 2f 74 69 6e 79 6d 63 65 2f 6c 61 6e 67 73 2f 49 30 55 4d 37 6a 42 4b 6d 5a 6d 4a 42 2e 70 68 70 90 0a 5a 00 68 74 74 70 73 3a 2f 2f 62 6f 6e 73 61 69 73 75 70 72 65 6d 65 2e } //1
