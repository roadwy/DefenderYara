...
rule TrojanDownloader_O97M_Dridex_SM_MTB_2{
	...
	strings :
		$a_03_0 = {20 3d 20 53 70 6c 69 74 28 [0-0f] 2c 20 [0-0e] 2c 20 [0-0f] 29 } //1
		...
		$a_03_6 = {57 69 74 68 20 47 65 74 4f 62 6a 65 63 74 28 [0-0f] 29 } //1
		$a_03_7 = {3d 20 52 65 70 6c 61 63 65 28 [0-0f] 2c 20 [0-0f] 2c 20 [0-0f] 29 } //1
	condition:
...
rule TrojanDownloader_O97M_Dridex_SM_MTB_3{
	...
	strings :
		$a_03_0 = {28 53 70 6c 69 74 28 [0-0f] 28 30 29 2c 20 [0-15] 28 4f 61 29 29 29 2c 20 31 29 2c 20 41 5f 6d 69 6e 5f 31 20 26 20 22 5c 22 20 26 20 76 65 67 61 2c 20 67 69 2c 20 67 69 } //1
		$a_01_1 = {55 52 4c 44 6f 77 6e 6c 6f 61 64 54 6f 46 69 6c 65 41 22 20 28 } //1 URLDownloadToFileA" (
		$a_03_2 = {52 75 6e 20 28 [0-0f] 20 26 20 22 } //1
		$a_03_3 = {3d 20 53 70 6c 69 74 28 [0-0f] 2c 20 22 51 22 20 26 20 22 23 22 29 } //1
		$a_03_4 = {3d 20 22 52 22 20 26 20 22 5e 22 [0-03] 49 66 20 [0-03] 20 3d 20 32 20 54 68 65 6e 20 [0-0f] 20 3d 20 22 2b 2b 22 } //1
		$a_03_5 = {46 6f 72 20 61 20 3d 20 30 20 54 6f 20 55 42 6f 75 6e 64 28 [0-0f] 29 20 2d 20 4c 42 6f 75 6e 64 28 90 1b 00 29 20 2b 20 31 } //1
	condition:
