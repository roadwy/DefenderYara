...
rule TrojanDownloader_O97M_Hancitor_C_MTB{
	meta:
		description = "TrojanDownloader:O97M/Hancitor.C!MTB,SIGNATURE_TYPE_MACROHSTR_EXT,06 00 06 00 06 00 00 01 00 "
	...
	strings :
		...
		$a_01_2 = {3d 20 45 6e 76 69 72 6f 6e 28 22 41 50 50 44 41 54 41 22 29 20 26 20 22 5c 4d 69 63 72 6f 73 6f 66 74 5c 57 6f 72 64 5c 53 74 61 72 74 75 70 5c 22 } //01 00  = Environ("APPDATA") & "\Microsoft\Word\Startup\"
		...
		$a_01_4 = {22 68 74 74 70 3a 2f 2f } //01 00  "http://
