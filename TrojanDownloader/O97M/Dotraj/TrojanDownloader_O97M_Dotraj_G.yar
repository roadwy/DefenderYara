...
rule TrojanDownloader_O97M_Dotraj_G{
	...
	strings :
		...
		$a_00_1 = {77 73 63 72 69 70 74 2e 73 68 65 6c 6c } //00 00 
	condition:
		any of ($a_*)
...
rule TrojanDownloader_O97M_Dotraj_G_3{
	...
	strings :
		$a_00_0 = {43 72 65 61 74 65 4f 62 6a 65 63 74 28 22 73 68 65 6c 6c 2e 61 70 70 6c 69 63 61 74 69 6f 6e 22 29 } //01 00 
		$a_00_1 = {53 65 6c 65 63 74 69 6f 6e 2e 54 79 70 65 54 65 78 74 20 28 } //01 00 
		$a_00_2 = {41 63 74 69 76 65 44 6f 63 75 6d 65 6e 74 2e 50 61 73 73 77 6f 72 64 20 3d 20 } //0a 00 
