...
rule TrojanDownloader_O97M_Dotraj_P{
	...
	strings :
		...
		$a_03_2 = {57 72 69 74 65 20 90 02 10 2e 52 65 73 70 6f 6e 73 65 42 6f 64 79 90 00 } //1
		$a_02_3 = {50 75 62 6c 69 63 20 53 75 62 20 41 75 74 6f 5f 4f 70 65 6e 28 29 90 02 ff 90 02 ff 90 02 ff 2e 65 78 65 63 20 28 22 90 02 10 2e 65 78 65 22 29 90 00 } //10
	condition:
