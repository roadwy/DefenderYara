...
rule TrojanDownloader_O97M_Endeeto_B{
	...
	strings :
		...
		$a_01_2 = {50 75 62 6c 69 63 20 53 75 62 20 57 50 41 4d 48 4f 28 29 0d 0a 20 20 20 20 44 6f 77 6e 6c 6f 61 64 5f 46 69 6c 65 } //1
		...
		$a_01_4 = {45 6e 76 69 72 6f 6e 28 22 48 4f 4d 45 50 41 54 48 22 29 } //1 Environ("HOMEPATH")
	condition:
