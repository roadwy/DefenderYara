...
rule TrojanDownloader_O97M_Endeeto_A{
	...
	strings :
		...
		$a_01_2 = {2e 53 65 6e 64 20 22 31 32 33 64 74 22 } //01 00  .Send "123dt"
		...
		$a_01_4 = {47 6c 72 65 67 20 3d 20 45 6e 76 69 72 6f 6e 28 22 57 49 4e 44 49 52 22 29 } //00 00  Glreg = Environ("WINDIR")
	condition:
		any of ($a_*)
