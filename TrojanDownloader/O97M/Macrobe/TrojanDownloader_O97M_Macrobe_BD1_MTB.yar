...
rule TrojanDownloader_O97M_Macrobe_BD1_MTB{
	...
	strings :
		$a_03_0 = {76 61 72 30 20 3d 20 22 4d 53 48 54 41 20 68 74 74 70 73 3a 2f 2f 90 02 0d 2e 73 73 6c 62 6c 69 6e 64 61 64 6f 2e 63 6f 6d 2f 90 02 0c 2e 90 03 03 04 68 74 61 68 74 6d 6c 22 90 00 } //1
