...
rule TrojanDownloader_O97M_Cridex_DHA_MTB{
	...
	strings :
		...
		$a_81_1 = {28 53 74 72 52 65 76 65 72 73 65 28 22 70 6d 65 74 22 29 29 20 26 20 22 5c 73 6e 2e 74 6d 70 22 } //0a 00 
		$a_81_2 = {28 53 74 72 52 65 76 65 72 73 65 28 22 3d 3d 77 63 7a 56 32 59 76 4a 48 55 66 4a 7a 4d 75 6c 32 56 36 4d 48 64 74 64 57 62 75 6c 32 64 22 29 29 } //01 00 
		...
		$a_81_6 = {3d 20 53 74 72 52 65 76 65 72 73 65 28 22 76 73 67 65 72 22 29 } //00 00 
	condition:
		any of ($a_*)
