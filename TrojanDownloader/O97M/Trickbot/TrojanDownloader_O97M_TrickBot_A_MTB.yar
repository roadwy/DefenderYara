...
rule TrojanDownloader_O97M_TrickBot_A_MTB{
	...
	strings :
		...
		$a_03_2 = {43 75 72 44 65 70 20 3d 20 43 75 72 44 65 70 20 2b 20 [0-16] 20 2a 20 43 65 69 6c 28 [0-18] 20 2b 20 [0-18] 20 2a 20 47 65 74 42 61 63 6b 29 } //1
		$a_03_3 = {76 69 73 69 74 63 6d 64 2e 57 72 69 74 65 4c 69 6e 65 20 28 22 73 74 61 72 74 20 63 3a 5c 47 72 6f 75 70 4c 6f 67 73 5c [0-10] 2e 65 78 65 22 29 } //1
	condition:
