...
rule TrojanDownloader_O97M_Powdow_RPA_MTB{
	...
	strings :
		$a_03_0 = {63 6f 6e 74 6f 73 6f 66 6f 72 72 65 73 74 65 72 64 65 6d 6f 2e 62 6c 6f 62 2e 63 6f 72 65 2e 77 69 6e 64 6f 77 73 2e 6e 65 74 2f 64 6f 63 73 2f 6c 6f 61 64 65 72 6f 75 74 6f 6e 65 6c 69 6e 65 72 2e 70 73 31 27 29 29 90 0a 9f 00 64 6f 77 6e 6c 6f 61 64 73 74 72 69 6e 67 28 27 68 74 74 70 73 3a 2f 2f 90 00 } //1
