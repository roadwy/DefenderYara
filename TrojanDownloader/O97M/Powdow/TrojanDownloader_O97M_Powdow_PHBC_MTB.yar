...
rule TrojanDownloader_O97M_Powdow_PHBC_MTB{
	...
	strings :
		...
		$a_03_1 = {44 65 73 74 69 6e 61 74 69 6f 6e 20 43 3a 5c 55 73 65 72 73 5c 50 75 62 6c 69 63 5c 44 6f 63 75 6d 65 6e 74 73 5c 90 02 14 2e 65 60 78 65 90 00 } //1
	condition:
