...
rule TrojanDownloader_O97M_Powdow_SHS_MTB_2{
	meta:
		description = "TrojanDownloader:O97M/Powdow.SHS!MTB,SIGNATURE_TYPE_MACROHSTR_EXT,06 00 06 00 06 00 00 01 00 "
		
	strings :
		$a_03_0 = {3d 20 56 42 41 2e 43 72 65 61 74 65 4f 62 6a 65 63 74 28 90 02 1f 28 22 90 02 2f 22 29 20 26 20 90 02 1f 28 22 90 02 2f 22 29 29 90 00 } //01 00 
		$a_01_1 = {2e 45 78 70 61 6e 64 45 6e 76 69 72 6f 6e 6d 65 6e 74 53 74 72 69 6e 67 73 28 22 25 54 45 4d 50 25 22 29 20 26 20 22 5c 63 79 6d 5f 31 36 30 30 31 33 38 30 34 33 30 42 44 38 34 42 32 34 2e 65 78 65 22 } //01 00  .ExpandEnvironmentStrings("%TEMP%") & "\cym_16001380430BD84B24.exe"
		$a_01_2 = {6f 62 6a 53 68 65 6c 6c 2e 52 75 6e 20 28 4e 61 6d 65 64 29 } //01 00  objShell.Run (Named)
		$a_03_3 = {3d 20 43 72 65 61 74 65 4f 62 6a 65 63 74 28 90 02 1f 28 22 90 02 2f 22 29 20 26 20 90 02 1f 28 22 90 02 2f 22 29 29 90 00 } //01 00 
		$a_03_4 = {2e 63 72 65 61 74 65 45 6c 65 6d 65 6e 74 28 90 02 1f 28 22 90 02 2f 22 29 29 90 00 } //01 00 
		$a_03_5 = {45 4c 2e 44 61 74 61 54 79 70 65 20 3d 20 90 02 1f 28 22 90 02 2f 22 29 20 26 20 90 02 1f 28 22 90 02 2f 22 29 90 00 } //00 00 
	condition:
		any of ($a_*)
