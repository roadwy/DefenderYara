...
rule TrojanDownloader_O97M_Powdow_SHS_MTB_2{
	...
	strings :
		$a_03_0 = {3d 20 56 42 41 2e 43 72 65 61 74 65 4f 62 6a 65 63 74 28 90 02 1f 28 22 90 02 2f 22 29 20 26 20 90 02 1f 28 22 90 02 2f 22 29 29 90 00 } //1
		...
		$a_03_3 = {3d 20 43 72 65 61 74 65 4f 62 6a 65 63 74 28 90 02 1f 28 22 90 02 2f 22 29 20 26 20 90 02 1f 28 22 90 02 2f 22 29 29 90 00 } //1
		$a_03_4 = {2e 63 72 65 61 74 65 45 6c 65 6d 65 6e 74 28 90 02 1f 28 22 90 02 2f 22 29 29 90 00 } //1
		$a_03_5 = {45 4c 2e 44 61 74 61 54 79 70 65 20 3d 20 90 02 1f 28 22 90 02 2f 22 29 20 26 20 90 02 1f 28 22 90 02 2f 22 29 90 00 } //1
	condition:
