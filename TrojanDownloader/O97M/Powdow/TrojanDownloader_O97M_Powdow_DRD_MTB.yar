...
rule TrojanDownloader_O97M_Powdow_DRD_MTB{
	...
	strings :
		...
		$a_03_1 = {6c 61 73 74 6c 69 6e 65 64 65 6d 6f 2e 63 6f 6d 2f 64 65 6d 6f 2f 74 65 73 74 66 69 6c 65 73 2f 73 61 6d 70 6c 65 2f 73 61 6d 70 6c 65 5f 65 78 65 5f 30 30 2e 65 78 65 90 0a 3f 00 68 74 74 70 3a 2f 2f 90 00 } //1
