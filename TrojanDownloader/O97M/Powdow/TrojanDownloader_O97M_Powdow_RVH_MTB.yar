...
rule TrojanDownloader_O97M_Powdow_RVH_MTB_2{
	...
	strings :
		...
		$a_03_1 = {65 72 72 6f 72 43 6f 64 65 20 3d 90 02 09 22 70 6f 77 65 72 73 68 65 6c 6c 2e 65 78 65 20 2d 45 78 65 63 75 74 69 6f 6e 50 6f 6c 69 63 79 20 62 79 70 61 73 73 90 00 } //1
