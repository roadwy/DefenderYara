...
rule TrojanDownloader_O97M_Powdow_PX_MTB{
	...
	strings :
		...
		$a_02_1 = {68 74 74 70 3a 2f 2f 33 35 2e 31 37 38 2e 37 35 2e 36 39 2f 38 2f [0-0a] 2e 6a 70 67 } //1
		$a_00_2 = {53 74 61 72 74 2d 50 72 6f 63 65 73 73 20 2d 46 69 6c 65 50 61 74 68 } //1 Start-Process -FilePath
		$a_02_3 = {43 3a 5c 55 73 65 72 73 5c 50 75 62 6c 69 63 5c 56 69 64 65 6f 73 5c [0-0a] 2e 65 78 65 } //1
