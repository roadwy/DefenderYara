...
rule TrojanDownloader_O97M_Powdow_DPJ_MTB{
	...
	strings :
		$a_01_0 = {2b 22 28 27 68 74 74 70 73 3a 2f 2f 70 6c 61 7a 61 62 6f 75 6c 65 76 61 72 64 2e 63 6f 6d 2e 62 72 2f 64 6f 67 2e 70 64 66 27 29 2d 22 2b 22 75 22 2b 22 73 22 2b 22 3f 22 2b 22 62 22 2b } //01 00  +"('https://plazaboulevard.com.br/dog.pdf')-"+"u"+"s"+"?"+"b"+
