...
rule TrojanDownloader_O97M_Powdow_SMA_MTB{
	...
	strings :
		$a_01_0 = {2e 44 6f 77 6e 22 20 26 20 22 6c 6f 61 22 20 26 20 22 64 53 74 72 22 20 26 20 22 69 6e 67 28 20 27 68 74 74 70 73 3a 2f 2f 70 74 2e 74 65 78 74 62 69 6e 2e 6e 65 74 2f 64 6f 77 6e 6c 6f 61 64 2f 78 37 73 66 36 74 32 64 67 76 27 20 29 } //01 00  .Down" & "loa" & "dStr" & "ing( 'https://pt.textbin.net/download/x7sf6t2dgv' )
		$a_01_1 = {7c 20 4f 75 74 2d 46 69 6c 65 20 2d 46 69 6c 65 50 61 74 68 20 78 2e 6a 73 20 2d 66 6f 72 63 65 } //01 00  | Out-File -FilePath x.js -force
		$a_03_2 = {43 61 6c 6c 20 53 68 65 6c 6c 28 22 70 6f 77 65 72 73 68 65 6c 6c 2e 65 78 65 20 2d 63 6f 6d 6d 61 6e 64 20 22 20 26 20 90 02 1f 20 26 20 22 20 3b 20 65 78 69 74 20 22 2c 20 76 62 48 69 64 65 29 90 00 } //00 00 
	condition:
		any of ($a_*)
