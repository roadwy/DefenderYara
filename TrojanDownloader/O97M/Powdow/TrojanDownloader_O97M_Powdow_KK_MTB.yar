...
rule TrojanDownloader_O97M_Powdow_KK_MTB_4{
	...
	strings :
		$a_03_0 = {2e 43 72 65 61 74 65 4f 62 6a 65 63 74 28 22 77 73 63 72 69 70 74 2e 73 22 20 26 20 73 68 65 29 2e 65 78 65 63 28 90 02 0d 20 26 20 90 02 0d 20 26 20 22 20 2d 77 20 22 20 26 20 73 65 61 73 65 20 26 20 22 20 49 6e 76 6f 6b 65 2d 57 65 62 52 65 71 75 65 73 74 20 2d 55 72 69 90 00 } //1
		...
		$a_03_2 = {2d 4f 75 74 46 22 20 26 20 22 69 6c 65 20 22 20 26 20 43 68 72 28 33 34 29 20 26 20 22 43 3a 5c 55 73 65 72 73 5c 50 75 62 6c 69 63 5c 44 6f 63 75 6d 65 6e 74 73 5c 90 02 0f 2e 65 78 90 00 } //1
	condition:
