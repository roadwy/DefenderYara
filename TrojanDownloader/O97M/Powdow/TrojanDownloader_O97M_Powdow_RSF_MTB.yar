...
rule TrojanDownloader_O97M_Powdow_RSF_MTB{
	...
	strings :
		$a_03_0 = {77 77 77 31 31 36 2e 7a 69 70 70 79 73 68 61 72 65 2e 63 6f 6d 2f 64 2f 33 73 57 71 68 6b 33 51 2f 32 36 39 2f 74 65 73 74 2e 70 73 31 90 0a 3d 00 24 77 65 62 20 3d 20 27 68 74 74 70 73 3a 2f 2f 90 00 } //1
