...
rule TrojanDownloader_O97M_Powdow_ULY_MTB{
	...
	strings :
		...
		$a_01_2 = {49 6e 76 6f 6b 65 28 28 27 68 74 27 2b 27 74 70 73 3a 2f 2f 74 69 6e 79 75 72 6c 2e 63 6f 6d 2f 79 34 70 74 68 65 64 32 27 29 2c 27 79 65 2e 65 78 65 27 29 } //00 00  Invoke(('ht'+'tps://tinyurl.com/y4pthed2'),'ye.exe')
	condition:
		any of ($a_*)
