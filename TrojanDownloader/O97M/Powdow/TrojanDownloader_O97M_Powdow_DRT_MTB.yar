...
rule TrojanDownloader_O97M_Powdow_DRT_MTB{
	...
	strings :
		...
		$a_03_1 = {55 73 65 72 73 5c 50 75 62 6c 69 63 5c 44 6f 63 75 6d 65 6e 74 73 5c 69 73 73 75 65 70 6f 6c 69 74 69 63 61 6c 2e 65 78 90 0a 2b 00 43 3a 5c 90 00 } //1
		...
		$a_03_3 = {69 6b 6c 61 6e 67 72 61 74 69 73 73 75 72 61 62 61 79 61 2e 73 6b 6f 6d 2e 69 64 2f 7a 78 2f 46 73 62 65 79 2e 65 78 22 20 26 20 43 68 72 28 31 30 31 29 90 0a 3a 00 68 74 74 70 3a 2f 2f 90 00 } //1
	condition:
