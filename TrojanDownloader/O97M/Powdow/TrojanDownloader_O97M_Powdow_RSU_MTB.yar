...
rule TrojanDownloader_O97M_Powdow_RSU_MTB{
	...
	strings :
		$a_02_0 = {77 77 77 2e 6d 69 6e 70 69 63 2e 64 65 2f 6b 2f 62 64 62 70 2f 31 36 67 6b 34 68 2f 27 90 0a 30 00 2e 49 6e 56 6f 6b 45 28 28 28 27 68 74 74 70 73 3a 2f 2f } //1
