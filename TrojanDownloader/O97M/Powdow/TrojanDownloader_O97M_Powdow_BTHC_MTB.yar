...
rule TrojanDownloader_O97M_Powdow_BTHC_MTB{
	...
	strings :
		...
		$a_03_2 = {2e 43 72 65 61 74 65 20 70 28 72 6d 29 90 0c 02 00 45 6e 64 20 53 75 62 90 00 } //1
		...
		$a_03_5 = {3d 20 53 74 72 52 65 76 65 72 73 65 28 22 61 74 68 2e 90 02 30 5c 61 74 61 64 6d 61 72 67 6f 72 70 5c 3a 63 20 65 78 65 2e 72 65 72 6f 6c 70 78 65 5c 73 77 6f 64 6e 69 77 5c 3a 63 22 29 90 00 } //1
	condition:
