...
rule TrojanDownloader_O97M_Powdow_RSV_MTB{
	...
	strings :
		...
		$a_02_4 = {22 70 6f 77 22 0d 0a 90 02 0a 20 3d 20 22 65 72 73 68 65 22 0d 0a 90 02 0a 20 3d 20 22 6c 6c 2e 65 78 65 22 90 00 } //1
		...
		$a_02_6 = {70 73 68 65 6c 6c 50 61 74 68 20 3d 20 22 43 3a 5c 5c 57 69 6e 64 6f 77 73 5c 5c 53 79 73 74 65 6d 33 32 5c 5c 22 20 90 02 0d 20 22 5c 5c 76 31 2e 30 5c 5c 22 90 00 } //1
	condition:
