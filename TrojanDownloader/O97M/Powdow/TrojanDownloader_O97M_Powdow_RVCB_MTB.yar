...
rule TrojanDownloader_O97M_Powdow_RVCB_MTB_2{
	...
	strings :
		$a_03_0 = {78 78 78 78 78 78 5f 2e 5f 6c 6f 61 64 28 22 68 74 74 70 [0-64] 2e 74 78 74 22 29 78 78 78 78 78 78 5f 2e 5f 74 72 61 6e 73 66 6f 72 6d 6e 6f 64 65 78 78 78 78 78 78 65 6e 64 73 75 62 } //1
