...
rule TrojanDownloader_O97M_Powdow_RSG_MTB{
	...
	strings :
		$a_03_0 = {61 69 6d 73 6d 6f 74 69 6f 6e 2e 63 6f 6d 2e 6d 79 2f 64 61 74 61 31 2f 69 6d 61 67 65 73 2f 31 32 33 2e 65 78 65 20 2d 4f 75 74 46 69 6c 65 90 0a 37 00 68 74 74 70 73 3a 2f 2f } //1
