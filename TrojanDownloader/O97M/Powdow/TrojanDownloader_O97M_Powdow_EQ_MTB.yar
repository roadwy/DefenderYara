...
rule TrojanDownloader_O97M_Powdow_EQ_MTB{
	...
	strings :
		$a_01_0 = {68 74 74 70 3a 2f 2f 75 72 65 66 65 72 65 2e 6f 72 67 2f 6f 70 78 65 2e 65 78 65 } //01 00 
		$a_01_1 = {43 3a 5c 49 46 79 52 4f 6c 48 5c 66 6c 68 74 77 4c 67 5c 69 72 43 77 61 70 49 2e 65 78 } //01 00 
