...
rule TrojanDownloader_O97M_Powdow_ALT_MTB_3{
	...
	strings :
		...
		$a_03_2 = {53 65 74 20 57 73 68 53 68 65 6c 6c 20 3d 20 43 72 65 61 74 65 4f 62 6a 65 63 74 28 22 57 53 63 72 69 70 74 2e 53 68 65 6c 6c 22 29 [0-20] 53 70 65 63 69 61 6c 50 61 74 68 20 3d 20 57 73 68 53 68 65 6c 6c 2e 53 70 65 63 69 61 6c 46 6f 6c 64 65 72 73 28 22 52 65 63 65 6e 74 22 29 } //1
		$a_03_3 = {2e 53 74 61 74 75 73 20 3d 20 32 30 30 20 54 68 65 6e 90 0c 02 00 53 65 74 } //1
		$a_03_4 = {46 75 6e 63 74 69 6f 6e 20 [0-35] 28 29 20 41 73 20 [0-10] 43 61 6c 6c 20 [0-40] 45 6e 64 20 46 75 6e 63 74 69 6f 6e } //1
		$a_03_5 = {69 2c 20 31 29 [0-20] 45 6e 64 20 49 66 [0-20] 4e 65 78 74 } //1
	condition:
