...
rule TrojanDownloader_O97M_Powdow_AA_MTB{
	...
	strings :
		...
		$a_03_1 = {2e 57 72 69 74 65 20 43 68 72 28 43 42 79 74 65 28 22 26 48 22 20 26 20 4d 69 64 28 90 02 20 2c 20 6c 70 2c 20 32 29 29 29 3a 20 4e 65 78 74 3a 20 45 6e 64 20 57 69 74 68 3a 20 6f 62 6a 46 69 6c 65 2e 43 6c 6f 73 65 90 00 } //1
