...
rule TrojanDownloader_O97M_Powdow_BB_MTB_5{
	...
	strings :
		...
		$a_03_1 = {2e 57 72 69 74 65 4c 69 6e 65 20 90 02 14 20 26 20 90 02 14 20 26 20 22 20 2d 77 20 68 69 20 73 6c 5e 65 65 70 20 2d 53 65 20 33 31 3b 53 74 61 5e 72 74 2d 42 69 74 73 54 72 5e 61 6e 73 5e 66 65 72 20 2d 53 6f 75 72 63 65 20 68 74 74 90 00 } //1
...
rule TrojanDownloader_O97M_Powdow_BB_MTB_7{
	...
	strings :
		...
		$a_03_1 = {28 53 74 72 52 65 76 65 72 73 65 28 22 70 6d 65 74 22 29 29 20 26 20 22 5c 90 02 05 2e 74 6d 70 22 90 00 } //1
		$a_03_2 = {2e 44 61 74 61 54 79 70 65 20 3d 20 22 62 69 6e 2e 62 61 73 65 36 34 22 90 0c 02 00 2e 54 65 78 74 90 00 } //1
		$a_03_3 = {2e 43 72 65 61 74 65 20 90 02 08 28 29 20 2b 20 22 20 22 20 2b 90 00 } //1
		...
		$a_03_5 = {3d 20 56 42 41 2e 43 72 65 61 74 65 4f 62 6a 65 63 74 28 90 02 03 29 90 0c 02 00 45 6e 64 20 46 75 6e 63 74 69 6f 6e 90 00 } //1
	condition:
