...
rule TrojanDownloader_O97M_Powdow_DA_MTB{
	...
	strings :
		...
		$a_03_1 = {48 65 72 74 69 31 20 3d 20 45 6e 76 69 72 6f 6e 28 22 75 73 65 72 70 72 6f 66 69 6c 65 22 29 20 26 20 22 5c 22 20 26 20 52 6e 64 28 90 02 06 29 20 26 20 22 2e 63 6f 6d 22 90 00 } //10
