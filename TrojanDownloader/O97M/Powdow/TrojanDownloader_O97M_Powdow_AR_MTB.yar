...
rule TrojanDownloader_O97M_Powdow_AR_MTB_3{
	...
	strings :
		...
		$a_03_1 = {53 68 65 6c 6c 20 53 74 72 52 65 76 65 72 73 65 28 22 [0-1e] 26 20 22 2e 22 20 26 20 22 6a 5c 5c 3a 73 22 20 26 20 22 70 74 74 68 22 [0-0f] 61 22 20 26 20 22 74 22 20 26 20 22 68 22 20 26 20 22 73 22 20 26 20 22 6d 22 20 26 20 22 22 22 22 29 } //10
	condition:
...
rule TrojanDownloader_O97M_Powdow_AR_MTB_6{
	...
	strings :
		...
		$a_03_1 = {70 61 74 68 20 3d 20 70 61 74 68 20 26 20 22 [0-09] 2e 74 78 74 } //1
		$a_03_2 = {6f 75 74 70 75 74 20 3d 20 53 70 6c 69 74 28 [0-0f] 2c 20 22 26 } //1
		...
		$a_03_5 = {3d 20 22 63 6d 64 20 2f 63 20 63 64 20 2f 64 20 25 55 53 45 52 50 52 4f 46 49 4c 45 25 20 26 26 20 72 65 6e 20 [0-09] 2e 74 78 74 20 90 1b 00 2e 65 78 65 20 26 26 [0-09] 68 74 74 70 3a 2f 2f } //10
		$a_03_6 = {3d 20 53 68 65 6c 6c 28 [0-0f] 2c 20 76 62 48 69 64 65 29 } //1
	condition:
...
rule TrojanDownloader_O97M_Powdow_AR_MTB_8{
	...
	strings :
		...
		$a_03_3 = {4c 6d 56 34 5a 58 30 37 49 43 59 67 65 31 4e 30 59 58 4a 30 4c 56 42 79 62 32 4e 6c 63 33 4d 67 4c 55 5a 70 62 47 56 51 59 58 52 6f 49 43 4a 44 4f 6c 78 56 63 32 56 79 63 31 78 51 64 57 4a 73 61 57 4e 63 55 47 6c 6a 64 48 56 79 5a 58 4e 63 [0-14] 4c 6d 56 34 5a 53 4a 39 49 67 } //10
	condition:
