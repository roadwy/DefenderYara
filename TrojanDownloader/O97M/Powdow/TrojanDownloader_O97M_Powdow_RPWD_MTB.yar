...
rule TrojanDownloader_O97M_Powdow_RPWD_MTB{
	...
	strings :
		$a_03_0 = {2e 64 6f 77 6e 6c 6f 61 64 73 74 72 69 6e 67 28 27 68 74 74 70 3a 2f 2f 31 33 38 2e 32 30 31 2e 31 34 39 2e 34 33 2f [0-1f] 2f [0-07] 2e 70 73 31 27 29 } //1
