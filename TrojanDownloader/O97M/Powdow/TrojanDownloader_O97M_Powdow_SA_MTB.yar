...
rule TrojanDownloader_O97M_Powdow_SA_MTB{
	...
	strings :
		...
		$a_03_1 = {53 68 65 6c 6c 20 45 6e 76 69 72 6f 6e 24 28 22 43 4f 4d 53 50 45 43 22 29 20 26 90 02 79 6c 6f 63 61 6c 68 6f 73 74 20 26 20 22 20 26 20 50 53 68 65 6c 6c 43 6f 64 65 2c 20 76 62 48 69 64 65 90 00 } //1
