...
rule TrojanDownloader_O97M_Powdow_ALS_MTB{
	...
	strings :
		$a_03_0 = {50 72 69 76 61 74 65 20 53 75 62 20 43 6f 6d 6d 61 6e 64 42 75 74 74 6f 6e 31 5f 43 6c 69 63 6b 28 29 90 02 06 45 6e 64 20 53 75 62 90 00 } //1
		...
		$a_03_2 = {53 75 62 20 5f 90 0c 02 00 41 75 74 6f 5f 4f 70 65 6e 20 5f 90 0c 02 00 28 29 90 00 } //1
