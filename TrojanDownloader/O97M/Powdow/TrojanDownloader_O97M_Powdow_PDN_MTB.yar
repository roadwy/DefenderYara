...
rule TrojanDownloader_O97M_Powdow_PDN_MTB{
	...
	strings :
		...
		$a_03_1 = {6f 62 6a 53 68 65 6c 6c 2e 43 72 65 61 74 65 4f 62 6a 65 63 74 28 22 53 68 65 6c 6c 2e 41 70 70 6c 69 63 61 74 69 6f 6e 22 29 2e 73 68 65 6c 6c 65 78 65 63 75 74 65 20 6c 75 6c 2e 6c 6f 6c 2c 20 22 68 74 74 70 3a 2f 2f 77 77 77 2e 6a 2e 6d 70 2f 90 02 2f 22 2c 90 00 } //1
