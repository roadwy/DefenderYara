...
rule TrojanDownloader_O97M_Powdow_TTY_MTB{
	...
	strings :
		...
		$a_01_2 = {22 49 6e 76 6f 6b 65 22 28 27 68 74 74 70 73 3a 2f 2f 63 75 74 74 2e 6c 79 2f 67 68 63 67 52 71 61 27 2c 27 70 64 } //00 00  "Invoke"('https://cutt.ly/ghcgRqa','pd
	condition:
		any of ($a_*)
