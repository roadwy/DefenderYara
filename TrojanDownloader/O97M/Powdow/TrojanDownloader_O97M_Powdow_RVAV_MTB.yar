...
rule TrojanDownloader_O97M_Powdow_RVAV_MTB{
	...
	strings :
		$a_03_0 = {2e 44 6f 77 6e 6c 6f 61 64 53 74 72 69 6e 67 28 27 68 74 74 70 3a 2f 2f 34 36 2e 34 2e 31 39 38 2e 35 35 2f 90 01 01 2f 62 6f 6f 6b 2e 70 73 31 27 29 90 00 } //1
