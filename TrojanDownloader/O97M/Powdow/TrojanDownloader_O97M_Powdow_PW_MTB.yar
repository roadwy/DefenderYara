...
rule TrojanDownloader_O97M_Powdow_PW_MTB{
	...
	strings :
		...
		$a_02_1 = {63 6f 6d 2f 77 70 2d 69 6e 63 6c 75 64 65 73 2f 49 44 33 2f 7a 2f 90 02 06 2e 6a 70 67 90 0a 32 00 68 74 74 70 3a 2f 2f 77 65 65 73 68 6f 70 70 69 2e 90 00 } //1
		$a_00_2 = {53 74 61 72 74 2d 50 72 6f 63 65 73 73 20 2d 46 69 6c 65 50 61 74 68 } //1 Start-Process -FilePath
		$a_02_3 = {43 3a 5c 55 73 65 72 73 5c 50 75 62 6c 69 63 5c 90 02 0a 2e 65 78 65 90 00 } //1
