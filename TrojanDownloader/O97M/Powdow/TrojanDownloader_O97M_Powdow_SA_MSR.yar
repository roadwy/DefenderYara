...
rule TrojanDownloader_O97M_Powdow_SA_MSR{
	...
	strings :
		...
		$a_03_1 = {43 3a 5c 44 69 73 6b 44 72 69 76 65 5c 31 5c 56 6f 6c 75 6d 65 5c 42 61 63 6b 46 69 6c 65 73 5c [0-09] 2e 6a 73 65 } //1
		$a_03_2 = {6e 64 6f 65 2e 6a 70 20 43 3a 5c 44 69 73 6b 44 72 69 76 65 5c 31 5c 56 6f 6c 75 6d 65 5c 42 61 63 6b 46 69 6c 65 73 5c [0-07] 2e 65 78 65 } //1
	condition:
