...
rule TrojanDownloader_O97M_Powdow_BTHB_MTB{
	...
	strings :
		$a_03_0 = {3d 20 22 63 3a 5c 77 69 6e 64 6f 77 73 5c 65 78 70 6c 6f 72 65 72 2e 65 78 65 20 63 3a 5c 70 72 6f 67 72 61 6d 64 61 74 61 5c 90 02 12 2e 68 74 61 22 90 00 } //1
		...
		$a_03_5 = {66 72 6d 2e 62 75 74 74 6f 6e 31 5f 43 6c 69 63 6b 90 0c 02 00 45 6e 64 20 53 75 62 90 00 } //1
	condition:
