...
rule TrojanDownloader_O97M_Ursnif_AE_MTB{
	...
	strings :
		...
		$a_01_2 = {2e 43 6f 6e 74 72 6f 6c 73 28 31 29 2e 56 61 6c 75 65 } //01 00 
		$a_01_3 = {3d 20 46 69 78 28 } //01 00 
		$a_01_4 = {2e 43 6f 6e 74 72 6f 6c 73 28 30 20 2b 20 31 29 } //01 00 
		$a_01_5 = {2e 4f 70 65 6e } //01 00 
