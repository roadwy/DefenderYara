...
rule TrojanDownloader_O97M_Ursnif_BD_MTB{
	...
	strings :
		...
		$a_03_4 = {74 65 6d 70 5c 90 02 10 2e 78 90 00 } //1
		$a_03_5 = {56 42 41 2e 49 6e 74 65 72 61 63 74 69 6f 6e 90 01 01 2e 53 68 65 6c 6c 40 20 90 02 10 2c 90 00 } //1
	condition:
...
rule TrojanDownloader_O97M_Ursnif_BD_MTB_2{
	...
	strings :
		$a_03_0 = {4f 70 65 6e 20 22 90 02 10 2e 78 22 20 2b 20 90 02 10 20 46 6f 72 20 4f 75 74 70 75 74 20 41 73 20 23 90 00 } //1
		...
		$a_03_5 = {3d 20 53 74 72 52 65 76 65 72 73 65 28 90 02 10 29 90 0c 02 00 43 61 6c 6c 20 90 02 10 2e 65 78 65 63 28 90 02 10 29 90 00 } //1
	condition:
