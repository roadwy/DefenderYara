...
rule TrojanDownloader_O97M_Ursnif_AC_MTB{
	...
	strings :
		...
		$a_01_1 = {2e 43 6f 6e 74 72 6f 6c 73 28 30 29 } //01 00  .Controls(0)
		...
		$a_01_6 = {3d 20 43 68 72 28 31 31 35 29 20 2b 20 22 68 22 20 2b 20 22 65 6c 6c 22 } //01 00  = Chr(115) + "h" + "ell"
