...
rule TrojanDownloader_O97M_Ursnif_FTIV_MTB{
	meta:
		description = "TrojanDownloader:O97M/Ursnif.FTIV!MTB,SIGNATURE_TYPE_MACROHSTR_EXT,07 00 07 00 07 00 00 01 00 "
	...
	strings :
		...
		$a_01_5 = {3c 68 74 6d 6c 3e 3c 62 6f 64 79 3e 3c 64 69 76 22 20 2b 20 22 20 69 64 3d 27 63 6f 6e 74 65 6e 74 27 3e 66 54 } //01 00  <html><body><div" + " id='content'>fT
		$a_03_6 = {43 6c 6f 73 65 20 23 31 90 0c 02 00 45 6e 64 20 46 75 6e 63 74 69 6f 6e 90 00 } //00 00 
	condition:
		any of ($a_*)
