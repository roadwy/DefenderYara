...
rule TrojanDownloader_O97M_Ursnif_AI_MTB{
	...
	strings :
		$a_03_0 = {26 20 22 5c [0-10] 2e 22 20 26 20 [0-08] 20 26 20 22 6c 22 } //1
		$a_03_1 = {3d 20 43 68 72 28 22 26 68 22 20 26 20 4d 69 64 28 [0-08] 2c 20 [0-10] 2c 20 [0-10] 29 29 } //1
