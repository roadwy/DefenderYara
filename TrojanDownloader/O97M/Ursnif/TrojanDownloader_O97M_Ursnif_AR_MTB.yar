...
rule TrojanDownloader_O97M_Ursnif_AR_MTB{
	...
	strings :
		...
		$a_03_2 = {28 22 74 6d 70 22 29 20 26 20 22 5c 90 02 09 2e 74 6d 70 22 90 00 } //1
	condition:
...
rule TrojanDownloader_O97M_Ursnif_AR_MTB_2{
	...
	strings :
		...
		$a_03_1 = {2e 43 6f 6e 74 72 6f 6c 73 28 90 02 55 29 2e 54 65 78 74 90 00 } //1
		$a_03_2 = {4f 70 65 6e 20 54 72 69 6d 28 90 02 55 29 20 46 6f 72 20 4f 75 74 70 75 74 20 41 73 20 23 90 00 } //1
		$a_03_3 = {50 72 69 6e 74 20 23 90 01 01 2c 20 54 72 69 6d 28 90 00 } //1
...
rule TrojanDownloader_O97M_Ursnif_AR_MTB_3{
	...
	strings :
		$a_03_0 = {3d 20 45 6e 76 69 72 6f 6e 28 90 02 0f 29 0d 0a 49 66 20 53 65 63 6f 6e 64 28 22 90 02 02 3a 90 02 02 3a 90 02 02 22 29 20 3d 20 22 90 04 02 03 30 2d 39 22 20 54 68 65 6e 0d 0a 90 02 0a 20 3d 20 52 65 70 6c 61 63 65 28 90 1b 05 2c 20 22 5c 22 2c 20 22 5c 5c 22 29 90 00 } //1
		$a_03_1 = {52 65 70 6c 61 63 65 28 90 02 0f 2c 20 22 5c 22 2c 20 22 5c 5c 22 29 90 0a 28 00 90 1b 00 20 3d 20 90 00 } //1
		...
		$a_03_3 = {53 65 74 20 90 02 0f 20 3d 20 43 72 65 61 74 65 4f 62 6a 65 63 74 28 22 53 63 72 69 70 74 69 6e 67 2e 46 69 6c 65 53 79 73 74 65 6d 4f 62 6a 65 63 74 22 29 90 02 5f 44 69 6d 20 90 02 0f 20 41 73 20 4f 62 6a 65 63 74 90 08 00 04 53 65 74 20 90 1b 02 20 3d 20 90 1b 00 2e 43 72 65 61 74 65 54 65 78 74 46 69 6c 65 28 90 02 0f 2c 20 54 72 75 65 2c 20 54 72 75 65 29 90 02 0a 90 1b 02 2e 57 72 69 74 65 90 00 } //1
	condition:
