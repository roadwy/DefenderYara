...
rule TrojanDownloader_O97M_Ursnif_AQ_MTB{
	...
	strings :
		$a_01_0 = {3d 20 43 68 72 28 32 33 30 20 2d 20 28 33 30 20 2f 20 32 29 20 2d 20 28 35 30 20 2a 20 32 29 29 20 2b 20 22 48 45 4c 4c 2e 22 } //01 00 
