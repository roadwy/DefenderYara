...
rule TrojanDownloader_O97M_Ursnif_AN_MTB{
	...
	strings :
		$a_03_0 = {26 20 22 5c 90 02 10 2e 78 22 90 00 } //1
		$a_03_1 = {3d 20 43 68 72 28 22 26 68 22 20 26 20 4d 69 64 28 90 02 08 2c 20 90 02 06 2c 20 90 02 06 29 29 90 00 } //1
		$a_03_2 = {3d 20 22 74 90 02 01 6d 70 22 90 00 } //1
