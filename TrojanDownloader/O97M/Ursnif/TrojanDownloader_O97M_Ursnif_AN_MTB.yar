...
rule TrojanDownloader_O97M_Ursnif_AN_MTB{
	meta:
		description = "TrojanDownloader:O97M/Ursnif.AN!MTB,SIGNATURE_TYPE_MACROHSTR_EXT,05 00 05 00 05 00 00 01 00 "
	...
	strings :
		...
		$a_03_2 = {3d 20 22 74 90 02 01 6d 70 22 90 00 } //01 00 
		$a_01_3 = {3d 20 22 22 } //01 00  = ""
		$a_01_4 = {22 62 69 6e 2e 62 61 73 65 36 34 22 } //00 00  "bin.base64"
	condition:
		any of ($a_*)
