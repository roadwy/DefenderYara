...
rule TrojanDownloader_O97M_Ursnif_VA_MTB_2{
	...
	strings :
		...
		$a_03_1 = {3d 20 43 72 65 61 74 65 4f 62 6a 65 63 74 28 90 02 28 28 33 29 20 26 20 22 2e 22 20 26 20 90 02 28 28 33 29 20 26 20 22 72 65 71 75 65 73 74 2e 35 2e 31 22 29 90 00 } //1
		$a_03_2 = {4f 70 65 6e 20 22 47 45 54 22 2c 20 90 02 28 28 90 02 28 29 2c 20 46 61 6c 73 65 90 00 } //1
