...
rule TrojanDownloader_O97M_Ursnif_RVE_MTB_2{
	...
	strings :
		...
		$a_03_1 = {28 6e 69 75 28 31 30 2c 20 31 34 29 29 3a 20 [0-05] 20 3d 20 [0-0a] 28 6e 69 75 28 31 35 2c 20 32 31 29 29 } //1
		...
		$a_03_3 = {45 6e 76 69 72 6f 6e [0-01] 28 28 28 6e 69 75 28 32 38 2c 20 32 39 29 29 29 29 20 26 20 22 5c 22 } //1
