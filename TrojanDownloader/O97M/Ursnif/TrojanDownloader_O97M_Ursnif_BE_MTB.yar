...
rule TrojanDownloader_O97M_Ursnif_BE_MTB{
	...
	strings :
		...
		$a_03_1 = {4f 70 65 6e 20 53 74 72 52 65 76 65 72 73 65 28 90 02 10 29 20 26 20 22 5c 90 02 10 22 20 2b 20 53 74 72 52 65 76 65 72 73 65 28 90 02 10 29 20 46 6f 72 20 4f 75 74 70 75 74 20 41 73 20 23 90 00 } //1
