...
rule TrojanDownloader_O97M_Ursnif_AB_MTB{
	...
	strings :
		$a_03_0 = {26 20 22 5c 90 02 20 2e 78 73 6c 22 90 00 } //1
		$a_01_1 = {22 61 70 70 64 61 74 61 22 } //1 "appdata"
		$a_03_2 = {3d 20 43 68 72 28 22 26 68 22 20 26 20 4d 69 64 28 90 02 15 2c 20 90 02 15 2c 20 32 29 29 90 00 } //1
