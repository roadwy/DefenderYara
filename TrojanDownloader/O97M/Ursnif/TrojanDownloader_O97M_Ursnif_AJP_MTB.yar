...
rule TrojanDownloader_O97M_Ursnif_AJP_MTB{
	...
	strings :
		...
		$a_03_3 = {49 6e 73 74 72 75 6d 65 6e 74 61 74 69 6f 6e 55 74 69 6c 2e 50 61 73 74 65 52 65 6d 6f 76 65 20 3d 20 22 43 3a 5c 75 73 65 72 73 5c 50 75 62 6c 69 63 5c 22 20 2b 20 22 [0-06] 2e 6a 70 67 22 } //1
