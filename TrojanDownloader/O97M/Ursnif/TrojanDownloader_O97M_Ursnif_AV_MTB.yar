...
rule TrojanDownloader_O97M_Ursnif_AV_MTB{
	...
	strings :
		$a_01_0 = {3d 20 53 74 72 52 65 76 65 72 73 65 28 22 5c 5c 5c 5c 70 6d 65 74 5c 5c 5c 5c 73 77 6f 64 6e 69 77 5c 5c 5c 5c 3a 63 22 29 } //01 00 
...
rule TrojanDownloader_O97M_Ursnif_AV_MTB_2{
	...
	strings :
		...
		$a_01_1 = {2e 43 6f 6e 74 72 6f 6c 73 } //01 00 
		...
		$a_01_6 = {43 6c 6f 73 65 20 23 } //00 00 
	condition:
		any of ($a_*)
