...
rule TrojanDownloader_O97M_Ursnif_AU_MTB{
	...
	strings :
		$a_03_0 = {2e 43 72 65 61 74 65 54 65 78 74 46 69 6c 65 28 [0-10] 20 26 20 [0-10] 20 26 20 [0-10] 20 26 20 22 70 22 20 26 20 22 5c 22 20 26 20 22 5c [0-08] 2e 78 73 6c 22 2c 20 31 29 } //1
		$a_03_1 = {43 61 6c 6c 20 49 6e 74 65 72 61 63 74 69 6f 6e 2e 53 68 65 6c 6c 40 28 [0-08] 2c 20 32 29 } //1
