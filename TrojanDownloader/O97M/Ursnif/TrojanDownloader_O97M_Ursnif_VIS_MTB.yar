...
rule TrojanDownloader_O97M_Ursnif_VIS_MTB{
	...
	strings :
		...
		$a_03_2 = {2e 52 65 67 57 72 69 74 65 20 90 02 50 2c 20 31 2c 20 22 52 45 47 5f 44 57 4f 52 44 22 90 00 } //1
		...
		$a_03_5 = {73 77 61 70 41 72 67 75 6d 65 6e 74 50 74 72 28 22 90 02 50 22 29 90 00 } //1
