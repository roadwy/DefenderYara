...
rule TrojanDownloader_O97M_Ursnif_AJ_MTB{
	...
	strings :
		$a_03_0 = {2e 43 72 65 61 74 65 54 65 78 74 46 69 6c 65 28 [0-10] 20 26 20 [0-30] 2e 78 73 6c 22 2c 20 31 29 } //1
		$a_03_1 = {26 20 43 68 72 28 [0-08] 28 [0-08] 28 [0-08] 29 2c } //1
...
rule TrojanDownloader_O97M_Ursnif_AJ_MTB_2{
	...
	strings :
		...
		$a_03_5 = {2e 57 72 69 74 65 4c 69 6e 65 20 [0-18] 2e 54 65 78 74 } //1
		$a_03_6 = {2e 43 72 65 61 74 65 54 65 78 74 46 69 6c 65 28 [0-18] 29 } //1
