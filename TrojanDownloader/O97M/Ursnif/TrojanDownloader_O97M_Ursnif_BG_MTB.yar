...
rule TrojanDownloader_O97M_Ursnif_BG_MTB{
	...
	strings :
		...
		$a_01_1 = {50 75 62 6c 69 63 20 44 65 63 6c 61 72 65 20 50 74 72 53 61 66 65 20 53 75 62 20 53 6c 65 65 70 20 4c 69 62 20 22 6b 65 72 6e 65 6c 33 32 22 20 28 42 79 56 61 6c 20 4d 69 6c 6c 69 73 65 63 6f 6e 64 73 20 41 73 20 4c 6f 6e 67 50 74 72 29 } //01 00 
		...
		$a_01_5 = {53 6c 65 65 70 20 33 30 30 30 } //00 00 
	condition:
		any of ($a_*)
