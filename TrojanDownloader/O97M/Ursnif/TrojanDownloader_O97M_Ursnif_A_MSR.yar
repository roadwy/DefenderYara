...
rule TrojanDownloader_O97M_Ursnif_A_MSR{
	...
	strings :
		...
		$a_02_1 = {2e 70 68 70 20 22 20 26 20 45 6e 76 69 72 6f 6e 28 22 61 70 70 64 61 74 61 22 29 20 26 20 [0-14] 2e 65 78 65 } //1
		$a_02_2 = {26 20 45 6e 76 69 72 6f 6e 28 22 61 70 70 64 61 74 61 22 29 20 26 20 [0-14] 2e 65 78 65 22 20 26 20 55 73 65 72 46 6f 72 6d 33 2e 52 6f 6f 74 4f 4c 45 32 2e 43 61 70 74 69 6f 6e } //1
	condition:
