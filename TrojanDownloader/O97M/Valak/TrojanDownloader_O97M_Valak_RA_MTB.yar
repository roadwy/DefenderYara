...
rule TrojanDownloader_O97M_Valak_RA_MTB{
	...
	strings :
		$a_01_0 = {56 42 5f 4e 61 6d 65 20 3d 20 22 72 54 22 } //01 00  VB_Name = "rT"
		$a_01_1 = {22 72 65 67 73 76 72 22 20 26 20 33 32 20 26 20 22 20 22 } //01 00  "regsvr" & 32 & " "
...
rule TrojanDownloader_O97M_Valak_RA_MTB_2{
	...
	strings :
		...
		$a_01_1 = {3d 20 45 6e 76 69 72 6f 6e 28 22 74 6d 70 22 29 20 26 20 22 5c 69 6e 64 65 78 2e 6a 70 67 } //01 00  = Environ("tmp") & "\index.jpg
		$a_01_2 = {45 6e 76 69 72 6f 6e 28 22 74 6d 70 22 29 20 26 20 22 5c 31 2e 6a 70 67 } //01 00  Environ("tmp") & "\1.jpg
		$a_01_3 = {28 22 72 31 34 65 61 36 67 32 35 73 64 35 76 63 38 72 66 36 33 30 61 32 64 65 22 29 } //02 00  ("r14ea6g25sd5vc8rf630a2de")
		...
		$a_01_6 = {72 64 30 65 31 65 67 66 39 73 39 62 76 33 31 72 63 37 33 38 62 32 30 32 } //01 00  rd0e1egf9s9bv31rc738b202
