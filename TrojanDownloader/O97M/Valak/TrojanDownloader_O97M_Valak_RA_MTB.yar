...
rule TrojanDownloader_O97M_Valak_RA_MTB{
	...
	strings :
		...
		$a_03_3 = {44 69 6d 20 90 01 02 20 41 73 20 4e 65 77 20 57 73 68 53 68 65 6c 6c 0d 0a 90 1b 00 2e 65 78 65 63 20 6b 65 90 00 } //1
	condition:
...
rule TrojanDownloader_O97M_Valak_RA_MTB_2{
	...
	strings :
		...
		$a_03_4 = {43 61 6c 6c 20 90 02 0a 2e 65 78 65 63 28 90 02 0a 20 26 20 22 20 22 20 26 20 90 02 0a 29 90 00 } //2
		$a_03_5 = {43 61 6c 6c 20 90 02 0a 2e 4f 70 65 6e 28 22 47 45 54 22 2c 20 90 02 0a 2c 20 46 61 6c 73 65 29 90 00 } //2
		$a_01_6 = {72 64 30 65 31 65 67 66 39 73 39 62 76 33 31 72 63 37 33 38 62 32 30 32 } //1 rd0e1egf9s9bv31rc738b202
		$a_03_7 = {45 6e 76 69 72 6f 6e 28 22 74 6d 70 22 29 20 26 20 22 5c 90 02 0a 2e 6a 70 67 90 00 } //1
	condition:
