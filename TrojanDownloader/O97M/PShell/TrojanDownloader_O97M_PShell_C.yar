...
rule TrojanDownloader_O97M_PShell_C{
	...
	strings :
		...
		$a_03_1 = {20 3d 20 22 64 20 2f 56 5e 3a 5e 4f 90 02 02 2f 43 22 20 2b 20 22 22 22 22 20 2b 20 22 5e 73 5e 65 5e 74 20 90 00 } //1
		...
		$a_02_9 = {20 3d 20 46 6f 72 6d 61 74 28 43 68 72 28 90 02 20 29 29 20 2b 20 22 6d 64 20 2f 56 90 02 20 22 20 2b 20 46 6f 72 6d 61 74 28 43 68 72 28 90 00 } //1
		...
		$a_03_14 = {53 68 65 6c 6c 20 46 6f 72 6d 61 74 28 90 02 20 29 20 2b 20 46 6f 72 6d 61 74 28 90 00 } //1
		$a_03_15 = {20 2b 20 43 72 65 61 74 65 4f 62 6a 65 63 74 28 22 57 73 63 72 69 70 74 2e 73 68 65 6c 6c 22 29 2e 52 75 6e 28 90 02 20 20 2b 20 43 68 72 28 90 00 } //1
		$a_03_16 = {56 42 41 2e 53 68 65 6c 6c 20 22 22 20 2b 20 90 02 30 20 2b 20 43 56 61 72 28 22 43 22 29 20 2b 90 00 } //1
	condition:
