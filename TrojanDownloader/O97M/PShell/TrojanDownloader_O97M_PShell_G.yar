...
rule TrojanDownloader_O97M_PShell_G{
	...
	strings :
		...
		$a_02_2 = {45 6e 76 69 72 6f 6e 24 28 22 55 73 65 72 70 72 6f 66 69 6c 65 22 29 20 26 20 22 [0-20] 5c 53 69 6c 65 6e 74 2e 76 62 73 22 2c 20 22 52 45 47 5f 53 5a 22 } //1
	condition:
