...
rule TrojanDownloader_O97M_PShell_H{
	...
	strings :
		$a_02_0 = {43 61 6c 6c 20 90 02 20 28 22 68 74 74 70 90 02 02 3a 2f 2f 90 02 30 2f 90 02 10 2e 6a 70 67 22 2c 20 45 6e 76 69 72 6f 6e 28 22 41 70 70 44 61 74 61 22 29 20 26 20 22 5c 90 02 10 2e 65 78 65 22 29 90 00 } //2
