...
rule TrojanDownloader_O97M_Gozi_AW_MTB{
	...
	strings :
		...
		$a_03_2 = {28 22 3a 2f 2f 90 02 0f 2e 90 02 05 2f 70 61 6e 30 72 61 6d 69 63 30 2e 6a 70 67 22 29 90 00 } //1
		$a_03_3 = {53 68 65 6c 6c 25 20 28 90 02 0f 20 2b 20 22 20 22 20 26 90 00 } //1
