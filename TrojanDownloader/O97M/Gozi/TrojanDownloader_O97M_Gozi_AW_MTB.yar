...
rule TrojanDownloader_O97M_Gozi_AW_MTB{
	...
	strings :
		$a_00_0 = {3d 20 22 43 3a 5c 75 73 65 72 73 5c 50 75 62 6c 69 63 5c 32 78 2e 6a 70 67 22 } //01 00  = "C:\users\Public\2x.jpg"
		...
		$a_00_4 = {2e 53 61 76 65 54 6f 46 69 6c 65 } //00 00  .SaveToFile
	condition:
		any of ($a_*)
