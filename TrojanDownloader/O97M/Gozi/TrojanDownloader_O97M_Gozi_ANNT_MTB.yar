...
rule TrojanDownloader_O97M_Gozi_ANNT_MTB{
	...
	strings :
		$a_03_0 = {56 42 41 2e 53 74 72 52 65 76 65 72 73 65 28 22 61 74 68 2e 90 02 25 5c 61 74 61 64 6d 61 72 67 6f 72 70 5c 3a 63 20 72 65 72 6f 6c 70 78 65 5c 73 77 6f 64 6e 69 77 90 00 } //1
		...
		$a_03_3 = {2e 65 78 65 63 20 70 28 72 6d 29 90 0c 02 00 45 6e 64 20 53 75 62 90 00 } //1
