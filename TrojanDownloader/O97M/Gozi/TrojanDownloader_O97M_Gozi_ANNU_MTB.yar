...
rule TrojanDownloader_O97M_Gozi_ANNU_MTB{
	meta:
		description = "TrojanDownloader:O97M/Gozi.ANNU!MTB,SIGNATURE_TYPE_MACROHSTR_EXT,07 00 07 00 07 00 00 01 00 "
	...
	strings :
		...
		$a_01_2 = {3d 20 53 70 6c 69 74 28 66 72 6d 2e 74 67 2c 20 22 20 22 29 } //01 00  = Split(frm.tg, " ")
		$a_03_3 = {65 78 65 63 20 74 67 90 0c 02 00 45 6e 64 20 53 75 62 90 00 } //01 00 
