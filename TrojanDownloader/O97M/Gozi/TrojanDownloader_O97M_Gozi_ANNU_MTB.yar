...
rule TrojanDownloader_O97M_Gozi_ANNU_MTB{
	...
	strings :
		...
		$a_03_3 = {65 78 65 63 20 74 67 90 0c 02 00 45 6e 64 20 53 75 62 } //1
		$a_03_4 = {66 72 6d 2e 62 75 74 74 6f 6e 31 5f 43 6c 69 63 6b 90 0c 02 00 45 6e 64 20 53 75 62 } //1
