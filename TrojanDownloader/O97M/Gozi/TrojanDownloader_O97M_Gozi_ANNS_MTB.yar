...
rule TrojanDownloader_O97M_Gozi_ANNS_MTB{
	...
	strings :
		$a_03_0 = {3d 20 22 65 78 70 6c 6f 72 65 72 20 63 3a 5c 75 73 65 72 73 5c 70 75 62 6c 69 63 5c [0-25] 2e 68 74 61 22 } //1
		$a_01_1 = {50 75 62 6c 69 63 20 53 75 62 20 62 75 74 74 6f 6e 31 5f 43 6c 69 63 6b 28 29 } //1 Public Sub button1_Click()
		$a_03_2 = {2e 65 78 65 63 20 74 67 90 0c 02 00 45 6e 64 20 53 75 62 } //1
