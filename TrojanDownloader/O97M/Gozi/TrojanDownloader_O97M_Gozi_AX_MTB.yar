...
rule TrojanDownloader_O97M_Gozi_AX_MTB{
	...
	strings :
		$a_03_0 = {3d 20 22 43 3a 5c 75 73 65 72 73 5c 50 75 62 6c 69 63 5c [0-05] 2e 70 6e 67 22 } //1
		...
		$a_03_5 = {28 22 3a 2f 2f 6c 69 6e 65 73 74 61 74 73 2e 63 61 73 61 2f [0-0a] 2e 6a 70 67 22 29 } //1
