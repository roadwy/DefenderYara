...
rule TrojanDownloader_O97M_Gozi_PVZ_MTB{
	...
	strings :
		...
		$a_01_2 = {4c 69 73 74 42 6f 78 31 2e 41 64 64 49 74 65 6d 20 28 22 3a 2f 2f } //01 00  ListBox1.AddItem ("://
		$a_01_3 = {2e 63 6f 6d 2f 68 65 61 64 65 72 2e 6a 70 67 22 29 } //01 00  .com/header.jpg")
		...
		$a_01_7 = {4c 65 6e 28 22 5a 5a 5a 22 29 20 54 68 65 6e } //01 00  Len("ZZZ") Then
