...
rule TrojanDownloader_O97M_Gozi_PAAA_MTB{
	...
	strings :
		...
		$a_03_1 = {66 6f 72 65 61 63 68 64 61 69 6e 62 6f 6c 65 65 61 6e 63 3d 28 62 6e 28 22 3d 22 26 64 61 2c 31 2b 37 29 29 3a 90 02 3f 28 28 90 02 3f 5f 70 61 67 6f 29 29 6e 65 78 74 77 90 00 } //1
