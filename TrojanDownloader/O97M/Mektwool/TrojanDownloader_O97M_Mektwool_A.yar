...
rule TrojanDownloader_O97M_Mektwool_A{
	...
	strings :
		...
		$a_01_3 = {62 79 4f 75 74 28 69 29 20 3d 20 28 28 62 79 49 6e 28 69 29 20 2b 20 4e 6f 74 20 62 45 6e 63 4f 72 44 65 63 29 20 58 6f 72 20 62 79 4b 65 79 28 6c 29 29 20 2d 20 62 45 6e 63 4f 72 44 65 63 } //00 00 
	condition:
		any of ($a_*)
