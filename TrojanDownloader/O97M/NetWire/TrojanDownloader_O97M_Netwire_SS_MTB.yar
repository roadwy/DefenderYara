...
rule TrojanDownloader_O97M_Netwire_SS_MTB{
	...
	strings :
		$a_03_0 = {78 20 3d 20 73 73 73 73 73 73 73 28 22 61 22 2c 20 [0-0f] 29 } //1
		...
		$a_03_6 = {53 75 62 20 57 6f 72 6b 62 6f 6f 6b 5f 4f 70 65 6e 28 29 [0-03] 44 69 6d 20 [0-0f] 20 41 73 20 53 74 72 69 6e 67 [0-03] 90 1b 01 20 3d 20 90 1b 01 20 2b 20 22 30 22 } //1
	condition:
