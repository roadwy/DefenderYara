...
rule TrojanDownloader_O97M_Adnel_D_2{
	...
	strings :
		$a_01_0 = {46 75 72 79 79 2e 4e 63 63 79 76 70 6e 67 76 62 61 } //01 00 
		$a_01_1 = {4e 51 42 51 4f 2e 46 67 65 72 6e 7a } //01 00 
		$a_01_2 = {46 70 65 76 63 67 76 61 74 2e 53 76 79 72 46 6c 66 67 72 7a 42 6f 77 72 70 67 } //01 00 
		$a_01_3 = {5a 46 4b 5a 59 32 2e 4b 5a 59 55 47 47 43 } //00 00 
	condition:
		any of ($a_*)
