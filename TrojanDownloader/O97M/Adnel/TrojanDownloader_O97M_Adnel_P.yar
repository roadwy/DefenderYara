...
rule TrojanDownloader_O97M_Adnel_P{
	...
	strings :
		...
		$a_03_1 = {3d 20 43 61 6c 6c 42 79 4e 61 6d 65 28 90 02 10 2c 20 90 02 10 2c 20 56 62 4d 65 74 68 6f 64 2c 20 90 02 10 2c 20 22 68 74 74 70 3a 2f 2f 90 02 30 2f 90 02 30 2e 65 78 65 22 2c 20 46 61 6c 73 65 29 90 00 } //1
