...
rule TrojanDownloader_O97M_Adnel_P{
	...
	strings :
		$a_01_0 = {3d 20 53 74 72 52 65 76 65 72 73 65 28 22 54 45 47 22 29 } //01 00 
		...
		$a_01_2 = {2b 20 53 74 72 52 65 76 65 72 73 65 28 22 6d 6e 6f 72 69 76 6e 45 64 22 29 } //00 00 
		$a_00_3 = {5d 04 } //00 00 
	condition:
		any of ($a_*)
