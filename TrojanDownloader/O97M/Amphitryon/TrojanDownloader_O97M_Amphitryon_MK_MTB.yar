...
rule TrojanDownloader_O97M_Amphitryon_MK_MTB{
	...
	strings :
		$a_03_0 = {50 72 6f 67 72 61 6d 20 3d 20 22 70 6f 77 65 72 73 68 65 6c 6c 2e 65 78 65 20 24 70 61 74 68 20 3d 20 24 45 6e 76 3a 74 65 6d 70 2b 27 5c [0-10] 2e 65 78 65 27 } //1
