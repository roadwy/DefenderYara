...
rule TrojanDownloader_O97M_Stratospk_A{
	meta:
		description = "TrojanDownloader:O97M/Stratospk.A,SIGNATURE_TYPE_MACROHSTR_EXT,03 00 03 00 03 00 00 01 00 "
		
	strings :
		$a_00_0 = {52 65 70 6c 61 63 65 28 28 22 68 68 68 66 64 61 2e 67 6f 76 2e 70 6b 2f 61 73 73 65 74 73 2f 75 70 6c 6f 61 64 73 2f 47 61 6c 6c 65 72 79 41 6c 62 75 6d 49 6d 61 67 65 73 2f 41 64 6f 62 65 } //01 00  Replace(("hhhfda.gov.pk/assets/uploads/GalleryAlbumImages/Adobe
