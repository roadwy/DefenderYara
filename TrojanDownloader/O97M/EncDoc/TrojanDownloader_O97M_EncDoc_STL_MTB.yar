...
rule TrojanDownloader_O97M_EncDoc_STL_MTB{
	...
	strings :
		...
		$a_03_2 = {61 2e 41 64 64 43 6f 64 65 20 28 41 63 74 69 76 65 57 6f 72 6b 62 6f 6f 6b 2e 42 75 69 6c 74 69 6e 44 6f 63 75 6d 65 6e 74 50 72 6f 70 65 72 74 69 65 73 28 22 43 6f 6d 6d 65 6e 74 73 22 29 2e 56 61 6c 75 65 29 [0-03] 45 6e 64 20 46 75 6e 63 74 69 6f 6e } //1
	condition:
