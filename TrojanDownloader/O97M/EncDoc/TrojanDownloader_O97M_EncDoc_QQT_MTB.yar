...
rule TrojanDownloader_O97M_EncDoc_QQT_MTB{
	...
	strings :
		$a_01_0 = {2f 64 73 2f 30 32 31 32 32 30 2e 67 69 66 } //01 00  /ds/021220.gif
		$a_01_1 = {43 3a 5c 67 6e 62 66 74 5c } //01 00  C:\gnbft\
		$a_01_2 = {63 68 74 66 6a 2e 64 6c 6c } //01 00  chtfj.dll
