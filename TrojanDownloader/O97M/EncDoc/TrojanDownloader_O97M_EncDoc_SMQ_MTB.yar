...
rule TrojanDownloader_O97M_EncDoc_SMQ_MTB{
	...
	strings :
		$a_01_0 = {65 78 65 2e 30 32 34 39 35 30 30 32 25 4f 50 2f 6b 72 61 6c 43 30 32 25 6c 75 61 50 2f 6d 6f 63 2e 6d 61 6b 63 69 6c 63 74 73 75 6a 2f 2f 3a 73 70 74 74 68 } //00 00  exe.02495002%OP/kralC02%luaP/moc.makcilctsuj//:sptth
	condition:
		any of ($a_*)
...
rule TrojanDownloader_O97M_EncDoc_SMQ_MTB_2{
	...
	strings :
		...
		$a_01_3 = {53 68 65 6c 6c 45 78 65 63 75 74 65 57 } //00 00  ShellExecuteW
	condition:
		any of ($a_*)
