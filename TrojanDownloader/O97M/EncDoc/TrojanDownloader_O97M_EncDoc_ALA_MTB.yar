...
rule TrojanDownloader_O97M_EncDoc_ALA_MTB{
	...
	strings :
		$a_03_0 = {6c 6f 6e 67 90 02 0a 63 6d 64 90 02 0a 6d 73 67 62 6f 78 72 6d 73 68 74 61 90 02 0a 68 74 74 70 73 77 77 77 62 69 74 6c 79 90 02 0a 63 6f 6d 64 77 71 64 61 73 66 63 90 02 0a 68 79 71 77 67 64 6a 6b 68 6b 61 73 90 02 ff 73 68 65 6c 6c 65 78 65 63 75 74 65 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule TrojanDownloader_O97M_EncDoc_ALA_MTB_2{
	...
	strings :
		...
		$a_03_2 = {20 3d 20 22 43 3a 90 02 0f 72 6f 67 72 61 6d 44 61 74 61 90 02 ff 22 20 2b 20 22 90 02 ff 22 90 00 } //1
		$a_03_3 = {52 65 70 6c 61 63 65 28 90 02 ff 2c 20 22 90 02 ff 22 2c 20 22 5c 22 29 90 00 } //1
	condition:
...
rule TrojanDownloader_O97M_EncDoc_ALA_MTB_6{
	...
	strings :
		...
		$a_03_2 = {43 61 6c 6c 42 79 4e 61 6d 65 28 90 02 ff 2c 20 90 02 ff 2c 20 56 62 4d 65 74 68 6f 64 2c 20 90 02 0a 28 30 29 2c 20 90 02 0a 28 31 29 2c 20 90 02 0a 28 32 29 2c 20 90 02 0a 28 33 29 2c 20 90 02 0a 28 34 29 29 90 00 } //1
...
rule TrojanDownloader_O97M_EncDoc_ALA_MTB_7{
	...
	strings :
		...
		$a_03_1 = {43 61 6c 6c 42 79 4e 61 6d 65 28 90 02 0f 2c 20 90 02 0f 28 22 20 53 20 68 20 65 20 6c 20 6c 20 45 20 78 20 65 20 63 20 75 20 74 20 65 20 22 29 2c 20 56 62 4d 65 74 68 6f 64 2c 90 00 } //1
		$a_01_2 = {22 70 69 6e 67 20 67 6f 6f 67 6c 65 2e 63 6f 6d 3b 22 20 2b 20 65 65 65 65 77 } //1 "ping google.com;" + eeeew
		$a_01_3 = {22 70 22 20 2b 20 69 66 67 6b 64 66 67 } //1 "p" + ifgkdfg
		$a_03_4 = {6e 65 77 53 74 72 20 3d 20 6e 65 77 53 74 72 20 2b 20 4d 69 64 28 90 02 0f 2c 20 69 2c 20 31 29 90 00 } //1
	condition:
...
rule TrojanDownloader_O97M_EncDoc_ALA_MTB_8{
	...
	strings :
		$a_03_0 = {62 69 74 6c 79 90 02 ff 22 2b 22 73 64 62 67 6a 61 73 66 64 6a 61 73 68 66 68 61 73 66 64 61 22 90 02 0f 3d 72 65 70 6c 61 63 65 28 90 02 0f 2c 22 30 22 2c 22 2e 22 29 90 02 0f 3d 72 65 70 6c 61 63 65 90 00 } //1
		...
		$a_03_2 = {67 65 74 6f 62 6a 65 63 74 28 90 02 0f 29 2e 5f 67 65 74 28 90 02 0f 29 2e 5f 63 72 65 61 74 65 5f 63 61 72 2c 5f 6e 75 6c 6c 2c 5f 6e 75 6c 6c 2c 5f 70 69 64 65 6e 64 73 75 62 90 00 } //1
	condition:
