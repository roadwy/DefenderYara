...
rule TrojanDownloader_O97M_EncDoc_OKN_MTB{
	...
	strings :
		...
		$a_01_3 = {53 68 65 65 74 73 28 22 4d 61 63 72 6f 31 22 29 2e 52 61 6e 67 65 28 22 44 31 33 30 22 29 20 3d 20 22 3d 45 58 22 20 2b 20 41 79 61 20 2b 20 22 28 22 20 2b 20 53 68 65 65 74 73 28 22 4d 61 63 72 6f 31 22 29 2e 52 61 6e 67 65 28 22 44 31 33 35 22 29 2e 56 61 6c 75 65 } //1 Sheets("Macro1").Range("D130") = "=EX" + Aya + "(" + Sheets("Macro1").Range("D135").Value
