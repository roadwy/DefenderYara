...
rule TrojanDownloader_O97M_EncDoc_STJ_MTB{
	...
	strings :
		...
		$a_03_1 = {2e 41 64 64 43 6f 64 65 20 28 41 63 74 69 76 65 57 6f 72 6b 62 6f 6f 6b 2e 42 75 69 6c 74 69 6e 44 6f 63 75 6d 65 6e 74 50 72 6f 70 65 72 74 69 65 73 28 22 54 69 74 6c 65 22 29 2e 56 61 6c 75 65 29 [0-0a] 45 6e 64 20 57 69 74 68 [0-03] 45 6e 64 20 46 75 6e 63 74 69 6f 6e } //1
		$a_03_2 = {41 74 74 72 69 62 75 74 65 20 56 42 5f 4e 61 6d 65 20 3d 20 22 4d 6f 64 75 6c 65 31 22 [0-03] 46 75 6e 63 74 69 6f 6e 20 41 75 74 6f 5f 4f 70 65 6e 28 29 } //1
	condition:
