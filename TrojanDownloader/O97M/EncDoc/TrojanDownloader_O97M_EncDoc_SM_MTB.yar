...
rule TrojanDownloader_O97M_EncDoc_SM_MTB_3{
	...
	strings :
		$a_03_0 = {70 64 61 73 31 20 3d 20 22 6d 90 02 05 73 90 02 05 68 90 02 05 74 90 02 05 61 20 68 90 02 20 74 90 00 } //1
		...
		$a_03_3 = {6f 6b 33 20 3d 20 22 90 02 aa 22 90 00 } //1
...
rule TrojanDownloader_O97M_EncDoc_SM_MTB_5{
	...
	strings :
		...
		$a_03_2 = {22 43 3a 5c 55 73 65 72 73 5c 50 75 62 6c 69 63 5c 44 6f 63 75 6d 65 6e 74 73 5c 90 02 15 2e 63 6d 22 20 26 20 43 68 72 28 43 4c 6e 67 28 39 37 2e 35 29 20 2b 20 43 4c 6e 67 28 31 2e 36 29 29 90 00 } //2
		$a_03_3 = {26 20 22 20 2d 77 20 68 69 20 73 6c 65 65 5e 70 20 2d 53 65 20 33 31 3b 53 74 61 90 02 02 72 74 2d 42 69 74 73 54 72 61 6e 73 5e 66 65 72 20 2d 53 6f 75 72 63 65 20 68 74 74 60 70 90 02 aa 2e 65 60 78 65 22 20 26 20 22 20 2d 44 65 73 74 69 6e 61 74 69 6f 6e 20 43 3a 5c 55 73 65 72 73 5c 50 75 62 6c 69 63 5c 44 6f 63 75 6d 65 6e 74 73 5c 90 02 15 2e 65 60 78 65 22 20 26 20 22 3b 43 3a 5c 55 73 65 72 73 5c 50 75 62 6c 69 63 5c 44 6f 63 75 6d 65 6e 74 73 5c 90 02 15 2e 65 60 78 65 90 00 } //2
	condition:
