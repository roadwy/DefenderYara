...
rule TrojanDownloader_O97M_EncDoc_QUSM_MTB{
	...
	strings :
		...
		$a_01_1 = {66 6f 72 3d 30 74 6f 28 29 2d 31 73 74 65 70 32 3d 2f 32 28 29 3d 32 35 35 2d 28 26 28 2c 29 26 28 2c 2b 31 29 29 6e 65 78 74 3d 65 6e 64 66 75 6e 63 74 69 6f 6e } //00 00  for=0to()-1step2=/2()=255-(&(,)&(,+1))next=endfunction
	condition:
		any of ($a_*)
