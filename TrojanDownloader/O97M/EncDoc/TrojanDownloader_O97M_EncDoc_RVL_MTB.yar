...
rule TrojanDownloader_O97M_EncDoc_RVL_MTB{
	...
	strings :
		...
		$a_01_2 = {6f 62 6a 46 53 4f 2e 43 72 65 61 74 65 54 65 78 74 46 69 6c 65 28 22 43 3a 5c 70 72 6f 67 72 61 6d 64 61 74 61 5c 6f 6b 2e 70 73 31 22 29 } //01 00  objFSO.CreateTextFile("C:\programdata\ok.ps1")
		$a_01_3 = {77 6f 72 6b 62 6f 6f 6b 5f 6f 70 65 6e 28 29 } //00 00  workbook_open()
	condition:
		any of ($a_*)
