...
rule TrojanDownloader_O97M_EncDoc_SNKQ_MTB{
	...
	strings :
		...
		$a_03_7 = {77 52 37 4e 35 51 51 20 3d 20 61 39 7a 57 47 57 63 72 4d 2e 52 65 70 6c 61 63 65 28 49 77 44 55 35 76 50 53 42 28 30 29 2c 20 22 22 29 90 0c 02 00 45 6e 64 20 46 75 6e 63 74 69 6f 6e 90 00 } //1
	condition:
