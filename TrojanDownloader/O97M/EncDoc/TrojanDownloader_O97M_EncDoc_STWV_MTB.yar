...
rule TrojanDownloader_O97M_EncDoc_STWV_MTB{
	...
	strings :
		...
		$a_03_3 = {67 6f 64 6b 6e 6f 77 73 20 3d 20 52 65 70 6c 61 63 65 28 22 63 6d 64 2e [0-2f] 20 2f 63 20 70 6f 77 5e [0-1f] 5e [0-1f] 2f 57 20 30 31 20 63 5e 75 5e 72 6c 20 68 74 74 5e 70 3a 2f 2f 31 37 32 2e 39 33 2e 32 31 33 2e 31 34 39 3a 38 30 38 30 2f 75 70 6c 6f 61 64 2f [0-2f] 2e [0-1f] 5e [0-1f] 20 2d 6f 20 22 20 26 20 76 61 7a 77 20 26 20 22 3b 22 20 26 20 76 61 7a 77 2c 20 22 [0-1f] 22 2c 20 22 65 22 29 } //1
	condition:
