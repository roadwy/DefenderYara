...
rule TrojanDownloader_O97M_EncDoc_SBS_MTB{
	...
	strings :
		...
		$a_03_2 = {2e 4f 70 65 6e 20 22 47 45 54 22 2c 20 22 68 74 74 70 90 02 5a 2e 65 78 65 22 2c 90 00 } //1
		$a_03_3 = {53 68 65 6c 6c 20 28 22 90 02 2f 2e 65 78 65 22 29 90 00 } //1
		$a_03_4 = {2e 73 61 76 65 74 6f 66 69 6c 65 20 22 90 02 2f 2e 65 78 65 22 2c 20 32 20 27 90 00 } //1
	condition:
