...
rule TrojanDownloader_O97M_EncDoc_ERV_MTB{
	...
	strings :
		...
		$a_03_4 = {55 52 4c 44 6f 77 6e 6c 6f 61 64 54 6f 46 69 6c 65 20 30 2c 20 76 6e 64 68 2c 20 64 6c 70 61 74 68 2c 20 30 2c 20 30 90 0c 02 00 45 6e 64 20 46 75 6e 63 74 69 6f 6e 90 00 } //1
		$a_03_5 = {23 49 66 20 57 69 6e 36 34 20 54 68 65 6e 90 02 08 23 45 6c 73 65 90 02 07 23 45 6e 64 20 49 66 90 0c 02 00 23 45 6c 73 65 90 0c 02 00 23 45 6e 64 20 49 66 90 00 } //1
