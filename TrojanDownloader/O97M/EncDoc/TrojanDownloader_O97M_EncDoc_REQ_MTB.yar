...
rule TrojanDownloader_O97M_EncDoc_REQ_MTB{
	...
	strings :
		...
		$a_01_2 = {47 75 69 6b 67 68 6a 67 66 68 20 3d 20 48 4a 48 47 75 79 20 26 20 48 4a 48 47 75 79 31 20 26 20 48 4a 48 47 75 79 32 20 26 20 48 4a 48 47 75 79 33 20 26 20 53 68 65 65 74 73 28 47 65 72 74 29 2e 52 61 6e 67 65 28 42 79 79 74 75 69 74 79 31 29 } //01 00  Guikghjgfh = HJHGuy & HJHGuy1 & HJHGuy2 & HJHGuy3 & Sheets(Gert).Range(Byytuity1)
		$a_01_3 = {42 74 64 75 66 6a 6b 68 6e 20 3d 20 53 68 65 65 74 73 28 47 65 72 74 29 2e 52 61 6e 67 65 28 42 79 79 74 75 69 74 79 29 } //01 00  Btdufjkhn = Sheets(Gert).Range(Byytuity)
