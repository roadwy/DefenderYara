...
rule TrojanDownloader_O97M_EncDoc_OSTP_MTB{
	...
	strings :
		$a_01_0 = {68 74 74 70 3a 2f 2f 77 69 6e 74 65 72 74 69 6d 65 2e 77 65 62 73 69 74 65 2f 66 65 2f 30 37 38 32 37 30 2e 6a 73 65 } //01 00  http://wintertime.website/fe/078270.jse
		...
		$a_01_3 = {43 3a 5c 41 76 61 73 74 5c 4c 6f 67 73 5c 6d 65 74 61 73 74 61 2e 6d 65 } //00 00  C:\Avast\Logs\metasta.me
	condition:
		any of ($a_*)
