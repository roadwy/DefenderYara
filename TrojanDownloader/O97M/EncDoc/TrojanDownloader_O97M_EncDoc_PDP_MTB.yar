...
rule TrojanDownloader_O97M_EncDoc_PDP_MTB{
	...
	strings :
		...
		$a_01_1 = {2e 65 78 65 2e 65 78 65 20 26 26 20 4e 7a 74 6d 66 6a 77 74 64 74 72 75 6b 6c 6d 64 66 73 62 79 69 64 6f 7a 2e 65 78 65 2e 65 78 65 22 2c 20 76 62 48 69 64 65 29 } //00 00 
	condition:
		any of ($a_*)
