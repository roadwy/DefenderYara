...
rule TrojanDownloader_O97M_EncDoc_AR_MTB{
	...
	strings :
		$a_00_0 = {64 48 41 36 4c 79 38 78 4f 54 49 75 4d 6a 4d 32 4c 6a 45 33 4f 43 34 34 4d 43 38 33 65 69 38 77 4e 6a 45 33 4e 7a 63 7a 4c 6d 70 77 } //0a 00 
		$a_00_1 = {63 31 78 51 64 57 4a 73 61 57 4e 63 64 32 68 77 5a 6e 64 72 63 6e 56 73 4c 6d 56 34 5a 53 4a 39 49 67 3d 3d } //00 00 
...
rule TrojanDownloader_O97M_EncDoc_AR_MTB_2{
	...
	strings :
		...
		$a_01_4 = {4a 4a 43 43 43 4a } //01 00 
		$a_01_5 = {64 54 6f 46 69 6c 65 41 } //00 00 
...
rule TrojanDownloader_O97M_EncDoc_AR_MTB_3{
	...
	strings :
		$a_01_0 = {68 74 74 70 3a 2f 2f 6a 6d 64 6d 65 6e 73 77 65 61 72 2e 63 6f 6d 2f 64 76 78 71 69 2f 44 } //0a 00 
		$a_01_1 = {68 74 74 70 3a 2f 2f 6a 6d 64 6d 65 6e 73 77 65 61 72 2e 63 6f 6d 2f 64 76 78 71 69 2f 35 33 30 33 34 30 2e 70 6e 67 } //01 00 
