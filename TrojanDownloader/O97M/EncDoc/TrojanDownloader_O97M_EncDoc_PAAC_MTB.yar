...
rule TrojanDownloader_O97M_EncDoc_PAAC_MTB{
	...
	strings :
		...
		$a_03_1 = {2f 64 6f 77 6e 6c 6f 61 64 2f 78 75 6e 6f 69 74 78 76 79 65 79 71 22 29 29 90 02 3f 2e 73 61 76 65 74 6f 66 69 6c 65 22 78 2e 76 62 73 22 2c 32 90 00 } //1
		$a_03_2 = {62 38 30 76 22 29 29 90 02 3f 2e 73 61 76 65 74 6f 66 69 6c 65 22 78 2e 76 62 73 22 2c 32 90 00 } //1
