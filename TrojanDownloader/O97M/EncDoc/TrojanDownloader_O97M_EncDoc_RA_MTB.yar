...
rule TrojanDownloader_O97M_EncDoc_RA_MTB{
	...
	strings :
		...
		$a_03_2 = {53 68 65 65 74 73 28 31 29 2e 52 61 6e 67 65 28 22 45 35 38 30 22 29 2e 4e 61 6d 65 20 3d 20 22 41 75 74 6f 5f 6f 75 76 72 69 72 35 90 04 01 03 30 2d 39 22 90 00 } //1
		$a_03_3 = {73 74 72 4d 61 63 72 6f 20 3d 20 22 41 75 74 6f 5f 6f 75 76 72 69 72 35 90 04 01 03 30 2d 39 22 90 00 } //1
...
rule TrojanDownloader_O97M_EncDoc_RA_MTB_2{
	...
	strings :
		...
		$a_03_2 = {41 70 70 6c 69 63 61 74 69 6f 6e 2e 57 61 69 74 20 28 4e 6f 77 20 2b 20 54 69 6d 65 56 61 6c 75 65 28 22 30 3a 30 30 3a 90 10 02 00 22 29 29 90 00 } //1
		$a_03_3 = {2e 52 75 6e 20 28 90 02 07 28 22 90 1f 10 00 90 00 } //1
		$a_03_4 = {50 75 62 6c 69 63 20 53 75 62 20 57 6f 72 6b 62 6f 6f 6b 5f 4f 70 65 6e 28 29 0d 0a 20 20 20 90 02 05 0d 0a 45 6e 64 20 53 75 62 0d 0a 50 72 69 76 61 74 65 20 53 75 62 20 90 1b 00 28 29 90 00 } //1
	condition:
...
rule TrojanDownloader_O97M_EncDoc_RA_MTB_4{
	...
	strings :
		...
		$a_03_1 = {67 69 74 68 75 62 2e 63 6f 6d 2f 74 63 6f 6e 71 75 65 72 6f 72 2f 62 6c 61 2f 72 61 77 2f 6d 61 73 74 65 72 2f 41 75 74 6f 72 75 6e 73 2e 65 78 65 22 2c 20 46 4e 61 6d 65 2c 20 30 2c 20 30 29 90 0a 8f 00 55 52 4c 44 6f 77 6e 6c 6f 61 64 54 6f 46 69 6c 65 28 30 2c 20 22 68 74 74 70 73 3a 2f 2f 90 00 } //1
