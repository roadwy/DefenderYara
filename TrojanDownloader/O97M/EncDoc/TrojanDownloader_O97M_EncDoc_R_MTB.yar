...
rule TrojanDownloader_O97M_EncDoc_R_MTB{
	...
	strings :
		...
		$a_03_3 = {6a 2e 6d 70 2f 61 6a 64 64 64 73 64 73 64 6a 73 6a 63 6a 6f 73 64 6a 90 0a 3f 00 68 74 74 70 3a 2f 2f 77 77 77 2e 90 00 } //3
	condition:
...
rule TrojanDownloader_O97M_EncDoc_R_MTB_2{
	...
	strings :
		...
		$a_03_3 = {43 3a 5c 50 72 6f 67 72 61 6d 44 61 74 61 5c 90 01 07 2e 65 78 65 90 00 } //1
