...
rule TrojanDownloader_O97M_EncDoc_VI_MTB_3{
	...
	strings :
		$a_03_0 = {2e 68 22 20 26 20 90 02 0f 20 26 20 22 61 90 00 } //1
		...
		$a_03_3 = {52 65 70 6c 61 63 65 28 90 02 ff 2c 20 22 90 02 0f 22 2c 20 76 62 4e 75 6c 6c 53 74 72 69 6e 67 29 90 00 } //1
	condition:
...
rule TrojanDownloader_O97M_EncDoc_VI_MTB_5{
	...
	strings :
		...
		$a_03_3 = {6f 69 75 70 28 90 01 03 29 20 26 20 6f 69 75 70 28 31 39 39 29 20 26 20 6f 69 75 70 28 31 39 30 29 20 26 20 6f 69 75 70 28 31 35 34 29 20 26 20 6f 69 75 70 28 31 36 39 29 20 26 20 6f 69 75 70 28 90 01 03 29 20 26 90 00 } //1
