...
rule TrojanDownloader_O97M_EncDoc_VIS_MTB_3{
	...
	strings :
		...
		$a_03_2 = {44 69 6d 20 90 02 09 20 41 73 20 4e 65 77 20 73 65 78 90 00 } //1
		$a_03_3 = {53 68 65 6c 6c 20 73 65 78 2e 90 02 20 2e 90 02 20 2e 54 61 67 90 00 } //1
	condition:
...
rule TrojanDownloader_O97M_EncDoc_VIS_MTB_5{
	...
	strings :
		...
		$a_03_3 = {53 68 65 6c 6c 20 90 02 70 2e 54 61 67 90 00 } //1
...
rule TrojanDownloader_O97M_EncDoc_VIS_MTB_13{
	...
	strings :
		...
		$a_03_1 = {2e 28 27 2e 27 2b 27 2f 90 02 ff 22 26 43 48 41 52 28 34 36 29 26 22 65 78 65 27 29 90 00 } //1
...
rule TrojanDownloader_O97M_EncDoc_VIS_MTB_14{
	...
	strings :
		...
		$a_03_1 = {53 68 65 6c 6c 20 28 45 6e 76 69 72 6f 6e 28 22 54 65 6d 70 22 29 20 2b 20 22 5c 90 02 0a 2e 62 61 74 22 29 90 00 } //1
...
rule TrojanDownloader_O97M_EncDoc_VIS_MTB_16{
	...
	strings :
		...
		$a_03_2 = {26 20 22 43 3a 5c 55 73 65 72 73 5c 50 75 62 6c 69 63 5c 44 6f 63 75 6d 65 6e 74 73 5c 90 02 0a 2e 65 78 22 20 26 20 43 68 72 28 31 30 31 29 90 00 } //1
	condition:
...
rule TrojanDownloader_O97M_EncDoc_VIS_MTB_18{
	...
	strings :
		$a_03_0 = {65 78 70 6c 6f 72 65 72 2e 65 78 65 20 63 3a 5c 70 72 6f 67 72 61 6d 64 61 74 61 5c 90 02 20 2e 68 74 61 22 90 00 } //1
		$a_03_1 = {27 27 29 2e 72 65 76 65 72 73 65 28 29 2e 6a 6f 69 6e 28 27 27 29 3b 7d 90 02 20 20 3d 20 77 69 6e 64 90 00 } //1
		$a_01_2 = {4f 70 74 69 6f 6e 20 45 78 70 6c 69 63 69 74 } //1 Option Explicit
		$a_03_3 = {53 70 6c 69 74 28 70 28 66 72 6d 2e 90 02 0a 29 2c 20 22 20 22 29 90 00 } //1
...
rule TrojanDownloader_O97M_EncDoc_VIS_MTB_22{
	...
	strings :
		...
		$a_03_1 = {2d 44 65 73 74 69 6e 61 74 69 6f 6e 20 22 20 26 20 43 68 72 28 33 34 29 20 26 20 22 43 3a 5c 55 73 65 72 73 5c 50 75 62 6c 69 63 5c 44 6f 63 75 6d 65 6e 74 73 5c 90 02 22 2e 65 78 22 20 26 20 43 68 72 28 31 30 31 29 20 26 20 43 68 72 28 33 34 29 20 26 90 00 } //1
...
rule TrojanDownloader_O97M_EncDoc_VIS_MTB_25{
	...
	strings :
		...
		$a_03_3 = {68 74 74 70 3a 2f 2f 90 02 72 2e 65 78 22 20 26 20 43 68 72 28 31 30 31 29 20 26 20 43 68 72 28 33 34 29 20 26 20 22 20 2d 4f 75 74 46 22 20 26 20 22 69 6c 65 20 22 20 26 20 43 68 72 28 33 34 29 90 00 } //1
		$a_03_4 = {43 3a 5c 55 73 65 72 73 5c 50 75 62 6c 69 63 5c 44 6f 63 75 6d 65 6e 74 73 5c 90 02 0f 2e 65 78 22 20 26 20 43 68 72 28 31 30 31 29 20 26 20 43 68 72 28 33 34 29 90 00 } //1
	condition:
