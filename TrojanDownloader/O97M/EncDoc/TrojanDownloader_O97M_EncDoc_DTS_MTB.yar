...
rule TrojanDownloader_O97M_EncDoc_DTS_MTB{
	...
	strings :
		$a_01_0 = {68 74 74 70 73 3a 2f 2f 73 65 63 66 69 6c 65 32 34 2e 74 6f 70 2f 6b 64 33 32 33 6a 61 73 64 2e 70 68 70 } //01 00  https://secfile24.top/kd323jasd.php
		$a_01_1 = {43 3a 5c 65 6f 4a 58 4b 77 58 5c 74 73 56 43 55 47 4b 5c 74 65 4d 4f 6a 4d 51 2e 64 6c 6c } //01 00  C:\eoJXKwX\tsVCUGK\teMOjMQ.dll
