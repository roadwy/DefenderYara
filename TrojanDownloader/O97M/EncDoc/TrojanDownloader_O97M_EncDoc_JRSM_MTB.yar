...
rule TrojanDownloader_O97M_EncDoc_JRSM_MTB{
	...
	strings :
		$a_03_0 = {43 3a 5c 78 35 63 50 72 6f 67 72 61 6d 44 61 74 61 5c 78 35 63 64 64 6f 6e 64 2e 63 6f 6d 5c 78 32 30 68 74 74 70 73 3a 2f 2f 77 77 77 2e 6d 65 64 69 61 66 69 72 65 2e 63 6f 6d 2f 66 69 6c 65 2f 90 02 1f 2f 90 02 1f 2e 68 74 6d 2f 66 69 6c 65 90 00 } //1
