...
rule TrojanDownloader_O97M_EncDoc_TRB_MTB{
	...
	strings :
		...
		$a_03_7 = {42 79 56 61 6c 20 64 77 52 65 73 65 72 76 65 64 20 41 73 20 4c 6f 6e 67 2c 20 42 79 56 61 6c 20 6c 70 66 6e 43 42 20 41 73 20 4c 6f 6e 67 29 20 41 73 20 4c 6f 6e 67 90 0c 02 00 23 45 6e 64 20 49 66 90 00 } //1
	condition:
