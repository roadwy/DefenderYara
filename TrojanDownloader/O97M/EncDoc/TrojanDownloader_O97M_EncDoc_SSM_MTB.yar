...
rule TrojanDownloader_O97M_EncDoc_SSM_MTB{
	...
	strings :
		...
		$a_01_1 = {2e 64 65 6c 65 74 65 66 69 6c 65 20 28 45 6e 76 69 72 6f 6e 28 22 55 53 45 52 50 52 4f 46 49 4c 45 22 29 20 2b 20 22 5c 4c 69 6e 6b 73 5c 2a 2e 6c 6e 6b 22 29 } //00 00 
	condition:
		any of ($a_*)
