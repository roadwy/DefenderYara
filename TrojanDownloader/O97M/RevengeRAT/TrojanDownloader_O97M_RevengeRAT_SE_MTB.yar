...
rule TrojanDownloader_O97M_RevengeRAT_SE_MTB{
	...
	strings :
		$a_03_0 = {77 77 77 2e 34 73 79 6e 63 2e 63 6f 6d 2f 77 65 62 2f 64 69 72 65 63 74 44 6f 77 6e 6c 6f 61 64 2f 90 02 08 2f 63 6d 6c 55 58 72 45 78 2e 90 00 } //1
		$a_03_1 = {55 52 4c 44 6f 77 6e 6c 6f 61 64 54 6f 46 69 6c 65 20 30 2c 20 49 6d 61 67 65 6d 53 69 6d 70 6c 65 73 43 44 54 2c 20 90 02 64 20 26 20 22 64 6f 63 75 6d 65 6e 74 2e 90 02 03 22 2c 20 30 2c 20 30 90 00 } //1
