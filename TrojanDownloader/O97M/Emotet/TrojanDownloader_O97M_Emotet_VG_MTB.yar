...
rule TrojanDownloader_O97M_Emotet_VG_MTB{
	...
	strings :
		...
		$a_03_4 = {53 75 62 20 90 02 20 28 29 90 0c 02 00 44 65 62 75 67 2e 50 72 69 6e 74 20 22 50 75 74 69 6e 2e 56 2e 56 22 20 2b 20 67 67 90 0c 02 00 45 6e 64 20 53 75 62 90 00 } //1
	condition:
