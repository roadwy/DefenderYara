...
rule TrojanDownloader_O97M_Emotet_EXNP_MTB{
	...
	strings :
		...
		$a_03_2 = {3a 2f 5e 2f 30 5e 78 35 5e 62 66 5e 30 37 5e 36 61 5e 38 2f 73 65 2f 73 90 02 04 2e 68 74 6d 6c 90 00 } //1
		...
		$a_03_6 = {3a 2f 5e 2f 30 78 5e 35 63 66 5e 66 5e 33 39 63 5e 33 5e 2f 5e 73 65 63 5e 2f 5e 73 65 90 02 03 2e 68 74 6d 6c 90 00 } //1
	condition:
