...
rule TrojanDownloader_O97M_Emotet_GF_MTB{
	...
	strings :
		$a_02_0 = {52 00 65 00 70 00 6c 00 61 00 63 00 65 00 90 02 05 28 00 90 02 0f 2c 00 20 00 90 02 1e 2c 00 20 00 22 00 22 00 29 00 90 00 } //10
		$a_02_1 = {52 65 70 6c 61 63 65 90 02 05 28 90 02 0f 2c 20 90 02 1e 2c 20 22 22 29 90 00 } //10
