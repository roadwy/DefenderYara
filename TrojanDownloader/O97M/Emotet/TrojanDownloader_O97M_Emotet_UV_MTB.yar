...
rule TrojanDownloader_O97M_Emotet_UV_MTB{
	...
	strings :
		...
		$a_01_2 = {3d 20 43 68 72 57 28 6f 77 64 73 64 20 2b 20 77 64 4b 65 79 50 20 2b 20 6b 77 6d } //01 00  = ChrW(owdsd + wdKeyP + kwm
		$a_01_3 = {53 48 6f 57 77 69 4e 44 6f 77 21 20 3d 20 46 61 6c 73 65 } //00 00  SHoWwiNDow! = False
	condition:
		any of ($a_*)
