...
rule TrojanDownloader_O97M_Emotet_RA_MTB{
	...
	strings :
		$a_03_0 = {5c 73 6f 61 6d 90 01 01 2e 4f 43 58 90 00 } //1
		$a_03_1 = {5c 73 6f 61 6d 90 01 01 2e 6f 63 78 90 00 } //1
...
rule TrojanDownloader_O97M_Emotet_RA_MTB_2{
	...
	strings :
		...
		$a_03_2 = {2e 52 65 70 6c 61 63 65 90 02 01 28 90 02 15 2c 20 90 02 15 2e 90 02 18 2c 20 22 22 29 90 00 } //1
		$a_03_3 = {3d 20 4d 73 67 42 6f 78 28 90 02 20 2e 90 02 20 2c 20 76 62 43 72 69 74 69 63 61 6c 2c 20 90 02 20 2e 90 02 20 29 90 00 } //1
	condition:
