...
rule TrojanDownloader_O97M_Emotet_VF_MTB{
	...
	strings :
		...
		$a_03_2 = {2e 43 6f 6e 74 72 6f 6c 54 69 70 54 65 78 74 90 02 20 20 3d 20 53 70 6c 69 74 28 90 02 20 20 2b 20 90 01 01 54 72 69 6d 28 53 74 72 52 65 76 65 72 73 65 28 90 02 10 29 29 2c 90 00 } //1
