...
rule TrojanDownloader_O97M_Emotet_UA_MTB{
	...
	strings :
		...
		$a_03_2 = {2b 20 43 68 72 57 28 77 64 4b 65 79 53 29 20 2b 20 90 02 20 2e 90 02 20 2e 54 61 67 90 00 } //1
		$a_03_3 = {3d 20 53 70 6c 69 74 28 90 02 20 20 2b 20 4c 54 72 69 6d 28 4c 54 72 69 6d 28 90 02 10 29 29 2c 90 00 } //1
	condition:
