...
rule TrojanDownloader_O97M_Emotet_UA_MTB{
	meta:
		description = "TrojanDownloader:O97M/Emotet.UA!MTB,SIGNATURE_TYPE_MACROHSTR_EXT,04 00 04 00 04 00 00 01 00 "
	...
	strings :
		...
		$a_03_3 = {3d 20 53 70 6c 69 74 28 90 02 20 20 2b 20 4c 54 72 69 6d 28 4c 54 72 69 6d 28 90 02 10 29 29 2c 90 00 } //00 00 
	condition:
		any of ($a_*)
