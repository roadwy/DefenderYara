...
rule TrojanDownloader_O97M_Emotet_SP_MTB{
	...
	strings :
		...
		$a_03_2 = {22 73 3a 57 90 02 06 69 90 02 06 6e 90 02 06 33 90 02 06 32 90 02 06 5f 90 02 06 50 90 02 12 72 90 02 06 6f 90 02 06 63 90 02 06 65 90 02 06 73 90 02 06 73 90 00 } //1
