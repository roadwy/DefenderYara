...
rule TrojanDownloader_O97M_Emotet_UJ_MTB{
	...
	strings :
		...
		$a_03_2 = {2e 47 72 6f 75 70 4e 61 6d 65 90 02 20 20 3d 20 53 70 6c 69 74 28 90 02 20 20 2b 20 43 56 61 72 28 54 72 69 6d 28 90 02 10 29 29 2c 90 00 } //1
		$a_03_3 = {46 75 6e 63 74 69 6f 6e 20 90 02 20 28 29 90 02 08 46 6f 72 90 00 } //1
	condition:
