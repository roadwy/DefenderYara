...
rule TrojanDownloader_O97M_Emotet_SS_MTB_2{
	...
	strings :
		...
		$a_03_1 = {6d 73 68 74 61 20 68 74 74 70 3a 2f 2f 39 31 2e 32 34 30 2e 31 31 38 2e 31 37 32 2f 90 05 03 05 28 61 2d 7a 29 2f 90 05 03 05 28 61 2d 7a 29 2e 68 74 6d 6c 90 00 } //1
	condition:
...
rule TrojanDownloader_O97M_Emotet_SS_MTB_3{
	...
	strings :
		$a_03_0 = {4e 65 78 74 90 0c 02 00 44 6f 20 57 68 69 6c 65 20 90 02 15 2e 43 72 65 61 74 65 28 4e 75 6c 6c 20 26 20 90 05 0f 06 41 2d 5a 61 2d 7a 2c 90 00 } //1
		$a_03_1 = {22 73 3a 57 90 02 09 69 90 02 09 6e 90 02 12 33 90 02 12 32 90 02 12 5f 90 02 12 20 2b 20 90 00 } //1
		$a_01_2 = {2e 43 6f 6e 74 72 6f 6c 54 69 70 54 65 78 74 } //1 .ControlTipText
		$a_03_3 = {3d 20 43 72 65 61 74 65 4f 62 6a 65 63 74 28 90 05 0f 06 41 2d 5a 61 2d 7a 29 90 00 } //1
	condition:
...
rule TrojanDownloader_O97M_Emotet_SS_MTB_4{
	...
	strings :
		...
		$a_03_1 = {3d 20 52 65 70 6c 61 63 65 28 90 02 35 2e 54 65 78 74 42 6f 78 90 01 01 2e 54 65 78 74 2c 20 22 77 67 6a 61 22 2c 20 22 22 29 90 00 } //1
		$a_03_2 = {4f 70 65 6e 20 90 02 35 2e 54 61 67 20 46 6f 72 20 4f 75 74 70 75 74 20 41 73 20 23 31 90 00 } //1
		$a_03_3 = {50 72 69 6e 74 20 23 31 2c 20 90 02 35 2e 43 6f 6d 62 6f 42 6f 78 31 2e 54 61 67 90 00 } //1
	condition:
...
rule TrojanDownloader_O97M_Emotet_SS_MTB_6{
	...
	strings :
		...
		$a_03_3 = {50 72 69 6e 74 20 23 31 2c 20 66 72 6d 70 61 67 65 2e 4c 61 62 65 6c 31 2e 43 61 70 74 69 6f 6e 90 02 03 6d 5f 46 6f 72 6d 57 69 64 20 3d 20 53 63 61 6c 65 57 69 64 74 68 90 02 03 43 6c 6f 73 65 20 23 31 90 00 } //1
	condition:
...
rule TrojanDownloader_O97M_Emotet_SS_MTB_8{
	...
	strings :
		...
		$a_03_1 = {4f 70 65 6e 20 90 02 35 2e 54 61 67 20 46 6f 72 20 4f 75 74 70 75 74 20 41 73 20 23 31 90 00 } //1
		...
		$a_03_3 = {78 6d 6c 68 74 74 70 2e 4f 70 65 6e 20 22 47 45 54 22 2c 20 55 52 4c 24 2c 20 54 72 75 65 3a 20 44 6f 45 76 65 6e 74 73 90 02 03 78 6d 6c 68 74 74 70 2e 53 65 6e 64 3a 20 44 6f 45 76 65 6e 74 73 90 00 } //1
	condition:
...
rule TrojanDownloader_O97M_Emotet_SS_MTB_10{
	...
	strings :
		$a_03_0 = {57 73 63 72 69 70 74 2e 53 68 65 6c 6c 90 02 0f 77 52 70 63 65 73 52 70 63 65 63 72 52 70 63 65 69 70 52 70 63 65 74 52 70 63 65 63 3a 52 70 63 65 5c 52 70 63 65 70 72 52 70 63 65 6f 67 72 52 70 63 65 61 6d 52 70 63 65 64 61 52 70 63 65 74 61 5c 77 65 74 69 64 6a 6b 73 2e 76 52 70 63 65 62 52 70 63 65 73 90 00 } //1
