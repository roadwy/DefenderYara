...
rule TrojanDownloader_O97M_Emotet_RX_MTB{
	meta:
		description = "TrojanDownloader:O97M/Emotet.RX!MTB,SIGNATURE_TYPE_MACROHSTR_EXT,04 00 04 00 04 00 00 01 00 "
		
	strings :
		$a_03_0 = {2e 43 72 65 61 74 65 90 02 14 28 90 02 45 2c 90 00 } //01 00 
