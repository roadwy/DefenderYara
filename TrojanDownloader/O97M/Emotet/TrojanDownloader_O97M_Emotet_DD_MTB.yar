...
rule TrojanDownloader_O97M_Emotet_DD_MTB{
	...
	strings :
		$a_01_0 = {31 2e 6f 6f 63 63 78 78 } //01 00  1.ooccxx
		$a_01_1 = {32 2e 6f 6f 63 63 78 78 } //01 00  2.ooccxx
		$a_01_2 = {33 2e 6f 6f 63 63 78 78 } //01 00  3.ooccxx
		$a_01_3 = {34 2e 6f 6f 63 63 78 78 } //01 00  4.ooccxx
