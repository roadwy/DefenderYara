...
rule TrojanDownloader_O97M_Emotet_VJ_MTB{
	...
	strings :
		...
		$a_03_1 = {3d 20 43 68 72 57 28 90 02 20 20 2b 20 77 64 4b 65 79 50 20 2b 20 90 02 20 29 90 00 } //1
		$a_01_2 = {2b 20 53 74 72 52 65 76 65 72 73 65 28 64 73 65 29 29 } //1 + StrReverse(dse))
		$a_03_3 = {64 73 65 20 3d 20 90 02 20 2e 90 02 15 2e 43 6f 6e 74 72 6f 6c 54 69 70 54 65 78 74 90 00 } //1
