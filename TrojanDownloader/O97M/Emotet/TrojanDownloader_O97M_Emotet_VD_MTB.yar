...
rule TrojanDownloader_O97M_Emotet_VD_MTB{
	...
	strings :
		...
		$a_03_2 = {3d 20 53 70 6c 69 74 28 22 [0-60] 77 [0-65] 22 20 2b 20 } //1
		$a_03_3 = {44 65 62 75 67 2e 50 72 69 6e 74 20 22 50 75 74 69 6e 2e 56 2e 56 22 20 2b 20 [0-04] 90 0c 02 00 45 6e 64 20 53 75 62 } //1
	condition:
