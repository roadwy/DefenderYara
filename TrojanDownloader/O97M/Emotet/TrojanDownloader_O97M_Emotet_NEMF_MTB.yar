...
rule TrojanDownloader_O97M_Emotet_NEMF_MTB{
	...
	strings :
		...
		$a_01_2 = {72 61 20 3d 20 52 65 70 6c 61 63 65 28 73 31 2c 20 22 2c 22 2c 20 22 22 29 } //01 00  ra = Replace(s1, ",", "")
		...
		$a_01_4 = {46 5f 43 6f 6e 74 65 6e 74 24 20 3d 20 46 5f 43 6f 6e 74 65 6e 74 24 20 26 20 22 26 22 20 26 20 72 65 73 24 20 26 20 22 22 20 26 20 76 62 4e 65 77 4c 69 6e 65 } //00 00  F_Content$ = F_Content$ & "&" & res$ & "" & vbNewLine
	condition:
		any of ($a_*)
