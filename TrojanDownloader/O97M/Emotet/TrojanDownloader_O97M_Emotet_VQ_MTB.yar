...
rule TrojanDownloader_O97M_Emotet_VQ_MTB{
	...
	strings :
		...
		$a_03_2 = {2b 20 53 74 72 52 65 76 65 72 73 65 28 90 02 06 29 29 90 02 20 5f 90 00 } //1
		$a_03_3 = {2e 54 61 67 90 02 20 5f 90 00 } //1
		$a_03_4 = {2e 43 6f 6e 74 72 6f 6c 54 69 70 54 65 78 74 20 2b 20 6f 49 50 90 02 20 5f 90 00 } //1
	condition:
