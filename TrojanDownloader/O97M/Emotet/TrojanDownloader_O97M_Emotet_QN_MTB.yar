...
rule TrojanDownloader_O97M_Emotet_QN_MTB{
	...
	strings :
		...
		$a_03_1 = {43 72 65 61 74 65 4f 62 6a 65 63 74 28 [0-15] 28 [0-15] 20 2b 20 [0-90] 29 29 } //1
		...
		$a_03_3 = {4f 6e 20 45 72 72 6f 72 20 52 65 73 75 6d 65 20 4e 65 78 74 [0-86] 44 69 6d } //1
