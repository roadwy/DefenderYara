...
rule TrojanDownloader_O97M_Emotet_TL_MTB{
	meta:
		description = "TrojanDownloader:O97M/Emotet.TL!MTB,SIGNATURE_TYPE_MACROHSTR_EXT,04 00 04 00 04 00 00 01 00 "
	...
	strings :
		...
		$a_03_2 = {2b 20 43 68 72 28 90 05 0f 06 41 2d 5a 61 2d 7a 2e 90 00 } //01 00 
		$a_03_3 = {3d 20 53 70 6c 69 74 28 22 90 02 15 77 90 02 25 22 20 2b 20 70 73 2c 20 73 6b 6b 29 90 00 } //00 00 
	condition:
		any of ($a_*)
