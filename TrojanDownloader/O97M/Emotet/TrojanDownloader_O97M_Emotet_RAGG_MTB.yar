...
rule TrojanDownloader_O97M_Emotet_RAGG_MTB{
	...
	strings :
		...
		$a_01_1 = {61 75 74 6f 5f 6f 70 65 6e } //65534 auto_open
		$a_01_2 = {43 6f 70 79 72 69 67 68 74 20 31 39 39 35 } //65534 Copyright 1995
		$a_01_3 = {4f 72 64 65 72 } //65534 Order
	condition:
		((#a_03_0  & 1)*1+(#a_01_1  & 1)*65534+(#a_01_2  & 1)*65534+(#a_01_3  & 1)*65534) >=1
