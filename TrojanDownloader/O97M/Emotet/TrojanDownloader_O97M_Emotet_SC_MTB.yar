...
rule TrojanDownloader_O97M_Emotet_SC_MTB{
	meta:
		description = "TrojanDownloader:O97M/Emotet.SC!MTB,SIGNATURE_TYPE_MACROHSTR_EXT,04 00 04 00 04 00 00 01 00 "
		
	strings :
		$a_03_0 = {2e 43 72 65 61 74 65 20 90 05 0f 06 41 2d 5a 61 2d 7a 2e 90 00 } //01 00 
