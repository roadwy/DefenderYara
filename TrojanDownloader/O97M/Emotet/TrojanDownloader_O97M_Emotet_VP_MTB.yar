...
rule TrojanDownloader_O97M_Emotet_VP_MTB{
	...
	strings :
		...
		$a_03_1 = {3d 20 4a 6f 69 6e ?? 28 53 70 6c 69 74 28 [0-20] 2c 20 [0-30] 29 2c 20 [0-25] 29 } //1
		$a_03_2 = {2b 20 43 68 72 57 28 49 6e 74 28 77 64 4b 65 79 53 29 29 20 2b 20 [0-20] 2e [0-20] 2e 54 61 67 20 2b } //1
	condition:
