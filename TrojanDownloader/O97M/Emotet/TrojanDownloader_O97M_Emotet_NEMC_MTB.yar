...
rule TrojanDownloader_O97M_Emotet_NEMC_MTB{
	...
	strings :
		...
		$a_03_3 = {51 75 65 72 79 54 61 62 6c 65 73 2e 41 64 64 28 22 22 20 26 20 52 65 70 6c 61 63 65 28 66 69 6c 65 6e 61 6d 65 24 2c 20 22 20 22 2c 20 22 90 02 10 22 29 2c 20 74 6d 70 53 68 65 65 74 2e 52 61 6e 67 65 28 22 41 31 22 29 29 90 00 } //1
	condition:
