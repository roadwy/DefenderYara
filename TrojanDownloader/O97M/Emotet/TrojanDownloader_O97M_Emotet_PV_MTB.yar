...
rule TrojanDownloader_O97M_Emotet_PV_MTB{
	...
	strings :
		$a_03_0 = {3d 20 22 6f 90 02 15 6e 90 02 15 33 90 02 15 32 90 02 20 50 90 02 15 72 90 02 15 6f 90 02 15 63 90 02 15 65 90 02 15 73 90 02 15 73 90 02 15 22 90 00 } //1
