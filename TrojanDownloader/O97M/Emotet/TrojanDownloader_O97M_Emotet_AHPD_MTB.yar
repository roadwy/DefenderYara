...
rule TrojanDownloader_O97M_Emotet_AHPD_MTB{
	...
	strings :
		$a_01_0 = {5c 63 75 73 6f 61 31 2e 6f 63 78 } //01 00  \cusoa1.ocx
		$a_01_1 = {5c 63 75 73 6f 61 32 2e 6f 63 78 } //01 00  \cusoa2.ocx
		$a_01_2 = {5c 63 75 73 6f 61 33 2e 6f 63 78 } //01 00  \cusoa3.ocx
