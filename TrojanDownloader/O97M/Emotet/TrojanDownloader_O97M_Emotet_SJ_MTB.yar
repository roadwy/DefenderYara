...
rule TrojanDownloader_O97M_Emotet_SJ_MTB{
	meta:
		description = "TrojanDownloader:O97M/Emotet.SJ!MTB,SIGNATURE_TYPE_MACROHSTR_EXT,05 00 05 00 05 00 00 01 00 "
	...
	strings :
		...
		$a_03_3 = {4e 65 78 74 90 0c 02 00 45 6e 64 20 46 75 6e 63 74 69 6f 6e 90 0c 02 00 46 75 6e 63 74 69 6f 6e 20 90 02 18 28 29 90 00 } //01 00 
