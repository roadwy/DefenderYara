...
rule TrojanDownloader_O97M_Emotet_TR_MTB{
	...
	strings :
		...
		$a_03_1 = {2b 20 43 68 72 57 28 77 64 4b 65 79 53 29 20 2b 20 [0-20] 2e [0-25] 2e 43 6f 6e 74 72 6f 6c 54 69 70 54 65 78 74 } //1
		$a_03_2 = {46 75 6e 63 74 69 6f 6e 20 [0-20] 28 29 [0-08] 44 6f 20 57 68 69 6c 65 } //1
