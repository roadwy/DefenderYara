...
rule TrojanDownloader_O97M_Yedat_A{
	meta:
		description = "TrojanDownloader:O97M/Yedat.A,SIGNATURE_TYPE_MACROHSTR_EXT,06 00 06 00 06 00 00 01 00 "
	...
	strings :
		...
		$a_03_2 = {20 41 73 20 53 74 72 69 6e 67 90 02 0f 20 3d 20 90 02 0f 2e 45 78 70 61 6e 64 45 6e 76 69 72 6f 6e 6d 65 6e 74 53 74 72 69 6e 67 73 28 22 25 41 50 50 44 41 54 41 25 5c 41 64 6f 62 65 5c 90 02 0f 2e 64 61 74 22 29 90 00 } //01 00 
		...
		$a_01_5 = {2e 45 78 65 63 28 22 72 75 6e 64 6c 6c 33 32 2e 65 78 65 } //00 00  .Exec("rundll32.exe
	condition:
		any of ($a_*)
