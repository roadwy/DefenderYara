...
rule TrojanDownloader_PowerShell_Elshutilo_CM_eml{
	...
	strings :
		...
		$a_03_2 = {61 77 2e 52 75 6e 20 74 6f 74 61 6c 90 01 01 2c 20 30 90 00 } //1
		$a_03_3 = {74 6f 74 61 6c 90 01 01 20 3d 20 74 6f 74 61 6c 90 01 01 20 2b 20 22 5f 31 30 5f 22 20 2b 20 90 00 } //1
		$a_03_4 = {74 6f 74 61 6c 90 01 01 20 3d 20 74 6f 74 61 6c 90 01 01 20 2b 20 90 02 50 73 20 2b 20 90 02 50 74 20 2b 20 90 02 50 61 20 2b 20 90 02 50 72 20 2b 20 90 02 50 74 20 2b 20 90 02 50 75 20 2b 20 90 02 50 70 20 2b 20 22 5f 22 20 2b 20 90 02 50 74 20 2b 20 90 02 50 61 20 2b 20 90 02 50 73 20 2b 20 90 02 50 6b 20 2b 20 22 27 29 90 00 } //1
	condition:
