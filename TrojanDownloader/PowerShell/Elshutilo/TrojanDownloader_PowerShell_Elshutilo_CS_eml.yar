...
rule TrojanDownloader_PowerShell_Elshutilo_CS_eml{
	...
	strings :
		...
		$a_01_1 = {53 65 74 20 65 72 20 3d 20 43 72 65 61 74 65 4f 62 6a 65 63 74 28 22 57 53 63 72 69 70 74 2e 53 68 65 6c 6c 22 29 } //01 00  Set er = CreateObject("WScript.Shell")
		$a_01_2 = {65 72 2e 52 75 6e } //01 00  er.Run
