...
rule TrojanDownloader_AndroidOS_SAgnt_B_MTB{
	...
	strings :
		$a_00_0 = {63 6c 5f 61 70 70 75 70 64 61 74 65 } //01 00  cl_appupdate
		$a_00_1 = {2f 41 70 70 55 70 64 61 74 65 45 78 61 6d 70 6c 65 2e 74 78 74 } //01 00  /AppUpdateExample.txt
		$a_00_2 = {5f 75 70 64 61 74 65 5f 75 70 64 61 74 65 63 6f 6d 70 6c 65 74 65 } //01 00  _update_updatecomplete
		$a_00_3 = {69 6e 73 74 61 6c 6c 5f 6e 6f 6e 5f 6d 61 72 6b 65 74 5f 61 70 70 73 } //01 00  install_non_market_apps
		$a_00_4 = {5f 73 6e 65 77 76 65 72 61 70 6b } //00 00  _snewverapk
	condition:
		any of ($a_*)
