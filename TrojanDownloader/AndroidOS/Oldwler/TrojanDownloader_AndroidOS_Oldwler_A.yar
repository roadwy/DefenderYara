...
rule TrojanDownloader_AndroidOS_Oldwler_A{
	...
	strings :
		...
		$a_03_6 = {21 80 db 03 00 02 21 80 91 04 00 03 91 02 04 03 23 35 71 00 12 00 90 01 04 90 01 02 04 00 48 06 08 06 48 07 08 02 b7 76 d5 66 ff 00 8d 66 4f 06 05 00 d8 00 00 01 d8 02 02 01 90 00 } //5
	condition:
