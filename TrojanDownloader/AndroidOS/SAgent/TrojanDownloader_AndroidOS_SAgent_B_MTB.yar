...
rule TrojanDownloader_AndroidOS_SAgent_B_MTB{
	...
	strings :
		$a_00_0 = {69 6c 6f 76 65 79 6f 75 } //01 00  iloveyou
		$a_00_1 = {61 64 5f 63 68 6f 69 63 65 73 5f 63 6f 6e 74 61 69 6e 65 72 } //01 00  ad_choices_container
		$a_00_2 = {43 75 53 65 72 76 69 63 65 } //01 00  CuService
		$a_00_3 = {4b 4b 52 65 63 65 69 76 65 72 } //05 00  KKReceiver
