...
rule TrojanDownloader_AndroidOS_SAgent_B_MTB{
	...
	strings :
		...
		$a_03_4 = {21 70 6e 10 90 01 02 08 00 0a 01 12 02 12 03 12 04 35 03 14 00 34 14 03 00 12 04 48 05 07 03 6e 20 90 01 02 48 00 0a 06 b7 65 8d 55 4f 05 07 03 d8 03 03 01 d8 04 04 01 28 ed 90 00 } //5
	condition:
