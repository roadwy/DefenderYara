...
rule TrojanDownloader_MacOS_AdLoad_D_MTB{
	...
	strings :
		$a_00_0 = {2f 43 6f 6e 74 65 6e 74 73 2f 52 65 73 6f 75 72 63 65 73 2f 77 69 63 2e 70 6e 67 } //01 00 
		...
		$a_01_2 = {2f 43 6f 6e 74 65 6e 74 73 2f 52 65 73 6f 75 72 63 65 73 2f 77 69 63 2e 70 6e 67 } //00 00 
	condition:
		any of ($a_*)
