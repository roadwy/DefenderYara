...
rule TrojanDownloader_MacOS_Adload_C{
	...
	strings :
		...
		$a_02_1 = {2f 50 4f 53 54 00 90 02 20 65 72 72 6f 72 20 77 68 69 6c 65 20 6d 61 6b 69 6e 67 20 72 65 71 75 65 73 74 3a 20 00 00 00 00 68 74 74 70 3a 2f 2f 6d 2e 90 00 } //2
