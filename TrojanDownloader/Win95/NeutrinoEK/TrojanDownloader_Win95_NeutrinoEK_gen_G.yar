...
rule TrojanDownloader_Win95_NeutrinoEK_gen_G{
	...
	strings :
		$a_03_0 = {2f 00 2f 00 42 00 20 00 2f 00 2f 00 45 00 3a 00 4a 00 53 00 63 00 72 00 69 00 70 00 74 00 20 00 90 02 02 33 00 32 00 2e 00 74 00 6d 00 70 00 20 00 22 00 90 02 20 22 00 20 00 22 00 68 00 74 00 74 00 70 00 3a 00 2f 00 2f 00 90 02 06 2e 00 90 02 06 2e 00 90 02 06 2e 00 90 02 06 2f 00 3f 00 90 00 } //1
