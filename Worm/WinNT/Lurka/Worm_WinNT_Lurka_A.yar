...
rule Worm_WinNT_Lurka_A{
	...
	strings :
		...
		$a_02_1 = {c6 45 f4 9c c6 45 f5 e8 e8 ?? ?? ff ff 53 ff 75 ec ff 75 f0 e8 ?? ?? ff ff 3b c3 74 05 6a 02 } //2
		$a_02_2 = {89 45 fc eb 3b c7 45 fc 06 00 00 80 eb 32 33 f6 39 35 ?? ?? 01 00 74 25 8d 45 e8 50 53 ff 75 30 e8 ?? ?? ff ff 84 c0 74 14 } //1
	condition:
