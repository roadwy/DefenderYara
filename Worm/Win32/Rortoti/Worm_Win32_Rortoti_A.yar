...
rule Worm_Win32_Rortoti_A{
	...
	strings :
		...
		$a_01_2 = {5c 69 67 66 78 68 6f 73 74 2e 65 78 65 } //01 00  \igfxhost.exe
		$a_01_3 = {7b 41 41 38 39 30 30 39 35 46 46 2d 35 38 37 36 2d 46 46 46 46 2d 37 36 54 48 2d 37 37 38 39 37 35 34 34 46 46 31 43 45 7d } //00 00  {AA890095FF-5876-FFFF-76TH-77897544FF1CE}
		$a_00_4 = {80 10 } //00 00 
	condition:
		any of ($a_*)
