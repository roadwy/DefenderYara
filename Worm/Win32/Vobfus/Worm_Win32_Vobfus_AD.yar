...
rule Worm_Win32_Vobfus_AD{
	...
	strings :
		...
		$a_03_1 = {0d 14 00 0c 00 08 00 ff 0d 58 00 0d 00 3e 44 ff 31 78 ff 1a 00 ff 00 34 6c 78 ff 1b ?? ?? 1b ?? ?? 2a 23 44 ff 1b ?? ?? 2a 23 f8 fe 1b ?? ?? 2a 23 f4 fe 1b ?? ?? 2a 23 f0 fe fb 30 32 } //1
		$a_03_2 = {04 48 ff 04 44 ff 05 ?? ?? 24 ?? ?? 0d 14 00 1a 00 08 44 ff 0d 58 00 1b 00 04 ?? ?? 10 38 00 14 00 04 ?? ?? f4 01 2b 3e ff 10 64 00 14 00 04 ?? ?? 6c 40 ff 1b ?? ?? 2a 23 34 ff 6c 38 ff 2a fd c7 2c ff 6c 48 ff 76 50 00 f5 01 00 00 80 59 30 ff 10 20 00 14 00 32 } //1
	condition:
