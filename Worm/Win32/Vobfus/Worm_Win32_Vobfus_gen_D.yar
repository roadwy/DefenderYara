...
rule Worm_Win32_Vobfus_gen_D{
	...
	strings :
		...
		$a_01_20 = {5c 00 5c 00 4d 00 41 00 50 00 4c 00 45 00 57 00 4f 00 4f 00 44 00 2c 00 5c 00 5c 00 4d 00 57 00 4f 00 4f 00 44 00 } //9c ff 
		$a_01_21 = {5c 00 44 00 79 00 6e 00 61 00 54 00 6f 00 75 00 63 00 68 00 } //00 00 
	condition:
		any of ($a_*)
