...
rule Worm_Win32_Hikjav_A{
	...
	strings :
		$a_03_0 = {c6 44 24 10 63 c7 44 24 14 90 01 04 8a 44 24 10 be 90 01 04 8d 7c 24 0c 66 a5 a4 88 44 24 0c 8d 44 24 0c 50 ff d3 83 f8 02 74 21 8d 44 24 0c 50 ff d3 83 f8 03 74 15 90 00 } //1
