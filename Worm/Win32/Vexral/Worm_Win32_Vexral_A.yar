...
rule Worm_Win32_Vexral_A{
	...
	strings :
		...
		$a_00_1 = {23 42 4f 54 23 55 52 4c 44 6f 77 6e 6c 6f 61 64 } //01 00 
		$a_02_2 = {66 61 63 65 62 6f 6f 6b 2e 90 02 04 2f 61 6a 61 78 2f 63 68 61 74 2f 73 65 6e 64 2e 70 68 70 90 00 } //01 00 
		$a_00_3 = {6c 6f 67 69 6e 5f 70 61 73 73 77 6f 72 64 3d } //01 00 
		$a_00_4 = {47 54 61 6c 6b 20 49 6e 73 74 61 6e 74 20 4d 65 73 73 61 67 65 } //00 00 
	condition:
		any of ($a_*)
