...
rule Worm_Win32_Vexral_A{
	...
	strings :
		$a_02_0 = {6a 40 68 00 30 00 00 ff 76 50 ff 76 34 ff 75 90 01 01 ff 90 02 02 3b c3 90 00 } //10
		$a_00_1 = {23 42 4f 54 23 55 52 4c 44 6f 77 6e 6c 6f 61 64 } //1 #BOT#URLDownload
		$a_02_2 = {66 61 63 65 62 6f 6f 6b 2e 90 02 04 2f 61 6a 61 78 2f 63 68 61 74 2f 73 65 6e 64 2e 70 68 70 90 00 } //1
