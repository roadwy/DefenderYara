...
rule Worm_Win32_Koobface_AW{
	...
	strings :
		$a_03_0 = {81 c6 50 c3 00 00 81 fe a0 25 26 00 0f 8f 90 01 02 00 00 56 ff 15 90 01 04 e8 90 01 04 84 c0 74 de 90 00 } //2
		...
		$a_03_4 = {25 73 3f 61 63 74 69 6f 6e 3d 90 02 0a 26 68 61 72 64 69 64 3d 25 73 26 76 3d 25 73 90 00 } //1
	condition:
