...
rule Worm_Win32_Koobface_AW{
	...
	strings :
		...
		$a_01_1 = {64 75 6d 70 20 72 65 73 70 6f 6e 63 65 20 3d 3d } //01 00 
		$a_01_2 = {23 42 4c 55 45 4c 41 42 45 4c } //01 00 
		$a_01_3 = {25 73 3f 61 25 73 6e 3d 25 73 67 65 6e 26 76 3d 25 73 } //01 00 
