...
rule Worm_Win32_Koobface_H{
	...
	strings :
		$a_03_0 = {b8 10 2b 00 00 e8 90 01 03 00 55 56 ff 15 90 01 03 00 99 b9 0a 00 00 00 90 02 10 f7 f9 90 02 10 52 ff d5 90 00 } //2
		$a_03_1 = {f2 ae f7 d1 49 03 d1 3b f2 72 bd ff 15 90 01 04 33 d2 b9 0a 00 00 00 f7 f1 52 ff d5 5f 5b 5e 5d 90 00 } //3
		$a_03_2 = {56 ff d5 83 c4 04 33 ff 56 ff d5 83 c4 04 85 c0 0f 85 90 01 02 00 00 47 81 ff 58 02 00 00 7c e9 56 90 00 } //3
