...
rule Worm_Win32_Pricbot_A{
	...
	strings :
		...
		$a_00_2 = {50 61 73 73 70 6f 72 74 2e 4e 65 74 5c 2a } //01 00 
		$a_01_3 = {44 69 73 61 62 6c 65 4e 6f 74 69 66 79 } //01 00 
		$a_00_4 = {46 6c 6f 6f 64 20 73 74 61 72 74 65 64 } //00 00 
	condition:
		any of ($a_*)
