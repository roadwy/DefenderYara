...
rule Worm_Win32_Tespot_A{
	...
	strings :
		...
		$a_03_2 = {3a 5c 52 45 43 59 43 4c 45 52 5c 53 2d 90 01 2a 5c 73 76 63 68 6f 73 74 2e 65 78 65 90 00 } //1
		$a_03_3 = {3a 5c 52 45 43 59 43 4c 45 52 5c 53 2d 90 01 2a 5c 73 70 6f 6f 6c 73 76 2e 65 78 65 90 00 } //1
	condition:
