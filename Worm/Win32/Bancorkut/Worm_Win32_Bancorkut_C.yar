...
rule Worm_Win32_Bancorkut_C{
	...
	strings :
		...
		$a_01_1 = {77 77 77 2e 67 6f 6f 67 6c 65 2e 63 6f 6d 2f 61 63 63 6f 75 6e 74 73 2f 73 65 72 76 69 63 65 6c 6f 67 69 6e 3f 73 65 72 76 69 63 65 3d 6f 72 6b 75 74 } //0a 00 
		...
		$a_01_3 = {45 6d 62 65 64 64 65 64 20 57 65 62 20 42 72 6f 77 73 65 72 20 66 72 6f 6d 3a 20 68 74 74 70 3a 2f 2f 62 73 61 6c 73 61 2e 63 6f 6d 2f } //00 00 
	condition:
		any of ($a_*)
