...
rule Worm_Win32_Recspa_A{
	...
	strings :
		...
		$a_00_2 = {5b 00 41 00 75 00 74 00 6f 00 72 00 75 00 6e 00 5d 00 } //01 00 
		$a_00_3 = {45 00 73 00 70 00 69 00 61 00 72 00 } //01 00 
		$a_00_4 = {45 00 6e 00 76 00 69 00 6f 00 20 00 64 00 65 00 20 00 69 00 6d 00 61 00 67 00 65 00 6e 00 20 00 63 00 6f 00 6d 00 70 00 6c 00 65 00 74 00 6f 00 } //01 00 
		$a_00_5 = {52 00 65 00 63 00 69 00 62 00 69 00 72 00 20 00 55 00 6e 00 69 00 64 00 61 00 64 00 65 00 73 00 } //00 00 
	condition:
		any of ($a_*)
