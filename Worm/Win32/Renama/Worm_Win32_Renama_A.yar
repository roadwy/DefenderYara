...
rule Worm_Win32_Renama_A{
	...
	strings :
		$a_02_0 = {68 01 00 00 80 c7 44 24 90 01 01 64 00 00 00 c7 44 24 90 01 01 00 00 00 00 ff d7 8b 4c 24 90 01 01 8d 54 24 90 01 01 8d 44 24 90 01 01 52 50 6a 00 6a 00 68 38 95 40 00 51 ff 15 90 01 04 8d 54 24 90 01 01 68 90 01 04 52 90 00 } //10
