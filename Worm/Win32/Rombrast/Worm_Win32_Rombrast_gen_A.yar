...
rule Worm_Win32_Rombrast_gen_A{
	...
	strings :
		...
		$a_01_1 = {45 52 52 4f 52 5f 42 52 41 49 4e 5f 54 4f 4f 5f 53 4d 41 4c 4c } //01 00  ERROR_BRAIN_TOO_SMALL
		$a_01_2 = {57 69 6e 64 6f 77 73 20 44 65 61 74 68 } //01 00  Windows Death
		$a_01_3 = {64 61 74 61 3d 25 73 3c 7c 3e 25 73 3c 7c 3e 25 64 3c 7c 3e 25 64 3c 7c 3e 25 73 3c 7c 3e 25 64 } //01 00  data=%s<|>%s<|>%d<|>%d<|>%s<|>%d
		$a_01_4 = {64 61 74 61 3d 55 53 42 3c 7c 3e 49 6e 66 65 63 74 65 64 20 44 72 69 76 65 20 25 63 3a 5c 3c 7c 7c 3e } //01 00  data=USB<|>Infected Drive %c:\<||>
		$a_01_5 = {3f 61 63 74 3d 73 70 72 65 61 64 69 6e 67 26 76 65 72 3d 25 73 } //01 00  ?act=spreading&ver=%s
