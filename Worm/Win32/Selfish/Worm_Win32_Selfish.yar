...
rule Worm_Win32_Selfish{
	...
	strings :
		...
		$a_01_2 = {56 69 72 75 73 55 6e 69 74 00 } //03 00  楖畲啳楮t
		$a_01_3 = {23 31 00 00 00 4d 5a 00 00 } //03 00 
		$a_01_4 = {49 4e 46 41 43 54 00 } //03 00 
		$a_01_5 = {57 48 45 52 45 20 64 61 74 65 3d 43 55 52 44 41 54 45 28 29 00 55 50 44 41 54 45 20 63 6f 6e 66 69 67 } //03 00  䡗剅⁅慤整䌽剕䅄䕔⤨唀䑐呁⁅潣普杩
		$a_01_6 = {28 73 69 74 65 69 64 2c 69 70 2c 64 61 74 65 29 20 56 41 4c 55 45 53 } //00 00  (siteid,ip,date) VALUES
	condition:
		any of ($a_*)
