...
rule Worm_Win32_Naras_gen_A{
	meta:
		description = "Worm:Win32/Naras.gen!A,SIGNATURE_TYPE_PEHSTR_EXT,12 00 11 00 05 00 00 0a 00 "
		
	strings :
		$a_00_0 = {50 45 5f 74 68 75 6e 6b 5f 69 6e 66 65 63 74 } //03 00  PE_thunk_infect
