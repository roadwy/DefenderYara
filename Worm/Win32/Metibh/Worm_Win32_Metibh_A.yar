...
rule Worm_Win32_Metibh_A{
	...
	strings :
		...
		$a_01_4 = {73 68 65 6c 6c 65 78 65 63 75 74 65 3d 52 75 6e 44 6c 6c 33 32 2e 65 78 65 20 2e 5c 54 68 75 6d 62 73 2e 6c 6e 6b 2c 47 65 74 50 69 63 } //01 00  shellexecute=RunDll32.exe .\Thumbs.lnk,GetPic
		$a_01_5 = {47 65 74 50 69 63 00 49 6e 69 74 4e 65 74 00 4e 76 53 74 61 72 74 75 70 } //00 00  敇側捩䤀楮乴瑥一卶慴瑲灵
	condition:
		any of ($a_*)
