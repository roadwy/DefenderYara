...
rule Worm_Win32_Ganelp_gen_A{
	...
	strings :
		...
		$a_01_2 = {62 64 3a 61 65 6c 2a 6e 45 3a 3a } //01 00  bd:ael*nE::
		$a_01_3 = {47 69 70 46 41 74 74 65 46 65 6c } //01 00  GipFAtteFel
		$a_01_4 = {65 74 6e 41 74 65 6e 74 6e 6e 6f 63 49 72 43 65 } //01 00  etnAtentnnocIrCe
		$a_01_5 = {6c 65 65 65 78 74 68 45 75 53 6c 63 41 } //00 00  leeexthEuSlcA
	condition:
		any of ($a_*)
