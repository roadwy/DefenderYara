...
rule Worm_Win32_Ganelp_C{
	...
	strings :
		$a_01_0 = {62 64 3a 61 65 6c 2a 6e 45 3a 3a } //01 00  bd:ael*nE::
		$a_01_1 = {67 46 73 6f 6d 65 72 61 6c 50 72 69 } //01 00  gFsomeralPri
		$a_01_2 = {53 61 45 67 56 65 65 74 75 41 52 65 6c 78 } //01 00  SaEgVeetuARelx
