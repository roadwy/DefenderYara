...
rule Worm_Win32_Ganelp_C{
	...
	strings :
		...
		$a_03_3 = {03 4d fc 0f be 51 05 83 fa 73 75 90 01 01 a1 90 01 04 03 45 fc 0f be 48 08 83 f9 74 75 90 01 01 8b 90 01 05 03 55 fc 0f be 42 0c 83 f8 6e 75 90 01 01 8b 90 01 05 03 4d fc 0f be 51 0f 83 fa 77 75 90 00 } //1
	condition:
