...
rule Worm_Win32_Ganelp_B{
	...
	strings :
		...
		$a_03_6 = {8b f4 8b 95 d0 fe ff ff 52 ff 15 90 01 04 3b f4 e8 90 01 04 89 85 cc fe ff ff 83 bd cc fe ff ff 02 0f 85 90 01 04 8d 85 54 fa ff ff 50 8b 8d d0 fe ff ff 51 e8 90 01 04 83 c4 08 89 85 c4 fe ff ff 8d 95 54 fa ff ff 89 95 50 fa ff ff 8b 85 d0 fe ff ff 50 8d 8d 60 fe ff ff 51 e8 76 1e 00 00 83 c4 08 6a 00 68 40 75 42 00 8d 95 54 fe ff ff 52 e8 90 00 } //6
	condition:
