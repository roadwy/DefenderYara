...
rule Worm_Win32_VB_AA_MTB{
	...
	strings :
		...
		$a_02_2 = {8b 45 08 ff 30 e8 90 01 04 8b 4d 80 03 8d 90 01 02 ff ff 8a 18 32 19 ff b5 90 01 02 ff ff 8b 45 08 ff 30 e8 90 01 04 88 18 eb 02 eb 90 01 01 e9 90 01 02 ff ff 90 00 } //1
	condition:
