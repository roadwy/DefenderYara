...
rule Worm_Win32_VB_BT{
	...
	strings :
		...
		$a_03_4 = {8b 55 d4 52 68 90 01 02 40 00 ff 15 90 01 02 40 00 f7 d8 1b c0 40 f7 d8 66 89 85 70 ff ff ff c7 85 68 ff ff ff 0b 00 00 00 8d 45 ac 50 8d 8d 78 ff ff ff 51 8d 55 9c 90 00 } //1
	condition:
