...
rule Worm_Win32_Rorpian_gen_A{
	...
	strings :
		...
		$a_03_6 = {8a 10 40 84 d2 75 90 01 01 2b c1 83 c0 5c 83 7d 7c 00 68 04 01 00 00 90 00 } //1
		...
		$a_02_9 = {05 00 00 03 10 00 00 00 90 02 02 00 00 01 00 00 00 90 02 02 00 00 90 00 } //1
	condition:
