...
rule Worm_Win32_Opanki{
	...
	strings :
		...
		$a_03_3 = {68 8b 00 00 00 68 11 01 00 00 ff 74 90 02 40 6a 25 68 00 01 00 00 90 00 } //3
		$a_03_4 = {41 49 4d 5f 49 4d 65 73 73 61 67 65 90 02 05 5f 4f 73 63 61 72 5f 54 72 65 65 90 00 } //3
	condition:
