...
rule Worm_Win32_Kangkio_A{
	...
	strings :
		...
		$a_01_1 = {2a 2e 2a 00 25 73 5c 64 72 69 76 65 72 73 5c 65 74 63 5c 68 6f 73 74 73 } //01 00  ⸪*猥摜楲敶獲敜捴桜獯獴
		$a_01_2 = {68 74 74 70 3a 2f 2f 25 37 37 25 37 37 25 37 37 25 32 45 25 } //01 00  http://%77%77%77%2E%
		$a_01_3 = {5c 4b 69 6c 6c 4a 70 67 2e 65 78 65 } //01 00  \KillJpg.exe
