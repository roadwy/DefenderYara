...
rule Worm_Win32_Faltbang_A{
	...
	strings :
		$a_03_0 = {74 0b 68 40 7e 05 00 ff 15 90 01 04 e8 90 01 04 50 66 c7 45 cc 02 00 ff 15 90 01 04 68 99 05 00 00 89 45 d0 90 00 } //1
		$a_03_1 = {74 04 3c 2a 75 03 c6 01 5f 8d 85 90 01 02 ff ff 47 50 e8 90 01 04 3b f8 59 72 b9 90 00 } //1
