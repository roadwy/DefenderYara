...
rule Worm_Win32_Cipush_A{
	...
	strings :
		...
		$a_03_7 = {00 64 00 75 00 6d 00 70 00 65 00 72 00 2e 00 65 00 78 00 65 00 00 90 02 4f 00 66 00 61 00 63 00 65 00 62 00 6f 00 6f 00 6b 00 2e 00 63 00 6f 00 6d 00 00 90 00 } //1
	condition:
