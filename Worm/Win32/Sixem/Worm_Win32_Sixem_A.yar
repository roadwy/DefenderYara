...
rule Worm_Win32_Sixem_A{
	...
	strings :
		$a_00_0 = {53 6f 66 74 77 61 72 65 5c 4d 69 63 72 6f 73 6f 66 74 5c 57 69 6e 64 6f 77 73 5c 43 75 72 72 65 6e 74 56 65 72 73 69 6f 6e 5c 55 72 6c } //0a 00 
		...
		$a_00_3 = {6d 61 69 6c 20 66 72 6f 6d } //01 00 
		$a_00_4 = {2e 6a 70 67 } //01 00 
		$a_00_5 = {53 6f 63 63 65 72 } //00 00 
	condition:
		any of ($a_*)
