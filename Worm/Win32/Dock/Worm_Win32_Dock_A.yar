...
rule Worm_Win32_Dock_A{
	...
	strings :
		...
		$a_01_3 = {25 73 70 61 67 65 66 69 6c 65 73 2e 64 61 74 } //01 00 
		$a_01_4 = {25 73 74 65 6d 70 2e 74 6d 70 } //01 00 
		$a_01_5 = {25 73 5c 6d 73 73 65 74 75 70 2e 65 78 65 } //01 00 
		$a_01_6 = {25 73 5c 77 73 32 68 65 6c 70 2e 64 6c 6c } //01 00 
		$a_01_7 = {25 73 5c 7e 24 25 73 } //00 00 
	condition:
		any of ($a_*)
