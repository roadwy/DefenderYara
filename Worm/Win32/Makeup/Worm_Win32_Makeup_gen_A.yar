...
rule Worm_Win32_Makeup_gen_A{
	...
	strings :
		$a_00_0 = {5f 4f 73 63 61 72 5f 53 74 61 74 75 73 4e 6f 74 69 66 79 } //01 00 
		$a_00_1 = {5f 5f 6f 78 46 72 61 6d 65 2e 63 6c 61 73 73 5f 5f } //01 00 
		$a_00_2 = {67 64 6b 57 69 6e 64 6f 77 54 6f 70 6c 65 76 65 6c } //01 00 
		$a_00_3 = {54 73 6b 4d 75 6c 74 69 43 68 61 74 46 6f 72 6d 2e 55 6e 69 63 6f 64 65 43 6c 61 73 73 } //01 00 
		$a_00_4 = {49 4d 57 69 6e 64 6f 77 43 6c 61 73 73 } //05 00 
