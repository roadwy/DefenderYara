...
rule Worm_Win32_Makeup_gen_A{
	...
	strings :
		...
		$a_03_5 = {6a 00 6a 00 6a 00 6a 11 ff 15 90 01 04 6a 00 6a 00 6a 00 6a 61 ff 15 90 01 04 50 ff 15 90 01 04 6a 00 6a 00 6a 00 6a 2e ff 15 90 00 } //5
		$a_03_6 = {6a 00 6a 02 6a 00 0f b7 85 90 01 02 ff ff 8a 84 05 90 01 02 ff ff 50 ff 15 90 01 04 50 ff 15 90 01 04 6a 64 ff 15 90 01 04 eb 90 00 } //10
	condition:
