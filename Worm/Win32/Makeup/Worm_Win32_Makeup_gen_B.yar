...
rule Worm_Win32_Makeup_gen_B{
	...
	strings :
		...
		$a_03_2 = {83 f8 02 75 34 89 5c 24 08 ba 05 00 00 00 b8 90 01 04 89 54 24 14 31 ff be 90 01 04 89 7c 24 10 89 74 24 0c 89 44 24 04 c7 04 24 00 00 00 00 90 00 } //10
	condition:
