...
rule Worm_Win32_Banwarum_gen_dr_A{
	...
	strings :
		$a_00_0 = {68 6c 65 67 65 68 72 69 76 69 68 62 75 67 50 68 53 65 44 65 } //04 00 
		$a_00_1 = {68 2e 65 78 65 68 6f 67 6f 6e 68 77 69 6e 6c } //04 00 
		$a_01_2 = {4f 70 65 6e 50 72 6f 63 65 73 73 54 6f 6b 65 6e 00 57 69 6e 33 32 2e 5a } //02 00 
