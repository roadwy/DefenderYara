...
rule Worm_Win32_Jadtre_gen_D{
	...
	strings :
		...
		$a_01_1 = {61 74 20 5c 5c 25 73 20 25 64 3a 25 64 20 43 3a 5c 25 73 2e 65 78 65 } //01 00 
		$a_01_2 = {25 73 26 66 6c 61 67 3d 25 73 26 61 6c 65 78 61 3d 30 26 4c 69 73 74 3d 25 73 } //01 00 
