...
rule Worm_Win32_Agent_AD{
	...
	strings :
		...
		$a_00_1 = {25 57 49 4e 44 49 52 25 5c 74 70 75 70 2e 65 78 65 } //0a 00  %WINDIR%\tpup.exe
		$a_00_2 = {43 3a 5c 57 49 4e 44 4f 57 53 5c 74 70 75 70 2e 65 78 65 } //0a 00  C:\WINDOWS\tpup.exe
		$a_00_3 = {56 43 32 30 58 43 30 30 55 } //01 00  VC20XC00U
		...
		$a_00_7 = {57 53 41 53 65 6e 64 } //01 00  WSASend
