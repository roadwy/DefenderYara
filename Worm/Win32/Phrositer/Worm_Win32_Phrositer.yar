...
rule Worm_Win32_Phrositer{
	...
	strings :
		$a_00_0 = {63 3a 5c 70 72 6f 67 72 61 6d 20 66 69 6c 65 73 5c 6d 69 63 72 6f 73 6f 66 74 20 76 69 73 75 61 6c 20 73 74 75 64 69 6f 5c 76 62 39 38 5c 76 62 36 2e 6f 6c 62 } //0b 00 
		$a_01_1 = {f5 00 00 00 00 05 06 00 3a 1c ff 49 00 fb ef 6c ff 0a 10 00 08 00 fd 6b fc fe fc f6 0c ff 35 6c ff 00 16 } //02 00 
		$a_01_2 = {53 65 70 68 69 72 6f 74 } //01 00 
		$a_01_3 = {72 65 67 61 74 74 61 63 6b } //01 00 
		$a_01_4 = {69 6e 66 65 63 74 64 72 69 76 65 } //01 00 
