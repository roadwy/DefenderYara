...
rule Worm_Win32_Wangy_gen_C{
	...
	strings :
		$a_01_0 = {68 74 74 70 3a 2f 2f 77 77 77 2e 30 31 73 6f 73 2e 63 6f 6d } //01 00  http://www.01sos.com
		$a_01_1 = {68 79 32 30 31 30 61 } //01 00  hy2010a
		$a_01_2 = {44 65 6c 65 74 65 4d 65 2e 62 61 74 } //0a 00  DeleteMe.bat
