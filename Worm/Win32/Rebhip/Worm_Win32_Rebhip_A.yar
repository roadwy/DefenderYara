...
rule Worm_Win32_Rebhip_A{
	...
	strings :
		$a_01_0 = {5f 78 5f 58 5f 55 50 44 41 54 45 5f 58 5f 78 5f } //0a 00 
		$a_01_1 = {5f 78 5f 58 5f 50 41 53 53 57 4f 52 44 4c 49 53 54 5f 58 5f 78 5f } //0a 00 
		$a_01_2 = {5f 78 5f 58 5f 42 4c 4f 43 4b 4d 4f 55 53 45 5f 58 5f 78 5f } //0a 00 
		$a_01_3 = {58 58 2d 2d 58 58 2d 2d 58 58 2e 74 78 74 } //01 00 
		$a_01_4 = {4d 53 4e 2e 61 62 63 } //01 00 
		$a_01_5 = {46 49 52 45 46 4f 58 2e 61 62 63 } //01 00 
		$a_01_6 = {49 45 4c 4f 47 49 4e 2e 61 62 63 } //01 00 
		$a_01_7 = {49 45 50 41 53 53 2e 61 62 63 } //00 00 
	condition:
		any of ($a_*)
