...
rule Worm_Win32_Yoybot{
	...
	strings :
		$a_00_0 = {2e 6a 70 65 67 2d 77 77 77 2e 69 6d 61 67 65 73 68 61 63 6b 2e 63 6f 6d } //05 00  .jpeg-www.imageshack.com
		$a_01_1 = {6d 47 fe 74 e8 bf c2 45 90 35 d1 5e 33 0a 24 6d } //03 00 
		$a_00_2 = {5c 70 68 6f 74 6f 20 61 6c 62 75 6d 2e } //03 00  \photo album.
		$a_01_3 = {59 4f 20 59 4f 20 59 4f 20 3a } //03 00  YO YO YO :
		...
		$a_00_6 = {69 6d 73 74 61 72 74 00 } //02 00  浩瑳牡t
		$a_00_7 = {00 69 6e 64 69 72 00 } //01 00 
		$a_00_8 = {64 6f 77 6e 6c 6f 61 64 00 } //01 00 
		$a_00_9 = {2e 7a 69 70 00 } //01 00 
		$a_01_10 = {53 65 74 43 6c 69 70 62 6f 61 72 64 44 61 74 61 } //05 00  SetClipboardData
