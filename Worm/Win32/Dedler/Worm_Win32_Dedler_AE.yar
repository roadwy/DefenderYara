...
rule Worm_Win32_Dedler_AE{
	...
	strings :
		$a_02_0 = {8d 44 24 00 53 56 8b 35 90 01 04 57 6a 14 50 68 90 01 04 ff d6 8d 4c 24 20 68 ff 00 00 00 51 68 90 01 04 ff d6 83 c9 ff 8d 7c 24 0c 33 c0 8b 94 24 24 01 00 00 f2 ae f7 d1 2b f9 8b c1 8b f7 8b fa c1 e9 02 f3 a5 8b c8 33 c0 83 e1 03 90 00 } //1
