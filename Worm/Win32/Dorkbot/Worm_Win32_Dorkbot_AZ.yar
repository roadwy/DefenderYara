...
rule Worm_Win32_Dorkbot_AZ{
	...
	strings :
		...
		$a_01_2 = {28 00 66 00 61 00 63 00 65 00 70 00 61 00 6c 00 6d 00 29 00 } //01 00 
		$a_00_3 = {6c 00 61 00 72 00 61 00 77 00 61 00 6e 00 67 00 20 00 69 00 74 00 6f 00 } //01 00 
		$a_00_4 = {64 00 65 00 74 00 74 00 61 00 20 00 66 00 6f 00 74 00 6f 00 } //01 00 
		$a_00_5 = {74 00 68 00 69 00 73 00 20 00 70 00 68 00 6f 00 74 00 6f 00 } //00 00 
	condition:
		any of ($a_*)
