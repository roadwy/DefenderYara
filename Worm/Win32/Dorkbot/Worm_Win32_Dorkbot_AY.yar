...
rule Worm_Win32_Dorkbot_AY{
	...
	strings :
		...
		$a_01_3 = {42 72 6f 77 73 65 72 3a 20 5b 25 73 5d 2c 20 57 65 62 73 69 74 65 3a 20 5b 25 73 5d 2c 20 55 73 65 72 6e 61 6d 65 3a 20 5b 25 73 5d 2c 20 50 61 73 73 77 6f 72 64 3a 20 5b 25 73 5d } //01 00  Browser: [%s], Website: [%s], Username: [%s], Password: [%s]
