...
rule Worm_Win32_Dorkbot_I{
	...
	strings :
		$a_00_0 = {4d 6f 64 75 6c 65 33 00 50 72 6f 79 65 63 74 6f 31 00 } //01 00 
...
rule Worm_Win32_Dorkbot_I_3{
	...
	strings :
		$a_00_0 = {25 73 5c 70 72 6f 67 72 61 6d 64 61 74 61 } //01 00 
		$a_00_1 = {25 73 5c 52 65 63 79 63 6c 65 72 } //01 00 
		$a_00_2 = {25 73 5c 2a 2e 2a } //01 00 
		$a_00_3 = {5c 55 70 64 61 74 65 5c } //01 00 
...
rule Worm_Win32_Dorkbot_I_4{
	...
	strings :
		$a_00_0 = {23 72 6e 64 62 6f 74 } //01 00 
		$a_00_1 = {23 72 6e 64 66 74 70 } //01 00 
		$a_00_2 = {6e 67 72 2e 68 6f 73 74 6e 61 6d 65 } //01 00 
		$a_00_3 = {5b 53 6c 6f 77 6c 6f 72 69 73 5d 3a } //05 00 
...
rule Worm_Win32_Dorkbot_I_6{
	...
	strings :
		$a_81_0 = {2a 2e 67 6f 6e 65 77 69 74 68 74 68 65 77 69 6e 67 73 } //01 00 
...
rule Worm_Win32_Dorkbot_I_7{
	...
	strings :
		$a_00_0 = {6e 67 72 42 6f 74 } //02 00 
		$a_00_1 = {6e 67 72 2d 3e 62 6c 6f 63 6b 73 69 7a 65 3a 20 25 64 } //01 00 
		$a_00_2 = {25 73 2e 42 6c 6f 63 6b 65 64 20 22 25 73 22 20 66 72 6f 6d 20 72 65 6d 6f 76 69 6e 67 20 6f 75 72 20 62 6f 74 20 66 69 6c 65 21 } //01 00 
		$a_00_3 = {73 74 61 72 74 20 25 25 63 64 25 25 52 45 43 59 43 4c 45 52 5c 25 73 } //01 00 
		$a_00_4 = {5b 76 3d 22 25 73 22 20 63 3d 22 25 73 22 20 68 3d 22 25 73 22 20 70 3d 22 25 53 22 5d } //05 00 
		$a_03_5 = {5b 53 6c 6f 77 6c 6f 72 69 73 5d 3a 20 90 01 08 20 66 6c 6f 6f 64 20 6f 6e 20 22 25 73 22 90 00 } //01 00 
		$a_00_6 = {5b 55 44 50 5d 3a 20 53 74 61 72 74 69 6e 67 20 66 6c 6f 6f 64 20 6f 6e 20 } //01 00 
		$a_00_7 = {5b 53 59 4e 5d 3a 20 53 74 61 72 74 69 6e 67 20 66 6c 6f 6f 64 20 6f 6e 20 } //01 00 
		$a_00_8 = {5b 55 53 42 5d 3a 20 49 6e 66 65 63 74 65 64 20 25 73 } //01 00 
		$a_00_9 = {5b 4d 53 4e 5d 3a 20 55 70 64 61 74 65 64 20 4d 53 4e 20 73 70 72 65 61 64 } //01 00 
		$a_00_10 = {5b 48 54 54 50 5d 3a 20 55 70 64 61 74 65 64 20 48 54 54 50 20 73 70 72 65 61 64 } //01 00 
		$a_00_11 = {5b 48 54 54 50 5d 3a 20 49 6e 6a 65 63 74 65 64 20 76 61 6c 75 65 20 69 73 20 6e 6f 77 20 25 73 } //01 00 
		$a_00_12 = {5b 75 73 62 3d 22 25 64 22 20 6d 73 6e 3d 22 25 64 22 20 68 74 74 70 3d 22 25 64 22 20 74 6f 74 61 6c 3d 22 25 64 22 5d } //01 00 
		$a_00_13 = {5b 66 74 70 3d 22 25 64 22 20 70 6f 70 3d 22 25 64 22 20 68 74 74 70 3d 22 25 64 22 20 74 6f 74 61 6c 3d 22 25 64 22 5d } //01 00 
		$a_00_14 = {5b 46 54 50 20 49 6e 66 65 63 74 5d 3a 20 25 73 20 77 61 73 20 69 66 72 61 6d 65 64 } //01 00 
		$a_00_15 = {5b 52 75 73 6b 69 6c 6c 5d 3a 20 44 65 74 65 63 74 65 64 20 46 69 6c 65 3a 20 22 25 73 22 } //01 00 
		$a_00_16 = {66 74 70 69 6e 66 65 63 74 } //01 00 
		$a_00_17 = {72 75 73 6b 69 6c 6c } //01 00 
		$a_00_18 = {68 74 74 70 73 70 72 65 61 64 } //01 00 
