...
rule Worm_Win32_Dorkbot_I_2{
	...
	strings :
		$a_03_0 = {3d 4d 5a 00 00 74 05 e9 7c 01 00 00 8b 0d 90 01 04 8b 55 08 03 51 3c 89 15 90 01 04 a1 90 01 04 81 38 50 45 00 00 74 05 90 00 } //1
...
rule Worm_Win32_Dorkbot_I_6{
	...
	strings :
		...
		$a_02_1 = {2f 00 43 00 52 00 45 00 41 00 54 00 45 00 20 00 2f 00 53 00 43 00 20 00 4f 00 4e 00 4c 00 4f 00 47 00 4f 00 4e 00 20 00 2f 00 54 00 4e 00 20 00 22 00 90 02 20 22 00 20 00 2f 00 54 00 52 00 20 00 22 00 25 00 73 00 22 00 20 00 2f 00 52 00 4c 00 20 00 48 00 49 00 47 00 48 00 45 00 53 00 54 00 90 00 } //1
		$a_02_2 = {2f 43 52 45 41 54 45 20 2f 53 43 20 4f 4e 4c 4f 47 4f 4e 20 2f 54 4e 20 22 90 02 20 22 20 2f 54 52 20 22 25 73 22 20 2f 52 4c 20 48 49 47 48 45 53 54 90 00 } //1
...
rule Worm_Win32_Dorkbot_I_7{
	...
	strings :
		...
		$a_03_5 = {5b 53 6c 6f 77 6c 6f 72 69 73 5d 3a 20 90 01 08 20 66 6c 6f 6f 64 20 6f 6e 20 22 25 73 22 90 00 } //5
