...
rule Worm_Win32_Shreptaz_A{
	...
	strings :
		...
		$a_01_1 = {61 74 74 72 69 62 20 2b 72 20 2b 73 20 2b 68 20 63 72 61 73 68 72 65 70 6f 72 74 2e 65 78 65 } //01 00 
		$a_01_2 = {62 69 74 2e 6c 79 2f 34 4e 46 39 4b 4a } //01 00 
		$a_01_3 = {74 69 6e 79 75 72 6c 2e 63 6f 6d 2f 6e 32 61 6e 76 73 } //00 00 
	condition:
		any of ($a_*)
