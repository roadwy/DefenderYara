...
rule Worm_Win32_Moldyow_A{
	...
	strings :
		...
		$a_00_2 = {77 73 32 5f 34 32 2e 64 6c 6c } //02 00 
...
rule Worm_Win32_Moldyow_A_2{
	...
	strings :
		...
		$a_01_3 = {73 68 65 6c 6c 5c 4f 70 65 6e 5c 43 6f 6d 6d 61 6e 64 3d 2e 5c 25 73 20 2d 6f } //01 00 
		$a_01_4 = {25 34 64 2d 25 30 32 64 2d 25 30 32 64 20 25 30 32 64 3a 25 30 32 64 3a 25 30 32 64 } //01 00 
		$a_01_5 = {76 65 72 73 69 6f 6e 20 25 64 2e 25 64 20 25 73 20 28 42 75 69 6c 64 20 25 64 29 } //01 00 
		$a_01_6 = {43 44 52 4f 4d 28 25 73 29 } //00 00 
	condition:
		any of ($a_*)
