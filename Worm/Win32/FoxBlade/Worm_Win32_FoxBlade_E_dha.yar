...
rule Worm_Win32_FoxBlade_E_dha{
	...
	strings :
		...
		$a_00_1 = {63 00 25 00 30 00 32 00 58 00 25 00 30 00 32 00 58 00 25 00 30 00 32 00 58 00 25 00 30 00 32 00 58 00 25 00 30 00 32 00 58 00 25 00 30 00 32 00 58 00 } //00 00  c%02X%02X%02X%02X%02X%02X
	condition:
		any of ($a_*)
