...
rule Worm_Win32_Mira_J_ibt{
	...
	strings :
		...
		$a_02_3 = {c7 44 24 1c 00 00 00 00 c7 44 24 18 00 00 00 00 c7 44 24 14 10 00 00 00 c7 44 24 10 00 00 00 00 c7 44 24 0c 00 00 00 00 c7 44 24 08 00 00 00 00 c7 44 24 04 00 00 00 00 c7 04 24 90 01 04 e8 90 00 } //1
	condition:
