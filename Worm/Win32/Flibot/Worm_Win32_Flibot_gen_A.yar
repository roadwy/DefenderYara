...
rule Worm_Win32_Flibot_gen_A{
	...
	strings :
		...
		$a_01_3 = {4d 4b 30 30 34 2e 57 7a 31 } //01 00 
		$a_01_4 = {5c 4d 53 56 42 56 4d 36 30 2e 44 4c 4c 5c 33 } //01 00 
		$a_00_5 = {47 65 74 4c 6f 67 69 63 61 6c 44 72 69 76 65 53 74 72 69 6e 67 73 } //01 00 
		$a_00_6 = {72 00 65 00 6d 00 6f 00 74 00 65 00 70 00 6f 00 72 00 74 00 } //02 00 
		$a_01_7 = {6f 00 71 00 32 00 2a 00 } //00 00 
	condition:
		any of ($a_*)
