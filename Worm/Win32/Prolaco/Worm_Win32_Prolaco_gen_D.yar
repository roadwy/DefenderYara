...
rule Worm_Win32_Prolaco_gen_D{
	...
	strings :
		$a_10_0 = {4d 2d 53 45 41 52 43 48 20 2a 20 48 54 54 50 2f 31 2e 31 } //0a 00 
		$a_10_1 = {48 4f 53 54 3a 20 32 33 39 2e 32 35 35 2e 32 35 35 2e 32 35 30 3a 31 39 30 30 } //0a 00 
		...
		$a_08_4 = {66 00 69 00 6c 00 65 00 73 00 2f 00 74 00 65 00 73 00 74 00 2f 00 73 00 76 00 63 00 68 00 6f 00 73 00 74 00 73 00 2e 00 65 00 78 00 65 00 } //00 00 
	condition:
		any of ($a_*)
