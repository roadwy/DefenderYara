...
rule Worm_Win32_Prolaco_gen_A{
	...
	strings :
		...
		$a_03_1 = {68 00 00 00 80 50 ff 15 ?? ?? ?? ?? 8b f8 56 57 ff 15 ?? ?? ?? ?? 3d ?? ?? ?? 00 7e 12 3d ?? ?? ?? 00 7d 0b } //1
		$a_03_2 = {3c 41 88 45 ?? 74 25 3c 42 74 21 3c 61 74 1d 3c 62 74 19 8d 45 ?? 50 ff 15 ?? ?? ?? ?? 83 f8 02 75 0a } //1
	condition:
