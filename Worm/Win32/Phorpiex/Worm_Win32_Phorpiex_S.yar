...
rule Worm_Win32_Phorpiex_S{
	...
	strings :
		$a_03_0 = {75 4e 6a 00 6a 00 6a 00 6a 11 e8 90 01 04 6a 00 6a 00 6a 00 6a 56 e8 90 01 04 6a 00 6a 02 6a 00 6a 56 e8 90 01 04 6a 00 6a 02 6a 00 6a 11 e8 90 01 04 6a 00 6a 00 6a 00 6a 0d 90 00 } //1
