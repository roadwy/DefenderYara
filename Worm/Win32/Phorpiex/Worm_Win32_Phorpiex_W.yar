...
rule Worm_Win32_Phorpiex_W{
	...
	strings :
		...
		$a_03_1 = {5b 44 6f 77 6e 6c 6f 61 64 5d 3a 90 02 10 5b 4d 61 69 6e 5d 3a 90 00 } //1
		$a_03_2 = {81 39 50 45 00 00 0f 85 90 01 04 8b 7d 0c 8b 81 a0 00 00 00 2b 79 34 8b 91 a4 00 00 00 03 c6 90 00 } //10
	condition:
