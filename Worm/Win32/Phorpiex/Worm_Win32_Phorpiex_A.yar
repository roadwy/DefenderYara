...
rule Worm_Win32_Phorpiex_A{
	...
	strings :
		...
		$a_03_3 = {6a 00 6a 01 6a 00 6a 11 ff d3 6a 00 6a 00 6a 00 6a 56 ff 15 90 01 04 0f b6 c8 51 ff d3 6a 00 6a 03 6a 2d 6a 11 ff d3 6a 00 6a 00 6a 00 6a 0d ff d3 90 00 } //1
	condition:
