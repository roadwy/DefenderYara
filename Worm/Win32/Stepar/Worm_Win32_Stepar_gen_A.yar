...
rule Worm_Win32_Stepar_gen_A{
	meta:
		description = "Worm:Win32/Stepar.gen!A,SIGNATURE_TYPE_PEHSTR_EXT,0c 00 0c 00 0b 00 00 "
		
	strings :
		$a_02_0 = {f3 a5 89 44 24 5c 89 44 24 70 89 44 24 74 89 44 24 78 89 44 24 7c 8d 44 24 10 50 68 3f 00 0f 00 8d 8c 24 20 01 00 00 6a 00 51 68 02 00 00 80 66 a5 c7 44 24 4c 00 00 90 01 02 c7 44 24 50 00 00 90 01 02 c7 44 24 54 00 00 90 01 02 c7 44 24 58 00 00 90 01 02 c7 44 24 5c 00 00 90 01 02 c7 44 24 60 00 00 90 01 02 c7 44 24 64 00 00 90 01 02 c7 44 24 68 00 00 90 01 02 c7 44 24 6c 00 00 90 01 02 c7 44 24 74 00 00 90 01 02 c7 44 24 78 00 00 90 01 02 c7 44 24 7c 00 00 90 01 02 c7 84 24 80 00 00 00 00 00 90 01 02 ff d3 90 00 } //2
		$a_02_1 = {8d 4c 24 20 c6 44 24 20 57 c6 44 24 21 49 68 00 00 22 10 51 c6 44 24 2a 4e ff d6 8d 94 24 98 00 00 00 68 90 01 04 52 ff d6 90 00 } //2
		$a_02_2 = {8b 4c 24 0c 6a 21 68 21 4e 00 00 51 50 ff 15 90 01 04 5f 33 c0 5e c2 10 00 90 00 } //2
