...
rule Worm_Win32_Playnro_A{
	...
	strings :
		$a_03_0 = {63 6d 64 00 90 02 10 6f 70 65 6e 00 90 02 20 77 69 6e 6c 67 6e 90 02 05 65 78 65 90 00 } //5
		$a_03_1 = {63 6f 70 79 90 02 20 2f 63 20 61 74 74 72 69 62 20 2d 68 20 2d 73 90 00 } //1
