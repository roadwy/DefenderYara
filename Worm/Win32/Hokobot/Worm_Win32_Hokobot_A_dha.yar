...
rule Worm_Win32_Hokobot_A_dha{
	...
	strings :
		...
		$a_00_8 = {5d 04 00 00 43 33 03 80 5c 25 00 00 44 33 03 80 00 00 01 00 08 00 0f 00 ac 21 48 6f 6b 6f 62 6f 74 2e 41 21 64 68 61 00 00 01 40 05 82 70 00 04 00 78 } //81 00 
	condition:
		any of ($a_*)
