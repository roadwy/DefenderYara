...
rule Worm_Win32_Bewmecky_A{
	...
	strings :
		$a_03_0 = {8a 08 88 0a 83 c0 01 83 c2 01 84 c9 75 f2 e9 ?? ?? ?? ?? 83 ff 02 75 28 } //1
		$a_03_1 = {8a 14 19 83 c3 01 80 fa 40 74 08 81 fb f4 01 00 00 7c ed 33 c0 33 f6 85 db bf 01 00 00 00 0f 8e ?? ?? 00 00 80 3c 31 23 } //1
