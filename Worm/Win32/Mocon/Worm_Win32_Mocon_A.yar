...
rule Worm_Win32_Mocon_A{
	...
	strings :
		...
		$a_00_1 = {5c 61 75 74 6f 72 75 6e 2e 69 6e 66 } //0a 00  \autorun.inf
		...
		$a_00_4 = {2f 63 73 73 72 73 2e 65 78 65 } //01 00  /cssrs.exe
		$a_00_5 = {61 74 74 72 69 62 20 2b 68 20 2b 73 20 2b 72 } //00 00  attrib +h +s +r
	condition:
		any of ($a_*)
