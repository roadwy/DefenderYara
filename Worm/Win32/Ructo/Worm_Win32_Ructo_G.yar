...
rule Worm_Win32_Ructo_G{
	...
	strings :
		...
		$a_00_2 = {72 00 65 00 67 00 73 00 76 00 72 00 33 00 32 00 20 00 2f 00 73 00 20 00 2f 00 75 00 } //01 00  regsvr32 /s /u
		$a_00_3 = {40 00 74 00 65 00 72 00 72 00 61 00 2e 00 63 00 6f 00 6d 00 2e 00 62 00 72 00 } //01 00  @terra.com.br
		$a_00_4 = {4d 00 41 00 49 00 4c 00 20 00 46 00 52 00 4f 00 4d 00 3a 00 } //01 00  MAIL FROM:
		$a_00_5 = {5c 00 6d 00 73 00 6d 00 73 00 67 00 73 00 2e 00 65 00 78 00 65 00 } //00 00  \msmsgs.exe
	condition:
		any of ($a_*)
