...
rule Worm_Win32_Ructo_P{
	...
	strings :
		...
		$a_01_2 = {73 00 6d 00 74 00 70 00 2e 00 62 00 72 00 61 00 2e 00 74 00 65 00 72 00 72 00 61 00 2e 00 63 00 6f 00 6d 00 2e 00 62 00 72 00 } //01 00  smtp.bra.terra.com.br
		$a_01_3 = {50 00 52 00 4f 00 43 00 45 00 53 00 53 00 4f 00 52 00 5f 00 41 00 52 00 43 00 48 00 49 00 54 00 45 00 43 00 54 00 55 00 52 00 45 00 } //01 00  PROCESSOR_ARCHITECTURE
		$a_01_4 = {34 00 2e 00 37 00 2e 00 30 00 2e 00 33 00 30 00 30 00 31 00 } //01 00  4.7.0.3001
