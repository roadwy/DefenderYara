...
rule Worm_Win32_Pakabot{
	...
	strings :
		...
		$a_03_7 = {6a 00 6a 00 6a 00 6a ff ff 15 90 01 04 85 c0 74 90 00 } //1
		...
		$a_03_11 = {6a 0a ff 15 90 01 04 ff 15 90 01 04 89 85 90 01 02 ff ff 6a 0a ff 15 90 01 04 ff 15 90 01 04 89 85 90 01 02 ff ff 8b 85 90 01 02 ff ff 2b 90 03 04 06 45 90 01 01 85 90 01 02 ff ff 83 f8 0a 73 90 01 01 8b 8d 90 01 02 ff ff 2b 90 03 04 06 4d 90 01 01 8d 90 01 02 ff ff 83 f9 14 73 90 00 } //6
		$a_03_12 = {6a 0a 8b d8 ff d5 ff d7 6a 0a 8b f0 ff d5 ff d7 2b f3 5d 83 fe 0a 73 90 01 01 2b c3 83 f8 14 73 90 00 } //6
	condition:
