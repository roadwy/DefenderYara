...
rule Worm_Win32_Kufgal_A{
	...
	strings :
		...
		$a_00_3 = {63 6d 64 20 2f 63 20 74 61 73 6b 6b 69 6c 6c 20 2f 69 6d 20 61 6c 67 2e 65 78 65 20 2f 66 } //01 00 
		$a_00_4 = {5c 46 6f 6e 74 73 5c 62 70 2e 69 6e 69 } //00 00 
	condition:
		any of ($a_*)
