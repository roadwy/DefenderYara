...
rule Worm_Win32_Kufgal_A{
	...
	strings :
		$a_03_0 = {7e 16 8b 44 24 08 56 2b d0 8b f1 8a 0c 02 80 c1 90 01 01 88 08 40 4e 75 f4 90 00 } //2
		$a_03_1 = {33 c0 b1 13 8a 90 90 90 01 04 32 d1 88 90 90 90 01 04 40 3d 90 01 04 7c ea 90 00 } //2
		$a_03_2 = {68 bd 01 00 00 89 44 24 0c e8 90 01 04 8d 54 24 04 6a 10 52 56 90 00 } //2
