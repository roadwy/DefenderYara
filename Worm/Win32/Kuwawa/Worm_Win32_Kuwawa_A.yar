...
rule Worm_Win32_Kuwawa_A{
	...
	strings :
		$a_03_0 = {5b 41 75 74 6f 52 75 6e 90 02 06 61 90 02 06 5c 61 75 74 6f 72 75 6e 2e 69 6e 66 90 00 } //1
		$a_03_1 = {25 73 5c 57 69 6e 64 6f 77 73 55 70 64 61 74 65 2e 65 78 65 90 02 06 6f 70 65 6e 90 02 06 65 78 70 6c 6f 72 65 90 00 } //1
