...
rule Worm_Win32_Dronzho_A{
	...
	strings :
		...
		$a_02_8 = {73 68 65 6c 6c 5c 6f 70 65 6e 5c 43 6f 6d 6d 61 6e 64 3d 22 2e 2e 2e 5c 90 02 08 2e 65 78 65 20 6f 5f 64 69 73 6b 90 00 } //1
		$a_02_9 = {73 68 65 6c 6c 5c 65 78 70 6c 6f 72 65 5c 43 6f 6d 6d 61 6e 64 3d 22 2e 2e 2e 5c 90 02 08 2e 65 78 65 20 6f 5f 64 69 73 6b 90 00 } //1
		$a_02_10 = {73 68 65 6c 6c 65 78 65 63 75 74 65 3d 22 2e 2e 2e 5c 90 02 08 2e 65 78 65 20 6f 5f 64 69 73 6b 90 00 } //1
