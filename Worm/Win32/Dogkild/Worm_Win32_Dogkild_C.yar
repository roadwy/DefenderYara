...
rule Worm_Win32_Dogkild_C{
	...
	strings :
		...
		$a_01_4 = {5c 5c 2e 5c 70 63 69 64 75 6d 70 00 } //01 00  屜尮捰摩浵p
		$a_00_5 = {5c 64 72 69 76 65 72 73 5c 41 73 79 6e 63 4d 61 63 2e 73 79 73 } //01 00  \drivers\AsyncMac.sys
		$a_00_6 = {74 61 73 6b 6b 69 6c 6c 2e 65 78 65 20 2f 69 6d } //00 00  taskkill.exe /im
	condition:
		any of ($a_*)
