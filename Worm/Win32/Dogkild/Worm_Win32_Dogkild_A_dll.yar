...
rule Worm_Win32_Dogkild_A_dll{
	...
	strings :
		$a_00_0 = {5c 64 72 69 76 65 72 73 5c 70 63 69 64 75 6d 70 2e 73 79 73 } //01 00 
		$a_01_1 = {56 53 4d 45 70 78 6f 6d 70 62 65 55 70 44 62 64 69 66 47 6a 6d 66 42 00 } //01 00 
