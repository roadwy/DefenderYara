...
rule Worm_Win32_Morto_B{
	...
	strings :
		$a_02_0 = {ff 75 0c ff 76 30 ff 75 08 ff 15 90 01 04 83 c4 0c 85 c0 74 04 8b 36 eb 90 00 } //1
		$a_02_1 = {83 c4 0c 89 85 90 01 04 68 00 02 00 00 8d 85 f0 fd ff ff 50 ff 75 08 ff 95 90 00 } //1
