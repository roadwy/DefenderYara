...
rule Worm_Win32_Mirbot_A{
	...
	strings :
		$a_03_0 = {5c 6d 42 6f 74 5c 90 02 20 5c 52 65 6c 65 61 73 65 5c 6d 90 02 0f 2e 70 64 62 90 00 } //50
		...
		$a_03_10 = {50 00 49 00 4e 00 47 00 20 00 3a 00 90 02 32 50 00 4f 00 4e 00 47 00 20 00 3a 00 90 00 } //1
	condition:
