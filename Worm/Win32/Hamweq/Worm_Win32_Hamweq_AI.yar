...
rule Worm_Win32_Hamweq_AI{
	...
	strings :
		$a_03_0 = {7e 15 8b 06 8b 4c 24 90 01 01 03 c3 51 8a 14 29 30 10 45 ff d7 3b e8 7c eb 8b 06 03 c3 90 00 } //3
		...
		$a_01_4 = {78 58 78 5f 78 5f 31 00 44 45 57 2e 65 78 65 00 } //1
