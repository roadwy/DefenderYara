...
rule Worm_Win32_Stuxnet_A{
	...
	strings :
		...
		$a_01_4 = {53 48 45 4c 4c 33 32 2e 44 4c 4c 2e 41 53 4c 52 2e } //01 00 
		$a_01_5 = {6e 63 61 63 6e 5f 69 70 5f 74 63 70 3a 25 73 } //01 00 
		$a_01_6 = {43 6f 6e 74 65 78 74 3d 22 25 73 22 3e 3c 45 78 65 63 3e 3c 43 6f 6d 6d 61 6e 64 3e } //01 00 
		$a_01_7 = {25 53 79 73 74 65 6d 52 6f 6f 74 25 5c 69 6e 66 5c 2a 2e 70 6e 66 } //9c ff 
