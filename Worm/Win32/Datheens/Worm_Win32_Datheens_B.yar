...
rule Worm_Win32_Datheens_B{
	...
	strings :
		$a_00_0 = {5c 44 65 61 74 68 2e 65 78 65 } //01 00 
		...
		$a_01_4 = {77 69 64 74 68 3d 30 20 68 65 69 67 68 74 3d 30 3e 3c 2f 69 66 72 61 6d 65 3e } //01 00 
		$a_01_5 = {3c 69 66 72 61 6d 65 20 73 72 63 3d } //01 00 
		$a_01_6 = {47 65 74 53 79 73 74 65 6d 44 69 72 65 63 74 6f 72 79 41 } //00 00 
	condition:
		any of ($a_*)
