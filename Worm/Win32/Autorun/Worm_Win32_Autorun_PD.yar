...
rule Worm_Win32_Autorun_PD{
	...
	strings :
		...
		$a_03_2 = {2d 77 61 69 74 [0-18] 6d 73 76 64 33 32 73 72 76 [0-0c] 2d 66 6c 61 73 68 [0-0c] 65 78 70 6c 6f 72 65 72 2e 65 78 65 [0-0c] 3a 5c [0-03] 64 33 62 37 75 65 35 38 79 37 6a 62 64 73 } //1
		$a_01_3 = {5b 61 75 74 6f 72 75 6e 5d } //1 [autorun]
		$a_03_4 = {2d 66 6c 61 73 68 [0-0a] 49 43 4f 4e 3d 73 68 65 6c 6c 33 32 2e 64 6c 6c 2c 34 } //1
	condition:
