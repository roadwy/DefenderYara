...
rule Worm_Win32_Autorun_AET{
	...
	strings :
		$a_01_0 = {55 00 53 00 42 00 44 00 69 00 73 00 6b 00 } //01 00 
		$a_01_1 = {25 73 3a 2f 2f 61 75 74 6f 72 75 6e 2e 65 78 65 } //02 00 
		$a_01_2 = {25 73 3a 2f 2f 61 75 74 6f 72 75 6e 2e 69 6e 66 } //03 00 
