...
rule Worm_Win32_Autorun_CX{
	...
	strings :
		...
		$a_02_4 = {2f 76 20 41 6e 74 69 76 69 72 75 7a 20 2f 64 20 25 77 69 6e 64 69 72 25 5c 73 79 73 74 65 6d 5c 90 02 08 2e 65 78 65 90 00 } //10
	condition:
...
rule Worm_Win32_Autorun_CX_2{
	...
	strings :
		$a_00_0 = {73 65 6d 65 6e 61 5f 64 6f 6f 72 } //10 semena_door
		$a_02_1 = {2e 62 61 74 90 02 10 40 73 68 69 66 74 90 00 } //10
		...
		$a_02_3 = {2f 76 20 41 6e 74 69 76 69 72 75 7a 20 2f 64 20 25 77 69 6e 64 69 72 25 5c 73 79 73 74 65 6d 5c 90 02 08 2e 65 78 65 90 00 } //10
