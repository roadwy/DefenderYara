...
rule Worm_Win32_Autorun_AGK{
	...
	strings :
		...
		$a_00_1 = {6f 70 65 6e 3d 22 53 56 43 48 4f 53 54 2e 63 6f 6d 20 2f 73 } //01 00  open="SVCHOST.com /s
		$a_00_2 = {61 75 74 6f 72 75 6e 2e 69 6e 66 } //01 00  autorun.inf
		$a_00_3 = {44 45 53 54 4f 52 59 5f 5a 5a 5f 25 64 } //01 00  DESTORY_ZZ_%d
		$a_00_4 = {77 6a 76 69 65 77 33 32 2e 63 6f 6d 20 2f 73 } //00 00  wjview32.com /s
	condition:
		any of ($a_*)
