...
rule Worm_Win32_Autorun_DQ{
	...
	strings :
		...
		$a_02_1 = {43 3a 5c 77 69 6e 64 6f 77 73 5c 54 65 6d 70 5c 90 02 08 2e 74 78 74 90 00 } //1
		$a_02_2 = {43 3a 5c 77 69 6e 64 6f 77 73 5c 54 65 6d 70 5c 90 02 08 2e 65 78 65 90 00 } //1
