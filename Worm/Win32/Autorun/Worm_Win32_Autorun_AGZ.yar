...
rule Worm_Win32_Autorun_AGZ{
	...
	strings :
		...
		$a_02_1 = {5c 5c 31 39 32 2e 31 36 38 2e 30 2e [0-03] 5c 73 65 63 72 65 74 2e 65 78 65 [0-03] 5c 5c 31 39 32 2e 31 36 38 2e 30 2e [0-03] 5c 73 65 63 72 65 74 2e 65 78 65 } //1
	condition:
