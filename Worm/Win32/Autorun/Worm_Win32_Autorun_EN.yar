...
rule Worm_Win32_Autorun_EN{
	...
	strings :
		...
		$a_03_3 = {ff 15 40 70 40 00 6a 07 8d ?? ?? ?? 50 ff d7 68 ?? ?? ?? ?? 6a 68 6a 00 ff 15 44 70 40 00 8b f0 85 f6 0f ?? ?? ?? 00 00 56 6a 00 ff 15 48 70 40 00 56 6a 00 ?? ?? ?? ?? ff 15 4c 70 40 00 } //1
	condition:
