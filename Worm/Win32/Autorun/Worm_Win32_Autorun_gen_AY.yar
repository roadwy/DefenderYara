...
rule Worm_Win32_Autorun_gen_AY{
	...
	strings :
		...
		$a_03_1 = {f7 d8 1b c0 f7 d8 23 f0 f7 de 1b f6 f7 de 8b 45 d8 50 68 90 01 04 ff 15 90 01 04 f7 d8 1b c0 f7 d8 23 f0 85 f6 75 50 c7 45 fc 0a 00 00 00 68 90 00 } //1
	condition:
