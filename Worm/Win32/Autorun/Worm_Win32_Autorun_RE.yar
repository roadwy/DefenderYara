...
rule Worm_Win32_Autorun_RE{
	...
	strings :
		...
		$a_02_3 = {52 45 47 20 41 44 44 20 48 4b 45 59 5f 90 02 10 5c 53 6f 66 74 77 61 72 65 5c 4d 69 63 72 6f 73 6f 66 74 5c 57 69 6e 64 6f 77 73 5c 43 75 72 72 65 6e 74 56 65 72 73 69 6f 6e 5c 52 75 6e 20 2f 76 20 90 00 } //10
