...
rule Worm_Win32_Autorun_QH{
	...
	strings :
		$a_01_0 = {55 00 53 00 42 00 4d 00 6f 00 6e 00 4d 00 75 00 74 00 65 00 78 00 32 00 2e 00 30 00 } //01 00 
		$a_01_1 = {25 53 79 73 74 65 6d 52 6f 6f 74 25 5c 73 79 73 74 65 6d 33 32 5c 75 73 62 6d 6f 6e 73 2e 65 78 65 } //01 00 
