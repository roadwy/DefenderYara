...
rule Worm_Win32_Autorun_AEU{
	...
	strings :
		...
		$a_00_3 = {73 6d 74 70 2e 6d 61 69 6c 2e 79 61 68 6f 6f 2e 63 6f 2e 75 6b } //01 00 
		$a_00_4 = {5b 43 74 72 6c 5d } //01 00 
		$a_00_5 = {5b 45 73 63 5d } //01 00 
		$a_00_6 = {6b 69 6c 6c 20 65 6e 65 6d 61 79 } //01 00 
		$a_00_7 = {5c 4e 65 77 56 65 72 53 69 6f 6e 2e 73 79 73 } //00 00 
	condition:
		any of ($a_*)
