...
rule Worm_Win32_Autorun_ES{
	...
	strings :
		...
		$a_01_2 = {68 74 74 70 3a 2f 2f 6b 6b 6b 6b 62 2e 63 6f 6d } //01 00 
		$a_01_3 = {41 75 74 6f 72 75 6e 2e 69 6e 66 } //01 00 
		$a_01_4 = {5b 41 75 74 6f 52 75 6e 5d } //01 00 
		$a_01_5 = {43 6f 6d 6d 61 6e 64 3d 44 72 69 76 65 2e 65 78 65 } //01 00 
		$a_01_6 = {51 51 32 30 30 37 69 6e 69 } //01 00 
		$a_01_7 = {68 70 78 6b 32 30 30 37 } //01 00 
		$a_01_8 = {55 52 4c 44 6f 77 6e 6c 6f 61 64 54 6f 46 69 6c 65 41 } //01 00 
		$a_01_9 = {43 3a 5c 57 49 4e 44 4f 57 53 5c 53 59 53 54 45 4d 33 32 5c 51 51 32 30 30 37 5c 51 51 2e 65 78 30 } //00 00 
	condition:
		any of ($a_*)
