...
rule Worm_Win32_Autorun_FL{
	...
	strings :
		...
		$a_01_2 = {5b 61 75 74 6f 72 75 6e 5d 00 } //01 00 
		$a_01_3 = {61 75 74 6f 72 75 6e 2e 69 6e 66 00 } //01 00 
		$a_01_4 = {73 65 72 69 61 6c 3d } //01 00 
		$a_01_5 = {76 65 72 73 69 6f 6e 3d } //01 00 
		$a_01_6 = {3a 2a 3a 45 6e 61 62 6c 65 64 3a } //00 00 
	condition:
		any of ($a_*)
