...
rule Worm_Win32_Autorun_KC{
	...
	strings :
		$a_02_0 = {5c 52 75 6e 90 02 08 48 6f 6f 6b 50 72 6f 63 2e 64 6c 6c 90 02 04 65 78 70 6c 6f 72 65 72 2e 65 78 65 90 00 } //10
		$a_02_1 = {48 69 64 65 51 51 90 02 04 48 6f 6f 6b 50 72 6f 63 90 00 } //10
