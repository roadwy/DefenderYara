...
rule Worm_Win32_Autorun_BR{
	...
	strings :
		...
		$a_02_2 = {68 74 74 70 3a 2f 2f 90 02 30 2e 65 78 65 90 00 } //10
		...
		$a_02_10 = {33 c9 51 51 51 51 51 51 33 c0 55 68 90 01 04 64 ff 30 64 89 20 6a 00 6a 00 8d 45 fc e8 90 01 04 8d 45 fc 50 8d 45 f4 8b 15 90 01 04 e8 90 01 04 8b 45 f4 8d 55 f8 e8 90 01 04 8b 55 f8 58 e8 90 01 04 8b 45 fc e8 90 01 04 50 a1 90 01 04 50 6a 00 e8 90 01 04 85 c0 75 3e 6a 01 8d 45 f0 90 00 } //100
	condition:
