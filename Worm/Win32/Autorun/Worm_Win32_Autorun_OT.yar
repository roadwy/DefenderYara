...
rule Worm_Win32_Autorun_OT{
	...
	strings :
		...
		$a_01_2 = {73 68 65 6c 6c 5c 41 75 74 6f 5c 63 6f 6d 6d 61 6e 64 3d 22 73 76 63 68 6f 76 73 74 2e 45 58 45 22 } //01 00 
		$a_01_3 = {5b 41 55 54 4f 52 55 4e 5d } //01 00 
		$a_01_4 = {25 73 61 75 74 6f 72 75 6e 2e 69 6e 66 } //00 00 
	condition:
		any of ($a_*)
