...
rule Worm_Win32_Autorun_AEL{
	...
	strings :
		...
		$a_00_1 = {41 75 74 6f 52 75 6e 2e 69 6e 66 } //03 00  AutoRun.inf
		$a_00_2 = {33 36 30 73 65 5f 46 72 61 6d 65 } //06 00  360se_Frame
		$a_00_3 = {63 3a 5c 54 53 54 50 5c 77 69 6e 6c 6f 67 6f 6e 2e 65 78 65 } //00 00  c:\TSTP\winlogon.exe
	condition:
		any of ($a_*)
