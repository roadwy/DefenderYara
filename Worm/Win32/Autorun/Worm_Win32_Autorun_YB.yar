...
rule Worm_Win32_Autorun_YB{
	...
	strings :
		$a_02_0 = {6d 79 64 6f 77 6e 2e 61 73 70 3f 76 65 72 3d 30 38 31 30 90 02 02 26 74 67 69 64 3d 90 02 10 26 61 64 64 72 65 73 73 3d 30 30 2d 30 30 2d 30 30 2d 30 30 2d 30 30 2d 30 30 90 00 } //10
