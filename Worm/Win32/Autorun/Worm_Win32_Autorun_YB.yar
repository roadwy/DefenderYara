...
rule Worm_Win32_Autorun_YB{
	...
	strings :
		...
		$a_00_1 = {43 3a 5c 57 49 4e 44 4f 57 53 5c 6d 79 64 6f 77 6e 2e 61 73 70 } //01 00 
		$a_00_2 = {53 68 75 69 4e 69 75 2e 65 78 65 } //01 00 
		$a_00_3 = {71 71 6d 2e 65 78 65 } //00 00 
	condition:
		any of ($a_*)
