...
rule Worm_Win32_Autorun_PI{
	...
	strings :
		$a_03_0 = {f7 d8 1b c0 40 23 f0 f7 de 1b f6 f7 de 8b 90 01 03 41 00 90 00 } //3
		$a_03_1 = {b8 04 00 02 80 89 85 90 01 01 ff ff ff b9 0a 00 00 00 89 8d 90 01 01 ff ff ff 83 ec 10 8b d4 89 0a 8b 8d 90 01 01 ff ff ff 89 4a 04 89 42 08 8b 85 90 01 01 ff ff ff 89 42 0c 90 00 } //3
