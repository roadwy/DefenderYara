...
rule Worm_Win32_Autorun_RY{
	...
	strings :
		$a_01_0 = {3a 5c 61 75 74 6f 72 75 6e 2e 69 6e 66 } //01 00 
		...
		$a_01_2 = {6c 6f 63 61 6c 69 70 3d 31 32 37 2e 30 2e 30 2e 31 26 63 6f 6d 70 6e 61 6d 65 3d } //01 00 
		$a_01_3 = {73 79 73 74 65 6d 33 32 5c 64 72 69 76 65 72 73 5c 65 74 63 5c 73 76 63 68 6f 73 74 2e 65 78 65 } //00 00 
	condition:
		any of ($a_*)
