...
rule Worm_Win32_Autorun_OH{
	...
	strings :
		...
		$a_02_1 = {5b 41 75 74 6f 52 75 6e 5d 90 02 20 4f 50 45 4e 3d 54 68 75 6d 62 73 2e 65 78 65 90 02 20 73 68 65 6c 6c 65 78 65 63 75 74 65 3d 54 68 75 6d 62 73 2e 65 78 65 90 02 20 73 68 65 6c 6c 5c 41 75 74 6f 5c 63 6f 6d 6d 61 6e 64 3d 54 68 75 6d 62 73 2e 65 78 65 90 00 } //1
