...
rule Worm_Win32_Autorun_GV{
	...
	strings :
		...
		$a_01_3 = {68 74 74 70 3a 2f 2f 25 63 25 63 25 63 2e 25 63 25 63 25 63 25 63 25 63 25 63 2e 25 63 25 63 25 63 2f 25 63 2e 25 63 25 63 25 63 } //00 00  http://%c%c%c.%c%c%c%c%c%c.%c%c%c/%c.%c%c%c
	condition:
		any of ($a_*)
