...
rule Worm_Win32_Autorun_ZH{
	...
	strings :
		$a_02_0 = {68 fa 8b 34 00 ff b5 ?? ?? ?? ?? e8 } //1
...
rule Worm_Win32_Autorun_ZH_3{
	...
	strings :
		$a_02_0 = {46 69 6c 65 4e 61 6d 65 41 63 74 75 61 6c [0-20] 46 69 72 73 74 49 6e 73 74 61 6c 6c [0-10] 64 64 6f 73 65 72 [0-10] 55 53 42 } //10
