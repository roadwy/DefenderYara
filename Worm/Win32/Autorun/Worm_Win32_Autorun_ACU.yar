...
rule Worm_Win32_Autorun_ACU{
	...
	strings :
		...
		$a_00_1 = {6e 65 74 73 68 20 66 69 72 65 77 61 6c 6c 20 73 65 74 20 6f 70 6d 6f 64 65 20 64 69 73 61 62 6c 65 } //01 00  netsh firewall set opmode disable
		$a_00_2 = {3a 5c 61 75 74 6f 72 75 6e 2e 69 6e 66 } //01 00  :\autorun.inf
