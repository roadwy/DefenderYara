...
rule Worm_Win32_Autorun_ACU{
	...
	strings :
		$a_02_0 = {fe 45 f7 80 7d f7 5b 0f 85 90 01 04 33 c0 90 00 } //1
		...
		$a_02_3 = {8d 85 b4 fe ff ff 50 8b 45 fc e8 90 01 04 50 e8 90 01 04 89 45 f4 83 7d f4 ff 74 0f c6 45 fb 01 90 00 } //1
	condition:
