...
rule Worm_Win32_Autorun_DB{
	meta:
		description = "Worm:Win32/Autorun.DB,SIGNATURE_TYPE_PEHSTR,06 00 06 00 06 00 00 01 00 "
		
	strings :
		$a_01_0 = {43 3a 5c 57 49 4e 44 4f 57 53 5c 53 59 53 54 45 4d 33 32 5c 6c 69 76 65 75 70 64 61 74 61 2e 64 6c 6c } //01 00  C:\WINDOWS\SYSTEM32\liveupdata.dll
		$a_01_1 = {6e 6f 20 63 72 65 61 74 65 } //01 00  no create
		$a_01_2 = {77 69 6e 6c 69 76 65 2e 65 78 65 } //01 00  winlive.exe
		$a_01_3 = {61 75 74 6f 72 75 6e 2e 69 6e 66 } //01 00  autorun.inf
		$a_01_4 = {5b 41 75 74 6f 52 75 6e 5d } //01 00  [AutoRun]
		$a_01_5 = {73 68 65 6c 6c 5c 41 75 74 6f 4f 70 65 6e 5c 63 6f 6d 6d 61 6e 64 3d 2e 5c 4d 53 4f 43 61 63 68 65 5c 39 30 30 30 30 38 30 34 2d 36 30 30 30 2d 31 31 44 33 2d 38 43 46 45 2d 30 31 35 30 30 34 38 33 38 33 43 30 5c 4b 42 39 31 35 38 36 36 2e 65 78 65 } //00 00  shell\AutoOpen\command=.\MSOCache\90000804-6000-11D3-8CFE-0150048383C0\KB915866.exe
	condition:
		any of ($a_*)
