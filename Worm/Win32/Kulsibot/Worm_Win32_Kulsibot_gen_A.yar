...
rule Worm_Win32_Kulsibot_gen_A{
	...
	strings :
		...
		$a_03_6 = {68 8b 00 00 00 56 e8 90 01 04 83 c4 90 01 01 83 f8 01 75 e1 68 8b 00 00 00 56 ff d7 50 e8 90 01 04 eb d1 90 00 } //5
		$a_03_7 = {68 bd 01 00 00 56 e8 90 01 04 83 c4 90 01 01 83 f8 01 75 e1 68 bd 01 00 00 56 ff d7 50 e8 90 01 04 eb d1 90 00 } //5
		$a_03_8 = {03 d9 81 e3 ff 00 00 00 8a 4c 1c 90 01 01 8a 1c 28 32 d9 88 1c 28 40 3b c2 72 90 00 } //5
	condition:
