...
rule Worm_Win32_Lightmoon_gen@mm_B{
	...
	strings :
		$a_01_0 = {4e 65 77 4d 6f 6f 6e 6c 69 67 68 74 } //14 00 
		...
		$a_01_2 = {54 6d 72 54 75 6e 67 67 75 63 6f 6e 65 63 74 } //05 00 
		$a_01_3 = {54 6d 72 4b 65 79 4c 6f 67 } //05 00 
		$a_01_4 = {54 6d 72 44 6f 73 } //01 00 
		$a_01_5 = {53 63 61 6e 45 6d 61 69 6c } //00 00 
	condition:
		any of ($a_*)
