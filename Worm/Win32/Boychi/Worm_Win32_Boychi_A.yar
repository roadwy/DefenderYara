...
rule Worm_Win32_Boychi_A{
	...
	strings :
		...
		$a_01_27 = {41 64 76 69 73 6f 72 73 20 41 73 73 69 73 74 61 6e 74 5c 41 64 76 69 73 6f 72 73 41 73 73 69 73 74 61 6e 74 2e 70 64 62 } //9c ff 
		$a_01_28 = {43 00 6c 00 69 00 65 00 6e 00 74 00 20 00 4d 00 61 00 72 00 6b 00 65 00 74 00 69 00 6e 00 67 00 20 00 53 00 79 00 73 00 74 00 65 00 6d 00 73 00 } //9c ff 
		$a_01_29 = {53 00 74 00 61 00 72 00 20 00 43 00 69 00 74 00 79 00 20 00 4f 00 6e 00 6c 00 69 00 6e 00 65 00 20 00 47 00 61 00 6d 00 65 00 } //9c ff 
		$a_01_30 = {4c 00 61 00 6e 00 67 00 75 00 61 00 67 00 65 00 3d 00 54 00 57 00 26 00 43 00 61 00 74 00 65 00 67 00 6f 00 72 00 79 00 3d 00 4c 00 6f 00 67 00 69 00 6e 00 26 00 52 00 65 00 67 00 69 00 6f 00 6e 00 3d 00 38 00 38 00 36 00 26 00 53 00 65 00 72 00 76 00 69 00 63 00 65 00 4e 00 61 00 6d 00 65 00 3d 00 } //9c ff 
		$a_01_31 = {50 73 79 63 68 6f 64 61 74 4f 66 66 69 63 65 2e 70 64 62 } //9c ff 
		$a_01_32 = {50 00 73 00 79 00 63 00 68 00 6f 00 44 00 61 00 74 00 20 00 6f 00 66 00 66 00 69 00 63 00 65 00 } //9c ff 
		$a_01_33 = {41 6e 56 69 72 20 54 61 73 6b 20 4d 61 6e 61 67 65 72 } //00 00 
	condition:
		any of ($a_*)
