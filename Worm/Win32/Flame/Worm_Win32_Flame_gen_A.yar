...
rule Worm_Win32_Flame_gen_A{
	...
	strings :
		...
		$a_01_3 = {55 00 50 00 44 00 54 00 5f 00 53 00 59 00 4e 00 43 00 5f 00 4d 00 54 00 58 00 5f 00 54 00 4d 00 45 00 } //01 00  UPDT_SYNC_MTX_TME
		$a_01_4 = {54 00 48 00 5f 00 50 00 4f 00 4f 00 4c 00 5f 00 53 00 48 00 44 00 5f 00 } //02 00  TH_POOL_SHD_
