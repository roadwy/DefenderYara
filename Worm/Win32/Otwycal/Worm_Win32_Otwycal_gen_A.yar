...
rule Worm_Win32_Otwycal_gen_A{
	...
	strings :
		...
		$a_03_1 = {2e c6 84 24 ?? ?? 00 00 65 c6 84 24 ?? ?? 00 00 78 c6 84 24 ?? ?? 00 00 74 88 84 24 ?? ?? 00 00 c6 84 24 ?? ?? 00 00 64 c6 84 24 ?? ?? 00 00 6f c6 84 24 ?? ?? 00 00 77 c6 84 24 ?? ?? 00 00 73 } //1
	condition:
