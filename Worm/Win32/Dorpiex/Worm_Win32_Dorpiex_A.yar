...
rule Worm_Win32_Dorpiex_A{
	...
	strings :
		...
		$a_03_1 = {8b f8 85 ff 0f 84 90 01 02 00 00 81 3f 31 52 44 4c 53 55 0f 85 90 01 02 00 00 8b 44 24 90 01 01 83 f8 0c 90 00 } //1
		$a_03_2 = {81 38 31 52 44 4c 0f 85 90 01 02 00 00 83 7d f4 90 01 01 73 05 e9 90 01 02 00 00 8b 4d 90 01 01 83 e9 0c 90 00 } //1
	condition:
