...
rule Worm_Win32_Ambler_B{
	...
	strings :
		$a_03_0 = {24 f8 50 56 ff 15 ?? ?? ?? ?? 56 ff 15 90 09 0c 00 be ?? ?? ?? ?? 56 ff 15 } //1
		$a_03_1 = {6a 01 5f 8d 4b 01 2b fb 0f be 51 ff 8a c2 03 75 fc f6 d0 32 c2 24 ?? f6 d2 32 c2 88 41 ff } //1
