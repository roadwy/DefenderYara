...
rule Worm_Win32_Taterf_B{
	...
	strings :
		$a_01_0 = {65 78 70 6c 6f 72 65 72 2e 65 78 65 20 25 73 } //01 00 
		$a_01_1 = {47 65 74 49 6e 70 75 74 53 74 61 74 65 } //01 00 
		$a_01_2 = {43 72 65 61 74 65 52 65 6d 6f 74 65 54 68 72 65 61 64 } //01 00 
		$a_01_3 = {81 7d f8 40 19 01 00 0f 87 } //01 00 
		$a_01_4 = {41 6c 65 72 74 44 69 61 6c 6f 67 } //02 00 
		$a_01_5 = {50 72 6f 64 75 63 74 5f 4e 6f 74 69 66 69 63 61 74 69 6f 6e } //02 00 
