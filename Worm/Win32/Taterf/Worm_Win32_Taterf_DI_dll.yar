...
rule Worm_Win32_Taterf_DI_dll{
	...
	strings :
		...
		$a_03_2 = {b0 65 aa b0 78 aa b0 70 aa b0 6c aa b0 6f aa b0 72 aa b0 65 aa b0 72 aa b0 2e aa b0 65 aa b0 78 aa b0 65 aa 68 90 01 04 68 90 01 04 ff 15 90 00 } //2
	condition:
