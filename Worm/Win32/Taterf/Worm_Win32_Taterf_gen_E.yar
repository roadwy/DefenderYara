...
rule Worm_Win32_Taterf_gen_E_2{
	...
	strings :
		...
		$a_03_1 = {ff d6 bf ff ff 00 00 23 c7 3d 16 1c 00 00 76 90 03 0d 0c 90 01 01 3d 20 1c 00 00 73 90 01 01 cc 0f 3d 20 1c 00 00 73 08 6a 00 ff 15 90 00 } //1
		$a_03_2 = {58 83 38 00 75 1f ff 00 ff 74 24 10 ff 74 24 10 ff 74 24 10 ff 74 24 10 90 09 09 00 e8 04 00 00 00 90 00 } //1
	condition:
