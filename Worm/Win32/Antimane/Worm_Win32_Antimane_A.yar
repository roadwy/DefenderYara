...
rule Worm_Win32_Antimane_A{
	...
	strings :
		...
		$a_02_2 = {68 74 74 70 3a 2f 2f 77 77 77 2e 70 72 6f 63 6f 6e 73 75 6c 2e 63 6f 6d 2e 72 6f 2f 66 6c 6f 72 69 6e 2f 90 02 20 2e 6d 70 33 90 00 } //1
		$a_00_3 = {41 64 72 69 61 6e 20 4d 69 6e 75 6e 65 } //1 Adrian Minune
		$a_02_4 = {31 32 37 2e 30 2e 30 2e 31 90 02 10 77 77 77 2e 6d 61 6e 65 6c 65 34 75 2e 6f 72 67 90 00 } //1
	condition:
