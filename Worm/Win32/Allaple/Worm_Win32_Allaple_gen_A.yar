...
rule Worm_Win32_Allaple_gen_A{
	...
	strings :
		...
		$a_01_1 = {5c 6c 73 61 72 70 63 00 5c 5c 2a 53 4d 42 53 45 52 56 45 52 5c 49 50 43 24 00 41 64 6d 69 6e 69 73 74 72 61 74 6f 72 00 70 61 73 73 77 6f 72 64 5c 5c 25 73 } //01 00 
