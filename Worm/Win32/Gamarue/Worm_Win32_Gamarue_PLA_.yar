...
rule Worm_Win32_Gamarue_PLA_{
	...
	strings :
		...
		$a_03_2 = {25 03 00 00 80 79 05 48 83 c8 fc 40 83 c0 08 39 45 ?? 7d 4b e8 ?? ?? ?? ?? 99 b9 4b 00 00 00 f7 f9 83 c2 30 89 55 ?? 83 7d ?? 30 7c 06 83 7d ?? 39 7e 0c 83 7d ?? 61 7c 1b 83 7d ?? 7a 7f 15 } //1
	condition:
