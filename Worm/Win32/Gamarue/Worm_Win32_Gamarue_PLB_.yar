...
rule Worm_Win32_Gamarue_PLB_{
	...
	strings :
		$a_01_0 = {25 00 74 00 6d 00 70 00 25 00 5c 00 74 00 76 00 2e 00 64 00 6c 00 6c 00 } //01 00 
		$a_01_1 = {2c 22 74 76 69 64 22 3a 25 6c 75 2c 22 74 76 70 77 22 3a 25 6c 75 } //01 00 
