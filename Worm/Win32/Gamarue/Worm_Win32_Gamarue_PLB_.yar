...
rule Worm_Win32_Gamarue_PLB_{
	...
	strings :
		...
		$a_03_2 = {68 83 4e 00 00 57 ff 15 90 01 04 8b f0 85 f6 74 40 68 00 01 00 00 8d 85 00 ff ff ff 50 68 82 4e 00 00 57 ff 15 90 01 04 85 c0 74 24 8d 85 00 ff ff ff 50 e8 90 01 04 8d 85 00 ff ff ff 50 ff 15 90 01 04 a3 90 01 04 89 35 90 00 } //1
	condition:
