...
rule Worm_Win32_Gamarue_AR_MTB{
	...
	strings :
		...
		$a_00_1 = {53 68 65 6c 6c 45 78 65 63 5c 6f 75 74 5c 72 65 6c 65 61 73 65 5c 6e 6f 75 62 6d 6e 7a 61 2e 70 64 62 } //01 00  ShellExec\out\release\noubmnza.pdb
		$a_01_2 = {49 6e 64 65 78 65 72 56 6f 6c 75 6d 65 47 75 69 64 } //00 00  IndexerVolumeGuid
	condition:
		any of ($a_*)
