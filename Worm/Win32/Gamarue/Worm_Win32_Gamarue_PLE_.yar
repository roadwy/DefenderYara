...
rule Worm_Win32_Gamarue_PLE_{
	...
	strings :
		$a_01_0 = {22 00 7d 00 2c 00 7b 00 22 00 74 00 22 00 3a 00 25 00 6c 00 75 00 2c 00 22 00 70 00 22 00 3a 00 22 00 25 00 73 00 22 00 2c 00 22 00 63 00 22 00 3a 00 22 00 25 00 73 00 25 00 73 00 22 00 2c 00 22 00 64 00 22 00 3a 00 22 00 25 00 73 00 } //01 00 
		$a_01_1 = {2c 22 6b 6c 22 3a 22 } //01 00 
