...
rule Worm_Win32_Gamarue_S{
	...
	strings :
		$a_03_0 = {a5 a5 a5 a5 33 f6 56 68 80 00 00 00 6a 03 56 6a 01 68 00 00 00 80 50 ff 15 ?? ?? ?? ?? a3 ?? ?? ?? ?? 83 f8 ff 74 1a 56 68 20 30 00 10 53 ff 35 18 30 00 10 50 ff 15 08 20 00 10 ff 15 18 30 00 10 } //1
