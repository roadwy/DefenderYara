...
rule Worm_Win32_Yacspeel_gen_A{
	...
	strings :
		$a_02_0 = {74 b1 8b 44 24 14 50 ff 15 14 00 01 10 b9 90 01 01 5b 01 10 e8 90 01 02 00 00 68 00 5c 26 05 ff 15 90 01 02 01 10 8b 0d 90 01 01 5b 01 10 6a 01 81 c1 20 07 00 00 6a 04 51 b9 90 00 } //10
		$a_02_1 = {74 24 8d 54 24 10 52 e8 ef 31 00 00 83 c4 04 e8 90 01 01 cd ff ff 8b 46 0c 8b 4c 24 10 89 48 10 8b 4e 0c e8 73 01 00 00 68 00 5c 26 05 ff d7 8b 15 90 01 01 5b 01 10 8b 82 44 08 00 00 85 c0 75 2f 8b ce e8 25 09 00 00 85 c0 74 24 90 00 } //10
