...
rule Worm_Win32_Regul_A{
	...
	strings :
		...
		$a_01_1 = {65 78 70 6c 6f 72 65 72 20 00 2e 65 78 65 00 72 65 73 74 61 72 74 } //01 00  硥汰牯牥 攮數爀獥慴瑲
		...
		$a_01_4 = {6b 65 79 62 64 5f 65 76 65 6e 74 } //01 00  keybd_event
		$a_01_5 = {47 65 74 54 65 6d 70 50 61 74 68 41 } //00 00  GetTempPathA
	condition:
		any of ($a_*)
