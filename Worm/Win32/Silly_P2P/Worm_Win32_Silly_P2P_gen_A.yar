...
rule Worm_Win32_Silly_P2P_gen_A{
	...
	strings :
		...
		$a_01_3 = {77 65 62 73 69 74 65 3d 31 } //01 00  website=1
		$a_01_4 = {6b 61 7a 61 61 5c 6d 79 20 73 68 61 72 65 64 20 66 6f 6c 64 65 72 } //01 00  kazaa\my shared folder
	condition:
		any of ($a_*)
