...
rule Worm_Win32_Silly_P2P_G{
	...
	strings :
		$a_02_0 = {73 68 65 6c 6c 5c 6f 70 65 6e 5c 63 6f 6d 6d 61 6e 64 3d 90 02 20 2e 65 78 65 90 00 } //10
		$a_02_1 = {69 63 6f 6e 3d 25 90 02 10 25 5c 73 79 73 74 65 6d 33 32 5c 53 48 45 4c 4c 33 32 2e 64 6c 6c 2c 90 00 } //10
