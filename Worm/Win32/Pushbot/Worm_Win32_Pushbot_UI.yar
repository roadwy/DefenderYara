...
rule Worm_Win32_Pushbot_UI{
	...
	strings :
		$a_00_0 = {43 3a 5c 55 73 65 72 73 5c 68 65 78 5c 41 70 70 44 61 74 61 5c 4c 6f 63 61 6c 5c 54 65 6d 70 5c 54 72 61 76 65 6c 65 72 7a 5c 56 42 36 2e 4f 4c 42 } //01 00  C:\Users\hex\AppData\Local\Temp\Travelerz\VB6.OLB
		$a_00_1 = {53 61 6c 6d 61 6e 64 6f 73 } //01 00  Salmandos
