...
rule Worm_Win32_Pushbot_UI{
	...
	strings :
		...
		$a_03_2 = {fc 06 00 00 c7 45 fc 90 01 01 00 00 00 c7 85 90 01 02 ff ff 90 01 02 40 00 c7 85 90 01 01 fe ff ff 08 00 00 00 8d 90 01 03 8d 90 01 02 fe ff ff 90 01 01 8d 90 01 03 ff ff 90 00 } //1
	condition:
