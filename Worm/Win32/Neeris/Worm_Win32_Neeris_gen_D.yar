...
rule Worm_Win32_Neeris_gen_D{
	...
	strings :
		...
		$a_01_3 = {00 73 79 73 64 72 76 33 32 2e 73 79 73 00 } //01 00 
		$a_01_4 = {43 61 63 68 65 2d 43 6f 6e 74 72 6f 6c 3a 20 6e 6f 2d 63 61 63 68 65 2c 6e 6f 2d 73 74 6f 72 65 2c 6d 61 78 2d 61 67 65 3d 30 } //00 00 
	condition:
		any of ($a_*)
