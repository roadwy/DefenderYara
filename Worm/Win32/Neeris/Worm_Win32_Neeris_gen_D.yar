...
rule Worm_Win32_Neeris_gen_D{
	...
	strings :
		...
		$a_03_1 = {8d 3c 10 0f b6 01 0f b6 cb 03 c1 8b ce 99 f7 f9 8b 4d 08 8a 84 15 90 01 04 32 04 39 ff 45 fc 88 07 90 00 } //2
		$a_03_2 = {6a 68 ff 15 90 01 04 6a 04 8d 75 90 01 01 99 59 f7 f9 85 c0 7e 90 01 01 53 57 8b 3d 90 01 04 8b d8 56 ff 15 90 01 04 83 f8 02 75 90 00 } //1
