...
rule Worm_Win32_Chiviper_C{
	...
	strings :
		...
		$a_03_1 = {8d 45 ec 50 ff 15 90 01 04 83 f8 03 74 05 83 f8 02 75 0a 8d 45 ec 50 e8 90 01 02 00 00 59 fe c3 80 fb 5a 7c c4 90 00 } //2
		...
		$a_03_5 = {25 73 5c 61 64 6d 69 6e 24 5c 90 02 08 2e 65 78 65 90 00 } //1
