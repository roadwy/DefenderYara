...
rule Worm_Win32_Chiviper_C{
	...
	strings :
		...
		$a_01_3 = {24 41 55 54 4f 52 55 49 4e 46 } //01 00 
		$a_01_4 = {6d 61 63 3d 25 73 26 76 65 72 3d } //01 00 
		$a_03_5 = {25 73 5c 61 64 6d 69 6e 24 5c 90 02 08 2e 65 78 65 90 00 } //01 00 
		$a_01_6 = {72 73 3d 63 72 65 61 74 65 4f 62 6a 65 63 74 28 22 57 73 63 72 69 70 74 2e 73 68 65 6c 6c 22 29 } //00 00 
	condition:
		any of ($a_*)
