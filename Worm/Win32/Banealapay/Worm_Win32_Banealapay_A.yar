...
rule Worm_Win32_Banealapay_A{
	...
	strings :
		$a_00_0 = {49 6e 66 65 63 74 44 72 69 76 65 } //01 00  InfectDrive
		$a_00_1 = {47 65 74 41 6c 69 76 65 48 6f 73 74 73 } //01 00  GetAliveHosts
		$a_00_2 = {49 6e 66 65 63 74 53 75 62 6e 65 74 } //01 00  InfectSubnet
