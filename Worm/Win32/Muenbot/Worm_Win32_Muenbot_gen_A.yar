...
rule Worm_Win32_Muenbot_gen_A{
	...
	strings :
		$a_03_0 = {b9 eb 05 00 00 8d 85 ?? ?? ?? ?? e8 ?? ?? ?? ?? 6a 00 8b 45 f8 50 8d 85 ?? ?? ?? ?? 50 8b 43 20 50 e8 ?? ?? ?? ?? 6a 01 e8 ?? ?? ?? ?? 8d 85 ?? ?? ?? ?? e8 ?? ?? ?? ?? 84 c0 74 ba } //5
		$a_03_1 = {3d 37 0c 00 00 7f 2b 0f 84 ?? ?? 00 00 2d 8b 00 00 00 74 4d 2d 32 01 00 00 74 5a 2d 63 01 00 00 74 67 2d 99 07 00 00 } //5
		$a_03_2 = {ba 8b 00 00 00 8b 45 fc e8 ?? ?? ?? ?? 8b d8 e9 ?? ?? ?? ?? ba bd 01 00 00 8b 45 fc e8 } //5
