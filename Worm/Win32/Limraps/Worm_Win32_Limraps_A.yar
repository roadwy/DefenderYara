...
rule Worm_Win32_Limraps_A{
	...
	strings :
		...
		$a_01_3 = {4d 65 73 73 61 67 65 2d 49 44 3a 20 3c 25 64 25 30 32 64 25 30 32 64 25 30 32 64 25 30 32 64 25 30 32 64 25 64 40 6d 78 2e 67 6f 6f 67 6c 65 2e 63 6f 6d 3e } //01 00 
		$a_01_4 = {5b 61 75 74 6f 72 75 6e 5d } //01 00 
		$a_01_5 = {74 66 74 70 20 2d 69 20 25 73 20 67 65 74 20 25 73 } //01 00 
		$a_01_6 = {46 72 6f 6d 3a 20 79 6f 75 72 20 66 72 69 65 6e 64 2e } //00 00 
	condition:
		any of ($a_*)
