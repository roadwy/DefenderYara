...
rule Worm_Win32_Seeav_B{
	...
	strings :
		$a_03_0 = {81 7d 10 00 80 00 00 0f 85 ?? ?? ?? ?? 8b 40 0c 32 db 8d 64 24 00 a8 01 75 09 fe c3 d1 e8 80 fb 1a 7c } //1
		$a_03_1 = {80 c3 41 0f be c3 50 68 ?? ?? ?? ?? 8d 4c 24 5c 6a 0a 51 e8 ?? ?? ?? ?? 83 c4 10 8d 54 24 0c 52 6a 00 8d 44 24 5c 50 68 ?? ?? ?? ?? 6a 00 6a 00 c7 44 24 24 00 00 00 00 ff 15 } //1
