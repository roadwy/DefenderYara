...
rule Worm_Win32_Yoinoir_A{
	...
	strings :
		$a_03_0 = {83 f8 02 75 19 8d 45 f8 8b d3 e8 90 01 04 8b 55 f8 8b c6 b9 90 01 04 e8 90 01 04 43 83 fb 5b 75 b7 90 00 } //2
		$a_03_1 = {66 c7 45 ea 50 00 8d 45 da 50 e8 90 01 04 85 c0 0f 94 c3 90 00 } //1
