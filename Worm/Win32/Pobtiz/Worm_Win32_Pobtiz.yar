...
rule Worm_Win32_Pobtiz{
	...
	strings :
		...
		$a_01_3 = {00 73 70 72 65 64 31 00 } //01 00  猀牰摥1
		$a_01_4 = {00 74 6f 62 65 73 68 6f 72 65 00 } //01 00 
		$a_01_5 = {00 68 69 64 65 69 74 00 } //01 00  栀摩楥t
		...
		$a_01_7 = {5c 00 41 00 72 00 65 00 73 00 5c 00 4d 00 79 00 20 00 53 00 68 00 61 00 72 00 65 00 64 00 20 00 46 00 6f 00 6c 00 64 00 65 00 72 00 5c 00 73 00 68 00 61 00 72 00 65 00 5c 00 } //01 00  \Ares\My Shared Folder\share\
