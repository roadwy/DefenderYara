...
rule Worm_Win32_Casmondu_A{
	...
	strings :
		$a_01_0 = {4d 00 79 00 4d 00 6f 00 6e 00 65 00 79 00 2e 00 76 00 62 00 70 00 } //01 00 
		$a_01_1 = {75 00 73 00 65 00 72 00 63 00 61 00 73 00 68 00 2e 00 63 00 6f 00 6d 00 } //01 00 
		...
		$a_01_3 = {74 6d 72 49 6e 66 65 63 74 } //01 00 
		$a_01_4 = {74 6d 72 4d 6f 6e 65 79 } //00 00 
	condition:
		any of ($a_*)
