...
rule Worm_Win32_EyeStye_B_2{
	...
	strings :
		$a_01_0 = {42 61 73 69 63 20 55 53 42 20 53 70 72 65 61 64 20 3a 20 53 70 72 65 61 64 69 6e 67 20 22 25 73 22 20 41 73 20 22 25 73 22 } //01 00  Basic USB Spread : Spreading "%s" As "%s"
		$a_01_1 = {49 6e 66 65 63 74 65 64 20 44 72 69 76 65 28 73 29 } //01 00  Infected Drive(s)
		$a_00_2 = {25 73 5c 61 75 74 6f 72 75 6e 2e 69 6e 69 } //00 00  %s\autorun.ini
	condition:
		any of ($a_*)
