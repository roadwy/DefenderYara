...
rule Worm_Win32_Sirefef_gen_A{
	...
	strings :
		...
		$a_03_1 = {74 08 8b 40 04 85 c0 75 f1 c3 85 f6 74 05 8b 48 10 90 09 08 00 eb 0b 81 38 90 00 } //1
		$a_03_2 = {81 38 04 00 00 80 75 24 8b 40 0c 3b 05 90 01 04 75 19 8b 41 04 c7 80 b8 00 00 00 90 00 } //1
