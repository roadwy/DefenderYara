...
rule Worm_Win32_Bancos_B{
	...
	strings :
		...
		$a_03_1 = {8b 83 20 03 00 00 90 09 4b 00 b8 90 01 03 00 33 d2 e8 90 01 02 ff ff 8d 45 e8 b9 44 dd 48 00 8b 15 b4 50 49 00 e8 90 01 03 ff 8b 45 e8 e8 90 01 02 ff ff b8 38 dd 48 00 33 d2 e8 90 01 02 ff ff b8 50 dd 48 00 33 d2 e8 90 01 02 ff ff e8 90 01 03 ff 8b 10 ff 52 10 b2 01 90 00 } //4
		...
		$a_02_5 = {44 53 43 30 90 01 03 2e 5a 49 50 90 00 } //1
