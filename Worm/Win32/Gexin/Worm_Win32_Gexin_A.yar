...
rule Worm_Win32_Gexin_A{
	...
	strings :
		...
		$a_00_2 = {43 68 65 63 6b 65 64 56 61 6c 75 65 20 2f 74 20 52 45 47 5f 53 5a 20 2f 64 20 30 20 2f 66 } //01 00  CheckedValue /t REG_SZ /d 0 /f
		$a_00_3 = {43 68 65 63 6b 65 64 56 61 6c 75 65 20 2f 74 20 52 45 47 5f 64 77 6f 72 64 20 2f 64 20 30 30 30 30 30 30 30 32 20 2f 66 } //00 00  CheckedValue /t REG_dword /d 00000002 /f
	condition:
		any of ($a_*)
