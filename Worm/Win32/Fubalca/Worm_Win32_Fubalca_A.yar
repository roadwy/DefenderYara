...
rule Worm_Win32_Fubalca_A{
	...
	strings :
		...
		$a_00_2 = {41 75 74 6f 52 75 6e 2e 69 6e 66 } //01 00  AutoRun.inf
		$a_00_3 = {5b 41 75 74 6f 52 75 6e 5d } //01 00  [AutoRun]
		$a_00_4 = {73 68 65 6c 6c 65 78 65 63 75 74 65 3d } //01 00  shellexecute=
		$a_00_5 = {73 68 65 6c 6c 5c 41 75 74 6f 5c 63 6f 6d 6d 61 6e 64 3d } //01 00  shell\Auto\command=
		$a_00_6 = {4e 6f 44 72 69 76 65 54 79 70 65 41 75 74 6f 52 75 6e } //00 00  NoDriveTypeAutoRun
	condition:
		any of ($a_*)
