...
rule Worm_Win32_Fakeon_A_bit{
	...
	strings :
		...
		$a_00_5 = {41 00 75 00 74 00 6f 00 72 00 20 00 44 00 61 00 76 00 69 00 64 00 20 00 46 00 61 00 72 00 6a 00 69 00 20 00 2d 00 20 00 43 00 6f 00 6e 00 63 00 65 00 70 00 74 00 6f 00 20 00 32 00 30 00 31 00 } //65436 Autor David Farji - Concepto 201
	condition:
		((#a_02_0  & 1)*2+(#a_00_1  & 1)*2+(#a_00_2  & 1)*2+(#a_00_3  & 1)*1+(#a_00_4  & 1)*1+(#a_00_5  & 1)*65436) >=6
