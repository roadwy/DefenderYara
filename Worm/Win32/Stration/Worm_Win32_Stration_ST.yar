...
rule Worm_Win32_Stration_ST{
	...
	strings :
		...
		$a_03_1 = {57 8d 54 24 90 01 01 52 33 90 01 02 8d 44 90 01 02 50 68 90 01 06 c7 44 90 01 02 00 00 00 00 ff 15 90 01 04 8b f8 85 ff 74 24 6a ff 57 ff 15 90 01 04 8d 4c 90 01 02 51 57 ff 15 90 01 04 85 c0 74 04 90 00 } //1
