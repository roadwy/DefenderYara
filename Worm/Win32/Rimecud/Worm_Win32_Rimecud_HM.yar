...
rule Worm_Win32_Rimecud_HM{
	...
	strings :
		$a_02_0 = {6f 6d 2f 73 65 74 75 70 5f 62 2e 61 73 70 3f 70 72 6a 3d [0-03] 26 70 69 64 3d [0-03] 26 6d 61 63 3d } //1
		$a_02_1 = {68 74 74 70 3a 2f 2f [0-05] 2e 77 69 6e 73 6f 66 74 31 2e 63 6f 6d 2f } //1
