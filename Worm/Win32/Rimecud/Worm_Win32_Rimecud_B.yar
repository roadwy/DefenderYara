...
rule Worm_Win32_Rimecud_B{
	...
	strings :
		...
		$a_00_4 = {5b 41 75 54 6f 52 75 4e 5d } //01 00 
		$a_00_5 = {50 32 50 20 43 6f 70 79 20 74 6f 3a } //01 00 
		$a_00_6 = {4d 53 4e 20 73 70 72 65 61 64 65 72 20 72 75 6e 6e 69 6e 67 } //01 00 
		$a_00_7 = {55 53 42 20 73 70 72 65 61 64 65 72 20 72 75 6e 6e 69 6e 67 } //01 00 
		$a_00_8 = {46 6c 6f 6f 64 20 72 75 6e 6e 69 6e 67 } //00 00 
	condition:
		any of ($a_*)
