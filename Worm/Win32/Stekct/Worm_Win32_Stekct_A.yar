...
rule Worm_Win32_Stekct_A{
	...
	strings :
		$a_00_0 = {59 61 68 6f 6f 42 75 64 64 79 4d 61 69 6e } //03 00 
		$a_00_1 = {6d 73 67 5f 69 64 3d 25 69 26 63 6c 69 65 6e 74 5f 74 69 6d 65 3d 25 69 26 74 6f 3d 25 73 } //03 00 
