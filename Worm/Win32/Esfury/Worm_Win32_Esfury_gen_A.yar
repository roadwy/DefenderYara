...
rule Worm_Win32_Esfury_gen_A{
	...
	strings :
		...
		$a_01_1 = {61 00 63 00 74 00 69 00 6f 00 6e 00 3d 00 41 00 62 00 72 00 69 00 72 00 } //01 00 
		$a_01_2 = {6d 53 70 72 65 61 64 5f 41 75 74 6f 72 75 6e } //01 00 
		$a_01_3 = {6d 53 70 72 65 61 64 5f 4d 73 6e } //00 00 
	condition:
		any of ($a_*)
