...
rule Worm_BAT_Remrochor_A{
	...
	strings :
		$a_01_0 = {43 68 72 6f 6d 65 72 2e 72 65 73 6f 75 72 63 65 73 } //01 00  Chromer.resources
		$a_01_1 = {61 6e 74 69 53 61 6e 64 62 6f 78 69 65 00 61 6e 74 69 41 6e 75 62 69 73 } //01 00  湡楴慓摮潢楸e湡楴湁扵獩
