...
rule Worm_BAT_Knowlog_B{
	...
	strings :
		...
		$a_01_1 = {67 65 74 4d 53 4e 37 35 50 61 73 73 77 6f 72 64 73 } //01 00  getMSN75Passwords
		$a_01_2 = {44 65 73 76 65 72 4d 61 6c 77 61 72 65 62 79 74 65 73 } //00 00  DesverMalwarebytes
	condition:
		any of ($a_*)
