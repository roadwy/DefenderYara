...
rule Worm_BAT_Necast_B{
	meta:
		description = "Worm:BAT/Necast.B,SIGNATURE_TYPE_PEHSTR_EXT,05 00 05 00 06 00 00 "
		
	strings :
		$a_02_0 = {50 00 65 00 72 00 73 00 69 00 73 00 74 00 61 00 6e 00 74 00 58 00 2a 00 58 00 90 01 02 53 00 70 00 72 00 65 00 61 00 64 00 58 00 2a 00 58 00 90 00 } //2
		$a_02_1 = {4b 00 69 00 6c 00 6c 00 40 00 90 02 10 55 00 53 00 42 00 2c 00 90 02 04 52 00 61 00 72 00 2c 00 5a 00 69 00 70 00 90 00 } //2
