...
rule Worm_BAT_NWorm_GA_MTB{
	...
	strings :
		...
		$a_80_4 = {45 78 65 63 75 74 69 6f 6e 50 6f 6c 69 63 79 20 42 79 70 61 73 73 20 2d 57 69 6e 64 6f 77 53 74 79 6c 65 20 48 69 64 64 65 6e 20 2d 4e 6f 45 78 69 74 20 2d 46 69 6c 65 } //ExecutionPolicy Bypass -WindowStyle Hidden -NoExit -File  1
		$a_80_5 = {72 75 6e 46 69 6c 65 } //runFile  1
		$a_80_6 = {70 6f 6e 67 50 69 6e 67 } //pongPing  1
	condition:
