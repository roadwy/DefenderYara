...
rule Worm_BAT_NWorm_G_MTB{
	meta:
		description = "Worm:BAT/NWorm.G!MTB,SIGNATURE_TYPE_PEHSTR_EXT,05 00 05 00 06 00 00 01 00 "
		
	strings :
		$a_00_0 = {57 30 72 6d 2e 65 78 65 } //01 00  W0rm.exe
		...
		$a_80_4 = {72 75 6e 46 69 6c 65 } //runFile  01 00 
		$a_80_5 = {70 6f 6e 67 50 69 6e 67 } //pongPing  00 00 
	condition:
		any of ($a_*)
