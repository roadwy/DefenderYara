...
rule Worm_BAT_Woserv_B{
	...
	strings :
		...
		$a_00_1 = {57 6f 72 6d 53 65 72 76 69 63 65 } //01 00  WormService
		$a_00_2 = {70 61 73 73 77 6f 72 64 } //01 00  password
		$a_00_3 = {68 69 64 64 65 6e } //01 00  hidden
		$a_00_4 = {41 74 74 61 63 6b 4d 65 74 68 6f 64 } //00 00  AttackMethod
	condition:
		any of ($a_*)
