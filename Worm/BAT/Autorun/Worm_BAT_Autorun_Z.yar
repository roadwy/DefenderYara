...
rule Worm_BAT_Autorun_Z{
	...
	strings :
		...
		$a_00_4 = {65 63 68 6f 20 6f 70 65 6e 3d 25 66 69 6c 65 25 } //01 00 
		$a_00_5 = {65 63 68 6f 20 73 68 65 6c 6c 65 78 65 63 75 74 3d 25 66 69 6c 65 25 } //00 00 
	condition:
		any of ($a_*)
...
rule Worm_BAT_Autorun_Z_2{
	...
	strings :
		$a_01_0 = {2e 00 79 00 6f 00 79 00 6f 00 2e 00 70 00 6c 00 2f 00 61 00 75 00 74 00 6f 00 72 00 75 00 6e 00 2e 00 69 00 6e 00 66 00 } //01 00 
		$a_01_1 = {2e 53 6d 61 72 74 49 72 63 34 6e 65 74 } //01 00 
		$a_01_2 = {47 6f 6c 64 54 72 6f 6a 61 6e } //01 00 
		$a_01_3 = {5c 00 53 00 65 00 74 00 75 00 70 00 5c 00 73 00 76 00 63 00 68 00 6f 00 73 00 74 00 2e 00 65 00 78 00 65 00 } //01 00 
		$a_01_4 = {5c 00 67 00 61 00 6d 00 6d 00 65 00 73 00 73 00 5c 00 73 00 76 00 63 00 68 00 6f 00 73 00 74 00 2e 00 65 00 78 00 65 00 } //00 00 
	condition:
		any of ($a_*)
