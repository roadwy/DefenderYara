...
rule Worm_BAT_Autorun_Z{
	...
	strings :
		...
		$a_02_1 = {5c 4d 69 63 72 6f 73 6f 66 74 5c 57 69 6e 64 6f 77 73 5c 43 75 72 72 65 6e 74 56 65 72 73 69 6f 6e 5c 52 75 6e 22 [0-32] 22 25 74 65 6d 70 25 5c 25 66 69 6c 65 25 } //1
		$a_02_2 = {63 6f 70 79 20 25 74 65 6d 70 25 5c 25 66 69 6c 65 25 20 22 25 25 ?? 3a 5c 25 66 69 6c 65 25 } //1
		$a_02_3 = {61 74 74 72 69 62 20 2b 68 20 22 25 25 ?? 3a 5c 41 75 74 6f 52 75 6e 2e 69 6e 66 } //1
