...
rule Worm_BAT_Autorun_AA{
	...
	strings :
		$a_02_0 = {63 6f 70 79 20 2f 79 20 25 30 20 90 01 01 3a 5c 90 02 10 2e 65 78 65 90 00 } //1
		$a_02_1 = {65 63 68 6f 20 5b 41 75 74 6f 52 75 6e 5d 20 3e 20 90 01 01 3a 5c 61 75 74 6f 72 75 6e 2e 69 6e 66 90 00 } //1
		$a_02_2 = {65 63 68 6f 20 73 68 65 6c 6c 65 78 65 63 75 74 65 3d 90 02 32 2e 65 78 65 20 3e 3e 20 90 01 01 3a 5c 61 75 74 6f 72 75 6e 2e 69 6e 66 90 00 } //1
