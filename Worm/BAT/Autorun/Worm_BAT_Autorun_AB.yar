...
rule Worm_BAT_Autorun_AB{
	...
	strings :
		$a_02_0 = {43 6f 70 79 20 2f 59 20 25 90 02 50 5c 73 79 73 74 65 6d 33 32 5c 90 02 30 2e 65 78 65 90 00 } //1
		...
		$a_02_3 = {43 6f 70 79 20 2f 59 20 25 6e 61 6d 25 90 02 30 5b 25 52 41 4e 44 4f 4d 25 5d 90 02 30 2d 50 69 63 74 75 72 65 2e 65 78 65 90 00 } //1
