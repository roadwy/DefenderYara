...
rule Worm_BAT_Mofin_A{
	...
	strings :
		...
		$a_01_1 = {74 61 72 5f 73 65 6e 64 5f 66 69 6c 73 00 } //01 00 
		$a_01_2 = {5c 00 77 00 73 00 79 00 73 00 74 00 65 00 6d 00 2e 00 76 00 78 00 } //01 00 
		$a_01_3 = {5c 00 73 00 75 00 63 00 68 00 6f 00 73 00 74 00 2e 00 2e 00 65 00 78 00 65 00 } //01 00 
		$a_01_4 = {5c 00 73 00 76 00 63 00 68 00 6f 00 73 00 74 00 2e 00 2e 00 65 00 78 00 65 00 } //01 00 
