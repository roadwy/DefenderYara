...
rule Program_Win32_CompromisedCert_A{
	...
	strings :
		$a_03_0 = {5c 53 75 70 65 72 66 69 73 68 5c 57 46 50 5c 44 72 69 76 65 72 5c 57 69 6e 38 52 65 6c 65 61 73 65 5c 78 90 01 02 5c 56 44 57 46 50 90 02 02 2e 70 64 62 90 00 } //1
