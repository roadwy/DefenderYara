...
rule VirTool_Win32_CobaltStrike_STC{
	meta:
		description = "VirTool:Win32/CobaltStrike.STC,SIGNATURE_TYPE_PEHSTR_EXT,03 00 03 00 04 00 00 01 00 "
	...
	strings :
		...
		$a_03_3 = {68 6e 65 74 00 68 77 69 6e 69 90 01 01 68 4c 77 26 07 ff 90 00 } //00 00 
		$a_00_4 = {5d 04 } //00 00 
	condition:
		any of ($a_*)
