...
rule VirTool_Win32_CobaltStrike_H{
	meta:
		description = "VirTool:Win32/CobaltStrike.H,SIGNATURE_TYPE_PEHSTR_EXT,03 00 03 00 03 00 00 01 00 "
...
rule VirTool_Win32_CobaltStrike_H_2{
	meta:
		description = "VirTool:Win32/CobaltStrike.H,SIGNATURE_TYPE_PEHSTR_EXT,04 00 04 00 04 00 00 01 00 "
