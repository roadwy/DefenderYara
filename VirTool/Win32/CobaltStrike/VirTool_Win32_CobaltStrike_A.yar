...
rule VirTool_Win32_CobaltStrike_A{
	...
	strings :
		$a_03_0 = {e8 00 00 00 00 5b 52 45 55 89 e5 81 c3 ?? ?? ?? ?? ff d3 89 c3 57 68 04 00 00 00 50 ff d0 68 f0 b5 a2 56 68 05 00 00 00 50 ff d3 } //1
...
rule VirTool_Win32_CobaltStrike_A_2{
	...
	strings :
		$a_03_0 = {3d 00 10 00 00 90 0a 0d 00 80 b0 ?? ?? ?? ?? 2e 40 } //5
		$a_01_1 = {89 10 89 50 04 89 48 08 89 48 0c c3 } //1
		$a_03_2 = {83 7e 08 04 73 03 33 c0 c3 8b 46 04 ff 30 e8 ?? ?? ?? ?? 83 46 04 04 83 46 08 fc c3 } //1
		$a_03_3 = {83 7e 08 02 73 03 33 c0 c3 8b 46 04 0f b7 00 50 e8 ?? ?? ?? ?? 83 46 04 02 83 46 08 fe 0f b7 c0 c3 } //1
