...
rule VirTool_Win32_SuspRemoteCmdCommand_C{
	...
	strings :
		...
		$a_02_2 = {3e 00 20 00 5c 00 5c 00 90 29 03 00 2e 00 90 29 03 00 2e 00 90 29 03 00 2e 00 90 29 03 00 5c 00 90 02 20 5c 00 90 02 20 2e 00 74 00 6d 00 70 00 90 00 } //1
