...
rule VirTool_Win32_CeeInject_QJ_bit{
	...
	strings :
		$a_03_0 = {8d 45 e4 0f 43 45 e4 c6 40 90 01 02 50 90 90 90 90 90 90 90 90 90 90 90 90 90 90 90 90 90 90 90 90 90 90 90 90 58 90 00 } //2
		$a_03_1 = {89 37 8b 06 8b 40 90 01 01 8b 4c 30 90 01 01 85 c9 74 05 8b 01 ff 50 04 90 00 } //1
