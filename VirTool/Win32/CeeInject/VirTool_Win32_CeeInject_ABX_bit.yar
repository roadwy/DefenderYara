...
rule VirTool_Win32_CeeInject_ABX_bit{
	...
	strings :
		$a_03_0 = {8b c1 83 e0 03 0f b6 44 04 90 01 01 30 81 90 01 04 8d 82 90 01 04 03 c1 83 e0 03 0f b6 44 04 90 01 01 30 81 90 01 04 8d 86 90 01 04 03 c1 83 e0 03 0f b6 44 04 90 01 01 30 81 90 01 04 8d 87 90 01 04 03 c1 83 e0 03 0f b6 44 04 90 01 01 30 81 90 00 } //2
		$a_03_1 = {33 c9 81 ea 90 01 04 81 ee 90 01 04 81 ef 90 00 } //2
