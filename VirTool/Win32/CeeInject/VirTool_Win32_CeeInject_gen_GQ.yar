...
rule VirTool_Win32_CeeInject_gen_GQ{
	...
	strings :
		...
		$a_03_1 = {81 cb 00 ff ff ff 43 8a 9c 9d 90 01 02 ff ff 8b 7d 90 01 01 30 1c 02 42 3b d7 72 90 00 } //1
		$a_01_2 = {c6 00 e9 8b 16 42 8b c2 89 16 2b d8 8d 54 3b fc } //1
		$a_03_3 = {66 8b 41 06 83 c3 28 3b f8 7c af 90 18 a1 90 01 04 6a 00 8b 50 3c 03 d3 8d 84 32 f8 00 00 00 90 00 } //1
	condition:
