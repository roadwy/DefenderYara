...
rule VirTool_Win32_CeeInject_ML_bit{
	...
	strings :
		$a_03_0 = {8d 0c b6 b8 ?? ?? ?? ?? c1 e1 ?? 2b ce c1 e1 ?? f7 e9 c1 fa ?? 8b c2 c1 e8 ?? 03 d0 8b fa 8d 14 f6 8d 04 d6 8a 4c 3c ?? c1 e0 ?? 03 c6 80 f1 ?? 8d 34 c0 b8 ?? ?? ?? ?? f7 ee c1 fa ?? 8b c2 c1 e8 ?? 03 d0 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule VirTool_Win32_CeeInject_ML_bit_2{
	...
	strings :
		...
		$a_03_1 = {8b 4d 98 83 c1 01 89 4d 98 81 7d 98 ?? ?? ?? ?? 7d 5e 8d 55 a0 52 ff 15 ?? ?? ?? ?? 8b 45 b0 03 45 98 33 c9 8a 08 89 4d e0 } //1
