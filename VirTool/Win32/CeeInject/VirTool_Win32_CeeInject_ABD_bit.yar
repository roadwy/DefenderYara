...
rule VirTool_Win32_CeeInject_ABD_bit{
	...
	strings :
		...
		$a_03_1 = {8b 55 08 8b 02 8b 4d 90 01 01 8a 54 01 03 88 55 90 01 01 0f b6 45 90 01 01 0f b6 4d 90 01 01 c1 e1 02 81 e1 c0 00 00 00 0b c1 88 45 90 01 01 0f b6 55 90 01 01 0f b6 45 90 01 01 c1 e0 04 90 00 } //1
