...
rule VirTool_Win32_CeeInject_BY{
	...
	strings :
		$a_03_0 = {8b 48 3c 8b 55 fc 0f b7 04 0a 3d 50 45 00 00 90 0a 2f 00 83 e9 02 8b 95 ?? fe ff ff 39 4a 3c } //2
		$a_03_1 = {4c 64 72 50 72 6f 63 00 90 09 39 00 6c 64 72 2e 65 78 65 00 } //2
