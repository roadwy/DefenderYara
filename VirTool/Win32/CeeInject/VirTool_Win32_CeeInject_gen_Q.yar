...
rule VirTool_Win32_CeeInject_gen_Q{
	...
	strings :
		...
		$a_03_4 = {ff 70 50 ff 70 34 ff 75 90 01 01 ff 15 90 00 } //3
		$a_01_5 = {81 38 50 45 00 00 0f 85 } //1
		$a_03_6 = {99 f7 f9 8b 4d 90 01 01 8a 84 15 90 01 02 ff ff 32 04 31 47 3b 7d 90 01 01 88 06 7c 90 00 } //2
		$a_03_7 = {83 45 08 28 0f b7 41 06 39 45 90 01 01 7c 90 00 } //2
	condition:
