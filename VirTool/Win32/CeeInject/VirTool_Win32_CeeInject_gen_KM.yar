...
rule VirTool_Win32_CeeInject_gen_KM{
	meta:
		description = "VirTool:Win32/CeeInject.gen!KM,SIGNATURE_TYPE_PEHSTR_EXT,01 00 01 00 02 00 00 01 00 "
		
	strings :
		$a_03_0 = {83 c4 08 83 bd 90 01 02 ff ff 32 7c 90 01 01 8b 85 90 01 02 ff ff 83 c0 01 89 85 90 1b 02 ff ff 8b 8d 90 1b 02 ff ff 83 c1 01 83 f1 90 01 01 88 8d 90 01 02 ff ff 8b 95 90 1b 02 ff ff 0f be 84 15 90 01 02 ff ff 0f be 8d 90 01 02 ff ff 03 c1 88 85 90 01 02 ff ff 90 00 } //01 00 
