...
rule VirTool_Win32_CeeInject_gen_LF{
	...
	strings :
		...
		$a_03_2 = {8b f4 8b 95 a8 fb ff ff 52 8b 85 f4 fb ff ff 50 ff 95 44 fb ff ff 3b f4 e8 90 01 04 c7 85 40 fb ff ff f7 2d 00 00 8d 8d 40 fb ff ff 89 8d 3c fb ff ff c7 85 38 fb ff ff 00 00 00 00 c7 85 34 fb ff ff 1c 02 00 00 c7 85 34 fb ff ff 8d 07 00 00 eb 90 00 } //1
	condition:
