...
rule VirTool_Win32_CeeInject_M{
	...
	strings :
		...
		$a_01_3 = {2e 53 74 6f 6e 65 } //01 00 
	condition:
		any of ($a_*)
...
rule VirTool_Win32_CeeInject_M_3{
	...
	strings :
		...
		$a_01_2 = {4e 65 77 20 45 58 45 20 69 6d 61 67 65 20 69 6e 6a 65 63 74 65 64 20 69 6e 74 6f 20 70 72 6f 63 65 73 73 2e } //01 00 
		$a_01_3 = {41 6c 6c 6f 63 61 74 65 64 20 4d 65 6d 20 66 6f 72 20 4e 65 77 20 45 58 45 20 61 74 20 25 58 2e 20 45 58 45 20 77 69 6c 6c 20 62 65 20 72 65 6c 6f 63 61 74 65 64 2e } //01 00 
...
rule VirTool_Win32_CeeInject_M_4{
	...
	strings :
		$a_01_0 = {41 00 41 00 56 00 5f 00 55 00 6e 00 70 00 61 00 63 00 6b 00 5f 00 64 00 6c 00 6c 00 5f 00 4d 00 75 00 74 00 65 00 78 00 } //01 00 
		$a_01_1 = {50 00 61 00 74 00 68 00 5b 00 20 00 43 00 3a 00 5c 00 54 00 45 00 4d 00 50 00 5c 00 4c 00 52 00 49 00 5f 00 76 00 30 00 2e 00 30 00 2e 00 31 00 2e 00 39 00 5c 00 6c 00 72 00 69 00 2e 00 64 00 6c 00 6c 00 5d 00 } //01 00 
		$a_01_2 = {46 00 61 00 69 00 6c 00 20 00 74 00 6f 00 20 00 67 00 65 00 6e 00 65 00 72 00 61 00 74 00 65 00 20 00 6c 00 72 00 69 00 2e 00 64 00 6c 00 6c 00 2e 00 } //01 00 
		$a_01_3 = {50 00 72 00 6f 00 64 00 75 00 63 00 74 00 69 00 6e 00 66 00 6f 00 7c 00 46 00 61 00 69 00 6c 00 20 00 44 00 65 00 63 00 72 00 79 00 70 00 74 00 20 00 41 00 41 00 56 00 20 00 70 00 72 00 6f 00 74 00 65 00 63 00 74 00 65 00 64 00 20 00 43 00 6f 00 64 00 65 00 21 00 } //00 00 
	condition:
		any of ($a_*)
...
rule VirTool_Win32_CeeInject_M_5{
	...
	strings :
		...
		$a_01_2 = {2e 73 6d 69 6c 65 79 } //02 00 
		$a_01_3 = {54 68 69 73 20 44 6c 6c 20 61 6c 67 6f 72 69 74 68 6d 20 69 73 6e 27 74 20 73 61 6d 65 20 2e } //02 00 
		$a_01_4 = {43 3a 5c 4c 52 49 4c 6f 67 2e 74 78 74 } //02 00 
		$a_01_5 = {54 68 69 73 20 44 6c 6c 20 68 61 76 65 20 6e 6f 74 20 65 6e 63 72 79 70 74 65 64 2e 20 49 74 20 72 75 6e 73 20 69 6e 20 6e 6f 6e 2d 70 72 6f 74 65 63 74 69 6f 6e 20 6d 6f 64 65 2e } //02 00 
		$a_01_6 = {4c 52 49 2e 64 6c 6c } //01 00 
	condition:
		any of ($a_*)
...
rule VirTool_Win32_CeeInject_M_6{
	...
	strings :
		...
		$a_01_3 = {5c 00 4c 00 52 00 49 00 2e 00 64 00 6c 00 6c 00 } //03 00 
		$a_01_4 = {4e 65 77 20 45 58 45 20 69 6d 61 67 65 20 69 6e 6a 65 63 74 65 64 20 69 6e 74 6f 20 70 72 6f 63 65 73 73 2e } //03 00 
		$a_01_5 = {52 79 61 6e 20 50 72 6f 6a 65 63 74 5c 41 6e 74 69 2d 41 6e 74 69 56 69 72 75 73 } //01 00 
		$a_01_6 = {41 6c 6c 6f 63 61 74 65 64 20 4d 65 6d 20 66 6f 72 20 4e 65 77 20 45 58 45 20 61 74 20 25 58 2e 20 45 58 45 20 77 69 6c 6c 20 62 65 20 72 65 6c 6f 63 61 74 65 64 2e } //01 00 
	condition:
		any of ($a_*)
...
rule VirTool_Win32_CeeInject_M_7{
	...
	strings :
		$a_01_0 = {5c 41 6e 74 69 41 6e 74 69 56 69 72 75 73 5f 63 6f 6d 6d 61 6e 64 } //01 00 
		$a_01_1 = {57 72 69 74 65 50 72 6f 63 65 73 73 4d 65 6d 6f 72 79 20 66 61 69 6c 65 64 } //01 00 
		$a_01_2 = {4e 65 77 20 45 58 45 20 69 6d 61 67 65 20 69 6e 6a 65 63 74 65 64 20 69 6e 74 6f 20 70 72 6f 63 65 73 73 2e } //00 00 
	condition:
		any of ($a_*)
