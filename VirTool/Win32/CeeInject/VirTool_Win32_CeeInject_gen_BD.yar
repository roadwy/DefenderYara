...
rule VirTool_Win32_CeeInject_gen_BD{
	...
	strings :
		$a_03_0 = {6a 10 8d 54 24 90 01 01 88 44 24 90 01 01 52 8d 44 24 90 01 01 50 c6 44 24 90 01 01 30 c6 44 24 90 01 01 78 88 4c 24 90 01 01 c6 44 24 90 01 01 00 e8 90 00 } //1
