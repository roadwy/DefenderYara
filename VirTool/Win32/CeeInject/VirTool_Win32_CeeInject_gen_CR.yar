...
rule VirTool_Win32_CeeInject_gen_CR{
	...
	strings :
		...
		$a_03_2 = {83 c6 02 83 f0 30 47 89 44 24 90 01 01 88 47 ff 3b f5 7c 9a 90 00 } //1
		$a_03_3 = {02 00 01 00 ff 15 90 01 04 85 c0 75 0b 90 01 0b 66 81 3b 4d 5a 90 00 } //1
	condition:
