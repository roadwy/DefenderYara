...
rule VirTool_Win32_CeeInject_gen_HW{
	...
	strings :
		$a_03_0 = {50 50 ff 75 08 68 6e 1c 04 45 e8 90 01 04 8b f0 e8 90 01 04 59 ff d0 5e 5d c3 90 00 } //1
		$a_03_1 = {68 12 ba 0c c3 e8 90 01 04 8b f0 e8 90 01 04 59 a3 90 01 04 5e ff 75 18 ff 75 14 ff 75 10 ff 75 0c ff 75 08 ff d0 90 00 } //1
