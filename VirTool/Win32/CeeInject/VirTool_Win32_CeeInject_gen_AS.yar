...
rule VirTool_Win32_CeeInject_gen_AS{
	...
	strings :
		$a_03_0 = {f7 f1 40 0f af c1 01 44 24 90 01 01 ff 44 24 90 01 01 0f b7 90 01 01 06 83 44 24 90 01 01 28 39 44 24 90 01 01 0f 8c 90 00 } //2
		...
		$a_03_5 = {6a 40 68 00 30 00 00 90 02 0a ff 90 01 01 50 ff 90 01 01 34 ff 74 24 90 01 01 ff 15 90 00 } //2
	condition:
