...
rule VirTool_Win32_CeeInject_DC{
	...
	strings :
		$a_00_0 = {76 6d 77 61 72 65 } //01 00  vmware
		$a_00_1 = {4f 4c 4c 59 44 42 47 } //01 00  OLLYDBG
		...
		$a_01_5 = {50 52 4f 43 4d 4f 4e 5f 57 49 4e 44 4f 57 5f 43 4c 41 53 53 } //00 00  PROCMON_WINDOW_CLASS
	condition:
		any of ($a_*)
