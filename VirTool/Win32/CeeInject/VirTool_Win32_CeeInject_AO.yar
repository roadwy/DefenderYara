...
rule VirTool_Win32_CeeInject_AO{
	...
	strings :
		$a_03_0 = {0f b6 44 31 04 83 c0 90 01 01 88 44 17 fb 83 c1 05 3b 8d 9c fd ff ff 76 b6 90 00 } //1
		$a_03_1 = {52 6a 24 52 52 52 50 52 ff 15 90 01 04 8b 45 cc ff 74 38 34 ff 35 90 01 04 ff 15 90 00 } //1
