...
rule VirTool_Win32_CeeInject_gen_EI{
	...
	strings :
		...
		$a_03_1 = {c7 44 24 04 00 00 00 00 c7 04 24 01 00 1f 00 e8 ?? ?? ?? ?? 83 ec 0c 85 c0 74 0c 31 c0 8d 65 f4 5b 5e 5f c9 c2 10 00 c7 44 24 08 ?? ?? ?? ?? c7 44 24 04 00 00 00 00 c7 04 24 00 00 00 00 e8 ?? ?? ?? ?? 83 ec 0c c7 44 24 08 04 01 00 00 } //1
	condition:
