...
rule VirTool_Win32_CeeInject_NK_bit{
	meta:
		description = "VirTool:Win32/CeeInject.NK!bit,SIGNATURE_TYPE_PEHSTR_EXT,02 00 02 00 02 00 00 01 00 "
...
rule VirTool_Win32_CeeInject_NK_bit_2{
	meta:
		description = "VirTool:Win32/CeeInject.NK!bit,SIGNATURE_TYPE_PEHSTR_EXT,03 00 03 00 03 00 00 01 00 "
