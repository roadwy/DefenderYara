...
rule VirTool_Win32_CeeInject_gen_EG{
	...
	strings :
		...
		$a_03_1 = {89 45 f8 8b 4d f4 51 8b 55 0c 52 ff 55 f8 6a 40 68 00 30 00 00 8b 45 fc 8b 48 50 51 8b 55 f4 52 8b 45 0c 50 ff 15 ?? ?? ?? ?? 6a 00 8b 4d fc 8b 51 54 52 8b 45 08 50 8b 4d f4 51 8b 55 0c 52 ff 15 } //1
	condition:
