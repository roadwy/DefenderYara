...
rule VirTool_Win32_CeeInject_AAG_bit{
	...
	strings :
		...
		$a_03_1 = {8b cf 56 e8 90 01 04 8b 54 24 90 01 01 2b d8 56 ff 74 24 90 01 01 8b cb e8 90 01 04 2b f8 b9 01 00 00 00 8b 44 24 90 01 01 83 c4 10 2b c8 03 f1 90 00 } //1
	condition:
