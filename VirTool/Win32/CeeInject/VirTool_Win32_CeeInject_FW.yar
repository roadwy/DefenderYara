...
rule VirTool_Win32_CeeInject_FW{
	...
	strings :
		...
		$a_03_2 = {8a 00 31 d0 88 01 83 45 ?? 02 83 55 ?? 00 8b 85 ?? ?? ?? ?? 8b 55 ?? 89 d3 31 c3 8b 85 ?? ?? ?? ?? 8b 55 ?? 89 d6 31 c6 89 d8 09 f0 85 c0 0f 95 c0 84 c0 } //1
		$a_03_3 = {89 c7 81 e7 ff 03 00 00 0f b6 bc 3d ?? ?? ?? ?? 89 fb 30 19 83 c0 02 83 d2 00 83 c1 02 } //1
	condition:
