...
rule VirTool_Win32_CeeInject_gen_ET{
	...
	strings :
		$a_03_0 = {56 8b cf 80 f3 ?? e8 ?? ?? ?? ?? 46 88 18 83 fe 14 72 e7 } //1
		$a_01_1 = {f7 b5 a4 00 00 00 8b 45 84 0f b6 04 02 0f b6 55 8b 03 c3 03 d0 23 d1 8b da } //1
		$a_01_2 = {40 3d 00 01 00 00 72 f2 33 c9 be ff 00 00 00 33 d2 8b c1 f7 75 14 } //1
		$a_03_3 = {8b 77 3c 68 4d 5a 00 00 50 c7 ?? ?? 07 00 01 00 03 f7 e8 } //1
