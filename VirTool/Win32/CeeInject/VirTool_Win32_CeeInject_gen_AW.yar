...
rule VirTool_Win32_CeeInject_gen_AW{
	...
	strings :
		$a_03_0 = {8a 14 08 8b c6 32 d3 83 e0 90 01 01 b9 08 00 00 00 8a da 2b c8 d2 e3 8a c8 d2 ea 0a da 88 1c 3e 46 3b f5 72 d1 90 00 } //2
		$a_03_1 = {8b 48 34 03 48 28 8d 85 90 01 02 ff ff 90 00 } //1
