...
rule VirTool_Win32_CeeInject_RT_bit{
	...
	strings :
		$a_03_0 = {30 01 69 c0 90 01 04 ff 4d 0c 05 90 01 04 41 83 7d 0c 00 77 e9 90 00 } //1
		$a_03_1 = {8b 54 24 04 33 c0 eb 90 01 01 0f be c9 c1 c0 07 33 c1 42 8a 0a 84 c9 90 00 } //1
		$a_03_2 = {88 45 08 8a 45 fe 8a c8 c0 f9 90 01 01 c0 e0 90 01 01 02 45 ff 80 e1 90 01 01 c0 e2 90 01 01 32 ca 90 00 } //1
	condition:
...
rule VirTool_Win32_CeeInject_RT_bit_2{
	...
	strings :
		...
		$a_03_3 = {50 c7 45 e4 90 01 04 c7 45 e8 90 01 04 ff 56 48 89 45 fc 90 00 } //1
		$a_03_4 = {8b c1 33 d2 52 50 8b 06 99 03 04 24 13 54 24 04 83 c4 08 c6 90 01 02 ff 06 81 3e 90 01 04 75 90 00 } //5
	condition:
