...
rule VirTool_Win32_CeeInject_FN{
	...
	strings :
		$a_03_0 = {99 b9 ff 00 00 00 f7 f9 89 74 24 90 01 01 42 3b de 76 90 01 01 8b 44 24 90 01 01 8a 0c 38 80 e9 90 01 01 32 ca ff 44 24 90 01 01 88 0c 38 39 5c 24 90 01 01 72 90 00 } //1
