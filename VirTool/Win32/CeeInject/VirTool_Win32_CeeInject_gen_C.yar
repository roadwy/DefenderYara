...
rule VirTool_Win32_CeeInject_gen_C{
	...
	strings :
		...
		$a_03_1 = {83 c4 0c 50 6a 09 68 90 01 04 68 90 01 04 e8 90 01 04 83 c4 0c 50 ff d7 50 ff d5 8b 4c 24 2c 8b 54 24 28 51 8b 4c 24 24 52 51 53 56 6a 02 a3 90 00 } //1
	condition:
