...
rule VirTool_Win32_CeeInject_TY_bit{
	...
	strings :
		...
		$a_03_2 = {0f af c6 03 c0 03 c0 03 c0 bb 90 01 04 6a 01 2b d8 90 00 } //1
	condition:
...
rule VirTool_Win32_CeeInject_TY_bit_2{
	...
	strings :
		$a_03_0 = {25 ff 00 00 80 79 07 48 0d 00 ff ff ff 40 8b 4d 18 03 4d f0 0f b6 09 33 8c 85 90 01 03 ff 8b 45 18 03 45 f0 88 08 90 00 } //2
		$a_03_1 = {8b 4d 08 03 48 10 89 4d 90 01 01 e8 90 01 03 00 6a 00 ff 75 0c ff 75 08 ff 55 90 01 01 89 45 90 01 01 e8 90 01 03 00 90 00 } //1
	condition:
