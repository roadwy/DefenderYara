...
rule VirTool_Win32_CeeInject_TS_bit{
	meta:
		description = "VirTool:Win32/CeeInject.TS!bit,SIGNATURE_TYPE_PEHSTR_EXT,02 00 02 00 02 00 00 01 00 "
...
rule VirTool_Win32_CeeInject_TS_bit_2{
	meta:
		description = "VirTool:Win32/CeeInject.TS!bit,SIGNATURE_TYPE_PEHSTR_EXT,03 00 03 00 03 00 00 01 00 "
		
	strings :
		$a_03_0 = {33 c0 89 45 90 01 01 99 f7 7d 90 01 01 8b 45 90 01 01 8a 8a 90 01 04 8b 55 90 01 01 c0 e1 03 32 c8 88 0c 02 40 3b c7 89 45 90 00 } //01 00 
		$a_03_1 = {8b c7 99 f7 7d 90 01 01 8b 45 90 01 01 8a 04 02 30 04 3e 47 3b 7d 90 01 01 7c eb 90 00 } //01 00 
		$a_03_2 = {8b c1 99 bf 90 01 02 00 00 f7 ff 8b 45 90 01 01 8a 04 02 30 04 31 41 81 f9 1d 02 00 00 7c e4 90 00 } //00 00 
	condition:
		any of ($a_*)
...
rule VirTool_Win32_CeeInject_TS_bit_3{
	meta:
		description = "VirTool:Win32/CeeInject.TS!bit,SIGNATURE_TYPE_PEHSTR_EXT,04 00 04 00 03 00 00 02 00 "
