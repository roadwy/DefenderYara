...
rule VirTool_Win32_CeeInject_BDJ_bit{
	...
	strings :
		$a_03_0 = {ff 4c c6 85 90 01 03 ff 6f c6 85 90 01 03 ff 63 c6 85 90 01 03 ff 6c c6 85 90 01 03 ff 6c c6 85 90 01 03 ff 61 c6 85 90 01 03 ff 41 c6 85 90 01 03 ff 6f c6 85 90 01 03 ff 63 90 00 } //1
