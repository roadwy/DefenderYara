...
rule VirTool_Win32_CeeInject_UF_bit{
	...
	strings :
		...
		$a_03_2 = {8b 06 03 85 90 01 04 53 ff 76 fc 50 8b 46 f8 03 85 90 01 04 50 ff b5 90 01 04 ff 15 90 01 04 0f b7 47 06 ff 85 90 01 04 83 c6 28 39 85 90 01 04 7c c8 90 00 } //1
	condition:
