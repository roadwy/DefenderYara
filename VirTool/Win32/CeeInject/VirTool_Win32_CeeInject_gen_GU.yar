...
rule VirTool_Win32_CeeInject_gen_GU{
	...
	strings :
		$a_03_0 = {07 00 01 00 90 09 07 00 c7 84 24 90 00 } //1
		$a_01_1 = {8b 16 8b 07 6a 40 68 00 30 00 00 51 52 50 ff 94 24 } //1
		$a_03_2 = {03 51 3c 89 55 90 01 01 8b 45 90 1b 00 0f b7 48 06 89 4d 90 01 01 8b 55 90 1b 00 81 c2 f8 00 00 00 90 00 } //1
