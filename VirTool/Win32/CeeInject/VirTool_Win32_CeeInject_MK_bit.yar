...
rule VirTool_Win32_CeeInject_MK_bit{
	...
	strings :
		...
		$a_03_1 = {8b 45 08 03 45 fc 0f b6 08 8b 15 90 01 04 81 c2 90 01 04 33 ca 8b 45 08 03 45 fc 88 08 eb 90 00 } //1
		$a_03_2 = {7d 1b 8b 55 90 01 01 03 55 90 01 01 0f b6 02 8b 4d 90 01 01 6b c9 90 01 01 33 c1 8b 55 90 01 01 03 55 90 01 01 88 02 eb 90 00 } //1
	condition:
