...
rule VirTool_Win32_CeeInject_UI_bit{
	...
	strings :
		...
		$a_03_1 = {75 b8 6a 00 68 90 01 04 89 55 90 01 01 89 4d 90 01 01 ff 15 90 01 04 50 ff 15 90 00 } //1
		$a_03_2 = {05 e0 33 00 00 50 56 ff 15 90 01 04 5f 8d 46 01 5e 90 00 } //1
	condition:
