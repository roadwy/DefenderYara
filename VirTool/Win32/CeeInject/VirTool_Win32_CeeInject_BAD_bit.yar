...
rule VirTool_Win32_CeeInject_BAD_bit{
	...
	strings :
		$a_03_0 = {55 8b ec 8b 45 08 c1 e0 04 03 45 0c 8b 4d 08 03 4d 10 33 c1 8b 90 01 01 08 c1 90 01 01 05 03 90 01 01 14 33 90 01 01 5d c3 90 00 } //1
		$a_03_1 = {55 8b ec 8b 45 08 c1 e0 04 03 45 0c 8b 4d 08 03 4d 14 33 c1 8b 90 01 01 08 c1 90 01 01 05 03 90 01 01 10 33 90 00 } //1
