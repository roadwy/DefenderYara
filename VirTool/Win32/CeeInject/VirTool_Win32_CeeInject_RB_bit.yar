...
rule VirTool_Win32_CeeInject_RB_bit{
	...
	strings :
		$a_03_0 = {8b c6 33 d2 b9 0f 00 00 00 f7 f1 8a 86 90 01 04 8a 92 90 01 04 32 c2 88 86 90 01 04 46 81 fe 90 01 04 72 90 00 } //1
		...
		$a_03_2 = {73 06 89 15 90 01 04 8b 35 90 01 04 8a 19 30 1c 30 47 41 40 4d 75 e1 90 00 } //1
	condition:
