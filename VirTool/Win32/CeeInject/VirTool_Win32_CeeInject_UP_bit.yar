...
rule VirTool_Win32_CeeInject_UP_bit{
	...
	strings :
		...
		$a_03_2 = {0f b7 02 8b e8 81 e5 90 01 04 81 fd 90 01 04 75 0d 8b 6c 24 18 25 90 01 04 03 c7 01 28 8b 46 04 83 e8 08 83 c1 01 d1 e8 83 c2 02 3b c8 72 ce 90 00 } //1
	condition:
