...
rule VirTool_Win32_Ceeinject_NY_bit{
	meta:
		description = "VirTool:Win32/Ceeinject.NY!bit,SIGNATURE_TYPE_PEHSTR_EXT,02 00 02 00 02 00 00 01 00 "
	...
	strings :
		...
		$a_03_1 = {8b c0 52 50 68 90 01 04 ff 35 90 01 04 ff 15 90 00 } //00 00 
	condition:
		any of ($a_*)
