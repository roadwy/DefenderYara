...
rule VirTool_Win32_CeeInject_gen_AO{
	...
	strings :
		...
		$a_03_2 = {e9 00 00 00 00 6a 0e 68 90 01 02 40 00 e8 90 01 04 59 a3 90 01 02 40 00 59 c3 e9 00 00 00 00 6a 14 68 90 01 02 40 00 e8 90 01 04 59 a3 90 01 02 40 00 59 c3 90 00 } //1
	condition:
