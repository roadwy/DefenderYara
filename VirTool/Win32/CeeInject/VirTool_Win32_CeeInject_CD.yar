...
rule VirTool_Win32_CeeInject_CD{
	...
	strings :
		$a_02_0 = {8b 4c 24 28 8b 54 24 14 2b cd c1 f9 02 3b d1 73 4c 8b 2b 8b 4c 24 44 8b 14 18 6a 0f 55 51 52 e8 ?? ?? ?? ?? 8b 7c 24 20 8b 54 24 20 8b f0 8b cd 8b c1 c1 e9 02 f3 a5 } //1
