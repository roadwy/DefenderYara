...
rule VirTool_Win32_CeeInject_gen_FQ{
	...
	strings :
		...
		$a_03_2 = {07 00 01 00 90 09 06 00 c7 05 90 00 } //1
	condition:
...
rule VirTool_Win32_CeeInject_gen_FQ_2{
	...
	strings :
		$a_03_0 = {6a 00 ff 55 90 01 01 85 c0 0f 84 90 01 04 50 6a 00 ff 55 90 01 01 85 c0 90 00 } //1
		$a_03_1 = {f7 c1 01 00 00 00 74 09 60 6a 90 01 01 e8 90 01 04 61 e2 90 01 01 ff 75 90 01 01 ff 75 90 01 01 b8 90 01 04 ff d0 90 00 } //1
	condition:
