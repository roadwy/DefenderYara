...
rule VirTool_Win32_CeeInject_gen_HG{
	...
	strings :
		$a_03_0 = {0f bf 5d 06 4b 3b 9c 24 90 01 04 0f 8c 90 01 04 68 28 00 00 00 8b 9c 24 90 01 04 8d 6c 24 90 01 01 8b 7d 3c 8b b4 24 90 01 04 6b f6 28 01 f7 81 c7 f8 00 00 00 90 00 } //2
		$a_03_1 = {8b 5d 34 03 5d 28 53 8d ac 24 90 01 04 58 89 85 b0 00 00 00 90 00 } //2
