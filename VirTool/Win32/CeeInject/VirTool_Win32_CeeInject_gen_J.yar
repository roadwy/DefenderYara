...
rule VirTool_Win32_CeeInject_gen_J{
	...
	strings :
		...
		$a_03_10 = {8a 10 32 91 90 01 04 8b 45 90 01 01 03 45 90 01 01 88 10 eb 90 00 } //10
		$a_01_11 = {81 e3 ff 00 00 80 79 08 4b 81 cb 00 ff ff ff 43 8a 5c 9c 14 30 1c 2a 42 3b d0 72 } //10
		$a_03_12 = {8b 45 08 03 85 90 01 02 ff ff 8a 10 32 94 8d 90 01 02 ff ff 8b 45 08 03 85 90 01 02 ff ff 88 10 e9 90 00 } //10
		$a_03_13 = {8a 04 1f 8a 54 94 90 01 01 32 c2 88 04 1f 8b 84 24 90 01 02 00 00 47 3b f8 72 90 00 } //10
		$a_03_14 = {99 f7 f9 8a 84 95 90 01 02 ff ff 30 07 ff 45 90 01 01 8b 45 90 01 01 3b 45 90 01 01 72 90 00 } //10
		$a_01_15 = {66 b9 ff ff eb 06 66 b8 00 4c cd 21 e2 f6 } //10
		$a_02_16 = {8a 14 31 8a 0c 07 32 ca 88 0c 07 ff d5 50 ff 15 90 01 04 a3 90 01 04 8b 44 24 20 47 3b f8 0f 8c 2f ff ff ff 90 00 } //10
		$a_01_17 = {6a 04 68 00 30 00 00 ff 73 50 ff 73 34 ff 75 e4 ff 15 } //100
		$a_03_18 = {6a 40 68 00 30 00 00 8b 48 50 8b 50 34 8b 44 24 90 01 01 51 52 50 ff 90 00 } //100
		$a_03_19 = {6a 40 68 00 30 00 00 90 03 02 01 8b 0d a1 90 01 04 8b 90 03 01 01 51 48 50 90 03 01 01 52 51 90 03 01 02 a1 8b 15 90 01 04 8b 90 03 01 01 48 42 34 90 03 01 01 51 50 8b 90 03 01 01 95 8d 90 01 02 ff ff 90 03 01 01 52 51 ff 90 00 } //100
		$a_03_20 = {8b 48 50 51 8b 15 90 01 04 8b 42 34 50 8b 4d 90 01 01 51 ff 15 90 00 } //100
		$a_01_21 = {6a 40 68 00 30 00 00 8b 50 50 8b 40 34 52 50 51 ff } //100
		$a_03_22 = {6a 40 68 00 30 00 00 a1 90 01 04 8b 4c 24 90 01 01 8b 50 50 8b 40 34 52 50 51 ff 90 00 } //100
		$a_03_23 = {6a 40 68 00 30 00 00 8b 0d 90 01 04 8b 51 50 52 a1 90 01 04 8b 48 34 51 8b 55 90 01 01 52 ff 90 00 } //100
		$a_03_24 = {8b 50 50 8b 40 34 8b 4c 24 90 01 01 6a 40 68 00 30 00 00 52 50 51 ff 90 00 } //100
		$a_02_25 = {6a 40 c1 e9 1f 03 d1 8b 4c 24 90 01 01 89 15 90 01 04 8b 50 50 8b 40 34 68 00 30 00 00 52 50 51 ff 15 90 00 } //100
	condition:
