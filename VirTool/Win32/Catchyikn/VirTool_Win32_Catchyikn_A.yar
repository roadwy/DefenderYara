...
rule VirTool_Win32_Catchyikn_A{
	...
	strings :
		...
		$a_01_1 = {65 6f 6c 3d 50 20 74 6f 6b 65 6e 73 3d 31 20 64 65 6c 69 6d 73 3d 20 22 20 25 25 69 20 69 6e 20 28 73 31 2e 74 78 74 29 } //01 00  eol=P tokens=1 delims= " %%i in (s1.txt)
		$a_01_2 = {5b 32 30 30 38 20 56 69 70 20 31 2e 30 5d } //00 00  [2008 Vip 1.0]
	condition:
		any of ($a_*)
