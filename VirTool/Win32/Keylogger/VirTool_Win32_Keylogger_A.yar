...
rule VirTool_Win32_Keylogger_A{
	...
	strings :
		...
		$a_03_1 = {83 f8 64 7f 5d 0f 84 ?? 00 00 00 83 f8 2e 7f 3b 0f 84 ?? ?? 00 00 83 f8 0d 7f 19 0f 84 ?? ?? 00 00 83 e8 09 0f 84 ?? ?? 00 00 83 e8 03 } //1
		$a_03_2 = {83 c0 9b 83 f8 09 0f 87 ?? ?? 00 00 ff 24 85 } //1
	condition:
