...
rule VirTool_Win32_Sliver_E_MTB{
	...
	strings :
		...
		$a_81_5 = {4d 69 67 72 61 74 65 29 2e } //1 Migrate).
		$a_81_6 = {49 6e 76 6f 6b 65 47 65 74 53 79 73 74 65 6d 52 65 71 29 2e } //1 InvokeGetSystemReq).
		$a_81_7 = {49 6e 76 6f 6b 65 53 70 61 77 6e 44 6c 6c 52 65 71 29 2e } //1 InvokeSpawnDllReq).
		$a_81_8 = {53 69 64 65 6c 6f 61 64 52 65 71 29 2e } //1 SideloadReq).
	condition:
