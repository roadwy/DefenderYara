...
rule VirTool_Win32_Oitorn_A{
	...
	strings :
		...
		$a_03_1 = {7c c5 b9 06 00 00 00 be ?? ?? ?? ?? 8b fb b8 06 00 00 00 f3 a5 66 a5 8b 15 ?? ?? ?? ?? 89 14 2b 83 c5 04 48 75 f1 a1 ?? ?? ?? ?? be ?? ?? ?? ?? 89 04 2b 83 c5 04 8d 0c 2b 83 c5 04 c7 01 48 48 48 48 } //1
	condition:
