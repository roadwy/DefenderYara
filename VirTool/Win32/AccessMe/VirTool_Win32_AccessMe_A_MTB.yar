...
rule VirTool_Win32_AccessMe_A_MTB{
	...
	strings :
		$a_02_0 = {ff d0 89 45 ?? c7 04 24 e8 03 00 00 a1 ?? ?? ?? 00 ff d0 83 ec 04 a1 ?? ?? ?? 00 ff d0 } //2
		$a_02_1 = {8d 70 01 89 34 24 e8 ?? ?? 00 00 89 43 fc 8b 4f fc 89 74 24 08 89 4c 24 04 89 04 24 e8 ?? ?? 00 00 39 7d 94 75 ca } //2
