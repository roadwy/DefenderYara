...
rule VirTool_Win32_Vetibuz_B_MTB{
	meta:
		description = "VirTool:Win32/Vetibuz.B!MTB,SIGNATURE_TYPE_PEHSTR_EXT,03 00 03 00 03 00 00 01 00 "
	...
	strings :
		...
		$a_02_2 = {61 70 69 2e 90 02 05 67 69 74 68 90 02 03 75 62 90 00 } //00 00 
	condition:
		any of ($a_*)
