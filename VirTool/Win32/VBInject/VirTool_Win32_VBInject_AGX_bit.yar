...
rule VirTool_Win32_VBInject_AGX_bit{
	...
	strings :
		$a_03_0 = {68 16 dc 2d 00 90 02 20 58 90 02 20 05 40 24 14 00 90 02 20 39 41 04 90 02 20 68 8d a3 3d 00 90 02 20 58 90 02 20 05 c0 5c 15 00 90 02 20 39 01 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule VirTool_Win32_VBInject_AGX_bit_2{
	...
	strings :
		...
		$a_03_1 = {ff 34 0e 81 34 24 90 01 04 83 e9 04 7d f1 ff e4 90 00 } //1
	condition:
