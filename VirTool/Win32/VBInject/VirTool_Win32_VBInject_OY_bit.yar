...
rule VirTool_Win32_VBInject_OY_bit{
	...
	strings :
		$a_03_0 = {6a 00 6a 00 6a 00 c6 04 24 48 c6 44 24 90 01 01 65 c6 44 24 90 01 01 61 c6 44 24 90 01 01 70 c6 44 24 90 01 01 43 c6 44 24 90 01 01 72 c6 44 24 90 01 01 65 c6 44 24 90 01 01 61 c6 44 24 90 01 01 74 c6 44 24 90 01 01 65 89 e2 e8 90 01 03 00 6a 00 6a 00 68 00 00 05 00 ff d0 90 00 } //1
