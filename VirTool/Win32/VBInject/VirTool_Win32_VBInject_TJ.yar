...
rule VirTool_Win32_VBInject_TJ{
	...
	strings :
		...
		$a_00_1 = {5c 00 73 00 44 00 65 00 6d 00 2e 00 76 00 62 00 70 00 } //01 00  \sDem.vbp
		$a_00_2 = {53 00 61 00 62 00 61 00 64 00 6f 00 53 00 61 00 62 00 61 00 64 00 6f 00 } //01 00  SabadoSabado
