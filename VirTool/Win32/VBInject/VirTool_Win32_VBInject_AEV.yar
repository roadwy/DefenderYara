...
rule VirTool_Win32_VBInject_AEV_2{
	...
	strings :
		...
		$a_03_1 = {64 a1 30 00 8b ?? ?? c7 ?? ?? 00 00 8b 40 8b ?? ?? c7 ?? ?? 10 8b 70 3c 8b ?? ?? c7 ?? ?? 0f b7 48 38 8b ?? ?? c7 ?? ?? 8b 7c 24 04 8b ?? ?? c7 ?? ?? 51 fc f3 a4 8b ?? ?? c7 ?? ?? 59 8b 74 24 8b ?? ?? c7 ?? ?? 04 89 4e fc 8b ?? ?? c7 ?? ?? c3 00 00 00 } //1
	condition:
