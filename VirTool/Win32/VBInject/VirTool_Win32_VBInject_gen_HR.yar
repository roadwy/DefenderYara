...
rule VirTool_Win32_VBInject_gen_HR{
	...
	strings :
		...
		$a_00_1 = {26 00 48 00 35 00 41 00 34 00 44 00 } //01 00 
		$a_00_2 = {26 00 48 00 33 00 43 00 } //01 00 
		$a_00_3 = {26 00 48 00 34 00 35 00 35 00 30 00 } //01 00 
		$a_00_4 = {26 00 48 00 46 00 38 00 } //00 00 
	condition:
		any of ($a_*)
