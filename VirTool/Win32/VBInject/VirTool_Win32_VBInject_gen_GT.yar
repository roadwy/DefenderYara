...
rule VirTool_Win32_VBInject_gen_GT{
	...
	strings :
		...
		$a_01_1 = {43 3a 5c 50 72 6f 67 72 61 6d 20 46 69 6c 65 73 20 28 78 38 36 29 5c 4a 4f 4b 45 52 2d 56 41 49 4f 5c 4a 6f 6b 65 72 32 5c 56 42 36 2e 4f 4c 42 } //01 00 
