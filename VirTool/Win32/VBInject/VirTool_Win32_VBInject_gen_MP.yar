...
rule VirTool_Win32_VBInject_gen_MP{
	...
	strings :
		...
		$a_03_1 = {0b c0 74 02 ff e0 68 90 01 02 40 00 b8 90 01 02 40 00 ff d0 ff e0 90 00 } //1
		$a_03_2 = {43 61 6c 6c 57 69 6e 64 6f 77 50 72 6f 63 90 02 60 0b c0 74 02 ff e0 90 00 } //1
