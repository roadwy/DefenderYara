...
rule VirTool_Win32_VBInject_gen_BY{
	...
	strings :
		$a_03_0 = {b8 ff 00 00 00 3b f0 7f 2e 81 fe 00 01 00 00 72 06 ff 15 90 01 04 8b ce ff 15 90 01 04 8b 4f 90 01 01 66 89 04 71 b8 01 00 00 00 03 c6 0f 80 90 01 04 8b f0 eb c9 90 00 } //1
		$a_03_1 = {b8 ff 00 00 00 66 3b f0 7f 2a 0f bf fe 81 ff 00 01 00 00 72 06 ff 15 90 01 04 8b 55 d0 b8 01 00 00 00 66 03 c6 66 89 34 7a 0f 80 90 00 } //1
		$a_03_2 = {6a 01 51 56 c7 45 90 01 01 e8 00 00 00 e8 90 00 } //1
		$a_01_3 = {6a 04 51 56 c7 45 9c 58 59 59 59 e8 } //1
		$a_01_4 = {6a 01 50 0f 80 8b 00 00 00 56 c7 45 a0 c3 00 00 00 e8 } //1
		$a_03_5 = {8d 45 e0 50 e8 90 01 04 33 db 66 3d ff ff 8d 4d e4 0f 94 c3 51 f7 db e8 90 01 04 33 d2 66 3d ff ff 0f 94 c2 8d 45 e8 90 00 } //1
