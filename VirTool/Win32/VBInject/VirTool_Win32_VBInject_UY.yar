...
rule VirTool_Win32_VBInject_UY{
	...
	strings :
		...
		$a_01_2 = {26 00 48 00 36 00 38 00 } //01 00 
		$a_01_3 = {26 00 48 00 45 00 38 00 } //01 00 
		$a_01_4 = {26 00 48 00 43 00 33 00 } //01 00 
		$a_01_5 = {4e 00 74 00 55 00 6e 00 6d 00 61 00 70 00 56 00 69 00 65 00 77 00 4f 00 66 00 53 00 65 00 63 00 74 00 69 00 6f 00 6e 00 } //00 00 
	condition:
		any of ($a_*)
