...
rule VirTool_Win32_VBInject_AFD{
	...
	strings :
		$a_03_0 = {f8 fc 0c 00 c7 45 90 01 01 01 00 00 00 83 65 d4 00 eb 0f 8b 45 d4 03 45 90 01 01 0f 80 90 01 01 16 00 00 89 45 d4 8b 45 d4 3b 45 90 01 01 7f 69 90 09 03 00 c7 45 90 00 } //2
