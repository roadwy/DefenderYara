...
rule VirTool_Win32_VBInject_AEB{
	...
	strings :
		...
		$a_01_1 = {38 00 31 00 37 00 43 00 31 00 44 00 46 00 43 00 34 00 33 00 34 00 33 00 } //01 00  817C1DFC4343
		$a_01_2 = {38 00 31 00 46 00 39 00 38 00 35 00 43 00 30 00 38 00 35 00 43 00 30 00 } //01 00  81F985C085C0
		$a_01_3 = {34 00 30 00 33 00 31 00 43 00 31 00 } //01 00  4031C1
		$a_00_4 = {78 e6 } //00 00 
	condition:
		any of ($a_*)
...
rule VirTool_Win32_VBInject_AEB_2{
	...
	strings :
		$a_01_0 = {34 00 30 00 33 00 31 00 43 00 31 00 38 00 31 00 46 00 39 00 38 00 39 00 44 00 38 00 38 00 39 00 44 00 38 00 37 00 35 00 43 00 45 00 } //01 00  4031C181F989D889D875CE
		$a_01_1 = {34 00 33 00 34 00 33 00 38 00 33 00 43 00 33 00 30 00 32 00 38 00 31 00 37 00 43 00 31 00 44 00 46 00 43 00 34 00 45 00 34 00 45 00 } //01 00  434383C302817C1DFC4E4E
		$a_01_2 = {38 00 42 00 35 00 34 00 31 00 44 00 30 00 30 00 36 00 36 00 30 00 46 00 46 00 } //01 00  8B541D00660FF
...
rule VirTool_Win32_VBInject_AEB_3{
	...
	strings :
		...
		$a_01_2 = {34 00 30 00 33 00 31 00 43 00 31 00 } //01 00  4031C1
		$a_01_3 = {34 00 33 00 34 00 33 00 38 00 33 00 43 00 33 00 30 00 32 00 38 00 31 00 37 00 43 00 31 00 44 00 } //01 00  434383C302817C1D
		$a_01_4 = {38 00 42 00 35 00 34 00 31 00 44 00 30 00 30 00 } //01 00  8B541D00
		$a_00_5 = {80 10 } //00 00 
	condition:
		any of ($a_*)
