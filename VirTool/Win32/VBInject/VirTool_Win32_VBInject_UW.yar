...
rule VirTool_Win32_VBInject_UW{
	...
	strings :
		...
		$a_01_1 = {26 00 48 00 35 00 39 00 35 00 } //02 00 
		$a_01_2 = {26 00 48 00 36 00 38 00 } //02 00 
		$a_01_3 = {26 00 48 00 45 00 38 00 } //02 00 
		$a_01_4 = {26 00 48 00 43 00 33 00 } //01 00 
		$a_01_5 = {35 00 39 00 35 00 38 00 } //01 00 
