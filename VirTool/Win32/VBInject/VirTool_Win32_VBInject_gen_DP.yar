...
rule VirTool_Win32_VBInject_gen_DP{
	...
	strings :
		$a_03_0 = {66 c1 f8 0f 66 33 05 90 01 04 66 8b 4d 90 01 01 66 c1 f9 0f 66 33 4d 90 01 01 66 3b c1 7f 90 00 } //2
		$a_03_1 = {66 8b d7 66 c1 fa 0f 8b da 33 55 90 01 01 33 1d 90 01 04 66 3b da 7f 90 00 } //2
