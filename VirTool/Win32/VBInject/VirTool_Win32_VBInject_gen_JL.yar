...
rule VirTool_Win32_VBInject_gen_JL{
	...
	strings :
		...
		$a_00_2 = {64 6f 61 6e 64 77 69 61 64 6e 69 6f } //01 00 
		$a_00_3 = {41 43 54 49 56 45 53 4b 49 4e 4c 69 62 43 74 6c 2e 53 6b 69 6e } //01 00 
		$a_00_4 = {2e 00 76 00 62 00 70 00 } //00 00 
	condition:
		any of ($a_*)
