...
rule VirTool_Win32_VBInject_VM{
	...
	strings :
		...
		$a_00_2 = {5c 00 41 00 76 00 69 00 5c 00 52 00 6f 00 70 00 65 00 72 00 5c 00 6f 00 52 00 6f 00 5c 00 70 00 65 00 5c 00 72 00 6f 00 6e 00 65 00 5c 00 74 00 61 00 41 00 76 00 69 00 2e 00 6f 00 6e 00 65 00 74 00 2e 00 76 00 62 00 70 00 } //00 00  \Avi\Roper\oRo\pe\rone\taAvi.onet.vbp
	condition:
		any of ($a_*)
