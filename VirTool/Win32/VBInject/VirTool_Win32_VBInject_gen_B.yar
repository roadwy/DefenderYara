...
rule VirTool_Win32_VBInject_gen_B{
	...
	strings :
		...
		$a_03_6 = {f5 04 00 00 00 f5 00 30 00 00 6c 90 01 02 6c 90 01 02 6c 90 01 02 5e 90 01 04 71 90 01 02 3c 6c 90 01 02 71 90 01 02 6c 90 01 02 f5 00 00 00 00 c7 90 00 } //9
	condition:
