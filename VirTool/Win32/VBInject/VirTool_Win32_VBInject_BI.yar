...
rule VirTool_Win32_VBInject_BI{
	...
	strings :
		...
		$a_03_1 = {50 45 00 00 0f 85 ?? ?? 00 00 8b 45 10 6a 44 5b ff 30 89 9d 4c fd ff ff } //1
		$a_03_2 = {6a 33 f3 ab 59 8d bd ?? ?? ff ff f3 ab 6a 11 8d bd ?? ?? ff ff 59 33 f6 f3 ab 8d bd ?? ?? ff ff 6a 0c ab } //1
	condition:
