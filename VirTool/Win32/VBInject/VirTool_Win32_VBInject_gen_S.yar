...
rule VirTool_Win32_VBInject_gen_S{
	...
	strings :
		...
		$a_01_3 = {53 00 59 00 53 00 54 00 45 00 4d 00 5c 00 43 00 6f 00 6e 00 74 00 72 00 6f 00 6c 00 53 00 65 00 74 00 30 00 30 00 31 00 5c 00 53 00 65 00 72 00 76 00 69 00 63 00 65 00 73 00 5c 00 44 00 69 00 73 00 6b 00 5c 00 45 00 6e 00 75 00 6d 00 } //00 00  SYSTEM\ControlSet001\Services\Disk\Enum
	condition:
		any of ($a_*)
