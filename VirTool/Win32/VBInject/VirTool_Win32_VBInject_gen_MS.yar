...
rule VirTool_Win32_VBInject_gen_MS{
	...
	strings :
		...
		$a_00_1 = {56 00 69 00 78 00 20 00 50 00 4f 00 4c 00 45 00 4d 00 44 00 20 00 4b 00 49 00 5c 00 42 00 65 00 6e 00 69 00 78 00 76 00 69 00 78 00 2e 00 76 00 62 00 70 00 } //00 00 
	condition:
		any of ($a_*)
