...
rule VirTool_Win32_VBInject_gen_IF{
	...
	strings :
		...
		$a_03_2 = {00 30 f5 04 00 00 00 6c 90 01 02 52 28 90 01 02 40 00 f5 05 00 00 00 6c 90 09 03 00 28 90 00 } //5
		$a_03_3 = {f5 f8 00 00 00 aa f5 28 00 00 00 6c 90 01 02 b2 aa 90 00 } //5
