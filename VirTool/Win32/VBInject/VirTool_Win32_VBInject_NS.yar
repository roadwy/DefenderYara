...
rule VirTool_Win32_VBInject_NS{
	...
	strings :
		$a_03_0 = {c7 45 a4 56 00 00 00 c7 45 9c 02 00 00 00 8d 75 9c 6a 00 ff 75 ac e8 ?? ?? ?? ?? 8b c8 8b d6 e8 ?? ?? ?? ?? c7 45 94 57 00 00 00 c7 45 8c 02 00 00 00 8d 75 8c 6a 01 ff 75 ac e8 ?? ?? ?? ?? 8b c8 8b d6 e8 ?? ?? ?? ?? c7 45 84 8b 00 00 00 } //1
		$a_03_1 = {05 f8 00 00 00 0f 80 ?? ?? ?? ?? 8b [0-06] 6b c9 28 } //1
