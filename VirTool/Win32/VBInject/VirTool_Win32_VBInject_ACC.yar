...
rule VirTool_Win32_VBInject_ACC{
	...
	strings :
		...
		$a_00_3 = {42 00 72 00 6f 00 6b 00 65 00 6e 00 48 00 65 00 61 00 72 00 74 00 68 00 } //01 00  BrokenHearth
		$a_00_4 = {4d 00 6f 00 74 00 6f 00 77 00 6e 00 } //00 00  Motown
	condition:
		any of ($a_*)
