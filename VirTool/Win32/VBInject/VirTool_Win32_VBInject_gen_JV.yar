...
rule VirTool_Win32_VBInject_gen_JV{
	...
	strings :
		...
		$a_03_1 = {b9 d2 00 00 00 ff d6 8b 15 ?? ?? ?? ?? b9 c7 00 00 00 88 82 35 03 00 00 ff d6 8b 0d ?? ?? ?? ?? 88 81 36 03 00 00 b9 a7 00 00 00 ff d6 8b 15 ?? ?? ?? ?? b9 68 00 00 00 88 82 37 03 00 00 ff d6 } //1
	condition:
