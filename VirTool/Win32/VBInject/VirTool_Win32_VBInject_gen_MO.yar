...
rule VirTool_Win32_VBInject_gen_MO{
	...
	strings :
		...
		$a_01_6 = {4e 00 65 00 74 00 6c 00 75 00 78 00 20 00 53 00 79 00 73 00 74 00 65 00 6d 00 73 00 20 00 50 00 72 00 69 00 76 00 61 00 74 00 65 00 20 00 4c 00 69 00 6d 00 69 00 74 00 65 00 64 00 } //00 00  Netlux Systems Private Limited
		$a_00_7 = {80 10 } //00 00 
	condition:
		any of ($a_*)
