...
rule VirTool_Win32_VBInject_gen_DE{
	...
	strings :
		...
		$a_03_2 = {f5 40 00 00 00 f5 00 30 00 00 6c 90 01 02 6c 90 01 02 6c 90 01 02 0a 90 00 } //2
		$a_03_3 = {f5 07 00 01 00 71 90 01 02 f5 00 00 00 00 f5 00 00 00 00 04 90 01 02 fe 8e 01 00 00 00 10 00 80 08 90 00 } //2
	condition:
