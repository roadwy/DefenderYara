...
rule VirTool_Win32_VBInject_gen_IS{
	...
	strings :
		$a_03_0 = {66 0f b6 0c 08 8b 95 90 01 02 ff ff 8b 45 90 01 01 66 33 0c 50 90 00 } //2
		$a_03_1 = {8a 1c 10 03 cb 0f 80 90 01 04 81 e1 ff 00 00 80 79 08 49 81 c9 00 ff ff ff 41 89 4d 90 00 } //2
