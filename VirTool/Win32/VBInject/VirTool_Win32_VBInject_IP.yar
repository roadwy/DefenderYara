...
rule VirTool_Win32_VBInject_IP{
	...
	strings :
		$a_03_0 = {66 0f b6 08 8b 45 08 8b 80 90 01 02 00 00 8b 95 90 01 02 ff ff 66 8b 04 50 66 25 ff 00 66 33 c8 90 00 } //1
		$a_03_1 = {eb 04 83 65 90 01 01 00 8d 45 90 01 01 50 66 b9 c3 00 90 00 } //1
