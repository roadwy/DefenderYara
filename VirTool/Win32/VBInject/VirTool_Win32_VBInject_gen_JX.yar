...
rule VirTool_Win32_VBInject_gen_JX{
	...
	strings :
		$a_03_0 = {8b 45 08 03 45 90 01 01 0f 80 90 01 01 00 00 00 89 45 08 8b 45 08 3b 45 90 01 01 7f 90 01 01 c7 45 90 01 02 00 00 00 ff 75 90 01 01 ff 75 08 e8 90 01 03 ff 8b d0 90 00 } //1
