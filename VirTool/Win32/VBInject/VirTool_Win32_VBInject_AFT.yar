...
rule VirTool_Win32_VBInject_AFT{
	...
	strings :
		$a_03_0 = {6a 73 8d 55 90 01 01 52 ff 15 90 01 04 c7 85 90 01 08 c7 85 90 01 08 6a 6e 8d 85 90 01 02 ff ff 50 ff 15 90 01 04 6a 78 8d 8d 90 01 02 ff ff 51 ff 15 90 01 04 c7 85 90 01 08 c7 85 90 01 08 6a 68 8d 95 90 01 02 ff ff 52 ff 15 90 01 04 6a 6b 90 00 } //1
