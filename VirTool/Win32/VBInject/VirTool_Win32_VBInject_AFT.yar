...
rule VirTool_Win32_VBInject_AFT{
	...
	strings :
		...
		$a_00_1 = {46 00 6c 00 61 00 77 00 6c 00 65 00 73 00 73 00 54 00 69 00 63 00 54 00 61 00 63 00 54 00 6f 00 65 00 2e 00 76 00 62 00 70 00 } //00 00  FlawlessTicTacToe.vbp
	condition:
		any of ($a_*)
