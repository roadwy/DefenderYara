...
rule VirTool_Win32_VBInject_AFN{
	...
	strings :
		$a_03_0 = {3b 41 40 75 05 e9 90 01 04 c7 45 fc 12 00 00 00 e8 90 01 04 c7 45 fc 13 00 00 00 c7 85 90 01 01 ff ff ff 90 01 04 6a 04 8b 45 08 ff 70 50 8d 85 90 01 01 ff ff ff 50 e8 90 00 } //1
