...
rule VirTool_Win32_TonickInject{
	...
	strings :
		...
		$a_01_6 = {52 00 67 00 77 00 50 00 6d 00 74 00 62 00 69 00 6d 00 49 00 64 00 62 00 79 00 6b 00 77 00 64 00 } //2 RgwPmtbimIdbykwd
		$a_01_7 = {53 00 67 00 70 00 71 00 68 00 63 00 53 00 60 00 7b 00 6f 00 6a 00 68 00 } //2 SgpqhcS`{ojh
		$a_01_8 = {4e 74 55 6e 6d 61 70 56 69 65 77 4f 66 53 65 63 74 69 6f 6e } //1 NtUnmapViewOfSection
