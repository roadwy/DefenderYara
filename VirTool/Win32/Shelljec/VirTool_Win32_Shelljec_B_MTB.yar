...
rule VirTool_Win32_Shelljec_B_MTB{
	...
	strings :
		$a_02_0 = {8b c8 ff 15 90 01 04 56 6a 00 68 ff ff 1f 00 ff 90 00 } //1
		...
		$a_02_4 = {6a ff 53 ff 15 90 01 04 68 30 23 40 00 51 8b 0d a4 40 40 00 ba 9c 43 40 00 90 00 } //1
	condition:
