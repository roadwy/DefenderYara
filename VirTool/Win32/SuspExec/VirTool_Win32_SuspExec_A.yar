...
rule VirTool_Win32_SuspExec_A{
	...
	strings :
		...
		$a_02_2 = {5c 00 57 00 69 00 6e 00 64 00 6f 00 77 00 73 00 5c 00 54 00 45 00 4d 00 50 00 5c 00 90 02 20 5c 00 66 00 69 00 6c 00 65 00 73 00 5c 00 90 00 } //1
		$a_02_3 = {5c 57 69 6e 64 6f 77 73 5c 54 45 4d 50 5c 90 02 20 5c 66 69 6c 65 73 5c 90 00 } //1
	condition:
