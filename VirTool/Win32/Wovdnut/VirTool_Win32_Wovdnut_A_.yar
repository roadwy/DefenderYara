...
rule VirTool_Win32_Wovdnut_A__5{
	...
	strings :
		...
		$a_01_3 = {8b 13 bd 04 00 00 00 44 8b cd 33 c9 41 b8 00 30 00 00 41 ff d4 48 8b f0 48 85 c0 75 } //1
	condition:
...
rule VirTool_Win32_Wovdnut_A__7{
	...
	strings :
		...
		$a_01_2 = {8b 52 50 81 c2 00 10 00 00 89 d2 41 b9 40 00 00 00 41 b8 00 30 00 00 b9 00 00 00 00 ff d0 48 89 } //1
	condition:
