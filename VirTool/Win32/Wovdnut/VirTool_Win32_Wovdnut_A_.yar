...
rule VirTool_Win32_Wovdnut_A_{
	meta:
		description = "VirTool:Win32/Wovdnut.A!!Wovdnut.gen!A,SIGNATURE_TYPE_ARHSTR_EXT,03 00 03 00 03 00 00 01 00 "
	...
	strings :
		...
		$a_03_2 = {68 05 00 00 20 55 89 90 01 01 89 90 01 01 04 ff 90 01 02 00 00 00 85 c0 74 33 8b 03 0b 43 04 74 2c 6a 04 68 00 30 00 00 ff 33 90 01 01 ff 90 00 } //05 00 
	condition:
		any of ($a_*)
...
rule VirTool_Win32_Wovdnut_A__5{
	meta:
		description = "VirTool:Win32/Wovdnut.A!!Wovdnut.gen!A,SIGNATURE_TYPE_ARHSTR_EXT,04 00 04 00 04 00 00 01 00 "
	...
	strings :
		...
		$a_01_3 = {8b 13 bd 04 00 00 00 44 8b cd 33 c9 41 b8 00 30 00 00 41 ff d4 48 8b f0 48 85 c0 75 } //05 00 
	condition:
		any of ($a_*)
...
rule VirTool_Win32_Wovdnut_A__6{
	...
	strings :
		...
		$a_03_2 = {48 81 ec 40 04 00 00 48 8b da 48 8b f1 48 8b 91 90 01 04 41 b8 00 30 00 00 33 c9 48 8d 14 55 02 00 00 00 44 8d 49 04 ff 56 48 4c 8b f0 48 85 c0 0f 90 00 } //05 00 
	condition:
		any of ($a_*)
...
rule VirTool_Win32_Wovdnut_A__7{
	...
	strings :
		...
		$a_01_2 = {8b 52 50 81 c2 00 10 00 00 89 d2 41 b9 40 00 00 00 41 b8 00 30 00 00 b9 00 00 00 00 ff d0 48 89 } //05 00 
	condition:
		any of ($a_*)
...
rule VirTool_Win32_Wovdnut_A__8{
	meta:
		description = "VirTool:Win32/Wovdnut.A!!Wovdnut.gen!A,SIGNATURE_TYPE_ARHSTR_EXT,05 00 05 00 05 00 00 01 00 "
		
	strings :
		$a_01_0 = {6f 6c 65 33 32 3b 6f 6c 65 61 75 74 33 32 3b 77 69 6e 69 6e 65 74 3b 6d 73 63 6f 72 65 65 3b 73 68 65 6c 6c 33 32 } //01 00 
		...
		$a_01_4 = {2f cb 3a ab d2 11 9c 40 00 c0 4f a3 0a 3e 22 67 2f cb 3a ab d2 11 9c 40 00 c0 4f a3 0a 3e dc } //05 00 
	condition:
		any of ($a_*)
