...
rule VirTool_Win32_BruterShell_A{
	...
	strings :
		$a_03_0 = {80 78 05 e8 75 90 01 01 80 78 06 03 75 90 01 01 80 78 0d 8b 75 90 01 01 80 78 0e d4 75 90 01 01 0f b6 50 02 90 00 } //1
		$a_01_1 = {c7 44 24 04 89 4d 39 8c 89 44 24 08 e8 } //1
		$a_03_2 = {89 14 24 c7 44 24 90 01 01 50 4f 53 54 c6 44 24 90 01 01 00 c7 44 24 90 01 01 7b 22 61 72 c7 44 24 90 01 01 63 68 22 3a 90 00 } //1
		$a_03_3 = {c7 44 24 04 aa fc 0d 7c 90 02 80 c7 44 24 04 bd ca 3b d3 90 00 } //1
	condition:
...
rule VirTool_Win32_BruterShell_A_2{
	...
	strings :
		...
		$a_03_1 = {80 78 05 e8 75 90 01 01 80 78 06 03 75 90 01 01 80 78 0d 8b 75 90 01 01 80 78 0e d4 75 90 01 01 0f b6 50 02 90 00 } //1
		$a_03_2 = {c7 44 24 04 bd ca 3b d3 89 44 24 08 8b 84 24 90 01 01 00 00 00 89 04 24 e8 90 00 } //1
