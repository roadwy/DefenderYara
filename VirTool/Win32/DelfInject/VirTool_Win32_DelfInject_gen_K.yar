...
rule VirTool_Win32_DelfInject_gen_K{
	...
	strings :
		...
		$a_02_3 = {8b 45 fc 8b 55 f4 8a 44 10 ff 88 45 f3 8d 45 e8 8a 55 f3 80 ea 90 01 01 e8 90 01 04 8b 55 e8 8b 45 f8 e8 90 01 04 8b 45 f8 ff 45 f4 ff 4d ec 75 cf 90 00 } //2
		$a_03_4 = {44 38 ff 88 45 fb 8d 45 f4 8a 55 fb 80 ea 90 01 01 e8 90 01 04 8b 55 f4 8b c6 e8 90 01 04 47 4b 75 da 90 09 04 00 8b 45 fc 90 03 01 01 8a 8b 90 00 } //2
		...
		$a_03_7 = {6a 40 68 00 30 00 00 8b 45 90 01 01 50 8b 45 90 01 01 8b 40 34 50 8b 90 03 06 04 85 90 01 02 ff ff 45 90 01 01 50 90 03 01 01 ff e8 90 00 } //1
	condition:
