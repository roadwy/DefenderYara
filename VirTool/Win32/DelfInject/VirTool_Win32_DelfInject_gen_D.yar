...
rule VirTool_Win32_DelfInject_gen_D{
	...
	strings :
		...
		$a_00_7 = {2f 73 20 22 43 3a 5c 53 4d 47 43 61 74 63 68 65 72 2e 64 6c 6c 22 } //65436 /s "C:\SMGCatcher.dll"
	condition:
		((#a_01_0  & 1)*1+(#a_01_1  & 1)*1+(#a_00_2  & 1)*3+(#a_00_3  & 1)*3+(#a_00_4  & 1)*5+(#a_00_5  & 1)*1+(#a_00_6  & 1)*1+(#a_00_7  & 1)*65436) >=7
