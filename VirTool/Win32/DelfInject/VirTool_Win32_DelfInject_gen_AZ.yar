...
rule VirTool_Win32_DelfInject_gen_AZ{
	...
	strings :
		...
		$a_03_1 = {0f b6 0c 8b 8b 0c 8d 90 01 04 8d 70 01 81 e6 03 00 00 80 79 05 90 00 } //1
		$a_01_2 = {8d 04 b6 8b 44 c7 14 3b e8 76 02 8b e8 46 4b 75 ef } //1
		$a_03_3 = {7d 11 6a 01 8b 85 90 01 04 50 ff 15 90 01 04 eb 75 6a 40 68 00 30 00 00 56 8b 45 f8 50 8b 85 90 01 04 50 ff 15 90 00 } //1
	condition:
