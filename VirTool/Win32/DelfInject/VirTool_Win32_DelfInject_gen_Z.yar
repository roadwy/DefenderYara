...
rule VirTool_Win32_DelfInject_gen_Z{
	...
	strings :
		...
		$a_03_4 = {8a 04 1f 24 0f 8b 55 ?? 8a 14 32 80 e2 0f 32 c2 8a 14 1f 80 e2 f0 02 d0 88 14 1f 46 8d 45 ?? 8b 55 ?? e8 ?? ?? ?? ?? 8b 45 ?? e8 ?? ?? ?? ?? 3b f0 7e 05 be 01 00 00 00 43 ff 4d ?? 75 c2 } //5
	condition:
