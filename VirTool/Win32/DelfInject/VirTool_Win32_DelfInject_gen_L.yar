...
rule VirTool_Win32_DelfInject_gen_L{
	...
	strings :
		...
		$a_00_1 = {4c 6f 61 64 52 65 73 6f 75 72 63 65 } //0a 00 
		$a_00_2 = {43 72 65 61 74 65 50 72 6f 63 65 73 73 41 } //0a 00 
		...
		$a_00_8 = {50 6c 65 61 73 65 20 76 69 73 69 74 20 77 77 77 2e 76 61 79 73 6f 66 74 2e 63 6f 6d 20 74 6f 20 67 65 74 20 6d 6f 72 65 20 64 65 74 61 69 6c } //00 00 
	condition:
		any of ($a_*)
