...
rule VirTool_Win32_DelfInject_gen_M{
	...
	strings :
		$a_03_0 = {6a 04 68 00 30 00 00 8b 45 ?? 8b 40 50 50 8b 45 ?? 8b 40 34 50 8b 45 ?? 50 a1 ?? ?? ?? ?? 8b 00 ff d0 } //3
		...
		$a_03_3 = {25 ff 00 00 80 79 07 48 0d 00 ff ff ff 40 8a 84 85 ?? ?? ff ff 8b 55 ?? 30 04 3a 47 ff 4d ?? 75 } //2
	condition:
