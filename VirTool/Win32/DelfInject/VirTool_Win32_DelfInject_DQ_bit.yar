...
rule VirTool_Win32_DelfInject_DQ_bit{
	...
	strings :
		$a_03_0 = {b9 40 00 00 00 ba 9d 53 00 00 a1 ?? ?? 48 00 ff 15 ?? ?? 48 00 33 db a1 ?? ?? 48 00 03 c3 8a 00 90 90 34 a6 8b 15 60 ?? ?? 00 03 d3 88 02 90 90 43 81 fb ?? ?? ?? 00 75 } //1
		$a_03_1 = {bb 3a 02 00 00 a1 ?? ?? 48 00 03 c3 a3 ?? ?? 48 00 90 90 90 90 90 90 ff 35 ?? ?? 48 00 c3 } //1
