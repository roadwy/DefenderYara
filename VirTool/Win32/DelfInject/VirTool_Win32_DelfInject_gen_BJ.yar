...
rule VirTool_Win32_DelfInject_gen_BJ{
	...
	strings :
		...
		$a_03_2 = {8b c3 99 f7 7d 90 01 01 8b c6 32 d0 90 00 } //1
		$a_01_3 = {0f b6 44 18 ff 99 f7 fb 33 f2 43 } //1
		$a_03_4 = {8d 34 9b 8b 45 90 01 01 8b 44 f0 10 50 8b 45 90 01 01 8b 44 f0 14 03 45 90 01 01 50 8b 45 90 01 01 8b 44 f0 0c 90 00 } //1
	condition:
