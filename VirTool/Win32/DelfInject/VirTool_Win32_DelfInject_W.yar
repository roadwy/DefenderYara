...
rule VirTool_Win32_DelfInject_W{
	...
	strings :
		...
		$a_02_2 = {43 33 ff a1 90 01 03 00 8a 04 38 a2 90 01 03 00 a0 90 01 03 00 c0 c8 90 01 01 a2 90 01 03 00 a1 90 01 03 00 8a 15 90 01 03 00 88 14 38 47 4b 75 90 00 } //10
		...
		$a_02_4 = {48 5a 8b ca 99 f7 f9 42 a1 90 01 03 00 8a 44 10 ff 8b 15 90 01 03 00 8a 14 3a 32 c2 8b 15 90 01 03 00 88 04 3a 90 00 } //10
	condition:
