...
rule VirTool_Win32_DelfInject_AP{
	...
	strings :
		...
		$a_01_3 = {5c 00 57 00 69 00 6e 00 64 00 6f 00 77 00 73 00 55 00 70 00 64 00 61 00 74 00 5f 00 39 00 36 00 37 00 39 00 33 00 2e 00 65 00 78 00 65 00 } //01 00 
