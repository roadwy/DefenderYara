...
rule VirTool_Win32_DelfInject_gen_BC{
	...
	strings :
		...
		$a_03_3 = {03 45 fc 50 8b 45 e8 8d 04 80 8b 55 dc 8b 44 c2 0c 03 45 f4 50 8b 45 c8 50 ff 15 ?? ?? 40 00 ff 45 e8 ff 4d d8 75 } //1
		$a_03_4 = {3c e8 0f 84 ?? ?? 00 00 e8 ?? ?? ff ff 3c ff 0f 84 } //1
	condition:
