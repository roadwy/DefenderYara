...
rule VirTool_Win32_DelfInject_gen_AL{
	...
	strings :
		$a_03_0 = {6a 00 6a 00 6a ff ff 15 90 01 04 85 c0 74 08 6a 00 ff 15 90 00 } //2
		$a_01_1 = {66 b9 ff ff eb 06 66 b8 00 4c cd 21 e2 f6 } //2
		$a_03_2 = {83 c0 01 89 45 90 01 01 33 c9 8a 0d 90 01 04 85 c9 74 eb 81 7d 90 01 01 00 e1 f5 05 7d 08 6a 00 ff 15 90 00 } //2
