...
rule VirTool_Win32_DelfInject_gen_U{
	...
	strings :
		...
		$a_02_3 = {8b 45 fc 8b 55 f4 8a 44 10 ff 88 45 f3 8d 45 e8 8a 55 f3 80 ea ?? e8 ?? ?? ?? ?? 8b 55 e8 8b 45 f8 e8 ?? ?? ?? ?? 8b 45 f8 ff 45 f4 ff 4d ec 75 cf } //1
		$a_03_4 = {44 38 ff 88 45 fb 8d 45 f4 8a 55 fb 80 ea ?? e8 ?? ?? ?? ?? 8b 55 f4 8b c6 e8 ?? ?? ?? ?? 47 4b 75 da 90 09 04 00 8b 45 fc (8a|8b) } //1
	condition:
