...
rule VirTool_Win32_DelfInject_gen_O{
	...
	strings :
		...
		$a_00_2 = {53 65 74 54 68 72 65 61 64 43 6f 6e 74 65 78 74 } //01 00 
		$a_00_3 = {52 65 73 75 6d 65 54 68 72 65 61 64 } //01 00 
		...
		$a_00_6 = {53 65 74 46 69 6c 65 50 6f 69 6e 74 65 72 } //01 00 
		$a_00_7 = {47 65 74 46 69 6c 65 53 69 7a 65 } //01 00 
		$a_00_8 = {43 72 65 61 74 65 50 72 6f 63 65 73 73 41 } //01 00 
		$a_00_9 = {52 65 61 64 46 69 6c 65 } //01 00 
