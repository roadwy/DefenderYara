...
rule VirTool_Win32_DelfInject_gen_O{
	...
	strings :
		...
		$a_02_10 = {6a 00 6a 00 68 90 01 02 00 00 53 e8 90 01 04 6a 00 53 e8 90 01 04 90 03 02 02 8b f0 89 c6 81 ee 90 01 02 00 00 8d 45 fc 90 03 02 02 8b d6 89 f2 e8 90 01 04 6a 00 8d 45 f4 50 56 8d 45 fc e8 90 01 04 50 53 e8 90 00 } //1
		$a_03_11 = {89 c3 83 fb ff 0f 84 90 01 02 00 00 6a 00 53 e8 90 01 04 89 c6 81 ee 00 5e 00 00 6a 00 6a 00 68 00 5e 00 00 53 e8 90 00 } //1
	condition:
