...
rule VirTool_Win32_DelfInject_gen_AE{
	...
	strings :
		...
		$a_02_9 = {8b 45 fc 33 db 8a 5c 38 ff 33 5d f8 8d 45 ec 8b d3 e8 90 01 04 8b 55 ec 8d 45 f0 e8 90 01 04 47 4e 75 90 00 } //5
		$a_03_10 = {44 38 ff 88 45 fb 8d 45 f4 8a 55 fb 80 ea 90 01 01 e8 90 01 04 8b 55 f4 8b c6 e8 90 01 04 47 4b 75 da 90 09 04 00 8b 45 fc 90 03 01 01 8a 8b 90 00 } //5
	condition:
