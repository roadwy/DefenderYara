...
rule VirTool_Win32_DelfInject_gen_BU{
	...
	strings :
		...
		$a_03_1 = {6a 04 8d 45 f0 50 53 e8 ?? ?? ?? ?? 8d 45 f4 8b 55 f0 e8 ?? ?? ?? ?? 6a 00 6a 00 68 05 04 00 00 53 e8 } //1
		$a_03_2 = {8d 34 9b 8b 45 ?? 8b 44 f0 10 50 8b 45 ?? 8b 44 f0 14 03 45 ?? 50 8b 45 ?? 8b 44 f0 0c } //1
	condition:
