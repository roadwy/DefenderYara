...
rule VirTool_Win32_DelfInject_gen_CA{
	...
	strings :
		...
		$a_03_1 = {32 c2 88 45 90 01 01 eb 90 02 05 40 72 90 00 } //1
		$a_03_2 = {2b 4d 08 8b 55 0c 90 90 66 81 3a 4d 5a 90 90 75 90 01 01 90 90 03 52 3c 90 90 81 3a 50 45 00 00 90 90 75 90 01 01 8b 52 78 90 00 } //1
	condition:
