...
rule VirTool_Win32_SuspServWmiCommand_C{
	...
	strings :
		...
		$a_00_2 = {73 00 76 00 20 00 } //01 00 
		$a_00_3 = {29 00 2e 00 76 00 61 00 6c 00 75 00 65 00 2e 00 74 00 6f 00 53 00 74 00 72 00 69 00 6e 00 67 00 28 00 29 00 } //00 00 
	condition:
		any of ($a_*)
