...
rule VirTool_Win32_SuspServWmiCommand_F{
	...
	strings :
		...
		$a_00_4 = {2e 00 6d 00 69 00 63 00 72 00 6f 00 73 00 6f 00 66 00 74 00 2e 00 63 00 6f 00 6d 00 2f 00 } //65436 .microsoft.com/
	condition:
		((#a_00_0  & 1)*1+(#a_00_1  & 1)*1+(#a_00_2  & 1)*1+(#a_00_3  & 1)*1+(#a_00_4  & 1)*65436) >=4
