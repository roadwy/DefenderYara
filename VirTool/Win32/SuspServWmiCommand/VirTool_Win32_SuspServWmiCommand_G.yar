...
rule VirTool_Win32_SuspServWmiCommand_G{
	...
	strings :
		...
		$a_00_3 = {5b 00 73 00 74 00 72 00 69 00 6e 00 67 00 5d 00 28 00 47 00 65 00 74 00 2d 00 57 00 4d 00 49 00 4f 00 62 00 6a 00 65 00 63 00 74 00 } //00 00  [string](Get-WMIObject
	condition:
		any of ($a_*)
