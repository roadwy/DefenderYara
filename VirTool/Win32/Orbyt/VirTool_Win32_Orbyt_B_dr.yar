...
rule VirTool_Win32_Orbyt_B_dr{
	...
	strings :
		...
		$a_00_1 = {4f 00 72 00 62 00 7a 00 20 00 43 00 72 00 79 00 70 00 74 00 65 00 72 00 } //01 00 
		$a_00_2 = {68 00 61 00 6e 00 73 00 69 00 72 00 6f 00 63 00 6b 00 7a 00 } //01 00 
