...
rule VirTool_Win32_DownRefDllz_B_MTB{
	...
	strings :
		...
		$a_02_1 = {8b f4 8d 85 ?? ?? ?? ?? 50 8d 8d ?? ?? ?? ?? 51 6a 00 6a 02 68 78 ff 41 00 68 ?? ff 41 00 68 02 00 00 80 ff } //1
		$a_00_2 = {89 85 b0 fd ff ff 8b 85 b0 fd ff ff 89 85 f4 f7 ff ff 81 bd f4 f7 ff ff 6f 07 00 00 74 21 } //1
		$a_02_3 = {8b f4 8d 45 ?? 50 8b 4d c0 51 8b 55 a8 52 8b 85 78 ff ff ff 50 ff } //1
