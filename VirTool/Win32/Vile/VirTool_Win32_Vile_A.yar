...
rule VirTool_Win32_Vile_A{
	...
	strings :
		...
		$a_03_3 = {41 b9 00 30 00 00 c7 44 24 20 04 00 00 00 48 8b c8 4c 8b c3 33 d2 48 8b f0 ff 15 90 01 04 4c 8b cb 48 c7 44 24 20 00 00 00 00 48 8b d0 4c 8d 84 24 80 02 00 00 48 8b ce 48 8b e8 ff 15 90 00 } //1
	condition:
