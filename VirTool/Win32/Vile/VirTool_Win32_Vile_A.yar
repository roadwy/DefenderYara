...
rule VirTool_Win32_Vile_A{
	...
	strings :
		$a_01_0 = {74 6f 2f 74 61 72 67 65 74 2f 65 78 65 } //01 00  to/target/exe
		$a_01_1 = {64 6c 6c 5f 69 6e 6a } //01 00  dll_inj
		$a_01_2 = {49 6e 6a 65 63 74 50 72 6f 63 } //01 00  InjectProc
