...
rule VirTool_Win32_Joiner_gen_B{
	...
	strings :
		$a_00_0 = {52 65 73 75 6c 74 2e 65 78 65 20 3d 20 25 6c 75 } //01 00 
		$a_00_1 = {53 68 65 6c 6c 45 78 65 63 75 74 65 41 } //01 00 
		$a_00_2 = {49 63 6f 6e 2c 20 45 78 65 2c 20 44 4c 4c 20 28 2a 2e 69 63 6f 2c 20 2a 2e 65 78 65 2c 20 2a 2e 64 6c 6c 29 } //01 00 
