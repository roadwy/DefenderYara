...
rule VirTool_Win32_Injector_KR_bit{
	...
	strings :
		...
		$a_03_1 = {54 6a 40 68 e2 59 00 00 57 e8 90 01 03 ff 90 00 } //1
		$a_03_2 = {8b f7 03 f2 90 02 20 8a 08 90 02 20 80 f1 79 90 02 20 88 0e 90 02 20 42 90 00 } //1
		$a_03_3 = {81 3c 24 e3 59 00 00 75 90 02 20 8b c7 e8 90 01 03 ff 90 00 } //1
	condition:
