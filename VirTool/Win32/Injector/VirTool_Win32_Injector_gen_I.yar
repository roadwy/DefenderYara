...
rule VirTool_Win32_Injector_gen_I{
	...
	strings :
		...
		$a_03_2 = {0f b7 40 06 85 c0 7e 2d 53 8b 5c 24 ?? 55 83 c3 08 8b e8 8b 0b 85 c9 74 14 33 d2 8b c1 f7 f6 85 d2 75 04 03 f9 eb 06 40 0f af c6 03 f8 83 c3 28 } //1
		$a_01_3 = {8b 47 34 6a 40 68 00 30 00 00 53 50 56 ff } //1
		$a_03_4 = {0f b7 55 06 40 83 c7 28 3b c2 89 44 24 ?? 7c } //1
	condition:
