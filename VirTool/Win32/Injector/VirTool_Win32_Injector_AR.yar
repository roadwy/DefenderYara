...
rule VirTool_Win32_Injector_AR{
	...
	strings :
		$a_03_0 = {03 42 24 89 45 90 09 06 00 8b 55 ?? 8b 45 08 } //1
		$a_03_1 = {03 51 24 89 55 90 09 06 00 8b 4d ?? 8b 55 08 } //1
		$a_03_2 = {03 51 24 89 55 90 09 09 00 8b 8d ?? ff ff ff 8b 55 08 } //1
		$a_03_3 = {6a 07 6a 0e 68 90 09 07 00 [0-03] 8d 90 17 03 05 05 08 4d ?? 51 45 ?? 50 8d ?? ff ff ff 51 } //10
