...
rule VirTool_Win32_Injector_HK{
	meta:
		description = "VirTool:Win32/Injector.HK,SIGNATURE_TYPE_PEHSTR_EXT,03 00 03 00 04 00 00 01 00 "
		
	strings :
		$a_01_0 = {73 19 8b 45 fc 8b 4d 8c 8b 14 81 8b 45 94 03 45 fc 8b 4d 80 8a 00 88 04 11 eb d6 } //01 00 
