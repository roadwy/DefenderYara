...
rule VirTool_Win32_Injector_gen_BF{
	...
	strings :
		...
		$a_03_1 = {53 56 57 89 65 e8 90 03 07 04 c7 45 fc 00 00 00 00 83 65 fc 00 f3 64 f1 90 03 07 04 c7 45 fc ff ff ff ff 83 4d fc ff eb 90 00 } //1
		$a_01_2 = {83 7d fc 00 74 0b 8b 45 fc 83 e8 01 89 45 fc eb ef } //1
		$a_03_3 = {83 45 0c 28 0f b7 40 06 39 45 08 90 13 8b 45 0c 03 43 3c 8d 90 01 01 18 f8 00 00 00 90 00 } //1
		$a_01_4 = {6a 40 68 00 30 00 00 ff 70 50 ff 70 34 ff } //1
		$a_03_5 = {40 00 ff e2 5a 90 09 05 00 52 8d 15 90 00 } //1
	condition:
