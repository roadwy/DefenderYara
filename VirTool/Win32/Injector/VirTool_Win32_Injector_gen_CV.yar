...
rule VirTool_Win32_Injector_gen_CV{
	...
	strings :
		$a_03_0 = {68 00 00 cf 00 68 90 01 04 68 90 01 04 68 00 03 00 00 e8 90 01 04 a3 90 01 04 68 58 02 00 00 ff 75 08 e8 90 00 } //1
		...
		$a_03_3 = {8d 45 fc eb 90 14 eb 90 14 90 03 01 01 eb e9 90 00 } //1
	condition:
