...
rule VirTool_Win32_Injector_AD{
	...
	strings :
		$a_03_0 = {4a 88 10 40 8a 10 84 d2 75 f6 b8 90 01 04 eb 04 90 00 } //1
		$a_03_1 = {8a 1c 03 30 19 40 3b 44 24 90 02 10 42 3b 54 24 90 01 01 72 90 14 8b 4c 24 90 01 01 01 d1 8b 5c 24 90 00 } //1
