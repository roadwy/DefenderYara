...
rule VirTool_Win32_Injector_HM{
	...
	strings :
		$a_03_0 = {8b 00 8d 4d e0 51 ff 75 d0 35 90 01 04 50 ff 75 d4 e8 90 01 04 53 89 45 64 81 ce 90 01 04 ff 55 0c 03 f8 39 5d 64 0f 84 90 00 } //1
		$a_03_1 = {ff 75 4c ff 75 64 ff 75 58 ff 55 b8 69 ff 90 01 04 81 f6 90 01 04 83 c4 0c 81 fe 90 01 04 0f 84 90 00 } //1
