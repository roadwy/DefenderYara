...
rule VirTool_Win32_Injector_gen_FQ{
	...
	strings :
		$a_00_0 = {77 65 72 6e 65 6c 75 32 2e 64 6c 6c 4a 58 4f 72 76 4f 49 } //01 00 
		$a_00_1 = {43 49 65 61 48 47 46 69 6c 65 41 } //01 00 
		$a_00_2 = {52 65 61 64 4d 69 6c 65 6c 6a 44 4f 42 70 } //03 00 
