...
rule VirTool_Win32_Injector_FO{
	...
	strings :
		$a_01_0 = {31 32 37 2e 30 2e 30 2e 31 3a 38 30 38 30 } //01 00  127.0.0.1:8080
		$a_01_1 = {4e 4f 4b 49 41 4e 39 35 2f 57 45 42 } //01 00  NOKIAN95/WEB
		$a_01_2 = {68 74 74 70 5c 73 68 65 6c 6c 5c 6f 70 65 6e 5c 63 6f 6d 6d 61 6e 64 } //01 00  http\shell\open\command
