...
rule VirTool_Win32_Injector_FS{
	...
	strings :
		$a_03_0 = {2c 56 8b 4d 90 01 01 03 4d 90 01 01 88 01 eb 12 8b 55 90 01 01 03 55 90 01 01 8a 02 2c 98 90 00 } //1
...
rule VirTool_Win32_Injector_FS_2{
	...
	strings :
		$a_03_0 = {56 4d 50 72 6f 74 65 63 74 90 02 10 00 b0 04 00 90 00 } //10
...
rule VirTool_Win32_Injector_FS_3{
	...
	strings :
		$a_03_0 = {c6 45 c4 2f c6 45 c5 63 c6 45 c6 20 c6 45 c7 70 c6 45 c8 69 c6 45 c9 6e c6 45 ca 67 c6 45 cb 20 c6 45 cc 31 c6 45 cd 32 c6 45 ce 37 c6 45 cf 2e 90 02 80 c6 45 e1 33 c6 45 e2 32 c6 45 e3 2e c6 45 e4 65 c6 45 e5 78 c6 45 e6 65 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
