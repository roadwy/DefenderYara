...
rule VirTool_Win32_Injector_gen_AX{
	...
	strings :
		$a_03_0 = {75 02 eb 34 ff b5 f8 fd ff ff 6a 00 ff 95 60 fe ff ff 89 45 e4 8b 85 b4 fd ff ff 03 45 e4 89 85 b4 fd ff ff 68 90 01 04 8d 85 e4 fe ff ff 50 ff 15 90 01 04 eb aa 90 00 } //1
