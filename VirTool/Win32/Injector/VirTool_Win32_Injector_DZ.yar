...
rule VirTool_Win32_Injector_DZ{
	...
	strings :
		$a_03_0 = {75 04 33 c0 eb 29 83 7d 2c 00 74 11 8d 45 e8 6a 10 50 ff 75 2c e8 90 01 04 83 c4 0c f6 45 1c 04 75 09 ff 75 ec ff 15 90 01 04 6a 01 90 00 } //10
		$a_03_1 = {8d 7c 07 04 eb 03 8b 45 fc 8b 4d 0c 03 c3 ff 31 8b 4d ec 2b cb 51 50 e8 90 01 04 83 c4 0c 85 c0 0f 8c 39 02 00 00 90 00 } //10
