...
rule VirTool_Win32_Injector_FZ{
	...
	strings :
		$a_03_0 = {eb 08 83 45 90 01 01 01 83 45 90 01 01 01 81 7d 90 01 03 01 00 7e ef 90 00 } //1
...
rule VirTool_Win32_Injector_FZ_2{
	...
	strings :
		$a_03_0 = {ff 45 f8 ff 45 f8 81 7d f8 90 01 02 00 00 7c f1 90 09 0e 00 c7 45 f8 90 00 } //2
...
rule VirTool_Win32_Injector_FZ_3{
	...
	strings :
		$a_03_0 = {83 f8 44 7d 0c 8a 4d 90 01 01 88 0c 02 40 83 f8 44 7c f4 8d 95 90 01 02 ff ff 8b 45 90 01 01 83 f8 10 90 00 } //1
		$a_03_1 = {8b c8 83 c0 ff 85 c9 75 f1 33 c0 89 45 90 01 01 c7 45 90 01 03 00 00 90 00 } //1
		$a_03_2 = {be 84 a0 40 00 8d bd 90 01 02 ff ff b9 90 01 01 00 00 00 f3 a5 90 00 } //1
	condition:
