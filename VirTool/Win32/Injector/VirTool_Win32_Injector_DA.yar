...
rule VirTool_Win32_Injector_DA{
	...
	strings :
		$a_03_0 = {43 43 58 31 0f 85 90 01 04 83 3d 90 01 04 01 0f 85 90 09 06 00 81 3d 90 00 } //1
		$a_03_1 = {58 59 59 59 90 09 03 00 90 03 03 01 00 00 b8 c7 90 00 } //1
		$a_03_2 = {80 7d ff e9 75 90 01 01 33 c0 40 eb 02 90 00 } //1
