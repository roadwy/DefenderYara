...
rule VirTool_Win32_Injector_BD_2{
	...
	strings :
		$a_03_0 = {68 00 00 32 40 6a 00 68 00 00 00 40 6a 00 ff 15 90 01 04 dc 8d 90 01 04 df e0 a8 0d 0f 85 90 01 01 90 04 01 03 03 2d 04 00 00 dd 9d 90 01 01 fe ff ff 90 01 1f 68 00 00 28 40 6a 00 68 00 00 00 40 6a 00 ff 15 90 00 } //14
		$a_03_1 = {c7 45 fc 22 00 00 00 8b 90 01 02 03 90 01 02 0f 80 90 01 01 02 00 00 89 90 01 02 c7 45 fc 23 00 00 00 8b 90 01 02 99 f7 7d 90 01 01 89 90 00 } //1
		$a_03_2 = {c7 45 fc 08 00 00 00 83 bd 90 01 01 ff ff ff 1a 0f 8c 90 01 01 00 00 00 83 bd 90 01 01 ff ff ff 33 0f 8f 90 01 01 00 00 00 c7 45 fc 09 00 00 00 90 00 } //1
		$a_03_3 = {ff 1a 0f 8c 90 01 01 00 00 00 83 bd 90 01 01 ff ff ff 33 0f 8f 90 01 01 00 00 00 c7 45 fc 90 01 01 00 00 00 90 00 } //1
	condition:
