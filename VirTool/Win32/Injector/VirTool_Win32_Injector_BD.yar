...
rule VirTool_Win32_Injector_BD{
	...
	strings :
		$a_01_0 = {58 79 6c 69 74 6f 6c 20 6b 6e 6f 77 73 20 74 68 65 20 61 6e 73 77 65 72 2e } //01 00  Xylitol knows the answer.
		$a_01_1 = {42 74 77 2c 20 54 48 45 20 47 41 4d 45 2e } //01 00  Btw, THE GAME.
		$a_01_2 = {28 59 6f 75 20 6a 75 73 74 20 6c 6f 73 74 20 69 74 2e 29 } //01 00  (You just lost it.)
