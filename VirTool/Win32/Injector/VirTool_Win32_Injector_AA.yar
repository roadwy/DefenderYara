...
rule VirTool_Win32_Injector_AA{
	...
	strings :
		$a_03_0 = {50 68 00 00 00 00 68 00 00 00 00 ff 75 ?? 68 00 e1 f5 05 68 00 00 00 00 ff 75 ?? ff 15 } //3
		$a_03_1 = {8b 48 3c 8b 4c 01 50 a3 ?? ?? ?? 00 89 0d ?? ?? ?? 00 03 c8 89 0d } //1
		$a_03_2 = {68 40 00 00 00 68 00 10 00 00 68 00 87 93 03 68 00 00 00 00 ff 75 ?? ff 15 } //1
