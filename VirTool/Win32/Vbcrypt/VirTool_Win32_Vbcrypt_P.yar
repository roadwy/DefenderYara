...
rule VirTool_Win32_Vbcrypt_P{
	...
	strings :
		...
		$a_00_1 = {5c 00 41 00 59 00 3a 00 5c 00 63 00 6f 00 64 00 65 00 5c 00 70 00 72 00 6f 00 67 00 5c 00 6d 00 79 00 5c 00 6d 00 79 00 70 00 72 00 6f 00 67 00 2e 00 76 00 62 00 70 00 } //00 00  \AY:\code\prog\my\myprog.vbp
	condition:
		any of ($a_*)
