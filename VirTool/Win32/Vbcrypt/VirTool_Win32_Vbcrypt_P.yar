...
rule VirTool_Win32_Vbcrypt_P{
	...
	strings :
		$a_02_0 = {73 68 65 6c 6c 2e 64 6c 6c 90 02 08 53 68 65 6c 6c 45 78 65 63 75 74 65 90 02 60 2e 00 65 00 78 00 65 00 00 00 90 02 08 64 00 66 00 64 00 90 00 } //1
