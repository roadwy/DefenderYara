...
rule VirTool_Win32_CoffLdz_B_MTB{
	...
	strings :
		$a_02_0 = {8b f4 8d 85 90 01 04 50 6a 20 8b 8d 6c ff ff ff 51 8b 95 7c ff ff ff 52 ff 90 00 } //1
		$a_02_1 = {8b f4 6a 04 68 00 30 10 00 8b 45 ac b9 08 00 00 00 f7 e1 50 6a 00 ff 15 90 01 04 3b f4 e8 90 01 04 89 45 c4 83 7d c4 00 90 00 } //1
