...
rule VirTool_Win32_Tetanus_A_MTB{
	...
	strings :
		...
		$a_01_4 = {75 73 65 72 5f 6f 75 74 70 75 74 63 6f 6d 70 6c 65 74 65 64 } //01 00  user_outputcompleted
		$a_01_5 = {65 6e 63 5f 6b 65 79 64 65 63 5f 6b 65 79 } //01 00  enc_keydec_key
		$a_01_6 = {4d 79 74 68 69 63 46 69 6c 65 } //00 00  MythicFile
	condition:
		any of ($a_*)
