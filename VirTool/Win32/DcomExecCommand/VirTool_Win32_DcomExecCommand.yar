...
rule VirTool_Win32_DcomExecCommand{
	...
	strings :
		...
		$a_00_1 = {31 00 20 00 3e 00 20 00 5c 00 5c 00 31 00 32 00 37 00 2e 00 30 00 2e 00 30 00 2e 00 31 00 5c 00 41 00 44 00 4d 00 49 00 4e 00 24 00 5c 00 5f 00 } //01 00  1 > \\127.0.0.1\ADMIN$\_
