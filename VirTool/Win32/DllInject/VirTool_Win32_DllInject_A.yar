...
rule VirTool_Win32_DllInject_A{
	...
	strings :
		$a_03_0 = {89 54 24 04 89 04 24 e8 90 01 06 8b 3b 89 c6 8b 4d 10 f3 a4 8b 55 10 03 13 89 13 c6 02 e9 8b 0b 8d 51 01 29 d0 8b 75 10 8d 44 06 fc 89 41 01 89 f0 f7 d0 01 c2 89 13 90 00 } //3
		...
		$a_03_3 = {f7 7d 10 8b 90 01 01 0c 8a 04 90 01 01 30 04 90 00 } //1
	condition:
