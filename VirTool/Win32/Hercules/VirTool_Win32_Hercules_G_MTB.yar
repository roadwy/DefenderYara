...
rule VirTool_Win32_Hercules_G_MTB{
	...
	strings :
		...
		$a_02_3 = {84 00 8b 05 68 90 01 02 00 90 90 8b 0d 90 01 03 00 90 90 89 04 24 c7 44 24 04 00 00 00 00 c7 44 24 08 00 00 00 00 89 4c 24 0c 8b 44 24 2c 89 44 24 10 c7 44 24 14 00 00 00 00 c7 44 24 18 00 00 00 00 e8 73 05 00 00 8b 44 24 1c 85 c0 74 16 8b 0d 90 00 } //2
	condition:
