...
rule VirTool_Win32_Delfsnif{
	...
	strings :
		...
		$a_02_1 = {8b 16 88 c3 32 da c1 e8 08 33 04 9d ?? ?? ?? ?? 88 c3 32 de c1 e8 08 33 04 9d } //2
		$a_02_2 = {89 f9 83 e1 03 e3 11 88 c3 32 1e c1 e8 08 46 33 04 9d ?? ?? ?? ?? e2 ef 35 ff ff ff ff } //2
