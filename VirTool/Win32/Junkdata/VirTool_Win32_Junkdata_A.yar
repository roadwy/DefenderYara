...
rule VirTool_Win32_Junkdata_A{
	...
	strings :
		$a_03_0 = {99 b9 ff 00 00 00 f7 f9 83 c7 01 3b ?? 88 54 37 ff 7c e8 } //1
		$a_03_1 = {80 04 30 ff 83 c0 01 3b ?? 7c f5 } //1
		$a_03_2 = {b9 1f 00 00 00 f7 f1 85 d2 0f 85 ?? ?? 00 00 8b 4c 24 ?? 8b d1 83 e2 0f 80 fa 08 74 } //1
