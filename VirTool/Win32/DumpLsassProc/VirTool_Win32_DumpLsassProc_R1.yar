...
rule VirTool_Win32_DumpLsassProc_R1{
	...
	strings :
		...
		$a_02_2 = {2f 00 70 00 90 02 08 28 00 47 00 65 00 74 00 2d 00 50 00 72 00 6f 00 63 00 65 00 73 00 73 00 20 00 6c 00 73 00 61 00 73 00 73 00 29 00 2e 00 49 00 64 00 20 00 90 00 } //1
	condition:
