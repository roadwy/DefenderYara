...
rule VirTool_Win32_Parlsz_B_MTB{
	...
	strings :
		...
		$a_02_1 = {c7 44 24 60 00 00 00 00 8d 90 01 03 50 6a 00 6a 00 56 8b 35 90 01 04 ff 90 00 } //1
		$a_00_2 = {ff 74 24 1c 89 7c 24 6c 57 56 ff 74 24 24 ff } //1
		$a_02_3 = {6a 08 8d 84 90 01 05 50 6a 00 57 ff 74 24 58 ff b4 24 8c 00 00 00 ff 90 00 } //1
	condition:
