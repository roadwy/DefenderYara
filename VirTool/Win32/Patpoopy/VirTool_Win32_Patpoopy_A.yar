...
rule VirTool_Win32_Patpoopy_A_2{
	...
	strings :
		$a_01_0 = {5f 5f 70 75 70 79 69 6d 70 6f 72 74 65 72 5f 64 6c 6c 73 28 } //01 00 
		$a_01_1 = {70 75 70 79 3a 2f 2f 28 } //01 00 
		$a_01_2 = {70 75 70 79 69 7a 65 64 3a 20 7b 7d 52 65 } //01 00 
		$a_01_3 = {50 75 70 79 20 63 6f 6e 6e 65 63 74 65 64 3a } //01 00 
		...
		$a_01_5 = {67 69 74 68 75 62 2e 63 6f 6d 2f 6e 31 6e 6a 34 73 65 63 2f 70 75 70 79 } //01 00 
		$a_01_6 = {70 75 70 79 2d 63 6c 69 65 6e 74 2d 7b 7d 2d 7b 7d 2d 64 65 62 75 67 2e 6c 6f 67 } //01 00 
		$a_01_7 = {6e 65 74 77 6f 72 6b 2e 6c 69 62 2e 73 74 72 65 61 6d 73 2e 50 75 70 79 53 6f 63 6b 65 74 53 74 72 65 61 6d } //00 00 
	condition:
		any of ($a_*)
