...
rule VirTool_Win32_Toksteal_B{
	...
	strings :
		$a_03_0 = {8b 55 08 52 6a 00 ff 15 90 01 04 8d 45 b4 50 6a 00 68 ff 01 0f 00 ff 15 90 01 04 50 ff 15 90 01 04 6a 00 6a 00 ff 15 90 01 04 eb 06 8b 4d 08 89 4d b4 8d 55 fc 52 6a 01 6a 02 6a 00 68 00 00 00 02 8b 45 b4 50 ff 15 90 00 } //10
