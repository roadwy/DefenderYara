...
rule VirTool_Win32_CoinMiner_A_{
	meta:
		description = "VirTool:Win32/CoinMiner.A!!CoinMiner.A,SIGNATURE_TYPE_ARHSTR_EXT,0a 00 0a 00 0a 00 00 01 00 "
	...
	strings :
		...
		$a_01_9 = {57 69 6e 52 69 6e 67 30 20 64 72 69 76 65 72 } //05 00  WinRing0 driver
	condition:
		any of ($a_*)
