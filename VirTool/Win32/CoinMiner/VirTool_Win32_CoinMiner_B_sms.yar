...
rule VirTool_Win32_CoinMiner_B_sms{
	...
	strings :
		$a_03_0 = {2d 2d 61 6c 67 6f 3d 90 02 01 72 78 2f 30 90 00 } //1
		$a_03_1 = {2d 2d 75 72 6c 3d 90 02 10 2e 90 02 10 2e 90 02 10 3a 90 02 20 2d 2d 75 73 65 72 3d 90 00 } //1
		$a_03_2 = {2d 2d 70 61 73 73 3d 90 02 20 2d 2d 63 70 75 2d 6d 61 78 2d 74 68 72 65 61 64 73 2d 68 69 6e 74 3d 90 00 } //1
