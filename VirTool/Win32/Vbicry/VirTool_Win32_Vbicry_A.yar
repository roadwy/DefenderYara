...
rule VirTool_Win32_Vbicry_A{
	...
	strings :
		$a_02_0 = {03 45 e4 0f b6 00 89 45 e0 81 7d e0 00 01 00 00 73 06 83 65 b8 00 eb 08 e8 90 01 02 ff ff 89 45 b8 8b 45 e0 c1 e0 08 8b 4d dc 03 c8 a1 90 01 04 66 0f b6 04 08 66 a3 90 01 04 0f bf 05 90 01 04 89 45 e4 81 7d e4 00 01 00 00 73 06 83 65 b4 00 eb 08 90 00 } //1
