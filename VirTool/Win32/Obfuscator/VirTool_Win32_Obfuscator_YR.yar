...
rule VirTool_Win32_Obfuscator_YR{
	...
	strings :
		...
		$a_03_1 = {88 14 08 f6 c1 01 74 14 a1 e0 90 01 01 90 03 01 01 42 43 00 8a 14 08 32 15 c0 90 01 01 90 03 01 01 42 43 00 80 f2 74 88 14 08 41 81 f9 00 d0 07 00 7c a2 90 00 } //1
	condition:
