...
rule VirTool_Win32_Obfuscator_CAP_{
	...
	strings :
		$a_03_0 = {fc ad 85 c0 74 90 01 01 40 74 90 01 01 48 03 45 04 8b d0 ad 56 8b c8 8b f2 f3 a4 5e eb 90 00 } //1
		...
		$a_03_7 = {8b 74 24 28 8b 7c 24 30 bd 03 00 00 00 31 c0 31 db ac 3c 11 76 90 01 01 2c 11 3c 04 73 90 01 01 89 c1 eb 90 01 01 05 ff 00 00 00 90 00 } //1
