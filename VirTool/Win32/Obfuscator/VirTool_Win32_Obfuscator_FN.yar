...
rule VirTool_Win32_Obfuscator_FN{
	...
	strings :
		...
		$a_03_1 = {39 00 00 00 fa 0f 85 90 03 01 01 ec f0 ff ff ff 81 c1 04 00 00 00 81 f9 10 00 00 00 0f 85 90 03 01 01 da de ff ff ff 90 00 } //6
		$a_03_2 = {ff f5 89 e5 81 ec 90 01 01 00 00 00 ff f6 90 02 20 e8 00 00 00 00 58 81 e8 90 01 02 40 00 90 00 } //2
