...
rule VirTool_Win32_Obfuscator_AMM{
	meta:
		description = "VirTool:Win32/Obfuscator.AMM,SIGNATURE_TYPE_PEHSTR_EXT,03 00 03 00 06 00 00 01 00 "
		
	strings :
		$a_01_0 = {33 c0 8b ce 03 c8 8a 09 88 0c 02 8d 48 01 33 4b 04 51 33 c9 8a 0c 02 5f 2b cf 88 0c 02 8d 48 01 33 0b 51 33 c9 8a 0c 02 5f 2b cf 88 0c 02 40 ff 8d 0c fe ff ff 75 cb } //01 00 
		$a_01_1 = {50 ff 55 d0 8b d8 53 ff 55 cc 89 45 e8 46 83 ff 64 76 ca e8 00 00 00 00 58 } //01 00 
		$a_01_2 = {75 f2 8b 55 ec 03 d0 8a 12 3a 55 84 75 e6 8b 55 ec 03 d0 42 8a 12 3a 55 85 75 d9 } //01 00 
