...
rule VirTool_Win32_Obfuscator_PV_2{
	...
	strings :
		$a_03_0 = {8b cc 8d 61 ?? 59 } //1
		$a_03_1 = {8b c4 8d 60 ?? 58 } //1
		$a_01_2 = {81 38 33 c0 c2 08 0f 84 } //1
		$a_03_3 = {81 38 8b ff 90 90 33 0f 84 } //1
	condition:
...
rule VirTool_Win32_Obfuscator_PV_3{
	...
	strings :
		$a_03_0 = {33 c0 c2 08 0f (84|85) } //1
		$a_03_1 = {8b 45 fc 66 83 78 06 02 0f (84|85) } //1
		$a_01_2 = {bb 90 90 90 90 } //1
		$a_03_3 = {39 58 6f 0f (84|85) } //1
