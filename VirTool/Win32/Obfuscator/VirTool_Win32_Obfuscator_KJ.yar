...
rule VirTool_Win32_Obfuscator_KJ{
	...
	strings :
		...
		$a_03_1 = {c6 00 68 8b 0d 90 01 04 89 48 01 c6 40 05 c3 90 00 } //2
		$a_03_2 = {6a 40 68 00 30 00 00 8b 45 cc 8b 48 50 51 6a 00 ff 15 90 01 04 89 45 d4 8b 95 50 ff ff ff 8b 42 3c 8b 4d cc 0f b7 51 06 6b d2 28 8d 84 10 38 01 00 00 90 00 } //2
		$a_03_3 = {8d 4c 10 02 8b 15 90 01 04 03 55 f4 33 0a a1 90 01 04 03 45 f4 89 08 eb 90 00 } //1
