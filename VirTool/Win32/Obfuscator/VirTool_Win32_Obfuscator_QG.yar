...
rule VirTool_Win32_Obfuscator_QG_2{
	...
	condition:
		((#a_11_0  & 1)*1+(#a_68_1  & 1)*1536+(#a_01_2  & 1)*3255+(#a_33_3  & 1)*38628+(#a_73_4  & 1)*28530) >=5
