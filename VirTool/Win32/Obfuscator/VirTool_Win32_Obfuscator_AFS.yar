...
rule VirTool_Win32_Obfuscator_AFS{
	...
	strings :
		...
		$a_0b_3 = {66 83 38 00 74 14 8a 08 80 f9 61 7c 03 80 e9 20 c1 c9 08 90 01 05 eb e6 89 5c 24 1c 90 00 } //1
		$a_0b_4 = {89 c1 ff b5 e0 fd ff ff 90 02 06 67 3f 7a 90 02 06 81 fa 90 01 01 22 7a 3f 0f 84 90 02 15 75 2d 68 0f 84 90 01 02 00 00 90 02 04 fa 90 01 01 7b 23 66 90 00 } //1
	condition:
