...
rule VirTool_Win32_Obfuscator_AJG{
	...
	strings :
		...
		$a_03_1 = {c1 e1 04 8b 55 90 01 01 c1 ea 05 33 ca 03 4d 90 01 01 89 4d 90 01 01 8b 45 90 01 01 c1 e8 0b 83 e0 03 90 00 } //1
		$a_03_2 = {c1 e1 04 8b 55 90 01 01 c1 ea 05 33 ca 03 4d 90 01 01 8b 45 90 01 01 c1 e8 0b 83 e0 03 90 00 } //1
		$a_03_3 = {33 d2 b9 09 00 00 00 f7 f1 8b 54 95 90 01 01 52 68 04 01 00 00 68 90 01 04 e8 90 01 04 83 c4 10 85 c0 74 06 90 00 } //1
