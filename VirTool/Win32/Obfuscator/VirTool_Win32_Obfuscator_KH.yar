...
rule VirTool_Win32_Obfuscator_KH{
	...
	strings :
		...
		$a_03_1 = {03 5b 3c 8b 4b 54 81 c3 f8 00 00 00 90 03 03 04 8b 5b 14 ff 73 14 90 02 05 5b 0b db 75 02 90 00 } //1
		$a_03_2 = {68 c8 12 11 97 50 e8 90 01 04 ff d0 90 00 } //1
	condition:
