...
rule VirTool_Win32_Obfuscator_ABZ_2{
	...
	strings :
		...
		$a_03_1 = {51 ff 75 dc c7 85 90 01 01 fc ff ff 07 00 01 00 ff d0 85 c0 0f 88 90 00 } //1
		$a_03_2 = {8b 41 3c 03 45 fc 8d 90 01 01 08 f8 00 00 00 8b 90 01 01 0c 03 45 f8 89 45 cc 8b 90 01 01 08 90 00 } //1
		$a_03_3 = {2a 16 30 14 08 90 01 01 75 90 00 } //1
	condition:
