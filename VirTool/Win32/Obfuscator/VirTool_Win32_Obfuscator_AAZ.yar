...
rule VirTool_Win32_Obfuscator_AAZ{
	...
	strings :
		$a_03_0 = {c7 45 ec 38 e1 05 be 68 90 01 04 c7 45 f4 3b e1 05 be ff d7 83 f8 30 0f 8e 39 00 00 00 8b 35 90 01 04 6a 37 ff 35 90 01 04 ff d6 68 90 01 04 ff d7 90 00 } //10
