...
rule VirTool_Win32_Obfuscator_KE{
	...
	strings :
		...
		$a_03_2 = {c7 45 f0 01 00 00 00 90 09 1c 00 c7 45 e0 90 01 01 00 00 00 c7 45 e4 90 01 01 00 00 00 c7 45 e8 90 01 01 00 00 00 c7 45 ec 90 01 01 00 00 00 90 00 } //1
	condition:
