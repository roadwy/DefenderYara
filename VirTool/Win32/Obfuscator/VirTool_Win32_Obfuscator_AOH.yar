...
rule VirTool_Win32_Obfuscator_AOH{
	...
	strings :
		$a_03_0 = {66 81 fd 00 fd 90 13 89 ec 5d } //1
		$a_03_1 = {66 81 fd 00 fe 90 13 89 ec 5d } //1
	condition:
...
rule VirTool_Win32_Obfuscator_AOH_2{
	...
	strings :
		$a_03_0 = {8b f9 79 0c dd 05 ?? ?? ?? ?? dd 05 ?? ?? ?? ?? d9 c1 d8 e1 d8 c1 d8 c1 d8 c1 d8 e1 d8 c1 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
