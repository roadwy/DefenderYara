...
rule VirTool_Win32_Obfuscator_VP_2{
	...
	strings :
		...
		$a_03_3 = {8b f0 85 f6 74 21 56 ff 15 ?? ?? ?? ?? 83 f8 01 75 0e 6a 00 ff 15 ?? ?? ?? ?? 50 e8 de fe ff ff } //1
		$a_03_4 = {88 5d f8 c7 45 a8 30 00 00 00 c7 45 ac 03 00 00 00 c7 45 b0 ?? ?? ?? ?? 89 5d b4 89 5d b8 89 45 bc ff d7 } //1
		$a_03_5 = {8d 5f 15 89 4c 24 18 8d 44 24 08 50 8b 43 fc 03 44 24 18 6a 40 ff 33 50 ff 15 ?? ?? ?? ?? 83 f8 01 } //1
	condition:
