...
rule VirTool_Win32_Obfuscator_4{
	...
	strings :
		$a_03_0 = {83 c0 68 3e 8b 00 83 f8 70 74 90 09 06 00 64 a1 30 00 00 00 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule VirTool_Win32_Obfuscator_7{
	...
	strings :
		...
		$a_03_2 = {68 34 01 00 00 68 90 01 03 00 51 89 5d f4 ff d7 90 00 } //1
		$a_03_3 = {8d 46 01 83 f8 3e 88 9e 90 01 03 00 7d 19 ba 3e 00 00 00 2b d0 52 8d 88 90 01 03 00 6a 01 51 e8 90 01 04 83 c4 0c 90 00 } //1
		$a_03_4 = {00 40 49 3b c6 7c f2 90 09 07 00 8a 11 88 90 90 90 00 } //1
	condition:
...
rule VirTool_Win32_Obfuscator_8{
	...
	strings :
		...
		$a_00_7 = {53 00 6f 00 6c 00 64 00 69 00 65 00 72 00 73 00 20 00 2d 00 20 00 41 00 72 00 65 00 6e 00 61 00 } //65436 Soldiers - Arena
		$a_00_8 = {47 00 61 00 74 00 65 00 73 00 20 00 4f 00 66 00 20 00 48 00 65 00 6c 00 6c 00 } //65436 Gates Of Hell
		$a_00_9 = {50 00 72 00 6f 00 64 00 75 00 63 00 74 00 4e 00 61 00 6d 00 65 00 00 00 00 00 42 00 61 00 74 00 74 00 6c 00 65 00 20 00 6f 00 66 00 20 00 45 00 6d 00 70 00 69 00 72 00 65 00 73 00 } //65436
	condition:
		((#a_01_0  & 1)*1+(#a_01_1  & 1)*1+(#a_01_2  & 1)*1+(#a_01_3  & 1)*1+(#a_01_4  & 1)*1+(#a_01_5  & 1)*1+(#a_01_6  & 1)*1+(#a_00_7  & 1)*65436+(#a_00_8  & 1)*65436+(#a_00_9  & 1)*65436) >=2
