...
rule VirTool_Win32_Obfuscator_8{
	...
	strings :
		...
		$a_00_7 = {53 00 6f 00 6c 00 64 00 69 00 65 00 72 00 73 00 20 00 2d 00 20 00 41 00 72 00 65 00 6e 00 61 00 } //9c ff  Soldiers - Arena
		$a_00_8 = {47 00 61 00 74 00 65 00 73 00 20 00 4f 00 66 00 20 00 48 00 65 00 6c 00 6c 00 } //9c ff  Gates Of Hell
