...
rule VirTool_Win32_Obfuscator_HG{
	...
	strings :
		...
		$a_03_2 = {ac 3c 41 72 06 3c 5a 77 02 04 20 aa e2 f2 81 7d 90 01 01 6b 65 72 6e 75 c7 81 7d 90 01 01 65 6c 33 32 75 be 81 7d 90 01 01 2e 64 6c 6c 75 90 00 } //2
	condition:
