...
rule VirTool_Win32_Obfuscator_AFT{
	...
	strings :
		...
		$a_01_3 = {50 45 2d 50 41 43 4b 3a 20 49 4d 50 4f 52 54 20 4c 44 52 20 45 52 52 4f 52 00 } //05 00  䕐倭䍁㩋䤠偍剏⁔䑌⁒剅佒R
		$a_01_4 = {41 44 3a 5c 50 72 6f 79 65 63 74 6f 31 2e 76 62 70 00 } //00 00  䑁尺牐祯捥潴⸱扶p
	condition:
		any of ($a_*)
