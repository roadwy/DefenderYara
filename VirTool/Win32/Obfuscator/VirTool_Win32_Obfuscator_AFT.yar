...
rule VirTool_Win32_Obfuscator_AFT{
	...
	strings :
		...
		$a_03_1 = {c7 45 cc 01 00 00 00 c7 45 c4 02 00 00 00 ff 75 dc 8d 45 c4 50 ff 75 e8 ff 75 e0 e8 90 01 02 ff ff 8b d0 8d 4d d4 e8 90 01 02 ff ff 50 e8 90 01 02 ff ff 8b d0 8d 4d dc e8 90 01 02 ff ff 8d 4d d4 e8 90 01 02 ff ff 8d 4d c4 e8 90 01 02 ff ff 90 00 } //10
		$a_03_2 = {8b 45 e8 3b 45 ac 0f 8f 90 01 01 00 00 00 c7 45 cc 01 00 00 00 c7 45 c4 02 00 00 00 6a 01 90 00 } //10
