...
rule VirTool_Win32_Obfuscator_ZB{
	...
	strings :
		...
		$a_03_1 = {0e 00 00 01 8a 06 c7 05 90 01 04 0f 00 00 01 8a 1f c7 05 90 01 04 10 00 00 01 30 d8 c7 05 90 01 04 11 00 00 01 88 06 c7 05 90 01 04 12 00 00 01 90 00 } //1
