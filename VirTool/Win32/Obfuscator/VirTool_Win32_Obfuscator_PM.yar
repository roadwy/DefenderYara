...
rule VirTool_Win32_Obfuscator_PM{
	...
	strings :
		...
		$a_03_6 = {8b 45 08 8b 75 08 8a 0c 0e 88 0c 10 0f b6 90 01 02 2b 15 90 01 04 89 15 90 00 } //1
		$a_03_7 = {8b 55 e8 81 ea 01 08 00 00 89 55 f8 a1 90 01 04 3b 05 90 01 04 7d 90 00 } //1
		$a_03_8 = {0f b6 14 10 03 ca 88 4d 90 01 01 0f b6 45 90 01 01 8b 4d 08 8a 14 01 88 55 90 00 } //1
		$a_03_9 = {8a 02 88 01 8b 4d 08 03 4d 90 01 01 8a 55 90 01 01 88 11 8b 45 08 90 00 } //1
		$a_03_10 = {8b 55 0c 03 55 90 01 01 0f b6 02 8b 4d 08 03 4d 90 01 01 0f b6 11 33 d0 8b 45 08 90 00 } //1
		$a_03_11 = {78 38 42 4d 08 8a 14 01 88 55 90 01 01 0f b6 45 90 01 01 0f b6 4d 90 01 01 8b 55 08 8b 75 08 8a 04 06 90 00 } //1
		$a_03_12 = {8b 45 08 8b 75 08 8a 0c 0e 88 0c 10 0f b6 55 90 01 01 8b 45 08 8a 4d 90 01 01 88 0c 10 90 00 } //1
		$a_03_13 = {8b 45 08 0f b6 14 10 03 ca 88 4d 90 01 01 0f b6 45 90 01 01 8b 4d 08 90 00 } //1
		$a_03_14 = {8b 55 08 0f b6 0c 0a 03 c1 88 45 90 01 01 0f b6 55 90 01 01 8b 45 08 90 00 } //1
		$a_03_15 = {8b 4d 08 0f b6 04 01 03 d0 88 55 90 01 01 0f b6 4d 90 01 01 8b 55 08 90 00 } //1
