...
rule VirTool_Win32_Obfuscator_US{
	...
	strings :
		...
		$a_03_5 = {74 13 49 75 90 01 01 58 c1 e0 90 01 01 c1 e0 90 01 01 d1 e0 5e 90 00 } //1
		$a_03_6 = {0c 20 c1 c2 90 01 01 c1 c2 90 01 01 c1 ca 90 01 01 c1 c2 90 01 01 32 d0 90 00 } //1
	condition:
