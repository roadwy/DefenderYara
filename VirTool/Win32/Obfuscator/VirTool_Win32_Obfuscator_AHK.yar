...
rule VirTool_Win32_Obfuscator_AHK{
	...
	strings :
		...
		$a_03_2 = {59 5e 89 c7 f3 a4 8b 75 90 01 01 8d bb 90 01 04 29 f7 01 f8 ff e0 90 00 } //1
		$a_03_3 = {30 c0 fc f3 aa 8b 75 90 01 01 89 f2 03 56 3c 8d 82 f8 00 00 00 0f b7 4a 06 90 00 } //1
