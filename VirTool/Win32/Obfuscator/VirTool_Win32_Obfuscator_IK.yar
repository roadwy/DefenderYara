...
rule VirTool_Win32_Obfuscator_IK{
	...
	strings :
		...
		$a_03_1 = {8a 11 84 d2 74 08 0f be d2 83 c2 90 01 01 eb 02 33 d2 88 11 41 80 39 00 90 00 } //1
...
rule VirTool_Win32_Obfuscator_IK_2{
	...
	strings :
		...
		$a_03_3 = {8b 40 3c 01 c8 89 c2 8b 98 c0 00 00 00 85 db 60 0f 84 90 01 04 e8 15 00 00 00 54 6c 73 90 00 } //1
	condition:
