...
rule VirTool_Win32_Obfuscator_AEP{
	...
	strings :
		$a_03_0 = {68 00 00 00 00 68 90 01 02 40 00 e8 90 01 02 00 00 83 c4 0c 68 00 00 00 00 90 00 } //1
...
rule VirTool_Win32_Obfuscator_AEP_2{
	...
	strings :
		$a_03_0 = {33 ea 89 2c 90 01 01 83 c1 04 81 90 03 01 01 c2 ea 90 01 04 40 81 f9 90 01 04 7c 90 00 } //10
		$a_03_1 = {33 fa 89 3c 90 01 01 83 c1 04 81 90 03 01 01 c2 ea 90 01 04 40 81 f9 90 01 04 7c 90 00 } //2
	condition:
