...
rule VirTool_Win32_Obfuscator_ACW{
	...
	strings :
		$a_0b_0 = {68 22 07 e4 71 50 e8 90 01 02 00 00 89 85 90 01 02 ff ff 58 68 b6 74 75 5d 50 e8 90 01 02 00 00 89 85 90 01 02 ff ff b8 f4 1c 19 0f 50 57 e8 90 01 02 00 00 92 6a 00 90 02 02 ff d2 90 00 } //5
