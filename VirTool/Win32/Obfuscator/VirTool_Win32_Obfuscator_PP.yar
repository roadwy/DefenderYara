...
rule VirTool_Win32_Obfuscator_PP{
	...
	strings :
		...
		$a_02_1 = {8d 7e 01 57 56 8d 4e ff 51 8d 56 fe 52 8d 4e fd 51 8d 56 fc 52 8d 4e fb 51 83 c6 fa 56 ff d0 3c 05 74 90 01 01 8d 54 24 14 52 8b f7 ff d3 68 90 01 04 50 ff d5 eb 90 00 } //1
	condition:
