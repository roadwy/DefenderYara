...
rule VirTool_Win32_Obfuscator_ZO{
	...
	strings :
		...
		$a_03_1 = {c1 e3 10 b9 ff ff 00 00 53 e8 90 01 04 3d 90 01 04 75 06 89 9d 54 fd ff ff 43 e2 ea 61 83 bd 54 fd ff ff 00 0f 84 aa 00 00 00 b9 00 24 00 00 c1 e9 02 90 00 } //1
	condition:
