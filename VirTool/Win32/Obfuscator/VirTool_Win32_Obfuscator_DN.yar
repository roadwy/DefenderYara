...
rule VirTool_Win32_Obfuscator_DN{
	...
	strings :
		$a_03_0 = {58 ff d0 40 e8 00 00 00 00 2d ?? ?? ?? ?? 01 04 24 ff 14 24 2d ?? ?? ?? ?? 83 7d f4 00 75 05 } //3
		$a_03_1 = {58 ff d0 40 e8 00 00 00 00 2d ?? ?? ?? ?? 01 04 24 8b 04 24 ff d0 2d ?? ?? ?? ?? 83 7d f4 00 75 05 } //3
