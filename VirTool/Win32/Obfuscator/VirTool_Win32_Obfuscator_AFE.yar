...
rule VirTool_Win32_Obfuscator_AFE{
	...
	strings :
		...
		$a_03_2 = {c6 02 e9 b9 90 01 04 a1 90 01 04 2b c8 83 e9 05 89 48 01 68 90 00 } //10
		$a_03_3 = {ff d6 50 ff d7 8d 55 90 01 01 52 ff d0 90 00 } //10
		$a_03_4 = {c6 00 e9 b9 90 01 03 00 a1 90 01 03 00 2b c8 83 e9 05 89 48 01 90 00 } //10
