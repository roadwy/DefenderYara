...
rule VirTool_Win32_Obfuscator_ANA{
	...
	strings :
		...
		$a_03_2 = {83 7d 0c 01 0f 84 90 01 02 00 00 83 7d 0c 02 0f 84 90 01 02 00 00 81 7d 0c 13 01 00 00 0f 84 90 01 02 00 00 83 7d 0c 05 0f 84 90 01 02 00 00 81 7d 0c 95 05 00 00 90 00 } //1
	condition:
