...
rule VirTool_Win32_Obfuscator_AJH{
	...
	strings :
		...
		$a_0b_3 = {66 83 38 00 74 90 01 01 8a 08 80 f9 61 7c 90 01 01 80 e9 20 90 02 01 c1 c9 08 90 00 } //1
		$a_0b_4 = {81 ea 22 67 3f 7a 5a 0f 84 90 01 02 00 00 52 81 ea 67 22 7a 3f 5a 0f 84 90 02 08 81 fa 28 6d 35 70 90 00 } //1
	condition:
