...
rule VirTool_Win32_Obfuscator_ZAI_bit{
	...
	strings :
		$a_03_0 = {03 d0 03 c3 8a 0c 1a 88 0c 30 60 8b 4d 08 8a 45 ff d3 e3 33 db 0b 1d 90 01 04 03 d9 8a 33 90 90 c1 ea 08 90 90 33 c2 88 03 90 90 61 8b 45 08 40 3d 90 01 04 89 45 08 90 00 } //1
