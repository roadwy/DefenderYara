...
rule VirTool_Win32_Obfuscator_VV{
	...
	strings :
		$a_01_0 = {4f 67 6f 78 75 5c 65 72 61 6c 79 67 61 2e 70 64 62 } //01 00  Ogoxu\eralyga.pdb
		$a_01_1 = {58 75 62 69 71 79 7a 5c 59 6c 61 6d 65 2e 70 64 62 } //01 00  Xubiqyz\Ylame.pdb
		$a_01_2 = {4e 69 7a 65 6c 5c 6f 68 75 77 61 68 2e 70 64 62 } //01 00  Nizel\ohuwah.pdb
		$a_01_3 = {4e 69 6b 6f 62 5c 4b 65 78 61 2e 70 64 62 } //01 00  Nikob\Kexa.pdb
