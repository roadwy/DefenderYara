...
rule VirTool_Win32_Obfuscator_PK{
	...
	strings :
		$a_03_0 = {89 4d f4 c7 45 fc 00 00 00 00 eb 09 8b 55 fc 83 c2 08 89 55 fc 81 7d fc 90 01 02 00 00 0f 83 90 00 } //1
...
rule VirTool_Win32_Obfuscator_PK_2{
	...
	strings :
		$a_03_0 = {81 ff 00 20 00 00 0f 82 90 16 c6 85 e5 fd ff ff 00 90 00 } //1
		$a_03_1 = {8d 44 95 e4 90 02 10 8b 08 90 00 } //1
		$a_01_2 = {ff 74 b5 e4 } //1
		$a_03_3 = {39 08 0f 84 90 01 02 00 00 90 02 10 8b d8 8b 03 90 02 10 8a 04 90 00 } //1
	condition:
...
rule VirTool_Win32_Obfuscator_PK_3{
	...
	strings :
		...
		$a_03_2 = {03 c1 8b 0d 90 01 02 40 00 8b 49 08 ff 31 ff d0 90 00 } //1
		$a_03_3 = {48 8a 0c 30 90 02 20 80 e9 90 01 01 d0 c9 88 0c 30 3b c3 0f 85 90 16 48 8a 90 00 } //1
	condition:
