...
rule VirTool_Win32_Obfuscator_ABN{
	...
	strings :
		$a_03_0 = {8b 88 a4 00 00 00 83 f9 05 77 90 01 01 83 b8 a8 00 00 00 02 90 09 05 00 a1 90 00 } //1
		$a_03_1 = {8d 4d f4 51 ff 75 fc ff 75 cc 57 ff 75 c8 6a 02 ff d0 85 c0 78 90 01 01 83 7d f4 00 90 00 } //1
