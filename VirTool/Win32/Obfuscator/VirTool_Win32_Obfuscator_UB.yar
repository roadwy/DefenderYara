...
rule VirTool_Win32_Obfuscator_UB{
	...
	strings :
		$a_03_0 = {83 e8 03 68 ?? ?? 40 00 48 ff d0 } //1
		$a_03_1 = {83 e8 03 68 ?? ?? 40 00 68 ?? ?? 40 00 48 ff d0 } //1
		$a_03_2 = {83 e8 03 68 ?? ?? 40 00 68 ?? ?? 40 00 68 ?? ?? 40 00 48 ff d0 } //1
		$a_03_3 = {83 e8 03 68 ?? ?? 40 00 68 ?? ?? 40 00 68 ?? ?? 40 00 68 ?? ?? 40 00 48 ff d0 } //1
