...
rule VirTool_Win32_Obfuscator_AEO{
	...
	strings :
		$a_03_0 = {55 53 ff 35 90 90 d4 40 00 68 90 01 02 40 00 e8 41 11 00 00 8b 2d 50 ae 40 00 8d 45 00 50 e8 f3 68 00 00 ff 35 90 90 d4 40 00 68 90 01 02 40 00 90 00 } //1
