...
rule VirTool_Win32_Obfuscator_AK{
	...
	strings :
		...
		$a_03_1 = {ff 36 ff 93 90 01 02 00 00 89 c7 83 c6 04 8b 0e 83 c6 04 8b 06 09 c0 74 09 50 57 e8 90 01 02 ff ff 89 06 83 c6 04 e2 ec eb d2 61 90 00 } //1
		$a_02_2 = {8b 7d 08 0f b6 1f 09 db 74 0c f7 e3 d1 e0 35 90 01 04 47 eb ed 89 45 fc 61 8b 45 fc 90 00 } //1
	condition:
