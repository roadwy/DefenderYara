...
rule VirTool_Win32_Obfuscator_CE{
	...
	strings :
		...
		$a_00_2 = {56 69 72 74 75 61 6c 41 6c 6c 6f 63 45 78 } //01 00 
		$a_00_3 = {56 69 72 74 75 61 6c 50 72 6f 74 65 63 74 45 78 } //01 00 
		$a_00_4 = {5a 77 55 6e 6d 61 70 56 69 65 77 4f 66 53 65 63 74 69 6f 6e } //01 00 
