...
rule VirTool_Win32_Obfuscator_Q{
	...
	strings :
		...
		$a_00_4 = {68 2e 64 6c 6c 68 65 6c 33 32 68 6b 65 72 6e 54 } //0a 00 
		$a_00_5 = {68 65 4f 62 6a 68 69 6e 67 6c 68 46 6f 72 53 68 57 61 69 74 54 50 } //0a 00 
		$a_00_6 = {68 65 4e 61 6d 68 65 46 69 6c 68 6f 64 75 6c 68 47 65 74 4d 54 57 } //0a 00 
		$a_00_7 = {68 64 6c 65 45 68 65 48 61 6e 68 6f 64 75 6c 68 47 65 74 4d 54 57 } //0a 00 
		$a_00_8 = {68 6c 6c 6f 63 68 75 61 6c 41 68 56 69 72 74 54 50 } //0a 00 
		$a_00_9 = {68 64 50 74 72 68 64 52 65 61 68 49 73 42 61 54 57 } //00 00 
	condition:
		any of ($a_*)
