...
rule VirTool_Win32_Obfuscator_ALB{
	...
	strings :
		$a_03_0 = {66 66 2e 0f 1f 84 00 00 00 00 00 55 89 e5 83 ec 90 02 08 e8 90 01 01 ff ff ff 90 02 15 8b 40 30 83 c4 90 01 01 5d c3 90 02 05 0f 1f 90 00 } //5
		$a_03_1 = {66 66 2e 0f 1f 84 00 00 00 00 00 55 89 e5 90 02 03 81 e4 90 01 01 ff ff ff 90 03 01 01 81 83 ec 90 00 } //5
