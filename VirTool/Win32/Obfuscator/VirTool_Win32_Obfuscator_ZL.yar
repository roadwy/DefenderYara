...
rule VirTool_Win32_Obfuscator_ZL{
	...
	strings :
		...
		$a_03_1 = {04 30 32 c2 34 79 88 83 90 01 04 33 d2 8b c3 b9 03 00 00 00 f7 f1 85 d2 74 90 00 } //1
		...
		$a_03_5 = {8b c2 c1 e8 10 c1 e0 08 90 02 12 c1 e8 10 32 d0 90 00 } //1
		$a_01_6 = {8b d6 c1 ea 10 c1 e2 08 c1 ea 10 32 d3 } //1
		$a_01_7 = {8b d6 c1 ea 10 c1 e2 08 c1 ea 10 32 d1 } //1
		$a_03_8 = {b9 89 d7 00 00 be 90 02 06 f3 a5 66 a5 90 02 03 a4 90 00 } //1
		$a_03_9 = {b9 89 8f 00 00 be 90 02 06 f3 a5 66 a5 90 02 03 a4 90 00 } //1
		$a_03_10 = {b9 89 53 00 00 be 90 02 06 f3 a5 66 a5 90 02 03 a4 90 00 } //1
		$a_03_11 = {b9 09 56 00 00 be 90 02 06 f3 a5 66 a5 90 02 03 a4 90 00 } //1
		$a_03_12 = {b9 89 10 00 00 be 90 02 06 f3 a5 66 a5 90 02 03 a4 90 00 } //1
		$a_03_13 = {b9 89 d4 00 00 be 90 02 06 f3 a5 66 a5 90 02 03 a4 90 00 } //1
