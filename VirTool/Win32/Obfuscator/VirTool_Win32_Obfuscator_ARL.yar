...
rule VirTool_Win32_Obfuscator_ARL{
	...
	strings :
		$a_03_0 = {e2 f5 8b 45 90 01 01 80 38 8b 75 01 c3 e8 90 01 04 5f 83 c7 0d 57 53 ff 55 08 90 00 } //2
		...
		$a_03_3 = {8b 09 33 c0 39 41 90 01 01 74 f7 ff 71 90 01 01 8f 45 90 01 01 e8 90 01 04 8f 41 1c 61 c3 58 ff d0 83 7c 24 08 02 90 00 } //1
