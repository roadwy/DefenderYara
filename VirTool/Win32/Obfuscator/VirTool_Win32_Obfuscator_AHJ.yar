...
rule VirTool_Win32_Obfuscator_AHJ{
	...
	strings :
		$a_00_0 = {45 78 70 6f 72 74 65 64 4d 61 69 6e 46 75 6e 63 74 69 6f 6e } //01 00 
		$a_00_1 = {46 6c 75 65 74 65 72 6d 41 6d 79 6c 52 65 65 66 6f 6e 75 73 4d 75 6d 70 73 63 61 64 } //01 00 
		$a_00_2 = {47 6f 62 79 63 72 6f 77 73 6d 75 67 4f 76 61 6c 42 61 68 74 4d 6f 6d 73 } //01 00 
		$a_00_3 = {4a 6f 6b 65 53 70 65 77 6c 65 61 73 6f 61 74 6d 6d } //02 00 
