...
rule VirTool_Win32_Obfuscator_APM{
	...
	strings :
		$a_03_0 = {8b cf 83 c1 [74-76] [0-18] 6a 14 [0-04] 8b 04 30 03 c7 8b f8 90 04 01 03 5[] } //5
...
rule VirTool_Win32_Obfuscator_APM_2{
	...
	strings :
		$a_03_0 = {73 16 8d 45 9c [0-18] eb d9 8b ?? 9c ff 90 17 02 02 01 65 9c e2 c7 45 c8 00 00 00 00 8b 4d fc 51 e8 ?? ?? ff ff 5f 5e 5b 8b e5 5d c2 04 00 55 8b ec a1 ?? ?? 40 00 5d } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule VirTool_Win32_Obfuscator_APM_3{
	...
	strings :
		$a_03_0 = {8b cf 83 c1 77 [0-18] 03 f8 8b 46 14 } //5
		$a_03_1 = {f3 33 c2 5a 47 [0-18] e2 [18-38] [0-40] ad 4e 4e 4e 75 } //1
		$a_03_2 = {54 5f 41 89 07 51 58 [0-10] 8b 06 03 f2 89 07 03 fa e2 f6 } //1
	condition:
...
rule VirTool_Win32_Obfuscator_APM_4{
	...
	strings :
		$a_03_0 = {8b cf 41 83 c1 76 [0-18] 03 f8 8b 46 14 } //5
		$a_03_1 = {8b cf 41 83 c1 [74-76] [0-18] 6a 14 8b 04 31 03 c7 8b f8 58 8b 04 30 } //5
		$a_01_2 = {41 8b 06 fe c0 46 fe c8 75 f6 } //1
		$a_03_3 = {8b c8 41 8b 06 46 3c 00 75 f8 49 89 4d ?? 8b c1 0f 85 } //1
	condition:
...
rule VirTool_Win32_Obfuscator_APM_5{
	...
	strings :
		...
		$a_03_2 = {47 8b 47 3b 4a 4f 23 c2 [0-18] 83 c1 77 03 c1 8b 00 5e 8b fe 03 f0 59 [0-20] 8b 04 31 03 f8 8b 46 14 } //1
	condition:
