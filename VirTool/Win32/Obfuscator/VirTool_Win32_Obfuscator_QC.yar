...
rule VirTool_Win32_Obfuscator_QC{
	...
	strings :
		$a_03_0 = {eb 0a 80 f1 90 01 01 80 90 03 01 01 c1 e9 90 01 01 88 08 40 42 8a 0a 84 c9 90 00 } //1
		$a_03_1 = {6a 00 6a 14 8d 4d 90 01 01 51 ff d0 90 03 01 01 eb e9 90 00 } //1
