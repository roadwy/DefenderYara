...
rule VirTool_Win32_Obfuscator_WQ{
	...
	strings :
		...
		$a_ac_2 = {00 5d 04 00 00 69 9d 02 80 5c 22 00 00 6b 9d 02 80 00 00 01 00 1e 00 0c 00 d0 21 50 64 66 6a 73 63 2e 41 41 56 00 00 01 40 05 82 59 00 04 00 28 0e 00 00 00 22 2a c0 c3 03 e3 9e 28 4e 50 03 00 00 5d 04 00 00 6b 9d 02 80 5c 28 00 00 } //35072
	condition:
		((#a_11_0  & 1)*5+(#a_89_1  & 1)*2560+(#a_ac_2  & 1)*35072) >=7
