...
rule VirTool_Win32_PsDnsTxtExec_B_MTB{
	...
	strings :
		...
		$a_02_1 = {70 00 6f 00 77 00 65 00 72 00 73 00 68 00 65 00 6c 00 6c 00 90 02 10 28 00 6e 00 73 00 6c 00 6f 00 6f 00 6b 00 75 00 70 00 90 02 08 20 00 2d 00 71 00 3d 00 74 00 78 00 74 00 20 00 90 02 40 29 00 5b 00 2d 00 31 00 5d 00 90 00 } //1
	condition:
