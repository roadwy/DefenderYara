...
rule VirTool_Win32_Hacty_gen_C{
	...
	strings :
		...
		$a_01_9 = {5a 46 4a 5f 52 4f 4f 54 4b 49 54 } //01 00 
		$a_01_10 = {5a 77 51 75 65 72 79 44 69 72 65 63 74 6f 72 79 46 69 6c 65 } //01 00 
		$a_01_11 = {5a 77 51 75 65 72 79 53 79 73 74 65 6d 49 6e 66 6f 72 6d 61 74 69 6f 6e } //01 00 
		$a_01_12 = {5a 77 44 65 76 69 63 65 49 6f 43 6f 6e 74 72 6f 6c 46 69 6c 65 } //00 00 
	condition:
		any of ($a_*)
