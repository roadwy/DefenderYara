...
rule VirTool_Win32_Rootkitdrv_BS{
	...
	strings :
		$a_03_0 = {89 48 78 c7 40 34 00 90 01 01 01 00 e8 90 01 02 00 00 33 c0 c2 08 00 fa 0f 20 c0 25 ff ff fe ff 0f 22 c0 c3 90 02 06 0f 20 c0 0d 00 00 01 00 0f 22 c0 fb c3 90 00 } //1
