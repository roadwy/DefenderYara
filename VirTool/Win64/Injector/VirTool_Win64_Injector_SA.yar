...
rule VirTool_Win64_Injector_SA{
	...
	strings :
		$a_03_0 = {b8 6b 00 00 00 66 89 84 24 90 01 01 01 00 00 b8 65 00 00 00 66 89 84 24 90 01 01 01 00 00 b8 72 00 00 00 66 89 84 24 90 01 01 01 00 00 b8 6e 00 00 00 90 00 } //3
		$a_01_1 = {66 00 00 00 c7 44 24 48 0c 09 3d 00 } //2
		$a_03_2 = {48 c7 84 24 90 01 01 01 00 00 00 00 00 00 48 c7 84 24 90 01 01 01 00 00 00 00 00 00 48 c7 84 24 90 01 01 01 00 00 00 00 00 00 c6 44 24 70 90 00 } //1
