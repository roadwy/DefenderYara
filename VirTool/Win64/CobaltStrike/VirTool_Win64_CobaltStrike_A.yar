...
rule VirTool_Win64_CobaltStrike_A{
	meta:
		description = "VirTool:Win64/CobaltStrike.A,SIGNATURE_TYPE_PEHSTR_EXT,04 00 04 00 03 00 00 02 00 "
		
	strings :
		$a_01_0 = {41 8b 10 41 8b 40 04 4d 8d 40 08 85 d2 75 04 } //02 00 
		$a_01_1 = {45 8b 0a 41 8b 42 04 4d 8d 52 08 45 85 c9 } //02 00 
		$a_01_2 = {2b c1 4c 8b c1 44 8b c8 48 8b 0b 8a 43 10 42 30 04 01 49 ff c0 49 ff c9 75 ee } //00 00 
		$a_00_3 = {78 71 } //00 00 
	condition:
		any of ($a_*)
...
rule VirTool_Win64_CobaltStrike_A_2{
	meta:
		description = "VirTool:Win64/CobaltStrike.A,SIGNATURE_TYPE_PEHSTR_EXT,02 00 02 00 02 00 00 01 00 "
		
	strings :
		$a_01_0 = {f0 e8 c8 00 00 00 41 51 41 50 52 51 56 48 31 d2 65 48 8b 52 60 48 8b 52 18 48 8b 52 20 48 8b 72 50 48 0f b7 4a 4a } //01 00 
		$a_01_1 = {e9 4f ff ff ff 5d 6a 00 49 be 77 69 6e 69 6e 65 74 00 41 56 49 89 e6 4c 89 f1 41 ba 4c 77 26 07 ff d5 48 31 c9 48 31 d2 4d 31 c0 4d 31 c9 41 50 41 50 41 ba 3a 56 79 a7 ff d5 } //01 00 
	condition:
		any of ($a_*)
...
rule VirTool_Win64_CobaltStrike_A_3{
	meta:
		description = "VirTool:Win64/CobaltStrike.A,SIGNATURE_TYPE_PEHSTR_EXT,05 00 05 00 05 00 00 01 00 "
