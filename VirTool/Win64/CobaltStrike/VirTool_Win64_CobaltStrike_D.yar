...
rule VirTool_Win64_CobaltStrike_D_2{
	...
	strings :
		...
		$a_01_2 = {25 63 25 63 25 63 25 63 25 63 25 63 25 63 25 63 25 63 4d 53 53 45 2d 25 64 2d 73 65 72 76 65 72 } //01 00  %c%c%c%c%c%c%c%c%cMSSE-%d-server
	condition:
		any of ($a_*)
...
rule VirTool_Win64_CobaltStrike_D_3{
	...
	strings :
		...
		$a_01_3 = {25 63 25 63 25 63 25 63 25 63 25 63 25 63 25 63 25 63 4d 53 53 45 2d 25 64 2d 73 65 72 76 65 72 } //01 00  %c%c%c%c%c%c%c%c%cMSSE-%d-server
