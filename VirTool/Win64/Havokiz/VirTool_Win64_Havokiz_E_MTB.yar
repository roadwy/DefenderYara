...
rule VirTool_Win64_Havokiz_E_MTB{
	...
	strings :
		...
		$a_03_3 = {48 89 74 24 78 48 ?? ?? ?? ?? 45 31 c0 48 89 d9 c7 44 24 28 40 00 00 00 48 ?? ?? ?? ?? 49 89 f1 c7 44 24 20 00 30 00 00 e8 ?? ?? ?? ?? 85 c0 0f 88 df 00 00 00 4c 8b 4c 24 78 48 8b 54 24 70 49 89 f8 48 89 d9 48 c7 44 24 20 00 00 00 00 e8 ?? ?? ?? ?? 85 c0 0f 88 } //1
	condition:
