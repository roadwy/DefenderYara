...
rule VirTool_Win64_Alanloader_A{
	...
	strings :
		$a_02_0 = {48 33 db ac 84 c0 ?? ?? c1 cf 13 3c 61 48 0f 4d da 2a c3 48 0f b6 c0 03 f8 } //1
		$a_02_1 = {48 0f b7 0b 48 03 f9 fd 48 33 c0 b0 5c 48 8b f7 f2 ae fc ?? ?? ?? 48 83 c7 02 48 2b f7 48 8b d6 48 8b cf } //1
