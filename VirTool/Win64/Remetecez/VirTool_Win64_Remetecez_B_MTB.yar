...
rule VirTool_Win64_Remetecez_B_MTB{
	...
	strings :
		...
		$a_03_1 = {48 bb bb bb bb bb bb bb bb bb 48 b9 cc cc cc cc cc cc cc cc 48 89 0b 48 83 ec 50 48 89 d9 48 c7 c2 00 04 00 00 41 b8 02 00 00 00 ?? ?? ?? ?? ?? 48 b8 bb bb bb bb bb bb bb bb ?? ?? ?? ?? ?? ?? ?? 48 83 c4 50 } //1
	condition:
