...
rule VirTool_Win64_Luidek_A_MTB{
	...
	strings :
		...
		$a_81_1 = {6c 75 70 6f 2f 6c 75 70 6f 2d 63 6c 69 65 6e 74 2f 63 6d 64 2e 52 65 73 70 6f 6e 73 65 } //01 00 
		$a_81_2 = {6c 75 70 6f 2f 6c 75 70 6f 2d 63 6c 69 65 6e 74 2f 63 6f 72 65 } //01 00 
		$a_81_3 = {6c 75 70 6f 2d 73 65 72 76 65 72 2f 63 6f 72 65 2e 53 65 73 73 69 6f 6e 73 } //00 00 
	condition:
		any of ($a_*)
