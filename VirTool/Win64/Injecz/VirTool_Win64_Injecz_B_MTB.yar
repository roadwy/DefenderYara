...
rule VirTool_Win64_Injecz_B_MTB{
	...
	strings :
		$a_02_0 = {48 89 b4 24 40 01 00 00 48 8b b4 24 b8 00 00 00 48 89 b4 24 48 01 00 00 bb 02 00 00 00 48 89 d9 48 8d ?? ?? ?? ?? ?? ?? e8 ?? ?? ?? ?? 48 8d ?? ?? ?? ?? ?? bb 0b 00 00 00 66 ?? e8 fb ?? ?? ?? 89 44 24 3c 48 85 db } //1
