...
rule VirTool_Win64_AccessMe_A_MTB{
	...
	strings :
		$a_02_0 = {ff d0 89 85 90 01 03 00 b9 e8 03 00 00 48 8b 05 90 01 03 00 ff d0 48 8b 05 90 01 03 00 ff d0 90 00 } //2
		$a_02_1 = {48 8d 70 01 48 89 f1 e8 90 01 02 00 00 49 89 f0 48 89 44 dd 00 48 8b 14 df 48 89 c1 e8 90 01 02 00 00 90 00 } //2
