...
rule VirTool_Win64_Obfuscator_A{
	...
	strings :
		...
		$a_06_2 = {48 83 ee 28 00 00 5d 04 00 00 1e 83 02 80 5c 1f 00 00 1f 83 02 80 00 00 01 00 27 00 09 00 c8 21 4c 61 71 6d 61 2e 43 00 00 03 40 05 82 5f 00 04 00 40 45 00 00 04 00 01 03 00 00 00 00 00 4a 30 00 0a c6 34 52 af 00 00 00 00 02 00 00 00 08 30 } //00 1e 
	condition:
		any of ($a_*)
