...
rule VirTool_Win64_CeeInject_BAC_bit{
	...
	strings :
		$a_03_0 = {8b 45 fc 48 63 d0 48 8b 45 f0 48 8d 1c 02 8b 45 fc 48 63 d0 48 8b 45 20 48 01 d0 0f b6 30 48 8b 45 28 48 89 c1 48 8b 05 90 01 04 ff d0 89 c1 8b 45 fc 99 f7 f9 89 d0 48 63 d0 90 00 } //1
