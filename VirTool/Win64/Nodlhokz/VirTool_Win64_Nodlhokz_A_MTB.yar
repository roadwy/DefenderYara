...
rule VirTool_Win64_Nodlhokz_A_MTB{
	...
	strings :
		...
		$a_02_1 = {41 b8 ef be ad de 48 8d 90 01 05 33 c9 ff 90 01 01 48 8d 90 01 05 e8 90 00 } //1
		$a_02_2 = {49 c1 e0 04 4c 03 90 01 05 4d 8b 08 4d 8b 40 08 48 ff 90 00 } //1
		$a_00_3 = {4c 8b c6 48 8b d5 8b cb ff } //1
		$a_02_4 = {48 c1 e7 05 ff 15 90 01 04 4c 8b 90 01 05 4c 8b cf 48 8b c8 33 d2 ff 90 00 } //1
	condition:
