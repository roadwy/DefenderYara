...
rule VirTool_Win64_Meteremulaprz_A_MTB{
	...
	strings :
		$a_02_0 = {48 81 ec 78 01 00 00 48 c7 84 24 58 01 00 00 00 00 00 00 48 c7 84 24 68 01 00 00 00 00 00 00 c7 84 24 60 01 00 00 00 00 00 00 e8 90 01 04 85 c0 90 00 } //1
		$a_02_1 = {48 89 44 24 38 48 c7 44 24 28 00 00 00 00 b9 90 01 04 e8 90 01 04 48 89 44 24 28 90 00 } //1
		$a_02_2 = {8b 84 24 50 01 00 00 4c 8d 90 01 06 41 b8 20 00 00 00 8b d0 48 8b 8c 24 58 01 00 00 ff 90 00 } //1
