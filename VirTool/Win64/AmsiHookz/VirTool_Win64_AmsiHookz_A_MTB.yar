...
rule VirTool_Win64_AmsiHookz_A_MTB{
	...
	strings :
		...
		$a_02_2 = {48 8b 44 24 68 48 89 44 24 28 48 8b 44 24 60 48 89 44 24 20 4c 8b 4c 24 58 44 8b 44 24 50 48 8d ?? ?? ?? ?? ?? 48 8b 4c 24 40 ff 15 ?? ?? ?? ?? 48 83 c4 38 c3 } //1
		$a_02_3 = {83 7c 24 48 01 75 ?? ff 15 ?? ?? ?? ?? b9 01 00 00 00 } //1
	condition:
