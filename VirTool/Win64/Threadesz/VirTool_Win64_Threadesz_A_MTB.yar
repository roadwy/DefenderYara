...
rule VirTool_Win64_Threadesz_A_MTB{
	...
	strings :
		$a_03_0 = {48 8b d5 e8 ?? ?? ?? ?? 4d 8b cc 66 0f 7f 74 24 40 4c ?? ?? ?? ?? 4c ?? ?? ?? ?? 48 8b d3 48 8b ce e8 ?? ?? ?? ?? 48 8b d5 85 c0 75 } //1
		...
		$a_03_2 = {4c 8b 45 8f 48 ?? ?? ?? 48 ?? ?? ?? 48 89 44 24 20 4d 8b ce 48 8b ce ff 15 ?? ?? ?? ?? 85 c0 74 } //1
		$a_03_3 = {48 8b e8 48 85 c0 0f 84 16 01 00 00 48 89 5c 24 30 89 5c 24 28 89 5c 24 20 45 33 c9 45 33 c0 33 d2 48 8b c8 ff 15 ?? ?? ?? ?? 44 8b f8 85 c0 0f 84 } //1
	condition:
