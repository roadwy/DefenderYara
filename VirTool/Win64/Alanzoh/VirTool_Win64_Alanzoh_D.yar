...
rule VirTool_Win64_Alanzoh_D{
	...
	strings :
		...
		$a_02_1 = {c7 84 24 c0 00 00 00 18 00 00 00 c7 84 24 d0 00 00 00 01 00 00 00 48 c7 84 24 c8 00 00 00 00 00 00 00 0f 29 b4 24 40 03 00 00 48 8d 90 01 06 48 8d 90 01 06 4c 8d 90 01 06 45 31 c9 ff 15 90 00 } //1
	condition:
