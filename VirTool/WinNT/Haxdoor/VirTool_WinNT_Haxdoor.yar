...
rule VirTool_WinNT_Haxdoor{
	...
	strings :
		$a_03_0 = {45 0c c7 40 18 00 00 00 00 90 02 01 83 60 1c 00 90 02 01 6a 00 ff 75 0c e8 90 01 01 03 00 00 83 c4 08 90 02 01 b8 00 00 00 00 c9 c2 08 00 90 00 } //10
		$a_03_1 = {e8 4e 03 00 00 59 90 90 3b c8 75 90 03 01 01 22 23 68 c4 09 01 00 68 f4 09 01 00 e8 3f 03 00 00 8b 4d 08 90 02 01 c7 41 38 e1 01 01 00 60 e8 48 00 00 00 90 00 } //10
