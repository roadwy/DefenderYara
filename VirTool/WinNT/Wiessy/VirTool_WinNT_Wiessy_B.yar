...
rule VirTool_WinNT_Wiessy_B{
	...
	strings :
		...
		$a_01_2 = {5c 44 65 76 69 63 65 5c 48 61 72 64 64 69 73 6b 30 5c 44 52 30 00 } //01 00 
		$a_01_3 = {5c 44 6f 73 44 65 76 69 63 65 73 5c 45 43 61 74 44 69 73 6b 31 00 } //01 00 
		$a_01_4 = {5c 44 65 76 69 63 65 5c 45 43 61 74 44 69 73 6b 30 00 } //00 00 
	condition:
		any of ($a_*)
