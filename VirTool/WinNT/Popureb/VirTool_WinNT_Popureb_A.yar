...
rule VirTool_WinNT_Popureb_A{
	...
	strings :
		...
		$a_03_2 = {01 00 00 0f 83 90 01 04 68 00 02 00 00 90 09 04 00 81 7d 90 01 01 90 90 90 00 } //1
		$a_03_3 = {83 fa 2a 75 10 8b 45 90 01 01 c7 40 0c 40 00 00 00 8b 4d 90 01 01 c6 01 28 90 00 } //2
	condition:
