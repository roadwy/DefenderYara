...
rule VirTool_WinNT_Emold_gen_A{
	...
	strings :
		...
		$a_02_4 = {8b 45 fc 0f b7 08 8b c1 66 25 00 f0 66 3d 00 30 75 90 01 01 81 e1 ff 0f 00 00 03 0e 8b 04 19 03 c2 90 00 } //1
		$a_02_5 = {fa 0f 20 c0 8b c0 89 45 90 01 01 8b db 25 ff ff fe ff 0f 22 c0 8b 45 90 01 01 8b 55 90 01 01 8b db f0 90 00 } //1
		$a_02_6 = {25 ff ff fe ff 0f 22 c0 8b 45 90 01 01 8b 55 90 01 03 f0 87 10 90 01 02 8b 45 90 01 01 0f 22 c0 fb 90 00 } //1
	condition:
