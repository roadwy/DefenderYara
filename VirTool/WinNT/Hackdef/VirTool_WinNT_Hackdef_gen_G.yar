...
rule VirTool_WinNT_Hackdef_gen_G{
	...
	strings :
		...
		$a_00_1 = {5c 00 44 00 65 00 76 00 69 00 63 00 65 00 5c 00 62 00 63 00 6f 00 6e 00 75 00 73 00 62 00 } //01 00 
		$a_00_2 = {5c 00 44 00 6f 00 73 00 44 00 65 00 76 00 69 00 63 00 65 00 73 00 5c 00 62 00 63 00 6f 00 6e 00 75 00 73 00 62 00 } //00 00 
	condition:
		any of ($a_*)
