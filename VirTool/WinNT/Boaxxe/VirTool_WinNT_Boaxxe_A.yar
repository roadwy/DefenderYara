...
rule VirTool_WinNT_Boaxxe_A{
	...
	strings :
		$a_02_0 = {3b c6 0f 8c ?? 02 00 00 8b 85 ?? ?? ff ff 8b 15 ?? ?? 01 00 8b 0d ?? ?? 01 00 89 85 ?? ?? ff ff 89 85 ?? ?? ff ff a1 } //2
		$a_02_1 = {89 85 94 fa ff ff 75 07 33 c0 e9 ?? 03 00 00 33 c0 6a 32 b9 00 01 00 00 8d bd 9c fa ff ff f3 ab 59 6a } //2
