...
rule VirTool_WinNT_Sedise_A{
	...
	strings :
		...
		$a_02_1 = {56 ff 75 10 53 ff 75 08 ff 15 90 01 02 01 00 85 c0 89 45 d4 0f 8c 9e 00 00 00 83 7d 08 05 0f 85 94 00 00 00 83 65 e4 00 85 db 0f 84 88 00 00 00 57 90 00 } //1
	condition:
