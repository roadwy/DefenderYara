...
rule VirTool_WinNT_Ruf_gen_A{
	...
	strings :
		$a_00_0 = {6e 00 73 00 6c 00 66 00 75 00 72 00 } //01 00  nslfur
		$a_01_1 = {5a 77 51 75 65 72 79 56 61 6c 75 65 4b 65 79 00 6e 74 6f 73 6b 72 6e 6c 2e 65 78 65 } //01 00  睚畑牥噹污敵敋y瑮獯牫汮攮數
