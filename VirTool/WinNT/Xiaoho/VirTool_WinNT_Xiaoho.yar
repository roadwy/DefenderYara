...
rule VirTool_WinNT_Xiaoho{
	...
	strings :
		...
		$a_02_2 = {83 ec 40 56 57 c7 90 01 02 10 00 00 c0 90 02 40 81 90 01 02 c0 20 22 00 74 05 e9 b1 00 00 00 90 00 } //1
		$a_02_3 = {56 64 a1 24 c7 45 90 01 01 01 00 00 8b c7 45 90 01 01 74 24 08 3b 90 00 } //1
	condition:
