...
rule VirTool_WinNT_Donk_ldr{
	...
	strings :
		...
		$a_03_4 = {73 65 63 75 72 69 74 79 90 01 01 43 6f 64 65 53 6f 75 72 63 65 90 00 } //4
		$a_03_5 = {72 65 66 6c 65 63 74 90 01 01 43 6f 6e 73 74 72 75 63 74 6f 72 90 00 } //4
