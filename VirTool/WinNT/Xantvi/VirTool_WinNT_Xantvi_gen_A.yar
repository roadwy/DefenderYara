...
rule VirTool_WinNT_Xantvi_gen_A{
	...
	strings :
		$a_02_0 = {8b 44 24 08 56 8b 70 28 6a 00 ff 15 90 01 02 01 00 8d 4e 50 ff 15 90 01 02 01 00 5e c2 10 00 90 00 } //5
		$a_02_1 = {01 00 8b 48 08 c1 e1 02 51 ff 30 6a 00 ff 15 90 01 02 01 00 85 c0 a3 90 01 02 01 00 75 06 b8 01 00 00 c0 c3 90 09 03 00 a1 90 00 } //5
		$a_02_2 = {50 56 56 56 8d 45 d4 50 68 3f 00 0f 00 8d 45 08 50 c7 45 d4 18 00 00 00 89 75 d8 c7 45 e0 40 02 00 00 89 75 e4 89 75 e8 ff 15 90 01 02 01 00 85 c0 75 50 8b 45 0c 89 45 f0 8d 50 02 66 8b 08 40 90 00 } //10
		$a_02_3 = {8d 45 e8 50 ff 15 90 01 02 01 00 8b 45 0c 89 45 f0 8d 45 f0 50 8d 45 d0 50 68 ff 0f 1f 00 8d 45 08 50 89 5d 08 89 5d f4 ff 15 90 01 02 01 00 53 ff 75 08 ff 15 90 01 02 01 00 47 8d 34 bd 90 01 02 01 00 39 1e 75 ad 90 00 } //13
