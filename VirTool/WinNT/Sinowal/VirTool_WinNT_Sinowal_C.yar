...
rule VirTool_WinNT_Sinowal_C{
	...
	strings :
		$a_02_0 = {33 f6 ff 25 90 01 02 01 00 90 02 07 ff 25 90 01 02 01 00 90 00 } //1
		$a_02_1 = {83 7c 24 0c 05 ff 25 90 01 02 01 00 90 02 07 ff 25 90 01 02 01 00 90 00 } //1
