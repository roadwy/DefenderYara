...
rule VirTool_WinNT_Ursnif_C{
	...
	strings :
		...
		$a_00_4 = {5a 77 51 75 65 72 79 44 69 72 65 63 74 6f 72 79 46 69 6c 65 } //1 ZwQueryDirectoryFile
		$a_00_5 = {5a 77 51 75 65 72 79 53 79 73 74 65 6d 49 6e 66 6f 72 6d 61 74 69 6f 6e } //1 ZwQuerySystemInformation
		$a_00_6 = {68 69 64 65 5f 65 76 72 32 2e 70 64 62 } //1 hide_evr2.pdb
	condition:
