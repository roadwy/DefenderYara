...
rule VirTool_WinNT_Knockex_D{
	...
	strings :
		$a_02_0 = {80 39 e8 75 ?? (8b|ff) [0-03] 8d 54 0a 05 81 3a 58 83 c0 03 75 ?? (8b|ff) [0-03] eb ?? 81 3a 58 ff 30 60 75 ?? (8b|ff) [0-03] eb 02 eb 0b c6 01 e9 2b d1 83 ea 05 89 51 01 } //3
		$a_02_1 = {66 81 38 ff 25 75 ?? (8b|ff) } //1
