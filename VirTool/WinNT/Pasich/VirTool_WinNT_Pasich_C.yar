...
rule VirTool_WinNT_Pasich_C{
	...
	strings :
		...
		$a_01_4 = {63 75 72 72 65 6e 74 5f 69 70 } //01 00  current_ip
		$a_01_5 = {66 69 72 73 74 5f 64 6f 77 6e 6c 6f 61 64 5f 64 65 6c 61 79 } //01 00  first_download_delay
		$a_01_6 = {6c 61 73 74 5f 64 6f 77 6e 6c 6f 61 64 5f 74 69 6d 65 } //00 00  last_download_time
	condition:
		any of ($a_*)
