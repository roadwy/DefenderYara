...
rule VirTool_WinNT_Pasich_A{
	...
	strings :
		$a_03_0 = {68 31 30 44 54 6a 30 6a 00 8b f8 ff 15 90 01 02 40 00 8b f0 85 f6 74 90 01 01 a1 90 01 02 40 00 6a 01 6a 01 50 6a 00 90 00 } //1
		...
		$a_03_2 = {83 65 fc 00 83 65 e4 00 6a 25 e8 90 01 02 00 00 8b f0 89 75 dc 85 f6 74 90 01 01 c6 45 d4 e9 33 c0 8d 7d d5 ab 8b 45 08 89 45 e0 ff 75 e0 90 00 } //2
