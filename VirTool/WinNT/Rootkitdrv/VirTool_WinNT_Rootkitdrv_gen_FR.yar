...
rule VirTool_WinNT_Rootkitdrv_gen_FR{
	...
	strings :
		$a_02_0 = {c7 45 c4 00 00 00 00 c7 45 c8 00 00 00 00 c7 45 fc 00 00 00 00 6a 04 6a 04 8b 4d d0 51 ff 15 90 01 04 6a 04 6a 04 8b 55 dc 52 ff 15 90 01 04 c7 45 fc ff ff ff ff 90 00 } //10
