...
rule VirTool_WinNT_Rootkitdrv_AT{
	...
	strings :
		...
		$a_02_4 = {68 6e 45 54 74 8b 45 90 01 01 c1 e0 02 50 6a 00 ff 15 90 00 } //1
		$a_02_5 = {fa 0f 20 c0 89 45 fc 25 ff ff fe ff 0f 22 c0 a1 90 01 04 8b 00 8b 15 90 00 } //1
		$a_02_6 = {fa 0f 20 c0 89 45 90 01 01 25 ff ff fe ff 0f 22 c0 a1 90 01 04 8b 40 01 a3 90 00 } //1
	condition:
