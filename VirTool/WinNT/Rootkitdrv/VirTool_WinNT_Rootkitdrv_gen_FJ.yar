...
rule VirTool_WinNT_Rootkitdrv_gen_FJ{
	...
	strings :
		...
		$a_00_2 = {53 00 79 00 73 00 74 00 65 00 6d 00 33 00 32 00 5c 00 64 00 72 00 69 00 76 00 65 00 72 00 73 00 5c 00 61 00 6b 00 39 00 32 00 32 00 2e 00 73 00 79 00 73 00 } //01 00 
		$a_00_3 = {53 00 65 00 72 00 76 00 69 00 63 00 65 00 73 00 5c 00 41 00 7a 00 79 00 4b 00 69 00 74 00 } //00 00 
	condition:
		any of ($a_*)
