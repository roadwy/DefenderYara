...
rule VirTool_WinNT_Rootkitdrv_gen_FJ{
	...
	strings :
		$a_02_0 = {83 c0 04 8d 1d 90 01 04 2b d8 83 eb 05 c6 00 e8 89 58 01 9d 61 e8 90 01 04 33 c0 90 00 } //1
		$a_02_1 = {c7 00 aa aa aa aa a1 90 01 04 c7 40 04 bb bb bb bb 6a 00 ff 35 90 01 04 ff 15 90 01 04 eb 90 00 } //1
