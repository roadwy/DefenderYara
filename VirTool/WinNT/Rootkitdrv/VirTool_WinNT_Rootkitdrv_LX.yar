...
rule VirTool_WinNT_Rootkitdrv_LX{
	...
	strings :
		$a_03_0 = {57 56 8b 78 18 8b 70 48 39 7e 18 74 04 8b 36 eb f7 68 90 01 02 01 00 ba 90 01 02 01 00 39 3a 0f 85 90 01 04 74 05 60 8b 74 24 24 8b 7c 24 28 fc b2 80 33 db a4 b3 02 90 00 } //1
