...
rule VirTool_WinNT_Rootkitdrv_LM{
	...
	strings :
		...
		$a_03_2 = {81 7d fc f4 01 00 00 0f 8f 90 01 02 00 00 6a 00 8b 95 90 01 02 ff ff 03 55 90 01 01 52 8d 85 90 01 02 ff ff 50 e8 90 01 04 03 45 90 01 01 89 45 90 01 01 83 bd 90 01 02 ff ff 29 75 90 01 01 6a 00 8b 8d 90 01 02 ff ff 03 4d 90 01 01 51 8d 95 90 01 02 ff ff 52 e8 90 00 } //1
	condition:
