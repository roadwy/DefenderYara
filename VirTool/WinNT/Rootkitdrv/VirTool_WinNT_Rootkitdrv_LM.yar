...
rule VirTool_WinNT_Rootkitdrv_LM{
	...
	strings :
		$a_00_0 = {5c 00 44 00 65 00 76 00 69 00 63 00 65 00 5c 00 6d 00 73 00 64 00 69 00 72 00 65 00 63 00 74 00 78 00 } //01 00 
		$a_00_1 = {5c 4f 62 6a 65 63 74 54 79 70 65 73 5c 50 72 6f 63 65 73 73 } //01 00 
