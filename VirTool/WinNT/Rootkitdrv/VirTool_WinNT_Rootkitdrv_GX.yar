...
rule VirTool_WinNT_Rootkitdrv_GX{
	...
	strings :
		...
		$a_01_3 = {5a 77 51 75 65 72 79 53 79 73 74 65 6d 49 6e 66 6f 72 6d 61 74 69 6f 6e } //01 00 
		$a_01_4 = {5a 77 51 75 65 72 79 44 69 72 65 63 74 6f 72 79 46 69 6c 65 } //00 00 
	condition:
		any of ($a_*)
