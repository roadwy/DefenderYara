...
rule VirTool_WinNT_Rootkitdrv_LG{
	...
	strings :
		...
		$a_03_1 = {53 53 53 53 50 68 00 00 00 40 ff b5 ?? ?? ff ff ff 15 ?? ?? ?? ?? eb 12 50 68 00 00 00 82 ff b5 ?? ?? ff ff ff 15 ?? ?? ?? ?? 5e 5b } //1
		$a_03_2 = {ff 75 1c 8d 45 ?? ff 75 18 ff 75 14 6a 00 50 ff 75 0c ff 15 ?? ?? ?? ?? ff 75 0c 8b f0 ff 15 ?? ?? ?? ?? 8b c6 5e c9 c2 18 00 } //1
	condition:
