...
rule VirTool_WinNT_Rootkitdrv_CY{
	...
	strings :
		...
		$a_01_2 = {5c 41 6e 74 69 44 72 69 76 65 72 2e 70 64 62 } //01 00 
		$a_01_3 = {5c 58 4e 47 5f 41 6e 74 69 56 65 72 73 69 6f 6e } //01 00 
		$a_01_4 = {5c 44 65 76 69 63 65 5c 58 4e 47 41 6e 74 69 } //00 00 
	condition:
		any of ($a_*)
