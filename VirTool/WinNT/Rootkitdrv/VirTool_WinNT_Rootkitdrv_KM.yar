...
rule VirTool_WinNT_Rootkitdrv_KM{
	...
	strings :
		...
		$a_00_1 = {5c 00 44 00 65 00 76 00 69 00 63 00 65 00 5c 00 57 00 69 00 6e 00 48 00 6f 00 6f 00 6b 00 } //01 00  \Device\WinHook
		$a_01_2 = {2a 57 69 6e 48 6f 6f 6b 3a 48 6f 6f 6b 20 53 79 73 74 65 6d 20 43 61 6c 6c 20 53 65 72 76 69 63 65 2a } //01 00  *WinHook:Hook System Call Service*
