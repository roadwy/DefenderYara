...
rule VirTool_WinNT_Rootkitdrv_GG{
	...
	strings :
		...
		$a_03_2 = {01 45 f8 83 c7 16 83 c6 04 4b 75 90 01 01 fb 0f 20 c0 0d 00 00 01 00 90 00 } //2
		$a_03_3 = {01 00 68 c6 81 90 01 02 01 00 c3 83 c1 16 81 f9 90 09 0d 00 ab ab 83 90 00 } //3
