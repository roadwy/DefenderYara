...
rule VirTool_WinNT_Rootkitdrv_gen_FM{
	...
	strings :
		$a_02_0 = {ff d6 83 4d ec ff 68 90 01 04 8d 85 8c fe ff ff 68 b8 04 01 00 50 c7 45 e8 80 3c 36 fe ff 15 90 01 04 83 c4 0c 8d 85 8c fe ff ff 50 8d 45 a0 50 ff 15 90 01 04 6a 01 90 00 } //100
