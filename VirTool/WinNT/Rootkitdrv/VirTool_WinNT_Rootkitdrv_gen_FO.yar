...
rule VirTool_WinNT_Rootkitdrv_gen_FO{
	...
	strings :
		...
		$a_00_1 = {41 78 63 58 42 65 67 69 68 73 74 6e 61 76 76 76 73 78 78 78 78 73 46 75 63 6b 78 78 78 } //01 00 
		$a_00_2 = {5c 00 44 00 65 00 76 00 69 00 63 00 65 00 5c 00 58 00 75 00 65 00 4c 00 75 00 6f 00 } //00 00 
	condition:
		any of ($a_*)
