...
rule VirTool_WinNT_Rootkitdrv_gen_FC{
	...
	strings :
		...
		$a_01_1 = {5c 00 44 00 65 00 76 00 69 00 63 00 65 00 5c 00 66 00 73 00 6f 00 64 00 68 00 66 00 6e 00 32 00 6d 00 } //01 00  \Device\fsodhfn2m
		$a_01_2 = {5c 00 44 00 6f 00 73 00 44 00 65 00 76 00 69 00 63 00 65 00 73 00 5c 00 66 00 73 00 6f 00 64 00 68 00 66 00 6e 00 32 00 6d 00 } //00 00  \DosDevices\fsodhfn2m
	condition:
		any of ($a_*)
