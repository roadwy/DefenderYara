...
rule VirTool_WinNT_Rootkitdrv_AQ{
	...
	strings :
		...
		$a_00_1 = {5a 77 51 75 65 72 79 56 61 6c 75 65 4b 65 79 } //01 00  ZwQueryValueKey
		$a_00_2 = {5a 77 45 6e 75 6d 65 72 61 74 65 4b 65 79 } //01 00  ZwEnumerateKey
		$a_00_3 = {5a 77 43 72 65 61 74 65 46 69 6c 65 } //01 00  ZwCreateFile
		$a_00_4 = {5a 77 43 72 65 61 74 65 53 65 63 74 69 6f 6e } //01 00  ZwCreateSection
		$a_00_5 = {4b 65 53 65 72 76 69 63 65 44 65 73 63 72 69 70 74 6f 72 54 61 62 6c 65 } //01 00  KeServiceDescriptorTable
		$a_00_6 = {5c 00 53 00 79 00 73 00 74 00 65 00 6d 00 52 00 6f 00 6f 00 74 00 5c 00 53 00 79 00 73 00 74 00 65 00 6d 00 33 00 32 00 5c 00 76 00 73 00 5f 00 6d 00 6f 00 6e 00 2e 00 64 00 6c 00 6c 00 } //00 00  \SystemRoot\System32\vs_mon.dll
	condition:
		any of ($a_*)
