...
rule VirTool_WinNT_Rootkitdrv_I{
	...
	strings :
		$a_03_0 = {89 45 e4 8b c0 81 f9 4b e1 22 00 74 0a ?? bb 00 00 c0 e9 ?? ?? 00 00 83 65 fc 00 6a 04 6a 04 53 ff 15 } //1
		$a_03_1 = {39 48 08 77 07 ?? 0d 00 00 c0 eb ?? 8b 00 8b 14 88 8b ?? 8b ?? ?? ?? 01 00 3b ?? 01 75 } //1
