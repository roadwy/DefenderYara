...
rule VirTool_WinNT_Rootkitdrv_AX{
	...
	strings :
		$a_01_0 = {6e 74 6f 73 6b 72 6e 6c 2e 65 78 65 } //01 00  ntoskrnl.exe
		$a_01_1 = {5c 00 44 00 65 00 76 00 69 00 63 00 65 00 5c 00 73 00 71 00 6c 00 6f 00 64 00 62 00 63 00 } //01 00  \Device\sqlodbc
