...
rule VirTool_WinNT_Rootkitdrv_LH{
	...
	strings :
		$a_01_0 = {4b 64 44 69 73 61 62 6c 65 44 65 62 75 67 67 65 72 } //01 00  KdDisableDebugger
		$a_00_1 = {5c 00 44 00 65 00 76 00 69 00 63 00 65 00 5c 00 48 00 61 00 72 00 64 00 44 00 69 00 73 00 6b 00 56 00 6f 00 6c 00 75 00 6d 00 65 00 25 00 64 00 } //01 00  \Device\HardDiskVolume%d
