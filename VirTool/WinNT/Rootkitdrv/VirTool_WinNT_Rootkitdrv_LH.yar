...
rule VirTool_WinNT_Rootkitdrv_LH{
	...
	strings :
		...
		$a_03_2 = {83 e8 24 c6 00 0d 8b 8d 90 01 02 ff ff 8b 49 08 8b 49 08 89 48 14 8b 8d 90 01 02 ff ff 89 48 18 8d 8d 90 01 02 ff ff c7 40 0c 73 00 09 00 c7 40 08 08 00 00 00 89 48 10 c7 40 04 10 01 00 00 e8 90 00 } //1
	condition:
