...
rule VirTool_WinNT_Rootkitdrv_HQ{
	...
	strings :
		...
		$a_03_2 = {8b 48 60 83 e9 24 89 4d 90 01 01 8b 55 90 01 01 c7 42 1c 90 01 04 8b 45 90 00 } //1
		$a_03_3 = {fa 0f 20 c0 25 ff ff fe ff 0f 22 c0 8b 45 90 01 01 8b 4d 90 01 01 8b 55 90 01 01 8b 12 89 14 81 90 00 } //1
	condition:
