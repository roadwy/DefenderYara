...
rule VirTool_WinNT_Rootkitdrv_HQ{
	...
	strings :
		$a_00_0 = {5c 00 3f 00 3f 00 5c 00 54 00 58 00 51 00 51 00 } //01 00 
		$a_00_1 = {49 00 6d 00 61 00 67 00 65 00 20 00 46 00 69 00 6c 00 65 00 20 00 45 00 78 00 65 00 63 00 75 00 74 00 69 00 6f 00 6e 00 20 00 4f 00 70 00 74 00 69 00 6f 00 6e 00 73 00 } //01 00 
