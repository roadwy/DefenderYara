...
rule VirTool_WinNT_Rootkitdrv_GA{
	...
	strings :
		$a_02_0 = {8b ff ff 35 ?? ?? ?? ?? 68 ?? ?? 01 00 68 ?? ?? 01 00 83 3c 24 00 75 0b 8d 54 24 0c 60 0e e8 48 00 00 00 83 2c 24 05 75 01 e8 c3 78 0b c0 75 08 b8 4f 00 00 c0 c2 08 00 75 06 0e e8 f4 fe ff ff } //1
