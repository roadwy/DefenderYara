...
rule VirTool_WinNT_Rootkitdrv_GF{
	...
	strings :
		...
		$a_00_2 = {48 65 6c 6c 6f 2c 20 54 6f 20 50 72 6f 63 65 73 73 5f 68 69 64 65 } //01 00  Hello, To Process_hide
		$a_00_3 = {48 65 6c 6c 6f 2c 20 66 72 6f 6d 20 44 72 69 76 65 72 45 6e 74 72 79 } //01 00  Hello, from DriverEntry
		$a_00_4 = {42 79 65 2c 20 66 72 6f 6d 20 44 72 69 76 65 72 55 6e 6c 6f 61 64 } //00 00  Bye, from DriverUnload
	condition:
		any of ($a_*)
