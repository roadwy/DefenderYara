...
rule VirTool_WinNT_Rootkitdrv_gen_FL{
	...
	strings :
		...
		$a_01_1 = {5c 00 44 00 65 00 76 00 69 00 63 00 65 00 5c 00 64 00 6d 00 65 00 6f 00 38 00 } //01 00 
		$a_01_2 = {5c 00 44 00 6f 00 73 00 44 00 65 00 76 00 69 00 63 00 65 00 73 00 5c 00 64 00 6d 00 65 00 6f 00 38 00 } //00 00 
	condition:
		any of ($a_*)
