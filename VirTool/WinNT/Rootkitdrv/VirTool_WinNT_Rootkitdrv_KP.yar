...
rule VirTool_WinNT_Rootkitdrv_KP{
	...
	strings :
		$a_00_0 = {5c 00 44 00 65 00 76 00 69 00 63 00 65 00 5c 00 61 00 67 00 6f 00 6e 00 79 00 } //01 00  \Device\agony
		$a_00_1 = {5c 00 44 00 6f 00 73 00 44 00 65 00 76 00 69 00 63 00 65 00 73 00 5c 00 61 00 67 00 6f 00 6e 00 79 00 } //01 00  \DosDevices\agony
