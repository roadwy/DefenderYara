...
rule VirTool_WinNT_Rootkitdrv_LD{
	...
	strings :
		...
		$a_03_1 = {c6 00 e9 8b 90 01 01 2b 90 01 01 89 90 01 01 01 8b 45 0c 2b 90 02 04 83 e8 05 89 90 01 01 01 c6 90 01 01 e9 90 00 } //1
		$a_03_2 = {80 f9 40 75 06 81 cb 00 01 00 00 80 f9 80 75 90 01 01 0b df eb 90 01 01 80 f9 40 75 06 81 cb 00 01 00 00 80 f9 80 75 06 81 cb 00 04 00 00 3c 04 75 90 01 01 8a 06 24 07 90 00 } //1
	condition:
