...
rule VirTool_WinNT_Rootkitdrv_HU{
	...
	strings :
		...
		$a_03_1 = {0f b7 88 88 01 00 00 8b 55 90 01 01 0f b7 82 8e 01 00 00 c1 e0 10 0b c8 90 00 } //1
		$a_03_2 = {3d 9d 00 00 00 74 90 01 01 0f b6 4d 90 01 01 81 f9 b8 00 00 00 74 90 01 01 0f b6 55 90 01 01 83 fa 5b 90 00 } //1
