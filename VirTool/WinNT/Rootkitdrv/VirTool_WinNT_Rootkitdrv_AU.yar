...
rule VirTool_WinNT_Rootkitdrv_AU{
	...
	strings :
		...
		$a_02_1 = {4e 65 74 42 6f 74 5c 69 33 38 36 5c 90 02 08 2e 70 64 62 90 00 } //10
		...
		$a_02_5 = {fa 0f 20 c0 25 ff ff fe ff 0f 22 c0 8b 07 8b 4d 90 01 01 89 04 8b 0f 20 c0 0d 00 00 01 00 0f 22 c0 90 00 } //1
	condition:
