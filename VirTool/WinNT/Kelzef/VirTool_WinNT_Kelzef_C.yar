...
rule VirTool_WinNT_Kelzef_C{
	...
	strings :
		$a_11_0 = {65 74 00 73 74 61 72 74 20 6e 65 77 64 72 69 76 65 72 00 01 } //00 1a  瑥猀慴瑲渠睥牤癩牥Ā
		$a_53_1 = {46 54 57 41 52 45 5c 4d 69 63 72 6f 73 6f 66 74 } //5c 44  FTWARE\Microsoft
