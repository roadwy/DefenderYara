...
rule VirTool_WinNT_Zuten_C{
	...
	strings :
		...
		$a_02_6 = {8b 75 10 6a 05 56 e8 90 01 02 ff ff 2b de 83 c3 0b c6 06 e9 89 5e 01 8b 4d 2c ff 15 90 00 } //2
		$a_02_7 = {60 e8 00 00 00 00 5f 81 e7 00 ff ff ff 8d 77 90 01 01 eb 09 80 3e 90 01 01 75 03 80 36 90 01 01 46 80 3e 00 75 f2 8d 77 90 01 01 eb 0c 56 ff 17 eb 01 46 80 3e 00 75 fa 46 66 83 3e 00 75 ee 90 00 } //2
	condition:
