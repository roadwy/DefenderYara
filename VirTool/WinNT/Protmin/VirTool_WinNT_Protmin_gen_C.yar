...
rule VirTool_WinNT_Protmin_gen_C{
	...
	strings :
		...
		$a_02_4 = {45 58 50 4c 4f 52 45 52 2e 45 58 45 90 02 05 4d 53 48 54 41 2e 45 58 45 90 02 05 52 55 4e 44 4c 4c 33 32 2e 45 58 45 90 02 05 45 58 50 4c 4f 52 45 52 2e 45 58 45 90 00 } //5
		$a_02_5 = {3b f7 74 37 ff 75 10 ff 15 90 02 05 80 7d 14 00 59 8d 46 08 50 ff 75 10 74 0e ff 15 90 02 05 59 85 c0 59 75 12 eb 0c 90 00 } //5
		...
		$a_02_7 = {f2 ae f7 d1 83 c1 08 51 6a 01 ff 90 02 05 8b f0 33 c0 3b f0 74 61 8b 7c 24 0c 53 50 50 50 bb 90 02 05 50 53 89 3e ff 15 90 02 05 c1 ef 02 81 e7 ff 00 00 00 8d 56 08 6a 00 53 90 00 } //10
	condition:
