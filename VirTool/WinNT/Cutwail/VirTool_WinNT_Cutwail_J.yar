...
rule VirTool_WinNT_Cutwail_J{
	...
	strings :
		...
		$a_01_3 = {45 00 58 00 45 00 52 00 45 00 53 00 4f 00 55 00 52 00 43 00 45 00 } //01 00  EXERESOURCE
		$a_01_4 = {5c 00 46 00 69 00 6c 00 65 00 53 00 79 00 73 00 74 00 65 00 6d 00 } //01 00  \FileSystem
		$a_01_5 = {57 00 69 00 6e 00 4e 00 74 00 33 00 32 00 2e 00 64 00 6c 00 6c 00 } //01 00  WinNt32.dll
		$a_01_6 = {5c 00 44 00 6f 00 73 00 44 00 65 00 76 00 69 00 63 00 65 00 73 00 5c 00 50 00 72 00 6f 00 74 00 32 00 } //01 00  \DosDevices\Prot2
		$a_01_7 = {5c 00 44 00 65 00 76 00 69 00 63 00 65 00 5c 00 50 00 72 00 6f 00 74 00 32 00 } //00 00  \Device\Prot2
	condition:
		any of ($a_*)
