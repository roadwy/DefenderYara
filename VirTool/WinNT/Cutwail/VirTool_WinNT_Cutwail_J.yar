...
rule VirTool_WinNT_Cutwail_J{
	...
	strings :
		$a_03_0 = {89 45 f8 8b 55 0c 52 a1 90 01 04 8b 4d fc 03 08 51 e8 90 01 02 00 00 83 c4 08 85 c0 75 04 b0 01 eb 02 32 c0 90 00 } //2
		$a_03_1 = {83 7d 08 00 74 63 83 7d 0c 00 74 5d 68 90 01 02 00 00 8d 8d 90 01 02 ff ff 51 8d 95 90 01 02 ff ff 52 e8 90 00 } //2
		$a_03_2 = {24 08 9d 74 17 81 7d 90 01 01 40 24 08 9d 90 00 } //1
