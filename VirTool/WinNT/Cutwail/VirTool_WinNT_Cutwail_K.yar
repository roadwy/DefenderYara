...
rule VirTool_WinNT_Cutwail_K{
	...
	strings :
		$a_03_0 = {73 54 8b 55 08 03 55 fc 0f b6 02 83 f0 90 01 01 8b 4d 08 03 4d fc 88 01 8b 55 08 03 55 fc 0f b6 42 01 83 f0 90 00 } //2
		$a_03_1 = {68 52 57 4e 44 8b 4d e4 51 8b 55 14 52 ff 15 90 01 04 89 45 f0 83 7d f0 00 74 1b 90 00 } //2
		$a_01_2 = {75 05 8b 45 08 eb 1b 8b 45 08 33 d2 f7 75 0c 89 45 fc 8b 45 fc } //2
		$a_03_3 = {73 39 8b 4d fc 81 c1 90 01 04 89 4d f8 8b 55 f8 81 3a 05 a1 55 f3 75 20 90 00 } //2
		$a_03_4 = {7c 1f 8b 55 0c 52 a1 90 01 04 8b 4d fc 03 08 51 e8 90 01 04 83 c4 08 85 c0 75 04 c6 45 f7 01 90 00 } //2
