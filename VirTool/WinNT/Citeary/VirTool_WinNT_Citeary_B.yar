...
rule VirTool_WinNT_Citeary_B{
	...
	strings :
		$a_02_0 = {63 3a 5c 75 73 65 72 73 5c 69 63 79 68 65 61 72 74 5c 64 6f 63 75 6d 65 7e 31 5c 76 69 73 75 61 6c 7e 90 01 01 5c 70 72 6f 6a 65 63 74 73 5c 64 6f 77 6e 6c 6f 61 64 5c 90 00 } //1
		...
		$a_02_3 = {fa 0f 20 c0 25 ff ff fe ff 0f 22 c0 90 02 ff 0f 20 c0 0d 00 00 01 00 0f 22 c0 fb 90 00 } //1
	condition:
