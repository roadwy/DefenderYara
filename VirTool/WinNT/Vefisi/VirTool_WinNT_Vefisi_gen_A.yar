...
rule VirTool_WinNT_Vefisi_gen_A{
	...
	strings :
		...
		$a_03_3 = {fa 0f 20 c0 25 ff ff fe ff 0f 22 c0 8b 0d 90 01 02 01 00 8b 31 a1 90 01 02 01 00 8b 50 01 8b 14 96 89 15 90 01 02 01 00 8b 40 01 8b 09 c7 04 81 90 00 } //5
