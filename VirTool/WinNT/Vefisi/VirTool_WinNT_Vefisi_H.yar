...
rule VirTool_WinNT_Vefisi_H{
	...
	strings :
		$a_03_0 = {53 79 73 74 65 6d 00 56 33 f6 8b 44 24 08 6a 06 03 c6 50 68 00 03 01 00 ff 15 90 01 02 01 00 83 c4 0c 85 c0 74 0f 46 81 fe 00 10 00 00 72 dc 90 00 } //4
		...
		$a_03_4 = {8b 4d 20 b8 14 80 7b 2a 3b c8 0f 87 90 01 02 00 00 0f 84 90 00 } //3
