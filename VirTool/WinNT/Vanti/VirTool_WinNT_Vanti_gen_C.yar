...
rule VirTool_WinNT_Vanti_gen_C{
	...
	strings :
		...
		$a_01_7 = {4b 65 53 65 72 76 69 63 65 44 65 73 63 72 69 70 74 6f 72 54 61 62 6c 65 } //01 00 
		$a_01_8 = {5a 77 51 75 65 72 79 53 79 73 74 65 6d 49 6e 66 6f 72 6d 61 74 69 6f 6e } //01 00 
		$a_01_9 = {5c 69 33 38 36 5c 72 69 73 69 6e 67 2e 73 79 73 } //01 00 
