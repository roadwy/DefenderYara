...
rule VirTool_WinNT_Mader_gen_A{
	...
	strings :
		$a_03_0 = {33 c9 33 d2 8d 44 4d 90 01 01 8a 10 81 e2 ff 00 ff ff 83 ea 90 01 01 41 83 f9 90 01 01 66 89 10 7c e6 66 83 65 90 01 01 00 8d 45 90 01 01 50 8d 45 f8 90 00 } //5
		$a_03_1 = {74 44 80 7d 90 01 01 3e 75 2f 80 7d 90 01 01 74 75 29 80 7d 90 01 01 6e 75 23 80 7d 90 01 01 63 75 1d 80 7d 90 01 01 61 75 17 80 7d 90 01 01 63 75 11 80 7d 90 01 01 68 75 0b 80 7d 90 01 01 65 75 05 33 c0 40 eb 02 90 00 } //5
