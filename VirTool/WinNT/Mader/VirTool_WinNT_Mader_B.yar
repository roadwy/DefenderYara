...
rule VirTool_WinNT_Mader_B{
	...
	strings :
		$a_01_0 = {44 72 69 76 65 72 3a 20 53 74 61 72 74 65 64 20 5b } //01 00 
		$a_00_1 = {5c 00 77 00 69 00 6e 00 6e 00 74 00 5c 00 65 00 78 00 70 00 6c 00 6f 00 72 00 65 00 72 00 2e 00 65 00 78 00 65 00 } //01 00 
