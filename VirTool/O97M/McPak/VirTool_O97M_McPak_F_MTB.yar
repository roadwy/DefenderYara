...
rule VirTool_O97M_McPak_F_MTB{
	...
	strings :
		...
		$a_00_1 = {45 6e 76 69 72 6f 6e 28 22 41 70 70 44 61 74 61 22 29 } //01 00 
		$a_02_2 = {50 72 69 76 61 74 65 20 44 65 63 6c 61 72 65 90 02 10 53 75 62 90 02 20 2e 61 73 64 90 00 } //01 00 
		$a_00_3 = {53 63 72 69 70 74 69 6e 67 2e 46 69 6c 65 53 79 73 74 65 6d 4f 62 6a 65 63 74 } //00 00 
	condition:
		any of ($a_*)
