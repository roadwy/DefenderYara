...
rule VirTool_Linux_Myrddin_DS_MTB{
	...
	strings :
		...
		$a_03_2 = {6e 65 74 2e 54 43 50 43 6f 6e 6e 90 02 3c 6e 65 74 2e 55 44 50 41 64 64 72 90 02 3c 6e 65 74 2e 55 44 50 43 6f 6e 90 02 3c 6e 65 74 2e 6e 73 73 43 6f 6e 66 90 02 3c 6e 65 74 2e 72 61 77 43 6f 6e 6e 90 00 } //1
