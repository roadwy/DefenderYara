...
rule VirTool_Linux_Myrddin_DS_MTB{
	...
	strings :
		$a_01_0 = {4d 65 72 6c 69 6e 43 6c 69 65 6e 74 } //01 00 
		$a_01_1 = {53 65 6e 64 4d 65 72 6c 69 6e 4d 65 73 73 61 67 65 } //01 00 
		...
		$a_01_3 = {6d 79 74 68 69 63 2e 54 61 73 6b } //01 00 
		$a_01_4 = {4b 65 79 4c 6f 67 57 72 69 74 65 72 } //00 00 
	condition:
		any of ($a_*)
