...
rule VirTool_BAT_CryptInject_YR_MTB{
	...
	strings :
		$a_02_0 = {fe 09 00 00 28 90 01 01 00 00 0a fe 0e 00 00 28 90 01 01 00 00 0a fe 0c 00 00 6f 90 01 01 00 00 0a fe 0e 01 00 38 00 00 00 00 fe 0c 01 00 2a 90 00 } //1
