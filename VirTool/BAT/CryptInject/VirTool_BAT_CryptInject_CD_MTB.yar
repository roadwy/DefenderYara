...
rule VirTool_BAT_CryptInject_CD_MTB{
	...
	strings :
		$a_03_0 = {11 04 11 05 9a 0c 08 6f 90 01 01 00 00 0a 72 90 01 02 00 70 28 90 01 01 00 00 0a 2c 21 90 00 } //1
		$a_03_1 = {08 14 17 8d 01 00 00 01 13 06 11 06 16 02 a2 11 06 6f 90 01 01 00 00 0a 74 90 01 01 00 00 01 0d de 13 26 de 00 90 00 } //1
