...
rule VirTool_BAT_Inject{
	...
	strings :
		$a_01_0 = {68 35 3a 6f 42 3e 3f 55 64 3d 49 3b 2a 3e 2c 3f 57 2f 2d 39 36 68 64 60 00 41 74 74 72 69 62 75 74 65 } //01 00 
		$a_01_1 = {62 61 62 69 67 67 62 6f 79 2e 64 64 6e 73 2e 6e 65 74 } //01 00 
		$a_01_2 = {6d 6f 64 65 6d 20 6b 69 6c 6c 61 } //00 00 
	condition:
		any of ($a_*)
...
rule VirTool_BAT_Inject_2{
	...
	strings :
		...
		$a_00_2 = {63 00 75 00 6d 00 74 00 65 00 2e 00 74 00 61 00 6d 00 62 00 61 00 6c 00 } //01 00 
		$a_01_3 = {43 75 6d 74 65 54 61 6d 62 61 6c } //01 00 
