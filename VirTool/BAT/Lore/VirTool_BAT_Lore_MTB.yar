...
rule VirTool_BAT_Lore_MTB_26{
	meta:
		description = "VirTool:BAT/Lore!MTB,SIGNATURE_TYPE_PEHSTR_EXT,13 00 13 00 16 00 00 "
		
	strings :
		$a_01_0 = {76 61 72 31 } //1 var1
		$a_01_1 = {76 61 72 32 } //1 var2
		$a_01_2 = {76 61 72 33 } //1 var3
		$a_01_3 = {67 65 74 5f 4a 6f 6e 61 73 } //1 get_Jonas
		$a_01_4 = {73 65 74 5f 4a 6f 6e 61 73 } //1 set_Jonas
		$a_01_5 = {70 72 6f 6a 65 63 74 6e 61 6d 65 } //1 projectname
		...
		$a_01_10 = {42 69 74 6d 61 70 } //1 Bitmap
		$a_01_11 = {49 6e 76 6f 6b 65 } //1 Invoke
		$a_01_12 = {67 65 74 5f 53 69 7a 65 } //1 get_Size
		$a_01_13 = {67 65 74 5f 4c 65 6e 67 74 68 } //1 get_Length
		$a_01_14 = {67 65 74 5f 57 69 64 74 68 } //1 get_Width
		$a_01_15 = {47 65 74 45 78 65 63 75 74 69 6e 67 41 73 73 65 6d 62 6c 79 } //1 GetExecutingAssembly
		$a_01_16 = {47 65 74 45 6e 74 72 79 41 73 73 65 6d 62 6c 79 } //1 GetEntryAssembly
		$a_01_17 = {53 79 73 74 65 6d 2e 52 65 66 6c 65 63 74 69 6f 6e 2e 45 6d 69 74 } //1 System.Reflection.Emit
		$a_01_18 = {53 79 73 74 65 6d 2e 52 65 66 6c 65 63 74 69 6f 6e 2e 41 73 73 65 6d 62 6c 79 } //1 System.Reflection.Assembly
		$a_01_19 = {47 65 74 4d 61 6e 69 66 65 73 74 52 65 73 6f 75 72 63 65 53 74 72 65 61 6d } //1 GetManifestResourceStream
		$a_01_20 = {4c 00 6f 00 61 00 64 00 } //1 Load
		$a_01_21 = {2e 00 52 00 65 00 73 00 6f 00 75 00 72 00 63 00 65 00 73 00 } //1 .Resources
	condition:
		((#a_01_0  & 1)*1+(#a_01_1  & 1)*1+(#a_01_2  & 1)*1+(#a_01_3  & 1)*1+(#a_01_4  & 1)*1+(#a_01_5  & 1)*1+(#a_01_6  & 1)*1+(#a_01_7  & 1)*1+(#a_01_8  & 1)*1+(#a_01_9  & 1)*1+(#a_01_10  & 1)*1+(#a_01_11  & 1)*1+(#a_01_12  & 1)*1+(#a_01_13  & 1)*1+(#a_01_14  & 1)*1+(#a_01_15  & 1)*1+(#a_01_16  & 1)*1+(#a_01_17  & 1)*1+(#a_01_18  & 1)*1+(#a_01_19  & 1)*1+(#a_01_20  & 1)*1+(#a_01_21  & 1)*1) >=19
