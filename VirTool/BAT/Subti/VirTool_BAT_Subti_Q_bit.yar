...
rule VirTool_BAT_Subti_Q_bit{
	...
	strings :
		$a_01_0 = {41 6e 74 69 72 75 6e 6e 65 72 73 } //01 00 
		$a_01_1 = {4e 61 74 69 76 65 46 75 6e 63 74 69 6f 6e 73 } //01 00 
		$a_01_2 = {43 72 69 74 69 63 61 6c 50 72 6f 63 65 73 73 } //01 00 
