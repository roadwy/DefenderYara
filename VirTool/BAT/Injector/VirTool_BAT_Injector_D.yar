...
rule VirTool_BAT_Injector_D{
	...
	strings :
		...
		$a_03_1 = {20 50 45 00 00 33 0e 12 00 7b 90 01 01 00 00 04 20 4d 5a 00 00 2e 02 90 00 } //1
		$a_03_2 = {11 11 17 58 13 11 11 11 12 02 7b 90 01 01 00 00 04 17 59 31 d9 90 00 } //1
	condition:
