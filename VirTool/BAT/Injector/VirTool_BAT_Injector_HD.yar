...
rule VirTool_BAT_Injector_HD{
	...
	strings :
		...
		$a_01_2 = {24 31 33 61 37 64 35 32 35 2d 65 35 32 34 2d 34 35 34 37 2d 61 66 39 31 2d 66 61 61 39 61 61 34 62 38 37 64 37 00 } //01 00  ㄤ愳搷㈵ⴵ㕥㐲㐭㐵ⴷ晡ㄹ昭慡愹㑡㡢搷7
		$a_01_3 = {41 7a 75 72 61 4d 61 6e 2e 50 72 6f 70 65 72 74 69 65 73 00 } //00 00  穁牵䵡湡倮潲数瑲敩s
	condition:
		any of ($a_*)
