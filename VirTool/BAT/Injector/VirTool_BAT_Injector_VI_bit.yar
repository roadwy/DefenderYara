...
rule VirTool_BAT_Injector_VI_bit{
	...
	strings :
		...
		$a_00_2 = {62 00 69 00 62 00 64 00 61 00 67 00 2e 00 50 00 72 00 6f 00 70 00 65 00 72 00 74 00 69 00 65 00 73 00 2e 00 52 00 65 00 73 00 6f 00 75 00 72 00 63 00 65 00 73 00 } //00 00 
	condition:
		any of ($a_*)
