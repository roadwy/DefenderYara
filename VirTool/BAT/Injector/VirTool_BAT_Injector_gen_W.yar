...
rule VirTool_BAT_Injector_gen_W{
	...
	strings :
		...
		$a_01_1 = {61 6e 74 69 52 65 67 4d 6f 6e 00 61 6e 74 69 53 61 6e 64 62 6f 78 69 65 } //01 00  湡楴敒䵧湯愀瑮卩湡扤硯敩
		$a_01_2 = {66 61 6b 65 45 72 72 6f 72 00 66 61 6b 65 45 72 72 6f 72 54 69 74 6c 65 } //01 00  慦敫牅潲r慦敫牅潲呲瑩敬
