...
rule VirTool_BAT_Injector_DO_bit{
	...
	strings :
		$a_03_0 = {8c 16 00 00 01 a2 90 02 04 14 28 20 00 00 0a 90 02 04 b4 8c 14 00 00 01 28 23 00 00 0a 28 24 00 00 0a 90 00 } //1
		$a_03_1 = {28 1f 00 00 0a 90 02 04 1b d6 90 02 04 20 ff 00 00 00 5f d8 90 00 } //1
