...
rule VirTool_BAT_Injector_TI_bit{
	...
	strings :
		$a_03_0 = {28 1c 00 00 06 03 6f 12 00 00 0a 74 01 00 00 1b 0a 16 0b 2b 15 7e 01 00 00 04 06 07 91 1f 90 01 01 61 d2 6f 13 00 00 0a 07 17 58 0b 07 06 8e 69 17 59 32 e3 16 2a 90 00 } //2
