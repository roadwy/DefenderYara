...
rule VirTool_BAT_Injector_UG_bit{
	...
	strings :
		...
		$a_01_2 = {00 3c 4d 6f 64 75 6c 65 3e 00 } //01 00 
		$a_01_3 = {53 79 73 74 65 6d 2e 43 6f 64 65 44 6f 6d 2e 43 6f 6d 70 69 6c 65 72 } //01 00 
		$a_01_4 = {47 65 6e 65 72 61 74 65 64 43 6f 64 65 41 74 74 72 69 62 75 74 65 } //01 00 
		$a_01_5 = {67 65 74 5f 45 6e 74 72 79 50 6f 69 6e 74 } //00 00 
	condition:
		any of ($a_*)
