...
rule VirTool_BAT_Injector_FA{
	...
	strings :
		...
		$a_03_1 = {1f 27 9a 13 90 01 01 11 90 01 01 14 17 8d 01 00 00 01 13 90 01 01 11 90 01 01 16 11 04 a2 11 90 01 01 6f 90 01 01 00 00 0a 74 90 01 01 00 00 01 90 00 } //1
	condition:
