...
rule VirTool_BAT_Injector_JM{
	...
	strings :
		...
		$a_01_2 = {24 39 33 65 38 36 39 37 33 2d 36 30 62 37 2d 34 38 33 37 2d 61 66 39 32 2d 39 34 31 38 39 39 66 62 33 64 63 30 } //00 00  $93e86973-60b7-4837-af92-941899fb3dc0
	condition:
		any of ($a_*)
