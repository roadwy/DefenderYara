...
rule VirTool_BAT_Injector_HL{
	...
	strings :
		$a_03_0 = {20 00 0e 00 00 8d 05 00 00 01 13 06 11 06 16 1f 90 01 01 9c 11 06 17 1f 16 9c 11 06 18 20 d5 00 00 00 9c 11 06 19 1f 54 9c 11 06 1a 1f 6b 9c 11 06 1b 1f 6a 9c 11 06 1c 1f 4a 90 00 } //1
	condition:
		((#a_03_0  & 1)*1) >=1
...
rule VirTool_BAT_Injector_HL_2{
	...
	strings :
		...
		$a_03_2 = {91 61 9c 08 17 58 0c 08 11 90 01 01 31 90 00 } //1
		$a_03_3 = {1f 5c 6a 73 90 01 04 13 90 01 01 17 2d 90 01 01 20 d0 0f 00 00 0b 90 00 } //1
		$a_03_4 = {20 8d 7f ee 00 6a 73 90 01 04 13 90 01 01 16 2d 90 00 } //1
		$a_01_5 = {20 08 01 00 00 8c } //1
		$a_01_6 = {1f 64 fe 04 5f 2c } //1
		$a_03_7 = {91 61 9c 06 90 02 10 58 4a 31 90 00 } //1
		...
		$a_01_10 = {78 00 70 00 65 00 63 00 74 00 6f 00 } //65436 xpecto
		$a_01_11 = {65 41 67 65 6e 74 75 72 4e 45 54 } //65436 eAgenturNET
	condition:
		((#a_03_0  & 1)*1+(#a_01_1  & 1)*1+(#a_03_2  & 1)*1+(#a_03_3  & 1)*1+(#a_03_4  & 1)*1+(#a_01_5  & 1)*1+(#a_01_6  & 1)*1+(#a_03_7  & 1)*1+(#a_00_8  & 1)*1+(#a_00_9  & 1)*1+(#a_01_10  & 1)*65436+(#a_01_11  & 1)*65436) >=3
