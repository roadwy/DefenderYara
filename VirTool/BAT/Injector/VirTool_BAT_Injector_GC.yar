...
rule VirTool_BAT_Injector_GC{
	...
	strings :
		...
		$a_00_1 = {23 00 34 00 3d 00 7e 00 71 00 34 00 69 00 42 00 62 00 51 00 7d 00 5c 00 5d 00 5c 00 5d 00 20 00 33 00 51 00 60 00 51 00 6d 00 5c 00 5b 00 72 00 68 00 5c 00 2a 00 3f 00 25 00 } //00 00 
	condition:
		any of ($a_*)
