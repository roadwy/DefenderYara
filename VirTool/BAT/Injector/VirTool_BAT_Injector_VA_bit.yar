...
rule VirTool_BAT_Injector_VA_bit{
	...
	strings :
		$a_01_0 = {52 00 75 00 6e 00 50 00 45 00 2e 00 50 00 72 00 6f 00 74 00 65 00 63 00 74 00 } //01 00 
		...
		$a_01_2 = {44 65 63 72 79 70 74 00 4c 6f 61 64 69 6e 67 00 4d 61 69 6e } //00 00 
	condition:
		any of ($a_*)
