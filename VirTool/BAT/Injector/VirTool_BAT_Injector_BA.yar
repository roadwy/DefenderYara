...
rule VirTool_BAT_Injector_BA{
	...
	strings :
		$a_03_0 = {07 20 82 fb 9d 4e 61 0b [0-05] 08 20 57 e1 0d 4a 61 0c 2b ?? 09 20 26 c1 bd 5b 61 0d 2b } //1
		$a_03_1 = {20 eb 2b 9c 5b 0d 2b [0-09] ff ff 20 ef 6a 53 15 13 05 } //1
