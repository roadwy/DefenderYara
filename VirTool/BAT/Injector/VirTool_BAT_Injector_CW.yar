...
rule VirTool_BAT_Injector_CW{
	...
	strings :
		$a_03_0 = {11 06 11 07 9a 0c 08 6f 90 01 01 00 00 0a 72 90 01 02 00 70 6f 90 01 01 00 00 0a 2c 67 08 6f 90 01 01 00 00 0a 0d 09 13 08 16 13 09 2b 50 90 00 } //1
