...
rule VirTool_BAT_Injector_IQ{
	...
	strings :
		$a_03_0 = {07 91 61 d2 9c 07 17 58 0b 07 7e 90 01 04 8e 69 fe 04 13 04 11 04 2d dd 06 90 00 } //1
		$a_03_1 = {2b 1c 06 23 00 00 00 00 00 00 70 40 07 6c 28 90 01 04 69 02 07 91 5a 58 0a 07 17 58 0b 07 1a fe 04 0d 09 2d dc 90 00 } //1
