...
rule VirTool_BAT_Injector_gen_F{
	...
	strings :
		$a_02_0 = {53 00 6f 00 66 00 74 00 77 00 61 00 72 00 65 00 5c 00 4d 00 69 00 63 00 72 00 6f 00 73 00 6f 00 66 00 74 00 5c 00 57 00 69 00 6e 00 64 00 6f 00 77 00 73 00 5c 00 43 00 75 00 72 00 72 00 65 00 6e 00 74 00 56 00 65 00 72 00 73 00 69 00 6f 00 6e 00 5c 00 52 00 75 00 6e 00 90 02 04 73 00 76 00 63 00 68 00 6f 00 73 00 74 00 90 00 } //1
		$a_03_1 = {03 00 70 6f 06 00 00 06 06 72 90 01 02 00 70 6f 06 00 00 06 28 05 00 00 2b 13 05 02 06 90 00 } //1
