...
rule VirTool_BAT_Injector_IY_bit{
	...
	strings :
		$a_03_0 = {5d 8c 27 00 00 01 13 90 01 02 11 90 01 02 11 90 01 03 11 90 01 01 28 90 01 01 00 00 0a 91 61 9c 11 90 01 01 17 58 13 90 01 01 11 90 01 01 11 90 01 01 31 90 00 } //1
