...
rule VirTool_BAT_Injector_SV_bit{
	...
	strings :
		$a_01_0 = {64 00 33 00 56 00 68 00 64 00 57 00 4e 00 73 00 64 00 43 00 51 00 3d 00 } //01 00  d3VhdWNsdCQ=
		$a_01_1 = {5c 77 6d 70 6e 65 74 77 6b 5c 77 6d 70 6e 65 74 77 6b } //01 00  \wmpnetwk\wmpnetwk
		$a_01_2 = {5f 00 45 00 6e 00 63 00 72 00 79 00 70 00 74 00 65 00 64 00 24 00 } //00 00  _Encrypted$
	condition:
		any of ($a_*)
...
rule VirTool_BAT_Injector_SV_bit_3{
	...
	strings :
		$a_01_0 = {49 6e 6a 65 63 74 69 6f 6e 45 6e 75 6d } //01 00  InjectionEnum
		...
		$a_01_2 = {43 00 72 00 65 00 61 00 74 00 65 00 20 00 2f 00 54 00 4e 00 20 00 22 00 55 00 70 00 64 00 61 00 74 00 65 00 } //01 00  Create /TN "Update
		$a_01_3 = {3a 00 5a 00 4f 00 4e 00 45 00 2e 00 69 00 64 00 65 00 6e 00 74 00 69 00 66 00 69 00 65 00 72 00 20 00 26 00 20 00 65 00 78 00 69 00 74 00 } //01 00  :ZONE.identifier & exit
