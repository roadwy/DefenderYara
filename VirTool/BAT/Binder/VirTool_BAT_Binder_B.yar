...
rule VirTool_BAT_Binder_B{
	...
	strings :
		...
		$a_01_1 = {41 6e 74 69 56 69 72 74 75 61 6c 50 43 00 41 6e 74 69 56 69 72 74 75 61 6c 42 6f 78 00 41 6e 74 69 56 6d 57 61 72 65 00 } //00 00  湁楴楖瑲慵偬C湁楴楖瑲慵䉬硯䄀瑮噩坭牡e
	condition:
		any of ($a_*)
