...
rule VirTool_BAT_AntiVmc_YF_MTB{
	...
	strings :
		$a_00_0 = {5c 00 76 00 6d 00 47 00 75 00 65 00 73 00 74 00 4c 00 69 00 62 00 2e 00 64 00 6c 00 6c 00 } //01 00 
		$a_00_1 = {5c 00 76 00 62 00 6f 00 78 00 6d 00 72 00 78 00 6e 00 70 00 2e 00 64 00 6c 00 6c 00 } //01 00 
		$a_00_2 = {53 00 62 00 69 00 65 00 44 00 6c 00 6c 00 2e 00 64 00 6c 00 6c 00 } //01 00 
