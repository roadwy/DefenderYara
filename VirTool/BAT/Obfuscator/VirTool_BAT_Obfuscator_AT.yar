...
rule VirTool_BAT_Obfuscator_AT{
	...
	strings :
		$a_03_0 = {61 0c 06 16 07 6f ?? ?? ?? ?? 08 20 ff ff 00 00 5f d1 8c ?? ?? ?? ?? 06 07 17 58 6f ?? ?? ?? ?? 28 ?? ?? ?? ?? 0a 07 17 58 } //1
		...
		$a_03_2 = {0c 08 17 58 0c 08 07 58 0c 08 20 ?? ?? ?? ?? 58 0c 08 07 61 0c 08 07 59 0c 08 17 59 0c 06 16 07 6f ?? ?? ?? ?? 08 20 ff ff 00 00 5f } //1
	condition:
