...
rule VirTool_BAT_Obfuscator_BQ{
	...
	strings :
		...
		$a_00_1 = {57 00 69 00 6e 00 48 00 54 00 54 00 50 00 } //01 00 
		$a_00_2 = {41 00 75 00 74 00 6f 00 2d 00 44 00 69 00 73 00 63 00 6f 00 76 00 65 00 72 00 79 00 } //01 00 
		$a_00_3 = {57 00 65 00 62 00 20 00 50 00 72 00 6f 00 78 00 79 00 } //00 00 
