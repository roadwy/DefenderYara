...
rule VirTool_BAT_Obfuscator_AL{
	...
	strings :
		...
		$a_03_1 = {53 79 73 74 65 6d 2e 52 75 6e 74 69 6d 65 2e 49 6e 74 65 72 6f 70 53 65 72 76 69 63 65 73 00 44 6c 6c 49 6d 70 6f 72 74 41 74 74 72 69 62 75 74 65 00 90 02 20 2e 64 6c 6c 00 90 00 } //1
