...
rule VirTool_BAT_Quiltran_A{
	meta:
		description = "VirTool:BAT/Quiltran.A,SIGNATURE_TYPE_PEHSTR_EXT,0c 00 0c 00 0c 00 00 "
	...
	strings :
		...
		$a_03_7 = {61 00 70 00 70 00 65 00 6e 00 64 00 90 02 04 6d 00 65 00 74 00 61 00 5f 00 70 00 61 00 74 00 68 00 90 02 04 70 00 61 00 74 00 68 00 90 00 } //1
		...
		$a_03_11 = {44 00 45 00 42 00 55 00 47 00 90 02 04 4d 00 61 00 69 00 6e 00 2e 00 70 00 79 00 90 02 04 45 00 78 00 65 00 63 00 75 00 74 00 65 00 90 00 } //1
	condition:
