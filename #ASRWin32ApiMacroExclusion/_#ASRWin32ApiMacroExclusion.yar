...
rule _#ASRWin32ApiMacroExclusion_71{
	...
	strings :
		$a_00_0 = {42 6c 6f 6f 6d 62 65 72 67 56 65 72 73 69 6f 6e 43 68 65 63 6b 65 72 } //1 BloombergVersionChecker
		$a_00_1 = {42 6c 6f 6f 6d 62 65 72 67 2e 63 63 79 72 65 61 64 65 72 } //1 Bloomberg.ccyreader
		$a_00_2 = {42 42 5f 54 41 58 5f 44 41 54 41 5f 41 53 53 55 4d } //1 BB_TAX_DATA_ASSUM
		$a_00_3 = {42 42 5f 52 45 56 5f 4e 55 4d 5f 45 53 54 5f 45 52 52 5f 45 50 53 } //1 BB_REV_NUM_EST_ERR_EPS
		$a_00_4 = {43 61 73 65 20 22 43 68 6e 67 20 69 6e 20 4e 65 74 20 4c 6f 6e 67 54 20 44 65 66 20 54 61 78 20 4c 69 61 62 22 } //1 Case "Chng in Net LongT Def Tax Liab"
	condition:
		((#a_00_0  & 1)*1+(#a_00_1  & 1)*1+(#a_00_2  & 1)*1+(#a_00_3  & 1)*1+(#a_00_4  & 1)*1) >=5
...
rule _#ASRWin32ApiMacroExclusion_260{
	meta:
