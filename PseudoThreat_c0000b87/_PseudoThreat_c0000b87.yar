...
rule _PseudoThreat_c0000b87{
	meta:
		description = "!PseudoThreat_c0000b87,SIGNATURE_TYPE_PEHSTR_EXT,06 00 06 00 07 00 00 "
	...
	strings :
		...
		$a_02_5 = {47 45 54 20 2f 90 02 08 2e 70 68 70 3f 26 61 64 76 69 64 3d 90 00 } //1
		$a_02_6 = {47 45 54 20 68 74 74 70 3a 2f 2f 64 6f 77 6e 6c 6f 61 64 2e 25 73 2e 63 6f 6d 2f 90 02 08 2e 70 68 70 3f 26 61 64 76 69 64 3d 90 00 } //1
	condition:
