...
rule _PseudoThreat_4000002d{
	meta:
		description = "!PseudoThreat_4000002d,SIGNATURE_TYPE_PEHSTR_EXT,24 00 24 00 08 00 00 "
	...
	strings :
		...
		$a_02_3 = {68 00 74 00 74 00 70 00 3a 00 2f 00 2f 00 74 00 68 00 65 00 6e 00 90 03 04 00 6d 00 6e 00 65 00 74 00 77 00 6f 00 72 00 6b 00 90 03 06 00 63 00 6f 00 6d 00 2e 00 63 00 6f 00 6d 00 2f 00 64 00 77 00 2e 00 70 00 68 00 70 00 90 00 } //3
