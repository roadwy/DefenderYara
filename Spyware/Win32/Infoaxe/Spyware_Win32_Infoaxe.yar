...
rule Spyware_Win32_Infoaxe{
	...
	strings :
		...
		$a_03_2 = {61 64 64 74 6f 73 6f 66 74 6c 69 6e 6b 73 66 6f 72 6d 2e 6a 73 70 3f 71 3d 25 55 52 4c 25 90 02 05 41 64 64 20 74 6f 20 71 75 69 63 6b 20 6c 69 6e 6b 73 90 00 } //1
