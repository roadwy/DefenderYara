...
rule Spyware_Win32_CnsMin_2{
	...
	strings :
		...
		$a_02_3 = {53 74 61 72 74 52 65 66 65 72 65 72 90 02 04 61 6c 72 65 78 2e 64 6c 6c 90 00 } //1
...
rule Spyware_Win32_CnsMin_4{
	...
	strings :
		...
		$a_02_1 = {77 69 6e 69 6e 69 74 2e 69 6e 69 00 5c 90 02 04 44 4f 57 4e 4c 4f 7e 31 5c 43 4e 53 00 90 00 } //1
...
rule Spyware_Win32_CnsMin_14{
	...
	strings :
		...
		$a_00_9 = {68 74 74 70 3a 2f 2f 77 77 77 2e 6a 77 6f 72 64 2e 6a 70 2f } //65486 http://www.jword.jp/
	condition:
		((#a_01_0  & 1)*1+(#a_01_1  & 1)*1+(#a_01_2  & 1)*2+(#a_01_3  & 1)*2+(#a_01_4  & 1)*1+(#a_01_5  & 1)*1+(#a_01_6  & 1)*1+(#a_01_7  & 1)*2+(#a_01_8  & 1)*2+(#a_00_9  & 1)*65486) >=11
