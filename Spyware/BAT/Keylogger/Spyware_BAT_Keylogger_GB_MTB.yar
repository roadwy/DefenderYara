...
rule Spyware_BAT_Keylogger_GB_MTB{
	...
	strings :
		$a_02_0 = {63 00 6d 00 64 00 2e 00 65 00 78 00 65 00 20 00 2f 00 63 00 20 00 70 00 69 00 6e 00 67 00 20 00 30 00 20 00 2d 00 6e 00 20 00 90 02 04 20 00 26 00 20 00 64 00 65 00 6c 00 90 00 } //10
		$a_02_1 = {63 6d 64 2e 65 78 65 20 2f 63 20 70 69 6e 67 20 30 20 2d 6e 20 90 02 04 20 26 20 64 65 6c 90 00 } //10
